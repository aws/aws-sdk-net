...
namespace AWSSDKDocSamples.Amazon.EC2.Generated
{
    class EC2Samples : ISample
    {
        ...
        public void EC2DescribeScheduledInstanceAvailability()
        {
            ...
            var response = client.DescribeScheduledInstanceAvailability(new DescribeScheduledInstanceAvailabilityRequest 
            {
                FirstSlotStartTimeRange = new SlotDateTimeRangeRequest {
                    EarliestTimeUtc = new DateTime(2016, 1, 30, 7, 0, 0, DateTimeKind.Utc),
                    LatestTimeUtc = new DateTime(2016, 1, 30, 11, 0, 0, DateTimeKind.Utc)
                },
        ...
        public void EC2DescribeSpotFleetRequestHistory()
        {
            ...
            {
                SpotFleetRequestId = "sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE",
                StartTimeUtc = new DateTime(2015, 5, 25, 8, 0, 0, DateTimeKind.Utc)
            });
