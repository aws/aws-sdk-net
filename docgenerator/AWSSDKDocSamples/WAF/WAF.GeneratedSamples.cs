...
namespace AWSSDKDocSamples.Amazon.WAF.Generated
{
    ...
    {
        static IAmazonWAF client = new AmazonWAFClient();
        ...
        public void WAFGetSampledRequests()
        {
            ...
            var response = client.GetSampledRequests(new GetSampledRequestsRequest 
            {
                ...
                TimeWindow = new TimeWindow {
                    EndTime = new DateTime(2016, 9, 27, 11, 50, 0, DateTimeKind.Utc),
                    StartTime = new DateTime(2016, 9, 27, 11, 50, 0, DateTimeKind.Utc)
                },
