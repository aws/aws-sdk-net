# AWS SDK for .NET [![Build status](https://ci.appveyor.com/api/projects/status/cvqw4kgyvcmj9k4q/branch/master)](https://ci.appveyor.com/project/wmatveyenko/aws-sdk-net/branch/master)
