...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RestartAppServerRequestMarshaller : IMarshaller<IRequest, RestartAppServerRequest>
    {
        public IRequest Marshall(RestartAppServerRequest restartAppServerRequest)
        {
            IRequest request = new DefaultRequest(restartAppServerRequest, "AmazonElasticBeanstalk");
