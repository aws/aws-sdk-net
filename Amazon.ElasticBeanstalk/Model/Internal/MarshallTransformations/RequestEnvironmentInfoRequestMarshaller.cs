...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RequestEnvironmentInfoRequestMarshaller : IMarshaller<IRequest, RequestEnvironmentInfoRequest>
    {
        public IRequest Marshall(RequestEnvironmentInfoRequest requestEnvironmentInfoRequest)
        {
            IRequest request = new DefaultRequest(requestEnvironmentInfoRequest, "AmazonElasticBeanstalk");
