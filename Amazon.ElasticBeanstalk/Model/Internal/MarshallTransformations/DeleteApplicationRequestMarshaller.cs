...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteApplicationRequestMarshaller : IMarshaller<IRequest, DeleteApplicationRequest>
    {
        public IRequest Marshall(DeleteApplicationRequest deleteApplicationRequest)
        {
            IRequest request = new DefaultRequest(deleteApplicationRequest, "AmazonElasticBeanstalk");
