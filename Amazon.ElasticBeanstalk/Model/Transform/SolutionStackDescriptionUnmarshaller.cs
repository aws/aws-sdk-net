...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class SolutionStackDescriptionUnmarshaller : IUnmarshaller<SolutionStackDescription, UnmarshallerContext> 
    {
        public SolutionStackDescription Unmarshall(UnmarshallerContext context) 
        {
