...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class EnvironmentInfoDescriptionUnmarshaller : IUnmarshaller<EnvironmentInfoDescription, UnmarshallerContext> 
    {
        public EnvironmentInfoDescription Unmarshall(UnmarshallerContext context) 
        {
