...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class UpdateConfigurationTemplateResultUnmarshaller : IUnmarshaller<UpdateConfigurationTemplateResult, UnmarshallerContext> 
    {
        public UpdateConfigurationTemplateResult Unmarshall(UnmarshallerContext context) 
        {
