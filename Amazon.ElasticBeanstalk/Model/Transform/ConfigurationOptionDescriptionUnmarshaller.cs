...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class ConfigurationOptionDescriptionUnmarshaller : IUnmarshaller<ConfigurationOptionDescription, UnmarshallerContext> 
    {
        public ConfigurationOptionDescription Unmarshall(UnmarshallerContext context) 
        {
