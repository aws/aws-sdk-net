...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class CreateStorageLocationResultUnmarshaller : IUnmarshaller<CreateStorageLocationResult, UnmarshallerContext> 
    {
        public CreateStorageLocationResult Unmarshall(UnmarshallerContext context) 
        {
