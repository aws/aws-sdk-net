...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class DescribeEnvironmentsResultUnmarshaller : IUnmarshaller<DescribeEnvironmentsResult, UnmarshallerContext> 
    {
        public DescribeEnvironmentsResult Unmarshall(UnmarshallerContext context) 
        {
