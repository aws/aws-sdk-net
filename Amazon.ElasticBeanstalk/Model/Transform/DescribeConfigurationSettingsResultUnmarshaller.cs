...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class DescribeConfigurationSettingsResultUnmarshaller : IUnmarshaller<DescribeConfigurationSettingsResult, UnmarshallerContext> 
    {
        public DescribeConfigurationSettingsResult Unmarshall(UnmarshallerContext context) 
        {
