...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class CreateApplicationVersionResponseUnmarshaller : IResponseUnmarshaller<CreateApplicationVersionResponse, UnmarshallerContext> {

        public CreateApplicationVersionResponse Unmarshall(UnmarshallerContext context) 
        {
