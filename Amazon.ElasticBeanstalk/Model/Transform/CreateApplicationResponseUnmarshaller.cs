...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class CreateApplicationResponseUnmarshaller : IResponseUnmarshaller<CreateApplicationResponse, UnmarshallerContext> {

        public CreateApplicationResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static CreateApplicationResponseUnmarshaller instance;
