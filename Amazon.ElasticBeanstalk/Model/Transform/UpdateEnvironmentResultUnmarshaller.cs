...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class UpdateEnvironmentResultUnmarshaller : IUnmarshaller<UpdateEnvironmentResult, UnmarshallerContext> 
    {
        public UpdateEnvironmentResult Unmarshall(UnmarshallerContext context) 
        {
