...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class TerminateEnvironmentResultUnmarshaller : IUnmarshaller<TerminateEnvironmentResult, UnmarshallerContext> 
    {
        public TerminateEnvironmentResult Unmarshall(UnmarshallerContext context) 
        {
