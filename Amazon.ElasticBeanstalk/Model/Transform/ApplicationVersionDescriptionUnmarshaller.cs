...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class ApplicationVersionDescriptionUnmarshaller : IUnmarshaller<ApplicationVersionDescription, UnmarshallerContext> 
    {
        public ApplicationVersionDescription Unmarshall(UnmarshallerContext context) 
        {
