...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeConfigurationOptionsResponseUnmarshaller : IResponseUnmarshaller<DescribeConfigurationOptionsResponse, UnmarshallerContext> {

        public DescribeConfigurationOptionsResponse Unmarshall(UnmarshallerContext context) 
        {
