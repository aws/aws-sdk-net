...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class DescribeApplicationsResultUnmarshaller : IUnmarshaller<DescribeApplicationsResult, UnmarshallerContext> 
    {
        public DescribeApplicationsResult Unmarshall(UnmarshallerContext context) 
        {
