...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class ListAvailableSolutionStacksResponseUnmarshaller : IResponseUnmarshaller<ListAvailableSolutionStacksResponse, UnmarshallerContext> {

        public ListAvailableSolutionStacksResponse Unmarshall(UnmarshallerContext context) 
        {
