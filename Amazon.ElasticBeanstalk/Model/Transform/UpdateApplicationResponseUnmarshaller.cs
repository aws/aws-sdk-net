...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateApplicationResponseUnmarshaller : IResponseUnmarshaller<UpdateApplicationResponse, UnmarshallerContext> {

        public UpdateApplicationResponse Unmarshall(UnmarshallerContext context) 
        {
