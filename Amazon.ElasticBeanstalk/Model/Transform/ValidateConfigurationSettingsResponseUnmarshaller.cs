...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class ValidateConfigurationSettingsResponseUnmarshaller : IResponseUnmarshaller<ValidateConfigurationSettingsResponse, UnmarshallerContext> {

        public ValidateConfigurationSettingsResponse Unmarshall(UnmarshallerContext context) 
        {
