...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class EnvironmentResourceDescriptionUnmarshaller : IUnmarshaller<EnvironmentResourceDescription, UnmarshallerContext> 
    {
        public EnvironmentResourceDescription Unmarshall(UnmarshallerContext context) 
        {
