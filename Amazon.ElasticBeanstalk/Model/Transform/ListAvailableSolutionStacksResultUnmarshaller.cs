...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class ListAvailableSolutionStacksResultUnmarshaller : IUnmarshaller<ListAvailableSolutionStacksResult, UnmarshallerContext> 
    {
        public ListAvailableSolutionStacksResult Unmarshall(UnmarshallerContext context) 
        {
