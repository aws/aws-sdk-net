...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class SwapEnvironmentCNAMEsResponseUnmarshaller : IResponseUnmarshaller<SwapEnvironmentCNAMEsResponse, UnmarshallerContext> {

        public SwapEnvironmentCNAMEsResponse Unmarshall(UnmarshallerContext context) 
        {
