...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class EnvironmentDescriptionUnmarshaller : IUnmarshaller<EnvironmentDescription, UnmarshallerContext> 
    {
        public EnvironmentDescription Unmarshall(UnmarshallerContext context) 
        {
