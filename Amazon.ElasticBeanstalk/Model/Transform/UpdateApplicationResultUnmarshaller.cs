...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class UpdateApplicationResultUnmarshaller : IUnmarshaller<UpdateApplicationResult, UnmarshallerContext> 
    {
        public UpdateApplicationResult Unmarshall(UnmarshallerContext context) 
        {
