...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateConfigurationTemplateResponseUnmarshaller : IResponseUnmarshaller<UpdateConfigurationTemplateResponse, UnmarshallerContext> {

        public UpdateConfigurationTemplateResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.UpdateConfigurationTemplateResult = UpdateConfigurationTemplateResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
