...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class CreateStorageLocationResponseUnmarshaller : IResponseUnmarshaller<CreateStorageLocationResponse, UnmarshallerContext> {

        public CreateStorageLocationResponse Unmarshall(UnmarshallerContext context) 
        {
