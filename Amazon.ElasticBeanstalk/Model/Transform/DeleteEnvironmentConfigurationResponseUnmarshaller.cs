...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteEnvironmentConfigurationResponseUnmarshaller : IResponseUnmarshaller<DeleteEnvironmentConfigurationResponse, UnmarshallerContext> {

        public DeleteEnvironmentConfigurationResponse Unmarshall(UnmarshallerContext context) 
        {
