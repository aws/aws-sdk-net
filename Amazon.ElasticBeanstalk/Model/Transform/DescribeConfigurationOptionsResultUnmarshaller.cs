...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class DescribeConfigurationOptionsResultUnmarshaller : IUnmarshaller<DescribeConfigurationOptionsResult, UnmarshallerContext> 
    {
        public DescribeConfigurationOptionsResult Unmarshall(UnmarshallerContext context) 
        {
