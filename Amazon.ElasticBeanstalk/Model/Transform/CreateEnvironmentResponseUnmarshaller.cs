...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class CreateEnvironmentResponseUnmarshaller : IResponseUnmarshaller<CreateEnvironmentResponse, UnmarshallerContext> {

        public CreateEnvironmentResponse Unmarshall(UnmarshallerContext context) 
        {
