...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class RebuildEnvironmentResponseUnmarshaller : IResponseUnmarshaller<RebuildEnvironmentResponse, UnmarshallerContext> {

        public RebuildEnvironmentResponse Unmarshall(UnmarshallerContext context) 
        {
