...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class OptionRestrictionRegexUnmarshaller : IUnmarshaller<OptionRestrictionRegex, UnmarshallerContext> 
    {
        public OptionRestrictionRegex Unmarshall(UnmarshallerContext context) 
        {
