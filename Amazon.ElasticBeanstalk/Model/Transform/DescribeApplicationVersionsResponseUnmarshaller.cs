...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeApplicationVersionsResponseUnmarshaller : IResponseUnmarshaller<DescribeApplicationVersionsResponse, UnmarshallerContext> {

        public DescribeApplicationVersionsResponse Unmarshall(UnmarshallerContext context) 
        {
