...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class UpdateApplicationVersionResultUnmarshaller : IUnmarshaller<UpdateApplicationVersionResult, UnmarshallerContext> 
    {
        public UpdateApplicationVersionResult Unmarshall(UnmarshallerContext context) 
        {
