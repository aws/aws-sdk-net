...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class ConfigurationOptionSettingUnmarshaller : IUnmarshaller<ConfigurationOptionSetting, UnmarshallerContext> 
    {
        public ConfigurationOptionSetting Unmarshall(UnmarshallerContext context) 
        {
