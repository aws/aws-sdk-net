...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class EventDescriptionUnmarshaller : IUnmarshaller<EventDescription, UnmarshallerContext> 
    {
        public EventDescription Unmarshall(UnmarshallerContext context) 
        {
