...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class ValidationMessageUnmarshaller : IUnmarshaller<ValidationMessage, UnmarshallerContext> 
    {
        public ValidationMessage Unmarshall(UnmarshallerContext context) 
        {
