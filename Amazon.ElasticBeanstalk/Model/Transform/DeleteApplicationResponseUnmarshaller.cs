...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteApplicationResponseUnmarshaller : IResponseUnmarshaller<DeleteApplicationResponse, UnmarshallerContext> {

        public DeleteApplicationResponse Unmarshall(UnmarshallerContext context) 
        {
