...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class CheckDNSAvailabilityResultUnmarshaller : IUnmarshaller<CheckDNSAvailabilityResult, UnmarshallerContext> 
    {
        public CheckDNSAvailabilityResult Unmarshall(UnmarshallerContext context) 
        {
