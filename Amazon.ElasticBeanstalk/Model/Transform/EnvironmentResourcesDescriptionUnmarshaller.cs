...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class EnvironmentResourcesDescriptionUnmarshaller : IUnmarshaller<EnvironmentResourcesDescription, UnmarshallerContext> 
    {
        public EnvironmentResourcesDescription Unmarshall(UnmarshallerContext context) 
        {
