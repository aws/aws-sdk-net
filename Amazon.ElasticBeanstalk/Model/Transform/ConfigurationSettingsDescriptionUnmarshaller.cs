...
namespace Amazon.ElasticBeanstalk.Model.Transform
{
     ...
     /// </summary>
    internal class ConfigurationSettingsDescriptionUnmarshaller : IUnmarshaller<ConfigurationSettingsDescription, UnmarshallerContext> 
    {
        public ConfigurationSettingsDescription Unmarshall(UnmarshallerContext context) 
        {
