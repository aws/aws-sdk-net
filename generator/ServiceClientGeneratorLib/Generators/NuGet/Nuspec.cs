...
#line hidden
	...
	if(Convert.ToBoolean(this.Session["CoreCLRSupport"]))
	{
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Path.Combine(".", "bin", "Release", "netstandard1.5", (string)this.Session["AssemblyName"] + ".dll")));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Path.Combine(".", "bin", "Release", "netstandard1.5", (string)this.Session["AssemblyName"] + ".pdb")));
