...
this.Write("));\t\t\t\t \r\n\r\n");
	...
	void ProcessStructure(int level, string variableName, Shape shape, string xmlNamespace)
	{
...
this.Write("\", kvp.Key);\r\n");
		...
		{
			ProcessSubMap(level + 1, member.Shape.ValueShape, "kvp", xmlNamespace);
		}
...
this.Write("\");\r\n");
        ...
        #line 305 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
			...
			ProcessStructure(level + 2, "kvp.Value", member.Shape.ValueShape, xmlNamespace);
...
this.Write("\t\t\t\t\txmlWriter.WriteEndElement();\t\t\t\t\r\n");
	...
	void ProcessSubMap(int level, Shape shape, string parentVariableName, string xmlNamespace)
	{				
...
this.Write(".Key);\r\n");
		...
		{
			ProcessSubMap(level + 1, shape.ValueShape, $"kvp{level}", xmlNamespace);
		}
		else
		{
