...
#line hidden
	...
	void ProcessRequestBodyMembers(string variableName, Operation operation)
	{
		...
		if (operation.RequestPayloadMember != null && operation.RequestPayloadMember.IsRequired)
		{
			bool omitRequiredFieldCheck = this.Config.ServiceModel.Customizations.TryGetPropertyModifier(operation.RequestStructure.Name, operation.RequestPayloadMember.ModeledName, out var modifier) && modifier.OmitRequiredFieldCheck;
			if (operation.RequestPayloadMember.Shape.IsString && !omitRequiredFieldCheck)
			{
...
this.Write("\");\r\n");
        ...
        #line 154 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
			...
			else if (!operation.RequestPayloadMember.Shape.IsString && !omitRequiredFieldCheck)
			{
...
this.Write("())\r\n\t\t\t\t{\r\n");
        ...
        #line 212 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
...
this.Write("\",kvp.Key);\r\n");
        ...
        #line 728 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write("\", kvp.Key);\r\n");
        ...
        #line 806 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write("\t\t\t\t\t\txmlWriter.WriteEndElement();\r\n");
        ...
        #line 825 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write(".Key);\r\n");
        ...
        #line 852 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write(".Value);\r\n");
        ...
        #line 856 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write("request.Headers[\"Content-Type\"] = \"text/plain\";\r\n");
        ...
        #line 875 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write("request.Headers[\"Content-Type\"] = \"application/octet-stream\";\r\n");
        ...
        #line 881 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
...
this.Write("\t\t\t\t{\r\n");
        ...
        #line 891 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write("\t\t\t\t}\r\n");
        ...
        #line 895 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
	...
	protected void ProcessNestedList(int level, string variableName, Member innerMember, Member owningMember)
	{
        ...
        #line 910 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', (level) * 4)));
...
this.Write("\t\t\t\t\t\txmlWriter.WriteEndElement();\r\n");
        ...
        #line 921 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', (level) * 4)));
...
this.Write("\t\t\t\t\t}\r\n");
        ...
        #line 925 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
	...
	protected void WriteXmlAttributeString(int level, Member member, string variableName,  bool isPayload, Operation operation = null)
	{
        ...
        #line 950 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
...
this.Write("));\r\n");
        ...
        #line 960 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
...
this.Write("));\r\n");
        ...
        #line 965 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
	...
	protected void WriteInjectXmlMarshallCode(int level, HashSet<string> injectXmlMarshallCode)
	{
        ...
        #line 971 "C:\Dev\Repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\RestXmlRequestMarshaller.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(new string(' ', level * 4)));
