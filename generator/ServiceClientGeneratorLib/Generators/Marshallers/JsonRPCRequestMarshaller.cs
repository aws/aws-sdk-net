...
#line hidden
	...
	AddCommonUsingStatements();
            ...
            #line 13 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
            ...
            #line 16 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
            ...
            this.Write(@"Request> , IMarshaller<IRequest,AmazonWebServiceRequest>
	{
		...
		public IRequest Marshall(AmazonWebServiceRequest input)
        {
            ...
            #line 27 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.Operation.Name));
            ...
            #line 35 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.Operation.Name));
   ...
   if (!string.IsNullOrEmpty(this.Config.ServiceModel.TargetPrefix))
	{
            ...
            #line 44 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	...
	if (this.Operation.HttpMethod != "GET" && this.Operation.HttpMethod != "DELETE")
	{
		...
		if (this.Config.ServiceModel.Customizations.OverrideContentType != null)
		{
            ...
            #line 54 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
		...
		else if (this.Config.ServiceModel.Type != ServiceType.Rest_Json)
		{
            ...
            #line 60 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
		...
		else if (this.Operation.RequestHasBodyMembers || this.Operation.RequestPayloadMember != null)
		{
            ...
            #line 67 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	...
	if (this.Config.ServiceModel.Type == ServiceType.Rest_Json)
	{
		...
		ProcessQueryStringMembers("publicRequest", this.Operation);
            ...
            #line 86 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	...
	if (this.Operation.RequestHasBodyMembers || shouldMarshallPayload)
	{
            ...
            #line 99 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
		...
		else
		{
            ...
            #line 116 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	...
	else if (payload?.Shape.IsString == true)
	{
            ...
            #line 131 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
...
");
		...
		else
		{
            ...
            #line 173 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
            ...
            #line 181 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	...
	else if (this.Config.ServiceModel.Type == ServiceType.Json)
	{
            ...
            #line 199 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	...
	if (this.Operation.UseQueryString)
	{
            ...
            #line 212 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
	}
	...
	if (!string.IsNullOrEmpty(this.Operation.EndpointHostPrefix) && this.Config.ServiceId != "S3" && this.Config.ServiceId != "S3 Control")
	{
		ProcessEndpointHostPrefixMembers("publicRequest", this.Operation);
            ...
            #line 223 "C:\Dev\repos\aws-sdk-net-staging\generator\ServiceClientGeneratorLib\Generators\Marshallers\JsonRPCRequestMarshaller.tt"
