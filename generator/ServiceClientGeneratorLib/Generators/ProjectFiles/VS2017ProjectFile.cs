...
");
    ...
    if(this.Project.CustomRoslynAnalyzersDllDirectory != null)
    {
            ...
            #line 182 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
    ...
    foreach (var compileIncludeEntry in this.Project.IndividualFileIncludes)
    {
            ...
            #line 194 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
    ...
    foreach (var compileRemoveEntry in this.Project.CompileRemoveList)
    {
        if (compileRemoveEntry == "bin" || compileRemoveEntry == "obj")
        {
            ...
            #line 212 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            ...
            #line 213 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(compileRemoveEntry));
    ...
    continue;
            ...
            #line 218 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(compileRemoveEntry));
    ...
    if (this.Project.PackageReferences != null)
    {
        ...
        foreach(var package in this.Project.PackageReferences.Where(p => p.IsAnalyzer))
        {
            ...
            #line 256 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            ...
            #line 264 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(package.Include));
        ...
        foreach(var package in this.Project.PackageReferences.Where(p => !p.IsAnalyzer))
        {
            ...
            #line 277 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(package.Include));
            ...
            #line 285 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(package.Include));
    ...
    if (this.Project.ReferenceDependencies != null)
    {
        ...
        foreach (var reference in this.Project.ReferenceDependencies)
        {
            ...
            #line 304 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            ...
            #line 310 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(reference.Name));
    ...
    foreach (var resource in this.Project.EmbeddedResources)
    {
            ...
            #line 329 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
    ...
    if (this.Project.Services != null)
    {
        ...
        foreach (var service in this.Project.Services)
        {
            ...
            #line 345 "C:\repos\aws-sdk-net-v4\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\VS2017ProjectFile.tt"
