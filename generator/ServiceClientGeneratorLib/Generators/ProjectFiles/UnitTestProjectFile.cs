...
");
	...
	if(compileInclude != null)
	{
		foreach(var entry in compileInclude)
		{
            ...
            #line 87 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
	...
	if (commonReferences != null)
	{
		foreach(var reference in commonReferences)
		{
            ...
            #line 94 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            ...
            #line 95 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            ...
            #line default
            #line hidden
            this.Write("  </ItemGroup>\r\n  <ItemGroup Condition=\"$(ReferenceServiceDLLs)\">\r\n");
	...
	if (commonReferences != null)
	{
		foreach(var reference in dllReferences)
		{
            ...
            #line 112 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            ...
            #line 114 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            ...
            #line 120 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
	...
	if (commonReferences != null)
	{
		foreach(var reference in serviceReferences)
		{
            ...
            #line 127 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(reference.IncludePath));
            ...
            #line 128 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(reference.ProjectGuid));
            ...
            #line 131 "D:\workspace\AWSDotNetPublic\generator\ServiceClientGeneratorLib\Generators\ProjectFiles\UnitTestProjectFile.tt"
            ...
            #line default
            #line hidden
            this.Write("  </ItemGroup>\r\n  <ItemGroup>\r\n    <ProjectReference Include=\"..\\..\\..\\generator\\" +
                    "ServiceClientGeneratorLib\\ServiceClientGeneratorLib.csproj\">\r\n      <Project>{7B" +
                    "EE7C44-BE12-43CC-AFB9-B5852A1F43C8}</Project>\r\n      <Name>ServiceClientGenerato" +
                    "rLib</Name>\r\n    </ProjectReference>\r\n  </ItemGroup>\r\n  <ItemGroup>\r\n    <Servic" +
                    "e Include=\"{508349B6-6B84-4DF5-91F0-309BEEBAD82D}\" />\r\n  </ItemGroup>\r\n  <ItemGr" +
                    "oup>\r\n    <None Include=\"App.config\" />\r\n  </ItemGroup>\r\n  <ItemGroup>\r\n    <Emb" +
                    "eddedResource Include=\"Custom\\Runtime\\TestResponses\\*.txt\" />\r\n  </ItemGroup>\r\n " +
                    " <ItemGroup>\r\n    <EmbeddedResource Include=\"Custom\\TestTools\\ComparerTest.json\"" +
                    " />\r\n  </ItemGroup>\r\n  <ItemGroup>\r\n    <EmbeddedResource Include=\"Custom\\CloudF" +
                    "ront\\sample.rsa.private.key.txt\" />\r\n  </ItemGroup>\r\n  <Choose>\r\n    <When Condi" +
                    "tion=\"\'$(VisualStudioVersion)\' == \'10.0\' And \'$(IsCodedUITest)\' == \'True\'\">\r\n   " +
                    "   <ItemGroup>\r\n        <Reference Include=\"Microsoft.VisualStudio.QualityTools." +
                    "CodedUITestFramework, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f" +
                    "11d50a3a, processorArchitecture=MSIL\">\r\n          <Private>False</Private>\r\n    " +
                    "    </Reference>\r\n        <Reference Include=\"Microsoft.VisualStudio.TestTools.U" +
                    "ITest.Common, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" +
                    ", processorArchitecture=MSIL\">\r\n          <Private>False</Private>\r\n        </Re" +
                    "ference>\r\n        <Reference Include=\"Microsoft.VisualStudio.TestTools.UITest.Ex" +
                    "tension, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a, pro" +
                    "cessorArchitecture=MSIL\">\r\n          <Private>False</Private>\r\n        </Referen" +
                    "ce>\r\n        <Reference Include=\"Microsoft.VisualStudio.TestTools.UITesting, Ver" +
                    "sion=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a, processorArchit" +
                    "ecture=MSIL\">\r\n          <Private>False</Private>\r\n        </Reference>\r\n      <" +
                    "/ItemGroup>\r\n    </When>\r\n  </Choose>\r\n  <Import Project=\"$(VSToolsPath)\\TeamTes" +
                    "t\\Microsoft.TestTools.targets\" Condition=\"Exists(\'$(VSToolsPath)\\TeamTest\\Micros" +
                    "oft.TestTools.targets\')\" />\r\n  <Import Project=\"$(MSBuildToolsPath)\\Microsoft.CS" +
                    "harp.targets\" />\r\n  <!-- To modify your build process, add your task inside one " +
                    "of the targets below and uncomment it. \r\n       Other similar extension points e" +
                    "xist, see Microsoft.Common.targets.\r\n  <Target Name=\"BeforeBuild\">\r\n  </Target>\r" +
