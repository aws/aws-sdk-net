...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    internal class GetTemplateResultUnmarshaller : IUnmarshaller<GetTemplateResult, UnmarshallerContext> 
    {
        ...
        private static GetTemplateResultUnmarshaller instance;

        public static GetTemplateResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new GetTemplateResultUnmarshaller();
