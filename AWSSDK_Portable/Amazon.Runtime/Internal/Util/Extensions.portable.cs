...
namespace Amazon.Runtime.Internal.Util
{
    internal static partial class Extensions
    {
        ...
        internal static string ToLower(this string self, IFormatProvider formatProvider)
        {
            return self.ToLower();
        }
        internal static string ToUpper(this string self, IFormatProvider formatProvider)
        {
            return self.ToUpper();
        }

        internal static string ToString(this bool self, IFormatProvider formatProvider)
        {
