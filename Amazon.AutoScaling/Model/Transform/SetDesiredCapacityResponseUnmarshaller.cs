...
namespace Amazon.AutoScaling.Model.Transform
{
    ...
    /// </summary>
    internal class SetDesiredCapacityResponseUnmarshaller : IResponseUnmarshaller<SetDesiredCapacityResponse, UnmarshallerContext> {

        public SetDesiredCapacityResponse Unmarshall(UnmarshallerContext context) 
        {
