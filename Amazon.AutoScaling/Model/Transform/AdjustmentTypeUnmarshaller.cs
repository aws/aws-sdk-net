...
namespace Amazon.AutoScaling.Model.Transform
{
     ...
     /// </summary>
    internal class AdjustmentTypeUnmarshaller : IUnmarshaller<AdjustmentType, UnmarshallerContext> 
    {
        public AdjustmentType Unmarshall(UnmarshallerContext context) 
        {
