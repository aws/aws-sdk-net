...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class PutNotificationConfigurationResponseUnmarshaller : IResponseUnmarshaller<PutNotificationConfigurationResponse, UnmarshallerContext> {

        public PutNotificationConfigurationResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static PutNotificationConfigurationResponseUnmarshaller instance;

        public static PutNotificationConfigurationResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new PutNotificationConfigurationResponseUnmarshaller();
            }
            return instance;
        }
