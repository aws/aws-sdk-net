...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteTagsResponseUnmarshaller : IResponseUnmarshaller<DeleteTagsResponse, UnmarshallerContext> {

        public DeleteTagsResponse Unmarshall(UnmarshallerContext context) 
        {
