...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteHostedZoneResponseUnmarshaller : IResponseUnmarshaller<DeleteHostedZoneResponse, UnmarshallerContext> {

        public DeleteHostedZoneResponse Unmarshall(UnmarshallerContext context) 
        {
