...
public class BedrockChatClientTests
{
    ...
    public async Task IChatClient_GetResponseAsync_AdditionalProperties_WithJsonNull()
    {
        ...
        MockBedrockRuntime mock = new()
        {
            ...
            {
                var dict = request.AdditionalModelRequestFields.AsDictionary();
                // Null JSON element becomes empty string according to the implementation
    ...
    [InlineData(true)]
    [InlineData(false)]
    public async Task IChatClient_GetResponseAsync_AdditionalProperties_WithJsonBoolean(bool boolValue)
    {
        ...
        MockBedrockRuntime mock = new()
        {
            ...
            {
                var dict = request.AdditionalModelRequestFields.AsDictionary();
                Assert.Equal(boolValue, dict["bool_prop"].AsBool());
    ...
    public async Task IChatClient_GetResponseAsync_FunctionCallContent()
    {
        ...
        Assert.Equal("San Francisco", ((System.Text.Json.JsonElement)functionCall.Arguments["location"]).GetString());
    }
    ...
    public async Task IChatClient_GetStreamingResponseAsync_WithToolUse()
    {
        ...
        Assert.NotNull(functionCall.Arguments);
        Assert.Null(functionCall.Exception);
        Assert.Equal("Seattle", ((System.Text.Json.JsonElement)functionCall.Arguments["location"]).GetString());
