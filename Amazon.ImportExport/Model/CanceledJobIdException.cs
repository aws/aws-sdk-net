...
namespace Amazon.ImportExport.Model
{
    ...
    public class CanceledJobIdException : AmazonImportExportException 
    {
        ...
        internal CanceledJobIdException(string message, Exception innerException) 
        ...
        internal CanceledJobIdException(string message, ErrorType errorType, string errorCode, string RequestId, HttpStatusCode statusCode) 
