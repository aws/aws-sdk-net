...
namespace Amazon.ImportExport.Model.Transform
{
     ...
     /// </summary>
    internal class ListJobsResultUnmarshaller : IUnmarshaller<ListJobsResult, UnmarshallerContext> 
    {
        public ListJobsResult Unmarshall(UnmarshallerContext context) 
        {
