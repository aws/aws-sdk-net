...
namespace Amazon.ImportExport.Model.Transform
{
     ...
     /// </summary>
    internal class CancelJobResultUnmarshaller : IUnmarshaller<CancelJobResult, UnmarshallerContext> 
    {
        public CancelJobResult Unmarshall(UnmarshallerContext context) 
        {
