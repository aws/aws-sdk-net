...
namespace Amazon.ImportExport.Model.Transform
{
     ...
     /// </summary>
    internal class GetStatusResultUnmarshaller : IUnmarshaller<GetStatusResult, UnmarshallerContext> 
    {
        public GetStatusResult Unmarshall(UnmarshallerContext context) 
        {
