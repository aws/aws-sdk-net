...
namespace Amazon.ImportExport.Model.Transform
{
    ...
    /// </summary>       
    public class CreateJobRequestMarshaller : IMarshaller<IRequest<CreateJobRequest>, CreateJobRequest> 
    {

        public IRequest<CreateJobRequest> Marshall(CreateJobRequest createJobRequest) 
        {
            IRequest<CreateJobRequest> request = new DefaultRequest<CreateJobRequest>(createJobRequest, "AmazonImportExport");
