...
namespace Amazon.ImportExport.Model.Transform
{
    ...
    /// </summary>       
    public class UpdateJobRequestMarshaller : IMarshaller<IRequest<UpdateJobRequest>, UpdateJobRequest> 
    {

        public IRequest<UpdateJobRequest> Marshall(UpdateJobRequest updateJobRequest) 
        {
            IRequest<UpdateJobRequest> request = new DefaultRequest<UpdateJobRequest>(updateJobRequest, "AmazonImportExport");
