...
namespace Amazon.ImportExport.Model.Transform
{
     ...
     /// </summary>
    internal class CreateJobResultUnmarshaller : IUnmarshaller<CreateJobResult, UnmarshallerContext> 
    {
        public CreateJobResult Unmarshall(UnmarshallerContext context) 
        {
