 ...
 */
    ...
    namespace Amazon.CloudTrail.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DeleteTrailResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,DeleteTrailResponse response)
        {
        ...
        private static DeleteTrailResponseUnmarshaller instance;
        public static DeleteTrailResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DeleteTrailResponseUnmarshaller();
          }
          return instance;
        }
