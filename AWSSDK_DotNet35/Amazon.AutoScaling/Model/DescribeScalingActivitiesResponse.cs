...
{
    /// <summary>
    /// Returns information about the  DescribeScalingActivities response and response metadata.
    /// </summary>
    public class DescribeScalingActivitiesResponse : DescribeScalingActivitiesResult
    {
        /// <summary>
