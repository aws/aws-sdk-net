...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    public class CreateLaunchConfigurationRequestMarshaller : IMarshaller<IRequest, CreateLaunchConfigurationRequest>
    {
        public IRequest Marshall(CreateLaunchConfigurationRequest createLaunchConfigurationRequest)
        {
            ...
            if (createLaunchConfigurationRequest != null && createLaunchConfigurationRequest.IsSetPlacementTenancy())
            {
                request.Parameters.Add("PlacementTenancy", StringUtils.FromString(createLaunchConfigurationRequest.PlacementTenancy));
            }
