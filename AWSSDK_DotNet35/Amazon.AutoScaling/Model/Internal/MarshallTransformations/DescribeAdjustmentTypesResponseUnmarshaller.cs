...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeAdjustmentTypesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeAdjustmentTypesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.AdjustmentTypes.Add(AdjustmentTypeUnmarshaller.GetInstance().Unmarshall(context));
