...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeNotificationConfigurationsRequestMarshaller : IMarshaller<IRequest, DescribeNotificationConfigurationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DescribeNotificationConfigurationsRequest)input);
        }
