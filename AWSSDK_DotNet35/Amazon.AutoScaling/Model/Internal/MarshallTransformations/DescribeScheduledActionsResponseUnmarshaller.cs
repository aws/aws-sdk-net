...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeScheduledActionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeScheduledActionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.ScheduledUpdateGroupActions.Add(ScheduledUpdateGroupActionUnmarshaller.GetInstance().Unmarshall(context));
