...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExitStandbyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ExitStandbyResponse response = new ExitStandbyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ExitStandbyResult", 2))
                    {
        ...
        private static ExitStandbyResponseUnmarshaller _instance = new ExitStandbyResponseUnmarshaller();        

        internal static ExitStandbyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ExitStandbyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
