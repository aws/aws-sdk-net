...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeScalingProcessTypesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeScalingProcessTypesResponseUnmarshaller _instance = new DescribeScalingProcessTypesResponseUnmarshaller();        

        internal static DescribeScalingProcessTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeScalingProcessTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
