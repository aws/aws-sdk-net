...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeAutoScalingNotificationTypesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeAutoScalingNotificationTypesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.AutoScalingNotificationTypes.Add(StringUnmarshaller.GetInstance().Unmarshall(context));
