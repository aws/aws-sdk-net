...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLifecycleHookResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            DeleteLifecycleHookResponse response = new DeleteLifecycleHookResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteLifecycleHookResult", 2))
                    {
        ...
        private static DeleteLifecycleHookResponseUnmarshaller _instance = new DeleteLifecycleHookResponseUnmarshaller();        

        internal static DeleteLifecycleHookResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteLifecycleHookResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
