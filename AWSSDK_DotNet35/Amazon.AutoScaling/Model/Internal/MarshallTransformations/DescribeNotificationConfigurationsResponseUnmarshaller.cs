...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeNotificationConfigurationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeNotificationConfigurationsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.NotificationConfigurations.Add(NotificationConfigurationUnmarshaller.GetInstance().Unmarshall(context));
