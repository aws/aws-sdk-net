...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuiteUnmarshaller : IUnmarshaller<Suite, XmlUnmarshallerContext>, IUnmarshaller<Suite, JsonUnmarshallerContext>
    {
        Suite IUnmarshaller<Suite, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
            throw new NotImplementedException();
        }

        public Suite Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
