...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static GetTestResponseUnmarshaller _instance = new GetTestResponseUnmarshaller();        

        internal static GetTestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetTestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
