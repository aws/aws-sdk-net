...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListUniqueProblemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ListUniqueProblemsResponseUnmarshaller _instance = new ListUniqueProblemsResponseUnmarshaller();        

        internal static ListUniqueProblemsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListUniqueProblemsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
