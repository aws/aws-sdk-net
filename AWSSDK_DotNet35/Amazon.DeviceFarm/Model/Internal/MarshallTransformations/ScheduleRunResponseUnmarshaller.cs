...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduleRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ScheduleRunResponse response = new ScheduleRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = RunUnmarshaller.Instance;
                    response.Run = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new IdempotencyException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static ScheduleRunResponseUnmarshaller _instance = new ScheduleRunResponseUnmarshaller();        

        internal static ScheduleRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ScheduleRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
