...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSamplesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Sample, SampleUnmarshaller>(SampleUnmarshaller.Instance);
                    response.Samples = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListSamplesResponseUnmarshaller _instance = new ListSamplesResponseUnmarshaller();        

        internal static ListSamplesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListSamplesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
