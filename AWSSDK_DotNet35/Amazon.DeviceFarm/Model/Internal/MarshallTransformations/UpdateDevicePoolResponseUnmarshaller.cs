...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDevicePoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            UpdateDevicePoolResponse response = new UpdateDevicePoolResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("devicePool", targetDepth))
                {
                    var unmarshaller = DevicePoolUnmarshaller.Instance;
                    response.DevicePool = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateDevicePoolResponseUnmarshaller _instance = new UpdateDevicePoolResponseUnmarshaller();        

        internal static UpdateDevicePoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateDevicePoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
