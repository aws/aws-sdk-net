...
namespace Amazon.Runtime.Internal.Auth
{
    ...
    public abstract class AbstractAWSSigner
    {
        ...
        /// </summary>
        protected string ComputeHash(string data, string secretkey, SigningAlgorithm algorithm)
        {
            try 
            {
        ...
        /// Computes RFC 2104-compliant HMAC signature.
        /// </summary>
        protected string ComputeHash(byte[] data, string secretkey, SigningAlgorithm algorithm)
        {
            try
            {
                string signature = CryptoUtilFactory.CryptoInstance.HMACSign(data, secretkey, algorithm);
        ...
        public abstract void Sign(IRequest request, ClientConfig clientConfig, string awsAccessKeyId, string awsSecretAccessKey);
