...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteTrafficPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("TrafficPolicyInUse"))
            {
                return new TrafficPolicyInUseException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        public static DeleteTrafficPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
