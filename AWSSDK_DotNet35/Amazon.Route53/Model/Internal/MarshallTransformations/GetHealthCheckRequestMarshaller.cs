...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetHealthCheckRequestMarshaller : IMarshaller<IRequest, GetHealthCheckRequest>
    {
        
    
        public IRequest Marshall(GetHealthCheckRequest getHealthCheckRequest)
        {
            IRequest request = new DefaultRequest(getHealthCheckRequest, "AmazonRoute53");
