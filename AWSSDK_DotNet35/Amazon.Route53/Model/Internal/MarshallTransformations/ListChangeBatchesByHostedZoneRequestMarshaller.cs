...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListChangeBatchesByHostedZoneRequestMarshaller : IMarshaller<IRequest, ListChangeBatchesByHostedZoneRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((ListChangeBatchesByHostedZoneRequest)input);
        }

        public IRequest Marshall(ListChangeBatchesByHostedZoneRequest publicRequest)
        {
