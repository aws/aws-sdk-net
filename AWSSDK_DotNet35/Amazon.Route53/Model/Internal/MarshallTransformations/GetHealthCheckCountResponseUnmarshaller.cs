    ...
    public class GetHealthCheckCountResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetHealthCheckCountResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("HealthCheckCount", targetDepth))
                    {
                        var unmarshaller = LongUnmarshaller.Instance;
                        response.HealthCheckCount = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        public static GetHealthCheckCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
