...
{
    /// <summary>
    /// Returns information about the  CreateLoadBalancerPolicy response and response metadata.
    /// </summary>
    public class CreateLoadBalancerPolicyResponse : CreateLoadBalancerPolicyResult
    {
        /// <summary>
