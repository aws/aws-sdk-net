...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public class InvalidInstanceException : AmazonElasticLoadBalancingException 
    {
        ...
        /// </param>
        internal InvalidInstanceException(string message) 
            : base(message) {}
          
        internal InvalidInstanceException(string message, Exception innerException) 
            : base(message, innerException) {}
            
        internal InvalidInstanceException(Exception innerException) 
            : base(innerException) {}
        ...
        internal InvalidInstanceException(string message, ErrorType errorType, string errorCode, string RequestId, HttpStatusCode statusCode) 
