...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    internal class ApplySecurityGroupsToLoadBalancerResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ApplySecurityGroupsToLoadBalancerResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.SecurityGroups.Add(StringUnmarshaller.GetInstance().Unmarshall(context));
