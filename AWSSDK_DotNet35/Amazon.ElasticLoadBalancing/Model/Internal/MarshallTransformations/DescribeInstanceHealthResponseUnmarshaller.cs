...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeInstanceHealthResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new InvalidEndPointException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DescribeInstanceHealthResponseUnmarshaller _instance = new DescribeInstanceHealthResponseUnmarshaller();        

        internal static DescribeInstanceHealthResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeInstanceHealthResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
