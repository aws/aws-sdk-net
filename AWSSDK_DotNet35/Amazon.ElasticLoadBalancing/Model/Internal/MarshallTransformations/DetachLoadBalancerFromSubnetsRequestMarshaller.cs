...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetachLoadBalancerFromSubnetsRequestMarshaller : IMarshaller<IRequest, DetachLoadBalancerFromSubnetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DetachLoadBalancerFromSubnetsRequest)input);
        }
