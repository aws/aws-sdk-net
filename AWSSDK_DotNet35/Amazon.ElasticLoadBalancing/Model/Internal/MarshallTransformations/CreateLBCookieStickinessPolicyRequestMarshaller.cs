...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLBCookieStickinessPolicyRequestMarshaller : IMarshaller<IRequest, CreateLBCookieStickinessPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((CreateLBCookieStickinessPolicyRequest)input);
        }
