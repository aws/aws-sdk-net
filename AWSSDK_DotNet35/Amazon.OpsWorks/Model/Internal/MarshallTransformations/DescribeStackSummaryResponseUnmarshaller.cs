...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeStackSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeStackSummaryResponseUnmarshaller _instance = new DescribeStackSummaryResponseUnmarshaller();        

        internal static DescribeStackSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeStackSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
