...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeCommandsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeCommandsResponseUnmarshaller _instance = new DescribeCommandsResponseUnmarshaller();        

        internal static DescribeCommandsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeCommandsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
