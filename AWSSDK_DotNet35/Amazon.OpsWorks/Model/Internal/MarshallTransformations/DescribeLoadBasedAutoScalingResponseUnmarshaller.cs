...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLoadBasedAutoScalingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LoadBasedAutoScalingConfiguration, LoadBasedAutoScalingConfigurationUnmarshaller>(LoadBasedAutoScalingConfigurationUnmarshaller.Instance);
        ...
        private static DescribeLoadBasedAutoScalingResponseUnmarshaller _instance = new DescribeLoadBasedAutoScalingResponseUnmarshaller();        

        internal static DescribeLoadBasedAutoScalingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeLoadBasedAutoScalingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
