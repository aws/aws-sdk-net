 ...
 */
    ...
    namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class RegisterElasticIpResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static RegisterElasticIpResponseUnmarshaller instance;
        public static RegisterElasticIpResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new RegisterElasticIpResponseUnmarshaller();
          }
          return instance;
        }
