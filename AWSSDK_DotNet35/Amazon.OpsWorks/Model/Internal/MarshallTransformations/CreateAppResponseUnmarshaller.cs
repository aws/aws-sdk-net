...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class CreateAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateAppResponseUnmarshaller _instance = new CreateAppResponseUnmarshaller();        

        internal static CreateAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
