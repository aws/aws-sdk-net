 ...
 */
    ...
    namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
    {
      ...
      internal class CreateDeploymentResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,CreateDeploymentResponse response)
        {
            ...
            while (context.Read())
            {
              ...
              {
                context.Read();
                response.DeploymentId = StringUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
