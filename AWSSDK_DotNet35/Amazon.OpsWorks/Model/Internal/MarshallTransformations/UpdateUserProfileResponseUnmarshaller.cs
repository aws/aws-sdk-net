...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateUserProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static UpdateUserProfileResponseUnmarshaller _instance = new UpdateUserProfileResponseUnmarshaller();        

        internal static UpdateUserProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateUserProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
