 ...
 */
    ...
    namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DetachElasticLoadBalancerResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static DetachElasticLoadBalancerResponseUnmarshaller instance;
        public static DetachElasticLoadBalancerResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DetachElasticLoadBalancerResponseUnmarshaller();
          }
          return instance;
        }
