...
namespace Amazon.OpsWorks.Model
{
    ...
    public partial class CloneStackRequest : AmazonWebServiceRequest
    {
        ...
        /// <summary>
        /// The cloned stack default operating system, which must be set to one of the following. <ul> <li>Standard operating systems: <c>Amazon
        /// Linux</c> or <c>Ubuntu 12.04 LTS</c></li> <li>Custom AMIs: <c>Custom</c></li> </ul> The default option is <c>Amazon Linux</c>. If you set
        /// this parameter to <c>Custom</c>, you must use the <a>CreateInstance</a> action's AmiId parameter to specify the custom AMI that you want to
        /// use. For more information on the standard operating systems, see <a
