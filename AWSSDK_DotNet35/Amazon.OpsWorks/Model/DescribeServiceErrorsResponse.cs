...
{
    /// <summary>
    /// Returns information about the  DescribeServiceErrors response and response metadata.
    /// </summary>
    public class DescribeServiceErrorsResponse : DescribeServiceErrorsResult
    {
        /// <summary>
