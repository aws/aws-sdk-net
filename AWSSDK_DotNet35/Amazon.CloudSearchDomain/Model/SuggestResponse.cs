...
namespace Amazon.CloudSearchDomain.Model
{
    ...
    /// </summary>
    public partial class SuggestResponse : SuggestResult
    {
        /// <summary>
        /// Gets and sets the SuggestResult property.
        /// Represents the output of a Suggest operation.
        /// </summary>
        [Obsolete(@"This property has been deprecated. All properties of the SuggestResult class are now available on the SuggestResponse class. You should use the properties on SuggestResponse instead of accessing them through SuggestResult.")]
