...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterContainerInstanceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeregisterContainerInstanceResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeregisterContainerInstanceResponse response)
        {
