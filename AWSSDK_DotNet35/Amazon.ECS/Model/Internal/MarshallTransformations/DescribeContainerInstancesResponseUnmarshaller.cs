...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeContainerInstancesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeContainerInstancesResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeContainerInstancesResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("containerInstances/member", targetDepth))
                    {
                        var unmarshaller = ContainerInstanceUnmarshaller.Instance;
                        var item = unmarshaller.Unmarshall(context);
                        response.ContainerInstances.Add(item);
                        continue;
                    }
