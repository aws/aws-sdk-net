...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTaskDefinitionFamiliesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ListTaskDefinitionFamiliesResponse response = new ListTaskDefinitionFamiliesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("families", targetDepth))
                {
                    ...
                    response.Families = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListTaskDefinitionFamiliesResponseUnmarshaller _instance = new ListTaskDefinitionFamiliesResponseUnmarshaller();        

        internal static ListTaskDefinitionFamiliesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListTaskDefinitionFamiliesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
