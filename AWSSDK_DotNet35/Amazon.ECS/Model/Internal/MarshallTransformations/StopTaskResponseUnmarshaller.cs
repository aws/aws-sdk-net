...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopTaskResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            StopTaskResponse response = new StopTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("StopTaskResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, StopTaskResponse response)
        {
        ...
        private static StopTaskResponseUnmarshaller _instance = new StopTaskResponseUnmarshaller();        

        internal static StopTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static StopTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
