...
{
    /// <summary>
    /// <para>This contains a ClusterSummaryList with the cluster details; for example, the cluster IDs, names, and status.</para>
    /// </summary>
    public partial class ListClustersResult : AmazonWebServiceResponse
    {
        
        private List<ClusterSummary> clusters = new List<ClusterSummary>();
