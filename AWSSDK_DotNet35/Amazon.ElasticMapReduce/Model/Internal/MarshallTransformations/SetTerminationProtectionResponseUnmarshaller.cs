...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class SetTerminationProtectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static SetTerminationProtectionResponseUnmarshaller _instance = new SetTerminationProtectionResponseUnmarshaller();        

        internal static SetTerminationProtectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static SetTerminationProtectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
