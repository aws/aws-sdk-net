...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddInstanceGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static AddInstanceGroupsResponseUnmarshaller _instance = new AddInstanceGroupsResponseUnmarshaller();        

        internal static AddInstanceGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static AddInstanceGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
