 ...
 */
    ...
    namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class ListInstanceGroupsResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
              ...
              if (context.TestExpression("InstanceGroups", targetDepth))
              {
                ...
                var unmarshaller = new ListUnmarshaller<InstanceGroup,InstanceGroupUnmarshaller>(
                    InstanceGroupUnmarshaller.GetInstance());                  
