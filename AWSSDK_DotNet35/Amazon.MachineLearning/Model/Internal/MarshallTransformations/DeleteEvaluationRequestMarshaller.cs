...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteEvaluationRequestMarshaller : IMarshaller<IRequest, DeleteEvaluationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DeleteEvaluationRequest)input);
        }

        public IRequest Marshall(DeleteEvaluationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MachineLearning");
            string target = "AmazonML_20141212.DeleteEvaluation";
