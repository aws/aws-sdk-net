...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDataSourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            DescribeDataSourcesResponse response = new DescribeDataSourcesResponse();
        ...
        private static DescribeDataSourcesResponseUnmarshaller _instance = new DescribeDataSourcesResponseUnmarshaller();        

        internal static DescribeDataSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeDataSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
