...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBatchPredictionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            CreateBatchPredictionResponse response = new CreateBatchPredictionResponse();
        ...
        private static CreateBatchPredictionResponseUnmarshaller _instance = new CreateBatchPredictionResponseUnmarshaller();        

        internal static CreateBatchPredictionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateBatchPredictionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
