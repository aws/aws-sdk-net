 ...
 */
    ...
    namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DescribeStreamResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static DescribeStreamResponseUnmarshaller instance;
        public static DescribeStreamResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeStreamResponseUnmarshaller();
          }
          return instance;
        }
