 ...
 */
    ...
    namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class SplitShardResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static SplitShardResponseUnmarshaller instance;
        public static SplitShardResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new SplitShardResponseUnmarshaller();
          }
          return instance;
        }
