...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSSHPublicKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            UpdateSSHPublicKeyResponse response = new UpdateSSHPublicKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateSSHPublicKeyResult", 2))
                    {
        ...
        private static UpdateSSHPublicKeyResponseUnmarshaller _instance = new UpdateSSHPublicKeyResponseUnmarshaller();        

        internal static UpdateSSHPublicKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateSSHPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
