...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class UpdateAccountPasswordPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static UpdateAccountPasswordPolicyResponseUnmarshaller instance;

        public static UpdateAccountPasswordPolicyResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateAccountPasswordPolicyResponseUnmarshaller();
            }
            return instance;
        }
