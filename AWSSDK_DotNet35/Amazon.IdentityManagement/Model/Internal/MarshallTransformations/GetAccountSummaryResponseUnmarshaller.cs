...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAccountSummaryResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static GetAccountSummaryResponseUnmarshaller _instance = new GetAccountSummaryResponseUnmarshaller();        

        internal static GetAccountSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetAccountSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
