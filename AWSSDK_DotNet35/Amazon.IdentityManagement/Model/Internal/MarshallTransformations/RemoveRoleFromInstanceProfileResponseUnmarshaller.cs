...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveRoleFromInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            RemoveRoleFromInstanceProfileResponse response = new RemoveRoleFromInstanceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RemoveRoleFromInstanceProfileResult", 2))
                    {
        ...
        private static RemoveRoleFromInstanceProfileResponseUnmarshaller _instance = new RemoveRoleFromInstanceProfileResponseUnmarshaller();        

        internal static RemoveRoleFromInstanceProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RemoveRoleFromInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
