...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListUserPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListUserPoliciesResponseUnmarshaller _instance = new ListUserPoliciesResponseUnmarshaller();        

        internal static ListUserPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListUserPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
