...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateAssumeRolePolicyRequestMarshaller : IMarshaller<IRequest, UpdateAssumeRolePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((UpdateAssumeRolePolicyRequest)input);
        }
    
        public IRequest Marshall(UpdateAssumeRolePolicyRequest publicRequest)
        {
