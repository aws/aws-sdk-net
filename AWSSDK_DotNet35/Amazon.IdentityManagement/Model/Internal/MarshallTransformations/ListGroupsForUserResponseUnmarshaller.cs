...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class ListGroupsForUserResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListGroupsForUserResponseUnmarshaller _instance = new ListGroupsForUserResponseUnmarshaller();        

        internal static ListGroupsForUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListGroupsForUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
