...
{
    /// <summary>
    /// Response Unmarshaller for UploadPublicAccessKey operation
    /// </summary>  
    public class UploadPublicAccessKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            UploadPublicAccessKeyResponse response = new UploadPublicAccessKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UploadPublicAccessKeyResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UploadPublicAccessKeyResponse response)
        {
        ...
        private static UploadPublicAccessKeyResponseUnmarshaller _instance = new UploadPublicAccessKeyResponseUnmarshaller();        

        internal static UploadPublicAccessKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UploadPublicAccessKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
