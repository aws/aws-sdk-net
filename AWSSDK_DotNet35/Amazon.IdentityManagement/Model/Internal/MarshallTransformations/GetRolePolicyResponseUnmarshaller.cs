...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    internal class GetRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,GetRolePolicyResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.RoleName = StringUnmarshaller.GetInstance().Unmarshall(context);
