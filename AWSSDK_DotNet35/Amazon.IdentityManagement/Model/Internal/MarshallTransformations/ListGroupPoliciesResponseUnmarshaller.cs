...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGroupPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListGroupPoliciesResponseUnmarshaller _instance = new ListGroupPoliciesResponseUnmarshaller();        

        internal static ListGroupPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListGroupPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
