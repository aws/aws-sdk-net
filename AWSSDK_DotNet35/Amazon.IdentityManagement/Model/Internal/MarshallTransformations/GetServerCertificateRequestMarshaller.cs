...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetServerCertificateRequestMarshaller : IMarshaller<IRequest, GetServerCertificateRequest>
    {
        public IRequest Marshall(GetServerCertificateRequest publicRequest)
        {
