...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveUserFromGroupRequestMarshaller : IMarshaller<IRequest, RemoveUserFromGroupRequest>
    {
        public IRequest Marshall(RemoveUserFromGroupRequest removeUserFromGroupRequest)
        {
            IRequest request = new DefaultRequest(removeUserFromGroupRequest, "AmazonIdentityManagementService");
