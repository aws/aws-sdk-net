...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListInstanceProfilesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListInstanceProfilesResponseUnmarshaller _instance = new ListInstanceProfilesResponseUnmarshaller();        

        internal static ListInstanceProfilesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListInstanceProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
