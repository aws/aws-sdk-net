...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    internal class CreateAccessKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,CreateAccessKeyResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.AccessKey = AccessKeyUnmarshaller.GetInstance().Unmarshall(context);
