...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class UpdateServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static UpdateServerCertificateResponseUnmarshaller instance;

        public static UpdateServerCertificateResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateServerCertificateResponseUnmarshaller();
            }
            return instance;
        }
