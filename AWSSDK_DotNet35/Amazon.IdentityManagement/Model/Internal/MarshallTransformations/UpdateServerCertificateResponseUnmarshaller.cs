...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            UpdateServerCertificateResponse response = new UpdateServerCertificateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateServerCertificateResult", 2))
                    {
        ...
        private static UpdateServerCertificateResponseUnmarshaller _instance = new UpdateServerCertificateResponseUnmarshaller();        

        internal static UpdateServerCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateServerCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
