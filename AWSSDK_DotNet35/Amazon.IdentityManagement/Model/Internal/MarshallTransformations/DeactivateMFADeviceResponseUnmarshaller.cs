...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeactivateMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeactivateMFADeviceResult", 2))
                    {
        ...
        private static DeactivateMFADeviceResponseUnmarshaller _instance = new DeactivateMFADeviceResponseUnmarshaller();        

        internal static DeactivateMFADeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeactivateMFADeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
