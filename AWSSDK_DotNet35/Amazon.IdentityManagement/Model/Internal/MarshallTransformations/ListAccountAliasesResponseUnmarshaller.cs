...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    internal class ListAccountAliasesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListAccountAliasesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.AccountAliases.Add(StringUnmarshaller.GetInstance().Unmarshall(context));
