...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class AddRoleToInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static AddRoleToInstanceProfileResponseUnmarshaller instance;

        public static AddRoleToInstanceProfileResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new AddRoleToInstanceProfileResponseUnmarshaller();
            }
            return instance;
        }
