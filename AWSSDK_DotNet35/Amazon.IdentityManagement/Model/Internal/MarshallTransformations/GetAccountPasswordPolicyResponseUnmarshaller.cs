...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    internal class GetAccountPasswordPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,GetAccountPasswordPolicyResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.PasswordPolicy = PasswordPolicyUnmarshaller.GetInstance().Unmarshall(context);
