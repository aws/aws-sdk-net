...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    internal class ListVirtualMFADevicesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListVirtualMFADevicesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.VirtualMFADevices.Add(VirtualMFADeviceUnmarshaller.GetInstance().Unmarshall(context));
