...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteServerCertificateResult", 2))
                    {
        ...
        private static DeleteServerCertificateResponseUnmarshaller _instance = new DeleteServerCertificateResponseUnmarshaller();        

        internal static DeleteServerCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteServerCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
