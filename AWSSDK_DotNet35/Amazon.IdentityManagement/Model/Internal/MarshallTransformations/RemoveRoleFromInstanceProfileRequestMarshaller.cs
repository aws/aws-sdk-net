...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveRoleFromInstanceProfileRequestMarshaller : IMarshaller<IRequest, RemoveRoleFromInstanceProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((RemoveRoleFromInstanceProfileRequest)input);
        }
    
        public IRequest Marshall(RemoveRoleFromInstanceProfileRequest publicRequest)
        {
