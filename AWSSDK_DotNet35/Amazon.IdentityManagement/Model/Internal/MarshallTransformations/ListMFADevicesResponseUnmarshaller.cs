...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListMFADevicesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListMFADevicesResponseUnmarshaller _instance = new ListMFADevicesResponseUnmarshaller();        

        internal static ListMFADevicesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListMFADevicesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
