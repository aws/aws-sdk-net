...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class ListSAMLProvidersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListSAMLProvidersResponseUnmarshaller _instance = new ListSAMLProvidersResponseUnmarshaller();        

        internal static ListSAMLProvidersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListSAMLProvidersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
