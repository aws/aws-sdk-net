...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CreateVirtualMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,CreateVirtualMFADeviceResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.VirtualMFADevice = VirtualMFADeviceUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static CreateVirtualMFADeviceResponseUnmarshaller instance;

        public static CreateVirtualMFADeviceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateVirtualMFADeviceResponseUnmarshaller();
            }
            return instance;
        }
