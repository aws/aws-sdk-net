...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVirtualMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            DeleteVirtualMFADeviceResponse response = new DeleteVirtualMFADeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteVirtualMFADeviceResult", 2))
                    {
        ...
        private static DeleteVirtualMFADeviceResponseUnmarshaller _instance = new DeleteVirtualMFADeviceResponseUnmarshaller();        

        internal static DeleteVirtualMFADeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteVirtualMFADeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
