...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteVirtualMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DeleteVirtualMFADeviceResponseUnmarshaller instance;

        public static DeleteVirtualMFADeviceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteVirtualMFADeviceResponseUnmarshaller();
            }
            return instance;
        }
