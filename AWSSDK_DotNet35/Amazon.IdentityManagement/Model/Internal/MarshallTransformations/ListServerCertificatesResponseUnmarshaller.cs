...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListServerCertificatesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListServerCertificatesResponseUnmarshaller _instance = new ListServerCertificatesResponseUnmarshaller();        

        internal static ListServerCertificatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListServerCertificatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
