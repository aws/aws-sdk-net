...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RemoveUserFromGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static RemoveUserFromGroupResponseUnmarshaller instance;

        public static RemoveUserFromGroupResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new RemoveUserFromGroupResponseUnmarshaller();
            }
            return instance;
        }
