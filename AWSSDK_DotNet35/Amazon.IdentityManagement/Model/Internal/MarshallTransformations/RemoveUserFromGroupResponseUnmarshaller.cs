...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveUserFromGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RemoveUserFromGroupResult", 2))
                    {
        ...
        private static RemoveUserFromGroupResponseUnmarshaller _instance = new RemoveUserFromGroupResponseUnmarshaller();        

        internal static RemoveUserFromGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RemoveUserFromGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
