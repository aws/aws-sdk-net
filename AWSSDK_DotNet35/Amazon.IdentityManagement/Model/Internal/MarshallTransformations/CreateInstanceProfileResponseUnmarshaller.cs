...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class CreateInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static CreateInstanceProfileResponseUnmarshaller _instance = new CreateInstanceProfileResponseUnmarshaller();        

        internal static CreateInstanceProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
