...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSAMLProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static UpdateSAMLProviderResponseUnmarshaller _instance = new UpdateSAMLProviderResponseUnmarshaller();        

        internal static UpdateSAMLProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateSAMLProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
