...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveClientIDFromOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            RemoveClientIDFromOpenIDConnectProviderResponse response = new RemoveClientIDFromOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RemoveClientIDFromOpenIDConnectProviderResult", 2))
                    {
        ...
        private static RemoveClientIDFromOpenIDConnectProviderResponseUnmarshaller _instance = new RemoveClientIDFromOpenIDConnectProviderResponseUnmarshaller();        

        internal static RemoveClientIDFromOpenIDConnectProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RemoveClientIDFromOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
