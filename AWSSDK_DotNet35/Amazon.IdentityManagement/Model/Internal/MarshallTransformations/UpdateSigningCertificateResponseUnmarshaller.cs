...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSigningCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateSigningCertificateResult", 2))
                    {
        ...
        private static UpdateSigningCertificateResponseUnmarshaller _instance = new UpdateSigningCertificateResponseUnmarshaller();        

        internal static UpdateSigningCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateSigningCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
