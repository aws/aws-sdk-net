...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class EnableSsoRequestMarshaller : IMarshaller<IRequest, EnableSsoRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((EnableSsoRequest)input);
        }

        public IRequest Marshall(EnableSsoRequest publicRequest)
        {
