...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeleteDirectoryResponseUnmarshaller _instance = new DeleteDirectoryResponseUnmarshaller();        

        internal static DeleteDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
