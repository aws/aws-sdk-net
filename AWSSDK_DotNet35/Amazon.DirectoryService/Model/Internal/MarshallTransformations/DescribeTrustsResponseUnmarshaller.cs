...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeTrustsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            DescribeTrustsResponse response = new DescribeTrustsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Trust, TrustUnmarshaller>(TrustUnmarshaller.Instance);
                    response.Trusts = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeTrustsResponseUnmarshaller _instance = new DescribeTrustsResponseUnmarshaller();        

        internal static DescribeTrustsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeTrustsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
