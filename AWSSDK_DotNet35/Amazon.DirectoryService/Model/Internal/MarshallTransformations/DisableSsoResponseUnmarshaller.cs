...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableSsoResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            DisableSsoResponse response = new DisableSsoResponse();
        ...
        private static DisableSsoResponseUnmarshaller _instance = new DisableSsoResponseUnmarshaller();        

        internal static DisableSsoResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DisableSsoResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
