...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTrustResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            CreateTrustResponse response = new CreateTrustResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("TrustId", targetDepth))
                {
                    ...
                    response.TrustId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateTrustResponseUnmarshaller _instance = new CreateTrustResponseUnmarshaller();        

        internal static CreateTrustResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateTrustResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
