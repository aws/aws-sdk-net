...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableRadiusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            DisableRadiusResponse response = new DisableRadiusResponse();
        ...
        private static DisableRadiusResponseUnmarshaller _instance = new DisableRadiusResponseUnmarshaller();        

        internal static DisableRadiusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DisableRadiusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
