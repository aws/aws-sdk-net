...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ConnectDirectoryResponse response = new ConnectDirectoryResponse();
        ...
        private static ConnectDirectoryResponseUnmarshaller _instance = new ConnectDirectoryResponseUnmarshaller();        

        internal static ConnectDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ConnectDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
