...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSnapshotLimitsRequestMarshaller : IMarshaller<IRequest, GetSnapshotLimitsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((GetSnapshotLimitsRequest)input);
        }

        public IRequest Marshall(GetSnapshotLimitsRequest publicRequest)
        {
