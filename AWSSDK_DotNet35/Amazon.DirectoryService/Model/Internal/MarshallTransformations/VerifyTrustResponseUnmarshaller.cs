...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerifyTrustResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            VerifyTrustResponse response = new VerifyTrustResponse();
        ...
        private static VerifyTrustResponseUnmarshaller _instance = new VerifyTrustResponseUnmarshaller();        

        internal static VerifyTrustResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static VerifyTrustResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
