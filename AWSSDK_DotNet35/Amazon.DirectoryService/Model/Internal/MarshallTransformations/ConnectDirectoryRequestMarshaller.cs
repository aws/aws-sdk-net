...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ConnectDirectoryRequestMarshaller : IMarshaller<IRequest, ConnectDirectoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((ConnectDirectoryRequest)input);
        }

        public IRequest Marshall(ConnectDirectoryRequest publicRequest)
        {
