...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDirectoriesRequestMarshaller : IMarshaller<IRequest, DescribeDirectoriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DescribeDirectoriesRequest)input);
        }

        public IRequest Marshall(DescribeDirectoriesRequest publicRequest)
        {
