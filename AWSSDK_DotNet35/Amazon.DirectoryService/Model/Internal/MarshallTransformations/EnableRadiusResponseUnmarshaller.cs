...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnableRadiusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            EnableRadiusResponse response = new EnableRadiusResponse();
        ...
        private static EnableRadiusResponseUnmarshaller _instance = new EnableRadiusResponseUnmarshaller();        

        internal static EnableRadiusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static EnableRadiusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
