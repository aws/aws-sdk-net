...
{
    /// <summary>
    /// Returns information about the  DeleteBandwidthRateLimit response and response metadata.
    /// </summary>
    public class DeleteBandwidthRateLimitResponse : DeleteBandwidthRateLimitResult
    {
        /// <summary>
