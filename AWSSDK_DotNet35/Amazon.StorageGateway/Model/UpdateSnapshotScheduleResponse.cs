...
{
    /// <summary>
    /// Returns information about the  UpdateSnapshotSchedule response and response metadata.
    /// </summary>
    public class UpdateSnapshotScheduleResponse : UpdateSnapshotScheduleResult
    {
        /// <summary>
