...
{
    /// <summary>
    /// Configuration for accessing Amazon DescribeCachediSCSIVolumes service
    /// </summary>
    public partial class DescribeCachediSCSIVolumesResponse : DescribeCachediSCSIVolumesResult
    {
        /// <summary>
        /// Gets and sets the DescribeCachediSCSIVolumesResult property.
        /// Represents the output of a DescribeCachediSCSIVolumes operation.
        /// </summary>
