...
{
    /// <summary>
    /// Returns information about the  CreateCachediSCSIVolume response and response metadata.
    /// </summary>
    public class CreateCachediSCSIVolumeResponse : CreateCachediSCSIVolumeResult
    {
        /// <summary>
