...
{
    /// <summary>
    /// Returns information about the  DeleteChapCredentials response and response metadata.
    /// </summary>
    public class DeleteChapCredentialsResponse : DeleteChapCredentialsResult
    {
        /// <summary>
