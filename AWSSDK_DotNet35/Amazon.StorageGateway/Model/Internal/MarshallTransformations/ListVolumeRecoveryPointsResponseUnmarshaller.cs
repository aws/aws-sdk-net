...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVolumeRecoveryPointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<VolumeRecoveryPointInfo, VolumeRecoveryPointInfoUnmarshaller>(VolumeRecoveryPointInfoUnmarshaller.Instance);
        ...
        private static ListVolumeRecoveryPointsResponseUnmarshaller _instance = new ListVolumeRecoveryPointsResponseUnmarshaller();        

        internal static ListVolumeRecoveryPointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListVolumeRecoveryPointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
