...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateBandwidthRateLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static UpdateBandwidthRateLimitResponseUnmarshaller _instance = new UpdateBandwidthRateLimitResponseUnmarshaller();        

        internal static UpdateBandwidthRateLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateBandwidthRateLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
