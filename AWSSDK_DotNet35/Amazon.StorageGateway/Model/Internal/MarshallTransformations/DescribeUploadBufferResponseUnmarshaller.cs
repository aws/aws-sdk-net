 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DescribeUploadBufferResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private void UnmarshallResult(JsonUnmarshallerContext context,DescribeUploadBufferResponse response)
        {
        ...
        private static DescribeUploadBufferResponseUnmarshaller instance;
        public static DescribeUploadBufferResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeUploadBufferResponseUnmarshaller();
          }
          return instance;
        }
