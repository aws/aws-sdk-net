 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class CreateTapesResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          CreateTapesResponse response = new CreateTapesResponse();          
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,CreateTapesResponse response)
        {
            ...
            while (context.Read())
            {
              ...
              {
                context.Read();
                response.TapeARNs = new List<String>();
                ...
                while (context.Read())
                {
                  ...
                  if (token == JsonToken.ArrayEnd)
                  {
                   ...
                   response.TapeARNs.Add(unmarshaller.Unmarshall(context));
                }
                continue;
              }
        ...
        private static CreateTapesResponseUnmarshaller instance;
