...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTapesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("TapeARNs", targetDepth))
                {
                    ...
                    response.TapeARNs = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateTapesResponseUnmarshaller _instance = new CreateTapesResponseUnmarshaller();        

        internal static CreateTapesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateTapesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
