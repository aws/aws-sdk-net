 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class CancelArchivalResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,CancelArchivalResponse response)
        {
        ...
        private static CancelArchivalResponseUnmarshaller instance;
        public static CancelArchivalResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new CancelArchivalResponseUnmarshaller();
          }
          return instance;
        }
