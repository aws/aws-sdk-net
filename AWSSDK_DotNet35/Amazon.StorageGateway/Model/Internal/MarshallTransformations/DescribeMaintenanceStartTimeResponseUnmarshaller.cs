 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DescribeMaintenanceStartTimeResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private void UnmarshallResult(JsonUnmarshallerContext context,DescribeMaintenanceStartTimeResponse response)
        {
        ...
        private static DescribeMaintenanceStartTimeResponseUnmarshaller instance;
        public static DescribeMaintenanceStartTimeResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeMaintenanceStartTimeResponseUnmarshaller();
          }
          return instance;
        }
