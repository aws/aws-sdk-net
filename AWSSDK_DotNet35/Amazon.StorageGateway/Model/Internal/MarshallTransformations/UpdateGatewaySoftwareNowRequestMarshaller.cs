...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    internal class UpdateGatewaySoftwareNowRequestMarshaller : IMarshaller<IRequest, UpdateGatewaySoftwareNowRequest> 
    {
        

        public IRequest Marshall(UpdateGatewaySoftwareNowRequest updateGatewaySoftwareNowRequest) 
        {
            ...
            using (StringWriter stringWriter = new StringWriter(System.Globalization.CultureInfo.InvariantCulture))
            {
                ...
                if (updateGatewaySoftwareNowRequest != null && updateGatewaySoftwareNowRequest.IsSetGatewayARN()) 
                {
                    writer.WritePropertyName("GatewayARN");
                    writer.Write(updateGatewaySoftwareNowRequest.GatewayARN);
                }
