 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class CreateSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private void UnmarshallResult(JsonUnmarshallerContext context,CreateSnapshotResponse response)
        {
        ...
        private static CreateSnapshotResponseUnmarshaller instance;
        public static CreateSnapshotResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new CreateSnapshotResponseUnmarshaller();
          }
          return instance;
        }
