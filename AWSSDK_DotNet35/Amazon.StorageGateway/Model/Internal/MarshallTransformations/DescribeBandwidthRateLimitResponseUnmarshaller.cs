...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeBandwidthRateLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeBandwidthRateLimitResponseUnmarshaller _instance = new DescribeBandwidthRateLimitResponseUnmarshaller();        

        internal static DescribeBandwidthRateLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeBandwidthRateLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
