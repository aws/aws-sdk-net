 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      internal class ListGatewaysResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,ListGatewaysResponse response)
        {
            ...
            while (context.Read())
            {
              ...
              {
                context.Read();
                response.Gateways = new List<GatewayInfo>();
                ...
                while (context.Read())
                {
                  ...
                  if (token == JsonToken.ArrayEnd)
                  {
                   ...
                   response.Gateways.Add(unmarshaller.Unmarshall(context));
                }
                continue;
              }
