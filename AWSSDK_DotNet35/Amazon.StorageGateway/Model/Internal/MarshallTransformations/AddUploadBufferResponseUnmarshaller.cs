 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class AddUploadBufferResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,AddUploadBufferResponse response)
        {
        ...
        private static AddUploadBufferResponseUnmarshaller instance;
        public static AddUploadBufferResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new AddUploadBufferResponseUnmarshaller();
          }
          return instance;
        }
