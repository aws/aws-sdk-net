 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class CreateStorediSCSIVolumeResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,CreateStorediSCSIVolumeResponse response)
        {
        ...
        private static CreateStorediSCSIVolumeResponseUnmarshaller instance;
        public static CreateStorediSCSIVolumeResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new CreateStorediSCSIVolumeResponseUnmarshaller();
          }
          return instance;
        }
