 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      internal class DescribeTapesResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,DescribeTapesResponse response)
        {
            ...
            while (context.Read())
            {
              ...
              {
                context.Read();
                response.Tapes = new List<Tape>();
                        TapeUnmarshaller unmarshaller = TapeUnmarshaller.GetInstance();
                while (context.Read())
                {
                  ...
                  if (token == JsonToken.ArrayEnd)
                  {
                   ...
                   response.Tapes.Add(unmarshaller.Unmarshall(context));
                }
                continue;
              }
