 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for DeleteGateway operation
      /// </summary>
      internal class DeleteGatewayResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private void UnmarshallResult(JsonUnmarshallerContext context,DeleteGatewayResponse response)
        {
        ...
        private static DeleteGatewayResponseUnmarshaller instance;
        public static DeleteGatewayResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DeleteGatewayResponseUnmarshaller();
          }
          return instance;
        }
