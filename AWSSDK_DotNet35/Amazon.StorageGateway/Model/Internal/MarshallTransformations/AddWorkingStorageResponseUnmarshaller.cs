 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class AddWorkingStorageResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,AddWorkingStorageResponse response)
        {
        ...
        private static AddWorkingStorageResponseUnmarshaller instance;
        public static AddWorkingStorageResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new AddWorkingStorageResponseUnmarshaller();
          }
          return instance;
        }
