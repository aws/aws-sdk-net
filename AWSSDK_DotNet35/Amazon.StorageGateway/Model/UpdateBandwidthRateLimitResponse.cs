...
{
    /// <summary>
    /// Returns information about the  UpdateBandwidthRateLimit response and response metadata.
    /// </summary>
    public class UpdateBandwidthRateLimitResponse : UpdateBandwidthRateLimitResult
    {
        /// <summary>
