...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    internal class DefineRankExpressionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DefineRankExpressionResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.RankExpression = RankExpressionStatusUnmarshaller.GetInstance().Unmarshall(context);
