...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class UpdateAvailabilityOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static UpdateAvailabilityOptionsResponseUnmarshaller instance;

        public static UpdateAvailabilityOptionsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateAvailabilityOptionsResponseUnmarshaller();
            }
            return instance;
        }
