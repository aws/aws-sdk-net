...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeSynonymOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeSynonymOptionsResponse response)
        {
        ...
        private static DescribeSynonymOptionsResponseUnmarshaller instance;

        public static DescribeSynonymOptionsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeSynonymOptionsResponseUnmarshaller();
            }
            return instance;
        }
