...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeIndexFieldsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeIndexFieldsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.IndexFields.Add(IndexFieldStatusUnmarshaller.GetInstance().Unmarshall(context));
        ...
        private static DescribeIndexFieldsResponseUnmarshaller instance;
