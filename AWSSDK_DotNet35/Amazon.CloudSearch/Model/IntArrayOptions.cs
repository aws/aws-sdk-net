...
{
    /// <summary>
    /// <para>Options for a field that contains an array of 64-bit signed integers. Present if <c>IndexFieldType</c> specifies the field is of type
    /// <c>int-array</c> . All options are enabled by default.</para>
    /// </summary>
    public partial class IntArrayOptions
    {
        ...
        {
            get { return this.defaultValue ?? default(long); }
