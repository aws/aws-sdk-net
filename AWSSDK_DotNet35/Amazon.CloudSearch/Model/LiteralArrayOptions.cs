...
{
    /// <summary>
    /// <para>Options for a field that contains an array of literal strings. Present if <c>IndexFieldType</c> specifies the field is of type
    /// <c>literal-array</c> . All options are enabled by default.</para>
    /// </summary>
    public partial class LiteralArrayOptions
    {
