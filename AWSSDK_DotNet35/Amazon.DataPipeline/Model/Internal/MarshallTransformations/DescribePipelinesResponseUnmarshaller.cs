...
namespace Amazon.DataPipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribePipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribePipelinesResponseUnmarshaller _instance = new DescribePipelinesResponseUnmarshaller();        

        internal static DescribePipelinesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribePipelinesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
