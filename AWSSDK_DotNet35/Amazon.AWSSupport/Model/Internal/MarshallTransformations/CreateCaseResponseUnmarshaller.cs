 ...
 */
    ...
    namespace Amazon.AWSSupport.Model.Internal.MarshallTransformations
    {
      ...
      internal class CreateCaseResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private void UnmarshallResult(JsonUnmarshallerContext context,CreateCaseResponse response)
        {
            ...
            while (context.Read())
            {
              ...
              {
                context.Read();
                response.CaseId = StringUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
