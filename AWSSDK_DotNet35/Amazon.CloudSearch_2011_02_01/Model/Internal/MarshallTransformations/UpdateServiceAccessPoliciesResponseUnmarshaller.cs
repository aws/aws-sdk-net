...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateServiceAccessPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateServiceAccessPoliciesResponse response)
        {
        ...
        private static UpdateServiceAccessPoliciesResponseUnmarshaller _instance = new UpdateServiceAccessPoliciesResponseUnmarshaller();        

        internal static UpdateServiceAccessPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateServiceAccessPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
