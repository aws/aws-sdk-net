...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDefaultSearchFieldResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static UpdateDefaultSearchFieldResponseUnmarshaller _instance = new UpdateDefaultSearchFieldResponseUnmarshaller();        

        internal static UpdateDefaultSearchFieldResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateDefaultSearchFieldResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
