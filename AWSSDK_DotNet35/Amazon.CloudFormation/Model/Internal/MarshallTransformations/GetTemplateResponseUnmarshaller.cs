...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    internal class GetTemplateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,GetTemplateResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.TemplateBody = StringUnmarshaller.GetInstance().Unmarshall(context);
