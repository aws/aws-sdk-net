...
namespace Amazon.SQS
{
    ...
    AWS4Signer signer = new AWS4Signer();
        ...
        public AmazonSQSClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSQSConfig(), true, AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        public AmazonSQSClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSQSConfig(){RegionEndpoint = region}, true, AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        /// <summary>
        /// <para>The AddPermission action adds a permission to a queue for a specific principal. This allows for sharing access to the queue.</para>
        /// <para>When you create a queue, you have full control access rights for the queue. Only you (as owner of the queue) can grant or deny
        /// permissions to the queue. For more information about these permissions, see Shared Queues in the Amazon SQS Developer Guide.</para> <para>
        /// <c>AddPermission</c> writes an SQS-generated policy. If you want to write your own policy, use SetQueueAttributes to upload your policy. For
        /// more information about writing your own policy, see Appendix: The Access Policy Language in the Amazon SQS Developer Guide.</para>
        /// </summary>
        /// 
        ...
        /// more than a total visibility timeout of 12 hours. (For more information visibility timeout, see Visibility Timeout in the Amazon SQS
