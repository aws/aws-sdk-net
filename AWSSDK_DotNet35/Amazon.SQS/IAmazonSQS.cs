...
namespace Amazon.SQS
{
    ...
    public partial interface IAmazonSQS : IDisposable
    {
        ...
        /// The queue referred to does not exist.
        /// </exception>
        ListDeadLetterSourceQueuesResponse ListDeadLetterSourceQueues(string queueUrl);
        ...
        /// been reached.
        /// </exception>
        ReceiveMessageResponse ReceiveMessage(string queueUrl, int maxNumberOfMessages);
