...
namespace Amazon.SQS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ListQueuesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListQueuesResponse response)
        {
        ...
        private static ListQueuesResponseUnmarshaller instance;

        public static ListQueuesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ListQueuesResponseUnmarshaller();
            }
            return instance;
        }
