...
{
    /// <summary>
    /// Returns information about the  DescribeVirtualGateways response and response metadata.
    /// </summary>
    public class DescribeVirtualGatewaysResponse : DescribeVirtualGatewaysResult
    {
        /// <summary>
