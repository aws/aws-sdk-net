 ...
 */
    ...
    namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DeleteInterconnectResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static void UnmarshallResult(JsonUnmarshallerContext context,DeleteInterconnectResponse response)
        {
        ...
        private static DeleteInterconnectResponseUnmarshaller instance;
        public static DeleteInterconnectResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DeleteInterconnectResponseUnmarshaller();
          }
          return instance;
        }
