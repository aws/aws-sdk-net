...
namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeVirtualGatewaysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeVirtualGatewaysResponseUnmarshaller _instance = new DescribeVirtualGatewaysResponseUnmarshaller();        

        internal static DescribeVirtualGatewaysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeVirtualGatewaysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
