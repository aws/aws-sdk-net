...
namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    internal class DescribeLocationsRequestMarshaller : IMarshaller<IRequest, DescribeLocationsRequest> 
    {
        

        public IRequest Marshall(DescribeLocationsRequest describeLocationsRequest) 
        {

            IRequest request = new DefaultRequest(describeLocationsRequest, "AmazonDirectConnect");
