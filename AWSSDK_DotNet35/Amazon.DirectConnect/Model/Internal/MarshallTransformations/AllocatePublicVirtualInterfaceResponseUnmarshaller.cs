 ...
 */
    ...
    namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class AllocatePublicVirtualInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static AllocatePublicVirtualInterfaceResponseUnmarshaller instance;
        public static AllocatePublicVirtualInterfaceResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new AllocatePublicVirtualInterfaceResponseUnmarshaller();
          }
          return instance;
        }
