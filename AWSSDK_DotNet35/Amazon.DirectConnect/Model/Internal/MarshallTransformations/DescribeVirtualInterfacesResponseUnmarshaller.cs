...
namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeVirtualInterfacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeVirtualInterfacesResponseUnmarshaller _instance = new DescribeVirtualInterfacesResponseUnmarshaller();        

        internal static DescribeVirtualInterfacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeVirtualInterfacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
