...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GrantToken = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateGrantResponseUnmarshaller _instance = new CreateGrantResponseUnmarshaller();        

        internal static CreateGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
