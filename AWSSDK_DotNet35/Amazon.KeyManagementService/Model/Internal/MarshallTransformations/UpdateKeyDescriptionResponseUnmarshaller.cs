...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateKeyDescriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static UpdateKeyDescriptionResponseUnmarshaller _instance = new UpdateKeyDescriptionResponseUnmarshaller();        

        internal static UpdateKeyDescriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateKeyDescriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
