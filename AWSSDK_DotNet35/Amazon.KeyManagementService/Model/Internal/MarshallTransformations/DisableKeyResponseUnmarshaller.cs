...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DisableKeyResponseUnmarshaller _instance = new DisableKeyResponseUnmarshaller();        

        internal static DisableKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DisableKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
