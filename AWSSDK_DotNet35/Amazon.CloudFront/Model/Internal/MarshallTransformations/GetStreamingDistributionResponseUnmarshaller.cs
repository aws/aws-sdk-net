...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class GetStreamingDistributionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static GetStreamingDistributionResponseUnmarshaller _instance = new GetStreamingDistributionResponseUnmarshaller();        

        internal static GetStreamingDistributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetStreamingDistributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
