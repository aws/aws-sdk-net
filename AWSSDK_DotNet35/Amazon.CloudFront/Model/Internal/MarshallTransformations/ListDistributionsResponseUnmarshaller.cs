...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    internal class ListDistributionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListDistributionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.DistributionList = DistributionListUnmarshaller.GetInstance().Unmarshall(context);
