...
namespace Amazon.Lambda.Model
{
    ...
    /// </summary>
    public partial class UpdateFunctionConfigurationResponse : UpdateFunctionConfigurationResult
    {
        /// <summary>
        /// Gets and sets the UpdateFunctionConfigurationResult property.
        /// Represents the output of a UpdateFunctionConfiguration operation.
        /// </summary>
        [Obsolete(@"This property has been deprecated. All properties of the UpdateFunctionConfigurationResult class are now available on the UpdateFunctionConfigurationResponse class. You should use the properties on UpdateFunctionConfigurationResponse instead of accessing them through UpdateFunctionConfigurationResult.")]
        public UpdateFunctionConfigurationResult UpdateFunctionConfigurationResult
        {
            get
            {
                return this;
