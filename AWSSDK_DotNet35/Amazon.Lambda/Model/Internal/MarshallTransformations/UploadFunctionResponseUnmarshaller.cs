...
{
    /// <summary>
    /// Response Unmarshaller for UploadFunction operation
    /// </summary>  
    public class UploadFunctionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            UploadFunctionResponse response = new UploadFunctionResponse();
        ...
        private static UploadFunctionResponseUnmarshaller _instance = new UploadFunctionResponseUnmarshaller();        

        internal static UploadFunctionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UploadFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
