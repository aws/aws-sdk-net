...
{
    /// <summary>
    /// Response Unmarshaller for GetEventSource operation
    /// </summary>  
    public class GetEventSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            GetEventSourceResponse response = new GetEventSourceResponse();
        ...
        private static GetEventSourceResponseUnmarshaller _instance = new GetEventSourceResponseUnmarshaller();        

        internal static GetEventSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
