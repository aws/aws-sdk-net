...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAssociationStatus operation
    /// </summary>  
    public class UpdateAssociationStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            UpdateAssociationStatusResponse response = new UpdateAssociationStatusResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("StatusUnchanged"))
            {
                return new StatusUnchangedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static UpdateAssociationStatusResponseUnmarshaller _instance = new UpdateAssociationStatusResponseUnmarshaller();        

        internal static UpdateAssociationStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateAssociationStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
