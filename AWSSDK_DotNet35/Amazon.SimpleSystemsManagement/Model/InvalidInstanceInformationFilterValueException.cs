...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    /// </summary>
    public class InvalidInstanceInformationFilterValueException : AmazonSimpleSystemsManagementException 
    {
        /// <summary>
        /// Constructs a new InvalidInstanceInformationFilterValueException with the specified error
        /// message.
        /// </summary>
        /// <param name="message">
