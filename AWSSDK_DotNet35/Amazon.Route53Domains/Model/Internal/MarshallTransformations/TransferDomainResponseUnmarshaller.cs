...
{
    /// <summary>
    /// Response Unmarshaller for TransferDomain operation
    /// </summary>  
    public class TransferDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            TransferDomainResponse response = new TransferDomainResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("DomainLimitExceeded"))
            {
                return new DomainLimitExceededException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static TransferDomainResponseUnmarshaller _instance = new TransferDomainResponseUnmarshaller();        

        internal static TransferDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static TransferDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
