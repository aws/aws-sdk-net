...
{
    /// <summary>
    /// Response Unmarshaller for CheckDomainAvailability operation
    /// </summary>  
    public class CheckDomainAvailabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CheckDomainAvailabilityResponseUnmarshaller _instance = new CheckDomainAvailabilityResponseUnmarshaller();        

        internal static CheckDomainAvailabilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CheckDomainAvailabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
