...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RetrieveEnvironmentInfoResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context,RetrieveEnvironmentInfoResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.EnvironmentInfo.Add(EnvironmentInfoDescriptionUnmarshaller.GetInstance().Unmarshall(context));
