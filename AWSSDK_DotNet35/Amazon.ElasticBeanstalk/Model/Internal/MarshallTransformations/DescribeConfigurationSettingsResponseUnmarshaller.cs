...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeConfigurationSettingsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeConfigurationSettingsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.ConfigurationSettings.Add(ConfigurationSettingsDescriptionUnmarshaller.GetInstance().Unmarshall(context));
