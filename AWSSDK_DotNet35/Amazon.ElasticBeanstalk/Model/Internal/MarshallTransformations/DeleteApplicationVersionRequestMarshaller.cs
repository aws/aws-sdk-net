...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(DeleteApplicationVersionRequest deleteApplicationVersionRequest)
        {
            IRequest request = new DefaultRequest(deleteApplicationVersionRequest, "AmazonElasticBeanstalk");
