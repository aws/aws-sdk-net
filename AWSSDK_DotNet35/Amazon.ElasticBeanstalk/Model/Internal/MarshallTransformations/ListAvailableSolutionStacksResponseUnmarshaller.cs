...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    internal class ListAvailableSolutionStacksResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListAvailableSolutionStacksResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.SolutionStacks.Add(StringUnmarshaller.GetInstance().Unmarshall(context));
                            
                        continue;
                    }
                    if (context.TestExpression("SolutionStackDetails/member", targetDepth))
                    {
                        response.SolutionStackDetails.Add(SolutionStackDescriptionUnmarshaller.GetInstance().Unmarshall(context));
