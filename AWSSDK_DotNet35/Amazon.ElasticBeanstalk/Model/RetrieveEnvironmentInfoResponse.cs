...
{
    /// <summary>
    /// Returns information about the  RetrieveEnvironmentInfo response and response metadata.
    /// </summary>
    public class RetrieveEnvironmentInfoResponse : RetrieveEnvironmentInfoResult
    {
        /// <summary>
