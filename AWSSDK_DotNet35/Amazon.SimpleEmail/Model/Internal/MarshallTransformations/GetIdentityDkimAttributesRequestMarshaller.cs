...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetIdentityDkimAttributesRequestMarshaller : IMarshaller<IRequest, GetIdentityDkimAttributesRequest>
    {
        public IRequest Marshall(GetIdentityDkimAttributesRequest getIdentityDkimAttributesRequest)
        {
            IRequest request = new DefaultRequest(getIdentityDkimAttributesRequest, "AmazonSimpleEmailService");
