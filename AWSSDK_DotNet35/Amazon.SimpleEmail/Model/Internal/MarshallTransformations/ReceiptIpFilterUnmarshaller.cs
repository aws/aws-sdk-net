...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReceiptIpFilterUnmarshaller : IUnmarshaller<ReceiptIpFilter, XmlUnmarshallerContext>, IUnmarshaller<ReceiptIpFilter, JsonUnmarshallerContext>
    {
        ...
        public ReceiptIpFilter Unmarshall(JsonUnmarshallerContext context)
        {
            return null;
        }
