...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class GetIdentityNotificationAttributesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,GetIdentityNotificationAttributesResponse response)
        {
        ...
        private static GetIdentityNotificationAttributesResponseUnmarshaller instance;

        public static GetIdentityNotificationAttributesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new GetIdentityNotificationAttributesResponseUnmarshaller();
            }
            return instance;
        }
