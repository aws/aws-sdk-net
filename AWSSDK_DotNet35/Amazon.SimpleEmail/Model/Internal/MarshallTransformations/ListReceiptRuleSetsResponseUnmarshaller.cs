...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListReceiptRuleSetsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ListReceiptRuleSetsResponse response = new ListReceiptRuleSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListReceiptRuleSetsResult", 2))
                    {
        ...
        private static ListReceiptRuleSetsResponseUnmarshaller _instance = new ListReceiptRuleSetsResponseUnmarshaller();        

        internal static ListReceiptRuleSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListReceiptRuleSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
