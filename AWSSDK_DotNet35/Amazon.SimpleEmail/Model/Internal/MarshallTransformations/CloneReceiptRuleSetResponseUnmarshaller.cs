...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CloneReceiptRuleSetResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            CloneReceiptRuleSetResponse response = new CloneReceiptRuleSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CloneReceiptRuleSetResult", 2))
                    {
        ...
        private static CloneReceiptRuleSetResponseUnmarshaller _instance = new CloneReceiptRuleSetResponseUnmarshaller();        

        internal static CloneReceiptRuleSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CloneReceiptRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
