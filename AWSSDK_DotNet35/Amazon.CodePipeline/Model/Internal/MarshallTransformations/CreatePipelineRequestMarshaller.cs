...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    public class CreatePipelineRequestMarshaller : IMarshaller<IRequest, CreatePipelineRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreatePipelineRequest publicRequest)
        {
            ...
            string target = "CodePipeline_20150709.CreatePipeline";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetPipeline())
                {
                    context.Writer.WritePropertyName("pipeline");
                    context.Writer.WriteObjectStart();

                    var marshaller = PipelineDeclarationMarshaller.Instance;
                    marshaller.Marshall(publicRequest.Pipeline, context);
