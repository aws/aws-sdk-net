...
namespace Amazon.CodePipeline.Model
{
    ...
    public class InvalidStageDeclarationException : AmazonCodePipelineException 
    {
        ...
        public InvalidStageDeclarationException(string message, Exception innerException) 
            : base(message, innerException) {}
            
        public InvalidStageDeclarationException(Exception innerException) 
            : base(innerException) {}
            
        public InvalidStageDeclarationException(string message, Exception innerException, ErrorType errorType, string errorCode, string RequestId, HttpStatusCode statusCode) 
