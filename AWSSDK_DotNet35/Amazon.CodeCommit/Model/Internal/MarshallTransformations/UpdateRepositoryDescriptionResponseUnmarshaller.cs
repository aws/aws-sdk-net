...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateRepositoryDescriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            UpdateRepositoryDescriptionResponse response = new UpdateRepositoryDescriptionResponse();
        ...
        private static UpdateRepositoryDescriptionResponseUnmarshaller _instance = new UpdateRepositoryDescriptionResponseUnmarshaller();        

        internal static UpdateRepositoryDescriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static UpdateRepositoryDescriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
