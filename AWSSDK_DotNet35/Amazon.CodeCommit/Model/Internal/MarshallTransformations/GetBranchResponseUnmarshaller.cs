...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBranchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static GetBranchResponseUnmarshaller _instance = new GetBranchResponseUnmarshaller();        

        internal static GetBranchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetBranchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
