...
namespace Amazon.DynamoDBv2.DataModel
{
    ...
    public partial interface IAsyncSearch<T>
    {
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetNextSet(AsyncCallback callback, object state);
        ...
        List<T> EndGetNextSet(IAsyncResult asyncResult);
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetRemaining(AsyncCallback callback, object state);

        /// <summary>
        /// Finishes the asynchronous execution of the BeginGetRemaining operation.
        /// </summary>
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetNextSet.</param>
        List<T> EndGetRemaining(IAsyncResult asyncResult);
    }
}
