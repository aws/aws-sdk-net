...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeCacheClustersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeCacheClustersResponseUnmarshaller _instance = new DescribeCacheClustersResponseUnmarshaller();        

        internal static DescribeCacheClustersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeCacheClustersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
