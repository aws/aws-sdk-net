...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RevokeCacheSecurityGroupIngressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,RevokeCacheSecurityGroupIngressResponse response)
        {
        ...
        private static RevokeCacheSecurityGroupIngressResponseUnmarshaller instance;

        public static RevokeCacheSecurityGroupIngressResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new RevokeCacheSecurityGroupIngressResponseUnmarshaller();
            }
            return instance;
        }
