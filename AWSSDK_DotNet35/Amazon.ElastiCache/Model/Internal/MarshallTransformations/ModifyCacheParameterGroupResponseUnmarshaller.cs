...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyCacheParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("CacheParameterGroupName", targetDepth))
                    {
                        ...
                        response.CacheParameterGroupName = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyCacheParameterGroupResponseUnmarshaller _instance = new ModifyCacheParameterGroupResponseUnmarshaller();        

        internal static ModifyCacheParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ModifyCacheParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
