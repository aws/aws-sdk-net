...
{
    /// <summary>
    ///    Response Unmarshaller for ModifyReplicationGroup operation
    /// </summary>
    internal class ModifyReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ModifyReplicationGroupResponse response = new ModifyReplicationGroupResponse();
            ...
            while (context.Read())
            {
                ...
                if (context.IsStartElement)
                {
                    ...
                    if(context.TestExpression("ModifyReplicationGroupResult", 2))
                    {
        ...
        private static ModifyReplicationGroupResponseUnmarshaller instance;

        public static ModifyReplicationGroupResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ModifyReplicationGroupResponseUnmarshaller();
            }
            return instance;
        }
