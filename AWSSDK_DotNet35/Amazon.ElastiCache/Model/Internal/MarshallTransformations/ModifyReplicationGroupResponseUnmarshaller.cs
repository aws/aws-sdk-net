...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ModifyReplicationGroupResponseUnmarshaller _instance = new ModifyReplicationGroupResponseUnmarshaller();        

        internal static ModifyReplicationGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ModifyReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
