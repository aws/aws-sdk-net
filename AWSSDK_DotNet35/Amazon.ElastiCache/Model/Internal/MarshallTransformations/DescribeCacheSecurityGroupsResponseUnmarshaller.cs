...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeCacheSecurityGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("CacheSecurityGroups/CacheSecurityGroup", targetDepth))
                    {
                        ...
                        response.CacheSecurityGroups.Add(item);
                        continue;
                    }
        ...
        private static DescribeCacheSecurityGroupsResponseUnmarshaller _instance = new DescribeCacheSecurityGroupsResponseUnmarshaller();        

        internal static DescribeCacheSecurityGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeCacheSecurityGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
