...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeCacheEngineVersionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeCacheEngineVersionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.CacheEngineVersions.Add(CacheEngineVersionUnmarshaller.GetInstance().Unmarshall(context));
