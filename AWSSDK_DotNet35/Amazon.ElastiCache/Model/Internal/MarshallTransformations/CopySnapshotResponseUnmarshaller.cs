...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CopySnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static CopySnapshotResponseUnmarshaller instance;

        public static CopySnapshotResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CopySnapshotResponseUnmarshaller();
            }
            return instance;
        }
