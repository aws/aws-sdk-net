...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RebootCacheClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static RebootCacheClusterResponseUnmarshaller _instance = new RebootCacheClusterResponseUnmarshaller();        

        internal static RebootCacheClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RebootCacheClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
