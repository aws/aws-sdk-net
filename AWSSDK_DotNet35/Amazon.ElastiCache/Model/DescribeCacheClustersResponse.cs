...
{
    /// <summary>
    /// Returns information about the  DescribeCacheClusters response and response metadata.
    /// </summary>
    public class DescribeCacheClustersResponse : DescribeCacheClustersResult
    {
        /// <summary>
