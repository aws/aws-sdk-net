...
{
    /// <summary>
    /// Returns information about the  DescribeDBSubnetGroups response and response metadata.
    /// </summary>
    public class DescribeDBSubnetGroupsResponse : DescribeDBSubnetGroupsResult
    {
        /// <summary>
