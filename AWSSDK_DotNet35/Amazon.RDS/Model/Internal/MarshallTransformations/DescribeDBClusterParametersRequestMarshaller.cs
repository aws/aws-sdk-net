...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDBClusterParametersRequestMarshaller : IMarshaller<IRequest, DescribeDBClusterParametersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DescribeDBClusterParametersRequest)input);
        }
    
        public IRequest Marshall(DescribeDBClusterParametersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBClusterParameters");
