...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDBParameterGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeDBParameterGroupsResponseUnmarshaller _instance = new DescribeDBParameterGroupsResponseUnmarshaller();        

        internal static DescribeDBParameterGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeDBParameterGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
