...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RemoveTagsFromResourceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static RemoveTagsFromResourceResponseUnmarshaller instance;

        public static RemoveTagsFromResourceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new RemoveTagsFromResourceResponseUnmarshaller();
            }
            return instance;
        }
