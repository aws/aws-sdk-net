...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDBParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("DBParameterGroup", targetDepth))
                    {
                        ...
                        response.DBParameterGroup = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static CreateDBParameterGroupResponseUnmarshaller _instance = new CreateDBParameterGroupResponseUnmarshaller();        

        internal static CreateDBParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateDBParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
