...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class CreateDBParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,CreateDBParameterGroupResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.DBParameterGroup = DBParameterGroupUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
