...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeDBSubnetGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeDBSubnetGroupsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.DBSubnetGroups.Add(DBSubnetGroupUnmarshaller.GetInstance().Unmarshall(context));
