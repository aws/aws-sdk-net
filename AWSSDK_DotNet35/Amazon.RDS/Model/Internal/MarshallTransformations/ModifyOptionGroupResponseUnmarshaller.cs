...
{
    /// <summary>
    ///    Response Unmarshaller for ModifyOptionGroup operation
    /// </summary>
    internal class ModifyOptionGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ModifyOptionGroupResponse response = new ModifyOptionGroupResponse();
            ...
            while (context.Read())
            {
                ...
                if (context.IsStartElement)
                {
                    ...
                    if(context.TestExpression("ModifyOptionGroupResult", 2))
                    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ModifyOptionGroupResponse response)
        {
        ...
        private static ModifyOptionGroupResponseUnmarshaller instance;

        public static ModifyOptionGroupResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ModifyOptionGroupResponseUnmarshaller();
            }
            return instance;
        }
