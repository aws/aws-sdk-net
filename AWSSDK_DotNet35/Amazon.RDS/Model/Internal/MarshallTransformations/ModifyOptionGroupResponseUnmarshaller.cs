...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyOptionGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ModifyOptionGroupResponseUnmarshaller _instance = new ModifyOptionGroupResponseUnmarshaller();        

        internal static ModifyOptionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ModifyOptionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
