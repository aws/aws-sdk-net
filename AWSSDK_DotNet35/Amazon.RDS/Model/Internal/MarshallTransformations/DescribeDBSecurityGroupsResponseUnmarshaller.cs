...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeDBSecurityGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeDBSecurityGroupsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.DBSecurityGroups.Add(DBSecurityGroupUnmarshaller.GetInstance().Unmarshall(context));
