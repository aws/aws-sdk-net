...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class AuthorizeDBSecurityGroupIngressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,AuthorizeDBSecurityGroupIngressResponse response)
        {
        ...
        private static AuthorizeDBSecurityGroupIngressResponseUnmarshaller instance;

        public static AuthorizeDBSecurityGroupIngressResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new AuthorizeDBSecurityGroupIngressResponseUnmarshaller();
            }
            return instance;
        }
