...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeOptionGroupOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeOptionGroupOptionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.OptionGroupOptions.Add(OptionGroupOptionUnmarshaller.GetInstance().Unmarshall(context));
