...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResetDBParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ResetDBParameterGroupResponseUnmarshaller _instance = new ResetDBParameterGroupResponseUnmarshaller();        

        internal static ResetDBParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ResetDBParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
