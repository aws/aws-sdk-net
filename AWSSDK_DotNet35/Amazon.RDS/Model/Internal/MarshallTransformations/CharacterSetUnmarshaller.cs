...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class CharacterSetUnmarshaller : IUnmarshaller<CharacterSet, XmlUnmarshallerContext>, IUnmarshaller<CharacterSet, JsonUnmarshallerContext>
    {
        ...
        {
            CharacterSet unmarshalledObject = new CharacterSet();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("CharacterSetDescription", targetDepth))
                    {
                        ...
                        unmarshalledObject.CharacterSetDescription = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        public static CharacterSetUnmarshaller Instance
        {
            get
            {
                return _instance;
