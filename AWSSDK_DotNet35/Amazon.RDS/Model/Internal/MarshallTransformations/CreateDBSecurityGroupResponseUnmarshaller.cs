...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDBSecurityGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static CreateDBSecurityGroupResponseUnmarshaller _instance = new CreateDBSecurityGroupResponseUnmarshaller();        

        internal static CreateDBSecurityGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateDBSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
