...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteEventSubscriptionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteEventSubscriptionResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidEventSubscriptionState"))
            {
                return new InvalidEventSubscriptionStateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DeleteEventSubscriptionResponseUnmarshaller _instance = new DeleteEventSubscriptionResponseUnmarshaller();        

        internal static DeleteEventSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteEventSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
