...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConfigRule operation
    /// </summary>  
    public class DeleteConfigRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeleteConfigRuleResponseUnmarshaller _instance = new DeleteConfigRuleResponseUnmarshaller();        

        internal static DeleteConfigRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteConfigRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
