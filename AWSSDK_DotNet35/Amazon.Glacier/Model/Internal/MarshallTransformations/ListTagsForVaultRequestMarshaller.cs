...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListTagsForVaultRequestMarshaller : IMarshaller<IRequest, ListTagsForVaultRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((ListTagsForVaultRequest)input);
        }

        public IRequest Marshall(ListTagsForVaultRequest publicRequest)
        {
