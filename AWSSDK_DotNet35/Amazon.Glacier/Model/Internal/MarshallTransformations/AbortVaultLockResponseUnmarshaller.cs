...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AbortVaultLockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            AbortVaultLockResponse response = new AbortVaultLockResponse();
        ...
        private static AbortVaultLockResponseUnmarshaller _instance = new AbortVaultLockResponseUnmarshaller();        

        internal static AbortVaultLockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static AbortVaultLockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
