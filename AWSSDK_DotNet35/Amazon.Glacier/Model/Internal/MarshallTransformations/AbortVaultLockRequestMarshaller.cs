...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AbortVaultLockRequestMarshaller : IMarshaller<IRequest, AbortVaultLockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((AbortVaultLockRequest)input);
        }

        public IRequest Marshall(AbortVaultLockRequest publicRequest)
        {
