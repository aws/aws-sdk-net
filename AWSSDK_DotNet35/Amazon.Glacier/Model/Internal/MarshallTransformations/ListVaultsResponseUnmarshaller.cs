 ...
 */
    ...
    namespace Amazon.Glacier.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class ListVaultsResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
              ...
              if (context.TestExpression("VaultList", targetDepth))
              {
                ...
                var unmarshaller = new ListUnmarshaller<DescribeVaultOutput,DescribeVaultOutputUnmarshaller>(
                    DescribeVaultOutputUnmarshaller.GetInstance());                  
        ...
        private static ListVaultsResponseUnmarshaller instance;
