...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddTagsToVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            AddTagsToVaultResponse response = new AddTagsToVaultResponse();
        ...
        private static AddTagsToVaultResponseUnmarshaller _instance = new AddTagsToVaultResponseUnmarshaller();        

        internal static AddTagsToVaultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static AddTagsToVaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
