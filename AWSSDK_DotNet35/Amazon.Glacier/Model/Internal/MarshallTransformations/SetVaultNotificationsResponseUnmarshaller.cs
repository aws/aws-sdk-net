 ...
 */
    ...
    namespace Amazon.Glacier.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class SetVaultNotificationsResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static SetVaultNotificationsResponseUnmarshaller instance;
        public static SetVaultNotificationsResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new SetVaultNotificationsResponseUnmarshaller();
          }
          return instance;
        }
