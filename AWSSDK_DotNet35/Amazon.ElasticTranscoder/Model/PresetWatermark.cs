...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class PresetWatermark
    {
        ...
        ///               <code>HorizontalOffset</code>: <ul>                <li><b>Left</b>:
        /// The left edge of the watermark is aligned with the left border of                
        ///    the video.</li>                <li><b>Right</b>: The right edge of the watermark
        /// is aligned with the right border                    of the video.</li>           
        ///     <li><b>Center</b>: The watermark is centered between the left and right      
        ///              borders.</li></ul>
        /// </para>
        /// </summary>
        ...
        /// from            the position specified by HorizontalAlign: <ul>                <li>number
        /// of pixels (px): The minimum value is 0 pixels, and the maximum value is          
        ///          the value of MaxWidth.</li>                <li>integer percentage (%): The
        /// range of valid values is 0 to 100.</li>            </ul>For example, if you specify
        /// Left for <code>HorizontalAlign</code> and 5px for                <code>HorizontalOffset</code>,
        ...
        /// is <code>Left</code> or <code>Right</code>. If you            specify an offset that
        ...
        /// <para>
        /// The maximum height of the watermark in one of the following formats: <ul>        
        ///        <li>number of pixels (px): The minimum value is 16 pixels, and the maximum
        /// value is                    the value of <code>MaxHeight</code>.</li>            
        ///    <li>integer percentage (%): The range of valid values is 0 to 100. Use the value
        /// of                        <code>Target</code> to specify whether you want Elastic
        /// Transcoder to include the black                    bars that are added by Elastic
        /// Transcoder, if any, in the calculation.</li>            </ul> If you specify the value
        /// in pixels, it must be less than or equal to the value of                <code>MaxHeight</code>.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The maximum width of the watermark in one of the following formats: <ul>         
        ///       <li>number of pixels (px): The minimum value is 16 pixels, and the maximum value
        /// is                    the value of <code>MaxWidth</code>.</li>                <li>integer
        /// percentage (%): The range of valid values is 0 to 100. Use the value of          
        ///              <code>Target</code> to specify whether you want Elastic Transcoder to
        /// include the black                    bars that are added by Elastic Transcoder, if
        /// any, in the calculation.</li> If                you specify the value in pixels, it
        /// must be less than or equal to the value of                    <code>MaxWidth</code>.</ul>
        /// </para>
        /// </summary>
        ...
        /// the            location where it appears. Valid values are 0 (the watermark is invisible)
        /// to 100 (the            watermark completely obscures the video in the specified location).
        /// The datatype of                <code>Opacity</code> is float.
        /// </para>
        ///         
        /// <para>
        /// Elastic Transcoder supports transparent .png graphics. If you use a transparent .png,
        /// the transparent            portion of the video appears as if you had specified a
        /// value of 0 for                <code>Opacity</code>. The .jpg file format doesn't support
        /// transparency.
        /// </para>
        /// </summary>
        ...
        ///                    exceeding the other value.</li>                <li><b>Stretch</b>:
        /// Elastic Transcoder stretches the watermark to match the values                   
        ...
        ///                    and <code>MaxHeight</code> are different, the watermark will be
        /// distorted.</li>                <li><b>ShrinkToFit</b>: Elastic Transcoder scales the
        ...
        /// Transcoder does not scale the                    watermark up.</li></ul>        
        /// </para>
        /// </summary>
        ...
        /// and                        <code>VerticalOffset</code> values are calculated based
        /// on the borders of                    the video excluding black bars added by Elastic
        /// Transcoder, if any. In addition,                        <code>MaxWidth</code> and
        /// <code>MaxHeight</code>, if specified as a                    percentage, are calculated
        /// based on the borders of the video excluding black                    bars added by
        /// Elastic Transcoder, if any.</li>                <li><b>Frame</b>: <code>HorizontalOffset</code>
        /// and <code>VerticalOffset</code>                    values are calculated based on
        /// the borders of the video including black bars                    added by Elastic
        /// Transcoder, if any.</li> In addition, <code>MaxWidth</code> and                  
        ...
        ///             <code>VerticalOffset</code>: <ul>                <li><b>Top</b>: The top
        /// edge of the watermark is aligned with the top border of the                    video.</li>
        ///                <li><b>Bottom</b>: The bottom edge of the watermark is aligned with
        /// the bottom                    border of the video.</li>                <li><b>Center</b>:
        /// The watermark is centered between the top and bottom                    borders.</li></ul>
        /// </para>
        /// </summary>
        ...
        /// the            position specified by VerticalAlign:<ul>                <li>number
        /// of pixels (px): The minimum value is 0 pixels, and the maximum value is          
        ///          the value of <code>MaxHeight</code>.</li>                <li>integer percentage
        /// (%): The range of valid values is 0 to 100.</li>            </ul> For example, if
        /// you specify <code>Top</code> for <code>VerticalAlign</code> and                <code>5px</code>
        /// for <code>VerticalOffset</code>, the top of the watermark appears 5            pixels
        ...
        /// cropped. If            Elastic Transcoder has added black bars, the watermark extends
        /// into the black bars. If            the watermark extends beyond the black bars, it
        /// is cropped.
        /// </para>
        ///         
        /// <para>
