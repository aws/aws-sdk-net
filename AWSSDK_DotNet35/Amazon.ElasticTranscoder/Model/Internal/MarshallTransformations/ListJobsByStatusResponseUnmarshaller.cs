...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListJobsByStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ListJobsByStatusResponseUnmarshaller _instance = new ListJobsByStatusResponseUnmarshaller();        

        internal static ListJobsByStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListJobsByStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
