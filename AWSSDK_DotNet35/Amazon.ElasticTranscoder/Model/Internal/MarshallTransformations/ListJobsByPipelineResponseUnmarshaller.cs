...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListJobsByPipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ListJobsByPipelineResponseUnmarshaller _instance = new ListJobsByPipelineResponseUnmarshaller();        

        internal static ListJobsByPipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListJobsByPipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
