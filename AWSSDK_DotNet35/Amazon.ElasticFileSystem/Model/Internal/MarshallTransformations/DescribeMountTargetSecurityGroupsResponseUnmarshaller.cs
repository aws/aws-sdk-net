...
namespace Amazon.ElasticFileSystem.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMountTargetSecurityGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeMountTargetSecurityGroupsResponseUnmarshaller _instance = new DescribeMountTargetSecurityGroupsResponseUnmarshaller();        

        internal static DescribeMountTargetSecurityGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeMountTargetSecurityGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
