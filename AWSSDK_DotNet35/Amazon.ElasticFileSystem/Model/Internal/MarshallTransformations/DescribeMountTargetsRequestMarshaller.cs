...
namespace Amazon.ElasticFileSystem.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeMountTargetsRequestMarshaller : IMarshaller<IRequest, DescribeMountTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DescribeMountTargetsRequest)input);
        }

        public IRequest Marshall(DescribeMountTargetsRequest publicRequest)
        {
