...
{
    /// <summary>
    /// GetApplicationRevision Request Marshaller
    /// </summary>       
    public class GetApplicationRevisionRequestMarshaller : IMarshaller<IRequest, GetApplicationRevisionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((GetApplicationRevisionRequest)input);
        }

        public IRequest Marshall(GetApplicationRevisionRequest publicRequest)
        {
