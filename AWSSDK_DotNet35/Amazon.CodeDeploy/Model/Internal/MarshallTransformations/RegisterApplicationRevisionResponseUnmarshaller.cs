...
{
    /// <summary>
    /// Response Unmarshaller for RegisterApplicationRevision operation
    /// </summary>  
    public class RegisterApplicationRevisionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DescriptionTooLongException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static RegisterApplicationRevisionResponseUnmarshaller _instance = new RegisterApplicationRevisionResponseUnmarshaller();        

        internal static RegisterApplicationRevisionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RegisterApplicationRevisionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
