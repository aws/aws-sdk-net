...
{
    /// <summary>
    /// Response Unmarshaller for AddTagsToOnPremisesInstances operation
    /// </summary>  
    public class AddTagsToOnPremisesInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            AddTagsToOnPremisesInstancesResponse response = new AddTagsToOnPremisesInstancesResponse();
        ...
        private static AddTagsToOnPremisesInstancesResponseUnmarshaller _instance = new AddTagsToOnPremisesInstancesResponseUnmarshaller();        

        internal static AddTagsToOnPremisesInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static AddTagsToOnPremisesInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
