...
namespace Amazon.CodeDeploy.Model
{
    ...
    /// </summary>
    public partial class UpdateDeploymentGroupResult : AmazonWebServiceResponse
    {
        ...
        /// Auto Scaling lifecycle event hooks from the AWS user account. If the output does contain
        /// data, AWS CodeDeploy could not remove some Auto Scaling lifecycle event hooks from
