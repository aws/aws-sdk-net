...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeVpnConnectionsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeVpnConnectionsResponseUnmarshaller _instance = new DescribeVpnConnectionsResponseUnmarshaller();        

        internal static DescribeVpnConnectionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeVpnConnectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
