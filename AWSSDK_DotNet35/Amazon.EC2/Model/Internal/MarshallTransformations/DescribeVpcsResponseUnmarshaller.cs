...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeVpcsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeVpcsResponseUnmarshaller _instance = new DescribeVpcsResponseUnmarshaller();        

        internal static DescribeVpcsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeVpcsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
