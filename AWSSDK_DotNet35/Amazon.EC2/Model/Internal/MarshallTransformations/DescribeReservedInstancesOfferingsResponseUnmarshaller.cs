...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeReservedInstancesOfferingsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeReservedInstancesOfferingsResponseUnmarshaller instance;

        public static DescribeReservedInstancesOfferingsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeReservedInstancesOfferingsResponseUnmarshaller();
            }
            return instance;
        }
