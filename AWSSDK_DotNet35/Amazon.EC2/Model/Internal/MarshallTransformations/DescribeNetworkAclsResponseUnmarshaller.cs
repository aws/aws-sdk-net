...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeNetworkAclsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeNetworkAclsResponseUnmarshaller instance;

        public static DescribeNetworkAclsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeNetworkAclsResponseUnmarshaller();
            }
            return instance;
        }
