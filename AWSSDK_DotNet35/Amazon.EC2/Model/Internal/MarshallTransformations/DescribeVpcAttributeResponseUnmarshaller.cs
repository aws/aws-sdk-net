...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeVpcAttributeResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeVpcAttributeResponseUnmarshaller instance;

        public static DescribeVpcAttributeResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeVpcAttributeResponseUnmarshaller();
            }
            return instance;
        }
