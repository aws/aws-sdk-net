...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeConversionTasksResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeConversionTasksResponseUnmarshaller _instance = new DescribeConversionTasksResponseUnmarshaller();        

        internal static DescribeConversionTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeConversionTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
