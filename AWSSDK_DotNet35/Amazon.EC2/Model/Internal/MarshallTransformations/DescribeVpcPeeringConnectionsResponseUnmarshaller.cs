...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeVpcPeeringConnectionsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeVpcPeeringConnectionsResponseUnmarshaller instance;

        public static DescribeVpcPeeringConnectionsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeVpcPeeringConnectionsResponseUnmarshaller();
            }
            return instance;
        }
