...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MonitorInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static MonitorInstancesResponseUnmarshaller _instance = new MonitorInstancesResponseUnmarshaller();        

        internal static MonitorInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static MonitorInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
