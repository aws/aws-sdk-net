...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelImportTaskResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static CancelImportTaskResponseUnmarshaller _instance = new CancelImportTaskResponseUnmarshaller();        

        internal static CancelImportTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CancelImportTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
