...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RevokeSecurityGroupEgressResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static RevokeSecurityGroupEgressResponseUnmarshaller instance;

        public static RevokeSecurityGroupEgressResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new RevokeSecurityGroupEgressResponseUnmarshaller();
            }
            return instance;
        }
