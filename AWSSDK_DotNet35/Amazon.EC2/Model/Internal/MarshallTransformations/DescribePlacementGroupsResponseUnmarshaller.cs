...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribePlacementGroupsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribePlacementGroupsResponseUnmarshaller instance;

        public static DescribePlacementGroupsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribePlacementGroupsResponseUnmarshaller();
            }
            return instance;
        }
