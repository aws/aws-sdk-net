...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeNetworkInterfacesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        {   
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.NetworkInterfaces.Add(NetworkInterfaceUnmarshaller.GetInstance().Unmarshall(context));
