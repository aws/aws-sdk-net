...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeSpotFleetRequestHistoryResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            DescribeSpotFleetRequestHistoryResponse response = new DescribeSpotFleetRequestHistoryResponse();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = HistoryRecordUnmarshaller.Instance;
        ...
        private static DescribeSpotFleetRequestHistoryResponseUnmarshaller _instance = new DescribeSpotFleetRequestHistoryResponseUnmarshaller();        

        internal static DescribeSpotFleetRequestHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeSpotFleetRequestHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
