...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class AuthorizeSecurityGroupEgressResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static AuthorizeSecurityGroupEgressResponseUnmarshaller instance;

        public static AuthorizeSecurityGroupEgressResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new AuthorizeSecurityGroupEgressResponseUnmarshaller();
            }
            return instance;
        }
