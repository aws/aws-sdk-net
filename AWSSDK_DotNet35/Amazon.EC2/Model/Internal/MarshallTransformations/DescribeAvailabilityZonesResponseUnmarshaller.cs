...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeAvailabilityZonesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeAvailabilityZonesResponseUnmarshaller instance;

        public static DescribeAvailabilityZonesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeAvailabilityZonesResponseUnmarshaller();
            }
            return instance;
        }
