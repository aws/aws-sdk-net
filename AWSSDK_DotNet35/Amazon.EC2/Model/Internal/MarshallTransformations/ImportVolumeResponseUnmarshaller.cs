...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ImportVolumeResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static ImportVolumeResponseUnmarshaller instance;

        public static ImportVolumeResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ImportVolumeResponseUnmarshaller();
            }
            return instance;
        }
