...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RunInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static RunInstancesResponseUnmarshaller _instance = new RunInstancesResponseUnmarshaller();        

        internal static RunInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RunInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
