...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AuthorizeSecurityGroupIngressRequestMarshaller : IMarshaller<IRequest, AuthorizeSecurityGroupIngressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((AuthorizeSecurityGroupIngressRequest)input);
        }
    
        public IRequest Marshall(AuthorizeSecurityGroupIngressRequest publicRequest)
        {
