...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static StopInstancesResponseUnmarshaller _instance = new StopInstancesResponseUnmarshaller();        

        internal static StopInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static StopInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
