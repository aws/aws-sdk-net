...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class StopInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static StopInstancesResponseUnmarshaller instance;

        public static StopInstancesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new StopInstancesResponseUnmarshaller();
            }
            return instance;
        }
