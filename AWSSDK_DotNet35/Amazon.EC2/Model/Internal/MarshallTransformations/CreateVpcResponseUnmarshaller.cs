...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateVpcResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static CreateVpcResponseUnmarshaller _instance = new CreateVpcResponseUnmarshaller();        

        internal static CreateVpcResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateVpcResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
