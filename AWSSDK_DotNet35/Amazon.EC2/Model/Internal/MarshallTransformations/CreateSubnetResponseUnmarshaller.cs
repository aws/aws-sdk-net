...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSubnetResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static CreateSubnetResponseUnmarshaller _instance = new CreateSubnetResponseUnmarshaller();        

        internal static CreateSubnetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateSubnetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
