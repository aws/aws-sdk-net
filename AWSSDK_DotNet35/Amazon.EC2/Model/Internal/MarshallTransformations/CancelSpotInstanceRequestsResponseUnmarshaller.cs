...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CancelSpotInstanceRequestsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        {   
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.CancelledSpotInstanceRequests.Add(CancelledSpotInstanceRequestUnmarshaller.GetInstance().Unmarshall(context));
