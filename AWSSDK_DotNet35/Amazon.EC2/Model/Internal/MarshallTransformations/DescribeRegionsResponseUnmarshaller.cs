...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeRegionsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeRegionsResponseUnmarshaller _instance = new DescribeRegionsResponseUnmarshaller();        

        internal static DescribeRegionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeRegionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
