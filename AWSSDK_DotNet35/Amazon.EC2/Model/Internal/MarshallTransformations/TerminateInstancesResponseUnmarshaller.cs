...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class TerminateInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static TerminateInstancesResponseUnmarshaller instance;

        public static TerminateInstancesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new TerminateInstancesResponseUnmarshaller();
            }
            return instance;
        }
