...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CreateNetworkInterfaceResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static CreateNetworkInterfaceResponseUnmarshaller instance;

        public static CreateNetworkInterfaceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateNetworkInterfaceResponseUnmarshaller();
            }
            return instance;
        }
