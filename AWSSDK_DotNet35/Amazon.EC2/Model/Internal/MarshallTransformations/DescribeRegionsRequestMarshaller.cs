...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeRegionsRequestMarshaller : IMarshaller<IRequest, DescribeRegionsRequest>
    {
        public IRequest Marshall(DescribeRegionsRequest describeRegionsRequest)
        {
            ...
            if (describeRegionsRequest != null)
            {
                ...
                foreach (string regionNamesListValue in regionNamesList)
                { 
                    request.Parameters.Add("RegionName." + regionNamesListIndex, StringUtils.FromString(regionNamesListValue));
            ...
            if (describeRegionsRequest != null)
            {
                List<Filter> filtersList = describeRegionsRequest.Filters;
