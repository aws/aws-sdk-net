...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RevokeSecurityGroupEgressRequestMarshaller : IMarshaller<IRequest, RevokeSecurityGroupEgressRequest>
    {
        public IRequest Marshall(RevokeSecurityGroupEgressRequest revokeSecurityGroupEgressRequest)
        {
            ...
            {
                List<IpPermission> ipPermissionsList = revokeSecurityGroupEgressRequest.IpPermissions;
