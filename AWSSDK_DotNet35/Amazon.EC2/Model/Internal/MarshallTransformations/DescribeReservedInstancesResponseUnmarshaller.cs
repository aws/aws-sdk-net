...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeReservedInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeReservedInstancesResponseUnmarshaller instance;

        public static DescribeReservedInstancesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeReservedInstancesResponseUnmarshaller();
            }
            return instance;
        }
