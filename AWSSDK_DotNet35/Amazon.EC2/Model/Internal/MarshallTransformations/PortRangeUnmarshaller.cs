...
{
     /// <summary>
     ///   PortRange Unmarshaller
     /// </summary>
    internal class PortRangeUnmarshaller : IUnmarshaller<PortRange, XmlUnmarshallerContext>, IUnmarshaller<PortRange, JsonUnmarshallerContext> 
    {
        ...
        private static PortRangeUnmarshaller instance;

        public static PortRangeUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new PortRangeUnmarshaller();
