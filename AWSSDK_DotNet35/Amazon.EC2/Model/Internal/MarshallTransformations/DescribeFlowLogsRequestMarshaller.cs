...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeFlowLogsRequestMarshaller : IMarshaller<IRequest, DescribeFlowLogsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DescribeFlowLogsRequest)input);
        }
    
        public IRequest Marshall(DescribeFlowLogsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeFlowLogs");
