...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeSecurityGroupsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeSecurityGroupsResponseUnmarshaller instance;

        public static DescribeSecurityGroupsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeSecurityGroupsResponseUnmarshaller();
            }
            return instance;
        }
