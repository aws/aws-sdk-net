...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSpotDatafeedSubscriptionResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static CreateSpotDatafeedSubscriptionResponseUnmarshaller _instance = new CreateSpotDatafeedSubscriptionResponseUnmarshaller();        

        internal static CreateSpotDatafeedSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateSpotDatafeedSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
