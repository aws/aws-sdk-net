...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CreateSpotDatafeedSubscriptionResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static CreateSpotDatafeedSubscriptionResponseUnmarshaller instance;

        public static CreateSpotDatafeedSubscriptionResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateSpotDatafeedSubscriptionResponseUnmarshaller();
            }
            return instance;
        }
