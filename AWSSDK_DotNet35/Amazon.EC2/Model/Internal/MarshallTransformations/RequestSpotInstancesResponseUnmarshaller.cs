...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RequestSpotInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static RequestSpotInstancesResponseUnmarshaller instance;

        public static RequestSpotInstancesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
