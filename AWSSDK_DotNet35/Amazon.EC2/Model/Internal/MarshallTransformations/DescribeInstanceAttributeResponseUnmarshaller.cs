...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeInstanceAttributeResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        ...
        private static DescribeInstanceAttributeResponseUnmarshaller instance;

        public static DescribeInstanceAttributeResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeInstanceAttributeResponseUnmarshaller();
            }
            return instance;
        }
