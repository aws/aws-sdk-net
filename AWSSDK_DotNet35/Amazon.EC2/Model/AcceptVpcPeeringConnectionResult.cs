...
namespace Amazon.EC2.Model
{
    ...
    /// 
    /// </summary>
    public partial class AcceptVpcPeeringConnectionResult : AmazonWebServiceResponse
    {
        ...
        {
            get { return this.vpcPeeringConnection; }
            set { this.vpcPeeringConnection = value; }
        }

        // Check to see if VpcPeeringConnection property is set
        internal bool IsSetVpcPeeringConnection()
        {
            return this.vpcPeeringConnection != null;
        }
    }
}
