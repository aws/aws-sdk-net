...
{
    /// <summary>
    /// Returns information about the  DescribeSnapshotAttribute response and response metadata.
    /// </summary>
    public class DescribeSnapshotAttributeResponse : DescribeSnapshotAttributeResult
    {
        /// <summary>
