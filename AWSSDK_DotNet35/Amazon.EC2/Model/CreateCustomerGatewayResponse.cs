...
{
    /// <summary>
    /// Returns information about the  CreateCustomerGateway response and response metadata.
    /// </summary>
    public class CreateCustomerGatewayResponse : CreateCustomerGatewayResult
    {
        /// <summary>
