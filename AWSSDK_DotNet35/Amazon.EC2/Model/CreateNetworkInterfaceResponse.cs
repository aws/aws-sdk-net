...
{
    /// <summary>
    /// Returns information about the  CreateNetworkInterface response and response metadata.
    /// </summary>
    public class CreateNetworkInterfaceResponse : CreateNetworkInterfaceResult
    {
        /// <summary>
