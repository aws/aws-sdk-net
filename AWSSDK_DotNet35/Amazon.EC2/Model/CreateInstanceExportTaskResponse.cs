...
{
    /// <summary>
    /// Returns information about the  CreateInstanceExportTask response and response metadata.
    /// </summary>
    public class CreateInstanceExportTaskResponse : CreateInstanceExportTaskResult
    {
        /// <summary>
