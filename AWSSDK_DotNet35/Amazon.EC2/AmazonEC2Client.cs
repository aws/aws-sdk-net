...
namespace Amazon.EC2
{
    ...
    QueryStringSigner signer = new QueryStringSigner();
        ...
        {
            return AuthorizeSecurityGroupIngress(new AuthorizeSecurityGroupIngressRequest());
        }
        ...
        {
            return DeleteSecurityGroup(new DeleteSecurityGroupRequest());
        }
        ...
        {
            return DisassociateAddress(new DisassociateAddressRequest());
        }
        ...
        {
            return ReleaseAddress(new ReleaseAddressRequest());
        }
        ...
        {
            return ReportInstanceStatus(new ReportInstanceStatusRequest());
        }
