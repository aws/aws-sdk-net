...
{
    /// <summary>
    /// Response Unmarshaller for SubscribeToDataset operation
    /// </summary>  
    public class SubscribeToDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            SubscribeToDatasetResponse response = new SubscribeToDatasetResponse();
        ...
        private static SubscribeToDatasetResponseUnmarshaller _instance = new SubscribeToDatasetResponseUnmarshaller();        

        internal static SubscribeToDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static SubscribeToDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
