...
{
    /// <summary>
    /// Response Unmarshaller for GetIdentityPoolConfiguration operation
    /// </summary>  
    public class GetIdentityPoolConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            GetIdentityPoolConfigurationResponse response = new GetIdentityPoolConfigurationResponse();
        ...
        private static GetIdentityPoolConfigurationResponseUnmarshaller _instance = new GetIdentityPoolConfigurationResponseUnmarshaller();        

        internal static GetIdentityPoolConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetIdentityPoolConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
