...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public class GetBucketLocationRequestMarshaller : IMarshaller<IRequest, GetBucketLocationRequest>
    {
        ...
        public IRequest Marshall(GetBucketLocationRequest getBucketLocationRequest)
        {
            ...
            string uriResourcePath = "/{Bucket}/?location"; 
            uriResourcePath = uriResourcePath.Replace("{Bucket}", getBucketLocationRequest.IsSetBucketName() ? S3Transforms.ToStringValue(getBucketLocationRequest.BucketName) : "" ); 
