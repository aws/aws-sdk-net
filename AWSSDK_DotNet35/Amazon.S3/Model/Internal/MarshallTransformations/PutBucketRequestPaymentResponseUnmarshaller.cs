...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class PutBucketRequestPaymentResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static PutBucketRequestPaymentResponseUnmarshaller instance;

        public static PutBucketRequestPaymentResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new PutBucketRequestPaymentResponseUnmarshaller();
            }
            return instance;
        }
