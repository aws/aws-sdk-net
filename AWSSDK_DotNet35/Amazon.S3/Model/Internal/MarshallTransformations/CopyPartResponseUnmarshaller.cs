...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CopyPartResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,CopyPartResponse response)
        {
        ...
        private static CopyPartResponseUnmarshaller instance;

        public static CopyPartResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CopyPartResponseUnmarshaller();
            }
            return instance;
        }
