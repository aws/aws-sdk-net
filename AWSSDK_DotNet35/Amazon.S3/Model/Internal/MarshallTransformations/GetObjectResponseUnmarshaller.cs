...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class GetObjectResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,GetObjectResponse response)
        {
