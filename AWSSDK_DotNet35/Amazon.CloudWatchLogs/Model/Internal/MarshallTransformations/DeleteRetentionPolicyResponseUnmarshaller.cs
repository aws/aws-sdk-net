...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteRetentionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            DeleteRetentionPolicyResponse response = new DeleteRetentionPolicyResponse();
        ...
        private static DeleteRetentionPolicyResponseUnmarshaller _instance = new DeleteRetentionPolicyResponseUnmarshaller();        

        internal static DeleteRetentionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteRetentionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
