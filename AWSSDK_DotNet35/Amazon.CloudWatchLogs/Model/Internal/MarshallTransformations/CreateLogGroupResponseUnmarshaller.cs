...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLogGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            CreateLogGroupResponse response = new CreateLogGroupResponse();
        ...
        private static CreateLogGroupResponseUnmarshaller _instance = new CreateLogGroupResponseUnmarshaller();        

        internal static CreateLogGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateLogGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
