...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilteredLogEventUnmarshaller : IUnmarshaller<FilteredLogEvent, XmlUnmarshallerContext>, IUnmarshaller<FilteredLogEvent, JsonUnmarshallerContext>
    {
        FilteredLogEvent IUnmarshaller<FilteredLogEvent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
            throw new NotImplementedException();
        }

        public FilteredLogEvent Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
