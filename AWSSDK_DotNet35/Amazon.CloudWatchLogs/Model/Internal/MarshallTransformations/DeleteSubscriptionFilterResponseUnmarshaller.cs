...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSubscriptionFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            DeleteSubscriptionFilterResponse response = new DeleteSubscriptionFilterResponse();
        ...
        private static DeleteSubscriptionFilterResponseUnmarshaller _instance = new DeleteSubscriptionFilterResponseUnmarshaller();        

        internal static DeleteSubscriptionFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteSubscriptionFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
