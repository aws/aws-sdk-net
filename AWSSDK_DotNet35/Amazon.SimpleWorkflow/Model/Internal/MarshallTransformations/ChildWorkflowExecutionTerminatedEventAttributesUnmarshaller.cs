...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChildWorkflowExecutionTerminatedEventAttributesUnmarshaller : IUnmarshaller<ChildWorkflowExecutionTerminatedEventAttributes, XmlUnmarshallerContext>, IUnmarshaller<ChildWorkflowExecutionTerminatedEventAttributes, JsonUnmarshallerContext>
    {
        ...
        private static ChildWorkflowExecutionTerminatedEventAttributesUnmarshaller _instance = new ChildWorkflowExecutionTerminatedEventAttributesUnmarshaller();        

        public static ChildWorkflowExecutionTerminatedEventAttributesUnmarshaller Instance
        {
            get
            {
                return _instance;
