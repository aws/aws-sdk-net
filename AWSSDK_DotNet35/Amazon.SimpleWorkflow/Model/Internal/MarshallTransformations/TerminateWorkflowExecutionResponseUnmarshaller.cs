...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TerminateWorkflowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static TerminateWorkflowExecutionResponseUnmarshaller _instance = new TerminateWorkflowExecutionResponseUnmarshaller();        

        internal static TerminateWorkflowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static TerminateWorkflowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
