...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetWorkflowExecutionHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static GetWorkflowExecutionHistoryResponseUnmarshaller _instance = new GetWorkflowExecutionHistoryResponseUnmarshaller();        

        internal static GetWorkflowExecutionHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetWorkflowExecutionHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
