 ...
 */
    ...
    namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class CountOpenWorkflowExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static CountOpenWorkflowExecutionsResponseUnmarshaller instance;
        public static CountOpenWorkflowExecutionsResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new CountOpenWorkflowExecutionsResponseUnmarshaller();
          }
          return instance;
        }
