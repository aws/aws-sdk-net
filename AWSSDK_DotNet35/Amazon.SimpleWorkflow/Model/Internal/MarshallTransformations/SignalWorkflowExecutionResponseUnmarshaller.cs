...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SignalWorkflowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static SignalWorkflowExecutionResponseUnmarshaller _instance = new SignalWorkflowExecutionResponseUnmarshaller();        

        internal static SignalWorkflowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static SignalWorkflowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
