 ...
 */
    ...
    namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DescribeWorkflowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private void UnmarshallResult(JsonUnmarshallerContext context,DescribeWorkflowExecutionResponse response)
        {                   
        ...
        private static DescribeWorkflowExecutionResponseUnmarshaller instance;
        public static DescribeWorkflowExecutionResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeWorkflowExecutionResponseUnmarshaller();
          }
          return instance;
        }
