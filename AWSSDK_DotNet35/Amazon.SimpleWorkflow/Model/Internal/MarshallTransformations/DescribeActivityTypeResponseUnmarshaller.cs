 ...
 */
    ...
    namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
    {
      ...
      internal class DescribeActivityTypeResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static DescribeActivityTypeResponseUnmarshaller instance;
        public static DescribeActivityTypeResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeActivityTypeResponseUnmarshaller();
          }
          return instance;
        }
