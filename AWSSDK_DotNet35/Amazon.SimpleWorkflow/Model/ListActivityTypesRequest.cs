...
namespace Amazon.SimpleWorkflow.Model
{
    ...
    public partial class ListActivityTypesRequest : AmazonSimpleWorkflowRequest
    {
        ...
        /// <para>
        ///  If on a previous call to this method a <code>NextResultToken</code> was returned,
        /// the results have more than one page. To get the next page of results, repeat the call
        /// with the <code>nextPageToken</code> and keep all other arguments unchanged. 
        /// </para>
        /// </summary>
