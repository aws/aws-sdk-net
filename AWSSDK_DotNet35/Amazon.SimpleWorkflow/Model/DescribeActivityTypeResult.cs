...
namespace Amazon.SimpleWorkflow.Model
{
    ...
    public partial class DescribeActivityTypeResult : AmazonWebServiceResponse
    {
        ...
        public ActivityTypeDetail ActivityTypeDetail
        {
            ...
            set { this._activityTypeDetail = value; }
        }

        // Check to see if ActivityTypeDetail property is set
        internal bool IsSetActivityTypeDetail()
        {
            return this._activityTypeDetail != null;
        }
    }
}