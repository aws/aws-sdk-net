...
{
    /// <summary>
    /// <para>Provides details of the <c>RecordMarkerFailed</c> event.</para>
    /// </summary>
    public class RecordMarkerFailedEventAttributes
    {
        ...
        ///         <description>OPERATION_NOT_PERMITTED</description>
        ///     </item>
        /// </list>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// The id of the <c>DecisionTaskCompleted</c> event corresponding to the decision task that resulted in the <c>RecordMarkerFailed</c> decision
        /// for this cancellation request. This information can be useful for diagnosing problems by tracing back the cause of events.
        ///  
        /// </summary>
