...
{
    /// <summary>
    /// Container for the parameters to the DescribeHAPartitionGroup operation.
    /// Describes an HA partition group
    /// </summary>
    public partial class DescribeHAPartitionGroupRequest : AmazonCloudHSMRequest
    {
