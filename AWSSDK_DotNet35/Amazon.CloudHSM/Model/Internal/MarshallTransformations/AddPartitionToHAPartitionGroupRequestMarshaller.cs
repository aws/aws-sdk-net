...
{
    /// <summary>
    /// AddPartitionToHAPartitionGroup Request Marshaller
    /// </summary>       
    public class AddPartitionToHAPartitionGroupRequestMarshaller : IMarshaller<IRequest, AddPartitionToHAPartitionGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((AddPartitionToHAPartitionGroupRequest)input);
        }

        public IRequest Marshall(AddPartitionToHAPartitionGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudHSM");
            string target = "cloudhsm.AddPartitionToHAPartitionGroup";
