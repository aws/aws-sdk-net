...
{
    /// <summary>
    /// DescribeClient Request Marshaller
    /// </summary>       
    public class DescribeClientRequestMarshaller : IMarshaller<IRequest, DescribeClientRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((DescribeClientRequest)input);
        }

        public IRequest Marshall(DescribeClientRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudHSM");
            string target = "cloudhsm.DescribeClient";
