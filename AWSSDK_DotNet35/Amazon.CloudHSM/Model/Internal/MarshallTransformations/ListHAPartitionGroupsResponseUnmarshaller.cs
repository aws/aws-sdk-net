...
{
    /// <summary>
    /// Response Unmarshaller for ListHAPartitionGroups operation
    /// </summary>  
    public class ListHAPartitionGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ListHAPartitionGroupsResponse response = new ListHAPartitionGroupsResponse();
        ...
        private static ListHAPartitionGroupsResponseUnmarshaller _instance = new ListHAPartitionGroupsResponseUnmarshaller();        

        internal static ListHAPartitionGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListHAPartitionGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
