...
{
    /// <summary>
    /// RemoveHAPartitionGroupFromClient Request Marshaller
    /// </summary>       
    public class RemoveHAPartitionGroupFromClientRequestMarshaller : IMarshaller<IRequest, RemoveHAPartitionGroupFromClientRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((RemoveHAPartitionGroupFromClientRequest)input);
        }

        public IRequest Marshall(RemoveHAPartitionGroupFromClientRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudHSM");
            string target = "cloudhsm.RemoveHAPartitionGroupFromClient";
