...
{
    /// <summary>
    /// Response Unmarshaller for CreateClient operation
    /// </summary>  
    public class CreateClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateClientResponseUnmarshaller _instance = new CreateClientResponseUnmarshaller();        

        internal static CreateClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
