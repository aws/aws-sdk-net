...
{
    /// <summary>
    /// ModifyLunaClient Request Marshaller
    /// </summary>       
    public class ModifyLunaClientRequestMarshaller : IMarshaller<IRequest, ModifyLunaClientRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((ModifyLunaClientRequest)input);
        }

        public IRequest Marshall(ModifyLunaClientRequest publicRequest)
        {
