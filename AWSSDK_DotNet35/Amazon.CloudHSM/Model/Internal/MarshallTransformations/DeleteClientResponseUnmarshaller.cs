...
{
    /// <summary>
    /// Response Unmarshaller for DeleteClient operation
    /// </summary>  
    public class DeleteClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeleteClientResponseUnmarshaller _instance = new DeleteClientResponseUnmarshaller();        

        internal static DeleteClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeleteClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
