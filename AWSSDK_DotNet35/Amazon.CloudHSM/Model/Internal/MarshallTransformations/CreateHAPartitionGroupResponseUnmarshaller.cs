...
{
    /// <summary>
    /// Response Unmarshaller for CreateHAPartitionGroup operation
    /// </summary>  
    public class CreateHAPartitionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            CreateHAPartitionGroupResponse response = new CreateHAPartitionGroupResponse();
        ...
        private static CreateHAPartitionGroupResponseUnmarshaller _instance = new CreateHAPartitionGroupResponseUnmarshaller();        

        internal static CreateHAPartitionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static CreateHAPartitionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
