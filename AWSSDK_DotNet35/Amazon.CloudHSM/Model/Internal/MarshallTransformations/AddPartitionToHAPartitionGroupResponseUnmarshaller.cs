...
{
    /// <summary>
    /// Response Unmarshaller for AddPartitionToHAPartitionGroup operation
    /// </summary>  
    public class AddPartitionToHAPartitionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            AddPartitionToHAPartitionGroupResponse response = new AddPartitionToHAPartitionGroupResponse();
        ...
        private static AddPartitionToHAPartitionGroupResponseUnmarshaller _instance = new AddPartitionToHAPartitionGroupResponseUnmarshaller();        

        internal static AddPartitionToHAPartitionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static AddPartitionToHAPartitionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
