...
{
    /// <summary>
    /// Response Unmarshaller for ListClients operation
    /// </summary>  
    public class ListClientsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ListClientsResponseUnmarshaller _instance = new ListClientsResponseUnmarshaller();        

        internal static ListClientsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListClientsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
