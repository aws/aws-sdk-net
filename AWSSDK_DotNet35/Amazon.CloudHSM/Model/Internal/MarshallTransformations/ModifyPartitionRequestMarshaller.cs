...
{
    /// <summary>
    /// ModifyPartition Request Marshaller
    /// </summary>       
    public class ModifyPartitionRequestMarshaller : IMarshaller<IRequest, ModifyPartitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((ModifyPartitionRequest)input);
        }

        public IRequest Marshall(ModifyPartitionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudHSM");
            string target = "cloudhsm.ModifyPartition";
