...
{
    /// <summary>
    /// Response Unmarshaller for ModifyClient operation
    /// </summary>  
    public class ModifyClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ModifyClientResponse response = new ModifyClientResponse();
        ...
        private static ModifyClientResponseUnmarshaller _instance = new ModifyClientResponseUnmarshaller();        

        internal static ModifyClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ModifyClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
