...
{
    /// <summary>
    /// Response Unmarshaller for GetClientConfiguration operation
    /// </summary>  
    public class GetClientConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            GetClientConfigurationResponse response = new GetClientConfigurationResponse();
        ...
        private static GetClientConfigurationResponseUnmarshaller _instance = new GetClientConfigurationResponseUnmarshaller();        

        internal static GetClientConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static GetClientConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
