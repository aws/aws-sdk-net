...
{
    /// <summary>
    /// ModifyClient Request Marshaller
    /// </summary>       
    public class ModifyClientRequestMarshaller : IMarshaller<IRequest, ModifyClientRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((ModifyClientRequest)input);
        }

        public IRequest Marshall(ModifyClientRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudHSM");
            string target = "cloudhsm.ModifyClient";
