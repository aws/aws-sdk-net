...
{
    /// <summary>
    /// Response Unmarshaller for AddHAPartitionGroupToClient operation
    /// </summary>  
    public class AddHAPartitionGroupToClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            AddHAPartitionGroupToClientResponse response = new AddHAPartitionGroupToClientResponse();
        ...
        private static AddHAPartitionGroupToClientResponseUnmarshaller _instance = new AddHAPartitionGroupToClientResponseUnmarshaller();        

        internal static AddHAPartitionGroupToClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static AddHAPartitionGroupToClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
