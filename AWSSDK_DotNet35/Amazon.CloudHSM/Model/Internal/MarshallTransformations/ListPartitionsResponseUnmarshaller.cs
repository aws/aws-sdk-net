...
{
    /// <summary>
    /// Response Unmarshaller for ListPartitions operation
    /// </summary>  
    public class ListPartitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ListPartitionsResponseUnmarshaller _instance = new ListPartitionsResponseUnmarshaller();        

        internal static ListPartitionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static ListPartitionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
