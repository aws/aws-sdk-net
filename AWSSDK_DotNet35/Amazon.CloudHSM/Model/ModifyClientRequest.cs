...
{
    /// <summary>
    /// Container for the parameters to the ModifyClient operation.
    /// Modifies a client's attributes
    /// </summary>
    public partial class ModifyClientRequest : AmazonCloudHSMRequest
    {
