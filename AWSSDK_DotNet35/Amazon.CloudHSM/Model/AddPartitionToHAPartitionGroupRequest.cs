...
{
    /// <summary>
    /// Container for the parameters to the AddPartitionToHAPartitionGroup operation.
    /// Adds a partition to an HA partition group
    /// </summary>
    public partial class AddPartitionToHAPartitionGroupRequest : AmazonCloudHSMRequest
    {
