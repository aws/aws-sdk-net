...
{
    /// <summary>
    /// Container for the parameters to the GetClientConfiguration operation.
    /// Get the configuration for aa Client.
    /// </summary>
    public partial class GetClientConfigurationRequest : AmazonCloudHSMRequest
    {
