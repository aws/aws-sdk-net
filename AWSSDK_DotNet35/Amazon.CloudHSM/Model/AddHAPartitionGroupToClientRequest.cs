...
{
    /// <summary>
    /// Container for the parameters to the AddHAPartitionGroupToClient operation.
    /// Adds an HAPG to a Client.
    /// </summary>
    public partial class AddHAPartitionGroupToClientRequest : AmazonCloudHSMRequest
    {
