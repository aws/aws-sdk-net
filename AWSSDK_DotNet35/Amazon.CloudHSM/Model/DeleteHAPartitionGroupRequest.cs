...
{
    /// <summary>
    /// Container for the parameters to the DeleteHAPartitionGroup operation.
    /// Delete an HAPartitionGroup
    /// </summary>
    public partial class DeleteHAPartitionGroupRequest : AmazonCloudHSMRequest
    {
