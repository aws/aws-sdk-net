...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class SubscribeRequest : AmazonSimpleNotificationServiceRequest
    {
        ...
        /// </para>
        ///  <ul> <li>For the <code>http</code> protocol, the endpoint is an URL beginning with
        /// "http://"</li> <li>For the <code>https</code> protocol, the endpoint is a URL beginning
        /// with "https://"</li> <li>For the <code>email</code> protocol, the endpoint is an email
        /// address</li> <li>For the <code>email-json</code> protocol, the endpoint is an email
        /// address</li> <li>For the <code>sms</code> protocol, the endpoint is a phone number
        /// of an SMS-enabled device</li> <li>For the <code>sqs</code> protocol, the endpoint
        /// is the ARN of an Amazon SQS queue</li> <li>For the <code>application</code> protocol,
        ...
        /// <li> <code>https</code> -- delivery of JSON-encoded message via HTTPS POST</li> <li>
        /// <code>email</code> -- delivery of message via SMTP</li> <li> <code>email-json</code>
