...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class GetSubscriptionAttributesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {   
            GetSubscriptionAttributesResponse response = new GetSubscriptionAttributesResponse();
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,GetSubscriptionAttributesResponse response)
        {
        ...
        private static GetSubscriptionAttributesResponseUnmarshaller instance;

        public static GetSubscriptionAttributesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new GetSubscriptionAttributesResponseUnmarshaller();
            }
            return instance;
        }
