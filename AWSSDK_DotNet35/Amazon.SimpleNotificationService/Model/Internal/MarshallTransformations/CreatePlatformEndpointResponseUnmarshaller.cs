...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CreatePlatformEndpointResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,CreatePlatformEndpointResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.EndpointArn = StringUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static CreatePlatformEndpointResponseUnmarshaller instance;
