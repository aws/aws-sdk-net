...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeletePlatformApplicationResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            DeletePlatformApplicationResponse response = new DeletePlatformApplicationResponse();
        ...
        private static DeletePlatformApplicationResponseUnmarshaller instance;
