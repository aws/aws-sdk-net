...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ListEndpointsByPlatformApplicationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListEndpointsByPlatformApplicationResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.Endpoints.Add(EndpointUnmarshaller.GetInstance().Unmarshall(context));
        ...
        private static ListEndpointsByPlatformApplicationResponseUnmarshaller instance;

        public static ListEndpointsByPlatformApplicationResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ListEndpointsByPlatformApplicationResponseUnmarshaller();
            }
            return instance;
        }
