...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ConfirmSubscriptionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ConfirmSubscriptionResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.SubscriptionArn = StringUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static ConfirmSubscriptionResponseUnmarshaller instance;
