...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ListPlatformApplicationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ListPlatformApplicationsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.PlatformApplications.Add(PlatformApplicationUnmarshaller.GetInstance().Unmarshall(context));
        ...
        private static ListPlatformApplicationsResponseUnmarshaller instance;

        public static ListPlatformApplicationsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ListPlatformApplicationsResponseUnmarshaller();
            }
            return instance;
        }
