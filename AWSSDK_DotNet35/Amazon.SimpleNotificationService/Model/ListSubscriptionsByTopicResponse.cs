...
{
    /// <summary>
    /// Returns information about the  ListSubscriptionsByTopic response and response metadata.
    /// </summary>
    public class ListSubscriptionsByTopicResponse : ListSubscriptionsByTopicResult
    {
        /// <summary>
