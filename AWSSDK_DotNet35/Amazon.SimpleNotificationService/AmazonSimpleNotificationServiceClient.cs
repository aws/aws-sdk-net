...
namespace Amazon.SimpleNotificationService
{
    ...
    public partial class AmazonSimpleNotificationServiceClient : AmazonServiceClient, IAmazonSimpleNotificationService
    {
        ...
        /// </exception>
        public ConfirmSubscriptionResponse ConfirmSubscription(string token, string topicArn)
        {
        ...
        /// Indicates that a request parameter does not comply with the associated constraints.
        /// </exception>
        public CreatePlatformApplicationResponse CreatePlatformApplication(string name, string platform, Dictionary<string, string> attributes)
        {
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public CreatePlatformEndpointResponse CreatePlatformEndpoint(string token, string platformApplicationArn)
        {
        ...
        /// Indicates that a request parameter does not comply with the associated constraints.
        /// </exception>
        public DeleteEndpointResponse DeleteEndpoint(string endpointArn)
        {
        ...
        /// Indicates that a request parameter does not comply with the associated constraints.
        /// </exception>
        public DeletePlatformApplicationResponse DeletePlatformApplication(string platformApplicationArn)
        {
            var request = new DeletePlatformApplicationRequest();
            request.PlatformApplicationArn = platformApplicationArn;
            return DeletePlatformApplication(request);
        }
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public ListEndpointsByPlatformApplicationResponse ListEndpointsByPlatformApplication(string platformApplicationArn)
        {
            var request = new ListEndpointsByPlatformApplicationRequest();
            request.PlatformApplicationArn = platformApplicationArn;
            return ListEndpointsByPlatformApplication(request);
        }
        ...
        public ListPlatformApplicationsResponse ListPlatformApplications()
        {
            ...
            return ListPlatformApplications(request);
        }
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public RemovePermissionResponse RemovePermission(string label, string topicArn)
        {
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public SetEndpointAttributesResponse SetEndpointAttributes(Dictionary<string, string> attributes, string endpointArn)
        {
            var request = new SetEndpointAttributesRequest();
            request.Attributes = attributes;
            request.EndpointArn = endpointArn;
            return SetEndpointAttributes(request);
        }
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public SetPlatformApplicationAttributesResponse SetPlatformApplicationAttributes(Dictionary<string, string> attributes, string platformApplicationArn)
        {
            var request = new SetPlatformApplicationAttributesRequest();
            request.Attributes = attributes;
            request.PlatformApplicationArn = platformApplicationArn;
            return SetPlatformApplicationAttributes(request);
        }
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public SetSubscriptionAttributesResponse SetSubscriptionAttributes(string attributeName, string attributeValue, string subscriptionArn)
        {
        ...
        /// Indicates that the requested resource does not exist.
        /// </exception>
        public SetTopicAttributesResponse SetTopicAttributes(string attributeName, string attributeValue, string topicArn)
        {
        ...
        /// Indicates that the customer already owns the maximum allowed number of subscriptions.
        /// </exception>
        public SubscribeResponse Subscribe(string endpoint, string protocol, string topicArn)
        {
