...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DisableAlarmActionsResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            DisableAlarmActionsResponse response = new DisableAlarmActionsResponse();
        ...
        private static DisableAlarmActionsResponseUnmarshaller instance;

        public static DisableAlarmActionsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DisableAlarmActionsResponseUnmarshaller();
            }
            return instance;
        }
