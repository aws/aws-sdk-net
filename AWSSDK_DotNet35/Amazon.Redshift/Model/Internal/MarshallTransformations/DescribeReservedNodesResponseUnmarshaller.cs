...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeReservedNodesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeReservedNodesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.ReservedNodes.Add(ReservedNodeUnmarshaller.GetInstance().Unmarshall(context));
