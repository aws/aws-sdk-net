...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class RevokeClusterSecurityGroupIngressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static RevokeClusterSecurityGroupIngressResponseUnmarshaller _instance = new RevokeClusterSecurityGroupIngressResponseUnmarshaller();        

        internal static RevokeClusterSecurityGroupIngressResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RevokeClusterSecurityGroupIngressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
