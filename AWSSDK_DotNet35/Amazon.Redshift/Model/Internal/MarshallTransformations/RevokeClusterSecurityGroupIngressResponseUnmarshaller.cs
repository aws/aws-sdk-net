...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    internal class RevokeClusterSecurityGroupIngressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,RevokeClusterSecurityGroupIngressResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.ClusterSecurityGroup = ClusterSecurityGroupUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
