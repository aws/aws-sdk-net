...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeEventSubscriptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeEventSubscriptionsResponseUnmarshaller _instance = new DescribeEventSubscriptionsResponseUnmarshaller();        

        internal static DescribeEventSubscriptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeEventSubscriptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
