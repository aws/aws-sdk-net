...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateClusterSecurityGroupRequestMarshaller : IMarshaller<IRequest, CreateClusterSecurityGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((CreateClusterSecurityGroupRequest)input);
        }
