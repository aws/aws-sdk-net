...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeEventCategoriesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeEventCategoriesResponseUnmarshaller _instance = new DescribeEventCategoriesResponseUnmarshaller();        

        internal static DescribeEventCategoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeEventCategoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
