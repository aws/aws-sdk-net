...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeOrderableClusterOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeOrderableClusterOptionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.OrderableClusterOptions.Add(OrderableClusterOptionUnmarshaller.GetInstance().Unmarshall(context));
