...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RotateEncryptionKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static RotateEncryptionKeyResponseUnmarshaller _instance = new RotateEncryptionKeyResponseUnmarshaller();        

        internal static RotateEncryptionKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static RotateEncryptionKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
