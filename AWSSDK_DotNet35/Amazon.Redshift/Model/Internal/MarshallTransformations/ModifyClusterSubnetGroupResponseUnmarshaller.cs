...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    internal class ModifyClusterSubnetGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,ModifyClusterSubnetGroupResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.ClusterSubnetGroup = ClusterSubnetGroupUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
