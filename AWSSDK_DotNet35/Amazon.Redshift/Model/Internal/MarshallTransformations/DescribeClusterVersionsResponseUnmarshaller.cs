...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    internal class DescribeClusterVersionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private void UnmarshallResult(XmlUnmarshallerContext context,DescribeClusterVersionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.ClusterVersions.Add(ClusterVersionUnmarshaller.GetInstance().Unmarshall(context));
