...
{
    /// <summary>
    /// Returns information about the  DescribeEventCategories response and response metadata.
    /// </summary>
    public class DescribeEventCategoriesResponse : DescribeEventCategoriesResult
    {
        /// <summary>
