If you’re new to the AWS S3 SDK, you’ll probably want to look first at [Getting Started with the AWS S3 SDK for .NET/Xamarin](deep link path) which explains how to set up the SDK and how to get started using AWS S3 services from an Xamarin application.
