If you’re new to the AWS SimpleNotificationService SDK, you’ll probably want to look first at [Getting Started with the AWS SimpleNotificationService SDK for .NET/Xamarin](deep link path) which explains how to set up the SDK and how to get started using AWS SimpleNotificationService services from an Xamarin application.
