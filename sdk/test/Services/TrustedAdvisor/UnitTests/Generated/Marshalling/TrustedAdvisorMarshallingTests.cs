...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class TrustedAdvisorMarshallingTests
    {
        ...
        public void BatchUpdateRecommendationResourceExclusionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchUpdateRecommendationResourceExclusion");

            var request = InstantiateClassGenerator.Execute<BatchUpdateRecommendationResourceExclusionRequest>(operation);
            var marshaller = new BatchUpdateRecommendationResourceExclusionRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("BatchUpdateRecommendationResourceExclusion", request, internalRequest, service_model);
            ...
            ResponseUnmarshaller unmarshaller = BatchUpdateRecommendationResourceExclusionResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as BatchUpdateRecommendationResourceExclusionResponse;
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("TrustedAdvisor")]
        public void BatchUpdateRecommendationResourceExclusion_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchUpdateRecommendationResourceExclusion");
            ...
            var response = BatchUpdateRecommendationResourceExclusionResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("TrustedAdvisor")]
        public void BatchUpdateRecommendationResourceExclusion_ConflictExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchUpdateRecommendationResourceExclusion");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("TrustedAdvisor")]
        public void BatchUpdateRecommendationResourceExclusion_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchUpdateRecommendationResourceExclusion");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("TrustedAdvisor")]
        public void BatchUpdateRecommendationResourceExclusion_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchUpdateRecommendationResourceExclusion");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("TrustedAdvisor")]
        public void BatchUpdateRecommendationResourceExclusion_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchUpdateRecommendationResourceExclusion");
