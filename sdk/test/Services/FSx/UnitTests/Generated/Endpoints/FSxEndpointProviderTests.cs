...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class FSxEndpointsTests
    {
        ...
        public void For_region_mecentral1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            var endpoint = new AmazonFSxEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fsx-fips.me-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "me-central-1";
            var endpoint = new AmazonFSxEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fsx-fips.me-central-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["Region"] = "me-central-1";
            var endpoint = new AmazonFSxEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fsx.me-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "me-central-1";
            var endpoint = new AmazonFSxEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fsx.me-central-1.amazonaws.com", endpoint.URL);
        }
