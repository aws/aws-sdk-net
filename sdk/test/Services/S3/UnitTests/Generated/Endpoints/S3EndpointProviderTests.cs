    ...
    public partial class S3EndpointsTests
    {
        ...
        public void Region_is_not_a_valid_DNSsuffix_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            });
        ...
        public void Invalid_access_point_ARN_Not_S3_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The ARN was not for the S3 service, found: not-s3", exception.Message);
        }
        ...
        public void Invalid_access_point_ARN_invalid_resource_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The ARN may only contain a single resource component after `accesspoint`.", exception.Message);
        }
        ...
        public void Invalid_access_point_ARN_invalid_no_ap_name_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: Expected a resource of the format `accesspoint:<accesspoint name>` but no name was provided", exception.Message);
        }
        ...
        public void Invalid_access_point_ARN_AccountId_is_invalid_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The account id may only contain a-z, A-Z, 0-9 and `-`. Found: `123456_789012`", exception.Message);
        }
        ...
        public void Invalid_access_point_ARN_access_point_name_is_invalid_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The access point name may only contain a-z, A-Z, 0-9 and `-`. Found: `ap_name`", exception.Message);
        }
        ...
        public void Bucket_region_is_invalid_Test()
        {
            ...
            Assert.AreEqual(@"Invalid region in ARN: `us-west -2` (invalid DNS name)", exception.Message);
        }
        ...
        public void Access_points_when_Access_points_explicitly_disabled_used_for_CreateBucket_Test()
        {
            ...
            Assert.AreEqual(@"Access points are not supported for this operation", exception.Message);
        }
        ...
        public void Missing_arn_type_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: `arn:aws:s3:us-west-2:123456789012:` was not a valid ARN", exception.Message);
        }
        ...
        public void SDKHost_access_point_Dualstack_is_an_error_Test()
        {
            ...
            Assert.AreEqual(@"Cannot set dual-stack in combination with a custom endpoint.", exception.Message);
        }
        ...
        public void MRAP_does_not_support_FIPS_Test()
        {
            ...
            Assert.AreEqual(@"S3 MRAP does not support FIPS", exception.Message);
        }
        ...
        public void MRAP_does_not_support_DualStack_Test()
        {
            ...
            Assert.AreEqual(@"S3 MRAP does not support dual-stack", exception.Message);
        }
        ...
        public void MRAP_does_not_support_S3_Accelerate_Test()
        {
            ...
            Assert.AreEqual(@"S3 MRAP does not support S3 Accelerate", exception.Message);
        }
        ...
        public void MRAP_explicitly_disabled_Test()
        {
            ...
            Assert.AreEqual(@"Invalid configuration: Multi-Region Access Point ARNs are disabled.", exception.Message);
        }
        ...
        public void Path_style_ARN_bucket_Test()
        {
            ...
            Assert.AreEqual(@"Path-style addressing cannot be used with ARN buckets", exception.Message);
        }
        ...
        public void Invalid_Endpoint_override_Test()
        {
            ...
            Assert.AreEqual(@"Custom endpoint `abcde://nota#url` was not a valid URI", exception.Message);
        }
        ...
        public void No_region_set_Test()
        {
            ...
            Assert.AreEqual(@"A region must be set when sending requests to S3.", exception.Message);
        }
        ...
        public void Cross_partition_MRAP_ARN_is_an_error_Test()
        {
            ...
            Assert.AreEqual(@"Client was configured for partition `aws` but bucket referred to partition `aws-cn`", exception.Message);
        }
        ...
        public void Nonbucket_endpoint_override_with_FIPS_error_Test()
        {
            ...
            Assert.AreEqual(@"A custom endpoint cannot be combined with FIPS", exception.Message);
        }
        ...
        public void Empty_arn_type_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: No ARN type specified", exception.Message);
        }
        ...
        public void Path_style_cant_be_used_with_accelerate_Test()
        {
            ...
            Assert.AreEqual(@"Path-style addressing cannot be used with S3 Accelerate", exception.Message);
        }
        ...
        public void Empty_arn_type_1_Test()
        {
            ...
            Assert.AreEqual(@"Invalid Access Point Name", exception.Message);
        }
        ...
        public void Empty_arn_type_2_Test()
        {
            ...
            Assert.AreEqual(@"Client was configured for partition `aws` but ARN (`arn:aws:s3:cn-north-1:123456789012:accesspoint:my-endpoint`) has `aws-cn`", exception.Message);
        }
        ...
        public void Invalid_arn_region_Test()
        {
            ...
            Assert.AreEqual(@"Invalid region in ARN: `us-east_2` (invalid DNS name)", exception.Message);
        }
        ...
        public void Invalid_ARN_outpost_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The outpost Id may only contain a-z, A-Z, 0-9 and `-`. Found: `op_01234567890123456`", exception.Message);
        }
        ...
        public void Invalid_ARN_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: expected an access point name", exception.Message);
        }
        ...
        public void Invalid_outpost_type_Test()
        {
            ...
            Assert.AreEqual(@"Expected an outpost type `accesspoint`, found not-accesspoint", exception.Message);
        }
        ...
        public void Invalid_outpost_type_1_Test()
        {
            ...
            Assert.AreEqual(@"Invalid region in ARN: `us-east_1` (invalid DNS name)", exception.Message);
        }
        ...
        public void Invalid_outpost_type_2_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The account id may only contain a-z, A-Z, 0-9 and `-`. Found: `12345_789012`", exception.Message);
        }
        ...
        public void Accelerate_fips_erroruswest2_Test()
        {
            ...
            Assert.AreEqual(@"Accelerate cannot be used with FIPS", exception.Message);
        }
        ...
        public void Accelerate_dualstackfalsecnnorth1_Test()
        {
            ...
            Assert.AreEqual(@"S3 Accelerate cannot be used in this region", exception.Message);
        }
        ...
        public void SDKHOST_accelerateuswest2_Test()
        {
            ...
            Assert.AreEqual(@"A custom endpoint cannot be combined with S3 Accelerate", exception.Message);
        }
        ...
        public void Access_point_arn_accelerate_erroruswest2_Test()
        {
            ...
            Assert.AreEqual(@"Access Points do not support S3 Accelerate", exception.Message);
        }
        ...
        public void Outposts_arn_with_partition_mismatch_and_UseArnRegiontrue_Test()
        {
            ...
            Assert.AreEqual(@"Client was configured for partition `aws` but ARN (`arn:aws:s3-outposts:cn-north-1:123456789012:outpost:op-01234567890123456:accesspoint:myaccesspoint`) has `aws-cn`", exception.Message);
        }
        ...
        public void S3_outposts_does_not_support_dualstack_Test()
        {
            ...
            Assert.AreEqual(@"S3 Outposts does not support Dual-stack", exception.Message);
        }
        ...
        public void S3_outposts_does_not_support_fips_Test()
        {
            ...
            Assert.AreEqual(@"S3 Outposts does not support FIPS", exception.Message);
        }
        ...
        public void S3_outposts_does_not_support_accelerate_Test()
        {
            ...
            Assert.AreEqual(@"S3 Outposts does not support S3 Accelerate", exception.Message);
        }
        ...
        public void Validates_against_subresource_Test()
        {
            ...
            Assert.AreEqual(@"Invalid Arn: Outpost Access Point ARN contains sub resources", exception.Message);
        }
        ...
        public void Validates_against_access_point_host_label_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The access point name may only contain a-z, A-Z, 0-9 and `-`. Found: `invalid.bucket#`", exception.Message);
        }
        ...
        public void Object_lambda_useast1_client_region_s3external1_useArnRegionfalse_Test()
        {
            ...
            Assert.AreEqual(@"Invalid configuration: region from ARN `us-east-1` does not match client region `s3-external-1` and UseArnRegion is `false`", exception.Message);
        }
        ...
        public void Object_lambda_useast1_client_region_awsglobal_useArnRegionfalse_Test()
        {
            ...
            Assert.AreEqual(@"Invalid configuration: region from ARN `us-east-1` does not match client region `aws-global` and UseArnRegion is `false`", exception.Message);
        }
        ...
        public void Object_lambda_cnnorth1_client_region_uswest2_cross_partition_useArnRegiontrue_Test()
        {
            ...
            Assert.AreEqual(@"Client was configured for partition `aws` but ARN (`arn:aws-cn:s3-object-lambda:cn-north-1:123456789012:accesspoint/mybanner`) has `aws-cn`", exception.Message);
        }
        ...
        public void Object_lambda_with_dualstack_Test()
        {
            ...
            Assert.AreEqual(@"S3 Object Lambda does not support Dual-stack", exception.Message);
        }
        ...
        public void Object_lambda_with_accelerate_Test()
        {
            ...
            Assert.AreEqual(@"S3 Object Lambda does not support S3 Accelerate", exception.Message);
        }
        ...
        public void Object_lambda_with_invalid_arn_bad_service_and_someresource_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: Unrecognized format: arn:aws:sqs:us-west-2:123456789012:someresource (type: someresource)", exception.Message);
        }
        ...
        public void Object_lambda_with_invalid_arn_invalid_resource_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: Object Lambda ARNs only support `accesspoint` arn types, but found: `bucket_name`", exception.Message);
        }
        ...
        public void Object_lambda_with_invalid_arn_missing_region_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: bucket ARN is missing a region", exception.Message);
        }
        ...
        public void Object_lambda_with_invalid_arn_account_id_contains_invalid_characters_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The account id may only contain a-z, A-Z, 0-9 and `-`. Found: `123.45678.9012`", exception.Message);
        }
        ...
        public void Object_lambda_with_invalid_arn_access_point_name_contains_invalid_character__Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The access point name may only contain a-z, A-Z, 0-9 and `-`. Found: `*`", exception.Message);
        }
        ...
        public void Object_lambda_with_invalid_arn_access_point_name_contains_invalid_character__1_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The access point name may only contain a-z, A-Z, 0-9 and `-`. Found: `my.bucket`", exception.Message);
        }
        ...
        public void S3_Outposts_bucketAlias_No_endpoint_set_for_beta_Test()
        {
            ...
            Assert.AreEqual(@"Expected a endpoint to be specified but no endpoint was found", exception.Message);
        }
        ...
        public void S3_Outposts_invalid_bucket_name_Test()
        {
            ...
            Assert.AreEqual(@"Invalid Outposts Bucket alias - it must be a valid bucket name.", exception.Message);
        }
        ...
        public void S3_Outposts_bucketAlias_Invalid_hardware_type_Test()
        {
            ...
            Assert.AreEqual(@"Unrecognized hardware type: ""Expected hardware type o or e but got h""", exception.Message);
        }
        ...
        public void S3_Outposts_bucketAlias_Special_character_in_Outpost_Arn_Test()
        {
            ...
            Assert.AreEqual(@"Invalid ARN: The outpost Id must only contain a-z, A-Z, 0-9 and `-`.", exception.Message);
        }
        ...
        public void Bad_format_error_Test()
        {
            ...
            Assert.AreEqual(@"Unrecognized S3Express bucket name format.", exception.Message);
        }
        ...
        public void Accelerate_error_Test()
        {
            ...
            Assert.AreEqual(@"S3Express does not support S3 Accelerate.", exception.Message);
        }
        ...
        public void Data_plane_bucket_format_error_Test()
        {
            ...
            Assert.AreEqual(@"S3Express bucket name is not a valid virtual hostable name.", exception.Message);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Control plane without bucket and dualstack")]
        public void Control_plane_without_bucket_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["UseFIPS"] = false;
            ...
            parameters["DisableS3ExpressSessionAuth"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://s3express-control.dualstack.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Control plane without bucket, fips and dualstack")]
        public void Control_plane_without_bucket_fips_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["UseFIPS"] = true;
            ...
            parameters["DisableS3ExpressSessionAuth"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://s3express-control-fips.dualstack.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with bucket containing delimiters")]
        public void Data_Plane_with_bucket_containing_delimiters_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["Bucket"] = "my--s3--bucket--abcd-ab1--x-s3";
            parameters["UseFIPS"] = false;
            parameters["UseDualStack"] = false;
            parameters["Accelerate"] = false;
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://my--s3--bucket--abcd-ab1--x-s3.s3express-abcd-ab1.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Control plane with with bucket containing delimiters")]
        public void Control_plane_with_with_bucket_containing_delimiters_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["Bucket"] = "my--s3--bucket--abcd-ab1--x-s3";
            ...
            parameters["DisableS3ExpressSessionAuth"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://s3express-control.us-east-1.amazonaws.com/my--s3--bucket--abcd-ab1--x-s3", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with short AZ and dualstack")]
        public void Data_Plane_with_short_AZ_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--usw2-az1--x-s3.s3express-usw2-az1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with short AZ and FIPS with dualstack")]
        public void Data_Plane_with_short_AZ_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--usw2-az1--x-s3.s3express-fips-usw2-az1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with short AZ and dualstack")]
        public void Data_Plane_sigv4_auth_with_short_AZ_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with short AZ and FIPS with dualstack")]
        public void Data_Plane_sigv4_auth_with_short_AZ_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with zone and dualstack")]
        public void Data_Plane_with_zone_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az12--x-s3";
            parameters["UseFIPS"] = false;
            parameters["UseDualStack"] = true;
            parameters["Accelerate"] = false;
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--usw2-az12--x-s3.s3express-usw2-az12.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with zone and FIPS with dualstack")]
        public void Data_Plane_with_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az12--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--usw2-az12--x-s3.s3express-fips-usw2-az12.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with zone and dualstack")]
        public void Data_Plane_sigv4_auth_with_zone_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az12--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with 9-char zone and FIPS with dualstack")]
        public void Data_Plane_sigv4_auth_with_9char_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--usw2-az12--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with 13-char zone and dualstack")]
        public void Data_Plane_with_13char_zone_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test-zone-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--test-zone-ab1--x-s3.s3express-test-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with 13-char zone and FIPS with dualstack")]
        public void Data_Plane_with_13char_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test-zone-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--test-zone-ab1--x-s3.s3express-fips-test-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with 13-char zone and dualstack")]
        public void Data_Plane_sigv4_auth_with_13char_zone_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test-zone-ab1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with 13-char zone and FIPS with dualstack")]
        public void Data_Plane_sigv4_auth_with_13char_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test-zone-ab1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with 14-char zone and dualstack")]
        public void Data_Plane_with_14char_zone_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-zone-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--test1-zone-ab1--x-s3.s3express-test1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with 14-char zone and FIPS with dualstack")]
        public void Data_Plane_with_14char_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-zone-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--test1-zone-ab1--x-s3.s3express-fips-test1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with 14-char zone and dualstack")]
        public void Data_Plane_sigv4_auth_with_14char_zone_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-zone-ab1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with 14-char zone and FIPS with dualstack")]
        public void Data_Plane_sigv4_auth_with_14char_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-zone-ab1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with long zone (20 cha) and dualstack")]
        public void Data_Plane_with_long_zone_20_cha_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-long1-zone-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--test1-long1-zone-ab1--x-s3.s3express-test1-long1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with long zone (20 char) and FIPS with dualstack")]
        public void Data_Plane_with_long_zone_20_char_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-long1-zone-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mybucket--test1-long1-zone-ab1--x-s3.s3express-fips-test1-long1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with long zone (20 char) and dualstack")]
        public void Data_Plane_sigv4_auth_with_long_zone_20_char_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-long1-zone-ab1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with long zone (20 char) and FIPS with dualstack")]
        public void Data_Plane_sigv4_auth_with_long_zone_20_char_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "mybucket--test1-long1-zone-ab1--x-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Control plane and FIPS with dualstack")]
        public void Control_plane_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["Bucket"] = "mybucket--test-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = true;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://s3express-control-fips.dualstack.us-east-1.amazonaws.com/mybucket--test-ab1--x-s3", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data plane with zone and dualstack and AP")]
        public void Data_plane_with_zone_and_dualstack_and_AP_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--usw2-az1--xa-s3.s3express-usw2-az1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data plane with zone and FIPS with dualstack and AP")]
        public void Data_plane_with_zone_and_FIPS_with_dualstack_and_AP_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--usw2-az1--xa-s3.s3express-fips-usw2-az1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with zone and dualstack and AP")]
        public void Data_Plane_sigv4_auth_with_zone_and_dualstack_and_AP_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane AP sigv4 auth with zone and FIPS with dualstack")]
        public void Data_Plane_AP_sigv4_auth_with_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with zone (9 char) and AP with dualstack")]
        public void Data_Plane_with_zone_9_char_and_AP_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az12--xa-s3";
            parameters["UseFIPS"] = false;
            parameters["UseDualStack"] = true;
            parameters["Accelerate"] = false;
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--usw2-az12--xa-s3.s3express-usw2-az12.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with zone (9 char) and FIPS with AP and dualstack")]
        public void Data_Plane_with_zone_9_char_and_FIPS_with_AP_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az12--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--usw2-az12--xa-s3.s3express-fips-usw2-az12.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with (9 char) zone and dualstack with AP")]
        public void Data_Plane_sigv4_auth_with_9_char_zone_and_dualstack_with_AP_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az12--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Access Point sigv4 auth with (9 char) zone and FIPS with dualstack")]
        public void Access_Point_sigv4_auth_with_9_char_zone_and_FIPS_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--usw2-az12--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with zone (13 char) and AP with dualstack")]
        public void Data_Plane_with_zone_13_char_and_AP_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test-zone-ab1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--test-zone-ab1--xa-s3.s3express-test-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with zone (13 char) and AP with FIPS and dualstack")]
        public void Data_Plane_with_zone_13_char_and_AP_with_FIPS_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test-zone-ab1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--test-zone-ab1--xa-s3.s3express-fips-test-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with (13 char) zone with AP and dualstack")]
        public void Data_Plane_sigv4_auth_with_13_char_zone_with_AP_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test-zone-ab1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with (13 char) zone with AP and FIPS and dualstack")]
        public void Data_Plane_sigv4_auth_with_13_char_zone_with_AP_and_FIPS_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test-zone-ab1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with (14 char) zone and AP with dualstack")]
        public void Data_Plane_with_14_char_zone_and_AP_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-zone-ab1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--test1-zone-ab1--xa-s3.s3express-test1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with (14 char) zone and AP with FIPS and dualstack")]
        public void Data_Plane_with_14_char_zone_and_AP_with_FIPS_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-zone-ab1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--test1-zone-ab1--xa-s3.s3express-fips-test1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane sigv4 auth with (14 char) zone and AP with dualstack")]
        public void Data_Plane_sigv4_auth_with_14_char_zone_and_AP_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-zone-ab1--xa-s3";
        ...
        [TestCategory("S3")]
        [Description("Data Plane with (14 char) zone and AP with FIPS and dualstack")]
        public void Data_Plane_with_14_char_zone_and_AP_with_FIPS_and_dualstack_1_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-zone-ab1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with (20 char) zone and AP with dualstack")]
        public void Data_Plane_with_20_char_zone_and_AP_with_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-long1-zone-ab1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--test1-long1-zone-ab1--xa-s3.s3express-test1-long1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data Plane with (20 char) zone and AP with FIPS and dualstack")]
        public void Data_Plane_with_20_char_zone_and_AP_with_FIPS_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-long1-zone-ab1--xa-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = false;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://myaccesspoint--test1-long1-zone-ab1--xa-s3.s3express-fips-test1-long1-zone-ab1.dualstack.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data plane AP with sigv4 and dualstack")]
        public void Data_plane_AP_with_sigv4_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-long1-zone-ab1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Data plane AP sigv4 with fips and dualstack")]
        public void Data_plane_AP_sigv4_with_fips_and_dualstack_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-west-2";
            parameters["Bucket"] = "myaccesspoint--test1-long1-zone-ab1--xa-s3";
        ...
        [TestCategory("Endpoints")]
        [TestCategory("S3")]
        [Description("Control plane with dualstack and bucket")]
        public void Control_plane_with_dualstack_and_bucket_Test()
        {
            var parameters = new S3EndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["Bucket"] = "mybucket--test-ab1--x-s3";
            ...
            parameters["UseS3ExpressControlEndpoint"] = true;
            var endpoint = new AmazonS3EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://s3express-control.dualstack.us-east-1.amazonaws.com/mybucket--test-ab1--x-s3", endpoint.URL);
        }
