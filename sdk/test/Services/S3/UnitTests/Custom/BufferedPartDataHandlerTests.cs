...
namespace AWSSDK.UnitTests
{
    ...
    public class BufferedPartDataHandlerTests
    {
        ...
        public async Task ProcessPartAsync_InOrderPart_CreatesStreamingDataSource()
        {
            ...
            mockBufferManager.Setup(m => m.AddBufferAsync(It.IsAny<IPartDataSource>(), It.IsAny<CancellationToken>()))
                .Callback<IPartDataSource, CancellationToken>((ds, ct) => capturedDataSource = ds)
        ...
        public async Task ProcessPartAsync_InOrderPart_ReleasesCapacityImmediately()
        {
            ...
            try
            {
                ...
                // We verify the AddBufferAsync was called with a StreamingDataSource
                mockBufferManager.Verify(m => m.AddBufferAsync(
                    It.Is<IPartDataSource>(ds => ds is StreamingDataSource),
        ...
        public async Task ProcessPartAsync_MultipleInOrderParts_AllStreamDirectly()
        {
            ...
            mockBufferManager.Setup(m => m.AddBufferAsync(It.IsAny<IPartDataSource>(), It.IsAny<CancellationToken>()))
                .Callback<IPartDataSource, CancellationToken>((ds, ct) =>
                {
        ...
        public async Task ProcessPartAsync_OutOfOrderPart_BuffersToMemory()
        {
            ...
            mockBufferManager.Setup(m => m.AddBufferAsync(It.IsAny<StreamPartBuffer>(), It.IsAny<CancellationToken>()))
        ...
        public async Task ProcessPartAsync_OutOfOrderPart_DoesNotReleaseCapacityImmediately()
        {
            ...
            try
            {
                ...
                // Assert - AddBufferAsync should be called with StreamPartBuffer (not IPartDataSource)
                mockBufferManager.Verify(m => m.AddBufferAsync(
        ...
        public async Task ProcessPartAsync_MixedInOrderAndOutOfOrder_HandlesCorrectly()
        {
            ...
            mockBufferManager.Setup(m => m.AddBufferAsync(It.IsAny<StreamPartBuffer>(), It.IsAny<CancellationToken>()))
                .Callback<StreamPartBuffer, CancellationToken>((buffer, ct) => bufferedParts++)
                .Returns(Task.CompletedTask);
        ...
        public async Task ProcessPartAsync_InOrderFollowedByOutOfOrder_HandlesCorrectly()
        {
            ...
            try
            {
                ...
                // Assert
                mockBufferManager.Verify(m => m.AddBufferAsync(
                    It.Is<IPartDataSource>(ds => ds is StreamingDataSource && ds.PartNumber == 1),
                    It.IsAny<CancellationToken>()), Times.Once);
                
                mockBufferManager.Verify(m => m.AddBufferAsync(
                    It.Is<StreamPartBuffer>(b => b.PartNumber == 3),
                    It.IsAny<CancellationToken>()), Times.Once);
            }
            finally
            {
        ...
        public async Task ProcessPartAsync_OutOfOrderFollowedByInOrder_HandlesCorrectly()
        {
            ...
            try
            {
                ...
                // Assert
                mockBufferManager.Verify(m => m.AddBufferAsync(
                    It.Is<StreamPartBuffer>(b => b.PartNumber == 2),
                    It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task ProcessPartAsync_InOrderVsOutOfOrder_VerifyStreamingVsBufferingBehavior()
        {
            ...
            mockBufferManager.Setup(m => m.AddBufferAsync(
            ...
            mockBufferManager.Setup(m => m.AddBufferAsync(
                It.IsAny<StreamPartBuffer>(), 
                It.IsAny<CancellationToken>()))
                .Callback<StreamPartBuffer, CancellationToken>((buffer, ct) => 
                {
