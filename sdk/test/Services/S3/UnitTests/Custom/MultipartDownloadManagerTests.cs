...
namespace AWSSDK.UnitTests
{
    ...
    public class MultipartDownloadManagerTests
    {
        ...
        public async Task CreateDownloadTasksAsync_CancellationImmediatelyAfterHttpSlot_ReleasesResourcesCorrectly()
        {
            ...
            // Use controlled semaphore to detect releases
            var testHttpThrottler = new TestSemaphoreSlim(1, 1);
        ...
        /// <summary>
        /// Test helper class to track semaphore operations
        /// </summary>
        private class TestSemaphoreSlim : SemaphoreSlim
        {
            public int WaitCount { get; private set; }
            public int ReleaseCount { get; private set; }
            
            public TestSemaphoreSlim(int initialCount, int maxCount) : base(initialCount, maxCount) { }
            
            public new async Task WaitAsync(CancellationToken cancellationToken = default)
            {
