...
namespace AWSSDK.UnitTests
{
    ...
    public class PartBufferManagerTests
    {
        ...
        public async Task AddBufferAsync_WithNullBuffer_ThrowsArgumentNullException()
        {
            ...
            {
                // Act
                await manager.AddBufferAsync((IPartDataSource)null, CancellationToken.None);
        ...
        public async Task AddBufferAsync_SignalsPartAvailable()
        {
            ...
            try
            {
                ...
                byte[] testBuffer = ArrayPool<byte>.Shared.Rent(512);
                var partBuffer = new StreamPartBuffer(1, testBuffer, 512);
                await manager.AddBufferAsync((StreamPartBuffer)partBuffer, CancellationToken.None);
        ...
        public async Task AddBufferAsync_IPartDataSource_WithStreamingDataSource_AddsSuccessfully()
        {
            ...
            try
            {
                ...
                // Act
                await manager.AddBufferAsync(streamingSource, CancellationToken.None);
        ...
        public async Task AddBufferAsync_IPartDataSource_WithBufferedDataSource_AddsSuccessfully()
        {
            ...
            try
            {
                ...
                // Act
                await manager.AddBufferAsync((IPartDataSource)bufferedSource, CancellationToken.None);
        ...
        public async Task AddBufferAsync_IPartDataSource_SignalsPartAvailable()
        {
            ...
            try
            {
                ...
                // Act
                await manager.AddBufferAsync((IPartDataSource)streamingSource, CancellationToken.None);
