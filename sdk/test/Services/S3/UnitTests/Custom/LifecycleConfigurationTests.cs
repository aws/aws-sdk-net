...
namespace AWSSDK.UnitTests
{
    ...
    public class LifecycleConfigurationTests
    {
        ...
        [TestMethod]
        public void TestGetLifecycleConfigurationUnmarshaller()
        {
            ...
            var expectedResponse = new GetLifecycleConfigurationResponse
            {
            ...
            var context = CreateLifecycleConfigurationResponse(expectedResponse);
            GetLifecycleConfigurationResponse actualResponse = GetLifecycleConfigurationResponseUnmarshaller.Instance.Unmarshall(context) as GetLifecycleConfigurationResponse;
            Comparer.CompareObjects<GetLifecycleConfigurationResponse>(expectedResponse, actualResponse);
        }
