...
{
    [TestClass]
    public class BCMDataExportsMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("bcm-data-exports");
        ...
        public void CreateExportMarshallTest()
        {
            ...
            Comparer.CompareObjectToJson<CreateExportRequest>(request,jsonRequest);
            ...
            var response = CreateExportResponseUnmarshaller.Instance.Unmarshall(context) as CreateExportResponse;
        ...
        public void DeleteExportMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<DeleteExportRequest>(request,jsonRequest);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = DeleteExportResponseUnmarshaller.Instance.Unmarshall(context) as DeleteExportResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void DeleteExport_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("DeleteExport");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExecutionMarshallTest()
        {
            var operation = service_model.FindOperation("GetExecution");

            var request = InstantiateClassGenerator.Execute<GetExecutionRequest>(operation);
            var marshaller = new GetExecutionRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<GetExecutionRequest>(request,jsonRequest);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = GetExecutionResponseUnmarshaller.Instance.Unmarshall(context) as GetExecutionResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExecution_InternalServerExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExecution");
            ...
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
            var response = GetExecutionResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExecution_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExecution");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExecution_ThrottlingExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExecution");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExecution_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExecution");
        ...
        public void GetExportMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetExportRequest>(operation);
            var marshaller = new GetExportRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<GetExportRequest>(request,jsonRequest);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = GetExportResponseUnmarshaller.Instance.Unmarshall(context) as GetExportResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExport_InternalServerExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExport");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExport_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExport");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExport_ThrottlingExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExport");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetExport_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetExport");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void GetTable_ThrottlingExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetTable");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void ListExecutions_InternalServerExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ListExecutions");
        ...
        [TestCategory("Json")]
        [TestCategory("BCMDataExports")]
        public void ListExecutions_ThrottlingExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ListExecutions");
        ...
        public void UpdateExportMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<UpdateExportRequest>(request,jsonRequest);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = UpdateExportResponseUnmarshaller.Instance.Unmarshall(context) as UpdateExportResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
