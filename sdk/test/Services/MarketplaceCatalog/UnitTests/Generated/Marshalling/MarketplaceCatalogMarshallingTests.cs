...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class MarketplaceCatalogMarshallingTests
    {
        ...
        public void BatchDescribeEntitiesMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDescribeEntities");

            var request = InstantiateClassGenerator.Execute<BatchDescribeEntitiesRequest>(operation);
            var marshaller = new BatchDescribeEntitiesRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("BatchDescribeEntities", request, internalRequest, service_model);
            ...
            ResponseUnmarshaller unmarshaller = BatchDescribeEntitiesResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as BatchDescribeEntitiesResponse;
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceCatalog")]
        public void BatchDescribeEntities_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDescribeEntities");
            ...
            var response = BatchDescribeEntitiesResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceCatalog")]
        public void BatchDescribeEntities_InternalServiceExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDescribeEntities");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceCatalog")]
        public void BatchDescribeEntities_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDescribeEntities");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceCatalog")]
        public void BatchDescribeEntities_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDescribeEntities");
        ...
        public void CancelChangeSetMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CancelChangeSetRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CancelChangeSetResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeChangeSetMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeChangeSetResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeEntityMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeEntityResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeEntity_ResourceNotSupportedExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ResourceNotSupportedException"},
                }
            };
        ...
        public void ListEntitiesMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListEntitiesRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ListEntitiesResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void StartChangeSetMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<StartChangeSetRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as StartChangeSetResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
