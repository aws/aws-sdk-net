...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class OpsWorksCMEndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonOpsWorksCMEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://opsworks-cm.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
