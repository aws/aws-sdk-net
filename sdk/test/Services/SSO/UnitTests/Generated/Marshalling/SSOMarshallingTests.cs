...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class SSOMarshallingTests
    {
        ...
        public void GetRoleCredentialsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetRoleCredentialsRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as GetRoleCredentialsResponse;
        ...
        public void ListAccountRolesMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListAccountRolesRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ListAccountRolesResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void LogoutMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<LogoutRequest>(operation);
