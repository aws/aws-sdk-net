...
{
    /// <summary>
    /// QueryStringListMap Request Marshaller
    /// </summary>       
    public class QueryStringListMapRequestMarshaller : IMarshaller<IRequest, QueryStringListMapRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((QueryStringListMapRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(QueryStringListMapRequest publicRequest)
        {
        ...
        private static QueryStringListMapRequestMarshaller _instance = new QueryStringListMapRequestMarshaller();        

        internal static QueryStringListMapRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryStringListMapRequestMarshaller Instance
        {
            get
            {
                return _instance;
