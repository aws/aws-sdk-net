...
namespace Amazon.RpcV2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RpcV2CborUnionUnmarshaller : ICborUnmarshaller<RpcV2CborUnion, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            RpcV2CborUnion unmarshalledObject = new RpcV2CborUnion();
                    ...
                    case "unionValue":
                        {
                            ...
                            var unmarshaller = RpcV2CborNestedUnionUnmarshaller.Instance;
                            unmarshalledObject.UnionValue = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RpcV2CborUnionUnmarshaller Instance
        {
            get
            {
                return _instance;
