...
namespace Amazon.RpcV2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RpcV2CborUnionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RpcV2CborUnionsResponse response = new RpcV2CborUnionsResponse();
                    ...
                    case "contents":
                        {
                            ...
                            var unmarshaller = RpcV2CborUnionUnmarshaller.Instance;
                    ...
                    case "otherValue":
                        {
                            ...
                            response.OtherValue = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        internal static RpcV2CborUnionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RpcV2CborUnionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
