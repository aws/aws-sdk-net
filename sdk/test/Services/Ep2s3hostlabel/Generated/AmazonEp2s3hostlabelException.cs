...
namespace Amazon.Ep2s3hostlabel
{
    ...
    public partial class AmazonEp2s3hostlabelException : AmazonServiceException
    {
        ...
        public AmazonEp2s3hostlabelException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonEp2s3hostlabelException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
