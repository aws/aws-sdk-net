...
{
    /// <summary>
    /// Implementation for accessing Ep2s3hostlabel
    ///
    /// 
    /// </summary>
    public partial class AmazonEp2s3hostlabelClient : AmazonServiceClient, IAmazonEp2s3hostlabel
    {
        ...
        public AmazonEp2s3hostlabelClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonEp2s3hostlabelConfig()) { }
        ...
        public AmazonEp2s3hostlabelClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonEp2s3hostlabelConfig{RegionEndpoint = region}) { }
        ...
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the MyOperation operation on AmazonEp2s3hostlabelClient.</param>
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ep2-s3-host-label-2022-08-24/MyOperation">REST API Reference for MyOperation Operation</seealso>
        public virtual IAsyncResult BeginMyOperation(MyOperationRequest request, AsyncCallback callback, object state)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = MyOperationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = MyOperationResponseUnmarshaller.Instance;
        ...
        /// 
        /// <returns>Returns a  MyOperationResult from Ep2s3hostlabel.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ep2-s3-host-label-2022-08-24/MyOperation">REST API Reference for MyOperation Operation</seealso>
        public virtual MyOperationResponse EndMyOperation(IAsyncResult asyncResult)
        {
            return EndInvoke<MyOperationResponse>(asyncResult);
        }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonEp2s3hostlabelEndpointResolver();
