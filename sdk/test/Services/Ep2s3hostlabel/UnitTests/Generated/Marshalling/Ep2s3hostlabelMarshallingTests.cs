...
{
    [TestClass]
    public class Ep2s3hostlabelMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("ep2-s3-host-label");
