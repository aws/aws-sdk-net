...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class CleanRoomsMarshallingTests
    {
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("CleanRooms")]
        public void BatchGetSchemaAnalysisRuleMarshallTest()
        {
            var operation = service_model.FindOperation("BatchGetSchemaAnalysisRule");

            var request = InstantiateClassGenerator.Execute<BatchGetSchemaAnalysisRuleRequest>(operation);
            var marshaller = new BatchGetSchemaAnalysisRuleRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("BatchGetSchemaAnalysisRule", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = BatchGetSchemaAnalysisRuleResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as BatchGetSchemaAnalysisRuleResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("CleanRooms")]
        public void BatchGetSchemaAnalysisRule_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchGetSchemaAnalysisRule");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = BatchGetSchemaAnalysisRuleResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("CleanRooms")]
        public void BatchGetSchemaAnalysisRule_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchGetSchemaAnalysisRule");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("CleanRooms")]
        public void BatchGetSchemaAnalysisRule_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchGetSchemaAnalysisRule");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("CleanRooms")]
        public void BatchGetSchemaAnalysisRule_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchGetSchemaAnalysisRule");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("CleanRooms")]
        public void BatchGetSchemaAnalysisRule_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchGetSchemaAnalysisRule");
