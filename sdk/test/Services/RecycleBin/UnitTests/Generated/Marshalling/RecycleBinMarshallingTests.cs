...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class RecycleBinMarshallingTests
    {
        ...
        public void LockRuleMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<LockRuleRequest>(operation);
        ...
        public void UnlockRuleMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<UnlockRuleRequest>(operation);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("RecycleBin")]
        public void UpdateRule_ServiceQuotaExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateRule");
