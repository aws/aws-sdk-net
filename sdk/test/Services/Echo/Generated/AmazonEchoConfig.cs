...
{
    /// <summary>
    /// Configuration for accessing Amazon Echo service
    /// </summary>
    public partial class AmazonEchoConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Echo", "4.0");
        ...
        /// Default constructor
        /// </summary>
        public AmazonEchoConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonEchoDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Echo";
            this.AuthenticationServiceName = "echoservice";
        }
