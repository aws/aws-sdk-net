...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class SecurityIREndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonSecurityIREndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://security-ir.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
