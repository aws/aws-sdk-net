...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class DLMMarshallingTests
    {
        ...
        public void GetLifecyclePoliciesMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetLifecyclePoliciesRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as GetLifecyclePoliciesResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
