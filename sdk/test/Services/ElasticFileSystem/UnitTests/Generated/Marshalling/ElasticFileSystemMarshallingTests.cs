...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class ElasticFileSystemMarshallingTests
    {
        ...
        public void CreateAccessPoint_AccessPointAlreadyExistsExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"AccessPointAlreadyExistsException"},
                }
            };
        ...
        public void CreateAccessPoint_AccessPointLimitExceededExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"AccessPointLimitExceededException"},
                }
            };
        ...
        public void CreateAccessPoint_IncorrectFileSystemLifeCycleStateExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"IncorrectFileSystemLifeCycleStateException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateAccessPoint_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateAccessPoint");
        ...
        public void CreateFileSystemMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as CreateFileSystemResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void CreateFileSystem_FileSystemAlreadyExistsExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"FileSystemAlreadyExistsException"},
                }
            };
        ...
        public void CreateFileSystem_FileSystemLimitExceededExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"FileSystemLimitExceededException"},
                }
            };
        ...
        public void CreateFileSystem_InsufficientThroughputCapacityExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"InsufficientThroughputCapacityException"},
                }
            };
        ...
        public void CreateFileSystem_ThroughputLimitExceededExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ThroughputLimitExceededException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateFileSystem_UnsupportedAvailabilityZoneExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateFileSystem");
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"UnsupportedAvailabilityZoneException"},
                }
            };
        ...
        public void CreateMountTargetMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CreateMountTargetRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CreateMountTargetResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateMountTarget_AvailabilityZonesMismatchExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateMountTarget");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("AvailabilityZonesMismatchException"));
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"AvailabilityZonesMismatchException"},
                }
            };
        ...
        public void CreateMountTarget_IpAddressInUseExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"IpAddressInUseException"},
                }
            };
        ...
        public void CreateMountTarget_MountTargetConflictExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"MountTargetConflictException"},
                }
            };
        ...
        public void CreateMountTarget_NetworkInterfaceLimitExceededExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"NetworkInterfaceLimitExceededException"},
                }
            };
        ...
        public void CreateMountTarget_NoFreeAddressesInSubnetExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"NoFreeAddressesInSubnetException"},
                }
            };
        ...
        public void CreateMountTarget_SecurityGroupLimitExceededExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"SecurityGroupLimitExceededException"},
                }
            };
        ...
        public void CreateMountTarget_SecurityGroupNotFoundExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"SecurityGroupNotFoundException"},
                }
            };
        ...
        public void CreateMountTarget_SubnetNotFoundExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"SubnetNotFoundException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfigurationMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");

            var request = InstantiateClassGenerator.Execute<CreateReplicationConfigurationRequest>(operation);
            var marshaller = new CreateReplicationConfigurationRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("CreateReplicationConfiguration", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = CreateReplicationConfigurationResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as CreateReplicationConfigurationResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = CreateReplicationConfigurationResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_ConflictExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_FileSystemLimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_FileSystemNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_IncorrectFileSystemLifeCycleStateExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_InsufficientThroughputCapacityExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_InternalServerErrorExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_ReplicationNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("ReplicationNotFoundException"));
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ReplicationNotFoundException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_ThroughputLimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_UnsupportedAvailabilityZoneExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void CreateReplicationConfiguration_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateReplicationConfiguration");
        ...
        public void DeleteAccessPoint_AccessPointNotFoundExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"AccessPointNotFoundException"},
                }
            };
        ...
        public void DeleteFileSystem_FileSystemInUseExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"FileSystemInUseException"},
                }
            };
        ...
        public void DeleteFileSystemPolicyMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DeleteFileSystemPolicyRequest>(operation);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DeleteFileSystemPolicy_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteFileSystemPolicy");
        ...
        public void DeleteMountTargetMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DeleteMountTargetRequest>(operation);
        ...
        public void DeleteMountTarget_DependencyTimeoutExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"DependencyTimeoutException"},
                }
            };
        ...
        public void DeleteMountTarget_MountTargetNotFoundExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"MountTargetNotFoundException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DeleteReplicationConfigurationMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteReplicationConfiguration");

            var request = InstantiateClassGenerator.Execute<DeleteReplicationConfigurationRequest>(operation);
            var marshaller = new DeleteReplicationConfigurationRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("DeleteReplicationConfiguration", request, internalRequest, service_model);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DeleteReplicationConfiguration_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteReplicationConfiguration");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = DeleteReplicationConfigurationResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DeleteReplicationConfiguration_FileSystemNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DeleteReplicationConfiguration_InternalServerErrorExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteReplicationConfiguration");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DeleteReplicationConfiguration_ReplicationNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteReplicationConfiguration");
        ...
        public void DescribeAccessPointsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeAccessPointsRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeAccessPointsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeAccountPreferencesMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeAccountPreferences");

            var request = InstantiateClassGenerator.Execute<DescribeAccountPreferencesRequest>(operation);
            var marshaller = new DescribeAccountPreferencesRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("DescribeAccountPreferences", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = DescribeAccountPreferencesResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as DescribeAccountPreferencesResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeAccountPreferences_InternalServerErrorExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeAccountPreferences");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = DescribeAccountPreferencesResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        public void DescribeBackupPolicyMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeBackupPolicyRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeBackupPolicyResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeFileSystemPolicyMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeFileSystemPolicyRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeFileSystemPolicyResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeFileSystemPolicy_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeFileSystemPolicy");
        ...
        public void DescribeFileSystemsMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeFileSystemsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeLifecycleConfigurationMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeLifecycleConfigurationRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeLifecycleConfigurationResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeMountTargetsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeMountTargetsRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeMountTargetsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeMountTargetSecurityGroupsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeMountTargetSecurityGroupsRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeMountTargetSecurityGroupsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void DescribeMountTargetSecurityGroups_IncorrectMountTargetStateExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"IncorrectMountTargetStateException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeReplicationConfigurationsMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeReplicationConfigurations");

            var request = InstantiateClassGenerator.Execute<DescribeReplicationConfigurationsRequest>(operation);
            var marshaller = new DescribeReplicationConfigurationsRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("DescribeReplicationConfigurations", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = DescribeReplicationConfigurationsResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as DescribeReplicationConfigurationsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeReplicationConfigurations_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeReplicationConfigurations");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = DescribeReplicationConfigurationsResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeReplicationConfigurations_FileSystemNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeReplicationConfigurations");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeReplicationConfigurations_InternalServerErrorExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeReplicationConfigurations");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeReplicationConfigurations_ReplicationNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeReplicationConfigurations");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void DescribeReplicationConfigurations_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeReplicationConfigurations");
        ...
        public void DescribeTagsMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeTagsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void ModifyMountTargetSecurityGroupsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ModifyMountTargetSecurityGroupsRequest>(operation);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void PutAccountPreferencesMarshallTest()
        {
            var operation = service_model.FindOperation("PutAccountPreferences");

            var request = InstantiateClassGenerator.Execute<PutAccountPreferencesRequest>(operation);
            var marshaller = new PutAccountPreferencesRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("PutAccountPreferences", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = PutAccountPreferencesResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as PutAccountPreferencesResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void PutAccountPreferences_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutAccountPreferences");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = PutAccountPreferencesResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void PutAccountPreferences_InternalServerErrorExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutAccountPreferences");
        ...
        public void PutBackupPolicyMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PutBackupPolicyRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as PutBackupPolicyResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void PutFileSystemPolicyMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PutFileSystemPolicyRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as PutFileSystemPolicyResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void PutFileSystemPolicy_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutFileSystemPolicy");
        ...
        public void PutFileSystemPolicy_InvalidPolicyExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"InvalidPolicyException"},
                }
            };
        ...
        public void PutLifecycleConfigurationMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PutLifecycleConfigurationRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as PutLifecycleConfigurationResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void UpdateFileSystemMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as UpdateFileSystemResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtectionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");

            var request = InstantiateClassGenerator.Execute<UpdateFileSystemProtectionRequest>(operation);
            var marshaller = new UpdateFileSystemProtectionRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("UpdateFileSystemProtection", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = UpdateFileSystemProtectionResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as UpdateFileSystemProtectionResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_BadRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = UpdateFileSystemProtectionResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_FileSystemNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_IncorrectFileSystemLifeCycleStateExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_InsufficientThroughputCapacityExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_InternalServerErrorExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_ReplicationAlreadyExistsExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("ReplicationAlreadyExistsException"));
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ReplicationAlreadyExistsException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_ThroughputLimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ElasticFileSystem")]
        public void UpdateFileSystemProtection_TooManyRequestsExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateFileSystemProtection");
