...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class Ep2parsearnEndpointsTests
    {
        ...
        public void Arn_region_resolution_0b0a20be82574d31ab9676f9a3ff531b_Test()
        {
        ...
        public void Arn_unset_outpost_id_bbf7bfd6bf634847a10bae4dce153f1e_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
        ...
        public void Arn_empty_outpost_id_tests_that_empty_strings_are_handled_properly_during_matching_5cd72ca87d044937aa1070ffbb6ad1d9_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["Bucket"] = "arn:aws:s3:us-east-2:012345678:outpost::";
            parameters["Region"] = "us-east-2";
        ...
        [ExpectedException(typeof(AmazonClientException), "OutpostId was empty")]
        public void Arn_empty_outpost_id_tests_that_ARN_parsing_considers_a_trailing_colon_b2f26f3be1bd4d82925541b56c2333d0_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["Bucket"] = "arn:aws:s3:us-east-2:012345678:outpost:";
            parameters["Region"] = "us-east-2";
        ...
        public void Valid_hostlabel_region_resolution_1675b885e4e84322865daf938384f650_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
        ...
        public void Not_a_valid_hostlabel_region_resolution_f8c497223c994ded8f9881fdc09fca2c_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
        ...
        public void No_bucket_4f9cd9f989ed4adb9e1c0e6bd0c8b3e9_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["Region"] = "us-east-2";
            var endpoint = new AmazonEp2parsearnEndpointProvider().ResolveEndpoint(parameters);
        ...
        public void A_string_that_is_not_a_6part_ARN_a110550e808b4a0b9cb69ceac309b276_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
        ...
        public void Resource_id_MUST_not_be_null_84ce47357fab4981b87fb7a1c63486f6_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["TestCaseId"] = "invalid-arn";
        ...
        public void Service_MUST_not_be_null_fae2bc20692e4cc0ba1941d467b17a32_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["TestCaseId"] = "invalid-arn";
        ...
        public void Partition_MUST_not_be_null_3e6fa00dbc9641669a7aaa7b52296847_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["TestCaseId"] = "invalid-arn";
        ...
        public void Region_MAY_be_null_340ba46170e64ead86b90abfa94e8826_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
        ...
        public void AccountId_MAY_be_null_4536697fddb74610ba185c2fbf6c889a_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["TestCaseId"] = "valid-arn";
        ...
        public void AccountId_MAY_be_nonnumeric_5de8f55a0f864d7e8f6fb8a468c15647_Test()
        {
            var parameters = new Ep2parsearnEndpointParameters();
            parameters["TestCaseId"] = "valid-arn";
