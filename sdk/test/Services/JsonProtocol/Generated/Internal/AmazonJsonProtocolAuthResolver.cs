...
namespace Amazon.JsonProtocol.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonJsonProtocolAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonJsonProtocolAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for JsonProtocol.
        /// </summary>
        public AmazonJsonProtocolAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonJsonProtocolAuthSchemeParameters
            {
    ...
    public class AmazonJsonProtocolAuthSchemeResolver : IAuthSchemeResolver<AmazonJsonProtocolAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonJsonProtocolAuthSchemeParameters authParameters)
        {
