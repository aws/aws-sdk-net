...
namespace Amazon.JsonProtocol.Model
{
    ...
    public partial class KitchenSinkOperationRequest : AmazonJsonProtocolRequest
    {
        ...
        private List<List<string>> _listOfLists = new List<List<string>>();
        private List<Dictionary<string, string>> _listOfMapsOfStrings = new List<Dictionary<string, string>>();
        private List<string> _listOfStrings = new List<string>();
        private List<SimpleStruct> _listOfStructs = new List<SimpleStruct>();
        private long? _long;
        private Dictionary<string, List<string>> _mapOfListsOfStrings = new Dictionary<string, List<string>>();
        private Dictionary<string, Dictionary<string, string>> _mapOfMaps = new Dictionary<string, Dictionary<string, string>>();
        private Dictionary<string, string> _mapOfStrings = new Dictionary<string, string>();
        private Dictionary<string, SimpleStruct> _mapOfStructs = new Dictionary<string, SimpleStruct>();
        private List<KitchenSink> _recursiveList = new List<KitchenSink>();
        private Dictionary<string, KitchenSink> _recursiveMap = new Dictionary<string, KitchenSink>();
        ...
        {
            return this._listOfLists != null && this._listOfLists.Count > 0; 
        }
        ...
        {
            return this._listOfMapsOfStrings != null && this._listOfMapsOfStrings.Count > 0; 
        }
        ...
        {
            return this._listOfStructs != null && this._listOfStructs.Count > 0; 
        }
        ...
        {
            return this._mapOfListsOfStrings != null && this._mapOfListsOfStrings.Count > 0; 
        }
        ...
        {
            return this._mapOfMaps != null && this._mapOfMaps.Count > 0; 
        }
        ...
        {
            return this._mapOfStrings != null && this._mapOfStrings.Count > 0; 
        }
        ...
        {
            return this._mapOfStructs != null && this._mapOfStructs.Count > 0; 
        }
        ...
        {
            return this._recursiveList != null && this._recursiveList.Count > 0; 
        }
        ...
        {
            return this._recursiveMap != null && this._recursiveMap.Count > 0; 
        }
