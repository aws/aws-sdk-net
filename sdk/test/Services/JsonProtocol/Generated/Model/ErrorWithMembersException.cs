...
namespace Amazon.JsonProtocol.Model
{
    ...
    public partial class ErrorWithMembersException : AmazonJsonProtocolException
    {
        ...
        private List<string> _listField = new List<string>();
        private Dictionary<string, string> _mapField = new Dictionary<string, string>();
        ...
        {
            return this._listField != null && this._listField.Count > 0; 
        }
        ...
        {
            return this._mapField != null && this._mapField.Count > 0; 
        }
