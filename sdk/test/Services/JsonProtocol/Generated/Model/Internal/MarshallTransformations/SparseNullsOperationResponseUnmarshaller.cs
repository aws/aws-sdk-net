...
{
    /// <summary>
    /// Response Unmarshaller for SparseNullsOperation operation
    /// </summary>  
    public class SparseNullsOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SparseNullsOperationResponseUnmarshaller _instance = new SparseNullsOperationResponseUnmarshaller();        

        internal static SparseNullsOperationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SparseNullsOperationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
