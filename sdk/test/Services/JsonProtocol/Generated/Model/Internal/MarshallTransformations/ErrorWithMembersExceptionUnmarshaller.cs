...
namespace Amazon.JsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ErrorWithMembersExceptionUnmarshaller : IErrorResponseUnmarshaller<ErrorWithMembersException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ErrorWithMembersException Unmarshall(JsonUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ErrorWithMembersException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ComplexData", targetDepth))
                {
                    ...
                    unmarshalledObject.ComplexData = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ListField", targetDepth))
                {
                    ...
                    unmarshalledObject.ListField = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("MapField", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.MapField = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("StringField", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StringField = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
