...
namespace Amazon.JsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SparseNullsOperationRequestMarshaller : IMarshaller<IRequest, SparseNullsOperationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(SparseNullsOperationRequest publicRequest)
        {
            ...
            string target = "JsonProtocol.SparseNullsOperation";
            ...
            if(publicRequest.IsSetSparseStringList())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestSparseStringListListValue);
                }
        ...
        private static SparseNullsOperationRequestMarshaller _instance = new SparseNullsOperationRequestMarshaller();        

        internal static SparseNullsOperationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SparseNullsOperationRequestMarshaller Instance
        {
            get
            {
                return _instance;
