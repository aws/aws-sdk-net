...
namespace Amazon.JsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatetimeOffsetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DatetimeOffsetsResponse response = new DatetimeOffsetsResponse();
        ...
        internal static DatetimeOffsetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DatetimeOffsetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
