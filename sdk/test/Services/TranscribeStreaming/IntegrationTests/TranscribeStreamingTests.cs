...
{
    /// <summary>
    /// xUnit fixture that owns a single <see cref="AmazonTranscribeStreamingClient"/> for the
    /// lifetime of the <see cref="TranscribeStreamingTests"/> class.
    /// </summary>
    public class TranscribeStreamingClientFixture : IAsyncLifetime
    {
        public AmazonTranscribeStreamingClient Client { get; private set; }

        public ValueTask InitializeAsync()
        {
            Client = new AmazonTranscribeStreamingClient();
    ...
    [Trait("Category", "TranscribeStreaming")]
    public class TranscribeStreamingTests : IClassFixture<TranscribeStreamingClientFixture>
    {
        private readonly AmazonTranscribeStreamingClient _client;

        public TranscribeStreamingTests(TranscribeStreamingClientFixture fixture)
        {
        ...
        public async Task TranscribeFlacFile()
        {
            ...
            startRequest.AudioStreamPublisher += async () =>
            {
                ...
                // The next call to publish will return null triggering an end to publishing.
            ...
            using var response = await _client.StartStreamTranscriptionAsync(startRequest);
        ...
        private static string FindFilePath(string file)
        {
            var directory = Directory.GetParent(typeof(TranscribeStreamingTests).Assembly.Location).FullName;
