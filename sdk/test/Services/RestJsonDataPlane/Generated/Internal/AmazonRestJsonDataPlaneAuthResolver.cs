...
namespace Amazon.RestJsonDataPlane.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonRestJsonDataPlaneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRestJsonDataPlaneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RestJsonDataPlane.
        /// </summary>
        public AmazonRestJsonDataPlaneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRestJsonDataPlaneAuthSchemeParameters
            {
    ...
    public class AmazonRestJsonDataPlaneAuthSchemeResolver : IAuthSchemeResolver<AmazonRestJsonDataPlaneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRestJsonDataPlaneAuthSchemeParameters authParameters)
        {
