...
using Amazon.RestJsonDataPlane.Internal;
...
{
    /// <summary>
    /// <para>Implementation for accessing RestJsonDataPlane</para>
    /// <para>
    ...
    /// 
    /// </summary>
    public partial class AmazonRestJsonDataPlaneClient : AmazonServiceClient, IAmazonRestJsonDataPlane
    {
        private static IServiceMetadata serviceMetadata = new AmazonRestJsonDataPlaneMetadata();
        
        #region Constructors

        /// <summary>
        /// Constructs AmazonRestJsonDataPlaneClient with the credentials loaded from the application's
        ...
        ///
        /// </summary>
        public AmazonRestJsonDataPlaneClient()
            : base(new AmazonRestJsonDataPlaneConfig()) { }
        ...
        public AmazonRestJsonDataPlaneClient(RegionEndpoint region)
            : base(new AmazonRestJsonDataPlaneConfig{RegionEndpoint = region}) { }
        ...
        ///
        /// </summary>
        /// <param name="config">The AmazonRestJsonDataPlaneClient Configuration Object</param>
        public AmazonRestJsonDataPlaneClient(AmazonRestJsonDataPlaneConfig config)
            : base(config) { }


        /// <summary>
        /// Constructs AmazonRestJsonDataPlaneClient with AWS Credentials
        /// </summary>
        /// <param name="credentials">AWS Credentials</param>
        public AmazonRestJsonDataPlaneClient(AWSCredentials credentials)
            : this(credentials, new AmazonRestJsonDataPlaneConfig())
        {
        }
        ...
        /// <param name="credentials">AWS Credentials</param>
        /// <param name="region">The region to connect.</param>
        public AmazonRestJsonDataPlaneClient(AWSCredentials credentials, RegionEndpoint region)
            : this(credentials, new AmazonRestJsonDataPlaneConfig{RegionEndpoint = region})
        {
        }

        /// <summary>
        /// Constructs AmazonRestJsonDataPlaneClient with AWS Credentials and an
        /// AmazonRestJsonDataPlaneClient Configuration object.
        /// </summary>
        /// <param name="credentials">AWS Credentials</param>
        /// <param name="clientConfig">The AmazonRestJsonDataPlaneClient Configuration Object</param>
        public AmazonRestJsonDataPlaneClient(AWSCredentials credentials, AmazonRestJsonDataPlaneConfig clientConfig)
            : base(credentials, clientConfig)
        {
        }

        /// <summary>
        /// Constructs AmazonRestJsonDataPlaneClient with AWS Access Key ID and AWS Secret Key
        /// </summary>
        /// <param name="awsAccessKeyId">AWS Access Key ID</param>
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        public AmazonRestJsonDataPlaneClient(string awsAccessKeyId, string awsSecretAccessKey)
            : this(awsAccessKeyId, awsSecretAccessKey, new AmazonRestJsonDataPlaneConfig())
        {
        }
        ...
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        /// <param name="region">The region to connect.</param>
        public AmazonRestJsonDataPlaneClient(string awsAccessKeyId, string awsSecretAccessKey, RegionEndpoint region)
            : this(awsAccessKeyId, awsSecretAccessKey, new AmazonRestJsonDataPlaneConfig() {RegionEndpoint=region})
        {
        }

        /// <summary>
        /// Constructs AmazonRestJsonDataPlaneClient with AWS Access Key ID, AWS Secret Key and an
        /// AmazonRestJsonDataPlaneClient Configuration object. 
        /// </summary>
        /// <param name="awsAccessKeyId">AWS Access Key ID</param>
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        /// <param name="clientConfig">The AmazonRestJsonDataPlaneClient Configuration Object</param>
        public AmazonRestJsonDataPlaneClient(string awsAccessKeyId, string awsSecretAccessKey, AmazonRestJsonDataPlaneConfig clientConfig)
        ...
        public AmazonRestJsonDataPlaneClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken)
            : this(awsAccessKeyId, awsSecretAccessKey, awsSessionToken, new AmazonRestJsonDataPlaneConfig())
        {
        }
        ...
        /// <param name="awsSessionToken">AWS Session Token</param>
        /// <param name="region">The region to connect.</param>
        public AmazonRestJsonDataPlaneClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, RegionEndpoint region)
            : this(awsAccessKeyId, awsSecretAccessKey, awsSessionToken, new AmazonRestJsonDataPlaneConfig{RegionEndpoint = region})
        {
        }
        ...
        /// <param name="awsSessionToken">AWS Session Token</param>
        /// <param name="clientConfig">The AmazonRestJsonDataPlaneClient Configuration Object</param>
        public AmazonRestJsonDataPlaneClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, AmazonRestJsonDataPlaneConfig clientConfig)
        ...
        {
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonRestJsonDataPlaneAuthSchemeHandler());
        }
