...
namespace Amazon.RestJsonDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HealthcheckResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ok", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Ok = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
