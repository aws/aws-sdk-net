...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class EBSMarshallingTests
    {
        ...
        public void CompleteSnapshotMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CompleteSnapshotRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CompleteSnapshotResponse;
        ...
        public void GetSnapshotBlockMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetSnapshotBlockRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as GetSnapshotBlockResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void ListChangedBlocksMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListChangedBlocksRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ListChangedBlocksResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void ListSnapshotBlocksMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListSnapshotBlocksRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ListSnapshotBlocksResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void PutSnapshotBlockMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PutSnapshotBlockRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as PutSnapshotBlockResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void StartSnapshotMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<StartSnapshotRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as StartSnapshotResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void StartSnapshot_ConcurrentLimitExceededExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ConcurrentLimitExceededException"},
                }
            };
