...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class CloudSearchDomainMarshallingTests
    {
        ...
        public void Search_SearchExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"SearchException"},
                }
            };
        ...
        public void SuggestMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as SuggestResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void UploadDocumentsMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as UploadDocumentsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void UploadDocuments_DocumentServiceExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"DocumentServiceException"},
                }
            };
