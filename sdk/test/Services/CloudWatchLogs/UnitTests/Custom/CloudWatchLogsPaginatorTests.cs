...
namespace AWSSDK.UnitTests
{
    ...
    public class CloudWatchLogsPaginatorTests
    {
        ...
        public async Task DescribeDestinationsTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverDestinations(paginator, token));
        }
        ...
        public async Task DescribeDestinationsTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverDestinations(paginator, token));
        }
        ...
        public async Task DescribeLogGroupsTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverLogGroups(paginator, token));
        }
        ...
        public async Task DescribeLogGroupsTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverLogGroups(paginator, token));
        }
        ...
        public async Task DescribeLogStreamsTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverLogStreams(paginator, token));
        }
        ...
        public async Task DescribeLogStreamsTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverLogStreams(paginator, token));
        }
        ...
        public async Task DescribeMetricFiltersTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverMetricFilters(paginator, token));
        }
        ...
        public async Task DescribeMetricFiltersTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverMetricFilters(paginator, token));
        }
        ...
        public async Task DescribeSubscriptionFiltersTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverSubscriptionFilters(paginator, token));
        }
        ...
        public async Task DescribeSubscriptionFiltersTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverSubscriptionFilters(paginator, token));
        }
        ...
        public async Task FilterLogEventsTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverFilterLogEvents(paginator, token));
        }
        ...
        public async Task FilterLogEventsTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverFilterLogEvents(paginator, token));
        }
        ...
        public async Task GetLogEventsTest__OnlyUsedOnce()
        {
            ...
            await Assert.ThrowsExactlyAsync<System.InvalidOperationException>(async () => await LoopOverGetLogEvents(paginator, token));
        }
        ...
        public async Task GetLogEventsTest__CancellationToken()
        {
            ...
            await Assert.ThrowsExactlyAsync<OperationCanceledException>(async () => await LoopOverGetLogEvents(paginator, token));
        }
    }
}
#endif
