...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class XRayEndpointsTests
    {
        ...
        public void For_region_apsouth2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            Assert.AreEqual("https://xray-fips.ap-south-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsouth2_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "ap-south-2";
            var endpoint = new AmazonXRayEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://xray-fips.ap-south-2.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apsouth2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["Region"] = "ap-south-2";
            var endpoint = new AmazonXRayEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://xray.ap-south-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsouth2_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "ap-south-2";
            var endpoint = new AmazonXRayEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://xray.ap-south-2.amazonaws.com", endpoint.URL);
        }
