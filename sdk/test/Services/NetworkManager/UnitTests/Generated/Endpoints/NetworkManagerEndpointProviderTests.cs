    ...
    public partial class NetworkManagerEndpointsTests
    {
        ...
        public void For_custom_endpoint_with_fips_enabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            });
        ...
        public void For_region_useast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.us-west-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_useast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.us-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_useast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.us-west-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.cn-northwest-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.cn-northwest-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.cn-northwest-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.cn-northwest-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonNetworkManagerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkmanager.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
