...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class MediaPackageEndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_custom_endpoint_with_fips_enabled_and_dualstack_disabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonMediaPackageEndpointProvider().ResolveEndpoint(parameters);
            });
