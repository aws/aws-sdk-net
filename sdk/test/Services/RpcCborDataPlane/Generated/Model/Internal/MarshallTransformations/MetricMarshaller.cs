...
namespace Amazon.RpcCborDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// Metric Marshaller
    /// </summary>
    public class MetricMarshaller : IRequestMarshaller<Metric, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Metric requestObject, CborMarshallerContext context)
        {
            ...
            if (requestObject.IsSetNamespace())
            {
                ...
                context.Writer.WriteTextString(requestObject.Namespace);
            }
        }
