...
namespace Amazon.RpcCborDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutItemResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("PutItem");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "ConsumedCapacity":
                        {
                            context.AddPathSegment("ConsumedCapacity");
                    ...
                    case "ItemCollectionMetrics":
                        {
                            context.AddPathSegment("ItemCollectionMetrics");
