...
namespace Amazon.RpcCborDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ItemCollectionMetricsUnmarshaller : ICborUnmarshaller<ItemCollectionMetrics, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ItemCollectionMetrics Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ItemCollectionKey":
                        {
                            context.AddPathSegment("ItemCollectionKey");
                    ...
                    case "SizeEstimateRangeGB":
                        {
                            context.AddPathSegment("SizeEstimateRangeGB");
