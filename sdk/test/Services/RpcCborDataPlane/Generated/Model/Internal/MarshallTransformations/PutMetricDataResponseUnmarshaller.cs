...
namespace Amazon.RpcCborDataPlane.Model.Internal.MarshallTransformations
{
    ...
    public class PutMetricDataResponseUnmarshaller : CborResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonRpcCborDataPlaneException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }
