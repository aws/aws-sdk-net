...
namespace Amazon.RpcCborDataPlane.Internal
{
    ...
    public class AmazonRpcCborDataPlaneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRpcCborDataPlaneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RpcCborDataPlane.
        /// </summary>
        public AmazonRpcCborDataPlaneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRpcCborDataPlaneAuthSchemeParameters
            {
    ...
    public class AmazonRpcCborDataPlaneAuthSchemeResolver : IAuthSchemeResolver<AmazonRpcCborDataPlaneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRpcCborDataPlaneAuthSchemeParameters authParameters)
        {
