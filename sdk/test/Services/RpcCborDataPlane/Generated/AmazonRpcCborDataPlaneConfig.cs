...
namespace Amazon.RpcCborDataPlane
{
    ...
    /// </summary>
    public partial class AmazonRpcCborDataPlaneConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("RpcCborDataPlane", "4.0");
        ...
        /// Default constructor
        /// </summary>
        public AmazonRpcCborDataPlaneConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonRpcCborDataPlaneDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "RpcCborDataPlane";
            this.AuthenticationServiceName = "smithyrpcv2cbordataplane";
        }
        ...
        public override string RegionEndpointServiceName
        {
            get
            {
                return "smithyrpcv2cbordataplane";
            }
        }
