...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public class JSONRPC10MarshallingTests
    {
        ...
        [TestCategory("Json")]
        [TestCategory("JSONRPC10")]
        public void OperationWithDefaultsMarshallTest()
        {
            var operation = service_model.FindOperation("OperationWithDefaults");

            var request = InstantiateClassGenerator.Execute<OperationWithDefaultsRequest>(operation);
            var marshaller = new OperationWithDefaultsRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<OperationWithDefaultsRequest>(request,jsonRequest);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = OperationWithDefaultsResponseUnmarshaller.Instance.Unmarshall(context) as OperationWithDefaultsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("JSONRPC10")]
        public void OperationWithNestedStructureMarshallTest()
        {
            var operation = service_model.FindOperation("OperationWithNestedStructure");

            var request = InstantiateClassGenerator.Execute<OperationWithNestedStructureRequest>(operation);
            var marshaller = new OperationWithNestedStructureRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<OperationWithNestedStructureRequest>(request,jsonRequest);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = OperationWithNestedStructureResponseUnmarshaller.Instance.Unmarshall(context) as OperationWithNestedStructureResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("JSONRPC10")]
        public void OperationWithRequiredMembersMarshallTest()
        {
            var operation = service_model.FindOperation("OperationWithRequiredMembers");

            var request = InstantiateClassGenerator.Execute<OperationWithRequiredMembersRequest>(operation);
            var marshaller = new OperationWithRequiredMembersRequestMarshaller();
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = OperationWithRequiredMembersResponseUnmarshaller.Instance.Unmarshall(context) as OperationWithRequiredMembersResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
