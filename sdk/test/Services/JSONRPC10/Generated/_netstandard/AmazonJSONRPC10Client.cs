...
namespace Amazon.JSONRPC10
{
    ...
    public partial class AmazonJSONRPC10Client : AmazonServiceClient, IAmazonJSONRPC10
    {
        ...
        internal virtual OperationWithDefaultsResponse OperationWithDefaults(OperationWithDefaultsRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual OperationWithNestedStructureResponse OperationWithNestedStructure(OperationWithNestedStructureRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual OperationWithRequiredMembersResponse OperationWithRequiredMembers(OperationWithRequiredMembersRequest request)
        {
            var options = new InvokeOptions();
