...
namespace Amazon.JSONRPC10.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NoInputAndNoOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static NoInputAndNoOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NoInputAndNoOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
