...
namespace Amazon.JSONRPC10.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonJSONRPC10AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonJSONRPC10AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for JSONRPC10.
        /// </summary>
        public AmazonJSONRPC10AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonJSONRPC10AuthSchemeParameters
            {
    ...
    public class AmazonJSONRPC10AuthSchemeResolver : IAuthSchemeResolver<AmazonJSONRPC10AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonJSONRPC10AuthSchemeParameters authParameters)
        {
