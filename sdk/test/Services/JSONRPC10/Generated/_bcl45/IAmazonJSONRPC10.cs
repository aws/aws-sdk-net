...
namespace Amazon.JSONRPC10
{
    ...
    public partial interface IAmazonJSONRPC10 : IAmazonService, IDisposable
    {
        ...
        OperationWithDefaultsResponse OperationWithDefaults(OperationWithDefaultsRequest request);
        ...
        /// <returns>The response from the OperationWithDefaults service method, as returned by JSONRPC10.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/json-rpc-10-2020-07-14/OperationWithDefaults">REST API Reference for OperationWithDefaults Operation</seealso>
        Task<OperationWithDefaultsResponse> OperationWithDefaultsAsync(OperationWithDefaultsRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        OperationWithNestedStructureResponse OperationWithNestedStructure(OperationWithNestedStructureRequest request);
        ...
        /// <returns>The response from the OperationWithNestedStructure service method, as returned by JSONRPC10.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/json-rpc-10-2020-07-14/OperationWithNestedStructure">REST API Reference for OperationWithNestedStructure Operation</seealso>
        Task<OperationWithNestedStructureResponse> OperationWithNestedStructureAsync(OperationWithNestedStructureRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        OperationWithRequiredMembersResponse OperationWithRequiredMembers(OperationWithRequiredMembersRequest request);
        ...
        /// <returns>The response from the OperationWithRequiredMembers service method, as returned by JSONRPC10.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/json-rpc-10-2020-07-14/OperationWithRequiredMembers">REST API Reference for OperationWithRequiredMembers Operation</seealso>
        Task<OperationWithRequiredMembersResponse> OperationWithRequiredMembersAsync(OperationWithRequiredMembersRequest request, CancellationToken cancellationToken = default(CancellationToken));
