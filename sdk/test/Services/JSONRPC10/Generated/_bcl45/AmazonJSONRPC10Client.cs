...
namespace Amazon.JSONRPC10
{
    ...
    public partial class AmazonJSONRPC10Client : AmazonServiceClient, IAmazonJSONRPC10
    {
        ...
        public virtual OperationWithDefaultsResponse OperationWithDefaults(OperationWithDefaultsRequest request)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = OperationWithDefaultsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = OperationWithDefaultsResponseUnmarshaller.Instance;

            return Invoke<OperationWithDefaultsResponse>(request, options);
        }
        ...
        /// <returns>The response from the OperationWithDefaults service method, as returned by JSONRPC10.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/json-rpc-10-2020-07-14/OperationWithDefaults">REST API Reference for OperationWithDefaults Operation</seealso>
        public virtual Task<OperationWithDefaultsResponse> OperationWithDefaultsAsync(OperationWithDefaultsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = OperationWithDefaultsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = OperationWithDefaultsResponseUnmarshaller.Instance;
            
            return InvokeAsync<OperationWithDefaultsResponse>(request, options, cancellationToken);
        }
        ...
        public virtual OperationWithNestedStructureResponse OperationWithNestedStructure(OperationWithNestedStructureRequest request)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = OperationWithNestedStructureRequestMarshaller.Instance;
            options.ResponseUnmarshaller = OperationWithNestedStructureResponseUnmarshaller.Instance;

            return Invoke<OperationWithNestedStructureResponse>(request, options);
        }
        ...
        /// <returns>The response from the OperationWithNestedStructure service method, as returned by JSONRPC10.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/json-rpc-10-2020-07-14/OperationWithNestedStructure">REST API Reference for OperationWithNestedStructure Operation</seealso>
        public virtual Task<OperationWithNestedStructureResponse> OperationWithNestedStructureAsync(OperationWithNestedStructureRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = OperationWithNestedStructureRequestMarshaller.Instance;
            options.ResponseUnmarshaller = OperationWithNestedStructureResponseUnmarshaller.Instance;
            
            return InvokeAsync<OperationWithNestedStructureResponse>(request, options, cancellationToken);
        }
        ...
        public virtual OperationWithRequiredMembersResponse OperationWithRequiredMembers(OperationWithRequiredMembersRequest request)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = OperationWithRequiredMembersRequestMarshaller.Instance;
            options.ResponseUnmarshaller = OperationWithRequiredMembersResponseUnmarshaller.Instance;

            return Invoke<OperationWithRequiredMembersResponse>(request, options);
        }
        ...
        /// <returns>The response from the OperationWithRequiredMembers service method, as returned by JSONRPC10.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/json-rpc-10-2020-07-14/OperationWithRequiredMembers">REST API Reference for OperationWithRequiredMembers Operation</seealso>
        public virtual Task<OperationWithRequiredMembersResponse> OperationWithRequiredMembersAsync(OperationWithRequiredMembersRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = OperationWithRequiredMembersRequestMarshaller.Instance;
            options.ResponseUnmarshaller = OperationWithRequiredMembersResponseUnmarshaller.Instance;
            
            return InvokeAsync<OperationWithRequiredMembersResponse>(request, options, cancellationToken);
        }
