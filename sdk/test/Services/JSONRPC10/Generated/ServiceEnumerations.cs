...
namespace Amazon.JSONRPC10
{
    ...
    /// <summary>
    /// Constants used for properties of type TestEnum.
    /// </summary>
    public class TestEnum : ConstantClass
    {

        /// <summary>
        /// Constant BAR for TestEnum
        /// </summary>
        public static readonly TestEnum BAR = new TestEnum("BAR");
        /// <summary>
        /// Constant BAZ for TestEnum
        /// </summary>
        public static readonly TestEnum BAZ = new TestEnum("BAZ");
        /// <summary>
        /// Constant FOO for TestEnum
        /// </summary>
        public static readonly TestEnum FOO = new TestEnum("FOO");
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static TestEnum FindValue(string value)
        {
            return FindValue<TestEnum>(value);
        }
