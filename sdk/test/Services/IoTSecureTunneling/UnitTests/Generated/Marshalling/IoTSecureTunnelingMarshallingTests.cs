...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public class IoTSecureTunnelingMarshallingTests
    {
        ...
        public void RotateTunnelAccessTokenMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);
            Comparer.CompareObjectToJson<RotateTunnelAccessTokenRequest>(request,jsonRequest);
        ...
        [TestCategory("Json")]
        [TestCategory("IoTSecureTunneling")]
        public void RotateTunnelAccessToken_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("RotateTunnelAccessToken");
            ...
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
            var response = RotateTunnelAccessTokenResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
