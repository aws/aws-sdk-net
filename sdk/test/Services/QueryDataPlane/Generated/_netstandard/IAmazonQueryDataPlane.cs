...
{
    /// <summary>
    /// <para>Interface for accessing QueryDataPlane</para>
    ///
    /// 
    /// </summary>
    public partial interface IAmazonQueryDataPlane : IAmazonService, IDisposable
    {
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonQueryDataPlaneConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonQueryDataPlaneConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonQueryDataPlaneConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonQueryDataPlaneConfig to create AmazonQueryDataPlaneClient");
            }

            return awsCredentials == null ? 
                    new AmazonQueryDataPlaneClient(serviceClientConfig) :
                    new AmazonQueryDataPlaneClient(awsCredentials, serviceClientConfig);
        }
