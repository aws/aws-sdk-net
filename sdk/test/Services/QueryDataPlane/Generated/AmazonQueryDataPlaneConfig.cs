...
namespace Amazon.QueryDataPlane
{
    ...
    /// </summary>
    public partial class AmazonQueryDataPlaneConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("QueryDataPlane", "4.0");
        ...
        /// Default constructor
        /// </summary>
        public AmazonQueryDataPlaneConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonQueryDataPlaneDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "QueryDataPlane";
            this.AuthenticationServiceName = "awsquerydataplane";
        }
