...
namespace Amazon.QueryDataPlane.Internal
{
    ...
    public class AmazonQueryDataPlaneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQueryDataPlaneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QueryDataPlane.
        /// </summary>
        public AmazonQueryDataPlaneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQueryDataPlaneAuthSchemeParameters
            {
    ...
    public class AmazonQueryDataPlaneAuthSchemeResolver : IAuthSchemeResolver<AmazonQueryDataPlaneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQueryDataPlaneAuthSchemeParameters authParameters)
        {
