...
namespace Amazon.QueryDataPlane.Model.Internal.MarshallTransformations
{
    /// <summary>
    ...
    public class PutMetricDataResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonQueryDataPlaneException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }
