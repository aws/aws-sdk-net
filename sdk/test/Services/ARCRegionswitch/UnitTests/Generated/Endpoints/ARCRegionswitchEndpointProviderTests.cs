...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class ARCRegionswitchEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonARCRegionswitchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://arc-region-switch.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
