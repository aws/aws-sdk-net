...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class CodeStarEndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeStarEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codestar.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
