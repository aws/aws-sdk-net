...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class IotDataMarshallingTests
    {
        ...
        public void DeleteThingShadowMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DeleteThingShadowRequest>(operation);
        ...
        public void DeleteThingShadow_UnsupportedDocumentEncodingExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"UnsupportedDocumentEncodingException"},
                }
            };
        ...
        public void GetRetainedMessageMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetRetainedMessageRequest>(operation);
        ...
        public void GetThingShadowMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetThingShadowRequest>(operation);
        ...
        public void ListNamedShadowsForThingMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListNamedShadowsForThingRequest>(operation);
        ...
        public void ListRetainedMessagesMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListRetainedMessagesRequest>(operation);
        ...
        public void UpdateThingShadowMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<UpdateThingShadowRequest>(operation);
        ...
        public void UpdateThingShadow_RequestEntityTooLargeExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"RequestEntityTooLargeException"},
                }
            };
