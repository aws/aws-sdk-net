...
namespace Amazon.QueryCompatibleJSONRPC10.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NoCustomCodeErrorExceptionUnmarshaller : IErrorResponseUnmarshaller<NoCustomCodeErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public NoCustomCodeErrorException Unmarshall(JsonUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public NoCustomCodeErrorException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            context.Read();
