...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class LexMarshallingTests
    {
        ...
        public void PostContentMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PostContentRequest>(operation);
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    ...
                    {"x-amz-lex-encoded-input-transcript","x-amz-lex-encoded-input-transcript_Value"},
                    {"x-amz-lex-encoded-message","x-amz-lex-encoded-message_Value"},
            ...
            var response = unmarshaller.Unmarshall(context) as PostContentResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void PostContent_LoopDetectedExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    ...
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"LoopDetectedException"},
                }
            };
        ...
        public void PostContent_NotAcceptableExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    ...
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"NotAcceptableException"},
                }
            };
        ...
        public void PostContent_UnsupportedMediaTypeExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    ...
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"UnsupportedMediaTypeException"},
                }
            };
        ...
        public void PostTextMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PostTextRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as PostTextResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void PutSessionMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PutSessionRequest>(operation);
