...
{
    /// <summary>
    /// This is the response object from the XmlLists operation.
    /// </summary>
    public partial class XmlListsResponse : AmazonWebServiceResponse
    {
        private List<bool> _booleanList = new List<bool>();
        private List<string> _enumList = new List<string>();
        private List<string> _flattenedList = new List<string>();
        private List<string> _flattenedList2 = new List<string>();
        private List<string> _flattenedListWithMemberNamespace = new List<string>();
        private List<string> _flattenedListWithNamespace = new List<string>();
        ...
        private List<string> _renamedListMembers = new List<string>();
        ...
        {
            return this._booleanList != null && this._booleanList.Count > 0; 
        }
        ...
        {
            return this._flattenedList != null && this._flattenedList.Count > 0; 
        }
        ...
        {
            return this._flattenedList2 != null && this._flattenedList2.Count > 0; 
        }
        ...
        {
            return this._flattenedListWithMemberNamespace != null && this._flattenedListWithMemberNamespace.Count > 0; 
        }
        ...
        {
            return this._flattenedListWithNamespace != null && this._flattenedListWithNamespace.Count > 0; 
        }
        ...
        {
            return this._intEnumList != null && this._intEnumList.Count > 0; 
        }
        ...
        {
            return this._renamedListMembers != null && this._renamedListMembers.Count > 0; 
        }
        ...
        {
            return this._stringSet != null && this._stringSet.Count > 0; 
        }
        ...
        {
            return this._structureList != null && this._structureList.Count > 0; 
        }
