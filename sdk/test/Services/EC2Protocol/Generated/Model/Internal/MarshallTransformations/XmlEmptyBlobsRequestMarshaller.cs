...
namespace Amazon.EC2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class XmlEmptyBlobsRequestMarshaller : IMarshaller<IRequest, XmlEmptyBlobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(XmlEmptyBlobsRequest publicRequest)
        {
            ...
            request.Parameters.Add("Action", "XmlEmptyBlobs");
