...
namespace Amazon.EC2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EndpointWithHostLabelOperationResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static EndpointWithHostLabelOperationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EndpointWithHostLabelOperationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
