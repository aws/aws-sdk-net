...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class GuardDutyEndpointsTests
    {
        ...
        public void For_region_eucentral2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            var endpoint = new AmazonGuardDutyEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://guardduty-fips.eu-central-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eucentral2_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "eu-central-2";
            var endpoint = new AmazonGuardDutyEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://guardduty-fips.eu-central-2.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_eucentral2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["Region"] = "eu-central-2";
            var endpoint = new AmazonGuardDutyEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://guardduty.eu-central-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eucentral2_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "eu-central-2";
            var endpoint = new AmazonGuardDutyEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://guardduty.eu-central-2.amazonaws.com", endpoint.URL);
        }
