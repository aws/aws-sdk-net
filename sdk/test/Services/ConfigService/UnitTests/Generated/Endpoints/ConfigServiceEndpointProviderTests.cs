...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class ConfigServiceEndpointsTests
    {
        ...
        public void For_region_apsoutheast4_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonConfigServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://config-fips.ap-southeast-4.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast4_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonConfigServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://config-fips.ap-southeast-4.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast4_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonConfigServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://config.ap-southeast-4.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast4_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonConfigServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://config.ap-southeast-4.amazonaws.com", endpoint.URL);
        }
