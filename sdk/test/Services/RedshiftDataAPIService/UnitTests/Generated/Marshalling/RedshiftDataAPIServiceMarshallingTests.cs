...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public class RedshiftDataAPIServiceMarshallingTests
    {
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void BatchExecuteStatement_ActiveStatementsExceededExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("BatchExecuteStatement");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("ActiveStatementsExceededException"));
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ActiveStatementsExceededException"},
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void BatchExecuteStatement_BatchExecuteStatementExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("BatchExecuteStatement");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("BatchExecuteStatementException"));
            var jsonResponse = new JsonSampleGenerator(service_model, exception).Execute();
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"BatchExecuteStatementException"},
                    {"Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString()}
                }
            };
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void BatchExecuteStatement_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("BatchExecuteStatement");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void CancelStatement_DatabaseConnectionExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelStatement");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("DatabaseConnectionException"));
            var jsonResponse = new JsonSampleGenerator(service_model, exception).Execute();
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"DatabaseConnectionException"},
                    {"Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString()}
                }
            };
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void CancelStatement_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelStatement");
        ...
        public void DescribeStatementMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeStatementRequest>(operation);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = DescribeStatementResponseUnmarshaller.Instance.Unmarshall(context) as DescribeStatementResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void DescribeTable_DatabaseConnectionExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("DescribeTable");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ExecuteStatement_ActiveStatementsExceededExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ExecuteStatement");
        ...
        public void ExecuteStatement_ExecuteStatementExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"ExecuteStatementException"},
                    {"Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString()}
                }
            };
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
        ...
        public void GetStatementResultMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetStatementResultRequest>(operation);
            ...
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = GetStatementResultResponseUnmarshaller.Instance.Unmarshall(context) as GetStatementResultResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ListDatabases_DatabaseConnectionExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ListDatabases");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ListSchemas_DatabaseConnectionExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ListSchemas");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ListTables_DatabaseConnectionExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ListTables");
