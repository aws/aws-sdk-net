...
namespace Amazon.RestXmlDataPlane.Internal
{
    ...
    public class AmazonRestXmlDataPlaneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRestXmlDataPlaneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RestXmlDataPlane.
        /// </summary>
        public AmazonRestXmlDataPlaneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRestXmlDataPlaneAuthSchemeParameters
            {
    ...
    public class AmazonRestXmlDataPlaneAuthSchemeResolver : IAuthSchemeResolver<AmazonRestXmlDataPlaneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRestXmlDataPlaneAuthSchemeParameters authParameters)
        {
