...
{
    /// <summary>
    /// Configuration for accessing Amazon RestXmlDataPlane service
    /// </summary>
    public partial class AmazonRestXmlDataPlaneConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("RestXmlDataPlane", "4.0");
        ...
        /// Default constructor
        /// </summary>
        public AmazonRestXmlDataPlaneConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonRestXmlDataPlaneDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "RestXmlDataPlane";
            this.AuthenticationServiceName = "awsrestxmldataplane";
        }
