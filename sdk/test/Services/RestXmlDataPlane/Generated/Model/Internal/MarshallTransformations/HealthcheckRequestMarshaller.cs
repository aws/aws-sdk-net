...
namespace Amazon.RestXmlDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public partial class HealthcheckRequestMarshaller : IMarshaller<IRequest, HealthcheckRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        partial void PostMarshallCustomization(DefaultRequest defaultRequest, HealthcheckRequest publicRequest);
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, HealthcheckRequest publicRequest);
    }    
}