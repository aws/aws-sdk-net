    ...
    public partial class PutObjectRequestMarshaller : IMarshaller<IRequest, PutObjectRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutObjectRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetBucket())
                throw new AmazonRestXmlDataPlaneException("Request object does not have required field Bucket set");
            request.AddPathResource("{Bucket}", StringUtils.FromString(publicRequest.Bucket));
            if (!publicRequest.IsSetKey())
                throw new AmazonRestXmlDataPlaneException("Request object does not have required field Key set");
