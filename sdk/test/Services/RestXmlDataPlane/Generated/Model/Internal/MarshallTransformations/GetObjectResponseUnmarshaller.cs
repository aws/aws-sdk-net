...
namespace Amazon.RestXmlDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class GetObjectResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            if (context.ResponseData.IsHeaderPresent("Expires"))
                response.Expires = DateTime.Parse(context.ResponseData.GetHeaderValue("Expires"), CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal);
            ...
            if (context.ResponseData.IsHeaderPresent("x-amz-restore"))
                response.Restore = context.ResponseData.GetHeaderValue("x-amz-restore");
            ...
            if (context.ResponseData.IsHeaderPresent("x-amz-tagging-count"))
                response.TagCount = int.Parse(context.ResponseData.GetHeaderValue("x-amz-tagging-count"), CultureInfo.InvariantCulture);
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetObjectResponse response);
