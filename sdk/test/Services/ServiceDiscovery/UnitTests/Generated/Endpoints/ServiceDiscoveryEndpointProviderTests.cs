...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class ServiceDiscoveryEndpointsTests
    {
        ...
        public void For_region_euscdeeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonServiceDiscoveryEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://servicediscovery-fips.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_euscdeeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonServiceDiscoveryEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://servicediscovery.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonServiceDiscoveryEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://servicediscovery-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonServiceDiscoveryEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://servicediscovery.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonServiceDiscoveryEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://servicediscovery-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonServiceDiscoveryEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://servicediscovery.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
