...
namespace Amazon.RestXmlProtocol.Model
{
    ...
    {
        private Dictionary<string, Dictionary<string, string>> _flatNestedMap = new Dictionary<string, Dictionary<string, string>>();
        private Dictionary<string, Dictionary<string, string>> _nestedMap = new Dictionary<string, Dictionary<string, string>>();
        ...
        {
            return this._flatNestedMap != null && this._flatNestedMap.Count > 0; 
        }
        ...
        {
            return this._nestedMap != null && this._nestedMap.Count > 0; 
        }
