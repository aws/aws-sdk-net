...
namespace Amazon.RestXmlProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class EndpointOperationRequestMarshaller : IMarshaller<IRequest, EndpointOperationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((EndpointOperationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(EndpointOperationRequest publicRequest)
        {
        ...
        internal static EndpointOperationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EndpointOperationRequestMarshaller Instance
        {
            get
            {
                return _instance;
        ...
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, EndpointOperationRequest publicRequest);
    }    
}