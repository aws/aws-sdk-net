...
namespace Amazon.RestXmlProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class FractionalSecondsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, FractionalSecondsResponse response)
        {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, FractionalSecondsResponse response);
