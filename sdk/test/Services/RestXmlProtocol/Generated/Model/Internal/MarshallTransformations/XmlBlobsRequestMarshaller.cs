...
namespace Amazon.RestXmlProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class XmlBlobsRequestMarshaller : IMarshaller<IRequest, XmlBlobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((XmlBlobsRequest)input);
        }
        ...
        public IRequest Marshall(XmlBlobsRequest publicRequest)
        {
            ...
            {   
                xmlWriter.WriteStartElement("XmlBlobsRequest", "");
        ...
        internal static XmlBlobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static XmlBlobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
