...
namespace Amazon.RestXmlProtocol.Model
{
    ...
    public partial class AllQueryStringTypesRequest : AmazonRestXmlProtocolRequest
    {
        ...
        private List<double> _queryDoubleList = new List<double>();
        private FooEnum _queryEnum;
        private List<string> _queryEnumList = new List<string>();
        private float? _queryFloat;
        private int? _queryInteger;
        private int? _queryIntegerEnum;
        private List<int> _queryIntegerEnumList = new List<int>();
        private List<int> _queryIntegerList = new List<int>();
        private List<int> _queryIntegerSet = new List<int>();
        private long? _queryLong;
        private Dictionary<string, string> _queryParamsMapOfStrings = new Dictionary<string, string>();
        private int? _queryShort;
        private string _queryString;
        private List<string> _queryStringList = new List<string>();
        private List<string> _queryStringSet = new List<string>();
        ...
        {
            return this._queryDoubleList != null && this._queryDoubleList.Count > 0; 
        }
        ...
        {
            return this._queryEnumList != null && this._queryEnumList.Count > 0; 
        }
        ...
        {
            return this._queryIntegerEnumList != null && this._queryIntegerEnumList.Count > 0; 
        }
        ...
        {
            return this._queryIntegerSet != null && this._queryIntegerSet.Count > 0; 
        }
        ...
        {
            return this._queryParamsMapOfStrings != null && this._queryParamsMapOfStrings.Count > 0; 
        }
        ...
        {
            return this._queryStringSet != null && this._queryStringSet.Count > 0; 
        }
