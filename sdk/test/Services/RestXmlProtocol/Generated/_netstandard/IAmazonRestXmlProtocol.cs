...
namespace Amazon.RestXmlProtocol
{
    ...
    public partial interface IAmazonRestXmlProtocol : IAmazonService, IDisposable
    {
        ...
        Task<XmlAttributesInMiddleResponse> XmlAttributesInMiddleAsync(XmlAttributesInMiddleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
