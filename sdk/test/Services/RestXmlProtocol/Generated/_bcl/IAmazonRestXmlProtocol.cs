...
namespace Amazon.RestXmlProtocol
{
    ...
    public partial interface IAmazonRestXmlProtocol : IAmazonService, IDisposable
    {
        ...
        /// <returns>The response from the NestedXmlMapWithXmlName service method, as returned by RestXmlProtocol.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/rest-xml-protocol-2019-12-16/NestedXmlMapWithXmlName">REST API Reference for NestedXmlMapWithXmlName Operation</seealso>
        Task<NestedXmlMapWithXmlNameResponse> NestedXmlMapWithXmlNameAsync(NestedXmlMapWithXmlNameRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        XmlAttributesInMiddleResponse XmlAttributesInMiddle(XmlAttributesInMiddleRequest request);
        ...
        /// <returns>The response from the XmlAttributesInMiddle service method, as returned by RestXmlProtocol.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/rest-xml-protocol-2019-12-16/XmlAttributesInMiddle">REST API Reference for XmlAttributesInMiddle Operation</seealso>
        Task<XmlAttributesInMiddleResponse> XmlAttributesInMiddleAsync(XmlAttributesInMiddleRequest request, CancellationToken cancellationToken = default(CancellationToken));
