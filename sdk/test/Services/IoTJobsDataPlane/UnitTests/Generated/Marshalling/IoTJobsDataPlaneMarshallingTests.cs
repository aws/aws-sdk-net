...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class IoTJobsDataPlaneMarshallingTests
    {
        ...
        public void DescribeJobExecutionMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeJobExecutionRequest>(operation);
        ...
        public void DescribeJobExecution_CertificateValidationExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"CertificateValidationException"},
                }
            };
        ...
        public void DescribeJobExecution_TerminalStateExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"TerminalStateException"},
                }
            };
        ...
        public void GetPendingJobExecutionsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetPendingJobExecutionsRequest>(operation);
        ...
        public void StartNextPendingJobExecutionMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<StartNextPendingJobExecutionRequest>(operation);
        ...
        public void UpdateJobExecutionMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<UpdateJobExecutionRequest>(operation);
        ...
        public void UpdateJobExecution_InvalidStateTransitionExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"InvalidStateTransitionException"},
                }
            };
