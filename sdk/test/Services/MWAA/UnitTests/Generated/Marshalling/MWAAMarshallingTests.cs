...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class MWAAMarshallingTests
    {
        ...
        public void CreateCliTokenMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CreateCliTokenRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CreateCliTokenResponse;
        ...
        public void CreateWebLoginTokenMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CreateWebLoginTokenRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CreateWebLoginTokenResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void PublishMetricsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<PublishMetricsRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as PublishMetricsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
