...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class LookoutforVisionMarshallingTests
    {
        ...
        public void DescribeModelPackagingJobMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context)
                as DescribeModelPackagingJobResponse;   
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);               
        }
        ...
        public void ListModelPackagingJobsMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context)
                as ListModelPackagingJobsResponse;   
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);               
        }
        ...
        public void StartModelPackagingJobMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context)
                as StartModelPackagingJobResponse;   
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);               
        }
