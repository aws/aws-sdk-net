...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class GeoPlacesEndpointsTests
    {
        ...
        public void For_region_euscdeeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonGeoPlacesEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://geo-places-fips.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_euscdeeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonGeoPlacesEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://geo-places.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
