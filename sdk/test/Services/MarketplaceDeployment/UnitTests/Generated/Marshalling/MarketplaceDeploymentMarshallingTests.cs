...
{
    [TestClass]
    public partial class MarketplaceDeploymentMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("marketplace-deployment");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameterMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");

            var request = InstantiateClassGenerator.Execute<PutDeploymentParameterRequest>(operation);
            var marshaller = new PutDeploymentParameterRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("PutDeploymentParameter", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = PutDeploymentParameterResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as PutDeploymentParameterResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = PutDeploymentParameterResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_ConflictExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_ServiceQuotaExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MarketplaceDeployment")]
        public void PutDeploymentParameter_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutDeploymentParameter");
