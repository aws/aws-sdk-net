...
{
    /// <summary>
    /// Response Unmarshaller for MemberRefOp operation
    /// </summary>  
    public class MemberRefOpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            MemberRefOpResponse response = new MemberRefOpResponse();
        ...
        private static MemberRefOpResponseUnmarshaller _instance = new MemberRefOpResponseUnmarshaller();        

        internal static MemberRefOpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MemberRefOpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
