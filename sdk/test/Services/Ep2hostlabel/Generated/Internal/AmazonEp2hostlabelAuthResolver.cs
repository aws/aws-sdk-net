...
namespace Amazon.Ep2hostlabel.Internal
{
    ...
    public class AmazonEp2hostlabelAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEp2hostlabelAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Ep2hostlabel.
        /// </summary>
        public AmazonEp2hostlabelAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEp2hostlabelAuthSchemeParameters
            {
    ...
    public class AmazonEp2hostlabelAuthSchemeResolver : IAuthSchemeResolver<AmazonEp2hostlabelAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEp2hostlabelAuthSchemeParameters authParameters)
        {
