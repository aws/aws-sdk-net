...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class DSQLEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonDSQLEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://dsql.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
