...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class WorkMailMessageFlowMarshallingTests
    {
        ...
        public void GetRawMessageContentMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as GetRawMessageContentResponse;
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("WorkMailMessageFlow")]
        public void PutRawMessageContentMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("PutRawMessageContent", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = PutRawMessageContentResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as PutRawMessageContentResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("WorkMailMessageFlow")]
        public void PutRawMessageContent_InvalidContentLocationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutRawMessageContent");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("InvalidContentLocationException"));
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"InvalidContentLocationException"},
                }
            };
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = PutRawMessageContentResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("WorkMailMessageFlow")]
        public void PutRawMessageContent_MessageFrozenExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutRawMessageContent");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("MessageFrozenException"));
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"MessageFrozenException"},
                }
            };
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("WorkMailMessageFlow")]
        public void PutRawMessageContent_MessageRejectedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutRawMessageContent");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("WorkMailMessageFlow")]
        public void PutRawMessageContent_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PutRawMessageContent");
