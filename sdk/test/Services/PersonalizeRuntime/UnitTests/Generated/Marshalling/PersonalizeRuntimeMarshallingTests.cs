...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class PersonalizeRuntimeMarshallingTests
    {
        ...
        public void GetActionRecommendationsMarshallTest()
        {
            var operation = service_model.FindOperation("GetActionRecommendations");

            var request = InstantiateClassGenerator.Execute<GetActionRecommendationsRequest>(operation);
            var marshaller = new GetActionRecommendationsRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("GetActionRecommendations", request, internalRequest, service_model);
            ...
            ResponseUnmarshaller unmarshaller = GetActionRecommendationsResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as GetActionRecommendationsResponse;
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("PersonalizeRuntime")]
        public void GetActionRecommendations_InvalidInputExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetActionRecommendations");
            ...
            var response = GetActionRecommendationsResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("PersonalizeRuntime")]
        public void GetActionRecommendations_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetActionRecommendations");
        ...
        public void GetPersonalizedRankingMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as GetPersonalizedRankingResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
