...
namespace Amazon.PaginatorsTest.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonPaginatorsTestAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPaginatorsTestAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PaginatorsTest.
        /// </summary>
        public AmazonPaginatorsTestAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPaginatorsTestAuthSchemeParameters
            {
    ...
    public class AmazonPaginatorsTestAuthSchemeResolver : IAuthSchemeResolver<AmazonPaginatorsTestAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPaginatorsTestAuthSchemeParameters authParameters)
        {
