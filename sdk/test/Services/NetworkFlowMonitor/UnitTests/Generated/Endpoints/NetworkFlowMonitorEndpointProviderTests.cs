...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class NetworkFlowMonitorEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = true;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonNetworkFlowMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://networkflowmonitor.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
