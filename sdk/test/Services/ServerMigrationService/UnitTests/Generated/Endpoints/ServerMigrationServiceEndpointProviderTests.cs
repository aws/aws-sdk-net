...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class ServerMigrationServiceEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            var endpoint = new AmazonServerMigrationServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "us-iso-east-1";
            var endpoint = new AmazonServerMigrationServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            var endpoint = new AmazonServerMigrationServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["Region"] = "us-isob-east-1";
            var endpoint = new AmazonServerMigrationServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
