...
using Amazon.Artifact.Endpoints;
using Amazon.Artifact.Internal;

namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    [TestClass]
    public partial class ArtifactEndpointsTests
    {
        [TestMethod]
        ...
        {
            var parameters = new ArtifactEndpointParameters();
            parameters["Endpoint"] = "https://example.com";
            parameters["UseFIPS"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
        ...
        public void For_custom_endpoint_with_fips_enabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            });
        ...
        public void For_region_useast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_useast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_useast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_useast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.cn-northwest-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.cn-northwest-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.cn-northwest-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.cn-northwest-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_euscdeeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_euscdeeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-gov-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact-fips.us-gov-west-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-gov-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonArtifactEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://artifact.us-gov-west-1.amazonaws.com", endpoint.URL);
        }
