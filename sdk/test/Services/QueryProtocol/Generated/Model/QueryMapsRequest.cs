...
namespace Amazon.QueryProtocol.Model
{
    ...
    {
        private Dictionary<string, GreetingStruct> _complexMapArg = new Dictionary<string, GreetingStruct>();
        private Dictionary<string, string> _flattenedMap = new Dictionary<string, string>();
        private Dictionary<string, string> _flattenedMapWithXmlName = new Dictionary<string, string>();
        private Dictionary<string, string> _mapArg = new Dictionary<string, string>();
        private Dictionary<string, List<string>> _mapOfLists = new Dictionary<string, List<string>>();
        private Dictionary<string, string> _mapWithXmlMemberName = new Dictionary<string, string>();
        private NestedStructWithMap _nestedStructWithMap;
        private Dictionary<string, string> _renamedMapArg = new Dictionary<string, string>();
        ...
        {
            return this._complexMapArg != null && this._complexMapArg.Count > 0; 
        }
        ...
        {
            return this._flattenedMap != null && this._flattenedMap.Count > 0; 
        }
        ...
        {
            return this._flattenedMapWithXmlName != null && this._flattenedMapWithXmlName.Count > 0; 
        }
        ...
        {
            return this._mapArg != null && this._mapArg.Count > 0; 
        }
        ...
        {
            return this._mapOfLists != null && this._mapOfLists.Count > 0; 
        }
        ...
        {
            return this._mapWithXmlMemberName != null && this._mapWithXmlMemberName.Count > 0; 
        }
        ...
        {
            return this._renamedMapArg != null && this._renamedMapArg.Count > 0; 
        }
