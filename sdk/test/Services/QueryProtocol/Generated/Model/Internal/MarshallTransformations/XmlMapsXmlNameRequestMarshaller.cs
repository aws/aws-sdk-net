...
namespace Amazon.QueryProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class XmlMapsXmlNameRequestMarshaller : IMarshaller<IRequest, XmlMapsXmlNameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(XmlMapsXmlNameRequest publicRequest)
        {
            ...
            request.Parameters.Add("Action", "XmlMapsXmlName");
