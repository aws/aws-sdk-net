    ...
    public class FlattenedXmlMapResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("FlattenedXmlMapResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, FlattenedXmlMapResponse response)
        {
        ...
        internal static FlattenedXmlMapResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FlattenedXmlMapResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
