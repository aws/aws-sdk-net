...
namespace Amazon.QueryProtocol.Model
{
    ...
    public partial class XmlIntEnumsResponse : AmazonWebServiceResponse
    {
        ...
        private Dictionary<string, int> _intEnumMap = new Dictionary<string, int>();
        private List<int> _intEnumSet = new List<int>();
        ...
        {
            return this._intEnumMap != null && this._intEnumMap.Count > 0; 
        }
        ...
        {
            return this._intEnumSet != null && this._intEnumSet.Count > 0; 
        }
