...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class CloudWatchEndpointsTests
    {
        ...
        public void For_region_cawest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonCloudWatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://monitoring-fips.ca-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_cawest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCloudWatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://monitoring-fips.ca-west-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_cawest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonCloudWatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://monitoring.ca-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_cawest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCloudWatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://monitoring.ca-west-1.amazonaws.com", endpoint.URL);
        }
