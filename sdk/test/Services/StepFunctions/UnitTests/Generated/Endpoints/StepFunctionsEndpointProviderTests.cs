    ...
    public partial class StepFunctionsEndpointsTests
    {
        ...
        public void For_custom_endpoint_with_fips_enabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            });
        ...
        public void For_region_euscdeeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://states-fips.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_euscdeeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://states.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://states-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://states.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://states-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStepFunctionsEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://states.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
