...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class DetectiveEndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonDetectiveEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://api.detective-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonDetectiveEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://api.detective-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonDetectiveEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://api.detective.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonDetectiveEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://api.detective.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
