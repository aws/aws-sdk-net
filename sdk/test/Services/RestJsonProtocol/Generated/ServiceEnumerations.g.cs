...
namespace Amazon.RestJsonProtocol
{
    ...
    public class FooEnum : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom FooEnum for a value not among the defined constants.
        /// </summary>
        public FooEnum(string value) : base(value) { }
    ...
    public class StringEnum : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom StringEnum for a value not among the defined constants.
        /// </summary>
