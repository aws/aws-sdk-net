...
{
    /// <summary>
    /// Container for the parameters to the ConstantQueryString operation.
    ...
    /// </summary>
    public partial class ConstantQueryStringRequest : AmazonRestJsonProtocolRequest
    {
        private string _hello;

        /// <summary>
        /// Gets and sets the property Hello.
        /// </summary>
        [AWSProperty(Required=true)]
        public string Hello
        {
            get { return this._hello; }
            set { this._hello = value; }
        }

        // Check to see if Hello property is set
        internal bool IsSetHello()
        {
