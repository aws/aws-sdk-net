...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    public partial class QueryPrecedenceRequest : AmazonRestJsonProtocolRequest
    {
        ...
        /// </summary>
        public Dictionary<string, string> Baz { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the Baz property is set.
        /// </summary>
        internal bool IsSetBaz() => this.Baz != null && (this.Baz.Count > 0 || !AWSConfigs.InitializeCollections);
