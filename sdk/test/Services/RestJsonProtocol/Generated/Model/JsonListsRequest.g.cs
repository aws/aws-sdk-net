...
{
    /// <summary>
    /// Container for the parameters to the JsonLists operation. This test case serializes
    /// JSON lists for the following cases for both input and output: 1. Normal JSON lists.
    /// 2. Normal JSON sets. 3. JSON lists of lists. 4. Lists of structures.
    /// </summary>
