...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    public partial class JsonEnumsRequest : AmazonRestJsonProtocolRequest
    {
        ...
        private List<string> _fooEnumList = new List<string>();
        private Dictionary<string, string> _fooEnumMap = new Dictionary<string, string>();
        private List<string> _fooEnumSet = new List<string>();
        ...
        {
            return this._fooEnumList != null && this._fooEnumList.Count > 0; 
        }
        ...
        {
            return this._fooEnumMap != null && this._fooEnumMap.Count > 0; 
        }
        ...
        {
            return this._fooEnumSet != null && this._fooEnumSet.Count > 0; 
        }
