...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    public partial class HttpPrefixHeadersResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public Dictionary<string, string> FooMap { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the FooMap property is set.
        /// </summary>
        internal bool IsSetFooMap() => this.FooMap != null && (this.FooMap.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
