...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    public partial class JsonIntEnumsRequest : AmazonRestJsonProtocolRequest
    {
        ...
        private List<int> _integerEnumList = new List<int>();
        private Dictionary<string, int> _integerEnumMap = new Dictionary<string, int>();
        private List<int> _integerEnumSet = new List<int>();
        ...
        {
            return this._integerEnumList != null && this._integerEnumList.Count > 0; 
        }
        ...
        {
            return this._integerEnumMap != null && this._integerEnumMap.Count > 0; 
        }
        ...
        {
            return this._integerEnumSet != null && this._integerEnumSet.Count > 0; 
        }
