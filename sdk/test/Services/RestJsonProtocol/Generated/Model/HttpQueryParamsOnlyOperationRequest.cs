...
{
    /// <summary>
    /// Container for the parameters to the HttpQueryParamsOnlyOperation operation.
    ...
    {
        private Dictionary<string, string> _queryMap = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;
