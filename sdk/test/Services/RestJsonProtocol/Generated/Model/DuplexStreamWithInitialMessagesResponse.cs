...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    public partial class DuplexStreamWithInitialMessagesResponse : AmazonWebServiceResponse, Amazon.Runtime.EventStreams.IEventInputStreamContextOwner, IDisposable
    {
        ...
        public string InitialResponseMember
        {
            get { return this._initialResponseMember; }
            set { this._initialResponseMember = value; }
        }

        // Check to see if InitialResponseMember property is set
        internal bool IsSetInitialResponseMember()
        {
            return this._initialResponseMember != null;
        }
