...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    {
        private List<bool> _headerBooleanList = new List<bool>();
        private int? _headerByte;
        private double? _headerDouble;
        private FooEnum _headerEnum;
        private List<string> _headerEnumList = new List<string>();
        private bool? _headerFalseBool;
        private float? _headerFloat;
        private int? _headerInteger;
        private int? _headerIntegerEnum;
        private List<int> _headerIntegerEnumList = new List<int>();
        private List<int> _headerIntegerList = new List<int>();
        private long? _headerLong;
        private int? _headerShort;
        private string _headerString;
        private List<string> _headerStringList = new List<string>();
        private List<string> _headerStringSet = new List<string>();
        private List<DateTime> _headerTimestampList = new List<DateTime>();
