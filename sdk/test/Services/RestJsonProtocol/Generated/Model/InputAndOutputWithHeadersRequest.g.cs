...
{
    /// <summary>
    /// Container for the parameters to the InputAndOutputWithHeaders operation. The example
    /// tests how requests and responses are serialized when there is no input or output payload
    /// but there are HTTP header bindings.
    /// </summary>
