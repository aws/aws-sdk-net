...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class JsonMapsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new JsonMapsResponse();
            ...
            {
                if (context.TestExpression("denseBooleanMap", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DenseBooleanMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("denseNumberMap", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DenseNumberMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("denseSetMap", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DenseSetMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("denseStringMap", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.DenseStringMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("denseStructMap", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DenseStructMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static JsonMapsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static JsonMapsResponseUnmarshaller Instance => _instance;
    }
}
