...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GreetingWithErrorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GreetingWithErrorsResponse();
            if (context.ResponseData.IsHeaderPresent("X-Greeting"))
            {
                unmarshalledObject.Greeting = context.ResponseData.GetHeaderValue("X-Greeting");
            }
        ...
        internal static GreetingWithErrorsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GreetingWithErrorsResponseUnmarshaller Instance => _instance;
    }
}
