...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class InputStreamWithInitialRequestRequestMarshaller : IMarshaller<IRequest, InputStreamWithInitialRequestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static InputStreamWithInitialRequestRequestMarshaller _instance = new InputStreamWithInitialRequestRequestMarshaller();        

        internal static InputStreamWithInitialRequestRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InputStreamWithInitialRequestRequestMarshaller Instance
        {
            get
            {
                return _instance;
