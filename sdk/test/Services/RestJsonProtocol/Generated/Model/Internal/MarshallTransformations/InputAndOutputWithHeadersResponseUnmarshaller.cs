...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputAndOutputWithHeadersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            if (context.ResponseData.IsHeaderPresent("X-IntegerEnum"))
                response.HeaderIntegerEnum = int.Parse(context.ResponseData.GetHeaderValue("X-IntegerEnum"), CultureInfo.InvariantCulture);
            if (context.ResponseData.IsHeaderPresent("X-IntegerEnumList"))
                response.HeaderIntegerEnumList = MultiValueHeaderParser.ToValueTypeList<int>(context.ResponseData.GetHeaderValue("X-IntegerEnumList"));
