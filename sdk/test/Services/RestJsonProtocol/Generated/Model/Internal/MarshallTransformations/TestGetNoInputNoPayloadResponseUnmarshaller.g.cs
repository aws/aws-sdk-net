...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TestGetNoInputNoPayloadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TestGetNoInputNoPayloadResponse();
            if (context.ResponseData.IsHeaderPresent("X-Amz-Test-Id"))
            {
                unmarshalledObject.TestId = context.ResponseData.GetHeaderValue("X-Amz-Test-Id");
            }
        ...
        internal static TestGetNoInputNoPayloadResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TestGetNoInputNoPayloadResponseUnmarshaller Instance => _instance;
    }
}
