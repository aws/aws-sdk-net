...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class TimestampFormatHeadersRequestMarshaller : IMarshaller<IRequest, TimestampFormatHeadersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly TimestampFormatHeadersRequestMarshaller _instance = new();

        internal static TimestampFormatHeadersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TimestampFormatHeadersRequestMarshaller Instance => _instance;
    }
}
