...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NullAndEmptyHeadersClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            NullAndEmptyHeadersClientResponse response = new NullAndEmptyHeadersClientResponse();
            if (context.ResponseData.IsHeaderPresent("X-A"))
                response.A = context.ResponseData.GetHeaderValue("X-A");
            if (context.ResponseData.IsHeaderPresent("X-B"))
                response.B = context.ResponseData.GetHeaderValue("X-B");
        ...
        internal static NullAndEmptyHeadersClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NullAndEmptyHeadersClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
