...
{
    /// <summary>
    /// Response Unmarshaller for OutputStreamWithInitialResponse operation
    /// </summary>  
    public class OutputStreamWithInitialResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static OutputStreamWithInitialResponseResponseUnmarshaller _instance = new OutputStreamWithInitialResponseResponseUnmarshaller();        

        internal static OutputStreamWithInitialResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OutputStreamWithInitialResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
