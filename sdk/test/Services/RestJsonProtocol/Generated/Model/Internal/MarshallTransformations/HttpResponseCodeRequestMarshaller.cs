...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class HttpResponseCodeRequestMarshaller : IMarshaller<IRequest, HttpResponseCodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((HttpResponseCodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(HttpResponseCodeRequest publicRequest)
        {
        ...
        internal static HttpResponseCodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HttpResponseCodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
