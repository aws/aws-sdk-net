...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HttpPrefixHeadersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new HttpPrefixHeadersResponse();
            ...
            foreach (var headerName in context.ResponseData.GetHeaderNames())
            {
                ...
                {
                    headersForFooMap.Add(keyToUse, context.ResponseData.GetHeaderValue($"x-foo-{keyToUse}"));
                }
            }
            if (headersForFooMap.Count > 0)
            {
                unmarshalledObject.FooMap = headersForFooMap;
            }
        ...
        internal static HttpPrefixHeadersResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HttpPrefixHeadersResponseUnmarshaller Instance => _instance;
    }
}
