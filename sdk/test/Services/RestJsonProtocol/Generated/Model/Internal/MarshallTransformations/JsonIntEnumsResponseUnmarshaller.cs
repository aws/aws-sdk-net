        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("integerEnumList", targetDepth))
                {
                    ...
                    response.IntegerEnumList = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("integerEnumMap", targetDepth))
                {
                    ...
                    response.IntegerEnumMap = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("integerEnumSet", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<int, IntUnmarshaller>(IntUnmarshaller.Instance);
                    response.IntegerEnumSet = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
