...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class NullAndEmptyHeadersClientRequestMarshaller : IMarshaller<IRequest, NullAndEmptyHeadersClientRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly NullAndEmptyHeadersClientRequestMarshaller _instance = new();

        internal static NullAndEmptyHeadersClientRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static NullAndEmptyHeadersClientRequestMarshaller Instance => _instance;
    }
}
