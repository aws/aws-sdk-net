...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class NoInputAndNoOutputRequestMarshaller : IMarshaller<IRequest, NoInputAndNoOutputRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly NoInputAndNoOutputRequestMarshaller _instance = new();

        internal static NoInputAndNoOutputRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static NoInputAndNoOutputRequestMarshaller Instance => _instance;
    }
}
