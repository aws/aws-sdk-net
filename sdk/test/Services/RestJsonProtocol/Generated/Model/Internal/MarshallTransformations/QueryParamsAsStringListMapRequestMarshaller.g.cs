...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class QueryParamsAsStringListMapRequestMarshaller : IMarshaller<IRequest, QueryParamsAsStringListMapRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly QueryParamsAsStringListMapRequestMarshaller _instance = new();

        internal static QueryParamsAsStringListMapRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static QueryParamsAsStringListMapRequestMarshaller Instance => _instance;
    }
}
