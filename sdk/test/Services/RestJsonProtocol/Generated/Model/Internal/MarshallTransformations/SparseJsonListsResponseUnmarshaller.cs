...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SparseJsonListsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SparseJsonListsResponse response = new SparseJsonListsResponse();
        ...
        internal static SparseJsonListsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SparseJsonListsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
