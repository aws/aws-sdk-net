...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class IgnoreQueryParamsInResponseRequestMarshaller : IMarshaller<IRequest, IgnoreQueryParamsInResponseRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly IgnoreQueryParamsInResponseRequestMarshaller _instance = new();

        internal static IgnoreQueryParamsInResponseRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static IgnoreQueryParamsInResponseRequestMarshaller Instance => _instance;
    }
}
