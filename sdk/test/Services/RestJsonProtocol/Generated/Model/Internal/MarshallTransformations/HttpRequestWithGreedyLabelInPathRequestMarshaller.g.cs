...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class HttpRequestWithGreedyLabelInPathRequestMarshaller : IMarshaller<IRequest, HttpRequestWithGreedyLabelInPathRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly HttpRequestWithGreedyLabelInPathRequestMarshaller _instance = new();

        internal static HttpRequestWithGreedyLabelInPathRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HttpRequestWithGreedyLabelInPathRequestMarshaller Instance => _instance;
    }
}
