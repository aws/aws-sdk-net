...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class DatetimeOffsetsRequestMarshaller : IMarshaller<IRequest, DatetimeOffsetsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly DatetimeOffsetsRequestMarshaller _instance = new();

        internal static DatetimeOffsetsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DatetimeOffsetsRequestMarshaller Instance => _instance;
    }
}
