...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class HttpPrefixHeadersRequestMarshaller : IMarshaller<IRequest, HttpPrefixHeadersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(HttpPrefixHeadersRequest publicRequest)
        {
            ...
            {
                foreach (var kvp in publicRequest.FooMap)
                {
                    request.Headers[$"x-foo-{kvp.Key}"] = kvp.Value;
                }
            }
        ...
        private static readonly HttpPrefixHeadersRequestMarshaller _instance = new();

        internal static HttpPrefixHeadersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HttpPrefixHeadersRequestMarshaller Instance => _instance;
    }
}
