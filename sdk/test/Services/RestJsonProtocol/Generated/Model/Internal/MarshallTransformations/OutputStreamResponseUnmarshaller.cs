...
{
    /// <summary>
    /// Response Unmarshaller for OutputStream operation
    /// </summary>  
    public class OutputStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ServiceUnavailableErrorExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static OutputStreamResponseUnmarshaller _instance = new OutputStreamResponseUnmarshaller();        

        internal static OutputStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OutputStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
