...
{
    /// <summary>
    /// Response Unmarshaller for HttpPrefixHeadersInResponse operation
    /// </summary>  
    public class HttpPrefixHeadersInResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            HttpPrefixHeadersInResponseResponse response = new HttpPrefixHeadersInResponseResponse();
        ...
        private static HttpPrefixHeadersInResponseResponseUnmarshaller _instance = new HttpPrefixHeadersInResponseResponseUnmarshaller();        

        internal static HttpPrefixHeadersInResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HttpPrefixHeadersInResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
