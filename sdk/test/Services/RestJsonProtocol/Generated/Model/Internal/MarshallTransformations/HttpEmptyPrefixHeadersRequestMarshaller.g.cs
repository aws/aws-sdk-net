...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class HttpEmptyPrefixHeadersRequestMarshaller : IMarshaller<IRequest, HttpEmptyPrefixHeadersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(HttpEmptyPrefixHeadersRequest publicRequest)
        {
            ...
            {
                foreach (var kvp in publicRequest.PrefixHeaders)
                {
        ...
        private static readonly HttpEmptyPrefixHeadersRequestMarshaller _instance = new();

        internal static HttpEmptyPrefixHeadersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HttpEmptyPrefixHeadersRequestMarshaller Instance => _instance;
    }
}
