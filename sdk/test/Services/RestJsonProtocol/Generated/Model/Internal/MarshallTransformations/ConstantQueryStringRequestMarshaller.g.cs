...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class ConstantQueryStringRequestMarshaller : IMarshaller<IRequest, ConstantQueryStringRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly ConstantQueryStringRequestMarshaller _instance = new();

        internal static ConstantQueryStringRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ConstantQueryStringRequestMarshaller Instance => _instance;
    }
}
