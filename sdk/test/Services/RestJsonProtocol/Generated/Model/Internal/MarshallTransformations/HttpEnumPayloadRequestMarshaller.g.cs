...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class HttpEnumPayloadRequestMarshaller : IMarshaller<IRequest, HttpEnumPayloadRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly HttpEnumPayloadRequestMarshaller _instance = new();

        internal static HttpEnumPayloadRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HttpEnumPayloadRequestMarshaller Instance => _instance;
    }
}
