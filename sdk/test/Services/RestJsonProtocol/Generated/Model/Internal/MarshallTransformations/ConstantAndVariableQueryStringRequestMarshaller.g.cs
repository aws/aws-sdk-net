...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class ConstantAndVariableQueryStringRequestMarshaller : IMarshaller<IRequest, ConstantAndVariableQueryStringRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly ConstantAndVariableQueryStringRequestMarshaller _instance = new();

        internal static ConstantAndVariableQueryStringRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ConstantAndVariableQueryStringRequestMarshaller Instance => _instance;
    }
}
