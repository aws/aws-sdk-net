...
{
    /// <summary>
    /// Exception Unmarshaller for InvalidGreetingException
    /// </summary>
    public partial class InvalidGreetingExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidGreetingException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InvalidGreetingException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static InvalidGreetingExceptionUnmarshaller Instance => _instance;
    }
}
