...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DocumentTypeAsMapValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DocumentTypeAsMapValueResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("docValuedMap", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DocValuedMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DocumentTypeAsMapValueResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DocumentTypeAsMapValueResponseUnmarshaller Instance => _instance;
    }
}
