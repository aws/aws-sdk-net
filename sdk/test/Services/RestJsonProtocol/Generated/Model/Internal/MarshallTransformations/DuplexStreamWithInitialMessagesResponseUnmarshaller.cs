...
{
    /// <summary>
    /// Response Unmarshaller for DuplexStreamWithInitialMessages operation
    /// </summary>  
    public class DuplexStreamWithInitialMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DuplexStreamWithInitialMessagesResponse response = new DuplexStreamWithInitialMessagesResponse();
        ...
        private static DuplexStreamWithInitialMessagesResponseUnmarshaller _instance = new DuplexStreamWithInitialMessagesResponseUnmarshaller();        

        internal static DuplexStreamWithInitialMessagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DuplexStreamWithInitialMessagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
