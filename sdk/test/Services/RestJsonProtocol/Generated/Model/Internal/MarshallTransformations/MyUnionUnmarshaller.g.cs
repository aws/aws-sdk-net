...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MyUnionUnmarshaller : IJsonUnmarshaller<MyUnion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MyUnion();
            ...
            {
                if (context.TestExpression("blobValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("enumValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("listValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("mapValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("renamedStructureValue", targetDepth, ref reader))
                {
                    var unmarshaller = RenamedGreetingUnmarshaller.Instance;
                    unmarshalledObject.RenamedStructureValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("structureValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("timestampValue", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static MyUnionUnmarshaller Instance => _instance;
    }
}
