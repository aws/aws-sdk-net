...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class NullAndEmptyHeadersServerRequestMarshaller : IMarshaller<IRequest, NullAndEmptyHeadersServerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly NullAndEmptyHeadersServerRequestMarshaller _instance = new();

        internal static NullAndEmptyHeadersServerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static NullAndEmptyHeadersServerRequestMarshaller Instance => _instance;
    }
}
