...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class QueryIdempotencyTokenAutoFillRequestMarshaller : IMarshaller<IRequest, QueryIdempotencyTokenAutoFillRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(QueryIdempotencyTokenAutoFillRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("token", Guid.NewGuid().ToString());
            }
        ...
        private static readonly QueryIdempotencyTokenAutoFillRequestMarshaller _instance = new();

        internal static QueryIdempotencyTokenAutoFillRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static QueryIdempotencyTokenAutoFillRequestMarshaller Instance => _instance;
    }
}
