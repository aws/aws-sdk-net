...
{
    /// <summary>
    /// Container for the parameters to the InputStreamWithInitialRequest operation.
    /// </summary>
    public partial class InputStreamWithInitialRequestRequest : AmazonRestJsonProtocolRequest
    {
        /// <summary>
        /// Gets and sets the property InitialRequestMember.
        /// </summary>
        [AWSProperty(Required = true)]
        public string InitialRequestMember { get; set; }

        /// <summary>
        /// Checks to see if the InitialRequestMember property is set.
        /// </summary>
        internal bool IsSetInitialRequestMember() => this.InitialRequestMember != null;
