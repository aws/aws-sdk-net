...
{
    /// <summary>
    /// Container for the parameters to the OmitsSerializingEmptyLists operation. Omits serializing
    /// empty lists. Because empty strings are serilized as `Foo=`, empty lists cannot also
    /// be serialized as `Foo=` and instead must be omitted.
    /// </summary>
