...
namespace Amazon.RestJsonProtocol.Model
{
    ...
    public partial class MyUnion
    {
        ...
        private Dictionary<string, string> _mapValue = new Dictionary<string, string>();
        private int? _numberValue;
        private RenamedGreeting _renamedStructureValue;
        ...
        /// </summary>
        public RenamedGreeting RenamedStructureValue
        {
            get { return this._renamedStructureValue; }
            set { this._renamedStructureValue = value; }
        }

        // Check to see if RenamedStructureValue property is set
        internal bool IsSetRenamedStructureValue()
        {
            return this._renamedStructureValue != null;
        }
