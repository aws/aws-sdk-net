...
{
    [TestClass]
    public partial class LambdaCoreEndpointsTests
    {
        [TestMethod]
        [TestCategory("UnitTest")]
        [TestCategory("Endpoints")]
        [TestCategory("LambdaCore")]
        [Description("For region us-east-1 with FIPS enabled and DualStack enabled")]
        public void For_region_useast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            var parameters = new LambdaCoreEndpointParameters();
            parameters["Region"] = "us-east-1";
            parameters["UseFIPS"] = true;
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonLambdaCoreEndpointProvider().ResolveEndpoint(parameters);
        ...
        public void For_custom_endpoint_with_fips_enabled_and_dualstack_disabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonLambdaCoreEndpointProvider().ResolveEndpoint(parameters);
            });
