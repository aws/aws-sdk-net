...
namespace AWSSDK_DotNet.UnitTests
{
    ...
    public class PropertyStorageTests
    {
        ...
        public void Validate_ThrowsWhenGlobalConverterTypeDoesNotImplementIPropertyConverter()
        {
            ...
            var fakeConverter = new FakePropertyConverter();
            var myO = new myC();
            context.ConverterCache[typeof(string)] = myO as IPropertyConverter;
        ...
        public void Validate_ThrowsWhenGlobalConverterAndPolymorphicProperty()
        {
            ...
            var context = new DummyContext(mockClient.Object);
            var fakeConverter = new FakePropertyConverter();
            context.ConverterCache[typeof(string)] = fakeConverter;
        ...
        public void Validate_ThrowsWhenGlobalConverterAndIsAutoGeneratedTimestamp()
        {
            ...
            var context = new DummyContext(mockClient.Object);
            var fakeConverter = new FakePropertyConverter();
            context.ConverterCache[typeof(Nullable<DateTime>)] = fakeConverter;
