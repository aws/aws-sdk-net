...
namespace AWSSDK_DotNet.UnitTests
{
    ...
    public class PropertyStorageTests
    {
        ...
        [ClassInitialize]
        public static void PropertyStorageTestsInitialize(TestContext context)
        {
            var mockClient = new Mock<IAmazonDynamoDB>();
            _context = new DummyContext(mockClient.Object);
        }
        ...
        public void Validate_ThrowsIfBothHashAndRangeKey()
        {
            ...
            Assert.ThrowsExactly<InvalidOperationException>(() => storage.Validate(null));
        }
        ...
        public void Validate_UsesConverterFromContextCache()
        {
            ...
            _context.ConverterCache[typeof(int)] = fakeConverter;
        ...
        [TestMethod]
        public void Validate_ThrowsWhenGlobalConverterAndPolymorphicProperty()
        {
            var storage = CreatePropertyStorage("Name");
            storage.IndexNames = new List<string>();
            storage.FlattenProperties = new List<PropertyStorage>();
        ...
        [TestMethod]
        public void Validate_ThrowsWhenGlobalConverterAndShouldFlattenChildProperties()
        {
            var storage = CreatePropertyStorage("Name");
            storage.IndexNames = new List<string>();
            storage.FlattenProperties = new List<PropertyStorage>();
        ...
        [TestMethod]
        public void Validate_ThrowsWhenGlobalConverterAndStoreAsEpoch()
        {
            var storage = CreatePropertyStorage("Name");
            storage.IndexNames = new List<string>();
            storage.FlattenProperties = new List<PropertyStorage>();
        ...
        [TestMethod]
        public void Validate_ThrowsWhenGlobalConverterAndStoreAsEpochLong()
        {
            var storage = CreatePropertyStorage("Name");
            storage.IndexNames = new List<string>();
            storage.FlattenProperties = new List<PropertyStorage>();
        ...
        [TestMethod]
        public void Validate_ThrowsWhenGlobalConverterAndIsAutoGeneratedTimestamp()
        {
            var storage = CreatePropertyStorage("Timestamp");
            storage.IndexNames = new List<string>();
            storage.FlattenProperties = new List<PropertyStorage>();
            ...
            var fakeConverter = new FakePropertyConverter();
            _context.ConverterCache[typeof(Nullable<DateTime>)] = fakeConverter;
