...
namespace AWSSDK_DotNet.UnitTests.Marshalling
{
    ...
    public partial class ConnectParticipantMarshallingTests
    {
        ...
        public void CompleteAttachmentUploadMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CompleteAttachmentUploadRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CompleteAttachmentUploadResponse;
        ...
        public void CreateParticipantConnectionMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<CreateParticipantConnectionRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as CreateParticipantConnectionResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ConnectParticipant")]
        public void DescribeViewMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeView");

            var request = InstantiateClassGenerator.Execute<DescribeViewRequest>(operation);
            var marshaller = new DescribeViewRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("DescribeView", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = DescribeViewResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as DescribeViewResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ConnectParticipant")]
        public void DescribeView_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeView");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = DescribeViewResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ConnectParticipant")]
        public void DescribeView_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeView");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ConnectParticipant")]
        public void DescribeView_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeView");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ConnectParticipant")]
        public void DescribeView_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeView");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("ConnectParticipant")]
        public void DescribeView_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeView");
        ...
        public void DisconnectParticipantMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DisconnectParticipantRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DisconnectParticipantResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void GetAttachmentMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetAttachmentRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as GetAttachmentResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void GetTranscriptMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<GetTranscriptRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as GetTranscriptResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void SendEventMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as SendEventResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void SendMessageMarshallTest()
        {
            ...
            var response = unmarshaller.Unmarshall(context) as SendMessageResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void StartAttachmentUploadMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<StartAttachmentUploadRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as StartAttachmentUploadResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
