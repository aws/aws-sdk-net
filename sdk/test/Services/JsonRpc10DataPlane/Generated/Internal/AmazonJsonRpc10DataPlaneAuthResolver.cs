...
namespace Amazon.JsonRpc10DataPlane.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonJsonRpc10DataPlaneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonJsonRpc10DataPlaneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for JsonRpc10DataPlane.
        /// </summary>
        public AmazonJsonRpc10DataPlaneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonJsonRpc10DataPlaneAuthSchemeParameters
            {
    ...
    public class AmazonJsonRpc10DataPlaneAuthSchemeResolver : IAuthSchemeResolver<AmazonJsonRpc10DataPlaneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonJsonRpc10DataPlaneAuthSchemeParameters authParameters)
        {
