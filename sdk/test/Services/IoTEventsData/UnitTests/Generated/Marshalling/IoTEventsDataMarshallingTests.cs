...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class IoTEventsDataMarshallingTests
    {
        ...
        public void BatchAcknowledgeAlarmMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<BatchAcknowledgeAlarmRequest>(operation);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTEventsData")]
        public void BatchDeleteDetectorMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDeleteDetector");

            var request = InstantiateClassGenerator.Execute<BatchDeleteDetectorRequest>(operation);
            var marshaller = new BatchDeleteDetectorRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("BatchDeleteDetector", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = BatchDeleteDetectorResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as BatchDeleteDetectorResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTEventsData")]
        public void BatchDeleteDetector_InternalFailureExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDeleteDetector");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = BatchDeleteDetectorResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTEventsData")]
        public void BatchDeleteDetector_InvalidRequestExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDeleteDetector");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTEventsData")]
        public void BatchDeleteDetector_ServiceUnavailableExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDeleteDetector");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTEventsData")]
        public void BatchDeleteDetector_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("BatchDeleteDetector");
        ...
        public void BatchDisableAlarmMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<BatchDisableAlarmRequest>(operation);
        ...
        public void BatchEnableAlarmMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<BatchEnableAlarmRequest>(operation);
        ...
        public void BatchResetAlarmMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<BatchResetAlarmRequest>(operation);
        ...
        public void BatchSnoozeAlarmMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<BatchSnoozeAlarmRequest>(operation);
        ...
        public void BatchUpdateDetectorMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<BatchUpdateDetectorRequest>(operation);
        ...
        public void DescribeAlarmMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeAlarmRequest>(operation);
        ...
        public void ListAlarmsMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListAlarmsRequest>(operation);
