...
namespace AWSSDK_DotNet35.UnitTests.Endpoints
{
    ...
    public partial class BatchEndpointsTests
    {
        ...
        public void For_region_apsouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            Assert.AreEqual("https://batch-fips.ap-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-south-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apsouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eusouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.eu-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eusouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.eu-south-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_eusouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.eu-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.me-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.me-central-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.me-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mecentral1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.me-central-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_cacentral1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ca-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_cacentral1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ca-central-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_cacentral1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ca-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eucentral1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.eu-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eucentral1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.eu-central-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_eucentral1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.eu-central-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_uswest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.us-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_uswest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.us-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_uswest2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.us-west-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_uswest2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.us-west-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_afsouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.af-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_afsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.af-south-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_afsouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.af-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eunorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.eu-north-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_eunorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.eu-north-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_eunorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.eu-north-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_euwest3_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.eu-west-3.api.aws", endpoint.URL);
        }
        ...
        public void For_region_euwest3_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.eu-west-3.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_euwest3_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.eu-west-3.api.aws", endpoint.URL);
        }
        ...
        public void For_region_euwest2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.eu-west-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_euwest2_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.eu-west-2.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_euwest2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.eu-west-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_euwest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.eu-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_euwest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.eu-west-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_euwest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.eu-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apnortheast3_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-northeast-3.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apnortheast3_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-northeast-3.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apnortheast3_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-northeast-3.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apnortheast2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-northeast-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apnortheast2_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-northeast-2.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apnortheast2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-northeast-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apnortheast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-northeast-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apnortheast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-northeast-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apnortheast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-northeast-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mesouth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.me-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_mesouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.me-south-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_mesouth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.me-south-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_saeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.sa-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_saeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.sa-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_saeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.sa-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apeast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apeast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.us-gov-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.us-gov-west-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-southeast-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-southeast-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-southeast-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-southeast-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast2_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-southeast-2.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-southeast-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast3_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.ap-southeast-3.api.aws", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast3_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://fips.batch.ap-southeast-3.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_apsoutheast3_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.ap-southeast-3.api.aws", endpoint.URL);
        }
        ...
        public void For_region_useast2_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.us-east-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_useast2_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.us-east-2.api.aws", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.cn-northwest-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch-fips.cn-northwest-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorthwest1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonBatchEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://batch.cn-northwest-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
