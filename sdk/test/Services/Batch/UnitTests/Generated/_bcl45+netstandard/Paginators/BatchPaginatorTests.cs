...
namespace AWSSDK_DotNet35.UnitTests.PaginatorTests
{
    ...
    public class BatchPaginatorTests
    {
        ...
        [TestCategory("UnitTest")]
        [TestCategory("Batch")]
        public void ListSchedulingPoliciesTest_TwoPages()
        {
            var request = InstantiateClassGenerator.Execute<ListSchedulingPoliciesRequest>();

            var firstResponse = InstantiateClassGenerator.Execute<ListSchedulingPoliciesResponse>();
            var secondResponse = InstantiateClassGenerator.Execute<ListSchedulingPoliciesResponse>();
            secondResponse.NextToken = null;

            _mockClient.SetupSequence(x => x.ListSchedulingPolicies(request)).Returns(firstResponse).Returns(secondResponse);
            var paginator = _mockClient.Object.Paginators.ListSchedulingPolicies(request);
        ...
        [TestCategory("Batch")]
        [ExpectedException(typeof(System.InvalidOperationException), "Paginator has already been consumed and cannot be reused. Please create a new instance.")]
        public void ListSchedulingPoliciesTest__OnlyUsedOnce()
        {
            var request = InstantiateClassGenerator.Execute<ListSchedulingPoliciesRequest>();

            var response = InstantiateClassGenerator.Execute<ListSchedulingPoliciesResponse>();
            response.NextToken = null;

            _mockClient.Setup(x => x.ListSchedulingPolicies(request)).Returns(response);
            var paginator = _mockClient.Object.Paginators.ListSchedulingPolicies(request);
