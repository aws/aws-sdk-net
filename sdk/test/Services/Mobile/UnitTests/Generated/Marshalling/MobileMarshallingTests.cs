...
namespace AWSSDK_DotNet35.UnitTests.Marshalling
{
    ...
    public partial class MobileMarshallingTests
    {
        ...
        public void DescribeBundleMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<DescribeBundleRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as DescribeBundleResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void ExportBundleMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ExportBundleRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ExportBundleResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void ExportProjectMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ExportProjectRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ExportProjectResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void ListBundlesMarshallTest()
        {
            ...
            var request = InstantiateClassGenerator.Execute<ListBundlesRequest>(operation);
            ...
            var response = unmarshaller.Unmarshall(context) as ListBundlesResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        public void UpdateProject_AccountActionRequiredExceptionMarshallTest()
        {
            ...
            var webResponse = new WebResponseData
            {
                Headers = {
                    {HeaderKeys.RequestIdHeader, Guid.NewGuid().ToString()},
                    {HeaderKeys.XAmzCrc32,"0"},
                    {HeaderKeys.XAmzErrorType,"AccountActionRequiredException"},
                }
            };
