...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class FinspaceEndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://finspace.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_custom_endpoint_with_fips_enabled_and_dualstack_disabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonFinspaceEndpointProvider().ResolveEndpoint(parameters);
            });
