...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class InternetMonitorEndpointsTests
    {
        ...
        public void For_region_useast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor-fips.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_useast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor.us-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://internetmonitor.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_custom_endpoint_with_fips_enabled_and_dualstack_disabled_Test()
        {
            ...
            var exception = Assert.ThrowsExactly<AmazonClientException>(() => {
                new AmazonInternetMonitorEndpointProvider().ResolveEndpoint(parameters);
            });
