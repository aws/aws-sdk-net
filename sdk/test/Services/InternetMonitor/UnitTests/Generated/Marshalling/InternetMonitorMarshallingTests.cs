...
{
    [TestClass]
    public partial class InternetMonitorMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("internetmonitor");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetHealthEventMarshallTest()
        {
            var operation = service_model.FindOperation("GetHealthEvent");

            var request = InstantiateClassGenerator.Execute<GetHealthEventRequest>(operation);
            var marshaller = new GetHealthEventRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("GetHealthEvent", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = GetHealthEventResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as GetHealthEventResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetHealthEvent_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetHealthEvent");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = GetHealthEventResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetHealthEvent_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetHealthEvent");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetHealthEvent_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetHealthEvent");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetHealthEvent_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetHealthEvent");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetInternetEventMarshallTest()
        {
            var operation = service_model.FindOperation("GetInternetEvent");

            var request = InstantiateClassGenerator.Execute<GetInternetEventRequest>(operation);
            var marshaller = new GetInternetEventRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("GetInternetEvent", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = GetInternetEventResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as GetInternetEventResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetInternetEvent_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetInternetEvent");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = GetInternetEventResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetInternetEvent_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetInternetEvent");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetInternetEvent_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetInternetEvent");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetInternetEvent_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetInternetEvent");
        ...
        public void GetQueryResultsMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("GetQueryResults", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = GetQueryResultsResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as GetQueryResultsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryResults_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryResults");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryResults_LimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryResults");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryResults_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryResults");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryResults_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryResults");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryStatusMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryStatus");

            var request = InstantiateClassGenerator.Execute<GetQueryStatusRequest>(operation);
            var marshaller = new GetQueryStatusRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("GetQueryStatus", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = GetQueryStatusResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as GetQueryStatusResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryStatus_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryStatus");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = GetQueryStatusResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryStatus_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryStatus");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryStatus_LimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryStatus");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryStatus_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryStatus");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void GetQueryStatus_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("GetQueryStatus");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListHealthEventsMarshallTest()
        {
            var operation = service_model.FindOperation("ListHealthEvents");

            var request = InstantiateClassGenerator.Execute<ListHealthEventsRequest>(operation);
            var marshaller = new ListHealthEventsRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("ListHealthEvents", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = ListHealthEventsResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as ListHealthEventsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListHealthEvents_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListHealthEvents");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = ListHealthEventsResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListHealthEvents_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListHealthEvents");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListHealthEvents_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListHealthEvents");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListHealthEvents_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListHealthEvents");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListInternetEventsMarshallTest()
        {
            var operation = service_model.FindOperation("ListInternetEvents");

            var request = InstantiateClassGenerator.Execute<ListInternetEventsRequest>(operation);
            var marshaller = new ListInternetEventsRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("ListInternetEvents", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = ListInternetEventsResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as ListInternetEventsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListInternetEvents_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListInternetEvents");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = ListInternetEventsResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListInternetEvents_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListInternetEvents");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListInternetEvents_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListInternetEvents");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void ListInternetEvents_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListInternetEvents");
        ...
        public void StartQueryMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("StartQuery", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = StartQueryResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as StartQueryResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StartQuery_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StartQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StartQuery_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StartQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StartQuery_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StartQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StartQuery_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StartQuery");
        ...
        public void StopQueryMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("StopQuery", request, internalRequest, service_model);
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = StopQueryResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context) as StopQueryResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StopQuery_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StopQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StopQuery_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StopQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StopQuery_LimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StopQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StopQuery_ThrottlingExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StopQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void StopQuery_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("StopQuery");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("InternetMonitor")]
        public void UpdateMonitor_LimitExceededExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateMonitor");
