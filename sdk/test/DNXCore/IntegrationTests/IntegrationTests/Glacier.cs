...
namespace Amazon.DNXCore.IntegrationTests
{
    ...
    public class Glacier : TestBase<AmazonGlacierClient>
    {
        ...
        public void ListCalls()
        {
            ...
            Assert.NotNull(Client.ListJobsAsync(new ListJobsRequest { VaultName = testingVaultName }).Result);
            Assert.NotNull(Client.ListMultipartUploadsAsync(new ListMultipartUploadsRequest { VaultName = testingVaultName }).Result);
            Assert.NotNull(Client.ListVaultsAsync(new ListVaultsRequest()).Result);
