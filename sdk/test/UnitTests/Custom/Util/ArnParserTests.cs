...
namespace AWSSDK.UnitTests
{
    ...
    public class ArnParserTests
    {
        ...
        [TestCategory("UnitTest")]
        [TestCategory("Util")]
        [DataRow("arn", "ARN is in incorrect format. ARN format is: arn:<parition>:<service>:<region>:<account-id>:<resource>")]
        [DataRow("arn:partition", "ARN is in incorrect format. ARN format is: arn:<parition>:<service>:<region>:<account-id>:<resource>")]
        [DataRow("arn:partition:service", "ARN is in incorrect format. ARN format is: arn:<parition>:<service>:<region>:<account-id>:<resource>")]
        [DataRow("arn:partition:service:region", "ARN is in incorrect format. ARN format is: arn:<parition>:<service>:<region>:<account-id>:<resource>")]
        [DataRow("arn:partition:service:region:account-id", "ARN is in incorrect format. ARN format is: arn:<parition>:<service>:<region>:<account-id>:<resource>")]
