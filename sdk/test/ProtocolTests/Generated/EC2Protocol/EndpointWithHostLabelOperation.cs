...
namespace AWSSDK.ProtocolTests.AwsEc2
{
    ...
    public class EndpointWithHostLabelOperation
    {
        ...
        [TestCategory("AwsEc2")]
        public void Ec2QueryEndpointTraitWithHostLabelRequest()
        {
            // Arrange
            ...
            // Assert
            var expectedParams = QueryTestUtils.ConvertBodyToParameters("Action=EndpointWithHostLabelOperation&Version=2020-01-08&Label=bar");
