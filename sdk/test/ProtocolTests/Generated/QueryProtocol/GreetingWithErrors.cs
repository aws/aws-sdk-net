...
namespace AWSSDK.ProtocolTests.AwsQuery
{
    ...
    public class GreetingWithErrors
    {
        ...
        public void QueryInvalidGreetingErrorErrorResponse()
        {
            ...
            var context = new XmlUnmarshallerContext(stream,true,webResponseData);
            // Act
            var errorResponse = new GreetingWithErrorsResponseUnmarshaller().UnmarshallException(context, new InvalidGreetingException(""), (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 400));
            // Assert
        ...
        public void QueryCustomizedErrorErrorResponse()
        {
            ...
            var context = new XmlUnmarshallerContext(stream,true,webResponseData);
            // Act
            var errorResponse = new GreetingWithErrorsResponseUnmarshaller().UnmarshallException(context, new CustomCodeErrorException(""), (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 402));
            // Assert
        ...
        public void QueryComplexErrorErrorResponse()
        {
            ...
            var context = new XmlUnmarshallerContext(stream,true,webResponseData);
            // Act
            var errorResponse = new GreetingWithErrorsResponseUnmarshaller().UnmarshallException(context, new ComplexErrorException(""), (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 400));
            // Assert
