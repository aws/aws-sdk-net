...
namespace AWSSDK.ProtocolTests.RestJson
{
    ...
    public class GreetingWithErrors
    {
        ...
        public void RestJsonFooErrorUsingXAmznErrorTypeErrorResponse()
        {
            ...
            var context = new JsonUnmarshallerContext(stream,true,webResponseData);
            // Act
            var errorResponse = new GreetingWithErrorsResponseUnmarshaller().UnmarshallException(context, new FooErrorException(""), (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 500));
            // Assert
        ...
        public void RestJsonComplexErrorWithNoMessageErrorResponse()
        {
            ...
            var context = new JsonUnmarshallerContext(stream,true,webResponseData);
            // Act
            var errorResponse = new GreetingWithErrorsResponseUnmarshaller().UnmarshallException(context, new ComplexErrorException(""), (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 403));
            // Assert
