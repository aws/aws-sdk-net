...
{
    [TestClass]
    public class HttpQueryParamsOnlyOperation
    {
        /// <summary>
        /// Test that httpQueryParams are included in request when no other
        ...
        /// <summary>
        /// Test that empty httpQueryParams map results in no query
        /// parameters
        /// </summary>
        [TestMethod]
        [TestCategory("ProtocolTest")]
