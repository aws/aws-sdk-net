            ...
            IRequestContext requestContext)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var partSize = wrappedRequest.ContentStream.Length - wrappedRequest.ContentStream.Position;
                        originalStream = new PartialWrapperStream(wrappedRequest.ContentStream, partSize);
                    }
                    else
                    {
