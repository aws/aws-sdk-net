        ...
        protected override async Task SerializeToStreamAsync( Stream stream, TransportContext context)
        {
            ...
            if(_publisher != null)
            {
                ...
                while((bytes = await _publisher.NextBytesAsync().ConfigureAwait(false)) != null)
                {
                    ...
                    // Compute SHA256 of the signed event bytes being written to the wire.
                    // This can be compared against the server's error message which includes
                    // the hash of what it received, to detect transport-layer corruption.
                ...
                _logger.DebugFormat(
                    "HttpContentRequestStreamHandle.SerializeToStreamAsync publisher returned null (end-of-stream): instanceId={0}, totalWrites={1}",
