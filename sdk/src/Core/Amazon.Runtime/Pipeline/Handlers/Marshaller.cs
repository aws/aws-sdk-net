...
namespace Amazon.Runtime.Internal
{
    ...
    public class Marshaller : PipelineHandler
    {
        ...
        public override void InvokeSync(IExecutionContext executionContext)
        {
            ...
            {
                // Disposes the request's ContentStream (e.g. PooledContentStream) to return pooled buffers after 
                // the entire inner pipeline completes, including retries. Safe to call even if already disposed.
