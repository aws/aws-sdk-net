...
namespace Amazon.Runtime.Internal
{
    ...
    public partial class StandardRetryPolicy : RetryPolicy
    {
        ...
        {
            var delay = CalculateRetryDelay(executionContext.RequestContext.Retries, this.MaxBackoffInMilliseconds, executionContext.RequestContext.IsLastErrorThrottling);
