            ...
            set
            {
                if (!string.IsNullOrEmpty(this.serviceURL))
                    Logger.GetLogger(GetType()).InfoFormat($"RegionEndpoint and ServiceURL are mutually exclusive. Since " +
                        $"RegionEndpoint was set last, RegionEndpoint: {value} will be used to make the request.");
        ...
        public string ServiceURL
        {
            ...
            set
            {
                if (regionEndpoint != null)
                    Logger.GetLogger(GetType()).InfoFormat($"RegionEndpoint and ServiceURL are mutually exclusive. Since " +
                        $"ServiceUrl was set last, ServiceUrl: {value} will be used to make the request.");
