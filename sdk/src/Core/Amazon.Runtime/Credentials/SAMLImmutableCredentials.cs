    ...
    public class SAMLImmutableCredentials : ImmutableCredentials
    {
        ...
        internal static SAMLImmutableCredentials FromJson(string json)
        {
            try
            {
                ...
                // ignore the data
                var expires = DateTime.Parse(o.RootElement.GetProperty(ExpiresProperty).GetString(), CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal);
                ...
                var accessKey = o.RootElement.GetProperty(AccessKeyProperty).GetString();
                var secretKey = o.RootElement.GetProperty(SecretKeyProperty).GetString();
                var token = o.RootElement.GetProperty(TokenProperty).GetString();
                var subject = o.RootElement.GetProperty(SubjectProperty).GetString();
