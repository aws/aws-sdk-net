...
namespace Amazon.TimestreamQuery.Model
{
    ...
    /// </summary>
    public partial class QueryInsightsResponse
    {
        ...
        private long? _unloadPartitionCount;
        private long? _unloadWrittenBytes;
        private long? _unloadWrittenRows;
        ...
        // Check to see if UnloadPartitionCount property is set
        internal bool IsSetUnloadPartitionCount()
        {
            return this._unloadPartitionCount.HasValue; 
        }
        ...
        // Check to see if UnloadWrittenBytes property is set
        internal bool IsSetUnloadWrittenBytes()
        {
            return this._unloadWrittenBytes.HasValue; 
        }
        ...
        // Check to see if UnloadWrittenRows property is set
        internal bool IsSetUnloadWrittenRows()
        {
            return this._unloadWrittenRows.HasValue; 
        }
