...
namespace Amazon.TimestreamQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnsConfigurationUnmarshaller : IJsonUnmarshaller<SnsConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnsConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
