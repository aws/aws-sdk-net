...
namespace Amazon.TimestreamQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionStatsUnmarshaller : IJsonUnmarshaller<ExecutionStats, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExecutionStats Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DataWrites", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.DataWrites = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.QueryResultRows = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
