...
namespace Amazon.TimestreamQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MultiMeasureAttributeMappingUnmarshaller : IJsonUnmarshaller<MultiMeasureAttributeMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MultiMeasureAttributeMapping Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TargetMultiMeasureAttributeName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TargetMultiMeasureAttributeName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
