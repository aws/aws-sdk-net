...
namespace Amazon.MailManager.Internal
{
    ...
    public class AmazonMailManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMailManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MailManager.
        /// </summary>
        public AmazonMailManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMailManagerAuthSchemeParameters
            {
    ...
    public class AmazonMailManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonMailManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMailManagerAuthSchemeParameters authParameters)
        {
