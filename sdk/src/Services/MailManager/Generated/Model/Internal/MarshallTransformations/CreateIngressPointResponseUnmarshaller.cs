...
{
    /// <summary>
    /// Response Unmarshaller for CreateIngressPoint operation
    /// </summary>  
    public class CreateIngressPointResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateIngressPointResponse response = new CreateIngressPointResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateIngressPoint");
            reader.ReadStartMap();
        ...
        private static CreateIngressPointResponseUnmarshaller _instance = new CreateIngressPointResponseUnmarshaller();        

        internal static CreateIngressPointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIngressPointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
