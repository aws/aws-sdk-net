...
{
    /// <summary>
    /// RuleIpExpression Marshaller
    /// </summary>
    public class RuleIpExpressionMarshaller : IRequestMarshaller<RuleIpExpression, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RuleIpExpression requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEvaluate())
            {
                ...
                var marshaller = RuleIpToEvaluateMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RuleIpExpressionMarshaller Instance = new RuleIpExpressionMarshaller();
