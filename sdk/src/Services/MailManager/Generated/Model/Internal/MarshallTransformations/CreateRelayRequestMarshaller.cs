...
{
    /// <summary>
    /// CreateRelay Request Marshaller
    /// </summary>       
    public class CreateRelayRequestMarshaller : IMarshaller<IRequest, CreateRelayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRelayRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateRelayRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MailManager");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/MailManagerSvc/operation/CreateRelay";
        ...
        private static CreateRelayRequestMarshaller _instance = new CreateRelayRequestMarshaller();        

        internal static CreateRelayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRelayRequestMarshaller Instance
        {
            get
            {
                return _instance;
