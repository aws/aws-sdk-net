...
{
    /// <summary>
    /// Response Unmarshaller for GetMemberOfAddressList operation
    /// </summary>  
    public class GetMemberOfAddressListResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMemberOfAddressListResponse response = new GetMemberOfAddressListResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetMemberOfAddressList");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Address":
                        {
                            context.AddPathSegment("Address");
        ...
        private static GetMemberOfAddressListResponseUnmarshaller _instance = new GetMemberOfAddressListResponseUnmarshaller();        

        internal static GetMemberOfAddressListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMemberOfAddressListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
