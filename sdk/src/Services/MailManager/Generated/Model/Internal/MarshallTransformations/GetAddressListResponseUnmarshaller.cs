...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAddressListResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetAddressList");
            reader.ReadStartMap();
                    ...
                    case "AddressListArn":
                        {
                            ...
                            response.AddressListArn = unmarshaller.Unmarshall(context);
                    ...
                    case "AddressListName":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.AddressListName = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
