...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class ArchiveActionMarshaller : IRequestMarshaller<ArchiveAction, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ArchiveAction requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("TargetArchive");
                context.Writer.WriteTextString(requestObject.TargetArchive);
            }
        }
