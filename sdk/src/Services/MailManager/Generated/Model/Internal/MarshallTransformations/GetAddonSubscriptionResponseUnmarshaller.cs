...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAddonSubscriptionResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetAddonSubscription");
            reader.ReadStartMap();
                    ...
                    case "AddonSubscriptionArn":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.AddonSubscriptionArn = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
