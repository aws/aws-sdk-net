...
{
    /// <summary>
    /// UpdateRuleSet Request Marshaller
    /// </summary>       
    public class UpdateRuleSetRequestMarshaller : IMarshaller<IRequest, UpdateRuleSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRuleSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRuleSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MailManager");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/MailManagerSvc/operation/UpdateRuleSet";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("Rules");
                    context.Writer.WriteStartArray(publicRequest.Rules.Count);
        ...
        private static UpdateRuleSetRequestMarshaller _instance = new UpdateRuleSetRequestMarshaller();        

        internal static UpdateRuleSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRuleSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
