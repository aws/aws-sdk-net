...
{
    /// <summary>
    /// Response Unmarshaller for DeleteIngressPoint operation
    /// </summary>  
    public class DeleteIngressPointResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIngressPointResponse response = new DeleteIngressPointResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteIngressPoint");
        ...
        private static DeleteIngressPointResponseUnmarshaller _instance = new DeleteIngressPointResponseUnmarshaller();        

        internal static DeleteIngressPointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIngressPointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
