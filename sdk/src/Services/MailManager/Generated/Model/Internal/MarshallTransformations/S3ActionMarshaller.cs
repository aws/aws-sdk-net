...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// S3Action Marshaller
    /// </summary>
    public class S3ActionMarshaller : IRequestMarshaller<S3Action, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(S3Action requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("S3Prefix");
                context.Writer.WriteTextString(requestObject.S3Prefix);
            }
            if (requestObject.IsSetS3SseKmsKeyId())
            {
                context.Writer.WriteTextString("S3SseKmsKeyId");
                context.Writer.WriteTextString(requestObject.S3SseKmsKeyId);
            }
        }
