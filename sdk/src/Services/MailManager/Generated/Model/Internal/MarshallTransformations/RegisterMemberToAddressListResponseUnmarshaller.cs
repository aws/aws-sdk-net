...
{
    /// <summary>
    /// Response Unmarshaller for RegisterMemberToAddressList operation
    /// </summary>  
    public class RegisterMemberToAddressListResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterMemberToAddressListResponse response = new RegisterMemberToAddressListResponse();
            var reader = context.Reader;
            context.AddPathSegment("RegisterMemberToAddressList");
        ...
        private static RegisterMemberToAddressListResponseUnmarshaller _instance = new RegisterMemberToAddressListResponseUnmarshaller();        

        internal static RegisterMemberToAddressListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterMemberToAddressListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
