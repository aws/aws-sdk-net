...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListArchivesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Archives":
                        {
                            context.AddPathSegment("Archives");
                            var unmarshaller = new CborListUnmarshaller<Archive, ArchiveUnmarshaller>(ArchiveUnmarshaller.Instance);
                            response.Archives = unmarshaller.Unmarshall(context);
