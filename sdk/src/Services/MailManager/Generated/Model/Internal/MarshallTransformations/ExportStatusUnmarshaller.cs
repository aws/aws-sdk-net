...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExportStatusUnmarshaller : ICborUnmarshaller<ExportStatus, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExportStatus Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "CompletionTimestamp":
                        {
                            context.AddPathSegment("CompletionTimestamp");
                    ...
                    case "SubmissionTimestamp":
                        {
                            context.AddPathSegment("SubmissionTimestamp");
                            var unmarshaller = CborNullableDateTimeUnmarshaller.Instance;
