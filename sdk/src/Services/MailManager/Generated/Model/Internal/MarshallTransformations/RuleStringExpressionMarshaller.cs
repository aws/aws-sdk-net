...
{
    /// <summary>
    /// RuleStringExpression Marshaller
    /// </summary>
    public class RuleStringExpressionMarshaller : IRequestMarshaller<RuleStringExpression, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RuleStringExpression requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEvaluate())
            {
                ...
                var marshaller = RuleStringToEvaluateMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RuleStringExpressionMarshaller Instance = new RuleStringExpressionMarshaller();
