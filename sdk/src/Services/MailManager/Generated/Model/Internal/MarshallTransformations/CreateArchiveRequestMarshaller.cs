...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    public class CreateArchiveRequestMarshaller : IMarshaller<IRequest, CreateArchiveRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateArchiveRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/MailManagerSvc/operation/CreateArchive";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("ArchiveName");
                    context.Writer.WriteTextString(publicRequest.ArchiveName);
                }
                ...
                {
                    context.Writer.WriteTextString("Retention");
                    context.Writer.WriteStartMap(null);

                    var marshaller = ArchiveRetentionMarshaller.Instance;
                    marshaller.Marshall(publicRequest.Retention, context);
