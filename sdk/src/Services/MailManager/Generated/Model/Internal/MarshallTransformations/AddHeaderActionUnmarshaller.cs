...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddHeaderActionUnmarshaller : ICborUnmarshaller<AddHeaderAction, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public AddHeaderAction Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "HeaderName":
                        {
                            context.AddPathSegment("HeaderName");
                    ...
                    case "HeaderValue":
                        {
                            context.AddPathSegment("HeaderValue");
                            var unmarshaller = CborStringUnmarshaller.Instance;
