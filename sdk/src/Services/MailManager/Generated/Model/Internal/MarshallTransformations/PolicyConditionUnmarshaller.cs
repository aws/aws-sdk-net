...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PolicyConditionUnmarshaller : ICborUnmarshaller<PolicyCondition, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public PolicyCondition Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "BooleanExpression":
                        {
                            context.AddPathSegment("BooleanExpression");
                    ...
                    case "IpExpression":
                        {
                            context.AddPathSegment("IpExpression");
                    ...
                    case "Ipv6Expression":
                        {
                            context.AddPathSegment("Ipv6Expression");
                    ...
                    case "StringExpression":
                        {
                            context.AddPathSegment("StringExpression");
                    ...
                    case "TlsExpression":
                        {
                            context.AddPathSegment("TlsExpression");
