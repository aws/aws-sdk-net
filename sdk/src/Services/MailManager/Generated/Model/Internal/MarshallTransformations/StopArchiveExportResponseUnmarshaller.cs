...
{
    /// <summary>
    /// Response Unmarshaller for StopArchiveExport operation
    /// </summary>  
    public class StopArchiveExportResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopArchiveExportResponse response = new StopArchiveExportResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopArchiveExport");
        ...
        private static StopArchiveExportResponseUnmarshaller _instance = new StopArchiveExportResponseUnmarshaller();        

        internal static StopArchiveExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopArchiveExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
