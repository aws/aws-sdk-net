...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTrafficPoliciesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListTrafficPolicies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "TrafficPolicies":
                        {
                            context.AddPathSegment("TrafficPolicies");
                            var unmarshaller = new CborListUnmarshaller<TrafficPolicy, TrafficPolicyUnmarshaller>(TrafficPolicyUnmarshaller.Instance);
                            response.TrafficPolicies = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
