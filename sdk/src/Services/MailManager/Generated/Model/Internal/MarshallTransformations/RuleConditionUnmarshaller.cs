...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuleConditionUnmarshaller : ICborUnmarshaller<RuleCondition, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuleCondition Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "DmarcExpression":
                        {
                            context.AddPathSegment("DmarcExpression");
                    ...
                    case "NumberExpression":
                        {
                            context.AddPathSegment("NumberExpression");
                    ...
                    case "VerdictExpression":
                        {
                            context.AddPathSegment("VerdictExpression");
