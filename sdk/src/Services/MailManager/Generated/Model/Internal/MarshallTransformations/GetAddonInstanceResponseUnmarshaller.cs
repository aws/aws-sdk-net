...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAddonInstanceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetAddonInstance");
            reader.ReadStartMap();
                    ...
                    case "AddonInstanceArn":
                        {
                            ...
                            response.AddonInstanceArn = unmarshaller.Unmarshall(context);
                    ...
                    case "AddonSubscriptionId":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.AddonSubscriptionId = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
