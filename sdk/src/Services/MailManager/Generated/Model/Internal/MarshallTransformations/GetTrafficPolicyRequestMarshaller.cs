...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    public class GetTrafficPolicyRequestMarshaller : IMarshaller<IRequest, GetTrafficPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetTrafficPolicyRequest)input);
        }
        ...
        public IRequest Marshall(GetTrafficPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/MailManagerSvc/operation/GetTrafficPolicy";
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrafficPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
