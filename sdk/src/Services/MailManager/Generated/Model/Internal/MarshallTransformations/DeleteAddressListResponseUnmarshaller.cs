...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAddressList operation
    /// </summary>  
    public class DeleteAddressListResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAddressListResponse response = new DeleteAddressListResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteAddressList");
        ...
        private static DeleteAddressListResponseUnmarshaller _instance = new DeleteAddressListResponseUnmarshaller();        

        internal static DeleteAddressListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAddressListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
