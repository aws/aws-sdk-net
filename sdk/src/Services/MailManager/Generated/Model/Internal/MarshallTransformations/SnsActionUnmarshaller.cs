...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnsActionUnmarshaller : ICborUnmarshaller<SnsAction, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnsAction Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "Encoding":
                        {
                            context.AddPathSegment("Encoding");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "PayloadType":
                        {
                            context.AddPathSegment("PayloadType");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "TopicArn":
                        {
                            context.AddPathSegment("TopicArn");
                            var unmarshaller = CborStringUnmarshaller.Instance;
