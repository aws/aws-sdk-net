...
{
    /// <summary>
    /// IngressIpv4Expression Marshaller
    /// </summary>
    public class IngressIpv4ExpressionMarshaller : IRequestMarshaller<IngressIpv4Expression, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IngressIpv4Expression requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEvaluate())
            {
                ...
                var marshaller = IngressIpToEvaluateMarshaller.Instance;
        ...
        /// </summary>
        public readonly static IngressIpv4ExpressionMarshaller Instance = new IngressIpv4ExpressionMarshaller();
