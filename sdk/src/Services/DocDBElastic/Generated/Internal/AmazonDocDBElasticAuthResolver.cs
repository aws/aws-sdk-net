...
namespace Amazon.DocDBElastic.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonDocDBElasticAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDocDBElasticAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DocDBElastic.
        /// </summary>
        public AmazonDocDBElasticAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDocDBElasticAuthSchemeParameters
            {
    ...
    public class AmazonDocDBElasticAuthSchemeResolver : IAuthSchemeResolver<AmazonDocDBElasticAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDocDBElasticAuthSchemeParameters authParameters)
        {
