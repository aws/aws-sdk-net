...
namespace Amazon.MigrationHubRefactorSpaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApiGatewayProxySummaryUnmarshaller : IUnmarshaller<ApiGatewayProxySummary, XmlUnmarshallerContext>, IUnmarshaller<ApiGatewayProxySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ApiGatewayProxySummary IUnmarshaller<ApiGatewayProxySummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ApiGatewayProxySummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
