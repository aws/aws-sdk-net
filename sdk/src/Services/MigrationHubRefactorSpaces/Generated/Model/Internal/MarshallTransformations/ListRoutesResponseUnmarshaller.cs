    ...
    public class ListRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RouteSummary, RouteSummaryUnmarshaller>(RouteSummaryUnmarshaller.Instance);
                    response.RouteSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
