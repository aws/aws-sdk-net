...
namespace Amazon.MigrationHubRefactorSpaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApiGatewayProxyInputUnmarshaller : IJsonUnmarshaller<ApiGatewayProxyInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApiGatewayProxyInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
