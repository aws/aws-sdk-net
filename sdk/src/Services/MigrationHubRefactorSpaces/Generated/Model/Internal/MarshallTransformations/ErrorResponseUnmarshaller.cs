...
namespace Amazon.MigrationHubRefactorSpaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ErrorResponseUnmarshaller : IJsonUnmarshaller<ErrorResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ErrorResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AdditionalDetails", targetDepth, ref reader))
                {
