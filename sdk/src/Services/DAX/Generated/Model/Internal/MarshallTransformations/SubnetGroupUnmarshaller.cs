...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubnetGroupUnmarshaller : IJsonUnmarshaller<SubnetGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SubnetGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SubnetGroup unmarshalledObject = new SubnetGroup();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Subnet, SubnetUnmarshaller>(SubnetUnmarshaller.Instance);
        ...
        private static SubnetGroupUnmarshaller _instance = new SubnetGroupUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SubnetGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
