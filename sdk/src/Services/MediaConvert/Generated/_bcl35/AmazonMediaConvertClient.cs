...
namespace Amazon.MediaConvert
{
    ...
    public partial class AmazonMediaConvertClient : AmazonServiceClient, IAmazonMediaConvert
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/GetJobsQueryResults">REST API Reference for GetJobsQueryResults Operation</seealso>
        public virtual IAsyncResult BeginGetJobsQueryResults(GetJobsQueryResultsRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetJobsQueryResultsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetJobsQueryResultsResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/GetJobsQueryResults">REST API Reference for GetJobsQueryResults Operation</seealso>
        public virtual GetJobsQueryResultsResponse EndGetJobsQueryResults(IAsyncResult asyncResult)
        {
            return EndInvoke<GetJobsQueryResultsResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/StartJobsQuery">REST API Reference for StartJobsQuery Operation</seealso>
        public virtual IAsyncResult BeginStartJobsQuery(StartJobsQueryRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = StartJobsQueryRequestMarshaller.Instance;
            options.ResponseUnmarshaller = StartJobsQueryResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/StartJobsQuery">REST API Reference for StartJobsQuery Operation</seealso>
        public virtual StartJobsQueryResponse EndStartJobsQuery(IAsyncResult asyncResult)
        {
            return EndInvoke<StartJobsQueryResponse>(asyncResult);
        }
