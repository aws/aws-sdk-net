...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class SpekeKeyProvider
    {
        ...
        /// </summary>
        public List<string> SystemIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SystemIds property is set.
        /// </summary>
        internal bool IsSetSystemIds() => this.SystemIds != null && (this.SystemIds.Count > 0 || !AWSConfigs.InitializeCollections);
