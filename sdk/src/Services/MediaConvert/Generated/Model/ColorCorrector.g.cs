...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class ColorCorrector
    {
        ...
        /// <summary>
        /// Checks to see if the Brightness property is set.
        /// </summary>
        internal bool IsSetBrightness() => this.Brightness.HasValue;
        ...
        /// </summary>
        public ClipLimits ClipLimits { get; set; }

        /// <summary>
        /// Checks to see if the ClipLimits property is set.
        /// </summary>
        internal bool IsSetClipLimits() => this.ClipLimits != null;
        ...
        /// primaries, transfer characteristics, and matrix coefficients: * HDR 10: BT.2020, PQ,
        /// BT.2020 non-constant * HLG 2020: BT.2020, HLG, BT.2020 non-constant * P3DCI (Theater):
        /// DCIP3, SMPTE 428M, BT.709 * P3D65 (SDR): Display P3, sRGB, BT.709 * P3D65 (HDR): Display
        /// P3, PQ, BT.709
        /// </summary>
        public ColorSpaceConversion ColorSpaceConversion { get; set; }

        /// <summary>
        /// Checks to see if the ColorSpaceConversion property is set.
        /// </summary>
        internal bool IsSetColorSpaceConversion() => this.ColorSpaceConversion != null;
        ...
        /// <summary>
        /// Checks to see if the Contrast property is set.
        /// </summary>
        internal bool IsSetContrast() => this.Contrast.HasValue;
        ...
        /// input is SDR.
        /// </summary>
        public HDRToSDRToneMapper HdrToSdrToneMapper { get; set; }

        /// <summary>
        /// Checks to see if the HdrToSdrToneMapper property is set.
        /// </summary>
        internal bool IsSetHdrToSdrToneMapper() => this.HdrToSdrToneMapper != null;
        ...
        /// <summary>
        /// Checks to see if the Hue property is set.
        /// </summary>
        internal bool IsSetHue() => this.Hue.HasValue;
        ...
        /// in the output.
        /// </summary>
        public SampleRangeConversion SampleRangeConversion { get; set; }

        /// <summary>
        /// Checks to see if the SampleRangeConversion property is set.
        /// </summary>
        internal bool IsSetSampleRangeConversion() => this.SampleRangeConversion != null;
        ...
        /// <summary>
        /// Checks to see if the Saturation property is set.
        /// </summary>
        internal bool IsSetSaturation() => this.Saturation.HasValue;
