...
namespace Amazon.MediaConvert.Model
{
    ...
    /// </summary>
    internal sealed partial class ListPresetsPaginator : IPaginator<ListPresetsResponse>, IListPresetsPaginator
    {
        private readonly IAmazonMediaConvert _client;
        private readonly ListPresetsRequest _request;
        private int _isPaginatorInUse = 0;

        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListPresetsResponse> Responses => new PaginatedResponse<ListPresetsResponse>(this);
...
#if NETFRAMEWORK
        IEnumerable<ListPresetsResponse> IPaginator<ListPresetsResponse>.Paginate()
        {
            ...
            ListPresetsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListPresets(_request);
        ...
        async IAsyncEnumerable<ListPresetsResponse> IPaginator<ListPresetsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListPresetsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
