...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class PartnerWatermarking
    {
        ...
        /// </summary>
        public NexGuardFileMarkerSettings NexguardFileMarkerSettings { get; set; }

        /// <summary>
        /// Checks to see if the NexguardFileMarkerSettings property is set.
        /// </summary>
        internal bool IsSetNexguardFileMarkerSettings() => this.NexguardFileMarkerSettings != null;
    }
}
