...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class Mpeg2Settings
    {
        ...
        /// it inserts for Scene change detection. When you specify a value for this setting,
        /// the encoder determines whether to skip a cadence-driven I-frame by the value you set.
        /// For example, if you set Min I interval to 5 and a cadence-driven I-frame would fall
        /// within 5 frames of a scene-change I-frame, then the encoder skips the cadence-driven
