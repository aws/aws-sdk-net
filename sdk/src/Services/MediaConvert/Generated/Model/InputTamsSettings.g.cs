...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class InputTamsSettings
    {
        ...
        /// </summary>
        public string AuthConnectionArn { get; set; }

        /// <summary>
        /// Checks to see if the AuthConnectionArn property is set.
        /// </summary>
        internal bool IsSetAuthConnectionArn() => this.AuthConnectionArn != null;
        ...
        /// </summary>
        public TamsGapHandling GapHandling { get; set; }

        /// <summary>
        /// Checks to see if the GapHandling property is set.
        /// </summary>
        internal bool IsSetGapHandling() => this.GapHandling != null;
