...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class MotionImageInserter
    {
        ...
        /// of .png files.
        /// </summary>
        public MotionImageInsertionMode InsertionMode { get; set; }
        ...
        /// </summary>
        internal bool IsSetOffset() => this.Offset != null;

        /// <summary>
        /// Gets and sets the property Playback. Specify whether your motion graphic overlay repeats
        /// on a loop or plays only once.
        /// </summary>
        public MotionImagePlayback Playback { get; set; }

        /// <summary>
        /// Checks to see if the Playback property is set.
        /// </summary>
        internal bool IsSetPlayback() => this.Playback != null;
