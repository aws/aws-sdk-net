...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class VideoSelector
    {
        ...
        /// </summary>
        public AlphaBehavior AlphaBehavior { get; set; }

        /// <summary>
        /// Checks to see if the AlphaBehavior property is set.
        /// </summary>
        internal bool IsSetAlphaBehavior() => this.AlphaBehavior != null;
        ...
        /// <summary>
        /// Checks to see if the ColorSpace property is set.
        /// </summary>
        internal bool IsSetColorSpace() => this.ColorSpace != null;
        ...
        /// </summary>
        public ColorSpaceUsage ColorSpaceUsage { get; set; }

        /// <summary>
        /// Checks to see if the ColorSpaceUsage property is set.
        /// </summary>
        internal bool IsSetColorSpaceUsage() => this.ColorSpaceUsage != null;
        ...
        /// MDPM timecode.
        /// </summary>
        public EmbeddedTimecodeOverride EmbeddedTimecodeOverride { get; set; }

        /// <summary>
        /// Checks to see if the EmbeddedTimecodeOverride property is set.
        /// </summary>
        internal bool IsSetEmbeddedTimecodeOverride() => this.EmbeddedTimecodeOverride != null;
        ...
        /// <summary>
        /// Checks to see if the Hdr10Metadata property is set.
        /// </summary>
        internal bool IsSetHdr10Metadata() => this.Hdr10Metadata != null;
        ...
        /// </summary>
        public PadVideo PadVideo { get; set; }

        /// <summary>
        /// Checks to see if the PadVideo property is set.
        /// </summary>
        internal bool IsSetPadVideo() => this.PadVideo != null;
        ...
        /// </summary>
        public InputRotate Rotate { get; set; }

        /// <summary>
        /// Checks to see if the Rotate property is set.
        /// </summary>
        internal bool IsSetRotate() => this.Rotate != null;
        ...
        /// </summary>
        public InputSampleRange SampleRange { get; set; }

        /// <summary>
        /// Checks to see if the SampleRange property is set.
        /// </summary>
        internal bool IsSetSampleRange() => this.SampleRange != null;
        ...
        /// </summary>
        public VideoSelectorType SelectorType { get; set; }
        ...
        /// the first stream in your HLS multivariant playlist starting at 1. For re-encoding
        /// workflows, MediaConvert uses the video stream that you select with the highest bitrate
        /// as the input. For video passthrough workflows, you specify whether to passthrough
        /// a single video stream or multiple video streams under Video selector source in the
