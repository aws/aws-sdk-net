...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class AudioPitchCorrectionSettings
    {
        ...
        /// </summary>
        public SlowPalPitchCorrection SlowPalPitchCorrection { get; set; }

        /// <summary>
        /// Checks to see if the SlowPalPitchCorrection property is set.
        /// </summary>
        internal bool IsSetSlowPalPitchCorrection() => this.SlowPalPitchCorrection != null;
    }
}
