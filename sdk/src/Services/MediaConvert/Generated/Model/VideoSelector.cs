...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class VideoSelector
    {
        ...
        /// video has metadata indicating the wrong color space, specify the accurate color space
        /// here. If your input video is HDR 10 and the SMPTE ST 2086 Mastering Display Color
        /// Volume static metadata isn't present in your video stream, or if that metadata is
        /// present but not accurate, choose Force HDR 10 here and specify correct values in the
        /// input HDR 10 metadata settings. For more information about MediaConvert HDR jobs,
        /// see https://docs.aws.amazon.com/console/mediaconvert/hdr. Select P3D65 (SDR) to set
        /// the input color space metadata to the following: * Color primaries: Display P3 * Transfer
