...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class AutomatedAbrSettings
    {
        ...
        public int? MaxAbrBitrate { get; set; }

        /// <summary>
        /// Checks to see if the MaxAbrBitrate property is set.
        /// </summary>
        internal bool IsSetMaxAbrBitrate() => this.MaxAbrBitrate.HasValue;
        ...
        /// </summary>
        public double? MaxQualityLevel { get; set; }

        /// <summary>
        /// Checks to see if the MaxQualityLevel property is set.
        /// </summary>
        internal bool IsSetMaxQualityLevel() => this.MaxQualityLevel.HasValue;
        ...
        public int? MaxRenditions { get; set; }

        /// <summary>
        /// Checks to see if the MaxRenditions property is set.
        /// </summary>
        internal bool IsSetMaxRenditions() => this.MaxRenditions.HasValue;
        ...
        /// </summary>
        [AWSProperty(Min = 100000, Max = 100000000)]
        public int? MinAbrBitrate { get; set; }

        /// <summary>
        /// Checks to see if the MinAbrBitrate property is set.
        /// </summary>
        internal bool IsSetMinAbrBitrate() => this.MinAbrBitrate.HasValue;
        ...
        /// </summary>
        public List<AutomatedAbrRule> Rules { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedAbrRule>() : null;
