...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class EmbeddedDestinationSettings
    {
        ...
        public int? Destination608ChannelNumber { get; set; }

        /// <summary>
        /// Checks to see if the Destination608ChannelNumber property is set.
        /// </summary>
        internal bool IsSetDestination608ChannelNumber() => this.Destination608ChannelNumber.HasValue;
        ...
        public int? Destination708ServiceNumber { get; set; }

        /// <summary>
        /// Checks to see if the Destination708ServiceNumber property is set.
        /// </summary>
        internal bool IsSetDestination708ServiceNumber() => this.Destination708ServiceNumber.HasValue;
    }
}
