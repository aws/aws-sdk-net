...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class BandwidthReductionFilter
    {
        ...
        /// </summary>
        public BandwidthReductionFilterSharpening Sharpening { get; set; }

        /// <summary>
        /// Checks to see if the Sharpening property is set.
        /// </summary>
        internal bool IsSetSharpening() => this.Sharpening != null;
        ...
        /// </summary>
        public BandwidthReductionFilterStrength Strength { get; set; }

        /// <summary>
        /// Checks to see if the Strength property is set.
        /// </summary>
        internal bool IsSetStrength() => this.Strength != null;
    }
}
