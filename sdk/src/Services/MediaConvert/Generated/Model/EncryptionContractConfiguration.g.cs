...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class EncryptionContractConfiguration
    {
        ...
        /// </summary>
        public PresetSpeke20Audio SpekeAudioPreset { get; set; }

        /// <summary>
        /// Checks to see if the SpekeAudioPreset property is set.
        /// </summary>
        internal bool IsSetSpekeAudioPreset() => this.SpekeAudioPreset != null;
        ...
        /// preset (other than Shared or Unencrypted).
        /// </summary>
        public PresetSpeke20Video SpekeVideoPreset { get; set; }

        /// <summary>
        /// Checks to see if the SpekeVideoPreset property is set.
        /// </summary>
        internal bool IsSetSpekeVideoPreset() => this.SpekeVideoPreset != null;
    }
}
