...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class VideoProperties
    {
        ...
        /// and make informed encoding decisions. These fields are returned for H.264 (AVC), H.265
        /// (HEVC), and MPEG-2 video, and might not be returned for other codecs. For MPEG-TS
        /// and MPEG-PS inputs, color information (color primaries, transfer characteristics,
        /// and matrix coefficients) appears in these fields rather than in the top-level videoProperties.
        /// </summary>
