...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class ElementalInferenceConfiguration
    {
        ...
        /// </summary>
        public List<string> Features { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ElementalInferenceFeed> Feeds { get; set; } = AWSConfigs.InitializeCollections ? new List<ElementalInferenceFeed>() : null;

        /// <summary>
        /// Checks to see if the Feeds property is set.
        /// </summary>
        internal bool IsSetFeeds() => this.Feeds != null && (this.Feeds.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
