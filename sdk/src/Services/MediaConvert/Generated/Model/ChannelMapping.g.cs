...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class ChannelMapping
    {
        ...
        /// </summary>
        public List<OutputChannelMapping> OutputChannels { get; set; } = AWSConfigs.InitializeCollections ? new List<OutputChannelMapping>() : null;

        /// <summary>
        /// Checks to see if the OutputChannels property is set.
        /// </summary>
        internal bool IsSetOutputChannels() => this.OutputChannels != null && (this.OutputChannels.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
