...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class MxfXavcProfileSettings
    {
        ...
        /// </summary>
        public MxfXavcDurationMode DurationMode { get; set; }

        /// <summary>
        /// Checks to see if the DurationMode property is set.
        /// </summary>
        internal bool IsSetDurationMode() => this.DurationMode != null;
        ...
        public int? MaxAncDataSize { get; set; }

        /// <summary>
        /// Checks to see if the MaxAncDataSize property is set.
        /// </summary>
        internal bool IsSetMaxAncDataSize() => this.MaxAncDataSize.HasValue;
    }
}
