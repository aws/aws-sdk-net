...
namespace Amazon.MediaConvert.Model
{
    ...
    internal sealed partial class ListVersionsPaginator : IPaginator<ListVersionsResponse>, IListVersionsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<JobEngineVersion> Versions =>
            new PaginatedResultKeyResponse<ListVersionsResponse, JobEngineVersion>(this, (i) => i.Versions ?? new List<JobEngineVersion>());

        internal ListVersionsPaginator(IAmazonMediaConvert client, ListVersionsRequest request)
        {
            this._client = client;
