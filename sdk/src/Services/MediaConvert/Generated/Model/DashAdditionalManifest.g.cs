...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class DashAdditionalManifest
    {
        ...
        /// <summary>
        /// Checks to see if the ManifestNameModifier property is set.
        /// </summary>
        internal bool IsSetManifestNameModifier() => this.ManifestNameModifier != null;
        ...
        /// </summary>
        public List<string> SelectedOutputs { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SelectedOutputs property is set.
        /// </summary>
        internal bool IsSetSelectedOutputs() => this.SelectedOutputs != null && (this.SelectedOutputs.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
