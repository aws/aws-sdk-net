...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class VideoOverlay
    {
        ...
        /// </summary>
        public VideoOverlayCrop Crop { get; set; }
        ...
        /// video: Leave blank.
        /// </summary>
        public VideoOverlayPosition InitialPosition { get; set; }

        /// <summary>
        /// Checks to see if the InitialPosition property is set.
        /// </summary>
        internal bool IsSetInitialPosition() => this.InitialPosition != null;
        ...
        /// </summary>
        public VideoOverlayInput Input { get; set; }
        ...
        /// </summary>
        public VideoOverlayPlayBackMode Playback { get; set; }
        ...
        /// </summary>
        public List<VideoOverlayTransition> Transitions { get; set; } = AWSConfigs.InitializeCollections ? new List<VideoOverlayTransition>() : null;
