...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class ClipLimits
    {
        ...
        public int? MaximumRGBTolerance { get; set; }

        /// <summary>
        /// Checks to see if the MaximumRGBTolerance property is set.
        /// </summary>
        internal bool IsSetMaximumRGBTolerance() => this.MaximumRGBTolerance.HasValue;
        ...
        public int? MaximumYUV { get; set; }

        /// <summary>
        /// Checks to see if the MaximumYUV property is set.
        /// </summary>
        internal bool IsSetMaximumYUV() => this.MaximumYUV.HasValue;
        ...
        public int? MinimumRGBTolerance { get; set; }

        /// <summary>
        /// Checks to see if the MinimumRGBTolerance property is set.
        /// </summary>
        internal bool IsSetMinimumRGBTolerance() => this.MinimumRGBTolerance.HasValue;
        ...
        public int? MinimumYUV { get; set; }

        /// <summary>
        /// Checks to see if the MinimumYUV property is set.
        /// </summary>
        internal bool IsSetMinimumYUV() => this.MinimumYUV.HasValue;
    }
}
