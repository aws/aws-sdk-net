...
{
    /// <summary>
    /// Base class for ListQueues paginators.
    /// </summary>
    internal sealed partial class ListQueuesPaginator : IPaginator<ListQueuesResponse>, IListQueuesPaginator
    {
        private readonly IAmazonMediaConvert _client;
        private readonly ListQueuesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListQueuesResponse> Responses => new PaginatedResponse<ListQueuesResponse>(this);
...
#if BCL
        IEnumerable<ListQueuesResponse> IPaginator<ListQueuesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListQueues(_request);
        ...
        async IAsyncEnumerable<ListQueuesResponse> IPaginator<ListQueuesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListQueuesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
