...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class TimedMetadataInsertion
    {
        ...
        /// </summary>
        public List<Id3Insertion> Id3Insertions { get; set; } = AWSConfigs.InitializeCollections ? new List<Id3Insertion>() : null;

        /// <summary>
        /// Checks to see if the Id3Insertions property is set.
        /// </summary>
        internal bool IsSetId3Insertions() => this.Id3Insertions != null && (this.Id3Insertions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
