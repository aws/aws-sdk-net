...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class NielsenConfiguration
    {
        ...
        public int? BreakoutCode { get; set; }

        /// <summary>
        /// Checks to see if the BreakoutCode property is set.
        /// </summary>
        internal bool IsSetBreakoutCode() => this.BreakoutCode.HasValue;
        ...
        /// <summary>
        /// Checks to see if the DistributorId property is set.
        /// </summary>
        internal bool IsSetDistributorId() => this.DistributorId != null;
    }
}
