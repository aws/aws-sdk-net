...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class ExtendedDataServices
    {
        ...
        /// </summary>
        public CopyProtectionAction CopyProtectionAction { get; set; }

        /// <summary>
        /// Checks to see if the CopyProtectionAction property is set.
        /// </summary>
        internal bool IsSetCopyProtectionAction() => this.CopyProtectionAction != null;
        ...
        /// </summary>
        public VchipAction VchipAction { get; set; }

        /// <summary>
        /// Checks to see if the VchipAction property is set.
        /// </summary>
        internal bool IsSetVchipAction() => this.VchipAction != null;
    }
}
