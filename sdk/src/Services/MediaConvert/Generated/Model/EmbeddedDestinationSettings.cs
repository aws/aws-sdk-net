...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class EmbeddedDestinationSettings
    {
        ...
        /// to replace the input channel number with the track number that you specify. If you
        /// don't specify an output track number, the system uses the input channel number for
        /// the output channel number. This setting applies to each output individually. Channels
        /// must be unique and may only be combined in the following combinations: (1+3, 2+4,
        /// 1+4, 2+3).
        /// </summary>
