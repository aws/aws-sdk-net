...
{
    /// <summary>
    /// Container for the parameters to the AssociateCertificate operation. Associates an
    /// AWS Certificate Manager (ACM) Amazon Resource Name (ARN) with AWS Elemental MediaConvert.
    /// </summary>
