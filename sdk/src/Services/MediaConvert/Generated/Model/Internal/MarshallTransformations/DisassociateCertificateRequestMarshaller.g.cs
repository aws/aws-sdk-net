...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateCertificateRequestMarshaller : IMarshaller<IRequest, DisassociateCertificateRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateCertificateRequestMarshaller _instance = new();

        internal static DisassociateCertificateRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateCertificateRequestMarshaller Instance => _instance;
    }
}
