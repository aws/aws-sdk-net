...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NoiseReducerUnmarshaller : IJsonUnmarshaller<NoiseReducer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new NoiseReducer();
        ...
        /// Gets the singleton.
        /// </summary>
        public static NoiseReducerUnmarshaller Instance => _instance;
    }
}
