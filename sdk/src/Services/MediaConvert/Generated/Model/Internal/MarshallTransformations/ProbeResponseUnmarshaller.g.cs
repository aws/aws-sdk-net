...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProbeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProbeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("probeResults", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ProbeResults = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ProbeResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ProbeResponseUnmarshaller Instance => _instance;
    }
}
