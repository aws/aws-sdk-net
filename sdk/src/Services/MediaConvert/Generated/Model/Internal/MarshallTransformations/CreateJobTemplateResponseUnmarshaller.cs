...
{
    /// <summary>
    /// Response Unmarshaller for CreateJobTemplate operation
    /// </summary>  
    public class CreateJobTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("jobTemplate", targetDepth, ref reader))
                {
                    var unmarshaller = JobTemplateUnmarshaller.Instance;
                    response.JobTemplate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateJobTemplateResponseUnmarshaller _instance = new CreateJobTemplateResponseUnmarshaller();        

        internal static CreateJobTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateJobTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
