...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetJobsQueryResultsRequestMarshaller : IMarshaller<IRequest, GetJobsQueryResultsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetJobsQueryResultsRequestMarshaller _instance = new GetJobsQueryResultsRequestMarshaller();        

        internal static GetJobsQueryResultsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobsQueryResultsRequestMarshaller Instance
        {
            get
            {
                return _instance;
