        ...
        public Policy Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("httpInputs", targetDepth))
                {
                    ...
                    unmarshalledObject.HttpInputs = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("httpsInputs", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HttpsInputs = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("s3Inputs", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.S3Inputs = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
