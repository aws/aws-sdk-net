...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TeletextDestinationSettingsMarshaller : IRequestMarshaller<TeletextDestinationSettings, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(TeletextDestinationSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetPageTypes())
            {
                ...
                {
                    context.Writer.WriteStringValue(requestObjectPageTypesListValue);
                }
