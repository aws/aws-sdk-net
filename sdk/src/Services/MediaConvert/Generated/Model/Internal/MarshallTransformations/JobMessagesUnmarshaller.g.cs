...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class JobMessagesUnmarshaller : IJsonUnmarshaller<JobMessages, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public JobMessages Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new JobMessages();
        ...
        /// Gets the singleton.
        /// </summary>
        public static JobMessagesUnmarshaller Instance => _instance;
    }
}
