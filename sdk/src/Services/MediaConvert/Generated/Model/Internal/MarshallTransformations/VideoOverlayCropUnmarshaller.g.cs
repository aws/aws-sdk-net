...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VideoOverlayCropUnmarshaller : IJsonUnmarshaller<VideoOverlayCrop, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VideoOverlayCrop();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("y", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static VideoOverlayCropUnmarshaller Instance => _instance;
    }
}
