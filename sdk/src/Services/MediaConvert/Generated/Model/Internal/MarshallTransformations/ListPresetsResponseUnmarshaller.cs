    ...
    public class ListPresetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("presets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Preset, PresetUnmarshaller>(PresetUnmarshaller.Instance);
                    response.Presets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
