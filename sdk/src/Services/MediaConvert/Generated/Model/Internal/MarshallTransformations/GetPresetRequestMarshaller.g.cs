...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetPresetRequestMarshaller : IMarshaller<IRequest, GetPresetRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetPresetRequestMarshaller _instance = new();

        internal static GetPresetRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPresetRequestMarshaller Instance => _instance;
    }
}
