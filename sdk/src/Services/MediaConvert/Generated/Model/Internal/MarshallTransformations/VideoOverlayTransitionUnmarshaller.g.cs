...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VideoOverlayTransitionUnmarshaller : IJsonUnmarshaller<VideoOverlayTransition, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public VideoOverlayTransition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new VideoOverlayTransition();
            ...
            {
                if (context.TestExpression("endPosition", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static VideoOverlayTransitionUnmarshaller Instance => _instance;
    }
}
