...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutPolicyRequestMarshaller : IMarshaller<IRequest, PutPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutPolicyRequestMarshaller _instance = new();

        internal static PutPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutPolicyRequestMarshaller Instance => _instance;
    }
}
