...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    public class TrackSourceSettingsMarshaller : IRequestMarshaller<TrackSourceSettings, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(TrackSourceSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetStreamNumber())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.StreamNumber.Value);
            }

            if(requestObject.IsSetTrackNumber())
            {
                context.Writer.WritePropertyName("trackNumber");
                context.Writer.WriteNumberValue(requestObject.TrackNumber.Value);
            }
