...
{
    /// <summary>
    /// DvbNitSettings Marshaller
    /// </summary>
    public class DvbNitSettingsMarshaller : IRequestMarshaller<DvbNitSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DvbNitSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetNitInterval())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.NitInterval.Value);
            }
        ...
        /// </summary>
        public readonly static DvbNitSettingsMarshaller Instance = new DvbNitSettingsMarshaller();
