    ...
    public class AudioPropertiesUnmarshaller : IJsonUnmarshaller<AudioProperties, JsonUnmarshallerContext>
    {
        ...
        public AudioProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("channelLayout", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ChannelLayout = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static AudioPropertiesUnmarshaller _instance = new AudioPropertiesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AudioPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
