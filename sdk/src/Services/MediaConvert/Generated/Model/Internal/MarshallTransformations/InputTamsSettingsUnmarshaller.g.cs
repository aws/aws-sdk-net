...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InputTamsSettingsUnmarshaller : IJsonUnmarshaller<InputTamsSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InputTamsSettings();
            ...
            {
                if (context.TestExpression("authConnectionArn", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("gapHandling", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static InputTamsSettingsUnmarshaller Instance => _instance;
    }
}
