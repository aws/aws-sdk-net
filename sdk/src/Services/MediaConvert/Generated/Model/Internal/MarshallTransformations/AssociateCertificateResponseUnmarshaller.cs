...
{
    /// <summary>
    /// Response Unmarshaller for AssociateCertificate operation
    /// </summary>  
    public class AssociateCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateCertificateResponse response = new AssociateCertificateResponse();
        ...
        private static AssociateCertificateResponseUnmarshaller _instance = new AssociateCertificateResponseUnmarshaller();        

        internal static AssociateCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
