    ...
    public class QueueUnmarshaller : IJsonUnmarshaller<Queue, JsonUnmarshallerContext>
    {
        ...
        public Queue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("concurrentJobs", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("maximumConcurrentFeeds", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.MaximumConcurrentFeeds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("progressingJobsCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.ProgressingJobsCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("reservationPlan", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("serviceOverrides", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("submittedJobsCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
