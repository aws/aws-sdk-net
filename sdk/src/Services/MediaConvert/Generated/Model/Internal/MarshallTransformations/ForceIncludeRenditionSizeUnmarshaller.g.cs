...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ForceIncludeRenditionSizeUnmarshaller : IJsonUnmarshaller<ForceIncludeRenditionSize, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ForceIncludeRenditionSize Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ForceIncludeRenditionSize();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ForceIncludeRenditionSizeUnmarshaller Instance => _instance;
    }
}
