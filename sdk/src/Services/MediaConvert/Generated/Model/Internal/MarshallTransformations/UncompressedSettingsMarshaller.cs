...
{
    /// <summary>
    /// UncompressedSettings Marshaller
    /// </summary>
    public class UncompressedSettingsMarshaller : IRequestMarshaller<UncompressedSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(UncompressedSettings requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetFourcc())
            {
                context.Writer.WritePropertyName("fourcc");
                context.Writer.WriteStringValue(requestObject.Fourcc);
            }
        ...
        /// </summary>
        public readonly static UncompressedSettingsMarshaller Instance = new UncompressedSettingsMarshaller();
