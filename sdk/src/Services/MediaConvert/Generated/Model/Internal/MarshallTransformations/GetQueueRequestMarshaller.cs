...
{
    /// <summary>
    /// GetQueue Request Marshaller
    /// </summary>       
    public class GetQueueRequestMarshaller : IMarshaller<IRequest, GetQueueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetQueueRequest)input);
        }
