...
{
    /// <summary>
    /// UpdatePreset Request Marshaller
    /// </summary>       
    public class UpdatePresetRequestMarshaller : IMarshaller<IRequest, UpdatePresetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePresetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePresetRequest publicRequest)
        {
        ...
        private static UpdatePresetRequestMarshaller _instance = new UpdatePresetRequestMarshaller();        

        internal static UpdatePresetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePresetRequestMarshaller Instance
        {
            get
            {
                return _instance;
