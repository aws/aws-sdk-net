...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TrackMappingUnmarshaller : IJsonUnmarshaller<TrackMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TrackMapping();
            ...
            {
                if (context.TestExpression("audioTrackIndexes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("dataTrackIndexes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<int, IntUnmarshaller>(IntUnmarshaller.Instance);
                ...
                if (context.TestExpression("videoTrackIndexes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<int, IntUnmarshaller>(IntUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static TrackMappingUnmarshaller Instance => _instance;
    }
}
