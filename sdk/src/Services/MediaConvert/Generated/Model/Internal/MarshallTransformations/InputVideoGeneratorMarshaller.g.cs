...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InputVideoGeneratorMarshaller : IRequestMarshaller<InputVideoGenerator, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(InputVideoGenerator requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetImageInput())
            {
                ...
                context.Writer.WriteStringValue(requestObject.ImageInput);
            }
