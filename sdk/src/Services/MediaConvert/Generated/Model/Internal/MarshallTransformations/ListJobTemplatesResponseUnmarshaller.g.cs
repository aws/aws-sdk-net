...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListJobTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListJobTemplatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("jobTemplates", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.JobTemplates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListJobTemplatesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListJobTemplatesResponseUnmarshaller Instance => _instance;
    }
}
