...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutomatedAbrSettingsUnmarshaller : IJsonUnmarshaller<AutomatedAbrSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AutomatedAbrSettings();
            ...
            {
                if (context.TestExpression("maxAbrBitrate", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("maxQualityLevel", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("maxRenditions", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                ...
                if (context.TestExpression("minAbrBitrate", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutomatedAbrSettingsUnmarshaller Instance => _instance;
    }
}
