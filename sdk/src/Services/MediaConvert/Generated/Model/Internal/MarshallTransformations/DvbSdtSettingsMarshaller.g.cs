...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DvbSdtSettingsMarshaller : IRequestMarshaller<DvbSdtSettings, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(DvbSdtSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetSdtInterval())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.SdtInterval.Value);
            }
