...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CmafEncryptionSettingsMarshaller : IRequestMarshaller<CmafEncryptionSettings, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(CmafEncryptionSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetClearLeadSegments())
            {
                context.Writer.WritePropertyName("clearLeadSegments");
                context.Writer.WriteNumberValue(requestObject.ClearLeadSegments.Value);
            }
