...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CancelJobRequestMarshaller : IMarshaller<IRequest, CancelJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CancelJobRequestMarshaller _instance = new();

        internal static CancelJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelJobRequestMarshaller Instance => _instance;
    }
}
