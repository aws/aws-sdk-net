...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class H264QvbrSettingsUnmarshaller : IJsonUnmarshaller<H264QvbrSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public H264QvbrSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("maxAverageBitrate", targetDepth, ref reader))
                {
