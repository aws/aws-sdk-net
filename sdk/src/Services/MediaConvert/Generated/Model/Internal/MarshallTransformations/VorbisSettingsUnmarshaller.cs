...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VorbisSettingsUnmarshaller : IJsonUnmarshaller<VorbisSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VorbisSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("vbrQuality", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
