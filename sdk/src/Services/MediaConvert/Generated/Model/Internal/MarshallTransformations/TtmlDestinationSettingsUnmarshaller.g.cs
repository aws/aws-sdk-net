...
{
    /// <summary>
    /// Response Unmarshaller for TtmlDestinationSettings Object
    /// </summary>
    public partial class TtmlDestinationSettingsUnmarshaller : IJsonUnmarshaller<TtmlDestinationSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TtmlDestinationSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TtmlDestinationSettings();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("backgroundOpacity", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("fontOpacity", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                ...
                if (context.TestExpression("stylePassthrough", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("textDecoration", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TextDecoration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static TtmlDestinationSettingsUnmarshaller _instance = new TtmlDestinationSettingsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TtmlDestinationSettingsUnmarshaller Instance => _instance;
    }
}
