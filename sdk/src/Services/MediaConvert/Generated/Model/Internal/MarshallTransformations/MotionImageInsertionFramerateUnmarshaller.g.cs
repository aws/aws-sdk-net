...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MotionImageInsertionFramerateUnmarshaller : IJsonUnmarshaller<MotionImageInsertionFramerate, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public MotionImageInsertionFramerate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new MotionImageInsertionFramerate();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MotionImageInsertionFramerateUnmarshaller Instance => _instance;
    }
}
