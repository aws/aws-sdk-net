...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FileGroupSettingsUnmarshaller : IJsonUnmarshaller<FileGroupSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public FileGroupSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new FileGroupSettings();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FileGroupSettingsUnmarshaller Instance => _instance;
    }
}
