...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutomatedAbrRuleUnmarshaller : IJsonUnmarshaller<AutomatedAbrRule, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AutomatedAbrRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AutomatedAbrRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutomatedAbrRuleUnmarshaller Instance => _instance;
    }
}
