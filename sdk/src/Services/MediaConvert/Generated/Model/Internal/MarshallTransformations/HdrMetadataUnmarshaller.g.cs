...
{
    /// <summary>
    /// Response Unmarshaller for HdrMetadata Object
    /// </summary>
    public partial class HdrMetadataUnmarshaller : IJsonUnmarshaller<HdrMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public HdrMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new HdrMetadata();
        ...
        private static HdrMetadataUnmarshaller _instance = new HdrMetadataUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HdrMetadataUnmarshaller Instance => _instance;
    }
}
