...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class TrackSourceSettings
    {
        ...
        /// <summary>
        /// Checks to see if the StreamNumber property is set.
        /// </summary>
        internal bool IsSetStreamNumber() => this.StreamNumber.HasValue;
        ...
        /// <summary>
        /// Checks to see if the TrackNumber property is set.
        /// </summary>
        internal bool IsSetTrackNumber() => this.TrackNumber.HasValue;
    }
}
