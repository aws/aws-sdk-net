...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class HdrMetadata
    {
        ...
        private MasteringDisplayColorVolume _masteringDisplayColorVolume;
        ...
        /// </summary>
        public MasteringDisplayColorVolume MasteringDisplayColorVolume
        {
            get { return this._masteringDisplayColorVolume; }
            set { this._masteringDisplayColorVolume = value; }
        }

        // Check to see if MasteringDisplayColorVolume property is set
        internal bool IsSetMasteringDisplayColorVolume()
        {
            return this._masteringDisplayColorVolume != null;
        }
