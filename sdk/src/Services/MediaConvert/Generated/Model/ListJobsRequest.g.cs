...
{
    /// <summary>
    /// Container for the parameters to the ListJobs operation. Retrieve a JSON array of up
    /// to twenty of your most recently created jobs. This array includes in-process, completed,
    /// and errored jobs. This will return the jobs themselves, not just a list of the jobs.
    ...
    public partial class ListJobsRequest : AmazonMediaConvertRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property Queue. Optional. Provide a queue name to get back only
