...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class H265QvbrSettings
    {
        ...
        /// <summary>
        /// Checks to see if the MaxAverageBitrate property is set.
        /// </summary>
        internal bool IsSetMaxAverageBitrate() => this.MaxAverageBitrate.HasValue;
        ...
        public int? QvbrQualityLevel { get; set; }

        /// <summary>
        /// Checks to see if the QvbrQualityLevel property is set.
        /// </summary>
        internal bool IsSetQvbrQualityLevel() => this.QvbrQualityLevel.HasValue;
        ...
        /// </summary>
        public double? QvbrQualityLevelFineTune { get; set; }

        /// <summary>
        /// Checks to see if the QvbrQualityLevelFineTune property is set.
        /// </summary>
        internal bool IsSetQvbrQualityLevelFineTune() => this.QvbrQualityLevelFineTune.HasValue;
    }
}
