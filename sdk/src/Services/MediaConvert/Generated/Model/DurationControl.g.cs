...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class DurationControl
    {
        ...
        public int? IntegerDurationMaximumCompressionDenominator { get; set; }

        /// <summary>
        /// Checks to see if the IntegerDurationMaximumCompressionDenominator property is set.
        /// </summary>
        internal bool IsSetIntegerDurationMaximumCompressionDenominator() => this.IntegerDurationMaximumCompressionDenominator.HasValue;
        ...
        public int? IntegerDurationMaximumCompressionNumerator { get; set; }

        /// <summary>
        /// Checks to see if the IntegerDurationMaximumCompressionNumerator property is set.
        /// </summary>
        internal bool IsSetIntegerDurationMaximumCompressionNumerator() => this.IntegerDurationMaximumCompressionNumerator.HasValue;
        ...
        public int? IntegerDurationTrimThresholdMilliseconds { get; set; }

        /// <summary>
        /// Checks to see if the IntegerDurationTrimThresholdMilliseconds property is set.
        /// </summary>
        internal bool IsSetIntegerDurationTrimThresholdMilliseconds() => this.IntegerDurationTrimThresholdMilliseconds.HasValue;
    }
}
