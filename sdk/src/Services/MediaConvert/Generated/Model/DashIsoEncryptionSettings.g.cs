...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class DashIsoEncryptionSettings
    {
        ...
        /// </summary>
        public DashIsoPlaybackDeviceCompatibility PlaybackDeviceCompatibility { get; set; }

        /// <summary>
        /// Checks to see if the PlaybackDeviceCompatibility property is set.
        /// </summary>
        internal bool IsSetPlaybackDeviceCompatibility() => this.PlaybackDeviceCompatibility != null;
