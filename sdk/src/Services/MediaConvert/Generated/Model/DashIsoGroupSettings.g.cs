...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class DashIsoGroupSettings
    {
        ...
        /// </summary>
        public List<DashAdditionalManifest> AdditionalManifests { get; set; } = AWSConfigs.InitializeCollections ? new List<DashAdditionalManifest>() : null;
        ...
        /// </summary>
        public DashIsoGroupAudioChannelConfigSchemeIdUri AudioChannelConfigSchemeIdUri { get; set; }

        /// <summary>
        /// Checks to see if the AudioChannelConfigSchemeIdUri property is set.
        /// </summary>
        internal bool IsSetAudioChannelConfigSchemeIdUri() => this.AudioChannelConfigSchemeIdUri != null;
        ...
        public string DashIFrameTrickPlayNameModifier { get; set; }

        /// <summary>
        /// Checks to see if the DashIFrameTrickPlayNameModifier property is set.
        /// </summary>
        internal bool IsSetDashIFrameTrickPlayNameModifier() => this.DashIFrameTrickPlayNameModifier != null;
        ...
        /// </summary>
        public DashManifestStyle DashManifestStyle { get; set; }

        /// <summary>
        /// Checks to see if the DashManifestStyle property is set.
        /// </summary>
        internal bool IsSetDashManifestStyle() => this.DashManifestStyle != null;
        ...
        /// </summary>
        public DashIsoHbbtvCompliance HbbtvCompliance { get; set; }

        /// <summary>
        /// Checks to see if the HbbtvCompliance property is set.
        /// </summary>
        internal bool IsSetHbbtvCompliance() => this.HbbtvCompliance != null;
        ...
        /// adds an entry in the .mpd manifest for each set of images that you generate. A common
        /// application for these images is Roku trick mode. The thumbnails and full-frame images
        /// that MediaConvert creates with this feature are compatible with this Roku specification:
        /// https://developer.roku.com/docs/developer-program/media-playback/trick-mode/hls-and-dash.md
        /// </summary>
        public DashIsoImageBasedTrickPlay ImageBasedTrickPlay { get; set; }
        ...
        /// </summary>
        public DashIsoImageBasedTrickPlaySettings ImageBasedTrickPlaySettings { get; set; }
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<DashIsoImageBasedTrickPlayVariant> ImageBasedTrickPlayVariants { get; set; } = AWSConfigs.InitializeCollections ? new List<DashIsoImageBasedTrickPlayVariant>() : null;
        ...
        /// <summary>
        /// Checks to see if the MinBufferTime property is set.
        /// </summary>
        internal bool IsSetMinBufferTime() => this.MinBufferTime.HasValue;
        ...
        /// </summary>
        public DashIsoMpdManifestBandwidthType MpdManifestBandwidthType { get; set; }

        /// <summary>
        /// Checks to see if the MpdManifestBandwidthType property is set.
        /// </summary>
        internal bool IsSetMpdManifestBandwidthType() => this.MpdManifestBandwidthType != null;
        ...
        /// </summary>
        public DashIsoMpdProfile MpdProfile { get; set; }

        /// <summary>
        /// Checks to see if the MpdProfile property is set.
        /// </summary>
        internal bool IsSetMpdProfile() => this.MpdProfile != null;
        ...
        /// of your choice here.
        /// </summary>
        public DashIsoPtsOffsetHandlingForBFrames PtsOffsetHandlingForBFrames { get; set; }

        /// <summary>
        /// Checks to see if the PtsOffsetHandlingForBFrames property is set.
        /// </summary>
        internal bool IsSetPtsOffsetHandlingForBFrames() => this.PtsOffsetHandlingForBFrames != null;
        ...
        /// </summary>
        public DashIsoSegmentControl SegmentControl { get; set; }
        ...
        /// 48kHz.
        /// </summary>
        public DashIsoSegmentLengthControl SegmentLengthControl { get; set; }
        ...
        /// </summary>
        public DashIsoVideoCompositionOffsets VideoCompositionOffsets { get; set; }

        /// <summary>
        /// Checks to see if the VideoCompositionOffsets property is set.
        /// </summary>
        internal bool IsSetVideoCompositionOffsets() => this.VideoCompositionOffsets != null;
        ...
        /// your DASH manifest.
        /// </summary>
        public DashIsoWriteSegmentTimelineInRepresentation WriteSegmentTimelineInRepresentation { get; set; }

        /// <summary>
        /// Checks to see if the WriteSegmentTimelineInRepresentation property is set.
        /// </summary>
        internal bool IsSetWriteSegmentTimelineInRepresentation() => this.WriteSegmentTimelineInRepresentation != null;
    }
}
