...
{
    /// <summary>
    /// Container for the parameters to the ListJobTemplates operation. Retrieve a JSON array
    /// of up to twenty of your job templates. This will return the templates themselves,
    /// not just a list of them. To retrieve the next twenty templates, use the nextToken
    ...
    public partial class ListJobTemplatesRequest : AmazonMediaConvertRequest
    {
        ...
        /// </summary>
        public JobTemplateListBy ListBy { get; set; }
