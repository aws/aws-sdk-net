...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class ImageInserter
    {
        ...
        /// </summary>
        public List<InsertableImage> InsertableImages { get; set; } = AWSConfigs.InitializeCollections ? new List<InsertableImage>() : null;

        /// <summary>
        /// Checks to see if the InsertableImages property is set.
        /// </summary>
        internal bool IsSetInsertableImages() => this.InsertableImages != null && (this.InsertableImages.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public int? SdrReferenceWhiteLevel { get; set; }

        /// <summary>
        /// Checks to see if the SdrReferenceWhiteLevel property is set.
        /// </summary>
        internal bool IsSetSdrReferenceWhiteLevel() => this.SdrReferenceWhiteLevel.HasValue;
    }
}
