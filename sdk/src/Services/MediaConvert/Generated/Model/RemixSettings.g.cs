...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class RemixSettings
    {
        ...
        public int? AudioDescriptionAudioChannel { get; set; }

        /// <summary>
        /// Checks to see if the AudioDescriptionAudioChannel property is set.
        /// </summary>
        internal bool IsSetAudioDescriptionAudioChannel() => this.AudioDescriptionAudioChannel.HasValue;
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 64)]
        public int? AudioDescriptionDataChannel { get; set; }

        /// <summary>
        /// Checks to see if the AudioDescriptionDataChannel property is set.
        /// </summary>
        internal bool IsSetAudioDescriptionDataChannel() => this.AudioDescriptionDataChannel.HasValue;
        ...
        /// <summary>
        /// Checks to see if the ChannelMapping property is set.
        /// </summary>
        internal bool IsSetChannelMapping() => this.ChannelMapping != null;
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 64)]
        public int? ChannelsIn { get; set; }

        /// <summary>
        /// Checks to see if the ChannelsIn property is set.
        /// </summary>
        internal bool IsSetChannelsIn() => this.ChannelsIn.HasValue;
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 64)]
        public int? ChannelsOut { get; set; }

        /// <summary>
        /// Checks to see if the ChannelsOut property is set.
        /// </summary>
        internal bool IsSetChannelsOut() => this.ChannelsOut.HasValue;
    }
}
