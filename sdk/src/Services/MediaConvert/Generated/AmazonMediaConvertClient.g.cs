...
namespace Amazon.MediaConvert
{
    ...
    public partial class AmazonMediaConvertClient : AmazonServiceClient, IAmazonMediaConvert
    {
        ...
        /// 
        /// </summary>
        public AmazonMediaConvertClient() : base(new AmazonMediaConvertConfig()) { }
        ...
        public AmazonMediaConvertClient(RegionEndpoint region) : base(new AmazonMediaConvertConfig { RegionEndpoint = region }) { }
        ...
        public AmazonMediaConvertClient(AmazonMediaConvertConfig config) : base(config) { }
        ...
        public virtual GetJobsQueryResultsResponse GetJobsQueryResults(GetJobsQueryResultsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual StartJobsQueryResponse StartJobsQuery(StartJobsQueryRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
