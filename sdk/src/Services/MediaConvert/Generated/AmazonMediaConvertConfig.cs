...
namespace Amazon.MediaConvert
{
    ...
    public partial class AmazonMediaConvertConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("MediaConvert", "4.0.105.0");
        ...
        /// </summary>
        public static new string ServiceId => "MediaConvert";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "mediaconvert";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2017-08-29";
