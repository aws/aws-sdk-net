...
namespace Amazon.CloudSearchDomain.Internal
{
    ...
    public class AmazonCloudSearchDomainAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudSearchDomainAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudSearchDomain.
        /// </summary>
        public AmazonCloudSearchDomainAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudSearchDomainAuthSchemeParameters
            {
    ...
    public class AmazonCloudSearchDomainAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudSearchDomainAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudSearchDomainAuthSchemeParameters authParameters)
        {
