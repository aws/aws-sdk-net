...
namespace Amazon.CloudSearchDomain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuggestModelUnmarshaller : IJsonUnmarshaller<SuggestModel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SuggestModel Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("suggestions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SuggestionMatch, SuggestionMatchUnmarshaller>(SuggestionMatchUnmarshaller.Instance);
                    unmarshalledObject.Suggestions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
