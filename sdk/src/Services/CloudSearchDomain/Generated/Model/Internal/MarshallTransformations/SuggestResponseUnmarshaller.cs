...
namespace Amazon.CloudSearchDomain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuggestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("suggest", targetDepth, ref reader))
                {
                    var unmarshaller = SuggestModelUnmarshaller.Instance;
                    response.Suggest = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return SearchExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static SuggestResponseUnmarshaller _instance = new SuggestResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SuggestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
