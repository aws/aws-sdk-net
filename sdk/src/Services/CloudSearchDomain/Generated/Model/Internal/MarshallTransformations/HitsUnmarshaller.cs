...
namespace Amazon.CloudSearchDomain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HitsUnmarshaller : IJsonUnmarshaller<Hits, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Hits Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
