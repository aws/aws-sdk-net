...
{
    /// <summary>
    /// Response Unmarshaller for GetSolutionMetrics operation
    /// </summary>  
    public class GetSolutionMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSolutionMetricsResponse response = new GetSolutionMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("solutionVersionArn", targetDepth))
                {
                    ...
                    response.SolutionVersionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSolutionMetricsResponseUnmarshaller _instance = new GetSolutionMetricsResponseUnmarshaller();        

        internal static GetSolutionMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolutionMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
