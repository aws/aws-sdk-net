...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterSummaryUnmarshaller : IJsonUnmarshaller<FilterSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("filterArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FilterArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
