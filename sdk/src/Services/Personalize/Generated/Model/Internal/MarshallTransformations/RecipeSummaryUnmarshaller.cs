...
{
    /// <summary>
    /// Response Unmarshaller for RecipeSummary Object
    /// </summary>  
    public class RecipeSummaryUnmarshaller : IJsonUnmarshaller<RecipeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecipeSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("recipeArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static RecipeSummaryUnmarshaller _instance = new RecipeSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RecipeSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
