...
{
    /// <summary>
    /// Response Unmarshaller for ListMetricAttributions operation
    /// </summary>  
    public class ListMetricAttributionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMetricAttributionsResponse response = new ListMetricAttributionsResponse();
            ...
            {
                if (context.TestExpression("metricAttributions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MetricAttributionSummary, MetricAttributionSummaryUnmarshaller>(MetricAttributionSummaryUnmarshaller.Instance);
                    response.MetricAttributions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListMetricAttributionsResponseUnmarshaller _instance = new ListMetricAttributionsResponseUnmarshaller();        

        internal static ListMetricAttributionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMetricAttributionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
