...
{
    /// <summary>
    /// Response Unmarshaller for CreateBatchSegmentJob operation
    /// </summary>  
    public class CreateBatchSegmentJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBatchSegmentJobResponse response = new CreateBatchSegmentJobResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("batchSegmentJobArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BatchSegmentJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateBatchSegmentJobResponseUnmarshaller _instance = new CreateBatchSegmentJobResponseUnmarshaller();        

        internal static CreateBatchSegmentJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBatchSegmentJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
