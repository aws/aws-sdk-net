...
{
    /// <summary>
    /// Response Unmarshaller for CreateDatasetImportJob operation
    /// </summary>  
    public class CreateDatasetImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDatasetImportJobResponse response = new CreateDatasetImportJobResponse();
        ...
        private static CreateDatasetImportJobResponseUnmarshaller _instance = new CreateDatasetImportJobResponseUnmarshaller();        

        internal static CreateDatasetImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDatasetImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
