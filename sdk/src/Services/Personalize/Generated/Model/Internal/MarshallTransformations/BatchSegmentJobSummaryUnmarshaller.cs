...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchSegmentJobSummaryUnmarshaller : IUnmarshaller<BatchSegmentJobSummary, XmlUnmarshallerContext>, IUnmarshaller<BatchSegmentJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BatchSegmentJobSummary IUnmarshaller<BatchSegmentJobSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public BatchSegmentJobSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
