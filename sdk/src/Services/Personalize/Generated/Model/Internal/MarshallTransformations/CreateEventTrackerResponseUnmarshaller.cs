...
{
    /// <summary>
    /// Response Unmarshaller for CreateEventTracker operation
    /// </summary>  
    public class CreateEventTrackerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEventTrackerResponse response = new CreateEventTrackerResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("eventTrackerArn", targetDepth))
                {
                    ...
                    response.EventTrackerArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("trackingId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TrackingId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateEventTrackerResponseUnmarshaller _instance = new CreateEventTrackerResponseUnmarshaller();        

        internal static CreateEventTrackerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventTrackerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
