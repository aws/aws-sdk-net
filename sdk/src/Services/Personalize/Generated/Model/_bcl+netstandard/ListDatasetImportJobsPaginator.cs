...
namespace Amazon.Personalize.Model
{
    ...
    internal sealed partial class ListDatasetImportJobsPaginator : IPaginator<ListDatasetImportJobsResponse>, IListDatasetImportJobsPaginator
    {
        ...
        public IPaginatedEnumerable<DatasetImportJobSummary> DatasetImportJobs => 
            new PaginatedResultKeyResponse<ListDatasetImportJobsResponse, DatasetImportJobSummary>(this, (i) => i.DatasetImportJobs ?? new List<DatasetImportJobSummary>());
        ...
        async IAsyncEnumerable<ListDatasetImportJobsResponse> IPaginator<ListDatasetImportJobsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
