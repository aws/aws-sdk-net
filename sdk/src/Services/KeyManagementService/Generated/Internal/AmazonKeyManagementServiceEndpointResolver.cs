...
namespace Amazon.KeyManagementService.Internal
{
    /// <summary>
    ...
    /// </summary>
    public class AmazonKeyManagementServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonKeyManagementServiceConfig)requestContext.ClientConfig;
            var result = new KeyManagementServiceEndpointParameters();
