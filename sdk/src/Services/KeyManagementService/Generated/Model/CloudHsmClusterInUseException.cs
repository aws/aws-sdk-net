...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class CloudHsmClusterInUseException : AmazonKeyManagementServiceException
    {
        ...
        public CloudHsmClusterInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudHsmClusterInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
