...
namespace Amazon.KeyManagementService.Model
{
    ...
    internal sealed partial class ListGrantsPaginator : IPaginator<ListGrantsResponse>, IListGrantsPaginator
    {
        ...
        public IPaginatedEnumerable<GrantListEntry> Grants => 
            new PaginatedResultKeyResponse<ListGrantsResponse, GrantListEntry>(this, (i) => i.Grants ?? new List<GrantListEntry>());
        ...
        async IAsyncEnumerable<ListGrantsResponse> IPaginator<ListGrantsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
