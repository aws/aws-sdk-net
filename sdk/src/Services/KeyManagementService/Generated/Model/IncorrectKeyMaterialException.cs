...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class IncorrectKeyMaterialException : AmazonKeyManagementServiceException
    {
        ...
        public IncorrectKeyMaterialException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IncorrectKeyMaterialException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
