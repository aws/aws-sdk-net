...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SignRequestMarshaller : IMarshaller<IRequest, SignRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SignRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SignRequest publicRequest)
        {
        ...
        private static SignRequestMarshaller _instance = new SignRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SignRequestMarshaller Instance
        {
            get
            {
                return _instance;
