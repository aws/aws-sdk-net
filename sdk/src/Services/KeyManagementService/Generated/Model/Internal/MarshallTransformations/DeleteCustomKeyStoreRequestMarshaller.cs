...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteCustomKeyStoreRequestMarshaller : IMarshaller<IRequest, DeleteCustomKeyStoreRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCustomKeyStoreRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCustomKeyStoreRequest publicRequest)
        {
        ...
        private static DeleteCustomKeyStoreRequestMarshaller _instance = new DeleteCustomKeyStoreRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomKeyStoreRequestMarshaller Instance
        {
            get
            {
                return _instance;
