...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RevokeGrantRequestMarshaller : IMarshaller<IRequest, RevokeGrantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RevokeGrantRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RevokeGrantRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KeyManagementService");
            string target = "TrentService.RevokeGrant";
            ...
            if(publicRequest.IsSetGrantId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.GrantId);
            }
        ...
        private static RevokeGrantRequestMarshaller _instance = new RevokeGrantRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeGrantRequestMarshaller Instance
        {
            get
            {
                return _instance;
