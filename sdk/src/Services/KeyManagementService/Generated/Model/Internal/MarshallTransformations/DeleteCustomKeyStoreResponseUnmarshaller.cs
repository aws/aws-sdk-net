...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteCustomKeyStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCustomKeyStoreResponse response = new DeleteCustomKeyStoreResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("CustomKeyStoreHasCMKsException"))
            {
                return new CustomKeyStoreHasCMKsException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DeleteCustomKeyStoreResponseUnmarshaller _instance = new DeleteCustomKeyStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomKeyStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
