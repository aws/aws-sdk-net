    ...
    public class VerifyMacResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MacAlgorithm = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("MacValid", targetDepth))
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.MacValid = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return KMSInvalidMacExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
