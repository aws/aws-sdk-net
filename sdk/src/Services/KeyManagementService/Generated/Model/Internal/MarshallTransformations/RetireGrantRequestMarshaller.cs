    ...
    public class RetireGrantRequestMarshaller : IMarshaller<IRequest, RetireGrantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(RetireGrantRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetGrantToken())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.GrantToken);
            }
        ...
        private static RetireGrantRequestMarshaller _instance = new RetireGrantRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetireGrantRequestMarshaller Instance
        {
            get
            {
                return _instance;
