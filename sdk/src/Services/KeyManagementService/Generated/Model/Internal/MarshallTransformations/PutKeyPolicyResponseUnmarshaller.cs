...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutKeyPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutKeyPolicyResponse response = new PutKeyPolicyResponse();
        ...
        private static PutKeyPolicyResponseUnmarshaller _instance = new PutKeyPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutKeyPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
