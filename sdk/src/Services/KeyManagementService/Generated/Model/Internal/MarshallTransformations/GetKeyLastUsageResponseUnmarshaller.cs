...
{
    /// <summary>
    /// Response Unmarshaller for GetKeyLastUsage operation
    /// </summary>  
    public class GetKeyLastUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKeyLastUsageResponse response = new GetKeyLastUsageResponse();
        ...
        private static GetKeyLastUsageResponseUnmarshaller _instance = new GetKeyLastUsageResponseUnmarshaller();        

        internal static GetKeyLastUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKeyLastUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
