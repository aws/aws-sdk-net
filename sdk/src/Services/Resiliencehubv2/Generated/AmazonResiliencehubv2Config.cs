...
{
    /// <summary>
    /// Configuration for accessing Amazon Resiliencehubv2 service
    /// </summary>
    public partial class AmazonResiliencehubv2Config : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("resiliencehubv2", "4.0.101.0");
        ...
        /// Default constructor
        /// </summary>
        public AmazonResiliencehubv2Config()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonResiliencehubv2DefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "resiliencehubv2";
            this.AuthenticationServiceName = "resiliencehub";
            this.EndpointProvider = new AmazonResiliencehubv2EndpointProvider();
        }
