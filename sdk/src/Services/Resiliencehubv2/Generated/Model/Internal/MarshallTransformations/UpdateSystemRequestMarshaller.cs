...
{
    /// <summary>
    /// UpdateSystem Request Marshaller
    /// </summary>       
    public class UpdateSystemRequestMarshaller : IMarshaller<IRequest, UpdateSystemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSystemRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSystemRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/update-system";
#if !NETFRAMEWORK
        ...
        private static UpdateSystemRequestMarshaller _instance = new UpdateSystemRequestMarshaller();        

        internal static UpdateSystemRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSystemRequestMarshaller Instance
        {
            get
            {
                return _instance;
