...
{
    /// <summary>
    /// Response Unmarshaller for ListServiceEvents operation
    /// </summary>  
    public class ListServiceEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListServiceEventsResponse response = new ListServiceEventsResponse();
        ...
        private static ListServiceEventsResponseUnmarshaller _instance = new ListServiceEventsResponseUnmarshaller();        

        internal static ListServiceEventsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
