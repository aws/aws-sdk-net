...
{
    /// <summary>
    /// Response Unmarshaller for TestRunPolicySnapshot Object
    /// </summary>  
    public class TestRunPolicySnapshotUnmarshaller : IJsonUnmarshaller<TestRunPolicySnapshot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TestRunPolicySnapshot Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TestRunPolicySnapshot unmarshalledObject = new TestRunPolicySnapshot();
        ...
        private static TestRunPolicySnapshotUnmarshaller _instance = new TestRunPolicySnapshotUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TestRunPolicySnapshotUnmarshaller Instance
        {
            get
            {
                return _instance;
