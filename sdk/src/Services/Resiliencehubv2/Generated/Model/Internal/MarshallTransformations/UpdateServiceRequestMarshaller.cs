...
namespace Amazon.Resiliencehubv2.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateServiceRequestMarshaller : IMarshaller<IRequest, UpdateServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateServiceRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/update-service";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetDependencyDiscovery())
            {
                context.Writer.WritePropertyName("dependencyDiscovery");
                context.Writer.WriteStringValue(publicRequest.DependencyDiscovery);
            }
            ...
            if(publicRequest.IsSetReportConfiguration())
            {
                ...
                var marshaller = ServiceReportConfigurationMarshaller.Instance;
