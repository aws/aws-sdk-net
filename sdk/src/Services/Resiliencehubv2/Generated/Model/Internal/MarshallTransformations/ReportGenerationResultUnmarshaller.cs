...
{
    /// <summary>
    /// Response Unmarshaller for ReportGenerationResult Object
    /// </summary>  
    public class ReportGenerationResultUnmarshaller : IJsonUnmarshaller<ReportGenerationResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReportGenerationResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ReportGenerationResult unmarshalledObject = new ReportGenerationResult();
        ...
        private static ReportGenerationResultUnmarshaller _instance = new ReportGenerationResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReportGenerationResultUnmarshaller Instance
        {
            get
            {
                return _instance;
