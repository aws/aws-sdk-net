...
{
    /// <summary>
    /// Response Unmarshaller for ServiceFunction Object
    /// </summary>  
    public class ServiceFunctionUnmarshaller : IJsonUnmarshaller<ServiceFunction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceFunction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ServiceFunction unmarshalledObject = new ServiceFunction();
        ...
        private static ServiceFunctionUnmarshaller _instance = new ServiceFunctionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ServiceFunctionUnmarshaller Instance
        {
            get
            {
                return _instance;
