...
{
    /// <summary>
    /// Response Unmarshaller for TestRunDependencySummary Object
    /// </summary>  
    public class TestRunDependencySummaryUnmarshaller : IJsonUnmarshaller<TestRunDependencySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TestRunDependencySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TestRunDependencySummary unmarshalledObject = new TestRunDependencySummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dependencyId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DependencyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("dependencyName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("sourceRegions", targetDepth, ref reader))
                {
        ...
        private static TestRunDependencySummaryUnmarshaller _instance = new TestRunDependencySummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TestRunDependencySummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
