...
{
    /// <summary>
    /// CreateTest Request Marshaller
    /// </summary>       
    public class CreateTestRequestMarshaller : IMarshaller<IRequest, CreateTestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTestRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTestRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/create-test";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetStopConditions())
            {
                ...
                foreach(var publicRequestStopConditionsListValue in publicRequest.StopConditions)
                {
                    ...
                    var marshaller = StopConditionMarshaller.Instance;
            ...
            {
                context.Writer.WritePropertyName("testTemplateArn");
                context.Writer.WriteStringValue(publicRequest.TestTemplateArn);
            }
        ...
        private static CreateTestRequestMarshaller _instance = new CreateTestRequestMarshaller();        

        internal static CreateTestRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTestRequestMarshaller Instance
        {
            get
            {
                return _instance;
