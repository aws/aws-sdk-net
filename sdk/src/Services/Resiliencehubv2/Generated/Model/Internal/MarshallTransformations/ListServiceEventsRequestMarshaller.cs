...
{
    /// <summary>
    /// ListServiceEvents Request Marshaller
    /// </summary>       
    public class ListServiceEventsRequestMarshaller : IMarshaller<IRequest, ListServiceEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListServiceEventsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListServiceEventsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/list-service-events";
            request.UseQueryString = true;

            return request;
        }
        private static ListServiceEventsRequestMarshaller _instance = new ListServiceEventsRequestMarshaller();        

        internal static ListServiceEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
