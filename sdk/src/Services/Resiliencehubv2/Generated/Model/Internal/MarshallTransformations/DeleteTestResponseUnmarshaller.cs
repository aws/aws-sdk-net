...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTest operation
    /// </summary>  
    public class DeleteTestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteTestResponseUnmarshaller _instance = new DeleteTestResponseUnmarshaller();        

        internal static DeleteTestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
