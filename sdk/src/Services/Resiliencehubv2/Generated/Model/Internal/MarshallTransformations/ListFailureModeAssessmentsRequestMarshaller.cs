...
{
    /// <summary>
    /// ListFailureModeAssessments Request Marshaller
    /// </summary>       
    public class ListFailureModeAssessmentsRequestMarshaller : IMarshaller<IRequest, ListFailureModeAssessmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListFailureModeAssessmentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListFailureModeAssessmentsRequest publicRequest)
        {
        ...
        private static ListFailureModeAssessmentsRequestMarshaller _instance = new ListFailureModeAssessmentsRequestMarshaller();        

        internal static ListFailureModeAssessmentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFailureModeAssessmentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
