...
namespace Amazon.Resiliencehubv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputSourceUnmarshaller : IJsonUnmarshaller<InputSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InputSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
