...
namespace Amazon.Resiliencehubv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceEventUnmarshaller : IJsonUnmarshaller<ServiceEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ServiceEvent unmarshalledObject = new ServiceEvent();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ServiceEventDetailsUnmarshaller.Instance;
        ...
        private static ServiceEventUnmarshaller _instance = new ServiceEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ServiceEventUnmarshaller Instance
        {
            get
            {
                return _instance;
