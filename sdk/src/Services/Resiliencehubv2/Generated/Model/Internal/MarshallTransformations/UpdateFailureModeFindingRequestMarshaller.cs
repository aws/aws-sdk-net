...
{
    /// <summary>
    /// UpdateFailureModeFinding Request Marshaller
    /// </summary>       
    public class UpdateFailureModeFindingRequestMarshaller : IMarshaller<IRequest, UpdateFailureModeFindingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFailureModeFindingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFailureModeFindingRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/update-failure-mode-finding";
#if !NETFRAMEWORK
        ...
        private static UpdateFailureModeFindingRequestMarshaller _instance = new UpdateFailureModeFindingRequestMarshaller();        

        internal static UpdateFailureModeFindingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFailureModeFindingRequestMarshaller Instance
        {
            get
            {
                return _instance;
