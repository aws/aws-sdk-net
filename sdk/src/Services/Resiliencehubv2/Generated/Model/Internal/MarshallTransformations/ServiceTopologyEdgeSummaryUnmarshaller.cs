...
{
    /// <summary>
    /// Response Unmarshaller for ServiceTopologyEdgeSummary Object
    /// </summary>  
    public class ServiceTopologyEdgeSummaryUnmarshaller : IJsonUnmarshaller<ServiceTopologyEdgeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceTopologyEdgeSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ServiceTopologyEdgeSummary unmarshalledObject = new ServiceTopologyEdgeSummary();
        ...
        private static ServiceTopologyEdgeSummaryUnmarshaller _instance = new ServiceTopologyEdgeSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ServiceTopologyEdgeSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
