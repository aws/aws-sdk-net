...
namespace Amazon.Resiliencehubv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetTestRequestMarshaller : IMarshaller<IRequest, GetTestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTestRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTestRequest publicRequest)
        {
            ...
            if (string.IsNullOrEmpty(publicRequest.TestId))
                throw new AmazonResiliencehubv2Exception("Request object does not have required field TestId set");
            
            if (publicRequest.IsSetTestId())
                request.Parameters.Add("testId", StringUtils.FromString(publicRequest.TestId));
            request.ResourcePath = "/v2/get-test";
