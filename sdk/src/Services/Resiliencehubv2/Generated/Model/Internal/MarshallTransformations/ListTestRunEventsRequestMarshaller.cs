...
{
    /// <summary>
    /// ListTestRunEvents Request Marshaller
    /// </summary>       
    public class ListTestRunEventsRequestMarshaller : IMarshaller<IRequest, ListTestRunEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTestRunEventsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTestRunEventsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/test-runs/{testRunId}/events";
            request.UseQueryString = true;

            return request;
        }
        private static ListTestRunEventsRequestMarshaller _instance = new ListTestRunEventsRequestMarshaller();        

        internal static ListTestRunEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTestRunEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
