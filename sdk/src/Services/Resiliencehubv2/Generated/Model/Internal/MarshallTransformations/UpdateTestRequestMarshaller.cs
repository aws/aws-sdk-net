...
{
    /// <summary>
    /// UpdateTest Request Marshaller
    /// </summary>       
    public class UpdateTestRequestMarshaller : IMarshaller<IRequest, UpdateTestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTestRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTestRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/update-test";
#if !NETFRAMEWORK
        ...
        private static UpdateTestRequestMarshaller _instance = new UpdateTestRequestMarshaller();        

        internal static UpdateTestRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTestRequestMarshaller Instance
        {
            get
            {
                return _instance;
