...
{
    /// <summary>
    /// Response Unmarshaller for UserJourneyChanges Object
    /// </summary>  
    public class UserJourneyChangesUnmarshaller : IJsonUnmarshaller<UserJourneyChanges, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UserJourneyChanges Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            UserJourneyChanges unmarshalledObject = new UserJourneyChanges();
        ...
        private static UserJourneyChangesUnmarshaller _instance = new UserJourneyChangesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static UserJourneyChangesUnmarshaller Instance
        {
            get
            {
                return _instance;
