...
{
    /// <summary>
    /// Response Unmarshaller for ImportApp operation
    /// </summary>  
    public class ImportAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportAppResponse response = new ImportAppResponse();
        ...
        private static ImportAppResponseUnmarshaller _instance = new ImportAppResponseUnmarshaller();        

        internal static ImportAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
