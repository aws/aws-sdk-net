...
{
    /// <summary>
    /// ListAssertions Request Marshaller
    /// </summary>       
    public class ListAssertionsRequestMarshaller : IMarshaller<IRequest, ListAssertionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAssertionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAssertionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/list-assertions";
            request.UseQueryString = true;

            return request;
        }
        private static ListAssertionsRequestMarshaller _instance = new ListAssertionsRequestMarshaller();        

        internal static ListAssertionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssertionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
