...
{
    /// <summary>
    /// Response Unmarshaller for TestRunSourceEvent Object
    /// </summary>  
    public class TestRunSourceEventUnmarshaller : IJsonUnmarshaller<TestRunSourceEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TestRunSourceEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TestRunSourceEvent unmarshalledObject = new TestRunSourceEvent();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TestRunSourceEventDetailUnmarshaller.Instance;
        ...
        private static TestRunSourceEventUnmarshaller _instance = new TestRunSourceEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TestRunSourceEventUnmarshaller Instance
        {
            get
            {
                return _instance;
