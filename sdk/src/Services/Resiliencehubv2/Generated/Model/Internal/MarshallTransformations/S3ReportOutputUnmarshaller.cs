...
namespace Amazon.Resiliencehubv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ReportOutputUnmarshaller : IJsonUnmarshaller<S3ReportOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3ReportOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
