...
{
    /// <summary>
    /// DeleteServiceFunctionResources Request Marshaller
    /// </summary>       
    public class DeleteServiceFunctionResourcesRequestMarshaller : IMarshaller<IRequest, DeleteServiceFunctionResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteServiceFunctionResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteServiceFunctionResourcesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/delete-service-function-resources";
#if !NETFRAMEWORK
        ...
        private static DeleteServiceFunctionResourcesRequestMarshaller _instance = new DeleteServiceFunctionResourcesRequestMarshaller();        

        internal static DeleteServiceFunctionResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServiceFunctionResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
