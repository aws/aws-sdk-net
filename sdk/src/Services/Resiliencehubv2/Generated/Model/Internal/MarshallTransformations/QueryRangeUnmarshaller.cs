...
{
    /// <summary>
    /// Response Unmarshaller for QueryRange Object
    /// </summary>  
    public class QueryRangeUnmarshaller : IJsonUnmarshaller<QueryRange, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QueryRange Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QueryRange unmarshalledObject = new QueryRange();
        ...
        private static QueryRangeUnmarshaller _instance = new QueryRangeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QueryRangeUnmarshaller Instance
        {
            get
            {
                return _instance;
