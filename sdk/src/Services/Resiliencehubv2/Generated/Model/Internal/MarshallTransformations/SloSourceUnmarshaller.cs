...
{
    /// <summary>
    /// Response Unmarshaller for SloSource Object
    /// </summary>  
    public class SloSourceUnmarshaller : IJsonUnmarshaller<SloSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SloSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SloSource unmarshalledObject = new SloSource();
        ...
        private static SloSourceUnmarshaller _instance = new SloSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SloSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
