...
{
    /// <summary>
    /// Identifies a monitoring source to add to or remove from a test. Exactly one member
    /// is set.
    /// </summary>
    public partial class TestSourceInput
    {
        private ObservabilityAlarmInput _observabilityAlarm;
        private SuccessCriteriaAlarmInput _successCriteriaAlarm;
        ...
        /// </para>
        /// </summary>
        public ObservabilityAlarmInput ObservabilityAlarm
        {
        ...
        /// </para>
        /// </summary>
        public SuccessCriteriaAlarmInput SuccessCriteriaAlarm
        {
