...
{
    /// <summary>
    /// Container for the parameters to the ListTestRunSources operation.
    /// Lists the monitoring source snapshots captured for a test run, optionally filtered
    /// by type.
    /// </summary>
    public partial class ListTestRunSourcesRequest : AmazonResiliencehubv2Request
    {
        private int? _maxResults;
        private string _nextToken;
        private string _serviceArn;
        private string _testRunId;
        private TestRunSourceType _type;
