...
{
    /// <summary>
    /// Container for the parameters to the ListTestSources operation.
    /// Lists the monitoring sources attached to a test, optionally filtered by type.
    /// </summary>
    public partial class ListTestSourcesRequest : AmazonResiliencehubv2Request
    {
        private int? _maxResults;
        private string _nextToken;
        private string _serviceArn;
        private string _testId;
        private TestSourceType _type;
