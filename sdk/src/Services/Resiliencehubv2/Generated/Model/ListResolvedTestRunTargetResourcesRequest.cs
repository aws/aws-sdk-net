...
{
    /// <summary>
    /// Container for the parameters to the ListResolvedTestRunTargetResources operation.
    /// Lists the AWS resources that AWS Fault Injection Service (AWS FIS) resolved as targets
    /// for a test run.
    /// </summary>
    public partial class ListResolvedTestRunTargetResourcesRequest : AmazonResiliencehubv2Request
    {
