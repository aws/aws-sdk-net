...
{
    /// <summary>
    /// This is the response object from the ListFailureModeAssessments operation.
    /// </summary>
    public partial class ListFailureModeAssessmentsResponse : AmazonWebServiceResponse
    {
        private List<AssessmentSummary> _assessmentSummaries = AWSConfigs.InitializeCollections ? new List<AssessmentSummary>() : null;
        ...
        public List<AssessmentSummary> AssessmentSummaries
        {
