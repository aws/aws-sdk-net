...
{
    /// <summary>
    /// This is the response object from the ListFailureModeFindings operation.
    /// </summary>
    public partial class ListFailureModeFindingsResponse : AmazonWebServiceResponse
    {
        private List<FindingSummary> _findingsSummary = AWSConfigs.InitializeCollections ? new List<FindingSummary>() : null;
        ...
        public List<FindingSummary> FindingsSummary
        {
