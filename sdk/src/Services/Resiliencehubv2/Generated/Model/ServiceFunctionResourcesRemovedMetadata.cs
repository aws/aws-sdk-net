...
namespace Amazon.Resiliencehubv2.Model
{
    ...
    /// </summary>
    public partial class ServiceFunctionResourcesRemovedMetadata
    {
        private List<string> _resourcesRemoved = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private string _serviceFunctionId;
        private string _serviceFunctionName;

        /// <summary>
        /// Gets and sets the property ResourcesRemoved. 
        /// <para>
        ...
        /// </summary>
        public List<string> ResourcesRemoved
        {
            get { return this._resourcesRemoved; }
            set { this._resourcesRemoved = value; }
        }

        // Check to see if ResourcesRemoved property is set
        internal bool IsSetResourcesRemoved()
        {
            return this._resourcesRemoved != null && (this._resourcesRemoved.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
