...
{
    /// <summary>
    /// This is the response object from the ListAssertions operation.
    /// </summary>
    public partial class ListAssertionsResponse : AmazonWebServiceResponse
    {
        private List<Assertion> _assertions = AWSConfigs.InitializeCollections ? new List<Assertion>() : null;
