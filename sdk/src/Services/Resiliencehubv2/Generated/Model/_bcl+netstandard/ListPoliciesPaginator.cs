...
namespace Amazon.Resiliencehubv2.Model
{
    ...
    internal sealed partial class ListPoliciesPaginator : IPaginator<ListPoliciesResponse>, IListPoliciesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<PolicySummary> PolicySummaries => 
            new PaginatedResultKeyResponse<ListPoliciesResponse, PolicySummary>(this, (i) => i.PolicySummaries ?? new List<PolicySummary>());

        internal ListPoliciesPaginator(IAmazonResiliencehubv2 client, ListPoliciesRequest request)
        {
            this._client = client;
