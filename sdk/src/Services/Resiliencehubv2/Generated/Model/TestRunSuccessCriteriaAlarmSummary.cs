...
namespace Amazon.Resiliencehubv2.Model
{
    ...
    /// </summary>
    public partial class TestRunSuccessCriteriaAlarmSummary
    {
        private string _accountId;
        private string _alarmArn;
        private string _alarmName;
        private TestSourceOutcome _outcome;
        ...
        /// <para>
        /// The evaluation outcome of the source. Absent while the source has not yet been evaluated;
        /// set to the terminal outcome afterwards.
        /// </para>
        /// </summary>
        public TestSourceOutcome Outcome
        {
        ...
        /// <summary>
        /// Gets and sets the property OutcomeReason. 
        /// <para>
        ...
        {
            get { return this._outcomeReason; }
            set { this._outcomeReason = value; }
        }

        // Check to see if OutcomeReason property is set
        internal bool IsSetOutcomeReason()
        {
            return this._outcomeReason != null;
        }
