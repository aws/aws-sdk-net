...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    public class WorkspaceConfigurationDescriptionUnmarshaller : IJsonUnmarshaller<WorkspaceConfigurationDescription, JsonUnmarshallerContext>
    {
        ...
        public WorkspaceConfigurationDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("limitsPerLabelSet", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("outOfOrderTimeWindowInSeconds", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.OutOfOrderTimeWindowInSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ruleQueryOffsetInSeconds", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.RuleQueryOffsetInSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
