...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlertManagerDefinitionStatusUnmarshaller : IJsonUnmarshaller<AlertManagerDefinitionStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AlertManagerDefinitionStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
