...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetDefaultScraperConfigurationRequestMarshaller : IMarshaller<IRequest, GetDefaultScraperConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetDefaultScraperConfigurationRequestMarshaller _instance = new GetDefaultScraperConfigurationRequestMarshaller();        

        internal static GetDefaultScraperConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDefaultScraperConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
