...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RandomCutForestConfigurationUnmarshaller : IJsonUnmarshaller<RandomCutForestConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RandomCutForestConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
