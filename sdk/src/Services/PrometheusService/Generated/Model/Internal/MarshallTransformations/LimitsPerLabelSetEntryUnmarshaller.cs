...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LimitsPerLabelSetEntryUnmarshaller : IJsonUnmarshaller<LimitsPerLabelSetEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LimitsPerLabelSetEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("maxSeries", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.MaxSeries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
