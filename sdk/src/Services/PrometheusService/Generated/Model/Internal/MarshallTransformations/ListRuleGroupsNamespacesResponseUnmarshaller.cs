    ...
    public class ListRuleGroupsNamespacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ruleGroupsNamespaces", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RuleGroupsNamespaceSummary, RuleGroupsNamespaceSummaryUnmarshaller>(RuleGroupsNamespaceSummaryUnmarshaller.Instance);
                    response.RuleGroupsNamespaces = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
