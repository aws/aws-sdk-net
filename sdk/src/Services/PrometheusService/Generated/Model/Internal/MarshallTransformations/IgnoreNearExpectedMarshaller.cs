...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class IgnoreNearExpectedMarshaller : IRequestMarshaller<IgnoreNearExpected, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(IgnoreNearExpected requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRatio())
            {
                ...
                if(StringUtils.IsSpecialDoubleValue(requestObject.Ratio))
                {
                    context.Writer.Write(StringUtils.FromSpecialDoubleValue(requestObject.Ratio));
                }
                else
                {
                    context.Writer.Write(requestObject.Ratio);
                }
            }
