...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnomalyDetectorConfigurationUnmarshaller : IJsonUnmarshaller<AnomalyDetectorConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnomalyDetectorConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
