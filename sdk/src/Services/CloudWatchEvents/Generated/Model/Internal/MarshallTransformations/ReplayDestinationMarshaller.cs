...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    public class ReplayDestinationMarshaller : IRequestMarshaller<ReplayDestination, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ReplayDestination requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFilterArns())
            {
                context.Writer.WritePropertyName("FilterArns");
                context.Writer.WriteStartArray();
                foreach(var requestObjectFilterArnsListValue in requestObject.FilterArns)
                {
                        context.Writer.WriteStringValue(requestObjectFilterArnsListValue);
                }
