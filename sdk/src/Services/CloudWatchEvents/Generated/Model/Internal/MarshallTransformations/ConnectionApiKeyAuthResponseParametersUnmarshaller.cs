...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionApiKeyAuthResponseParametersUnmarshaller : IUnmarshaller<ConnectionApiKeyAuthResponseParameters, XmlUnmarshallerContext>, IUnmarshaller<ConnectionApiKeyAuthResponseParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ConnectionApiKeyAuthResponseParameters IUnmarshaller<ConnectionApiKeyAuthResponseParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ConnectionApiKeyAuthResponseParameters Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ApiKeyName", targetDepth))
                {
                    ...
                    unmarshalledObject.ApiKeyName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
