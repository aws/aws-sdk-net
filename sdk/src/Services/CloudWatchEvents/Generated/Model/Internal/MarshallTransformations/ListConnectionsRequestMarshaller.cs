...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    public class ListConnectionsRequestMarshaller : IMarshaller<IRequest, ListConnectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListConnectionsRequest publicRequest)
        {
            ...
            string target = "AWSEvents.ListConnections";
            ...
            if(publicRequest.IsSetConnectionState())
            {
                context.Writer.WritePropertyName("ConnectionState");
                context.Writer.WriteStringValue(publicRequest.ConnectionState);
            }
