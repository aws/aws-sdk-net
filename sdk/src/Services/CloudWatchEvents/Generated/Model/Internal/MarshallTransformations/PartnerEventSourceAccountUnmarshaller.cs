...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PartnerEventSourceAccountUnmarshaller : IJsonUnmarshaller<PartnerEventSourceAccount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PartnerEventSourceAccount Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
