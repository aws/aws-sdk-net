...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    public class SageMakerPipelineParametersMarshaller : IRequestMarshaller<SageMakerPipelineParameters, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(SageMakerPipelineParameters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPipelineParameterList())
            {
                ...
                foreach(var requestObjectPipelineParameterListListValue in requestObject.PipelineParameterList)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = SageMakerPipelineParameterMarshaller.Instance;
                    marshaller.Marshall(requestObjectPipelineParameterListListValue, context);
