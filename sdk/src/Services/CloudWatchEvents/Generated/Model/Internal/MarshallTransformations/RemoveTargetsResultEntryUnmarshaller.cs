...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveTargetsResultEntryUnmarshaller : IJsonUnmarshaller<RemoveTargetsResultEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RemoveTargetsResultEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
