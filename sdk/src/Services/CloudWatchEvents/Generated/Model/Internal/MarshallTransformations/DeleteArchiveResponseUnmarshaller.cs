...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteArchiveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteArchiveResponseUnmarshaller _instance = new DeleteArchiveResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteArchiveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
