...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutEventsResultEntryUnmarshaller : IJsonUnmarshaller<PutEventsResultEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PutEventsResultEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
