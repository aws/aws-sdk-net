...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListRulesResponseUnmarshaller _instance = new ListRulesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
