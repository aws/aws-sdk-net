...
namespace Amazon.IoTAnalytics.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonIoTAnalyticsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTAnalyticsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTAnalytics.
        /// </summary>
        public AmazonIoTAnalyticsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTAnalyticsAuthSchemeParameters
            {
    ...
    public class AmazonIoTAnalyticsAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTAnalyticsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTAnalyticsAuthSchemeParameters authParameters)
        {
