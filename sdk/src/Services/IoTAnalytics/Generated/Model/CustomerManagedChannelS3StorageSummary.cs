...
namespace Amazon.IoTAnalytics.Model
{
    ...
    public partial class CustomerManagedChannelS3StorageSummary
    {
        ...
        /// <para>
        /// The prefix used to create the keys of the channel data objects. Each object in an
        /// Amazon S3 bucket has a key that is its unique identifier within the bucket (each object
