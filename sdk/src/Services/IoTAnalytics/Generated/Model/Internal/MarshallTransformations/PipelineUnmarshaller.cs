    ...
    public class PipelineUnmarshaller : IJsonUnmarshaller<Pipeline, JsonUnmarshallerContext>
    {
        ...
        public Pipeline Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PipelineActivity, PipelineActivityUnmarshaller>(PipelineActivityUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ReprocessingSummary, ReprocessingSummaryUnmarshaller>(ReprocessingSummaryUnmarshaller.Instance);
                    unmarshalledObject.ReprocessingSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
