...
namespace Amazon.IoTAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatastoreIotSiteWiseMultiLayerStorageSummaryUnmarshaller : IJsonUnmarshaller<DatastoreIotSiteWiseMultiLayerStorageSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatastoreIotSiteWiseMultiLayerStorageSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("customerManagedS3Storage", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomerManagedS3Storage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
