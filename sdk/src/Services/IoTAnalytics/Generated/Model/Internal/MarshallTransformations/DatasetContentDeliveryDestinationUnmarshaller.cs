...
namespace Amazon.IoTAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatasetContentDeliveryDestinationUnmarshaller : IJsonUnmarshaller<DatasetContentDeliveryDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatasetContentDeliveryDestination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("iotEventsDestinationConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.IotEventsDestinationConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
