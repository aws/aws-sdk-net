...
{
    /// <summary>
    /// Response Unmarshaller for CreateDatastore operation
    /// </summary>  
    public class CreateDatastoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDatastoreResponse response = new CreateDatastoreResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("datastoreArn", targetDepth))
                {
                    ...
                    response.DatastoreArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("datastoreName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DatastoreName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateDatastoreResponseUnmarshaller _instance = new CreateDatastoreResponseUnmarshaller();        

        internal static CreateDatastoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDatastoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
