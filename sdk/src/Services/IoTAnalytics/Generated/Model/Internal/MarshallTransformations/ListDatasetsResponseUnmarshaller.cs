    ...
    public class ListDatasetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DatasetSummary, DatasetSummaryUnmarshaller>(DatasetSummaryUnmarshaller.Instance);
                    response.DatasetSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
