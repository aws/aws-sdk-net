    ...
    public class ListDatasetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DatasetSummary, DatasetSummaryUnmarshaller>(DatasetSummaryUnmarshaller.Instance);
                    response.DatasetSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
