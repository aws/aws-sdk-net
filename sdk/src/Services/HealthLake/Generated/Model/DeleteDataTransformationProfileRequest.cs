...
{
    /// <summary>
    /// Container for the parameters to the DeleteDataTransformationProfile operation.
    /// Deletes a data transformation profile and all its versions, including the DRAFT and
    /// all published versions.
    /// </summary>
    public partial class DeleteDataTransformationProfileRequest : AmazonHealthLakeRequest
    {
