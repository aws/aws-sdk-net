...
{
    /// <summary>
    /// The Amazon S3 output configuration for a data transformation job, including the output
    /// location and encryption settings.
    /// </summary>
    public partial class DataTransformationS3Configuration
    {
