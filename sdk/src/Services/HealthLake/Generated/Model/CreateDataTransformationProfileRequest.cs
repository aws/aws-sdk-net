...
{
    /// <summary>
    /// Container for the parameters to the CreateDataTransformationProfile operation.
    ...
    /// </summary>
    public partial class CreateDataTransformationProfileRequest : AmazonHealthLakeRequest
    {
        private string _clientToken;
        private string _kmsKeyId;
        private string _profileDescription;
        private string _profileName;
        private CreateDataTransformationProfileSource _source;
        ...
        /// <para>
        /// The source for the initial profile content. Specify a built-in starter profile, an
        /// existing profile version to clone, raw profile content for CI/CD workflows, or a sample
        /// data file in Amazon S3.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public CreateDataTransformationProfileSource Source
        {
        ...
        /// <para>
        /// The source data format that this profile converts from (Consolidated Clinical Document
        /// Architecture (C-CDA) or Comma-separated values (CSV)).
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
