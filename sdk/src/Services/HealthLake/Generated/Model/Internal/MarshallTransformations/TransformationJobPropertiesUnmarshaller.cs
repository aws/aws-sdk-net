...
{
    /// <summary>
    /// Response Unmarshaller for TransformationJobProperties Object
    /// </summary>  
    public class TransformationJobPropertiesUnmarshaller : IJsonUnmarshaller<TransformationJobProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TransformationJobProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TransformationJobProperties unmarshalledObject = new TransformationJobProperties();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DriftDetectionEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.DriftDetectionEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = TransformationInputDataConfigUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = TransformationJobProgressReportUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = TransformationOutputDataConfigUnmarshaller.Instance;
                ...
                if (context.TestExpression("ProvenanceEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.ProvenanceEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static TransformationJobPropertiesUnmarshaller _instance = new TransformationJobPropertiesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TransformationJobPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
