    ...
    public class ProfileConfigurationMarshaller : IRequestMarshaller<ProfileConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ProfileConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetDefaultProfiles())
            {
                context.Writer.WritePropertyName("DefaultProfiles");
                context.Writer.WriteStartArray();
                foreach(var requestObjectDefaultProfilesListValue in requestObject.DefaultProfiles)
                {
                        context.Writer.WriteStringValue(requestObjectDefaultProfilesListValue);
                }
