...
{
    /// <summary>
    /// ListDataTransformationJobs Request Marshaller
    /// </summary>       
    public class ListDataTransformationJobsRequestMarshaller : IMarshaller<IRequest, ListDataTransformationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDataTransformationJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDataTransformationJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.HealthLake");
            string target = "HealthLake.ListDataTransformationJobs";
        ...
        private static ListDataTransformationJobsRequestMarshaller _instance = new ListDataTransformationJobsRequestMarshaller();        

        internal static ListDataTransformationJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDataTransformationJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
