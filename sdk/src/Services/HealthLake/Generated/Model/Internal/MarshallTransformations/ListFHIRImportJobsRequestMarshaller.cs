...
{
    /// <summary>
    /// ListFHIRImportJobs Request Marshaller
    /// </summary>       
    public class ListFHIRImportJobsRequestMarshaller : IMarshaller<IRequest, ListFHIRImportJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListFHIRImportJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListFHIRImportJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.HealthLake");
            string target = "HealthLake.ListFHIRImportJobs";
        ...
        private static ListFHIRImportJobsRequestMarshaller _instance = new ListFHIRImportJobsRequestMarshaller();        

        internal static ListFHIRImportJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFHIRImportJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
