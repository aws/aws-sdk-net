...
namespace Amazon.HealthLake.Model
{
    ...
    public partial class ProfileConfiguration
    {
        ...
        {
            get { return this._defaultProfiles; }
            set { this._defaultProfiles = value; }
        }

        // Check to see if DefaultProfiles property is set
        internal bool IsSetDefaultProfiles()
        {
            return this._defaultProfiles != null && (this._defaultProfiles.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
