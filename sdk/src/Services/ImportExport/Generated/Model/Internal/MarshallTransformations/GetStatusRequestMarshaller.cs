...
{
    /// <summary>
    /// GetStatus Request Marshaller
    /// </summary>       
    public class GetStatusRequestMarshaller : IMarshaller<IRequest, GetStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetStatusRequest publicRequest)
        {
