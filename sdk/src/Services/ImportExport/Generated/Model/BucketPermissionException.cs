...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class BucketPermissionException : AmazonImportExportException
    {
        ...
        /// <summary>
        /// Default constructor for BucketPermissionException
        /// message.
        /// </summary>
        ...
        public BucketPermissionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public BucketPermissionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
