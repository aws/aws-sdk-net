...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class MalformedManifestException : AmazonImportExportException
    {
        ...
        /// <summary>
        /// Construct instance of MalformedManifestException
        /// </summary>
        ...
        public MalformedManifestException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MalformedManifestException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected MalformedManifestException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
