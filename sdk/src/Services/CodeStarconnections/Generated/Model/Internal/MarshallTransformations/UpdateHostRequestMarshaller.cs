...
{
    /// <summary>
    /// UpdateHost Request Marshaller
    /// </summary>       
    public class UpdateHostRequestMarshaller : IMarshaller<IRequest, UpdateHostRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateHostRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateHostRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeStarconnections");
            string target = "com.amazonaws.codestar.connections.CodeStar_connections_20191201.UpdateHost";
        ...
        private static UpdateHostRequestMarshaller _instance = new UpdateHostRequestMarshaller();        

        internal static UpdateHostRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHostRequestMarshaller Instance
        {
            get
            {
                return _instance;
