...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRepositoryLink operation
    /// </summary>  
    public class UpdateRepositoryLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRepositoryLinkResponse response = new UpdateRepositoryLinkResponse();
        ...
        private static UpdateRepositoryLinkResponseUnmarshaller _instance = new UpdateRepositoryLinkResponseUnmarshaller();        

        internal static UpdateRepositoryLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRepositoryLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
