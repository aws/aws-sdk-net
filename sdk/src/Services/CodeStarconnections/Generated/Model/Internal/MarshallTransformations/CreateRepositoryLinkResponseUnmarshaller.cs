...
{
    /// <summary>
    /// Response Unmarshaller for CreateRepositoryLink operation
    /// </summary>  
    public class CreateRepositoryLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRepositoryLinkResponse response = new CreateRepositoryLinkResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("RepositoryLinkInfo", targetDepth))
                {
                    ...
                    response.RepositoryLinkInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateRepositoryLinkResponseUnmarshaller _instance = new CreateRepositoryLinkResponseUnmarshaller();        

        internal static CreateRepositoryLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRepositoryLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
