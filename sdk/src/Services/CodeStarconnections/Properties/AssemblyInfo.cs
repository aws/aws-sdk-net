...
#elif PCL
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (PCL) -  AWS CodeStar connections. Public beta for Bitbucket Cloud support in AWS CodePipeline through integration with AWS CodeStar connections.")]
#elif UNITY
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (Unity) - AWS CodeStar connections. Public beta for Bitbucket Cloud support in AWS CodePipeline through integration with AWS CodeStar connections.")]
#elif NETSTANDARD13
