...
{
    /// <summary>
    /// Base class for ListCustomRoutingListeners paginators.
    /// </summary>
    internal sealed partial class ListCustomRoutingListenersPaginator : IPaginator<ListCustomRoutingListenersResponse>, IListCustomRoutingListenersPaginator
    {
...
#if BCL
        IEnumerable<ListCustomRoutingListenersResponse> IPaginator<ListCustomRoutingListenersResponse>.Paginate()
        {
            ...
            ListCustomRoutingListenersResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListCustomRoutingListeners(_request);
        ...
        async IAsyncEnumerable<ListCustomRoutingListenersResponse> IPaginator<ListCustomRoutingListenersResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
