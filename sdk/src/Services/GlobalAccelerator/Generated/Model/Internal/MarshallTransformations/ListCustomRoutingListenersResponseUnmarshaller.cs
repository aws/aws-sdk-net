...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomRoutingListeners operation
    /// </summary>  
    public class ListCustomRoutingListenersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomRoutingListenersResponse response = new ListCustomRoutingListenersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CustomRoutingListener, CustomRoutingListenerUnmarshaller>(CustomRoutingListenerUnmarshaller.Instance);
        ...
        private static ListCustomRoutingListenersResponseUnmarshaller _instance = new ListCustomRoutingListenersResponseUnmarshaller();        

        internal static ListCustomRoutingListenersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomRoutingListenersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
