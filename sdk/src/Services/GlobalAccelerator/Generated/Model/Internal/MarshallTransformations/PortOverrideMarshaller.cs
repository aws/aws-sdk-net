...
{
    /// <summary>
    /// PortOverride Marshaller
    /// </summary>
    public class PortOverrideMarshaller : IRequestMarshaller<PortOverride, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(PortOverride requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEndpointPort())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.EndpointPort.Value);
            }
        ...
        /// </summary>
        public readonly static PortOverrideMarshaller Instance = new PortOverrideMarshaller();
