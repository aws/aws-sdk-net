...
{
    /// <summary>
    /// Response Unmarshaller for ProvisionByoipCidr operation
    /// </summary>  
    public class ProvisionByoipCidrResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ProvisionByoipCidrResponse response = new ProvisionByoipCidrResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("IncorrectCidrStateException"))
            {
                return new IncorrectCidrStateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static ProvisionByoipCidrResponseUnmarshaller _instance = new ProvisionByoipCidrResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProvisionByoipCidrResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
