...
{
    /// <summary>
    /// Response Unmarshaller for ListAccelerators operation
    /// </summary>  
    public class ListAcceleratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListAcceleratorsResponseUnmarshaller _instance = new ListAcceleratorsResponseUnmarshaller();        

        internal static ListAcceleratorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAcceleratorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
