...
{
    /// <summary>
    /// Response Unmarshaller for CreateCrossAccountAttachment operation
    /// </summary>  
    public class CreateCrossAccountAttachmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCrossAccountAttachmentResponse response = new CreateCrossAccountAttachmentResponse();
        ...
        private static CreateCrossAccountAttachmentResponseUnmarshaller _instance = new CreateCrossAccountAttachmentResponseUnmarshaller();        

        internal static CreateCrossAccountAttachmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCrossAccountAttachmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
