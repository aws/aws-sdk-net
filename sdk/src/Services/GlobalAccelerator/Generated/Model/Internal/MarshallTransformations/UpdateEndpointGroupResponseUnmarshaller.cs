...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEndpointGroup operation
    /// </summary>  
    public class UpdateEndpointGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEndpointGroupResponse response = new UpdateEndpointGroupResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new EndpointGroupNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static UpdateEndpointGroupResponseUnmarshaller _instance = new UpdateEndpointGroupResponseUnmarshaller();        

        internal static UpdateEndpointGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEndpointGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
