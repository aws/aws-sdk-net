...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    public class AttachmentUnmarshaller : IJsonUnmarshaller<Attachment, JsonUnmarshallerContext>
    {
        ...
        public Attachment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AttachmentArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AttachmentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("Principals", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Principals = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
