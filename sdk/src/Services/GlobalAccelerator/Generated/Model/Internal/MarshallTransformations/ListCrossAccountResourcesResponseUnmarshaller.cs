    ...
    public class ListCrossAccountResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CrossAccountResource, CrossAccountResourceUnmarshaller>(CrossAccountResourceUnmarshaller.Instance);
                    response.CrossAccountResources = unmarshaller.Unmarshall(context);
                    continue;
                }
