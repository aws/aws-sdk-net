...
{
    /// <summary>
    /// Response Unmarshaller for DescribeListener operation
    /// </summary>  
    public class DescribeListenerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeListenerResponse response = new DescribeListenerResponse();
        ...
        private static DescribeListenerResponseUnmarshaller _instance = new DescribeListenerResponseUnmarshaller();        

        internal static DescribeListenerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeListenerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
