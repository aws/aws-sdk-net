...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AcceleratorEventUnmarshaller : IJsonUnmarshaller<AcceleratorEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AcceleratorEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
