...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ByoipCidrUnmarshaller : IJsonUnmarshaller<ByoipCidr, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ByoipCidr Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
