    ...
    public class ListByoipCidrsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ByoipCidr, ByoipCidrUnmarshaller>(ByoipCidrUnmarshaller.Instance);
                    response.ByoipCidrs = unmarshaller.Unmarshall(context);
                    continue;
                }
