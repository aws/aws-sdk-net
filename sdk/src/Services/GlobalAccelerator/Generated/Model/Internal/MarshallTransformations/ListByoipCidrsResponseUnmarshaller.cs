...
{
    /// <summary>
    /// Response Unmarshaller for ListByoipCidrs operation
    /// </summary>  
    public class ListByoipCidrsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListByoipCidrsResponse response = new ListByoipCidrsResponse();
            ...
            {
                if (context.TestExpression("ByoipCidrs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ByoipCidr, ByoipCidrUnmarshaller>(ByoipCidrUnmarshaller.Instance);
                    response.ByoipCidrs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListByoipCidrsResponseUnmarshaller _instance = new ListByoipCidrsResponseUnmarshaller();        

        internal static ListByoipCidrsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListByoipCidrsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
