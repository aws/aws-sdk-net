...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccelerator operation
    /// </summary>  
    public class CreateAcceleratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAcceleratorResponse response = new CreateAcceleratorResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AcceleratorUnmarshaller.Instance;
        ...
        private static CreateAcceleratorResponseUnmarshaller _instance = new CreateAcceleratorResponseUnmarshaller();        

        internal static CreateAcceleratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAcceleratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
