...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListListenersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListListenersResponse response = new ListListenersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Listeners", targetDepth))
                {
                    ...
                    response.Listeners = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListListenersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListListenersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
