...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteListenerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new AssociatedEndpointGroupFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
