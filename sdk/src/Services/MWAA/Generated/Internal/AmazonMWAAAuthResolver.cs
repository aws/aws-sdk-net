...
namespace Amazon.MWAA.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonMWAAAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMWAAAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MWAA.
        /// </summary>
        public AmazonMWAAAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMWAAAuthSchemeParameters
            {
    ...
    public class AmazonMWAAAuthSchemeResolver : IAuthSchemeResolver<AmazonMWAAAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMWAAAuthSchemeParameters authParameters)
        {
