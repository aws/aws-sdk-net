...
namespace Amazon.MWAA
{
    ...
    public partial class AmazonMWAAClient : AmazonServiceClient, IAmazonMWAA
    {
        ...
        /// 
        /// </summary>
        public AmazonMWAAClient() : base(new AmazonMWAAConfig()) { }
        ...
        public AmazonMWAAClient(RegionEndpoint region) : base(new AmazonMWAAConfig { RegionEndpoint = region }) { }
        ...
        public AmazonMWAAClient(AmazonMWAAConfig config) : base(config) { }
