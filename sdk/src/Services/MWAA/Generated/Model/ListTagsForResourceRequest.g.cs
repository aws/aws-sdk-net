...
{
    /// <summary>
    /// Container for the parameters to the ListTagsForResource operation. Lists the key-value
    /// tag pairs associated to the Amazon Managed Workflows for Apache Airflow (MWAA) environment.
    /// For example, <c>"Environment": "Staging"</c>.
    /// </summary>
