...
namespace Amazon.MWAA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateErrorUnmarshaller : IJsonUnmarshaller<UpdateError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UpdateError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
