...
namespace Amazon.MWAA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LastUpdateUnmarshaller : IJsonUnmarshaller<LastUpdate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LastUpdate();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LastUpdateUnmarshaller Instance => _instance;
    }
}
