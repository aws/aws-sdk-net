...
namespace Amazon.MWAA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InvokeRestApiRequestMarshaller : IMarshaller<IRequest, InvokeRestApiRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly InvokeRestApiRequestMarshaller _instance = new();

        internal static InvokeRestApiRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static InvokeRestApiRequestMarshaller Instance => _instance;
    }
}
