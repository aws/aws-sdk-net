...
namespace Amazon.MWAA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PublishMetricsRequestMarshaller : IMarshaller<IRequest, PublishMetricsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PublishMetricsRequestMarshaller _instance = new();

        internal static PublishMetricsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PublishMetricsRequestMarshaller Instance => _instance;
    }
}
