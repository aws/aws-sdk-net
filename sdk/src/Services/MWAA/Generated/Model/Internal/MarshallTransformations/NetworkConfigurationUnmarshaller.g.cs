...
namespace Amazon.MWAA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NetworkConfigurationUnmarshaller : IJsonUnmarshaller<NetworkConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new NetworkConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static NetworkConfigurationUnmarshaller Instance => _instance;
    }
}
