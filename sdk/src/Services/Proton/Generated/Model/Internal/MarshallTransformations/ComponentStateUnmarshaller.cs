...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentStateUnmarshaller : IUnmarshaller<ComponentState, XmlUnmarshallerContext>, IUnmarshaller<ComponentState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ComponentState IUnmarshaller<ComponentState, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ComponentState Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TemplateFile = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
