...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProvisionedResourceUnmarshaller : IUnmarshaller<ProvisionedResource, XmlUnmarshallerContext>, IUnmarshaller<ProvisionedResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProvisionedResource IUnmarshaller<ProvisionedResource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProvisionedResource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProvisioningEngine = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
