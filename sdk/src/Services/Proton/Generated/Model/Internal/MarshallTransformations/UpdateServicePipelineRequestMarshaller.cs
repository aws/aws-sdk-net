...
{
    /// <summary>
    /// UpdateServicePipeline Request Marshaller
    /// </summary>       
    public class UpdateServicePipelineRequestMarshaller : IMarshaller<IRequest, UpdateServicePipelineRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateServicePipelineRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateServicePipelineRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Proton");
            string target = "AwsProton20200720.UpdateServicePipeline";
        ...
        private static UpdateServicePipelineRequestMarshaller _instance = new UpdateServicePipelineRequestMarshaller();        

        internal static UpdateServicePipelineRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServicePipelineRequestMarshaller Instance
        {
            get
            {
                return _instance;
