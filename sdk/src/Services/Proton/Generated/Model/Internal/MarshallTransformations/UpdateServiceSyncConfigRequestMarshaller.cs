...
{
    /// <summary>
    /// UpdateServiceSyncConfig Request Marshaller
    /// </summary>       
    public class UpdateServiceSyncConfigRequestMarshaller : IMarshaller<IRequest, UpdateServiceSyncConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateServiceSyncConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateServiceSyncConfigRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Proton");
            string target = "AwsProton20200720.UpdateServiceSyncConfig";
        ...
        private static UpdateServiceSyncConfigRequestMarshaller _instance = new UpdateServiceSyncConfigRequestMarshaller();        

        internal static UpdateServiceSyncConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceSyncConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
