...
{
    /// <summary>
    /// CreateTemplateSyncConfig Request Marshaller
    /// </summary>       
    public class CreateTemplateSyncConfigRequestMarshaller : IMarshaller<IRequest, CreateTemplateSyncConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTemplateSyncConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTemplateSyncConfigRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Proton");
            string target = "AwsProton20200720.CreateTemplateSyncConfig";
        ...
        private static CreateTemplateSyncConfigRequestMarshaller _instance = new CreateTemplateSyncConfigRequestMarshaller();        

        internal static CreateTemplateSyncConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTemplateSyncConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
