...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceTemplateSummaryUnmarshaller : IJsonUnmarshaller<ServiceTemplateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceTemplateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("pipelineProvisioning", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
