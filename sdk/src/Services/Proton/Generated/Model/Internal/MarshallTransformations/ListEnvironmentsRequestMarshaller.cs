...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    public class ListEnvironmentsRequestMarshaller : IMarshaller<IRequest, ListEnvironmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListEnvironmentsRequest publicRequest)
        {
            ...
            string target = "AwsProton20200720.ListEnvironments";
            ...
            if(publicRequest.IsSetEnvironmentTemplates())
            {
                context.Writer.WritePropertyName("environmentTemplates");
                context.Writer.WriteStartArray();
                foreach(var publicRequestEnvironmentTemplatesListValue in publicRequest.EnvironmentTemplates)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = EnvironmentTemplateFilterMarshaller.Instance;
                    marshaller.Marshall(publicRequestEnvironmentTemplatesListValue, context);
