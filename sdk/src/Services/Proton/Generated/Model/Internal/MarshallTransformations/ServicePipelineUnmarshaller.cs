...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServicePipelineUnmarshaller : IUnmarshaller<ServicePipeline, XmlUnmarshallerContext>, IUnmarshaller<ServicePipeline, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ServicePipeline IUnmarshaller<ServicePipeline, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
