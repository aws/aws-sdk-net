...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceSyncConfigUnmarshaller : IJsonUnmarshaller<ServiceSyncConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceSyncConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
