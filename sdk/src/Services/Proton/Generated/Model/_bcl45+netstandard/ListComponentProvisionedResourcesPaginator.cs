...
namespace Amazon.Proton.Model
{
    ...
    internal sealed partial class ListComponentProvisionedResourcesPaginator : IPaginator<ListComponentProvisionedResourcesResponse>, IListComponentProvisionedResourcesPaginator
    {
        ...
        public IPaginatedEnumerable<ProvisionedResource> ProvisionedResources => 
            new PaginatedResultKeyResponse<ListComponentProvisionedResourcesResponse, ProvisionedResource>(this, (i) => i.ProvisionedResources);
        ...
        async IAsyncEnumerable<ListComponentProvisionedResourcesResponse> IPaginator<ListComponentProvisionedResourcesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
