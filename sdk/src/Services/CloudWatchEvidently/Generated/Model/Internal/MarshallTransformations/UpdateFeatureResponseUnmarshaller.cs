...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFeature operation
    /// </summary>  
    public class UpdateFeatureResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("feature", targetDepth))
                {
                    ...
                    response.Feature = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateFeatureResponseUnmarshaller _instance = new UpdateFeatureResponseUnmarshaller();        

        internal static UpdateFeatureResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFeatureResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
