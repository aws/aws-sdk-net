...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduledSplitUnmarshaller : IUnmarshaller<ScheduledSplit, XmlUnmarshallerContext>, IUnmarshaller<ScheduledSplit, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ScheduledSplit IUnmarshaller<ScheduledSplit, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
