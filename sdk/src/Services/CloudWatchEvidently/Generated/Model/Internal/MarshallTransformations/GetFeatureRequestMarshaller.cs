...
{
    /// <summary>
    /// GetFeature Request Marshaller
    /// </summary>       
    public class GetFeatureRequestMarshaller : IMarshaller<IRequest, GetFeatureRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFeatureRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetFeatureRequest publicRequest)
        {
        ...
        private static GetFeatureRequestMarshaller _instance = new GetFeatureRequestMarshaller();        

        internal static GetFeatureRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFeatureRequestMarshaller Instance
        {
            get
            {
                return _instance;
