...
{
    /// <summary>
    /// Response Unmarshaller for GetExperiment operation
    /// </summary>  
    public class GetExperimentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetExperimentResponseUnmarshaller _instance = new GetExperimentResponseUnmarshaller();        

        internal static GetExperimentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExperimentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
