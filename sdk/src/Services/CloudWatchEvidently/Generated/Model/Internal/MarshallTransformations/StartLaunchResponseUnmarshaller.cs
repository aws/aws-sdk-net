...
{
    /// <summary>
    /// Response Unmarshaller for StartLaunch operation
    /// </summary>  
    public class StartLaunchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartLaunchResponse response = new StartLaunchResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("launch", targetDepth))
                {
                    ...
                    response.Launch = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartLaunchResponseUnmarshaller _instance = new StartLaunchResponseUnmarshaller();        

        internal static StartLaunchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartLaunchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
