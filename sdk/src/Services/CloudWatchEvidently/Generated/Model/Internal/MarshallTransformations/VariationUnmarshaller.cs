...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VariationUnmarshaller : IJsonUnmarshaller<Variation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Variation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
