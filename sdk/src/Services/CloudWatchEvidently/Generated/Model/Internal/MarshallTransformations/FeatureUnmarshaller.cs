...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FeatureUnmarshaller : IUnmarshaller<Feature, XmlUnmarshallerContext>, IUnmarshaller<Feature, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Feature IUnmarshaller<Feature, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Feature Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("entityOverrides", targetDepth))
                {
                    ...
                    unmarshalledObject.EntityOverrides = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Variation, VariationUnmarshaller>(VariationUnmarshaller.Instance);
