...
{
    /// <summary>
    /// PutProjectEvents Request Marshaller
    /// </summary>       
    public class PutProjectEventsRequestMarshaller : IMarshaller<IRequest, PutProjectEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutProjectEventsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutProjectEventsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/events/projects/{project}";
#if !NETFRAMEWORK
        ...
        private static PutProjectEventsRequestMarshaller _instance = new PutProjectEventsRequestMarshaller();        

        internal static PutProjectEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutProjectEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
