...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    public class StartExperimentRequestMarshaller : IMarshaller<IRequest, StartExperimentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartExperimentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/projects/{project}/experiments/{experiment}/start";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetAnalysisCompleteTime())
            {
                ...
                context.Writer.WriteNumberValue(Convert.ToInt64(StringUtils.FromDateTimeToUnixTimestamp(publicRequest.AnalysisCompleteTime.Value)));
            }
