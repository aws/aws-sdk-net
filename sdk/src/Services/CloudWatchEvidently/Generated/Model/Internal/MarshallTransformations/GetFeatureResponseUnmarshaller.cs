...
{
    /// <summary>
    /// Response Unmarshaller for GetFeature operation
    /// </summary>  
    public class GetFeatureResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetFeatureResponseUnmarshaller _instance = new GetFeatureResponseUnmarshaller();        

        internal static GetFeatureResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFeatureResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
