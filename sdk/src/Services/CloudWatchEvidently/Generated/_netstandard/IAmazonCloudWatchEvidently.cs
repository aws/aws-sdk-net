...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCloudWatchEvidentlyConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCloudWatchEvidentlyConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCloudWatchEvidentlyConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCloudWatchEvidentlyConfig to create AmazonCloudWatchEvidentlyClient");
            }

            return awsCredentials == null ? 
                    new AmazonCloudWatchEvidentlyClient(serviceClientConfig) :
                    new AmazonCloudWatchEvidentlyClient(awsCredentials, serviceClientConfig);
        }
