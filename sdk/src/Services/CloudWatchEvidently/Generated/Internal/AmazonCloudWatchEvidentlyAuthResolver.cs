...
namespace Amazon.CloudWatchEvidently.Internal
{
    ...
    public class AmazonCloudWatchEvidentlyAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudWatchEvidentlyAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudWatchEvidently.
        /// </summary>
        public AmazonCloudWatchEvidentlyAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudWatchEvidentlyAuthSchemeParameters
            {
    ...
    public class AmazonCloudWatchEvidentlyAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudWatchEvidentlyAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudWatchEvidentlyAuthSchemeParameters authParameters)
        {
