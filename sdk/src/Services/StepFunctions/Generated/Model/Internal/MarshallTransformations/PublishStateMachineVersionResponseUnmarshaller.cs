...
{
    /// <summary>
    /// Response Unmarshaller for PublishStateMachineVersion operation
    /// </summary>  
    public class PublishStateMachineVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PublishStateMachineVersionResponse response = new PublishStateMachineVersionResponse();
        ...
        private static PublishStateMachineVersionResponseUnmarshaller _instance = new PublishStateMachineVersionResponseUnmarshaller();        

        internal static PublishStateMachineVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PublishStateMachineVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
