    ...
    public class ListMapRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MapRunListItem, MapRunListItemUnmarshaller>(MapRunListItemUnmarshaller.Instance);
                    response.MapRuns = unmarshaller.Unmarshall(context);
                    continue;
                }
