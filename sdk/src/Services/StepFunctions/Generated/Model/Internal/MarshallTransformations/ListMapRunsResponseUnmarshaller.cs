...
{
    /// <summary>
    /// Response Unmarshaller for ListMapRuns operation
    /// </summary>  
    public class ListMapRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMapRunsResponse response = new ListMapRunsResponse();
            ...
            {
                if (context.TestExpression("mapRuns", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MapRunListItem, MapRunListItemUnmarshaller>(MapRunListItemUnmarshaller.Instance);
                    response.MapRuns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListMapRunsResponseUnmarshaller _instance = new ListMapRunsResponseUnmarshaller();        

        internal static ListMapRunsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMapRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
