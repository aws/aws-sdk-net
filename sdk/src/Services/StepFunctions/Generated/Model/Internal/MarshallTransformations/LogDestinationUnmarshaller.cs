...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogDestinationUnmarshaller : IJsonUnmarshaller<LogDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogDestination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
