...
{
    /// <summary>
    /// Response Unmarshaller for DescribeActivity operation
    /// </summary>  
    public class DescribeActivityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeActivityResponse response = new DescribeActivityResponse();
            ...
            {
                if (context.TestExpression("activityArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ActivityArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ActivityDoesNotExist"))
                {
                    return ActivityDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DescribeActivityResponseUnmarshaller _instance = new DescribeActivityResponseUnmarshaller();        

        internal static DescribeActivityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeActivityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
