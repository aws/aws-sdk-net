...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaskSubmitFailedEventDetailsUnmarshaller : IJsonUnmarshaller<TaskSubmitFailedEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaskSubmitFailedEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
