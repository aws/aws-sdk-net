    ...
    public class ExecutionStartedEventDetailsUnmarshaller : IJsonUnmarshaller<ExecutionStartedEventDetails, JsonUnmarshallerContext>
    {
        ...
        public ExecutionStartedEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("inputDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("stateMachineAliasArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StateMachineAliasArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("stateMachineVersionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static ExecutionStartedEventDetailsUnmarshaller _instance = new ExecutionStartedEventDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ExecutionStartedEventDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
