...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionListItemUnmarshaller : IUnmarshaller<ExecutionListItem, XmlUnmarshallerContext>, IUnmarshaller<ExecutionListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ExecutionListItem IUnmarshaller<ExecutionListItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
