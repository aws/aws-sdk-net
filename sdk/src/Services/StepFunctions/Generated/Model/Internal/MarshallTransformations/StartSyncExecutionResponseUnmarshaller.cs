...
{
    /// <summary>
    /// Response Unmarshaller for StartSyncExecution operation
    /// </summary>  
    public class StartSyncExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSyncExecutionResponse response = new StartSyncExecutionResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("billingDetails", targetDepth, ref reader))
                {
                    var unmarshaller = BillingDetailsUnmarshaller.Instance;
                    response.BillingDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("inputDetails", targetDepth, ref reader))
                {
                    ...
                    response.InputDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = CloudWatchEventsExecutionDataDetailsUnmarshaller.Instance;
                    response.OutputDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartSyncExecutionResponseUnmarshaller _instance = new StartSyncExecutionResponseUnmarshaller();        

        internal static StartSyncExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSyncExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
