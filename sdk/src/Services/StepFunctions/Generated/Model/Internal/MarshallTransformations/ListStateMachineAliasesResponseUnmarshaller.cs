    ...
    public class ListStateMachineAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StateMachineAliasListItem, StateMachineAliasListItemUnmarshaller>(StateMachineAliasListItemUnmarshaller.Instance);
                    response.StateMachineAliases = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
