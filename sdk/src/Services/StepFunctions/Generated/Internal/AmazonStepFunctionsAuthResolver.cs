...
namespace Amazon.StepFunctions.Internal
{
    ...
    public class AmazonStepFunctionsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonStepFunctionsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for StepFunctions.
        /// </summary>
        public AmazonStepFunctionsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonStepFunctionsAuthSchemeParameters
            {
    ...
    public class AmazonStepFunctionsAuthSchemeResolver : IAuthSchemeResolver<AmazonStepFunctionsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonStepFunctionsAuthSchemeParameters authParameters)
        {
