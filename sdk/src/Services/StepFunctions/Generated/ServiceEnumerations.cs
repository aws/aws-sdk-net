...
namespace Amazon.StepFunctions
{
    ...
    /// <summary>
    /// Constants used for properties of type MockResponseValidationMode.
    /// </summary>
    public class MockResponseValidationMode : ConstantClass
    {

        /// <summary>
        /// Constant NONE for MockResponseValidationMode
        /// </summary>
        public static readonly MockResponseValidationMode NONE = new MockResponseValidationMode("NONE");
        /// <summary>
        /// Constant PRESENT for MockResponseValidationMode
        /// </summary>
        public static readonly MockResponseValidationMode PRESENT = new MockResponseValidationMode("PRESENT");
        /// <summary>
        /// Constant STRICT for MockResponseValidationMode
        /// </summary>
        public static readonly MockResponseValidationMode STRICT = new MockResponseValidationMode("STRICT");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public MockResponseValidationMode(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static MockResponseValidationMode FindValue(string value)
        {
            return FindValue<MockResponseValidationMode>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator MockResponseValidationMode(string value)
        {
            return FindValue(value);
        }
    }
