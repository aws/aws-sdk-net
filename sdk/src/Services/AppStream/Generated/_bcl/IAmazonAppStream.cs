...
namespace Amazon.AppStream
{
    ...
    public partial interface IAmazonAppStream : IAmazonService, IDisposable
    {
        ...
        DrainSessionInstanceResponse DrainSessionInstance(DrainSessionInstanceRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/DrainSessionInstance">REST API Reference for DrainSessionInstance Operation</seealso>
        Task<DrainSessionInstanceResponse> DrainSessionInstanceAsync(DrainSessionInstanceRequest request, CancellationToken cancellationToken = default(CancellationToken));
