...
{
    /// <summary>
    /// Container for the parameters to the AssociateSoftwareToImageBuilder operation.
    /// Associates license included application(s) with an existing image builder instance.
    /// </summary>
    public partial class AssociateSoftwareToImageBuilderRequest : AmazonAppStreamRequest
    {
