...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAppBlocksResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAppBlocks");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AppBlocks":
                        {
                            context.AddPathSegment("AppBlocks");
                            var unmarshaller = new CborListUnmarshaller<AppBlock, AppBlockUnmarshaller>(AppBlockUnmarshaller.Instance);
                            response.AppBlocks = unmarshaller.Unmarshall(context);
