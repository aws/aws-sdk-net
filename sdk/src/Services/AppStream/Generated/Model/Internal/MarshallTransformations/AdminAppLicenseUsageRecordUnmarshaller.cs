...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminAppLicenseUsageRecordUnmarshaller : IUnmarshaller<AdminAppLicenseUsageRecord, XmlUnmarshallerContext>, IUnmarshaller<AdminAppLicenseUsageRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AdminAppLicenseUsageRecord IUnmarshaller<AdminAppLicenseUsageRecord, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AdminAppLicenseUsageRecord Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("OwnerAWSAccountId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OwnerAWSAccountId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SubscriptionFirstUsedDate", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.SubscriptionFirstUsedDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SubscriptionLastUsedDate", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
        ...
        private static AdminAppLicenseUsageRecordUnmarshaller _instance = new AdminAppLicenseUsageRecordUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AdminAppLicenseUsageRecordUnmarshaller Instance
        {
            get
            {
                return _instance;
