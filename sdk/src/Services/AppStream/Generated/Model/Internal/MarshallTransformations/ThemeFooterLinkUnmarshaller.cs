...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ThemeFooterLinkUnmarshaller : ICborUnmarshaller<ThemeFooterLink, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThemeFooterLink Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "FooterLinkURL":
                        {
                            context.AddPathSegment("FooterLinkURL");
                            var unmarshaller = CborStringUnmarshaller.Instance;
