...
{
    /// <summary>
    /// Response Unmarshaller for ListAssociatedFleets operation
    /// </summary>  
    public class ListAssociatedFleetsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssociatedFleetsResponse response = new ListAssociatedFleetsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAssociatedFleets");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Names":
                        {
                            context.AddPathSegment("Names");
                            var unmarshaller = new CborListUnmarshaller<string, CborStringUnmarshaller>(CborStringUnmarshaller.Instance);
                            response.Names = unmarshaller.Unmarshall(context);
        ...
        private static ListAssociatedFleetsResponseUnmarshaller _instance = new ListAssociatedFleetsResponseUnmarshaller();        

        internal static ListAssociatedFleetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssociatedFleetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
