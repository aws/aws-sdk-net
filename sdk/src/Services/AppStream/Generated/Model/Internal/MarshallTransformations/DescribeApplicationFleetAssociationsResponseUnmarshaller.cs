...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeApplicationFleetAssociationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeApplicationFleetAssociations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ApplicationFleetAssociations":
                        {
                            context.AddPathSegment("ApplicationFleetAssociations");
                            var unmarshaller = new CborListUnmarshaller<ApplicationFleetAssociation, ApplicationFleetAssociationUnmarshaller>(ApplicationFleetAssociationUnmarshaller.Instance);
