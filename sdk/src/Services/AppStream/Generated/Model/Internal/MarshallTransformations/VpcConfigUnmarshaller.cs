...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VpcConfigUnmarshaller : ICborUnmarshaller<VpcConfig, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public VpcConfig Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "SecurityGroupIds":
                        {
                            context.AddPathSegment("SecurityGroupIds");
                    ...
                    case "SubnetIds":
                        {
                            context.AddPathSegment("SubnetIds");
                            var unmarshaller = new CborListUnmarshaller<string, CborStringUnmarshaller>(CborStringUnmarshaller.Instance);
