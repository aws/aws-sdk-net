...
{
    /// <summary>
    /// Response Unmarshaller for AssociateSoftwareToImageBuilder operation
    /// </summary>  
    public class AssociateSoftwareToImageBuilderResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateSoftwareToImageBuilderResponse response = new AssociateSoftwareToImageBuilderResponse();
            var reader = context.Reader;
            context.AddPathSegment("AssociateSoftwareToImageBuilder");
        ...
        private static AssociateSoftwareToImageBuilderResponseUnmarshaller _instance = new AssociateSoftwareToImageBuilderResponseUnmarshaller();        

        internal static AssociateSoftwareToImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateSoftwareToImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
