...
{
    /// <summary>
    /// DescribeImageBuilders Request Marshaller
    /// </summary>       
    public class DescribeImageBuildersRequestMarshaller : IMarshaller<IRequest, DescribeImageBuildersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeImageBuildersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeImageBuildersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AppStream");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PhotonAdminProxyService/operation/DescribeImageBuilders";
        ...
        private static DescribeImageBuildersRequestMarshaller _instance = new DescribeImageBuildersRequestMarshaller();        

        internal static DescribeImageBuildersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImageBuildersRequestMarshaller Instance
        {
            get
            {
                return _instance;
