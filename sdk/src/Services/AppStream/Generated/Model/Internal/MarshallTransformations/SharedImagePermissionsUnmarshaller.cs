...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SharedImagePermissionsUnmarshaller : ICborUnmarshaller<SharedImagePermissions, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public SharedImagePermissions Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "sharedAccountId":
                        {
                            context.AddPathSegment("SharedAccountId");
        ...
        private static SharedImagePermissionsUnmarshaller _instance = new SharedImagePermissionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SharedImagePermissionsUnmarshaller Instance
        {
            get
            {
                return _instance;
