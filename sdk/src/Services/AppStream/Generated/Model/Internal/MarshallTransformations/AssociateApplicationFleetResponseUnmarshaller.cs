...
{
    /// <summary>
    /// Response Unmarshaller for AssociateApplicationFleet operation
    /// </summary>  
    public class AssociateApplicationFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateApplicationFleetResponse response = new AssociateApplicationFleetResponse();
            var reader = context.Reader;
            context.AddPathSegment("AssociateApplicationFleet");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ApplicationFleetAssociation":
                        {
                            context.AddPathSegment("ApplicationFleetAssociation");
                            var unmarshaller = ApplicationFleetAssociationUnmarshaller.Instance;
                            response.ApplicationFleetAssociation = unmarshaller.Unmarshall(context);
        ...
        private static AssociateApplicationFleetResponseUnmarshaller _instance = new AssociateApplicationFleetResponseUnmarshaller();        

        internal static AssociateApplicationFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateApplicationFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
