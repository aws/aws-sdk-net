...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CopyImageResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("CopyImage");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "DestinationImageName":
                        {
                            context.AddPathSegment("DestinationImageName");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.DestinationImageName = unmarshaller.Unmarshall(context);
