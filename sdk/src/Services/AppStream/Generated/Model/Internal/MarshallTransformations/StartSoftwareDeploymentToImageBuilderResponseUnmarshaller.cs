...
{
    /// <summary>
    /// Response Unmarshaller for StartSoftwareDeploymentToImageBuilder operation
    /// </summary>  
    public class StartSoftwareDeploymentToImageBuilderResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSoftwareDeploymentToImageBuilderResponse response = new StartSoftwareDeploymentToImageBuilderResponse();
            var reader = context.Reader;
            context.AddPathSegment("StartSoftwareDeploymentToImageBuilder");
        ...
        private static StartSoftwareDeploymentToImageBuilderResponseUnmarshaller _instance = new StartSoftwareDeploymentToImageBuilderResponseUnmarshaller();        

        internal static StartSoftwareDeploymentToImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSoftwareDeploymentToImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
