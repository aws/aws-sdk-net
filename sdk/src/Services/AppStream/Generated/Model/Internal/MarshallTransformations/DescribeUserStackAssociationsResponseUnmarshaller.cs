...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeUserStackAssociationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeUserStackAssociations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "UserStackAssociations":
                        {
                            context.AddPathSegment("UserStackAssociations");
                            var unmarshaller = new CborListUnmarshaller<UserStackAssociation, UserStackAssociationUnmarshaller>(UserStackAssociationUnmarshaller.Instance);
