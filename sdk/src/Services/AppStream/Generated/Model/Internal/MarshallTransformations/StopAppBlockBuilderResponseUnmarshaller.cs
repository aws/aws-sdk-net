...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopAppBlockBuilderResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("StopAppBlockBuilder");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AppBlockBuilder":
                        {
                            context.AddPathSegment("AppBlockBuilder");
                            var unmarshaller = AppBlockBuilderUnmarshaller.Instance;
                            response.AppBlockBuilder = unmarshaller.Unmarshall(context);
