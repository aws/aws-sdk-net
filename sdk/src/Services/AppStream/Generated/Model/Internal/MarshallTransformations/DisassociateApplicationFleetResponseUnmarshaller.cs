...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateApplicationFleet operation
    /// </summary>  
    public class DisassociateApplicationFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateApplicationFleetResponse response = new DisassociateApplicationFleetResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateApplicationFleet");
        ...
        private static DisassociateApplicationFleetResponseUnmarshaller _instance = new DisassociateApplicationFleetResponseUnmarshaller();        

        internal static DisassociateApplicationFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateApplicationFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
