...
{
    /// <summary>
    /// Response Unmarshaller for CreateExportImageTask operation
    /// </summary>  
    public class CreateExportImageTaskResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateExportImageTaskResponse response = new CreateExportImageTaskResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateExportImageTask");
            reader.ReadStartMap();
        ...
        private static CreateExportImageTaskResponseUnmarshaller _instance = new CreateExportImageTaskResponseUnmarshaller();        

        internal static CreateExportImageTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExportImageTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
