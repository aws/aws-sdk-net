...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateApplicationFromEntitlement operation
    /// </summary>  
    public class DisassociateApplicationFromEntitlementResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateApplicationFromEntitlementResponse response = new DisassociateApplicationFromEntitlementResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateApplicationFromEntitlement");
        ...
        private static DisassociateApplicationFromEntitlementResponseUnmarshaller _instance = new DisassociateApplicationFromEntitlementResponseUnmarshaller();        

        internal static DisassociateApplicationFromEntitlementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateApplicationFromEntitlementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
