...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppBlockBuilderAppBlockAssociationUnmarshaller : IUnmarshaller<AppBlockBuilderAppBlockAssociation, XmlUnmarshallerContext>, IUnmarshaller<AppBlockBuilderAppBlockAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AppBlockBuilderAppBlockAssociation IUnmarshaller<AppBlockBuilderAppBlockAssociation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AppBlockBuilderAppBlockAssociation Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
