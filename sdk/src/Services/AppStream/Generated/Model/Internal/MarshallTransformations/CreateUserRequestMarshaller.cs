...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    public class CreateUserRequestMarshaller : IMarshaller<IRequest, CreateUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateUserRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/PhotonAdminProxyService/operation/CreateUser";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("FirstName");
                    context.Writer.WriteTextString(publicRequest.FirstName);
                }
                if (publicRequest.IsSetLastName())
                {
                    context.Writer.WriteTextString("LastName");
                    context.Writer.WriteTextString(publicRequest.LastName);
                }
                if (publicRequest.IsSetMessageAction())
                {
                    context.Writer.WriteTextString("MessageAction");
                    context.Writer.WriteTextString(publicRequest.MessageAction);
                }
