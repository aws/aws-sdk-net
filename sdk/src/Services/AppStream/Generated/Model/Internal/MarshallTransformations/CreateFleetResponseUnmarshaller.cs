...
{
    /// <summary>
    /// Response Unmarshaller for CreateFleet operation
    /// </summary>  
    public class CreateFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("CreateFleet");
            reader.ReadStartMap();
        ...
        private static CreateFleetResponseUnmarshaller _instance = new CreateFleetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
