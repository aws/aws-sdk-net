...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceErrorUnmarshaller : ICborUnmarshaller<ResourceError, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceError Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "ErrorTimestamp":
                        {
                            context.AddPathSegment("ErrorTimestamp");
