...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateSoftwareFromImageBuilder operation
    /// </summary>  
    public class DisassociateSoftwareFromImageBuilderResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateSoftwareFromImageBuilderResponse response = new DisassociateSoftwareFromImageBuilderResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateSoftwareFromImageBuilder");
        ...
        private static DisassociateSoftwareFromImageBuilderResponseUnmarshaller _instance = new DisassociateSoftwareFromImageBuilderResponseUnmarshaller();        

        internal static DisassociateSoftwareFromImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateSoftwareFromImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
