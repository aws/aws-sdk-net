...
{
    /// <summary>
    /// Response Unmarshaller for StopImageBuilder operation
    /// </summary>  
    public class StopImageBuilderResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopImageBuilderResponse response = new StopImageBuilderResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopImageBuilder");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ImageBuilder":
                        {
                            context.AddPathSegment("ImageBuilder");
                            var unmarshaller = ImageBuilderUnmarshaller.Instance;
                            response.ImageBuilder = unmarshaller.Unmarshall(context);
        ...
        private static StopImageBuilderResponseUnmarshaller _instance = new StopImageBuilderResponseUnmarshaller();        

        internal static StopImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
