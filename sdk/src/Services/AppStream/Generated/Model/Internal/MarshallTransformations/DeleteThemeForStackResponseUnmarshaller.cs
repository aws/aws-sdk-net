...
{
    /// <summary>
    /// Response Unmarshaller for DeleteThemeForStack operation
    /// </summary>  
    public class DeleteThemeForStackResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteThemeForStackResponse response = new DeleteThemeForStackResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteThemeForStack");
        ...
        private static DeleteThemeForStackResponseUnmarshaller _instance = new DeleteThemeForStackResponseUnmarshaller();        

        internal static DeleteThemeForStackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThemeForStackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
