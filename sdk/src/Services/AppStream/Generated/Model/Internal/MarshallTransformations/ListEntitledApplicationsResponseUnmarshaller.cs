...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListEntitledApplicationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListEntitledApplications");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EntitledApplications":
                        {
                            context.AddPathSegment("EntitledApplications");
                            var unmarshaller = new CborListUnmarshaller<EntitledApplication, EntitledApplicationUnmarshaller>(EntitledApplicationUnmarshaller.Instance);
