...
{
    /// <summary>
    /// Response Unmarshaller for StartFleet operation
    /// </summary>  
    public class StartFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFleetResponse response = new StartFleetResponse();
            var reader = context.Reader;
            context.AddPathSegment("StartFleet");
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new CborUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InvalidAccountStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                {
                    return ResourceNotAvailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static StartFleetResponseUnmarshaller _instance = new StartFleetResponseUnmarshaller();        

        internal static StartFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
