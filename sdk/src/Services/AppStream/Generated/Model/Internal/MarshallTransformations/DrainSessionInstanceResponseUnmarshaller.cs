...
{
    /// <summary>
    /// Response Unmarshaller for DrainSessionInstance operation
    /// </summary>  
    public class DrainSessionInstanceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DrainSessionInstanceResponse response = new DrainSessionInstanceResponse();
            var reader = context.Reader;
            context.AddPathSegment("DrainSessionInstance");
        ...
        private static DrainSessionInstanceResponseUnmarshaller _instance = new DrainSessionInstanceResponseUnmarshaller();        

        internal static DrainSessionInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DrainSessionInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
