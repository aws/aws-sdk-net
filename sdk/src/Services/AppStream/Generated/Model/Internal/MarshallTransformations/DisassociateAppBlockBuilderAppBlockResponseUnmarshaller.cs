...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateAppBlockBuilderAppBlock operation
    /// </summary>  
    public class DisassociateAppBlockBuilderAppBlockResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateAppBlockBuilderAppBlockResponse response = new DisassociateAppBlockBuilderAppBlockResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateAppBlockBuilderAppBlock");
        ...
        private static DisassociateAppBlockBuilderAppBlockResponseUnmarshaller _instance = new DisassociateAppBlockBuilderAppBlockResponseUnmarshaller();        

        internal static DisassociateAppBlockBuilderAppBlockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAppBlockBuilderAppBlockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
