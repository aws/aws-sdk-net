...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAppBlockResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("CreateAppBlock");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AppBlock":
                        {
                            context.AddPathSegment("AppBlock");
                            var unmarshaller = AppBlockUnmarshaller.Instance;
                            response.AppBlock = unmarshaller.Unmarshall(context);
