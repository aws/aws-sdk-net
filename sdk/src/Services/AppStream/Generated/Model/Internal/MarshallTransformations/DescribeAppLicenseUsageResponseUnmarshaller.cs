...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAppLicenseUsage operation
    /// </summary>  
    public class DescribeAppLicenseUsageResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAppLicenseUsageResponse response = new DescribeAppLicenseUsageResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeAppLicenseUsage");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AppLicenseUsages":
                        {
                            context.AddPathSegment("AppLicenseUsages");
                            var unmarshaller = new CborListUnmarshaller<AdminAppLicenseUsageRecord, AdminAppLicenseUsageRecordUnmarshaller>(AdminAppLicenseUsageRecordUnmarshaller.Instance);
                            response.AppLicenseUsages = unmarshaller.Unmarshall(context);
        ...
        private static DescribeAppLicenseUsageResponseUnmarshaller _instance = new DescribeAppLicenseUsageResponseUnmarshaller();        

        internal static DescribeAppLicenseUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAppLicenseUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
