...
{
    /// <summary>
    /// Response Unmarshaller for BatchDisassociateUserStack operation
    /// </summary>  
    public class BatchDisassociateUserStackResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDisassociateUserStackResponse response = new BatchDisassociateUserStackResponse();
            var reader = context.Reader;
            context.AddPathSegment("BatchDisassociateUserStack");
            reader.ReadStartMap();
                    ...
                    case "errors":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<UserStackAssociationError, UserStackAssociationErrorUnmarshaller>(UserStackAssociationErrorUnmarshaller.Instance);
        ...
        private static BatchDisassociateUserStackResponseUnmarshaller _instance = new BatchDisassociateUserStackResponseUnmarshaller();        

        internal static BatchDisassociateUserStackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDisassociateUserStackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
