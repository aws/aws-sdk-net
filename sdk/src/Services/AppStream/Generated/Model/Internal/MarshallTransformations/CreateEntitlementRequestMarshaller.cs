...
{
    /// <summary>
    /// CreateEntitlement Request Marshaller
    /// </summary>       
    public class CreateEntitlementRequestMarshaller : IMarshaller<IRequest, CreateEntitlementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEntitlementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEntitlementRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AppStream");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PhotonAdminProxyService/operation/CreateEntitlement";
        ...
        private static CreateEntitlementRequestMarshaller _instance = new CreateEntitlementRequestMarshaller();        

        internal static CreateEntitlementRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEntitlementRequestMarshaller Instance
        {
            get
            {
                return _instance;
