...
{
    /// <summary>
    /// Response Unmarshaller for CreateImportedImage operation
    /// </summary>  
    public class CreateImportedImageResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateImportedImageResponse response = new CreateImportedImageResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateImportedImage");
            reader.ReadStartMap();
        ...
        private static CreateImportedImageResponseUnmarshaller _instance = new CreateImportedImageResponseUnmarshaller();        

        internal static CreateImportedImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImportedImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
