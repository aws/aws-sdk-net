...
{
    /// <summary>
    /// Response Unmarshaller for EnableUser operation
    /// </summary>  
    public class EnableUserResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("EnableUser");
        ...
        private static EnableUserResponseUnmarshaller _instance = new EnableUserResponseUnmarshaller();        

        internal static EnableUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
