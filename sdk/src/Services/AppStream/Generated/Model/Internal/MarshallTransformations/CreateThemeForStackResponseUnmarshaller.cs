...
{
    /// <summary>
    /// Response Unmarshaller for CreateThemeForStack operation
    /// </summary>  
    public class CreateThemeForStackResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateThemeForStackResponse response = new CreateThemeForStackResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateThemeForStack");
            reader.ReadStartMap();
        ...
        private static CreateThemeForStackResponseUnmarshaller _instance = new CreateThemeForStackResponseUnmarshaller();        

        internal static CreateThemeForStackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThemeForStackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
