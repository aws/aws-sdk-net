...
{
    /// <summary>
    /// Response Unmarshaller for GetExportImageTask operation
    /// </summary>  
    public class GetExportImageTaskResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetExportImageTaskResponse response = new GetExportImageTaskResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetExportImageTask");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ExportImageTask":
                        {
                            context.AddPathSegment("ExportImageTask");
                            var unmarshaller = ExportImageTaskUnmarshaller.Instance;
                            response.ExportImageTask = unmarshaller.Unmarshall(context);
        ...
        private static GetExportImageTaskResponseUnmarshaller _instance = new GetExportImageTaskResponseUnmarshaller();        

        internal static GetExportImageTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExportImageTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
