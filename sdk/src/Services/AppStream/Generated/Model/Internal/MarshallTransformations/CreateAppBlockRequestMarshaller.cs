...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    public class CreateAppBlockRequestMarshaller : IMarshaller<IRequest, CreateAppBlockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateAppBlockRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/PhotonAdminProxyService/operation/CreateAppBlock";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("PackagingType");
                    context.Writer.WriteTextString(publicRequest.PackagingType);
                }
                if (publicRequest.IsSetPostSetupScriptDetails())
                {
                    context.Writer.WriteTextString("PostSetupScriptDetails");
                ...
                {
                    context.Writer.WriteTextString("SetupScriptDetails");
                    context.Writer.WriteStartMap(null);
                ...
                {
                    context.Writer.WriteTextString("SourceS3Location");
                    context.Writer.WriteStartMap(null);
