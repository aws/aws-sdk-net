...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeImagePermissionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeImagePermissions");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "SharedImagePermissionsList":
                        {
                            context.AddPathSegment("SharedImagePermissionsList");
                            var unmarshaller = new CborListUnmarshaller<SharedImagePermissions, SharedImagePermissionsUnmarshaller>(SharedImagePermissionsUnmarshaller.Instance);
