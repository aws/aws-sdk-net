...
namespace Amazon.AppStream.Model
{
    ...
    public partial class InvalidAccountStatusException : AmazonAppStreamException
    {
        ...
        public InvalidAccountStatusException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidAccountStatusException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
