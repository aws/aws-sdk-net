...
namespace Amazon.ApplicationCostProfiler
{
    ...
    public partial class AmazonApplicationCostProfilerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("ApplicationCostProfiler", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "ApplicationCostProfiler";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "application-cost-profiler";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-09-10";
