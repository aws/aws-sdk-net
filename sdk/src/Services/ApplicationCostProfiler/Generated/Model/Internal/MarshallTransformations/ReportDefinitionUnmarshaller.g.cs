...
namespace Amazon.ApplicationCostProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReportDefinitionUnmarshaller : IJsonUnmarshaller<ReportDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReportDefinition();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReportDefinitionUnmarshaller Instance => _instance;
    }
}
