...
namespace Amazon.ApplicationCostProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportApplicationUsageRequestMarshaller : IMarshaller<IRequest, ImportApplicationUsageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ImportApplicationUsageRequestMarshaller _instance = new();

        internal static ImportApplicationUsageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ImportApplicationUsageRequestMarshaller Instance => _instance;
    }
}
