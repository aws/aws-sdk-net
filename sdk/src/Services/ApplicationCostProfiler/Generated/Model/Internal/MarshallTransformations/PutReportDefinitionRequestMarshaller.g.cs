...
namespace Amazon.ApplicationCostProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutReportDefinitionRequestMarshaller : IMarshaller<IRequest, PutReportDefinitionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutReportDefinitionRequestMarshaller _instance = new();

        internal static PutReportDefinitionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutReportDefinitionRequestMarshaller Instance => _instance;
    }
}
