    ...
    public class ListReportDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("reportDefinitions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReportDefinition, ReportDefinitionUnmarshaller>(ReportDefinitionUnmarshaller.Instance);
                    response.ReportDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
