...
namespace Amazon.ApplicationCostProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteReportDefinitionRequestMarshaller : IMarshaller<IRequest, DeleteReportDefinitionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteReportDefinitionRequestMarshaller _instance = new();

        internal static DeleteReportDefinitionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteReportDefinitionRequestMarshaller Instance => _instance;
    }
}
