...
namespace Amazon.ApplicationCostProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportApplicationUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImportApplicationUsageResponse();
        ...
        internal static ImportApplicationUsageResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ImportApplicationUsageResponseUnmarshaller Instance => _instance;
    }
}
