...
namespace Amazon.ApplicationCostProfiler
{
    ...
    public partial class AmazonApplicationCostProfilerClient : AmazonServiceClient, IAmazonApplicationCostProfiler
    {
        ...
        /// 
        /// </summary>
        public AmazonApplicationCostProfilerClient() : base(new AmazonApplicationCostProfilerConfig()) { }
        ...
        public AmazonApplicationCostProfilerClient(RegionEndpoint region) : base(new AmazonApplicationCostProfilerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonApplicationCostProfilerClient(AmazonApplicationCostProfilerConfig config) : base(config) { }
