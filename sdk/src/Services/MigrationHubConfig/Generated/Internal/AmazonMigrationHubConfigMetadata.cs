...
{
    /// <summary>
    /// Service metadata for  Amazon MigrationHubConfig service
    /// </summary>
    public partial class AmazonMigrationHubConfigMetadata : IServiceMetadata
    {
        /// <summary>
        ...
        public string ServiceFullName
        {
            get
            {
                return "AWS Migration Hub Config";
            }
        }
