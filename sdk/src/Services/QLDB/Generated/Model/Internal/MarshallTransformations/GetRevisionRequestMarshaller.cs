...
namespace Amazon.QLDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetRevisionRequestMarshaller : IMarshaller<IRequest, GetRevisionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetRevisionRequestMarshaller _instance = new GetRevisionRequestMarshaller();        

        internal static GetRevisionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevisionRequestMarshaller Instance
        {
            get
            {
                return _instance;
