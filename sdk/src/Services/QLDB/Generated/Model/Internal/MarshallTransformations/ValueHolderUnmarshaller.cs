...
namespace Amazon.QLDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ValueHolderUnmarshaller : IJsonUnmarshaller<ValueHolder, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ValueHolder Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IonText", targetDepth))
                {
                    ...
                    unmarshalledObject.IonText = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
