...
{
    /// <summary>
    /// DescribeJournalKinesisStream Request Marshaller
    /// </summary>       
    public class DescribeJournalKinesisStreamRequestMarshaller : IMarshaller<IRequest, DescribeJournalKinesisStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeJournalKinesisStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeJournalKinesisStreamRequest publicRequest)
        {
        ...
        private static DescribeJournalKinesisStreamRequestMarshaller _instance = new DescribeJournalKinesisStreamRequestMarshaller();        

        internal static DescribeJournalKinesisStreamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeJournalKinesisStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
