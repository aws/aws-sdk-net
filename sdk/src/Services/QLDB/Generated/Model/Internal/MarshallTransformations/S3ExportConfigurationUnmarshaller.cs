...
namespace Amazon.QLDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ExportConfigurationUnmarshaller : IJsonUnmarshaller<S3ExportConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3ExportConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = S3EncryptionConfigurationUnmarshaller.Instance;
