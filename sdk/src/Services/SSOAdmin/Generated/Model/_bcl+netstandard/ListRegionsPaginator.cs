...
namespace Amazon.SSOAdmin.Model
{
    ...
    internal sealed partial class ListRegionsPaginator : IPaginator<ListRegionsResponse>, IListRegionsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<RegionMetadata> Regions => 
            new PaginatedResultKeyResponse<ListRegionsResponse, RegionMetadata>(this, (i) => i.Regions ?? new List<RegionMetadata>());

        internal ListRegionsPaginator(IAmazonSSOAdmin client, ListRegionsRequest request)
        {
            this._client = client;
