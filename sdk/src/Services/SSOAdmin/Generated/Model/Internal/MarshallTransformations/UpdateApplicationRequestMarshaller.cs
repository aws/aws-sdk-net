...
namespace Amazon.SSOAdmin.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateApplicationRequestMarshaller : IMarshaller<IRequest, UpdateApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateApplicationRequest publicRequest)
        {
            ...
            string target = "SWBExternalService.UpdateApplication";
            ...
            if(publicRequest.IsSetPortalOptions())
            {
                context.Writer.WritePropertyName("PortalOptions");
                context.Writer.WriteStartObject();

                var marshaller = UpdateApplicationPortalOptionsMarshaller.Instance;
                marshaller.Marshall(publicRequest.PortalOptions, context);
