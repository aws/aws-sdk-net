...
namespace Amazon.SSOAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PortalOptionsUnmarshaller : IJsonUnmarshaller<PortalOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PortalOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("SignInOptions", targetDepth, ref reader))
                {
                    var unmarshaller = SignInOptionsUnmarshaller.Instance;
                    unmarshalledObject.SignInOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
