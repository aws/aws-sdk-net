...
namespace Amazon.SSOAdmin.Model.Internal.MarshallTransformations
{
    ...
    public class AuthorizedTokenIssuerUnmarshaller : IUnmarshaller<AuthorizedTokenIssuer, XmlUnmarshallerContext>, IUnmarshaller<AuthorizedTokenIssuer, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        AuthorizedTokenIssuer IUnmarshaller<AuthorizedTokenIssuer, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AuthorizedTokenIssuer Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AuthorizedAudiences", targetDepth))
                {
                    ...
                    unmarshalledObject.AuthorizedAudiences = unmarshaller.Unmarshall(context);
                    continue;
                }
