...
{
    /// <summary>
    /// Response Unmarshaller for CreateKxUser operation
    /// </summary>  
    public class CreateKxUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKxUserResponse response = new CreateKxUserResponse();
        ...
        private static CreateKxUserResponseUnmarshaller _instance = new CreateKxUserResponseUnmarshaller();        

        internal static CreateKxUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
