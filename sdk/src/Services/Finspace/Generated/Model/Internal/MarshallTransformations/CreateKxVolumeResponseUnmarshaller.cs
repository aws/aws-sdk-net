...
{
    /// <summary>
    /// Response Unmarshaller for CreateKxVolume operation
    /// </summary>  
    public class CreateKxVolumeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKxVolumeResponse response = new CreateKxVolumeResponse();
        ...
        private static CreateKxVolumeResponseUnmarshaller _instance = new CreateKxVolumeResponseUnmarshaller();        

        internal static CreateKxVolumeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxVolumeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
