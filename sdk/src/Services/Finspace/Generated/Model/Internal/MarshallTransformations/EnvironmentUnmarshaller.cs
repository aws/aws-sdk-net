    ...
    public class EnvironmentUnmarshaller : IUnmarshaller<Environment, XmlUnmarshallerContext>, IUnmarshaller<Environment, JsonUnmarshallerContext>
    {
        ...
        public Environment Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EnvironmentUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("federationParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.FederationParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SageMakerStudioDomainUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
