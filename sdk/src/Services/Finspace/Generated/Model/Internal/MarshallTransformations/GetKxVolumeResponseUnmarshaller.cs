...
{
    /// <summary>
    /// Response Unmarshaller for GetKxVolume operation
    /// </summary>  
    public class GetKxVolumeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKxVolumeResponse response = new GetKxVolumeResponse();
        ...
        private static GetKxVolumeResponseUnmarshaller _instance = new GetKxVolumeResponseUnmarshaller();        

        internal static GetKxVolumeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKxVolumeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
