...
namespace Amazon.Finspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KxDataviewConfigurationUnmarshaller : IJsonUnmarshaller<KxDataviewConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KxDataviewConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataviewVersionId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataviewVersionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
