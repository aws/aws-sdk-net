...
{
    /// <summary>
    /// Response Unmarshaller for UpdateKxDataview operation
    /// </summary>  
    public class UpdateKxDataviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateKxDataviewResponse response = new UpdateKxDataviewResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("activeVersions", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("autoUpdate", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("readWrite", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.ReadWrite = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("segmentConfigurations", targetDepth, ref reader))
                {
        ...
        private static UpdateKxDataviewResponseUnmarshaller _instance = new UpdateKxDataviewResponseUnmarshaller();        

        internal static UpdateKxDataviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKxDataviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
