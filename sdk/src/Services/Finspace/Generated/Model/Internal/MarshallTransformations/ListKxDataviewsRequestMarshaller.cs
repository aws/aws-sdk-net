...
{
    /// <summary>
    /// ListKxDataviews Request Marshaller
    /// </summary>       
    public class ListKxDataviewsRequestMarshaller : IMarshaller<IRequest, ListKxDataviewsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListKxDataviewsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListKxDataviewsRequest publicRequest)
        {
        ...
        private static ListKxDataviewsRequestMarshaller _instance = new ListKxDataviewsRequestMarshaller();        

        internal static ListKxDataviewsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListKxDataviewsRequestMarshaller Instance
        {
            get
            {
                return _instance;
