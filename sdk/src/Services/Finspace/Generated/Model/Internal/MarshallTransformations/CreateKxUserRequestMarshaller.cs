...
{
    /// <summary>
    /// CreateKxUser Request Marshaller
    /// </summary>       
    public class CreateKxUserRequestMarshaller : IMarshaller<IRequest, CreateKxUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateKxUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateKxUserRequest publicRequest)
        {
            ...
            request.ResourcePath = "/kx/environments/{environmentId}/users";
#if !NETFRAMEWORK
        ...
        private static CreateKxUserRequestMarshaller _instance = new CreateKxUserRequestMarshaller();        

        internal static CreateKxUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
