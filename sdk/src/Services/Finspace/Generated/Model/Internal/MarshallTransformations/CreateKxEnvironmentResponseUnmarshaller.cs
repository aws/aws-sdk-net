...
{
    /// <summary>
    /// Response Unmarshaller for CreateKxEnvironment operation
    /// </summary>  
    public class CreateKxEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKxEnvironmentResponse response = new CreateKxEnvironmentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EnvironmentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateKxEnvironmentResponseUnmarshaller _instance = new CreateKxEnvironmentResponseUnmarshaller();        

        internal static CreateKxEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
