...
{
    /// <summary>
    /// Response Unmarshaller for CreateKxDataview operation
    /// </summary>  
    public class CreateKxDataviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKxDataviewResponse response = new CreateKxDataviewResponse();
        ...
        private static CreateKxDataviewResponseUnmarshaller _instance = new CreateKxDataviewResponseUnmarshaller();        

        internal static CreateKxDataviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxDataviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
