...
{
    /// <summary>
    /// DeleteKxScalingGroup Request Marshaller
    /// </summary>       
    public class DeleteKxScalingGroupRequestMarshaller : IMarshaller<IRequest, DeleteKxScalingGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteKxScalingGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteKxScalingGroupRequest publicRequest)
        {
        ...
        private static DeleteKxScalingGroupRequestMarshaller _instance = new DeleteKxScalingGroupRequestMarshaller();        

        internal static DeleteKxScalingGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteKxScalingGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
