...
namespace Amazon.SagemakerJobRuntime
{
    ...
    public partial interface IAmazonSagemakerJobRuntime : IAmazonService, IDisposable
    {
        ...
        CompleteRolloutResponse CompleteRollout(CompleteRolloutRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemakerjobruntime-2026-02-01/CompleteRollout">REST API Reference for CompleteRollout Operation</seealso>
        Task<CompleteRolloutResponse> CompleteRolloutAsync(CompleteRolloutRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemakerjobruntime-2026-02-01/Sample">REST API Reference for Sample Operation</seealso>
        Task<SampleResponse> SampleAsync(SampleRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        SampleWithResponseStreamResponse SampleWithResponseStream(SampleWithResponseStreamRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemakerjobruntime-2026-02-01/SampleWithResponseStream">REST API Reference for SampleWithResponseStream Operation</seealso>
        Task<SampleWithResponseStreamResponse> SampleWithResponseStreamAsync(SampleWithResponseStreamRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        UpdateRewardResponse UpdateReward(UpdateRewardRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemakerjobruntime-2026-02-01/UpdateReward">REST API Reference for UpdateReward Operation</seealso>
        Task<UpdateRewardResponse> UpdateRewardAsync(UpdateRewardRequest request, CancellationToken cancellationToken = default(CancellationToken));
