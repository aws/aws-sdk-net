...
namespace Amazon.SagemakerJobRuntime
{
    ...
    public partial class AmazonSagemakerJobRuntimeClient : AmazonServiceClient, IAmazonSagemakerJobRuntime
    {
        ...
        internal virtual CompleteRolloutResponse CompleteRollout(CompleteRolloutRequest request)
        {
        ...
        internal virtual SampleResponse Sample(SampleRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual SampleWithResponseStreamResponse SampleWithResponseStream(SampleWithResponseStreamRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual UpdateRewardResponse UpdateReward(UpdateRewardRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
