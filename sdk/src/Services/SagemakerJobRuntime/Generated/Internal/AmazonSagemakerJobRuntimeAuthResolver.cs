...
namespace Amazon.SagemakerJobRuntime.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonSagemakerJobRuntimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSagemakerJobRuntimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SagemakerJobRuntime.
        /// </summary>
        public AmazonSagemakerJobRuntimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSagemakerJobRuntimeAuthSchemeParameters
            {
    ...
    public class AmazonSagemakerJobRuntimeAuthSchemeResolver : IAuthSchemeResolver<AmazonSagemakerJobRuntimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSagemakerJobRuntimeAuthSchemeParameters authParameters)
        {
