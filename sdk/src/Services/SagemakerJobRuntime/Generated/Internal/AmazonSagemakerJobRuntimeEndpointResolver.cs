...
{
    /// <summary>
    /// Amazon SagemakerJobRuntime endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for SagemakerJobRuntime service requests.
    /// Collects values for SagemakerJobRuntimeEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SagemakerJobRuntimeEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonSagemakerJobRuntimeEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSagemakerJobRuntimeConfig)requestContext.ClientConfig;
            var result = new SagemakerJobRuntimeEndpointParameters();
