...
{
    /// <summary>
    /// Configuration for accessing Amazon SagemakerJobRuntime service
    /// </summary>
    public partial class AmazonSagemakerJobRuntimeConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SagemakerJobRuntime", "4.0.100.11");
        ...
        /// Default constructor
        /// </summary>
        public AmazonSagemakerJobRuntimeConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonSagemakerJobRuntimeDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "SagemakerJobRuntime";
            this.AuthenticationServiceName = "sagemaker";
            this.EndpointProvider = new AmazonSagemakerJobRuntimeEndpointProvider();
        }
