...
{
    /// <summary>
    /// Response Unmarshaller for UpdateReward operation
    /// </summary>  
    public class UpdateRewardResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRewardResponse response = new UpdateRewardResponse();
        ...
        private static UpdateRewardResponseUnmarshaller _instance = new UpdateRewardResponseUnmarshaller();        

        internal static UpdateRewardResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRewardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
