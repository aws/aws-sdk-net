...
{
    /// <summary>
    /// Response Unmarshaller for Sample operation
    /// </summary>  
    public class SampleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonSagemakerJobRuntimeException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static SampleResponseUnmarshaller _instance = new SampleResponseUnmarshaller();        

        internal static SampleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SampleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
