...
{
    /// <summary>
    /// Response Unmarshaller for CompleteRollout operation
    /// </summary>  
    public class CompleteRolloutResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CompleteRolloutResponse response = new CompleteRolloutResponse();
        ...
        private static CompleteRolloutResponseUnmarshaller _instance = new CompleteRolloutResponseUnmarshaller();        

        internal static CompleteRolloutResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CompleteRolloutResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
