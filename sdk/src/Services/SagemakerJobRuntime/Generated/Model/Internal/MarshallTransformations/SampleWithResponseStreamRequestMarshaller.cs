...
{
    /// <summary>
    /// SampleWithResponseStream Request Marshaller
    /// </summary>       
    public class SampleWithResponseStreamRequestMarshaller : IMarshaller<IRequest, SampleWithResponseStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SampleWithResponseStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SampleWithResponseStreamRequest publicRequest)
        {
            ...
            request.ResourcePath = "/sample-with-response-stream";
        ...
        private static SampleWithResponseStreamRequestMarshaller _instance = new SampleWithResponseStreamRequestMarshaller();        

        internal static SampleWithResponseStreamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SampleWithResponseStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
