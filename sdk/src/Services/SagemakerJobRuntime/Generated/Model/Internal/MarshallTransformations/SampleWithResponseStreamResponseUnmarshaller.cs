...
{
    /// <summary>
    /// Response Unmarshaller for SampleWithResponseStream operation
    /// </summary>  
    public class SampleWithResponseStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SampleWithResponseStreamResponse response = new SampleWithResponseStreamResponse();
        ...
        private static SampleWithResponseStreamResponseUnmarshaller _instance = new SampleWithResponseStreamResponseUnmarshaller();        

        internal static SampleWithResponseStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SampleWithResponseStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
