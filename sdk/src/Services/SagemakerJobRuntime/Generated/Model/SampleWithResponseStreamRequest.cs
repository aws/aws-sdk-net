...
{
    /// <summary>
    /// Container for the parameters to the SampleWithResponseStream operation.
    ...
    /// </summary>
    public partial class SampleWithResponseStreamRequest : AmazonSagemakerJobRuntimeRequest
    {
        ...
        /// <para>
        /// The trajectory ID for grouping turns into a single rollout. Each turn is captured
        /// for later use.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true, Min=1, Max=256)]
