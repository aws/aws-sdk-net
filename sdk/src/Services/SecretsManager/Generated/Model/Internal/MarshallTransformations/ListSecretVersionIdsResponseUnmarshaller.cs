...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSecretVersionIdsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SecretVersionsListEntry, SecretVersionsListEntryUnmarshaller>(SecretVersionsListEntryUnmarshaller.Instance);
        ...
        private static ListSecretVersionIdsResponseUnmarshaller _instance = new ListSecretVersionIdsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecretVersionIdsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
