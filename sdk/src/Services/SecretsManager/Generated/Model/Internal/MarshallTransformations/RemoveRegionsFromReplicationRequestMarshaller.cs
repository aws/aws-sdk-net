...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveRegionsFromReplicationRequestMarshaller : IMarshaller<IRequest, RemoveRegionsFromReplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveRegionsFromReplicationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveRegionsFromReplicationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SecretsManager");
            string target = "secretsmanager.RemoveRegionsFromReplication";
            ...
            if(publicRequest.IsSetRemoveReplicaRegions())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestRemoveReplicaRegionsListValue);
                }
        ...
        private static RemoveRegionsFromReplicationRequestMarshaller _instance = new RemoveRegionsFromReplicationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveRegionsFromReplicationRequestMarshaller Instance
        {
            get
            {
                return _instance;
