...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecretValueEntryUnmarshaller : IUnmarshaller<SecretValueEntry, XmlUnmarshallerContext>, IUnmarshaller<SecretValueEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SecretValueEntry IUnmarshaller<SecretValueEntry, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SecretValueEntry Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SecretBinary", targetDepth))
                {
                    ...
                    unmarshalledObject.SecretBinary = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SecretString", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecretString = unmarshaller.Unmarshall(context);
                    continue;
                }
