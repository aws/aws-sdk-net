...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecretVersionsListEntryUnmarshaller : IJsonUnmarshaller<SecretVersionsListEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SecretVersionsListEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("KmsKeyIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.KmsKeyIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("VersionStages", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
