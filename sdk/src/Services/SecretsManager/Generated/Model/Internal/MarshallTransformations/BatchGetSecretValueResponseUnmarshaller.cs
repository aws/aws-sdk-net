    ...
    public class BatchGetSecretValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<APIErrorType, APIErrorTypeUnmarshaller>(APIErrorTypeUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SecretValueEntry, SecretValueEntryUnmarshaller>(SecretValueEntryUnmarshaller.Instance);
                    response.SecretValues = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
