...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkloadEstimate operation
    /// </summary>  
    public class UpdateWorkloadEstimateResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkloadEstimateResponse response = new UpdateWorkloadEstimateResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateWorkloadEstimate");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "costCurrency":
                        {
                            context.AddPathSegment("CostCurrency");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.CostCurrency = unmarshaller.Unmarshall(context);
                    ...
                    case "rateTimestamp":
                        {
                            context.AddPathSegment("RateTimestamp");
                            var unmarshaller = CborNullableDateTimeUnmarshaller.Instance;
                            response.RateTimestamp = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "rateType":
                        {
                            context.AddPathSegment("RateType");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.RateType = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "status":
                    ...
                    case "totalCost":
                        {
                            context.AddPathSegment("TotalCost");
        ...
        private static UpdateWorkloadEstimateResponseUnmarshaller _instance = new UpdateWorkloadEstimateResponseUnmarshaller();        

        internal static UpdateWorkloadEstimateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkloadEstimateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
