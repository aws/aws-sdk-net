...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkloadEstimate operation
    /// </summary>  
    public class GetWorkloadEstimateResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkloadEstimateResponse response = new GetWorkloadEstimateResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetWorkloadEstimate");
            reader.ReadStartMap();
        ...
        private static GetWorkloadEstimateResponseUnmarshaller _instance = new GetWorkloadEstimateResponseUnmarshaller();        

        internal static GetWorkloadEstimateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkloadEstimateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
