...
{
    /// <summary>
    /// Response Unmarshaller for ListBillScenarioUsageModifications operation
    /// </summary>  
    public class ListBillScenarioUsageModificationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBillScenarioUsageModificationsResponse response = new ListBillScenarioUsageModificationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListBillScenarioUsageModifications");
            reader.ReadStartMap();
                    ...
                    case "items":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<BillScenarioUsageModificationItem, BillScenarioUsageModificationItemUnmarshaller>(BillScenarioUsageModificationItemUnmarshaller.Instance);
        ...
        private static ListBillScenarioUsageModificationsResponseUnmarshaller _instance = new ListBillScenarioUsageModificationsResponseUnmarshaller();        

        internal static ListBillScenarioUsageModificationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBillScenarioUsageModificationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
