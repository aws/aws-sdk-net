...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBillEstimate operation
    /// </summary>  
    public class DeleteBillEstimateResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBillEstimateResponse response = new DeleteBillEstimateResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteBillEstimate");
        ...
        private static DeleteBillEstimateResponseUnmarshaller _instance = new DeleteBillEstimateResponseUnmarshaller();        

        internal static DeleteBillEstimateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBillEstimateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
