...
{
    /// <summary>
    /// BatchCreateBillScenarioCommitmentModification Request Marshaller
    /// </summary>       
    public class BatchCreateBillScenarioCommitmentModificationRequestMarshaller : IMarshaller<IRequest, BatchCreateBillScenarioCommitmentModificationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchCreateBillScenarioCommitmentModificationRequest)input);
        }
        ...
        internal static BatchCreateBillScenarioCommitmentModificationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateBillScenarioCommitmentModificationRequestMarshaller Instance
        {
            get
            {
                return _instance;
