...
{
    /// <summary>
    /// CreateBillEstimate Request Marshaller
    /// </summary>       
    public class CreateBillEstimateRequestMarshaller : IMarshaller<IRequest, CreateBillEstimateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateBillEstimateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateBillEstimateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.BCMPricingCalculator");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/AWSBCMPricingCalculator/operation/CreateBillEstimate";
        ...
        private static CreateBillEstimateRequestMarshaller _instance = new CreateBillEstimateRequestMarshaller();        

        internal static CreateBillEstimateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBillEstimateRequestMarshaller Instance
        {
            get
            {
                return _instance;
