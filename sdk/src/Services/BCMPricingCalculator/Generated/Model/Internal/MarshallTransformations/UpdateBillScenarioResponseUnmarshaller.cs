...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBillScenario operation
    /// </summary>  
    public class UpdateBillScenarioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBillScenarioResponse response = new UpdateBillScenarioResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("billInterval", targetDepth, ref reader))
                {
                    ...
                    response.BillInterval = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("costCategoryGroupSharingPreferenceArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CostCategoryGroupSharingPreferenceArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("groupSharingPreference", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GroupSharingPreference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateBillScenarioResponseUnmarshaller _instance = new UpdateBillScenarioResponseUnmarshaller();        

        internal static UpdateBillScenarioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBillScenarioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
