...
namespace Amazon.BCMPricingCalculator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageQuantityUnmarshaller : ICborUnmarshaller<UsageQuantity, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public UsageQuantity Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "startHour":
                        {
                            context.AddPathSegment("StartHour");
