...
{
    /// <summary>
    /// Container for the parameters to the ListWorkloadEstimates operation.
    /// Lists all workload estimates for the account.
    /// </summary>
    public partial class ListWorkloadEstimatesRequest : AmazonBCMPricingCalculatorRequest
    {
        private FilterTimestamp _createdAtFilter;
        private FilterTimestamp _expiresAtFilter;
        private List<ListWorkloadEstimatesFilter> _filters = AWSConfigs.InitializeCollections ? new List<ListWorkloadEstimatesFilter>() : null;
        ...
        /// </summary>
        public List<ListWorkloadEstimatesFilter> Filters
        {
