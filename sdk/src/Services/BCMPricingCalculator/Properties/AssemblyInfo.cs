...
#if NET472
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Framework 4.7.2) - AWS Billing and Cost Management Pricing Calculator. Initial release of the AWS Billing and Cost Management Pricing Calculator API.")]
