...
namespace Amazon.WellArchitected
{
    ...
    public partial class AmazonWellArchitectedConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("WellArchitected", "4.0.101.6");
        ...
        /// </summary>
        public static new string ServiceId => "WellArchitected";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "wellarchitected";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-03-31";
