...
{
    /// <summary>
    /// Container for the parameters to the ListProfiles operation. List profiles.
    /// </summary>
    public partial class ListProfilesRequest : AmazonWellArchitectedRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ProfileOwnerType property is set.
        /// </summary>
        internal bool IsSetProfileOwnerType() => this.ProfileOwnerType != null;
    }
}
