...
namespace Amazon.WellArchitected.Model
{
    ...
    public partial class GetConsolidatedReportResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Checks to see if the Base64String property is set.
        /// </summary>
        internal bool IsSetBase64String() => this.Base64String != null;
        ...
        /// </summary>
        public List<ConsolidatedReportMetric> Metrics { get; set; } = AWSConfigs.InitializeCollections ? new List<ConsolidatedReportMetric>() : null;
