...
{
    /// <summary>
    /// Container for the parameters to the ListAgentRecommendations operation. Lists active
    /// optimization recommendations for a specified profile with optional filtering by state.
    /// </summary>
