...
{
    /// <summary>
    /// Container for the parameters to the UpdateReviewTemplateLensReview operation. Update
    /// a lens review associated with a review template.
    /// </summary>
    public partial class UpdateReviewTemplateLensReviewRequest : AmazonWellArchitectedRequest
    {
        ...
        /// <summary>
        /// Checks to see if the LensNotes property is set.
        /// </summary>
        internal bool IsSetLensNotes() => this.LensNotes != null;
        ...
        /// </summary>
        public Dictionary<string, string> PillarNotes { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the PillarNotes property is set.
        /// </summary>
        internal bool IsSetPillarNotes() => this.PillarNotes != null && (this.PillarNotes.Count > 0 || !AWSConfigs.InitializeCollections);
