...
{
    /// <summary>
    /// This is the response object from the ListAnswers operation.
    /// </summary>
    public partial class ListAnswersResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<AnswerSummary> AnswerSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<AnswerSummary>() : null;
