...
namespace Amazon.WellArchitected.Model
{
    ...
    public partial class ProfileQuestion
    {
        ...
        /// </summary>
        public List<ProfileChoice> QuestionChoices { get; set; } = AWSConfigs.InitializeCollections ? new List<ProfileChoice>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> SelectedChoiceIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SelectedChoiceIds property is set.
        /// </summary>
        internal bool IsSetSelectedChoiceIds() => this.SelectedChoiceIds != null && (this.SelectedChoiceIds.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
