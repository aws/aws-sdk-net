...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReviewTemplateLensReviewUnmarshaller : IUnmarshaller<ReviewTemplateLensReview, XmlUnmarshallerContext>, IUnmarshaller<ReviewTemplateLensReview, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReviewTemplateLensReview IUnmarshaller<ReviewTemplateLensReview, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ReviewTemplateLensReview Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ReviewTemplatePillarReviewSummary, ReviewTemplatePillarReviewSummaryUnmarshaller>(ReviewTemplatePillarReviewSummaryUnmarshaller.Instance);
