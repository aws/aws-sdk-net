...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateReviewTemplateAnswerRequestMarshaller : IMarshaller<IRequest, UpdateReviewTemplateAnswerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateReviewTemplateAnswerRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetIsApplicable())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.IsApplicable.Value);
            }
            ...
            if (publicRequest.IsSetSelectedChoices())
            {
                ...
                {
                    context.Writer.WriteStringValue(publicRequestSelectedChoicesListValue);
                }
        ...
        private static readonly UpdateReviewTemplateAnswerRequestMarshaller _instance = new();

        internal static UpdateReviewTemplateAnswerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateReviewTemplateAnswerRequestMarshaller Instance => _instance;
    }
}
