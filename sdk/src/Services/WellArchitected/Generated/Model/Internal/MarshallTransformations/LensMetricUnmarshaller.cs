...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LensMetricUnmarshaller : IJsonUnmarshaller<LensMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LensMetric Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PillarMetric, PillarMetricUnmarshaller>(PillarMetricUnmarshaller.Instance);
