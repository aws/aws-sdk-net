...
{
    /// <summary>
    /// UpdateAgentGoal Request Marshaller
    /// </summary>       
    public class UpdateAgentGoalRequestMarshaller : IMarshaller<IRequest, UpdateAgentGoalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAgentGoalRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAgentGoalRequest publicRequest)
        {
        ...
        private static UpdateAgentGoalRequestMarshaller _instance = new UpdateAgentGoalRequestMarshaller();        

        internal static UpdateAgentGoalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentGoalRequestMarshaller Instance
        {
            get
            {
                return _instance;
