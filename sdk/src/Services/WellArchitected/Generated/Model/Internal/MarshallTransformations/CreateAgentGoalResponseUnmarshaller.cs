...
{
    /// <summary>
    /// Response Unmarshaller for CreateAgentGoal operation
    /// </summary>  
    public class CreateAgentGoalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAgentGoalResponse response = new CreateAgentGoalResponse();
        ...
        private static CreateAgentGoalResponseUnmarshaller _instance = new CreateAgentGoalResponseUnmarshaller();        

        internal static CreateAgentGoalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentGoalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
