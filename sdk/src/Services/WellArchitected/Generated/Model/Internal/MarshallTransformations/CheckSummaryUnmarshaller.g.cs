...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CheckSummaryUnmarshaller : IJsonUnmarshaller<CheckSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CheckSummary();
            ...
            {
                if (context.TestExpression("AccountSummary", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static CheckSummaryUnmarshaller Instance => _instance;
    }
}
