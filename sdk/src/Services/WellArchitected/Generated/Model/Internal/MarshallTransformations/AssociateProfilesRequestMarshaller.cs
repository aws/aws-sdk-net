...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateProfilesRequestMarshaller : IMarshaller<IRequest, AssociateProfilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AssociateProfilesRequestMarshaller _instance = new AssociateProfilesRequestMarshaller();        

        internal static AssociateProfilesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateProfilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
