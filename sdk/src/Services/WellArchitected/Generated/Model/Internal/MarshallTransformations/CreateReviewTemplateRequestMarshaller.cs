...
{
    /// <summary>
    /// CreateReviewTemplate Request Marshaller
    /// </summary>       
    public class CreateReviewTemplateRequestMarshaller : IMarshaller<IRequest, CreateReviewTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateReviewTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateReviewTemplateRequest publicRequest)
        {
        ...
        private static CreateReviewTemplateRequestMarshaller _instance = new CreateReviewTemplateRequestMarshaller();        

        internal static CreateReviewTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReviewTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
