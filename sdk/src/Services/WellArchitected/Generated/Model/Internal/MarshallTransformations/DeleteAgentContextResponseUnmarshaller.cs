...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAgentContextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAgentContextResponse response = new DeleteAgentContextResponse();
        ...
        internal static DeleteAgentContextResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentContextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
