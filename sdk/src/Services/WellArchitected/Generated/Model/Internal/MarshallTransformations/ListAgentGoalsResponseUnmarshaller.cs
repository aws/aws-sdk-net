...
{
    /// <summary>
    /// Response Unmarshaller for ListAgentGoals operation
    /// </summary>  
    public class ListAgentGoalsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAgentGoalsResponse response = new ListAgentGoalsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GoalSummary, GoalSummaryUnmarshaller>(GoalSummaryUnmarshaller.Instance);
        ...
        private static ListAgentGoalsResponseUnmarshaller _instance = new ListAgentGoalsResponseUnmarshaller();        

        internal static ListAgentGoalsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentGoalsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
