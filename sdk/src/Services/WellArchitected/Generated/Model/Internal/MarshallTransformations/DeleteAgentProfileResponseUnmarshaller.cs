...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAgentProfile operation
    /// </summary>  
    public class DeleteAgentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAgentProfileResponse response = new DeleteAgentProfileResponse();
        ...
        private static DeleteAgentProfileResponseUnmarshaller _instance = new DeleteAgentProfileResponseUnmarshaller();        

        internal static DeleteAgentProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
