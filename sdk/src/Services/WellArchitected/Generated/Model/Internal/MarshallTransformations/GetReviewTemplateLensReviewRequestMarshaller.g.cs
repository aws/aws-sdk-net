...
{
    /// <summary>
    /// GetReviewTemplateLensReview Request Marshaller
    /// </summary>
    public partial class GetReviewTemplateLensReviewRequestMarshaller : IMarshaller<IRequest, GetReviewTemplateLensReviewRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetReviewTemplateLensReviewRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetReviewTemplateLensReviewRequest publicRequest)
        {
        ...
        private static readonly GetReviewTemplateLensReviewRequestMarshaller _instance = new();

        internal static GetReviewTemplateLensReviewRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetReviewTemplateLensReviewRequestMarshaller Instance => _instance;
    }
}
