...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociateLensesRequestMarshaller : IMarshaller<IRequest, AssociateLensesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(AssociateLensesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetLensAliases())
            {
                ...
                {
                    context.Writer.WriteStringValue(publicRequestLensAliasesListValue);
                }
        ...
        private static readonly AssociateLensesRequestMarshaller _instance = new();

        internal static AssociateLensesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AssociateLensesRequestMarshaller Instance => _instance;
    }
}
