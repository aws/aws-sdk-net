...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdditionalResourcesUnmarshaller : IJsonUnmarshaller<AdditionalResources, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AdditionalResources Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChoiceContent, ChoiceContentUnmarshaller>(ChoiceContentUnmarshaller.Instance);
