...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProfileSummaryUnmarshaller : IJsonUnmarshaller<ProfileSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProfileSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ProfileDescription", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProfileDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
