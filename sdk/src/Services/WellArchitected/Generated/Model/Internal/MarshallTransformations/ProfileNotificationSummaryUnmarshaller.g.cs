...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProfileNotificationSummaryUnmarshaller : IJsonUnmarshaller<ProfileNotificationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProfileNotificationSummary();
            ...
            {
                if (context.TestExpression("CurrentProfileVersion", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LatestProfileVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProfileNotificationSummaryUnmarshaller Instance => _instance;
    }
}
