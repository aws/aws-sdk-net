...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReviewTemplateAnswerSummaryUnmarshaller : IJsonUnmarshaller<ReviewTemplateAnswerSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ReviewTemplateAnswerSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ReviewTemplateAnswerSummary();
            ...
            {
                if (context.TestExpression("AnswerStatus", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReviewTemplateAnswerSummaryUnmarshaller Instance => _instance;
    }
}
