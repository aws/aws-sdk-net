...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProfileUnmarshaller : IJsonUnmarshaller<Profile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Profile();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ProfileQuestions", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProfileUnmarshaller Instance => _instance;
    }
}
