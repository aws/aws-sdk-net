...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMilestoneRequestMarshaller : IMarshaller<IRequest, GetMilestoneRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetMilestoneRequest publicRequest)
        {
            ...
            request.AddPathResource("{MilestoneNumber}", StringUtils.FromInt(publicRequest.MilestoneNumber.Value));
        ...
        private static readonly GetMilestoneRequestMarshaller _instance = new();

        internal static GetMilestoneRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMilestoneRequestMarshaller Instance => _instance;
    }
}
