...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListAgentRecommendationItemsRequestMarshaller : IMarshaller<IRequest, ListAgentRecommendationItemsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListAgentRecommendationItemsRequestMarshaller _instance = new ListAgentRecommendationItemsRequestMarshaller();        

        internal static ListAgentRecommendationItemsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentRecommendationItemsRequestMarshaller Instance
        {
            get
            {
                return _instance;
