...
{
    /// <summary>
    /// Response Unmarshaller for AgentRecommendationItemSummary Object
    /// </summary>  
    public class AgentRecommendationItemSummaryUnmarshaller : IJsonUnmarshaller<AgentRecommendationItemSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AgentRecommendationItemSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AgentRecommendationItemSummary unmarshalledObject = new AgentRecommendationItemSummary();
        ...
        private static AgentRecommendationItemSummaryUnmarshaller _instance = new AgentRecommendationItemSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AgentRecommendationItemSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
