...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAgentContextsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAgentContextsResponse response = new ListAgentContextsResponse();
        ...
        internal static ListAgentContextsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentContextsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
