...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ErrorDetailsUnmarshaller : IJsonUnmarshaller<ErrorDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ErrorDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ErrorDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ErrorDetailsUnmarshaller Instance => _instance;
    }
}
