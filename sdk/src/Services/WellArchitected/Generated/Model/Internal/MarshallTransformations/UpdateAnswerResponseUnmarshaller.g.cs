...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAnswer operation.
    /// </summary>
    public partial class UpdateAnswerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateAnswerResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AnswerUnmarshaller.Instance;
                    unmarshalledObject.Answer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("LensAlias", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LensArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static UpdateAnswerResponseUnmarshaller _instance = new UpdateAnswerResponseUnmarshaller();

        internal static UpdateAnswerResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAnswerResponseUnmarshaller Instance => _instance;
    }
}
