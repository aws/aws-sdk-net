...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAgentContextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAgentContextResponse response = new CreateAgentContextResponse();
        ...
        internal static CreateAgentContextResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentContextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
