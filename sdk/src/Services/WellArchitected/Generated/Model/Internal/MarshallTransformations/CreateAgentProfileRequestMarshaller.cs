...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAgentProfileRequestMarshaller : IMarshaller<IRequest, CreateAgentProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateAgentProfileRequestMarshaller _instance = new CreateAgentProfileRequestMarshaller();        

        internal static CreateAgentProfileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
