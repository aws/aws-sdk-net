...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReviewTemplateLensReviewUnmarshaller : IJsonUnmarshaller<ReviewTemplateLensReview, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReviewTemplateLensReview();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PillarReviewSummaries", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReviewTemplateLensReviewUnmarshaller Instance => _instance;
    }
}
