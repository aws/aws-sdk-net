    ...
    public class ProfileUnmarshaller : IUnmarshaller<Profile, XmlUnmarshallerContext>, IUnmarshaller<Profile, JsonUnmarshallerContext>
    {
        ...
        public Profile Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProfileQuestion, ProfileQuestionUnmarshaller>(ProfileQuestionUnmarshaller.Instance);
                    unmarshalledObject.ProfileQuestions = unmarshaller.Unmarshall(context);
                    continue;
                }
