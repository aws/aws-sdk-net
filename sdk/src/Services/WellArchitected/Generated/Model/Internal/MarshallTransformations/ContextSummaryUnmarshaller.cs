...
{
    /// <summary>
    /// Response Unmarshaller for ContextSummary Object
    /// </summary>  
    public class ContextSummaryUnmarshaller : IJsonUnmarshaller<ContextSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContextSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ContextSummary unmarshalledObject = new ContextSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ContextContentUnmarshaller.Instance;
        ...
        private static ContextSummaryUnmarshaller _instance = new ContextSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContextSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
