...
{
    /// <summary>
    /// GetAgentGoal Request Marshaller
    /// </summary>       
    public class GetAgentGoalRequestMarshaller : IMarshaller<IRequest, GetAgentGoalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAgentGoalRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAgentGoalRequest publicRequest)
        {
        ...
        private static GetAgentGoalRequestMarshaller _instance = new GetAgentGoalRequestMarshaller();        

        internal static GetAgentGoalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentGoalRequestMarshaller Instance
        {
            get
            {
                return _instance;
