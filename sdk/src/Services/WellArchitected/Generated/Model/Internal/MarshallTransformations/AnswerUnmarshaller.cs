...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnswerUnmarshaller : IJsonUnmarshaller<Answer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Answer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ChoiceAnswers", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("HelpfulResourceDisplayText", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HelpfulResourceDisplayText = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("HelpfulResourceUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
