...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAgentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgentProfileResponse response = new GetAgentProfileResponse();
        ...
        internal static GetAgentProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
