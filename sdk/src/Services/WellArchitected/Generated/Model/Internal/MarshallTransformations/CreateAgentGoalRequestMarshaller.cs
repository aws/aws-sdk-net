...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAgentGoalRequestMarshaller : IMarshaller<IRequest, CreateAgentGoalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateAgentGoalRequestMarshaller _instance = new CreateAgentGoalRequestMarshaller();        

        internal static CreateAgentGoalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentGoalRequestMarshaller Instance
        {
            get
            {
                return _instance;
