...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAgentGoalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAgentGoalResponse response = new DeleteAgentGoalResponse();
        ...
        internal static DeleteAgentGoalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentGoalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
