...
{
    /// <summary>
    /// AccountJiraConfigurationInput Marshaller
    /// </summary>
    public partial class AccountJiraConfigurationInputMarshaller : IRequestMarshaller<AccountJiraConfigurationInput, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(AccountJiraConfigurationInput requestObject, JsonMarshallerContext context)
        {
            if (requestObject == null) return;

            if (requestObject.IsSetIntegrationStatus())
            {
                context.Writer.WritePropertyName("IntegrationStatus");
                context.Writer.WriteStringValue(requestObject.IntegrationStatus);
            }
        ...
        /// </summary>
        public readonly static AccountJiraConfigurationInputMarshaller Instance = new AccountJiraConfigurationInputMarshaller();
    }
}
