...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAgentProfile operation.
    /// </summary>
    public partial class UpdateAgentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateAgentProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("aggregationConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AggregationConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.BusinessOverview = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.EligibleForArchitectureGeneration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.EligibleForScheduledGeneration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("fieldErrors", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.FieldErrors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAgentProfileResponseUnmarshaller _instance = new UpdateAgentProfileResponseUnmarshaller();

        internal static UpdateAgentProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAgentProfileResponseUnmarshaller Instance => _instance;
    }
}
