...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReviewTemplateUnmarshaller : IJsonUnmarshaller<ReviewTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ReviewTemplate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ReviewTemplate();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Lenses", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("QuestionCounts", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ShareInvitationId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReviewTemplateUnmarshaller Instance => _instance;
    }
}
