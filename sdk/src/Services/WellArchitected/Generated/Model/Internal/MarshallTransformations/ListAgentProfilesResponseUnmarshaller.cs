...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAgentProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAgentProfilesResponse response = new ListAgentProfilesResponse();
        ...
        internal static ListAgentProfilesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
