...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAgentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAgentProfileResponse response = new UpdateAgentProfileResponse();
        ...
        internal static UpdateAgentProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
