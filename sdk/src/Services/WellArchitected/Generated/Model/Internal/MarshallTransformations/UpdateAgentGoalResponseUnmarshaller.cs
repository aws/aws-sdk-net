...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAgentGoal operation
    /// </summary>  
    public class UpdateAgentGoalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAgentGoalResponse response = new UpdateAgentGoalResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = GoalSummaryUnmarshaller.Instance;
                    response.Goal = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateAgentGoalResponseUnmarshaller _instance = new UpdateAgentGoalResponseUnmarshaller();        

        internal static UpdateAgentGoalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentGoalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
