...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    public class InsightUnmarshaller : IJsonUnmarshaller<Insight, JsonUnmarshallerContext>
    {
        ...
        public Insight Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("signalsDetected", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SignalsDetected = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("usagePattern", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UsagePattern = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
