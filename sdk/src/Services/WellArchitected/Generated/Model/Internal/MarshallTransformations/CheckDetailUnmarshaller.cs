...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CheckDetailUnmarshaller : IUnmarshaller<CheckDetail, XmlUnmarshallerContext>, IUnmarshaller<CheckDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CheckDetail IUnmarshaller<CheckDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CheckDetail Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
