...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PillarReviewSummaryUnmarshaller : IJsonUnmarshaller<PillarReviewSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PillarReviewSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("Notes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PrioritizedRiskCounts", targetDepth, ref reader))
                {
