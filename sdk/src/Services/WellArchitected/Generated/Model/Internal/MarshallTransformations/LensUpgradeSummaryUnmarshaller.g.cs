...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LensUpgradeSummaryUnmarshaller : IJsonUnmarshaller<LensUpgradeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LensUpgradeSummary();
            ...
            {
                if (context.TestExpression("CurrentLensVersion", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LatestLensVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static LensUpgradeSummaryUnmarshaller Instance => _instance;
    }
}
