...
{
    /// <summary>
    /// Response Unmarshaller for StartAgentRecommendationGeneration operation
    /// </summary>  
    public class StartAgentRecommendationGenerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAgentRecommendationGenerationResponse response = new StartAgentRecommendationGenerationResponse();
        ...
        private static StartAgentRecommendationGenerationResponseUnmarshaller _instance = new StartAgentRecommendationGenerationResponseUnmarshaller();        

        internal static StartAgentRecommendationGenerationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAgentRecommendationGenerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
