...
{
    /// <summary>
    /// Response Unmarshaller for GetAgentGoal operation
    /// </summary>  
    public class GetAgentGoalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgentGoalResponse response = new GetAgentGoalResponse();
        ...
        private static GetAgentGoalResponseUnmarshaller _instance = new GetAgentGoalResponseUnmarshaller();        

        internal static GetAgentGoalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentGoalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
