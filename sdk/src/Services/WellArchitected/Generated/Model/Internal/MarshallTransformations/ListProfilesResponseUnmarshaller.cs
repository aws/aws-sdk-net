...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProfileSummary, ProfileSummaryUnmarshaller>(ProfileSummaryUnmarshaller.Instance);
                    response.ProfileSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListProfilesResponseUnmarshaller _instance = new ListProfilesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
