...
{
    /// <summary>
    /// Response Unmarshaller for GetAgentContext operation
    /// </summary>  
    public class GetAgentContextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgentContextResponse response = new GetAgentContextResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ContextSummaryUnmarshaller.Instance;
                    response.Context = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetAgentContextResponseUnmarshaller _instance = new GetAgentContextResponseUnmarshaller();        

        internal static GetAgentContextResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentContextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
