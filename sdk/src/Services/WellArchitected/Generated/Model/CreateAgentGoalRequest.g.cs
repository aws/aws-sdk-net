...
{
    /// <summary>
    /// Container for the parameters to the CreateAgentGoal operation. Creates an optimization
    /// goal associated with a profile. Goals define specific targets and objectives for the
