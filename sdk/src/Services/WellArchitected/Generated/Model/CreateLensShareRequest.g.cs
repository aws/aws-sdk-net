...
{
    /// <summary>
    /// Container for the parameters to the CreateLensShare operation. Create a lens share.
    /// <para> The owner of a lens can share it with other Amazon Web Services accounts, users,
    ...
    /// be shared. </para> <para> Shared access to a lens is not removed until the lens invitation
    /// is deleted. </para> <para> If you share a lens with an organization or OU, all accounts
    /// in the organization or OU are granted access to the lens. </para> <para> For more
    /// information, see <a href="https://docs.aws.amazon.com/wellarchitected/latest/userguide/lenses-sharing.html">Sharing
    /// a custom lens</a> in the <i>Well-Architected Tool User Guide</i>. </para> <note> <para>
