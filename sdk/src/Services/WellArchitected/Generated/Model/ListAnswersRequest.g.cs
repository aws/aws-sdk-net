...
{
    /// <summary>
    /// Container for the parameters to the ListAnswers operation. List of answers for a particular
    /// workload and lens.
    /// </summary>
    public partial class ListAnswersRequest : AmazonWellArchitectedRequest
    {
        ...
        /// <summary>
        /// Checks to see if the QuestionPriority property is set.
        /// </summary>
        internal bool IsSetQuestionPriority() => this.QuestionPriority != null;
