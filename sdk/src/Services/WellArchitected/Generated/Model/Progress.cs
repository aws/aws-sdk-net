...
namespace Amazon.WellArchitected.Model
{
    ...
    public partial class Progress
    {
        ...
        {
            get { return this._completionPercentage; }
            set { this._completionPercentage = value; }
        }

        // Check to see if CompletionPercentage property is set
        internal bool IsSetCompletionPercentage()
        {
            return this._completionPercentage.HasValue; 
        }
