...
{
    /// <summary>
    /// Container for the parameters to the DeleteReviewTemplate operation. Delete a review
    /// template. <para> Only the owner of a review template can delete it. </para> <para>
    ...
    /// be able to apply it to new workloads. </para>
    /// </summary>
