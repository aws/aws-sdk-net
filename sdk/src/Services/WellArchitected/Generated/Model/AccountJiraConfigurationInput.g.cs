...
namespace Amazon.WellArchitected.Model
{
    ...
    public partial class AccountJiraConfigurationInput
    {
        ...
        /// </para>
        /// </summary>
        public IntegrationStatusInput IntegrationStatus { get; set; }

        /// <summary>
        /// Checks to see if the IntegrationStatus property is set.
        /// </summary>
        internal bool IsSetIntegrationStatus() => this.IntegrationStatus != null;
        ...
        /// </para>
        /// </summary>
        public AccountJiraIssueManagementStatus IssueManagementStatus { get; set; }
