...
namespace Amazon.WellArchitected.Model
{
    ...
    public partial class Scope
    {
        ...
        public List<string> GoalIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the GoalIds property is set.
        /// </summary>
        internal bool IsSetGoalIds() => this.GoalIds != null && (this.GoalIds.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<PillarItem> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<PillarItem>() : null;
