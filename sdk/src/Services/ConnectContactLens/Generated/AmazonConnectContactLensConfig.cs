...
namespace Amazon.ConnectContactLens
{
    ...
    public partial class AmazonConnectContactLensConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Connect Contact Lens", "4.0.101.2");
        ...
        /// </summary>
        public static new string ServiceId => "Connect Contact Lens";
        ...
        {
            base.ServiceId = "Connect Contact Lens";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "contact-lens";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-08-21";
