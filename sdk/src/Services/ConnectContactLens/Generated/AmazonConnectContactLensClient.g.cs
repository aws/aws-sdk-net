...
namespace Amazon.ConnectContactLens
{
    ...
    public partial class AmazonConnectContactLensClient : AmazonServiceClient, IAmazonConnectContactLens
    {
        ...
        /// 
        /// </summary>
        public AmazonConnectContactLensClient() : base(new AmazonConnectContactLensConfig()) { }
        ...
        public AmazonConnectContactLensClient(RegionEndpoint region) : base(new AmazonConnectContactLensConfig { RegionEndpoint = region }) { }
        ...
        public AmazonConnectContactLensClient(AmazonConnectContactLensConfig config) : base(config) { }
