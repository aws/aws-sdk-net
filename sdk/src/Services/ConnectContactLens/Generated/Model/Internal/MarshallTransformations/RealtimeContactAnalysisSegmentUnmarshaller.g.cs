...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RealtimeContactAnalysisSegmentUnmarshaller : IJsonUnmarshaller<RealtimeContactAnalysisSegment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RealtimeContactAnalysisSegment();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RealtimeContactAnalysisSegmentUnmarshaller Instance => _instance;
    }
}
