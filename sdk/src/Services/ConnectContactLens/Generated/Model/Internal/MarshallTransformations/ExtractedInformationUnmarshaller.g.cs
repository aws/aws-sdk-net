...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExtractedInformationUnmarshaller : IJsonUnmarshaller<ExtractedInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExtractedInformation();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExtractedInformationUnmarshaller Instance => _instance;
    }
}
