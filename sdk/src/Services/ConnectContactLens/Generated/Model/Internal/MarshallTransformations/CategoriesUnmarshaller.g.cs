...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CategoriesUnmarshaller : IJsonUnmarshaller<Categories, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Categories();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CategoriesUnmarshaller Instance => _instance;
    }
}
