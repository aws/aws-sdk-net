...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PointOfInterestUnmarshaller : IJsonUnmarshaller<PointOfInterest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PointOfInterest Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
