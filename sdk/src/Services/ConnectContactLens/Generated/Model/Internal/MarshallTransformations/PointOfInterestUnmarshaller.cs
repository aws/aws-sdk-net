...
{
    /// <summary>
    /// Response Unmarshaller for PointOfInterest Object
    /// </summary>  
    public class PointOfInterestUnmarshaller : IUnmarshaller<PointOfInterest, XmlUnmarshallerContext>, IUnmarshaller<PointOfInterest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PointOfInterest IUnmarshaller<PointOfInterest, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static PointOfInterestUnmarshaller _instance = new PointOfInterestUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PointOfInterestUnmarshaller Instance
        {
            get
            {
                return _instance;
