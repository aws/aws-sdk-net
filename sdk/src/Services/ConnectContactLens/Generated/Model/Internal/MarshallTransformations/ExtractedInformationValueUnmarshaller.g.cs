...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExtractedInformationValueUnmarshaller : IJsonUnmarshaller<ExtractedInformationValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExtractedInformationValue();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExtractedInformationValueUnmarshaller Instance => _instance;
    }
}
