...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PostContactSummaryUnmarshaller : IJsonUnmarshaller<PostContactSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PostContactSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PostContactSummaryUnmarshaller Instance => _instance;
    }
}
