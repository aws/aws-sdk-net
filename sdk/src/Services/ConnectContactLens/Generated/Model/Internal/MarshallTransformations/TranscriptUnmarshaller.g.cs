...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TranscriptUnmarshaller : IJsonUnmarshaller<Transcript, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Transcript();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TranscriptUnmarshaller Instance => _instance;
    }
}
