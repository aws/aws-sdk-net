...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRealtimeContactAnalysisSegmentsRequestMarshaller : IMarshaller<IRequest, ListRealtimeContactAnalysisSegmentsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListRealtimeContactAnalysisSegmentsRequestMarshaller _instance = new();

        internal static ListRealtimeContactAnalysisSegmentsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRealtimeContactAnalysisSegmentsRequestMarshaller Instance => _instance;
    }
}
