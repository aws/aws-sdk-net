...
namespace Amazon.ConnectContactLens.Internal
{
    /// <summary>
    /// Amazon ConnectContactLens endpoint resolver.
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for ConnectContactLens service requests.
    /// <para />
    /// Collects values for <see cref="ConnectContactLensEndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonConnectContactLensEndpointProvider"/>.
    /// <para />
    /// Responsible for setting authentication and HTTP headers provided by resolved endpoint.
    /// </summary>
    public class AmazonConnectContactLensEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonConnectContactLensConfig)requestContext.ClientConfig;
            var result = new ConnectContactLensEndpointParameters();
