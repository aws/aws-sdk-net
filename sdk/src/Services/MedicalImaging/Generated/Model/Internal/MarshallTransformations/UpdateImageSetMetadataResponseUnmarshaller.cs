...
{
    /// <summary>
    /// Response Unmarshaller for UpdateImageSetMetadata operation
    /// </summary>  
    public class UpdateImageSetMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateImageSetMetadataResponse response = new UpdateImageSetMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("imageSetId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageSetId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("imageSetState", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageSetState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("imageSetWorkflowStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageSetWorkflowStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("latestVersionId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LatestVersionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateImageSetMetadataResponseUnmarshaller _instance = new UpdateImageSetMetadataResponseUnmarshaller();        

        internal static UpdateImageSetMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateImageSetMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
