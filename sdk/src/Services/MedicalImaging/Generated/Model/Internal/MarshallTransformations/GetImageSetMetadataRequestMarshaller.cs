...
{
    /// <summary>
    /// GetImageSetMetadata Request Marshaller
    /// </summary>       
    public class GetImageSetMetadataRequestMarshaller : IMarshaller<IRequest, GetImageSetMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetImageSetMetadataRequest)input);
        }
        ...
        public IRequest Marshall(GetImageSetMetadataRequest publicRequest)
        {
            ...
            request.ResourcePath = "/datastore/{datastoreId}/imageSet/{imageSetId}/getImageSetMetadata";
        ...
        private static GetImageSetMetadataRequestMarshaller _instance = new GetImageSetMetadataRequestMarshaller();        

        internal static GetImageSetMetadataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImageSetMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
