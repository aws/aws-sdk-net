    ...
    public class GetImageSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageSetArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("isPrimary", targetDepth))
                {
                    ...
                    response.IsPrimary = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastAccessedAt", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.LastAccessedAt = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StorageTier = unmarshaller.Unmarshall(context);
                    continue;
                }
