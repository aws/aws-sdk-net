...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImageSet operation
    /// </summary>  
    public class DeleteImageSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImageSetResponse response = new DeleteImageSetResponse();
        ...
        private static DeleteImageSetResponseUnmarshaller _instance = new DeleteImageSetResponseUnmarshaller();        

        internal static DeleteImageSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImageSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
