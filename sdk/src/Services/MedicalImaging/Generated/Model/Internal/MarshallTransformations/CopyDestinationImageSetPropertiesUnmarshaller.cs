...
namespace Amazon.MedicalImaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CopyDestinationImageSetPropertiesUnmarshaller : IJsonUnmarshaller<CopyDestinationImageSetProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CopyDestinationImageSetProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("imageSetArn", targetDepth, ref reader))
                {
