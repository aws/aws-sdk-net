...
namespace Amazon.Backup.Internal
{
    ...
    public class AmazonBackupAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBackupAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Backup.
        /// </summary>
        public AmazonBackupAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBackupAuthSchemeParameters
            {
    ...
    public class AmazonBackupAuthSchemeResolver : IAuthSchemeResolver<AmazonBackupAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBackupAuthSchemeParameters authParameters)
        {
