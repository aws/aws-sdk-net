...
namespace Amazon.Backup
{
    ...
    public partial class AmazonBackupClient : AmazonServiceClient, IAmazonBackup
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeScanJob">REST API Reference for DescribeScanJob Operation</seealso>
        public virtual IAsyncResult BeginDescribeScanJob(DescribeScanJobRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = DescribeScanJobRequestMarshaller.Instance;
            options.ResponseUnmarshaller = DescribeScanJobResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeScanJob">REST API Reference for DescribeScanJob Operation</seealso>
        public virtual DescribeScanJobResponse EndDescribeScanJob(IAsyncResult asyncResult)
        {
            return EndInvoke<DescribeScanJobResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListScanJobs">REST API Reference for ListScanJobs Operation</seealso>
        public virtual IAsyncResult BeginListScanJobs(ListScanJobsRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListScanJobsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListScanJobsResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListScanJobs">REST API Reference for ListScanJobs Operation</seealso>
        public virtual ListScanJobsResponse EndListScanJobs(IAsyncResult asyncResult)
        {
            return EndInvoke<ListScanJobsResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListScanJobSummaries">REST API Reference for ListScanJobSummaries Operation</seealso>
        public virtual IAsyncResult BeginListScanJobSummaries(ListScanJobSummariesRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListScanJobSummariesRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListScanJobSummariesResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListScanJobSummaries">REST API Reference for ListScanJobSummaries Operation</seealso>
        public virtual ListScanJobSummariesResponse EndListScanJobSummaries(IAsyncResult asyncResult)
        {
            return EndInvoke<ListScanJobSummariesResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/StartScanJob">REST API Reference for StartScanJob Operation</seealso>
        public virtual IAsyncResult BeginStartScanJob(StartScanJobRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = StartScanJobRequestMarshaller.Instance;
            options.ResponseUnmarshaller = StartScanJobResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/StartScanJob">REST API Reference for StartScanJob Operation</seealso>
        public virtual StartScanJobResponse EndStartScanJob(IAsyncResult asyncResult)
        {
            return EndInvoke<StartScanJobResponse>(asyncResult);
        }
