...
namespace Amazon.Backup.Model
{
    ...
    public partial class MissingParameterValueException : AmazonBackupException
    {
        ...
        public MissingParameterValueException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MissingParameterValueException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
