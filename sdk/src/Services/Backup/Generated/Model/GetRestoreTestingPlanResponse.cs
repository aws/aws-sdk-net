...
namespace Amazon.Backup.Model
{
    ...
    /// </summary>
    public partial class GetRestoreTestingPlanResponse : AmazonWebServiceResponse
    {
        private RestoreTestingPlanForGet _restoreTestingPlan;

        /// <summary>
        /// Gets and sets the property RestoreTestingPlan. 
        /// <para>
        /// Specifies the body of a restore testing plan. Includes <c>RestoreTestingPlanName</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public RestoreTestingPlanForGet RestoreTestingPlan
        {
