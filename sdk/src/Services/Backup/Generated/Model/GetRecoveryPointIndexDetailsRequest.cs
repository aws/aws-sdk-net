...
{
    /// <summary>
    /// Container for the parameters to the GetRecoveryPointIndexDetails operation.
    /// This operation returns the metadata and details specific to the backup index associated
    /// with the specified recovery point.
    /// </summary>
    public partial class GetRecoveryPointIndexDetailsRequest : AmazonBackupRequest
    {
