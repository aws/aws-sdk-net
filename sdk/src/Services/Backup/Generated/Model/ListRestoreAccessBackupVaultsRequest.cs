...
{
    /// <summary>
    /// Container for the parameters to the ListRestoreAccessBackupVaults operation.
    /// Returns a list of restore access backup vaults associated with a specified backup
    /// vault.
    /// </summary>
    public partial class ListRestoreAccessBackupVaultsRequest : AmazonBackupRequest
    {
