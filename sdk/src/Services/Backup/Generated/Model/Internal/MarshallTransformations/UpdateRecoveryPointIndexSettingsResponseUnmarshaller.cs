...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRecoveryPointIndexSettings operation
    /// </summary>  
    public class UpdateRecoveryPointIndexSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRecoveryPointIndexSettingsResponse response = new UpdateRecoveryPointIndexSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Index = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateRecoveryPointIndexSettingsResponseUnmarshaller _instance = new UpdateRecoveryPointIndexSettingsResponseUnmarshaller();        

        internal static UpdateRecoveryPointIndexSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecoveryPointIndexSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
