...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFramework operation
    /// </summary>  
    public class DescribeFrameworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFrameworkResponse response = new DescribeFrameworkResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FrameworkControl, FrameworkControlUnmarshaller>(FrameworkControlUnmarshaller.Instance);
                    response.FrameworkControls = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FrameworkDescription", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FrameworkDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FrameworkStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("IdempotencyToken", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.IdempotencyToken = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeFrameworkResponseUnmarshaller _instance = new DescribeFrameworkResponseUnmarshaller();        

        internal static DescribeFrameworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFrameworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
