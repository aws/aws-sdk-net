...
{
    /// <summary>
    /// Response Unmarshaller for RevokeRestoreAccessBackupVault operation
    /// </summary>  
    public class RevokeRestoreAccessBackupVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeRestoreAccessBackupVaultResponse response = new RevokeRestoreAccessBackupVaultResponse();
        ...
        private static RevokeRestoreAccessBackupVaultResponseUnmarshaller _instance = new RevokeRestoreAccessBackupVaultResponseUnmarshaller();        

        internal static RevokeRestoreAccessBackupVaultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeRestoreAccessBackupVaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
