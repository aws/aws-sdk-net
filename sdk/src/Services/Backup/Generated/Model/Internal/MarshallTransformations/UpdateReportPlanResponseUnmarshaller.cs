...
{
    /// <summary>
    /// Response Unmarshaller for UpdateReportPlan operation
    /// </summary>  
    public class UpdateReportPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateReportPlanResponse response = new UpdateReportPlanResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReportPlanArn", targetDepth))
                {
                    ...
                    response.ReportPlanArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ReportPlanName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ReportPlanName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateReportPlanResponseUnmarshaller _instance = new UpdateReportPlanResponseUnmarshaller();        

        internal static UpdateReportPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateReportPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
