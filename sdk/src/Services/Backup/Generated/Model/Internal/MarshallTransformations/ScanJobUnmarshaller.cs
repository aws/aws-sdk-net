...
{
    /// <summary>
    /// Response Unmarshaller for ScanJob Object
    /// </summary>  
    public class ScanJobUnmarshaller : IJsonUnmarshaller<ScanJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScanJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ScanJob unmarshalledObject = new ScanJob();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ContinuousScanEndTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.ContinuousScanEndTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ContinuousScanStartTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.ContinuousScanStartTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ScanBaseRecoveryPointArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ScanBaseRecoveryPointArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ScanJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = ScanResultInfoUnmarshaller.Instance;
        ...
        private static ScanJobUnmarshaller _instance = new ScanJobUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ScanJobUnmarshaller Instance
        {
            get
            {
                return _instance;
