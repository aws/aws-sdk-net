...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    public class ListBackupSelectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("BackupSelectionsList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BackupSelectionsListMember, BackupSelectionsListMemberUnmarshaller>(BackupSelectionsListMemberUnmarshaller.Instance);
                    response.BackupSelectionsList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
