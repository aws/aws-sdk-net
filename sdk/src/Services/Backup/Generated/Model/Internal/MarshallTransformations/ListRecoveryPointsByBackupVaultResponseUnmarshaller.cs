    ...
    public class ListRecoveryPointsByBackupVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RecoveryPoints", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RecoveryPointByBackupVault, RecoveryPointByBackupVaultUnmarshaller>(RecoveryPointByBackupVaultUnmarshaller.Instance);
