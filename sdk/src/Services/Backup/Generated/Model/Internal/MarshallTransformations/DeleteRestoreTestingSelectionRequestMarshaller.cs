...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRestoreTestingSelectionRequestMarshaller : IMarshaller<IRequest, DeleteRestoreTestingSelectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteRestoreTestingSelectionRequestMarshaller _instance = new DeleteRestoreTestingSelectionRequestMarshaller();        

        internal static DeleteRestoreTestingSelectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRestoreTestingSelectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
