    ...
    public class ListReportPlansResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReportPlans", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReportPlan, ReportPlanUnmarshaller>(ReportPlanUnmarshaller.Instance);
                    response.ReportPlans = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
