...
{
    /// <summary>
    /// Response Unmarshaller for CreateRestoreTestingSelection operation
    /// </summary>  
    public class CreateRestoreTestingSelectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRestoreTestingSelectionResponse response = new CreateRestoreTestingSelectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RestoreTestingSelectionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateRestoreTestingSelectionResponseUnmarshaller _instance = new CreateRestoreTestingSelectionResponseUnmarshaller();        

        internal static CreateRestoreTestingSelectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRestoreTestingSelectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
