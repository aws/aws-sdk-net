...
{
    /// <summary>
    /// CreateRestoreTestingSelection Request Marshaller
    /// </summary>       
    public class CreateRestoreTestingSelectionRequestMarshaller : IMarshaller<IRequest, CreateRestoreTestingSelectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRestoreTestingSelectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateRestoreTestingSelectionRequest publicRequest)
        {
        ...
        private static CreateRestoreTestingSelectionRequestMarshaller _instance = new CreateRestoreTestingSelectionRequestMarshaller();        

        internal static CreateRestoreTestingSelectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRestoreTestingSelectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
