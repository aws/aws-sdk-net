...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    public class ListBackupPlanTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("BackupPlanTemplatesList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BackupPlanTemplatesListMember, BackupPlanTemplatesListMemberUnmarshaller>(BackupPlanTemplatesListMemberUnmarshaller.Instance);
                    response.BackupPlanTemplatesList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
