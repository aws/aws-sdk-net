...
{
    /// <summary>
    /// Response Unmarshaller for StartReportJob operation
    /// </summary>  
    public class StartReportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartReportJobResponse response = new StartReportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ReportJobId", targetDepth))
                {
                    ...
                    response.ReportJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartReportJobResponseUnmarshaller _instance = new StartReportJobResponseUnmarshaller();        

        internal static StartReportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartReportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
