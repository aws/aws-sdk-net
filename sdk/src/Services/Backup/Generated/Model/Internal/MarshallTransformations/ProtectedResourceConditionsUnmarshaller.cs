...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    public class ProtectedResourceConditionsUnmarshaller : IUnmarshaller<ProtectedResourceConditions, XmlUnmarshallerContext>, IUnmarshaller<ProtectedResourceConditions, JsonUnmarshallerContext>
    {
        ...
        private static ProtectedResourceConditionsUnmarshaller _instance = new ProtectedResourceConditionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProtectedResourceConditionsUnmarshaller Instance
        {
            get
            {
                return _instance;
