...
{
    /// <summary>
    /// Response Unmarshaller for ListReportJobs operation
    /// </summary>  
    public class ListReportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReportJobsResponse response = new ListReportJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReportJobs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReportJob, ReportJobUnmarshaller>(ReportJobUnmarshaller.Instance);
                    response.ReportJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListReportJobsResponseUnmarshaller _instance = new ListReportJobsResponseUnmarshaller();        

        internal static ListReportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
