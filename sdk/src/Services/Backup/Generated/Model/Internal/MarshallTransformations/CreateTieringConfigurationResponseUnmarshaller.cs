...
{
    /// <summary>
    /// Response Unmarshaller for CreateTieringConfiguration operation
    /// </summary>  
    public class CreateTieringConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTieringConfigurationResponse response = new CreateTieringConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TieringConfigurationArn", targetDepth))
                {
                    ...
                    response.TieringConfigurationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TieringConfigurationName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TieringConfigurationName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateTieringConfigurationResponseUnmarshaller _instance = new CreateTieringConfigurationResponseUnmarshaller();        

        internal static CreateTieringConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTieringConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
