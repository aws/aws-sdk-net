...
{
    /// <summary>
    /// Response Unmarshaller for ListBackupJobSummaries operation
    /// </summary>  
    public class ListBackupJobSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBackupJobSummariesResponse response = new ListBackupJobSummariesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("BackupJobSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BackupJobSummary, BackupJobSummaryUnmarshaller>(BackupJobSummaryUnmarshaller.Instance);
                    response.BackupJobSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListBackupJobSummariesResponseUnmarshaller _instance = new ListBackupJobSummariesResponseUnmarshaller();        

        internal static ListBackupJobSummariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBackupJobSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
