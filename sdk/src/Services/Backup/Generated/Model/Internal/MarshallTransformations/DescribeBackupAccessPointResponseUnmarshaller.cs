...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBackupAccessPoint operation
    /// </summary>  
    public class DescribeBackupAccessPointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBackupAccessPointResponse response = new DescribeBackupAccessPointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AccessPointMetadata", targetDepth, ref reader))
                {
                    ...
                    response.AccessPointMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeBackupAccessPointResponseUnmarshaller _instance = new DescribeBackupAccessPointResponseUnmarshaller();        

        internal static DescribeBackupAccessPointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBackupAccessPointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
