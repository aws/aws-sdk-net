...
{
    /// <summary>
    /// Response Unmarshaller for GetRestoreJobMetadata operation
    /// </summary>  
    public class GetRestoreJobMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRestoreJobMetadataResponse response = new GetRestoreJobMetadataResponse();
        ...
        private static GetRestoreJobMetadataResponseUnmarshaller _instance = new GetRestoreJobMetadataResponseUnmarshaller();        

        internal static GetRestoreJobMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRestoreJobMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
