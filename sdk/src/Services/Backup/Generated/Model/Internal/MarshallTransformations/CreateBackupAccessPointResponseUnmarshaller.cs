...
{
    /// <summary>
    /// Response Unmarshaller for CreateBackupAccessPoint operation
    /// </summary>  
    public class CreateBackupAccessPointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBackupAccessPointResponse response = new CreateBackupAccessPointResponse();
        ...
        private static CreateBackupAccessPointResponseUnmarshaller _instance = new CreateBackupAccessPointResponseUnmarshaller();        

        internal static CreateBackupAccessPointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBackupAccessPointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
