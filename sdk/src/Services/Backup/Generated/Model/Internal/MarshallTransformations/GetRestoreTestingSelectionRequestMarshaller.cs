...
{
    /// <summary>
    /// GetRestoreTestingSelection Request Marshaller
    /// </summary>       
    public class GetRestoreTestingSelectionRequestMarshaller : IMarshaller<IRequest, GetRestoreTestingSelectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRestoreTestingSelectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRestoreTestingSelectionRequest publicRequest)
        {
        ...
        private static GetRestoreTestingSelectionRequestMarshaller _instance = new GetRestoreTestingSelectionRequestMarshaller();        

        internal static GetRestoreTestingSelectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRestoreTestingSelectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
