...
{
    /// <summary>
    /// Response Unmarshaller for ExportBackupPlanTemplate operation
    /// </summary>  
    public class ExportBackupPlanTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportBackupPlanTemplateResponse response = new ExportBackupPlanTemplateResponse();
            ...
            {
                if (context.TestExpression("BackupPlanTemplateJson", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BackupPlanTemplateJson = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ExportBackupPlanTemplateResponseUnmarshaller _instance = new ExportBackupPlanTemplateResponseUnmarshaller();        

        internal static ExportBackupPlanTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportBackupPlanTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
