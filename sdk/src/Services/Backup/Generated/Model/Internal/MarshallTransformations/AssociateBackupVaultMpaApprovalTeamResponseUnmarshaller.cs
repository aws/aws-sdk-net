...
{
    /// <summary>
    /// Response Unmarshaller for AssociateBackupVaultMpaApprovalTeam operation
    /// </summary>  
    public class AssociateBackupVaultMpaApprovalTeamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateBackupVaultMpaApprovalTeamResponse response = new AssociateBackupVaultMpaApprovalTeamResponse();
        ...
        private static AssociateBackupVaultMpaApprovalTeamResponseUnmarshaller _instance = new AssociateBackupVaultMpaApprovalTeamResponseUnmarshaller();        

        internal static AssociateBackupVaultMpaApprovalTeamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateBackupVaultMpaApprovalTeamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
