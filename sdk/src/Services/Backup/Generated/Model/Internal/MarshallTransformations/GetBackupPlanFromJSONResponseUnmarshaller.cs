...
{
    /// <summary>
    /// Response Unmarshaller for GetBackupPlanFromJSON operation
    /// </summary>  
    public class GetBackupPlanFromJSONResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBackupPlanFromJSONResponse response = new GetBackupPlanFromJSONResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("BackupPlan", targetDepth, ref reader))
                {
                    var unmarshaller = BackupPlanUnmarshaller.Instance;
                    response.BackupPlan = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetBackupPlanFromJSONResponseUnmarshaller _instance = new GetBackupPlanFromJSONResponseUnmarshaller();        

        internal static GetBackupPlanFromJSONResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBackupPlanFromJSONResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
