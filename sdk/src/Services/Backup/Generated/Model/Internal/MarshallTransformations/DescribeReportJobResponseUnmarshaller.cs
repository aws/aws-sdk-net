...
{
    /// <summary>
    /// Response Unmarshaller for DescribeReportJob operation
    /// </summary>  
    public class DescribeReportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeReportJobResponse response = new DescribeReportJobResponse();
            ...
            {
                if (context.TestExpression("ReportJob", targetDepth, ref reader))
                {
                    var unmarshaller = ReportJobUnmarshaller.Instance;
                    response.ReportJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeReportJobResponseUnmarshaller _instance = new DescribeReportJobResponseUnmarshaller();        

        internal static DescribeReportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeReportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
