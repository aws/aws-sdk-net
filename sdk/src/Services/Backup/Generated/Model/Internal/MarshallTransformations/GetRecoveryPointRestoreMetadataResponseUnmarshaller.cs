...
{
    /// <summary>
    /// Response Unmarshaller for GetRecoveryPointRestoreMetadata operation
    /// </summary>  
    public class GetRecoveryPointRestoreMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRecoveryPointRestoreMetadataResponse response = new GetRecoveryPointRestoreMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RestoreMetadata", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    response.RestoreMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRecoveryPointRestoreMetadataResponseUnmarshaller _instance = new GetRecoveryPointRestoreMetadataResponseUnmarshaller();        

        internal static GetRecoveryPointRestoreMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRecoveryPointRestoreMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
