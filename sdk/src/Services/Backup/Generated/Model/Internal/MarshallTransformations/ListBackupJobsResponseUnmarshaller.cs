...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    public class ListBackupJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("BackupJobs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BackupJob, BackupJobUnmarshaller>(BackupJobUnmarshaller.Instance);
                    response.BackupJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
