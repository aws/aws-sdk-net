...
{
    /// <summary>
    /// Response Unmarshaller for StartScanJob operation
    /// </summary>  
    public class StartScanJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartScanJobResponse response = new StartScanJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ScanJobId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScanJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartScanJobResponseUnmarshaller _instance = new StartScanJobResponseUnmarshaller();        

        internal static StartScanJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartScanJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
