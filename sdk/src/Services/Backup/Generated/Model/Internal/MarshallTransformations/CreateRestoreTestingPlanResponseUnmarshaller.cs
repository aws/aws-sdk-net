...
{
    /// <summary>
    /// Response Unmarshaller for CreateRestoreTestingPlan operation
    /// </summary>  
    public class CreateRestoreTestingPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRestoreTestingPlanResponse response = new CreateRestoreTestingPlanResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RestoreTestingPlanArn", targetDepth))
                {
                    ...
                    response.RestoreTestingPlanArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RestoreTestingPlanName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RestoreTestingPlanName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateRestoreTestingPlanResponseUnmarshaller _instance = new CreateRestoreTestingPlanResponseUnmarshaller();        

        internal static CreateRestoreTestingPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRestoreTestingPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
