...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBackupAccessPoint operation
    /// </summary>  
    public class DeleteBackupAccessPointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBackupAccessPointResponse response = new DeleteBackupAccessPointResponse();
        ...
        private static DeleteBackupAccessPointResponseUnmarshaller _instance = new DeleteBackupAccessPointResponseUnmarshaller();        

        internal static DeleteBackupAccessPointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBackupAccessPointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
