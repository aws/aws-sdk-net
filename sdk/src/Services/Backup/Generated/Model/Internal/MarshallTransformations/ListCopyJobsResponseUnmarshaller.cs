...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    public class ListCopyJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("CopyJobs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CopyJob, CopyJobUnmarshaller>(CopyJobUnmarshaller.Instance);
                    response.CopyJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
