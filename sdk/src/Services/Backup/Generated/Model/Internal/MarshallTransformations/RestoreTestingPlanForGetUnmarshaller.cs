    ...
    public class RestoreTestingPlanForGetUnmarshaller : IJsonUnmarshaller<RestoreTestingPlanForGet, JsonUnmarshallerContext>
    {
        ...
        public RestoreTestingPlanForGet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LastExecutionTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                ...
                if (context.TestExpression("RestoreTestingPlanArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RestoreTestingPlanArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RestoreTestingPlanName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("StartWindowHours", targetDepth, ref reader))
                {
        ...
        private static RestoreTestingPlanForGetUnmarshaller _instance = new RestoreTestingPlanForGetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RestoreTestingPlanForGetUnmarshaller Instance
        {
            get
            {
                return _instance;
