...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFramework operation
    /// </summary>  
    public class UpdateFrameworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFrameworkResponse response = new UpdateFrameworkResponse();
        ...
        private static UpdateFrameworkResponseUnmarshaller _instance = new UpdateFrameworkResponseUnmarshaller();        

        internal static UpdateFrameworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFrameworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
