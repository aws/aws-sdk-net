...
{
    /// <summary>
    /// Response Unmarshaller for ListFrameworks operation
    /// </summary>  
    public class ListFrameworksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFrameworksResponse response = new ListFrameworksResponse();
            ...
            {
                if (context.TestExpression("Frameworks", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Framework, FrameworkUnmarshaller>(FrameworkUnmarshaller.Instance);
                    response.Frameworks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFrameworksResponseUnmarshaller _instance = new ListFrameworksResponseUnmarshaller();        

        internal static ListFrameworksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFrameworksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
