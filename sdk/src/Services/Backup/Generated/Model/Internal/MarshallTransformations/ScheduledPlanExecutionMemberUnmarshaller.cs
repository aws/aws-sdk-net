...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduledPlanExecutionMemberUnmarshaller : IJsonUnmarshaller<ScheduledPlanExecutionMember, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduledPlanExecutionMember Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RuleExecutionType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RuleExecutionType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
