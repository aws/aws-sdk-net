...
namespace Amazon.Backup.Model
{
    ...
    internal sealed partial class ListBackupPlanVersionsPaginator : IPaginator<ListBackupPlanVersionsResponse>, IListBackupPlanVersionsPaginator
    {
        ...
        public IPaginatedEnumerable<BackupPlansListMember> BackupPlanVersionsList => 
            new PaginatedResultKeyResponse<ListBackupPlanVersionsResponse, BackupPlansListMember>(this, (i) => i.BackupPlanVersionsList);
        ...
        async IAsyncEnumerable<ListBackupPlanVersionsResponse> IPaginator<ListBackupPlanVersionsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
