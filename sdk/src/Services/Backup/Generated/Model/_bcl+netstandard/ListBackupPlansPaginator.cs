...
{
    /// <summary>
    /// Base class for ListBackupPlans paginators.
    /// </summary>
    internal sealed partial class ListBackupPlansPaginator : IPaginator<ListBackupPlansResponse>, IListBackupPlansPaginator
    {
        private readonly IAmazonBackup _client;
        private readonly ListBackupPlansRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListBackupPlansResponse> Responses => new PaginatedResponse<ListBackupPlansResponse>(this);
...
#if BCL
        IEnumerable<ListBackupPlansResponse> IPaginator<ListBackupPlansResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListBackupPlans(_request);
        ...
        async IAsyncEnumerable<ListBackupPlansResponse> IPaginator<ListBackupPlansResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListBackupPlansAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
