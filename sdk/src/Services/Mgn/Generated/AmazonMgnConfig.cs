...
namespace Amazon.Mgn
{
    ...
    public partial class AmazonMgnConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("mgn", "4.0.102.2");
        ...
        /// </summary>
        public static new string ServiceId => "mgn";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "mgn";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-02-26";
