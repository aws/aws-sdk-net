...
{
    /// <summary>
    /// Container for the parameters to the TerminateTargetInstances operation. Starts a job
    /// that terminates specific launched EC2 Test and Cutover instances. This command will
    /// not work for any Source Server with a lifecycle.state of TESTING, CUTTING_OVER, or
    /// CUTOVER.
    /// </summary>
