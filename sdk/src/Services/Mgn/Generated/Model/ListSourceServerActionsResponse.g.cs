...
{
    /// <summary>
    /// This is the response object from the ListSourceServerActions operation.
    /// </summary>
    public partial class ListSourceServerActionsResponse : AmazonWebServiceResponse
    {
        ...
        public List<SourceServerActionDocument> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<SourceServerActionDocument>() : null;
