...
{
    /// <summary>
    /// Container for the parameters to the ListNetworkMigrationExecutions operation. Lists
    /// network migration execution instances for a given definition, showing the status and
    ...
    public partial class ListNetworkMigrationExecutionsRequest : AmazonMgnRequest
    {
        ...
        /// </para>
        /// </summary>
        public ListNetworkMigrationExecutionRequestFilters Filters { get; set; }
