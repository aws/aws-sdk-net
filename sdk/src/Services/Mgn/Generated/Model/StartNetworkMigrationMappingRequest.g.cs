...
{
    /// <summary>
    /// Container for the parameters to the StartNetworkMigrationMapping operation. Starts
    /// the network migration mapping process for a given network migration execution.
    /// </summary>
    public partial class StartNetworkMigrationMappingRequest : AmazonMgnRequest
    {
        ...
        /// </para>
        /// </summary>
        public SecurityGroupMappingStrategy SecurityGroupMappingStrategy { get; set; }

        /// <summary>
        /// Checks to see if the SecurityGroupMappingStrategy property is set.
        /// </summary>
        internal bool IsSetSecurityGroupMappingStrategy() => this.SecurityGroupMappingStrategy != null;
    }
}
