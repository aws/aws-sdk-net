...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class JobPostLaunchActionsLaunchStatusUnmarshaller : IJsonUnmarshaller<JobPostLaunchActionsLaunchStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new JobPostLaunchActionsLaunchStatus();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ssmDocument", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ssmDocumentType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static JobPostLaunchActionsLaunchStatusUnmarshaller Instance => _instance;
    }
}
