...
{
    /// <summary>
    /// StartExport Request Marshaller
    /// </summary>
    public partial class StartExportRequestMarshaller : IMarshaller<IRequest, StartExportRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartExportRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(StartExportRequest publicRequest)
        {
        ...
        private static readonly StartExportRequestMarshaller _instance = new();

        internal static StartExportRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartExportRequestMarshaller Instance => _instance;
    }
}
