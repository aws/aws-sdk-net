...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportErrorDataUnmarshaller : IJsonUnmarshaller<ImportErrorData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImportErrorData();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("rowNumber", targetDepth, ref reader))
                {
        ...
        private static ImportErrorDataUnmarshaller _instance = new ImportErrorDataUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ImportErrorDataUnmarshaller Instance => _instance;
    }
}
