...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NetworkMigrationCodeGenerationSegmentUnmarshaller : IJsonUnmarshaller<NetworkMigrationCodeGenerationSegment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new NetworkMigrationCodeGenerationSegment();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("mapperSegmentID", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static NetworkMigrationCodeGenerationSegmentUnmarshaller Instance => _instance;
    }
}
