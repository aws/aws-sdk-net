    ...
    public class DataReplicationInfoUnmarshaller : IJsonUnmarshaller<DataReplicationInfo, JsonUnmarshallerContext>
    {
        ...
        public DataReplicationInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("lastSnapshotDateTime", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("replicatorId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReplicatorId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
