...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChecksumUnmarshaller : IJsonUnmarshaller<Checksum, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Checksum Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hash", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
