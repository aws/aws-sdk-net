...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkMigrationMapperSegmentUnmarshaller : IJsonUnmarshaller<NetworkMigrationMapperSegment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkMigrationMapperSegment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("referencedSegments", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.ReferencedSegments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("targetAccount", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
