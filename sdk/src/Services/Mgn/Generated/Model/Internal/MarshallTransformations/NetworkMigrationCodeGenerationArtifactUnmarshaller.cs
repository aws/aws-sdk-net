...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkMigrationCodeGenerationArtifactUnmarshaller : IUnmarshaller<NetworkMigrationCodeGenerationArtifact, XmlUnmarshallerContext>, IUnmarshaller<NetworkMigrationCodeGenerationArtifact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NetworkMigrationCodeGenerationArtifact IUnmarshaller<NetworkMigrationCodeGenerationArtifact, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public NetworkMigrationCodeGenerationArtifact Unmarshall(JsonUnmarshallerContext context)
        {
            NetworkMigrationCodeGenerationArtifact unmarshalledObject = new NetworkMigrationCodeGenerationArtifact();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("artifactSubType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ArtifactSubType = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NetworkMigrationCodeGenerationArtifactUnmarshaller Instance
        {
            get
            {
                return _instance;
