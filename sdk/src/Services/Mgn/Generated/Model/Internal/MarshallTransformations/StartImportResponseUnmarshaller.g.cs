...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartImportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StartImportResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("importTask", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ImportTask = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static StartImportResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartImportResponseUnmarshaller Instance => _instance;
    }
}
