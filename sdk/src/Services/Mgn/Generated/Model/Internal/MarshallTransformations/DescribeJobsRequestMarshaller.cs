...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeJobsRequestMarshaller : IMarshaller<IRequest, DescribeJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeJobsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/DescribeJobs";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetFilters())
            {
                ...
                var marshaller = DescribeJobsRequestFiltersMarshaller.Instance;
        ...
        private static DescribeJobsRequestMarshaller _instance = new DescribeJobsRequestMarshaller();        

        internal static DescribeJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
