...
{
    /// <summary>
    /// Response Unmarshaller for ListWaves operation.
    /// </summary>
    public partial class ListWavesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListWavesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Wave, WaveUnmarshaller>(WaveUnmarshaller.Instance);
        ...
        private static ListWavesResponseUnmarshaller _instance = new ListWavesResponseUnmarshaller();

        internal static ListWavesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWavesResponseUnmarshaller Instance => _instance;
    }
}
