...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeLaunchConfigurationTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeLaunchConfigurationTemplatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LaunchConfigurationTemplate, LaunchConfigurationTemplateUnmarshaller>(LaunchConfigurationTemplateUnmarshaller.Instance);
        ...
        internal static DescribeLaunchConfigurationTemplatesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeLaunchConfigurationTemplatesResponseUnmarshaller Instance => _instance;
    }
}
