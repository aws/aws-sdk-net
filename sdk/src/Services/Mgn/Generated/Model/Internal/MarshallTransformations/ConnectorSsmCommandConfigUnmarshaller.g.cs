...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectorSsmCommandConfigUnmarshaller : IJsonUnmarshaller<ConnectorSsmCommandConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ConnectorSsmCommandConfig();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("cloudWatchOutputEnabled", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("outputS3BucketName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("s3OutputEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConnectorSsmCommandConfigUnmarshaller Instance => _instance;
    }
}
