...
{
    /// <summary>
    /// Response Unmarshaller for PutTemplateAction operation
    /// </summary>  
    public class PutTemplateActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTemplateActionResponse response = new PutTemplateActionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("documentIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static PutTemplateActionResponseUnmarshaller _instance = new PutTemplateActionResponseUnmarshaller();        

        internal static PutTemplateActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTemplateActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
