...
{
    /// <summary>
    /// Response Unmarshaller for StartCutover operation
    /// </summary>  
    public class StartCutoverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartCutoverResponse response = new StartCutoverResponse();
        ...
        private static StartCutoverResponseUnmarshaller _instance = new StartCutoverResponseUnmarshaller();        

        internal static StartCutoverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartCutoverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
