...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DiskUnmarshaller : IJsonUnmarshaller<Disk, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Disk Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Disk();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DiskUnmarshaller Instance => _instance;
    }
}
