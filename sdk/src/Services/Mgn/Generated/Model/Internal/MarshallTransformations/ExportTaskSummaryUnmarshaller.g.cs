...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExportTaskSummaryUnmarshaller : IJsonUnmarshaller<ExportTaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ExportTaskSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ExportTaskSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExportTaskSummaryUnmarshaller Instance => _instance;
    }
}
