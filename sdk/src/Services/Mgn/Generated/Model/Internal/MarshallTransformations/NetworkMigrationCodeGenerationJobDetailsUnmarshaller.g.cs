...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NetworkMigrationCodeGenerationJobDetailsUnmarshaller : IJsonUnmarshaller<NetworkMigrationCodeGenerationJobDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public NetworkMigrationCodeGenerationJobDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new NetworkMigrationCodeGenerationJobDetails();
            ...
            {
                if (context.TestExpression("codeGenerationOutputFormatStatusDetailsMap", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, CodeGenerationOutputFormatStatusDetails, StringUnmarshaller, CodeGenerationOutputFormatStatusDetailsUnmarshaller>(StringUnmarshaller.Instance, CodeGenerationOutputFormatStatusDetailsUnmarshaller.Instance);
                    unmarshalledObject.CodeGenerationOutputFormatStatusDetailsMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static NetworkMigrationCodeGenerationJobDetailsUnmarshaller Instance => _instance;
    }
}
