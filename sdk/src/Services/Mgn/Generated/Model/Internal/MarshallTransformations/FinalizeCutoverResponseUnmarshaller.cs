...
{
    /// <summary>
    /// Response Unmarshaller for FinalizeCutover operation
    /// </summary>  
    public class FinalizeCutoverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            FinalizeCutoverResponse response = new FinalizeCutoverResponse();
        ...
        private static FinalizeCutoverResponseUnmarshaller _instance = new FinalizeCutoverResponseUnmarshaller();        

        internal static FinalizeCutoverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FinalizeCutoverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
