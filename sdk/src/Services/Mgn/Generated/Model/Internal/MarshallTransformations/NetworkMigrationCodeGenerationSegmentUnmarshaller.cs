...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkMigrationCodeGenerationSegmentUnmarshaller : IUnmarshaller<NetworkMigrationCodeGenerationSegment, XmlUnmarshallerContext>, IUnmarshaller<NetworkMigrationCodeGenerationSegment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NetworkMigrationCodeGenerationSegment IUnmarshaller<NetworkMigrationCodeGenerationSegment, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public NetworkMigrationCodeGenerationSegment Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<NetworkMigrationCodeGenerationArtifact, NetworkMigrationCodeGenerationArtifactUnmarshaller>(NetworkMigrationCodeGenerationArtifactUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MapperSegmentID = unmarshaller.Unmarshall(context);
                    continue;
                }
