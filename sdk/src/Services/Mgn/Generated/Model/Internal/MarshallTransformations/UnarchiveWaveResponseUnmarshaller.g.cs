...
{
    /// <summary>
    /// Response Unmarshaller for UnarchiveWave operation.
    /// </summary>
    public partial class UnarchiveWaveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UnarchiveWaveResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("waveAggregatedStatus", targetDepth, ref reader))
                {
                    var unmarshaller = WaveAggregatedStatusUnmarshaller.Instance;
                    unmarshalledObject.WaveAggregatedStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UnarchiveWaveResponseUnmarshaller _instance = new UnarchiveWaveResponseUnmarshaller();

        internal static UnarchiveWaveResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UnarchiveWaveResponseUnmarshaller Instance => _instance;
    }
}
