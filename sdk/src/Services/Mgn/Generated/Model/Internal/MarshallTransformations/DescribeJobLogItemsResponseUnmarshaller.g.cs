...
{
    /// <summary>
    /// Response Unmarshaller for DescribeJobLogItems operation.
    /// </summary>
    public partial class DescribeJobLogItemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeJobLogItemsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<JobLog, JobLogUnmarshaller>(JobLogUnmarshaller.Instance);
        ...
        private static DescribeJobLogItemsResponseUnmarshaller _instance = new DescribeJobLogItemsResponseUnmarshaller();

        internal static DescribeJobLogItemsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeJobLogItemsResponseUnmarshaller Instance => _instance;
    }
}
