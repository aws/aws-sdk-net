...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportTaskUnmarshaller : IJsonUnmarshaller<ImportTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImportTask();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("s3BucketSource", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ImportTaskUnmarshaller Instance => _instance;
    }
}
