...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportFileEnrichmentUnmarshaller : IJsonUnmarshaller<ImportFileEnrichment, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ImportFileEnrichment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ImportFileEnrichment();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("s3BucketTarget", targetDepth, ref reader))
                {
                    var unmarshaller = EnrichmentTargetS3ConfigurationUnmarshaller.Instance;
                    unmarshalledObject.S3BucketTarget = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static ImportFileEnrichmentUnmarshaller Instance => _instance;
    }
}
