...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReplicationConfigurationReplicatedDiskUnmarshaller : IJsonUnmarshaller<ReplicationConfigurationReplicatedDisk, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReplicationConfigurationReplicatedDisk();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("isBootDisk", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("stagingDiskType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReplicationConfigurationReplicatedDiskUnmarshaller Instance => _instance;
    }
}
