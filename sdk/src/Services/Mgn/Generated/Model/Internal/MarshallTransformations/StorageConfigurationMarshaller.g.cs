...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StorageConfigurationMarshaller : IRequestMarshaller<StorageConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(StorageConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetFsxOntapConfiguration())
            {
                context.Writer.WritePropertyName("fsxOntapConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = FsxOntapConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.FsxOntapConfiguration, context);
