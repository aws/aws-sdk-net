...
namespace Amazon.Mgn.Model
{
    ...
    public partial class CidrMapping
    {
        ...
        public string OriginalCidr { get; set; }

        /// <summary>
        /// Checks to see if the OriginalCidr property is set.
        /// </summary>
        internal bool IsSetOriginalCidr() => this.OriginalCidr != null;
        ...
        /// </summary>
        [AWSProperty(Required = true, Min = 9, Max = 18)]
        public string UpdatedCidr { get; set; }

        /// <summary>
        /// Checks to see if the UpdatedCidr property is set.
        /// </summary>
        internal bool IsSetUpdatedCidr() => this.UpdatedCidr != null;
    }
}
