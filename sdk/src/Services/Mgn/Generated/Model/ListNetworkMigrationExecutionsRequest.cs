...
{
    /// <summary>
    /// Container for the parameters to the ListNetworkMigrationExecutions operation.
    /// Lists network migration execution instances for a given definition, showing the status
    /// and progress of each execution.
    /// </summary>
    public partial class ListNetworkMigrationExecutionsRequest : AmazonMgnRequest
    {
        private ListNetworkMigrationExecutionRequestFilters _filters;
        ...
        /// </para>
        /// </summary>
        public ListNetworkMigrationExecutionRequestFilters Filters
        {
