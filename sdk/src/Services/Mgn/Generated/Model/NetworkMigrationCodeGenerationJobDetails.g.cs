...
namespace Amazon.Mgn.Model
{
    ...
    public partial class NetworkMigrationCodeGenerationJobDetails
    {
        ...
        public Dictionary<string, CodeGenerationOutputFormatStatusDetails> CodeGenerationOutputFormatStatusDetailsMap { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, CodeGenerationOutputFormatStatusDetails>() : null;

        /// <summary>
        /// Checks to see if the CodeGenerationOutputFormatStatusDetailsMap property is set.
        /// </summary>
        internal bool IsSetCodeGenerationOutputFormatStatusDetailsMap() => this.CodeGenerationOutputFormatStatusDetailsMap != null && (this.CodeGenerationOutputFormatStatusDetailsMap.Count > 0 || !AWSConfigs.InitializeCollections);
