...
{
    /// <summary>
    /// This is the response object from the ListTemplateActions operation.
    /// </summary>
    public partial class ListTemplateActionsResponse : AmazonWebServiceResponse
    {
        ...
        public List<TemplateActionDocument> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<TemplateActionDocument>() : null;
