...
{
    /// <summary>
    /// Container for the parameters to the MarkAsArchived operation. Archives specific Source
    /// Servers by setting the SourceServer.isArchived property to true for specified SourceServers
    /// by ID. This command only works for SourceServers with a lifecycle state that equals
