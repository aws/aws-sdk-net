...
{
    /// <summary>
    /// Container for the parameters to the ListNetworkMigrationAnalysisResults operation.
    /// Lists the results of network migration analyses, showing connectivity and compatibility
    /// findings for migrated resources.
    /// </summary>
    public partial class ListNetworkMigrationAnalysisResultsRequest : AmazonMgnRequest
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public ListNetworkMigrationAnalysisResultsFilters Filters { get; set; }
