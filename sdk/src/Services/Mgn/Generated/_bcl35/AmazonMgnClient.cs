...
namespace Amazon.Mgn
{
    ...
    public partial class AmazonMgnClient : AmazonServiceClient, IAmazonMgn
    {
        ...
        {
            return EndInvoke<ListExportErrorsResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<ListImportErrorsResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<PauseReplicationResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<ResumeReplicationResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<StartExportResponse>(asyncResult);
        }
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/UpdateSourceServer">REST API Reference for UpdateSourceServer Operation</seealso>
        public virtual UpdateSourceServerResponse EndUpdateSourceServer(IAsyncResult asyncResult)
        {
            return EndInvoke<UpdateSourceServerResponse>(asyncResult);
        }
