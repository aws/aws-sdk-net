...
namespace Amazon.Wickr.Internal
{
    ...
    public class AmazonWickrAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWickrAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Wickr.
        /// </summary>
        public AmazonWickrAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWickrAuthSchemeParameters
            {
    ...
    public class AmazonWickrAuthSchemeResolver : IAuthSchemeResolver<AmazonWickrAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWickrAuthSchemeParameters authParameters)
        {
