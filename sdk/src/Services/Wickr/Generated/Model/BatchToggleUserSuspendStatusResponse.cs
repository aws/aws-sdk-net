...
{
    /// <summary>
    /// This is the response object from the BatchToggleUserSuspendStatus operation.
    /// </summary>
    public partial class BatchToggleUserSuspendStatusResponse : AmazonWebServiceResponse
    {
        ...
        private List<BatchUserSuccessResponseItem> _successful = AWSConfigs.InitializeCollections ? new List<BatchUserSuccessResponseItem>() : null;

        /// <summary>
        /// Gets and sets the property Failed. 
        /// <para>
        /// A list of suspend status toggle attempts that failed, including error details explaining
        /// why each user's status could not be changed.
        /// </para>
        /// </summary>
        ...
        /// </para>
        /// </summary>
        public List<BatchUserSuccessResponseItem> Successful
        {
