...
{
    /// <summary>
    /// This is the response object from the ListDevicesForUser operation.
    /// </summary>
    public partial class ListDevicesForUserResponse : AmazonWebServiceResponse
    {
        private List<BasicDeviceObject> _devices = AWSConfigs.InitializeCollections ? new List<BasicDeviceObject>() : null;
        ...
        public List<BasicDeviceObject> Devices
        {
