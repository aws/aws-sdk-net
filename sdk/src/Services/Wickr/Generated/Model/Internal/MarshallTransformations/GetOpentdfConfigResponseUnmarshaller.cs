...
{
    /// <summary>
    /// Response Unmarshaller for GetOpentdfConfig operation
    /// </summary>  
    public class GetOpentdfConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOpentdfConfigResponse response = new GetOpentdfConfigResponse();
        ...
        private static GetOpentdfConfigResponseUnmarshaller _instance = new GetOpentdfConfigResponseUnmarshaller();        

        internal static GetOpentdfConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOpentdfConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
