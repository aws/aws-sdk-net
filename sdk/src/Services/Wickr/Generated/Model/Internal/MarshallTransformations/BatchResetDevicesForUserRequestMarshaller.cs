...
namespace Amazon.Wickr.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchResetDevicesForUserRequestMarshaller : IMarshaller<IRequest, BatchResetDevicesForUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static BatchResetDevicesForUserRequestMarshaller _instance = new BatchResetDevicesForUserRequestMarshaller();        

        internal static BatchResetDevicesForUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchResetDevicesForUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
