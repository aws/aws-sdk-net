...
{
    /// <summary>
    /// Response Unmarshaller for BatchToggleUserSuspendStatus operation
    /// </summary>  
    public class BatchToggleUserSuspendStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchToggleUserSuspendStatusResponse response = new BatchToggleUserSuspendStatusResponse();
        ...
        private static BatchToggleUserSuspendStatusResponseUnmarshaller _instance = new BatchToggleUserSuspendStatusResponseUnmarshaller();        

        internal static BatchToggleUserSuspendStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchToggleUserSuspendStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
