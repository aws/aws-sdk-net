    ...
    public class GetUserRequestMarshaller : IMarshaller<IRequest, GetUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetUserRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetEndTime())
                request.Parameters.Add("endTime", StringUtils.FromDateTimeToUnixTimestamp(publicRequest.EndTime));
            
            if (publicRequest.IsSetStartTime())
                request.Parameters.Add("startTime", StringUtils.FromDateTimeToUnixTimestamp(publicRequest.StartTime));
            request.ResourcePath = "/networks/{networkId}/users/{userId}";
