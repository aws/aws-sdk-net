        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("accessLevel", targetDepth))
                {
                    ...
                    response.AccessLevel = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FreeTrialExpiration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("migrationState", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.MigrationState = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("networkArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.NetworkArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.NetworkName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("standing", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.Standing = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
