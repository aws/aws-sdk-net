...
namespace Amazon.Wickr.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BlockedGuestUserUnmarshaller : IJsonUnmarshaller<BlockedGuestUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BlockedGuestUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
