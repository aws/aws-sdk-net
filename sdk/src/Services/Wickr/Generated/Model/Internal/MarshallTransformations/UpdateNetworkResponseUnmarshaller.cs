...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNetwork operation
    /// </summary>  
    public class UpdateNetworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateNetworkResponseUnmarshaller _instance = new UpdateNetworkResponseUnmarshaller();        

        internal static UpdateNetworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNetworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
