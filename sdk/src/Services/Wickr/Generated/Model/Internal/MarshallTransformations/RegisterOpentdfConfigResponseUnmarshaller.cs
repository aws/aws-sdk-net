...
namespace Amazon.Wickr.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterOpentdfConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterOpentdfConfigResponse response = new RegisterOpentdfConfigResponse();
        ...
        internal static RegisterOpentdfConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterOpentdfConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
