...
{
    /// <summary>
    /// UpdateUserDetails Marshaller
    /// </summary>
    public class UpdateUserDetailsMarshaller : IRequestMarshaller<UpdateUserDetails, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(UpdateUserDetails requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCodeValidation())
            {
                ...
                context.Writer.Write(requestObject.CodeValidation);
            }
            ...
            if(requestObject.IsSetInviteCode())
            {
                ...
                context.Writer.Write(requestObject.InviteCode);
            }

            if(requestObject.IsSetInviteCodeTtl())
            {
                context.Writer.WritePropertyName("inviteCodeTtl");
                context.Writer.Write(requestObject.InviteCodeTtl);
            }
        ...
        /// </summary>
        public readonly static UpdateUserDetailsMarshaller Instance = new UpdateUserDetailsMarshaller();
