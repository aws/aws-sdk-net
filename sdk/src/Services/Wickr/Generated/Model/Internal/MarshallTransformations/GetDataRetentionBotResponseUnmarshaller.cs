        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("botExists", targetDepth))
                {
                    ...
                    response.BotExists = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.IsBotActive = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("isDataRetentionBotRegistered", targetDepth))
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.IsDataRetentionBotRegistered = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("isDataRetentionServiceEnabled", targetDepth))
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.IsDataRetentionServiceEnabled = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("isPubkeyMsgAcked", targetDepth))
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.IsPubkeyMsgAcked = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
