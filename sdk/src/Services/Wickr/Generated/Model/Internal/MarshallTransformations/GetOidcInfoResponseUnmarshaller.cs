...
{
    /// <summary>
    /// Response Unmarshaller for GetOidcInfo operation
    /// </summary>  
    public class GetOidcInfoResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOidcInfoResponse response = new GetOidcInfoResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("openidConnectInfo", targetDepth))
                {
                    ...
                    response.OpenidConnectInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("tokenInfo", targetDepth))
                {
                    var unmarshaller = OidcTokenInfoUnmarshaller.Instance;
                    response.TokenInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetOidcInfoResponseUnmarshaller _instance = new GetOidcInfoResponseUnmarshaller();        

        internal static GetOidcInfoResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOidcInfoResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
