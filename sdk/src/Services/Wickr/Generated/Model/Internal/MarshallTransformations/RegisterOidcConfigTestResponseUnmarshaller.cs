    ...
    public class RegisterOidcConfigTestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EndSessionEndpoint = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("grantTypesSupported", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.GrantTypesSupported = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LogoutEndpoint = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("microsoftMultiRefreshToken", targetDepth))
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.MicrosoftMultiRefreshToken = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("responseTypesSupported", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ResponseTypesSupported = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("revocationEndpoint", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RevocationEndpoint = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scopesSupported", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ScopesSupported = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.TokenEndpointAuthMethodsSupported = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("userinfoEndpoint", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UserinfoEndpoint = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
