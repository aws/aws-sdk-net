...
{
    /// <summary>
    /// Response Unmarshaller for ListSecurityGroups operation
    /// </summary>  
    public class ListSecurityGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListSecurityGroupsResponseUnmarshaller _instance = new ListSecurityGroupsResponseUnmarshaller();        

        internal static ListSecurityGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecurityGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
