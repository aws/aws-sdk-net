...
{
    /// <summary>
    /// Response Unmarshaller for ListSecurityGroupUsers operation
    /// </summary>  
    public class ListSecurityGroupUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSecurityGroupUsersResponse response = new ListSecurityGroupUsersResponse();
        ...
        private static ListSecurityGroupUsersResponseUnmarshaller _instance = new ListSecurityGroupUsersResponseUnmarshaller();        

        internal static ListSecurityGroupUsersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecurityGroupUsersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
