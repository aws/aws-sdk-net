...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataRetentionBotChallenge operation
    /// </summary>  
    public class CreateDataRetentionBotChallengeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataRetentionBotChallengeResponse response = new CreateDataRetentionBotChallengeResponse();
        ...
        private static CreateDataRetentionBotChallengeResponseUnmarshaller _instance = new CreateDataRetentionBotChallengeResponseUnmarshaller();        

        internal static CreateDataRetentionBotChallengeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataRetentionBotChallengeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
