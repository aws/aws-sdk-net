...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDataRetentionBot operation
    /// </summary>  
    public class DeleteDataRetentionBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDataRetentionBotResponse response = new DeleteDataRetentionBotResponse();
        ...
        private static DeleteDataRetentionBotResponseUnmarshaller _instance = new DeleteDataRetentionBotResponseUnmarshaller();        

        internal static DeleteDataRetentionBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDataRetentionBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
