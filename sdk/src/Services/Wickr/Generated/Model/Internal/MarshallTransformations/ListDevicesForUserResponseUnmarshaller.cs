...
{
    /// <summary>
    /// Response Unmarshaller for ListDevicesForUser operation
    /// </summary>  
    public class ListDevicesForUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDevicesForUserResponse response = new ListDevicesForUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BasicDeviceObject, BasicDeviceObjectUnmarshaller>(BasicDeviceObjectUnmarshaller.Instance);
        ...
        private static ListDevicesForUserResponseUnmarshaller _instance = new ListDevicesForUserResponseUnmarshaller();        

        internal static ListDevicesForUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDevicesForUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
