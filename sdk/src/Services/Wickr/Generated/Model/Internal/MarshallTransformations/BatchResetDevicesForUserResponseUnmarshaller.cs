...
{
    /// <summary>
    /// Response Unmarshaller for BatchResetDevicesForUser operation
    /// </summary>  
    public class BatchResetDevicesForUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchResetDevicesForUserResponse response = new BatchResetDevicesForUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDeviceErrorResponseItem, BatchDeviceErrorResponseItemUnmarshaller>(BatchDeviceErrorResponseItemUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDeviceSuccessResponseItem, BatchDeviceSuccessResponseItemUnmarshaller>(BatchDeviceSuccessResponseItemUnmarshaller.Instance);
        ...
        private static BatchResetDevicesForUserResponseUnmarshaller _instance = new BatchResetDevicesForUserResponseUnmarshaller();        

        internal static BatchResetDevicesForUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchResetDevicesForUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
