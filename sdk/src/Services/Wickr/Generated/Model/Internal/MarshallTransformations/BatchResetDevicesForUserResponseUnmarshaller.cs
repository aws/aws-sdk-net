    ...
    public class BatchResetDevicesForUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchDeviceErrorResponseItem, BatchDeviceErrorResponseItemUnmarshaller>(BatchDeviceErrorResponseItemUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchDeviceSuccessResponseItem, BatchDeviceSuccessResponseItemUnmarshaller>(BatchDeviceSuccessResponseItemUnmarshaller.Instance);
