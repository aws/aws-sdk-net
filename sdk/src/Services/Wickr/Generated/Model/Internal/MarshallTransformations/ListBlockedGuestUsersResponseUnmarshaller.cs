...
{
    /// <summary>
    /// Response Unmarshaller for ListBlockedGuestUsers operation
    /// </summary>  
    public class ListBlockedGuestUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBlockedGuestUsersResponse response = new ListBlockedGuestUsersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BlockedGuestUser, BlockedGuestUserUnmarshaller>(BlockedGuestUserUnmarshaller.Instance);
                    response.Blocklist = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListBlockedGuestUsersResponseUnmarshaller _instance = new ListBlockedGuestUsersResponseUnmarshaller();        

        internal static ListBlockedGuestUsersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBlockedGuestUsersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
