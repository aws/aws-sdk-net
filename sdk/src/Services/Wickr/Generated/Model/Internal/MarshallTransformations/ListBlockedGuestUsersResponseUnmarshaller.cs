    ...
    public class ListBlockedGuestUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BlockedGuestUser, BlockedGuestUserUnmarshaller>(BlockedGuestUserUnmarshaller.Instance);
                    response.Blocklist = unmarshaller.Unmarshall(context);
                    continue;
                }
