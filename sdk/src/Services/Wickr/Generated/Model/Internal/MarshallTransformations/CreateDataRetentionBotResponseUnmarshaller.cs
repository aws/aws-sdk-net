...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataRetentionBot operation
    /// </summary>  
    public class CreateDataRetentionBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataRetentionBotResponse response = new CreateDataRetentionBotResponse();
        ...
        private static CreateDataRetentionBotResponseUnmarshaller _instance = new CreateDataRetentionBotResponseUnmarshaller();        

        internal static CreateDataRetentionBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataRetentionBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
