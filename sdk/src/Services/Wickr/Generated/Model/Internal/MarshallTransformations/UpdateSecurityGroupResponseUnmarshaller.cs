...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSecurityGroup operation
    /// </summary>  
    public class UpdateSecurityGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSecurityGroupResponse response = new UpdateSecurityGroupResponse();
        ...
        private static UpdateSecurityGroupResponseUnmarshaller _instance = new UpdateSecurityGroupResponseUnmarshaller();        

        internal static UpdateSecurityGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
