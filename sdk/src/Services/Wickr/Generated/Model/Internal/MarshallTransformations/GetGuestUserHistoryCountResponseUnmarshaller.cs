...
{
    /// <summary>
    /// Response Unmarshaller for GetGuestUserHistoryCount operation
    /// </summary>  
    public class GetGuestUserHistoryCountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGuestUserHistoryCountResponse response = new GetGuestUserHistoryCountResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GuestUserHistoryCount, GuestUserHistoryCountUnmarshaller>(GuestUserHistoryCountUnmarshaller.Instance);
        ...
        private static GetGuestUserHistoryCountResponseUnmarshaller _instance = new GetGuestUserHistoryCountResponseUnmarshaller();        

        internal static GetGuestUserHistoryCountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGuestUserHistoryCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
