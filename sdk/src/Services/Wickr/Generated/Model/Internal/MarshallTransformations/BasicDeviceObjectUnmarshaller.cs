...
namespace Amazon.Wickr.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BasicDeviceObjectUnmarshaller : IJsonUnmarshaller<BasicDeviceObject, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BasicDeviceObject Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("statusText", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StatusText = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
