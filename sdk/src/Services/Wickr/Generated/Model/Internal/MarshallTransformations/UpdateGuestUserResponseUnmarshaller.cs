...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGuestUser operation
    /// </summary>  
    public class UpdateGuestUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGuestUserResponse response = new UpdateGuestUserResponse();
        ...
        private static UpdateGuestUserResponseUnmarshaller _instance = new UpdateGuestUserResponseUnmarshaller();        

        internal static UpdateGuestUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGuestUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
