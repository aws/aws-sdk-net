        ...
        public SecurityGroup Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("activeDirectoryGuid", targetDepth))
                {
                    ...
                    unmarshalledObject.ActiveDirectoryGuid = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("activeMembers", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.ActiveMembers = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("botMembers", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.BotMembers = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("securityGroupSettings", targetDepth))
                {
                    ...
                    unmarshalledObject.SecurityGroupSettings = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
