        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("codeValidation", targetDepth))
                {
                    ...
                    response.CodeValidation = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InviteCode = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("inviteExpiration", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.InviteExpiration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MiddleName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("modified", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.Modified = unmarshaller.Unmarshall(context);
                    continue;
                }
