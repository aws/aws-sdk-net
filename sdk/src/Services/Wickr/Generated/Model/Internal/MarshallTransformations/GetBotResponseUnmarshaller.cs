        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hasChallenge", targetDepth))
                {
                    ...
                    response.HasChallenge = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("lastLogin", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastLogin = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("pubkey", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Pubkey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Uname = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
