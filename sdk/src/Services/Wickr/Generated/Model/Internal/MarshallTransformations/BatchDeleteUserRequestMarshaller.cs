...
{
    /// <summary>
    /// BatchDeleteUser Request Marshaller
    /// </summary>       
    public class BatchDeleteUserRequestMarshaller : IMarshaller<IRequest, BatchDeleteUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchDeleteUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchDeleteUserRequest publicRequest)
        {
            ...
            request.ResourcePath = "/networks/{networkId}/users/batch-delete";
#if !NETFRAMEWORK
        ...
        private static BatchDeleteUserRequestMarshaller _instance = new BatchDeleteUserRequestMarshaller();        

        internal static BatchDeleteUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
