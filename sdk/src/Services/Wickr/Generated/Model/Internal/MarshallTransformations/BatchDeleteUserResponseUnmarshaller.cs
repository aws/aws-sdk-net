...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteUser operation
    /// </summary>  
    public class BatchDeleteUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteUserResponse response = new BatchDeleteUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchUserErrorResponseItem, BatchUserErrorResponseItemUnmarshaller>(BatchUserErrorResponseItemUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchUserSuccessResponseItem, BatchUserSuccessResponseItemUnmarshaller>(BatchUserSuccessResponseItemUnmarshaller.Instance);
        ...
        private static BatchDeleteUserResponseUnmarshaller _instance = new BatchDeleteUserResponseUnmarshaller();        

        internal static BatchDeleteUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
