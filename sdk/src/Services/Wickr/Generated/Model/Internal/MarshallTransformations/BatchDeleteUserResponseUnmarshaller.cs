    ...
    public class BatchDeleteUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchUserSuccessResponseItem, BatchUserSuccessResponseItemUnmarshaller>(BatchUserSuccessResponseItemUnmarshaller.Instance);
