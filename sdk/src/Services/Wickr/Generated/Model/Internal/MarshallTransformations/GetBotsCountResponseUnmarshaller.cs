...
{
    /// <summary>
    /// Response Unmarshaller for GetBotsCount operation
    /// </summary>  
    public class GetBotsCountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBotsCountResponse response = new GetBotsCountResponse();
        ...
        private static GetBotsCountResponseUnmarshaller _instance = new GetBotsCountResponseUnmarshaller();        

        internal static GetBotsCountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBotsCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
