...
{
    /// <summary>
    /// Response Unmarshaller for BatchReinviteUser operation
    /// </summary>  
    public class BatchReinviteUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchReinviteUserResponse response = new BatchReinviteUserResponse();
        ...
        private static BatchReinviteUserResponseUnmarshaller _instance = new BatchReinviteUserResponseUnmarshaller();        

        internal static BatchReinviteUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchReinviteUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
