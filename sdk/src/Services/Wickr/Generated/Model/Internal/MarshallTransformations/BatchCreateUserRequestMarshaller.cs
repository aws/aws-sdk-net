...
{
    /// <summary>
    /// BatchCreateUser Request Marshaller
    /// </summary>       
    public class BatchCreateUserRequestMarshaller : IMarshaller<IRequest, BatchCreateUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchCreateUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchCreateUserRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetUsers())
                {
                    ...
                    foreach(var publicRequestUsersListValue in publicRequest.Users)
                    {
                        ...
                        var marshaller = BatchCreateUserRequestItemMarshaller.Instance;
        ...
        private static BatchCreateUserRequestMarshaller _instance = new BatchCreateUserRequestMarshaller();        

        internal static BatchCreateUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
