...
{
    /// <summary>
    /// Response Unmarshaller for GetSecurityGroup operation
    /// </summary>  
    public class GetSecurityGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSecurityGroupResponse response = new GetSecurityGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("securityGroup", targetDepth))
                {
                    ...
                    response.SecurityGroup = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSecurityGroupResponseUnmarshaller _instance = new GetSecurityGroupResponseUnmarshaller();        

        internal static GetSecurityGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
