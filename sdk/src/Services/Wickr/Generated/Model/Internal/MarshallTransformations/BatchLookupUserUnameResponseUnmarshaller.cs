    ...
    public class BatchLookupUserUnameResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchUnameErrorResponseItem, BatchUnameErrorResponseItemUnmarshaller>(BatchUnameErrorResponseItemUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchUnameSuccessResponseItem, BatchUnameSuccessResponseItemUnmarshaller>(BatchUnameSuccessResponseItemUnmarshaller.Instance);
