...
{
    /// <summary>
    /// Response Unmarshaller for BatchLookupUserUname operation
    /// </summary>  
    public class BatchLookupUserUnameResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchLookupUserUnameResponse response = new BatchLookupUserUnameResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchUnameErrorResponseItem, BatchUnameErrorResponseItemUnmarshaller>(BatchUnameErrorResponseItemUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchUnameSuccessResponseItem, BatchUnameSuccessResponseItemUnmarshaller>(BatchUnameSuccessResponseItemUnmarshaller.Instance);
        ...
        private static BatchLookupUserUnameResponseUnmarshaller _instance = new BatchLookupUserUnameResponseUnmarshaller();        

        internal static BatchLookupUserUnameResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchLookupUserUnameResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
