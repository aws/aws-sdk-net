...
{
    /// <summary>
    /// RegisterOpentdfConfig Request Marshaller
    /// </summary>       
    public class RegisterOpentdfConfigRequestMarshaller : IMarshaller<IRequest, RegisterOpentdfConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RegisterOpentdfConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RegisterOpentdfConfigRequest publicRequest)
        {
        ...
        private static RegisterOpentdfConfigRequestMarshaller _instance = new RegisterOpentdfConfigRequestMarshaller();        

        internal static RegisterOpentdfConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterOpentdfConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
