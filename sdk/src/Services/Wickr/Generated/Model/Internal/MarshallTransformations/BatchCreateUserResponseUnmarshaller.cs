...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreateUser operation
    /// </summary>  
    public class BatchCreateUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreateUserResponse response = new BatchCreateUserResponse();
        ...
        private static BatchCreateUserResponseUnmarshaller _instance = new BatchCreateUserResponseUnmarshaller();        

        internal static BatchCreateUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
