...
{
    /// <summary>
    /// BatchReinviteUser Request Marshaller
    /// </summary>       
    public class BatchReinviteUserRequestMarshaller : IMarshaller<IRequest, BatchReinviteUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchReinviteUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchReinviteUserRequest publicRequest)
        {
            ...
            request.ResourcePath = "/networks/{networkId}/users/re-invite";
        ...
        private static BatchReinviteUserRequestMarshaller _instance = new BatchReinviteUserRequestMarshaller();        

        internal static BatchReinviteUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchReinviteUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
