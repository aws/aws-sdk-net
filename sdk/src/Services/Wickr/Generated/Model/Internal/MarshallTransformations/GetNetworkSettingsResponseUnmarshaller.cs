...
{
    /// <summary>
    /// Response Unmarshaller for GetNetworkSettings operation
    /// </summary>  
    public class GetNetworkSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Setting, SettingUnmarshaller>(SettingUnmarshaller.Instance);
        ...
        private static GetNetworkSettingsResponseUnmarshaller _instance = new GetNetworkSettingsResponseUnmarshaller();        

        internal static GetNetworkSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNetworkSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
