    ...
    public class ListGuestUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GuestUser, GuestUserUnmarshaller>(GuestUserUnmarshaller.Instance);
                    response.Guestlist = unmarshaller.Unmarshall(context);
                    continue;
                }
