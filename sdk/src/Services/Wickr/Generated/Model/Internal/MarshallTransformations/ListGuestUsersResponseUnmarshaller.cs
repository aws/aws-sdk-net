...
{
    /// <summary>
    /// Response Unmarshaller for ListGuestUsers operation
    /// </summary>  
    public class ListGuestUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGuestUsersResponse response = new ListGuestUsersResponse();
            ...
            {
                if (context.TestExpression("guestlist", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<GuestUser, GuestUserUnmarshaller>(GuestUserUnmarshaller.Instance);
                    response.Guestlist = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListGuestUsersResponseUnmarshaller _instance = new ListGuestUsersResponseUnmarshaller();        

        internal static ListGuestUsersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGuestUsersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
