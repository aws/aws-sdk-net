...
{
    /// <summary>
    /// Container for the parameters to the BatchDeleteUser operation.
    ...
    /// </summary>
    public partial class BatchDeleteUserRequest : AmazonWickrRequest
    {
        ...
        /// <para>
        /// A list of user IDs identifying the users to be deleted from the network. Maximum 50
