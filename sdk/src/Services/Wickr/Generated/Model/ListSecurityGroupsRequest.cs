...
{
    /// <summary>
    /// Container for the parameters to the ListSecurityGroups operation.
    /// Retrieves a paginated list of security groups in a specified Wickr network. You can
    /// sort the results by various criteria.
    /// </summary>
    public partial class ListSecurityGroupsRequest : AmazonWickrRequest
    {
        ...
        /// <para>
        /// The maximum number of security groups to return in a single page. Valid range is 1-100.
        /// Default is 10.
        /// </para>
        /// </summary>
