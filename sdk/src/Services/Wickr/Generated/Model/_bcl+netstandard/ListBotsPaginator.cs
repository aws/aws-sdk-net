...
namespace Amazon.Wickr.Model
{
    ...
    internal sealed partial class ListBotsPaginator : IPaginator<ListBotsResponse>, IListBotsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<Bot> Bots => 
            new PaginatedResultKeyResponse<ListBotsResponse, Bot>(this, (i) => i.Bots ?? new List<Bot>());

        internal ListBotsPaginator(IAmazonWickr client, ListBotsRequest request)
        {
            this._client = client;
