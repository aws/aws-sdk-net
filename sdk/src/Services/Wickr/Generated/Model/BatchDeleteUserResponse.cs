...
{
    /// <summary>
    /// This is the response object from the BatchDeleteUser operation.
    /// </summary>
    public partial class BatchDeleteUserResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// A list of user deletion attempts that failed, including error details explaining why
        /// each user could not be deleted.
        /// </para>
        /// <para />
