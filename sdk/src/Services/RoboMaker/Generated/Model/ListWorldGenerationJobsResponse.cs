...
{
    /// <summary>
    /// This is the response object from the ListWorldGenerationJobs operation.
    /// </summary>
    public partial class ListWorldGenerationJobsResponse : AmazonWebServiceResponse
    {
        ...
        /// the next set of results, call <c>ListWorldGeneratorJobsRequest</c> again and assign
        ...
        /// <summary>
        /// Gets and sets the property WorldGenerationJobSummaries. 
        /// <para>
        ...
        {
            get { return this._worldGenerationJobSummaries; }
            set { this._worldGenerationJobSummaries = value; }
        }
