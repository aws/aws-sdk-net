...
{
    /// <summary>
    /// This is the response object from the ListWorldTemplates operation.
    /// </summary>
    public partial class ListWorldTemplatesResponse : AmazonWebServiceResponse
    {
        ...
        /// the next set of results, call <c>ListWorldTemplates</c> again and assign that token
        ...
        /// <summary>
        /// Gets and sets the property TemplateSummaries. 
        /// <para>
        ...
        /// </summary>
        public List<TemplateSummary> TemplateSummaries
        {
            get { return this._templateSummaries; }
            set { this._templateSummaries = value; }
        }
