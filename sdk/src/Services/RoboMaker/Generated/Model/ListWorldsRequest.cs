...
{
    /// <summary>
    /// Container for the parameters to the ListWorlds operation.
    /// <important> 
    /// <para>
    ...
    /// </para>
    /// </summary>
    public partial class ListWorldsRequest : AmazonRoboMakerRequest
    {
        ...
        /// <para>
        /// Optional filters to limit results. You can use <c>status</c>.
        /// </para>
        /// <para />
        ...
        /// <para>
        /// When this parameter is used, <c>ListWorlds</c> only returns <c>maxResults</c> results
        /// in a single page along with a <c>nextToken</c> response element. The remaining results
        /// of the initial request can be seen by sending another <c>ListWorlds</c> request with
        /// the returned <c>nextToken</c> value. This value can be between 1 and 100. If this
        /// parameter is not used, then <c>ListWorlds</c> returns up to 100 results and a <c>nextToken</c>
        /// value if applicable. 
        /// </para>
        /// </summary>
