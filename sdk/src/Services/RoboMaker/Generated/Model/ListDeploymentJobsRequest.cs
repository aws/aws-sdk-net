...
namespace Amazon.RoboMaker.Model
{
    ...
    public partial class ListDeploymentJobsRequest : AmazonRoboMakerRequest
    {
        ...
        /// with the status <c>InProgress</c> or the status <c>Pending</c>.
        /// </para>
        /// <para />
        ...
        /// <para>
        /// When this parameter is used, <c>ListDeploymentJobs</c> only returns <c>maxResults</c>
        /// results in a single page along with a <c>nextToken</c> response element. The remaining
        /// results of the initial request can be seen by sending another <c>ListDeploymentJobs</c>
        /// request with the returned <c>nextToken</c> value. This value can be between 1 and
        /// 200. If this parameter is not used, then <c>ListDeploymentJobs</c> returns up to 200
        ...
        /// the next set of results, call <c>ListDeploymentJobs</c> again and assign that token
