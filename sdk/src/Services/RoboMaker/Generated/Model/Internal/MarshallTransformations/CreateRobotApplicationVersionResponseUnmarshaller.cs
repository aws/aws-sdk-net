...
{
    /// <summary>
    /// Response Unmarshaller for CreateRobotApplicationVersion operation
    /// </summary>  
    public class CreateRobotApplicationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRobotApplicationVersionResponse response = new CreateRobotApplicationVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("robotSoftwareSuite", targetDepth))
                {
                    ...
                    response.RobotSoftwareSuite = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateRobotApplicationVersionResponseUnmarshaller _instance = new CreateRobotApplicationVersionResponseUnmarshaller();        

        internal static CreateRobotApplicationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRobotApplicationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
