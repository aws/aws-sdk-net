...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRobotApplication operation
    /// </summary>  
    public class UpdateRobotApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRobotApplicationResponse response = new UpdateRobotApplicationResponse();
        ...
        private static UpdateRobotApplicationResponseUnmarshaller _instance = new UpdateRobotApplicationResponseUnmarshaller();        

        internal static UpdateRobotApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRobotApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
