...
{
    /// <summary>
    /// StartSimulationJobBatch Request Marshaller
    /// </summary>       
    public class StartSimulationJobBatchRequestMarshaller : IMarshaller<IRequest, StartSimulationJobBatchRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartSimulationJobBatchRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartSimulationJobBatchRequest publicRequest)
        {
        ...
        private static StartSimulationJobBatchRequestMarshaller _instance = new StartSimulationJobBatchRequestMarshaller();        

        internal static StartSimulationJobBatchRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSimulationJobBatchRequestMarshaller Instance
        {
            get
            {
                return _instance;
