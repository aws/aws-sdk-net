...
{
    /// <summary>
    /// Response Unmarshaller for CreateSimulationApplication operation
    /// </summary>  
    public class CreateSimulationApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSimulationApplicationResponse response = new CreateSimulationApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = RenderingEngineUnmarshaller.Instance;
                    response.RenderingEngine = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("simulationSoftwareSuite", targetDepth))
                {
                    ...
                    response.SimulationSoftwareSuite = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateSimulationApplicationResponseUnmarshaller _instance = new CreateSimulationApplicationResponseUnmarshaller();        

        internal static CreateSimulationApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSimulationApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
