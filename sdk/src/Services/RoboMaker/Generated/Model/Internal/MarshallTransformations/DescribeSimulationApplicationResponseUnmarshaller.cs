...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSimulationApplication operation
    /// </summary>  
    public class DescribeSimulationApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSimulationApplicationResponse response = new DescribeSimulationApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageDigest = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeSimulationApplicationResponseUnmarshaller _instance = new DescribeSimulationApplicationResponseUnmarshaller();        

        internal static DescribeSimulationApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSimulationApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
