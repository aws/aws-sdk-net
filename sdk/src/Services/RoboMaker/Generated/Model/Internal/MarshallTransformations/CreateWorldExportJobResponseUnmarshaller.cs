...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorldExportJob operation
    /// </summary>  
    public class CreateWorldExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorldExportJobResponse response = new CreateWorldExportJobResponse();
        ...
        private static CreateWorldExportJobResponseUnmarshaller _instance = new CreateWorldExportJobResponseUnmarshaller();        

        internal static CreateWorldExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorldExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
