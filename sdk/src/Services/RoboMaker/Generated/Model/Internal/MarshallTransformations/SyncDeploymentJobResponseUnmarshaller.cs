...
{
    /// <summary>
    /// Response Unmarshaller for SyncDeploymentJob operation
    /// </summary>  
    public class SyncDeploymentJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SyncDeploymentJobResponse response = new SyncDeploymentJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DeploymentApplicationConfig, DeploymentApplicationConfigUnmarshaller>(DeploymentApplicationConfigUnmarshaller.Instance);
                    response.DeploymentApplicationConfigs = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("ConcurrentDeploymentException"))
            {
                return new ConcurrentDeploymentException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static SyncDeploymentJobResponseUnmarshaller _instance = new SyncDeploymentJobResponseUnmarshaller();        

        internal static SyncDeploymentJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SyncDeploymentJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
