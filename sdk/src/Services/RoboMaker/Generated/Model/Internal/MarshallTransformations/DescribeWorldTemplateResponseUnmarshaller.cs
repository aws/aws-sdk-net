...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWorldTemplate operation
    /// </summary>  
    public class DescribeWorldTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWorldTemplateResponse response = new DescribeWorldTemplateResponse();
        ...
        private static DescribeWorldTemplateResponseUnmarshaller _instance = new DescribeWorldTemplateResponseUnmarshaller();        

        internal static DescribeWorldTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorldTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
