...
namespace Amazon.RoboMaker
{
    ...
    public partial class AmazonRoboMakerException : AmazonServiceException
    {
        ...
        public AmazonRoboMakerException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonRoboMakerException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
