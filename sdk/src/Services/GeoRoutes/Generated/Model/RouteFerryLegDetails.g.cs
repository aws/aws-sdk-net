...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class RouteFerryLegDetails
    {
        ...
        public List<RouteFerryAfterTravelStep> AfterTravelSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteFerryAfterTravelStep>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public RouteFerryArrival Arrival { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteFerryBeforeTravelStep> BeforeTravelSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteFerryBeforeTravelStep>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public RouteFerryDeparture Departure { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteFerryNotice> Notices { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteFerryNotice>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteFerrySpan> Spans { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteFerrySpan>() : null;
        ...
        /// </para>
        /// </summary>
        public RouteFerrySummary Summary { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteFerryTravelStep> TravelSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteFerryTravelStep>() : null;
