...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class RouteMatrixAvoidanceOptions
    {
        ...
        /// </summary>
        [AWSProperty(Max = 250)]
        public List<RouteMatrixAvoidanceArea> Areas { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteMatrixAvoidanceArea>() : null;
        ...
        /// </summary>
        [AWSProperty(Max = 3)]
        public List<RouteMatrixAvoidanceZoneCategory> ZoneCategories { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteMatrixAvoidanceZoneCategory>() : null;
