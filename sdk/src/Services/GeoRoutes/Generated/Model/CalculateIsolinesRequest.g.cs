...
{
    /// <summary>
    /// Container for the parameters to the CalculateIsolines operation. Calculates areas
    /// that can be reached within specified time or distance thresholds from a given point.
    /// For example, you can use this operation to determine the area within a 30-minute drive
    /// of a store location, find neighborhoods within walking distance of a school, or identify
    /// delivery zones based on drive time. <para> Isolines (also known as isochrones for
    /// time-based calculations) are useful for various applications including: </para> <ul>
    /// <li> <para> Service area visualization - Show customers the area you can serve within
    /// promised delivery times </para> </li> <li> <para> Site selection - Analyze potential
    /// business locations based on population within travel distance </para> </li> <li> <para>
    /// Site selection - Determine areas that can be reached within specified response times
    /// </para> </li> </ul> <note> <para> Route preferences such as avoiding toll roads or
    /// ferries are treated as preferences rather than absolute restrictions. If a viable
    /// route cannot be calculated while honoring all preferences, some may be ignored. </para>
    /// </note> <para> For more information, see <a href="https://docs.aws.amazon.com/location/latest/developerguide/calculate-isolines.html">Calculate
    /// isolines</a> in the <i>Amazon Location Service Developer Guide</i>. </para>
    /// </summary>
    public partial class CalculateIsolinesRequest : AmazonGeoRoutesRequest
    {
        ...
        /// </para>
        /// </summary>
        public IsolineAllowOptions Allow { get; set; }
        ...
        /// </para>
        /// </summary>
        public IsolineAvoidanceOptions Avoid { get; set; }
        ...
        /// </para>
        /// </summary>
        public IsolineDestinationOptions DestinationOptions { get; set; }
        ...
        /// </para>
        /// </summary>
        public IsolineGranularityOptions IsolineGranularity { get; set; }

        /// <summary>
        /// Checks to see if the IsolineGranularity property is set.
        /// </summary>
        internal bool IsSetIsolineGranularity() => this.IsolineGranularity != null;
        ...
        /// </para>
        /// </summary>
        public IsolineOptimizationObjective OptimizeIsolineFor { get; set; }

        /// <summary>
        /// Checks to see if the OptimizeIsolineFor property is set.
        /// </summary>
        internal bool IsSetOptimizeIsolineFor() => this.OptimizeIsolineFor != null;
        ...
        /// </para>
        /// </summary>
        public IsolineOriginOptions OriginOptions { get; set; }
        ...
        public IsolineThresholds Thresholds { get; set; }

        /// <summary>
        /// Checks to see if the Thresholds property is set.
        /// </summary>
        internal bool IsSetThresholds() => this.Thresholds != null;
        ...
        /// </para>
        /// </summary>
        public IsolineTrafficOptions Traffic { get; set; }
        ...
        /// </para>
        /// </summary>
        public IsolineTravelMode TravelMode { get; set; }
        ...
        /// </para>
        /// </summary>
        public IsolineTravelModeOptions TravelModeOptions { get; set; }
