...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class IsolineAvoidanceOptions
    {
        ...
        /// </summary>
        public List<IsolineAvoidanceArea> Areas { get; set; } = AWSConfigs.InitializeCollections ? new List<IsolineAvoidanceArea>() : null;
        ...
        /// </summary>
        [AWSProperty(Max = 3)]
        public List<IsolineAvoidanceZoneCategory> ZoneCategories { get; set; } = AWSConfigs.InitializeCollections ? new List<IsolineAvoidanceZoneCategory>() : null;
