...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class WaypointOptimizationDriverOptions
    {
        ...
        /// </para>
        /// </summary>
        public WaypointOptimizationRestCycles RestCycles { get; set; }

        /// <summary>
        /// Checks to see if the RestCycles property is set.
        /// </summary>
        internal bool IsSetRestCycles() => this.RestCycles != null;
        ...
        /// </para>
        /// </summary>
        public WaypointOptimizationRestProfile RestProfile { get; set; }

        /// <summary>
        /// Checks to see if the RestProfile property is set.
        /// </summary>
        internal bool IsSetRestProfile() => this.RestProfile != null;
        ...
        public WaypointOptimizationServiceTimeTreatment TreatServiceTimeAs { get; set; }

        /// <summary>
        /// Checks to see if the TreatServiceTimeAs property is set.
        /// </summary>
        internal bool IsSetTreatServiceTimeAs() => this.TreatServiceTimeAs != null;
    }
}
