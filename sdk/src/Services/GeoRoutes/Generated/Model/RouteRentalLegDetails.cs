...
namespace Amazon.GeoRoutes.Model
{
    ...
    {
        private List<RouteRentalAfterTravelStep> _afterTravelSteps = AWSConfigs.InitializeCollections ? new List<RouteRentalAfterTravelStep>() : null;
        private RouteRentalAgency _agency;
        private RouteRentalArrival _arrival;
        private List<RouteAttribution> _attributions = AWSConfigs.InitializeCollections ? new List<RouteAttribution>() : null;
        private List<RouteRentalBeforeTravelStep> _beforeTravelSteps = AWSConfigs.InitializeCollections ? new List<RouteRentalBeforeTravelStep>() : null;
        private List<RouteWebLink> _bookingWebLinks = AWSConfigs.InitializeCollections ? new List<RouteWebLink>() : null;
        private RouteRentalDeparture _departure;
        private RouteRentalSummary _summary;
        private RouteRentalTransportModeDetails _transport;
        private List<RouteRentalTravelStep> _travelSteps = AWSConfigs.InitializeCollections ? new List<RouteRentalTravelStep>() : null;
        ...
        public List<RouteRentalAfterTravelStep> AfterTravelSteps
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public RouteRentalAgency Agency
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public RouteRentalArrival Arrival
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<RouteRentalBeforeTravelStep> BeforeTravelSteps
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public RouteRentalDeparture Departure
        {
        ...
        /// </para>
        /// </summary>
        public RouteRentalSummary Summary
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public RouteRentalTransportModeDetails Transport
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<RouteRentalTravelStep> TravelSteps
        {
