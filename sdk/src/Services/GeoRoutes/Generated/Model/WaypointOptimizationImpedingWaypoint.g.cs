...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class WaypointOptimizationImpedingWaypoint
    {
        ...
        public List<WaypointOptimizationFailedConstraint> FailedConstraints { get; set; } = AWSConfigs.InitializeCollections ? new List<WaypointOptimizationFailedConstraint>() : null;

        /// <summary>
        /// Checks to see if the FailedConstraints property is set.
        /// </summary>
        internal bool IsSetFailedConstraints() => this.FailedConstraints != null && (this.FailedConstraints.Count > 0 || !AWSConfigs.InitializeCollections);
