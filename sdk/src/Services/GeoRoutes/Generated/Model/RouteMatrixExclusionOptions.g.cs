...
namespace Amazon.GeoRoutes.Model
{
    ...
    {
        /// <summary>
        /// Gets and sets the property Countries. 
        /// <para>
        ...
        public List<string> Countries { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Countries property is set.
        /// </summary>
        internal bool IsSetCountries() => this.Countries != null && (this.Countries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
