...
{
    /// <summary>
    /// Response Unmarshaller for RouteStationDetails Object
    /// </summary>
    public partial class RouteStationDetailsUnmarshaller : IJsonUnmarshaller<RouteStationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteStationDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteStationDetails();
        ...
        private static RouteStationDetailsUnmarshaller _instance = new RouteStationDetailsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RouteStationDetailsUnmarshaller Instance => _instance;
    }
}
