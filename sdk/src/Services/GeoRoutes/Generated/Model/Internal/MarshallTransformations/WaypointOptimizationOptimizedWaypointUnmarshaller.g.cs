...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WaypointOptimizationOptimizedWaypointUnmarshaller : IJsonUnmarshaller<WaypointOptimizationOptimizedWaypoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WaypointOptimizationOptimizedWaypoint();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ClusterIndex", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static WaypointOptimizationOptimizedWaypointUnmarshaller Instance => _instance;
    }
}
