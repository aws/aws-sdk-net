    ...
    public class RouteVehicleLegDetailsUnmarshaller : IJsonUnmarshaller<RouteVehicleLegDetails, JsonUnmarshallerContext>
    {
        ...
        public RouteVehicleLegDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RouteVehicleAfterTravelStep, RouteVehicleAfterTravelStepUnmarshaller>(RouteVehicleAfterTravelStepUnmarshaller.Instance);
                ...
                if (context.TestExpression("TollSystems", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("TruckRoadTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.TruckRoadTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Zones", targetDepth, ref reader))
                {
