...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RouteVehicleTravelStepUnmarshaller : IJsonUnmarshaller<RouteVehicleTravelStep, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RouteVehicleTravelStep();
            ...
            {
                if (context.TestExpression("ContinueHighwayStepDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("EnterHighwayStepDetails", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RouteVehicleTravelStepUnmarshaller Instance => _instance;
    }
}
