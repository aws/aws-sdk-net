    ...
    public class RouteTollPassValidityPeriodUnmarshaller : IJsonUnmarshaller<RouteTollPassValidityPeriod, JsonUnmarshallerContext>
    {
        ...
        public RouteTollPassValidityPeriod Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PeriodCount", targetDepth, ref reader))
                {
        ...
        private static RouteTollPassValidityPeriodUnmarshaller _instance = new RouteTollPassValidityPeriodUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RouteTollPassValidityPeriodUnmarshaller Instance
        {
            get
            {
                return _instance;
