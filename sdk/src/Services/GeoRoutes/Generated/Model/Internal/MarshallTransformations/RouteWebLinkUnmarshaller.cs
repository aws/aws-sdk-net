...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouteWebLinkUnmarshaller : IJsonUnmarshaller<RouteWebLink, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            RouteWebLink unmarshalledObject = new RouteWebLink();
            ...
            {
                if (context.TestExpression("AnchorText", targetDepth))
                {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RouteWebLinkUnmarshaller Instance
        {
            get
            {
                return _instance;
