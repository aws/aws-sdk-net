...
{
    /// <summary>
    /// Response Unmarshaller for RouteTransitLegDetails Object
    /// </summary>
    public partial class RouteTransitLegDetailsUnmarshaller : IJsonUnmarshaller<RouteTransitLegDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteTransitLegDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteTransitLegDetails();
        ...
        private static RouteTransitLegDetailsUnmarshaller _instance = new RouteTransitLegDetailsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RouteTransitLegDetailsUnmarshaller Instance => _instance;
    }
}
