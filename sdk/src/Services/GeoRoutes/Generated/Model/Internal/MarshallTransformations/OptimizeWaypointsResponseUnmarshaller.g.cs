...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OptimizeWaypointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new OptimizeWaypointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ImpedingWaypoints", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ImpedingWaypoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("OptimizedWaypoints", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.OptimizedWaypoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TimeBreakdown", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TimeBreakdown = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static OptimizeWaypointsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static OptimizeWaypointsResponseUnmarshaller Instance => _instance;
    }
}
