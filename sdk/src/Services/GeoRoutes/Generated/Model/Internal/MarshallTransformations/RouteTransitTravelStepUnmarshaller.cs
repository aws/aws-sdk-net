...
{
    /// <summary>
    /// Response Unmarshaller for RouteTransitTravelStep Object
    /// </summary>  
    public class RouteTransitTravelStepUnmarshaller : IJsonUnmarshaller<RouteTransitTravelStep, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouteTransitTravelStep Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RouteTransitTravelStep unmarshalledObject = new RouteTransitTravelStep();
        ...
        private static RouteTransitTravelStepUnmarshaller _instance = new RouteTransitTravelStepUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RouteTransitTravelStepUnmarshaller Instance
        {
            get
            {
                return _instance;
