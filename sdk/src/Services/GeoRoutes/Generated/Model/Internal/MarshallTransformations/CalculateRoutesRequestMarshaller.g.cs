...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CalculateRoutesRequestMarshaller : IMarshaller<IRequest, CalculateRoutesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CalculateRoutesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/routes";
#if !NETFRAMEWORK
        ...
        private static readonly CalculateRoutesRequestMarshaller _instance = new();

        internal static CalculateRoutesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CalculateRoutesRequestMarshaller Instance => _instance;
    }
}
