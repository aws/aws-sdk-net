...
{
    /// <summary>
    /// Response Unmarshaller for RouteTransitIntermediateStop Object
    /// </summary>
    public partial class RouteTransitIntermediateStopUnmarshaller : IJsonUnmarshaller<RouteTransitIntermediateStop, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteTransitIntermediateStop Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteTransitIntermediateStop();
        ...
        private static RouteTransitIntermediateStopUnmarshaller _instance = new RouteTransitIntermediateStopUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RouteTransitIntermediateStopUnmarshaller Instance => _instance;
    }
}
