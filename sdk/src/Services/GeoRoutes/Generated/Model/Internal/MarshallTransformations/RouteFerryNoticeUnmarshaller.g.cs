...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RouteFerryNoticeUnmarshaller : IJsonUnmarshaller<RouteFerryNotice, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteFerryNotice Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteFerryNotice();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RouteFerryNoticeUnmarshaller Instance => _instance;
    }
}
