    ...
    public class RouteUnmarshaller : IUnmarshaller<Route, XmlUnmarshallerContext>, IUnmarshaller<Route, JsonUnmarshallerContext>
    {
        ...
        public Route Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RouteLeg, RouteLegUnmarshaller>(RouteLegUnmarshaller.Instance);
                    unmarshalledObject.Legs = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("MajorRoadLabels", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<RouteMajorRoadLabel, RouteMajorRoadLabelUnmarshaller>(RouteMajorRoadLabelUnmarshaller.Instance);
                    unmarshalledObject.MajorRoadLabels = unmarshaller.Unmarshall(context);
                    continue;
                }
