        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ArrivalTime", targetDepth))
                {
                    ...
                    response.ArrivalTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DepartureTime", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DepartureTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("IsolineGeometryFormat", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.IsolineGeometryFormat = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Isolines", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<Isoline, IsolineUnmarshaller>(IsolineUnmarshaller.Instance);
                    response.Isolines = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SnappedDestination", targetDepth))
                {
                    ...
                    response.SnappedDestination = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SnappedOrigin", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<double, DoubleUnmarshaller>(DoubleUnmarshaller.Instance);
                    response.SnappedOrigin = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
