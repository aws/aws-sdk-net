...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RouteVehicleNoticeUnmarshaller : IJsonUnmarshaller<RouteVehicleNotice, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteVehicleNotice Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteVehicleNotice();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RouteVehicleNoticeDetail, RouteVehicleNoticeDetailUnmarshaller>(RouteVehicleNoticeDetailUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static RouteVehicleNoticeUnmarshaller Instance => _instance;
    }
}
