        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LegGeometryFormat", targetDepth))
                {
                    ...
                    response.LegGeometryFormat = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Notices", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<RouteResponseNotice, RouteResponseNoticeUnmarshaller>(RouteResponseNoticeUnmarshaller.Instance);
