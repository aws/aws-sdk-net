...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RouteTollUnmarshaller : IJsonUnmarshaller<RouteToll, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RouteToll();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PaymentSites", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Rates", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Systems", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RouteTollUnmarshaller Instance => _instance;
    }
}
