...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CalculateIsolinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CalculateIsolinesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IsolineGeometryFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("Isolines", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Isolines = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SnappedDestination", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SnappedDestination = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<double, DoubleUnmarshaller>(DoubleUnmarshaller.Instance);
                    unmarshalledObject.SnappedOrigin = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CalculateIsolinesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CalculateIsolinesResponseUnmarshaller Instance => _instance;
    }
}
