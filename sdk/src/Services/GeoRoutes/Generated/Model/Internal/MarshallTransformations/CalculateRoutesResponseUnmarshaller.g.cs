...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CalculateRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CalculateRoutesResponse();
            ...
            {
                if (context.TestExpression("LegGeometryFormat", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LegGeometryFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CalculateRoutesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CalculateRoutesResponseUnmarshaller Instance => _instance;
    }
}
