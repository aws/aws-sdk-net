...
{
    /// <summary>
    /// Response Unmarshaller for RouteLeg Object
    /// </summary>
    public partial class RouteLegUnmarshaller : IJsonUnmarshaller<RouteLeg, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteLeg Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteLeg();
        ...
        private static RouteLegUnmarshaller _instance = new RouteLegUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RouteLegUnmarshaller Instance => _instance;
    }
}
