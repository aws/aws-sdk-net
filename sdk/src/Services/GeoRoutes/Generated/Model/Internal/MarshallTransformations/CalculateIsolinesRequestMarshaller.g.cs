...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CalculateIsolinesRequestMarshaller : IMarshaller<IRequest, CalculateIsolinesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CalculateIsolinesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/isolines";
#if !NETFRAMEWORK
        ...
        private static readonly CalculateIsolinesRequestMarshaller _instance = new();

        internal static CalculateIsolinesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CalculateIsolinesRequestMarshaller Instance => _instance;
    }
}
