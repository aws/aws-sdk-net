...
{
    /// <summary>
    /// RouteDestinationOptions Marshaller
    /// </summary>
    public class RouteDestinationOptionsMarshaller : IRequestMarshaller<RouteDestinationOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RouteDestinationOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetStopDuration())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.StopDuration.Value);
            }
        ...
        /// </summary>
        public readonly static RouteDestinationOptionsMarshaller Instance = new RouteDestinationOptionsMarshaller();
