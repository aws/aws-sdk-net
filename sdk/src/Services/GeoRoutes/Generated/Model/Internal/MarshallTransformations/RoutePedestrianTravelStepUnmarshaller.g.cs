...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RoutePedestrianTravelStepUnmarshaller : IJsonUnmarshaller<RoutePedestrianTravelStep, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RoutePedestrianTravelStep Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RoutePedestrianTravelStep();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CurrentRoad", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ExitNumber", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("NextRoad", targetDepth, ref reader))
                {
                    var unmarshaller = RouteRoadUnmarshaller.Instance;
                ...
                if (context.TestExpression("Signpost", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RoutePedestrianTravelStepUnmarshaller Instance => _instance;
    }
}
