...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RoutePedestrianSpanUnmarshaller : IUnmarshaller<RoutePedestrianSpan, XmlUnmarshallerContext>, IUnmarshaller<RoutePedestrianSpan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RoutePedestrianSpan IUnmarshaller<RoutePedestrianSpan, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RoutePedestrianSpan Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("PedestrianAccess", targetDepth))
                {
                    ...
                    unmarshalledObject.PedestrianAccess = unmarshaller.Unmarshall(context);
                    continue;
                }
