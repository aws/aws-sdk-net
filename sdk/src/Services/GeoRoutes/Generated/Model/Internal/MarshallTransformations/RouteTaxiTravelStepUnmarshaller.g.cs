...
{
    /// <summary>
    /// Response Unmarshaller for RouteTaxiTravelStep Object
    /// </summary>
    public partial class RouteTaxiTravelStepUnmarshaller : IJsonUnmarshaller<RouteTaxiTravelStep, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouteTaxiTravelStep Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouteTaxiTravelStep();
        ...
        private static RouteTaxiTravelStepUnmarshaller _instance = new RouteTaxiTravelStepUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RouteTaxiTravelStepUnmarshaller Instance => _instance;
    }
}
