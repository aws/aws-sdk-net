...
namespace Amazon.GeoRoutes.Model
{
    ...
    /// </summary>
    public partial class RouteTransitPedestrianOptions
    {
        /// <summary>
        /// Gets and sets the property MaxDistance. 
        /// <para>
        ...
        /// </para>
        /// </summary>
        [AWSProperty(Sensitive = true, Max = 6000)]
        public long? MaxDistance { get; set; }

        /// <summary>
        /// Checks to see if the MaxDistance property is set.
        /// </summary>
        internal bool IsSetMaxDistance() => this.MaxDistance.HasValue;
