...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class IsolineTrafficOptions
    {
        ...
        public long? FlowEventThresholdOverride { get; set; }

        /// <summary>
        /// Checks to see if the FlowEventThresholdOverride property is set.
        /// </summary>
        internal bool IsSetFlowEventThresholdOverride() => this.FlowEventThresholdOverride.HasValue;
