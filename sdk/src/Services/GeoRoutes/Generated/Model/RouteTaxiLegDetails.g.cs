...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class RouteTaxiLegDetails
    {
        ...
        public List<RouteTaxiAfterTravelStep> AfterTravelSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteTaxiAfterTravelStep>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public RouteTaxiAgency Agency { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public RouteTaxiArrival Arrival { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteTaxiBeforeTravelStep> BeforeTravelSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteTaxiBeforeTravelStep>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public RouteTaxiDeparture Departure { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteTaxiNotice> Notices { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteTaxiNotice>() : null;
        ...
        /// </para>
        /// </summary>
        public RouteTaxiSummary Summary { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public RouteTaxiTransportModeDetails Transport { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouteTaxiTravelStep> TravelSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RouteTaxiTravelStep>() : null;
