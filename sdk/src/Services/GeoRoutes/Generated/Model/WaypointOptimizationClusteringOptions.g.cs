...
namespace Amazon.GeoRoutes.Model
{
    ...
    public partial class WaypointOptimizationClusteringOptions
    {
        ...
        public WaypointOptimizationClusteringAlgorithm Algorithm { get; set; }
        ...
        /// </para>
        /// </summary>
        public WaypointOptimizationDrivingDistanceOptions DrivingDistanceOptions { get; set; }

        /// <summary>
        /// Checks to see if the DrivingDistanceOptions property is set.
        /// </summary>
        internal bool IsSetDrivingDistanceOptions() => this.DrivingDistanceOptions != null;
    }
}
