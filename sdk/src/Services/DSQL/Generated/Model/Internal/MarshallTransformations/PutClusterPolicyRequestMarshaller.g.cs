...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutClusterPolicyRequestMarshaller : IMarshaller<IRequest, PutClusterPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutClusterPolicyRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetExpectedPolicyVersion())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ExpectedPolicyVersion);
            }
        ...
        private static readonly PutClusterPolicyRequestMarshaller _instance = new();

        internal static PutClusterPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutClusterPolicyRequestMarshaller Instance => _instance;
    }
}
