...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListClustersRequestMarshaller : IMarshaller<IRequest, ListClustersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListClustersRequestMarshaller _instance = new();

        internal static ListClustersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListClustersRequestMarshaller Instance => _instance;
    }
}
