...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StreamSummaryUnmarshaller : IJsonUnmarshaller<StreamSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StreamSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("streamIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StreamIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>
        public static StreamSummaryUnmarshaller Instance => _instance;
    }
}
