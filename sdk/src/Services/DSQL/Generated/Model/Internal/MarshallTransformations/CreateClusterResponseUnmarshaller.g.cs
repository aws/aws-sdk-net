...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("encryptionDetails", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EncryptionDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("multiRegionProperties", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MultiRegionProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateClusterResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateClusterResponseUnmarshaller Instance => _instance;
    }
}
