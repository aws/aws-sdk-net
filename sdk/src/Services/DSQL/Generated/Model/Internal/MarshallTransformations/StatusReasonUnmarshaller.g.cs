...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StatusReasonUnmarshaller : IJsonUnmarshaller<StatusReason, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StatusReason();
        ...
        /// Gets the singleton.
        /// </summary>
        public static StatusReasonUnmarshaller Instance => _instance;
    }
}
