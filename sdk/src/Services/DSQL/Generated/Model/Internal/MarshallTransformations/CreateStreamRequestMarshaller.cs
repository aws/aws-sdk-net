...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    public class CreateStreamRequestMarshaller : IMarshaller<IRequest, CreateStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateStreamRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetOrdering())
            {
                context.Writer.WritePropertyName("ordering");
                context.Writer.WriteStringValue(publicRequest.Ordering);
            }
            ...
            if(publicRequest.IsSetTargetDefinition())
            {
                context.Writer.WritePropertyName("targetDefinition");
                context.Writer.WriteStartObject();

                var marshaller = TargetDefinitionMarshaller.Instance;
                marshaller.Marshall(publicRequest.TargetDefinition, context);
