...
namespace Amazon.DSQL
{
    ...
    public partial class AmazonDSQLClient : AmazonServiceClient, IAmazonDSQL
    {
        ...
        /// 
        /// </summary>
        public AmazonDSQLClient() : base(new AmazonDSQLConfig()) { }
        ...
        public AmazonDSQLClient(RegionEndpoint region) : base(new AmazonDSQLConfig { RegionEndpoint = region }) { }
        ...
        public AmazonDSQLClient(AmazonDSQLConfig config) : base(config) { }
