...
namespace Amazon.DSQL
{
    ...
    public partial class AmazonDSQLClient : AmazonServiceClient, IAmazonDSQL
    {
        ...
        internal virtual CreateMultiRegionClustersResponse CreateMultiRegionClusters(CreateMultiRegionClustersRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual DeleteMultiRegionClustersResponse DeleteMultiRegionClusters(DeleteMultiRegionClustersRequest request)
        {
            var options = new InvokeOptions();
