...
namespace Amazon.WorkMailMessageFlow.Model
{
    ...
    public partial class InvalidContentLocationException : AmazonWorkMailMessageFlowException
    {
        ...
        public InvalidContentLocationException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidContentLocationException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
