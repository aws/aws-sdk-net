...
namespace Amazon.WorkMailMessageFlow.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonWorkMailMessageFlowAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkMailMessageFlowAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkMailMessageFlow.
        /// </summary>
        public AmazonWorkMailMessageFlowAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkMailMessageFlowAuthSchemeParameters
            {
    ...
    public class AmazonWorkMailMessageFlowAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkMailMessageFlowAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkMailMessageFlowAuthSchemeParameters authParameters)
        {
