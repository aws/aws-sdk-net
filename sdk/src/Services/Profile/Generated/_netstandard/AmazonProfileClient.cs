...
using Amazon.Profile.Model.Internal.MarshallTransformations;
using Amazon.Profile.Internal;
...
{
    /// <summary>
    /// Implementation for accessing Profile
    ///
...
#endif
    public partial class AmazonProfileClient : AmazonServiceClient, IAmazonProfile
    {
        private static IServiceMetadata serviceMetadata = new AmazonProfileMetadata();
        
        #region Constructors

        /// <summary>
        /// Constructs AmazonProfileClient with the credentials loaded from the application's
        ...
        ///
        /// </summary>
        public AmazonProfileClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonProfileConfig()) { }
        ...
        public AmazonProfileClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonProfileConfig{RegionEndpoint = region}) { }
        ...
        ///
        /// </summary>
        /// <param name="config">The AmazonProfileClient Configuration Object</param>
        public AmazonProfileClient(AmazonProfileConfig config)
            : base(FallbackCredentialsFactory.GetCredentials(), config) { }


        /// <summary>
        /// Constructs AmazonProfileClient with AWS Credentials
        /// </summary>
        /// <param name="credentials">AWS Credentials</param>
        public AmazonProfileClient(AWSCredentials credentials)
            : this(credentials, new AmazonProfileConfig())
        {
        }
        ...
        /// <param name="credentials">AWS Credentials</param>
        /// <param name="region">The region to connect.</param>
        public AmazonProfileClient(AWSCredentials credentials, RegionEndpoint region)
            : this(credentials, new AmazonProfileConfig{RegionEndpoint = region})
        {
        }

        /// <summary>
        /// Constructs AmazonProfileClient with AWS Credentials and an
        /// AmazonProfileClient Configuration object.
        /// </summary>
        /// <param name="credentials">AWS Credentials</param>
        /// <param name="clientConfig">The AmazonProfileClient Configuration Object</param>
        public AmazonProfileClient(AWSCredentials credentials, AmazonProfileConfig clientConfig)
            : base(credentials, clientConfig)
        {
        }

        /// <summary>
        /// Constructs AmazonProfileClient with AWS Access Key ID and AWS Secret Key
        /// </summary>
        /// <param name="awsAccessKeyId">AWS Access Key ID</param>
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        public AmazonProfileClient(string awsAccessKeyId, string awsSecretAccessKey)
            : this(awsAccessKeyId, awsSecretAccessKey, new AmazonProfileConfig())
        {
        }
        ...
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        /// <param name="region">The region to connect.</param>
        public AmazonProfileClient(string awsAccessKeyId, string awsSecretAccessKey, RegionEndpoint region)
            : this(awsAccessKeyId, awsSecretAccessKey, new AmazonProfileConfig() {RegionEndpoint=region})
        {
        }

        /// <summary>
        /// Constructs AmazonProfileClient with AWS Access Key ID, AWS Secret Key and an
        /// AmazonProfileClient Configuration object. 
        /// </summary>
        /// <param name="awsAccessKeyId">AWS Access Key ID</param>
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        /// <param name="clientConfig">The AmazonProfileClient Configuration Object</param>
        public AmazonProfileClient(string awsAccessKeyId, string awsSecretAccessKey, AmazonProfileConfig clientConfig)
        ...
        public AmazonProfileClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken)
            : this(awsAccessKeyId, awsSecretAccessKey, awsSessionToken, new AmazonProfileConfig())
        {
        }
        ...
        /// <param name="awsSessionToken">AWS Session Token</param>
        /// <param name="region">The region to connect.</param>
        public AmazonProfileClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, RegionEndpoint region)
            : this(awsAccessKeyId, awsSecretAccessKey, awsSessionToken, new AmazonProfileConfig{RegionEndpoint = region})
        {
        }
        ...
        /// <param name="awsSessionToken">AWS Session Token</param>
        /// <param name="clientConfig">The AmazonProfileClient Configuration Object</param>
        public AmazonProfileClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, AmazonProfileConfig clientConfig)
        ...
        /// </param>
        /// 
        /// <returns>The response from the AddProfileKey service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        /// The input you provided is invalid.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.InternalServerException">
        /// An internal service error occurred.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.ResourceNotFoundException">
        /// The requested resource does not exist, or access was denied.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.ThrottlingException">
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/AddProfileKey">REST API Reference for AddProfileKey Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the CreateDomain service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/CreateDomain">REST API Reference for CreateDomain Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the CreateProfile service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/CreateProfile">REST API Reference for CreateProfile Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the DeleteDomain service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteDomain">REST API Reference for DeleteDomain Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the DeleteIntegration service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteIntegration">REST API Reference for DeleteIntegration Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the DeleteProfile service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfile">REST API Reference for DeleteProfile Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the DeleteProfileKey service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfileKey">REST API Reference for DeleteProfileKey Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the DeleteProfileObject service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfileObject">REST API Reference for DeleteProfileObject Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the DeleteProfileObjectType service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfileObjectType">REST API Reference for DeleteProfileObjectType Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the GetDomain service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetDomain">REST API Reference for GetDomain Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the GetIntegration service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetIntegration">REST API Reference for GetIntegration Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the GetProfileObjectType service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetProfileObjectType">REST API Reference for GetProfileObjectType Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the GetProfileObjectTypeTemplate service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetProfileObjectTypeTemplate">REST API Reference for GetProfileObjectTypeTemplate Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListAccountIntegrations service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListAccountIntegrations">REST API Reference for ListAccountIntegrations Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListDomains service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListDomains">REST API Reference for ListDomains Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListIntegrations service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListIntegrations">REST API Reference for ListIntegrations Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListProfileObjects service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjects">REST API Reference for ListProfileObjects Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListProfileObjectTypes service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjectTypes">REST API Reference for ListProfileObjectTypes Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListProfileObjectTypeTemplates service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjectTypeTemplates">REST API Reference for ListProfileObjectTypeTemplates Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListTagsForResource service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        /// The input you provided is invalid.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.InternalServerException">
        ...
        /// The requested resource does not exist, or access was denied.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListTagsForResource">REST API Reference for ListTagsForResource Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the PutIntegration service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/PutIntegration">REST API Reference for PutIntegration Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the PutProfileObject service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/PutProfileObject">REST API Reference for PutProfileObject Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the PutProfileObjectType service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/PutProfileObjectType">REST API Reference for PutProfileObjectType Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the SearchProfiles service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/SearchProfiles">REST API Reference for SearchProfiles Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the TagResource service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        /// The input you provided is invalid.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.InternalServerException">
        ...
        /// The requested resource does not exist, or access was denied.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/TagResource">REST API Reference for TagResource Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the UntagResource service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        /// The input you provided is invalid.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.InternalServerException">
        ...
        /// The requested resource does not exist, or access was denied.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/UntagResource">REST API Reference for UntagResource Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the UpdateDomain service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/UpdateDomain">REST API Reference for UpdateDomain Operation</seealso>
        ...
        /// </param>
        /// 
        /// <returns>The response from the UpdateProfile service method, as returned by Profile.</returns>
        /// <exception cref="Amazon.Profile.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.Profile.Model.BadRequestException">
        ...
        /// You exceeded the maximum number of requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/UpdateProfile">REST API Reference for UpdateProfile Operation</seealso>
