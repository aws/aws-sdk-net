...
namespace Amazon.CodeStarNotifications.Model
{
    ...
    /// </summary>
    internal sealed partial class ListTargetsPaginator : IPaginator<ListTargetsResponse>, IListTargetsPaginator
    {
        private readonly IAmazonCodeStarNotifications _client;
        private readonly ListTargetsRequest _request;
        private int _isPaginatorInUse = 0;

        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListTargetsResponse> Responses => new PaginatedResponse<ListTargetsResponse>(this);
...
#if NETFRAMEWORK
        IEnumerable<ListTargetsResponse> IPaginator<ListTargetsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListTargets(_request);
        ...
        async IAsyncEnumerable<ListTargetsResponse> IPaginator<ListTargetsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListTargetsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
