...
namespace Amazon.CodeStarNotifications.Model
{
    ...
    public partial class ConfigurationException : AmazonCodeStarNotificationsException
    {
        ...
        public ConfigurationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConfigurationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
