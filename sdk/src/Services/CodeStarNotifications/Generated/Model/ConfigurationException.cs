...
namespace Amazon.CodeStarNotifications.Model
{
    ...
    [Serializable]
#endif
    public class ConfigurationException : AmazonCodeStarNotificationsException 
    {
        /// <summary>
        ...
        public ConfigurationException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConfigurationException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
