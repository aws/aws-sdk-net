...
{
    /// <summary>
    /// Container for the parameters to the ListEventTypes operation. Returns information
    /// about the event types available for configuring notifications.
    /// </summary>
    public partial class ListEventTypesRequest : AmazonCodeStarNotificationsRequest
    {
        ...
        /// </summary>
        public List<ListEventTypesFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<ListEventTypesFilter>() : null;
