...
{
    /// <summary>
    /// Container for the parameters to the ListTargets operation. Returns a list of the notification
    /// rule targets for an Amazon Web Services account.
    /// </summary>
    public partial class ListTargetsRequest : AmazonCodeStarNotificationsRequest
    {
        ...
        /// </summary>
        public List<ListTargetsFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<ListTargetsFilter>() : null;
