...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListNotificationRulesRequestMarshaller : IMarshaller<IRequest, ListNotificationRulesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListNotificationRulesRequestMarshaller _instance = new();

        internal static ListNotificationRulesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListNotificationRulesRequestMarshaller Instance => _instance;
    }
}
