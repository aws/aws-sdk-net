...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SubscribeRequestMarshaller : IMarshaller<IRequest, SubscribeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SubscribeRequestMarshaller _instance = new();

        internal static SubscribeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SubscribeRequestMarshaller Instance => _instance;
    }
}
