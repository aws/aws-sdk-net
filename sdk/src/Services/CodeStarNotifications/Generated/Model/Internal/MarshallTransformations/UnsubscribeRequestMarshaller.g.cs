...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UnsubscribeRequestMarshaller : IMarshaller<IRequest, UnsubscribeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UnsubscribeRequest publicRequest)
        {
            ...
            request.ResourcePath = "/unsubscribe";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetTargetAddress())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TargetAddress);
            }
        ...
        private static readonly UnsubscribeRequestMarshaller _instance = new();

        internal static UnsubscribeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UnsubscribeRequestMarshaller Instance => _instance;
    }
}
