...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateNotificationRuleRequestMarshaller : IMarshaller<IRequest, CreateNotificationRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateNotificationRuleRequestMarshaller _instance = new();

        internal static CreateNotificationRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateNotificationRuleRequestMarshaller Instance => _instance;
    }
}
