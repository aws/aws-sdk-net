...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EventTypeSummaryUnmarshaller : IJsonUnmarshaller<EventTypeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EventTypeSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EventTypeSummaryUnmarshaller Instance => _instance;
    }
}
