...
{
    /// <summary>
    /// Container for the parameters to the UpdateNotificationRule operation. Updates a notification
    /// rule for a resource. You can change the events that trigger the notification rule,
    /// the status of the rule, and the targets that receive the notifications. <note> <para>
    /// To add or remove tags for a notification rule, you must use <a>TagResource</a> and
    /// <a>UntagResource</a>. </para> </note>
    /// </summary>
