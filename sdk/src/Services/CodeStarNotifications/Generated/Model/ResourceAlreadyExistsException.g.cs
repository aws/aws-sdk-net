...
namespace Amazon.CodeStarNotifications.Model
{
    ...
    public partial class ResourceAlreadyExistsException : AmazonCodeStarNotificationsException
    {
        ...
        /// Construct instance of ResourceAlreadyExistsException
        /// </summary>
        public ResourceAlreadyExistsException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ResourceAlreadyExistsException
        /// </summary>
        public ResourceAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ResourceAlreadyExistsException
        /// </summary>
        public ResourceAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
