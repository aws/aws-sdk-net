...
namespace Amazon.CodeStarNotifications
{
    ...
    public partial class AmazonCodeStarNotificationsClient : AmazonServiceClient, IAmazonCodeStarNotifications
    {
        ...
        /// 
        /// </summary>
        public AmazonCodeStarNotificationsClient() : base(new AmazonCodeStarNotificationsConfig()) { }
        ...
        public AmazonCodeStarNotificationsClient(RegionEndpoint region) : base(new AmazonCodeStarNotificationsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonCodeStarNotificationsClient(AmazonCodeStarNotificationsConfig config) : base(config) { }
