...
namespace Amazon.CodeStarNotifications
{
    ...
    public partial class AmazonCodeStarNotificationsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("codestar notifications", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "codestar notifications";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "codestar-notifications";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-10-15";
