...
namespace Amazon.Omics.Model
{
    ...
    internal sealed partial class ListRunsPaginator : IPaginator<ListRunsResponse>, IListRunsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<RunListItem> Items => 
            new PaginatedResultKeyResponse<ListRunsResponse, RunListItem>(this, (i) => i.Items ?? new List<RunListItem>());

        internal ListRunsPaginator(IAmazonOmics client, ListRunsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListRunsResponse> IPaginator<ListRunsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
