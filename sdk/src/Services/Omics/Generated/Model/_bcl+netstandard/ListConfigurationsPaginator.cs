...
namespace Amazon.Omics.Model
{
    ...
    internal sealed partial class ListConfigurationsPaginator : IPaginator<ListConfigurationsResponse>, IListConfigurationsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ConfigurationListItem> Items => 
            new PaginatedResultKeyResponse<ListConfigurationsResponse, ConfigurationListItem>(this, (i) => i.Items ?? new List<ConfigurationListItem>());

        internal ListConfigurationsPaginator(IAmazonOmics client, ListConfigurationsRequest request)
        {
            this._client = client;
