...
{
    /// <summary>
    /// Response Unmarshaller for GetReadSetImportJob operation
    /// </summary>  
    public class GetReadSetImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetReadSetImportJobResponse response = new GetReadSetImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImportReadSetSourceItem, ImportReadSetSourceItemUnmarshaller>(ImportReadSetSourceItemUnmarshaller.Instance);
        ...
        private static GetReadSetImportJobResponseUnmarshaller _instance = new GetReadSetImportJobResponseUnmarshaller();        

        internal static GetReadSetImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReadSetImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
