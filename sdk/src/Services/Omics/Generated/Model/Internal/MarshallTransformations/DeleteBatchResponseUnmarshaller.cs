...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBatch operation
    /// </summary>  
    public class DeleteBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteBatchResponseUnmarshaller _instance = new DeleteBatchResponseUnmarshaller();        

        internal static DeleteBatchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
