...
{
    /// <summary>
    /// Response Unmarshaller for StartRunBatch operation
    /// </summary>  
    public class StartRunBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRunBatchResponse response = new StartRunBatchResponse();
        ...
        private static StartRunBatchResponseUnmarshaller _instance = new StartRunBatchResponseUnmarshaller();        

        internal static StartRunBatchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRunBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
