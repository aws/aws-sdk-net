...
{
    /// <summary>
    /// Response Unmarshaller for StartReadSetExportJob operation
    /// </summary>  
    public class StartReadSetExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartReadSetExportJobResponse response = new StartReadSetExportJobResponse();
        ...
        private static StartReadSetExportJobResponseUnmarshaller _instance = new StartReadSetExportJobResponseUnmarshaller();        

        internal static StartReadSetExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartReadSetExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
