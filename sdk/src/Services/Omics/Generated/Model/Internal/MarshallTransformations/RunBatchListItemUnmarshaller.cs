...
namespace Amazon.Omics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RunBatchListItemUnmarshaller : IUnmarshaller<RunBatchListItem, XmlUnmarshallerContext>, IUnmarshaller<RunBatchListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RunBatchListItem IUnmarshaller<RunBatchListItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RunBatchListItem Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RunInternalUuid = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("runSettingId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RunSettingId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("submissionFailureMessage", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SubmissionFailureMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("submissionFailureReason", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SubmissionFailureReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("submissionStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SubmissionStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
