...
{
    /// <summary>
    /// Response Unmarshaller for ListRunCaches operation
    /// </summary>  
    public class ListRunCachesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRunCachesResponse response = new ListRunCachesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RunCacheListItem, RunCacheListItemUnmarshaller>(RunCacheListItemUnmarshaller.Instance);
        ...
        private static ListRunCachesResponseUnmarshaller _instance = new ListRunCachesResponseUnmarshaller();        

        internal static ListRunCachesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRunCachesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
