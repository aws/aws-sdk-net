...
{
    /// <summary>
    /// ListWorkflowVersions Request Marshaller
    /// </summary>       
    public class ListWorkflowVersionsRequestMarshaller : IMarshaller<IRequest, ListWorkflowVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListWorkflowVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListWorkflowVersionsRequest publicRequest)
        {
        ...
        private static ListWorkflowVersionsRequestMarshaller _instance = new ListWorkflowVersionsRequestMarshaller();        

        internal static ListWorkflowVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkflowVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
