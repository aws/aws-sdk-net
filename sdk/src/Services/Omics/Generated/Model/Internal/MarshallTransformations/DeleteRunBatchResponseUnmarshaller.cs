...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRunBatch operation
    /// </summary>  
    public class DeleteRunBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRunBatchResponse response = new DeleteRunBatchResponse();
        ...
        private static DeleteRunBatchResponseUnmarshaller _instance = new DeleteRunBatchResponseUnmarshaller();        

        internal static DeleteRunBatchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRunBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
