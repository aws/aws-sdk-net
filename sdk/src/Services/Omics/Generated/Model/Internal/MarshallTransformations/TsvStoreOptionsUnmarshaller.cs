...
namespace Amazon.Omics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TsvStoreOptionsUnmarshaller : IUnmarshaller<TsvStoreOptions, XmlUnmarshallerContext>, IUnmarshaller<TsvStoreOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TsvStoreOptions IUnmarshaller<TsvStoreOptions, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TsvStoreOptions Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("annotationType", targetDepth))
                {
                    ...
                    unmarshalledObject.AnnotationType = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("formatToHeader", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.FormatToHeader = unmarshaller.Unmarshall(context);
                    continue;
                }
