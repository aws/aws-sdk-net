...
{
    /// <summary>
    /// GetWorkflowVersion Request Marshaller
    /// </summary>       
    public class GetWorkflowVersionRequestMarshaller : IMarshaller<IRequest, GetWorkflowVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetWorkflowVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetWorkflowVersionRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetExport())
                request.ParameterCollection.Add("export", publicRequest.Export);
        ...
        private static GetWorkflowVersionRequestMarshaller _instance = new GetWorkflowVersionRequestMarshaller();        

        internal static GetWorkflowVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
