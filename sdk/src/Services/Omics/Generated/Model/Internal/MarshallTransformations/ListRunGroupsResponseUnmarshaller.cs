...
{
    /// <summary>
    /// Response Unmarshaller for ListRunGroups operation
    /// </summary>  
    public class ListRunGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRunGroupsResponse response = new ListRunGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RunGroupListItem, RunGroupListItemUnmarshaller>(RunGroupListItemUnmarshaller.Instance);
        ...
        private static ListRunGroupsResponseUnmarshaller _instance = new ListRunGroupsResponseUnmarshaller();        

        internal static ListRunGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRunGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
