...
{
    /// <summary>
    /// Response Unmarshaller for CancelRunBatch operation
    /// </summary>  
    public class CancelRunBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelRunBatchResponse response = new CancelRunBatchResponse();
        ...
        private static CancelRunBatchResponseUnmarshaller _instance = new CancelRunBatchResponseUnmarshaller();        

        internal static CancelRunBatchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelRunBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
