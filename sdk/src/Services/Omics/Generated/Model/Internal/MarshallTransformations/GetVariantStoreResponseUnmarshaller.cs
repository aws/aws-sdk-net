        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("reference", targetDepth))
                {
                    ...
                    response.Reference = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StoreArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("storeSizeBytes", targetDepth))
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    response.StoreSizeBytes = unmarshaller.Unmarshall(context);
                    continue;
                }
