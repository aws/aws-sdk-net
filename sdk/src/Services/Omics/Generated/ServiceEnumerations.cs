...
namespace Amazon.Omics
{
    ...
    /// <summary>
    /// Constants used for properties of type ScratchStorageMode.
    /// </summary>
    public class ScratchStorageMode : ConstantClass
    {

        /// <summary>
        /// Constant LOCAL for ScratchStorageMode
        /// </summary>
        public static readonly ScratchStorageMode LOCAL = new ScratchStorageMode("LOCAL");
        /// <summary>
        /// Constant SHARED for ScratchStorageMode
        /// </summary>
        public static readonly ScratchStorageMode SHARED = new ScratchStorageMode("SHARED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ScratchStorageMode(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ScratchStorageMode FindValue(string value)
        {
            return FindValue<ScratchStorageMode>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ScratchStorageMode(string value)
        {
            return FindValue(value);
        }
    }
