...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeMLModelsRequestMarshaller : IMarshaller<IRequest, DescribeMLModelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMLModelsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMLModelsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MachineLearning");
            string target = "AmazonML_20141212.DescribeMLModels";
        ...
        private static DescribeMLModelsRequestMarshaller _instance = new DescribeMLModelsRequestMarshaller();        

        internal static DescribeMLModelsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMLModelsRequestMarshaller Instance
        {
            get
            {
                return _instance;
