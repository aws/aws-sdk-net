...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateDataSourceFromRDSRequestMarshaller : IMarshaller<IRequest, CreateDataSourceFromRDSRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDataSourceFromRDSRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDataSourceFromRDSRequest publicRequest)
        {
        ...
        private static CreateDataSourceFromRDSRequestMarshaller _instance = new CreateDataSourceFromRDSRequestMarshaller();        

        internal static CreateDataSourceFromRDSRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataSourceFromRDSRequestMarshaller Instance
        {
            get
            {
                return _instance;
