...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMLModelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMLModelsResponse response = new DescribeMLModelsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MLModel, MLModelUnmarshaller>(MLModelUnmarshaller.Instance);
        ...
        private static DescribeMLModelsResponseUnmarshaller _instance = new DescribeMLModelsResponseUnmarshaller();        

        internal static DescribeMLModelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMLModelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
