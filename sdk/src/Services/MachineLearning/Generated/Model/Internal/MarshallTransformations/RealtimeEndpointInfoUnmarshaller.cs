...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RealtimeEndpointInfoUnmarshaller : IJsonUnmarshaller<RealtimeEndpointInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RealtimeEndpointInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RealtimeEndpointInfo unmarshalledObject = new RealtimeEndpointInfo();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PeakRequestsPerSecond", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.PeakRequestsPerSecond = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
