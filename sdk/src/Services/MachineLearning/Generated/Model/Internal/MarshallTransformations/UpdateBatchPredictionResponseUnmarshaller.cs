...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateBatchPredictionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBatchPredictionResponse response = new UpdateBatchPredictionResponse();
        ...
        private static UpdateBatchPredictionResponseUnmarshaller _instance = new UpdateBatchPredictionResponseUnmarshaller();        

        internal static UpdateBatchPredictionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBatchPredictionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
