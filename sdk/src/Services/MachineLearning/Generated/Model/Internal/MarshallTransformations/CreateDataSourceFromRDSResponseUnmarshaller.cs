...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDataSourceFromRDSResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataSourceFromRDSResponse response = new CreateDataSourceFromRDSResponse();
        ...
        private static CreateDataSourceFromRDSResponseUnmarshaller _instance = new CreateDataSourceFromRDSResponseUnmarshaller();        

        internal static CreateDataSourceFromRDSResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataSourceFromRDSResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
