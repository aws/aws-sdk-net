...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredictionUnmarshaller : IUnmarshaller<Prediction, XmlUnmarshallerContext>, IUnmarshaller<Prediction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Prediction IUnmarshaller<Prediction, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Prediction Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("predictedLabel", targetDepth))
                {
                    ...
                    unmarshalledObject.PredictedLabel = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("predictedScores", targetDepth))
                {
                    ...
                    unmarshalledObject.PredictedScores = unmarshaller.Unmarshall(context);
                    continue;
                }
