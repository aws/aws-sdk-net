...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDataSourcesRequestMarshaller : IMarshaller<IRequest, DescribeDataSourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDataSourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDataSourcesRequest publicRequest)
        {
