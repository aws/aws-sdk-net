...
namespace Amazon.MachineLearning.Internal
{
    ...
    public class AmazonMachineLearningAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMachineLearningAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MachineLearning.
        /// </summary>
        public AmazonMachineLearningAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMachineLearningAuthSchemeParameters
            {
    ...
    public class AmazonMachineLearningAuthSchemeResolver : IAuthSchemeResolver<AmazonMachineLearningAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMachineLearningAuthSchemeParameters authParameters)
        {
