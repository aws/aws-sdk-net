...
namespace Amazon.MachineLearning
{
    ...
    public partial class AmazonMachineLearningException : AmazonServiceException
    {
        ...
        public AmazonMachineLearningException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonMachineLearningException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
