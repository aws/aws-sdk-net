...
namespace Amazon.RedshiftServerless
{
    ...
    public partial interface IAmazonRedshiftServerless : IAmazonService, IDisposable
    {
        ...
        Task<UpdateLakehouseConfigurationResponse> UpdateLakehouseConfigurationAsync(UpdateLakehouseConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
