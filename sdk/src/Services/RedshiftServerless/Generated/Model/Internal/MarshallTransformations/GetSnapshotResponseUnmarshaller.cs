...
{
    /// <summary>
    /// Response Unmarshaller for GetSnapshot operation
    /// </summary>  
    public class GetSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetSnapshotResponseUnmarshaller _instance = new GetSnapshotResponseUnmarshaller();        

        internal static GetSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
