...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSnapshot operation
    /// </summary>  
    public class UpdateSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateSnapshotResponseUnmarshaller _instance = new UpdateSnapshotResponseUnmarshaller();        

        internal static UpdateSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
