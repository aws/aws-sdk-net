...
namespace Amazon.RedshiftServerless.Model.Internal.MarshallTransformations
{
    ...
    public class GetIdentityCenterAuthTokenRequestMarshaller : IMarshaller<IRequest, GetIdentityCenterAuthTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetIdentityCenterAuthTokenRequest publicRequest)
        {
            ...
            string target = "RedshiftServerless.GetIdentityCenterAuthToken";
            ...
            if(publicRequest.IsSetWorkgroupNames())
            {
                context.Writer.WritePropertyName("workgroupNames");
                context.Writer.WriteStartArray();
                foreach(var publicRequestWorkgroupNamesListValue in publicRequest.WorkgroupNames)
                {
                        context.Writer.WriteStringValue(publicRequestWorkgroupNamesListValue);
                }
