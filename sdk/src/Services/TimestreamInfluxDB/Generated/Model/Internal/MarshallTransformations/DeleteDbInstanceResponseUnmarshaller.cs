    ...
    public class DeleteDbInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dbParameterGroupIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("nextMaintenanceTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SecondaryAvailabilityZone = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
