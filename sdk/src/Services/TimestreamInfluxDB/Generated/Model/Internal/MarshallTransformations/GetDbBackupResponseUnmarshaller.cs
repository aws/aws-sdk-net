...
{
    /// <summary>
    /// Response Unmarshaller for GetDbBackup operation
    /// </summary>  
    public class GetDbBackupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDbBackupResponse response = new GetDbBackupResponse();
        ...
        private static GetDbBackupResponseUnmarshaller _instance = new GetDbBackupResponseUnmarshaller();        

        internal static GetDbBackupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDbBackupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
