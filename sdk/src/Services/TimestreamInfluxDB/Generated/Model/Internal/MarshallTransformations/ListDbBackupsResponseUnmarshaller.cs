...
{
    /// <summary>
    /// Response Unmarshaller for ListDbBackups operation
    /// </summary>  
    public class ListDbBackupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDbBackupsResponse response = new ListDbBackupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DbBackupSummary, DbBackupSummaryUnmarshaller>(DbBackupSummaryUnmarshaller.Instance);
        ...
        private static ListDbBackupsResponseUnmarshaller _instance = new ListDbBackupsResponseUnmarshaller();        

        internal static ListDbBackupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDbBackupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
