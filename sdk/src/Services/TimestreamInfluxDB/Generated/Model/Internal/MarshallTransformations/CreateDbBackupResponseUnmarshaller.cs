...
{
    /// <summary>
    /// Response Unmarshaller for CreateDbBackup operation
    /// </summary>  
    public class CreateDbBackupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDbBackupResponse response = new CreateDbBackupResponse();
        ...
        private static CreateDbBackupResponseUnmarshaller _instance = new CreateDbBackupResponseUnmarshaller();        

        internal static CreateDbBackupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDbBackupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
