...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDbCluster operation
    /// </summary>  
    public class UpdateDbClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDbClusterResponse response = new UpdateDbClusterResponse();
            ...
            {
                if (context.TestExpression("dbClusterStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DbClusterStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateDbClusterResponseUnmarshaller _instance = new UpdateDbClusterResponseUnmarshaller();        

        internal static UpdateDbClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDbClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
