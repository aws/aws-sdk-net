...
{
    /// <summary>
    /// Response Unmarshaller for RestoreFromDbBackup operation
    /// </summary>  
    public class RestoreFromDbBackupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreFromDbBackupResponse response = new RestoreFromDbBackupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("restoredDbResourceId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RestoredDbResourceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("restoreStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RestoreStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RestoreFromDbBackupResponseUnmarshaller _instance = new RestoreFromDbBackupResponseUnmarshaller();        

        internal static RestoreFromDbBackupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreFromDbBackupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
