...
namespace Amazon.TimestreamInfluxDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogDeliveryConfigurationUnmarshaller : IJsonUnmarshaller<LogDeliveryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogDeliveryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
