...
namespace Amazon.TimestreamInfluxDB
{
    ...
    public partial class AmazonTimestreamInfluxDBClient : AmazonServiceClient, IAmazonTimestreamInfluxDB
    {
        ...
        internal virtual CreateDbBackupResponse CreateDbBackup(CreateDbBackupRequest request)
        {
        ...
        internal virtual DeleteDbBackupResponse DeleteDbBackup(DeleteDbBackupRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetDbBackupResponse GetDbBackup(GetDbBackupRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListDbBackupsResponse ListDbBackups(ListDbBackupsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual RestoreFromDbBackupResponse RestoreFromDbBackup(RestoreFromDbBackupRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
