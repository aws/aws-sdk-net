...
namespace Amazon.NetworkFirewall.Model
{
    ...
    /// </summary>
    public partial class ProxyRuleGroupAttachment
    {
        private int? _insertPosition;
        private string _proxyRuleGroupName;

        /// <summary>
        /// Gets and sets the property InsertPosition. 
        /// <para>
        ...
        {
            get { return this._insertPosition.GetValueOrDefault(); }
            set { this._insertPosition = value; }
        }

        // Check to see if InsertPosition property is set
        internal bool IsSetInsertPosition()
        {
            return this._insertPosition.HasValue; 
        }
