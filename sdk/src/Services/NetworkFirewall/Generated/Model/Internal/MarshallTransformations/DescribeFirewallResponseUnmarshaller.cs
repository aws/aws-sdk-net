...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFirewall operation
    /// </summary>  
    public class DescribeFirewallResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("Firewall", targetDepth, ref reader))
                {
                    var unmarshaller = FirewallUnmarshaller.Instance;
                    response.Firewall = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("FirewallStatus", targetDepth, ref reader))
                {
                    var unmarshaller = FirewallStatusUnmarshaller.Instance;
                    response.FirewallStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeFirewallResponseUnmarshaller _instance = new DescribeFirewallResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFirewallResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
