...
namespace Amazon.NetworkFirewall.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProxyRuleConditionUnmarshaller : IUnmarshaller<ProxyRuleCondition, XmlUnmarshallerContext>, IUnmarshaller<ProxyRuleCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProxyRuleCondition IUnmarshaller<ProxyRuleCondition, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProxyRuleCondition Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConditionOperator = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ConditionValues", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.ConditionValues = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
