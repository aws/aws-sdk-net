...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRuleGroup operation
    /// </summary>  
    public class UpdateRuleGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRuleGroupResponse response = new UpdateRuleGroupResponse();
            ...
            {
                if (context.TestExpression("RuleGroupResponse", targetDepth, ref reader))
                {
                    var unmarshaller = RuleGroupResponseUnmarshaller.Instance;
                    response.RuleGroupResponse = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateRuleGroupResponseUnmarshaller _instance = new UpdateRuleGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRuleGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
