...
{
    /// <summary>
    /// Response Unmarshaller for CreateProxyConfiguration operation
    /// </summary>  
    public class CreateProxyConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProxyConfigurationResponse response = new CreateProxyConfigurationResponse();
        ...
        private static CreateProxyConfigurationResponseUnmarshaller _instance = new CreateProxyConfigurationResponseUnmarshaller();        

        internal static CreateProxyConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProxyConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
