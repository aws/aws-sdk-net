...
namespace Amazon.NetworkFirewall.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StatefulRuleUnmarshaller : IUnmarshaller<StatefulRule, XmlUnmarshallerContext>, IUnmarshaller<StatefulRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        StatefulRule IUnmarshaller<StatefulRule, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public StatefulRule Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RuleOption, RuleOptionUnmarshaller>(RuleOptionUnmarshaller.Instance);
