...
namespace Amazon.NetworkFirewall.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnalysisReportUnmarshaller : IUnmarshaller<AnalysisReport, XmlUnmarshallerContext>, IUnmarshaller<AnalysisReport, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AnalysisReport IUnmarshaller<AnalysisReport, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AnalysisReport Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ReportTime", targetDepth))
                {
                    ...
                    unmarshalledObject.ReportTime = unmarshaller.Unmarshall(context);
                    continue;
                }
