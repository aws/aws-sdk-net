...
{
    /// <summary>
    /// Response Unmarshaller for CreateProxy operation
    /// </summary>  
    public class CreateProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProxyResponse response = new CreateProxyResponse();
        ...
        private static CreateProxyResponseUnmarshaller _instance = new CreateProxyResponseUnmarshaller();        

        internal static CreateProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
