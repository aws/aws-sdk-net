...
{
    /// <summary>
    /// Response Unmarshaller for ListFirewallPolicies operation
    /// </summary>  
    public class ListFirewallPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFirewallPoliciesResponse response = new ListFirewallPoliciesResponse();
            ...
            {
                if (context.TestExpression("FirewallPolicies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FirewallPolicyMetadata, FirewallPolicyMetadataUnmarshaller>(FirewallPolicyMetadataUnmarshaller.Instance);
                    response.FirewallPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFirewallPoliciesResponseUnmarshaller _instance = new ListFirewallPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFirewallPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
