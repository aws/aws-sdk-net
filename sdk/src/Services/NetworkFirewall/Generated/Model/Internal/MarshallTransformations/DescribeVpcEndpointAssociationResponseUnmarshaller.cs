...
{
    /// <summary>
    /// Response Unmarshaller for DescribeVpcEndpointAssociation operation
    /// </summary>  
    public class DescribeVpcEndpointAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeVpcEndpointAssociationResponse response = new DescribeVpcEndpointAssociationResponse();
        ...
        private static DescribeVpcEndpointAssociationResponseUnmarshaller _instance = new DescribeVpcEndpointAssociationResponseUnmarshaller();        

        internal static DescribeVpcEndpointAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVpcEndpointAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
