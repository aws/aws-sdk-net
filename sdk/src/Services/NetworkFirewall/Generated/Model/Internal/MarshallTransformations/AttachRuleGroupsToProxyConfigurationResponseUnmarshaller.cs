...
{
    /// <summary>
    /// Response Unmarshaller for AttachRuleGroupsToProxyConfiguration operation
    /// </summary>  
    public class AttachRuleGroupsToProxyConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachRuleGroupsToProxyConfigurationResponse response = new AttachRuleGroupsToProxyConfigurationResponse();
        ...
        private static AttachRuleGroupsToProxyConfigurationResponseUnmarshaller _instance = new AttachRuleGroupsToProxyConfigurationResponseUnmarshaller();        

        internal static AttachRuleGroupsToProxyConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachRuleGroupsToProxyConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
