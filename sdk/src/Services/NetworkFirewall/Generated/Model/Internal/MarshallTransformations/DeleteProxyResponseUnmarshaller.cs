...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProxy operation
    /// </summary>  
    public class DeleteProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProxyResponse response = new DeleteProxyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("NatGatewayId", targetDepth, ref reader))
                {
                    ...
                    response.NatGatewayId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ProxyArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProxyArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ProxyName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProxyName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteProxyResponseUnmarshaller _instance = new DeleteProxyResponseUnmarshaller();        

        internal static DeleteProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
