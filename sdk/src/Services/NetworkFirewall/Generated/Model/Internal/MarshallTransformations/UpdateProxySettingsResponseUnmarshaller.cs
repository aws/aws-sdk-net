...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProxySettings operation
    /// </summary>  
    public class UpdateProxySettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProxySettingsResponse response = new UpdateProxySettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ProxySettings", targetDepth, ref reader))
                {
                    ...
                    response.ProxySettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateProxySettingsResponseUnmarshaller _instance = new UpdateProxySettingsResponseUnmarshaller();        

        internal static UpdateProxySettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProxySettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
