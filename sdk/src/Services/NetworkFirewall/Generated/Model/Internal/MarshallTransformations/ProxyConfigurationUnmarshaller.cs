...
namespace Amazon.NetworkFirewall.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProxyConfigurationUnmarshaller : IUnmarshaller<ProxyConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ProxyConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProxyConfiguration IUnmarshaller<ProxyConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProxyConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("DefaultRulePhaseActions", targetDepth))
                {
                    ...
                    unmarshalledObject.DefaultRulePhaseActions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProxyConfigRuleGroup, ProxyConfigRuleGroupUnmarshaller>(ProxyConfigRuleGroupUnmarshaller.Instance);
                    unmarshalledObject.RuleGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
