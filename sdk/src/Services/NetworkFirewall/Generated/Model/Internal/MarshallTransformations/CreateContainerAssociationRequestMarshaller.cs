...
{
    /// <summary>
    /// CreateContainerAssociation Request Marshaller
    /// </summary>       
    public class CreateContainerAssociationRequestMarshaller : IMarshaller<IRequest, CreateContainerAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateContainerAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateContainerAssociationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.CreateContainerAssociation";
        ...
        private static CreateContainerAssociationRequestMarshaller _instance = new CreateContainerAssociationRequestMarshaller();        

        internal static CreateContainerAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContainerAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
