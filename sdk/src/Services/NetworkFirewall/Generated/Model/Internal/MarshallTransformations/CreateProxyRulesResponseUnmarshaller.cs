...
{
    /// <summary>
    /// Response Unmarshaller for CreateProxyRules operation
    /// </summary>  
    public class CreateProxyRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProxyRulesResponse response = new CreateProxyRulesResponse();
        ...
        private static CreateProxyRulesResponseUnmarshaller _instance = new CreateProxyRulesResponseUnmarshaller();        

        internal static CreateProxyRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProxyRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
