...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProxy operation
    /// </summary>  
    public class UpdateProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProxyResponse response = new UpdateProxyResponse();
        ...
        private static UpdateProxyResponseUnmarshaller _instance = new UpdateProxyResponseUnmarshaller();        

        internal static UpdateProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
