...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFirewallDeleteProtection operation
    /// </summary>  
    public class UpdateFirewallDeleteProtectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFirewallDeleteProtectionResponse response = new UpdateFirewallDeleteProtectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DeleteProtection", targetDepth))
                {
                    ...
                    response.DeleteProtection = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResourceOwnerCheckException"))
                {
                    return ResourceOwnerCheckExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateFirewallDeleteProtectionResponseUnmarshaller _instance = new UpdateFirewallDeleteProtectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallDeleteProtectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
