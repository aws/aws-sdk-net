...
{
    /// <summary>
    /// UpdateProxySettings Request Marshaller
    /// </summary>       
    public class UpdateProxySettingsRequestMarshaller : IMarshaller<IRequest, UpdateProxySettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateProxySettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateProxySettingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.UpdateProxySettings";
        ...
        private static UpdateProxySettingsRequestMarshaller _instance = new UpdateProxySettingsRequestMarshaller();        

        internal static UpdateProxySettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProxySettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
