...
{
    /// <summary>
    /// Response Unmarshaller for DetachRuleGroupsFromProxyConfiguration operation
    /// </summary>  
    public class DetachRuleGroupsFromProxyConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachRuleGroupsFromProxyConfigurationResponse response = new DetachRuleGroupsFromProxyConfigurationResponse();
        ...
        private static DetachRuleGroupsFromProxyConfigurationResponseUnmarshaller _instance = new DetachRuleGroupsFromProxyConfigurationResponseUnmarshaller();        

        internal static DetachRuleGroupsFromProxyConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachRuleGroupsFromProxyConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
