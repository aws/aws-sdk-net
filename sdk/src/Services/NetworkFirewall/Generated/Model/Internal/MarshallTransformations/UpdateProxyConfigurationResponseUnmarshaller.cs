...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProxyConfiguration operation
    /// </summary>  
    public class UpdateProxyConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProxyConfigurationResponse response = new UpdateProxyConfigurationResponse();
        ...
        private static UpdateProxyConfigurationResponseUnmarshaller _instance = new UpdateProxyConfigurationResponseUnmarshaller();        

        internal static UpdateProxyConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProxyConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
