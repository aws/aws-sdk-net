...
{
    /// <summary>
    /// UpdateProxyConfiguration Request Marshaller
    /// </summary>       
    public class UpdateProxyConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateProxyConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateProxyConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateProxyConfigurationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.UpdateProxyConfiguration";
        ...
        private static UpdateProxyConfigurationRequestMarshaller _instance = new UpdateProxyConfigurationRequestMarshaller();        

        internal static UpdateProxyConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProxyConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
