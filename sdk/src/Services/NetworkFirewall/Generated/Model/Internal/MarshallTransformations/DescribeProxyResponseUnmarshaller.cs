...
{
    /// <summary>
    /// Response Unmarshaller for DescribeProxy operation
    /// </summary>  
    public class DescribeProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeProxyResponse response = new DescribeProxyResponse();
        ...
        private static DescribeProxyResponseUnmarshaller _instance = new DescribeProxyResponseUnmarshaller();        

        internal static DescribeProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
