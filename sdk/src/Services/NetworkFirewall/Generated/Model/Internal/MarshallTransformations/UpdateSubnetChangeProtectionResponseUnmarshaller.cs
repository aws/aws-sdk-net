...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSubnetChangeProtection operation
    /// </summary>  
    public class UpdateSubnetChangeProtectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSubnetChangeProtectionResponse response = new UpdateSubnetChangeProtectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SubnetChangeProtection", targetDepth))
                {
                    ...
                    response.SubnetChangeProtection = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateSubnetChangeProtectionResponseUnmarshaller _instance = new UpdateSubnetChangeProtectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubnetChangeProtectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
