...
{
    /// <summary>
    /// Container for the parameters to the DescribeProxyConfiguration operation.
    /// Returns the data objects for the specified proxy configuration.
    /// </summary>
    public partial class DescribeProxyConfigurationRequest : AmazonNetworkFirewallRequest
    {
