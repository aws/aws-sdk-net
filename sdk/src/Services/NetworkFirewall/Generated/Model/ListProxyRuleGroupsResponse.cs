...
{
    /// <summary>
    /// This is the response object from the ListProxyRuleGroups operation.
    /// </summary>
    public partial class ListProxyRuleGroupsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<ProxyRuleGroupMetadata> _proxyRuleGroups = AWSConfigs.InitializeCollections ? new List<ProxyRuleGroupMetadata>() : null;
        ...
        /// <para>
        /// The metadata for the proxy rule groups. Depending on your setting for max results
        /// and the number of proxy rule groups that you have, this might not be the full list.
        /// 
        /// </para>
        /// <para />
        ...
        /// </summary>
        public List<ProxyRuleGroupMetadata> ProxyRuleGroups
        {
