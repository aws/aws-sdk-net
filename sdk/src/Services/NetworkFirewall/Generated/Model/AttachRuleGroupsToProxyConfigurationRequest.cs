...
{
    /// <summary>
    /// Container for the parameters to the AttachRuleGroupsToProxyConfiguration operation.
    ...
    /// </para>
    /// </summary>
    public partial class AttachRuleGroupsToProxyConfigurationRequest : AmazonNetworkFirewallRequest
    {
        private string _proxyConfigurationArn;
        private string _proxyConfigurationName;
        private List<ProxyRuleGroupAttachment> _ruleGroups = AWSConfigs.InitializeCollections ? new List<ProxyRuleGroupAttachment>() : null;
        ...
        public List<ProxyRuleGroupAttachment> RuleGroups
        {
