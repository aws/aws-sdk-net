...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class ListProductSubscriptionsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ProductUserSummary> ProductUserSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ProductUserSummary>() : null;

        /// <summary>
        /// Checks to see if the ProductUserSummaries property is set.
        /// </summary>
        internal bool IsSetProductUserSummaries() => this.ProductUserSummaries != null && (this.ProductUserSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
