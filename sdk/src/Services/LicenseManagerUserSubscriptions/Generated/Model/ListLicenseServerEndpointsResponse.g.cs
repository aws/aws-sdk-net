...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class ListLicenseServerEndpointsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<LicenseServerEndpoint> LicenseServerEndpoints { get; set; } = AWSConfigs.InitializeCollections ? new List<LicenseServerEndpoint>() : null;

        /// <summary>
        /// Checks to see if the LicenseServerEndpoints property is set.
        /// </summary>
        internal bool IsSetLicenseServerEndpoints() => this.LicenseServerEndpoints != null && (this.LicenseServerEndpoints.Count > 0 || !AWSConfigs.InitializeCollections);
