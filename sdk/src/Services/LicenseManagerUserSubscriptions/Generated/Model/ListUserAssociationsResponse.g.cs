...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class ListUserAssociationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<InstanceUserSummary> InstanceUserSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<InstanceUserSummary>() : null;

        /// <summary>
        /// Checks to see if the InstanceUserSummaries property is set.
        /// </summary>
        internal bool IsSetInstanceUserSummaries() => this.InstanceUserSummaries != null && (this.InstanceUserSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
