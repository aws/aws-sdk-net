...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ActiveDirectorySettingsUnmarshaller : IJsonUnmarshaller<ActiveDirectorySettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ActiveDirectorySettings();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ActiveDirectorySettingsUnmarshaller Instance => _instance;
    }
}
