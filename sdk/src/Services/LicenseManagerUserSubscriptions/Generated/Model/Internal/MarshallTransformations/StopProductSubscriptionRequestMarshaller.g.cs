...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StopProductSubscriptionRequestMarshaller : IMarshaller<IRequest, StopProductSubscriptionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StopProductSubscriptionRequestMarshaller _instance = new();

        internal static StopProductSubscriptionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopProductSubscriptionRequestMarshaller Instance => _instance;
    }
}
