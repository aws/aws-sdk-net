...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InstanceSummaryUnmarshaller : IJsonUnmarshaller<InstanceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InstanceSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static InstanceSummaryUnmarshaller Instance => _instance;
    }
}
