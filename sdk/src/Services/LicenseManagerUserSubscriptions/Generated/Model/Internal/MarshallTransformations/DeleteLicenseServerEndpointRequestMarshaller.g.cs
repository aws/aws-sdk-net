...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteLicenseServerEndpointRequestMarshaller : IMarshaller<IRequest, DeleteLicenseServerEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteLicenseServerEndpointRequestMarshaller _instance = new();

        internal static DeleteLicenseServerEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteLicenseServerEndpointRequestMarshaller Instance => _instance;
    }
}
