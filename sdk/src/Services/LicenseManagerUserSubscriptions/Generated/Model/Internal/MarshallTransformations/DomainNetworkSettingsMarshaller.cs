...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class DomainNetworkSettingsMarshaller : IRequestMarshaller<DomainNetworkSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DomainNetworkSettings requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static DomainNetworkSettingsMarshaller Instance = new DomainNetworkSettingsMarshaller();
