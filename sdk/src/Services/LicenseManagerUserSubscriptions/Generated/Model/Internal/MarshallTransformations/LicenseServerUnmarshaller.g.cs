...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LicenseServerUnmarshaller : IJsonUnmarshaller<LicenseServer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LicenseServer();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LicenseServerUnmarshaller Instance => _instance;
    }
}
