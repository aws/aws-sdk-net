...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListProductSubscriptionsRequestMarshaller : IMarshaller<IRequest, ListProductSubscriptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListProductSubscriptionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListProductSubscriptionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/user/ListProductSubscriptions";
#if !NETFRAMEWORK
        ...
        private static ListProductSubscriptionsRequestMarshaller _instance = new ListProductSubscriptionsRequestMarshaller();        

        internal static ListProductSubscriptionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProductSubscriptionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
