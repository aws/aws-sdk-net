...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisterIdentityProviderRequestMarshaller : IMarshaller<IRequest, RegisterIdentityProviderRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RegisterIdentityProviderRequestMarshaller _instance = new();

        internal static RegisterIdentityProviderRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterIdentityProviderRequestMarshaller Instance => _instance;
    }
}
