...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateIdentityProviderSettingsRequestMarshaller : IMarshaller<IRequest, UpdateIdentityProviderSettingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateIdentityProviderSettingsRequestMarshaller _instance = new();

        internal static UpdateIdentityProviderSettingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIdentityProviderSettingsRequestMarshaller Instance => _instance;
    }
}
