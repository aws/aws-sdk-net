...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CredentialsProviderUnmarshaller : IJsonUnmarshaller<CredentialsProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CredentialsProvider();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CredentialsProviderUnmarshaller Instance => _instance;
    }
}
