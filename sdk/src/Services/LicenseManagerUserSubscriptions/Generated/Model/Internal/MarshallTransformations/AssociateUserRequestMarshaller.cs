...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateUserRequestMarshaller : IMarshaller<IRequest, AssociateUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateUserRequest publicRequest)
        {
            ...
            request.ResourcePath = "/user/AssociateUser";
#if !NETFRAMEWORK
        ...
        private static AssociateUserRequestMarshaller _instance = new AssociateUserRequestMarshaller();        

        internal static AssociateUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
