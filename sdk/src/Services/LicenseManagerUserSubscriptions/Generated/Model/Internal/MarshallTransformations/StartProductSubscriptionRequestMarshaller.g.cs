...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartProductSubscriptionRequestMarshaller : IMarshaller<IRequest, StartProductSubscriptionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartProductSubscriptionRequestMarshaller _instance = new();

        internal static StartProductSubscriptionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartProductSubscriptionRequestMarshaller Instance => _instance;
    }
}
