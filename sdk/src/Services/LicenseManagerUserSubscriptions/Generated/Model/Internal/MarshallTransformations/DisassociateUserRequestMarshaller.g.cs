...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateUserRequestMarshaller : IMarshaller<IRequest, DisassociateUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateUserRequestMarshaller _instance = new();

        internal static DisassociateUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateUserRequestMarshaller Instance => _instance;
    }
}
