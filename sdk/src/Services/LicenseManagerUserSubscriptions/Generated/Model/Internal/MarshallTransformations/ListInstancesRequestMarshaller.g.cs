...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListInstancesRequestMarshaller : IMarshaller<IRequest, ListInstancesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListInstancesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/instance/ListInstances";
#if !NETFRAMEWORK
        ...
        private static readonly ListInstancesRequestMarshaller _instance = new();

        internal static ListInstancesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListInstancesRequestMarshaller Instance => _instance;
    }
}
