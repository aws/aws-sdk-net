...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ActiveDirectoryIdentityProviderUnmarshaller : IJsonUnmarshaller<ActiveDirectoryIdentityProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ActiveDirectoryIdentityProvider();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ActiveDirectoryIdentityProviderUnmarshaller Instance => _instance;
    }
}
