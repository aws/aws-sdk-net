...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListProductSubscriptionsRequestMarshaller : IMarshaller<IRequest, ListProductSubscriptionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListProductSubscriptionsRequestMarshaller _instance = new();

        internal static ListProductSubscriptionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListProductSubscriptionsRequestMarshaller Instance => _instance;
    }
}
