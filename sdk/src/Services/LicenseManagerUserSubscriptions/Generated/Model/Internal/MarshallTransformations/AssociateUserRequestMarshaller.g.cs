...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociateUserRequestMarshaller : IMarshaller<IRequest, AssociateUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AssociateUserRequestMarshaller _instance = new();

        internal static AssociateUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AssociateUserRequestMarshaller Instance => _instance;
    }
}
