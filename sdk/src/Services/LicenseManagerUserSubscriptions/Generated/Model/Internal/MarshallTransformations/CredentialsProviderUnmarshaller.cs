...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CredentialsProviderUnmarshaller : IUnmarshaller<CredentialsProvider, XmlUnmarshallerContext>, IUnmarshaller<CredentialsProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CredentialsProvider IUnmarshaller<CredentialsProvider, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CredentialsProvider Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SecretsManagerCredentialsProvider", targetDepth))
                {
                    ...
                    unmarshalledObject.SecretsManagerCredentialsProvider = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
