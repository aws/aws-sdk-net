...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProductUserSummaryUnmarshaller : IJsonUnmarshaller<ProductUserSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProductUserSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProductUserSummaryUnmarshaller Instance => _instance;
    }
}
