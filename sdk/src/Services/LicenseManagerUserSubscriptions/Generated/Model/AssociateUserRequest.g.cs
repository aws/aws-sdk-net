...
{
    /// <summary>
    /// Container for the parameters to the AssociateUser operation. Associates the user to
    /// an EC2 instance to utilize user-based subscriptions. <note> <para> Your estimated
