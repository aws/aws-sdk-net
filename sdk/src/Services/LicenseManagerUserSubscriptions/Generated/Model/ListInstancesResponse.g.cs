...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class ListInstancesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<InstanceSummary> InstanceSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<InstanceSummary>() : null;

        /// <summary>
        /// Checks to see if the InstanceSummaries property is set.
        /// </summary>
        internal bool IsSetInstanceSummaries() => this.InstanceSummaries != null && (this.InstanceSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
