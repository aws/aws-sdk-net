...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class RdsSalSettings
    {
        ...
        public CredentialsProvider RdsSalCredentialsProvider { get; set; }

        /// <summary>
        /// Checks to see if the RdsSalCredentialsProvider property is set.
        /// </summary>
        internal bool IsSetRdsSalCredentialsProvider() => this.RdsSalCredentialsProvider != null;
    }
}
