...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class ListIdentityProvidersResponse : AmazonWebServiceResponse
    {
        ...
        public List<IdentityProviderSummary> IdentityProviderSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<IdentityProviderSummary>() : null;

        /// <summary>
        /// Checks to see if the IdentityProviderSummaries property is set.
        /// </summary>
        internal bool IsSetIdentityProviderSummaries() => this.IdentityProviderSummaries != null && (this.IdentityProviderSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
