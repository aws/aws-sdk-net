...
namespace Amazon.LicenseManagerUserSubscriptions.Model
{
    ...
    public partial class DeleteLicenseServerEndpointResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public LicenseServerEndpoint LicenseServerEndpoint { get; set; }

        /// <summary>
        /// Checks to see if the LicenseServerEndpoint property is set.
        /// </summary>
        internal bool IsSetLicenseServerEndpoint() => this.LicenseServerEndpoint != null;
    }
}
