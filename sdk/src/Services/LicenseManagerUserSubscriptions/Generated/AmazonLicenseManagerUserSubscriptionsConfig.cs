...
namespace Amazon.LicenseManagerUserSubscriptions
{
    ...
    public partial class AmazonLicenseManagerUserSubscriptionsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("License Manager User Subscriptions", "4.0.101.3");
        ...
        /// </summary>
        public static new string ServiceId => "License Manager User Subscriptions";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "license-manager-user-subscriptions";
