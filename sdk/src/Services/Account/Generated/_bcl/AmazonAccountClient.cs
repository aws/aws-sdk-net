...
namespace Amazon.Account
{
    ...
    public partial class AmazonAccountClient : AmazonServiceClient, IAmazonAccount
    {
        ...
        public virtual GetGovCloudAccountInformationResponse GetGovCloudAccountInformation(GetGovCloudAccountInformationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetGovCloudAccountInformationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetGovCloudAccountInformationResponseUnmarshaller.Instance;

            return Invoke<GetGovCloudAccountInformationResponse>(request, options);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/GetGovCloudAccountInformation">REST API Reference for GetGovCloudAccountInformation Operation</seealso>
        public virtual Task<GetGovCloudAccountInformationResponse> GetGovCloudAccountInformationAsync(GetGovCloudAccountInformationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetGovCloudAccountInformationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetGovCloudAccountInformationResponseUnmarshaller.Instance;
            
            return InvokeAsync<GetGovCloudAccountInformationResponse>(request, options, cancellationToken);
        }
        ...
        public virtual GetPrimaryEmailUpdateStatusResponse GetPrimaryEmailUpdateStatus(GetPrimaryEmailUpdateStatusRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetPrimaryEmailUpdateStatusRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetPrimaryEmailUpdateStatusResponseUnmarshaller.Instance;

            return Invoke<GetPrimaryEmailUpdateStatusResponse>(request, options);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/GetPrimaryEmailUpdateStatus">REST API Reference for GetPrimaryEmailUpdateStatus Operation</seealso>
        public virtual Task<GetPrimaryEmailUpdateStatusResponse> GetPrimaryEmailUpdateStatusAsync(GetPrimaryEmailUpdateStatusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetPrimaryEmailUpdateStatusRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetPrimaryEmailUpdateStatusResponseUnmarshaller.Instance;
            
            return InvokeAsync<GetPrimaryEmailUpdateStatusResponse>(request, options, cancellationToken);
        }
