...
namespace Amazon.Account
{
    ...
    public partial class AmazonAccountClient : AmazonServiceClient, IAmazonAccount
    {
        ...
        /// 
        /// </summary>
        public AmazonAccountClient() : base(new AmazonAccountConfig()) { }
        ...
        public AmazonAccountClient(RegionEndpoint region) : base(new AmazonAccountConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAccountClient(AmazonAccountConfig config) : base(config) { }
