...
namespace Amazon.Account.Internal
{
    ...
    public class AmazonAccountAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAccountAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Account.
        /// </summary>
        public AmazonAccountAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAccountAuthSchemeParameters
            {
    ...
    public class AmazonAccountAuthSchemeResolver : IAuthSchemeResolver<AmazonAccountAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAccountAuthSchemeParameters authParameters)
        {
