...
namespace Amazon.Account
{
    ...
    public partial interface IAmazonAccount : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/GetGovCloudAccountInformation">REST API Reference for GetGovCloudAccountInformation Operation</seealso>
        Task<GetGovCloudAccountInformationResponse> GetGovCloudAccountInformationAsync(GetGovCloudAccountInformationRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        GetPrimaryEmailUpdateStatusResponse GetPrimaryEmailUpdateStatus(GetPrimaryEmailUpdateStatusRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/GetPrimaryEmailUpdateStatus">REST API Reference for GetPrimaryEmailUpdateStatus Operation</seealso>
        Task<GetPrimaryEmailUpdateStatusResponse> GetPrimaryEmailUpdateStatusAsync(GetPrimaryEmailUpdateStatusRequest request, CancellationToken cancellationToken = default(CancellationToken));
