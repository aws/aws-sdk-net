...
{
    /// <summary>
    /// Container for the parameters to the GetAlternateContact operation. Retrieves the specified
    /// alternate contact attached to an Amazon Web Services account. <para> For complete
