...
{
    /// <summary>
    /// Container for the parameters to the PutAccountName operation. Updates the account
    /// name of the specified account. To use this API, IAM principals must have the <c>account:PutAccountName</c>
    /// IAM permission.
    /// </summary>
