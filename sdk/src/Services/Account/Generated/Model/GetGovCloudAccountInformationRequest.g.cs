...
{
    /// <summary>
    /// Container for the parameters to the GetGovCloudAccountInformation operation. Retrieves
    /// information about the GovCloud account linked to the specified standard account (if
    /// it exists) including the GovCloud account ID and state. To use this API, an IAM user
    /// or role must have the <c>account:GetGovCloudAccountInformation</c> IAM permission.
    /// </summary>
    public partial class GetGovCloudAccountInformationRequest : AmazonAccountRequest
    {
        ...
        /// <summary>
        /// Checks to see if the StandardAccountId property is set.
        /// </summary>
        internal bool IsSetStandardAccountId() => this.StandardAccountId != null;
    }
}
