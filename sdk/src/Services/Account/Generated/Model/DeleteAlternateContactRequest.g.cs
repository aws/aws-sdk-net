...
{
    /// <summary>
    /// Container for the parameters to the DeleteAlternateContact operation. Deletes the
    /// specified alternate contact from an Amazon Web Services account. <para> For complete
    /// details about how to use the alternate contact operations, see <a href="https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-contact-alternate.html">Update
    /// the alternate contacts for your Amazon Web Services account</a>. </para> <note> <para>
    ...
    /// trusted access for Amazon Web Services Account Management</a>. </para> </note>
    /// </summary>
