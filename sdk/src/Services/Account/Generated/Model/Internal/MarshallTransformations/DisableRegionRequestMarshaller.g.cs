...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisableRegionRequestMarshaller : IMarshaller<IRequest, DisableRegionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisableRegionRequestMarshaller _instance = new();

        internal static DisableRegionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisableRegionRequestMarshaller Instance => _instance;
    }
}
