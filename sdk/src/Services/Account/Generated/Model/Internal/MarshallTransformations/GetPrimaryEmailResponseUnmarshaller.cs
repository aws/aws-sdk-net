...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPrimaryEmailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPrimaryEmailResponse response = new GetPrimaryEmailResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PrimaryEmail", targetDepth, ref reader))
                {
                    ...
                    response.PrimaryEmail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPrimaryEmailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
