...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetRegionOptStatusRequestMarshaller : IMarshaller<IRequest, GetRegionOptStatusRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetRegionOptStatusRequestMarshaller _instance = new();

        internal static GetRegionOptStatusRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRegionOptStatusRequestMarshaller Instance => _instance;
    }
}
