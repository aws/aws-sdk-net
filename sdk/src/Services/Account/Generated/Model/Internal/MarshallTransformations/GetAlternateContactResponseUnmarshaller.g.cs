...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAlternateContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAlternateContactResponse();
            ...
            {
                if (context.TestExpression("AlternateContact", targetDepth, ref reader))
                {
                    var unmarshaller = AlternateContactUnmarshaller.Instance;
                    unmarshalledObject.AlternateContact = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetAlternateContactResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAlternateContactResponseUnmarshaller Instance => _instance;
    }
}
