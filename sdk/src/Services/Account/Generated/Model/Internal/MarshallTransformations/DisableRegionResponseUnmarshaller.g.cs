...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisableRegionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DisableRegionResponse();
        ...
        internal static DisableRegionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisableRegionResponseUnmarshaller Instance => _instance;
    }
}
