...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EnableRegionRequestMarshaller : IMarshaller<IRequest, EnableRegionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly EnableRegionRequestMarshaller _instance = new();

        internal static EnableRegionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static EnableRegionRequestMarshaller Instance => _instance;
    }
}
