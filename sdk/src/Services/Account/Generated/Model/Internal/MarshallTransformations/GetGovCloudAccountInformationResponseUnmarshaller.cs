...
{
    /// <summary>
    /// Response Unmarshaller for GetGovCloudAccountInformation operation
    /// </summary>  
    public class GetGovCloudAccountInformationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGovCloudAccountInformationResponse response = new GetGovCloudAccountInformationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AccountState", targetDepth))
                {
                    ...
                    response.AccountState = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("GovCloudAccountId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GovCloudAccountId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetGovCloudAccountInformationResponseUnmarshaller _instance = new GetGovCloudAccountInformationResponseUnmarshaller();        

        internal static GetGovCloudAccountInformationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGovCloudAccountInformationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
