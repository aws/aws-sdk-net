...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutContactInformationRequestMarshaller : IMarshaller<IRequest, PutContactInformationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutContactInformationRequestMarshaller _instance = new();

        internal static PutContactInformationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutContactInformationRequestMarshaller Instance => _instance;
    }
}
