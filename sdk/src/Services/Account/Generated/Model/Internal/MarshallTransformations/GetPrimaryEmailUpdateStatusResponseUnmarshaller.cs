...
{
    /// <summary>
    /// Response Unmarshaller for GetPrimaryEmailUpdateStatus operation
    /// </summary>  
    public class GetPrimaryEmailUpdateStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPrimaryEmailUpdateStatusResponse response = new GetPrimaryEmailUpdateStatusResponse();
        ...
        private static GetPrimaryEmailUpdateStatusResponseUnmarshaller _instance = new GetPrimaryEmailUpdateStatusResponseUnmarshaller();        

        internal static GetPrimaryEmailUpdateStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPrimaryEmailUpdateStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
