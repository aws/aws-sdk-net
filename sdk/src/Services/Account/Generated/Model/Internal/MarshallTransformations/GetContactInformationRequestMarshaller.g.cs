...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetContactInformationRequestMarshaller : IMarshaller<IRequest, GetContactInformationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetContactInformationRequestMarshaller _instance = new();

        internal static GetContactInformationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetContactInformationRequestMarshaller Instance => _instance;
    }
}
