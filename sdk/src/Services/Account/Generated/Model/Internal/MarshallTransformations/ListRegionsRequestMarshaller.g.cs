...
namespace Amazon.Account.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRegionsRequestMarshaller : IMarshaller<IRequest, ListRegionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListRegionsRequestMarshaller _instance = new();

        internal static ListRegionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRegionsRequestMarshaller Instance => _instance;
    }
}
