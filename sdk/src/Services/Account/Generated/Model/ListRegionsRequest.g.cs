...
{
    /// <summary>
    /// Container for the parameters to the ListRegions operation. Lists all the Regions for
    /// a given account and their respective opt-in statuses. Optionally, this list can be
    /// filtered by the <c>region-opt-status-contains</c> parameter.
    /// </summary>
    public partial class ListRegionsRequest : AmazonAccountRequest
    {
        ...
        /// </summary>
        public List<string> RegionOptStatusContains { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the RegionOptStatusContains property is set.
        /// </summary>
        internal bool IsSetRegionOptStatusContains() => this.RegionOptStatusContains != null && (this.RegionOptStatusContains.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
