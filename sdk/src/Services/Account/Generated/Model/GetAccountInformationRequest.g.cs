...
{
    /// <summary>
    /// Container for the parameters to the GetAccountInformation operation. Retrieves information
    /// about the specified account including its account name, account ID, account creation
    /// date and time, and account state. To use this API, an IAM user or role must have the
    /// <c>account:GetAccountInformation</c> IAM permission.
    /// </summary>
