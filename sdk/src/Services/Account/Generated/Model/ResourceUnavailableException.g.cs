...
namespace Amazon.Account.Model
{
    ...
    [Serializable]
#endif
    public partial class ResourceUnavailableException : AmazonAccountException
    {
        /// <summary>
        /// Default constructor for ResourceUnavailableException
        /// message.
        /// </summary>
        public ResourceUnavailableException() : base() { }
        ...
        /// Construct instance of ResourceUnavailableException
        /// </summary>
        public ResourceUnavailableException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ResourceUnavailableException
        /// </summary>
        public ResourceUnavailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ResourceUnavailableException
        /// </summary>
        public ResourceUnavailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
