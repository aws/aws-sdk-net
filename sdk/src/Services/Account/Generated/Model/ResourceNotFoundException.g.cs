...
namespace Amazon.Account.Model
{
    ...
    public partial class ResourceNotFoundException : AmazonAccountException
    {
        ...
        /// </para>
        /// </summary>
        public string RequestErrorType { get; set; }

        /// <summary>
        /// Checks to see if the RequestErrorType property is set.
        /// </summary>
        internal bool IsSetRequestErrorType() => this.RequestErrorType != null;
