...
{
    /// <summary>
    /// Container for the parameters to the AcceptPrimaryEmailUpdate operation. Accepts the
    /// request that originated from <a>StartPrimaryEmailUpdate</a> to update the primary
    /// email address (also known as the root user email address) for the specified account.
    /// </summary>
    public partial class AcceptPrimaryEmailUpdateRequest : AmazonAccountRequest
    {
        /// <summary>
        ...
        /// <para>
        /// The OTP code sent to the <c>PrimaryEmail</c> specified on the <c>StartPrimaryEmailUpdate</c>
        /// API call.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Checks to see if the Otp property is set.
        /// </summary>
        internal bool IsSetOtp() => this.Otp != null;

        /// <summary>
        /// Gets and sets the property PrimaryEmail. 
        /// <para>
        /// The new primary email address for use with the specified account. This must match
        /// the <c>PrimaryEmail</c> from the <c>StartPrimaryEmailUpdate</c> API call.
        /// </para>
        /// </summary>
