...
{
    /// <summary>
    /// Container for the parameters to the DisableRegion operation. Disables (opts-out) a
    /// particular Region for an account. <note> <para> The act of disabling a Region will
    /// remove all IAM access to any resources that reside in that Region. </para> </note>
    /// </summary>
