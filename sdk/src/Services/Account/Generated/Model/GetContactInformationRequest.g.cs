...
{
    /// <summary>
    /// Container for the parameters to the GetContactInformation operation. Retrieves the
    /// primary contact information of an Amazon Web Services account. <para> For complete
    /// details about how to use the primary contact operations, see <a href="https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-contact-primary.html">Update
