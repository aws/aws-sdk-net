...
{
    /// <summary>
    /// Container for the parameters to the GetPrimaryEmailUpdateStatus operation. Retrieves
    /// the status of the most recent primary email update for the specified account. For
    /// complete details about how to update the primary email address, see <a href="https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-root-user-email.html">Update
    /// the primary email address for your AWS account</a>.
    /// </summary>
    public partial class GetPrimaryEmailUpdateStatusRequest : AmazonAccountRequest
    {
        /// <summary>
