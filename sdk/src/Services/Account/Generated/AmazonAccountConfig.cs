...
namespace Amazon.Account
{
    ...
    public partial class AmazonAccountConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Account", "4.0.101.7");
        ...
        /// </summary>
        public static new string ServiceId => "Account";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "account";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-02-01";
