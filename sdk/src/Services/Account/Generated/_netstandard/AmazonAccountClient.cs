...
namespace Amazon.Account
{
    ...
    public partial class AmazonAccountClient : AmazonServiceClient, IAmazonAccount
    {
        ...
        internal virtual GetGovCloudAccountInformationResponse GetGovCloudAccountInformation(GetGovCloudAccountInformationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetPrimaryEmailUpdateStatusResponse GetPrimaryEmailUpdateStatus(GetPrimaryEmailUpdateStatusRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
