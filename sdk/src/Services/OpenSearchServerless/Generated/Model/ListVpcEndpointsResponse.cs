...
namespace Amazon.OpenSearchServerless.Model
{
    ...
    public partial class ListVpcEndpointsResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property VpcEndpointSummaries. 
        /// <para>
        /// Details about each VPC endpoint, including the name and current status.
        /// </para>
        /// </summary>
        public List<VpcEndpointSummary> VpcEndpointSummaries
        {
            get { return this._vpcEndpointSummaries; }
            set { this._vpcEndpointSummaries = value; }
        }
