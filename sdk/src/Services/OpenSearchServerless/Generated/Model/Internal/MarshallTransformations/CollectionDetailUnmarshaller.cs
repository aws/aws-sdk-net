...
namespace Amazon.OpenSearchServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CollectionDetailUnmarshaller : IUnmarshaller<CollectionDetail, XmlUnmarshallerContext>, IUnmarshaller<CollectionDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CollectionDetail IUnmarshaller<CollectionDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CollectionDetail Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
