...
namespace Amazon.OpenSearchServerless.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateLifecyclePolicyRequestMarshaller : IMarshaller<IRequest, UpdateLifecyclePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateLifecyclePolicyRequest publicRequest)
        {
            ...
            string target = "OpenSearchServerless.UpdateLifecyclePolicy";
            ...
            if(publicRequest.IsSetPolicyVersion())
            {
                context.Writer.WritePropertyName("policyVersion");
                context.Writer.WriteStringValue(publicRequest.PolicyVersion);
            }
