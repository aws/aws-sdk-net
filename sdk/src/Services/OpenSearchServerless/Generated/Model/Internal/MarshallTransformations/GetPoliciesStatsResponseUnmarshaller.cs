...
{
    /// <summary>
    /// Response Unmarshaller for GetPoliciesStats operation
    /// </summary>  
    public class GetPoliciesStatsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPoliciesStatsResponse response = new GetPoliciesStatsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SecurityConfigStats", targetDepth))
                {
                    ...
                    response.SecurityConfigStats = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SecurityPolicyStats", targetDepth))
                {
                    var unmarshaller = SecurityPolicyStatsUnmarshaller.Instance;
                    response.SecurityPolicyStats = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetPoliciesStatsResponseUnmarshaller _instance = new GetPoliciesStatsResponseUnmarshaller();        

        internal static GetPoliciesStatsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPoliciesStatsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
