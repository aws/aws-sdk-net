...
namespace Amazon.OpenSearchServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecurityPolicyStatsUnmarshaller : IJsonUnmarshaller<SecurityPolicyStats, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SecurityPolicyStats Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
