...
namespace Amazon.OpenSearchServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCollectionGroupDetailUnmarshaller : IUnmarshaller<CreateCollectionGroupDetail, XmlUnmarshallerContext>, IUnmarshaller<CreateCollectionGroupDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CreateCollectionGroupDetail IUnmarshaller<CreateCollectionGroupDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CreateCollectionGroupDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StandbyReplicas = unmarshaller.Unmarshall(context);
                    continue;
                }
