...
namespace Amazon.BedrockAgentRuntime.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "AgenticRetrieveStreamResponseOutputCollection is not descriptive")]
    ...
    public sealed class AgenticRetrieveStreamResponseOutput : EnumerableEventOutputStream<IEventStreamEvent, BedrockAgentRuntimeEventStreamException>
    {
        /// <summary>
            ...
            {"ResponseEvent", payload => 
                {
                    ...
                    return new AgenticRetrieveResponseEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
            {"Result", payload => 
                {
                    var context = EventStreamUtils.ConvertMessageToJsonContext(payload);
                    var reader = new StreamingUtf8JsonReader(context.Stream, AWSConfigs.StreamingUtf8JsonReaderBufferSize ?? 4096, context.JsonMaxDepth);
                    return new AgenticRetrieveResultEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
            {"TraceEvent", payload => 
                {
                    var context = EventStreamUtils.ConvertMessageToJsonContext(payload);
                    var reader = new StreamingUtf8JsonReader(context.Stream, AWSConfigs.StreamingUtf8JsonReaderBufferSize ?? 4096, context.JsonMaxDepth);
                    return new AgenticRetrieveTraceEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
        };
        /// <summary>
        ...
        ///<summary>
        ///Raised when an ResponseEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<AgenticRetrieveResponseEvent>> ResponseEventReceived;
        ///<summary>
        ///Raised when an Result event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<AgenticRetrieveResultEvent>> ResultReceived;
        ///<summary>
        ///Raised when an TraceEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<AgenticRetrieveTraceEvent>> TraceEventReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public AgenticRetrieveStreamResponseOutput(Stream stream) : this (stream, null)
        {
        }
        ...
        public AgenticRetrieveStreamResponseOutput(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
            ...
            Decoder.MessageReceived += (sender, args) =>
            {
                ...
                var _ =
                    ...
                    RaiseEvent(ResponseEventReceived,ev) ||
                    RaiseEvent(ResultReceived,ev) ||
                    RaiseEvent(TraceEventReceived,ev);
            };       
        }
