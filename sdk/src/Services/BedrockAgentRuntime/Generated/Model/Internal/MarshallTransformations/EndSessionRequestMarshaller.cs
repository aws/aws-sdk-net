...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class EndSessionRequestMarshaller : IMarshaller<IRequest, EndSessionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static EndSessionRequestMarshaller _instance = new EndSessionRequestMarshaller();        

        internal static EndSessionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EndSessionRequestMarshaller Instance
        {
            get
            {
                return _instance;
