    ...
    public class RetrieveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<KnowledgeBaseRetrievalResult, KnowledgeBaseRetrievalResultUnmarshaller>(KnowledgeBaseRetrievalResultUnmarshaller.Instance);
                    response.RetrievalResults = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
