...
{
    /// <summary>
    /// CheckIngestedDocumentAcl Request Marshaller
    /// </summary>       
    public class CheckIngestedDocumentAclRequestMarshaller : IMarshaller<IRequest, CheckIngestedDocumentAclRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CheckIngestedDocumentAclRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CheckIngestedDocumentAclRequest publicRequest)
        {
            ...
            request.ResourcePath = "/knowledgebases/{knowledgeBaseId}/datasources/{dataSourceId}/check-ingested-document-acl";
#if !NETFRAMEWORK
        ...
        private static CheckIngestedDocumentAclRequestMarshaller _instance = new CheckIngestedDocumentAclRequestMarshaller();        

        internal static CheckIngestedDocumentAclRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckIngestedDocumentAclRequestMarshaller Instance
        {
            get
            {
                return _instance;
