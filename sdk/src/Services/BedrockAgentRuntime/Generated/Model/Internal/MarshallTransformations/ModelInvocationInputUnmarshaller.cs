...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelInvocationInputUnmarshaller : IJsonUnmarshaller<ModelInvocationInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ModelInvocationInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("parserMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ParserMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("promptCreationMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
