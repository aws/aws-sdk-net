...
{
    /// <summary>
    /// Response Unmarshaller for GetIngestedDocumentAcl operation
    /// </summary>  
    public class GetIngestedDocumentAclResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIngestedDocumentAclResponse response = new GetIngestedDocumentAclResponse();
        ...
        private static GetIngestedDocumentAclResponseUnmarshaller _instance = new GetIngestedDocumentAclResponseUnmarshaller();        

        internal static GetIngestedDocumentAclResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIngestedDocumentAclResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
