...
{
    /// <summary>
    /// GetIngestedDocumentAcl Request Marshaller
    /// </summary>       
    public class GetIngestedDocumentAclRequestMarshaller : IMarshaller<IRequest, GetIngestedDocumentAclRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIngestedDocumentAclRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIngestedDocumentAclRequest publicRequest)
        {
            ...
            request.ResourcePath = "/knowledgebases/{knowledgeBaseId}/datasources/{dataSourceId}/get-ingested-document-acl";
#if !NETFRAMEWORK
        ...
        private static GetIngestedDocumentAclRequestMarshaller _instance = new GetIngestedDocumentAclRequestMarshaller();        

        internal static GetIngestedDocumentAclRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIngestedDocumentAclRequestMarshaller Instance
        {
            get
            {
                return _instance;
