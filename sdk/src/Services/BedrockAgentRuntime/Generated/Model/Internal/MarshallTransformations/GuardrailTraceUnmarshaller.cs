...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GuardrailTraceUnmarshaller : IJsonUnmarshaller<GuardrailTrace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailTrace Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("inputAssessments", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.InputAssessments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
