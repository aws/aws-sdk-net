...
{
    /// <summary>
    /// Response Unmarshaller for StopFlowExecution operation
    /// </summary>  
    public class StopFlowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopFlowExecutionResponse response = new StopFlowExecutionResponse();
        ...
        private static StopFlowExecutionResponseUnmarshaller _instance = new StopFlowExecutionResponseUnmarshaller();        

        internal static StopFlowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopFlowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
