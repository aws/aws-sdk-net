...
{
    /// <summary>
    /// GetAgentMemory Request Marshaller
    /// </summary>       
    public class GetAgentMemoryRequestMarshaller : IMarshaller<IRequest, GetAgentMemoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAgentMemoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAgentMemoryRequest publicRequest)
        {
        ...
        private static GetAgentMemoryRequestMarshaller _instance = new GetAgentMemoryRequestMarshaller();        

        internal static GetAgentMemoryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentMemoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
