...
{
    /// <summary>
    /// Response Unmarshaller for AgenticRetrieveStream operation
    /// </summary>  
    public class AgenticRetrieveStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AgenticRetrieveStreamResponse response = new AgenticRetrieveStreamResponse();
            response.Stream = new AgenticRetrieveStreamResponseOutput(context.Stream);
        ...
        private static AgenticRetrieveStreamResponseUnmarshaller _instance = new AgenticRetrieveStreamResponseUnmarshaller();        

        internal static AgenticRetrieveStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AgenticRetrieveStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
