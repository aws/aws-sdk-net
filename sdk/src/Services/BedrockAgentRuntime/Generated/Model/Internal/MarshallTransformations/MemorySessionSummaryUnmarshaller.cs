...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MemorySessionSummaryUnmarshaller : IUnmarshaller<MemorySessionSummary, XmlUnmarshallerContext>, IUnmarshaller<MemorySessionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MemorySessionSummary IUnmarshaller<MemorySessionSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MemorySessionSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SummaryText = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
