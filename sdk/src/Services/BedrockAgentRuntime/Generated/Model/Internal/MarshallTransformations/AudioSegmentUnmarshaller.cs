...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AudioSegmentUnmarshaller : IJsonUnmarshaller<AudioSegment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AudioSegment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("transcription", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Transcription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
