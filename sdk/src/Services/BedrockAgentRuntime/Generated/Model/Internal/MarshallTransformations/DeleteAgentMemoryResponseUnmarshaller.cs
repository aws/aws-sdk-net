...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAgentMemory operation
    /// </summary>  
    public class DeleteAgentMemoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAgentMemoryResponse response = new DeleteAgentMemoryResponse();
        ...
        private static DeleteAgentMemoryResponseUnmarshaller _instance = new DeleteAgentMemoryResponseUnmarshaller();        

        internal static DeleteAgentMemoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentMemoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
