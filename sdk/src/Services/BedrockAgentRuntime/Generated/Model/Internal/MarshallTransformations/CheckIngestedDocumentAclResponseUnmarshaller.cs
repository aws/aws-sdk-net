...
{
    /// <summary>
    /// Response Unmarshaller for CheckIngestedDocumentAcl operation
    /// </summary>  
    public class CheckIngestedDocumentAclResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckIngestedDocumentAclResponse response = new CheckIngestedDocumentAclResponse();
        ...
        private static CheckIngestedDocumentAclResponseUnmarshaller _instance = new CheckIngestedDocumentAclResponseUnmarshaller();        

        internal static CheckIngestedDocumentAclResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckIngestedDocumentAclResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
