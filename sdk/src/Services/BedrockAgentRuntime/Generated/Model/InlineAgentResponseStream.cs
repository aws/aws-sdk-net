...
namespace Amazon.BedrockAgentRuntime.Model
{
    ...
    public sealed class InlineAgentResponseStream : EnumerableEventStream<IEventStreamEvent, BedrockAgentRuntimeEventStreamException>
    {
        ...
        new Dictionary<string,Func<IEventStreamMessage,IEventStreamEvent>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"Chunk", payload => new InlineAgentPayloadPartUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
            {"Files", payload => new InlineAgentFilePartUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
            {"ReturnControl", payload => new InlineAgentReturnControlPayloadUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
            {"Trace", payload => new InlineAgentTracePartUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
        };
        /// <summary>
