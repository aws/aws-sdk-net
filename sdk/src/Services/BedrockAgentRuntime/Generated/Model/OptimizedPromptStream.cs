...
namespace Amazon.BedrockAgentRuntime.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "OptimizedPromptStreamCollection is not descriptive")]
    ...
    public sealed class OptimizedPromptStream : EnumerableEventStream<IEventStreamEvent, BedrockAgentRuntimeEventStreamException>
    {
        /// <summary>
        ...
        new Dictionary<string,Func<IEventStreamMessage,IEventStreamEvent>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"AnalyzePromptEvent", payload => new AnalyzePromptEventUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
            {"OptimizedPromptEvent", payload => new OptimizedPromptEventUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
        };
        /// <summary>
        ...
        ///<summary>
        ///Raised when an AnalyzePromptEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<AnalyzePromptEvent>> AnalyzePromptEventReceived;
        ///<summary>
        ///Raised when an OptimizedPromptEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<OptimizedPromptEvent>> OptimizedPromptEventReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public OptimizedPromptStream(Stream stream) : this (stream, null)
        {
        }
        ...
        public OptimizedPromptStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
            ...
            Decoder.MessageReceived += (sender, args) =>
            {
                ...
                var _ =
                    ...
                    RaiseEvent(AnalyzePromptEventReceived,ev) ||
                    RaiseEvent(OptimizedPromptEventReceived,ev);
            };       
        }
