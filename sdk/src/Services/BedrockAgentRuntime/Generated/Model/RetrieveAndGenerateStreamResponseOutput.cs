...
namespace Amazon.BedrockAgentRuntime.Model
{
    ...
    public sealed class RetrieveAndGenerateStreamResponseOutput : EnumerableEventStream<IEventStreamEvent, BedrockAgentRuntimeEventStreamException>
    {
        /// <summary>
        ...
        new Dictionary<string,Func<IEventStreamMessage,IEventStreamEvent>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"Citation", payload => new CitationEventUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
            {"Guardrail", payload => new GuardrailEventUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
            {"Output", payload => new RetrieveAndGenerateOutputEventUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
        };
        /// <summary>
