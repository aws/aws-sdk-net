...
namespace Amazon.BedrockAgentRuntime.Model
{
    ...
    [Serializable]
    #endif
    public partial class BadGatewayException : AmazonBedrockAgentRuntimeException
    {
        ...
        public BadGatewayException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public BadGatewayException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
