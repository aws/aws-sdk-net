...
namespace Amazon.BedrockAgentRuntime
{
    ...
    public partial class AmazonBedrockAgentRuntimeClient : AmazonServiceClient, IAmazonBedrockAgentRuntime
    {
        ...
        internal virtual CheckIngestedDocumentAclResponse CheckIngestedDocumentAcl(CheckIngestedDocumentAclRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetIngestedDocumentAclResponse GetIngestedDocumentAcl(GetIngestedDocumentAclRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
