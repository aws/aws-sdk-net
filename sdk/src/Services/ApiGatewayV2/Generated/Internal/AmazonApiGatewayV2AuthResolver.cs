...
namespace Amazon.ApiGatewayV2.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonApiGatewayV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonApiGatewayV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ApiGatewayV2.
        /// </summary>
        public AmazonApiGatewayV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonApiGatewayV2AuthSchemeParameters
            {
    ...
    public class AmazonApiGatewayV2AuthSchemeResolver : IAuthSchemeResolver<AmazonApiGatewayV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonApiGatewayV2AuthSchemeParameters authParameters)
        {
