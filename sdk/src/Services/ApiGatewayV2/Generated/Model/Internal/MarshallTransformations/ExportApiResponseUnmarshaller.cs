...
{
    /// <summary>
    /// Response Unmarshaller for ExportApi operation
    /// </summary>  
    public class ExportApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportApiResponse response = new ExportApiResponse();
        ...
        private static ExportApiResponseUnmarshaller _instance = new ExportApiResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
