...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRouteSettings operation
    /// </summary>  
    public class DeleteRouteSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRouteSettingsResponse response = new DeleteRouteSettingsResponse();
        ...
        private static DeleteRouteSettingsResponseUnmarshaller _instance = new DeleteRouteSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRouteSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
