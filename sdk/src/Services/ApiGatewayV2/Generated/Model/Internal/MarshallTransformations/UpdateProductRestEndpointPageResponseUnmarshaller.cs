...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProductRestEndpointPage operation
    /// </summary>  
    public class UpdateProductRestEndpointPageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProductRestEndpointPageResponse response = new UpdateProductRestEndpointPageResponse();
        ...
        private static UpdateProductRestEndpointPageResponseUnmarshaller _instance = new UpdateProductRestEndpointPageResponseUnmarshaller();        

        internal static UpdateProductRestEndpointPageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProductRestEndpointPageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
