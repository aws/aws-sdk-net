        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("conditions", targetDepth))
                {
                    ...
                    response.Conditions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("routingRuleArn", targetDepth))
                {
                    ...
                    response.RoutingRuleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("routingRuleId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RoutingRuleId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
