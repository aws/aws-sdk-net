...
{
    /// <summary>
    /// Response Unmarshaller for GetIntegrations operation
    /// </summary>  
    public class GetIntegrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIntegrationsResponse response = new GetIntegrationsResponse();
        ...
        private static GetIntegrationsResponseUnmarshaller _instance = new GetIntegrationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIntegrationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
