...
namespace Amazon.ApiGatewayV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RoutingRuleActionInvokeApiUnmarshaller : IUnmarshaller<RoutingRuleActionInvokeApi, XmlUnmarshallerContext>, IUnmarshaller<RoutingRuleActionInvokeApi, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RoutingRuleActionInvokeApi IUnmarshaller<RoutingRuleActionInvokeApi, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RoutingRuleActionInvokeApi Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("stripBasePath", targetDepth))
                {
                    ...
                    unmarshalledObject.StripBasePath = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
