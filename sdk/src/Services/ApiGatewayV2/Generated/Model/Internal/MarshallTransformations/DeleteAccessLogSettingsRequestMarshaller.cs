...
{
    /// <summary>
    /// DeleteAccessLogSettings Request Marshaller
    /// </summary>       
    public class DeleteAccessLogSettingsRequestMarshaller : IMarshaller<IRequest, DeleteAccessLogSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAccessLogSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAccessLogSettingsRequest publicRequest)
        {
        ...
        private static DeleteAccessLogSettingsRequestMarshaller _instance = new DeleteAccessLogSettingsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessLogSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
