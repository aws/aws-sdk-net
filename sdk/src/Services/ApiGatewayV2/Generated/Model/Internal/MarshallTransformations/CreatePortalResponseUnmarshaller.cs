        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("includedPortalProductArns", targetDepth))
                {
                    ...
                    response.IncludedPortalProductArns = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.LastPublished = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastPublishedDescription", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastPublishedDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("portalContent", targetDepth))
                {
                    ...
                    response.PortalContent = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PublishStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("rumAppMonitorName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RumAppMonitorName = unmarshaller.Unmarshall(context);
                    continue;
                }
