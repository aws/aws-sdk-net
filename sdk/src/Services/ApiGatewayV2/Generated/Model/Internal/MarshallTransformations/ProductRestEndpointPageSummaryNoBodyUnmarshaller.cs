...
namespace Amazon.ApiGatewayV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProductRestEndpointPageSummaryNoBodyUnmarshaller : IUnmarshaller<ProductRestEndpointPageSummaryNoBody, XmlUnmarshallerContext>, IUnmarshaller<ProductRestEndpointPageSummaryNoBody, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProductRestEndpointPageSummaryNoBody IUnmarshaller<ProductRestEndpointPageSummaryNoBody, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProductRestEndpointPageSummaryNoBody Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProductRestEndpointPageArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("productRestEndpointPageId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProductRestEndpointPageId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("restEndpointIdentifier", targetDepth))
                {
                    var unmarshaller = RestEndpointIdentifierUnmarshaller.Instance;
                    unmarshalledObject.RestEndpointIdentifier = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TryItState = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
