...
namespace Amazon.ApiGatewayV2.Model.Internal.MarshallTransformations
{
    ...
    public class RoutingRuleConditionUnmarshaller : IUnmarshaller<RoutingRuleCondition, XmlUnmarshallerContext>, IUnmarshaller<RoutingRuleCondition, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        RoutingRuleCondition IUnmarshaller<RoutingRuleCondition, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RoutingRuleCondition Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("matchBasePaths", targetDepth))
                {
                    ...
                    unmarshalledObject.MatchBasePaths = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("matchHeaders", targetDepth))
                {
                    var unmarshaller = RoutingRuleMatchHeadersUnmarshaller.Instance;
                    unmarshalledObject.MatchHeaders = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
