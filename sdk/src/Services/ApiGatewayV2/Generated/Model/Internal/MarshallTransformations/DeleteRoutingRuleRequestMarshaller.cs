...
{
    /// <summary>
    /// DeleteRoutingRule Request Marshaller
    /// </summary>       
    public class DeleteRoutingRuleRequestMarshaller : IMarshaller<IRequest, DeleteRoutingRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRoutingRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRoutingRuleRequest publicRequest)
        {
        ...
        private static DeleteRoutingRuleRequestMarshaller _instance = new DeleteRoutingRuleRequestMarshaller();        

        internal static DeleteRoutingRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoutingRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
