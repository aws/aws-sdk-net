...
{
    /// <summary>
    /// This is the response object from the GetProductRestEndpointPage operation.
    /// </summary>
    public partial class GetProductRestEndpointPageResponse : AmazonWebServiceResponse
    {
        private EndpointDisplayContentResponse _displayContent;
        private DateTime? _lastModified;
        private string _productRestEndpointPageArn;
        private string _productRestEndpointPageId;
        private string _rawDisplayContent;
        ...
        /// </para>
        /// </summary>
        public EndpointDisplayContentResponse DisplayContent
        {
        ...
        /// <summary>
        /// Gets and sets the property RawDisplayContent. 
        /// <para>
        ...
        {
            get { return this._rawDisplayContent; }
            set { this._rawDisplayContent = value; }
        }

        // Check to see if RawDisplayContent property is set
        internal bool IsSetRawDisplayContent()
        {
            return this._rawDisplayContent != null;
        }
