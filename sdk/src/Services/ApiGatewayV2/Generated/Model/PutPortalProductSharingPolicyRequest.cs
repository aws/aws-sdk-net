...
{
    /// <summary>
    /// Container for the parameters to the PutPortalProductSharingPolicy operation.
    /// Updates the sharing policy for a portal product.
    /// </summary>
    public partial class PutPortalProductSharingPolicyRequest : AmazonApiGatewayV2Request
    {
        ...
        /// </para>
        /// </summary>
        [AWSProperty(Required=true, Min=1, Max=307200)]
