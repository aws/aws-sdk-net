...
namespace Amazon.PartnerCentralAccount
{
    ...
    public partial class AmazonPartnerCentralAccountClient : AmazonServiceClient, IAmazonPartnerCentralAccount
    {
        ...
        public AmazonPartnerCentralAccountClient()
            : base(new AmazonPartnerCentralAccountConfig()) { }
        ...
        public AmazonPartnerCentralAccountClient(RegionEndpoint region)
            : base(new AmazonPartnerCentralAccountConfig{RegionEndpoint = region}) { }
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonPartnerCentralAccountAuthSchemeHandler());
        }
        ...
        internal virtual GetQualificationsAssociationDetailsResponse GetQualificationsAssociationDetails(GetQualificationsAssociationDetailsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetQualificationsAssociationTaskResponse GetQualificationsAssociationTask(GetQualificationsAssociationTaskRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetQualificationsDisassociationTaskResponse GetQualificationsDisassociationTask(GetQualificationsDisassociationTaskRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetVerificationResponse GetVerification(GetVerificationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual StartQualificationsAssociationTaskResponse StartQualificationsAssociationTask(StartQualificationsAssociationTaskRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual StartQualificationsDisassociationTaskResponse StartQualificationsDisassociationTask(StartQualificationsDisassociationTaskRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual StartVerificationResponse StartVerification(StartVerificationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
