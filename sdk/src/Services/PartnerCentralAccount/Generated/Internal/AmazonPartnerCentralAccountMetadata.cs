...
{
    /// <summary>
    /// Service metadata for  Amazon PartnerCentralAccount service
    /// </summary>
    public partial class AmazonPartnerCentralAccountMetadata : IServiceMetadata
    {
        /// <summary>
        ...
        public string ServiceFullName
        {
            get
            {
                return "Partner Central Account API";
            }
        }
