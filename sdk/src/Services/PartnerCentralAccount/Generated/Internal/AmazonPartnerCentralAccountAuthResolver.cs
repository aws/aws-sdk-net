...
namespace Amazon.PartnerCentralAccount.Internal
{
    ...
    public class AmazonPartnerCentralAccountAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPartnerCentralAccountAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PartnerCentralAccount.
        /// </summary>
        public AmazonPartnerCentralAccountAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPartnerCentralAccountAuthSchemeParameters
            {
    ...
    public class AmazonPartnerCentralAccountAuthSchemeResolver : IAuthSchemeResolver<AmazonPartnerCentralAccountAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPartnerCentralAccountAuthSchemeParameters authParameters)
        {
