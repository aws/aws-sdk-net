...
using Amazon.Util;
using Amazon.PartnerCentralAccount.Endpoints;

#pragma warning disable 1591

namespace Amazon.PartnerCentralAccount.Internal
{
    /// <summary>
    /// Amazon PartnerCentralAccount endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for PartnerCentralAccount service requests.
    /// Collects values for PartnerCentralAccountEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PartnerCentralAccountEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPartnerCentralAccountEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPartnerCentralAccountConfig)requestContext.ClientConfig;
            var result = new PartnerCentralAccountEndpointParameters();
