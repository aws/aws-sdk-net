...
namespace Amazon.PartnerCentralAccount
{
    ...
    public partial class AmazonPartnerCentralAccountClient : AmazonServiceClient, IAmazonPartnerCentralAccount
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-account-2025-04-04/GetVerification">REST API Reference for GetVerification Operation</seealso>
        public virtual IAsyncResult BeginGetVerification(GetVerificationRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetVerificationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetVerificationResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-account-2025-04-04/GetVerification">REST API Reference for GetVerification Operation</seealso>
        public virtual GetVerificationResponse EndGetVerification(IAsyncResult asyncResult)
        {
            return EndInvoke<GetVerificationResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-account-2025-04-04/StartVerification">REST API Reference for StartVerification Operation</seealso>
        public virtual IAsyncResult BeginStartVerification(StartVerificationRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = StartVerificationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = StartVerificationResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-account-2025-04-04/StartVerification">REST API Reference for StartVerification Operation</seealso>
        public virtual StartVerificationResponse EndStartVerification(IAsyncResult asyncResult)
        {
            return EndInvoke<StartVerificationResponse>(asyncResult);
        }
