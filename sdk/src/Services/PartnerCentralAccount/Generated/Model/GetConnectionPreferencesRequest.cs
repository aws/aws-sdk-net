...
{
    /// <summary>
    /// Container for the parameters to the GetConnectionPreferences operation.
    /// Retrieves the connection preferences for a partner account, including access settings
    /// and exclusions.
    /// </summary>
    public partial class GetConnectionPreferencesRequest : AmazonPartnerCentralAccountRequest
    {
