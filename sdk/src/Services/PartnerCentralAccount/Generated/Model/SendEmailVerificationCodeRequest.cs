...
{
    /// <summary>
    /// Container for the parameters to the SendEmailVerificationCode operation.
    /// Sends an email verification code to the specified email address for account verification
    /// purposes.
    /// </summary>
    public partial class SendEmailVerificationCodeRequest : AmazonPartnerCentralAccountRequest
    {
