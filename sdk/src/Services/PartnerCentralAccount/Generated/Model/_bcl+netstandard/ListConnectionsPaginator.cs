...
namespace Amazon.PartnerCentralAccount.Model
{
    ...
    internal sealed partial class ListConnectionsPaginator : IPaginator<ListConnectionsResponse>, IListConnectionsPaginator
    {
        ...
        /// <summary>
        /// Enumerable containing all of the ConnectionSummaries
        /// </summary>
        public IPaginatedEnumerable<ConnectionSummary> ConnectionSummaries => 
            new PaginatedResultKeyResponse<ListConnectionsResponse, ConnectionSummary>(this, (i) => i.ConnectionSummaries ?? new List<ConnectionSummary>());

        internal ListConnectionsPaginator(IAmazonPartnerCentralAccount client, ListConnectionsRequest request)
        {
            this._client = client;
