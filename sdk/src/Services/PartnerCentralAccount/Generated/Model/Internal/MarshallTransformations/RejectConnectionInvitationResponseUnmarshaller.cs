...
{
    /// <summary>
    /// Response Unmarshaller for RejectConnectionInvitation operation
    /// </summary>  
    public class RejectConnectionInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectConnectionInvitationResponse response = new RejectConnectionInvitationResponse();
        ...
        private static RejectConnectionInvitationResponseUnmarshaller _instance = new RejectConnectionInvitationResponseUnmarshaller();        

        internal static RejectConnectionInvitationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectConnectionInvitationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
