...
{
    /// <summary>
    /// Response Unmarshaller for StartQualificationsAssociationTask operation
    /// </summary>  
    public class StartQualificationsAssociationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartQualificationsAssociationTaskResponse response = new StartQualificationsAssociationTaskResponse();
        ...
        private static StartQualificationsAssociationTaskResponseUnmarshaller _instance = new StartQualificationsAssociationTaskResponseUnmarshaller();        

        internal static StartQualificationsAssociationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQualificationsAssociationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
