...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionTypeDetailUnmarshaller : IUnmarshaller<ConnectionTypeDetail, XmlUnmarshallerContext>, IUnmarshaller<ConnectionTypeDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ConnectionTypeDetail IUnmarshaller<ConnectionTypeDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ConnectionTypeDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CanceledAt", targetDepth))
                {
                    ...
                    unmarshalledObject.CanceledAt = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CanceledBy", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CanceledBy = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InviterEmail = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("InviterName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InviterName = unmarshaller.Unmarshall(context);
                    continue;
                }
