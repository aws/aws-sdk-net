...
{
    /// <summary>
    /// Response Unmarshaller for GetVerification operation
    /// </summary>  
    public class GetVerificationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("VerificationResponseDetails", targetDepth))
                {
                    ...
                    response.VerificationResponseDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VerificationStatusReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("VerificationType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VerificationType = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetVerificationResponseUnmarshaller _instance = new GetVerificationResponseUnmarshaller();        

        internal static GetVerificationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVerificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
