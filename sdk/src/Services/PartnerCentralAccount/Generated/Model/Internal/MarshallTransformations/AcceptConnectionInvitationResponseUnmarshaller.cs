...
{
    /// <summary>
    /// Response Unmarshaller for AcceptConnectionInvitation operation
    /// </summary>  
    public class AcceptConnectionInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptConnectionInvitationResponse response = new AcceptConnectionInvitationResponse();
        ...
        private static AcceptConnectionInvitationResponseUnmarshaller _instance = new AcceptConnectionInvitationResponseUnmarshaller();        

        internal static AcceptConnectionInvitationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptConnectionInvitationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
