...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionInvitationSummaryUnmarshaller : IJsonUnmarshaller<ConnectionInvitationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionInvitationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OtherParticipantIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
