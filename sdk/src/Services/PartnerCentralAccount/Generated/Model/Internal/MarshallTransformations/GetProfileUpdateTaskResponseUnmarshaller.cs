...
{
    /// <summary>
    /// Response Unmarshaller for GetProfileUpdateTask operation
    /// </summary>  
    public class GetProfileUpdateTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProfileUpdateTaskResponse response = new GetProfileUpdateTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ErrorDetailList", targetDepth))
                {
                    ...
                    response.ErrorDetailList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = TaskDetailsUnmarshaller.Instance;
                    response.TaskDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetProfileUpdateTaskResponseUnmarshaller _instance = new GetProfileUpdateTaskResponseUnmarshaller();        

        internal static GetProfileUpdateTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProfileUpdateTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
