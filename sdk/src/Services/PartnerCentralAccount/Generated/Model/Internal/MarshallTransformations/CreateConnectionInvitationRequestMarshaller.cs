...
{
    /// <summary>
    /// CreateConnectionInvitation Request Marshaller
    /// </summary>       
    public class CreateConnectionInvitationRequestMarshaller : IMarshaller<IRequest, CreateConnectionInvitationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateConnectionInvitationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateConnectionInvitationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralAccount");
            string target = "PartnerCentralAccount.CreateConnectionInvitation";
            ...
            if(publicRequest.IsSetReceiverIdentifier())
            {
                context.Writer.WritePropertyName("ReceiverIdentifier");
                context.Writer.WriteStringValue(publicRequest.ReceiverIdentifier);
            }
        ...
        private static CreateConnectionInvitationRequestMarshaller _instance = new CreateConnectionInvitationRequestMarshaller();        

        internal static CreateConnectionInvitationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConnectionInvitationRequestMarshaller Instance
        {
            get
            {
                return _instance;
