...
{
    /// <summary>
    /// Response Unmarshaller for GetAllianceLeadContact operation
    /// </summary>  
    public class GetAllianceLeadContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAllianceLeadContactResponse response = new GetAllianceLeadContactResponse();
        ...
        private static GetAllianceLeadContactResponseUnmarshaller _instance = new GetAllianceLeadContactResponseUnmarshaller();        

        internal static GetAllianceLeadContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAllianceLeadContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
