...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BusinessVerificationDetailsUnmarshaller : IUnmarshaller<BusinessVerificationDetails, XmlUnmarshallerContext>, IUnmarshaller<BusinessVerificationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BusinessVerificationDetails IUnmarshaller<BusinessVerificationDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public BusinessVerificationDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.JurisdictionOfIncorporation = unmarshaller.Unmarshall(context);
                    continue;
                }
