...
{
    /// <summary>
    /// Response Unmarshaller for GetConnectionPreferences operation
    /// </summary>  
    public class GetConnectionPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConnectionPreferencesResponse response = new GetConnectionPreferencesResponse();
        ...
        private static GetConnectionPreferencesResponseUnmarshaller _instance = new GetConnectionPreferencesResponseUnmarshaller();        

        internal static GetConnectionPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectionPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
