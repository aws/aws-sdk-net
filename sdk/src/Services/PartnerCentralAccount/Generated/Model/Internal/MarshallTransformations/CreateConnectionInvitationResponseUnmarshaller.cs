...
{
    /// <summary>
    /// Response Unmarshaller for CreateConnectionInvitation operation
    /// </summary>  
    public class CreateConnectionInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConnectionInvitationResponse response = new CreateConnectionInvitationResponse();
        ...
        private static CreateConnectionInvitationResponseUnmarshaller _instance = new CreateConnectionInvitationResponseUnmarshaller();        

        internal static CreateConnectionInvitationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConnectionInvitationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
