...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PartnerDomainUnmarshaller : IJsonUnmarshaller<PartnerDomain, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PartnerDomain Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
