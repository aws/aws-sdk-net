    ...
    public class VerificationDetailsMarshaller : IRequestMarshaller<VerificationDetails, JsonMarshallerContext> 
    {
        ...
        public void Marshall(VerificationDetails requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetBusinessVerificationDetails())
            {
                context.Writer.WritePropertyName("BusinessVerificationDetails");
                context.Writer.WriteStartObject();

                var marshaller = BusinessVerificationDetailsMarshaller.Instance;
                marshaller.Marshall(requestObject.BusinessVerificationDetails, context);

                context.Writer.WriteEndObject();
            }

            if(requestObject.IsSetRegistrantVerificationDetails())
            {
                context.Writer.WritePropertyName("RegistrantVerificationDetails");
                context.Writer.WriteStartObject();

                var marshaller = RegistrantVerificationDetailsMarshaller.Instance;
                marshaller.Marshall(requestObject.RegistrantVerificationDetails, context);
