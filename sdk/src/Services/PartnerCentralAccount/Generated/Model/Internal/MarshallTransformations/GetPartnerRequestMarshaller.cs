...
{
    /// <summary>
    /// GetPartner Request Marshaller
    /// </summary>       
    public class GetPartnerRequestMarshaller : IMarshaller<IRequest, GetPartnerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPartnerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPartnerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralAccount");
            string target = "PartnerCentralAccount.GetPartner";
        ...
        private static GetPartnerRequestMarshaller _instance = new GetPartnerRequestMarshaller();        

        internal static GetPartnerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartnerRequestMarshaller Instance
        {
            get
            {
                return _instance;
