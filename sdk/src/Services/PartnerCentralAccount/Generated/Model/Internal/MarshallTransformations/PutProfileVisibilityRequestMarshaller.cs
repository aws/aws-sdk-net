...
{
    /// <summary>
    /// PutProfileVisibility Request Marshaller
    /// </summary>       
    public class PutProfileVisibilityRequestMarshaller : IMarshaller<IRequest, PutProfileVisibilityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutProfileVisibilityRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutProfileVisibilityRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralAccount");
            string target = "PartnerCentralAccount.PutProfileVisibility";
        ...
        private static PutProfileVisibilityRequestMarshaller _instance = new PutProfileVisibilityRequestMarshaller();        

        internal static PutProfileVisibilityRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutProfileVisibilityRequestMarshaller Instance
        {
            get
            {
                return _instance;
