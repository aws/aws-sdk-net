...
{
    /// <summary>
    /// Response Unmarshaller for PutProfileVisibility operation
    /// </summary>  
    public class PutProfileVisibilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutProfileVisibilityResponse response = new PutProfileVisibilityResponse();
        ...
        private static PutProfileVisibilityResponseUnmarshaller _instance = new PutProfileVisibilityResponseUnmarshaller();        

        internal static PutProfileVisibilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutProfileVisibilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
