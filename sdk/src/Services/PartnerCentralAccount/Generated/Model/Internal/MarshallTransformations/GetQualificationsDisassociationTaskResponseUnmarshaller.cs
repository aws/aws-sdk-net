...
{
    /// <summary>
    /// Response Unmarshaller for GetQualificationsDisassociationTask operation
    /// </summary>  
    public class GetQualificationsDisassociationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQualificationsDisassociationTaskResponse response = new GetQualificationsDisassociationTaskResponse();
        ...
        private static GetQualificationsDisassociationTaskResponseUnmarshaller _instance = new GetQualificationsDisassociationTaskResponseUnmarshaller();        

        internal static GetQualificationsDisassociationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQualificationsDisassociationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
