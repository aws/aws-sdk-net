...
{
    /// <summary>
    /// Response Unmarshaller for CancelProfileUpdateTask operation
    /// </summary>  
    public class CancelProfileUpdateTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelProfileUpdateTaskResponse response = new CancelProfileUpdateTaskResponse();
        ...
        private static CancelProfileUpdateTaskResponseUnmarshaller _instance = new CancelProfileUpdateTaskResponseUnmarshaller();        

        internal static CancelProfileUpdateTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelProfileUpdateTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
