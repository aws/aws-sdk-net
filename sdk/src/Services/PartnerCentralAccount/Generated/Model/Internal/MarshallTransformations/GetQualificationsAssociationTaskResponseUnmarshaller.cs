...
{
    /// <summary>
    /// Response Unmarshaller for GetQualificationsAssociationTask operation
    /// </summary>  
    public class GetQualificationsAssociationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQualificationsAssociationTaskResponse response = new GetQualificationsAssociationTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PrimaryPartner", targetDepth, ref reader))
                {
                    var unmarshaller = QualificationsAssociationPartnerUnmarshaller.Instance;
                    response.PrimaryPartner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetQualificationsAssociationTaskResponseUnmarshaller _instance = new GetQualificationsAssociationTaskResponseUnmarshaller();        

        internal static GetQualificationsAssociationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQualificationsAssociationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
