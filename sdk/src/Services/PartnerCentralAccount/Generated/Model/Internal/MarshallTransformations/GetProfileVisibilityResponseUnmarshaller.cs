...
{
    /// <summary>
    /// Response Unmarshaller for GetProfileVisibility operation
    /// </summary>  
    public class GetProfileVisibilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProfileVisibilityResponse response = new GetProfileVisibilityResponse();
        ...
        private static GetProfileVisibilityResponseUnmarshaller _instance = new GetProfileVisibilityResponseUnmarshaller();        

        internal static GetProfileVisibilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProfileVisibilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
