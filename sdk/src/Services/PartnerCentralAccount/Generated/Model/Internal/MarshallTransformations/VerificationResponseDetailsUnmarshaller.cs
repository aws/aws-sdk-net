...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerificationResponseDetailsUnmarshaller : IJsonUnmarshaller<VerificationResponseDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VerificationResponseDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
