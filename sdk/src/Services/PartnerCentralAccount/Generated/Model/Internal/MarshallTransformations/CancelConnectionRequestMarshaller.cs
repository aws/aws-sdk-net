...
{
    /// <summary>
    /// CancelConnection Request Marshaller
    /// </summary>       
    public class CancelConnectionRequestMarshaller : IMarshaller<IRequest, CancelConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelConnectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelConnectionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralAccount");
            string target = "PartnerCentralAccount.CancelConnection";
        ...
        private static CancelConnectionRequestMarshaller _instance = new CancelConnectionRequestMarshaller();        

        internal static CancelConnectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelConnectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
