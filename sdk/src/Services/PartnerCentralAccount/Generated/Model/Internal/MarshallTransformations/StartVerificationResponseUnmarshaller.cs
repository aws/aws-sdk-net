...
{
    /// <summary>
    /// Response Unmarshaller for StartVerification operation
    /// </summary>  
    public class StartVerificationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartVerificationResponse response = new StartVerificationResponse();
        ...
        private static StartVerificationResponseUnmarshaller _instance = new StartVerificationResponseUnmarshaller();        

        internal static StartVerificationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartVerificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
