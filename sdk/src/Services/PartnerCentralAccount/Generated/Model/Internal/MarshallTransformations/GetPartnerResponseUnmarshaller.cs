...
{
    /// <summary>
    /// Response Unmarshaller for GetPartner operation
    /// </summary>  
    public class GetPartnerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPartnerResponse response = new GetPartnerResponse();
        ...
        private static GetPartnerResponseUnmarshaller _instance = new GetPartnerResponseUnmarshaller();        

        internal static GetPartnerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartnerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
