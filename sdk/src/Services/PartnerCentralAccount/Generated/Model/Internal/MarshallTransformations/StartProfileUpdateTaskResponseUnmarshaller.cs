...
{
    /// <summary>
    /// Response Unmarshaller for StartProfileUpdateTask operation
    /// </summary>  
    public class StartProfileUpdateTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartProfileUpdateTaskResponse response = new StartProfileUpdateTaskResponse();
        ...
        private static StartProfileUpdateTaskResponseUnmarshaller _instance = new StartProfileUpdateTaskResponseUnmarshaller();        

        internal static StartProfileUpdateTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartProfileUpdateTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
