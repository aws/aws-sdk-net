    ...
    public class GetConnectionInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InviterEmail = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("InviterName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InviterName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("OtherParticipantIdentifier", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OtherParticipantIdentifier = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ParticipantType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ParticipantType = unmarshaller.Unmarshall(context);
                    continue;
                }
