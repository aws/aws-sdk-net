...
{
    /// <summary>
    /// PutAllianceLeadContact Request Marshaller
    /// </summary>       
    public class PutAllianceLeadContactRequestMarshaller : IMarshaller<IRequest, PutAllianceLeadContactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutAllianceLeadContactRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutAllianceLeadContactRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralAccount");
            string target = "PartnerCentralAccount.PutAllianceLeadContact";
        ...
        private static PutAllianceLeadContactRequestMarshaller _instance = new PutAllianceLeadContactRequestMarshaller();        

        internal static PutAllianceLeadContactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAllianceLeadContactRequestMarshaller Instance
        {
            get
            {
                return _instance;
