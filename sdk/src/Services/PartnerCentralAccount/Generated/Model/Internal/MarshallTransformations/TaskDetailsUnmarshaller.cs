...
{
    /// <summary>
    /// Response Unmarshaller for TaskDetails Object
    /// </summary>  
    public class TaskDetailsUnmarshaller : IUnmarshaller<TaskDetails, XmlUnmarshallerContext>, IUnmarshaller<TaskDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TaskDetails IUnmarshaller<TaskDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TaskDetails Unmarshall(JsonUnmarshallerContext context)
        {
            TaskDetails unmarshalledObject = new TaskDetails();
        ...
        private static TaskDetailsUnmarshaller _instance = new TaskDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TaskDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
