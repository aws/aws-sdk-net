...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaskDetailsUnmarshaller : IJsonUnmarshaller<TaskDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaskDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
