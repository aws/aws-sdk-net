...
{
    /// <summary>
    /// Response Unmarshaller for StartQualificationsDisassociationTask operation
    /// </summary>  
    public class StartQualificationsDisassociationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartQualificationsDisassociationTaskResponse response = new StartQualificationsDisassociationTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AssociatedPartner", targetDepth, ref reader))
                {
                    var unmarshaller = QualificationsAssociationPartnerUnmarshaller.Instance;
                    response.AssociatedPartner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartQualificationsDisassociationTaskResponseUnmarshaller _instance = new StartQualificationsDisassociationTaskResponseUnmarshaller();        

        internal static StartQualificationsDisassociationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQualificationsDisassociationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
