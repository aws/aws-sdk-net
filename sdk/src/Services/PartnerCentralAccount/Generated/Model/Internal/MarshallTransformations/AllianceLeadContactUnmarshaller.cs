...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AllianceLeadContactUnmarshaller : IJsonUnmarshaller<AllianceLeadContact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AllianceLeadContact Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
