...
{
    /// <summary>
    /// Response Unmarshaller for AllianceLeadContact Object
    /// </summary>  
    public class AllianceLeadContactUnmarshaller : IUnmarshaller<AllianceLeadContact, XmlUnmarshallerContext>, IUnmarshaller<AllianceLeadContact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AllianceLeadContact IUnmarshaller<AllianceLeadContact, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AllianceLeadContact Unmarshall(JsonUnmarshallerContext context)
        {
            AllianceLeadContact unmarshalledObject = new AllianceLeadContact();
        ...
        private static AllianceLeadContactUnmarshaller _instance = new AllianceLeadContactUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AllianceLeadContactUnmarshaller Instance
        {
            get
            {
                return _instance;
