    ...
    public class ConnectionSummaryUnmarshaller : IUnmarshaller<ConnectionSummary, XmlUnmarshallerContext>, IUnmarshaller<ConnectionSummary, JsonUnmarshallerContext>
    {
        ...
        public ConnectionSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ConnectionTypeSummary, StringUnmarshaller, ConnectionTypeSummaryUnmarshaller>(StringUnmarshaller.Instance, ConnectionTypeSummaryUnmarshaller.Instance);
                    unmarshalledObject.ConnectionTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OtherParticipantAccountId = unmarshaller.Unmarshall(context);
                    continue;
                }
