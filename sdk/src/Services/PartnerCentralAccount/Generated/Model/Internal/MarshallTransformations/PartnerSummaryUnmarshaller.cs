...
namespace Amazon.PartnerCentralAccount.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PartnerSummaryUnmarshaller : IJsonUnmarshaller<PartnerSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PartnerSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
