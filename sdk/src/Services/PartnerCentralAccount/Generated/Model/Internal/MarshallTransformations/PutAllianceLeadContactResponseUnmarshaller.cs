...
{
    /// <summary>
    /// Response Unmarshaller for PutAllianceLeadContact operation
    /// </summary>  
    public class PutAllianceLeadContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAllianceLeadContactResponse response = new PutAllianceLeadContactResponse();
        ...
        private static PutAllianceLeadContactResponseUnmarshaller _instance = new PutAllianceLeadContactResponseUnmarshaller();        

        internal static PutAllianceLeadContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAllianceLeadContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
