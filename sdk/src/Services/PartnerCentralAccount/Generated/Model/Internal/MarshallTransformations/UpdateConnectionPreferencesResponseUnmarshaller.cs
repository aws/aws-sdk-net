...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConnectionPreferences operation
    /// </summary>  
    public class UpdateConnectionPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConnectionPreferencesResponse response = new UpdateConnectionPreferencesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AccessType", targetDepth))
                {
                    ...
                    response.AccessType = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ExcludedParticipantIds", targetDepth))
                {
                    ...
                    response.ExcludedParticipantIds = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static UpdateConnectionPreferencesResponseUnmarshaller _instance = new UpdateConnectionPreferencesResponseUnmarshaller();        

        internal static UpdateConnectionPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConnectionPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
