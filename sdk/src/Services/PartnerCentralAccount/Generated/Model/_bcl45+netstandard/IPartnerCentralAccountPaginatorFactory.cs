...
namespace Amazon.PartnerCentralAccount.Model
{
    ...
    public interface IPartnerCentralAccountPaginatorFactory
    {
        ...
        IListConnectionInvitationsPaginator ListConnectionInvitations(ListConnectionInvitationsRequest request);
        ...
        IListPartnersPaginator ListPartners(ListPartnersRequest request);
    }
}