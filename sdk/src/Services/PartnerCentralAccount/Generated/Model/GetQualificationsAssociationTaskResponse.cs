...
{
    /// <summary>
    /// This is the response object from the GetQualificationsAssociationTask operation.
    /// </summary>
    public partial class GetQualificationsAssociationTaskResponse : AmazonWebServiceResponse
    {
        private string _arn;
        ...
        /// <para>
        /// The timestamp when the qualifications association task ended, in ISO 8601 format.
        ...
        /// <para>
        /// The primary partner's profile and account identifiers that the task is associating
        /// qualifications with.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// The current status of the qualifications association task. Valid values: <c>IN_PROGRESS</c>,
        /// <c>SUCCEEDED</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// The unique identifier of the qualifications association task, in the format <c>pqatask-[a-z2-7]{13}</c>.
        /// </para>
        /// </summary>
