...
namespace Amazon.PartnerCentralAccount.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationException : AmazonPartnerCentralAccountException
    {
        private List<ValidationError> _errorDetails = AWSConfigs.InitializeCollections ? new List<ValidationError>() : null;
        ...
        protected ValidationException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.ErrorDetails = (List<ValidationError>)info.GetValue("ErrorDetails", typeof(List<ValidationError>));
        ...
        /// </para>
        /// </summary>
        public List<ValidationError> ErrorDetails
        {
