...
namespace Amazon.PartnerCentralAccount.Model
{
    ...
    public partial class ConnectionSummary
    {
        ...
        private Dictionary<string, ConnectionTypeSummary> _connectionTypes = AWSConfigs.InitializeCollections ? new Dictionary<string, ConnectionTypeSummary>() : null;
        private string _id;
        ...
        public Dictionary<string, ConnectionTypeSummary> ConnectionTypes
        {
