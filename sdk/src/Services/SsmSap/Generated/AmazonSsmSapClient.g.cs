...
namespace Amazon.SsmSap
{
    ...
    public partial class AmazonSsmSapClient : AmazonServiceClient, IAmazonSsmSap
    {
        ...
        /// 
        /// </summary>
        public AmazonSsmSapClient() : base(new AmazonSsmSapConfig()) { }
        ...
        public AmazonSsmSapClient(RegionEndpoint region) : base(new AmazonSsmSapConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSsmSapClient(AmazonSsmSapConfig config) : base(config) { }
