...
namespace Amazon.SsmSap.Model
{
    ...
    public partial class ListSubCheckResultsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SubCheckResult> SubCheckResults { get; set; } = AWSConfigs.InitializeCollections ? new List<SubCheckResult>() : null;

        /// <summary>
        /// Checks to see if the SubCheckResults property is set.
        /// </summary>
        internal bool IsSetSubCheckResults() => this.SubCheckResults != null && (this.SubCheckResults.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
