...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OperationUnmarshaller : IJsonUnmarshaller<Operation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Operation();
        ...
        /// Gets the singleton.
        /// </summary>
        public static OperationUnmarshaller Instance => _instance;
    }
}
