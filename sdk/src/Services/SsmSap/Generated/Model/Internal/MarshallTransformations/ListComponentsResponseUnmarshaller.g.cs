...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListComponentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListComponentsResponse();
        ...
        internal static ListComponentsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListComponentsResponseUnmarshaller Instance => _instance;
    }
}
