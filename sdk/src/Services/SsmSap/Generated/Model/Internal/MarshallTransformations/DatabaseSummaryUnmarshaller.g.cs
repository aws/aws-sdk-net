...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DatabaseSummaryUnmarshaller : IJsonUnmarshaller<DatabaseSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DatabaseSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DatabaseSummaryUnmarshaller Instance => _instance;
    }
}
