...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDatabaseRequestMarshaller : IMarshaller<IRequest, GetDatabaseRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDatabaseRequestMarshaller _instance = new();

        internal static GetDatabaseRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDatabaseRequestMarshaller Instance => _instance;
    }
}
