...
{
    /// <summary>
    /// Response Unmarshaller for RuleStatusCounts Object
    /// </summary>
    public partial class RuleStatusCountsUnmarshaller : IJsonUnmarshaller<RuleStatusCounts, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RuleStatusCounts Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RuleStatusCounts();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Passed", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        private static RuleStatusCountsUnmarshaller _instance = new RuleStatusCountsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RuleStatusCountsUnmarshaller Instance => _instance;
    }
}
