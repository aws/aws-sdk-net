...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociatedHostUnmarshaller : IJsonUnmarshaller<AssociatedHost, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AssociatedHost();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssociatedHostUnmarshaller Instance => _instance;
    }
}
