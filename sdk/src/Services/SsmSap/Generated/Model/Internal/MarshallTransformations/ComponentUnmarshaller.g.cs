...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ComponentUnmarshaller : IJsonUnmarshaller<Component, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Component();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ComponentUnmarshaller Instance => _instance;
    }
}
