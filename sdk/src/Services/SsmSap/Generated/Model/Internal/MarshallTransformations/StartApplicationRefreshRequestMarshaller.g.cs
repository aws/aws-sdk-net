...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartApplicationRefreshRequestMarshaller : IMarshaller<IRequest, StartApplicationRefreshRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartApplicationRefreshRequestMarshaller _instance = new();

        internal static StartApplicationRefreshRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartApplicationRefreshRequestMarshaller Instance => _instance;
    }
}
