...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisterApplicationRequestMarshaller : IMarshaller<IRequest, RegisterApplicationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RegisterApplicationRequestMarshaller _instance = new();

        internal static RegisterApplicationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterApplicationRequestMarshaller Instance => _instance;
    }
}
