...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListComponentsRequestMarshaller : IMarshaller<IRequest, ListComponentsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListComponentsRequestMarshaller _instance = new();

        internal static ListComponentsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListComponentsRequestMarshaller Instance => _instance;
    }
}
