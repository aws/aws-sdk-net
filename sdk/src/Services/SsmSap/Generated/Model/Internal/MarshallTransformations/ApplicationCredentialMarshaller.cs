...
{
    /// <summary>
    /// ApplicationCredential Marshaller
    /// </summary>
    public class ApplicationCredentialMarshaller : IRequestMarshaller<ApplicationCredential, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(ApplicationCredential requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCredentialType())
            {
                ...
                context.Writer.WriteStringValue(requestObject.CredentialType);
            }
        ...
        /// </summary>
        public readonly static ApplicationCredentialMarshaller Instance = new ApplicationCredentialMarshaller();
