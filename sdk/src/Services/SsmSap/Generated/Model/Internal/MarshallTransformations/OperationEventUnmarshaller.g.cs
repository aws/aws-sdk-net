...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OperationEventUnmarshaller : IJsonUnmarshaller<OperationEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public OperationEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new OperationEvent();
        ...
        /// Gets the singleton.
        /// </summary>
        public static OperationEventUnmarshaller Instance => _instance;
    }
}
