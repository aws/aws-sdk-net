...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IpAddressMemberUnmarshaller : IJsonUnmarshaller<IpAddressMember, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IpAddressMember();
            ...
            {
                if (context.TestExpression("AllocationType", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static IpAddressMemberUnmarshaller Instance => _instance;
    }
}
