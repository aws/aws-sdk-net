...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetOperationResponse();
        ...
        internal static GetOperationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOperationResponseUnmarshaller Instance => _instance;
    }
}
