...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateApplicationSettingsRequestMarshaller : IMarshaller<IRequest, UpdateApplicationSettingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateApplicationSettingsRequestMarshaller _instance = new();

        internal static UpdateApplicationSettingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateApplicationSettingsRequestMarshaller Instance => _instance;
    }
}
