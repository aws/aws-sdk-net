...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListOperationsRequestMarshaller : IMarshaller<IRequest, ListOperationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListOperationsRequestMarshaller _instance = new();

        internal static ListOperationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListOperationsRequestMarshaller Instance => _instance;
    }
}
