...
namespace Amazon.SsmSap.Model
{
    ...
    public partial class GetConfigurationCheckOperationResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public ConfigurationCheckOperation ConfigurationCheckOperation { get; set; }

        /// <summary>
        /// Checks to see if the ConfigurationCheckOperation property is set.
        /// </summary>
        internal bool IsSetConfigurationCheckOperation() => this.ConfigurationCheckOperation != null;
    }
}
