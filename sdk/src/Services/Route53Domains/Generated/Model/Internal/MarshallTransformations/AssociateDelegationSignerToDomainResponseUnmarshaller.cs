...
{
    /// <summary>
    /// Response Unmarshaller for AssociateDelegationSignerToDomain operation
    /// </summary>  
    public class AssociateDelegationSignerToDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateDelegationSignerToDomainResponse response = new AssociateDelegationSignerToDomainResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DnssecLimitExceeded"))
                {
                    return DnssecLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return OperationLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("TLDRulesViolation"))
                {
                    return TLDRulesViolationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static AssociateDelegationSignerToDomainResponseUnmarshaller _instance = new AssociateDelegationSignerToDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDelegationSignerToDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
