...
{
    /// <summary>
    /// Response Unmarshaller for TransferDomainToAnotherAwsAccount operation
    /// </summary>  
    public class TransferDomainToAnotherAwsAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TransferDomainToAnotherAwsAccountResponse response = new TransferDomainToAnotherAwsAccountResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Password = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static TransferDomainToAnotherAwsAccountResponseUnmarshaller _instance = new TransferDomainToAnotherAwsAccountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransferDomainToAnotherAwsAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
