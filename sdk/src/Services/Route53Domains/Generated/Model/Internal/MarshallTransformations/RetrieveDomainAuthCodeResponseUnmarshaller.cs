...
{
    /// <summary>
    /// Response Unmarshaller for RetrieveDomainAuthCode operation
    /// </summary>  
    public class RetrieveDomainAuthCodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RetrieveDomainAuthCodeResponse response = new RetrieveDomainAuthCodeResponse();
            ...
            {
                if (context.TestExpression("AuthCode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AuthCode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RetrieveDomainAuthCodeResponseUnmarshaller _instance = new RetrieveDomainAuthCodeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetrieveDomainAuthCodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
