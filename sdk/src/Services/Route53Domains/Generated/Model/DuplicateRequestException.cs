...
namespace Amazon.Route53Domains.Model
{
    ...
    public partial class DuplicateRequestException : AmazonRoute53DomainsException
    {
        ...
        public DuplicateRequestException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicateRequestException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
