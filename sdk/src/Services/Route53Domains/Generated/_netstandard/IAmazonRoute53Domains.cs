...
namespace Amazon.Route53Domains
{
    ...
    public partial interface IAmazonRoute53Domains : IAmazonService, IDisposable
    {
        ...
        Task<AssociateDelegationSignerToDomainResponse> AssociateDelegationSignerToDomainAsync(AssociateDelegationSignerToDomainRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisassociateDelegationSignerFromDomainResponse> DisassociateDelegationSignerFromDomainAsync(DisassociateDelegationSignerFromDomainRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <summary>
        /// This operation sets the transfer lock on the domain (specifically the <c>clientTransferProhibited</c>
        ...
        Task<ListPricesResponse> ListPricesAsync(ListPricesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PushDomainResponse> PushDomainAsync(PushDomainRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ResendOperationAuthorizationResponse> ResendOperationAuthorizationAsync(ResendOperationAuthorizationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRoute53DomainsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRoute53DomainsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRoute53DomainsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRoute53DomainsConfig to create AmazonRoute53DomainsClient");
            }

            return awsCredentials == null ? 
                    new AmazonRoute53DomainsClient(serviceClientConfig) :
                    new AmazonRoute53DomainsClient(awsCredentials, serviceClientConfig);
        }
