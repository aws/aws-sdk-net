...
{
    /// <summary>
    /// Read-only configuration details for OAuth2 authorization code grant flow, including
    /// endpoints and client information.
    /// </summary>
    public partial class ReadAuthorizationCodeGrantDetails
    {
        ...
        /// <para>
        /// The authorization server endpoint used to obtain authorization codes from the resource
        /// owner.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The authorization server endpoint used to obtain access tokens via the authorization
        /// code grant flow.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true, Min=1, Max=8192)]
