...
namespace Amazon.QuickSight.Model
{
    ...
    public partial class GridLayoutScreenCanvasSizeOptions
    {
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <c>FIXED</c>: A fixed width will be used when optimizing the layout. In the QuickSight
        /// console, this option is called <c>Classic</c>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>RESPONSIVE</c>: The width of the canvas will be responsive and optimized to the
        /// view port. In the QuickSight console, this option is called <c>Tiled</c>.
        /// </para>
        ///  </li> </ul>
        /// </summary>
