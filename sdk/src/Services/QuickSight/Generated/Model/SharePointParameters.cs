...
{
    /// <summary>
    /// The connection parameters for a SharePoint data source. Provide these parameters in
    /// the <c>DataSourceParameters</c> object when you create or update a data source that
    /// uses SharePoint.
    /// </summary>
    public partial class SharePointParameters
    {
        ...
        /// <summary>
        /// Gets and sets the property SharePointDomain. 
        /// <para>
        ...
        {
            get { return this._sharePointDomain; }
            set { this._sharePointDomain = value; }
        }

        // Check to see if SharePointDomain property is set
        internal bool IsSetSharePointDomain()
        {
            return this._sharePointDomain != null;
        }
