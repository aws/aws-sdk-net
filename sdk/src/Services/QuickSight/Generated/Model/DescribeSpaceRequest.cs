...
namespace Amazon.QuickSight.Model
{
    ...
    /// </summary>
    public partial class DescribeSpaceRequest : AmazonQuickSightRequest
    {
        private string _awsAccountId;
        private int? _maxContributors;
        ...
        /// <summary>
        /// Gets and sets the property MaxContributors. 
        /// <para>
        ...
        {
            get { return this._maxContributors; }
            set { this._maxContributors = value; }
        }

        // Check to see if MaxContributors property is set
        internal bool IsSetMaxContributors()
        {
            return this._maxContributors.HasValue; 
        }
