...
namespace Amazon.QuickSight.Model
{
    ...
    public partial class PivotOperation
    {
        ...
        private PivotConfiguration _pivotConfiguration;
        private TransformOperationSource _source;
        private ValueColumnConfiguration _valueColumnConfiguration;
        ...
        public PivotConfiguration PivotConfiguration
        {
            get { return this._pivotConfiguration; }
            set { this._pivotConfiguration = value; }
        }

        // Check to see if PivotConfiguration property is set
        internal bool IsSetPivotConfiguration()
        {
            return this._pivotConfiguration != null;
        }
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public ValueColumnConfiguration ValueColumnConfiguration
        {
            get { return this._valueColumnConfiguration; }
            set { this._valueColumnConfiguration = value; }
        }

        // Check to see if ValueColumnConfiguration property is set
        internal bool IsSetValueColumnConfiguration()
        {
            return this._valueColumnConfiguration != null;
        }
