...
namespace Amazon.QuickSight.Model
{
    ...
    public partial class GetSessionEmbedUrlResponse : AmazonWebServiceResponse
    {
        ...
        /// Suite session. This URL is valid for 5 minutes. The API operation provides the URL
        /// with an <c>auth_code</c> value that enables one (and only one) sign-on to a user session
