...
{
    /// <summary>
    /// Container for the parameters to the DescribeDataSetPermissions operation.
    ...
    public partial class DescribeDataSetPermissionsRequest : AmazonQuickSightRequest
    {
        ...
        /// <para>
        /// The ID for the dataset that you want to create. This ID is unique per Region; for
