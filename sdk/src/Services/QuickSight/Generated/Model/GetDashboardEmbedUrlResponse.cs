...
{
    /// <summary>
    /// Output returned from the <c>GetDashboardEmbedUrl</c> operation.
    /// </summary>
    public partial class GetDashboardEmbedUrlResponse : AmazonWebServiceResponse
    {
        ...
        /// This URL is valid for 5 minutes. The API operation provides the URL with an <c>auth_code</c>
        /// value that enables one (and only one) sign-on to a user session that is valid for
        /// 10 hours. 
        /// </para>
        /// </summary>
