...
namespace Amazon.QuickSight.Model
{
    ...
    /// </summary>
    internal sealed partial class ListGroupMembershipsPaginator : IPaginator<ListGroupMembershipsResponse>, IListGroupMembershipsPaginator
    {
        private readonly IAmazonQuickSight _client;
        private readonly ListGroupMembershipsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListGroupMembershipsResponse> Responses => new PaginatedResponse<ListGroupMembershipsResponse>(this);
...
#if BCL
        IEnumerable<ListGroupMembershipsResponse> IPaginator<ListGroupMembershipsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListGroupMemberships(_request);
        ...
        async IAsyncEnumerable<ListGroupMembershipsResponse> IPaginator<ListGroupMembershipsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListGroupMembershipsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
