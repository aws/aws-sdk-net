...
{
    /// <summary>
    /// Base class for ListTemplates paginators.
    /// </summary>
    internal sealed partial class ListTemplatesPaginator : IPaginator<ListTemplatesResponse>, IListTemplatesPaginator
    {
        ...
        public IPaginatedEnumerable<TemplateSummary> TemplateSummaryList => 
            new PaginatedResultKeyResponse<ListTemplatesResponse, TemplateSummary>(this, (i) => i.TemplateSummaryList ?? new List<TemplateSummary>());
...
#if BCL
        IEnumerable<ListTemplatesResponse> IPaginator<ListTemplatesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListTemplates(_request);
