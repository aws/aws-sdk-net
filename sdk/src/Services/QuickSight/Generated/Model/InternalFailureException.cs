...
namespace Amazon.QuickSight.Model
{
    ...
    [Serializable]
    #endif
    public partial class InternalFailureException : AmazonQuickSightException
    {
        ...
        public InternalFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InternalFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
