...
namespace Amazon.QuickSight.Model
{
    ...
    internal sealed partial class ListFlowsPaginator : IPaginator<ListFlowsResponse>, IListFlowsPaginator
    {
        ...
        public IPaginatedEnumerable<FlowSummary> FlowSummaryList => 
            new PaginatedResultKeyResponse<ListFlowsResponse, FlowSummary>(this, (i) => i.FlowSummaryList ?? new List<FlowSummary>());

        internal ListFlowsPaginator(IAmazonQuickSight client, ListFlowsRequest request)
        {
            this._client = client;
