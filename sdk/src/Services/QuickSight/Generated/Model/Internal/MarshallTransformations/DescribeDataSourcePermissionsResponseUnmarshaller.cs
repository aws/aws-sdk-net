...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataSourcePermissions operation
    /// </summary>  
    public class DescribeDataSourcePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDataSourcePermissionsResponse response = new DescribeDataSourcePermissionsResponse();
        ...
        private static DescribeDataSourcePermissionsResponseUnmarshaller _instance = new DescribeDataSourcePermissionsResponseUnmarshaller();        

        internal static DescribeDataSourcePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataSourcePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
