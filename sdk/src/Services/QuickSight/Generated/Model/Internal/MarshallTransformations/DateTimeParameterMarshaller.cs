...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class DateTimeParameterMarshaller : IRequestMarshaller<DateTimeParameter, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DateTimeParameter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetValues())
            {
                ...
                {
                        context.Writer.WriteNumberValue(Amazon.Util.AWSSDKUtils.ConvertToUnixEpochSecondsDecimal(requestObjectValuesListValue));
                }
