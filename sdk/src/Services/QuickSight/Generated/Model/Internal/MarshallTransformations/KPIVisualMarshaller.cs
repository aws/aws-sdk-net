...
{
    /// <summary>
    /// KPIVisual Marshaller
    /// </summary>
    public class KPIVisualMarshaller : IRequestMarshaller<KPIVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(KPIVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = KPIConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetConditionalFormatting())
            {
                context.Writer.WritePropertyName("ConditionalFormatting");
                context.Writer.WriteObjectStart();

                var marshaller = KPIConditionalFormattingMarshaller.Instance;
                marshaller.Marshall(requestObject.ConditionalFormatting, context);
        ...
        /// </summary>
        public readonly static KPIVisualMarshaller Instance = new KPIVisualMarshaller();
