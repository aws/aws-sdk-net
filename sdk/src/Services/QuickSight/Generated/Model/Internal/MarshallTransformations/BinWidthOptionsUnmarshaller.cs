...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BinWidthOptionsUnmarshaller : IUnmarshaller<BinWidthOptions, XmlUnmarshallerContext>, IUnmarshaller<BinWidthOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BinWidthOptions IUnmarshaller<BinWidthOptions, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public BinWidthOptions Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BinCountLimit", targetDepth))
                {
                    ...
                    unmarshalledObject.BinCountLimit = unmarshaller.Unmarshall(context);
                    continue;
                }
