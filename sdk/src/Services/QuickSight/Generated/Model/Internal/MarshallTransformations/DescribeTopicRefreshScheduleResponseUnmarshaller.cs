...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTopicRefreshSchedule operation
    /// </summary>  
    public class DescribeTopicRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTopicRefreshScheduleResponse response = new DescribeTopicRefreshScheduleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = TopicRefreshScheduleUnmarshaller.Instance;
        ...
        private static DescribeTopicRefreshScheduleResponseUnmarshaller _instance = new DescribeTopicRefreshScheduleResponseUnmarshaller();        

        internal static DescribeTopicRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTopicRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
