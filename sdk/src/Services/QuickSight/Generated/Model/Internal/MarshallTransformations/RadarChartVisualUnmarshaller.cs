...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RadarChartVisualUnmarshaller : IUnmarshaller<RadarChartVisual, XmlUnmarshallerContext>, IUnmarshaller<RadarChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RadarChartVisual IUnmarshaller<RadarChartVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RadarChartVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
