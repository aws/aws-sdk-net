...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApprovalPolicy operation
    /// </summary>  
    public class UpdateApprovalPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateApprovalPolicyResponse response = new UpdateApprovalPolicyResponse();
        ...
        private static UpdateApprovalPolicyResponseUnmarshaller _instance = new UpdateApprovalPolicyResponseUnmarshaller();        

        internal static UpdateApprovalPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApprovalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
