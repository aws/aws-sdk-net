...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BarChartVisualUnmarshaller : IUnmarshaller<BarChartVisual, XmlUnmarshallerContext>, IUnmarshaller<BarChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BarChartVisual IUnmarshaller<BarChartVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public BarChartVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
