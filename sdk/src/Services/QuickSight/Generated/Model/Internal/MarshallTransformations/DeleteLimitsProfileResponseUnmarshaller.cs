...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLimitsProfile operation
    /// </summary>  
    public class DeleteLimitsProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLimitsProfileResponse response = new DeleteLimitsProfileResponse();
        ...
        private static DeleteLimitsProfileResponseUnmarshaller _instance = new DeleteLimitsProfileResponseUnmarshaller();        

        internal static DeleteLimitsProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLimitsProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
