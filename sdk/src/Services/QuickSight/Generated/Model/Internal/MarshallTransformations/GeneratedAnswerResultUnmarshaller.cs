...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeneratedAnswerResultUnmarshaller : IUnmarshaller<GeneratedAnswerResult, XmlUnmarshallerContext>, IUnmarshaller<GeneratedAnswerResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeneratedAnswerResult IUnmarshaller<GeneratedAnswerResult, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GeneratedAnswerResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QuestionText = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("QuestionUrl", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QuestionUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Restatement", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Restatement = unmarshaller.Unmarshall(context);
                    continue;
                }
