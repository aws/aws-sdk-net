...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBrand operation
    /// </summary>  
    public class UpdateBrandResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BrandDefinition", targetDepth))
                {
                    ...
                    response.BrandDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("BrandDetail", targetDepth))
                {
                    var unmarshaller = BrandDetailUnmarshaller.Instance;
                    response.BrandDetail = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static UpdateBrandResponseUnmarshaller _instance = new UpdateBrandResponseUnmarshaller();        

        internal static UpdateBrandResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBrandResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
