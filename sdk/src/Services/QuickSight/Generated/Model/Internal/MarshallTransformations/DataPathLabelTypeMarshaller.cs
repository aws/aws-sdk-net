...
{
    /// <summary>
    /// DataPathLabelType Marshaller
    /// </summary>
    public class DataPathLabelTypeMarshaller : IRequestMarshaller<DataPathLabelType, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(DataPathLabelType requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFieldValue())
            {
                ...
                context.Writer.WriteStringValue(requestObject.FieldValue);
            }
        ...
        /// </summary>
        public readonly static DataPathLabelTypeMarshaller Instance = new DataPathLabelTypeMarshaller();
