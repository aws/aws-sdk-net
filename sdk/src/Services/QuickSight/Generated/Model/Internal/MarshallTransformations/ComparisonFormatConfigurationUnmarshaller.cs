...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComparisonFormatConfigurationUnmarshaller : IUnmarshaller<ComparisonFormatConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ComparisonFormatConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ComparisonFormatConfiguration IUnmarshaller<ComparisonFormatConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ComparisonFormatConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("NumberDisplayFormatConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberDisplayFormatConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PercentageDisplayFormatConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.PercentageDisplayFormatConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
