...
{
    /// <summary>
    /// TableAggregatedFieldWells Marshaller
    /// </summary>
    public class TableAggregatedFieldWellsMarshaller : IRequestMarshaller<TableAggregatedFieldWells, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TableAggregatedFieldWells requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static TableAggregatedFieldWellsMarshaller Instance = new TableAggregatedFieldWellsMarshaller();
