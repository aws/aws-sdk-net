...
{
    /// <summary>
    /// UpdateTopicPermissionsV2 Request Marshaller
    /// </summary>       
    public class UpdateTopicPermissionsV2RequestMarshaller : IMarshaller<IRequest, UpdateTopicPermissionsV2Request> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTopicPermissionsV2Request)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTopicPermissionsV2Request publicRequest)
        {
        ...
        private static UpdateTopicPermissionsV2RequestMarshaller _instance = new UpdateTopicPermissionsV2RequestMarshaller();        

        internal static UpdateTopicPermissionsV2RequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTopicPermissionsV2RequestMarshaller Instance
        {
            get
            {
                return _instance;
