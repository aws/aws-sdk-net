...
{
    /// <summary>
    /// Response Unmarshaller for CreateTopicV2 operation
    /// </summary>  
    public class CreateTopicV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTopicV2Response response = new CreateTopicV2Response();
        ...
        private static CreateTopicV2ResponseUnmarshaller _instance = new CreateTopicV2ResponseUnmarshaller();        

        internal static CreateTopicV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTopicV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
