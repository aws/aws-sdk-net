...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DateTimeFormatConfigurationUnmarshaller : IUnmarshaller<DateTimeFormatConfiguration, XmlUnmarshallerContext>, IUnmarshaller<DateTimeFormatConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DateTimeFormatConfiguration IUnmarshaller<DateTimeFormatConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DateTimeFormatConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
