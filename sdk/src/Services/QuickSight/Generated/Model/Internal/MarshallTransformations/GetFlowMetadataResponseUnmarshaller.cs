...
{
    /// <summary>
    /// Response Unmarshaller for GetFlowMetadata operation
    /// </summary>  
    public class GetFlowMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFlowMetadataResponse response = new GetFlowMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PublishState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("RunCount", targetDepth))
                {
                    ...
                    response.RunCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetFlowMetadataResponseUnmarshaller _instance = new GetFlowMetadataResponseUnmarshaller();        

        internal static GetFlowMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFlowMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
