...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSelfUpgradeConfiguration operation
    /// </summary>  
    public class DescribeSelfUpgradeConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSelfUpgradeConfigurationResponse response = new DescribeSelfUpgradeConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SelfUpgradeConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = SelfUpgradeConfigurationUnmarshaller.Instance;
                    response.SelfUpgradeConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeSelfUpgradeConfigurationResponseUnmarshaller _instance = new DescribeSelfUpgradeConfigurationResponseUnmarshaller();        

        internal static DescribeSelfUpgradeConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSelfUpgradeConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
