...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PieChartVisualUnmarshaller : IUnmarshaller<PieChartVisual, XmlUnmarshallerContext>, IUnmarshaller<PieChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PieChartVisual IUnmarshaller<PieChartVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PieChartVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
