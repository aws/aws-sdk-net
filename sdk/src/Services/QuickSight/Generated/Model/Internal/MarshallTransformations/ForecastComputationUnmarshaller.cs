...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ForecastComputationUnmarshaller : IUnmarshaller<ForecastComputation, XmlUnmarshallerContext>, IUnmarshaller<ForecastComputation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ForecastComputation IUnmarshaller<ForecastComputation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ForecastComputation Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("CustomSeasonalityValue", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomSeasonalityValue = unmarshaller.Unmarshall(context);
                    continue;
                }
