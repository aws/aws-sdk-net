...
{
    /// <summary>
    /// Response Unmarshaller for ListSelfUpgrades operation
    /// </summary>  
    public class ListSelfUpgradesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSelfUpgradesResponse response = new ListSelfUpgradesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SelfUpgradeRequestDetails", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SelfUpgradeRequestDetail, SelfUpgradeRequestDetailUnmarshaller>(SelfUpgradeRequestDetailUnmarshaller.Instance);
                    response.SelfUpgradeRequestDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSelfUpgradesResponseUnmarshaller _instance = new ListSelfUpgradesResponseUnmarshaller();        

        internal static ListSelfUpgradesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSelfUpgradesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
