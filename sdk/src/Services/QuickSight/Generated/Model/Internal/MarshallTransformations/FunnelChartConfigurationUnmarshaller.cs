    ...
    public class FunnelChartConfigurationUnmarshaller : IJsonUnmarshaller<FunnelChartConfiguration, JsonUnmarshallerContext>
    {
        ...
        public FunnelChartConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DataLabelOptions", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ValueLabelOptions", targetDepth, ref reader))
                {
                    var unmarshaller = ChartAxisLabelOptionsUnmarshaller.Instance;
        ...
        private static FunnelChartConfigurationUnmarshaller _instance = new FunnelChartConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FunnelChartConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
