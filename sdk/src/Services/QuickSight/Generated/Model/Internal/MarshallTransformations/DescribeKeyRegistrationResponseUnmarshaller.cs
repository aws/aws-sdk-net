...
{
    /// <summary>
    /// Response Unmarshaller for DescribeKeyRegistration operation
    /// </summary>  
    public class DescribeKeyRegistrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeKeyRegistrationResponse response = new DescribeKeyRegistrationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("KeyRegistration", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RegisteredCustomerManagedKey, RegisteredCustomerManagedKeyUnmarshaller>(RegisteredCustomerManagedKeyUnmarshaller.Instance);
                    response.KeyRegistration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("QDataKey", targetDepth, ref reader))
                {
                    var unmarshaller = QDataKeyUnmarshaller.Instance;
                    response.QDataKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeKeyRegistrationResponseUnmarshaller _instance = new DescribeKeyRegistrationResponseUnmarshaller();        

        internal static DescribeKeyRegistrationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeKeyRegistrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
