...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class CreateFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateFlowResponseUnmarshaller _instance = new CreateFlowResponseUnmarshaller();        

        internal static CreateFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
