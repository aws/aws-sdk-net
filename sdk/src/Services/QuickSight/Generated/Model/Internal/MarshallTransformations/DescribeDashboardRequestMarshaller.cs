...
{
    /// <summary>
    /// DescribeDashboard Request Marshaller
    /// </summary>       
    public class DescribeDashboardRequestMarshaller : IMarshaller<IRequest, DescribeDashboardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDashboardRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDashboardRequest publicRequest)
        {
        ...
        private static DescribeDashboardRequestMarshaller _instance = new DescribeDashboardRequestMarshaller();        

        internal static DescribeDashboardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDashboardRequestMarshaller Instance
        {
            get
            {
                return _instance;
