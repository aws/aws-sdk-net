...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTopicV2 operation
    /// </summary>  
    public class DescribeTopicV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTopicV2Response response = new DescribeTopicV2Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TopicV2DetailsUnmarshaller.Instance;
        ...
        private static DescribeTopicV2ResponseUnmarshaller _instance = new DescribeTopicV2ResponseUnmarshaller();        

        internal static DescribeTopicV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTopicV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
