...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSelfUpgradeConfiguration operation
    /// </summary>  
    public class UpdateSelfUpgradeConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSelfUpgradeConfigurationResponse response = new UpdateSelfUpgradeConfigurationResponse();
        ...
        private static UpdateSelfUpgradeConfigurationResponseUnmarshaller _instance = new UpdateSelfUpgradeConfigurationResponseUnmarshaller();        

        internal static UpdateSelfUpgradeConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSelfUpgradeConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
