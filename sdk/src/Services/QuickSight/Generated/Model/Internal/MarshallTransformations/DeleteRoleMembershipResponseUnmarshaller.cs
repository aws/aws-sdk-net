...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRoleMembership operation
    /// </summary>  
    public class DeleteRoleMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRoleMembershipResponse response = new DeleteRoleMembershipResponse();
        ...
        private static DeleteRoleMembershipResponseUnmarshaller _instance = new DeleteRoleMembershipResponseUnmarshaller();        

        internal static DeleteRoleMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoleMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
