...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NumericalMeasureFieldUnmarshaller : IUnmarshaller<NumericalMeasureField, XmlUnmarshallerContext>, IUnmarshaller<NumericalMeasureField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NumericalMeasureField IUnmarshaller<NumericalMeasureField, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public NumericalMeasureField Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
