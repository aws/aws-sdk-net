...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HeatMapSortConfigurationUnmarshaller : IUnmarshaller<HeatMapSortConfiguration, XmlUnmarshallerContext>, IUnmarshaller<HeatMapSortConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HeatMapSortConfiguration IUnmarshaller<HeatMapSortConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public HeatMapSortConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("HeatMapColumnItemsLimitConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.HeatMapColumnItemsLimitConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("HeatMapColumnSort", targetDepth))
                {
                    ...
                    unmarshalledObject.HeatMapColumnSort = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("HeatMapRowItemsLimitConfiguration", targetDepth))
                {
                    var unmarshaller = ItemsLimitConfigurationUnmarshaller.Instance;
                    unmarshalledObject.HeatMapRowItemsLimitConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("HeatMapRowSort", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<FieldSortOptions, FieldSortOptionsUnmarshaller>(FieldSortOptionsUnmarshaller.Instance);
                    unmarshalledObject.HeatMapRowSort = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
