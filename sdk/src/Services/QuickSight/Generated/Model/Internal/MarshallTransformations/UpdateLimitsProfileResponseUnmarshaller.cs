...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLimitsProfile operation
    /// </summary>  
    public class UpdateLimitsProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLimitsProfileResponse response = new UpdateLimitsProfileResponse();
        ...
        private static UpdateLimitsProfileResponseUnmarshaller _instance = new UpdateLimitsProfileResponseUnmarshaller();        

        internal static UpdateLimitsProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLimitsProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
