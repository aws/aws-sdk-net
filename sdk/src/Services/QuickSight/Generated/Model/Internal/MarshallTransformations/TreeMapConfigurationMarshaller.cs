...
{
    /// <summary>
    /// TreeMapConfiguration Marshaller
    /// </summary>
    public class TreeMapConfigurationMarshaller : IRequestMarshaller<TreeMapConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TreeMapConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFieldWells())
            {
                ...
                var marshaller = TreeMapFieldWellsMarshaller.Instance;
                marshaller.Marshall(requestObject.FieldWells, context);

                context.Writer.WriteObjectEnd();
            }

            if(requestObject.IsSetGroupLabelOptions())
            {
                context.Writer.WritePropertyName("GroupLabelOptions");
                context.Writer.WriteObjectStart();

                var marshaller = ChartAxisLabelOptionsMarshaller.Instance;
                marshaller.Marshall(requestObject.GroupLabelOptions, context);
            ...
            if(requestObject.IsSetSizeLabelOptions())
            {
                context.Writer.WritePropertyName("SizeLabelOptions");
                context.Writer.WriteObjectStart();

                var marshaller = ChartAxisLabelOptionsMarshaller.Instance;
                marshaller.Marshall(requestObject.SizeLabelOptions, context);
            ...
            if(requestObject.IsSetSortConfiguration())
            {
                ...
                var marshaller = TreeMapSortConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static TreeMapConfigurationMarshaller Instance = new TreeMapConfigurationMarshaller();
