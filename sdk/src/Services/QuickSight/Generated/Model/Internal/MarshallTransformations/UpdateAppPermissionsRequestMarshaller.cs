...
{
    /// <summary>
    /// UpdateAppPermissions Request Marshaller
    /// </summary>       
    public class UpdateAppPermissionsRequestMarshaller : IMarshaller<IRequest, UpdateAppPermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAppPermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAppPermissionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/accounts/{AwsAccountId}/apps/{AppId}/permissions";
#if !NETFRAMEWORK
        ...
        private static UpdateAppPermissionsRequestMarshaller _instance = new UpdateAppPermissionsRequestMarshaller();        

        internal static UpdateAppPermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAppPermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
