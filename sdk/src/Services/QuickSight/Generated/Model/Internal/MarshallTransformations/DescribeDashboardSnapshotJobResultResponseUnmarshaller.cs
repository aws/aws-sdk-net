...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDashboardSnapshotJobResult operation
    /// </summary>  
    public class DescribeDashboardSnapshotJobResultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDashboardSnapshotJobResultResponse response = new DescribeDashboardSnapshotJobResultResponse();
        ...
        private static DescribeDashboardSnapshotJobResultResponseUnmarshaller _instance = new DescribeDashboardSnapshotJobResultResponseUnmarshaller();        

        internal static DescribeDashboardSnapshotJobResultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDashboardSnapshotJobResultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
