...
{
    /// <summary>
    /// Response Unmarshaller for ListRefreshSchedules operation
    /// </summary>  
    public class ListRefreshSchedulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRefreshSchedulesResponse response = new ListRefreshSchedulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RefreshSchedule, RefreshScheduleUnmarshaller>(RefreshScheduleUnmarshaller.Instance);
                    response.RefreshSchedules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListRefreshSchedulesResponseUnmarshaller _instance = new ListRefreshSchedulesResponseUnmarshaller();        

        internal static ListRefreshSchedulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRefreshSchedulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
