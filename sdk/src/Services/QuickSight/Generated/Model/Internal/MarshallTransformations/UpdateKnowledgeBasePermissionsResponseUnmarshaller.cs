...
{
    /// <summary>
    /// Response Unmarshaller for UpdateKnowledgeBasePermissions operation
    /// </summary>  
    public class UpdateKnowledgeBasePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateKnowledgeBasePermissionsResponse response = new UpdateKnowledgeBasePermissionsResponse();
        ...
        private static UpdateKnowledgeBasePermissionsResponseUnmarshaller _instance = new UpdateKnowledgeBasePermissionsResponseUnmarshaller();        

        internal static UpdateKnowledgeBasePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKnowledgeBasePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
