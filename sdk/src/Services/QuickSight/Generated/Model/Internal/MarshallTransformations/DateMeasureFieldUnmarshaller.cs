...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DateMeasureFieldUnmarshaller : IUnmarshaller<DateMeasureField, XmlUnmarshallerContext>, IUnmarshaller<DateMeasureField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DateMeasureField IUnmarshaller<DateMeasureField, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DateMeasureField Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
