...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeospatialLayerColorFieldUnmarshaller : IUnmarshaller<GeospatialLayerColorField, XmlUnmarshallerContext>, IUnmarshaller<GeospatialLayerColorField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeospatialLayerColorField IUnmarshaller<GeospatialLayerColorField, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GeospatialLayerColorField Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ColorDimensionsFields", targetDepth))
                {
                    ...
                    unmarshalledObject.ColorDimensionsFields = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ColorValuesFields", targetDepth))
                {
                    ...
                    unmarshalledObject.ColorValuesFields = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
