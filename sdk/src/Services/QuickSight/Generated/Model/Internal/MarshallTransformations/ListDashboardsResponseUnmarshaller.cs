...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDashboardsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDashboardsResponse response = new ListDashboardsResponse();
            ...
            {
                if (context.TestExpression("DashboardSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DashboardSummary, DashboardSummaryUnmarshaller>(DashboardSummaryUnmarshaller.Instance);
                    response.DashboardSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDashboardsResponseUnmarshaller _instance = new ListDashboardsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDashboardsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
