    ...
    public class ListDashboardsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DashboardSummary, DashboardSummaryUnmarshaller>(DashboardSummaryUnmarshaller.Instance);
                    response.DashboardSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
