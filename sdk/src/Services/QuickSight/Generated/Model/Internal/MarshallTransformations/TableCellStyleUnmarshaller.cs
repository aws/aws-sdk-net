...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TableCellStyleUnmarshaller : IUnmarshaller<TableCellStyle, XmlUnmarshallerContext>, IUnmarshaller<TableCellStyle, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TableCellStyle IUnmarshaller<TableCellStyle, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TableCellStyle Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TextWrap = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("VerticalTextAlignment", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VerticalTextAlignment = unmarshaller.Unmarshall(context);
                    continue;
                }
