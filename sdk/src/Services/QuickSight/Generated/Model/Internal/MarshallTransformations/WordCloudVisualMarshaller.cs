...
{
    /// <summary>
    /// WordCloudVisual Marshaller
    /// </summary>
    public class WordCloudVisualMarshaller : IRequestMarshaller<WordCloudVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(WordCloudVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = WordCloudChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static WordCloudVisualMarshaller Instance = new WordCloudVisualMarshaller();
