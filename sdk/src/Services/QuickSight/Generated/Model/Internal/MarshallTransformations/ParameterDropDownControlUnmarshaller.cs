...
{
    /// <summary>
    /// Response Unmarshaller for ParameterDropDownControl Object
    /// </summary>  
    public class ParameterDropDownControlUnmarshaller : IUnmarshaller<ParameterDropDownControl, XmlUnmarshallerContext>, IUnmarshaller<ParameterDropDownControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ParameterDropDownControl IUnmarshaller<ParameterDropDownControl, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ParameterDropDownControl Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            ParameterDropDownControl unmarshalledObject = new ParameterDropDownControl();
        ...
        private static ParameterDropDownControlUnmarshaller _instance = new ParameterDropDownControlUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ParameterDropDownControlUnmarshaller Instance
        {
            get
            {
                return _instance;
