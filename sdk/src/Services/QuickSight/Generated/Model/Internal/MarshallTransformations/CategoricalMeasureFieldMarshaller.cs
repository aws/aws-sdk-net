...
{
    /// <summary>
    /// CategoricalMeasureField Marshaller
    /// </summary>
    public class CategoricalMeasureFieldMarshaller : IRequestMarshaller<CategoricalMeasureField, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CategoricalMeasureField requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFormatConfiguration())
            {
                ...
                var marshaller = StringFormatConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CategoricalMeasureFieldMarshaller Instance = new CategoricalMeasureFieldMarshaller();
