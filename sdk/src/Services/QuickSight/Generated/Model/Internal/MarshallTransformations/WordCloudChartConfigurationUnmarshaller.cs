    ...
    public class WordCloudChartConfigurationUnmarshaller : IJsonUnmarshaller<WordCloudChartConfiguration, JsonUnmarshallerContext>
    {
        ...
        public WordCloudChartConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WordCloudOptions", targetDepth, ref reader))
                {
        ...
        private static WordCloudChartConfigurationUnmarshaller _instance = new WordCloudChartConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WordCloudChartConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
