...
{
    /// <summary>
    /// Response Unmarshaller for DescribeActionConnector operation
    /// </summary>  
    public class DescribeActionConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeActionConnectorResponse response = new DescribeActionConnectorResponse();
            ...
            {
                if (context.TestExpression("ActionConnector", targetDepth, ref reader))
                {
                    var unmarshaller = ActionConnectorUnmarshaller.Instance;
                    response.ActionConnector = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeActionConnectorResponseUnmarshaller _instance = new DescribeActionConnectorResponseUnmarshaller();        

        internal static DescribeActionConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeActionConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
