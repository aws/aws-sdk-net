...
{
    /// <summary>
    /// Response Unmarshaller for ListDlpSettings operation
    /// </summary>  
    public class ListDlpSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDlpSettingsResponse response = new ListDlpSettingsResponse();
            ...
            {
                if (context.TestExpression("DlpSettingSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DlpSettingSummary, DlpSettingSummaryUnmarshaller>(DlpSettingSummaryUnmarshaller.Instance);
                    response.DlpSettingSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDlpSettingsResponseUnmarshaller _instance = new ListDlpSettingsResponseUnmarshaller();        

        internal static ListDlpSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDlpSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
