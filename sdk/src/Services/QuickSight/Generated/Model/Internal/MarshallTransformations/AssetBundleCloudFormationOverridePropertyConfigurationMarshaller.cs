...
{
    /// <summary>
    /// AssetBundleCloudFormationOverridePropertyConfiguration Marshaller
    /// </summary>
    public class AssetBundleCloudFormationOverridePropertyConfigurationMarshaller : IRequestMarshaller<AssetBundleCloudFormationOverridePropertyConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(AssetBundleCloudFormationOverridePropertyConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAnalyses())
            {
                ...
                foreach(var requestObjectAnalysesListValue in requestObject.Analyses)
                {
                    ...
                    var marshaller = AssetBundleExportJobAnalysisOverridePropertiesMarshaller.Instance;
            ...
            if(requestObject.IsSetDashboards())
            {
                ...
                foreach(var requestObjectDashboardsListValue in requestObject.Dashboards)
                {
                    ...
                    var marshaller = AssetBundleExportJobDashboardOverridePropertiesMarshaller.Instance;
            ...
            if(requestObject.IsSetDataSets())
            {
                ...
                foreach(var requestObjectDataSetsListValue in requestObject.DataSets)
                {
                    ...
                    var marshaller = AssetBundleExportJobDataSetOverridePropertiesMarshaller.Instance;
            ...
            if(requestObject.IsSetRefreshSchedules())
            {
                ...
                foreach(var requestObjectRefreshSchedulesListValue in requestObject.RefreshSchedules)
                {
                    ...
                    var marshaller = AssetBundleExportJobRefreshScheduleOverridePropertiesMarshaller.Instance;
            ...
            if(requestObject.IsSetResourceIdOverrideConfiguration())
            {
                ...
                var marshaller = AssetBundleExportJobResourceIdOverrideConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetThemes())
            {
                ...
                foreach(var requestObjectThemesListValue in requestObject.Themes)
                {
                    ...
                    var marshaller = AssetBundleExportJobThemeOverridePropertiesMarshaller.Instance;
            ...
            if(requestObject.IsSetTopicsV2())
            {
                ...
                foreach(var requestObjectTopicsV2ListValue in requestObject.TopicsV2)
                {
                    ...
                    var marshaller = AssetBundleExportJobTopicV2OverridePropertiesMarshaller.Instance;
            ...
            if(requestObject.IsSetVPCConnections())
            {
                ...
                foreach(var requestObjectVPCConnectionsListValue in requestObject.VPCConnections)
                {
                    ...
                    var marshaller = AssetBundleExportJobVPCConnectionOverridePropertiesMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AssetBundleCloudFormationOverridePropertyConfigurationMarshaller Instance = new AssetBundleCloudFormationOverridePropertyConfigurationMarshaller();
