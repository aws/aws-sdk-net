    ...
    public class ListFolderMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MemberIdArnPair, MemberIdArnPairUnmarshaller>(MemberIdArnPairUnmarshaller.Instance);
                    response.FolderMemberList = unmarshaller.Unmarshall(context);
                    continue;
                }
