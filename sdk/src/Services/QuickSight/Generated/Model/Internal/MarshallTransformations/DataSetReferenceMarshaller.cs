...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class DataSetReferenceMarshaller : IRequestMarshaller<DataSetReference, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DataSetReference requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDataSetPlaceholder())
            {
                context.Writer.WritePropertyName("DataSetPlaceholder");
                context.Writer.WriteStringValue(requestObject.DataSetPlaceholder);
            }
