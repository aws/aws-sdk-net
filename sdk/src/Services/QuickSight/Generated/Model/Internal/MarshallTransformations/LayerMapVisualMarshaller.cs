...
{
    /// <summary>
    /// LayerMapVisual Marshaller
    /// </summary>
    public class LayerMapVisualMarshaller : IRequestMarshaller<LayerMapVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(LayerMapVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = GeospatialLayerMapConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static LayerMapVisualMarshaller Instance = new LayerMapVisualMarshaller();
