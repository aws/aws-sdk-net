...
{
    /// <summary>
    /// Response Unmarshaller for CreateDlpSetting operation
    /// </summary>  
    public class CreateDlpSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDlpSettingResponse response = new CreateDlpSettingResponse();
        ...
        private static CreateDlpSettingResponseUnmarshaller _instance = new CreateDlpSettingResponseUnmarshaller();        

        internal static CreateDlpSettingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDlpSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
