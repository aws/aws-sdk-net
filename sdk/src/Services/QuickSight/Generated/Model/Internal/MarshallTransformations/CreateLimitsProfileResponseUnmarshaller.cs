...
{
    /// <summary>
    /// Response Unmarshaller for CreateLimitsProfile operation
    /// </summary>  
    public class CreateLimitsProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLimitsProfileResponse response = new CreateLimitsProfileResponse();
        ...
        private static CreateLimitsProfileResponseUnmarshaller _instance = new CreateLimitsProfileResponseUnmarshaller();        

        internal static CreateLimitsProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLimitsProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
