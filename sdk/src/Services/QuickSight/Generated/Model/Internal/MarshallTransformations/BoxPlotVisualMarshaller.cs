...
{
    /// <summary>
    /// BoxPlotVisual Marshaller
    /// </summary>
    public class BoxPlotVisualMarshaller : IRequestMarshaller<BoxPlotVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(BoxPlotVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = BoxPlotChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static BoxPlotVisualMarshaller Instance = new BoxPlotVisualMarshaller();
