...
{
    /// <summary>
    /// Response Unmarshaller for InsightVisual Object
    /// </summary>  
    public class InsightVisualUnmarshaller : IUnmarshaller<InsightVisual, XmlUnmarshallerContext>, IUnmarshaller<InsightVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InsightVisual IUnmarshaller<InsightVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InsightVisual Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("InsightConfiguration", targetDepth))
                {
                    var unmarshaller = InsightConfigurationUnmarshaller.Instance;
                    unmarshalledObject.InsightConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static InsightVisualUnmarshaller _instance = new InsightVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InsightVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
