...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InsightVisualUnmarshaller : IJsonUnmarshaller<InsightVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InsightVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("InsightConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = InsightConfigurationUnmarshaller.Instance;
                    unmarshalledObject.InsightConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
