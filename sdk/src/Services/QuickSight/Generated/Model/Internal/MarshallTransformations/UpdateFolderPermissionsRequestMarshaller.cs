...
{
    /// <summary>
    /// UpdateFolderPermissions Request Marshaller
    /// </summary>       
    public class UpdateFolderPermissionsRequestMarshaller : IMarshaller<IRequest, UpdateFolderPermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFolderPermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFolderPermissionsRequest publicRequest)
        {
        ...
        private static UpdateFolderPermissionsRequestMarshaller _instance = new UpdateFolderPermissionsRequestMarshaller();        

        internal static UpdateFolderPermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFolderPermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
