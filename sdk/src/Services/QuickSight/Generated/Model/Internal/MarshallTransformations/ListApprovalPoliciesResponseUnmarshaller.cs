...
{
    /// <summary>
    /// Response Unmarshaller for ListApprovalPolicies operation
    /// </summary>  
    public class ListApprovalPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApprovalPoliciesResponse response = new ListApprovalPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ApprovalPolicy, ApprovalPolicyUnmarshaller>(ApprovalPolicyUnmarshaller.Instance);
        ...
        private static ListApprovalPoliciesResponseUnmarshaller _instance = new ListApprovalPoliciesResponseUnmarshaller();        

        internal static ListApprovalPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApprovalPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
