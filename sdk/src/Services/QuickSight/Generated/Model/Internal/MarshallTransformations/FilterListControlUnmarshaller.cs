...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterListControlUnmarshaller : IUnmarshaller<FilterListControl, XmlUnmarshallerContext>, IUnmarshaller<FilterListControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FilterListControl IUnmarshaller<FilterListControl, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FilterListControl Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
