...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFolder operation
    /// </summary>  
    public class DeleteFolderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FolderId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FolderId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteFolderResponseUnmarshaller _instance = new DeleteFolderResponseUnmarshaller();        

        internal static DeleteFolderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFolderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
