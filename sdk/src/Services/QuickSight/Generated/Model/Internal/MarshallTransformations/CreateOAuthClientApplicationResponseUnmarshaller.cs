...
{
    /// <summary>
    /// Response Unmarshaller for CreateOAuthClientApplication operation
    /// </summary>  
    public class CreateOAuthClientApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOAuthClientApplicationResponse response = new CreateOAuthClientApplicationResponse();
        ...
        private static CreateOAuthClientApplicationResponseUnmarshaller _instance = new CreateOAuthClientApplicationResponseUnmarshaller();        

        internal static CreateOAuthClientApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOAuthClientApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
