...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApprovalPolicy operation
    /// </summary>  
    public class DeleteApprovalPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApprovalPolicyResponse response = new DeleteApprovalPolicyResponse();
        ...
        private static DeleteApprovalPolicyResponseUnmarshaller _instance = new DeleteApprovalPolicyResponseUnmarshaller();        

        internal static DeleteApprovalPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApprovalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
