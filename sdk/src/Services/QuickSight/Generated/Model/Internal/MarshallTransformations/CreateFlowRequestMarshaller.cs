...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class CreateFlowRequestMarshaller : IMarshaller<IRequest, CreateFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateFlowRequest publicRequest)
        {
            ...
            request.ResourcePath = "/accounts/{AwsAccountId}/flows";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetFlowDefinition())
            {
                ...
                Amazon.Runtime.Documents.Internal.Transform.DocumentMarshaller.Instance.Write(context.Writer, publicRequest.FlowDefinition);
            }
