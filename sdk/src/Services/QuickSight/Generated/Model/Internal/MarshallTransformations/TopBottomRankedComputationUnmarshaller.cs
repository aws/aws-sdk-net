...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TopBottomRankedComputationUnmarshaller : IJsonUnmarshaller<TopBottomRankedComputation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TopBottomRankedComputation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ResultSize", targetDepth, ref reader))
                {
