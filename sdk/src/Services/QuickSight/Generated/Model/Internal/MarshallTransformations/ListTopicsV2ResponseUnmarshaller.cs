...
{
    /// <summary>
    /// Response Unmarshaller for ListTopicsV2 operation
    /// </summary>  
    public class ListTopicsV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTopicsV2Response response = new ListTopicsV2Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TopicV2Summary, TopicV2SummaryUnmarshaller>(TopicV2SummaryUnmarshaller.Instance);
        ...
        private static ListTopicsV2ResponseUnmarshaller _instance = new ListTopicsV2ResponseUnmarshaller();        

        internal static ListTopicsV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTopicsV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
