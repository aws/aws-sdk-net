...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CurrencyDisplayFormatConfigurationUnmarshaller : IUnmarshaller<CurrencyDisplayFormatConfiguration, XmlUnmarshallerContext>, IUnmarshaller<CurrencyDisplayFormatConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CurrencyDisplayFormatConfiguration IUnmarshaller<CurrencyDisplayFormatConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CurrencyDisplayFormatConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("NumberScale", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberScale = unmarshaller.Unmarshall(context);
                    continue;
                }
