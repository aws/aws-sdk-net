...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteKnowledgeBase operation
    /// </summary>  
    public class BatchDeleteKnowledgeBaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteKnowledgeBaseResponse response = new BatchDeleteKnowledgeBaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDeleteKnowledgeBaseSuccess, BatchDeleteKnowledgeBaseSuccessUnmarshaller>(BatchDeleteKnowledgeBaseSuccessUnmarshaller.Instance);
                    response.Deleted = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Errors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDeleteKnowledgeBaseFailure, BatchDeleteKnowledgeBaseFailureUnmarshaller>(BatchDeleteKnowledgeBaseFailureUnmarshaller.Instance);
        ...
        private static BatchDeleteKnowledgeBaseResponseUnmarshaller _instance = new BatchDeleteKnowledgeBaseResponseUnmarshaller();        

        internal static BatchDeleteKnowledgeBaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteKnowledgeBaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
