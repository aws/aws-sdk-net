...
{
    /// <summary>
    /// Response Unmarshaller for ListOAuthClientApplications operation
    /// </summary>  
    public class ListOAuthClientApplicationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOAuthClientApplicationsResponse response = new ListOAuthClientApplicationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OAuthClientApplications", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<OAuthClientApplicationSummary, OAuthClientApplicationSummaryUnmarshaller>(OAuthClientApplicationSummaryUnmarshaller.Instance);
                    response.OAuthClientApplications = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListOAuthClientApplicationsResponseUnmarshaller _instance = new ListOAuthClientApplicationsResponseUnmarshaller();        

        internal static ListOAuthClientApplicationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOAuthClientApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
