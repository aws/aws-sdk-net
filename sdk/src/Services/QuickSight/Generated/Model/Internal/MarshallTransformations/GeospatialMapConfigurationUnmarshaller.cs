...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeospatialMapConfigurationUnmarshaller : IUnmarshaller<GeospatialMapConfiguration, XmlUnmarshallerContext>, IUnmarshaller<GeospatialMapConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeospatialMapConfiguration IUnmarshaller<GeospatialMapConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public GeospatialMapConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("PointStyleOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.PointStyleOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
