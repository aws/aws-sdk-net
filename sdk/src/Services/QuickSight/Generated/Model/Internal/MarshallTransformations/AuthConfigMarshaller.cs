    ...
    public class AuthConfigMarshaller : IRequestMarshaller<AuthConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(AuthConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAuthenticationMetadata())
            {
                context.Writer.WritePropertyName("AuthenticationMetadata");
                context.Writer.WriteStartObject();

                var marshaller = AuthenticationMetadataMarshaller.Instance;
                marshaller.Marshall(requestObject.AuthenticationMetadata, context);
