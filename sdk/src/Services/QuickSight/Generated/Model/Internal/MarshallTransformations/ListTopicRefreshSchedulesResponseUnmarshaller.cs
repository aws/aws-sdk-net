...
{
    /// <summary>
    /// Response Unmarshaller for ListTopicRefreshSchedules operation
    /// </summary>  
    public class ListTopicRefreshSchedulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTopicRefreshSchedulesResponse response = new ListTopicRefreshSchedulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TopicRefreshScheduleSummary, TopicRefreshScheduleSummaryUnmarshaller>(TopicRefreshScheduleSummaryUnmarshaller.Instance);
        ...
        private static ListTopicRefreshSchedulesResponseUnmarshaller _instance = new ListTopicRefreshSchedulesResponseUnmarshaller();        

        internal static ListTopicRefreshSchedulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTopicRefreshSchedulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
