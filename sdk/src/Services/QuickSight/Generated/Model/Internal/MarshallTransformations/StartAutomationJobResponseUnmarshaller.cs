...
{
    /// <summary>
    /// Response Unmarshaller for StartAutomationJob operation
    /// </summary>  
    public class StartAutomationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAutomationJobResponse response = new StartAutomationJobResponse();
        ...
        private static StartAutomationJobResponseUnmarshaller _instance = new StartAutomationJobResponseUnmarshaller();        

        internal static StartAutomationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAutomationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
