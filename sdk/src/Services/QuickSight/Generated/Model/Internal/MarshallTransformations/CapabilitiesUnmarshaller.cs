...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class CapabilitiesUnmarshaller : IJsonUnmarshaller<Capabilities, JsonUnmarshallerContext>
    {
        ...
        public Capabilities Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AccessAppsNativeDataStore", targetDepth))
                {
                ...
                if (context.TestExpression("CreateAndUpdateApps", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("CreateSpaces", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("GenerateAnalyses", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("InvokeAppsAIInference", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ManageSharedFolders", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ShareApps", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ShareChatAgents", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ShareSpaces", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("Story", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
