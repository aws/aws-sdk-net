...
{
    /// <summary>
    /// Response Unmarshaller for SearchApps operation
    /// </summary>  
    public class SearchAppsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchAppsResponse response = new SearchAppsResponse();
            ...
            {
                if (context.TestExpression("AppSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AppSummary, AppSummaryUnmarshaller>(AppSummaryUnmarshaller.Instance);
                    response.AppSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchAppsResponseUnmarshaller _instance = new SearchAppsResponseUnmarshaller();        

        internal static SearchAppsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchAppsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
