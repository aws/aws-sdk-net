...
{
    /// <summary>
    /// DateMeasureField Marshaller
    /// </summary>
    public class DateMeasureFieldMarshaller : IRequestMarshaller<DateMeasureField, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DateMeasureField requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAggregationFunction())
            {
                ...
                context.Writer.WriteStringValue(requestObject.AggregationFunction);
            }
            ...
            if(requestObject.IsSetFormatConfiguration())
            {
                ...
                var marshaller = DateTimeFormatConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static DateMeasureFieldMarshaller Instance = new DateMeasureFieldMarshaller();
