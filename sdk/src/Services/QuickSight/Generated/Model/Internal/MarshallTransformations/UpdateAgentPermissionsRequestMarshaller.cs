...
{
    /// <summary>
    /// UpdateAgentPermissions Request Marshaller
    /// </summary>       
    public class UpdateAgentPermissionsRequestMarshaller : IMarshaller<IRequest, UpdateAgentPermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAgentPermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAgentPermissionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/accounts/{AwsAccountId}/agents/{AgentId}/permissions";
#if !NETFRAMEWORK
        ...
        private static UpdateAgentPermissionsRequestMarshaller _instance = new UpdateAgentPermissionsRequestMarshaller();        

        internal static UpdateAgentPermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentPermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
