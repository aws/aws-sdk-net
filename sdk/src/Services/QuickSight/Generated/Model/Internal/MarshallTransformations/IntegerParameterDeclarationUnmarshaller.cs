...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IntegerParameterDeclarationUnmarshaller : IJsonUnmarshaller<IntegerParameterDeclaration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IntegerParameterDeclaration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ParameterValueType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
