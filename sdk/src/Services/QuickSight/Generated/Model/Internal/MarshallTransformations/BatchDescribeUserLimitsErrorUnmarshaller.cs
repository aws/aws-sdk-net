...
{
    /// <summary>
    /// Response Unmarshaller for BatchDescribeUserLimitsError Object
    /// </summary>  
    public class BatchDescribeUserLimitsErrorUnmarshaller : IJsonUnmarshaller<BatchDescribeUserLimitsError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchDescribeUserLimitsError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchDescribeUserLimitsError unmarshalledObject = new BatchDescribeUserLimitsError();
        ...
        private static BatchDescribeUserLimitsErrorUnmarshaller _instance = new BatchDescribeUserLimitsErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchDescribeUserLimitsErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
