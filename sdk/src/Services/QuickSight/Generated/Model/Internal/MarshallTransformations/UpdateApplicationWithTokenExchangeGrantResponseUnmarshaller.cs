...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApplicationWithTokenExchangeGrant operation
    /// </summary>  
    public class UpdateApplicationWithTokenExchangeGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateApplicationWithTokenExchangeGrantResponse response = new UpdateApplicationWithTokenExchangeGrantResponse();
        ...
        private static UpdateApplicationWithTokenExchangeGrantResponseUnmarshaller _instance = new UpdateApplicationWithTokenExchangeGrantResponseUnmarshaller();        

        internal static UpdateApplicationWithTokenExchangeGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApplicationWithTokenExchangeGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
