...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BoxPlotChartConfigurationUnmarshaller : IUnmarshaller<BoxPlotChartConfiguration, XmlUnmarshallerContext>, IUnmarshaller<BoxPlotChartConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BoxPlotChartConfiguration IUnmarshaller<BoxPlotChartConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public BoxPlotChartConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BoxPlotOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.BoxPlotOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
