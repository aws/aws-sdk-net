...
{
    /// <summary>
    /// UpdateFlowPermissions Request Marshaller
    /// </summary>       
    public class UpdateFlowPermissionsRequestMarshaller : IMarshaller<IRequest, UpdateFlowPermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFlowPermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFlowPermissionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/accounts/{AwsAccountId}/flows/{FlowId}/permissions";
#if !NETFRAMEWORK
        ...
        private static UpdateFlowPermissionsRequestMarshaller _instance = new UpdateFlowPermissionsRequestMarshaller();        

        internal static UpdateFlowPermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowPermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
