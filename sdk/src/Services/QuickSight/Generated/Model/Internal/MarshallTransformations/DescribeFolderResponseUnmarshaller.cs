...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFolder operation
    /// </summary>  
    public class DescribeFolderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFolderResponse response = new DescribeFolderResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Folder", targetDepth, ref reader))
                {
                    var unmarshaller = FolderUnmarshaller.Instance;
                    response.Folder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeFolderResponseUnmarshaller _instance = new DescribeFolderResponseUnmarshaller();        

        internal static DescribeFolderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFolderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
