...
{
    /// <summary>
    /// Response Unmarshaller for DescribeOAuthClientApplication operation
    /// </summary>  
    public class DescribeOAuthClientApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeOAuthClientApplicationResponse response = new DescribeOAuthClientApplicationResponse();
            ...
            {
                if (context.TestExpression("OAuthClientApplication", targetDepth, ref reader))
                {
                    var unmarshaller = OAuthClientApplicationUnmarshaller.Instance;
                    response.OAuthClientApplication = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeOAuthClientApplicationResponseUnmarshaller _instance = new DescribeOAuthClientApplicationResponseUnmarshaller();        

        internal static DescribeOAuthClientApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeOAuthClientApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
