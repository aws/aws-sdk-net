...
{
    /// <summary>
    /// Response Unmarshaller for SearchTopicsV2 operation
    /// </summary>  
    public class SearchTopicsV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchTopicsV2Response response = new SearchTopicsV2Response();
        ...
        private static SearchTopicsV2ResponseUnmarshaller _instance = new SearchTopicsV2ResponseUnmarshaller();        

        internal static SearchTopicsV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTopicsV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
