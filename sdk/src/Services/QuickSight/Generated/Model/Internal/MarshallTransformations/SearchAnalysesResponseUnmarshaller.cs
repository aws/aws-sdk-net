...
{
    /// <summary>
    /// Response Unmarshaller for SearchAnalyses operation
    /// </summary>  
    public class SearchAnalysesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchAnalysesResponse response = new SearchAnalysesResponse();
            ...
            {
                if (context.TestExpression("AnalysisSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AnalysisSummary, AnalysisSummaryUnmarshaller>(AnalysisSummaryUnmarshaller.Instance);
                    response.AnalysisSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchAnalysesResponseUnmarshaller _instance = new SearchAnalysesResponseUnmarshaller();        

        internal static SearchAnalysesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchAnalysesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
