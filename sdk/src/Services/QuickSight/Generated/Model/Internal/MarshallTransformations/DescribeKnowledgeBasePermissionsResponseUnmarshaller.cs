...
{
    /// <summary>
    /// Response Unmarshaller for DescribeKnowledgeBasePermissions operation
    /// </summary>  
    public class DescribeKnowledgeBasePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeKnowledgeBasePermissionsResponse response = new DescribeKnowledgeBasePermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("KnowledgeBaseArn", targetDepth, ref reader))
                {
                    ...
                    response.KnowledgeBaseArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("KnowledgeBaseId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.KnowledgeBaseId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeKnowledgeBasePermissionsResponseUnmarshaller _instance = new DescribeKnowledgeBasePermissionsResponseUnmarshaller();        

        internal static DescribeKnowledgeBasePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeKnowledgeBasePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
