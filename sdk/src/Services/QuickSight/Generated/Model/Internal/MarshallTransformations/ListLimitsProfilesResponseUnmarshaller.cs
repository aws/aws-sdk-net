...
{
    /// <summary>
    /// Response Unmarshaller for ListLimitsProfiles operation
    /// </summary>  
    public class ListLimitsProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLimitsProfilesResponse response = new ListLimitsProfilesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LimitsProfile, LimitsProfileUnmarshaller>(LimitsProfileUnmarshaller.Instance);
        ...
        private static ListLimitsProfilesResponseUnmarshaller _instance = new ListLimitsProfilesResponseUnmarshaller();        

        internal static ListLimitsProfilesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLimitsProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
