    ...
    public class ListCustomPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CustomPermissions, CustomPermissionsUnmarshaller>(CustomPermissionsUnmarshaller.Instance);
                    response.CustomPermissionsList = unmarshaller.Unmarshall(context);
                    continue;
                }
