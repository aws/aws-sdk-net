...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RedshiftParametersUnmarshaller : IJsonUnmarshaller<RedshiftParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RedshiftParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IAMParameters", targetDepth, ref reader))
                {
                    var unmarshaller = RedshiftIAMParametersUnmarshaller.Instance;
                    unmarshalledObject.IAMParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
