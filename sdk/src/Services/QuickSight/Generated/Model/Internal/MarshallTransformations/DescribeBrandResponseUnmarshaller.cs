...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBrand operation
    /// </summary>  
    public class DescribeBrandResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBrandResponse response = new DescribeBrandResponse();
        ...
        private static DescribeBrandResponseUnmarshaller _instance = new DescribeBrandResponseUnmarshaller();        

        internal static DescribeBrandResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBrandResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
