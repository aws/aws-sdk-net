...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActiveIAMPolicyAssignmentUnmarshaller : IJsonUnmarshaller<ActiveIAMPolicyAssignment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActiveIAMPolicyAssignment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AssignmentName", targetDepth, ref reader))
                {
