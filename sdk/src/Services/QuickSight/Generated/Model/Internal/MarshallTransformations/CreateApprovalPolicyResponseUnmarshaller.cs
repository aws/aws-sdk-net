...
{
    /// <summary>
    /// Response Unmarshaller for CreateApprovalPolicy operation
    /// </summary>  
    public class CreateApprovalPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateApprovalPolicyResponse response = new CreateApprovalPolicyResponse();
        ...
        private static CreateApprovalPolicyResponseUnmarshaller _instance = new CreateApprovalPolicyResponseUnmarshaller();        

        internal static CreateApprovalPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApprovalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
