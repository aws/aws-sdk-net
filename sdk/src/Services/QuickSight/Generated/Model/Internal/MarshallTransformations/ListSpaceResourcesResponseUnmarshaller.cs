...
{
    /// <summary>
    /// Response Unmarshaller for ListSpaceResources operation
    /// </summary>  
    public class ListSpaceResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSpaceResourcesResponse response = new ListSpaceResourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SpaceResources", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SpaceResourceSummary, SpaceResourceSummaryUnmarshaller>(SpaceResourceSummaryUnmarshaller.Instance);
                    response.SpaceResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSpaceResourcesResponseUnmarshaller _instance = new ListSpaceResourcesResponseUnmarshaller();        

        internal static ListSpaceResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSpaceResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
