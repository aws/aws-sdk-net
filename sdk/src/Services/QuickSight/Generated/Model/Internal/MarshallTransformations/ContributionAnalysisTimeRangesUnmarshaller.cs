...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class ContributionAnalysisTimeRangesUnmarshaller : IJsonUnmarshaller<ContributionAnalysisTimeRanges, JsonUnmarshallerContext>
    {
        ...
        public ContributionAnalysisTimeRanges Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("EndRange", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("StartRange", targetDepth, ref reader))
                {
                    var unmarshaller = TopicIRFilterOptionUnmarshaller.Instance;
        ...
        private static ContributionAnalysisTimeRangesUnmarshaller _instance = new ContributionAnalysisTimeRangesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContributionAnalysisTimeRangesUnmarshaller Instance
        {
            get
            {
                return _instance;
