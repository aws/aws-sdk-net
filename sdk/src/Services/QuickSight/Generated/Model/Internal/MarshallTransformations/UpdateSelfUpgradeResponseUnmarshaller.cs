...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSelfUpgrade operation
    /// </summary>  
    public class UpdateSelfUpgradeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSelfUpgradeResponse response = new UpdateSelfUpgradeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SelfUpgradeRequestDetail", targetDepth, ref reader))
                {
                    var unmarshaller = SelfUpgradeRequestDetailUnmarshaller.Instance;
                    response.SelfUpgradeRequestDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateSelfUpgradeResponseUnmarshaller _instance = new UpdateSelfUpgradeResponseUnmarshaller();        

        internal static UpdateSelfUpgradeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSelfUpgradeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
