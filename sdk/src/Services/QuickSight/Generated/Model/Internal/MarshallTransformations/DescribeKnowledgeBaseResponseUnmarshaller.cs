...
{
    /// <summary>
    /// Response Unmarshaller for DescribeKnowledgeBase operation
    /// </summary>  
    public class DescribeKnowledgeBaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeKnowledgeBaseResponse response = new DescribeKnowledgeBaseResponse();
        ...
        private static DescribeKnowledgeBaseResponseUnmarshaller _instance = new DescribeKnowledgeBaseResponseUnmarshaller();        

        internal static DescribeKnowledgeBaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeKnowledgeBaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
