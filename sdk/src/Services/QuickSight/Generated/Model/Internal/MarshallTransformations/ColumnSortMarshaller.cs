...
{
    /// <summary>
    /// ColumnSort Marshaller
    /// </summary>
    public class ColumnSortMarshaller : IRequestMarshaller<ColumnSort, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ColumnSort requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSortBy())
            {
                ...
                marshaller.Marshall(requestObject.SortBy, context);
        ...
        /// </summary>
        public readonly static ColumnSortMarshaller Instance = new ColumnSortMarshaller();
