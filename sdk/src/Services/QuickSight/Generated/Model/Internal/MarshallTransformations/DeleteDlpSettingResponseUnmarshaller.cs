...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDlpSetting operation
    /// </summary>  
    public class DeleteDlpSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDlpSettingResponse response = new DeleteDlpSettingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DlpSettingId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteDlpSettingResponseUnmarshaller _instance = new DeleteDlpSettingResponseUnmarshaller();        

        internal static DeleteDlpSettingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDlpSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
