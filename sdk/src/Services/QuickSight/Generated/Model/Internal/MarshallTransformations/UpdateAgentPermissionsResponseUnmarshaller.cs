...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAgentPermissions operation
    /// </summary>  
    public class UpdateAgentPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAgentPermissionsResponse response = new UpdateAgentPermissionsResponse();
        ...
        private static UpdateAgentPermissionsResponseUnmarshaller _instance = new UpdateAgentPermissionsResponseUnmarshaller();        

        internal static UpdateAgentPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
