...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataSetPermissions operation
    /// </summary>  
    public class DescribeDataSetPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDataSetPermissionsResponse response = new DescribeDataSetPermissionsResponse();
        ...
        private static DescribeDataSetPermissionsResponseUnmarshaller _instance = new DescribeDataSetPermissionsResponseUnmarshaller();        

        internal static DescribeDataSetPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataSetPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
