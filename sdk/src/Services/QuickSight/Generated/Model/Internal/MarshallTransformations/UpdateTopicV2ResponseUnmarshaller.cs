...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTopicV2 operation
    /// </summary>  
    public class UpdateTopicV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTopicV2Response response = new UpdateTopicV2Response();
        ...
        private static UpdateTopicV2ResponseUnmarshaller _instance = new UpdateTopicV2ResponseUnmarshaller();        

        internal static UpdateTopicV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTopicV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
