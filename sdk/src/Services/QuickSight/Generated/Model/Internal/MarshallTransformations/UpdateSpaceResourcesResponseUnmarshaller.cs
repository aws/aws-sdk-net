...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSpaceResources operation
    /// </summary>  
    public class UpdateSpaceResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSpaceResourcesResponse response = new UpdateSpaceResourcesResponse();
        ...
        private static UpdateSpaceResourcesResponseUnmarshaller _instance = new UpdateSpaceResourcesResponseUnmarshaller();        

        internal static UpdateSpaceResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSpaceResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
