...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFolder operation
    /// </summary>  
    public class UpdateFolderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateFolderResponseUnmarshaller _instance = new UpdateFolderResponseUnmarshaller();        

        internal static UpdateFolderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFolderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
