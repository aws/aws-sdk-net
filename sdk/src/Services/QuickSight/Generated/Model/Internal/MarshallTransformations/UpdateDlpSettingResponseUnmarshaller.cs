...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDlpSetting operation
    /// </summary>  
    public class UpdateDlpSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDlpSettingResponse response = new UpdateDlpSettingResponse();
        ...
        private static UpdateDlpSettingResponseUnmarshaller _instance = new UpdateDlpSettingResponseUnmarshaller();        

        internal static UpdateDlpSettingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDlpSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
