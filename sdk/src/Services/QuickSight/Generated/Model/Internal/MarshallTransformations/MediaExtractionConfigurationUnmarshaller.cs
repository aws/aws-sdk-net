...
{
    /// <summary>
    /// Response Unmarshaller for MediaExtractionConfiguration Object
    /// </summary>  
    public class MediaExtractionConfigurationUnmarshaller : IJsonUnmarshaller<MediaExtractionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MediaExtractionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MediaExtractionConfiguration unmarshalledObject = new MediaExtractionConfiguration();
        ...
        private static MediaExtractionConfigurationUnmarshaller _instance = new MediaExtractionConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MediaExtractionConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
