...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSpacePermissions operation
    /// </summary>  
    public class DescribeSpacePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSpacePermissionsResponse response = new DescribeSpacePermissionsResponse();
        ...
        private static DescribeSpacePermissionsResponseUnmarshaller _instance = new DescribeSpacePermissionsResponseUnmarshaller();        

        internal static DescribeSpacePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSpacePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
