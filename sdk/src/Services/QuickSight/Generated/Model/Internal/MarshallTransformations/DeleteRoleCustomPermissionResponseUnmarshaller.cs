...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRoleCustomPermission operation
    /// </summary>  
    public class DeleteRoleCustomPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRoleCustomPermissionResponse response = new DeleteRoleCustomPermissionResponse();
        ...
        private static DeleteRoleCustomPermissionResponseUnmarshaller _instance = new DeleteRoleCustomPermissionResponseUnmarshaller();        

        internal static DeleteRoleCustomPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoleCustomPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
