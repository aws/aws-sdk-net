...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteDashboardRequestMarshaller : IMarshaller<IRequest, DeleteDashboardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteDashboardRequestMarshaller _instance = new DeleteDashboardRequestMarshaller();        

        internal static DeleteDashboardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDashboardRequestMarshaller Instance
        {
            get
            {
                return _instance;
