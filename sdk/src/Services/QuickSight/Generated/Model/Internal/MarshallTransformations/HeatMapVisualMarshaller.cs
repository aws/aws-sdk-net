...
{
    /// <summary>
    /// HeatMapVisual Marshaller
    /// </summary>
    public class HeatMapVisualMarshaller : IRequestMarshaller<HeatMapVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(HeatMapVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = HeatMapConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static HeatMapVisualMarshaller Instance = new HeatMapVisualMarshaller();
