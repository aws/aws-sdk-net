...
{
    /// <summary>
    /// Response Unmarshaller for SearchSpaces operation
    /// </summary>  
    public class SearchSpacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchSpacesResponse response = new SearchSpacesResponse();
        ...
        private static SearchSpacesResponseUnmarshaller _instance = new SearchSpacesResponseUnmarshaller();        

        internal static SearchSpacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchSpacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
