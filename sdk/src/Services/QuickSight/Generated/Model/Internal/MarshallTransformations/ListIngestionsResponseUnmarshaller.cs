    ...
    public class ListIngestionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Ingestion, IngestionUnmarshaller>(IngestionUnmarshaller.Instance);
                    response.Ingestions = unmarshaller.Unmarshall(context);
                    continue;
                }
