...
{
    /// <summary>
    /// Response Unmarshaller for ListIngestions operation
    /// </summary>  
    public class ListIngestionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIngestionsResponse response = new ListIngestionsResponse();
            ...
            {
                if (context.TestExpression("Ingestions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Ingestion, IngestionUnmarshaller>(IngestionUnmarshaller.Instance);
                    response.Ingestions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ResourceExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ListIngestionsResponseUnmarshaller _instance = new ListIngestionsResponseUnmarshaller();        

        internal static ListIngestionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIngestionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
