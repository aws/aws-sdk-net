...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HistogramConfigurationUnmarshaller : IUnmarshaller<HistogramConfiguration, XmlUnmarshallerContext>, IUnmarshaller<HistogramConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HistogramConfiguration IUnmarshaller<HistogramConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public HistogramConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BinOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.BinOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
