...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class CreateNamespaceRequestMarshaller : IMarshaller<IRequest, CreateNamespaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateNamespaceRequest publicRequest)
        {
            ...
            request.ResourcePath = "/accounts/{AwsAccountId}";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetIdentityStore())
            {
                context.Writer.WritePropertyName("IdentityStore");
                context.Writer.WriteStringValue(publicRequest.IdentityStore);
            }
