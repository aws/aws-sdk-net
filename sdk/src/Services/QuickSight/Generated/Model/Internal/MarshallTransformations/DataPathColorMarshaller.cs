...
{
    /// <summary>
    /// DataPathColor Marshaller
    /// </summary>
    public class DataPathColorMarshaller : IRequestMarshaller<DataPathColor, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DataPathColor requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetElement())
            {
                ...
                marshaller.Marshall(requestObject.Element, context);
        ...
        /// </summary>
        public readonly static DataPathColorMarshaller Instance = new DataPathColorMarshaller();
