...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeospatialCategoricalDataColorUnmarshaller : IJsonUnmarshaller<GeospatialCategoricalDataColor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeospatialCategoricalDataColor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DataValue", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
