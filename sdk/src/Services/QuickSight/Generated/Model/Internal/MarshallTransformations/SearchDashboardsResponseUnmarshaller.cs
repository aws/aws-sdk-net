...
{
    /// <summary>
    /// Response Unmarshaller for SearchDashboards operation
    /// </summary>  
    public class SearchDashboardsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchDashboardsResponse response = new SearchDashboardsResponse();
        ...
        private static SearchDashboardsResponseUnmarshaller _instance = new SearchDashboardsResponseUnmarshaller();        

        internal static SearchDashboardsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchDashboardsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
