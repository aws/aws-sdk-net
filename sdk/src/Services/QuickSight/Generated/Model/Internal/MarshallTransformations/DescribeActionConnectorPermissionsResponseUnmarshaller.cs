...
{
    /// <summary>
    /// Response Unmarshaller for DescribeActionConnectorPermissions operation
    /// </summary>  
    public class DescribeActionConnectorPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeActionConnectorPermissionsResponse response = new DescribeActionConnectorPermissionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ActionConnectorId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ActionConnectorId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeActionConnectorPermissionsResponseUnmarshaller _instance = new DescribeActionConnectorPermissionsResponseUnmarshaller();        

        internal static DescribeActionConnectorPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeActionConnectorPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
