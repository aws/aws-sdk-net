...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIpRestriction operation
    /// </summary>  
    public class UpdateIpRestrictionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIpRestrictionResponse response = new UpdateIpRestrictionResponse();
        ...
        private static UpdateIpRestrictionResponseUnmarshaller _instance = new UpdateIpRestrictionResponseUnmarshaller();        

        internal static UpdateIpRestrictionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIpRestrictionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
