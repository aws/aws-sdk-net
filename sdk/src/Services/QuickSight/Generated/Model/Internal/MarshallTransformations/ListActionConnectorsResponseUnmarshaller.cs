...
{
    /// <summary>
    /// Response Unmarshaller for ListActionConnectors operation
    /// </summary>  
    public class ListActionConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListActionConnectorsResponse response = new ListActionConnectorsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ActionConnectorSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ActionConnectorSummary, ActionConnectorSummaryUnmarshaller>(ActionConnectorSummaryUnmarshaller.Instance);
                    response.ActionConnectorSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListActionConnectorsResponseUnmarshaller _instance = new ListActionConnectorsResponseUnmarshaller();        

        internal static ListActionConnectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListActionConnectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
