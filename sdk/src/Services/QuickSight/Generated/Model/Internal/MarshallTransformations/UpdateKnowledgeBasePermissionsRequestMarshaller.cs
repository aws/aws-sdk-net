...
{
    /// <summary>
    /// UpdateKnowledgeBasePermissions Request Marshaller
    /// </summary>       
    public class UpdateKnowledgeBasePermissionsRequestMarshaller : IMarshaller<IRequest, UpdateKnowledgeBasePermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateKnowledgeBasePermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateKnowledgeBasePermissionsRequest publicRequest)
        {
        ...
        private static UpdateKnowledgeBasePermissionsRequestMarshaller _instance = new UpdateKnowledgeBasePermissionsRequestMarshaller();        

        internal static UpdateKnowledgeBasePermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKnowledgeBasePermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
