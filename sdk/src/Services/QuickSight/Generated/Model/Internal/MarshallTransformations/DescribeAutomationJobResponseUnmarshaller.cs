...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAutomationJob operation
    /// </summary>  
    public class DescribeAutomationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAutomationJobResponse response = new DescribeAutomationJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OutputPayload", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OutputPayload = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAutomationJobResponseUnmarshaller _instance = new DescribeAutomationJobResponseUnmarshaller();        

        internal static DescribeAutomationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAutomationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
