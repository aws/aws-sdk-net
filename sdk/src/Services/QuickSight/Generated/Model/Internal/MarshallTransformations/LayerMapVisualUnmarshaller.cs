...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LayerMapVisualUnmarshaller : IUnmarshaller<LayerMapVisual, XmlUnmarshallerContext>, IUnmarshaller<LayerMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LayerMapVisual IUnmarshaller<LayerMapVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public LayerMapVisual Unmarshall(JsonUnmarshallerContext context)
        {
            LayerMapVisual unmarshalledObject = new LayerMapVisual();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LayerMapVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
