...
{
    /// <summary>
    /// Response Unmarshaller for UpdateActionConnectorPermissions operation
    /// </summary>  
    public class UpdateActionConnectorPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateActionConnectorPermissionsResponse response = new UpdateActionConnectorPermissionsResponse();
        ...
        private static UpdateActionConnectorPermissionsResponseUnmarshaller _instance = new UpdateActionConnectorPermissionsResponseUnmarshaller();        

        internal static UpdateActionConnectorPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateActionConnectorPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
