...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateRoleMembershipRequestMarshaller : IMarshaller<IRequest, CreateRoleMembershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateRoleMembershipRequestMarshaller _instance = new CreateRoleMembershipRequestMarshaller();        

        internal static CreateRoleMembershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRoleMembershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
