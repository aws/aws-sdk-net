...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDlpSetting operation
    /// </summary>  
    public class DescribeDlpSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDlpSettingResponse response = new DescribeDlpSettingResponse();
            ...
            {
                if (context.TestExpression("DlpSetting", targetDepth, ref reader))
                {
                    var unmarshaller = DlpSettingDetailsUnmarshaller.Instance;
                    response.DlpSetting = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeDlpSettingResponseUnmarshaller _instance = new DescribeDlpSettingResponseUnmarshaller();        

        internal static DescribeDlpSettingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDlpSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
