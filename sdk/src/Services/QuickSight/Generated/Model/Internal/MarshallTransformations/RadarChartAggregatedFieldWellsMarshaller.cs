...
{
    /// <summary>
    /// RadarChartAggregatedFieldWells Marshaller
    /// </summary>
    public class RadarChartAggregatedFieldWellsMarshaller : IRequestMarshaller<RadarChartAggregatedFieldWells, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RadarChartAggregatedFieldWells requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetColor())
            {
                ...
                context.Writer.WriteArrayStart();
                foreach(var requestObjectColorListValue in requestObject.Color)
                {
                    context.Writer.WriteObjectStart();

                    var marshaller = DimensionFieldMarshaller.Instance;
                    marshaller.Marshall(requestObjectColorListValue, context);
        ...
        /// </summary>
        public readonly static RadarChartAggregatedFieldWellsMarshaller Instance = new RadarChartAggregatedFieldWellsMarshaller();
