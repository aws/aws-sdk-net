...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAgent operation
    /// </summary>  
    public class DescribeAgentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAgentResponse response = new DescribeAgentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AgentUnmarshaller.Instance;
                    response.Agent = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAgentResponseUnmarshaller _instance = new DescribeAgentResponseUnmarshaller();        

        internal static DescribeAgentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAgentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
