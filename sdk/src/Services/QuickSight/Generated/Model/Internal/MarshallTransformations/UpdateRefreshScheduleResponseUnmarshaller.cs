...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRefreshSchedule operation
    /// </summary>  
    public class UpdateRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRefreshScheduleResponse response = new UpdateRefreshScheduleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScheduleId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateRefreshScheduleResponseUnmarshaller _instance = new UpdateRefreshScheduleResponseUnmarshaller();        

        internal static UpdateRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
