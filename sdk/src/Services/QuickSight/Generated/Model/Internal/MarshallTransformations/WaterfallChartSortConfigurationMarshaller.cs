...
{
    /// <summary>
    /// WaterfallChartSortConfiguration Marshaller
    /// </summary>
    public class WaterfallChartSortConfigurationMarshaller : IRequestMarshaller<WaterfallChartSortConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(WaterfallChartSortConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetBreakdownItemsLimit())
            {
                ...
                marshaller.Marshall(requestObject.BreakdownItemsLimit, context);
        ...
        /// </summary>
        public readonly static WaterfallChartSortConfigurationMarshaller Instance = new WaterfallChartSortConfigurationMarshaller();
