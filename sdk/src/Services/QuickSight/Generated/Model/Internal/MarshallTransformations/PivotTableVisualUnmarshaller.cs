...
{
    /// <summary>
    /// Response Unmarshaller for PivotTableVisual Object
    /// </summary>  
    public class PivotTableVisualUnmarshaller : IUnmarshaller<PivotTableVisual, XmlUnmarshallerContext>, IUnmarshaller<PivotTableVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PivotTableVisual IUnmarshaller<PivotTableVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PivotTableVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            PivotTableVisual unmarshalledObject = new PivotTableVisual();
        ...
        private static PivotTableVisualUnmarshaller _instance = new PivotTableVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PivotTableVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
