...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HeatMapVisualUnmarshaller : IUnmarshaller<HeatMapVisual, XmlUnmarshallerContext>, IUnmarshaller<HeatMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HeatMapVisual IUnmarshaller<HeatMapVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public HeatMapVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
