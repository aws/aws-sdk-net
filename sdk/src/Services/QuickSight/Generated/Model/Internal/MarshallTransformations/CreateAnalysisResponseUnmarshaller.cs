...
{
    /// <summary>
    /// Response Unmarshaller for CreateAnalysis operation
    /// </summary>  
    public class CreateAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAnalysisResponse response = new CreateAnalysisResponse();
        ...
        private static CreateAnalysisResponseUnmarshaller _instance = new CreateAnalysisResponseUnmarshaller();        

        internal static CreateAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
