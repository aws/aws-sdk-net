...
{
    /// <summary>
    /// Response Unmarshaller for LineChartVisual Object
    /// </summary>  
    public class LineChartVisualUnmarshaller : IJsonUnmarshaller<LineChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LineChartVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LineChartConfigurationUnmarshaller.Instance;
                    unmarshalledObject.ChartConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ColumnHierarchies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ColumnHierarchy, ColumnHierarchyUnmarshaller>(ColumnHierarchyUnmarshaller.Instance);
        ...
        private static LineChartVisualUnmarshaller _instance = new LineChartVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LineChartVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
