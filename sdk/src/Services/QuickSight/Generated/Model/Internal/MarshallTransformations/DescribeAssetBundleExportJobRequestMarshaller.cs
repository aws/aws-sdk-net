...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeAssetBundleExportJobRequestMarshaller : IMarshaller<IRequest, DescribeAssetBundleExportJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeAssetBundleExportJobRequestMarshaller _instance = new DescribeAssetBundleExportJobRequestMarshaller();        

        internal static DescribeAssetBundleExportJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssetBundleExportJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
