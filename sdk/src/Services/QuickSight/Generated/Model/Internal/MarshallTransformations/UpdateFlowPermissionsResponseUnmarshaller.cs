...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFlowPermissions operation
    /// </summary>  
    public class UpdateFlowPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFlowPermissionsResponse response = new UpdateFlowPermissionsResponse();
        ...
        private static UpdateFlowPermissionsResponseUnmarshaller _instance = new UpdateFlowPermissionsResponseUnmarshaller();        

        internal static UpdateFlowPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
