...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DateDimensionFieldUnmarshaller : IUnmarshaller<DateDimensionField, XmlUnmarshallerContext>, IUnmarshaller<DateDimensionField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DateDimensionField IUnmarshaller<DateDimensionField, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DateDimensionField Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("DateGranularity", targetDepth))
                {
                    ...
                    unmarshalledObject.DateGranularity = unmarshaller.Unmarshall(context);
                    continue;
                }
