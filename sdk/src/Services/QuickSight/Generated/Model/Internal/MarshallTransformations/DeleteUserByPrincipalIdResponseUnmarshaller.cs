...
{
    /// <summary>
    /// Response Unmarshaller for DeleteUserByPrincipalId operation
    /// </summary>  
    public class DeleteUserByPrincipalIdResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUserByPrincipalIdResponse response = new DeleteUserByPrincipalIdResponse();
        ...
        private static DeleteUserByPrincipalIdResponseUnmarshaller _instance = new DeleteUserByPrincipalIdResponseUnmarshaller();        

        internal static DeleteUserByPrincipalIdResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserByPrincipalIdResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
