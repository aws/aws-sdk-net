    ...
    public class ListVPCConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<VPCConnectionSummary, VPCConnectionSummaryUnmarshaller>(VPCConnectionSummaryUnmarshaller.Instance);
                    response.VPCConnectionSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
