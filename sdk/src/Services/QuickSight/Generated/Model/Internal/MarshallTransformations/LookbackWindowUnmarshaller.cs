...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LookbackWindowUnmarshaller : IJsonUnmarshaller<LookbackWindow, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LookbackWindow Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SizeUnit", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SizeUnit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
