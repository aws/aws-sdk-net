...
{
    /// <summary>
    /// Response Unmarshaller for DescribeApprovalPolicy operation
    /// </summary>  
    public class DescribeApprovalPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeApprovalPolicyResponse response = new DescribeApprovalPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ApprovalPolicyUnmarshaller.Instance;
        ...
        private static DescribeApprovalPolicyResponseUnmarshaller _instance = new DescribeApprovalPolicyResponseUnmarshaller();        

        internal static DescribeApprovalPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeApprovalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
