...
{
    /// <summary>
    /// Response Unmarshaller for DeleteOAuthClientApplication operation
    /// </summary>  
    public class DeleteOAuthClientApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteOAuthClientApplicationResponse response = new DeleteOAuthClientApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OAuthClientApplicationId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OAuthClientApplicationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteOAuthClientApplicationResponseUnmarshaller _instance = new DeleteOAuthClientApplicationResponseUnmarshaller();        

        internal static DeleteOAuthClientApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOAuthClientApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
