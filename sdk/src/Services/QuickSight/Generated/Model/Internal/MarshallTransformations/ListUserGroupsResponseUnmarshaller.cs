...
{
    /// <summary>
    /// Response Unmarshaller for ListUserGroups operation
    /// </summary>  
    public class ListUserGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GroupList", targetDepth))
                {
                    ...
                    response.GroupList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListUserGroupsResponseUnmarshaller _instance = new ListUserGroupsResponseUnmarshaller();        

        internal static ListUserGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
