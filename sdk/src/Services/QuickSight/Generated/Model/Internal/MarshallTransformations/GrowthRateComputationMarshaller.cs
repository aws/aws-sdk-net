...
{
    /// <summary>
    /// GrowthRateComputation Marshaller
    /// </summary>
    public class GrowthRateComputationMarshaller : IRequestMarshaller<GrowthRateComputation, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(GrowthRateComputation requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPeriodSize())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.PeriodSize.Value);
            }
        ...
        /// </summary>
        public readonly static GrowthRateComputationMarshaller Instance = new GrowthRateComputationMarshaller();
