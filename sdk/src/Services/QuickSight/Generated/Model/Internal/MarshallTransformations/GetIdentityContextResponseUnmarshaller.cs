...
{
    /// <summary>
    /// Response Unmarshaller for GetIdentityContext operation
    /// </summary>  
    public class GetIdentityContextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdentityContextResponse response = new GetIdentityContextResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Context", targetDepth))
                {
                    ...
                    response.Context = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetIdentityContextResponseUnmarshaller _instance = new GetIdentityContextResponseUnmarshaller();        

        internal static GetIdentityContextResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdentityContextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
