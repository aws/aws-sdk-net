    ...
    public class SearchTopicsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TopicSummary, TopicSummaryUnmarshaller>(TopicSummaryUnmarshaller.Instance);
                    response.TopicSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
