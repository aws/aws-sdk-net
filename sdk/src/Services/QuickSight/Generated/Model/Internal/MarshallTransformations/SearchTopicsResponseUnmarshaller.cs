...
{
    /// <summary>
    /// Response Unmarshaller for SearchTopics operation
    /// </summary>  
    public class SearchTopicsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchTopicsResponse response = new SearchTopicsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TopicSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TopicSummary, TopicSummaryUnmarshaller>(TopicSummaryUnmarshaller.Instance);
                    response.TopicSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static SearchTopicsResponseUnmarshaller _instance = new SearchTopicsResponseUnmarshaller();        

        internal static SearchTopicsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTopicsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
