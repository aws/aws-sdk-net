...
{
    /// <summary>
    /// Response Unmarshaller for GenerateEmbedUrlForAnonymousUser operation
    /// </summary>  
    public class GenerateEmbedUrlForAnonymousUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateEmbedUrlForAnonymousUserResponse response = new GenerateEmbedUrlForAnonymousUserResponse();
            ...
            {
                if (context.TestExpression("AnonymousUserArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AnonymousUserArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SessionLifetimeInMinutesInvalidException"))
                {
                    return SessionLifetimeInMinutesInvalidExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ThrottlingException"))
                {
                    return ThrottlingExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedPricingPlanException"))
                {
                    return UnsupportedPricingPlanExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GenerateEmbedUrlForAnonymousUserResponseUnmarshaller _instance = new GenerateEmbedUrlForAnonymousUserResponseUnmarshaller();        

        internal static GenerateEmbedUrlForAnonymousUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateEmbedUrlForAnonymousUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
