...
{
    /// <summary>
    /// Response Unmarshaller for ListUsersIndexCapacity operation
    /// </summary>  
    public class ListUsersIndexCapacityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUsersIndexCapacityResponse response = new ListUsersIndexCapacityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UserIndexCapacity, UserIndexCapacityUnmarshaller>(UserIndexCapacityUnmarshaller.Instance);
        ...
        private static ListUsersIndexCapacityResponseUnmarshaller _instance = new ListUsersIndexCapacityResponseUnmarshaller();        

        internal static ListUsersIndexCapacityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUsersIndexCapacityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
