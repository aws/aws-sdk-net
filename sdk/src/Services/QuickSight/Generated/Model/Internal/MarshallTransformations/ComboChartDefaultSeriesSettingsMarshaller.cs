...
{
    /// <summary>
    /// ComboChartDefaultSeriesSettings Marshaller
    /// </summary>
    public class ComboChartDefaultSeriesSettingsMarshaller : IRequestMarshaller<ComboChartDefaultSeriesSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ComboChartDefaultSeriesSettings requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetBorderSettings())
            {
                context.Writer.WritePropertyName("BorderSettings");
                context.Writer.WriteStartObject();

                var marshaller = BorderSettingsMarshaller.Instance;
                marshaller.Marshall(requestObject.BorderSettings, context);
        ...
        /// </summary>
        public readonly static ComboChartDefaultSeriesSettingsMarshaller Instance = new ComboChartDefaultSeriesSettingsMarshaller();
