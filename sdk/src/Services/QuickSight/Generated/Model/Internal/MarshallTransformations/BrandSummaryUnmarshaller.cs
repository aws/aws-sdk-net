...
{
    /// <summary>
    /// Response Unmarshaller for BrandSummary Object
    /// </summary>  
    public class BrandSummaryUnmarshaller : IJsonUnmarshaller<BrandSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BrandSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BrandSummary unmarshalledObject = new BrandSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("BrandId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("BrandStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static BrandSummaryUnmarshaller _instance = new BrandSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BrandSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
