...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTopicPermissionsV2 operation
    /// </summary>  
    public class UpdateTopicPermissionsV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTopicPermissionsV2Response response = new UpdateTopicPermissionsV2Response();
        ...
        private static UpdateTopicPermissionsV2ResponseUnmarshaller _instance = new UpdateTopicPermissionsV2ResponseUnmarshaller();        

        internal static UpdateTopicPermissionsV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTopicPermissionsV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
