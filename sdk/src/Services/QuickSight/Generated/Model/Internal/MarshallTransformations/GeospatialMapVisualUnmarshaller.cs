...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeospatialMapVisualUnmarshaller : IUnmarshaller<GeospatialMapVisual, XmlUnmarshallerContext>, IUnmarshaller<GeospatialMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeospatialMapVisual IUnmarshaller<GeospatialMapVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GeospatialMapVisual Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GeocodePreference, GeocodePreferenceUnmarshaller>(GeocodePreferenceUnmarshaller.Instance);
                    unmarshalledObject.GeocodingPreferences = unmarshaller.Unmarshall(context);
                    continue;
                }
