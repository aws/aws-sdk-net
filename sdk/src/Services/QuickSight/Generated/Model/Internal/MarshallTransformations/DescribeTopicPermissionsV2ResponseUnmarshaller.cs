...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTopicPermissionsV2 operation
    /// </summary>  
    public class DescribeTopicPermissionsV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTopicPermissionsV2Response response = new DescribeTopicPermissionsV2Response();
        ...
        private static DescribeTopicPermissionsV2ResponseUnmarshaller _instance = new DescribeTopicPermissionsV2ResponseUnmarshaller();        

        internal static DescribeTopicPermissionsV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTopicPermissionsV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
