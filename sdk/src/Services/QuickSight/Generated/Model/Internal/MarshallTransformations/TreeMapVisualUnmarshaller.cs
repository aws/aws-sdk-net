...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TreeMapVisualUnmarshaller : IUnmarshaller<TreeMapVisual, XmlUnmarshallerContext>, IUnmarshaller<TreeMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TreeMapVisual IUnmarshaller<TreeMapVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TreeMapVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
