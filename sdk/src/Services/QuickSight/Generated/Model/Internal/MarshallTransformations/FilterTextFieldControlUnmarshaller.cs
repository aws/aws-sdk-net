...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterTextFieldControlUnmarshaller : IJsonUnmarshaller<FilterTextFieldControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterTextFieldControl Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FilterControlId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FilterControlId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SourceFilterId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
