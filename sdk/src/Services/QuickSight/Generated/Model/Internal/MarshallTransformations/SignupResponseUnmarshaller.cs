...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SignupResponseUnmarshaller : IUnmarshaller<SignupResponse, XmlUnmarshallerContext>, IUnmarshaller<SignupResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SignupResponse IUnmarshaller<SignupResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SignupResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UserLoginName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
