...
{
    /// <summary>
    /// Response Unmarshaller for SearchKnowledgeBases operation
    /// </summary>  
    public class SearchKnowledgeBasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchKnowledgeBasesResponse response = new SearchKnowledgeBasesResponse();
        ...
        private static SearchKnowledgeBasesResponseUnmarshaller _instance = new SearchKnowledgeBasesResponseUnmarshaller();        

        internal static SearchKnowledgeBasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchKnowledgeBasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
