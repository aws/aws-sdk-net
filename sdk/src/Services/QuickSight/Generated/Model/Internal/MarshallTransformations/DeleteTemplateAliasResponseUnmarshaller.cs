...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTemplateAlias operation
    /// </summary>  
    public class DeleteTemplateAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTemplateAliasResponse response = new DeleteTemplateAliasResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AliasName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AliasName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteTemplateAliasResponseUnmarshaller _instance = new DeleteTemplateAliasResponseUnmarshaller();        

        internal static DeleteTemplateAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTemplateAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
