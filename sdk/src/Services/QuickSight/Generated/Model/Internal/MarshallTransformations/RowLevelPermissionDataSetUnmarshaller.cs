...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RowLevelPermissionDataSetUnmarshaller : IJsonUnmarshaller<RowLevelPermissionDataSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RowLevelPermissionDataSet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PermissionPolicy", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PermissionPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
