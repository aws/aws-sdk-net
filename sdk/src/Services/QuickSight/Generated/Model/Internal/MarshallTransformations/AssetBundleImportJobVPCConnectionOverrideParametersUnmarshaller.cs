...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetBundleImportJobVPCConnectionOverrideParametersUnmarshaller : IUnmarshaller<AssetBundleImportJobVPCConnectionOverrideParameters, XmlUnmarshallerContext>, IUnmarshaller<AssetBundleImportJobVPCConnectionOverrideParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AssetBundleImportJobVPCConnectionOverrideParameters IUnmarshaller<AssetBundleImportJobVPCConnectionOverrideParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AssetBundleImportJobVPCConnectionOverrideParameters Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DnsResolvers", targetDepth))
                {
                    ...
                    unmarshalledObject.DnsResolvers = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VPCConnectionId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
