...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAccountCustomization operation
    /// </summary>  
    public class UpdateAccountCustomizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAccountCustomizationResponse response = new UpdateAccountCustomizationResponse();
            ...
            {
                if (context.TestExpression("AccountCustomization", targetDepth, ref reader))
                {
                    var unmarshaller = AccountCustomizationUnmarshaller.Instance;
                    response.AccountCustomization = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAccountCustomizationResponseUnmarshaller _instance = new UpdateAccountCustomizationResponseUnmarshaller();        

        internal static UpdateAccountCustomizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccountCustomizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
