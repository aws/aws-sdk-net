...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAppPermissions operation
    /// </summary>  
    public class DescribeAppPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAppPermissionsResponse response = new DescribeAppPermissionsResponse();
        ...
        private static DescribeAppPermissionsResponseUnmarshaller _instance = new DescribeAppPermissionsResponseUnmarshaller();        

        internal static DescribeAppPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAppPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
