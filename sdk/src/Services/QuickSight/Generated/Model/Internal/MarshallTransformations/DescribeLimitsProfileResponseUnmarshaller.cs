...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLimitsProfile operation
    /// </summary>  
    public class DescribeLimitsProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLimitsProfileResponse response = new DescribeLimitsProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LimitsProfileUnmarshaller.Instance;
        ...
        private static DescribeLimitsProfileResponseUnmarshaller _instance = new DescribeLimitsProfileResponseUnmarshaller();        

        internal static DescribeLimitsProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLimitsProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
