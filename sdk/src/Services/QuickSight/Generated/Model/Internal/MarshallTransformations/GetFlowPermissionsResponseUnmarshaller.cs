...
{
    /// <summary>
    /// Response Unmarshaller for GetFlowPermissions operation
    /// </summary>  
    public class GetFlowPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFlowPermissionsResponse response = new GetFlowPermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Permission, PermissionUnmarshaller>(PermissionUnmarshaller.Instance);
        ...
        private static GetFlowPermissionsResponseUnmarshaller _instance = new GetFlowPermissionsResponseUnmarshaller();        

        internal static GetFlowPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFlowPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
