...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComboChartConfigurationUnmarshaller : IUnmarshaller<ComboChartConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ComboChartConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ComboChartConfiguration IUnmarshaller<ComboChartConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ComboChartConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BarDataLabels", targetDepth))
                {
                    ...
                    unmarshalledObject.BarDataLabels = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DataLabelOptionsUnmarshaller.Instance;
                    unmarshalledObject.LineDataLabels = unmarshaller.Unmarshall(context);
                    continue;
                }
