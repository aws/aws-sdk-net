...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WaterfallVisualUnmarshaller : IUnmarshaller<WaterfallVisual, XmlUnmarshallerContext>, IUnmarshaller<WaterfallVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        WaterfallVisual IUnmarshaller<WaterfallVisual, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public WaterfallVisual Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
