...
{
    /// <summary>
    /// Response Unmarshaller for ListTemplates operation
    /// </summary>  
    public class ListTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TemplateSummaryList", targetDepth, ref reader))
                {
                    ...
                    response.TemplateSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTemplatesResponseUnmarshaller _instance = new ListTemplatesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTemplatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
