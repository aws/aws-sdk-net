...
{
    /// <summary>
    /// Response Unmarshaller for CreateBrand operation
    /// </summary>  
    public class CreateBrandResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateBrandResponseUnmarshaller _instance = new CreateBrandResponseUnmarshaller();        

        internal static CreateBrandResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBrandResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
