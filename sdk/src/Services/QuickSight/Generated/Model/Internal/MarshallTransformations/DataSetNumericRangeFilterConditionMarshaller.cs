...
{
    /// <summary>
    /// DataSetNumericRangeFilterCondition Marshaller
    /// </summary>
    public class DataSetNumericRangeFilterConditionMarshaller : IRequestMarshaller<DataSetNumericRangeFilterCondition, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DataSetNumericRangeFilterCondition requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRangeMaximum())
            {
                ...
                var marshaller = DataSetNumericFilterValueMarshaller.Instance;
        ...
        /// </summary>
        public readonly static DataSetNumericRangeFilterConditionMarshaller Instance = new DataSetNumericRangeFilterConditionMarshaller();
