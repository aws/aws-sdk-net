...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAppPermissions operation
    /// </summary>  
    public class UpdateAppPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAppPermissionsResponse response = new UpdateAppPermissionsResponse();
        ...
        private static UpdateAppPermissionsResponseUnmarshaller _instance = new UpdateAppPermissionsResponseUnmarshaller();        

        internal static UpdateAppPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAppPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
