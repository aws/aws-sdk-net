...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class DatabricksParametersMarshaller : IRequestMarshaller<DatabricksParameters, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(DatabricksParameters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSqlEndpointPath())
            {
                ...
                context.Writer.Write(requestObject.SqlEndpointPath);
            }
