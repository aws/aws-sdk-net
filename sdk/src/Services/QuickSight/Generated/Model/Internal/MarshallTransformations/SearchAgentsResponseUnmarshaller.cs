...
{
    /// <summary>
    /// Response Unmarshaller for SearchAgents operation
    /// </summary>  
    public class SearchAgentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchAgentsResponse response = new SearchAgentsResponse();
        ...
        private static SearchAgentsResponseUnmarshaller _instance = new SearchAgentsResponseUnmarshaller();        

        internal static SearchAgentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchAgentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
