...
{
    /// <summary>
    /// Response Unmarshaller for CreateThemeAlias operation
    /// </summary>  
    public class CreateThemeAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateThemeAliasResponse response = new CreateThemeAliasResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ThemeAlias", targetDepth, ref reader))
                {
                    var unmarshaller = ThemeAliasUnmarshaller.Instance;
                    response.ThemeAlias = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateThemeAliasResponseUnmarshaller _instance = new CreateThemeAliasResponseUnmarshaller();        

        internal static CreateThemeAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThemeAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
