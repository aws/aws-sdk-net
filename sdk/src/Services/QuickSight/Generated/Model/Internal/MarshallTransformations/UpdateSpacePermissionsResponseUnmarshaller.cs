...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSpacePermissions operation
    /// </summary>  
    public class UpdateSpacePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSpacePermissionsResponse response = new UpdateSpacePermissionsResponse();
        ...
        private static UpdateSpacePermissionsResponseUnmarshaller _instance = new UpdateSpacePermissionsResponseUnmarshaller();        

        internal static UpdateSpacePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSpacePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
