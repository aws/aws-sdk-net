...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAgentPermissions operation
    /// </summary>  
    public class DescribeAgentPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAgentPermissionsResponse response = new DescribeAgentPermissionsResponse();
        ...
        private static DescribeAgentPermissionsResponseUnmarshaller _instance = new DescribeAgentPermissionsResponseUnmarshaller();        

        internal static DescribeAgentPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAgentPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
