...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExplicitHierarchyUnmarshaller : IJsonUnmarshaller<ExplicitHierarchy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExplicitHierarchy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DrillDownFilters", targetDepth, ref reader))
                {
