...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTopicV2 operation
    /// </summary>  
    public class DeleteTopicV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTopicV2Response response = new DeleteTopicV2Response();
        ...
        private static DeleteTopicV2ResponseUnmarshaller _instance = new DeleteTopicV2ResponseUnmarshaller();        

        internal static DeleteTopicV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTopicV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
