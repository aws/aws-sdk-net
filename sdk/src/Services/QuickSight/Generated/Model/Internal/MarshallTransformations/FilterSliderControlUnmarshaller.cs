...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterSliderControlUnmarshaller : IUnmarshaller<FilterSliderControl, XmlUnmarshallerContext>, IUnmarshaller<FilterSliderControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FilterSliderControl IUnmarshaller<FilterSliderControl, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FilterSliderControl Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
