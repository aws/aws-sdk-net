...
{
    /// <summary>
    /// Response Unmarshaller for DescribeIAMPolicyAssignment operation
    /// </summary>  
    public class DescribeIAMPolicyAssignmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeIAMPolicyAssignmentResponse response = new DescribeIAMPolicyAssignmentResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IAMPolicyAssignment", targetDepth, ref reader))
                {
                    var unmarshaller = IAMPolicyAssignmentUnmarshaller.Instance;
                    response.IAMPolicyAssignment = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeIAMPolicyAssignmentResponseUnmarshaller _instance = new DescribeIAMPolicyAssignmentResponseUnmarshaller();        

        internal static DescribeIAMPolicyAssignmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIAMPolicyAssignmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
