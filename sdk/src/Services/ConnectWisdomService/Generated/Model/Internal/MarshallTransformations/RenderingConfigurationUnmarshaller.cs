...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RenderingConfigurationUnmarshaller : IUnmarshaller<RenderingConfiguration, XmlUnmarshallerContext>, IUnmarshaller<RenderingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RenderingConfiguration IUnmarshaller<RenderingConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RenderingConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("templateUri", targetDepth))
                {
                    ...
                    unmarshalledObject.TemplateUri = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
