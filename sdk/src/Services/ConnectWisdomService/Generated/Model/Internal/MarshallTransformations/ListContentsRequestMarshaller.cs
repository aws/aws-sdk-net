...
{
    /// <summary>
    /// ListContents Request Marshaller
    /// </summary>       
    public class ListContentsRequestMarshaller : IMarshaller<IRequest, ListContentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListContentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListContentsRequest publicRequest)
        {
        ...
        private static ListContentsRequestMarshaller _instance = new ListContentsRequestMarshaller();        

        internal static ListContentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
