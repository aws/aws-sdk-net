...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SessionDataUnmarshaller : IUnmarshaller<SessionData, XmlUnmarshallerContext>, IUnmarshaller<SessionData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SessionData IUnmarshaller<SessionData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SessionData Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
