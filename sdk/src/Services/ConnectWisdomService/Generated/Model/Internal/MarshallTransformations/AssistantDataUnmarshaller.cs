...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssistantDataUnmarshaller : IUnmarshaller<AssistantData, XmlUnmarshallerContext>, IUnmarshaller<AssistantData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AssistantData IUnmarshaller<AssistantData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AssistantData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("integrationConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.IntegrationConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssistantDataUnmarshaller Instance
        {
            get
            {
                return _instance;
