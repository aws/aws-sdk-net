...
{
    /// <summary>
    /// CreateAssistant Request Marshaller
    /// </summary>       
    public class CreateAssistantRequestMarshaller : IMarshaller<IRequest, CreateAssistantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAssistantRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAssistantRequest publicRequest)
        {
        ...
        private static CreateAssistantRequestMarshaller _instance = new CreateAssistantRequestMarshaller();        

        internal static CreateAssistantRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssistantRequestMarshaller Instance
        {
            get
            {
                return _instance;
