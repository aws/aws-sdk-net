...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("importJob", targetDepth))
                {
                    ...
                    response.ImportJob = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static GetImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
