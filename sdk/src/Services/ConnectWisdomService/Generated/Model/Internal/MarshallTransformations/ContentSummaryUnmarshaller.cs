...
{
    /// <summary>
    /// Response Unmarshaller for ContentSummary Object
    /// </summary>  
    public class ContentSummaryUnmarshaller : IUnmarshaller<ContentSummary, XmlUnmarshallerContext>, IUnmarshaller<ContentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ContentSummary IUnmarshaller<ContentSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ContentSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            ContentSummary unmarshalledObject = new ContentSummary();
        ...
        private static ContentSummaryUnmarshaller _instance = new ContentSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContentSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
