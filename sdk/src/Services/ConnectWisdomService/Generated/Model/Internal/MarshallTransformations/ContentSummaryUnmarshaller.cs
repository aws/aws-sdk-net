...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContentSummaryUnmarshaller : IJsonUnmarshaller<ContentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContentSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("contentArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ContentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("contentId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
