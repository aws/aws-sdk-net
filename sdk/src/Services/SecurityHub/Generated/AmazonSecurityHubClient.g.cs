...
namespace Amazon.SecurityHub
{
    ...
    public partial class AmazonSecurityHubClient : AmazonServiceClient, IAmazonSecurityHub
    {
        ...
        /// 
        /// </summary>
        public AmazonSecurityHubClient() : base(new AmazonSecurityHubConfig()) { }
        ...
        public AmazonSecurityHubClient(RegionEndpoint region) : base(new AmazonSecurityHubConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSecurityHubClient(AmazonSecurityHubConfig config) : base(config) { }
...
#else
        internal virtual ListFreeTrialStatusesV2Response ListFreeTrialStatusesV2(ListFreeTrialStatusesV2Request request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListFreeTrialStatusesV2RequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListFreeTrialStatusesV2ResponseUnmarshaller.Instance;
