...
namespace Amazon.SecurityHub
{
    ...
    public partial class AmazonSecurityHubConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SecurityHub", "4.0.103.7");
        ...
        /// </summary>
        public static new string ServiceId => "SecurityHub";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "securityhub";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2018-10-26";
