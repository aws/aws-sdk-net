...
namespace Amazon.SecurityHub
{
    ...
    public partial class AmazonSecurityHubClient : AmazonServiceClient, IAmazonSecurityHub
    {
        ...
        public virtual DisableSecurityHubFeatureV2Response DisableSecurityHubFeatureV2(DisableSecurityHubFeatureV2Request request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual EnableSecurityHubFeatureV2Response EnableSecurityHubFeatureV2(EnableSecurityHubFeatureV2Request request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual GenerateRecommendedPolicyV2Response GenerateRecommendedPolicyV2(GenerateRecommendedPolicyV2Request request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual GetRecommendedPolicyV2Response GetRecommendedPolicyV2(GetRecommendedPolicyV2Request request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual ListFreeTrialStatusesV2Response ListFreeTrialStatusesV2(ListFreeTrialStatusesV2Request request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListFreeTrialStatusesV2RequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListFreeTrialStatusesV2ResponseUnmarshaller.Instance;

            return Invoke<ListFreeTrialStatusesV2Response>(request, options);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/ListFreeTrialStatusesV2">REST API Reference for ListFreeTrialStatusesV2 Operation</seealso>
        public virtual Task<ListFreeTrialStatusesV2Response> ListFreeTrialStatusesV2Async(ListFreeTrialStatusesV2Request request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListFreeTrialStatusesV2RequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListFreeTrialStatusesV2ResponseUnmarshaller.Instance;
            
            return InvokeAsync<ListFreeTrialStatusesV2Response>(request, options, cancellationToken);
        }
