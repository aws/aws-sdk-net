...
{
    /// <summary>
    /// Container for the parameters to the ListMembers operation. Lists details about all
    /// member accounts for the current Security Hub CSPM administrator account. <para> The
    ...
    public partial class ListMembersRequest : AmazonSecurityHubRequest
    {
        ...
        /// <summary>
        /// Checks to see if the OnlyAssociated property is set.
        /// </summary>
        internal bool IsSetOnlyAssociated() => this.OnlyAssociated.HasValue;
    }
}
