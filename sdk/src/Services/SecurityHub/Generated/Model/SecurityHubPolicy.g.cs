...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class SecurityHubPolicy
    {
        ...
        /// </summary>
        public List<string> EnabledStandardIdentifiers { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the EnabledStandardIdentifiers property is set.
        /// </summary>
        internal bool IsSetEnabledStandardIdentifiers() => this.EnabledStandardIdentifiers != null && (this.EnabledStandardIdentifiers.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the SecurityControlsConfiguration property is set.
        /// </summary>
        internal bool IsSetSecurityControlsConfiguration() => this.SecurityControlsConfiguration != null;
