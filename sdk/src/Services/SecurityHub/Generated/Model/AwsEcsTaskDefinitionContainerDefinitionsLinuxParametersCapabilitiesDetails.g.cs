...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetails
    {
        ...
        /// </summary>
        public List<string> Add { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Add property is set.
        /// </summary>
        internal bool IsSetAdd() => this.Add != null && (this.Add.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> Drop { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Drop property is set.
        /// </summary>
        internal bool IsSetDrop() => this.Drop != null && (this.Drop.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
