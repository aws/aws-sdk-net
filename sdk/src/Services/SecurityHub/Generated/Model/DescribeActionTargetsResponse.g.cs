...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class DescribeActionTargetsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ActionTarget> ActionTargets { get; set; } = AWSConfigs.InitializeCollections ? new List<ActionTarget>() : null;

        /// <summary>
        /// Checks to see if the ActionTargets property is set.
        /// </summary>
        internal bool IsSetActionTargets() => this.ActionTargets != null && (this.ActionTargets.Count > 0 || !AWSConfigs.InitializeCollections);
