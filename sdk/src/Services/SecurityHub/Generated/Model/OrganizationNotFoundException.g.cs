...
namespace Amazon.SecurityHub.Model
{
    ...
    [Serializable]
#endif
    public partial class OrganizationNotFoundException : AmazonSecurityHubException
    {
        /// <summary>
        ...
        /// Construct instance of OrganizationNotFoundException
        /// </summary>
        public OrganizationNotFoundException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of OrganizationNotFoundException
        /// </summary>
        public OrganizationNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of OrganizationNotFoundException
        /// </summary>
        public OrganizationNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
