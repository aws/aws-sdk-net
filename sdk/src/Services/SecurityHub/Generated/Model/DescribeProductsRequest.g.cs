...
{
    /// <summary>
    /// Container for the parameters to the DescribeProducts operation. Returns information
    /// about product integrations in Security Hub CSPM. <para> You can optionally provide
    /// an integration ARN. If you provide an integration ARN, then the results only include
    /// that integration. </para> <para> If you don't provide an integration ARN, then the
    /// results include all of the available product integrations. </para>
    /// </summary>
