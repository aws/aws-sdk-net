...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class ResourcesTrendsMetricsResult
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public ResourcesTrendsValues TrendsValues { get; set; }

        /// <summary>
        /// Checks to see if the TrendsValues property is set.
        /// </summary>
        internal bool IsSetTrendsValues() => this.TrendsValues != null;
    }
}
