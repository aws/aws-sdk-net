...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class BatchUpdateStandardsControlAssociationsRequest : AmazonSecurityHubRequest
    {
        ...
        public List<StandardsControlAssociationUpdate> StandardsControlAssociationUpdates { get; set; } = AWSConfigs.InitializeCollections ? new List<StandardsControlAssociationUpdate>() : null;

        /// <summary>
        /// Checks to see if the StandardsControlAssociationUpdates property is set.
        /// </summary>
        internal bool IsSetStandardsControlAssociationUpdates() => this.StandardsControlAssociationUpdates != null && (this.StandardsControlAssociationUpdates.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
