...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class DescribeSecurityHubV2Response : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public Dictionary<string, FeatureDetail> Features { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, FeatureDetail>() : null;
        ...
        /// </para>
        /// </summary>
        public string HubV2Arn { get; set; }

        /// <summary>
        /// Checks to see if the HubV2Arn property is set.
        /// </summary>
        internal bool IsSetHubV2Arn() => this.HubV2Arn != null;
