...
{
    /// <summary>
    /// Container for the parameters to the GetFindingAggregator operation. <note> <para>
    /// The <i>aggregation Region</i> is now called the <i>home Region</i>. </para> </note>
    /// <para> Returns the current configuration in the calling account for cross-Region aggregation.
