...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsWafRegionalRuleDetails
    {
        ...
        /// </summary>
        public List<AwsWafRegionalRulePredicateListDetails> PredicateList { get; set; } = AWSConfigs.InitializeCollections ? new List<AwsWafRegionalRulePredicateListDetails>() : null;

        /// <summary>
        /// Checks to see if the PredicateList property is set.
        /// </summary>
        internal bool IsSetPredicateList() => this.PredicateList != null && (this.PredicateList.Count > 0 || !AWSConfigs.InitializeCollections);
