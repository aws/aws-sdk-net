...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsEventsEndpointRoutingConfigDetails
    {
        ...
        /// </para>
        /// </summary>
        public AwsEventsEndpointRoutingConfigFailoverConfigDetails FailoverConfig { get; set; }

        /// <summary>
        /// Checks to see if the FailoverConfig property is set.
        /// </summary>
        internal bool IsSetFailoverConfig() => this.FailoverConfig != null;
    }
}
