...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class ListConfigurationPolicyAssociationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ConfigurationPolicyAssociationSummary> ConfigurationPolicyAssociationSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ConfigurationPolicyAssociationSummary>() : null;

        /// <summary>
        /// Checks to see if the ConfigurationPolicyAssociationSummaries property is set.
        /// </summary>
        internal bool IsSetConfigurationPolicyAssociationSummaries() => this.ConfigurationPolicyAssociationSummaries != null && (this.ConfigurationPolicyAssociationSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
