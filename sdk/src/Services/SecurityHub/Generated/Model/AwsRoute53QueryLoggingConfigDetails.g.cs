...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsRoute53QueryLoggingConfigDetails
    {
        ...
        /// <para>
        ///  The Amazon Resource Name (ARN) of the Amazon CloudWatch Logs log group that Route
        /// 53 is publishing logs to.
        /// </para>
        /// </summary>
        public CloudWatchLogsLogGroupArnConfigDetails CloudWatchLogsLogGroupArn { get; set; }
