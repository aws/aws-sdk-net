...
{
    /// <summary>
    /// Container for the parameters to the UpdateConfigurationPolicy operation. Updates a
    /// configuration policy. Only the Security Hub CSPM delegated administrator can invoke
