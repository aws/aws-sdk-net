...
{
    /// <summary>
    /// Container for the parameters to the CreateTicketV2 operation. Grants permission to
    /// create a ticket in the chosen ITSM based on finding information for the provided finding
    /// metadata UID.
    /// </summary>
    public partial class CreateTicketV2Request : AmazonSecurityHubRequest
    {
        ...
        /// <summary>
        /// Checks to see if the FindingMetadataUid property is set.
        /// </summary>
        internal bool IsSetFindingMetadataUid() => this.FindingMetadataUid != null;
        ...
        /// </para>
        /// </summary>
        public TicketCreationMode Mode { get; set; }
