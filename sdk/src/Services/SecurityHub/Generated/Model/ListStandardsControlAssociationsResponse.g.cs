...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class ListStandardsControlAssociationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<StandardsControlAssociationSummary> StandardsControlAssociationSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<StandardsControlAssociationSummary>() : null;

        /// <summary>
        /// Checks to see if the StandardsControlAssociationSummaries property is set.
        /// </summary>
        internal bool IsSetStandardsControlAssociationSummaries() => this.StandardsControlAssociationSummaries != null && (this.StandardsControlAssociationSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
