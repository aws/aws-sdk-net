...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class TrendsValues
    {
        ...
        public SeverityTrendsCount SeverityTrends { get; set; }

        /// <summary>
        /// Checks to see if the SeverityTrends property is set.
        /// </summary>
        internal bool IsSetSeverityTrends() => this.SeverityTrends != null;
    }
}
