...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class ResourcesFilters
    {
        ...
        /// </summary>
        public List<ResourcesCompositeFilter> CompositeFilters { get; set; } = AWSConfigs.InitializeCollections ? new List<ResourcesCompositeFilter>() : null;
        ...
        /// </para>
        /// </summary>
        public AllowedOperators CompositeOperator { get; set; }

        /// <summary>
        /// Checks to see if the CompositeOperator property is set.
        /// </summary>
        internal bool IsSetCompositeOperator() => this.CompositeOperator != null;
    }
}
