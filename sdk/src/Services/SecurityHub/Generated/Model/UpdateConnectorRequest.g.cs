...
{
    /// <summary>
    /// Container for the parameters to the UpdateConnector operation. Updates a CSPM connector's
    /// configuration, such as the scope or regions for the connected cloud provider.
    /// </summary>
    public partial class UpdateConnectorRequest : AmazonSecurityHubRequest
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public CspmProviderUpdateConfiguration Provider { get; set; }
