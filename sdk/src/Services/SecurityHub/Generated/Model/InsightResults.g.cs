...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class InsightResults
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<InsightResultValue> ResultValues { get; set; } = AWSConfigs.InitializeCollections ? new List<InsightResultValue>() : null;

        /// <summary>
        /// Checks to see if the ResultValues property is set.
        /// </summary>
        internal bool IsSetResultValues() => this.ResultValues != null && (this.ResultValues.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
