...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsEcsServiceDeploymentConfigurationDetails
    {
        ...
        /// <summary>
        /// Checks to see if the DeploymentCircuitBreaker property is set.
        /// </summary>
        internal bool IsSetDeploymentCircuitBreaker() => this.DeploymentCircuitBreaker != null;
        ...
        /// <summary>
        /// Checks to see if the MaximumPercent property is set.
        /// </summary>
        internal bool IsSetMaximumPercent() => this.MaximumPercent.HasValue;
        ...
        /// </para>
        /// </summary>
        public int? MinimumHealthyPercent { get; set; }

        /// <summary>
        /// Checks to see if the MinimumHealthyPercent property is set.
        /// </summary>
        internal bool IsSetMinimumHealthyPercent() => this.MinimumHealthyPercent.HasValue;
    }
}
