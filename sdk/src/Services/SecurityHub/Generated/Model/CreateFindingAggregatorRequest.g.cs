...
{
    /// <summary>
    /// Container for the parameters to the CreateFindingAggregator operation. <note> <para>
    /// The <i>aggregation Region</i> is now called the <i>home Region</i>. </para> </note>
    /// <para> Used to enable cross-Region aggregation. This operation can be invoked from
    /// the home Region only. </para> <para> For information about how cross-Region aggregation
    /// works, see <a href="https://docs.aws.amazon.com/securityhub/latest/userguide/finding-aggregation.html">Understanding
    ...
    public partial class CreateFindingAggregatorRequest : AmazonSecurityHubRequest
    {
        ...
        /// as Security Hub CSPM supports them and you opt into them.
        /// </para>
        ///  
        /// <para>
