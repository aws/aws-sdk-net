...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsDynamoDbTableProjection
    {
        ...
        /// </summary>
        public List<string> NonKeyAttributes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the NonKeyAttributes property is set.
        /// </summary>
        internal bool IsSetNonKeyAttributes() => this.NonKeyAttributes != null && (this.NonKeyAttributes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the ProjectionType property is set.
        /// </summary>
        internal bool IsSetProjectionType() => this.ProjectionType != null;
    }
}
