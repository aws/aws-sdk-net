...
{
    /// <summary>
    /// Container for the parameters to the CreateConfigurationPolicy operation. Creates a
    /// configuration policy with the defined configuration. Only the Security Hub CSPM delegated
