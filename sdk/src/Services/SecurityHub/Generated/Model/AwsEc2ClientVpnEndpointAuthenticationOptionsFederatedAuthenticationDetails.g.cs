...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails
    {
        ...
        /// <summary>
        /// Checks to see if the SamlProviderArn property is set.
        /// </summary>
        internal bool IsSetSamlProviderArn() => this.SamlProviderArn != null;
        ...
        /// <summary>
        /// Checks to see if the SelfServiceSamlProviderArn property is set.
        /// </summary>
        internal bool IsSetSelfServiceSamlProviderArn() => this.SelfServiceSamlProviderArn != null;
    }
}
