...
namespace Amazon.SecurityHub.Model
{
    ...
    internal sealed partial class ListMembersPaginator : IPaginator<ListMembersResponse>, IListMembersPaginator
    {
        ...
        internal ListMembersPaginator(IAmazonSecurityHub client, ListMembersRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListMembersResponse> IPaginator<ListMembersResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
