...
{
    /// <summary>
    /// Container for the parameters to the DeclineInvitations operation. <note> <para> We
    /// recommend using Organizations instead of Security Hub CSPM invitations to manage your
    ...
    /// <i>Security Hub CSPM User Guide</i>. </para> </note> <para> Declines invitations to
    /// become a Security Hub CSPM member account. </para> <para> A prospective member account
    /// uses this operation to decline an invitation to become a member. </para> <para> Only
    /// member accounts that aren't part of an Amazon Web Services organization should use
    /// this operation. Organization accounts don't receive invitations. </para>
    /// </summary>
