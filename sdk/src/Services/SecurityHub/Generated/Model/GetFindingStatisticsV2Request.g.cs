...
{
    /// <summary>
    /// Container for the parameters to the GetFindingStatisticsV2 operation. Returns aggregated
    /// statistical data about findings. <para> You can use the <c>Scopes</c> parameter to
    /// define the data boundary for the query. Currently, <c>Scopes</c> supports <c>AwsOrganizations</c>,
    /// which lets you aggregate findings from your entire organization or from specific organizational
    ...
    /// the <c>securityhub:GetAdhocInsightResults</c> action. </para>
    /// </summary>
    public partial class GetFindingStatisticsV2Request : AmazonSecurityHubRequest
    {
        ...
        public List<GroupByRule> GroupByRules { get; set; } = AWSConfigs.InitializeCollections ? new List<GroupByRule>() : null;
