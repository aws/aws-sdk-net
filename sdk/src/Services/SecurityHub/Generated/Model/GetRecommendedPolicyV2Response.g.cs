...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class GetRecommendedPolicyV2Response : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<RecommendationStep> RecommendationSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<RecommendationStep>() : null;

        /// <summary>
        /// Checks to see if the RecommendationSteps property is set.
        /// </summary>
        internal bool IsSetRecommendationSteps() => this.RecommendationSteps != null && (this.RecommendationSteps.Count > 0 || !AWSConfigs.InitializeCollections);
