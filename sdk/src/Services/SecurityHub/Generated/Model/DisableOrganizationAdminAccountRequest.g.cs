...
{
    /// <summary>
    /// Container for the parameters to the DisableOrganizationAdminAccount operation. Disables
    /// a Security Hub CSPM administrator account. Can only be called by the organization
    /// management account.
    /// </summary>
    public partial class DisableOrganizationAdminAccountRequest : AmazonSecurityHubRequest
    {
        ...
        /// </para>
        /// </summary>
        public SecurityHubFeature Feature { get; set; }

        /// <summary>
        /// Checks to see if the Feature property is set.
        /// </summary>
        internal bool IsSetFeature() => this.Feature != null;
    }
}
