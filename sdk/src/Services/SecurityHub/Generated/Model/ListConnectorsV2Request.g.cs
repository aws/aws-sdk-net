...
{
    /// <summary>
    /// Container for the parameters to the ListConnectorsV2 operation. Grants permission
    /// to retrieve a list of connectorsV2 and their metadata for the calling account.
    /// </summary>
