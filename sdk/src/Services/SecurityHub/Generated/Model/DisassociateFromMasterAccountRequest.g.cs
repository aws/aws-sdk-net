...
{
    /// <summary>
    /// Container for the parameters to the DisassociateFromMasterAccount operation. This
    /// method is deprecated. Instead, use <c>DisassociateFromAdministratorAccount</c>. <para>
    ...
    /// begins to use <c>DisassociateFromAdministratorAccount</c>. </para> <para> Disassociates
    /// the current Security Hub CSPM member account from the associated administrator account.
    /// </para> <para> This operation is only used by accounts that are not part of an organization.
