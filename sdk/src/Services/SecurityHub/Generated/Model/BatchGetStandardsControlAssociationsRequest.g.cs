...
namespace Amazon.SecurityHub.Model
{
    ...
    /// currently enabled or disabled in a standard. <para> Calls to this operation return
    /// a <c>RESOURCE_NOT_FOUND_EXCEPTION</c> error when the standard subscription for the
    /// association has a <c>NOT_READY_FOR_UPDATES</c> value for <c>StandardsControlsUpdatable</c>.
    /// </para>
    /// </summary>
    public partial class BatchGetStandardsControlAssociationsRequest : AmazonSecurityHubRequest
    {
        ...
        public List<StandardsControlAssociationId> StandardsControlAssociationIds { get; set; } = AWSConfigs.InitializeCollections ? new List<StandardsControlAssociationId>() : null;

        /// <summary>
        /// Checks to see if the StandardsControlAssociationIds property is set.
        /// </summary>
        internal bool IsSetStandardsControlAssociationIds() => this.StandardsControlAssociationIds != null && (this.StandardsControlAssociationIds.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
