...
{
    /// <summary>
    /// Container for the parameters to the UpdateFindingAggregator operation. <note> <para>
    /// The <i>aggregation Region</i> is now called the <i>home Region</i>. </para> </note>
    /// <para> Updates cross-Region aggregation settings. You can use this operation to update
    /// the Region linking mode and the list of included or excluded Amazon Web Services Regions.
    /// However, you can't use this operation to change the home Region. </para> <para> You
    /// can invoke this operation from the current home Region only. </para>
    /// </summary>
