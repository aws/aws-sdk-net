...
namespace Amazon.SecurityHub.Model
{
    ...
    {
        private List<CspmConnectorSummary> _connectors = AWSConfigs.InitializeCollections ? new List<CspmConnectorSummary>() : null;
        ...
        public List<CspmConnectorSummary> Connectors
        {
        ...
        /// <para>
        /// The pagination token to use to request the next page of results. If there are no additional
