...
{
    /// <summary>
    /// Container for the parameters to the GenerateRecommendedPolicyV2 operation. Begins
    /// the recommended policy generation to remediate a Security Hub finding. <c>GenerateRecommendedPolicyV2</c>
