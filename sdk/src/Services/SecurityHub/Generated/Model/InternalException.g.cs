...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class InternalException : AmazonSecurityHubException
    {
        ...
        /// Construct instance of InternalException
        /// </summary>
        public InternalException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InternalException
        /// </summary>
        public InternalException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InternalException
        /// </summary>
        public InternalException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
