...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class BatchGetConfigurationPolicyAssociationsRequest : AmazonSecurityHubRequest
    {
        ...
        public List<ConfigurationPolicyAssociation> ConfigurationPolicyAssociationIdentifiers { get; set; } = AWSConfigs.InitializeCollections ? new List<ConfigurationPolicyAssociation>() : null;

        /// <summary>
        /// Checks to see if the ConfigurationPolicyAssociationIdentifiers property is set.
        /// </summary>
        internal bool IsSetConfigurationPolicyAssociationIdentifiers() => this.ConfigurationPolicyAssociationIdentifiers != null && (this.ConfigurationPolicyAssociationIdentifiers.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
