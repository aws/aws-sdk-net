...
{
    /// <summary>
    /// Response Unmarshaller for CreateConfigurationPolicy operation
    /// </summary>  
    public class CreateConfigurationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConfigurationPolicyResponse response = new CreateConfigurationPolicyResponse();
        ...
        private static CreateConfigurationPolicyResponseUnmarshaller _instance = new CreateConfigurationPolicyResponseUnmarshaller();        

        internal static CreateConfigurationPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigurationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
