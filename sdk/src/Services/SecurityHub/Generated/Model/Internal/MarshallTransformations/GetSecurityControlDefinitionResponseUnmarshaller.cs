...
{
    /// <summary>
    /// Response Unmarshaller for GetSecurityControlDefinition operation
    /// </summary>  
    public class GetSecurityControlDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSecurityControlDefinitionResponse response = new GetSecurityControlDefinitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SecurityControlDefinition", targetDepth))
                {
                    ...
                    response.SecurityControlDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSecurityControlDefinitionResponseUnmarshaller _instance = new GetSecurityControlDefinitionResponseUnmarshaller();        

        internal static GetSecurityControlDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecurityControlDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
