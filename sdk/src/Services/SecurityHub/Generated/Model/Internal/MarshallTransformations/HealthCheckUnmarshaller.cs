        ...
        public HealthCheck Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ConnectorStatus", targetDepth))
                {
                    ...
                    unmarshalledObject.ConnectorStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LastCheckedAt", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.LastCheckedAt = unmarshaller.Unmarshall(context);
                    continue;
                }
