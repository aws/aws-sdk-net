...
{
    /// <summary>
    /// Response Unmarshaller for CreateFindingAggregator operation
    /// </summary>  
    public class CreateFindingAggregatorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFindingAggregatorResponse response = new CreateFindingAggregatorResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FindingAggregationRegion", targetDepth, ref reader))
                {
                    ...
                    response.FindingAggregationRegion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("FindingAggregatorArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FindingAggregatorArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RegionLinkingMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegionLinkingMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateFindingAggregatorResponseUnmarshaller _instance = new CreateFindingAggregatorResponseUnmarshaller();        

        internal static CreateFindingAggregatorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFindingAggregatorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
