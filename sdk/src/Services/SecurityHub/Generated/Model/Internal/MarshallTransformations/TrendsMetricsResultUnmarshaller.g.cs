...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TrendsMetricsResultUnmarshaller : IJsonUnmarshaller<TrendsMetricsResult, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TrendsMetricsResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TrendsMetricsResult();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TrendsMetricsResultUnmarshaller Instance => _instance;
    }
}
