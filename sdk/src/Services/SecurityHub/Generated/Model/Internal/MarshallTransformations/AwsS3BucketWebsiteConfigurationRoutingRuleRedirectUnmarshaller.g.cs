...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsS3BucketWebsiteConfigurationRoutingRuleRedirectUnmarshaller : IJsonUnmarshaller<AwsS3BucketWebsiteConfigurationRoutingRuleRedirect, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsS3BucketWebsiteConfigurationRoutingRuleRedirect();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HttpRedirectCode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ReplaceKeyPrefixWith", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ReplaceKeyWith", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsS3BucketWebsiteConfigurationRoutingRuleRedirectUnmarshaller Instance => _instance;
    }
}
