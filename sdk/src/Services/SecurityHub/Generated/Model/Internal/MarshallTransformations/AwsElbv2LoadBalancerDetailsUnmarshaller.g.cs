...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsElbv2LoadBalancerDetailsUnmarshaller : IJsonUnmarshaller<AwsElbv2LoadBalancerDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsElbv2LoadBalancerDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CanonicalHostedZoneId", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsElbv2LoadBalancerDetailsUnmarshaller Instance => _instance;
    }
}
