...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsElbLoadBalancerAttributesUnmarshaller : IJsonUnmarshaller<AwsElbLoadBalancerAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsElbLoadBalancerAttributes();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ConnectionDraining", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ConnectionSettings", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("CrossZoneLoadBalancing", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsElbLoadBalancerAttributesUnmarshaller Instance => _instance;
    }
}
