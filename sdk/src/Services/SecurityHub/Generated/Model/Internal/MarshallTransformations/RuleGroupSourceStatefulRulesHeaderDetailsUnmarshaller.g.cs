...
{
    /// <summary>
    /// Response Unmarshaller for RuleGroupSourceStatefulRulesHeaderDetails Object
    /// </summary>
    public partial class RuleGroupSourceStatefulRulesHeaderDetailsUnmarshaller : IJsonUnmarshaller<RuleGroupSourceStatefulRulesHeaderDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RuleGroupSourceStatefulRulesHeaderDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RuleGroupSourceStatefulRulesHeaderDetails();
        ...
        private static RuleGroupSourceStatefulRulesHeaderDetailsUnmarshaller _instance = new RuleGroupSourceStatefulRulesHeaderDetailsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RuleGroupSourceStatefulRulesHeaderDetailsUnmarshaller Instance => _instance;
    }
}
