...
{
    /// <summary>
    /// Response Unmarshaller for RuleGroupSource Object
    /// </summary>
    public partial class RuleGroupSourceUnmarshaller : IJsonUnmarshaller<RuleGroupSource, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RuleGroupSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RuleGroupSource();
        ...
        private static RuleGroupSourceUnmarshaller _instance = new RuleGroupSourceUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RuleGroupSourceUnmarshaller Instance => _instance;
    }
}
