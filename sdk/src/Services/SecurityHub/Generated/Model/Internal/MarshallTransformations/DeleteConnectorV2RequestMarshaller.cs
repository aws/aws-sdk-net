...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteConnectorV2RequestMarshaller : IMarshaller<IRequest, DeleteConnectorV2Request> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteConnectorV2RequestMarshaller _instance = new DeleteConnectorV2RequestMarshaller();        

        internal static DeleteConnectorV2RequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConnectorV2RequestMarshaller Instance
        {
            get
            {
                return _instance;
