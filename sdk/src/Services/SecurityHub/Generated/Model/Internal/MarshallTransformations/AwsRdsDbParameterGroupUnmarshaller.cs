...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsRdsDbParameterGroupUnmarshaller : IJsonUnmarshaller<AwsRdsDbParameterGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsRdsDbParameterGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("DbParameterGroupName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DbParameterGroupName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
