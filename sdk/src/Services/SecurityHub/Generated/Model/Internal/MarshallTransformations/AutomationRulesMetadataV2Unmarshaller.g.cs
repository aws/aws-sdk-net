...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutomationRulesMetadataV2Unmarshaller : IJsonUnmarshaller<AutomationRulesMetadataV2, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AutomationRulesMetadataV2 Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AutomationRulesMetadataV2();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationRulesActionTypeObjectV2, AutomationRulesActionTypeObjectV2Unmarshaller>(AutomationRulesActionTypeObjectV2Unmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutomationRulesMetadataV2Unmarshaller Instance => _instance;
    }
}
