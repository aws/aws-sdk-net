...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsUnmarshaller : IJsonUnmarshaller<AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails();
            ...
            {
                if (context.TestExpression("Autoprovision", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Driver", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("DriverOpts", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsUnmarshaller Instance => _instance;
    }
}
