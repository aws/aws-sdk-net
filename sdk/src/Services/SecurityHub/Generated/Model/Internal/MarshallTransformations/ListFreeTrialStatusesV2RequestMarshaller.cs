...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListFreeTrialStatusesV2RequestMarshaller : IMarshaller<IRequest, ListFreeTrialStatusesV2Request> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListFreeTrialStatusesV2RequestMarshaller _instance = new ListFreeTrialStatusesV2RequestMarshaller();        

        internal static ListFreeTrialStatusesV2RequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFreeTrialStatusesV2RequestMarshaller Instance
        {
            get
            {
                return _instance;
