...
{
    /// <summary>
    /// Response Unmarshaller for StartConfigurationPolicyDisassociation operation
    /// </summary>  
    public class StartConfigurationPolicyDisassociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartConfigurationPolicyDisassociationResponse response = new StartConfigurationPolicyDisassociationResponse();
        ...
        private static StartConfigurationPolicyDisassociationResponseUnmarshaller _instance = new StartConfigurationPolicyDisassociationResponseUnmarshaller();        

        internal static StartConfigurationPolicyDisassociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartConfigurationPolicyDisassociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
