...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeHubResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AutoEnableControls", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AutoEnableControls = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ControlFindingGenerator", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ControlFindingGenerator = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeHubResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeHubResponseUnmarshaller Instance => _instance;
    }
}
