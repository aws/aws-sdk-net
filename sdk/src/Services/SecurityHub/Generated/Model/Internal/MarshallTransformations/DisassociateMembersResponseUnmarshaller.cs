...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisassociateMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateMembersResponse response = new DisassociateMembersResponse();
        ...
        internal static DisassociateMembersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateMembersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
