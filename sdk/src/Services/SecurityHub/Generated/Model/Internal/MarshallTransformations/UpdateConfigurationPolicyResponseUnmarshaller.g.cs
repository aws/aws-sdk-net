...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationPolicy operation.
    /// </summary>
    public partial class UpdateConfigurationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateConfigurationPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ConfigurationPolicy", targetDepth, ref reader))
                {
                    var unmarshaller = PolicyUnmarshaller.Instance;
                    unmarshalledObject.ConfigurationPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateConfigurationPolicyResponseUnmarshaller _instance = new UpdateConfigurationPolicyResponseUnmarshaller();

        internal static UpdateConfigurationPolicyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateConfigurationPolicyResponseUnmarshaller Instance => _instance;
    }
}
