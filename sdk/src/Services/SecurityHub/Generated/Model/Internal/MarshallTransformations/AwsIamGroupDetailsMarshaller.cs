...
{
    /// <summary>
    /// AwsIamGroupDetails Marshaller
    /// </summary>
    public class AwsIamGroupDetailsMarshaller : IRequestMarshaller<AwsIamGroupDetails, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AwsIamGroupDetails requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetGroupPolicyList())
            {
                context.Writer.WritePropertyName("GroupPolicyList");
                context.Writer.WriteStartArray();
                foreach(var requestObjectGroupPolicyListListValue in requestObject.GroupPolicyList)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = AwsIamGroupPolicyMarshaller.Instance;
                    marshaller.Marshall(requestObjectGroupPolicyListListValue, context);
        ...
        /// </summary>
        public readonly static AwsIamGroupDetailsMarshaller Instance = new AwsIamGroupDetailsMarshaller();
