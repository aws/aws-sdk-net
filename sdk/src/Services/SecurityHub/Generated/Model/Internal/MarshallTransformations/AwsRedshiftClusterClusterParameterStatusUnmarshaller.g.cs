...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsRedshiftClusterClusterParameterStatusUnmarshaller : IJsonUnmarshaller<AwsRedshiftClusterClusterParameterStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsRedshiftClusterClusterParameterStatus();
            ...
            {
                if (context.TestExpression("ParameterApplyErrorDescription", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsRedshiftClusterClusterParameterStatusUnmarshaller Instance => _instance;
    }
}
