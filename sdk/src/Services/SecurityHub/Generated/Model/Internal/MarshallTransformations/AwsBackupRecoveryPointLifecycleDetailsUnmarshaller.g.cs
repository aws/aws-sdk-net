...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsBackupRecoveryPointLifecycleDetailsUnmarshaller : IJsonUnmarshaller<AwsBackupRecoveryPointLifecycleDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AwsBackupRecoveryPointLifecycleDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AwsBackupRecoveryPointLifecycleDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsBackupRecoveryPointLifecycleDetailsUnmarshaller Instance => _instance;
    }
}
