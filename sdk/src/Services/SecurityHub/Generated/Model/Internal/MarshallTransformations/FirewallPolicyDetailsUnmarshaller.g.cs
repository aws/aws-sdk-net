...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FirewallPolicyDetailsUnmarshaller : IJsonUnmarshaller<FirewallPolicyDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public FirewallPolicyDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new FirewallPolicyDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FirewallPolicyDetailsUnmarshaller Instance => _instance;
    }
}
