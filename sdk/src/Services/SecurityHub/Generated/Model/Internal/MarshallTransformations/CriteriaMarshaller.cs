    ...
    public class CriteriaMarshaller : IRequestMarshaller<Criteria, JsonMarshallerContext> 
    {
        ...
        public void Marshall(Criteria requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetOcsfFindingCriteria())
            {
                context.Writer.WritePropertyName("OcsfFindingCriteria");
                context.Writer.WriteStartObject();

                var marshaller = OcsfFindingFiltersMarshaller.Instance;
                marshaller.Marshall(requestObject.OcsfFindingCriteria, context);
