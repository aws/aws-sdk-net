...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateMembersRequestMarshaller : IMarshaller<IRequest, DisassociateMembersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DisassociateMembersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/members/disassociate";
#if !NETFRAMEWORK
        ...
        private static readonly DisassociateMembersRequestMarshaller _instance = new();

        internal static DisassociateMembersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateMembersRequestMarshaller Instance => _instance;
    }
}
