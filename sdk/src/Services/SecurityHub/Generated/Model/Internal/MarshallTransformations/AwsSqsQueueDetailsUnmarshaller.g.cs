...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsSqsQueueDetailsUnmarshaller : IJsonUnmarshaller<AwsSqsQueueDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsSqsQueueDetails();
            ...
            {
                if (context.TestExpression("DeadLetterTargetArn", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsSqsQueueDetailsUnmarshaller Instance => _instance;
    }
}
