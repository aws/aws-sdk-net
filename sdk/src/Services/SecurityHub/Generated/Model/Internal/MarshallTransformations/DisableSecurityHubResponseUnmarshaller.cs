...
{
    /// <summary>
    /// Response Unmarshaller for DisableSecurityHub operation
    /// </summary>  
    public class DisableSecurityHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableSecurityHubResponse response = new DisableSecurityHubResponse();
        ...
        private static DisableSecurityHubResponseUnmarshaller _instance = new DisableSecurityHubResponseUnmarshaller();        

        internal static DisableSecurityHubResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableSecurityHubResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
