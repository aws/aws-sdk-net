...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsRoute53HostedZoneDetailsUnmarshaller : IJsonUnmarshaller<AwsRoute53HostedZoneDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsRoute53HostedZoneDetailsUnmarshaller _instance = new AwsRoute53HostedZoneDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsRoute53HostedZoneDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
