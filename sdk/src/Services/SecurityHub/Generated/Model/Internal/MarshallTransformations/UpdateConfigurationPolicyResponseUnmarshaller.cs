...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateConfigurationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationPolicyResponse response = new UpdateConfigurationPolicyResponse();
        ...
        internal static UpdateConfigurationPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
