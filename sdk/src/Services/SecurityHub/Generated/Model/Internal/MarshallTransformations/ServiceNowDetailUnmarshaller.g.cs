...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ServiceNowDetailUnmarshaller : IJsonUnmarshaller<ServiceNowDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ServiceNowDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ServiceNowDetail();
            ...
            {
                if (context.TestExpression("AuthStatus", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ServiceNowDetailUnmarshaller Instance => _instance;
    }
}
