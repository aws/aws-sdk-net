...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsEc2InstanceDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2InstanceDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsEc2InstanceDetails();
            ...
            {
                if (context.TestExpression("IamInstanceProfileArn", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("VirtualizationType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsEc2InstanceDetailsUnmarshaller Instance => _instance;
    }
}
