...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LoadBalancerStateUnmarshaller : IJsonUnmarshaller<LoadBalancerState, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public LoadBalancerState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new LoadBalancerState();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LoadBalancerStateUnmarshaller Instance => _instance;
    }
}
