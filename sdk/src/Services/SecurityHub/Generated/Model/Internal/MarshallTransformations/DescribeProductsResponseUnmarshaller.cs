...
{
    /// <summary>
    /// Response Unmarshaller for DescribeProducts operation
    /// </summary>  
    public class DescribeProductsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Product, ProductUnmarshaller>(ProductUnmarshaller.Instance);
                    response.Products = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeProductsResponseUnmarshaller _instance = new DescribeProductsResponseUnmarshaller();        

        internal static DescribeProductsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProductsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
