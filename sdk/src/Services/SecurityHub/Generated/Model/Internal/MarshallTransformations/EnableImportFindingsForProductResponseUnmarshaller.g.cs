...
{
    /// <summary>
    /// Response Unmarshaller for EnableImportFindingsForProduct operation.
    /// </summary>
    public partial class EnableImportFindingsForProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EnableImportFindingsForProductResponse();
            ...
            {
                if (context.TestExpression("ProductSubscriptionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProductSubscriptionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static EnableImportFindingsForProductResponseUnmarshaller _instance = new EnableImportFindingsForProductResponseUnmarshaller();

        internal static EnableImportFindingsForProductResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static EnableImportFindingsForProductResponseUnmarshaller Instance => _instance;
    }
}
