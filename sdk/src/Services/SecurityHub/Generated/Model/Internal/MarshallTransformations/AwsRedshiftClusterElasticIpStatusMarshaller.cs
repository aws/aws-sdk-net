...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsRedshiftClusterElasticIpStatusMarshaller : IRequestMarshaller<AwsRedshiftClusterElasticIpStatus, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AwsRedshiftClusterElasticIpStatus requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetElasticIp())
            {
                context.Writer.WritePropertyName("ElasticIp");
                context.Writer.WriteStringValue(requestObject.ElasticIp);
            }
