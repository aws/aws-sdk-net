...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsEfsAccessPointPosixUserDetailsUnmarshaller : IUnmarshaller<AwsEfsAccessPointPosixUserDetails, XmlUnmarshallerContext>, IUnmarshaller<AwsEfsAccessPointPosixUserDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AwsEfsAccessPointPosixUserDetails IUnmarshaller<AwsEfsAccessPointPosixUserDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AwsEfsAccessPointPosixUserDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SecondaryGids", targetDepth))
                {
                    ...
                    unmarshalledObject.SecondaryGids = unmarshaller.Unmarshall(context);
                    continue;
                }
