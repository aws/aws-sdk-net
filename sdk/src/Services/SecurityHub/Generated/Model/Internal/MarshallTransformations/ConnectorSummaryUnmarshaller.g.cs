...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectorSummaryUnmarshaller : IJsonUnmarshaller<ConnectorSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ConnectorSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EnablementStatusReason = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ProviderSummary", targetDepth, ref reader))
                {
                    var unmarshaller = ProviderSummaryUnmarshaller.Instance;
                    unmarshalledObject.ProviderSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConnectorSummaryUnmarshaller Instance => _instance;
    }
}
