...
{
    /// <summary>
    /// Response Unmarshaller for GetConnectorV2 operation
    /// </summary>  
    public class GetConnectorV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConnectorV2Response response = new GetConnectorV2Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Health", targetDepth))
                {
                    ...
                    response.Health = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ProviderDetail", targetDepth))
                {
                    var unmarshaller = ProviderDetailUnmarshaller.Instance;
                    response.ProviderDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetConnectorV2ResponseUnmarshaller _instance = new GetConnectorV2ResponseUnmarshaller();        

        internal static GetConnectorV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectorV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
