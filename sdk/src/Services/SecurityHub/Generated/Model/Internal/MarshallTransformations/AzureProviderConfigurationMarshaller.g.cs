...
{
    /// <summary>
    /// AzureProviderConfiguration Marshaller
    /// </summary>
    public partial class AzureProviderConfigurationMarshaller : IRequestMarshaller<AzureProviderConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(AzureProviderConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetScopeConfiguration())
            {
                ...
                var marshaller = AzureScopeConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AzureProviderConfigurationMarshaller Instance = new AzureProviderConfigurationMarshaller();
    }
}
