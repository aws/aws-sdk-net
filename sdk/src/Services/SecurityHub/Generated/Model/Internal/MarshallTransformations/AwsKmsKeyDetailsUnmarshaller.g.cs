...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsKmsKeyDetailsUnmarshaller : IJsonUnmarshaller<AwsKmsKeyDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsKmsKeyDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("KeyManager", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("KeyRotationStatus", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsKmsKeyDetailsUnmarshaller Instance => _instance;
    }
}
