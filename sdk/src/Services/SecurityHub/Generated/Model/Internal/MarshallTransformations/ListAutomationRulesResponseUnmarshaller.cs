...
{
    /// <summary>
    /// Response Unmarshaller for ListAutomationRules operation
    /// </summary>  
    public class ListAutomationRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAutomationRulesResponse response = new ListAutomationRulesResponse();
            ...
            {
                if (context.TestExpression("AutomationRulesMetadata", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationRulesMetadata, AutomationRulesMetadataUnmarshaller>(AutomationRulesMetadataUnmarshaller.Instance);
                    response.AutomationRulesMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAutomationRulesResponseUnmarshaller _instance = new ListAutomationRulesResponseUnmarshaller();        

        internal static ListAutomationRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
