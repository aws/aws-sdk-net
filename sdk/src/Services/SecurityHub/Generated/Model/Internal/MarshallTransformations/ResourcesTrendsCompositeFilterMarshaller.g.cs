...
{
    /// <summary>
    /// ResourcesTrendsCompositeFilter Marshaller
    /// </summary>
    public partial class ResourcesTrendsCompositeFilterMarshaller : IRequestMarshaller<ResourcesTrendsCompositeFilter, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(ResourcesTrendsCompositeFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetNestedCompositeFilters())
            {
                ...
                foreach (var requestObjectNestedCompositeFiltersListValue in requestObject.NestedCompositeFilters)
                {
                    ...
                    var marshaller = ResourcesTrendsCompositeFilterMarshaller.Instance;
            ...
            if (requestObject.IsSetStringFilters())
            {
                ...
                foreach (var requestObjectStringFiltersListValue in requestObject.StringFilters)
                {
                    ...
                    var marshaller = ResourcesTrendsStringFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static ResourcesTrendsCompositeFilterMarshaller Instance = new ResourcesTrendsCompositeFilterMarshaller();
    }
}
