...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSecurityControl operation
    /// </summary>  
    public class UpdateSecurityControlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSecurityControlResponse response = new UpdateSecurityControlResponse();
        ...
        private static UpdateSecurityControlResponseUnmarshaller _instance = new UpdateSecurityControlResponseUnmarshaller();        

        internal static UpdateSecurityControlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSecurityControlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
