...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProductV2Unmarshaller : IUnmarshaller<ProductV2, XmlUnmarshallerContext>, IUnmarshaller<ProductV2, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProductV2 IUnmarshaller<ProductV2, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProductV2 Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.IntegrationV2Types = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("MarketplaceProductId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MarketplaceProductId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProductV2Name = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
