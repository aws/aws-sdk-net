...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodeRepositoryDetailsMarshaller : IRequestMarshaller<CodeRepositoryDetails, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(CodeRepositoryDetails requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetCodeSecurityIntegrationArn())
            {
                ...
                context.Writer.WriteStringValue(requestObject.CodeSecurityIntegrationArn);
            }

            if (requestObject.IsSetProjectName())
            {
                context.Writer.WritePropertyName("ProjectName");
                context.Writer.WriteStringValue(requestObject.ProjectName);
            }

            if (requestObject.IsSetProviderType())
            {
                context.Writer.WritePropertyName("ProviderType");
                context.Writer.WriteStringValue(requestObject.ProviderType);
            }
        }
