...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ParameterValueUnmarshaller : IJsonUnmarshaller<ParameterValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ParameterValue();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Enum", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ParameterValueUnmarshaller Instance => _instance;
    }
}
