...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsLambdaFunctionEnvironmentErrorMarshaller : IRequestMarshaller<AwsLambdaFunctionEnvironmentError, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AwsLambdaFunctionEnvironmentError requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetErrorCode())
            {
                context.Writer.WritePropertyName("ErrorCode");
                context.Writer.WriteStringValue(requestObject.ErrorCode);
            }
