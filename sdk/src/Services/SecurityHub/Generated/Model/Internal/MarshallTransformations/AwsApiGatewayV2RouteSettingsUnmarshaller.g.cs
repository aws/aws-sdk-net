...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsApiGatewayV2RouteSettingsUnmarshaller : IJsonUnmarshaller<AwsApiGatewayV2RouteSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsApiGatewayV2RouteSettings();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DetailedMetricsEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsApiGatewayV2RouteSettingsUnmarshaller Instance => _instance;
    }
}
