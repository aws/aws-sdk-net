...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsRdsDbClusterSnapshotDetailsUnmarshaller : IJsonUnmarshaller<AwsRdsDbClusterSnapshotDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsRdsDbClusterSnapshotDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DbClusterSnapshotAttributes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("DbClusterSnapshotIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsRdsDbClusterSnapshotDetailsUnmarshaller Instance => _instance;
    }
}
