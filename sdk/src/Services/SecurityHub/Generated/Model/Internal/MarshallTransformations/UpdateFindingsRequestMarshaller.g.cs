...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateFindingsRequestMarshaller : IMarshaller<IRequest, UpdateFindingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateFindingsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetRecordState())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.RecordState);
            }
        ...
        private static readonly UpdateFindingsRequestMarshaller _instance = new();

        internal static UpdateFindingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateFindingsRequestMarshaller Instance => _instance;
    }
}
