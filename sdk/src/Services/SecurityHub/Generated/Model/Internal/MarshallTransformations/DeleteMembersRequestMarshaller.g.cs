...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteMembersRequestMarshaller : IMarshaller<IRequest, DeleteMembersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteMembersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/members/delete";
#if !NETFRAMEWORK
        ...
        private static readonly DeleteMembersRequestMarshaller _instance = new();

        internal static DeleteMembersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteMembersRequestMarshaller Instance => _instance;
    }
}
