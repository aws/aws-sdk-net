    ...
    public class GetAutomationRuleV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AutomationRulesActionV2, AutomationRulesActionV2Unmarshaller>(AutomationRulesActionV2Unmarshaller.Instance);
                ...
                if (context.TestExpression("RuleOrder", targetDepth))
                {
                    ...
                    response.RuleOrder = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RuleStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RuleStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
