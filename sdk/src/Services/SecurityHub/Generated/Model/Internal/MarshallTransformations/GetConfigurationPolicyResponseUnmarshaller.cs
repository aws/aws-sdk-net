...
{
    /// <summary>
    /// Response Unmarshaller for GetConfigurationPolicy operation
    /// </summary>  
    public class GetConfigurationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConfigurationPolicyResponse response = new GetConfigurationPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ConfigurationPolicy", targetDepth, ref reader))
                {
                    ...
                    response.ConfigurationPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetConfigurationPolicyResponseUnmarshaller _instance = new GetConfigurationPolicyResponseUnmarshaller();        

        internal static GetConfigurationPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfigurationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
