...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeStandardsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeStandardsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Standards", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Standard, StandardUnmarshaller>(StandardUnmarshaller.Instance);
                    unmarshalledObject.Standards = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeStandardsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeStandardsResponseUnmarshaller Instance => _instance;
    }
}
