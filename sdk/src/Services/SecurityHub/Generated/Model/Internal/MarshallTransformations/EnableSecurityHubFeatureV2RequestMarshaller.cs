...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class EnableSecurityHubFeatureV2RequestMarshaller : IMarshaller<IRequest, EnableSecurityHubFeatureV2Request> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static EnableSecurityHubFeatureV2RequestMarshaller _instance = new EnableSecurityHubFeatureV2RequestMarshaller();        

        internal static EnableSecurityHubFeatureV2RequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableSecurityHubFeatureV2RequestMarshaller Instance
        {
            get
            {
                return _instance;
