...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetInsightResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetInsightResultsResponse();
            ...
            {
                if (context.TestExpression("InsightResults", targetDepth, ref reader))
                {
                    var unmarshaller = InsightResultsUnmarshaller.Instance;
                    unmarshalledObject.InsightResults = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetInsightResultsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInsightResultsResponseUnmarshaller Instance => _instance;
    }
}
