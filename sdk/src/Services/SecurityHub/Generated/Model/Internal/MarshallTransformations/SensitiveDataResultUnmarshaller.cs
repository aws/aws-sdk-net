...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SensitiveDataResultUnmarshaller : IUnmarshaller<SensitiveDataResult, XmlUnmarshallerContext>, IUnmarshaller<SensitiveDataResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SensitiveDataResult IUnmarshaller<SensitiveDataResult, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SensitiveDataResult Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SensitiveDataDetections, SensitiveDataDetectionsUnmarshaller>(SensitiveDataDetectionsUnmarshaller.Instance);
