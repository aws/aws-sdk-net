...
{
    /// <summary>
    /// Response Unmarshaller for GetAdministratorAccount operation.
    /// </summary>
    public partial class GetAdministratorAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAdministratorAccountResponse();
            ...
            {
                if (context.TestExpression("Administrator", targetDepth, ref reader))
                {
                    var unmarshaller = InvitationUnmarshaller.Instance;
                    unmarshalledObject.Administrator = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetAdministratorAccountResponseUnmarshaller _instance = new GetAdministratorAccountResponseUnmarshaller();

        internal static GetAdministratorAccountResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAdministratorAccountResponseUnmarshaller Instance => _instance;
    }
}
