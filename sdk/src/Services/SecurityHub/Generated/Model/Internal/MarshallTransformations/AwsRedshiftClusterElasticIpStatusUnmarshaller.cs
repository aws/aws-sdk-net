...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsRedshiftClusterElasticIpStatusUnmarshaller : IJsonUnmarshaller<AwsRedshiftClusterElasticIpStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsRedshiftClusterElasticIpStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ElasticIp", targetDepth, ref reader))
                {
