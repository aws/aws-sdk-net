...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsCodeBuildProjectEnvironmentUnmarshaller : IUnmarshaller<AwsCodeBuildProjectEnvironment, XmlUnmarshallerContext>, IUnmarshaller<AwsCodeBuildProjectEnvironment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AwsCodeBuildProjectEnvironment IUnmarshaller<AwsCodeBuildProjectEnvironment, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AwsCodeBuildProjectEnvironment Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
