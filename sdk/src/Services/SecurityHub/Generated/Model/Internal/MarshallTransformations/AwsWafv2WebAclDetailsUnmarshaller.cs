...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsWafv2WebAclDetailsUnmarshaller : IJsonUnmarshaller<AwsWafv2WebAclDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsWafv2WebAclDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AwsWafv2RulesDetails, AwsWafv2RulesDetailsUnmarshaller>(AwsWafv2RulesDetailsUnmarshaller.Instance);
