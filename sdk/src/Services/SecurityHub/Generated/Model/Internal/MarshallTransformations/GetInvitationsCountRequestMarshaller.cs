...
{
    /// <summary>
    /// GetInvitationsCount Request Marshaller
    /// </summary>       
    public class GetInvitationsCountRequestMarshaller : IMarshaller<IRequest, GetInvitationsCountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetInvitationsCountRequest)input);
        }
        ...
        public IRequest Marshall(GetInvitationsCountRequest publicRequest)
        {
            ...
            string uriResourcePath = "/invitations/count";
