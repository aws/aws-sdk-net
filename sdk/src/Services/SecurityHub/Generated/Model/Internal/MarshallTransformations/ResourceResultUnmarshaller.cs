    ...
    public class ResourceResultUnmarshaller : IUnmarshaller<ResourceResult, XmlUnmarshallerContext>, IUnmarshaller<ResourceResult, JsonUnmarshallerContext>
    {
        ...
        public ResourceResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceFindingsSummary, ResourceFindingsSummaryUnmarshaller>(ResourceFindingsSummaryUnmarshaller.Instance);
                    unmarshalledObject.FindingsSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceCategory = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceCreationTimeDt = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ResourceDetailCaptureTimeDt", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceDetailCaptureTimeDt = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ResourceGuid", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceGuid = unmarshaller.Unmarshall(context);
                    continue;
                }
