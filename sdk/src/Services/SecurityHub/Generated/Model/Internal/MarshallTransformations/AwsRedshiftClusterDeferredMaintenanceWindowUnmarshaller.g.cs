...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsRedshiftClusterDeferredMaintenanceWindowUnmarshaller : IJsonUnmarshaller<AwsRedshiftClusterDeferredMaintenanceWindow, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsRedshiftClusterDeferredMaintenanceWindow();
            ...
            {
                if (context.TestExpression("DeferMaintenanceEndTime", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("DeferMaintenanceIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("DeferMaintenanceStartTime", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsRedshiftClusterDeferredMaintenanceWindowUnmarshaller Instance => _instance;
    }
}
