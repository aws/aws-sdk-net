...
{
    /// <summary>
    /// FindingsTrendsCompositeFilter Marshaller
    /// </summary>
    public class FindingsTrendsCompositeFilterMarshaller : IRequestMarshaller<FindingsTrendsCompositeFilter, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(FindingsTrendsCompositeFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetStringFilters())
            {
                ...
                foreach(var requestObjectStringFiltersListValue in requestObject.StringFilters)
                {
                    ...
                    var marshaller = FindingsTrendsStringFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static FindingsTrendsCompositeFilterMarshaller Instance = new FindingsTrendsCompositeFilterMarshaller();
