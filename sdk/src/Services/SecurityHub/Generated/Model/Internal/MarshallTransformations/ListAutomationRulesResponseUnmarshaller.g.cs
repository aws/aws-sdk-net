...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAutomationRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAutomationRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AutomationRulesMetadata", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AutomationRulesMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAutomationRulesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAutomationRulesResponseUnmarshaller Instance => _instance;
    }
}
