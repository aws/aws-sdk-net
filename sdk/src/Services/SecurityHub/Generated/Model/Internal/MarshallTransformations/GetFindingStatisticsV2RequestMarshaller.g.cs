...
{
    /// <summary>
    /// GetFindingStatisticsV2 Request Marshaller
    /// </summary>
    public partial class GetFindingStatisticsV2RequestMarshaller : IMarshaller<IRequest, GetFindingStatisticsV2Request>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFindingStatisticsV2Request)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetFindingStatisticsV2Request publicRequest)
        {
            ...
            request.ResourcePath = "/findingsv2/statistics";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetGroupByRules())
            {
                ...
                foreach (var publicRequestGroupByRulesListValue in publicRequest.GroupByRules)
                {
                    ...
                    var marshaller = GroupByRuleMarshaller.Instance;
        ...
        private static readonly GetFindingStatisticsV2RequestMarshaller _instance = new();

        internal static GetFindingStatisticsV2RequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetFindingStatisticsV2RequestMarshaller Instance => _instance;
    }
}
