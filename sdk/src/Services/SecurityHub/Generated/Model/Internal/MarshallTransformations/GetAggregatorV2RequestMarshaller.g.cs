...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAggregatorV2RequestMarshaller : IMarshaller<IRequest, GetAggregatorV2Request>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAggregatorV2RequestMarshaller _instance = new();

        internal static GetAggregatorV2RequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAggregatorV2RequestMarshaller Instance => _instance;
    }
}
