...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AvailabilityZoneUnmarshaller : IJsonUnmarshaller<AvailabilityZone, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AvailabilityZone Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ZoneName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ZoneName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
