...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAggregatorV2RequestMarshaller : IMarshaller<IRequest, DeleteAggregatorV2Request>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAggregatorV2RequestMarshaller _instance = new();

        internal static DeleteAggregatorV2RequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAggregatorV2RequestMarshaller Instance => _instance;
    }
}
