...
{
    /// <summary>
    /// Response Unmarshaller for GetInvitationsCount operation.
    /// </summary>
    public partial class GetInvitationsCountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetInvitationsCountResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InvitationsCount", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.InvitationsCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetInvitationsCountResponseUnmarshaller _instance = new GetInvitationsCountResponseUnmarshaller();

        internal static GetInvitationsCountResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInvitationsCountResponseUnmarshaller Instance => _instance;
    }
}
