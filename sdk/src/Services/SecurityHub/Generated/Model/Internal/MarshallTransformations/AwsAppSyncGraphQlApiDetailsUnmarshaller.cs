...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsAppSyncGraphQlApiDetailsUnmarshaller : IJsonUnmarshaller<AwsAppSyncGraphQlApiDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsAppSyncGraphQlApiDetailsUnmarshaller _instance = new AwsAppSyncGraphQlApiDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsAppSyncGraphQlApiDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
