...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsLambdaFunctionEnvironmentUnmarshaller : IJsonUnmarshaller<AwsLambdaFunctionEnvironment, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AwsLambdaFunctionEnvironment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AwsLambdaFunctionEnvironment();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsLambdaFunctionEnvironmentUnmarshaller Instance => _instance;
    }
}
