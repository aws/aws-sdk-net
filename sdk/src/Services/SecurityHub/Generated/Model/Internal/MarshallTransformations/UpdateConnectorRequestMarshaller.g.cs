...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateConnectorRequestMarshaller : IMarshaller<IRequest, UpdateConnectorRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateConnectorRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetProvider())
            {
                ...
                var marshaller = CspmProviderUpdateConfigurationMarshaller.Instance;
        ...
        private static readonly UpdateConnectorRequestMarshaller _instance = new();

        internal static UpdateConnectorRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateConnectorRequestMarshaller Instance => _instance;
    }
}
