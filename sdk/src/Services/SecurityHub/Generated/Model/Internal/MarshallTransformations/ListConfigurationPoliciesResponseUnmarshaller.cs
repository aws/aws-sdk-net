...
{
    /// <summary>
    /// Response Unmarshaller for ListConfigurationPolicies operation
    /// </summary>  
    public class ListConfigurationPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListConfigurationPoliciesResponse response = new ListConfigurationPoliciesResponse();
            ...
            {
                if (context.TestExpression("ConfigurationPolicySummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ConfigurationPolicySummary, ConfigurationPolicySummaryUnmarshaller>(ConfigurationPolicySummaryUnmarshaller.Instance);
                    response.ConfigurationPolicySummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListConfigurationPoliciesResponseUnmarshaller _instance = new ListConfigurationPoliciesResponseUnmarshaller();        

        internal static ListConfigurationPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListConfigurationPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
