...
{
    /// <summary>
    /// Response Unmarshaller for ResourceSeverityBreakdown Object
    /// </summary>
    public partial class ResourceSeverityBreakdownUnmarshaller : IJsonUnmarshaller<ResourceSeverityBreakdown, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ResourceSeverityBreakdown Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ResourceSeverityBreakdown();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Fatal", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.Fatal = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ResourceSeverityBreakdownUnmarshaller _instance = new ResourceSeverityBreakdownUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ResourceSeverityBreakdownUnmarshaller Instance => _instance;
    }
}
