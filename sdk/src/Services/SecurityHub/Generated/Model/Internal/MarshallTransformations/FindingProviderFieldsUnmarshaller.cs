...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class FindingProviderFieldsUnmarshaller : IJsonUnmarshaller<FindingProviderFields, JsonUnmarshallerContext>
    {
        ...
        private static FindingProviderFieldsUnmarshaller _instance = new FindingProviderFieldsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FindingProviderFieldsUnmarshaller Instance
        {
            get
            {
                return _instance;
