...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateInsightResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInsightResponse response = new CreateInsightResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InsightArn", targetDepth))
                {
                    ...
                    response.InsightArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateInsightResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInsightResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
