...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsRedshiftClusterPendingModifiedValuesUnmarshaller : IJsonUnmarshaller<AwsRedshiftClusterPendingModifiedValues, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AwsRedshiftClusterPendingModifiedValues Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AwsRedshiftClusterPendingModifiedValues();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsRedshiftClusterPendingModifiedValuesUnmarshaller Instance => _instance;
    }
}
