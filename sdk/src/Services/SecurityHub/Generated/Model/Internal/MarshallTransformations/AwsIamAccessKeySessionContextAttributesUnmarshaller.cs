...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsIamAccessKeySessionContextAttributesUnmarshaller : IUnmarshaller<AwsIamAccessKeySessionContextAttributes, XmlUnmarshallerContext>, IUnmarshaller<AwsIamAccessKeySessionContextAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AwsIamAccessKeySessionContextAttributes IUnmarshaller<AwsIamAccessKeySessionContextAttributes, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AwsIamAccessKeySessionContextAttributes Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
