...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ContainerDetailsUnmarshaller : IJsonUnmarshaller<ContainerDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ContainerDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ContainerDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ContainerDetailsUnmarshaller Instance => _instance;
    }
}
