...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeOrganizationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeOrganizationConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AutoEnableStandards", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AutoEnableStandards = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.MemberAccountLimitReached = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeOrganizationConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeOrganizationConfigurationResponseUnmarshaller Instance => _instance;
    }
}
