...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsEc2VolumeDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2VolumeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsEc2VolumeDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VolumeScanStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsEc2VolumeDetailsUnmarshaller Instance => _instance;
    }
}
