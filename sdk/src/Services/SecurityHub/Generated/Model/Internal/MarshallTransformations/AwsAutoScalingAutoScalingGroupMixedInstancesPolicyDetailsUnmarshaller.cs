...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsUnmarshaller : IJsonUnmarshaller<AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsUnmarshaller _instance = new AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
