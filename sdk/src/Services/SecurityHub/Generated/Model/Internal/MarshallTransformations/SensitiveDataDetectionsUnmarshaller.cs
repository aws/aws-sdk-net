...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SensitiveDataDetectionsUnmarshaller : IJsonUnmarshaller<SensitiveDataDetections, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SensitiveDataDetections Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Occurrences", targetDepth, ref reader))
                {
                    var unmarshaller = OccurrencesUnmarshaller.Instance;
                    unmarshalledObject.Occurrences = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
