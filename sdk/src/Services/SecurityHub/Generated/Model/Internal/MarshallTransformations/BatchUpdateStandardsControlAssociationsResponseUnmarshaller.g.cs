...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchUpdateStandardsControlAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchUpdateStandardsControlAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UnprocessedAssociationUpdates", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.UnprocessedAssociationUpdates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static BatchUpdateStandardsControlAssociationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchUpdateStandardsControlAssociationsResponseUnmarshaller Instance => _instance;
    }
}
