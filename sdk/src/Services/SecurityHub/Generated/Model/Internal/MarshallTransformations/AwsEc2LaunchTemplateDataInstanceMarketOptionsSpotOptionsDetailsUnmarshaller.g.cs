...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails();
            ...
            {
                if (context.TestExpression("BlockDurationMinutes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("InstanceInterruptionBehavior", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("MaxPrice", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SpotInstanceType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ValidUntil", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetailsUnmarshaller Instance => _instance;
    }
}
