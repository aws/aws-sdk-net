...
{
    /// <summary>
    /// Response Unmarshaller for GetInsights operation.
    /// </summary>
    public partial class GetInsightsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetInsightsResponse();
        ...
        private static GetInsightsResponseUnmarshaller _instance = new GetInsightsResponseUnmarshaller();

        internal static GetInsightsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInsightsResponseUnmarshaller Instance => _instance;
    }
}
