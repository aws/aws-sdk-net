...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProviderDetailUnmarshaller : IJsonUnmarshaller<ProviderDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProviderDetail();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AzureDetailUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProviderDetailUnmarshaller Instance => _instance;
    }
}
