...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetailsUnmarshaller : IJsonUnmarshaller<AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails();
            ...
            {
                if (context.TestExpression("CloudWatchEncryptionEnabled", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("S3EncryptionEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetailsUnmarshaller Instance => _instance;
    }
}
