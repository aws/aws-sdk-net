...
{
    /// <summary>
    /// Response Unmarshaller for AcceptAdministratorInvitation operation
    /// </summary>  
    public class AcceptAdministratorInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptAdministratorInvitationResponse response = new AcceptAdministratorInvitationResponse();
        ...
        private static AcceptAdministratorInvitationResponseUnmarshaller _instance = new AcceptAdministratorInvitationResponseUnmarshaller();        

        internal static AcceptAdministratorInvitationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptAdministratorInvitationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
