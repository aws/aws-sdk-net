...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchUpdateFindingsV2RequestMarshaller : IMarshaller<IRequest, BatchUpdateFindingsV2Request>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(BatchUpdateFindingsV2Request publicRequest)
        {
            ...
            if (publicRequest.IsSetMetadataUids())
            {
                ...
                {
                    context.Writer.WriteStringValue(publicRequestMetadataUidsListValue);
                }
                context.Writer.WriteEndArray();
            }
            if (publicRequest.IsSetSeverityId())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.SeverityId.Value);
            }
            if (publicRequest.IsSetStatusId())
            {
                context.Writer.WritePropertyName("StatusId");
                context.Writer.WriteNumberValue(publicRequest.StatusId.Value);
            }
        ...
        private static readonly BatchUpdateFindingsV2RequestMarshaller _instance = new();

        internal static BatchUpdateFindingsV2RequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchUpdateFindingsV2RequestMarshaller Instance => _instance;
    }
}
