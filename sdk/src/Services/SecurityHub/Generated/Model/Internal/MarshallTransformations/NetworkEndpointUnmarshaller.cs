...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkEndpointUnmarshaller : IJsonUnmarshaller<NetworkEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AutonomousSystem", targetDepth, ref reader))
                {
                    var unmarshaller = NetworkAutonomousSystemUnmarshaller.Instance;
                    unmarshalledObject.AutonomousSystem = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
