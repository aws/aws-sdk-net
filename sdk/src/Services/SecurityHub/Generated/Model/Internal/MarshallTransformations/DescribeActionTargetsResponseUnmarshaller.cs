    ...
    public class DescribeActionTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ActionTarget, ActionTargetUnmarshaller>(ActionTargetUnmarshaller.Instance);
                    response.ActionTargets = unmarshaller.Unmarshall(context);
                    continue;
                }
