...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetConnectorRequestMarshaller : IMarshaller<IRequest, GetConnectorRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetConnectorRequest publicRequest)
        {
            ...
            request.ResourcePath = "/connectors/{ConnectorId+}";

            return request;
        }

        private static readonly GetConnectorRequestMarshaller _instance = new();

        internal static GetConnectorRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetConnectorRequestMarshaller Instance => _instance;
    }
}
