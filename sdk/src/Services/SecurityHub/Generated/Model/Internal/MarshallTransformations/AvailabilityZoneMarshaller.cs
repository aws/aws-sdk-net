...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AvailabilityZoneMarshaller : IRequestMarshaller<AvailabilityZone, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AvailabilityZone requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetZoneName())
            {
                context.Writer.WritePropertyName("ZoneName");
                context.Writer.WriteStringValue(requestObject.ZoneName);
            }
