...
{
    /// <summary>
    /// Container for the parameters to the DeleteMembers operation. Deletes the specified
    /// member accounts from Security Hub CSPM. <para> You can invoke this API only to delete
    /// accounts that became members through invitation. You can't invoke this API to delete
    /// accounts that belong to an Organizations organization. </para>
    /// </summary>
