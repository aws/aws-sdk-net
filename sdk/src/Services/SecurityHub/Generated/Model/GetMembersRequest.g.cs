...
{
    /// <summary>
    /// Container for the parameters to the GetMembers operation. Returns the details for
    /// the Security Hub CSPM member accounts for the specified account IDs. <para> An administrator
    /// account can be either the delegated Security Hub CSPM administrator account for an
    /// organization or an administrator account that enabled Security Hub CSPM manually.
    /// </para> <para> The results include both member accounts that are managed using Organizations
    /// and accounts that were invited manually. </para>
    /// </summary>
