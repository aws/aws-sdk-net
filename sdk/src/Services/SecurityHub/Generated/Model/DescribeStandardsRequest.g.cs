...
{
    /// <summary>
    /// Container for the parameters to the DescribeStandards operation. Returns a list of
    /// the available standards in Security Hub CSPM. <para> For each standard, the results
    /// include the standard ARN, the name, and a description. </para>
    /// </summary>
