...
namespace Amazon.SecurityHub.Model
{
    ...
    public partial class AwsBackupRecoveryPointCalculatedLifecycleDetails
    {
        ...
        /// <summary>
        /// Checks to see if the DeleteAt property is set.
        /// </summary>
        internal bool IsSetDeleteAt() => this.DeleteAt != null;
        ...
        /// <summary>
        /// Checks to see if the MoveToColdStorageAt property is set.
        /// </summary>
        internal bool IsSetMoveToColdStorageAt() => this.MoveToColdStorageAt != null;
    }
}
