...
namespace Amazon.TranscribeService
{
    ...
    public partial interface IAmazonTranscribeService : IAmazonService, IDisposable
    {
        ...
        Task<UpdateLanguageModelResponse> UpdateLanguageModelAsync(UpdateLanguageModelRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
