...
namespace Amazon.TranscribeService.Model
{
    ...
    internal sealed partial class ListMedicalTranscriptionJobsPaginator : IPaginator<ListMedicalTranscriptionJobsResponse>, IListMedicalTranscriptionJobsPaginator
    {
        ...
        async IAsyncEnumerable<ListMedicalTranscriptionJobsResponse> IPaginator<ListMedicalTranscriptionJobsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
