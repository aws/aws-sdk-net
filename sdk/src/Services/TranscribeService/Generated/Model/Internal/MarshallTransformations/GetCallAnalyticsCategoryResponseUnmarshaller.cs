...
{
    /// <summary>
    /// Response Unmarshaller for GetCallAnalyticsCategory operation
    /// </summary>  
    public class GetCallAnalyticsCategoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCallAnalyticsCategoryResponse response = new GetCallAnalyticsCategoryResponse();
            ...
            {
                if (context.TestExpression("CategoryProperties", targetDepth, ref reader))
                {
                    var unmarshaller = CategoryPropertiesUnmarshaller.Instance;
                    response.CategoryProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCallAnalyticsCategoryResponseUnmarshaller _instance = new GetCallAnalyticsCategoryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCallAnalyticsCategoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
