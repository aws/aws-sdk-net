...
{
    /// <summary>
    /// Response Unmarshaller for GetTranscriptionJob operation
    /// </summary>  
    public class GetTranscriptionJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonTranscribeServiceException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }

        private static GetTranscriptionJobResponseUnmarshaller _instance = new GetTranscriptionJobResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTranscriptionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
