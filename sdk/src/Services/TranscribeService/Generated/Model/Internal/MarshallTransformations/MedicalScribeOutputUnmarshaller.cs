...
namespace Amazon.TranscribeService.Model.Internal.MarshallTransformations
{
    ...
    public class MedicalScribeOutputUnmarshaller : IJsonUnmarshaller<MedicalScribeOutput, JsonUnmarshallerContext>
    {
        ...
        public MedicalScribeOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ClinicalDocumentUri", targetDepth, ref reader))
                {
        ...
        private static MedicalScribeOutputUnmarshaller _instance = new MedicalScribeOutputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MedicalScribeOutputUnmarshaller Instance
        {
            get
            {
                return _instance;
