...
{
    /// <summary>
    /// Response Unmarshaller for ListCallAnalyticsCategories operation
    /// </summary>  
    public class ListCallAnalyticsCategoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCallAnalyticsCategoriesResponse response = new ListCallAnalyticsCategoriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CategoryProperties, CategoryPropertiesUnmarshaller>(CategoryPropertiesUnmarshaller.Instance);
        ...
        private static ListCallAnalyticsCategoriesResponseUnmarshaller _instance = new ListCallAnalyticsCategoriesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCallAnalyticsCategoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
