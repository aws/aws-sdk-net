    ...
    public class AbsoluteTimeRangeUnmarshaller : IJsonUnmarshaller<AbsoluteTimeRange, JsonUnmarshallerContext>
    {
        ...
        public AbsoluteTimeRange Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("First", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
        ...
        private static AbsoluteTimeRangeUnmarshaller _instance = new AbsoluteTimeRangeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AbsoluteTimeRangeUnmarshaller Instance
        {
            get
            {
                return _instance;
