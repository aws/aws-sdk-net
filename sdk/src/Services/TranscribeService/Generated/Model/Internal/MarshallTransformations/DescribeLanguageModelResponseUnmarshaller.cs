...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLanguageModel operation
    /// </summary>  
    public class DescribeLanguageModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLanguageModelResponse response = new DescribeLanguageModelResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LanguageModel", targetDepth))
                {
                    ...
                    response.LanguageModel = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeLanguageModelResponseUnmarshaller _instance = new DescribeLanguageModelResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLanguageModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
