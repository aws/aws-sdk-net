...
namespace Amazon.TranscribeService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SentimentFilterUnmarshaller : IUnmarshaller<SentimentFilter, XmlUnmarshallerContext>, IUnmarshaller<SentimentFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SentimentFilter IUnmarshaller<SentimentFilter, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SentimentFilter Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Sentiments", targetDepth))
                {
                    ...
                    unmarshalledObject.Sentiments = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
