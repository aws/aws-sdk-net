...
{
    /// <summary>
    /// Response Unmarshaller for ListMedicalVocabularies operation
    /// </summary>  
    public class ListMedicalVocabulariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMedicalVocabulariesResponse response = new ListMedicalVocabulariesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Vocabularies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<VocabularyInfo, VocabularyInfoUnmarshaller>(VocabularyInfoUnmarshaller.Instance);
                    response.Vocabularies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListMedicalVocabulariesResponseUnmarshaller _instance = new ListMedicalVocabulariesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMedicalVocabulariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
