...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KeySummaryUnmarshaller : IUnmarshaller<KeySummary, XmlUnmarshallerContext>, IUnmarshaller<KeySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        KeySummary IUnmarshaller<KeySummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
