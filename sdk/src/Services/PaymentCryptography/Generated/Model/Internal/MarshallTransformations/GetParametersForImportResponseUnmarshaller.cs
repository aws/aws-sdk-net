...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetParametersForImportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WrappingKeyAlgorithm = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("WrappingKeyCertificate", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WrappingKeyCertificate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("WrappingKeyCertificateChain", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WrappingKeyCertificateChain = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonPaymentCryptographyException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static GetParametersForImportResponseUnmarshaller _instance = new GetParametersForImportResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetParametersForImportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
