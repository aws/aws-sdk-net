    ...
    public class ImportKeyMaterialMarshaller : IRequestMarshaller<ImportKeyMaterial, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ImportKeyMaterial requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAs2805KeyCryptogram())
            {
                context.Writer.WritePropertyName("As2805KeyCryptogram");
                context.Writer.WriteStartObject();

                var marshaller = ImportAs2805KeyCryptogramMarshaller.Instance;
                marshaller.Marshall(requestObject.As2805KeyCryptogram, context);
