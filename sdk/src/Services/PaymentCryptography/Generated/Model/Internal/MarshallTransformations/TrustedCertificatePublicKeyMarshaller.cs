...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class TrustedCertificatePublicKeyMarshaller : IRequestMarshaller<TrustedCertificatePublicKey, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// </summary>
        public readonly static TrustedCertificatePublicKeyMarshaller Instance = new TrustedCertificatePublicKeyMarshaller();
