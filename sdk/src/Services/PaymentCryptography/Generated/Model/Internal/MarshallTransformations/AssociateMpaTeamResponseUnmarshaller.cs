...
{
    /// <summary>
    /// Response Unmarshaller for AssociateMpaTeam operation
    /// </summary>  
    public class AssociateMpaTeamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateMpaTeamResponse response = new AssociateMpaTeamResponse();
        ...
        private static AssociateMpaTeamResponseUnmarshaller _instance = new AssociateMpaTeamResponseUnmarshaller();        

        internal static AssociateMpaTeamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateMpaTeamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
