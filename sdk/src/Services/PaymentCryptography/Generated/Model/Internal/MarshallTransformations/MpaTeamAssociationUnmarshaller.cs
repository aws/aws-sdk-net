...
{
    /// <summary>
    /// Response Unmarshaller for MpaTeamAssociation Object
    /// </summary>  
    public class MpaTeamAssociationUnmarshaller : IJsonUnmarshaller<MpaTeamAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MpaTeamAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MpaTeamAssociation unmarshalledObject = new MpaTeamAssociation();
        ...
        private static MpaTeamAssociationUnmarshaller _instance = new MpaTeamAssociationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MpaTeamAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
