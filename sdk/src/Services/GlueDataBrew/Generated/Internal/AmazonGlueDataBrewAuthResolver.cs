...
namespace Amazon.GlueDataBrew.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonGlueDataBrewAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGlueDataBrewAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GlueDataBrew.
        /// </summary>
        public AmazonGlueDataBrewAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGlueDataBrewAuthSchemeParameters
            {
    ...
    public class AmazonGlueDataBrewAuthSchemeResolver : IAuthSchemeResolver<AmazonGlueDataBrewAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGlueDataBrewAuthSchemeParameters authParameters)
        {
