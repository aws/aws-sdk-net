...
{
    /// <summary>
    /// Container for the parameters to the CreateRuleset operation.
    /// Creates a new ruleset that can be used in a profile job to validate the data quality
    /// of a dataset.
    /// </summary>
    public partial class CreateRulesetRequest : AmazonGlueDataBrewRequest
    {
        ...
        /// <para>
        /// The name of the ruleset to be created. Valid characters are alphanumeric (A-Z, a-z,
