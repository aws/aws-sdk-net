...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSchedule operation
    /// </summary>  
    public class UpdateScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateScheduleResponseUnmarshaller _instance = new UpdateScheduleResponseUnmarshaller();        

        internal static UpdateScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
