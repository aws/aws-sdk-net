    ...
    public class DescribeRecipeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PublishedBy = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PublishedDate", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.PublishedDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RecipeVersion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RecipeVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
