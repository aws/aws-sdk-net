...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataCatalogOutputUnmarshaller : IJsonUnmarshaller<DataCatalogOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataCatalogOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("S3Options", targetDepth, ref reader))
                {
                    var unmarshaller = S3TableOutputOptionsUnmarshaller.Instance;
                    unmarshalledObject.S3Options = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
