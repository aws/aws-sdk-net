        ...
        public Rule Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CheckExpression", targetDepth))
                {
                    ...
                    unmarshalledObject.CheckExpression = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ColumnSelectors", targetDepth))
                {
                    ...
                    unmarshalledObject.ColumnSelectors = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("SubstitutionMap", targetDepth))
                {
                    ...
                    unmarshalledObject.SubstitutionMap = unmarshaller.Unmarshall(context);
                    continue;
                }
