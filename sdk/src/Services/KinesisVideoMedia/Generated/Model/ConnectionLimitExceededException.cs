...
namespace Amazon.KinesisVideoMedia.Model
{
    ...
    public partial class ConnectionLimitExceededException : AmazonKinesisVideoMediaException
    {
        ...
        public ConnectionLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConnectionLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
