...
using Amazon.Util;
using Amazon.IoTEventsData.Endpoints;

#pragma warning disable 1591

namespace Amazon.IoTEventsData.Internal
{
    /// <summary>
    /// Amazon IoTEventsData endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IoTEventsData service requests.
    /// Collects values for IoTEventsDataEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IoTEventsDataEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonIoTEventsDataEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonIoTEventsDataConfig)requestContext.ClientConfig;
            var result = new IoTEventsDataEndpointParameters();
