...
{
    /// <summary>
    /// BatchAcknowledgeAlarm Request Marshaller
    /// </summary>       
    public class BatchAcknowledgeAlarmRequestMarshaller : IMarshaller<IRequest, BatchAcknowledgeAlarmRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchAcknowledgeAlarmRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchAcknowledgeAlarmRequest publicRequest)
        {
        ...
        private static BatchAcknowledgeAlarmRequestMarshaller _instance = new BatchAcknowledgeAlarmRequestMarshaller();        

        internal static BatchAcknowledgeAlarmRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAcknowledgeAlarmRequestMarshaller Instance
        {
            get
            {
                return _instance;
