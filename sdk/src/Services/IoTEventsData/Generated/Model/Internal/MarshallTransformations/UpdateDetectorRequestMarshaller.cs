...
{
    /// <summary>
    /// UpdateDetectorRequest Marshaller
    /// </summary>
    public class UpdateDetectorRequestMarshaller : IRequestMarshaller<UpdateDetectorRequest, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(UpdateDetectorRequest requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDetectorModelName())
            {
                ...
                context.Writer.WriteStringValue(requestObject.DetectorModelName);
            }
            ...
            if(requestObject.IsSetState())
            {
                ...
                var marshaller = DetectorStateDefinitionMarshaller.Instance;
        ...
        /// </summary>
        public readonly static UpdateDetectorRequestMarshaller Instance = new UpdateDetectorRequestMarshaller();
