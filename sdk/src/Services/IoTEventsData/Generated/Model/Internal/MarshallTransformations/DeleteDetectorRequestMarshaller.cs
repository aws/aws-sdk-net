...
namespace Amazon.IoTEventsData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class DeleteDetectorRequestMarshaller : IRequestMarshaller<DeleteDetectorRequest, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DeleteDetectorRequest requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static DeleteDetectorRequestMarshaller Instance = new DeleteDetectorRequestMarshaller();
