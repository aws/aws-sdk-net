...
namespace Amazon.IoTEventsData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SimpleRuleEvaluationUnmarshaller : IUnmarshaller<SimpleRuleEvaluation, XmlUnmarshallerContext>, IUnmarshaller<SimpleRuleEvaluation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SimpleRuleEvaluation IUnmarshaller<SimpleRuleEvaluation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SimpleRuleEvaluation Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("inputPropertyValue", targetDepth))
                {
                    ...
                    unmarshalledObject.InputPropertyValue = unmarshaller.Unmarshall(context);
                    continue;
                }
