...
namespace Amazon.IoTEventsData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlarmUnmarshaller : IJsonUnmarshaller<Alarm, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Alarm Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("alarmModelName", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("alarmState", targetDepth, ref reader))
                {
                    var unmarshaller = AlarmStateUnmarshaller.Instance;
                    unmarshalledObject.AlarmState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
