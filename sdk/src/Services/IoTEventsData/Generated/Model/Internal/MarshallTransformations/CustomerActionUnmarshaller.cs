...
namespace Amazon.IoTEventsData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomerActionUnmarshaller : IJsonUnmarshaller<CustomerAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomerAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
