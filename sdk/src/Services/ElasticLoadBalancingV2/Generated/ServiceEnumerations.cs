...
namespace Amazon.ElasticLoadBalancingV2
{
    ...
    /// <summary>
    /// Constants used for properties of type SourceIpAddressTypeEnum.
    /// </summary>
    public class SourceIpAddressTypeEnum : ConstantClass
    {

        /// <summary>
        /// Constant Ipv4 for SourceIpAddressTypeEnum
        /// </summary>
        public static readonly SourceIpAddressTypeEnum Ipv4 = new SourceIpAddressTypeEnum("ipv4");
        /// <summary>
        /// Constant Ipv6 for SourceIpAddressTypeEnum
        /// </summary>
        public static readonly SourceIpAddressTypeEnum Ipv6 = new SourceIpAddressTypeEnum("ipv6");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public SourceIpAddressTypeEnum(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static SourceIpAddressTypeEnum FindValue(string value)
        {
            return FindValue<SourceIpAddressTypeEnum>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator SourceIpAddressTypeEnum(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type TransformTypeEnum.
    /// </summary>
    public class TransformTypeEnum : ConstantClass
    {

        /// <summary>
        /// Constant HostHeaderRewrite for TransformTypeEnum
        /// </summary>
        public static readonly TransformTypeEnum HostHeaderRewrite = new TransformTypeEnum("host-header-rewrite");
        /// <summary>
        /// Constant UrlRewrite for TransformTypeEnum
        /// </summary>
        public static readonly TransformTypeEnum UrlRewrite = new TransformTypeEnum("url-rewrite");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public TransformTypeEnum(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static TransformTypeEnum FindValue(string value)
        {
            return FindValue<TransformTypeEnum>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator TransformTypeEnum(string value)
        {
            return FindValue(value);
        }
    }
