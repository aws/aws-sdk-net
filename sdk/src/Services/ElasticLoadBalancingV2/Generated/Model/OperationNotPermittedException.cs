...
namespace Amazon.ElasticLoadBalancingV2.Model
{
    ...
    [Serializable]
    #endif
    public partial class OperationNotPermittedException : AmazonElasticLoadBalancingV2Exception
    {
        ...
        public OperationNotPermittedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OperationNotPermittedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
