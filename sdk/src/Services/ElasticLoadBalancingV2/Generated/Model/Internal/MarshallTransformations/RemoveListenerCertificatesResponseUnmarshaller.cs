...
{
    /// <summary>
    /// Response Unmarshaller for RemoveListenerCertificates operation
    /// </summary>  
    public class RemoveListenerCertificatesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveListenerCertificatesResponse response = new RemoveListenerCertificatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RemoveListenerCertificatesResult", 2))
                    {
        ...
        private static RemoveListenerCertificatesResponseUnmarshaller _instance = new RemoveListenerCertificatesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveListenerCertificatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
