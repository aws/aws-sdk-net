...
{
    /// <summary>
    /// Response Unmarshaller for DeleteListener operation
    /// </summary>  
    public class DeleteListenerResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteListenerResponse response = new DeleteListenerResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteListenerResult", 2))
                    {
        ...
        private static DeleteListenerResponseUnmarshaller _instance = new DeleteListenerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteListenerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
