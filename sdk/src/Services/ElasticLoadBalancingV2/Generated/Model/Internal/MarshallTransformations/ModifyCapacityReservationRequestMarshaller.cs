    ...
    public class ModifyCapacityReservationRequestMarshaller : IMarshaller<IRequest, ModifyCapacityReservationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ModifyCapacityReservationRequest publicRequest)
        {
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetMinimumLoadBalancerCapacity())
                {
                    if(publicRequest.MinimumLoadBalancerCapacity.IsSetCapacityUnits())
                    {
                        request.Parameters.Add("MinimumLoadBalancerCapacity" + "." + "CapacityUnits", StringUtils.FromInt(publicRequest.MinimumLoadBalancerCapacity.CapacityUnits));
                    }
                }
                if(publicRequest.IsSetResetCapacityReservation())
                {
