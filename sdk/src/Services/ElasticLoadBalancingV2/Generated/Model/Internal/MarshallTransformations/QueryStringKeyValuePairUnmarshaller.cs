...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class QueryStringKeyValuePairUnmarshaller : IXmlUnmarshaller<QueryStringKeyValuePair, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public QueryStringKeyValuePair Unmarshall(XmlUnmarshallerContext context)
        {
            QueryStringKeyValuePair unmarshalledObject = new QueryStringKeyValuePair();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryStringKeyValuePairUnmarshaller Instance
        {
            get
            {
                return _instance;
