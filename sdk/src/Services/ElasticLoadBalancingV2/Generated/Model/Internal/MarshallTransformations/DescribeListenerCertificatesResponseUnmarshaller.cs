...
{
    /// <summary>
    /// Response Unmarshaller for DescribeListenerCertificates operation
    /// </summary>  
    public class DescribeListenerCertificatesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeListenerCertificatesResponse response = new DescribeListenerCertificatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeListenerCertificatesResult", 2))
                    {
        ...
        private static DescribeListenerCertificatesResponseUnmarshaller _instance = new DescribeListenerCertificatesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeListenerCertificatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
