...
namespace Amazon.ElasticLoadBalancingV2.Model
{
    ...
    public partial class TooManyUniqueTargetGroupsPerLoadBalancerException : AmazonElasticLoadBalancingV2Exception
    {
        ...
        /// <summary>
        /// Construct instance of TooManyUniqueTargetGroupsPerLoadBalancerException
        /// </summary>
        ...
        public TooManyUniqueTargetGroupsPerLoadBalancerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyUniqueTargetGroupsPerLoadBalancerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected TooManyUniqueTargetGroupsPerLoadBalancerException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
