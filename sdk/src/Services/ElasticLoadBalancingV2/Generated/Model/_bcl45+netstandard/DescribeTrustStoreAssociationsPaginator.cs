...
namespace Amazon.ElasticLoadBalancingV2.Model
{
    ...
    internal sealed partial class DescribeTrustStoreAssociationsPaginator : IPaginator<DescribeTrustStoreAssociationsResponse>, IDescribeTrustStoreAssociationsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeTrustStoreAssociationsResponse> IPaginator<DescribeTrustStoreAssociationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
