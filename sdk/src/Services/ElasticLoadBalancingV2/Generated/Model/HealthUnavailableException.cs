...
namespace Amazon.ElasticLoadBalancingV2.Model
{
    ...
    public partial class HealthUnavailableException : AmazonElasticLoadBalancingV2Exception
    {
        ...
        /// <summary>
        /// Default constructor for HealthUnavailableException
        /// message.
        /// </summary>
        ...
        public HealthUnavailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HealthUnavailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
