...
namespace Amazon.ElasticLoadBalancingV2.Model
{
    ...
    public partial class HostHeaderConditionConfig
    {
        ...
        /// <para>
        /// The regular expressions to compare against the host header. The maximum length of
        ...
        /// <para>
        /// The host names. The maximum length of each string is 128 characters. The comparison
        /// is case insensitive. The following wildcard characters are supported: * (matches 0
        /// or more characters) and ? (matches exactly 1 character). You must include at least
        /// one "." character. You can include only alphabetical characters after the final "."
        /// character.
        /// </para>
        ///  
        /// <para>
