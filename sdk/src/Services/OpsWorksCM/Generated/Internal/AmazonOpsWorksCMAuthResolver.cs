...
namespace Amazon.OpsWorksCM.Internal
{
    ...
    public class AmazonOpsWorksCMAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOpsWorksCMAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for OpsWorksCM.
        /// </summary>
        public AmazonOpsWorksCMAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOpsWorksCMAuthSchemeParameters
            {
    ...
    public class AmazonOpsWorksCMAuthSchemeResolver : IAuthSchemeResolver<AmazonOpsWorksCMAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOpsWorksCMAuthSchemeParameters authParameters)
        {
