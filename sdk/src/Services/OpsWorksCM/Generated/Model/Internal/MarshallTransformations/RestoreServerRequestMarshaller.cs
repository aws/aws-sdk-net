...
{
    /// <summary>
    /// RestoreServer Request Marshaller
    /// </summary>       
    public class RestoreServerRequestMarshaller : IMarshaller<IRequest, RestoreServerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RestoreServerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RestoreServerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.RestoreServer";
        ...
        private static RestoreServerRequestMarshaller _instance = new RestoreServerRequestMarshaller();        

        internal static RestoreServerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreServerRequestMarshaller Instance
        {
            get
            {
                return _instance;
