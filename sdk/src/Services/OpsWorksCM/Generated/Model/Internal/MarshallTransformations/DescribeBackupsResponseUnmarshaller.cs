...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBackups operation
    /// </summary>  
    public class DescribeBackupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeBackupsResponseUnmarshaller _instance = new DescribeBackupsResponseUnmarshaller();        

        internal static DescribeBackupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBackupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
