...
namespace Amazon.OpsWorksCM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServerEventUnmarshaller : IJsonUnmarshaller<ServerEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServerEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
