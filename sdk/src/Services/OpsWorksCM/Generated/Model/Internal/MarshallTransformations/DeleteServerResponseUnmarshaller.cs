...
namespace Amazon.OpsWorksCM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteServerResponseUnmarshaller _instance = new DeleteServerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
