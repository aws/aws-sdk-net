    ...
    public class DescribeEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ServerEvent, ServerEventUnmarshaller>(ServerEventUnmarshaller.Instance);
                    response.ServerEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
