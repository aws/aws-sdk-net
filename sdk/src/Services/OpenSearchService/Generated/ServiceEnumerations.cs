...
namespace Amazon.OpenSearchService
{
    ...
    /// <summary>
    /// Constants used for properties of type DataSourceAttachmentStatus.
    /// </summary>
    public class DataSourceAttachmentStatus : ConstantClass
    {

        /// <summary>
        /// Constant ATTACHED for DataSourceAttachmentStatus
        /// </summary>
        public static readonly DataSourceAttachmentStatus ATTACHED = new DataSourceAttachmentStatus("ATTACHED");
        /// <summary>
        /// Constant FAILED for DataSourceAttachmentStatus
        /// </summary>
        public static readonly DataSourceAttachmentStatus FAILED = new DataSourceAttachmentStatus("FAILED");
        /// <summary>
        /// Constant PENDING for DataSourceAttachmentStatus
        /// </summary>
        public static readonly DataSourceAttachmentStatus PENDING = new DataSourceAttachmentStatus("PENDING");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public DataSourceAttachmentStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static DataSourceAttachmentStatus FindValue(string value)
        {
            return FindValue<DataSourceAttachmentStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator DataSourceAttachmentStatus(string value)
        {
            return FindValue(value);
        }
    }
