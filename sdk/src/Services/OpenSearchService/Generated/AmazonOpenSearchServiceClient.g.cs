...
namespace Amazon.OpenSearchService
{
    ...
    public partial class AmazonOpenSearchServiceClient : AmazonServiceClient, IAmazonOpenSearchService
    {
        ...
        /// 
        /// </summary>
        public AmazonOpenSearchServiceClient() : base(new AmazonOpenSearchServiceConfig()) { }
        ...
        public AmazonOpenSearchServiceClient(RegionEndpoint region) : base(new AmazonOpenSearchServiceConfig { RegionEndpoint = region }) { }
        ...
        public AmazonOpenSearchServiceClient(AmazonOpenSearchServiceConfig config) : base(config) { }
