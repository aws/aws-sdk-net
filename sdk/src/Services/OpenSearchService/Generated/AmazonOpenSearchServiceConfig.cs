...
namespace Amazon.OpenSearchService
{
    ...
    public partial class AmazonOpenSearchServiceConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("OpenSearch", "4.0.102.13");
        ...
        /// </summary>
        public static new string ServiceId => "OpenSearch";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "es";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-01-01";
