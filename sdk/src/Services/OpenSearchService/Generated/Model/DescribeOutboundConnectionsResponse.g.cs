...
{
    /// <summary>
    /// This is the response object from the DescribeOutboundConnections operation.
    /// </summary>
    public partial class DescribeOutboundConnectionsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<OutboundConnection> Connections { get; set; } = AWSConfigs.InitializeCollections ? new List<OutboundConnection>() : null;
