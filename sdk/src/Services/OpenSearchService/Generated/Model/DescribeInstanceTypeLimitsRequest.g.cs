...
{
    /// <summary>
    /// Container for the parameters to the DescribeInstanceTypeLimits operation. Describes
    /// the instance count, storage, and master node limits for a given OpenSearch or Elasticsearch
