...
{
    /// <summary>
    /// Container for the parameters to the GetPackageVersionHistory operation. Returns a
    /// list of Amazon OpenSearch Service package versions, along with their creation time,
    /// commit message, and plugin properties (if the package is a zip plugin package). For
    /// more information, see <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/custom-packages.html">Custom
