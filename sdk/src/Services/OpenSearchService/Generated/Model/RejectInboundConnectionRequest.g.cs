...
{
    /// <summary>
    /// Container for the parameters to the RejectInboundConnection operation. Allows the
    /// remote Amazon OpenSearch Service domain owner to reject an inbound cross-cluster connection
    /// request.
    /// </summary>
