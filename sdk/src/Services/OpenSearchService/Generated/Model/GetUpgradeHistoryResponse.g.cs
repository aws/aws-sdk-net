...
{
    /// <summary>
    /// This is the response object from the GetUpgradeHistory operation.
    /// </summary>
    public partial class GetUpgradeHistoryResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<UpgradeHistory> UpgradeHistories { get; set; } = AWSConfigs.InitializeCollections ? new List<UpgradeHistory>() : null;

        /// <summary>
        /// Checks to see if the UpgradeHistories property is set.
        /// </summary>
        internal bool IsSetUpgradeHistories() => this.UpgradeHistories != null && (this.UpgradeHistories.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
