...
{
    /// <summary>
    /// This is the response object from the DescribeInboundConnections operation.
    /// </summary>
    public partial class DescribeInboundConnectionsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<InboundConnection> Connections { get; set; } = AWSConfigs.InitializeCollections ? new List<InboundConnection>() : null;
