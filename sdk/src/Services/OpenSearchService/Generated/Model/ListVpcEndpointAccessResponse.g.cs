...
namespace Amazon.OpenSearchService.Model
{
    ...
    public partial class ListVpcEndpointAccessResponse : AmazonWebServiceResponse
    {
        ...
        public List<AuthorizedPrincipal> AuthorizedPrincipalList { get; set; } = AWSConfigs.InitializeCollections ? new List<AuthorizedPrincipal>() : null;

        /// <summary>
        /// Checks to see if the AuthorizedPrincipalList property is set.
        /// </summary>
        internal bool IsSetAuthorizedPrincipalList() => this.AuthorizedPrincipalList != null && (this.AuthorizedPrincipalList.Count > 0 || !AWSConfigs.InitializeCollections);
