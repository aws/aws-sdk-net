...
{
    /// <summary>
    /// Container for the parameters to the GetCapability operation. Retrieves information
    /// about a registered capability for an OpenSearch UI application, including its configuration
    /// and current status.
    /// </summary>
