...
{
    /// <summary>
    /// Container for the parameters to the DescribeOutboundConnections operation. Lists all
    /// the outbound cross-cluster connections for a local (source) Amazon OpenSearch Service
    /// domain. For more information, see <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/cross-cluster-search.html">Cross-cluster
