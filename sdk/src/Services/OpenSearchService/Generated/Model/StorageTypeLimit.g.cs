...
namespace Amazon.OpenSearchService.Model
{
    ...
    public partial class StorageTypeLimit
    {
        ...
        /// </summary>
        public List<string> LimitValues { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the LimitValues property is set.
        /// </summary>
        internal bool IsSetLimitValues() => this.LimitValues != null && (this.LimitValues.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
