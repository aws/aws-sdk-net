...
{
    /// <summary>
    /// Container for the parameters to the ListDomainNames operation. Returns the names of
    /// all Amazon OpenSearch Service domains owned by the current user in the active Region.
    /// </summary>
