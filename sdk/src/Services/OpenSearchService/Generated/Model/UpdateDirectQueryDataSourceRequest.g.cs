...
{
    /// <summary>
    /// Container for the parameters to the UpdateDirectQueryDataSource operation. Updates
    /// the configuration or properties of an existing direct query data source in Amazon
    /// OpenSearch Service.
    /// </summary>
