...
{
    /// <summary>
    /// Container for the parameters to the AddDataSource operation. Creates a new direct-query
    /// data source to the specified domain. For more information, see <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/direct-query-s3-creating.html">Creating
