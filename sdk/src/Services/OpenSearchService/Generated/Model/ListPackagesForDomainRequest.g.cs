...
{
    /// <summary>
    /// Container for the parameters to the ListPackagesForDomain operation. Lists all packages
    /// associated with an Amazon OpenSearch Service domain. For more information, see <a
