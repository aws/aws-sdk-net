...
{
    /// <summary>
    /// This is the response object from the AttachDataSource operation.
    /// </summary>
    public partial class AttachDataSourceResponse : AmazonWebServiceResponse
    {
        private string _arn;
        ...
        /// <para>
        /// The status of the data source attachment. Valid values are <c>PENDING</c> (waiting
        /// for resources to become active), <c>ATTACHED</c> (successfully attached), and <c>FAILED</c>
