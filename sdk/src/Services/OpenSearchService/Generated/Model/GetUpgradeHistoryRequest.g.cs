...
{
    /// <summary>
    /// Container for the parameters to the GetUpgradeHistory operation. Retrieves the complete
    /// history of the last 10 upgrades performed on an Amazon OpenSearch Service domain.
    /// </summary>
