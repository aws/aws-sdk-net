...
{
    /// <summary>
    /// Container for the parameters to the DescribeReservedInstanceOfferings operation. Describes
    /// the available Amazon OpenSearch Service Reserved Instance offerings for a given Region.
