...
{
    /// <summary>
    /// Container for the parameters to the UpdatePackageScope operation. Updates the scope
    /// of a package. Scope of the package defines users who can view and associate a package.
    /// </summary>
