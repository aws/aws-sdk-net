...
namespace Amazon.OpenSearchService.Model
{
    ...
    public partial class PackageAssociationConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public KeyStoreAccessOption KeyStoreAccessOption { get; set; }

        /// <summary>
        /// Checks to see if the KeyStoreAccessOption property is set.
        /// </summary>
        internal bool IsSetKeyStoreAccessOption() => this.KeyStoreAccessOption != null;
    }
}
