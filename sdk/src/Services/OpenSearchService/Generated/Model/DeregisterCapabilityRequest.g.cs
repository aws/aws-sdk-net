...
{
    /// <summary>
    /// Container for the parameters to the DeregisterCapability operation. Deregisters a
    /// capability from an OpenSearch UI application. This operation removes the capability
