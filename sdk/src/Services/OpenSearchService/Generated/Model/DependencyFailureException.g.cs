...
namespace Amazon.OpenSearchService.Model
{
    ...
    public partial class DependencyFailureException : AmazonOpenSearchServiceException
    {
        ...
        /// Construct instance of DependencyFailureException
        /// </summary>
        public DependencyFailureException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of DependencyFailureException
        /// </summary>
        public DependencyFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of DependencyFailureException
        /// </summary>
        public DependencyFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
