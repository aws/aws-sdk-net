...
namespace Amazon.OpenSearchService.Model
{
    ...
    public partial class ExportOptions
    {
        ...
        /// </para>
        /// </summary>
        public bool? IncludeReferencesDeep { get; set; }

        /// <summary>
        /// Checks to see if the IncludeReferencesDeep property is set.
        /// </summary>
        internal bool IsSetIncludeReferencesDeep() => this.IncludeReferencesDeep.HasValue;
        ...
        /// </summary>
        public List<SavedObjectIdentifier> Objects { get; set; } = AWSConfigs.InitializeCollections ? new List<SavedObjectIdentifier>() : null;
