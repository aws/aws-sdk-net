...
{
    /// <summary>
    /// Container for the parameters to the DescribeInboundConnections operation. Lists all
    /// the inbound cross-cluster search connections for a destination (remote) Amazon OpenSearch
