...
{
    /// <summary>
    /// Container for the parameters to the ListScheduledActions operation. Retrieves a list
    /// of configuration changes that are scheduled for a domain. These changes can be <a
