...
{
    /// <summary>
    /// Container for the parameters to the CreateOutboundConnection operation. Creates a
    /// new cross-cluster search connection from a source Amazon OpenSearch Service domain
    /// to a destination domain. For more information, see <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/cross-cluster-search.html">Cross-cluster
