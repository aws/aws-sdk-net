...
{
    /// <summary>
    /// Container for the parameters to the ListTags operation. Returns all resource tags
    /// for an Amazon OpenSearch Service domain, data source, or application. For more information,
