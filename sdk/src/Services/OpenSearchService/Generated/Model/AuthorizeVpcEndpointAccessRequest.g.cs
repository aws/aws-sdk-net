...
{
    /// <summary>
    /// Container for the parameters to the AuthorizeVpcEndpointAccess operation. Provides
    /// access to an Amazon OpenSearch Service domain through the use of an interface VPC
    /// endpoint.
    /// </summary>
