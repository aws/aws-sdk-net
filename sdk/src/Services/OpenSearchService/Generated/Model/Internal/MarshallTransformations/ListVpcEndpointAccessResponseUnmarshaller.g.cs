...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListVpcEndpointAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListVpcEndpointAccessResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AuthorizedPrincipalList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AuthorizedPrincipalList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListVpcEndpointAccessResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVpcEndpointAccessResponseUnmarshaller Instance => _instance;
    }
}
