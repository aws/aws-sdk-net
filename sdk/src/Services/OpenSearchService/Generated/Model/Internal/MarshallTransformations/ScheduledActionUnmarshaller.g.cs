...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScheduledActionUnmarshaller : IJsonUnmarshaller<ScheduledAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ScheduledAction();
            ...
            {
                if (context.TestExpression("Cancellable", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Mandatory", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                ...
                if (context.TestExpression("ScheduledBy", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScheduledActionUnmarshaller Instance => _instance;
    }
}
