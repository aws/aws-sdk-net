...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class EncryptionAtRestOptionsStatusUnmarshaller : IJsonUnmarshaller<EncryptionAtRestOptionsStatus, JsonUnmarshallerContext>
    {
        ...
        private static EncryptionAtRestOptionsStatusUnmarshaller _instance = new EncryptionAtRestOptionsStatusUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EncryptionAtRestOptionsStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
