...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDomainMaintenanceStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDomainMaintenanceStatusResponse response = new GetDomainMaintenanceStatusResponse();
        ...
        internal static GetDomainMaintenanceStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDomainMaintenanceStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
