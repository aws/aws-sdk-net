...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class StartMigrationRequestMarshaller : IMarshaller<IRequest, StartMigrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartMigrationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2021-01-01/opensearch/app-migrations";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetMigrationOptions())
            {
                context.Writer.WritePropertyName("migrationOptions");
                context.Writer.WriteStartObject();

                var marshaller = MigrationOptionsMarshaller.Instance;
                marshaller.Marshall(publicRequest.MigrationOptions, context);
