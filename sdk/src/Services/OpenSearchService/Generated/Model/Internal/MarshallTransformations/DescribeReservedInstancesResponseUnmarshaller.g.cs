...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeReservedInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeReservedInstancesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReservedInstances", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReservedInstance, ReservedInstanceUnmarshaller>(ReservedInstanceUnmarshaller.Instance);
                    unmarshalledObject.ReservedInstances = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeReservedInstancesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeReservedInstancesResponseUnmarshaller Instance => _instance;
    }
}
