...
{
    /// <summary>
    /// Response Unmarshaller for AttachDataSource operation
    /// </summary>  
    public class AttachDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachDataSourceResponse response = new AttachDataSourceResponse();
        ...
        private static AttachDataSourceResponseUnmarshaller _instance = new AttachDataSourceResponseUnmarshaller();        

        internal static AttachDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
