...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteVpcEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteVpcEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VpcEndpointSummary", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VpcEndpointSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DeleteVpcEndpointResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteVpcEndpointResponseUnmarshaller Instance => _instance;
    }
}
