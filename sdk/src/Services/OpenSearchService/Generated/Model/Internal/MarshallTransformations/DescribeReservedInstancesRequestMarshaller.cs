...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeReservedInstancesRequestMarshaller : IMarshaller<IRequest, DescribeReservedInstancesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeReservedInstancesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetReservedInstanceId())
                request.Parameters.Add("reservationId", StringUtils.FromString(publicRequest.ReservedInstanceId));
            request.ResourcePath = "/2021-01-01/opensearch/reservedInstances";
            request.UseQueryString = true;

            return request;
        }
        private static DescribeReservedInstancesRequestMarshaller _instance = new DescribeReservedInstancesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeReservedInstancesRequestMarshaller Instance
        {
            get
            {
                return _instance;
