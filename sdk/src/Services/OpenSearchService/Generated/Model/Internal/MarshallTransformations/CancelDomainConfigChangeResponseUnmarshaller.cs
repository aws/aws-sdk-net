...
{
    /// <summary>
    /// Response Unmarshaller for CancelDomainConfigChange operation
    /// </summary>  
    public class CancelDomainConfigChangeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelDomainConfigChangeResponse response = new CancelDomainConfigChangeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CancelledChangeIds", targetDepth))
                {
                    ...
                    response.CancelledChangeIds = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CancelledChangeProperties", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<CancelledChangeProperty, CancelledChangePropertyUnmarshaller>(CancelledChangePropertyUnmarshaller.Instance);
                    response.CancelledChangeProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CancelDomainConfigChangeResponseUnmarshaller _instance = new CancelDomainConfigChangeResponseUnmarshaller();        

        internal static CancelDomainConfigChangeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelDomainConfigChangeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
