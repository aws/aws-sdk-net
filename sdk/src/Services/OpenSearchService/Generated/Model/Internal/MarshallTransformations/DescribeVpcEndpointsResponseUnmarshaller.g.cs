...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeVpcEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeVpcEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VpcEndpointErrors", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VpcEndpointErrors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeVpcEndpointsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeVpcEndpointsResponseUnmarshaller Instance => _instance;
    }
}
