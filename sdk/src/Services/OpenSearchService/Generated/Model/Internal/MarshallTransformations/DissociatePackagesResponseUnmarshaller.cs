    ...
    public class DissociatePackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DomainPackageDetails, DomainPackageDetailsUnmarshaller>(DomainPackageDetailsUnmarshaller.Instance);
                    response.DomainPackageDetailsList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
