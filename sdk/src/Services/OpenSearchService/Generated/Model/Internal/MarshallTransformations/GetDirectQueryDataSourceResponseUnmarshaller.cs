...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class GetDirectQueryDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("DataSourceAccessPolicy", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DataSourceAccessPolicy = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DataSourceName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("OpenSearchArns", targetDepth))
                {
                    ...
                    response.OpenSearchArns = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
