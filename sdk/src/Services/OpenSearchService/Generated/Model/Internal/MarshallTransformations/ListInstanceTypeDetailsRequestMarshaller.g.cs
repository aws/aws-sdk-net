...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListInstanceTypeDetailsRequestMarshaller : IMarshaller<IRequest, ListInstanceTypeDetailsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListInstanceTypeDetailsRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("retrieveAZs", StringUtils.FromBool(publicRequest.RetrieveAZs.Value));
            }
        ...
        private static readonly ListInstanceTypeDetailsRequestMarshaller _instance = new();

        internal static ListInstanceTypeDetailsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListInstanceTypeDetailsRequestMarshaller Instance => _instance;
    }
}
