...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChangeProgressStatusDetailsUnmarshaller : IJsonUnmarshaller<ChangeProgressStatusDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChangeProgressStatusDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CompletedProperties", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PendingProperties", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChangeProgressStatusDetailsUnmarshaller Instance => _instance;
    }
}
