...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeDomainChangeProgressResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeDomainChangeProgressResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChangeProgressStatus", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChangeProgressStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeDomainChangeProgressResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeDomainChangeProgressResponseUnmarshaller Instance => _instance;
    }
}
