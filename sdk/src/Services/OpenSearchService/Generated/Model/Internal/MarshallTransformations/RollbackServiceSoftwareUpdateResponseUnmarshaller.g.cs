...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RollbackServiceSoftwareUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RollbackServiceSoftwareUpdateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("RollbackServiceSoftwareOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.RollbackServiceSoftwareOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static RollbackServiceSoftwareUpdateResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RollbackServiceSoftwareUpdateResponseUnmarshaller Instance => _instance;
    }
}
