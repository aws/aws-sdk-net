...
{
    /// <summary>
    /// Response Unmarshaller for GetPackageVersionHistory operation.
    /// </summary>
    public partial class GetPackageVersionHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetPackageVersionHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PackageVersionHistoryList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PackageVersionHistoryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetPackageVersionHistoryResponseUnmarshaller _instance = new GetPackageVersionHistoryResponseUnmarshaller();

        internal static GetPackageVersionHistoryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPackageVersionHistoryResponseUnmarshaller Instance => _instance;
    }
}
