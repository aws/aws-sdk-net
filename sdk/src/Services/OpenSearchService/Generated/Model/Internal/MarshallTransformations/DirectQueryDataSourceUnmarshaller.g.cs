...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DirectQueryDataSourceUnmarshaller : IJsonUnmarshaller<DirectQueryDataSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DirectQueryDataSource();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OpenSearchArns", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DirectQueryDataSourceUnmarshaller Instance => _instance;
    }
}
