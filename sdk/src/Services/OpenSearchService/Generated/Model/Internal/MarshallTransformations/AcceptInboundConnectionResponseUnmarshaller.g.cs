...
{
    /// <summary>
    /// Response Unmarshaller for AcceptInboundConnection operation.
    /// </summary>
    public partial class AcceptInboundConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AcceptInboundConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = InboundConnectionUnmarshaller.Instance;
        ...
        private static AcceptInboundConnectionResponseUnmarshaller _instance = new AcceptInboundConnectionResponseUnmarshaller();

        internal static AcceptInboundConnectionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AcceptInboundConnectionResponseUnmarshaller Instance => _instance;
    }
}
