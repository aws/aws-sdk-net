...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuthorizeVpcEndpointAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AuthorizeVpcEndpointAccessResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AuthorizedPrincipal", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AuthorizedPrincipal = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static AuthorizeVpcEndpointAccessResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AuthorizeVpcEndpointAccessResponseUnmarshaller Instance => _instance;
    }
}
