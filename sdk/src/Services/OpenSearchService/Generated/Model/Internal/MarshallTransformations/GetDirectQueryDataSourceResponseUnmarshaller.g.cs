...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDirectQueryDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDirectQueryDataSourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DataSourceAccessPolicy", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DataSourceAccessPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetDirectQueryDataSourceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDirectQueryDataSourceResponseUnmarshaller Instance => _instance;
    }
}
