    ...
    public class DescribeDomainNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DomainNodesStatus, DomainNodesStatusUnmarshaller>(DomainNodesStatusUnmarshaller.Instance);
                    response.DomainNodesStatusList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
