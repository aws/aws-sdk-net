...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDomainConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateDomainConfigResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DomainConfig", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DomainConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("DryRunProgressStatus", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DryRunProgressStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("DryRunResults", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DryRunResults = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateDomainConfigResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDomainConfigResponseUnmarshaller Instance => _instance;
    }
}
