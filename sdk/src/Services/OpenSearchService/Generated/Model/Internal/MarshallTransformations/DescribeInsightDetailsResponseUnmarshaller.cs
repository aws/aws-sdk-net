...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInsightDetails operation
    /// </summary>  
    public class DescribeInsightDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInsightDetailsResponse response = new DescribeInsightDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InsightField, InsightFieldUnmarshaller>(InsightFieldUnmarshaller.Instance);
        ...
        private static DescribeInsightDetailsResponseUnmarshaller _instance = new DescribeInsightDetailsResponseUnmarshaller();        

        internal static DescribeInsightDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInsightDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
