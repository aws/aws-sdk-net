...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeDryRunProgressRequestMarshaller : IMarshaller<IRequest, DescribeDryRunProgressRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DescribeDryRunProgressRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("loadDryRunConfig", StringUtils.FromBool(publicRequest.LoadDryRunConfig.Value));
            }
        ...
        private static readonly DescribeDryRunProgressRequestMarshaller _instance = new();

        internal static DescribeDryRunProgressRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeDryRunProgressRequestMarshaller Instance => _instance;
    }
}
