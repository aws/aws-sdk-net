...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataSourceAttachment operation
    /// </summary>  
    public class DescribeDataSourceAttachmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDataSourceAttachmentResponse response = new DescribeDataSourceAttachmentResponse();
        ...
        private static DescribeDataSourceAttachmentResponseUnmarshaller _instance = new DescribeDataSourceAttachmentResponseUnmarshaller();        

        internal static DescribeDataSourceAttachmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataSourceAttachmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
