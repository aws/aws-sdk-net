...
{
    /// <summary>
    /// Response Unmarshaller for RegisterCapability operation.
    /// </summary>
    public partial class RegisterCapabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RegisterCapabilityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = CapabilityBaseResponseConfigUnmarshaller.Instance;
                    unmarshalledObject.CapabilityConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CapabilityName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RegisterCapabilityResponseUnmarshaller _instance = new RegisterCapabilityResponseUnmarshaller();

        internal static RegisterCapabilityResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterCapabilityResponseUnmarshaller Instance => _instance;
    }
}
