...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InsightUnmarshaller : IJsonUnmarshaller<Insight, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Insight();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IsExperimental", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.IsExperimental = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static InsightUnmarshaller Instance => _instance;
    }
}
