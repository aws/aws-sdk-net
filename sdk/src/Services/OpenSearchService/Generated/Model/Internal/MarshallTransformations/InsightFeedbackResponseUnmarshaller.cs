...
{
    /// <summary>
    /// Response Unmarshaller for InsightFeedback operation
    /// </summary>  
    public class InsightFeedbackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InsightFeedbackResponse response = new InsightFeedbackResponse();
        ...
        private static InsightFeedbackResponseUnmarshaller _instance = new InsightFeedbackResponseUnmarshaller();        

        internal static InsightFeedbackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InsightFeedbackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
