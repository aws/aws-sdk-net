...
{
    /// <summary>
    /// Response Unmarshaller for StartServiceSoftwareUpdate operation
    /// </summary>  
    public class StartServiceSoftwareUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartServiceSoftwareUpdateResponse response = new StartServiceSoftwareUpdateResponse();
        ...
        private static StartServiceSoftwareUpdateResponseUnmarshaller _instance = new StartServiceSoftwareUpdateResponseUnmarshaller();        

        internal static StartServiceSoftwareUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartServiceSoftwareUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
