...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoTuneMaintenanceScheduleUnmarshaller : IJsonUnmarshaller<AutoTuneMaintenanceSchedule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutoTuneMaintenanceSchedule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CronExpressionForRecurrence", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CronExpressionForRecurrence = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("StartAt", targetDepth, ref reader))
                {
