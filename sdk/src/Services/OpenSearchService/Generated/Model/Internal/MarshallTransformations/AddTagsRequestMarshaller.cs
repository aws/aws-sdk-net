...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class AddTagsRequestMarshaller : IMarshaller<IRequest, AddTagsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(AddTagsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2021-01-01/tags";
#if !NETFRAMEWORK
        ...
        private static AddTagsRequestMarshaller _instance = new AddTagsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddTagsRequestMarshaller Instance
        {
            get
            {
                return _instance;
