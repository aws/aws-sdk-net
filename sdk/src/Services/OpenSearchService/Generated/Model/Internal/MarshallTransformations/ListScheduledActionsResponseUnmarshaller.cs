...
{
    /// <summary>
    /// Response Unmarshaller for ListScheduledActions operation
    /// </summary>  
    public class ListScheduledActionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListScheduledActionsResponse response = new ListScheduledActionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ScheduledActions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ScheduledAction, ScheduledActionUnmarshaller>(ScheduledActionUnmarshaller.Instance);
                    response.ScheduledActions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListScheduledActionsResponseUnmarshaller _instance = new ListScheduledActionsResponseUnmarshaller();        

        internal static ListScheduledActionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListScheduledActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
