...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthorizedPrincipalUnmarshaller : IUnmarshaller<AuthorizedPrincipal, XmlUnmarshallerContext>, IUnmarshaller<AuthorizedPrincipal, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AuthorizedPrincipal IUnmarshaller<AuthorizedPrincipal, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AuthorizedPrincipal Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
