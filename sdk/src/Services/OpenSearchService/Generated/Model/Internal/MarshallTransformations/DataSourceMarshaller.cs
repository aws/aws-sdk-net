...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class DataSourceMarshaller : IRequestMarshaller<DataSource, JsonMarshallerContext> 
    {
        ...
        public void Marshall(DataSource requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDataSourceDescription())
            {
                context.Writer.WritePropertyName("dataSourceDescription");
                context.Writer.Write(requestObject.DataSourceDescription);
            }

            if(requestObject.IsSetIamRoleForDataSourceArn())
            {
                context.Writer.WritePropertyName("iamRoleForDataSourceArn");
                context.Writer.Write(requestObject.IamRoleForDataSourceArn);
            }
