...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePackageScope operation.
    /// </summary>
    public partial class UpdatePackageScopeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdatePackageScopeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PackageUserList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.PackageUserList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdatePackageScopeResponseUnmarshaller _instance = new UpdatePackageScopeResponseUnmarshaller();

        internal static UpdatePackageScopeResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePackageScopeResponseUnmarshaller Instance => _instance;
    }
}
