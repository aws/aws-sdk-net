...
{
    /// <summary>
    /// Response Unmarshaller for DescribeOutboundConnections operation.
    /// </summary>
    public partial class DescribeOutboundConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeOutboundConnectionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<OutboundConnection, OutboundConnectionUnmarshaller>(OutboundConnectionUnmarshaller.Instance);
        ...
        private static DescribeOutboundConnectionsResponseUnmarshaller _instance = new DescribeOutboundConnectionsResponseUnmarshaller();

        internal static DescribeOutboundConnectionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeOutboundConnectionsResponseUnmarshaller Instance => _instance;
    }
}
