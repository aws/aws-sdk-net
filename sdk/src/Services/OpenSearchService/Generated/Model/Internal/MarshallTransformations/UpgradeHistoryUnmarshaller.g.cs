...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpgradeHistoryUnmarshaller : IJsonUnmarshaller<UpgradeHistory, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public UpgradeHistory Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new UpgradeHistory();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UpgradeHistoryUnmarshaller Instance => _instance;
    }
}
