...
{
    /// <summary>
    /// Response Unmarshaller for ListMigrations operation
    /// </summary>  
    public class ListMigrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMigrationsResponse response = new ListMigrationsResponse();
            ...
            {
                if (context.TestExpression("migrations", targetDepth, ref reader))
                {
                    ...
                    response.Migrations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListMigrationsResponseUnmarshaller _instance = new ListMigrationsResponseUnmarshaller();        

        internal static ListMigrationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMigrationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
