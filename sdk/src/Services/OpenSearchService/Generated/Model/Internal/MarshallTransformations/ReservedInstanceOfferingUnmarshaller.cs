...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReservedInstanceOfferingUnmarshaller : IUnmarshaller<ReservedInstanceOffering, XmlUnmarshallerContext>, IUnmarshaller<ReservedInstanceOffering, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReservedInstanceOffering IUnmarshaller<ReservedInstanceOffering, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ReservedInstanceOffering Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReservedInstanceOfferingId = unmarshaller.Unmarshall(context);
                    continue;
                }
