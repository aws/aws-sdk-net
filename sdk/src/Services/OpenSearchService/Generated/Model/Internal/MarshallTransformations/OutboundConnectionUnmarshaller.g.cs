...
{
    /// <summary>
    /// Response Unmarshaller for OutboundConnection Object
    /// </summary>
    public partial class OutboundConnectionUnmarshaller : IJsonUnmarshaller<OutboundConnection, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public OutboundConnection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new OutboundConnection();
        ...
        private static OutboundConnectionUnmarshaller _instance = new OutboundConnectionUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static OutboundConnectionUnmarshaller Instance => _instance;
    }
}
