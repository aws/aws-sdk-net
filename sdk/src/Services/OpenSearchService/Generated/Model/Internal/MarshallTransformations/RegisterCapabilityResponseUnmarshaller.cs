...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterCapabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterCapabilityResponse response = new RegisterCapabilityResponse();
        ...
        internal static RegisterCapabilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterCapabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
