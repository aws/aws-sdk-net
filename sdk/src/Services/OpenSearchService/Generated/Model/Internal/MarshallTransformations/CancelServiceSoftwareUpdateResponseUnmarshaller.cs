...
{
    /// <summary>
    /// Response Unmarshaller for CancelServiceSoftwareUpdate operation
    /// </summary>  
    public class CancelServiceSoftwareUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelServiceSoftwareUpdateResponse response = new CancelServiceSoftwareUpdateResponse();
        ...
        private static CancelServiceSoftwareUpdateResponseUnmarshaller _instance = new CancelServiceSoftwareUpdateResponseUnmarshaller();        

        internal static CancelServiceSoftwareUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelServiceSoftwareUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
