...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterCapabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterCapabilityResponse response = new DeregisterCapabilityResponse();
        ...
        internal static DeregisterCapabilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterCapabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
