...
{
    /// <summary>
    /// Response Unmarshaller for GetUpgradeStatus operation.
    /// </summary>
    public partial class GetUpgradeStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetUpgradeStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UpgradeStep", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpgradeStep = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetUpgradeStatusResponseUnmarshaller _instance = new GetUpgradeStatusResponseUnmarshaller();

        internal static GetUpgradeStatusResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetUpgradeStatusResponseUnmarshaller Instance => _instance;
    }
}
