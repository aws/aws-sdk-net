...
{
    /// <summary>
    /// Response Unmarshaller for ListVpcEndpoints operation.
    /// </summary>
    public partial class ListVpcEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListVpcEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VpcEndpointSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<VpcEndpointSummary, VpcEndpointSummaryUnmarshaller>(VpcEndpointSummaryUnmarshaller.Instance);
                    unmarshalledObject.VpcEndpointSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListVpcEndpointsResponseUnmarshaller _instance = new ListVpcEndpointsResponseUnmarshaller();

        internal static ListVpcEndpointsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVpcEndpointsResponseUnmarshaller Instance => _instance;
    }
}
