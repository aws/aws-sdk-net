...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDomainConfig operation
    /// </summary>  
    public class DescribeDomainConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDomainConfigResponse response = new DescribeDomainConfigResponse();
        ...
        private static DescribeDomainConfigResponseUnmarshaller _instance = new DescribeDomainConfigResponseUnmarshaller();        

        internal static DescribeDomainConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDomainConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
