...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChangeProgressDetailsUnmarshaller : IJsonUnmarshaller<ChangeProgressDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChangeProgressDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ConfigChangeStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
