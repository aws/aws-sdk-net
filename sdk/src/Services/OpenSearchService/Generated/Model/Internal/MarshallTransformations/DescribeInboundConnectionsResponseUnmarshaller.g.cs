...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeInboundConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeInboundConnectionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InboundConnection, InboundConnectionUnmarshaller>(InboundConnectionUnmarshaller.Instance);
        ...
        internal static DescribeInboundConnectionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeInboundConnectionsResponseUnmarshaller Instance => _instance;
    }
}
