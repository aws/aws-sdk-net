...
{
    /// <summary>
    /// Response Unmarshaller for UpdateScheduledAction operation
    /// </summary>  
    public class UpdateScheduledActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateScheduledActionResponse response = new UpdateScheduledActionResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SlotNotAvailableException"))
                {
                    return SlotNotAvailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateScheduledActionResponseUnmarshaller _instance = new UpdateScheduledActionResponseUnmarshaller();        

        internal static UpdateScheduledActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateScheduledActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
