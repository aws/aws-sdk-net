...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    public class CreateApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("appConfigs", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AppConfig, AppConfigUnmarshaller>(AppConfigUnmarshaller.Instance);
                    response.AppConfigs = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("iamIdentityCenterOptions", targetDepth))
                {
                    ...
                    response.IamIdentityCenterOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
