...
{
    /// <summary>
    /// Response Unmarshaller for GetUpgradeHistory operation.
    /// </summary>
    public partial class GetUpgradeHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetUpgradeHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UpgradeHistories", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UpgradeHistory, UpgradeHistoryUnmarshaller>(UpgradeHistoryUnmarshaller.Instance);
                    unmarshalledObject.UpgradeHistories = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetUpgradeHistoryResponseUnmarshaller _instance = new GetUpgradeHistoryResponseUnmarshaller();

        internal static GetUpgradeHistoryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetUpgradeHistoryResponseUnmarshaller Instance => _instance;
    }
}
