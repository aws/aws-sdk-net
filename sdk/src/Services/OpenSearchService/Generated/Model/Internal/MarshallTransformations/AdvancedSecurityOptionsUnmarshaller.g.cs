...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AdvancedSecurityOptionsUnmarshaller : IJsonUnmarshaller<AdvancedSecurityOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AdvancedSecurityOptions();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("JWTOptions", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AdvancedSecurityOptionsUnmarshaller Instance => _instance;
    }
}
