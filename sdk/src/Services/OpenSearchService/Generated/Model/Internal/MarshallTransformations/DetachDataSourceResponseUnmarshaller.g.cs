...
{
    /// <summary>
    /// Response Unmarshaller for DetachDataSource operation.
    /// </summary>
    public partial class DetachDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DetachDataSourceResponse();
        ...
        private static DetachDataSourceResponseUnmarshaller _instance = new DetachDataSourceResponseUnmarshaller();

        internal static DetachDataSourceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DetachDataSourceResponseUnmarshaller Instance => _instance;
    }
}
