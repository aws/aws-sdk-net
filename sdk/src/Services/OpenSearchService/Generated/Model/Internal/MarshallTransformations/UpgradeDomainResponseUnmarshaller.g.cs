...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpgradeDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpgradeDomainResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PerformCheckOnly", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PerformCheckOnly = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpgradeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpgradeDomainResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpgradeDomainResponseUnmarshaller Instance => _instance;
    }
}
