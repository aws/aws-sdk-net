...
{
    /// <summary>
    /// Response Unmarshaller for RollbackServiceSoftwareUpdate operation
    /// </summary>  
    public class RollbackServiceSoftwareUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RollbackServiceSoftwareUpdateResponse response = new RollbackServiceSoftwareUpdateResponse();
        ...
        private static RollbackServiceSoftwareUpdateResponseUnmarshaller _instance = new RollbackServiceSoftwareUpdateResponseUnmarshaller();        

        internal static RollbackServiceSoftwareUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RollbackServiceSoftwareUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
