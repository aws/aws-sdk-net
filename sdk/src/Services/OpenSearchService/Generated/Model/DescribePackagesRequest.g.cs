...
{
    /// <summary>
    /// Container for the parameters to the DescribePackages operation. Describes all packages
    /// available to OpenSearch Service. For more information, see <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/custom-packages.html">Custom
    ...
    public partial class DescribePackagesRequest : AmazonOpenSearchServiceRequest
    {
        ...
        /// </summary>
        public List<DescribePackagesFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<DescribePackagesFilter>() : null;
