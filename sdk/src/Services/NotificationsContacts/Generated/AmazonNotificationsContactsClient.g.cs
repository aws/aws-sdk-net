...
namespace Amazon.NotificationsContacts
{
    ...
    public partial class AmazonNotificationsContactsClient : AmazonServiceClient, IAmazonNotificationsContacts
    {
        ...
        /// 
        /// </summary>
        public AmazonNotificationsContactsClient() : base(new AmazonNotificationsContactsConfig()) { }
        ...
        public AmazonNotificationsContactsClient(RegionEndpoint region) : base(new AmazonNotificationsContactsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonNotificationsContactsClient(AmazonNotificationsContactsConfig config) : base(config) { }
