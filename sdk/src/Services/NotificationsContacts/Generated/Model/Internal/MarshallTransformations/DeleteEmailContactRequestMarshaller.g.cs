...
namespace Amazon.NotificationsContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteEmailContactRequestMarshaller : IMarshaller<IRequest, DeleteEmailContactRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteEmailContactRequestMarshaller _instance = new();

        internal static DeleteEmailContactRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteEmailContactRequestMarshaller Instance => _instance;
    }
}
