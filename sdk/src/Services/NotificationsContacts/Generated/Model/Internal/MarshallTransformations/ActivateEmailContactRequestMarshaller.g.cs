...
namespace Amazon.NotificationsContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ActivateEmailContactRequestMarshaller : IMarshaller<IRequest, ActivateEmailContactRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ActivateEmailContactRequestMarshaller _instance = new();

        internal static ActivateEmailContactRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ActivateEmailContactRequestMarshaller Instance => _instance;
    }
}
