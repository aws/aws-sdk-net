...
namespace Amazon.NotificationsContacts.Model
{
    ...
    public interface IListEmailContactsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListEmailContactsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the EmailContacts
        /// </summary>
        IPaginatedEnumerable<EmailContact> EmailContacts { get; }
    }
}