...
namespace Amazon.Lambda
{
    ...
    /// <summary>
    /// Constants used for properties of type PropagateTagsMode.
    /// </summary>
    public class PropagateTagsMode : ConstantClass
    {

        /// <summary>
        /// Constant Explicit for PropagateTagsMode
        /// </summary>
        public static readonly PropagateTagsMode Explicit = new PropagateTagsMode("Explicit");
        /// <summary>
        /// Constant None for PropagateTagsMode
        /// </summary>
        public static readonly PropagateTagsMode None = new PropagateTagsMode("None");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public PropagateTagsMode(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static PropagateTagsMode FindValue(string value)
        {
            return FindValue<PropagateTagsMode>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator PropagateTagsMode(string value)
        {
            return FindValue(value);
        }
    }
    ...
    public class Runtime : ConstantClass
    {
        ...
        /// <summary>
        /// Constant Dotnet10 for Runtime
        /// </summary>
        public static readonly Runtime Dotnet10 = new Runtime("dotnet10");
        /// <summary>
        ...
        /// <summary>
        /// Constant Ruby40 for Runtime
        /// </summary>
        public static readonly Runtime Ruby40 = new Runtime("ruby4.0");
