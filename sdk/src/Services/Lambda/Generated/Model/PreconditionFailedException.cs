...
namespace Amazon.Lambda.Model
{
    ...
    public partial class PreconditionFailedException : AmazonLambdaException
    {
        ...
        public PreconditionFailedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PreconditionFailedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
