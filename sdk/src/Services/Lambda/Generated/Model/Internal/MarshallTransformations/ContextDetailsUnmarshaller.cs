...
namespace Amazon.Lambda.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContextDetailsUnmarshaller : IUnmarshaller<ContextDetails, XmlUnmarshallerContext>, IUnmarshaller<ContextDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ContextDetails IUnmarshaller<ContextDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ContextDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ReplayChildren", targetDepth))
                {
                    ...
                    unmarshalledObject.ReplayChildren = unmarshaller.Unmarshall(context);
                    continue;
                }
