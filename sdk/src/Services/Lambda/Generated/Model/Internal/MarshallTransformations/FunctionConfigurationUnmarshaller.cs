        ...
        public FunctionConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("CapacityProviderConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.CapacityProviderConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConfigSha256 = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("DurableConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.DurableConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
