...
{
    /// <summary>
    /// Response Unmarshaller for GetDurableExecutionHistory operation
    /// </summary>  
    public class GetDurableExecutionHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDurableExecutionHistoryResponse response = new GetDurableExecutionHistoryResponse();
        ...
        private static GetDurableExecutionHistoryResponseUnmarshaller _instance = new GetDurableExecutionHistoryResponseUnmarshaller();        

        internal static GetDurableExecutionHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDurableExecutionHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
