...
{
    /// <summary>
    /// Response Unmarshaller for GetDurableExecutionState operation
    /// </summary>  
    public class GetDurableExecutionStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDurableExecutionStateResponse response = new GetDurableExecutionStateResponse();
        ...
        private static GetDurableExecutionStateResponseUnmarshaller _instance = new GetDurableExecutionStateResponseUnmarshaller();        

        internal static GetDurableExecutionStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDurableExecutionStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
