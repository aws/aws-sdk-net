...
{
    /// <summary>
    /// Response Unmarshaller for ListLayerVersions operation
    /// </summary>  
    public class ListLayerVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("LayerVersions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LayerVersionsListItem, LayerVersionsListItemUnmarshaller>(LayerVersionsListItemUnmarshaller.Instance);
                    response.LayerVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListLayerVersionsResponseUnmarshaller _instance = new ListLayerVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLayerVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
