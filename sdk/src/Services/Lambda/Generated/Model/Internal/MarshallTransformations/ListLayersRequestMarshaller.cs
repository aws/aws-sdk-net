...
{
    /// <summary>
    /// ListLayers Request Marshaller
    /// </summary>       
    public class ListLayersRequestMarshaller : IMarshaller<IRequest, ListLayersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLayersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListLayersRequest publicRequest)
        {
        ...
        private static ListLayersRequestMarshaller _instance = new ListLayersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLayersRequestMarshaller Instance
        {
            get
            {
                return _instance;
