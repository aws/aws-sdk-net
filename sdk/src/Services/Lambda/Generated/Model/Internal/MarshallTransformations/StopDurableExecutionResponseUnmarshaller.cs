...
{
    /// <summary>
    /// Response Unmarshaller for StopDurableExecution operation
    /// </summary>  
    public class StopDurableExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopDurableExecutionResponse response = new StopDurableExecutionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("StopTimestamp", targetDepth))
                {
                    ...
                    response.StopTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StopDurableExecutionResponseUnmarshaller _instance = new StopDurableExecutionResponseUnmarshaller();        

        internal static StopDurableExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDurableExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
