...
{
    /// <summary>
    /// GetEventSource Request Marshaller
    /// </summary>       
    public class GetEventSourceRequestMarshaller : IMarshaller<IRequest, GetEventSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        public IRequest Marshall(AmazonWebServiceRequest input)
        {
            return this.Marshall((GetEventSourceRequest)input);
        }

        public IRequest Marshall(GetEventSourceRequest publicRequest)
        {
