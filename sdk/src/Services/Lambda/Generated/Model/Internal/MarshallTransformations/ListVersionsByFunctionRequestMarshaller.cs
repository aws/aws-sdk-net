...
{
    /// <summary>
    /// ListVersionsByFunction Request Marshaller
    /// </summary>       
    public class ListVersionsByFunctionRequestMarshaller : IMarshaller<IRequest, ListVersionsByFunctionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListVersionsByFunctionRequest)input);
        }
