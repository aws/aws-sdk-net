...
{
    /// <summary>
    /// DeleteLayerVersion Request Marshaller
    /// </summary>       
    public class DeleteLayerVersionRequestMarshaller : IMarshaller<IRequest, DeleteLayerVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteLayerVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteLayerVersionRequest publicRequest)
        {
        ...
        private static DeleteLayerVersionRequestMarshaller _instance = new DeleteLayerVersionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLayerVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
