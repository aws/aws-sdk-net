...
{
    /// <summary>
    /// Response Unmarshaller for PutFunctionRecursionConfig operation
    /// </summary>  
    public class PutFunctionRecursionConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutFunctionRecursionConfigResponse response = new PutFunctionRecursionConfigResponse();
        ...
        private static PutFunctionRecursionConfigResponseUnmarshaller _instance = new PutFunctionRecursionConfigResponseUnmarshaller();        

        internal static PutFunctionRecursionConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutFunctionRecursionConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
