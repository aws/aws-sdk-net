...
{
    /// <summary>
    /// Response Unmarshaller for GetFunctionEventInvokeConfig operation
    /// </summary>  
    public class GetFunctionEventInvokeConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFunctionEventInvokeConfigResponse response = new GetFunctionEventInvokeConfigResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MaximumEventAgeInSeconds", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.MaximumEventAgeInSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetFunctionEventInvokeConfigResponseUnmarshaller _instance = new GetFunctionEventInvokeConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFunctionEventInvokeConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
