...
{
    /// <summary>
    /// Response Unmarshaller for GetDurableExecution operation
    /// </summary>  
    public class GetDurableExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDurableExecutionResponse response = new GetDurableExecutionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DurableExecutionArn", targetDepth, ref reader))
                {
                    ...
                    response.DurableExecutionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DurableExecutionName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DurableExecutionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EndTimestamp", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.EndTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ExecutionDataIncluded", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.ExecutionDataIncluded = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("InputPayload", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InputPayload = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TraceHeader", targetDepth, ref reader))
                {
                    var unmarshaller = TraceHeaderUnmarshaller.Instance;
                    response.TraceHeader = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetDurableExecutionResponseUnmarshaller _instance = new GetDurableExecutionResponseUnmarshaller();        

        internal static GetDurableExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDurableExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
