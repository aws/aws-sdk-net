...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFunctionUrlConfig operation
    /// </summary>  
    public class UpdateFunctionUrlConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFunctionUrlConfigResponse response = new UpdateFunctionUrlConfigResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Cors", targetDepth, ref reader))
                {
                    var unmarshaller = CorsUnmarshaller.Instance;
                    response.Cors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("FunctionUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FunctionUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("InvokeMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InvokeMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateFunctionUrlConfigResponseUnmarshaller _instance = new UpdateFunctionUrlConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFunctionUrlConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
