...
{
    /// <summary>
    /// TargetTrackingScalingPolicy Marshaller
    /// </summary>
    public class TargetTrackingScalingPolicyMarshaller : IRequestMarshaller<TargetTrackingScalingPolicy, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TargetTrackingScalingPolicy requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static TargetTrackingScalingPolicyMarshaller Instance = new TargetTrackingScalingPolicyMarshaller();
