...
namespace Amazon.Lambda
{
    ...
    public partial class AmazonLambdaClient : AmazonServiceClient, IAmazonLambda
    {
        ...
        internal virtual GetPublicAccessBlockConfigResponse GetPublicAccessBlockConfig(GetPublicAccessBlockConfigRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual PutPublicAccessBlockConfigResponse PutPublicAccessBlockConfig(PutPublicAccessBlockConfigRequest request)
        {
            var options = new InvokeOptions();
