...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidWebACLIdException : AmazonCloudFrontException
    {
        ...
        /// <summary>
        /// Default constructor for InvalidWebACLIdException
        /// message.
        /// </summary>
        public InvalidWebACLIdException() 
            : base() {}
        ...
        public InvalidWebACLIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidWebACLIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
