...
{
    /// <summary>
    /// Container for the parameters to the ListDistributionsByOwnedResource operation.
    /// Lists the CloudFront distributions that are associated with the specified resource
    /// that you own.
    /// </summary>
    public partial class ListDistributionsByOwnedResourceRequest : AmazonCloudFrontRequest
    {
        ...
        /// <para>
        /// The ARN of the CloudFront resource that you've shared with other Amazon Web Services
        /// accounts.
        /// </para>
        /// </summary>
