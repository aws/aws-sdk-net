...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchOriginRequestPolicyException : AmazonCloudFrontException
    {
        ...
        /// <summary>
        /// Default constructor for NoSuchOriginRequestPolicyException
        /// message.
        /// </summary>
        public NoSuchOriginRequestPolicyException() 
            : base() {}
        ...
        public NoSuchOriginRequestPolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchOriginRequestPolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
