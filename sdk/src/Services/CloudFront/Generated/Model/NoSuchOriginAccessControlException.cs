...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchOriginAccessControlException : AmazonCloudFrontException
    {
        ...
        /// <summary>
        /// Default constructor for NoSuchOriginAccessControlException
        /// message.
        /// </summary>
        public NoSuchOriginAccessControlException() 
            : base() {}
        ...
        public NoSuchOriginAccessControlException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchOriginAccessControlException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
