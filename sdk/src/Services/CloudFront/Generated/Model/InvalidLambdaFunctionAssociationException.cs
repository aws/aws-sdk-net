...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidLambdaFunctionAssociationException : AmazonCloudFrontException
    {
        ...
        public InvalidLambdaFunctionAssociationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidLambdaFunctionAssociationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
