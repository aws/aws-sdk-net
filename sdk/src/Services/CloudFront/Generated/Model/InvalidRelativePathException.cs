...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidRelativePathException : AmazonCloudFrontException
    {
        ...
        public InvalidRelativePathException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRelativePathException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
