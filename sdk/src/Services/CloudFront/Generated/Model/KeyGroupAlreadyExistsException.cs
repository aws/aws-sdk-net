...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class KeyGroupAlreadyExistsException : AmazonCloudFrontException
    {
        ...
        /// <summary>
        /// Default constructor for KeyGroupAlreadyExistsException
        /// message.
        /// </summary>
        public KeyGroupAlreadyExistsException() 
            : base() {}
        ...
        public KeyGroupAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KeyGroupAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
