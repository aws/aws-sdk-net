...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class ResponseHeadersPolicySummary
    {
        ...
        /// <para>
        /// The type of response headers policy, either <code>managed</code> (created by Amazon
        /// Web Services) or <code>custom</code> (created in this Amazon Web Services account).
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
