...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchDistributionException : AmazonCloudFrontException
    {
        ...
        public NoSuchDistributionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchDistributionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
