...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidQueryStringParametersException : AmazonCloudFrontException
    {
        ...
        public InvalidQueryStringParametersException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidQueryStringParametersException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
