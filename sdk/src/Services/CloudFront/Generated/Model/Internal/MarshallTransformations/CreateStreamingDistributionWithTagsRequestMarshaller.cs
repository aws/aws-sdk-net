...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class CreateStreamingDistributionWithTagsRequestMarshaller : IMarshaller<IRequest, CreateStreamingDistributionWithTagsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateStreamingDistributionWithTagsRequest publicRequest)
        {
            ...
            {   
                xmlWriter.WriteStartElement("StreamingDistributionConfigWithTags", "http://cloudfront.amazonaws.com/doc/2016-08-20/");                                
                ...
                if (publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig != null) 
                {
                    ...
                    if (publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Aliases != null) 
                    {
                        ...
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Aliases.IsSetQuantity())
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromInt(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Aliases.Quantity));                 
        
                        xmlWriter.WriteEndElement();
                    }
                    if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.IsSetCallerReference())
                        xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.CallerReference));                 
    
                    if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.IsSetComment())
                        xmlWriter.WriteElementString("Comment", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Comment));                 
    
                    if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.IsSetEnabled())
                        xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromBool(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Enabled));                 
                    ...
                    if (publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging != null) 
                    {
                        ...
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging.IsSetBucket())
                            xmlWriter.WriteElementString("Bucket", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging.Bucket));                 
        
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging.IsSetEnabled())
                            xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromBool(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging.Enabled));                 
        
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging.IsSetPrefix())
                            xmlWriter.WriteElementString("Prefix", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.Logging.Prefix));                 
        
                        xmlWriter.WriteEndElement();
                    }
                    if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.IsSetPriceClass())
                        xmlWriter.WriteElementString("PriceClass", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.PriceClass));                 
                    ...
                    if (publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.S3Origin != null) 
                    {
                        ...
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.S3Origin.IsSetDomainName())
                            xmlWriter.WriteElementString("DomainName", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.S3Origin.DomainName));                 
        
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.S3Origin.IsSetOriginAccessIdentity())
                            xmlWriter.WriteElementString("OriginAccessIdentity", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.S3Origin.OriginAccessIdentity));                 
                    ...
                    if (publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.TrustedSigners != null) 
                    {
                        ...
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.TrustedSigners.IsSetEnabled())
                            xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromBool(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.TrustedSigners.Enabled));                 
                        ...
                        if(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.TrustedSigners.IsSetQuantity())
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromInt(publicRequest.StreamingDistributionConfigWithTags.StreamingDistributionConfig.TrustedSigners.Quantity));                 
                    ...
                    {                        
                        ...
                        if (publicRequestStreamingDistributionConfigWithTagsTagsItemsValue != null) 
                        {
                            ...
                            if(publicRequestStreamingDistributionConfigWithTagsTagsItemsValue.IsSetKey())
                                xmlWriter.WriteElementString("Key", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequestStreamingDistributionConfigWithTagsTagsItemsValue.Key));                 
            
                            if(publicRequestStreamingDistributionConfigWithTagsTagsItemsValue.IsSetValue())
                                xmlWriter.WriteElementString("Value", "http://cloudfront.amazonaws.com/doc/2016-08-20/", StringUtils.FromString(publicRequestStreamingDistributionConfigWithTagsTagsItemsValue.Value));                 
