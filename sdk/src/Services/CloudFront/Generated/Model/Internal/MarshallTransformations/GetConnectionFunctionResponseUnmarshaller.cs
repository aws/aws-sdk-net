...
{
    /// <summary>
    /// Response Unmarshaller for GetConnectionFunction operation
    /// </summary>  
    public partial class GetConnectionFunctionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConnectionFunctionResponse response = new GetConnectionFunctionResponse();

            var ms = new MemoryStream();
            Amazon.Util.AWSSDKUtils.CopyStream(context.Stream, ms);
            ms.Seek(0, SeekOrigin.Begin);
            if (ms.Length > 0)
                response.ConnectionFunctionCode = ms;
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetConnectionFunctionResponse response);

        private static GetConnectionFunctionResponseUnmarshaller _instance = new GetConnectionFunctionResponseUnmarshaller();        

        internal static GetConnectionFunctionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectionFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
