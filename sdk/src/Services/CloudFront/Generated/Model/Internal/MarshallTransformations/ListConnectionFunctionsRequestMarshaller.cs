...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListConnectionFunctionsRequestMarshaller : IMarshaller<IRequest, ListConnectionFunctionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListConnectionFunctionsRequest publicRequest)
        {
            ...
            {   
                ...
                if(publicRequest.IsSetMaxItems())
                    xmlWriter.WriteElementString("MaxItems", StringUtils.FromInt(publicRequest.MaxItems));
