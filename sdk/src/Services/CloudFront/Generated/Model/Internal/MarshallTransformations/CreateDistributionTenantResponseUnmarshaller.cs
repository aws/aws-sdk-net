...
{
    /// <summary>
    /// Response Unmarshaller for CreateDistributionTenant operation
    /// </summary>  
    public partial class CreateDistributionTenantResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDistributionTenantResponse response = new CreateDistributionTenantResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateDistributionTenantResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("DistributionTenant", targetDepth))
                    {
                        var unmarshaller = DistributionTenantUnmarshaller.Instance;
                        response.DistributionTenant = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidAssociation"))
                {
                    return InvalidAssociationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CreateDistributionTenantResponse response);

        private static CreateDistributionTenantResponseUnmarshaller _instance = new CreateDistributionTenantResponseUnmarshaller();        

        internal static CreateDistributionTenantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDistributionTenantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
