                ...
                {                        
                    ...
                    if (publicRequestTagsItemsValue != null) 
                    {
                        ...
                        if(publicRequestTagsItemsValue.IsSetKey())
                            xmlWriter.WriteElementString("Key", "http://cloudfront.amazonaws.com/doc/2016-09-29/", StringUtils.FromString(publicRequestTagsItemsValue.Key));                 
        
                        if(publicRequestTagsItemsValue.IsSetValue())
                            xmlWriter.WriteElementString("Value", "http://cloudfront.amazonaws.com/doc/2016-09-29/", StringUtils.FromString(publicRequestTagsItemsValue.Value));                 
