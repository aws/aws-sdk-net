...
{
    /// <summary>
    /// CreateKeyGroup Request Marshaller
    /// </summary>       
    public partial class CreateKeyGroupRequestMarshaller : IMarshaller<IRequest, CreateKeyGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateKeyGroupRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKeyGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
