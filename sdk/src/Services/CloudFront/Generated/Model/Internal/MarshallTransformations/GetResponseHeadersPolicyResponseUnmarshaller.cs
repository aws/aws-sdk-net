...
{
    /// <summary>
    /// Response Unmarshaller for GetResponseHeadersPolicy operation
    /// </summary>  
    public partial class GetResponseHeadersPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResponseHeadersPolicyResponse response = new GetResponseHeadersPolicyResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("ResponseHeadersPolicy", targetDepth))
                    {
                        ...
                        response.ResponseHeadersPolicy = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetResponseHeadersPolicyResponse response);

        private static GetResponseHeadersPolicyResponseUnmarshaller _instance = new GetResponseHeadersPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResponseHeadersPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
