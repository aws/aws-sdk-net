...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class PublicKeyAlreadyExistsExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<PublicKeyAlreadyExistsException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PublicKeyAlreadyExistsException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static PublicKeyAlreadyExistsExceptionUnmarshaller _instance = new PublicKeyAlreadyExistsExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PublicKeyAlreadyExistsExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
