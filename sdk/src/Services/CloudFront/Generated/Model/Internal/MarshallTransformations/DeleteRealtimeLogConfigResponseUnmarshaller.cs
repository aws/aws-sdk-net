    ...
    public class DeleteRealtimeLogConfigResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("RealtimeLogConfigInUse"))
                {
                    return RealtimeLogConfigInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRealtimeLogConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
