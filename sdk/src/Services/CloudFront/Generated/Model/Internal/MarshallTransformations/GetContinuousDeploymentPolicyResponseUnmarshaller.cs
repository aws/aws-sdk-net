...
{
    /// <summary>
    /// Response Unmarshaller for GetContinuousDeploymentPolicy operation
    /// </summary>  
    public partial class GetContinuousDeploymentPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContinuousDeploymentPolicyResponse response = new GetContinuousDeploymentPolicyResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetContinuousDeploymentPolicyResponse response);

        private static GetContinuousDeploymentPolicyResponseUnmarshaller _instance = new GetContinuousDeploymentPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContinuousDeploymentPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
