...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class CloudFrontOriginAccessIdentityListUnmarshaller : IXmlUnmarshaller<CloudFrontOriginAccessIdentityList, XmlUnmarshallerContext>
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Items/CloudFrontOriginAccessIdentitySummary", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Items = new List<CloudFrontOriginAccessIdentitySummary>();
                        }
                        var unmarshaller = CloudFrontOriginAccessIdentitySummaryUnmarshaller.Instance;
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, CloudFrontOriginAccessIdentityList unmarshalledObject, int targetDepth);

        private static CloudFrontOriginAccessIdentityListUnmarshaller _instance = new CloudFrontOriginAccessIdentityListUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CloudFrontOriginAccessIdentityListUnmarshaller Instance
        {
            get
            {
                return _instance;
