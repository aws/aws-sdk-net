...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrustStore operation
    /// </summary>  
    public partial class CreateTrustStoreResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTrustStoreResponse response = new CreateTrustStoreResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("TrustStore", targetDepth))
                    {
                        ...
                        response.TrustStore = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CreateTrustStoreResponse response);

        private static CreateTrustStoreResponseUnmarshaller _instance = new CreateTrustStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrustStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
