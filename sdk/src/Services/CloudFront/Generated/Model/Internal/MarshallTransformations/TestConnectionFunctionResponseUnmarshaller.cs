...
{
    /// <summary>
    /// Response Unmarshaller for TestConnectionFunction operation
    /// </summary>  
    public partial class TestConnectionFunctionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestConnectionFunctionResponse response = new TestConnectionFunctionResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, TestConnectionFunctionResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("ConnectionFunctionTestResult", targetDepth))
                    {
                        var unmarshaller = ConnectionFunctionTestResultUnmarshaller.Instance;
                        response.ConnectionFunctionTestResult = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, TestConnectionFunctionResponse response);

        private static TestConnectionFunctionResponseUnmarshaller _instance = new TestConnectionFunctionResponseUnmarshaller();        

        internal static TestConnectionFunctionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestConnectionFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
