...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class UpdateConnectionGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            UpdateConnectionGroupResponse response = new UpdateConnectionGroupResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateConnectionGroupResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("ConnectionGroup", targetDepth))
                    {
                        var unmarshaller = ConnectionGroupUnmarshaller.Instance;
                        response.ConnectionGroup = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        internal static UpdateConnectionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConnectionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
