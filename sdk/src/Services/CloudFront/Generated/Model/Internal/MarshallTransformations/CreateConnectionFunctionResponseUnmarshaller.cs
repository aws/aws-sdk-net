...
{
    /// <summary>
    /// Response Unmarshaller for CreateConnectionFunction operation
    /// </summary>  
    public partial class CreateConnectionFunctionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConnectionFunctionResponse response = new CreateConnectionFunctionResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateConnectionFunctionResponse response)
        {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CreateConnectionFunctionResponse response);

        private static CreateConnectionFunctionResponseUnmarshaller _instance = new CreateConnectionFunctionResponseUnmarshaller();        

        internal static CreateConnectionFunctionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConnectionFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
