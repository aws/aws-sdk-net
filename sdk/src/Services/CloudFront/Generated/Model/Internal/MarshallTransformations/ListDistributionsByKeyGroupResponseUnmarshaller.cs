...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class ListDistributionsByKeyGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListDistributionsByKeyGroupResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = DistributionIdListUnmarshaller.Instance;
                        response.DistributionIdList = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDistributionsByKeyGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
