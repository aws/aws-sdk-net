...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConnectionFunction operation
    /// </summary>  
    public partial class DeleteConnectionFunctionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConnectionFunctionResponse response = new DeleteConnectionFunctionResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, DeleteConnectionFunctionResponse response);

        private static DeleteConnectionFunctionResponseUnmarshaller _instance = new DeleteConnectionFunctionResponseUnmarshaller();        

        internal static DeleteConnectionFunctionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConnectionFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
