...
{
    /// <summary>
    /// CreateInvalidationForDistributionTenant Request Marshaller
    /// </summary>       
    public partial class CreateInvalidationForDistributionTenantRequestMarshaller : IMarshaller<IRequest, CreateInvalidationForDistributionTenantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateInvalidationForDistributionTenantRequest)input);
        }
        ...
        internal static CreateInvalidationForDistributionTenantRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInvalidationForDistributionTenantRequestMarshaller Instance
        {
            get
            {
                return _instance;
