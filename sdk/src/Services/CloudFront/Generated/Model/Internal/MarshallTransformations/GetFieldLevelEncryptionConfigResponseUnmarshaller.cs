...
{
    /// <summary>
    /// Response Unmarshaller for GetFieldLevelEncryptionConfig operation
    /// </summary>  
    public partial class GetFieldLevelEncryptionConfigResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFieldLevelEncryptionConfigResponse response = new GetFieldLevelEncryptionConfigResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("FieldLevelEncryptionConfig", targetDepth))
                    {
                        ...
                        response.FieldLevelEncryptionConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetFieldLevelEncryptionConfigResponse response);

        private static GetFieldLevelEncryptionConfigResponseUnmarshaller _instance = new GetFieldLevelEncryptionConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFieldLevelEncryptionConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
