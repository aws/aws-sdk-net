...
{
    /// <summary>
    /// Response Unmarshaller for UpdateKeyValueStore operation
    /// </summary>  
    public partial class UpdateKeyValueStoreResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateKeyValueStoreResponse response = new UpdateKeyValueStoreResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateKeyValueStoreResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = KeyValueStoreUnmarshaller.Instance;
                        response.KeyValueStore = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateKeyValueStoreResponse response);

        private static UpdateKeyValueStoreResponseUnmarshaller _instance = new UpdateKeyValueStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKeyValueStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
