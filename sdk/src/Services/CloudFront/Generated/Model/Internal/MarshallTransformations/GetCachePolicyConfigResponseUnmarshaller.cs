...
{
    /// <summary>
    /// Response Unmarshaller for GetCachePolicyConfig operation
    /// </summary>  
    public partial class GetCachePolicyConfigResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCachePolicyConfigResponse response = new GetCachePolicyConfigResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("CachePolicyConfig", targetDepth))
                    {
                        ...
                        response.CachePolicyConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetCachePolicyConfigResponse response);

        private static GetCachePolicyConfigResponseUnmarshaller _instance = new GetCachePolicyConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCachePolicyConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
