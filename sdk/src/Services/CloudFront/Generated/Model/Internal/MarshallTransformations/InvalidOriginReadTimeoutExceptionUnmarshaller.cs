...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidOriginReadTimeoutExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<InvalidOriginReadTimeoutException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InvalidOriginReadTimeoutException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static InvalidOriginReadTimeoutExceptionUnmarshaller _instance = new InvalidOriginReadTimeoutExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvalidOriginReadTimeoutExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
