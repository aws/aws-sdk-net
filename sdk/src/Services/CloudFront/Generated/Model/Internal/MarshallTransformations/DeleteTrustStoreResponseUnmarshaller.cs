...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTrustStore operation
    /// </summary>  
    public partial class DeleteTrustStoreResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTrustStoreResponse response = new DeleteTrustStoreResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, DeleteTrustStoreResponse response);

        private static DeleteTrustStoreResponseUnmarshaller _instance = new DeleteTrustStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrustStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
