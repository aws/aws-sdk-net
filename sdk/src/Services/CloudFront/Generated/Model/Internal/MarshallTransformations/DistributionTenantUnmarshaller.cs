...
{
    /// <summary>
    /// Response Unmarshaller for DistributionTenant Object
    /// </summary>  
    public partial class DistributionTenantUnmarshaller : IXmlUnmarshaller<DistributionTenant, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DistributionTenant Unmarshall(XmlUnmarshallerContext context)
        {
            DistributionTenant unmarshalledObject = new DistributionTenant();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Parameters/member", targetDepth))
                    {
                        ...
                        unmarshalledObject.Parameters.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = TagsUnmarshaller.Instance;
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, DistributionTenant unmarshalledObject, int targetDepth);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DistributionTenantUnmarshaller Instance
        {
            get
            {
                return _instance;
