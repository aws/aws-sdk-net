...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class DistributionListUnmarshaller : IXmlUnmarshaller<DistributionList, XmlUnmarshallerContext>
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Items/DistributionSummary", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Items = new List<DistributionSummary>();
                        }
                        var unmarshaller = DistributionSummaryUnmarshaller.Instance;
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, DistributionList unmarshalledObject, int targetDepth);
