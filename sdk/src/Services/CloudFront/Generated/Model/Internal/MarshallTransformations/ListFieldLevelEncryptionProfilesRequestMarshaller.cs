...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListFieldLevelEncryptionProfilesRequestMarshaller : IMarshaller<IRequest, ListFieldLevelEncryptionProfilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((ListFieldLevelEncryptionProfilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListFieldLevelEncryptionProfilesRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFieldLevelEncryptionProfilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
        ...
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, ListFieldLevelEncryptionProfilesRequest publicRequest);
    }    
}