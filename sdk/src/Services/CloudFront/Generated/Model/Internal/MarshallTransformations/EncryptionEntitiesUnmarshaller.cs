...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class EncryptionEntitiesUnmarshaller : IXmlUnmarshaller<EncryptionEntities, XmlUnmarshallerContext>
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("Items/EncryptionEntity", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Items = new List<EncryptionEntity>();
                        }
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, EncryptionEntities unmarshalledObject, int targetDepth);
