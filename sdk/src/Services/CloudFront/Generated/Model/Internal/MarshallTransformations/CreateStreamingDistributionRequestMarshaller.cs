...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class CreateStreamingDistributionRequestMarshaller : IMarshaller<IRequest, CreateStreamingDistributionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateStreamingDistributionRequest publicRequest)
        {
            ...
            {   
                xmlWriter.WriteStartElement("StreamingDistributionConfig", "http://cloudfront.amazonaws.com/doc/2016-08-01/");                                
                ...
                if (publicRequest.StreamingDistributionConfig.Aliases != null) 
                {
                    ...
                    if(publicRequest.StreamingDistributionConfig.Aliases.IsSetQuantity())
                        xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromInt(publicRequest.StreamingDistributionConfig.Aliases.Quantity));                 
    
                    xmlWriter.WriteEndElement();
                }
                if(publicRequest.StreamingDistributionConfig.IsSetCallerReference())
                    xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.CallerReference));                    

                if(publicRequest.StreamingDistributionConfig.IsSetComment())
                    xmlWriter.WriteElementString("Comment", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.Comment));                    

                if(publicRequest.StreamingDistributionConfig.IsSetEnabled())
                    xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromBool(publicRequest.StreamingDistributionConfig.Enabled));                    
                ...
                if (publicRequest.StreamingDistributionConfig.Logging != null) 
                {
                    ...
                    if(publicRequest.StreamingDistributionConfig.Logging.IsSetBucket())
                        xmlWriter.WriteElementString("Bucket", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.Logging.Bucket));                 
    
                    if(publicRequest.StreamingDistributionConfig.Logging.IsSetEnabled())
                        xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromBool(publicRequest.StreamingDistributionConfig.Logging.Enabled));                 
    
                    if(publicRequest.StreamingDistributionConfig.Logging.IsSetPrefix())
                        xmlWriter.WriteElementString("Prefix", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.Logging.Prefix));                 
    
                    xmlWriter.WriteEndElement();
                }
                if(publicRequest.StreamingDistributionConfig.IsSetPriceClass())
                    xmlWriter.WriteElementString("PriceClass", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.PriceClass));                    

                
                if (publicRequest.StreamingDistributionConfig.S3Origin != null) 
                {
                    xmlWriter.WriteStartElement("S3Origin", "http://cloudfront.amazonaws.com/doc/2016-08-01/");            
                    if(publicRequest.StreamingDistributionConfig.S3Origin.IsSetDomainName())
                        xmlWriter.WriteElementString("DomainName", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.S3Origin.DomainName));                 
    
                    if(publicRequest.StreamingDistributionConfig.S3Origin.IsSetOriginAccessIdentity())
                        xmlWriter.WriteElementString("OriginAccessIdentity", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromString(publicRequest.StreamingDistributionConfig.S3Origin.OriginAccessIdentity));                 
                ...
                if (publicRequest.StreamingDistributionConfig.TrustedSigners != null) 
                {
                    ...
                    if(publicRequest.StreamingDistributionConfig.TrustedSigners.IsSetEnabled())
                        xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromBool(publicRequest.StreamingDistributionConfig.TrustedSigners.Enabled));                 
                    ...
                    if(publicRequest.StreamingDistributionConfig.TrustedSigners.IsSetQuantity())
                        xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2016-08-01/", StringUtils.FromInt(publicRequest.StreamingDistributionConfig.TrustedSigners.Quantity));                 
