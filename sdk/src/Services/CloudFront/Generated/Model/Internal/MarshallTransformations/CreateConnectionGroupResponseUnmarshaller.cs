...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class CreateConnectionGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            CreateConnectionGroupResponse response = new CreateConnectionGroupResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateConnectionGroupResponse response)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConnectionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
