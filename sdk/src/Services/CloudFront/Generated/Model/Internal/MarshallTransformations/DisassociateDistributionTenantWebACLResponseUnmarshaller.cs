...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class DisassociateDistributionTenantWebACLResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            DisassociateDistributionTenantWebACLResponse response = new DisassociateDistributionTenantWebACLResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DisassociateDistributionTenantWebACLResponse response)
        {
        ...
        internal static DisassociateDistributionTenantWebACLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateDistributionTenantWebACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
