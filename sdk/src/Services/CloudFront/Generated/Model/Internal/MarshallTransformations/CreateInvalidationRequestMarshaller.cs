...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class CreateInvalidationRequestMarshaller : IMarshaller<IRequest, CreateInvalidationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateInvalidationRequest publicRequest)
        {
            ...
            {   
                xmlWriter.WriteStartElement("InvalidationBatch", "http://cloudfront.amazonaws.com/doc/2016-11-25/");                                
                if(publicRequest.InvalidationBatch.IsSetCallerReference())
                    xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2016-11-25/", StringUtils.FromString(publicRequest.InvalidationBatch.CallerReference));                    

                
                if (publicRequest.InvalidationBatch.Paths != null) 
                {
                    xmlWriter.WriteStartElement("Paths", "http://cloudfront.amazonaws.com/doc/2016-11-25/");            
                    ...
                    {                        
                        ...
                        {
                            xmlWriter.WriteStartElement("Path", "http://cloudfront.amazonaws.com/doc/2016-11-25/");
                    ...
                    if(publicRequest.InvalidationBatch.Paths.IsSetQuantity())
                        xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2016-11-25/", StringUtils.FromInt(publicRequest.InvalidationBatch.Paths.Quantity));                 
