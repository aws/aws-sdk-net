...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class CreateInvalidationRequestMarshaller : IMarshaller<IRequest, CreateInvalidationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateInvalidationRequest publicRequest)
        {
            ...
            string uriResourcePath = "/2015-07-27/distribution/{DistributionId}/invalidation";
            ...
            {   
                xmlWriter.WriteStartElement("InvalidationBatch", "http://cloudfront.amazonaws.com/doc/2015-07-27/");                                
                if(publicRequest.InvalidationBatch.IsSetCallerReference())
                    xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2015-07-27/", StringUtils.FromString(publicRequest.InvalidationBatch.CallerReference));                    

                
                if (publicRequest.InvalidationBatch.Paths != null) 
                {
                    xmlWriter.WriteStartElement("Paths", "http://cloudfront.amazonaws.com/doc/2015-07-27/");            
                    ...
                    {                        
                        ...
                        {
                            xmlWriter.WriteStartElement("Path", "http://cloudfront.amazonaws.com/doc/2015-07-27/");
                    ...
                    if(publicRequest.InvalidationBatch.Paths.IsSetQuantity())
                        xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2015-07-27/", StringUtils.FromInt(publicRequest.InvalidationBatch.Paths.Quantity));                 
