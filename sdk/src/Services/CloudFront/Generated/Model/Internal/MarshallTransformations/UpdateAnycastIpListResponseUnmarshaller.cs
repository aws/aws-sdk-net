...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAnycastIpList operation
    /// </summary>  
    public partial class UpdateAnycastIpListResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAnycastIpListResponse response = new UpdateAnycastIpListResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateAnycastIpListResponse response)
        {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateAnycastIpListResponse response);

        private static UpdateAnycastIpListResponseUnmarshaller _instance = new UpdateAnycastIpListResponseUnmarshaller();        

        internal static UpdateAnycastIpListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAnycastIpListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
