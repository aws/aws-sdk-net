...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidFunctionAssociationException : AmazonCloudFrontException
    {
        ...
        /// <summary>
        /// Default constructor for InvalidFunctionAssociationException
        /// message.
        /// </summary>
        public InvalidFunctionAssociationException() 
            : base() {}
        ...
        public InvalidFunctionAssociationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidFunctionAssociationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
