...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchContinuousDeploymentPolicyException : AmazonCloudFrontException
    {
        ...
        public NoSuchContinuousDeploymentPolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchContinuousDeploymentPolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
