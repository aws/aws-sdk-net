...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InconsistentQuantitiesException : AmazonCloudFrontException
    {
        ...
        public InconsistentQuantitiesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InconsistentQuantitiesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
