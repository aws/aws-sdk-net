...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidOriginException : AmazonCloudFrontException
    {
        ...
        public InvalidOriginException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOriginException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
