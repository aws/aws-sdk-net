...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidOriginAccessIdentityException : AmazonCloudFrontException
    {
        ...
        public InvalidOriginAccessIdentityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOriginAccessIdentityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
