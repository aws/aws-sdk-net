...
namespace Amazon.IoTSecureTunneling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DestinationConfigUnmarshaller : IJsonUnmarshaller<DestinationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DestinationConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
