...
namespace Amazon.EKS
{
    ...
    public partial class AmazonEKSClient : AmazonServiceClient, IAmazonEKS
    {
        ...
        public virtual ActivateCertificateAuthorityResponse ActivateCertificateAuthority(ActivateCertificateAuthorityRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ActivateCertificateAuthorityRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ActivateCertificateAuthorityResponseUnmarshaller.Instance;

            return Invoke<ActivateCertificateAuthorityResponse>(request, options);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/ActivateCertificateAuthority">REST API Reference for ActivateCertificateAuthority Operation</seealso>
        public virtual Task<ActivateCertificateAuthorityResponse> ActivateCertificateAuthorityAsync(ActivateCertificateAuthorityRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ActivateCertificateAuthorityRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ActivateCertificateAuthorityResponseUnmarshaller.Instance;
            
            return InvokeAsync<ActivateCertificateAuthorityResponse>(request, options, cancellationToken);
        }
        ...
        /// </para>
        /// </summary>
        /// <param name="request">Container for the necessary parameters to execute the CancelUpdate service method.</param>
        /// 
        /// <returns>The response from the CancelUpdate service method, as returned by EKS.</returns>
        /// <exception cref="Amazon.EKS.Model.ClientException">
        /// These errors are usually caused by a client action. Actions can include using an action
        /// or resource on behalf of an <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html">IAM
        /// principal</a> that doesn't have permissions to use the action or resource or specifying
        ...
        /// The request or operation couldn't be performed because a service is throttling requests.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/CancelUpdate">REST API Reference for CancelUpdate Operation</seealso>
        public virtual CancelUpdateResponse CancelUpdate(CancelUpdateRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = CancelUpdateRequestMarshaller.Instance;
            options.ResponseUnmarshaller = CancelUpdateResponseUnmarshaller.Instance;

            return Invoke<CancelUpdateResponse>(request, options);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/CancelUpdate">REST API Reference for CancelUpdate Operation</seealso>
        public virtual Task<CancelUpdateResponse> CancelUpdateAsync(CancelUpdateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = CancelUpdateRequestMarshaller.Instance;
            options.ResponseUnmarshaller = CancelUpdateResponseUnmarshaller.Instance;
            
            return InvokeAsync<CancelUpdateResponse>(request, options, cancellationToken);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/DescribeCapability">REST API Reference for DescribeCapability Operation</seealso>
        public virtual Task<DescribeCapabilityResponse> DescribeCapabilityAsync(DescribeCapabilityRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = DescribeCapabilityRequestMarshaller.Instance;
            options.ResponseUnmarshaller = DescribeCapabilityResponseUnmarshaller.Instance;
            
            return InvokeAsync<DescribeCapabilityResponse>(request, options, cancellationToken);
        }
