...
namespace Amazon.EKS
{
    ...
    public partial class AmazonEKSClient : AmazonServiceClient, IAmazonEKS
    {
        ...
        internal virtual ActivateCertificateAuthorityResponse ActivateCertificateAuthority(ActivateCertificateAuthorityRequest request)
        {
        ...
        internal virtual CancelUpdateResponse CancelUpdate(CancelUpdateRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual DescribeCapabilityResponse DescribeCapability(DescribeCapabilityRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
