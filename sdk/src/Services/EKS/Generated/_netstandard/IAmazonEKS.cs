...
namespace Amazon.EKS
{
    ...
    public partial interface IAmazonEKS : IAmazonService, IDisposable
    {
        ...
        Task<ActivateCertificateAuthorityResponse> ActivateCertificateAuthorityAsync(ActivateCertificateAuthorityRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CancelUpdateResponse> CancelUpdateAsync(CancelUpdateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
