...
namespace Amazon.EKS.Model
{
    ...
    {
        private ArgoCdConfigResponse _argoCd;

        /// <summary>
        /// Gets and sets the property ArgoCd. 
        /// <para>
        /// Configuration settings for an Argo CD capability, including the server URL and other
        /// Argo CD-specific settings.
        /// </para>
        /// </summary>
        public ArgoCdConfigResponse ArgoCd
        {
            get { return this._argoCd; }
            set { this._argoCd = value; }
        }

        // Check to see if ArgoCd property is set
        internal bool IsSetArgoCd()
        {
            return this._argoCd != null;
        }
