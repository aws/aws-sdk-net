...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteNodegroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteNodegroupResponse response = new DeleteNodegroupResponse();
        ...
        private static DeleteNodegroupResponseUnmarshaller _instance = new DeleteNodegroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNodegroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
