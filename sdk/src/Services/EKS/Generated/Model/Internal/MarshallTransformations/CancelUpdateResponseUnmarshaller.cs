...
{
    /// <summary>
    /// Response Unmarshaller for CancelUpdate operation
    /// </summary>  
    public class CancelUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelUpdateResponse response = new CancelUpdateResponse();
        ...
        private static CancelUpdateResponseUnmarshaller _instance = new CancelUpdateResponseUnmarshaller();        

        internal static CancelUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
