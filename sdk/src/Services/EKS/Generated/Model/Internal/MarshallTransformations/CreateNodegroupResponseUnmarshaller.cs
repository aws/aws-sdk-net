...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateNodegroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateNodegroupResponse response = new CreateNodegroupResponse();
        ...
        private static CreateNodegroupResponseUnmarshaller _instance = new CreateNodegroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNodegroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
