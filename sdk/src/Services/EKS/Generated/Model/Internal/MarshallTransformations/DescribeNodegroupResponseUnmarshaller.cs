...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeNodegroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeNodegroupResponse response = new DescribeNodegroupResponse();
            ...
            {
                if (context.TestExpression("nodegroup", targetDepth, ref reader))
                {
                    var unmarshaller = NodegroupUnmarshaller.Instance;
                    response.Nodegroup = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeNodegroupResponseUnmarshaller _instance = new DescribeNodegroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNodegroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
