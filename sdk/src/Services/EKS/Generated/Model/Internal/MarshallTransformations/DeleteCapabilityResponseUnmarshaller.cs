...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCapability operation
    /// </summary>  
    public class DeleteCapabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCapabilityResponse response = new DeleteCapabilityResponse();
            ...
            {
                if (context.TestExpression("capability", targetDepth, ref reader))
                {
                    var unmarshaller = CapabilityUnmarshaller.Instance;
                    response.Capability = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteCapabilityResponseUnmarshaller _instance = new DeleteCapabilityResponseUnmarshaller();        

        internal static DeleteCapabilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCapabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
