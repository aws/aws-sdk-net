...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LoggingUnmarshaller : IJsonUnmarshaller<Logging, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Logging Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LogSetup, LogSetupUnmarshaller>(LogSetupUnmarshaller.Instance);
