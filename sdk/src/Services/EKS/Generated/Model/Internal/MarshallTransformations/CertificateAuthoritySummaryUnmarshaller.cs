...
{
    /// <summary>
    /// Response Unmarshaller for CertificateAuthoritySummary Object
    /// </summary>  
    public class CertificateAuthoritySummaryUnmarshaller : IJsonUnmarshaller<CertificateAuthoritySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CertificateAuthoritySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CertificateAuthoritySummary unmarshalledObject = new CertificateAuthoritySummary();
        ...
        private static CertificateAuthoritySummaryUnmarshaller _instance = new CertificateAuthoritySummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CertificateAuthoritySummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
