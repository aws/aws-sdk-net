...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    public class ListCertificateAuthoritiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("certificateAuthorities", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CertificateAuthoritySummary, CertificateAuthoritySummaryUnmarshaller>(CertificateAuthoritySummaryUnmarshaller.Instance);
