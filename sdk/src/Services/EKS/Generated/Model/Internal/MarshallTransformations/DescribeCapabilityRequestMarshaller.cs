...
{
    /// <summary>
    /// DescribeCapability Request Marshaller
    /// </summary>       
    public class DescribeCapabilityRequestMarshaller : IMarshaller<IRequest, DescribeCapabilityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeCapabilityRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeCapabilityRequest publicRequest)
        {
        ...
        private static DescribeCapabilityRequestMarshaller _instance = new DescribeCapabilityRequestMarshaller();        

        internal static DescribeCapabilityRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCapabilityRequestMarshaller Instance
        {
            get
            {
                return _instance;
