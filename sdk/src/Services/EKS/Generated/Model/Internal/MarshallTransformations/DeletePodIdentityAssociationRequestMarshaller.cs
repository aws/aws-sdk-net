...
{
    /// <summary>
    /// DeletePodIdentityAssociation Request Marshaller
    /// </summary>       
    public class DeletePodIdentityAssociationRequestMarshaller : IMarshaller<IRequest, DeletePodIdentityAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePodIdentityAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePodIdentityAssociationRequest publicRequest)
        {
        ...
        private static DeletePodIdentityAssociationRequestMarshaller _instance = new DeletePodIdentityAssociationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePodIdentityAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
