...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEksAnywhereSubscription operation
    /// </summary>  
    public class DeleteEksAnywhereSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEksAnywhereSubscriptionResponse response = new DeleteEksAnywhereSubscriptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("subscription", targetDepth))
                {
                    ...
                    response.Subscription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DeleteEksAnywhereSubscriptionResponseUnmarshaller _instance = new DeleteEksAnywhereSubscriptionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEksAnywhereSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
