...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAddonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAddonResponse response = new CreateAddonResponse();
        ...
        private static CreateAddonResponseUnmarshaller _instance = new CreateAddonResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAddonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
