...
{
    /// <summary>
    /// Response Unmarshaller for ActivateCertificateAuthority operation
    /// </summary>  
    public class ActivateCertificateAuthorityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ActivateCertificateAuthorityResponse response = new ActivateCertificateAuthorityResponse();
        ...
        private static ActivateCertificateAuthorityResponseUnmarshaller _instance = new ActivateCertificateAuthorityResponseUnmarshaller();        

        internal static ActivateCertificateAuthorityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivateCertificateAuthorityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
