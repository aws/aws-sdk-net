...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeIdentityProviderConfigRequestMarshaller : IMarshaller<IRequest, DescribeIdentityProviderConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeIdentityProviderConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeIdentityProviderConfigRequest publicRequest)
        {
        ...
        private static DescribeIdentityProviderConfigRequestMarshaller _instance = new DescribeIdentityProviderConfigRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIdentityProviderConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
