...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListNodegroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListNodegroupsResponse response = new ListNodegroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("nodegroups", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.Nodegroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListNodegroupsResponseUnmarshaller _instance = new ListNodegroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNodegroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
