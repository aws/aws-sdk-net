...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAddonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAddonResponse response = new DeleteAddonResponse();
            ...
            {
                if (context.TestExpression("addon", targetDepth, ref reader))
                {
                    var unmarshaller = AddonUnmarshaller.Instance;
                    response.Addon = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteAddonResponseUnmarshaller _instance = new DeleteAddonResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAddonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
