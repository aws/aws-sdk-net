    ...
    public class DescribeClusterVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ClusterVersionInformation, ClusterVersionInformationUnmarshaller>(ClusterVersionInformationUnmarshaller.Instance);
                    response.ClusterVersions = unmarshaller.Unmarshall(context);
                    continue;
                }
