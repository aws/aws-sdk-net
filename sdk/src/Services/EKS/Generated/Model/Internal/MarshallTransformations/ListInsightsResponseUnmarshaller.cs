...
{
    /// <summary>
    /// Response Unmarshaller for ListInsights operation
    /// </summary>  
    public class ListInsightsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListInsightsResponse response = new ListInsightsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InsightSummary, InsightSummaryUnmarshaller>(InsightSummaryUnmarshaller.Instance);
        ...
        private static ListInsightsResponseUnmarshaller _instance = new ListInsightsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInsightsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
