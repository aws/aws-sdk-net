...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MarketplaceInformationUnmarshaller : IJsonUnmarshaller<MarketplaceInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MarketplaceInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("productUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
