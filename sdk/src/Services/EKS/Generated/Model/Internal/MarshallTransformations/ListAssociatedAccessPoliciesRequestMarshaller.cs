...
{
    /// <summary>
    /// ListAssociatedAccessPolicies Request Marshaller
    /// </summary>       
    public class ListAssociatedAccessPoliciesRequestMarshaller : IMarshaller<IRequest, ListAssociatedAccessPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAssociatedAccessPoliciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAssociatedAccessPoliciesRequest publicRequest)
        {
        ...
        private static ListAssociatedAccessPoliciesRequestMarshaller _instance = new ListAssociatedAccessPoliciesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssociatedAccessPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
