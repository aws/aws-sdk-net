...
{
    /// <summary>
    /// DeleteAccessEntry Request Marshaller
    /// </summary>       
    public class DeleteAccessEntryRequestMarshaller : IMarshaller<IRequest, DeleteAccessEntryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAccessEntryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAccessEntryRequest publicRequest)
        {
            ...
            request.ResourcePath = "/clusters/{name}/access-entries/{principalArn}";

            return request;
        }
        private static DeleteAccessEntryRequestMarshaller _instance = new DeleteAccessEntryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessEntryRequestMarshaller Instance
        {
            get
            {
                return _instance;
