...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectorConfigResponseUnmarshaller : IUnmarshaller<ConnectorConfigResponse, XmlUnmarshallerContext>, IUnmarshaller<ConnectorConfigResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ConnectorConfigResponse IUnmarshaller<ConnectorConfigResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ConnectorConfigResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("activationExpiry", targetDepth))
                {
                    ...
                    unmarshalledObject.ActivationExpiry = unmarshaller.Unmarshall(context);
                    continue;
                }
