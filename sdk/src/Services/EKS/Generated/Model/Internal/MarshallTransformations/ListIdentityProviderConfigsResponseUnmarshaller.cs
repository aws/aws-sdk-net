    ...
    public class ListIdentityProviderConfigsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<IdentityProviderConfig, IdentityProviderConfigUnmarshaller>(IdentityProviderConfigUnmarshaller.Instance);
                    response.IdentityProviderConfigs = unmarshaller.Unmarshall(context);
                    continue;
                }
