...
namespace Amazon.EKS.Model
{
    ...
    /// When VPC endpoint IDs are specified, public access is blocked and the Argo CD server
    /// is only accessible through the specified VPC endpoints.
    /// </summary>
    public partial class ArgoCdNetworkAccessConfigRequest
    {
        ...
        /// server. You can specify multiple VPC endpoint IDs to enable access from multiple VPCs.
        /// </para>
        /// <para />
