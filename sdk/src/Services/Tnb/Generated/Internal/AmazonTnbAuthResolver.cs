...
namespace Amazon.Tnb.Internal
{
    ...
    public class AmazonTnbAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonTnbAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Tnb.
        /// </summary>
        public AmazonTnbAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonTnbAuthSchemeParameters
            {
    ...
    public class AmazonTnbAuthSchemeResolver : IAuthSchemeResolver<AmazonTnbAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonTnbAuthSchemeParameters authParameters)
        {
