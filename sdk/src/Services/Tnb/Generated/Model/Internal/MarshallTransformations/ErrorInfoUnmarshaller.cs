...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ErrorInfoUnmarshaller : IJsonUnmarshaller<ErrorInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ErrorInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
