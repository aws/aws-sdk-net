...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolFunctionPackageContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSolFunctionPackageContentResponse response = new GetSolFunctionPackageContentResponse();
        ...
        private static GetSolFunctionPackageContentResponseUnmarshaller _instance = new GetSolFunctionPackageContentResponseUnmarshaller();        

        internal static GetSolFunctionPackageContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolFunctionPackageContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
