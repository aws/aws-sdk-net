    ...
    public class GetSolVnfcResourceInfoMetadataUnmarshaller : IJsonUnmarshaller<GetSolVnfcResourceInfoMetadata, JsonUnmarshallerContext>
    {
        ...
        public GetSolVnfcResourceInfoMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("helmChart", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static GetSolVnfcResourceInfoMetadataUnmarshaller _instance = new GetSolVnfcResourceInfoMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GetSolVnfcResourceInfoMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
