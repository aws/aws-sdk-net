    ...
    public class GetSolFunctionPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OnboardingState = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("operationalState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OperationalState = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UsageState = unmarshaller.Unmarshall(context);
                    continue;
                }
