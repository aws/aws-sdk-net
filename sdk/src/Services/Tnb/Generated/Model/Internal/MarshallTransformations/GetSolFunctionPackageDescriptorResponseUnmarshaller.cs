...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolFunctionPackageDescriptorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSolFunctionPackageDescriptorResponse response = new GetSolFunctionPackageDescriptorResponse();
        ...
        private static GetSolFunctionPackageDescriptorResponseUnmarshaller _instance = new GetSolFunctionPackageDescriptorResponseUnmarshaller();        

        internal static GetSolFunctionPackageDescriptorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolFunctionPackageDescriptorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
