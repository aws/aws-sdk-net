...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSolNetworkPackageContentRequestMarshaller : IMarshaller<IRequest, GetSolNetworkPackageContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSolNetworkPackageContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSolNetworkPackageContentRequest publicRequest)
        {
        ...
        private static GetSolNetworkPackageContentRequestMarshaller _instance = new GetSolNetworkPackageContentRequestMarshaller();        

        internal static GetSolNetworkPackageContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolNetworkPackageContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
