...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolFunctionPackageMetadataUnmarshaller : IJsonUnmarshaller<GetSolFunctionPackageMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GetSolFunctionPackageMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("vnfd", targetDepth, ref reader))
                {
