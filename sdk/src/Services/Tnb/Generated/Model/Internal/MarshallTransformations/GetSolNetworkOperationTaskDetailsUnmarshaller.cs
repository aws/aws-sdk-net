...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolNetworkOperationTaskDetailsUnmarshaller : IUnmarshaller<GetSolNetworkOperationTaskDetails, XmlUnmarshallerContext>, IUnmarshaller<GetSolNetworkOperationTaskDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GetSolNetworkOperationTaskDetails IUnmarshaller<GetSolNetworkOperationTaskDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GetSolNetworkOperationTaskDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("taskContext", targetDepth))
                {
                    ...
                    unmarshalledObject.TaskContext = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("taskErrorDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.TaskErrorDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
