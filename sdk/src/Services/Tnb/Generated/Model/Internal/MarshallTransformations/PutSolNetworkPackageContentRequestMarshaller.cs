...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutSolNetworkPackageContentRequestMarshaller : IMarshaller<IRequest, PutSolNetworkPackageContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutSolNetworkPackageContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutSolNetworkPackageContentRequest publicRequest)
        {
        ...
        private static PutSolNetworkPackageContentRequestMarshaller _instance = new PutSolNetworkPackageContentRequestMarshaller();        

        internal static PutSolNetworkPackageContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSolNetworkPackageContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
