...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSolFunctionPackageContentRequestMarshaller : IMarshaller<IRequest, GetSolFunctionPackageContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSolFunctionPackageContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSolFunctionPackageContentRequest publicRequest)
        {
        ...
        private static GetSolFunctionPackageContentRequestMarshaller _instance = new GetSolFunctionPackageContentRequestMarshaller();        

        internal static GetSolFunctionPackageContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolFunctionPackageContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
