...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("MediaStore", "4.0.0.0");

        private static readonly AmazonMediaStoreEndpointResolver EndpointResolver =
            new AmazonMediaStoreEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("MediaStore", "3.7.400.130");
=======
            InternalSDKUtils.BuildUserAgentString("MediaStore", "3.7.400.140");
>>>>>>> bcc442e12cc015138c506095ec7e21230ccd4f2e
        ...
        /// Default constructor
        /// </summary>
        public AmazonMediaStoreConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonMediaStoreDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "MediaStore";
            this.AuthenticationServiceName = "mediastore";
            this.EndpointProvider = new AmazonMediaStoreEndpointProvider();
        }
