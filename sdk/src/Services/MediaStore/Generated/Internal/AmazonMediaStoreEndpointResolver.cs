...
namespace Amazon.MediaStore.Internal
{
    /// <summary>
    /// Amazon MediaStore endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for MediaStore service requests.
    /// Collects values for MediaStoreEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses MediaStoreEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonMediaStoreEndpointResolver : BaseEndpointResolver
    {
