...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetContainerPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerPolicyResponse response = new GetContainerPolicyResponse();
        ...
        private static GetContainerPolicyResponseUnmarshaller _instance = new GetContainerPolicyResponseUnmarshaller();        

        internal static GetContainerPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
