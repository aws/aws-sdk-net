...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricPolicyRuleUnmarshaller : IJsonUnmarshaller<MetricPolicyRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricPolicyRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
