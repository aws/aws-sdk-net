...
namespace Amazon.CodeGuruSecurity
{
    ...
    public class ScanState : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ScanState for a value not among the defined constants.
        /// </summary>
        public ScanState(string value) : base(value) { }
    ...
    public class ScanType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ScanType for a value not among the defined constants.
        /// </summary>
        public ScanType(string value) : base(value) { }
