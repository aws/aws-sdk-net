...
{
    /// <summary>
    /// Container for the parameters to the CreateUploadUrl operation. Generates a pre-signed
    /// URL, request headers used to upload a code resource, and code artifact identifier
    /// for the uploaded resource. <para> You can upload your code resource to the URL with
    /// the request headers using any HTTP client. </para>
    /// </summary>
