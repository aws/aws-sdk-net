...
namespace Amazon.CodeGuruSecurity.Model
{
    ...
    public partial class BatchGetFindingsResponse : AmazonWebServiceResponse
    {
        ...
        public List<BatchGetFindingsError> FailedFindings { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchGetFindingsError>() : null;

        /// <summary>
        /// Checks to see if the FailedFindings property is set.
        /// </summary>
        internal bool IsSetFailedFindings() => this.FailedFindings != null && (this.FailedFindings.Count > 0 || !AWSConfigs.InitializeCollections);
