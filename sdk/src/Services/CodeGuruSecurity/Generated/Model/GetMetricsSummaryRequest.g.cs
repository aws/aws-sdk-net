...
{
    /// <summary>
    /// Container for the parameters to the GetMetricsSummary operation. Returns a summary
    /// of metrics for an account from a specified date, including number of open findings,
    /// the categories with most findings, the scans with most open findings, and scans with
