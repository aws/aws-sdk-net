...
namespace Amazon.CodeGuruSecurity.Model
{
    ...
    public partial class ListScansResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ScanSummary> Summaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ScanSummary>() : null;

        /// <summary>
        /// Checks to see if the Summaries property is set.
        /// </summary>
        internal bool IsSetSummaries() => this.Summaries != null && (this.Summaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
