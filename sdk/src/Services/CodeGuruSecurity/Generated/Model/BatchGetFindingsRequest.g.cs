...
{
    /// <summary>
    /// Container for the parameters to the BatchGetFindings operation. Returns a list of
    /// requested findings from standard scans.
    /// </summary>
    public partial class BatchGetFindingsRequest : AmazonCodeGuruSecurityRequest
    {
        ...
        public List<FindingIdentifier> FindingIdentifiers { get; set; } = AWSConfigs.InitializeCollections ? new List<FindingIdentifier>() : null;
