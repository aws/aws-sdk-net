...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetFindingsRequestMarshaller : IMarshaller<IRequest, GetFindingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetFindingsRequestMarshaller _instance = new();

        internal static GetFindingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetFindingsRequestMarshaller Instance => _instance;
    }
}
