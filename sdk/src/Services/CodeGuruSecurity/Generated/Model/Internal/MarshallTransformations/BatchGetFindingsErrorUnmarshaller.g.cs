...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetFindingsErrorUnmarshaller : IJsonUnmarshaller<BatchGetFindingsError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetFindingsError();
        ...
        /// Gets the singleton.
        /// </summary>
        public static BatchGetFindingsErrorUnmarshaller Instance => _instance;
    }
}
