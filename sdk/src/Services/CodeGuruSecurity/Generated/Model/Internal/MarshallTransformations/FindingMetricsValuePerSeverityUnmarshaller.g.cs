...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FindingMetricsValuePerSeverityUnmarshaller : IJsonUnmarshaller<FindingMetricsValuePerSeverity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FindingMetricsValuePerSeverity();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FindingMetricsValuePerSeverityUnmarshaller Instance => _instance;
    }
}
