...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FilePathUnmarshaller : IJsonUnmarshaller<FilePath, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FilePath();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FilePathUnmarshaller Instance => _instance;
    }
}
