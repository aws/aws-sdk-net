...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListFindingsMetricsRequestMarshaller : IMarshaller<IRequest, ListFindingsMetricsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListFindingsMetricsRequestMarshaller _instance = new();

        internal static ListFindingsMetricsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListFindingsMetricsRequestMarshaller Instance => _instance;
    }
}
