...
{
    /// <summary>
    /// Response Unmarshaller for GetMetricsSummary operation
    /// </summary>  
    public class GetMetricsSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMetricsSummaryResponse response = new GetMetricsSummaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("metricsSummary", targetDepth))
                {
                    ...
                    response.MetricsSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetMetricsSummaryResponseUnmarshaller _instance = new GetMetricsSummaryResponseUnmarshaller();        

        internal static GetMetricsSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMetricsSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
