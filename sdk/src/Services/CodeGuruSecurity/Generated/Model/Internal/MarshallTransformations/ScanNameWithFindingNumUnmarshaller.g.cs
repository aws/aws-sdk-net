...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScanNameWithFindingNumUnmarshaller : IJsonUnmarshaller<ScanNameWithFindingNum, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ScanNameWithFindingNum();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScanNameWithFindingNumUnmarshaller Instance => _instance;
    }
}
