...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EncryptionConfigUnmarshaller : IJsonUnmarshaller<EncryptionConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EncryptionConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EncryptionConfigUnmarshaller Instance => _instance;
    }
}
