...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemediationUnmarshaller : IUnmarshaller<Remediation, XmlUnmarshallerContext>, IUnmarshaller<Remediation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Remediation IUnmarshaller<Remediation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Remediation Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            Remediation unmarshalledObject = new Remediation();
        ...
        private static RemediationUnmarshaller _instance = new RemediationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RemediationUnmarshaller Instance
        {
            get
            {
                return _instance;
