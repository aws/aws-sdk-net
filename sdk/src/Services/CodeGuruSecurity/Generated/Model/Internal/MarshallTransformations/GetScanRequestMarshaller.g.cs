...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetScanRequestMarshaller : IMarshaller<IRequest, GetScanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetScanRequestMarshaller _instance = new();

        internal static GetScanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetScanRequestMarshaller Instance => _instance;
    }
}
