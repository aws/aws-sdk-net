...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListScansRequestMarshaller : IMarshaller<IRequest, ListScansRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListScansRequestMarshaller _instance = new ListScansRequestMarshaller();        

        internal static ListScansRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListScansRequestMarshaller Instance
        {
            get
            {
                return _instance;
