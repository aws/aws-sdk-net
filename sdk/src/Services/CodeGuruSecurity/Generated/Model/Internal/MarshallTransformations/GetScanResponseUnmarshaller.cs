        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("numberOfRevisions", targetDepth))
                {
                    ...
                    response.NumberOfRevisions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScanName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scanNameArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScanNameArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scanState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScanState = unmarshaller.Unmarshall(context);
                    continue;
                }
