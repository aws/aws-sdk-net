...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAccountConfigurationRequestMarshaller : IMarshaller<IRequest, GetAccountConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAccountConfigurationRequestMarshaller _instance = new();

        internal static GetAccountConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAccountConfigurationRequestMarshaller Instance => _instance;
    }
}
