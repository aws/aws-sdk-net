...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScanSummaryUnmarshaller : IJsonUnmarshaller<ScanSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ScanSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScanSummaryUnmarshaller Instance => _instance;
    }
}
