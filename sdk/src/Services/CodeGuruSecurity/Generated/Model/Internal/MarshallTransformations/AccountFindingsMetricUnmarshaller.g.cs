...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AccountFindingsMetricUnmarshaller : IJsonUnmarshaller<AccountFindingsMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AccountFindingsMetric();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AccountFindingsMetricUnmarshaller Instance => _instance;
    }
}
