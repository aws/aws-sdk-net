...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    public class AccountFindingsMetricUnmarshaller : IJsonUnmarshaller<AccountFindingsMetric, JsonUnmarshallerContext>
    {
        ...
        private static AccountFindingsMetricUnmarshaller _instance = new AccountFindingsMetricUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AccountFindingsMetricUnmarshaller Instance
        {
            get
            {
                return _instance;
