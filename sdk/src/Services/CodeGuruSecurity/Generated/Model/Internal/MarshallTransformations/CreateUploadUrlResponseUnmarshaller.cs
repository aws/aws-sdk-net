        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("codeArtifactId", targetDepth))
                {
                    ...
                    response.CodeArtifactId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("requestHeaders", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    response.RequestHeaders = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("s3Url", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.S3Url = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
