...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetFindings operation
    /// </summary>  
    public class BatchGetFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetFindingsResponse response = new BatchGetFindingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchGetFindingsError, BatchGetFindingsErrorUnmarshaller>(BatchGetFindingsErrorUnmarshaller.Instance);
                    response.FailedFindings = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static BatchGetFindingsResponseUnmarshaller _instance = new BatchGetFindingsResponseUnmarshaller();        

        internal static BatchGetFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
