...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FindingUnmarshaller : IJsonUnmarshaller<Finding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Finding();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("detectorName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("detectorTags", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("vulnerability", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static FindingUnmarshaller Instance => _instance;
    }
}
