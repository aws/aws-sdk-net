...
namespace Amazon.CodeGuruSecurity
{
    ...
    public partial class AmazonCodeGuruSecurityClient : AmazonServiceClient, IAmazonCodeGuruSecurity
    {
        ...
        {
            return EndInvoke<BatchGetFindingsResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<CreateScanResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<GetMetricsSummaryResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<GetScanResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<ListFindingsMetricsResponse>(asyncResult);
        }
        ...
        {
            return EndInvoke<ListScansResponse>(asyncResult);
        }
