...
namespace Amazon.AgentRegistry.Internal
{
    ...
    public class AmazonAgentRegistryAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAgentRegistryAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AgentRegistry.
        /// </summary>
        public AmazonAgentRegistryAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAgentRegistryAuthSchemeParameters
            {
    ...
    public class AmazonAgentRegistryAuthSchemeResolver : IAuthSchemeResolver<AmazonAgentRegistryAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAgentRegistryAuthSchemeParameters authParameters)
        {
