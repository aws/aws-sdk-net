...
namespace Amazon.AgentRegistry
{
    ...
    public partial class AmazonAgentRegistryClient : AmazonServiceClient, IAmazonAgentRegistry
    {
        ...
        public virtual BatchGetDiscoverableRegistryRecordResponse BatchGetDiscoverableRegistryRecord(BatchGetDiscoverableRegistryRecordRequest request)
        {
        ...
        public virtual ListDiscoverableRegistryRecordsResponse ListDiscoverableRegistryRecords(ListDiscoverableRegistryRecordsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual SearchDiscoverableRegistryRecordsResponse SearchDiscoverableRegistryRecords(SearchDiscoverableRegistryRecordsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
