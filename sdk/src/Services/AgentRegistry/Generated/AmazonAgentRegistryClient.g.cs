...
namespace Amazon.AgentRegistry
{
    ...
    public partial class AmazonAgentRegistryClient : AmazonServiceClient, IAmazonAgentRegistry
    {
        ...
        /// 
        /// </summary>
        public AmazonAgentRegistryClient() : base(new AmazonAgentRegistryConfig()) { }
        ...
        public AmazonAgentRegistryClient(RegionEndpoint region) : base(new AmazonAgentRegistryConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAgentRegistryClient(AmazonAgentRegistryConfig config) : base(config) { }
