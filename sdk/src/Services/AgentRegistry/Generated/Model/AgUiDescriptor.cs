...
{
    /// <summary>
    /// A descriptor for a registry record that exposes an AG-UI protocol endpoint. This
    /// descriptor is source-only: it identifies where the endpoint is located and carries
    /// no descriptor payload data or schema version.
    /// </summary>
