...
namespace Amazon.AgentRegistry.Model
{
    ...
    {
        private List<BatchGetDiscoverableRegistryRecordError> _errors = AWSConfigs.InitializeCollections ? new List<BatchGetDiscoverableRegistryRecordError>() : null;
        ...
        public List<BatchGetDiscoverableRegistryRecordError> Errors
        {
