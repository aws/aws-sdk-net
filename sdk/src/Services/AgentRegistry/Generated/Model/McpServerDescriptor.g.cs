...
namespace Amazon.AgentRegistry.Model
{
    ...
    public partial class McpServerDescriptor
    {
        ...
        /// </para>
        /// </summary>
        public McpServerAdditionalData AdditionalData { get; set; }

        /// <summary>
        /// Checks to see if the AdditionalData property is set.
        /// </summary>
        internal bool IsSetAdditionalData() => this.AdditionalData != null;
        ...
        /// <para>
        ///  The source location from which the MCP (Model Context Protocol) server descriptor
