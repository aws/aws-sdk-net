...
{
    /// <summary>
    /// Response Unmarshaller for DiscoverableRegistryRecordSummary Object
    /// </summary>  
    public class DiscoverableRegistryRecordSummaryUnmarshaller : IJsonUnmarshaller<DiscoverableRegistryRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DiscoverableRegistryRecordSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DiscoverableRegistryRecordSummary unmarshalledObject = new DiscoverableRegistryRecordSummary();
        ...
        private static DiscoverableRegistryRecordSummaryUnmarshaller _instance = new DiscoverableRegistryRecordSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DiscoverableRegistryRecordSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
