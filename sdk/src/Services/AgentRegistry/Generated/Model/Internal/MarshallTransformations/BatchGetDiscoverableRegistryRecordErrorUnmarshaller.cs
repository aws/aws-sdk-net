...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetDiscoverableRegistryRecordError Object
    /// </summary>  
    public class BatchGetDiscoverableRegistryRecordErrorUnmarshaller : IJsonUnmarshaller<BatchGetDiscoverableRegistryRecordError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetDiscoverableRegistryRecordError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetDiscoverableRegistryRecordError unmarshalledObject = new BatchGetDiscoverableRegistryRecordError();
        ...
        private static BatchGetDiscoverableRegistryRecordErrorUnmarshaller _instance = new BatchGetDiscoverableRegistryRecordErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetDiscoverableRegistryRecordErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
