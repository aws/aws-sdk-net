...
namespace Amazon.AgentRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DiscoverableRegistryRecordSummaryUnmarshaller : IJsonUnmarshaller<DiscoverableRegistryRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DiscoverableRegistryRecordSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DiscoverableRegistryRecordSummaryUnmarshaller Instance => _instance;
    }
}
