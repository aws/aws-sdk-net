...
{
    /// <summary>
    /// Response Unmarshaller for McpServerDescriptor Object
    /// </summary>
    public partial class McpServerDescriptorUnmarshaller : IJsonUnmarshaller<McpServerDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public McpServerDescriptor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new McpServerDescriptor();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = McpServerAdditionalDataUnmarshaller.Instance;
        ...
        private static McpServerDescriptorUnmarshaller _instance = new McpServerDescriptorUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static McpServerDescriptorUnmarshaller Instance => _instance;
    }
}
