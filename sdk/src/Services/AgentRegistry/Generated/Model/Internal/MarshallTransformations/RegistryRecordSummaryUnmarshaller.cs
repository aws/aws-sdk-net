...
{
    /// <summary>
    /// Response Unmarshaller for RegistryRecordSummary Object
    /// </summary>  
    public class RegistryRecordSummaryUnmarshaller : IJsonUnmarshaller<RegistryRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RegistryRecordSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RegistryRecordSummary unmarshalledObject = new RegistryRecordSummary();
        ...
        private static RegistryRecordSummaryUnmarshaller _instance = new RegistryRecordSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistryRecordSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
