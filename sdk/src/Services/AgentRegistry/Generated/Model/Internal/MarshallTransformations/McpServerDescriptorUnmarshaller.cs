...
namespace Amazon.AgentRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class McpServerDescriptorUnmarshaller : IJsonUnmarshaller<McpServerDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            McpServerDescriptor unmarshalledObject = new McpServerDescriptor();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static McpServerDescriptorUnmarshaller Instance
        {
            get
            {
                return _instance;
