...
{
    /// <summary>
    /// Response Unmarshaller for AgentSkillsMdDescriptor Object
    /// </summary>  
    public class AgentSkillsMdDescriptorUnmarshaller : IJsonUnmarshaller<AgentSkillsMdDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AgentSkillsMdDescriptor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AgentSkillsMdDescriptor unmarshalledObject = new AgentSkillsMdDescriptor();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DescriptorSourceUnmarshaller.Instance;
        ...
        private static AgentSkillsMdDescriptorUnmarshaller _instance = new AgentSkillsMdDescriptorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AgentSkillsMdDescriptorUnmarshaller Instance
        {
            get
            {
                return _instance;
