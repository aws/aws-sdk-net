...
{
    /// <summary>
    /// Response Unmarshaller for Descriptors Object
    /// </summary>  
    public class DescriptorsUnmarshaller : IJsonUnmarshaller<Descriptors, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Descriptors Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Descriptors unmarshalledObject = new Descriptors();
            ...
            {
                if (context.TestExpression("a2aAgentCard", targetDepth, ref reader))
                {
                    var unmarshaller = A2aAgentCardDescriptorUnmarshaller.Instance;
                    unmarshalledObject.A2aAgentCard = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("agentSkillsDefinition", targetDepth, ref reader))
                {
                    var unmarshaller = AgentSkillsDefinitionDescriptorUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = McpServerDescriptorUnmarshaller.Instance;
        ...
        private static DescriptorsUnmarshaller _instance = new DescriptorsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DescriptorsUnmarshaller Instance
        {
            get
            {
                return _instance;
