...
namespace Amazon.AgentRegistry
{
    ...
    public class BatchGetDiscoverableRegistryRecordErrorCode : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom BatchGetDiscoverableRegistryRecordErrorCode for a value not among the defined constants.
        /// </summary>
        public BatchGetDiscoverableRegistryRecordErrorCode(string value) : base(value) { }
