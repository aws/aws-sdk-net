...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsCredentialsUnmarshaller : IJsonUnmarshaller<AwsCredentials, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsCredentials Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
