...
{
    /// <summary>
    /// UpdateChangeset Request Marshaller
    /// </summary>       
    public class UpdateChangesetRequestMarshaller : IMarshaller<IRequest, UpdateChangesetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateChangesetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateChangesetRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetFormatParams())
            {
                ...
                foreach (var publicRequestFormatParamsKvp in publicRequest.FormatParams)
                {
                    ...
                    var publicRequestFormatParamsValue = publicRequestFormatParamsKvp.Value;
                        ...
                        context.Writer.WriteStringValue(publicRequestFormatParamsValue);
                }
            ...
            if(publicRequest.IsSetSourceParams())
            {
                ...
                foreach (var publicRequestSourceParamsKvp in publicRequest.SourceParams)
                {
                    ...
                    var publicRequestSourceParamsValue = publicRequestSourceParamsKvp.Value;
                        ...
                        context.Writer.WriteStringValue(publicRequestSourceParamsValue);
                }
                context.Writer.WriteEndObject();
            }
        ...
        private static UpdateChangesetRequestMarshaller _instance = new UpdateChangesetRequestMarshaller();        

        internal static UpdateChangesetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChangesetRequestMarshaller Instance
        {
            get
            {
                return _instance;
