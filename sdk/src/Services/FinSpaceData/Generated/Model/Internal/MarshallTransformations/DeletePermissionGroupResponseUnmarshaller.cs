...
{
    /// <summary>
    /// Response Unmarshaller for DeletePermissionGroup operation
    /// </summary>  
    public class DeletePermissionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePermissionGroupResponse response = new DeletePermissionGroupResponse();
            ...
            {
                if (context.TestExpression("permissionGroupId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PermissionGroupId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeletePermissionGroupResponseUnmarshaller _instance = new DeletePermissionGroupResponseUnmarshaller();        

        internal static DeletePermissionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePermissionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
