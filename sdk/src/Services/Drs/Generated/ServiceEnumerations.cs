...
namespace Amazon.Drs
{
    ...
    /// <summary>
    /// Constants used for properties of type SourceServerArchitecture.
    /// </summary>
    public class SourceServerArchitecture : ConstantClass
    {

        /// <summary>
        /// Constant Arm64 for SourceServerArchitecture
        /// </summary>
        public static readonly SourceServerArchitecture Arm64 = new SourceServerArchitecture("arm64");
        /// <summary>
        /// Constant X86_64 for SourceServerArchitecture
        /// </summary>
        public static readonly SourceServerArchitecture X86_64 = new SourceServerArchitecture("x86_64");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public SourceServerArchitecture(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static SourceServerArchitecture FindValue(string value)
        {
            return FindValue<SourceServerArchitecture>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator SourceServerArchitecture(string value)
        {
            return FindValue(value);
        }
    }
