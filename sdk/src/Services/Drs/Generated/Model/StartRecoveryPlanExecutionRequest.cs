...
{
    /// <summary>
    /// Container for the parameters to the StartRecoveryPlanExecution operation.
    ...
    /// </summary>
    public partial class StartRecoveryPlanExecutionRequest : AmazonDrsRequest
    {
        private string _clientToken;
        private RecoveryPlanExecutionMode _mode;
        private string _recoveryPlanArn;
        private List<RecoveryPlanExecutionSourceServer> _sourceServers = AWSConfigs.InitializeCollections ? new List<RecoveryPlanExecutionSourceServer>() : null;
        ...
        /// <para>
        /// The execution mode (<c>DRILL</c> or <c>RECOVERY</c>).
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Optional list of source servers with specific recovery snapshots. If not provided,
        /// the latest snapshot is used for each server.
        /// </para>
        /// <para />
        ...
        public List<RecoveryPlanExecutionSourceServer> SourceServers
        {
