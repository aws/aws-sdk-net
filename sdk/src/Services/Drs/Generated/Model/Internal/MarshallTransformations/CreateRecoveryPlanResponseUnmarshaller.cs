...
{
    /// <summary>
    /// Response Unmarshaller for CreateRecoveryPlan operation
    /// </summary>  
    public class CreateRecoveryPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRecoveryPlanResponse response = new CreateRecoveryPlanResponse();
            ...
            {
                if (context.TestExpression("recoveryPlan", targetDepth, ref reader))
                {
                    var unmarshaller = RecoveryPlanUnmarshaller.Instance;
                    response.RecoveryPlan = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateRecoveryPlanResponseUnmarshaller _instance = new CreateRecoveryPlanResponseUnmarshaller();        

        internal static CreateRecoveryPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRecoveryPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
