...
{
    /// <summary>
    /// Response Unmarshaller for RecoveryPlanExecutionStep Object
    /// </summary>  
    public class RecoveryPlanExecutionStepUnmarshaller : IJsonUnmarshaller<RecoveryPlanExecutionStep, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecoveryPlanExecutionStep Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RecoveryPlanExecutionStep unmarshalledObject = new RecoveryPlanExecutionStep();
        ...
        private static RecoveryPlanExecutionStepUnmarshaller _instance = new RecoveryPlanExecutionStepUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RecoveryPlanExecutionStepUnmarshaller Instance
        {
            get
            {
                return _instance;
