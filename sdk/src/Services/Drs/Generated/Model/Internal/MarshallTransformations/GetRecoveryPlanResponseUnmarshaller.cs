...
{
    /// <summary>
    /// Response Unmarshaller for GetRecoveryPlan operation
    /// </summary>  
    public class GetRecoveryPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRecoveryPlanResponse response = new GetRecoveryPlanResponse();
        ...
        private static GetRecoveryPlanResponseUnmarshaller _instance = new GetRecoveryPlanResponseUnmarshaller();        

        internal static GetRecoveryPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRecoveryPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
