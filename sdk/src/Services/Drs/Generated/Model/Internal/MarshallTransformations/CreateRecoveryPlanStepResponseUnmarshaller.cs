...
{
    /// <summary>
    /// Response Unmarshaller for CreateRecoveryPlanStep operation
    /// </summary>  
    public class CreateRecoveryPlanStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRecoveryPlanStepResponse response = new CreateRecoveryPlanStepResponse();
        ...
        private static CreateRecoveryPlanStepResponseUnmarshaller _instance = new CreateRecoveryPlanStepResponseUnmarshaller();        

        internal static CreateRecoveryPlanStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRecoveryPlanStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
