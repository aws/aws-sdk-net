...
{
    /// <summary>
    /// Response Unmarshaller for GetRecoveryPlanStep operation
    /// </summary>  
    public class GetRecoveryPlanStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRecoveryPlanStepResponse response = new GetRecoveryPlanStepResponse();
        ...
        private static GetRecoveryPlanStepResponseUnmarshaller _instance = new GetRecoveryPlanStepResponseUnmarshaller();        

        internal static GetRecoveryPlanStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRecoveryPlanStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
