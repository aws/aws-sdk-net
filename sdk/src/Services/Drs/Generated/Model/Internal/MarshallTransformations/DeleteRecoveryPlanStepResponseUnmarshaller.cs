...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRecoveryPlanStep operation
    /// </summary>  
    public class DeleteRecoveryPlanStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRecoveryPlanStepResponse response = new DeleteRecoveryPlanStepResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("recoveryPlanStepArn", targetDepth, ref reader))
                {
                    ...
                    response.RecoveryPlanStepArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteRecoveryPlanStepResponseUnmarshaller _instance = new DeleteRecoveryPlanStepResponseUnmarshaller();        

        internal static DeleteRecoveryPlanStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecoveryPlanStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
