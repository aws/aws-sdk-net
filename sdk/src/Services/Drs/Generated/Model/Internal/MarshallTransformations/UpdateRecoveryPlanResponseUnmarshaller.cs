...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRecoveryPlan operation
    /// </summary>  
    public class UpdateRecoveryPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRecoveryPlanResponse response = new UpdateRecoveryPlanResponse();
        ...
        private static UpdateRecoveryPlanResponseUnmarshaller _instance = new UpdateRecoveryPlanResponseUnmarshaller();        

        internal static UpdateRecoveryPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecoveryPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
