...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEphemeris operation
    /// </summary>  
    public class DeleteEphemerisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEphemerisResponse response = new DeleteEphemerisResponse();
            ...
            {
                if (context.TestExpression("ephemerisId", targetDepth, ref reader))
                {
        ...
        private static DeleteEphemerisResponseUnmarshaller _instance = new DeleteEphemerisResponseUnmarshaller();        

        internal static DeleteEphemerisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEphemerisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
