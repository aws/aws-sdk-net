    ...
    public class DescribeEphemerisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EphemerisErrorReason, EphemerisErrorReasonUnmarshaller>(EphemerisErrorReasonUnmarshaller.Instance);
                    response.ErrorReasons = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("invalidReason", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InvalidReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("suppliedData", targetDepth))
                {
                    ...
                    response.SuppliedData = unmarshaller.Unmarshall(context);
                    continue;
                }
