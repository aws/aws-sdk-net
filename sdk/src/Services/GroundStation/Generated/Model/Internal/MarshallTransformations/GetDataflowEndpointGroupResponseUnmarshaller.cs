...
{
    /// <summary>
    /// Response Unmarshaller for GetDataflowEndpointGroup operation
    /// </summary>  
    public class GetDataflowEndpointGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataflowEndpointGroupResponse response = new GetDataflowEndpointGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("dataflowEndpointGroupArn", targetDepth))
                {
                    ...
                    response.DataflowEndpointGroupArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EndpointDetails, EndpointDetailsUnmarshaller>(EndpointDetailsUnmarshaller.Instance);
                    response.EndpointsDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetDataflowEndpointGroupResponseUnmarshaller _instance = new GetDataflowEndpointGroupResponseUnmarshaller();        

        internal static GetDataflowEndpointGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataflowEndpointGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
