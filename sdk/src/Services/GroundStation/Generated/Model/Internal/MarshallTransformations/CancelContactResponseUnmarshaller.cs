...
{
    /// <summary>
    /// Response Unmarshaller for CancelContact operation
    /// </summary>  
    public class CancelContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelContactResponse response = new CancelContactResponse();
        ...
        private static CancelContactResponseUnmarshaller _instance = new CancelContactResponseUnmarshaller();        

        internal static CancelContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
