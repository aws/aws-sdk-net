...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeEphemerisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeEphemerisResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("errorReasons", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ErrorReasons = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InvalidReason = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("suppliedData", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SuppliedData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeEphemerisResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeEphemerisResponseUnmarshaller Instance => _instance;
    }
}
