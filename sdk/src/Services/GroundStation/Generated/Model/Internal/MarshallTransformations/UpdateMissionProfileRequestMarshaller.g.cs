...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateMissionProfileRequestMarshaller : IMarshaller<IRequest, UpdateMissionProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateMissionProfileRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetTelemetrySinkConfigArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TelemetrySinkConfigArn);
            }
        ...
        private static readonly UpdateMissionProfileRequestMarshaller _instance = new();

        internal static UpdateMissionProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMissionProfileRequestMarshaller Instance => _instance;
    }
}
