...
{
    /// <summary>
    /// Response Unmarshaller for ReserveContact operation
    /// </summary>  
    public class ReserveContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReserveContactResponse response = new ReserveContactResponse();
        ...
        private static ReserveContactResponseUnmarshaller _instance = new ReserveContactResponseUnmarshaller();        

        internal static ReserveContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReserveContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
