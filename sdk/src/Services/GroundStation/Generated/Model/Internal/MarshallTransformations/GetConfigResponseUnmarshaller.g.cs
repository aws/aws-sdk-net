...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetConfigResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("configData", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConfigData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetConfigResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetConfigResponseUnmarshaller Instance => _instance;
    }
}
