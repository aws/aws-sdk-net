...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContact operation
    /// </summary>  
    public class UpdateContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateContactResponseUnmarshaller _instance = new UpdateContactResponseUnmarshaller();        

        internal static UpdateContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
