...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDataflowEndpointGroup operation
    /// </summary>  
    public class DeleteDataflowEndpointGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDataflowEndpointGroupResponse response = new DeleteDataflowEndpointGroupResponse();
        ...
        private static DeleteDataflowEndpointGroupResponseUnmarshaller _instance = new DeleteDataflowEndpointGroupResponseUnmarshaller();        

        internal static DeleteDataflowEndpointGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDataflowEndpointGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
