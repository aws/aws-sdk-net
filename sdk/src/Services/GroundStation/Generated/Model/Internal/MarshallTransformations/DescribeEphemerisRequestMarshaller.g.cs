...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeEphemerisRequestMarshaller : IMarshaller<IRequest, DescribeEphemerisRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeEphemerisRequestMarshaller _instance = new();

        internal static DescribeEphemerisRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeEphemerisRequestMarshaller Instance => _instance;
    }
}
