...
{
    /// <summary>
    /// Response Unmarshaller for CreateEphemeris operation
    /// </summary>  
    public class CreateEphemerisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEphemerisResponse response = new CreateEphemerisResponse();
        ...
        private static CreateEphemerisResponseUnmarshaller _instance = new CreateEphemerisResponseUnmarshaller();        

        internal static CreateEphemerisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEphemerisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
