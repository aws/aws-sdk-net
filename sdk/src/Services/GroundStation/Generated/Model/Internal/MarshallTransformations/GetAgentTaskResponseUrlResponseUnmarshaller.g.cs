...
{
    /// <summary>
    /// Response Unmarshaller for GetAgentTaskResponseUrl operation.
    /// </summary>
    public partial class GetAgentTaskResponseUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAgentTaskResponseUrlResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("presignedLogUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PresignedLogUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetAgentTaskResponseUrlResponseUnmarshaller _instance = new GetAgentTaskResponseUrlResponseUnmarshaller();

        internal static GetAgentTaskResponseUrlResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAgentTaskResponseUrlResponseUnmarshaller Instance => _instance;
    }
}
