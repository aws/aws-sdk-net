...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfig operation
    /// </summary>  
    public class UpdateConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("configArn", targetDepth))
                {
                    ...
                    response.ConfigArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("configId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConfigId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("configType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConfigType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateConfigResponseUnmarshaller _instance = new UpdateConfigResponseUnmarshaller();        

        internal static UpdateConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
