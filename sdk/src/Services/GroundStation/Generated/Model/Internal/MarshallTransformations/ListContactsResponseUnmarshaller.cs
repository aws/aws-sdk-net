...
{
    /// <summary>
    /// Response Unmarshaller for ListContacts operation
    /// </summary>  
    public class ListContactsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("contactList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ContactData, ContactDataUnmarshaller>(ContactDataUnmarshaller.Instance);
                    response.ContactList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListContactsResponseUnmarshaller _instance = new ListContactsResponseUnmarshaller();        

        internal static ListContactsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContactsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
