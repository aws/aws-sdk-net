...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetDataflowEndpointGroupRequestMarshaller : IMarshaller<IRequest, GetDataflowEndpointGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetDataflowEndpointGroupRequestMarshaller _instance = new GetDataflowEndpointGroupRequestMarshaller();        

        internal static GetDataflowEndpointGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataflowEndpointGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
