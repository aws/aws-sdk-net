...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeContactVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeContactVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataflowList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DataflowList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("trackingOverrides", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TrackingOverrides = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeContactVersionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeContactVersionResponseUnmarshaller Instance => _instance;
    }
}
