...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMissionProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetMissionProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("contactPostPassDurationSeconds", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ContactPostPassDurationSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.ContactPrePassDurationSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("dataflowEdges", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DataflowEdges = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.MinimumViableContactDurationSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("streamsKmsKey", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.StreamsKmsKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StreamsKmsRole = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TelemetrySinkConfigArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TrackingConfigArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetMissionProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMissionProfileResponseUnmarshaller Instance => _instance;
    }
}
