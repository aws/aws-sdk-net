...
{
    /// <summary>
    /// Response Unmarshaller for RegisterAgent operation
    /// </summary>  
    public class RegisterAgentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterAgentResponseUnmarshaller _instance = new RegisterAgentResponseUnmarshaller();        

        internal static RegisterAgentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterAgentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
