...
{
    /// <summary>
    /// Container for the parameters to the CreateMissionProfile operation. Creates a mission
    /// profile. <para> <c>dataflowEdges</c> is a list of lists of strings. Each lower level
    /// list of strings has two elements: a <i>from</i> ARN and a <i>to</i> ARN. </para>
    /// </summary>
