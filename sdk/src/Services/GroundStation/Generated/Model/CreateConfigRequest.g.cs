...
{
    /// <summary>
    /// Container for the parameters to the CreateConfig operation. Creates a <c>Config</c>
    /// with the specified <c>configData</c> parameters. <para> Only one type of <c>configData</c>
