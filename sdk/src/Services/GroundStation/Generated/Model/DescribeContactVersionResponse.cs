...
{
    /// <summary>
    /// This is the response object from the DescribeContactVersion operation.
    /// </summary>
    public partial class DescribeContactVersionResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// Tracking configuration overrides applied to this contact version. For the initial
        /// version, these are the overrides specified when the contact was reserved. For subsequent
        /// versions, these are the overrides associated with that specific version update.
        /// </para>
        /// </summary>
