...
namespace Amazon.GroundStation.Model
{
    ...
    public partial class DownlinkConnectionDetails
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public ConnectionDetails EgressAddressAndPort { get; set; }

        /// <summary>
        /// Checks to see if the EgressAddressAndPort property is set.
        /// </summary>
        internal bool IsSetEgressAddressAndPort() => this.EgressAddressAndPort != null;
    }
}
