...
namespace Amazon.GroundStation.Model
{
    ...
    public partial class TLEEphemeris
    {
        ...
        public List<TLEData> TleData { get; set; } = AWSConfigs.InitializeCollections ? new List<TLEData>() : null;

        /// <summary>
        /// Checks to see if the TleData property is set.
        /// </summary>
        internal bool IsSetTleData() => this.TleData != null && (this.TleData.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
