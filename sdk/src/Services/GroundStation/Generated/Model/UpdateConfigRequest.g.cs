...
{
    /// <summary>
    /// Container for the parameters to the UpdateConfig operation. Updates the <c>Config</c>
    /// used when scheduling contacts. <para> Updating a <c>Config</c> will not update the
    /// execution parameters for existing future contacts scheduled with this <c>Config</c>.
    /// </para>
    /// </summary>
