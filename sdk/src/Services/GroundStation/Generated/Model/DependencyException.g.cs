...
namespace Amazon.GroundStation.Model
{
    ...
    public partial class DependencyException : AmazonGroundStationException
    {
        ...
        /// Construct instance of DependencyException
        /// </summary>
        public DependencyException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of DependencyException
        /// </summary>
        public DependencyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of DependencyException
        /// </summary>
        public DependencyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
