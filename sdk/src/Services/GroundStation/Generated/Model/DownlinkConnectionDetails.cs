...
namespace Amazon.GroundStation.Model
{
    ...
    /// </summary>
    public partial class DownlinkConnectionDetails
    {
        private RangedConnectionDetails _agentIpAndPortAddress;
        private ConnectionDetails _egressAddressAndPort;
        ...
        /// <summary>
        /// Gets and sets the property EgressAddressAndPort.
        /// </summary>
        [AWSProperty(Required=true)]
        public ConnectionDetails EgressAddressAndPort
        {
            get { return this._egressAddressAndPort; }
            set { this._egressAddressAndPort = value; }
        }

        // Check to see if EgressAddressAndPort property is set
        internal bool IsSetEgressAddressAndPort()
        {
            return this._egressAddressAndPort != null;
        }
