...
{
    /// <summary>
    /// This is the response object from the GetDataflowEndpointGroup operation.
    /// </summary>
    public partial class GetDataflowEndpointGroupResponse : AmazonWebServiceResponse
    {
        ...
        public List<EndpointDetails> EndpointsDetails { get; set; } = AWSConfigs.InitializeCollections ? new List<EndpointDetails>() : null;

        /// <summary>
        /// Checks to see if the EndpointsDetails property is set.
        /// </summary>
        internal bool IsSetEndpointsDetails() => this.EndpointsDetails != null && (this.EndpointsDetails.Count > 0 || !AWSConfigs.InitializeCollections);
