...
namespace Amazon.GroundStation
{
    ...
    public partial class AmazonGroundStationClient : AmazonServiceClient, IAmazonGroundStation
    {
        ...
        internal virtual DescribeContactVersionResponse DescribeContactVersion(DescribeContactVersionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListAntennasResponse ListAntennas(ListAntennasRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListContactVersionsResponse ListContactVersions(ListContactVersionsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListGroundStationReservationsResponse ListGroundStationReservations(ListGroundStationReservationsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
