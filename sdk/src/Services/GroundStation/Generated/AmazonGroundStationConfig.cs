...
namespace Amazon.GroundStation
{
    ...
    public partial class AmazonGroundStationConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("GroundStation", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "GroundStation";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "groundstation";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-05-23";
