...
namespace Amazon.GroundStation
{
    ...
    public partial class AmazonGroundStationClient : AmazonServiceClient, IAmazonGroundStation
    {
        ...
        /// 
        /// </summary>
        public AmazonGroundStationClient() : base(new AmazonGroundStationConfig()) { }
        ...
        public AmazonGroundStationClient(RegionEndpoint region) : base(new AmazonGroundStationConfig { RegionEndpoint = region }) { }
        ...
        public AmazonGroundStationClient(AmazonGroundStationConfig config) : base(config) { }
