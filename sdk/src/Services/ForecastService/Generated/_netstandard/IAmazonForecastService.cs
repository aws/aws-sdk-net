...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonForecastServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonForecastServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonForecastServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonForecastServiceConfig to create AmazonForecastServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonForecastServiceClient(serviceClientConfig) :
                    new AmazonForecastServiceClient(awsCredentials, serviceClientConfig);
        }
