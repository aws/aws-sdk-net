...
{
    /// <summary>
    /// Container for the parameters to the ListWhatIfForecasts operation.
    ...
    /// </summary>
    public partial class ListWhatIfForecastsRequest : AmazonForecastServiceRequest
    {
        ...
        ///  </li> <li> 
        /// <para>
        ///  <code>Key</code> - The name of the parameter to filter on. Valid values are <code>WhatIfForecastArn</code>
        ...
        ///  </li> </ul> 
        /// <para>
        /// For example, to list all jobs that export a forecast named <i>electricityWhatIfForecast</i>,
        /// specify the following filter:
        /// </para>
        ///  
        /// <para>
        ///  <code>"Filters": [ { "Condition": "IS", "Key": "WhatIfForecastArn", "Value": "arn:aws:forecast:us-west-2:&lt;acct-id&gt;:forecast/electricityWhatIfForecast"
        /// } ]</code> 
        /// </para>
        /// </summary>
