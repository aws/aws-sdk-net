...
namespace Amazon.ForecastService.Model
{
    ...
    public partial class DescribeExplainabilityResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// If <code>TimePointGranularity</code> is set to <code>SPECIFIC</code>, the last time
        ...
        /// <para>
        /// If <code>TimePointGranularity</code> is set to <code>SPECIFIC</code>, the first time
        /// point in the Explainability.
        /// </para>
        /// </summary>
        [AWSProperty(Max=19)]
