...
{
    /// <summary>
    /// This is the response object from the ListWhatIfAnalyses operation.
    /// </summary>
    public partial class ListWhatIfAnalysesResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// If the response is truncated, Forecast returns this token. To retrieve the next set
        ...
        {
            get { return this._whatIfAnalyses; }
            set { this._whatIfAnalyses = value; }
        }
