...
{
    /// <summary>
    /// Response Unmarshaller for StopResource operation
    /// </summary>  
    public class StopResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopResourceResponse response = new StopResourceResponse();
        ...
        private static StopResourceResponseUnmarshaller _instance = new StopResourceResponseUnmarshaller();        

        internal static StopResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
