        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("TimeSeriesReplacementsDataSource", targetDepth))
                {
                    ...
                    response.TimeSeriesReplacementsDataSource = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TimeSeriesTransformations", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<TimeSeriesTransformation, TimeSeriesTransformationUnmarshaller>(TimeSeriesTransformationUnmarshaller.Instance);
                    response.TimeSeriesTransformations = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WhatIfForecastArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("WhatIfForecastName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WhatIfForecastName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
