...
namespace Amazon.ForecastService.Model.Internal.MarshallTransformations
{
    ...
    public class TimeSeriesSelectorUnmarshaller : IJsonUnmarshaller<TimeSeriesSelector, JsonUnmarshallerContext>
    {
        ...
        public TimeSeriesSelector Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("TimeSeriesIdentifiers", targetDepth, ref reader))
                {
        ...
        private static TimeSeriesSelectorUnmarshaller _instance = new TimeSeriesSelectorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TimeSeriesSelectorUnmarshaller Instance
        {
            get
            {
                return _instance;
