...
{
    /// <summary>
    /// Response Unmarshaller for CreatePredictorBacktestExportJob operation
    /// </summary>  
    public class CreatePredictorBacktestExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePredictorBacktestExportJobResponse response = new CreatePredictorBacktestExportJobResponse();
        ...
        private static CreatePredictorBacktestExportJobResponseUnmarshaller _instance = new CreatePredictorBacktestExportJobResponseUnmarshaller();        

        internal static CreatePredictorBacktestExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePredictorBacktestExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
