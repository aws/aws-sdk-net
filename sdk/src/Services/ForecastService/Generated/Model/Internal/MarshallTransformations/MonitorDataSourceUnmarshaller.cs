...
namespace Amazon.ForecastService.Model.Internal.MarshallTransformations
{
    ...
    public class MonitorDataSourceUnmarshaller : IJsonUnmarshaller<MonitorDataSource, JsonUnmarshallerContext>
    {
        ...
        public MonitorDataSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("DatasetImportJobArn", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PredictorArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static MonitorDataSourceUnmarshaller _instance = new MonitorDataSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MonitorDataSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
