...
{
    /// <summary>
    /// Response Unmarshaller for DescribePredictorBacktestExportJob operation
    /// </summary>  
    public class DescribePredictorBacktestExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePredictorBacktestExportJobResponse response = new DescribePredictorBacktestExportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PredictorBacktestExportJobArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PredictorBacktestExportJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PredictorBacktestExportJobName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PredictorBacktestExportJobName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribePredictorBacktestExportJobResponseUnmarshaller _instance = new DescribePredictorBacktestExportJobResponseUnmarshaller();        

        internal static DescribePredictorBacktestExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePredictorBacktestExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
