...
{
    /// <summary>
    /// Response Unmarshaller for ListForecastExportJobs operation
    /// </summary>  
    public class ListForecastExportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListForecastExportJobsResponse response = new ListForecastExportJobsResponse();
            ...
            {
                if (context.TestExpression("ForecastExportJobs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ForecastExportJobSummary, ForecastExportJobSummaryUnmarshaller>(ForecastExportJobSummaryUnmarshaller.Instance);
                    response.ForecastExportJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListForecastExportJobsResponseUnmarshaller _instance = new ListForecastExportJobsResponseUnmarshaller();        

        internal static ListForecastExportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListForecastExportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
