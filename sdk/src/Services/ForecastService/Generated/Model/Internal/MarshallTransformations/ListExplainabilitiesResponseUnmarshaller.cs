...
{
    /// <summary>
    /// Response Unmarshaller for ListExplainabilities operation
    /// </summary>  
    public class ListExplainabilitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListExplainabilitiesResponse response = new ListExplainabilitiesResponse();
            ...
            {
                if (context.TestExpression("Explainabilities", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ExplainabilitySummary, ExplainabilitySummaryUnmarshaller>(ExplainabilitySummaryUnmarshaller.Instance);
                    response.Explainabilities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListExplainabilitiesResponseUnmarshaller _instance = new ListExplainabilitiesResponseUnmarshaller();        

        internal static ListExplainabilitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExplainabilitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
