...
{
    /// <summary>
    /// Response Unmarshaller for CreateForecast operation
    /// </summary>  
    public class CreateForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateForecastResponse response = new CreateForecastResponse();
        ...
        private static CreateForecastResponseUnmarshaller _instance = new CreateForecastResponseUnmarshaller();        

        internal static CreateForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
