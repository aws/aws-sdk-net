...
{
    /// <summary>
    /// Response Unmarshaller for CreateWhatIfForecastExport operation
    /// </summary>  
    public class CreateWhatIfForecastExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWhatIfForecastExportResponse response = new CreateWhatIfForecastExportResponse();
            ...
            {
                if (context.TestExpression("WhatIfForecastExportArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WhatIfForecastExportArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateWhatIfForecastExportResponseUnmarshaller _instance = new CreateWhatIfForecastExportResponseUnmarshaller();        

        internal static CreateWhatIfForecastExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatIfForecastExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
