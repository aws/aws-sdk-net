...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWhatIfAnalysis operation
    /// </summary>  
    public class DeleteWhatIfAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWhatIfAnalysisResponse response = new DeleteWhatIfAnalysisResponse();
        ...
        private static DeleteWhatIfAnalysisResponseUnmarshaller _instance = new DeleteWhatIfAnalysisResponseUnmarshaller();        

        internal static DeleteWhatIfAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWhatIfAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
