...
{
    /// <summary>
    /// Response Unmarshaller for ListPredictors operation
    /// </summary>  
    public class ListPredictorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPredictorsResponse response = new ListPredictorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Predictors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PredictorSummary, PredictorSummaryUnmarshaller>(PredictorSummaryUnmarshaller.Instance);
                    response.Predictors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListPredictorsResponseUnmarshaller _instance = new ListPredictorsResponseUnmarshaller();        

        internal static ListPredictorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPredictorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
