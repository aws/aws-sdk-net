...
namespace Amazon.ForecastService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteMonitorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMonitorResponse response = new DeleteMonitorResponse();
        ...
        private static DeleteMonitorResponseUnmarshaller _instance = new DeleteMonitorResponseUnmarshaller();        

        internal static DeleteMonitorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMonitorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
