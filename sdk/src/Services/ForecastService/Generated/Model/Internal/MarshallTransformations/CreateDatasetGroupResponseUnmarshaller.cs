...
{
    /// <summary>
    /// Response Unmarshaller for CreateDatasetGroup operation
    /// </summary>  
    public class CreateDatasetGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDatasetGroupResponse response = new CreateDatasetGroupResponse();
        ...
        private static CreateDatasetGroupResponseUnmarshaller _instance = new CreateDatasetGroupResponseUnmarshaller();        

        internal static CreateDatasetGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDatasetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
