...
{
    /// <summary>
    /// Base class for ListMonitorEvaluations paginators.
    /// </summary>
    internal sealed partial class ListMonitorEvaluationsPaginator : IPaginator<ListMonitorEvaluationsResponse>, IListMonitorEvaluationsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ListMonitorEvaluationsResponse> Responses => new PaginatedResponse<ListMonitorEvaluationsResponse>(this);
...
#if BCL
        IEnumerable<ListMonitorEvaluationsResponse> IPaginator<ListMonitorEvaluationsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListMonitorEvaluations(_request);
        ...
        async IAsyncEnumerable<ListMonitorEvaluationsResponse> IPaginator<ListMonitorEvaluationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
