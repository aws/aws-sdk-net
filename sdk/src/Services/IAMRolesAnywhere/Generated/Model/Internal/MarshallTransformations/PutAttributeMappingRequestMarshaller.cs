...
{
    /// <summary>
    /// PutAttributeMapping Request Marshaller
    /// </summary>       
    public class PutAttributeMappingRequestMarshaller : IMarshaller<IRequest, PutAttributeMappingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutAttributeMappingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutAttributeMappingRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCertificateField())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.CertificateField);
            }
        ...
        private static PutAttributeMappingRequestMarshaller _instance = new PutAttributeMappingRequestMarshaller();        

        internal static PutAttributeMappingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAttributeMappingRequestMarshaller Instance
        {
            get
            {
                return _instance;
