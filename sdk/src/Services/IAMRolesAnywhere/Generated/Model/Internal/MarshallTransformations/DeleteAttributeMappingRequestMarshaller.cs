...
namespace Amazon.IAMRolesAnywhere.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAttributeMappingRequestMarshaller : IMarshaller<IRequest, DeleteAttributeMappingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteAttributeMappingRequestMarshaller _instance = new DeleteAttributeMappingRequestMarshaller();        

        internal static DeleteAttributeMappingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAttributeMappingRequestMarshaller Instance
        {
            get
            {
                return _instance;
