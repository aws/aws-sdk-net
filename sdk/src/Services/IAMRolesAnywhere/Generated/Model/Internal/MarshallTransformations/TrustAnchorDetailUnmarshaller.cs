...
namespace Amazon.IAMRolesAnywhere.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrustAnchorDetailUnmarshaller : IUnmarshaller<TrustAnchorDetail, XmlUnmarshallerContext>, IUnmarshaller<TrustAnchorDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TrustAnchorDetail IUnmarshaller<TrustAnchorDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TrustAnchorDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TrustAnchorId = unmarshaller.Unmarshall(context);
                    continue;
                }
