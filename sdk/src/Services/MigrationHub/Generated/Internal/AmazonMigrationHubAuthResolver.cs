...
namespace Amazon.MigrationHub.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonMigrationHubAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMigrationHubAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MigrationHub.
        /// </summary>
        public AmazonMigrationHubAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMigrationHubAuthSchemeParameters
            {
    ...
    public class AmazonMigrationHubAuthSchemeResolver : IAuthSchemeResolver<AmazonMigrationHubAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMigrationHubAuthSchemeParameters authParameters)
        {
