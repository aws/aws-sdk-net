...
{
    /// <summary>
    /// Container for the parameters to the ListSourceResources operation.
    /// Lists all the source resource that are associated with the specified <c>MigrationTaskName</c>
    /// and <c>ProgressUpdateStream</c>.
    /// </summary>
    public partial class ListSourceResourcesRequest : AmazonMigrationHubRequest
    {
        ...
        /// <para>
        /// A unique identifier that references the migration task. <i>Do not store confidential
