...
{
    /// <summary>
    /// Response Unmarshaller for ImportMigrationTask operation
    /// </summary>  
    public class ImportMigrationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportMigrationTaskResponse response = new ImportMigrationTaskResponse();
        ...
        private static ImportMigrationTaskResponseUnmarshaller _instance = new ImportMigrationTaskResponseUnmarshaller();        

        internal static ImportMigrationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportMigrationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
