...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProgressUpdateStream operation
    /// </summary>  
    public class DeleteProgressUpdateStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProgressUpdateStreamResponse response = new DeleteProgressUpdateStreamResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DryRunOperation"))
                {
            ...
            return new AmazonMigrationHubException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static DeleteProgressUpdateStreamResponseUnmarshaller _instance = new DeleteProgressUpdateStreamResponseUnmarshaller();        

        internal static DeleteProgressUpdateStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProgressUpdateStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
