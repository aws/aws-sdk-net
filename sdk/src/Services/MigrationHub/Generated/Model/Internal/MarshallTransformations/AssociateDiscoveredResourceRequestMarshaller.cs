...
{
    /// <summary>
    /// AssociateDiscoveredResource Request Marshaller
    /// </summary>       
    public class AssociateDiscoveredResourceRequestMarshaller : IMarshaller<IRequest, AssociateDiscoveredResourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateDiscoveredResourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateDiscoveredResourceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MigrationHub");
            string target = "AWSMigrationHub.AssociateDiscoveredResource";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetDiscoveredResource())
                {
                    context.Writer.WritePropertyName("DiscoveredResource");
                    context.Writer.WriteObjectStart();

                    var marshaller = DiscoveredResourceMarshaller.Instance;
                    marshaller.Marshall(publicRequest.DiscoveredResource, context);
