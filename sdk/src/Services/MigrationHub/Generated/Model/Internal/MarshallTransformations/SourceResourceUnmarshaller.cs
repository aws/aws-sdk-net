...
namespace Amazon.MigrationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceResourceUnmarshaller : IJsonUnmarshaller<SourceResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourceResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("StatusDetail", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
