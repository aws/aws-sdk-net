...
{
    /// <summary>
    /// Container for the parameters to the UpdateServiceSettings operation. Updates the service
    /// settings for Linux subscriptions.
    /// </summary>
    public partial class UpdateServiceSettingsRequest : AmazonLicenseManagerLinuxSubscriptionsRequest
    {
        ...
        /// <summary>
        /// Checks to see if the AllowUpdate property is set.
        /// </summary>
        internal bool IsSetAllowUpdate() => this.AllowUpdate.HasValue;
