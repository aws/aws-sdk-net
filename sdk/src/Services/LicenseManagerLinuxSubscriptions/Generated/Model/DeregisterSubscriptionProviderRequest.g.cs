...
{
    /// <summary>
    /// Container for the parameters to the DeregisterSubscriptionProvider operation. Remove
    /// a third-party subscription provider from the Bring Your Own License (BYOL) subscriptions
