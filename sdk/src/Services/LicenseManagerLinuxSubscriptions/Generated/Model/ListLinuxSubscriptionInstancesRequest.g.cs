...
{
    /// <summary>
    /// Container for the parameters to the ListLinuxSubscriptionInstances operation. Lists
    /// the running Amazon EC2 instances that were discovered with commercial Linux subscriptions.
    /// </summary>
