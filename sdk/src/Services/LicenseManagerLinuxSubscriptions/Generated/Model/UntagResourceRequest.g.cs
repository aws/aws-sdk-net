...
{
    /// <summary>
    /// Container for the parameters to the UntagResource operation. Remove one or more metadata
    /// tag from the specified Amazon Web Services resource.
    /// </summary>
    public partial class UntagResourceRequest : AmazonLicenseManagerLinuxSubscriptionsRequest
    {
        /// <summary>
