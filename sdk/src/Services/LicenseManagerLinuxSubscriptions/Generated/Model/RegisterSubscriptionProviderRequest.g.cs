...
{
    /// <summary>
    /// Container for the parameters to the RegisterSubscriptionProvider operation. Register
    /// the supported third-party subscription provider for your Bring Your Own License (BYOL)
    /// subscription.
    /// </summary>
