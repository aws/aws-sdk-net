...
{
    /// <summary>
    /// Container for the parameters to the ListTagsForResource operation. List the metadata
    /// tags that are assigned to the specified Amazon Web Services resource.
    /// </summary>
