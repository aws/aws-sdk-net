...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model
{
    ...
    public partial class ListRegisteredSubscriptionProvidersResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<RegisteredSubscriptionProvider> RegisteredSubscriptionProviders { get; set; } = AWSConfigs.InitializeCollections ? new List<RegisteredSubscriptionProvider>() : null;

        /// <summary>
        /// Checks to see if the RegisteredSubscriptionProviders property is set.
        /// </summary>
        internal bool IsSetRegisteredSubscriptionProviders() => this.RegisteredSubscriptionProviders != null && (this.RegisteredSubscriptionProviders.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
