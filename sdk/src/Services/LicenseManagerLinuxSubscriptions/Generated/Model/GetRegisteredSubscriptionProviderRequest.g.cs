...
{
    /// <summary>
    /// Container for the parameters to the GetRegisteredSubscriptionProvider operation. Get
    /// details for a Bring Your Own License (BYOL) subscription that's registered to your
    /// account.
    /// </summary>
