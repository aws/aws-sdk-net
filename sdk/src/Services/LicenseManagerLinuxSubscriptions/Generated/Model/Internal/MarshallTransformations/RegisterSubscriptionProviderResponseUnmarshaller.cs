...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterSubscriptionProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterSubscriptionProviderResponse response = new RegisterSubscriptionProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SubscriptionProviderArn", targetDepth))
                {
                    ...
                    response.SubscriptionProviderArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SubscriptionProviderSource", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SubscriptionProviderSource = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SubscriptionProviderStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SubscriptionProviderStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static RegisterSubscriptionProviderResponseUnmarshaller _instance = new RegisterSubscriptionProviderResponseUnmarshaller();        

        internal static RegisterSubscriptionProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterSubscriptionProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
