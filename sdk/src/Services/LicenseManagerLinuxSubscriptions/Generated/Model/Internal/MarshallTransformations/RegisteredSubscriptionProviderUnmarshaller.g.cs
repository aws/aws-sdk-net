...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisteredSubscriptionProviderUnmarshaller : IJsonUnmarshaller<RegisteredSubscriptionProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RegisteredSubscriptionProvider();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RegisteredSubscriptionProviderUnmarshaller Instance => _instance;
    }
}
