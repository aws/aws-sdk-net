        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("HomeRegions", targetDepth))
                {
                    ...
                    response.HomeRegions = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LinuxSubscriptionsDiscovery", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LinuxSubscriptionsDiscovery = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LinuxSubscriptionsDiscoverySettings", targetDepth))
                {
                    ...
                    response.LinuxSubscriptionsDiscoverySettings = unmarshaller.Unmarshall(context);
                    continue;
                }
