...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetServiceSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetServiceSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("HomeRegions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.HomeRegions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("LinuxSubscriptionsDiscovery", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.LinuxSubscriptionsDiscovery = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("LinuxSubscriptionsDiscoverySettings", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.LinuxSubscriptionsDiscoverySettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetServiceSettingsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetServiceSettingsResponseUnmarshaller Instance => _instance;
    }
}
