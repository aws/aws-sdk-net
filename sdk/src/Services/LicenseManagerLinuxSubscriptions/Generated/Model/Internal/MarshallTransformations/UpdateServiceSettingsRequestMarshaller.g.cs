...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateServiceSettingsRequestMarshaller : IMarshaller<IRequest, UpdateServiceSettingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateServiceSettingsRequestMarshaller _instance = new();

        internal static UpdateServiceSettingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateServiceSettingsRequestMarshaller Instance => _instance;
    }
}
