...
using Amazon.Util;
using Amazon.DeviceFarm.Endpoints;

#pragma warning disable 1591

namespace Amazon.DeviceFarm.Internal
{
    /// <summary>
    /// Amazon DeviceFarm endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for DeviceFarm service requests.
    /// Collects values for DeviceFarmEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses DeviceFarmEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonDeviceFarmEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonDeviceFarmConfig)requestContext.ClientConfig;
            var result = new DeviceFarmEndpointParameters();
