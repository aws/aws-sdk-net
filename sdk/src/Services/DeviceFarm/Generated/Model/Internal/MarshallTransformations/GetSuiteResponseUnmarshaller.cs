...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSuiteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSuiteResponse response = new GetSuiteResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SuiteUnmarshaller.Instance;
                    response.Suite = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSuiteResponseUnmarshaller _instance = new GetSuiteResponseUnmarshaller();        

        internal static GetSuiteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSuiteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
