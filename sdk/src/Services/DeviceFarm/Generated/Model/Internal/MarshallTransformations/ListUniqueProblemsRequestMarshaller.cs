...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListUniqueProblemsRequestMarshaller : IMarshaller<IRequest, ListUniqueProblemsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUniqueProblemsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUniqueProblemsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DeviceFarm");
            string target = "DeviceFarm_20150623.ListUniqueProblems";
