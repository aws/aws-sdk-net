...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobReportUnmarshaller : IJsonUnmarshaller<JobReport, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobReport Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("jobDetailsUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.JobDetailsUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = JobReportMetricsUnmarshaller.Instance;
