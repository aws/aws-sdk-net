...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    public class DeviceSelectionConfigurationMarshaller : IRequestMarshaller<DeviceSelectionConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DeviceSelectionConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMaxDevices())
            {
                context.Writer.WritePropertyName("maxDevices");
                context.Writer.WriteNumberValue(requestObject.MaxDevices.Value);
            }
