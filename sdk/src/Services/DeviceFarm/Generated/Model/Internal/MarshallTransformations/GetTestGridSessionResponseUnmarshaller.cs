...
{
    /// <summary>
    /// Response Unmarshaller for GetTestGridSession operation
    /// </summary>  
    public class GetTestGridSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTestGridSessionResponse response = new GetTestGridSessionResponse();
            ...
            {
                if (context.TestExpression("testGridSession", targetDepth, ref reader))
                {
                    var unmarshaller = TestGridSessionUnmarshaller.Instance;
                    response.TestGridSession = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTestGridSessionResponseUnmarshaller _instance = new GetTestGridSessionResponseUnmarshaller();        

        internal static GetTestGridSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTestGridSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
