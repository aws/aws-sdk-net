...
namespace Amazon.DeviceFarm.Model
{
    ...
    /// </summary>
    internal sealed partial class ListDevicesPaginator : IPaginator<ListDevicesResponse>, IListDevicesPaginator
    {
        private readonly IAmazonDeviceFarm _client;
        private readonly ListDevicesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListDevicesResponse> Responses => new PaginatedResponse<ListDevicesResponse>(this);
...
#if BCL
        IEnumerable<ListDevicesResponse> IPaginator<ListDevicesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListDevices(_request);
        ...
        async IAsyncEnumerable<ListDevicesResponse> IPaginator<ListDevicesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListDevicesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
