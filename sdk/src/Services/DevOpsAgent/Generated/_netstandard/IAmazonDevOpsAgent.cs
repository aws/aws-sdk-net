...
namespace Amazon.DevOpsAgent
{
    ...
    public partial interface IAmazonDevOpsAgent : IAmazonService, IDisposable
    {
        ...
        Task<UpdateApprovalActionResponse> UpdateApprovalActionAsync(UpdateApprovalActionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
