...
{
    /// <summary>
    /// Amazon DevOpsAgent endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for DevOpsAgent service requests.
    /// Collects values for DevOpsAgentEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses DevOpsAgentEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonDevOpsAgentEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonDevOpsAgentConfig)requestContext.ClientConfig;
            var result = new DevOpsAgentEndpointParameters();
