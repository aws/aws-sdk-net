...
namespace Amazon.DevOpsAgent.Internal
{
    ...
    public class AmazonDevOpsAgentAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDevOpsAgentAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DevOpsAgent.
        /// </summary>
        public AmazonDevOpsAgentAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDevOpsAgentAuthSchemeParameters
            {
    ...
    public class AmazonDevOpsAgentAuthSchemeResolver : IAuthSchemeResolver<AmazonDevOpsAgentAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDevOpsAgentAuthSchemeParameters authParameters)
        {
