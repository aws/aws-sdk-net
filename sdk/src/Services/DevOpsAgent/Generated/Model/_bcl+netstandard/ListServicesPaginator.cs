...
namespace Amazon.DevOpsAgent.Model
{
    ...
    internal sealed partial class ListServicesPaginator : IPaginator<ListServicesResponse>, IListServicesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<RegisteredService> Services => 
            new PaginatedResultKeyResponse<ListServicesResponse, RegisteredService>(this, (i) => i.Services ?? new List<RegisteredService>());

        internal ListServicesPaginator(IAmazonDevOpsAgent client, ListServicesRequest request)
        {
            this._client = client;
