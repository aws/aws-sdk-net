...
namespace Amazon.DevOpsAgent.Model
{
    ...
    internal sealed partial class ListAssetsPaginator : IPaginator<ListAssetsResponse>, IListAssetsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<Asset> Items => 
            new PaginatedResultKeyResponse<ListAssetsResponse, Asset>(this, (i) => i.Items ?? new List<Asset>());

        internal ListAssetsPaginator(IAmazonDevOpsAgent client, ListAssetsRequest request)
        {
            this._client = client;
