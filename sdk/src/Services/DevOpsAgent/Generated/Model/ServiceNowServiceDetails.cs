...
namespace Amazon.DevOpsAgent.Model
{
    ...
    /// </summary>
    public partial class ServiceNowServiceDetails
    {
        private ServiceNowServiceAuthorizationConfig _authorizationConfig;
        private string _instanceUrl;

        /// <summary>
        /// Gets and sets the property AuthorizationConfig. 
        /// <para>
        /// ServiceNow OAuth client credentials configuration. Use this when registering with
        /// OAuth client credentials flow.
        /// </para>
        /// </summary>
        public ServiceNowServiceAuthorizationConfig AuthorizationConfig
        {
