...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListPrivateConnectionsRequestMarshaller : IMarshaller<IRequest, ListPrivateConnectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListPrivateConnectionsRequestMarshaller _instance = new ListPrivateConnectionsRequestMarshaller();        

        internal static ListPrivateConnectionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPrivateConnectionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
