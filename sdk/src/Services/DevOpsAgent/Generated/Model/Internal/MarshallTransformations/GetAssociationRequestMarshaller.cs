...
{
    /// <summary>
    /// GetAssociation Request Marshaller
    /// </summary>       
    public class GetAssociationRequestMarshaller : IMarshaller<IRequest, GetAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAssociationRequest publicRequest)
        {
        ...
        private static GetAssociationRequestMarshaller _instance = new GetAssociationRequestMarshaller();        

        internal static GetAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
