...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduleConditionUnmarshaller : IJsonUnmarshaller<ScheduleCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ScheduleCondition unmarshalledObject = new ScheduleCondition();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ScheduleConditionUnmarshaller Instance
        {
            get
            {
                return _instance;
