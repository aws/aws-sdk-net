...
{
    /// <summary>
    /// CreateBacklogTask Request Marshaller
    /// </summary>       
    public class CreateBacklogTaskRequestMarshaller : IMarshaller<IRequest, CreateBacklogTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateBacklogTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateBacklogTaskRequest publicRequest)
        {
            ...
            request.ResourcePath = "/backlog/agent-space/{agentSpaceId}/tasks";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetReference())
            {
                ...
                var marshaller = ReferenceInputMarshaller.Instance;
        ...
        private static CreateBacklogTaskRequestMarshaller _instance = new CreateBacklogTaskRequestMarshaller();        

        internal static CreateBacklogTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBacklogTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
