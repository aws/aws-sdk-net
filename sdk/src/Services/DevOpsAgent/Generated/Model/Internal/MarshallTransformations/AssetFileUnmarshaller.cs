...
{
    /// <summary>
    /// Response Unmarshaller for AssetFile Object
    /// </summary>  
    public class AssetFileUnmarshaller : IJsonUnmarshaller<AssetFile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetFile Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AssetFile unmarshalledObject = new AssetFile();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AssetFileBodyUnmarshaller.Instance;
        ...
        private static AssetFileUnmarshaller _instance = new AssetFileUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssetFileUnmarshaller Instance
        {
            get
            {
                return _instance;
