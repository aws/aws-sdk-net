...
{
    /// <summary>
    /// Response Unmarshaller for GetAccountUsage operation
    /// </summary>  
    public class GetAccountUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccountUsageResponse response = new GetAccountUsageResponse();
        ...
        private static GetAccountUsageResponseUnmarshaller _instance = new GetAccountUsageResponseUnmarshaller();        

        internal static GetAccountUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
