...
{
    /// <summary>
    /// MCPServerGrafanaConfiguration Marshaller
    /// </summary>
    public class MCPServerGrafanaConfigurationMarshaller : IRequestMarshaller<MCPServerGrafanaConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(MCPServerGrafanaConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTools())
            {
                ...
                {
                        context.Writer.WriteStringValue(requestObjectToolsListValue);
                }
        ...
        /// </summary>
        public readonly static MCPServerGrafanaConfigurationMarshaller Instance = new MCPServerGrafanaConfigurationMarshaller();
