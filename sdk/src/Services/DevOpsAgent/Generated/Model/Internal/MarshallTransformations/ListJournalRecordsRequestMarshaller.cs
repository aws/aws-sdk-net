...
{
    /// <summary>
    /// ListJournalRecords Request Marshaller
    /// </summary>       
    public class ListJournalRecordsRequestMarshaller : IMarshaller<IRequest, ListJournalRecordsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListJournalRecordsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListJournalRecordsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/journal/agent-space/{agentSpaceId}/journalRecords";
#if !NETFRAMEWORK
        ...
        private static ListJournalRecordsRequestMarshaller _instance = new ListJournalRecordsRequestMarshaller();        

        internal static ListJournalRecordsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListJournalRecordsRequestMarshaller Instance
        {
            get
            {
                return _instance;
