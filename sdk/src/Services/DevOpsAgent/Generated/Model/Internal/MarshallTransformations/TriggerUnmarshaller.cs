    ...
    public class TriggerUnmarshaller : IJsonUnmarshaller<Trigger, JsonUnmarshallerContext>
    {
        ...
        public Trigger Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TriggerConditionUnmarshaller.Instance;
                ...
                if (context.TestExpression("triggerId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TriggerId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
