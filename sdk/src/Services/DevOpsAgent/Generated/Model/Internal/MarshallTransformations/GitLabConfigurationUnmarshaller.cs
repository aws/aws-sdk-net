...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GitLabConfigurationUnmarshaller : IJsonUnmarshaller<GitLabConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            GitLabConfiguration unmarshalledObject = new GitLabConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("projectPath", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GitLabConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
