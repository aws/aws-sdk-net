...
{
    /// <summary>
    /// UpdateAssetFile Request Marshaller
    /// </summary>       
    public class UpdateAssetFileRequestMarshaller : IMarshaller<IRequest, UpdateAssetFileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAssetFileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAssetFileRequest publicRequest)
        {
        ...
        private static UpdateAssetFileRequestMarshaller _instance = new UpdateAssetFileRequestMarshaller();        

        internal static UpdateAssetFileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetFileRequestMarshaller Instance
        {
            get
            {
                return _instance;
