...
{
    /// <summary>
    /// Response Unmarshaller for GetAssetContent operation
    /// </summary>  
    public class GetAssetContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAssetContentResponse response = new GetAssetContentResponse();
        ...
        private static GetAssetContentResponseUnmarshaller _instance = new GetAssetContentResponseUnmarshaller();        

        internal static GetAssetContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssetContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
