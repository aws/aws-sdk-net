...
{
    /// <summary>
    /// ListAssetVersions Request Marshaller
    /// </summary>       
    public class ListAssetVersionsRequestMarshaller : IMarshaller<IRequest, ListAssetVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAssetVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAssetVersionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/asset/agent-space/{agentSpaceId}/assets/{assetId}/versions";
        ...
        private static ListAssetVersionsRequestMarshaller _instance = new ListAssetVersionsRequestMarshaller();        

        internal static ListAssetVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssetVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
