...
{
    /// <summary>
    /// Response Unmarshaller for IdentityCenterServiceException Object
    /// </summary>  
    public class IdentityCenterServiceExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<IdentityCenterServiceException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentityCenterServiceException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            IdentityCenterServiceException unmarshalledObject = new IdentityCenterServiceException(errorResponse.Message, errorResponse.InnerException,
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IdentityCenterServiceExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
