...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageMetricUnmarshaller : IJsonUnmarshaller<UsageMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            UsageMetric unmarshalledObject = new UsageMetric();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UsageMetricUnmarshaller Instance
        {
            get
            {
                return _instance;
