...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    public class ListRecommendationsRequestMarshaller : IMarshaller<IRequest, ListRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListRecommendationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/backlog/agent-space/{agentSpaceId}/recommendations/list";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetGoalId())
            {
                context.Writer.WritePropertyName("goalId");
                context.Writer.WriteStringValue(publicRequest.GoalId);
            }
