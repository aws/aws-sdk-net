...
{
    /// <summary>
    /// ListAssetFiles Request Marshaller
    /// </summary>       
    public class ListAssetFilesRequestMarshaller : IMarshaller<IRequest, ListAssetFilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAssetFilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAssetFilesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/asset/agent-space/{agentSpaceId}/assets/{assetId}/files";
        ...
        private static ListAssetFilesRequestMarshaller _instance = new ListAssetFilesRequestMarshaller();        

        internal static ListAssetFilesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssetFilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
