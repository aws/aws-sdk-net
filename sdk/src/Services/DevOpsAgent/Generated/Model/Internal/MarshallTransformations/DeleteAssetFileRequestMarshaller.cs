...
{
    /// <summary>
    /// DeleteAssetFile Request Marshaller
    /// </summary>       
    public class DeleteAssetFileRequestMarshaller : IMarshaller<IRequest, DeleteAssetFileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAssetFileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAssetFileRequest publicRequest)
        {
        ...
        private static DeleteAssetFileRequestMarshaller _instance = new DeleteAssetFileRequestMarshaller();        

        internal static DeleteAssetFileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAssetFileRequestMarshaller Instance
        {
            get
            {
                return _instance;
