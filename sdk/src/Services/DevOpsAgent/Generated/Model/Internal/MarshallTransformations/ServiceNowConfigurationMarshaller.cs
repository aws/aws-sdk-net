    ...
    public class ServiceNowConfigurationMarshaller : IRequestMarshaller<ServiceNowConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ServiceNowConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAuthScopes())
            {
                context.Writer.WritePropertyName("authScopes");
                context.Writer.WriteStartArray();
                foreach(var requestObjectAuthScopesListValue in requestObject.AuthScopes)
                {
                        context.Writer.WriteStringValue(requestObjectAuthScopesListValue);
                }
