...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    public class ListAssociationsRequestMarshaller : IMarshaller<IRequest, ListAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListAssociationsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetFilterServiceTypes())
                request.Parameters.Add("filterServiceTypes", StringUtils.FromString(publicRequest.FilterServiceTypes));
            ...
            request.ResourcePath = "/v1/agentspaces/{agentSpaceId}/associations/list";
