...
{
    /// <summary>
    /// DisassociateService Request Marshaller
    /// </summary>       
    public class DisassociateServiceRequestMarshaller : IMarshaller<IRequest, DisassociateServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateServiceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateServiceRequest publicRequest)
        {
        ...
        private static DisassociateServiceRequestMarshaller _instance = new DisassociateServiceRequestMarshaller();        

        internal static DisassociateServiceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateServiceRequestMarshaller Instance
        {
            get
            {
                return _instance;
