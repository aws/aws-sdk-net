...
{
    /// <summary>
    /// Response Unmarshaller for JournalRecord Object
    /// </summary>  
    public class JournalRecordUnmarshaller : IJsonUnmarshaller<JournalRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JournalRecord Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            JournalRecord unmarshalledObject = new JournalRecord();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("userReference", targetDepth, ref reader))
                {
                    var unmarshaller = UserReferenceUnmarshaller.Instance;
                    unmarshalledObject.UserReference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static JournalRecordUnmarshaller _instance = new JournalRecordUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static JournalRecordUnmarshaller Instance
        {
            get
            {
                return _instance;
