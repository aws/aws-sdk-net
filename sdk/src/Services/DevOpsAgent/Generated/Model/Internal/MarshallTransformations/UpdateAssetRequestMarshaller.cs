...
{
    /// <summary>
    /// UpdateAsset Request Marshaller
    /// </summary>       
    public class UpdateAssetRequestMarshaller : IMarshaller<IRequest, UpdateAssetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAssetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAssetRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetContent())
            {
                ...
                var marshaller = AssetContentMarshaller.Instance;
        ...
        private static UpdateAssetRequestMarshaller _instance = new UpdateAssetRequestMarshaller();        

        internal static UpdateAssetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetRequestMarshaller Instance
        {
            get
            {
                return _instance;
