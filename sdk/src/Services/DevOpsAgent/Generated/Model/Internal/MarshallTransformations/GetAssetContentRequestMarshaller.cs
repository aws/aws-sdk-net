...
namespace Amazon.DevOpsAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAssetContentRequestMarshaller : IMarshaller<IRequest, GetAssetContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetAssetContentRequestMarshaller _instance = new GetAssetContentRequestMarshaller();        

        internal static GetAssetContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssetContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
