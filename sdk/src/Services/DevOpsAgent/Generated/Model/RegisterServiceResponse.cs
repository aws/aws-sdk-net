...
namespace Amazon.DevOpsAgent.Model
{
    ...
    {
        private AdditionalServiceRegistrationStep _additionalStep;
        ...
        /// </para>
        /// </summary>
        public AdditionalServiceRegistrationStep AdditionalStep
        {
            get { return this._additionalStep; }
            set { this._additionalStep = value; }
        }

        // Check to see if AdditionalStep property is set
        internal bool IsSetAdditionalStep()
        {
            return this._additionalStep != null;
        }
