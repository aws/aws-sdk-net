...
namespace Amazon.DevOpsAgent.Model
{
    ...
    /// names are allowed.
    /// </summary>
    public partial class CreateAgentSpaceRequest : AmazonDevOpsAgentRequest
    {
        ...
        /// <para>
        /// Client-provided token to ensure request idempotency. When the same token is provided
        /// in subsequent calls, the same response is returned within a 8-hour window.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The preferences to configure on the agent space. Preferences not provided take their
        /// default values.
        /// </para>
        /// <para />
