...
{
    /// <summary>
    /// Container for the parameters to the GetAssetFile operation.
    /// Gets a file from an asset
    /// </summary>
    public partial class GetAssetFileRequest : AmazonDevOpsAgentRequest
    {
        ...
        /// <para>
        /// The specific asset version to retrieve the file from. If omitted, the latest version
        /// is returned.
        /// </para>
        /// </summary>
        [AWSProperty(Min=1)]
