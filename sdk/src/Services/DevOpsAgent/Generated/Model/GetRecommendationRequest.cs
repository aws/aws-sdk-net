...
namespace Amazon.DevOpsAgent.Model
{
    ...
    /// </summary>
    public partial class GetRecommendationRequest : AmazonDevOpsAgentRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property RecommendationVersion. 
        /// <para>
        /// Specific version of the recommendation to retrieve. If not specified, returns the
        /// latest version.
        /// </para>
        /// </summary>
        public long? RecommendationVersion
        {
            get { return this._recommendationVersion; }
            set { this._recommendationVersion = value; }
        }

        // Check to see if RecommendationVersion property is set
        internal bool IsSetRecommendationVersion()
        {
            return this._recommendationVersion.HasValue; 
        }
