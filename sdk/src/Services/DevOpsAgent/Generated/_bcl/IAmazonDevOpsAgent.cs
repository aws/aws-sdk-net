...
namespace Amazon.DevOpsAgent
{
    ...
    public partial interface IAmazonDevOpsAgent : IAmazonService, IDisposable
    {
        ...
        AllowVendedLogDeliveryForResourceResponse AllowVendedLogDeliveryForResource(AllowVendedLogDeliveryForResourceRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/AllowVendedLogDeliveryForResource">REST API Reference for AllowVendedLogDeliveryForResource Operation</seealso>
        Task<AllowVendedLogDeliveryForResourceResponse> AllowVendedLogDeliveryForResourceAsync(AllowVendedLogDeliveryForResourceRequest request, CancellationToken cancellationToken = default(CancellationToken));
