...
namespace Amazon.SecurityToken.Model
{
    ...
    public partial class PackedPolicyTooLargeException : AmazonSecurityTokenServiceException
    {
        ...
        public PackedPolicyTooLargeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PackedPolicyTooLargeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
