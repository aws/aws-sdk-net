...
namespace Amazon.SecurityToken.Internal
{
    ...
    /// </summary>
    public class AmazonSecurityTokenServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSecurityTokenServiceConfig)requestContext.ClientConfig;
            var result = new SecurityTokenServiceEndpointParameters();
