...
namespace Amazon.SecurityToken.Internal
{
    ...
    public class AmazonSecurityTokenServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSecurityTokenServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SecurityTokenService.
        /// </summary>
        public AmazonSecurityTokenServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSecurityTokenServiceAuthSchemeParameters
            {
    ...
    public class AmazonSecurityTokenServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonSecurityTokenServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSecurityTokenServiceAuthSchemeParameters authParameters)
        {
