...
namespace Amazon.SecurityToken
{
    ...
    public partial interface IAmazonSecurityTokenService : IAmazonService, IDisposable
    {
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the AssumeRoot operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the AssumeRoot operation on AmazonSecurityTokenServiceClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndAssumeRoot
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoot">REST API Reference for AssumeRoot Operation</seealso>
        IAsyncResult BeginAssumeRoot(AssumeRootRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  AssumeRoot operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginAssumeRoot.</param>
        /// 
        /// <returns>Returns a  AssumeRootResult from SecurityTokenService.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoot">REST API Reference for AssumeRoot Operation</seealso>
        AssumeRootResponse EndAssumeRoot(IAsyncResult asyncResult);
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetDelegatedAccessToken">REST API Reference for GetDelegatedAccessToken Operation</seealso>
        IAsyncResult BeginGetDelegatedAccessToken(GetDelegatedAccessTokenRequest request, AsyncCallback callback, object state);
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetDelegatedAccessToken">REST API Reference for GetDelegatedAccessToken Operation</seealso>
        GetDelegatedAccessTokenResponse EndGetDelegatedAccessToken(IAsyncResult asyncResult);
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GetWebIdentityToken operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GetWebIdentityToken operation on AmazonSecurityTokenServiceClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGetWebIdentityToken
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetWebIdentityToken">REST API Reference for GetWebIdentityToken Operation</seealso>
        IAsyncResult BeginGetWebIdentityToken(GetWebIdentityTokenRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  GetWebIdentityToken operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetWebIdentityToken.</param>
        /// 
        /// <returns>Returns a  GetWebIdentityTokenResult from SecurityTokenService.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetWebIdentityToken">REST API Reference for GetWebIdentityToken Operation</seealso>
        GetWebIdentityTokenResponse EndGetWebIdentityToken(IAsyncResult asyncResult);
