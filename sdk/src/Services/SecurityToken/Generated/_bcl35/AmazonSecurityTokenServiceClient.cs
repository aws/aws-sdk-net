...
namespace Amazon.SecurityToken
{
    ...
    public partial class AmazonSecurityTokenServiceClient : AmazonServiceClient, IAmazonSecurityTokenService
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoot">REST API Reference for AssumeRoot Operation</seealso>
        public virtual IAsyncResult BeginAssumeRoot(AssumeRootRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = AssumeRootRequestMarshaller.Instance;
            options.ResponseUnmarshaller = AssumeRootResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoot">REST API Reference for AssumeRoot Operation</seealso>
        public virtual AssumeRootResponse EndAssumeRoot(IAsyncResult asyncResult)
        {
            return EndInvoke<AssumeRootResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetWebIdentityToken">REST API Reference for GetWebIdentityToken Operation</seealso>
        public virtual IAsyncResult BeginGetWebIdentityToken(GetWebIdentityTokenRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetWebIdentityTokenRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetWebIdentityTokenResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetWebIdentityToken">REST API Reference for GetWebIdentityToken Operation</seealso>
        public virtual GetWebIdentityTokenResponse EndGetWebIdentityToken(IAsyncResult asyncResult)
        {
            return EndInvoke<GetWebIdentityTokenResponse>(asyncResult);
        }
