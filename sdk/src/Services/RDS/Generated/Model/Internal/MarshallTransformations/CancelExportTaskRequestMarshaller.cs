    ...
    public class CancelExportTaskRequestMarshaller : IMarshaller<IRequest, CancelExportTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CancelExportTaskRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CancelExportTaskRequestMarshaller _instance = new CancelExportTaskRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelExportTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
