    ...
    public class DescribeAccountAttributesRequestMarshaller : IMarshaller<IRequest, DescribeAccountAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeAccountAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeAccountAttributesRequestMarshaller _instance = new DescribeAccountAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccountAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
