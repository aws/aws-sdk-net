...
{
    /// <summary>
    /// Response Unmarshaller for ModifyDBProxyTargetGroup operation
    /// </summary>  
    public class ModifyDBProxyTargetGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyDBProxyTargetGroupResponse response = new ModifyDBProxyTargetGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyDBProxyTargetGroupResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ModifyDBProxyTargetGroupResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("DBProxyTargetGroup", targetDepth))
                    {
                        var unmarshaller = DBProxyTargetGroupUnmarshaller.Instance;
                        response.DBProxyTargetGroup = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyDBProxyTargetGroupResponseUnmarshaller _instance = new ModifyDBProxyTargetGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBProxyTargetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
