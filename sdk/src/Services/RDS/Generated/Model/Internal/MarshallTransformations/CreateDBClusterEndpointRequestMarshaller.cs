...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateDBClusterEndpointRequestMarshaller : IMarshaller<IRequest, CreateDBClusterEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDBClusterEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDBClusterEndpointRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "CreateDBClusterEndpoint");
            ...
            return request;
                    ...
                    private static CreateDBClusterEndpointRequestMarshaller _instance = new CreateDBClusterEndpointRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDBClusterEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
