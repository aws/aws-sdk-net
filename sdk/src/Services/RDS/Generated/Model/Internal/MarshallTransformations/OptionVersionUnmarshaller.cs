...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class OptionVersionUnmarshaller : IUnmarshaller<OptionVersion, XmlUnmarshallerContext>, IUnmarshaller<OptionVersion, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OptionVersion Unmarshall(XmlUnmarshallerContext context)
        {
            OptionVersion unmarshalledObject = new OptionVersion();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OptionVersionUnmarshaller Instance
        {
            get
            {
                return _instance;
