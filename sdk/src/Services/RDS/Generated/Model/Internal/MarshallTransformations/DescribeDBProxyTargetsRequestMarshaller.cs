...
{
    /// <summary>
    /// DescribeDBProxyTargets Request Marshaller
    /// </summary>       
    public class DescribeDBProxyTargetsRequestMarshaller : IMarshaller<IRequest, DescribeDBProxyTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBProxyTargetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBProxyTargetsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBProxyTargets");
            ...
            return request;
                    ...
                    private static DescribeDBProxyTargetsRequestMarshaller _instance = new DescribeDBProxyTargetsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBProxyTargetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
