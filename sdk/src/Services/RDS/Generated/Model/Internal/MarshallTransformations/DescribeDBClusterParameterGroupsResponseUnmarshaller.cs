...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDBClusterParameterGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBClusterParameterGroupsResponse response = new DescribeDBClusterParameterGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBClusterParameterGroupsResult", 2))
                    {
        ...
        private static DescribeDBClusterParameterGroupsResponseUnmarshaller _instance = new DescribeDBClusterParameterGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClusterParameterGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
