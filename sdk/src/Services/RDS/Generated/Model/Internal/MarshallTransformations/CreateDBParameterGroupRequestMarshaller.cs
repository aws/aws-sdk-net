    ...
    public class CreateDBParameterGroupRequestMarshaller : IMarshaller<IRequest, CreateDBParameterGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateDBParameterGroupRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CreateDBParameterGroupRequestMarshaller _instance = new CreateDBParameterGroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDBParameterGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
