...
{
    /// <summary>
    /// Response Unmarshaller for ModifyActivityStream operation
    /// </summary>  
    public class ModifyActivityStreamResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyActivityStreamResponse response = new ModifyActivityStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyActivityStreamResult", 2))
                    {
        ...
        private static ModifyActivityStreamResponseUnmarshaller _instance = new ModifyActivityStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyActivityStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
