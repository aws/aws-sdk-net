...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDBClusterEndpointResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDBClusterEndpointResponse response = new DeleteDBClusterEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDBClusterEndpointResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DBClusterEndpointNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidDBClusterEndpointStateFault"))
            {
                return new InvalidDBClusterEndpointStateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DeleteDBClusterEndpointResponseUnmarshaller _instance = new DeleteDBClusterEndpointResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBClusterEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
