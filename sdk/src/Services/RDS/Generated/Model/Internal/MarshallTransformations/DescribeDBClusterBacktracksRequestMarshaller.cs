...
{
    /// <summary>
    /// DescribeDBClusterBacktracks Request Marshaller
    /// </summary>       
    public class DescribeDBClusterBacktracksRequestMarshaller : IMarshaller<IRequest, DescribeDBClusterBacktracksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBClusterBacktracksRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBClusterBacktracksRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBClusterBacktracks");
            request.Parameters.Add("Version", "2014-10-31");

            if(publicRequest != null)
            {
                if(publicRequest.IsSetBacktrackIdentifier())
                {
                    request.Parameters.Add("BacktrackIdentifier", StringUtils.FromString(publicRequest.BacktrackIdentifier));
                }
            ...
            return request;
                    ...
                    private static DescribeDBClusterBacktracksRequestMarshaller _instance = new DescribeDBClusterBacktracksRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClusterBacktracksRequestMarshaller Instance
        {
            get
            {
                return _instance;
