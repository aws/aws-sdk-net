...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeGlobalClustersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeGlobalClustersResponse response = new DescribeGlobalClustersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeGlobalClustersResult", 2))
                    {
        ...
        private static DescribeGlobalClustersResponseUnmarshaller _instance = new DescribeGlobalClustersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGlobalClustersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
