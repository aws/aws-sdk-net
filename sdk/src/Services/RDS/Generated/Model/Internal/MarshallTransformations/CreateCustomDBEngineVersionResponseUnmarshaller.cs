...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomDBEngineVersion operation
    /// </summary>  
    public class CreateCustomDBEngineVersionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomDBEngineVersionResponse response = new CreateCustomDBEngineVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateCustomDBEngineVersionResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("CreateCustomDBEngineVersionFault"))
                {
                    return CreateCustomDBEngineVersionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("CustomDBEngineVersionAlreadyExistsFault"))
                {
        ...
        private static CreateCustomDBEngineVersionResponseUnmarshaller _instance = new CreateCustomDBEngineVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomDBEngineVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
