...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidS3BucketExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<InvalidS3BucketException, XmlUnmarshallerContext>
    {
        ...
        private static InvalidS3BucketExceptionUnmarshaller _instance = new InvalidS3BucketExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvalidS3BucketExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
