...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteGlobalClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGlobalClusterResponse response = new DeleteGlobalClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteGlobalClusterResult", 2))
                    {
        ...
        private static DeleteGlobalClusterResponseUnmarshaller _instance = new DeleteGlobalClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGlobalClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
