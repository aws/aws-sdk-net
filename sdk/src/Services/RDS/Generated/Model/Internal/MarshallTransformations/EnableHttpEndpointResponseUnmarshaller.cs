...
{
    /// <summary>
    /// Response Unmarshaller for EnableHttpEndpoint operation
    /// </summary>  
    public class EnableHttpEndpointResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableHttpEndpointResponse response = new EnableHttpEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnableHttpEndpointResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("HttpEndpointEnabled", targetDepth))
                    {
                        ...
                        response.HttpEndpointEnabled = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        private static EnableHttpEndpointResponseUnmarshaller _instance = new EnableHttpEndpointResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableHttpEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
