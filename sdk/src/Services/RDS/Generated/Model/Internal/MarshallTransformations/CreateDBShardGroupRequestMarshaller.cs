...
{
    /// <summary>
    /// CreateDBShardGroup Request Marshaller
    /// </summary>       
    public class CreateDBShardGroupRequestMarshaller : IMarshaller<IRequest, CreateDBShardGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDBShardGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDBShardGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "CreateDBShardGroup");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDBShardGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
