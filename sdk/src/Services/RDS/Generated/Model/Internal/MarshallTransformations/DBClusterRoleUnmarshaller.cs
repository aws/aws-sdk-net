...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class DBClusterRoleUnmarshaller : IXmlUnmarshaller<DBClusterRole, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DBClusterRole Unmarshall(XmlUnmarshallerContext context)
        {
            DBClusterRole unmarshalledObject = new DBClusterRole();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DBClusterRoleUnmarshaller Instance
        {
            get
            {
                return _instance;
