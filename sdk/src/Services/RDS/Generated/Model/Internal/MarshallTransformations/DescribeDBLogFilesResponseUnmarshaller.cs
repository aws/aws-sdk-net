...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDBLogFiles operation
    /// </summary>  
    public class DescribeDBLogFilesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBLogFilesResponse response = new DescribeDBLogFilesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBLogFilesResult", 2))
                    {
        ...
        private static DescribeDBLogFilesResponseUnmarshaller _instance = new DescribeDBLogFilesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBLogFilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
