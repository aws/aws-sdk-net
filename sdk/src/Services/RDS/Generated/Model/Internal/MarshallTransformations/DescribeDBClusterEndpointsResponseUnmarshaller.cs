...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDBClusterEndpointsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBClusterEndpointsResponse response = new DescribeDBClusterEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBClusterEndpointsResult", 2))
                    {
        ...
        private static DescribeDBClusterEndpointsResponseUnmarshaller _instance = new DescribeDBClusterEndpointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClusterEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
