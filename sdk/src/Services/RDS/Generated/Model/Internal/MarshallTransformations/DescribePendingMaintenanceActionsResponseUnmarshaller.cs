...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribePendingMaintenanceActionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePendingMaintenanceActionsResponse response = new DescribePendingMaintenanceActionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribePendingMaintenanceActionsResult", 2))
                    {
        ...
        private static DescribePendingMaintenanceActionsResponseUnmarshaller _instance = new DescribePendingMaintenanceActionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePendingMaintenanceActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
