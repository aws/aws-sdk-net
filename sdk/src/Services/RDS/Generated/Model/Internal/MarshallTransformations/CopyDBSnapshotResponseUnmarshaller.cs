...
{
    /// <summary>
    /// Response Unmarshaller for CopyDBSnapshot operation
    /// </summary>  
    public class CopyDBSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CopyDBSnapshotResponse response = new CopyDBSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CopyDBSnapshotResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CopyDBSnapshotResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        response.DBSnapshot = DBSnapshotUnmarshaller.Instance.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static CopyDBSnapshotResponseUnmarshaller _instance = new CopyDBSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CopyDBSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
