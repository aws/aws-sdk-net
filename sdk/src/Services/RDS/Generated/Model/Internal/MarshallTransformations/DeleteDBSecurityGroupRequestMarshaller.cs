    ...
    public class DeleteDBSecurityGroupRequestMarshaller : IMarshaller<IRequest, DeleteDBSecurityGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteDBSecurityGroupRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DeleteDBSecurityGroupRequestMarshaller _instance = new DeleteDBSecurityGroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBSecurityGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
