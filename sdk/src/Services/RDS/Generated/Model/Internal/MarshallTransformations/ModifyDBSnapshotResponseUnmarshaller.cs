...
{
    /// <summary>
    /// Response Unmarshaller for ModifyDBSnapshot operation
    /// </summary>  
    public class ModifyDBSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyDBSnapshotResponse response = new ModifyDBSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyDBSnapshotResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("DBSnapshot", targetDepth))
                    {
                        ...
                        response.DBSnapshot = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyDBSnapshotResponseUnmarshaller _instance = new ModifyDBSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
