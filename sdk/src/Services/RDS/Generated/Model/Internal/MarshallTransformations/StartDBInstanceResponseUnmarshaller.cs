...
{
    /// <summary>
    /// Response Unmarshaller for StartDBInstance operation
    /// </summary>  
    public class StartDBInstanceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDBInstanceResponse response = new StartDBInstanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("StartDBInstanceResult", 2))
                    {
        ...
        private static StartDBInstanceResponseUnmarshaller _instance = new StartDBInstanceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDBInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
