...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDBClusterEndpointsRequestMarshaller : IMarshaller<IRequest, DescribeDBClusterEndpointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBClusterEndpointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBClusterEndpointsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBClusterEndpoints");
            ...
            return request;
                    ...
                    private static DescribeDBClusterEndpointsRequestMarshaller _instance = new DescribeDBClusterEndpointsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClusterEndpointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
