...
namespace Amazon.RDS.Model
{
    ...
    [Serializable]
    #endif
    public partial class SNSInvalidTopicException : AmazonRDSException
    {
        ...
        public SNSInvalidTopicException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SNSInvalidTopicException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
