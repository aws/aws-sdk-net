...
namespace Amazon.RDS.Model
{
    ...
    public partial class InvalidDBSubnetGroupException : AmazonRDSException
    {
        ...
        /// <summary>
        /// Construct instance of InvalidDBSubnetGroupException
        /// </summary>
        ...
        public InvalidDBSubnetGroupException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDBSubnetGroupException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected InvalidDBSubnetGroupException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
