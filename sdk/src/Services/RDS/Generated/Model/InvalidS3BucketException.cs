...
namespace Amazon.RDS.Model
{
    ...
    public partial class InvalidS3BucketException : AmazonRDSException
    {
        ...
        /// <summary>
        /// Default constructor for InvalidS3BucketException
        /// message.
        /// </summary>
        public InvalidS3BucketException() 
            : base() {}
        ...
        public InvalidS3BucketException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidS3BucketException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
