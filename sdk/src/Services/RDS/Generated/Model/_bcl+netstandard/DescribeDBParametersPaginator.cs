...
namespace Amazon.RDS.Model
{
    ...
    internal sealed partial class DescribeDBParametersPaginator : IPaginator<DescribeDBParametersResponse>, IDescribeDBParametersPaginator
    {
        ...
        async IAsyncEnumerable<DescribeDBParametersResponse> IPaginator<DescribeDBParametersResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
