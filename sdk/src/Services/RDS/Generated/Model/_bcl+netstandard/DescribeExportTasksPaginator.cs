...
namespace Amazon.RDS.Model
{
    ...
    internal sealed partial class DescribeExportTasksPaginator : IPaginator<DescribeExportTasksResponse>, IDescribeExportTasksPaginator
    {
        ...
        /// <summary>
        /// Enumerable containing all of the ExportTasks
        /// </summary>
        public IPaginatedEnumerable<ExportTask> ExportTasks => 
            new PaginatedResultKeyResponse<DescribeExportTasksResponse, ExportTask>(this, (i) => i.ExportTasks ?? new List<ExportTask>());

        internal DescribeExportTasksPaginator(IAmazonRDS client, DescribeExportTasksRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<DescribeExportTasksResponse> IPaginator<DescribeExportTasksResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
