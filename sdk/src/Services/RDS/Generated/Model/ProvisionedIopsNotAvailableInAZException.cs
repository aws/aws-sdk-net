...
namespace Amazon.RDS.Model
{
    ...
    public partial class ProvisionedIopsNotAvailableInAZException : AmazonRDSException
    {
        ...
        public ProvisionedIopsNotAvailableInAZException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ProvisionedIopsNotAvailableInAZException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected ProvisionedIopsNotAvailableInAZException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
