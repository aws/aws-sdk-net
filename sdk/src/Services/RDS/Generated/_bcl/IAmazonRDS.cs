...
namespace Amazon.RDS
{
    ...
    public partial interface IAmazonRDS : IAmazonService, IDisposable
    {
        ...
        DescribeServerlessV2PlatformVersionsResponse DescribeServerlessV2PlatformVersions(DescribeServerlessV2PlatformVersionsRequest request);
        ...
        /// <returns>The response from the DescribeServerlessV2PlatformVersions service method, as returned by RDS.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/DescribeServerlessV2PlatformVersions">REST API Reference for DescribeServerlessV2PlatformVersions Operation</seealso>
        Task<DescribeServerlessV2PlatformVersionsResponse> DescribeServerlessV2PlatformVersionsAsync(DescribeServerlessV2PlatformVersionsRequest request, CancellationToken cancellationToken = default(CancellationToken));
