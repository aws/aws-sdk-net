...
namespace Amazon.AIOps
{
    ...
    public partial class AmazonAIOpsClient : AmazonServiceClient, IAmazonAIOps
    {
        ...
        /// 
        /// </summary>
        public AmazonAIOpsClient() : base(new AmazonAIOpsConfig()) { }
        ...
        public AmazonAIOpsClient(RegionEndpoint region) : base(new AmazonAIOpsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAIOpsClient(AmazonAIOpsConfig config) : base(config) { }
