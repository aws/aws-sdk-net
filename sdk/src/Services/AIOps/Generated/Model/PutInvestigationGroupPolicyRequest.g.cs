...
{
    /// <summary>
    /// Container for the parameters to the PutInvestigationGroupPolicy operation. Creates
    /// an IAM resource policy and assigns it to the specified investigation group. <para>
    ...
    /// you must use this operation to create a policy similar to this example. </para> <para>
