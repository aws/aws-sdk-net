...
namespace Amazon.AIOps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListInvestigationGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListInvestigationGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("investigationGroups", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.InvestigationGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListInvestigationGroupsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListInvestigationGroupsResponseUnmarshaller Instance => _instance;
    }
}
