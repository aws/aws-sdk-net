...
namespace Amazon.AIOps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetInvestigationGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetInvestigationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("chatbotNotificationChannel", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChatbotNotificationChannel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("crossAccountConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.CrossAccountConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("isCloudTrailEventHistoryEnabled", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IsCloudTrailEventHistoryEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("tagKeyBoundaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TagKeyBoundaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetInvestigationGroupResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInvestigationGroupResponseUnmarshaller Instance => _instance;
    }
}
