...
namespace Amazon.AIOps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteInvestigationGroupRequestMarshaller : IMarshaller<IRequest, DeleteInvestigationGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteInvestigationGroupRequestMarshaller _instance = new();

        internal static DeleteInvestigationGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteInvestigationGroupRequestMarshaller Instance => _instance;
    }
}
