...
namespace Amazon.AIOps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateInvestigationGroupRequestMarshaller : IMarshaller<IRequest, CreateInvestigationGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateInvestigationGroupRequestMarshaller _instance = new();

        internal static CreateInvestigationGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateInvestigationGroupRequestMarshaller Instance => _instance;
    }
}
