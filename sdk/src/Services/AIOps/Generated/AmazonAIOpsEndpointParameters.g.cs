...
namespace Amazon.AIOps.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving AIOps endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonAIOpsEndpointProvider"/> and <see cref="AmazonAIOpsEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class AIOpsEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// AIOpsEndpointParameters constructor
        /// </summary>
        public AIOpsEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
