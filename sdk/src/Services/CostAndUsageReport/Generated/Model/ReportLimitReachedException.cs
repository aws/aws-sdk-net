...
namespace Amazon.CostAndUsageReport.Model
{
    ...
    public partial class ReportLimitReachedException : AmazonCostAndUsageReportException
    {
        ...
        public ReportLimitReachedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ReportLimitReachedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
