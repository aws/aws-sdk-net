...
{
    /// <summary>
    /// Container for the parameters to the TagResource operation. Assigns one of more tags
    /// (key-value pairs) to the specified MediaPackage resource. <para> Tags can help you
    /// organize and categorize your resources. You can also use them to scope user permissions,
    /// by granting a user permission to access or change only resources with certain tag
    /// values. You can use the TagResource operation with a resource that already has tags.
