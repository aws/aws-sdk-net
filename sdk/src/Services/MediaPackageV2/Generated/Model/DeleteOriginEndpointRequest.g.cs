...
{
    /// <summary>
    /// Container for the parameters to the DeleteOriginEndpoint operation. Origin endpoints
    /// can serve content until they're deleted. Delete the endpoint if it should no longer
    /// respond to playback requests. You must delete all endpoints from a channel before
