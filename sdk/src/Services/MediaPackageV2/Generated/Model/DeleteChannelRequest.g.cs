...
{
    /// <summary>
    /// Container for the parameters to the DeleteChannel operation. Delete a channel to stop
    /// AWS Elemental MediaPackage from receiving further content. You must delete the channel's
