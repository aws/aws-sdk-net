...
{
    /// <summary>
    /// Container for the parameters to the GetOriginEndpointPolicy operation. Retrieves the
    /// specified origin endpoint policy that's configured in AWS Elemental MediaPackage.
    /// </summary>
    public partial class GetOriginEndpointPolicyRequest : AmazonMediaPackageV2Request
    {
        /// <summary>
