...
{
    /// <summary>
    /// GetOriginEndpointPolicy Request Marshaller
    /// </summary>
    public partial class GetOriginEndpointPolicyRequestMarshaller : IMarshaller<IRequest, GetOriginEndpointPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetOriginEndpointPolicyRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetOriginEndpointPolicyRequest publicRequest)
        {
        ...
        private static readonly GetOriginEndpointPolicyRequestMarshaller _instance = new();

        internal static GetOriginEndpointPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOriginEndpointPolicyRequestMarshaller Instance => _instance;
    }
}
