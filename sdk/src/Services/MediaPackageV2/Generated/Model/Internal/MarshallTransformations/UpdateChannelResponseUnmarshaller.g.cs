...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateChannelResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AttachedMultiviewChannels", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AttachedMultiviewChannels = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("InputSwitchConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = InputSwitchConfigurationUnmarshaller.Instance;
                    unmarshalledObject.InputSwitchConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("MultiviewConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = MultiviewConfigurationUnmarshaller.Instance;
                    unmarshalledObject.MultiviewConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("OutputHeaderConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = OutputHeaderConfigurationUnmarshaller.Instance;
                    unmarshalledObject.OutputHeaderConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static UpdateChannelResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateChannelResponseUnmarshaller Instance => _instance;
    }
}
