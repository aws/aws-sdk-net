    ...
    public class CreateOriginEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ContainerType = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ForceEndpointErrorConfiguration", targetDepth))
                {
                    ...
                    response.ForceEndpointErrorConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("HlsManifests", targetDepth))
                {
                    ...
                    response.HlsManifests = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LowLatencyHlsManifests", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<GetLowLatencyHlsManifestConfiguration, GetLowLatencyHlsManifestConfigurationUnmarshaller>(GetLowLatencyHlsManifestConfigurationUnmarshaller.Instance);
                    response.LowLatencyHlsManifests = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GetMssManifestConfiguration, GetMssManifestConfigurationUnmarshaller>(GetMssManifestConfigurationUnmarshaller.Instance);
                    response.MssManifests = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("OriginEndpointName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OriginEndpointName = unmarshaller.Unmarshall(context);
                    continue;
                }
