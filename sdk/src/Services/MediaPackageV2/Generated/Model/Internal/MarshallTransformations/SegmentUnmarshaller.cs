...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SegmentUnmarshaller : IJsonUnmarshaller<Segment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Segment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OutputTimestampMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OutputTimestampMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
