...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetOriginEndpointPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetOriginEndpointPolicyResponse();
            ...
            {
                if (context.TestExpression("CdnAuthConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = CdnAuthConfigurationUnmarshaller.Instance;
                    unmarshalledObject.CdnAuthConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetOriginEndpointPolicyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOriginEndpointPolicyResponseUnmarshaller Instance => _instance;
    }
}
