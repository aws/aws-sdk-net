...
{
    /// <summary>
    /// Response Unmarshaller for GetOriginEndpoint operation.
    /// </summary>
    public partial class GetOriginEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetOriginEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.ResetAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("StreamNameOutputMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StreamNameOutputMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetOriginEndpointResponseUnmarshaller _instance = new GetOriginEndpointResponseUnmarshaller();

        internal static GetOriginEndpointResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOriginEndpointResponseUnmarshaller Instance => _instance;
    }
}
