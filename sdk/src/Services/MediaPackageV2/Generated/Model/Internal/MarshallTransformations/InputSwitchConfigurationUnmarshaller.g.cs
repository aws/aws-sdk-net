...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InputSwitchConfigurationUnmarshaller : IJsonUnmarshaller<InputSwitchConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InputSwitchConfiguration();
            ...
            {
                if (context.TestExpression("MQCSInputSwitching", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PreferredInput", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static InputSwitchConfigurationUnmarshaller Instance => _instance;
    }
}
