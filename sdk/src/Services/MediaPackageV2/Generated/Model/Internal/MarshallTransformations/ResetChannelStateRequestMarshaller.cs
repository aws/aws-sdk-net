...
{
    /// <summary>
    /// ResetChannelState Request Marshaller
    /// </summary>       
    public class ResetChannelStateRequestMarshaller : IMarshaller<IRequest, ResetChannelStateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ResetChannelStateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ResetChannelStateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/channelGroup/{ChannelGroupName}/channel/{ChannelName}/reset";

            return request;
        }
        private static ResetChannelStateRequestMarshaller _instance = new ResetChannelStateRequestMarshaller();        

        internal static ResetChannelStateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetChannelStateRequestMarshaller Instance
        {
            get
            {
                return _instance;
