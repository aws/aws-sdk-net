...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FilterConfigurationUnmarshaller : IJsonUnmarshaller<FilterConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FilterConfiguration();
            ...
            {
                if (context.TestExpression("ClipStartTime", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("DrmSettings", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ManifestFilter", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static FilterConfigurationUnmarshaller Instance => _instance;
    }
}
