...
{
    /// <summary>
    /// Response Unmarshaller for CreateChannelGroup operation.
    /// </summary>
    public partial class CreateChannelGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateChannelGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EgressDomain", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EgressDomain = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateChannelGroupResponseUnmarshaller _instance = new CreateChannelGroupResponseUnmarshaller();

        internal static CreateChannelGroupResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChannelGroupResponseUnmarshaller Instance => _instance;
    }
}
