...
{
    /// <summary>
    /// Container for the parameters to the PutOriginEndpointPolicy operation. Attaches an
    /// IAM policy to the specified origin endpoint. You can attach only one policy with each
    /// request.
    /// </summary>
    public partial class PutOriginEndpointPolicyRequest : AmazonMediaPackageV2Request
    {
        ...
        /// </para>
        /// </summary>
        public CdnAuthConfiguration CdnAuthConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the CdnAuthConfiguration property is set.
        /// </summary>
        internal bool IsSetCdnAuthConfiguration() => this.CdnAuthConfiguration != null;
        ...
        /// </para>
        /// </summary>
        [AWSProperty(Required = true, Max = 6144)]
