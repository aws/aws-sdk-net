...
namespace Amazon.MediaPackageV2.Model
{
    ...
    public partial class CdnAuthConfiguration
    {
        ...
        public List<string> CdnIdentifierSecretArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the CdnIdentifierSecretArns property is set.
        /// </summary>
        internal bool IsSetCdnIdentifierSecretArns() => this.CdnIdentifierSecretArns != null && (this.CdnIdentifierSecretArns.Count > 0 || !AWSConfigs.InitializeCollections);
