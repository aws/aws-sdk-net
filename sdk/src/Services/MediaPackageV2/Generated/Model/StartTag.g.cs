...
namespace Amazon.MediaPackageV2.Model
{
    ...
    public partial class StartTag
    {
        ...
        /// <summary>
        /// Checks to see if the Precise property is set.
        /// </summary>
        internal bool IsSetPrecise() => this.Precise.HasValue;
        ...
        /// <summary>
        /// Checks to see if the TimeOffset property is set.
        /// </summary>
        internal bool IsSetTimeOffset() => this.TimeOffset.HasValue;
    }
}
