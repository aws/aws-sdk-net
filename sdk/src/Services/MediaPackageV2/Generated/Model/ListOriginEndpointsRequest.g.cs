...
{
    /// <summary>
    /// Container for the parameters to the ListOriginEndpoints operation. Retrieves all origin
    /// endpoints in a specific channel that are configured in AWS Elemental MediaPackage.
    /// </summary>
