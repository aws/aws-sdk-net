...
namespace Amazon.MediaPackageV2.Model
{
    ...
    public partial class DashAvailabilityStartTimeConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public DateTime? FixedAvailabilityStartTime { get; set; }

        /// <summary>
        /// Checks to see if the FixedAvailabilityStartTime property is set.
        /// </summary>
        internal bool IsSetFixedAvailabilityStartTime() => this.FixedAvailabilityStartTime.HasValue;
    }
}
