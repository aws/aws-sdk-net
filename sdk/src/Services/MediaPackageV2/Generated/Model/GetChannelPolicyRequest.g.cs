...
{
    /// <summary>
    /// Container for the parameters to the GetChannelPolicy operation. Retrieves the specified
    /// channel policy that's configured in AWS Elemental MediaPackage. With policies, you
    /// can specify who has access to AWS resources and what actions they can perform on those
    /// resources.
    /// </summary>
