...
{
    /// <summary>
    /// Container for the parameters to the GetOriginEndpoint operation. Retrieves the specified
    /// origin endpoint that's configured in AWS Elemental MediaPackage to obtain its playback
    /// URL and to view the packaging settings that it's currently using.
    /// </summary>
    public partial class GetOriginEndpointRequest : AmazonMediaPackageV2Request
    {
        /// <summary>
