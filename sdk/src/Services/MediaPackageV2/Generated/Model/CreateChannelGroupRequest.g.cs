...
{
    /// <summary>
    /// Container for the parameters to the CreateChannelGroup operation. Create a channel
    /// group to group your channels and origin endpoints. A channel group is the top-level
    /// resource that consists of channels and origin endpoints that are associated with it
    /// and that provides predictable URLs for stream delivery. All channels and origin endpoints
    /// within the channel group are guaranteed to share the DNS. You can create only one
