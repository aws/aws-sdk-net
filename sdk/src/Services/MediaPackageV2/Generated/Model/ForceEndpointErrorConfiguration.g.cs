...
namespace Amazon.MediaPackageV2.Model
{
    ...
    public partial class ForceEndpointErrorConfiguration
    {
        ...
        /// </summary>
        public List<string> EndpointErrorConditions { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the EndpointErrorConditions property is set.
        /// </summary>
        internal bool IsSetEndpointErrorConditions() => this.EndpointErrorConditions != null && (this.EndpointErrorConditions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
