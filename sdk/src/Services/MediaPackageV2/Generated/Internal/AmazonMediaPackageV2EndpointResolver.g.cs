...
{
    /// <summary>
    /// Amazon MediaPackageV2 endpoint resolver.
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for MediaPackageV2 service requests.
    /// <para />
    /// Collects values for <see cref="MediaPackageV2EndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonMediaPackageV2EndpointProvider"/>.
    /// <para />
    /// Responsible for setting authentication and HTTP headers provided by resolved endpoint.
    /// </summary>
    public class AmazonMediaPackageV2EndpointResolver : BaseEndpointResolver
    {
