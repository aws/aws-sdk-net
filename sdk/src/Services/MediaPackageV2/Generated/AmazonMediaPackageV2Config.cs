...
namespace Amazon.MediaPackageV2
{
    ...
    public partial class AmazonMediaPackageV2Config : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("MediaPackageV2", "4.0.103.1");
        ...
        /// </summary>
        public static new string ServiceId => "MediaPackageV2";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "mediapackagev2";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-12-25";
