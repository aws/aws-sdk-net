...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMediaPackageV2Config))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMediaPackageV2Config();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMediaPackageV2Config;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMediaPackageV2Config to create AmazonMediaPackageV2Client");
            }

            return awsCredentials == null ?
                    new AmazonMediaPackageV2Client(serviceClientConfig) :
                    new AmazonMediaPackageV2Client(awsCredentials, serviceClientConfig);
        }
