...
namespace Amazon.MainframeModernization
{
    ...
    public partial interface IAmazonMainframeModernization : IAmazonService, IDisposable
    {
        ...
        Task<CreateDataSetExportTaskResponse> CreateDataSetExportTaskAsync(CreateDataSetExportTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetDataSetExportTaskResponse> GetDataSetExportTaskAsync(GetDataSetExportTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetSignedBluinsightsUrlResponse> GetSignedBluinsightsUrlAsync(GetSignedBluinsightsUrlRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListBatchJobRestartPointsResponse> ListBatchJobRestartPointsAsync(ListBatchJobRestartPointsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListDataSetExportHistoryResponse> ListDataSetExportHistoryAsync(ListDataSetExportHistoryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMainframeModernizationConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMainframeModernizationConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMainframeModernizationConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMainframeModernizationConfig to create AmazonMainframeModernizationClient");
            }

            return awsCredentials == null ? 
                    new AmazonMainframeModernizationClient(serviceClientConfig) :
                    new AmazonMainframeModernizationClient(awsCredentials, serviceClientConfig);
        }
