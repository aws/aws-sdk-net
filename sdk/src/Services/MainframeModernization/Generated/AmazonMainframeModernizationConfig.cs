...
namespace Amazon.MainframeModernization
{
    ...
    public partial class AmazonMainframeModernizationConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("m2", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "m2";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "m2";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-04-28";
