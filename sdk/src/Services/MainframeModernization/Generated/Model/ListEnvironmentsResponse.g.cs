...
namespace Amazon.MainframeModernization.Model
{
    ...
    public partial class ListEnvironmentsResponse : AmazonWebServiceResponse
    {
        ...
        public List<EnvironmentSummary> Environments { get; set; } = AWSConfigs.InitializeCollections ? new List<EnvironmentSummary>() : null;

        /// <summary>
        /// Checks to see if the Environments property is set.
        /// </summary>
        internal bool IsSetEnvironments() => this.Environments != null && (this.Environments.Count > 0 || !AWSConfigs.InitializeCollections);
