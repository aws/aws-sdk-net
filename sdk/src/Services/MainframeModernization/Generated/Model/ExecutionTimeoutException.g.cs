...
namespace Amazon.MainframeModernization.Model
{
    ...
    public partial class ExecutionTimeoutException : AmazonMainframeModernizationException
    {
        ...
        /// Construct instance of ExecutionTimeoutException
        /// </summary>
        public ExecutionTimeoutException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ExecutionTimeoutException
        /// </summary>
        public ExecutionTimeoutException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ExecutionTimeoutException
        /// </summary>
        public ExecutionTimeoutException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
