...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetApplicationVersionRequestMarshaller : IMarshaller<IRequest, GetApplicationVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetApplicationVersionRequest publicRequest)
        {
            ...
            request.AddPathResource("{applicationVersion}", StringUtils.FromInt(publicRequest.ApplicationVersion.Value));
        ...
        private static readonly GetApplicationVersionRequestMarshaller _instance = new();

        internal static GetApplicationVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetApplicationVersionRequestMarshaller Instance => _instance;
    }
}
