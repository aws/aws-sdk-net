...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartBatchJobRequestMarshaller : IMarshaller<IRequest, StartBatchJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(StartBatchJobRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetJobParams())
            {
                ...
                foreach (var publicRequestJobParamsKvp in publicRequest.JobParams)
                {
                    ...
                    context.Writer.WriteStringValue(publicRequestJobParamsValue);
                }
                context.Writer.WriteEndObject();
            }
        ...
        private static readonly StartBatchJobRequestMarshaller _instance = new();

        internal static StartBatchJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartBatchJobRequestMarshaller Instance => _instance;
    }
}
