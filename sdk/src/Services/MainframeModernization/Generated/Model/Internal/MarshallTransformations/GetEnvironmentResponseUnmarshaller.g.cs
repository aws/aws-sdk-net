...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetEnvironmentResponse();
            ...
            {
                if (context.TestExpression("actualCapacity", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.ActualCapacity = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("highAvailabilityConfig", targetDepth, ref reader))
                {
                    var unmarshaller = HighAvailabilityConfigUnmarshaller.Instance;
                    unmarshalledObject.HighAvailabilityConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("loadBalancerArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LoadBalancerArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("pendingMaintenance", targetDepth, ref reader))
                {
                    var unmarshaller = PendingMaintenanceUnmarshaller.Instance;
                    unmarshalledObject.PendingMaintenance = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<StorageConfiguration, StorageConfigurationUnmarshaller>(StorageConfigurationUnmarshaller.Instance);
        ...
        internal static GetEnvironmentResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEnvironmentResponseUnmarshaller Instance => _instance;
    }
}
