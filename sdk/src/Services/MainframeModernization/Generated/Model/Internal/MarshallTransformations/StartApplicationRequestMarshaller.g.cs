...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartApplicationRequestMarshaller : IMarshaller<IRequest, StartApplicationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartApplicationRequestMarshaller _instance = new();

        internal static StartApplicationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartApplicationRequestMarshaller Instance => _instance;
    }
}
