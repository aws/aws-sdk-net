...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DataSetExportTaskUnmarshaller : IJsonUnmarshaller<DataSetExportTask, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public DataSetExportTask Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new DataSetExportTask();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DataSetExportTaskUnmarshaller Instance => _instance;
    }
}
