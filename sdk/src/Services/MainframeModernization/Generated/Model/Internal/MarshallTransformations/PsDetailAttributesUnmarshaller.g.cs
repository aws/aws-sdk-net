...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PsDetailAttributesUnmarshaller : IJsonUnmarshaller<PsDetailAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PsDetailAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PsDetailAttributes();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PsDetailAttributesUnmarshaller Instance => _instance;
    }
}
