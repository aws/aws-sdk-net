...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DataSetImportSummaryUnmarshaller : IJsonUnmarshaller<DataSetImportSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public DataSetImportSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new DataSetImportSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DataSetImportSummaryUnmarshaller Instance => _instance;
    }
}
