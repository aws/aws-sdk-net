...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListBatchJobRestartPointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListBatchJobRestartPointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("batchJobSteps", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BatchJobSteps = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListBatchJobRestartPointsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListBatchJobRestartPointsResponseUnmarshaller Instance => _instance;
    }
}
