...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchJobDefinitionUnmarshaller : IUnmarshaller<BatchJobDefinition, XmlUnmarshallerContext>, IUnmarshaller<BatchJobDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BatchJobDefinition IUnmarshaller<BatchJobDefinition, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public BatchJobDefinition Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("fileBatchJobDefinition", targetDepth))
                {
                    ...
                    unmarshalledObject.FileBatchJobDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scriptBatchJobDefinition", targetDepth))
                {
                    ...
                    unmarshalledObject.ScriptBatchJobDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
