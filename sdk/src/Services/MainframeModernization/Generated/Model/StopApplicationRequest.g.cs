...
{
    /// <summary>
    /// Container for the parameters to the StopApplication operation. Stops a running application.
    /// </summary>
    public partial class StopApplicationRequest : AmazonMainframeModernizationRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ForceStop property is set.
        /// </summary>
        internal bool IsSetForceStop() => this.ForceStop.HasValue;
    }
}
