...
{
    /// <summary>
    /// Container for the parameters to the CreateDataSetImportTask operation. Starts a data
    /// set import task for a specific application.
    /// </summary>
    public partial class CreateDataSetImportTaskRequest : AmazonMainframeModernizationRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ImportConfig property is set.
        /// </summary>
        internal bool IsSetImportConfig() => this.ImportConfig != null;
    }
}
