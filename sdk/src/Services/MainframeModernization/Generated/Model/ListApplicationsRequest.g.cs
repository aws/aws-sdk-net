...
{
    /// <summary>
    /// Container for the parameters to the ListApplications operation. Lists the applications
    /// associated with a specific Amazon Web Services account. You can provide the unique
    /// identifier of a specific runtime environment in a query parameter to see all applications
