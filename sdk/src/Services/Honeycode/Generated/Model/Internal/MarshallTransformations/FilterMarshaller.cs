...
namespace Amazon.Honeycode.Model.Internal.MarshallTransformations
{
    ...
    public class FilterMarshaller : IRequestMarshaller<Filter, JsonMarshallerContext> 
    {
        ...
        {
            if(requestObject.IsSetContextRowId())
            {
                context.Writer.WritePropertyName("contextRowId");
                context.Writer.Write(requestObject.ContextRowId);
            }

            if(requestObject.IsSetFormula())
            {
                context.Writer.WritePropertyName("formula");
                context.Writer.Write(requestObject.Formula);
            }
