...
namespace Amazon.Honeycode.Model.Internal.MarshallTransformations
{
    ...
    public class CreateRowDataMarshaller : IRequestMarshaller<CreateRowData, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(CreateRowData requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCellsToCreate())
            {
                context.Writer.WritePropertyName("cellsToCreate");
                context.Writer.WriteObjectStart();
                foreach (var requestObjectCellsToCreateKvp in requestObject.CellsToCreate)
                {
                    context.Writer.WritePropertyName(requestObjectCellsToCreateKvp.Key);
                    var requestObjectCellsToCreateValue = requestObjectCellsToCreateKvp.Value;

                    context.Writer.WriteObjectStart();

                    var marshaller = CellInputMarshaller.Instance;
                    marshaller.Marshall(requestObjectCellsToCreateValue, context);
