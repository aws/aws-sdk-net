...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonHoneycodeConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonHoneycodeConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonHoneycodeConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonHoneycodeConfig to create AmazonHoneycodeClient");
            }

            return awsCredentials == null ? 
                    new AmazonHoneycodeClient(serviceClientConfig) :
                    new AmazonHoneycodeClient(awsCredentials, serviceClientConfig);
        }
