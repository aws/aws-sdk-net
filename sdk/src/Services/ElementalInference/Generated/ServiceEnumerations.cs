...
namespace Amazon.ElementalInference
{
    ...
    /// <summary>
    /// Constants used for properties of type SummaryGenerationMode.
    /// </summary>
    public class SummaryGenerationMode : ConstantClass
    {

        /// <summary>
        /// Constant DISABLED for SummaryGenerationMode
        /// </summary>
        public static readonly SummaryGenerationMode DISABLED = new SummaryGenerationMode("DISABLED");
        /// <summary>
        /// Constant ENABLED for SummaryGenerationMode
        /// </summary>
        public static readonly SummaryGenerationMode ENABLED = new SummaryGenerationMode("ENABLED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public SummaryGenerationMode(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static SummaryGenerationMode FindValue(string value)
        {
            return FindValue<SummaryGenerationMode>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator SummaryGenerationMode(string value)
        {
            return FindValue(value);
        }
    }
