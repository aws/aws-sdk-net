...
namespace Amazon.ElementalInference
{
    ...
    public partial interface IAmazonElementalInference : IAmazonService, IDisposable
    {
        ...
        Task<AssociateFeedResponse> AssociateFeedAsync(AssociateFeedRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateFeedResponse> CreateFeedAsync(CreateFeedRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteFeedResponse> DeleteFeedAsync(DeleteFeedRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteFeedPolicyResponse> DeleteFeedPolicyAsync(DeleteFeedPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisassociateFeedResponse> DisassociateFeedAsync(DisassociateFeedRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetFeedPolicyResponse> GetFeedPolicyAsync(GetFeedPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListFeedsResponse> ListFeedsAsync(ListFeedsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutFeedPolicyResponse> PutFeedPolicyAsync(PutFeedPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </summary>
        /// <param name="request">Container for the necessary parameters to execute the SearchFixtures service method.</param>
        /// <param name="cancellationToken">
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
        /// 
        /// <returns>The response from the SearchFixtures service method, as returned by ElementalInference.</returns>
        /// <exception cref="Amazon.ElementalInference.Model.AccessDeniedException">
        /// You do not have sufficient access to perform this action.
        /// </exception>
        /// <exception cref="Amazon.ElementalInference.Model.GatewayTimedOutException">
        ...
        /// before retrying.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/elementalinference-2018-11-14/SearchFixtures">REST API Reference for SearchFixtures Operation</seealso>
        Task<SearchFixturesResponse> SearchFixturesAsync(SearchFixturesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateFeedResponse> UpdateFeedAsync(UpdateFeedRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElementalInferenceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElementalInferenceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElementalInferenceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElementalInferenceConfig to create AmazonElementalInferenceClient");
            }

            return awsCredentials == null ? 
                    new AmazonElementalInferenceClient(serviceClientConfig) :
                    new AmazonElementalInferenceClient(awsCredentials, serviceClientConfig);
        }
