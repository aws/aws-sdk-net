...
namespace Amazon.ElementalInference.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ElementalInference service requests.
    /// Collects values for ElementalInferenceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ElementalInferenceEndpointProvider.
