...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFeed operation
    /// </summary>  
    public class DeleteFeedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFeedResponse response = new DeleteFeedResponse();
        ...
        private static DeleteFeedResponseUnmarshaller _instance = new DeleteFeedResponseUnmarshaller();        

        internal static DeleteFeedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFeedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
