...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDictionaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDictionaryResponse response = new UpdateDictionaryResponse();
        ...
        internal static UpdateDictionaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDictionaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
