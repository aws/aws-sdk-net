...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExportDictionaryEntriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportDictionaryEntriesResponse response = new ExportDictionaryEntriesResponse();
        ...
        internal static ExportDictionaryEntriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportDictionaryEntriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
