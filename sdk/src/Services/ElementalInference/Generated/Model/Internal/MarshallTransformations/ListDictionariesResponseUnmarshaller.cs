...
{
    /// <summary>
    /// Response Unmarshaller for ListDictionaries operation
    /// </summary>  
    public class ListDictionariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDictionariesResponse response = new ListDictionariesResponse();
            ...
            {
                if (context.TestExpression("dictionaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DictionarySummary, DictionarySummaryUnmarshaller>(DictionarySummaryUnmarshaller.Instance);
                    response.Dictionaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDictionariesResponseUnmarshaller _instance = new ListDictionariesResponseUnmarshaller();        

        internal static ListDictionariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDictionariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
