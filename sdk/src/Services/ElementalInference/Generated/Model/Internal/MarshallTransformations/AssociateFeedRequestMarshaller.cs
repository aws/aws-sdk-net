...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateFeedRequestMarshaller : IMarshaller<IRequest, AssociateFeedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AssociateFeedRequestMarshaller _instance = new AssociateFeedRequestMarshaller();        

        internal static AssociateFeedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateFeedRequestMarshaller Instance
        {
            get
            {
                return _instance;
