...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateFeedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateFeedResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataEndpoints", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DataEndpoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateFeedResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateFeedResponseUnmarshaller Instance => _instance;
    }
}
