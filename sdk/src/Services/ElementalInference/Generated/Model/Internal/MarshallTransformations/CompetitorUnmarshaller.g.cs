...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CompetitorUnmarshaller : IJsonUnmarshaller<Competitor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Competitor();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CompetitorUnmarshaller Instance => _instance;
    }
}
