...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFeed operation
    /// </summary>  
    public class UpdateFeedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFeedResponse response = new UpdateFeedResponse();
        ...
        private static UpdateFeedResponseUnmarshaller _instance = new UpdateFeedResponseUnmarshaller();        

        internal static UpdateFeedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFeedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
