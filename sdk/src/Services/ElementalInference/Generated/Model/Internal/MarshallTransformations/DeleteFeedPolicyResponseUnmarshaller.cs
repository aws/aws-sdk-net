...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteFeedPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFeedPolicyResponse response = new DeleteFeedPolicyResponse();
        ...
        internal static DeleteFeedPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFeedPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
