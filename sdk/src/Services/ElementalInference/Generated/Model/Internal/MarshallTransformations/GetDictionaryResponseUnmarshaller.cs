...
{
    /// <summary>
    /// Response Unmarshaller for GetDictionary operation
    /// </summary>  
    public class GetDictionaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDictionaryResponseUnmarshaller _instance = new GetDictionaryResponseUnmarshaller();        

        internal static GetDictionaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDictionaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
