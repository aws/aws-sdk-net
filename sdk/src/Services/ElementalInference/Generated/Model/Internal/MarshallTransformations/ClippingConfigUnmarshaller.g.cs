...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ClippingConfigUnmarshaller : IJsonUnmarshaller<ClippingConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ClippingConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ClippingConfigUnmarshaller Instance => _instance;
    }
}
