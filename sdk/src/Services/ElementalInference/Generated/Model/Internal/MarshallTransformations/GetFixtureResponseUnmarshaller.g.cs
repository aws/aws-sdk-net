...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetFixtureResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetFixtureResponse();
        ...
        internal static GetFixtureResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetFixtureResponseUnmarshaller Instance => _instance;
    }
}
