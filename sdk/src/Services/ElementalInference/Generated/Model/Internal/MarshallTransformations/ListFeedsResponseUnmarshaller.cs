...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListFeedsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFeedsResponse response = new ListFeedsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FeedSummary, FeedSummaryUnmarshaller>(FeedSummaryUnmarshaller.Instance);
                    response.Feeds = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static ListFeedsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFeedsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
