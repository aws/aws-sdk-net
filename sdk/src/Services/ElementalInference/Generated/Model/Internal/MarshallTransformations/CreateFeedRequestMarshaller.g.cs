...
{
    /// <summary>
    /// CreateFeed Request Marshaller
    /// </summary>
    public partial class CreateFeedRequestMarshaller : IMarshaller<IRequest, CreateFeedRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateFeedRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateFeedRequest publicRequest)
        {
        ...
        private static readonly CreateFeedRequestMarshaller _instance = new();

        internal static CreateFeedRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateFeedRequestMarshaller Instance => _instance;
    }
}
