...
{
    /// <summary>
    /// Response Unmarshaller for SubtitlingConfig Object
    /// </summary>
    public partial class SubtitlingConfigUnmarshaller : IJsonUnmarshaller<SubtitlingConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SubtitlingConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SubtitlingConfig();
        ...
        private static SubtitlingConfigUnmarshaller _instance = new SubtitlingConfigUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SubtitlingConfigUnmarshaller Instance => _instance;
    }
}
