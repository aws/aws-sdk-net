...
{
    /// <summary>
    /// Response Unmarshaller for GetFeed operation
    /// </summary>  
    public class GetFeedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetFeedResponseUnmarshaller _instance = new GetFeedResponseUnmarshaller();        

        internal static GetFeedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFeedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
