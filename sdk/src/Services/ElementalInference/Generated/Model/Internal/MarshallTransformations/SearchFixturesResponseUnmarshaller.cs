...
{
    /// <summary>
    /// Response Unmarshaller for SearchFixtures operation
    /// </summary>  
    public class SearchFixturesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchFixturesResponse response = new SearchFixturesResponse();
            ...
            {
                if (context.TestExpression("fixtures", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FixtureSummary, FixtureSummaryUnmarshaller>(FixtureSummaryUnmarshaller.Instance);
                    response.Fixtures = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchFixturesResponseUnmarshaller _instance = new SearchFixturesResponseUnmarshaller();        

        internal static SearchFixturesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchFixturesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
