...
{
    /// <summary>
    /// UpdateFeed Request Marshaller
    /// </summary>
    public partial class UpdateFeedRequestMarshaller : IMarshaller<IRequest, UpdateFeedRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFeedRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateFeedRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/feed/{id}";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetOutputs())
            {
                ...
                foreach (var publicRequestOutputsListValue in publicRequest.Outputs)
                {
                    ...
                    var marshaller = UpdateOutputMarshaller.Instance;
        ...
        private static readonly UpdateFeedRequestMarshaller _instance = new();

        internal static UpdateFeedRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateFeedRequestMarshaller Instance => _instance;
    }
}
