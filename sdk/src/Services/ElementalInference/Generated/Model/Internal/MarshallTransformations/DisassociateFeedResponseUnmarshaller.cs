...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateFeed operation
    /// </summary>  
    public class DisassociateFeedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateFeedResponse response = new DisassociateFeedResponse();
        ...
        private static DisassociateFeedResponseUnmarshaller _instance = new DisassociateFeedResponseUnmarshaller();        

        internal static DisassociateFeedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateFeedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
