...
{
    /// <summary>
    /// Response Unmarshaller for CreateDictionary operation
    /// </summary>  
    public class CreateDictionaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDictionaryResponse response = new CreateDictionaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Language = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateDictionaryResponseUnmarshaller _instance = new CreateDictionaryResponseUnmarshaller();        

        internal static CreateDictionaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDictionaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
