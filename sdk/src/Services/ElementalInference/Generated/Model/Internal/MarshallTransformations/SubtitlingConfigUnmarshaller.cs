...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubtitlingConfigUnmarshaller : IJsonUnmarshaller<SubtitlingConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            SubtitlingConfig unmarshalledObject = new SubtitlingConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubtitlingConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
