...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateFeedRequestMarshaller : IMarshaller<IRequest, CreateFeedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateFeedRequestMarshaller _instance = new CreateFeedRequestMarshaller();        

        internal static CreateFeedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFeedRequestMarshaller Instance
        {
            get
            {
                return _instance;
