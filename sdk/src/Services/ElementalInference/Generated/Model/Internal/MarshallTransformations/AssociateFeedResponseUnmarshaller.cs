...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateFeedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateFeedResponse response = new AssociateFeedResponse();
        ...
        internal static AssociateFeedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateFeedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
