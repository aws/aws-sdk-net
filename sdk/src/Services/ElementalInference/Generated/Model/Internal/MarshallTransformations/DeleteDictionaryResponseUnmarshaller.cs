...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDictionaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDictionaryResponse response = new DeleteDictionaryResponse();
        ...
        internal static DeleteDictionaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDictionaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
