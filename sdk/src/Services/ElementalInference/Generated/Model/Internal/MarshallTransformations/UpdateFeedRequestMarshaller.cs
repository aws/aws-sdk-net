...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateFeedRequestMarshaller : IMarshaller<IRequest, UpdateFeedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateFeedRequestMarshaller _instance = new UpdateFeedRequestMarshaller();        

        internal static UpdateFeedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFeedRequestMarshaller Instance
        {
            get
            {
                return _instance;
