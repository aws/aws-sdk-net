...
{
    /// <summary>
    /// UpdateDictionary Request Marshaller
    /// </summary>       
    public class UpdateDictionaryRequestMarshaller : IMarshaller<IRequest, UpdateDictionaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateDictionaryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateDictionaryRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetEntries())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.Entries);
            }
        ...
        private static UpdateDictionaryRequestMarshaller _instance = new UpdateDictionaryRequestMarshaller();        

        internal static UpdateDictionaryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDictionaryRequestMarshaller Instance
        {
            get
            {
                return _instance;
