...
{
    /// <summary>
    /// Response Unmarshaller for ListFeeds operation.
    /// </summary>
    public partial class ListFeedsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListFeedsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FeedSummary, FeedSummaryUnmarshaller>(FeedSummaryUnmarshaller.Instance);
        ...
        private static ListFeedsResponseUnmarshaller _instance = new ListFeedsResponseUnmarshaller();

        internal static ListFeedsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListFeedsResponseUnmarshaller Instance => _instance;
    }
}
