...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteDictionaryRequestMarshaller : IMarshaller<IRequest, DeleteDictionaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteDictionaryRequestMarshaller _instance = new DeleteDictionaryRequestMarshaller();        

        internal static DeleteDictionaryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDictionaryRequestMarshaller Instance
        {
            get
            {
                return _instance;
