...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchFixturesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchFixturesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("fixtures", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Fixtures = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static SearchFixturesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchFixturesResponseUnmarshaller Instance => _instance;
    }
}
