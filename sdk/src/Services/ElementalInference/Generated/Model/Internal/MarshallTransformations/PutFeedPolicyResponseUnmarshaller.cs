...
{
    /// <summary>
    /// Response Unmarshaller for PutFeedPolicy operation
    /// </summary>  
    public class PutFeedPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutFeedPolicyResponse response = new PutFeedPolicyResponse();
        ...
        private static PutFeedPolicyResponseUnmarshaller _instance = new PutFeedPolicyResponseUnmarshaller();        

        internal static PutFeedPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutFeedPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
