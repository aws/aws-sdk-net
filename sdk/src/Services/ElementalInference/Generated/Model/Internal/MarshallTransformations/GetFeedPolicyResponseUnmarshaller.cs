...
{
    /// <summary>
    /// Response Unmarshaller for GetFeedPolicy operation
    /// </summary>  
    public class GetFeedPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFeedPolicyResponse response = new GetFeedPolicyResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return TooManyRequestExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetFeedPolicyResponseUnmarshaller _instance = new GetFeedPolicyResponseUnmarshaller();        

        internal static GetFeedPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFeedPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
