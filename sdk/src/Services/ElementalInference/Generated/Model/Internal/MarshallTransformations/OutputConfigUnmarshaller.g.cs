...
namespace Amazon.ElementalInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OutputConfigUnmarshaller : IJsonUnmarshaller<OutputConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public OutputConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new OutputConfig();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("contextualMetadata", targetDepth, ref reader))
                {
                    var unmarshaller = ContextualMetadataConfigUnmarshaller.Instance;
                    unmarshalledObject.ContextualMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static OutputConfigUnmarshaller _instance = new OutputConfigUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static OutputConfigUnmarshaller Instance => _instance;
    }
}
