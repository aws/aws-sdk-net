...
namespace Amazon.ElementalInference.Model
{
    ...
    public partial class CroppingConfig
    {
        ...
        public List<TemplateGroup> TemplateGroups { get; set; } = AWSConfigs.InitializeCollections ? new List<TemplateGroup>() : null;

        /// <summary>
        /// Checks to see if the TemplateGroups property is set.
        /// </summary>
        internal bool IsSetTemplateGroups() => this.TemplateGroups != null && (this.TemplateGroups.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
