...
{
    /// <summary>
    /// Container for the parameters to the GetFixture operation. Retrieves information about
    /// the specified fixture (a sports event, such as a specific basketball game). You obtain
    /// a fixtureId from SearchFixtures, or from the clipping output of a feed.
    /// </summary>
