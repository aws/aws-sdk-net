...
namespace Amazon.CloudWatch
{
    ...
    public partial class AmazonCloudWatchException : AmazonServiceException
    {
        ...
        /// </summary>
        public AmazonCloudWatchException()
            : base()
        {
        }
        ...
        public AmazonCloudWatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCloudWatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
