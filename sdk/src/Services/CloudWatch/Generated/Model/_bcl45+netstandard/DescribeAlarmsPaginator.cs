...
namespace Amazon.CloudWatch.Model
{
    ...
    internal sealed partial class DescribeAlarmsPaginator : IPaginator<DescribeAlarmsResponse>, IDescribeAlarmsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<DescribeAlarmsResponse> Responses => new PaginatedResponse<DescribeAlarmsResponse>(this);
        ...
        async IAsyncEnumerable<DescribeAlarmsResponse> IPaginator<DescribeAlarmsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
