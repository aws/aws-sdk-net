...
namespace Amazon.CloudWatch.Model
{
    ...
    public partial class DashboardInvalidInputErrorException : AmazonCloudWatchException
    {
        ...
        public DashboardInvalidInputErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DashboardInvalidInputErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
