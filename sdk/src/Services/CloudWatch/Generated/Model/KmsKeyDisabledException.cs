...
namespace Amazon.CloudWatch.Model
{
    ...
    [Serializable]
    #endif
    public partial class KmsKeyDisabledException : AmazonCloudWatchException
    {
        ...
        public KmsKeyDisabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KmsKeyDisabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
