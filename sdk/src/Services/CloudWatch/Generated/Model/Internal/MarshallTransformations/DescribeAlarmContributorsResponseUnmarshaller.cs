...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAlarmContributorsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAlarmContributors");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AlarmContributors":
                        {
                            context.AddPathSegment("AlarmContributors");
                            var unmarshaller = new CborListUnmarshaller<AlarmContributor, AlarmContributorUnmarshaller>(AlarmContributorUnmarshaller.Instance);
                            response.AlarmContributors = unmarshaller.Unmarshall(context);
