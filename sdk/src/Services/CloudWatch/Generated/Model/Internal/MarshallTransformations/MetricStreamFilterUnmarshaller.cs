...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricStreamFilterUnmarshaller : ICborUnmarshaller<MetricStreamFilter, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricStreamFilter Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "MetricNames":
                        {
                            context.AddPathSegment("MetricNames");
