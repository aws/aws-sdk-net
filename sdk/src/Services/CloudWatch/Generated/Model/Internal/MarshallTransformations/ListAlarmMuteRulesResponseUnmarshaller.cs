...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAlarmMuteRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("AlarmMuteRuleSummaries", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AlarmMuteRuleSummary, AlarmMuteRuleSummaryUnmarshaller>(AlarmMuteRuleSummaryUnmarshaller.Instance);
