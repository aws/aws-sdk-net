...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    public class MetricDatumMarshaller : IRequestMarshaller<MetricDatum, JsonMarshallerContext> 
    {
        ...
        public void Marshall(MetricDatum requestObject, JsonMarshallerContext context)
        {
            ...
            {
                context.Writer.WritePropertyName("Counts");
                context.Writer.WriteArrayStart();
                foreach(var requestObjectCountsListValue in requestObject.Counts)
                {
                        context.Writer.Write(requestObjectCountsListValue);
                }
            ...
            {
                context.Writer.WritePropertyName("StorageResolution");
                context.Writer.Write(requestObject.StorageResolution);
            }

            if(requestObject.IsSetTimestampUtc())
            {
                context.Writer.WritePropertyName("Timestamp");
                context.Writer.Write(requestObject.TimestampUtc);
            }
