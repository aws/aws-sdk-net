...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDashboardsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListDashboards");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "DashboardEntries":
                        {
                            context.AddPathSegment("DashboardEntries");
                            var unmarshaller = new CborListUnmarshaller<DashboardEntry, DashboardEntryUnmarshaller>(DashboardEntryUnmarshaller.Instance);
                            response.DashboardEntries = unmarshaller.Unmarshall(context);
