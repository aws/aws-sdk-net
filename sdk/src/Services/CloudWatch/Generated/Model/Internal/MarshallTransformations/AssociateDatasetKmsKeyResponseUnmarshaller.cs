...
{
    /// <summary>
    /// Response Unmarshaller for AssociateDatasetKmsKey operation
    /// </summary>  
    public class AssociateDatasetKmsKeyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateDatasetKmsKeyResponse response = new AssociateDatasetKmsKeyResponse();
            var reader = context.Reader;
            context.AddPathSegment("AssociateDatasetKmsKey");
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new CborUnmarshallerContext(streamCopy, true, context.ResponseData))
            {
                ...
                if (errorTypeName != null && errorTypeName.Equals("KmsAccessDeniedException"))
                {
                    return KmsAccessDeniedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorTypeName != null && errorTypeName.Equals("KmsKeyDisabledException"))
                {
                    return KmsKeyDisabledExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorTypeName != null && errorTypeName.Equals("KmsKeyNotFoundException"))
                {
        ...
        private static AssociateDatasetKmsKeyResponseUnmarshaller _instance = new AssociateDatasetKmsKeyResponseUnmarshaller();        

        internal static AssociateDatasetKmsKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDatasetKmsKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
