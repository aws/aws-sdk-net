...
{
    /// <summary>
    /// Response Unmarshaller for PutAlarmMuteRule operation
    /// </summary>  
    public class PutAlarmMuteRuleResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAlarmMuteRuleResponse response = new PutAlarmMuteRuleResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutAlarmMuteRule");
        ...
        private static PutAlarmMuteRuleResponseUnmarshaller _instance = new PutAlarmMuteRuleResponseUnmarshaller();        

        internal static PutAlarmMuteRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAlarmMuteRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
