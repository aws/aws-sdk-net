...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnableAlarmActionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnableAlarmActionsResult", 2))
                    {
        ...
        private static EnableAlarmActionsResponseUnmarshaller _instance = new EnableAlarmActionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableAlarmActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
