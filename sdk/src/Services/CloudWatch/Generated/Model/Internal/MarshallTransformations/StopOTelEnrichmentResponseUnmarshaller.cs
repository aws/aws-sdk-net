...
{
    /// <summary>
    /// Response Unmarshaller for StopOTelEnrichment operation
    /// </summary>  
    public class StopOTelEnrichmentResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopOTelEnrichmentResponse response = new StopOTelEnrichmentResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopOTelEnrichment");
        ...
        private static StopOTelEnrichmentResponseUnmarshaller _instance = new StopOTelEnrichmentResponseUnmarshaller();        

        internal static StopOTelEnrichmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopOTelEnrichmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
