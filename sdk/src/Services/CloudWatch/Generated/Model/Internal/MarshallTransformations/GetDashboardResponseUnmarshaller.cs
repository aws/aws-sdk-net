...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDashboardResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DashboardNotFoundErrorException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static GetDashboardResponseUnmarshaller _instance = new GetDashboardResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDashboardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
