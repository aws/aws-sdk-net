...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopMetricStreamsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopMetricStreamsResponse response = new StopMetricStreamsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("StopMetricStreamsResult", 2))
                    {
        ...
        private static StopMetricStreamsResponseUnmarshaller _instance = new StopMetricStreamsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopMetricStreamsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
