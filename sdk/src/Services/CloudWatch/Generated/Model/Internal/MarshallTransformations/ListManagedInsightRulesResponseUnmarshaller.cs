...
{
    /// <summary>
    /// Response Unmarshaller for ListManagedInsightRules operation
    /// </summary>  
    public class ListManagedInsightRulesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListManagedInsightRulesResponse response = new ListManagedInsightRulesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListManagedInsightRules");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ManagedRules":
                        {
                            context.AddPathSegment("ManagedRules");
                            var unmarshaller = new CborListUnmarshaller<ManagedRuleDescription, ManagedRuleDescriptionUnmarshaller>(ManagedRuleDescriptionUnmarshaller.Instance);
        ...
        private static ListManagedInsightRulesResponseUnmarshaller _instance = new ListManagedInsightRulesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListManagedInsightRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
