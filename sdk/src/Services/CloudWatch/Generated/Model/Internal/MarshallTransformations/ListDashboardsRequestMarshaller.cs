...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    public class ListDashboardsRequestMarshaller : IMarshaller<IRequest, ListDashboardsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListDashboardsRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/GraniteServiceVersion20100801/operation/ListDashboards";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("DashboardNamePrefix");
                    context.Writer.WriteTextString(publicRequest.DashboardNamePrefix);
                }
