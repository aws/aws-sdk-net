...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutMetricDataResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutMetricDataResult", 2))
                    {
        ...
        private static PutMetricDataResponseUnmarshaller _instance = new PutMetricDataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
