...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateDatasetKmsKey operation
    /// </summary>  
    public class DisassociateDatasetKmsKeyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateDatasetKmsKeyResponse response = new DisassociateDatasetKmsKeyResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateDatasetKmsKey");
        ...
        private static DisassociateDatasetKmsKeyResponseUnmarshaller _instance = new DisassociateDatasetKmsKeyResponseUnmarshaller();        

        internal static DisassociateDatasetKmsKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateDatasetKmsKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
