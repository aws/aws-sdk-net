...
{
    /// <summary>
    /// Response Unmarshaller for PutManagedInsightRules operation
    /// </summary>  
    public class PutManagedInsightRulesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutManagedInsightRulesResponse response = new PutManagedInsightRulesResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutManagedInsightRules");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Failures":
                        {
                            context.AddPathSegment("Failures");
                            var unmarshaller = new CborListUnmarshaller<PartialFailure, PartialFailureUnmarshaller>(PartialFailureUnmarshaller.Instance);
        ...
        private static PutManagedInsightRulesResponseUnmarshaller _instance = new PutManagedInsightRulesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutManagedInsightRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
