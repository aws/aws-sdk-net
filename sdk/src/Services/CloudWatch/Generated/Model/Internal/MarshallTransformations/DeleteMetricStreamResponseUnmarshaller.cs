...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteMetricStreamResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMetricStreamResponse response = new DeleteMetricStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteMetricStreamResult", 2))
                    {
        ...
        private static DeleteMetricStreamResponseUnmarshaller _instance = new DeleteMetricStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMetricStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
