...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMetricDataResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetMetricData");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "MetricDataResults":
                        {
                            context.AddPathSegment("MetricDataResults");
                            var unmarshaller = new CborListUnmarshaller<MetricDataResult, MetricDataResultUnmarshaller>(MetricDataResultUnmarshaller.Instance);
                            response.MetricDataResults = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "NextToken":
