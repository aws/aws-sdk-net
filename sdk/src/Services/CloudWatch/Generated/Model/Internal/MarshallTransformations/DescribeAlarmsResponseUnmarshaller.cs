...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAlarmsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAlarms");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "CompositeAlarms":
                        {
                            context.AddPathSegment("CompositeAlarms");
                            var unmarshaller = new CborListUnmarshaller<CompositeAlarm, CompositeAlarmUnmarshaller>(CompositeAlarmUnmarshaller.Instance);
                            response.CompositeAlarms = unmarshaller.Unmarshall(context);
                    ...
                    case "MetricAlarms":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<MetricAlarm, MetricAlarmUnmarshaller>(MetricAlarmUnmarshaller.Instance);
                            response.MetricAlarms = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "NextToken":
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new CborUnmarshallerContext(streamCopy, true, context.ResponseData))
            {
                ...
                if (errorTypeName != null && errorTypeName.Equals("InvalidNextToken"))
                {
