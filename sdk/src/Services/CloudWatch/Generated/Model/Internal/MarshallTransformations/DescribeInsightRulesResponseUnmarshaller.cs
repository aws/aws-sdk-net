...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeInsightRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InsightRule, InsightRuleUnmarshaller>(InsightRuleUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInsightRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
