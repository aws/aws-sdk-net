...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListMetricStreamsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMetricStreamsResponse response = new ListMetricStreamsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListMetricStreams");
            reader.ReadStartMap();
                    ...
                    case "Entries":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<MetricStreamEntry, MetricStreamEntryUnmarshaller>(MetricStreamEntryUnmarshaller.Instance);
        ...
        private static ListMetricStreamsResponseUnmarshaller _instance = new ListMetricStreamsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMetricStreamsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
