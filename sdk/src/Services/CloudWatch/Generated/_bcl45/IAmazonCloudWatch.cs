...
namespace Amazon.CloudWatch
{
    ...
    public partial interface IAmazonCloudWatch : IAmazonService, IDisposable
    {
        ...
        DescribeAlarmContributorsResponse DescribeAlarmContributors(DescribeAlarmContributorsRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/DescribeAlarmContributors">REST API Reference for DescribeAlarmContributors Operation</seealso>
        Task<DescribeAlarmContributorsResponse> DescribeAlarmContributorsAsync(DescribeAlarmContributorsRequest request, CancellationToken cancellationToken = default(CancellationToken));
