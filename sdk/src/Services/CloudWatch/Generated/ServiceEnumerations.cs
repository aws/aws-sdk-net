...
namespace Amazon.CloudWatch
{
    ...
    /// </summary>
    public class AlarmMuteRuleStatus : ConstantClass
    {

        /// <summary>
        /// Constant ACTIVE for AlarmMuteRuleStatus
        /// </summary>
        public static readonly AlarmMuteRuleStatus ACTIVE = new AlarmMuteRuleStatus("ACTIVE");
        /// <summary>
        /// Constant EXPIRED for AlarmMuteRuleStatus
        /// </summary>
        public static readonly AlarmMuteRuleStatus EXPIRED = new AlarmMuteRuleStatus("EXPIRED");
        /// <summary>
        /// Constant SCHEDULED for AlarmMuteRuleStatus
        /// </summary>
        public static readonly AlarmMuteRuleStatus SCHEDULED = new AlarmMuteRuleStatus("SCHEDULED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public AlarmMuteRuleStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static AlarmMuteRuleStatus FindValue(string value)
        {
            return FindValue<AlarmMuteRuleStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator AlarmMuteRuleStatus(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// </summary>
    public class OTelEnrichmentStatus : ConstantClass
    {

        /// <summary>
        /// Constant Running for OTelEnrichmentStatus
        /// </summary>
        public static readonly OTelEnrichmentStatus Running = new OTelEnrichmentStatus("Running");
        /// <summary>
        /// Constant Stopped for OTelEnrichmentStatus
        /// </summary>
        public static readonly OTelEnrichmentStatus Stopped = new OTelEnrichmentStatus("Stopped");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public OTelEnrichmentStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static OTelEnrichmentStatus FindValue(string value)
        {
            return FindValue<OTelEnrichmentStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator OTelEnrichmentStatus(string value)
        {
            return FindValue(value);
        }
    }
