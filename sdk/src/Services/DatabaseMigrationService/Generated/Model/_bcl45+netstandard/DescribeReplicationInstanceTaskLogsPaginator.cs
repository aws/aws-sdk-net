...
namespace Amazon.DatabaseMigrationService.Model
{
    ...
    internal sealed partial class DescribeReplicationInstanceTaskLogsPaginator : IPaginator<DescribeReplicationInstanceTaskLogsResponse>, IDescribeReplicationInstanceTaskLogsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeReplicationInstanceTaskLogsResponse> IPaginator<DescribeReplicationInstanceTaskLogsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
