...
namespace Amazon.DatabaseMigrationService.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidOperationException : AmazonDatabaseMigrationServiceException
    {
        ...
        public InvalidOperationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOperationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
