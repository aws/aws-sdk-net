...
{
    /// <summary>
    /// ReloadTables Request Marshaller
    /// </summary>       
    public class ReloadTablesRequestMarshaller : IMarshaller<IRequest, ReloadTablesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ReloadTablesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ReloadTablesRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetReloadOption())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ReloadOption);
            }
            ...
            if(publicRequest.IsSetTablesToReload())
            {
                context.Writer.WritePropertyName("TablesToReload");
                context.Writer.WriteStartArray();
                foreach(var publicRequestTablesToReloadListValue in publicRequest.TablesToReload)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = TableToReloadMarshaller.Instance;
                    marshaller.Marshall(publicRequestTablesToReloadListValue, context);
