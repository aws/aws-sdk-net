...
{
    /// <summary>
    /// Response Unmarshaller for BatchStartRecommendations operation
    /// </summary>  
    public class BatchStartRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchStartRecommendationsResponse response = new BatchStartRecommendationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchStartRecommendationsErrorEntry, BatchStartRecommendationsErrorEntryUnmarshaller>(BatchStartRecommendationsErrorEntryUnmarshaller.Instance);
        ...
        private static BatchStartRecommendationsResponseUnmarshaller _instance = new BatchStartRecommendationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchStartRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
