...
{
    /// <summary>
    /// DescribeTableStatistics Request Marshaller
    /// </summary>       
    public class DescribeTableStatisticsRequestMarshaller : IMarshaller<IRequest, DescribeTableStatisticsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeTableStatisticsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeTableStatisticsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeTableStatistics";
