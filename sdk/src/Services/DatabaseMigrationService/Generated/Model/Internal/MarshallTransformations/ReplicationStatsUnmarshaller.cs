...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplicationStatsUnmarshaller : IUnmarshaller<ReplicationStats, XmlUnmarshallerContext>, IUnmarshaller<ReplicationStats, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReplicationStats IUnmarshaller<ReplicationStats, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ReplicationStats Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
