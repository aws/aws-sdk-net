...
{
    /// <summary>
    /// Response Unmarshaller for StartMetadataModelCreation operation
    /// </summary>  
    public class StartMetadataModelCreationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMetadataModelCreationResponse response = new StartMetadataModelCreationResponse();
        ...
        private static StartMetadataModelCreationResponseUnmarshaller _instance = new StartMetadataModelCreationResponseUnmarshaller();        

        internal static StartMetadataModelCreationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMetadataModelCreationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
