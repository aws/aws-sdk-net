...
{
    /// <summary>
    /// StartMetadataModelExportAsScript Request Marshaller
    /// </summary>       
    public class StartMetadataModelExportAsScriptRequestMarshaller : IMarshaller<IRequest, StartMetadataModelExportAsScriptRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartMetadataModelExportAsScriptRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartMetadataModelExportAsScriptRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.StartMetadataModelExportAsScript";
        ...
        private static StartMetadataModelExportAsScriptRequestMarshaller _instance = new StartMetadataModelExportAsScriptRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMetadataModelExportAsScriptRequestMarshaller Instance
        {
            get
            {
                return _instance;
