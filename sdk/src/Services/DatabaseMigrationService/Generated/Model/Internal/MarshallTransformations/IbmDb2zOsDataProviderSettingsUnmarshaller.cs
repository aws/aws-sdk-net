...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IbmDb2zOsDataProviderSettingsUnmarshaller : IJsonUnmarshaller<IbmDb2zOsDataProviderSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IbmDb2zOsDataProviderSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("S3AccessRoleArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.S3AccessRoleArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("S3Path", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
