    ...
    public class FleetAdvisorSchemaObjectResponseUnmarshaller : IJsonUnmarshaller<FleetAdvisorSchemaObjectResponse, JsonUnmarshallerContext>
    {
        ...
        public FleetAdvisorSchemaObjectResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumberOfObjects", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
        ...
        private static FleetAdvisorSchemaObjectResponseUnmarshaller _instance = new FleetAdvisorSchemaObjectResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FleetAdvisorSchemaObjectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
