...
{
    /// <summary>
    /// Response Unmarshaller for RefreshSchemas operation
    /// </summary>  
    public class RefreshSchemasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RefreshSchemasResponse response = new RefreshSchemasResponse();
            ...
            {
                if (context.TestExpression("RefreshSchemasStatus", targetDepth, ref reader))
                {
                    var unmarshaller = RefreshSchemasStatusUnmarshaller.Instance;
                    response.RefreshSchemasStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RefreshSchemasResponseUnmarshaller _instance = new RefreshSchemasResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RefreshSchemasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
