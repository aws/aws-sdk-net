...
{
    /// <summary>
    /// Response Unmarshaller for ModifyEndpoint operation
    /// </summary>  
    public class ModifyEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyEndpointResponse response = new ModifyEndpointResponse();
        ...
        private static ModifyEndpointResponseUnmarshaller _instance = new ModifyEndpointResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
