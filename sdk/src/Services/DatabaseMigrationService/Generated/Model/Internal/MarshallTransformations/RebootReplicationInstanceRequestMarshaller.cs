...
{
    /// <summary>
    /// RebootReplicationInstance Request Marshaller
    /// </summary>       
    public class RebootReplicationInstanceRequestMarshaller : IMarshaller<IRequest, RebootReplicationInstanceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RebootReplicationInstanceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RebootReplicationInstanceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.RebootReplicationInstance";
            ...
            if(publicRequest.IsSetForceFailover())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.ForceFailover.Value);
            }

            if(publicRequest.IsSetForcePlannedFailover())
            {
                context.Writer.WritePropertyName("ForcePlannedFailover");
                context.Writer.WriteBooleanValue(publicRequest.ForcePlannedFailover.Value);
            }
