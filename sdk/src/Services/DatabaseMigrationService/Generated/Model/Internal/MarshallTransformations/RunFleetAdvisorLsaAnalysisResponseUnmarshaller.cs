...
{
    /// <summary>
    /// Response Unmarshaller for RunFleetAdvisorLsaAnalysis operation
    /// </summary>  
    public class RunFleetAdvisorLsaAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RunFleetAdvisorLsaAnalysisResponse response = new RunFleetAdvisorLsaAnalysisResponse();
            ...
            {
                if (context.TestExpression("LsaAnalysisId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LsaAnalysisId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RunFleetAdvisorLsaAnalysisResponseUnmarshaller _instance = new RunFleetAdvisorLsaAnalysisResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RunFleetAdvisorLsaAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
