    ...
    public class DescribeReplicationInstanceTaskLogsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ReplicationInstanceArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ReplicationInstanceTaskLogs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReplicationInstanceTaskLog, ReplicationInstanceTaskLogUnmarshaller>(ReplicationInstanceTaskLogUnmarshaller.Instance);
                    response.ReplicationInstanceTaskLogs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
