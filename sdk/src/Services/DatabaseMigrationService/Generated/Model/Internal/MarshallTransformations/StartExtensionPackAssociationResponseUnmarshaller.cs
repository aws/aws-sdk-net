...
{
    /// <summary>
    /// Response Unmarshaller for StartExtensionPackAssociation operation
    /// </summary>  
    public class StartExtensionPackAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartExtensionPackAssociationResponse response = new StartExtensionPackAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("RequestIdentifier", targetDepth))
                {
                    ...
                    response.RequestIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ResourceQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartExtensionPackAssociationResponseUnmarshaller _instance = new StartExtensionPackAssociationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExtensionPackAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
