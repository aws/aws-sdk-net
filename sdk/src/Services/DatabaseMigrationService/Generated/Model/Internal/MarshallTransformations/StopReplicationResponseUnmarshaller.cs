...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    public class StopReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("Replication", targetDepth, ref reader))
                {
                    var unmarshaller = ReplicationUnmarshaller.Instance;
                    response.Replication = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
