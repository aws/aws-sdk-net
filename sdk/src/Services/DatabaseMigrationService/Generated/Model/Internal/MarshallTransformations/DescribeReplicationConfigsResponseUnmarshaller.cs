...
{
    /// <summary>
    /// Response Unmarshaller for DescribeReplicationConfigs operation
    /// </summary>  
    public class DescribeReplicationConfigsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeReplicationConfigsResponse response = new DescribeReplicationConfigsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReplicationConfigs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReplicationConfig, ReplicationConfigUnmarshaller>(ReplicationConfigUnmarshaller.Instance);
                    response.ReplicationConfigs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeReplicationConfigsResponseUnmarshaller _instance = new DescribeReplicationConfigsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeReplicationConfigsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
