...
{
    /// <summary>
    /// DescribeMetadataModelImports Request Marshaller
    /// </summary>       
    public class DescribeMetadataModelImportsRequestMarshaller : IMarshaller<IRequest, DescribeMetadataModelImportsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMetadataModelImportsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMetadataModelImportsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeMetadataModelImports";
        ...
        private static DescribeMetadataModelImportsRequestMarshaller _instance = new DescribeMetadataModelImportsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMetadataModelImportsRequestMarshaller Instance
        {
            get
            {
                return _instance;
