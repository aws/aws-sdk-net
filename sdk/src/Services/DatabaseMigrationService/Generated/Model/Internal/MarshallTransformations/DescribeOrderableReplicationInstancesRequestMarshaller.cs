...
{
    /// <summary>
    /// DescribeOrderableReplicationInstances Request Marshaller
    /// </summary>       
    public class DescribeOrderableReplicationInstancesRequestMarshaller : IMarshaller<IRequest, DescribeOrderableReplicationInstancesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeOrderableReplicationInstancesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeOrderableReplicationInstancesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeOrderableReplicationInstances";
