...
{
    /// <summary>
    /// DataProviderDescriptorDefinition Marshaller
    /// </summary>
    public class DataProviderDescriptorDefinitionMarshaller : IRequestMarshaller<DataProviderDescriptorDefinition, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(DataProviderDescriptorDefinition requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDataProviderIdentifier())
            {
                ...
                context.Writer.WriteStringValue(requestObject.DataProviderIdentifier);
            }
        ...
        /// </summary>
        public readonly static DataProviderDescriptorDefinitionMarshaller Instance = new DataProviderDescriptorDefinitionMarshaller();
