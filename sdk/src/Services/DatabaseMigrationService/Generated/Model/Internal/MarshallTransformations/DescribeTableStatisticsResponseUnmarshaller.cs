    ...
    public class DescribeTableStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TableStatistics, TableStatisticsUnmarshaller>(TableStatisticsUnmarshaller.Instance);
                    response.TableStatistics = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
