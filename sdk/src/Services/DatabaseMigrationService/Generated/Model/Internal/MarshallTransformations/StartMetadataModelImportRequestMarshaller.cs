...
{
    /// <summary>
    /// StartMetadataModelImport Request Marshaller
    /// </summary>       
    public class StartMetadataModelImportRequestMarshaller : IMarshaller<IRequest, StartMetadataModelImportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartMetadataModelImportRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartMetadataModelImportRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.StartMetadataModelImport";
            ...
            if(publicRequest.IsSetRefresh())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.Refresh.Value);
            }
        ...
        private static StartMetadataModelImportRequestMarshaller _instance = new StartMetadataModelImportRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMetadataModelImportRequestMarshaller Instance
        {
            get
            {
                return _instance;
