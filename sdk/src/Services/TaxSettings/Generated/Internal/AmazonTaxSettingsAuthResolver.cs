...
namespace Amazon.TaxSettings.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonTaxSettingsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonTaxSettingsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for TaxSettings.
        /// </summary>
        public AmazonTaxSettingsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonTaxSettingsAuthSchemeParameters
            {
    ...
    public class AmazonTaxSettingsAuthSchemeResolver : IAuthSchemeResolver<AmazonTaxSettingsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonTaxSettingsAuthSchemeParameters authParameters)
        {
