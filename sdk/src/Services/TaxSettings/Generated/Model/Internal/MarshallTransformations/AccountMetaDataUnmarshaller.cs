...
namespace Amazon.TaxSettings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccountMetaDataUnmarshaller : IUnmarshaller<AccountMetaData, XmlUnmarshallerContext>, IUnmarshaller<AccountMetaData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AccountMetaData IUnmarshaller<AccountMetaData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AccountMetaData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, Jurisdiction, StringUnmarshaller, JurisdictionUnmarshaller>(StringUnmarshaller.Instance, JurisdictionUnmarshaller.Instance);
                    unmarshalledObject.AddressRoleMap = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Seller = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
