...
namespace Amazon.TaxSettings.Model
{
    ...
    public partial class MonacoAdditionalInfo
    {
        ...
        {
            get { return this._businessNumber; }
            set { this._businessNumber = value; }
        }

        // Check to see if BusinessNumber property is set
        internal bool IsSetBusinessNumber()
        {
            return this._businessNumber != null;
        }
