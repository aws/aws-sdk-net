...
namespace Amazon.TaxSettings.Model
{
    ...
    public partial class FranceAdditionalInfo
    {
        ...
        {
            get { return this._sirenNumber; }
            set { this._sirenNumber = value; }
        }

        // Check to see if SirenNumber property is set
        internal bool IsSetSirenNumber()
        {
            return this._sirenNumber != null;
        }
