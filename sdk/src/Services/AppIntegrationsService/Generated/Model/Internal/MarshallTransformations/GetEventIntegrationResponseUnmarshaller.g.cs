...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEventIntegrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetEventIntegrationResponse();
        ...
        internal static GetEventIntegrationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEventIntegrationResponseUnmarshaller Instance => _instance;
    }
}
