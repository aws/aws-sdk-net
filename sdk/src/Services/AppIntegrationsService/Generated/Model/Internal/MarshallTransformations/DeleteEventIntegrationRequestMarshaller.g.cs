...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteEventIntegrationRequestMarshaller : IMarshaller<IRequest, DeleteEventIntegrationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteEventIntegrationRequestMarshaller _instance = new();

        internal static DeleteEventIntegrationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteEventIntegrationRequestMarshaller Instance => _instance;
    }
}
