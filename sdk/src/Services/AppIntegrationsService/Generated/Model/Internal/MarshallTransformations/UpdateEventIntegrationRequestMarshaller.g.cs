...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateEventIntegrationRequestMarshaller : IMarshaller<IRequest, UpdateEventIntegrationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateEventIntegrationRequestMarshaller _instance = new();

        internal static UpdateEventIntegrationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateEventIntegrationRequestMarshaller Instance => _instance;
    }
}
