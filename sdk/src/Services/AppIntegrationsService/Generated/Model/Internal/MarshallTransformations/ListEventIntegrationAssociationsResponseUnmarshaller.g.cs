...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEventIntegrationAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListEventIntegrationAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EventIntegrationAssociations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EventIntegrationAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListEventIntegrationAssociationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEventIntegrationAssociationsResponseUnmarshaller Instance => _instance;
    }
}
