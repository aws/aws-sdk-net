...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEventIntegrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListEventIntegrationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EventIntegrations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EventIntegrations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListEventIntegrationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEventIntegrationsResponseUnmarshaller Instance => _instance;
    }
}
