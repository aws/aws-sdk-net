...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EventFilterUnmarshaller : IJsonUnmarshaller<EventFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EventFilter();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EventFilterUnmarshaller Instance => _instance;
    }
}
