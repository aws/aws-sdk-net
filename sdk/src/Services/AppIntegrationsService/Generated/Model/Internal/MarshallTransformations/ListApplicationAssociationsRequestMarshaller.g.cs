...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListApplicationAssociationsRequestMarshaller : IMarshaller<IRequest, ListApplicationAssociationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListApplicationAssociationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/applications/{ApplicationId}/associations";
        ...
        private static readonly ListApplicationAssociationsRequestMarshaller _instance = new();

        internal static ListApplicationAssociationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListApplicationAssociationsRequestMarshaller Instance => _instance;
    }
}
