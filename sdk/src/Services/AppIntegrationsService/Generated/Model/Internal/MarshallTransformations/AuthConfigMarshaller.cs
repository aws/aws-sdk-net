...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    public class AuthConfigMarshaller : IRequestMarshaller<AuthConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(AuthConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCredentialProviderIdentifier())
            {
                context.Writer.WritePropertyName("CredentialProviderIdentifier");
                context.Writer.WriteStringValue(requestObject.CredentialProviderIdentifier);
            }
