...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDataIntegrationRequestMarshaller : IMarshaller<IRequest, UpdateDataIntegrationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateDataIntegrationRequestMarshaller _instance = new();

        internal static UpdateDataIntegrationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDataIntegrationRequestMarshaller Instance => _instance;
    }
}
