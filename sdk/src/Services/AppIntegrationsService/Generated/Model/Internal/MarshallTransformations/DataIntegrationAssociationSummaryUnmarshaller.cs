...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataIntegrationAssociationSummaryUnmarshaller : IJsonUnmarshaller<DataIntegrationAssociationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataIntegrationAssociationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
