...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ApplicationSourceConfigUnmarshaller : IJsonUnmarshaller<ApplicationSourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ApplicationSourceConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ApplicationSourceConfigUnmarshaller Instance => _instance;
    }
}
