...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DataIntegrationAssociationSummaryUnmarshaller : IJsonUnmarshaller<DataIntegrationAssociationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DataIntegrationAssociationSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DataIntegrationAssociationSummaryUnmarshaller Instance => _instance;
    }
}
