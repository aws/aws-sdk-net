...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScheduleConfigurationUnmarshaller : IJsonUnmarshaller<ScheduleConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ScheduleConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScheduleConfigurationUnmarshaller Instance => _instance;
    }
}
