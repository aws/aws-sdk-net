...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEventIntegrationsRequestMarshaller : IMarshaller<IRequest, ListEventIntegrationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListEventIntegrationsRequestMarshaller _instance = new();

        internal static ListEventIntegrationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEventIntegrationsRequestMarshaller Instance => _instance;
    }
}
