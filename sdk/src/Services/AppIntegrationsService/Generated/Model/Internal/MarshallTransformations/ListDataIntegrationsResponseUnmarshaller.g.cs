...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListDataIntegrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListDataIntegrationsResponse();
            ...
            {
                if (context.TestExpression("DataIntegrations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DataIntegrationSummary, DataIntegrationSummaryUnmarshaller>(DataIntegrationSummaryUnmarshaller.Instance);
                    unmarshalledObject.DataIntegrations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListDataIntegrationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListDataIntegrationsResponseUnmarshaller Instance => _instance;
    }
}
