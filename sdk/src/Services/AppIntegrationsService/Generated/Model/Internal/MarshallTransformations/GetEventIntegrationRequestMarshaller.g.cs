...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEventIntegrationRequestMarshaller : IMarshaller<IRequest, GetEventIntegrationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetEventIntegrationRequestMarshaller _instance = new();

        internal static GetEventIntegrationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEventIntegrationRequestMarshaller Instance => _instance;
    }
}
