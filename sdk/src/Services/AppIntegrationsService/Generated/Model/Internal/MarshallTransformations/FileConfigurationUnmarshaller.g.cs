...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FileConfigurationUnmarshaller : IJsonUnmarshaller<FileConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FileConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FileConfigurationUnmarshaller Instance => _instance;
    }
}
