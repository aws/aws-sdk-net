...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListDataIntegrationAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListDataIntegrationAssociationsResponse();
            ...
            {
                if (context.TestExpression("DataIntegrationAssociations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DataIntegrationAssociationSummary, DataIntegrationAssociationSummaryUnmarshaller>(DataIntegrationAssociationSummaryUnmarshaller.Instance);
                    unmarshalledObject.DataIntegrationAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListDataIntegrationAssociationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListDataIntegrationAssociationsResponseUnmarshaller Instance => _instance;
    }
}
