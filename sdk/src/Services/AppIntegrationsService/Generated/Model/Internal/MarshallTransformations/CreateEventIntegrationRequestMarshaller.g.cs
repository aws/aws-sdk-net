...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateEventIntegrationRequestMarshaller : IMarshaller<IRequest, CreateEventIntegrationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateEventIntegrationRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetEventBridgeBus())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.EventBridgeBus);
            }
        ...
        private static readonly CreateEventIntegrationRequestMarshaller _instance = new();

        internal static CreateEventIntegrationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateEventIntegrationRequestMarshaller Instance => _instance;
    }
}
