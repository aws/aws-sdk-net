...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExecutionConfigurationUnmarshaller : IJsonUnmarshaller<ExecutionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExecutionConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExecutionConfigurationUnmarshaller Instance => _instance;
    }
}
