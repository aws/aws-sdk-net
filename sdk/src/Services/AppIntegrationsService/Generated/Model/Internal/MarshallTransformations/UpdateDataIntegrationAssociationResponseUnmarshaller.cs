...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDataIntegrationAssociation operation
    /// </summary>  
    public class UpdateDataIntegrationAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDataIntegrationAssociationResponse response = new UpdateDataIntegrationAssociationResponse();
        ...
        private static UpdateDataIntegrationAssociationResponseUnmarshaller _instance = new UpdateDataIntegrationAssociationResponseUnmarshaller();        

        internal static UpdateDataIntegrationAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataIntegrationAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
