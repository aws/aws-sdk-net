...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListDataIntegrationsRequestMarshaller : IMarshaller<IRequest, ListDataIntegrationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListDataIntegrationsRequestMarshaller _instance = new();

        internal static ListDataIntegrationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListDataIntegrationsRequestMarshaller Instance => _instance;
    }
}
