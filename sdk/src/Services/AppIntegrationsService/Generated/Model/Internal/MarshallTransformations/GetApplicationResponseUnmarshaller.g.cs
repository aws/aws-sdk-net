...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    public partial class GetApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ApplicationConfig", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ApplicationSourceConfig", targetDepth, ref reader))
                {
                    var unmarshaller = ApplicationSourceConfigUnmarshaller.Instance;
                    unmarshalledObject.ApplicationSourceConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("AuthConfig", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AuthConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("IframeConfig", targetDepth, ref reader))
                {
                    var unmarshaller = IframeConfigUnmarshaller.Instance;
                    unmarshalledObject.IframeConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("InitializationTimeout", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.InitializationTimeout = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("Publications", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Publication, PublicationUnmarshaller>(PublicationUnmarshaller.Instance);
                    unmarshalledObject.Publications = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("Subscriptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Subscriptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
