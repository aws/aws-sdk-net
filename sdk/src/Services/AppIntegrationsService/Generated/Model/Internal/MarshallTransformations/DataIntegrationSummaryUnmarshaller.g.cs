...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DataIntegrationSummaryUnmarshaller : IJsonUnmarshaller<DataIntegrationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public DataIntegrationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new DataIntegrationSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DataIntegrationSummaryUnmarshaller Instance => _instance;
    }
}
