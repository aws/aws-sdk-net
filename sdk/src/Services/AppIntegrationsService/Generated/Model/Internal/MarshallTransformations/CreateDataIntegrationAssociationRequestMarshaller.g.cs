...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateDataIntegrationAssociationRequestMarshaller : IMarshaller<IRequest, CreateDataIntegrationAssociationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateDataIntegrationAssociationRequest publicRequest)
        {
            ...
            request.AddPathResource("{DataIntegrationIdentifier}", StringUtils.FromString(publicRequest.DataIntegrationIdentifier));

            request.ResourcePath = "/dataIntegrations/{DataIntegrationIdentifier}/associations";
#if !NETFRAMEWORK
        ...
        private static readonly CreateDataIntegrationAssociationRequestMarshaller _instance = new();

        internal static CreateDataIntegrationAssociationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateDataIntegrationAssociationRequestMarshaller Instance => _instance;
    }
}
