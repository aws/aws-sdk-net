...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListApplicationAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListApplicationAssociationsResponse();
            ...
            {
                if (context.TestExpression("ApplicationAssociations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ApplicationAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListApplicationAssociationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListApplicationAssociationsResponseUnmarshaller Instance => _instance;
    }
}
