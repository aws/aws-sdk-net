...
namespace Amazon.AppIntegrationsService.Model
{
    ...
    public partial class DuplicateResourceException : AmazonAppIntegrationsServiceException
    {
        ...
        /// Construct instance of DuplicateResourceException
        /// </summary>
        public DuplicateResourceException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of DuplicateResourceException
        /// </summary>
        public DuplicateResourceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of DuplicateResourceException
        /// </summary>
        public DuplicateResourceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
