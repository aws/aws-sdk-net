...
namespace Amazon.AppIntegrationsService.Model
{
    ...
    public partial class CreateDataIntegrationAssociationResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public string DataIntegrationAssociationId { get; set; }

        /// <summary>
        /// Checks to see if the DataIntegrationAssociationId property is set.
        /// </summary>
        internal bool IsSetDataIntegrationAssociationId() => this.DataIntegrationAssociationId != null;
    }
}
