...
namespace Amazon.AppIntegrationsService.Model
{
    ...
    public partial class AuthConfig
    {
        ...
        private string _credentialProviderIdentifier;
        ...
        {
            get { return this._credentialProviderIdentifier; }
            set { this._credentialProviderIdentifier = value; }
        }

        // Check to see if CredentialProviderIdentifier property is set
        internal bool IsSetCredentialProviderIdentifier()
        {
            return this._credentialProviderIdentifier != null;
        }
