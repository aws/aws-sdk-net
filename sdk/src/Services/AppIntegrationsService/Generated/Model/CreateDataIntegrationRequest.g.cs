...
{
    /// <summary>
    /// Container for the parameters to the CreateDataIntegration operation. Creates and persists
    /// a DataIntegration resource. <note> <para> You cannot create a DataIntegration association
    /// for a DataIntegration that has been previously associated. Use a different DataIntegration,
    /// or recreate the DataIntegration using the <c>CreateDataIntegration</c> API. </para>
    /// </note>
    /// </summary>
    public partial class CreateDataIntegrationRequest : AmazonAppIntegrationsServiceRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ScheduleConfig property is set.
        /// </summary>
        internal bool IsSetScheduleConfig() => this.ScheduleConfig != null;
