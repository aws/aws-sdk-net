...
namespace Amazon.AppIntegrationsService
{
    ...
    public partial class AmazonAppIntegrationsServiceClient : AmazonServiceClient, IAmazonAppIntegrationsService
    {
        ...
        /// 
        /// </summary>
        public AmazonAppIntegrationsServiceClient() : base(new AmazonAppIntegrationsServiceConfig()) { }
        ...
        public AmazonAppIntegrationsServiceClient(RegionEndpoint region) : base(new AmazonAppIntegrationsServiceConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAppIntegrationsServiceClient(AmazonAppIntegrationsServiceConfig config) : base(config) { }
