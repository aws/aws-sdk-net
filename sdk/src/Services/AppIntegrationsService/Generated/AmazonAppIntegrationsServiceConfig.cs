...
namespace Amazon.AppIntegrationsService
{
    ...
    public partial class AmazonAppIntegrationsServiceConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("AppIntegrations", "4.0.102.0");
        ...
        /// </summary>
        public static new string ServiceId => "AppIntegrations";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "app-integrations";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-07-29";
