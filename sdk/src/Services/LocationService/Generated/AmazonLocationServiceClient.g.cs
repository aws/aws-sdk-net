...
namespace Amazon.LocationService
{
    ...
    public partial class AmazonLocationServiceClient : AmazonServiceClient, IAmazonLocationService
    {
        ...
        /// 
        /// </summary>
        public AmazonLocationServiceClient() : base(new AmazonLocationServiceConfig()) { }
        ...
        public AmazonLocationServiceClient(RegionEndpoint region) : base(new AmazonLocationServiceConfig { RegionEndpoint = region }) { }
        ...
        public AmazonLocationServiceClient(AmazonLocationServiceConfig config) : base(config) { }
