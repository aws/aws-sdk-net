...
namespace Amazon.LocationService.Model
{
    ...
    public partial class CalculateRouteMatrixResponse : AmazonWebServiceResponse
    {
        ...
        public List<List<RouteMatrixEntry>> RouteMatrix { get; set; } = AWSConfigs.InitializeCollections ? new List<List<RouteMatrixEntry>>() : null;

        /// <summary>
        /// Checks to see if the RouteMatrix property is set.
        /// </summary>
        internal bool IsSetRouteMatrix() => this.RouteMatrix != null && (this.RouteMatrix.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public List<List<double>> SnappedDeparturePositions { get; set; } = AWSConfigs.InitializeCollections ? new List<List<double>>() : null;

        /// <summary>
        /// Checks to see if the SnappedDeparturePositions property is set.
        /// </summary>
        internal bool IsSetSnappedDeparturePositions() => this.SnappedDeparturePositions != null && (this.SnappedDeparturePositions.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 350)]
        public List<List<double>> SnappedDestinationPositions { get; set; } = AWSConfigs.InitializeCollections ? new List<List<double>>() : null;

        /// <summary>
        /// Checks to see if the SnappedDestinationPositions property is set.
        /// </summary>
        internal bool IsSetSnappedDestinationPositions() => this.SnappedDestinationPositions != null && (this.SnappedDestinationPositions.Count > 0 || !AWSConfigs.InitializeCollections);
