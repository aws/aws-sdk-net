...
namespace Amazon.LocationService.Model
{
    ...
    public partial class SearchPlaceIndexForTextSummary
    {
        ...
        /// </summary>
        [AWSProperty(Sensitive = true, Min = 4, Max = 4)]
        public List<double> ResultBBox { get; set; } = AWSConfigs.InitializeCollections ? new List<double>() : null;

        /// <summary>
        /// Checks to see if the ResultBBox property is set.
        /// </summary>
        internal bool IsSetResultBBox() => this.ResultBBox != null && (this.ResultBBox.Count > 0 || !AWSConfigs.InitializeCollections);
