...
namespace Amazon.LocationService.Model
{
    ...
    internal sealed partial class ListJobsPaginator : IPaginator<ListJobsResponse>, IListJobsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ListJobsResponseEntry> Entries =>
            new PaginatedResultKeyResponse<ListJobsResponse, ListJobsResponseEntry>(this, (i) => i.Entries ?? new List<ListJobsResponseEntry>());

        internal ListJobsPaginator(IAmazonLocationService client, ListJobsRequest request)
        {
            this._client = client;
