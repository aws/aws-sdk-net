...
{
    /// <summary>
    /// Container for the parameters to the CalculateRoute operation. <important> <para> This
    /// operation is no longer current and may be deprecated in the future. We recommend you
    /// upgrade to <a href="/location/latest/APIReference/API_CalculateRoutes.html"> <c>CalculateRoutes</c>
    /// </a> or <a href="/location/latest/APIReference/API_CalculateIsolines.html"> <c>CalculateIsolines</c>
    /// </a> unless you require Grab data. </para> <ul> <li> <para> <c>CalculateRoute</c>
    /// is part of a previous Amazon Location Service Routes API (version 1) which has been
    /// superseded by a more intuitive, powerful, and complete API (version 2). </para> </li>
    /// <li> <para> The version 2 <c>CalculateRoutes</c> operation gives better results for
    /// point-to-point routing, while the version 2 <c>CalculateIsolines</c> operation adds
    /// support for calculating service areas and travel time envelopes. </para> </li> <li>
    ...
    /// Grab. </para> </li> </ul> </important> <para> <a href="https://docs.aws.amazon.com/location/previous/developerguide/calculate-route.html">Calculates
    ...
    /// conditions when calculating the route. </para> <para> Additional options include:
    ...
    /// a route based on predictive traffic data at the given time. </para> <note> <para>
    /// You can't specify both <c>DepartureTime</c> and <c>DepartNow</c> in a single request.
    /// Specifying both parameters returns a validation error. </para> </note> </li> <li>
    /// <para> <a href="https://docs.aws.amazon.com/location/previous/developerguide/travel-mode.html">Specifying
    ...
    /// </para> <note> <para> If you specify <c>walking</c> for the travel mode and your data
    /// provider is Esri, the start and destination must be within 40km. </para> </note> </li>
    /// </ul>
    /// </summary>
    public partial class CalculateRouteRequest : AmazonLocationServiceRequest
    {
        ...
        /// </summary>
        internal bool IsSetArrivalTime() => this.ArrivalTime.HasValue;
        ...
        public List<double> DeparturePosition { get; set; } = AWSConfigs.InitializeCollections ? new List<double>() : null;

        /// <summary>
        /// Checks to see if the DeparturePosition property is set.
        /// </summary>
        internal bool IsSetDeparturePosition() => this.DeparturePosition != null && (this.DeparturePosition.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Required = true, Sensitive = true, Min = 2, Max = 2)]
        public List<double> DestinationPosition { get; set; } = AWSConfigs.InitializeCollections ? new List<double>() : null;

        /// <summary>
        /// Checks to see if the DestinationPosition property is set.
        /// </summary>
        internal bool IsSetDestinationPosition() => this.DestinationPosition != null && (this.DestinationPosition.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the IncludeLegGeometry property is set.
        /// </summary>
        internal bool IsSetIncludeLegGeometry() => this.IncludeLegGeometry.HasValue;
        ...
        /// </para>
        /// </summary>
        public OptimizationMode OptimizeFor { get; set; }

        /// <summary>
        /// Checks to see if the OptimizeFor property is set.
        /// </summary>
        internal bool IsSetOptimizeFor() => this.OptimizeFor != null;
        ...
        /// </summary>
        [AWSProperty(Max = 23)]
        public List<List<double>> WaypointPositions { get; set; } = AWSConfigs.InitializeCollections ? new List<List<double>>() : null;

        /// <summary>
        /// Checks to see if the WaypointPositions property is set.
        /// </summary>
        internal bool IsSetWaypointPositions() => this.WaypointPositions != null && (this.WaypointPositions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
