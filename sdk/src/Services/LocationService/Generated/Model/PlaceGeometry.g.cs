...
namespace Amazon.LocationService.Model
{
    ...
    public partial class PlaceGeometry
    {
        ...
        public List<double> Point { get; set; } = AWSConfigs.InitializeCollections ? new List<double>() : null;

        /// <summary>
        /// Checks to see if the Point property is set.
        /// </summary>
        internal bool IsSetPoint() => this.Point != null && (this.Point.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
