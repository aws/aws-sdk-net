...
{
    /// <summary>
    /// Container for the parameters to the ListMaps operation. <important> <para> This operation
    /// is no longer current and may be deprecated in the future. We recommend upgrading to
    /// the Maps API V2 unless you require <c>Grab</c> data. </para> <ul> <li> <para> <c>ListMaps</c>
    ...
    /// Guide</a>. </para> </li> </ul> </important> <para> Lists map resources in your Amazon
