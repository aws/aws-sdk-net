...
{
    /// <summary>
    /// Container for the parameters to the UpdatePlaceIndex operation. <important> <para>
    ...
    /// <c>UpdatePlaceIndex</c> is part of a previous Amazon Location Service Places API (version
    ...
    /// of a given place index resource. </para>
    /// </summary>
