...
{
    /// <summary>
    /// Response Unmarshaller for DescribePlaceIndex operation
    /// </summary>  
    public class DescribePlaceIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePlaceIndexResponse response = new DescribePlaceIndexResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DataSourceConfiguration", targetDepth))
                {
                    ...
                    response.DataSourceConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.IndexArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribePlaceIndexResponseUnmarshaller _instance = new DescribePlaceIndexResponseUnmarshaller();        

        internal static DescribePlaceIndexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePlaceIndexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
