...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDevicePositionHistoryRequestMarshaller : IMarshaller<IRequest, GetDevicePositionHistoryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetDevicePositionHistoryRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetEndTimeExclusive())
            {
                ...
                context.Writer.WriteStringValue(StringUtils.FromDateTimeToISO8601WithOptionalMs(publicRequest.EndTimeExclusive));
            }
            ...
            if (publicRequest.IsSetStartTimeInclusive())
            {
                ...
                context.Writer.WriteStringValue(StringUtils.FromDateTimeToISO8601WithOptionalMs(publicRequest.StartTimeInclusive));
            }
        ...
        private static readonly GetDevicePositionHistoryRequestMarshaller _instance = new();

        internal static GetDevicePositionHistoryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDevicePositionHistoryRequestMarshaller Instance => _instance;
    }
}
