...
{
    /// <summary>
    /// Response Unmarshaller for CreateTracker operation.
    /// </summary>
    public partial class CreateTrackerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateTrackerResponse();
        ...
        private static CreateTrackerResponseUnmarshaller _instance = new CreateTrackerResponseUnmarshaller();

        internal static CreateTrackerResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateTrackerResponseUnmarshaller Instance => _instance;
    }
}
