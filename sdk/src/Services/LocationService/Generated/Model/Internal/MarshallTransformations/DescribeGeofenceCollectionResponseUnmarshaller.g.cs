...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeGeofenceCollectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeGeofenceCollectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("GeofenceCount", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.GeofenceCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeGeofenceCollectionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeGeofenceCollectionResponseUnmarshaller Instance => _instance;
    }
}
