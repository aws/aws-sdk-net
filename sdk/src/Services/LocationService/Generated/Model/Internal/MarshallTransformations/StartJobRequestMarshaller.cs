...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    public class StartJobRequestMarshaller : IMarshaller<IRequest, StartJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartJobRequest publicRequest)
        {
            ...
            request.ResourcePath = "/metadata/v0/jobs";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetActionOptions())
            {
                context.Writer.WritePropertyName("ActionOptions");
                context.Writer.WriteStartObject();

                var marshaller = JobActionOptionsMarshaller.Instance;
                marshaller.Marshall(publicRequest.ActionOptions, context);
            ...
            if(publicRequest.IsSetInputOptions())
            {
                context.Writer.WritePropertyName("InputOptions");
                context.Writer.WriteStartObject();

                var marshaller = JobInputOptionsMarshaller.Instance;
                marshaller.Marshall(publicRequest.InputOptions, context);
            ...
            if(publicRequest.IsSetOutputOptions())
            {
                context.Writer.WritePropertyName("OutputOptions");
                context.Writer.WriteStartObject();

                var marshaller = JobOutputOptionsMarshaller.Instance;
                marshaller.Marshall(publicRequest.OutputOptions, context);
