...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteTrackerRequestMarshaller : IMarshaller<IRequest, DeleteTrackerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteTrackerRequestMarshaller _instance = new();

        internal static DeleteTrackerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteTrackerRequestMarshaller Instance => _instance;
    }
}
