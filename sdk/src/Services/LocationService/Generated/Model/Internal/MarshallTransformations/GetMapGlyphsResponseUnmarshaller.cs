...
{
    /// <summary>
    /// Response Unmarshaller for GetMapGlyphs operation
    /// </summary>  
    public class GetMapGlyphsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMapGlyphsResponse response = new GetMapGlyphsResponse();
        ...
        private static GetMapGlyphsResponseUnmarshaller _instance = new GetMapGlyphsResponseUnmarshaller();        

        internal static GetMapGlyphsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMapGlyphsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
