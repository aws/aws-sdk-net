...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeTrackerRequestMarshaller : IMarshaller<IRequest, DescribeTrackerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeTrackerRequestMarshaller _instance = new();

        internal static DescribeTrackerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeTrackerRequestMarshaller Instance => _instance;
    }
}
