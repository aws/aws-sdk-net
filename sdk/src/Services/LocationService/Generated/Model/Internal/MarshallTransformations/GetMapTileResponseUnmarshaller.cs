...
{
    /// <summary>
    /// Response Unmarshaller for GetMapTile operation
    /// </summary>  
    public class GetMapTileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMapTileResponse response = new GetMapTileResponse();
        ...
        private static GetMapTileResponseUnmarshaller _instance = new GetMapTileResponseUnmarshaller();        

        internal static GetMapTileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMapTileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
