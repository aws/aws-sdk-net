...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeletePlaceIndexRequestMarshaller : IMarshaller<IRequest, DeletePlaceIndexRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeletePlaceIndexRequestMarshaller _instance = new DeletePlaceIndexRequestMarshaller();        

        internal static DeletePlaceIndexRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePlaceIndexRequestMarshaller Instance
        {
            get
            {
                return _instance;
