...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListKeysResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListKeysResponseEntry, ListKeysResponseEntryUnmarshaller>(ListKeysResponseEntryUnmarshaller.Instance);
        ...
        internal static ListKeysResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListKeysResponseUnmarshaller Instance => _instance;
    }
}
