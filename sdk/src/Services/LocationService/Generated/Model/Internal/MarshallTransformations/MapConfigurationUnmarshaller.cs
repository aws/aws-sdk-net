...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MapConfigurationUnmarshaller : IUnmarshaller<MapConfiguration, XmlUnmarshallerContext>, IUnmarshaller<MapConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MapConfiguration IUnmarshaller<MapConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MapConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CustomLayers", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomLayers = unmarshaller.Unmarshall(context);
                    continue;
                }
