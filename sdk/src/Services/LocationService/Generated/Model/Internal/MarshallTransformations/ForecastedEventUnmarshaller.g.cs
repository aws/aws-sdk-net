...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ForecastedEventUnmarshaller : IJsonUnmarshaller<ForecastedEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ForecastedEvent();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ForecastedBreachTime", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("IsDeviceInGeofence", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("NearestDistance", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ForecastedEventUnmarshaller Instance => _instance;
    }
}
