...
{
    /// <summary>
    /// TruckWeight Marshaller
    /// </summary>
    public partial class TruckWeightMarshaller : IRequestMarshaller<TruckWeight, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(TruckWeight requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetTotal())
            {
                ...
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(requestObject.Total.Value));
                }
                else
                {
        ...
        /// </summary>
        public readonly static TruckWeightMarshaller Instance = new TruckWeightMarshaller();
    }
}
