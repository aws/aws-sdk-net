...
{
    /// <summary>
    /// Response Unmarshaller for GetGeofence operation.
    /// </summary>
    public partial class GetGeofenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetGeofenceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("GeofenceId", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("GeofenceProperties", targetDepth, ref reader))
                {
        ...
        private static GetGeofenceResponseUnmarshaller _instance = new GetGeofenceResponseUnmarshaller();

        internal static GetGeofenceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetGeofenceResponseUnmarshaller Instance => _instance;
    }
}
