...
{
    /// <summary>
    /// Response Unmarshaller for DescribeGeofenceCollection operation
    /// </summary>  
    public class DescribeGeofenceCollectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeGeofenceCollectionResponse response = new DescribeGeofenceCollectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CollectionArn", targetDepth, ref reader))
                {
                    ...
                    response.CollectionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("CollectionName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CollectionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("GeofenceCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.GeofenceCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PricingPlan = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PricingPlanDataSource", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PricingPlanDataSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeGeofenceCollectionResponseUnmarshaller _instance = new DescribeGeofenceCollectionResponseUnmarshaller();        

        internal static DescribeGeofenceCollectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGeofenceCollectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
