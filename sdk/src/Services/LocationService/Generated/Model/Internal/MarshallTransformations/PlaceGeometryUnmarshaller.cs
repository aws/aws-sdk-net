...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlaceGeometryUnmarshaller : IJsonUnmarshaller<PlaceGeometry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PlaceGeometry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("Point", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<double, DoubleUnmarshaller>(DoubleUnmarshaller.Instance);
                    unmarshalledObject.Point = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
