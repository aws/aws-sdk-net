...
namespace Amazon.LocationService.Model
{
    ...
    public partial class JobActionOptions
    {
        ...
        /// </para>
        /// </summary>
        public ValidateAddressActionOptions ValidateAddress { get; set; }

        /// <summary>
        /// Checks to see if the ValidateAddress property is set.
        /// </summary>
        internal bool IsSetValidateAddress() => this.ValidateAddress != null;
    }
}
