...
namespace Amazon.LocationService.Model
{
    ...
    public partial class ApiKeyRestrictions
    {
        ...
        public List<string> AllowActions { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AllowActions property is set.
        /// </summary>
        internal bool IsSetAllowActions() => this.AllowActions != null && (this.AllowActions.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public List<AndroidApp> AllowAndroidApps { get; set; } = AWSConfigs.InitializeCollections ? new List<AndroidApp>() : null;

        /// <summary>
        /// Checks to see if the AllowAndroidApps property is set.
        /// </summary>
        internal bool IsSetAllowAndroidApps() => this.AllowAndroidApps != null && (this.AllowAndroidApps.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Min = 0, Max = 5)]
        public List<AppleApp> AllowAppleApps { get; set; } = AWSConfigs.InitializeCollections ? new List<AppleApp>() : null;

        /// <summary>
        /// Checks to see if the AllowAppleApps property is set.
        /// </summary>
        internal bool IsSetAllowAppleApps() => this.AllowAppleApps != null && (this.AllowAppleApps.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Min = 0, Max = 5)]
        public List<string> AllowReferers { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AllowReferers property is set.
        /// </summary>
        internal bool IsSetAllowReferers() => this.AllowReferers != null && (this.AllowReferers.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public List<string> AllowResources { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AllowResources property is set.
        /// </summary>
        internal bool IsSetAllowResources() => this.AllowResources != null && (this.AllowResources.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
