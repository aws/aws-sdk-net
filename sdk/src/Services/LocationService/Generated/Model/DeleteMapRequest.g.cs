...
{
    /// <summary>
    /// Container for the parameters to the DeleteMap operation. <important> <para> This operation
    /// is no longer current and may be deprecated in the future. We recommend upgrading to
    /// the Maps API V2 unless you require <c>Grab</c> data. </para> <ul> <li> <para> <c>DeleteMap</c>
    ...
    /// Guide</a>. </para> </li> </ul> </important> <para> Deletes a map resource from your
    /// Amazon Web Services account. </para> <note> <para> This operation deletes the resource
    /// permanently. If the map is being used in an application, the map may not render. </para>
    /// </note>
    /// </summary>
