...
namespace Amazon.LocationService.Model
{
    ...
    public partial class ListTrackerConsumersResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> ConsumerArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ConsumerArns property is set.
        /// </summary>
        internal bool IsSetConsumerArns() => this.ConsumerArns != null && (this.ConsumerArns.Count > 0 || !AWSConfigs.InitializeCollections);
