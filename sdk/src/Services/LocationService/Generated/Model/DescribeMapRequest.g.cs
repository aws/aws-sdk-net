...
{
    /// <summary>
    /// Container for the parameters to the DescribeMap operation. <important> <para> This
    /// operation is no longer current and may be deprecated in the future. We recommend upgrading
    /// to the Maps API V2 unless you require <c>Grab</c> data. </para> <ul> <li> <para> <c>DescribeMap</c>
    ...
    /// Guide</a>. </para> </li> </ul> </important> <para> Retrieves the map resource details.
    /// </para>
    /// </summary>
