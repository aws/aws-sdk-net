...
{
    /// <summary>
    /// Container for the parameters to the DescribePlaceIndex operation. <important> <para>
    ...
    /// API (version 2). </para> </li> <li> <para> The Places API version 2 has a simplified
    /// interface that can be used without creating or managing place index resources. </para>
    ...
    /// Guide</a>. </para> </li> </ul> </important> <para> Retrieves the place index resource
    /// details. </para>
    /// </summary>
