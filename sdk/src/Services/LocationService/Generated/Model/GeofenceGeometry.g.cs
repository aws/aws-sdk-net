...
namespace Amazon.LocationService.Model
{
    ...
    public partial class GeofenceGeometry
    {
        ...
        ///  </li> </ul> </note>
        /// </summary>
        [AWSProperty(Sensitive = true, Max = 700000)]
        public MemoryStream Geobuf { get; set; }

        /// <summary>
        /// Checks to see if the Geobuf property is set.
        /// </summary>
        internal bool IsSetGeobuf() => this.Geobuf != null;
        ...
        public List<List<List<List<double>>>> MultiPolygon { get; set; } = AWSConfigs.InitializeCollections ? new List<List<List<List<double>>>>() : null;

        /// <summary>
        /// Checks to see if the MultiPolygon property is set.
        /// </summary>
        internal bool IsSetMultiPolygon() => this.MultiPolygon != null && (this.MultiPolygon.Count > 0 || !AWSConfigs.InitializeCollections);
