...
namespace Amazon.LocationService.Model
{
    ...
    public partial class InferredState
    {
        ...
        /// <summary>
        /// Checks to see if the DeviationDistance property is set.
        /// </summary>
        internal bool IsSetDeviationDistance() => this.DeviationDistance.HasValue;
        ...
        /// <summary>
        /// Checks to see if the ProxyDetected property is set.
        /// </summary>
        internal bool IsSetProxyDetected() => this.ProxyDetected.HasValue;
    }
}
