...
{
    /// <summary>
    /// Container for the parameters to the DeletePlaceIndex operation. <important> <para>
    ...
    /// <c>DeletePlaceIndex</c> is part of a previous Amazon Location Service Places API (version
    ...
    /// Guide</a>. </para> </li> </ul> </important> <para> Deletes a place index resource
    /// from your Amazon Web Services account. </para> <note> <para> This operation deletes
    /// the resource permanently. </para> </note>
    /// </summary>
