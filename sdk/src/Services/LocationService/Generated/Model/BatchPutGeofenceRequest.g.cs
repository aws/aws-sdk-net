...
{
    /// <summary>
    /// Container for the parameters to the BatchPutGeofence operation. A batch request for
    /// storing geofence geometries into a given geofence collection, or updates the geometry
    ...
    public partial class BatchPutGeofenceRequest : AmazonLocationServiceRequest
    {
        ...
        public List<BatchPutGeofenceRequestEntry> Entries { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchPutGeofenceRequestEntry>() : null;
