...
{
    /// <summary>
    /// Container for the parameters to the GetMapSprites operation. <important> <para> This
    /// operation is no longer current and may be deprecated in the future. We recommend upgrading
    /// to <a href="https://docs.aws.amazon.com/location/latest/APIReference/API_geomaps_GetSprites.html">
    /// <c>GetSprites</c> </a> unless you require <c>Grab</c> data. </para> <ul> <li> <para>
    ...
    /// 2). </para> </li> <li> <para> The version 2 <c>GetSprites</c> operation gives a better
    ...
    /// Guide</a>. </para> </li> </ul> </important> <para> Retrieves the sprite sheet corresponding
    /// to a map resource. The sprite sheet is a PNG image paired with a JSON document describing
    /// the offsets of individual icons that will be displayed on a rendered map. </para>
    /// </summary>
