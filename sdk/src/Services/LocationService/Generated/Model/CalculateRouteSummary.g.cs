...
namespace Amazon.LocationService.Model
{
    ...
    public partial class CalculateRouteSummary
    {
        ...
        public List<double> RouteBBox { get; set; } = AWSConfigs.InitializeCollections ? new List<double>() : null;

        /// <summary>
        /// Checks to see if the RouteBBox property is set.
        /// </summary>
        internal bool IsSetRouteBBox() => this.RouteBBox != null && (this.RouteBBox.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
