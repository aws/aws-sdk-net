...
{
    /// <summary>
    /// Container for the parameters to the DeleteGeofenceCollection operation. Deletes a
    /// geofence collection from your Amazon Web Services account. <note> <para> This operation
    /// deletes the resource permanently. If the geofence collection is the target of a tracker
    /// resource, the devices will no longer be monitored. </para> </note>
    /// </summary>
