...
{
    /// <summary>
    /// Container for the parameters to the VerifyDevicePosition operation. Verifies the integrity
    /// of the device's position by determining if it was reported behind a proxy, and by
    /// comparing it to an inferred position estimated based on the device's state. <note>
    /// <para> The Location Integrity SDK provides enhanced features related to device verification,
