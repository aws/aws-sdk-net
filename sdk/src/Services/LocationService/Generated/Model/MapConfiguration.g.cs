...
namespace Amazon.LocationService.Model
{
    ...
    public partial class MapConfiguration
    {
        ...
        /// </summary>
        [AWSProperty(Max = 10)]
        public List<string> CustomLayers { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the CustomLayers property is set.
        /// </summary>
        internal bool IsSetCustomLayers() => this.CustomLayers != null && (this.CustomLayers.Count > 0 || !AWSConfigs.InitializeCollections);
