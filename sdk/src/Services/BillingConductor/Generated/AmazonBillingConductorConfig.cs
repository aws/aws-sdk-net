...
namespace Amazon.BillingConductor
{
    ...
    public partial class AmazonBillingConductorConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("billingconductor", "4.0.102.1");
        ...
        /// </summary>
        public static new string ServiceId => "billingconductor";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "billingconductor";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-07-30";
