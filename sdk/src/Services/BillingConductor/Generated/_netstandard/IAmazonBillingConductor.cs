...
namespace Amazon.BillingConductor
{
    ...
    public partial interface IAmazonBillingConductor : IAmazonService, IDisposable
    {
        ...
        Task<GetBillingTransferPreferenceResponse> GetBillingTransferPreferenceAsync(GetBillingTransferPreferenceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateBillingTransferPreferenceResponse> UpdateBillingTransferPreferenceAsync(UpdateBillingTransferPreferenceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
