...
{
    /// <summary>
    /// Container for the parameters to the ListPricingRules operation. Describes a pricing
    /// rule that can be associated to a pricing plan, or set of pricing plans.
    /// </summary>
