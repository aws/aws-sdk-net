...
namespace Amazon.BillingConductor.Model
{
    ...
    public partial class CustomLineItemPercentageChargeDetails
    {
        ...
        /// </summary>
        [AWSProperty(Max = 5)]
        public List<string> AssociatedValues { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AssociatedValues property is set.
        /// </summary>
        internal bool IsSetAssociatedValues() => this.AssociatedValues != null && (this.AssociatedValues.Count > 0 || !AWSConfigs.InitializeCollections);
