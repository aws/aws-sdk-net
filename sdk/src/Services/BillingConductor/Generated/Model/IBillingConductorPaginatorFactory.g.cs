...
namespace Amazon.BillingConductor.Model
{
    ...
    {
        /// <summary>
        /// Paginator for GetBillingGroupCostReport operation
        /// </summary>
        [AWSPaginator(InputToken = ["NextToken"], LimitKey = "MaxResults", OutputToken = ["NextToken"])]
        IGetBillingGroupCostReportPaginator GetBillingGroupCostReport(GetBillingGroupCostReportRequest request);
