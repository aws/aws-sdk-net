...
namespace Amazon.BillingConductor.Model
{
    ...
    public partial class ListPricingPlansAssociatedWithPricingRuleResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> PricingPlanArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the PricingPlanArns property is set.
        /// </summary>
        internal bool IsSetPricingPlanArns() => this.PricingPlanArns != null && (this.PricingPlanArns.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the PricingRuleArn property is set.
        /// </summary>
        internal bool IsSetPricingRuleArn() => this.PricingRuleArn != null;
    }
}
