...
{
    /// <summary>
    /// Container for the parameters to the AssociatePricingRules operation. Connects an array
    /// of <c>PricingRuleArns</c> to a defined <c>PricingPlan</c>. The maximum number <c>PricingRuleArn</c>
