...
{
    /// <summary>
    /// Container for the parameters to the DeleteCustomLineItem operation. Deletes the custom
    /// line item identified by the given ARN in the current, or previous billing period.
    /// </summary>
