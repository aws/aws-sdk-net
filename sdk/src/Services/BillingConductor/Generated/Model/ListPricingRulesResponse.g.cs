...
namespace Amazon.BillingConductor.Model
{
    ...
    public partial class ListPricingRulesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PricingRuleListElement> PricingRules { get; set; } = AWSConfigs.InitializeCollections ? new List<PricingRuleListElement>() : null;

        /// <summary>
        /// Checks to see if the PricingRules property is set.
        /// </summary>
        internal bool IsSetPricingRules() => this.PricingRules != null && (this.PricingRules.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
