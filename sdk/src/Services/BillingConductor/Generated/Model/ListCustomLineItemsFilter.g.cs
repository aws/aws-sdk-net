...
namespace Amazon.BillingConductor.Model
{
    ...
    public partial class ListCustomLineItemsFilter
    {
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 100)]
        public List<string> BillingGroups { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the BillingGroups property is set.
        /// </summary>
        internal bool IsSetBillingGroups() => this.BillingGroups != null && (this.BillingGroups.Count > 0 || !AWSConfigs.InitializeCollections);
