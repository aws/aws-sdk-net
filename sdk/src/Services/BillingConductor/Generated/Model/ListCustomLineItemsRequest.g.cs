...
{
    /// <summary>
    /// Container for the parameters to the ListCustomLineItems operation. A paginated call
    /// to get a list of all custom line items (FFLIs) for the given billing period. If you
