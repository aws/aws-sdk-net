...
{
    /// <summary>
    /// Container for the parameters to the CreatePricingPlan operation. Creates a pricing
    /// plan that is used for computing Amazon Web Services charges for billing groups.
    /// </summary>
