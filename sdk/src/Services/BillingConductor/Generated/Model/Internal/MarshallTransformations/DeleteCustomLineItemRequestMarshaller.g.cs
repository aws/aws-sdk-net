...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteCustomLineItemRequestMarshaller : IMarshaller<IRequest, DeleteCustomLineItemRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteCustomLineItemRequestMarshaller _instance = new();

        internal static DeleteCustomLineItemRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteCustomLineItemRequestMarshaller Instance => _instance;
    }
}
