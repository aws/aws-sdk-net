...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeletePricingRuleRequestMarshaller : IMarshaller<IRequest, DeletePricingRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeletePricingRuleRequestMarshaller _instance = new();

        internal static DeletePricingRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeletePricingRuleRequestMarshaller Instance => _instance;
    }
}
