...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCustomLineItemRequestMarshaller : IMarshaller<IRequest, CreateCustomLineItemRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateCustomLineItemRequestMarshaller _instance = new();

        internal static CreateCustomLineItemRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCustomLineItemRequestMarshaller Instance => _instance;
    }
}
