...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeletePricingPlanRequestMarshaller : IMarshaller<IRequest, DeletePricingPlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeletePricingPlanRequestMarshaller _instance = new();

        internal static DeletePricingPlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeletePricingPlanRequestMarshaller Instance => _instance;
    }
}
