    ...
    public class ListAccountAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AccountAssociationsListElement, AccountAssociationsListElementUnmarshaller>(AccountAssociationsListElementUnmarshaller.Instance);
                    response.LinkedAccounts = unmarshaller.Unmarshall(context);
                    continue;
                }
