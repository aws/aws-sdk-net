...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteCustomLineItemRequestMarshaller : IMarshaller<IRequest, DeleteCustomLineItemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCustomLineItemRequest publicRequest)
        {
            ...
            request.ResourcePath = "/delete-custom-line-item";
#if !NETFRAMEWORK
        ...
        private static DeleteCustomLineItemRequestMarshaller _instance = new DeleteCustomLineItemRequestMarshaller();        

        internal static DeleteCustomLineItemRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomLineItemRequestMarshaller Instance
        {
            get
            {
                return _instance;
