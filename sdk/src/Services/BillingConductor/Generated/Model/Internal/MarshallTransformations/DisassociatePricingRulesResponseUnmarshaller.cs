...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    public class DisassociatePricingRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DisassociatePricingRulesResponseUnmarshaller _instance = new DisassociatePricingRulesResponseUnmarshaller();        

        internal static DisassociatePricingRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociatePricingRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
