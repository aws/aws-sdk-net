...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateAccountsRequestMarshaller : IMarshaller<IRequest, DisassociateAccountsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateAccountsRequestMarshaller _instance = new();

        internal static DisassociateAccountsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateAccountsRequestMarshaller Instance => _instance;
    }
}
