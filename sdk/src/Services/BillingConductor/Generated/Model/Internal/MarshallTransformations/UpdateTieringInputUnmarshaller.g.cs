...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateTieringInputUnmarshaller : IJsonUnmarshaller<UpdateTieringInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateTieringInput();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UpdateTieringInputUnmarshaller Instance => _instance;
    }
}
