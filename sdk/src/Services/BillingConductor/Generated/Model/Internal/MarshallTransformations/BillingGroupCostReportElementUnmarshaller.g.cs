...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BillingGroupCostReportElementUnmarshaller : IJsonUnmarshaller<BillingGroupCostReportElement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BillingGroupCostReportElement();
            ...
            {
                if (context.TestExpression("AWSCost", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("MarginPercentage", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ProformaCost", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static BillingGroupCostReportElementUnmarshaller Instance => _instance;
    }
}
