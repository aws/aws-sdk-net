...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomTierUnmarshaller : IJsonUnmarshaller<CustomTier, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomTier();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomTierUnmarshaller Instance => _instance;
    }
}
