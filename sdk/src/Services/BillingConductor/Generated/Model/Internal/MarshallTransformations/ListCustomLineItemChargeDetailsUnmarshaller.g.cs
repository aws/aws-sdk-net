...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListCustomLineItemChargeDetailsUnmarshaller : IJsonUnmarshaller<ListCustomLineItemChargeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListCustomLineItemChargeDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ListCustomLineItemChargeDetailsUnmarshaller Instance => _instance;
    }
}
