...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomLineItemVersionListElementUnmarshaller : IJsonUnmarshaller<CustomLineItemVersionListElement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomLineItemVersionListElement();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("StartBillingPeriod", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomLineItemVersionListElementUnmarshaller Instance => _instance;
    }
}
