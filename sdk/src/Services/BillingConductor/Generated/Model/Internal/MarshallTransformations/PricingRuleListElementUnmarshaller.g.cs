...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PricingRuleListElementUnmarshaller : IJsonUnmarshaller<PricingRuleListElement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PricingRuleListElement();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PricingRuleListElementUnmarshaller Instance => _instance;
    }
}
