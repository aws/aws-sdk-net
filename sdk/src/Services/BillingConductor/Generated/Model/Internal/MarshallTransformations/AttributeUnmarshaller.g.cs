...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AttributeUnmarshaller : IJsonUnmarshaller<Attribute, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Attribute();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AttributeUnmarshaller Instance => _instance;
    }
}
