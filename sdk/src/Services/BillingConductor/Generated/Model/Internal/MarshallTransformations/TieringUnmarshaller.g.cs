...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TieringUnmarshaller : IJsonUnmarshaller<Tiering, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Tiering();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TieringUnmarshaller Instance => _instance;
    }
}
