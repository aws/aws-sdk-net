...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateBillingTransferPreferenceRequestMarshaller : IMarshaller<IRequest, UpdateBillingTransferPreferenceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateBillingTransferPreferenceRequestMarshaller _instance = new UpdateBillingTransferPreferenceRequestMarshaller();        

        internal static UpdateBillingTransferPreferenceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBillingTransferPreferenceRequestMarshaller Instance
        {
            get
            {
                return _instance;
