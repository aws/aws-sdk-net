...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdatePricingRuleRequestMarshaller : IMarshaller<IRequest, UpdatePricingRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdatePricingRuleRequestMarshaller _instance = new();

        internal static UpdatePricingRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePricingRuleRequestMarshaller Instance => _instance;
    }
}
