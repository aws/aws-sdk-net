...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchAssociateResourcesToCustomLineItemRequestMarshaller : IMarshaller<IRequest, BatchAssociateResourcesToCustomLineItemRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchAssociateResourcesToCustomLineItemRequestMarshaller _instance = new();

        internal static BatchAssociateResourcesToCustomLineItemRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchAssociateResourcesToCustomLineItemRequestMarshaller Instance => _instance;
    }
}
