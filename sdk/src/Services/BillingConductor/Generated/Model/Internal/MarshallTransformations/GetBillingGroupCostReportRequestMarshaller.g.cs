...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetBillingGroupCostReportRequestMarshaller : IMarshaller<IRequest, GetBillingGroupCostReportRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetBillingGroupCostReportRequestMarshaller _instance = new();

        internal static GetBillingGroupCostReportRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetBillingGroupCostReportRequestMarshaller Instance => _instance;
    }
}
