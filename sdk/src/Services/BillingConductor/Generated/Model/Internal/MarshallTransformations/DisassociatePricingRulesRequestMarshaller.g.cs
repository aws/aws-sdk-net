...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociatePricingRulesRequestMarshaller : IMarshaller<IRequest, DisassociatePricingRulesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociatePricingRulesRequestMarshaller _instance = new();

        internal static DisassociatePricingRulesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociatePricingRulesRequestMarshaller Instance => _instance;
    }
}
