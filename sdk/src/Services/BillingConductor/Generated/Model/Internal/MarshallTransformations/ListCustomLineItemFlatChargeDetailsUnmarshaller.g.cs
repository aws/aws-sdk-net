...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListCustomLineItemFlatChargeDetailsUnmarshaller : IJsonUnmarshaller<ListCustomLineItemFlatChargeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListCustomLineItemFlatChargeDetails();
            ...
            {
                if (context.TestExpression("ChargeValue", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ListCustomLineItemFlatChargeDetailsUnmarshaller Instance => _instance;
    }
}
