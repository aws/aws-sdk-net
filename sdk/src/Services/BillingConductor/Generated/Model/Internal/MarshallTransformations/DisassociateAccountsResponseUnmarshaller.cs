...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    public class DisassociateAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DisassociateAccountsResponseUnmarshaller _instance = new DisassociateAccountsResponseUnmarshaller();        

        internal static DisassociateAccountsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAccountsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
