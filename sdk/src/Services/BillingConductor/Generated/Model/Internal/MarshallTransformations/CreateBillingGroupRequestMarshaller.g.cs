...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateBillingGroupRequestMarshaller : IMarshaller<IRequest, CreateBillingGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateBillingGroupRequestMarshaller _instance = new();

        internal static CreateBillingGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateBillingGroupRequestMarshaller Instance => _instance;
    }
}
