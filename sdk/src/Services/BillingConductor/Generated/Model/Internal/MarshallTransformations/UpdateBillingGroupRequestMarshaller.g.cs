...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateBillingGroupRequestMarshaller : IMarshaller<IRequest, UpdateBillingGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateBillingGroupRequestMarshaller _instance = new();

        internal static UpdateBillingGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateBillingGroupRequestMarshaller Instance => _instance;
    }
}
