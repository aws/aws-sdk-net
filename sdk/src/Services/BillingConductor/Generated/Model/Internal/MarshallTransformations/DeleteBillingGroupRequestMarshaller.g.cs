...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteBillingGroupRequestMarshaller : IMarshaller<IRequest, DeleteBillingGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteBillingGroupRequestMarshaller _instance = new();

        internal static DeleteBillingGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteBillingGroupRequestMarshaller Instance => _instance;
    }
}
