...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LineItemFilterUnmarshaller : IJsonUnmarshaller<LineItemFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LineItemFilter();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LineItemFilterUnmarshaller Instance => _instance;
    }
}
