...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchDisassociateResourcesFromCustomLineItemRequestMarshaller : IMarshaller<IRequest, BatchDisassociateResourcesFromCustomLineItemRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchDisassociateResourcesFromCustomLineItemRequestMarshaller _instance = new();

        internal static BatchDisassociateResourcesFromCustomLineItemRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchDisassociateResourcesFromCustomLineItemRequestMarshaller Instance => _instance;
    }
}
