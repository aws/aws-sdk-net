    ...
    public class ListBillingGroupCostReportsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BillingGroupCostReportElement, BillingGroupCostReportElementUnmarshaller>(BillingGroupCostReportElementUnmarshaller.Instance);
                    response.BillingGroupCostReports = unmarshaller.Unmarshall(context);
                    continue;
                }
