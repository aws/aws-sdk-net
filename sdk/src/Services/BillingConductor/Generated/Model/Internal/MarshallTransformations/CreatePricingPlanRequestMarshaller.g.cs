...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreatePricingPlanRequestMarshaller : IMarshaller<IRequest, CreatePricingPlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreatePricingPlanRequestMarshaller _instance = new();

        internal static CreatePricingPlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreatePricingPlanRequestMarshaller Instance => _instance;
    }
}
