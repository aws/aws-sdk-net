...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdatePricingPlanRequestMarshaller : IMarshaller<IRequest, UpdatePricingPlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdatePricingPlanRequestMarshaller _instance = new();

        internal static UpdatePricingPlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePricingPlanRequestMarshaller Instance => _instance;
    }
}
