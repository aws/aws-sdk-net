...
{
    /// <summary>
    /// Container for the parameters to the AssociateAccounts operation. Connects an array
    /// of account IDs in a consolidated billing family to a predefined billing group. The
    /// account IDs must be a part of the consolidated billing family during the current month,
    /// and not already associated with another billing group. The maximum number of accounts
