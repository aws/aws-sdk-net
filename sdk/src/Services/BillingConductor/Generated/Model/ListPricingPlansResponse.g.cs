...
namespace Amazon.BillingConductor.Model
{
    ...
    public partial class ListPricingPlansResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PricingPlanListElement> PricingPlans { get; set; } = AWSConfigs.InitializeCollections ? new List<PricingPlanListElement>() : null;

        /// <summary>
        /// Checks to see if the PricingPlans property is set.
        /// </summary>
        internal bool IsSetPricingPlans() => this.PricingPlans != null && (this.PricingPlans.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
