...
namespace Amazon.BillingConductor.Model
{
    ...
    [Serializable]
#endif
    public partial class ServiceLimitExceededException : AmazonBillingConductorException
    {
        /// <summary>
        /// Default constructor for ServiceLimitExceededException
        /// message.
        /// </summary>
        public ServiceLimitExceededException() : base() { }
        ...
        /// </param>
        public ServiceLimitExceededException(string message) : base(message) { }

        /// <summary>
        /// Construct instance of ServiceLimitExceededException
        /// </summary>
        public ServiceLimitExceededException(string message, Exception innerException) : base(message, innerException) { }

        /// <summary>
        /// Construct instance of ServiceLimitExceededException
        /// </summary>
        public ServiceLimitExceededException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ServiceLimitExceededException
        /// </summary>
        public ServiceLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ServiceLimitExceededException
        /// </summary>
        public ServiceLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
        ...
        /// <summary>
        /// Checks to see if the LimitCode property is set.
        /// </summary>
        internal bool IsSetLimitCode() => this.LimitCode != null;
