...
namespace Amazon.BillingConductor.Model
{
    ...
    public class BillingConductorPaginatorFactory : IBillingConductorPaginatorFactory
    {
        ...
        /// </summary>
        public IGetBillingGroupCostReportPaginator GetBillingGroupCostReport(GetBillingGroupCostReportRequest request)
        {
            return new GetBillingGroupCostReportPaginator(this.client, request);
        }
