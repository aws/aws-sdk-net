...
namespace Amazon.BillingConductor.Model
{
    ...
    internal sealed partial class ListAccountAssociationsPaginator : IPaginator<ListAccountAssociationsResponse>, IListAccountAssociationsPaginator
    {
        ...
        async IAsyncEnumerable<ListAccountAssociationsResponse> IPaginator<ListAccountAssociationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
