...
namespace Amazon.BillingConductor.Internal
{
    ...
    public class AmazonBillingConductorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBillingConductorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BillingConductor.
        /// </summary>
        public AmazonBillingConductorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBillingConductorAuthSchemeParameters
            {
    ...
    public class AmazonBillingConductorAuthSchemeResolver : IAuthSchemeResolver<AmazonBillingConductorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBillingConductorAuthSchemeParameters authParameters)
        {
