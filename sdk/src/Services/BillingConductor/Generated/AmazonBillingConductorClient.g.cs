...
namespace Amazon.BillingConductor
{
    ...
    public partial class AmazonBillingConductorClient : AmazonServiceClient, IAmazonBillingConductor
    {
        ...
        /// 
        /// </summary>
        public AmazonBillingConductorClient() : base(new AmazonBillingConductorConfig()) { }
        ...
        public AmazonBillingConductorClient(RegionEndpoint region) : base(new AmazonBillingConductorConfig { RegionEndpoint = region }) { }
        ...
        public AmazonBillingConductorClient(AmazonBillingConductorConfig config) : base(config) { }
...
#else
        internal virtual GetBillingTransferPreferenceResponse GetBillingTransferPreference(GetBillingTransferPreferenceRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetBillingTransferPreferenceRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetBillingTransferPreferenceResponseUnmarshaller.Instance;
...
#else
        internal virtual UpdateBillingTransferPreferenceResponse UpdateBillingTransferPreference(UpdateBillingTransferPreferenceRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateBillingTransferPreferenceRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateBillingTransferPreferenceResponseUnmarshaller.Instance;
