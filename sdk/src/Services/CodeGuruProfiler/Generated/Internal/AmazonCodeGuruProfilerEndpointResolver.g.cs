...
{
    /// <summary>
    /// Amazon CodeGuruProfiler endpoint resolver.
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for CodeGuruProfiler service requests.
    /// <para />
    /// Collects values for <see cref="CodeGuruProfilerEndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonCodeGuruProfilerEndpointProvider"/>.
    /// <para />
    /// Responsible for setting authentication and HTTP headers provided by resolved endpoint.
    /// </summary>
    public class AmazonCodeGuruProfilerEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonCodeGuruProfilerConfig)requestContext.ClientConfig;
            var result = new CodeGuruProfilerEndpointParameters();
