...
namespace Amazon.CodeGuruProfiler
{
    ...
    public partial class AmazonCodeGuruProfilerClient : AmazonServiceClient, IAmazonCodeGuruProfiler
    {
        ...
        /// 
        /// </summary>
        public AmazonCodeGuruProfilerClient() : base(new AmazonCodeGuruProfilerConfig()) { }
        ...
        public AmazonCodeGuruProfilerClient(RegionEndpoint region) : base(new AmazonCodeGuruProfilerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonCodeGuruProfilerClient(AmazonCodeGuruProfilerConfig config) : base(config) { }
