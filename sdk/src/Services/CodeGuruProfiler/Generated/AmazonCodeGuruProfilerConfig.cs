...
namespace Amazon.CodeGuruProfiler
{
    ...
    public partial class AmazonCodeGuruProfilerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CodeGuruProfiler", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "CodeGuruProfiler";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "codeguru-profiler";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-07-18";
