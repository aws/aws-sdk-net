...
{
    /// <summary>
    /// This is the response object from the GetFindingsReportAccountSummary operation.
    /// </summary>
    public partial class GetFindingsReportAccountSummaryResponse : AmazonWebServiceResponse
    {
        ...
        public List<FindingsReportSummary> ReportSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<FindingsReportSummary>() : null;

        /// <summary>
        /// Checks to see if the ReportSummaries property is set.
        /// </summary>
        internal bool IsSetReportSummaries() => this.ReportSummaries != null && (this.ReportSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
