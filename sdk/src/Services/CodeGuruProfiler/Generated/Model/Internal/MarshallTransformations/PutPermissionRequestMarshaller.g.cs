...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutPermissionRequestMarshaller : IMarshaller<IRequest, PutPermissionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutPermissionRequestMarshaller _instance = new();

        internal static PutPermissionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutPermissionRequestMarshaller Instance => _instance;
    }
}
