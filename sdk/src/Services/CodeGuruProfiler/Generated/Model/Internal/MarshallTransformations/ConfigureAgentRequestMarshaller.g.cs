...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConfigureAgentRequestMarshaller : IMarshaller<IRequest, ConfigureAgentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ConfigureAgentRequestMarshaller _instance = new();

        internal static ConfigureAgentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ConfigureAgentRequestMarshaller Instance => _instance;
    }
}
