...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AgentConfigurationUnmarshaller : IJsonUnmarshaller<AgentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AgentConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AgentConfigurationUnmarshaller Instance => _instance;
    }
}
