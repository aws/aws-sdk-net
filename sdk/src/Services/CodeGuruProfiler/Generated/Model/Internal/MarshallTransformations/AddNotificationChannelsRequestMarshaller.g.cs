...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddNotificationChannelsRequestMarshaller : IMarshaller<IRequest, AddNotificationChannelsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AddNotificationChannelsRequestMarshaller _instance = new();

        internal static AddNotificationChannelsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddNotificationChannelsRequestMarshaller Instance => _instance;
    }
}
