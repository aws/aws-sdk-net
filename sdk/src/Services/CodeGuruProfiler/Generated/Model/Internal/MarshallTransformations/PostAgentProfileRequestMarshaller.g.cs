...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PostAgentProfileRequestMarshaller : IMarshaller<IRequest, PostAgentProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PostAgentProfileRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("profileToken", Guid.NewGuid().ToString());
            }
        ...
        private static readonly PostAgentProfileRequestMarshaller _instance = new();

        internal static PostAgentProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PostAgentProfileRequestMarshaller Instance => _instance;
    }
}
