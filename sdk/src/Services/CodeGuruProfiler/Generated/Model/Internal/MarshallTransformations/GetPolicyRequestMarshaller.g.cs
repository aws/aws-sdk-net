...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetPolicyRequestMarshaller : IMarshaller<IRequest, GetPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/profilingGroups/{profilingGroupName}/policy";

            return request;
        }

        private static readonly GetPolicyRequestMarshaller _instance = new();

        internal static GetPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPolicyRequestMarshaller Instance => _instance;
    }
}
