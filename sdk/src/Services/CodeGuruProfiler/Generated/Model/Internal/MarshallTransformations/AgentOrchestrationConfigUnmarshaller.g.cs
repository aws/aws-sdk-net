...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AgentOrchestrationConfigUnmarshaller : IJsonUnmarshaller<AgentOrchestrationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AgentOrchestrationConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AgentOrchestrationConfigUnmarshaller Instance => _instance;
    }
}
