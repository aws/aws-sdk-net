...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateProfilingGroupRequestMarshaller : IMarshaller<IRequest, UpdateProfilingGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateProfilingGroupRequestMarshaller _instance = new();

        internal static UpdateProfilingGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateProfilingGroupRequestMarshaller Instance => _instance;
    }
}
