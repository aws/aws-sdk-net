...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnomalyInstanceUnmarshaller : IJsonUnmarshaller<AnomalyInstance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnomalyInstance Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
