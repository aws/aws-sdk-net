...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RemoveNotificationChannelRequestMarshaller : IMarshaller<IRequest, RemoveNotificationChannelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RemoveNotificationChannelRequestMarshaller _instance = new();

        internal static RemoveNotificationChannelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RemoveNotificationChannelRequestMarshaller Instance => _instance;
    }
}
