...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProfilingGroupDescriptionUnmarshaller : IJsonUnmarshaller<ProfilingGroupDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProfilingGroupDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("agentOrchestrationConfig", targetDepth, ref reader))
                {
                    var unmarshaller = AgentOrchestrationConfigUnmarshaller.Instance;
                    unmarshalledObject.AgentOrchestrationConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("profilingStatus", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ProfilingStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
