...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetFrameMetricDataRequestMarshaller : IMarshaller<IRequest, BatchGetFrameMetricDataRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchGetFrameMetricDataRequestMarshaller _instance = new();

        internal static BatchGetFrameMetricDataRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetFrameMetricDataRequestMarshaller Instance => _instance;
    }
}
