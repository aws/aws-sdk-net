...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FrameMetricDatumUnmarshaller : IJsonUnmarshaller<FrameMetricDatum, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FrameMetricDatum();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FrameMetricDatumUnmarshaller Instance => _instance;
    }
}
