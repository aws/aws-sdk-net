...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProfilingStatusUnmarshaller : IJsonUnmarshaller<ProfilingStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProfilingStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
