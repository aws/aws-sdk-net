...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetNotificationConfigurationRequestMarshaller : IMarshaller<IRequest, GetNotificationConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetNotificationConfigurationRequestMarshaller _instance = new();

        internal static GetNotificationConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetNotificationConfigurationRequestMarshaller Instance => _instance;
    }
}
