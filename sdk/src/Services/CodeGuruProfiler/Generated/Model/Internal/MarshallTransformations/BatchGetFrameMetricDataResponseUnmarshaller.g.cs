...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetFrameMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetFrameMetricDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("endTimes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EndTimes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("frameMetricData", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.FrameMetricData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("unprocessedEndTimes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.UnprocessedEndTimes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static BatchGetFrameMetricDataResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetFrameMetricDataResponseUnmarshaller Instance => _instance;
    }
}
