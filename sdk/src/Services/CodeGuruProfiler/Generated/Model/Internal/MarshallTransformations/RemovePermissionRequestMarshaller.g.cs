...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RemovePermissionRequestMarshaller : IMarshaller<IRequest, RemovePermissionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RemovePermissionRequestMarshaller _instance = new();

        internal static RemovePermissionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RemovePermissionRequestMarshaller Instance => _instance;
    }
}
