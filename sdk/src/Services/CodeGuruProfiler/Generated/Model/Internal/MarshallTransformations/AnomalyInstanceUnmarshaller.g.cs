...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnomalyInstanceUnmarshaller : IJsonUnmarshaller<AnomalyInstance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AnomalyInstance();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnomalyInstanceUnmarshaller Instance => _instance;
    }
}
