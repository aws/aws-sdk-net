...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnomalyUnmarshaller : IJsonUnmarshaller<Anomaly, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Anomaly();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnomalyUnmarshaller Instance => _instance;
    }
}
