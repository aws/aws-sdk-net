...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProfilingStatusUnmarshaller : IJsonUnmarshaller<ProfilingStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProfilingStatus();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProfilingStatusUnmarshaller Instance => _instance;
    }
}
