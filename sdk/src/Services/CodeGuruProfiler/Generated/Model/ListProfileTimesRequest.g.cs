...
{
    /// <summary>
    /// Container for the parameters to the ListProfileTimes operation. Lists the start times
    /// of the available aggregated profiles of a profiling group for an aggregation period
