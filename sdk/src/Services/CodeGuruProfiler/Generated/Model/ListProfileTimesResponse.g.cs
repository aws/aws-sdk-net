...
{
    /// <summary>
    /// This is the response object from the ListProfileTimes operation.
    /// </summary>
    public partial class ListProfileTimesResponse : AmazonWebServiceResponse
    {
        ...
        public List<ProfileTime> ProfileTimes { get; set; } = AWSConfigs.InitializeCollections ? new List<ProfileTime>() : null;

        /// <summary>
        /// Checks to see if the ProfileTimes property is set.
        /// </summary>
        internal bool IsSetProfileTimes() => this.ProfileTimes != null && (this.ProfileTimes.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
