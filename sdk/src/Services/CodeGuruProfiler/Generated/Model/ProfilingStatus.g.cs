...
namespace Amazon.CodeGuruProfiler.Model
{
    ...
    public partial class ProfilingStatus
    {
        ...
        /// </para>
        /// </summary>
        public DateTime? LatestAgentOrchestratedAt { get; set; }

        /// <summary>
        /// Checks to see if the LatestAgentOrchestratedAt property is set.
        /// </summary>
        internal bool IsSetLatestAgentOrchestratedAt() => this.LatestAgentOrchestratedAt.HasValue;
        ...
        /// </para>
        /// </summary>
        public DateTime? LatestAgentProfileReportedAt { get; set; }

        /// <summary>
        /// Checks to see if the LatestAgentProfileReportedAt property is set.
        /// </summary>
        internal bool IsSetLatestAgentProfileReportedAt() => this.LatestAgentProfileReportedAt.HasValue;
        ...
        /// <summary>
        /// Checks to see if the LatestAggregatedProfile property is set.
        /// </summary>
        internal bool IsSetLatestAggregatedProfile() => this.LatestAggregatedProfile != null;
    }
}
