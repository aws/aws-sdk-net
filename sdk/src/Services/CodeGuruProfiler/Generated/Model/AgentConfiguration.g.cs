...
namespace Amazon.CodeGuruProfiler.Model
{
    ...
    public partial class AgentConfiguration
    {
        ...
        /// </summary>
        public Dictionary<string, string> AgentParameters { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the AgentParameters property is set.
        /// </summary>
        internal bool IsSetAgentParameters() => this.AgentParameters != null && (this.AgentParameters.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the PeriodInSeconds property is set.
        /// </summary>
        internal bool IsSetPeriodInSeconds() => this.PeriodInSeconds.HasValue;
        ...
        /// <summary>
        /// Checks to see if the ShouldProfile property is set.
        /// </summary>
        internal bool IsSetShouldProfile() => this.ShouldProfile.HasValue;
    }
}
