...
namespace Amazon.CodeGuruProfiler.Model
{
    ...
    public partial class FrameMetricDatum
    {
        ...
        /// <summary>
        /// Checks to see if the FrameMetric property is set.
        /// </summary>
        internal bool IsSetFrameMetric() => this.FrameMetric != null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<double> Values { get; set; } = AWSConfigs.InitializeCollections ? new List<double>() : null;
