...
{
    /// <summary>
    /// Container for the parameters to the ConfigureAgent operation. Used by profiler agents
    /// to report their current state and to receive remote configuration updates. For example,
    /// <c>ConfigureAgent</c> can be used to tell an agent whether to profile or not and for
    ...
    public partial class ConfigureAgentRequest : AmazonCodeGuruProfilerRequest
    {
        ...
        /// <summary>
        /// Checks to see if the FleetInstanceId property is set.
        /// </summary>
        internal bool IsSetFleetInstanceId() => this.FleetInstanceId != null;
