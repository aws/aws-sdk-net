...
{
    /// <summary>
    /// Container for the parameters to the GetNotificationConfiguration operation. Get the
    /// current configuration for anomaly notifications for a profiling group.
    /// </summary>
