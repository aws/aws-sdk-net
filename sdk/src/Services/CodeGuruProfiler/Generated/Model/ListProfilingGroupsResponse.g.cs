...
{
    /// <summary>
    /// This is the response object from the ListProfilingGroups operation.
    /// </summary>
    public partial class ListProfilingGroupsResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> ProfilingGroupNames { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ProfilingGroupNames property is set.
        /// </summary>
        internal bool IsSetProfilingGroupNames() => this.ProfilingGroupNames != null && (this.ProfilingGroupNames.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ProfilingGroupDescription> ProfilingGroups { get; set; } = AWSConfigs.InitializeCollections ? new List<ProfilingGroupDescription>() : null;

        /// <summary>
        /// Checks to see if the ProfilingGroups property is set.
        /// </summary>
        internal bool IsSetProfilingGroups() => this.ProfilingGroups != null && (this.ProfilingGroups.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
