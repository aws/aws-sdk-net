...
namespace Amazon.CodeGuruProfiler.Model
{
    ...
    public partial class Channel
    {
        ...
        public List<string> EventPublishers { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the EventPublishers property is set.
        /// </summary>
        internal bool IsSetEventPublishers() => this.EventPublishers != null && (this.EventPublishers.Count > 0 || !AWSConfigs.InitializeCollections);
