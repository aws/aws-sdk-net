...
{
    /// <summary>
    /// UpdatePipeSourceSelfManagedKafkaParameters Marshaller
    /// </summary>
    public class UpdatePipeSourceSelfManagedKafkaParametersMarshaller : IRequestMarshaller<UpdatePipeSourceSelfManagedKafkaParameters, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(UpdatePipeSourceSelfManagedKafkaParameters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetServerRootCaCertificate())
            {
                ...
                context.Writer.Write(requestObject.ServerRootCaCertificate);
            }
        ...
        /// </summary>
        public readonly static UpdatePipeSourceSelfManagedKafkaParametersMarshaller Instance = new UpdatePipeSourceSelfManagedKafkaParametersMarshaller();
