...
namespace Amazon.Pipes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipeSourceKinesisStreamParametersUnmarshaller : IUnmarshaller<PipeSourceKinesisStreamParameters, XmlUnmarshallerContext>, IUnmarshaller<PipeSourceKinesisStreamParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PipeSourceKinesisStreamParameters IUnmarshaller<PipeSourceKinesisStreamParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PipeSourceKinesisStreamParameters Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
