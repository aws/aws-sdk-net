...
namespace Amazon.Pipes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipeSourceParametersUnmarshaller : IUnmarshaller<PipeSourceParameters, XmlUnmarshallerContext>, IUnmarshaller<PipeSourceParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PipeSourceParameters IUnmarshaller<PipeSourceParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PipeSourceParameters Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ActiveMQBrokerParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.ActiveMQBrokerParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DynamoDBStreamParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.DynamoDBStreamParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ManagedStreamingKafkaParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.ManagedStreamingKafkaParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RabbitMQBrokerParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.RabbitMQBrokerParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SelfManagedKafkaParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.SelfManagedKafkaParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
