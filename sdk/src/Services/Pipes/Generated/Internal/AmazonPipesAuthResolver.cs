...
namespace Amazon.Pipes.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonPipesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPipesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Pipes.
        /// </summary>
        public AmazonPipesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPipesAuthSchemeParameters
            {
    ...
    public class AmazonPipesAuthSchemeResolver : IAuthSchemeResolver<AmazonPipesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPipesAuthSchemeParameters authParameters)
        {
