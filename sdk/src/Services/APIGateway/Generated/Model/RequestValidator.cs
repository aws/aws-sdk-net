...
namespace Amazon.APIGateway.Model
{
    ...
    ///  <div class="remarks"> 
    /// <para>
    /// In Swagger, a <a>RequestValidator</a> of an API is defined by the <a href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validators.requestValidator.html">x-amazon-apigateway-request-validators.requestValidator</a>
    /// object. It the referenced using the <a href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validator">x-amazon-apigateway-request-validator</a>
    /// property.
    /// </para>
    ///  </div> <div class="seeAlso"><a href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/api-gateway-method-request-validation.html">Enable
