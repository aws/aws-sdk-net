...
namespace Amazon.APIGateway.Model.Internal.MarshallTransformations
{
    ...
    public class GetSdkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static GetSdkResponseUnmarshaller _instance = new GetSdkResponseUnmarshaller();        

        internal static GetSdkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSdkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
