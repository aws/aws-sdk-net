...
namespace Amazon.APIGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ThrottleSettingsUnmarshaller : IJsonUnmarshaller<ThrottleSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThrottleSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("burstLimit", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.BurstLimit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
