...
namespace Amazon.APIGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SdkConfigurationPropertyUnmarshaller : IJsonUnmarshaller<SdkConfigurationProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SdkConfigurationProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("friendlyName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FriendlyName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
