...
namespace Amazon.APIGateway.Model.Internal.MarshallTransformations
{
    ...
    public class IntegrationResponseUnmarshaller : IJsonUnmarshaller<IntegrationResponse, JsonUnmarshallerContext>
    {
        ...
        public IntegrationResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("contentHandling", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("selectionPattern", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SelectionPattern = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
