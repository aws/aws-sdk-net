...
{
    /// <summary>
    /// Response Unmarshaller for GetSdkTypes operation
    /// </summary>  
    public class GetSdkTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSdkTypesResponse response = new GetSdkTypesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SdkType, SdkTypeUnmarshaller>(SdkTypeUnmarshaller.Instance);
        ...
        private static GetSdkTypesResponseUnmarshaller _instance = new GetSdkTypesResponseUnmarshaller();        

        internal static GetSdkTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSdkTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
