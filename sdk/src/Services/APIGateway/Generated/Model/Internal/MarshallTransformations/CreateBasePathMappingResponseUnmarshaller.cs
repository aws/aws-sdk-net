...
{
    /// <summary>
    /// Response Unmarshaller for CreateBasePathMapping operation
    /// </summary>  
    public class CreateBasePathMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBasePathMappingResponse response = new CreateBasePathMappingResponse();
        ...
        private static CreateBasePathMappingResponseUnmarshaller _instance = new CreateBasePathMappingResponseUnmarshaller();        

        internal static CreateBasePathMappingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBasePathMappingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
