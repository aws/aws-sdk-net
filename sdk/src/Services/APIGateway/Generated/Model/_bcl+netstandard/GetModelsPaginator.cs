...
namespace Amazon.APIGateway.Model
{
    ...
    internal sealed partial class GetModelsPaginator : IPaginator<GetModelsResponse>, IGetModelsPaginator
    {
        ...
        public IPaginatedEnumerable<Model> Items => 
            new PaginatedResultKeyResponse<GetModelsResponse, Model>(this, (i) => i.Items ?? new List<Model>());
        ...
        async IAsyncEnumerable<GetModelsResponse> IPaginator<GetModelsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
