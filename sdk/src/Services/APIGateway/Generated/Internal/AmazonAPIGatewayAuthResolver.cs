...
namespace Amazon.APIGateway.Internal
{
    ...
    public class AmazonAPIGatewayAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAPIGatewayAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for APIGateway.
        /// </summary>
        public AmazonAPIGatewayAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAPIGatewayAuthSchemeParameters
            {
    ...
    public class AmazonAPIGatewayAuthSchemeResolver : IAuthSchemeResolver<AmazonAPIGatewayAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAPIGatewayAuthSchemeParameters authParameters)
        {
