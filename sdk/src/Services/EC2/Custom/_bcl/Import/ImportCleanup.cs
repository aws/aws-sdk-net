...
namespace Amazon.EC2.Import
{
    ...
    public abstract class ImportCleanup
    {
        ...
        public static void DeleteImageArtifacts(RegionEndpoint region, 
                                                ...
                                                CleanupProgressCallback progressCallback)
        {
            DeleteImageArtifacts(ServiceClientHelpers.CreateServiceFromAssembly<ICoreAmazonS3>(ServiceClientHelpers.S3_ASSEMBLY_NAME, ServiceClientHelpers.S3_SERVICE_CLASS_NAME, region), manifestUrl, progressCallback);
        }
