...
namespace Amazon.EC2.Model
{
    ...
    /// </summary>
    public partial class CreateTrafficMirrorTargetResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property TrafficMirrorTarget. 
        /// <para>
        ...
        {
            get { return this._trafficMirrorTarget; }
            set { this._trafficMirrorTarget = value; }
        }

        // Check to see if TrafficMirrorTarget property is set
        internal bool IsSetTrafficMirrorTarget()
        {
            return this._trafficMirrorTarget != null;
        }
