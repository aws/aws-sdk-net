...
{
    /// <summary>
    /// Container for the parameters to the CreateIpamRoutingPolicyRegistration operation.
    ...
    /// </summary>
    public partial class CreateIpamRoutingPolicyRegistrationRequest : AmazonEC2Request
    {
        ...
        /// <para>
        /// Forces the creation of the routing policy registration even if it conflicts with an
        /// announced route. Default: <c>false</c>.
        /// </para>
        /// </summary>
        public bool? Force
        {
        ...
        /// <para>
        /// The maximum prefix length that the ASNs are authorized to announce. Must be greater
        /// than or equal to the prefix length of the CIDR. If not specified, defaults to the
        /// prefix length of the CIDR (exact match only).
        /// </para>
        /// </summary>
