...
namespace Amazon.EC2.Model
{
    ...
    /// </summary>
    public partial class ModifyVolumeResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._volumeModification; }
            set { this._volumeModification = value; }
        }

        // Check to see if VolumeModification property is set
        internal bool IsSetVolumeModification()
        {
            return this._volumeModification != null;
        }
