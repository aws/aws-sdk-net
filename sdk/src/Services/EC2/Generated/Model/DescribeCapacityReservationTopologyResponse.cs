...
{
    /// <summary>
    /// This is the response object from the DescribeCapacityReservationTopology operation.
    /// </summary>
    public partial class DescribeCapacityReservationTopologyResponse : AmazonWebServiceResponse
    {
        private List<CapacityReservationTopology> _capacityReservations = AWSConfigs.InitializeCollections ? new List<CapacityReservationTopology>() : null;
        ...
        /// </summary>
        public List<CapacityReservationTopology> CapacityReservations
        {
