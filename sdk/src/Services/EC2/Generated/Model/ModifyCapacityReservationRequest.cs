...
namespace Amazon.EC2.Model
{
    ...
    public partial class ModifyCapacityReservationRequest : AmazonEC2Request
    {
        ...
        private bool? _acceptModificationTerms;
        ...
        /// <summary>
        /// Gets and sets the property AcceptModificationTerms. 
        /// <para>
        /// Indicates that you accept the modification terms of the quote identified by <c>QuoteId</c>.
        /// To apply a quoted modification, set this parameter to <c>true</c>.
        /// </para>
        /// </summary>
        public bool? AcceptModificationTerms
        {
            get { return this._acceptModificationTerms; }
            set { this._acceptModificationTerms = value; }
        }

        // Check to see if AcceptModificationTerms property is set
        internal bool IsSetAcceptModificationTerms()
        {
            return this._acceptModificationTerms.HasValue; 
        }
        ...
        /// <para>
        /// The ID of the quote that describes the modification you want to apply. Generate a
        /// quote by using <c>CreateCapacityReservationDateChangeQuote</c>. The quote must be
        /// in the <c>active</c> state, and each quote can be used only once.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The new start date for the Capacity Reservation, in the ISO8601 format in the UTC
        ...
        /// the quote ID in <c>QuoteId</c> with <c>AcceptModificationTerms</c> set to <c>true</c>.
        /// </para>
        /// </summary>
