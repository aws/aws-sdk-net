...
{
    /// <summary>
    /// Container for the parameters to the DescribeIpamPolicies operation.
    ...
    /// </para>
    /// </summary>
    public partial class DescribeIpamPoliciesRequest : AmazonEC2Request
    {
        private bool? _dryRun;
        private List<Filter> _filters = AWSConfigs.InitializeCollections ? new List<Filter>() : null;
        private List<string> _ipamPolicyIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property IpamPolicyIds. 
        /// <para>
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> IpamPolicyIds
        {
            get { return this._ipamPolicyIds; }
            set { this._ipamPolicyIds = value; }
        }

        // Check to see if IpamPolicyIds property is set
        internal bool IsSetIpamPolicyIds()
        {
            return this._ipamPolicyIds != null && (this._ipamPolicyIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
