...
{
    /// <summary>
    /// Describes the source for a health check path in a request. The source defines the
    /// subnet and security group where a health check elastic network interface (ENI) is
    /// created to originate health check traffic.
    /// </summary>
    public partial class HealthCheckPathSourceRequestObject
    {
