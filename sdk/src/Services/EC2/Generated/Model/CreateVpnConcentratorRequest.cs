...
{
    /// <summary>
    /// Container for the parameters to the CreateVpnConcentrator operation.
    /// Creates a VPN concentrator that aggregates multiple VPN connections to a transit gateway.
    /// </summary>
    public partial class CreateVpnConcentratorRequest : AmazonEC2Request
    {
        private bool? _dryRun;
        private List<TagSpecification> _tagSpecifications = AWSConfigs.InitializeCollections ? new List<TagSpecification>() : null;
        private string _transitGatewayId;
        private VpnConcentratorType _type;
        ...
        public VpnConcentratorType Type
        {
