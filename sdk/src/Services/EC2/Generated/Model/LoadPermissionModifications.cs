...
namespace Amazon.EC2.Model
{
    ...
    {
        private List<LoadPermissionRequest> _add = AWSConfigs.InitializeCollections ? new List<LoadPermissionRequest>() : null;
        private List<LoadPermissionRequest> _remove = AWSConfigs.InitializeCollections ? new List<LoadPermissionRequest>() : null;
