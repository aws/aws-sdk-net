...
{
    /// <summary>
    /// Describes a destination for a health check path in a request. Destinations can be
    /// in a different Availability Zone than the source (cross-AZ) or in a Local Zone (AZ
    /// to Local Zone), enabling remote health validation of your application.
    /// </summary>
    public partial class HealthCheckPathDestinationRequestObject
    {
