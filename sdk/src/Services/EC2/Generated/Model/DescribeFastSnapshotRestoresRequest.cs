...
{
    /// <summary>
    /// Container for the parameters to the DescribeFastSnapshotRestores operation.
    ...
    public partial class DescribeFastSnapshotRestoresRequest : AmazonEC2Request
    {
        ...
        ///  </li> <li> 
        /// <para>
        ///  <code>owner-id</code>: The ID of the account that enabled fast snapshot restore on
        /// the snapshot.
        /// </para>
        ///  </li> <li> 
        /// <para>
