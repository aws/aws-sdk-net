...
{
    /// <summary>
    /// This is the response object from the AssociateApplicationStatusCheck operation.
    /// </summary>
    public partial class AssociateApplicationStatusCheckResponse : AmazonWebServiceResponse
    {
        private List<SuccessfulAssociationResponseObject> _successfulResults = AWSConfigs.InitializeCollections ? new List<SuccessfulAssociationResponseObject>() : null;
        private List<UnsuccessfulAssociationResponseObject> _unsuccessfulResults = AWSConfigs.InitializeCollections ? new List<UnsuccessfulAssociationResponseObject>() : null;
        ...
        /// </summary>
        public List<SuccessfulAssociationResponseObject> SuccessfulResults
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<UnsuccessfulAssociationResponseObject> UnsuccessfulResults
        {
