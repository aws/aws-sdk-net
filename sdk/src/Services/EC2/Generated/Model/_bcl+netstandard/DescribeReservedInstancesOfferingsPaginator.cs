...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeReservedInstancesOfferingsPaginator : IPaginator<DescribeReservedInstancesOfferingsResponse>, IDescribeReservedInstancesOfferingsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeReservedInstancesOfferingsResponse> IPaginator<DescribeReservedInstancesOfferingsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
