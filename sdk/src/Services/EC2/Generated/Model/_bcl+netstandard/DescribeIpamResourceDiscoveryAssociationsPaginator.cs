...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeIpamResourceDiscoveryAssociationsPaginator : IPaginator<DescribeIpamResourceDiscoveryAssociationsResponse>, IDescribeIpamResourceDiscoveryAssociationsPaginator
    {
        ...
        public IPaginatedEnumerable<IpamResourceDiscoveryAssociation> IpamResourceDiscoveryAssociations => 
            new PaginatedResultKeyResponse<DescribeIpamResourceDiscoveryAssociationsResponse, IpamResourceDiscoveryAssociation>(this, (i) => i.IpamResourceDiscoveryAssociations);
        ...
        async IAsyncEnumerable<DescribeIpamResourceDiscoveryAssociationsResponse> IPaginator<DescribeIpamResourceDiscoveryAssociationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
