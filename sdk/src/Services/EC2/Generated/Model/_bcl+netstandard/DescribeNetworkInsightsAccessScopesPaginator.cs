...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeNetworkInsightsAccessScopesPaginator : IPaginator<DescribeNetworkInsightsAccessScopesResponse>, IDescribeNetworkInsightsAccessScopesPaginator
    {
        ...
        public IPaginatedEnumerable<NetworkInsightsAccessScope> NetworkInsightsAccessScopes => 
            new PaginatedResultKeyResponse<DescribeNetworkInsightsAccessScopesResponse, NetworkInsightsAccessScope>(this, (i) => i.NetworkInsightsAccessScopes);
        ...
        async IAsyncEnumerable<DescribeNetworkInsightsAccessScopesResponse> IPaginator<DescribeNetworkInsightsAccessScopesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
