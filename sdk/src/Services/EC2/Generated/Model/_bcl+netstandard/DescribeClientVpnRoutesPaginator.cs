...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeClientVpnRoutesPaginator : IPaginator<DescribeClientVpnRoutesResponse>, IDescribeClientVpnRoutesPaginator
    {
        ...
        public IPaginatedEnumerable<ClientVpnRoute> Routes => 
            new PaginatedResultKeyResponse<DescribeClientVpnRoutesResponse, ClientVpnRoute>(this, (i) => i.Routes ?? new List<ClientVpnRoute>());
        ...
        async IAsyncEnumerable<DescribeClientVpnRoutesResponse> IPaginator<DescribeClientVpnRoutesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
