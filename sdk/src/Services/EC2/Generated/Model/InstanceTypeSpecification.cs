...
{
    /// <summary>
    /// Describes the instance type compatibility rules for an AMI, including lists of supported
    /// and unsupported instance type patterns.
    /// </summary>
    public partial class InstanceTypeSpecification
    {
        private List<InstanceTypeItem> _supportedInstanceTypes = AWSConfigs.InitializeCollections ? new List<InstanceTypeItem>() : null;
        private List<InstanceTypeItem> _unsupportedInstanceTypes = AWSConfigs.InitializeCollections ? new List<InstanceTypeItem>() : null;
        ...
        /// </summary>
        public List<InstanceTypeItem> SupportedInstanceTypes
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<InstanceTypeItem> UnsupportedInstanceTypes
        {
