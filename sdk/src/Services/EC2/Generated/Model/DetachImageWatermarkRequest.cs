...
{
    /// <summary>
    /// Container for the parameters to the DetachImageWatermark operation.
    ...
    /// </para>
    /// </summary>
    public partial class DetachImageWatermarkRequest : AmazonEC2Request
    {
        ...
        /// <para>
        /// The watermark key to remove, in <c>accountId:watermarkName</c> format (for example,
        /// <c>123456789012:approvedAmi</c>).
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
