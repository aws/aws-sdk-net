...
namespace Amazon.EC2.Model
{
    ...
    public partial class PacketHeaderStatementRequest
    {
        ...
        private List<string> _destinationPorts = new List<string>();
        private List<string> _destinationPrefixLists = new List<string>();
        private List<string> _protocols = new List<string>();
        private List<string> _sourceAddresses = new List<string>();
        private List<string> _sourcePorts = new List<string>();
        private List<string> _sourcePrefixLists = new List<string>();
        ...
        {
            return this._destinationPrefixLists != null && this._destinationPrefixLists.Count > 0; 
        }
        ...
        {
            return this._sourcePrefixLists != null && this._sourcePrefixLists.Count > 0; 
        }
