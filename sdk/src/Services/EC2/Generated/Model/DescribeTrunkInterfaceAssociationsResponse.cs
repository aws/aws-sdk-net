...
namespace Amazon.EC2.Model
{
    ...
    {
        private List<TrunkInterfaceAssociation> _interfaceAssociations = new List<TrunkInterfaceAssociation>();
        ...
        {
            return this._interfaceAssociations != null && this._interfaceAssociations.Count > 0; 
        }
