...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class BlockDeviceMappingResponseUnmarshaller : IXmlUnmarshaller<BlockDeviceMappingResponse, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public BlockDeviceMappingResponse Unmarshall(XmlUnmarshallerContext context)
        {
            BlockDeviceMappingResponse unmarshalledObject = new BlockDeviceMappingResponse();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = EbsBlockDeviceResponseUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BlockDeviceMappingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
