    ...
    public class DescribeSnapshotAttributeRequestMarshaller : IMarshaller<IRequest, DescribeSnapshotAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeSnapshotAttributeRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeSnapshotAttributeRequestMarshaller _instance = new DescribeSnapshotAttributeRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSnapshotAttributeRequestMarshaller Instance
        {
            get
            {
                return _instance;
