...
{
    /// <summary>
    /// Response Unmarshaller for IpamDiscoveredRoute Object
    /// </summary>  
    public class IpamDiscoveredRouteUnmarshaller : IXmlUnmarshaller<IpamDiscoveredRoute, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IpamDiscoveredRoute Unmarshall(XmlUnmarshallerContext context)
        {
            IpamDiscoveredRoute unmarshalledObject = new IpamDiscoveredRoute();
        ...
        private static IpamDiscoveredRouteUnmarshaller _instance = new IpamDiscoveredRouteUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IpamDiscoveredRouteUnmarshaller Instance
        {
            get
            {
                return _instance;
