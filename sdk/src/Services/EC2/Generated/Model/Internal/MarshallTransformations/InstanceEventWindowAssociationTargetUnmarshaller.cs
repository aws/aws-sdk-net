...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceEventWindowAssociationTargetUnmarshaller : IXmlUnmarshaller<InstanceEventWindowAssociationTarget, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InstanceEventWindowAssociationTarget Unmarshall(XmlUnmarshallerContext context)
        {
            InstanceEventWindowAssociationTarget unmarshalledObject = new InstanceEventWindowAssociationTarget();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceEventWindowAssociationTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
