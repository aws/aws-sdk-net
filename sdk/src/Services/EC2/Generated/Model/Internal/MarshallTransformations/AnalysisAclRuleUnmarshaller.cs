...
{
    /// <summary>
    /// Response Unmarshaller for AnalysisAclRule Object
    /// </summary>  
    public class AnalysisAclRuleUnmarshaller : IUnmarshaller<AnalysisAclRule, XmlUnmarshallerContext>, IUnmarshaller<AnalysisAclRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public AnalysisAclRule Unmarshall(XmlUnmarshallerContext context)
        {
            AnalysisAclRule unmarshalledObject = new AnalysisAclRule();
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AnalysisAclRule Unmarshall(JsonUnmarshallerContext context)
        {
            return null;
        }


        private static AnalysisAclRuleUnmarshaller _instance = new AnalysisAclRuleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AnalysisAclRuleUnmarshaller Instance
        {
            get
            {
                return _instance;
