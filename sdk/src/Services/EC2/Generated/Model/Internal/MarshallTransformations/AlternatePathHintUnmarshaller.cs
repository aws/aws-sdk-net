...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class AlternatePathHintUnmarshaller : IXmlUnmarshaller<AlternatePathHint, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AlternatePathHint Unmarshall(XmlUnmarshallerContext context)
        {
            AlternatePathHint unmarshalledObject = new AlternatePathHint();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AlternatePathHintUnmarshaller Instance
        {
            get
            {
                return _instance;
