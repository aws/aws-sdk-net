...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class CapacityReservationSpecificationResponseUnmarshaller : IXmlUnmarshaller<CapacityReservationSpecificationResponse, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CapacityReservationSpecificationResponse Unmarshall(XmlUnmarshallerContext context)
        {
            CapacityReservationSpecificationResponse unmarshalledObject = new CapacityReservationSpecificationResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CapacityReservationSpecificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
