...
{
    /// <summary>
    /// DescribeSecurityGroupRules Request Marshaller
    /// </summary>       
    public class DescribeSecurityGroupRulesRequestMarshaller : IMarshaller<IRequest, DescribeSecurityGroupRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSecurityGroupRulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSecurityGroupRulesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeSecurityGroupRules");
            ...
            return request;
                    ...
                    private static DescribeSecurityGroupRulesRequestMarshaller _instance = new DescribeSecurityGroupRulesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSecurityGroupRulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
