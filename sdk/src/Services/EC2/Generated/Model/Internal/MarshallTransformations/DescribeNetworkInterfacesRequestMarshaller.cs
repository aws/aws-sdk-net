...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeNetworkInterfacesRequestMarshaller : IMarshaller<IRequest, DescribeNetworkInterfacesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeNetworkInterfacesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeNetworkInterfacesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeNetworkInterfaces");
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetNetworkInterfaceIds())
                {
                    if (publicRequest.NetworkInterfaceIds.Count == 0)
                        request.Parameters.Add("NetworkInterfaceId", "");
                    else
                    {
                         int publicRequestlistValueIndex = 1;
                         foreach(var publicRequestlistValue in publicRequest.NetworkInterfaceIds)
                         {
                             request.Parameters.Add("NetworkInterfaceId" + "." + publicRequestlistValueIndex, StringUtils.FromString(publicRequestlistValue));
                             publicRequestlistValueIndex++;
                         }
                    }
                }
            ...
            return request;
                    ...
                    private static DescribeNetworkInterfacesRequestMarshaller _instance = new DescribeNetworkInterfacesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNetworkInterfacesRequestMarshaller Instance
        {
            get
            {
                return _instance;
