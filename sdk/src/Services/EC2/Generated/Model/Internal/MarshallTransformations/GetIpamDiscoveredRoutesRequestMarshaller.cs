...
{
    /// <summary>
    /// GetIpamDiscoveredRoutes Request Marshaller
    /// </summary>       
    public class GetIpamDiscoveredRoutesRequestMarshaller : IMarshaller<IRequest, GetIpamDiscoveredRoutesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIpamDiscoveredRoutesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIpamDiscoveredRoutesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetIpamDiscoveredRoutes");
            ...
            return request;
                    ...
                    private static GetIpamDiscoveredRoutesRequestMarshaller _instance = new GetIpamDiscoveredRoutesRequestMarshaller();        

        internal static GetIpamDiscoveredRoutesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIpamDiscoveredRoutesRequestMarshaller Instance
        {
            get
            {
                return _instance;
