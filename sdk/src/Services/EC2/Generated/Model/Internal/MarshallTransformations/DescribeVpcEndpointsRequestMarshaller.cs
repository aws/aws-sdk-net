...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeVpcEndpointsRequestMarshaller : IMarshaller<IRequest, DescribeVpcEndpointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVpcEndpointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVpcEndpointsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeVpcEndpoints");
            ...
            return request;
                    ...
                    private static DescribeVpcEndpointsRequestMarshaller _instance = new DescribeVpcEndpointsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVpcEndpointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
