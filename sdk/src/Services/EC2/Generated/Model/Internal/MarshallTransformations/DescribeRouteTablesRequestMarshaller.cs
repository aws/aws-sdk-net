...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeRouteTablesRequestMarshaller : IMarshaller<IRequest, DescribeRouteTablesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeRouteTablesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeRouteTablesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeRouteTablesRequestMarshaller _instance = new DescribeRouteTablesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRouteTablesRequestMarshaller Instance
        {
            get
            {
                return _instance;
