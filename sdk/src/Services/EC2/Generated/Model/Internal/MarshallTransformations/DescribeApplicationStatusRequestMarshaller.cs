...
{
    /// <summary>
    /// DescribeApplicationStatus Request Marshaller
    /// </summary>       
    public class DescribeApplicationStatusRequestMarshaller : IMarshaller<IRequest, DescribeApplicationStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeApplicationStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeApplicationStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeApplicationStatus");
            ...
            return request;
                    ...
                    private static DescribeApplicationStatusRequestMarshaller _instance = new DescribeApplicationStatusRequestMarshaller();        

        internal static DescribeApplicationStatusRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeApplicationStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
