...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeVpcClassicLinkRequestMarshaller : IMarshaller<IRequest, DescribeVpcClassicLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVpcClassicLinkRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVpcClassicLinkRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeVpcClassicLink");
            ...
            return request;
                    ...
                    private static DescribeVpcClassicLinkRequestMarshaller _instance = new DescribeVpcClassicLinkRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVpcClassicLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
