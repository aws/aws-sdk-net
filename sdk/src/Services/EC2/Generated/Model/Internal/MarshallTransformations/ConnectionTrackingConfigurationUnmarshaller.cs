...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ConnectionTrackingConfigurationUnmarshaller : IXmlUnmarshaller<ConnectionTrackingConfiguration, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ConnectionTrackingConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            ConnectionTrackingConfiguration unmarshalledObject = new ConnectionTrackingConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConnectionTrackingConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
