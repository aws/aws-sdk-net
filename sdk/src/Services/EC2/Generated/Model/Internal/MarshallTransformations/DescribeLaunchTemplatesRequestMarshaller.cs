...
{
    /// <summary>
    /// DescribeLaunchTemplates Request Marshaller
    /// </summary>       
    public class DescribeLaunchTemplatesRequestMarshaller : IMarshaller<IRequest, DescribeLaunchTemplatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeLaunchTemplatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeLaunchTemplatesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeLaunchTemplates");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLaunchTemplatesRequestMarshaller Instance
        {
            get
            {
                return _instance;
