...
{
    /// <summary>
    /// GetIpamPoolCidrs Request Marshaller
    /// </summary>       
    public class GetIpamPoolCidrsRequestMarshaller : IMarshaller<IRequest, GetIpamPoolCidrsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIpamPoolCidrsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIpamPoolCidrsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetIpamPoolCidrs");
            ...
            return request;
                    ...
                    private static GetIpamPoolCidrsRequestMarshaller _instance = new GetIpamPoolCidrsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIpamPoolCidrsRequestMarshaller Instance
        {
            get
            {
                return _instance;
