...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ReservationValueUnmarshaller : IXmlUnmarshaller<ReservationValue, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ReservationValue Unmarshall(XmlUnmarshallerContext context)
        {
            ReservationValue unmarshalledObject = new ReservationValue();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.RemainingTotalValue = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("remainingUpfrontValue", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.RemainingUpfrontValue = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReservationValueUnmarshaller Instance
        {
            get
            {
                return _instance;
