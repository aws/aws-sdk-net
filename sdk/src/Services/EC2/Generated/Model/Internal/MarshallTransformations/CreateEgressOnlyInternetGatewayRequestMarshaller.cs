...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateEgressOnlyInternetGatewayRequestMarshaller : IMarshaller<IRequest, CreateEgressOnlyInternetGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEgressOnlyInternetGatewayRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEgressOnlyInternetGatewayRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateEgressOnlyInternetGateway");
