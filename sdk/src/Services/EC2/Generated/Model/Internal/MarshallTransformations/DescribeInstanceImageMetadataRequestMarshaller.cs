...
{
    /// <summary>
    /// DescribeInstanceImageMetadata Request Marshaller
    /// </summary>       
    public class DescribeInstanceImageMetadataRequestMarshaller : IMarshaller<IRequest, DescribeInstanceImageMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInstanceImageMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeInstanceImageMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeInstanceImageMetadata");
            ...
            return request;
                    ...
                    private static DescribeInstanceImageMetadataRequestMarshaller _instance = new DescribeInstanceImageMetadataRequestMarshaller();        

        internal static DescribeInstanceImageMetadataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceImageMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
