...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeHostsRequestMarshaller : IMarshaller<IRequest, DescribeHostsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeHostsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeHostsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeHosts");
            ...
            if(publicRequest != null)
            {
                ...
                {
                    if (publicRequest.HostIds.Count == 0)
                        request.Parameters.Add("HostId", "");
                    else
                    {
                         int publicRequestlistValueIndex = 1;
            ...
            return request;
                    ...
                    private static DescribeHostsRequestMarshaller _instance = new DescribeHostsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeHostsRequestMarshaller Instance
        {
            get
            {
                return _instance;
