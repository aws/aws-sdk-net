...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class Ipv6CidrBlockUnmarshaller : IXmlUnmarshaller<Ipv6CidrBlock, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public Ipv6CidrBlock Unmarshall(XmlUnmarshallerContext context)
        {
            Ipv6CidrBlock unmarshalledObject = new Ipv6CidrBlock();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static Ipv6CidrBlockUnmarshaller Instance
        {
            get
            {
                return _instance;
