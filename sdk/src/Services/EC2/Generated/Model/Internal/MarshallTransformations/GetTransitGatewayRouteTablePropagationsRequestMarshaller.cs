...
{
    /// <summary>
    /// GetTransitGatewayRouteTablePropagations Request Marshaller
    /// </summary>       
    public class GetTransitGatewayRouteTablePropagationsRequestMarshaller : IMarshaller<IRequest, GetTransitGatewayRouteTablePropagationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTransitGatewayRouteTablePropagationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTransitGatewayRouteTablePropagationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetTransitGatewayRouteTablePropagations");
            ...
            return request;
                    ...
                    private static GetTransitGatewayRouteTablePropagationsRequestMarshaller _instance = new GetTransitGatewayRouteTablePropagationsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTransitGatewayRouteTablePropagationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
