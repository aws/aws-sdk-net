...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class SuccessfulQueuedPurchaseDeletionUnmarshaller : IXmlUnmarshaller<SuccessfulQueuedPurchaseDeletion, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SuccessfulQueuedPurchaseDeletion Unmarshall(XmlUnmarshallerContext context)
        {
            SuccessfulQueuedPurchaseDeletion unmarshalledObject = new SuccessfulQueuedPurchaseDeletion();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SuccessfulQueuedPurchaseDeletionUnmarshaller Instance
        {
            get
            {
                return _instance;
