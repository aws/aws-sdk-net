...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PurchaseHostReservationRequestMarshaller : IMarshaller<IRequest, PurchaseHostReservationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PurchaseHostReservationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PurchaseHostReservationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "PurchaseHostReservation");
            ...
            if(publicRequest != null)
            {
                ...
                {
                    request.Parameters.Add("CurrencyCode", StringUtils.FromString(publicRequest.CurrencyCode));
                }
                ...
                {
                    request.Parameters.Add("LimitPrice", StringUtils.FromString(publicRequest.LimitPrice));
                }
            ...
            return request;
                    ...
                    private static PurchaseHostReservationRequestMarshaller _instance = new PurchaseHostReservationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PurchaseHostReservationRequestMarshaller Instance
        {
            get
            {
                return _instance;
