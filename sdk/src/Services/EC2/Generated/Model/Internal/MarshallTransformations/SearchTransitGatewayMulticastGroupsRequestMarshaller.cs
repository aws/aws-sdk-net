...
{
    /// <summary>
    /// SearchTransitGatewayMulticastGroups Request Marshaller
    /// </summary>       
    public class SearchTransitGatewayMulticastGroupsRequestMarshaller : IMarshaller<IRequest, SearchTransitGatewayMulticastGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchTransitGatewayMulticastGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchTransitGatewayMulticastGroupsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "SearchTransitGatewayMulticastGroups");
            ...
            return request;
                    ...
                    private static SearchTransitGatewayMulticastGroupsRequestMarshaller _instance = new SearchTransitGatewayMulticastGroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTransitGatewayMulticastGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
