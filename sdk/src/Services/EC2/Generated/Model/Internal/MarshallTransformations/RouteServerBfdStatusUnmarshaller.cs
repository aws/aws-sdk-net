...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class RouteServerBfdStatusUnmarshaller : IXmlUnmarshaller<RouteServerBfdStatus, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RouteServerBfdStatus Unmarshall(XmlUnmarshallerContext context)
        {
            RouteServerBfdStatus unmarshalledObject = new RouteServerBfdStatus();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RouteServerBfdStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
