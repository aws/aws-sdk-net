...
{
    /// <summary>
    /// ModifyTransitGatewayPolicyTableEntry Request Marshaller
    /// </summary>       
    public class ModifyTransitGatewayPolicyTableEntryRequestMarshaller : IMarshaller<IRequest, ModifyTransitGatewayPolicyTableEntryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyTransitGatewayPolicyTableEntryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyTransitGatewayPolicyTableEntryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ModifyTransitGatewayPolicyTableEntry");
            ...
            return request;
                    ...
                    private static ModifyTransitGatewayPolicyTableEntryRequestMarshaller _instance = new ModifyTransitGatewayPolicyTableEntryRequestMarshaller();        

        internal static ModifyTransitGatewayPolicyTableEntryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyTransitGatewayPolicyTableEntryRequestMarshaller Instance
        {
            get
            {
                return _instance;
