    ...
    public class DisassociateAddressRequestMarshaller : IMarshaller<IRequest, DisassociateAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DisassociateAddressRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DisassociateAddressRequestMarshaller _instance = new DisassociateAddressRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAddressRequestMarshaller Instance
        {
            get
            {
                return _instance;
