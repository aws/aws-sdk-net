    ...
    public class DescribeNetworkInterfaceAttributeRequestMarshaller : IMarshaller<IRequest, DescribeNetworkInterfaceAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeNetworkInterfaceAttributeRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeNetworkInterfaceAttributeRequestMarshaller _instance = new DescribeNetworkInterfaceAttributeRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNetworkInterfaceAttributeRequestMarshaller Instance
        {
            get
            {
                return _instance;
