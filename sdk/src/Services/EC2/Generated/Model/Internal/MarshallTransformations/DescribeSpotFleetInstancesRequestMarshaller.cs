...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeSpotFleetInstancesRequestMarshaller : IMarshaller<IRequest, DescribeSpotFleetInstancesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSpotFleetInstancesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSpotFleetInstancesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeSpotFleetInstances");
