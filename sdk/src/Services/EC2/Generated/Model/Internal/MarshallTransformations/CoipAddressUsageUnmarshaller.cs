...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class CoipAddressUsageUnmarshaller : IXmlUnmarshaller<CoipAddressUsage, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CoipAddressUsage Unmarshall(XmlUnmarshallerContext context)
        {
            CoipAddressUsage unmarshalledObject = new CoipAddressUsage();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.CoIp = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CoipAddressUsageUnmarshaller Instance
        {
            get
            {
                return _instance;
