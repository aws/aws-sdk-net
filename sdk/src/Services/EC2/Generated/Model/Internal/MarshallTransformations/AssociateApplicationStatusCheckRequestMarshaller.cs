...
{
    /// <summary>
    /// AssociateApplicationStatusCheck Request Marshaller
    /// </summary>       
    public class AssociateApplicationStatusCheckRequestMarshaller : IMarshaller<IRequest, AssociateApplicationStatusCheckRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateApplicationStatusCheckRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateApplicationStatusCheckRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "AssociateApplicationStatusCheck");
            ...
            return request;
                    ...
                    private static AssociateApplicationStatusCheckRequestMarshaller _instance = new AssociateApplicationStatusCheckRequestMarshaller();        

        internal static AssociateApplicationStatusCheckRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateApplicationStatusCheckRequestMarshaller Instance
        {
            get
            {
                return _instance;
