...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class RuleOptionUnmarshaller : IXmlUnmarshaller<RuleOption, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RuleOption Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        if (unmarshalledObject.Settings == null)
                        {
                            unmarshalledObject.Settings = new List<string>();
                        }
                        var item = unmarshaller.Unmarshall(context);
                        unmarshalledObject.Settings.Add(item);
                        continue;
                    }
                }
