...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class LaunchTemplateElasticInferenceAcceleratorResponseUnmarshaller : IXmlUnmarshaller<LaunchTemplateElasticInferenceAcceleratorResponse, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public LaunchTemplateElasticInferenceAcceleratorResponse Unmarshall(XmlUnmarshallerContext context)
        {
            LaunchTemplateElasticInferenceAcceleratorResponse unmarshalledObject = new LaunchTemplateElasticInferenceAcceleratorResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LaunchTemplateElasticInferenceAcceleratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
