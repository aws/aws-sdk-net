...
{
    /// <summary>
    /// StartDeclarativePoliciesReport Request Marshaller
    /// </summary>       
    public class StartDeclarativePoliciesReportRequestMarshaller : IMarshaller<IRequest, StartDeclarativePoliciesReportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDeclarativePoliciesReportRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDeclarativePoliciesReportRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "StartDeclarativePoliciesReport");
        ...
        internal static StartDeclarativePoliciesReportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDeclarativePoliciesReportRequestMarshaller Instance
        {
            get
            {
                return _instance;
