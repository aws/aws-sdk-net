...
{
    /// <summary>
    /// TerminateClientVpnConnections Request Marshaller
    /// </summary>       
    public class TerminateClientVpnConnectionsRequestMarshaller : IMarshaller<IRequest, TerminateClientVpnConnectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TerminateClientVpnConnectionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TerminateClientVpnConnectionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "TerminateClientVpnConnections");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateClientVpnConnectionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
