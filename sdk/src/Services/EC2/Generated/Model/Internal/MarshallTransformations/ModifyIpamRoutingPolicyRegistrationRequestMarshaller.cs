...
{
    /// <summary>
    /// ModifyIpamRoutingPolicyRegistration Request Marshaller
    /// </summary>       
    public class ModifyIpamRoutingPolicyRegistrationRequestMarshaller : IMarshaller<IRequest, ModifyIpamRoutingPolicyRegistrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyIpamRoutingPolicyRegistrationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyIpamRoutingPolicyRegistrationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ModifyIpamRoutingPolicyRegistration");
            ...
            return request;
                    ...
                    private static ModifyIpamRoutingPolicyRegistrationRequestMarshaller _instance = new ModifyIpamRoutingPolicyRegistrationRequestMarshaller();        

        internal static ModifyIpamRoutingPolicyRegistrationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyIpamRoutingPolicyRegistrationRequestMarshaller Instance
        {
            get
            {
                return _instance;
