...
{
    /// <summary>
    /// DescribeLockedSnapshots Request Marshaller
    /// </summary>       
    public class DescribeLockedSnapshotsRequestMarshaller : IMarshaller<IRequest, DescribeLockedSnapshotsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeLockedSnapshotsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeLockedSnapshotsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeLockedSnapshots");
            ...
            return request;
                    ...
                    private static DescribeLockedSnapshotsRequestMarshaller _instance = new DescribeLockedSnapshotsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLockedSnapshotsRequestMarshaller Instance
        {
            get
            {
                return _instance;
