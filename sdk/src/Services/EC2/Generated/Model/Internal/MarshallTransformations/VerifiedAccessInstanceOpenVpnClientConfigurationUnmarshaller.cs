...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VerifiedAccessInstanceOpenVpnClientConfigurationUnmarshaller : IXmlUnmarshaller<VerifiedAccessInstanceOpenVpnClientConfiguration, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VerifiedAccessInstanceOpenVpnClientConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            VerifiedAccessInstanceOpenVpnClientConfiguration unmarshalledObject = new VerifiedAccessInstanceOpenVpnClientConfiguration();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = VerifiedAccessInstanceOpenVpnClientConfigurationRouteUnmarshaller.Instance;
                        if (unmarshalledObject.Routes == null)
                        {
                            unmarshalledObject.Routes = new List<VerifiedAccessInstanceOpenVpnClientConfigurationRoute>();
                        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifiedAccessInstanceOpenVpnClientConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
