...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateRouteTableRequestMarshaller : IMarshaller<IRequest, AssociateRouteTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateRouteTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateRouteTableRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateRouteTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
