...
{
    /// <summary>
    /// GetTransitGatewayPrefixListReferences Request Marshaller
    /// </summary>       
    public class GetTransitGatewayPrefixListReferencesRequestMarshaller : IMarshaller<IRequest, GetTransitGatewayPrefixListReferencesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTransitGatewayPrefixListReferencesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTransitGatewayPrefixListReferencesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetTransitGatewayPrefixListReferences");
            ...
            return request;
                    ...
                    private static GetTransitGatewayPrefixListReferencesRequestMarshaller _instance = new GetTransitGatewayPrefixListReferencesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTransitGatewayPrefixListReferencesRequestMarshaller Instance
        {
            get
            {
                return _instance;
