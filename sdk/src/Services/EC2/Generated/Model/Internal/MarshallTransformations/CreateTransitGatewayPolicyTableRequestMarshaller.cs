...
{
    /// <summary>
    /// CreateTransitGatewayPolicyTable Request Marshaller
    /// </summary>       
    public class CreateTransitGatewayPolicyTableRequestMarshaller : IMarshaller<IRequest, CreateTransitGatewayPolicyTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTransitGatewayPolicyTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTransitGatewayPolicyTableRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateTransitGatewayPolicyTable");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransitGatewayPolicyTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
