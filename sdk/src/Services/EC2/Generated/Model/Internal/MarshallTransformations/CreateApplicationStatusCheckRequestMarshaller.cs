...
{
    /// <summary>
    /// CreateApplicationStatusCheck Request Marshaller
    /// </summary>       
    public class CreateApplicationStatusCheckRequestMarshaller : IMarshaller<IRequest, CreateApplicationStatusCheckRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateApplicationStatusCheckRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateApplicationStatusCheckRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateApplicationStatusCheck");
            ...
            return request;
                    ...
                    private static CreateApplicationStatusCheckRequestMarshaller _instance = new CreateApplicationStatusCheckRequestMarshaller();        

        internal static CreateApplicationStatusCheckRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApplicationStatusCheckRequestMarshaller Instance
        {
            get
            {
                return _instance;
