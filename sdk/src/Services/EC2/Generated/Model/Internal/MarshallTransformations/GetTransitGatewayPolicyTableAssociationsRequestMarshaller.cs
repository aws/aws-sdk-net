...
{
    /// <summary>
    /// GetTransitGatewayPolicyTableAssociations Request Marshaller
    /// </summary>       
    public class GetTransitGatewayPolicyTableAssociationsRequestMarshaller : IMarshaller<IRequest, GetTransitGatewayPolicyTableAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTransitGatewayPolicyTableAssociationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTransitGatewayPolicyTableAssociationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetTransitGatewayPolicyTableAssociations");
            ...
            return request;
                    ...
                    private static GetTransitGatewayPolicyTableAssociationsRequestMarshaller _instance = new GetTransitGatewayPolicyTableAssociationsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTransitGatewayPolicyTableAssociationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
