...
{
    /// <summary>
    /// CreateIpam Request Marshaller
    /// </summary>       
    public class CreateIpamRequestMarshaller : IMarshaller<IRequest, CreateIpamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateIpamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateIpamRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateIpam");
            ...
            if(publicRequest != null)
            {
                ...
                {
                    if (publicRequest.OperatingRegions.Count == 0)
                        request.Parameters.Add("OperatingRegion", "");
                    else
                    {
                         int publicRequestlistValueIndex = 1;
                         foreach(var publicRequestlistValue in publicRequest.OperatingRegions)
                         {
                            if(publicRequestlistValue.IsSetRegionName())
                            {
                                request.Parameters.Add("OperatingRegion" + "." + publicRequestlistValueIndex + "." + "RegionName", StringUtils.FromString(publicRequestlistValue.RegionName));
                            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIpamRequestMarshaller Instance
        {
            get
            {
                return _instance;
