...
{
    /// <summary>
    /// DescribeInstanceSqlHaHistoryStates Request Marshaller
    /// </summary>       
    public class DescribeInstanceSqlHaHistoryStatesRequestMarshaller : IMarshaller<IRequest, DescribeInstanceSqlHaHistoryStatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInstanceSqlHaHistoryStatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeInstanceSqlHaHistoryStatesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeInstanceSqlHaHistoryStates");
            ...
            return request;
                    ...
                    private static DescribeInstanceSqlHaHistoryStatesRequestMarshaller _instance = new DescribeInstanceSqlHaHistoryStatesRequestMarshaller();        

        internal static DescribeInstanceSqlHaHistoryStatesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceSqlHaHistoryStatesRequestMarshaller Instance
        {
            get
            {
                return _instance;
