    ...
    public class DetachNetworkInterfaceRequestMarshaller : IMarshaller<IRequest, DetachNetworkInterfaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DetachNetworkInterfaceRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DetachNetworkInterfaceRequestMarshaller _instance = new DetachNetworkInterfaceRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachNetworkInterfaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
