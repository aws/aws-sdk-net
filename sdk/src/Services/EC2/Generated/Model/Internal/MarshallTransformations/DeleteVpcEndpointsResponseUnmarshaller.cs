...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVpcEndpointsResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVpcEndpointsResponse response = new DeleteVpcEndpointsResponse();
        ...
        private static DeleteVpcEndpointsResponseUnmarshaller _instance = new DeleteVpcEndpointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVpcEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
