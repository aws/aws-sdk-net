    ...
    public class DescribeInstanceAttributeRequestMarshaller : IMarshaller<IRequest, DescribeInstanceAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeInstanceAttributeRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeInstanceAttributeRequestMarshaller _instance = new DescribeInstanceAttributeRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceAttributeRequestMarshaller Instance
        {
            get
            {
                return _instance;
