...
{
    /// <summary>
    /// DisassociateTransitGatewayPolicyTable Request Marshaller
    /// </summary>       
    public class DisassociateTransitGatewayPolicyTableRequestMarshaller : IMarshaller<IRequest, DisassociateTransitGatewayPolicyTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateTransitGatewayPolicyTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateTransitGatewayPolicyTableRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DisassociateTransitGatewayPolicyTable");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateTransitGatewayPolicyTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
