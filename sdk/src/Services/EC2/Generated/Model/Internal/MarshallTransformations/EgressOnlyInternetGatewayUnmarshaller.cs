...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class EgressOnlyInternetGatewayUnmarshaller : IXmlUnmarshaller<EgressOnlyInternetGateway, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public EgressOnlyInternetGateway Unmarshall(XmlUnmarshallerContext context)
        {
            EgressOnlyInternetGateway unmarshalledObject = new EgressOnlyInternetGateway();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("attachmentSet/item", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Attachments = new List<InternetGatewayAttachment>();
                        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EgressOnlyInternetGatewayUnmarshaller Instance
        {
            get
            {
                return _instance;
