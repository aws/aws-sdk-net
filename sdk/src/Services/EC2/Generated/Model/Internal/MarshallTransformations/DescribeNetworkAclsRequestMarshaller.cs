...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeNetworkAclsRequestMarshaller : IMarshaller<IRequest, DescribeNetworkAclsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeNetworkAclsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeNetworkAclsRequest publicRequest)
        {
            ...
            if(publicRequest != null)
            {
                ...
                {
                    if (publicRequest.NetworkAclIds.Count == 0)
                        request.Parameters.Add("NetworkAclId", "");
                    else
                    {
                         int publicRequestlistValueIndex = 1;
                         foreach(var publicRequestlistValue in publicRequest.NetworkAclIds)
                         {
            ...
            return request;
                    ...
                    private static DescribeNetworkAclsRequestMarshaller _instance = new DescribeNetworkAclsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNetworkAclsRequestMarshaller Instance
        {
            get
            {
                return _instance;
