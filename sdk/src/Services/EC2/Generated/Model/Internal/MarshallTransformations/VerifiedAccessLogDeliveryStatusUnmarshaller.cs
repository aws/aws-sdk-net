...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VerifiedAccessLogDeliveryStatusUnmarshaller : IXmlUnmarshaller<VerifiedAccessLogDeliveryStatus, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VerifiedAccessLogDeliveryStatus Unmarshall(XmlUnmarshallerContext context)
        {
            VerifiedAccessLogDeliveryStatus unmarshalledObject = new VerifiedAccessLogDeliveryStatus();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifiedAccessLogDeliveryStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
