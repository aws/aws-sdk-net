...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class StaleSecurityGroupUnmarshaller : IXmlUnmarshaller<StaleSecurityGroup, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public StaleSecurityGroup Unmarshall(XmlUnmarshallerContext context)
        {
            StaleSecurityGroup unmarshalledObject = new StaleSecurityGroup();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StaleSecurityGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
