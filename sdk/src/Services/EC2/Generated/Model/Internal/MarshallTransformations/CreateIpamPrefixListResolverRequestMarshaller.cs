...
{
    /// <summary>
    /// CreateIpamPrefixListResolver Request Marshaller
    /// </summary>       
    public class CreateIpamPrefixListResolverRequestMarshaller : IMarshaller<IRequest, CreateIpamPrefixListResolverRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateIpamPrefixListResolverRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateIpamPrefixListResolverRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateIpamPrefixListResolver");
            ...
            return request;
                    ...
                    private static CreateIpamPrefixListResolverRequestMarshaller _instance = new CreateIpamPrefixListResolverRequestMarshaller();        

        internal static CreateIpamPrefixListResolverRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIpamPrefixListResolverRequestMarshaller Instance
        {
            get
            {
                return _instance;
