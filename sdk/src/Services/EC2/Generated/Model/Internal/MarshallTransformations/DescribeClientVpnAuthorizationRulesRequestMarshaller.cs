...
{
    /// <summary>
    /// DescribeClientVpnAuthorizationRules Request Marshaller
    /// </summary>       
    public class DescribeClientVpnAuthorizationRulesRequestMarshaller : IMarshaller<IRequest, DescribeClientVpnAuthorizationRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeClientVpnAuthorizationRulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeClientVpnAuthorizationRulesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeClientVpnAuthorizationRules");
            ...
            return request;
                    ...
                    private static DescribeClientVpnAuthorizationRulesRequestMarshaller _instance = new DescribeClientVpnAuthorizationRulesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClientVpnAuthorizationRulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
