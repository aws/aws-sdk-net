    ...
    public class CancelConversionTaskRequestMarshaller : IMarshaller<IRequest, CancelConversionTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CancelConversionTaskRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CancelConversionTaskRequestMarshaller _instance = new CancelConversionTaskRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelConversionTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
