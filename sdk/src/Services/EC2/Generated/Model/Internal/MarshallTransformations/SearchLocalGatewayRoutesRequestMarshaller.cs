...
{
    /// <summary>
    /// SearchLocalGatewayRoutes Request Marshaller
    /// </summary>       
    public class SearchLocalGatewayRoutesRequestMarshaller : IMarshaller<IRequest, SearchLocalGatewayRoutesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchLocalGatewayRoutesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchLocalGatewayRoutesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "SearchLocalGatewayRoutes");
            ...
            return request;
                    ...
                    private static SearchLocalGatewayRoutesRequestMarshaller _instance = new SearchLocalGatewayRoutesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchLocalGatewayRoutesRequestMarshaller Instance
        {
            get
            {
                return _instance;
