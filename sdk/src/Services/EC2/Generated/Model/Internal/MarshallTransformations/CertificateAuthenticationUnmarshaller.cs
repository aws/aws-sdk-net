...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class CertificateAuthenticationUnmarshaller : IXmlUnmarshaller<CertificateAuthentication, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CertificateAuthentication Unmarshall(XmlUnmarshallerContext context)
        {
            CertificateAuthentication unmarshalledObject = new CertificateAuthentication();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CertificateAuthenticationUnmarshaller Instance
        {
            get
            {
                return _instance;
