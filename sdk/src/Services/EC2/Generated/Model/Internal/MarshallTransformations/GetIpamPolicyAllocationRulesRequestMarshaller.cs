...
{
    /// <summary>
    /// GetIpamPolicyAllocationRules Request Marshaller
    /// </summary>       
    public class GetIpamPolicyAllocationRulesRequestMarshaller : IMarshaller<IRequest, GetIpamPolicyAllocationRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIpamPolicyAllocationRulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIpamPolicyAllocationRulesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetIpamPolicyAllocationRules");
        ...
        internal static GetIpamPolicyAllocationRulesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIpamPolicyAllocationRulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
