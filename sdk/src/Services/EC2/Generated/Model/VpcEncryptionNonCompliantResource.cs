...
namespace Amazon.EC2.Model
{
    ...
    /// </para>
    /// </summary>
    public partial class VpcEncryptionNonCompliantResource
    {
        ...
        /// <summary>
        /// Gets and sets the property IsExcludable. 
        /// <para>
        ...
        {
            get { return this._isExcludable.GetValueOrDefault(); }
            set { this._isExcludable = value; }
        }

        // Check to see if IsExcludable property is set
        internal bool IsSetIsExcludable()
        {
            return this._isExcludable.HasValue; 
        }
