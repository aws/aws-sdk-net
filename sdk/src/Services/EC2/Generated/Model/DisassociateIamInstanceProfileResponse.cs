...
namespace Amazon.EC2.Model
{
    ...
    /// </summary>
    public partial class DisassociateIamInstanceProfileResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._iamInstanceProfileAssociation; }
            set { this._iamInstanceProfileAssociation = value; }
        }

        // Check to see if IamInstanceProfileAssociation property is set
        internal bool IsSetIamInstanceProfileAssociation()
        {
            return this._iamInstanceProfileAssociation != null;
        }
