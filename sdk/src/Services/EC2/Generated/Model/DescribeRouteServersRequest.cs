...
{
    /// <summary>
    /// Container for the parameters to the DescribeRouteServers operation.
    ...
    /// </para>
    /// </summary>
    public partial class DescribeRouteServersRequest : AmazonEC2Request
    {
        private bool? _dryRun;
        private List<Filter> _filters = AWSConfigs.InitializeCollections ? new List<Filter>() : null;
        private int? _maxResults;
        private string _nextToken;
        private List<string> _routeServerIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property RouteServerIds. 
        /// <para>
        /// The IDs of the route servers to describe.
        /// </para>
        /// </summary>
        public List<string> RouteServerIds
        {
            get { return this._routeServerIds; }
            set { this._routeServerIds = value; }
        }

        // Check to see if RouteServerIds property is set
        internal bool IsSetRouteServerIds()
        {
            return this._routeServerIds != null && (this._routeServerIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
