...
{
    /// <summary>
    /// Container for the parameters to the AssociateApplicationStatusCheck operation.
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class AssociateApplicationStatusCheckRequest : AmazonEC2Request
    {
        ...
        /// to associate the application status check with. Each tag is a key-value pair. When
        /// you associate tags, the application status check automatically monitors all instances
        /// that have the specified tags.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
