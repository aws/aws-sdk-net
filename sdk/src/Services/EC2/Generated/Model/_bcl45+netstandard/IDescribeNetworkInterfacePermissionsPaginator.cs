...
namespace Amazon.EC2.Model
{
    ...
    public interface IDescribeNetworkInterfacePermissionsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<DescribeNetworkInterfacePermissionsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the NetworkInterfacePermissions
        /// </summary>
        IPaginatedEnumerable<NetworkInterfacePermission> NetworkInterfacePermissions { get; }
    }
}