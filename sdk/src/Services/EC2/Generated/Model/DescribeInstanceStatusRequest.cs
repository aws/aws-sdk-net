...
namespace Amazon.EC2.Model
{
    ...
    public partial class DescribeInstanceStatusRequest : AmazonEC2Request
    {
        ...
        /// <para>
        /// The maximum number of items to return for this request. To retrieve the next page
        /// of items, make another request with the token returned in the output. This value can
        /// be between 5 and 1000. You cannot specify this parameter and the instance IDs parameter
        /// in the same call. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Query-Requests.html#api-pagination">Pagination</a>.
        /// </para>
        /// </summary>
