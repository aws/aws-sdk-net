...
{
    /// <summary>
    /// This is the response object from the DescribeIpamPolicies operation.
    /// </summary>
    public partial class DescribeIpamPoliciesResponse : AmazonWebServiceResponse
    {
        private List<IpamPolicy> _ipamPolicies = AWSConfigs.InitializeCollections ? new List<IpamPolicy>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property IpamPolicies. 
        /// <para>
        ...
        /// </para>
        /// </summary>
        public List<IpamPolicy> IpamPolicies
        {
            get { return this._ipamPolicies; }
            set { this._ipamPolicies = value; }
        }

        // Check to see if IpamPolicies property is set
        internal bool IsSetIpamPolicies()
        {
            return this._ipamPolicies != null && (this._ipamPolicies.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
