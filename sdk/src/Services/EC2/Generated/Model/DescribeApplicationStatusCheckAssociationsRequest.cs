...
{
    /// <summary>
    /// Container for the parameters to the DescribeApplicationStatusCheckAssociations operation.
    ...
    ///  </note>
    /// </summary>
    public partial class DescribeApplicationStatusCheckAssociationsRequest : AmazonEC2Request
    {
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <c>association-type</c> – The type of association. Valid values: <c>tag</c> and <c>instance-id</c>.
        /// </para>
        ///  </li> </ul>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
