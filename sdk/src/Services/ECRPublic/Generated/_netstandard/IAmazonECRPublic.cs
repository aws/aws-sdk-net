...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonECRPublicConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonECRPublicConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonECRPublicConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonECRPublicConfig to create AmazonECRPublicClient");
            }

            return awsCredentials == null ? 
                    new AmazonECRPublicClient(serviceClientConfig) :
                    new AmazonECRPublicClient(awsCredentials, serviceClientConfig);
        }
