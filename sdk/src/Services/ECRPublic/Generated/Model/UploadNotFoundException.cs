...
namespace Amazon.ECRPublic.Model
{
    ...
    [Serializable]
    #endif
    public partial class UploadNotFoundException : AmazonECRPublicException
    {
        ...
        public UploadNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UploadNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
