...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAuthorizationTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAuthorizationTokenResponseUnmarshaller _instance = new GetAuthorizationTokenResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAuthorizationTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
