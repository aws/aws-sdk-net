...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositoryCatalogDataUnmarshaller : IUnmarshaller<RepositoryCatalogData, XmlUnmarshallerContext>, IUnmarshaller<RepositoryCatalogData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RepositoryCatalogData IUnmarshaller<RepositoryCatalogData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RepositoryCatalogData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("aboutText", targetDepth))
                {
                    ...
                    unmarshalledObject.AboutText = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.OperatingSystems = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("usageText", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UsageText = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
