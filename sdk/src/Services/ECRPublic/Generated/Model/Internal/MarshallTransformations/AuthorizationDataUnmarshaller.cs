...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthorizationDataUnmarshaller : IUnmarshaller<AuthorizationData, XmlUnmarshallerContext>, IUnmarshaller<AuthorizationData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AuthorizationData IUnmarshaller<AuthorizationData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AuthorizationData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("authorizationToken", targetDepth))
                {
                    ...
                    unmarshalledObject.AuthorizationToken = unmarshaller.Unmarshall(context);
                    continue;
                }
