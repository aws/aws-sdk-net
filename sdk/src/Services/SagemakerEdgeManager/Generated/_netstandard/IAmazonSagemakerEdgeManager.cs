...
namespace Amazon.SagemakerEdgeManager
{
    ...
    public partial interface IAmazonSagemakerEdgeManager : IAmazonService, IDisposable
    {
        ...
        Task<GetDeviceRegistrationResponse> GetDeviceRegistrationAsync(GetDeviceRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SendHeartbeatResponse> SendHeartbeatAsync(SendHeartbeatRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSagemakerEdgeManagerConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSagemakerEdgeManagerConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSagemakerEdgeManagerConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSagemakerEdgeManagerConfig to create AmazonSagemakerEdgeManagerClient");
            }

            return awsCredentials == null ? 
                    new AmazonSagemakerEdgeManagerClient(serviceClientConfig) :
                    new AmazonSagemakerEdgeManagerClient(awsCredentials, serviceClientConfig);
        }
