...
namespace Amazon.SagemakerEdgeManager.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonSagemakerEdgeManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSagemakerEdgeManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SagemakerEdgeManager.
        /// </summary>
        public AmazonSagemakerEdgeManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSagemakerEdgeManagerAuthSchemeParameters
            {
    ...
    public class AmazonSagemakerEdgeManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonSagemakerEdgeManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSagemakerEdgeManagerAuthSchemeParameters authParameters)
        {
