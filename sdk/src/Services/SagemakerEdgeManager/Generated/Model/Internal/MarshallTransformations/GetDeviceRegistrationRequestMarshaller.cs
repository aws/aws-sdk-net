...
{
    /// <summary>
    /// GetDeviceRegistration Request Marshaller
    /// </summary>       
    public class GetDeviceRegistrationRequestMarshaller : IMarshaller<IRequest, GetDeviceRegistrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDeviceRegistrationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDeviceRegistrationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/GetDeviceRegistration";
#if !NETFRAMEWORK
        ...
        private static GetDeviceRegistrationRequestMarshaller _instance = new GetDeviceRegistrationRequestMarshaller();        

        internal static GetDeviceRegistrationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeviceRegistrationRequestMarshaller Instance
        {
            get
            {
                return _instance;
