...
{
    /// <summary>
    /// This is the response object from the ListWatchlists operation.
    /// </summary>
    public partial class ListWatchlistsResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property WatchlistSummaries. 
        /// <para>
        /// A list that contains details about each watchlist in the Amazon Web Services account.
        /// 
        /// </para>
        /// </summary>
        public List<WatchlistSummary> WatchlistSummaries
        {
            get { return this._watchlistSummaries; }
            set { this._watchlistSummaries = value; }
        }
