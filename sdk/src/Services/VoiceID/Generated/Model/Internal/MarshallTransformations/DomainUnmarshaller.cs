...
namespace Amazon.VoiceID.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DomainUnmarshaller : IJsonUnmarshaller<Domain, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Domain Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ServerSideEncryptionUpdateDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("WatchlistDetails", targetDepth, ref reader))
                {
