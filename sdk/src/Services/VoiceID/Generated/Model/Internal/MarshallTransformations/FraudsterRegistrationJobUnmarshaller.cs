...
namespace Amazon.VoiceID.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FraudsterRegistrationJobUnmarshaller : IJsonUnmarshaller<FraudsterRegistrationJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FraudsterRegistrationJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FailureDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("JobProgress", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("RegistrationConfig", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.RegistrationConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
