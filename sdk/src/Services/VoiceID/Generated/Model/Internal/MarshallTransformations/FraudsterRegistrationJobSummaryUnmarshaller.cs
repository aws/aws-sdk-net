...
namespace Amazon.VoiceID.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FraudsterRegistrationJobSummaryUnmarshaller : IUnmarshaller<FraudsterRegistrationJobSummary, XmlUnmarshallerContext>, IUnmarshaller<FraudsterRegistrationJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FraudsterRegistrationJobSummary IUnmarshaller<FraudsterRegistrationJobSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FraudsterRegistrationJobSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
