...
namespace Amazon.ManagedGrafana
{
    ...
    public partial class AmazonManagedGrafanaConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("grafana", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "grafana";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "grafana";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-08-18";
