...
namespace Amazon.ManagedGrafana
{
    ...
    public partial class AmazonManagedGrafanaClient : AmazonServiceClient, IAmazonManagedGrafana
    {
        ...
        /// 
        /// </summary>
        public AmazonManagedGrafanaClient() : base(new AmazonManagedGrafanaConfig()) { }
        ...
        public AmazonManagedGrafanaClient(RegionEndpoint region) : base(new AmazonManagedGrafanaConfig { RegionEndpoint = region }) { }
        ...
        public AmazonManagedGrafanaClient(AmazonManagedGrafanaConfig config) : base(config) { }
