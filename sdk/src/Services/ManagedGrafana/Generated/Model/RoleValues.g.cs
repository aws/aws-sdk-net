...
namespace Amazon.ManagedGrafana.Model
{
    ...
    public partial class RoleValues
    {
        ...
        public List<string> Admin { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Admin property is set.
        /// </summary>
        internal bool IsSetAdmin() => this.Admin != null && (this.Admin.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Sensitive = true)]
        public List<string> Editor { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Editor property is set.
        /// </summary>
        internal bool IsSetEditor() => this.Editor != null && (this.Editor.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
