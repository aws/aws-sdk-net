...
{
    /// <summary>
    /// Container for the parameters to the ListWorkspaceServiceAccounts operation. Returns
    /// a list of service accounts for a workspace. <para> Service accounts are only available
    /// for workspaces that are compatible with Grafana version 9 and above. </para>
    /// </summary>
