...
namespace Amazon.ManagedGrafana.Model
{
    ...
    public partial class NetworkAccessConfiguration
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<string> VpceIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the VpceIds property is set.
        /// </summary>
        internal bool IsSetVpceIds() => this.VpceIds != null && (this.VpceIds.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
