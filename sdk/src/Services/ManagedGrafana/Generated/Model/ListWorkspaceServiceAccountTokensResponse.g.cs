...
namespace Amazon.ManagedGrafana.Model
{
    ...
    public partial class ListWorkspaceServiceAccountTokensResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<ServiceAccountTokenSummary> ServiceAccountTokens { get; set; } = AWSConfigs.InitializeCollections ? new List<ServiceAccountTokenSummary>() : null;

        /// <summary>
        /// Checks to see if the ServiceAccountTokens property is set.
        /// </summary>
        internal bool IsSetServiceAccountTokens() => this.ServiceAccountTokens != null && (this.ServiceAccountTokens.Count > 0 || !AWSConfigs.InitializeCollections);
