...
namespace Amazon.ManagedGrafana.Model
{
    ...
    public partial class ListWorkspaceServiceAccountsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ServiceAccountSummary> ServiceAccounts { get; set; } = AWSConfigs.InitializeCollections ? new List<ServiceAccountSummary>() : null;

        /// <summary>
        /// Checks to see if the ServiceAccounts property is set.
        /// </summary>
        internal bool IsSetServiceAccounts() => this.ServiceAccounts != null && (this.ServiceAccounts.Count > 0 || !AWSConfigs.InitializeCollections);
