...
{
    /// <summary>
    /// Container for the parameters to the DeleteWorkspaceServiceAccount operation. Deletes
    /// a workspace service account from the workspace. <para> This will delete any tokens
    /// created for the service account, as well. If the tokens are currently in use, the
    /// will fail to authenticate / authorize after they are deleted. </para> <para> Service
    /// accounts are only available for workspaces that are compatible with Grafana version
    /// 9 and above. </para>
    /// </summary>
