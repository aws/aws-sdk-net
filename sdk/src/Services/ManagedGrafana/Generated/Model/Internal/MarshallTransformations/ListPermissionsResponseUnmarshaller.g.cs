...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListPermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PermissionEntry, PermissionEntryUnmarshaller>(PermissionEntryUnmarshaller.Instance);
        ...
        private static ListPermissionsResponseUnmarshaller _instance = new ListPermissionsResponseUnmarshaller();

        internal static ListPermissionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPermissionsResponseUnmarshaller Instance => _instance;
    }
}
