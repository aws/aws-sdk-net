...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeWorkspaceConfigurationRequestMarshaller : IMarshaller<IRequest, DescribeWorkspaceConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeWorkspaceConfigurationRequestMarshaller _instance = new();

        internal static DescribeWorkspaceConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeWorkspaceConfigurationRequestMarshaller Instance => _instance;
    }
}
