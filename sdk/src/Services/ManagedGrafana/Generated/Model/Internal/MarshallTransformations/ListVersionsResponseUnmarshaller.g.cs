...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListVersionsResponse();
            ...
            {
                if (context.TestExpression("grafanaVersions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.GrafanaVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListVersionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVersionsResponseUnmarshaller Instance => _instance;
    }
}
