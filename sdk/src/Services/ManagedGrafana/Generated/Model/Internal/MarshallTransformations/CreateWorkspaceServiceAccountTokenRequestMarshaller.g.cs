...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateWorkspaceServiceAccountTokenRequestMarshaller : IMarshaller<IRequest, CreateWorkspaceServiceAccountTokenRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateWorkspaceServiceAccountTokenRequestMarshaller _instance = new();

        internal static CreateWorkspaceServiceAccountTokenRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateWorkspaceServiceAccountTokenRequestMarshaller Instance => _instance;
    }
}
