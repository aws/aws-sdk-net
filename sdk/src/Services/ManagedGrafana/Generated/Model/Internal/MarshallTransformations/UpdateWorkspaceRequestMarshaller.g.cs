...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateWorkspaceRequestMarshaller : IMarshaller<IRequest, UpdateWorkspaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateWorkspaceRequestMarshaller _instance = new();

        internal static UpdateWorkspaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateWorkspaceRequestMarshaller Instance => _instance;
    }
}
