...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuthenticationSummaryUnmarshaller : IJsonUnmarshaller<AuthenticationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AuthenticationSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AuthenticationSummaryUnmarshaller Instance => _instance;
    }
}
