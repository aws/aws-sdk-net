...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssertionAttributesUnmarshaller : IJsonUnmarshaller<AssertionAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssertionAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("login", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Login = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
