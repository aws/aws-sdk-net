...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateInstructionUnmarshaller : IJsonUnmarshaller<UpdateInstruction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UpdateInstruction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
