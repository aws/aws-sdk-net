...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthenticationDescriptionUnmarshaller : IUnmarshaller<AuthenticationDescription, XmlUnmarshallerContext>, IUnmarshaller<AuthenticationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AuthenticationDescription IUnmarshaller<AuthenticationDescription, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AuthenticationDescription Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("awsSso", targetDepth))
                {
                    ...
                    unmarshalledObject.AwsSso = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("saml", targetDepth))
                {
                    ...
                    unmarshalledObject.Saml = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
