...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateWorkspaceApiKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateWorkspaceApiKeyResponse();
        ...
        internal static CreateWorkspaceApiKeyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateWorkspaceApiKeyResponseUnmarshaller Instance => _instance;
    }
}
