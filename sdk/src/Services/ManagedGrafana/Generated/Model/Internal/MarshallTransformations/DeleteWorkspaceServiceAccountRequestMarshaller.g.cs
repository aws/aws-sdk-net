...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteWorkspaceServiceAccountRequestMarshaller : IMarshaller<IRequest, DeleteWorkspaceServiceAccountRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteWorkspaceServiceAccountRequestMarshaller _instance = new();

        internal static DeleteWorkspaceServiceAccountRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteWorkspaceServiceAccountRequestMarshaller Instance => _instance;
    }
}
