...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWorkspaceServiceAccountTokensResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListWorkspaceServiceAccountTokensResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("serviceAccountTokens", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ServiceAccountTokens = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListWorkspaceServiceAccountTokensResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWorkspaceServiceAccountTokensResponseUnmarshaller Instance => _instance;
    }
}
