...
{
    /// <summary>
    /// Response Unmarshaller for AssociateLicense operation
    /// </summary>  
    public class AssociateLicenseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateLicenseResponse response = new AssociateLicenseResponse();
        ...
        private static AssociateLicenseResponseUnmarshaller _instance = new AssociateLicenseResponseUnmarshaller();        

        internal static AssociateLicenseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateLicenseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
