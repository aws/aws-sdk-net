...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IdpMetadataUnmarshaller : IJsonUnmarshaller<IdpMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IdpMetadata();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IdpMetadataUnmarshaller Instance => _instance;
    }
}
