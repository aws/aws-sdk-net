...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SamlConfigurationUnmarshaller : IJsonUnmarshaller<SamlConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SamlConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SamlConfigurationUnmarshaller Instance => _instance;
    }
}
