...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RoleValuesUnmarshaller : IJsonUnmarshaller<RoleValues, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RoleValues();
            ...
            {
                if (context.TestExpression("admin", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("editor", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static RoleValuesUnmarshaller Instance => _instance;
    }
}
