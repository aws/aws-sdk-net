...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateInstructionUnmarshaller : IJsonUnmarshaller<UpdateInstruction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateInstruction();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UpdateInstructionUnmarshaller Instance => _instance;
    }
}
