...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListVersionsRequestMarshaller : IMarshaller<IRequest, ListVersionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly ListVersionsRequestMarshaller _instance = new();

        internal static ListVersionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVersionsRequestMarshaller Instance => _instance;
    }
}
