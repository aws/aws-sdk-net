...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeWorkspaceRequestMarshaller : IMarshaller<IRequest, DescribeWorkspaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeWorkspaceRequestMarshaller _instance = new();

        internal static DescribeWorkspaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeWorkspaceRequestMarshaller Instance => _instance;
    }
}
