...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateWorkspaceAuthenticationRequestMarshaller : IMarshaller<IRequest, UpdateWorkspaceAuthenticationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateWorkspaceAuthenticationRequestMarshaller _instance = new();

        internal static UpdateWorkspaceAuthenticationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateWorkspaceAuthenticationRequestMarshaller Instance => _instance;
    }
}
