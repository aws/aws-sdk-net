...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuthenticationDescriptionUnmarshaller : IJsonUnmarshaller<AuthenticationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AuthenticationDescription();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AuthenticationDescriptionUnmarshaller Instance => _instance;
    }
}
