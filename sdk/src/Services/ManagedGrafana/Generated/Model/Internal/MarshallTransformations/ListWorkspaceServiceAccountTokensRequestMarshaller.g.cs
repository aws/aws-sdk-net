...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWorkspaceServiceAccountTokensRequestMarshaller : IMarshaller<IRequest, ListWorkspaceServiceAccountTokensRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListWorkspaceServiceAccountTokensRequestMarshaller _instance = new();

        internal static ListWorkspaceServiceAccountTokensRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWorkspaceServiceAccountTokensRequestMarshaller Instance => _instance;
    }
}
