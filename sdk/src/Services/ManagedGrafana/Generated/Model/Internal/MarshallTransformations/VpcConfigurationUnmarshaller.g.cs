...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VpcConfigurationUnmarshaller : IJsonUnmarshaller<VpcConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VpcConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static VpcConfigurationUnmarshaller Instance => _instance;
    }
}
