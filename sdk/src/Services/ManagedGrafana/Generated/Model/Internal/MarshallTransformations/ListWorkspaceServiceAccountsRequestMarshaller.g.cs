...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWorkspaceServiceAccountsRequestMarshaller : IMarshaller<IRequest, ListWorkspaceServiceAccountsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListWorkspaceServiceAccountsRequestMarshaller _instance = new();

        internal static ListWorkspaceServiceAccountsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWorkspaceServiceAccountsRequestMarshaller Instance => _instance;
    }
}
