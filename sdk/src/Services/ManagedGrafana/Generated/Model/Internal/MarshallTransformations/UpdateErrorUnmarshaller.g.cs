...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateErrorUnmarshaller : IJsonUnmarshaller<UpdateError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateError();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UpdateErrorUnmarshaller Instance => _instance;
    }
}
