...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWorkspaceServiceAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListWorkspaceServiceAccountsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("serviceAccounts", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceAccountSummary, ServiceAccountSummaryUnmarshaller>(ServiceAccountSummaryUnmarshaller.Instance);
                    unmarshalledObject.ServiceAccounts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListWorkspaceServiceAccountsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWorkspaceServiceAccountsResponseUnmarshaller Instance => _instance;
    }
}
