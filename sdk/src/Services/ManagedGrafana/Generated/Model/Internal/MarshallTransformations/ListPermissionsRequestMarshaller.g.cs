...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListPermissionsRequestMarshaller : IMarshaller<IRequest, ListPermissionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListPermissionsRequestMarshaller _instance = new();

        internal static ListPermissionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPermissionsRequestMarshaller Instance => _instance;
    }
}
