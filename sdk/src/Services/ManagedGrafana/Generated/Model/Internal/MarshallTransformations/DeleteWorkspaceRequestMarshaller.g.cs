...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteWorkspaceRequestMarshaller : IMarshaller<IRequest, DeleteWorkspaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteWorkspaceRequestMarshaller _instance = new();

        internal static DeleteWorkspaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteWorkspaceRequestMarshaller Instance => _instance;
    }
}
