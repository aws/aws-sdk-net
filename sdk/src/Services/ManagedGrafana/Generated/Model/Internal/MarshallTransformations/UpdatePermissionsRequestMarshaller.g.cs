...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdatePermissionsRequestMarshaller : IMarshaller<IRequest, UpdatePermissionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdatePermissionsRequestMarshaller _instance = new();

        internal static UpdatePermissionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePermissionsRequestMarshaller Instance => _instance;
    }
}
