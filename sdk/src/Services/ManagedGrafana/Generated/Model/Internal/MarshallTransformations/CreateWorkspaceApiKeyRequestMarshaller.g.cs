...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateWorkspaceApiKeyRequestMarshaller : IMarshaller<IRequest, CreateWorkspaceApiKeyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateWorkspaceApiKeyRequestMarshaller _instance = new();

        internal static CreateWorkspaceApiKeyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateWorkspaceApiKeyRequestMarshaller Instance => _instance;
    }
}
