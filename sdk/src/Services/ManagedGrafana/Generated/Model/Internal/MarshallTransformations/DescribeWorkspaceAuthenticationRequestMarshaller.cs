...
{
    /// <summary>
    /// DescribeWorkspaceAuthentication Request Marshaller
    /// </summary>       
    public class DescribeWorkspaceAuthenticationRequestMarshaller : IMarshaller<IRequest, DescribeWorkspaceAuthenticationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeWorkspaceAuthenticationRequest)input);
        }
        ...
        private static DescribeWorkspaceAuthenticationRequestMarshaller _instance = new DescribeWorkspaceAuthenticationRequestMarshaller();        

        internal static DescribeWorkspaceAuthenticationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkspaceAuthenticationRequestMarshaller Instance
        {
            get
            {
                return _instance;
