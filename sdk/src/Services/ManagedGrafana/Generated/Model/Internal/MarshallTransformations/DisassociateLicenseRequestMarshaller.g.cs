...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateLicenseRequestMarshaller : IMarshaller<IRequest, DisassociateLicenseRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateLicenseRequestMarshaller _instance = new();

        internal static DisassociateLicenseRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateLicenseRequestMarshaller Instance => _instance;
    }
}
