...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssertionAttributesUnmarshaller : IJsonUnmarshaller<AssertionAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AssertionAttributes();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssertionAttributesUnmarshaller Instance => _instance;
    }
}
