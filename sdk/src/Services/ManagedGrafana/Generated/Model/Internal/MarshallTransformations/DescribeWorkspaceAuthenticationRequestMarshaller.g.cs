...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeWorkspaceAuthenticationRequestMarshaller : IMarshaller<IRequest, DescribeWorkspaceAuthenticationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeWorkspaceAuthenticationRequestMarshaller _instance = new();

        internal static DescribeWorkspaceAuthenticationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeWorkspaceAuthenticationRequestMarshaller Instance => _instance;
    }
}
