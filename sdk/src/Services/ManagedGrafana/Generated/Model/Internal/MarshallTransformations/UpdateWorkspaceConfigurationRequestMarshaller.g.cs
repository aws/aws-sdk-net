...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateWorkspaceConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateWorkspaceConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateWorkspaceConfigurationRequestMarshaller _instance = new();

        internal static UpdateWorkspaceConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateWorkspaceConfigurationRequestMarshaller Instance => _instance;
    }
}
