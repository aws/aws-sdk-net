...
namespace Amazon.ManagedGrafana.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SamlAuthenticationUnmarshaller : IJsonUnmarshaller<SamlAuthentication, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SamlAuthentication Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SamlAuthentication();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SamlAuthenticationUnmarshaller Instance => _instance;
    }
}
