...
namespace Amazon.ManagedGrafana.Model
{
    ...
    /// defines the permissions that are used by the API. <important> <para> When you create
    /// the service account token, you will receive a key that is used when calling Grafana
    /// APIs. Do not lose this key, as it will not be retrievable again. </para> <para> If
    /// you do lose the key, you can delete the token and recreate it to receive a new key.
    /// This will disable the initial key. </para> </important> <para> Service accounts are
    /// only available for workspaces that are compatible with Grafana version 9 and above.
    /// </para>
    /// </summary>
