...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteConfigurationTemplateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteConfigurationTemplateResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeleteConfigurationTemplateResponse response)
        {
        ...
        private static DeleteConfigurationTemplateResponseUnmarshaller _instance = new DeleteConfigurationTemplateResponseUnmarshaller();        

        internal static DeleteConfigurationTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConfigurationTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
