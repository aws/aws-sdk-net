...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    public class MaxCountRuleUnmarshaller : IXmlUnmarshaller<MaxCountRule, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public MaxCountRule Unmarshall(XmlUnmarshallerContext context)
        {
            MaxCountRule unmarshalledObject = new MaxCountRule();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MaxCountRuleUnmarshaller Instance
        {
            get
            {
                return _instance;
