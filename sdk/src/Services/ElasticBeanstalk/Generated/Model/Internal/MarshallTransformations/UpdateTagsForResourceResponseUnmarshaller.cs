...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTagsForResource operation
    /// </summary>  
    public class UpdateTagsForResourceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTagsForResourceResponse response = new UpdateTagsForResourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateTagsForResourceResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateTagsForResourceResponse response)
        {
        ...
        private static UpdateTagsForResourceResponseUnmarshaller _instance = new UpdateTagsForResourceResponseUnmarshaller();        

        internal static UpdateTagsForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTagsForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
