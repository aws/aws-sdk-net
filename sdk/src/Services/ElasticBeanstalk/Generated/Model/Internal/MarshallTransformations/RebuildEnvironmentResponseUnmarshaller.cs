...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RebuildEnvironmentResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RebuildEnvironmentResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, RebuildEnvironmentResponse response)
        {
        ...
        private static RebuildEnvironmentResponseUnmarshaller _instance = new RebuildEnvironmentResponseUnmarshaller();        

        internal static RebuildEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebuildEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
