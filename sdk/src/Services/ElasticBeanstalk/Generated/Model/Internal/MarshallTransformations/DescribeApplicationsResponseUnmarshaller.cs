...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeApplicationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Applications/member", targetDepth))
                    {
                        ...
                        {
                            response.Applications = new List<ApplicationDescription>();
                        }
        ...
        private static DescribeApplicationsResponseUnmarshaller _instance = new DescribeApplicationsResponseUnmarshaller();        

        internal static DescribeApplicationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
