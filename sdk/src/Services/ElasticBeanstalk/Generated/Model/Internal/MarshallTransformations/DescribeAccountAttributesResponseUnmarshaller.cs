        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeAccountAttributesResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ResourceQuotas", targetDepth))
                    {
                        var unmarshaller = ResourceQuotasUnmarshaller.Instance;
                        response.ResourceQuotas = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
