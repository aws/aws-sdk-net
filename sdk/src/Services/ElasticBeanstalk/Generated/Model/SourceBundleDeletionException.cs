...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    public partial class SourceBundleDeletionException : AmazonElasticBeanstalkException
    {
        ...
        public SourceBundleDeletionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SourceBundleDeletionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
