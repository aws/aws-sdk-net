...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    public partial class ResourceTypeNotSupportedException : AmazonElasticBeanstalkException
    {
        ...
        public ResourceTypeNotSupportedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceTypeNotSupportedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
