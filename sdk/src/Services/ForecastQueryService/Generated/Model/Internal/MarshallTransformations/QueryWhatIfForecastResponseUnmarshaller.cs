...
{
    /// <summary>
    /// Response Unmarshaller for QueryWhatIfForecast operation
    /// </summary>  
    public class QueryWhatIfForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            QueryWhatIfForecastResponse response = new QueryWhatIfForecastResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ForecastUnmarshaller.Instance;
                    response.Forecast = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonForecastQueryServiceException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static QueryWhatIfForecastResponseUnmarshaller _instance = new QueryWhatIfForecastResponseUnmarshaller();        

        internal static QueryWhatIfForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryWhatIfForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
