...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonForecastQueryServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonForecastQueryServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonForecastQueryServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonForecastQueryServiceConfig to create AmazonForecastQueryServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonForecastQueryServiceClient(serviceClientConfig) :
                    new AmazonForecastQueryServiceClient(awsCredentials, serviceClientConfig);
        }
