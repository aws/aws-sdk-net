...
{
    /// <summary>
    /// Response Unmarshaller for CreateWebACLMigrationStack operation
    /// </summary>  
    public class CreateWebACLMigrationStackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWebACLMigrationStackResponse response = new CreateWebACLMigrationStackResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("S3ObjectUrl", targetDepth))
                {
                    ...
                    response.S3ObjectUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("WAFEntityMigrationException"))
            {
                return new WAFEntityMigrationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static CreateWebACLMigrationStackResponseUnmarshaller _instance = new CreateWebACLMigrationStackResponseUnmarshaller();        

        internal static CreateWebACLMigrationStackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWebACLMigrationStackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
