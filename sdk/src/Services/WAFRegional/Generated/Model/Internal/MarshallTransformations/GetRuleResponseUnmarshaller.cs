...
namespace Amazon.WAFRegional.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static GetRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
