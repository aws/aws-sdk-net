...
{
    /// <summary>
    /// Response Unmarshaller for CreateByteMatchSet operation
    /// </summary>  
    public class CreateByteMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateByteMatchSetResponse response = new CreateByteMatchSetResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ByteMatchSet", targetDepth, ref reader))
                {
                    var unmarshaller = ByteMatchSetUnmarshaller.Instance;
                    response.ByteMatchSet = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateByteMatchSetResponseUnmarshaller _instance = new CreateByteMatchSetResponseUnmarshaller();        

        internal static CreateByteMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateByteMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
