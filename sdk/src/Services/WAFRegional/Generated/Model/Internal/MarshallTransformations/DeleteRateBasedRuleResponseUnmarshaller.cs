...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRateBasedRule operation
    /// </summary>  
    public class DeleteRateBasedRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRateBasedRuleResponse response = new DeleteRateBasedRuleResponse();
        ...
        private static DeleteRateBasedRuleResponseUnmarshaller _instance = new DeleteRateBasedRuleResponseUnmarshaller();        

        internal static DeleteRateBasedRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRateBasedRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
