...
{
    /// <summary>
    /// GetByteMatchSet Request Marshaller
    /// </summary>       
    public class GetByteMatchSetRequestMarshaller : IMarshaller<IRequest, GetByteMatchSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetByteMatchSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetByteMatchSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.GetByteMatchSet";
            ...
            if(publicRequest.IsSetByteMatchSetId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ByteMatchSetId);
            }
