...
{
    /// <summary>
    /// GetChangeTokenStatus Request Marshaller
    /// </summary>       
    public class GetChangeTokenStatusRequestMarshaller : IMarshaller<IRequest, GetChangeTokenStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetChangeTokenStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetChangeTokenStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.GetChangeTokenStatus";
