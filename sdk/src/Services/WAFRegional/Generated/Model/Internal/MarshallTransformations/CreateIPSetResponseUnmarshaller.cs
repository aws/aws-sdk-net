...
{
    /// <summary>
    /// Response Unmarshaller for CreateIPSet operation
    /// </summary>  
    public class CreateIPSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateIPSetResponse response = new CreateIPSetResponse();
        ...
        private static CreateIPSetResponseUnmarshaller _instance = new CreateIPSetResponseUnmarshaller();        

        internal static CreateIPSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIPSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
