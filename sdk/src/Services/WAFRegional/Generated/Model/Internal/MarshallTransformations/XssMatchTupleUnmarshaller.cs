...
namespace Amazon.WAFRegional.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class XssMatchTupleUnmarshaller : IJsonUnmarshaller<XssMatchTuple, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public XssMatchTuple Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
