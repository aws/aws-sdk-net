...
{
    /// <summary>
    /// Response Unmarshaller for XssMatchTuple Object
    /// </summary>  
    public class XssMatchTupleUnmarshaller : IUnmarshaller<XssMatchTuple, XmlUnmarshallerContext>, IUnmarshaller<XssMatchTuple, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        XssMatchTuple IUnmarshaller<XssMatchTuple, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static XssMatchTupleUnmarshaller _instance = new XssMatchTupleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static XssMatchTupleUnmarshaller Instance
        {
            get
            {
                return _instance;
