...
{
    /// <summary>
    /// Response Unmarshaller for GetGeoMatchSet operation
    /// </summary>  
    public class GetGeoMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGeoMatchSetResponse response = new GetGeoMatchSetResponse();
        ...
        private static GetGeoMatchSetResponseUnmarshaller _instance = new GetGeoMatchSetResponseUnmarshaller();        

        internal static GetGeoMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGeoMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
