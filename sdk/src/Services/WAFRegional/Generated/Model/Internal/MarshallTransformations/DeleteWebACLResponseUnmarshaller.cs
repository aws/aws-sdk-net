...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWebACL operation
    /// </summary>  
    public class DeleteWebACLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWebACLResponse response = new DeleteWebACLResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return WAFNonEmptyEntityExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return WAFReferencedItemExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("WAFStaleDataException"))
                {
                    return WAFStaleDataExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("WAFTagOperationException"))
                {
                    return WAFTagOperationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("WAFTagOperationInternalErrorException"))
                {
                    return WAFTagOperationInternalErrorExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static DeleteWebACLResponseUnmarshaller _instance = new DeleteWebACLResponseUnmarshaller();        

        internal static DeleteWebACLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWebACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
