...
{
    /// <summary>
    /// Response Unmarshaller for ListRateBasedRules operation
    /// </summary>  
    public class ListRateBasedRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRateBasedRulesResponse response = new ListRateBasedRulesResponse();
        ...
        private static ListRateBasedRulesResponseUnmarshaller _instance = new ListRateBasedRulesResponseUnmarshaller();        

        internal static ListRateBasedRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRateBasedRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
