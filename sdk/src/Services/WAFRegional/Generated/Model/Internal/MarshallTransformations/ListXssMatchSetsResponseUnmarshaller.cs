    ...
    public class ListXssMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<XssMatchSetSummary, XssMatchSetSummaryUnmarshaller>(XssMatchSetSummaryUnmarshaller.Instance);
                    response.XssMatchSets = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
