...
{
    /// <summary>
    /// Response Unmarshaller for ListXssMatchSets operation
    /// </summary>  
    public class ListXssMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListXssMatchSetsResponse response = new ListXssMatchSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("XssMatchSets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<XssMatchSetSummary, XssMatchSetSummaryUnmarshaller>(XssMatchSetSummaryUnmarshaller.Instance);
                    response.XssMatchSets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListXssMatchSetsResponseUnmarshaller _instance = new ListXssMatchSetsResponseUnmarshaller();        

        internal static ListXssMatchSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListXssMatchSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
