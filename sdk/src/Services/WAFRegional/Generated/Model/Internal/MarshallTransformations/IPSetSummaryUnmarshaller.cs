...
namespace Amazon.WAFRegional.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IPSetSummaryUnmarshaller : IJsonUnmarshaller<IPSetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IPSetSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
