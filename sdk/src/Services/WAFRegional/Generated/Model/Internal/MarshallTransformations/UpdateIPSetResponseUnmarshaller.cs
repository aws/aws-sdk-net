...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIPSet operation
    /// </summary>  
    public class UpdateIPSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIPSetResponse response = new UpdateIPSetResponse();
        ...
        private static UpdateIPSetResponseUnmarshaller _instance = new UpdateIPSetResponseUnmarshaller();        

        internal static UpdateIPSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIPSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
