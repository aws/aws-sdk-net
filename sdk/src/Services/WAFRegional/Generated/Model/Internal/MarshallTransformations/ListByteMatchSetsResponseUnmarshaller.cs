...
{
    /// <summary>
    /// Response Unmarshaller for ListByteMatchSets operation
    /// </summary>  
    public class ListByteMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListByteMatchSetsResponse response = new ListByteMatchSetsResponse();
            ...
            {
                if (context.TestExpression("ByteMatchSets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ByteMatchSetSummary, ByteMatchSetSummaryUnmarshaller>(ByteMatchSetSummaryUnmarshaller.Instance);
                    response.ByteMatchSets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListByteMatchSetsResponseUnmarshaller _instance = new ListByteMatchSetsResponseUnmarshaller();        

        internal static ListByteMatchSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListByteMatchSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
