    ...
    public class ListByteMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ByteMatchSetSummary, ByteMatchSetSummaryUnmarshaller>(ByteMatchSetSummaryUnmarshaller.Instance);
                    response.ByteMatchSets = unmarshaller.Unmarshall(context);
                    continue;
                }
