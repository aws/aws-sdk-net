    ...
    public class ListRegexMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RegexMatchSetSummary, RegexMatchSetSummaryUnmarshaller>(RegexMatchSetSummaryUnmarshaller.Instance);
                    response.RegexMatchSets = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
