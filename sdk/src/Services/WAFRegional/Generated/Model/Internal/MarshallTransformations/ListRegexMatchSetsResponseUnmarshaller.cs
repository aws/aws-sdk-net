...
{
    /// <summary>
    /// Response Unmarshaller for ListRegexMatchSets operation
    /// </summary>  
    public class ListRegexMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRegexMatchSetsResponse response = new ListRegexMatchSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RegexMatchSets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RegexMatchSetSummary, RegexMatchSetSummaryUnmarshaller>(RegexMatchSetSummaryUnmarshaller.Instance);
                    response.RegexMatchSets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRegexMatchSetsResponseUnmarshaller _instance = new ListRegexMatchSetsResponseUnmarshaller();        

        internal static ListRegexMatchSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRegexMatchSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
