    ...
    public class ListWebACLsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WebACLSummary, WebACLSummaryUnmarshaller>(WebACLSummaryUnmarshaller.Instance);
                    response.WebACLs = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
