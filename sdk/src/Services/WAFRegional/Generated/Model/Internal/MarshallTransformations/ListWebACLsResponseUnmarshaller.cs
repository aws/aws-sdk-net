...
{
    /// <summary>
    /// Response Unmarshaller for ListWebACLs operation
    /// </summary>  
    public class ListWebACLsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWebACLsResponse response = new ListWebACLsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WebACLs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<WebACLSummary, WebACLSummaryUnmarshaller>(WebACLSummaryUnmarshaller.Instance);
                    response.WebACLs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListWebACLsResponseUnmarshaller _instance = new ListWebACLsResponseUnmarshaller();        

        internal static ListWebACLsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWebACLsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
