...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSqlInjectionMatchSet operation
    /// </summary>  
    public class UpdateSqlInjectionMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSqlInjectionMatchSetResponse response = new UpdateSqlInjectionMatchSetResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return WAFNonexistentContainerExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateSqlInjectionMatchSetResponseUnmarshaller _instance = new UpdateSqlInjectionMatchSetResponseUnmarshaller();        

        internal static UpdateSqlInjectionMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSqlInjectionMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
