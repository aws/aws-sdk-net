...
{
    /// <summary>
    /// CreateSqlInjectionMatchSet Request Marshaller
    /// </summary>       
    public class CreateSqlInjectionMatchSetRequestMarshaller : IMarshaller<IRequest, CreateSqlInjectionMatchSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSqlInjectionMatchSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSqlInjectionMatchSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.CreateSqlInjectionMatchSet";
