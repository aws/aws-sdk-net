...
{
    /// <summary>
    /// Response Unmarshaller for GetByteMatchSet operation
    /// </summary>  
    public class GetByteMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetByteMatchSetResponse response = new GetByteMatchSetResponse();
        ...
        private static GetByteMatchSetResponseUnmarshaller _instance = new GetByteMatchSetResponseUnmarshaller();        

        internal static GetByteMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetByteMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
