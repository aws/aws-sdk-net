...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGeoMatchSet operation
    /// </summary>  
    public class UpdateGeoMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGeoMatchSetResponse response = new UpdateGeoMatchSetResponse();
        ...
        private static UpdateGeoMatchSetResponseUnmarshaller _instance = new UpdateGeoMatchSetResponseUnmarshaller();        

        internal static UpdateGeoMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGeoMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
