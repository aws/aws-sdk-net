...
namespace Amazon.WAFRegional.Model.Internal.MarshallTransformations
{
    ...
    public class WAFEntityMigrationExceptionUnmarshaller : IErrorResponseUnmarshaller<WAFEntityMigrationException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public WAFEntityMigrationException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        private static WAFEntityMigrationExceptionUnmarshaller _instance = new WAFEntityMigrationExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WAFEntityMigrationExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
