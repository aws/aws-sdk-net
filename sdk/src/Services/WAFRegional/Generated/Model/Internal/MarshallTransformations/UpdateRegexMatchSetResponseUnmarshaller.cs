...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRegexMatchSet operation
    /// </summary>  
    public class UpdateRegexMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRegexMatchSetResponse response = new UpdateRegexMatchSetResponse();
        ...
        private static UpdateRegexMatchSetResponseUnmarshaller _instance = new UpdateRegexMatchSetResponseUnmarshaller();        

        internal static UpdateRegexMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRegexMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
