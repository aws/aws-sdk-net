...
namespace Amazon.WAFRegional.Model
{
    ...
    public partial class WAFUnavailableEntityException : AmazonWAFRegionalException
    {
        ...
        public WAFUnavailableEntityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public WAFUnavailableEntityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
