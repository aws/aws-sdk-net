...
#elif NET6_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 6.0) - Managed Streaming for Kafka Connect. This is the initial SDK release for Amazon Managed Streaming for Apache Kafka Connect (MSK Connect).")]
#else
