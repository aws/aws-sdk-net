...
namespace Amazon.KafkaConnect.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonKafkaConnectAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKafkaConnectAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for KafkaConnect.
        /// </summary>
        public AmazonKafkaConnectAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKafkaConnectAuthSchemeParameters
            {
    ...
    public class AmazonKafkaConnectAuthSchemeResolver : IAuthSchemeResolver<AmazonKafkaConnectAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKafkaConnectAuthSchemeParameters authParameters)
        {
