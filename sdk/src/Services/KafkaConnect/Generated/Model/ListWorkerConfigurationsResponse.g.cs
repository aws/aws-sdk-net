...
namespace Amazon.KafkaConnect.Model
{
    ...
    public partial class ListWorkerConfigurationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<WorkerConfigurationSummary> WorkerConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<WorkerConfigurationSummary>() : null;

        /// <summary>
        /// Checks to see if the WorkerConfigurations property is set.
        /// </summary>
        internal bool IsSetWorkerConfigurations() => this.WorkerConfigurations != null && (this.WorkerConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
