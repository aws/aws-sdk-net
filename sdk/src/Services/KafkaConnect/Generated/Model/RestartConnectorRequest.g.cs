...
{
    /// <summary>
    /// Container for the parameters to the RestartConnector operation. Restarts the specified
    /// connector. By default, this operation restarts the connector and all of its tasks.
    /// This operation is asynchronous and returns a connector operation ARN that you can
    /// pass to <c>DescribeConnectorOperation</c> to track the state of the restart.
    /// </summary>
    public partial class RestartConnectorRequest : AmazonKafkaConnectRequest
    {
        ...
        /// <summary>
        /// Checks to see if the OnlyFailedTasks property is set.
        /// </summary>
        internal bool IsSetOnlyFailedTasks() => this.OnlyFailedTasks.HasValue;
    }
}
