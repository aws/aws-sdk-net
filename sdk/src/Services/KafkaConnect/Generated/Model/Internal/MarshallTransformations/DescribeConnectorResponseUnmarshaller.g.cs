...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeConnectorResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("connectorConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConnectorConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeConnectorResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeConnectorResponseUnmarshaller Instance => _instance;
    }
}
