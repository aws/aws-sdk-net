...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteCustomPluginRequestMarshaller : IMarshaller<IRequest, DeleteCustomPluginRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteCustomPluginRequestMarshaller _instance = new();

        internal static DeleteCustomPluginRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteCustomPluginRequestMarshaller Instance => _instance;
    }
}
