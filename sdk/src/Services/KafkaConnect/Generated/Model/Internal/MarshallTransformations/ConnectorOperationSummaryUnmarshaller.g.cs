...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectorOperationSummaryUnmarshaller : IJsonUnmarshaller<ConnectorOperationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ConnectorOperationSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConnectorOperationSummaryUnmarshaller Instance => _instance;
    }
}
