...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProvisionedCapacityDescriptionUnmarshaller : IJsonUnmarshaller<ProvisionedCapacityDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProvisionedCapacityDescription();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProvisionedCapacityDescriptionUnmarshaller Instance => _instance;
    }
}
