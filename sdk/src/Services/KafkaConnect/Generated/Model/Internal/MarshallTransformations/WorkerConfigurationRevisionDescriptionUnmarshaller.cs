...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkerConfigurationRevisionDescriptionUnmarshaller : IJsonUnmarshaller<WorkerConfigurationRevisionDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkerConfigurationRevisionDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("propertiesFileContent", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PropertiesFileContent = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
