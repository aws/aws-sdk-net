...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteConnectorRequestMarshaller : IMarshaller<IRequest, DeleteConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteConnectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteConnectorRequest publicRequest)
        {
        ...
        private static DeleteConnectorRequestMarshaller _instance = new DeleteConnectorRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConnectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
