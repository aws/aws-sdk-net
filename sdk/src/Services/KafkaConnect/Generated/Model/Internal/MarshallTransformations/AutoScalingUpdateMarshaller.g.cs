...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutoScalingUpdateMarshaller : IRequestMarshaller<AutoScalingUpdate, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(AutoScalingUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetMaxAutoscalingTaskCount())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.MaxAutoscalingTaskCount.Value);
            }
