...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RestartConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestartConnectorResponse response = new RestartConnectorResponse();
        ...
        internal static RestartConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestartConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
