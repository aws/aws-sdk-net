...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutoScalingDescriptionUnmarshaller : IJsonUnmarshaller<AutoScalingDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AutoScalingDescription();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutoScalingDescriptionUnmarshaller Instance => _instance;
    }
}
