...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCustomPluginRequestMarshaller : IMarshaller<IRequest, CreateCustomPluginRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateCustomPluginRequestMarshaller _instance = new();

        internal static CreateCustomPluginRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCustomPluginRequestMarshaller Instance => _instance;
    }
}
