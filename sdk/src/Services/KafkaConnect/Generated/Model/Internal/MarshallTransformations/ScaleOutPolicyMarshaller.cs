...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    public class ScaleOutPolicyMarshaller : IRequestMarshaller<ScaleOutPolicy, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ScaleOutPolicy requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCpuUtilizationPercentage())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.CpuUtilizationPercentage.Value);
            }
