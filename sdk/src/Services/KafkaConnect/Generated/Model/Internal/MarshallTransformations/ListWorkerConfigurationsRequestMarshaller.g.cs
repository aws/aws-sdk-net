...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWorkerConfigurationsRequestMarshaller : IMarshaller<IRequest, ListWorkerConfigurationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListWorkerConfigurationsRequestMarshaller _instance = new();

        internal static ListWorkerConfigurationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWorkerConfigurationsRequestMarshaller Instance => _instance;
    }
}
