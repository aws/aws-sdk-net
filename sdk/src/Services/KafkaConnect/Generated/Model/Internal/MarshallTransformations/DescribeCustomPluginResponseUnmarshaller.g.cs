...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeCustomPluginResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeCustomPluginResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("stateDescription", targetDepth, ref reader))
                {
                    var unmarshaller = StateDescriptionUnmarshaller.Instance;
                    unmarshalledObject.StateDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeCustomPluginResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeCustomPluginResponseUnmarshaller Instance => _instance;
    }
}
