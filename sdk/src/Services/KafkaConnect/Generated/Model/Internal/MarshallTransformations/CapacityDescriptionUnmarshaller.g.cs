...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CapacityDescriptionUnmarshaller : IJsonUnmarshaller<CapacityDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CapacityDescription();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CapacityDescriptionUnmarshaller Instance => _instance;
    }
}
