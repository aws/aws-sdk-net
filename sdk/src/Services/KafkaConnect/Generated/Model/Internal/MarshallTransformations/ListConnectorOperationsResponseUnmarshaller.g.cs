...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListConnectorOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListConnectorOperationsResponse();
            ...
            {
                if (context.TestExpression("connectorOperations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConnectorOperations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListConnectorOperationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListConnectorOperationsResponseUnmarshaller Instance => _instance;
    }
}
