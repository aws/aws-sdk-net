...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeCustomPluginRequestMarshaller : IMarshaller<IRequest, DescribeCustomPluginRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeCustomPluginRequestMarshaller _instance = new();

        internal static DescribeCustomPluginRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeCustomPluginRequestMarshaller Instance => _instance;
    }
}
