...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WorkerLogDeliveryDescriptionUnmarshaller : IJsonUnmarshaller<WorkerLogDeliveryDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WorkerLogDeliveryDescription();
        ...
        /// Gets the singleton.
        /// </summary>
        public static WorkerLogDeliveryDescriptionUnmarshaller Instance => _instance;
    }
}
