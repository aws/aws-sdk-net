...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListCustomPluginsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListCustomPluginsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("customPlugins", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.CustomPlugins = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListCustomPluginsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListCustomPluginsResponseUnmarshaller Instance => _instance;
    }
}
