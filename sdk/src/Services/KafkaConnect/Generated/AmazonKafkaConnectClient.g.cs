...
namespace Amazon.KafkaConnect
{
    ...
    public partial class AmazonKafkaConnectClient : AmazonServiceClient, IAmazonKafkaConnect
    {
        ...
        /// 
        /// </summary>
        public AmazonKafkaConnectClient() : base(new AmazonKafkaConnectConfig()) { }
        ...
        public AmazonKafkaConnectClient(RegionEndpoint region) : base(new AmazonKafkaConnectConfig { RegionEndpoint = region }) { }
        ...
        public AmazonKafkaConnectClient(AmazonKafkaConnectConfig config) : base(config) { }
