...
namespace Amazon.KafkaConnect
{
    ...
    public partial class AmazonKafkaConnectClient : AmazonServiceClient, IAmazonKafkaConnect
    {
        ...
        #region  RestartConnector

        internal virtual RestartConnectorResponse RestartConnector(RestartConnectorRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = RestartConnectorRequestMarshaller.Instance;
            options.ResponseUnmarshaller = RestartConnectorResponseUnmarshaller.Instance;

            return Invoke<RestartConnectorResponse>(request, options);
        }
        ...
        /// restart.
        /// </summary>
        /// <param name="request">Container for the necessary parameters to execute the RestartConnector service method.</param>
        /// <param name="cancellationToken">
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
        /// 
        /// <returns>The response from the RestartConnector service method, as returned by KafkaConnect.</returns>
        /// <exception cref="Amazon.KafkaConnect.Model.BadRequestException">
        /// HTTP Status Code 400: Bad request due to incorrect input. Correct your request and
        /// then retry it.
        /// </exception>
        ...
        /// HTTP Status Code 401: Unauthorized request. The provided credentials couldn't be validated.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/RestartConnector">REST API Reference for RestartConnector Operation</seealso>
        public virtual Task<RestartConnectorResponse> RestartConnectorAsync(RestartConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = RestartConnectorRequestMarshaller.Instance;
            options.ResponseUnmarshaller = RestartConnectorResponseUnmarshaller.Instance;

            return InvokeAsync<RestartConnectorResponse>(request, options, cancellationToken);
        }
        #endregion
