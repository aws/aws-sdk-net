...
namespace Amazon.KafkaConnect
{
    ...
    public partial interface IAmazonKafkaConnect : IAmazonService, IDisposable
    {
        ...
        Task<RestartConnectorResponse> RestartConnectorAsync(RestartConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
