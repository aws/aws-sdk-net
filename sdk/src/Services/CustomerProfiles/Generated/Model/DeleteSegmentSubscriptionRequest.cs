...
{
    /// <summary>
    /// Container for the parameters to the DeleteSegmentSubscription operation.
    /// Deletes a segment subscription for membership events. All active event notifications
    /// for this segment are stopped.
    /// </summary>
    public partial class DeleteSegmentSubscriptionRequest : AmazonCustomerProfilesRequest
    {
