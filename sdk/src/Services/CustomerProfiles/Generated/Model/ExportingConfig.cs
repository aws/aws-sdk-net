...
{
    /// <summary>
    /// Configuration information about the S3 bucket where Identity Resolution Jobs writes
    /// result files. 
    /// 
    ///  <note> 
    /// <para>
    ...
    /// <a href="https://docs.aws.amazon.com/connect/latest/adminguide/cross-service-confused-deputy-prevention.html#customer-profiles-cross-service">Amazon
    /// Connect Customer Profiles cross-service confused deputy prevention</a>. 
    /// </para>
    ///  </note>
    /// </summary>
    public partial class ExportingConfig
    {
        private S3ExportingConfig _s3Exporting;
