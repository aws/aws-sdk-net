...
{
    /// <summary>
    /// Response Unmarshaller for SearchRecommendations operation
    /// </summary>  
    public class SearchRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchRecommendationsResponse response = new SearchRecommendationsResponse();
        ...
        private static SearchRecommendationsResponseUnmarshaller _instance = new SearchRecommendationsResponseUnmarshaller();        

        internal static SearchRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
