...
{
    /// <summary>
    /// Response Unmarshaller for GetSegmentSubscription operation
    /// </summary>  
    public class GetSegmentSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSegmentSubscriptionResponse response = new GetSegmentSubscriptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ScheduledExecutions", targetDepth, ref reader))
                {
                    var unmarshaller = ScheduledExecutionsUnmarshaller.Instance;
                    response.ScheduledExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetSegmentSubscriptionResponseUnmarshaller _instance = new GetSegmentSubscriptionResponseUnmarshaller();        

        internal static GetSegmentSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
