...
{
    /// <summary>
    /// CreateDomainLayout Request Marshaller
    /// </summary>       
    public class CreateDomainLayoutRequestMarshaller : IMarshaller<IRequest, CreateDomainLayoutRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDomainLayoutRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDomainLayoutRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetLayout())
                {
                    ...
                    context.Writer.Write(publicRequest.Layout);
                }

                if(publicRequest.IsSetLayoutType())
                {
                    context.Writer.WritePropertyName("LayoutType");
                    context.Writer.Write(publicRequest.LayoutType);
                }
        ...
        private static CreateDomainLayoutRequestMarshaller _instance = new CreateDomainLayoutRequestMarshaller();        

        internal static CreateDomainLayoutRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDomainLayoutRequestMarshaller Instance
        {
            get
            {
                return _instance;
