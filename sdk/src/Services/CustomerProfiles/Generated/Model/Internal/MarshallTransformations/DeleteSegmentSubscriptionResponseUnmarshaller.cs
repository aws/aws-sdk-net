...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSegmentSubscription operation
    /// </summary>  
    public class DeleteSegmentSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSegmentSubscriptionResponse response = new DeleteSegmentSubscriptionResponse();
        ...
        private static DeleteSegmentSubscriptionResponseUnmarshaller _instance = new DeleteSegmentSubscriptionResponseUnmarshaller();        

        internal static DeleteSegmentSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSegmentSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
