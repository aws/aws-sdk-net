...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConflictResolutionUnmarshaller : IJsonUnmarshaller<ConflictResolution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConflictResolution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ConflictResolvingModel", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConflictResolvingModel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
