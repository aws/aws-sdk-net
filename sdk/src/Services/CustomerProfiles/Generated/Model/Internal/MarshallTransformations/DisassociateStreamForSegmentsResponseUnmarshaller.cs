...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateStreamForSegments operation
    /// </summary>  
    public class DisassociateStreamForSegmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateStreamForSegmentsResponse response = new DisassociateStreamForSegmentsResponse();
        ...
        private static DisassociateStreamForSegmentsResponseUnmarshaller _instance = new DisassociateStreamForSegmentsResponseUnmarshaller();        

        internal static DisassociateStreamForSegmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateStreamForSegmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
