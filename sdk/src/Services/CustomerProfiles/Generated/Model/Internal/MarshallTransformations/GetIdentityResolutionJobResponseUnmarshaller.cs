        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AutoMerging", targetDepth))
                {
                    ...
                    response.AutoMerging = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ExportingLocation", targetDepth))
                {
                    ...
                    response.ExportingLocation = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("JobStats", targetDepth))
                {
                    ...
                    response.JobStats = unmarshaller.Unmarshall(context);
                    continue;
                }
