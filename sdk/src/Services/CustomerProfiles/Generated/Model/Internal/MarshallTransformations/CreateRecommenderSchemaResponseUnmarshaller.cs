...
{
    /// <summary>
    /// Response Unmarshaller for CreateRecommenderSchema operation
    /// </summary>  
    public class CreateRecommenderSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRecommenderSchemaResponse response = new CreateRecommenderSchemaResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RecommenderSchemaArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RecommenderSchemaArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateRecommenderSchemaResponseUnmarshaller _instance = new CreateRecommenderSchemaResponseUnmarshaller();        

        internal static CreateRecommenderSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRecommenderSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
