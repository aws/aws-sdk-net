...
{
    /// <summary>
    /// GetEventStream Request Marshaller
    /// </summary>       
    public class GetEventStreamRequestMarshaller : IMarshaller<IRequest, GetEventStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEventStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEventStreamRequest publicRequest)
        {
        ...
        private static GetEventStreamRequestMarshaller _instance = new GetEventStreamRequestMarshaller();        

        internal static GetEventStreamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
