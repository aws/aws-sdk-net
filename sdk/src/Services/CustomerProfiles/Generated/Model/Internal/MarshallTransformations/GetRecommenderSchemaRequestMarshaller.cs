...
{
    /// <summary>
    /// GetRecommenderSchema Request Marshaller
    /// </summary>       
    public class GetRecommenderSchemaRequestMarshaller : IMarshaller<IRequest, GetRecommenderSchemaRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRecommenderSchemaRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRecommenderSchemaRequest publicRequest)
        {
        ...
        private static GetRecommenderSchemaRequestMarshaller _instance = new GetRecommenderSchemaRequestMarshaller();        

        internal static GetRecommenderSchemaRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRecommenderSchemaRequestMarshaller Instance
        {
            get
            {
                return _instance;
