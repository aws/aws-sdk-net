...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventParametersUnmarshaller : IJsonUnmarshaller<EventParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EventWeight", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
