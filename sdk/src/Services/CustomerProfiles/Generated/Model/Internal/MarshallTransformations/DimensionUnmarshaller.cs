    ...
    public class DimensionUnmarshaller : IUnmarshaller<Dimension, XmlUnmarshallerContext>, IUnmarshaller<Dimension, JsonUnmarshallerContext>
    {
        ...
        public Dimension Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, CalculatedAttributeDimension, StringUnmarshaller, CalculatedAttributeDimensionUnmarshaller>(StringUnmarshaller.Instance, CalculatedAttributeDimensionUnmarshaller.Instance);
                    unmarshalledObject.CalculatedAttributes = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ProfileAttributes", targetDepth))
                {
                    var unmarshaller = ProfileAttributesUnmarshaller.Instance;
                    unmarshalledObject.ProfileAttributes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
