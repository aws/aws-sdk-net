...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteDomainObjectTypeRequestMarshaller : IMarshaller<IRequest, DeleteDomainObjectTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteDomainObjectTypeRequestMarshaller _instance = new DeleteDomainObjectTypeRequestMarshaller();        

        internal static DeleteDomainObjectTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDomainObjectTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
