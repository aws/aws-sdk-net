...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventTriggerSummaryItemUnmarshaller : IJsonUnmarshaller<EventTriggerSummaryItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventTriggerSummaryItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EventTriggerName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
