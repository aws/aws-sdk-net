...
{
    /// <summary>
    /// DeleteRecommenderSchema Request Marshaller
    /// </summary>       
    public class DeleteRecommenderSchemaRequestMarshaller : IMarshaller<IRequest, DeleteRecommenderSchemaRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRecommenderSchemaRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRecommenderSchemaRequest publicRequest)
        {
        ...
        private static DeleteRecommenderSchemaRequestMarshaller _instance = new DeleteRecommenderSchemaRequestMarshaller();        

        internal static DeleteRecommenderSchemaRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecommenderSchemaRequestMarshaller Instance
        {
            get
            {
                return _instance;
