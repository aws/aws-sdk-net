...
{
    /// <summary>
    /// GetDomainObjectType Request Marshaller
    /// </summary>       
    public class GetDomainObjectTypeRequestMarshaller : IMarshaller<IRequest, GetDomainObjectTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDomainObjectTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDomainObjectTypeRequest publicRequest)
        {
        ...
        private static GetDomainObjectTypeRequestMarshaller _instance = new GetDomainObjectTypeRequestMarshaller();        

        internal static GetDomainObjectTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDomainObjectTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
