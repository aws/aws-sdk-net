...
{
    /// <summary>
    /// UpdateRecommender Request Marshaller
    /// </summary>       
    public class UpdateRecommenderRequestMarshaller : IMarshaller<IRequest, UpdateRecommenderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRecommenderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRecommenderRequest publicRequest)
        {
        ...
        private static UpdateRecommenderRequestMarshaller _instance = new UpdateRecommenderRequestMarshaller();        

        internal static UpdateRecommenderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecommenderRequestMarshaller Instance
        {
            get
            {
                return _instance;
