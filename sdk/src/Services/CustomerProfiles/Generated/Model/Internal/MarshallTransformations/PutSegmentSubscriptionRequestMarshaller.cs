...
{
    /// <summary>
    /// PutSegmentSubscription Request Marshaller
    /// </summary>       
    public class PutSegmentSubscriptionRequestMarshaller : IMarshaller<IRequest, PutSegmentSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutSegmentSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutSegmentSubscriptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/domains/{DomainName}/segment-definitions/{SegmentDefinitionName}/subscriptions";
#if !NETFRAMEWORK
        ...
        private static PutSegmentSubscriptionRequestMarshaller _instance = new PutSegmentSubscriptionRequestMarshaller();        

        internal static PutSegmentSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSegmentSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
