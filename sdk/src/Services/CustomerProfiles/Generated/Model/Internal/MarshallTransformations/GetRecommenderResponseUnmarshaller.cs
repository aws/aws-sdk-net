        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("LatestRecommenderUpdate", targetDepth))
                {
                    ...
                    response.LatestRecommenderUpdate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RecommenderConfig", targetDepth))
                {
                    var unmarshaller = RecommenderConfigUnmarshaller.Instance;
                    response.RecommenderConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RecommenderRecipeName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TrainingMetrics, TrainingMetricsUnmarshaller>(TrainingMetricsUnmarshaller.Instance);
