...
{
    /// <summary>
    /// GetDomainLayout Request Marshaller
    /// </summary>       
    public class GetDomainLayoutRequestMarshaller : IMarshaller<IRequest, GetDomainLayoutRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDomainLayoutRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDomainLayoutRequest publicRequest)
        {
        ...
        private static GetDomainLayoutRequestMarshaller _instance = new GetDomainLayoutRequestMarshaller();        

        internal static GetDomainLayoutRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDomainLayoutRequestMarshaller Instance
        {
            get
            {
                return _instance;
