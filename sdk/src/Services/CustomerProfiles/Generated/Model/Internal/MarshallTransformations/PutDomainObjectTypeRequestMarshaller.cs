...
{
    /// <summary>
    /// PutDomainObjectType Request Marshaller
    /// </summary>       
    public class PutDomainObjectTypeRequestMarshaller : IMarshaller<IRequest, PutDomainObjectTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutDomainObjectTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutDomainObjectTypeRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetFields())
                {
                    ...
                    foreach (var publicRequestFieldsKvp in publicRequest.Fields)
                    {
                        ...
                        var marshaller = DomainObjectTypeFieldMarshaller.Instance;
        ...
        private static PutDomainObjectTypeRequestMarshaller _instance = new PutDomainObjectTypeRequestMarshaller();        

        internal static PutDomainObjectTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDomainObjectTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
