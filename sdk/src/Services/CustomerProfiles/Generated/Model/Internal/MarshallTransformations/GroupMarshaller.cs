...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// Group Marshaller
    /// </summary>
    public class GroupMarshaller : IRequestMarshaller<Group, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Group requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSourceSegments())
            {
                ...
                foreach(var requestObjectSourceSegmentsListValue in requestObject.SourceSegments)
                {
                    ...
                    var marshaller = SourceSegmentMarshaller.Instance;
        ...
        /// </summary>
        public readonly static GroupMarshaller Instance = new GroupMarshaller();
