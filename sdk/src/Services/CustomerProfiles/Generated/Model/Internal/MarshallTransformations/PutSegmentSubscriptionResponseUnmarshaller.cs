...
{
    /// <summary>
    /// Response Unmarshaller for PutSegmentSubscription operation
    /// </summary>  
    public class PutSegmentSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSegmentSubscriptionResponse response = new PutSegmentSubscriptionResponse();
        ...
        private static PutSegmentSubscriptionResponseUnmarshaller _instance = new PutSegmentSubscriptionResponseUnmarshaller();        

        internal static PutSegmentSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSegmentSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
