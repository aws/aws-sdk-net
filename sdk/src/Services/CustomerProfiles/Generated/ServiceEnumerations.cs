...
namespace Amazon.CustomerProfiles
{
    ...
    /// <summary>
    /// Constants used for properties of type DiversityCapType.
    /// </summary>
    public class DiversityCapType : ConstantClass
    {

        /// <summary>
        /// Constant PERCENTAGE for DiversityCapType
        /// </summary>
        public static readonly DiversityCapType PERCENTAGE = new DiversityCapType("PERCENTAGE");
        /// <summary>
        /// Constant VALUE for DiversityCapType
        /// </summary>
        public static readonly DiversityCapType VALUE = new DiversityCapType("VALUE");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public DiversityCapType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static DiversityCapType FindValue(string value)
        {
            return FindValue<DiversityCapType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator DiversityCapType(string value)
        {
            return FindValue(value);
        }
    }
