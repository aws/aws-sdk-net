...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MeshRefUnmarshaller : IJsonUnmarshaller<MeshRef, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MeshRef Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("meshOwner", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MeshOwner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
