...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateVirtualServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            response.VirtualService = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static CreateVirtualServiceResponseUnmarshaller _instance = new CreateVirtualServiceResponseUnmarshaller();        

        internal static CreateVirtualServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
