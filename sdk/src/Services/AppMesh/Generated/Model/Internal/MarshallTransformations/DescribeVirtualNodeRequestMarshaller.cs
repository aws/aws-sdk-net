...
{
    /// <summary>
    /// DescribeVirtualNode Request Marshaller
    /// </summary>       
    public class DescribeVirtualNodeRequestMarshaller : IMarshaller<IRequest, DescribeVirtualNodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVirtualNodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVirtualNodeRequest publicRequest)
        {
        ...
        private static DescribeVirtualNodeRequestMarshaller _instance = new DescribeVirtualNodeRequestMarshaller();        

        internal static DescribeVirtualNodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVirtualNodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
