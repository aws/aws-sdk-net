...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVirtualNode operation
    /// </summary>  
    public class DeleteVirtualNodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVirtualNodeResponse response = new DeleteVirtualNodeResponse();
        ...
        private static DeleteVirtualNodeResponseUnmarshaller _instance = new DeleteVirtualNodeResponseUnmarshaller();        

        internal static DeleteVirtualNodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVirtualNodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
