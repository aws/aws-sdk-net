...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateMeshResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateMeshResponseUnmarshaller _instance = new CreateMeshResponseUnmarshaller();        

        internal static CreateMeshResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMeshResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
