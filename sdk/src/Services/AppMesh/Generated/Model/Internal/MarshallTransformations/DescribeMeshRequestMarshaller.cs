...
{
    /// <summary>
    /// DescribeMesh Request Marshaller
    /// </summary>       
    public class DescribeMeshRequestMarshaller : IMarshaller<IRequest, DescribeMeshRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMeshRequest)input);
        }
        ...
        private static DescribeMeshRequestMarshaller _instance = new DescribeMeshRequestMarshaller();        

        internal static DescribeMeshRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMeshRequestMarshaller Instance
        {
            get
            {
                return _instance;
