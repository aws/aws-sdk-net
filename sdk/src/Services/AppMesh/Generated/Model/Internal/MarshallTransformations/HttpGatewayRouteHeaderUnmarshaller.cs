...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HttpGatewayRouteHeaderUnmarshaller : IJsonUnmarshaller<HttpGatewayRouteHeader, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HttpGatewayRouteHeader Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("invert", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.Invert = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
