...
{
    /// <summary>
    /// DeleteVirtualGateway Request Marshaller
    /// </summary>       
    public class DeleteVirtualGatewayRequestMarshaller : IMarshaller<IRequest, DeleteVirtualGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVirtualGatewayRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVirtualGatewayRequest publicRequest)
        {
        ...
        private static DeleteVirtualGatewayRequestMarshaller _instance = new DeleteVirtualGatewayRequestMarshaller();        

        internal static DeleteVirtualGatewayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVirtualGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
