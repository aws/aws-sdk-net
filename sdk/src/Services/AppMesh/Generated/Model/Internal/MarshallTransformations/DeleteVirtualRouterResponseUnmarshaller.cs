...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVirtualRouter operation
    /// </summary>  
    public class DeleteVirtualRouterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVirtualRouterResponse response = new DeleteVirtualRouterResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = VirtualRouterDataUnmarshaller.Instance;
            response.VirtualRouter = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static DeleteVirtualRouterResponseUnmarshaller _instance = new DeleteVirtualRouterResponseUnmarshaller();        

        internal static DeleteVirtualRouterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVirtualRouterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
