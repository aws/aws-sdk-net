...
{
    /// <summary>
    /// DescribeGatewayRoute Request Marshaller
    /// </summary>       
    public class DescribeGatewayRouteRequestMarshaller : IMarshaller<IRequest, DescribeGatewayRouteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeGatewayRouteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeGatewayRouteRequest publicRequest)
        {
        ...
        private static DescribeGatewayRouteRequestMarshaller _instance = new DescribeGatewayRouteRequestMarshaller();        

        internal static DescribeGatewayRouteRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGatewayRouteRequestMarshaller Instance
        {
            get
            {
                return _instance;
