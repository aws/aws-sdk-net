...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VirtualGatewayDataUnmarshaller : IJsonUnmarshaller<VirtualGatewayData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VirtualGatewayData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("meshName", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("virtualGatewayName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VirtualGatewayName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
