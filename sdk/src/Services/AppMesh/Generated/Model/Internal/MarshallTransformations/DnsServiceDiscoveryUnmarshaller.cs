...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DnsServiceDiscoveryUnmarshaller : IJsonUnmarshaller<DnsServiceDiscovery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DnsServiceDiscovery Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ipPreference", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IpPreference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("responseType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
