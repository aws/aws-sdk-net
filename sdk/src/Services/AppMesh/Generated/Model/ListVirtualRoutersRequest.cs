...
{
    /// <summary>
    /// Container for the parameters to the ListVirtualRouters operation.
    /// Returns a list of existing virtual routers in a service mesh.
    /// </summary>
    public partial class ListVirtualRoutersRequest : AmazonAppMeshRequest
    {
        private int? _limit;
        ...
        /// <para>
        /// The maximum number of results returned by <c>ListVirtualRouters</c> in paginated output.
        ...
        /// <para>
        /// The <c>nextToken</c> value returned from a previous paginated <c>ListVirtualRouters</c>
