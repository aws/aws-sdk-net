...
{
    /// <summary>
    /// This is the response object from the ListStepConsumers operation.
    /// </summary>
    public partial class ListStepConsumersResponse : AmazonWebServiceResponse
    {
        private List<StepConsumer> _consumers = AWSConfigs.InitializeCollections ? new List<StepConsumer>() : null;
        ...
        public List<StepConsumer> Consumers
        {
