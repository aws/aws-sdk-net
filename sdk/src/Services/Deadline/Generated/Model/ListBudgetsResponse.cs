...
{
    /// <summary>
    /// This is the response object from the ListBudgets operation.
    /// </summary>
    public partial class ListBudgetsResponse : AmazonWebServiceResponse
    {
        private List<BudgetSummary> _budgets = AWSConfigs.InitializeCollections ? new List<BudgetSummary>() : null;
        ...
        public List<BudgetSummary> Budgets
        {
