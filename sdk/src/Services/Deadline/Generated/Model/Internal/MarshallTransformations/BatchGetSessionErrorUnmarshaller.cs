...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetSessionError Object
    /// </summary>  
    public class BatchGetSessionErrorUnmarshaller : IJsonUnmarshaller<BatchGetSessionError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetSessionError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetSessionError unmarshalledObject = new BatchGetSessionError();
        ...
        private static BatchGetSessionErrorUnmarshaller _instance = new BatchGetSessionErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetSessionErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
