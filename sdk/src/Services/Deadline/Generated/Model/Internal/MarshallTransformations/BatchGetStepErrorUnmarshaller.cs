...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetStepError Object
    /// </summary>  
    public class BatchGetStepErrorUnmarshaller : IJsonUnmarshaller<BatchGetStepError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetStepError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetStepError unmarshalledObject = new BatchGetStepError();
        ...
        private static BatchGetStepErrorUnmarshaller _instance = new BatchGetStepErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetStepErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
