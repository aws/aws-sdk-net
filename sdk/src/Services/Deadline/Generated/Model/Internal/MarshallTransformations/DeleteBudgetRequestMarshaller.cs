...
{
    /// <summary>
    /// DeleteBudget Request Marshaller
    /// </summary>       
    public class DeleteBudgetRequestMarshaller : IMarshaller<IRequest, DeleteBudgetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteBudgetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBudgetRequest publicRequest)
        {
        ...
        private static DeleteBudgetRequestMarshaller _instance = new DeleteBudgetRequestMarshaller();        

        internal static DeleteBudgetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBudgetRequestMarshaller Instance
        {
            get
            {
                return _instance;
