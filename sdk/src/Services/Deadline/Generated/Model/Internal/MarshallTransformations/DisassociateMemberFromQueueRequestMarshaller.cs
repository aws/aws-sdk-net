...
{
    /// <summary>
    /// DisassociateMemberFromQueue Request Marshaller
    /// </summary>       
    public class DisassociateMemberFromQueueRequestMarshaller : IMarshaller<IRequest, DisassociateMemberFromQueueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateMemberFromQueueRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateMemberFromQueueRequest publicRequest)
        {
        ...
        private static DisassociateMemberFromQueueRequestMarshaller _instance = new DisassociateMemberFromQueueRequestMarshaller();        

        internal static DisassociateMemberFromQueueRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateMemberFromQueueRequestMarshaller Instance
        {
            get
            {
                return _instance;
