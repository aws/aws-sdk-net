...
namespace Amazon.Deadline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HostPropertiesResponseUnmarshaller : IUnmarshaller<HostPropertiesResponse, XmlUnmarshallerContext>, IUnmarshaller<HostPropertiesResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HostPropertiesResponse IUnmarshaller<HostPropertiesResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public HostPropertiesResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ec2InstanceArn", targetDepth))
                {
                    ...
                    unmarshalledObject.Ec2InstanceArn = unmarshaller.Unmarshall(context);
                    continue;
                }
