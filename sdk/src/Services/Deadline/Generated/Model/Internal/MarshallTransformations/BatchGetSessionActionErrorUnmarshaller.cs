...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetSessionActionError Object
    /// </summary>  
    public class BatchGetSessionActionErrorUnmarshaller : IJsonUnmarshaller<BatchGetSessionActionError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetSessionActionError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetSessionActionError unmarshalledObject = new BatchGetSessionActionError();
        ...
        private static BatchGetSessionActionErrorUnmarshaller _instance = new BatchGetSessionActionErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetSessionActionErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
