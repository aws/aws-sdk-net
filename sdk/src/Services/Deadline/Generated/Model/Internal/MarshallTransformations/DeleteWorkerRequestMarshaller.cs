...
{
    /// <summary>
    /// DeleteWorker Request Marshaller
    /// </summary>       
    public class DeleteWorkerRequestMarshaller : IMarshaller<IRequest, DeleteWorkerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteWorkerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteWorkerRequest publicRequest)
        {
        ...
        private static DeleteWorkerRequestMarshaller _instance = new DeleteWorkerRequestMarshaller();        

        internal static DeleteWorkerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWorkerRequestMarshaller Instance
        {
            get
            {
                return _instance;
