...
{
    /// <summary>
    /// DisassociateMemberFromJob Request Marshaller
    /// </summary>       
    public class DisassociateMemberFromJobRequestMarshaller : IMarshaller<IRequest, DisassociateMemberFromJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateMemberFromJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateMemberFromJobRequest publicRequest)
        {
        ...
        private static DisassociateMemberFromJobRequestMarshaller _instance = new DisassociateMemberFromJobRequestMarshaller();        

        internal static DisassociateMemberFromJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateMemberFromJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
