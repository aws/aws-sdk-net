...
{
    /// <summary>
    /// Response Unmarshaller for GetWorker operation
    /// </summary>  
    public class GetWorkerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hostProperties", targetDepth, ref reader))
                {
        ...
        private static GetWorkerResponseUnmarshaller _instance = new GetWorkerResponseUnmarshaller();        

        internal static GetWorkerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
