...
{
    /// <summary>
    /// GetStep Request Marshaller
    /// </summary>       
    public class GetStepRequestMarshaller : IMarshaller<IRequest, GetStepRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetStepRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetStepRequest publicRequest)
        {
        ...
        private static GetStepRequestMarshaller _instance = new GetStepRequestMarshaller();        

        internal static GetStepRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStepRequestMarshaller Instance
        {
            get
            {
                return _instance;
