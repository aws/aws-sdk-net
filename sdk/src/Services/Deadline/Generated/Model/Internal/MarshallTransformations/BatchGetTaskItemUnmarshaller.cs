...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetTaskItem Object
    /// </summary>  
    public class BatchGetTaskItemUnmarshaller : IJsonUnmarshaller<BatchGetTaskItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetTaskItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetTaskItem unmarshalledObject = new BatchGetTaskItem();
        ...
        private static BatchGetTaskItemUnmarshaller _instance = new BatchGetTaskItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetTaskItemUnmarshaller Instance
        {
            get
            {
                return _instance;
