        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("allowedStorageProfileIds", targetDepth))
                {
                    ...
                    response.AllowedStorageProfileIds = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("blockedReason", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BlockedReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DefaultBudgetAction = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("jobAttachmentSettings", targetDepth))
                {
                    ...
                    response.JobAttachmentSettings = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("jobRunAsUser", targetDepth))
                {
                    var unmarshaller = JobRunAsUserUnmarshaller.Instance;
                    response.JobRunAsUser = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("queueId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.QueueId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("requiredFileSystemLocationNames", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.RequiredFileSystemLocationNames = unmarshaller.Unmarshall(context);
                    continue;
                }
