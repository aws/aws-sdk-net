...
{
    /// <summary>
    /// ListStepDependencies Request Marshaller
    /// </summary>       
    public class ListStepDependenciesRequestMarshaller : IMarshaller<IRequest, ListStepDependenciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListStepDependenciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListStepDependenciesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/queues/{queueId}/jobs/{jobId}/steps/{stepId}/dependencies";
        ...
        private static ListStepDependenciesRequestMarshaller _instance = new ListStepDependenciesRequestMarshaller();        

        internal static ListStepDependenciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStepDependenciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
