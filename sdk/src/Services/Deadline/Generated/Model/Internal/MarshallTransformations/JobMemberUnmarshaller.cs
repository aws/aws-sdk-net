...
{
    /// <summary>
    /// Response Unmarshaller for JobMember Object
    /// </summary>  
    public class JobMemberUnmarshaller : IJsonUnmarshaller<JobMember, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobMember Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            JobMember unmarshalledObject = new JobMember();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("membershipLevel", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MembershipLevel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static JobMemberUnmarshaller _instance = new JobMemberUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static JobMemberUnmarshaller Instance
        {
            get
            {
                return _instance;
