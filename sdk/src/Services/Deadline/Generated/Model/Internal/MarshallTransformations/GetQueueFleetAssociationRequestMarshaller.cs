...
{
    /// <summary>
    /// GetQueueFleetAssociation Request Marshaller
    /// </summary>       
    public class GetQueueFleetAssociationRequestMarshaller : IMarshaller<IRequest, GetQueueFleetAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetQueueFleetAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetQueueFleetAssociationRequest publicRequest)
        {
        ...
        private static GetQueueFleetAssociationRequestMarshaller _instance = new GetQueueFleetAssociationRequestMarshaller();        

        internal static GetQueueFleetAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueueFleetAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
