...
{
    /// <summary>
    /// Response Unmarshaller for ListFleets operation
    /// </summary>  
    public class ListFleetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFleetsResponse response = new ListFleetsResponse();
            ...
            {
                if (context.TestExpression("fleets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FleetSummary, FleetSummaryUnmarshaller>(FleetSummaryUnmarshaller.Instance);
                    response.Fleets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFleetsResponseUnmarshaller _instance = new ListFleetsResponseUnmarshaller();        

        internal static ListFleetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFleetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
