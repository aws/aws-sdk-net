...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorker operation
    /// </summary>  
    public class UpdateWorkerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateWorkerResponseUnmarshaller _instance = new UpdateWorkerResponseUnmarshaller();        

        internal static UpdateWorkerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
