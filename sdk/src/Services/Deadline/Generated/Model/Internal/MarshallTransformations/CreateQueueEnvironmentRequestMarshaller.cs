...
{
    /// <summary>
    /// CreateQueueEnvironment Request Marshaller
    /// </summary>       
    public class CreateQueueEnvironmentRequestMarshaller : IMarshaller<IRequest, CreateQueueEnvironmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateQueueEnvironmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateQueueEnvironmentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/queues/{queueId}/environments";
#if !NETFRAMEWORK
        ...
        private static CreateQueueEnvironmentRequestMarshaller _instance = new CreateQueueEnvironmentRequestMarshaller();        

        internal static CreateQueueEnvironmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQueueEnvironmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
