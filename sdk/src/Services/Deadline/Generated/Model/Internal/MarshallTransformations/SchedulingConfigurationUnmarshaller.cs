...
{
    /// <summary>
    /// Response Unmarshaller for SchedulingConfiguration Object
    /// </summary>  
    public class SchedulingConfigurationUnmarshaller : IJsonUnmarshaller<SchedulingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SchedulingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SchedulingConfiguration unmarshalledObject = new SchedulingConfiguration();
        ...
        private static SchedulingConfigurationUnmarshaller _instance = new SchedulingConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SchedulingConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
