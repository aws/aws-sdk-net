...
{
    /// <summary>
    /// Response Unmarshaller for GetFarm operation
    /// </summary>  
    public class GetFarmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("costScaleFactor", targetDepth, ref reader))
                {
                    var unmarshaller = NullableFloatUnmarshaller.Instance;
                    response.CostScaleFactor = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetFarmResponseUnmarshaller _instance = new GetFarmResponseUnmarshaller();        

        internal static GetFarmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFarmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
