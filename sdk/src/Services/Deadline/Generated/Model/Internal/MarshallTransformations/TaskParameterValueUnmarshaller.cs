...
namespace Amazon.Deadline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaskParameterValueUnmarshaller : IUnmarshaller<TaskParameterValue, XmlUnmarshallerContext>, IUnmarshaller<TaskParameterValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TaskParameterValue IUnmarshaller<TaskParameterValue, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TaskParameterValue Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("chunkInt", targetDepth))
                {
                    ...
                    unmarshalledObject.ChunkInt = unmarshaller.Unmarshall(context);
                    continue;
                }
