...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetWorkerItem Object
    /// </summary>  
    public class BatchGetWorkerItemUnmarshaller : IJsonUnmarshaller<BatchGetWorkerItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetWorkerItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetWorkerItem unmarshalledObject = new BatchGetWorkerItem();
        ...
        private static BatchGetWorkerItemUnmarshaller _instance = new BatchGetWorkerItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetWorkerItemUnmarshaller Instance
        {
            get
            {
                return _instance;
