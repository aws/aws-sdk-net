...
namespace Amazon.Deadline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomerManagedFleetConfigurationUnmarshaller : IUnmarshaller<CustomerManagedFleetConfiguration, XmlUnmarshallerContext>, IUnmarshaller<CustomerManagedFleetConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CustomerManagedFleetConfiguration IUnmarshaller<CustomerManagedFleetConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CustomerManagedFleetConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TagPropagationMode = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("workerCapabilities", targetDepth))
                {
                    ...
                    unmarshalledObject.WorkerCapabilities = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
