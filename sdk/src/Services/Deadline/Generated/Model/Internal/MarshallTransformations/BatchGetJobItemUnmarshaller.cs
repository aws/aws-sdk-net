...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetJobItem Object
    /// </summary>  
    public class BatchGetJobItemUnmarshaller : IJsonUnmarshaller<BatchGetJobItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetJobItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetJobItem unmarshalledObject = new BatchGetJobItem();
        ...
        private static BatchGetJobItemUnmarshaller _instance = new BatchGetJobItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetJobItemUnmarshaller Instance
        {
            get
            {
                return _instance;
