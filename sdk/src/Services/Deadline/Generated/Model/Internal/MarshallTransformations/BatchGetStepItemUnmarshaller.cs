...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetStepItem Object
    /// </summary>  
    public class BatchGetStepItemUnmarshaller : IJsonUnmarshaller<BatchGetStepItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetStepItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetStepItem unmarshalledObject = new BatchGetStepItem();
        ...
        private static BatchGetStepItemUnmarshaller _instance = new BatchGetStepItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetStepItemUnmarshaller Instance
        {
            get
            {
                return _instance;
