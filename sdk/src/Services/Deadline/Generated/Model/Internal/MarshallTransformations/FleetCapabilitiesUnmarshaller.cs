...
namespace Amazon.Deadline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FleetCapabilitiesUnmarshaller : IJsonUnmarshaller<FleetCapabilities, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FleetCapabilities Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("amounts", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Amounts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
