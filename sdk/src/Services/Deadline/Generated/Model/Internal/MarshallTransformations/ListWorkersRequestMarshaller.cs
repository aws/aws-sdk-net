...
{
    /// <summary>
    /// ListWorkers Request Marshaller
    /// </summary>       
    public class ListWorkersRequestMarshaller : IMarshaller<IRequest, ListWorkersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListWorkersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListWorkersRequest publicRequest)
        {
        ...
        private static ListWorkersRequestMarshaller _instance = new ListWorkersRequestMarshaller();        

        internal static ListWorkersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkersRequestMarshaller Instance
        {
            get
            {
                return _instance;
