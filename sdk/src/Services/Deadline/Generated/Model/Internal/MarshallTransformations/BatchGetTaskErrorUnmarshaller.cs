...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetTaskError Object
    /// </summary>  
    public class BatchGetTaskErrorUnmarshaller : IJsonUnmarshaller<BatchGetTaskError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetTaskError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetTaskError unmarshalledObject = new BatchGetTaskError();
        ...
        private static BatchGetTaskErrorUnmarshaller _instance = new BatchGetTaskErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetTaskErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
