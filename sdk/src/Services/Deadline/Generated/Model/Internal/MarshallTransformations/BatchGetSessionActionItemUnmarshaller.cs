...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetSessionActionItem Object
    /// </summary>  
    public class BatchGetSessionActionItemUnmarshaller : IJsonUnmarshaller<BatchGetSessionActionItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetSessionActionItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetSessionActionItem unmarshalledObject = new BatchGetSessionActionItem();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("acquiredLimits", targetDepth))
                {
                    ...
                    unmarshalledObject.AcquiredLimits = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("processExitCode", targetDepth))
                {
                    ...
                    unmarshalledObject.ProcessExitCode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("progressMessage", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProgressMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static BatchGetSessionActionItemUnmarshaller _instance = new BatchGetSessionActionItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetSessionActionItemUnmarshaller Instance
        {
            get
            {
                return _instance;
