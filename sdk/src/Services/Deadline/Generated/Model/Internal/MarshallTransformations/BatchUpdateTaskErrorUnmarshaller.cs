...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdateTaskError Object
    /// </summary>  
    public class BatchUpdateTaskErrorUnmarshaller : IJsonUnmarshaller<BatchUpdateTaskError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchUpdateTaskError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchUpdateTaskError unmarshalledObject = new BatchUpdateTaskError();
        ...
        private static BatchUpdateTaskErrorUnmarshaller _instance = new BatchUpdateTaskErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateTaskErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
