...
{
    /// <summary>
    /// UpdateQueueFleetAssociation Request Marshaller
    /// </summary>       
    public class UpdateQueueFleetAssociationRequestMarshaller : IMarshaller<IRequest, UpdateQueueFleetAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateQueueFleetAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateQueueFleetAssociationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/queue-fleet-associations/{queueId}/{fleetId}";
#if !NETFRAMEWORK
        ...
        private static UpdateQueueFleetAssociationRequestMarshaller _instance = new UpdateQueueFleetAssociationRequestMarshaller();        

        internal static UpdateQueueFleetAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQueueFleetAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
