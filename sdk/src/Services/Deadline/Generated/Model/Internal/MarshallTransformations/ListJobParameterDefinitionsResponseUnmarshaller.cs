...
{
    /// <summary>
    /// Response Unmarshaller for ListJobParameterDefinitions operation
    /// </summary>  
    public class ListJobParameterDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListJobParameterDefinitionsResponse response = new ListJobParameterDefinitionsResponse();
            ...
            {
                if (context.TestExpression("jobParameterDefinitions", targetDepth, ref reader))
                {
                    ...
                    response.JobParameterDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListJobParameterDefinitionsResponseUnmarshaller _instance = new ListJobParameterDefinitionsResponseUnmarshaller();        

        internal static ListJobParameterDefinitionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListJobParameterDefinitionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
