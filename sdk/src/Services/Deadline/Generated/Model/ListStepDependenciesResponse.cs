...
{
    /// <summary>
    /// This is the response object from the ListStepDependencies operation.
    /// </summary>
    public partial class ListStepDependenciesResponse : AmazonWebServiceResponse
    {
        private List<StepDependency> _dependencies = AWSConfigs.InitializeCollections ? new List<StepDependency>() : null;
