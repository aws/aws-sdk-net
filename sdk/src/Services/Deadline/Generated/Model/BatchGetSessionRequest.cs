...
{
    /// <summary>
    /// Container for the parameters to the BatchGetSession operation.
    ...
    /// </para>
    /// </summary>
    public partial class BatchGetSessionRequest : AmazonDeadlineRequest
    {
        private List<BatchGetSessionIdentifier> _identifiers = AWSConfigs.InitializeCollections ? new List<BatchGetSessionIdentifier>() : null;

        /// <summary>
        /// Gets and sets the property Identifiers. 
        /// <para>
        /// The list of session identifiers to retrieve. You can specify up to 100 identifiers
        /// per request.
        /// </para>
        /// <para />
        ...
        public List<BatchGetSessionIdentifier> Identifiers
        {
