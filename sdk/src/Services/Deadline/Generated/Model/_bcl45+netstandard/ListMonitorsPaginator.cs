...
namespace Amazon.Deadline.Model
{
    ...
    internal sealed partial class ListMonitorsPaginator : IPaginator<ListMonitorsResponse>, IListMonitorsPaginator
    {
        ...
        internal ListMonitorsPaginator(IAmazonDeadline client, ListMonitorsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListMonitorsResponse> IPaginator<ListMonitorsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
