...
{
    /// <summary>
    /// Container for the parameters to the BatchGetSessionAction operation.
    ...
    /// </para>
    /// </summary>
    public partial class BatchGetSessionActionRequest : AmazonDeadlineRequest
    {
        private List<BatchGetSessionActionIdentifier> _identifiers = AWSConfigs.InitializeCollections ? new List<BatchGetSessionActionIdentifier>() : null;

        /// <summary>
        /// Gets and sets the property Identifiers. 
        /// <para>
        /// The list of session action identifiers to retrieve. You can specify up to 100 identifiers
        /// per request.
        /// </para>
        /// <para />
        ...
        public List<BatchGetSessionActionIdentifier> Identifiers
        {
