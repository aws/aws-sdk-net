...
{
    /// <summary>
    /// Container for the parameters to the BatchGetJob operation.
    ...
    /// </para>
    /// </summary>
    public partial class BatchGetJobRequest : AmazonDeadlineRequest
    {
        private List<BatchGetJobIdentifier> _identifiers = AWSConfigs.InitializeCollections ? new List<BatchGetJobIdentifier>() : null;

        /// <summary>
        /// Gets and sets the property Identifiers. 
        /// <para>
        /// The list of job identifiers to retrieve. You can specify up to 100 identifiers per
        /// request.
        /// </para>
        /// <para />
        ...
        public List<BatchGetJobIdentifier> Identifiers
        {
