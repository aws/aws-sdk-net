...
{
    /// <summary>
    /// The error details for a session action that could not be retrieved in a batch get
    /// operation.
    /// </summary>
    public partial class BatchGetSessionActionError
    {
        private BatchGetSessionActionErrorCode _code;
        ...
        public BatchGetSessionActionErrorCode Code
        {
