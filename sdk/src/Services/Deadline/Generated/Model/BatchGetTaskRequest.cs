...
{
    /// <summary>
    /// Container for the parameters to the BatchGetTask operation.
    ...
    /// </para>
    /// </summary>
    public partial class BatchGetTaskRequest : AmazonDeadlineRequest
    {
        private List<BatchGetTaskIdentifier> _identifiers = AWSConfigs.InitializeCollections ? new List<BatchGetTaskIdentifier>() : null;

        /// <summary>
        /// Gets and sets the property Identifiers. 
        /// <para>
        /// The list of task identifiers to retrieve. You can specify up to 100 identifiers per
        /// request.
        /// </para>
        /// <para />
        ...
        public List<BatchGetTaskIdentifier> Identifiers
        {
