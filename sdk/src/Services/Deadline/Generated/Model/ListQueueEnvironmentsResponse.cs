...
{
    /// <summary>
    /// This is the response object from the ListQueueEnvironments operation.
    /// </summary>
    public partial class ListQueueEnvironmentsResponse : AmazonWebServiceResponse
    {
        private List<QueueEnvironmentSummary> _environments = AWSConfigs.InitializeCollections ? new List<QueueEnvironmentSummary>() : null;
        ...
        public List<QueueEnvironmentSummary> Environments
        {
