...
{
    /// <summary>
    /// Container for the parameters to the BatchGetWorker operation.
    ...
    /// </para>
    /// </summary>
    public partial class BatchGetWorkerRequest : AmazonDeadlineRequest
    {
        private List<BatchGetWorkerIdentifier> _identifiers = AWSConfigs.InitializeCollections ? new List<BatchGetWorkerIdentifier>() : null;

        /// <summary>
        /// Gets and sets the property Identifiers. 
        /// <para>
        /// The list of worker identifiers to retrieve. You can specify up to 100 identifiers
        /// per request.
        /// </para>
        /// <para />
        ...
        public List<BatchGetWorkerIdentifier> Identifiers
        {
