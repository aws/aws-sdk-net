...
namespace Amazon.Uxc
{
    ...
    public partial class AmazonUxcClient : AmazonServiceClient, IAmazonUxc
    {
        ...
        /// 
        /// </summary>
        public AmazonUxcClient() : base(new AmazonUxcConfig()) { }
        ...
        public AmazonUxcClient(RegionEndpoint region) : base(new AmazonUxcConfig { RegionEndpoint = region }) { }
        ...
        public AmazonUxcClient(AmazonUxcConfig config) : base(config) { }
