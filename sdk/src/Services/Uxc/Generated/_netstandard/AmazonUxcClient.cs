...
namespace Amazon.Uxc
{
    ...
    public partial class AmazonUxcClient : AmazonServiceClient, IAmazonUxc
    {
        ...
        public AmazonUxcClient(RegionEndpoint region)
            : base(new AmazonUxcConfig{RegionEndpoint = region}) { }
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonUxcAuthSchemeHandler());
        }
        ...
        internal virtual GetAccountCustomizationsResponse GetAccountCustomizations(GetAccountCustomizationsRequest request)
        {
        ...
        public virtual Task<GetAccountCustomizationsResponse> GetAccountCustomizationsAsync(GetAccountCustomizationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetAccountCustomizationsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetAccountCustomizationsResponseUnmarshaller.Instance;

            return InvokeAsync<GetAccountCustomizationsResponse>(request, options, cancellationToken);
        }
        #endregion
        ...
        internal virtual UpdateAccountCustomizationsResponse UpdateAccountCustomizations(UpdateAccountCustomizationsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual Task<UpdateAccountCustomizationsResponse> UpdateAccountCustomizationsAsync(UpdateAccountCustomizationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateAccountCustomizationsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateAccountCustomizationsResponseUnmarshaller.Instance;

            return InvokeAsync<UpdateAccountCustomizationsResponse>(request, options, cancellationToken);
        }
        #endregion
