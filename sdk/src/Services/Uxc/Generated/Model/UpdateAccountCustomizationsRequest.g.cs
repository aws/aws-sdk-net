...
{
    /// <summary>
    /// Container for the parameters to the UpdateAccountCustomizations operation. Updates
    /// one or more account customization settings. You can update account color, visible
    /// services, and visible Regions in a single request. Only the settings that you include
    /// in the request body are modified. Omitted settings remain unchanged. To reset a setting
    /// to its default behavior, set the value to <c>null</c> for visible Regions and visible
    /// services, or <c>none</c> for account color. This operation is idempotent. <note> <para>
    ...
    /// restrict access through the CLI, SDKs, or other APIs. </para> </note>
    /// </summary>
