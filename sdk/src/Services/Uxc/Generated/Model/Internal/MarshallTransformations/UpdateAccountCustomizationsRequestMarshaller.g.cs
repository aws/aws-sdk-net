...
namespace Amazon.Uxc.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAccountCustomizationsRequestMarshaller : IMarshaller<IRequest, UpdateAccountCustomizationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAccountCustomizationsRequestMarshaller _instance = new();

        internal static UpdateAccountCustomizationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAccountCustomizationsRequestMarshaller Instance => _instance;
    }
}
