...
namespace Amazon.Uxc.Model.Internal.MarshallTransformations
{
    ...
    public partial class ValidationExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ValidationException, JsonUnmarshallerContext>
    {
        ...
        {
            var unmarshalledObject = new ValidationException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
