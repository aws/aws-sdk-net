...
{
    /// <summary>
    /// Exception Unmarshaller for ValidationException
    /// </summary>
    public partial class ValidationExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ValidationException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ValidationException unmarshalledObject = new ValidationException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static ValidationExceptionUnmarshaller Instance => _instance;
    }
}
