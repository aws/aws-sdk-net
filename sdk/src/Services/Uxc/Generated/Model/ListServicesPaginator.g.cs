...
namespace Amazon.Uxc.Model
{
    ...
    {
        private readonly IAmazonUxc _client;
        ...
        /// </summary>
        public IPaginatedEnumerable<string> Services =>
            new PaginatedResultKeyResponse<ListServicesResponse, string>(this, (i) => i.Services ?? new List<string>());

        internal ListServicesPaginator(IAmazonUxc client, ListServicesRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListServicesResponse> IPaginator<ListServicesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
