...
namespace Amazon.Uxc.Model
{
    ...
    public partial class ListServicesResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// The token for retrieving the next page of results. This value is <c>null</c> when
        ...
        /// </summary>
        [AWSProperty(Max = 500)]
        public List<string> Services { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;
