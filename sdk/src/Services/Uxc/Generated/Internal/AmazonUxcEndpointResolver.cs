...
namespace Amazon.Uxc.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Uxc service requests.
    /// Collects values for UxcEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses UxcEndpointProvider.
