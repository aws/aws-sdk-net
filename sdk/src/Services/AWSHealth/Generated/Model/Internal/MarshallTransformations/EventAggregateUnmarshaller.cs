...
namespace Amazon.AWSHealth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventAggregateUnmarshaller : IJsonUnmarshaller<EventAggregate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventAggregate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("aggregateValue", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AggregateValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
