...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAffectedEntities operation
    /// </summary>  
    public class DescribeAffectedEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAffectedEntitiesResponse response = new DescribeAffectedEntitiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AffectedEntity, AffectedEntityUnmarshaller>(AffectedEntityUnmarshaller.Instance);
        ...
        private static DescribeAffectedEntitiesResponseUnmarshaller _instance = new DescribeAffectedEntitiesResponseUnmarshaller();        

        internal static DescribeAffectedEntitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAffectedEntitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
