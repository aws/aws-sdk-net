...
namespace Amazon.AWSHealth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EntityAggregateUnmarshaller : IJsonUnmarshaller<EntityAggregate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EntityAggregate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
