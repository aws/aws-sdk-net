...
namespace Amazon.PaymentCryptographyData
{
    ...
    public partial class AmazonPaymentCryptographyDataClient : AmazonServiceClient, IAmazonPaymentCryptographyData
    {
        ...
        /// 
        /// </summary>
        public AmazonPaymentCryptographyDataClient() : base(new AmazonPaymentCryptographyDataConfig()) { }
        ...
        public AmazonPaymentCryptographyDataClient(RegionEndpoint region) : base(new AmazonPaymentCryptographyDataConfig { RegionEndpoint = region }) { }
        ...
        public AmazonPaymentCryptographyDataClient(AmazonPaymentCryptographyDataConfig config) : base(config) { }
...
#else
        internal virtual GenerateAs2805KekValidationResponse GenerateAs2805KekValidation(GenerateAs2805KekValidationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GenerateAs2805KekValidationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GenerateAs2805KekValidationResponseUnmarshaller.Instance;
...
#else
        internal virtual GenerateAuthRequestCryptogramResponse GenerateAuthRequestCryptogram(GenerateAuthRequestCryptogramRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GenerateAuthRequestCryptogramRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GenerateAuthRequestCryptogramResponseUnmarshaller.Instance;
...
#else
        internal virtual TranslateKeyMaterialResponse TranslateKeyMaterial(TranslateKeyMaterialRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = TranslateKeyMaterialRequestMarshaller.Instance;
            options.ResponseUnmarshaller = TranslateKeyMaterialResponseUnmarshaller.Instance;
