...
namespace Amazon.PaymentCryptographyData
{
    ...
    public partial class AmazonPaymentCryptographyDataClient : AmazonServiceClient, IAmazonPaymentCryptographyData
    {
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GenerateAs2805KekValidation operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GenerateAs2805KekValidation operation on AmazonPaymentCryptographyDataClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGenerateAs2805KekValidation
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/GenerateAs2805KekValidation">REST API Reference for GenerateAs2805KekValidation Operation</seealso>
        public virtual IAsyncResult BeginGenerateAs2805KekValidation(GenerateAs2805KekValidationRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GenerateAs2805KekValidationRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GenerateAs2805KekValidationResponseUnmarshaller.Instance;
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  GenerateAs2805KekValidation operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGenerateAs2805KekValidation.</param>
        /// 
        /// <returns>Returns a  GenerateAs2805KekValidationResult from PaymentCryptographyData.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/GenerateAs2805KekValidation">REST API Reference for GenerateAs2805KekValidation Operation</seealso>
        public virtual GenerateAs2805KekValidationResponse EndGenerateAs2805KekValidation(IAsyncResult asyncResult)
        {
            return EndInvoke<GenerateAs2805KekValidationResponse>(asyncResult);
        }
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/GenerateMacEmvPinChange">REST API Reference for GenerateMacEmvPinChange Operation</seealso>
        public virtual IAsyncResult BeginGenerateMacEmvPinChange(GenerateMacEmvPinChangeRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GenerateMacEmvPinChangeRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GenerateMacEmvPinChangeResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/GenerateMacEmvPinChange">REST API Reference for GenerateMacEmvPinChange Operation</seealso>
        public virtual GenerateMacEmvPinChangeResponse EndGenerateMacEmvPinChange(IAsyncResult asyncResult)
        {
            return EndInvoke<GenerateMacEmvPinChangeResponse>(asyncResult);
        }
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the TranslateKeyMaterial operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the TranslateKeyMaterial operation on AmazonPaymentCryptographyDataClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndTranslateKeyMaterial
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/TranslateKeyMaterial">REST API Reference for TranslateKeyMaterial Operation</seealso>
        public virtual IAsyncResult BeginTranslateKeyMaterial(TranslateKeyMaterialRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = TranslateKeyMaterialRequestMarshaller.Instance;
            options.ResponseUnmarshaller = TranslateKeyMaterialResponseUnmarshaller.Instance;
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  TranslateKeyMaterial operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginTranslateKeyMaterial.</param>
        /// 
        /// <returns>Returns a  TranslateKeyMaterialResult from PaymentCryptographyData.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/TranslateKeyMaterial">REST API Reference for TranslateKeyMaterial Operation</seealso>
        public virtual TranslateKeyMaterialResponse EndTranslateKeyMaterial(IAsyncResult asyncResult)
        {
            return EndInvoke<TranslateKeyMaterialResponse>(asyncResult);
        }
