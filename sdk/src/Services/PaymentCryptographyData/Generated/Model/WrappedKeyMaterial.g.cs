...
namespace Amazon.PaymentCryptographyData.Model
{
    ...
    public partial class WrappedKeyMaterial
    {
        ...
        /// </para>
        /// </summary>
        public EcdhDerivationAttributes DiffieHellmanSymmetricKey { get; set; }

        /// <summary>
        /// Checks to see if the DiffieHellmanSymmetricKey property is set.
        /// </summary>
        internal bool IsSetDiffieHellmanSymmetricKey() => this.DiffieHellmanSymmetricKey != null;
        ...
        public string Tr31KeyBlock { get; set; }
