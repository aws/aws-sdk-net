    ...
    public class GenerateAs2805KekValidationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RandomKeyReceive", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RandomKeyReceive = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RandomKeySend", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RandomKeySend = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
