...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class KekValidationResponseMarshaller : IRequestMarshaller<KekValidationResponse, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(KekValidationResponse requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRandomKeySend())
            {
                ...
                context.Writer.Write(requestObject.RandomKeySend);
            }
