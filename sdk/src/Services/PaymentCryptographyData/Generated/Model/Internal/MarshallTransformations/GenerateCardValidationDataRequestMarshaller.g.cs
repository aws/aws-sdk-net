...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GenerateCardValidationDataRequestMarshaller : IMarshaller<IRequest, GenerateCardValidationDataRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GenerateCardValidationDataRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetValidationDataLength())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.ValidationDataLength.Value);
            }
        ...
        private static readonly GenerateCardValidationDataRequestMarshaller _instance = new();

        internal static GenerateCardValidationDataRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GenerateCardValidationDataRequestMarshaller Instance => _instance;
    }
}
