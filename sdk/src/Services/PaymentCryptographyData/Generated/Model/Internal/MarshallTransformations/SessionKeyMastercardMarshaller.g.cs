...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SessionKeyMastercardMarshaller : IRequestMarshaller<SessionKeyMastercard, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(SessionKeyMastercard requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetUnpredictableNumber())
            {
                context.Writer.WritePropertyName("UnpredictableNumber");
                context.Writer.WriteStringValue(requestObject.UnpredictableNumber);
            }
        }
        ...
        /// </summary>
        public readonly static SessionKeyMastercardMarshaller Instance = new SessionKeyMastercardMarshaller();
    }
}
