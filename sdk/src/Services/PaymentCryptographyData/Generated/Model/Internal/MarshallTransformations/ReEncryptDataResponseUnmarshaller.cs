...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReEncryptDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReEncryptDataResponse response = new ReEncryptDataResponse();
        ...
        private static ReEncryptDataResponseUnmarshaller _instance = new ReEncryptDataResponseUnmarshaller();        

        internal static ReEncryptDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReEncryptDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
