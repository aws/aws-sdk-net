...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VerifyAuthRequestCryptogramRequestMarshaller : IMarshaller<IRequest, VerifyAuthRequestCryptogramRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((VerifyAuthRequestCryptogramRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(VerifyAuthRequestCryptogramRequest publicRequest)
        {
        ...
        private static readonly VerifyAuthRequestCryptogramRequestMarshaller _instance = new();

        internal static VerifyAuthRequestCryptogramRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static VerifyAuthRequestCryptogramRequestMarshaller Instance => _instance;
    }
}
