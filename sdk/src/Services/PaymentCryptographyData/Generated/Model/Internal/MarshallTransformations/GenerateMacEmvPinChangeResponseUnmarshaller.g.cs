...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GenerateMacEmvPinChangeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GenerateMacEmvPinChangeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Mac = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NewPinPekArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NewPinPekKeyCheckValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecureMessagingConfidentialityKeyArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecureMessagingConfidentialityKeyCheckValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecureMessagingIntegrityKeyArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecureMessagingIntegrityKeyCheckValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("VisaAmexDerivationOutputs", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VisaAmexDerivationOutputs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GenerateMacEmvPinChangeResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GenerateMacEmvPinChangeResponseUnmarshaller Instance => _instance;
    }
}
