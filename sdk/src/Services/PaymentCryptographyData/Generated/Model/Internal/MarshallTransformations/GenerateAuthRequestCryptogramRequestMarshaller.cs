...
{
    /// <summary>
    /// GenerateAuthRequestCryptogram Request Marshaller
    /// </summary>       
    public class GenerateAuthRequestCryptogramRequestMarshaller : IMarshaller<IRequest, GenerateAuthRequestCryptogramRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GenerateAuthRequestCryptogramRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GenerateAuthRequestCryptogramRequest publicRequest)
        {
            ...
            request.ResourcePath = "/cryptogram/generate";
#if !NETFRAMEWORK
        ...
        private static GenerateAuthRequestCryptogramRequestMarshaller _instance = new GenerateAuthRequestCryptogramRequestMarshaller();        

        internal static GenerateAuthRequestCryptogramRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateAuthRequestCryptogramRequestMarshaller Instance
        {
            get
            {
                return _instance;
