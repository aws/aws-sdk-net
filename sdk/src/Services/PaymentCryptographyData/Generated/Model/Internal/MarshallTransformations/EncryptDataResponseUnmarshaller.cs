...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EncryptDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("CipherText", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CipherText = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static EncryptDataResponseUnmarshaller _instance = new EncryptDataResponseUnmarshaller();        

        internal static EncryptDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EncryptDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
