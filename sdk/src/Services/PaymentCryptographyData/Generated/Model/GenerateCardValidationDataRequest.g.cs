...
{
    /// <summary>
    /// Container for the parameters to the GenerateCardValidationData operation. Generates
    /// card-related validation data using algorithms such as Card Verification Values (CVV/CVV2),
    /// Dynamic Card Verification Values (dCVV/dCVV2), or Card Security Codes (CSC). For more
    /// information, see <a href="https://docs.aws.amazon.com/payment-cryptography/latest/userguide/generate-card-data.html">Generate
    ...
    /// should be set to <c>Generate</c> and <c>Verify</c> for a CVK encryption key. </para>
    ...
    /// </para> </li> <li> <para> <a>VerifyCardValidationData</a> </para> </li> </ul>
    /// </summary>
    public partial class GenerateCardValidationDataRequest : AmazonPaymentCryptographyDataRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ValidationDataLength property is set.
        /// </summary>
        internal bool IsSetValidationDataLength() => this.ValidationDataLength.HasValue;
    }
}
