...
namespace Amazon.PaymentCryptographyData.Model
{
    ...
    ///  <ul> <li> 
    /// <para>
    ///  <b>DUKPT</b>: <c>TDES</c> and <c>AES</c> algorithms. To encrypt using DUKPT, a DUKPT
    /// key must already exist within your account with <c>KeyModesOfUse</c> set to <c>DeriveKey</c>
    ...
    ///  </li> <li> 
    /// <para>
    ///  <b>Symmetric</b>: <c>TDES</c> and <c>AES</c> algorithms.
    /// </para>
    ///  </li> <li> 
    /// <para>
    ///  <b>Asymmetric</b>: <c>RSA</c>. You can use an <c>RSA</c> key on either the incoming
    /// or the outgoing side, paired with a symmetric key on the other side.
    /// </para>
    ///  </li> </ul> 
    /// <para>
