...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class GetApplicationResponse : AmazonWebServiceResponse
    {
        ...
        private IdCConfiguration _idcConfiguration;
        ...
        {
            get { return this._idcConfiguration; }
            set { this._idcConfiguration = value; }
        }

        // Check to see if IdcConfiguration property is set
        internal bool IsSetIdcConfiguration()
        {
            return this._idcConfiguration != null;
        }
