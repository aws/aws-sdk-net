...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class InitiateProviderRegistrationResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Checks to see if the CsrfState property is set.
        /// </summary>
        internal bool IsSetCsrfState() => this.CsrfState != null;
        ...
        /// <summary>
        /// Checks to see if the RedirectTo property is set.
        /// </summary>
        internal bool IsSetRedirectTo() => this.RedirectTo != null;
    }
}
