...
{
    /// <summary>
    /// Container for the parameters to the StopCodeReviewJob operation. Stops a running code
    /// review job. The job transitions to a stopping state and then to stopped after cleanup
    /// completes.
    /// </summary>
