...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class ListFindingsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<FindingSummary> FindingsSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<FindingSummary>() : null;

        /// <summary>
        /// Checks to see if the FindingsSummaries property is set.
        /// </summary>
        internal bool IsSetFindingsSummaries() => this.FindingsSummaries != null && (this.FindingsSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
