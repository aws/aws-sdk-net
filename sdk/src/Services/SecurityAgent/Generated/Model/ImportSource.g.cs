...
{
    /// <summary>
    /// The source from which to import security requirements. Currently supports document
    /// uploads.
    /// </summary>
    public partial class ImportSource
    {
        ...
        /// </summary>
        public List<SecurityRequirementArtifact> Documents { get; set; } = AWSConfigs.InitializeCollections ? new List<SecurityRequirementArtifact>() : null;
