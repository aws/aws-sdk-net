...
{
    /// <summary>
    /// Represents a target domain registered for penetration testing. A target domain must
    /// be verified through DNS TXT or HTTP route verification before it can be used in pentests.
    /// </summary>
