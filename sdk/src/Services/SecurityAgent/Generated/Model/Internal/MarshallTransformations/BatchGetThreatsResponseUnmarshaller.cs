...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetThreatsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetThreatsResponse response = new BatchGetThreatsResponse();
        ...
        internal static BatchGetThreatsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetThreatsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
