...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodeReviewJobTaskSummaryUnmarshaller : IJsonUnmarshaller<CodeReviewJobTaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CodeReviewJobTaskSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CodeReviewJobTaskSummaryUnmarshaller Instance => _instance;
    }
}
