...
{
    /// <summary>
    /// Response Unmarshaller for GetArtifact operation
    /// </summary>  
    public class GetArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetArtifactResponse response = new GetArtifactResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("artifact", targetDepth, ref reader))
                {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ArtifactId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetArtifactResponseUnmarshaller _instance = new GetArtifactResponseUnmarshaller();        

        internal static GetArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
