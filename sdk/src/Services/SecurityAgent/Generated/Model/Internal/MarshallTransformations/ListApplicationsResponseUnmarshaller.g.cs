...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListApplicationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListApplicationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("applicationSummaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ApplicationSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListApplicationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListApplicationsResponseUnmarshaller Instance => _instance;
    }
}
