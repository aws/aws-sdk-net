...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TargetDomainUnmarshaller : IJsonUnmarshaller<TargetDomain, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TargetDomain();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TargetDomainUnmarshaller Instance => _instance;
    }
}
