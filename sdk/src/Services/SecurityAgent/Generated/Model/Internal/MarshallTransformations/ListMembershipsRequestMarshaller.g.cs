...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMembershipsRequestMarshaller : IMarshaller<IRequest, ListMembershipsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListMembershipsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ListMemberships";
#if !NETFRAMEWORK
        ...
        private static readonly ListMembershipsRequestMarshaller _instance = new();

        internal static ListMembershipsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMembershipsRequestMarshaller Instance => _instance;
    }
}
