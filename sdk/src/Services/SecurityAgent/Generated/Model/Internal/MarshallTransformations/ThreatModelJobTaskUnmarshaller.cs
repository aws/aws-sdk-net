...
{
    /// <summary>
    /// Response Unmarshaller for ThreatModelJobTask Object
    /// </summary>  
    public class ThreatModelJobTaskUnmarshaller : IJsonUnmarshaller<ThreatModelJobTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThreatModelJobTask Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ThreatModelJobTask unmarshalledObject = new ThreatModelJobTask();
        ...
        private static ThreatModelJobTaskUnmarshaller _instance = new ThreatModelJobTaskUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ThreatModelJobTaskUnmarshaller Instance
        {
            get
            {
                return _instance;
