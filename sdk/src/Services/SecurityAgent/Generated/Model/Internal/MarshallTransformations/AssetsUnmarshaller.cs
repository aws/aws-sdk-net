...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetsUnmarshaller : IJsonUnmarshaller<Assets, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            Assets unmarshalledObject = new Assets();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssetsUnmarshaller Instance
        {
            get
            {
                return _instance;
