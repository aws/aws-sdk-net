...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePrivateConnectionCertificate operation
    /// </summary>  
    public class UpdatePrivateConnectionCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePrivateConnectionCertificateResponse response = new UpdatePrivateConnectionCertificateResponse();
        ...
        private static UpdatePrivateConnectionCertificateResponseUnmarshaller _instance = new UpdatePrivateConnectionCertificateResponseUnmarshaller();        

        internal static UpdatePrivateConnectionCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePrivateConnectionCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
