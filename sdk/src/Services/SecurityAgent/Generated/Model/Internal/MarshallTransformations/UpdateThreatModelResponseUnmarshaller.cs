...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateThreatModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThreatModelResponse response = new UpdateThreatModelResponse();
        ...
        internal static UpdateThreatModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThreatModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
