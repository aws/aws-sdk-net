...
{
    /// <summary>
    /// UpdateCodeReview Request Marshaller
    /// </summary>
    public partial class UpdateCodeReviewRequestMarshaller : IMarshaller<IRequest, UpdateCodeReviewRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCodeReviewRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateCodeReviewRequest publicRequest)
        {
            ...
            request.ResourcePath = "/UpdateCodeReview";
#if !NETFRAMEWORK
        ...
        private static readonly UpdateCodeReviewRequestMarshaller _instance = new();

        internal static UpdateCodeReviewRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateCodeReviewRequestMarshaller Instance => _instance;
    }
}
