...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ThreatSummaryUnmarshaller : IJsonUnmarshaller<ThreatSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ThreatSummary unmarshalledObject = new ThreatSummary();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ThreatSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
