...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateThreatRequestMarshaller : IMarshaller<IRequest, UpdateThreatRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateThreatRequestMarshaller _instance = new();

        internal static UpdateThreatRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateThreatRequestMarshaller Instance => _instance;
    }
}
