...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DocumentInfoUnmarshaller : IJsonUnmarshaller<DocumentInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DocumentInfo();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DocumentInfoUnmarshaller Instance => _instance;
    }
}
