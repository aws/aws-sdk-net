...
{
    /// <summary>
    /// BatchGetFindings Request Marshaller
    /// </summary>       
    public class BatchGetFindingsRequestMarshaller : IMarshaller<IRequest, BatchGetFindingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchGetFindingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchGetFindingsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/BatchGetFindings";
#if !NETFRAMEWORK
        ...
        private static BatchGetFindingsRequestMarshaller _instance = new BatchGetFindingsRequestMarshaller();        

        internal static BatchGetFindingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetFindingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
