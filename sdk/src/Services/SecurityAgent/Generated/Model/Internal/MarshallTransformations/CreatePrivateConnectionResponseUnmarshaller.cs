...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreatePrivateConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePrivateConnectionResponse response = new CreatePrivateConnectionResponse();
        ...
        internal static CreatePrivateConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePrivateConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
