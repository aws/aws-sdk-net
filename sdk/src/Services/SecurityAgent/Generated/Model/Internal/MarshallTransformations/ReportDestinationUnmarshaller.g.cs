...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReportDestinationUnmarshaller : IJsonUnmarshaller<ReportDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReportDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReportDestinationUnmarshaller Instance => _instance;
    }
}
