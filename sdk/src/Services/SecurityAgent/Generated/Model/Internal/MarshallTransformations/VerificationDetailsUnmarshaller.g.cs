...
{
    /// <summary>
    /// Response Unmarshaller for VerificationDetails Object
    /// </summary>
    public partial class VerificationDetailsUnmarshaller : IJsonUnmarshaller<VerificationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public VerificationDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new VerificationDetails();
        ...
        private static VerificationDetailsUnmarshaller _instance = new VerificationDetailsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static VerificationDetailsUnmarshaller Instance => _instance;
    }
}
