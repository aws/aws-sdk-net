...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteIntegrationRequestMarshaller : IMarshaller<IRequest, DeleteIntegrationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteIntegrationRequestMarshaller _instance = new();

        internal static DeleteIntegrationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteIntegrationRequestMarshaller Instance => _instance;
    }
}
