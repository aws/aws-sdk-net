...
{
    /// <summary>
    /// StartCodeRemediation Request Marshaller
    /// </summary>
    public partial class StartCodeRemediationRequestMarshaller : IMarshaller<IRequest, StartCodeRemediationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartCodeRemediationRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(StartCodeRemediationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/StartCodeRemediation";
#if !NETFRAMEWORK
        ...
        private static readonly StartCodeRemediationRequestMarshaller _instance = new();

        internal static StartCodeRemediationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartCodeRemediationRequestMarshaller Instance => _instance;
    }
}
