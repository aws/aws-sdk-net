...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateThreatModelRequestMarshaller : IMarshaller<IRequest, UpdateThreatModelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateThreatModelRequestMarshaller _instance = new();

        internal static UpdateThreatModelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateThreatModelRequestMarshaller Instance => _instance;
    }
}
