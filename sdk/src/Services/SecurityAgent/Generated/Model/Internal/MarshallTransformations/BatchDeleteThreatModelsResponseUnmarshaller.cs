...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDeleteThreatModelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteThreatModelsResponse response = new BatchDeleteThreatModelsResponse();
        ...
        internal static BatchDeleteThreatModelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteThreatModelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
