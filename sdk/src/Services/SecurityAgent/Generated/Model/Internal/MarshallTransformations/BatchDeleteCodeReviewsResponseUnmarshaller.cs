...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteCodeReviews operation
    /// </summary>  
    public class BatchDeleteCodeReviewsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteCodeReviewsResponse response = new BatchDeleteCodeReviewsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DeleteCodeReviewFailure, DeleteCodeReviewFailureUnmarshaller>(DeleteCodeReviewFailureUnmarshaller.Instance);
        ...
        private static BatchDeleteCodeReviewsResponseUnmarshaller _instance = new BatchDeleteCodeReviewsResponseUnmarshaller();        

        internal static BatchDeleteCodeReviewsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteCodeReviewsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
