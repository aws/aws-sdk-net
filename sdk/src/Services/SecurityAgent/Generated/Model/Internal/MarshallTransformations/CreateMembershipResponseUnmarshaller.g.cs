...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateMembershipResponse();
        ...
        internal static CreateMembershipResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMembershipResponseUnmarshaller Instance => _instance;
    }
}
