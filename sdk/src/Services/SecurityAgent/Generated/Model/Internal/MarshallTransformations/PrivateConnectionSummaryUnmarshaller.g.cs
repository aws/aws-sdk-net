...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PrivateConnectionSummaryUnmarshaller : IJsonUnmarshaller<PrivateConnectionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PrivateConnectionSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PrivateConnectionSummaryUnmarshaller Instance => _instance;
    }
}
