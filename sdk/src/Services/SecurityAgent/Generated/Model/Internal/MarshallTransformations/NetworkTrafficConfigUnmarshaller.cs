...
{
    /// <summary>
    /// Response Unmarshaller for NetworkTrafficConfig Object
    /// </summary>  
    public class NetworkTrafficConfigUnmarshaller : IJsonUnmarshaller<NetworkTrafficConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkTrafficConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            NetworkTrafficConfig unmarshalledObject = new NetworkTrafficConfig();
        ...
        private static NetworkTrafficConfigUnmarshaller _instance = new NetworkTrafficConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NetworkTrafficConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
