...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    public class ListFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("findingsSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FindingSummary, FindingSummaryUnmarshaller>(FindingSummaryUnmarshaller.Instance);
                    response.FindingsSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
