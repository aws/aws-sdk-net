...
{
    /// <summary>
    /// Response Unmarshaller for CreateCodeReview operation.
    /// </summary>
    public partial class CreateCodeReviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateCodeReviewResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CodeRemediationStrategy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("maxTaskHours", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MaxTaskHours = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("reportFilters", targetDepth, ref reader))
                {
                    var unmarshaller = ReportFiltersUnmarshaller.Instance;
                    unmarshalledObject.ReportFilters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ValidationMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateCodeReviewResponseUnmarshaller _instance = new CreateCodeReviewResponseUnmarshaller();

        internal static CreateCodeReviewResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCodeReviewResponseUnmarshaller Instance => _instance;
    }
}
