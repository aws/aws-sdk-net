...
{
    /// <summary>
    /// UpdateThreatModel Request Marshaller
    /// </summary>       
    public class UpdateThreatModelRequestMarshaller : IMarshaller<IRequest, UpdateThreatModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateThreatModelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateThreatModelRequest publicRequest)
        {
            ...
            request.ResourcePath = "/UpdateThreatModel";
#if !NETFRAMEWORK
        ...
        private static UpdateThreatModelRequestMarshaller _instance = new UpdateThreatModelRequestMarshaller();        

        internal static UpdateThreatModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThreatModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
