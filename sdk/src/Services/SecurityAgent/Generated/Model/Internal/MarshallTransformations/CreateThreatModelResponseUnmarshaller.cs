...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateThreatModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateThreatModelResponse response = new CreateThreatModelResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("scopeDocs", targetDepth, ref reader))
                {
                    ...
                    response.ScopeDocs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ThreatModelId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateThreatModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThreatModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
