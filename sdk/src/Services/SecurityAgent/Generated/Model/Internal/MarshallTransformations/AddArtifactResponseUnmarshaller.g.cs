...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AddArtifactResponse();
        ...
        internal static AddArtifactResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddArtifactResponseUnmarshaller Instance => _instance;
    }
}
