...
{
    /// <summary>
    /// UpdateThreat Request Marshaller
    /// </summary>       
    public class UpdateThreatRequestMarshaller : IMarshaller<IRequest, UpdateThreatRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateThreatRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateThreatRequest publicRequest)
        {
            ...
            request.ResourcePath = "/UpdateThreat";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetThreatId())
            {
                context.Writer.WritePropertyName("threatId");
                context.Writer.WriteStringValue(publicRequest.ThreatId);
            }
        ...
        private static UpdateThreatRequestMarshaller _instance = new UpdateThreatRequestMarshaller();        

        internal static UpdateThreatRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThreatRequestMarshaller Instance
        {
            get
            {
                return _instance;
