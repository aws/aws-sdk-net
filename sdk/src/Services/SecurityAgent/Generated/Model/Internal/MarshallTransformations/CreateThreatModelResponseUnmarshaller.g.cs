...
{
    /// <summary>
    /// Response Unmarshaller for CreateThreatModel operation.
    /// </summary>
    public partial class CreateThreatModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateThreatModelResponse();
        ...
        private static CreateThreatModelResponseUnmarshaller _instance = new CreateThreatModelResponseUnmarshaller();

        internal static CreateThreatModelResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateThreatModelResponseUnmarshaller Instance => _instance;
    }
}
