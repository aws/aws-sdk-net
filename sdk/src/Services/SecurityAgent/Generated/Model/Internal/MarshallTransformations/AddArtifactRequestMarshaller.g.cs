...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddArtifactRequestMarshaller : IMarshaller<IRequest, AddArtifactRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AddArtifactRequestMarshaller _instance = new();

        internal static AddArtifactRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddArtifactRequestMarshaller Instance => _instance;
    }
}
