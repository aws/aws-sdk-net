...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerificationScriptUnmarshaller : IJsonUnmarshaller<VerificationScript, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            VerificationScript unmarshalledObject = new VerificationScript();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerificationScriptUnmarshaller Instance
        {
            get
            {
                return _instance;
