...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuthenticationUnmarshaller : IJsonUnmarshaller<Authentication, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Authentication();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AuthenticationUnmarshaller Instance => _instance;
    }
}
