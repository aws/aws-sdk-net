...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListThreatsRequestMarshaller : IMarshaller<IRequest, ListThreatsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListThreatsRequestMarshaller _instance = new ListThreatsRequestMarshaller();        

        internal static ListThreatsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListThreatsRequestMarshaller Instance
        {
            get
            {
                return _instance;
