...
{
    /// <summary>
    /// Response Unmarshaller for ListIntegrations operation.
    /// </summary>
    public partial class ListIntegrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListIntegrationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("integrationSummaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IntegrationSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListIntegrationsResponseUnmarshaller _instance = new ListIntegrationsResponseUnmarshaller();

        internal static ListIntegrationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListIntegrationsResponseUnmarshaller Instance => _instance;
    }
}
