...
{
    /// <summary>
    /// Response Unmarshaller for ThreatModelJobTaskSummary Object
    /// </summary>  
    public class ThreatModelJobTaskSummaryUnmarshaller : IJsonUnmarshaller<ThreatModelJobTaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThreatModelJobTaskSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ThreatModelJobTaskSummary unmarshalledObject = new ThreatModelJobTaskSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("threatModelJobId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ThreatModelJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ThreatModelJobTaskSummaryUnmarshaller _instance = new ThreatModelJobTaskSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ThreatModelJobTaskSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
