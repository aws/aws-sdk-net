...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ThreatModelJobTaskUnmarshaller : IJsonUnmarshaller<ThreatModelJobTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ThreatModelJobTask();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ThreatModelJobTaskUnmarshaller Instance => _instance;
    }
}
