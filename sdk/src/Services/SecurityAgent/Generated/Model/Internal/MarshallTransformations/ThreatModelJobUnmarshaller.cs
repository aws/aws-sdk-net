...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ThreatModelJobUnmarshaller : IJsonUnmarshaller<ThreatModelJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ThreatModelJob unmarshalledObject = new ThreatModelJob();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ThreatModelJobUnmarshaller Instance
        {
            get
            {
                return _instance;
