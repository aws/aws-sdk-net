...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodeReviewSummaryUnmarshaller : IJsonUnmarshaller<CodeReviewSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CodeReviewSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CodeReviewSummaryUnmarshaller Instance => _instance;
    }
}
