...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateFindingRequestMarshaller : IMarshaller<IRequest, UpdateFindingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateFindingRequestMarshaller _instance = new UpdateFindingRequestMarshaller();        

        internal static UpdateFindingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFindingRequestMarshaller Instance
        {
            get
            {
                return _instance;
