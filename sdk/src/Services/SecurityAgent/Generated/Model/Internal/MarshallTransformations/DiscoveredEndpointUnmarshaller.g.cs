...
{
    /// <summary>
    /// Response Unmarshaller for DiscoveredEndpoint Object
    /// </summary>
    public partial class DiscoveredEndpointUnmarshaller : IJsonUnmarshaller<DiscoveredEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public DiscoveredEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new DiscoveredEndpoint();
        ...
        private static DiscoveredEndpointUnmarshaller _instance = new DiscoveredEndpointUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DiscoveredEndpointUnmarshaller Instance => _instance;
    }
}
