...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThreat operation
    /// </summary>  
    public class UpdateThreatResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThreatResponse response = new UpdateThreatResponse();
        ...
        private static UpdateThreatResponseUnmarshaller _instance = new UpdateThreatResponseUnmarshaller();        

        internal static UpdateThreatResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThreatResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
