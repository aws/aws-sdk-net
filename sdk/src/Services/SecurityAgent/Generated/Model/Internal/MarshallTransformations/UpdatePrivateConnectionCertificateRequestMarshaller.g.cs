...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdatePrivateConnectionCertificateRequestMarshaller : IMarshaller<IRequest, UpdatePrivateConnectionCertificateRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdatePrivateConnectionCertificateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/UpdatePrivateConnectionCertificate";
#if !NETFRAMEWORK
        ...
        private static readonly UpdatePrivateConnectionCertificateRequestMarshaller _instance = new();

        internal static UpdatePrivateConnectionCertificateRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePrivateConnectionCertificateRequestMarshaller Instance => _instance;
    }
}
