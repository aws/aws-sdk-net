...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NetworkTrafficConfigUnmarshaller : IJsonUnmarshaller<NetworkTrafficConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new NetworkTrafficConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static NetworkTrafficConfigUnmarshaller Instance => _instance;
    }
}
