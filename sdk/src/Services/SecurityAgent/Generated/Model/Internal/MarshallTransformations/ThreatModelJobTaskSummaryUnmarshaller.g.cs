...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ThreatModelJobTaskSummaryUnmarshaller : IJsonUnmarshaller<ThreatModelJobTaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ThreatModelJobTaskSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ThreatModelJobTaskSummaryUnmarshaller Instance => _instance;
    }
}
