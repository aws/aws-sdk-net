...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ThreatModelUnmarshaller : IJsonUnmarshaller<ThreatModel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ThreatModel();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ThreatModelUnmarshaller Instance => _instance;
    }
}
