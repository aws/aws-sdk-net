...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTargetDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTargetDomainResponse response = new CreateTargetDomainResponse();
        ...
        internal static CreateTargetDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTargetDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
