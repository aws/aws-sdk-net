...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ArtifactUnmarshaller : IJsonUnmarshaller<Artifact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Artifact Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
