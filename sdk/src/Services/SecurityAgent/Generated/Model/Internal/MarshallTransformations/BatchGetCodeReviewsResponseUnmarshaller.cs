...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetCodeReviews operation
    /// </summary>  
    public class BatchGetCodeReviewsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetCodeReviewsResponse response = new BatchGetCodeReviewsResponse();
            ...
            {
                if (context.TestExpression("codeReviews", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CodeReview, CodeReviewUnmarshaller>(CodeReviewUnmarshaller.Instance);
                    response.CodeReviews = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static BatchGetCodeReviewsResponseUnmarshaller _instance = new BatchGetCodeReviewsResponseUnmarshaller();        

        internal static BatchGetCodeReviewsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetCodeReviewsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
