...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    public class VpcConfigMarshaller : IRequestMarshaller<VpcConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(VpcConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSubnetArns())
            {
                context.Writer.WritePropertyName("subnetArns");
                context.Writer.WriteStartArray();
                foreach(var requestObjectSubnetArnsListValue in requestObject.SubnetArns)
                {
                        context.Writer.WriteStringValue(requestObjectSubnetArnsListValue);
                }
                context.Writer.WriteEndArray();
            }

            if(requestObject.IsSetVpcArn())
            {
                context.Writer.WritePropertyName("vpcArn");
                context.Writer.WriteStringValue(requestObject.VpcArn);
            }
