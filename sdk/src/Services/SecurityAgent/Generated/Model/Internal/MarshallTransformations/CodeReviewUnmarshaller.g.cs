...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodeReviewUnmarshaller : IJsonUnmarshaller<CodeReview, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CodeReview Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CodeReview();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CodeReviewUnmarshaller Instance => _instance;
    }
}
