    ...
    public partial class TaskUnmarshaller : IJsonUnmarshaller<Task, JsonUnmarshallerContext>
    {
        ...
        public Task Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("targetEndpoint", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("taskHours", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.TaskHours = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
