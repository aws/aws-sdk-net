...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodeReviewJobTaskUnmarshaller : IJsonUnmarshaller<CodeReviewJobTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CodeReviewJobTask();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CodeReviewJobTaskUnmarshaller Instance => _instance;
    }
}
