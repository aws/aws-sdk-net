...
{
    /// <summary>
    /// Response Unmarshaller for StopThreatModelJob operation
    /// </summary>  
    public class StopThreatModelJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopThreatModelJobResponse response = new StopThreatModelJobResponse();
        ...
        private static StopThreatModelJobResponseUnmarshaller _instance = new StopThreatModelJobResponseUnmarshaller();        

        internal static StopThreatModelJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopThreatModelJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
