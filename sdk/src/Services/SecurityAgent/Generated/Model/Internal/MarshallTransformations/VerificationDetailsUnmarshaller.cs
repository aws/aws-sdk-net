...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerificationDetailsUnmarshaller : IJsonUnmarshaller<VerificationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            VerificationDetails unmarshalledObject = new VerificationDetails();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerificationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
