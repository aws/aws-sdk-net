...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTargetDomain operation
    /// </summary>  
    public class UpdateTargetDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTargetDomainResponse response = new UpdateTargetDomainResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TargetDomainId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("verificationDetails", targetDepth, ref reader))
                {
                    var unmarshaller = VerificationDetailsUnmarshaller.Instance;
                    response.VerificationDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.VerifiedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateTargetDomainResponseUnmarshaller _instance = new UpdateTargetDomainResponseUnmarshaller();        

        internal static UpdateTargetDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTargetDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
