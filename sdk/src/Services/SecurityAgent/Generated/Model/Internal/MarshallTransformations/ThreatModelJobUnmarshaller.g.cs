...
{
    /// <summary>
    /// Response Unmarshaller for ThreatModelJob Object
    /// </summary>
    public partial class ThreatModelJobUnmarshaller : IJsonUnmarshaller<ThreatModelJob, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ThreatModelJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ThreatModelJob();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("errorInformation", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("systemOverview", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SystemOverview = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ThreatModelJobUnmarshaller _instance = new ThreatModelJobUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ThreatModelJobUnmarshaller Instance => _instance;
    }
}
