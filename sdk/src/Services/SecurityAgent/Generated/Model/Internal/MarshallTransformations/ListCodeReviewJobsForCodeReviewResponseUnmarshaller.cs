...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListCodeReviewJobsForCodeReviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCodeReviewJobsForCodeReviewResponse response = new ListCodeReviewJobsForCodeReviewResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("codeReviewJobSummaries", targetDepth))
                {
                    ...
                    response.CodeReviewJobSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListCodeReviewJobsForCodeReviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCodeReviewJobsForCodeReviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
