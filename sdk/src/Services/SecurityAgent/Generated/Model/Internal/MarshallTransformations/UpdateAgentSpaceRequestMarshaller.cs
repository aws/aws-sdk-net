...
{
    /// <summary>
    /// UpdateAgentSpace Request Marshaller
    /// </summary>       
    public class UpdateAgentSpaceRequestMarshaller : IMarshaller<IRequest, UpdateAgentSpaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAgentSpaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAgentSpaceRequest publicRequest)
        {
            ...
            request.ResourcePath = "/UpdateAgentSpace";
#if !NETFRAMEWORK
        ...
        private static UpdateAgentSpaceRequestMarshaller _instance = new UpdateAgentSpaceRequestMarshaller();        

        internal static UpdateAgentSpaceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentSpaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
