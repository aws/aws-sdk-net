...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodeReviewJobUnmarshaller : IJsonUnmarshaller<CodeReviewJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            CodeReviewJob unmarshalledObject = new CodeReviewJob();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CodeReviewJobUnmarshaller Instance
        {
            get
            {
                return _instance;
