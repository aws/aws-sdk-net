...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAgentSpaceRequestMarshaller : IMarshaller<IRequest, CreateAgentSpaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateAgentSpaceRequestMarshaller _instance = new();

        internal static CreateAgentSpaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAgentSpaceRequestMarshaller Instance => _instance;
    }
}
