...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribePrivateConnectionRequestMarshaller : IMarshaller<IRequest, DescribePrivateConnectionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribePrivateConnectionRequestMarshaller _instance = new();

        internal static DescribePrivateConnectionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribePrivateConnectionRequestMarshaller Instance => _instance;
    }
}
