...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateIntegratedResourcesRequestMarshaller : IMarshaller<IRequest, UpdateIntegratedResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateIntegratedResourcesRequestMarshaller _instance = new UpdateIntegratedResourcesRequestMarshaller();        

        internal static UpdateIntegratedResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIntegratedResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
