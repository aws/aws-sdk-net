...
{
    /// <summary>
    /// UpdateIntegratedResources Request Marshaller
    /// </summary>
    public partial class UpdateIntegratedResourcesRequestMarshaller : IMarshaller<IRequest, UpdateIntegratedResourcesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateIntegratedResourcesRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateIntegratedResourcesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/UpdateIntegratedResources";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetItems())
            {
                ...
                foreach (var publicRequestItemsListValue in publicRequest.Items)
                {
                    ...
                    var marshaller = IntegratedResourceInputItemMarshaller.Instance;
        ...
        private static readonly UpdateIntegratedResourcesRequestMarshaller _instance = new();

        internal static UpdateIntegratedResourcesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIntegratedResourcesRequestMarshaller Instance => _instance;
    }
}
