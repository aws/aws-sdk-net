...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetCodeReviewJobs operation
    /// </summary>  
    public class BatchGetCodeReviewJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetCodeReviewJobsResponse response = new BatchGetCodeReviewJobsResponse();
        ...
        private static BatchGetCodeReviewJobsResponseUnmarshaller _instance = new BatchGetCodeReviewJobsResponseUnmarshaller();        

        internal static BatchGetCodeReviewJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetCodeReviewJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
