...
{
    /// <summary>
    /// Response Unmarshaller for StartThreatModelJob operation
    /// </summary>  
    public class StartThreatModelJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartThreatModelJobResponse response = new StartThreatModelJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ThreatModelJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartThreatModelJobResponseUnmarshaller _instance = new StartThreatModelJobResponseUnmarshaller();        

        internal static StartThreatModelJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartThreatModelJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
