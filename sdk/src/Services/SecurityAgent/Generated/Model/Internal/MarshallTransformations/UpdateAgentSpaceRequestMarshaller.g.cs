...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAgentSpaceRequestMarshaller : IMarshaller<IRequest, UpdateAgentSpaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAgentSpaceRequestMarshaller _instance = new();

        internal static UpdateAgentSpaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAgentSpaceRequestMarshaller Instance => _instance;
    }
}
