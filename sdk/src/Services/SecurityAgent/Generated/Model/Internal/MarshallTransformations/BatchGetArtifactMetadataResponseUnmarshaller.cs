...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetArtifactMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetArtifactMetadataResponse response = new BatchGetArtifactMetadataResponse();
        ...
        internal static BatchGetArtifactMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetArtifactMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
