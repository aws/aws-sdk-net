...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCodeReview operation
    /// </summary>  
    public class UpdateCodeReviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCodeReviewResponse response = new UpdateCodeReviewResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("codeRemediationStrategy", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CodeRemediationStrategy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("codeReviewId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CodeReviewId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateCodeReviewResponseUnmarshaller _instance = new UpdateCodeReviewResponseUnmarshaller();        

        internal static UpdateCodeReviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCodeReviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
