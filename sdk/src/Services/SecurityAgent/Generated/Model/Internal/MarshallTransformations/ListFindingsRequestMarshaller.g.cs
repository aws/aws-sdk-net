...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListFindingsRequestMarshaller : IMarshaller<IRequest, ListFindingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListFindingsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ListFindings";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetConfidence())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.Confidence);
            }
            ...
            if (publicRequest.IsSetPentestJobId())
            {
                context.Writer.WritePropertyName("pentestJobId");
                context.Writer.WriteStringValue(publicRequest.PentestJobId);
            }
