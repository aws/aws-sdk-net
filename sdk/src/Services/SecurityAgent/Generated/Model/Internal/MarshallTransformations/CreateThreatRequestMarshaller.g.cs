...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateThreatRequestMarshaller : IMarshaller<IRequest, CreateThreatRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateThreatRequestMarshaller _instance = new();

        internal static CreateThreatRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateThreatRequestMarshaller Instance => _instance;
    }
}
