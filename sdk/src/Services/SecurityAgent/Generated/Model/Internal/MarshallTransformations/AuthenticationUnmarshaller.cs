...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthenticationUnmarshaller : IJsonUnmarshaller<Authentication, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Authentication Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Authentication unmarshalledObject = new Authentication();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AuthenticationUnmarshaller Instance
        {
            get
            {
                return _instance;
