...
{
    /// <summary>
    /// Response Unmarshaller for CodeReviewJobTask Object
    /// </summary>  
    public class CodeReviewJobTaskUnmarshaller : IJsonUnmarshaller<CodeReviewJobTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CodeReviewJobTask Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CodeReviewJobTask unmarshalledObject = new CodeReviewJobTask();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("logsLocation", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("riskType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static CodeReviewJobTaskUnmarshaller _instance = new CodeReviewJobTaskUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CodeReviewJobTaskUnmarshaller Instance
        {
            get
            {
                return _instance;
