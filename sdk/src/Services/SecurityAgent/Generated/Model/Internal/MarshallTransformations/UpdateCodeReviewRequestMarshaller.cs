...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateCodeReviewRequestMarshaller : IMarshaller<IRequest, UpdateCodeReviewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateCodeReviewRequestMarshaller _instance = new UpdateCodeReviewRequestMarshaller();        

        internal static UpdateCodeReviewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCodeReviewRequestMarshaller Instance
        {
            get
            {
                return _instance;
