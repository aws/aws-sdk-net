...
{
    /// <summary>
    /// Response Unmarshaller for DeletePrivateConnection operation
    /// </summary>  
    public class DeletePrivateConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePrivateConnectionResponse response = new DeletePrivateConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HostAddress = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeletePrivateConnectionResponseUnmarshaller _instance = new DeletePrivateConnectionResponseUnmarshaller();        

        internal static DeletePrivateConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePrivateConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
