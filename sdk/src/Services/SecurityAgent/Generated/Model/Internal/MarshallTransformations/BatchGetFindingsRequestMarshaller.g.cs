...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetFindingsRequestMarshaller : IMarshaller<IRequest, BatchGetFindingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchGetFindingsRequestMarshaller _instance = new();

        internal static BatchGetFindingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetFindingsRequestMarshaller Instance => _instance;
    }
}
