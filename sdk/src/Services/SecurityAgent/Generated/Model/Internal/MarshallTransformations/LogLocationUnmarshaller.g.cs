...
{
    /// <summary>
    /// Response Unmarshaller for LogLocation Object
    /// </summary>
    public partial class LogLocationUnmarshaller : IJsonUnmarshaller<LogLocation, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public LogLocation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new LogLocation();
        ...
        private static LogLocationUnmarshaller _instance = new LogLocationUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static LogLocationUnmarshaller Instance => _instance;
    }
}
