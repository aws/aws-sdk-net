...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DiscoveredEndpointUnmarshaller : IJsonUnmarshaller<DiscoveredEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            DiscoveredEndpoint unmarshalledObject = new DiscoveredEndpoint();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DiscoveredEndpointUnmarshaller Instance
        {
            get
            {
                return _instance;
