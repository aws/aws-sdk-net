...
{
    /// <summary>
    /// Response Unmarshaller for ThreatSummary Object
    /// </summary>
    public partial class ThreatSummaryUnmarshaller : IJsonUnmarshaller<ThreatSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ThreatSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ThreatSummary();
        ...
        private static ThreatSummaryUnmarshaller _instance = new ThreatSummaryUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ThreatSummaryUnmarshaller Instance => _instance;
    }
}
