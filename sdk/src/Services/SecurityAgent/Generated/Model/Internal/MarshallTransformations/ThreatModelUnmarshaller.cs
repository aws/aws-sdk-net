...
{
    /// <summary>
    /// Response Unmarshaller for ThreatModel Object
    /// </summary>  
    public class ThreatModelUnmarshaller : IJsonUnmarshaller<ThreatModel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThreatModel Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ThreatModel unmarshalledObject = new ThreatModel();
        ...
        private static ThreatModelUnmarshaller _instance = new ThreatModelUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ThreatModelUnmarshaller Instance
        {
            get
            {
                return _instance;
