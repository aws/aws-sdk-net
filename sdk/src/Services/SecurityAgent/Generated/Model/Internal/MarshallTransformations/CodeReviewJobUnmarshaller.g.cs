...
{
    /// <summary>
    /// Response Unmarshaller for CodeReviewJob Object
    /// </summary>
    public partial class CodeReviewJobUnmarshaller : IJsonUnmarshaller<CodeReviewJob, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CodeReviewJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CodeReviewJob();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ExecutionContext, ExecutionContextUnmarshaller>(ExecutionContextUnmarshaller.Instance);
        ...
        private static CodeReviewJobUnmarshaller _instance = new CodeReviewJobUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CodeReviewJobUnmarshaller Instance => _instance;
    }
}
