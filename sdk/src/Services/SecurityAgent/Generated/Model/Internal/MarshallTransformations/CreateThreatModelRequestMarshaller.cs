...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateThreatModelRequestMarshaller : IMarshaller<IRequest, CreateThreatModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateThreatModelRequestMarshaller _instance = new CreateThreatModelRequestMarshaller();        

        internal static CreateThreatModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThreatModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
