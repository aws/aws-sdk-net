...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateIntegrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateIntegrationResponse();
        ...
        internal static CreateIntegrationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateIntegrationResponseUnmarshaller Instance => _instance;
    }
}
