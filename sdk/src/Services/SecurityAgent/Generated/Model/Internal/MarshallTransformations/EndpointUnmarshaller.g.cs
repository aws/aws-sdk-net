...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EndpointUnmarshaller : IJsonUnmarshaller<Endpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Endpoint();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EndpointUnmarshaller Instance => _instance;
    }
}
