...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IntegratedRepositoryUnmarshaller : IJsonUnmarshaller<IntegratedRepository, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IntegratedRepository();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IntegratedRepositoryUnmarshaller Instance => _instance;
    }
}
