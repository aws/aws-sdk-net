...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class InitiateProviderRegistrationRequestMarshaller : IMarshaller<IRequest, InitiateProviderRegistrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static InitiateProviderRegistrationRequestMarshaller _instance = new InitiateProviderRegistrationRequestMarshaller();        

        internal static InitiateProviderRegistrationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InitiateProviderRegistrationRequestMarshaller Instance
        {
            get
            {
                return _instance;
