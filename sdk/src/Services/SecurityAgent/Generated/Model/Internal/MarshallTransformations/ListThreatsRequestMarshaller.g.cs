...
{
    /// <summary>
    /// ListThreats Request Marshaller
    /// </summary>
    public partial class ListThreatsRequestMarshaller : IMarshaller<IRequest, ListThreatsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListThreatsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListThreatsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ListThreats";
#if !NETFRAMEWORK
        ...
        private static readonly ListThreatsRequestMarshaller _instance = new();

        internal static ListThreatsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListThreatsRequestMarshaller Instance => _instance;
    }
}
