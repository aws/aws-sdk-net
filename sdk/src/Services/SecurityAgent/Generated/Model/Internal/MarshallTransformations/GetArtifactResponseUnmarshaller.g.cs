...
namespace Amazon.SecurityAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetArtifactResponse();
        ...
        internal static GetArtifactResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetArtifactResponseUnmarshaller Instance => _instance;
    }
}
