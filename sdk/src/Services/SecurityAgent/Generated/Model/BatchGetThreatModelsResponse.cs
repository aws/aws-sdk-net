...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class BatchGetThreatModelsResponse : AmazonWebServiceResponse
    {
        ...
        private List<ThreatModel> _threatModels = AWSConfigs.InitializeCollections ? new List<ThreatModel>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ThreatModel> ThreatModels
        {
            get { return this._threatModels; }
            set { this._threatModels = value; }
        }

        // Check to see if ThreatModels property is set
        internal bool IsSetThreatModels()
        {
            return this._threatModels != null && (this._threatModels.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
