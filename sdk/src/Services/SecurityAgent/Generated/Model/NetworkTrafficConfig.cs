...
namespace Amazon.SecurityAgent.Model
{
    ...
    {
        private List<CustomHeader> _customHeaders = AWSConfigs.InitializeCollections ? new List<CustomHeader>() : null;
        private List<NetworkTrafficRule> _rules = AWSConfigs.InitializeCollections ? new List<NetworkTrafficRule>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<NetworkTrafficRule> Rules
        {
