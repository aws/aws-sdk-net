...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class BatchGetArtifactMetadataRequest : AmazonSecurityAgentRequest
    {
        ...
        private List<string> _artifactIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        {
            get { return this._artifactIds; }
            set { this._artifactIds = value; }
        }

        // Check to see if ArtifactIds property is set
        internal bool IsSetArtifactIds()
        {
            return this._artifactIds != null && (this._artifactIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
