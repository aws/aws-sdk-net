...
{
    /// <summary>
    /// Container for the parameters to the VerifyTargetDomain operation. Initiates verification
    /// of a target domain. This checks whether the domain ownership verification token has
