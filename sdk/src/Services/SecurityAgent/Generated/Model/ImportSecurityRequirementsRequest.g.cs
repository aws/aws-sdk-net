...
{
    /// <summary>
    /// Container for the parameters to the ImportSecurityRequirements operation. Imports
    /// security requirements from uploaded documents into a customer managed security requirement
    /// pack. The import process asynchronously extracts and generates structured security
    ...
    public partial class ImportSecurityRequirementsRequest : AmazonSecurityAgentRequest
    {
        ...
        public ImportSource Input { get; set; }
