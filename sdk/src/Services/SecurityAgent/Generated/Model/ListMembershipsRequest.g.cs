...
{
    /// <summary>
    /// Container for the parameters to the ListMemberships operation. Returns a paginated
    /// list of membership summaries for the specified agent space within an application.
    /// </summary>
    public partial class ListMembershipsRequest : AmazonSecurityAgentRequest
    {
        ...
        /// </para>
        /// </summary>
        public MembershipTypeFilter MemberType { get; set; }
