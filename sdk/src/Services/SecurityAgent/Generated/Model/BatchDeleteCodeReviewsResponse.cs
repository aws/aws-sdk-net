...
namespace Amazon.SecurityAgent.Model
{
    ...
    /// </summary>
    public partial class BatchDeleteCodeReviewsResponse : AmazonWebServiceResponse
    {
        private List<string> _deleted = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private List<DeleteCodeReviewFailure> _failed = AWSConfigs.InitializeCollections ? new List<DeleteCodeReviewFailure>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<DeleteCodeReviewFailure> Failed
        {
