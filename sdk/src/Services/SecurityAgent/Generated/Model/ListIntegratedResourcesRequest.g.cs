...
{
    /// <summary>
    /// Container for the parameters to the ListIntegratedResources operation. Lists the integrated
    /// resources for an agent space, optionally filtered by integration or resource type.
    /// </summary>
