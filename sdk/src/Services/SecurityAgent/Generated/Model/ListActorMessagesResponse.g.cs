...
{
    /// <summary>
    /// This is the response object from the ListActorMessages operation.
    /// </summary>
    public partial class ListActorMessagesResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        /// </summary>
        public List<ActorMessage> Messages { get; set; } = AWSConfigs.InitializeCollections ? new List<ActorMessage>() : null;
