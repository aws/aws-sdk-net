...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class ListApplicationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ApplicationSummary> ApplicationSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ApplicationSummary>() : null;

        /// <summary>
        /// Checks to see if the ApplicationSummaries property is set.
        /// </summary>
        internal bool IsSetApplicationSummaries() => this.ApplicationSummaries != null && (this.ApplicationSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
