...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class NetworkTrafficConfig
    {
        ...
        /// </summary>
        public List<CustomHeader> CustomHeaders { get; set; } = AWSConfigs.InitializeCollections ? new List<CustomHeader>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<NetworkTrafficRule> Rules { get; set; } = AWSConfigs.InitializeCollections ? new List<NetworkTrafficRule>() : null;
