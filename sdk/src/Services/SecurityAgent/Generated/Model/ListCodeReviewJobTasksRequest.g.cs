...
{
    /// <summary>
    /// Container for the parameters to the ListCodeReviewJobTasks operation. Returns a paginated
    /// list of task summaries for the specified code review job, optionally filtered by step
    /// name or category.
    /// </summary>
    public partial class ListCodeReviewJobTasksRequest : AmazonSecurityAgentRequest
    {
        ...
        /// <summary>
        /// Checks to see if the CategoryName property is set.
        /// </summary>
        internal bool IsSetCategoryName() => this.CategoryName != null;
