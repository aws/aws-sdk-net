...
{
    /// <summary>
    /// Container for the parameters to the DeleteTargetDomain operation. Deletes a target
    /// domain registration. After deletion, the domain can no longer be used for penetration
    /// testing.
    /// </summary>
