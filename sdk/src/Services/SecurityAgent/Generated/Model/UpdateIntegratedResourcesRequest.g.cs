...
{
    /// <summary>
    /// Container for the parameters to the UpdateIntegratedResources operation. Updates the
    /// integrated resources for an agent space, including their capabilities.
    /// </summary>
    public partial class UpdateIntegratedResourcesRequest : AmazonSecurityAgentRequest
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<IntegratedResourceInputItem> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<IntegratedResourceInputItem>() : null;
