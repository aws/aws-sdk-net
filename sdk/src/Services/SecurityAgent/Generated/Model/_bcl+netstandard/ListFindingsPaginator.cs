...
namespace Amazon.SecurityAgent.Model
{
    ...
    internal sealed partial class ListFindingsPaginator : IPaginator<ListFindingsResponse>, IListFindingsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<FindingSummary> FindingsSummaries => 
            new PaginatedResultKeyResponse<ListFindingsResponse, FindingSummary>(this, (i) => i.FindingsSummaries ?? new List<FindingSummary>());

        internal ListFindingsPaginator(IAmazonSecurityAgent client, ListFindingsRequest request)
        {
            this._client = client;
