...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class UpdateIntegratedResourcesRequest : AmazonSecurityAgentRequest
    {
        ...
        private List<IntegratedResourceInputItem> _items = AWSConfigs.InitializeCollections ? new List<IntegratedResourceInputItem>() : null;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<IntegratedResourceInputItem> Items
        {
