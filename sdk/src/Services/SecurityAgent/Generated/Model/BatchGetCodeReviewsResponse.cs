...
namespace Amazon.SecurityAgent.Model
{
    ...
    {
        private List<CodeReview> _codeReviews = AWSConfigs.InitializeCollections ? new List<CodeReview>() : null;
        ...
        /// </summary>
        public List<CodeReview> CodeReviews
        {
            get { return this._codeReviews; }
            set { this._codeReviews = value; }
        }

        // Check to see if CodeReviews property is set
        internal bool IsSetCodeReviews()
        {
            return this._codeReviews != null && (this._codeReviews.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
