...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class ListIntegratedResourcesResponse : AmazonWebServiceResponse
    {
        ...
        public List<IntegratedResourceSummary> IntegratedResourceSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<IntegratedResourceSummary>() : null;

        /// <summary>
        /// Checks to see if the IntegratedResourceSummaries property is set.
        /// </summary>
        internal bool IsSetIntegratedResourceSummaries() => this.IntegratedResourceSummaries != null && (this.IntegratedResourceSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
