...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class CaCertificateSource
    {
        ...
        public string InlinePem
        {
            get { return this._inlinePem; }
            set { this._inlinePem = value; }
        }

        // Check to see if InlinePem property is set
        internal bool IsSetInlinePem()
        {
            return this._inlinePem != null;
        }
