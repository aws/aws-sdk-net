...
{
    /// <summary>
    /// Container for the parameters to the CreateAgentSpace operation. Creates a new agent
    /// space. An agent space is a dedicated workspace for securing a specific application.
    /// </summary>
