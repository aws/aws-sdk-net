...
namespace Amazon.SecurityAgent.Model
{
    ...
    public partial class CodeRemediationTask
    {
        ...
        public CodeRemediationTaskStatus Status { get; set; }
        ...
        /// </summary>
        public List<CodeRemediationTaskDetails> TaskDetails { get; set; } = AWSConfigs.InitializeCollections ? new List<CodeRemediationTaskDetails>() : null;

        /// <summary>
        /// Checks to see if the TaskDetails property is set.
        /// </summary>
        internal bool IsSetTaskDetails() => this.TaskDetails != null && (this.TaskDetails.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
