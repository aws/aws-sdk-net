...
{
    /// <summary>
    /// Container for the parameters to the UpdateApplication operation. Updates the configuration
    /// of an existing application, including the IAM role and default KMS key.
    /// </summary>
