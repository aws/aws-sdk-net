...
namespace Amazon.SecurityAgent.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for SecurityAgent service requests.
    /// Collects values for SecurityAgentEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SecurityAgentEndpointProvider.
