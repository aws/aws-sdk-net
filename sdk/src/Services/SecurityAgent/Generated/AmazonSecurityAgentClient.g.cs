...
namespace Amazon.SecurityAgent
{
    ...
    public partial class AmazonSecurityAgentClient : AmazonServiceClient, IAmazonSecurityAgent
    {
        ...
        /// 
        /// </summary>
        public AmazonSecurityAgentClient() : base(new AmazonSecurityAgentConfig()) { }
        ...
        public AmazonSecurityAgentClient(RegionEndpoint region) : base(new AmazonSecurityAgentConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSecurityAgentClient(AmazonSecurityAgentConfig config) : base(config) { }
