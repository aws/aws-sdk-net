    ...
    public class ListComponentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Component, ComponentUnmarshaller>(ComponentUnmarshaller.Instance);
                    response.Components = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
