...
{
    /// <summary>
    /// GetServiceRoleForAccount Request Marshaller
    /// </summary>       
    public class GetServiceRoleForAccountRequestMarshaller : IMarshaller<IRequest, GetServiceRoleForAccountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetServiceRoleForAccountRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetServiceRoleForAccountRequest publicRequest)
        {
