    ...
    public class DescribeComponentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ComponentName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("componentVersion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ComponentVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ComponentPlatform, ComponentPlatformUnmarshaller>(ComponentPlatformUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Publisher = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("status", targetDepth))
                {
                    var unmarshaller = CloudComponentStatusUnmarshaller.Instance;
