...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentDeploymentSpecificationUnmarshaller : IJsonUnmarshaller<ComponentDeploymentSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComponentDeploymentSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
