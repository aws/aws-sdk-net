...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteCoreDeviceRequestMarshaller : IMarshaller<IRequest, DeleteCoreDeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCoreDeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCoreDeviceRequest publicRequest)
        {
        ...
        private static DeleteCoreDeviceRequestMarshaller _instance = new DeleteCoreDeviceRequestMarshaller();        

        internal static DeleteCoreDeviceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCoreDeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
