...
namespace Amazon.GreengrassV2.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonGreengrassV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGreengrassV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GreengrassV2.
        /// </summary>
        public AmazonGreengrassV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGreengrassV2AuthSchemeParameters
            {
    ...
    public class AmazonGreengrassV2AuthSchemeResolver : IAuthSchemeResolver<AmazonGreengrassV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGreengrassV2AuthSchemeParameters authParameters)
        {
