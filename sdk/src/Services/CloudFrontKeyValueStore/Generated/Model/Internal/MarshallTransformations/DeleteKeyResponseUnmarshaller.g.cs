...
namespace Amazon.CloudFrontKeyValueStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteKeyResponse();
        ...
        private static DeleteKeyResponseUnmarshaller _instance = new DeleteKeyResponseUnmarshaller();

        internal static DeleteKeyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteKeyResponseUnmarshaller Instance => _instance;
    }
}
