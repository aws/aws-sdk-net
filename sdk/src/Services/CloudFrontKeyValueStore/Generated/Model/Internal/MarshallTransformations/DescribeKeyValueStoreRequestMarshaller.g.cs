...
namespace Amazon.CloudFrontKeyValueStore.Model.Internal.MarshallTransformations
{
    ...
    public partial class DescribeKeyValueStoreRequestMarshaller : IMarshaller<IRequest, DescribeKeyValueStoreRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        private static readonly DescribeKeyValueStoreRequestMarshaller _instance = new();

        internal static DescribeKeyValueStoreRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeKeyValueStoreRequestMarshaller Instance => _instance;
    }
}
