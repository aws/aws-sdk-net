...
namespace Amazon.CloudFrontKeyValueStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutKeyRequestMarshaller : IMarshaller<IRequest, PutKeyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutKeyRequestMarshaller _instance = new();

        internal static PutKeyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutKeyRequestMarshaller Instance => _instance;
    }
}
