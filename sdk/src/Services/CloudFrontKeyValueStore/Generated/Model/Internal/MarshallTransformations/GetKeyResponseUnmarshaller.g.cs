...
namespace Amazon.CloudFrontKeyValueStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetKeyResponse();
        ...
        private static GetKeyResponseUnmarshaller _instance = new GetKeyResponseUnmarshaller();

        internal static GetKeyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetKeyResponseUnmarshaller Instance => _instance;
    }
}
