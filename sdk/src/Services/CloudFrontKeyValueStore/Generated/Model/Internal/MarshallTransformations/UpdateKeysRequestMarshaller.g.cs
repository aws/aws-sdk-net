...
namespace Amazon.CloudFrontKeyValueStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateKeysRequestMarshaller : IMarshaller<IRequest, UpdateKeysRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateKeysRequestMarshaller _instance = new();

        internal static UpdateKeysRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateKeysRequestMarshaller Instance => _instance;
    }
}
