...
namespace Amazon.CloudFrontKeyValueStore
{
    ...
    public partial class AmazonCloudFrontKeyValueStoreConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CloudFront KeyValueStore", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "CloudFront KeyValueStore";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "cloudfront-keyvaluestore";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-07-26";
