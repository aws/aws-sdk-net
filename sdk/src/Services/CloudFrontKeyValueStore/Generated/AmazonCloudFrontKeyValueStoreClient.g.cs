...
namespace Amazon.CloudFrontKeyValueStore
{
    ...
    public partial class AmazonCloudFrontKeyValueStoreClient : AmazonServiceClient, IAmazonCloudFrontKeyValueStore
    {
        ...
        /// 
        /// </summary>
        public AmazonCloudFrontKeyValueStoreClient() : base(new AmazonCloudFrontKeyValueStoreConfig()) { }
        ...
        public AmazonCloudFrontKeyValueStoreClient(RegionEndpoint region) : base(new AmazonCloudFrontKeyValueStoreConfig { RegionEndpoint = region }) { }
        ...
        public AmazonCloudFrontKeyValueStoreClient(AmazonCloudFrontKeyValueStoreConfig config) : base(config) { }
