...
namespace Amazon.AppTest.Model
{
    ...
    /// </summary>
    public partial class CreateCloudFormationStepOutput
    {
        private Dictionary<string, string> _exports = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;
        ...
        /// </summary>
        public Dictionary<string, string> Exports
        {
