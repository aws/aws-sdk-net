...
namespace Amazon.AppTest.Model
{
    ...
    /// </summary>
    public partial class GetTestRunStepResponse : AmazonWebServiceResponse
    {
        ...
        private StepRunSummary _stepRunSummary;
        ...
        /// <summary>
        /// Gets and sets the property StepRunSummary. 
        /// <para>
        /// The step run summary of the test run step.
        /// </para>
        /// </summary>
        public StepRunSummary StepRunSummary
        {
            get { return this._stepRunSummary; }
            set { this._stepRunSummary = value; }
        }

        // Check to see if StepRunSummary property is set
        internal bool IsSetStepRunSummary()
        {
            return this._stepRunSummary != null;
        }
