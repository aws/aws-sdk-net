        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("afterSteps", targetDepth))
                {
                    ...
                    response.AfterSteps = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("beforeSteps", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<Step, StepUnmarshaller>(StepUnmarshaller.Instance);
                    response.BeforeSteps = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestSuiteArn = unmarshaller.Unmarshall(context);
                    continue;
                }
