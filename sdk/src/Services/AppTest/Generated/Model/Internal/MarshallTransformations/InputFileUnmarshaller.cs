...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputFileUnmarshaller : IJsonUnmarshaller<InputFile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InputFile Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("fileMetadata", targetDepth))
                {
                    ...
                    unmarshalledObject.FileMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
