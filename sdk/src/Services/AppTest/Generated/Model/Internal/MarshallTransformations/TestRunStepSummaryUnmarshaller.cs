...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestRunStepSummaryUnmarshaller : IUnmarshaller<TestRunStepSummary, XmlUnmarshallerContext>, IUnmarshaller<TestRunStepSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TestRunStepSummary IUnmarshaller<TestRunStepSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TestRunStepSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("afterStep", targetDepth))
                {
                    ...
                    unmarshalledObject.AfterStep = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("beforeStep", targetDepth))
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    unmarshalledObject.BeforeStep = unmarshaller.Unmarshall(context);
                    continue;
                }
