...
{
    /// <summary>
    /// M2ManagedApplicationAction Marshaller
    /// </summary>
    public class M2ManagedApplicationActionMarshaller : IRequestMarshaller<M2ManagedApplicationAction, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(M2ManagedApplicationAction requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetProperties())
            {
                ...
                var marshaller = M2ManagedActionPropertiesMarshaller.Instance;
        ...
        /// </summary>
        public readonly static M2ManagedApplicationActionMarshaller Instance = new M2ManagedApplicationActionMarshaller();
