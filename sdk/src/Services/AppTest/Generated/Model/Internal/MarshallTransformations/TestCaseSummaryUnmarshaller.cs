...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestCaseSummaryUnmarshaller : IJsonUnmarshaller<TestCaseSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TestCaseSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TestCaseArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
