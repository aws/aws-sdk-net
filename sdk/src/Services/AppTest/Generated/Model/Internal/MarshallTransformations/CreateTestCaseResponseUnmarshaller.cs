...
{
    /// <summary>
    /// Response Unmarshaller for CreateTestCase operation
    /// </summary>  
    public class CreateTestCaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateTestCaseResponseUnmarshaller _instance = new CreateTestCaseResponseUnmarshaller();        

        internal static CreateTestCaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTestCaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
