...
{
    /// <summary>
    /// Response Unmarshaller for StartApp operation
    /// </summary>  
    public class StartAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Simulation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartAppResponseUnmarshaller _instance = new StartAppResponseUnmarshaller();        

        internal static StartAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
