...
{
    /// <summary>
    /// StopApp Request Marshaller
    /// </summary>       
    public class StopAppRequestMarshaller : IMarshaller<IRequest, StopAppRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopAppRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopAppRequest publicRequest)
        {
        ...
        private static StopAppRequestMarshaller _instance = new StopAppRequestMarshaller();        

        internal static StopAppRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopAppRequestMarshaller Instance
        {
            get
            {
                return _instance;
