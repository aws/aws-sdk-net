...
namespace Amazon.SimSpaceWeaver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SimulationAppMetadataUnmarshaller : IUnmarshaller<SimulationAppMetadata, XmlUnmarshallerContext>, IUnmarshaller<SimulationAppMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SimulationAppMetadata IUnmarshaller<SimulationAppMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SimulationAppMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Simulation = unmarshaller.Unmarshall(context);
                    continue;
                }
