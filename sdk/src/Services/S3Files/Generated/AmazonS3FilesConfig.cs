...
{
    /// <summary>
    /// Configuration for accessing Amazon S3Files service
    /// </summary>
    public partial class AmazonS3FilesConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("S3Files", "4.0.100.10");
        ...
        /// Default constructor
        /// </summary>
        public AmazonS3FilesConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonS3FilesDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "S3Files";
            this.AuthenticationServiceName = "s3files";
            this.EndpointProvider = new AmazonS3FilesEndpointProvider();
        }
