...
namespace Amazon.S3Files.Internal
{
    ...
    public class AmazonS3FilesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonS3FilesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for S3Files.
        /// </summary>
        public AmazonS3FilesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonS3FilesAuthSchemeParameters
            {
    ...
    public class AmazonS3FilesAuthSchemeResolver : IAuthSchemeResolver<AmazonS3FilesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonS3FilesAuthSchemeParameters authParameters)
        {
