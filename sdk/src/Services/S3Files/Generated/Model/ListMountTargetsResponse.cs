...
{
    /// <summary>
    /// This is the response object from the ListMountTargets operation.
    /// </summary>
    public partial class ListMountTargetsResponse : AmazonWebServiceResponse
    {
        private List<ListMountTargetsDescription> _mountTargets = AWSConfigs.InitializeCollections ? new List<ListMountTargetsDescription>() : null;
        ...
        public List<ListMountTargetsDescription> MountTargets
        {
