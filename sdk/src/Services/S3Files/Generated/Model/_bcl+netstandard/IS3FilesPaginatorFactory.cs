...
namespace Amazon.S3Files.Model
{
    ...
    ///</summary>
    public interface IS3FilesPaginatorFactory
    {
        ...
        IListFileSystemsPaginator ListFileSystems(ListFileSystemsRequest request);
        ...
        IListMountTargetsPaginator ListMountTargets(ListMountTargetsRequest request);
