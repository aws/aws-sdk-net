...
namespace Amazon.S3Files.Model
{
    ...
    {
        private List<ListAccessPointsDescription> _accessPoints = AWSConfigs.InitializeCollections ? new List<ListAccessPointsDescription>() : null;
        ...
        public List<ListAccessPointsDescription> AccessPoints
        {
