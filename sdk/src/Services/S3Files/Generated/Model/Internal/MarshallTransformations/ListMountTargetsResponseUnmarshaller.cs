...
{
    /// <summary>
    /// Response Unmarshaller for ListMountTargets operation
    /// </summary>  
    public class ListMountTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMountTargetsResponse response = new ListMountTargetsResponse();
        ...
        private static ListMountTargetsResponseUnmarshaller _instance = new ListMountTargetsResponseUnmarshaller();        

        internal static ListMountTargetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMountTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
