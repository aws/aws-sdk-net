...
{
    /// <summary>
    /// UpdateMountTarget Request Marshaller
    /// </summary>       
    public class UpdateMountTargetRequestMarshaller : IMarshaller<IRequest, UpdateMountTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateMountTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateMountTargetRequest publicRequest)
        {
        ...
        private static UpdateMountTargetRequestMarshaller _instance = new UpdateMountTargetRequestMarshaller();        

        internal static UpdateMountTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMountTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
