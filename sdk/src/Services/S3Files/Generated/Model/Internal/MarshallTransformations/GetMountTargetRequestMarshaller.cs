...
{
    /// <summary>
    /// GetMountTarget Request Marshaller
    /// </summary>       
    public class GetMountTargetRequestMarshaller : IMarshaller<IRequest, GetMountTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMountTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMountTargetRequest publicRequest)
        {
        ...
        private static GetMountTargetRequestMarshaller _instance = new GetMountTargetRequestMarshaller();        

        internal static GetMountTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMountTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
