...
namespace Amazon.S3Files.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetFileSystemPolicyRequestMarshaller : IMarshaller<IRequest, GetFileSystemPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetFileSystemPolicyRequestMarshaller _instance = new GetFileSystemPolicyRequestMarshaller();        

        internal static GetFileSystemPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFileSystemPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
