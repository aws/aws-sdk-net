...
namespace Amazon.S3Files.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutSynchronizationConfigurationRequestMarshaller : IMarshaller<IRequest, PutSynchronizationConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static PutSynchronizationConfigurationRequestMarshaller _instance = new PutSynchronizationConfigurationRequestMarshaller();        

        internal static PutSynchronizationConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSynchronizationConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
