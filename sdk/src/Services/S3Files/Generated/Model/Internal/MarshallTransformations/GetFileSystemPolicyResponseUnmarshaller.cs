...
{
    /// <summary>
    /// Response Unmarshaller for GetFileSystemPolicy operation
    /// </summary>  
    public class GetFileSystemPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFileSystemPolicyResponse response = new GetFileSystemPolicyResponse();
        ...
        private static GetFileSystemPolicyResponseUnmarshaller _instance = new GetFileSystemPolicyResponseUnmarshaller();        

        internal static GetFileSystemPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFileSystemPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
