...
{
    /// <summary>
    /// Response Unmarshaller for GetFileSystem operation
    /// </summary>  
    public class GetFileSystemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFileSystemResponse response = new GetFileSystemResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Prefix = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetFileSystemResponseUnmarshaller _instance = new GetFileSystemResponseUnmarshaller();        

        internal static GetFileSystemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFileSystemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
