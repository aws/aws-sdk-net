...
{
    /// <summary>
    /// Response Unmarshaller for GetSynchronizationConfiguration operation
    /// </summary>  
    public class GetSynchronizationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSynchronizationConfigurationResponse response = new GetSynchronizationConfigurationResponse();
        ...
        private static GetSynchronizationConfigurationResponseUnmarshaller _instance = new GetSynchronizationConfigurationResponseUnmarshaller();        

        internal static GetSynchronizationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSynchronizationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
