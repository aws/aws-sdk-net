...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMountTarget operation
    /// </summary>  
    public class UpdateMountTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMountTargetResponse response = new UpdateMountTargetResponse();
        ...
        private static UpdateMountTargetResponseUnmarshaller _instance = new UpdateMountTargetResponseUnmarshaller();        

        internal static UpdateMountTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMountTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
