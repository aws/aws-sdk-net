...
{
    /// <summary>
    /// GetFileSystem Request Marshaller
    /// </summary>       
    public class GetFileSystemRequestMarshaller : IMarshaller<IRequest, GetFileSystemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFileSystemRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetFileSystemRequest publicRequest)
        {
        ...
        private static GetFileSystemRequestMarshaller _instance = new GetFileSystemRequestMarshaller();        

        internal static GetFileSystemRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFileSystemRequestMarshaller Instance
        {
            get
            {
                return _instance;
