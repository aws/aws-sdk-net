...
{
    /// <summary>
    /// Response Unmarshaller for CreationPermissions Object
    /// </summary>  
    public class CreationPermissionsUnmarshaller : IJsonUnmarshaller<CreationPermissions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CreationPermissions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CreationPermissions unmarshalledObject = new CreationPermissions();
        ...
        private static CreationPermissionsUnmarshaller _instance = new CreationPermissionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CreationPermissionsUnmarshaller Instance
        {
            get
            {
                return _instance;
