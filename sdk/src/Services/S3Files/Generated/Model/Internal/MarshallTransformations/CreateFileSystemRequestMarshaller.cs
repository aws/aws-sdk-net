...
namespace Amazon.S3Files.Model.Internal.MarshallTransformations
{
    ...
    public class CreateFileSystemRequestMarshaller : IMarshaller<IRequest, CreateFileSystemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateFileSystemRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAcceptBucketWarning())
            {
                context.Writer.WritePropertyName("acceptBucketWarning");
                context.Writer.WriteBooleanValue(publicRequest.AcceptBucketWarning.Value);
            }
