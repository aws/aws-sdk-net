...
{
    /// <summary>
    /// Response Unmarshaller for ListAccessPoints operation
    /// </summary>  
    public class ListAccessPointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccessPointsResponse response = new ListAccessPointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListAccessPointsDescription, ListAccessPointsDescriptionUnmarshaller>(ListAccessPointsDescriptionUnmarshaller.Instance);
        ...
        private static ListAccessPointsResponseUnmarshaller _instance = new ListAccessPointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessPointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
