...
namespace Amazon.S3Files.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExpirationDataRuleUnmarshaller : IJsonUnmarshaller<ExpirationDataRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ExpirationDataRule unmarshalledObject = new ExpirationDataRule();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExpirationDataRuleUnmarshaller Instance
        {
            get
            {
                return _instance;
