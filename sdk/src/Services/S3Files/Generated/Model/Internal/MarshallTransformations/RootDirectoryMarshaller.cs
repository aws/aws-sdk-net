    ...
    public class RootDirectoryMarshaller : IRequestMarshaller<RootDirectory, JsonMarshallerContext> 
    {
        ...
        public void Marshall(RootDirectory requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetCreationPermissions())
            {
                context.Writer.WritePropertyName("creationPermissions");
                context.Writer.WriteStartObject();

                var marshaller = CreationPermissionsMarshaller.Instance;
                marshaller.Marshall(requestObject.CreationPermissions, context);
