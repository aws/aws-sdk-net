...
namespace Amazon.LambdaMicrovms.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving LambdaMicrovms endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonLambdaMicrovmsEndpointProvider"/> and <see cref="AmazonLambdaMicrovmsEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class LambdaMicrovmsEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// LambdaMicrovmsEndpointParameters constructor
        /// </summary>
        public LambdaMicrovmsEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
