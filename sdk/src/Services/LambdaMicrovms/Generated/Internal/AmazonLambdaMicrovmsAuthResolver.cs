...
namespace Amazon.LambdaMicrovms.Internal
{
    ...
    public class AmazonLambdaMicrovmsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLambdaMicrovmsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LambdaMicrovms.
        /// </summary>
        public AmazonLambdaMicrovmsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLambdaMicrovmsAuthSchemeParameters
            {
    ...
    public class AmazonLambdaMicrovmsAuthSchemeResolver : IAuthSchemeResolver<AmazonLambdaMicrovmsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLambdaMicrovmsAuthSchemeParameters authParameters)
        {
