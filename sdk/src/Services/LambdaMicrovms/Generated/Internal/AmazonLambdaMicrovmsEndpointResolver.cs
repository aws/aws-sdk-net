...
namespace Amazon.LambdaMicrovms.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for LambdaMicrovms service requests.
    /// Collects values for LambdaMicrovmsEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses LambdaMicrovmsEndpointProvider.
