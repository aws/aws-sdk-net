...
namespace Amazon.LambdaMicrovms.Model
{
    ...
    {
        private List<MicrovmImageBuildSummary> _items = AWSConfigs.InitializeCollections ? new List<MicrovmImageBuildSummary>() : null;
        ...
        public List<MicrovmImageBuildSummary> Items
        {
