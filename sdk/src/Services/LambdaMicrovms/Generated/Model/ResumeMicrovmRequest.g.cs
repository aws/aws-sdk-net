...
{
    /// <summary>
    /// Container for the parameters to the ResumeMicrovm operation. Resumes a suspended MicroVM,
    /// restoring it to RUNNING state with all state intact. The MicroVM must be in SUSPENDED
    /// state.
    /// </summary>
    public partial class ResumeMicrovmRequest : AmazonLambdaMicrovmsRequest
    {
        /// <summary>
