...
{
    /// <summary>
    /// Container for the parameters to the ListManagedMicrovmImageVersions operation. Lists
    /// versions of a managed MicroVM image. We recommend using pagination to ensure that
    /// the operation returns quickly and successfully.
    /// </summary>
    public partial class ListManagedMicrovmImageVersionsRequest : AmazonLambdaMicrovmsRequest
    {
        /// <summary>
