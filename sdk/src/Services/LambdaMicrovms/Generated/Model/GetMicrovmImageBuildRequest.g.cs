...
{
    /// <summary>
    /// Container for the parameters to the GetMicrovmImageBuild operation. Retrieves the
    /// details of a specific MicroVM image build, including its state, target architecture,
    /// and snapshot information.
    /// </summary>
    public partial class GetMicrovmImageBuildRequest : AmazonLambdaMicrovmsRequest
    {
        /// <summary>
