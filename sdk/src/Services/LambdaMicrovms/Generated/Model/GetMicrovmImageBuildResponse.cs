...
namespace Amazon.LambdaMicrovms.Model
{
    ...
    public partial class GetMicrovmImageBuildResponse : AmazonWebServiceResponse
    {
        ...
        private SnapshotBuild _snapshotBuild;
        ...
        /// </para>
        /// </summary>
        public SnapshotBuild SnapshotBuild
        {
            get { return this._snapshotBuild; }
            set { this._snapshotBuild = value; }
        }

        // Check to see if SnapshotBuild property is set
        internal bool IsSetSnapshotBuild()
        {
            return this._snapshotBuild != null;
        }
