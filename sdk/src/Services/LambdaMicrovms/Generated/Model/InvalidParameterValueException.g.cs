...
namespace Amazon.LambdaMicrovms.Model
{
    ...
    [Serializable]
#endif
    public partial class InvalidParameterValueException : AmazonLambdaMicrovmsException
    {
        /// <summary>
        /// Default constructor for InvalidParameterValueException
        /// message.
        /// </summary>
        public InvalidParameterValueException() : base() { }
        ...
        /// Construct instance of InvalidParameterValueException
        /// </summary>
        public InvalidParameterValueException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidParameterValueException
        /// </summary>
        public InvalidParameterValueException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
