...
{
    /// <summary>
    /// Container for the parameters to the ListMicrovmImages operation. Lists MicroVM images
    /// in the account with optional name filtering. We recommend using pagination to ensure
