...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteMicrovmImageVersionRequestMarshaller : IMarshaller<IRequest, DeleteMicrovmImageVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteMicrovmImageVersionRequestMarshaller _instance = new DeleteMicrovmImageVersionRequestMarshaller();        

        internal static DeleteMicrovmImageVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMicrovmImageVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
