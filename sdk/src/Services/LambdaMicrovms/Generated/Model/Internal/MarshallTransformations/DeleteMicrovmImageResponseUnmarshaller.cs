...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteMicrovmImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMicrovmImageResponse response = new DeleteMicrovmImageResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("imageIdentifier", targetDepth, ref reader))
                {
                    ...
                    response.ImageIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DeleteMicrovmImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMicrovmImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
