...
{
    /// <summary>
    /// GetMicrovmImageBuild Request Marshaller
    /// </summary>       
    public class GetMicrovmImageBuildRequestMarshaller : IMarshaller<IRequest, GetMicrovmImageBuildRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMicrovmImageBuildRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMicrovmImageBuildRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetBuildId())
                throw new AmazonLambdaMicrovmsException("Request object does not have required field BuildId set");
            request.AddPathResource("{buildId}", StringUtils.FromString(publicRequest.BuildId));
            ...
            request.ResourcePath = "/2025-09-09/microvm-images/{imageIdentifier}/versions/{imageVersion}/builds/{buildId}";

            return request;
        }
        private static GetMicrovmImageBuildRequestMarshaller _instance = new GetMicrovmImageBuildRequestMarshaller();        

        internal static GetMicrovmImageBuildRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmImageBuildRequestMarshaller Instance
        {
            get
            {
                return _instance;
