...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMicrovmImageVersion operation
    /// </summary>  
    public class DeleteMicrovmImageVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMicrovmImageVersionResponse response = new DeleteMicrovmImageVersionResponse();
        ...
        private static DeleteMicrovmImageVersionResponseUnmarshaller _instance = new DeleteMicrovmImageVersionResponseUnmarshaller();        

        internal static DeleteMicrovmImageVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMicrovmImageVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
