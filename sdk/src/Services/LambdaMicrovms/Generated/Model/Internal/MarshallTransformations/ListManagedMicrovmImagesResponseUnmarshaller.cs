...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListManagedMicrovmImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListManagedMicrovmImagesResponse response = new ListManagedMicrovmImagesResponse();
        ...
        internal static ListManagedMicrovmImagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListManagedMicrovmImagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
