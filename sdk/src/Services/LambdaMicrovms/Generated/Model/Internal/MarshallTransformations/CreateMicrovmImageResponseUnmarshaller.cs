...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMicrovmImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMicrovmImageResponse response = new CreateMicrovmImageResponse();
        ...
        internal static CreateMicrovmImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMicrovmImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
