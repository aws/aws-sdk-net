...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMicrovmImageVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMicrovmImageVersionResponse response = new GetMicrovmImageVersionResponse();
        ...
        internal static GetMicrovmImageVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmImageVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
