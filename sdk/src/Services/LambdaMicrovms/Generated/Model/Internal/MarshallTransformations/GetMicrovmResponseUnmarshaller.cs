...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMicrovmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMicrovmResponse response = new GetMicrovmResponse();
        ...
        internal static GetMicrovmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
