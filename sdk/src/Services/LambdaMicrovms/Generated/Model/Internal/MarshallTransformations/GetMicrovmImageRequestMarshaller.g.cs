...
{
    /// <summary>
    /// GetMicrovmImage Request Marshaller
    /// </summary>
    public partial class GetMicrovmImageRequestMarshaller : IMarshaller<IRequest, GetMicrovmImageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMicrovmImageRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetMicrovmImageRequest publicRequest)
        {
        ...
        private static readonly GetMicrovmImageRequestMarshaller _instance = new();

        internal static GetMicrovmImageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMicrovmImageRequestMarshaller Instance => _instance;
    }
}
