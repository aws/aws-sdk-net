...
{
    /// <summary>
    /// Response Unmarshaller for ListMicrovmImages operation
    /// </summary>  
    public class ListMicrovmImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMicrovmImagesResponse response = new ListMicrovmImagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MicrovmImageSummary, MicrovmImageSummaryUnmarshaller>(MicrovmImageSummaryUnmarshaller.Instance);
        ...
        private static ListMicrovmImagesResponseUnmarshaller _instance = new ListMicrovmImagesResponseUnmarshaller();        

        internal static ListMicrovmImagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMicrovmImagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
