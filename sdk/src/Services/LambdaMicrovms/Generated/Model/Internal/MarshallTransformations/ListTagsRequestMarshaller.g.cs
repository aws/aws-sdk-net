...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListTagsRequestMarshaller : IMarshaller<IRequest, ListTagsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListTagsRequestMarshaller _instance = new();

        internal static ListTagsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListTagsRequestMarshaller Instance => _instance;
    }
}
