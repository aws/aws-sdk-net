...
{
    /// <summary>
    /// Response Unmarshaller for CreateMicrovmAuthToken operation
    /// </summary>  
    public class CreateMicrovmAuthTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMicrovmAuthTokenResponse response = new CreateMicrovmAuthTokenResponse();
        ...
        private static CreateMicrovmAuthTokenResponseUnmarshaller _instance = new CreateMicrovmAuthTokenResponseUnmarshaller();        

        internal static CreateMicrovmAuthTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMicrovmAuthTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
