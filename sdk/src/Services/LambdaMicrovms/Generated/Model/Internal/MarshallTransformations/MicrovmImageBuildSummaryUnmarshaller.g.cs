...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MicrovmImageBuildSummaryUnmarshaller : IJsonUnmarshaller<MicrovmImageBuildSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MicrovmImageBuildSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MicrovmImageBuildSummaryUnmarshaller Instance => _instance;
    }
}
