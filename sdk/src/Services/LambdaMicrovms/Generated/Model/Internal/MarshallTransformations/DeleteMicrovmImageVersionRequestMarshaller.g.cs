...
{
    /// <summary>
    /// DeleteMicrovmImageVersion Request Marshaller
    /// </summary>
    public partial class DeleteMicrovmImageVersionRequestMarshaller : IMarshaller<IRequest, DeleteMicrovmImageVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteMicrovmImageVersionRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteMicrovmImageVersionRequest publicRequest)
        {
        ...
        private static readonly DeleteMicrovmImageVersionRequestMarshaller _instance = new();

        internal static DeleteMicrovmImageVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteMicrovmImageVersionRequestMarshaller Instance => _instance;
    }
}
