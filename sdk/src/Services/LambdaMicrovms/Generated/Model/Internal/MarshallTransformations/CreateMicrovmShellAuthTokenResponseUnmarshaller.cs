...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMicrovmShellAuthTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMicrovmShellAuthTokenResponse response = new CreateMicrovmShellAuthTokenResponse();
        ...
        internal static CreateMicrovmShellAuthTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMicrovmShellAuthTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
