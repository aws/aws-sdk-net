...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListMicrovmImageBuildsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMicrovmImageBuildsResponse response = new ListMicrovmImageBuildsResponse();
        ...
        internal static ListMicrovmImageBuildsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMicrovmImageBuildsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
