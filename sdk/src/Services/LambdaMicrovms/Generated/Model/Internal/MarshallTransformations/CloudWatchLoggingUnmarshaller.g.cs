...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CloudWatchLoggingUnmarshaller : IJsonUnmarshaller<CloudWatchLogging, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CloudWatchLogging();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CloudWatchLoggingUnmarshaller Instance => _instance;
    }
}
