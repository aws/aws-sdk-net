...
{
    /// <summary>
    /// CreateMicrovmImage Request Marshaller
    /// </summary>       
    public class CreateMicrovmImageRequestMarshaller : IMarshaller<IRequest, CreateMicrovmImageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMicrovmImageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMicrovmImageRequest publicRequest)
        {
        ...
        private static CreateMicrovmImageRequestMarshaller _instance = new CreateMicrovmImageRequestMarshaller();        

        internal static CreateMicrovmImageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMicrovmImageRequestMarshaller Instance
        {
            get
            {
                return _instance;
