...
{
    /// <summary>
    /// Response Unmarshaller for GetMicrovmImageBuild operation.
    /// </summary>
    public partial class GetMicrovmImageBuildResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetMicrovmImageBuildResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("snapshotBuild", targetDepth, ref reader))
                {
                    var unmarshaller = SnapshotBuildUnmarshaller.Instance;
                    unmarshalledObject.SnapshotBuild = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetMicrovmImageBuildResponseUnmarshaller _instance = new GetMicrovmImageBuildResponseUnmarshaller();

        internal static GetMicrovmImageBuildResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMicrovmImageBuildResponseUnmarshaller Instance => _instance;
    }
}
