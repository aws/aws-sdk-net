...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMicrovmImagesRequestMarshaller : IMarshaller<IRequest, ListMicrovmImagesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListMicrovmImagesRequestMarshaller _instance = new();

        internal static ListMicrovmImagesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMicrovmImagesRequestMarshaller Instance => _instance;
    }
}
