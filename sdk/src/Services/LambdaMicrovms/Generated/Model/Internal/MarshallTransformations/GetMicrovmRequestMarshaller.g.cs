...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMicrovmRequestMarshaller : IMarshaller<IRequest, GetMicrovmRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetMicrovmRequestMarshaller _instance = new();

        internal static GetMicrovmRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMicrovmRequestMarshaller Instance => _instance;
    }
}
