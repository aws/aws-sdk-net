...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResumeMicrovmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResumeMicrovmResponse response = new ResumeMicrovmResponse();
        ...
        internal static ResumeMicrovmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResumeMicrovmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
