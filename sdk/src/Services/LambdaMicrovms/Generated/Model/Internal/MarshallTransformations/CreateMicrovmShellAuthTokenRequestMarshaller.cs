...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateMicrovmShellAuthTokenRequestMarshaller : IMarshaller<IRequest, CreateMicrovmShellAuthTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateMicrovmShellAuthTokenRequestMarshaller _instance = new CreateMicrovmShellAuthTokenRequestMarshaller();        

        internal static CreateMicrovmShellAuthTokenRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMicrovmShellAuthTokenRequestMarshaller Instance
        {
            get
            {
                return _instance;
