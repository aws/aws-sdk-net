...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateMicrovmImageRequestMarshaller : IMarshaller<IRequest, UpdateMicrovmImageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateMicrovmImageRequestMarshaller _instance = new();

        internal static UpdateMicrovmImageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMicrovmImageRequestMarshaller Instance => _instance;
    }
}
