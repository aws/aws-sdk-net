...
{
    /// <summary>
    /// GetMicrovmImageVersion Request Marshaller
    /// </summary>       
    public class GetMicrovmImageVersionRequestMarshaller : IMarshaller<IRequest, GetMicrovmImageVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMicrovmImageVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMicrovmImageVersionRequest publicRequest)
        {
        ...
        private static GetMicrovmImageVersionRequestMarshaller _instance = new GetMicrovmImageVersionRequestMarshaller();        

        internal static GetMicrovmImageVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmImageVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
