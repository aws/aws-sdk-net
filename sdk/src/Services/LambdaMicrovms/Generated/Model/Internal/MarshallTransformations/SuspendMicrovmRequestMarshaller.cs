...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SuspendMicrovmRequestMarshaller : IMarshaller<IRequest, SuspendMicrovmRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static SuspendMicrovmRequestMarshaller _instance = new SuspendMicrovmRequestMarshaller();        

        internal static SuspendMicrovmRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SuspendMicrovmRequestMarshaller Instance
        {
            get
            {
                return _instance;
