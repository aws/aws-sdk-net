...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMicrovmImageBuildResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMicrovmImageBuildResponse response = new GetMicrovmImageBuildResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BuildId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("buildState", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BuildState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("chipset", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Chipset = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("chipsetGeneration", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ChipsetGeneration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("snapshotBuild", targetDepth, ref reader))
                {
                    ...
                    response.SnapshotBuild = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetMicrovmImageBuildResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmImageBuildResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
