...
{
    /// <summary>
    /// Response Unmarshaller for ListMicrovmImageVersions operation
    /// </summary>  
    public class ListMicrovmImageVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMicrovmImageVersionsResponse response = new ListMicrovmImageVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MicrovmImageVersionSummary, MicrovmImageVersionSummaryUnmarshaller>(MicrovmImageVersionSummaryUnmarshaller.Instance);
        ...
        private static ListMicrovmImageVersionsResponseUnmarshaller _instance = new ListMicrovmImageVersionsResponseUnmarshaller();        

        internal static ListMicrovmImageVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMicrovmImageVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
