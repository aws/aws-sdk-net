...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class TerminateMicrovmRequestMarshaller : IMarshaller<IRequest, TerminateMicrovmRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static TerminateMicrovmRequestMarshaller _instance = new TerminateMicrovmRequestMarshaller();        

        internal static TerminateMicrovmRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateMicrovmRequestMarshaller Instance
        {
            get
            {
                return _instance;
