...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MicrovmItemUnmarshaller : IJsonUnmarshaller<MicrovmItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MicrovmItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MicrovmItemUnmarshaller Instance => _instance;
    }
}
