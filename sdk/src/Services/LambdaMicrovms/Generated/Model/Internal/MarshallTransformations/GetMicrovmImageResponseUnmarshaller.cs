...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMicrovmImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMicrovmImageResponse response = new GetMicrovmImageResponse();
        ...
        internal static GetMicrovmImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
