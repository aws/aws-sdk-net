...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListManagedMicrovmImageVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListManagedMicrovmImageVersionsResponse response = new ListManagedMicrovmImageVersionsResponse();
        ...
        internal static ListManagedMicrovmImageVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListManagedMicrovmImageVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
