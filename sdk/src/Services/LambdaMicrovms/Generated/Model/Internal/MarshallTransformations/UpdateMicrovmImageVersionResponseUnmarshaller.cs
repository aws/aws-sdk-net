...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateMicrovmImageVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMicrovmImageVersionResponse response = new UpdateMicrovmImageVersionResponse();
        ...
        internal static UpdateMicrovmImageVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMicrovmImageVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
