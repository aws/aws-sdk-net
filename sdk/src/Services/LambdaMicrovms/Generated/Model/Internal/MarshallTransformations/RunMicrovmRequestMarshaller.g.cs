...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RunMicrovmRequestMarshaller : IMarshaller<IRequest, RunMicrovmRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RunMicrovmRequestMarshaller _instance = new();

        internal static RunMicrovmRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RunMicrovmRequestMarshaller Instance => _instance;
    }
}
