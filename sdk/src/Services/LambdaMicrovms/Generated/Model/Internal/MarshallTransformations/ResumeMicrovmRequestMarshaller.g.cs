...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResumeMicrovmRequestMarshaller : IMarshaller<IRequest, ResumeMicrovmRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ResumeMicrovmRequestMarshaller _instance = new();

        internal static ResumeMicrovmRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ResumeMicrovmRequestMarshaller Instance => _instance;
    }
}
