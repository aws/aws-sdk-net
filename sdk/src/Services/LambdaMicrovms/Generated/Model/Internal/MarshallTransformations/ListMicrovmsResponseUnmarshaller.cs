...
{
    /// <summary>
    /// Response Unmarshaller for ListMicrovms operation
    /// </summary>  
    public class ListMicrovmsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMicrovmsResponse response = new ListMicrovmsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MicrovmItem, MicrovmItemUnmarshaller>(MicrovmItemUnmarshaller.Instance);
        ...
        private static ListMicrovmsResponseUnmarshaller _instance = new ListMicrovmsResponseUnmarshaller();        

        internal static ListMicrovmsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMicrovmsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
