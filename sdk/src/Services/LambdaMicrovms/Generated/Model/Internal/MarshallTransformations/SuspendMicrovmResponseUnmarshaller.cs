...
{
    /// <summary>
    /// Response Unmarshaller for SuspendMicrovm operation
    /// </summary>  
    public class SuspendMicrovmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SuspendMicrovmResponse response = new SuspendMicrovmResponse();
        ...
        private static SuspendMicrovmResponseUnmarshaller _instance = new SuspendMicrovmResponseUnmarshaller();        

        internal static SuspendMicrovmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SuspendMicrovmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
