...
{
    /// <summary>
    /// ListMicrovmImageBuilds Request Marshaller
    /// </summary>       
    public class ListMicrovmImageBuildsRequestMarshaller : IMarshaller<IRequest, ListMicrovmImageBuildsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListMicrovmImageBuildsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListMicrovmImageBuildsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetChipset())
                request.Parameters.Add("chipset", StringUtils.FromString(publicRequest.Chipset));
            
            if (publicRequest.IsSetChipsetGeneration())
                request.Parameters.Add("chipsetGeneration", StringUtils.FromString(publicRequest.ChipsetGeneration));
            ...
            request.ResourcePath = "/2025-09-09/microvm-images/{imageIdentifier}/versions/{imageVersion}/builds";
            request.UseQueryString = true;

            return request;
        }
        private static ListMicrovmImageBuildsRequestMarshaller _instance = new ListMicrovmImageBuildsRequestMarshaller();        

        internal static ListMicrovmImageBuildsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMicrovmImageBuildsRequestMarshaller Instance
        {
            get
            {
                return _instance;
