...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListMicrovmsRequestMarshaller : IMarshaller<IRequest, ListMicrovmsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListMicrovmsRequestMarshaller _instance = new ListMicrovmsRequestMarshaller();        

        internal static ListMicrovmsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMicrovmsRequestMarshaller Instance
        {
            get
            {
                return _instance;
