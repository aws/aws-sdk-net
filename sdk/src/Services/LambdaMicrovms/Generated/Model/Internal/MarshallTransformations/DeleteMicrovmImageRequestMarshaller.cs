...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteMicrovmImageRequestMarshaller : IMarshaller<IRequest, DeleteMicrovmImageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteMicrovmImageRequestMarshaller _instance = new DeleteMicrovmImageRequestMarshaller();        

        internal static DeleteMicrovmImageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMicrovmImageRequestMarshaller Instance
        {
            get
            {
                return _instance;
