...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MicrovmImageVersionSummaryUnmarshaller : IJsonUnmarshaller<MicrovmImageVersionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MicrovmImageVersionSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MicrovmImageVersionSummaryUnmarshaller Instance => _instance;
    }
}
