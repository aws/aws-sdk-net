...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetMicrovmImageRequestMarshaller : IMarshaller<IRequest, GetMicrovmImageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetMicrovmImageRequestMarshaller _instance = new GetMicrovmImageRequestMarshaller();        

        internal static GetMicrovmImageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMicrovmImageRequestMarshaller Instance
        {
            get
            {
                return _instance;
