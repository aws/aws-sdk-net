...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMicrovmImageVersionRequestMarshaller : IMarshaller<IRequest, GetMicrovmImageVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetMicrovmImageVersionRequestMarshaller _instance = new();

        internal static GetMicrovmImageVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMicrovmImageVersionRequestMarshaller Instance => _instance;
    }
}
