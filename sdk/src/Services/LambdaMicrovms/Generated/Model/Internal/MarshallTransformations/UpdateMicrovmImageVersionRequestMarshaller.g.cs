...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateMicrovmImageVersionRequestMarshaller : IMarshaller<IRequest, UpdateMicrovmImageVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateMicrovmImageVersionRequestMarshaller _instance = new();

        internal static UpdateMicrovmImageVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMicrovmImageVersionRequestMarshaller Instance => _instance;
    }
}
