...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MicrovmHooksUnmarshaller : IJsonUnmarshaller<MicrovmHooks, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MicrovmHooks();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MicrovmHooksUnmarshaller Instance => _instance;
    }
}
