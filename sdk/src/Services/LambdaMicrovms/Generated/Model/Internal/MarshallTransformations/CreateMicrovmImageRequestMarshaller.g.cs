...
namespace Amazon.LambdaMicrovms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMicrovmImageRequestMarshaller : IMarshaller<IRequest, CreateMicrovmImageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateMicrovmImageRequestMarshaller _instance = new();

        internal static CreateMicrovmImageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMicrovmImageRequestMarshaller Instance => _instance;
    }
}
