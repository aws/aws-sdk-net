...
{
    /// <summary>
    /// Container for the parameters to the CreateMicrovmShellAuthToken operation. Creates
    /// a shell authentication token for interactive shell access to a running MicroVM. The
    /// MicroVM must have been run with the SHELL_INGRESS network connector attached.
    /// </summary>
    public partial class CreateMicrovmShellAuthTokenRequest : AmazonLambdaMicrovmsRequest
    {
        /// <summary>
