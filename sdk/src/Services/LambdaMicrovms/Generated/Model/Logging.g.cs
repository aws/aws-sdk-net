...
namespace Amazon.LambdaMicrovms.Model
{
    ...
    public partial class Logging
    {
        ...
        /// </para>
        /// </summary>
        public CloudWatchLogging CloudWatch { get; set; }

        /// <summary>
        /// Checks to see if the CloudWatch property is set.
        /// </summary>
        internal bool IsSetCloudWatch() => this.CloudWatch != null;
        ...
        /// </para>
        /// </summary>
        public LoggingDisabled Disabled { get; set; }

        /// <summary>
        /// Checks to see if the Disabled property is set.
        /// </summary>
        internal bool IsSetDisabled() => this.Disabled != null;
    }
}
