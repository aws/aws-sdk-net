...
namespace Amazon.KendraRanking.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceUnavailableExceptionUnmarshaller : ICborErrorResponseUnmarshaller<ResourceUnavailableException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ResourceUnavailableException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ResourceUnavailableException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("ResourceUnavailableException");
            reader.ReadStartMap();
