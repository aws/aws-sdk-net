...
{
    /// <summary>
    /// CreateRescoreExecutionPlan Request Marshaller
    /// </summary>       
    public class CreateRescoreExecutionPlanRequestMarshaller : IMarshaller<IRequest, CreateRescoreExecutionPlanRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRescoreExecutionPlanRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateRescoreExecutionPlanRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KendraRanking");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/AWSKendraRerankingFrontendService/operation/CreateRescoreExecutionPlan";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("CapacityUnits");
        ...
        private static CreateRescoreExecutionPlanRequestMarshaller _instance = new CreateRescoreExecutionPlanRequestMarshaller();        

        internal static CreateRescoreExecutionPlanRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRescoreExecutionPlanRequestMarshaller Instance
        {
            get
            {
                return _instance;
