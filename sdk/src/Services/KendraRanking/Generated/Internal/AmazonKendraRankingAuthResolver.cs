...
namespace Amazon.KendraRanking.Internal
{
    ...
    public class AmazonKendraRankingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKendraRankingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for KendraRanking.
        /// </summary>
        public AmazonKendraRankingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKendraRankingAuthSchemeParameters
            {
    ...
    public class AmazonKendraRankingAuthSchemeResolver : IAuthSchemeResolver<AmazonKendraRankingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKendraRankingAuthSchemeParameters authParameters)
        {
