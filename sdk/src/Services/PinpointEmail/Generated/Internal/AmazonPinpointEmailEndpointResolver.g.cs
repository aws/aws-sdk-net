...
{
    /// <summary>
    /// Amazon PinpointEmail endpoint resolver.
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for PinpointEmail service requests.
    /// <para />
    /// Collects values for <see cref="PinpointEmailEndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonPinpointEmailEndpointProvider"/>.
    /// <para />
    /// Responsible for setting authentication and HTTP headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPinpointEmailEndpointResolver : BaseEndpointResolver
    {
