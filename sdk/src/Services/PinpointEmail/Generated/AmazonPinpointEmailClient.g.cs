...
namespace Amazon.PinpointEmail
{
    ...
    public partial class AmazonPinpointEmailClient : AmazonServiceClient, IAmazonPinpointEmail
    {
        ...
        /// 
        /// </summary>
        public AmazonPinpointEmailClient() : base(new AmazonPinpointEmailConfig()) { }
        ...
        public AmazonPinpointEmailClient(RegionEndpoint region) : base(new AmazonPinpointEmailConfig { RegionEndpoint = region }) { }
        ...
        public AmazonPinpointEmailClient(AmazonPinpointEmailConfig config) : base(config) { }
