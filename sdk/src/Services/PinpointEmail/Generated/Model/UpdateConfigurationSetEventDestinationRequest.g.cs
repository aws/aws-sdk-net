...
namespace Amazon.PinpointEmail.Model
{
    ...
    /// Update the configuration of an event destination for a configuration set. <para> In
    /// Amazon Pinpoint, <i>events</i> include message sends, deliveries, opens, clicks, bounces,
    ...
    /// Data Firehose to stream data to Amazon S3 for long-term storage. </para>
    /// </summary>
    public partial class UpdateConfigurationSetEventDestinationRequest : AmazonPinpointEmailRequest
    {
        /// <summary>
