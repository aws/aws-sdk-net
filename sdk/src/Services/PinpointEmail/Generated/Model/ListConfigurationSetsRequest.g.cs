...
namespace Amazon.PinpointEmail.Model
{
    ...
    /// <para> In Amazon Pinpoint, <i>configuration sets</i> are groups of rules that you
    /// can apply to the emails you send. You apply a configuration set to an email by including
