...
{
    /// <summary>
    /// Container for the parameters to the GetEmailIdentity operation. Provides information
    /// about a specific identity associated with your Amazon Pinpoint account, including
    /// the identity's verification status, its DKIM authentication status, and its custom
    /// Mail-From settings.
    /// </summary>
