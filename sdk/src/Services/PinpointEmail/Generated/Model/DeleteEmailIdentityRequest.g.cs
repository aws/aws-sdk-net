...
{
    /// <summary>
    /// Container for the parameters to the DeleteEmailIdentity operation. Deletes an email
    /// identity that you previously verified for use with Amazon Pinpoint. An identity can
