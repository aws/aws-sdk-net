...
namespace Amazon.PinpointEmail.Model
{
    ...
    /// complaint event. <para> When you enable feedback forwarding, Amazon Pinpoint sends
    /// you email notifications when bounce or complaint events occur. Amazon Pinpoint sends
    /// this notification to the address that you specified in the Return-Path header of the
    /// original email. </para> <para> When you disable feedback forwarding, Amazon Pinpoint
    /// sends notifications through other mechanisms, such as by notifying an Amazon SNS topic.
