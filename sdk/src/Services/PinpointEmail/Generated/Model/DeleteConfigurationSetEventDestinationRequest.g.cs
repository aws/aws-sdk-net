...
namespace Amazon.PinpointEmail.Model
{
    ...
    /// Delete an event destination. <para> In Amazon Pinpoint, <i>events</i> include message
    ...
    /// complaints, or you can use Amazon Kinesis Data Firehose to stream data to Amazon S3
    /// for long-term storage. </para>
    /// </summary>
