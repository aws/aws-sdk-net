...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutConfigurationSetReputationOptionsRequestMarshaller : IMarshaller<IRequest, PutConfigurationSetReputationOptionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutConfigurationSetReputationOptionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/email/configuration-sets/{ConfigurationSetName}/reputation-options";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetReputationMetricsEnabled())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.ReputationMetricsEnabled.Value);
            }
        ...
        private static readonly PutConfigurationSetReputationOptionsRequestMarshaller _instance = new();

        internal static PutConfigurationSetReputationOptionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutConfigurationSetReputationOptionsRequestMarshaller Instance => _instance;
    }
}
