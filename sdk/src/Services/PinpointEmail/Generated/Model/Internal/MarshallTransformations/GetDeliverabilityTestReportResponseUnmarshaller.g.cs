...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDeliverabilityTestReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDeliverabilityTestReportResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DeliverabilityTestReport", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DeliverabilityTestReport = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("IspPlacements", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IspPlacements = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("OverallPlacement", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.OverallPlacement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetDeliverabilityTestReportResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeliverabilityTestReportResponseUnmarshaller Instance => _instance;
    }
}
