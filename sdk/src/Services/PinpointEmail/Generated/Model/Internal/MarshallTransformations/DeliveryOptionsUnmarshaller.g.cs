...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeliveryOptionsUnmarshaller : IJsonUnmarshaller<DeliveryOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeliveryOptions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeliveryOptionsUnmarshaller Instance => _instance;
    }
}
