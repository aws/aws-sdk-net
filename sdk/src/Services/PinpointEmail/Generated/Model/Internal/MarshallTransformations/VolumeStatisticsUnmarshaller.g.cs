...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VolumeStatisticsUnmarshaller : IJsonUnmarshaller<VolumeStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VolumeStatistics();
        ...
        /// Gets the singleton.
        /// </summary>
        public static VolumeStatisticsUnmarshaller Instance => _instance;
    }
}
