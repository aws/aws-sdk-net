...
{
    /// <summary>
    /// Response Unmarshaller for GetDeliverabilityDashboardOptions operation.
    /// </summary>
    public partial class GetDeliverabilityDashboardOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDeliverabilityDashboardOptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ActiveSubscribedDomains", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ActiveSubscribedDomains = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("DashboardEnabled", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DashboardEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DomainDeliverabilityTrackingOption, DomainDeliverabilityTrackingOptionUnmarshaller>(DomainDeliverabilityTrackingOptionUnmarshaller.Instance);
                    unmarshalledObject.PendingExpirationSubscribedDomains = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SubscriptionExpiryDate", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SubscriptionExpiryDate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDeliverabilityDashboardOptionsResponseUnmarshaller _instance = new GetDeliverabilityDashboardOptionsResponseUnmarshaller();

        internal static GetDeliverabilityDashboardOptionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeliverabilityDashboardOptionsResponseUnmarshaller Instance => _instance;
    }
}
