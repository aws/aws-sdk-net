...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateDedicatedIpPoolRequestMarshaller : IMarshaller<IRequest, CreateDedicatedIpPoolRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateDedicatedIpPoolRequestMarshaller _instance = new();

        internal static CreateDedicatedIpPoolRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateDedicatedIpPoolRequestMarshaller Instance => _instance;
    }
}
