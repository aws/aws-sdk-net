...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IspPlacementUnmarshaller : IJsonUnmarshaller<IspPlacement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IspPlacement();
            ...
            {
                if (context.TestExpression("IspName", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PlacementStatistics", targetDepth, ref reader))
                {
        ...
        private static IspPlacementUnmarshaller _instance = new IspPlacementUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static IspPlacementUnmarshaller Instance => _instance;
    }
}
