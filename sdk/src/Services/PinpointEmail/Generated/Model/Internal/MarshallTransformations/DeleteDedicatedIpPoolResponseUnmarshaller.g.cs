...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteDedicatedIpPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteDedicatedIpPoolResponse();
        ...
        internal static DeleteDedicatedIpPoolResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteDedicatedIpPoolResponseUnmarshaller Instance => _instance;
    }
}
