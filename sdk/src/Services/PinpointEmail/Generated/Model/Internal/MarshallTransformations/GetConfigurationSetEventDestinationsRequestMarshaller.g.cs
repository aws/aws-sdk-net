...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetConfigurationSetEventDestinationsRequestMarshaller : IMarshaller<IRequest, GetConfigurationSetEventDestinationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetConfigurationSetEventDestinationsRequestMarshaller _instance = new();

        internal static GetConfigurationSetEventDestinationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetConfigurationSetEventDestinationsRequestMarshaller Instance => _instance;
    }
}
