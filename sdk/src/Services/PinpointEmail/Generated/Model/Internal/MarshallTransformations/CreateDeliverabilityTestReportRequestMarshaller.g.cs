...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateDeliverabilityTestReportRequestMarshaller : IMarshaller<IRequest, CreateDeliverabilityTestReportRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateDeliverabilityTestReportRequestMarshaller _instance = new();

        internal static CreateDeliverabilityTestReportRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateDeliverabilityTestReportRequestMarshaller Instance => _instance;
    }
}
