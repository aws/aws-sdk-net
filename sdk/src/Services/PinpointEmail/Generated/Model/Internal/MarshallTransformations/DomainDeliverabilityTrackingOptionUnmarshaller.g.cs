...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DomainDeliverabilityTrackingOptionUnmarshaller : IJsonUnmarshaller<DomainDeliverabilityTrackingOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DomainDeliverabilityTrackingOption();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DomainDeliverabilityTrackingOptionUnmarshaller Instance => _instance;
    }
}
