...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutConfigurationSetSendingOptionsRequestMarshaller : IMarshaller<IRequest, PutConfigurationSetSendingOptionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutConfigurationSetSendingOptionsRequestMarshaller _instance = new();

        internal static PutConfigurationSetSendingOptionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutConfigurationSetSendingOptionsRequestMarshaller Instance => _instance;
    }
}
