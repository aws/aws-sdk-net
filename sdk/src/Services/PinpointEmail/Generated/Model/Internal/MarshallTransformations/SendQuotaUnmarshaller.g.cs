...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendQuotaUnmarshaller : IJsonUnmarshaller<SendQuota, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SendQuota();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SendQuotaUnmarshaller Instance => _instance;
    }
}
