...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateEmailIdentityRequestMarshaller : IMarshaller<IRequest, CreateEmailIdentityRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateEmailIdentityRequestMarshaller _instance = new();

        internal static CreateEmailIdentityRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateEmailIdentityRequestMarshaller Instance => _instance;
    }
}
