...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReputationOptionsUnmarshaller : IJsonUnmarshaller<ReputationOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReputationOptions();
            ...
            {
                if (context.TestExpression("LastFreshStart", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ReputationMetricsEnabled", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReputationOptionsUnmarshaller Instance => _instance;
    }
}
