...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDomainDeliverabilityCampaignResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDomainDeliverabilityCampaignResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DomainDeliverabilityCampaign", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DomainDeliverabilityCampaign = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetDomainDeliverabilityCampaignResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDomainDeliverabilityCampaignResponseUnmarshaller Instance => _instance;
    }
}
