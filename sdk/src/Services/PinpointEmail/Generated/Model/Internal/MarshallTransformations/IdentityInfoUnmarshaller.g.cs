...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IdentityInfoUnmarshaller : IJsonUnmarshaller<IdentityInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IdentityInfo();
            ...
            {
                if (context.TestExpression("IdentityName", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static IdentityInfoUnmarshaller Instance => _instance;
    }
}
