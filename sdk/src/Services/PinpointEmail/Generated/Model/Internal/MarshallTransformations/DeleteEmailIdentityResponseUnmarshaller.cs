...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteEmailIdentityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEmailIdentityResponse response = new DeleteEmailIdentityResponse();
        ...
        internal static DeleteEmailIdentityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEmailIdentityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
