...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutEmailIdentityMailFromAttributesRequestMarshaller : IMarshaller<IRequest, PutEmailIdentityMailFromAttributesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutEmailIdentityMailFromAttributesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetBehaviorOnMxFailure())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.BehaviorOnMxFailure);
            }
            if (publicRequest.IsSetMailFromDomain())
            {
                context.Writer.WritePropertyName("MailFromDomain");
                context.Writer.WriteStringValue(publicRequest.MailFromDomain);
            }
        ...
        private static readonly PutEmailIdentityMailFromAttributesRequestMarshaller _instance = new();

        internal static PutEmailIdentityMailFromAttributesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutEmailIdentityMailFromAttributesRequestMarshaller Instance => _instance;
    }
}
