...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateConfigurationSetEventDestinationRequestMarshaller : IMarshaller<IRequest, UpdateConfigurationSetEventDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateConfigurationSetEventDestinationRequest publicRequest)
        {
            ...
            string target = "com.amazonaws.services.pinpoint.email.UpdateConfigurationSetEventDestination";
        ...
        private static UpdateConfigurationSetEventDestinationRequestMarshaller _instance = new UpdateConfigurationSetEventDestinationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationSetEventDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
