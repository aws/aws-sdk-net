...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDomainStatisticsReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDomainStatisticsReportResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DailyVolumes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DailyVolumes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("OverallVolume", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.OverallVolume = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetDomainStatisticsReportResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDomainStatisticsReportResponseUnmarshaller Instance => _instance;
    }
}
