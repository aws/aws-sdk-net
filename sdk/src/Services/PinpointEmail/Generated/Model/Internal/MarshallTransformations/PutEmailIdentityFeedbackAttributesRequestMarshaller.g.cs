...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutEmailIdentityFeedbackAttributesRequestMarshaller : IMarshaller<IRequest, PutEmailIdentityFeedbackAttributesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutEmailIdentityFeedbackAttributesRequestMarshaller _instance = new();

        internal static PutEmailIdentityFeedbackAttributesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutEmailIdentityFeedbackAttributesRequestMarshaller Instance => _instance;
    }
}
