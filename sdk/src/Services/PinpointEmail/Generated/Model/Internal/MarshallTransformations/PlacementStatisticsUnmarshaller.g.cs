...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PlacementStatisticsUnmarshaller : IJsonUnmarshaller<PlacementStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PlacementStatistics();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PlacementStatisticsUnmarshaller Instance => _instance;
    }
}
