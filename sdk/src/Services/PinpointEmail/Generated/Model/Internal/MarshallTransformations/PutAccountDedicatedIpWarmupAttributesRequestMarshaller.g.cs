...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutAccountDedicatedIpWarmupAttributesRequestMarshaller : IMarshaller<IRequest, PutAccountDedicatedIpWarmupAttributesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutAccountDedicatedIpWarmupAttributesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetAutoWarmupEnabled())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.AutoWarmupEnabled.Value);
            }
        ...
        private static readonly PutAccountDedicatedIpWarmupAttributesRequestMarshaller _instance = new();

        internal static PutAccountDedicatedIpWarmupAttributesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutAccountDedicatedIpWarmupAttributesRequestMarshaller Instance => _instance;
    }
}
