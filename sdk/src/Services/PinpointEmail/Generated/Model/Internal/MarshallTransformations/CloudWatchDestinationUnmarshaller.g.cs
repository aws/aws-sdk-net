...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CloudWatchDestinationUnmarshaller : IJsonUnmarshaller<CloudWatchDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CloudWatchDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CloudWatchDestinationUnmarshaller Instance => _instance;
    }
}
