...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OverallVolumeUnmarshaller : IJsonUnmarshaller<OverallVolume, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new OverallVolume();
        ...
        /// Gets the singleton.
        /// </summary>
        public static OverallVolumeUnmarshaller Instance => _instance;
    }
}
