...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrackingOptionsUnmarshaller : IJsonUnmarshaller<TrackingOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrackingOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TrackingOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
