...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class KinesisFirehoseDestinationUnmarshaller : IJsonUnmarshaller<KinesisFirehoseDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new KinesisFirehoseDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static KinesisFirehoseDestinationUnmarshaller Instance => _instance;
    }
}
