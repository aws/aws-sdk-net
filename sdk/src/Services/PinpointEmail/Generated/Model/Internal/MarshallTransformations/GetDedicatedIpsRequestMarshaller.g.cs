...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDedicatedIpsRequestMarshaller : IMarshaller<IRequest, GetDedicatedIpsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDedicatedIpsRequestMarshaller _instance = new();

        internal static GetDedicatedIpsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDedicatedIpsRequestMarshaller Instance => _instance;
    }
}
