...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDedicatedIpPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDedicatedIpPoolResponse response = new CreateDedicatedIpPoolResponse();
        ...
        internal static CreateDedicatedIpPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDedicatedIpPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
