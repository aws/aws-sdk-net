...
namespace Amazon.PinpointEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEmailIdentityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetEmailIdentityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FeedbackForwardingStatus", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.FeedbackForwardingStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("MailFromAttributes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MailFromAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetEmailIdentityResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEmailIdentityResponseUnmarshaller Instance => _instance;
    }
}
