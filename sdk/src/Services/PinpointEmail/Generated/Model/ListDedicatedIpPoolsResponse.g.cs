...
{
    /// <summary>
    /// This is the response object from the ListDedicatedIpPools operation.
    /// </summary>
    public partial class ListDedicatedIpPoolsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<string> DedicatedIpPools { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the DedicatedIpPools property is set.
        /// </summary>
        internal bool IsSetDedicatedIpPools() => this.DedicatedIpPools != null && (this.DedicatedIpPools.Count > 0 || !AWSConfigs.InitializeCollections);
