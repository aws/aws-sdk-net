...
namespace Amazon.ARCZonalShift.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonARCZonalShiftAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonARCZonalShiftAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ARCZonalShift.
        /// </summary>
        public AmazonARCZonalShiftAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonARCZonalShiftAuthSchemeParameters
            {
    ...
    public class AmazonARCZonalShiftAuthSchemeResolver : IAuthSchemeResolver<AmazonARCZonalShiftAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonARCZonalShiftAuthSchemeParameters authParameters)
        {
