...
{
    /// <summary>
    /// Response Unmarshaller for StartZonalShift operation
    /// </summary>  
    public class StartZonalShiftResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartZonalShiftResponse response = new StartZonalShiftResponse();
        ...
        private static StartZonalShiftResponseUnmarshaller _instance = new StartZonalShiftResponseUnmarshaller();        

        internal static StartZonalShiftResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartZonalShiftResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
