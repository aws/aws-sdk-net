...
{
    /// <summary>
    /// StartPracticeRun Request Marshaller
    /// </summary>       
    public class StartPracticeRunRequestMarshaller : IMarshaller<IRequest, StartPracticeRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartPracticeRunRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartPracticeRunRequest publicRequest)
        {
            ...
            request.ResourcePath = "/practiceruns";
#if !NETFRAMEWORK
        ...
        private static StartPracticeRunRequestMarshaller _instance = new StartPracticeRunRequestMarshaller();        

        internal static StartPracticeRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPracticeRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
