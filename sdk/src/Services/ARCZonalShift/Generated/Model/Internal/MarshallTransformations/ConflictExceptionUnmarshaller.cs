...
namespace Amazon.ARCZonalShift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConflictExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ConflictException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConflictException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            if (context.Stream.Length > 0)
            {
                while (context.ReadAtDepth(targetDepth, ref reader))
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.ZonalShiftId = unmarshaller.Unmarshall(context, ref reader);
                        continue;
                    }
                }
            }
