...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InternalServerErrorExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InternalServerErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InternalServerErrorException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
