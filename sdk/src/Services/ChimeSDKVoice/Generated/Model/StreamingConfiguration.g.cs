...
namespace Amazon.ChimeSDKVoice.Model
{
    ...
    public partial class StreamingConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the MediaInsightsConfiguration property is set.
        /// </summary>
        internal bool IsSetMediaInsightsConfiguration() => this.MediaInsightsConfiguration != null;
        ...
        public List<StreamingNotificationTarget> StreamingNotificationTargets { get; set; } = AWSConfigs.InitializeCollections ? new List<StreamingNotificationTarget>() : null;

        /// <summary>
        /// Checks to see if the StreamingNotificationTargets property is set.
        /// </summary>
        internal bool IsSetStreamingNotificationTargets() => this.StreamingNotificationTargets != null && (this.StreamingNotificationTargets.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
