...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorProxy operation.
    /// </summary>
    public partial class GetVoiceConnectorProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetVoiceConnectorProxyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Proxy", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Proxy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVoiceConnectorProxyResponseUnmarshaller _instance = new GetVoiceConnectorProxyResponseUnmarshaller();

        internal static GetVoiceConnectorProxyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceConnectorProxyResponseUnmarshaller Instance => _instance;
    }
}
