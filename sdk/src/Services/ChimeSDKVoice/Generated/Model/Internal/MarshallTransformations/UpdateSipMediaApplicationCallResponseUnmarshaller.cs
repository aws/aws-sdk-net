...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSipMediaApplicationCall operation
    /// </summary>  
    public class UpdateSipMediaApplicationCallResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSipMediaApplicationCallResponse response = new UpdateSipMediaApplicationCallResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SipMediaApplicationCall", targetDepth, ref reader))
                {
                    var unmarshaller = SipMediaApplicationCallUnmarshaller.Instance;
                    response.SipMediaApplicationCall = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateSipMediaApplicationCallResponseUnmarshaller _instance = new UpdateSipMediaApplicationCallResponseUnmarshaller();        

        internal static UpdateSipMediaApplicationCallResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSipMediaApplicationCallResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
