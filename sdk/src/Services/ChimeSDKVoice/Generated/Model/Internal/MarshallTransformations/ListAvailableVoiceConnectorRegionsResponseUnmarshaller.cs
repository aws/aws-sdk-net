...
{
    /// <summary>
    /// Response Unmarshaller for ListAvailableVoiceConnectorRegions operation
    /// </summary>  
    public class ListAvailableVoiceConnectorRegionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAvailableVoiceConnectorRegionsResponse response = new ListAvailableVoiceConnectorRegionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VoiceConnectorRegions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.VoiceConnectorRegions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListAvailableVoiceConnectorRegionsResponseUnmarshaller _instance = new ListAvailableVoiceConnectorRegionsResponseUnmarshaller();        

        internal static ListAvailableVoiceConnectorRegionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAvailableVoiceConnectorRegionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
