...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociatePhoneNumbersWithVoiceConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociatePhoneNumbersWithVoiceConnectorResponse response = new AssociatePhoneNumbersWithVoiceConnectorResponse();
        ...
        internal static AssociatePhoneNumbersWithVoiceConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociatePhoneNumbersWithVoiceConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
