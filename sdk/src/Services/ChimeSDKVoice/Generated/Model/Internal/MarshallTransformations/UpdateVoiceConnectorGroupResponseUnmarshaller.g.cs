...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateVoiceConnectorGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateVoiceConnectorGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VoiceConnectorGroup", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VoiceConnectorGroup = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateVoiceConnectorGroupResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateVoiceConnectorGroupResponseUnmarshaller Instance => _instance;
    }
}
