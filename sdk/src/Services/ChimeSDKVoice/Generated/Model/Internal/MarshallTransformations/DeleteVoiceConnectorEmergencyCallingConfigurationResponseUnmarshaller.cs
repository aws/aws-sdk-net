...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceConnectorEmergencyCallingConfiguration operation
    /// </summary>  
    public class DeleteVoiceConnectorEmergencyCallingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorEmergencyCallingConfigurationResponse response = new DeleteVoiceConnectorEmergencyCallingConfigurationResponse();
        ...
        private static DeleteVoiceConnectorEmergencyCallingConfigurationResponseUnmarshaller _instance = new DeleteVoiceConnectorEmergencyCallingConfigurationResponseUnmarshaller();        

        internal static DeleteVoiceConnectorEmergencyCallingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorEmergencyCallingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
