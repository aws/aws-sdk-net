...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSpeakerSearchTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSpeakerSearchTaskResponse();
            ...
            {
                if (context.TestExpression("SpeakerSearchTask", targetDepth, ref reader))
                {
                    var unmarshaller = SpeakerSearchTaskUnmarshaller.Instance;
                    unmarshalledObject.SpeakerSearchTask = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetSpeakerSearchTaskResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSpeakerSearchTaskResponseUnmarshaller Instance => _instance;
    }
}
