...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceProfileDomain operation.
    /// </summary>
    public partial class GetVoiceProfileDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetVoiceProfileDomainResponse();
            ...
            {
                if (context.TestExpression("VoiceProfileDomain", targetDepth, ref reader))
                {
                    var unmarshaller = VoiceProfileDomainUnmarshaller.Instance;
                    unmarshalledObject.VoiceProfileDomain = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVoiceProfileDomainResponseUnmarshaller _instance = new GetVoiceProfileDomainResponseUnmarshaller();

        internal static GetVoiceProfileDomainResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceProfileDomainResponseUnmarshaller Instance => _instance;
    }
}
