...
{
    /// <summary>
    /// GetProxySession Request Marshaller
    /// </summary>
    public partial class GetProxySessionRequestMarshaller : IMarshaller<IRequest, GetProxySessionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetProxySessionRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetProxySessionRequest publicRequest)
        {
        ...
        private static readonly GetProxySessionRequestMarshaller _instance = new();

        internal static GetProxySessionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetProxySessionRequestMarshaller Instance => _instance;
    }
}
