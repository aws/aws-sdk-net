...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdatePhoneNumber operation
    /// </summary>  
    public class BatchUpdatePhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUpdatePhoneNumberResponse response = new BatchUpdatePhoneNumberResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PhoneNumberError, PhoneNumberErrorUnmarshaller>(PhoneNumberErrorUnmarshaller.Instance);
                    response.PhoneNumberErrors = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static BatchUpdatePhoneNumberResponseUnmarshaller _instance = new BatchUpdatePhoneNumberResponseUnmarshaller();        

        internal static BatchUpdatePhoneNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdatePhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
