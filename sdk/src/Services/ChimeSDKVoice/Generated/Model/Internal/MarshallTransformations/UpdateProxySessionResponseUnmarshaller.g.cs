...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateProxySessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateProxySessionResponse();
            ...
            {
                if (context.TestExpression("ProxySession", targetDepth, ref reader))
                {
                    var unmarshaller = ProxySessionUnmarshaller.Instance;
                    unmarshalledObject.ProxySession = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateProxySessionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateProxySessionResponseUnmarshaller Instance => _instance;
    }
}
