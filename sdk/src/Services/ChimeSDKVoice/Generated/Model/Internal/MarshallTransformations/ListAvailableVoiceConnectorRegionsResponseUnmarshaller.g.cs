...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAvailableVoiceConnectorRegionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAvailableVoiceConnectorRegionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VoiceConnectorRegions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VoiceConnectorRegions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListAvailableVoiceConnectorRegionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAvailableVoiceConnectorRegionsResponseUnmarshaller Instance => _instance;
    }
}
