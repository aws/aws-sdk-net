...
{
    /// <summary>
    /// Response Unmarshaller for CreatePhoneNumberOrder operation.
    /// </summary>
    public partial class CreatePhoneNumberOrderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreatePhoneNumberOrderResponse();
            ...
            {
                if (context.TestExpression("PhoneNumberOrder", targetDepth, ref reader))
                {
                    var unmarshaller = PhoneNumberOrderUnmarshaller.Instance;
                    unmarshalledObject.PhoneNumberOrder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreatePhoneNumberOrderResponseUnmarshaller _instance = new CreatePhoneNumberOrderResponseUnmarshaller();

        internal static CreatePhoneNumberOrderResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreatePhoneNumberOrderResponseUnmarshaller Instance => _instance;
    }
}
