...
{
    /// <summary>
    /// Response Unmarshaller for ListVoiceConnectorGroups operation.
    /// </summary>
    public partial class ListVoiceConnectorGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListVoiceConnectorGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VoiceConnectorGroups", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<VoiceConnectorGroup, VoiceConnectorGroupUnmarshaller>(VoiceConnectorGroupUnmarshaller.Instance);
                    unmarshalledObject.VoiceConnectorGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListVoiceConnectorGroupsResponseUnmarshaller _instance = new ListVoiceConnectorGroupsResponseUnmarshaller();

        internal static ListVoiceConnectorGroupsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVoiceConnectorGroupsResponseUnmarshaller Instance => _instance;
    }
}
