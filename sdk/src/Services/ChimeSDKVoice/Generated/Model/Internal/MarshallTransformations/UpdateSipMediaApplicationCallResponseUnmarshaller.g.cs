...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSipMediaApplicationCallResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateSipMediaApplicationCallResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SipMediaApplicationCall", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SipMediaApplicationCall = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateSipMediaApplicationCallResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSipMediaApplicationCallResponseUnmarshaller Instance => _instance;
    }
}
