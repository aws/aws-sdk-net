...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSipMediaApplication operation
    /// </summary>  
    public class UpdateSipMediaApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSipMediaApplicationResponse response = new UpdateSipMediaApplicationResponse();
        ...
        private static UpdateSipMediaApplicationResponseUnmarshaller _instance = new UpdateSipMediaApplicationResponseUnmarshaller();        

        internal static UpdateSipMediaApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSipMediaApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
