...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateVoiceConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateVoiceConnectorResponse();
            ...
            {
                if (context.TestExpression("VoiceConnector", targetDepth, ref reader))
                {
                    var unmarshaller = VoiceConnectorUnmarshaller.Instance;
                    unmarshalledObject.VoiceConnector = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateVoiceConnectorResponseUnmarshaller _instance = new CreateVoiceConnectorResponseUnmarshaller();

        internal static CreateVoiceConnectorResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateVoiceConnectorResponseUnmarshaller Instance => _instance;
    }
}
