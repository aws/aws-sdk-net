...
{
    /// <summary>
    /// Response Unmarshaller for GetGlobalSettings operation.
    /// </summary>
    public partial class GetGlobalSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetGlobalSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = VoiceConnectorSettingsUnmarshaller.Instance;
        ...
        private static GetGlobalSettingsResponseUnmarshaller _instance = new GetGlobalSettingsResponseUnmarshaller();

        internal static GetGlobalSettingsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetGlobalSettingsResponseUnmarshaller Instance => _instance;
    }
}
