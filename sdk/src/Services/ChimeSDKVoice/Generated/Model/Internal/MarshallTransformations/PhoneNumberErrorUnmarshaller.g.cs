...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PhoneNumberErrorUnmarshaller : IJsonUnmarshaller<PhoneNumberError, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PhoneNumberError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PhoneNumberError();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PhoneNumberErrorUnmarshaller Instance => _instance;
    }
}
