...
{
    /// <summary>
    /// Response Unmarshaller for ListSipRules operation.
    /// </summary>
    public partial class ListSipRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListSipRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SipRules", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SipRule, SipRuleUnmarshaller>(SipRuleUnmarshaller.Instance);
                    unmarshalledObject.SipRules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSipRulesResponseUnmarshaller _instance = new ListSipRulesResponseUnmarshaller();

        internal static ListSipRulesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSipRulesResponseUnmarshaller Instance => _instance;
    }
}
