...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VoiceConnectorUnmarshaller : IJsonUnmarshaller<VoiceConnector, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VoiceConnector();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OutboundHostName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("RequireEncryption", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("VoiceConnectorArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static VoiceConnectorUnmarshaller Instance => _instance;
    }
}
