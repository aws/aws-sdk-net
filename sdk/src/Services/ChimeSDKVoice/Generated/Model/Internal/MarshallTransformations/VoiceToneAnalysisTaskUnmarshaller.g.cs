...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VoiceToneAnalysisTaskUnmarshaller : IJsonUnmarshaller<VoiceToneAnalysisTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VoiceToneAnalysisTask();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VoiceToneAnalysisTaskId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("VoiceToneAnalysisTaskStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static VoiceToneAnalysisTaskUnmarshaller Instance => _instance;
    }
}
