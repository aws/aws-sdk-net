...
{
    /// <summary>
    /// Response Unmarshaller for CreateVoiceProfile operation.
    /// </summary>
    public partial class CreateVoiceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateVoiceProfileResponse();
            ...
            {
                if (context.TestExpression("VoiceProfile", targetDepth, ref reader))
                {
                    var unmarshaller = VoiceProfileUnmarshaller.Instance;
                    unmarshalledObject.VoiceProfile = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateVoiceProfileResponseUnmarshaller _instance = new CreateVoiceProfileResponseUnmarshaller();

        internal static CreateVoiceProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateVoiceProfileResponseUnmarshaller Instance => _instance;
    }
}
