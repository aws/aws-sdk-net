...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListVoiceProfileDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListVoiceProfileDomainsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VoiceProfileDomains", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VoiceProfileDomains = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListVoiceProfileDomainsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVoiceProfileDomainsResponseUnmarshaller Instance => _instance;
    }
}
