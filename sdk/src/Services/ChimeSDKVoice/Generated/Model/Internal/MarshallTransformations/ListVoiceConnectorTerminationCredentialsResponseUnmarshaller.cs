...
{
    /// <summary>
    /// Response Unmarshaller for ListVoiceConnectorTerminationCredentials operation
    /// </summary>  
    public class ListVoiceConnectorTerminationCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVoiceConnectorTerminationCredentialsResponse response = new ListVoiceConnectorTerminationCredentialsResponse();
            ...
            {
                if (context.TestExpression("Usernames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.Usernames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListVoiceConnectorTerminationCredentialsResponseUnmarshaller _instance = new ListVoiceConnectorTerminationCredentialsResponseUnmarshaller();        

        internal static ListVoiceConnectorTerminationCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVoiceConnectorTerminationCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
