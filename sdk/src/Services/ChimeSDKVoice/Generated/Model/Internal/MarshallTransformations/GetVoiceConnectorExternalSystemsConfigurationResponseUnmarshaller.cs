...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorExternalSystemsConfiguration operation
    /// </summary>  
    public class GetVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorExternalSystemsConfigurationResponse response = new GetVoiceConnectorExternalSystemsConfigurationResponse();
            ...
            {
                if (context.TestExpression("ExternalSystemsConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = ExternalSystemsConfigurationUnmarshaller.Instance;
                    response.ExternalSystemsConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller _instance = new GetVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller();        

        internal static GetVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
