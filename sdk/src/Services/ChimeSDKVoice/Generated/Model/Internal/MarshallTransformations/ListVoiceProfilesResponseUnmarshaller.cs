    ...
    public class ListVoiceProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<VoiceProfileSummary, VoiceProfileSummaryUnmarshaller>(VoiceProfileSummaryUnmarshaller.Instance);
                    response.VoiceProfiles = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
