...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorTermination operation
    /// </summary>  
    public class GetVoiceConnectorTerminationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorTerminationResponse response = new GetVoiceConnectorTerminationResponse();
            ...
            {
                if (context.TestExpression("Termination", targetDepth, ref reader))
                {
                    var unmarshaller = TerminationUnmarshaller.Instance;
                    response.Termination = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVoiceConnectorTerminationResponseUnmarshaller _instance = new GetVoiceConnectorTerminationResponseUnmarshaller();        

        internal static GetVoiceConnectorTerminationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorTerminationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
