...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateSipMediaApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateSipMediaApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SipMediaApplication", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SipMediaApplication = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateSipMediaApplicationResponseUnmarshaller _instance = new CreateSipMediaApplicationResponseUnmarshaller();

        internal static CreateSipMediaApplicationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSipMediaApplicationResponseUnmarshaller Instance => _instance;
    }
}
