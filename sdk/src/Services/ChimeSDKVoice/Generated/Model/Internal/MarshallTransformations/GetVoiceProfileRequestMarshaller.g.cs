...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetVoiceProfileRequestMarshaller : IMarshaller<IRequest, GetVoiceProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetVoiceProfileRequestMarshaller _instance = new();

        internal static GetVoiceProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceProfileRequestMarshaller Instance => _instance;
    }
}
