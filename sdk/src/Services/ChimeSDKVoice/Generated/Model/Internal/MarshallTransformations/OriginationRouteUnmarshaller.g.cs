...
{
    /// <summary>
    /// Response Unmarshaller for OriginationRoute Object
    /// </summary>
    public partial class OriginationRouteUnmarshaller : IJsonUnmarshaller<OriginationRoute, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public OriginationRoute Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new OriginationRoute();
        ...
        private static OriginationRouteUnmarshaller _instance = new OriginationRouteUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static OriginationRouteUnmarshaller Instance => _instance;
    }
}
