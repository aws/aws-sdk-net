...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetVoiceToneAnalysisTaskRequestMarshaller : IMarshaller<IRequest, GetVoiceToneAnalysisTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetVoiceToneAnalysisTaskRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("isCaller", StringUtils.FromBool(publicRequest.IsCaller.Value));
            }
        ...
        private static readonly GetVoiceToneAnalysisTaskRequestMarshaller _instance = new();

        internal static GetVoiceToneAnalysisTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceToneAnalysisTaskRequestMarshaller Instance => _instance;
    }
}
