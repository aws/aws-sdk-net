...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ValidateE911AddressResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ValidateE911AddressResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AddressExternalId", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AddressExternalId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("CandidateAddressList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.CandidateAddressList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ValidateE911AddressResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ValidateE911AddressResponseUnmarshaller Instance => _instance;
    }
}
