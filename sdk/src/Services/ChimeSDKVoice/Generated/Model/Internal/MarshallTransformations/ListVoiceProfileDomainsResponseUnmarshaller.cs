...
{
    /// <summary>
    /// Response Unmarshaller for ListVoiceProfileDomains operation
    /// </summary>  
    public class ListVoiceProfileDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVoiceProfileDomainsResponse response = new ListVoiceProfileDomainsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VoiceProfileDomains", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<VoiceProfileDomainSummary, VoiceProfileDomainSummaryUnmarshaller>(VoiceProfileDomainSummaryUnmarshaller.Instance);
                    response.VoiceProfileDomains = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListVoiceProfileDomainsResponseUnmarshaller _instance = new ListVoiceProfileDomainsResponseUnmarshaller();        

        internal static ListVoiceProfileDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVoiceProfileDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
