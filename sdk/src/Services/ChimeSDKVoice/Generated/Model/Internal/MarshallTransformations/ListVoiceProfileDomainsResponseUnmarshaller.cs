    ...
    public class ListVoiceProfileDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<VoiceProfileDomainSummary, VoiceProfileDomainSummaryUnmarshaller>(VoiceProfileDomainSummaryUnmarshaller.Instance);
                    response.VoiceProfileDomains = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
