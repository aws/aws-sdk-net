...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSupportedPhoneNumberCountriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListSupportedPhoneNumberCountriesResponse();
            ...
            {
                if (context.TestExpression("PhoneNumberCountries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PhoneNumberCountry, PhoneNumberCountryUnmarshaller>(PhoneNumberCountryUnmarshaller.Instance);
                    unmarshalledObject.PhoneNumberCountries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListSupportedPhoneNumberCountriesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSupportedPhoneNumberCountriesResponseUnmarshaller Instance => _instance;
    }
}
