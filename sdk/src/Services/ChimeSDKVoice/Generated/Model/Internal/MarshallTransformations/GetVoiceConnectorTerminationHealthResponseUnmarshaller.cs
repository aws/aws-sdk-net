...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorTerminationHealth operation
    /// </summary>  
    public class GetVoiceConnectorTerminationHealthResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorTerminationHealthResponse response = new GetVoiceConnectorTerminationHealthResponse();
            ...
            {
                if (context.TestExpression("TerminationHealth", targetDepth, ref reader))
                {
                    var unmarshaller = TerminationHealthUnmarshaller.Instance;
                    response.TerminationHealth = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVoiceConnectorTerminationHealthResponseUnmarshaller _instance = new GetVoiceConnectorTerminationHealthResponseUnmarshaller();        

        internal static GetVoiceConnectorTerminationHealthResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorTerminationHealthResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
