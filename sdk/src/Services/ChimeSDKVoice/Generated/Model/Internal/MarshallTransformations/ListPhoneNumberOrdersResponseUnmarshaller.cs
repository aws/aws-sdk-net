...
{
    /// <summary>
    /// Response Unmarshaller for ListPhoneNumberOrders operation
    /// </summary>  
    public class ListPhoneNumberOrdersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPhoneNumberOrdersResponse response = new ListPhoneNumberOrdersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PhoneNumberOrders", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PhoneNumberOrder, PhoneNumberOrderUnmarshaller>(PhoneNumberOrderUnmarshaller.Instance);
                    response.PhoneNumberOrders = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListPhoneNumberOrdersResponseUnmarshaller _instance = new ListPhoneNumberOrdersResponseUnmarshaller();        

        internal static ListPhoneNumberOrdersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPhoneNumberOrdersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
