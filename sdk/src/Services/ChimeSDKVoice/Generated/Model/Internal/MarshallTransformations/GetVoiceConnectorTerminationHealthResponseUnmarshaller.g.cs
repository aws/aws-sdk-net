...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetVoiceConnectorTerminationHealthResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetVoiceConnectorTerminationHealthResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("TerminationHealth", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TerminationHealth = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetVoiceConnectorTerminationHealthResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceConnectorTerminationHealthResponseUnmarshaller Instance => _instance;
    }
}
