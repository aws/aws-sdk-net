...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutSipMediaApplicationAlexaSkillConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PutSipMediaApplicationAlexaSkillConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SipMediaApplicationAlexaSkillConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SipMediaApplicationAlexaSkillConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static PutSipMediaApplicationAlexaSkillConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutSipMediaApplicationAlexaSkillConfigurationResponseUnmarshaller Instance => _instance;
    }
}
