...
{
    /// <summary>
    /// ListProxySessions Request Marshaller
    /// </summary>
    public partial class ListProxySessionsRequestMarshaller : IMarshaller<IRequest, ListProxySessionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListProxySessionsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListProxySessionsRequest publicRequest)
        {
        ...
        private static readonly ListProxySessionsRequestMarshaller _instance = new();

        internal static ListProxySessionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListProxySessionsRequestMarshaller Instance => _instance;
    }
}
