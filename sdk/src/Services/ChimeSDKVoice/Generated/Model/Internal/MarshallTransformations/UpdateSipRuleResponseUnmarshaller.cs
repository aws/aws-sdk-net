...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSipRule operation
    /// </summary>  
    public class UpdateSipRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSipRuleResponse response = new UpdateSipRuleResponse();
            ...
            {
                if (context.TestExpression("SipRule", targetDepth, ref reader))
                {
                    var unmarshaller = SipRuleUnmarshaller.Instance;
                    response.SipRule = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateSipRuleResponseUnmarshaller _instance = new UpdateSipRuleResponseUnmarshaller();        

        internal static UpdateSipRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSipRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
