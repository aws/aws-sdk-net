...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorOrigination operation.
    /// </summary>
    public partial class GetVoiceConnectorOriginationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetVoiceConnectorOriginationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = OriginationUnmarshaller.Instance;
        ...
        private static GetVoiceConnectorOriginationResponseUnmarshaller _instance = new GetVoiceConnectorOriginationResponseUnmarshaller();

        internal static GetVoiceConnectorOriginationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceConnectorOriginationResponseUnmarshaller Instance => _instance;
    }
}
