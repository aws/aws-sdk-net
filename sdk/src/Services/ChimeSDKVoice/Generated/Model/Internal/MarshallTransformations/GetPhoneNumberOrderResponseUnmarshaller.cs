...
{
    /// <summary>
    /// Response Unmarshaller for GetPhoneNumberOrder operation
    /// </summary>  
    public class GetPhoneNumberOrderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPhoneNumberOrderResponse response = new GetPhoneNumberOrderResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PhoneNumberOrder", targetDepth))
                {
                    var unmarshaller = PhoneNumberOrderUnmarshaller.Instance;
                    response.PhoneNumberOrder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetPhoneNumberOrderResponseUnmarshaller _instance = new GetPhoneNumberOrderResponseUnmarshaller();        

        internal static GetPhoneNumberOrderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPhoneNumberOrderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
