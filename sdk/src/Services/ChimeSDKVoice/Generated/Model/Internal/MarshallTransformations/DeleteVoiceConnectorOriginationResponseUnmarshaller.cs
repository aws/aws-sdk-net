...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceConnectorOrigination operation
    /// </summary>  
    public class DeleteVoiceConnectorOriginationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorOriginationResponse response = new DeleteVoiceConnectorOriginationResponse();
        ...
        private static DeleteVoiceConnectorOriginationResponseUnmarshaller _instance = new DeleteVoiceConnectorOriginationResponseUnmarshaller();        

        internal static DeleteVoiceConnectorOriginationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorOriginationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
