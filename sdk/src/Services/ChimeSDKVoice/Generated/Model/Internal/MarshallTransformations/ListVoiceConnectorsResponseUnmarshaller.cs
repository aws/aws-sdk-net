...
{
    /// <summary>
    /// Response Unmarshaller for ListVoiceConnectors operation
    /// </summary>  
    public class ListVoiceConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVoiceConnectorsResponse response = new ListVoiceConnectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<VoiceConnector, VoiceConnectorUnmarshaller>(VoiceConnectorUnmarshaller.Instance);
                    response.VoiceConnectors = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListVoiceConnectorsResponseUnmarshaller _instance = new ListVoiceConnectorsResponseUnmarshaller();        

        internal static ListVoiceConnectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVoiceConnectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
