...
{
    /// <summary>
    /// StopVoiceToneAnalysisTask Request Marshaller
    /// </summary>       
    public class StopVoiceToneAnalysisTaskRequestMarshaller : IMarshaller<IRequest, StopVoiceToneAnalysisTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopVoiceToneAnalysisTaskRequest)input);
        }
        ...
        private static StopVoiceToneAnalysisTaskRequestMarshaller _instance = new StopVoiceToneAnalysisTaskRequestMarshaller();        

        internal static StopVoiceToneAnalysisTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopVoiceToneAnalysisTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
