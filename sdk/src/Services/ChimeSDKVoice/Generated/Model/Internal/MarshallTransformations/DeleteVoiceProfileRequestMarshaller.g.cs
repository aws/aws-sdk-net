...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteVoiceProfileRequestMarshaller : IMarshaller<IRequest, DeleteVoiceProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteVoiceProfileRequestMarshaller _instance = new();

        internal static DeleteVoiceProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteVoiceProfileRequestMarshaller Instance => _instance;
    }
}
