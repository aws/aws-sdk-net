...
{
    /// <summary>
    /// Container for the parameters to the GetSipMediaApplication operation. Retrieves the
    /// information for a SIP media application, including name, AWS Region, and endpoints.
    /// </summary>
