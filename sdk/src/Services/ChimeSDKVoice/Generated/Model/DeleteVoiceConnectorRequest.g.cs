...
{
    /// <summary>
    /// Container for the parameters to the DeleteVoiceConnector operation. Deletes an Amazon
    /// Chime SDK Voice Connector. Any phone numbers associated with the Amazon Chime SDK
