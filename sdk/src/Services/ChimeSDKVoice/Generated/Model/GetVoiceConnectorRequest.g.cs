...
{
    /// <summary>
    /// Container for the parameters to the GetVoiceConnector operation. Retrieves details
    /// for the specified Amazon Chime SDK Voice Connector, such as timestamps,name, outbound
