...
{
    /// <summary>
    /// Container for the parameters to the CreateVoiceConnectorGroup operation. Creates an
    /// Amazon Chime SDK Voice Connector group under the administrator's AWS account. You
    /// can associate Amazon Chime SDK Voice Connectors with the Voice Connector group by
    /// including <c>VoiceConnectorItems</c> in the request. <para> You can include Voice
    /// Connectors from different AWS Regions in your group. This creates a fault tolerant
    /// mechanism for fallback in case of availability events. </para>
    /// </summary>
