...
{
    /// <summary>
    /// Container for the parameters to the DeleteVoiceConnectorProxy operation. Deletes the
    /// proxy configuration from the specified Amazon Chime SDK Voice Connector. <important>
