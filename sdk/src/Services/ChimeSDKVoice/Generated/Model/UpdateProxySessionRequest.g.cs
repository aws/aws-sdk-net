...
{
    /// <summary>
    /// Container for the parameters to the UpdateProxySession operation. Updates the specified
    /// proxy session details, such as voice or SMS capabilities. <important> <para> End of
    /// support notice: On April 7, 2026, AWS will end support for Amazon Chime SDK proxy
    /// sessions. </para> </important>
    /// </summary>
