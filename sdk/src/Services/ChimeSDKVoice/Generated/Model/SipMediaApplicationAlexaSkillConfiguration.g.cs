...
namespace Amazon.ChimeSDKVoice.Model
{
    ...
    public partial class SipMediaApplicationAlexaSkillConfiguration
    {
        ...
        public List<string> AlexaSkillIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AlexaSkillIds property is set.
        /// </summary>
        internal bool IsSetAlexaSkillIds() => this.AlexaSkillIds != null && (this.AlexaSkillIds.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the AlexaSkillStatus property is set.
        /// </summary>
        internal bool IsSetAlexaSkillStatus() => this.AlexaSkillStatus != null;
    }
}
