...
{
    /// <summary>
    /// Container for the parameters to the DeleteProxySession operation. Deletes the specified
    /// proxy session from the specified Amazon Chime SDK Voice Connector. <important> <para>
    /// End of support notice: On April 7, 2026, AWS will end support for Amazon Chime SDK
    /// proxy sessions. </para> </important>
    /// </summary>
