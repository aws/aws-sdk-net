...
{
    /// <summary>
    /// Container for the parameters to the CreatePhoneNumberOrder operation. Creates an order
    /// for phone numbers to be provisioned. For numbers outside the U.S., you must use the
