...
{
    /// <summary>
    /// Container for the parameters to the GetSipMediaApplicationAlexaSkillConfiguration
    /// operation. Gets the Alexa Skill configuration for the SIP media application. <important>
