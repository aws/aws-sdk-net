...
namespace Amazon.ChimeSDKVoice.Model
{
    ...
    public partial class AssociatePhoneNumbersWithVoiceConnectorResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PhoneNumberError> PhoneNumberErrors { get; set; } = AWSConfigs.InitializeCollections ? new List<PhoneNumberError>() : null;

        /// <summary>
        /// Checks to see if the PhoneNumberErrors property is set.
        /// </summary>
        internal bool IsSetPhoneNumberErrors() => this.PhoneNumberErrors != null && (this.PhoneNumberErrors.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
