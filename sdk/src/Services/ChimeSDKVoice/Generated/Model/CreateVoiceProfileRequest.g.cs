...
{
    /// <summary>
    /// Container for the parameters to the CreateVoiceProfile operation. Creates a voice
    /// profile, which consists of an enrolled user and their latest voice print. <important>
    /// <para> Before creating any voice profiles, you must provide all notices and obtain
    ...
    /// about voice profiles and voice analytics, see <a href="https://docs.aws.amazon.com/chime-sdk/latest/dg/pstn-voice-analytics.html">Using
