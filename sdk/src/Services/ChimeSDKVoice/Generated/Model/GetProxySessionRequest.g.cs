...
{
    /// <summary>
    /// Container for the parameters to the GetProxySession operation. Retrieves the specified
    /// proxy session details for the specified Amazon Chime SDK Voice Connector. <important>
