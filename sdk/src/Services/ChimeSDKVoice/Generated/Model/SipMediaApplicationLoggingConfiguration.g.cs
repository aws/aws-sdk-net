...
namespace Amazon.ChimeSDKVoice.Model
{
    ...
    public partial class SipMediaApplicationLoggingConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public bool? EnableSipMediaApplicationMessageLogs { get; set; }

        /// <summary>
        /// Checks to see if the EnableSipMediaApplicationMessageLogs property is set.
        /// </summary>
        internal bool IsSetEnableSipMediaApplicationMessageLogs() => this.EnableSipMediaApplicationMessageLogs.HasValue;
    }
}
