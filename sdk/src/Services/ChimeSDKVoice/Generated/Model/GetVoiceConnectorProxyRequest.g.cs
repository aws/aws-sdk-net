...
{
    /// <summary>
    /// Container for the parameters to the GetVoiceConnectorProxy operation. Retrieves the
    /// proxy configuration details for the specified Amazon Chime SDK Voice Connector. <important>
