...
{
    /// <summary>
    /// Container for the parameters to the GetVoiceConnectorGroup operation. Retrieves details
    /// for the specified Amazon Chime SDK Voice Connector group, such as timestamps,name,
