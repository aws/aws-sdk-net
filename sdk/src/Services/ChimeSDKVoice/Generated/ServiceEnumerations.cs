...
namespace Amazon.ChimeSDKVoice
{
    ...
    /// <summary>
    /// Constants used for properties of type CallDistributionType.
    /// </summary>
    public class CallDistributionType : ConstantClass
    {

        /// <summary>
        /// Constant LoadBalancedDistribution for CallDistributionType
        /// </summary>
        public static readonly CallDistributionType LoadBalancedDistribution = new CallDistributionType("LoadBalancedDistribution");
        /// <summary>
        /// Constant PriorityWeightedDistribution for CallDistributionType
        /// </summary>
        public static readonly CallDistributionType PriorityWeightedDistribution = new CallDistributionType("PriorityWeightedDistribution");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public CallDistributionType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static CallDistributionType FindValue(string value)
        {
            return FindValue<CallDistributionType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator CallDistributionType(string value)
        {
            return FindValue(value);
        }
    }
    ...
    public class CallLegType : ConstantClass
    {
        ...
        {
            return FindValue<CallLegType>(value);
        }
    ...
    public class ErrorCode : ConstantClass
    {
        ...
        /// <summary>
        /// Constant Validation for ErrorCode
        /// </summary>
        public static readonly ErrorCode Validation = new ErrorCode("Validation");
        /// <summary>
    ...
    public class NetworkType : ConstantClass
    {
        ...
        /// <summary>
        /// Constant IPV4_ONLY for NetworkType
        /// </summary>
        public static readonly NetworkType IPV4_ONLY = new NetworkType("IPV4_ONLY");
