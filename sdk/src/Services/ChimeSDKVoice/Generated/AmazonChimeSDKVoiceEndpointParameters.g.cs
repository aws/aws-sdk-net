...
namespace Amazon.ChimeSDKVoice.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving ChimeSDKVoice endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonChimeSDKVoiceEndpointProvider"/> and <see cref="AmazonChimeSDKVoiceEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class ChimeSDKVoiceEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// ChimeSDKVoiceEndpointParameters constructor
        /// </summary>
        public ChimeSDKVoiceEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
