...
namespace Amazon.ChimeSDKVoice
{
    ...
    public partial class AmazonChimeSDKVoiceClient : AmazonServiceClient, IAmazonChimeSDKVoice
    {
        ...
        /// 
        /// </summary>
        public AmazonChimeSDKVoiceClient() : base(new AmazonChimeSDKVoiceConfig()) { }
        ...
        public AmazonChimeSDKVoiceClient(RegionEndpoint region) : base(new AmazonChimeSDKVoiceConfig { RegionEndpoint = region }) { }
        ...
        public AmazonChimeSDKVoiceClient(AmazonChimeSDKVoiceConfig config) : base(config) { }
