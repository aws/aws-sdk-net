...
namespace Amazon.SupportApp
{
    ...
    public partial class AmazonSupportAppClient : AmazonServiceClient, IAmazonSupportApp
    {
        ...
        /// 
        /// </summary>
        public AmazonSupportAppClient() : base(new AmazonSupportAppConfig()) { }
        ...
        public AmazonSupportAppClient(RegionEndpoint region) : base(new AmazonSupportAppConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSupportAppClient(AmazonSupportAppConfig config) : base(config) { }
