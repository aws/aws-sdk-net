...
{
    /// <summary>
    /// Container for the parameters to the ListSlackWorkspaceConfigurations operation. Lists
    /// the Slack workspace configurations for an Amazon Web Services account.
    /// </summary>
