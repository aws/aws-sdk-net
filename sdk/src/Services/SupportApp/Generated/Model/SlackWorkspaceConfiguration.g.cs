...
namespace Amazon.SupportApp.Model
{
    ...
    public partial class SlackWorkspaceConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public bool? AllowOrganizationMemberAccount { get; set; }

        /// <summary>
        /// Checks to see if the AllowOrganizationMemberAccount property is set.
        /// </summary>
        internal bool IsSetAllowOrganizationMemberAccount() => this.AllowOrganizationMemberAccount.HasValue;
