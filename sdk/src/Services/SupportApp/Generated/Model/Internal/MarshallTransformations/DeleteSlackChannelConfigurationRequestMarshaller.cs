...
namespace Amazon.SupportApp.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSlackChannelConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteSlackChannelConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteSlackChannelConfigurationRequestMarshaller _instance = new DeleteSlackChannelConfigurationRequestMarshaller();        

        internal static DeleteSlackChannelConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSlackChannelConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
