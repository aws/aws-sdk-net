...
namespace Amazon.SupportApp.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutAccountAliasRequestMarshaller : IMarshaller<IRequest, PutAccountAliasRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutAccountAliasRequestMarshaller _instance = new();

        internal static PutAccountAliasRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutAccountAliasRequestMarshaller Instance => _instance;
    }
}
