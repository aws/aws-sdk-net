...
{
    /// <summary>
    /// Response Unmarshaller for SlackWorkspaceConfiguration Object
    /// </summary>  
    public class SlackWorkspaceConfigurationUnmarshaller : IUnmarshaller<SlackWorkspaceConfiguration, XmlUnmarshallerContext>, IUnmarshaller<SlackWorkspaceConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SlackWorkspaceConfiguration IUnmarshaller<SlackWorkspaceConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static SlackWorkspaceConfigurationUnmarshaller _instance = new SlackWorkspaceConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SlackWorkspaceConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
