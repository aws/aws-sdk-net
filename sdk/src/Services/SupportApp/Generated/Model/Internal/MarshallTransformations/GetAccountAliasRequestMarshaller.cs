...
namespace Amazon.SupportApp.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAccountAliasRequestMarshaller : IMarshaller<IRequest, GetAccountAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetAccountAliasRequestMarshaller _instance = new GetAccountAliasRequestMarshaller();        

        internal static GetAccountAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
