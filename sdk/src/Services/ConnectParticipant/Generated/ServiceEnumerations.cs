...
namespace Amazon.ConnectParticipant
{
    ...
    /// <summary>
    /// Constants used for properties of type MessageProcessingStatus.
    /// </summary>
    public class MessageProcessingStatus : ConstantClass
    {

        /// <summary>
        /// Constant FAILED for MessageProcessingStatus
        /// </summary>
        public static readonly MessageProcessingStatus FAILED = new MessageProcessingStatus("FAILED");
        /// <summary>
        /// Constant PROCESSING for MessageProcessingStatus
        /// </summary>
        public static readonly MessageProcessingStatus PROCESSING = new MessageProcessingStatus("PROCESSING");
        /// <summary>
        /// Constant REJECTED for MessageProcessingStatus
        /// </summary>
        public static readonly MessageProcessingStatus REJECTED = new MessageProcessingStatus("REJECTED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public MessageProcessingStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static MessageProcessingStatus FindValue(string value)
        {
            return FindValue<MessageProcessingStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator MessageProcessingStatus(string value)
        {
            return FindValue(value);
        }
    }
