...
namespace Amazon.ConnectParticipant.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeViewRequestMarshaller : IMarshaller<IRequest, DescribeViewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeViewRequestMarshaller _instance = new DescribeViewRequestMarshaller();        

        internal static DescribeViewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeViewRequestMarshaller Instance
        {
            get
            {
                return _instance;
