...
namespace Amazon.SSMQuickSetup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateServiceSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateServiceSettingsResponse response = new UpdateServiceSettingsResponse();
        ...
        internal static UpdateServiceSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
