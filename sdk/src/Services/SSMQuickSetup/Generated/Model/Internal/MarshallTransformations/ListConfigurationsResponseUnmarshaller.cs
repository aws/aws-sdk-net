    ...
    public class ListConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ConfigurationSummary, ConfigurationSummaryUnmarshaller>(ConfigurationSummaryUnmarshaller.Instance);
                    response.ConfigurationsList = unmarshaller.Unmarshall(context);
                    continue;
                }
