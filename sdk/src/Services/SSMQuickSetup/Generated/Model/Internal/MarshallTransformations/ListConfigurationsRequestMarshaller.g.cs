...
namespace Amazon.SSMQuickSetup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListConfigurationsRequestMarshaller : IMarshaller<IRequest, ListConfigurationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListConfigurationsRequestMarshaller _instance = new();

        internal static ListConfigurationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListConfigurationsRequestMarshaller Instance => _instance;
    }
}
