...
namespace Amazon.SSMQuickSetup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateConfigurationDefinitionRequestMarshaller : IMarshaller<IRequest, UpdateConfigurationDefinitionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateConfigurationDefinitionRequestMarshaller _instance = new();

        internal static UpdateConfigurationDefinitionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateConfigurationDefinitionRequestMarshaller Instance => _instance;
    }
}
