...
namespace Amazon.SSMQuickSetup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetConfigurationManagerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetConfigurationManagerResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ConfigurationDefinitions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConfigurationDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetConfigurationManagerResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetConfigurationManagerResponseUnmarshaller Instance => _instance;
    }
}
