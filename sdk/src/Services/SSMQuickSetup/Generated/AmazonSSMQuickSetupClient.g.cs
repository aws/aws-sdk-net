...
namespace Amazon.SSMQuickSetup
{
    ...
    public partial class AmazonSSMQuickSetupClient : AmazonServiceClient, IAmazonSSMQuickSetup
    {
        ...
        /// 
        /// </summary>
        public AmazonSSMQuickSetupClient() : base(new AmazonSSMQuickSetupConfig()) { }
        ...
        public AmazonSSMQuickSetupClient(RegionEndpoint region) : base(new AmazonSSMQuickSetupConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSSMQuickSetupClient(AmazonSSMQuickSetupConfig config) : base(config) { }
