...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteTableRequestMarshaller : IMarshaller<IRequest, DeleteTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteTableRequest publicRequest)
        {
            ...
            string target = "Timestream_20181101.DeleteTable";
        ...
        private static DeleteTableRequestMarshaller _instance = new DeleteTableRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
