...
{
    /// <summary>
    /// WriteRecords Request Marshaller
    /// </summary>       
    public class WriteRecordsRequestMarshaller : IMarshaller<IRequest, WriteRecordsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IRequest Marshall(WriteRecordsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.TimestreamWrite");
            string target = "Timestream_20181101.WriteRecords";
        ...
        private static WriteRecordsRequestMarshaller _instance = new WriteRecordsRequestMarshaller();        

        internal static WriteRecordsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static WriteRecordsRequestMarshaller Instance
        {
            get
            {
                return _instance;
