...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MagneticStoreWritePropertiesUnmarshaller : IUnmarshaller<MagneticStoreWriteProperties, XmlUnmarshallerContext>, IUnmarshaller<MagneticStoreWriteProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MagneticStoreWriteProperties IUnmarshaller<MagneticStoreWriteProperties, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public MagneticStoreWriteProperties Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("MagneticStoreRejectedDataLocation", targetDepth))
                {
                    ...
                    unmarshalledObject.MagneticStoreRejectedDataLocation = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
