...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataModelConfigurationUnmarshaller : IUnmarshaller<DataModelConfiguration, XmlUnmarshallerContext>, IUnmarshaller<DataModelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DataModelConfiguration IUnmarshaller<DataModelConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DataModelConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DataModel", targetDepth))
                {
                    ...
                    unmarshalledObject.DataModel = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DataModelS3Configuration", targetDepth))
                {
                    ...
                    unmarshalledObject.DataModelS3Configuration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
