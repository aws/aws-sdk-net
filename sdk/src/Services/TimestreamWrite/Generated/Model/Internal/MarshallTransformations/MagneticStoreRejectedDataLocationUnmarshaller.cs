...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MagneticStoreRejectedDataLocationUnmarshaller : IJsonUnmarshaller<MagneticStoreRejectedDataLocation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MagneticStoreRejectedDataLocation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
