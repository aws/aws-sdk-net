...
namespace Amazon.AutoScalingPlans.Model
{
    ...
    public partial class ConcurrentUpdateException : AmazonAutoScalingPlansException
    {
        ...
        public ConcurrentUpdateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConcurrentUpdateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
