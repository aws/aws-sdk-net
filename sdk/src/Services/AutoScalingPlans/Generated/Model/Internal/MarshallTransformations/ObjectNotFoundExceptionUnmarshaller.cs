...
namespace Amazon.AutoScalingPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ObjectNotFoundExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ObjectNotFoundException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ObjectNotFoundException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ObjectNotFoundException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
