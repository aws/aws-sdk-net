...
namespace Amazon.AutoScalingPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationSourceUnmarshaller : IJsonUnmarshaller<ApplicationSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
