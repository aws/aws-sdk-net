...
namespace Amazon.AutoScalingPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConcurrentUpdateExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ConcurrentUpdateException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ConcurrentUpdateException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ConcurrentUpdateException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
