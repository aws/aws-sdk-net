...
namespace Amazon.AutoScalingPlans
{
    ...
    public partial class AmazonAutoScalingPlansException : AmazonServiceException
    {
        ...
        /// </summary>
        public AmazonAutoScalingPlansException()
            : base()
        {
        }
        ...
        public AmazonAutoScalingPlansException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonAutoScalingPlansException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
