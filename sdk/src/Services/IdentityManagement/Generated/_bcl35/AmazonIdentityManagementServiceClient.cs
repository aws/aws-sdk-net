...
namespace Amazon.IdentityManagement
{
    ...
    public partial class AmazonIdentityManagementServiceClient : AmazonServiceClient, IAmazonIdentityManagementService
    {
        ...
        ///         operation.</returns>
        public IAsyncResult BeginUploadPublicAccessKey(UploadPublicAccessKeyRequest request, AsyncCallback callback, object state)
        {
            var marshaller = new UploadPublicAccessKeyRequestMarshaller();
            var unmarshaller = UploadPublicAccessKeyResponseUnmarshaller.Instance;

            return BeginInvoke<UploadPublicAccessKeyRequest>(request, marshaller, unmarshaller,
                callback, state);
        }
        ...
        public  UploadPublicAccessKeyResponse EndUploadPublicAccessKey(IAsyncResult asyncResult)
        {
            return EndInvoke<UploadPublicAccessKeyResponse>(asyncResult);
        }
