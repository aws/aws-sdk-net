...
{
    /// <summary>
    /// Amazon IdentityManagementService endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IdentityManagementService service requests.
    /// Collects values for IdentityManagementServiceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IdentityManagementServiceEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonIdentityManagementServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonIdentityManagementServiceConfig)requestContext.ClientConfig;
            var result = new IdentityManagementServiceEndpointParameters();
