...
namespace Amazon.IdentityManagement.Model
{
    ...
    /// </summary>
    public partial class ListSAMLProviderTagsResponse : AmazonWebServiceResponse
    {
        ...
        /// (SAML) identity provider. Each tag consists of a key name and an associated value.
        /// If no tags are attached to the specified resource, the response contains an empty
        /// list.
        /// </para>
        /// <para />
