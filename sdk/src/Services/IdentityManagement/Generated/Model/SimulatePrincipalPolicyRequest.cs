...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class SimulatePrincipalPolicyRequest : AmazonIdentityManagementServiceRequest
    {
        ...
        private List<PolicyIdentifier> _policyExclusionList = AWSConfigs.InitializeCollections ? new List<PolicyIdentifier>() : null;
        ...
        /// <para>
        /// The ARN of the IAM user, group, or role that you want to specify as the simulated
        ...
        ///  
        /// <para>
        /// You can specify the ARN of an IAM user, group, or role. You cannot specify the ARN
        /// of an assumed role, federated user, or a service principal.
        /// </para>
        ///  
        /// <para>
        ///  <c>CallerArn</c> is required if you include a <c>ResourcePolicy</c> and the <c>PolicySourceArn</c>
        /// is not the ARN for an IAM user, group, or role. This is required so that the resource-based
        /// policy's <c>Principal</c> element has a value to use in evaluating the policy.
        /// </para>
        ///  
        /// <para>
        ...
        /// <summary>
        /// Gets and sets the property PolicyExclusionList. 
        /// <para>
        /// A list of policies to exclude from the simulation. Use this parameter to test what
        /// the simulation result would be if a policy were removed, without changing which policies
        /// are actually attached to the principal identified by <c>PolicySourceArn</c>.
        /// </para>
        ///  
        /// <para>
        /// Each entry is a <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_PolicyIdentifier.html">PolicyIdentifier</a>
        ...
        ///  
        /// <para>
        /// Syntactically invalid identifiers, such as malformed ARNs or wildcards in disallowed
        ...
        /// </summary>
        [AWSProperty(Max=256)]
        public List<PolicyIdentifier> PolicyExclusionList
        {
            get { return this._policyExclusionList; }
            set { this._policyExclusionList = value; }
        }

        // Check to see if PolicyExclusionList property is set
        internal bool IsSetPolicyExclusionList()
        {
            return this._policyExclusionList != null && (this._policyExclusionList.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
        ...
        /// resource is different from the account that owns the simulated calling user <c>CallerArn</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Min=1, Max=2048)]
