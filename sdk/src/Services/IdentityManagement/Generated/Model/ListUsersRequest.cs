...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class ListUsersRequest : AmazonIdentityManagementServiceRequest
    {
        ...
        /// <para>
        ///  The path prefix for filtering the results. For example: <c>/division_abc/subdivision_xyz/</c>,
        /// which would get all user names whose path starts with <c>/division_abc/subdivision_xyz/</c>.
        /// </para>
        ///  
        /// <para>
