...
namespace Amazon.IdentityManagement.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidCertificateException : AmazonIdentityManagementServiceException
    {
        ...
        public InvalidCertificateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCertificateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
