...
namespace Amazon.IdentityManagement.Model
{
    ...
    internal sealed partial class ListAttachedGroupPoliciesPaginator : IPaginator<ListAttachedGroupPoliciesResponse>, IListAttachedGroupPoliciesPaginator
    {
        ...
        async IAsyncEnumerable<ListAttachedGroupPoliciesResponse> IPaginator<ListAttachedGroupPoliciesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
