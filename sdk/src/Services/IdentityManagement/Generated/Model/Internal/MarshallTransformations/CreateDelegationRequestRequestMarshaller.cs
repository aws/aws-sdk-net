        ...
        public IRequest Marshall(CreateDelegationRequestRequest publicRequest)
        {
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetPermissions())
                {
                    ...
                    {
                        if (publicRequest.Permissions.Parameters.Count == 0)
                            request.Parameters.Add("Permissions" + "." + "Parameters", "");
                        else
                        {
                             ...
                             foreach(var publicRequestPermissionslistValue in publicRequest.Permissions.Parameters)
                             {
                                ...
                                {
                                    if (publicRequestPermissionslistValue.Values.Count == 0)
                                        request.Parameters.Add("Permissions" + "." + "Parameters" + "." + "member" + "." + publicRequestPermissionslistValueIndex + "." + "Values", "");
                                    else
                                    {
