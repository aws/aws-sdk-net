...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListInstanceProfilesRequestMarshaller : IMarshaller<IRequest, ListInstanceProfilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInstanceProfilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInstanceProfilesRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInstanceProfilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
