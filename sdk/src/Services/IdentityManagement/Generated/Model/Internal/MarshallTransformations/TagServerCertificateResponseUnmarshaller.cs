...
{
    /// <summary>
    /// Response Unmarshaller for TagServerCertificate operation
    /// </summary>  
    public class TagServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagServerCertificateResponse response = new TagServerCertificateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagServerCertificateResult", 2))
                    {
        ...
        private static TagServerCertificateResponseUnmarshaller _instance = new TagServerCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagServerCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
