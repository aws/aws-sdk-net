...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAccountAliasRequestMarshaller : IMarshaller<IRequest, CreateAccountAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccountAliasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccountAliasRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
