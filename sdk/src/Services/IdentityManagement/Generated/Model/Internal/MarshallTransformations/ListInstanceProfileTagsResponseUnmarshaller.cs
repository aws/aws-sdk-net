...
{
    /// <summary>
    /// Response Unmarshaller for ListInstanceProfileTags operation
    /// </summary>  
    public class ListInstanceProfileTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListInstanceProfileTagsResponse response = new ListInstanceProfileTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListInstanceProfileTagsResult", 2))
                    {
        ...
        private static ListInstanceProfileTagsResponseUnmarshaller _instance = new ListInstanceProfileTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInstanceProfileTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
