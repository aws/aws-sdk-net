...
{
    /// <summary>
    /// Response Unmarshaller for ListPolicyTags operation
    /// </summary>  
    public class ListPolicyTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPolicyTagsResponse response = new ListPolicyTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListPolicyTagsResult", 2))
                    {
        ...
        private static ListPolicyTagsResponseUnmarshaller _instance = new ListPolicyTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPolicyTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
