...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreatePolicyVersionRequestMarshaller : IMarshaller<IRequest, CreatePolicyVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePolicyVersionRequest)input);
        }
        ...
        public IRequest Marshall(CreatePolicyVersionRequest publicRequest)
        {
            ...
            request.Parameters.Add("Action", "CreatePolicyVersion");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePolicyVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
