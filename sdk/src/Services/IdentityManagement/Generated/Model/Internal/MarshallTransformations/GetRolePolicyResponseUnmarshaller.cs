...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRolePolicyResponse response = new GetRolePolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetRolePolicyResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetRolePolicyResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.RoleName = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static GetRolePolicyResponseUnmarshaller _instance = new GetRolePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRolePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
