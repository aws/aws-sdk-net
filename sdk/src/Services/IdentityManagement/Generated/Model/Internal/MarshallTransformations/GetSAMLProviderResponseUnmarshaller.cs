...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSAMLProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSAMLProviderResponse response = new GetSAMLProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetSAMLProviderResult", 2))
                    {
        ...
        private static GetSAMLProviderResponseUnmarshaller _instance = new GetSAMLProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSAMLProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
