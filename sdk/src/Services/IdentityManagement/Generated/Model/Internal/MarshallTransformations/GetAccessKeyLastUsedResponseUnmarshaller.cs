...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAccessKeyLastUsedResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccessKeyLastUsedResponse response = new GetAccessKeyLastUsedResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetAccessKeyLastUsedResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetAccessKeyLastUsedResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AccessKeyLastUsed", targetDepth))
                    {
                        var unmarshaller = AccessKeyLastUsedUnmarshaller.Instance;
                        response.AccessKeyLastUsed = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        private static GetAccessKeyLastUsedResponseUnmarshaller _instance = new GetAccessKeyLastUsedResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessKeyLastUsedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
