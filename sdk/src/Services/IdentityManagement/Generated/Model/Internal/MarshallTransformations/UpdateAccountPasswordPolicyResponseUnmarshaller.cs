...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAccountPasswordPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAccountPasswordPolicyResponse response = new UpdateAccountPasswordPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateAccountPasswordPolicyResult", 2))
                    {
        ...
        private static UpdateAccountPasswordPolicyResponseUnmarshaller _instance = new UpdateAccountPasswordPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccountPasswordPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
