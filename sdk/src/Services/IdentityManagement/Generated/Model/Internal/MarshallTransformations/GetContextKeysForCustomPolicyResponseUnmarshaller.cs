...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetContextKeysForCustomPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContextKeysForCustomPolicyResponse response = new GetContextKeysForCustomPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetContextKeysForCustomPolicyResult", 2))
                    {
        ...
        private static GetContextKeysForCustomPolicyResponseUnmarshaller _instance = new GetContextKeysForCustomPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContextKeysForCustomPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
