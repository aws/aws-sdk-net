...
{
    /// <summary>
    /// Response Unmarshaller for AcceptDelegationRequest operation
    /// </summary>  
    public class AcceptDelegationRequestResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptDelegationRequestResponse response = new AcceptDelegationRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AcceptDelegationRequestResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AcceptDelegationRequestResponse response)
        {
        ...
        private static AcceptDelegationRequestResponseUnmarshaller _instance = new AcceptDelegationRequestResponseUnmarshaller();        

        internal static AcceptDelegationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptDelegationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
