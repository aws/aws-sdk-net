...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateSAMLProviderRequestMarshaller : IMarshaller<IRequest, UpdateSAMLProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSAMLProviderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSAMLProviderRequest publicRequest)
        {
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetRemovePrivateKey())
                {
                    request.Parameters.Add("RemovePrivateKey", StringUtils.FromString(publicRequest.RemovePrivateKey));
                }
            ...
            return request;
                    ...
                    private static UpdateSAMLProviderRequestMarshaller _instance = new UpdateSAMLProviderRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSAMLProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
