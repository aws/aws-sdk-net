...
{
    /// <summary>
    /// Response Unmarshaller for RejectDelegationRequest operation
    /// </summary>  
    public class RejectDelegationRequestResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectDelegationRequestResponse response = new RejectDelegationRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RejectDelegationRequestResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, RejectDelegationRequestResponse response)
        {
        ...
        private static RejectDelegationRequestResponseUnmarshaller _instance = new RejectDelegationRequestResponseUnmarshaller();        

        internal static RejectDelegationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectDelegationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
