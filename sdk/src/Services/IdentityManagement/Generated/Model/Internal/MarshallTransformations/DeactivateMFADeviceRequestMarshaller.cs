...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeactivateMFADeviceRequestMarshaller : IMarshaller<IRequest, DeactivateMFADeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeactivateMFADeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeactivateMFADeviceRequest publicRequest)
        {
