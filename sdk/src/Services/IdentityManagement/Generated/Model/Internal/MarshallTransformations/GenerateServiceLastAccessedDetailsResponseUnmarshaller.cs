...
{
    /// <summary>
    /// Response Unmarshaller for GenerateServiceLastAccessedDetails operation
    /// </summary>  
    public class GenerateServiceLastAccessedDetailsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateServiceLastAccessedDetailsResponse response = new GenerateServiceLastAccessedDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GenerateServiceLastAccessedDetailsResult", 2))
                    {
        ...
        private static GenerateServiceLastAccessedDetailsResponseUnmarshaller _instance = new GenerateServiceLastAccessedDetailsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateServiceLastAccessedDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
