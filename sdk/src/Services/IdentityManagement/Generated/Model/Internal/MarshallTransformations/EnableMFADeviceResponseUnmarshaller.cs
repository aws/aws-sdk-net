    ...
    public class EnableMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnableMFADeviceResult", 2))
                    {
        ...
        private static EnableMFADeviceResponseUnmarshaller _instance = new EnableMFADeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableMFADeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
