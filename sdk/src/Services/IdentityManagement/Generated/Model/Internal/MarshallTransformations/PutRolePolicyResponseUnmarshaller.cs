...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRolePolicyResponse response = new PutRolePolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutRolePolicyResult", 2))
                    {
        ...
        private static PutRolePolicyResponseUnmarshaller _instance = new PutRolePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRolePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
