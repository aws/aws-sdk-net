...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListEntitiesForPolicyRequestMarshaller : IMarshaller<IRequest, ListEntitiesForPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListEntitiesForPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListEntitiesForPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityManagement");
            request.Parameters.Add("Action", "ListEntitiesForPolicy");
            request.Parameters.Add("Version", "2010-05-08");

            if(publicRequest != null)
            {
                if(publicRequest.IsSetEntityFilter())
                {
                    request.Parameters.Add("EntityFilter", StringUtils.FromString(publicRequest.EntityFilter));
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEntitiesForPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
