...
{
    /// <summary>
    /// Response Unmarshaller for ListPoliciesGrantingServiceAccess operation
    /// </summary>  
    public class ListPoliciesGrantingServiceAccessResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPoliciesGrantingServiceAccessResponse response = new ListPoliciesGrantingServiceAccessResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListPoliciesGrantingServiceAccessResult", 2))
                    {
        ...
        private static ListPoliciesGrantingServiceAccessResponseUnmarshaller _instance = new ListPoliciesGrantingServiceAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPoliciesGrantingServiceAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
