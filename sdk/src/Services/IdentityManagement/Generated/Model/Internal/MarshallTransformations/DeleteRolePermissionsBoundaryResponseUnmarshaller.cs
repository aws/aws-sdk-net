...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRolePermissionsBoundary operation
    /// </summary>  
    public class DeleteRolePermissionsBoundaryResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRolePermissionsBoundaryResponse response = new DeleteRolePermissionsBoundaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteRolePermissionsBoundaryResult", 2))
                    {
        ...
        private static DeleteRolePermissionsBoundaryResponseUnmarshaller _instance = new DeleteRolePermissionsBoundaryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRolePermissionsBoundaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
