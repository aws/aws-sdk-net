...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateOpenIDConnectProviderThumbprintResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateOpenIDConnectProviderThumbprintResponse response = new UpdateOpenIDConnectProviderThumbprintResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateOpenIDConnectProviderThumbprintResult", 2))
                    {
        ...
        private static UpdateOpenIDConnectProviderThumbprintResponseUnmarshaller _instance = new UpdateOpenIDConnectProviderThumbprintResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateOpenIDConnectProviderThumbprintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
