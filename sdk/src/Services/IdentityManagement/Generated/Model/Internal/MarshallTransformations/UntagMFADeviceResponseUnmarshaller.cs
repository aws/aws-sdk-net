...
{
    /// <summary>
    /// Response Unmarshaller for UntagMFADevice operation
    /// </summary>  
    public class UntagMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagMFADeviceResponse response = new UntagMFADeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagMFADeviceResult", 2))
                    {
        ...
        private static UntagMFADeviceResponseUnmarshaller _instance = new UntagMFADeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagMFADeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
