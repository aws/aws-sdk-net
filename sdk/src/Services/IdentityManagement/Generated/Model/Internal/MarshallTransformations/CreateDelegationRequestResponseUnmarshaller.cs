...
{
    /// <summary>
    /// Response Unmarshaller for CreateDelegationRequest operation
    /// </summary>  
    public class CreateDelegationRequestResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDelegationRequestResponse response = new CreateDelegationRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateDelegationRequestResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateDelegationRequestResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ConsoleDeepLink", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.ConsoleDeepLink = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("DelegationRequestId", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.DelegationRequestId = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static CreateDelegationRequestResponseUnmarshaller _instance = new CreateDelegationRequestResponseUnmarshaller();        

        internal static CreateDelegationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDelegationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
