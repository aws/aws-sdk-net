...
{
    /// <summary>
    /// Response Unmarshaller for PutAccountProperties operation
    /// </summary>  
    public class PutAccountPropertiesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccountPropertiesResponse response = new PutAccountPropertiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutAccountPropertiesResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, PutAccountPropertiesResponse response)
        {
        ...
        private static PutAccountPropertiesResponseUnmarshaller _instance = new PutAccountPropertiesResponseUnmarshaller();        

        internal static PutAccountPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccountPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
