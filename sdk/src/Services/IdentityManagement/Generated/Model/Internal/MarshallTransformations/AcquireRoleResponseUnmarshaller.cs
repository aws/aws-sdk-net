...
{
    /// <summary>
    /// Response Unmarshaller for AcquireRole operation
    /// </summary>  
    public class AcquireRoleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcquireRoleResponse response = new AcquireRoleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AcquireRoleResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AcquireRoleResponse response)
        {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NameConflict"))
                {
                    return NameConflictExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("RoleModified"))
                {
                    return RoleModifiedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("RoleTemplateDisabled"))
                {
                    return RoleTemplateDisabledExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static AcquireRoleResponseUnmarshaller _instance = new AcquireRoleResponseUnmarshaller();        

        internal static AcquireRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcquireRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
