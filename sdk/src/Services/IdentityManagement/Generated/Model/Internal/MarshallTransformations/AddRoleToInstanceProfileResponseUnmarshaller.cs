...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddRoleToInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddRoleToInstanceProfileResponse response = new AddRoleToInstanceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AddRoleToInstanceProfileResult", 2))
                    {
        ...
        private static AddRoleToInstanceProfileResponseUnmarshaller _instance = new AddRoleToInstanceProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddRoleToInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
