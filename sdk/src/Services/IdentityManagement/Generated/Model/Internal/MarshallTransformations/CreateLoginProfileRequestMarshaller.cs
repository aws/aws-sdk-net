...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLoginProfileRequestMarshaller : IMarshaller<IRequest, CreateLoginProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLoginProfileRequest)input);
        }
        ...
        public IRequest Marshall(CreateLoginProfileRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CreateLoginProfileRequestMarshaller _instance = new CreateLoginProfileRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLoginProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
