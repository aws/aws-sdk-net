...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListInstanceProfilesForRoleRequestMarshaller : IMarshaller<IRequest, ListInstanceProfilesForRoleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInstanceProfilesForRoleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInstanceProfilesForRoleRequest publicRequest)
        {
