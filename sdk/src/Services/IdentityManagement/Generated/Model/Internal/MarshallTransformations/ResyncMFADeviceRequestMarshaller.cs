...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ResyncMFADeviceRequestMarshaller : IMarshaller<IRequest, ResyncMFADeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ResyncMFADeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ResyncMFADeviceRequest publicRequest)
        {
