...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAccountAliasResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateAccountAliasResult", 2))
                    {
        ...
        private static CreateAccountAliasResponseUnmarshaller _instance = new CreateAccountAliasResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
