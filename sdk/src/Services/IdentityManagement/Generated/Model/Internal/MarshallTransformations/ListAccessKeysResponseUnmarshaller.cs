...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAccessKeysResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AccessKeyMetadata/member", targetDepth))
                    {
                        ...
                        {
                            response.AccessKeyMetadata = new List<AccessKeyMetadata>();
                        }
        ...
        private static ListAccessKeysResponseUnmarshaller _instance = new ListAccessKeysResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
