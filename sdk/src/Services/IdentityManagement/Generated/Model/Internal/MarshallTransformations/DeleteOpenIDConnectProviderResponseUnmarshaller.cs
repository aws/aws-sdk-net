...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteOpenIDConnectProviderResponse response = new DeleteOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteOpenIDConnectProviderResult", 2))
                    {
        ...
        private static DeleteOpenIDConnectProviderResponseUnmarshaller _instance = new DeleteOpenIDConnectProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
