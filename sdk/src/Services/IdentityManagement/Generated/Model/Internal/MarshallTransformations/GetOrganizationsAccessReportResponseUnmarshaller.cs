...
{
    /// <summary>
    /// Response Unmarshaller for GetOrganizationsAccessReport operation
    /// </summary>  
    public class GetOrganizationsAccessReportResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOrganizationsAccessReportResponse response = new GetOrganizationsAccessReportResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetOrganizationsAccessReportResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetOrganizationsAccessReportResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = AccessDetailUnmarshaller.Instance;
                        if (response.AccessDetails == null)
                        {
                            response.AccessDetails = new List<AccessDetail>();
                        }
                        var item = unmarshaller.Unmarshall(context);
                        response.AccessDetails.Add(item);
                        continue;
                    }
        ...
        private static GetOrganizationsAccessReportResponseUnmarshaller _instance = new GetOrganizationsAccessReportResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOrganizationsAccessReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
