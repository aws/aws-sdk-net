...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDelegationRequest operation
    /// </summary>  
    public class UpdateDelegationRequestResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDelegationRequestResponse response = new UpdateDelegationRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateDelegationRequestResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateDelegationRequestResponse response)
        {
        ...
        private static UpdateDelegationRequestResponseUnmarshaller _instance = new UpdateDelegationRequestResponseUnmarshaller();        

        internal static UpdateDelegationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDelegationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
