...
{
    /// <summary>
    /// Response Unmarshaller for UntagSAMLProvider operation
    /// </summary>  
    public class UntagSAMLProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagSAMLProviderResponse response = new UntagSAMLProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagSAMLProviderResult", 2))
                    {
        ...
        private static UntagSAMLProviderResponseUnmarshaller _instance = new UntagSAMLProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagSAMLProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
