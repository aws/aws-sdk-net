...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveUserFromGroupRequestMarshaller : IMarshaller<IRequest, RemoveUserFromGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveUserFromGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveUserFromGroupRequest publicRequest)
        {
