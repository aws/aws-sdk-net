...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAttachedRolePoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AttachedPolicies/member", targetDepth))
                    {
                        ...
                        {
                            response.AttachedPolicies = new List<AttachedPolicyType>();
                        }
        ...
        private static ListAttachedRolePoliciesResponseUnmarshaller _instance = new ListAttachedRolePoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedRolePoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
