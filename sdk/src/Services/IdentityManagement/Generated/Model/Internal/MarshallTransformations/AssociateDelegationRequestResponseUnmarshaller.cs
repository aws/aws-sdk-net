...
{
    /// <summary>
    /// Response Unmarshaller for AssociateDelegationRequest operation
    /// </summary>  
    public class AssociateDelegationRequestResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateDelegationRequestResponse response = new AssociateDelegationRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AssociateDelegationRequestResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AssociateDelegationRequestResponse response)
        {
        ...
        private static AssociateDelegationRequestResponseUnmarshaller _instance = new AssociateDelegationRequestResponseUnmarshaller();        

        internal static AssociateDelegationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDelegationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
