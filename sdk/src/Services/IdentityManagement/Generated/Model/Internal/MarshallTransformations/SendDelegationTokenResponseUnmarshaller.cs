...
{
    /// <summary>
    /// Response Unmarshaller for SendDelegationToken operation
    /// </summary>  
    public class SendDelegationTokenResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendDelegationTokenResponse response = new SendDelegationTokenResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SendDelegationTokenResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, SendDelegationTokenResponse response)
        {
        ...
        private static SendDelegationTokenResponseUnmarshaller _instance = new SendDelegationTokenResponseUnmarshaller();        

        internal static SendDelegationTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendDelegationTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
