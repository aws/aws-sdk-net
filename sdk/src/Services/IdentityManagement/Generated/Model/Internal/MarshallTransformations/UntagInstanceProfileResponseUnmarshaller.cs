...
{
    /// <summary>
    /// Response Unmarshaller for UntagInstanceProfile operation
    /// </summary>  
    public class UntagInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagInstanceProfileResponse response = new UntagInstanceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagInstanceProfileResult", 2))
                    {
        ...
        private static UntagInstanceProfileResponseUnmarshaller _instance = new UntagInstanceProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
