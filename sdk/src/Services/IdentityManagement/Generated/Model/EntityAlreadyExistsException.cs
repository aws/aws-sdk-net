...
namespace Amazon.IdentityManagement.Model
{
    ...
    [Serializable]
    #endif
    public partial class EntityAlreadyExistsException : AmazonIdentityManagementServiceException
    {
        ...
        public EntityAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EntityAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
