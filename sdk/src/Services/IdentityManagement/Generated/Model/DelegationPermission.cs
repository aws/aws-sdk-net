...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class DelegationPermission
    {
        ...
        {
            get { return this._policyTemplateArn; }
            set { this._policyTemplateArn = value; }
        }

        // Check to see if PolicyTemplateArn property is set
        internal bool IsSetPolicyTemplateArn()
        {
            return this._policyTemplateArn != null;
        }
