...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class DeleteGroupRequest : AmazonIdentityManagementServiceRequest
    {
        ...
        /// </summary>
        /// <param name="groupName">The name of the IAM group to delete. This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</param>
