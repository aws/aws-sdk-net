...
{
    /// <summary>
    /// Base class for ListSigningCertificates paginators.
    /// </summary>
    internal sealed partial class ListSigningCertificatesPaginator : IPaginator<ListSigningCertificatesResponse>, IListSigningCertificatesPaginator
    {
        private readonly IAmazonIdentityManagementService _client;
        private readonly ListSigningCertificatesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListSigningCertificatesResponse> Responses => new PaginatedResponse<ListSigningCertificatesResponse>(this);
...
#if BCL
        IEnumerable<ListSigningCertificatesResponse> IPaginator<ListSigningCertificatesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListSigningCertificates(_request);
        ...
        async IAsyncEnumerable<ListSigningCertificatesResponse> IPaginator<ListSigningCertificatesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.Marker = marker;
                response = await _client.ListSigningCertificatesAsync(_request, cancellationToken).ConfigureAwait(false);
                marker = response.Marker;
