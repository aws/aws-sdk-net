...
namespace Amazon.IdentityManagement.Model
{
    ...
    internal sealed partial class ListInstanceProfileTagsPaginator : IPaginator<ListInstanceProfileTagsResponse>, IListInstanceProfileTagsPaginator
    {
        ...
        public IPaginatedEnumerable<Tag> Tags => 
            new PaginatedResultKeyResponse<ListInstanceProfileTagsResponse, Tag>(this, (i) => i.Tags);
        ...
        async IAsyncEnumerable<ListInstanceProfileTagsResponse> IPaginator<ListInstanceProfileTagsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
