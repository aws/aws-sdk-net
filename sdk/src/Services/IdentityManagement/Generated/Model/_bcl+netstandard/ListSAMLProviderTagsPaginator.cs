...
namespace Amazon.IdentityManagement.Model
{
    ...
    internal sealed partial class ListSAMLProviderTagsPaginator : IPaginator<ListSAMLProviderTagsResponse>, IListSAMLProviderTagsPaginator
    {
        ...
        public IPaginatedEnumerable<Tag> Tags => 
            new PaginatedResultKeyResponse<ListSAMLProviderTagsResponse, Tag>(this, (i) => i.Tags);
        ...
        async IAsyncEnumerable<ListSAMLProviderTagsResponse> IPaginator<ListSAMLProviderTagsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
