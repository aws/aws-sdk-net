...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class DuplicateSSHPublicKeyException : AmazonIdentityManagementServiceException
    {
        ...
        public DuplicateSSHPublicKeyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicateSSHPublicKeyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected DuplicateSSHPublicKeyException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
