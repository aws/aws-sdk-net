...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidReferenceNameException : AmazonCodeCommitException
    {
        ...
        public InvalidReferenceNameException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidReferenceNameException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
