...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class RevisionNotCurrentException : AmazonCodeCommitException
    {
        ...
        public RevisionNotCurrentException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RevisionNotCurrentException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
