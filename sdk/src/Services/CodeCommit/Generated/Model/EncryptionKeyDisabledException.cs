...
namespace Amazon.CodeCommit.Model
{
    ...
    [Serializable]
    #endif
    public partial class EncryptionKeyDisabledException : AmazonCodeCommitException
    {

        /// <summary>
        /// Default constructor for EncryptionKeyDisabledException
        /// message.
        /// </summary>
        public EncryptionKeyDisabledException() 
            : base() {}
        ...
        public EncryptionKeyDisabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EncryptionKeyDisabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
