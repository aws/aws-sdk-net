...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidRelativeFileVersionEnumException : AmazonCodeCommitException
    {
        ...
        public InvalidRelativeFileVersionEnumException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRelativeFileVersionEnumException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
