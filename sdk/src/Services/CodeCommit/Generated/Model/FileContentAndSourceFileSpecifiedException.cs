...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class FileContentAndSourceFileSpecifiedException : AmazonCodeCommitException
    {
        ...
        public FileContentAndSourceFileSpecifiedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FileContentAndSourceFileSpecifiedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected FileContentAndSourceFileSpecifiedException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
