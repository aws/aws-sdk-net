...
namespace Amazon.CodeCommit.Model
{
    ...
    public class FileContentAndSourceFileSpecifiedException : AmazonCodeCommitException 
    {
        ...
        public FileContentAndSourceFileSpecifiedException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FileContentAndSourceFileSpecifiedException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
