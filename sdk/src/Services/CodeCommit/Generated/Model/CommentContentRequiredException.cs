...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class CommentContentRequiredException : AmazonCodeCommitException
    {
        ...
        public CommentContentRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CommentContentRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
