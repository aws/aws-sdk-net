...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class MaximumFileEntriesExceededException : AmazonCodeCommitException
    {
        ...
        /// <summary>
        /// Default constructor for MaximumFileEntriesExceededException
        /// message.
        /// </summary>
        public MaximumFileEntriesExceededException() 
            : base() {}
        ...
        public MaximumFileEntriesExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MaximumFileEntriesExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
