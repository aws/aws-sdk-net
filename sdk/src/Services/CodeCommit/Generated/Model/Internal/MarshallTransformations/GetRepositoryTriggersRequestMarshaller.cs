...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetRepositoryTriggersRequestMarshaller : IMarshaller<IRequest, GetRepositoryTriggersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRepositoryTriggersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRepositoryTriggersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeCommit");
            string target = "CodeCommit_20150413.GetRepositoryTriggers";
