...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class MergeBranchesByFastForwardRequestMarshaller : IMarshaller<IRequest, MergeBranchesByFastForwardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((MergeBranchesByFastForwardRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(MergeBranchesByFastForwardRequest publicRequest)
        {
        ...
        private static MergeBranchesByFastForwardRequestMarshaller _instance = new MergeBranchesByFastForwardRequestMarshaller();        

        internal static MergeBranchesByFastForwardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MergeBranchesByFastForwardRequestMarshaller Instance
        {
            get
            {
                return _instance;
