...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("repositoryMetadata", targetDepth, ref reader))
                {
                    var unmarshaller = RepositoryMetadataUnmarshaller.Instance;
                    response.RepositoryMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRepositoryResponseUnmarshaller _instance = new GetRepositoryResponseUnmarshaller();        

        internal static GetRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
