...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PullRequestStatusChangedEventMetadataUnmarshaller : IUnmarshaller<PullRequestStatusChangedEventMetadata, XmlUnmarshallerContext>, IUnmarshaller<PullRequestStatusChangedEventMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PullRequestStatusChangedEventMetadata IUnmarshaller<PullRequestStatusChangedEventMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PullRequestStatusChangedEventMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
