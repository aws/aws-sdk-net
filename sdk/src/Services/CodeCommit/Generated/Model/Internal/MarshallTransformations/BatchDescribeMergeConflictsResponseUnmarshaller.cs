    ...
    public class BatchDescribeMergeConflictsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Conflict, ConflictUnmarshaller>(ConflictUnmarshaller.Instance);
                    response.Conflicts = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("destinationCommitId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DestinationCommitId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("errors", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<BatchDescribeMergeConflictsError, BatchDescribeMergeConflictsErrorUnmarshaller>(BatchDescribeMergeConflictsErrorUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceCommitId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new InvalidMaxMergeHunksException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidMergeOptionException"))
            {
                return new InvalidMergeOptionException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
