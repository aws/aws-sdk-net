...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDescribeMergeConflictsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDescribeMergeConflictsResponse response = new BatchDescribeMergeConflictsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("conflicts", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Conflict, ConflictUnmarshaller>(ConflictUnmarshaller.Instance);
                    response.Conflicts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDescribeMergeConflictsError, BatchDescribeMergeConflictsErrorUnmarshaller>(BatchDescribeMergeConflictsErrorUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InvalidMaxConflictFilesExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidMaxMergeHunksException"))
                {
                    return InvalidMaxMergeHunksExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidMergeOptionException"))
                {
                    return InvalidMergeOptionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return MergeOptionRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static BatchDescribeMergeConflictsResponseUnmarshaller _instance = new BatchDescribeMergeConflictsResponseUnmarshaller();        

        internal static BatchDescribeMergeConflictsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDescribeMergeConflictsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
