...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MergePullRequestBySquashResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            MergePullRequestBySquashResponse response = new MergePullRequestBySquashResponse();
        ...
        private static MergePullRequestBySquashResponseUnmarshaller _instance = new MergePullRequestBySquashResponseUnmarshaller();        

        internal static MergePullRequestBySquashResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MergePullRequestBySquashResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
