...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCommentsForComparedCommitRequestMarshaller : IMarshaller<IRequest, GetCommentsForComparedCommitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCommentsForComparedCommitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCommentsForComparedCommitRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeCommit");
            string target = "CodeCommit_20150413.GetCommentsForComparedCommit";
            ...
            if(publicRequest.IsSetAfterCommitId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AfterCommitId);
            }

            if(publicRequest.IsSetBeforeCommitId())
            {
                context.Writer.WritePropertyName("beforeCommitId");
                context.Writer.WriteStringValue(publicRequest.BeforeCommitId);
            }
