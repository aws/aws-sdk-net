...
{
    /// <summary>
    /// Response Unmarshaller for GetBlobDifferences operation
    /// </summary>  
    public class GetBlobDifferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBlobDifferencesResponse response = new GetBlobDifferencesResponse();
            ...
            {
                if (context.TestExpression("afterBlobSize", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.AfterBlobSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("beforeBlobSize", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.BeforeBlobSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("hunks", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DiffHunk, DiffHunkUnmarshaller>(DiffHunkUnmarshaller.Instance);
                    response.Hunks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("isBinary", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.IsBinary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetBlobDifferencesResponseUnmarshaller _instance = new GetBlobDifferencesResponseUnmarshaller();        

        internal static GetBlobDifferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBlobDifferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
