...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SymbolicLinkUnmarshaller : IUnmarshaller<SymbolicLink, XmlUnmarshallerContext>, IUnmarshaller<SymbolicLink, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SymbolicLink IUnmarshaller<SymbolicLink, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SymbolicLink Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
