...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class MergePullRequestByThreeWayRequestMarshaller : IMarshaller<IRequest, MergePullRequestByThreeWayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((MergePullRequestByThreeWayRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(MergePullRequestByThreeWayRequest publicRequest)
        {
        ...
        private static MergePullRequestByThreeWayRequestMarshaller _instance = new MergePullRequestByThreeWayRequestMarshaller();        

        internal static MergePullRequestByThreeWayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MergePullRequestByThreeWayRequestMarshaller Instance
        {
            get
            {
                return _instance;
