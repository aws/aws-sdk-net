...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeletePullRequestApprovalRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePullRequestApprovalRuleResponse response = new DeletePullRequestApprovalRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("approvalRuleId", targetDepth))
                {
                    ...
                    response.ApprovalRuleId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("ApprovalRuleNameRequiredException"))
            {
                return new ApprovalRuleNameRequiredException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("CannotDeleteApprovalRuleFromTemplateException"))
            {
                return new CannotDeleteApprovalRuleFromTemplateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidApprovalRuleNameException"))
            {
                return new InvalidApprovalRuleNameException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DeletePullRequestApprovalRuleResponseUnmarshaller _instance = new DeletePullRequestApprovalRuleResponseUnmarshaller();        

        internal static DeletePullRequestApprovalRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePullRequestApprovalRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
