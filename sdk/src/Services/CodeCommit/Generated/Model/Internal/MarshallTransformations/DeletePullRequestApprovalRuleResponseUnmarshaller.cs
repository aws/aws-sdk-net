    ...
    public class DeletePullRequestApprovalRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return ApprovalRuleNameRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("CannotDeleteApprovalRuleFromTemplateException"))
                {
                    return CannotDeleteApprovalRuleFromTemplateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                {
                    return InvalidApprovalRuleNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
