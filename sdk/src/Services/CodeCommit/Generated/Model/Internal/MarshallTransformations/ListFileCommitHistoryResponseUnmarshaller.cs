    ...
    public class ListFileCommitHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FileVersion, FileVersionUnmarshaller>(FileVersionUnmarshaller.Instance);
                    response.RevisionDag = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
