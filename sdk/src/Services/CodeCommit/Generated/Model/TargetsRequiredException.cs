...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class TargetsRequiredException : AmazonCodeCommitException
    {
        ...
        public TargetsRequiredException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
