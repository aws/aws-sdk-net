...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class BranchNameExistsException : AmazonCodeCommitException
    {
        ...
        /// <summary>
        /// Default constructor for BranchNameExistsException
        /// message.
        /// </summary>
        public BranchNameExistsException() 
            : base() {}
        ...
        public BranchNameExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public BranchNameExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
