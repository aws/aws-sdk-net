...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class ApprovalRuleTemplateInUseException : AmazonCodeCommitException
    {
        ...
        public ApprovalRuleTemplateInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ApprovalRuleTemplateInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
