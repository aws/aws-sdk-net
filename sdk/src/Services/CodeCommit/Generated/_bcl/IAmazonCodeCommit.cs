...
namespace Amazon.CodeCommit
{
    ...
    public partial interface IAmazonCodeCommit : IAmazonService, IDisposable
    {
        ...
        GetBlobDifferencesResponse GetBlobDifferences(GetBlobDifferencesRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codecommit-2015-04-13/GetBlobDifferences">REST API Reference for GetBlobDifferences Operation</seealso>
        Task<GetBlobDifferencesResponse> GetBlobDifferencesAsync(GetBlobDifferencesRequest request, CancellationToken cancellationToken = default(CancellationToken));
