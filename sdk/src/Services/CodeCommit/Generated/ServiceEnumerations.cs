...
namespace Amazon.CodeCommit
{
    ...
    /// <summary>
    /// Constants used for properties of type DiffChangeType.
    /// </summary>
    public class DiffChangeType : ConstantClass
    {

        /// <summary>
        /// Constant ADD for DiffChangeType
        /// </summary>
        public static readonly DiffChangeType ADD = new DiffChangeType("ADD");
        /// <summary>
        /// Constant CONTEXT for DiffChangeType
        /// </summary>
        public static readonly DiffChangeType CONTEXT = new DiffChangeType("CONTEXT");
        /// <summary>
        /// Constant DELETE for DiffChangeType
        /// </summary>
        public static readonly DiffChangeType DELETE = new DiffChangeType("DELETE");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public DiffChangeType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static DiffChangeType FindValue(string value)
        {
            return FindValue<DiffChangeType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator DiffChangeType(string value)
        {
            return FindValue(value);
        }
    }
