...
namespace Amazon.CodeCommit
{
    ...
    public partial interface IAmazonCodeCommit : IAmazonService, IDisposable
    {
        ...
        Task<GetBlobDifferencesResponse> GetBlobDifferencesAsync(GetBlobDifferencesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
