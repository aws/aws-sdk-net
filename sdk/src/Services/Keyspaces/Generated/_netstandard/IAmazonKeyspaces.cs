...
namespace Amazon.Keyspaces
{
    ...
    public partial interface IAmazonKeyspaces : IAmazonService, IDisposable
    {
        ...
        Task<UpdateKeyspaceResponse> UpdateKeyspaceAsync(UpdateKeyspaceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKeyspacesConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKeyspacesConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKeyspacesConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKeyspacesConfig to create AmazonKeyspacesClient");
            }

            return awsCredentials == null ? 
                    new AmazonKeyspacesClient(serviceClientConfig) :
                    new AmazonKeyspacesClient(awsCredentials, serviceClientConfig);
        }
