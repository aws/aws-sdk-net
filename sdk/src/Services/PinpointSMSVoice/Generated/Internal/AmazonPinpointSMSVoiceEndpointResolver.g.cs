...
namespace Amazon.PinpointSMSVoice.Internal
{
    /// <summary>
    /// Amazon PinpointSMSVoice endpoint resolver.
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for PinpointSMSVoice service requests.
    /// <para />
    /// Collects values for <see cref="PinpointSMSVoiceEndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonPinpointSMSVoiceEndpointProvider"/>.
    /// <para />
    /// Responsible for setting authentication and HTTP headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPinpointSMSVoiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPinpointSMSVoiceConfig)requestContext.ClientConfig;
            var result = new PinpointSMSVoiceEndpointParameters();
