...
namespace Amazon.PinpointSMSVoice
{
    ...
    public partial class AmazonPinpointSMSVoiceClient : AmazonServiceClient, IAmazonPinpointSMSVoice
    {
        ...
        /// 
        /// </summary>
        public AmazonPinpointSMSVoiceClient() : base(new AmazonPinpointSMSVoiceConfig()) { }
        ...
        public AmazonPinpointSMSVoiceClient(RegionEndpoint region) : base(new AmazonPinpointSMSVoiceConfig { RegionEndpoint = region }) { }
        ...
        public AmazonPinpointSMSVoiceClient(AmazonPinpointSMSVoiceConfig config) : base(config) { }
