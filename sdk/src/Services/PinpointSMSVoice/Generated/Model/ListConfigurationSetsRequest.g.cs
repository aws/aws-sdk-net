...
{
    /// <summary>
    /// Container for the parameters to the ListConfigurationSets operation. List all of the
    /// configuration sets associated with your Amazon Pinpoint account in the current region.
    /// </summary>
    public partial class ListConfigurationSetsRequest : AmazonPinpointSMSVoiceRequest
    {
        ...
        /// </summary>
        internal bool IsSetPageSize() => this.PageSize != null;
    }
}
