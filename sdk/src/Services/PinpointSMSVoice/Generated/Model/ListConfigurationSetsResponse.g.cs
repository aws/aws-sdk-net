...
{
    /// <summary>
    /// This is the response object from the ListConfigurationSets operation.
    /// </summary>
    public partial class ListConfigurationSetsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<string> ConfigurationSets { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ConfigurationSets property is set.
        /// </summary>
        internal bool IsSetConfigurationSets() => this.ConfigurationSets != null && (this.ConfigurationSets.Count > 0 || !AWSConfigs.InitializeCollections);
