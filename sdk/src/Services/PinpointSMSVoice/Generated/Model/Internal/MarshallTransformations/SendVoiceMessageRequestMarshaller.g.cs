...
namespace Amazon.PinpointSMSVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendVoiceMessageRequestMarshaller : IMarshaller<IRequest, SendVoiceMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SendVoiceMessageRequestMarshaller _instance = new();

        internal static SendVoiceMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendVoiceMessageRequestMarshaller Instance => _instance;
    }
}
