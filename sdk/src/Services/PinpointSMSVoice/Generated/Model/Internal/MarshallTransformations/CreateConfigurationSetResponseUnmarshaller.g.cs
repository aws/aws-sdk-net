...
{
    /// <summary>
    /// Response Unmarshaller for CreateConfigurationSet operation.
    /// </summary>
    public partial class CreateConfigurationSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateConfigurationSetResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonPinpointSMSVoiceException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static CreateConfigurationSetResponseUnmarshaller _instance = new CreateConfigurationSetResponseUnmarshaller();

        internal static CreateConfigurationSetResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateConfigurationSetResponseUnmarshaller Instance => _instance;
    }
}
