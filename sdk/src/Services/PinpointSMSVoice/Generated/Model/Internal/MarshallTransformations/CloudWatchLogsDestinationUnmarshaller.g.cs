...
namespace Amazon.PinpointSMSVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CloudWatchLogsDestinationUnmarshaller : IJsonUnmarshaller<CloudWatchLogsDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CloudWatchLogsDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CloudWatchLogsDestinationUnmarshaller Instance => _instance;
    }
}
