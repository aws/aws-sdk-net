...
namespace Amazon.PinpointSMSVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateConfigurationSetRequestMarshaller : IMarshaller<IRequest, CreateConfigurationSetRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateConfigurationSetRequestMarshaller _instance = new();

        internal static CreateConfigurationSetRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateConfigurationSetRequestMarshaller Instance => _instance;
    }
}
