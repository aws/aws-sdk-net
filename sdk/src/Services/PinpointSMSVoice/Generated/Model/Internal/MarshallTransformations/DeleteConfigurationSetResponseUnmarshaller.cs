...
namespace Amazon.PinpointSMSVoice.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteConfigurationSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonPinpointSMSVoiceException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }
