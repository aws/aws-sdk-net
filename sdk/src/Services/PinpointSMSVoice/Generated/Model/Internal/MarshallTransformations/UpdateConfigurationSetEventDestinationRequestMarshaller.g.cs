...
{
    /// <summary>
    /// UpdateConfigurationSetEventDestination Request Marshaller
    /// </summary>
    public partial class UpdateConfigurationSetEventDestinationRequestMarshaller : IMarshaller<IRequest, UpdateConfigurationSetEventDestinationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateConfigurationSetEventDestinationRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateConfigurationSetEventDestinationRequest publicRequest)
        {
        ...
        private static readonly UpdateConfigurationSetEventDestinationRequestMarshaller _instance = new();

        internal static UpdateConfigurationSetEventDestinationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateConfigurationSetEventDestinationRequestMarshaller Instance => _instance;
    }
}
