...
namespace Amazon.PinpointSMSVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SnsDestinationUnmarshaller : IJsonUnmarshaller<SnsDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SnsDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SnsDestinationUnmarshaller Instance => _instance;
    }
}
