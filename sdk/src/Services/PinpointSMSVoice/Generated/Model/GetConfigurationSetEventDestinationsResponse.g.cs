...
{
    /// <summary>
    /// This is the response object from the GetConfigurationSetEventDestinations operation.
    /// </summary>
    public partial class GetConfigurationSetEventDestinationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<EventDestination> EventDestinations { get; set; } = AWSConfigs.InitializeCollections ? new List<EventDestination>() : null;
