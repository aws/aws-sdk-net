...
namespace Amazon.KinesisVideoArchivedMedia.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FragmentUnmarshaller : IJsonUnmarshaller<Fragment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Fragment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
