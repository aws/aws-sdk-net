...
namespace Amazon.KinesisVideoArchivedMedia.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMediaForFragmentListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMediaForFragmentListResponse response = new GetMediaForFragmentListResponse();
        ...
        private static GetMediaForFragmentListResponseUnmarshaller _instance = new GetMediaForFragmentListResponseUnmarshaller();        

        internal static GetMediaForFragmentListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMediaForFragmentListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
