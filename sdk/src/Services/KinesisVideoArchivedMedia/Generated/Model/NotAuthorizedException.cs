...
namespace Amazon.KinesisVideoArchivedMedia.Model
{
    ...
    public partial class NotAuthorizedException : AmazonKinesisVideoArchivedMediaException
    {
        ...
        /// <summary>
        /// Default constructor for NotAuthorizedException
        /// message.
        /// </summary>
        ...
        public NotAuthorizedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotAuthorizedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected NotAuthorizedException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
