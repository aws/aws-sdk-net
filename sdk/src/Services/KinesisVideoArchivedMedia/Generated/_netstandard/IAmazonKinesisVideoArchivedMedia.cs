...
namespace Amazon.KinesisVideoArchivedMedia
{
    ...
    public partial interface IAmazonKinesisVideoArchivedMedia : IAmazonService, IDisposable
    {
        ...
        Task<GetClipResponse> GetClipAsync(GetClipRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetDASHStreamingSessionURLResponse> GetDASHStreamingSessionURLAsync(GetDASHStreamingSessionURLRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetImagesResponse> GetImagesAsync(GetImagesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKinesisVideoArchivedMediaConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKinesisVideoArchivedMediaConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKinesisVideoArchivedMediaConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKinesisVideoArchivedMediaConfig to create AmazonKinesisVideoArchivedMediaClient");
            }

            return awsCredentials == null ? 
                    new AmazonKinesisVideoArchivedMediaClient(serviceClientConfig) :
                    new AmazonKinesisVideoArchivedMediaClient(awsCredentials, serviceClientConfig);
        }
