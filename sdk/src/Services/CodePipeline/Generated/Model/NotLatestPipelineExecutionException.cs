...
namespace Amazon.CodePipeline.Model
{
    ...
    public partial class NotLatestPipelineExecutionException : AmazonCodePipelineException
    {
        ...
        public NotLatestPipelineExecutionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotLatestPipelineExecutionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
