    ...
    public class ListActionTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ActionType, ActionTypeUnmarshaller>(ActionTypeUnmarshaller.Instance);
                    response.ActionTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
