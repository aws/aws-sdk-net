...
{
    /// <summary>
    /// Response Unmarshaller for ListActionTypes operation
    /// </summary>  
    public class ListActionTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListActionTypesResponse response = new ListActionTypesResponse();
            ...
            {
                if (context.TestExpression("actionTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ActionType, ActionTypeUnmarshaller>(ActionTypeUnmarshaller.Instance);
                    response.ActionTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListActionTypesResponseUnmarshaller _instance = new ListActionTypesResponseUnmarshaller();        

        internal static ListActionTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListActionTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
