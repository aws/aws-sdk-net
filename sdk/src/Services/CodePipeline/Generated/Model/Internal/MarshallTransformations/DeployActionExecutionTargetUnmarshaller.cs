...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeployActionExecutionTargetUnmarshaller : IUnmarshaller<DeployActionExecutionTarget, XmlUnmarshallerContext>, IUnmarshaller<DeployActionExecutionTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DeployActionExecutionTarget IUnmarshaller<DeployActionExecutionTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DeployActionExecutionTarget Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DeployTargetEvent, DeployTargetEventUnmarshaller>(DeployTargetEventUnmarshaller.Instance);
