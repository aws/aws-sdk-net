...
{
    /// <summary>
    /// Response Unmarshaller for PutActionRevision operation
    /// </summary>  
    public class PutActionRevisionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutActionRevisionResponse response = new PutActionRevisionResponse();
            ...
            {
                if (context.TestExpression("newRevision", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.NewRevision = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ActionNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static PutActionRevisionResponseUnmarshaller _instance = new PutActionRevisionResponseUnmarshaller();        

        internal static PutActionRevisionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutActionRevisionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
