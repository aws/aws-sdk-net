...
namespace Amazon.CodePipeline.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonCodePipelineAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodePipelineAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodePipeline.
        /// </summary>
        public AmazonCodePipelineAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodePipelineAuthSchemeParameters
            {
    ...
    public class AmazonCodePipelineAuthSchemeResolver : IAuthSchemeResolver<AmazonCodePipelineAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodePipelineAuthSchemeParameters authParameters)
        {
