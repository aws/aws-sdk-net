...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricSourceUnmarshaller : ICborUnmarshaller<MetricSource, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricSource Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "providerArn":
                        {
                            context.AddPathSegment("ProviderArn");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.ProviderArn = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
