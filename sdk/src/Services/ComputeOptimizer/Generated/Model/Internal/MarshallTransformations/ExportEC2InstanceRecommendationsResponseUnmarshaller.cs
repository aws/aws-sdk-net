...
{
    /// <summary>
    /// Response Unmarshaller for ExportEC2InstanceRecommendations operation
    /// </summary>  
    public class ExportEC2InstanceRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportEC2InstanceRecommendationsResponse response = new ExportEC2InstanceRecommendationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ExportEC2InstanceRecommendations");
            reader.ReadStartMap();
        ...
        private static ExportEC2InstanceRecommendationsResponseUnmarshaller _instance = new ExportEC2InstanceRecommendationsResponseUnmarshaller();        

        internal static ExportEC2InstanceRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportEC2InstanceRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
