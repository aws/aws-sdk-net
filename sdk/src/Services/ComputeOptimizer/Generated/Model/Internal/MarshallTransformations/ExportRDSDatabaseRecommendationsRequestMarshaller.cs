...
{
    /// <summary>
    /// ExportRDSDatabaseRecommendations Request Marshaller
    /// </summary>       
    public class ExportRDSDatabaseRecommendationsRequestMarshaller : IMarshaller<IRequest, ExportRDSDatabaseRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportRDSDatabaseRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportRDSDatabaseRecommendationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizer");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/ComputeOptimizerService/operation/ExportRDSDatabaseRecommendations";
        ...
        private static ExportRDSDatabaseRecommendationsRequestMarshaller _instance = new ExportRDSDatabaseRecommendationsRequestMarshaller();        

        internal static ExportRDSDatabaseRecommendationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportRDSDatabaseRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
