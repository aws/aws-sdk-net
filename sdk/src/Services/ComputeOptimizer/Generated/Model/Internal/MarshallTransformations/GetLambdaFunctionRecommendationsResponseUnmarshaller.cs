...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLambdaFunctionRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetLambdaFunctionRecommendations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "lambdaFunctionRecommendations":
                        {
                            context.AddPathSegment("LambdaFunctionRecommendations");
                            var unmarshaller = new CborListUnmarshaller<LambdaFunctionRecommendation, LambdaFunctionRecommendationUnmarshaller>(LambdaFunctionRecommendationUnmarshaller.Instance);
