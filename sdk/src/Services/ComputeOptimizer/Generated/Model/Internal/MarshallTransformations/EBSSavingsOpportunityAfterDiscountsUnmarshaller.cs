...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EBSSavingsOpportunityAfterDiscountsUnmarshaller : IJsonUnmarshaller<EBSSavingsOpportunityAfterDiscounts, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EBSSavingsOpportunityAfterDiscounts Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("savingsOpportunityPercentage", targetDepth))
                {
                    ...
                    unmarshalledObject.SavingsOpportunityPercentage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
