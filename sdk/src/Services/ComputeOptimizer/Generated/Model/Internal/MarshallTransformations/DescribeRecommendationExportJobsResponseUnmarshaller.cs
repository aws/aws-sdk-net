...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeRecommendationExportJobsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeRecommendationExportJobs");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "recommendationExportJobs":
                        {
                            context.AddPathSegment("RecommendationExportJobs");
                            var unmarshaller = new CborListUnmarshaller<RecommendationExportJob, RecommendationExportJobUnmarshaller>(RecommendationExportJobUnmarshaller.Instance);
