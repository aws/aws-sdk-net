...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    public class GetRDSDatabaseRecommendationsRequestMarshaller : IMarshaller<IRequest, GetRDSDatabaseRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetRDSDatabaseRecommendationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/ComputeOptimizerService/operation/GetRDSDatabaseRecommendations";
            ...
            try
            {
                ...
                if (publicRequest.IsSetResourceArns())
                {
                    ...
                    context.Writer.WriteStartArray(publicRequest.ResourceArns.Count);
                    foreach(var publicRequestResourceArnsListValue in publicRequest.ResourceArns)
                    {
                            context.Writer.WriteTextString(publicRequestResourceArnsListValue);
                    }
                    context.Writer.WriteEndArray();
                }
                writer.WriteEndMap();
