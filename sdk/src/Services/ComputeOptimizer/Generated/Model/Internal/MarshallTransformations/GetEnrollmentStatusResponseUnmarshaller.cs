...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEnrollmentStatusResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetEnrollmentStatus");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "memberAccountsEnrolled":
                        {
                            context.AddPathSegment("MemberAccountsEnrolled");
                    ...
                    case "numberOfMemberAccountsOptedIn":
                        {
                            context.AddPathSegment("NumberOfMemberAccountsOptedIn");
