...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContainerConfigurationUnmarshaller : ICborUnmarshaller<ContainerConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "memorySizeConfiguration":
                        {
                            context.AddPathSegment("MemorySizeConfiguration");
