...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VolumeRecommendationOptionUnmarshaller : IUnmarshaller<VolumeRecommendationOption, XmlUnmarshallerContext>, IUnmarshaller<VolumeRecommendationOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VolumeRecommendationOption IUnmarshaller<VolumeRecommendationOption, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static VolumeRecommendationOptionUnmarshaller _instance = new VolumeRecommendationOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VolumeRecommendationOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
