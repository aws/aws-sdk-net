...
{
    /// <summary>
    /// Response Unmarshaller for GetLicenseRecommendations operation
    /// </summary>  
    public class GetLicenseRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLicenseRecommendationsResponse response = new GetLicenseRecommendationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetLicenseRecommendations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "licenseRecommendations":
                        {
                            context.AddPathSegment("LicenseRecommendations");
                            var unmarshaller = new CborListUnmarshaller<LicenseRecommendation, LicenseRecommendationUnmarshaller>(LicenseRecommendationUnmarshaller.Instance);
                            response.LicenseRecommendations = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "nextToken":
        ...
        private static GetLicenseRecommendationsResponseUnmarshaller _instance = new GetLicenseRecommendationsResponseUnmarshaller();        

        internal static GetLicenseRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLicenseRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
