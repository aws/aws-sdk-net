...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEC2RecommendationProjectedMetricsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "recommendedOptionProjectedMetrics":
                        {
                            context.AddPathSegment("RecommendedOptionProjectedMetrics");
                            var unmarshaller = new CborListUnmarshaller<RecommendedOptionProjectedMetric, RecommendedOptionProjectedMetricUnmarshaller>(RecommendedOptionProjectedMetricUnmarshaller.Instance);
