...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecommendedOptionProjectedMetricUnmarshaller : ICborUnmarshaller<RecommendedOptionProjectedMetric, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecommendedOptionProjectedMetric Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "projectedMetrics":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<ProjectedMetric, ProjectedMetricUnmarshaller>(ProjectedMetricUnmarshaller.Instance);
                    ...
                    case "recommendedInstanceType":
                        {
                            context.AddPathSegment("RecommendedInstanceType");
