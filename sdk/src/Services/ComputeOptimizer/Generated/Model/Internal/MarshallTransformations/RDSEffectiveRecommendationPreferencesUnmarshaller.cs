...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RDSEffectiveRecommendationPreferencesUnmarshaller : ICborUnmarshaller<RDSEffectiveRecommendationPreferences, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RDSEffectiveRecommendationPreferences Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "cpuVendorArchitectures":
                        {
                            context.AddPathSegment("CpuVendorArchitectures");
