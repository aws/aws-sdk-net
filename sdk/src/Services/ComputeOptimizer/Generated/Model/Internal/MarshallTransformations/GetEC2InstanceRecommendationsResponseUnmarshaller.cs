...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEC2InstanceRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetEC2InstanceRecommendations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "instanceRecommendations":
                        {
                            context.AddPathSegment("InstanceRecommendations");
                            var unmarshaller = new CborListUnmarshaller<InstanceRecommendation, InstanceRecommendationUnmarshaller>(InstanceRecommendationUnmarshaller.Instance);
