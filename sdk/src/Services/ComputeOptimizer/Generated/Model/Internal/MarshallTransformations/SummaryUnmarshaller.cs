...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SummaryUnmarshaller : ICborUnmarshaller<Summary, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Summary Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "reasonCodeSummaries":
                        {
                            context.AddPathSegment("ReasonCodeSummaries");
                            var unmarshaller = new CborListUnmarshaller<ReasonCodeSummary, ReasonCodeSummaryUnmarshaller>(ReasonCodeSummaryUnmarshaller.Instance);
