...
{
    /// <summary>
    /// Response Unmarshaller for ExportECSServiceRecommendations operation
    /// </summary>  
    public class ExportECSServiceRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportECSServiceRecommendationsResponse response = new ExportECSServiceRecommendationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ExportECSServiceRecommendations");
            reader.ReadStartMap();
        ...
        private static ExportECSServiceRecommendationsResponseUnmarshaller _instance = new ExportECSServiceRecommendationsResponseUnmarshaller();        

        internal static ExportECSServiceRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportECSServiceRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
