...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoScalingGroupRecommendationOptionUnmarshaller : IUnmarshaller<AutoScalingGroupRecommendationOption, XmlUnmarshallerContext>, IUnmarshaller<AutoScalingGroupRecommendationOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutoScalingGroupRecommendationOption IUnmarshaller<AutoScalingGroupRecommendationOption, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AutoScalingGroupRecommendationOption Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
