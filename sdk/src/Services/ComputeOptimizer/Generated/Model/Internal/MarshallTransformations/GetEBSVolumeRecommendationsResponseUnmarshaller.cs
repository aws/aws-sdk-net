...
{
    /// <summary>
    /// Response Unmarshaller for GetEBSVolumeRecommendations operation
    /// </summary>  
    public class GetEBSVolumeRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEBSVolumeRecommendationsResponse response = new GetEBSVolumeRecommendationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetEBSVolumeRecommendations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "errors":
                        {
                            context.AddPathSegment("Errors");
                            var unmarshaller = new CborListUnmarshaller<GetRecommendationError, GetRecommendationErrorUnmarshaller>(GetRecommendationErrorUnmarshaller.Instance);
                    ...
                    case "volumeRecommendations":
                        {
                            context.AddPathSegment("VolumeRecommendations");
                            var unmarshaller = new CborListUnmarshaller<VolumeRecommendation, VolumeRecommendationUnmarshaller>(VolumeRecommendationUnmarshaller.Instance);
                            response.VolumeRecommendations = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static GetEBSVolumeRecommendationsResponseUnmarshaller _instance = new GetEBSVolumeRecommendationsResponseUnmarshaller();        

        internal static GetEBSVolumeRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEBSVolumeRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
