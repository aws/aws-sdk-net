...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LicenseRecommendationUnmarshaller : IUnmarshaller<LicenseRecommendation, XmlUnmarshallerContext>, IUnmarshaller<LicenseRecommendation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LicenseRecommendation IUnmarshaller<LicenseRecommendation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public LicenseRecommendation Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LicenseRecommendationOption, LicenseRecommendationOptionUnmarshaller>(LicenseRecommendationOptionUnmarshaller.Instance);
