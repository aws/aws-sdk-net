...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEnrollmentStatusesForOrganizationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetEnrollmentStatusesForOrganization");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "accountEnrollmentStatuses":
                        {
                            context.AddPathSegment("AccountEnrollmentStatuses");
                            var unmarshaller = new CborListUnmarshaller<AccountEnrollmentStatus, AccountEnrollmentStatusUnmarshaller>(AccountEnrollmentStatusUnmarshaller.Instance);
