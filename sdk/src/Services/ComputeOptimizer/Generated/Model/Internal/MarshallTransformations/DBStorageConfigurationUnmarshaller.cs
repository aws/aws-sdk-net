...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DBStorageConfigurationUnmarshaller : ICborUnmarshaller<DBStorageConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public DBStorageConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "allocatedStorage":
                        {
                            context.AddPathSegment("AllocatedStorage");
                    ...
                    case "maxAllocatedStorage":
                        {
                            context.AddPathSegment("MaxAllocatedStorage");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                    ...
                    case "storageThroughput":
                        {
                            context.AddPathSegment("StorageThroughput");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                    ...
                    case "storageType":
                        {
                            context.AddPathSegment("StorageType");
