...
{
    /// <summary>
    /// Response Unmarshaller for ExportAutoScalingGroupRecommendations operation
    /// </summary>  
    public class ExportAutoScalingGroupRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportAutoScalingGroupRecommendationsResponse response = new ExportAutoScalingGroupRecommendationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ExportAutoScalingGroupRecommendations");
            reader.ReadStartMap();
        ...
        private static ExportAutoScalingGroupRecommendationsResponseUnmarshaller _instance = new ExportAutoScalingGroupRecommendationsResponseUnmarshaller();        

        internal static ExportAutoScalingGroupRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportAutoScalingGroupRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
