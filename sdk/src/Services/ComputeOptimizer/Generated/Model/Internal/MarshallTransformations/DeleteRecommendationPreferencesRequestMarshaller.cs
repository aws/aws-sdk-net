...
{
    /// <summary>
    /// DeleteRecommendationPreferences Request Marshaller
    /// </summary>       
    public class DeleteRecommendationPreferencesRequestMarshaller : IMarshaller<IRequest, DeleteRecommendationPreferencesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRecommendationPreferencesRequest)input);
        }
        ...
        internal static DeleteRecommendationPreferencesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecommendationPreferencesRequestMarshaller Instance
        {
            get
            {
                return _instance;
