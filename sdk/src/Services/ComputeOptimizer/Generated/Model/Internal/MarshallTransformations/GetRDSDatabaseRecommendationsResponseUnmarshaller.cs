...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRDSDatabaseRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetRDSDatabaseRecommendations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "rdsDBRecommendations":
                        {
                            context.AddPathSegment("RdsDBRecommendations");
                            var unmarshaller = new CborListUnmarshaller<RDSDBRecommendation, RDSDBRecommendationUnmarshaller>(RDSDBRecommendationUnmarshaller.Instance);
                            response.RdsDBRecommendations = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
