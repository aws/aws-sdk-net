...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetECSServiceRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetECSServiceRecommendations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ecsServiceRecommendations":
                        {
                            context.AddPathSegment("EcsServiceRecommendations");
                            var unmarshaller = new CborListUnmarshaller<ECSServiceRecommendation, ECSServiceRecommendationUnmarshaller>(ECSServiceRecommendationUnmarshaller.Instance);
                            response.EcsServiceRecommendations = unmarshaller.Unmarshall(context);
