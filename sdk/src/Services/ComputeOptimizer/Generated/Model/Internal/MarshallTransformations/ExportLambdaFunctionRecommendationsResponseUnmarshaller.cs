...
{
    /// <summary>
    /// Response Unmarshaller for ExportLambdaFunctionRecommendations operation
    /// </summary>  
    public class ExportLambdaFunctionRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportLambdaFunctionRecommendationsResponse response = new ExportLambdaFunctionRecommendationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ExportLambdaFunctionRecommendations");
            reader.ReadStartMap();
        ...
        private static ExportLambdaFunctionRecommendationsResponseUnmarshaller _instance = new ExportLambdaFunctionRecommendationsResponseUnmarshaller();        

        internal static ExportLambdaFunctionRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportLambdaFunctionRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
