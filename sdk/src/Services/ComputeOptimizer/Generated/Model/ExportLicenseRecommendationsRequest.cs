...
{
    /// <summary>
    /// Container for the parameters to the ExportLicenseRecommendations operation.
    ...
    /// </para>
    /// </summary>
    public partial class ExportLicenseRecommendationsRequest : AmazonComputeOptimizerRequest
    {
        ...
        ///  
        /// <para>
        /// If this parameter is omitted, recommendations for member accounts aren't included
        /// in the export.
        /// </para>
        ///  
        /// <para>
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<LicenseRecommendationFilter> Filters
        {
