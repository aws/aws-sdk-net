...
namespace Amazon.ComputeOptimizer.Model
{
    ...
    public partial class OptInRequiredException : AmazonComputeOptimizerException
    {
        ...
        public OptInRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OptInRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
