...
namespace Amazon.ComputeOptimizer.Model
{
    ...
    public interface IGetEnrollmentStatusesForOrganizationPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<GetEnrollmentStatusesForOrganizationResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the AccountEnrollmentStatuses
        /// </summary>
        IPaginatedEnumerable<AccountEnrollmentStatus> AccountEnrollmentStatuses { get; }
    }
}