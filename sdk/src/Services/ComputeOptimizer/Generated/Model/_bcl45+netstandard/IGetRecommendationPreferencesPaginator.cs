...
namespace Amazon.ComputeOptimizer.Model
{
    ...
    public interface IGetRecommendationPreferencesPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<GetRecommendationPreferencesResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the RecommendationPreferencesDetails
        /// </summary>
        IPaginatedEnumerable<RecommendationPreferencesDetail> RecommendationPreferencesDetails { get; }
    }
}