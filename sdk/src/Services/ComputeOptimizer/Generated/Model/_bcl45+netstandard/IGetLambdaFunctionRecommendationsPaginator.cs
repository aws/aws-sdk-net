...
namespace Amazon.ComputeOptimizer.Model
{
    ...
    public interface IGetLambdaFunctionRecommendationsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<GetLambdaFunctionRecommendationsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the LambdaFunctionRecommendations
        /// </summary>
        IPaginatedEnumerable<LambdaFunctionRecommendation> LambdaFunctionRecommendations { get; }
    }
}