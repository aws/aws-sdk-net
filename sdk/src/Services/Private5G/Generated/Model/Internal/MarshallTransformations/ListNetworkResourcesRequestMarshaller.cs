...
{
    /// <summary>
    /// ListNetworkResources Request Marshaller
    /// </summary>       
    public class ListNetworkResourcesRequestMarshaller : IMarshaller<IRequest, ListNetworkResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListNetworkResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListNetworkResourcesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/network-resources";
        ...
        private static ListNetworkResourcesRequestMarshaller _instance = new ListNetworkResourcesRequestMarshaller();        

        internal static ListNetworkResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNetworkResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
