...
{
    /// <summary>
    /// CreateNetworkSite Request Marshaller
    /// </summary>       
    public class CreateNetworkSiteRequestMarshaller : IMarshaller<IRequest, CreateNetworkSiteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateNetworkSiteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateNetworkSiteRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetNetworkSiteName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.NetworkSiteName);
            }
        ...
        private static CreateNetworkSiteRequestMarshaller _instance = new CreateNetworkSiteRequestMarshaller();        

        internal static CreateNetworkSiteRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNetworkSiteRequestMarshaller Instance
        {
            get
            {
                return _instance;
