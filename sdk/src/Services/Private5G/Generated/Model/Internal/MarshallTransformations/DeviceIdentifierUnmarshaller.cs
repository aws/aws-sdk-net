...
namespace Amazon.Private5G.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceIdentifierUnmarshaller : IUnmarshaller<DeviceIdentifier, XmlUnmarshallerContext>, IUnmarshaller<DeviceIdentifier, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DeviceIdentifier IUnmarshaller<DeviceIdentifier, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DeviceIdentifier Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("deviceIdentifierArn", targetDepth))
                {
                    ...
                    unmarshalledObject.DeviceIdentifierArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("iccid", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Iccid = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("imsi", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Imsi = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TrafficGroupArn = unmarshaller.Unmarshall(context);
                    continue;
                }
