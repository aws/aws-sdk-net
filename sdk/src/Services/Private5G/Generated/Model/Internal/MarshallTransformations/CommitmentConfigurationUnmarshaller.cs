...
namespace Amazon.Private5G.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CommitmentConfigurationUnmarshaller : IJsonUnmarshaller<CommitmentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CommitmentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("commitmentLength", targetDepth))
                {
                    ...
                    unmarshalledObject.CommitmentLength = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
