...
{
    /// <summary>
    /// Response Unmarshaller for ListOrders operation
    /// </summary>  
    public class ListOrdersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("orders", targetDepth))
                {
                    ...
                    response.Orders = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListOrdersResponseUnmarshaller _instance = new ListOrdersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOrdersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
