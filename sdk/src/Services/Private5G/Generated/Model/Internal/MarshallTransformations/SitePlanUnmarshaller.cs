...
namespace Amazon.Private5G.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SitePlanUnmarshaller : IJsonUnmarshaller<SitePlan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SitePlan Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<NetworkResourceDefinition, NetworkResourceDefinitionUnmarshaller>(NetworkResourceDefinitionUnmarshaller.Instance);
                    unmarshalledObject.ResourceDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
