...
namespace Amazon.Private5G.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrackingInformationUnmarshaller : IJsonUnmarshaller<TrackingInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrackingInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
