...
{
    /// <summary>
    /// ListOrders Request Marshaller
    /// </summary>       
    public class ListOrdersRequestMarshaller : IMarshaller<IRequest, ListOrdersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListOrdersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListOrdersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/orders/list";
        ...
        private static ListOrdersRequestMarshaller _instance = new ListOrdersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOrdersRequestMarshaller Instance
        {
            get
            {
                return _instance;
