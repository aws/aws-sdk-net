...
{
    /// <summary>
    /// Response Unmarshaller for GetOrder operation
    /// </summary>  
    public class GetOrderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetOrderResponseUnmarshaller _instance = new GetOrderResponseUnmarshaller();        

        internal static GetOrderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOrderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
