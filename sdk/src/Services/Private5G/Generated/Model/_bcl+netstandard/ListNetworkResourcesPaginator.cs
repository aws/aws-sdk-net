...
{
    /// <summary>
    /// Base class for ListNetworkResources paginators.
    /// </summary>
    internal sealed partial class ListNetworkResourcesPaginator : IPaginator<ListNetworkResourcesResponse>, IListNetworkResourcesPaginator
    {
        private readonly IAmazonPrivate5G _client;
        private readonly ListNetworkResourcesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListNetworkResourcesResponse> Responses => new PaginatedResponse<ListNetworkResourcesResponse>(this);
...
#if BCL
        IEnumerable<ListNetworkResourcesResponse> IPaginator<ListNetworkResourcesResponse>.Paginate()
        {
            ...
            ListNetworkResourcesResponse response;
            do
            {
                _request.StartToken = startToken;
                response = _client.ListNetworkResources(_request);
        ...
        async IAsyncEnumerable<ListNetworkResourcesResponse> IPaginator<ListNetworkResourcesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.StartToken = startToken;
                response = await _client.ListNetworkResourcesAsync(_request, cancellationToken).ConfigureAwait(false);
                startToken = response.NextToken;
