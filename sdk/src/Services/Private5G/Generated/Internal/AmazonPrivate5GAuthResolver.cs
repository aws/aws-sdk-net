...
namespace Amazon.Private5G.Internal
{
    ...
    public class AmazonPrivate5GAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPrivate5GAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Private5G.
        /// </summary>
        public AmazonPrivate5GAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPrivate5GAuthSchemeParameters
            {
    ...
    public class AmazonPrivate5GAuthSchemeResolver : IAuthSchemeResolver<AmazonPrivate5GAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPrivate5GAuthSchemeParameters authParameters)
        {
