...
{
    /// <summary>
    /// Container for the parameters to the ListConnectorScanConfigurations operation.
    ...
    /// </summary>
    public partial class ListConnectorScanConfigurationsRequest : AmazonInspector2Request
    {
        private List<string> _awsConfigConnectorArns = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        public List<string> AwsConfigConnectorArns
        {
        ...
        /// <para>
        /// The maximum number of results to return in a single call. Valid range is 1 to 50.
