...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FailedMemberAccountEc2DeepInspectionStatusStateUnmarshaller : IJsonUnmarshaller<FailedMemberAccountEc2DeepInspectionStatusState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedMemberAccountEc2DeepInspectionStatusState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ec2ScanStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Ec2ScanStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
