...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkPathUnmarshaller : IUnmarshaller<NetworkPath, XmlUnmarshallerContext>, IUnmarshaller<NetworkPath, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NetworkPath IUnmarshaller<NetworkPath, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public NetworkPath Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
