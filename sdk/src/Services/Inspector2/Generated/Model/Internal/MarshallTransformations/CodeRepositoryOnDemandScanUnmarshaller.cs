...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodeRepositoryOnDemandScanUnmarshaller : IUnmarshaller<CodeRepositoryOnDemandScan, XmlUnmarshallerContext>, IUnmarshaller<CodeRepositoryOnDemandScan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CodeRepositoryOnDemandScan IUnmarshaller<CodeRepositoryOnDemandScan, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CodeRepositoryOnDemandScan Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("lastScanAt", targetDepth))
                {
                    ...
                    unmarshalledObject.LastScanAt = unmarshaller.Unmarshall(context);
                    continue;
                }
