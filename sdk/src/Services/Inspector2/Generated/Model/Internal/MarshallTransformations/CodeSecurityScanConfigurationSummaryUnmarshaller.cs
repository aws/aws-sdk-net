...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodeSecurityScanConfigurationSummaryUnmarshaller : IUnmarshaller<CodeSecurityScanConfigurationSummary, XmlUnmarshallerContext>, IUnmarshaller<CodeSecurityScanConfigurationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CodeSecurityScanConfigurationSummary IUnmarshaller<CodeSecurityScanConfigurationSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CodeSecurityScanConfigurationSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("continuousIntegrationScanSupportedEvents", targetDepth))
                {
                    ...
                    unmarshalledObject.ContinuousIntegrationScanSupportedEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("frequencyExpression", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FrequencyExpression = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PeriodicScanFrequency = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ruleSetCategories", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.RuleSetCategories = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("scopeSettings", targetDepth))
                {
                    ...
                    unmarshalledObject.ScopeSettings = unmarshaller.Unmarshall(context);
                    continue;
                }
