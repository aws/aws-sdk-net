...
{
    /// <summary>
    /// CreateFindingsReport Request Marshaller
    /// </summary>       
    public class CreateFindingsReportRequestMarshaller : IMarshaller<IRequest, CreateFindingsReportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateFindingsReportRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateFindingsReportRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetReportFormat())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ReportFormat);
            }
        ...
        private static CreateFindingsReportRequestMarshaller _instance = new CreateFindingsReportRequestMarshaller();        

        internal static CreateFindingsReportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFindingsReportRequestMarshaller Instance
        {
            get
            {
                return _instance;
