...
{
    /// <summary>
    /// Response Unmarshaller for VmInstanceAggregationResponse Object
    /// </summary>  
    public class VmInstanceAggregationResponseUnmarshaller : IJsonUnmarshaller<VmInstanceAggregationResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VmInstanceAggregationResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            VmInstanceAggregationResponse unmarshalledObject = new VmInstanceAggregationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("networkFindings", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.NetworkFindings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static VmInstanceAggregationResponseUnmarshaller _instance = new VmInstanceAggregationResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VmInstanceAggregationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
