...
{
    /// <summary>
    /// SendCisSessionTelemetry Request Marshaller
    /// </summary>       
    public class SendCisSessionTelemetryRequestMarshaller : IMarshaller<IRequest, SendCisSessionTelemetryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendCisSessionTelemetryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendCisSessionTelemetryRequest publicRequest)
        {
        ...
        private static SendCisSessionTelemetryRequestMarshaller _instance = new SendCisSessionTelemetryRequestMarshaller();        

        internal static SendCisSessionTelemetryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendCisSessionTelemetryRequestMarshaller Instance
        {
            get
            {
                return _instance;
