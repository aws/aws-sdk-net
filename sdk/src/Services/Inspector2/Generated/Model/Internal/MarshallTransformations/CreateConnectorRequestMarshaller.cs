...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    public class CreateConnectorRequestMarshaller : IMarshaller<IRequest, CreateConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateConnectorRequest publicRequest)
        {
            ...
            request.ResourcePath = "/connector/create";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetProviderDetail())
            {
                context.Writer.WritePropertyName("providerDetail");
                context.Writer.WriteStartObject();

                var marshaller = ProviderDetailCreateMarshaller.Instance;
                marshaller.Marshall(publicRequest.ProviderDetail, context);
