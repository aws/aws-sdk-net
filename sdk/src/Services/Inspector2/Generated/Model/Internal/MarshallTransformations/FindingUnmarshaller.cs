    ...
    public class FindingUnmarshaller : IJsonUnmarshaller<Finding, JsonUnmarshallerContext>
    {
        ...
        public Finding Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("codeVulnerabilityDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("epss", targetDepth, ref reader))
                {
                    var unmarshaller = EpssDetailsUnmarshaller.Instance;
                    unmarshalledObject.Epss = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("exploitabilityDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("inspectorScoreDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("networkReachabilityDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("packageVulnerabilityDetails", targetDepth, ref reader))
                {
