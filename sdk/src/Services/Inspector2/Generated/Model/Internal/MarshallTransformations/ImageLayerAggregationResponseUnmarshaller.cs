...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageLayerAggregationResponseUnmarshaller : IUnmarshaller<ImageLayerAggregationResponse, XmlUnmarshallerContext>, IUnmarshaller<ImageLayerAggregationResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ImageLayerAggregationResponse IUnmarshaller<ImageLayerAggregationResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ImageLayerAggregationResponse Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LayerHash = unmarshaller.Unmarshall(context);
                    continue;
                }
