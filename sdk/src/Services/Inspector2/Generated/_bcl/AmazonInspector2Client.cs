...
namespace Amazon.Inspector2
{
    ...
    public partial class AmazonInspector2Client : AmazonServiceClient, IAmazonInspector2
    {
        ...
        public virtual ListConnectorScanConfigurationsResponse ListConnectorScanConfigurations(ListConnectorScanConfigurationsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual UpdateConnectorScanConfigurationResponse UpdateConnectorScanConfiguration(UpdateConnectorScanConfigurationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
