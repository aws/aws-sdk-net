...
namespace Amazon.IoTTwinMaker
{
    ...
    public class ColumnType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ColumnType for a value not among the defined constants.
        /// </summary>
        public ColumnType(string value) : base(value) { }
    ...
    public class ComponentUpdateType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ComponentUpdateType for a value not among the defined constants.
        /// </summary>
        public ComponentUpdateType(string value) : base(value) { }
    ...
    {
        /// <summary>
        /// Constant Iotsitewise for DestinationType
        /// </summary>
        public static readonly DestinationType Iotsitewise = new DestinationType("iotsitewise");

        /// <summary>
        /// Constant Iottwinmaker for DestinationType
        /// </summary>
        public static readonly DestinationType Iottwinmaker = new DestinationType("iottwinmaker");
    ...
    {
        /// <summary>
        /// Constant COMPOSITE_COMPONENT_FAILURE for ErrorCode
        /// </summary>
        public static readonly ErrorCode COMPOSITE_COMPONENT_FAILURE = new ErrorCode("COMPOSITE_COMPONENT_FAILURE");
        ...
        /// <summary>
        /// Constant PROCESSING_ERROR for ErrorCode
        /// </summary>
        public static readonly ErrorCode PROCESSING_ERROR = new ErrorCode("PROCESSING_ERROR");
        ...
        /// <summary>
        /// Constant SYNC_DELETING_ERROR for ErrorCode
        /// </summary>
        public static readonly ErrorCode SYNC_DELETING_ERROR = new ErrorCode("SYNC_DELETING_ERROR");
    ...
    public class GroupType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom GroupType for a value not among the defined constants.
        /// </summary>
        public GroupType(string value) : base(value) { }
    ...
    public class InterpolationType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom InterpolationType for a value not among the defined constants.
        /// </summary>
        public InterpolationType(string value) : base(value) { }
    ...
    /// <summary>
    /// Constants used for properties of type MetadataTransferJobState.
    /// </summary>
    public class MetadataTransferJobState : ConstantClass
    {
        /// <summary>
        /// Constant CANCELLED for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState CANCELLED = new MetadataTransferJobState("CANCELLED");

        /// <summary>
        /// Constant CANCELLING for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState CANCELLING = new MetadataTransferJobState("CANCELLING");

        /// <summary>
        /// Constant COMPLETED for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState COMPLETED = new MetadataTransferJobState("COMPLETED");

        /// <summary>
        /// Constant ERROR for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState ERROR = new MetadataTransferJobState("ERROR");

        /// <summary>
        /// Constant PENDING for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState PENDING = new MetadataTransferJobState("PENDING");

        /// <summary>
        /// Constant RUNNING for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState RUNNING = new MetadataTransferJobState("RUNNING");

        /// <summary>
        /// Constant VALIDATING for MetadataTransferJobState
        /// </summary>
        public static readonly MetadataTransferJobState VALIDATING = new MetadataTransferJobState("VALIDATING");

        /// <summary>
        /// Constructs a custom MetadataTransferJobState for a value not among the defined constants.
        /// </summary>
        public MetadataTransferJobState(string value) : base(value) { }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static MetadataTransferJobState FindValue(string value)
        {
            return FindValue<MetadataTransferJobState>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator MetadataTransferJobState(string value)
        {
            return FindValue(value);
        }
    }
    ...
    public class Order : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom Order for a value not among the defined constants.
        /// </summary>
        public Order(string value) : base(value) { }
    ...
    public class OrderByTime : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom OrderByTime for a value not among the defined constants.
        /// </summary>
        public OrderByTime(string value) : base(value) { }
    ...
    public class ParentEntityUpdateType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ParentEntityUpdateType for a value not among the defined constants.
        /// </summary>
        public ParentEntityUpdateType(string value) : base(value) { }
    ...
    public class PricingMode : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom PricingMode for a value not among the defined constants.
        /// </summary>
        public PricingMode(string value) : base(value) { }
    ...
    public class PricingTier : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom PricingTier for a value not among the defined constants.
        /// </summary>
        public PricingTier(string value) : base(value) { }
    ...
    public class PropertyGroupUpdateType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom PropertyGroupUpdateType for a value not among the defined constants.
        /// </summary>
        public PropertyGroupUpdateType(string value) : base(value) { }
    ...
    public class PropertyUpdateType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom PropertyUpdateType for a value not among the defined constants.
        /// </summary>
        public PropertyUpdateType(string value) : base(value) { }
    ...
    public class SceneErrorCode : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom SceneErrorCode for a value not among the defined constants.
        /// </summary>
        public SceneErrorCode(string value) : base(value) { }
    ...
    public class Scope : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom Scope for a value not among the defined constants.
        /// </summary>
    ...
    {
        /// <summary>
        /// Constant Iotsitewise for SourceType
        /// </summary>
        public static readonly SourceType Iotsitewise = new SourceType("iotsitewise");

        /// <summary>
        /// Constant Iottwinmaker for SourceType
        /// </summary>
        public static readonly SourceType Iottwinmaker = new SourceType("iottwinmaker");
    ...
    public class State : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom State for a value not among the defined constants.
        /// </summary>
    ...
    public class SyncJobState : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom SyncJobState for a value not among the defined constants.
        /// </summary>
        public SyncJobState(string value) : base(value) { }
    ...
    public class SyncResourceState : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom SyncResourceState for a value not among the defined constants.
        /// </summary>
        public SyncResourceState(string value) : base(value) { }
    ...
    public class SyncResourceType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom SyncResourceType for a value not among the defined constants.
        /// </summary>
        public SyncResourceType(string value) : base(value) { }
    ...
    public class UpdateReason : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom UpdateReason for a value not among the defined constants.
        /// </summary>
        public UpdateReason(string value) : base(value) { }
