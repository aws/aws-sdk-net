...
namespace Amazon.IoTTwinMaker
{
    ...
    public partial class AmazonIoTTwinMakerClient : AmazonServiceClient, IAmazonIoTTwinMaker
    {
        ...
        /// 
        /// </summary>
        public AmazonIoTTwinMakerClient() : base(new AmazonIoTTwinMakerConfig()) { }
        ...
        public AmazonIoTTwinMakerClient(RegionEndpoint region) : base(new AmazonIoTTwinMakerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIoTTwinMakerClient(AmazonIoTTwinMakerConfig config) : base(config) { }
