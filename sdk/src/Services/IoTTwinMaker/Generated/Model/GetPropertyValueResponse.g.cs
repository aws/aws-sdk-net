...
namespace Amazon.IoTTwinMaker.Model
{
    ...
    public partial class GetPropertyValueResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public Dictionary<string, PropertyLatestValue> PropertyValues { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, PropertyLatestValue>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<List<Dictionary<string, DataValue>>> TabularPropertyValues { get; set; } = AWSConfigs.InitializeCollections ? new List<List<Dictionary<string, DataValue>>>() : null;

        /// <summary>
        /// Checks to see if the TabularPropertyValues property is set.
        /// </summary>
        internal bool IsSetTabularPropertyValues() => this.TabularPropertyValues != null && (this.TabularPropertyValues.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
