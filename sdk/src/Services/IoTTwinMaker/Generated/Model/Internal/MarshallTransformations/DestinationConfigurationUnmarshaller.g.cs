...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DestinationConfigurationUnmarshaller : IJsonUnmarshaller<DestinationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DestinationConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = IotTwinMakerDestinationConfigurationUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static DestinationConfigurationUnmarshaller Instance => _instance;
    }
}
