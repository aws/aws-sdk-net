...
{
    /// <summary>
    /// CreateComponentType Request Marshaller
    /// </summary>       
    public class CreateComponentTypeRequestMarshaller : IMarshaller<IRequest, CreateComponentTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateComponentTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateComponentTypeRequest publicRequest)
        {
        ...
        private static CreateComponentTypeRequestMarshaller _instance = new CreateComponentTypeRequestMarshaller();        

        internal static CreateComponentTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateComponentTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
