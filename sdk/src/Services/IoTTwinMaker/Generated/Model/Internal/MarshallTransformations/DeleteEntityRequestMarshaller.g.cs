...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteEntityRequestMarshaller : IMarshaller<IRequest, DeleteEntityRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteEntityRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("isRecursive", StringUtils.FromBool(publicRequest.IsRecursive.Value));
            }
        ...
        private static readonly DeleteEntityRequestMarshaller _instance = new();

        internal static DeleteEntityRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteEntityRequestMarshaller Instance => _instance;
    }
}
