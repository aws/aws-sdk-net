...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchPutPropertyErrorUnmarshaller : IJsonUnmarshaller<BatchPutPropertyError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchPutPropertyError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("entry", targetDepth, ref reader))
                {
