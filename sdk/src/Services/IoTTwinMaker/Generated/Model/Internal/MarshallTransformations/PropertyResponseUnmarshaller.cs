...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PropertyResponseUnmarshaller : IJsonUnmarshaller<PropertyResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PropertyResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("areAllPropertyValuesReturned", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.AreAllPropertyValuesReturned = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
