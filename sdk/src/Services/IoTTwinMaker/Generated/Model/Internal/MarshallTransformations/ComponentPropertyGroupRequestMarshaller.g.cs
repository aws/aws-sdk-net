...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ComponentPropertyGroupRequestMarshaller : IRequestMarshaller<ComponentPropertyGroupRequest, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ComponentPropertyGroupRequest requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetGroupType())
            {
                ...
                context.Writer.WriteStringValue(requestObject.GroupType);
            }
            ...
            if (requestObject.IsSetPropertyNames())
            {
                ...
                {
                    context.Writer.WriteStringValue(requestObjectPropertyNamesListValue);
                }
