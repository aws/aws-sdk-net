...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEntityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetEntityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("areAllComponentsReturned", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AreAllComponentsReturned = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetEntityResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEntityResponseUnmarshaller Instance => _instance;
    }
}
