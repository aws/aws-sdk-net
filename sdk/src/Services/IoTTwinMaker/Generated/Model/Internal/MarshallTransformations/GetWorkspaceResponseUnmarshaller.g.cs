...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkspace operation.
    /// </summary>
    public partial class GetWorkspaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetWorkspaceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("linkedServices", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.LinkedServices = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetWorkspaceResponseUnmarshaller _instance = new GetWorkspaceResponseUnmarshaller();

        internal static GetWorkspaceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetWorkspaceResponseUnmarshaller Instance => _instance;
    }
}
