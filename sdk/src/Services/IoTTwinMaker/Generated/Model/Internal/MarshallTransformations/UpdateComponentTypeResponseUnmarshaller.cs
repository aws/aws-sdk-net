...
{
    /// <summary>
    /// Response Unmarshaller for UpdateComponentType operation
    /// </summary>  
    public class UpdateComponentTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateComponentTypeResponse response = new UpdateComponentTypeResponse();
        ...
        private static UpdateComponentTypeResponseUnmarshaller _instance = new UpdateComponentTypeResponseUnmarshaller();        

        internal static UpdateComponentTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateComponentTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
