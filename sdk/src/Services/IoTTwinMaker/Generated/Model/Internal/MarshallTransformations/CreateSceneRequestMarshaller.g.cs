...
{
    /// <summary>
    /// CreateScene Request Marshaller
    /// </summary>
    public partial class CreateSceneRequestMarshaller : IMarshaller<IRequest, CreateSceneRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSceneRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateSceneRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetContentLocation())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ContentLocation);
            }
            ...
            if (publicRequest.IsSetSceneId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SceneId);
            }
            if (publicRequest.IsSetSceneMetadata())
            {
                ...
                foreach (var publicRequestSceneMetadataKvp in publicRequest.SceneMetadata)
                {
                    ...
                    context.Writer.WriteStringValue(publicRequestSceneMetadataValue);
                }
        ...
        private static readonly CreateSceneRequestMarshaller _instance = new();

        internal static CreateSceneRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSceneRequestMarshaller Instance => _instance;
    }
}
