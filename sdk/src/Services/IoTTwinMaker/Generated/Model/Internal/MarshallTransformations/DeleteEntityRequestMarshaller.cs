...
{
    /// <summary>
    /// DeleteEntity Request Marshaller
    /// </summary>       
    public class DeleteEntityRequestMarshaller : IMarshaller<IRequest, DeleteEntityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteEntityRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteEntityRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetIsRecursive())
                request.Parameters.Add("isRecursive", StringUtils.FromBool(publicRequest.IsRecursive));
        ...
        private static DeleteEntityRequestMarshaller _instance = new DeleteEntityRequestMarshaller();        

        internal static DeleteEntityRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEntityRequestMarshaller Instance
        {
            get
            {
                return _instance;
