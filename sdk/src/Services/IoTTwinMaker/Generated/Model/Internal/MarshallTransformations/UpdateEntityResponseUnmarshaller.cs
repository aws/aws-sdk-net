...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEntity operation
    /// </summary>  
    public class UpdateEntityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateEntityResponseUnmarshaller _instance = new UpdateEntityResponseUnmarshaller();        

        internal static UpdateEntityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEntityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
