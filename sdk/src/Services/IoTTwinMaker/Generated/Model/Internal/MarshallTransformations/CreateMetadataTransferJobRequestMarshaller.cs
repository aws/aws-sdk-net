...
{
    /// <summary>
    /// CreateMetadataTransferJob Request Marshaller
    /// </summary>       
    public class CreateMetadataTransferJobRequestMarshaller : IMarshaller<IRequest, CreateMetadataTransferJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMetadataTransferJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMetadataTransferJobRequest publicRequest)
        {
        ...
        private static CreateMetadataTransferJobRequestMarshaller _instance = new CreateMetadataTransferJobRequestMarshaller();        

        internal static CreateMetadataTransferJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMetadataTransferJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
