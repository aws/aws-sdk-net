    ...
    public class ExecuteQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ColumnDescription, ColumnDescriptionUnmarshaller>(ColumnDescriptionUnmarshaller.Instance);
                    response.ColumnDescriptions = unmarshaller.Unmarshall(context);
                    continue;
                }
