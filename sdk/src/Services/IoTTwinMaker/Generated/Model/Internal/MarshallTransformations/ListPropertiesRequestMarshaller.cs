...
{
    /// <summary>
    /// ListProperties Request Marshaller
    /// </summary>       
    public class ListPropertiesRequestMarshaller : IMarshaller<IRequest, ListPropertiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPropertiesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPropertiesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workspaces/{workspaceId}/properties-list";
#if !NETFRAMEWORK
        ...
        private static ListPropertiesRequestMarshaller _instance = new ListPropertiesRequestMarshaller();        

        internal static ListPropertiesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPropertiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
