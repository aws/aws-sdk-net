...
{
    /// <summary>
    /// DeleteScene Request Marshaller
    /// </summary>
    public partial class DeleteSceneRequestMarshaller : IMarshaller<IRequest, DeleteSceneRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSceneRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteSceneRequest publicRequest)
        {
        ...
        private static readonly DeleteSceneRequestMarshaller _instance = new();

        internal static DeleteSceneRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSceneRequestMarshaller Instance => _instance;
    }
}
