        ...
        public SourceConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("iotSiteWiseConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.IotSiteWiseConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("iotTwinMakerConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.IotTwinMakerConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
