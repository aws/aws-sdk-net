...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FunctionResponseUnmarshaller : IJsonUnmarshaller<FunctionResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FunctionResponse();
            ...
            {
                if (context.TestExpression("implementedBy", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("requiredProperties", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static FunctionResponseUnmarshaller Instance => _instance;
    }
}
