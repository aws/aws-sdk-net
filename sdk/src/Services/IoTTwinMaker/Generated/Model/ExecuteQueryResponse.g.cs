...
namespace Amazon.IoTTwinMaker.Model
{
    ...
    public partial class ExecuteQueryResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ColumnDescription> ColumnDescriptions { get; set; } = AWSConfigs.InitializeCollections ? new List<ColumnDescription>() : null;

        /// <summary>
        /// Checks to see if the ColumnDescriptions property is set.
        /// </summary>
        internal bool IsSetColumnDescriptions() => this.ColumnDescriptions != null && (this.ColumnDescriptions.Count > 0 || !AWSConfigs.InitializeCollections);
