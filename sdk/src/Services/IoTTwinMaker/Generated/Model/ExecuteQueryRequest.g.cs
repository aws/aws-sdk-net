...
{
    /// <summary>
    /// Container for the parameters to the ExecuteQuery operation. Run queries to access
    /// information from your knowledge graph of entities within individual workspaces. <note>
    /// <para> The ExecuteQuery action only works with <a href="https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/home.html">Amazon
    /// Web Services Java SDK2</a>. ExecuteQuery will not work with any Amazon Web Services
    /// Java SDK version &lt; 2.x. </para> </note>
    /// </summary>
