...
{
    /// <summary>
    /// Container for the parameters to the ListMetadataTransferJobs operation. Lists the
    ...
    public partial class ListMetadataTransferJobsRequest : AmazonIoTTwinMakerRequest
    {
        ...
        /// </summary>
        public List<ListMetadataTransferJobsFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<ListMetadataTransferJobsFilter>() : null;
