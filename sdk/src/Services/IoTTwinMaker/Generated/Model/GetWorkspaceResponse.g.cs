...
namespace Amazon.IoTTwinMaker.Model
{
    ...
    public partial class GetWorkspaceResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<string> LinkedServices { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the LinkedServices property is set.
        /// </summary>
        internal bool IsSetLinkedServices() => this.LinkedServices != null && (this.LinkedServices.Count > 0 || !AWSConfigs.InitializeCollections);
