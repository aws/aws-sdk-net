...
{
    /// <summary>
    /// Container for the parameters to the ListEntities operation. Lists all entities in
    /// a workspace.
    /// </summary>
    public partial class ListEntitiesRequest : AmazonIoTTwinMakerRequest
    {
        ...
        /// </summary>
        public List<ListEntitiesFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<ListEntitiesFilter>() : null;
