...
{
    /// <summary>
    /// Container for the parameters to the BatchPutPropertyValues operation. Sets values
    /// for multiple time series properties.
    /// </summary>
    public partial class BatchPutPropertyValuesRequest : AmazonIoTTwinMakerRequest
    {
        ...
        public List<PropertyValueEntry> Entries { get; set; } = AWSConfigs.InitializeCollections ? new List<PropertyValueEntry>() : null;
