...
namespace Amazon.IoTTwinMaker.Model
{
    ...
    public partial class GetSceneResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        [AWSProperty(Min = 0, Max = 50)]
        public Dictionary<string, string> GeneratedSceneMetadata { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the GeneratedSceneMetadata property is set.
        /// </summary>
        internal bool IsSetGeneratedSceneMetadata() => this.GeneratedSceneMetadata != null && (this.GeneratedSceneMetadata.Count > 0 || !AWSConfigs.InitializeCollections);
