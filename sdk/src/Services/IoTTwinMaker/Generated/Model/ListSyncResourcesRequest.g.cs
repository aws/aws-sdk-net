...
{
    /// <summary>
    /// Container for the parameters to the ListSyncResources operation. Lists the sync resources.
    /// </summary>
    public partial class ListSyncResourcesRequest : AmazonIoTTwinMakerRequest
    {
        ...
        /// </summary>
        public List<SyncResourceFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<SyncResourceFilter>() : null;
