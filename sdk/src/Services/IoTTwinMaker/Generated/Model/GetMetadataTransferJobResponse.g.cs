...
namespace Amazon.IoTTwinMaker.Model
{
    ...
    public partial class GetMetadataTransferJobResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        [AWSProperty(Required = true, Min = 20, Max = 2048)]
        public string MetadataTransferJobRole { get; set; }

        /// <summary>
        /// Checks to see if the MetadataTransferJobRole property is set.
        /// </summary>
        internal bool IsSetMetadataTransferJobRole() => this.MetadataTransferJobRole != null;
        ...
        /// <summary>
        /// Checks to see if the ReportUrl property is set.
        /// </summary>
        internal bool IsSetReportUrl() => this.ReportUrl != null;
