...
namespace Amazon.IoTTwinMaker
{
    ...
    public partial class AmazonIoTTwinMakerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("IoTTwinMaker", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "IoTTwinMaker";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "iottwinmaker";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-11-29";
