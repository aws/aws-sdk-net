...
{
    /// <summary>
    /// SaaSProductFilters Marshaller
    /// </summary>
    public class SaaSProductFiltersMarshaller : IRequestMarshaller<SaaSProductFilters, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SaaSProductFilters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEntityId())
            {
                ...
                var marshaller = SaaSProductEntityIdFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetLastModifiedDate())
            {
                ...
                var marshaller = SaaSProductLastModifiedDateFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetProductTitle())
            {
                ...
                var marshaller = SaaSProductTitleFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetVisibility())
            {
                ...
                var marshaller = SaaSProductVisibilityFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static SaaSProductFiltersMarshaller Instance = new SaaSProductFiltersMarshaller();
