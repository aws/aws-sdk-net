...
namespace Amazon.MarketplaceCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChangeSummaryUnmarshaller : IJsonUnmarshaller<ChangeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChangeSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
