    ...
    public class AssessmentSummaryUnmarshaller : IJsonUnmarshaller<AssessmentSummary, JsonUnmarshallerContext>
    {
        ...
        public AssessmentSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AssessmentResult = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AssessmentTargetSummary", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AssessmentTargetSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("FrameworkSummary", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.FrameworkSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
