...
{
    /// <summary>
    /// Allows filtering on <c>AvailabilityEndDate</c> of a ResaleAuthorization with date
    /// range as input.
    /// </summary>
    public partial class ResaleAuthorizationAvailabilityEndDateFilterDateRange
    {
        ...
        /// <para>
        /// Allows filtering on <c>AvailabilityEndDate</c> of a ResaleAuthorization after a date.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Allows filtering on <c>AvailabilityEndDate</c> of a ResaleAuthorization before a date.
        /// </para>
        /// </summary>
        [AWSProperty(Min=20, Max=20)]
