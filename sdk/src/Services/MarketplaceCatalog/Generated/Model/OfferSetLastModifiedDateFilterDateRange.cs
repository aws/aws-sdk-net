...
{
    /// <summary>
    /// Allows filtering on the <c>LastModifiedDate</c> of an offer set with date range as
    /// input.
    /// </summary>
    public partial class OfferSetLastModifiedDateFilterDateRange
    {
        ...
        /// <para>
        /// Allows filtering on the <c>LastModifiedDate</c> of an offer set after a date.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Allows filtering on the <c>LastModifiedDate</c> of an offer set before a date.
        /// </para>
        /// </summary>
        [AWSProperty(Min=20, Max=20)]
