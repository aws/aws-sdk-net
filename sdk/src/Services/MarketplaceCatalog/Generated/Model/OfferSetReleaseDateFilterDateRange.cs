...
{
    /// <summary>
    /// Allows filtering on the <c>ReleaseDate</c> of an offer set with date range as input.
    /// </summary>
    public partial class OfferSetReleaseDateFilterDateRange
    {
        ...
        /// <para>
        /// Allows filtering on the <c>ReleaseDate</c> of offer set after a date.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Allows filtering on the <c>ReleaseDate</c> of offer set before a date.
        /// </para>
        /// </summary>
        [AWSProperty(Min=20, Max=20)]
