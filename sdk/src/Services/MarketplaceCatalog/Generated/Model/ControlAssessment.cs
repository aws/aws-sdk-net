...
namespace Amazon.MarketplaceCatalog.Model
{
    ...
    {
        private ControlAssessmentResult _controlAssessmentResult;
        private string _controlId;
        private List<ControlError> _errors = AWSConfigs.InitializeCollections ? new List<ControlError>() : null;
        ...
        /// </para>
        /// </summary>
        public ControlAssessmentResult ControlAssessmentResult
        {
            get { return this._controlAssessmentResult; }
            set { this._controlAssessmentResult = value; }
        }

        // Check to see if ControlAssessmentResult property is set
        internal bool IsSetControlAssessmentResult()
        {
            return this._controlAssessmentResult != null;
        }
        ...
        /// </summary>
        public List<ControlError> Errors
        {
