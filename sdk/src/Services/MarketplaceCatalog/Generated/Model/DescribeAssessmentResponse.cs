...
namespace Amazon.MarketplaceCatalog.Model
{
    ...
    public partial class DescribeAssessmentResponse : AmazonWebServiceResponse
    {
        ...
        private List<ControlAssessment> _controlAssessments = AWSConfigs.InitializeCollections ? new List<ControlAssessment>() : null;
        ...
        /// </summary>
        public List<ControlAssessment> ControlAssessments
        {
            get { return this._controlAssessments; }
            set { this._controlAssessments = value; }
        }

        // Check to see if ControlAssessments property is set
        internal bool IsSetControlAssessments()
        {
            return this._controlAssessments != null && (this._controlAssessments.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
