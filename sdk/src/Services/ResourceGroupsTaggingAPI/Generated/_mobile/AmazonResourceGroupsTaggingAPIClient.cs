...
namespace Amazon.ResourceGroupsTaggingAPI
{
    ...
    public partial class AmazonResourceGroupsTaggingAPIClient : AmazonServiceClient, IAmazonResourceGroupsTaggingAPI
    {
        ...
        internal virtual DeleteTagPolicyResponse DeleteTagPolicy(DeleteTagPolicyRequest request)
        {
        ...
        internal virtual DisableTagPoliciesResponse DisableTagPolicies(DisableTagPoliciesRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual EnableTagPoliciesResponse EnableTagPolicies(EnableTagPoliciesRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual GetEffectiveTagPolicyResponse GetEffectiveTagPolicy(GetEffectiveTagPolicyRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual GetTagPolicyResponse GetTagPolicy(GetTagPolicyRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual PutTagPolicyResponse PutTagPolicy(PutTagPolicyRequest request)
        {
            var options = new InvokeOptions();
