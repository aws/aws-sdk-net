...
{
    /// <summary>
    /// Response Unmarshaller for PutTagPolicy operation
    /// </summary>  
    public class PutTagPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTagPolicyResponse response = new PutTagPolicyResponse();
        ...
        private static PutTagPolicyResponseUnmarshaller _instance = new PutTagPolicyResponseUnmarshaller();        

        internal static PutTagPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTagPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
