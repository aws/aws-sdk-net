...
{
    /// <summary>
    /// Response Unmarshaller for GetEffectiveTagPolicy operation
    /// </summary>  
    public class GetEffectiveTagPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEffectiveTagPolicyResponse response = new GetEffectiveTagPolicyResponse();
        ...
        private static GetEffectiveTagPolicyResponseUnmarshaller _instance = new GetEffectiveTagPolicyResponseUnmarshaller();        

        internal static GetEffectiveTagPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEffectiveTagPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
