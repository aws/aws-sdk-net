...
{
    /// <summary>
    /// Response Unmarshaller for GetTagPolicy operation
    /// </summary>  
    public class GetTagPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTagPolicyResponse response = new GetTagPolicyResponse();
        ...
        private static GetTagPolicyResponseUnmarshaller _instance = new GetTagPolicyResponseUnmarshaller();        

        internal static GetTagPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTagPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
