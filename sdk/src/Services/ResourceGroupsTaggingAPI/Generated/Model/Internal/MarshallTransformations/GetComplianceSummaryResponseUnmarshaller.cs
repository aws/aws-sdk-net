...
{
    /// <summary>
    /// Response Unmarshaller for GetComplianceSummary operation
    /// </summary>  
    public class GetComplianceSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetComplianceSummaryResponse response = new GetComplianceSummaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Summary, SummaryUnmarshaller>(SummaryUnmarshaller.Instance);
                    response.SummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetComplianceSummaryResponseUnmarshaller _instance = new GetComplianceSummaryResponseUnmarshaller();        

        internal static GetComplianceSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetComplianceSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
