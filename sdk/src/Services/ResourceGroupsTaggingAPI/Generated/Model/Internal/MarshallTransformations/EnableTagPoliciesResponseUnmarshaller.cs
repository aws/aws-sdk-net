...
{
    /// <summary>
    /// Response Unmarshaller for EnableTagPolicies operation
    /// </summary>  
    public class EnableTagPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableTagPoliciesResponse response = new EnableTagPoliciesResponse();
        ...
        private static EnableTagPoliciesResponseUnmarshaller _instance = new EnableTagPoliciesResponseUnmarshaller();        

        internal static EnableTagPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableTagPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
