...
{
    /// <summary>
    /// Response Unmarshaller for UntagResources operation
    /// </summary>  
    public class UntagResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagResourcesResponse response = new UntagResourcesResponse();
        ...
        private static UntagResourcesResponseUnmarshaller _instance = new UntagResourcesResponseUnmarshaller();        

        internal static UntagResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
