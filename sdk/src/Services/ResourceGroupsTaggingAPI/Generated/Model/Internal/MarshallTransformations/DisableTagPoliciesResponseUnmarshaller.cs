...
{
    /// <summary>
    /// Response Unmarshaller for DisableTagPolicies operation
    /// </summary>  
    public class DisableTagPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableTagPoliciesResponse response = new DisableTagPoliciesResponse();
        ...
        private static DisableTagPoliciesResponseUnmarshaller _instance = new DisableTagPoliciesResponseUnmarshaller();        

        internal static DisableTagPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableTagPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
