...
{
    /// <summary>
    /// Response Unmarshaller for GetResources operation
    /// </summary>  
    public class GetResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("PaginationTokenExpiredException"))
            {
                return new PaginationTokenExpiredException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            return new AmazonResourceGroupsTaggingAPIException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }

        private static GetResourcesResponseUnmarshaller _instance = new GetResourcesResponseUnmarshaller();        

        internal static GetResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
