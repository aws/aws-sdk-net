...
namespace Amazon.ResourceGroupsTaggingAPI.Model
{
    ...
    public partial class ThrottledException : AmazonResourceGroupsTaggingAPIException
    {
        ...
        public ThrottledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ThrottledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
