...
namespace Amazon.ResourceGroupsTaggingAPI
{
    ...
    public partial interface IAmazonResourceGroupsTaggingAPI : IAmazonService, IDisposable
    {
        ...
        Task<ListRequiredTagsResponse> ListRequiredTagsAsync(ListRequiredTagsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
