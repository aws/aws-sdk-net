...
namespace Amazon.Organizations.Model
{
    ...
    public partial class ListHandshakesForOrganizationRequest : AmazonOrganizationsRequest
    {
        ...
        /// all types. Use the <c>ActionType</c> element to limit the output to only a specified
        /// type, such as <c>INVITE</c>, <c>ENABLE-ALL-FEATURES</c>, or <c>APPROVE-ALL-FEATURES</c>.
        /// Alternatively, for the <c>ENABLE-ALL-FEATURES</c> handshake that generates a separate
        /// child handshake for each member account, you can specify the <c>ParentHandshakeId</c>
