...
namespace Amazon.Organizations.Model
{
    ...
    public partial class ListHandshakesForAccountRequest : AmazonOrganizationsRequest
    {
        ...
        /// types. Use the <c>ActionType</c> element to limit the output to only a specified type,
        /// such as <c>INVITE</c>, <c>ENABLE_ALL_FEATURES</c>, or <c>APPROVE_ALL_FEATURES</c>.
        /// Alternatively, for the <c>ENABLE_ALL_FEATURES</c> handshake that generates a separate
        /// child handshake for each member account, you can specify <c>ParentHandshakeId</c>
