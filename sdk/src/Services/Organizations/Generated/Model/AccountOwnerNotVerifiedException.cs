...
namespace Amazon.Organizations.Model
{
    ...
    public partial class AccountOwnerNotVerifiedException : AmazonOrganizationsException
    {
        ...
        public AccountOwnerNotVerifiedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccountOwnerNotVerifiedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
