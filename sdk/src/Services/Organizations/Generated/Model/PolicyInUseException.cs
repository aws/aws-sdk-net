...
namespace Amazon.Organizations.Model
{
    ...
    public partial class PolicyInUseException : AmazonOrganizationsException
    {
        ...
        /// <summary>
        /// Construct instance of PolicyInUseException
        /// </summary>
        ...
        public PolicyInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PolicyInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected PolicyInUseException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
