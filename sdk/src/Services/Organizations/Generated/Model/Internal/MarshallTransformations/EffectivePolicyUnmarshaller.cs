...
namespace Amazon.Organizations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EffectivePolicyUnmarshaller : IJsonUnmarshaller<EffectivePolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EffectivePolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PolicyContent", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PolicyContent = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
