...
{
    /// <summary>
    /// Response Unmarshaller for DescribeHandshake operation
    /// </summary>  
    public class DescribeHandshakeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeHandshakeResponse response = new DescribeHandshakeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Handshake", targetDepth))
                {
                    ...
                    response.Handshake = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new HandshakeNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DescribeHandshakeResponseUnmarshaller _instance = new DescribeHandshakeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeHandshakeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
