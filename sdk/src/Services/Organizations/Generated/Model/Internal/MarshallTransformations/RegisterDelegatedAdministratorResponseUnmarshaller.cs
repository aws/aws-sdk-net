...
{
    /// <summary>
    /// Response Unmarshaller for RegisterDelegatedAdministrator operation
    /// </summary>  
    public class RegisterDelegatedAdministratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterDelegatedAdministratorResponse response = new RegisterDelegatedAdministratorResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("AccountAlreadyRegisteredException"))
            {
                return new AccountAlreadyRegisteredException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static RegisterDelegatedAdministratorResponseUnmarshaller _instance = new RegisterDelegatedAdministratorResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterDelegatedAdministratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
