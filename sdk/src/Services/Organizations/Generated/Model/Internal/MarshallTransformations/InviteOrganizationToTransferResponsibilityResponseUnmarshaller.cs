...
{
    /// <summary>
    /// Response Unmarshaller for InviteOrganizationToTransferResponsibility operation
    /// </summary>  
    public class InviteOrganizationToTransferResponsibilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InviteOrganizationToTransferResponsibilityResponse response = new InviteOrganizationToTransferResponsibilityResponse();
        ...
        private static InviteOrganizationToTransferResponsibilityResponseUnmarshaller _instance = new InviteOrganizationToTransferResponsibilityResponseUnmarshaller();        

        internal static InviteOrganizationToTransferResponsibilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InviteOrganizationToTransferResponsibilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
