...
{
    /// <summary>
    /// Response Unmarshaller for DescribeOrganizationalUnit operation
    /// </summary>  
    public class DescribeOrganizationalUnitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeOrganizationalUnitResponse response = new DescribeOrganizationalUnitResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = OrganizationalUnitUnmarshaller.Instance;
                    response.OrganizationalUnit = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new OrganizationalUnitNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DescribeOrganizationalUnitResponseUnmarshaller _instance = new DescribeOrganizationalUnitResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeOrganizationalUnitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
