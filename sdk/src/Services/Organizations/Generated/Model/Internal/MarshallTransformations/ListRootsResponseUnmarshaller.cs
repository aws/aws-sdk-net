...
{
    /// <summary>
    /// Response Unmarshaller for ListRoots operation
    /// </summary>  
    public class ListRootsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRootsResponse response = new ListRootsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Roots", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Root, RootUnmarshaller>(RootUnmarshaller.Instance);
                    response.Roots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRootsResponseUnmarshaller _instance = new ListRootsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRootsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
