...
namespace Amazon.Organizations.Model.Internal.MarshallTransformations
{
    ...
    public class CreateOrganizationalUnitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DuplicateOrganizationalUnitException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
