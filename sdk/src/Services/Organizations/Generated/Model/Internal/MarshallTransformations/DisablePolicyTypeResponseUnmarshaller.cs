...
{
    /// <summary>
    /// Response Unmarshaller for DisablePolicyType operation
    /// </summary>  
    public class DisablePolicyTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisablePolicyTypeResponse response = new DisablePolicyTypeResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return PolicyChangesInProgressExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("PolicyTypeNotEnabledException"))
                {
                    return PolicyTypeNotEnabledExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("RootNotFoundException"))
                {
                    return RootNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DisablePolicyTypeResponseUnmarshaller _instance = new DisablePolicyTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisablePolicyTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
