...
{
    /// <summary>
    /// Response Unmarshaller for EnablePolicyType operation
    /// </summary>  
    public class EnablePolicyTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnablePolicyTypeResponse response = new EnablePolicyTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Root", targetDepth))
                {
                    ...
                    response.Root = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new PolicyTypeAlreadyEnabledException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            {
                return new RootNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static EnablePolicyTypeResponseUnmarshaller _instance = new EnablePolicyTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnablePolicyTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
