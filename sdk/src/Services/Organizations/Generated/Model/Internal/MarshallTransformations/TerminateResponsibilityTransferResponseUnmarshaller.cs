...
{
    /// <summary>
    /// Response Unmarshaller for TerminateResponsibilityTransfer operation
    /// </summary>  
    public class TerminateResponsibilityTransferResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TerminateResponsibilityTransferResponse response = new TerminateResponsibilityTransferResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ResponsibilityTransfer", targetDepth))
                {
                    ...
                    response.ResponsibilityTransfer = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidResponsibilityTransferTransitionException"))
                {
                    return InvalidResponsibilityTransferTransitionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResponsibilityTransferAlreadyInStatusException"))
                {
                    return ResponsibilityTransferAlreadyInStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResponsibilityTransferNotFoundException"))
                {
                    return ResponsibilityTransferNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static TerminateResponsibilityTransferResponseUnmarshaller _instance = new TerminateResponsibilityTransferResponseUnmarshaller();        

        internal static TerminateResponsibilityTransferResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateResponsibilityTransferResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
