    ...
    public class ListOutboundResponsibilityTransfersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResponsibilityTransfer, ResponsibilityTransferUnmarshaller>(ResponsibilityTransferUnmarshaller.Instance);
                    response.ResponsibilityTransfers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
