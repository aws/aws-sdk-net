...
{
    /// <summary>
    /// Response Unmarshaller for ListOutboundResponsibilityTransfers operation
    /// </summary>  
    public class ListOutboundResponsibilityTransfersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOutboundResponsibilityTransfersResponse response = new ListOutboundResponsibilityTransfersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ResponsibilityTransfers", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ResponsibilityTransfer, ResponsibilityTransferUnmarshaller>(ResponsibilityTransferUnmarshaller.Instance);
                    response.ResponsibilityTransfers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListOutboundResponsibilityTransfersResponseUnmarshaller _instance = new ListOutboundResponsibilityTransfersResponseUnmarshaller();        

        internal static ListOutboundResponsibilityTransfersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOutboundResponsibilityTransfersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
