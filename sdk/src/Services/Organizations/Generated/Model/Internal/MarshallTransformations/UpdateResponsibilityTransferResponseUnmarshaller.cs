...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResponsibilityTransfer operation
    /// </summary>  
    public class UpdateResponsibilityTransferResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResponsibilityTransferResponse response = new UpdateResponsibilityTransferResponse();
        ...
        private static UpdateResponsibilityTransferResponseUnmarshaller _instance = new UpdateResponsibilityTransferResponseUnmarshaller();        

        internal static UpdateResponsibilityTransferResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResponsibilityTransferResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
