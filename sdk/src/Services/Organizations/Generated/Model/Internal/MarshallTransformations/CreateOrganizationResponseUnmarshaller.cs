    ...
    public class CreateOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return AccessDeniedForDependencyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("AlreadyInOrganizationException"))
                {
                    return AlreadyInOrganizationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
