...
{
    /// <summary>
    /// Response Unmarshaller for CreateOrganization operation
    /// </summary>  
    public class CreateOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("PaymentInstrumentRequiredException"))
            {
                return new PaymentInstrumentRequiredException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static CreateOrganizationResponseUnmarshaller _instance = new CreateOrganizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
