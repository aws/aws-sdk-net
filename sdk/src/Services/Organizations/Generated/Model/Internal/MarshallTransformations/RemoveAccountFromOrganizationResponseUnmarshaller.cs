...
{
    /// <summary>
    /// Response Unmarshaller for RemoveAccountFromOrganization operation
    /// </summary>  
    public class RemoveAccountFromOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveAccountFromOrganizationResponse response = new RemoveAccountFromOrganizationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("AccountCannotLeaveOrganizationException"))
            {
                return new AccountCannotLeaveOrganizationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("AccountNotFoundException"))
            {
                return new AccountNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            {
                return new MasterCannotLeaveOrganizationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static RemoveAccountFromOrganizationResponseUnmarshaller _instance = new RemoveAccountFromOrganizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveAccountFromOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
