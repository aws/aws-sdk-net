...
namespace Amazon.Organizations.Model
{
    ...
    public partial class HandshakeAlreadyInStateException : AmazonOrganizationsException
    {
        ...
        public HandshakeAlreadyInStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HandshakeAlreadyInStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
