...
namespace Amazon.Organizations
{
    ...
    ///  
    /// <para>
    /// For the current release of Organizations, specify the <c>us-east-1</c> region for
    ...
    /// China, then specify <c>cn-northwest-1</c>. You can do this in the CLI by using these
    ...
    ///  
    /// <para>
    ///  <c>--endpoint-url https://organizations.us-east-1.amazonaws.com</c> <i>(from commercial
    ...
    ///  
    /// <para>
    ///  <c>--endpoint-url https://organizations.cn-northwest-1.amazonaws.com.cn</c> <i>(from
    /// Amazon Web Services Regions in China)</i> 
    /// </para>
    ///  </li> <li> 
    /// <para>
    ...
    ///  
    /// <para>
    ///  <c>aws configure set default.region us-east-1</c> <i>(from commercial Amazon Web
    /// Services Regions outside of China)</i> 
    /// </para>
    ///  
    /// <para>
    /// or
    ...
    ///  
    /// <para>
    ///  <c>aws configure set default.region cn-northwest-1</c> <i>(from Amazon Web Services
    /// Regions in China)</i> 
    /// </para>
    ///  </li> <li> 
    /// <para>
    ...
    ///  
    /// <para>
    ///  <c>--region us-east-1</c> <i>(from commercial Amazon Web Services Regions outside
    /// of China)</i> 
    /// </para>
    ///  
    /// <para>
    ...
    ///  
    /// <para>
    ///  <c>--region cn-northwest-1</c> <i>(from Amazon Web Services Regions in China)</i>
    /// 
    /// </para>
    ///  </li> </ul> 
    /// <para>
    ...
    public partial interface IAmazonOrganizations : IAmazonService, IDisposable
    {
        ...
        Task<CloseAccountResponse> CloseAccountAsync(CloseAccountRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// We can't find a root with the <c>RootId</c> that you specified.
        /// </exception>
        /// <exception cref="Amazon.Organizations.Model.ServiceException">
        /// Organizations can't complete your request because of an internal service error. Try
        /// again later.
        ...
        #region  ListAccountsWithInvalidEffectivePolicy
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListAccountsWithInvalidEffectivePolicy service method, as returned by Organizations.</returns>
        /// <exception cref="Amazon.Organizations.Model.AccessDeniedException">
        /// You don't have permissions to perform the requested operation. The user or role that
        /// is making the request must have at least one IAM permissions policy attached that
        /// grants the required permissions. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access.html">Access
        ...
        /// This action isn't available in the current Amazon Web Services Region.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/organizations-2016-11-28/ListAccountsWithInvalidEffectivePolicy">REST API Reference for ListAccountsWithInvalidEffectivePolicy Operation</seealso>
        Task<ListAccountsWithInvalidEffectivePolicyResponse> ListAccountsWithInvalidEffectivePolicyAsync(ListAccountsWithInvalidEffectivePolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        #region  ListEffectivePolicyValidationErrors
        ...
        /// </param>
        /// 
        /// <returns>The response from the ListEffectivePolicyValidationErrors service method, as returned by Organizations.</returns>
        /// <exception cref="Amazon.Organizations.Model.AccessDeniedException">
        /// You don't have permissions to perform the requested operation. The user or role that
        /// is making the request must have at least one IAM permissions policy attached that
        /// grants the required permissions. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access.html">Access
        ...
        /// This action isn't available in the current Amazon Web Services Region.
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/organizations-2016-11-28/ListEffectivePolicyValidationErrors">REST API Reference for ListEffectivePolicyValidationErrors Operation</seealso>
        Task<ListEffectivePolicyValidationErrorsResponse> ListEffectivePolicyValidationErrorsAsync(ListEffectivePolicyValidationErrorsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonOrganizationsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonOrganizationsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonOrganizationsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonOrganizationsConfig to create AmazonOrganizationsClient");
            }

            return awsCredentials == null ? 
                    new AmazonOrganizationsClient(serviceClientConfig) :
                    new AmazonOrganizationsClient(awsCredentials, serviceClientConfig);
        }
