...
namespace Amazon.AlexaForBusiness.Model
{
    ...
    public partial class InvalidServiceLinkedRoleStateException : AmazonAlexaForBusinessException
    {
        ...
        public InvalidServiceLinkedRoleStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidServiceLinkedRoleStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
