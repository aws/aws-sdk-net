...
namespace Amazon.AlexaForBusiness.Model
{
    ...
    public partial class InvalidUserStatusException : AmazonAlexaForBusinessException
    {
        ...
        public InvalidUserStatusException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidUserStatusException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
