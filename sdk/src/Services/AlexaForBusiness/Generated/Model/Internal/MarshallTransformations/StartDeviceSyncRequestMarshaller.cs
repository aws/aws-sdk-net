...
{
    /// <summary>
    /// StartDeviceSync Request Marshaller
    /// </summary>       
    public class StartDeviceSyncRequestMarshaller : IMarshaller<IRequest, StartDeviceSyncRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDeviceSyncRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDeviceSyncRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AlexaForBusiness");
            string target = "AlexaForBusiness.StartDeviceSync";
