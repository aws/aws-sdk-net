...
{
    /// <summary>
    /// Response Unmarshaller for CreateContact operation
    /// </summary>  
    public class CreateContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateContactResponseUnmarshaller _instance = new CreateContactResponseUnmarshaller();        

        internal static CreateContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
