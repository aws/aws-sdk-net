...
{
    /// <summary>
    /// Response Unmarshaller for CreateAddressBook operation
    /// </summary>  
    public class CreateAddressBookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAddressBookResponse response = new CreateAddressBookResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AddressBookArn", targetDepth))
                {
                    ...
                    response.AddressBookArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateAddressBookResponseUnmarshaller _instance = new CreateAddressBookResponseUnmarshaller();        

        internal static CreateAddressBookResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAddressBookResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
