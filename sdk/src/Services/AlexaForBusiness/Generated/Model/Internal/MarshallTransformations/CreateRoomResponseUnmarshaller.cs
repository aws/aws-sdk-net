...
namespace Amazon.AlexaForBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateRoomResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateRoomResponseUnmarshaller _instance = new CreateRoomResponseUnmarshaller();        

        internal static CreateRoomResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRoomResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
