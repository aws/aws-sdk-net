...
namespace Amazon.AlexaForBusiness.Model
{
    ...
    public partial class InvalidCertificateAuthorityException : AmazonAlexaForBusinessException
    {
        ...
        public InvalidCertificateAuthorityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCertificateAuthorityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
