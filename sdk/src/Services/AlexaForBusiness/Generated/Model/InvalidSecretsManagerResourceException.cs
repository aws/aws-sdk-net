...
namespace Amazon.AlexaForBusiness.Model
{
    ...
    public partial class InvalidSecretsManagerResourceException : AmazonAlexaForBusinessException
    {
        ...
        public InvalidSecretsManagerResourceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSecretsManagerResourceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
