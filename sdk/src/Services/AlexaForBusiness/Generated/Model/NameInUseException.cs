...
namespace Amazon.AlexaForBusiness.Model
{
    ...
    public partial class NameInUseException : AmazonAlexaForBusinessException
    {
        ...
        public NameInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NameInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
