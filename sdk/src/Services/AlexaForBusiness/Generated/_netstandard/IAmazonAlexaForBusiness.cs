...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAlexaForBusinessConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAlexaForBusinessConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAlexaForBusinessConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAlexaForBusinessConfig to create AmazonAlexaForBusinessClient");
            }

            return awsCredentials == null ? 
                    new AmazonAlexaForBusinessClient(serviceClientConfig) :
                    new AmazonAlexaForBusinessClient(awsCredentials, serviceClientConfig);
        }
