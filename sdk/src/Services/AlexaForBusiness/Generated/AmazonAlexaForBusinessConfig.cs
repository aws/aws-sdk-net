...
namespace Amazon.AlexaForBusiness
{
    ...
    public partial class AmazonAlexaForBusinessConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Alexa For Business", "4.0.0.0");

        private static readonly AmazonAlexaForBusinessEndpointResolver EndpointResolver =
            new AmazonAlexaForBusinessEndpointResolver();
