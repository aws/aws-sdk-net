...
{
    /// <summary>
    /// Base class for ListOrganizationRecommendationAccounts paginators.
    /// </summary>
    internal sealed partial class ListOrganizationRecommendationAccountsPaginator : IPaginator<ListOrganizationRecommendationAccountsResponse>, IListOrganizationRecommendationAccountsPaginator
    {
        private readonly IAmazonTrustedAdvisor _client;
        private readonly ListOrganizationRecommendationAccountsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListOrganizationRecommendationAccountsResponse> Responses => new PaginatedResponse<ListOrganizationRecommendationAccountsResponse>(this);
...
#if BCL
        IEnumerable<ListOrganizationRecommendationAccountsResponse> IPaginator<ListOrganizationRecommendationAccountsResponse>.Paginate()
        {
            ...
            ListOrganizationRecommendationAccountsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListOrganizationRecommendationAccounts(_request);
        ...
        async IAsyncEnumerable<ListOrganizationRecommendationAccountsResponse> IPaginator<ListOrganizationRecommendationAccountsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListOrganizationRecommendationAccountsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
