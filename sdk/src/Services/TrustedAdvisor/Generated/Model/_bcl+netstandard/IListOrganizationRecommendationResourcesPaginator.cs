...
namespace Amazon.TrustedAdvisor.Model
{
    ...
    public interface IListOrganizationRecommendationResourcesPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListOrganizationRecommendationResourcesResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the OrganizationRecommendationResourceSummaries
        /// </summary>
        IPaginatedEnumerable<OrganizationRecommendationResourceSummary> OrganizationRecommendationResourceSummaries { get; }
    }
}