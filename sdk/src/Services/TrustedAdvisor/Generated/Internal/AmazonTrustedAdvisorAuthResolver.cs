...
namespace Amazon.TrustedAdvisor.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonTrustedAdvisorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonTrustedAdvisorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for TrustedAdvisor.
        /// </summary>
        public AmazonTrustedAdvisorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonTrustedAdvisorAuthSchemeParameters
            {
    ...
    public class AmazonTrustedAdvisorAuthSchemeResolver : IAuthSchemeResolver<AmazonTrustedAdvisorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonTrustedAdvisorAuthSchemeParameters authParameters)
        {
