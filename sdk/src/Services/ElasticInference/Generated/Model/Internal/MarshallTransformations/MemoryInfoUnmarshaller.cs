...
namespace Amazon.ElasticInference.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MemoryInfoUnmarshaller : IJsonUnmarshaller<MemoryInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MemoryInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("sizeInMiB", targetDepth))
                {
                    ...
                    unmarshalledObject.SizeInMiB = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
