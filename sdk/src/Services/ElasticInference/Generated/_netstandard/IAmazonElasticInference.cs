...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElasticInferenceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElasticInferenceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElasticInferenceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElasticInferenceConfig to create AmazonElasticInferenceClient");
            }

            return awsCredentials == null ? 
                    new AmazonElasticInferenceClient(serviceClientConfig) :
                    new AmazonElasticInferenceClient(awsCredentials, serviceClientConfig);
        }
