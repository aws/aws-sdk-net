...
namespace Amazon.ElasticInference.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonElasticInferenceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonElasticInferenceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ElasticInference.
        /// </summary>
        public AmazonElasticInferenceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonElasticInferenceAuthSchemeParameters
            {
    ...
    public class AmazonElasticInferenceAuthSchemeResolver : IAuthSchemeResolver<AmazonElasticInferenceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonElasticInferenceAuthSchemeParameters authParameters)
        {
