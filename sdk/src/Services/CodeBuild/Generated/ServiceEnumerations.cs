...
namespace Amazon.CodeBuild
{
    ...
    /// <summary>
    /// Constants used for properties of type HostKernel.
    /// </summary>
    public class HostKernel : ConstantClass
    {

        /// <summary>
        /// Constant LINUX_KERNEL_4 for HostKernel
        /// </summary>
        public static readonly HostKernel LINUX_KERNEL_4 = new HostKernel("LINUX_KERNEL_4");
        /// <summary>
        /// Constant LINUX_KERNEL_6 for HostKernel
        /// </summary>
        public static readonly HostKernel LINUX_KERNEL_6 = new HostKernel("LINUX_KERNEL_6");
        /// <summary>
        /// Constant LINUX_KERNEL_LATEST for HostKernel
        /// </summary>
        public static readonly HostKernel LINUX_KERNEL_LATEST = new HostKernel("LINUX_KERNEL_LATEST");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public HostKernel(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static HostKernel FindValue(string value)
        {
            return FindValue<HostKernel>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator HostKernel(string value)
        {
            return FindValue(value);
        }
    }
