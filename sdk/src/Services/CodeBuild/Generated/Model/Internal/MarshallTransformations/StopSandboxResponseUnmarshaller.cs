...
{
    /// <summary>
    /// Response Unmarshaller for StopSandbox operation
    /// </summary>  
    public class StopSandboxResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopSandboxResponse response = new StopSandboxResponse();
            ...
            {
                if (context.TestExpression("sandbox", targetDepth, ref reader))
                {
                    var unmarshaller = SandboxUnmarshaller.Instance;
                    response.Sandbox = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StopSandboxResponseUnmarshaller _instance = new StopSandboxResponseUnmarshaller();        

        internal static StopSandboxResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopSandboxResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
