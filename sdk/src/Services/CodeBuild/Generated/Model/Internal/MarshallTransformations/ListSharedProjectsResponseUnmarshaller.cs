...
{
    /// <summary>
    /// Response Unmarshaller for ListSharedProjects operation
    /// </summary>  
    public class ListSharedProjectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSharedProjectsResponse response = new ListSharedProjectsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("projects", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.Projects = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSharedProjectsResponseUnmarshaller _instance = new ListSharedProjectsResponseUnmarshaller();        

        internal static ListSharedProjectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSharedProjectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
