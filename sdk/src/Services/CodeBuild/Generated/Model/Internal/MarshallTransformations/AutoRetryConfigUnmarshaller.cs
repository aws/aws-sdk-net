...
namespace Amazon.CodeBuild.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoRetryConfigUnmarshaller : IUnmarshaller<AutoRetryConfig, XmlUnmarshallerContext>, IUnmarshaller<AutoRetryConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutoRetryConfig IUnmarshaller<AutoRetryConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutoRetryConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("nextAutoRetry", targetDepth))
                {
                    ...
                    unmarshalledObject.NextAutoRetry = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("previousAutoRetry", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PreviousAutoRetry = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
