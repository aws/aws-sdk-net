...
{
    /// <summary>
    /// BatchDeleteBuilds Request Marshaller
    /// </summary>       
    public class BatchDeleteBuildsRequestMarshaller : IMarshaller<IRequest, BatchDeleteBuildsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchDeleteBuildsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchDeleteBuildsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeBuild");
            string target = "CodeBuild_20161006.BatchDeleteBuilds";
