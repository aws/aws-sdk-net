...
namespace Amazon.MediaTailor
{
    ...
    public partial class AmazonMediaTailorClient : AmazonServiceClient, IAmazonMediaTailor
    {
        ...
        /// 
        /// </summary>
        public AmazonMediaTailorClient() : base(new AmazonMediaTailorConfig()) { }
        ...
        public AmazonMediaTailorClient(RegionEndpoint region) : base(new AmazonMediaTailorConfig { RegionEndpoint = region }) { }
        ...
        public AmazonMediaTailorClient(AmazonMediaTailorConfig config) : base(config) { }
