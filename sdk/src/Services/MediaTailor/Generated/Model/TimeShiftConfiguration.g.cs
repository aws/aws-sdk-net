...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class TimeShiftConfiguration
    {
        ...
        public int? MaxTimeDelaySeconds { get; set; }

        /// <summary>
        /// Checks to see if the MaxTimeDelaySeconds property is set.
        /// </summary>
        internal bool IsSetMaxTimeDelaySeconds() => this.MaxTimeDelaySeconds.HasValue;
    }
}
