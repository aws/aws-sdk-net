...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class HlsPlaylistSettings
    {
        ...
        /// </summary>
        public List<string> AdMarkupType { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AdMarkupType property is set.
        /// </summary>
        internal bool IsSetAdMarkupType() => this.AdMarkupType != null && (this.AdMarkupType.Count > 0 || !AWSConfigs.InitializeCollections);
