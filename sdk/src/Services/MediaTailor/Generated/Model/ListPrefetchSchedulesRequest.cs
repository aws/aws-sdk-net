...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class ListPrefetchSchedulesRequest : AmazonMediaTailorRequest
    {
        ...
        /// <para>
        /// (Optional) If the playback configuration has more than <c>MaxResults</c> prefetch
        /// schedules, use <c>NextToken</c> to get the second and subsequent pages of results.
        /// </para>
        ///  
        /// <para>
        ///  For the first <c>ListPrefetchSchedulesRequest</c> request, omit this value.
        /// </para>
        ///  
        /// <para>
        ...
        ///  
        /// <para>
        ///  If the previous response didn't include a <c>NextToken</c> element, there are no
