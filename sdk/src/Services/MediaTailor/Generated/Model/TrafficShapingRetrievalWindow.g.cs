...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class TrafficShapingRetrievalWindow
    {
        ...
        /// </para>
        /// </summary>
        public int? RetrievalWindowDurationSeconds { get; set; }

        /// <summary>
        /// Checks to see if the RetrievalWindowDurationSeconds property is set.
        /// </summary>
        internal bool IsSetRetrievalWindowDurationSeconds() => this.RetrievalWindowDurationSeconds.HasValue;
    }
}
