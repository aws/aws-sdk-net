...
{
    /// <summary>
    /// Container for the parameters to the ListChannels operation. Retrieves information
    /// about the channels that are associated with the current AWS account.
    /// </summary>
    public partial class ListChannelsRequest : AmazonMediaTailorRequest
    {
        /// <summary>
        ...
        ///  
        /// <para>
        /// For the first <c>ListChannels</c> request, omit this value. For subsequent requests,
