...
{
    /// <summary>
    /// This is the response object from the ListPrefetchSchedules operation.
    /// </summary>
    public partial class ListPrefetchSchedulesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PrefetchSchedule> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<PrefetchSchedule>() : null;
