...
{
    /// <summary>
    /// Container for the parameters to the DeletePrefetchSchedule operation. Deletes a prefetch
    /// schedule for a specific playback configuration. If you call <c>DeletePrefetchSchedule</c>
