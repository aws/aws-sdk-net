    ...
    public class LivePreRollConfigurationMarshaller : IRequestMarshaller<LivePreRollConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(LivePreRollConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAdDecisionServerConfiguration())
            {
                context.Writer.WritePropertyName("AdDecisionServerConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = PreRollAdDecisionServerConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.AdDecisionServerConfiguration, context);
            ...
            if(requestObject.IsSetAdDecisionServerUrl())
            {
                ...
                context.Writer.WriteStringValue(requestObject.AdDecisionServerUrl);
            }

            if(requestObject.IsSetMaxDurationSeconds())
            {
                context.Writer.WritePropertyName("MaxDurationSeconds");
                context.Writer.WriteNumberValue(requestObject.MaxDurationSeconds.Value);
            }
