...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeSourceLocationRequestMarshaller : IMarshaller<IRequest, DescribeSourceLocationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeSourceLocationRequestMarshaller _instance = new DescribeSourceLocationRequestMarshaller();        

        internal static DescribeSourceLocationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSourceLocationRequestMarshaller Instance
        {
            get
            {
                return _instance;
