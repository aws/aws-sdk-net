...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PrefetchRetrievalUnmarshaller : IJsonUnmarshaller<PrefetchRetrieval, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PrefetchRetrieval Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PrefetchRetrieval();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PrefetchRetrievalUnmarshaller Instance => _instance;
    }
}
