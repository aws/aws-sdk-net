...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutChannelPolicyRequestMarshaller : IMarshaller<IRequest, PutChannelPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutChannelPolicyRequestMarshaller _instance = new();

        internal static PutChannelPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutChannelPolicyRequestMarshaller Instance => _instance;
    }
}
