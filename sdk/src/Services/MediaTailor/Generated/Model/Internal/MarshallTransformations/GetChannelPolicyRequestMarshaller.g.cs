...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetChannelPolicyRequestMarshaller : IMarshaller<IRequest, GetChannelPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetChannelPolicyRequestMarshaller _instance = new();

        internal static GetChannelPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetChannelPolicyRequestMarshaller Instance => _instance;
    }
}
