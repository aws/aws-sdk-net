...
{
    /// <summary>
    /// DeletePrefetchSchedule Request Marshaller
    /// </summary>
    public partial class DeletePrefetchScheduleRequestMarshaller : IMarshaller<IRequest, DeletePrefetchScheduleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePrefetchScheduleRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeletePrefetchScheduleRequest publicRequest)
        {
        ...
        private static readonly DeletePrefetchScheduleRequestMarshaller _instance = new();

        internal static DeletePrefetchScheduleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeletePrefetchScheduleRequestMarshaller Instance => _instance;
    }
}
