...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListFunctionsRequestMarshaller : IMarshaller<IRequest, ListFunctionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListFunctionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/functions";
        ...
        private static readonly ListFunctionsRequestMarshaller _instance = new();

        internal static ListFunctionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListFunctionsRequestMarshaller Instance => _instance;
    }
}
