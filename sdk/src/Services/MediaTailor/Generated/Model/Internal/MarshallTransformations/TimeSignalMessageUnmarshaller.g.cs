...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TimeSignalMessageUnmarshaller : IJsonUnmarshaller<TimeSignalMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TimeSignalMessage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TimeSignalMessage();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TimeSignalMessageUnmarshaller Instance => _instance;
    }
}
