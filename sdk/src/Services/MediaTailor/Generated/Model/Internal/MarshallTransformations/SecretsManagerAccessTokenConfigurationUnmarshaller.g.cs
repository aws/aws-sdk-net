...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SecretsManagerAccessTokenConfigurationUnmarshaller : IJsonUnmarshaller<SecretsManagerAccessTokenConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SecretsManagerAccessTokenConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SecretStringKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static SecretsManagerAccessTokenConfigurationUnmarshaller Instance => _instance;
    }
}
