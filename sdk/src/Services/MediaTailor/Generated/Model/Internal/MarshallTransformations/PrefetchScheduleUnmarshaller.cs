...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PrefetchScheduleUnmarshaller : IUnmarshaller<PrefetchSchedule, XmlUnmarshallerContext>, IUnmarshaller<PrefetchSchedule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PrefetchSchedule IUnmarshaller<PrefetchSchedule, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PrefetchSchedule Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Consumption", targetDepth))
                {
                    ...
                    unmarshalledObject.Consumption = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PlaybackConfigurationName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RecurringPrefetchConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.RecurringPrefetchConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
