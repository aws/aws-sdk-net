...
{
    /// <summary>
    /// Response Unmarshaller for CreateLiveSource operation
    /// </summary>  
    public class CreateLiveSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLiveSourceResponse response = new CreateLiveSourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HttpPackageConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<HttpPackageConfiguration, HttpPackageConfigurationUnmarshaller>(HttpPackageConfigurationUnmarshaller.Instance);
                    response.HttpPackageConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LiveSourceName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateLiveSourceResponseUnmarshaller _instance = new CreateLiveSourceResponseUnmarshaller();        

        internal static CreateLiveSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLiveSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
