...
{
    /// <summary>
    /// CreateLiveSource Request Marshaller
    /// </summary>
    public partial class CreateLiveSourceRequestMarshaller : IMarshaller<IRequest, CreateLiveSourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLiveSourceRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateLiveSourceRequest publicRequest)
        {
        ...
        private static readonly CreateLiveSourceRequestMarshaller _instance = new();

        internal static CreateLiveSourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateLiveSourceRequestMarshaller Instance => _instance;
    }
}
