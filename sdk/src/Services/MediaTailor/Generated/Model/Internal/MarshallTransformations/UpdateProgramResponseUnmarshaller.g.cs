...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateProgramResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateProgramResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AudienceMedia", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AudienceMedia, AudienceMediaUnmarshaller>(AudienceMediaUnmarshaller.Instance);
                    unmarshalledObject.AudienceMedia = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static UpdateProgramResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateProgramResponseUnmarshaller Instance => _instance;
    }
}
