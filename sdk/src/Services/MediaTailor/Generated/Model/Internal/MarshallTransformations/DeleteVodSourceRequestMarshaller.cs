...
{
    /// <summary>
    /// DeleteVodSource Request Marshaller
    /// </summary>       
    public class DeleteVodSourceRequestMarshaller : IMarshaller<IRequest, DeleteVodSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVodSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVodSourceRequest publicRequest)
        {
        ...
        private static DeleteVodSourceRequestMarshaller _instance = new DeleteVodSourceRequestMarshaller();        

        internal static DeleteVodSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVodSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
