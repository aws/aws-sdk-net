...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HlsPlaylistSettingsUnmarshaller : IJsonUnmarshaller<HlsPlaylistSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new HlsPlaylistSettings();
            ...
            {
                if (context.TestExpression("AdMarkupType", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static HlsPlaylistSettingsUnmarshaller Instance => _instance;
    }
}
