...
{
    /// <summary>
    /// Response Unmarshaller for Program Object
    /// </summary>  
    public class ProgramUnmarshaller : IUnmarshaller<Program, XmlUnmarshallerContext>, IUnmarshaller<Program, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Program IUnmarshaller<Program, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Program Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            Program unmarshalledObject = new Program();
        ...
        private static ProgramUnmarshaller _instance = new ProgramUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProgramUnmarshaller Instance
        {
            get
            {
                return _instance;
