...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutFunctionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutFunctionResponse response = new PutFunctionResponse();
        ...
        internal static PutFunctionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
