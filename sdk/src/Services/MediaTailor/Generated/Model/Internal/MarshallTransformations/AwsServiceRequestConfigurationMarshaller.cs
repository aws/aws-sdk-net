...
{
    /// <summary>
    /// AwsServiceRequestConfiguration Marshaller
    /// </summary>
    public class AwsServiceRequestConfigurationMarshaller : IRequestMarshaller<AwsServiceRequestConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AwsServiceRequestConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTargetService())
            {
                context.Writer.WritePropertyName("TargetService");
                context.Writer.WriteStringValue(requestObject.TargetService);
            }
        ...
        /// </summary>
        public readonly static AwsServiceRequestConfigurationMarshaller Instance = new AwsServiceRequestConfigurationMarshaller();
