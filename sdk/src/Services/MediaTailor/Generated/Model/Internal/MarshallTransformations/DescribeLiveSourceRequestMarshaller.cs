...
{
    /// <summary>
    /// DescribeLiveSource Request Marshaller
    /// </summary>       
    public class DescribeLiveSourceRequestMarshaller : IMarshaller<IRequest, DescribeLiveSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeLiveSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeLiveSourceRequest publicRequest)
        {
        ...
        private static DescribeLiveSourceRequestMarshaller _instance = new DescribeLiveSourceRequestMarshaller();        

        internal static DescribeLiveSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLiveSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
