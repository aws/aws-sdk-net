...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeProgramRequestMarshaller : IMarshaller<IRequest, DescribeProgramRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeProgramRequestMarshaller _instance = new();

        internal static DescribeProgramRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeProgramRequestMarshaller Instance => _instance;
    }
}
