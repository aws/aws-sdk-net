...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VodSourceUnmarshaller : IUnmarshaller<VodSource, XmlUnmarshallerContext>, IUnmarshaller<VodSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VodSource IUnmarshaller<VodSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public VodSource Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
