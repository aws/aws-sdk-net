...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class AdsInteractionLog
    {
        ...
        /// </summary>
        public List<string> ExcludeEventTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ExcludeEventTypes property is set.
        /// </summary>
        internal bool IsSetExcludeEventTypes() => this.ExcludeEventTypes != null && (this.ExcludeEventTypes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> PublishOptInEventTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the PublishOptInEventTypes property is set.
        /// </summary>
        internal bool IsSetPublishOptInEventTypes() => this.PublishOptInEventTypes != null && (this.PublishOptInEventTypes.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
