...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class TrafficShapingTpsConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the PeakConcurrentUsers property is set.
        /// </summary>
        internal bool IsSetPeakConcurrentUsers() => this.PeakConcurrentUsers.HasValue;
        ...
        /// </para>
        /// </summary>
        public int? PeakTps { get; set; }

        /// <summary>
        /// Checks to see if the PeakTps property is set.
        /// </summary>
        internal bool IsSetPeakTps() => this.PeakTps.HasValue;
    }
}
