...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class SequentialExecutorConfiguration
    {
        ...
        public List<FunctionRef> FunctionList { get; set; } = AWSConfigs.InitializeCollections ? new List<FunctionRef>() : null;

        /// <summary>
        /// Checks to see if the FunctionList property is set.
        /// </summary>
        internal bool IsSetFunctionList() => this.FunctionList != null && (this.FunctionList.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the TimeoutMilliseconds property is set.
        /// </summary>
        internal bool IsSetTimeoutMilliseconds() => this.TimeoutMilliseconds.HasValue;
    }
}
