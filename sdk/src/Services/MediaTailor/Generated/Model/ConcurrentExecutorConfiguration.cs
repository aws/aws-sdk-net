...
{
    /// <summary>
    /// The configuration for a <c>CONCURRENT_EXECUTOR</c> function. A <c>CONCURRENT_EXECUTOR</c>
    /// runs a set of child functions in parallel, up to a maximum concurrency, and combines
    /// their output when all functions complete. For more information about functions, see
    /// <a href="https://docs.aws.amazon.com/mediatailor/latest/ug/monetization-functions.html">Working
    /// with functions</a> in the <i>MediaTailor User Guide</i>.
    /// </summary>
    public partial class ConcurrentExecutorConfiguration
    {
        ...
        /// <para>
        /// The list of child functions that MediaTailor runs in parallel. Each entry specifies
        ...
        /// <para>
        /// The maximum number of child functions that MediaTailor runs simultaneously. When the
        ...
        /// <para>
        /// A map of output bindings that controls which bindings the executor commits to the
        ...
        /// results of the child functions.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        ...
        /// <para>
        /// The maximum time, in milliseconds, for all child functions to complete. This timeout
        ...
        /// and proceeds with default behavior.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
