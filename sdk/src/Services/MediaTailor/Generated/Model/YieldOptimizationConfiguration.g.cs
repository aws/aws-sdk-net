...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class YieldOptimizationConfiguration
    {
        ...
        public int? MinimumUnfilledDuration { get; set; }

        /// <summary>
        /// Checks to see if the MinimumUnfilledDuration property is set.
        /// </summary>
        internal bool IsSetMinimumUnfilledDuration() => this.MinimumUnfilledDuration.HasValue;
        ...
        public string OpenRtbTemplate { get; set; }

        /// <summary>
        /// Checks to see if the OpenRtbTemplate property is set.
        /// </summary>
        internal bool IsSetOpenRtbTemplate() => this.OpenRtbTemplate != null;
        ...
        /// <summary>
        /// Checks to see if the PublisherId property is set.
        /// </summary>
        internal bool IsSetPublisherId() => this.PublisherId != null;
        ...
        public ApsRegion Region { get; set; }
