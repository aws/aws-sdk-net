...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class TimeSignalMessage
    {
        ...
        /// </summary>
        public List<SegmentationDescriptor> SegmentationDescriptors { get; set; } = AWSConfigs.InitializeCollections ? new List<SegmentationDescriptor>() : null;

        /// <summary>
        /// Checks to see if the SegmentationDescriptors property is set.
        /// </summary>
        internal bool IsSetSegmentationDescriptors() => this.SegmentationDescriptors != null && (this.SegmentationDescriptors.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
