...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class AdConditioningConfiguration
    {
        ...
        public StreamingMediaFileConditioning StreamingMediaFileConditioning { get; set; }

        /// <summary>
        /// Checks to see if the StreamingMediaFileConditioning property is set.
        /// </summary>
        internal bool IsSetStreamingMediaFileConditioning() => this.StreamingMediaFileConditioning != null;
    }
}
