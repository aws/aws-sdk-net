...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class RecurringRetrieval
    {
        ...
        /// </para>
        /// </summary>
        public int? DelayAfterAvailEndSeconds { get; set; }

        /// <summary>
        /// Checks to see if the DelayAfterAvailEndSeconds property is set.
        /// </summary>
        internal bool IsSetDelayAfterAvailEndSeconds() => this.DelayAfterAvailEndSeconds.HasValue;
