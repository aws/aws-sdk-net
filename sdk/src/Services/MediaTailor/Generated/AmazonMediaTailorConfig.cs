...
namespace Amazon.MediaTailor
{
    ...
    public partial class AmazonMediaTailorConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("MediaTailor", "4.0.106.1");
        ...
        /// </summary>
        public static new string ServiceId => "MediaTailor";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "api.mediatailor";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2018-04-23";
