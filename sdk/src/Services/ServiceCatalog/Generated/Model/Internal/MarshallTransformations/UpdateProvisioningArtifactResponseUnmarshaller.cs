...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProvisioningArtifact operation
    /// </summary>  
    public class UpdateProvisioningArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProvisioningArtifactResponse response = new UpdateProvisioningArtifactResponse();
        ...
        private static UpdateProvisioningArtifactResponseUnmarshaller _instance = new UpdateProvisioningArtifactResponseUnmarshaller();        

        internal static UpdateProvisioningArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProvisioningArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
