...
{
    /// <summary>
    /// Response Unmarshaller for CreateProvisioningArtifact operation
    /// </summary>  
    public class CreateProvisioningArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Info", targetDepth))
                {
                    ...
                    response.Info = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateProvisioningArtifactResponseUnmarshaller _instance = new CreateProvisioningArtifactResponseUnmarshaller();        

        internal static CreateProvisioningArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProvisioningArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
