...
namespace Amazon.ServiceCatalog.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateProvisioningPreferencesMarshaller : IRequestMarshaller<UpdateProvisioningPreferences, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(UpdateProvisioningPreferences requestObject, JsonMarshallerContext context)
        {
            ...
            {
                context.Writer.WritePropertyName("StackSetOperationType");
                context.Writer.WriteStringValue(requestObject.StackSetOperationType);
            }
