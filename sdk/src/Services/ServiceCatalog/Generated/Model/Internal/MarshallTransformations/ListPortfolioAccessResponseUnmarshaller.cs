...
{
    /// <summary>
    /// Response Unmarshaller for ListPortfolioAccess operation
    /// </summary>  
    public class ListPortfolioAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AccountIds", targetDepth))
                {
                    ...
                    response.AccountIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListPortfolioAccessResponseUnmarshaller _instance = new ListPortfolioAccessResponseUnmarshaller();        

        internal static ListPortfolioAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPortfolioAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
