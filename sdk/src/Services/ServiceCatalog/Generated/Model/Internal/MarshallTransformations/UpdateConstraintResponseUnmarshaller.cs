...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConstraint operation
    /// </summary>  
    public class UpdateConstraintResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConstraintResponse response = new UpdateConstraintResponse();
            ...
            {
                if (context.TestExpression("ConstraintDetail", targetDepth, ref reader))
                {
                    var unmarshaller = ConstraintDetailUnmarshaller.Instance;
                    response.ConstraintDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ConstraintParameters", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConstraintParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateConstraintResponseUnmarshaller _instance = new UpdateConstraintResponseUnmarshaller();        

        internal static UpdateConstraintResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConstraintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
