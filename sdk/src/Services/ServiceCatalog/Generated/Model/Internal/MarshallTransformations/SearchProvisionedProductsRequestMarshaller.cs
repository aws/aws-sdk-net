...
{
    /// <summary>
    /// SearchProvisionedProducts Request Marshaller
    /// </summary>       
    public class SearchProvisionedProductsRequestMarshaller : IMarshaller<IRequest, SearchProvisionedProductsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchProvisionedProductsRequest)input);
        }
        ...
        private static SearchProvisionedProductsRequestMarshaller _instance = new SearchProvisionedProductsRequestMarshaller();        

        internal static SearchProvisionedProductsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchProvisionedProductsRequestMarshaller Instance
        {
            get
            {
                return _instance;
