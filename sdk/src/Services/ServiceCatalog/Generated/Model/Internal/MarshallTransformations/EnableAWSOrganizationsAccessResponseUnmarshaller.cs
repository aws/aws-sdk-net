...
{
    /// <summary>
    /// Response Unmarshaller for EnableAWSOrganizationsAccess operation
    /// </summary>  
    public class EnableAWSOrganizationsAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableAWSOrganizationsAccessResponse response = new EnableAWSOrganizationsAccessResponse();
        ...
        private static EnableAWSOrganizationsAccessResponseUnmarshaller _instance = new EnableAWSOrganizationsAccessResponseUnmarshaller();        

        internal static EnableAWSOrganizationsAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableAWSOrganizationsAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
