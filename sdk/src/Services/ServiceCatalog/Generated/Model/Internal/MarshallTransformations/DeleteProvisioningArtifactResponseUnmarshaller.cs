...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProvisioningArtifact operation
    /// </summary>  
    public class DeleteProvisioningArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProvisioningArtifactResponse response = new DeleteProvisioningArtifactResponse();
        ...
        private static DeleteProvisioningArtifactResponseUnmarshaller _instance = new DeleteProvisioningArtifactResponseUnmarshaller();        

        internal static DeleteProvisioningArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProvisioningArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
