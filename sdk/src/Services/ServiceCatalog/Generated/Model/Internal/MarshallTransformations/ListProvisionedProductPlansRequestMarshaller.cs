    ...
    public class ListProvisionedProductPlansRequestMarshaller : IMarshaller<IRequest, ListProvisionedProductPlansRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListProvisionedProductPlansRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetProvisionProductId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ProvisionProductId);
            }
        ...
        private static ListProvisionedProductPlansRequestMarshaller _instance = new ListProvisionedProductPlansRequestMarshaller();        

        internal static ListProvisionedProductPlansRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProvisionedProductPlansRequestMarshaller Instance
        {
            get
            {
                return _instance;
