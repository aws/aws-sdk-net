...
{
    /// <summary>
    /// Response Unmarshaller for ImportAsProvisionedProduct operation
    /// </summary>  
    public class ImportAsProvisionedProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportAsProvisionedProductResponse response = new ImportAsProvisionedProductResponse();
            ...
            {
                if (context.TestExpression("RecordDetail", targetDepth, ref reader))
                {
                    var unmarshaller = RecordDetailUnmarshaller.Instance;
                    response.RecordDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ImportAsProvisionedProductResponseUnmarshaller _instance = new ImportAsProvisionedProductResponseUnmarshaller();        

        internal static ImportAsProvisionedProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportAsProvisionedProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
