...
namespace Amazon.ServiceCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceTargetDefinitionUnmarshaller : IJsonUnmarshaller<ResourceTargetDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceTargetDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RequiresRecreation", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RequiresRecreation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
