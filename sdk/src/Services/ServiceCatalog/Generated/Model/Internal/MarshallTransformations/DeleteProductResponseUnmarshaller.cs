...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProduct operation
    /// </summary>  
    public class DeleteProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteProductResponseUnmarshaller _instance = new DeleteProductResponseUnmarshaller();        

        internal static DeleteProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
