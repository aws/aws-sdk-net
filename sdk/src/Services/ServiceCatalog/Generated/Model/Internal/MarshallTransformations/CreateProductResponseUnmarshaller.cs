...
{
    /// <summary>
    /// Response Unmarshaller for CreateProduct operation
    /// </summary>  
    public class CreateProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateProductResponseUnmarshaller _instance = new CreateProductResponseUnmarshaller();        

        internal static CreateProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
