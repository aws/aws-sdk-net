    ...
    public class DescribeProvisioningArtifactRequestMarshaller : IMarshaller<IRequest, DescribeProvisioningArtifactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeProvisioningArtifactRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetIncludeProvisioningArtifactParameters())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.IncludeProvisioningArtifactParameters.Value);
            }
            ...
            if(publicRequest.IsSetVerbose())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.Verbose.Value);
            }
        ...
        private static DescribeProvisioningArtifactRequestMarshaller _instance = new DescribeProvisioningArtifactRequestMarshaller();        

        internal static DescribeProvisioningArtifactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProvisioningArtifactRequestMarshaller Instance
        {
            get
            {
                return _instance;
