...
{
    /// <summary>
    /// ListRecordHistory Request Marshaller
    /// </summary>       
    public class ListRecordHistoryRequestMarshaller : IMarshaller<IRequest, ListRecordHistoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListRecordHistoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListRecordHistoryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.ListRecordHistory";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetSearchFilter())
                {
                    ...
                    var marshaller = ListRecordHistorySearchFilterMarshaller.Instance;
        ...
        private static ListRecordHistoryRequestMarshaller _instance = new ListRecordHistoryRequestMarshaller();        

        internal static ListRecordHistoryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRecordHistoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
