...
namespace Amazon.ServiceCatalog.Model
{
    ...
    internal sealed partial class ListOrganizationPortfolioAccessPaginator : IPaginator<ListOrganizationPortfolioAccessResponse>, IListOrganizationPortfolioAccessPaginator
    {
        ...
        async IAsyncEnumerable<ListOrganizationPortfolioAccessResponse> IPaginator<ListOrganizationPortfolioAccessResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
