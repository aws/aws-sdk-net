...
namespace Amazon.ServiceCatalog.Model
{
    ...
    internal sealed partial class ListResourcesForTagOptionPaginator : IPaginator<ListResourcesForTagOptionResponse>, IListResourcesForTagOptionPaginator
    {
        ...
        async IAsyncEnumerable<ListResourcesForTagOptionResponse> IPaginator<ListResourcesForTagOptionResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
