...
namespace Amazon.ServiceCatalog.Internal
{
    ...
    public class AmazonServiceCatalogAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonServiceCatalogAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ServiceCatalog.
        /// </summary>
        public AmazonServiceCatalogAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonServiceCatalogAuthSchemeParameters
            {
    ...
    public class AmazonServiceCatalogAuthSchemeResolver : IAuthSchemeResolver<AmazonServiceCatalogAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonServiceCatalogAuthSchemeParameters authParameters)
        {
