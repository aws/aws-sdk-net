...
namespace Amazon.WorkLink.Model
{
    ...
    internal sealed partial class ListFleetsPaginator : IPaginator<ListFleetsResponse>, IListFleetsPaginator
    {
        ...
        internal ListFleetsPaginator(IAmazonWorkLink client, ListFleetsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListFleetsResponse> IPaginator<ListFleetsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
