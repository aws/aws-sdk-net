...
{
    /// <summary>
    /// Response Unmarshaller for AssociateDomain operation
    /// </summary>  
    public class AssociateDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateDomainResponse response = new AssociateDomainResponse();
        ...
        private static AssociateDomainResponseUnmarshaller _instance = new AssociateDomainResponseUnmarshaller();        

        internal static AssociateDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
