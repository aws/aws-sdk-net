...
{
    /// <summary>
    /// UpdateFleetMetadata Request Marshaller
    /// </summary>       
    public class UpdateFleetMetadataRequestMarshaller : IMarshaller<IRequest, UpdateFleetMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFleetMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFleetMetadataRequest publicRequest)
        {
            ...
            string uriResourcePath = "/UpdateFleetMetadata";
        ...
        private static UpdateFleetMetadataRequestMarshaller _instance = new UpdateFleetMetadataRequestMarshaller();        

        internal static UpdateFleetMetadataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFleetMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
