...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateDomain operation
    /// </summary>  
    public class DisassociateDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateDomainResponse response = new DisassociateDomainResponse();
        ...
        private static DisassociateDomainResponseUnmarshaller _instance = new DisassociateDomainResponseUnmarshaller();        

        internal static DisassociateDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
