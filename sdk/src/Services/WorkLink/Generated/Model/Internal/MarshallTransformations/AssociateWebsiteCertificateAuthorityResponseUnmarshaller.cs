...
{
    /// <summary>
    /// Response Unmarshaller for AssociateWebsiteCertificateAuthority operation
    /// </summary>  
    public class AssociateWebsiteCertificateAuthorityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateWebsiteCertificateAuthorityResponse response = new AssociateWebsiteCertificateAuthorityResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("WebsiteCaId", targetDepth))
                {
                    ...
                    response.WebsiteCaId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static AssociateWebsiteCertificateAuthorityResponseUnmarshaller _instance = new AssociateWebsiteCertificateAuthorityResponseUnmarshaller();        

        internal static AssociateWebsiteCertificateAuthorityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateWebsiteCertificateAuthorityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
