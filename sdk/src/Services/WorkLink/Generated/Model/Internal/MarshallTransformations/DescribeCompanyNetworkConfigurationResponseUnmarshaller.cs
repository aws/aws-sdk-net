...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCompanyNetworkConfiguration operation
    /// </summary>  
    public class DescribeCompanyNetworkConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCompanyNetworkConfigurationResponse response = new DescribeCompanyNetworkConfigurationResponse();
        ...
        private static DescribeCompanyNetworkConfigurationResponseUnmarshaller _instance = new DescribeCompanyNetworkConfigurationResponseUnmarshaller();        

        internal static DescribeCompanyNetworkConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCompanyNetworkConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
