...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFleet operation
    /// </summary>  
    public class DeleteFleetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFleetResponse response = new DeleteFleetResponse();
        ...
        private static DeleteFleetResponseUnmarshaller _instance = new DeleteFleetResponseUnmarshaller();        

        internal static DeleteFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
