...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonWorkLinkConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonWorkLinkConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonWorkLinkConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonWorkLinkConfig to create AmazonWorkLinkClient");
            }

            return awsCredentials == null ? 
                    new AmazonWorkLinkClient(serviceClientConfig) :
                    new AmazonWorkLinkClient(awsCredentials, serviceClientConfig);
        }
