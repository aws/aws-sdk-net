...
namespace Amazon.Inspector.Model
{
    ...
    public partial class InvalidCrossAccountRoleException : AmazonInspectorException
    {
        ...
        public InvalidCrossAccountRoleException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCrossAccountRoleException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
