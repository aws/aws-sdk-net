...
{
    /// <summary>
    /// Container for the parameters to the ListAssessmentAgents operation.
    /// Lists the agents of the assessment specified by the assessment ARN.
    /// </summary>
    public partial class ListAssessmentAgentsRequest : AmazonInspectorRequest
    {
        private string _assessmentArn;
        private AgentsFilter _filter;
