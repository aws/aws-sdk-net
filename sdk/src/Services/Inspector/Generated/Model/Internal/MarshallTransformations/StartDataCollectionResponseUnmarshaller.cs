...
{
    /// <summary>
    /// Response Unmarshaller for StartDataCollection operation
    /// </summary>  
    public class StartDataCollectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDataCollectionResponse response = new StartDataCollectionResponse();
        ...
        private static StartDataCollectionResponseUnmarshaller _instance = new StartDataCollectionResponseUnmarshaller();        

        internal static StartDataCollectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDataCollectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
