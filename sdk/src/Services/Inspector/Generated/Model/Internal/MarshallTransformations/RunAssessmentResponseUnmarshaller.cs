...
{
    /// <summary>
    /// Response Unmarshaller for RunAssessment operation
    /// </summary>  
    public class RunAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RunAssessmentResponse response = new RunAssessmentResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("runArn", targetDepth))
                {
                    ...
                    response.RunArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static RunAssessmentResponseUnmarshaller _instance = new RunAssessmentResponseUnmarshaller();        

        internal static RunAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RunAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
