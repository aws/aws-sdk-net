...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRulesPackage operation
    /// </summary>  
    public class DescribeRulesPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRulesPackageResponse response = new DescribeRulesPackageResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = RulesPackageUnmarshaller.Instance;
                    response.RulesPackage = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeRulesPackageResponseUnmarshaller _instance = new DescribeRulesPackageResponseUnmarshaller();        

        internal static DescribeRulesPackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRulesPackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
