...
{
    /// <summary>
    /// Response Unmarshaller for StopDataCollection operation
    /// </summary>  
    public class StopDataCollectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopDataCollectionResponse response = new StopDataCollectionResponse();
        ...
        private static StopDataCollectionResponseUnmarshaller _instance = new StopDataCollectionResponseUnmarshaller();        

        internal static StopDataCollectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDataCollectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
