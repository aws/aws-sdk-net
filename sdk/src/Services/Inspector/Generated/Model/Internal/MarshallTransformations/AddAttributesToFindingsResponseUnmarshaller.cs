...
{
    /// <summary>
    /// Response Unmarshaller for AddAttributesToFindings operation
    /// </summary>  
    public class AddAttributesToFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddAttributesToFindingsResponse response = new AddAttributesToFindingsResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return NoSuchEntityExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServiceTemporarilyUnavailableException"))
                {
                    return ServiceTemporarilyUnavailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static AddAttributesToFindingsResponseUnmarshaller _instance = new AddAttributesToFindingsResponseUnmarshaller();        

        internal static AddAttributesToFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddAttributesToFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
