...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFinding operation
    /// </summary>  
    public class DescribeFindingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFindingResponse response = new DescribeFindingResponse();
        ...
        private static DescribeFindingResponseUnmarshaller _instance = new DescribeFindingResponseUnmarshaller();        

        internal static DescribeFindingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFindingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
