...
{
    /// <summary>
    /// Response Unmarshaller for DescribeResourceGroup operation
    /// </summary>  
    public class DescribeResourceGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeResourceGroupResponse response = new DescribeResourceGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("resourceGroup", targetDepth))
                {
                    ...
                    response.ResourceGroup = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeResourceGroupResponseUnmarshaller _instance = new DescribeResourceGroupResponseUnmarshaller();        

        internal static DescribeResourceGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeResourceGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
