...
namespace Amazon.Inspector.Model.Internal.MarshallTransformations
{
    ...
    public class CreateAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateAssessmentResponseUnmarshaller _instance = new CreateAssessmentResponseUnmarshaller();        

        internal static CreateAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
