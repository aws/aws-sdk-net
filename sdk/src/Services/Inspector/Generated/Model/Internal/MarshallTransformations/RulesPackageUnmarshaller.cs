...
{
    /// <summary>
    /// Response Unmarshaller for RulesPackage Object
    /// </summary>  
    public class RulesPackageUnmarshaller : IUnmarshaller<RulesPackage, XmlUnmarshallerContext>, IUnmarshaller<RulesPackage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RulesPackage IUnmarshaller<RulesPackage, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RulesPackage Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RulesPackageName = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static RulesPackageUnmarshaller _instance = new RulesPackageUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RulesPackageUnmarshaller Instance
        {
            get
            {
                return _instance;
