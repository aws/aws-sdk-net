...
{
    /// <summary>
    /// Response Unmarshaller for ListAttachedAssessments operation
    /// </summary>  
    public class ListAttachedAssessmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttachedAssessmentsResponse response = new ListAttachedAssessmentsResponse();
        ...
        private static ListAttachedAssessmentsResponseUnmarshaller _instance = new ListAttachedAssessmentsResponseUnmarshaller();        

        internal static ListAttachedAssessmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedAssessmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
