...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRun operation
    /// </summary>  
    public class DescribeRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRunResponse response = new DescribeRunResponse();
        ...
        private static DescribeRunResponseUnmarshaller _instance = new DescribeRunResponseUnmarshaller();        

        internal static DescribeRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
