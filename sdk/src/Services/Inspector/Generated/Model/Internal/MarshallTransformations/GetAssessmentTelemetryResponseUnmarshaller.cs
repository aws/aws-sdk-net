...
{
    /// <summary>
    /// Response Unmarshaller for GetAssessmentTelemetry operation
    /// </summary>  
    public class GetAssessmentTelemetryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAssessmentTelemetryResponse response = new GetAssessmentTelemetryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("telemetry", targetDepth))
                {
                    ...
                    response.Telemetry = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetAssessmentTelemetryResponseUnmarshaller _instance = new GetAssessmentTelemetryResponseUnmarshaller();        

        internal static GetAssessmentTelemetryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssessmentTelemetryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
