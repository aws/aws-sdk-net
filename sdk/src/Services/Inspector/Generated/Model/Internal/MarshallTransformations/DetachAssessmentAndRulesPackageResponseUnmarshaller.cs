...
{
    /// <summary>
    /// Response Unmarshaller for DetachAssessmentAndRulesPackage operation
    /// </summary>  
    public class DetachAssessmentAndRulesPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachAssessmentAndRulesPackageResponse response = new DetachAssessmentAndRulesPackageResponse();
        ...
        private static DetachAssessmentAndRulesPackageResponseUnmarshaller _instance = new DetachAssessmentAndRulesPackageResponseUnmarshaller();        

        internal static DetachAssessmentAndRulesPackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachAssessmentAndRulesPackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
