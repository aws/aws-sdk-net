...
namespace Amazon.Inspector.Model.Internal.MarshallTransformations
{
    ...
    public class ListAssessmentsRequestMarshaller : IMarshaller<IRequest, ListAssessmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListAssessmentsRequest publicRequest)
        {
            ...
            string target = "InspectorService.ListAssessments";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetApplicationArns())
                {
                    context.Writer.WritePropertyName("applicationArns");
                    context.Writer.WriteArrayStart();
                    foreach(var publicRequestApplicationArnsListValue in publicRequest.ApplicationArns)
                    {
                            context.Writer.Write(publicRequestApplicationArnsListValue);
                    }
