...
namespace Amazon.Inspector.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventSubscriptionUnmarshaller : IJsonUnmarshaller<EventSubscription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventSubscription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
