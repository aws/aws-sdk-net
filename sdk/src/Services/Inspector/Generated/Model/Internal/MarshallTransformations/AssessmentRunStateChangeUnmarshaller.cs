...
namespace Amazon.Inspector.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssessmentRunStateChangeUnmarshaller : IJsonUnmarshaller<AssessmentRunStateChange, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssessmentRunStateChange Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("stateChangedAt", targetDepth, ref reader))
                {
