...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAssessment operation
    /// </summary>  
    public class DeleteAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteAssessmentResponseUnmarshaller _instance = new DeleteAssessmentResponseUnmarshaller();        

        internal static DeleteAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
