...
{
    /// <summary>
    /// Response Unmarshaller for ListAttachedRulesPackages operation
    /// </summary>  
    public class ListAttachedRulesPackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttachedRulesPackagesResponse response = new ListAttachedRulesPackagesResponse();
        ...
        private static ListAttachedRulesPackagesResponseUnmarshaller _instance = new ListAttachedRulesPackagesResponseUnmarshaller();        

        internal static ListAttachedRulesPackagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedRulesPackagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
