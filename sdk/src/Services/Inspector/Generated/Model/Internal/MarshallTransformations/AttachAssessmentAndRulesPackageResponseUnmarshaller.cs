...
{
    /// <summary>
    /// Response Unmarshaller for AttachAssessmentAndRulesPackage operation
    /// </summary>  
    public class AttachAssessmentAndRulesPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachAssessmentAndRulesPackageResponse response = new AttachAssessmentAndRulesPackageResponse();
        ...
        private static AttachAssessmentAndRulesPackageResponseUnmarshaller _instance = new AttachAssessmentAndRulesPackageResponseUnmarshaller();        

        internal static AttachAssessmentAndRulesPackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachAssessmentAndRulesPackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
