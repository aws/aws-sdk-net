    ...
    public class DescribeAssessmentTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AssessmentTemplate, AssessmentTemplateUnmarshaller>(AssessmentTemplateUnmarshaller.Instance);
                    response.AssessmentTemplates = unmarshaller.Unmarshall(context);
                    continue;
                }
