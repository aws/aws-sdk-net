...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAssessmentTemplates operation
    /// </summary>  
    public class DescribeAssessmentTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAssessmentTemplatesResponse response = new DescribeAssessmentTemplatesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("assessmentTemplates", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AssessmentTemplate, AssessmentTemplateUnmarshaller>(AssessmentTemplateUnmarshaller.Instance);
                    response.AssessmentTemplates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAssessmentTemplatesResponseUnmarshaller _instance = new DescribeAssessmentTemplatesResponseUnmarshaller();        

        internal static DescribeAssessmentTemplatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssessmentTemplatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
