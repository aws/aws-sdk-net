...
namespace Amazon.PricingPlanManager.Model
{
    ...
    {
        private readonly IAmazonPricingPlanManager _client;
        ...
        /// <summary>
        /// Enumerable containing all of the SubscriptionSummaries
        /// </summary>
        public IPaginatedEnumerable<SubscriptionSummary> SubscriptionSummaries => 
            new PaginatedResultKeyResponse<ListSubscriptionsResponse, SubscriptionSummary>(this, (i) => i.SubscriptionSummaries ?? new List<SubscriptionSummary>());

        internal ListSubscriptionsPaginator(IAmazonPricingPlanManager client, ListSubscriptionsRequest request)
        {
            this._client = client;
