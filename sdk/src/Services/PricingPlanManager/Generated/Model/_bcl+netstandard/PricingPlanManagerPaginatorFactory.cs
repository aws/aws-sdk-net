...
{
    /// <summary>
    /// Paginators for the PricingPlanManager service
    ///</summary>
    public class PricingPlanManagerPaginatorFactory : IPricingPlanManagerPaginatorFactory
    {
        private readonly IAmazonPricingPlanManager client;

        internal PricingPlanManagerPaginatorFactory(IAmazonPricingPlanManager client) 
        {
            this.client = client;
        }
