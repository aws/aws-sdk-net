...
{
    /// <summary>
    /// Container for the parameters to the CancelSubscriptionChange operation. Cancels a
    /// pending scheduled change on a subscription, such as a pending downgrade or cancellation.
    /// The subscription returns to its state before the change was scheduled. <note> <para>
    /// You cannot cancel a scheduled change close to its effective date. If the change is
    /// within the processing window, this operation returns an error. </para> </note>
    /// </summary>
    public partial class CancelSubscriptionChangeRequest : AmazonPricingPlanManagerRequest
    {
        /// <summary>
