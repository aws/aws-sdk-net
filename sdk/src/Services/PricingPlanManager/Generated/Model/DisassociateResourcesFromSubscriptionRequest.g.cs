...
namespace Amazon.PricingPlanManager.Model
{
    ...
    /// Removes one or more resources from an existing subscription. <note> <para> For subscriptions
    /// in the CloudFront plan family, the associated resources must always include exactly
    /// one Amazon CloudFront distribution and exactly one WAF web ACL. You cannot remove
    /// these required resources. </para> </note>
    /// </summary>
