...
namespace Amazon.PricingPlanManager.Model
{
    ...
    /// </summary>
    public partial class ListSubscriptionsRequest : AmazonPricingPlanManagerRequest
    {
        ...
        /// <para>
        /// A token from a previous <c>ListSubscriptions</c> response. If the response included
        /// a <c>nextToken</c>, there are more results available. Pass this value to retrieve
