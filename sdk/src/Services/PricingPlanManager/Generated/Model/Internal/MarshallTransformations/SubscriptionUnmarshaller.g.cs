...
namespace Amazon.PricingPlanManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SubscriptionUnmarshaller : IJsonUnmarshaller<Subscription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Subscription();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SubscriptionUnmarshaller Instance => _instance;
    }
}
