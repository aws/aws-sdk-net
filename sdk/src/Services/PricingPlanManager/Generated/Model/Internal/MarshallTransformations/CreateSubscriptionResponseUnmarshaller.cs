...
{
    /// <summary>
    /// Response Unmarshaller for CreateSubscription operation
    /// </summary>  
    public class CreateSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateSubscriptionResponseUnmarshaller _instance = new CreateSubscriptionResponseUnmarshaller();        

        internal static CreateSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
