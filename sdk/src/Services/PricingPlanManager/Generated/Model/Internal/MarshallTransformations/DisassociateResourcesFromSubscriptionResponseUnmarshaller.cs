...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateResourcesFromSubscription operation
    /// </summary>  
    public class DisassociateResourcesFromSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateResourcesFromSubscriptionResponse response = new DisassociateResourcesFromSubscriptionResponse();
        ...
        private static DisassociateResourcesFromSubscriptionResponseUnmarshaller _instance = new DisassociateResourcesFromSubscriptionResponseUnmarshaller();        

        internal static DisassociateResourcesFromSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateResourcesFromSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
