...
namespace Amazon.PricingPlanManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelSubscriptionChangeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelSubscriptionChangeResponse response = new CancelSubscriptionChangeResponse();
        ...
        internal static CancelSubscriptionChangeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelSubscriptionChangeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
