...
namespace Amazon.PricingPlanManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateSubscriptionResponse();
        ...
        internal static UpdateSubscriptionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSubscriptionResponseUnmarshaller Instance => _instance;
    }
}
