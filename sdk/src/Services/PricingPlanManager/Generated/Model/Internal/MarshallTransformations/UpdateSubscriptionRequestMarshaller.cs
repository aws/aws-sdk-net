...
{
    /// <summary>
    /// UpdateSubscription Request Marshaller
    /// </summary>       
    public class UpdateSubscriptionRequestMarshaller : IMarshaller<IRequest, UpdateSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSubscriptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/UpdateSubscription";
#if !NETFRAMEWORK
        ...
        private static UpdateSubscriptionRequestMarshaller _instance = new UpdateSubscriptionRequestMarshaller();        

        internal static UpdateSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
