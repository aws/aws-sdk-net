...
namespace Amazon.PricingPlanManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateSubscriptionRequestMarshaller : IMarshaller<IRequest, CreateSubscriptionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateSubscriptionRequestMarshaller _instance = new();

        internal static CreateSubscriptionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSubscriptionRequestMarshaller Instance => _instance;
    }
}
