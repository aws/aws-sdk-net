...
namespace Amazon.PricingPlanManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApprovePaidSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ApprovePaidSubscriptionResponse response = new ApprovePaidSubscriptionResponse();
        ...
        internal static ApprovePaidSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ApprovePaidSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
