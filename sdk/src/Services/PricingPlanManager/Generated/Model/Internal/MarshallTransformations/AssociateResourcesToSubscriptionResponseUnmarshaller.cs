...
{
    /// <summary>
    /// Response Unmarshaller for AssociateResourcesToSubscription operation
    /// </summary>  
    public class AssociateResourcesToSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateResourcesToSubscriptionResponse response = new AssociateResourcesToSubscriptionResponse();
        ...
        private static AssociateResourcesToSubscriptionResponseUnmarshaller _instance = new AssociateResourcesToSubscriptionResponseUnmarshaller();        

        internal static AssociateResourcesToSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateResourcesToSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
