...
{
    /// <summary>
    /// Amazon PricingPlanManager endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for PricingPlanManager service requests.
    /// Collects values for PricingPlanManagerEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PricingPlanManagerEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPricingPlanManagerEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPricingPlanManagerConfig)requestContext.ClientConfig;
            var result = new PricingPlanManagerEndpointParameters();
