...
namespace Amazon.PricingPlanManager.Internal
{
    ...
    public class AmazonPricingPlanManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPricingPlanManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PricingPlanManager.
        /// </summary>
        public AmazonPricingPlanManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPricingPlanManagerAuthSchemeParameters
            {
    ...
    public class AmazonPricingPlanManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonPricingPlanManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPricingPlanManagerAuthSchemeParameters authParameters)
        {
