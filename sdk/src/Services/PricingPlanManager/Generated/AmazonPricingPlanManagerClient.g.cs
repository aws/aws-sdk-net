...
namespace Amazon.PricingPlanManager
{
    ...
    public partial class AmazonPricingPlanManagerClient : AmazonServiceClient, IAmazonPricingPlanManager
    {
        ...
        /// 
        /// </summary>
        public AmazonPricingPlanManagerClient() : base(new AmazonPricingPlanManagerConfig()) { }
        ...
        public AmazonPricingPlanManagerClient(RegionEndpoint region) : base(new AmazonPricingPlanManagerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonPricingPlanManagerClient(AmazonPricingPlanManagerConfig config) : base(config) { }
...
#else
        internal virtual ApprovePaidSubscriptionResponse ApprovePaidSubscription(ApprovePaidSubscriptionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ApprovePaidSubscriptionRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ApprovePaidSubscriptionResponseUnmarshaller.Instance;
...
#else
        internal virtual AssociateResourcesToSubscriptionResponse AssociateResourcesToSubscription(AssociateResourcesToSubscriptionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = AssociateResourcesToSubscriptionRequestMarshaller.Instance;
            options.ResponseUnmarshaller = AssociateResourcesToSubscriptionResponseUnmarshaller.Instance;
...
#else
        internal virtual CancelSubscriptionChangeResponse CancelSubscriptionChange(CancelSubscriptionChangeRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = CancelSubscriptionChangeRequestMarshaller.Instance;
            options.ResponseUnmarshaller = CancelSubscriptionChangeResponseUnmarshaller.Instance;
...
#else
        internal virtual DisassociateResourcesFromSubscriptionResponse DisassociateResourcesFromSubscription(DisassociateResourcesFromSubscriptionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = DisassociateResourcesFromSubscriptionRequestMarshaller.Instance;
            options.ResponseUnmarshaller = DisassociateResourcesFromSubscriptionResponseUnmarshaller.Instance;
