...
namespace Amazon.PricingPlanManager
{
    ...
    public class ApprovalMode : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ApprovalMode for a value not among the defined constants.
        /// </summary>
        public ApprovalMode(string value) : base(value) { }
    ...
    public class ScheduledChangeType : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ScheduledChangeType for a value not among the defined constants.
        /// </summary>
        public ScheduledChangeType(string value) : base(value) { }
