...
namespace Amazon.PricingPlanManager
{
    ...
    public partial interface IAmazonPricingPlanManager : IAmazonService, IDisposable
    {
        ...
        ApprovePaidSubscriptionResponse ApprovePaidSubscription(ApprovePaidSubscriptionRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/ApprovePaidSubscription">REST API Reference for ApprovePaidSubscription Operation</seealso>
        Task<ApprovePaidSubscriptionResponse> ApprovePaidSubscriptionAsync(ApprovePaidSubscriptionRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        AssociateResourcesToSubscriptionResponse AssociateResourcesToSubscription(AssociateResourcesToSubscriptionRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/AssociateResourcesToSubscription">REST API Reference for AssociateResourcesToSubscription Operation</seealso>
        Task<AssociateResourcesToSubscriptionResponse> AssociateResourcesToSubscriptionAsync(AssociateResourcesToSubscriptionRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        CancelSubscriptionChangeResponse CancelSubscriptionChange(CancelSubscriptionChangeRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/CancelSubscriptionChange">REST API Reference for CancelSubscriptionChange Operation</seealso>
        Task<CancelSubscriptionChangeResponse> CancelSubscriptionChangeAsync(CancelSubscriptionChangeRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        DisassociateResourcesFromSubscriptionResponse DisassociateResourcesFromSubscription(DisassociateResourcesFromSubscriptionRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/DisassociateResourcesFromSubscription">REST API Reference for DisassociateResourcesFromSubscription Operation</seealso>
        Task<DisassociateResourcesFromSubscriptionResponse> DisassociateResourcesFromSubscriptionAsync(DisassociateResourcesFromSubscriptionRequest request, CancellationToken cancellationToken = default(CancellationToken));
