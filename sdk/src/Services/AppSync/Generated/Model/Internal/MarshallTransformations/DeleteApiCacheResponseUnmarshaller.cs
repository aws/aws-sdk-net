...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApiCache operation
    /// </summary>  
    public class DeleteApiCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApiCacheResponse response = new DeleteApiCacheResponse();
        ...
        private static DeleteApiCacheResponseUnmarshaller _instance = new DeleteApiCacheResponseUnmarshaller();        

        internal static DeleteApiCacheResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApiCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
