...
{
    /// <summary>
    /// Response Unmarshaller for AssociateSourceGraphqlApi operation
    /// </summary>  
    public class AssociateSourceGraphqlApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateSourceGraphqlApiResponse response = new AssociateSourceGraphqlApiResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("sourceApiAssociation", targetDepth))
                {
                    ...
                    response.SourceApiAssociation = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static AssociateSourceGraphqlApiResponseUnmarshaller _instance = new AssociateSourceGraphqlApiResponseUnmarshaller();        

        internal static AssociateSourceGraphqlApiResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateSourceGraphqlApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
