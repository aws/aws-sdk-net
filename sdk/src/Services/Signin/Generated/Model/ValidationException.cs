...
namespace Amazon.Signin.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationException : AmazonSigninException
    {
        ...
        /// <para>
        /// OAuth 2.0 error code indicating validation failure Will be INVALID_REQUEST for validation
        /// errors
        /// </para>
        /// </summary>
