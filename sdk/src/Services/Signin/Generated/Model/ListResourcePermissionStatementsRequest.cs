...
{
    /// <summary>
    /// Container for the parameters to the ListResourcePermissionStatements operation.
    /// Retrieve all permission statements in the account's SignIn resource-based policy
    /// </summary>
    public partial class ListResourcePermissionStatementsRequest : AmazonSigninRequest
    {
