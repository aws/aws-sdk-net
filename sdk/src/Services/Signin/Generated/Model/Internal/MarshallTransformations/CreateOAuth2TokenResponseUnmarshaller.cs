...
{
    /// <summary>
    /// Response Unmarshaller for CreateOAuth2Token operation
    /// </summary>  
    public class CreateOAuth2TokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOAuth2TokenResponse response = new CreateOAuth2TokenResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = CreateOAuth2TokenResponseBodyUnmarshaller.Instance;
            response.TokenOutput = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static CreateOAuth2TokenResponseUnmarshaller _instance = new CreateOAuth2TokenResponseUnmarshaller();        

        internal static CreateOAuth2TokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOAuth2TokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
