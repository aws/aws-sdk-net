...
{
    /// <summary>
    /// Response Unmarshaller for PutResourcePermissionStatement operation
    /// </summary>  
    public class PutResourcePermissionStatementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutResourcePermissionStatementResponse response = new PutResourcePermissionStatementResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("statementId", targetDepth, ref reader))
                {
                    ...
                    response.StatementId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PutResourcePermissionStatementResponseUnmarshaller _instance = new PutResourcePermissionStatementResponseUnmarshaller();        

        internal static PutResourcePermissionStatementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutResourcePermissionStatementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
