...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConsoleAuthorizationConfiguration operation
    /// </summary>  
    public class DeleteConsoleAuthorizationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConsoleAuthorizationConfigurationResponse response = new DeleteConsoleAuthorizationConfigurationResponse();
            ...
            {
                if (context.TestExpression("consoleAuthorizationEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.ConsoleAuthorizationEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteConsoleAuthorizationConfigurationResponseUnmarshaller _instance = new DeleteConsoleAuthorizationConfigurationResponseUnmarshaller();        

        internal static DeleteConsoleAuthorizationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConsoleAuthorizationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
