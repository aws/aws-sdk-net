...
{
    /// <summary>
    /// Response Unmarshaller for GetConsoleAuthorizationConfiguration operation
    /// </summary>  
    public class GetConsoleAuthorizationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConsoleAuthorizationConfigurationResponse response = new GetConsoleAuthorizationConfigurationResponse();
        ...
        private static GetConsoleAuthorizationConfigurationResponseUnmarshaller _instance = new GetConsoleAuthorizationConfigurationResponseUnmarshaller();        

        internal static GetConsoleAuthorizationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConsoleAuthorizationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
