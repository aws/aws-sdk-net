...
namespace Amazon.Signin.Model.Internal.MarshallTransformations
{
    ...
    public class GetResourcePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("signinResourceBasedPolicy", targetDepth, ref reader))
                {
                    var unmarshaller = SigninResourceBasedPolicyUnmarshaller.Instance;
                    response.SigninResourceBasedPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
