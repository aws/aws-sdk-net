...
{
    /// <summary>
    /// Response Unmarshaller for CreateOAuth2TokenWithIAM operation
    /// </summary>  
    public class CreateOAuth2TokenWithIAMResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOAuth2TokenWithIAMResponse response = new CreateOAuth2TokenWithIAMResponse();
            ...
            {
                if (context.TestExpression("access_token", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AccessToken = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("expires_in", targetDepth, ref reader))
                {
        ...
        private static CreateOAuth2TokenWithIAMResponseUnmarshaller _instance = new CreateOAuth2TokenWithIAMResponseUnmarshaller();        

        internal static CreateOAuth2TokenWithIAMResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOAuth2TokenWithIAMResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
