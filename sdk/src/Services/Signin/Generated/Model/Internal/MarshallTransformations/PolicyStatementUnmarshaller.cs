...
{
    /// <summary>
    /// Response Unmarshaller for PolicyStatement Object
    /// </summary>  
    public class PolicyStatementUnmarshaller : IJsonUnmarshaller<PolicyStatement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PolicyStatement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static PolicyStatementUnmarshaller _instance = new PolicyStatementUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PolicyStatementUnmarshaller Instance
        {
            get
            {
                return _instance;
