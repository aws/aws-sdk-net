...
{
    /// <summary>
    /// Response Unmarshaller for PutConsoleAuthorizationConfiguration operation
    /// </summary>  
    public class PutConsoleAuthorizationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutConsoleAuthorizationConfigurationResponse response = new PutConsoleAuthorizationConfigurationResponse();
        ...
        private static PutConsoleAuthorizationConfigurationResponseUnmarshaller _instance = new PutConsoleAuthorizationConfigurationResponseUnmarshaller();        

        internal static PutConsoleAuthorizationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutConsoleAuthorizationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
