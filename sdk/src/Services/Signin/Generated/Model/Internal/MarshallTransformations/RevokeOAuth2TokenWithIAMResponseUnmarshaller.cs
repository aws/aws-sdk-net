...
{
    /// <summary>
    /// Response Unmarshaller for RevokeOAuth2TokenWithIAM operation
    /// </summary>  
    public class RevokeOAuth2TokenWithIAMResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeOAuth2TokenWithIAMResponse response = new RevokeOAuth2TokenWithIAMResponse();
        ...
        private static RevokeOAuth2TokenWithIAMResponseUnmarshaller _instance = new RevokeOAuth2TokenWithIAMResponseUnmarshaller();        

        internal static RevokeOAuth2TokenWithIAMResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeOAuth2TokenWithIAMResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
