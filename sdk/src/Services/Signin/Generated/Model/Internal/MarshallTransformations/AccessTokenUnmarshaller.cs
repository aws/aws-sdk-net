...
{
    /// <summary>
    /// Response Unmarshaller for AccessToken Object
    /// </summary>  
    public class AccessTokenUnmarshaller : IUnmarshaller<AccessToken, XmlUnmarshallerContext>, IUnmarshaller<AccessToken, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AccessToken IUnmarshaller<AccessToken, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AccessToken Unmarshall(JsonUnmarshallerContext context)
        {
            AccessToken unmarshalledObject = new AccessToken();
        ...
        private static AccessTokenUnmarshaller _instance = new AccessTokenUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AccessTokenUnmarshaller Instance
        {
            get
            {
                return _instance;
