...
namespace Amazon.Signin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccessTokenUnmarshaller : IJsonUnmarshaller<AccessToken, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccessToken Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
