...
namespace Amazon.Signin.Model
{
    ...
    [Serializable]
    #endif
    public partial class InternalServerException : AmazonSigninException
    {
        ...
        /// <para>
        /// OAuth 2.0 error code indicating server error Will be SERVER_ERROR for internal server
        /// errors
        /// </para>
        /// </summary>
