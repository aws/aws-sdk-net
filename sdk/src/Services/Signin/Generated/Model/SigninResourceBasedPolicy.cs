...
namespace Amazon.Signin.Model
{
    ...
    /// </summary>
    public partial class SigninResourceBasedPolicy
    {
        private List<PolicyStatement> _statement = AWSConfigs.InitializeCollections ? new List<PolicyStatement>() : null;
        ...
        /// </summary>
        public List<PolicyStatement> Statement
        {
        ...
        {
            return this._statement != null && (this._statement.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
