...
namespace Amazon.Signin
{
    ...
    public partial class AmazonSigninClient : AmazonServiceClient, IAmazonSignin
    {
        ...
        public AmazonSigninClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSigninConfig()) { }
        ...
        public AmazonSigninClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSigninConfig{RegionEndpoint = region}) { }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonSigninEndpointResolver();
