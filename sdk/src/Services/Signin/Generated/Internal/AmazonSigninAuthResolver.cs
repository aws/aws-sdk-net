...
namespace Amazon.Signin.Internal
{
    ...
    public class AmazonSigninAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSigninAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Signin.
        /// </summary>
        public AmazonSigninAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSigninAuthSchemeParameters
            {
    ...
    public class AmazonSigninAuthSchemeResolver : IAuthSchemeResolver<AmazonSigninAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSigninAuthSchemeParameters authParameters)
        {
            switch (authParameters.Operation)
            {
                case "CreateOAuth2TokenRequest":
