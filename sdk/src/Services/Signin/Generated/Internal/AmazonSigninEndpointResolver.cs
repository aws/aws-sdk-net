...
{
    /// <summary>
    /// Amazon Signin endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Signin service requests.
    /// Collects values for SigninEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SigninEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonSigninEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSigninConfig)requestContext.ClientConfig;
            var result = new SigninEndpointParameters();
