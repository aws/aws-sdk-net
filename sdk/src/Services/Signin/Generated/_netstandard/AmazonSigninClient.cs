...
namespace Amazon.Signin
{
    ...
    public partial class AmazonSigninClient : AmazonServiceClient, IAmazonSignin
    {
        ...
        internal virtual CreateOAuth2TokenWithIAMResponse CreateOAuth2TokenWithIAM(CreateOAuth2TokenWithIAMRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual IntrospectOAuth2TokenWithIAMResponse IntrospectOAuth2TokenWithIAM(IntrospectOAuth2TokenWithIAMRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual RevokeOAuth2TokenWithIAMResponse RevokeOAuth2TokenWithIAM(RevokeOAuth2TokenWithIAMRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
