                ...
                if (IsSet(refs["OutpostId"]))
                {
                    if ((refs["partitionResult"] = Partition((string)refs["Region"])) != null)
                    {
                        ...
                        if (IsValidHostLabel((string)refs["Region"], true))
                        {
                            ...
                            {
                                return new Endpoint(Interpolate(@"{url#scheme}://{url#authority}{url#path}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                            }
                            if (Equals(refs["UseFIPS"], true))
                            {
                                return new Endpoint(Interpolate(@"https://s3-outposts-fips.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                            }
                            return new Endpoint(Interpolate(@"https://s3-outposts.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                                                            ...
                                                            if ((refs["outpostType"] = GetAttr(refs["accessPointArn"], "resourceId[2]")) != null)
                                                            {
                                                                if ((refs["accessPointName"] = GetAttr(refs["accessPointArn"], "resourceId[3]")) != null)
                                                                {
                                                                    if (Equals(refs["outpostType"], "accesspoint"))
                                                                    {
                                                                        if (Equals(refs["UseFIPS"], true))
                                                                        {
                                                                            return new Endpoint(Interpolate(@"https://s3-outposts-fips.{accessPointArn#region}.{arnPartition#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{accessPointArn#region}""}]}", refs), InterpolateJson(@"{""x-amz-account-id"":[""{accessPointArn#accountId}""],""x-amz-outpost-id"":[""{outpostId}""]}", refs));
                                                                        }
                                                                        if (IsSet(refs["Endpoint"]) && (refs["url"] = ParseURL((string)refs["Endpoint"])) != null)
                                                                        {
                                                                            return new Endpoint(Interpolate(@"{url#scheme}://{url#authority}{url#path}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{accessPointArn#region}""}]}", refs), InterpolateJson(@"{""x-amz-account-id"":[""{accessPointArn#accountId}""],""x-amz-outpost-id"":[""{outpostId}""]}", refs));
                                                                        }
                                                                        return new Endpoint(Interpolate(@"https://s3-outposts.{accessPointArn#region}.{arnPartition#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{accessPointArn#region}""}]}", refs), InterpolateJson(@"{""x-amz-account-id"":[""{accessPointArn#accountId}""],""x-amz-outpost-id"":[""{outpostId}""]}", refs));
                                                                    }
                                                            ...
                                                            if ((refs["outpostType"] = GetAttr(refs["bucketArn"], "resourceId[2]")) != null)
                                                            {
                                                                if ((refs["bucketName"] = GetAttr(refs["bucketArn"], "resourceId[3]")) != null)
                                                                {
                                                                    if (Equals(refs["outpostType"], "bucket"))
                                                                    {
                                                                        if (Equals(refs["UseFIPS"], true))
                                                                        {
                                                                            return new Endpoint(Interpolate(@"https://s3-outposts-fips.{bucketArn#region}.{arnPartition#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{bucketArn#region}""}]}", refs), InterpolateJson(@"{""x-amz-account-id"":[""{bucketArn#accountId}""],""x-amz-outpost-id"":[""{outpostId}""]}", refs));
                                                                        }
                                                                        if (IsSet(refs["Endpoint"]) && (refs["url"] = ParseURL((string)refs["Endpoint"])) != null)
                                                                        {
                                                                            return new Endpoint(Interpolate(@"{url#scheme}://{url#authority}{url#path}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{bucketArn#region}""}]}", refs), InterpolateJson(@"{""x-amz-account-id"":[""{bucketArn#accountId}""],""x-amz-outpost-id"":[""{outpostId}""]}", refs));
                                                                        }
                                                                        return new Endpoint(Interpolate(@"https://s3-outposts.{bucketArn#region}.{arnPartition#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3-outposts"",""signingRegion"":""{bucketArn#region}""}]}", refs), InterpolateJson(@"{""x-amz-account-id"":[""{bucketArn#accountId}""],""x-amz-outpost-id"":[""{outpostId}""]}", refs));
                                                                    }
                ...
                if ((refs["partitionResult"] = Partition((string)refs["Region"])) != null)
                {
                    if (IsValidHostLabel((string)refs["Region"], true))
                    {
                        ...
                        if (IsSet(refs["Endpoint"]) && (refs["url"] = ParseURL((string)refs["Endpoint"])) != null)
                        {
                            ...
                            if (IsSet(refs["RequiresAccountId"]) && Equals(refs["RequiresAccountId"], true) && IsSet(refs["AccountId"]))
                            {
                                return new Endpoint(Interpolate(@"{url#scheme}://{AccountId}.{url#authority}{url#path}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                            }
                            return new Endpoint(Interpolate(@"{url#scheme}://{url#authority}{url#path}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        ...
                        {
                            return new Endpoint(Interpolate(@"https://{AccountId}.s3-control-fips.dualstack.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        if (Equals(refs["UseFIPS"], true) && Equals(refs["UseDualStack"], true))
                        {
                            return new Endpoint(Interpolate(@"https://s3-control-fips.dualstack.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        ...
                        {
                            return new Endpoint(Interpolate(@"https://{AccountId}.s3-control-fips.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        if (Equals(refs["UseFIPS"], true) && Equals(refs["UseDualStack"], false))
                        {
                            return new Endpoint(Interpolate(@"https://s3-control-fips.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        ...
                        {
                            return new Endpoint(Interpolate(@"https://{AccountId}.s3-control.dualstack.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        if (Equals(refs["UseFIPS"], false) && Equals(refs["UseDualStack"], true))
                        {
                            return new Endpoint(Interpolate(@"https://s3-control.dualstack.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        ...
                        {
                            return new Endpoint(Interpolate(@"https://{AccountId}.s3-control.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                        if (Equals(refs["UseFIPS"], false) && Equals(refs["UseDualStack"], false))
                        {
                            return new Endpoint(Interpolate(@"https://s3-control.{Region}.{partitionResult#dnsSuffix}", refs), InterpolateJson(@"{""authSchemes"":[{""name"":""sigv4"",""disableDoubleEncoding"":true,""signingName"":""s3"",""signingRegion"":""{Region}""}]}", refs), InterpolateJson(@"", refs));
                        }
                    }
                    throw new AmazonClientException("Invalid region: region was not a valid DNS name.");
                }
