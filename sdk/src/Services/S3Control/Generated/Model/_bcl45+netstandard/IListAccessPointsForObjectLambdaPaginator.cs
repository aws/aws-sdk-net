...
namespace Amazon.S3Control.Model
{
    ...
    public interface IListAccessPointsForObjectLambdaPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListAccessPointsForObjectLambdaResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the ObjectLambdaAccessPointList
        /// </summary>
        IPaginatedEnumerable<ObjectLambdaAccessPoint> ObjectLambdaAccessPointList { get; }
    }
}
#endif