...
{
    /// <summary>
    /// The container element for S3 Storage Lens advanced performance metrics. Advanced performance
    /// metrics provide insights into application performance, such as request efficiency
    /// and access patterns. These metrics help you optimize your S3 storage for both cost
    /// and performance by providing detailed analytics on how your applications interact
    /// with S3 resources.
    /// 
    ///  
    /// <para>
    ...
    /// </para>
    /// </summary>
    public partial class AdvancedPerformanceMetrics
    {
        ...
        /// <para>
        /// A container that indicates whether S3 Storage Lens advanced performance metrics are
        /// enabled.
        /// </para>
        /// </summary>
