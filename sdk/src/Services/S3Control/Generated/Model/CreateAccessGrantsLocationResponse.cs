...
{
    /// <summary>
    /// This is the response object from the CreateAccessGrantsLocation operation.
    /// </summary>
    public partial class CreateAccessGrantsLocationResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// The S3 URI path to the location that you are registering. The location scope can be
        /// the default S3 location <code>s3://</code>, the S3 path to a bucket, or the S3 path
        /// to a bucket and prefix. A prefix in S3 is a string of characters at the beginning
        /// of an object key name used to organize the objects that you store in your S3 buckets.
        /// For example, object key names that start with the <code>engineering/</code> prefix
        /// or object key names that start with the <code>marketing/campaigns/</code> prefix.
        /// </para>
        /// </summary>
