...
{
    /// <summary>
    /// Response Unmarshaller for GetAccessGrantsInstanceForPrefix operation
    /// </summary>  
    public partial class GetAccessGrantsInstanceForPrefixResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccessGrantsInstanceForPrefixResponse response = new GetAccessGrantsInstanceForPrefixResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetAccessGrantsInstanceForPrefixResponse response);

        private static GetAccessGrantsInstanceForPrefixResponseUnmarshaller _instance = new GetAccessGrantsInstanceForPrefixResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessGrantsInstanceForPrefixResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
