...
{
    /// <summary>
    /// Response Unmarshaller for GetJobTagging operation
    /// </summary>  
    public partial class GetJobTaggingResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJobTaggingResponse response = new GetJobTaggingResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetJobTaggingResponse response);

        private static GetJobTaggingResponseUnmarshaller _instance = new GetJobTaggingResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobTaggingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
