...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class CreateAccessGrantsInstanceRequestMarshaller : IMarshaller<IRequest, CreateAccessGrantsInstanceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((CreateAccessGrantsInstanceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccessGrantsInstanceRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessGrantsInstanceRequestMarshaller Instance
        {
            get
            {
                return _instance;
        ...
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, CreateAccessGrantsInstanceRequest publicRequest);
    }    
}