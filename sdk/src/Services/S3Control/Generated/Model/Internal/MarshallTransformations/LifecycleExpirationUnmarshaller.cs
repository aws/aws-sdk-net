...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class LifecycleExpirationUnmarshaller : IXmlUnmarshaller<LifecycleExpiration, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public LifecycleExpiration Unmarshall(XmlUnmarshallerContext context)
        {
            LifecycleExpiration unmarshalledObject = new LifecycleExpiration();
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, LifecycleExpiration unmarshalledObject, int targetDepth);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LifecycleExpirationUnmarshaller Instance
        {
            get
            {
                return _instance;
