...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class PutStorageLensConfigurationTaggingRequestMarshaller : IMarshaller<IRequest, PutStorageLensConfigurationTaggingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((PutStorageLensConfigurationTaggingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutStorageLensConfigurationTaggingRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutStorageLensConfigurationTaggingRequestMarshaller Instance
        {
            get
            {
                return _instance;
        ...
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, PutStorageLensConfigurationTaggingRequest publicRequest);
    }    
}