...
namespace Amazon.S3Control.Model
{
    ...
    public partial class GetAccessGrantsLocationResponse : AmazonWebServiceResponse
    {
        ...
        /// S3 location <code>s3://</code>, the S3 path to a bucket, or the S3 path to a bucket
        /// and prefix. A prefix in S3 is a string of characters at the beginning of an object
        /// key name used to organize the objects that you store in your S3 buckets. For example,
        /// object key names that start with the <code>engineering/</code> prefix or object key
        /// names that start with the <code>marketing/campaigns/</code> prefix.
        /// </para>
        /// </summary>
