...
namespace Amazon.IoTDeviceAdvisor
{
    ...
    public partial class AmazonIoTDeviceAdvisorConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("IotDeviceAdvisor", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "IotDeviceAdvisor";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "api.iotdeviceadvisor";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-09-18";
