...
namespace Amazon.IoTDeviceAdvisor
{
    ...
    public partial class AmazonIoTDeviceAdvisorClient : AmazonServiceClient, IAmazonIoTDeviceAdvisor
    {
        ...
        /// 
        /// </summary>
        public AmazonIoTDeviceAdvisorClient() : base(new AmazonIoTDeviceAdvisorConfig()) { }
        ...
        public AmazonIoTDeviceAdvisorClient(RegionEndpoint region) : base(new AmazonIoTDeviceAdvisorConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIoTDeviceAdvisorClient(AmazonIoTDeviceAdvisorConfig config) : base(config) { }
