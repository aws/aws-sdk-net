...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSuiteDefinitionRequestMarshaller : IMarshaller<IRequest, UpdateSuiteDefinitionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateSuiteDefinitionRequestMarshaller _instance = new();

        internal static UpdateSuiteDefinitionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSuiteDefinitionRequestMarshaller Instance => _instance;
    }
}
