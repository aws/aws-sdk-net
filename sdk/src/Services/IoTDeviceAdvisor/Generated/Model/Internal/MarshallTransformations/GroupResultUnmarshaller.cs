...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GroupResultUnmarshaller : IJsonUnmarshaller<GroupResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GroupResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
