...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSuiteRunReportRequestMarshaller : IMarshaller<IRequest, GetSuiteRunReportRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSuiteRunReportRequestMarshaller _instance = new();

        internal static GetSuiteRunReportRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSuiteRunReportRequestMarshaller Instance => _instance;
    }
}
