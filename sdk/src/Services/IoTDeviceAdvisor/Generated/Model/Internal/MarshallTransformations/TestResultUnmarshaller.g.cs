...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TestResultUnmarshaller : IJsonUnmarshaller<TestResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TestResult();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TestResultUnmarshaller Instance => _instance;
    }
}
