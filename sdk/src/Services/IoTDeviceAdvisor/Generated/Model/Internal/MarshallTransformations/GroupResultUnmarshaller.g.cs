...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GroupResultUnmarshaller : IJsonUnmarshaller<GroupResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GroupResult();
        ...
        /// Gets the singleton.
        /// </summary>
        public static GroupResultUnmarshaller Instance => _instance;
    }
}
