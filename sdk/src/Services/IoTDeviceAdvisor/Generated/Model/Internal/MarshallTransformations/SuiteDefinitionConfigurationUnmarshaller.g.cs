...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SuiteDefinitionConfigurationUnmarshaller : IJsonUnmarshaller<SuiteDefinitionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SuiteDefinitionConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SuiteDefinitionConfigurationUnmarshaller Instance => _instance;
    }
}
