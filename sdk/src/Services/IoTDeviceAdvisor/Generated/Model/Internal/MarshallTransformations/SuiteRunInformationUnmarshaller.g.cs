...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SuiteRunInformationUnmarshaller : IJsonUnmarshaller<SuiteRunInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SuiteRunInformation();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("endAt", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static SuiteRunInformationUnmarshaller Instance => _instance;
    }
}
