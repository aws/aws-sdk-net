...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSuiteDefinitionRequestMarshaller : IMarshaller<IRequest, GetSuiteDefinitionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSuiteDefinitionRequestMarshaller _instance = new();

        internal static GetSuiteDefinitionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSuiteDefinitionRequestMarshaller Instance => _instance;
    }
}
