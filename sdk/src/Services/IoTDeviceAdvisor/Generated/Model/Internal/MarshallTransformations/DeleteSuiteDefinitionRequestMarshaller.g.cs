...
{
    /// <summary>
    /// DeleteSuiteDefinition Request Marshaller
    /// </summary>
    public partial class DeleteSuiteDefinitionRequestMarshaller : IMarshaller<IRequest, DeleteSuiteDefinitionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSuiteDefinitionRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteSuiteDefinitionRequest publicRequest)
        {
        ...
        private static readonly DeleteSuiteDefinitionRequestMarshaller _instance = new();

        internal static DeleteSuiteDefinitionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSuiteDefinitionRequestMarshaller Instance => _instance;
    }
}
