...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SuiteRunConfigurationUnmarshaller : IJsonUnmarshaller<SuiteRunConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SuiteRunConfiguration();
            ...
            {
                if (context.TestExpression("parallelRun", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("primaryDevice", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("selectedTestList", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static SuiteRunConfigurationUnmarshaller Instance => _instance;
    }
}
