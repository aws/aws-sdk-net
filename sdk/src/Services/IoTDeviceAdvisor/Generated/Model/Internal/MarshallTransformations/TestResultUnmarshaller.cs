...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestResultUnmarshaller : IJsonUnmarshaller<TestResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TestResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
