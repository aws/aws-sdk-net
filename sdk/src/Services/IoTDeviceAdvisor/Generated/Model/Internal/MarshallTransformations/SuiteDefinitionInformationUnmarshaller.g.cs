...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SuiteDefinitionInformationUnmarshaller : IJsonUnmarshaller<SuiteDefinitionInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SuiteDefinitionInformation();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("defaultDevices", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static SuiteDefinitionInformationUnmarshaller Instance => _instance;
    }
}
