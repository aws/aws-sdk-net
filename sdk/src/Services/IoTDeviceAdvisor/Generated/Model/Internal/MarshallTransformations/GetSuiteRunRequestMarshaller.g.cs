...
{
    /// <summary>
    /// GetSuiteRun Request Marshaller
    /// </summary>
    public partial class GetSuiteRunRequestMarshaller : IMarshaller<IRequest, GetSuiteRunRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSuiteRunRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetSuiteRunRequest publicRequest)
        {
            ...
            request.ResourcePath = "/suiteDefinitions/{suiteDefinitionId}/suiteRuns/{suiteRunId}";

            return request;
        }

        private static readonly GetSuiteRunRequestMarshaller _instance = new();

        internal static GetSuiteRunRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSuiteRunRequestMarshaller Instance => _instance;
    }
}
