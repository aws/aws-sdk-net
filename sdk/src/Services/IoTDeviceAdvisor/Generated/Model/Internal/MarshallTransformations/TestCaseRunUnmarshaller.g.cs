...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TestCaseRunUnmarshaller : IJsonUnmarshaller<TestCaseRun, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TestCaseRun();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TestCaseRunUnmarshaller Instance => _instance;
    }
}
