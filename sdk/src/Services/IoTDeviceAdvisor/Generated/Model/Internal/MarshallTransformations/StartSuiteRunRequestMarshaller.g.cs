...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartSuiteRunRequestMarshaller : IMarshaller<IRequest, StartSuiteRunRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartSuiteRunRequestMarshaller _instance = new();

        internal static StartSuiteRunRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartSuiteRunRequestMarshaller Instance => _instance;
    }
}
