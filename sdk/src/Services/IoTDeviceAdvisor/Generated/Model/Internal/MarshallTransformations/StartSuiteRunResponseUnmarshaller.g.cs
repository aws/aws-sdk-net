...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartSuiteRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StartSuiteRunResponse();
        ...
        internal static StartSuiteRunResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartSuiteRunResponseUnmarshaller Instance => _instance;
    }
}
