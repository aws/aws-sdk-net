...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSuiteDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSuiteDefinitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("suiteDefinitionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SuiteDefinitionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("suiteDefinitionConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = SuiteDefinitionConfigurationUnmarshaller.Instance;
                    unmarshalledObject.SuiteDefinitionConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetSuiteDefinitionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSuiteDefinitionResponseUnmarshaller Instance => _instance;
    }
}
