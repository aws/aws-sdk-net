...
{
    /// <summary>
    /// Container for the parameters to the StopSuiteRun operation. Stops a Device Advisor
    /// test suite run that is currently running. <para> Requires permission to access the
    /// <a href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsiot.html#awsiot-actions-as-permissions">StopSuiteRun</a>
    /// action. </para>
    /// </summary>
