...
{
    /// <summary>
    /// Container for the parameters to the GetSuiteRunReport operation. Gets a report download
    /// link for a successful Device Advisor qualifying test suite run. <para> Requires permission
    /// to access the <a href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsiot.html#awsiot-actions-as-permissions">GetSuiteRunReport</a>
    /// action. </para>
    /// </summary>
