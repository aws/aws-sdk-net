...
namespace Amazon.IoTDeviceAdvisor.Model
{
    ...
    public partial class GroupResult
    {
        ...
        /// </summary>
        public List<TestCaseRun> Tests { get; set; } = AWSConfigs.InitializeCollections ? new List<TestCaseRun>() : null;

        /// <summary>
        /// Checks to see if the Tests property is set.
        /// </summary>
        internal bool IsSetTests() => this.Tests != null && (this.Tests.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
