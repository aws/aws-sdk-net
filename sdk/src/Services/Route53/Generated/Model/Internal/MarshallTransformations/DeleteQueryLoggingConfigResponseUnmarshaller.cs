...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteQueryLoggingConfigResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new NoSuchQueryLoggingConfigException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteQueryLoggingConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
