...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class UpdateHostedZoneCommentResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHostedZoneCommentResponse response = new UpdateHostedZoneCommentResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateHostedZoneCommentResponse response);

        private static UpdateHostedZoneCommentResponseUnmarshaller _instance = new UpdateHostedZoneCommentResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHostedZoneCommentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
