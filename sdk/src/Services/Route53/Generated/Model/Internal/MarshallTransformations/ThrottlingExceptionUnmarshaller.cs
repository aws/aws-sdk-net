...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class ThrottlingExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<ThrottlingException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ThrottlingException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ThrottlingException Unmarshall(XmlUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ThrottlingException response = new ThrottlingException(errorResponse.Message, errorResponse.InnerException, 
