...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class ListTrafficPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTrafficPoliciesResponse response = new ListTrafficPoliciesResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListTrafficPoliciesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        if (response.TrafficPolicySummaries == null)
                        {
                            response.TrafficPolicySummaries = new List<TrafficPolicySummary>();
                        }
                        var unmarshaller = TrafficPolicySummaryUnmarshaller.Instance;
                        response.TrafficPolicySummaries.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    ...
                    if (context.TestExpression("TrafficPolicyIdMarker", targetDepth))
                    {
                        ...
                        response.TrafficPolicyIdMarker = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, ListTrafficPoliciesResponse response);

        private static ListTrafficPoliciesResponseUnmarshaller _instance = new ListTrafficPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTrafficPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
