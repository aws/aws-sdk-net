...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class GeoLocationUnmarshaller : IXmlUnmarshaller<GeoLocation, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public GeoLocation Unmarshall(XmlUnmarshallerContext context)
        {
            GeoLocation unmarshalledObject = new GeoLocation();
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, GeoLocation unmarshalledObject, int targetDepth);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GeoLocationUnmarshaller Instance
        {
            get
            {
                return _instance;
