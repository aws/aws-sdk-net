...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public partial class DeleteHealthCheckRequestMarshaller : IMarshaller<IRequest, DeleteHealthCheckRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((DeleteHealthCheckRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteHealthCheckRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHealthCheckRequestMarshaller Instance
        {
            get
            {
                return _instance;
        ...
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, DeleteHealthCheckRequest publicRequest);
    }    
}