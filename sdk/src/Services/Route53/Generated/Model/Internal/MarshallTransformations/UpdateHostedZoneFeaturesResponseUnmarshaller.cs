...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHostedZoneFeatures operation
    /// </summary>  
    public partial class UpdateHostedZoneFeaturesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHostedZoneFeaturesResponse response = new UpdateHostedZoneFeaturesResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateHostedZoneFeaturesResponse response);

        private static UpdateHostedZoneFeaturesResponseUnmarshaller _instance = new UpdateHostedZoneFeaturesResponseUnmarshaller();        

        internal static UpdateHostedZoneFeaturesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHostedZoneFeaturesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
