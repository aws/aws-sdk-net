...
namespace Amazon.Route53.Model
{
    ...
    public partial class HealthCheckInUseException : AmazonRoute53Exception
    {
        ...
        public HealthCheckInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HealthCheckInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
