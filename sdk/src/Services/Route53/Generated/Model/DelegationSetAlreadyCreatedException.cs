...
namespace Amazon.Route53.Model
{
    ...
    public partial class DelegationSetAlreadyCreatedException : AmazonRoute53Exception
    {
        ...
        public DelegationSetAlreadyCreatedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DelegationSetAlreadyCreatedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected DelegationSetAlreadyCreatedException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
