...
namespace Amazon.Route53.Model
{
    ...
    public partial class InsufficientCloudWatchLogsResourcePolicyException : AmazonRoute53Exception
    {
        ...
        public InsufficientCloudWatchLogsResourcePolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InsufficientCloudWatchLogsResourcePolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected InsufficientCloudWatchLogsResourcePolicyException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
