...
namespace Amazon.Route53.Model
{
    ...
    [Serializable]
    #endif
    public partial class TooManyTrafficPolicyVersionsForCurrentPolicyException : AmazonRoute53Exception
    {

        /// <summary>
        /// Default constructor for TooManyTrafficPolicyVersionsForCurrentPolicyException
        /// message.
        /// </summary>
        public TooManyTrafficPolicyVersionsForCurrentPolicyException() 
            : base() {}

        /// <summary>
        /// Constructs a new TooManyTrafficPolicyVersionsForCurrentPolicyException with the specified error
        /// message.
        /// </summary>
        /// <param name="message">
        ...
        /// <summary>
        /// Construct instance of TooManyTrafficPolicyVersionsForCurrentPolicyException
        /// </summary>
        ...
        public TooManyTrafficPolicyVersionsForCurrentPolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyTrafficPolicyVersionsForCurrentPolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
