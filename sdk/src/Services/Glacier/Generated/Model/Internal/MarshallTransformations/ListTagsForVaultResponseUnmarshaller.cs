...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTagsForVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTagsForVaultResponse response = new ListTagsForVaultResponse();
        ...
        private static ListTagsForVaultResponseUnmarshaller _instance = new ListTagsForVaultResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTagsForVaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
