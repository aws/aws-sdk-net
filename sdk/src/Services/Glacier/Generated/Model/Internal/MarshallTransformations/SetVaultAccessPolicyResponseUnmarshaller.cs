...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetVaultAccessPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetVaultAccessPolicyResponse response = new SetVaultAccessPolicyResponse();
        ...
        private static SetVaultAccessPolicyResponseUnmarshaller _instance = new SetVaultAccessPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetVaultAccessPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
