    ...
    public class ListMultipartUploadsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UploadsList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UploadListElement, UploadListElementUnmarshaller>(UploadListElementUnmarshaller.Instance);
                    response.UploadsList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
