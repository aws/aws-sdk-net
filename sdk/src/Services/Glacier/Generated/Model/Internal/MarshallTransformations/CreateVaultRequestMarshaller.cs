...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateVaultRequestMarshaller : IMarshaller<IRequest, CreateVaultRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateVaultRequest)input);
        }
        ...
        private static CreateVaultRequestMarshaller _instance = new CreateVaultRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVaultRequestMarshaller Instance
        {
            get
            {
                return _instance;
