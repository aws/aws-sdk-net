...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CompleteVaultLockRequestMarshaller : IMarshaller<IRequest, CompleteVaultLockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CompleteVaultLockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CompleteVaultLockRequest publicRequest)
        {
        ...
        private static CompleteVaultLockRequestMarshaller _instance = new CompleteVaultLockRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CompleteVaultLockRequestMarshaller Instance
        {
            get
            {
                return _instance;
