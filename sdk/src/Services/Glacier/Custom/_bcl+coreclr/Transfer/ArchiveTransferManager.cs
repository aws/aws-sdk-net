...
namespace Amazon.Glacier.Transfer
{
    public partial class ArchiveTransferManager : IDisposable
    {
        ...
        {
#if AWS_ASYNC_API
            return UploadAsync(vaultName, archiveDescription, filepath, options);
#else
            return UploadBcl(vaultName, archiveDescription, filepath, options);
#endif
        }
        ...
        {
#if AWS_ASYNC_API
            DownloadAsync(vaultName, archiveId, filePath, new DownloadOptions());
#else
             DownloadBcl(vaultName, archiveId,  filePath, new DownloadOptions());
#endif
        }
        #endregion
        ...
        {
#if AWS_ASYNC_API
            DownloadJobAsync(vaultName, jobId, filePath, new DownloadOptions());
#else
            DownloadJobBcl(vaultName,  jobId,  filePath, new DownloadOptions());
#endif
        }
        #endregion
        ...
        {
#if AWS_ASYNC_API
            return InitiateArchiveRetrievalJobAsync(vaultName, archiveId, options);
#else
            return InitiateArchiveRetrievalJobBcl(vaultName, archiveId, option);
#endif
        }
        #endregion
