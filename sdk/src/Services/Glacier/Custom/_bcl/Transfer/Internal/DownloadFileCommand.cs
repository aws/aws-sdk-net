...
namespace Amazon.Glacier.Transfer.Internal
{
    internal class DownloadFileCommand : IDisposable
    {
        ...
        string initiateJob()
        {
            ...
            ((Amazon.Runtime.Internal.IAmazonWebServiceRequest)request).AddBeforeRequestHandler(new UserAgentPostFix("DownloadArchive").UserAgentRequestEventHandlerSync);
