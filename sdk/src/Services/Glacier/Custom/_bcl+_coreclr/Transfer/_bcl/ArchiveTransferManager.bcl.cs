...
namespace Amazon.Glacier.Transfer
{
    public partial class ArchiveTransferManager : IDisposable
    {
        ...
        public UploadResult UploadBcl(string vaultName, string archiveDescription, string filepath, UploadOptions options)
        {
        ...
        public void DownloadBcl(string vaultName, string archiveId, string filePath, DownloadOptions options)
        {
