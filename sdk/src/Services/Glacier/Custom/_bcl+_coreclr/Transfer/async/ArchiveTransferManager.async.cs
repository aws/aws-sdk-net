...
namespace Amazon.Glacier.Transfer
{
    public partial class ArchiveTransferManager:IDisposable
    {
        ...
        public async void CreateVaultAsync(string vaultName)
        {
            ...
            await this.glacierClient.CreateVaultAsync(request);
        }
        ...
        public async void DeleteVaultAsync(string vaultName)
        {
            ...
            await this.glacierClient.DeleteVaultAsync(request);
        }
        ...
        public async void DeleteArchiveAsync(string vaultName, string archiveId)
        {
            ...
            await this.glacierClient.DeleteArchiveAsync(request);
        }
        ...
        public UploadResult UploadAsync(string vaultName, string archiveDescription, string filepath, UploadOptions options)
        {
        ...
        public void DownloadAsync(string vaultName, string archiveId, string filePath, DownloadOptions options)
        {
        ...
        /// <param name="options">Additional options that can be used for the download.</param>
        public void DownloadJobAsync(string vaultName, string jobId, string filePath, DownloadOptions options)
        {
        ...
        public string InitiateArchiveRetrievalJobAsync(string vaultName, string archiveId, InitiateArchiveRetrievalOptions options)
        { 
            ...
            var jobId = glacierClient.InitiateJobAsync(jobRequest).Result.JobId;
            return jobId;
        }
        #endregion
    }
