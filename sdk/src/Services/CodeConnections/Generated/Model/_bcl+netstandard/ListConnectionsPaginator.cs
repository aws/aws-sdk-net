...
namespace Amazon.CodeConnections.Model
{
    ...
    internal sealed partial class ListConnectionsPaginator : IPaginator<ListConnectionsResponse>, IListConnectionsPaginator
    {
        ...
        internal ListConnectionsPaginator(IAmazonCodeConnections client, ListConnectionsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListConnectionsResponse> IPaginator<ListConnectionsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
