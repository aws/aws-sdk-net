...
{
    /// <summary>
    /// Response Unmarshaller for CreateSyncConfiguration operation
    /// </summary>  
    public class CreateSyncConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSyncConfigurationResponse response = new CreateSyncConfigurationResponse();
        ...
        private static CreateSyncConfigurationResponseUnmarshaller _instance = new CreateSyncConfigurationResponseUnmarshaller();        

        internal static CreateSyncConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSyncConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
