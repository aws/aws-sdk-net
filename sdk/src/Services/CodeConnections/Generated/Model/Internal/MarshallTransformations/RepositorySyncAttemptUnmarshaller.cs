...
namespace Amazon.CodeConnections.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositorySyncAttemptUnmarshaller : IUnmarshaller<RepositorySyncAttempt, XmlUnmarshallerContext>, IUnmarshaller<RepositorySyncAttempt, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RepositorySyncAttempt IUnmarshaller<RepositorySyncAttempt, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RepositorySyncAttempt Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RepositorySyncEvent, RepositorySyncEventUnmarshaller>(RepositorySyncEventUnmarshaller.Instance);
