...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceSyncStatus operation
    /// </summary>  
    public class GetResourceSyncStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceSyncStatusResponse response = new GetResourceSyncStatusResponse();
        ...
        private static GetResourceSyncStatusResponseUnmarshaller _instance = new GetResourceSyncStatusResponseUnmarshaller();        

        internal static GetResourceSyncStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceSyncStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
