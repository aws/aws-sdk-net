...
{
    /// <summary>
    /// UpdateRepositoryLink Request Marshaller
    /// </summary>       
    public class UpdateRepositoryLinkRequestMarshaller : IMarshaller<IRequest, UpdateRepositoryLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRepositoryLinkRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRepositoryLinkRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeConnections");
            string target = "com.amazonaws.codeconnections.CodeConnections_20231201.UpdateRepositoryLink";
        ...
        private static UpdateRepositoryLinkRequestMarshaller _instance = new UpdateRepositoryLinkRequestMarshaller();        

        internal static UpdateRepositoryLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRepositoryLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
