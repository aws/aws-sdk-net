...
using Amazon.CodeConnections.Internal;
...
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("CodeConnections", "3.7.401.49");
=======
            InternalSDKUtils.BuildUserAgentString("CodeConnections", "3.7.401.67");
>>>>>>> 155cf7e693f514d013f0b7a90cc36b7db1c33d52
        ...
        /// Default constructor
        /// </summary>
        public AmazonCodeConnectionsConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonCodeConnectionsDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "CodeConnections";
            this.AuthenticationServiceName = "codeconnections";
            this.EndpointProvider = new AmazonCodeConnectionsEndpointProvider();
        }
