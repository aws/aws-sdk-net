...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCodeConnectionsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCodeConnectionsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCodeConnectionsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCodeConnectionsConfig to create AmazonCodeConnectionsClient");
            }

            return awsCredentials == null ? 
                    new AmazonCodeConnectionsClient(serviceClientConfig) :
                    new AmazonCodeConnectionsClient(awsCredentials, serviceClientConfig);
        }
