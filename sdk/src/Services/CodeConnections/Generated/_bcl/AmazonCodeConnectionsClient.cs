...
using Amazon.CodeConnections.Model.Internal.MarshallTransformations;
...
{
    /// <summary>
    /// <para>Implementation for accessing CodeConnections</para>
    ///
    /// AWS CodeConnections 
    /// <para>
    ...
    /// </para>
    /// </summary>
    public partial class AmazonCodeConnectionsClient : AmazonServiceClient, IAmazonCodeConnections
    {
        private static IServiceMetadata serviceMetadata = new AmazonCodeConnectionsMetadata();
        private ICodeConnectionsPaginatorFactory _paginators;

        /// <summary>
        /// Paginators for the service
        /// </summary>
        public ICodeConnectionsPaginatorFactory Paginators 
        {
            get 
            {
                if (this._paginators == null) 
                {
                    this._paginators = new CodeConnectionsPaginatorFactory(this);
                }
        ...
        public AmazonCodeConnectionsClient(AWSCredentials credentials)
            : this(credentials, new AmazonCodeConnectionsConfig())
        {
        }
        ...
        /// <param name="credentials">AWS Credentials</param>
        /// <param name="region">The region to connect.</param>
        public AmazonCodeConnectionsClient(AWSCredentials credentials, RegionEndpoint region)
            : this(credentials, new AmazonCodeConnectionsConfig{RegionEndpoint = region})
        {
        }

        /// <summary>
        /// Constructs AmazonCodeConnectionsClient with AWS Credentials and an
        /// AmazonCodeConnectionsClient Configuration object.
        /// </summary>
        /// <param name="credentials">AWS Credentials</param>
        /// <param name="clientConfig">The AmazonCodeConnectionsClient Configuration Object</param>
        public AmazonCodeConnectionsClient(AWSCredentials credentials, AmazonCodeConnectionsConfig clientConfig)
            : base(credentials, clientConfig)
        {
        }

        /// <summary>
        /// Constructs AmazonCodeConnectionsClient with AWS Access Key ID and AWS Secret Key
        /// </summary>
        /// <param name="awsAccessKeyId">AWS Access Key ID</param>
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        public AmazonCodeConnectionsClient(string awsAccessKeyId, string awsSecretAccessKey)
            : this(awsAccessKeyId, awsSecretAccessKey, new AmazonCodeConnectionsConfig())
        {
        }
        ...
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        /// <param name="region">The region to connect.</param>
        public AmazonCodeConnectionsClient(string awsAccessKeyId, string awsSecretAccessKey, RegionEndpoint region)
            : this(awsAccessKeyId, awsSecretAccessKey, new AmazonCodeConnectionsConfig() {RegionEndpoint=region})
        {
        }

        /// <summary>
        /// Constructs AmazonCodeConnectionsClient with AWS Access Key ID, AWS Secret Key and an
        /// AmazonCodeConnectionsClient Configuration object. 
        /// </summary>
        /// <param name="awsAccessKeyId">AWS Access Key ID</param>
        /// <param name="awsSecretAccessKey">AWS Secret Access Key</param>
        /// <param name="clientConfig">The AmazonCodeConnectionsClient Configuration Object</param>
        public AmazonCodeConnectionsClient(string awsAccessKeyId, string awsSecretAccessKey, AmazonCodeConnectionsConfig clientConfig)
        ...
        public AmazonCodeConnectionsClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken)
            : this(awsAccessKeyId, awsSecretAccessKey, awsSessionToken, new AmazonCodeConnectionsConfig())
        {
        }
        ...
        /// <param name="awsSessionToken">AWS Session Token</param>
        /// <param name="region">The region to connect.</param>
        public AmazonCodeConnectionsClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, RegionEndpoint region)
            : this(awsAccessKeyId, awsSecretAccessKey, awsSessionToken, new AmazonCodeConnectionsConfig{RegionEndpoint = region})
        {
        }
        ...
        /// <param name="awsSessionToken">AWS Session Token</param>
        /// <param name="clientConfig">The AmazonCodeConnectionsClient Configuration Object</param>
        public AmazonCodeConnectionsClient(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, AmazonCodeConnectionsConfig clientConfig)
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonCodeConnectionsEndpointResolver();
