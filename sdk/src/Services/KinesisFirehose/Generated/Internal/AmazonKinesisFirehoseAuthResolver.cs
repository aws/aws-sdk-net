...
namespace Amazon.KinesisFirehose.Internal
{
    ...
    public class AmazonKinesisFirehoseAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKinesisFirehoseAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for KinesisFirehose.
        /// </summary>
        public AmazonKinesisFirehoseAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKinesisFirehoseAuthSchemeParameters
            {
    ...
    public class AmazonKinesisFirehoseAuthSchemeResolver : IAuthSchemeResolver<AmazonKinesisFirehoseAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKinesisFirehoseAuthSchemeParameters authParameters)
        {
