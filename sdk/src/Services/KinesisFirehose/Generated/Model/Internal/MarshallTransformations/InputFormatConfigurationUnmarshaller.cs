...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    public class InputFormatConfigurationUnmarshaller : IUnmarshaller<InputFormatConfiguration, XmlUnmarshallerContext>, IUnmarshaller<InputFormatConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static InputFormatConfigurationUnmarshaller _instance = new InputFormatConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InputFormatConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
