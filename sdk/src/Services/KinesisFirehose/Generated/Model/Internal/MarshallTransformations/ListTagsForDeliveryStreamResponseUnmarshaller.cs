...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTagsForDeliveryStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTagsForDeliveryStreamResponse response = new ListTagsForDeliveryStreamResponse();
            ...
            {
                if (context.TestExpression("HasMoreTags", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.HasMoreTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListTagsForDeliveryStreamResponseUnmarshaller _instance = new ListTagsForDeliveryStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTagsForDeliveryStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
