...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AmazonOpenSearchServerlessDestinationDescriptionUnmarshaller : IJsonUnmarshaller<AmazonOpenSearchServerlessDestinationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AmazonOpenSearchServerlessDestinationDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CollectionEndpoint", targetDepth, ref reader))
                {
