...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    public class GetKinesisStreamRequestMarshaller : IMarshaller<IRequest, GetKinesisStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static GetKinesisStreamRequestMarshaller _instance = new GetKinesisStreamRequestMarshaller();        

        internal static GetKinesisStreamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKinesisStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
