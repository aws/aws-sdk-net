...
namespace Amazon.Braket
{
    ...
    public partial class AmazonBraketClient : AmazonServiceClient, IAmazonBraket
    {
        ...
        /// 
        /// </summary>
        public AmazonBraketClient() : base(new AmazonBraketConfig()) { }
        ...
        public AmazonBraketClient(RegionEndpoint region) : base(new AmazonBraketConfig { RegionEndpoint = region }) { }
        ...
        public AmazonBraketClient(AmazonBraketConfig config) : base(config) { }
