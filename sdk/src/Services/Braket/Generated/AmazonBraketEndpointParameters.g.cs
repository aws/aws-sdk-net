...
namespace Amazon.Braket.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving Braket endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonBraketEndpointProvider"/> and <see cref="AmazonBraketEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class BraketEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// BraketEndpointParameters constructor
        /// </summary>
        public BraketEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
