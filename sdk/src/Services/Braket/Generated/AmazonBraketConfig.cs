...
namespace Amazon.Braket
{
    ...
    public partial class AmazonBraketConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Braket", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Braket";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "braket";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-09-01";
