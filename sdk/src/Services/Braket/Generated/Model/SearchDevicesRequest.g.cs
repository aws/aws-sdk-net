...
{
    /// <summary>
    /// Container for the parameters to the SearchDevices operation. Searches for devices
    ...
    public partial class SearchDevicesRequest : AmazonBraketRequest
    {
        ...
        public List<SearchDevicesFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<SearchDevicesFilter>() : null;
