...
namespace Amazon.Braket.Model
{
    ...
    public partial class SearchSpendingLimitsResponse : AmazonWebServiceResponse
    {
        ...
        public List<SpendingLimitSummary> SpendingLimits { get; set; } = AWSConfigs.InitializeCollections ? new List<SpendingLimitSummary>() : null;

        /// <summary>
        /// Checks to see if the SpendingLimits property is set.
        /// </summary>
        internal bool IsSetSpendingLimits() => this.SpendingLimits != null && (this.SpendingLimits.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
