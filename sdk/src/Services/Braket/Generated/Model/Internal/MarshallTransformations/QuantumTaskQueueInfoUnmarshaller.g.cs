...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class QuantumTaskQueueInfoUnmarshaller : IJsonUnmarshaller<QuantumTaskQueueInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new QuantumTaskQueueInfo();
        ...
        /// Gets the singleton.
        /// </summary>
        public static QuantumTaskQueueInfoUnmarshaller Instance => _instance;
    }
}
