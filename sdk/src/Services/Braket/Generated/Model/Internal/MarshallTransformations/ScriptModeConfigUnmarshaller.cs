...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScriptModeConfigUnmarshaller : IUnmarshaller<ScriptModeConfig, XmlUnmarshallerContext>, IUnmarshaller<ScriptModeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ScriptModeConfig IUnmarshaller<ScriptModeConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
