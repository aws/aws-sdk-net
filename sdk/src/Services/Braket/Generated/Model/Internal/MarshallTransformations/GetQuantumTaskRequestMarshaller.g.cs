...
{
    /// <summary>
    /// GetQuantumTask Request Marshaller
    /// </summary>
    public partial class GetQuantumTaskRequestMarshaller : IMarshaller<IRequest, GetQuantumTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetQuantumTaskRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetQuantumTaskRequest publicRequest)
        {
        ...
        private static readonly GetQuantumTaskRequestMarshaller _instance = new();

        internal static GetQuantumTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetQuantumTaskRequestMarshaller Instance => _instance;
    }
}
