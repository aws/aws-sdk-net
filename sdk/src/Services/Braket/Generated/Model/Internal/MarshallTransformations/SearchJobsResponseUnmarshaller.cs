    ...
    public class SearchJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<JobSummary, JobSummaryUnmarshaller>(JobSummaryUnmarshaller.Instance);
        ...
        private static SearchJobsResponseUnmarshaller _instance = new SearchJobsResponseUnmarshaller();        

        internal static SearchJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
