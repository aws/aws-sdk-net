...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetQuantumTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetQuantumTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("actionMetadata", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ActionMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DeviceParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("experimentalCapabilities", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ExperimentalCapabilities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("numSuccessfulShots", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.NumSuccessfulShots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetQuantumTaskResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetQuantumTaskResponseUnmarshaller Instance => _instance;
    }
}
