...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSpendingLimitRequestMarshaller : IMarshaller<IRequest, DeleteSpendingLimitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteSpendingLimitRequestMarshaller _instance = new DeleteSpendingLimitRequestMarshaller();        

        internal static DeleteSpendingLimitRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSpendingLimitRequestMarshaller Instance
        {
            get
            {
                return _instance;
