...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSpendingLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("spendingLimitArn", targetDepth))
                {
                    ...
                    response.SpendingLimitArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateSpendingLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSpendingLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
