...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InputFileConfigUnmarshaller : IJsonUnmarshaller<InputFileConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InputFileConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static InputFileConfigUnmarshaller Instance => _instance;
    }
}
