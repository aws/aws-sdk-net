...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DeviceCapabilities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("deviceQueueInfo", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DeviceQueueInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetDeviceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeviceResponseUnmarshaller Instance => _instance;
    }
}
