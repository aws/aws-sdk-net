...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSpendingLimitRequestMarshaller : IMarshaller<IRequest, UpdateSpendingLimitRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateSpendingLimitRequestMarshaller _instance = new();

        internal static UpdateSpendingLimitRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSpendingLimitRequestMarshaller Instance => _instance;
    }
}
