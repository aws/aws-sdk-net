...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScriptModeConfigUnmarshaller : IJsonUnmarshaller<ScriptModeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ScriptModeConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScriptModeConfigUnmarshaller Instance => _instance;
    }
}
