...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchSpendingLimitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchSpendingLimitsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("spendingLimits", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SpendingLimits = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static SearchSpendingLimitsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchSpendingLimitsResponseUnmarshaller Instance => _instance;
    }
}
