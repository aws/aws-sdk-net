...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DataSourceUnmarshaller : IJsonUnmarshaller<DataSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DataSource();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DataSourceUnmarshaller Instance => _instance;
    }
}
