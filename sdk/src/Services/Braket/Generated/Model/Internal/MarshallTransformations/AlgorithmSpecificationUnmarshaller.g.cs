...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AlgorithmSpecificationUnmarshaller : IJsonUnmarshaller<AlgorithmSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AlgorithmSpecification();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AlgorithmSpecificationUnmarshaller Instance => _instance;
    }
}
