...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateQuantumTaskRequestMarshaller : IMarshaller<IRequest, CreateQuantumTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateQuantumTaskRequestMarshaller _instance = new();

        internal static CreateQuantumTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateQuantumTaskRequestMarshaller Instance => _instance;
    }
}
