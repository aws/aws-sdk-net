...
{
    /// <summary>
    /// CreateSpendingLimit Request Marshaller
    /// </summary>
    public partial class CreateSpendingLimitRequestMarshaller : IMarshaller<IRequest, CreateSpendingLimitRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSpendingLimitRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateSpendingLimitRequest publicRequest)
        {
            ...
            request.ResourcePath = "/spending-limit";
#if !NETFRAMEWORK
        ...
        private static readonly CreateSpendingLimitRequestMarshaller _instance = new();

        internal static CreateSpendingLimitRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSpendingLimitRequestMarshaller Instance => _instance;
    }
}
