...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociationUnmarshaller : IJsonUnmarshaller<Association, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Association();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssociationUnmarshaller Instance => _instance;
    }
}
