...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CancelQuantumTaskRequestMarshaller : IMarshaller<IRequest, CancelQuantumTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CancelQuantumTaskRequestMarshaller _instance = new();

        internal static CancelQuantumTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelQuantumTaskRequestMarshaller Instance => _instance;
    }
}
