...
namespace Amazon.Braket.Model
{
    ...
    public partial class ValidationException : AmazonBraketException
    {
        ...
        /// </summary>
        public List<ProgramSetValidationFailure> ProgramSetValidationFailures { get; set; } = AWSConfigs.InitializeCollections ? new List<ProgramSetValidationFailure>() : null;

        /// <summary>
        /// Checks to see if the ProgramSetValidationFailures property is set.
        /// </summary>
        internal bool IsSetProgramSetValidationFailures() => this.ProgramSetValidationFailures != null && (this.ProgramSetValidationFailures.Count > 0 || !AWSConfigs.InitializeCollections);
