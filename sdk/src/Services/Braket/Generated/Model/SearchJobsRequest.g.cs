...
{
    /// <summary>
    /// Container for the parameters to the SearchJobs operation. Searches for Amazon Braket
    /// hybrid jobs that match the specified filter values.
    /// </summary>
    public partial class SearchJobsRequest : AmazonBraketRequest
    {
        ...
        public List<SearchJobsFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<SearchJobsFilter>() : null;
