...
{
    /// <summary>
    /// Container for the parameters to the SearchSpendingLimits operation.
    ...
    {
        private List<SearchSpendingLimitsFilter> _filters = AWSConfigs.InitializeCollections ? new List<SearchSpendingLimitsFilter>() : null;
        ...
        public List<SearchSpendingLimitsFilter> Filters
        {
