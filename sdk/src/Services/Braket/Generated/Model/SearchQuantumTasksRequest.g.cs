...
{
    /// <summary>
    /// Container for the parameters to the SearchQuantumTasks operation. Searches for tasks
    ...
    public partial class SearchQuantumTasksRequest : AmazonBraketRequest
    {
        ...
        public List<SearchQuantumTasksFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<SearchQuantumTasksFilter>() : null;
