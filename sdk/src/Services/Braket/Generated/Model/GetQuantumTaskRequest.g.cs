...
{
    /// <summary>
    /// Container for the parameters to the GetQuantumTask operation. Retrieves the specified
    /// quantum task.
    /// </summary>
    public partial class GetQuantumTaskRequest : AmazonBraketRequest
    {
        ...
        /// </summary>
        public List<string> AdditionalAttributeNames { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AdditionalAttributeNames property is set.
        /// </summary>
        internal bool IsSetAdditionalAttributeNames() => this.AdditionalAttributeNames != null && (this.AdditionalAttributeNames.Count > 0 || !AWSConfigs.InitializeCollections);
