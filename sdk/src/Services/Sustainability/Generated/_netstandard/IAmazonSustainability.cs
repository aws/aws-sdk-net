...
namespace Amazon.Sustainability
{
    ...
    public partial interface IAmazonSustainability : IAmazonService, IDisposable
    {
        ...
        Task<GetEstimatedWaterAllocationResponse> GetEstimatedWaterAllocationAsync(GetEstimatedWaterAllocationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetEstimatedWaterAllocationDimensionValuesResponse> GetEstimatedWaterAllocationDimensionValuesAsync(GetEstimatedWaterAllocationDimensionValuesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
