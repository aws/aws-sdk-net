...
namespace Amazon.Sustainability.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Sustainability service requests.
    /// Collects values for SustainabilityEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SustainabilityEndpointProvider.
