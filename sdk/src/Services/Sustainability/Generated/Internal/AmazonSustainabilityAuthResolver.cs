...
namespace Amazon.Sustainability.Internal
{
    ...
    public class AmazonSustainabilityAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSustainabilityAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Sustainability.
        /// </summary>
        public AmazonSustainabilityAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSustainabilityAuthSchemeParameters
            {
    ...
    public class AmazonSustainabilityAuthSchemeResolver : IAuthSchemeResolver<AmazonSustainabilityAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSustainabilityAuthSchemeParameters authParameters)
        {
