...
namespace Amazon.Sustainability
{
    ...
    public partial class AmazonSustainabilityClient : AmazonServiceClient, IAmazonSustainability
    {
        ...
        public virtual GetEstimatedWaterAllocationResponse GetEstimatedWaterAllocation(GetEstimatedWaterAllocationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual GetEstimatedWaterAllocationDimensionValuesResponse GetEstimatedWaterAllocationDimensionValues(GetEstimatedWaterAllocationDimensionValuesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
