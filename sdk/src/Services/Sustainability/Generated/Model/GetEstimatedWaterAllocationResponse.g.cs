...
{
    /// <summary>
    /// This is the response object from the GetEstimatedWaterAllocation operation.
    /// </summary>
    public partial class GetEstimatedWaterAllocationResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        public List<EstimatedWaterAllocation> Results { get; set; } = AWSConfigs.InitializeCollections ? new List<EstimatedWaterAllocation>() : null;
