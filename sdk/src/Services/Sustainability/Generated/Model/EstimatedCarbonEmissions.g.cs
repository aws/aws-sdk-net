...
namespace Amazon.Sustainability.Model
{
    ...
    public partial class EstimatedCarbonEmissions
    {
        ...
        public Dictionary<string, string> DimensionsValues { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the DimensionsValues property is set.
        /// </summary>
        internal bool IsSetDimensionsValues() => this.DimensionsValues != null && (this.DimensionsValues.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public Dictionary<string, Emissions> EmissionsValues { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, Emissions>() : null;

        /// <summary>
        /// Checks to see if the EmissionsValues property is set.
        /// </summary>
        internal bool IsSetEmissionsValues() => this.EmissionsValues != null && (this.EmissionsValues.Count > 0 || !AWSConfigs.InitializeCollections);
