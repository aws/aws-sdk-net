...
{
    /// <summary>
    /// Container for the parameters to the GetEstimatedWaterAllocation operation. Returns
    /// estimated water allocation values based on customer grouping and filtering parameters.
    ...
    public partial class GetEstimatedWaterAllocationRequest : AmazonSustainabilityRequest
    {
        ...
        /// </summary>
        public List<string> AllocationTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AllocationTypes property is set.
        /// </summary>
        internal bool IsSetAllocationTypes() => this.AllocationTypes != null && (this.AllocationTypes.Count > 0 || !AWSConfigs.InitializeCollections);
