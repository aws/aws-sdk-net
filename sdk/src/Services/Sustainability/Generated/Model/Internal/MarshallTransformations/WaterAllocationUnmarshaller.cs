...
namespace Amazon.Sustainability.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WaterAllocationUnmarshaller : IJsonUnmarshaller<WaterAllocation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            WaterAllocation unmarshalledObject = new WaterAllocation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static WaterAllocationUnmarshaller Instance
        {
            get
            {
                return _instance;
