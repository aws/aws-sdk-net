...
namespace Amazon.Sustainability.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EstimatedCarbonEmissionsUnmarshaller : IJsonUnmarshaller<EstimatedCarbonEmissions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EstimatedCarbonEmissions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EstimatedCarbonEmissionsUnmarshaller Instance => _instance;
    }
}
