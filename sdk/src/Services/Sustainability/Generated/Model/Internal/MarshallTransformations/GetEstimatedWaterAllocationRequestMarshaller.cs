...
namespace Amazon.Sustainability.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetEstimatedWaterAllocationRequestMarshaller : IMarshaller<IRequest, GetEstimatedWaterAllocationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetEstimatedWaterAllocationRequestMarshaller _instance = new GetEstimatedWaterAllocationRequestMarshaller();        

        internal static GetEstimatedWaterAllocationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEstimatedWaterAllocationRequestMarshaller Instance
        {
            get
            {
                return _instance;
