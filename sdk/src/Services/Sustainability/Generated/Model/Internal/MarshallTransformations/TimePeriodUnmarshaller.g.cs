...
namespace Amazon.Sustainability.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TimePeriodUnmarshaller : IJsonUnmarshaller<TimePeriod, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TimePeriod();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TimePeriodUnmarshaller Instance => _instance;
    }
}
