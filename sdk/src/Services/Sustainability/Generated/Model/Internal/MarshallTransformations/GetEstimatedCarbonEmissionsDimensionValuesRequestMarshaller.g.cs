...
namespace Amazon.Sustainability.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEstimatedCarbonEmissionsDimensionValuesRequestMarshaller : IMarshaller<IRequest, GetEstimatedCarbonEmissionsDimensionValuesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetEstimatedCarbonEmissionsDimensionValuesRequestMarshaller _instance = new();

        internal static GetEstimatedCarbonEmissionsDimensionValuesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEstimatedCarbonEmissionsDimensionValuesRequestMarshaller Instance => _instance;
    }
}
