...
namespace Amazon.Sustainability.Model
{
    ...
    public partial class GetEstimatedWaterAllocationResponse : AmazonWebServiceResponse
    {
        ...
        private List<EstimatedWaterAllocation> _results = AWSConfigs.InitializeCollections ? new List<EstimatedWaterAllocation>() : null;
        ...
        public List<EstimatedWaterAllocation> Results
        {
