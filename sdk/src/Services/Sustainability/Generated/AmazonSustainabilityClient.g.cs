...
namespace Amazon.Sustainability
{
    ...
    public partial class AmazonSustainabilityClient : AmazonServiceClient, IAmazonSustainability
    {
        ...
        /// 
        /// </summary>
        public AmazonSustainabilityClient() : base(new AmazonSustainabilityConfig()) { }
        ...
        public AmazonSustainabilityClient(RegionEndpoint region) : base(new AmazonSustainabilityConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSustainabilityClient(AmazonSustainabilityConfig config) : base(config) { }
