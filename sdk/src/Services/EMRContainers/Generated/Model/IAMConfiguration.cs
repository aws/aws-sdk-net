...
namespace Amazon.EMRContainers.Model
{
    ...
    public partial class IAMConfiguration
    {
        ...
        {
            get { return this._systemRole; }
            set { this._systemRole = value; }
        }

        // Check to see if SystemRole property is set
        internal bool IsSetSystemRole()
        {
            return this._systemRole != null;
        }
