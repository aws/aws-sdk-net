        ...
        public LakeFormationConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("authorizedSessionTagValue", targetDepth))
                {
                    ...
                    unmarshalledObject.AuthorizedSessionTagValue = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("queryEngineRoleArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QueryEngineRoleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("secureNamespaceInfo", targetDepth))
                {
                    var unmarshaller = SecureNamespaceInfoUnmarshaller.Instance;
                    unmarshalledObject.SecureNamespaceInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
