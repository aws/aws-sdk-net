...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LakeFormationConfigurationUnmarshaller : IJsonUnmarshaller<LakeFormationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LakeFormationConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
