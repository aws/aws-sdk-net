...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParametricS3MonitoringConfigurationUnmarshaller : IJsonUnmarshaller<ParametricS3MonitoringConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ParametricS3MonitoringConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
