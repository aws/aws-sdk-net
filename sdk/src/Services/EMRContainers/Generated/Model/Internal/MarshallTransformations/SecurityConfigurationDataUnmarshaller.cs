...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecurityConfigurationDataUnmarshaller : IUnmarshaller<SecurityConfigurationData, XmlUnmarshallerContext>, IUnmarshaller<SecurityConfigurationData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SecurityConfigurationData IUnmarshaller<SecurityConfigurationData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SecurityConfigurationData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("authorizationConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.AuthorizationConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
