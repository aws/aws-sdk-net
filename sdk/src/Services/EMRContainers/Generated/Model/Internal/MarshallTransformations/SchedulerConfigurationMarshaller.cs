    ...
    public class SchedulerConfigurationMarshaller : IRequestMarshaller<SchedulerConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(SchedulerConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetMaxConcurrentJobRuns())
            {
                context.Writer.WritePropertyName("maxConcurrentJobRuns");
                context.Writer.WriteNumberValue(requestObject.MaxConcurrentJobRuns.Value);
            }

            if(requestObject.IsSetMaxInQueueJobRuns())
            {
                context.Writer.WritePropertyName("maxInQueueJobRuns");
                context.Writer.WriteNumberValue(requestObject.MaxInQueueJobRuns.Value);
            }
