...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContainerInfoUnmarshaller : IJsonUnmarshaller<ContainerInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("eksInfo", targetDepth, ref reader))
                {
                    var unmarshaller = EksInfoUnmarshaller.Instance;
                    unmarshalledObject.EksInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
