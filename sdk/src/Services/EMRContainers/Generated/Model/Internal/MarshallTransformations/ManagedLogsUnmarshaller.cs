...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ManagedLogsUnmarshaller : IJsonUnmarshaller<ManagedLogs, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ManagedLogs Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("allowAWSToRetainLogs", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AllowAWSToRetainLogs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
