...
{
    /// <summary>
    /// DescribeManagedEndpoint Request Marshaller
    /// </summary>       
    public class DescribeManagedEndpointRequestMarshaller : IMarshaller<IRequest, DescribeManagedEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeManagedEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeManagedEndpointRequest publicRequest)
        {
        ...
        private static DescribeManagedEndpointRequestMarshaller _instance = new DescribeManagedEndpointRequestMarshaller();        

        internal static DescribeManagedEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeManagedEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
