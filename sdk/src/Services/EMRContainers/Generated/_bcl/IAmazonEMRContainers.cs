...
namespace Amazon.EMRContainers
{
    ...
    public partial interface IAmazonEMRContainers : IAmazonService, IDisposable
    {
        ...
        UpdateVirtualClusterResponse UpdateVirtualCluster(UpdateVirtualClusterRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/emr-containers-2020-10-01/UpdateVirtualCluster">REST API Reference for UpdateVirtualCluster Operation</seealso>
        Task<UpdateVirtualClusterResponse> UpdateVirtualClusterAsync(UpdateVirtualClusterRequest request, CancellationToken cancellationToken = default(CancellationToken));
