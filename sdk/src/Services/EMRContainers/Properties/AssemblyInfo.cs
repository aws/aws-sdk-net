...
#if NET472
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Framework 4.7.2) - Amazon EMR Containers. This release adds support for Amazon EMR on EKS, a simple way to run Spark on Kubernetes.")]
