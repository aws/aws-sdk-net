...
{
    /// <summary>
    /// Response Unmarshaller for DescribeManagedJobTemplate operation
    /// </summary>  
    public class DescribeManagedJobTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeManagedJobTemplateResponse response = new DescribeManagedJobTemplateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("documentParameters", targetDepth, ref reader))
                {
                    ...
                    response.DocumentParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TemplateVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeManagedJobTemplateResponseUnmarshaller _instance = new DescribeManagedJobTemplateResponseUnmarshaller();        

        internal static DescribeManagedJobTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeManagedJobTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
