...
{
    /// <summary>
    /// UpdateRoleAlias Request Marshaller
    /// </summary>       
    public class UpdateRoleAliasRequestMarshaller : IMarshaller<IRequest, UpdateRoleAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRoleAliasRequest)input);
        }
        ...
        public IRequest Marshall(UpdateRoleAliasRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCredentialDurationSeconds())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.CredentialDurationSeconds.Value);
            }
