...
{
    /// <summary>
    /// Response Unmarshaller for ListV2LoggingLevels operation
    /// </summary>  
    public class ListV2LoggingLevelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListV2LoggingLevelsResponse response = new ListV2LoggingLevelsResponse();
            ...
            {
                if (context.TestExpression("logTargetConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LogTargetConfiguration, LogTargetConfigurationUnmarshaller>(LogTargetConfigurationUnmarshaller.Instance);
                    response.LogTargetConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return NotConfiguredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ListV2LoggingLevelsResponseUnmarshaller _instance = new ListV2LoggingLevelsResponseUnmarshaller();        

        internal static ListV2LoggingLevelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListV2LoggingLevelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
