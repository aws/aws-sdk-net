    ...
    public class ListOutgoingCertificatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<OutgoingCertificate, OutgoingCertificateUnmarshaller>(OutgoingCertificateUnmarshaller.Instance);
                    response.OutgoingCertificates = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
