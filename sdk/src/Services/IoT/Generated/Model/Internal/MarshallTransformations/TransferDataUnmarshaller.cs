...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransferDataUnmarshaller : IUnmarshaller<TransferData, XmlUnmarshallerContext>, IUnmarshaller<TransferData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TransferData IUnmarshaller<TransferData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TransferData Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("acceptDate", targetDepth))
                {
                    ...
                    unmarshalledObject.AcceptDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("rejectDate", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.RejectDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("rejectReason", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RejectReason = unmarshaller.Unmarshall(context);
                    continue;
                }
