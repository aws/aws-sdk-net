...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRoleAlias operation
    /// </summary>  
    public class DescribeRoleAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRoleAliasResponse response = new DescribeRoleAliasResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("roleAliasDescription", targetDepth))
                {
                    ...
                    response.RoleAliasDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeRoleAliasResponseUnmarshaller _instance = new DescribeRoleAliasResponseUnmarshaller();        

        internal static DescribeRoleAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRoleAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
