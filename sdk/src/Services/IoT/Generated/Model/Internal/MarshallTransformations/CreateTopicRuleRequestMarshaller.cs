...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateTopicRuleRequestMarshaller : IMarshaller<IRequest, CreateTopicRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTopicRuleRequest)input);
        }
        ...
        private static CreateTopicRuleRequestMarshaller _instance = new CreateTopicRuleRequestMarshaller();        

        internal static CreateTopicRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTopicRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
