...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListPrincipalPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPrincipalPoliciesResponse response = new ListPrincipalPoliciesResponse();
        ...
        private static ListPrincipalPoliciesResponseUnmarshaller _instance = new ListPrincipalPoliciesResponseUnmarshaller();        

        internal static ListPrincipalPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPrincipalPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
