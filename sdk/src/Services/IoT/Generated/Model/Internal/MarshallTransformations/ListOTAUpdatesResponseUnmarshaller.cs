    ...
    public class ListOTAUpdatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<OTAUpdateSummary, OTAUpdateSummaryUnmarshaller>(OTAUpdateSummaryUnmarshaller.Instance);
                    response.OtaUpdates = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
