    ...
    public class OTAUpdateFileUnmarshaller : IJsonUnmarshaller<OTAUpdateFile, JsonUnmarshallerContext>
    {
        ...
        public OTAUpdateFile Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("codeSigning", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("fileLocation", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("fileVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
