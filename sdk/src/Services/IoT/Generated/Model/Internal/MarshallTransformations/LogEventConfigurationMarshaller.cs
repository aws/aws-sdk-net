...
{
    /// <summary>
    /// LogEventConfiguration Marshaller
    /// </summary>
    public class LogEventConfigurationMarshaller : IRequestMarshaller<LogEventConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(LogEventConfiguration requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static LogEventConfigurationMarshaller Instance = new LogEventConfigurationMarshaller();
