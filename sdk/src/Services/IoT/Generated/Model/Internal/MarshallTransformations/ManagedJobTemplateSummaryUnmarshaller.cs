...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ManagedJobTemplateSummaryUnmarshaller : IUnmarshaller<ManagedJobTemplateSummary, XmlUnmarshallerContext>, IUnmarshaller<ManagedJobTemplateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ManagedJobTemplateSummary IUnmarshaller<ManagedJobTemplateSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ManagedJobTemplateSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
