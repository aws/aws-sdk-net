    ...
    public class DescribeScheduledAuditResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Frequency = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scheduledAuditArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScheduledAuditArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("targetCheckNames", targetDepth))
                {
                    ...
                    response.TargetCheckNames = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
