...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFleetMetric operation
    /// </summary>  
    public class DeleteFleetMetricResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFleetMetricResponse response = new DeleteFleetMetricResponse();
        ...
        private static DeleteFleetMetricResponseUnmarshaller _instance = new DeleteFleetMetricResponseUnmarshaller();        

        internal static DeleteFleetMetricResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFleetMetricResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
