...
{
    /// <summary>
    /// ListCertificatesByCA Request Marshaller
    /// </summary>       
    public class ListCertificatesByCARequestMarshaller : IMarshaller<IRequest, ListCertificatesByCARequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCertificatesByCARequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCertificatesByCARequest publicRequest)
        {
            ...
            uriResourcePath = uriResourcePath.Replace("{caCertificateId}", StringUtils.FromStringWithSlashEncoding(publicRequest.CaCertificateId));
