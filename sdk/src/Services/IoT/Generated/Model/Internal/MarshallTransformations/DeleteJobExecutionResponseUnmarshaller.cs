...
{
    /// <summary>
    /// Response Unmarshaller for DeleteJobExecution operation
    /// </summary>  
    public class DeleteJobExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteJobExecutionResponse response = new DeleteJobExecutionResponse();
        ...
        private static DeleteJobExecutionResponseUnmarshaller _instance = new DeleteJobExecutionResponseUnmarshaller();        

        internal static DeleteJobExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteJobExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
