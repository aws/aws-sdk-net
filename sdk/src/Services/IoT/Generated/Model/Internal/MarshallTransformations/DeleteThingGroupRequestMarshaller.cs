...
{
    /// <summary>
    /// DeleteThingGroup Request Marshaller
    /// </summary>       
    public class DeleteThingGroupRequestMarshaller : IMarshaller<IRequest, DeleteThingGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteThingGroupRequest)input);
        }
        ...
        private static DeleteThingGroupRequestMarshaller _instance = new DeleteThingGroupRequestMarshaller();        

        internal static DeleteThingGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThingGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
