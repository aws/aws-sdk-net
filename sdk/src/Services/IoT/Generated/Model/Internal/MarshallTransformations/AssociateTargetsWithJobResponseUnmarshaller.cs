...
{
    /// <summary>
    /// Response Unmarshaller for AssociateTargetsWithJob operation
    /// </summary>  
    public class AssociateTargetsWithJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateTargetsWithJobResponse response = new AssociateTargetsWithJobResponse();
        ...
        private static AssociateTargetsWithJobResponseUnmarshaller _instance = new AssociateTargetsWithJobResponseUnmarshaller();        

        internal static AssociateTargetsWithJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateTargetsWithJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
