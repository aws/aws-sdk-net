...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodeSigningCertificateChainUnmarshaller : IJsonUnmarshaller<CodeSigningCertificateChain, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CodeSigningCertificateChain Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InlineDocument = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
