    ...
    public class ListAuthorizersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AuthorizerSummary, AuthorizerSummaryUnmarshaller>(AuthorizerSummaryUnmarshaller.Instance);
                    response.Authorizers = unmarshaller.Unmarshall(context);
                    continue;
                }
