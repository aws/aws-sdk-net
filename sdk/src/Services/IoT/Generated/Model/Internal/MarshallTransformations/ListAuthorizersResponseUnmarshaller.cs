...
{
    /// <summary>
    /// Response Unmarshaller for ListAuthorizers operation
    /// </summary>  
    public class ListAuthorizersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAuthorizersResponse response = new ListAuthorizersResponse();
            ...
            {
                if (context.TestExpression("authorizers", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AuthorizerSummary, AuthorizerSummaryUnmarshaller>(AuthorizerSummaryUnmarshaller.Instance);
                    response.Authorizers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAuthorizersResponseUnmarshaller _instance = new ListAuthorizersResponseUnmarshaller();        

        internal static ListAuthorizersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAuthorizersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
