...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    public class LogTargetMarshaller : IRequestMarshaller<LogTarget, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(LogTarget requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetTargetName())
            {
                context.Writer.WritePropertyName("targetName");
                context.Writer.WriteStringValue(requestObject.TargetName);
            }
