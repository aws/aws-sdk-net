...
{
    /// <summary>
    /// Response Unmarshaller for GetOTAUpdate operation
    /// </summary>  
    public class GetOTAUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOTAUpdateResponse response = new GetOTAUpdateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("otaUpdateInfo", targetDepth))
                {
                    ...
                    response.OtaUpdateInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetOTAUpdateResponseUnmarshaller _instance = new GetOTAUpdateResponseUnmarshaller();        

        internal static GetOTAUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOTAUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
