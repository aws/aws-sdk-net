...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTopicRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTopicRuleResponse response = new CreateTopicRuleResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new ConflictingResourceUpdateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("SqlParseException"))
            {
                return new SqlParseException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static CreateTopicRuleResponseUnmarshaller _instance = new CreateTopicRuleResponseUnmarshaller();        

        internal static CreateTopicRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTopicRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
