...
{
    /// <summary>
    /// CreateFleetMetric Request Marshaller
    /// </summary>       
    public class CreateFleetMetricRequestMarshaller : IMarshaller<IRequest, CreateFleetMetricRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateFleetMetricRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateFleetMetricRequest publicRequest)
        {
        ...
        private static CreateFleetMetricRequestMarshaller _instance = new CreateFleetMetricRequestMarshaller();        

        internal static CreateFleetMetricRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFleetMetricRequestMarshaller Instance
        {
            get
            {
                return _instance;
