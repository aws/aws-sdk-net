...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeletePolicyVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePolicyVersionResponse response = new DeletePolicyVersionResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return DeleteConflictExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeletePolicyVersionResponseUnmarshaller _instance = new DeletePolicyVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePolicyVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
