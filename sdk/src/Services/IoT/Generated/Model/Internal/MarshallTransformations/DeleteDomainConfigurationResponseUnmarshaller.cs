...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDomainConfiguration operation
    /// </summary>  
    public class DeleteDomainConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDomainConfigurationResponse response = new DeleteDomainConfigurationResponse();
        ...
        private static DeleteDomainConfigurationResponseUnmarshaller _instance = new DeleteDomainConfigurationResponseUnmarshaller();        

        internal static DeleteDomainConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDomainConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
