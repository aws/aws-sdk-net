...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    public class ViolationEventAdditionalInfoUnmarshaller : IJsonUnmarshaller<ViolationEventAdditionalInfo, JsonUnmarshallerContext>
    {
        ...
        private static ViolationEventAdditionalInfoUnmarshaller _instance = new ViolationEventAdditionalInfoUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ViolationEventAdditionalInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
