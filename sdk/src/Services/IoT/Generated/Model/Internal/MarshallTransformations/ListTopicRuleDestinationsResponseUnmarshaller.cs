...
{
    /// <summary>
    /// Response Unmarshaller for ListTopicRuleDestinations operation
    /// </summary>  
    public class ListTopicRuleDestinationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("destinationSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TopicRuleDestinationSummary, TopicRuleDestinationSummaryUnmarshaller>(TopicRuleDestinationSummaryUnmarshaller.Instance);
                    response.DestinationSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListTopicRuleDestinationsResponseUnmarshaller _instance = new ListTopicRuleDestinationsResponseUnmarshaller();        

        internal static ListTopicRuleDestinationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTopicRuleDestinationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
