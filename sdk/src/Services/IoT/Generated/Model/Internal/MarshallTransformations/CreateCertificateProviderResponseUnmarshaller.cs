...
{
    /// <summary>
    /// Response Unmarshaller for CreateCertificateProvider operation
    /// </summary>  
    public class CreateCertificateProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCertificateProviderResponse response = new CreateCertificateProviderResponse();
            ...
            {
                if (context.TestExpression("certificateProviderArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CertificateProviderArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("certificateProviderName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static CreateCertificateProviderResponseUnmarshaller _instance = new CreateCertificateProviderResponseUnmarshaller();        

        internal static CreateCertificateProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCertificateProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
