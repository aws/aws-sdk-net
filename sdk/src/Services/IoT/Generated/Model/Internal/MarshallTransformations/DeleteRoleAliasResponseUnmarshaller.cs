...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRoleAlias operation
    /// </summary>  
    public class DeleteRoleAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRoleAliasResponse response = new DeleteRoleAliasResponse();
        ...
        private static DeleteRoleAliasResponseUnmarshaller _instance = new DeleteRoleAliasResponseUnmarshaller();        

        internal static DeleteRoleAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoleAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
