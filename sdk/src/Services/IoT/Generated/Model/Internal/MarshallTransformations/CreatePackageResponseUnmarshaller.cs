...
{
    /// <summary>
    /// Response Unmarshaller for CreatePackage operation
    /// </summary>  
    public class CreatePackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("packageArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PackageArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreatePackageResponseUnmarshaller _instance = new CreatePackageResponseUnmarshaller();        

        internal static CreatePackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
