...
{
    /// <summary>
    /// DeletePackageVersion Request Marshaller
    /// </summary>       
    public class DeletePackageVersionRequestMarshaller : IMarshaller<IRequest, DeletePackageVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePackageVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePackageVersionRequest publicRequest)
        {
        ...
        private static DeletePackageVersionRequestMarshaller _instance = new DeletePackageVersionRequestMarshaller();        

        internal static DeletePackageVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePackageVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
