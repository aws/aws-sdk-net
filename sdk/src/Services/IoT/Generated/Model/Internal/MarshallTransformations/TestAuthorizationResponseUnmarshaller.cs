...
{
    /// <summary>
    /// Response Unmarshaller for TestAuthorization operation
    /// </summary>  
    public class TestAuthorizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestAuthorizationResponse response = new TestAuthorizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AuthResult, AuthResultUnmarshaller>(AuthResultUnmarshaller.Instance);
                    response.AuthResults = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static TestAuthorizationResponseUnmarshaller _instance = new TestAuthorizationResponseUnmarshaller();        

        internal static TestAuthorizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestAuthorizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
