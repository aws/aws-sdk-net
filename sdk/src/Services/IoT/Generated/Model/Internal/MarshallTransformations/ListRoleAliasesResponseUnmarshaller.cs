...
{
    /// <summary>
    /// Response Unmarshaller for ListRoleAliases operation
    /// </summary>  
    public class ListRoleAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRoleAliasesResponse response = new ListRoleAliasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("roleAliases", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.RoleAliases = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRoleAliasesResponseUnmarshaller _instance = new ListRoleAliasesResponseUnmarshaller();        

        internal static ListRoleAliasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRoleAliasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
