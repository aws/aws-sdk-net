...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeletePolicyVersionRequestMarshaller : IMarshaller<IRequest, DeletePolicyVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePolicyVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePolicyVersionRequest publicRequest)
        {
        ...
        private static DeletePolicyVersionRequestMarshaller _instance = new DeletePolicyVersionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePolicyVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
