...
{
    /// <summary>
    /// Response Unmarshaller for DescribeJobExecution operation
    /// </summary>  
    public class DescribeJobExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("execution", targetDepth))
                {
                    ...
                    response.Execution = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeJobExecutionResponseUnmarshaller _instance = new DescribeJobExecutionResponseUnmarshaller();        

        internal static DescribeJobExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeJobExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
