...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CommandParameterValueUnmarshaller : IUnmarshaller<CommandParameterValue, XmlUnmarshallerContext>, IUnmarshaller<CommandParameterValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CommandParameterValue IUnmarshaller<CommandParameterValue, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CommandParameterValue Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UL = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
