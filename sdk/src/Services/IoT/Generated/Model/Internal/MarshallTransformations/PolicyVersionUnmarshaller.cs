...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PolicyVersionUnmarshaller : IJsonUnmarshaller<PolicyVersion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PolicyVersion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("isDefaultVersion", targetDepth, ref reader))
                {
