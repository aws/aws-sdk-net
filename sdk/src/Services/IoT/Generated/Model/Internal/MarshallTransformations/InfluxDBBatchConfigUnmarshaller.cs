...
{
    /// <summary>
    /// Response Unmarshaller for InfluxDBBatchConfig Object
    /// </summary>  
    public class InfluxDBBatchConfigUnmarshaller : IJsonUnmarshaller<InfluxDBBatchConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InfluxDBBatchConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            InfluxDBBatchConfig unmarshalledObject = new InfluxDBBatchConfig();
        ...
        private static InfluxDBBatchConfigUnmarshaller _instance = new InfluxDBBatchConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InfluxDBBatchConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
