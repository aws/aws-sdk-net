...
{
    /// <summary>
    /// Response Unmarshaller for ListCommands operation
    /// </summary>  
    public class ListCommandsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("commands", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CommandSummary, CommandSummaryUnmarshaller>(CommandSummaryUnmarshaller.Instance);
                    response.Commands = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCommandsResponseUnmarshaller _instance = new ListCommandsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCommandsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
