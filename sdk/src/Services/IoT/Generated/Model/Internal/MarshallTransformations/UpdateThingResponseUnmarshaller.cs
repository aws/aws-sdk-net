...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateThingResponseUnmarshaller _instance = new UpdateThingResponseUnmarshaller();        

        internal static UpdateThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
