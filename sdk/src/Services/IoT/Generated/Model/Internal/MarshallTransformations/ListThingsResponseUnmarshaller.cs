...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListThingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListThingsResponse response = new ListThingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ThingAttribute, ThingAttributeUnmarshaller>(ThingAttributeUnmarshaller.Instance);
        ...
        private static ListThingsResponseUnmarshaller _instance = new ListThingsResponseUnmarshaller();        

        internal static ListThingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListThingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
