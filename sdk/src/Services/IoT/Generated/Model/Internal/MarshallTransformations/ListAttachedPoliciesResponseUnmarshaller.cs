...
{
    /// <summary>
    /// Response Unmarshaller for ListAttachedPolicies operation
    /// </summary>  
    public class ListAttachedPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttachedPoliciesResponse response = new ListAttachedPoliciesResponse();
        ...
        private static ListAttachedPoliciesResponseUnmarshaller _instance = new ListAttachedPoliciesResponseUnmarshaller();        

        internal static ListAttachedPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
