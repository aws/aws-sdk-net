...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DocumentParameterUnmarshaller : IJsonUnmarshaller<DocumentParameter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentParameter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("example", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Example = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
