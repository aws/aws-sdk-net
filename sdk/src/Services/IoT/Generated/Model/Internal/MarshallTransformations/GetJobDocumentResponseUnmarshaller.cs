...
{
    /// <summary>
    /// Response Unmarshaller for GetJobDocument operation
    /// </summary>  
    public class GetJobDocumentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJobDocumentResponse response = new GetJobDocumentResponse();
        ...
        private static GetJobDocumentResponseUnmarshaller _instance = new GetJobDocumentResponseUnmarshaller();        

        internal static GetJobDocumentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobDocumentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
