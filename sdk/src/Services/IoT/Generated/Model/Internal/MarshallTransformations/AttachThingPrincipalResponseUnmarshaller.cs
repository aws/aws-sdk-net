...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttachThingPrincipalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachThingPrincipalResponse response = new AttachThingPrincipalResponse();
        ...
        private static AttachThingPrincipalResponseUnmarshaller _instance = new AttachThingPrincipalResponseUnmarshaller();        

        internal static AttachThingPrincipalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachThingPrincipalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
