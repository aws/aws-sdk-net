...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCommand operation
    /// </summary>  
    public class UpdateCommandResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCommandResponse response = new UpdateCommandResponse();
        ...
        private static UpdateCommandResponseUnmarshaller _instance = new UpdateCommandResponseUnmarshaller();        

        internal static UpdateCommandResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCommandResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
