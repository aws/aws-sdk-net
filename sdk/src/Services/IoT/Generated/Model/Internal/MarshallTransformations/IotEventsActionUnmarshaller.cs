...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IotEventsActionUnmarshaller : IJsonUnmarshaller<IotEventsAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IotEventsAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("batchMode", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.BatchMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
