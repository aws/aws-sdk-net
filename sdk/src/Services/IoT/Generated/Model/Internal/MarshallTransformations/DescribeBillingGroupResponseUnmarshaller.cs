...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBillingGroup operation
    /// </summary>  
    public class DescribeBillingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBillingGroupResponse response = new DescribeBillingGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("billingGroupMetadata", targetDepth))
                {
                    ...
                    response.BillingGroupMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("billingGroupProperties", targetDepth))
                {
                    ...
                    response.BillingGroupProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeBillingGroupResponseUnmarshaller _instance = new DescribeBillingGroupResponseUnmarshaller();        

        internal static DescribeBillingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBillingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
