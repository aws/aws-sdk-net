...
namespace Amazon.IoT.Model
{
    ...
    public interface IListDetectMitigationActionsExecutionsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListDetectMitigationActionsExecutionsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the ActionsExecutions
        /// </summary>
        IPaginatedEnumerable<DetectMitigationActionExecution> ActionsExecutions { get; }
    }
}