...
namespace Amazon.IoT
{
    ...
    public class DisconnectReasonValue : ConstantClass
    {
        ...
        /// <summary>
        /// Constant API_INITIATED_DISCONNECT for DisconnectReasonValue
        /// </summary>
        public static readonly DisconnectReasonValue API_INITIATED_DISCONNECT = new DisconnectReasonValue("API_INITIATED_DISCONNECT");
        /// <summary>
    ...
    /// <summary>
    /// Constants used for properties of type FleetIndexingApi.
    /// </summary>
    public class FleetIndexingApi : ConstantClass
    {

        /// <summary>
        /// Constant GET_THING_CONNECTIVITY_DATA for FleetIndexingApi
        /// </summary>
        public static readonly FleetIndexingApi GET_THING_CONNECTIVITY_DATA = new FleetIndexingApi("GET_THING_CONNECTIVITY_DATA");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public FleetIndexingApi(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static FleetIndexingApi FindValue(string value)
        {
            return FindValue<FleetIndexingApi>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator FleetIndexingApi(string value)
        {
            return FindValue(value);
        }
    }
