...
using Amazon.Util;
using Amazon.Notifications.Endpoints;
...
namespace Amazon.Notifications.Internal
{
    ...
    /// </summary>
    public class AmazonNotificationsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonNotificationsConfig)requestContext.ClientConfig;
            var result = new NotificationsEndpointParameters();
