...
namespace Amazon.Notifications
{
    ...
    public partial interface IAmazonNotifications : IAmazonService, IDisposable
    {
        ...
        UpdateManagedNotificationChannelAssociationResponse UpdateManagedNotificationChannelAssociation(UpdateManagedNotificationChannelAssociationRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/notifications-2018-05-10/UpdateManagedNotificationChannelAssociation">REST API Reference for UpdateManagedNotificationChannelAssociation Operation</seealso>
        Task<UpdateManagedNotificationChannelAssociationResponse> UpdateManagedNotificationChannelAssociationAsync(UpdateManagedNotificationChannelAssociationRequest request, CancellationToken cancellationToken = default(CancellationToken));
