...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    public class NotificationHubOverviewUnmarshaller : IJsonUnmarshaller<NotificationHubOverview, JsonUnmarshallerContext>
    {
        ...
        private static NotificationHubOverviewUnmarshaller _instance = new NotificationHubOverviewUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NotificationHubOverviewUnmarshaller Instance
        {
            get
            {
                return _instance;
