...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ManagedNotificationEventUnmarshaller : IJsonUnmarshaller<ManagedNotificationEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ManagedNotificationEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("aggregationEventType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AggregationEventType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("aggregationSummary", targetDepth, ref reader))
                {
