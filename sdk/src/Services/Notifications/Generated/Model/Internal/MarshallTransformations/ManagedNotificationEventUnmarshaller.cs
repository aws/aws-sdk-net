...
{
    /// <summary>
    /// Response Unmarshaller for ManagedNotificationEvent Object
    /// </summary>  
    public class ManagedNotificationEventUnmarshaller : IUnmarshaller<ManagedNotificationEvent, XmlUnmarshallerContext>, IUnmarshaller<ManagedNotificationEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ManagedNotificationEvent IUnmarshaller<ManagedNotificationEvent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ManagedNotificationEvent Unmarshall(JsonUnmarshallerContext context)
        {
            ManagedNotificationEvent unmarshalledObject = new ManagedNotificationEvent();
        ...
        private static ManagedNotificationEventUnmarshaller _instance = new ManagedNotificationEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ManagedNotificationEventUnmarshaller Instance
        {
            get
            {
                return _instance;
