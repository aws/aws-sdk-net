...
{
    /// <summary>
    /// Response Unmarshaller for PutTableBucketMaintenanceConfiguration operation
    /// </summary>  
    public class PutTableBucketMaintenanceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTableBucketMaintenanceConfigurationResponse response = new PutTableBucketMaintenanceConfigurationResponse();
        ...
        private static PutTableBucketMaintenanceConfigurationResponseUnmarshaller _instance = new PutTableBucketMaintenanceConfigurationResponseUnmarshaller();        

        internal static PutTableBucketMaintenanceConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableBucketMaintenanceConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
