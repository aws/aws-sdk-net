...
{
    /// <summary>
    /// Response Unmarshaller for GetTableRecordExpirationConfiguration operation
    /// </summary>  
    public class GetTableRecordExpirationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableRecordExpirationConfigurationResponse response = new GetTableRecordExpirationConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TableRecordExpirationConfigurationValueUnmarshaller.Instance;
        ...
        private static GetTableRecordExpirationConfigurationResponseUnmarshaller _instance = new GetTableRecordExpirationConfigurationResponseUnmarshaller();        

        internal static GetTableRecordExpirationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableRecordExpirationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
