...
{
    /// <summary>
    /// Response Unmarshaller for PutTableBucketReplication operation
    /// </summary>  
    public class PutTableBucketReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTableBucketReplicationResponse response = new PutTableBucketReplicationResponse();
        ...
        private static PutTableBucketReplicationResponseUnmarshaller _instance = new PutTableBucketReplicationResponseUnmarshaller();        

        internal static PutTableBucketReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableBucketReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
