...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTablePolicy operation
    /// </summary>  
    public class DeleteTablePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTablePolicyResponse response = new DeleteTablePolicyResponse();
        ...
        private static DeleteTablePolicyResponseUnmarshaller _instance = new DeleteTablePolicyResponseUnmarshaller();        

        internal static DeleteTablePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTablePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
