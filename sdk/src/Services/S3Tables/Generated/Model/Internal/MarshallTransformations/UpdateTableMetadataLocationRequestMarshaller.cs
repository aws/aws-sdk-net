...
{
    /// <summary>
    /// UpdateTableMetadataLocation Request Marshaller
    /// </summary>       
    public class UpdateTableMetadataLocationRequestMarshaller : IMarshaller<IRequest, UpdateTableMetadataLocationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTableMetadataLocationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTableMetadataLocationRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetMetadataLocation())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.MetadataLocation);
            }
        ...
        private static UpdateTableMetadataLocationRequestMarshaller _instance = new UpdateTableMetadataLocationRequestMarshaller();        

        internal static UpdateTableMetadataLocationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTableMetadataLocationRequestMarshaller Instance
        {
            get
            {
                return _instance;
