...
namespace Amazon.S3Tables.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetTableReplicationStatusRequestMarshaller : IMarshaller<IRequest, GetTableReplicationStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetTableReplicationStatusRequestMarshaller _instance = new GetTableReplicationStatusRequestMarshaller();        

        internal static GetTableReplicationStatusRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableReplicationStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
