...
{
    /// <summary>
    /// PutTableBucketMaintenanceConfiguration Request Marshaller
    /// </summary>       
    public class PutTableBucketMaintenanceConfigurationRequestMarshaller : IMarshaller<IRequest, PutTableBucketMaintenanceConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutTableBucketMaintenanceConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutTableBucketMaintenanceConfigurationRequest publicRequest)
        {
        ...
        private static PutTableBucketMaintenanceConfigurationRequestMarshaller _instance = new PutTableBucketMaintenanceConfigurationRequestMarshaller();        

        internal static PutTableBucketMaintenanceConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableBucketMaintenanceConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
