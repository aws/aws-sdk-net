...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTableReplication operation
    /// </summary>  
    public class DeleteTableReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTableReplicationResponse response = new DeleteTableReplicationResponse();
        ...
        private static DeleteTableReplicationResponseUnmarshaller _instance = new DeleteTableReplicationResponseUnmarshaller();        

        internal static DeleteTableReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTableReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
