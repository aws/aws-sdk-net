...
{
    /// <summary>
    /// Response Unmarshaller for PutTableReplication operation
    /// </summary>  
    public class PutTableReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTableReplicationResponse response = new PutTableReplicationResponse();
        ...
        private static PutTableReplicationResponseUnmarshaller _instance = new PutTableReplicationResponseUnmarshaller();        

        internal static PutTableReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
