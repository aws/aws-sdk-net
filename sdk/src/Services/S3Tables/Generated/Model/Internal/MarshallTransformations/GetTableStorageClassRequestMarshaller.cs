...
{
    /// <summary>
    /// GetTableStorageClass Request Marshaller
    /// </summary>       
    public class GetTableStorageClassRequestMarshaller : IMarshaller<IRequest, GetTableStorageClassRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTableStorageClassRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTableStorageClassRequest publicRequest)
        {
            ...
            request.ResourcePath = "/tables/{tableBucketARN}/{namespace}/{name}/storage-class";

            return request;
        }
        private static GetTableStorageClassRequestMarshaller _instance = new GetTableStorageClassRequestMarshaller();        

        internal static GetTableStorageClassRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableStorageClassRequestMarshaller Instance
        {
            get
            {
                return _instance;
