...
namespace Amazon.S3Tables.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplicationDestinationStatusModelUnmarshaller : IUnmarshaller<ReplicationDestinationStatusModel, XmlUnmarshallerContext>, IUnmarshaller<ReplicationDestinationStatusModel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReplicationDestinationStatusModel IUnmarshaller<ReplicationDestinationStatusModel, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ReplicationDestinationStatusModel Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("destinationTableArn", targetDepth))
                {
                    ...
                    unmarshalledObject.DestinationTableArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("destinationTableBucketArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DestinationTableBucketArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("lastSuccessfulReplicatedUpdate", targetDepth))
                {
                    ...
                    unmarshalledObject.LastSuccessfulReplicatedUpdate = unmarshaller.Unmarshall(context);
                    continue;
                }
