...
{
    /// <summary>
    /// Response Unmarshaller for PutTablePolicy operation
    /// </summary>  
    public class PutTablePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTablePolicyResponse response = new PutTablePolicyResponse();
        ...
        private static PutTablePolicyResponseUnmarshaller _instance = new PutTablePolicyResponseUnmarshaller();        

        internal static PutTablePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTablePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
