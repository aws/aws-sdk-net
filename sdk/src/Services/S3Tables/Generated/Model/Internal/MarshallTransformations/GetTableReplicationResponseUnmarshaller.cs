...
{
    /// <summary>
    /// Response Unmarshaller for GetTableReplication operation
    /// </summary>  
    public class GetTableReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableReplicationResponse response = new GetTableReplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TableReplicationConfigurationUnmarshaller.Instance;
        ...
        private static GetTableReplicationResponseUnmarshaller _instance = new GetTableReplicationResponseUnmarshaller();        

        internal static GetTableReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
