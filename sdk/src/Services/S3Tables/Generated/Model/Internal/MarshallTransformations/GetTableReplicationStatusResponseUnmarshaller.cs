...
{
    /// <summary>
    /// Response Unmarshaller for GetTableReplicationStatus operation
    /// </summary>  
    public class GetTableReplicationStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableReplicationStatusResponse response = new GetTableReplicationStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ReplicationDestinationStatusModel, ReplicationDestinationStatusModelUnmarshaller>(ReplicationDestinationStatusModelUnmarshaller.Instance);
                ...
                if (context.TestExpression("sourceTableArn", targetDepth))
                {
                    ...
                    response.SourceTableArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTableReplicationStatusResponseUnmarshaller _instance = new GetTableReplicationStatusResponseUnmarshaller();        

        internal static GetTableReplicationStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableReplicationStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
