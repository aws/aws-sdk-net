...
{
    /// <summary>
    /// Response Unmarshaller for GetTableBucketReplication operation
    /// </summary>  
    public class GetTableBucketReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableBucketReplicationResponse response = new GetTableBucketReplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TableBucketReplicationConfigurationUnmarshaller.Instance;
        ...
        private static GetTableBucketReplicationResponseUnmarshaller _instance = new GetTableBucketReplicationResponseUnmarshaller();        

        internal static GetTableBucketReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableBucketReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
