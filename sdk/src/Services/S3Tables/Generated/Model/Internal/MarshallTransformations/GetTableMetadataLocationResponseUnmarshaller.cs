...
{
    /// <summary>
    /// Response Unmarshaller for GetTableMetadataLocation operation
    /// </summary>  
    public class GetTableMetadataLocationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableMetadataLocationResponse response = new GetTableMetadataLocationResponse();
        ...
        private static GetTableMetadataLocationResponseUnmarshaller _instance = new GetTableMetadataLocationResponseUnmarshaller();        

        internal static GetTableMetadataLocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableMetadataLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
