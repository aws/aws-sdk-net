...
{
    /// <summary>
    /// Response Unmarshaller for GetTableRecordExpirationJobStatus operation
    /// </summary>  
    public class GetTableRecordExpirationJobStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableRecordExpirationJobStatusResponse response = new GetTableRecordExpirationJobStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("lastRunTimestamp", targetDepth))
                {
                    ...
                    response.LastRunTimestamp = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetTableRecordExpirationJobStatusResponseUnmarshaller _instance = new GetTableRecordExpirationJobStatusResponseUnmarshaller();        

        internal static GetTableRecordExpirationJobStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableRecordExpirationJobStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
