...
namespace Amazon.S3Tables.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MethodNotAllowedExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<MethodNotAllowedException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public MethodNotAllowedException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public MethodNotAllowedException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
