...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTableBucketMetricsConfiguration operation
    /// </summary>  
    public class DeleteTableBucketMetricsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTableBucketMetricsConfigurationResponse response = new DeleteTableBucketMetricsConfigurationResponse();
        ...
        private static DeleteTableBucketMetricsConfigurationResponseUnmarshaller _instance = new DeleteTableBucketMetricsConfigurationResponseUnmarshaller();        

        internal static DeleteTableBucketMetricsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTableBucketMetricsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
