...
{
    /// <summary>
    /// Response Unmarshaller for GetTableBucketMetricsConfiguration operation
    /// </summary>  
    public class GetTableBucketMetricsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableBucketMetricsConfigurationResponse response = new GetTableBucketMetricsConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("tableBucketARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TableBucketARN = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTableBucketMetricsConfigurationResponseUnmarshaller _instance = new GetTableBucketMetricsConfigurationResponseUnmarshaller();        

        internal static GetTableBucketMetricsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableBucketMetricsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
