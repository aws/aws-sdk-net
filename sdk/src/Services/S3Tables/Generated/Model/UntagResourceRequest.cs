...
namespace Amazon.S3Tables.Model
{
    ...
    ///  </dd> </dl>
    /// </summary>
    public partial class UntagResourceRequest : AmazonS3TablesRequest
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) of the Amazon S3 Tables resource that you're removing
        /// tags from. The tagged resource can be a table bucket or a table. For a list of all
        ...
        /// <para>
        /// The array of tag keys that you're removing from the S3 Tables resource. For more information,
