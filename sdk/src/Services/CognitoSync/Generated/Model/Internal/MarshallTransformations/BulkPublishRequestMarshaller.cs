...
namespace Amazon.CognitoSync.Model.Internal.MarshallTransformations
{
    ...
    public class BulkPublishRequestMarshaller : IMarshaller<IRequest, BulkPublishRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(BulkPublishRequest publicRequest)
        {
            ...
            request.ResourcePath = "/identitypools/{IdentityPoolId}/bulkpublish";

            return request;
        }
        private static BulkPublishRequestMarshaller _instance = new BulkPublishRequestMarshaller();        

        internal static BulkPublishRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BulkPublishRequestMarshaller Instance
        {
            get
            {
                return _instance;
