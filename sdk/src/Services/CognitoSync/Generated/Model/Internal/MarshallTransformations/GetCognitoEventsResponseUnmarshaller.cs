...
{
    /// <summary>
    /// Response Unmarshaller for GetCognitoEvents operation
    /// </summary>  
    public class GetCognitoEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCognitoEventsResponse response = new GetCognitoEventsResponse();
        ...
        private static GetCognitoEventsResponseUnmarshaller _instance = new GetCognitoEventsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCognitoEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
