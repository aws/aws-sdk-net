...
{
    /// <summary>
    /// Response Unmarshaller for CreateGraphSnapshot operation
    /// </summary>  
    public class CreateGraphSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGraphSnapshotResponse response = new CreateGraphSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("snapshotCreateTime", targetDepth, ref reader))
                {
                    ...
                    response.SnapshotCreateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("sourceGraphId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceGraphId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateGraphSnapshotResponseUnmarshaller _instance = new CreateGraphSnapshotResponseUnmarshaller();        

        internal static CreateGraphSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGraphSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
