...
{
    /// <summary>
    /// GetGraph Request Marshaller
    /// </summary>       
    public class GetGraphRequestMarshaller : IMarshaller<IRequest, GetGraphRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetGraphRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetGraphRequest publicRequest)
        {
        ...
        private static GetGraphRequestMarshaller _instance = new GetGraphRequestMarshaller();        

        internal static GetGraphRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGraphRequestMarshaller Instance
        {
            get
            {
                return _instance;
