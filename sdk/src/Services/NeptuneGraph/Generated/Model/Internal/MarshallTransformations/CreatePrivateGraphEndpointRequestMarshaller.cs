...
{
    /// <summary>
    /// CreatePrivateGraphEndpoint Request Marshaller
    /// </summary>       
    public class CreatePrivateGraphEndpointRequestMarshaller : IMarshaller<IRequest, CreatePrivateGraphEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePrivateGraphEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePrivateGraphEndpointRequest publicRequest)
        {
        ...
        private static CreatePrivateGraphEndpointRequestMarshaller _instance = new CreatePrivateGraphEndpointRequestMarshaller();        

        internal static CreatePrivateGraphEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePrivateGraphEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
