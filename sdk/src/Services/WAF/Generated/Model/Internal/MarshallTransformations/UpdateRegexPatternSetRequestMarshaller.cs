...
{
    /// <summary>
    /// UpdateRegexPatternSet Request Marshaller
    /// </summary>       
    public class UpdateRegexPatternSetRequestMarshaller : IMarshaller<IRequest, UpdateRegexPatternSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRegexPatternSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRegexPatternSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAF");
            string target = "AWSWAF_20150824.UpdateRegexPatternSet";
            ...
            if(publicRequest.IsSetRegexPatternSetId())
            {
                context.Writer.WritePropertyName("RegexPatternSetId");
                context.Writer.WriteStringValue(publicRequest.RegexPatternSetId);
            }
            ...
            if(publicRequest.IsSetUpdates())
            {
                ...
                foreach(var publicRequestUpdatesListValue in publicRequest.Updates)
                {
                    ...
                    var marshaller = RegexPatternSetUpdateMarshaller.Instance;
