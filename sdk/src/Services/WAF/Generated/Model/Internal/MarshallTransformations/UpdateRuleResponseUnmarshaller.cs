...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRule operation
    /// </summary>  
    public class UpdateRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateRuleResponseUnmarshaller _instance = new UpdateRuleResponseUnmarshaller();        

        internal static UpdateRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
