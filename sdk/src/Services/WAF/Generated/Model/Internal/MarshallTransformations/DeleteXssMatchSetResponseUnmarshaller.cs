...
{
    /// <summary>
    /// Response Unmarshaller for DeleteXssMatchSet operation
    /// </summary>  
    public class DeleteXssMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteXssMatchSetResponse response = new DeleteXssMatchSetResponse();
        ...
        private static DeleteXssMatchSetResponseUnmarshaller _instance = new DeleteXssMatchSetResponseUnmarshaller();        

        internal static DeleteXssMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteXssMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
