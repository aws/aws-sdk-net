...
{
    /// <summary>
    /// ListRateBasedRules Request Marshaller
    /// </summary>       
    public class ListRateBasedRulesRequestMarshaller : IMarshaller<IRequest, ListRateBasedRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListRateBasedRulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListRateBasedRulesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAF");
            string target = "AWSWAF_20150824.ListRateBasedRules";
