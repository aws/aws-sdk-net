...
{
    /// <summary>
    /// Response Unmarshaller for ListIPSets operation
    /// </summary>  
    public class ListIPSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIPSetsResponse response = new ListIPSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<IPSetSummary, IPSetSummaryUnmarshaller>(IPSetSummaryUnmarshaller.Instance);
                    response.IPSets = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListIPSetsResponseUnmarshaller _instance = new ListIPSetsResponseUnmarshaller();        

        internal static ListIPSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIPSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
