...
namespace Amazon.WAF.Model.Internal.MarshallTransformations
{
    ...
    public class ListLoggingConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("LoggingConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LoggingConfiguration, LoggingConfigurationUnmarshaller>(LoggingConfigurationUnmarshaller.Instance);
                    response.LoggingConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
