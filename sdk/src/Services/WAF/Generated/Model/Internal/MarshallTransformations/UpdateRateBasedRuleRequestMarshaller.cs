...
{
    /// <summary>
    /// UpdateRateBasedRule Request Marshaller
    /// </summary>       
    public class UpdateRateBasedRuleRequestMarshaller : IMarshaller<IRequest, UpdateRateBasedRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRateBasedRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRateBasedRuleRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAF");
            string target = "AWSWAF_20150824.UpdateRateBasedRule";
            ...
            if(publicRequest.IsSetRateLimit())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.RateLimit.Value);
            }
