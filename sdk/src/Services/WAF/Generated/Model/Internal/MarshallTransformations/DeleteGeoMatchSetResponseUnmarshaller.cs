...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGeoMatchSet operation
    /// </summary>  
    public class DeleteGeoMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGeoMatchSetResponse response = new DeleteGeoMatchSetResponse();
        ...
        private static DeleteGeoMatchSetResponseUnmarshaller _instance = new DeleteGeoMatchSetResponseUnmarshaller();        

        internal static DeleteGeoMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGeoMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
