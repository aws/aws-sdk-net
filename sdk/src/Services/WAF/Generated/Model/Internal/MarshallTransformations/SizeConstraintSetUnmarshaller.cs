...
namespace Amazon.WAF.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SizeConstraintSetUnmarshaller : IJsonUnmarshaller<SizeConstraintSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SizeConstraintSet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
