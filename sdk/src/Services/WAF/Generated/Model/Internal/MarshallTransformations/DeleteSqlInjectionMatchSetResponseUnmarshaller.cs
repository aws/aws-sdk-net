...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSqlInjectionMatchSet operation
    /// </summary>  
    public class DeleteSqlInjectionMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSqlInjectionMatchSetResponse response = new DeleteSqlInjectionMatchSetResponse();
        ...
        private static DeleteSqlInjectionMatchSetResponseUnmarshaller _instance = new DeleteSqlInjectionMatchSetResponseUnmarshaller();        

        internal static DeleteSqlInjectionMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSqlInjectionMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
