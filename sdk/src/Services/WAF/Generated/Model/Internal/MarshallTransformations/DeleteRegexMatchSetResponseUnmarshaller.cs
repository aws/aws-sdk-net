...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRegexMatchSet operation
    /// </summary>  
    public class DeleteRegexMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRegexMatchSetResponse response = new DeleteRegexMatchSetResponse();
        ...
        private static DeleteRegexMatchSetResponseUnmarshaller _instance = new DeleteRegexMatchSetResponseUnmarshaller();        

        internal static DeleteRegexMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegexMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
