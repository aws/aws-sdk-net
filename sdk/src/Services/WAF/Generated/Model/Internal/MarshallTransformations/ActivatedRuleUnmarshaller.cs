...
namespace Amazon.WAF.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivatedRuleUnmarshaller : IJsonUnmarshaller<ActivatedRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActivatedRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
