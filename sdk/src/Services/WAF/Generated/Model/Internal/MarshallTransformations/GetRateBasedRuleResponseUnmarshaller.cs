...
{
    /// <summary>
    /// Response Unmarshaller for GetRateBasedRule operation
    /// </summary>  
    public class GetRateBasedRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRateBasedRuleResponse response = new GetRateBasedRuleResponse();
        ...
        private static GetRateBasedRuleResponseUnmarshaller _instance = new GetRateBasedRuleResponseUnmarshaller();        

        internal static GetRateBasedRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRateBasedRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
