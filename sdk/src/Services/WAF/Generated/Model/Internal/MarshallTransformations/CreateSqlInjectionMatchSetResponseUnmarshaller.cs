...
{
    /// <summary>
    /// Response Unmarshaller for CreateSqlInjectionMatchSet operation
    /// </summary>  
    public class CreateSqlInjectionMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSqlInjectionMatchSetResponse response = new CreateSqlInjectionMatchSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SqlInjectionMatchSet", targetDepth, ref reader))
                {
                    var unmarshaller = SqlInjectionMatchSetUnmarshaller.Instance;
                    response.SqlInjectionMatchSet = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateSqlInjectionMatchSetResponseUnmarshaller _instance = new CreateSqlInjectionMatchSetResponseUnmarshaller();        

        internal static CreateSqlInjectionMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSqlInjectionMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
