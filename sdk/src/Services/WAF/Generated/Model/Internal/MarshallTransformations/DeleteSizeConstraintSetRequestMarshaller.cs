...
{
    /// <summary>
    /// DeleteSizeConstraintSet Request Marshaller
    /// </summary>       
    public class DeleteSizeConstraintSetRequestMarshaller : IMarshaller<IRequest, DeleteSizeConstraintSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSizeConstraintSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSizeConstraintSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAF");
            string target = "AWSWAF_20150824.DeleteSizeConstraintSet";
            ...
            if(publicRequest.IsSetSizeConstraintSetId())
            {
                context.Writer.WritePropertyName("SizeConstraintSetId");
                context.Writer.WriteStringValue(publicRequest.SizeConstraintSetId);
            }
