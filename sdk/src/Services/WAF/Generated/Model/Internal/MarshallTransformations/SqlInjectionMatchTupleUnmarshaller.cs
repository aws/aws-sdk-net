...
namespace Amazon.WAF.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SqlInjectionMatchTupleUnmarshaller : IJsonUnmarshaller<SqlInjectionMatchTuple, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SqlInjectionMatchTuple Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
