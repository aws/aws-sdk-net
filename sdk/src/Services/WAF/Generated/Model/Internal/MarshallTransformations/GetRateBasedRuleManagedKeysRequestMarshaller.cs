...
{
    /// <summary>
    /// GetRateBasedRuleManagedKeys Request Marshaller
    /// </summary>       
    public class GetRateBasedRuleManagedKeysRequestMarshaller : IMarshaller<IRequest, GetRateBasedRuleManagedKeysRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRateBasedRuleManagedKeysRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRateBasedRuleManagedKeysRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAF");
            string target = "AWSWAF_20150824.GetRateBasedRuleManagedKeys";
