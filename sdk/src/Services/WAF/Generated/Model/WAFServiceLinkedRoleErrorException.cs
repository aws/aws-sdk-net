...
namespace Amazon.WAF.Model
{
    ...
    [Serializable]
    #endif
    public partial class WAFServiceLinkedRoleErrorException : AmazonWAFException
    {
        ...
        public WAFServiceLinkedRoleErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public WAFServiceLinkedRoleErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
