...
namespace Amazon.WAF.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonWAFAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWAFAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WAF.
        /// </summary>
        public AmazonWAFAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWAFAuthSchemeParameters
            {
    ...
    public class AmazonWAFAuthSchemeResolver : IAuthSchemeResolver<AmazonWAFAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWAFAuthSchemeParameters authParameters)
        {
