...
namespace Amazon.AWSMarketplaceMetering.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageRecordResultUnmarshaller : IJsonUnmarshaller<UsageRecordResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UsageRecordResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
