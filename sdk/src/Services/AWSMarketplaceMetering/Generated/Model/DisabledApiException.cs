...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class DisabledApiException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public DisabledApiException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DisabledApiException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
