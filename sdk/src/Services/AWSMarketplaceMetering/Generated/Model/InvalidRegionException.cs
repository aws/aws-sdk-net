...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidRegionException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidRegionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRegionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
