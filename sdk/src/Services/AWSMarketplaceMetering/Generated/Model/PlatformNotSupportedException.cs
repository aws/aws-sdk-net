...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class PlatformNotSupportedException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public PlatformNotSupportedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PlatformNotSupportedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
