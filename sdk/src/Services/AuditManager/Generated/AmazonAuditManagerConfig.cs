...
namespace Amazon.AuditManager
{
    ...
    public partial class AmazonAuditManagerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("AuditManager", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "AuditManager";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "auditmanager";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2017-07-25";
