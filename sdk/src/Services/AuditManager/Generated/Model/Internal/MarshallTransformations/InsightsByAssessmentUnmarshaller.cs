...
{
    /// <summary>
    /// Response Unmarshaller for InsightsByAssessment Object
    /// </summary>  
    public class InsightsByAssessmentUnmarshaller : IJsonUnmarshaller<InsightsByAssessment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InsightsByAssessment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            InsightsByAssessment unmarshalledObject = new InsightsByAssessment();
            ...
            {
                if (context.TestExpression("assessmentControlsCountByNoncompliantEvidence", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("totalAssessmentControlsCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        private static InsightsByAssessmentUnmarshaller _instance = new InsightsByAssessmentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InsightsByAssessmentUnmarshaller Instance
        {
            get
            {
                return _instance;
