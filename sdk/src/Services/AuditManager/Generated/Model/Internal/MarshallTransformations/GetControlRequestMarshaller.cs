...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetControlRequestMarshaller : IMarshaller<IRequest, GetControlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetControlRequestMarshaller _instance = new GetControlRequestMarshaller();        

        internal static GetControlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetControlRequestMarshaller Instance
        {
            get
            {
                return _instance;
