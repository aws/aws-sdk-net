...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetChangeLogsRequestMarshaller : IMarshaller<IRequest, GetChangeLogsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetChangeLogsRequestMarshaller _instance = new GetChangeLogsRequestMarshaller();        

        internal static GetChangeLogsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChangeLogsRequestMarshaller Instance
        {
            get
            {
                return _instance;
