...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EvidenceFinderEnablementUnmarshaller : IJsonUnmarshaller<EvidenceFinderEnablement, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public EvidenceFinderEnablement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new EvidenceFinderEnablement();
            ...
            {
                if (context.TestExpression("backfillStatus", targetDepth, ref reader))
                {
        ...
        private static EvidenceFinderEnablementUnmarshaller _instance = new EvidenceFinderEnablementUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static EvidenceFinderEnablementUnmarshaller Instance => _instance;
    }
}
