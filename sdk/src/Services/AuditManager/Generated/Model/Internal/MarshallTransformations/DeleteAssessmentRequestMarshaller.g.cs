...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAssessmentRequestMarshaller : IMarshaller<IRequest, DeleteAssessmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAssessmentRequestMarshaller _instance = new();

        internal static DeleteAssessmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAssessmentRequestMarshaller Instance => _instance;
    }
}
