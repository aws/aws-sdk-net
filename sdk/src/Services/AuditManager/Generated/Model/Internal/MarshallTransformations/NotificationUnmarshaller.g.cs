...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NotificationUnmarshaller : IJsonUnmarshaller<Notification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Notification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("controlSetName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ControlSetName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
