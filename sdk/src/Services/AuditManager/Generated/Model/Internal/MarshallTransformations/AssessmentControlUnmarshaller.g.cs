...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssessmentControlUnmarshaller : IJsonUnmarshaller<AssessmentControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AssessmentControl();
            ...
            {
                if (context.TestExpression("assessmentReportEvidenceCount", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("evidenceCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                ...
                if (context.TestExpression("evidenceSources", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssessmentControlUnmarshaller Instance => _instance;
    }
}
