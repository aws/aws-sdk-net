...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetEvidenceRequestMarshaller : IMarshaller<IRequest, GetEvidenceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetEvidenceRequestMarshaller _instance = new GetEvidenceRequestMarshaller();        

        internal static GetEvidenceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEvidenceRequestMarshaller Instance
        {
            get
            {
                return _instance;
