...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DelegationUnmarshaller : IJsonUnmarshaller<Delegation, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Delegation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Delegation();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("assessmentName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("roleType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoleType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DelegationUnmarshaller _instance = new DelegationUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DelegationUnmarshaller Instance => _instance;
    }
}
