...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAssessmentReportUrlRequestMarshaller : IMarshaller<IRequest, GetAssessmentReportUrlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetAssessmentReportUrlRequestMarshaller _instance = new GetAssessmentReportUrlRequestMarshaller();        

        internal static GetAssessmentReportUrlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssessmentReportUrlRequestMarshaller Instance
        {
            get
            {
                return _instance;
