...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssessmentFrameworkShareRequestUnmarshaller : IJsonUnmarshaller<AssessmentFrameworkShareRequest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AssessmentFrameworkShareRequest();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("customControlsCount", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("destinationAccount", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("standardControlsCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssessmentFrameworkShareRequestUnmarshaller Instance => _instance;
    }
}
