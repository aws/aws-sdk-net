...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    public class CreateAssessmentRequestMarshaller : IMarshaller<IRequest, CreateAssessmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static CreateAssessmentRequestMarshaller _instance = new CreateAssessmentRequestMarshaller();        

        internal static CreateAssessmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssessmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
