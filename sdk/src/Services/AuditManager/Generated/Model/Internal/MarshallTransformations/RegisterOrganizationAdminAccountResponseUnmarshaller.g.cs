...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisterOrganizationAdminAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RegisterOrganizationAdminAccountResponse();
            ...
            {
                if (context.TestExpression("adminAccountId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AdminAccountId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static RegisterOrganizationAdminAccountResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterOrganizationAdminAccountResponseUnmarshaller Instance => _instance;
    }
}
