...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InsightsUnmarshaller : IUnmarshaller<Insights, XmlUnmarshallerContext>, IUnmarshaller<Insights, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Insights IUnmarshaller<Insights, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Insights Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("activeAssessmentsCount", targetDepth))
                {
                    ...
                    unmarshalledObject.ActiveAssessmentsCount = unmarshaller.Unmarshall(context);
                    continue;
                }
