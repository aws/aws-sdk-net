    ...
    public class BatchImportEvidenceToAssessmentControlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchImportEvidenceToAssessmentControlError, BatchImportEvidenceToAssessmentControlErrorUnmarshaller>(BatchImportEvidenceToAssessmentControlErrorUnmarshaller.Instance);
