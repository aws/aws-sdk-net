...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FrameworkUnmarshaller : IJsonUnmarshaller<Framework, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Framework Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Framework();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("controlSets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ControlSet, ControlSetUnmarshaller>(ControlSetUnmarshaller.Instance);
                    unmarshalledObject.ControlSets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("controlSources", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ControlSources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static FrameworkUnmarshaller Instance => _instance;
    }
}
