...
namespace Amazon.AuditManager.Model
{
    ...
    /// all active assessments. <note> <para> Control insights are listed only if the control
    /// belongs to the control domain that was specified and the control collected evidence
    /// on the <c>lastUpdated</c> date of <c>controlInsightsMetadata</c>. If neither of these
    /// conditions are met, no data is listed for that control. </para> </note>
    /// </summary>
