...
namespace Amazon.AuditManager.Model
{
    ...
    public partial class ListNotificationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Notification> Notifications { get; set; } = AWSConfigs.InitializeCollections ? new List<Notification>() : null;

        /// <summary>
        /// Checks to see if the Notifications property is set.
        /// </summary>
        internal bool IsSetNotifications() => this.Notifications != null && (this.Notifications.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
