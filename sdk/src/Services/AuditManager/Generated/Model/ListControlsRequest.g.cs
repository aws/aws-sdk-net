...
{
    /// <summary>
    /// Container for the parameters to the ListControls operation. Returns a list of controls
    /// from Audit Manager.
    /// </summary>
    public partial class ListControlsRequest : AmazonAuditManagerRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ControlCatalogId property is set.
        /// </summary>
        internal bool IsSetControlCatalogId() => this.ControlCatalogId != null;
        ...
        /// <summary>
        /// Checks to see if the ControlType property is set.
        /// </summary>
        internal bool IsSetControlType() => this.ControlType != null;
