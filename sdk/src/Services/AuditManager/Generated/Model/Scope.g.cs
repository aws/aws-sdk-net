...
namespace Amazon.AuditManager.Model
{
    ...
    public partial class Scope
    {
        ...
        public List<AWSAccount> AwsAccounts { get; set; } = AWSConfigs.InitializeCollections ? new List<AWSAccount>() : null;

        /// <summary>
        /// Checks to see if the AwsAccounts property is set.
        /// </summary>
        internal bool IsSetAwsAccounts() => this.AwsAccounts != null && (this.AwsAccounts.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public List<AWSService> AwsServices { get; set; } = AWSConfigs.InitializeCollections ? new List<AWSService>() : null;
