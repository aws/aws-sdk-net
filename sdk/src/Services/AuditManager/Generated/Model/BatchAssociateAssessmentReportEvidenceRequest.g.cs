...
namespace Amazon.AuditManager.Model
{
    ...
    public partial class BatchAssociateAssessmentReportEvidenceRequest : AmazonAuditManagerRequest
    {
        ...
        public List<string> EvidenceIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the EvidenceIds property is set.
        /// </summary>
        internal bool IsSetEvidenceIds() => this.EvidenceIds != null && (this.EvidenceIds.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
