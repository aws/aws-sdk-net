...
namespace Amazon.AuditManager.Model
{
    ...
    public partial class Control
    {
        ...
        /// <summary>
        /// Checks to see if the ActionPlanInstructions property is set.
        /// </summary>
        internal bool IsSetActionPlanInstructions() => this.ActionPlanInstructions != null;
        ...
        /// <summary>
        /// Checks to see if the ActionPlanTitle property is set.
        /// </summary>
        internal bool IsSetActionPlanTitle() => this.ActionPlanTitle != null;
        ...
        /// </summary>
        [AWSProperty(Min = 1)]
        public List<ControlMappingSource> ControlMappingSources { get; set; } = AWSConfigs.InitializeCollections ? new List<ControlMappingSource>() : null;

        /// <summary>
        /// Checks to see if the ControlMappingSources property is set.
        /// </summary>
        internal bool IsSetControlMappingSources() => this.ControlMappingSources != null && (this.ControlMappingSources.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the TestingInformation property is set.
        /// </summary>
        internal bool IsSetTestingInformation() => this.TestingInformation != null;
