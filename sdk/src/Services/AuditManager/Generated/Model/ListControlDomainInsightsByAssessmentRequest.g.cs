...
namespace Amazon.AuditManager.Model
{
    ...
    /// Lists analytics data for control domains within a specified active assessment. <para>
    ...
    /// </para> <note> <para> A control domain is listed only if at least one of the controls
    /// within that domain collected evidence on the <c>lastUpdated</c> date of <c>controlDomainInsights</c>.
    /// If this condition isn’t met, no data is listed for that domain. </para> </note>
    /// </summary>
