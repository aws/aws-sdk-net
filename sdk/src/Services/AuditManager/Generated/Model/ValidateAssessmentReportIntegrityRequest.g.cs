...
{
    /// <summary>
    /// Container for the parameters to the ValidateAssessmentReportIntegrity operation. Validates
    ...
    public partial class ValidateAssessmentReportIntegrityRequest : AmazonAuditManagerRequest
    {
        ...
        /// <summary>
        /// Checks to see if the S3RelativePath property is set.
        /// </summary>
        internal bool IsSetS3RelativePath() => this.S3RelativePath != null;
    }
}
