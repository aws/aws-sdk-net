...
namespace Amazon.AuditManager.Model
{
    ...
    public partial class EvidenceInsights
    {
        ...
        /// </para>
        /// </summary>
        public int? CompliantEvidenceCount { get; set; }

        /// <summary>
        /// Checks to see if the CompliantEvidenceCount property is set.
        /// </summary>
        internal bool IsSetCompliantEvidenceCount() => this.CompliantEvidenceCount.HasValue;
        ...
        ///  </note>
        /// </summary>
        public int? InconclusiveEvidenceCount { get; set; }

        /// <summary>
        /// Checks to see if the InconclusiveEvidenceCount property is set.
        /// </summary>
        internal bool IsSetInconclusiveEvidenceCount() => this.InconclusiveEvidenceCount.HasValue;
        ...
        /// </para>
        /// </summary>
        public int? NoncompliantEvidenceCount { get; set; }

        /// <summary>
        /// Checks to see if the NoncompliantEvidenceCount property is set.
        /// </summary>
        internal bool IsSetNoncompliantEvidenceCount() => this.NoncompliantEvidenceCount.HasValue;
    }
}
