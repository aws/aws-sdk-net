...
namespace Amazon.AuditManager.Model
{
    ...
    public partial class InsightsByAssessment
    {
        ...
        /// if the associated control uses Security Hub CSPM or Config as a data source and you
        /// didn't enable those services. This is also the case if a control uses a data source
