...
namespace Amazon.AuditManager
{
    ...
    public partial class AmazonAuditManagerClient : AmazonServiceClient, IAmazonAuditManager
    {
        ...
        /// 
        /// </summary>
        public AmazonAuditManagerClient() : base(new AmazonAuditManagerConfig()) { }
        ...
        public AmazonAuditManagerClient(RegionEndpoint region) : base(new AmazonAuditManagerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAuditManagerClient(AmazonAuditManagerConfig config) : base(config) { }
