...
namespace Amazon.AuditManager.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving AuditManager endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonAuditManagerEndpointProvider"/> and <see cref="AmazonAuditManagerEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class AuditManagerEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// AuditManagerEndpointParameters constructor
        /// </summary>
        public AuditManagerEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
