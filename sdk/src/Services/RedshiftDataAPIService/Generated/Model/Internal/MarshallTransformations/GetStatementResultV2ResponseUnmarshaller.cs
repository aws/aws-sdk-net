...
{
    /// <summary>
    /// Response Unmarshaller for GetStatementResultV2 operation
    /// </summary>  
    public class GetStatementResultV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStatementResultV2Response response = new GetStatementResultV2Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<QueryRecords, QueryRecordsUnmarshaller>(QueryRecordsUnmarshaller.Instance);
        ...
        private static GetStatementResultV2ResponseUnmarshaller _instance = new GetStatementResultV2ResponseUnmarshaller();        

        internal static GetStatementResultV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStatementResultV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
