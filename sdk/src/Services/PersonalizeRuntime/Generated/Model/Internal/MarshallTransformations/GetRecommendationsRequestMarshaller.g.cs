...
namespace Amazon.PersonalizeRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetRecommendationsRequestMarshaller : IMarshaller<IRequest, GetRecommendationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetRecommendationsRequestMarshaller _instance = new();

        internal static GetRecommendationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRecommendationsRequestMarshaller Instance => _instance;
    }
}
