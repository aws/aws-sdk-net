...
namespace Amazon.PersonalizeRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetActionRecommendationsRequestMarshaller : IMarshaller<IRequest, GetActionRecommendationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetActionRecommendationsRequestMarshaller _instance = new();

        internal static GetActionRecommendationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetActionRecommendationsRequestMarshaller Instance => _instance;
    }
}
