...
namespace Amazon.PersonalizeRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetPersonalizedRankingRequestMarshaller : IMarshaller<IRequest, GetPersonalizedRankingRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetPersonalizedRankingRequestMarshaller _instance = new();

        internal static GetPersonalizedRankingRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPersonalizedRankingRequestMarshaller Instance => _instance;
    }
}
