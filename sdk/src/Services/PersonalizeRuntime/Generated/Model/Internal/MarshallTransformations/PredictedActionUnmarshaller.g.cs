...
namespace Amazon.PersonalizeRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PredictedActionUnmarshaller : IJsonUnmarshaller<PredictedAction, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PredictedAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PredictedAction();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PredictedActionUnmarshaller Instance => _instance;
    }
}
