...
namespace Amazon.PersonalizeRuntime.Model
{
    ...
    public partial class GetPersonalizedRankingResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PredictedItem> PersonalizedRanking { get; set; } = AWSConfigs.InitializeCollections ? new List<PredictedItem>() : null;

        /// <summary>
        /// Checks to see if the PersonalizedRanking property is set.
        /// </summary>
        internal bool IsSetPersonalizedRanking() => this.PersonalizedRanking != null && (this.PersonalizedRanking.Count > 0 || !AWSConfigs.InitializeCollections);
