...
namespace Amazon.PersonalizeRuntime.Model
{
    ...
    public partial class GetRecommendationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PredictedItem> ItemList { get; set; } = AWSConfigs.InitializeCollections ? new List<PredictedItem>() : null;

        /// <summary>
        /// Checks to see if the ItemList property is set.
        /// </summary>
        internal bool IsSetItemList() => this.ItemList != null && (this.ItemList.Count > 0 || !AWSConfigs.InitializeCollections);
