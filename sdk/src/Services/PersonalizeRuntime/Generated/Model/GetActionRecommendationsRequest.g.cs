...
{
    /// <summary>
    /// Container for the parameters to the GetActionRecommendations operation. Returns a
    /// list of recommended actions in sorted in descending order by prediction score. Use
    /// the <c>GetActionRecommendations</c> API if you have a custom campaign that deploys
    /// a solution version trained with a PERSONALIZED_ACTIONS recipe. <para> For more information
    /// about PERSONALIZED_ACTIONS recipes, see <a href="https://docs.aws.amazon.com/personalize/latest/dg/nexts-best-action-recipes.html">PERSONALIZED_ACTIONS
