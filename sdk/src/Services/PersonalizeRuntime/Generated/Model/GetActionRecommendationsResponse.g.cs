...
namespace Amazon.PersonalizeRuntime.Model
{
    ...
    public partial class GetActionRecommendationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<PredictedAction> ActionList { get; set; } = AWSConfigs.InitializeCollections ? new List<PredictedAction>() : null;

        /// <summary>
        /// Checks to see if the ActionList property is set.
        /// </summary>
        internal bool IsSetActionList() => this.ActionList != null && (this.ActionList.Count > 0 || !AWSConfigs.InitializeCollections);
