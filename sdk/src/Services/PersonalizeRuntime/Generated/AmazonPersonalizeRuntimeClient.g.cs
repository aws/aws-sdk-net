...
namespace Amazon.PersonalizeRuntime
{
    ...
    public partial class AmazonPersonalizeRuntimeClient : AmazonServiceClient, IAmazonPersonalizeRuntime
    {
        ...
        /// 
        /// </summary>
        public AmazonPersonalizeRuntimeClient() : base(new AmazonPersonalizeRuntimeConfig()) { }
        ...
        public AmazonPersonalizeRuntimeClient(RegionEndpoint region) : base(new AmazonPersonalizeRuntimeConfig { RegionEndpoint = region }) { }
        ...
        public AmazonPersonalizeRuntimeClient(AmazonPersonalizeRuntimeConfig config) : base(config) { }
