...
namespace Amazon.PersonalizeRuntime
{
    ...
    public partial class AmazonPersonalizeRuntimeConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Personalize Runtime", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "Personalize Runtime";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "personalize-runtime";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2018-05-22";
