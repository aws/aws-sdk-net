...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPersonalizeRuntimeConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPersonalizeRuntimeConfig();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPersonalizeRuntimeConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPersonalizeRuntimeConfig to create AmazonPersonalizeRuntimeClient");
            }

            return awsCredentials == null ?
                    new AmazonPersonalizeRuntimeClient(serviceClientConfig) :
                    new AmazonPersonalizeRuntimeClient(awsCredentials, serviceClientConfig);
        }
