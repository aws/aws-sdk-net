...
namespace Amazon.S3.Model
{
    ...
    public partial class GetObjectMetadataResponse : AmazonWebServiceResponse
    {
        ...
        /// <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_RestoreObject.html">RestoreObject</a>
        /// or an archive copy is already restored.
        /// </para>
        ///  
        /// <para>
        ///  If an archive copy is already restored, the header value indicates when Amazon S3
        /// is scheduled to delete the object copy. For example:
        /// </para>
        ///  
        /// <para>
        ///  <c>x-amz-restore: ongoing-request="false", expiry-date="Fri, 21 Dec 2012 00:00:00
        /// GMT"</c> 
        /// </para>
        ///  
        /// <para>
        /// If the object restoration is in progress, the header returns the value <c>ongoing-request="true"</c>.
        /// </para>
        ///  
        /// <para>
        /// For more information about archiving objects, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html#lifecycle-transition-general-considerations">Transitioning
