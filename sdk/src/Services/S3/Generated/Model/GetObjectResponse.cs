...
namespace Amazon.S3.Model
{
    ...
    public partial class GetObjectResponse : StreamResponse
    {
        ...
        private DateTime? _restoreExpiration;
        ...
        /// only present if the checksum was uploaded with the object. For more information, see
        /// <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">
        /// Checking object integrity</a> in the <i>Amazon S3 User Guide</i>.
        /// </para>
        /// </summary>
        ...
        {
            get { return this._restoreExpiration; }
            set { this._restoreExpiration = value; }
        }

        // Check to see if RestoreExpiration property is set
        internal bool IsSetRestoreExpiration()
        {
            return this._restoreExpiration != null;
        }
        ...
        {
            get { return CustomSSECustomerMethodGetter(); }
