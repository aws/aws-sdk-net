...
namespace Amazon.S3.Model
{
    ...
    {
        private BucketInfo _bucketName;
        ...
        /// To use the Local Zone location type, your account must be enabled for Dedicated Local
        /// Zones. Otherwise, you get an HTTP <c>403 Forbidden</c> error with the error code <c>AccessDenied</c>.
