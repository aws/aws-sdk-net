    ...
    public partial class PutBucketAnalyticsConfigurationRequestMarshaller : IMarshaller<IRequest, PutBucketAnalyticsConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutBucketAnalyticsConfigurationRequest publicRequest)
        {
            ...
            if (string.IsNullOrEmpty(publicRequest.AnalyticsId))
                throw new System.ArgumentException("AnalyticsId is a required property and must be set before making this call.", "PutBucketAnalyticsConfigurationRequest.AnalyticsId");
            if (publicRequest.IsSetAnalyticsId())
                request.AddSubResource("id", StringUtils.FromString(publicRequest.AnalyticsId));
            ...
            {   
                if (publicRequest.IsSetAnalyticsConfiguration())
                {
                    ...
                    if (publicRequest.AnalyticsConfiguration.AnalyticsFilter != null)
                    {
                        if (publicRequest.AnalyticsConfiguration.AnalyticsFilter.AnalyticsFilterPredicate != null)
                        {
                            xmlWriter.WriteStartElement("Filter");
                            publicRequest.AnalyticsConfiguration.AnalyticsFilter.AnalyticsFilterPredicate.Accept(new AnalyticsPredicateVisitor(xmlWriter));
