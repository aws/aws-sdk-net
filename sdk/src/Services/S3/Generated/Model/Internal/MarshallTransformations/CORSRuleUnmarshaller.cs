    ...
    public class CORSRuleUnmarshaller : IXmlUnmarshaller<CORSRule, XmlUnmarshallerContext>
    {
        ...
        public CORSRule Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("AllowedHeader/member", targetDepth))
                    {
                    ...
                    if (context.TestExpression("AllowedMethod/member", targetDepth))
                    {
                    ...
                    if (context.TestExpression("AllowedOrigin/member", targetDepth))
                    {
                    ...
                    if (context.TestExpression("ExposeHeader/member", targetDepth))
                    {
