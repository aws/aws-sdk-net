...
{
    /// <summary>
    /// Response Unmarshaller for AnalyticsS3BucketDestination Object
    /// </summary>  
    public partial class AnalyticsS3BucketDestinationUnmarshaller : IXmlUnmarshaller<AnalyticsS3BucketDestination, XmlUnmarshallerContext>
    {
        ...
        {
            AnalyticsS3BucketDestination unmarshalledObject = new AnalyticsS3BucketDestination();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        FormatCustomUnmarshall(context, unmarshalledObject);
                        continue;
                    }
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, AnalyticsS3BucketDestination unmarshalledObject, int targetDepth);

        private static AnalyticsS3BucketDestinationUnmarshaller _instance = new AnalyticsS3BucketDestinationUnmarshaller();        
