...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class PartitionedPrefixUnmarshaller : IXmlUnmarshaller<PartitionedPrefix, XmlUnmarshallerContext>
    {
        ...
        {
            PartitionedPrefix unmarshalledObject = new PartitionedPrefix();
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("PartitionDateSource", targetDepth))
                    {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PartitionedPrefixUnmarshaller Instance
        {
            get
            {
                return _instance;
