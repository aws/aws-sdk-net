...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class DeleteObjectsResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Error", targetDepth))
                    {
                        ...
                        var unmarshaller = DeleteErrorUnmarshaller.Instance;
                        response.DeleteErrors.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, DeleteObjectsResponse response);
