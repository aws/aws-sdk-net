...
{
    /// <summary>
    /// Response Unmarshaller for ListBucketMetricsConfigurations operation
    /// </summary>  
    public partial class ListBucketMetricsConfigurationsResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("MetricsConfiguration", targetDepth))
                    {
                        ...
                        response.MetricsConfigurationList.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
        ...
        internal static ListBucketMetricsConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
