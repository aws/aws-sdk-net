...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class MetadataTableConfigurationResultUnmarshaller : IXmlUnmarshaller<MetadataTableConfigurationResult, XmlUnmarshallerContext>
    {
        ...
        {
            MetadataTableConfigurationResult unmarshalledObject = new MetadataTableConfigurationResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = S3TablesDestinationResultUnmarshaller.Instance;
