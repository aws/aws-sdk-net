...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class InitiateMultipartUploadRequestMarshaller : IMarshaller<IRequest, InitiateMultipartUploadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(InitiateMultipartUploadRequest publicRequest)
        {
            ...
            {
                request.Headers["x-amz-server-side-encryption-customer-key-MD5"] = publicRequest.ServerSideEncryptionCustomerProvidedKeyMD5;
            }
            ...
            if (string.IsNullOrEmpty(publicRequest.BucketName))
                throw new System.ArgumentException("BucketName is a required property and must be set before making this call.", "CreateMultipartUploadRequest.BucketName");
            if (string.IsNullOrEmpty(publicRequest.Key))
                throw new System.ArgumentException("Key is a required property and must be set before making this call.", "CreateMultipartUploadRequest.Key");
