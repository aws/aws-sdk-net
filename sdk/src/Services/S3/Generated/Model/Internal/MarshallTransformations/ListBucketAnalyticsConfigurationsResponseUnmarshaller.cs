...
{
    /// <summary>
    /// Response Unmarshaller for ListBucketAnalyticsConfigurations operation
    /// </summary>  
    public partial class ListBucketAnalyticsConfigurationsResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("AnalyticsConfiguration", targetDepth))
                    {
                        ...
                        response.AnalyticsConfigurationList.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, ListBucketAnalyticsConfigurationsResponse response);
        ...
        internal static ListBucketAnalyticsConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
