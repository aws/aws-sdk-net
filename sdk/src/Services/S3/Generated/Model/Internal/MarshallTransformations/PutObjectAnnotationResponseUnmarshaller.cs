...
{
    /// <summary>
    /// Response Unmarshaller for PutObjectAnnotation operation
    /// </summary>  
    public partial class PutObjectAnnotationResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutObjectAnnotationResponse response = new PutObjectAnnotationResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, PutObjectAnnotationResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("AnnotationName", targetDepth))
                    {
                        ...
                        response.AnnotationName = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("AnnotationLimitExceeded"))
                {
                    return AnnotationLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("AnnotationNameTooLong"))
                {
                    return AnnotationNameTooLongExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidAnnotationName"))
                {
                    return InvalidAnnotationNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedMediaType"))
                {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, PutObjectAnnotationResponse response);

        private static PutObjectAnnotationResponseUnmarshaller _instance = new PutObjectAnnotationResponseUnmarshaller();        

        internal static PutObjectAnnotationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutObjectAnnotationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
