...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListMultipartUploadsResponseUnmarshaller : S3ReponseUnmarshaller
    {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("MaxUploads", targetDepth))
                    {
                        ...
                        response.MaxUploads = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("Upload", targetDepth))
                    {
                        ...
                        var unmarshaller = MultipartUploadUnmarshaller.Instance;
                        response.MultipartUploads.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.NextUploadIdMarker = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.UploadIdMarker = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, ListMultipartUploadsResponse response);
