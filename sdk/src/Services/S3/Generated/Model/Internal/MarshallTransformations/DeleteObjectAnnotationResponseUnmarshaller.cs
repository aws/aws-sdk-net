...
{
    /// <summary>
    /// Response Unmarshaller for DeleteObjectAnnotation operation
    /// </summary>  
    public partial class DeleteObjectAnnotationResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteObjectAnnotationResponse response = new DeleteObjectAnnotationResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, DeleteObjectAnnotationResponse response);

        private static DeleteObjectAnnotationResponseUnmarshaller _instance = new DeleteObjectAnnotationResponseUnmarshaller();        

        internal static DeleteObjectAnnotationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteObjectAnnotationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
