...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class GetObjectTorrentResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetObjectTorrentResponse response);

        private static GetObjectTorrentResponseUnmarshaller _instance = new GetObjectTorrentResponseUnmarshaller();        

        internal static GetObjectTorrentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
