...
{
    /// <summary>
    /// PutBucketAccelerateConfiguration Request Marshaller
    /// </summary>       
    public partial class PutBucketAccelerateConfigurationRequestMarshaller : IMarshaller<IRequest, PutBucketAccelerateConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IRequest Marshall(PutBucketAccelerateConfigurationRequest publicRequest)
        {
            ...
            {
#endif
                if (publicRequest.IsSetAccelerateConfiguration())
                {
                    xmlWriter.WriteStartElement("AccelerateConfiguration", "http://s3.amazonaws.com/doc/2006-03-01/");
                    if(publicRequest.AccelerateConfiguration.IsSetStatus())
                        xmlWriter.WriteElementString("Status", StringUtils.FromString(publicRequest.AccelerateConfiguration.Status));
        ...
        private static PutBucketAccelerateConfigurationRequestMarshaller _instance = new PutBucketAccelerateConfigurationRequestMarshaller();        

        internal static PutBucketAccelerateConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        partial void PostMarshallCustomization(DefaultRequest defaultRequest, PutBucketAccelerateConfigurationRequest publicRequest);
        partial void PreMarshallCustomization(DefaultRequest defaultRequest, PutBucketAccelerateConfigurationRequest publicRequest);
    }    
}