...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class CopyObjectResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            if (context.ResponseData.IsHeaderPresent("x-amz-copy-source-version-id"))
                response.SourceVersionId = context.ResponseData.GetHeaderValue("x-amz-copy-source-version-id");
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CopyObjectResponse response);
