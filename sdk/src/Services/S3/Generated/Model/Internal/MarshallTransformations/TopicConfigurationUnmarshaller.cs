...
{
    /// <summary>
    /// Response Unmarshaller for TopicConfiguration Object
    /// </summary>  
    public partial class TopicConfigurationUnmarshaller : IXmlUnmarshaller<TopicConfiguration, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            TopicConfiguration unmarshalledObject = new TopicConfiguration();
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, TopicConfiguration unmarshalledObject, int targetDepth);

        private static TopicConfigurationUnmarshaller _instance = new TopicConfigurationUnmarshaller();        
