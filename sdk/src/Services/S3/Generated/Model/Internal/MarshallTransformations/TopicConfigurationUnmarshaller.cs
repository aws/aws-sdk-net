    ...
    public class TopicConfigurationUnmarshaller : IXmlUnmarshaller<TopicConfiguration, XmlUnmarshallerContext>
    {
        ...
        public TopicConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("Event/member", targetDepth))
                    {
                        if (unmarshalledObject.Events == null)
                        {
                            unmarshalledObject.Events = new List<string>();
                        }
                    ...
                    {
                        var unmarshaller = NotificationConfigurationFilterUnmarshaller.Instance;
