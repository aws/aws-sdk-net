...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class GetBucketMetadataConfigurationRequestMarshaller : IMarshaller<IRequest, GetBucketMetadataConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetBucketMetadataConfigurationRequest)input);
        }
        ...
        internal static GetBucketMetadataConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketMetadataConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
