...
{
    /// <summary>
    /// Response Unmarshaller for CopyPartResult Object
    /// </summary>  
    public class CopyPartResultUnmarshaller : IXmlUnmarshaller<CopyPartResult, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CopyPartResult Unmarshall(XmlUnmarshallerContext context)
        {
            CopyPartResult unmarshalledObject = new CopyPartResult();
        ...
        private static CopyPartResultUnmarshaller _instance = new CopyPartResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CopyPartResultUnmarshaller Instance
        {
            get
            {
                return _instance;
