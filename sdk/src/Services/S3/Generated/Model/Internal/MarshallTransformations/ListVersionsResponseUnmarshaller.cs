...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVersionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("DeleteMarker", targetDepth))
                    {
                        ...
                        {
                            response.DeleteMarkers = new List<DeleteMarkerEntry>();
                        }
                        var unmarshaller = DeleteMarkerEntryUnmarshaller.Instance;
                        response.DeleteMarkers.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    ...
                    if (context.TestExpression("Version", targetDepth))
                    {
                        ...
                        {
                            response.Versions = new List<ObjectVersion>();
                        }
                        var unmarshaller = ObjectVersionUnmarshaller.Instance;
                        response.Versions.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                }
