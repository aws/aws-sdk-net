...
{
    /// <summary>
    /// Response Unmarshaller for InventoryFilter Object
    /// </summary>  
    public class InventoryFilterUnmarshaller : IXmlUnmarshaller<InventoryFilter, XmlUnmarshallerContext>
    {
        ...
        {
            InventoryFilter unmarshalledObject = new InventoryFilter();
        ...
        private static InventoryFilterUnmarshaller _instance = new InventoryFilterUnmarshaller();        
