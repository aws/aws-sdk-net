...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class FilterUnmarshaller : IXmlUnmarshaller<Filter, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        public Filter Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = S3KeyFilterUnmarshaller.Instance;
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, Filter unmarshalledObject, int targetDepth);
