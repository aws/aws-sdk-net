...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class PutBucketIntelligentTieringConfigurationRequestMarshaller : IMarshaller<IRequest, PutBucketIntelligentTieringConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutBucketIntelligentTieringConfigurationRequest publicRequest)
        {
            ...
            if (publicRequest.IntelligentTieringConfiguration == null)
            ...
            {   
                if (publicRequest.IsSetIntelligentTieringConfiguration())
                {
                    ...
                    if (publicRequest.IntelligentTieringConfiguration.IntelligentTieringFilter != null)
                    {
                        if (publicRequest.IntelligentTieringConfiguration.IntelligentTieringFilter.IntelligentTieringFilterPredicate != null)
                        {
                            xmlWriter.WriteStartElement("Filter");
                            publicRequest.IntelligentTieringConfiguration.IntelligentTieringFilter.IntelligentTieringFilterPredicate.Accept(new IntelligentTieringPredicateVisitor(xmlWriter));
