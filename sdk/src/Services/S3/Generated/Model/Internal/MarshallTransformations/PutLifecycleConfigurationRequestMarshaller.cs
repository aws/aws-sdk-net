                ...
                if (publicRequest.IsSetConfiguration())
                {
                    ...
                    if (publicRequestConfigurationRules != null && (publicRequestConfigurationRules.Count > 0 || !AWSConfigs.InitializeCollections)) 
                    {
                        ...
                        if (publicRequestConfigurationRulesValue != null)
                        {
                            ...
                            if (publicRequestConfigurationRulesValue.NoncurrentVersionTransition != null)
                            {
                                xmlWriter.WriteStartElement("NoncurrentVersionTransition");
                                if(publicRequestConfigurationRulesValue.NoncurrentVersionTransition.IsSetNewerNoncurrentVersions())
                                    xmlWriter.WriteElementString("NewerNoncurrentVersions", StringUtils.FromInt(publicRequestConfigurationRulesValue.NoncurrentVersionTransition.NewerNoncurrentVersions.Value));
                                if(publicRequestConfigurationRulesValue.NoncurrentVersionTransition.IsSetNoncurrentDays())
                                    xmlWriter.WriteElementString("NoncurrentDays", StringUtils.FromInt(publicRequestConfigurationRulesValue.NoncurrentVersionTransition.NoncurrentDays.Value));
                                if(publicRequestConfigurationRulesValue.NoncurrentVersionTransition.IsSetStorageClass())
                                    xmlWriter.WriteElementString("StorageClass", StringUtils.FromString(publicRequestConfigurationRulesValue.NoncurrentVersionTransition.StorageClass));
                                xmlWriter.WriteEndElement();
                            }
                            ...
                            if (publicRequestConfigurationRulesValue.Transition != null)
                            {
                                xmlWriter.WriteStartElement("Transition");
                                if(publicRequestConfigurationRulesValue.Transition.IsSetDate())
                                    xmlWriter.WriteElementString("Date", StringUtils.FromDateTimeToISO8601WithOptionalMs(publicRequestConfigurationRulesValue.Transition.Date.Value));
                                if(publicRequestConfigurationRulesValue.Transition.IsSetDays())
                                    xmlWriter.WriteElementString("Days", StringUtils.FromInt(publicRequestConfigurationRulesValue.Transition.Days.Value));
                                if(publicRequestConfigurationRulesValue.Transition.IsSetStorageClass())
                                    xmlWriter.WriteElementString("StorageClass", StringUtils.FromString(publicRequestConfigurationRulesValue.Transition.StorageClass));
                                xmlWriter.WriteEndElement();
                            }
                            xmlWriter.WriteEndElement();
                        }
