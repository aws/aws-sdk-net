...
namespace Amazon.S3.Model
{
    ...
    public partial class LoggingEnabled
    {
        ...
        private List<TargetGrant> _targetGrants = AWSConfigs.InitializeCollections ? new List<TargetGrant>() : null;
        ...
        /// <summary>
        /// Gets and sets the property TargetGrants. 
        /// <para>
        ...
        {
            get { return this._targetGrants; }
            set { this._targetGrants = value; }
        }

        // Check to see if TargetGrants property is set
        internal bool IsSetTargetGrants()
        {
            return this._targetGrants != null && (this._targetGrants.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
