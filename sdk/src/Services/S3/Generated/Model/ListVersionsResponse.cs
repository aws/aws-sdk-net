...
namespace Amazon.S3.Model
{
    ...
    public partial class ListVersionsResponse : AmazonWebServiceResponse
    {
        ...
        private List<DeleteMarkerEntry> _deleteMarkers = AWSConfigs.InitializeCollections ? new List<DeleteMarkerEntry>() : null;
        ...
        private List<ObjectVersion> _versions = AWSConfigs.InitializeCollections ? new List<ObjectVersion>() : null;
        ...
        /// <summary>
        /// Gets and sets the property DeleteMarkers. 
        /// <para>
        /// Container for an object that is a delete marker. To learn more about delete markers,
        /// see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/DeleteMarker.html">Working
        /// with delete markers</a>.
        /// </para>
        /// </summary>
        public List<DeleteMarkerEntry> DeleteMarkers
        {
            get { return this._deleteMarkers; }
            set { this._deleteMarkers = value; }
        }

        // Check to see if DeleteMarkers property is set
        internal bool IsSetDeleteMarkers()
        {
            return this._deleteMarkers != null && (this._deleteMarkers.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
