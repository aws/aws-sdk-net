...
namespace Amazon.S3.Model
{
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class PutBucketLoggingRequest : AmazonS3Request
    {
        private BucketLoggingStatus _bucketLoggingStatus;
        ...
        /// <summary>
        /// Gets and sets the property BucketLoggingStatus. 
        /// <para>
        ...
        {
            get { return this._bucketLoggingStatus; }
            set { this._bucketLoggingStatus = value; }
        }

        // Check to see if BucketLoggingStatus property is set
        internal bool IsSetBucketLoggingStatus()
        {
            return this._bucketLoggingStatus != null;
        }
