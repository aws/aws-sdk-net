...
namespace Amazon.S3
{
    public sealed partial class S3Region
    {
        ...
        /// <summary>
        /// Specifies that the S3 Bucket should use the ap-east-2 locality.
        /// </summary>
        public static readonly S3Region APEast2 = new S3Region("ap-east-2");
        ...
        /// <summary>
        /// Specifies that the S3 Bucket should use the ap-southeast-5 locality.
        /// </summary>
        public static readonly S3Region APSoutheast5 = new S3Region("ap-southeast-5");

        /// <summary>
        /// Specifies that the S3 Bucket should use the ap-southeast-6 locality.
        /// </summary>
        public static readonly S3Region APSoutheast6 = new S3Region("ap-southeast-6");
        ...
        /// <summary>
        /// Specifies that the S3 Bucket should use the us-isob-west-1 locality.
        /// </summary>
        public static readonly S3Region USIsobWest1 = new S3Region("us-isob-west-1");

        /// <summary>
        /// Specifies that the S3 Bucket should use the eu-isoe-west-1 locality.
        /// </summary>
        public static readonly S3Region EUIsoeWest1 = new S3Region("eu-isoe-west-1");

        /// <summary>
        /// Specifies that the S3 Bucket should use the us-isof-east-1 locality.
        /// </summary>
        public static readonly S3Region USIsofEast1 = new S3Region("us-isof-east-1");

        /// <summary>
        /// Specifies that the S3 Bucket should use the us-isof-south-1 locality.
        /// </summary>
