...
namespace Amazon.S3.Model
{
    ...
    public partial class CopyPartRequest : AmazonWebServiceRequest
    {
        ...
        /// <note> 
        /// <para>
        /// Copying objects across different Amazon Web Services Regions isn't supported when the source or destination bucket is in Amazon Web Services 
        /// Local Zones. The source and destination buckets must have the same parent Amazon Web Services Region. Otherwise, you get an 
        /// HTTP <c>400 Bad Request</c> error with the error code <c>InvalidRequest</c>.
        /// </para> 
        /// </note> 
        /// <para> 
