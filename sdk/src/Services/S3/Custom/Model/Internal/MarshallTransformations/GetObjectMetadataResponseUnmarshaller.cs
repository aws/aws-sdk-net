...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public class GetObjectMetadataResponseUnmarshaller : S3ReponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context,GetObjectMetadataResponse response)
        {
            ...
            if (responseData.IsHeaderPresent("x-amz-checksum-md5"))
                response.ChecksumMD5 = responseData.GetHeaderValue("x-amz-checksum-md5");
            if (responseData.IsHeaderPresent("x-amz-checksum-sha512"))
                response.ChecksumSHA512 = responseData.GetHeaderValue("x-amz-checksum-sha512");
            if (responseData.IsHeaderPresent("x-amz-checksum-xxhash128"))
                response.ChecksumXXHASH128 = responseData.GetHeaderValue("x-amz-checksum-xxhash128");
            if (responseData.IsHeaderPresent("x-amz-checksum-xxhash3"))
                response.ChecksumXXHASH3 = responseData.GetHeaderValue("x-amz-checksum-xxhash3");
            if (responseData.IsHeaderPresent("x-amz-checksum-xxhash64"))
                response.ChecksumXXHASH64 = responseData.GetHeaderValue("x-amz-checksum-xxhash64");
