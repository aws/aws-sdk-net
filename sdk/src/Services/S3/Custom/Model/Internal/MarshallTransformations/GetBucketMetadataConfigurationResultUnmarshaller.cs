...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBucketMetadataConfigurationResultUnmarshaller : IUnmarshaller<GetBucketMetadataConfigurationResult, XmlUnmarshallerContext>, IUnmarshaller<GetBucketMetadataConfigurationResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public GetBucketMetadataConfigurationResult Unmarshall(JsonUnmarshallerContext context)
        {
