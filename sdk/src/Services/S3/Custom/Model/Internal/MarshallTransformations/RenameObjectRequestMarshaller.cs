    ...
    public class RenameObjectRequestMarshaller : IMarshaller<IRequest, RenameObjectRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(RenameObjectRequest renameObjectRequest)
        {
            ...
            if (!renameObjectRequest.IsSetBucketName())
                throw new ArgumentException("BucketName is a required property and must be set before making this call.", "RenameObjectRequest.BucketName");
            if (!renameObjectRequest.IsSetKey())
                throw new ArgumentException("Key is a required property and must be set before making this call.", "RenameObjectRequest.Key");
            if (!renameObjectRequest.IsSetRenameSource())
                throw new ArgumentException("RenameSource is a required property and must be set before making this call.", "RenameObjectRequest.RenameSource");
