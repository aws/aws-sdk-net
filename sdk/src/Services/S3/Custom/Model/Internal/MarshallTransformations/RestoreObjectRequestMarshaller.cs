...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class RestoreObjectRequestMarshaller : IMarshaller<IRequest, RestoreObjectRequest> ,IMarshaller<IRequest,Amazon.Runtime.AmazonWebServiceRequest>
    {
        ...
        // Tier needs a custom marshall because GlacierJobParameters on RestoreRequest has been flattened and moved up to the parent. However, since the modeled name of the property is "Tier" 
        // and a "Tier" already exists in RestoreRequest, a customization renaming "Tier" to something else will affect both properties and therefore this just needs a custom marshall.
