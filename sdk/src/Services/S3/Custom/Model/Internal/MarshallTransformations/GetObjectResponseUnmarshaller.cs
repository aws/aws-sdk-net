...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetObjectResponseUnmarshaller : S3ReponseUnmarshaller
    {
        void MetadataCustomUnmarshall(XmlUnmarshallerContext context, GetObjectResponse response)
        {
        ...
        void RestoreExpirationCustomUnmarshall(XmlUnmarshallerContext context, GetObjectResponse response)
        {
            var responseData = context.ResponseData;
