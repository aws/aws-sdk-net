...
namespace Amazon.S3.Transfer.Internal
{
    ...
    /// 3. Add buffered part: await <see cref="AddBufferAsync(StreamPartBuffer, CancellationToken)"/>
    ...
    internal class PartBufferManager : IPartBufferManager
    {
        ...
        /// <inheritdoc/>
        public Task AddBufferAsync(IPartDataSource dataSource, CancellationToken cancellationToken)
        {
            ThrowIfDisposed();
            ...
            return AddDataSourceAsync(dataSource, cancellationToken);
        }
