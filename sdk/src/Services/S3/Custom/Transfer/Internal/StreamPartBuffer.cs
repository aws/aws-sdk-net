...
namespace Amazon.S3.Transfer.Internal
{
    ...
    internal class StreamPartBuffer : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the actual length of valid data in the ArrayPool buffer.
        ...
        /// </summary>
        public int RemainingBytes => Math.Max(0, ActualDataLength - CurrentPosition);

        /// <summary>
        /// Gets the total length of valid data in the buffer.
        /// Compatibility property for unified pattern implementation.
        /// </summary>
        public int Length => ActualDataLength;

        /// <summary>
        /// Gets the actual size of the part data.
        /// Alias for ActualDataLength for compatibility.
        /// </summary>
        public int ActualSize => ActualDataLength;
        ...
        /// <param name="actualDataLength">The actual length of valid data in the buffer</param>
        public StreamPartBuffer(int partNumber, byte[] arrayPoolBuffer, int actualDataLength)
        {
        ...
        /// <summary>
        /// Creates a StreamPartBuffer from ArrayPool buffer (unified pattern factory method).
        ...
        public static StreamPartBuffer FromArrayPoolBuffer(int partNumber, byte[] arrayPoolBuffer, int actualDataLength)
        {
        ...
        {
            return $"StreamPartBuffer(Part={PartNumber}, ArrayPool={ActualDataLength} bytes, pos={CurrentPosition}, remaining={RemainingBytes})";
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposed && disposing)
            {
                ...
                catch (Exception)
                {
                    ...
                    // If disposal fails, continue cleanup process
                    #pragma warning disable CA1031
                    // Intentionally swallowing exception during dispose
