...
{
    /// <summary>
    /// Base class for single-object download commands that provides common functionality 
    /// for converting TransferUtility requests to S3 GetObjectRequests.
    /// </summary>
    internal abstract partial class BaseDownloadCommand : BaseCommand
    {
        /// <summary>
        /// Converts a BaseDownloadRequest to a GetObjectRequest for single-object operations.
        /// </summary>
        /// <param name="request">The transfer utility download request to convert.</param>
        /// <returns>A configured GetObjectRequest ready for execution.</returns>
