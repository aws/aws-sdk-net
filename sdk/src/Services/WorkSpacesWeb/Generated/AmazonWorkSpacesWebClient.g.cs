...
namespace Amazon.WorkSpacesWeb
{
    ...
    public partial class AmazonWorkSpacesWebClient : AmazonServiceClient, IAmazonWorkSpacesWeb
    {
        ...
        /// 
        /// </summary>
        public AmazonWorkSpacesWebClient() : base(new AmazonWorkSpacesWebConfig()) { }
        ...
        public AmazonWorkSpacesWebClient(RegionEndpoint region) : base(new AmazonWorkSpacesWebConfig { RegionEndpoint = region }) { }
        ...
        public AmazonWorkSpacesWebClient(AmazonWorkSpacesWebConfig config) : base(config) { }
