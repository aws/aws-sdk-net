...
namespace Amazon.WorkSpacesWeb
{
    ...
    public partial class AmazonWorkSpacesWebConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("WorkSpaces Web", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "WorkSpaces Web";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "workspaces-web";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-07-08";
