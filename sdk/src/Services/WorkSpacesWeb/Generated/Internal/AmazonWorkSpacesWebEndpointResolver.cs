...
{
    /// <summary>
    /// Amazon WorkSpacesWeb endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for WorkSpacesWeb service requests.
    /// Collects values for WorkSpacesWebEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses WorkSpacesWebEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonWorkSpacesWebEndpointResolver : BaseEndpointResolver
    {
