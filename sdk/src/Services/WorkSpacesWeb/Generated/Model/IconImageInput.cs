...
{
    /// <summary>
    /// The input for an icon image (logo or favicon). Provide either a binary image file
    /// or an S3 URI pointing to the image file. Maximum 100 KB in JPEG, PNG, or ICO format.
    /// </summary>
    public partial class IconImageInput
    {
