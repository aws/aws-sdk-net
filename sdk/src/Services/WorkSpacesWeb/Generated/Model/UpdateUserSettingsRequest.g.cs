...
{
    /// <summary>
    /// Container for the parameters to the UpdateUserSettings operation. Updates the user
    /// settings.
    /// </summary>
    public partial class UpdateUserSettingsRequest : AmazonWorkSpacesWebRequest
    {
        ...
        /// fields (logo, favicon, localized strings, and color theme) are required except for
        /// wallpaper and terms of service. When updating user settings with an existing branding
        /// configuration, all fields are optional.
        /// </para>
        /// </summary>
        public BrandingConfigurationUpdateInput BrandingConfigurationInput { get; set; }

        /// <summary>
        /// Checks to see if the BrandingConfigurationInput property is set.
        /// </summary>
        internal bool IsSetBrandingConfigurationInput() => this.BrandingConfigurationInput != null;
