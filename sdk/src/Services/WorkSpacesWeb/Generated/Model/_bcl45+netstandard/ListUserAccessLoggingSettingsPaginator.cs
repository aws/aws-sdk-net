...
namespace Amazon.WorkSpacesWeb.Model
{
    ...
    internal sealed partial class ListUserAccessLoggingSettingsPaginator : IPaginator<ListUserAccessLoggingSettingsResponse>, IListUserAccessLoggingSettingsPaginator
    {
        ...
        async IAsyncEnumerable<ListUserAccessLoggingSettingsResponse> IPaginator<ListUserAccessLoggingSettingsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
