...
{
    /// <summary>
    /// Container for the parameters to the CreateBrowserSettings operation. Creates a browser
    /// settings resource that can be associated with a web portal. Once associated with a
    /// web portal, browser settings control how the browser will behave once a user starts
