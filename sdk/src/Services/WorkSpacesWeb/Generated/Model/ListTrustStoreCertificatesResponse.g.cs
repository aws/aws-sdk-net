...
namespace Amazon.WorkSpacesWeb.Model
{
    ...
    public partial class ListTrustStoreCertificatesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<CertificateSummary> CertificateList { get; set; } = AWSConfigs.InitializeCollections ? new List<CertificateSummary>() : null;

        /// <summary>
        /// Checks to see if the CertificateList property is set.
        /// </summary>
        internal bool IsSetCertificateList() => this.CertificateList != null && (this.CertificateList.Count > 0 || !AWSConfigs.InitializeCollections);
