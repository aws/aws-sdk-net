...
{
    /// <summary>
    /// The input configuration for updating branding settings. All fields are optional when
    /// updating existing branding.
    /// </summary>
    public partial class BrandingConfigurationUpdateInput
    {
        /// <summary>
        ...
        /// <para>
        /// The terms of service text in Markdown format. To remove existing terms of service,
