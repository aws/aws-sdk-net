...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSessionLoggerRequestMarshaller : IMarshaller<IRequest, GetSessionLoggerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSessionLoggerRequestMarshaller _instance = new();

        internal static GetSessionLoggerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSessionLoggerRequestMarshaller Instance => _instance;
    }
}
