...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateUserAccessLoggingSettingsRequestMarshaller : IMarshaller<IRequest, UpdateUserAccessLoggingSettingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateUserAccessLoggingSettingsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetKinesisStreamArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.KinesisStreamArn);
            }
        ...
        private static readonly UpdateUserAccessLoggingSettingsRequestMarshaller _instance = new();

        internal static UpdateUserAccessLoggingSettingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateUserAccessLoggingSettingsRequestMarshaller Instance => _instance;
    }
}
