...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IpAccessSettingsUnmarshaller : IJsonUnmarshaller<IpAccessSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IpAccessSettings();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ipRules", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static IpAccessSettingsUnmarshaller Instance => _instance;
    }
}
