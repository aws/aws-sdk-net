...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UserAccessLoggingSettingsUnmarshaller : IJsonUnmarshaller<UserAccessLoggingSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public UserAccessLoggingSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new UserAccessLoggingSettings();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UserAccessLoggingSettingsUnmarshaller Instance => _instance;
    }
}
