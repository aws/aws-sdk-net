...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SessionUnmarshaller : IJsonUnmarshaller<Session, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Session();
            ...
            {
                if (context.TestExpression("clientIpAddresses", targetDepth, ref reader))
                {
