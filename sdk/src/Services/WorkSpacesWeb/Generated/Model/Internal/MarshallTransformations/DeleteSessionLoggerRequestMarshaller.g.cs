...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteSessionLoggerRequestMarshaller : IMarshaller<IRequest, DeleteSessionLoggerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteSessionLoggerRequestMarshaller _instance = new();

        internal static DeleteSessionLoggerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSessionLoggerRequestMarshaller Instance => _instance;
    }
}
