...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ToolbarConfigurationUnmarshaller : IJsonUnmarshaller<ToolbarConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ToolbarConfiguration();
            ...
            {
                if (context.TestExpression("hiddenToolbarItems", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("maxDisplayResolution", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("toolbarType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("visualMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ToolbarConfigurationUnmarshaller Instance => _instance;
    }
}
