...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TrustStoreUnmarshaller : IJsonUnmarshaller<TrustStore, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TrustStore Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TrustStore();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TrustStoreUnmarshaller Instance => _instance;
    }
}
