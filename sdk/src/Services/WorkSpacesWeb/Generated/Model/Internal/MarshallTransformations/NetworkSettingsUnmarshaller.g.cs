...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NetworkSettingsUnmarshaller : IJsonUnmarshaller<NetworkSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public NetworkSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new NetworkSettings();
        ...
        /// Gets the singleton.
        /// </summary>
        public static NetworkSettingsUnmarshaller Instance => _instance;
    }
}
