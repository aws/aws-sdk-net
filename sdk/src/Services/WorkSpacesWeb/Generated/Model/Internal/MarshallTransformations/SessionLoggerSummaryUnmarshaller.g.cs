...
{
    /// <summary>
    /// Response Unmarshaller for SessionLoggerSummary Object
    /// </summary>
    public partial class SessionLoggerSummaryUnmarshaller : IJsonUnmarshaller<SessionLoggerSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SessionLoggerSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SessionLoggerSummary();
        ...
        private static SessionLoggerSummaryUnmarshaller _instance = new SessionLoggerSummaryUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SessionLoggerSummaryUnmarshaller Instance => _instance;
    }
}
