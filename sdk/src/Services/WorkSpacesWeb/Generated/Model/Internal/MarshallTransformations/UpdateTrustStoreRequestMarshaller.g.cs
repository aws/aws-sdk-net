    ...
    public partial class UpdateTrustStoreRequestMarshaller : IMarshaller<IRequest, UpdateTrustStoreRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateTrustStoreRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetCertificatesToAdd())
            {
                ...
                {
                    StringUtils.WriteBase64StringValue(context.Writer, publicRequestCertificatesToAddListValue);
                }
        ...
        private static readonly UpdateTrustStoreRequestMarshaller _instance = new();

        internal static UpdateTrustStoreRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateTrustStoreRequestMarshaller Instance => _instance;
    }
}
