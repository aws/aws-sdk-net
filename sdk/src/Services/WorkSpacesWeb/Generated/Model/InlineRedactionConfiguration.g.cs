...
namespace Amazon.WorkSpacesWeb.Model
{
    ...
    public partial class InlineRedactionConfiguration
    {
        ...
        public int? GlobalConfidenceLevel { get; set; }

        /// <summary>
        /// Checks to see if the GlobalConfidenceLevel property is set.
        /// </summary>
        internal bool IsSetGlobalConfidenceLevel() => this.GlobalConfidenceLevel.HasValue;
        ...
        public List<string> GlobalEnforcedUrls { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the GlobalEnforcedUrls property is set.
        /// </summary>
        internal bool IsSetGlobalEnforcedUrls() => this.GlobalEnforcedUrls != null && (this.GlobalEnforcedUrls.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 100)]
        public List<string> GlobalExemptUrls { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the GlobalExemptUrls property is set.
        /// </summary>
        internal bool IsSetGlobalExemptUrls() => this.GlobalExemptUrls != null && (this.GlobalExemptUrls.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public List<InlineRedactionPattern> InlineRedactionPatterns { get; set; } = AWSConfigs.InitializeCollections ? new List<InlineRedactionPattern>() : null;

        /// <summary>
        /// Checks to see if the InlineRedactionPatterns property is set.
        /// </summary>
        internal bool IsSetInlineRedactionPatterns() => this.InlineRedactionPatterns != null && (this.InlineRedactionPatterns.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
