...
{
    /// <summary>
    /// Container for the parameters to the CreateUserSettings operation. Creates a user settings
    /// resource that can be associated with a web portal. Once associated with a web portal,
    /// user settings control how users can transfer data between a streaming session and
    /// the their local devices.
    /// </summary>
    public partial class CreateUserSettingsRequest : AmazonWorkSpacesWebRequest
    {
        ...
        /// </para>
        /// </summary>
        public BrandingConfigurationCreateInput BrandingConfigurationInput { get; set; }
