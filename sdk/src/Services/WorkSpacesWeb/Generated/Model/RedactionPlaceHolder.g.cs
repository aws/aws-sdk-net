...
namespace Amazon.WorkSpacesWeb.Model
{
    ...
    public partial class RedactionPlaceHolder
    {
        ...
        /// <summary>
        /// Checks to see if the RedactionPlaceHolderText property is set.
        /// </summary>
        internal bool IsSetRedactionPlaceHolderText() => this.RedactionPlaceHolderText != null;
        ...
        public RedactionPlaceHolderType RedactionPlaceHolderType { get; set; }

        /// <summary>
        /// Checks to see if the RedactionPlaceHolderType property is set.
        /// </summary>
        internal bool IsSetRedactionPlaceHolderType() => this.RedactionPlaceHolderType != null;
    }
}
