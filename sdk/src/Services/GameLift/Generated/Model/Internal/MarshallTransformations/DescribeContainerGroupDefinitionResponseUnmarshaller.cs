...
{
    /// <summary>
    /// Response Unmarshaller for DescribeContainerGroupDefinition operation
    /// </summary>  
    public class DescribeContainerGroupDefinitionResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeContainerGroupDefinitionResponse response = new DescribeContainerGroupDefinitionResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeContainerGroupDefinition");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ContainerGroupDefinition":
                        {
                            context.AddPathSegment("ContainerGroupDefinition");
                            var unmarshaller = ContainerGroupDefinitionUnmarshaller.Instance;
                            response.ContainerGroupDefinition = unmarshaller.Unmarshall(context);
        ...
        private static DescribeContainerGroupDefinitionResponseUnmarshaller _instance = new DescribeContainerGroupDefinitionResponseUnmarshaller();        

        internal static DescribeContainerGroupDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeContainerGroupDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
