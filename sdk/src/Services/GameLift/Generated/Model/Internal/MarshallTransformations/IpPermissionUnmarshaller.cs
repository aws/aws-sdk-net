...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IpPermissionUnmarshaller : ICborUnmarshaller<IpPermission, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public IpPermission Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "IpRange":
                        {
                            context.AddPathSegment("IpRange");
