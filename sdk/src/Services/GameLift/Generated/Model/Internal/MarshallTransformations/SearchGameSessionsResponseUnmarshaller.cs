...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SearchGameSessionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("SearchGameSessions");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameSessions":
                        {
                            context.AddPathSegment("GameSessions");
                            var unmarshaller = new CborListUnmarshaller<GameSession, GameSessionUnmarshaller>(GameSessionUnmarshaller.Instance);
