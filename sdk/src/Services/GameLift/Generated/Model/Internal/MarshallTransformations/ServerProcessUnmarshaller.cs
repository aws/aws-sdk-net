...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServerProcessUnmarshaller : ICborUnmarshaller<ServerProcess, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServerProcess Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ConcurrentExecutions":
                        {
                            context.AddPathSegment("ConcurrentExecutions");
                    ...
                    case "LaunchPath":
                        {
                            context.AddPathSegment("LaunchPath");
                    ...
                    case "Parameters":
                        {
                            context.AddPathSegment("Parameters");
                            var unmarshaller = CborStringUnmarshaller.Instance;
