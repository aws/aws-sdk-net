...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PingBeaconUnmarshaller : ICborUnmarshaller<PingBeacon, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public PingBeacon Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "UDPEndpoint":
                        {
                            context.AddPathSegment("UDPEndpoint");
