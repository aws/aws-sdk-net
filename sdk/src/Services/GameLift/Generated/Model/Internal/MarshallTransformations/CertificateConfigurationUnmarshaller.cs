...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CertificateConfigurationUnmarshaller : ICborUnmarshaller<CertificateConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public CertificateConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "CertificateType":
                        {
                            context.AddPathSegment("CertificateType");
