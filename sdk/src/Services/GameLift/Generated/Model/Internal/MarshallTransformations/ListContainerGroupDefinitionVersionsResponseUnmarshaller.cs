...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListContainerGroupDefinitionVersionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListContainerGroupDefinitionVersions");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ContainerGroupDefinitions":
                        {
                            context.AddPathSegment("ContainerGroupDefinitions");
                            var unmarshaller = new CborListUnmarshaller<ContainerGroupDefinition, ContainerGroupDefinitionUnmarshaller>(ContainerGroupDefinitionUnmarshaller.Instance);
                            response.ContainerGroupDefinitions = unmarshaller.Unmarshall(context);
