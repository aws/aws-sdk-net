...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeGameSessionQueuesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeGameSessionQueues");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameSessionQueues":
                        {
                            context.AddPathSegment("GameSessionQueues");
                            var unmarshaller = new CborListUnmarshaller<GameSessionQueue, GameSessionQueueUnmarshaller>(GameSessionQueueUnmarshaller.Instance);
