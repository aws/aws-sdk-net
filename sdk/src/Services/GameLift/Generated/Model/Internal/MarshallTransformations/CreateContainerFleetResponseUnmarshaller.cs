...
{
    /// <summary>
    /// Response Unmarshaller for CreateContainerFleet operation
    /// </summary>  
    public class CreateContainerFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContainerFleetResponse response = new CreateContainerFleetResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateContainerFleet");
            reader.ReadStartMap();
        ...
        private static CreateContainerFleetResponseUnmarshaller _instance = new CreateContainerFleetResponseUnmarshaller();        

        internal static CreateContainerFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContainerFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
