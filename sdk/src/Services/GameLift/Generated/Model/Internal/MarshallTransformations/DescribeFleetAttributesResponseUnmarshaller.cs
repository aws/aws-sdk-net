...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeFleetAttributesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeFleetAttributes");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "FleetAttributes":
                        {
                            context.AddPathSegment("FleetAttributes");
                            var unmarshaller = new CborListUnmarshaller<FleetAttributes, FleetAttributesUnmarshaller>(FleetAttributesUnmarshaller.Instance);
