...
{
    /// <summary>
    /// Response Unmarshaller for DescribeContainerFleet operation
    /// </summary>  
    public class DescribeContainerFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeContainerFleetResponse response = new DescribeContainerFleetResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeContainerFleet");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ContainerFleet":
                        {
                            context.AddPathSegment("ContainerFleet");
                            var unmarshaller = ContainerFleetUnmarshaller.Instance;
                            response.ContainerFleet = unmarshaller.Unmarshall(context);
        ...
        private static DescribeContainerFleetResponseUnmarshaller _instance = new DescribeContainerFleetResponseUnmarshaller();        

        internal static DescribeContainerFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeContainerFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
