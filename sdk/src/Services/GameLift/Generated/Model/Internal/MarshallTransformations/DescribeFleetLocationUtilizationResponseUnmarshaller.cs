...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFleetLocationUtilization operation
    /// </summary>  
    public class DescribeFleetLocationUtilizationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFleetLocationUtilizationResponse response = new DescribeFleetLocationUtilizationResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeFleetLocationUtilization");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "FleetUtilization":
                        {
                            context.AddPathSegment("FleetUtilization");
                            var unmarshaller = FleetUtilizationUnmarshaller.Instance;
                            response.FleetUtilization = unmarshaller.Unmarshall(context);
        ...
        private static DescribeFleetLocationUtilizationResponseUnmarshaller _instance = new DescribeFleetLocationUtilizationResponseUnmarshaller();        

        internal static DescribeFleetLocationUtilizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFleetLocationUtilizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
