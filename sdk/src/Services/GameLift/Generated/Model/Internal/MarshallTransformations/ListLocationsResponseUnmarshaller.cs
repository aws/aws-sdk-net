...
{
    /// <summary>
    /// Response Unmarshaller for ListLocations operation
    /// </summary>  
    public class ListLocationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListLocations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Locations":
                        {
                            context.AddPathSegment("Locations");
                            var unmarshaller = new CborListUnmarshaller<LocationModel, LocationModelUnmarshaller>(LocationModelUnmarshaller.Instance);
        ...
        private static ListLocationsResponseUnmarshaller _instance = new ListLocationsResponseUnmarshaller();        

        internal static ListLocationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
