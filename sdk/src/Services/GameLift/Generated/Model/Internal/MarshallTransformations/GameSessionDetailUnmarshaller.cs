...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GameSessionDetailUnmarshaller : ICborUnmarshaller<GameSessionDetail, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public GameSessionDetail Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "ProtectionPolicy":
                        {
                            context.AddPathSegment("ProtectionPolicy");
