...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeVpcPeeringConnectionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeVpcPeeringConnections");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "VpcPeeringConnections":
                        {
                            context.AddPathSegment("VpcPeeringConnections");
                            var unmarshaller = new CborListUnmarshaller<VpcPeeringConnection, VpcPeeringConnectionUnmarshaller>(VpcPeeringConnectionUnmarshaller.Instance);
