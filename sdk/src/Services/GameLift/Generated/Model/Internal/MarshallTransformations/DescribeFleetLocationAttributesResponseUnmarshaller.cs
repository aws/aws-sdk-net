...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeFleetLocationAttributesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeFleetLocationAttributes");
            reader.ReadStartMap();
                    ...
                    case "LocationAttributes":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<LocationAttributes, LocationAttributesUnmarshaller>(LocationAttributesUnmarshaller.Instance);
                            response.LocationAttributes = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "NextToken":
