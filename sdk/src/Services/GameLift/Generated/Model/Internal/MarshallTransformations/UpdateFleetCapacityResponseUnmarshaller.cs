...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFleetCapacity operation
    /// </summary>  
    public class UpdateFleetCapacityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFleetCapacityResponse response = new UpdateFleetCapacityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FleetArn", targetDepth))
                {
                    ...
                    response.FleetArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ManagedCapacityConfiguration", targetDepth))
                {
                    ...
                    response.ManagedCapacityConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InvalidFleetStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return UnsupportedRegionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static UpdateFleetCapacityResponseUnmarshaller _instance = new UpdateFleetCapacityResponseUnmarshaller();        

        internal static UpdateFleetCapacityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFleetCapacityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
