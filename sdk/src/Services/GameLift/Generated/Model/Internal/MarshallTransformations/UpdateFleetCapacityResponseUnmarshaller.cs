...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateFleetCapacityResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("UpdateFleetCapacity");
            reader.ReadStartMap();
                    ...
                    case "ManagedCapacityConfiguration":
                        {
                            ...
                            response.ManagedCapacityConfiguration = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new CborUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InvalidFleetStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
