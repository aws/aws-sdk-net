...
{
    /// <summary>
    /// Response Unmarshaller for StopFleetActions operation
    /// </summary>  
    public class StopFleetActionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopFleetActionsResponse response = new StopFleetActionsResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopFleetActions");
            reader.ReadStartMap();
        ...
        private static StopFleetActionsResponseUnmarshaller _instance = new StopFleetActionsResponseUnmarshaller();        

        internal static StopFleetActionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopFleetActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
