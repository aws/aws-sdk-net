...
{
    /// <summary>
    /// Response Unmarshaller for RegisterCompute operation
    /// </summary>  
    public class RegisterComputeResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterComputeResponse response = new RegisterComputeResponse();
            var reader = context.Reader;
            context.AddPathSegment("RegisterCompute");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Compute":
                        {
                            context.AddPathSegment("Compute");
        ...
        private static RegisterComputeResponseUnmarshaller _instance = new RegisterComputeResponseUnmarshaller();        

        internal static RegisterComputeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterComputeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
