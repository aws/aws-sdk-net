...
{
    /// <summary>
    /// Response Unmarshaller for CreateMatchmakingRuleSet operation
    /// </summary>  
    public class CreateMatchmakingRuleSetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMatchmakingRuleSetResponse response = new CreateMatchmakingRuleSetResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateMatchmakingRuleSet");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "RuleSet":
                        {
                            context.AddPathSegment("RuleSet");
                            var unmarshaller = MatchmakingRuleSetUnmarshaller.Instance;
                            response.RuleSet = unmarshaller.Unmarshall(context);
        ...
        private static CreateMatchmakingRuleSetResponseUnmarshaller _instance = new CreateMatchmakingRuleSetResponseUnmarshaller();        

        internal static CreateMatchmakingRuleSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMatchmakingRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
