...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFleetPortSettings operation
    /// </summary>  
    public class DescribeFleetPortSettingsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFleetPortSettingsResponse response = new DescribeFleetPortSettingsResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeFleetPortSettings");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "InboundPermissions":
                        {
                            context.AddPathSegment("InboundPermissions");
        ...
        private static DescribeFleetPortSettingsResponseUnmarshaller _instance = new DescribeFleetPortSettingsResponseUnmarshaller();        

        internal static DescribeFleetPortSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFleetPortSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
