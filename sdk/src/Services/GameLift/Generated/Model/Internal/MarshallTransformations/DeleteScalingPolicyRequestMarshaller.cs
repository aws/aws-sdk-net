...
{
    /// <summary>
    /// DeleteScalingPolicy Request Marshaller
    /// </summary>       
    public class DeleteScalingPolicyRequestMarshaller : IMarshaller<IRequest, DeleteScalingPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteScalingPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteScalingPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.GameLift");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/GameLift/operation/DeleteScalingPolicy";
