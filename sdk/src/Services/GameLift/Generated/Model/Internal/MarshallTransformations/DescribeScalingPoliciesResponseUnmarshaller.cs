...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeScalingPoliciesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeScalingPolicies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "ScalingPolicies":
                        {
                            context.AddPathSegment("ScalingPolicies");
                            var unmarshaller = new CborListUnmarshaller<ScalingPolicy, ScalingPolicyUnmarshaller>(ScalingPolicyUnmarshaller.Instance);
