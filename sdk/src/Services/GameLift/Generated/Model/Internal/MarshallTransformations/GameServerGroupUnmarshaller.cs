...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GameServerGroupUnmarshaller : IUnmarshaller<GameServerGroup, XmlUnmarshallerContext>, IUnmarshaller<GameServerGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GameServerGroup IUnmarshaller<GameServerGroup, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public GameServerGroup Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InstanceDefinition, InstanceDefinitionUnmarshaller>(InstanceDefinitionUnmarshaller.Instance);
