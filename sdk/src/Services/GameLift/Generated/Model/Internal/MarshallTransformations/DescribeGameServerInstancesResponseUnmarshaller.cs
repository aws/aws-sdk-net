...
{
    /// <summary>
    /// Response Unmarshaller for DescribeGameServerInstances operation
    /// </summary>  
    public class DescribeGameServerInstancesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeGameServerInstancesResponse response = new DescribeGameServerInstancesResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeGameServerInstances");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameServerInstances":
                        {
                            context.AddPathSegment("GameServerInstances");
                            var unmarshaller = new CborListUnmarshaller<GameServerInstance, GameServerInstanceUnmarshaller>(GameServerInstanceUnmarshaller.Instance);
                            response.GameServerInstances = unmarshaller.Unmarshall(context);
        ...
        private static DescribeGameServerInstancesResponseUnmarshaller _instance = new DescribeGameServerInstancesResponseUnmarshaller();        

        internal static DescribeGameServerInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGameServerInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
