...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMatchmakingRuleSetsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeMatchmakingRuleSets");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "RuleSets":
                        {
                            context.AddPathSegment("RuleSets");
                            var unmarshaller = new CborListUnmarshaller<MatchmakingRuleSet, MatchmakingRuleSetUnmarshaller>(MatchmakingRuleSetUnmarshaller.Instance);
