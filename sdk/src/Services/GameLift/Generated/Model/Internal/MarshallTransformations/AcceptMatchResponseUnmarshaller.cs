...
{
    /// <summary>
    /// Response Unmarshaller for AcceptMatch operation
    /// </summary>  
    public class AcceptMatchResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptMatchResponse response = new AcceptMatchResponse();
            var reader = context.Reader;
            context.AddPathSegment("AcceptMatch");
        ...
        private static AcceptMatchResponseUnmarshaller _instance = new AcceptMatchResponseUnmarshaller();        

        internal static AcceptMatchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptMatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
