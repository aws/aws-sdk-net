...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGameServerGroup operation
    /// </summary>  
    public class DeleteGameServerGroupResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGameServerGroupResponse response = new DeleteGameServerGroupResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteGameServerGroup");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameServerGroup":
                        {
                            context.AddPathSegment("GameServerGroup");
                            var unmarshaller = GameServerGroupUnmarshaller.Instance;
                            response.GameServerGroup = unmarshaller.Unmarshall(context);
        ...
        private static DeleteGameServerGroupResponseUnmarshaller _instance = new DeleteGameServerGroupResponseUnmarshaller();        

        internal static DeleteGameServerGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGameServerGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
