...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlayerGatewayConfigurationUnmarshaller : ICborUnmarshaller<PlayerGatewayConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public PlayerGatewayConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameServerIpProtocolSupported":
                        {
                            context.AddPathSegment("GameServerIpProtocolSupported");
