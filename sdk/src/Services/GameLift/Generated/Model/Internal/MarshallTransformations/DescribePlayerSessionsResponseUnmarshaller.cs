...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribePlayerSessionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribePlayerSessions");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "PlayerSessions":
                        {
                            context.AddPathSegment("PlayerSessions");
                            var unmarshaller = new CborListUnmarshaller<PlayerSession, PlayerSessionUnmarshaller>(PlayerSessionUnmarshaller.Instance);
