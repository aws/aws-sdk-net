...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContainerFleet operation
    /// </summary>  
    public class UpdateContainerFleetResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContainerFleetResponse response = new UpdateContainerFleetResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateContainerFleet");
            reader.ReadStartMap();
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new CborUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NotReadyException"))
                {
                    return NotReadyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateContainerFleetResponseUnmarshaller _instance = new UpdateContainerFleetResponseUnmarshaller();        

        internal static UpdateContainerFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContainerFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
