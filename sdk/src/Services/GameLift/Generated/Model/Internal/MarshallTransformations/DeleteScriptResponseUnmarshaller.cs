...
{
    /// <summary>
    /// Response Unmarshaller for DeleteScript operation
    /// </summary>  
    public class DeleteScriptResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DeleteScript");
        ...
        private static DeleteScriptResponseUnmarshaller _instance = new DeleteScriptResponseUnmarshaller();        

        internal static DeleteScriptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteScriptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
