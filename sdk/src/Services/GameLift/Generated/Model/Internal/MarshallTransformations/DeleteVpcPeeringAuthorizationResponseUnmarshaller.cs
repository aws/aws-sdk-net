...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVpcPeeringAuthorization operation
    /// </summary>  
    public class DeleteVpcPeeringAuthorizationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVpcPeeringAuthorizationResponse response = new DeleteVpcPeeringAuthorizationResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteVpcPeeringAuthorization");
        ...
        private static DeleteVpcPeeringAuthorizationResponseUnmarshaller _instance = new DeleteVpcPeeringAuthorizationResponseUnmarshaller();        

        internal static DeleteVpcPeeringAuthorizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVpcPeeringAuthorizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
