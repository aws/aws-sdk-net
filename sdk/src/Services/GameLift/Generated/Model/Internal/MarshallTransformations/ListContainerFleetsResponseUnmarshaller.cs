...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListContainerFleetsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListContainerFleets");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ContainerFleets":
                        {
                            context.AddPathSegment("ContainerFleets");
                            var unmarshaller = new CborListUnmarshaller<ContainerFleet, ContainerFleetUnmarshaller>(ContainerFleetUnmarshaller.Instance);
                            response.ContainerFleets = unmarshaller.Unmarshall(context);
