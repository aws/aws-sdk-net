...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFleetLocationCapacity operation
    /// </summary>  
    public class DescribeFleetLocationCapacityResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFleetLocationCapacityResponse response = new DescribeFleetLocationCapacityResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeFleetLocationCapacity");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "FleetCapacity":
                        {
                            context.AddPathSegment("FleetCapacity");
                            var unmarshaller = FleetCapacityUnmarshaller.Instance;
                            response.FleetCapacity = unmarshaller.Unmarshall(context);
        ...
        private static DescribeFleetLocationCapacityResponseUnmarshaller _instance = new DescribeFleetLocationCapacityResponseUnmarshaller();        

        internal static DescribeFleetLocationCapacityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFleetLocationCapacityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
