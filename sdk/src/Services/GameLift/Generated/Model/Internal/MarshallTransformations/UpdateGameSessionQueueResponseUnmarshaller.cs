...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGameSessionQueue operation
    /// </summary>  
    public class UpdateGameSessionQueueResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGameSessionQueueResponse response = new UpdateGameSessionQueueResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateGameSessionQueue");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameSessionQueue":
                        {
                            context.AddPathSegment("GameSessionQueue");
                            var unmarshaller = GameSessionQueueUnmarshaller.Instance;
                            response.GameSessionQueue = unmarshaller.Unmarshall(context);
        ...
        private static UpdateGameSessionQueueResponseUnmarshaller _instance = new UpdateGameSessionQueueResponseUnmarshaller();        

        internal static UpdateGameSessionQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGameSessionQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
