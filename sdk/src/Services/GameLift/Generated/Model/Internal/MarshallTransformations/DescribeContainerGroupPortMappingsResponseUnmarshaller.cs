...
{
    /// <summary>
    /// Response Unmarshaller for DescribeContainerGroupPortMappings operation
    /// </summary>  
    public class DescribeContainerGroupPortMappingsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeContainerGroupPortMappingsResponse response = new DescribeContainerGroupPortMappingsResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeContainerGroupPortMappings");
            reader.ReadStartMap();
                    ...
                    case "ContainerGroupDefinitionArn":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.ContainerGroupDefinitionArn = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "ContainerGroupPortMappings":
                        {
                            context.AddPathSegment("ContainerGroupPortMappings");
                            var unmarshaller = new CborListUnmarshaller<ContainerGroupPortMapping, ContainerGroupPortMappingUnmarshaller>(ContainerGroupPortMappingUnmarshaller.Instance);
                            response.ContainerGroupPortMappings = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "ContainerGroupType":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.ContainerGroupType = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "FleetArn":
        ...
        private static DescribeContainerGroupPortMappingsResponseUnmarshaller _instance = new DescribeContainerGroupPortMappingsResponseUnmarshaller();        

        internal static DescribeContainerGroupPortMappingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeContainerGroupPortMappingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
