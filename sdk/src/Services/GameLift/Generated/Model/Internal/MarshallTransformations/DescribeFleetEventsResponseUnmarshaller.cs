...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeFleetEventsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeFleetEvents");
            reader.ReadStartMap();
                    ...
                    case "Events":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<Event, EventUnmarshaller>(EventUnmarshaller.Instance);
