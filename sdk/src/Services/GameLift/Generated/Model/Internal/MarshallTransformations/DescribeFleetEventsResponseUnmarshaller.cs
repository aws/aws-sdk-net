...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFleetEvents operation
    /// </summary>  
    public class DescribeFleetEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFleetEventsResponse response = new DescribeFleetEventsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Event, EventUnmarshaller>(EventUnmarshaller.Instance);
        ...
        private static DescribeFleetEventsResponseUnmarshaller _instance = new DescribeFleetEventsResponseUnmarshaller();        

        internal static DescribeFleetEventsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFleetEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
