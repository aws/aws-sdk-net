...
{
    /// <summary>
    /// Response Unmarshaller for CreateScript operation
    /// </summary>  
    public class CreateScriptResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateScriptResponse response = new CreateScriptResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateScript");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Script":
                        {
                            context.AddPathSegment("Script");
                            var unmarshaller = ScriptUnmarshaller.Instance;
                            response.Script = unmarshaller.Unmarshall(context);
        ...
        private static CreateScriptResponseUnmarshaller _instance = new CreateScriptResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateScriptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
