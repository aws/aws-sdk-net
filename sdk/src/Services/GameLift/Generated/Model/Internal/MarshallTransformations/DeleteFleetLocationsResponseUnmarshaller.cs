...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteFleetLocationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DeleteFleetLocations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "LocationStates":
                        {
                            context.AddPathSegment("LocationStates");
                            var unmarshaller = new CborListUnmarshaller<LocationState, LocationStateUnmarshaller>(LocationStateUnmarshaller.Instance);
