...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlayerLatencyUnmarshaller : IUnmarshaller<PlayerLatency, XmlUnmarshallerContext>, IUnmarshaller<PlayerLatency, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PlayerLatency IUnmarshaller<PlayerLatency, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PlayerLatency Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
        ...
        private static PlayerLatencyUnmarshaller _instance = new PlayerLatencyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PlayerLatencyUnmarshaller Instance
        {
            get
            {
                return _instance;
