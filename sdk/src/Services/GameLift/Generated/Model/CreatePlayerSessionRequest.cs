...
namespace Amazon.GameLift.Model
{
    ...
    public partial class CreatePlayerSessionRequest : AmazonGameLiftRequest
    {
        ...
        /// <para>
        /// An identifier for the game session that is unique across all regions to add a player
        /// to. The value is always a full ARN in the following format: <c>arn:aws:gamelift:&lt;location&gt;::gamesession/&lt;fleet
        /// ID&gt;/&lt;ID string&gt;</c>.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Developer-defined information related to a player. Amazon GameLift Servers does not
