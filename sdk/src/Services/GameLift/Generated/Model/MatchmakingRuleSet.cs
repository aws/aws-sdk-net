...
namespace Amazon.GameLift.Model
{
    ...
    /// and examples showing how to construct a rule set, see <a href="http://docs.aws.amazon.com/gamelift/latest/developerguide/match-rules.html">Create
    /// Matchmaking Rules for Your Game</a>. 
    /// </para>
    ///  <ul> <li> 
    /// <para>
    ...
    /// on player attributes. A rule might specify minimum requirements for individual players--such
    /// as each player must meet a certain skill level, or may describe an entire group--such
    ...
    /// time if no acceptable matches are found. This feature lets you balance getting players
