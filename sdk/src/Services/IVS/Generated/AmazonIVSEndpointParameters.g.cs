...
namespace Amazon.IVS.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving IVS endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonIVSEndpointProvider"/> and <see cref="AmazonIVSEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class IVSEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// IVSEndpointParameters constructor
        /// </summary>
        public IVSEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
