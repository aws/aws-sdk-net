...
{
    /// <summary>
    /// This is the response object from the BatchStartViewerSessionRevocation operation.
    /// </summary>
    public partial class BatchStartViewerSessionRevocationResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<BatchStartViewerSessionRevocationError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchStartViewerSessionRevocationError>() : null;
