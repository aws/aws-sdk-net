...
{
    /// <summary>
    /// Container for the parameters to the CreateAdConfiguration operation. Creates a new
    /// ad configuration to be used for server-side ad insertion.
    /// </summary>
    public partial class CreateAdConfigurationRequest : AmazonIVSRequest
    {
        ...
        /// <para>
        /// Configuration for the post-roll ad break to use for this ad configuration. Default:
        /// disabled (<c>enabled</c> set to false, <c>durationSeconds</c> set to 15).
        /// </para>
        /// </summary>
