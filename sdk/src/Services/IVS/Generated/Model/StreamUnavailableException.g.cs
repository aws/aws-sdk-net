...
namespace Amazon.IVS.Model
{
    ...
    public partial class StreamUnavailableException : AmazonIVSException
    {
        ...
        /// message.
        /// </summary>
        public StreamUnavailableException() : base() { }
        ...
        /// Construct instance of StreamUnavailableException
        /// </summary>
        public StreamUnavailableException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of StreamUnavailableException
        /// </summary>
        public StreamUnavailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of StreamUnavailableException
        /// </summary>
        public StreamUnavailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
