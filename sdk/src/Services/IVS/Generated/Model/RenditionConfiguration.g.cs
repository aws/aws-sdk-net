...
namespace Amazon.IVS.Model
{
    ...
    public partial class RenditionConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the RenditionSelection property is set.
        /// </summary>
        internal bool IsSetRenditionSelection() => this.RenditionSelection != null;
        ...
        /// </summary>
        public List<string> Renditions { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Renditions property is set.
        /// </summary>
        internal bool IsSetRenditions() => this.Renditions != null && (this.Renditions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
