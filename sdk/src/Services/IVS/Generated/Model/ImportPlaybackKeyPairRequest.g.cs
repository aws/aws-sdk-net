...
{
    /// <summary>
    /// Container for the parameters to the ImportPlaybackKeyPair operation. Imports the public
    /// portion of a new key pair and returns its <c>arn</c> and <c>fingerprint</c>. The <c>privateKey</c>
    /// can then be used to generate viewer authorization tokens, to grant viewers access
    /// to private channels. For more information, see <a href="https://docs.aws.amazon.com/ivs/latest/userguide/private-channels.html">Setting
