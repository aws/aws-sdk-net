...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListPlaybackRestrictionPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListPlaybackRestrictionPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("playbackRestrictionPolicies", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PlaybackRestrictionPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListPlaybackRestrictionPoliciesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPlaybackRestrictionPoliciesResponseUnmarshaller Instance => _instance;
    }
}
