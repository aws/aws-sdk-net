...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MultitrackInputConfigurationUnmarshaller : IJsonUnmarshaller<MultitrackInputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MultitrackInputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("maximumResolution", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MaximumResolution = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
