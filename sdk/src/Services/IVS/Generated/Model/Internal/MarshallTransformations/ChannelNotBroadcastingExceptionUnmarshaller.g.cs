...
{
    /// <summary>
    /// Exception Unmarshaller for ChannelNotBroadcastingException
    /// </summary>
    public partial class ChannelNotBroadcastingExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ChannelNotBroadcastingException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelNotBroadcastingException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelNotBroadcastingExceptionUnmarshaller Instance => _instance;
    }
}
