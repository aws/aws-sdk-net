...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StreamEventUnmarshaller : IJsonUnmarshaller<StreamEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StreamEvent();
        ...
        /// Gets the singleton.
        /// </summary>
        public static StreamEventUnmarshaller Instance => _instance;
    }
}
