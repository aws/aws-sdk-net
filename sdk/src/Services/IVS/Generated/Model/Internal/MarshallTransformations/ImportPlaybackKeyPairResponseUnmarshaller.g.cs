...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportPlaybackKeyPairResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImportPlaybackKeyPairResponse();
        ...
        internal static ImportPlaybackKeyPairResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ImportPlaybackKeyPairResponseUnmarshaller Instance => _instance;
    }
}
