...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListPlaybackKeyPairsRequestMarshaller : IMarshaller<IRequest, ListPlaybackKeyPairsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListPlaybackKeyPairsRequestMarshaller _instance = new();

        internal static ListPlaybackKeyPairsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPlaybackKeyPairsRequestMarshaller Instance => _instance;
    }
}
