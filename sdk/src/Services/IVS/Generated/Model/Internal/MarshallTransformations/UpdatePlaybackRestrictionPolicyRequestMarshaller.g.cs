...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdatePlaybackRestrictionPolicyRequestMarshaller : IMarshaller<IRequest, UpdatePlaybackRestrictionPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdatePlaybackRestrictionPolicyRequestMarshaller _instance = new();

        internal static UpdatePlaybackRestrictionPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePlaybackRestrictionPolicyRequestMarshaller Instance => _instance;
    }
}
