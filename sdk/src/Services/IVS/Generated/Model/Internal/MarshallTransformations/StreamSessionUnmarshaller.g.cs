...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StreamSessionUnmarshaller : IJsonUnmarshaller<StreamSession, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StreamSession();
        ...
        /// Gets the singleton.
        /// </summary>
        public static StreamSessionUnmarshaller Instance => _instance;
    }
}
