...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAdConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAdConfigurationResponse response = new CreateAdConfigurationResponse();
        ...
        internal static CreateAdConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAdConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
