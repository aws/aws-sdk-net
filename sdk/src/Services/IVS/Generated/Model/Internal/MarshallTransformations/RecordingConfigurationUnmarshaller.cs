...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecordingConfigurationUnmarshaller : IJsonUnmarshaller<RecordingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecordingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
