...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListChannelsRequestMarshaller : IMarshaller<IRequest, ListChannelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListChannelsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetFilterByName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.FilterByName);
            }
            ...
            if(publicRequest.IsSetFilterByPlaybackRestrictionPolicyArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.FilterByPlaybackRestrictionPolicyArn);
            }
            ...
            if(publicRequest.IsSetFilterByRecordingConfigurationArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.FilterByRecordingConfigurationArn);
            }
