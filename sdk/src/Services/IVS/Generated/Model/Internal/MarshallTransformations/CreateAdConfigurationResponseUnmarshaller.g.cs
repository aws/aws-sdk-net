...
{
    /// <summary>
    /// Response Unmarshaller for CreateAdConfiguration operation.
    /// </summary>
    public partial class CreateAdConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAdConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("adConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AdConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAdConfigurationResponseUnmarshaller _instance = new CreateAdConfigurationResponseUnmarshaller();

        internal static CreateAdConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAdConfigurationResponseUnmarshaller Instance => _instance;
    }
}
