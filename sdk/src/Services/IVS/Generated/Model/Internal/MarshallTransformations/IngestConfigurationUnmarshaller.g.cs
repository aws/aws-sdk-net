...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IngestConfigurationUnmarshaller : IJsonUnmarshaller<IngestConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IngestConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IngestConfigurationUnmarshaller Instance => _instance;
    }
}
