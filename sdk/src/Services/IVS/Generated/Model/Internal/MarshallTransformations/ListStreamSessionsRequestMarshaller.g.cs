...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListStreamSessionsRequestMarshaller : IMarshaller<IRequest, ListStreamSessionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListStreamSessionsRequestMarshaller _instance = new();

        internal static ListStreamSessionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListStreamSessionsRequestMarshaller Instance => _instance;
    }
}
