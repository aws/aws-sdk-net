...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IngestConfigurationsUnmarshaller : IJsonUnmarshaller<IngestConfigurations, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IngestConfigurations();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IngestConfigurationsUnmarshaller Instance => _instance;
    }
}
