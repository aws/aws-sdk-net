...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreatePlaybackRestrictionPolicyRequestMarshaller : IMarshaller<IRequest, CreatePlaybackRestrictionPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreatePlaybackRestrictionPolicyRequestMarshaller _instance = new();

        internal static CreatePlaybackRestrictionPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreatePlaybackRestrictionPolicyRequestMarshaller Instance => _instance;
    }
}
