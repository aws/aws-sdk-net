...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateRecordingConfigurationRequestMarshaller : IMarshaller<IRequest, CreateRecordingConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateRecordingConfigurationRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetRecordingReconnectWindowSeconds())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.RecordingReconnectWindowSeconds.Value);
            }
        ...
        private static readonly CreateRecordingConfigurationRequestMarshaller _instance = new();

        internal static CreateRecordingConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateRecordingConfigurationRequestMarshaller Instance => _instance;
    }
}
