...
{
    /// <summary>
    /// Exception Unmarshaller for StreamUnavailableException
    /// </summary>
    public partial class StreamUnavailableExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<StreamUnavailableException, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the exception from the service to the appropriate exception class
        /// </summary>
        public StreamUnavailableException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// Unmarshall the exception from the service to the appropriate exception class
        /// </summary>
        public StreamUnavailableException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new StreamUnavailableException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        private static StreamUnavailableExceptionUnmarshaller _instance = new StreamUnavailableExceptionUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StreamUnavailableExceptionUnmarshaller Instance => _instance;
    }
}
