...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetStreamKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetStreamKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("streamKeys", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.StreamKeys = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static BatchGetStreamKeyResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetStreamKeyResponseUnmarshaller Instance => _instance;
    }
}
