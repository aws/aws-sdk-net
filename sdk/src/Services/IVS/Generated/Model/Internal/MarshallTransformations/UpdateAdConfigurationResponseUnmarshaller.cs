...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAdConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAdConfigurationResponse response = new UpdateAdConfigurationResponse();
        ...
        internal static UpdateAdConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAdConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
