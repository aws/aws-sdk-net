...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutMetadataRequestMarshaller : IMarshaller<IRequest, PutMetadataRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutMetadataRequestMarshaller _instance = new();

        internal static PutMetadataRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutMetadataRequestMarshaller Instance => _instance;
    }
}
