...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InsertAdBreakRequestMarshaller : IMarshaller<IRequest, InsertAdBreakRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly InsertAdBreakRequestMarshaller _instance = new();

        internal static InsertAdBreakRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static InsertAdBreakRequestMarshaller Instance => _instance;
    }
}
