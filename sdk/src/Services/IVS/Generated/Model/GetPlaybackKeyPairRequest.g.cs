...
{
    /// <summary>
    /// Container for the parameters to the GetPlaybackKeyPair operation. Gets a specified
    /// playback authorization key pair and returns the <c>arn</c> and <c>fingerprint</c>.
