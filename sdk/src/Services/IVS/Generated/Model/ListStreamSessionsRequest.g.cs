...
{
    /// <summary>
    /// Container for the parameters to the ListStreamSessions operation. Gets a summary of
    /// current and previous streams for a specified channel in your account, in the AWS region
