...
namespace Amazon.IVS
{
    ...
    public partial class AmazonIVSClient : AmazonServiceClient, IAmazonIVS
    {
        ...
        /// 
        /// </summary>
        public AmazonIVSClient() : base(new AmazonIVSConfig()) { }
        ...
        public AmazonIVSClient(RegionEndpoint region) : base(new AmazonIVSConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIVSClient(AmazonIVSConfig config) : base(config) { }
