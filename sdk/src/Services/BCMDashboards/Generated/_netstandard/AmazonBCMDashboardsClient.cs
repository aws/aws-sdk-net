...
namespace Amazon.BCMDashboards
{
    ...
    public partial class AmazonBCMDashboardsClient : AmazonServiceClient, IAmazonBCMDashboards
    {
        ...
        internal virtual CreateScheduledReportResponse CreateScheduledReport(CreateScheduledReportRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual DeleteScheduledReportResponse DeleteScheduledReport(DeleteScheduledReportRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ExecuteScheduledReportResponse ExecuteScheduledReport(ExecuteScheduledReportRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetScheduledReportResponse GetScheduledReport(GetScheduledReportRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListScheduledReportsResponse ListScheduledReports(ListScheduledReportsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual UpdateScheduledReportResponse UpdateScheduledReport(UpdateScheduledReportRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
