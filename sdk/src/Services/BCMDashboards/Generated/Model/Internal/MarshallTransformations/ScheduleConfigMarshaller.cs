...
namespace Amazon.BCMDashboards.Model.Internal.MarshallTransformations
{
    ...
    public class ScheduleConfigMarshaller : IRequestMarshaller<ScheduleConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ScheduleConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSchedulePeriod())
            {
                context.Writer.WritePropertyName("schedulePeriod");
                context.Writer.WriteStartObject();

                var marshaller = SchedulePeriodMarshaller.Instance;
                marshaller.Marshall(requestObject.SchedulePeriod, context);
