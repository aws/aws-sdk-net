...
namespace Amazon.BCMDashboards.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SavingsPlansUtilizationQueryUnmarshaller : IUnmarshaller<SavingsPlansUtilizationQuery, XmlUnmarshallerContext>, IUnmarshaller<SavingsPlansUtilizationQuery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SavingsPlansUtilizationQuery IUnmarshaller<SavingsPlansUtilizationQuery, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SavingsPlansUtilizationQuery Unmarshall(JsonUnmarshallerContext context)
        {
