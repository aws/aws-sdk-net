...
{
    /// <summary>
    /// Response Unmarshaller for ScheduledReportSummary Object
    /// </summary>  
    public class ScheduledReportSummaryUnmarshaller : IJsonUnmarshaller<ScheduledReportSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduledReportSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ScheduledReportSummary unmarshalledObject = new ScheduledReportSummary();
        ...
        private static ScheduledReportSummaryUnmarshaller _instance = new ScheduledReportSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ScheduledReportSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
