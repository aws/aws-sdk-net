...
namespace Amazon.MarketplaceEntitlementService.Model
{
    ...
    public partial class InternalServiceErrorException : AmazonMarketplaceEntitlementServiceException
    {
        ...
        public InternalServiceErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InternalServiceErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
