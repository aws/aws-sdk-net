...
namespace Amazon.MarketplaceEntitlementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidParameterExceptionUnmarshaller : ICborErrorResponseUnmarshaller<InvalidParameterException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidParameterException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidParameterException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("InvalidParameterException");
            reader.ReadStartMap();
