...
namespace Amazon.MarketplaceEntitlementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InternalServiceErrorExceptionUnmarshaller : ICborErrorResponseUnmarshaller<InternalServiceErrorException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InternalServiceErrorException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InternalServiceErrorException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("InternalServiceErrorException");
            reader.ReadStartMap();
