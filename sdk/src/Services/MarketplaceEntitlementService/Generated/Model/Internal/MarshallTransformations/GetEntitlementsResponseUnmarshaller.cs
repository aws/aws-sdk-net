...
{
    /// <summary>
    /// Response Unmarshaller for GetEntitlements operation
    /// </summary>  
    public class GetEntitlementsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEntitlementsResponse response = new GetEntitlementsResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetEntitlements");
            reader.ReadStartMap();
                    ...
                    case "Entitlements":
                        {
                            ...
                            response.Entitlements = unmarshaller.Unmarshall(context);
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonMarketplaceEntitlementServiceException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static GetEntitlementsResponseUnmarshaller _instance = new GetEntitlementsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEntitlementsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
