...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMarketplaceEntitlementServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMarketplaceEntitlementServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMarketplaceEntitlementServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMarketplaceEntitlementServiceConfig to create AmazonMarketplaceEntitlementServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonMarketplaceEntitlementServiceClient(serviceClientConfig) :
                    new AmazonMarketplaceEntitlementServiceClient(awsCredentials, serviceClientConfig);
        }
