...
namespace Amazon.MarketplaceEntitlementService
{
    ...
    public partial class AmazonMarketplaceEntitlementServiceException : AmazonServiceException
    {
        ...
        public AmazonMarketplaceEntitlementServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonMarketplaceEntitlementServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        protected AmazonMarketplaceEntitlementServiceException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
#endif
