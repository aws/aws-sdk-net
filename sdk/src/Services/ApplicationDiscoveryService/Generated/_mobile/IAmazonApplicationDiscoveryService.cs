...
namespace Amazon.ApplicationDiscoveryService
{
    ...
    public partial interface IAmazonApplicationDiscoveryService : IDisposable
    {
        ...
        /// </param>
        /// <returns>The task object representing the asynchronous operation.</returns>
        Task<GetConfigurationAttributesResponse> GetConfigurationAttributesAsync(GetConfigurationAttributesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </param>
        /// <returns>The task object representing the asynchronous operation.</returns>
        Task<GetExportStatusResponse> GetExportStatusAsync(GetExportStatusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </param>
        /// <returns>The task object representing the asynchronous operation.</returns>
        Task<RemoveConfigurationResponse> RemoveConfigurationAsync(RemoveConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
