...
namespace Amazon.ApplicationDiscoveryService
{
    ...
    public partial interface IAmazonApplicationDiscoveryService : IDisposable
    {
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetConfigurationAttributes(GetConfigurationAttributesRequest request, AsyncCallback callback, object state);
        ...
        GetConfigurationAttributesResponse EndGetConfigurationAttributes(IAsyncResult asyncResult);
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetExportStatus(GetExportStatusRequest request, AsyncCallback callback, object state);
        ...
        GetExportStatusResponse EndGetExportStatus(IAsyncResult asyncResult);
        ...
        ///         operation.</returns>
        IAsyncResult BeginRemoveConfiguration(RemoveConfigurationRequest request, AsyncCallback callback, object state);
        ...
        RemoveConfigurationResponse EndRemoveConfiguration(IAsyncResult asyncResult);
