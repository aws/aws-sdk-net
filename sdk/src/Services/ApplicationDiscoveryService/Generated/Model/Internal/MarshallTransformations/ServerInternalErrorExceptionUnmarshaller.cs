...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServerInternalErrorExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ServerInternalErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ServerInternalErrorException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ServerInternalErrorException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
