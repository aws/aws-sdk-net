...
{
    /// <summary>
    /// AssociateConfigurationItemsToApplication Request Marshaller
    /// </summary>       
    public class AssociateConfigurationItemsToApplicationRequestMarshaller : IMarshaller<IRequest, AssociateConfigurationItemsToApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateConfigurationItemsToApplicationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateConfigurationItemsToApplicationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ApplicationDiscoveryService");
            string target = "AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication";
            ...
            if(publicRequest.IsSetApplicationConfigurationId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ApplicationConfigurationId);
            }
            ...
            if(publicRequest.IsSetConfigurationIds())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestConfigurationIdsListValue);
                }
