...
{
    /// <summary>
    /// Response Unmarshaller for AssociateConfigurationItemsToApplication operation
    /// </summary>  
    public class AssociateConfigurationItemsToApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateConfigurationItemsToApplicationResponse response = new AssociateConfigurationItemsToApplicationResponse();
        ...
        private static AssociateConfigurationItemsToApplicationResponseUnmarshaller _instance = new AssociateConfigurationItemsToApplicationResponseUnmarshaller();        

        internal static AssociateConfigurationItemsToApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateConfigurationItemsToApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
