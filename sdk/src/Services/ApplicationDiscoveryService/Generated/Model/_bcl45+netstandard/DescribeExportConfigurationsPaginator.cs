...
namespace Amazon.ApplicationDiscoveryService.Model
{
    ...
    internal sealed partial class DescribeExportConfigurationsPaginator : IPaginator<DescribeExportConfigurationsResponse>, IDescribeExportConfigurationsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeExportConfigurationsResponse> IPaginator<DescribeExportConfigurationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
