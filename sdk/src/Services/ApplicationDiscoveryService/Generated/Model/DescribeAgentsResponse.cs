...
namespace Amazon.ApplicationDiscoveryService.Model
{
    ...
    public partial class DescribeAgentsResponse : AmazonWebServiceResponse
    {
        ...
        /// did not specify an agent ID. The output includes agent IDs, IP addresses, MAC addresses,
        /// agent health, host name where the agent resides, and the version number of each agent.
        /// </para>
        /// </summary>
