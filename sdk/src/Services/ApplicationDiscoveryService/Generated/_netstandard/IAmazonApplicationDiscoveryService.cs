...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonApplicationDiscoveryServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonApplicationDiscoveryServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonApplicationDiscoveryServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonApplicationDiscoveryServiceConfig to create AmazonApplicationDiscoveryServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonApplicationDiscoveryServiceClient(serviceClientConfig) :
                    new AmazonApplicationDiscoveryServiceClient(awsCredentials, serviceClientConfig);
        }
