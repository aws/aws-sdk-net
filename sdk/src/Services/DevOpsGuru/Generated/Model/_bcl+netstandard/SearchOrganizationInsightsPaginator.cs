...
{
    /// <summary>
    /// Base class for SearchOrganizationInsights paginators.
    /// </summary>
    internal sealed partial class SearchOrganizationInsightsPaginator : IPaginator<SearchOrganizationInsightsResponse>, ISearchOrganizationInsightsPaginator
    {
        private readonly IAmazonDevOpsGuru _client;
        private readonly SearchOrganizationInsightsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<SearchOrganizationInsightsResponse> Responses => new PaginatedResponse<SearchOrganizationInsightsResponse>(this);
...
#if BCL
        IEnumerable<SearchOrganizationInsightsResponse> IPaginator<SearchOrganizationInsightsResponse>.Paginate()
        {
            ...
            SearchOrganizationInsightsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.SearchOrganizationInsights(_request);
        ...
        async IAsyncEnumerable<SearchOrganizationInsightsResponse> IPaginator<SearchOrganizationInsightsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.SearchOrganizationInsightsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
