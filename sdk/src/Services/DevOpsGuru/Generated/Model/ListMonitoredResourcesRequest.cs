...
{
    /// <summary>
    /// Container for the parameters to the ListMonitoredResources operation.
    /// Returns the list of all log groups that are being monitored and tagged by DevOps
    /// Guru.
    /// </summary>
    public partial class ListMonitoredResourcesRequest : AmazonDevOpsGuruRequest
    {
        private ListMonitoredResourcesFilters _filters;
