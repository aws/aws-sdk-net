...
namespace Amazon.DevOpsGuru.Model.Internal.MarshallTransformations
{
    ...
    public class ListMonitoredResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("MonitoredResourceIdentifiers", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MonitoredResourceIdentifier, MonitoredResourceIdentifierUnmarshaller>(MonitoredResourceIdentifierUnmarshaller.Instance);
                    response.MonitoredResourceIdentifiers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
