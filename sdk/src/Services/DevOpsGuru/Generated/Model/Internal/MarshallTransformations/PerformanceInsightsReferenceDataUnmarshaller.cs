...
namespace Amazon.DevOpsGuru.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PerformanceInsightsReferenceDataUnmarshaller : IJsonUnmarshaller<PerformanceInsightsReferenceData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PerformanceInsightsReferenceData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ComparisonValues", targetDepth, ref reader))
                {
                    var unmarshaller = PerformanceInsightsReferenceComparisonValuesUnmarshaller.Instance;
                    unmarshalledObject.ComparisonValues = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
