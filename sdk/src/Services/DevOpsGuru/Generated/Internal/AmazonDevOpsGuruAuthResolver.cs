...
namespace Amazon.DevOpsGuru.Internal
{
    ...
    public class AmazonDevOpsGuruAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDevOpsGuruAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DevOpsGuru.
        /// </summary>
        public AmazonDevOpsGuruAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDevOpsGuruAuthSchemeParameters
            {
    ...
    public class AmazonDevOpsGuruAuthSchemeResolver : IAuthSchemeResolver<AmazonDevOpsGuruAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDevOpsGuruAuthSchemeParameters authParameters)
        {
