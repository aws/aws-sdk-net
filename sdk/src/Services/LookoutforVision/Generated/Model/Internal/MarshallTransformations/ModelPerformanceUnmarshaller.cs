...
namespace Amazon.LookoutforVision.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelPerformanceUnmarshaller : IUnmarshaller<ModelPerformance, XmlUnmarshallerContext>, IUnmarshaller<ModelPerformance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ModelPerformance IUnmarshaller<ModelPerformance, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ModelPerformance Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
