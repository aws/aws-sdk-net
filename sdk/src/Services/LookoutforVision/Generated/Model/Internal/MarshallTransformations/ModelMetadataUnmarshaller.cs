...
namespace Amazon.LookoutforVision.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelMetadataUnmarshaller : IJsonUnmarshaller<ModelMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ModelMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
