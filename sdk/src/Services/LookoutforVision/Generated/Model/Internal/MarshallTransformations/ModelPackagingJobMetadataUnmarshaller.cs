...
namespace Amazon.LookoutforVision.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelPackagingJobMetadataUnmarshaller : IUnmarshaller<ModelPackagingJobMetadata, XmlUnmarshallerContext>, IUnmarshaller<ModelPackagingJobMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ModelPackagingJobMetadata IUnmarshaller<ModelPackagingJobMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ModelPackagingJobMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
