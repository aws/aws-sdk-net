...
{
    /// <summary>
    /// Amazon LookoutforVision endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for LookoutforVision service requests.
    /// Collects values for LookoutforVisionEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses LookoutforVisionEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonLookoutforVisionEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLookoutforVisionConfig)requestContext.ClientConfig;
            var result = new LookoutforVisionEndpointParameters();
