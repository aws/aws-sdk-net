...
namespace Amazon.ConfigService.Model
{
    ...
    /// </summary>
    public partial class AggregatorFilters
    {
        private AggregatorFilterResourceType _resourceType;
        private AggregatorFilterServicePrincipal _servicePrincipal;

        /// <summary>
        /// Gets and sets the property ResourceType. 
        /// <para>
        /// An object to filter the configuration recorders based on the resource types in scope
        /// for recording.
        /// </para>
        /// </summary>
        public AggregatorFilterResourceType ResourceType
        {
        ...
        /// </para>
        /// </summary>
        public AggregatorFilterServicePrincipal ServicePrincipal
        {
