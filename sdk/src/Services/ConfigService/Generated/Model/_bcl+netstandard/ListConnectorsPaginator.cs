...
namespace Amazon.ConfigService.Model
{
    ...
    internal sealed partial class ListConnectorsPaginator : IPaginator<ListConnectorsResponse>, IListConnectorsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ConnectorSummary> ConnectorSummaries => 
            new PaginatedResultKeyResponse<ListConnectorsResponse, ConnectorSummary>(this, (i) => i.ConnectorSummaries ?? new List<ConnectorSummary>());

        internal ListConnectorsPaginator(IAmazonConfigService client, ListConnectorsRequest request)
        {
            this._client = client;
