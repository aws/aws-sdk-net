...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluationResultQualifierUnmarshaller : IJsonUnmarshaller<EvaluationResultQualifier, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationResultQualifier Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ConfigRuleName", targetDepth, ref reader))
                {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EvaluationMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
