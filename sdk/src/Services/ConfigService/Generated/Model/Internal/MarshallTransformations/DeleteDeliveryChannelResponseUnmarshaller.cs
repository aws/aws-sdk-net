    ...
    public class DeleteDeliveryChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return LastDeliveryChannelDeleteFailedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("NoSuchDeliveryChannelException"))
                {
                    return NoSuchDeliveryChannelExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
