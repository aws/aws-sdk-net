...
{
    /// <summary>
    /// ListDiscoveredResources Request Marshaller
    /// </summary>       
    public class ListDiscoveredResourcesRequestMarshaller : IMarshaller<IRequest, ListDiscoveredResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDiscoveredResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDiscoveredResourcesRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetIncludeDeletedResources())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.IncludeDeletedResources.Value);
            }
        ...
        private static ListDiscoveredResourcesRequestMarshaller _instance = new ListDiscoveredResourcesRequestMarshaller();        

        internal static ListDiscoveredResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDiscoveredResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
