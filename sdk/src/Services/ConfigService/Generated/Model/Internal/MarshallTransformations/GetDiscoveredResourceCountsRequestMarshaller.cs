...
{
    /// <summary>
    /// GetDiscoveredResourceCounts Request Marshaller
    /// </summary>       
    public class GetDiscoveredResourceCountsRequestMarshaller : IMarshaller<IRequest, GetDiscoveredResourceCountsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDiscoveredResourceCountsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDiscoveredResourceCountsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ConfigService");
            string target = "StarlingDoveService.GetDiscoveredResourceCounts";
