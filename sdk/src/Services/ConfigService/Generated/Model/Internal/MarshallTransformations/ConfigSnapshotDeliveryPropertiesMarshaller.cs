...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    public class ConfigSnapshotDeliveryPropertiesMarshaller : IRequestMarshaller<ConfigSnapshotDeliveryProperties, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ConfigSnapshotDeliveryProperties requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetDeliveryFrequency())
            {
                context.Writer.WritePropertyName("deliveryFrequency");
                context.Writer.WriteStringValue(requestObject.DeliveryFrequency);
            }
