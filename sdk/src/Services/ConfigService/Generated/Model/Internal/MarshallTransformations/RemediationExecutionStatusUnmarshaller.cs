...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemediationExecutionStatusUnmarshaller : IUnmarshaller<RemediationExecutionStatus, XmlUnmarshallerContext>, IUnmarshaller<RemediationExecutionStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RemediationExecutionStatus IUnmarshaller<RemediationExecutionStatus, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RemediationExecutionStatus Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ResourceKey", targetDepth))
                {
                    ...
                    unmarshalledObject.ResourceKey = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RemediationExecutionStep, RemediationExecutionStepUnmarshaller>(RemediationExecutionStepUnmarshaller.Instance);
