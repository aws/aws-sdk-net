...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    public class ListConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ConnectorSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ConnectorSummary, ConnectorSummaryUnmarshaller>(ConnectorSummaryUnmarshaller.Instance);
                    response.ConnectorSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
