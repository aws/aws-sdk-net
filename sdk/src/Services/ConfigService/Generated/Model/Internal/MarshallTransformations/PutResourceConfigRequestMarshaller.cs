...
{
    /// <summary>
    /// PutResourceConfig Request Marshaller
    /// </summary>       
    public class PutResourceConfigRequestMarshaller : IMarshaller<IRequest, PutResourceConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutResourceConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutResourceConfigRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ConfigService");
            string target = "StarlingDoveService.PutResourceConfig";
        ...
        private static PutResourceConfigRequestMarshaller _instance = new PutResourceConfigRequestMarshaller();        

        internal static PutResourceConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutResourceConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
