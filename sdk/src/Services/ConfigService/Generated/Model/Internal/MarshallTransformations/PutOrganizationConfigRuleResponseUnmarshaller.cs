...
{
    /// <summary>
    /// Response Unmarshaller for PutOrganizationConfigRule operation
    /// </summary>  
    public class PutOrganizationConfigRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutOrganizationConfigRuleResponse response = new PutOrganizationConfigRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("OrganizationConfigRuleArn", targetDepth))
                {
                    ...
                    response.OrganizationConfigRuleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("MaxNumberOfOrganizationConfigRulesExceededException"))
            {
                return new MaxNumberOfOrganizationConfigRulesExceededException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("OrganizationAllFeaturesNotEnabledException"))
            {
                return new OrganizationAllFeaturesNotEnabledException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static PutOrganizationConfigRuleResponseUnmarshaller _instance = new PutOrganizationConfigRuleResponseUnmarshaller();        

        internal static PutOrganizationConfigRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutOrganizationConfigRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
