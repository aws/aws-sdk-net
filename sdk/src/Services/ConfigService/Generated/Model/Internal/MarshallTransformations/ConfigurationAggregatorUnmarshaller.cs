...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    public class ConfigurationAggregatorUnmarshaller : IUnmarshaller<ConfigurationAggregator, XmlUnmarshallerContext>, IUnmarshaller<ConfigurationAggregator, JsonUnmarshallerContext>
    {
        ...
        private static ConfigurationAggregatorUnmarshaller _instance = new ConfigurationAggregatorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConfigurationAggregatorUnmarshaller Instance
        {
            get
            {
                return _instance;
