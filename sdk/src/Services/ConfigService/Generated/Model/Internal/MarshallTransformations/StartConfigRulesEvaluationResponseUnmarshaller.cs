...
{
    /// <summary>
    /// Response Unmarshaller for StartConfigRulesEvaluation operation
    /// </summary>  
    public class StartConfigRulesEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartConfigRulesEvaluationResponse response = new StartConfigRulesEvaluationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return NoSuchConfigRuleExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartConfigRulesEvaluationResponseUnmarshaller _instance = new StartConfigRulesEvaluationResponseUnmarshaller();        

        internal static StartConfigRulesEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartConfigRulesEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
