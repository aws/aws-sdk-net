...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    public class ResourceDetailsUnmarshaller : IJsonUnmarshaller<ResourceDetails, JsonUnmarshallerContext>
    {
        ...
        public ResourceDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ResourceConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ResourceConfigurationSchemaType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
