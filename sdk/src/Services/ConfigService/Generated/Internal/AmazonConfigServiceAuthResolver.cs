...
namespace Amazon.ConfigService.Internal
{
    ...
    public class AmazonConfigServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonConfigServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ConfigService.
        /// </summary>
        public AmazonConfigServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonConfigServiceAuthSchemeParameters
            {
    ...
    public class AmazonConfigServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonConfigServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonConfigServiceAuthSchemeParameters authParameters)
        {
