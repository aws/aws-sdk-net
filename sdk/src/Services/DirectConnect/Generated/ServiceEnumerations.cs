...
namespace Amazon.DirectConnect
{
    ...
    /// <summary>
    /// Constants used for properties of type AsPathType.
    /// </summary>
    public class AsPathType : ConstantClass
    {

        /// <summary>
        /// Constant Seq for AsPathType
        /// </summary>
        public static readonly AsPathType Seq = new AsPathType("seq");
        /// <summary>
        /// Constant Set for AsPathType
        /// </summary>
        public static readonly AsPathType Set = new AsPathType("set");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public AsPathType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static AsPathType FindValue(string value)
        {
            return FindValue<AsPathType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator AsPathType(string value)
        {
            return FindValue(value);
        }
    }
    ...
    public class RouteDirection : ConstantClass
    {
        ...
        /// <summary>
        /// Constant Accepted for RouteDirection
        /// </summary>
        public static readonly RouteDirection Accepted = new RouteDirection("accepted");
        /// <summary>
        /// Constant Advertised for RouteDirection
        /// </summary>
        public static readonly RouteDirection Advertised = new RouteDirection("advertised");
