...
namespace Amazon.DirectConnect.Internal
{
    ...
    public class AmazonDirectConnectAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDirectConnectAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DirectConnect.
        /// </summary>
        public AmazonDirectConnectAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDirectConnectAuthSchemeParameters
            {
    ...
    public class AmazonDirectConnectAuthSchemeResolver : IAuthSchemeResolver<AmazonDirectConnectAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDirectConnectAuthSchemeParameters authParameters)
        {
