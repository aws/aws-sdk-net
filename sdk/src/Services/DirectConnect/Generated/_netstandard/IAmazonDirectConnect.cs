...
namespace Amazon.DirectConnect
{
    ...
    public partial interface IAmazonDirectConnect : IAmazonService, IDisposable
    {
        ...
        Task<AssociateMacSecKeyResponse> AssociateMacSecKeyAsync(AssociateMacSecKeyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ConfirmCustomerAgreementResponse> ConfirmCustomerAgreementAsync(ConfirmCustomerAgreementRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeCustomerMetadataResponse> DescribeCustomerMetadataAsync(DescribeCustomerMetadataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeRouterConfigurationResponse> DescribeRouterConfigurationAsync(DescribeRouterConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListVirtualInterfaceRoutesResponse> ListVirtualInterfaceRoutesAsync(ListVirtualInterfaceRoutesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateDirectConnectGatewayResponse> UpdateDirectConnectGatewayAsync(UpdateDirectConnectGatewayRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDirectConnectConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDirectConnectConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDirectConnectConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDirectConnectConfig to create AmazonDirectConnectClient");
            }

            return awsCredentials == null ? 
                    new AmazonDirectConnectClient(serviceClientConfig) :
                    new AmazonDirectConnectClient(awsCredentials, serviceClientConfig);
        }
