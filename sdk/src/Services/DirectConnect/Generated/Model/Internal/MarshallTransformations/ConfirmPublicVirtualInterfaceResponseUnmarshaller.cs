...
namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConfirmPublicVirtualInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ConfirmPublicVirtualInterfaceResponseUnmarshaller _instance = new ConfirmPublicVirtualInterfaceResponseUnmarshaller();        

        internal static ConfirmPublicVirtualInterfaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfirmPublicVirtualInterfaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
