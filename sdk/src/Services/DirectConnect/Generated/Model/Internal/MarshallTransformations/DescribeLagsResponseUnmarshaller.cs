...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLags operation
    /// </summary>  
    public class DescribeLagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLagsResponse response = new DescribeLagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Lag, LagUnmarshaller>(LagUnmarshaller.Instance);
                    response.Lags = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeLagsResponseUnmarshaller _instance = new DescribeLagsResponseUnmarshaller();        

        internal static DescribeLagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
