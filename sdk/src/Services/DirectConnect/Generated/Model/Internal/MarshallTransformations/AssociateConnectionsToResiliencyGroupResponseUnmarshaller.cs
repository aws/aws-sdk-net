...
{
    /// <summary>
    /// Response Unmarshaller for AssociateConnectionsToResiliencyGroup operation
    /// </summary>  
    public class AssociateConnectionsToResiliencyGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateConnectionsToResiliencyGroupResponse response = new AssociateConnectionsToResiliencyGroupResponse();
            ...
            {
                if (context.TestExpression("resiliencyGroupAssociations", targetDepth, ref reader))
                {
                    ...
                    response.ResiliencyGroupAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static AssociateConnectionsToResiliencyGroupResponseUnmarshaller _instance = new AssociateConnectionsToResiliencyGroupResponseUnmarshaller();        

        internal static AssociateConnectionsToResiliencyGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateConnectionsToResiliencyGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
