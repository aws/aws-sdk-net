...
{
    /// <summary>
    /// Response Unmarshaller for GetResiliencyGroup operation
    /// </summary>  
    public class GetResiliencyGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResiliencyGroupResponse response = new GetResiliencyGroupResponse();
        ...
        private static GetResiliencyGroupResponseUnmarshaller _instance = new GetResiliencyGroupResponseUnmarshaller();        

        internal static GetResiliencyGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResiliencyGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
