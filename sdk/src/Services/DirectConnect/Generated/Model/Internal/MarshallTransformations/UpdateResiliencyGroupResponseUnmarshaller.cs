...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResiliencyGroup operation
    /// </summary>  
    public class UpdateResiliencyGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResiliencyGroupResponse response = new UpdateResiliencyGroupResponse();
        ...
        private static UpdateResiliencyGroupResponseUnmarshaller _instance = new UpdateResiliencyGroupResponseUnmarshaller();        

        internal static UpdateResiliencyGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResiliencyGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
