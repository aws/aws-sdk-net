...
{
    /// <summary>
    /// Response Unmarshaller for AssociateMacSecKey operation
    /// </summary>  
    public class AssociateMacSecKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateMacSecKeyResponse response = new AssociateMacSecKeyResponse();
        ...
        private static AssociateMacSecKeyResponseUnmarshaller _instance = new AssociateMacSecKeyResponseUnmarshaller();        

        internal static AssociateMacSecKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateMacSecKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
