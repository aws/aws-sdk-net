...
{
    /// <summary>
    /// AssociateVirtualInterface Request Marshaller
    /// </summary>       
    public class AssociateVirtualInterfaceRequestMarshaller : IMarshaller<IRequest, AssociateVirtualInterfaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateVirtualInterfaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateVirtualInterfaceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectConnect");
            string target = "OvertureService.AssociateVirtualInterface";
