...
{
    /// <summary>
    /// NewPrivateVirtualInterface Marshaller
    /// </summary>
    public class NewPrivateVirtualInterfaceMarshaller : IRequestMarshaller<NewPrivateVirtualInterface, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(NewPrivateVirtualInterface requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDirectConnectGatewayId())
            {
                ...
                context.Writer.WriteStringValue(requestObject.DirectConnectGatewayId);
            }

            if(requestObject.IsSetEnableSiteLink())
            {
                context.Writer.WritePropertyName("enableSiteLink");
                context.Writer.WriteBooleanValue(requestObject.EnableSiteLink.Value);
            }
            ...
            if(requestObject.IsSetVirtualGatewayId())
            {
                ...
                context.Writer.WriteStringValue(requestObject.VirtualGatewayId);
            }
        ...
        /// </summary>
        public readonly static NewPrivateVirtualInterfaceMarshaller Instance = new NewPrivateVirtualInterfaceMarshaller();
