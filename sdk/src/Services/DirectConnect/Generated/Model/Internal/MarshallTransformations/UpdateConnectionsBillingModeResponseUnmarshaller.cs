...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConnectionsBillingMode operation
    /// </summary>  
    public class UpdateConnectionsBillingModeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConnectionsBillingModeResponse response = new UpdateConnectionsBillingModeResponse();
        ...
        private static UpdateConnectionsBillingModeResponseUnmarshaller _instance = new UpdateConnectionsBillingModeResponseUnmarshaller();        

        internal static UpdateConnectionsBillingModeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConnectionsBillingModeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
