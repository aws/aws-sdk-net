...
{
    /// <summary>
    /// Response Unmarshaller for DescribeHostedConnections operation
    /// </summary>  
    public class DescribeHostedConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeHostedConnectionsResponse response = new DescribeHostedConnectionsResponse();
        ...
        private static DescribeHostedConnectionsResponseUnmarshaller _instance = new DescribeHostedConnectionsResponseUnmarshaller();        

        internal static DescribeHostedConnectionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeHostedConnectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
