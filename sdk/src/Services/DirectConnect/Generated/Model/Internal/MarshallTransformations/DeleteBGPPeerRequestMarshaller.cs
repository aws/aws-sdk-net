...
{
    /// <summary>
    /// DeleteBGPPeer Request Marshaller
    /// </summary>       
    public class DeleteBGPPeerRequestMarshaller : IMarshaller<IRequest, DeleteBGPPeerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteBGPPeerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBGPPeerRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAsn())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.Asn.Value);
            }

            if(publicRequest.IsSetAsnLong())
            {
                context.Writer.WritePropertyName("asnLong");
                context.Writer.WriteNumberValue(publicRequest.AsnLong.Value);
            }

            if(publicRequest.IsSetBgpPeerId())
            {
                context.Writer.WritePropertyName("bgpPeerId");
                context.Writer.WriteStringValue(publicRequest.BgpPeerId);
            }

            if(publicRequest.IsSetCustomerAddress())
            {
                context.Writer.WritePropertyName("customerAddress");
                context.Writer.WriteStringValue(publicRequest.CustomerAddress);
            }
