...
{
    /// <summary>
    /// Response Unmarshaller for ResiliencyGroupSummary Object
    /// </summary>  
    public class ResiliencyGroupSummaryUnmarshaller : IJsonUnmarshaller<ResiliencyGroupSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResiliencyGroupSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ResiliencyGroupSummary unmarshalledObject = new ResiliencyGroupSummary();
        ...
        private static ResiliencyGroupSummaryUnmarshaller _instance = new ResiliencyGroupSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResiliencyGroupSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
