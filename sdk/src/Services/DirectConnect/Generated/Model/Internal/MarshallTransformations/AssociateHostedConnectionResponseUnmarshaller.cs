...
{
    /// <summary>
    /// Response Unmarshaller for AssociateHostedConnection operation
    /// </summary>  
    public class AssociateHostedConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateHostedConnectionResponse response = new AssociateHostedConnectionResponse();
        ...
        private static AssociateHostedConnectionResponseUnmarshaller _instance = new AssociateHostedConnectionResponseUnmarshaller();        

        internal static AssociateHostedConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateHostedConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
