...
{
    /// <summary>
    /// Response Unmarshaller for ListResiliencyGroupAssociations operation
    /// </summary>  
    public class ListResiliencyGroupAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResiliencyGroupAssociationsResponse response = new ListResiliencyGroupAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResiliencyGroupAssociation, ResiliencyGroupAssociationUnmarshaller>(ResiliencyGroupAssociationUnmarshaller.Instance);
        ...
        private static ListResiliencyGroupAssociationsResponseUnmarshaller _instance = new ListResiliencyGroupAssociationsResponseUnmarshaller();        

        internal static ListResiliencyGroupAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResiliencyGroupAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
