...
{
    /// <summary>
    /// Response Unmarshaller for CreateResiliencyGroup operation
    /// </summary>  
    public class CreateResiliencyGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResiliencyGroupResponse response = new CreateResiliencyGroupResponse();
        ...
        private static CreateResiliencyGroupResponseUnmarshaller _instance = new CreateResiliencyGroupResponseUnmarshaller();        

        internal static CreateResiliencyGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResiliencyGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
