...
{
    /// <summary>
    /// Response Unmarshaller for ListResiliencyGroups operation
    /// </summary>  
    public class ListResiliencyGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResiliencyGroupsResponse response = new ListResiliencyGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResiliencyGroupSummary, ResiliencyGroupSummaryUnmarshaller>(ResiliencyGroupSummaryUnmarshaller.Instance);
        ...
        private static ListResiliencyGroupsResponseUnmarshaller _instance = new ListResiliencyGroupsResponseUnmarshaller();        

        internal static ListResiliencyGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResiliencyGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
