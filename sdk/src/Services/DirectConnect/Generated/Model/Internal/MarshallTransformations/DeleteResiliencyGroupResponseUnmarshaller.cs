...
{
    /// <summary>
    /// Response Unmarshaller for DeleteResiliencyGroup operation
    /// </summary>  
    public class DeleteResiliencyGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteResiliencyGroupResponse response = new DeleteResiliencyGroupResponse();
            ...
            {
                if (context.TestExpression("resiliencyGroup", targetDepth, ref reader))
                {
                    var unmarshaller = ResiliencyGroupUnmarshaller.Instance;
                    response.ResiliencyGroup = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteResiliencyGroupResponseUnmarshaller _instance = new DeleteResiliencyGroupResponseUnmarshaller();        

        internal static DeleteResiliencyGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteResiliencyGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
