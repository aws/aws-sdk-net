...
{
    /// <summary>
    /// Response Unmarshaller for ListVirtualInterfaceRoutes operation
    /// </summary>  
    public class ListVirtualInterfaceRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVirtualInterfaceRoutesResponse response = new ListVirtualInterfaceRoutesResponse();
        ...
        private static ListVirtualInterfaceRoutesResponseUnmarshaller _instance = new ListVirtualInterfaceRoutesResponseUnmarshaller();        

        internal static ListVirtualInterfaceRoutesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVirtualInterfaceRoutesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
