...
namespace Amazon.SavingsPlans.Model
{
    ...
    public partial class SavingsPlanOfferingRate
    {
        ...
        /// </summary>
        public List<SavingsPlanOfferingRateProperty> Properties { get; set; } = AWSConfigs.InitializeCollections ? new List<SavingsPlanOfferingRateProperty>() : null;
        ...
        /// </para>
        /// </summary>
        public ParentSavingsPlanOffering SavingsPlanOffering { get; set; }

        /// <summary>
        /// Checks to see if the SavingsPlanOffering property is set.
        /// </summary>
        internal bool IsSetSavingsPlanOffering() => this.SavingsPlanOffering != null;
