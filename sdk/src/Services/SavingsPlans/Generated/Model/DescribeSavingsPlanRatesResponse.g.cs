...
namespace Amazon.SavingsPlans.Model
{
    ...
    public partial class DescribeSavingsPlanRatesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SavingsPlanRate> SearchResults { get; set; } = AWSConfigs.InitializeCollections ? new List<SavingsPlanRate>() : null;

        /// <summary>
        /// Checks to see if the SearchResults property is set.
        /// </summary>
        internal bool IsSetSearchResults() => this.SearchResults != null && (this.SearchResults.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
