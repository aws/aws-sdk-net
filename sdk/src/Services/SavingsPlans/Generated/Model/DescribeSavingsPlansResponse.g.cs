...
namespace Amazon.SavingsPlans.Model
{
    ...
    public partial class DescribeSavingsPlansResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SavingsPlan> SavingsPlans { get; set; } = AWSConfigs.InitializeCollections ? new List<SavingsPlan>() : null;

        /// <summary>
        /// Checks to see if the SavingsPlans property is set.
        /// </summary>
        internal bool IsSetSavingsPlans() => this.SavingsPlans != null && (this.SavingsPlans.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
