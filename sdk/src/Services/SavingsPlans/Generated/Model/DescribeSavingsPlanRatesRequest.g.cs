...
{
    /// <summary>
    /// Container for the parameters to the DescribeSavingsPlanRates operation. Describes
    /// the rates for a specific, existing Savings Plan.
    /// </summary>
    public partial class DescribeSavingsPlanRatesRequest : AmazonSavingsPlansRequest
    {
        ...
        /// </summary>
        public List<SavingsPlanRateFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<SavingsPlanRateFilter>() : null;
