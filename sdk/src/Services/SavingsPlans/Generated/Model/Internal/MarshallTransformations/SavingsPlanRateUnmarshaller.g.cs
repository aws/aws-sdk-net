...
namespace Amazon.SavingsPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SavingsPlanRateUnmarshaller : IJsonUnmarshaller<SavingsPlanRate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SavingsPlanRate();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("productType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("rate", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static SavingsPlanRateUnmarshaller Instance => _instance;
    }
}
