...
namespace Amazon.SavingsPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SavingsPlanUnmarshaller : IJsonUnmarshaller<SavingsPlan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SavingsPlan();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SavingsPlanUnmarshaller Instance => _instance;
    }
}
