...
namespace Amazon.SavingsPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteQueuedSavingsPlanRequestMarshaller : IMarshaller<IRequest, DeleteQueuedSavingsPlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteQueuedSavingsPlanRequestMarshaller _instance = new();

        internal static DeleteQueuedSavingsPlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteQueuedSavingsPlanRequestMarshaller Instance => _instance;
    }
}
