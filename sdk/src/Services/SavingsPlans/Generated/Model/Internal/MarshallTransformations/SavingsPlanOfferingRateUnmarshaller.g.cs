...
namespace Amazon.SavingsPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SavingsPlanOfferingRateUnmarshaller : IJsonUnmarshaller<SavingsPlanOfferingRate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SavingsPlanOfferingRate();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SavingsPlanOfferingRateUnmarshaller Instance => _instance;
    }
}
