...
namespace Amazon.SavingsPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeSavingsPlansOfferingRatesRequestMarshaller : IMarshaller<IRequest, DescribeSavingsPlansOfferingRatesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeSavingsPlansOfferingRatesRequestMarshaller _instance = new();

        internal static DescribeSavingsPlansOfferingRatesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeSavingsPlansOfferingRatesRequestMarshaller Instance => _instance;
    }
}
