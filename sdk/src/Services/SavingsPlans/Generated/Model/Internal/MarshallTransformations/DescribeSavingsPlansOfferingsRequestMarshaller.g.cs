...
namespace Amazon.SavingsPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeSavingsPlansOfferingsRequestMarshaller : IMarshaller<IRequest, DescribeSavingsPlansOfferingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeSavingsPlansOfferingsRequestMarshaller _instance = new();

        internal static DescribeSavingsPlansOfferingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeSavingsPlansOfferingsRequestMarshaller Instance => _instance;
    }
}
