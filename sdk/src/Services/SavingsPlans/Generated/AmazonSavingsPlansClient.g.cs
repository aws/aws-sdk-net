...
namespace Amazon.SavingsPlans
{
    ...
    public partial class AmazonSavingsPlansClient : AmazonServiceClient, IAmazonSavingsPlans
    {
        ...
        /// 
        /// </summary>
        public AmazonSavingsPlansClient() : base(new AmazonSavingsPlansConfig()) { }
        ...
        public AmazonSavingsPlansClient(RegionEndpoint region) : base(new AmazonSavingsPlansConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSavingsPlansClient(AmazonSavingsPlansConfig config) : base(config) { }
...
#else
        internal virtual ReturnSavingsPlanResponse ReturnSavingsPlan(ReturnSavingsPlanRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ReturnSavingsPlanRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ReturnSavingsPlanResponseUnmarshaller.Instance;
