...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("savingsplans", "4.0.0.0");

        private static readonly AmazonSavingsPlansEndpointResolver EndpointResolver =
            new AmazonSavingsPlansEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("savingsplans", "3.7.400.130");
=======
            InternalSDKUtils.BuildUserAgentString("savingsplans", "3.7.400.140");
