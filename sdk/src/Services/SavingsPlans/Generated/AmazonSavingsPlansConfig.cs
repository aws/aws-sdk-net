...
namespace Amazon.SavingsPlans
{
    ...
    public partial class AmazonSavingsPlansConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("savingsplans", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "savingsplans";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "savingsplans";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-06-28";
