...
namespace Amazon.DataSync.Model
{
    ...
    internal sealed partial class ListTasksPaginator : IPaginator<ListTasksResponse>, IListTasksPaginator
    {
        ...
        public IPaginatedEnumerable<TaskListEntry> Tasks => 
            new PaginatedResultKeyResponse<ListTasksResponse, TaskListEntry>(this, (i) => i.Tasks ?? new List<TaskListEntry>());
        ...
        async IAsyncEnumerable<ListTasksResponse> IPaginator<ListTasksResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
