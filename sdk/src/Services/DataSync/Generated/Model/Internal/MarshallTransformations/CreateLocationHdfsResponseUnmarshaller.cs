...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationHdfs operation
    /// </summary>  
    public class CreateLocationHdfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationHdfsResponse response = new CreateLocationHdfsResponse();
        ...
        private static CreateLocationHdfsResponseUnmarshaller _instance = new CreateLocationHdfsResponseUnmarshaller();        

        internal static CreateLocationHdfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationHdfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
