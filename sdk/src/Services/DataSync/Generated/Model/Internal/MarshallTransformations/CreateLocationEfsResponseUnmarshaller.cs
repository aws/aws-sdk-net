...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationEfs operation
    /// </summary>  
    public class CreateLocationEfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationEfsResponse response = new CreateLocationEfsResponse();
        ...
        private static CreateLocationEfsResponseUnmarshaller _instance = new CreateLocationEfsResponseUnmarshaller();        

        internal static CreateLocationEfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationEfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
