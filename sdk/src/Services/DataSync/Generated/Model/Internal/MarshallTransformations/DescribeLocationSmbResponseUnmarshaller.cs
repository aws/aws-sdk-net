...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationSmb operation
    /// </summary>  
    public class DescribeLocationSmbResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationSmbResponse response = new DescribeLocationSmbResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.DnsIpAddresses = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeLocationSmbResponseUnmarshaller _instance = new DescribeLocationSmbResponseUnmarshaller();        

        internal static DescribeLocationSmbResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationSmbResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
