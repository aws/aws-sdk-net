    ...
    public class ResourceDetailsUnmarshaller : IUnmarshaller<ResourceDetails, XmlUnmarshallerContext>, IUnmarshaller<ResourceDetails, JsonUnmarshallerContext>
    {
        ...
        public ResourceDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<NetAppONTAPCluster, NetAppONTAPClusterUnmarshaller>(NetAppONTAPClusterUnmarshaller.Instance);
                    unmarshalledObject.NetAppONTAPClusters = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("NetAppONTAPSVMs", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<NetAppONTAPSVM, NetAppONTAPSVMUnmarshaller>(NetAppONTAPSVMUnmarshaller.Instance);
                    unmarshalledObject.NetAppONTAPSVMs = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("NetAppONTAPVolumes", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<NetAppONTAPVolume, NetAppONTAPVolumeUnmarshaller>(NetAppONTAPVolumeUnmarshaller.Instance);
                    unmarshalledObject.NetAppONTAPVolumes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
