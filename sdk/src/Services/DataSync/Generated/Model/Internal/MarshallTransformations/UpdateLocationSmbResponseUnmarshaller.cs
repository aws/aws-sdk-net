...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLocationSmb operation
    /// </summary>  
    public class UpdateLocationSmbResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLocationSmbResponse response = new UpdateLocationSmbResponse();
        ...
        private static UpdateLocationSmbResponseUnmarshaller _instance = new UpdateLocationSmbResponseUnmarshaller();        

        internal static UpdateLocationSmbResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLocationSmbResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
