    ...
    public class ListTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TaskListEntry, TaskListEntryUnmarshaller>(TaskListEntryUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
