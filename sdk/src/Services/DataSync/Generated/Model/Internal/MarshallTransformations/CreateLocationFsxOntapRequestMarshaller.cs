...
{
    /// <summary>
    /// CreateLocationFsxOntap Request Marshaller
    /// </summary>       
    public class CreateLocationFsxOntapRequestMarshaller : IMarshaller<IRequest, CreateLocationFsxOntapRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLocationFsxOntapRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLocationFsxOntapRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DataSync");
            string target = "FmrsService.CreateLocationFsxOntap";
            ...
            if(publicRequest.IsSetStorageVirtualMachineArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.StorageVirtualMachineArn);
            }
        ...
        private static CreateLocationFsxOntapRequestMarshaller _instance = new CreateLocationFsxOntapRequestMarshaller();        

        internal static CreateLocationFsxOntapRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationFsxOntapRequestMarshaller Instance
        {
            get
            {
                return _instance;
