...
namespace Amazon.DataSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateTaskResponseUnmarshaller _instance = new CreateTaskResponseUnmarshaller();        

        internal static CreateTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
