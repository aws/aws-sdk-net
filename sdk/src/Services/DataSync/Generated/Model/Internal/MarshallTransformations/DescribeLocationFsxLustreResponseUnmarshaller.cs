...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationFsxLustre operation
    /// </summary>  
    public class DescribeLocationFsxLustreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationFsxLustreResponse response = new DescribeLocationFsxLustreResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SecurityGroupArns", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.SecurityGroupArns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeLocationFsxLustreResponseUnmarshaller _instance = new DescribeLocationFsxLustreResponseUnmarshaller();        

        internal static DescribeLocationFsxLustreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationFsxLustreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
