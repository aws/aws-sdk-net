...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationS3 operation
    /// </summary>  
    public class DescribeLocationS3ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationS3Response response = new DescribeLocationS3Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("S3Config", targetDepth, ref reader))
                {
                    ...
                    response.S3Config = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("S3StorageClass", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.S3StorageClass = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeLocationS3ResponseUnmarshaller _instance = new DescribeLocationS3ResponseUnmarshaller();        

        internal static DescribeLocationS3ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationS3ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
