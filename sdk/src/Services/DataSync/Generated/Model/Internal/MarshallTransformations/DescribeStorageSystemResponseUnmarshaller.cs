    ...
    public class DescribeStorageSystemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConnectivityStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SecretsManagerArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ServerConfiguration", targetDepth))
                {
                    ...
                    response.ServerConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SystemType = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
