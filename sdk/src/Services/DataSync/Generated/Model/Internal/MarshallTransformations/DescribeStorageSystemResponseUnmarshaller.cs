...
{
    /// <summary>
    /// Response Unmarshaller for DescribeStorageSystem operation
    /// </summary>  
    public class DescribeStorageSystemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeStorageSystemResponse response = new DescribeStorageSystemResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConnectivityStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SecretsManagerArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ServerConfiguration", targetDepth))
                {
                    var unmarshaller = DiscoveryServerConfigurationUnmarshaller.Instance;
                    response.ServerConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SystemType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeStorageSystemResponseUnmarshaller _instance = new DescribeStorageSystemResponseUnmarshaller();        

        internal static DescribeStorageSystemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStorageSystemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
