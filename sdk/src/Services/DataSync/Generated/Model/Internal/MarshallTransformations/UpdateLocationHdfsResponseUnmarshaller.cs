...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLocationHdfs operation
    /// </summary>  
    public class UpdateLocationHdfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLocationHdfsResponse response = new UpdateLocationHdfsResponse();
        ...
        private static UpdateLocationHdfsResponseUnmarshaller _instance = new UpdateLocationHdfsResponseUnmarshaller();        

        internal static UpdateLocationHdfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLocationHdfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
