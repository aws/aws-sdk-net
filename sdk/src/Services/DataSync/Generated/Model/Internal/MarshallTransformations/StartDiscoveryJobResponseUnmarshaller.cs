...
{
    /// <summary>
    /// Response Unmarshaller for StartDiscoveryJob operation
    /// </summary>  
    public class StartDiscoveryJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDiscoveryJobResponse response = new StartDiscoveryJobResponse();
        ...
        private static StartDiscoveryJobResponseUnmarshaller _instance = new StartDiscoveryJobResponseUnmarshaller();        

        internal static StartDiscoveryJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDiscoveryJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
