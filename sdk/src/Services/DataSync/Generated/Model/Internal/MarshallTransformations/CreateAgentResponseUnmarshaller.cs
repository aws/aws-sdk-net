...
{
    /// <summary>
    /// Response Unmarshaller for CreateAgent operation
    /// </summary>  
    public class CreateAgentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AgentArn", targetDepth))
                {
                    ...
                    response.AgentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAgentResponseUnmarshaller _instance = new CreateAgentResponseUnmarshaller();        

        internal static CreateAgentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
