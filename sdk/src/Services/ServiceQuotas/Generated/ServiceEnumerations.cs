...
namespace Amazon.ServiceQuotas
{
    ...
    /// <summary>
    /// Constants used for properties of type AdjustableAtLevelEnum.
    /// </summary>
    public class AdjustableAtLevelEnum : ConstantClass
    {

        /// <summary>
        /// Constant ACCOUNT for AdjustableAtLevelEnum
        /// </summary>
        public static readonly AdjustableAtLevelEnum ACCOUNT = new AdjustableAtLevelEnum("ACCOUNT");
        /// <summary>
        /// Constant ALL for AdjustableAtLevelEnum
        /// </summary>
        public static readonly AdjustableAtLevelEnum ALL = new AdjustableAtLevelEnum("ALL");
        /// <summary>
        /// Constant PER_RESOURCE for AdjustableAtLevelEnum
        /// </summary>
        public static readonly AdjustableAtLevelEnum PER_RESOURCE = new AdjustableAtLevelEnum("PER_RESOURCE");
        ...
        /// </summary>
        public AdjustableAtLevelEnum(string value)
            : base(value)
        {
        }
        ...
        public static AdjustableAtLevelEnum FindValue(string value)
        {
            return FindValue<AdjustableAtLevelEnum>(value);
        }
        ...
        /// <returns></returns>
        public static implicit operator AdjustableAtLevelEnum(string value)
        {
    ...
    public class ReportStatus : ConstantClass
    {
        ...
        /// <summary>
        /// Constant IN_PROGRESS for ReportStatus
        /// </summary>
        public static readonly ReportStatus IN_PROGRESS = new ReportStatus("IN_PROGRESS");
        /// <summary>
    ...
    /// <summary>
    /// Constants used for properties of type RequestType.
    /// </summary>
    public class RequestType : ConstantClass
    {

        /// <summary>
        /// Constant AutomaticManagement for RequestType
        /// </summary>
        public static readonly RequestType AutomaticManagement = new RequestType("AutomaticManagement");
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static RequestType FindValue(string value)
        {
            return FindValue<RequestType>(value);
        }
