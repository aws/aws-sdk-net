...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAutoManagement operation
    /// </summary>  
    public class UpdateAutoManagementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAutoManagementResponse response = new UpdateAutoManagementResponse();
        ...
        private static UpdateAutoManagementResponseUnmarshaller _instance = new UpdateAutoManagementResponseUnmarshaller();        

        internal static UpdateAutoManagementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAutoManagementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
