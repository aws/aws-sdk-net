...
{
    /// <summary>
    /// Response Unmarshaller for StartQuotaUtilizationReport operation
    /// </summary>  
    public class StartQuotaUtilizationReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartQuotaUtilizationReportResponse response = new StartQuotaUtilizationReportResponse();
        ...
        private static StartQuotaUtilizationReportResponseUnmarshaller _instance = new StartQuotaUtilizationReportResponseUnmarshaller();        

        internal static StartQuotaUtilizationReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQuotaUtilizationReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
