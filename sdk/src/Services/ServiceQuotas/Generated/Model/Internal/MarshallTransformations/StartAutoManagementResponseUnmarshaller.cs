...
{
    /// <summary>
    /// Response Unmarshaller for StartAutoManagement operation
    /// </summary>  
    public class StartAutoManagementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAutoManagementResponse response = new StartAutoManagementResponse();
        ...
        private static StartAutoManagementResponseUnmarshaller _instance = new StartAutoManagementResponseUnmarshaller();        

        internal static StartAutoManagementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAutoManagementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
