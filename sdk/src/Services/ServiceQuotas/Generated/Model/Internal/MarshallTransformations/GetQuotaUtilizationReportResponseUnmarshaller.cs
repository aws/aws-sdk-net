...
{
    /// <summary>
    /// Response Unmarshaller for GetQuotaUtilizationReport operation
    /// </summary>  
    public class GetQuotaUtilizationReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQuotaUtilizationReportResponse response = new GetQuotaUtilizationReportResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("GeneratedAt", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.GeneratedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<QuotaUtilizationInfo, QuotaUtilizationInfoUnmarshaller>(QuotaUtilizationInfoUnmarshaller.Instance);
        ...
        private static GetQuotaUtilizationReportResponseUnmarshaller _instance = new GetQuotaUtilizationReportResponseUnmarshaller();        

        internal static GetQuotaUtilizationReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQuotaUtilizationReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
