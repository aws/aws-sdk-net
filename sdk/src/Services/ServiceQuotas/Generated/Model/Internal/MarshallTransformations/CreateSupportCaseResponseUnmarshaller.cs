...
{
    /// <summary>
    /// Response Unmarshaller for CreateSupportCase operation
    /// </summary>  
    public class CreateSupportCaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSupportCaseResponse response = new CreateSupportCaseResponse();
        ...
        private static CreateSupportCaseResponseUnmarshaller _instance = new CreateSupportCaseResponseUnmarshaller();        

        internal static CreateSupportCaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSupportCaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
