...
namespace Amazon.ServiceQuotas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QuotaUtilizationInfoUnmarshaller : IJsonUnmarshaller<QuotaUtilizationInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QuotaUtilizationInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("Adjustable", targetDepth, ref reader))
                {
