...
namespace Amazon.ServiceQuotas.Model.Internal.MarshallTransformations
{
    ...
    public class GetAssociationForServiceQuotaTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new ServiceQuotaTemplateNotInUseException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
