...
{
    /// <summary>
    /// StartAutoManagement Request Marshaller
    /// </summary>       
    public class StartAutoManagementRequestMarshaller : IMarshaller<IRequest, StartAutoManagementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartAutoManagementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartAutoManagementRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceQuotas");
            string target = "ServiceQuotasV20190624.StartAutoManagement";
            ...
            if(publicRequest.IsSetOptInLevel())
            {
                context.Writer.WritePropertyName("OptInLevel");
                context.Writer.WriteStringValue(publicRequest.OptInLevel);
            }
        ...
        private static StartAutoManagementRequestMarshaller _instance = new StartAutoManagementRequestMarshaller();        

        internal static StartAutoManagementRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAutoManagementRequestMarshaller Instance
        {
            get
            {
                return _instance;
