...
namespace Amazon.ServiceQuotas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IllegalArgumentExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<IllegalArgumentException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IllegalArgumentException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public IllegalArgumentException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
