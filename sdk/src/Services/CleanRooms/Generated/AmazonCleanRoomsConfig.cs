...
namespace Amazon.CleanRooms
{
    ...
    public partial class AmazonCleanRoomsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CleanRooms", "4.0.104.6");
        ...
        /// </summary>
        public static new string ServiceId => "CleanRooms";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "cleanrooms";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-02-17";
