...
namespace Amazon.CleanRooms
{
    ...
    public partial class AmazonCleanRoomsException : AmazonServiceException
    {
        ...
        /// </summary>
        public AmazonCleanRoomsException()
            : base()
        {
        }
        ...
        public AmazonCleanRoomsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCleanRoomsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
