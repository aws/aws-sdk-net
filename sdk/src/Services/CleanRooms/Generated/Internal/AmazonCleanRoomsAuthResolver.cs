...
namespace Amazon.CleanRooms.Internal
{
    ...
    public class AmazonCleanRoomsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCleanRoomsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CleanRooms.
        /// </summary>
        public AmazonCleanRoomsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCleanRoomsAuthSchemeParameters
            {
    ...
    public class AmazonCleanRoomsAuthSchemeResolver : IAuthSchemeResolver<AmazonCleanRoomsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCleanRoomsAuthSchemeParameters authParameters)
        {
