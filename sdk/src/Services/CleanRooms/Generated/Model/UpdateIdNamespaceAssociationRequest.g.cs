...
{
    /// <summary>
    /// Container for the parameters to the UpdateIdNamespaceAssociation operation. Provides
    /// the details that are necessary to update an ID namespace association.
    /// </summary>
