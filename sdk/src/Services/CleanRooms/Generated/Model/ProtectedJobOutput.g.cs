...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class ProtectedJobOutput
    {
        ...
        /// </summary>
        public List<ProtectedJobSingleMemberOutput> MemberList { get; set; } = AWSConfigs.InitializeCollections ? new List<ProtectedJobSingleMemberOutput>() : null;

        /// <summary>
        /// Checks to see if the MemberList property is set.
        /// </summary>
        internal bool IsSetMemberList() => this.MemberList != null && (this.MemberList.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </para>
        /// </summary>
        public ProtectedJobS3Output S3 { get; set; }
