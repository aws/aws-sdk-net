...
{
    /// <summary>
    /// Container for the parameters to the PreviewPrivacyImpact operation. An estimate of
    /// the number of aggregation functions that the member who can query can run given epsilon
    ...
    public partial class PreviewPrivacyImpactRequest : AmazonCleanRoomsRequest
    {
        ...
        public PreviewPrivacyImpactParametersInput Parameters { get; set; }
