...
{
    /// <summary>
    /// Container for the parameters to the GetIdNamespaceAssociation operation. Retrieves
    /// an ID namespace association.
    /// </summary>
    public partial class GetIdNamespaceAssociationRequest : AmazonCleanRoomsRequest
    {
        ...
        /// <summary>
        /// Checks to see if the IdNamespaceAssociationIdentifier property is set.
        /// </summary>
        internal bool IsSetIdNamespaceAssociationIdentifier() => this.IdNamespaceAssociationIdentifier != null;
