...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class ColumnClassificationDetails
    {
        ...
        public List<SyntheticDataColumnProperties> ColumnMapping { get; set; } = AWSConfigs.InitializeCollections ? new List<SyntheticDataColumnProperties>() : null;

        /// <summary>
        /// Checks to see if the ColumnMapping property is set.
        /// </summary>
        internal bool IsSetColumnMapping() => this.ColumnMapping != null && (this.ColumnMapping.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
