...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class BatchGetSchemaResponse : AmazonWebServiceResponse
    {
        ...
        public List<BatchGetSchemaError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchGetSchemaError>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true, Max = 25)]
        public List<Schema> Schemas { get; set; } = AWSConfigs.InitializeCollections ? new List<Schema>() : null;
