...
{
    /// <summary>
    /// Container for the parameters to the CreateCollaborationChangeRequest operation. Creates
    /// a new change request to modify an existing collaboration. This enables post-creation
    ...
    public partial class CreateCollaborationChangeRequestRequest : AmazonCleanRoomsRequest
    {
        ...
        public List<ChangeInput> Changes { get; set; } = AWSConfigs.InitializeCollections ? new List<ChangeInput>() : null;
