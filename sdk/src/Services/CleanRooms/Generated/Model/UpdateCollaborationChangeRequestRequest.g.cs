...
{
    /// <summary>
    /// Container for the parameters to the UpdateCollaborationChangeRequest operation. Updates
    /// an existing collaboration change request. This operation allows approval actions for
    /// pending change requests in collaborations (APPROVE, DENY, CANCEL, COMMIT). <para>
    ...
    public partial class UpdateCollaborationChangeRequestRequest : AmazonCleanRoomsRequest
    {
        ...
        public ChangeRequestAction Action { get; set; }
        ...
        /// <summary>
        /// Checks to see if the ChangeRequestIdentifier property is set.
        /// </summary>
        internal bool IsSetChangeRequestIdentifier() => this.ChangeRequestIdentifier != null;
