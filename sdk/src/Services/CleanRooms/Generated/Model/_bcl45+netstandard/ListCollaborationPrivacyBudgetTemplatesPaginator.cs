...
namespace Amazon.CleanRooms.Model
{
    ...
    internal sealed partial class ListCollaborationPrivacyBudgetTemplatesPaginator : IPaginator<ListCollaborationPrivacyBudgetTemplatesResponse>, IListCollaborationPrivacyBudgetTemplatesPaginator
    {
        ...
        public IPaginatedEnumerable<CollaborationPrivacyBudgetTemplateSummary> CollaborationPrivacyBudgetTemplateSummaries => 
            new PaginatedResultKeyResponse<ListCollaborationPrivacyBudgetTemplatesResponse, CollaborationPrivacyBudgetTemplateSummary>(this, (i) => i.CollaborationPrivacyBudgetTemplateSummaries ?? new List<CollaborationPrivacyBudgetTemplateSummary>());
        ...
        async IAsyncEnumerable<ListCollaborationPrivacyBudgetTemplatesResponse> IPaginator<ListCollaborationPrivacyBudgetTemplatesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
