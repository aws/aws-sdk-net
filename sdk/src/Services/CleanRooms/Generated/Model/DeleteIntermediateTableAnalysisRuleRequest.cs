...
{
    /// <summary>
    /// Container for the parameters to the DeleteIntermediateTableAnalysisRule operation.
    ...
    /// </summary>
    public partial class DeleteIntermediateTableAnalysisRuleRequest : AmazonCleanRoomsRequest
    {
        ...
        /// <para>
        /// The type of analysis rule to delete. Currently, only <c>CUSTOM</c> is supported.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The unique identifier of the intermediate table from which to delete the analysis
        /// rule.
        /// </para>
        /// </summary>
