...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class BatchGetSchemaAnalysisRuleResponse : AmazonWebServiceResponse
    {
        ...
        public List<AnalysisRule> AnalysisRules { get; set; } = AWSConfigs.InitializeCollections ? new List<AnalysisRule>() : null;

        /// <summary>
        /// Checks to see if the AnalysisRules property is set.
        /// </summary>
        internal bool IsSetAnalysisRules() => this.AnalysisRules != null && (this.AnalysisRules.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Required = true, Max = 25)]
        public List<BatchGetSchemaAnalysisRuleError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchGetSchemaAnalysisRuleError>() : null;
