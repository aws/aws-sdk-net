...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class WorkerComputeConfigurationProperties
    {
        ...
        public Dictionary<string, string> Spark { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the Spark property is set.
        /// </summary>
        internal bool IsSetSpark() => this.Spark != null && (this.Spark.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
