...
{
    /// <summary>
    /// Container for the parameters to the ListSchemas operation. Lists the schemas for relations
    ...
    public partial class ListSchemasRequest : AmazonCleanRoomsRequest
    {
        ...
        /// <summary>
        /// Checks to see if the SchemaType property is set.
        /// </summary>
        internal bool IsSetSchemaType() => this.SchemaType != null;
    }
}
