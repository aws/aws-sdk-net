...
{
    /// <summary>
    /// Container for the parameters to the DeletePrivacyBudgetTemplate operation. Deletes
    /// a privacy budget template for a specified collaboration.
    /// </summary>
    public partial class DeletePrivacyBudgetTemplateRequest : AmazonCleanRoomsRequest
    {
        ...
        /// <summary>
        /// Checks to see if the PrivacyBudgetTemplateIdentifier property is set.
        /// </summary>
        internal bool IsSetPrivacyBudgetTemplateIdentifier() => this.PrivacyBudgetTemplateIdentifier != null;
    }
}
