...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class AnalysisRuleIdMappingTable
    {
        ...
        public List<QueryConstraint> QueryConstraints { get; set; } = AWSConfigs.InitializeCollections ? new List<QueryConstraint>() : null;

        /// <summary>
        /// Checks to see if the QueryConstraints property is set.
        /// </summary>
        internal bool IsSetQueryConstraints() => this.QueryConstraints != null && (this.QueryConstraints.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
