...
{
    /// <summary>
    /// Response Unmarshaller for ConsolidatedPolicyCustom Object
    /// </summary>  
    public class ConsolidatedPolicyCustomUnmarshaller : IJsonUnmarshaller<ConsolidatedPolicyCustom, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConsolidatedPolicyCustom Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ConsolidatedPolicyCustom unmarshalledObject = new ConsolidatedPolicyCustom();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AllowedAnalyses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("allowedAnalysisProviders", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AllowedAnalysisProviders = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.DisallowedOutputColumns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ConsolidatedPolicyCustomUnmarshaller _instance = new ConsolidatedPolicyCustomUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConsolidatedPolicyCustomUnmarshaller Instance
        {
            get
            {
                return _instance;
...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// Response Unmarshaller for ConsolidatedPolicyCustom Object
    /// </summary>  
    public class ConsolidatedPolicyCustomUnmarshaller : IUnmarshaller<ConsolidatedPolicyCustom, XmlUnmarshallerContext>, IUnmarshaller<ConsolidatedPolicyCustom, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshaller the response from the service to the response class.
        /// </summary>  
        /// <param name="context"></param>
        /// <returns></returns>
        ConsolidatedPolicyCustom IUnmarshaller<ConsolidatedPolicyCustom, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns>The unmarshalled object</returns>
        public ConsolidatedPolicyCustom Unmarshall(JsonUnmarshallerContext context)
        {
            ConsolidatedPolicyCustom unmarshalledObject = new ConsolidatedPolicyCustom();
            if (context.IsEmptyResponse)
                return null;
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AllowedAnalyses = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("allowedAnalysisProviders", targetDepth))
                {
