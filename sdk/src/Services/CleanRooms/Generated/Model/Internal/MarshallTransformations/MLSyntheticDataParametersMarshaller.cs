    ...
    public class MLSyntheticDataParametersMarshaller : IRequestMarshaller<MLSyntheticDataParameters, JsonMarshallerContext> 
    {
        ...
        public void Marshall(MLSyntheticDataParameters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEpsilon())
            {
                ...
                if(StringUtils.IsSpecialDoubleValue(requestObject.Epsilon.Value))
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(requestObject.Epsilon.Value));
                }
                else
                {
            ...
            if(requestObject.IsSetMaxMembershipInferenceAttackScore())
            {
                ...
                if(StringUtils.IsSpecialDoubleValue(requestObject.MaxMembershipInferenceAttackScore.Value))
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(requestObject.MaxMembershipInferenceAttackScore.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(requestObject.MaxMembershipInferenceAttackScore.Value);
                }
            }
