...
{
    /// <summary>
    /// UpdateConfiguredAudienceModelAssociation Request Marshaller
    /// </summary>
    public partial class UpdateConfiguredAudienceModelAssociationRequestMarshaller : IMarshaller<IRequest, UpdateConfiguredAudienceModelAssociationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateConfiguredAudienceModelAssociationRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateConfiguredAudienceModelAssociationRequest publicRequest)
        {
        ...
        private static readonly UpdateConfiguredAudienceModelAssociationRequestMarshaller _instance = new();

        internal static UpdateConfiguredAudienceModelAssociationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateConfiguredAudienceModelAssociationRequestMarshaller Instance => _instance;
    }
}
