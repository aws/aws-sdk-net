...
{
    /// <summary>
    /// UpdateIntermediateTableAnalysisRule Request Marshaller
    /// </summary>
    public partial class UpdateIntermediateTableAnalysisRuleRequestMarshaller : IMarshaller<IRequest, UpdateIntermediateTableAnalysisRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateIntermediateTableAnalysisRuleRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateIntermediateTableAnalysisRuleRequest publicRequest)
        {
            ...
            request.ResourcePath = "/memberships/{membershipIdentifier}/intermediateTables/{intermediateTableIdentifier}/analysisRule/{analysisRuleType}";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetAnalysisRulePolicy())
            {
                ...
                var marshaller = IntermediateTableAnalysisRulePolicyMarshaller.Instance;
        ...
        private static readonly UpdateIntermediateTableAnalysisRuleRequestMarshaller _instance = new();

        internal static UpdateIntermediateTableAnalysisRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIntermediateTableAnalysisRuleRequestMarshaller Instance => _instance;
    }
}
