...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteIntermediateTableAnalysisRuleRequestMarshaller : IMarshaller<IRequest, DeleteIntermediateTableAnalysisRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteIntermediateTableAnalysisRuleRequestMarshaller _instance = new DeleteIntermediateTableAnalysisRuleRequestMarshaller();        

        internal static DeleteIntermediateTableAnalysisRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIntermediateTableAnalysisRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
