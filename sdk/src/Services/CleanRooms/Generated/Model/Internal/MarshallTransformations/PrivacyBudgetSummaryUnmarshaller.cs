...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PrivacyBudgetSummaryUnmarshaller : IUnmarshaller<PrivacyBudgetSummary, XmlUnmarshallerContext>, IUnmarshaller<PrivacyBudgetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PrivacyBudgetSummary IUnmarshaller<PrivacyBudgetSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PrivacyBudgetSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrivacyBudgetTemplateArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("privacyBudgetTemplateId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrivacyBudgetTemplateId = unmarshaller.Unmarshall(context);
                    continue;
                }
