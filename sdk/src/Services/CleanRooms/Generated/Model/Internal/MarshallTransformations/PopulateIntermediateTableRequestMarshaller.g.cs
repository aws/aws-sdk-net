...
{
    /// <summary>
    /// PopulateIntermediateTable Request Marshaller
    /// </summary>
    public partial class PopulateIntermediateTableRequestMarshaller : IMarshaller<IRequest, PopulateIntermediateTableRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PopulateIntermediateTableRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(PopulateIntermediateTableRequest publicRequest)
        {
            ...
            request.ResourcePath = "/memberships/{membershipIdentifier}/intermediateTables/{intermediateTableIdentifier}/populate";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetAnalysisPayerAccountId())
            {
                context.Writer.WritePropertyName("analysisPayerAccountId");
                context.Writer.WriteStringValue(publicRequest.AnalysisPayerAccountId);
            }
            if (publicRequest.IsSetComputeConfiguration())
            {
                ...
                var marshaller = IntermediateTableComputeConfigurationMarshaller.Instance;
        ...
        private static readonly PopulateIntermediateTableRequestMarshaller _instance = new();

        internal static PopulateIntermediateTableRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PopulateIntermediateTableRequestMarshaller Instance => _instance;
    }
}
