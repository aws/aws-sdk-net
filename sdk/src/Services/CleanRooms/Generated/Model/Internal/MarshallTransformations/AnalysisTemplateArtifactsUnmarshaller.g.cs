...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnalysisTemplateArtifactsUnmarshaller : IJsonUnmarshaller<AnalysisTemplateArtifacts, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AnalysisTemplateArtifacts Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AnalysisTemplateArtifacts();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnalysisTemplateArtifactsUnmarshaller Instance => _instance;
    }
}
