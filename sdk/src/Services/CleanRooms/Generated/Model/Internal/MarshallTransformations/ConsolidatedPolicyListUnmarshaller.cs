...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// Response Unmarshaller for ConsolidatedPolicyList Object
    /// </summary>  
    public class ConsolidatedPolicyListUnmarshaller : IUnmarshaller<ConsolidatedPolicyList, XmlUnmarshallerContext>, IUnmarshaller<ConsolidatedPolicyList, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshaller the response from the service to the response class.
        /// </summary>  
        /// <param name="context"></param>
        /// <returns></returns>
        ConsolidatedPolicyList IUnmarshaller<ConsolidatedPolicyList, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns>The unmarshalled object</returns>
        public ConsolidatedPolicyList Unmarshall(JsonUnmarshallerContext context)
        {
            ConsolidatedPolicyList unmarshalledObject = new ConsolidatedPolicyList();
            if (context.IsEmptyResponse)
                return null;
