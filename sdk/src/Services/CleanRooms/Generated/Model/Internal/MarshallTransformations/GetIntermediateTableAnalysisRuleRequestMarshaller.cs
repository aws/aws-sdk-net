...
{
    /// <summary>
    /// GetIntermediateTableAnalysisRule Request Marshaller
    /// </summary>       
    public class GetIntermediateTableAnalysisRuleRequestMarshaller : IMarshaller<IRequest, GetIntermediateTableAnalysisRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIntermediateTableAnalysisRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIntermediateTableAnalysisRuleRequest publicRequest)
        {
        ...
        private static GetIntermediateTableAnalysisRuleRequestMarshaller _instance = new GetIntermediateTableAnalysisRuleRequestMarshaller();        

        internal static GetIntermediateTableAnalysisRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIntermediateTableAnalysisRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
