...
{
    /// <summary>
    /// Response Unmarshaller for PrivacyBudgetTemplateSummary Object
    /// </summary>
    public partial class PrivacyBudgetTemplateSummaryUnmarshaller : IJsonUnmarshaller<PrivacyBudgetTemplateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PrivacyBudgetTemplateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PrivacyBudgetTemplateSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("privacyBudgetType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static PrivacyBudgetTemplateSummaryUnmarshaller _instance = new PrivacyBudgetTemplateSummaryUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PrivacyBudgetTemplateSummaryUnmarshaller Instance => _instance;
    }
}
