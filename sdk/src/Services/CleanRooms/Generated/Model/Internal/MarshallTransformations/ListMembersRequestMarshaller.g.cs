...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMembersRequestMarshaller : IMarshaller<IRequest, ListMembersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListMembersRequestMarshaller _instance = new();

        internal static ListMembersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMembersRequestMarshaller Instance => _instance;
    }
}
