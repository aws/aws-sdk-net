...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetIntermediateTableRequestMarshaller : IMarshaller<IRequest, GetIntermediateTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetIntermediateTableRequestMarshaller _instance = new GetIntermediateTableRequestMarshaller();        

        internal static GetIntermediateTableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIntermediateTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
