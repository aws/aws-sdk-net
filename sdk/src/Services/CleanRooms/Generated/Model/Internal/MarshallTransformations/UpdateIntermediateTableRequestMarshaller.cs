...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateIntermediateTableRequestMarshaller : IMarshaller<IRequest, UpdateIntermediateTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateIntermediateTableRequestMarshaller _instance = new UpdateIntermediateTableRequestMarshaller();        

        internal static UpdateIntermediateTableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIntermediateTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
