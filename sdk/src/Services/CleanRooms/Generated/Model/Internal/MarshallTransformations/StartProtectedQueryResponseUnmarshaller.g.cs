...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartProtectedQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StartProtectedQueryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("protectedQuery", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ProtectedQuery = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static StartProtectedQueryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartProtectedQueryResponseUnmarshaller Instance => _instance;
    }
}
