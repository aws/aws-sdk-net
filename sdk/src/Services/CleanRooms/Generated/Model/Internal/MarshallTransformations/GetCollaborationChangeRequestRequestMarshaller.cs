...
{
    /// <summary>
    /// GetCollaborationChangeRequest Request Marshaller
    /// </summary>       
    public class GetCollaborationChangeRequestRequestMarshaller : IMarshaller<IRequest, GetCollaborationChangeRequestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCollaborationChangeRequestRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCollaborationChangeRequestRequest publicRequest)
        {
        ...
        private static GetCollaborationChangeRequestRequestMarshaller _instance = new GetCollaborationChangeRequestRequestMarshaller();        

        internal static GetCollaborationChangeRequestRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCollaborationChangeRequestRequestMarshaller Instance
        {
            get
            {
                return _instance;
