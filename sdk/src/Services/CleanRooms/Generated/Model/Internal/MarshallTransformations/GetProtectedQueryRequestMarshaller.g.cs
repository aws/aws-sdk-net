...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetProtectedQueryRequestMarshaller : IMarshaller<IRequest, GetProtectedQueryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetProtectedQueryRequestMarshaller _instance = new();

        internal static GetProtectedQueryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetProtectedQueryRequestMarshaller Instance => _instance;
    }
}
