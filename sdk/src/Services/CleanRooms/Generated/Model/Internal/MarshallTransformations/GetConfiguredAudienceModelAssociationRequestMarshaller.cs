...
{
    /// <summary>
    /// GetConfiguredAudienceModelAssociation Request Marshaller
    /// </summary>       
    public class GetConfiguredAudienceModelAssociationRequestMarshaller : IMarshaller<IRequest, GetConfiguredAudienceModelAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetConfiguredAudienceModelAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetConfiguredAudienceModelAssociationRequest publicRequest)
        {
        ...
        private static GetConfiguredAudienceModelAssociationRequestMarshaller _instance = new GetConfiguredAudienceModelAssociationRequestMarshaller();        

        internal static GetConfiguredAudienceModelAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfiguredAudienceModelAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
