...
{
    /// <summary>
    /// DeleteIntermediateTable Request Marshaller
    /// </summary>
    public partial class DeleteIntermediateTableRequestMarshaller : IMarshaller<IRequest, DeleteIntermediateTableRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteIntermediateTableRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteIntermediateTableRequest publicRequest)
        {
        ...
        private static readonly DeleteIntermediateTableRequestMarshaller _instance = new();

        internal static DeleteIntermediateTableRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteIntermediateTableRequestMarshaller Instance => _instance;
    }
}
