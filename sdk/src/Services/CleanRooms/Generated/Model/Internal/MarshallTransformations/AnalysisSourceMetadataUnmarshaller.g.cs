...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnalysisSourceMetadataUnmarshaller : IJsonUnmarshaller<AnalysisSourceMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AnalysisSourceMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AnalysisSourceMetadata();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnalysisSourceMetadataUnmarshaller Instance => _instance;
    }
}
