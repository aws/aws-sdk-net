...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DifferentialPrivacySensitivityParametersUnmarshaller : IJsonUnmarshaller<DifferentialPrivacySensitivityParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DifferentialPrivacySensitivityParameters();
            ...
            {
                if (context.TestExpression("aggregationExpression", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("maxColumnValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("minColumnValue", targetDepth, ref reader))
                {
                    var unmarshaller = NullableFloatUnmarshaller.Instance;
                ...
                if (context.TestExpression("userContributionLimit", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DifferentialPrivacySensitivityParametersUnmarshaller Instance => _instance;
    }
}
