...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AccessBudgetUnmarshaller : IJsonUnmarshaller<AccessBudget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AccessBudget();
            ...
            {
                if (context.TestExpression("aggregateRemainingBudget", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AccessBudgetUnmarshaller Instance => _instance;
    }
}
