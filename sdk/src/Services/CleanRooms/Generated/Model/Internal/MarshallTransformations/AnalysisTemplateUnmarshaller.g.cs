...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnalysisTemplateUnmarshaller : IJsonUnmarshaller<AnalysisTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AnalysisTemplate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AnalysisTemplate();
            ...
            {
                if (context.TestExpression("analysisParameters", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("errorMessageConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("syntheticDataParameters", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnalysisTemplateUnmarshaller Instance => _instance;
    }
}
