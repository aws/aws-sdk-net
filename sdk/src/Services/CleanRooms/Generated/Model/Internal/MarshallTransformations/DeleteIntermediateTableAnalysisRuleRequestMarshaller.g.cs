...
{
    /// <summary>
    /// DeleteIntermediateTableAnalysisRule Request Marshaller
    /// </summary>
    public partial class DeleteIntermediateTableAnalysisRuleRequestMarshaller : IMarshaller<IRequest, DeleteIntermediateTableAnalysisRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteIntermediateTableAnalysisRuleRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteIntermediateTableAnalysisRuleRequest publicRequest)
        {
        ...
        private static readonly DeleteIntermediateTableAnalysisRuleRequestMarshaller _instance = new();

        internal static DeleteIntermediateTableAnalysisRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteIntermediateTableAnalysisRuleRequestMarshaller Instance => _instance;
    }
}
