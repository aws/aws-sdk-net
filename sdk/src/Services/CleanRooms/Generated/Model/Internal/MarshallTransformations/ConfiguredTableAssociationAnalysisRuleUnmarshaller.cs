...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConfiguredTableAssociationAnalysisRuleUnmarshaller : IUnmarshaller<ConfiguredTableAssociationAnalysisRule, XmlUnmarshallerContext>, IUnmarshaller<ConfiguredTableAssociationAnalysisRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ConfiguredTableAssociationAnalysisRule IUnmarshaller<ConfiguredTableAssociationAnalysisRule, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ConfiguredTableAssociationAnalysisRule Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("configuredTableAssociationArn", targetDepth))
                {
                    ...
                    unmarshalledObject.ConfiguredTableAssociationArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("configuredTableAssociationId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConfiguredTableAssociationId = unmarshaller.Unmarshall(context);
                    continue;
                }
