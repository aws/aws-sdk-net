...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProtectedQueryResultConfigurationUnmarshaller : IJsonUnmarshaller<ProtectedQueryResultConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ProtectedQueryResultConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ProtectedQueryResultConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProtectedQueryResultConfigurationUnmarshaller Instance => _instance;
    }
}
