...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnowflakeTableSchemaV1Unmarshaller : IJsonUnmarshaller<SnowflakeTableSchemaV1, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnowflakeTableSchemaV1 Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("columnType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ColumnType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
