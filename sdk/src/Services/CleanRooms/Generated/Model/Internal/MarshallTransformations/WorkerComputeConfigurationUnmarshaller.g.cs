...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WorkerComputeConfigurationUnmarshaller : IJsonUnmarshaller<WorkerComputeConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public WorkerComputeConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new WorkerComputeConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static WorkerComputeConfigurationUnmarshaller Instance => _instance;
    }
}
