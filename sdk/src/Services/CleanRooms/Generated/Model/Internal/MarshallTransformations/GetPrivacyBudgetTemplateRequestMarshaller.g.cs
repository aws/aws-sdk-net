...
{
    /// <summary>
    /// GetPrivacyBudgetTemplate Request Marshaller
    /// </summary>
    public partial class GetPrivacyBudgetTemplateRequestMarshaller : IMarshaller<IRequest, GetPrivacyBudgetTemplateRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPrivacyBudgetTemplateRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetPrivacyBudgetTemplateRequest publicRequest)
        {
        ...
        private static readonly GetPrivacyBudgetTemplateRequestMarshaller _instance = new();

        internal static GetPrivacyBudgetTemplateRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPrivacyBudgetTemplateRequestMarshaller Instance => _instance;
    }
}
