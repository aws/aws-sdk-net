...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateIntermediateTableAnalysisRuleRequestMarshaller : IMarshaller<IRequest, UpdateIntermediateTableAnalysisRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateIntermediateTableAnalysisRuleRequestMarshaller _instance = new UpdateIntermediateTableAnalysisRuleRequestMarshaller();        

        internal static UpdateIntermediateTableAnalysisRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIntermediateTableAnalysisRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
