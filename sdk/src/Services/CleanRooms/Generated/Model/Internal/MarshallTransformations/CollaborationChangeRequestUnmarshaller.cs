...
{
    /// <summary>
    /// Response Unmarshaller for CollaborationChangeRequest Object
    /// </summary>  
    public class CollaborationChangeRequestUnmarshaller : IUnmarshaller<CollaborationChangeRequest, XmlUnmarshallerContext>, IUnmarshaller<CollaborationChangeRequest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CollaborationChangeRequest IUnmarshaller<CollaborationChangeRequest, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CollaborationChangeRequest Unmarshall(JsonUnmarshallerContext context)
        {
            CollaborationChangeRequest unmarshalledObject = new CollaborationChangeRequest();
        ...
        private static CollaborationChangeRequestUnmarshaller _instance = new CollaborationChangeRequestUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CollaborationChangeRequestUnmarshaller Instance
        {
            get
            {
                return _instance;
