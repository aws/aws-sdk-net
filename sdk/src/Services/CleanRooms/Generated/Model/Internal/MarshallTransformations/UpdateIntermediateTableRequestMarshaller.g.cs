...
{
    /// <summary>
    /// UpdateIntermediateTable Request Marshaller
    /// </summary>
    public partial class UpdateIntermediateTableRequestMarshaller : IMarshaller<IRequest, UpdateIntermediateTableRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateIntermediateTableRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateIntermediateTableRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetColumns())
            {
                context.Writer.WritePropertyName("columns");
                context.Writer.WriteStartArray();
                foreach (var publicRequestColumnsListValue in publicRequest.Columns)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = IntermediateTableColumnMarshaller.Instance;
                    marshaller.Marshall(publicRequestColumnsListValue, context);
        ...
        private static readonly UpdateIntermediateTableRequestMarshaller _instance = new();

        internal static UpdateIntermediateTableRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIntermediateTableRequestMarshaller Instance => _instance;
    }
}
