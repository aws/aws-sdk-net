...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteIntermediateTableRequestMarshaller : IMarshaller<IRequest, DeleteIntermediateTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteIntermediateTableRequestMarshaller _instance = new DeleteIntermediateTableRequestMarshaller();        

        internal static DeleteIntermediateTableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIntermediateTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
