...
{
    /// <summary>
    /// Response Unmarshaller for ChildResource Object
    /// </summary>  
    public class ChildResourceUnmarshaller : IJsonUnmarshaller<ChildResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChildResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ChildResource unmarshalledObject = new ChildResource();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ChildResourceUnmarshaller _instance = new ChildResourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChildResourceUnmarshaller Instance
        {
            get
            {
                return _instance;
