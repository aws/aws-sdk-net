...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProtectedQueryS3OutputConfigurationUnmarshaller : IJsonUnmarshaller<ProtectedQueryS3OutputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProtectedQueryS3OutputConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("singleFileOutput", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProtectedQueryS3OutputConfigurationUnmarshaller Instance => _instance;
    }
}
