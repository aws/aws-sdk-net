...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PopulateIntermediateTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PopulateIntermediateTableResponse response = new PopulateIntermediateTableResponse();
        ...
        internal static PopulateIntermediateTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PopulateIntermediateTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
