...
{
    /// <summary>
    /// Response Unmarshaller for ProtectedJobOutput Object
    /// </summary>
    public partial class ProtectedJobOutputUnmarshaller : IJsonUnmarshaller<ProtectedJobOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ProtectedJobOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ProtectedJobOutput();
        ...
        private static ProtectedJobOutputUnmarshaller _instance = new ProtectedJobOutputUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ProtectedJobOutputUnmarshaller Instance => _instance;
    }
}
