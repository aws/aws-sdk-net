...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PopulateIntermediateTableRequestMarshaller : IMarshaller<IRequest, PopulateIntermediateTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static PopulateIntermediateTableRequestMarshaller _instance = new PopulateIntermediateTableRequestMarshaller();        

        internal static PopulateIntermediateTableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PopulateIntermediateTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
