...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProtectedQuerySummaryUnmarshaller : IJsonUnmarshaller<ProtectedQuerySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ProtectedQuerySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ProtectedQuerySummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("receiverConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReceiverConfiguration, ReceiverConfigurationUnmarshaller>(ReceiverConfigurationUnmarshaller.Instance);
                    unmarshalledObject.ReceiverConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProtectedQuerySummaryUnmarshaller Instance => _instance;
    }
}
