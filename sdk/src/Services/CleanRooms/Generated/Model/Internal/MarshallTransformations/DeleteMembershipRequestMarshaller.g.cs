...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteMembershipRequestMarshaller : IMarshaller<IRequest, DeleteMembershipRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteMembershipRequestMarshaller _instance = new();

        internal static DeleteMembershipRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteMembershipRequestMarshaller Instance => _instance;
    }
}
