...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateConfiguredTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateConfiguredTableResponse();
            ...
            {
                if (context.TestExpression("configuredTable", targetDepth, ref reader))
                {
                    var unmarshaller = ConfiguredTableUnmarshaller.Instance;
                    unmarshalledObject.ConfiguredTable = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateConfiguredTableResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateConfiguredTableResponseUnmarshaller Instance => _instance;
    }
}
