...
{
    /// <summary>
    /// Response Unmarshaller for PrivacyBudgetTemplate Object
    /// </summary>  
    public class PrivacyBudgetTemplateUnmarshaller : IUnmarshaller<PrivacyBudgetTemplate, XmlUnmarshallerContext>, IUnmarshaller<PrivacyBudgetTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PrivacyBudgetTemplate IUnmarshaller<PrivacyBudgetTemplate, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PrivacyBudgetTemplate Unmarshall(JsonUnmarshallerContext context)
        {
            PrivacyBudgetTemplate unmarshalledObject = new PrivacyBudgetTemplate();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrivacyBudgetType = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static PrivacyBudgetTemplateUnmarshaller _instance = new PrivacyBudgetTemplateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PrivacyBudgetTemplateUnmarshaller Instance
        {
            get
            {
                return _instance;
