...
{
    /// <summary>
    /// Response Unmarshaller for AnalysisLogExport Object
    /// </summary>
    public partial class AnalysisLogExportUnmarshaller : IJsonUnmarshaller<AnalysisLogExport, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AnalysisLogExport Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AnalysisLogExport();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("analysisLogExportId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AnalysisLogExportId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = AnalysisLogExportErrorUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = AnalysisLogExportResultConfigurationUnmarshaller.Instance;
        ...
        private static AnalysisLogExportUnmarshaller _instance = new AnalysisLogExportUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AnalysisLogExportUnmarshaller Instance => _instance;
    }
}
