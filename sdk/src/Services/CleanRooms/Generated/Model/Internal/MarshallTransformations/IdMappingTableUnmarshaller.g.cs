...
{
    /// <summary>
    /// Response Unmarshaller for IdMappingTable Object
    /// </summary>
    public partial class IdMappingTableUnmarshaller : IJsonUnmarshaller<IdMappingTable, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public IdMappingTable Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new IdMappingTable();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = IdMappingTableInputReferenceConfigUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = IdMappingTableInputReferencePropertiesUnmarshaller.Instance;
        ...
        private static IdMappingTableUnmarshaller _instance = new IdMappingTableUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static IdMappingTableUnmarshaller Instance => _instance;
    }
}
