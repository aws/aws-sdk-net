...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnalysisRuleUnmarshaller : IJsonUnmarshaller<AnalysisRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnalysisRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("collaborationPolicy", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("consolidatedPolicy", targetDepth, ref reader))
                {
