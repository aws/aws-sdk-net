...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProtectedQueryOutputConfigurationUnmarshaller : IJsonUnmarshaller<ProtectedQueryOutputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProtectedQueryOutputConfiguration();
            ...
            {
                if (context.TestExpression("distribute", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProtectedQueryOutputConfigurationUnmarshaller Instance => _instance;
    }
}
