...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class ProtectedJobSummary
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<ProtectedJobReceiverConfiguration> ReceiverConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<ProtectedJobReceiverConfiguration>() : null;
