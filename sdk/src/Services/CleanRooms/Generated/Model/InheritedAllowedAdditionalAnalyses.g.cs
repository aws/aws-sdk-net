...
{
    /// <summary>
    /// Contains the inherited allowed additional analyses constraint and its sources from
    /// parent tables.
    /// </summary>
    public partial class InheritedAllowedAdditionalAnalyses
    {
        /// <summary>
        ...
        public List<InheritedAllowedAdditionalAnalysesSource> Sources { get; set; } = AWSConfigs.InitializeCollections ? new List<InheritedAllowedAdditionalAnalysesSource>() : null;
