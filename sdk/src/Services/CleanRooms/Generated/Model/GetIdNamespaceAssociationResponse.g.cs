...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class GetIdNamespaceAssociationResponse : AmazonWebServiceResponse
    {
        ...
        public IdNamespaceAssociation IdNamespaceAssociation { get; set; }

        /// <summary>
        /// Checks to see if the IdNamespaceAssociation property is set.
        /// </summary>
        internal bool IsSetIdNamespaceAssociation() => this.IdNamespaceAssociation != null;
    }
}
