...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class ComparisonControls
    {
        ...
        public List<string> AllowedColumnComparisonColumns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AllowedColumnComparisonColumns property is set.
        /// </summary>
        internal bool IsSetAllowedColumnComparisonColumns() => this.AllowedColumnComparisonColumns != null && (this.AllowedColumnComparisonColumns.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<string> AllowedLiteralComparisonColumns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AllowedLiteralComparisonColumns property is set.
        /// </summary>
        internal bool IsSetAllowedLiteralComparisonColumns() => this.AllowedLiteralComparisonColumns != null && (this.AllowedLiteralComparisonColumns.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
