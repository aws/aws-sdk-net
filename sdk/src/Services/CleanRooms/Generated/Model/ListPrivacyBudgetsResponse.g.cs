...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class ListPrivacyBudgetsResponse : AmazonWebServiceResponse
    {
        ...
        public List<PrivacyBudgetSummary> PrivacyBudgetSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<PrivacyBudgetSummary>() : null;

        /// <summary>
        /// Checks to see if the PrivacyBudgetSummaries property is set.
        /// </summary>
        internal bool IsSetPrivacyBudgetSummaries() => this.PrivacyBudgetSummaries != null && (this.PrivacyBudgetSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
