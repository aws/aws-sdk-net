...
{
    /// <summary>
    /// Container for the parameters to the UpdateIntermediateTableAnalysisRule operation.
    /// Updates the analysis rule policy for an intermediate table. Only the intermediate
    /// table owner can call this operation.
    /// </summary>
    public partial class UpdateIntermediateTableAnalysisRuleRequest : AmazonCleanRoomsRequest
    {
        ...
        /// <para>
        /// The type of analysis rule to update. Currently, only <c>CUSTOM</c> is supported.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
