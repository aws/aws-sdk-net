...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class StartAnalysisLogExportResponse : AmazonWebServiceResponse
    {
        ...
        public AnalysisLogExport AnalysisLogExport { get; set; }

        /// <summary>
        /// Checks to see if the AnalysisLogExport property is set.
        /// </summary>
        internal bool IsSetAnalysisLogExport() => this.AnalysisLogExport != null;
    }
}
