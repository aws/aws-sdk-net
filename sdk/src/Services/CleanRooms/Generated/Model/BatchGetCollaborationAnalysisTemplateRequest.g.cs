...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class BatchGetCollaborationAnalysisTemplateRequest : AmazonCleanRoomsRequest
    {
        ...
        public List<string> AnalysisTemplateArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AnalysisTemplateArns property is set.
        /// </summary>
        internal bool IsSetAnalysisTemplateArns() => this.AnalysisTemplateArns != null && (this.AnalysisTemplateArns.Count > 0 || !AWSConfigs.InitializeCollections);
