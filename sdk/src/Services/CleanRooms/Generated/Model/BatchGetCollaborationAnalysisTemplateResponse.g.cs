...
namespace Amazon.CleanRooms.Model
{
    ...
    public partial class BatchGetCollaborationAnalysisTemplateResponse : AmazonWebServiceResponse
    {
        ...
        public List<CollaborationAnalysisTemplate> CollaborationAnalysisTemplates { get; set; } = AWSConfigs.InitializeCollections ? new List<CollaborationAnalysisTemplate>() : null;

        /// <summary>
        /// Checks to see if the CollaborationAnalysisTemplates property is set.
        /// </summary>
        internal bool IsSetCollaborationAnalysisTemplates() => this.CollaborationAnalysisTemplates != null && (this.CollaborationAnalysisTemplates.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Required = true, Max = 10)]
        public List<BatchGetCollaborationAnalysisTemplateError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchGetCollaborationAnalysisTemplateError>() : null;
