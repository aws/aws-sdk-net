...
namespace Amazon.ManagedBlockchainQuery.Model.Internal.MarshallTransformations
{
    ...
    public class TransactionOutputItemUnmarshaller : IJsonUnmarshaller<TransactionOutputItem, JsonUnmarshallerContext>
    {
        ...
        public TransactionOutputItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("confirmationStatus", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("transactionHash", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("transactionTimestamp", targetDepth, ref reader))
                {
        ...
        private static TransactionOutputItemUnmarshaller _instance = new TransactionOutputItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TransactionOutputItemUnmarshaller Instance
        {
            get
            {
                return _instance;
