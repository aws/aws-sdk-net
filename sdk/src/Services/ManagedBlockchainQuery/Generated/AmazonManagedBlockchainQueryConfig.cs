...
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("ManagedBlockchain Query", "3.7.400.104");
=======
            InternalSDKUtils.BuildUserAgentString("ManagedBlockchain Query", "3.7.400.130");
>>>>>>> b6da6ace600c307cc9bd6dbf99b06a9d2b81da7e
        ...
        /// Default constructor
        /// </summary>
        public AmazonManagedBlockchainQueryConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonManagedBlockchainQueryDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "ManagedBlockchain Query";
            this.AuthenticationServiceName = "managedblockchain-query";
            this.EndpointProvider = new AmazonManagedBlockchainQueryEndpointProvider();
        }
