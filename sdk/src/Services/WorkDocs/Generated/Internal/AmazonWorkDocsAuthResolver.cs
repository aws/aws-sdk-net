...
namespace Amazon.WorkDocs.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonWorkDocsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkDocsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkDocs.
        /// </summary>
        public AmazonWorkDocsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkDocsAuthSchemeParameters
            {
    ...
    public class AmazonWorkDocsAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkDocsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkDocsAuthSchemeParameters authParameters)
        {
