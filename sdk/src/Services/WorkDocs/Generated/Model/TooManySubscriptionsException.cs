...
namespace Amazon.WorkDocs.Model
{
    ...
    public partial class TooManySubscriptionsException : AmazonWorkDocsException
    {
        ...
        public TooManySubscriptionsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManySubscriptionsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
