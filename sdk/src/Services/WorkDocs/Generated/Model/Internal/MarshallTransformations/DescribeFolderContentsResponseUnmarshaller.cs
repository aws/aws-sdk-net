...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFolderContents operation
    /// </summary>  
    public class DescribeFolderContentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFolderContentsResponse response = new DescribeFolderContentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DocumentMetadata, DocumentMetadataUnmarshaller>(DocumentMetadataUnmarshaller.Instance);
                    response.Documents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Folders", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<FolderMetadata, FolderMetadataUnmarshaller>(FolderMetadataUnmarshaller.Instance);
                    response.Folders = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeFolderContentsResponseUnmarshaller _instance = new DescribeFolderContentsResponseUnmarshaller();        

        internal static DescribeFolderContentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFolderContentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
