...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLabels operation
    /// </summary>  
    public class DeleteLabelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ProhibitedStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeleteLabelsResponseUnmarshaller _instance = new DeleteLabelsResponseUnmarshaller();        

        internal static DeleteLabelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLabelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
