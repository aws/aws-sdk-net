...
{
    /// <summary>
    /// DescribeNotificationSubscriptions Request Marshaller
    /// </summary>       
    public class DescribeNotificationSubscriptionsRequestMarshaller : IMarshaller<IRequest, DescribeNotificationSubscriptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeNotificationSubscriptionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeNotificationSubscriptionsRequest publicRequest)
        {
