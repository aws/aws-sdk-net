...
{
    /// <summary>
    /// DeleteDocumentVersion Request Marshaller
    /// </summary>       
    public class DeleteDocumentVersionRequestMarshaller : IMarshaller<IRequest, DeleteDocumentVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteDocumentVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteDocumentVersionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/api/v1/documentVersions/{DocumentId}/versions/{VersionId}";
        ...
        private static DeleteDocumentVersionRequestMarshaller _instance = new DeleteDocumentVersionRequestMarshaller();        

        internal static DeleteDocumentVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDocumentVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
