...
{
    /// <summary>
    /// Response Unmarshaller for GetFolderPath operation
    /// </summary>  
    public class GetFolderPathResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ResourcePathUnmarshaller.Instance;
        ...
        private static GetFolderPathResponseUnmarshaller _instance = new GetFolderPathResponseUnmarshaller();        

        internal static GetFolderPathResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFolderPathResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
