...
{
    /// <summary>
    /// Response Unmarshaller for DeactivateUser operation
    /// </summary>  
    public class DeactivateUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeactivateUserResponseUnmarshaller _instance = new DeactivateUserResponseUnmarshaller();        

        internal static DeactivateUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
