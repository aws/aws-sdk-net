...
{
    /// <summary>
    /// Response Unmarshaller for AddResourcePermissions operation
    /// </summary>  
    public class AddResourcePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddResourcePermissionsResponse response = new AddResourcePermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ShareResult, ShareResultUnmarshaller>(ShareResultUnmarshaller.Instance);
                    response.ShareResults = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static AddResourcePermissionsResponseUnmarshaller _instance = new AddResourcePermissionsResponseUnmarshaller();        

        internal static AddResourcePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddResourcePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
