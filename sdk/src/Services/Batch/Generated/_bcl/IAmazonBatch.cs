...
namespace Amazon.Batch
{
    ...
    public partial interface IAmazonBatch : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/CreateQuotaShare">REST API Reference for CreateQuotaShare Operation</seealso>
        Task<CreateQuotaShareResponse> CreateQuotaShareAsync(CreateQuotaShareRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DeleteQuotaShare">REST API Reference for DeleteQuotaShare Operation</seealso>
        Task<DeleteQuotaShareResponse> DeleteQuotaShareAsync(DeleteQuotaShareRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DescribeQuotaShare">REST API Reference for DescribeQuotaShare Operation</seealso>
        Task<DescribeQuotaShareResponse> DescribeQuotaShareAsync(DescribeQuotaShareRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/ListQuotaShares">REST API Reference for ListQuotaShares Operation</seealso>
        Task<ListQuotaSharesResponse> ListQuotaSharesAsync(ListQuotaSharesRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/UpdateQuotaShare">REST API Reference for UpdateQuotaShare Operation</seealso>
        Task<UpdateQuotaShareResponse> UpdateQuotaShareAsync(UpdateQuotaShareRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/UpdateServiceJob">REST API Reference for UpdateServiceJob Operation</seealso>
        Task<UpdateServiceJobResponse> UpdateServiceJobAsync(UpdateServiceJobRequest request, CancellationToken cancellationToken = default(CancellationToken));
