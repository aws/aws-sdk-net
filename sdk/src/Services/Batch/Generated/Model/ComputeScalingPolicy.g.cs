...
namespace Amazon.Batch.Model
{
    ...
    public partial class ComputeScalingPolicy
    {
        ...
        ///  </li> </ul> </note>
        /// </summary>
        public int? MinScaleDownDelayMinutes { get; set; }

        /// <summary>
        /// Checks to see if the MinScaleDownDelayMinutes property is set.
        /// </summary>
        internal bool IsSetMinScaleDownDelayMinutes() => this.MinScaleDownDelayMinutes.HasValue;
    }
}
