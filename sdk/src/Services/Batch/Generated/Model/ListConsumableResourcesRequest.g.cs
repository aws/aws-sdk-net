...
{
    /// <summary>
    /// Container for the parameters to the ListConsumableResources operation. Returns a list
    /// of Batch consumable resources.
    /// </summary>
    public partial class ListConsumableResourcesRequest : AmazonBatchRequest
    {
        /// <summary>
        /// Gets and sets the property Filters. 
        /// <para>
        /// The filters to apply to the consumable resource list query. If used, only those consumable
        /// resources that match the filter are listed. Filter names and values can be:
        /// </para>
        ///  <ul> <li> 
        /// <para>
        /// name: <c>CONSUMABLE_RESOURCE_NAME </c> 
        /// </para>
        ///  
        /// <para>
        /// values: case-insensitive matches for the consumable resource name. If a filter value
        ...
        /// <para>
        /// The maximum number of results returned by <c>ListConsumableResources</c> in paginated
        ...
        /// <para>
        /// The <c>nextToken</c> value returned from a previous paginated <c>ListConsumableResources</c>
