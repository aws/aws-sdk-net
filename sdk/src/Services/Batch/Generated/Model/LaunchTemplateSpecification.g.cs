...
namespace Amazon.Batch.Model
{
    ...
    public partial class LaunchTemplateSpecification
    {
        ...
        /// </summary>
        public List<LaunchTemplateSpecificationOverride> Overrides { get; set; } = AWSConfigs.InitializeCollections ? new List<LaunchTemplateSpecificationOverride>() : null;
        ...
        /// </para>
        /// </summary>
        public UserdataType UserdataType { get; set; }

        /// <summary>
        /// Checks to see if the UserdataType property is set.
        /// </summary>
        internal bool IsSetUserdataType() => this.UserdataType != null;
