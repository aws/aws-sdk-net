...
namespace Amazon.Batch.Model
{
    ...
    public partial class QuotaShareResourceSharingConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the BorrowLimit property is set.
        /// </summary>
        internal bool IsSetBorrowLimit() => this.BorrowLimit.HasValue;
        ...
        public QuotaShareResourceSharingStrategy Strategy { get; set; }
