...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<JobDetail, JobDetailUnmarshaller>(JobDetailUnmarshaller.Instance);
        ...
        private static DescribeJobsResponseUnmarshaller _instance = new DescribeJobsResponseUnmarshaller();

        internal static DescribeJobsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeJobsResponseUnmarshaller Instance => _instance;
    }
}
