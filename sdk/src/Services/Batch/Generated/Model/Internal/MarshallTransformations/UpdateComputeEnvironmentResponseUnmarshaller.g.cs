...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateComputeEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateComputeEnvironmentResponse();
            ...
            {
                if (context.TestExpression("computeEnvironmentArn", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("computeEnvironmentName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        internal static UpdateComputeEnvironmentResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateComputeEnvironmentResponseUnmarshaller Instance => _instance;
    }
}
