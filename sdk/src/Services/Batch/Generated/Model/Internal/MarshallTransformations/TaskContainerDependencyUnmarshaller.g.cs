...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TaskContainerDependencyUnmarshaller : IJsonUnmarshaller<TaskContainerDependency, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TaskContainerDependency Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TaskContainerDependency();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TaskContainerDependencyUnmarshaller Instance => _instance;
    }
}
