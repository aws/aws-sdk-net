...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateQuotaShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateQuotaShareResponse response = new CreateQuotaShareResponse();
        ...
        internal static CreateQuotaShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQuotaShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
