...
{
    /// <summary>
    /// Response Unmarshaller for TerminateServiceJobs operation.
    /// </summary>
    public partial class TerminateServiceJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TerminateServiceJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TerminateServiceJobsErrorDetail, TerminateServiceJobsErrorDetailUnmarshaller>(TerminateServiceJobsErrorDetailUnmarshaller.Instance);
        ...
        private static TerminateServiceJobsResponseUnmarshaller _instance = new TerminateServiceJobsResponseUnmarshaller();

        internal static TerminateServiceJobsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TerminateServiceJobsResponseUnmarshaller Instance => _instance;
    }
}
