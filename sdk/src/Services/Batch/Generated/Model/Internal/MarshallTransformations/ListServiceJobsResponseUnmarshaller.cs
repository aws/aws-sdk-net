    ...
    public class ListServiceJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ServiceJobSummary, ServiceJobSummaryUnmarshaller>(ServiceJobSummaryUnmarshaller.Instance);
                    response.JobSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
