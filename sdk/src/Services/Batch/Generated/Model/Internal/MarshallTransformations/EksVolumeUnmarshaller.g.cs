...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EksVolumeUnmarshaller : IJsonUnmarshaller<EksVolume, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EksVolume();
            ...
            {
                if (context.TestExpression("emptyDir", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("hostPath", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("persistentVolumeClaim", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static EksVolumeUnmarshaller Instance => _instance;
    }
}
