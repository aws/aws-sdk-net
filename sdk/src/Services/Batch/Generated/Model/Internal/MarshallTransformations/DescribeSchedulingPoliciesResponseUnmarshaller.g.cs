...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeSchedulingPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeSchedulingPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("schedulingPolicies", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SchedulingPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeSchedulingPoliciesResponseUnmarshaller _instance = new DescribeSchedulingPoliciesResponseUnmarshaller();

        internal static DescribeSchedulingPoliciesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeSchedulingPoliciesResponseUnmarshaller Instance => _instance;
    }
}
