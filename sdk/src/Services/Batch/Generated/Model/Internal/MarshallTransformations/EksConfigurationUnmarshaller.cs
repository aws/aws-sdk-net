...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EksConfigurationUnmarshaller : IJsonUnmarshaller<EksConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EksConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("kubernetesNamespace", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
