...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RetryStrategyUnmarshaller : IJsonUnmarshaller<RetryStrategy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RetryStrategy();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("evaluateOnExit", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RetryStrategyUnmarshaller Instance => _instance;
    }
}
