...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ArrayPropertiesSummaryUnmarshaller : IJsonUnmarshaller<ArrayPropertiesSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ArrayPropertiesSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ArrayPropertiesSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ArrayPropertiesSummaryUnmarshaller Instance => _instance;
    }
}
