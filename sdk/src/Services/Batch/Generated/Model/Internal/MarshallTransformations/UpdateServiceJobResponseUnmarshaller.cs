...
{
    /// <summary>
    /// Response Unmarshaller for UpdateServiceJob operation
    /// </summary>  
    public class UpdateServiceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateServiceJobResponse response = new UpdateServiceJobResponse();
        ...
        private static UpdateServiceJobResponseUnmarshaller _instance = new UpdateServiceJobResponseUnmarshaller();        

        internal static UpdateServiceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
