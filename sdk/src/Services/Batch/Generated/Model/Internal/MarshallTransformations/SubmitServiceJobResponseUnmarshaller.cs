...
{
    /// <summary>
    /// Response Unmarshaller for SubmitServiceJob operation
    /// </summary>  
    public class SubmitServiceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubmitServiceJobResponse response = new SubmitServiceJobResponse();
        ...
        private static SubmitServiceJobResponseUnmarshaller _instance = new SubmitServiceJobResponseUnmarshaller();        

        internal static SubmitServiceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitServiceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
