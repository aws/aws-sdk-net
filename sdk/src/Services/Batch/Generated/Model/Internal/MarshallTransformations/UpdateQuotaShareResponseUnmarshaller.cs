...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateQuotaShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQuotaShareResponse response = new UpdateQuotaShareResponse();
        ...
        internal static UpdateQuotaShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQuotaShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
