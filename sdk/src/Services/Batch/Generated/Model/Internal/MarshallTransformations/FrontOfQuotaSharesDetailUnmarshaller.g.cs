...
{
    /// <summary>
    /// Response Unmarshaller for FrontOfQuotaSharesDetail Object
    /// </summary>
    public partial class FrontOfQuotaSharesDetailUnmarshaller : IJsonUnmarshaller<FrontOfQuotaSharesDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public FrontOfQuotaSharesDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new FrontOfQuotaSharesDetail();
        ...
        private static FrontOfQuotaSharesDetailUnmarshaller _instance = new FrontOfQuotaSharesDetailUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static FrontOfQuotaSharesDetailUnmarshaller Instance => _instance;
    }
}
