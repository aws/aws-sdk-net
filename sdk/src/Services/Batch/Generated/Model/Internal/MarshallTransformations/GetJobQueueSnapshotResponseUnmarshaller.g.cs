...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetJobQueueSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetJobQueueSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("frontOfQueue", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.FrontOfQueue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("frontOfQuotaShares", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.FrontOfQuotaShares = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("queueUtilization", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.QueueUtilization = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetJobQueueSnapshotResponseUnmarshaller _instance = new GetJobQueueSnapshotResponseUnmarshaller();

        internal static GetJobQueueSnapshotResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetJobQueueSnapshotResponseUnmarshaller Instance => _instance;
    }
}
