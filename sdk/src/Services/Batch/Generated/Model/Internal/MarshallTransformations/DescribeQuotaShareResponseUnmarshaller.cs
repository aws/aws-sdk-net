...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeQuotaShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeQuotaShareResponse response = new DescribeQuotaShareResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<QuotaShareCapacityLimit, QuotaShareCapacityLimitUnmarshaller>(QuotaShareCapacityLimitUnmarshaller.Instance);
                    response.CapacityLimits = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.QuotaShareArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("resourceSharingConfiguration", targetDepth))
                {
                    ...
                    response.ResourceSharingConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static DescribeQuotaShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQuotaShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
