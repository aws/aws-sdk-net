...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeJobDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeJobDefinitionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("jobDefinitions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.JobDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeJobDefinitionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeJobDefinitionsResponseUnmarshaller Instance => _instance;
    }
}
