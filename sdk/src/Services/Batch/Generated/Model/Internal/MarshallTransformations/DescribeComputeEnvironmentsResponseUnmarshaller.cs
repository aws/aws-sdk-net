    ...
    public class DescribeComputeEnvironmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ComputeEnvironmentDetail, ComputeEnvironmentDetailUnmarshaller>(ComputeEnvironmentDetailUnmarshaller.Instance);
                    response.ComputeEnvironments = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static DescribeComputeEnvironmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeComputeEnvironmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
