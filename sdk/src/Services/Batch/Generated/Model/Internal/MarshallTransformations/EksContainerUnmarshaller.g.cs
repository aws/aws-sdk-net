...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EksContainerUnmarshaller : IJsonUnmarshaller<EksContainer, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public EksContainer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new EksContainer();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EksContainerUnmarshaller Instance => _instance;
    }
}
