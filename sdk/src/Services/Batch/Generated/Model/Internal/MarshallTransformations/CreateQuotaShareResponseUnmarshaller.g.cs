...
{
    /// <summary>
    /// Response Unmarshaller for CreateQuotaShare operation.
    /// </summary>
    public partial class CreateQuotaShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateQuotaShareResponse();
        ...
        private static CreateQuotaShareResponseUnmarshaller _instance = new CreateQuotaShareResponseUnmarshaller();

        internal static CreateQuotaShareResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateQuotaShareResponseUnmarshaller Instance => _instance;
    }
}
