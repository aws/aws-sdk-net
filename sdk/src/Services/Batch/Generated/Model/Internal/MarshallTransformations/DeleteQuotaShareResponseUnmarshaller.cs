...
{
    /// <summary>
    /// Response Unmarshaller for DeleteQuotaShare operation
    /// </summary>  
    public class DeleteQuotaShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteQuotaShareResponse response = new DeleteQuotaShareResponse();
        ...
        private static DeleteQuotaShareResponseUnmarshaller _instance = new DeleteQuotaShareResponseUnmarshaller();        

        internal static DeleteQuotaShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteQuotaShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
