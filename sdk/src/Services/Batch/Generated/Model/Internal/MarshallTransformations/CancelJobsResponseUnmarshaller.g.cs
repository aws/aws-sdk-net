...
{
    /// <summary>
    /// Response Unmarshaller for CancelJobs operation.
    /// </summary>
    public partial class CancelJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CancelJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CancelJobsErrorDetail, CancelJobsErrorDetailUnmarshaller>(CancelJobsErrorDetailUnmarshaller.Instance);
        ...
        private static CancelJobsResponseUnmarshaller _instance = new CancelJobsResponseUnmarshaller();

        internal static CancelJobsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelJobsResponseUnmarshaller Instance => _instance;
    }
}
