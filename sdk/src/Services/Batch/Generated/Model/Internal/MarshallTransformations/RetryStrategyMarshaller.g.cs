...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RetryStrategyMarshaller : IRequestMarshaller<RetryStrategy, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(RetryStrategy requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetAttempts())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.Attempts.Value);
            }
