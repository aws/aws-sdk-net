...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class EksSecretMarshaller : IRequestMarshaller<EksSecret, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(EksSecret requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSecretName())
            {
                ...
                context.Writer.WriteStringValue(requestObject.SecretName);
            }
        ...
        /// </summary>
        public readonly static EksSecretMarshaller Instance = new EksSecretMarshaller();
