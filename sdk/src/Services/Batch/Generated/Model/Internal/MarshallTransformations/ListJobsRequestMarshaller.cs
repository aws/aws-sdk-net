    ...
    public class ListJobsRequestMarshaller : IMarshaller<IRequest, ListJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListJobsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetArrayJobId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ArrayJobId);
            }
            ...
            if(publicRequest.IsSetJobStatus())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.JobStatus);
            }
            ...
            if(publicRequest.IsSetMultiNodeJobId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.MultiNodeJobId);
            }
