    ...
    public class DescribeSchedulingPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SchedulingPolicyDetail, SchedulingPolicyDetailUnmarshaller>(SchedulingPolicyDetailUnmarshaller.Instance);
                    response.SchedulingPolicies = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
