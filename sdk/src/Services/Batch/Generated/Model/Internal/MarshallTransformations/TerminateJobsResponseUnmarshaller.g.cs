...
{
    /// <summary>
    /// Response Unmarshaller for TerminateJobs operation.
    /// </summary>
    public partial class TerminateJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TerminateJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TerminateJobsErrorDetail, TerminateJobsErrorDetailUnmarshaller>(TerminateJobsErrorDetailUnmarshaller.Instance);
        ...
        private static TerminateJobsResponseUnmarshaller _instance = new TerminateJobsResponseUnmarshaller();

        internal static TerminateJobsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TerminateJobsResponseUnmarshaller Instance => _instance;
    }
}
