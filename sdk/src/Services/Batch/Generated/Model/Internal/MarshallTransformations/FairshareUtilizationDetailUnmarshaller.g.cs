...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FairshareUtilizationDetailUnmarshaller : IJsonUnmarshaller<FairshareUtilizationDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FairshareUtilizationDetail();
            ...
            {
                if (context.TestExpression("activeShareCount", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static FairshareUtilizationDetailUnmarshaller Instance => _instance;
    }
}
