...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSchedulingPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSchedulingPolicyResponse response = new CreateSchedulingPolicyResponse();
        ...
        private static CreateSchedulingPolicyResponseUnmarshaller _instance = new CreateSchedulingPolicyResponseUnmarshaller();        

        internal static CreateSchedulingPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSchedulingPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
