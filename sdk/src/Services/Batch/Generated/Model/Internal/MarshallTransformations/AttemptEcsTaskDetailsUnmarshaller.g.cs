...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AttemptEcsTaskDetailsUnmarshaller : IJsonUnmarshaller<AttemptEcsTaskDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AttemptEcsTaskDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AttemptEcsTaskDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AttemptEcsTaskDetailsUnmarshaller Instance => _instance;
    }
}
