...
{
    /// <summary>
    /// Response Unmarshaller for DeleteServiceEnvironment operation
    /// </summary>  
    public class DeleteServiceEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteServiceEnvironmentResponse response = new DeleteServiceEnvironmentResponse();
        ...
        private static DeleteServiceEnvironmentResponseUnmarshaller _instance = new DeleteServiceEnvironmentResponseUnmarshaller();        

        internal static DeleteServiceEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServiceEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
