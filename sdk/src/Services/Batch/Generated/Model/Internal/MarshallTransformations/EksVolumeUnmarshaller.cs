...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EksVolumeUnmarshaller : IUnmarshaller<EksVolume, XmlUnmarshallerContext>, IUnmarshaller<EksVolume, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        EksVolume IUnmarshaller<EksVolume, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public EksVolume Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("emptyDir", targetDepth))
                {
                    ...
                    unmarshalledObject.EmptyDir = unmarshaller.Unmarshall(context);
                    continue;
                }
