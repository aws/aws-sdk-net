...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceJobSummaryUnmarshaller : IJsonUnmarshaller<ServiceJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceJobSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceJobCapacityUsageSummary, ServiceJobCapacityUsageSummaryUnmarshaller>(ServiceJobCapacityUsageSummaryUnmarshaller.Instance);
