...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateJobQueueRequestMarshaller : IMarshaller<IRequest, CreateJobQueueRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateJobQueueRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetJobQueueName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.JobQueueName);
            }
            if (publicRequest.IsSetJobQueueType())
            {
                context.Writer.WritePropertyName("jobQueueType");
                context.Writer.WriteStringValue(publicRequest.JobQueueType);
            }
        ...
        private static readonly CreateJobQueueRequestMarshaller _instance = new();

        internal static CreateJobQueueRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateJobQueueRequestMarshaller Instance => _instance;
    }
}
