...
{
    /// <summary>
    /// Response Unmarshaller for CreateServiceEnvironment operation
    /// </summary>  
    public class CreateServiceEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateServiceEnvironmentResponse response = new CreateServiceEnvironmentResponse();
            ...
            {
                if (context.TestExpression("serviceEnvironmentArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ServiceEnvironmentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("serviceEnvironmentName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ServiceEnvironmentName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateServiceEnvironmentResponseUnmarshaller _instance = new CreateServiceEnvironmentResponseUnmarshaller();        

        internal static CreateServiceEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServiceEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
