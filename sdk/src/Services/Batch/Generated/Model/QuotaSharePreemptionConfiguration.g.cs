...
namespace Amazon.Batch.Model
{
    ...
    public partial class QuotaSharePreemptionConfiguration
    {
        ...
        public QuotaShareInSharePreemptionState InSharePreemption { get; set; }

        /// <summary>
        /// Checks to see if the InSharePreemption property is set.
        /// </summary>
        internal bool IsSetInSharePreemption() => this.InSharePreemption != null;
    }
}
