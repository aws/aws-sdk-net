...
namespace Amazon.Batch.Model
{
    ...
    public partial class RetryStrategy
    {
        ...
        /// </summary>
        internal bool IsSetAttempts() => this.Attempts.HasValue;
        ...
        /// </summary>
        public List<EvaluateOnExit> EvaluateOnExit { get; set; } = AWSConfigs.InitializeCollections ? new List<EvaluateOnExit>() : null;

        /// <summary>
        /// Checks to see if the EvaluateOnExit property is set.
        /// </summary>
        internal bool IsSetEvaluateOnExit() => this.EvaluateOnExit != null && (this.EvaluateOnExit.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
