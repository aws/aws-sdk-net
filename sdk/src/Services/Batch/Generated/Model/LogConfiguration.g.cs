...
namespace Amazon.Batch.Model
{
    ...
    public partial class LogConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the LogDriver property is set.
        /// </summary>
        internal bool IsSetLogDriver() => this.LogDriver != null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<Secret> SecretOptions { get; set; } = AWSConfigs.InitializeCollections ? new List<Secret>() : null;

        /// <summary>
        /// Checks to see if the SecretOptions property is set.
        /// </summary>
        internal bool IsSetSecretOptions() => this.SecretOptions != null && (this.SecretOptions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
