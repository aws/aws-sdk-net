...
namespace Amazon.Batch.Model
{
    ...
    public partial class DescribeJobQueuesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<JobQueueDetail> JobQueues { get; set; } = AWSConfigs.InitializeCollections ? new List<JobQueueDetail>() : null;

        /// <summary>
        /// Checks to see if the JobQueues property is set.
        /// </summary>
        internal bool IsSetJobQueues() => this.JobQueues != null && (this.JobQueues.Count > 0 || !AWSConfigs.InitializeCollections);
