...
namespace Amazon.Batch.Model
{
    ...
    public partial class FairsharePolicy
    {
        ...
        /// </para>
        /// </summary>
        public int? ComputeReservation { get; set; }

        /// <summary>
        /// Checks to see if the ComputeReservation property is set.
        /// </summary>
        internal bool IsSetComputeReservation() => this.ComputeReservation.HasValue;
        ...
        /// </para>
        /// </summary>
        public int? ShareDecaySeconds { get; set; }

        /// <summary>
        /// Checks to see if the ShareDecaySeconds property is set.
        /// </summary>
        internal bool IsSetShareDecaySeconds() => this.ShareDecaySeconds.HasValue;
        ...
        /// </summary>
        public List<ShareAttributes> ShareDistribution { get; set; } = AWSConfigs.InitializeCollections ? new List<ShareAttributes>() : null;

        /// <summary>
        /// Checks to see if the ShareDistribution property is set.
        /// </summary>
        internal bool IsSetShareDistribution() => this.ShareDistribution != null && (this.ShareDistribution.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
