...
namespace Amazon.Batch.Model
{
    ...
    public partial class NodeOverrides
    {
        ...
        /// </summary>
        public List<NodePropertyOverride> NodePropertyOverrides { get; set; } = AWSConfigs.InitializeCollections ? new List<NodePropertyOverride>() : null;

        /// <summary>
        /// Checks to see if the NodePropertyOverrides property is set.
        /// </summary>
        internal bool IsSetNodePropertyOverrides() => this.NodePropertyOverrides != null && (this.NodePropertyOverrides.Count > 0 || !AWSConfigs.InitializeCollections);
