...
namespace Amazon.Batch.Model
{
    ...
    public partial class LaunchTemplateSpecificationOverride
    {
        ...
        /// </summary>
        public List<string> TargetInstanceTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the TargetInstanceTypes property is set.
        /// </summary>
        internal bool IsSetTargetInstanceTypes() => this.TargetInstanceTypes != null && (this.TargetInstanceTypes.Count > 0 || !AWSConfigs.InitializeCollections);
