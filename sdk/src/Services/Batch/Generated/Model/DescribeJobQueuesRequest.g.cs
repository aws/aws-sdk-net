...
{
    /// <summary>
    /// Container for the parameters to the DescribeJobQueues operation. Describes one or
    /// more of your job queues.
    /// </summary>
    public partial class DescribeJobQueuesRequest : AmazonBatchRequest
    {
        ...
        /// </summary>
        public List<string> JobQueues { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;
