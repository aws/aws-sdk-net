...
namespace Amazon.Batch.Model
{
    ...
    {
        private ContainerInsights _containerInsights;
        ...
        /// </para>
        /// </summary>
        public ContainerInsights ContainerInsights
        {
            get { return this._containerInsights; }
            set { this._containerInsights = value; }
        }

        // Check to see if ContainerInsights property is set
        internal bool IsSetContainerInsights()
        {
            return this._containerInsights != null;
        }
