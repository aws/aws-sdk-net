...
namespace Amazon.Batch.Model
{
    ...
    public partial class ListSchedulingPoliciesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SchedulingPolicyListingDetail> SchedulingPolicies { get; set; } = AWSConfigs.InitializeCollections ? new List<SchedulingPolicyListingDetail>() : null;

        /// <summary>
        /// Checks to see if the SchedulingPolicies property is set.
        /// </summary>
        internal bool IsSetSchedulingPolicies() => this.SchedulingPolicies != null && (this.SchedulingPolicies.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
