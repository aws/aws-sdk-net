...
namespace Amazon.Batch.Model
{
    ...
    public partial class EksContainerResourceRequirements
    {
        ...
        /// </summary>
        public Dictionary<string, string> Limits { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public Dictionary<string, string> Requests { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the Requests property is set.
        /// </summary>
        internal bool IsSetRequests() => this.Requests != null && (this.Requests.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
