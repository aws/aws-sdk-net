...
{
    /// <summary>
    /// An object that contains the details of a job that couldn't be cancelled by a <c>CancelJobs</c>
    /// operation.
    /// </summary>
    public partial class CancelJobsErrorDetail
    {
        /// <summary>
        /// Gets and sets the property Code. 
        /// <para>
        /// An error code that identifies the reason the job couldn't be cancelled. Valid values
        /// are:
        /// </para>
        ///  <ul> <li> 
        /// <para>
        ///  <c>ValidationException</c> – A job identifier in the request is malformed or isn't
        /// valid.
        /// </para>
        ///  </li> <li> 
        /// <para>
