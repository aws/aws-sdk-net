...
{
    /// <summary>
    /// Container for the parameters to the CreateServiceEnvironment operation. Creates a
    /// service environment for running service jobs. Service environments define capacity
