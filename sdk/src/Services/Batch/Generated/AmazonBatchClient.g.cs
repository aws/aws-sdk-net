...
namespace Amazon.Batch
{
    ...
    public partial class AmazonBatchClient : AmazonServiceClient, IAmazonBatch
    {
        ...
        /// 
        /// </summary>
        public AmazonBatchClient() : base(new AmazonBatchConfig()) { }
        ...
        public AmazonBatchClient(RegionEndpoint region) : base(new AmazonBatchConfig { RegionEndpoint = region }) { }
        ...
        public AmazonBatchClient(AmazonBatchConfig config) : base(config) { }
