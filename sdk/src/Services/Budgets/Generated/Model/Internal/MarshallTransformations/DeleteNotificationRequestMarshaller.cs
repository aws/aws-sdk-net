...
{
    /// <summary>
    /// DeleteNotification Request Marshaller
    /// </summary>       
    public class DeleteNotificationRequestMarshaller : IMarshaller<IRequest, DeleteNotificationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteNotificationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteNotificationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Budgets");
            string target = "AWSBudgetServiceGateway.DeleteNotification";
