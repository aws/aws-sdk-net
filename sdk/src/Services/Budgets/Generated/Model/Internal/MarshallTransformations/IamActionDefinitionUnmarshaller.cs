...
namespace Amazon.Budgets.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IamActionDefinitionUnmarshaller : IJsonUnmarshaller<IamActionDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IamActionDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
