...
{
    /// <summary>
    /// DescribeSubscribersForNotification Request Marshaller
    /// </summary>       
    public class DescribeSubscribersForNotificationRequestMarshaller : IMarshaller<IRequest, DescribeSubscribersForNotificationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSubscribersForNotificationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSubscribersForNotificationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Budgets");
            string target = "AWSBudgetServiceGateway.DescribeSubscribersForNotification";
