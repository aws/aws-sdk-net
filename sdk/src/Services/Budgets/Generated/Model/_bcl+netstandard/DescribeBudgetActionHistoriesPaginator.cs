...
namespace Amazon.Budgets.Model
{
    ...
    internal sealed partial class DescribeBudgetActionHistoriesPaginator : IPaginator<DescribeBudgetActionHistoriesResponse>, IDescribeBudgetActionHistoriesPaginator
    {
...
#if BCL
        IEnumerable<DescribeBudgetActionHistoriesResponse> IPaginator<DescribeBudgetActionHistoriesResponse>.Paginate()
        {
            ...
            DescribeBudgetActionHistoriesResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.DescribeBudgetActionHistories(_request);
        ...
        async IAsyncEnumerable<DescribeBudgetActionHistoriesResponse> IPaginator<DescribeBudgetActionHistoriesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.DescribeBudgetActionHistoriesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
