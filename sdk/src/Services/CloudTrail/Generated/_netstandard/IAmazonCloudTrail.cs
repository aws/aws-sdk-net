...
namespace Amazon.CloudTrail
{
    ...
    public partial interface IAmazonCloudTrail : IAmazonService, IDisposable
    {
        ...
        Task<DisableFederationResponse> DisableFederationAsync(DisableFederationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<EnableFederationResponse> EnableFederationAsync(EnableFederationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetEventConfigurationResponse> GetEventConfigurationAsync(GetEventConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListInsightsDataResponse> ListInsightsDataAsync(ListInsightsDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListInsightsMetricDataResponse> ListInsightsMetricDataAsync(ListInsightsMetricDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutEventConfigurationResponse> PutEventConfigurationAsync(PutEventConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartDashboardRefreshResponse> StartDashboardRefreshAsync(StartDashboardRefreshRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCloudTrailConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCloudTrailConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCloudTrailConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCloudTrailConfig to create AmazonCloudTrailClient");
            }

            return awsCredentials == null ? 
                    new AmazonCloudTrailClient(serviceClientConfig) :
                    new AmazonCloudTrailClient(awsCredentials, serviceClientConfig);
        }
