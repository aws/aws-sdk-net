...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class InvalidS3PrefixException : AmazonCloudTrailException
    {
        ...
        public InvalidS3PrefixException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidS3PrefixException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
