...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class ResourcePolicyNotFoundException : AmazonCloudTrailException
    {
        ...
        public ResourcePolicyNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourcePolicyNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
