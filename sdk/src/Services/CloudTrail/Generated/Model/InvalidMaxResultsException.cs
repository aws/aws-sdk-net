...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class InvalidMaxResultsException : AmazonCloudTrailException
    {
        ...
        public InvalidMaxResultsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidMaxResultsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
