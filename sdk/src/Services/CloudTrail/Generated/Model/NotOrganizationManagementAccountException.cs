...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class NotOrganizationManagementAccountException : AmazonCloudTrailException
    {
        ...
        /// <summary>
        /// Default constructor for NotOrganizationManagementAccountException
        /// message.
        /// </summary>
        public NotOrganizationManagementAccountException() 
            : base() {}
        ...
        public NotOrganizationManagementAccountException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotOrganizationManagementAccountException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
