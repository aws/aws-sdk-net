    ...
    public class ListImportsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImportsListItem, ImportsListItemUnmarshaller>(ImportsListItemUnmarshaller.Instance);
                    response.Imports = unmarshaller.Unmarshall(context);
                    continue;
                }
