...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTrail operation
    /// </summary>  
    public class DeleteTrailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTrailResponse response = new DeleteTrailResponse();
        ...
        private static DeleteTrailResponseUnmarshaller _instance = new DeleteTrailResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
