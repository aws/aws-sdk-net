    ...
    public class TrailUnmarshaller : IJsonUnmarshaller<Trail, JsonUnmarshallerContext>
    {
        ...
        public Trail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HasInsightSelectors", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                ...
                if (context.TestExpression("RecursiveLogging", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.RecursiveLogging = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
