...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterOrganizationDelegatedAdmin operation
    /// </summary>  
    public class DeregisterOrganizationDelegatedAdminResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterOrganizationDelegatedAdminResponse response = new DeregisterOrganizationDelegatedAdminResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("AccountNotRegisteredException"))
                {
                    return AccountNotRegisteredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeregisterOrganizationDelegatedAdminResponseUnmarshaller _instance = new DeregisterOrganizationDelegatedAdminResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterOrganizationDelegatedAdminResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
