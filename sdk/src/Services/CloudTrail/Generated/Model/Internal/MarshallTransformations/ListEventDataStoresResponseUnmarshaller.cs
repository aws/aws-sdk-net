    ...
    public class ListEventDataStoresResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EventDataStore, EventDataStoreUnmarshaller>(EventDataStoreUnmarshaller.Instance);
                    response.EventDataStores = unmarshaller.Unmarshall(context);
                    continue;
                }
