    ...
    public class DescribeTrailsRequestMarshaller : IMarshaller<IRequest, DescribeTrailsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeTrailsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetIncludeShadowTrails())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.IncludeShadowTrails.Value);
            }
            ...
            if(publicRequest.IsSetTrailNameList())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestTrailNameListListValue);
                }
        ...
        private static DescribeTrailsRequestMarshaller _instance = new DescribeTrailsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrailsRequestMarshaller Instance
        {
            get
            {
                return _instance;
