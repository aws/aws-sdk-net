...
{
    /// <summary>
    /// Response Unmarshaller for ListImportFailures operation
    /// </summary>  
    public class ListImportFailuresResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImportFailuresResponse response = new ListImportFailuresResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImportFailureListItem, ImportFailureListItemUnmarshaller>(ImportFailureListItemUnmarshaller.Instance);
        ...
        private static ListImportFailuresResponseUnmarshaller _instance = new ListImportFailuresResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImportFailuresResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
