...
{
    /// <summary>
    /// DescribeQuery Request Marshaller
    /// </summary>       
    public class DescribeQueryRequestMarshaller : IMarshaller<IRequest, DescribeQueryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeQueryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeQueryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudTrail");
            string target = "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DescribeQuery";
        ...
        private static DescribeQueryRequestMarshaller _instance = new DescribeQueryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQueryRequestMarshaller Instance
        {
            get
            {
                return _instance;
