    ...
    public class ListDashboardsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DashboardDetail, DashboardDetailUnmarshaller>(DashboardDetailUnmarshaller.Instance);
                    response.Dashboards = unmarshaller.Unmarshall(context);
                    continue;
                }
