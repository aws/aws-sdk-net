...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class NotOrganizationMasterAccountException : AmazonCloudTrailException
    {
        ...
        public NotOrganizationMasterAccountException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotOrganizationMasterAccountException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
