...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class InsightNotEnabledException : AmazonCloudTrailException
    {
        ...
        /// <summary>
        /// Construct instance of InsightNotEnabledException
        /// </summary>
        ...
        public InsightNotEnabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InsightNotEnabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected InsightNotEnabledException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
