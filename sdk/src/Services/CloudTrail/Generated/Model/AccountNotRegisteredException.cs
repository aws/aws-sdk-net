...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class AccountNotRegisteredException : AmazonCloudTrailException
    {
        ...
        public AccountNotRegisteredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccountNotRegisteredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
