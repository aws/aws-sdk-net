...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class MaxConcurrentQueriesException : AmazonCloudTrailException
    {
        ...
        public MaxConcurrentQueriesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MaxConcurrentQueriesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
