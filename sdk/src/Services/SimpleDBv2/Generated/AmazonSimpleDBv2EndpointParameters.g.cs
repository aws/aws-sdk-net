...
namespace Amazon.SimpleDBv2.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving SimpleDBv2 endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonSimpleDBv2EndpointProvider"/> and <see cref="AmazonSimpleDBv2EndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class SimpleDBv2EndpointParameters : EndpointParameters
    {
        /// <summary>
        /// SimpleDBv2EndpointParameters constructor
        /// </summary>
        public SimpleDBv2EndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
