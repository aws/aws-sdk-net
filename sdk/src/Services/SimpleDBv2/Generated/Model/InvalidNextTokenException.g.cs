...
namespace Amazon.SimpleDBv2.Model
{
    ...
    public partial class InvalidNextTokenException : AmazonSimpleDBv2Exception
    {
        ...
        /// message.
        /// </summary>
        public InvalidNextTokenException() : base() { }
        ...
        /// Construct instance of InvalidNextTokenException
        /// </summary>
        public InvalidNextTokenException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidNextTokenException
        /// </summary>
        public InvalidNextTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidNextTokenException
        /// </summary>
        public InvalidNextTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
