...
namespace Amazon.SimpleDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartDomainExportRequestMarshaller : IMarshaller<IRequest, StartDomainExportRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartDomainExportRequestMarshaller _instance = new();

        internal static StartDomainExportRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartDomainExportRequestMarshaller Instance => _instance;
    }
}
