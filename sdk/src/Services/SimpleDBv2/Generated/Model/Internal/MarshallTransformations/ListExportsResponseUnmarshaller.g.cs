...
namespace Amazon.SimpleDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListExportsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListExportsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("exportSummaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ExportSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListExportsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListExportsResponseUnmarshaller Instance => _instance;
    }
}
