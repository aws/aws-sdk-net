...
namespace Amazon.SimpleDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartDomainExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return NumberExportsLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        internal static StartDomainExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDomainExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
