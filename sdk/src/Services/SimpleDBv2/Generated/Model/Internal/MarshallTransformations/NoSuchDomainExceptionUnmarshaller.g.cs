...
{
    /// <summary>
    /// Exception Unmarshaller for NoSuchDomainException
    /// </summary>
    public partial class NoSuchDomainExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<NoSuchDomainException, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the exception from the service to the appropriate exception class
        /// </summary>
        public NoSuchDomainException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// Gets the singleton.
        /// </summary>
        public static NoSuchDomainExceptionUnmarshaller Instance => _instance;
    }
}
