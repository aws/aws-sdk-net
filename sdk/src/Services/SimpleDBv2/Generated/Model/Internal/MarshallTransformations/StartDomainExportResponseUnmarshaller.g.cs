...
{
    /// <summary>
    /// Response Unmarshaller for StartDomainExport operation.
    /// </summary>
    public partial class StartDomainExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDomainExportResponse response = new StartDomainExportResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var streamCopy = new MemoryStream(responseBodyBytes))
            {
                using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
                {
                    ...
                    if (errorResponse.Code != null && errorResponse.Code.Equals("NoSuchDomainException"))
                    {
                        return NoSuchDomainExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
                    if (errorResponse.Code != null && errorResponse.Code.Equals("NumberExportsLimitExceeded"))
                    {
                        return NumberExportsLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
                }
            }
        ...
        private static StartDomainExportResponseUnmarshaller _instance = new StartDomainExportResponseUnmarshaller();

        internal static StartDomainExportResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartDomainExportResponseUnmarshaller Instance => _instance;
    }
}
