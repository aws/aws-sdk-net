...
namespace Amazon.SimpleDBv2.Model
{
    ...
    {
        private readonly IAmazonSimpleDBv2 _client;
        ...
        /// </summary>
        public IPaginatedEnumerable<ExportSummary> ExportSummaries => 
            new PaginatedResultKeyResponse<ListExportsResponse, ExportSummary>(this, (i) => i.ExportSummaries ?? new List<ExportSummary>());

        internal ListExportsPaginator(IAmazonSimpleDBv2 client, ListExportsRequest request)
        {
            this._client = client;
