...
namespace Amazon.SimpleDBv2.Model
{
    ...
    public partial class ListExportsRequest : AmazonSimpleDBv2Request
    {
        ...
        /// <para>
        /// The name of the domain to filter exports. If not provided, exports for all the domains
        /// will be listed.
        /// </para>
        /// </summary>
        [AWSProperty(Min=1)]
        ...
        /// <para>
        /// A pagination token used to retrieve the next page of results. This token is obtained
