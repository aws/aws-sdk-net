...
namespace Amazon.SimpleDBv2.Model
{
    ...
    public partial class ListExportsResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// List of export summaries containing export ARN, status, request timestamp, and associated
        /// domain name.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// A pagination token indicating that more results are available. To retrieve the next
        /// page of results, provide this token in a subsequent ListExports request. If null or
        /// empty, there are no more results to retrieve.
        /// </para>
        /// </summary>
