...
namespace Amazon.SimpleDBv2
{
    ...
    /// on application development. A traditional, clustered relational database requires
    /// a sizable upfront capital outlay, is complex to design, and often requires extensive
    /// and repetitive database administration. Amazon SimpleDB is dramatically simpler, requiring
    /// no schema, automatically indexing your data and providing a simple API for storage
    /// and access. This approach eliminates the administrative burden of data modeling, index
    /// maintenance, and performance tuning. Developers gain access to this functionality
    /// within Amazon's proven computing environment, are able to scale instantly, and pay
