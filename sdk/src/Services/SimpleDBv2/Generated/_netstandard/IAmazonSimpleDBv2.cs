...
namespace Amazon.SimpleDBv2
{
    ...
    public partial interface IAmazonSimpleDBv2 : IAmazonService, IDisposable
    {
        ...
        Task<StartDomainExportResponse> StartDomainExportAsync(StartDomainExportRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSimpleDBv2Config))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSimpleDBv2Config();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSimpleDBv2Config;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSimpleDBv2Config to create AmazonSimpleDBv2Client");
            }

            return awsCredentials == null ? 
                    new AmazonSimpleDBv2Client(serviceClientConfig) :
                    new AmazonSimpleDBv2Client(awsCredentials, serviceClientConfig);
        }
