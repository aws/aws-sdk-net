...
namespace Amazon.SimpleDBv2
{
    ...
    public partial class AmazonSimpleDBv2Client : AmazonServiceClient, IAmazonSimpleDBv2
    {
        ...
        public AmazonSimpleDBv2Client()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSimpleDBv2Config()) { }
        ...
        public AmazonSimpleDBv2Client(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSimpleDBv2Config{RegionEndpoint = region}) { }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonSimpleDBv2EndpointResolver();
