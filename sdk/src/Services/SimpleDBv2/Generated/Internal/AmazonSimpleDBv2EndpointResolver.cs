...
namespace Amazon.SimpleDBv2.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for SimpleDBv2 service requests.
    /// Collects values for SimpleDBv2EndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SimpleDBv2EndpointProvider.
