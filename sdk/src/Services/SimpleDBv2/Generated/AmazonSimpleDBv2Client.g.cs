...
namespace Amazon.SimpleDBv2
{
    ...
    public partial class AmazonSimpleDBv2Client : AmazonServiceClient, IAmazonSimpleDBv2
    {
        ...
        /// 
        /// </summary>
        public AmazonSimpleDBv2Client() : base(new AmazonSimpleDBv2Config()) { }
        ...
        public AmazonSimpleDBv2Client(RegionEndpoint region) : base(new AmazonSimpleDBv2Config { RegionEndpoint = region }) { }
        ...
        public AmazonSimpleDBv2Client(AmazonSimpleDBv2Config config) : base(config) { }
