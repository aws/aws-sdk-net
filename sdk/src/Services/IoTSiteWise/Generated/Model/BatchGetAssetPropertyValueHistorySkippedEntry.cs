...
{
    /// <summary>
    /// Contains information for an entry that has been processed by the previous <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_BatchGetAssetPropertyValue.html">BatchGetAssetPropertyValueHistory</a>
    /// request.
    /// </summary>
    public partial class BatchGetAssetPropertyValueHistorySkippedEntry
    {
        private BatchEntryCompletionStatus _completionStatus;
        private string _entryId;
        private BatchGetAssetPropertyValueHistoryErrorInfo _errorInfo;

        /// <summary>
        /// Gets and sets the property CompletionStatus. 
        /// <para>
        /// The completion status of each entry that is associated with the <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_BatchGetAssetPropertyValueHistory.html">BatchGetAssetPropertyValueHistory</a>
        /// API.
        /// </para>
        /// </summary>
