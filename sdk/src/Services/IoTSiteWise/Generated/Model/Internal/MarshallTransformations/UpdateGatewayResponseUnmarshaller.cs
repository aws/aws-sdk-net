...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGateway operation
    /// </summary>  
    public class UpdateGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new ConflictingOperationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static UpdateGatewayResponseUnmarshaller _instance = new UpdateGatewayResponseUnmarshaller();        

        internal static UpdateGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
