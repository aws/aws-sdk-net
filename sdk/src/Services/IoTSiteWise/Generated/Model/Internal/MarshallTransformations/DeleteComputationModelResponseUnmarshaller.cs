...
{
    /// <summary>
    /// Response Unmarshaller for DeleteComputationModel operation
    /// </summary>  
    public class DeleteComputationModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteComputationModelResponse response = new DeleteComputationModelResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("computationModelStatus", targetDepth))
                {
                    ...
                    response.ComputationModelStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DeleteComputationModelResponseUnmarshaller _instance = new DeleteComputationModelResponseUnmarshaller();        

        internal static DeleteComputationModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteComputationModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
