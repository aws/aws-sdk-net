...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSearchResultsRequestMarshaller : IMarshaller<IRequest, GetSearchResultsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSearchResultsRequestMarshaller _instance = new GetSearchResultsRequestMarshaller();        

        internal static GetSearchResultsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSearchResultsRequestMarshaller Instance
        {
            get
            {
                return _instance;
