...
{
    /// <summary>
    /// Response Unmarshaller for GetSearchResults operation
    /// </summary>  
    public class GetSearchResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SearchResult, SearchResultUnmarshaller>(SearchResultUnmarshaller.Instance);
        ...
        private static GetSearchResultsResponseUnmarshaller _instance = new GetSearchResultsResponseUnmarshaller();        

        internal static GetSearchResultsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSearchResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
