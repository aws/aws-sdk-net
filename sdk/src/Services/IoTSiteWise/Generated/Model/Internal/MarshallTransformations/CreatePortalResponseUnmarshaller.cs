...
{
    /// <summary>
    /// Response Unmarshaller for CreatePortal operation
    /// </summary>  
    public class CreatePortalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePortalResponse response = new CreatePortalResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ssoApplicationId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SsoApplicationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreatePortalResponseUnmarshaller _instance = new CreatePortalResponseUnmarshaller();        

        internal static CreatePortalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePortalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
