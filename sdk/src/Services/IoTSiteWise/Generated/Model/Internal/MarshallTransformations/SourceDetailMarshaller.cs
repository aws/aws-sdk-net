    ...
    public class SourceDetailMarshaller : IRequestMarshaller<SourceDetail, JsonMarshallerContext> 
    {
        ...
        public void Marshall(SourceDetail requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetKendra())
            {
                context.Writer.WritePropertyName("kendra");
                context.Writer.WriteStartObject();

                var marshaller = KendraSourceDetailMarshaller.Instance;
                marshaller.Marshall(requestObject.Kendra, context);
