...
{
    /// <summary>
    /// CancelPipelineExecution Request Marshaller
    /// </summary>       
    public class CancelPipelineExecutionRequestMarshaller : IMarshaller<IRequest, CancelPipelineExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelPipelineExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelPipelineExecutionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workspaces/{workspaceName}/pipelines/{pipelineName}/executions/{pipelineExecutionId}/cancel";
#if !NETFRAMEWORK
        ...
        private static CancelPipelineExecutionRequestMarshaller _instance = new CancelPipelineExecutionRequestMarshaller();        

        internal static CancelPipelineExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelPipelineExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
