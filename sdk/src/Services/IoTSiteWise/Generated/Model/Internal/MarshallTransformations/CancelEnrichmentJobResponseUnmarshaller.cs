...
{
    /// <summary>
    /// Response Unmarshaller for CancelEnrichmentJob operation
    /// </summary>  
    public class CancelEnrichmentJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelEnrichmentJobResponse response = new CancelEnrichmentJobResponse();
        ...
        private static CancelEnrichmentJobResponseUnmarshaller _instance = new CancelEnrichmentJobResponseUnmarshaller();        

        internal static CancelEnrichmentJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelEnrichmentJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
