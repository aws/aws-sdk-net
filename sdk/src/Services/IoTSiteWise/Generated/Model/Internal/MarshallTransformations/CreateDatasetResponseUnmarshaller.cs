...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("datasetStatus", targetDepth))
                {
                    var unmarshaller = DatasetStatusUnmarshaller.Instance;
                    response.DatasetStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateDatasetResponseUnmarshaller _instance = new CreateDatasetResponseUnmarshaller();        

        internal static CreateDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
