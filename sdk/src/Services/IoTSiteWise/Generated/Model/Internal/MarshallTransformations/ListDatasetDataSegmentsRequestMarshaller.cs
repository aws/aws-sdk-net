...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListDatasetDataSegmentsRequestMarshaller : IMarshaller<IRequest, ListDatasetDataSegmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListDatasetDataSegmentsRequestMarshaller _instance = new ListDatasetDataSegmentsRequestMarshaller();        

        internal static ListDatasetDataSegmentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDatasetDataSegmentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
