...
{
    /// <summary>
    /// Response Unmarshaller for CancelPipelineExecution operation
    /// </summary>  
    public class CancelPipelineExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelPipelineExecutionResponse response = new CancelPipelineExecutionResponse();
        ...
        private static CancelPipelineExecutionResponseUnmarshaller _instance = new CancelPipelineExecutionResponseUnmarshaller();        

        internal static CancelPipelineExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelPipelineExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
