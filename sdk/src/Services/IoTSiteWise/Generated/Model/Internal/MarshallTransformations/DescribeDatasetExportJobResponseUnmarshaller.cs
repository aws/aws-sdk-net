...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDatasetExportJob operation
    /// </summary>  
    public class DescribeDatasetExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDatasetExportJobResponse response = new DescribeDatasetExportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("destinationS3Uri", targetDepth, ref reader))
                {
                    ...
                    response.DestinationS3Uri = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("errorReportLocation", targetDepth, ref reader))
                {
                    var unmarshaller = ExportErrorReportLocationUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = ProcessingInputUnmarshaller.Instance;
        ...
        private static DescribeDatasetExportJobResponseUnmarshaller _instance = new DescribeDatasetExportJobResponseUnmarshaller();        

        internal static DescribeDatasetExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDatasetExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
