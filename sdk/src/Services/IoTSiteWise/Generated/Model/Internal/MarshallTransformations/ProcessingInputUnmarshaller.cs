    ...
    public class ProcessingInputUnmarshaller : IJsonUnmarshaller<ProcessingInput, JsonUnmarshallerContext>
    {
        ...
        public ProcessingInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DatasetItemUnmarshaller.Instance;
                    unmarshalledObject.Dataset = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("timeseries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TimeseriesItem, TimeseriesItemUnmarshaller>(TimeseriesItemUnmarshaller.Instance);
                    unmarshalledObject.Timeseries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
