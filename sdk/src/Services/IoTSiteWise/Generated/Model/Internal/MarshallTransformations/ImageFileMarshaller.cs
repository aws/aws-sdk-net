...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    public class ImageFileMarshaller : IRequestMarshaller<ImageFile, JsonMarshallerContext> 
    {
        ...
        {
            if(requestObject.IsSetEncodedString())
            {
                context.Writer.WritePropertyName("encodedString");
                context.Writer.Write(StringUtils.FromMemoryStream(requestObject.EncodedString));
            }
