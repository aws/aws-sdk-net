...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspace operation
    /// </summary>  
    public class UpdateWorkspaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("workspaceStatus", targetDepth, ref reader))
                {
                    var unmarshaller = WorkspaceStatusUnmarshaller.Instance;
                    response.WorkspaceStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateWorkspaceResponseUnmarshaller _instance = new UpdateWorkspaceResponseUnmarshaller();        

        internal static UpdateWorkspaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
