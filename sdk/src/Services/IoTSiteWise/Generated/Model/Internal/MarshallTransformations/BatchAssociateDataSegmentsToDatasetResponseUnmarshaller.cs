...
{
    /// <summary>
    /// Response Unmarshaller for BatchAssociateDataSegmentsToDataset operation
    /// </summary>  
    public class BatchAssociateDataSegmentsToDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchAssociateDataSegmentsToDatasetResponse response = new BatchAssociateDataSegmentsToDatasetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("failedAssociations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FailedDataSegmentAssociation, FailedDataSegmentAssociationUnmarshaller>(FailedDataSegmentAssociationUnmarshaller.Instance);
                    response.FailedAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchAssociateDataSegmentsToDatasetResponseUnmarshaller _instance = new BatchAssociateDataSegmentsToDatasetResponseUnmarshaller();        

        internal static BatchAssociateDataSegmentsToDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAssociateDataSegmentsToDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
