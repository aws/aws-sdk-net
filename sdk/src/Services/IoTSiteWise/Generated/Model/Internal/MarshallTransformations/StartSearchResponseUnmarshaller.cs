...
{
    /// <summary>
    /// Response Unmarshaller for StartSearch operation
    /// </summary>  
    public class StartSearchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSearchResponse response = new StartSearchResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SearchId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartSearchResponseUnmarshaller _instance = new StartSearchResponseUnmarshaller();        

        internal static StartSearchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSearchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
