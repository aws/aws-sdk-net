...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    public class StartPipelineExecutionRequestMarshaller : IMarshaller<IRequest, StartPipelineExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartPipelineExecutionRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetExecutionEnvironmentVariableOverrides())
            {
                context.Writer.WritePropertyName("executionEnvironmentVariableOverrides");
                context.Writer.WriteStartObject();

                var marshaller = ExecutionEnvironmentVariablesMarshaller.Instance;
                marshaller.Marshall(publicRequest.ExecutionEnvironmentVariableOverrides, context);
            ...
            if(publicRequest.IsSetExecutionPriority())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.ExecutionPriority.Value);
            }
