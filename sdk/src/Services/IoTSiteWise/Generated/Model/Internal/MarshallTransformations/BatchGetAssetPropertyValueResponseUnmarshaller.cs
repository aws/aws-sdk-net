    ...
    public class BatchGetAssetPropertyValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchGetAssetPropertyValueErrorEntry, BatchGetAssetPropertyValueErrorEntryUnmarshaller>(BatchGetAssetPropertyValueErrorEntryUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchGetAssetPropertyValueSkippedEntry, BatchGetAssetPropertyValueSkippedEntryUnmarshaller>(BatchGetAssetPropertyValueSkippedEntryUnmarshaller.Instance);
                    response.SkippedEntries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("successEntries", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchGetAssetPropertyValueSuccessEntry, BatchGetAssetPropertyValueSuccessEntryUnmarshaller>(BatchGetAssetPropertyValueSuccessEntryUnmarshaller.Instance);
