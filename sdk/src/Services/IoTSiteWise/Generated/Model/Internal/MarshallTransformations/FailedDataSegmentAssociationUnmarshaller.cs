...
{
    /// <summary>
    /// Response Unmarshaller for FailedDataSegmentAssociation Object
    /// </summary>  
    public class FailedDataSegmentAssociationUnmarshaller : IJsonUnmarshaller<FailedDataSegmentAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedDataSegmentAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FailedDataSegmentAssociation unmarshalledObject = new FailedDataSegmentAssociation();
        ...
        private static FailedDataSegmentAssociationUnmarshaller _instance = new FailedDataSegmentAssociationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FailedDataSegmentAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
