...
{
    /// <summary>
    /// Response Unmarshaller for SearchResult Object
    /// </summary>  
    public class SearchResultUnmarshaller : IJsonUnmarshaller<SearchResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SearchResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SearchResult unmarshalledObject = new SearchResult();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("topTimestamp", targetDepth, ref reader))
                {
                    var unmarshaller = TimeInNanosUnmarshaller.Instance;
                    unmarshalledObject.TopTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchResultUnmarshaller _instance = new SearchResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SearchResultUnmarshaller Instance
        {
            get
            {
                return _instance;
