...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    public class DeletePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeletePipelineResponseUnmarshaller _instance = new DeletePipelineResponseUnmarshaller();        

        internal static DeletePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
