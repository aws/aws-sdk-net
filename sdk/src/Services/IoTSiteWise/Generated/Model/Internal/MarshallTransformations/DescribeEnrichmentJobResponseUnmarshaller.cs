...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEnrichmentJob operation
    /// </summary>  
    public class DescribeEnrichmentJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEnrichmentJobResponse response = new DescribeEnrichmentJobResponse();
            ...
            {
                if (context.TestExpression("cancelledAt", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.CancelledAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = EnrichmentJobConfigurationUnmarshaller.Instance;
        ...
        private static DescribeEnrichmentJobResponseUnmarshaller _instance = new DescribeEnrichmentJobResponseUnmarshaller();        

        internal static DescribeEnrichmentJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEnrichmentJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
