        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("computationModelArn", targetDepth))
                {
                    ...
                    response.ComputationModelArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("computationModelConfiguration", targetDepth))
                {
                    ...
                    response.ComputationModelConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("computationModelCreationDate", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.ComputationModelCreationDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("computationModelDataBinding", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ComputationModelDataBindingValue, StringUnmarshaller, ComputationModelDataBindingValueUnmarshaller>(StringUnmarshaller.Instance, ComputationModelDataBindingValueUnmarshaller.Instance);
                    response.ComputationModelDataBinding = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("computationModelDescription", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ComputationModelDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.ComputationModelLastUpdateDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("computationModelName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ComputationModelName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ComputationModelVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
