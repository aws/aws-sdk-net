...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAssetProperty operation
    /// </summary>  
    public class DescribeAssetPropertyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAssetPropertyResponse response = new DescribeAssetPropertyResponse();
        ...
        private static DescribeAssetPropertyResponseUnmarshaller _instance = new DescribeAssetPropertyResponseUnmarshaller();        

        internal static DescribeAssetPropertyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssetPropertyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
