...
{
    /// <summary>
    /// Response Unmarshaller for ListEnrichmentJobs operation
    /// </summary>  
    public class ListEnrichmentJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListEnrichmentJobsResponse response = new ListEnrichmentJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EnrichmentJobSummary, EnrichmentJobSummaryUnmarshaller>(EnrichmentJobSummaryUnmarshaller.Instance);
        ...
        private static ListEnrichmentJobsResponseUnmarshaller _instance = new ListEnrichmentJobsResponseUnmarshaller();        

        internal static ListEnrichmentJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEnrichmentJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
