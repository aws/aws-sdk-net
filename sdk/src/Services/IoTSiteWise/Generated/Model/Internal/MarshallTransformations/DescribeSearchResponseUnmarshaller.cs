...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSearch operation
    /// </summary>  
    public class DescribeSearchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSearchResponse response = new DescribeSearchResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.QueryStatement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SearchType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeSearchResponseUnmarshaller _instance = new DescribeSearchResponseUnmarshaller();        

        internal static DescribeSearchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSearchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
