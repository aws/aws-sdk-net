...
{
    /// <summary>
    /// Response Unmarshaller for BatchDisassociateDataSegmentsFromDataset operation
    /// </summary>  
    public class BatchDisassociateDataSegmentsFromDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDisassociateDataSegmentsFromDatasetResponse response = new BatchDisassociateDataSegmentsFromDatasetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("failedDisassociations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FailedDataSegmentDisassociation, FailedDataSegmentDisassociationUnmarshaller>(FailedDataSegmentDisassociationUnmarshaller.Instance);
                    response.FailedDisassociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchDisassociateDataSegmentsFromDatasetResponseUnmarshaller _instance = new BatchDisassociateDataSegmentsFromDatasetResponseUnmarshaller();        

        internal static BatchDisassociateDataSegmentsFromDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDisassociateDataSegmentsFromDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
