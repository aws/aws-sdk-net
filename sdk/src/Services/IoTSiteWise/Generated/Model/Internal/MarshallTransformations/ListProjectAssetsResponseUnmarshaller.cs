...
{
    /// <summary>
    /// Response Unmarshaller for ListProjectAssets operation
    /// </summary>  
    public class ListProjectAssetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListProjectAssetsResponse response = new ListProjectAssetsResponse();
            ...
            {
                if (context.TestExpression("assetIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.AssetIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListProjectAssetsResponseUnmarshaller _instance = new ListProjectAssetsResponseUnmarshaller();        

        internal static ListProjectAssetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProjectAssetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
