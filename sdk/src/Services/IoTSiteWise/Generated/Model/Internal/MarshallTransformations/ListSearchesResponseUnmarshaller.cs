...
{
    /// <summary>
    /// Response Unmarshaller for ListSearches operation
    /// </summary>  
    public class ListSearchesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSearchesResponse response = new ListSearchesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("searchSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SearchSummary, SearchSummaryUnmarshaller>(SearchSummaryUnmarshaller.Instance);
                    response.SearchSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSearchesResponseUnmarshaller _instance = new ListSearchesResponseUnmarshaller();        

        internal static ListSearchesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSearchesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
