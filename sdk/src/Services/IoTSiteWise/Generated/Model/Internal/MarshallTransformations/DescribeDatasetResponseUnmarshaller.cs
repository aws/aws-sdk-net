        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("datasetCreationDate", targetDepth))
                {
                    ...
                    response.DatasetCreationDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.DatasetLastUpdateDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("datasetSource", targetDepth))
                {
                    ...
                    response.DatasetSource = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DatasetVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
