...
{
    /// <summary>
    /// Response Unmarshaller for ListAssetModelCompositeModels operation
    /// </summary>  
    public class ListAssetModelCompositeModelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssetModelCompositeModelsResponse response = new ListAssetModelCompositeModelsResponse();
        ...
        private static ListAssetModelCompositeModelsResponseUnmarshaller _instance = new ListAssetModelCompositeModelsResponseUnmarshaller();        

        internal static ListAssetModelCompositeModelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssetModelCompositeModelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
