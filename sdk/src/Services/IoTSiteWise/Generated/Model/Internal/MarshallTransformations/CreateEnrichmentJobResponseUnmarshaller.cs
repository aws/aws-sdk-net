...
{
    /// <summary>
    /// Response Unmarshaller for CreateEnrichmentJob operation
    /// </summary>  
    public class CreateEnrichmentJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEnrichmentJobResponse response = new CreateEnrichmentJobResponse();
        ...
        private static CreateEnrichmentJobResponseUnmarshaller _instance = new CreateEnrichmentJobResponseUnmarshaller();        

        internal static CreateEnrichmentJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEnrichmentJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
