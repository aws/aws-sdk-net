...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteDatasetDataSegments operation
    /// </summary>  
    public class BatchDeleteDatasetDataSegmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteDatasetDataSegmentsResponse response = new BatchDeleteDatasetDataSegmentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FailedDataSegmentDeletion, FailedDataSegmentDeletionUnmarshaller>(FailedDataSegmentDeletionUnmarshaller.Instance);
        ...
        private static BatchDeleteDatasetDataSegmentsResponseUnmarshaller _instance = new BatchDeleteDatasetDataSegmentsResponseUnmarshaller();        

        internal static BatchDeleteDatasetDataSegmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteDatasetDataSegmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
