...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetModelPropertySummaryUnmarshaller : IJsonUnmarshaller<AssetModelPropertySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetModelPropertySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("interfaceSummaries", targetDepth, ref reader))
                {
