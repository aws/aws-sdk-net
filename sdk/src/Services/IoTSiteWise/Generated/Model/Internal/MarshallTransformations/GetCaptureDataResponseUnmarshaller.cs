...
{
    /// <summary>
    /// Response Unmarshaller for GetCaptureData operation
    /// </summary>  
    public class GetCaptureDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCaptureDataResponse response = new GetCaptureDataResponse();
        ...
        private static GetCaptureDataResponseUnmarshaller _instance = new GetCaptureDataResponseUnmarshaller();        

        internal static GetCaptureDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCaptureDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
