    ...
    public class DescribePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ComputeNode, ComputeNodeUnmarshaller>(ComputeNodeUnmarshaller.Instance);
                    response.Computations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
