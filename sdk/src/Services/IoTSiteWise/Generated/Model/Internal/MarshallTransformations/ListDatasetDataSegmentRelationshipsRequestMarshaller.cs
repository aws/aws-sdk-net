...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListDatasetDataSegmentRelationshipsRequestMarshaller : IMarshaller<IRequest, ListDatasetDataSegmentRelationshipsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListDatasetDataSegmentRelationshipsRequestMarshaller _instance = new ListDatasetDataSegmentRelationshipsRequestMarshaller();        

        internal static ListDatasetDataSegmentRelationshipsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDatasetDataSegmentRelationshipsRequestMarshaller Instance
        {
            get
            {
                return _instance;
