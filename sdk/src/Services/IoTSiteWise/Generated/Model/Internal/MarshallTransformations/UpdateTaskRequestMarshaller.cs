...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateTaskRequestMarshaller : IMarshaller<IRequest, UpdateTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateTaskRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetTaskConfiguration())
            {
                context.Writer.WritePropertyName("taskConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = TaskConfigurationMarshaller.Instance;
                marshaller.Marshall(publicRequest.TaskConfiguration, context);
