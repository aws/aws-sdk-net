...
{
    /// <summary>
    /// Response Unmarshaller for ComputeNode Object
    /// </summary>  
    public class ComputeNodeUnmarshaller : IJsonUnmarshaller<ComputeNode, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComputeNode Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ComputeNode unmarshalledObject = new ComputeNode();
        ...
        private static ComputeNodeUnmarshaller _instance = new ComputeNodeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ComputeNodeUnmarshaller Instance
        {
            get
            {
                return _instance;
