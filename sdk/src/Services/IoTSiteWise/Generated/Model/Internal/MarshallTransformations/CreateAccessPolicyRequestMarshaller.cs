...
{
    /// <summary>
    /// CreateAccessPolicy Request Marshaller
    /// </summary>       
    public class CreateAccessPolicyRequestMarshaller : IMarshaller<IRequest, CreateAccessPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccessPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccessPolicyRequest publicRequest)
        {
        ...
        private static CreateAccessPolicyRequestMarshaller _instance = new CreateAccessPolicyRequestMarshaller();        

        internal static CreateAccessPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
