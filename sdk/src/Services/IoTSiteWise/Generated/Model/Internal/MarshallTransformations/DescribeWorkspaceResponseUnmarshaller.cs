    ...
    public class DescribeWorkspaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = WorkspaceEncryptionConfigurationInfoUnmarshaller.Instance;
                ...
                if (context.TestExpression("workspaceDescription", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkspaceDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
