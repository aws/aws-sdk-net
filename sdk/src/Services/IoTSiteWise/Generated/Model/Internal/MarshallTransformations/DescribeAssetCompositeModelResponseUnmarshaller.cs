        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("assetCompositeModelDescription", targetDepth))
                {
                    ...
                    response.AssetCompositeModelDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("assetCompositeModelExternalId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetCompositeModelExternalId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("assetCompositeModelId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetCompositeModelId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("assetCompositeModelName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetCompositeModelName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("assetCompositeModelPath", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AssetCompositeModelPathSegment, AssetCompositeModelPathSegmentUnmarshaller>(AssetCompositeModelPathSegmentUnmarshaller.Instance);
                    response.AssetCompositeModelPath = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("assetCompositeModelProperties", targetDepth))
                {
                    ...
                    response.AssetCompositeModelProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetCompositeModelType = unmarshaller.Unmarshall(context);
                    continue;
                }
