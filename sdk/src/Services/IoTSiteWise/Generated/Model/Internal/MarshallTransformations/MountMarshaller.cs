...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// Mount Marshaller
    /// </summary>
    public class MountMarshaller : IRequestMarshaller<Mount, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Mount requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSource())
            {
                ...
                var marshaller = MountSourceMarshaller.Instance;
        ...
        /// </summary>
        public readonly static MountMarshaller Instance = new MountMarshaller();
