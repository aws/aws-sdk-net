    ...
    public class DescribeTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("taskConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = TaskConfigurationUnmarshaller.Instance;
                    response.TaskConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
