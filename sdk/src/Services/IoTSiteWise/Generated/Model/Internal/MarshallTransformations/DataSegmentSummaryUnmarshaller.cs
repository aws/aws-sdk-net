...
{
    /// <summary>
    /// Response Unmarshaller for DataSegmentSummary Object
    /// </summary>  
    public class DataSegmentSummaryUnmarshaller : IJsonUnmarshaller<DataSegmentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataSegmentSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DataSegmentSummary unmarshalledObject = new DataSegmentSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("enrichment", targetDepth, ref reader))
                {
                    var unmarshaller = DataSegmentEnrichmentUnmarshaller.Instance;
        ...
        private static DataSegmentSummaryUnmarshaller _instance = new DataSegmentSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataSegmentSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
