...
{
    /// <summary>
    /// Response Unmarshaller for FailedDataSegmentDisassociation Object
    /// </summary>  
    public class FailedDataSegmentDisassociationUnmarshaller : IJsonUnmarshaller<FailedDataSegmentDisassociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedDataSegmentDisassociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FailedDataSegmentDisassociation unmarshalledObject = new FailedDataSegmentDisassociation();
        ...
        private static FailedDataSegmentDisassociationUnmarshaller _instance = new FailedDataSegmentDisassociationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FailedDataSegmentDisassociationUnmarshaller Instance
        {
            get
            {
                return _instance;
