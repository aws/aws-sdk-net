...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListProjectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("projectSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ProjectSummary, ProjectSummaryUnmarshaller>(ProjectSummaryUnmarshaller.Instance);
                    response.ProjectSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListProjectsResponseUnmarshaller _instance = new ListProjectsResponseUnmarshaller();        

        internal static ListProjectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProjectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
