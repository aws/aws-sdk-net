...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    public class DescribePipelineExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("computeNodeExecutionDetails", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ComputeNodeExecutionDetails, ComputeNodeExecutionDetailsUnmarshaller>(ComputeNodeExecutionDetailsUnmarshaller.Instance);
                    response.ComputeNodeExecutionDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("executionPriority", targetDepth, ref reader))
                {
                    ...
                    response.ExecutionPriority = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("requestEnvironmentVariables", targetDepth, ref reader))
                {
                    var unmarshaller = ExecutionEnvironmentVariablesUnmarshaller.Instance;
