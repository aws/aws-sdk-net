...
{
    /// <summary>
    /// Response Unmarshaller for FailedDataSegmentDeletion Object
    /// </summary>  
    public class FailedDataSegmentDeletionUnmarshaller : IJsonUnmarshaller<FailedDataSegmentDeletion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedDataSegmentDeletion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FailedDataSegmentDeletion unmarshalledObject = new FailedDataSegmentDeletion();
        ...
        private static FailedDataSegmentDeletionUnmarshaller _instance = new FailedDataSegmentDeletionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FailedDataSegmentDeletionUnmarshaller Instance
        {
            get
            {
                return _instance;
