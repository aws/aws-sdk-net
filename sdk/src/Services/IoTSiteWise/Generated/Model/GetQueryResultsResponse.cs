...
namespace Amazon.IoTSiteWise.Model
{
    ...
    {
        private List<ColumnInformation> _columnInfo = AWSConfigs.InitializeCollections ? new List<ColumnInformation>() : null;
        ...
        /// <para>
        /// A list of column metadata for the query results. Each entry contains the column name
        /// and data type. Present when the query status is COMPLETED.
        /// </para>
        /// <para />
        ...
        /// </summary>
        public List<ColumnInformation> ColumnInfo
        {
        ...
        /// <para>
        /// The result rows. Each row is a list of string column values, positional to match the
        /// columnInfo order. Present when the query status is COMPLETED.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
