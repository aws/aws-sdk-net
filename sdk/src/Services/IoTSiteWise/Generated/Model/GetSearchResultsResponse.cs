...
namespace Amazon.IoTSiteWise.Model
{
    ...
    /// </summary>
    public partial class GetSearchResultsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<SearchResult> _searchResults = AWSConfigs.InitializeCollections ? new List<SearchResult>() : null;

        /// <summary>
        /// Gets and sets the property NextToken. 
        /// <para>
        /// The pagination token to use in a subsequent GetSearchResults call to retrieve the
        /// next page. Absent when there are no more results.
        /// </para>
        /// </summary>
