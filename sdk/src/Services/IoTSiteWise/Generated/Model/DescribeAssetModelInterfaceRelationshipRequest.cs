...
{
    /// <summary>
    /// Container for the parameters to the DescribeAssetModelInterfaceRelationship operation.
    /// Retrieves information about an interface relationship between an asset model and an
    /// interface asset model.
    /// </summary>
    public partial class DescribeAssetModelInterfaceRelationshipRequest : AmazonIoTSiteWiseRequest
    {
