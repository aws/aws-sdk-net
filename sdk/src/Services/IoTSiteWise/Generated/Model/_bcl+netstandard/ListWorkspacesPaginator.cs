...
namespace Amazon.IoTSiteWise.Model
{
    ...
    internal sealed partial class ListWorkspacesPaginator : IPaginator<ListWorkspacesResponse>, IListWorkspacesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<WorkspaceSummary> WorkspaceSummaries => 
            new PaginatedResultKeyResponse<ListWorkspacesResponse, WorkspaceSummary>(this, (i) => i.WorkspaceSummaries ?? new List<WorkspaceSummary>());

        internal ListWorkspacesPaginator(IAmazonIoTSiteWise client, ListWorkspacesRequest request)
        {
            this._client = client;
