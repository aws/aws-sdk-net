...
namespace Amazon.IoTSiteWise.Model
{
    ...
    internal sealed partial class ListQueriesPaginator : IPaginator<ListQueriesResponse>, IListQueriesPaginator
    {
        ...
        public IPaginatedEnumerable<QuerySummary> Queries => 
            new PaginatedResultKeyResponse<ListQueriesResponse, QuerySummary>(this, (i) => i.Queries ?? new List<QuerySummary>());

        internal ListQueriesPaginator(IAmazonIoTSiteWise client, ListQueriesRequest request)
        {
            this._client = client;
