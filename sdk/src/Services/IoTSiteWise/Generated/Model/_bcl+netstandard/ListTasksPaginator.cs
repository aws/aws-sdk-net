...
namespace Amazon.IoTSiteWise.Model
{
    ...
    internal sealed partial class ListTasksPaginator : IPaginator<ListTasksResponse>, IListTasksPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<TaskSummary> TaskSummaries => 
            new PaginatedResultKeyResponse<ListTasksResponse, TaskSummary>(this, (i) => i.TaskSummaries ?? new List<TaskSummary>());

        internal ListTasksPaginator(IAmazonIoTSiteWise client, ListTasksRequest request)
        {
            this._client = client;
