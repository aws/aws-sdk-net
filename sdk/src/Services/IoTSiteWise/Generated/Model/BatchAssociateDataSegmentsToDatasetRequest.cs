...
{
    /// <summary>
    /// Container for the parameters to the BatchAssociateDataSegmentsToDataset operation.
    ...
    /// they belong to.
    /// </summary>
    public partial class BatchAssociateDataSegmentsToDatasetRequest : AmazonIoTSiteWiseRequest
    {
        private List<AssociateDataSegmentEntry> _associateDataSegmentEntries = AWSConfigs.InitializeCollections ? new List<AssociateDataSegmentEntry>() : null;
        private string _clientToken;
        private string _datasetId;
        private string _workspaceName;

        /// <summary>
        /// Gets and sets the property AssociateDataSegmentEntries. 
        /// <para>
        ...
        public List<AssociateDataSegmentEntry> AssociateDataSegmentEntries
        {
            get { return this._associateDataSegmentEntries; }
            set { this._associateDataSegmentEntries = value; }
        }

        // Check to see if AssociateDataSegmentEntries property is set
        internal bool IsSetAssociateDataSegmentEntries()
        {
            return this._associateDataSegmentEntries != null && (this._associateDataSegmentEntries.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
