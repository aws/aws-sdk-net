...
{
    /// <summary>
    /// Amazon IoTSiteWise endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IoTSiteWise service requests.
    /// Collects values for IoTSiteWiseEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IoTSiteWiseEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonIoTSiteWiseEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonIoTSiteWiseConfig)requestContext.ClientConfig;
            var result = new IoTSiteWiseEndpointParameters();
