...
namespace Amazon.SSMContacts.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonSSMContactsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSSMContactsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SSMContacts.
        /// </summary>
        public AmazonSSMContactsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSSMContactsAuthSchemeParameters
            {
    ...
    public class AmazonSSMContactsAuthSchemeResolver : IAuthSchemeResolver<AmazonSSMContactsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSSMContactsAuthSchemeParameters authParameters)
        {
