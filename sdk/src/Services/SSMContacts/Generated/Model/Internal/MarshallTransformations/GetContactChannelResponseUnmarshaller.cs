        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ActivationStatus", targetDepth))
                {
                    ...
                    response.ActivationStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ContactChannelArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DeliveryAddress", targetDepth))
                {
                    var unmarshaller = ContactChannelAddressUnmarshaller.Instance;
                    response.DeliveryAddress = unmarshaller.Unmarshall(context);
                    continue;
                }
