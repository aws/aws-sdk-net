...
{
    /// <summary>
    /// Response Unmarshaller for GetRotationOverride operation
    /// </summary>  
    public class GetRotationOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRotationOverrideResponse response = new GetRotationOverrideResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NewContactIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.NewContactIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RotationArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RotationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetRotationOverrideResponseUnmarshaller _instance = new GetRotationOverrideResponseUnmarshaller();        

        internal static GetRotationOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRotationOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
