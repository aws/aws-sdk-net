...
{
    /// <summary>
    /// UpdateRotation Request Marshaller
    /// </summary>       
    public class UpdateRotationRequestMarshaller : IMarshaller<IRequest, UpdateRotationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRotationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRotationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SSMContacts");
            string target = "SSMContacts.UpdateRotation";
        ...
        private static UpdateRotationRequestMarshaller _instance = new UpdateRotationRequestMarshaller();        

        internal static UpdateRotationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRotationRequestMarshaller Instance
        {
            get
            {
                return _instance;
