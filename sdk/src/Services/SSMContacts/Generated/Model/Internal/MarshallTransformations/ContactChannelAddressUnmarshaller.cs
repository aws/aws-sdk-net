...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactChannelAddressUnmarshaller : IJsonUnmarshaller<ContactChannelAddress, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContactChannelAddress Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
