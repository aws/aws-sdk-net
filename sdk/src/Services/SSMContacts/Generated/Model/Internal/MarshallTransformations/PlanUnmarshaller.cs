...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlanUnmarshaller : IJsonUnmarshaller<Plan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Plan Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("RotationIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.RotationIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Stages", targetDepth, ref reader))
                {
