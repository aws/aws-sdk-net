...
{
    /// <summary>
    /// MonthlySetting Marshaller
    /// </summary>
    public class MonthlySettingMarshaller : IRequestMarshaller<MonthlySetting, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(MonthlySetting requestObject, JsonMarshallerContext context)
        {
            ...
            {
                context.Writer.WritePropertyName("HandOffTime");
                context.Writer.WriteObjectStart();

                var marshaller = HandOffTimeMarshaller.Instance;
                marshaller.Marshall(requestObject.HandOffTime, context);
        ...
        /// </summary>
        public readonly static MonthlySettingMarshaller Instance = new MonthlySettingMarshaller();
