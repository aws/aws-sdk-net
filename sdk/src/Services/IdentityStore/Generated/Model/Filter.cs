...
namespace Amazon.IdentityStore.Model
{
    ...
    public partial class Filter
    {
        ...
        /// <para>
        /// The attribute path used to specify which attribute name to search. Length limit is
        /// 255 characters. For example, <code>UserName</code> is a valid attribute path for the
        /// <code>ListUsers</code> API, and <code>DisplayName</code> is a valid attribute path
        /// for the <code>ListGroups</code> API.
        /// </para>
        /// </summary>
