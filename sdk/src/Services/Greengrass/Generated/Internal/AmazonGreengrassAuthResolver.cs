...
namespace Amazon.Greengrass.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonGreengrassAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGreengrassAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Greengrass.
        /// </summary>
        public AmazonGreengrassAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGreengrassAuthSchemeParameters
            {
    ...
    public class AmazonGreengrassAuthSchemeResolver : IAuthSchemeResolver<AmazonGreengrassAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGreengrassAuthSchemeParameters authParameters)
        {
