...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("Greengrass", "4.0.0.0");

        private static readonly AmazonGreengrassEndpointResolver EndpointResolver =
            new AmazonGreengrassEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("Greengrass", "3.7.400.104");
=======
            InternalSDKUtils.BuildUserAgentString("Greengrass", "3.7.400.118");
