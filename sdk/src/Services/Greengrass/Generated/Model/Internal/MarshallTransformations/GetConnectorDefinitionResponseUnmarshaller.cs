...
{
    /// <summary>
    /// Response Unmarshaller for GetConnectorDefinition operation
    /// </summary>  
    public class GetConnectorDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConnectorDefinitionResponse response = new GetConnectorDefinitionResponse();
        ...
        private static GetConnectorDefinitionResponseUnmarshaller _instance = new GetConnectorDefinitionResponseUnmarshaller();        

        internal static GetConnectorDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectorDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
