...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    public class ListBulkDeploymentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("BulkDeployments", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BulkDeployment, BulkDeploymentUnmarshaller>(BulkDeploymentUnmarshaller.Instance);
                    response.BulkDeployments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
