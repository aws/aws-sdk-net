...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    public class TelemetryConfigurationUnmarshaller : IJsonUnmarshaller<TelemetryConfiguration, JsonUnmarshallerContext>
    {
        ...
        public TelemetryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ConfigurationSyncStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConfigurationSyncStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Telemetry", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static TelemetryConfigurationUnmarshaller _instance = new TelemetryConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TelemetryConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
