...
{
    /// <summary>
    /// Response Unmarshaller for GetSubscriptionDefinition operation
    /// </summary>  
    public class GetSubscriptionDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSubscriptionDefinitionResponse response = new GetSubscriptionDefinitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LatestVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LatestVersionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetSubscriptionDefinitionResponseUnmarshaller _instance = new GetSubscriptionDefinitionResponseUnmarshaller();        

        internal static GetSubscriptionDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubscriptionDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
