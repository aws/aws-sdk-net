...
{
    /// <summary>
    /// Response Unmarshaller for GetLoggerDefinition operation
    /// </summary>  
    public class GetLoggerDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLoggerDefinitionResponse response = new GetLoggerDefinitionResponse();
        ...
        private static GetLoggerDefinitionResponseUnmarshaller _instance = new GetLoggerDefinitionResponseUnmarshaller();        

        internal static GetLoggerDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoggerDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
