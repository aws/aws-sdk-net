...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3MachineLearningModelResourceDataUnmarshaller : IJsonUnmarshaller<S3MachineLearningModelResourceData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3MachineLearningModelResourceData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OwnerSetting", targetDepth, ref reader))
                {
                    var unmarshaller = ResourceDownloadOwnerSettingUnmarshaller.Instance;
                    unmarshalledObject.OwnerSetting = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
