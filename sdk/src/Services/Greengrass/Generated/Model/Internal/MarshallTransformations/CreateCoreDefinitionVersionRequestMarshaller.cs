...
{
    /// <summary>
    /// CreateCoreDefinitionVersion Request Marshaller
    /// </summary>       
    public class CreateCoreDefinitionVersionRequestMarshaller : IMarshaller<IRequest, CreateCoreDefinitionVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateCoreDefinitionVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateCoreDefinitionVersionRequest publicRequest)
        {
        ...
        private static CreateCoreDefinitionVersionRequestMarshaller _instance = new CreateCoreDefinitionVersionRequestMarshaller();        

        internal static CreateCoreDefinitionVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCoreDefinitionVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
