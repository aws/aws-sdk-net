...
{
    /// <summary>
    /// Response Unmarshaller for GetFunctionDefinition operation
    /// </summary>  
    public class GetFunctionDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFunctionDefinitionResponse response = new GetFunctionDefinitionResponse();
        ...
        private static GetFunctionDefinitionResponseUnmarshaller _instance = new GetFunctionDefinitionResponseUnmarshaller();        

        internal static GetFunctionDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFunctionDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
