...
{
    /// <summary>
    /// Response Unmarshaller for ListTypedLinkFacetNames operation
    /// </summary>  
    public class ListTypedLinkFacetNamesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTypedLinkFacetNamesResponse response = new ListTypedLinkFacetNamesResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("FacetNames", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.FacetNames = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListTypedLinkFacetNamesResponseUnmarshaller _instance = new ListTypedLinkFacetNamesResponseUnmarshaller();        

        internal static ListTypedLinkFacetNamesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTypedLinkFacetNamesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
