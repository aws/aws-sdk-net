...
{
    /// <summary>
    /// Response Unmarshaller for ListFacetNames operation
    /// </summary>  
    public class ListFacetNamesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFacetNamesResponse response = new ListFacetNamesResponse();
        ...
        private static ListFacetNamesResponseUnmarshaller _instance = new ListFacetNamesResponseUnmarshaller();        

        internal static ListFacetNamesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFacetNamesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
