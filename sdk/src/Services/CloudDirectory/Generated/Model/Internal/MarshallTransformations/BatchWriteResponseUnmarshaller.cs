...
{
    /// <summary>
    /// Response Unmarshaller for BatchWrite operation
    /// </summary>  
    public class BatchWriteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchWriteResponse response = new BatchWriteResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchWriteOperationResponse, BatchWriteOperationResponseUnmarshaller>(BatchWriteOperationResponseUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("BatchWriteException"))
            {
                return new BatchWriteException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static BatchWriteResponseUnmarshaller _instance = new BatchWriteResponseUnmarshaller();        

        internal static BatchWriteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchWriteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
