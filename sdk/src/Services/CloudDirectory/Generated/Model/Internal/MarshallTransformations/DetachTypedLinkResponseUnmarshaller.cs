...
{
    /// <summary>
    /// Response Unmarshaller for DetachTypedLink operation
    /// </summary>  
    public class DetachTypedLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachTypedLinkResponse response = new DetachTypedLinkResponse();
        ...
        private static DetachTypedLinkResponseUnmarshaller _instance = new DetachTypedLinkResponseUnmarshaller();        

        internal static DetachTypedLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachTypedLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
