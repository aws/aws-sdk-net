...
{
    /// <summary>
    /// Response Unmarshaller for ListObjectPolicies operation
    /// </summary>  
    public class ListObjectPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListObjectPoliciesResponse response = new ListObjectPoliciesResponse();
            ...
            {
                if (context.TestExpression("AttachedPolicyIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.AttachedPolicyIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListObjectPoliciesResponseUnmarshaller _instance = new ListObjectPoliciesResponseUnmarshaller();        

        internal static ListObjectPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListObjectPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
