...
{
    /// <summary>
    /// Response Unmarshaller for ListDirectories operation
    /// </summary>  
    public class ListDirectoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDirectoriesResponse response = new ListDirectoriesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Directories", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Directory, DirectoryUnmarshaller>(DirectoryUnmarshaller.Instance);
                    response.Directories = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDirectoriesResponseUnmarshaller _instance = new ListDirectoriesResponseUnmarshaller();        

        internal static ListDirectoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDirectoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
