    ...
    public class ListDirectoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Directory, DirectoryUnmarshaller>(DirectoryUnmarshaller.Instance);
                    response.Directories = unmarshaller.Unmarshall(context);
                    continue;
                }
