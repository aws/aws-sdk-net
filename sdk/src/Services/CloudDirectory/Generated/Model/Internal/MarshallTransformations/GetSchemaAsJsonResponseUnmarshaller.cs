...
{
    /// <summary>
    /// Response Unmarshaller for GetSchemaAsJson operation
    /// </summary>  
    public class GetSchemaAsJsonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSchemaAsJsonResponse response = new GetSchemaAsJsonResponse();
        ...
        private static GetSchemaAsJsonResponseUnmarshaller _instance = new GetSchemaAsJsonResponseUnmarshaller();        

        internal static GetSchemaAsJsonResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSchemaAsJsonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
