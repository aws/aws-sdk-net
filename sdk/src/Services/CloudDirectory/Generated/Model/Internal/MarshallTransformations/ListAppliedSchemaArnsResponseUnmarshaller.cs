...
{
    /// <summary>
    /// Response Unmarshaller for ListAppliedSchemaArns operation
    /// </summary>  
    public class ListAppliedSchemaArnsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAppliedSchemaArnsResponse response = new ListAppliedSchemaArnsResponse();
        ...
        private static ListAppliedSchemaArnsResponseUnmarshaller _instance = new ListAppliedSchemaArnsResponseUnmarshaller();        

        internal static ListAppliedSchemaArnsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAppliedSchemaArnsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
