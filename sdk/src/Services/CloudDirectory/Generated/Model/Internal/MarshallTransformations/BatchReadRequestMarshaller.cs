...
{
    /// <summary>
    /// BatchRead Request Marshaller
    /// </summary>       
    public class BatchReadRequestMarshaller : IMarshaller<IRequest, BatchReadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchReadRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchReadRequest publicRequest)
        {
            ...
            request.ResourcePath = "/amazonclouddirectory/2017-01-11/batchread";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetOperations())
            {
                ...
                foreach(var publicRequestOperationsListValue in publicRequest.Operations)
                {
                    ...
                    var marshaller = BatchReadOperationMarshaller.Instance;
