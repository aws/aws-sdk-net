...
{
    /// <summary>
    /// Response Unmarshaller for DetachPolicy operation
    /// </summary>  
    public class DetachPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachPolicyResponse response = new DetachPolicyResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return NotPolicyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DetachPolicyResponseUnmarshaller _instance = new DetachPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
