...
{
    /// <summary>
    /// Response Unmarshaller for ListDevelopmentSchemaArns operation
    /// </summary>  
    public class ListDevelopmentSchemaArnsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDevelopmentSchemaArnsResponse response = new ListDevelopmentSchemaArnsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SchemaArns", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.SchemaArns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListDevelopmentSchemaArnsResponseUnmarshaller _instance = new ListDevelopmentSchemaArnsResponseUnmarshaller();        

        internal static ListDevelopmentSchemaArnsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDevelopmentSchemaArnsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
