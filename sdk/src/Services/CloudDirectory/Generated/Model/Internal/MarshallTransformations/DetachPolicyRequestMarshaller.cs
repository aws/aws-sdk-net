...
{
    /// <summary>
    /// DetachPolicy Request Marshaller
    /// </summary>       
    public class DetachPolicyRequestMarshaller : IMarshaller<IRequest, DetachPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetachPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetachPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/amazonclouddirectory/2017-01-11/policy/detach";
#if !NETFRAMEWORK
        ...
        private static DetachPolicyRequestMarshaller _instance = new DetachPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
