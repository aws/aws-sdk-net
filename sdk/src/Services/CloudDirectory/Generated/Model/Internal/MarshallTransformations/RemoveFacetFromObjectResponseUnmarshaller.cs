...
{
    /// <summary>
    /// Response Unmarshaller for RemoveFacetFromObject operation
    /// </summary>  
    public class RemoveFacetFromObjectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveFacetFromObjectResponse response = new RemoveFacetFromObjectResponse();
        ...
        private static RemoveFacetFromObjectResponseUnmarshaller _instance = new RemoveFacetFromObjectResponseUnmarshaller();        

        internal static RemoveFacetFromObjectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveFacetFromObjectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
