...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class DirectoryAlreadyExistsException : AmazonCloudDirectoryException
    {
        ...
        /// <summary>
        /// Default constructor for DirectoryAlreadyExistsException
        /// message.
        /// </summary>
        ...
        public DirectoryAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DirectoryAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
