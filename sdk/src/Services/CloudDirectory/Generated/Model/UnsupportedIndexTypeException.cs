...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class UnsupportedIndexTypeException : AmazonCloudDirectoryException
    {
        ...
        public UnsupportedIndexTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedIndexTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
