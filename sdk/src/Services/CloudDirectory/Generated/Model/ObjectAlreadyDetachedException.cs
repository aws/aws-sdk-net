...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class ObjectAlreadyDetachedException : AmazonCloudDirectoryException
    {
        ...
        public ObjectAlreadyDetachedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ObjectAlreadyDetachedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
