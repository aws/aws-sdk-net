...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class ObjectNotDetachedException : AmazonCloudDirectoryException
    {
        ...
        public ObjectNotDetachedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ObjectNotDetachedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
