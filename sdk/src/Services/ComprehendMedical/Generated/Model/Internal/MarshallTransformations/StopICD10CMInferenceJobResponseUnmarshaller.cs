...
{
    /// <summary>
    /// Response Unmarshaller for StopICD10CMInferenceJob operation
    /// </summary>  
    public class StopICD10CMInferenceJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopICD10CMInferenceJobResponse response = new StopICD10CMInferenceJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopICD10CMInferenceJob");
            reader.ReadStartMap();
        ...
        private static StopICD10CMInferenceJobResponseUnmarshaller _instance = new StopICD10CMInferenceJobResponseUnmarshaller();        

        internal static StopICD10CMInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopICD10CMInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
