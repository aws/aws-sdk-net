...
{
    /// <summary>
    /// Response Unmarshaller for DescribePHIDetectionJob operation
    /// </summary>  
    public class DescribePHIDetectionJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePHIDetectionJobResponse response = new DescribePHIDetectionJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribePHIDetectionJob");
            reader.ReadStartMap();
        ...
        private static DescribePHIDetectionJobResponseUnmarshaller _instance = new DescribePHIDetectionJobResponseUnmarshaller();        

        internal static DescribePHIDetectionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePHIDetectionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
