...
{
    /// <summary>
    /// Response Unmarshaller for StartRxNormInferenceJob operation
    /// </summary>  
    public class StartRxNormInferenceJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRxNormInferenceJobResponse response = new StartRxNormInferenceJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("StartRxNormInferenceJob");
            reader.ReadStartMap();
        ...
        private static StartRxNormInferenceJobResponseUnmarshaller _instance = new StartRxNormInferenceJobResponseUnmarshaller();        

        internal static StartRxNormInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRxNormInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
