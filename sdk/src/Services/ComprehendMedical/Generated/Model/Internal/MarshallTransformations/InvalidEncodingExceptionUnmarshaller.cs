...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidEncodingExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidEncodingException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidEncodingException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public InvalidEncodingException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
