...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidRequestExceptionUnmarshaller : ICborErrorResponseUnmarshaller<InvalidRequestException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidRequestException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidRequestException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("InvalidRequestException");
            reader.ReadStartMap();
