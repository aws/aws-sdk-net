...
{
    /// <summary>
    /// Response Unmarshaller for StopPHIDetectionJob operation
    /// </summary>  
    public class StopPHIDetectionJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopPHIDetectionJobResponse response = new StopPHIDetectionJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopPHIDetectionJob");
            reader.ReadStartMap();
        ...
        private static StopPHIDetectionJobResponseUnmarshaller _instance = new StopPHIDetectionJobResponseUnmarshaller();        

        internal static StopPHIDetectionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopPHIDetectionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
