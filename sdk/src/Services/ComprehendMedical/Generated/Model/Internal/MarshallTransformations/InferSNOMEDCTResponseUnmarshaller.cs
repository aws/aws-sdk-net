...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferSNOMEDCTResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("InferSNOMEDCT");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Characters":
                        {
                            context.AddPathSegment("Characters");
                            var unmarshaller = CharactersUnmarshaller.Instance;
                            response.Characters = unmarshaller.Unmarshall(context);
                    ...
                    case "Entities":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<SNOMEDCTEntity, SNOMEDCTEntityUnmarshaller>(SNOMEDCTEntityUnmarshaller.Instance);
                    ...
                    case "SNOMEDCTDetails":
                        {
                            context.AddPathSegment("SNOMEDCTDetails");
                            var unmarshaller = SNOMEDCTDetailsUnmarshaller.Instance;
                            response.SNOMEDCTDetails = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
