...
{
    /// <summary>
    /// Response Unmarshaller for StartICD10CMInferenceJob operation
    /// </summary>  
    public class StartICD10CMInferenceJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartICD10CMInferenceJobResponse response = new StartICD10CMInferenceJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("StartICD10CMInferenceJob");
            reader.ReadStartMap();
        ...
        private static StartICD10CMInferenceJobResponseUnmarshaller _instance = new StartICD10CMInferenceJobResponseUnmarshaller();        

        internal static StartICD10CMInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartICD10CMInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
