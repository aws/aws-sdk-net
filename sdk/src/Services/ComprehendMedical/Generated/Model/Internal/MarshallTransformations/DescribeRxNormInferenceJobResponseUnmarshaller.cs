...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeRxNormInferenceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ComprehendMedicalAsyncJobProperties", targetDepth))
                {
                    ...
                    response.ComprehendMedicalAsyncJobProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
