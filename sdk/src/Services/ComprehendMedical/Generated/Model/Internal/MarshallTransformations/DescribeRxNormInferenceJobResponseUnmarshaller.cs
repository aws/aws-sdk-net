...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRxNormInferenceJob operation
    /// </summary>  
    public class DescribeRxNormInferenceJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRxNormInferenceJobResponse response = new DescribeRxNormInferenceJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeRxNormInferenceJob");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ComprehendMedicalAsyncJobProperties":
                        {
                            context.AddPathSegment("ComprehendMedicalAsyncJobProperties");
        ...
        private static DescribeRxNormInferenceJobResponseUnmarshaller _instance = new DescribeRxNormInferenceJobResponseUnmarshaller();        

        internal static DescribeRxNormInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRxNormInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
