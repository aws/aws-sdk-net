...
{
    /// <summary>
    /// StartPHIDetectionJob Request Marshaller
    /// </summary>       
    public class StartPHIDetectionJobRequestMarshaller : IMarshaller<IRequest, StartPHIDetectionJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartPHIDetectionJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartPHIDetectionJobRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComprehendMedical");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/ComprehendMedical_20181030/operation/StartPHIDetectionJob";
        ...
        private static StartPHIDetectionJobRequestMarshaller _instance = new StartPHIDetectionJobRequestMarshaller();        

        internal static StartPHIDetectionJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPHIDetectionJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
