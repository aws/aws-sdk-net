...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttributeUnmarshaller : ICborUnmarshaller<Attribute, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Attribute Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "RelationshipType":
                        {
                            context.AddPathSegment("RelationshipType");
                            var unmarshaller = CborStringUnmarshaller.Instance;
