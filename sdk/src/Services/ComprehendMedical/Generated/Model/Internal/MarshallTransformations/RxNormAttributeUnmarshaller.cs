...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RxNormAttributeUnmarshaller : ICborUnmarshaller<RxNormAttribute, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RxNormAttribute Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "RelationshipScore":
                        {
                            context.AddPathSegment("RelationshipScore");
                    ...
                    case "Traits":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<RxNormTrait, RxNormTraitUnmarshaller>(RxNormTraitUnmarshaller.Instance);
