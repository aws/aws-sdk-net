...
{
    /// <summary>
    /// Response Unmarshaller for StopRxNormInferenceJob operation
    /// </summary>  
    public class StopRxNormInferenceJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopRxNormInferenceJobResponse response = new StopRxNormInferenceJobResponse();
            var reader = context.Reader;
            context.AddPathSegment("StopRxNormInferenceJob");
            reader.ReadStartMap();
        ...
        private static StopRxNormInferenceJobResponseUnmarshaller _instance = new StopRxNormInferenceJobResponseUnmarshaller();        

        internal static StopRxNormInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopRxNormInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
