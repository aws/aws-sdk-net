...
namespace Amazon.ComprehendMedical.Model
{
    ...
    public partial class InvalidEncodingException : AmazonComprehendMedicalException
    {
        ...
        public InvalidEncodingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidEncodingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
