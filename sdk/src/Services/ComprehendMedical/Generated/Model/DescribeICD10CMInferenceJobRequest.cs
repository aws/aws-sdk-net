...
{
    /// <summary>
    /// Container for the parameters to the DescribeICD10CMInferenceJob operation.
    /// Gets the properties associated with an InferICD10CM job. Use this operation to get
    /// the status of an inference job.
    /// </summary>
    public partial class DescribeICD10CMInferenceJobRequest : AmazonComprehendMedicalRequest
    {
