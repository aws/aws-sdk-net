...
{
    /// <summary>
    /// <para>Implementation for accessing CodeStar</para>
    ///
    /// AWS CodeStar 
    /// <para>
    ...
    public partial class AmazonCodeStarClient : AmazonServiceClient, IAmazonCodeStar
    {
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonCodeStarEndpointResolver());
        }    
        /// <summary>
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonCodeStarEndpointResolver();
