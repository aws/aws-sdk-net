...
namespace Amazon.CodeStar.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListResourcesResponseUnmarshaller _instance = new ListResourcesResponseUnmarshaller();        

        internal static ListResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
