...
{
    /// <summary>
    /// Response Unmarshaller for ListTeamMembers operation
    /// </summary>  
    public class ListTeamMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTeamMembersResponse response = new ListTeamMembersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TeamMember, TeamMemberUnmarshaller>(TeamMemberUnmarshaller.Instance);
                    response.TeamMembers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListTeamMembersResponseUnmarshaller _instance = new ListTeamMembersResponseUnmarshaller();        

        internal static ListTeamMembersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTeamMembersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
