...
namespace Amazon.CodeStar.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeUserProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("UserProfileNotFoundException"))
                {
                    return UserProfileNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            ...
            return new AmazonCodeStarException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }
