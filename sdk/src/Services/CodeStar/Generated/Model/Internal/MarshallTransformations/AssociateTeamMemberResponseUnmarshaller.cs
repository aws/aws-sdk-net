...
namespace Amazon.CodeStar.Model.Internal.MarshallTransformations
{
    ...
    public class AssociateTeamMemberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new TeamMemberAlreadyAssociatedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
