...
namespace Amazon.CodeStar.Model
{
    ...
    public partial class TeamMemberAlreadyAssociatedException : AmazonCodeStarException
    {
        ...
        public TeamMemberAlreadyAssociatedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TeamMemberAlreadyAssociatedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
