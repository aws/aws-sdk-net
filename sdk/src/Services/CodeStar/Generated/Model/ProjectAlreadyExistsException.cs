...
namespace Amazon.CodeStar.Model
{
    ...
    public partial class ProjectAlreadyExistsException : AmazonCodeStarException
    {
        ...
        public ProjectAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ProjectAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
