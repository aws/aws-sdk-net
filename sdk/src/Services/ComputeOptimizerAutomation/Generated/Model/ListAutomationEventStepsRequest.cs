...
{
    /// <summary>
    /// Container for the parameters to the ListAutomationEventSteps operation.
    /// Lists the steps for a specific automation event. You can only list steps for events
    /// created within the past year.
    /// </summary>
    public partial class ListAutomationEventStepsRequest : AmazonComputeOptimizerAutomationRequest
    {
        ...
        /// <para>
        /// The maximum number of automation event steps to return in a single response. Valid
        /// range is 1-1000.
        /// </para>
        /// </summary>
