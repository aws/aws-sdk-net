...
{
    /// <summary>
    /// Container for the parameters to the ListRecommendedActions operation.
    ...
    ///  </note>
    /// </summary>
    public partial class ListRecommendedActionsRequest : AmazonComputeOptimizerAutomationRequest
    {
        private List<RecommendedActionFilter> _filters = AWSConfigs.InitializeCollections ? new List<RecommendedActionFilter>() : null;
        ...
        /// </para>
        /// </summary>
        public List<RecommendedActionFilter> Filters
        {
        ...
        /// <para>
        /// The maximum number of recommended actions to return in a single response. Valid range
        /// is 1-1000.
        /// </para>
        /// </summary>
