...
namespace Amazon.ComputeOptimizerAutomation.Model
{
    ...
    /// </summary>
    public partial class SummaryTotals
    {
        private int? _automationEventCount;
        private EstimatedMonthlySavings _estimatedMonthlySavings;

        /// <summary>
        /// Gets and sets the property AutomationEventCount. 
        /// <para>
        ...
        {
            get { return this._automationEventCount.GetValueOrDefault(); }
            set { this._automationEventCount = value; }
        }

        // Check to see if AutomationEventCount property is set
        internal bool IsSetAutomationEventCount()
        {
            return this._automationEventCount.HasValue; 
        }
