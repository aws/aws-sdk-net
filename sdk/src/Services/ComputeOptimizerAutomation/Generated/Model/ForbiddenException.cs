...
namespace Amazon.ComputeOptimizerAutomation.Model
{
    ...
    [Serializable]
    #endif
    public partial class ForbiddenException : AmazonComputeOptimizerAutomationException
    {
        ...
        public ForbiddenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ForbiddenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
