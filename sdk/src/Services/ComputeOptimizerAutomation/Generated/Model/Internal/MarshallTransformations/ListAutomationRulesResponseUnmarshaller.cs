...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    public class ListAutomationRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("automationRules", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationRule, AutomationRuleUnmarshaller>(AutomationRuleUnmarshaller.Instance);
                    response.AutomationRules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
