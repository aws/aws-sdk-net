...
{
    /// <summary>
    /// AssociateAccounts Request Marshaller
    /// </summary>       
    public class AssociateAccountsRequestMarshaller : IMarshaller<IRequest, AssociateAccountsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateAccountsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateAccountsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizerAutomation");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/ComputeOptimizerAutomationService/operation/AssociateAccounts";
        ...
        private static AssociateAccountsRequestMarshaller _instance = new AssociateAccountsRequestMarshaller();        

        internal static AssociateAccountsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAccountsRequestMarshaller Instance
        {
            get
            {
                return _instance;
