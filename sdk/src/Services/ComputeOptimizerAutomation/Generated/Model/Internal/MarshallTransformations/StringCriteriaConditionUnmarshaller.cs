...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StringCriteriaConditionUnmarshaller : IUnmarshaller<StringCriteriaCondition, XmlUnmarshallerContext>, IUnmarshaller<StringCriteriaCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        StringCriteriaCondition IUnmarshaller<StringCriteriaCondition, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public StringCriteriaCondition Unmarshall(JsonUnmarshallerContext context)
        {
