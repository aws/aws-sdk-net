...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecommendedActionTotalUnmarshaller : IUnmarshaller<RecommendedActionTotal, XmlUnmarshallerContext>, IUnmarshaller<RecommendedActionTotal, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RecommendedActionTotal IUnmarshaller<RecommendedActionTotal, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RecommendedActionTotal Unmarshall(JsonUnmarshallerContext context)
        {
        ...
        private static RecommendedActionTotalUnmarshaller _instance = new RecommendedActionTotalUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RecommendedActionTotalUnmarshaller Instance
        {
            get
            {
                return _instance;
