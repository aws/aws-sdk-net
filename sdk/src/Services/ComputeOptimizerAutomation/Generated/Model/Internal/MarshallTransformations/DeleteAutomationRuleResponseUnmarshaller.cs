...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAutomationRule operation
    /// </summary>  
    public class DeleteAutomationRuleResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAutomationRuleResponse response = new DeleteAutomationRuleResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteAutomationRule");
        ...
        private static DeleteAutomationRuleResponseUnmarshaller _instance = new DeleteAutomationRuleResponseUnmarshaller();        

        internal static DeleteAutomationRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAutomationRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
