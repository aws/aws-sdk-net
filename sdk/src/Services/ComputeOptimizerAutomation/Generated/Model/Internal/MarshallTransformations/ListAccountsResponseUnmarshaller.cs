...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAccountsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListAccounts");
            reader.ReadStartMap();
                    ...
                    case "accounts":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<AccountInfo, AccountInfoUnmarshaller>(AccountInfoUnmarshaller.Instance);
