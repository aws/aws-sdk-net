...
{
    /// <summary>
    /// Response Unmarshaller for GetEnrollmentConfiguration operation
    /// </summary>  
    public class GetEnrollmentConfigurationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEnrollmentConfigurationResponse response = new GetEnrollmentConfigurationResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetEnrollmentConfiguration");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "organizationRuleMode":
                        {
                            context.AddPathSegment("OrganizationRuleMode");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.OrganizationRuleMode = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "status":
        ...
        private static GetEnrollmentConfigurationResponseUnmarshaller _instance = new GetEnrollmentConfigurationResponseUnmarshaller();        

        internal static GetEnrollmentConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEnrollmentConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
