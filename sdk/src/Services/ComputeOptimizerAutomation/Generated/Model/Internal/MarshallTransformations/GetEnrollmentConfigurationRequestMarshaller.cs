...
{
    /// <summary>
    /// GetEnrollmentConfiguration Request Marshaller
    /// </summary>       
    public class GetEnrollmentConfigurationRequestMarshaller : IMarshaller<IRequest, GetEnrollmentConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEnrollmentConfigurationRequest)input);
        }
        ...
        internal static GetEnrollmentConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEnrollmentConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
