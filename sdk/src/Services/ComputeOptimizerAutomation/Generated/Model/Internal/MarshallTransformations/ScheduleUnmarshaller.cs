...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduleUnmarshaller : ICborUnmarshaller<Schedule, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Schedule Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "executionWindowInMinutes":
                        {
                            context.AddPathSegment("ExecutionWindowInMinutes");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            unmarshalledObject.ExecutionWindowInMinutes = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "scheduleExpression":
                        {
                            context.AddPathSegment("ScheduleExpression");
                    ...
                    case "scheduleExpressionTimezone":
                        {
                            context.AddPathSegment("ScheduleExpressionTimezone");
                            var unmarshaller = CborStringUnmarshaller.Instance;
