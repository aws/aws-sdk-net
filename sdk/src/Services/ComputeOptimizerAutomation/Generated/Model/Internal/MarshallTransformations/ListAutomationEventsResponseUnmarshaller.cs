...
{
    /// <summary>
    /// Response Unmarshaller for ListAutomationEvents operation
    /// </summary>  
    public class ListAutomationEventsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAutomationEventsResponse response = new ListAutomationEventsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAutomationEvents");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "automationEvents":
                        {
                            context.AddPathSegment("AutomationEvents");
                            var unmarshaller = new CborListUnmarshaller<AutomationEvent, AutomationEventUnmarshaller>(AutomationEventUnmarshaller.Instance);
                            response.AutomationEvents = unmarshaller.Unmarshall(context);
        ...
        private static ListAutomationEventsResponseUnmarshaller _instance = new ListAutomationEventsResponseUnmarshaller();        

        internal static ListAutomationEventsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
