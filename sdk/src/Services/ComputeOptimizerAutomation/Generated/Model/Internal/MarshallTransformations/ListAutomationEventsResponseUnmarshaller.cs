...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAutomationEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("automationEvents", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationEvent, AutomationEventUnmarshaller>(AutomationEventUnmarshaller.Instance);
                    response.AutomationEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
