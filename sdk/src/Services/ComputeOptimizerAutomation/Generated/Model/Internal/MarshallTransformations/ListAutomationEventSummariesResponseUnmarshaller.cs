...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAutomationEventSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("automationEventSummaries", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationEventSummary, AutomationEventSummaryUnmarshaller>(AutomationEventSummaryUnmarshaller.Instance);
                    response.AutomationEventSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
