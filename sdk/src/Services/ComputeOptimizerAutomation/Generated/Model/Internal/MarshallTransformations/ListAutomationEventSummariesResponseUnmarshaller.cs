...
{
    /// <summary>
    /// Response Unmarshaller for ListAutomationEventSummaries operation
    /// </summary>  
    public class ListAutomationEventSummariesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAutomationEventSummariesResponse response = new ListAutomationEventSummariesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAutomationEventSummaries");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "automationEventSummaries":
                        {
                            context.AddPathSegment("AutomationEventSummaries");
                            var unmarshaller = new CborListUnmarshaller<AutomationEventSummary, AutomationEventSummaryUnmarshaller>(AutomationEventSummaryUnmarshaller.Instance);
                            response.AutomationEventSummaries = unmarshaller.Unmarshall(context);
        ...
        private static ListAutomationEventSummariesResponseUnmarshaller _instance = new ListAutomationEventSummariesResponseUnmarshaller();        

        internal static ListAutomationEventSummariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationEventSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
