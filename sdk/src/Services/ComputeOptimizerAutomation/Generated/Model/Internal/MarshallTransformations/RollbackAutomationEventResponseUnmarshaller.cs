...
{
    /// <summary>
    /// Response Unmarshaller for RollbackAutomationEvent operation
    /// </summary>  
    public class RollbackAutomationEventResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RollbackAutomationEventResponse response = new RollbackAutomationEventResponse();
            var reader = context.Reader;
            context.AddPathSegment("RollbackAutomationEvent");
            reader.ReadStartMap();
        ...
        private static RollbackAutomationEventResponseUnmarshaller _instance = new RollbackAutomationEventResponseUnmarshaller();        

        internal static RollbackAutomationEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RollbackAutomationEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
