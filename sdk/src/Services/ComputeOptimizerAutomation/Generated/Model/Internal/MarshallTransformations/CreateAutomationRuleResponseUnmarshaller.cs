...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAutomationRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("recommendedActionTypes", targetDepth))
                {
                    ...
                    response.RecommendedActionTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ruleRevision", targetDepth))
                {
                    ...
                    response.RuleRevision = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ruleType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RuleType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
