...
{
    /// <summary>
    /// Response Unmarshaller for ListAutomationRulePreview operation
    /// </summary>  
    public class ListAutomationRulePreviewResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAutomationRulePreviewResponse response = new ListAutomationRulePreviewResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAutomationRulePreview");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "previewResults":
                        {
                            context.AddPathSegment("PreviewResults");
                            var unmarshaller = new CborListUnmarshaller<PreviewResult, PreviewResultUnmarshaller>(PreviewResultUnmarshaller.Instance);
                            response.PreviewResults = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static ListAutomationRulePreviewResponseUnmarshaller _instance = new ListAutomationRulePreviewResponseUnmarshaller();        

        internal static ListAutomationRulePreviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationRulePreviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
