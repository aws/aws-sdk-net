...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAutomationRulePreviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PreviewResult, PreviewResultUnmarshaller>(PreviewResultUnmarshaller.Instance);
                    response.PreviewResults = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
