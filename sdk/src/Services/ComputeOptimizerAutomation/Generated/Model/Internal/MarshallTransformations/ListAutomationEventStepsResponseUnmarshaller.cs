...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAutomationEventStepsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("automationEventSteps", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationEventStep, AutomationEventStepUnmarshaller>(AutomationEventStepUnmarshaller.Instance);
                    response.AutomationEventSteps = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
