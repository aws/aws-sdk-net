...
{
    /// <summary>
    /// Response Unmarshaller for ListAutomationEventSteps operation
    /// </summary>  
    public class ListAutomationEventStepsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAutomationEventStepsResponse response = new ListAutomationEventStepsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAutomationEventSteps");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "automationEventSteps":
                        {
                            context.AddPathSegment("AutomationEventSteps");
                            var unmarshaller = new CborListUnmarshaller<AutomationEventStep, AutomationEventStepUnmarshaller>(AutomationEventStepUnmarshaller.Instance);
                            response.AutomationEventSteps = unmarshaller.Unmarshall(context);
        ...
        private static ListAutomationEventStepsResponseUnmarshaller _instance = new ListAutomationEventStepsResponseUnmarshaller();        

        internal static ListAutomationEventStepsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationEventStepsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
