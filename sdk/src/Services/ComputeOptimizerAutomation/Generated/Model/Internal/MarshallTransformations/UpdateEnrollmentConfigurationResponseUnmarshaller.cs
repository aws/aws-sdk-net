...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEnrollmentConfiguration operation
    /// </summary>  
    public class UpdateEnrollmentConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEnrollmentConfigurationResponse response = new UpdateEnrollmentConfigurationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return IdempotencyTokenInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NotManagementAccountException"))
                {
                    return NotManagementAccountExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateEnrollmentConfigurationResponseUnmarshaller _instance = new UpdateEnrollmentConfigurationResponseUnmarshaller();        

        internal static UpdateEnrollmentConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEnrollmentConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
