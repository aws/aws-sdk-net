...
{
    /// <summary>
    /// ListAutomationRulePreview Request Marshaller
    /// </summary>       
    public class ListAutomationRulePreviewRequestMarshaller : IMarshaller<IRequest, ListAutomationRulePreviewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAutomationRulePreviewRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAutomationRulePreviewRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizerAutomation");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/ComputeOptimizerAutomationService/operation/ListAutomationRulePreview";
        ...
        private static ListAutomationRulePreviewRequestMarshaller _instance = new ListAutomationRulePreviewRequestMarshaller();        

        internal static ListAutomationRulePreviewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationRulePreviewRequestMarshaller Instance
        {
            get
            {
                return _instance;
