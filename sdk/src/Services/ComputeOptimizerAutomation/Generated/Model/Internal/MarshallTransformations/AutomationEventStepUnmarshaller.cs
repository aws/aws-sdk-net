...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomationEventStepUnmarshaller : IUnmarshaller<AutomationEventStep, XmlUnmarshallerContext>, IUnmarshaller<AutomationEventStep, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutomationEventStep IUnmarshaller<AutomationEventStep, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutomationEventStep Unmarshall(JsonUnmarshallerContext context)
        {
