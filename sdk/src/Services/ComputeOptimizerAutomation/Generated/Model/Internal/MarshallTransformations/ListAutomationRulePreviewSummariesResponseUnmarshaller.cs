...
{
    /// <summary>
    /// Response Unmarshaller for ListAutomationRulePreviewSummaries operation
    /// </summary>  
    public class ListAutomationRulePreviewSummariesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAutomationRulePreviewSummariesResponse response = new ListAutomationRulePreviewSummariesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAutomationRulePreviewSummaries");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "previewResultSummaries":
                        {
                            context.AddPathSegment("PreviewResultSummaries");
                            var unmarshaller = new CborListUnmarshaller<PreviewResultSummary, PreviewResultSummaryUnmarshaller>(PreviewResultSummaryUnmarshaller.Instance);
                            response.PreviewResultSummaries = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static ListAutomationRulePreviewSummariesResponseUnmarshaller _instance = new ListAutomationRulePreviewSummariesResponseUnmarshaller();        

        internal static ListAutomationRulePreviewSummariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAutomationRulePreviewSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
