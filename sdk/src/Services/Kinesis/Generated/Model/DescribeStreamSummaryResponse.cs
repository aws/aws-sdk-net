...
namespace Amazon.Kinesis.Model
{
    ...
    /// </summary>
    public partial class DescribeStreamSummaryResponse : AmazonWebServiceResponse
    {
        ...
        public StreamDescriptionSummary StreamDescriptionSummary
        {
            ...
            set { this._streamDescriptionSummary = value; }
        }

        // Check to see if StreamDescriptionSummary property is set
        internal bool IsSetStreamDescriptionSummary()
        {
            return this._streamDescriptionSummary != null;
        }
