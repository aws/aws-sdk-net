...
namespace Amazon.Kinesis.Model
{
    ...
    /// </summary>
    public partial class StreamModeDetails
    {
        ...
        {
            get { return this._streamMode; }
            set { this._streamMode = value; }
        }

        // Check to see if StreamMode property is set
        internal bool IsSetStreamMode()
        {
            return this._streamMode != null;
        }
