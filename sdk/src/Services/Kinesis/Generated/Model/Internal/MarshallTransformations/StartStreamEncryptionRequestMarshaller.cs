...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartStreamEncryptionRequestMarshaller : IMarshaller<IRequest, StartStreamEncryptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartStreamEncryptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartStreamEncryptionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kinesis");
            string target = "Kinesis_20131202.StartStreamEncryption";
        ...
        private static StartStreamEncryptionRequestMarshaller _instance = new StartStreamEncryptionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartStreamEncryptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
