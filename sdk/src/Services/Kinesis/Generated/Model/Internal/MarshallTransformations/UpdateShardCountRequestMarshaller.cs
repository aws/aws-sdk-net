...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateShardCountRequestMarshaller : IMarshaller<IRequest, UpdateShardCountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateShardCountRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateShardCountRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetScalingType())
            {
                context.Writer.WritePropertyName("ScalingType");
                context.Writer.WriteStringValue(publicRequest.ScalingType);
            }
            ...
            if(publicRequest.IsSetTargetShardCount())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.TargetShardCount.Value);
            }
        ...
        private static UpdateShardCountRequestMarshaller _instance = new UpdateShardCountRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateShardCountRequestMarshaller Instance
        {
            get
            {
                return _instance;
