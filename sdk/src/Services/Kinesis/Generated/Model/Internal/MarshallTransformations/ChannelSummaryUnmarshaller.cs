    ...
    public class ChannelSummaryUnmarshaller : IJsonUnmarshaller<ChannelSummary, JsonUnmarshallerContext>
    {
        ...
        public ChannelSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ChannelDestinationType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ChannelDestinationType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelStreamIdentifier, ChannelStreamIdentifierUnmarshaller>(ChannelStreamIdentifierUnmarshaller.Instance);
