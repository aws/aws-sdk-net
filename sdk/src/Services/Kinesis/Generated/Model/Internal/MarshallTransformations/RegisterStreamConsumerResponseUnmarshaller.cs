...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterStreamConsumerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterStreamConsumerResponse response = new RegisterStreamConsumerResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Consumer", targetDepth, ref reader))
                {
                    var unmarshaller = ConsumerUnmarshaller.Instance;
                    response.Consumer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RegisterStreamConsumerResponseUnmarshaller _instance = new RegisterStreamConsumerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterStreamConsumerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
