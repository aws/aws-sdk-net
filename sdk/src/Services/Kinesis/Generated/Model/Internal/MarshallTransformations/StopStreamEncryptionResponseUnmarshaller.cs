...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopStreamEncryptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopStreamEncryptionResponse response = new StopStreamEncryptionResponse();
        ...
        private static StopStreamEncryptionResponseUnmarshaller _instance = new StopStreamEncryptionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopStreamEncryptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
