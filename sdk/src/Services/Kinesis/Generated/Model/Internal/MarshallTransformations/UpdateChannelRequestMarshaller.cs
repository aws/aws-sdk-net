...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateChannelRequestMarshaller : IMarshaller<IRequest, UpdateChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateChannelRequest publicRequest)
        {
            ...
            string target = "Kinesis_20131202.UpdateChannel";
            ...
            if(publicRequest.IsSetLoggingConfiguration())
            {
                ...
                var marshaller = ChannelLoggingUpdateInputMarshaller.Instance;
            ...
            if(publicRequest.IsSetS3DestinationConfiguration())
            {
                ...
                var marshaller = S3DestinationUpdateInputMarshaller.Instance;
            ...
            if(publicRequest.IsSetS3TablesDestinationConfiguration())
            {
                ...
                var marshaller = S3TablesDestinationUpdateInputMarshaller.Instance;
