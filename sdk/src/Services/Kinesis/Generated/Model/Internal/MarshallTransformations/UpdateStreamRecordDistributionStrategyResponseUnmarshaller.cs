...
{
    /// <summary>
    /// Response Unmarshaller for UpdateStreamRecordDistributionStrategy operation
    /// </summary>  
    public class UpdateStreamRecordDistributionStrategyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateStreamRecordDistributionStrategyResponse response = new UpdateStreamRecordDistributionStrategyResponse();
        ...
        private static UpdateStreamRecordDistributionStrategyResponseUnmarshaller _instance = new UpdateStreamRecordDistributionStrategyResponseUnmarshaller();        

        internal static UpdateStreamRecordDistributionStrategyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStreamRecordDistributionStrategyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
