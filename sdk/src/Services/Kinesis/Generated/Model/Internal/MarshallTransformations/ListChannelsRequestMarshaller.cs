...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    public class ListChannelsRequestMarshaller : IMarshaller<IRequest, ListChannelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListChannelsRequest publicRequest)
        {
            ...
            string target = "Kinesis_20131202.ListChannels";
            ...
            if(publicRequest.IsSetStreamFilter())
            {
                context.Writer.WritePropertyName("StreamFilter");
                context.Writer.WriteStartArray();
                foreach(var publicRequestStreamFilterListValue in publicRequest.StreamFilter)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = StreamFilterMarshaller.Instance;
                    marshaller.Marshall(publicRequestStreamFilterListValue, context);
