...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMaxRecordSize operation
    /// </summary>  
    public class UpdateMaxRecordSizeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMaxRecordSizeResponse response = new UpdateMaxRecordSizeResponse();
        ...
        private static UpdateMaxRecordSizeResponseUnmarshaller _instance = new UpdateMaxRecordSizeResponseUnmarshaller();        

        internal static UpdateMaxRecordSizeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMaxRecordSizeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
