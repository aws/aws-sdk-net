...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeregisterStreamConsumerRequestMarshaller : IMarshaller<IRequest, DeregisterStreamConsumerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeregisterStreamConsumerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeregisterStreamConsumerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kinesis");
            string target = "Kinesis_20131202.DeregisterStreamConsumer";
            ...
            if(publicRequest.IsSetConsumerARN())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ConsumerARN);
            }
        ...
        private static DeregisterStreamConsumerRequestMarshaller _instance = new DeregisterStreamConsumerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterStreamConsumerRequestMarshaller Instance
        {
            get
            {
                return _instance;
