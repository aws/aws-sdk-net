...
{
    /// <summary>
    /// S3StorageConfiguration Marshaller
    /// </summary>
    public class S3StorageConfigurationMarshaller : IRequestMarshaller<S3StorageConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(S3StorageConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetOutputKeyTemplate())
            {
                context.Writer.WritePropertyName("OutputKeyTemplate");
                context.Writer.WriteStringValue(requestObject.OutputKeyTemplate);
            }
        ...
        /// </summary>
        public readonly static S3StorageConfigurationMarshaller Instance = new S3StorageConfigurationMarshaller();
