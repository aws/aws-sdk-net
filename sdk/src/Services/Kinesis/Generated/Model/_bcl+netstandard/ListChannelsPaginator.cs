...
namespace Amazon.Kinesis.Model
{
    ...
    internal sealed partial class ListChannelsPaginator : IPaginator<ListChannelsResponse>, IListChannelsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ChannelSummary> ChannelSummaries => 
            new PaginatedResultKeyResponse<ListChannelsResponse, ChannelSummary>(this, (i) => i.ChannelSummaries ?? new List<ChannelSummary>());

        internal ListChannelsPaginator(IAmazonKinesis client, ListChannelsRequest request)
        {
            this._client = client;
