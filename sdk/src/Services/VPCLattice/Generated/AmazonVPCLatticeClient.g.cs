...
namespace Amazon.VPCLattice
{
    ...
    public partial class AmazonVPCLatticeClient : AmazonServiceClient, IAmazonVPCLattice
    {
        ...
        /// 
        /// </summary>
        public AmazonVPCLatticeClient() : base(new AmazonVPCLatticeConfig()) { }
        ...
        public AmazonVPCLatticeClient(RegionEndpoint region) : base(new AmazonVPCLatticeConfig { RegionEndpoint = region }) { }
        ...
        public AmazonVPCLatticeClient(AmazonVPCLatticeConfig config) : base(config) { }
