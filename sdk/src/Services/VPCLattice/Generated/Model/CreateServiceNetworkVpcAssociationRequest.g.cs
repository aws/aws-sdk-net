...
namespace Amazon.VPCLattice.Model
{
    ...
    /// VPC associations</a> in the <i>Amazon VPC Lattice User Guide</i>. <para> You can't
    /// use this operation if there is a disassociation in progress. If the association fails,
    /// retry by deleting the association and recreating it. </para> <para> As a result of
    /// this operation, the association gets created in the service network account and the
    /// VPC owner account. </para> <para> If you add a security group to the service network
    /// and VPC association, the association must continue to always have at least one security
    /// group. You can add or edit security groups at any time. However, to remove all security
    /// groups, you must first delete the association and recreate it without security groups.
    /// </para>
    /// </summary>
