...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteResourceEndpointAssociationRequestMarshaller : IMarshaller<IRequest, DeleteResourceEndpointAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteResourceEndpointAssociationRequestMarshaller _instance = new DeleteResourceEndpointAssociationRequestMarshaller();        

        internal static DeleteResourceEndpointAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteResourceEndpointAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
