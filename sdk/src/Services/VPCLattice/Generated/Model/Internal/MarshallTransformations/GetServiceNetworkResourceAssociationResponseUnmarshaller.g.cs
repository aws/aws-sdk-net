...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetServiceNetworkResourceAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetServiceNetworkResourceAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DomainVerificationStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetServiceNetworkResourceAssociationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetServiceNetworkResourceAssociationResponseUnmarshaller Instance => _instance;
    }
}
