...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResourceConfiguration operation.
    /// </summary>
    public partial class UpdateResourceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateResourceConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("allowAssociationToShareableServiceNetwork", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AllowAssociationToShareableServiceNetwork = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("resourceConfigurationDefinition", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ResourceConfigurationDefinition = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceConfigurationGroupId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateResourceConfigurationResponseUnmarshaller _instance = new UpdateResourceConfigurationResponseUnmarshaller();

        internal static UpdateResourceConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateResourceConfigurationResponseUnmarshaller Instance => _instance;
    }
}
