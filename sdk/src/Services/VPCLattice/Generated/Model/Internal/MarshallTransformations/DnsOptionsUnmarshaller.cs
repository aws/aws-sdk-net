...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DnsOptionsUnmarshaller : IUnmarshaller<DnsOptions, XmlUnmarshallerContext>, IUnmarshaller<DnsOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DnsOptions IUnmarshaller<DnsOptions, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DnsOptions Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("privateDnsSpecifiedDomains", targetDepth))
                {
                    ...
                    unmarshalledObject.PrivateDnsSpecifiedDomains = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
