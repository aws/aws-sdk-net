...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceConfiguration operation
    /// </summary>  
    public class GetResourceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceConfigurationResponse response = new GetResourceConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("portRanges", targetDepth))
                {
                    ...
                    response.PortRanges = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("resourceConfigurationDefinition", targetDepth))
                {
                    ...
                    response.ResourceConfigurationDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("resourceConfigurationGroupId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResourceConfigurationGroupId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("resourceGatewayId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResourceGatewayId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetResourceConfigurationResponseUnmarshaller _instance = new GetResourceConfigurationResponseUnmarshaller();        

        internal static GetResourceConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
