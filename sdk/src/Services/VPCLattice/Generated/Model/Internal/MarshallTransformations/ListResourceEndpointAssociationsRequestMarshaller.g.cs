...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListResourceEndpointAssociationsRequestMarshaller : IMarshaller<IRequest, ListResourceEndpointAssociationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListResourceEndpointAssociationsRequest publicRequest)
        {
            ...
            if (string.IsNullOrEmpty(publicRequest.ResourceConfigurationIdentifier))
            {
        ...
        private static readonly ListResourceEndpointAssociationsRequestMarshaller _instance = new();

        internal static ListResourceEndpointAssociationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListResourceEndpointAssociationsRequestMarshaller Instance => _instance;
    }
}
