...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListServiceNetworkResourceAssociationsRequestMarshaller : IMarshaller<IRequest, ListServiceNetworkResourceAssociationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListServiceNetworkResourceAssociationsRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("includeChildren", StringUtils.FromBool(publicRequest.IncludeChildren.Value));
            }
        ...
        private static readonly ListServiceNetworkResourceAssociationsRequestMarshaller _instance = new();

        internal static ListServiceNetworkResourceAssociationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListServiceNetworkResourceAssociationsRequestMarshaller Instance => _instance;
    }
}
