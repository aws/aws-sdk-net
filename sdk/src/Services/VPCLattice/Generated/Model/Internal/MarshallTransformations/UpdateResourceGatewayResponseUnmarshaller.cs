...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResourceGateway operation
    /// </summary>  
    public class UpdateResourceGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResourceGatewayResponse response = new UpdateResourceGatewayResponse();
        ...
        private static UpdateResourceGatewayResponseUnmarshaller _instance = new UpdateResourceGatewayResponseUnmarshaller();        

        internal static UpdateResourceGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResourceGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
