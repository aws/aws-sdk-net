...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    public class WeightedTargetGroupUnmarshaller : IJsonUnmarshaller<WeightedTargetGroup, JsonUnmarshallerContext>
    {
        ...
        public WeightedTargetGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("targetGroupIdentifier", targetDepth, ref reader))
                {
        ...
        private static WeightedTargetGroupUnmarshaller _instance = new WeightedTargetGroupUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WeightedTargetGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
