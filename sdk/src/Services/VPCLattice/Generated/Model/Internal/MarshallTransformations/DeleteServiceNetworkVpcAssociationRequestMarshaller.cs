...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteServiceNetworkVpcAssociationRequestMarshaller : IMarshaller<IRequest, DeleteServiceNetworkVpcAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteServiceNetworkVpcAssociationRequestMarshaller _instance = new DeleteServiceNetworkVpcAssociationRequestMarshaller();        

        internal static DeleteServiceNetworkVpcAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServiceNetworkVpcAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
