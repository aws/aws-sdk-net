...
{
    /// <summary>
    /// UpdateTargetGroup Request Marshaller
    /// </summary>
    public partial class UpdateTargetGroupRequestMarshaller : IMarshaller<IRequest, UpdateTargetGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTargetGroupRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateTargetGroupRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetHealthCheck())
            {
                ...
                marshaller.Marshall(publicRequest.HealthCheck, context);
        ...
        private static readonly UpdateTargetGroupRequestMarshaller _instance = new();

        internal static UpdateTargetGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateTargetGroupRequestMarshaller Instance => _instance;
    }
}
