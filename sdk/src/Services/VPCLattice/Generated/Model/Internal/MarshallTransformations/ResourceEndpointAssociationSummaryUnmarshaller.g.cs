...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResourceEndpointAssociationSummaryUnmarshaller : IJsonUnmarshaller<ResourceEndpointAssociationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ResourceEndpointAssociationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ResourceEndpointAssociationSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("vpcEndpointOwner", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VpcEndpointOwner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResourceEndpointAssociationSummaryUnmarshaller Instance => _instance;
    }
}
