...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListDomainVerificationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListDomainVerificationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DomainVerificationSummary, DomainVerificationSummaryUnmarshaller>(DomainVerificationSummaryUnmarshaller.Instance);
        ...
        internal static ListDomainVerificationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListDomainVerificationsResponseUnmarshaller Instance => _instance;
    }
}
