...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DnsOptionsUnmarshaller : IJsonUnmarshaller<DnsOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public DnsOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new DnsOptions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DnsOptionsUnmarshaller Instance => _instance;
    }
}
