...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeregisterTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeregisterTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("unsuccessful", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Unsuccessful = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DeregisterTargetsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeregisterTargetsResponseUnmarshaller Instance => _instance;
    }
}
