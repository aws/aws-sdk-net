...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ServiceNetworkEndpointAssociationUnmarshaller : IJsonUnmarshaller<ServiceNetworkEndpointAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ServiceNetworkEndpointAssociation();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("vpcEndpointOwnerId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ServiceNetworkEndpointAssociationUnmarshaller Instance => _instance;
    }
}
