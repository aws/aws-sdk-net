...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HealthCheckConfigUnmarshaller : IJsonUnmarshaller<HealthCheckConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new HealthCheckConfig();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("healthCheckIntervalSeconds", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("healthCheckTimeoutSeconds", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                ...
                if (context.TestExpression("matcher", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static HealthCheckConfigUnmarshaller Instance => _instance;
    }
}
