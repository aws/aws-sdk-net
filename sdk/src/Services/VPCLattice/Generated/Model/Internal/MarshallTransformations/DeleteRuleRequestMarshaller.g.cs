...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteRuleRequestMarshaller : IMarshaller<IRequest, DeleteRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteRuleRequestMarshaller _instance = new();

        internal static DeleteRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteRuleRequestMarshaller Instance => _instance;
    }
}
