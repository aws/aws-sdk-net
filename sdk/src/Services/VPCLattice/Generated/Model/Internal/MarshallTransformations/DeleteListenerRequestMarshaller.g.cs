...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteListenerRequestMarshaller : IMarshaller<IRequest, DeleteListenerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteListenerRequestMarshaller _instance = new();

        internal static DeleteListenerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteListenerRequestMarshaller Instance => _instance;
    }
}
