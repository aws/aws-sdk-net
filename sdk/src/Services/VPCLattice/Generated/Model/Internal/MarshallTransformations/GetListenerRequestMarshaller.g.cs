...
{
    /// <summary>
    /// GetListener Request Marshaller
    /// </summary>
    public partial class GetListenerRequestMarshaller : IMarshaller<IRequest, GetListenerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetListenerRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetListenerRequest publicRequest)
        {
        ...
        private static readonly GetListenerRequestMarshaller _instance = new();

        internal static GetListenerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetListenerRequestMarshaller Instance => _instance;
    }
}
