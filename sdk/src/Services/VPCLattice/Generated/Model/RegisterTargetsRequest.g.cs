...
{
    /// <summary>
    /// Container for the parameters to the RegisterTargets operation. Registers the targets
    /// with the target group. If it's a Lambda target, you can only have one target in a
    /// target group.
    /// </summary>
