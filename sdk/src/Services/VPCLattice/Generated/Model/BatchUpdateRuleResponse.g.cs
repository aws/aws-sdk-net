...
namespace Amazon.VPCLattice.Model
{
    ...
    public partial class BatchUpdateRuleResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<RuleUpdateSuccess> Successful { get; set; } = AWSConfigs.InitializeCollections ? new List<RuleUpdateSuccess>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<RuleUpdateFailure> Unsuccessful { get; set; } = AWSConfigs.InitializeCollections ? new List<RuleUpdateFailure>() : null;
