...
namespace Amazon.VPCLattice.Model
{
    ...
    public partial class GetServiceNetworkResourceAssociationRequest : AmazonVPCLatticeRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ServiceNetworkResourceAssociationIdentifier property is set.
        /// </summary>
        internal bool IsSetServiceNetworkResourceAssociationIdentifier() => this.ServiceNetworkResourceAssociationIdentifier != null;
    }
}
