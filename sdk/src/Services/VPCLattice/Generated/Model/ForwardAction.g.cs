...
namespace Amazon.VPCLattice.Model
{
    ...
    public partial class ForwardAction
    {
        ...
        public List<WeightedTargetGroup> TargetGroups { get; set; } = AWSConfigs.InitializeCollections ? new List<WeightedTargetGroup>() : null;

        /// <summary>
        /// Checks to see if the TargetGroups property is set.
        /// </summary>
        internal bool IsSetTargetGroups() => this.TargetGroups != null && (this.TargetGroups.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
