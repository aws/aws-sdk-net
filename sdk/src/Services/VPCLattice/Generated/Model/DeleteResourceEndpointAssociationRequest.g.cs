...
{
    /// <summary>
    /// Container for the parameters to the DeleteResourceEndpointAssociation operation. Disassociates
    /// the resource configuration from the resource VPC endpoint.
    /// </summary>
