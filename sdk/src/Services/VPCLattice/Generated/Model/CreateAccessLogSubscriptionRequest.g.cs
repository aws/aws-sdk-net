...
namespace Amazon.VPCLattice.Model
{
    ...
    /// The service network owner can only see access logs from clients and services that
    /// are associated with their service network. Access log entries represent traffic originated
    /// from VPCs associated with that network. For more information, see <a href="https://docs.aws.amazon.com/vpc-lattice/latest/ug/monitoring-access-logs.html">Access
