...
namespace Amazon.VPCLattice.Model
{
    ...
    public partial class DnsOptions
    {
        ...
        ///  </li> </ul>
        /// </summary>
        public PrivateDnsPreference PrivateDnsPreference { get; set; }

        /// <summary>
        /// Checks to see if the PrivateDnsPreference property is set.
        /// </summary>
        internal bool IsSetPrivateDnsPreference() => this.PrivateDnsPreference != null;
        ...
        public List<string> PrivateDnsSpecifiedDomains { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the PrivateDnsSpecifiedDomains property is set.
        /// </summary>
        internal bool IsSetPrivateDnsSpecifiedDomains() => this.PrivateDnsSpecifiedDomains != null && (this.PrivateDnsSpecifiedDomains.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
