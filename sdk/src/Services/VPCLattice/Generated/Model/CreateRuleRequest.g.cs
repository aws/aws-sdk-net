...
{
    /// <summary>
    /// Container for the parameters to the CreateRule operation. Creates a listener rule.
    /// Each listener has a default rule for checking connection requests, but you can define
    /// additional rules. Each rule consists of a priority, one or more actions, and one or
    /// more conditions. For more information, see <a href="https://docs.aws.amazon.com/vpc-lattice/latest/ug/listeners.html#listener-rules">Listener
