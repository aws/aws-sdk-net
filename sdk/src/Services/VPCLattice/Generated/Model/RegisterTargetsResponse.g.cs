...
namespace Amazon.VPCLattice.Model
{
    ...
    public partial class RegisterTargetsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Target> Successful { get; set; } = AWSConfigs.InitializeCollections ? new List<Target>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<TargetFailure> Unsuccessful { get; set; } = AWSConfigs.InitializeCollections ? new List<TargetFailure>() : null;

        /// <summary>
        /// Checks to see if the Unsuccessful property is set.
        /// </summary>
        internal bool IsSetUnsuccessful() => this.Unsuccessful != null && (this.Unsuccessful.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
