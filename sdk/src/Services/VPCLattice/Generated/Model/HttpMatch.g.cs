...
namespace Amazon.VPCLattice.Model
{
    ...
    public partial class HttpMatch
    {
        ...
        public List<HeaderMatch> HeaderMatches { get; set; } = AWSConfigs.InitializeCollections ? new List<HeaderMatch>() : null;

        /// <summary>
        /// Checks to see if the HeaderMatches property is set.
        /// </summary>
        internal bool IsSetHeaderMatches() => this.HeaderMatches != null && (this.HeaderMatches.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the PathMatch property is set.
        /// </summary>
        internal bool IsSetPathMatch() => this.PathMatch != null;
    }
}
