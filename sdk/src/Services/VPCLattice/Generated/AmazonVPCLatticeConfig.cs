...
{
    /// <summary>
    /// Configuration for accessing Amazon VPCLattice service
    /// </summary>
    public partial class AmazonVPCLatticeConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("VPC Lattice", "4.0.101.5");

        private static readonly AmazonVPCLatticeEndpointResolver EndpointResolver =
            new AmazonVPCLatticeEndpointResolver();
        ...
        /// </summary>
        public static new string ServiceId => "VPC Lattice";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "vpc-lattice";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-11-30";
