...
using Amazon.Util;
using Amazon.VerifiedPermissions.Endpoints;
...
namespace Amazon.VerifiedPermissions.Internal
{
    ...
    /// </summary>
    public class AmazonVerifiedPermissionsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonVerifiedPermissionsConfig)requestContext.ClientConfig;
            var result = new VerifiedPermissionsEndpointParameters();
