...
namespace Amazon.VerifiedPermissions.Model
{
    ...
    public partial class EncryptionSettings
    {
        ...
        private KmsEncryptionSettings _kmsEncryptionSettings;
        ...
        /// </para>
        /// </summary>
        public KmsEncryptionSettings KmsEncryptionSettings
        {
            get { return this._kmsEncryptionSettings; }
            set { this._kmsEncryptionSettings = value; }
        }

        // Check to see if KmsEncryptionSettings property is set
        internal bool IsSetKmsEncryptionSettings()
        {
            return this._kmsEncryptionSettings != null;
        }
