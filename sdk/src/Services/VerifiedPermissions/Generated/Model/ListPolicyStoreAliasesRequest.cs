...
{
    /// <summary>
    /// Container for the parameters to the ListPolicyStoreAliases operation.
    /// Returns a paginated list of all policy store aliases in the calling Amazon Web Services
    /// account.
    /// </summary>
    public partial class ListPolicyStoreAliasesRequest : AmazonVerifiedPermissionsRequest
    {
        private PolicyStoreAliasFilter _filter;
        ...
        /// <para>
        /// Specifies a filter to narrow the results. You can filter by <c>policyStoreId</c> to
        /// list only the policy store aliases associated with a specific policy store.
        /// </para>
        /// </summary>
        public PolicyStoreAliasFilter Filter
        {
