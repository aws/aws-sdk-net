...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreatePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("policyId", targetDepth))
                {
                    ...
                    response.PolicyId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyType = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CreatePolicyResponseUnmarshaller _instance = new CreatePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
