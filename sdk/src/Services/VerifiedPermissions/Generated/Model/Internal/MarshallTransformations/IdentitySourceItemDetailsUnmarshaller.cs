...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdentitySourceItemDetailsUnmarshaller : IJsonUnmarshaller<IdentitySourceItemDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentitySourceItemDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
