...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchIsAuthorizedWithTokenInputItemUnmarshaller : IJsonUnmarshaller<BatchIsAuthorizedWithTokenInputItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchIsAuthorizedWithTokenInputItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
