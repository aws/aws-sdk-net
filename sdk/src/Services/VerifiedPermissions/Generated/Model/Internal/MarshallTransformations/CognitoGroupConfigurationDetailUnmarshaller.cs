...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CognitoGroupConfigurationDetailUnmarshaller : IJsonUnmarshaller<CognitoGroupConfigurationDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CognitoGroupConfigurationDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("groupEntityType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.GroupEntityType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
