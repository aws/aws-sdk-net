...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PolicyStoreAliasItemUnmarshaller : IJsonUnmarshaller<PolicyStoreAliasItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PolicyStoreAliasItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
