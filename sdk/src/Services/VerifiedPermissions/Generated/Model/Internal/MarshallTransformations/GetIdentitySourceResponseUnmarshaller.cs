...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIdentitySourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdentitySourceResponse response = new GetIdentitySourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ConfigurationDetailUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = IdentitySourceDetailsUnmarshaller.Instance;
                ...
                if (context.TestExpression("identitySourceId", targetDepth))
                {
                    ...
                    response.IdentitySourceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PrincipalEntityType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetIdentitySourceResponseUnmarshaller _instance = new GetIdentitySourceResponseUnmarshaller();        

        internal static GetIdentitySourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdentitySourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
