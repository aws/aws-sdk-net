...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class IsAuthorizedRequestMarshaller : IMarshaller<IRequest, IsAuthorizedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((IsAuthorizedRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(IsAuthorizedRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.VerifiedPermissions");
            string target = "VerifiedPermissions.IsAuthorized";
        ...
        private static IsAuthorizedRequestMarshaller _instance = new IsAuthorizedRequestMarshaller();        

        internal static IsAuthorizedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IsAuthorizedRequestMarshaller Instance
        {
            get
            {
                return _instance;
