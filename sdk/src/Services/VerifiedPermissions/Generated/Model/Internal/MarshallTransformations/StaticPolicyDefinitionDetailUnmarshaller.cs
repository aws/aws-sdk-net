...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StaticPolicyDefinitionDetailUnmarshaller : IJsonUnmarshaller<StaticPolicyDefinitionDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StaticPolicyDefinitionDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
