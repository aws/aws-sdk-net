...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetPolicyOutputItemUnmarshaller : IJsonUnmarshaller<BatchGetPolicyOutputItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetPolicyOutputItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
