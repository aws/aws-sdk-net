...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreatePolicyTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePolicyTemplateResponse response = new CreatePolicyTemplateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyTemplateId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreatePolicyTemplateResponseUnmarshaller _instance = new CreatePolicyTemplateResponseUnmarshaller();        

        internal static CreatePolicyTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePolicyTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
