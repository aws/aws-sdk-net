...
{
    /// <summary>
    /// This is the response object from the ListRoute53HealthChecksInRegion operation.
    /// </summary>
    public partial class ListRoute53HealthChecksInRegionResponse : AmazonWebServiceResponse
    {
        private List<Route53HealthCheck> _healthChecks = AWSConfigs.InitializeCollections ? new List<Route53HealthCheck>() : null;
        ...
        /// </summary>
        public List<Route53HealthCheck> HealthChecks
        {
