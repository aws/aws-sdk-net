...
{
    /// <summary>
    /// This is the response object from the ListPlanExecutionEvents operation.
    /// </summary>
    public partial class ListPlanExecutionEventsResponse : AmazonWebServiceResponse
    {
        private List<ExecutionEvent> _items = AWSConfigs.InitializeCollections ? new List<ExecutionEvent>() : null;
        ...
        /// </summary>
        public List<ExecutionEvent> Items
        {
