...
{
    /// <summary>
    /// Container for the parameters to the ListRoute53HealthChecksInRegion operation.
    /// List the Amazon Route 53 health checks in a specific Amazon Web Services Region.
    /// </summary>
    public partial class ListRoute53HealthChecksInRegionRequest : AmazonARCRegionswitchRequest
    {
        private string _arn;
