        ...
        public Workflow Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("workflowDescription", targetDepth))
                {
                    ...
                    unmarshalledObject.WorkflowDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("workflowTargetAction", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WorkflowTargetAction = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("workflowTargetRegion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WorkflowTargetRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
