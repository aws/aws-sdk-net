...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionEventUnmarshaller : IUnmarshaller<ExecutionEvent, XmlUnmarshallerContext>, IUnmarshaller<ExecutionEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ExecutionEvent IUnmarshaller<ExecutionEvent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ExecutionEvent Unmarshall(JsonUnmarshallerContext context)
        {
