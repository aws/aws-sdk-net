...
{
    /// <summary>
    /// Response Unmarshaller for LambdaEventSourceMappingConfiguration Object
    /// </summary>  
    public class LambdaEventSourceMappingConfigurationUnmarshaller : IJsonUnmarshaller<LambdaEventSourceMappingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LambdaEventSourceMappingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            LambdaEventSourceMappingConfiguration unmarshalledObject = new LambdaEventSourceMappingConfiguration();
        ...
        private static LambdaEventSourceMappingConfigurationUnmarshaller _instance = new LambdaEventSourceMappingConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LambdaEventSourceMappingConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
