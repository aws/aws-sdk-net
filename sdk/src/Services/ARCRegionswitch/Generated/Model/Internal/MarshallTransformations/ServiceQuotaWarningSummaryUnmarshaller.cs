...
{
    /// <summary>
    /// Response Unmarshaller for ServiceQuotaWarningSummary Object
    /// </summary>  
    public class ServiceQuotaWarningSummaryUnmarshaller : IJsonUnmarshaller<ServiceQuotaWarningSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceQuotaWarningSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ServiceQuotaWarningSummary unmarshalledObject = new ServiceQuotaWarningSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("quotaRegion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QuotaRegion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("warningCreatedAt", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.WarningCreatedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ServiceQuotaWarningSummaryUnmarshaller _instance = new ServiceQuotaWarningSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ServiceQuotaWarningSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
