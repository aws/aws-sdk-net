...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePlan operation
    /// </summary>  
    public class UpdatePlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdatePlanResponseUnmarshaller _instance = new UpdatePlanResponseUnmarshaller();        

        internal static UpdatePlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
