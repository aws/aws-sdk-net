        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("actualRecoveryTime", targetDepth))
                {
                    ...
                    response.ActualRecoveryTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExecutionAction = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExecutionRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PlanArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("recoveryExecutionId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RecoveryExecutionId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StepState, StepStateUnmarshaller>(StepStateUnmarshaller.Instance);
                    response.StepStates = unmarshaller.Unmarshall(context);
                    continue;
                }
