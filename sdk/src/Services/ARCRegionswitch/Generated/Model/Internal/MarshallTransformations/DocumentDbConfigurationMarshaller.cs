...
{
    /// <summary>
    /// DocumentDbConfiguration Marshaller
    /// </summary>
    public class DocumentDbConfigurationMarshaller : IRequestMarshaller<DocumentDbConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DocumentDbConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetUngraceful())
            {
                ...
                var marshaller = DocumentDbUngracefulMarshaller.Instance;
        ...
        /// </summary>
        public readonly static DocumentDbConfigurationMarshaller Instance = new DocumentDbConfigurationMarshaller();
