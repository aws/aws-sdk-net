...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AbbreviatedExecutionUnmarshaller : IUnmarshaller<AbbreviatedExecution, XmlUnmarshallerContext>, IUnmarshaller<AbbreviatedExecution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AbbreviatedExecution IUnmarshaller<AbbreviatedExecution, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AbbreviatedExecution Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("actualRecoveryTime", targetDepth))
                {
                    ...
                    unmarshalledObject.ActualRecoveryTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExecutionAction = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExecutionRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("executionState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExecutionState = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PlanArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("recoveryExecutionId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RecoveryExecutionId = unmarshaller.Unmarshall(context);
                    continue;
                }
