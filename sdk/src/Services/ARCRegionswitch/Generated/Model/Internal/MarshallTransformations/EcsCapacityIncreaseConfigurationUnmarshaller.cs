    ...
    public class EcsCapacityIncreaseConfigurationUnmarshaller : IJsonUnmarshaller<EcsCapacityIncreaseConfiguration, JsonUnmarshallerContext>
    {
        ...
        public EcsCapacityIncreaseConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("waitELBTargetGroupHealthy", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WaitELBTargetGroupHealthy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
