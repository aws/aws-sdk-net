...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DocumentDbConfigurationUnmarshaller : IJsonUnmarshaller<DocumentDbConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentDbConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
