...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ArcRoutingControlConfigurationUnmarshaller : IJsonUnmarshaller<ArcRoutingControlConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ArcRoutingControlConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
