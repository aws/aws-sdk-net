    ...
    public class StepUnmarshaller : IUnmarshaller<Step, XmlUnmarshallerContext>, IUnmarshaller<Step, JsonUnmarshallerContext>
    {
        ...
        public Step Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("executionBlockConfiguration", targetDepth))
                {
                    var unmarshaller = ExecutionBlockConfigurationUnmarshaller.Instance;
                    unmarshalledObject.ExecutionBlockConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("executionBlockType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExecutionBlockType = unmarshaller.Unmarshall(context);
                    continue;
                }
