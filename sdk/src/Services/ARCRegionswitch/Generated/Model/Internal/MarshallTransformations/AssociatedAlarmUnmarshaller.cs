...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociatedAlarmUnmarshaller : IUnmarshaller<AssociatedAlarm, XmlUnmarshallerContext>, IUnmarshaller<AssociatedAlarm, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AssociatedAlarm IUnmarshaller<AssociatedAlarm, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AssociatedAlarm Unmarshall(JsonUnmarshallerContext context)
        {
