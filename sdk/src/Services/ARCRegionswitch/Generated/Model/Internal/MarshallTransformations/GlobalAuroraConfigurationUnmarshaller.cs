...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GlobalAuroraConfigurationUnmarshaller : IUnmarshaller<GlobalAuroraConfiguration, XmlUnmarshallerContext>, IUnmarshaller<GlobalAuroraConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GlobalAuroraConfiguration IUnmarshaller<GlobalAuroraConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GlobalAuroraConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("databaseClusterArns", targetDepth))
                {
                    ...
                    unmarshalledObject.DatabaseClusterArns = unmarshaller.Unmarshall(context);
                    continue;
                }
