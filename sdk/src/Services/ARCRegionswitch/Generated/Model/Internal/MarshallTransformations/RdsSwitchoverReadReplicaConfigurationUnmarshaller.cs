...
{
    /// <summary>
    /// Response Unmarshaller for RdsSwitchoverReadReplicaConfiguration Object
    /// </summary>  
    public class RdsSwitchoverReadReplicaConfigurationUnmarshaller : IJsonUnmarshaller<RdsSwitchoverReadReplicaConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RdsSwitchoverReadReplicaConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RdsSwitchoverReadReplicaConfiguration unmarshalledObject = new RdsSwitchoverReadReplicaConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = RdsUngracefulUnmarshaller.Instance;
        ...
        private static RdsSwitchoverReadReplicaConfigurationUnmarshaller _instance = new RdsSwitchoverReadReplicaConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RdsSwitchoverReadReplicaConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
