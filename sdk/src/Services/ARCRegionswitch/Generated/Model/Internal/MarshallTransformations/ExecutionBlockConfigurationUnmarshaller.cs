...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionBlockConfigurationUnmarshaller : IUnmarshaller<ExecutionBlockConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ExecutionBlockConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ExecutionBlockConfiguration IUnmarshaller<ExecutionBlockConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ExecutionBlockConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("arcRoutingControlConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.ArcRoutingControlConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ec2AsgCapacityIncreaseConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.Ec2AsgCapacityIncreaseConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ecsCapacityIncreaseConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.EcsCapacityIncreaseConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("eksResourceScalingConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.EksResourceScalingConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("executionApprovalConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.ExecutionApprovalConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("globalAuroraConfig", targetDepth))
                {
                    var unmarshaller = GlobalAuroraConfigurationUnmarshaller.Instance;
                    unmarshalledObject.GlobalAuroraConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("parallelConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.ParallelConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("rdsCreateCrossRegionReadReplicaConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.RdsCreateCrossRegionReadReplicaConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("rdsPromoteReadReplicaConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.RdsPromoteReadReplicaConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("regionSwitchPlanConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.RegionSwitchPlanConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("route53HealthCheckConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.Route53HealthCheckConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
