...
{
    /// <summary>
    /// NeptuneGlobalDatabaseConfiguration Marshaller
    /// </summary>
    public class NeptuneGlobalDatabaseConfigurationMarshaller : IRequestMarshaller<NeptuneGlobalDatabaseConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(NeptuneGlobalDatabaseConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetUngraceful())
            {
                ...
                var marshaller = NeptuneUngracefulMarshaller.Instance;
        ...
        /// </summary>
        public readonly static NeptuneGlobalDatabaseConfigurationMarshaller Instance = new NeptuneGlobalDatabaseConfigurationMarshaller();
