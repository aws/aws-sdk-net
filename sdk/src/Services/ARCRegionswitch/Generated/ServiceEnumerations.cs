...
namespace Amazon.ARCRegionswitch
{
    ...
    /// <summary>
    /// Constants used for properties of type ServiceQuotaWarningStatus.
    /// </summary>
    public class ServiceQuotaWarningStatus : ConstantClass
    {

        /// <summary>
        /// Constant Denied for ServiceQuotaWarningStatus
        /// </summary>
        public static readonly ServiceQuotaWarningStatus Denied = new ServiceQuotaWarningStatus("denied");
        /// <summary>
        /// Constant InsufficientPermissions for ServiceQuotaWarningStatus
        /// </summary>
        public static readonly ServiceQuotaWarningStatus InsufficientPermissions = new ServiceQuotaWarningStatus("insufficientPermissions");
        /// <summary>
        /// Constant MaxAccountRequestsExceeded for ServiceQuotaWarningStatus
        /// </summary>
        public static readonly ServiceQuotaWarningStatus MaxAccountRequestsExceeded = new ServiceQuotaWarningStatus("maxAccountRequestsExceeded");
        /// <summary>
        /// Constant MaxRegionSwitchRequestsExceeded for ServiceQuotaWarningStatus
        /// </summary>
        public static readonly ServiceQuotaWarningStatus MaxRegionSwitchRequestsExceeded = new ServiceQuotaWarningStatus("maxRegionSwitchRequestsExceeded");
        /// <summary>
        /// Constant Pending for ServiceQuotaWarningStatus
        /// </summary>
        public static readonly ServiceQuotaWarningStatus Pending = new ServiceQuotaWarningStatus("pending");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ServiceQuotaWarningStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ServiceQuotaWarningStatus FindValue(string value)
        {
            return FindValue<ServiceQuotaWarningStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ServiceQuotaWarningStatus(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type WaitELBTargetGroupHealthy.
    /// </summary>
    public class WaitELBTargetGroupHealthy : ConstantClass
    {

        /// <summary>
        /// Constant Disabled for WaitELBTargetGroupHealthy
        /// </summary>
        public static readonly WaitELBTargetGroupHealthy Disabled = new WaitELBTargetGroupHealthy("disabled");
        /// <summary>
        /// Constant Enabled for WaitELBTargetGroupHealthy
        /// </summary>
        public static readonly WaitELBTargetGroupHealthy Enabled = new WaitELBTargetGroupHealthy("enabled");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public WaitELBTargetGroupHealthy(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static WaitELBTargetGroupHealthy FindValue(string value)
        {
            return FindValue<WaitELBTargetGroupHealthy>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator WaitELBTargetGroupHealthy(string value)
        {
            return FindValue(value);
        }
    }
