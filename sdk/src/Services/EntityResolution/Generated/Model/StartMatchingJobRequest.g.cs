...
{
    /// <summary>
    /// Container for the parameters to the StartMatchingJob operation. Starts the <c>MatchingJob</c>
    /// of a workflow. The workflow must have previously been created using the <c>CreateMatchingWorkflow</c>
    /// endpoint.
    /// </summary>
