...
{
    /// <summary>
    /// Container for the parameters to the DeleteIdMappingWorkflow operation. Deletes the
    /// <c>IdMappingWorkflow</c> with a given name. This operation returns a <c>ResourceNotFoundException</c>
