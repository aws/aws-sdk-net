...
{
    /// <summary>
    /// Container for the parameters to the DeleteMatchingWorkflow operation. Deletes the
    /// <c>MatchingWorkflow</c> with a given name. This operation returns a <c>ResourceNotFoundException</c>
