...
namespace Amazon.EntityResolution.Model
{
    ...
    public partial class ListSchemaMappingsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SchemaMappingSummary> SchemaList { get; set; } = AWSConfigs.InitializeCollections ? new List<SchemaMappingSummary>() : null;

        /// <summary>
        /// Checks to see if the SchemaList property is set.
        /// </summary>
        internal bool IsSetSchemaList() => this.SchemaList != null && (this.SchemaList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
