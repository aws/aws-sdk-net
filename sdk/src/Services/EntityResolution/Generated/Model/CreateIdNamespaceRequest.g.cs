...
{
    /// <summary>
    /// Container for the parameters to the CreateIdNamespace operation. Creates an ID namespace
    /// object which will help customers provide metadata explaining their dataset and how
    /// to use it. Each ID namespace must have a unique name. To modify an existing ID namespace,
    ...
    public partial class CreateIdNamespaceRequest : AmazonEntityResolutionRequest
    {
        ...
        /// <para>
        /// Determines the properties of <c>IdMappingWorflow</c> where this <c>IdNamespace</c>
