...
{
    /// <summary>
    /// Container for the parameters to the CreateSchemaMapping operation. Creates a schema
    /// mapping, which defines the schema of the input customer records table. The <c>SchemaMapping</c>
    /// also provides Entity Resolution with some metadata about the table, such as the attribute
