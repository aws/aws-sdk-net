...
{
    /// <summary>
    /// Container for the parameters to the DeleteIdNamespace operation. Deletes the <c>IdNamespace</c>
    /// with a given name. This operation returns a <c>ResourceNotFoundException</c> if an
    /// ID namespace with the given name does not exist.
    /// </summary>
