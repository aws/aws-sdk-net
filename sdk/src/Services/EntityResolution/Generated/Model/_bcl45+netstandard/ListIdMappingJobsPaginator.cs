...
namespace Amazon.EntityResolution.Model
{
    ...
    internal sealed partial class ListIdMappingJobsPaginator : IPaginator<ListIdMappingJobsResponse>, IListIdMappingJobsPaginator
    {
        ...
        public IPaginatedEnumerable<JobSummary> Jobs => 
            new PaginatedResultKeyResponse<ListIdMappingJobsResponse, JobSummary>(this, (i) => i.Jobs);
        ...
        async IAsyncEnumerable<ListIdMappingJobsResponse> IPaginator<ListIdMappingJobsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
