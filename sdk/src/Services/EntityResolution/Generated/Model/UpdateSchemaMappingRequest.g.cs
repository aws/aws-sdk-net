...
{
    /// <summary>
    /// Container for the parameters to the UpdateSchemaMapping operation. Updates a schema
    /// mapping. <note> <para> A schema is immutable if it is being used by a workflow. Therefore,
    /// you can't update a schema mapping if it's associated with a workflow. </para> </note>
    /// </summary>
