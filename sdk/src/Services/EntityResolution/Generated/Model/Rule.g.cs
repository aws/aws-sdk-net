...
namespace Amazon.EntityResolution.Model
{
    ...
    public partial class Rule
    {
        ...
        /// </summary>
        [AWSProperty(Required = true, Max = 15)]
        public List<string> MatchingKeys { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the MatchingKeys property is set.
        /// </summary>
        internal bool IsSetMatchingKeys() => this.MatchingKeys != null && (this.MatchingKeys.Count > 0 || !AWSConfigs.InitializeCollections);
