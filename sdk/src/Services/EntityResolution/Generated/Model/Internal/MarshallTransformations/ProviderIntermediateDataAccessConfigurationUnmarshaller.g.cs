...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProviderIntermediateDataAccessConfigurationUnmarshaller : IJsonUnmarshaller<ProviderIntermediateDataAccessConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProviderIntermediateDataAccessConfiguration();
            ...
            {
                if (context.TestExpression("awsAccountIds", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("requiredBucketActions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProviderIntermediateDataAccessConfigurationUnmarshaller Instance => _instance;
    }
}
