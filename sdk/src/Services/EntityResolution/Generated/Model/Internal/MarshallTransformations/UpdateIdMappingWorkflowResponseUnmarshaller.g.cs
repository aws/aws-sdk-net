...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateIdMappingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateIdMappingWorkflowResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("idMappingTechniques", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IdMappingTechniques = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("incrementalRunConfig", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IncrementalRunConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("inputSourceConfig", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.InputSourceConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static UpdateIdMappingWorkflowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIdMappingWorkflowResponseUnmarshaller Instance => _instance;
    }
}
