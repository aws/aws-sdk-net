...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSchemaMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateSchemaMappingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("mappedInputFields", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MappedInputFields = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateSchemaMappingResponseUnmarshaller _instance = new UpdateSchemaMappingResponseUnmarshaller();

        internal static UpdateSchemaMappingResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSchemaMappingResponseUnmarshaller Instance => _instance;
    }
}
