...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSchemaMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSchemaMappingResponse response = new GetSchemaMappingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hasWorkflows", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.HasWorkflows = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetSchemaMappingResponseUnmarshaller _instance = new GetSchemaMappingResponseUnmarshaller();        

        internal static GetSchemaMappingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSchemaMappingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
