...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSchemaMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSchemaMappingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hasWorkflows", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.HasWorkflows = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetSchemaMappingResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSchemaMappingResponseUnmarshaller Instance => _instance;
    }
}
