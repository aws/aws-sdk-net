...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProviderIntermediateDataAccessConfigurationUnmarshaller : IUnmarshaller<ProviderIntermediateDataAccessConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ProviderIntermediateDataAccessConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProviderIntermediateDataAccessConfiguration IUnmarshaller<ProviderIntermediateDataAccessConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProviderIntermediateDataAccessConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("awsAccountIds", targetDepth))
                {
                    ...
                    unmarshalledObject.AwsAccountIds = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("requiredBucketActions", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.RequiredBucketActions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
