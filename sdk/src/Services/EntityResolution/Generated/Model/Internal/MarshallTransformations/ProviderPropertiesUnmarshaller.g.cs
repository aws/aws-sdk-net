...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProviderPropertiesUnmarshaller : IJsonUnmarshaller<ProviderProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProviderProperties();
            ...
            {
                if (context.TestExpression("intermediateSourceConfiguration", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProviderPropertiesUnmarshaller Instance => _instance;
    }
}
