...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IdNamespaceIdMappingWorkflowPropertiesUnmarshaller : IJsonUnmarshaller<IdNamespaceIdMappingWorkflowProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public IdNamespaceIdMappingWorkflowProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new IdNamespaceIdMappingWorkflowProperties();
            ...
            {
                if (context.TestExpression("idMappingType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IdMappingType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static IdNamespaceIdMappingWorkflowPropertiesUnmarshaller Instance => _instance;
    }
}
