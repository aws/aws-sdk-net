...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateMatchingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateMatchingWorkflowResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resolutionTechniques", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ResolutionTechniques = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static UpdateMatchingWorkflowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMatchingWorkflowResponseUnmarshaller Instance => _instance;
    }
}
