        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("incrementalRunConfig", targetDepth))
                {
                    ...
                    response.IncrementalRunConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<OutputSource, OutputSourceUnmarshaller>(OutputSourceUnmarshaller.Instance);
                ...
                if (context.TestExpression("resolutionTechniques", targetDepth))
                {
                    ...
                    response.ResolutionTechniques = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkflowName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
