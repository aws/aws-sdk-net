...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateMatchingWorkflowRequestMarshaller : IMarshaller<IRequest, CreateMatchingWorkflowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMatchingWorkflowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMatchingWorkflowRequest publicRequest)
        {
        ...
        private static CreateMatchingWorkflowRequestMarshaller _instance = new CreateMatchingWorkflowRequestMarshaller();        

        internal static CreateMatchingWorkflowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMatchingWorkflowRequestMarshaller Instance
        {
            get
            {
                return _instance;
