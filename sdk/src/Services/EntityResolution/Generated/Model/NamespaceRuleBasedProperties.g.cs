...
namespace Amazon.EntityResolution.Model
{
    ...
    public partial class NamespaceRuleBasedProperties
    {
        ...
        /// </summary>
        public List<string> RecordMatchingModels { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the RecordMatchingModels property is set.
        /// </summary>
        internal bool IsSetRecordMatchingModels() => this.RecordMatchingModels != null && (this.RecordMatchingModels.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> RuleDefinitionTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the RuleDefinitionTypes property is set.
        /// </summary>
        internal bool IsSetRuleDefinitionTypes() => this.RuleDefinitionTypes != null && (this.RuleDefinitionTypes.Count > 0 || !AWSConfigs.InitializeCollections);
