...
{
    /// <summary>
    /// Container for the parameters to the GetMatchId operation. Returns the corresponding
    /// Match ID of a customer record if the record has been processed in a rule-based matching
    /// workflow. <para> You can call this API as a dry run of an incremental load on the
    /// rule-based matching workflow. </para>
    /// </summary>
    public partial class GetMatchIdRequest : AmazonEntityResolutionRequest
    {
        ...
        public Dictionary<string, string> Record { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;
