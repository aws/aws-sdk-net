...
namespace Amazon.EntityResolution.Model
{
    ...
    public partial class Record
    {
        ...
        public Dictionary<string, string> RecordAttributeMap { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the RecordAttributeMap property is set.
        /// </summary>
        internal bool IsSetRecordAttributeMap() => this.RecordAttributeMap != null && (this.RecordAttributeMap.Count > 0 || !AWSConfigs.InitializeCollections);
