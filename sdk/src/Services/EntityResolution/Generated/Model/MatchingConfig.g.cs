...
namespace Amazon.EntityResolution.Model
{
    ...
    public partial class MatchingConfig
    {
        ...
        /// </para>
        /// </summary>
        public bool? EnableTransitiveMatching { get; set; }

        /// <summary>
        /// Checks to see if the EnableTransitiveMatching property is set.
        /// </summary>
        internal bool IsSetEnableTransitiveMatching() => this.EnableTransitiveMatching.HasValue;
    }
}
