...
namespace Amazon.EntityResolution
{
    ...
    public partial class AmazonEntityResolutionClient : AmazonServiceClient, IAmazonEntityResolution
    {
        ...
        /// 
        /// </summary>
        public AmazonEntityResolutionClient() : base(new AmazonEntityResolutionConfig()) { }
        ...
        public AmazonEntityResolutionClient(RegionEndpoint region) : base(new AmazonEntityResolutionConfig { RegionEndpoint = region }) { }
        ...
        public AmazonEntityResolutionClient(AmazonEntityResolutionConfig config) : base(config) { }
