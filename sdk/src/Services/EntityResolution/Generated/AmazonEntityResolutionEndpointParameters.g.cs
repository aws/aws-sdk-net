...
namespace Amazon.EntityResolution.Endpoints
{
    /// <summary>
    ...
    /// internal <see cref="AmazonEntityResolutionEndpointProvider"/> and <see cref="AmazonEntityResolutionEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class EntityResolutionEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// EntityResolutionEndpointParameters constructor
        /// </summary>
        public EntityResolutionEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
