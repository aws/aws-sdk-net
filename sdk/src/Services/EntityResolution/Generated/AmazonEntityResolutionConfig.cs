...
namespace Amazon.EntityResolution
{
    ...
    public partial class AmazonEntityResolutionConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("EntityResolution", "4.0.102.5");
        ...
        /// </summary>
        public static new string ServiceId => "EntityResolution";

        /// <summary>
        /// Default constructor
        /// </summary>
        public AmazonEntityResolutionConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonEntityResolutionDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "EntityResolution";
            this.AuthenticationServiceName = "entityresolution";
            this.EndpointProvider = new AmazonEntityResolutionEndpointProvider();
        }

        /// <summary>
        /// The constant used to lookup in the region hash the endpoint.
        /// </summary>
        public override string RegionEndpointServiceName => "entityresolution";
