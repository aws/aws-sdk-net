...
#elif NET6_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 6.0) - AWSServerlessApplicationRepository. First release of the AWS Serverless Application Repository SDK.")]
#else
