...
namespace Amazon.ServerlessApplicationRepository
{
    ...
    /// You can also search for applications by name, publisher, or event source. To use an
    /// application, you simply choose it, configure any required fields, and deploy it with
    /// a few clicks. 
    /// </para>
    /// 
    /// <para>
    ...
    public partial class AmazonServerlessApplicationRepositoryClient : AmazonServiceClient, IAmazonServerlessApplicationRepository
    {
        ...
        /// 
        /// </summary>
        public AmazonServerlessApplicationRepositoryClient() : base(new AmazonServerlessApplicationRepositoryConfig()) { }
        ...
        public AmazonServerlessApplicationRepositoryClient(RegionEndpoint region) : base(new AmazonServerlessApplicationRepositoryConfig { RegionEndpoint = region }) { }
        ...
        public AmazonServerlessApplicationRepositoryClient(AmazonServerlessApplicationRepositoryConfig config) : base(config) { }
