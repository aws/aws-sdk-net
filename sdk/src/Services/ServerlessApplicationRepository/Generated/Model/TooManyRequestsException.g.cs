...
namespace Amazon.ServerlessApplicationRepository.Model
{
    ...
    [Serializable]
#endif
    public partial class TooManyRequestsException : AmazonServerlessApplicationRepositoryException
    {
        /// <summary>
        ...
        /// Construct instance of TooManyRequestsException
        /// </summary>
        public TooManyRequestsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of TooManyRequestsException
        /// </summary>
        public TooManyRequestsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
