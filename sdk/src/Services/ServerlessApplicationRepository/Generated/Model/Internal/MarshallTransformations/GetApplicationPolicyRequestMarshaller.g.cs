...
{
    /// <summary>
    /// GetApplicationPolicy Request Marshaller
    /// </summary>
    public partial class GetApplicationPolicyRequestMarshaller : IMarshaller<IRequest, GetApplicationPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetApplicationPolicyRequest)input);
        }
        ...
        private static readonly GetApplicationPolicyRequestMarshaller _instance = new();

        internal static GetApplicationPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetApplicationPolicyRequestMarshaller Instance => _instance;
    }
}
