...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UnshareApplicationRequestMarshaller : IMarshaller<IRequest, UnshareApplicationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UnshareApplicationRequestMarshaller _instance = new();

        internal static UnshareApplicationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UnshareApplicationRequestMarshaller Instance => _instance;
    }
}
