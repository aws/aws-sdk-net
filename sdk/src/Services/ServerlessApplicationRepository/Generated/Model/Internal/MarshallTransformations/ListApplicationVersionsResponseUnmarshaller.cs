...
{
    /// <summary>
    /// Response Unmarshaller for ListApplicationVersions operation
    /// </summary>  
    public class ListApplicationVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApplicationVersionsResponse response = new ListApplicationVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VersionSummary, VersionSummaryUnmarshaller>(VersionSummaryUnmarshaller.Instance);
        ...
        private static ListApplicationVersionsResponseUnmarshaller _instance = new ListApplicationVersionsResponseUnmarshaller();        

        internal static ListApplicationVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
