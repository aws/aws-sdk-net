...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCloudFormationTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateCloudFormationTemplateResponse();
        ...
        internal static CreateCloudFormationTemplateResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCloudFormationTemplateResponseUnmarshaller Instance => _instance;
    }
}
