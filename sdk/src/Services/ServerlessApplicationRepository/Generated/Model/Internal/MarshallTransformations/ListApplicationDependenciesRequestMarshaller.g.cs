...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListApplicationDependenciesRequestMarshaller : IMarshaller<IRequest, ListApplicationDependenciesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListApplicationDependenciesRequestMarshaller _instance = new();

        internal static ListApplicationDependenciesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListApplicationDependenciesRequestMarshaller Instance => _instance;
    }
}
