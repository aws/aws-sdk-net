...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCloudFormationChangeSetRequestMarshaller : IMarshaller<IRequest, CreateCloudFormationChangeSetRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateCloudFormationChangeSetRequestMarshaller _instance = new();

        internal static CreateCloudFormationChangeSetRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCloudFormationChangeSetRequestMarshaller Instance => _instance;
    }
}
