...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCloudFormationTemplateRequestMarshaller : IMarshaller<IRequest, CreateCloudFormationTemplateRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateCloudFormationTemplateRequestMarshaller _instance = new();

        internal static CreateCloudFormationTemplateRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCloudFormationTemplateRequestMarshaller Instance => _instance;
    }
}
