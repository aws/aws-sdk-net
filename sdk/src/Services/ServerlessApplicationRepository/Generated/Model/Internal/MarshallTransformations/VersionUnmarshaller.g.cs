...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VersionUnmarshaller : IJsonUnmarshaller<Version, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Version();
        ...
        /// Gets the singleton.
        /// </summary>
        public static VersionUnmarshaller Instance => _instance;
    }
}
