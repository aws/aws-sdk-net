...
{
    /// <summary>
    /// Response Unmarshaller for CreateCloudFormationChangeSet operation
    /// </summary>  
    public class CreateCloudFormationChangeSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCloudFormationChangeSetResponse response = new CreateCloudFormationChangeSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StackId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateCloudFormationChangeSetResponseUnmarshaller _instance = new CreateCloudFormationChangeSetResponseUnmarshaller();        

        internal static CreateCloudFormationChangeSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCloudFormationChangeSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
