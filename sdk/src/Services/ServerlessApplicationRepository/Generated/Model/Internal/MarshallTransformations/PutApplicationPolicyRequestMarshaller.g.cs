...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutApplicationPolicyRequestMarshaller : IMarshaller<IRequest, PutApplicationPolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutApplicationPolicyRequestMarshaller _instance = new();

        internal static PutApplicationPolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutApplicationPolicyRequestMarshaller Instance => _instance;
    }
}
