...
{
    /// <summary>
    /// Response Unmarshaller for ListApplicationDependencies operation
    /// </summary>  
    public class ListApplicationDependenciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApplicationDependenciesResponse response = new ListApplicationDependenciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ApplicationDependencySummary, ApplicationDependencySummaryUnmarshaller>(ApplicationDependencySummaryUnmarshaller.Instance);
        ...
        private static ListApplicationDependenciesResponseUnmarshaller _instance = new ListApplicationDependenciesResponseUnmarshaller();        

        internal static ListApplicationDependenciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationDependenciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
