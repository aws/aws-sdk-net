...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCloudFormationChangeSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateCloudFormationChangeSetResponse();
        ...
        internal static CreateCloudFormationChangeSetResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCloudFormationChangeSetResponseUnmarshaller Instance => _instance;
    }
}
