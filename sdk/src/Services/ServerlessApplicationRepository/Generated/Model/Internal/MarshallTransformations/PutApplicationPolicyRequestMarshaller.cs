...
{
    /// <summary>
    /// PutApplicationPolicy Request Marshaller
    /// </summary>       
    public class PutApplicationPolicyRequestMarshaller : IMarshaller<IRequest, PutApplicationPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutApplicationPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutApplicationPolicyRequest publicRequest)
        {
        ...
        private static PutApplicationPolicyRequestMarshaller _instance = new PutApplicationPolicyRequestMarshaller();        

        internal static PutApplicationPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutApplicationPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
