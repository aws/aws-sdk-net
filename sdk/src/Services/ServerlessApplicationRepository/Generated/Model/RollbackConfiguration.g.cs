...
namespace Amazon.ServerlessApplicationRepository.Model
{
    ...
    public partial class RollbackConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public int? MonitoringTimeInMinutes { get; set; }

        /// <summary>
        /// Checks to see if the MonitoringTimeInMinutes property is set.
        /// </summary>
        internal bool IsSetMonitoringTimeInMinutes() => this.MonitoringTimeInMinutes.HasValue;
        ...
        /// </summary>
        public List<RollbackTrigger> RollbackTriggers { get; set; } = AWSConfigs.InitializeCollections ? new List<RollbackTrigger>() : null;

        /// <summary>
        /// Checks to see if the RollbackTriggers property is set.
        /// </summary>
        internal bool IsSetRollbackTriggers() => this.RollbackTriggers != null && (this.RollbackTriggers.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
