...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecurringPaymentTermUnmarshaller : IJsonUnmarshaller<RecurringPaymentTerm, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecurringPaymentTerm Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
