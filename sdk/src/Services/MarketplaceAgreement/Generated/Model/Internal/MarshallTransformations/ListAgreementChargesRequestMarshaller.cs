...
{
    /// <summary>
    /// ListAgreementCharges Request Marshaller
    /// </summary>       
    public class ListAgreementChargesRequestMarshaller : IMarshaller<IRequest, ListAgreementChargesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAgreementChargesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAgreementChargesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MarketplaceAgreement");
            string target = "AWSMPCommerceService_v20200301.ListAgreementCharges";
        ...
        private static ListAgreementChargesRequestMarshaller _instance = new ListAgreementChargesRequestMarshaller();        

        internal static ListAgreementChargesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgreementChargesRequestMarshaller Instance
        {
            get
            {
                return _instance;
