...
{
    /// <summary>
    /// Response Unmarshaller for CancelAgreement operation
    /// </summary>  
    public class CancelAgreementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CancelAgreementResponseUnmarshaller _instance = new CancelAgreementResponseUnmarshaller();        

        internal static CancelAgreementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelAgreementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
