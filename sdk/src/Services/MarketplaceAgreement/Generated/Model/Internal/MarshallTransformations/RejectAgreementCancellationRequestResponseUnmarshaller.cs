...
{
    /// <summary>
    /// Response Unmarshaller for RejectAgreementCancellationRequest operation
    /// </summary>  
    public class RejectAgreementCancellationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectAgreementCancellationRequestResponse response = new RejectAgreementCancellationRequestResponse();
        ...
        private static RejectAgreementCancellationRequestResponseUnmarshaller _instance = new RejectAgreementCancellationRequestResponseUnmarshaller();        

        internal static RejectAgreementCancellationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectAgreementCancellationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
