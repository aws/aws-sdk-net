...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    public class PaymentScheduleTermTemplateUnmarshaller : IJsonUnmarshaller<PaymentScheduleTermTemplate, JsonUnmarshallerContext>
    {
        ...
        private static PaymentScheduleTermTemplateUnmarshaller _instance = new PaymentScheduleTermTemplateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PaymentScheduleTermTemplateUnmarshaller Instance
        {
            get
            {
                return _instance;
