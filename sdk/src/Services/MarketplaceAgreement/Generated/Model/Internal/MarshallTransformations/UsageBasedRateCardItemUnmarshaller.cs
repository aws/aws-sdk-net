...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageBasedRateCardItemUnmarshaller : IUnmarshaller<UsageBasedRateCardItem, XmlUnmarshallerContext>, IUnmarshaller<UsageBasedRateCardItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        UsageBasedRateCardItem IUnmarshaller<UsageBasedRateCardItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public UsageBasedRateCardItem Unmarshall(JsonUnmarshallerContext context)
        {
