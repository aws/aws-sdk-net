...
{
    /// <summary>
    /// ListBillingAdjustmentRequests Request Marshaller
    /// </summary>       
    public class ListBillingAdjustmentRequestsRequestMarshaller : IMarshaller<IRequest, ListBillingAdjustmentRequestsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListBillingAdjustmentRequestsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListBillingAdjustmentRequestsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MarketplaceAgreement");
            string target = "AWSMPCommerceService_v20200301.ListBillingAdjustmentRequests";
        ...
        private static ListBillingAdjustmentRequestsRequestMarshaller _instance = new ListBillingAdjustmentRequestsRequestMarshaller();        

        internal static ListBillingAdjustmentRequestsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBillingAdjustmentRequestsRequestMarshaller Instance
        {
            get
            {
                return _instance;
