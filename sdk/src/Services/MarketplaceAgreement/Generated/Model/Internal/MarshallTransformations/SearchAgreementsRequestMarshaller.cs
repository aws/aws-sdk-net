...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SearchAgreementsRequestMarshaller : IMarshaller<IRequest, SearchAgreementsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchAgreementsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchAgreementsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MarketplaceAgreement");
            string target = "AWSMPCommerceService_v20200301.SearchAgreements";
        ...
        private static SearchAgreementsRequestMarshaller _instance = new SearchAgreementsRequestMarshaller();        

        internal static SearchAgreementsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchAgreementsRequestMarshaller Instance
        {
            get
            {
                return _instance;
