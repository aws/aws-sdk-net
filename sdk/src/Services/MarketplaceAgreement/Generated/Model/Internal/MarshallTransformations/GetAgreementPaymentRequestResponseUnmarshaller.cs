...
{
    /// <summary>
    /// Response Unmarshaller for GetAgreementPaymentRequest operation
    /// </summary>  
    public class GetAgreementPaymentRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgreementPaymentRequestResponse response = new GetAgreementPaymentRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ChargeAmount = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("chargeId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ChargeId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PaymentRequestId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetAgreementPaymentRequestResponseUnmarshaller _instance = new GetAgreementPaymentRequestResponseUnmarshaller();        

        internal static GetAgreementPaymentRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgreementPaymentRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
