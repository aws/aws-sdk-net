...
{
    /// <summary>
    /// Response Unmarshaller for GetAgreementCancellationRequest operation
    /// </summary>  
    public class GetAgreementCancellationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgreementCancellationRequestResponse response = new GetAgreementCancellationRequestResponse();
        ...
        private static GetAgreementCancellationRequestResponseUnmarshaller _instance = new GetAgreementCancellationRequestResponseUnmarshaller();        

        internal static GetAgreementCancellationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgreementCancellationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
