...
{
    /// <summary>
    /// Response Unmarshaller for AcceptAgreementCancellationRequest operation
    /// </summary>  
    public class AcceptAgreementCancellationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptAgreementCancellationRequestResponse response = new AcceptAgreementCancellationRequestResponse();
        ...
        private static AcceptAgreementCancellationRequestResponseUnmarshaller _instance = new AcceptAgreementCancellationRequestResponseUnmarshaller();        

        internal static AcceptAgreementCancellationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptAgreementCancellationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
