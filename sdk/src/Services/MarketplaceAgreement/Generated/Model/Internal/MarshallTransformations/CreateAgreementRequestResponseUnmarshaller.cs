...
{
    /// <summary>
    /// Response Unmarshaller for CreateAgreementRequest operation
    /// </summary>  
    public class CreateAgreementRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAgreementRequestResponse response = new CreateAgreementRequestResponse();
        ...
        private static CreateAgreementRequestResponseUnmarshaller _instance = new CreateAgreementRequestResponseUnmarshaller();        

        internal static CreateAgreementRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgreementRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
