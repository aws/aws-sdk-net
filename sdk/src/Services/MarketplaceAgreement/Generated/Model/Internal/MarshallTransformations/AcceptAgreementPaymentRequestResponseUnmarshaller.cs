...
{
    /// <summary>
    /// Response Unmarshaller for AcceptAgreementPaymentRequest operation
    /// </summary>  
    public class AcceptAgreementPaymentRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptAgreementPaymentRequestResponse response = new AcceptAgreementPaymentRequestResponse();
        ...
        private static AcceptAgreementPaymentRequestResponseUnmarshaller _instance = new AcceptAgreementPaymentRequestResponseUnmarshaller();        

        internal static AcceptAgreementPaymentRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptAgreementPaymentRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
