...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageBasedPricingTermUnmarshaller : IJsonUnmarshaller<UsageBasedPricingTerm, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UsageBasedPricingTerm Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UsageBasedRateCardItem, UsageBasedRateCardItemUnmarshaller>(UsageBasedRateCardItemUnmarshaller.Instance);
