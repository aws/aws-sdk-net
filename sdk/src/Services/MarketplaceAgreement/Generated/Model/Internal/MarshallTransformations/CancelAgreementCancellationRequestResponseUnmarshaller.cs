...
{
    /// <summary>
    /// Response Unmarshaller for CancelAgreementCancellationRequest operation
    /// </summary>  
    public class CancelAgreementCancellationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelAgreementCancellationRequestResponse response = new CancelAgreementCancellationRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("agreementCancellationRequestId", targetDepth))
                {
                    ...
                    response.AgreementCancellationRequestId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CancelAgreementCancellationRequestResponseUnmarshaller _instance = new CancelAgreementCancellationRequestResponseUnmarshaller();        

        internal static CancelAgreementCancellationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelAgreementCancellationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
