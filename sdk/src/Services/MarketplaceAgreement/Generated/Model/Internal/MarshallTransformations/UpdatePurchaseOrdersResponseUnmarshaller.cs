...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePurchaseOrders operation
    /// </summary>  
    public class UpdatePurchaseOrdersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePurchaseOrdersResponse response = new UpdatePurchaseOrdersResponse();
        ...
        private static UpdatePurchaseOrdersResponseUnmarshaller _instance = new UpdatePurchaseOrdersResponseUnmarshaller();        

        internal static UpdatePurchaseOrdersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePurchaseOrdersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
