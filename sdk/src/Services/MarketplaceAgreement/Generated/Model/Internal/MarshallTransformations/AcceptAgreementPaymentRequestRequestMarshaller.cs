...
{
    /// <summary>
    /// AcceptAgreementPaymentRequest Request Marshaller
    /// </summary>       
    public class AcceptAgreementPaymentRequestRequestMarshaller : IMarshaller<IRequest, AcceptAgreementPaymentRequestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AcceptAgreementPaymentRequestRequest)input);
        }
        ...
        internal static AcceptAgreementPaymentRequestRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptAgreementPaymentRequestRequestMarshaller Instance
        {
            get
            {
                return _instance;
