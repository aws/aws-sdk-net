...
{
    /// <summary>
    /// Response Unmarshaller for GetBillingAdjustmentRequest operation
    /// </summary>  
    public class GetBillingAdjustmentRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBillingAdjustmentRequestResponse response = new GetBillingAdjustmentRequestResponse();
            ...
            {
                if (context.TestExpression("adjustmentAmount", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AdjustmentAmount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("adjustmentReasonCode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AdjustmentReasonCode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("billingAdjustmentRequestId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BillingAdjustmentRequestId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OriginalInvoiceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetBillingAdjustmentRequestResponseUnmarshaller _instance = new GetBillingAdjustmentRequestResponseUnmarshaller();        

        internal static GetBillingAdjustmentRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBillingAdjustmentRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
