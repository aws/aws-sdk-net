...
{
    /// <summary>
    /// Response Unmarshaller for SendAgreementCancellationRequest operation
    /// </summary>  
    public class SendAgreementCancellationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendAgreementCancellationRequestResponse response = new SendAgreementCancellationRequestResponse();
        ...
        private static SendAgreementCancellationRequestResponseUnmarshaller _instance = new SendAgreementCancellationRequestResponseUnmarshaller();        

        internal static SendAgreementCancellationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendAgreementCancellationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
