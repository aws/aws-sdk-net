...
namespace Amazon.MarketplaceAgreement
{
    ...
    public partial class AmazonMarketplaceAgreementClient : AmazonServiceClient, IAmazonMarketplaceAgreement
    {
        ...
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the DescribeAgreement operation on AmazonMarketplaceAgreementClient.</param>
        ...
        /// 
        /// <returns>Returns a  DescribeAgreementResult from MarketplaceAgreement.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-agreement-2020-03-01/DescribeAgreement">REST API Reference for DescribeAgreement Operation</seealso>
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GetAgreementTerms operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GetAgreementTerms operation on AmazonMarketplaceAgreementClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGetAgreementTerms
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-agreement-2020-03-01/GetAgreementTerms">REST API Reference for GetAgreementTerms Operation</seealso>
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  GetAgreementTerms operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetAgreementTerms.</param>
        /// 
        /// <returns>Returns a  GetAgreementTermsResult from MarketplaceAgreement.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-agreement-2020-03-01/GetAgreementTerms">REST API Reference for GetAgreementTerms Operation</seealso>
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the SearchAgreements operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the SearchAgreements operation on AmazonMarketplaceAgreementClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndSearchAgreements
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-agreement-2020-03-01/SearchAgreements">REST API Reference for SearchAgreements Operation</seealso>
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  SearchAgreements operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginSearchAgreements.</param>
        /// 
        /// <returns>Returns a  SearchAgreementsResult from MarketplaceAgreement.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-agreement-2020-03-01/SearchAgreements">REST API Reference for SearchAgreements Operation</seealso>
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonMarketplaceAgreementEndpointResolver();
