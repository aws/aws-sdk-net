...
namespace Amazon.Mobile
{
    ...
    public partial class AmazonMobileConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Mobile", "3.7.300.84");

        private static readonly AmazonMobileEndpointResolver EndpointResolver =
            new AmazonMobileEndpointResolver();
