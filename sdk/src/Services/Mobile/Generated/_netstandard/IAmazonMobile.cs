...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMobileConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMobileConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMobileConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMobileConfig to create AmazonMobileClient");
            }

            return awsCredentials == null ? 
                    new AmazonMobileClient(serviceClientConfig) :
                    new AmazonMobileClient(awsCredentials, serviceClientConfig);
        }
