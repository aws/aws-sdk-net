...
{
    /// <summary>
    /// WorkflowExportConfig Marshaller
    /// </summary>
    public class WorkflowExportConfigMarshaller : IRequestMarshaller<WorkflowExportConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(WorkflowExportConfig requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static WorkflowExportConfigMarshaller Instance = new WorkflowExportConfigMarshaller();
