...
namespace Amazon.NovaAct.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetWorkflowDefinitionRequestMarshaller : IMarshaller<IRequest, GetWorkflowDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetWorkflowDefinitionRequestMarshaller _instance = new GetWorkflowDefinitionRequestMarshaller();        

        internal static GetWorkflowDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
