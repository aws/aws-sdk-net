...
{
    /// <summary>
    /// CreateAct Request Marshaller
    /// </summary>       
    public class CreateActRequestMarshaller : IMarshaller<IRequest, CreateActRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateActRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateActRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workflow-definitions/{workflowDefinitionName}/workflow-runs/{workflowRunId}/sessions/{sessionId}/acts";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetToolSpecs())
            {
                context.Writer.WritePropertyName("toolSpecs");
                context.Writer.WriteStartArray();
                foreach(var publicRequestToolSpecsListValue in publicRequest.ToolSpecs)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = ToolSpecMarshaller.Instance;
                    marshaller.Marshall(publicRequestToolSpecsListValue, context);
        ...
        private static CreateActRequestMarshaller _instance = new CreateActRequestMarshaller();        

        internal static CreateActRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateActRequestMarshaller Instance
        {
            get
            {
                return _instance;
