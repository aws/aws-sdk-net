...
namespace Amazon.NovaAct.Model.Internal.MarshallTransformations
{
    ...
    /// ToolSpec Marshaller
    /// </summary>
    public class ToolSpecMarshaller : IRequestMarshaller<ToolSpec, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ToolSpec requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static ToolSpecMarshaller Instance = new ToolSpecMarshaller();
