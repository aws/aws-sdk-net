...
namespace Amazon.NovaAct.Model.Internal.MarshallTransformations
{
    ...
    /// ActError Marshaller
    /// </summary>
    public class ActErrorMarshaller : IRequestMarshaller<ActError, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ActError requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static ActErrorMarshaller Instance = new ActErrorMarshaller();
