    ...
    public class WorkflowRunSummaryUnmarshaller : IJsonUnmarshaller<WorkflowRunSummary, JsonUnmarshallerContext>
    {
        ...
        public WorkflowRunSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("traceLocation", targetDepth, ref reader))
                {
                    var unmarshaller = TraceLocationUnmarshaller.Instance;
                    unmarshalledObject.TraceLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("workflowRunArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WorkflowRunArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
