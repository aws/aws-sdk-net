...
namespace Amazon.NovaAct.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActSummaryUnmarshaller : IJsonUnmarshaller<ActSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("actId", targetDepth))
                {
                    ...
                    unmarshalledObject.ActId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
