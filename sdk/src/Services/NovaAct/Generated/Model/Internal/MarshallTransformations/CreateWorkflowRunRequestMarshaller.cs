...
namespace Amazon.NovaAct.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateWorkflowRunRequestMarshaller : IMarshaller<IRequest, CreateWorkflowRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateWorkflowRunRequestMarshaller _instance = new CreateWorkflowRunRequestMarshaller();        

        internal static CreateWorkflowRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkflowRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
