...
{
    /// <summary>
    /// UpdateAct Request Marshaller
    /// </summary>       
    public class UpdateActRequestMarshaller : IMarshaller<IRequest, UpdateActRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateActRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateActRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workflow-definitions/{workflowDefinitionName}/workflow-runs/{workflowRunId}/sessions/{sessionId}/acts/{actId}";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetError())
            {
                ...
                var marshaller = ActErrorMarshaller.Instance;
        ...
        private static UpdateActRequestMarshaller _instance = new UpdateActRequestMarshaller();        

        internal static UpdateActRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateActRequestMarshaller Instance
        {
            get
            {
                return _instance;
