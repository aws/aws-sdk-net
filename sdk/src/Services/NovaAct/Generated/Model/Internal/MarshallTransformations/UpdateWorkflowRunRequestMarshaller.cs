...
{
    /// <summary>
    /// UpdateWorkflowRun Request Marshaller
    /// </summary>       
    public class UpdateWorkflowRunRequestMarshaller : IMarshaller<IRequest, UpdateWorkflowRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateWorkflowRunRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateWorkflowRunRequest publicRequest)
        {
        ...
        private static UpdateWorkflowRunRequestMarshaller _instance = new UpdateWorkflowRunRequestMarshaller();        

        internal static UpdateWorkflowRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkflowRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
