...
namespace Amazon.NovaAct.Model
{
    ...
    public interface IListWorkflowRunsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListWorkflowRunsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the WorkflowRunSummaries
        /// </summary>
        IPaginatedEnumerable<WorkflowRunSummary> WorkflowRunSummaries { get; }
    }
}