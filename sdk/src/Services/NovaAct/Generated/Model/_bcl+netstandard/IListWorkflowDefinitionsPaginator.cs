...
namespace Amazon.NovaAct.Model
{
    ...
    public partial interface IListWorkflowDefinitionsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListWorkflowDefinitionsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the WorkflowDefinitionSummaries
        /// </summary>
        IPaginatedEnumerable<WorkflowDefinitionSummary> WorkflowDefinitionSummaries { get; }
    }
}