...
namespace Amazon.NovaAct.Internal
{
    ...
    public class AmazonNovaActAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNovaActAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for NovaAct.
        /// </summary>
        public AmazonNovaActAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNovaActAuthSchemeParameters
            {
    ...
    public class AmazonNovaActAuthSchemeResolver : IAuthSchemeResolver<AmazonNovaActAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNovaActAuthSchemeParameters authParameters)
        {
