...
namespace Amazon.SimpleEmail.Internal
{
    ...
    public class AmazonSimpleEmailServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSimpleEmailServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SimpleEmailService.
        /// </summary>
        public AmazonSimpleEmailServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSimpleEmailServiceAuthSchemeParameters
            {
    ...
    public class AmazonSimpleEmailServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonSimpleEmailServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSimpleEmailServiceAuthSchemeParameters authParameters)
        {
