...
namespace Amazon.SimpleEmail.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidFirehoseDestinationException : AmazonSimpleEmailServiceException
    {
        private string _configurationSetName;
        private string _eventDestinationName;

        /// <summary>
        /// Default constructor for InvalidFirehoseDestinationException
        /// message.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new InvalidFirehoseDestinationException with the specified error
        /// message.
        /// </summary>
        /// <param name="message">
        ...
        public InvalidFirehoseDestinationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidFirehoseDestinationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected InvalidFirehoseDestinationException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
