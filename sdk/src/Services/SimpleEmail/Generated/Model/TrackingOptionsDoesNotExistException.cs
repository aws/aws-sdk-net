...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class TrackingOptionsDoesNotExistException : AmazonSimpleEmailServiceException
    {
        ...
        public TrackingOptionsDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TrackingOptionsDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
