...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    public class ConfigurationSetUnmarshaller : IXmlUnmarshaller<ConfigurationSet, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ConfigurationSet Unmarshall(XmlUnmarshallerContext context)
        {
            ConfigurationSet unmarshalledObject = new ConfigurationSet();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfigurationSetUnmarshaller Instance
        {
            get
            {
                return _instance;
