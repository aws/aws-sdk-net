...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateReceiptRuleRequestMarshaller : IMarshaller<IRequest, UpdateReceiptRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateReceiptRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateReceiptRuleRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static UpdateReceiptRuleRequestMarshaller _instance = new UpdateReceiptRuleRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateReceiptRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
