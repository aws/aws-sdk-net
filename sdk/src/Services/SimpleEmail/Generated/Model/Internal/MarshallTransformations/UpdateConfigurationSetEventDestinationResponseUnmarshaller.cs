...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationSetEventDestination operation
    /// </summary>  
    public class UpdateConfigurationSetEventDestinationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationSetEventDestinationResponse response = new UpdateConfigurationSetEventDestinationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateConfigurationSetEventDestinationResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("EventDestinationDoesNotExist"))
            {
                return new EventDestinationDoesNotExistException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationSetEventDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
