...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetActiveReceiptRuleSetResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetActiveReceiptRuleSetResponse response = new SetActiveReceiptRuleSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetActiveReceiptRuleSetResult", 2))
                    {
        ...
        private static SetActiveReceiptRuleSetResponseUnmarshaller _instance = new SetActiveReceiptRuleSetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetActiveReceiptRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
