...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetReceiptRulePositionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetReceiptRulePositionResponse response = new SetReceiptRulePositionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetReceiptRulePositionResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new RuleDoesNotExistException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static SetReceiptRulePositionResponseUnmarshaller _instance = new SetReceiptRulePositionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetReceiptRulePositionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
