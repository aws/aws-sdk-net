...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetIdentityMailFromDomainResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetIdentityMailFromDomainResponse response = new SetIdentityMailFromDomainResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetIdentityMailFromDomainResult", 2))
                    {
        ...
        private static SetIdentityMailFromDomainResponseUnmarshaller _instance = new SetIdentityMailFromDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetIdentityMailFromDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
