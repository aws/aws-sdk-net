...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteReceiptRuleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteReceiptRuleResponse response = new DeleteReceiptRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteReceiptRuleResult", 2))
                    {
        ...
        private static DeleteReceiptRuleResponseUnmarshaller _instance = new DeleteReceiptRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReceiptRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
