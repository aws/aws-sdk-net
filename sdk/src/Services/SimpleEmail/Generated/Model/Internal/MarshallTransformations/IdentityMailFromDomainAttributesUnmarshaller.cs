...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    public class IdentityMailFromDomainAttributesUnmarshaller : IXmlUnmarshaller<IdentityMailFromDomainAttributes, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public IdentityMailFromDomainAttributes Unmarshall(XmlUnmarshallerContext context)
        {
            IdentityMailFromDomainAttributes unmarshalledObject = new IdentityMailFromDomainAttributes();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("BehaviorOnMXFailure", targetDepth))
                    {
                        ...
                        unmarshalledObject.BehaviorOnMXFailure = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("MailFromDomain", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.MailFromDomain = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("MailFromDomainStatus", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.MailFromDomainStatus = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IdentityMailFromDomainAttributesUnmarshaller Instance
        {
            get
            {
                return _instance;
