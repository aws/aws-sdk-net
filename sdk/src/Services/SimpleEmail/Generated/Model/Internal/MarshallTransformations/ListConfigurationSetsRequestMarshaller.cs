...
{
    /// <summary>
    /// ListConfigurationSets Request Marshaller
    /// </summary>       
    public class ListConfigurationSetsRequestMarshaller : IMarshaller<IRequest, ListConfigurationSetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListConfigurationSetsRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListConfigurationSetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
