...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationSetSendingEnabled operation
    /// </summary>  
    public class UpdateConfigurationSetSendingEnabledResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationSetSendingEnabledResponse response = new UpdateConfigurationSetSendingEnabledResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateConfigurationSetSendingEnabledResult", 2))
                    {
        ...
        private static UpdateConfigurationSetSendingEnabledResponseUnmarshaller _instance = new UpdateConfigurationSetSendingEnabledResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationSetSendingEnabledResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
