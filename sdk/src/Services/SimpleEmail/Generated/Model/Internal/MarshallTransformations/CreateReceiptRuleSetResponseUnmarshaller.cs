...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateReceiptRuleSetResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateReceiptRuleSetResponse response = new CreateReceiptRuleSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateReceiptRuleSetResult", 2))
                    {
        ...
        private static CreateReceiptRuleSetResponseUnmarshaller _instance = new CreateReceiptRuleSetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReceiptRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
