...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    public class TemplateMetadataUnmarshaller : IXmlUnmarshaller<TemplateMetadata, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TemplateMetadata Unmarshall(XmlUnmarshallerContext context)
        {
            TemplateMetadata unmarshalledObject = new TemplateMetadata();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TemplateMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
