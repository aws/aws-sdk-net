...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class CannotDeleteException : AmazonSimpleEmailServiceException
    {
        ...
        public CannotDeleteException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CannotDeleteException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
