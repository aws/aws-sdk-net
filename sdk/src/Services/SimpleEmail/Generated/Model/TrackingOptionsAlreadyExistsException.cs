...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class TrackingOptionsAlreadyExistsException : AmazonSimpleEmailServiceException
    {
        ...
        public TrackingOptionsAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TrackingOptionsAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
