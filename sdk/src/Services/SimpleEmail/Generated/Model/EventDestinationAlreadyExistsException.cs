...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class EventDestinationAlreadyExistsException : AmazonSimpleEmailServiceException
    {
        ...
        public EventDestinationAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EventDestinationAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
