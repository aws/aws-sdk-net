...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class ConfigurationSetSendingPausedException : AmazonSimpleEmailServiceException
    {
        ...
        public ConfigurationSetSendingPausedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConfigurationSetSendingPausedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
