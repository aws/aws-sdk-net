...
namespace Amazon.IoTThingsGraph.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonIoTThingsGraphAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTThingsGraphAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTThingsGraph.
        /// </summary>
        public AmazonIoTThingsGraphAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTThingsGraphAuthSchemeParameters
            {
    ...
    public class AmazonIoTThingsGraphAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTThingsGraphAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTThingsGraphAuthSchemeParameters authParameters)
        {
