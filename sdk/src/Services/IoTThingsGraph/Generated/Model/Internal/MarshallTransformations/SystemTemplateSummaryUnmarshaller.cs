...
namespace Amazon.IoTThingsGraph.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SystemTemplateSummaryUnmarshaller : IJsonUnmarshaller<SystemTemplateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SystemTemplateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("revisionNumber", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.RevisionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
