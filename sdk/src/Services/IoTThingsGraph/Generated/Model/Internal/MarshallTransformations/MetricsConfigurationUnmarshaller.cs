...
namespace Amazon.IoTThingsGraph.Model.Internal.MarshallTransformations
{
    ...
    public class MetricsConfigurationUnmarshaller : IUnmarshaller<MetricsConfiguration, XmlUnmarshallerContext>, IUnmarshaller<MetricsConfiguration, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        MetricsConfiguration IUnmarshaller<MetricsConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MetricsConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("metricRuleRoleArn", targetDepth))
                {
                    ...
                    unmarshalledObject.MetricRuleRoleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
