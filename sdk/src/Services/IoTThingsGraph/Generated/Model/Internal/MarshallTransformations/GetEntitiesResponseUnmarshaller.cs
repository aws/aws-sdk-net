...
{
    /// <summary>
    /// Response Unmarshaller for GetEntities operation
    /// </summary>  
    public class GetEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetEntitiesResponseUnmarshaller _instance = new GetEntitiesResponseUnmarshaller();        

        internal static GetEntitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEntitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
