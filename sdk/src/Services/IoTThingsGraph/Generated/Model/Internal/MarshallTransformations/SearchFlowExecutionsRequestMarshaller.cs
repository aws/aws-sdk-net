...
{
    /// <summary>
    /// SearchFlowExecutions Request Marshaller
    /// </summary>       
    public class SearchFlowExecutionsRequestMarshaller : IMarshaller<IRequest, SearchFlowExecutionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchFlowExecutionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchFlowExecutionsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetFlowExecutionId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.FlowExecutionId);
            }
            ...
            if(publicRequest.IsSetSystemInstanceId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SystemInstanceId);
            }
        ...
        private static SearchFlowExecutionsRequestMarshaller _instance = new SearchFlowExecutionsRequestMarshaller();        

        internal static SearchFlowExecutionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchFlowExecutionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
