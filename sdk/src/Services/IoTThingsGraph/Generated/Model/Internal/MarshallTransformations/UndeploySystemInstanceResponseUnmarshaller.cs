...
{
    /// <summary>
    /// Response Unmarshaller for UndeploySystemInstance operation
    /// </summary>  
    public class UndeploySystemInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UndeploySystemInstanceResponse response = new UndeploySystemInstanceResponse();
        ...
        private static UndeploySystemInstanceResponseUnmarshaller _instance = new UndeploySystemInstanceResponseUnmarshaller();        

        internal static UndeploySystemInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UndeploySystemInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
