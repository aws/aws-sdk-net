...
{
    /// <summary>
    /// Response Unmarshaller for CreateSystemTemplate operation
    /// </summary>  
    public class CreateSystemTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSystemTemplateResponse response = new CreateSystemTemplateResponse();
        ...
        private static CreateSystemTemplateResponseUnmarshaller _instance = new CreateSystemTemplateResponseUnmarshaller();        

        internal static CreateSystemTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSystemTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
