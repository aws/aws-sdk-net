...
namespace Amazon.IoTThingsGraph.Model.Internal.MarshallTransformations
{
    ...
    public class FlowTemplateDescriptionUnmarshaller : IJsonUnmarshaller<FlowTemplateDescription, JsonUnmarshallerContext>
    {
        ...
        private static FlowTemplateDescriptionUnmarshaller _instance = new FlowTemplateDescriptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FlowTemplateDescriptionUnmarshaller Instance
        {
            get
            {
                return _instance;
