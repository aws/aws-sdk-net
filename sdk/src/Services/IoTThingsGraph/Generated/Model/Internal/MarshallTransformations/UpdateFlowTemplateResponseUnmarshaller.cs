...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFlowTemplate operation
    /// </summary>  
    public class UpdateFlowTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFlowTemplateResponse response = new UpdateFlowTemplateResponse();
        ...
        private static UpdateFlowTemplateResponseUnmarshaller _instance = new UpdateFlowTemplateResponseUnmarshaller();        

        internal static UpdateFlowTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
