...
{
    /// <summary>
    /// Response Unmarshaller for SearchEntities operation
    /// </summary>  
    public class SearchEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EntityDescription, EntityDescriptionUnmarshaller>(EntityDescriptionUnmarshaller.Instance);
        ...
        private static SearchEntitiesResponseUnmarshaller _instance = new SearchEntitiesResponseUnmarshaller();        

        internal static SearchEntitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchEntitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
