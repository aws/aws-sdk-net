...
{
    /// <summary>
    /// Response Unmarshaller for DeprecateFlowTemplate operation
    /// </summary>  
    public class DeprecateFlowTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeprecateFlowTemplateResponse response = new DeprecateFlowTemplateResponse();
        ...
        private static DeprecateFlowTemplateResponseUnmarshaller _instance = new DeprecateFlowTemplateResponseUnmarshaller();        

        internal static DeprecateFlowTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeprecateFlowTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
