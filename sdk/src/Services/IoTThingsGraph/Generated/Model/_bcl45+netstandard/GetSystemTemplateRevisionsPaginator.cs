...
namespace Amazon.IoTThingsGraph.Model
{
    ...
    internal sealed partial class GetSystemTemplateRevisionsPaginator : IPaginator<GetSystemTemplateRevisionsResponse>, IGetSystemTemplateRevisionsPaginator
    {
        ...
        public IPaginatedEnumerable<SystemTemplateSummary> Summaries => 
            new PaginatedResultKeyResponse<GetSystemTemplateRevisionsResponse, SystemTemplateSummary>(this, (i) => i.Summaries);
        ...
        async IAsyncEnumerable<GetSystemTemplateRevisionsResponse> IPaginator<GetSystemTemplateRevisionsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
