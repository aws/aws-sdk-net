...
namespace Amazon.IoTThingsGraph.Model
{
    ...
    internal sealed partial class GetFlowTemplateRevisionsPaginator : IPaginator<GetFlowTemplateRevisionsResponse>, IGetFlowTemplateRevisionsPaginator
    {
        ...
        public IPaginatedEnumerable<FlowTemplateSummary> Summaries => 
            new PaginatedResultKeyResponse<GetFlowTemplateRevisionsResponse, FlowTemplateSummary>(this, (i) => i.Summaries ?? new List<FlowTemplateSummary>());
        ...
        async IAsyncEnumerable<GetFlowTemplateRevisionsResponse> IPaginator<GetFlowTemplateRevisionsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
