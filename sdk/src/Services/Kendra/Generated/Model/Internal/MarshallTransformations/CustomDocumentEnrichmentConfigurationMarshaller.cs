...
{
    /// <summary>
    /// CustomDocumentEnrichmentConfiguration Marshaller
    /// </summary>
    public class CustomDocumentEnrichmentConfigurationMarshaller : IRequestMarshaller<CustomDocumentEnrichmentConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CustomDocumentEnrichmentConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetInlineConfigurations())
            {
                ...
                foreach(var requestObjectInlineConfigurationsListValue in requestObject.InlineConfigurations)
                {
                    ...
                    var marshaller = InlineCustomDocumentEnrichmentConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CustomDocumentEnrichmentConfigurationMarshaller Instance = new CustomDocumentEnrichmentConfigurationMarshaller();
