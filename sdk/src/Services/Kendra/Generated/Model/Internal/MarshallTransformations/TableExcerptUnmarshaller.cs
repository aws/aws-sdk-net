    ...
    public class TableExcerptUnmarshaller : IJsonUnmarshaller<TableExcerpt, JsonUnmarshallerContext>
    {
        ...
        public TableExcerpt Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TotalNumberOfRows", targetDepth, ref reader))
                {
        ...
        private static TableExcerptUnmarshaller _instance = new TableExcerptUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TableExcerptUnmarshaller Instance
        {
            get
            {
                return _instance;
