...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateDataSourceResponseUnmarshaller _instance = new UpdateDataSourceResponseUnmarshaller();        

        internal static UpdateDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
