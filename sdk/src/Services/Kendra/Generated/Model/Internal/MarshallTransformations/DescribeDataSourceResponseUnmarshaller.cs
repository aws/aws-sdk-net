...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataSource operation
    /// </summary>  
    public class DescribeDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CustomDocumentEnrichmentConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = CustomDocumentEnrichmentConfigurationUnmarshaller.Instance;
                    response.CustomDocumentEnrichmentConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.IndexId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeDataSourceResponseUnmarshaller _instance = new DescribeDataSourceResponseUnmarshaller();        

        internal static DescribeDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
