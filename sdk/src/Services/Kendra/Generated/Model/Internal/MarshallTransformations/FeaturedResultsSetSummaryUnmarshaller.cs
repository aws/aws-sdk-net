...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FeaturedResultsSetSummaryUnmarshaller : IUnmarshaller<FeaturedResultsSetSummary, XmlUnmarshallerContext>, IUnmarshaller<FeaturedResultsSetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FeaturedResultsSetSummary IUnmarshaller<FeaturedResultsSetSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FeaturedResultsSetSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
