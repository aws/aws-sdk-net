...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFaq operation
    /// </summary>  
    public class DescribeFaqResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFaqResponse response = new DescribeFaqResponse();
        ...
        private static DescribeFaqResponseUnmarshaller _instance = new DescribeFaqResponseUnmarshaller();        

        internal static DescribeFaqResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFaqResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
