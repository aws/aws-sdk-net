...
{
    /// <summary>
    /// Response Unmarshaller for DescribeQuerySuggestionsConfig operation
    /// </summary>  
    public class DescribeQuerySuggestionsConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeQuerySuggestionsConfigResponse response = new DescribeQuerySuggestionsConfigResponse();
        ...
        private static DescribeQuerySuggestionsConfigResponseUnmarshaller _instance = new DescribeQuerySuggestionsConfigResponseUnmarshaller();        

        internal static DescribeQuerySuggestionsConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQuerySuggestionsConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
