...
{
    /// <summary>
    /// CreateAccessControlConfiguration Request Marshaller
    /// </summary>       
    public class CreateAccessControlConfigurationRequestMarshaller : IMarshaller<IRequest, CreateAccessControlConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccessControlConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccessControlConfigurationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kendra");
            string target = "AWSKendraFrontendService.CreateAccessControlConfiguration";
        ...
        private static CreateAccessControlConfigurationRequestMarshaller _instance = new CreateAccessControlConfigurationRequestMarshaller();        

        internal static CreateAccessControlConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessControlConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
