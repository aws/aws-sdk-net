...
namespace Amazon.Macie2.Model
{
    ...
    public partial class ListClassificationScopesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ClassificationScopeSummary> ClassificationScopes { get; set; } = AWSConfigs.InitializeCollections ? new List<ClassificationScopeSummary>() : null;

        /// <summary>
        /// Checks to see if the ClassificationScopes property is set.
        /// </summary>
        internal bool IsSetClassificationScopes() => this.ClassificationScopes != null && (this.ClassificationScopes.Count > 0 || !AWSConfigs.InitializeCollections);
