...
{
    /// <summary>
    /// Container for the parameters to the TestCustomDataIdentifier operation. Tests criteria
    ...
    public partial class TestCustomDataIdentifierRequest : AmazonMacie2Request
    {
        ...
        /// <summary>
        /// Checks to see if the SampleText property is set.
        /// </summary>
        internal bool IsSetSampleText() => this.SampleText != null;
    }
}
