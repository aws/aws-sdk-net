...
namespace Amazon.Macie2.Model
{
    ...
    public partial class BucketCountPolicyAllowsUnencryptedObjectUploads
    {
        ...
        /// </para>
        /// </summary>
        public long? AllowsUnencryptedObjectUploads { get; set; }

        /// <summary>
        /// Checks to see if the AllowsUnencryptedObjectUploads property is set.
        /// </summary>
        internal bool IsSetAllowsUnencryptedObjectUploads() => this.AllowsUnencryptedObjectUploads.HasValue;
        ...
        /// </para>
        /// </summary>
        public long? DeniesUnencryptedObjectUploads { get; set; }

        /// <summary>
        /// Checks to see if the DeniesUnencryptedObjectUploads property is set.
        /// </summary>
        internal bool IsSetDeniesUnencryptedObjectUploads() => this.DeniesUnencryptedObjectUploads.HasValue;
