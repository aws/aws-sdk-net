...
{
    /// <summary>
    /// Paginator for the ListCustomDataIdentifiers operation
    /// </summary>
    internal sealed partial class ListCustomDataIdentifiersPaginator : IPaginator<ListCustomDataIdentifiersResponse>, IListCustomDataIdentifiersPaginator
    {
        ...
        async IAsyncEnumerable<ListCustomDataIdentifiersResponse> IPaginator<ListCustomDataIdentifiersResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
