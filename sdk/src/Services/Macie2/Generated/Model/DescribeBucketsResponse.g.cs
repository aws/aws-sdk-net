...
namespace Amazon.Macie2.Model
{
    ...
    public partial class DescribeBucketsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<BucketMetadata> Buckets { get; set; } = AWSConfigs.InitializeCollections ? new List<BucketMetadata>() : null;

        /// <summary>
        /// Checks to see if the Buckets property is set.
        /// </summary>
        internal bool IsSetBuckets() => this.Buckets != null && (this.Buckets.Count > 0 || !AWSConfigs.InitializeCollections);
