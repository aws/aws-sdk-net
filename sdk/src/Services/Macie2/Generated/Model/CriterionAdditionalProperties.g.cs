...
namespace Amazon.Macie2.Model
{
    ...
    public partial class CriterionAdditionalProperties
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> EqExactMatch { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the EqExactMatch property is set.
        /// </summary>
        internal bool IsSetEqExactMatch() => this.EqExactMatch != null && (this.EqExactMatch.Count > 0 || !AWSConfigs.InitializeCollections);
