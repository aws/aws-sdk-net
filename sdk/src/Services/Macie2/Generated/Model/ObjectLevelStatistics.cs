...
namespace Amazon.Macie2.Model
{
    ...
    /// that Amazon Macie can't analyze in one or more S3 buckets. In a BucketMetadata object,
    /// this data is for a specific bucket. In a GetBucketStatisticsResponse object, this
    /// data is aggregated for all the buckets in the query results. If versioning is enabled
    /// for a bucket, total storage size values are based on the size of the latest version
