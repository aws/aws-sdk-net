...
{
    /// <summary>
    /// Container for the parameters to the CreateInvitations operation. Sends an Amazon Macie
    /// membership invitation to one or more accounts.
    /// </summary>
    public partial class CreateInvitationsRequest : AmazonMacie2Request
    {
        ...
        /// <summary>
        /// Checks to see if the DisableEmailNotification property is set.
        /// </summary>
        internal bool IsSetDisableEmailNotification() => this.DisableEmailNotification.HasValue;
