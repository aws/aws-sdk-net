...
namespace Amazon.Macie2.Model
{
    ...
    public partial class UpdateClassificationJobRequest : AmazonMacie2Request
    {
        ...
        /// to the schedule and other configuration settings for the job.
        /// </para>
        /// </li> <li>
        /// <para>
        ...
        /// Macie immediately begins to pause all processing tasks for the job.
        /// </para>
        ///  
        /// <para>
        /// If you pause a job when its status is RUNNING and you don't resume the job within
        /// 30 days, the job expires and Macie cancels it. You can't resume a job after it's cancelled.
        /// </para>
        /// </li></ul>
        /// </summary>
        [AWSProperty(Required=true)]
