...
namespace Amazon.Macie2.Model
{
    ...
    public partial class ListJobsFilterCriteria
    {
        ...
        /// </summary>
        public List<ListJobsFilterTerm> Excludes { get; set; } = AWSConfigs.InitializeCollections ? new List<ListJobsFilterTerm>() : null;

        /// <summary>
        /// Checks to see if the Excludes property is set.
        /// </summary>
        internal bool IsSetExcludes() => this.Excludes != null && (this.Excludes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ListJobsFilterTerm> Includes { get; set; } = AWSConfigs.InitializeCollections ? new List<ListJobsFilterTerm>() : null;

        /// <summary>
        /// Checks to see if the Includes property is set.
        /// </summary>
        internal bool IsSetIncludes() => this.Includes != null && (this.Includes.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
