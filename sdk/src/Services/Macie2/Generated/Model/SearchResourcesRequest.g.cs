...
{
    /// <summary>
    /// Container for the parameters to the SearchResources operation. Retrieves (queries)
    /// statistical data and other information about Amazon Web Services resources that Amazon
