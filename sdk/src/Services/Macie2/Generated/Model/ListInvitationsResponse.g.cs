...
namespace Amazon.Macie2.Model
{
    ...
    public partial class ListInvitationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Invitation> Invitations { get; set; } = AWSConfigs.InitializeCollections ? new List<Invitation>() : null;

        /// <summary>
        /// Checks to see if the Invitations property is set.
        /// </summary>
        internal bool IsSetInvitations() => this.Invitations != null && (this.Invitations.Count > 0 || !AWSConfigs.InitializeCollections);
