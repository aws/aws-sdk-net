...
namespace Amazon.Macie2.Model
{
    ...
    public partial class ListOrganizationAdminAccountsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<AdminAccount> AdminAccounts { get; set; } = AWSConfigs.InitializeCollections ? new List<AdminAccount>() : null;

        /// <summary>
        /// Checks to see if the AdminAccounts property is set.
        /// </summary>
        internal bool IsSetAdminAccounts() => this.AdminAccounts != null && (this.AdminAccounts.Count > 0 || !AWSConfigs.InitializeCollections);
