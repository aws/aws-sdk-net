...
{
    /// <summary>
    /// Container for the parameters to the UpdateResourceProfile operation. Updates the sensitivity
    ...
    public partial class UpdateResourceProfileRequest : AmazonMacie2Request
    {
        ...
        /// <summary>
        /// Checks to see if the SensitivityScoreOverride property is set.
        /// </summary>
        internal bool IsSetSensitivityScoreOverride() => this.SensitivityScoreOverride.HasValue;
    }
}
