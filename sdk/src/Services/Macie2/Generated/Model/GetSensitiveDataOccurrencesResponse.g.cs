...
namespace Amazon.Macie2.Model
{
    ...
    public partial class GetSensitiveDataOccurrencesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public Dictionary<string, List<DetectedDataDetails>> SensitiveDataOccurrences { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, List<DetectedDataDetails>>() : null;

        /// <summary>
        /// Checks to see if the SensitiveDataOccurrences property is set.
        /// </summary>
        internal bool IsSetSensitiveDataOccurrences() => this.SensitiveDataOccurrences != null && (this.SensitiveDataOccurrences.Count > 0 || !AWSConfigs.InitializeCollections);
