...
{
    /// <summary>
    /// Container for the parameters to the UpdateRevealConfiguration operation. Updates the
    /// status and configuration settings for retrieving occurrences of sensitive data reported
    /// by findings.
    /// </summary>
    public partial class UpdateRevealConfigurationRequest : AmazonMacie2Request
    {
        ...
        /// </para>
        /// </summary>
        public UpdateRetrievalConfiguration RetrievalConfiguration { get; set; }
