...
namespace Amazon.Macie2.Model
{
    ...
    public partial class UnprocessableEntityException : AmazonMacie2Exception
    {
        ...
        /// Construct instance of UnprocessableEntityException
        /// </summary>
        public UnprocessableEntityException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of UnprocessableEntityException
        /// </summary>
        public UnprocessableEntityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of UnprocessableEntityException
        /// </summary>
        public UnprocessableEntityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
