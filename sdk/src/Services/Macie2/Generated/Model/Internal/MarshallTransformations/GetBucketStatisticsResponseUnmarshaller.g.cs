...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetBucketStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetBucketStatisticsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("bucketCount", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BucketCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("bucketCountByEffectivePermission", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BucketCountByEffectivePermission = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("bucketCountByEncryptionType", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BucketCountByEncryptionType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("bucketCountByObjectEncryptionRequirement", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BucketCountByObjectEncryptionRequirement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("bucketCountBySharedAccessType", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BucketCountBySharedAccessType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("bucketStatisticsBySensitivity", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BucketStatisticsBySensitivity = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetBucketStatisticsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetBucketStatisticsResponseUnmarshaller Instance => _instance;
    }
}
