...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UsageTotalUnmarshaller : IJsonUnmarshaller<UsageTotal, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public UsageTotal Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new UsageTotal();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UsageTotalUnmarshaller Instance => _instance;
    }
}
