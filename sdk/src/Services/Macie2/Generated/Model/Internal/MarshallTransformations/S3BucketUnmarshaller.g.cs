...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class S3BucketUnmarshaller : IJsonUnmarshaller<S3Bucket, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new S3Bucket();
            ...
            {
                if (context.TestExpression("allowsUnencryptedObjectUploads", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("defaultServerSideEncryption", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static S3BucketUnmarshaller Instance => _instance;
    }
}
