...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FederatedUserUnmarshaller : IJsonUnmarshaller<FederatedUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FederatedUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("sessionContext", targetDepth, ref reader))
                {
                    var unmarshaller = SessionContextUnmarshaller.Instance;
