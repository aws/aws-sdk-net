...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ObjectCountByEncryptionTypeUnmarshaller : IJsonUnmarshaller<ObjectCountByEncryptionType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ObjectCountByEncryptionType();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("kmsManaged", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                ...
                if (context.TestExpression("s3Managed", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                ...
                if (context.TestExpression("unencrypted", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static ObjectCountByEncryptionTypeUnmarshaller Instance => _instance;
    }
}
