...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetResourceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetResourceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("profileUpdatedAt", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ProfileUpdatedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("sensitivityScoreOverridden", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SensitivityScoreOverridden = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetResourceProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetResourceProfileResponseUnmarshaller Instance => _instance;
    }
}
