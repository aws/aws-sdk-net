    ...
    public class BucketMetadataUnmarshaller : IJsonUnmarshaller<BucketMetadata, JsonUnmarshallerContext>
    {
        ...
        public BucketMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("bucketCreatedAt", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("replicationDetails", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("serverSideEncryption", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("sharedAccess", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("versioning", targetDepth, ref reader))
                {
