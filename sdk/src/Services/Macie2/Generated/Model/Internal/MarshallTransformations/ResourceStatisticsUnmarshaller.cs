...
{
    /// <summary>
    /// Response Unmarshaller for ResourceStatistics Object
    /// </summary>  
    public class ResourceStatisticsUnmarshaller : IUnmarshaller<ResourceStatistics, XmlUnmarshallerContext>, IUnmarshaller<ResourceStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ResourceStatistics IUnmarshaller<ResourceStatistics, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ResourceStatistics Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            ResourceStatistics unmarshalledObject = new ResourceStatistics();
        ...
        private static ResourceStatisticsUnmarshaller _instance = new ResourceStatisticsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResourceStatisticsUnmarshaller Instance
        {
            get
            {
                return _instance;
