...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetCustomDataIdentifiersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetCustomDataIdentifiersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("notFoundIdentifierIds", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.NotFoundIdentifierIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static BatchGetCustomDataIdentifiersResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetCustomDataIdentifiersResponseUnmarshaller Instance => _instance;
    }
}
