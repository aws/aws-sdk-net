    ...
    public class SensitivityAggregationsUnmarshaller : IJsonUnmarshaller<SensitivityAggregations, JsonUnmarshallerContext>
    {
        ...
        public SensitivityAggregations Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("publiclyAccessibleCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
        ...
        private static SensitivityAggregationsUnmarshaller _instance = new SensitivityAggregationsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SensitivityAggregationsUnmarshaller Instance
        {
            get
            {
                return _instance;
