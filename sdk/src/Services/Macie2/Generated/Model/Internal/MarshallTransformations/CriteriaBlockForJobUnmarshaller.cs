...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CriteriaBlockForJobUnmarshaller : IUnmarshaller<CriteriaBlockForJob, XmlUnmarshallerContext>, IUnmarshaller<CriteriaBlockForJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CriteriaBlockForJob IUnmarshaller<CriteriaBlockForJob, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CriteriaBlockForJob Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CriteriaForJob, CriteriaForJobUnmarshaller>(CriteriaForJobUnmarshaller.Instance);
