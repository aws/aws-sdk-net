...
{
    /// <summary>
    /// Response Unmarshaller for GetRevealConfiguration operation
    /// </summary>  
    public class GetRevealConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRevealConfigurationResponse response = new GetRevealConfigurationResponse();
        ...
        private static GetRevealConfigurationResponseUnmarshaller _instance = new GetRevealConfigurationResponseUnmarshaller();        

        internal static GetRevealConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevealConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
