...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CellUnmarshaller : IJsonUnmarshaller<Cell, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Cell Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("cellReference", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CellReference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
