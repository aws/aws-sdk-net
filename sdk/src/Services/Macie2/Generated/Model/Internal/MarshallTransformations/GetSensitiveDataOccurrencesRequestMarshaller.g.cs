...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSensitiveDataOccurrencesRequestMarshaller : IMarshaller<IRequest, GetSensitiveDataOccurrencesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSensitiveDataOccurrencesRequestMarshaller _instance = new();

        internal static GetSensitiveDataOccurrencesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSensitiveDataOccurrencesRequestMarshaller Instance => _instance;
    }
}
