...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeClassificationJobRequestMarshaller : IMarshaller<IRequest, DescribeClassificationJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeClassificationJobRequestMarshaller _instance = new DescribeClassificationJobRequestMarshaller();        

        internal static DescribeClassificationJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClassificationJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
