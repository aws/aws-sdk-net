...
{
    /// <summary>
    /// Response Unmarshaller for GetFindings operation
    /// </summary>  
    public class GetFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFindingsResponse response = new GetFindingsResponse();
        ...
        private static GetFindingsResponseUnmarshaller _instance = new GetFindingsResponseUnmarshaller();        

        internal static GetFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
