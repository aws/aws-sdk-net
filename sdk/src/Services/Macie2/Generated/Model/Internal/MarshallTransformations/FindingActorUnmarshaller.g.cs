...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FindingActorUnmarshaller : IJsonUnmarshaller<FindingActor, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public FindingActor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new FindingActor();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FindingActorUnmarshaller Instance => _instance;
    }
}
