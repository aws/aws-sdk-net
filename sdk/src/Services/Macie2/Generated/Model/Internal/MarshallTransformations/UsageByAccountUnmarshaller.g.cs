...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UsageByAccountUnmarshaller : IJsonUnmarshaller<UsageByAccount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UsageByAccount();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("serviceLimit", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static UsageByAccountUnmarshaller Instance => _instance;
    }
}
