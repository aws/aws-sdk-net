    ...
    public class ListAutomatedDiscoveryAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomatedDiscoveryAccount, AutomatedDiscoveryAccountUnmarshaller>(AutomatedDiscoveryAccountUnmarshaller.Instance);
