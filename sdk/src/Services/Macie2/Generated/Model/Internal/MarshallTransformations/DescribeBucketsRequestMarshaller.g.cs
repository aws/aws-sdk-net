...
{
    /// <summary>
    /// DescribeBuckets Request Marshaller
    /// </summary>
    public partial class DescribeBucketsRequestMarshaller : IMarshaller<IRequest, DescribeBucketsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeBucketsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DescribeBucketsRequest publicRequest)
        {
        ...
        private static readonly DescribeBucketsRequestMarshaller _instance = new();

        internal static DescribeBucketsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeBucketsRequestMarshaller Instance => _instance;
    }
}
