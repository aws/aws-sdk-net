...
{
    /// <summary>
    /// Response Unmarshaller for GetUsageTotals operation.
    /// </summary>
    public partial class GetUsageTotalsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetUsageTotalsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("usageTotals", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.UsageTotals = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetUsageTotalsResponseUnmarshaller _instance = new GetUsageTotalsResponseUnmarshaller();

        internal static GetUsageTotalsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetUsageTotalsResponseUnmarshaller Instance => _instance;
    }
}
