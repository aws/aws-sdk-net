...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SessionIssuerUnmarshaller : IJsonUnmarshaller<SessionIssuer, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SessionIssuer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SessionIssuer();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SessionIssuerUnmarshaller Instance => _instance;
    }
}
