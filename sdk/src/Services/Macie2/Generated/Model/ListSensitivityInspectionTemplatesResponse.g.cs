...
namespace Amazon.Macie2.Model
{
    ...
    public partial class ListSensitivityInspectionTemplatesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SensitivityInspectionTemplatesEntry> SensitivityInspectionTemplates { get; set; } = AWSConfigs.InitializeCollections ? new List<SensitivityInspectionTemplatesEntry>() : null;

        /// <summary>
        /// Checks to see if the SensitivityInspectionTemplates property is set.
        /// </summary>
        internal bool IsSetSensitivityInspectionTemplates() => this.SensitivityInspectionTemplates != null && (this.SensitivityInspectionTemplates.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
