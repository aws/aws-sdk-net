...
{
    /// <summary>
    /// Specifies configuration settings that determine which findings are published to AWS
    /// Security Hub automatically. For information about how Macie publishes findings to
    /// Security Hub, see <a href="https://docs.aws.amazon.com/macie/latest/user/securityhub-integration.html">Amazon
    ...
    public partial class SecurityHubConfiguration
    {
        ...
        /// <para>
        /// Specifies whether to publish sensitive data findings to AWS Security Hub. If you set
        /// this value to true, Amazon Macie automatically publishes all sensitive data findings
        /// that weren't suppressed by a findings filter. The default value is false.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Specifies whether to publish policy findings to AWS Security Hub. If you set this
