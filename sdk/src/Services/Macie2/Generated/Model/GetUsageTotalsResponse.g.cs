...
namespace Amazon.Macie2.Model
{
    ...
    public partial class GetUsageTotalsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<UsageTotal> UsageTotals { get; set; } = AWSConfigs.InitializeCollections ? new List<UsageTotal>() : null;

        /// <summary>
        /// Checks to see if the UsageTotals property is set.
        /// </summary>
        internal bool IsSetUsageTotals() => this.UsageTotals != null && (this.UsageTotals.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
