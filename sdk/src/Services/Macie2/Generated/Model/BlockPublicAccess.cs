...
namespace Amazon.Macie2.Model
{
    ...
    /// settings can apply to a bucket at the account level or bucket level. For detailed
    /// information about each setting, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html">Using
    /// Amazon S3 block public access</a> in the <i>Amazon Simple Storage Service Developer
    /// Guide</i>.
    /// </summary>
