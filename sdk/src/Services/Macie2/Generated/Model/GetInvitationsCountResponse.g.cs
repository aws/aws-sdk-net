...
namespace Amazon.Macie2.Model
{
    ...
    public partial class GetInvitationsCountResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public long? InvitationsCount { get; set; }

        /// <summary>
        /// Checks to see if the InvitationsCount property is set.
        /// </summary>
        internal bool IsSetInvitationsCount() => this.InvitationsCount.HasValue;
    }
}
