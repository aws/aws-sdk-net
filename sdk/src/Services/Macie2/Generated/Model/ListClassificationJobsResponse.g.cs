...
{
    /// <summary>
    /// This is the response object from the ListClassificationJobs operation.
    /// </summary>
    public partial class ListClassificationJobsResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        /// </summary>
        public List<JobSummary> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<JobSummary>() : null;
