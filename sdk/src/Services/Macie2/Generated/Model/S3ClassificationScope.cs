...
{
    /// <summary>
    /// Specifies the S3 buckets that are excluded from automated sensitive data discovery
    /// for an Amazon Macie account.
    /// </summary>
    public partial class S3ClassificationScope
    {
        private S3ClassificationScopeExclusion _excludes;
