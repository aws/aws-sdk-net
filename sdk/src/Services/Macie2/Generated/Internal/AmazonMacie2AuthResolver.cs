...
namespace Amazon.Macie2.Internal
{
    ...
    public class AmazonMacie2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMacie2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Macie2.
        /// </summary>
        public AmazonMacie2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMacie2AuthSchemeParameters
            {
    ...
    public class AmazonMacie2AuthSchemeResolver : IAuthSchemeResolver<AmazonMacie2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMacie2AuthSchemeParameters authParameters)
        {
