...
namespace Amazon.Macie2
{
    ...
    public partial class AmazonMacie2Config : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Macie2", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Macie2";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "macie2";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-01-01";
