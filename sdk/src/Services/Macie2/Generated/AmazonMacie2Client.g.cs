...
namespace Amazon.Macie2
{
    ...
    public partial class AmazonMacie2Client : AmazonServiceClient, IAmazonMacie2
    {
        ...
        /// 
        /// </summary>
        public AmazonMacie2Client() : base(new AmazonMacie2Config()) { }
        ...
        public AmazonMacie2Client(RegionEndpoint region) : base(new AmazonMacie2Config { RegionEndpoint = region }) { }
        ...
        public AmazonMacie2Client(AmazonMacie2Config config) : base(config) { }
