...
namespace Amazon.SageMakerMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchPutMetricsRequestMarshaller : IMarshaller<IRequest, BatchPutMetricsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchPutMetricsRequestMarshaller _instance = new();

        internal static BatchPutMetricsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchPutMetricsRequestMarshaller Instance => _instance;
    }
}
