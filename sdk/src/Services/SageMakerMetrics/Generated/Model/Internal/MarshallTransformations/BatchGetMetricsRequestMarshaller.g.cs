...
namespace Amazon.SageMakerMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetMetricsRequestMarshaller : IMarshaller<IRequest, BatchGetMetricsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchGetMetricsRequestMarshaller _instance = new();

        internal static BatchGetMetricsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetMetricsRequestMarshaller Instance => _instance;
    }
}
