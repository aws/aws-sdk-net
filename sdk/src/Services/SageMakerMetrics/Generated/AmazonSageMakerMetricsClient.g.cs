...
namespace Amazon.SageMakerMetrics
{
    ...
    public partial class AmazonSageMakerMetricsClient : AmazonServiceClient, IAmazonSageMakerMetrics
    {
        ...
        /// 
        /// </summary>
        public AmazonSageMakerMetricsClient() : base(new AmazonSageMakerMetricsConfig()) { }
        ...
        public AmazonSageMakerMetricsClient(RegionEndpoint region) : base(new AmazonSageMakerMetricsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSageMakerMetricsClient(AmazonSageMakerMetricsConfig config) : base(config) { }
