...
namespace Amazon.SageMakerMetrics
{
    ...
    public partial class AmazonSageMakerMetricsClient : AmazonServiceClient, IAmazonSageMakerMetrics
    {
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-metrics-2022-09-30/BatchGetMetrics">REST API Reference for BatchGetMetrics Operation</seealso>
        public virtual BatchGetMetricsResponse EndBatchGetMetrics(IAsyncResult asyncResult)
        {
            return EndInvoke<BatchGetMetricsResponse>(asyncResult);
        }
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-metrics-2022-09-30/BatchPutMetrics">REST API Reference for BatchPutMetrics Operation</seealso>
        public virtual BatchPutMetricsResponse EndBatchPutMetrics(IAsyncResult asyncResult)
        {
            return EndInvoke<BatchPutMetricsResponse>(asyncResult);
        }
