...
{
    /// <summary>
    /// Response Unmarshaller for GetAppMonitor operation
    /// </summary>  
    public class GetAppMonitorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAppMonitorResponse response = new GetAppMonitorResponse();
            ...
            {
                if (context.TestExpression("AppMonitor", targetDepth, ref reader))
                {
                    var unmarshaller = AppMonitorUnmarshaller.Instance;
                    response.AppMonitor = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetAppMonitorResponseUnmarshaller _instance = new GetAppMonitorResponseUnmarshaller();        

        internal static GetAppMonitorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAppMonitorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
