...
namespace Amazon.CloudWatchRUM
{
    ...
    /// <summary>
    /// Constants used for properties of type AppMonitorPlatform.
    /// </summary>
    public class AppMonitorPlatform : ConstantClass
    {

        /// <summary>
        /// Constant Android for AppMonitorPlatform
        /// </summary>
        public static readonly AppMonitorPlatform Android = new AppMonitorPlatform("Android");
        /// <summary>
        /// Constant IOS for AppMonitorPlatform
        /// </summary>
        public static readonly AppMonitorPlatform IOS = new AppMonitorPlatform("iOS");
        /// <summary>
        /// Constant Web for AppMonitorPlatform
        /// </summary>
        public static readonly AppMonitorPlatform Web = new AppMonitorPlatform("Web");
        ...
        /// </summary>
        public AppMonitorPlatform(string value)
            : base(value)
        {
        }
        ...
        public static AppMonitorPlatform FindValue(string value)
        {
            return FindValue<AppMonitorPlatform>(value);
        }
        ...
        /// <returns></returns>
        public static implicit operator AppMonitorPlatform(string value)
        {
