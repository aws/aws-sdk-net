...
namespace Amazon.Bedrock
{
    ...
    public partial class AmazonBedrockConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Bedrock", "4.0.102.3");
        ...
        /// </summary>
        public static new string ServiceId => "Bedrock";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "bedrock";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2023-04-20";
