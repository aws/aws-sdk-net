...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningPolicyBuildStep
    {
        ...
        public AutomatedReasoningPolicyBuildStepContext Context { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<AutomatedReasoningPolicyBuildStepMessage> Messages { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningPolicyBuildStepMessage>() : null;
        ...
        /// </para>
        /// </summary>
        public AutomatedReasoningPolicyDefinitionElement PriorElement { get; set; }

        /// <summary>
        /// Checks to see if the PriorElement property is set.
        /// </summary>
        internal bool IsSetPriorElement() => this.PriorElement != null;
    }
}
