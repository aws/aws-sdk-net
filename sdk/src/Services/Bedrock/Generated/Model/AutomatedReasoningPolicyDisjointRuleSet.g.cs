...
namespace Amazon.Bedrock.Model
{
    ...
    /// </summary>
    public partial class AutomatedReasoningPolicyDisjointRuleSet
    {
        /// <summary>
        ...
        public List<string> Rules { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        public List<string> Variables { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;
