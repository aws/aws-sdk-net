...
{
    /// <summary>
    /// Container for the parameters to the CreateModelCustomizationJob operation. Creates
    /// a fine-tuning job to customize a base model. <para> You specify the base foundation
    /// model and the location of the training data. After the model-customization job completes
    /// successfully, your custom model resource will be ready to use. Amazon Bedrock returns
    /// validation loss metrics and output generations after the job completes. </para> <para>
    ...
    /// the datasets</a>. </para> <para> Model-customization jobs are asynchronous and the
    /// completion time depends on the base model and the training/validation data size. To
    /// monitor a job, use the <c>GetModelCustomizationJob</c> operation to retrieve the job
    /// status. </para> <para> For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html">Custom
    ...
    public partial class CreateModelCustomizationJobRequest : AmazonBedrockRequest
    {
        ...
        /// <summary>
        /// Checks to see if the BaseModelIdentifier property is set.
        /// </summary>
        internal bool IsSetBaseModelIdentifier() => this.BaseModelIdentifier != null;
        ...
        /// <summary>
        /// Checks to see if the CustomModelKmsKeyId property is set.
        /// </summary>
        internal bool IsSetCustomModelKmsKeyId() => this.CustomModelKmsKeyId != null;
        ...
        public List<Tag> CustomModelTags { get; set; } = AWSConfigs.InitializeCollections ? new List<Tag>() : null;

        /// <summary>
        /// Checks to see if the CustomModelTags property is set.
        /// </summary>
        internal bool IsSetCustomModelTags() => this.CustomModelTags != null && (this.CustomModelTags.Count > 0 || !AWSConfigs.InitializeCollections);
