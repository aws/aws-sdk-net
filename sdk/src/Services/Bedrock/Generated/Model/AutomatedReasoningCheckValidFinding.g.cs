...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningCheckValidFinding
    {
        ...
        /// </para>
        /// </summary>
        public AutomatedReasoningCheckScenario ClaimsTrueScenario { get; set; }

        /// <summary>
        /// Checks to see if the ClaimsTrueScenario property is set.
        /// </summary>
        internal bool IsSetClaimsTrueScenario() => this.ClaimsTrueScenario != null;
        ...
        /// </summary>
        public List<AutomatedReasoningCheckRule> SupportingRules { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningCheckRule>() : null;

        /// <summary>
        /// Checks to see if the SupportingRules property is set.
        /// </summary>
        internal bool IsSetSupportingRules() => this.SupportingRules != null && (this.SupportingRules.Count > 0 || !AWSConfigs.InitializeCollections);
