...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningCheckTranslationOption
    {
        ...
        /// </summary>
        public List<AutomatedReasoningCheckTranslation> Translations { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningCheckTranslation>() : null;

        /// <summary>
        /// Checks to see if the Translations property is set.
        /// </summary>
        internal bool IsSetTranslations() => this.Translations != null && (this.Translations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
