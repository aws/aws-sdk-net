...
{
    /// <summary>
    /// Container for the parameters to the UpdateCustomModelDeployment operation. Updates
    /// a custom model deployment with a new custom model. This allows you to deploy updated
    /// models without creating new deployment endpoints.
    /// </summary>
    public partial class UpdateCustomModelDeploymentRequest : AmazonBedrockRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Checks to see if the CustomModelDeploymentIdentifier property is set.
        /// </summary>
        internal bool IsSetCustomModelDeploymentIdentifier() => this.CustomModelDeploymentIdentifier != null;
