...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class ListProvisionedModelThroughputsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ProvisionedModelSummary> ProvisionedModelSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ProvisionedModelSummary>() : null;

        /// <summary>
        /// Checks to see if the ProvisionedModelSummaries property is set.
        /// </summary>
        internal bool IsSetProvisionedModelSummaries() => this.ProvisionedModelSummaries != null && (this.ProvisionedModelSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
