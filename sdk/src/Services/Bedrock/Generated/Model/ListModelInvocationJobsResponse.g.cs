...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class ListModelInvocationJobsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ModelInvocationJobSummary> InvocationJobSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ModelInvocationJobSummary>() : null;

        /// <summary>
        /// Checks to see if the InvocationJobSummaries property is set.
        /// </summary>
        internal bool IsSetInvocationJobSummaries() => this.InvocationJobSummaries != null && (this.InvocationJobSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
