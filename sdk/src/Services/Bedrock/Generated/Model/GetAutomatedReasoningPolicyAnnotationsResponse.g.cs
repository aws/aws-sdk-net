...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class GetAutomatedReasoningPolicyAnnotationsResponse : AmazonWebServiceResponse
    {
        ...
        public string AnnotationSetHash { get; set; }

        /// <summary>
        /// Checks to see if the AnnotationSetHash property is set.
        /// </summary>
        internal bool IsSetAnnotationSetHash() => this.AnnotationSetHash != null;
