...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedEvaluationCustomMetricSource
    {
        ...
        public CustomMetricDefinition CustomMetricDefinition { get; set; }

        /// <summary>
        /// Checks to see if the CustomMetricDefinition property is set.
        /// </summary>
        internal bool IsSetCustomMetricDefinition() => this.CustomMetricDefinition != null;
    }
}
