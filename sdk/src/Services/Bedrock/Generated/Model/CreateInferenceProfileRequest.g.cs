...
{
    /// <summary>
    /// Container for the parameters to the CreateInferenceProfile operation. Creates an application
    /// inference profile to track metrics and costs when invoking a model. To create an application
    /// inference profile for a foundation model in one region, specify the ARN of the model
    /// in that region. To create an application inference profile for a foundation model
    /// across multiple regions, specify the ARN of the system-defined inference profile that
    /// contains the regions that you want to route requests to. For more information, see
    /// <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/cross-region-inference.html">Increase
    ...
    public partial class CreateInferenceProfileRequest : AmazonBedrockRequest
    {
        ...
        public InferenceProfileModelSource ModelSource { get; set; }

        /// <summary>
        /// Checks to see if the ModelSource property is set.
        /// </summary>
        internal bool IsSetModelSource() => this.ModelSource != null;
