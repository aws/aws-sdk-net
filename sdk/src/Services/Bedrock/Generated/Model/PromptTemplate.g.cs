...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class PromptTemplate
    {
        ...
        public string TextPromptTemplate { get; set; }

        /// <summary>
        /// Checks to see if the TextPromptTemplate property is set.
        /// </summary>
        internal bool IsSetTextPromptTemplate() => this.TextPromptTemplate != null;
    }
}
