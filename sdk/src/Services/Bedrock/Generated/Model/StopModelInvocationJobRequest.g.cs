...
{
    /// <summary>
    /// Container for the parameters to the StopModelInvocationJob operation. Stops a batch
    /// inference job. You're only charged for tokens that were already processed. For more
    /// information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/batch-inference-stop.html">Stop
