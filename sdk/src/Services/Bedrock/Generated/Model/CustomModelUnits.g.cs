...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class CustomModelUnits
    {
        ...
        /// </para>
        /// </summary>
        public int? CustomModelUnitsPerModelCopy { get; set; }

        /// <summary>
        /// Checks to see if the CustomModelUnitsPerModelCopy property is set.
        /// </summary>
        internal bool IsSetCustomModelUnitsPerModelCopy() => this.CustomModelUnitsPerModelCopy.HasValue;
        ...
        /// </para>
        /// </summary>
        public string CustomModelUnitsVersion { get; set; }

        /// <summary>
        /// Checks to see if the CustomModelUnitsVersion property is set.
        /// </summary>
        internal bool IsSetCustomModelUnitsVersion() => this.CustomModelUnitsVersion != null;
    }
}
