...
{
    /// <summary>
    /// Container for the parameters to the GetCustomModelDeployment operation. Retrieves
    /// information about a custom model deployment, including its status, configuration,
    /// and metadata. Use this operation to monitor the deployment status and retrieve details
    /// needed for inference requests. <para> The following actions are related to the <c>GetCustomModelDeployment</c>
