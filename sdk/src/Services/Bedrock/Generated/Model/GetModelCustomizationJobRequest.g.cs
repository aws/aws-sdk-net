...
{
    /// <summary>
    /// Container for the parameters to the GetModelCustomizationJob operation. Retrieves
    /// the properties associated with a model-customization job, including the status of
    /// the job. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html">Custom
