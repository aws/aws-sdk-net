...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningCheckTranslationAmbiguousFinding
    {
        ...
        /// </summary>
        [AWSProperty(Max = 2)]
        public List<AutomatedReasoningCheckScenario> DifferenceScenarios { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningCheckScenario>() : null;

        /// <summary>
        /// Checks to see if the DifferenceScenarios property is set.
        /// </summary>
        internal bool IsSetDifferenceScenarios() => this.DifferenceScenarios != null && (this.DifferenceScenarios.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Max = 2)]
        public List<AutomatedReasoningCheckTranslationOption> Options { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningCheckTranslationOption>() : null;
