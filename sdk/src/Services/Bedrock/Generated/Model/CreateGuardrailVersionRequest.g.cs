...
{
    /// <summary>
    /// Container for the parameters to the CreateGuardrailVersion operation. Creates a version
    /// of the guardrail. Use this API to create a snapshot of the guardrail when you are
