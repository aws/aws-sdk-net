...
{
    /// <summary>
    /// Container for the parameters to the ListModelImportJobs operation. Returns a list
    /// of import jobs you've submitted. You can filter the results to return based on one
    /// or more criteria. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/model-customization-import-model.html">Import
    /// a customized model</a> in the <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html">Amazon
    /// Bedrock User Guide</a>.
    /// </summary>
    public partial class ListModelImportJobsRequest : AmazonBedrockRequest
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public ModelImportJobStatus StatusEquals { get; set; }
