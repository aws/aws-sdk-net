...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class ListModelCopyJobsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ModelCopyJobSummary> ModelCopyJobSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ModelCopyJobSummary>() : null;

        /// <summary>
        /// Checks to see if the ModelCopyJobSummaries property is set.
        /// </summary>
        internal bool IsSetModelCopyJobSummaries() => this.ModelCopyJobSummaries != null && (this.ModelCopyJobSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
