...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class GuardrailCrossRegionDetails
    {
        ...
        /// <summary>
        /// Checks to see if the GuardrailProfileArn property is set.
        /// </summary>
        internal bool IsSetGuardrailProfileArn() => this.GuardrailProfileArn != null;
        ...
        public string GuardrailProfileId { get; set; }

        /// <summary>
        /// Checks to see if the GuardrailProfileId property is set.
        /// </summary>
        internal bool IsSetGuardrailProfileId() => this.GuardrailProfileId != null;
    }
}
