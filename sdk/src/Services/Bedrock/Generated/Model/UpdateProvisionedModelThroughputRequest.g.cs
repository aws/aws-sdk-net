...
{
    /// <summary>
    /// Container for the parameters to the UpdateProvisionedModelThroughput operation. Updates
    /// the name or associated model for a Provisioned Throughput. For more information, see
    /// <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html">Provisioned
    ...
    public partial class UpdateProvisionedModelThroughputRequest : AmazonBedrockRequest
    {
        ...
        /// <summary>
        /// Checks to see if the DesiredModelId property is set.
        /// </summary>
        internal bool IsSetDesiredModelId() => this.DesiredModelId != null;
        ...
        /// <summary>
        /// Checks to see if the DesiredProvisionedModelName property is set.
        /// </summary>
        internal bool IsSetDesiredProvisionedModelName() => this.DesiredProvisionedModelName != null;
