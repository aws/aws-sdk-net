...
{
    /// <summary>
    /// Container for the parameters to the ListCustomModels operation. Returns a list of
    /// the custom models that you have created with the <c>CreateModelCustomizationJob</c>
    /// operation. <para> For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html">Custom
    ...
    public partial class ListCustomModelsRequest : AmazonBedrockRequest
    {
        ...
        /// <summary>
        /// Checks to see if the BaseModelArnEquals property is set.
        /// </summary>
        internal bool IsSetBaseModelArnEquals() => this.BaseModelArnEquals != null;
        ...
        /// <summary>
        /// Checks to see if the FoundationModelArnEquals property is set.
        /// </summary>
        internal bool IsSetFoundationModelArnEquals() => this.FoundationModelArnEquals != null;
