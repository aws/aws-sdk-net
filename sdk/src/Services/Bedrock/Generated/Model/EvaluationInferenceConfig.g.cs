...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class EvaluationInferenceConfig
    {
        ...
        public List<EvaluationModelConfig> Models { get; set; } = AWSConfigs.InitializeCollections ? new List<EvaluationModelConfig>() : null;
        ...
        public List<RAGConfig> RagConfigs { get; set; } = AWSConfigs.InitializeCollections ? new List<RAGConfig>() : null;

        /// <summary>
        /// Checks to see if the RagConfigs property is set.
        /// </summary>
        internal bool IsSetRagConfigs() => this.RagConfigs != null && (this.RagConfigs.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
