...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class CustomModelDataSource
    {
        ...
        /// </para>
        /// </summary>
        public ModelPackageArnDataSource ModelPackageArnDataSource { get; set; }

        /// <summary>
        /// Checks to see if the ModelPackageArnDataSource property is set.
        /// </summary>
        internal bool IsSetModelPackageArnDataSource() => this.ModelPackageArnDataSource != null;
    }
}
