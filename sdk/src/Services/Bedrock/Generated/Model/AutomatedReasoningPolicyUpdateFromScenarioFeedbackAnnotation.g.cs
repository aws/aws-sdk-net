...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation
    {
        ...
        public string ScenarioExpression { get; set; }

        /// <summary>
        /// Checks to see if the ScenarioExpression property is set.
        /// </summary>
        internal bool IsSetScenarioExpression() => this.ScenarioExpression != null;
    }
}
