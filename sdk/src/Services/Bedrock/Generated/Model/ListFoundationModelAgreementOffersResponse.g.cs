...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class ListFoundationModelAgreementOffersResponse : AmazonWebServiceResponse
    {
        ...
        public List<Offer> Offers { get; set; } = AWSConfigs.InitializeCollections ? new List<Offer>() : null;

        /// <summary>
        /// Checks to see if the Offers property is set.
        /// </summary>
        internal bool IsSetOffers() => this.Offers != null && (this.Offers.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
