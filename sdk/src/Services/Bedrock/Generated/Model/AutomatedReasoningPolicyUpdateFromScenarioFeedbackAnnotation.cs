...
namespace Amazon.Bedrock.Model
{
    ...
    /// </summary>
    public partial class AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation
    {
        private string _feedback;
        private List<string> _ruleIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private string _scenarioExpression;
        ...
        /// <summary>
        /// Gets and sets the property ScenarioExpression. 
        /// <para>
        ...
        public string ScenarioExpression
        {
            get { return this._scenarioExpression; }
            set { this._scenarioExpression = value; }
        }

        // Check to see if ScenarioExpression property is set
        internal bool IsSetScenarioExpression()
        {
            return this._scenarioExpression != null;
        }
