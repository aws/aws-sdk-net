...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningPolicyBuildStepContext
    {
        ...
        /// </para>
        /// </summary>
        public AutomatedReasoningPolicyMutation Mutation { get; set; }

        /// <summary>
        /// Checks to see if the Mutation property is set.
        /// </summary>
        internal bool IsSetMutation() => this.Mutation != null;
        ...
        /// </para>
        /// </summary>
        public AutomatedReasoningPolicyPlanning Planning { get; set; }

        /// <summary>
        /// Checks to see if the Planning property is set.
        /// </summary>
        internal bool IsSetPlanning() => this.Planning != null;
    }
}
