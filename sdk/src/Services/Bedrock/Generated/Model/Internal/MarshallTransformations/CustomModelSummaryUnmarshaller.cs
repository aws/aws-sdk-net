...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomModelSummaryUnmarshaller : IUnmarshaller<CustomModelSummary, XmlUnmarshallerContext>, IUnmarshaller<CustomModelSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CustomModelSummary IUnmarshaller<CustomModelSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CustomModelSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CustomizationType = unmarshaller.Unmarshall(context);
                    continue;
                }
