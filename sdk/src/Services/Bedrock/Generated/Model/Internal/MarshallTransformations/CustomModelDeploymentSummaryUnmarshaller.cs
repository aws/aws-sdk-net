...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomModelDeploymentSummaryUnmarshaller : IUnmarshaller<CustomModelDeploymentSummary, XmlUnmarshallerContext>, IUnmarshaller<CustomModelDeploymentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CustomModelDeploymentSummary IUnmarshaller<CustomModelDeploymentSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CustomModelDeploymentSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("customModelDeploymentArn", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomModelDeploymentArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("customModelDeploymentName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CustomModelDeploymentName = unmarshaller.Unmarshall(context);
                    continue;
                }
