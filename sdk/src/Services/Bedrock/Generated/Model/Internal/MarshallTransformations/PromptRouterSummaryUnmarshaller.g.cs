...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PromptRouterSummaryUnmarshaller : IJsonUnmarshaller<PromptRouterSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PromptRouterSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("fallbackModel", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("promptRouterArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("promptRouterName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static PromptRouterSummaryUnmarshaller Instance => _instance;
    }
}
