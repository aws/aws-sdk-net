...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutomatedReasoningPolicy operation
    /// </summary>  
    public class CreateAutomatedReasoningPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutomatedReasoningPolicyResponse response = new CreateAutomatedReasoningPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("definitionHash", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DefinitionHash = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateAutomatedReasoningPolicyResponseUnmarshaller _instance = new CreateAutomatedReasoningPolicyResponseUnmarshaller();        

        internal static CreateAutomatedReasoningPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutomatedReasoningPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
