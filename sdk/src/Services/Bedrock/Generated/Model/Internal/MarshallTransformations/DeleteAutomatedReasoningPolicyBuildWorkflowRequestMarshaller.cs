...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAutomatedReasoningPolicyBuildWorkflowRequestMarshaller : IMarshaller<IRequest, DeleteAutomatedReasoningPolicyBuildWorkflowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteAutomatedReasoningPolicyBuildWorkflowRequestMarshaller _instance = new DeleteAutomatedReasoningPolicyBuildWorkflowRequestMarshaller();        

        internal static DeleteAutomatedReasoningPolicyBuildWorkflowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAutomatedReasoningPolicyBuildWorkflowRequestMarshaller Instance
        {
            get
            {
                return _instance;
