        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("fallbackModel", targetDepth))
                {
                    ...
                    response.FallbackModel = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromptRouterName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("routingCriteria", targetDepth))
                {
                    var unmarshaller = RoutingCriteriaUnmarshaller.Instance;
                    response.RoutingCriteria = unmarshaller.Unmarshall(context);
                    continue;
                }
