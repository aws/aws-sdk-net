        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("agreementAvailability", targetDepth))
                {
                    ...
                    response.AgreementAvailability = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("authorizationStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AuthorizationStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("entitlementAvailability", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EntitlementAvailability = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegionAvailability = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
