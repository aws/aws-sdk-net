...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetrieveAndGenerateConfigurationUnmarshaller : IUnmarshaller<RetrieveAndGenerateConfiguration, XmlUnmarshallerContext>, IUnmarshaller<RetrieveAndGenerateConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RetrieveAndGenerateConfiguration IUnmarshaller<RetrieveAndGenerateConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RetrieveAndGenerateConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("externalSourcesConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.ExternalSourcesConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
