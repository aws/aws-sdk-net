...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutomatedReasoningPolicyTypeValueAnnotationUnmarshaller : IJsonUnmarshaller<AutomatedReasoningPolicyTypeValueAnnotation, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AutomatedReasoningPolicyTypeValueAnnotation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AutomatedReasoningPolicyTypeValueAnnotation();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutomatedReasoningPolicyTypeValueAnnotationUnmarshaller Instance => _instance;
    }
}
