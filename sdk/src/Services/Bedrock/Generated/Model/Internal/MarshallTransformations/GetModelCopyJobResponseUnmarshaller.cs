    ...
    public class GetModelCopyJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceAccountId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("sourceModelArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceModelArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("sourceModelName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceModelName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TargetModelArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("targetModelKmsKeyArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TargetModelKmsKeyArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("targetModelName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TargetModelName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("targetModelTags", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<Tag, TagUnmarshaller>(TagUnmarshaller.Instance);
                    response.TargetModelTags = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
