...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomatedReasoningCheckTranslationUnmarshaller : IUnmarshaller<AutomatedReasoningCheckTranslation, XmlUnmarshallerContext>, IUnmarshaller<AutomatedReasoningCheckTranslation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutomatedReasoningCheckTranslation IUnmarshaller<AutomatedReasoningCheckTranslation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutomatedReasoningCheckTranslation Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AutomatedReasoningCheckInputTextReference, AutomatedReasoningCheckInputTextReferenceUnmarshaller>(AutomatedReasoningCheckInputTextReferenceUnmarshaller.Instance);
