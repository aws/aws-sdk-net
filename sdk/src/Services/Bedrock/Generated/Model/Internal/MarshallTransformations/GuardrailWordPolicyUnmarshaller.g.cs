...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GuardrailWordPolicyUnmarshaller : IJsonUnmarshaller<GuardrailWordPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GuardrailWordPolicy();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("words", targetDepth, ref reader))
                {
        ...
        private static GuardrailWordPolicyUnmarshaller _instance = new GuardrailWordPolicyUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GuardrailWordPolicyUnmarshaller Instance => _instance;
    }
}
