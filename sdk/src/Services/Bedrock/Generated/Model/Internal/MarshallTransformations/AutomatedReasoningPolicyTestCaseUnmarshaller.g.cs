...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutomatedReasoningPolicyTestCaseUnmarshaller : IJsonUnmarshaller<AutomatedReasoningPolicyTestCase, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AutomatedReasoningPolicyTestCase();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("expectedAggregatedFindingsResult", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("queryContent", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutomatedReasoningPolicyTestCaseUnmarshaller Instance => _instance;
    }
}
