...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomizationConfigUnmarshaller : IJsonUnmarshaller<CustomizationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomizationConfig();
            ...
            {
                if (context.TestExpression("distillationConfig", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("rftConfig", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomizationConfigUnmarshaller Instance => _instance;
    }
}
