...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RequestMetadataBaseFiltersUnmarshaller : IJsonUnmarshaller<RequestMetadataBaseFilters, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RequestMetadataBaseFilters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RequestMetadataBaseFilters();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RequestMetadataBaseFiltersUnmarshaller Instance => _instance;
    }
}
