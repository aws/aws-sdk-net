...
{
    /// <summary>
    /// Response Unmarshaller for CreateInferenceProfile operation
    /// </summary>  
    public class CreateInferenceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInferenceProfileResponse response = new CreateInferenceProfileResponse();
            ...
            {
                if (context.TestExpression("inferenceProfileArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InferenceProfileArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateInferenceProfileResponseUnmarshaller _instance = new CreateInferenceProfileResponseUnmarshaller();        

        internal static CreateInferenceProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInferenceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
