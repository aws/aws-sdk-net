...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PerformanceConfigurationMarshaller : IRequestMarshaller<PerformanceConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(PerformanceConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetLatency())
            {
                ...
                context.Writer.WriteStringValue(requestObject.Latency);
            }
        }
