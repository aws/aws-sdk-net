...
{
    /// <summary>
    /// Response Unmarshaller for CreateProvisionedModelThroughput operation
    /// </summary>  
    public class CreateProvisionedModelThroughputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProvisionedModelThroughputResponse response = new CreateProvisionedModelThroughputResponse();
            ...
            {
                if (context.TestExpression("provisionedModelArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProvisionedModelArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateProvisionedModelThroughputResponseUnmarshaller _instance = new CreateProvisionedModelThroughputResponseUnmarshaller();        

        internal static CreateProvisionedModelThroughputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProvisionedModelThroughputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
