...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomMetricEvaluatorModelConfigUnmarshaller : IJsonUnmarshaller<CustomMetricEvaluatorModelConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomMetricEvaluatorModelConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CustomMetricBedrockEvaluatorModel, CustomMetricBedrockEvaluatorModelUnmarshaller>(CustomMetricBedrockEvaluatorModelUnmarshaller.Instance);
