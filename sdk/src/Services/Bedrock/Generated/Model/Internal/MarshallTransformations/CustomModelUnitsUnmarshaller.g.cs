...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomModelUnitsUnmarshaller : IJsonUnmarshaller<CustomModelUnits, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CustomModelUnits Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CustomModelUnits();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomModelUnitsUnmarshaller Instance => _instance;
    }
}
