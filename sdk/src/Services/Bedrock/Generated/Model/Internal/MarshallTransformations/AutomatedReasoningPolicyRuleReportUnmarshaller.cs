...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomatedReasoningPolicyRuleReportUnmarshaller : IUnmarshaller<AutomatedReasoningPolicyRuleReport, XmlUnmarshallerContext>, IUnmarshaller<AutomatedReasoningPolicyRuleReport, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutomatedReasoningPolicyRuleReport IUnmarshaller<AutomatedReasoningPolicyRuleReport, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutomatedReasoningPolicyRuleReport Unmarshall(JsonUnmarshallerContext context)
        {
            AutomatedReasoningPolicyRuleReport unmarshalledObject = new AutomatedReasoningPolicyRuleReport();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AutomatedReasoningPolicyRuleReportUnmarshaller Instance
        {
            get
            {
                return _instance;
