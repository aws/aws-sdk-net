...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCustomModelDeploymentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomModelDeploymentResponse response = new CreateCustomModelDeploymentResponse();
        ...
        internal static CreateCustomModelDeploymentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomModelDeploymentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
