...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EvaluationModelConfigUnmarshaller : IJsonUnmarshaller<EvaluationModelConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public EvaluationModelConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new EvaluationModelConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EvaluationModelConfigUnmarshaller Instance => _instance;
    }
}
