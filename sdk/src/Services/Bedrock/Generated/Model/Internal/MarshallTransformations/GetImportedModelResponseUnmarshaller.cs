        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("instructSupported", targetDepth))
                {
                    ...
                    response.InstructSupported = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ModelArchitecture = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("modelDataSource", targetDepth))
                {
                    ...
                    response.ModelDataSource = unmarshaller.Unmarshall(context);
                    continue;
                }
