...
{
    /// <summary>
    /// CreateModelCopyJob Request Marshaller
    /// </summary>
    public partial class CreateModelCopyJobRequestMarshaller : IMarshaller<IRequest, CreateModelCopyJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateModelCopyJobRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateModelCopyJobRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetSourceModelArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SourceModelArn);
            }
            if (publicRequest.IsSetTargetModelName())
            {
                context.Writer.WritePropertyName("targetModelName");
                context.Writer.WriteStringValue(publicRequest.TargetModelName);
            }
        ...
        private static readonly CreateModelCopyJobRequestMarshaller _instance = new();

        internal static CreateModelCopyJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateModelCopyJobRequestMarshaller Instance => _instance;
    }
}
