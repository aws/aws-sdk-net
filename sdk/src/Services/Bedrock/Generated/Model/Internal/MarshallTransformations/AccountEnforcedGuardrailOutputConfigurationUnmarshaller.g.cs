...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AccountEnforcedGuardrailOutputConfigurationUnmarshaller : IJsonUnmarshaller<AccountEnforcedGuardrailOutputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AccountEnforcedGuardrailOutputConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("inputTags", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("modelEnforcement", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("selectiveContentGuarding", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AccountEnforcedGuardrailOutputConfigurationUnmarshaller Instance => _instance;
    }
}
