...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteCustomModelRequestMarshaller : IMarshaller<IRequest, DeleteCustomModelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteCustomModelRequestMarshaller _instance = new();

        internal static DeleteCustomModelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteCustomModelRequestMarshaller Instance => _instance;
    }
}
