...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutomatedReasoningPolicyIterativeRefinementContentMarshaller : IRequestMarshaller<AutomatedReasoningPolicyIterativeRefinementContent, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(AutomatedReasoningPolicyIterativeRefinementContent requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetDocuments())
            {
                ...
                foreach (var requestObjectDocumentsListValue in requestObject.Documents)
                {
                    ...
                    var marshaller = AutomatedReasoningPolicyBuildWorkflowDocumentMarshaller.Instance;
