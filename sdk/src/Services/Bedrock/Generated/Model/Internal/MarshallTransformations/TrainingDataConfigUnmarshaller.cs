...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrainingDataConfigUnmarshaller : IJsonUnmarshaller<TrainingDataConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrainingDataConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("invocationLogsConfig", targetDepth, ref reader))
                {
                    var unmarshaller = InvocationLogsConfigUnmarshaller.Instance;
                    unmarshalledObject.InvocationLogsConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
