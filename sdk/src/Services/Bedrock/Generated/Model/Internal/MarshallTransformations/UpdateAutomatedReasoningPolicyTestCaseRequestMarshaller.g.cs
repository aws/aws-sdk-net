...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAutomatedReasoningPolicyTestCaseRequestMarshaller : IMarshaller<IRequest, UpdateAutomatedReasoningPolicyTestCaseRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateAutomatedReasoningPolicyTestCaseRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetConfidenceThreshold())
            {
                ...
                if (StringUtils.IsSpecialDoubleValue(publicRequest.ConfidenceThreshold.Value))
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(publicRequest.ConfidenceThreshold.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(publicRequest.ConfidenceThreshold.Value);
                }
            }
            if (publicRequest.IsSetExpectedAggregatedFindingsResult())
            {
                context.Writer.WritePropertyName("expectedAggregatedFindingsResult");
                context.Writer.WriteStringValue(publicRequest.ExpectedAggregatedFindingsResult);
            }
            if (publicRequest.IsSetGuardContent())
            {
                context.Writer.WritePropertyName("guardContent");
                context.Writer.WriteStringValue(publicRequest.GuardContent);
            }
            if (publicRequest.IsSetLastUpdatedAt())
            {
                context.Writer.WritePropertyName("lastUpdatedAt");
                context.Writer.WriteStringValue(StringUtils.FromDateTimeToISO8601WithOptionalMs(publicRequest.LastUpdatedAt));
            }
            if (publicRequest.IsSetQueryContent())
            {
                context.Writer.WritePropertyName("queryContent");
                context.Writer.WriteStringValue(publicRequest.QueryContent);
            }
        ...
        private static readonly UpdateAutomatedReasoningPolicyTestCaseRequestMarshaller _instance = new();

        internal static UpdateAutomatedReasoningPolicyTestCaseRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAutomatedReasoningPolicyTestCaseRequestMarshaller Instance => _instance;
    }
}
