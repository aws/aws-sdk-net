...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomModelDeploymentUpdateDetailsUnmarshaller : IJsonUnmarshaller<CustomModelDeploymentUpdateDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CustomModelDeploymentUpdateDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CustomModelDeploymentUpdateDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomModelDeploymentUpdateDetailsUnmarshaller Instance => _instance;
    }
}
