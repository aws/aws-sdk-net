...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomatedReasoningPolicyBuildStepUnmarshaller : IUnmarshaller<AutomatedReasoningPolicyBuildStep, XmlUnmarshallerContext>, IUnmarshaller<AutomatedReasoningPolicyBuildStep, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutomatedReasoningPolicyBuildStep IUnmarshaller<AutomatedReasoningPolicyBuildStep, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutomatedReasoningPolicyBuildStep Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AutomatedReasoningPolicyBuildStepMessage, AutomatedReasoningPolicyBuildStepMessageUnmarshaller>(AutomatedReasoningPolicyBuildStepMessageUnmarshaller.Instance);
                ...
                if (context.TestExpression("priorElement", targetDepth))
                {
                    ...
                    unmarshalledObject.PriorElement = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
