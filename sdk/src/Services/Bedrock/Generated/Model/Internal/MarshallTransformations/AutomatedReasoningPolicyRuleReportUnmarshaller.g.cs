...
{
    /// <summary>
    /// Response Unmarshaller for AutomatedReasoningPolicyRuleReport Object
    /// </summary>
    public partial class AutomatedReasoningPolicyRuleReportUnmarshaller : IJsonUnmarshaller<AutomatedReasoningPolicyRuleReport, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AutomatedReasoningPolicyRuleReport Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AutomatedReasoningPolicyRuleReport();
        ...
        private static AutomatedReasoningPolicyRuleReportUnmarshaller _instance = new AutomatedReasoningPolicyRuleReportUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AutomatedReasoningPolicyRuleReportUnmarshaller Instance => _instance;
    }
}
