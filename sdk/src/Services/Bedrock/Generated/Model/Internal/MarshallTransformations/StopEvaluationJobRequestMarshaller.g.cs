...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StopEvaluationJobRequestMarshaller : IMarshaller<IRequest, StopEvaluationJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StopEvaluationJobRequestMarshaller _instance = new();

        internal static StopEvaluationJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopEvaluationJobRequestMarshaller Instance => _instance;
    }
}
