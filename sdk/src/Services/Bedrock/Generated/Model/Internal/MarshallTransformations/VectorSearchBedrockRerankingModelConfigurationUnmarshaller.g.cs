...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VectorSearchBedrockRerankingModelConfigurationUnmarshaller : IJsonUnmarshaller<VectorSearchBedrockRerankingModelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public VectorSearchBedrockRerankingModelConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new VectorSearchBedrockRerankingModelConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static VectorSearchBedrockRerankingModelConfigurationUnmarshaller Instance => _instance;
    }
}
