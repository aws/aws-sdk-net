...
{
    /// <summary>
    /// Response Unmarshaller for CreateModelCustomizationJob operation
    /// </summary>  
    public class CreateModelCustomizationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelCustomizationJobResponse response = new CreateModelCustomizationJobResponse();
        ...
        private static CreateModelCustomizationJobResponseUnmarshaller _instance = new CreateModelCustomizationJobResponseUnmarshaller();        

        internal static CreateModelCustomizationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelCustomizationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
