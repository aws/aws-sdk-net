...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAutomatedReasoningPolicyAnnotationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAutomatedReasoningPolicyAnnotationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("annotationSetHash", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AnnotationSetHash = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetAutomatedReasoningPolicyAnnotationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAutomatedReasoningPolicyAnnotationsResponseUnmarshaller Instance => _instance;
    }
}
