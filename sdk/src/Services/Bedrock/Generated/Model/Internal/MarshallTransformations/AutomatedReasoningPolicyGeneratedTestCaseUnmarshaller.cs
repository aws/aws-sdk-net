...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomatedReasoningPolicyGeneratedTestCaseUnmarshaller : IUnmarshaller<AutomatedReasoningPolicyGeneratedTestCase, XmlUnmarshallerContext>, IUnmarshaller<AutomatedReasoningPolicyGeneratedTestCase, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutomatedReasoningPolicyGeneratedTestCase IUnmarshaller<AutomatedReasoningPolicyGeneratedTestCase, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutomatedReasoningPolicyGeneratedTestCase Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("expectedAggregatedFindingsResult", targetDepth))
                {
                    ...
                    unmarshalledObject.ExpectedAggregatedFindingsResult = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QueryContent = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
