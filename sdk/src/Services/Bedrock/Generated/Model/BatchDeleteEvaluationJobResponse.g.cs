...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class BatchDeleteEvaluationJobResponse : AmazonWebServiceResponse
    {
        ...
        public List<BatchDeleteEvaluationJobError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchDeleteEvaluationJobError>() : null;
        ...
        public List<BatchDeleteEvaluationJobItem> EvaluationJobs { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchDeleteEvaluationJobItem>() : null;

        /// <summary>
        /// Checks to see if the EvaluationJobs property is set.
        /// </summary>
        internal bool IsSetEvaluationJobs() => this.EvaluationJobs != null && (this.EvaluationJobs.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
