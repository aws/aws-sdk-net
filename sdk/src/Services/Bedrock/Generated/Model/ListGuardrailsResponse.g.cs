...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class ListGuardrailsResponse : AmazonWebServiceResponse
    {
        ...
        public List<GuardrailSummary> Guardrails { get; set; } = AWSConfigs.InitializeCollections ? new List<GuardrailSummary>() : null;

        /// <summary>
        /// Checks to see if the Guardrails property is set.
        /// </summary>
        internal bool IsSetGuardrails() => this.Guardrails != null && (this.Guardrails.Count > 0 || !AWSConfigs.InitializeCollections);
