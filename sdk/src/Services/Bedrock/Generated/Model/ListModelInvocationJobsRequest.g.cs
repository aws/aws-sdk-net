...
{
    /// <summary>
    /// Container for the parameters to the ListModelInvocationJobs operation. Lists all batch
    /// inference jobs in the account. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/batch-inference-view.html">View
    ...
    public partial class ListModelInvocationJobsRequest : AmazonBedrockRequest
    {
        ...
        ///  </li> </ul>
        /// </summary>
        public ModelInvocationJobStatus StatusEquals { get; set; }
        ...
        /// </para>
        /// </summary>
        public DateTime? SubmitTimeAfter { get; set; }

        /// <summary>
        /// Checks to see if the SubmitTimeAfter property is set.
        /// </summary>
        internal bool IsSetSubmitTimeAfter() => this.SubmitTimeAfter.HasValue;
        ...
        /// </para>
        /// </summary>
        public DateTime? SubmitTimeBefore { get; set; }

        /// <summary>
        /// Checks to see if the SubmitTimeBefore property is set.
        /// </summary>
        internal bool IsSetSubmitTimeBefore() => this.SubmitTimeBefore.HasValue;
    }
}
