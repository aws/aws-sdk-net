...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class VectorSearchRerankingConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public VectorSearchBedrockRerankingConfiguration BedrockRerankingConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the BedrockRerankingConfiguration property is set.
        /// </summary>
        internal bool IsSetBedrockRerankingConfiguration() => this.BedrockRerankingConfiguration != null;
        ...
        public VectorSearchRerankingConfigurationType Type { get; set; }
