...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class CustomMetricDefinition
    {
        ...
        public List<RatingScaleItem> RatingScale { get; set; } = AWSConfigs.InitializeCollections ? new List<RatingScaleItem>() : null;

        /// <summary>
        /// Checks to see if the RatingScale property is set.
        /// </summary>
        internal bool IsSetRatingScale() => this.RatingScale != null && (this.RatingScale.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
