...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningPolicyBuildLogEntry
    {
        ...
        public AutomatedReasoningPolicyAnnotation Annotation { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<AutomatedReasoningPolicyBuildStep> BuildSteps { get; set; } = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningPolicyBuildStep>() : null;

        /// <summary>
        /// Checks to see if the BuildSteps property is set.
        /// </summary>
        internal bool IsSetBuildSteps() => this.BuildSteps != null && (this.BuildSteps.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public AutomatedReasoningPolicyAnnotationStatus Status { get; set; }
