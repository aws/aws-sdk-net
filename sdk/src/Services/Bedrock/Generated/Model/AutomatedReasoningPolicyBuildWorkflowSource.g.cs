...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class AutomatedReasoningPolicyBuildWorkflowSource
    {
        ...
        /// </para>
        /// </summary>
        public AutomatedReasoningPolicyWorkflowTypeContent WorkflowContent { get; set; }

        /// <summary>
        /// Checks to see if the WorkflowContent property is set.
        /// </summary>
        internal bool IsSetWorkflowContent() => this.WorkflowContent != null;
    }
}
