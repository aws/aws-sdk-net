...
{
    /// <summary>
    /// Container for the parameters to the CreateCustomModel operation. Creates a new custom
    /// model in Amazon Bedrock. After the model is active, you can use it for inference.
    /// <para> You can provide the model data source in one of the following ways: </para>
    /// <ul> <li> <para> <c>customModelDataSource</c> — Specify a SageMaker AI model package
    /// ARN. Amazon Bedrock resolves the model package to retrieve the model artifacts. This
    /// is the preferred method for new SageMaker AI training outputs. </para> </li> <li>
    /// <para> <c>modelSourceConfig</c> — Specify an Amazon S3 URI pointing to the Amazon-managed
    /// Amazon S3 bucket containing your model artifacts. </para> </li> </ul> <para> To use
    /// the model for inference, you must purchase Provisioned Throughput for it. You can't
    /// use On-demand inference with these custom models. For more information about Provisioned
    /// Throughput, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html">Provisioned
    /// Throughput</a>. </para> <para> The model appears in <c>ListCustomModels</c> with a
    /// <c>customizationType</c> of <c>imported</c>. To track the status of the new model,
    /// you use the <c>GetCustomModel</c> API operation. The model can be in the following
    /// states: </para> <ul> <li> <para> <c>Creating</c> - Initial state during validation
    /// and registration </para> </li> <li> <para> <c>Active</c> - Model is ready for use
    /// in inference </para> </li> <li> <para> <c>Failed</c> - Creation process encountered
    /// an error </para> </li> </ul> <para> <b>Related APIs</b> </para> <ul> <li> <para> <a
    /// href="https://docs.aws.amazon.com/bedrock/latest/APIReference/API_GetCustomModel.html">GetCustomModel</a>
    /// </para> </li> <li> <para> <a href="https://docs.aws.amazon.com/bedrock/latest/APIReference/API_ListCustomModels.html">ListCustomModels</a>
    /// </para> </li> <li> <para> <a href="https://docs.aws.amazon.com/bedrock/latest/APIReference/API_DeleteCustomModel.html">DeleteCustomModel</a>
    /// </para> </li> </ul>
    /// </summary>
    public partial class CreateCustomModelRequest : AmazonBedrockRequest
    {
        ...
        /// </para>
        /// </summary>
        public CustomModelDataSource CustomModelDataSource { get; set; }

        /// <summary>
        /// Checks to see if the CustomModelDataSource property is set.
        /// </summary>
        internal bool IsSetCustomModelDataSource() => this.CustomModelDataSource != null;
        ...
        /// </para>
        /// </summary>
        public ModelDataSource ModelSourceConfig { get; set; }

        /// <summary>
        /// Checks to see if the ModelSourceConfig property is set.
        /// </summary>
        internal bool IsSetModelSourceConfig() => this.ModelSourceConfig != null;
        ...
        public List<Tag> ModelTags { get; set; } = AWSConfigs.InitializeCollections ? new List<Tag>() : null;

        /// <summary>
        /// Checks to see if the ModelTags property is set.
        /// </summary>
        internal bool IsSetModelTags() => this.ModelTags != null && (this.ModelTags.Count > 0 || !AWSConfigs.InitializeCollections);
