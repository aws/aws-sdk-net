...
{
    /// <summary>
    /// Container for the parameters to the CreateModelCopyJob operation. Copies a model to
    /// another region so that it can be used there. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/copy-model.html">Copy
    ...
    public partial class CreateModelCopyJobRequest : AmazonBedrockRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ModelKmsKeyId property is set.
        /// </summary>
        internal bool IsSetModelKmsKeyId() => this.ModelKmsKeyId != null;
