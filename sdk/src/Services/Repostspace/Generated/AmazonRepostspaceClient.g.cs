...
namespace Amazon.Repostspace
{
    ...
    public partial class AmazonRepostspaceClient : AmazonServiceClient, IAmazonRepostspace
    {
        ...
        /// 
        /// </summary>
        public AmazonRepostspaceClient() : base(new AmazonRepostspaceConfig()) { }
        ...
        public AmazonRepostspaceClient(RegionEndpoint region) : base(new AmazonRepostspaceConfig { RegionEndpoint = region }) { }
        ...
        public AmazonRepostspaceClient(AmazonRepostspaceConfig config) : base(config) { }
