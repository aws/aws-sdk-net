...
namespace Amazon.Repostspace.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving Repostspace endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonRepostspaceEndpointProvider"/> and <see cref="AmazonRepostspaceEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class RepostspaceEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// RepostspaceEndpointParameters constructor
        /// </summary>
        public RepostspaceEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
