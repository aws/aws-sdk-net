...
namespace Amazon.Repostspace
{
    ...
    public partial interface IAmazonRepostspace : IAmazonService, IDisposable
    {
        ...
        Task<BatchAddChannelRoleToAccessorsResponse> BatchAddChannelRoleToAccessorsAsync(BatchAddChannelRoleToAccessorsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BatchAddRoleResponse> BatchAddRoleAsync(BatchAddRoleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BatchRemoveChannelRoleFromAccessorsResponse> BatchRemoveChannelRoleFromAccessorsAsync(BatchRemoveChannelRoleFromAccessorsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BatchRemoveRoleResponse> BatchRemoveRoleAsync(BatchRemoveRoleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRepostspaceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRepostspaceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRepostspaceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRepostspaceConfig to create AmazonRepostspaceClient");
            }

            return awsCredentials == null ? 
                    new AmazonRepostspaceClient(serviceClientConfig) :
                    new AmazonRepostspaceClient(awsCredentials, serviceClientConfig);
        }
