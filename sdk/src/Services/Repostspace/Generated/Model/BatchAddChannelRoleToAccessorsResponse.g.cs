...
namespace Amazon.Repostspace.Model
{
    ...
    public partial class BatchAddChannelRoleToAccessorsResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> AddedAccessorIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AddedAccessorIds property is set.
        /// </summary>
        internal bool IsSetAddedAccessorIds() => this.AddedAccessorIds != null && (this.AddedAccessorIds.Count > 0 || !AWSConfigs.InitializeCollections);
