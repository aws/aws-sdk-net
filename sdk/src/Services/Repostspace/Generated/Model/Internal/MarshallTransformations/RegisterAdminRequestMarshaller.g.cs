...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisterAdminRequestMarshaller : IMarshaller<IRequest, RegisterAdminRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RegisterAdminRequestMarshaller _instance = new();

        internal static RegisterAdminRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterAdminRequestMarshaller Instance => _instance;
    }
}
