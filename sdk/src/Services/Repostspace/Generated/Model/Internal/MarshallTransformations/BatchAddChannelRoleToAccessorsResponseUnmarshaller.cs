...
{
    /// <summary>
    /// Response Unmarshaller for BatchAddChannelRoleToAccessors operation
    /// </summary>  
    public class BatchAddChannelRoleToAccessorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchAddChannelRoleToAccessorsResponse response = new BatchAddChannelRoleToAccessorsResponse();
            ...
            {
                if (context.TestExpression("addedAccessorIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.AddedAccessorIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static BatchAddChannelRoleToAccessorsResponseUnmarshaller _instance = new BatchAddChannelRoleToAccessorsResponseUnmarshaller();        

        internal static BatchAddChannelRoleToAccessorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAddChannelRoleToAccessorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
