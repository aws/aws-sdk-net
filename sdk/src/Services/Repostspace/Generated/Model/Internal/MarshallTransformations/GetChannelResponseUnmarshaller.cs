        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("channelDescription", targetDepth))
                {
                    ...
                    response.ChannelDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("channelRoles", targetDepth))
                {
                    ...
                    response.ChannelRoles = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("channelStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ChannelStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
