...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchAddRoleRequestMarshaller : IMarshaller<IRequest, BatchAddRoleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchAddRoleRequestMarshaller _instance = new();

        internal static BatchAddRoleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchAddRoleRequestMarshaller Instance => _instance;
    }
}
