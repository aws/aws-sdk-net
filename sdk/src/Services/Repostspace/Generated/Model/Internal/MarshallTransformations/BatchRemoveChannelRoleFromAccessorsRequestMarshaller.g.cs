...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchRemoveChannelRoleFromAccessorsRequestMarshaller : IMarshaller<IRequest, BatchRemoveChannelRoleFromAccessorsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchRemoveChannelRoleFromAccessorsRequestMarshaller _instance = new();

        internal static BatchRemoveChannelRoleFromAccessorsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchRemoveChannelRoleFromAccessorsRequestMarshaller Instance => _instance;
    }
}
