...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelDataUnmarshaller : IJsonUnmarshaller<ChannelData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelData();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("groupCount", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelDataUnmarshaller Instance => _instance;
    }
}
