...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeregisterAdminRequestMarshaller : IMarshaller<IRequest, DeregisterAdminRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeregisterAdminRequestMarshaller _instance = new();

        internal static DeregisterAdminRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeregisterAdminRequestMarshaller Instance => _instance;
    }
}
