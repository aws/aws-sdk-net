...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendInvitesRequestMarshaller : IMarshaller<IRequest, SendInvitesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SendInvitesRequestMarshaller _instance = new();

        internal static SendInvitesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendInvitesRequestMarshaller Instance => _instance;
    }
}
