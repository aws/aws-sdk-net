...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchAddChannelRoleToAccessorsRequestMarshaller : IMarshaller<IRequest, BatchAddChannelRoleToAccessorsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchAddChannelRoleToAccessorsRequestMarshaller _instance = new();

        internal static BatchAddChannelRoleToAccessorsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchAddChannelRoleToAccessorsRequestMarshaller Instance => _instance;
    }
}
