...
{
    /// <summary>
    /// Response Unmarshaller for BatchAddRole operation
    /// </summary>  
    public class BatchAddRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchAddRoleResponse response = new BatchAddRoleResponse();
        ...
        private static BatchAddRoleResponseUnmarshaller _instance = new BatchAddRoleResponseUnmarshaller();        

        internal static BatchAddRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAddRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
