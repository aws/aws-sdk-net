...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetChannelRequestMarshaller : IMarshaller<IRequest, GetChannelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetChannelRequestMarshaller _instance = new();

        internal static GetChannelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetChannelRequestMarshaller Instance => _instance;
    }
}
