...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSpaceRequestMarshaller : IMarshaller<IRequest, GetSpaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSpaceRequestMarshaller _instance = new();

        internal static GetSpaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSpaceRequestMarshaller Instance => _instance;
    }
}
