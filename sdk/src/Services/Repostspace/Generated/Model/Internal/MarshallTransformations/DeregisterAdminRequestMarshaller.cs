...
{
    /// <summary>
    /// DeregisterAdmin Request Marshaller
    /// </summary>       
    public class DeregisterAdminRequestMarshaller : IMarshaller<IRequest, DeregisterAdminRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeregisterAdminRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeregisterAdminRequest publicRequest)
        {
        ...
        private static DeregisterAdminRequestMarshaller _instance = new DeregisterAdminRequestMarshaller();        

        internal static DeregisterAdminRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterAdminRequestMarshaller Instance
        {
            get
            {
                return _instance;
