...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SpaceDataUnmarshaller : IJsonUnmarshaller<SpaceData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SpaceData();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SpaceDataUnmarshaller Instance => _instance;
    }
}
