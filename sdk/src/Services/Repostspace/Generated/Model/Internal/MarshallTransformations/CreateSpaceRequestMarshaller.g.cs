...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateSpaceRequestMarshaller : IMarshaller<IRequest, CreateSpaceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateSpaceRequestMarshaller _instance = new();

        internal static CreateSpaceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSpaceRequestMarshaller Instance => _instance;
    }
}
