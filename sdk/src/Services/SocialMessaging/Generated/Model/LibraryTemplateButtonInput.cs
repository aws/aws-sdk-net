...
namespace Amazon.SocialMessaging.Model
{
    ...
    /// </summary>
    public partial class LibraryTemplateButtonInput
    {
        ...
        private Dictionary<string, string> _url = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;
        ...
        {
            return this._url != null && (this._url.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
        ...
        {
            get { return this._zeroTapTermsAccepted.GetValueOrDefault(); }
