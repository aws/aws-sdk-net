...
{
    /// <summary>
    /// Response Unmarshaller for GetWhatsAppBusinessPublicKey operation
    /// </summary>  
    public class GetWhatsAppBusinessPublicKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWhatsAppBusinessPublicKeyResponse response = new GetWhatsAppBusinessPublicKeyResponse();
            ...
            {
                if (context.TestExpression("businessPublicKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BusinessPublicKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("businessPublicKeySignatureStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BusinessPublicKeySignatureStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetWhatsAppBusinessPublicKeyResponseUnmarshaller _instance = new GetWhatsAppBusinessPublicKeyResponseUnmarshaller();        

        internal static GetWhatsAppBusinessPublicKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWhatsAppBusinessPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
