...
{
    /// <summary>
    /// CreateWhatsAppFlow Request Marshaller
    /// </summary>       
    public class CreateWhatsAppFlowRequestMarshaller : IMarshaller<IRequest, CreateWhatsAppFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateWhatsAppFlowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateWhatsAppFlowRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/whatsapp/flow/create";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetCloneFlowId())
            {
                context.Writer.WritePropertyName("cloneFlowId");
            ...
            if(publicRequest.IsSetFlowJson())
            {
                ...
                StringUtils.WriteBase64StringValue(context.Writer, publicRequest.FlowJson);
            }
        ...
        private static CreateWhatsAppFlowRequestMarshaller _instance = new CreateWhatsAppFlowRequestMarshaller();        

        internal static CreateWhatsAppFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatsAppFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
