...
{
    /// <summary>
    /// Response Unmarshaller for DeprecateWhatsAppFlow operation
    /// </summary>  
    public class DeprecateWhatsAppFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeprecateWhatsAppFlowResponse response = new DeprecateWhatsAppFlowResponse();
        ...
        private static DeprecateWhatsAppFlowResponseUnmarshaller _instance = new DeprecateWhatsAppFlowResponseUnmarshaller();        

        internal static DeprecateWhatsAppFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeprecateWhatsAppFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
