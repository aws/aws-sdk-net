...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWhatsAppFlow operation
    /// </summary>  
    public class DeleteWhatsAppFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWhatsAppFlowResponse response = new DeleteWhatsAppFlowResponse();
        ...
        private static DeleteWhatsAppFlowResponseUnmarshaller _instance = new DeleteWhatsAppFlowResponseUnmarshaller();        

        internal static DeleteWhatsAppFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWhatsAppFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
