...
{
    /// <summary>
    /// Response Unmarshaller for GetWhatsAppFlowPreview operation
    /// </summary>  
    public class GetWhatsAppFlowPreviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWhatsAppFlowPreviewResponse response = new GetWhatsAppFlowPreviewResponse();
        ...
        private static GetWhatsAppFlowPreviewResponseUnmarshaller _instance = new GetWhatsAppFlowPreviewResponseUnmarshaller();        

        internal static GetWhatsAppFlowPreviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWhatsAppFlowPreviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
