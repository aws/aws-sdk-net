...
{
    /// <summary>
    /// Response Unmarshaller for SendWhatsAppCallEvent operation
    /// </summary>  
    public class SendWhatsAppCallEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendWhatsAppCallEventResponse response = new SendWhatsAppCallEventResponse();
            ...
            {
                if (context.TestExpression("callId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CallId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static SendWhatsAppCallEventResponseUnmarshaller _instance = new SendWhatsAppCallEventResponseUnmarshaller();        

        internal static SendWhatsAppCallEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendWhatsAppCallEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
