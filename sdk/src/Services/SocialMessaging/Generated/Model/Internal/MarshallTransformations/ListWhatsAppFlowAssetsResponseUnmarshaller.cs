...
{
    /// <summary>
    /// Response Unmarshaller for ListWhatsAppFlowAssets operation
    /// </summary>  
    public class ListWhatsAppFlowAssetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWhatsAppFlowAssetsResponse response = new ListWhatsAppFlowAssetsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("flowAssets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MetaFlowAsset, MetaFlowAssetUnmarshaller>(MetaFlowAssetUnmarshaller.Instance);
                    response.FlowAssets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListWhatsAppFlowAssetsResponseUnmarshaller _instance = new ListWhatsAppFlowAssetsResponseUnmarshaller();        

        internal static ListWhatsAppFlowAssetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWhatsAppFlowAssetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
