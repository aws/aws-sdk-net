...
{
    /// <summary>
    /// DeleteWhatsAppFlow Request Marshaller
    /// </summary>       
    public class DeleteWhatsAppFlowRequestMarshaller : IMarshaller<IRequest, DeleteWhatsAppFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteWhatsAppFlowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteWhatsAppFlowRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/whatsapp/flow";
            request.UseQueryString = true;

            return request;
        }
        private static DeleteWhatsAppFlowRequestMarshaller _instance = new DeleteWhatsAppFlowRequestMarshaller();        

        internal static DeleteWhatsAppFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWhatsAppFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
