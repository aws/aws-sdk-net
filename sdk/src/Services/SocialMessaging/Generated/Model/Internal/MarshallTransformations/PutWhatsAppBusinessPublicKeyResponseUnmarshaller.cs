...
{
    /// <summary>
    /// Response Unmarshaller for PutWhatsAppBusinessPublicKey operation
    /// </summary>  
    public class PutWhatsAppBusinessPublicKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutWhatsAppBusinessPublicKeyResponse response = new PutWhatsAppBusinessPublicKeyResponse();
        ...
        private static PutWhatsAppBusinessPublicKeyResponseUnmarshaller _instance = new PutWhatsAppBusinessPublicKeyResponseUnmarshaller();        

        internal static PutWhatsAppBusinessPublicKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutWhatsAppBusinessPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
