...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWhatsAppFlowAssets operation
    /// </summary>  
    public class UpdateWhatsAppFlowAssetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWhatsAppFlowAssetsResponse response = new UpdateWhatsAppFlowAssetsResponse();
        ...
        private static UpdateWhatsAppFlowAssetsResponseUnmarshaller _instance = new UpdateWhatsAppFlowAssetsResponseUnmarshaller();        

        internal static UpdateWhatsAppFlowAssetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWhatsAppFlowAssetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
