...
{
    /// <summary>
    /// Response Unmarshaller for CreateWhatsAppDataset operation
    /// </summary>  
    public class CreateWhatsAppDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWhatsAppDatasetResponse response = new CreateWhatsAppDatasetResponse();
        ...
        private static CreateWhatsAppDatasetResponseUnmarshaller _instance = new CreateWhatsAppDatasetResponseUnmarshaller();        

        internal static CreateWhatsAppDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatsAppDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
