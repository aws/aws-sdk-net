...
{
    /// <summary>
    /// Response Unmarshaller for SendWhatsAppConversionEvent operation
    /// </summary>  
    public class SendWhatsAppConversionEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendWhatsAppConversionEventResponse response = new SendWhatsAppConversionEventResponse();
        ...
        private static SendWhatsAppConversionEventResponseUnmarshaller _instance = new SendWhatsAppConversionEventResponseUnmarshaller();        

        internal static SendWhatsAppConversionEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendWhatsAppConversionEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
