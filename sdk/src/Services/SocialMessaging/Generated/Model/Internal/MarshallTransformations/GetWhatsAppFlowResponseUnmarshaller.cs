...
{
    /// <summary>
    /// Response Unmarshaller for GetWhatsAppFlow operation
    /// </summary>  
    public class GetWhatsAppFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWhatsAppFlowResponse response = new GetWhatsAppFlowResponse();
        ...
        private static GetWhatsAppFlowResponseUnmarshaller _instance = new GetWhatsAppFlowResponseUnmarshaller();        

        internal static GetWhatsAppFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWhatsAppFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
