...
{
    /// <summary>
    /// Response Unmarshaller for PublishWhatsAppFlow operation
    /// </summary>  
    public class PublishWhatsAppFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PublishWhatsAppFlowResponse response = new PublishWhatsAppFlowResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ThrottledRequestExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static PublishWhatsAppFlowResponseUnmarshaller _instance = new PublishWhatsAppFlowResponseUnmarshaller();        

        internal static PublishWhatsAppFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PublishWhatsAppFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
