...
namespace Amazon.SocialMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListWhatsAppFlowAssetsRequestMarshaller : IMarshaller<IRequest, ListWhatsAppFlowAssetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListWhatsAppFlowAssetsRequestMarshaller _instance = new ListWhatsAppFlowAssetsRequestMarshaller();        

        internal static ListWhatsAppFlowAssetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWhatsAppFlowAssetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
