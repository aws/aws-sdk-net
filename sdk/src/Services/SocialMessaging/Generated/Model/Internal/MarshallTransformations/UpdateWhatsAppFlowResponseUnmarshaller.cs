...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWhatsAppFlow operation
    /// </summary>  
    public class UpdateWhatsAppFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWhatsAppFlowResponse response = new UpdateWhatsAppFlowResponse();
        ...
        private static UpdateWhatsAppFlowResponseUnmarshaller _instance = new UpdateWhatsAppFlowResponseUnmarshaller();        

        internal static UpdateWhatsAppFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWhatsAppFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
