...
{
    /// <summary>
    /// GetWhatsAppFlow Request Marshaller
    /// </summary>       
    public class GetWhatsAppFlowRequestMarshaller : IMarshaller<IRequest, GetWhatsAppFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetWhatsAppFlowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetWhatsAppFlowRequest publicRequest)
        {
        ...
        private static GetWhatsAppFlowRequestMarshaller _instance = new GetWhatsAppFlowRequestMarshaller();        

        internal static GetWhatsAppFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWhatsAppFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
