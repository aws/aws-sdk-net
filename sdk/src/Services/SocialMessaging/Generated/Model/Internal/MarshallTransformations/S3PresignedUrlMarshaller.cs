...
{
    /// <summary>
    /// S3PresignedUrl Marshaller
    /// </summary>
    public class S3PresignedUrlMarshaller : IRequestMarshaller<S3PresignedUrl, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(S3PresignedUrl requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetHeaders())
            {
                ...
                foreach (var requestObjectHeadersKvp in requestObject.Headers)
                {
                    ...
                    var requestObjectHeadersValue = requestObjectHeadersKvp.Value;
                        ...
                        context.Writer.Write(requestObjectHeadersValue);
                }
        ...
        /// </summary>
        public readonly static S3PresignedUrlMarshaller Instance = new S3PresignedUrlMarshaller();
