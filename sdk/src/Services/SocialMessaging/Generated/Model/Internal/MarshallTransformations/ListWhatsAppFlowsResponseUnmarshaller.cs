...
{
    /// <summary>
    /// Response Unmarshaller for ListWhatsAppFlows operation
    /// </summary>  
    public class ListWhatsAppFlowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWhatsAppFlowsResponse response = new ListWhatsAppFlowsResponse();
        ...
        private static ListWhatsAppFlowsResponseUnmarshaller _instance = new ListWhatsAppFlowsResponseUnmarshaller();        

        internal static ListWhatsAppFlowsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWhatsAppFlowsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
