...
namespace Amazon.SocialMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LinkedWhatsAppBusinessAccountUnmarshaller : IJsonUnmarshaller<LinkedWhatsAppBusinessAccount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LinkedWhatsAppBusinessAccount Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("eventDestinations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EventDestinations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("linkDate", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.LinkDate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("marketingMessagesOnboardingStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WhatsAppPhoneNumberSummary, WhatsAppPhoneNumberSummaryUnmarshaller>(WhatsAppPhoneNumberSummaryUnmarshaller.Instance);
                ...
                if (context.TestExpression("wabaName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WabaName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
