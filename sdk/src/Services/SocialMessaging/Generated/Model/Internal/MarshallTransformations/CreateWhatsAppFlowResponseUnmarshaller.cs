...
{
    /// <summary>
    /// Response Unmarshaller for CreateWhatsAppFlow operation
    /// </summary>  
    public class CreateWhatsAppFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWhatsAppFlowResponse response = new CreateWhatsAppFlowResponse();
        ...
        private static CreateWhatsAppFlowResponseUnmarshaller _instance = new CreateWhatsAppFlowResponseUnmarshaller();        

        internal static CreateWhatsAppFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatsAppFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
