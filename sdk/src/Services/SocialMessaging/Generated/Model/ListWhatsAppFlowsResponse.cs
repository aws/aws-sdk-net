...
{
    /// <summary>
    /// This is the response object from the ListWhatsAppFlows operation.
    /// </summary>
    public partial class ListWhatsAppFlowsResponse : AmazonWebServiceResponse
    {
        private List<MetaFlowSummary> _flows = AWSConfigs.InitializeCollections ? new List<MetaFlowSummary>() : null;
        ...
        public List<MetaFlowSummary> Flows
        {
