...
namespace Amazon.MigrationHubStrategyRecommendations
{
    ...
    public partial interface IAmazonMigrationHubStrategyRecommendations : IAmazonService, IDisposable
    {
        ...
        Task<ListAnalyzableServersResponse> ListAnalyzableServersAsync(ListAnalyzableServersRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMigrationHubStrategyRecommendationsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMigrationHubStrategyRecommendationsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMigrationHubStrategyRecommendationsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMigrationHubStrategyRecommendationsConfig to create AmazonMigrationHubStrategyRecommendationsClient");
            }

            return awsCredentials == null ? 
                    new AmazonMigrationHubStrategyRecommendationsClient(serviceClientConfig) :
                    new AmazonMigrationHubStrategyRecommendationsClient(awsCredentials, serviceClientConfig);
        }
