...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    public class NetworkInfoUnmarshaller : IUnmarshaller<NetworkInfo, XmlUnmarshallerContext>, IUnmarshaller<NetworkInfo, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        NetworkInfo IUnmarshaller<NetworkInfo, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public NetworkInfo Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("interfaceName", targetDepth))
                {
                    ...
                    unmarshalledObject.InterfaceName = unmarshaller.Unmarshall(context);
                    continue;
                }
