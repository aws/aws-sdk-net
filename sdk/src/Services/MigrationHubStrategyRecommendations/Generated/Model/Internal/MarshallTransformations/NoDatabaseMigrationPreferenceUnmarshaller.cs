...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    public class NoDatabaseMigrationPreferenceUnmarshaller : IJsonUnmarshaller<NoDatabaseMigrationPreference, JsonUnmarshallerContext>
    {
        ...
        public NoDatabaseMigrationPreference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("targetDatabaseEngine", targetDepth, ref reader))
                {
        ...
        private static NoDatabaseMigrationPreferenceUnmarshaller _instance = new NoDatabaseMigrationPreferenceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NoDatabaseMigrationPreferenceUnmarshaller Instance
        {
            get
            {
                return _instance;
