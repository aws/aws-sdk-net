...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    public class AntipatternReportResultUnmarshaller : IJsonUnmarshaller<AntipatternReportResult, JsonUnmarshallerContext>
    {
        ...
        public AntipatternReportResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("analyzerName", targetDepth, ref reader))
                {
        ...
        private static AntipatternReportResultUnmarshaller _instance = new AntipatternReportResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AntipatternReportResultUnmarshaller Instance
        {
            get
            {
                return _instance;
