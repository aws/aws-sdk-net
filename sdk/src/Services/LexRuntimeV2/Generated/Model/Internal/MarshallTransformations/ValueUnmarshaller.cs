        ...
        public Value Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("interpretedValue", targetDepth))
                {
                    ...
                    unmarshalledObject.InterpretedValue = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("originalValue", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OriginalValue = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("resolvedValues", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.ResolvedValues = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
