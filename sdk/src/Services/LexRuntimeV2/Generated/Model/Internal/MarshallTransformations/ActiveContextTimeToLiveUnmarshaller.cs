...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActiveContextTimeToLiveUnmarshaller : IUnmarshaller<ActiveContextTimeToLive, XmlUnmarshallerContext>, IUnmarshaller<ActiveContextTimeToLive, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ActiveContextTimeToLive IUnmarshaller<ActiveContextTimeToLive, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActiveContextTimeToLiveUnmarshaller Instance
        {
            get
            {
                return _instance;
