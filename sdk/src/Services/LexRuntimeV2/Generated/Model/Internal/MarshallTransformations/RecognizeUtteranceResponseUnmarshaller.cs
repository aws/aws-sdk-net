...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecognizeUtteranceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RecognizeUtteranceResponse response = new RecognizeUtteranceResponse();
            ...
            if (context.ResponseData.IsHeaderPresent("x-amz-lex-input-mode"))
                response.InputMode = context.ResponseData.GetHeaderValue("x-amz-lex-input-mode");
            ...
            if (context.ResponseData.IsHeaderPresent("x-amz-lex-interpretations"))
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonLexRuntimeV2Exception(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }
        ...
        private static RecognizeUtteranceResponseUnmarshaller _instance = new RecognizeUtteranceResponseUnmarshaller();        

        internal static RecognizeUtteranceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RecognizeUtteranceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
