...
namespace Amazon.ConnectCases
{
    ...
    public partial class AmazonConnectCasesException : AmazonServiceException
    {
        ...
        public AmazonConnectCasesException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonConnectCasesException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
