...
namespace Amazon.ConnectCases
{
    ...
    /// <summary>
    /// Constants used for properties of type TagPropagationResourceType.
    /// </summary>
    public class TagPropagationResourceType : ConstantClass
    {

        /// <summary>
        /// Constant Cases for TagPropagationResourceType
        /// </summary>
        public static readonly TagPropagationResourceType Cases = new TagPropagationResourceType("Cases");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public TagPropagationResourceType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static TagPropagationResourceType FindValue(string value)
        {
            return FindValue<TagPropagationResourceType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator TagPropagationResourceType(string value)
        {
            return FindValue(value);
        }
    }
