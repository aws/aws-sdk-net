...
namespace Amazon.ConnectCases
{
    ...
    public partial class AmazonConnectCasesClient : AmazonServiceClient, IAmazonConnectCases
    {
        ...
        public virtual UpdateRelatedItemResponse UpdateRelatedItem(UpdateRelatedItemRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/connectcases-2022-10-03/UpdateRelatedItem">REST API Reference for UpdateRelatedItem Operation</seealso>
        public virtual IAsyncResult BeginUpdateRelatedItem(UpdateRelatedItemRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateRelatedItemRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateRelatedItemResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/connectcases-2022-10-03/UpdateRelatedItem">REST API Reference for UpdateRelatedItem Operation</seealso>
        public virtual UpdateRelatedItemResponse EndUpdateRelatedItem(IAsyncResult asyncResult)
        {
            return EndInvoke<UpdateRelatedItemResponse>(asyncResult);
        }
