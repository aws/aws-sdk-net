...
namespace Amazon.ConnectCases
{
    ...
    public partial interface IAmazonConnectCases : IAmazonService, IDisposable
    {
        ...
        UpdateRelatedItemResponse UpdateRelatedItem(UpdateRelatedItemRequest request);

        /// <summary>
        /// Initiates the asynchronous execution of the UpdateRelatedItem operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the UpdateRelatedItem operation on AmazonConnectCasesClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndUpdateRelatedItem
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/connectcases-2022-10-03/UpdateRelatedItem">REST API Reference for UpdateRelatedItem Operation</seealso>
        IAsyncResult BeginUpdateRelatedItem(UpdateRelatedItemRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  UpdateRelatedItem operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginUpdateRelatedItem.</param>
        /// 
        /// <returns>Returns a  UpdateRelatedItemResult from ConnectCases.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/connectcases-2022-10-03/UpdateRelatedItem">REST API Reference for UpdateRelatedItem Operation</seealso>
        UpdateRelatedItemResponse EndUpdateRelatedItem(IAsyncResult asyncResult);
