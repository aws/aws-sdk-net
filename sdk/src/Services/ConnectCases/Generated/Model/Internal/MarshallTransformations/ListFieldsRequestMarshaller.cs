...
namespace Amazon.ConnectCases.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListFieldsRequestMarshaller : IMarshaller<IRequest, ListFieldsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListFieldsRequestMarshaller _instance = new ListFieldsRequestMarshaller();        

        internal static ListFieldsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFieldsRequestMarshaller Instance
        {
            get
            {
                return _instance;
