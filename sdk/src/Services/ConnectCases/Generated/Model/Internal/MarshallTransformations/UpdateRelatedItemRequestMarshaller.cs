...
{
    /// <summary>
    /// UpdateRelatedItem Request Marshaller
    /// </summary>       
    public class UpdateRelatedItemRequestMarshaller : IMarshaller<IRequest, UpdateRelatedItemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRelatedItemRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRelatedItemRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetContent())
            {
                ...
                var marshaller = RelatedItemUpdateContentMarshaller.Instance;
        ...
        private static UpdateRelatedItemRequestMarshaller _instance = new UpdateRelatedItemRequestMarshaller();        

        internal static UpdateRelatedItemRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRelatedItemRequestMarshaller Instance
        {
            get
            {
                return _instance;
