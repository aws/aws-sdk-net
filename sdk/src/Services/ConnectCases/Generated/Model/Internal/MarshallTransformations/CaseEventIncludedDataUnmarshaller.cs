...
namespace Amazon.ConnectCases.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CaseEventIncludedDataUnmarshaller : IJsonUnmarshaller<CaseEventIncludedData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CaseEventIncludedData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FieldIdentifier, FieldIdentifierUnmarshaller>(FieldIdentifierUnmarshaller.Instance);
