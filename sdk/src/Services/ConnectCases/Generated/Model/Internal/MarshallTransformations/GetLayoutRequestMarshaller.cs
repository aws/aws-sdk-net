...
{
    /// <summary>
    /// GetLayout Request Marshaller
    /// </summary>       
    public class GetLayoutRequestMarshaller : IMarshaller<IRequest, GetLayoutRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetLayoutRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetLayoutRequest publicRequest)
        {
        ...
        private static GetLayoutRequestMarshaller _instance = new GetLayoutRequestMarshaller();        

        internal static GetLayoutRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLayoutRequestMarshaller Instance
        {
            get
            {
                return _instance;
