...
namespace Amazon.Chime
{
    ...
    public partial class AmazonChimeClient : AmazonServiceClient, IAmazonChime
    {
        ...
        /// 
        /// </summary>
        public AmazonChimeClient() : base(new AmazonChimeConfig()) { }
        ...
        public AmazonChimeClient(RegionEndpoint region) : base(new AmazonChimeConfig { RegionEndpoint = region }) { }
        ...
        public AmazonChimeClient(AmazonChimeConfig config) : base(config) { }
