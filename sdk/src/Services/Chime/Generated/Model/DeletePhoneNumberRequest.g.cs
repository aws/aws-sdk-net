...
{
    /// <summary>
    /// Container for the parameters to the DeletePhoneNumber operation. Moves the specified
    /// phone number into the <b>Deletion queue</b>. A phone number must be disassociated
    /// from any users or Amazon Chime Voice Connectors before it can be deleted. <para> Deleted
