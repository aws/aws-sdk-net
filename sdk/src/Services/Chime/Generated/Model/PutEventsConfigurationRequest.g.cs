...
{
    /// <summary>
    /// Container for the parameters to the PutEventsConfiguration operation. Creates an events
    /// configuration that allows a bot to receive outgoing events sent by Amazon Chime. Choose
    /// either an HTTPS endpoint or a Lambda function ARN. For more information, see <a>Bot</a>.
    /// </summary>
