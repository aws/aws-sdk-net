...
{
    /// <summary>
    /// Container for the parameters to the UpdateUser operation. Updates user details for
    /// a specified user ID. Currently, only <c>LicenseType</c> updates are supported for
    /// this action.
    /// </summary>
