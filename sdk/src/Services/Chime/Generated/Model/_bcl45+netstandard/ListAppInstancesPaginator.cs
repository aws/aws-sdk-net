...
namespace Amazon.Chime.Model
{
    ...
    internal sealed partial class ListAppInstancesPaginator : IPaginator<ListAppInstancesResponse>, IListAppInstancesPaginator
    {
        ...
        internal ListAppInstancesPaginator(IAmazonChime client, ListAppInstancesRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListAppInstancesResponse> IPaginator<ListAppInstancesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
