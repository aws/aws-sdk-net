...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeleteAccountResponseUnmarshaller _instance = new DeleteAccountResponseUnmarshaller();        

        internal static DeleteAccountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
