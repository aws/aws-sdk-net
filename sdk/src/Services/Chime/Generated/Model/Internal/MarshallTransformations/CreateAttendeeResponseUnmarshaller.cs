...
{
    /// <summary>
    /// Response Unmarshaller for CreateAttendee operation
    /// </summary>  
    public class CreateAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAttendeeResponse response = new CreateAttendeeResponse();
        ...
        private static CreateAttendeeResponseUnmarshaller _instance = new CreateAttendeeResponseUnmarshaller();        

        internal static CreateAttendeeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAttendeeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
