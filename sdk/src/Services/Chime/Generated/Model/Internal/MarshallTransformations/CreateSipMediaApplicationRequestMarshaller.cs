...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class CreateSipMediaApplicationRequestMarshaller : IMarshaller<IRequest, CreateSipMediaApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSipMediaApplicationRequest publicRequest)
        {
        ...
        private static CreateSipMediaApplicationRequestMarshaller _instance = new CreateSipMediaApplicationRequestMarshaller();        

        internal static CreateSipMediaApplicationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSipMediaApplicationRequestMarshaller Instance
        {
            get
            {
                return _instance;
