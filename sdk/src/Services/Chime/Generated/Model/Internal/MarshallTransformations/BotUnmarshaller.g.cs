...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BotUnmarshaller : IJsonUnmarshaller<Bot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Bot();
            ...
            {
                if (context.TestExpression("BotEmail", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("SecurityToken", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static BotUnmarshaller Instance => _instance;
    }
}
