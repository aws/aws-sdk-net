...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorStreamingConfiguration operation
    /// </summary>  
    public class GetVoiceConnectorStreamingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorStreamingConfigurationResponse response = new GetVoiceConnectorStreamingConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("StreamingConfiguration", targetDepth))
                {
                    ...
                    response.StreamingConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVoiceConnectorStreamingConfigurationResponseUnmarshaller _instance = new GetVoiceConnectorStreamingConfigurationResponseUnmarshaller();        

        internal static GetVoiceConnectorStreamingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorStreamingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
