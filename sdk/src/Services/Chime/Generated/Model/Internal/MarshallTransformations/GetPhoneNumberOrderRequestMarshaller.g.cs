...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetPhoneNumberOrderRequestMarshaller : IMarshaller<IRequest, GetPhoneNumberOrderRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetPhoneNumberOrderRequestMarshaller _instance = new();

        internal static GetPhoneNumberOrderRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPhoneNumberOrderRequestMarshaller Instance => _instance;
    }
}
