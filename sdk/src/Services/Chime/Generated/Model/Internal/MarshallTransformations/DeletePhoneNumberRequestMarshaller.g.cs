...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeletePhoneNumberRequestMarshaller : IMarshaller<IRequest, DeletePhoneNumberRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeletePhoneNumberRequestMarshaller _instance = new();

        internal static DeletePhoneNumberRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeletePhoneNumberRequestMarshaller Instance => _instance;
    }
}
