...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateRoomMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateRoomMembershipResponse();
            ...
            {
                if (context.TestExpression("RoomMembership", targetDepth, ref reader))
                {
                    var unmarshaller = RoomMembershipUnmarshaller.Instance;
                    unmarshalledObject.RoomMembership = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateRoomMembershipResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateRoomMembershipResponseUnmarshaller Instance => _instance;
    }
}
