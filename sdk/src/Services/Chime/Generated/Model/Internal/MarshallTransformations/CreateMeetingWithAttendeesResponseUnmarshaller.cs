...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMeetingWithAttendeesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMeetingWithAttendeesResponse response = new CreateMeetingWithAttendeesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Attendee, AttendeeUnmarshaller>(AttendeeUnmarshaller.Instance);
                    response.Attendees = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Errors", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<CreateAttendeeError, CreateAttendeeErrorUnmarshaller>(CreateAttendeeErrorUnmarshaller.Instance);
        ...
        internal static CreateMeetingWithAttendeesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMeetingWithAttendeesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
