...
{
    /// <summary>
    /// Response Unmarshaller for PutVoiceConnectorTermination operation
    /// </summary>  
    public class PutVoiceConnectorTerminationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVoiceConnectorTerminationResponse response = new PutVoiceConnectorTerminationResponse();
        ...
        private static PutVoiceConnectorTerminationResponseUnmarshaller _instance = new PutVoiceConnectorTerminationResponseUnmarshaller();        

        internal static PutVoiceConnectorTerminationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVoiceConnectorTerminationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
