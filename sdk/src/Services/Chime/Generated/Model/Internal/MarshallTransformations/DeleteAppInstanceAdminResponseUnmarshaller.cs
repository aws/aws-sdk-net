...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppInstanceAdmin operation
    /// </summary>  
    public class DeleteAppInstanceAdminResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppInstanceAdminResponse response = new DeleteAppInstanceAdminResponse();
        ...
        private static DeleteAppInstanceAdminResponseUnmarshaller _instance = new DeleteAppInstanceAdminResponseUnmarshaller();        

        internal static DeleteAppInstanceAdminResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppInstanceAdminResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
