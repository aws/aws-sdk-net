...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceConnectorGroup operation
    /// </summary>  
    public class DeleteVoiceConnectorGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorGroupResponse response = new DeleteVoiceConnectorGroupResponse();
        ...
        private static DeleteVoiceConnectorGroupResponseUnmarshaller _instance = new DeleteVoiceConnectorGroupResponseUnmarshaller();        

        internal static DeleteVoiceConnectorGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
