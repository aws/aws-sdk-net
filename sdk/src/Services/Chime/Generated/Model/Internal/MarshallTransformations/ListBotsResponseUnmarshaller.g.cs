...
{
    /// <summary>
    /// Response Unmarshaller for ListBots operation.
    /// </summary>
    public partial class ListBotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListBotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Bots", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Bots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListBotsResponseUnmarshaller _instance = new ListBotsResponseUnmarshaller();

        internal static ListBotsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListBotsResponseUnmarshaller Instance => _instance;
    }
}
