...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateBotResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Bot", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Bot = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateBotResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateBotResponseUnmarshaller Instance => _instance;
    }
}
