...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchChannelMembershipsUnmarshaller : IJsonUnmarshaller<BatchChannelMemberships, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchChannelMemberships Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Identity, IdentityUnmarshaller>(IdentityUnmarshaller.Instance);
