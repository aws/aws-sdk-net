...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class CreateSipRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateSipRuleResponseUnmarshaller _instance = new CreateSipRuleResponseUnmarshaller();        

        internal static CreateSipRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSipRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
