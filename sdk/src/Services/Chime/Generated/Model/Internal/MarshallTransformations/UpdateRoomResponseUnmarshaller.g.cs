...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRoomResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateRoomResponse();
            ...
            {
                if (context.TestExpression("Room", targetDepth, ref reader))
                {
                    var unmarshaller = RoomUnmarshaller.Instance;
                    unmarshalledObject.Room = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateRoomResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRoomResponseUnmarshaller Instance => _instance;
    }
}
