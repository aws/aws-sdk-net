...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RestorePhoneNumberRequestMarshaller : IMarshaller<IRequest, RestorePhoneNumberRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RestorePhoneNumberRequestMarshaller _instance = new();

        internal static RestorePhoneNumberRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RestorePhoneNumberRequestMarshaller Instance => _instance;
    }
}
