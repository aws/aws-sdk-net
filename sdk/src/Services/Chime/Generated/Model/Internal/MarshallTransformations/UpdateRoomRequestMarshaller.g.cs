...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRoomRequestMarshaller : IMarshaller<IRequest, UpdateRoomRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateRoomRequest publicRequest)
        {
            ...
            request.ResourcePath = "/accounts/{AccountId}/rooms/{RoomId}";
#if !NETFRAMEWORK
        ...
        private static readonly UpdateRoomRequestMarshaller _instance = new();

        internal static UpdateRoomRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRoomRequestMarshaller Instance => _instance;
    }
}
