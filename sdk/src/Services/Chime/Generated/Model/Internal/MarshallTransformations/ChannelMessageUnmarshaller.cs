...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChannelMessageUnmarshaller : IJsonUnmarshaller<ChannelMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChannelMessage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Persistence = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
