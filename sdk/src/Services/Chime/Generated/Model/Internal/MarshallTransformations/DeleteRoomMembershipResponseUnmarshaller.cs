...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteRoomMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRoomMembershipResponse response = new DeleteRoomMembershipResponse();
        ...
        internal static DeleteRoomMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoomMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
