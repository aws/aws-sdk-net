    ...
    public class ListChannelMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ChannelMessageSummary, ChannelMessageSummaryUnmarshaller>(ChannelMessageSummaryUnmarshaller.Instance);
                    response.ChannelMessages = unmarshaller.Unmarshall(context);
                    continue;
                }
