...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelMessages operation
    /// </summary>  
    public class ListChannelMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelMessagesResponse response = new ListChannelMessagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelMessageSummary, ChannelMessageSummaryUnmarshaller>(ChannelMessageSummaryUnmarshaller.Instance);
                    response.ChannelMessages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListChannelMessagesResponseUnmarshaller _instance = new ListChannelMessagesResponseUnmarshaller();        

        internal static ListChannelMessagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelMessagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
