...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeletePhoneNumber operation
    /// </summary>  
    public class BatchDeletePhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeletePhoneNumberResponse response = new BatchDeletePhoneNumberResponse();
        ...
        private static BatchDeletePhoneNumberResponseUnmarshaller _instance = new BatchDeletePhoneNumberResponseUnmarshaller();        

        internal static BatchDeletePhoneNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeletePhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
