...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SipMediaApplicationUnmarshaller : IJsonUnmarshaller<SipMediaApplication, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SipMediaApplication Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SipMediaApplicationEndpoint, SipMediaApplicationEndpointUnmarshaller>(SipMediaApplicationEndpointUnmarshaller.Instance);
