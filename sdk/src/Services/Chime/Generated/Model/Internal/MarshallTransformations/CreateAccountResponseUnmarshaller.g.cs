...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccount operation.
    /// </summary>
    public partial class CreateAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAccountResponse();
        ...
        private static CreateAccountResponseUnmarshaller _instance = new CreateAccountResponseUnmarshaller();

        internal static CreateAccountResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAccountResponseUnmarshaller Instance => _instance;
    }
}
