...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetChannelMessageRequestMarshaller : IMarshaller<IRequest, GetChannelMessageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetChannelMessageRequestMarshaller _instance = new GetChannelMessageRequestMarshaller();        

        internal static GetChannelMessageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChannelMessageRequestMarshaller Instance
        {
            get
            {
                return _instance;
