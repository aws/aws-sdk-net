...
{
    /// <summary>
    /// Response Unmarshaller for GetAttendee operation
    /// </summary>  
    public class GetAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAttendeeResponseUnmarshaller _instance = new GetAttendeeResponseUnmarshaller();        

        internal static GetAttendeeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAttendeeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
