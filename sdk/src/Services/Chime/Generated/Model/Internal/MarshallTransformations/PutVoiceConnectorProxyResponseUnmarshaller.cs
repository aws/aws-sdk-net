...
{
    /// <summary>
    /// Response Unmarshaller for PutVoiceConnectorProxy operation
    /// </summary>  
    public class PutVoiceConnectorProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVoiceConnectorProxyResponse response = new PutVoiceConnectorProxyResponse();
        ...
        private static PutVoiceConnectorProxyResponseUnmarshaller _instance = new PutVoiceConnectorProxyResponseUnmarshaller();        

        internal static PutVoiceConnectorProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVoiceConnectorProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
