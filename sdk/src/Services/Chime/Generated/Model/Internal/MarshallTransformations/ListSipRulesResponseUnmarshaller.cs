...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSipRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSipRulesResponse response = new ListSipRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SipRules", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<SipRule, SipRuleUnmarshaller>(SipRuleUnmarshaller.Instance);
                    response.SipRules = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static ListSipRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSipRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
