...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAccountRequestMarshaller : IMarshaller<IRequest, GetAccountRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAccountRequestMarshaller _instance = new();

        internal static GetAccountRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAccountRequestMarshaller Instance => _instance;
    }
}
