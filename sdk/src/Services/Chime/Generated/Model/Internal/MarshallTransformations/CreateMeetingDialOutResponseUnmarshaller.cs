...
{
    /// <summary>
    /// Response Unmarshaller for CreateMeetingDialOut operation
    /// </summary>  
    public class CreateMeetingDialOutResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMeetingDialOutResponse response = new CreateMeetingDialOutResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("TransactionId", targetDepth))
                {
                    ...
                    response.TransactionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateMeetingDialOutResponseUnmarshaller _instance = new CreateMeetingDialOutResponseUnmarshaller();        

        internal static CreateMeetingDialOutResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMeetingDialOutResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
