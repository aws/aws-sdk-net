...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProxySession operation
    /// </summary>  
    public class UpdateProxySessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProxySessionResponse response = new UpdateProxySessionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ProxySessionUnmarshaller.Instance;
                    response.ProxySession = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateProxySessionResponseUnmarshaller _instance = new UpdateProxySessionResponseUnmarshaller();        

        internal static UpdateProxySessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProxySessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
