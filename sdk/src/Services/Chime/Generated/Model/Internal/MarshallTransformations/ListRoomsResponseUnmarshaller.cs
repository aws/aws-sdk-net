...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRoomsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Rooms", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Room, RoomUnmarshaller>(RoomUnmarshaller.Instance);
                    response.Rooms = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRoomsResponseUnmarshaller _instance = new ListRoomsResponseUnmarshaller();        

        internal static ListRoomsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRoomsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
