...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreateRoomMembership operation
    /// </summary>  
    public class BatchCreateRoomMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreateRoomMembershipResponse response = new BatchCreateRoomMembershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MemberError, MemberErrorUnmarshaller>(MemberErrorUnmarshaller.Instance);
        ...
        private static BatchCreateRoomMembershipResponseUnmarshaller _instance = new BatchCreateRoomMembershipResponseUnmarshaller();        

        internal static BatchCreateRoomMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateRoomMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
