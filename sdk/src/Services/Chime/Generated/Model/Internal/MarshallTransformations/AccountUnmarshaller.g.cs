...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AccountUnmarshaller : IJsonUnmarshaller<Account, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Account();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DefaultLicense", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SigninDelegateGroups", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("SupportedLicenses", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AccountUnmarshaller Instance => _instance;
    }
}
