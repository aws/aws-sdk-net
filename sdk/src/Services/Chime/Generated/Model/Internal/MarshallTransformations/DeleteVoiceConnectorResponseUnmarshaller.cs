...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVoiceConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorResponse response = new DeleteVoiceConnectorResponse();
        ...
        internal static DeleteVoiceConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
