...
{
    /// <summary>
    /// Response Unmarshaller for GetProxySession operation
    /// </summary>  
    public class GetProxySessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProxySessionResponse response = new GetProxySessionResponse();
        ...
        private static GetProxySessionResponseUnmarshaller _instance = new GetProxySessionResponseUnmarshaller();        

        internal static GetProxySessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProxySessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
