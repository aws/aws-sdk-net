...
{
    /// <summary>
    /// Response Unmarshaller for CreateChannelModerator operation
    /// </summary>  
    public class CreateChannelModeratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChannelModeratorResponse response = new CreateChannelModeratorResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ChannelModerator", targetDepth))
                {
                    var unmarshaller = IdentityUnmarshaller.Instance;
                    response.ChannelModerator = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateChannelModeratorResponseUnmarshaller _instance = new CreateChannelModeratorResponseUnmarshaller();        

        internal static CreateChannelModeratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelModeratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
