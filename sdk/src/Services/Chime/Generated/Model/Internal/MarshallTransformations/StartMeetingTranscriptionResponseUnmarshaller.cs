...
{
    /// <summary>
    /// Response Unmarshaller for StartMeetingTranscription operation
    /// </summary>  
    public class StartMeetingTranscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMeetingTranscriptionResponse response = new StartMeetingTranscriptionResponse();
        ...
        private static StartMeetingTranscriptionResponseUnmarshaller _instance = new StartMeetingTranscriptionResponseUnmarshaller();        

        internal static StartMeetingTranscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMeetingTranscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
