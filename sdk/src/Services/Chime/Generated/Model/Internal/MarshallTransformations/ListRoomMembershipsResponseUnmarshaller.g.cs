...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRoomMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListRoomMembershipsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RoomMemberships", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RoomMembership, RoomMembershipUnmarshaller>(RoomMembershipUnmarshaller.Instance);
                    unmarshalledObject.RoomMemberships = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListRoomMembershipsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRoomMembershipsResponseUnmarshaller Instance => _instance;
    }
}
