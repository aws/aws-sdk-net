...
{
    /// <summary>
    /// Response Unmarshaller for DeleteChannelBan operation
    /// </summary>  
    public class DeleteChannelBanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteChannelBanResponse response = new DeleteChannelBanResponse();
        ...
        private static DeleteChannelBanResponseUnmarshaller _instance = new DeleteChannelBanResponseUnmarshaller();        

        internal static DeleteChannelBanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelBanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
