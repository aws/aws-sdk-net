...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutEventsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutEventsConfigurationResponse response = new PutEventsConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("EventsConfiguration", targetDepth))
                {
                    ...
                    response.EventsConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static PutEventsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutEventsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
