...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePhoneNumber operation.
    /// </summary>
    public partial class UpdatePhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdatePhoneNumberResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = PhoneNumberUnmarshaller.Instance;
        ...
        private static UpdatePhoneNumberResponseUnmarshaller _instance = new UpdatePhoneNumberResponseUnmarshaller();

        internal static UpdatePhoneNumberResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdatePhoneNumberResponseUnmarshaller Instance => _instance;
    }
}
