...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListPhoneNumberOrdersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListPhoneNumberOrdersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PhoneNumberOrders", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PhoneNumberOrders = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListPhoneNumberOrdersResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPhoneNumberOrdersResponseUnmarshaller Instance => _instance;
    }
}
