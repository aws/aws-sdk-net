...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class CreateSipMediaApplicationCallResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateSipMediaApplicationCallResponseUnmarshaller _instance = new CreateSipMediaApplicationCallResponseUnmarshaller();        

        internal static CreateSipMediaApplicationCallResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSipMediaApplicationCallResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
