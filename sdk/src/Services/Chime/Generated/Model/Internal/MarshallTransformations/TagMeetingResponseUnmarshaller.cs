...
{
    /// <summary>
    /// Response Unmarshaller for TagMeeting operation
    /// </summary>  
    public class TagMeetingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagMeetingResponse response = new TagMeetingResponse();
        ...
        private static TagMeetingResponseUnmarshaller _instance = new TagMeetingResponseUnmarshaller();        

        internal static TagMeetingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagMeetingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
