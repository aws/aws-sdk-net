...
{
    /// <summary>
    /// Response Unmarshaller for PutVoiceConnectorOrigination operation
    /// </summary>  
    public class PutVoiceConnectorOriginationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVoiceConnectorOriginationResponse response = new PutVoiceConnectorOriginationResponse();
        ...
        private static PutVoiceConnectorOriginationResponseUnmarshaller _instance = new PutVoiceConnectorOriginationResponseUnmarshaller();        

        internal static PutVoiceConnectorOriginationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVoiceConnectorOriginationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
