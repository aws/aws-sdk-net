...
{
    /// <summary>
    /// Response Unmarshaller for GetRetentionSettings operation
    /// </summary>  
    public class GetRetentionSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRetentionSettingsResponse response = new GetRetentionSettingsResponse();
        ...
        private static GetRetentionSettingsResponseUnmarshaller _instance = new GetRetentionSettingsResponseUnmarshaller();        

        internal static GetRetentionSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRetentionSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
