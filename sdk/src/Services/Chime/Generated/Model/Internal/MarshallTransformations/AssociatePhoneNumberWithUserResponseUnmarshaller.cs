...
{
    /// <summary>
    /// Response Unmarshaller for AssociatePhoneNumberWithUser operation
    /// </summary>  
    public class AssociatePhoneNumberWithUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociatePhoneNumberWithUserResponse response = new AssociatePhoneNumberWithUserResponse();
        ...
        private static AssociatePhoneNumberWithUserResponseUnmarshaller _instance = new AssociatePhoneNumberWithUserResponseUnmarshaller();        

        internal static AssociatePhoneNumberWithUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociatePhoneNumberWithUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
