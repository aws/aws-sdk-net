...
{
    /// <summary>
    /// Response Unmarshaller for CreateAppInstance operation
    /// </summary>  
    public class CreateAppInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAppInstanceResponse response = new CreateAppInstanceResponse();
        ...
        private static CreateAppInstanceResponseUnmarshaller _instance = new CreateAppInstanceResponseUnmarshaller();        

        internal static CreateAppInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
