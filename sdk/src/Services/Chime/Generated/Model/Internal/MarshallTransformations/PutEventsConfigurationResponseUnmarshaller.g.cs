...
{
    /// <summary>
    /// Response Unmarshaller for PutEventsConfiguration operation.
    /// </summary>
    public partial class PutEventsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PutEventsConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EventsConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EventsConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PutEventsConfigurationResponseUnmarshaller _instance = new PutEventsConfigurationResponseUnmarshaller();

        internal static PutEventsConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutEventsConfigurationResponseUnmarshaller Instance => _instance;
    }
}
