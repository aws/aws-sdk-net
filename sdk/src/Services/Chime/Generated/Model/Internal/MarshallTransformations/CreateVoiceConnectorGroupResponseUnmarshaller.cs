    ...
    public class CreateVoiceConnectorGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = VoiceConnectorGroupUnmarshaller.Instance;
                    response.VoiceConnectorGroup = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateVoiceConnectorGroupResponseUnmarshaller _instance = new CreateVoiceConnectorGroupResponseUnmarshaller();        

        internal static CreateVoiceConnectorGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVoiceConnectorGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
