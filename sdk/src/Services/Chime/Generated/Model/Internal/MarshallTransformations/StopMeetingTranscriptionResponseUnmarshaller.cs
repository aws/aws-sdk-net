...
{
    /// <summary>
    /// Response Unmarshaller for StopMeetingTranscription operation
    /// </summary>  
    public class StopMeetingTranscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopMeetingTranscriptionResponse response = new StopMeetingTranscriptionResponse();
        ...
        private static StopMeetingTranscriptionResponseUnmarshaller _instance = new StopMeetingTranscriptionResponseUnmarshaller();        

        internal static StopMeetingTranscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopMeetingTranscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
