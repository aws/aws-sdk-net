...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdateUser operation.
    /// </summary>
    public partial class BatchUpdateUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchUpdateUserResponse();
            ...
            {
                if (context.TestExpression("UserErrors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UserError, UserErrorUnmarshaller>(UserErrorUnmarshaller.Instance);
                    unmarshalledObject.UserErrors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchUpdateUserResponseUnmarshaller _instance = new BatchUpdateUserResponseUnmarshaller();

        internal static BatchUpdateUserResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchUpdateUserResponseUnmarshaller Instance => _instance;
    }
}
