...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelModeratedByAppInstanceUser operation
    /// </summary>  
    public class DescribeChannelModeratedByAppInstanceUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelModeratedByAppInstanceUserResponse response = new DescribeChannelModeratedByAppInstanceUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ChannelModeratedByAppInstanceUserSummaryUnmarshaller.Instance;
        ...
        private static DescribeChannelModeratedByAppInstanceUserResponseUnmarshaller _instance = new DescribeChannelModeratedByAppInstanceUserResponseUnmarshaller();        

        internal static DescribeChannelModeratedByAppInstanceUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelModeratedByAppInstanceUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
