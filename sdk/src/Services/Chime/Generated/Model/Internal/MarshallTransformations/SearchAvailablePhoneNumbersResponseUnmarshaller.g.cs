...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchAvailablePhoneNumbersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchAvailablePhoneNumbersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("E164PhoneNumbers", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.E164PhoneNumbers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static SearchAvailablePhoneNumbersResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchAvailablePhoneNumbersResponseUnmarshaller Instance => _instance;
    }
}
