...
{
    /// <summary>
    /// DeleteChannelBan Request Marshaller
    /// </summary>       
    public class DeleteChannelBanRequestMarshaller : IMarshaller<IRequest, DeleteChannelBanRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteChannelBanRequest)input);
        }
        ...
        private static DeleteChannelBanRequestMarshaller _instance = new DeleteChannelBanRequestMarshaller();        

        internal static DeleteChannelBanRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelBanRequestMarshaller Instance
        {
            get
            {
                return _instance;
