...
{
    /// <summary>
    /// Response Unmarshaller for GetUserSettings operation
    /// </summary>  
    public class GetUserSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UserSettings", targetDepth))
                {
                    ...
                    response.UserSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetUserSettingsResponseUnmarshaller _instance = new GetUserSettingsResponseUnmarshaller();        

        internal static GetUserSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
