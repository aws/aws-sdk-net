...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetVoiceConnectorProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorProxyResponse response = new GetVoiceConnectorProxyResponse();
        ...
        internal static GetVoiceConnectorProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
