...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAttendee operation
    /// </summary>  
    public class DeleteAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteAttendeeResponseUnmarshaller _instance = new DeleteAttendeeResponseUnmarshaller();        

        internal static DeleteAttendeeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAttendeeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
