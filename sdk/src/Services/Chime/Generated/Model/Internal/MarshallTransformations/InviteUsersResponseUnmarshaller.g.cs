...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InviteUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InviteUsersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Invites", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Invites = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static InviteUsersResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static InviteUsersResponseUnmarshaller Instance => _instance;
    }
}
