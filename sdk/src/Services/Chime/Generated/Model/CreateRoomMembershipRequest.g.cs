...
{
    /// <summary>
    /// Container for the parameters to the CreateRoomMembership operation. Adds a member
    /// to a chat room in an Amazon Chime Enterprise account. A member can be either a user
    /// or a bot. The member role designates whether the member is a chat room administrator
