...
namespace Amazon.Chime.Model
{
    ...
    public partial class PutRetentionSettingsResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public DateTime? InitiateDeletionTimestamp { get; set; }

        /// <summary>
        /// Checks to see if the InitiateDeletionTimestamp property is set.
        /// </summary>
        internal bool IsSetInitiateDeletionTimestamp() => this.InitiateDeletionTimestamp.HasValue;
        ...
        /// <summary>
        /// Checks to see if the RetentionSettings property is set.
        /// </summary>
        internal bool IsSetRetentionSettings() => this.RetentionSettings != null;
    }
}
