...
namespace Amazon.Chime.Model
{
    ...
    /// details, such as product type or calling name, for the specified phone number ID.
    /// You can update one phone number detail at a time. For example, you can update either
    /// the product type or the calling name in one action. <para> For toll-free numbers,
    /// you cannot use the Amazon Chime Business Calling product type. For numbers outside
    /// the U.S., you must use the Amazon Chime SIP Media Application Dial-In product type.
    /// </para> <para> Updates to outbound calling names can take 72 hours to complete. Pending
