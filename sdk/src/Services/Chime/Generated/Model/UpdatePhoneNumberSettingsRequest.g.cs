...
{
    /// <summary>
    /// Container for the parameters to the UpdatePhoneNumberSettings operation. Updates the
    /// phone number settings for the administrator's AWS account, such as the default outbound
    /// calling name. You can update the default outbound calling name once every seven days.
