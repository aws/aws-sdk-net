...
namespace Amazon.Chime.Model
{
    ...
    public partial class UnauthorizedClientException : AmazonChimeException
    {
        ...
        /// Construct instance of UnauthorizedClientException
        /// </summary>
        public UnauthorizedClientException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of UnauthorizedClientException
        /// </summary>
        public UnauthorizedClientException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of UnauthorizedClientException
        /// </summary>
        public UnauthorizedClientException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
