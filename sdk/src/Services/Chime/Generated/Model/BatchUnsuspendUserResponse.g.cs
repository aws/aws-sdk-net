...
namespace Amazon.Chime.Model
{
    ...
    public partial class BatchUnsuspendUserResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<UserError> UserErrors { get; set; } = AWSConfigs.InitializeCollections ? new List<UserError>() : null;

        /// <summary>
        /// Checks to see if the UserErrors property is set.
        /// </summary>
        internal bool IsSetUserErrors() => this.UserErrors != null && (this.UserErrors.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
