...
{
    /// <summary>
    /// Container for the parameters to the ListRoomMemberships operation. Lists the membership
    /// details for the specified room in an Amazon Chime Enterprise account, such as the
