...
{
    /// <summary>
    /// Container for the parameters to the UpdateAccount operation. Updates account details
    /// for the specified Amazon Chime account. Currently, only account name and default license
