...
{
    /// <summary>
    /// Container for the parameters to the ResetPersonalPIN operation. Resets the personal
    /// meeting PIN for the specified user on an Amazon Chime account. Returns the <a>User</a>
