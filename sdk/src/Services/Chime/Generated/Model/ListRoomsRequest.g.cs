...
{
    /// <summary>
    /// Container for the parameters to the ListRooms operation. Lists the room details for
    /// the specified Amazon Chime Enterprise account. Optionally, filter the results by a
