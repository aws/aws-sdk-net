...
namespace Amazon.MediaPackageVod.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackagingGroupUnmarshaller : IJsonUnmarshaller<PackagingGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackagingGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("approximateAssetCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.ApproximateAssetCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("egressAccessLogs", targetDepth, ref reader))
                {
                    var unmarshaller = EgressAccessLogsUnmarshaller.Instance;
                    unmarshalledObject.EgressAccessLogs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
