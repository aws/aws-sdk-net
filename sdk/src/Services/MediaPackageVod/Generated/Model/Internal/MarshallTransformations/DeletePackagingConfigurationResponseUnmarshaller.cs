...
{
    /// <summary>
    /// Response Unmarshaller for DeletePackagingConfiguration operation
    /// </summary>  
    public class DeletePackagingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePackagingConfigurationResponse response = new DeletePackagingConfigurationResponse();
        ...
        private static DeletePackagingConfigurationResponseUnmarshaller _instance = new DeletePackagingConfigurationResponseUnmarshaller();        

        internal static DeletePackagingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePackagingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
