...
{
    /// <summary>
    /// Response Unmarshaller for DescribePackagingGroup operation
    /// </summary>  
    public class DescribePackagingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePackagingGroupResponse response = new DescribePackagingGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("approximateAssetCount", targetDepth))
                {
                    ...
                    response.ApproximateAssetCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("egressAccessLogs", targetDepth))
                {
                    ...
                    response.EgressAccessLogs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribePackagingGroupResponseUnmarshaller _instance = new DescribePackagingGroupResponseUnmarshaller();        

        internal static DescribePackagingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePackagingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
