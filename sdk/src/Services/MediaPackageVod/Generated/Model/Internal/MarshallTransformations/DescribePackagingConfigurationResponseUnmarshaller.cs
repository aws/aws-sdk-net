...
{
    /// <summary>
    /// Response Unmarshaller for DescribePackagingConfiguration operation
    /// </summary>  
    public class DescribePackagingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePackagingConfigurationResponse response = new DescribePackagingConfigurationResponse();
        ...
        private static DescribePackagingConfigurationResponseUnmarshaller _instance = new DescribePackagingConfigurationResponseUnmarshaller();        

        internal static DescribePackagingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePackagingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
