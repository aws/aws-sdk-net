...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMediaPackageVodConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMediaPackageVodConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMediaPackageVodConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMediaPackageVodConfig to create AmazonMediaPackageVodClient");
            }

            return awsCredentials == null ? 
                    new AmazonMediaPackageVodClient(serviceClientConfig) :
                    new AmazonMediaPackageVodClient(awsCredentials, serviceClientConfig);
        }
