...
using Amazon.Util;
using Amazon.Pinpoint.Endpoints;

#pragma warning disable 1591

namespace Amazon.Pinpoint.Internal
{
    /// <summary>
    /// Amazon Pinpoint endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Pinpoint service requests.
    /// Collects values for PinpointEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PinpointEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPinpointEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPinpointConfig)requestContext.ClientConfig;
            var result = new PinpointEndpointParameters();
