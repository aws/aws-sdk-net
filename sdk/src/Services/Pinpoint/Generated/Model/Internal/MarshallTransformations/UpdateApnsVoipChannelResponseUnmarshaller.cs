...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApnsVoipChannel operation
    /// </summary>  
    public class UpdateApnsVoipChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateApnsVoipChannelResponse response = new UpdateApnsVoipChannelResponse();
        ...
        private static UpdateApnsVoipChannelResponseUnmarshaller _instance = new UpdateApnsVoipChannelResponseUnmarshaller();        

        internal static UpdateApnsVoipChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApnsVoipChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
