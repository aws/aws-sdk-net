...
{
    /// <summary>
    /// Response Unmarshaller for DeleteInAppTemplate operation
    /// </summary>  
    public class DeleteInAppTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInAppTemplateResponse response = new DeleteInAppTemplateResponse();
        ...
        private static DeleteInAppTemplateResponseUnmarshaller _instance = new DeleteInAppTemplateResponseUnmarshaller();        

        internal static DeleteInAppTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInAppTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
