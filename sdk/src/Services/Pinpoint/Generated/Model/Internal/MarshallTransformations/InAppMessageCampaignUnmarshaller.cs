...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InAppMessageCampaignUnmarshaller : IJsonUnmarshaller<InAppMessageCampaign, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InAppMessageCampaign Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("InAppMessage", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("SessionCap", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.SessionCap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
