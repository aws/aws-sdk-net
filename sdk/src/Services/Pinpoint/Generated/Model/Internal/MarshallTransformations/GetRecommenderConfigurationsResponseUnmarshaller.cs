...
{
    /// <summary>
    /// Response Unmarshaller for GetRecommenderConfigurations operation
    /// </summary>  
    public class GetRecommenderConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRecommenderConfigurationsResponse response = new GetRecommenderConfigurationsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = ListRecommenderConfigurationsResponseUnmarshaller.Instance;
            response.ListRecommenderConfigurationsResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetRecommenderConfigurationsResponseUnmarshaller _instance = new GetRecommenderConfigurationsResponseUnmarshaller();        

        internal static GetRecommenderConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRecommenderConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
