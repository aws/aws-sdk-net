...
{
    /// <summary>
    /// Response Unmarshaller for GetChannels operation
    /// </summary>  
    public class GetChannelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshaller = ChannelsResponseUnmarshaller.Instance;
            response.ChannelsResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetChannelsResponseUnmarshaller _instance = new GetChannelsResponseUnmarshaller();        

        internal static GetChannelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChannelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
