...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TreatmentResourceUnmarshaller : IUnmarshaller<TreatmentResource, XmlUnmarshallerContext>, IUnmarshaller<TreatmentResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TreatmentResource IUnmarshaller<TreatmentResource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TreatmentResource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SizePercent", targetDepth))
                {
                    ...
                    unmarshalledObject.SizePercent = unmarshaller.Unmarshall(context);
                    continue;
                }
