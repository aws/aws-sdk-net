...
{
    /// <summary>
    /// Response Unmarshaller for GetSegment operation
    /// </summary>  
    public class GetSegmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetSegmentResponseUnmarshaller _instance = new GetSegmentResponseUnmarshaller();        

        internal static GetSegmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
