...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    public class EventConditionMarshaller : IRequestMarshaller<EventCondition, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(EventCondition requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDimensions())
            {
                ...
                var marshaller = EventDimensionsMarshaller.Instance;
                marshaller.Marshall(requestObject.Dimensions, context);

                context.Writer.WriteEndObject();
            }

            if(requestObject.IsSetMessageActivity())
            {
                context.Writer.WritePropertyName("MessageActivity");
                context.Writer.WriteStringValue(requestObject.MessageActivity);
            }
