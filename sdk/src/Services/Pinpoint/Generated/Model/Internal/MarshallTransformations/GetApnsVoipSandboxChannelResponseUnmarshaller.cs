...
{
    /// <summary>
    /// Response Unmarshaller for GetApnsVoipSandboxChannel operation
    /// </summary>  
    public class GetApnsVoipSandboxChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApnsVoipSandboxChannelResponse response = new GetApnsVoipSandboxChannelResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = APNSVoipSandboxChannelResponseUnmarshaller.Instance;
            response.APNSVoipSandboxChannelResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetApnsVoipSandboxChannelResponseUnmarshaller _instance = new GetApnsVoipSandboxChannelResponseUnmarshaller();        

        internal static GetApnsVoipSandboxChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApnsVoipSandboxChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
