...
{
    /// <summary>
    /// Response Unmarshaller for SendOTPMessage operation
    /// </summary>  
    public class SendOTPMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            response.MessageResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static SendOTPMessageResponseUnmarshaller _instance = new SendOTPMessageResponseUnmarshaller();        

        internal static SendOTPMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendOTPMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
