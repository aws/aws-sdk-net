...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTemplateActiveVersion operation
    /// </summary>  
    public class UpdateTemplateActiveVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTemplateActiveVersionResponse response = new UpdateTemplateActiveVersionResponse();
        ...
        private static UpdateTemplateActiveVersionResponseUnmarshaller _instance = new UpdateTemplateActiveVersionResponseUnmarshaller();        

        internal static UpdateTemplateActiveVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTemplateActiveVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
