...
{
    /// <summary>
    /// Response Unmarshaller for CreateJourney operation
    /// </summary>  
    public class CreateJourneyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateJourneyResponse response = new CreateJourneyResponse();
        ...
        private static CreateJourneyResponseUnmarshaller _instance = new CreateJourneyResponseUnmarshaller();        

        internal static CreateJourneyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateJourneyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
