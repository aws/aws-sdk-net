...
{
    /// <summary>
    /// GetSegmentExportJobs Request Marshaller
    /// </summary>       
    public class GetSegmentExportJobsRequestMarshaller : IMarshaller<IRequest, GetSegmentExportJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSegmentExportJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSegmentExportJobsRequest publicRequest)
        {
        ...
        private static GetSegmentExportJobsRequestMarshaller _instance = new GetSegmentExportJobsRequestMarshaller();        

        internal static GetSegmentExportJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentExportJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
