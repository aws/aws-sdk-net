...
{
    /// <summary>
    /// Response Unmarshaller for DeletePushTemplate operation
    /// </summary>  
    public class DeletePushTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeletePushTemplateResponseUnmarshaller _instance = new DeletePushTemplateResponseUnmarshaller();        

        internal static DeletePushTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePushTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
