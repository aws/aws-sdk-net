...
{
    /// <summary>
    /// Response Unmarshaller for CreateCampaign operation
    /// </summary>  
    public class CreateCampaignResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateCampaignResponseUnmarshaller _instance = new CreateCampaignResponseUnmarshaller();        

        internal static CreateCampaignResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCampaignResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
