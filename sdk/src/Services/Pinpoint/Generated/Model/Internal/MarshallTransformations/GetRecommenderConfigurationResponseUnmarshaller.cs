...
{
    /// <summary>
    /// Response Unmarshaller for GetRecommenderConfiguration operation
    /// </summary>  
    public class GetRecommenderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRecommenderConfigurationResponse response = new GetRecommenderConfigurationResponse();
        ...
        private static GetRecommenderConfigurationResponseUnmarshaller _instance = new GetRecommenderConfigurationResponseUnmarshaller();        

        internal static GetRecommenderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRecommenderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
