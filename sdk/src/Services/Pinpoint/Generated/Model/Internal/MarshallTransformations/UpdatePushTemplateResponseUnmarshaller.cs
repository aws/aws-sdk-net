...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePushTemplate operation
    /// </summary>  
    public class UpdatePushTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdatePushTemplateResponseUnmarshaller _instance = new UpdatePushTemplateResponseUnmarshaller();        

        internal static UpdatePushTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePushTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
