...
{
    /// <summary>
    /// Response Unmarshaller for CreateRecommenderConfiguration operation
    /// </summary>  
    public class CreateRecommenderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRecommenderConfigurationResponse response = new CreateRecommenderConfigurationResponse();

            var unmarshaller = RecommenderConfigurationResponseUnmarshaller.Instance;
            response.RecommenderConfigurationResponse = unmarshaller.Unmarshall(context);
        ...
        private static CreateRecommenderConfigurationResponseUnmarshaller _instance = new CreateRecommenderConfigurationResponseUnmarshaller();        

        internal static CreateRecommenderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRecommenderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
