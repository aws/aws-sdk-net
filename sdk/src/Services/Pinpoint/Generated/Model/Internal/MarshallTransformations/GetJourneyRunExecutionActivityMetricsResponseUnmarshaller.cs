...
{
    /// <summary>
    /// Response Unmarshaller for GetJourneyRunExecutionActivityMetrics operation
    /// </summary>  
    public class GetJourneyRunExecutionActivityMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJourneyRunExecutionActivityMetricsResponse response = new GetJourneyRunExecutionActivityMetricsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = JourneyRunExecutionActivityMetricsResponseUnmarshaller.Instance;
            response.JourneyRunExecutionActivityMetricsResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetJourneyRunExecutionActivityMetricsResponseUnmarshaller _instance = new GetJourneyRunExecutionActivityMetricsResponseUnmarshaller();        

        internal static GetJourneyRunExecutionActivityMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJourneyRunExecutionActivityMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
