...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClosedDaysUnmarshaller : IUnmarshaller<ClosedDays, XmlUnmarshallerContext>, IUnmarshaller<ClosedDays, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ClosedDays IUnmarshaller<ClosedDays, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ClosedDays Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ClosedDaysRule, ClosedDaysRuleUnmarshaller>(ClosedDaysRuleUnmarshaller.Instance);
