...
{
    /// <summary>
    /// Response Unmarshaller for GetInAppMessages operation
    /// </summary>  
    public class GetInAppMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInAppMessagesResponse response = new GetInAppMessagesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = InAppMessagesResponseUnmarshaller.Instance;
            response.InAppMessagesResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetInAppMessagesResponseUnmarshaller _instance = new GetInAppMessagesResponseUnmarshaller();        

        internal static GetInAppMessagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInAppMessagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
