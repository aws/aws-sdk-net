...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSmsTemplate operation
    /// </summary>  
    public class DeleteSmsTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteSmsTemplateResponseUnmarshaller _instance = new DeleteSmsTemplateResponseUnmarshaller();        

        internal static DeleteSmsTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSmsTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
