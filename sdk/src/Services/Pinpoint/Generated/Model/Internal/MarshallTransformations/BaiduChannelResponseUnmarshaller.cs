...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BaiduChannelResponseUnmarshaller : IJsonUnmarshaller<BaiduChannelResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BaiduChannelResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HasCredential", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
