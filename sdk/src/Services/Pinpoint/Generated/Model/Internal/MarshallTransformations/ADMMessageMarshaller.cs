...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    public class ADMMessageMarshaller : IRequestMarshaller<ADMMessage, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ADMMessage requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetConsolidationKey())
            {
                context.Writer.WritePropertyName("ConsolidationKey");
                context.Writer.WriteStringValue(requestObject.ConsolidationKey);
            }
            ...
            if(requestObject.IsSetExpiresAfter())
            {
                context.Writer.WritePropertyName("ExpiresAfter");
                context.Writer.WriteStringValue(requestObject.ExpiresAfter);
            }
            ...
            if(requestObject.IsSetMD5())
            {
                ...
                context.Writer.WriteStringValue(requestObject.MD5);
            }
