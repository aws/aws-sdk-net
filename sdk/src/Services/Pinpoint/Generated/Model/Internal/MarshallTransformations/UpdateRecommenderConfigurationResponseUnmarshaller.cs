...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRecommenderConfiguration operation
    /// </summary>  
    public class UpdateRecommenderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateRecommenderConfigurationResponseUnmarshaller _instance = new UpdateRecommenderConfigurationResponseUnmarshaller();        

        internal static UpdateRecommenderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecommenderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
