...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventStreamUnmarshaller : IJsonUnmarshaller<EventStream, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventStream Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DestinationStreamArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DestinationStreamArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
