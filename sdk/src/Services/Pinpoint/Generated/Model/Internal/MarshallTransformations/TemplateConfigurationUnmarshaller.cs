...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    public class TemplateConfigurationUnmarshaller : IJsonUnmarshaller<TemplateConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static TemplateConfigurationUnmarshaller _instance = new TemplateConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TemplateConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
