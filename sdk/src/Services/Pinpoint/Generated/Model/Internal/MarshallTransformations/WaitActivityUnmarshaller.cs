...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WaitActivityUnmarshaller : IJsonUnmarshaller<WaitActivity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WaitActivity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WaitTime", targetDepth, ref reader))
                {
                    var unmarshaller = WaitTimeUnmarshaller.Instance;
                    unmarshalledObject.WaitTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
