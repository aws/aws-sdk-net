...
{
    /// <summary>
    /// Response Unmarshaller for GetSmsTemplate operation
    /// </summary>  
    public class GetSmsTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSmsTemplateResponse response = new GetSmsTemplateResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = SMSTemplateResponseUnmarshaller.Instance;
            response.SMSTemplateResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetSmsTemplateResponseUnmarshaller _instance = new GetSmsTemplateResponseUnmarshaller();        

        internal static GetSmsTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSmsTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
