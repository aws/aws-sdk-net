...
{
    /// <summary>
    /// Response Unmarshaller for GetApplicationSettings operation
    /// </summary>  
    public class GetApplicationSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApplicationSettingsResponse response = new GetApplicationSettingsResponse();
        ...
        private static GetApplicationSettingsResponseUnmarshaller _instance = new GetApplicationSettingsResponseUnmarshaller();        

        internal static GetApplicationSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApplicationSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
