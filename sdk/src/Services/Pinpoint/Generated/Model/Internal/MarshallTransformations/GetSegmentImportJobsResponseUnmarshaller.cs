...
{
    /// <summary>
    /// Response Unmarshaller for GetSegmentImportJobs operation
    /// </summary>  
    public class GetSegmentImportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSegmentImportJobsResponse response = new GetSegmentImportJobsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = ImportJobsResponseUnmarshaller.Instance;
            response.ImportJobsResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetSegmentImportJobsResponseUnmarshaller _instance = new GetSegmentImportJobsResponseUnmarshaller();        

        internal static GetSegmentImportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentImportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
