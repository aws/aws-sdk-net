...
{
    /// <summary>
    /// Response Unmarshaller for DeleteJourney operation
    /// </summary>  
    public class DeleteJourneyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteJourneyResponse response = new DeleteJourneyResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = JourneyResponseUnmarshaller.Instance;
            response.JourneyResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static DeleteJourneyResponseUnmarshaller _instance = new DeleteJourneyResponseUnmarshaller();        

        internal static DeleteJourneyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteJourneyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
