...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEmailTemplate operation
    /// </summary>  
    public class UpdateEmailTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEmailTemplateResponse response = new UpdateEmailTemplateResponse();
        ...
        private static UpdateEmailTemplateResponseUnmarshaller _instance = new UpdateEmailTemplateResponseUnmarshaller();        

        internal static UpdateEmailTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEmailTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
