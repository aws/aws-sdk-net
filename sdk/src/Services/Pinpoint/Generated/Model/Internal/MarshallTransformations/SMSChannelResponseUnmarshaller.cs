...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SMSChannelResponseUnmarshaller : IUnmarshaller<SMSChannelResponse, XmlUnmarshallerContext>, IUnmarshaller<SMSChannelResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SMSChannelResponse IUnmarshaller<SMSChannelResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SMSChannelResponse Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
