...
{
    /// <summary>
    /// Response Unmarshaller for GetCampaignVersion operation
    /// </summary>  
    public class GetCampaignVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCampaignVersionResponse response = new GetCampaignVersionResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = CampaignResponseUnmarshaller.Instance;
            response.CampaignResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetCampaignVersionResponseUnmarshaller _instance = new GetCampaignVersionResponseUnmarshaller();        

        internal static GetCampaignVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
