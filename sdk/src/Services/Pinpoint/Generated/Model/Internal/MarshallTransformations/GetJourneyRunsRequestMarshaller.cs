...
{
    /// <summary>
    /// GetJourneyRuns Request Marshaller
    /// </summary>       
    public class GetJourneyRunsRequestMarshaller : IMarshaller<IRequest, GetJourneyRunsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetJourneyRunsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetJourneyRunsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/apps/{application-id}/journeys/{journey-id}/runs";
            request.UseQueryString = true;

            return request;
        }
        private static GetJourneyRunsRequestMarshaller _instance = new GetJourneyRunsRequestMarshaller();        

        internal static GetJourneyRunsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJourneyRunsRequestMarshaller Instance
        {
            get
            {
                return _instance;
