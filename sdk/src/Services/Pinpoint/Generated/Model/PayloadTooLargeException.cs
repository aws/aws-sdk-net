...
namespace Amazon.Pinpoint.Model
{
    ...
    [Serializable]
    #endif
    public partial class PayloadTooLargeException : AmazonPinpointException
    {
        ...
        public PayloadTooLargeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PayloadTooLargeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
