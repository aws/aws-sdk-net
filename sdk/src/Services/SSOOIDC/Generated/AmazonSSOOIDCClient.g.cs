...
namespace Amazon.SSOOIDC
{
    ...
    public partial class AmazonSSOOIDCClient : AmazonServiceClient, IAmazonSSOOIDC
    {
        ...
        /// 
        /// </summary>
        public AmazonSSOOIDCClient() : base(new AmazonSSOOIDCConfig()) { }
        ...
        public AmazonSSOOIDCClient(RegionEndpoint region) : base(new AmazonSSOOIDCConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSSOOIDCClient(AmazonSSOOIDCConfig config) : base(config) { }
