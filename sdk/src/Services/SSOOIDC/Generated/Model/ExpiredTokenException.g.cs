...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class ExpiredTokenException : AmazonSSOOIDCException
    {
        ...
        /// message.
        /// </summary>
        public ExpiredTokenException() : base() { }
        ...
        /// Construct instance of ExpiredTokenException
        /// </summary>
        public ExpiredTokenException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ExpiredTokenException
        /// </summary>
        public ExpiredTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ExpiredTokenException
        /// </summary>
        public ExpiredTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Gets and sets the property Error. 
        /// <para>
        /// Single error code. For this exception the value will be <c>expired_token</c>.
        /// </para>
        /// </summary>
