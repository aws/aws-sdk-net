...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class ExpiredTokenException : AmazonSSOOIDCException
    {
        ...
        public ExpiredTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ExpiredTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
