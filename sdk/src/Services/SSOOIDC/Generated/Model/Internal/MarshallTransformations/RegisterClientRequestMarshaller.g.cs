...
namespace Amazon.SSOOIDC.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisterClientRequestMarshaller : IMarshaller<IRequest, RegisterClientRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RegisterClientRequestMarshaller _instance = new();

        internal static RegisterClientRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterClientRequestMarshaller Instance => _instance;
    }
}
