...
namespace Amazon.SSOOIDC.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartDeviceAuthorizationRequestMarshaller : IMarshaller<IRequest, StartDeviceAuthorizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartDeviceAuthorizationRequestMarshaller _instance = new();

        internal static StartDeviceAuthorizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartDeviceAuthorizationRequestMarshaller Instance => _instance;
    }
}
