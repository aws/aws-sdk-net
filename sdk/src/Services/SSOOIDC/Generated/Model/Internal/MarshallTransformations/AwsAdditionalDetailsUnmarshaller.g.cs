...
namespace Amazon.SSOOIDC.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AwsAdditionalDetailsUnmarshaller : IJsonUnmarshaller<AwsAdditionalDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// Gets the singleton.
        /// </summary>
        public static AwsAdditionalDetailsUnmarshaller Instance => _instance;
    }
}
