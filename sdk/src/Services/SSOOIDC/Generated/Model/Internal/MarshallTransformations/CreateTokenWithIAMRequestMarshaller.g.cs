...
namespace Amazon.SSOOIDC.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateTokenWithIAMRequestMarshaller : IMarshaller<IRequest, CreateTokenWithIAMRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateTokenWithIAMRequestMarshaller _instance = new();

        internal static CreateTokenWithIAMRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateTokenWithIAMRequestMarshaller Instance => _instance;
    }
}
