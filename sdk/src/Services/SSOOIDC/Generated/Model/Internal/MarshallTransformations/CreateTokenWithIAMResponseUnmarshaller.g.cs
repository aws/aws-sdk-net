...
namespace Amazon.SSOOIDC.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateTokenWithIAMResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateTokenWithIAMResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("awsAdditionalDetails", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AwsAdditionalDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IssuedTokenType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateTokenWithIAMResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateTokenWithIAMResponseUnmarshaller Instance => _instance;
    }
}
