...
{
    /// <summary>
    /// Exception Unmarshaller for InvalidRequestRegionException
    /// </summary>
    public partial class InvalidRequestRegionExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidRequestRegionException, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the exception from the service to the appropriate exception class
        /// </summary>
        public InvalidRequestRegionException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static InvalidRequestRegionExceptionUnmarshaller _instance = new InvalidRequestRegionExceptionUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static InvalidRequestRegionExceptionUnmarshaller Instance => _instance;
    }
}
