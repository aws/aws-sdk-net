...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class InvalidGrantException : AmazonSSOOIDCException
    {
        ...
        /// Construct instance of InvalidGrantException
        /// </summary>
        public InvalidGrantException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidGrantException
        /// </summary>
        public InvalidGrantException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidGrantException
        /// </summary>
        public InvalidGrantException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
