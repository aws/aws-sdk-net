...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class AuthorizationPendingException : AmazonSSOOIDCException
    {
        ...
        /// message.
        /// </summary>
        public AuthorizationPendingException() : base() { }
        ...
        /// Construct instance of AuthorizationPendingException
        /// </summary>
        public AuthorizationPendingException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of AuthorizationPendingException
        /// </summary>
        public AuthorizationPendingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of AuthorizationPendingException
        /// </summary>
        public AuthorizationPendingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
