...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class InvalidRequestRegionException : AmazonSSOOIDCException
    {
        ...
        /// message.
        /// </summary>
        public InvalidRequestRegionException() : base() { }
        ...
        /// </param>
        public InvalidRequestRegionException(string message) : base(message) { }

        /// <summary>
        /// Construct instance of InvalidRequestRegionException
        /// </summary>
        public InvalidRequestRegionException(string message, Exception innerException) : base(message, innerException) { }

        /// <summary>
        /// Construct instance of InvalidRequestRegionException
        /// </summary>
        public InvalidRequestRegionException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidRequestRegionException
        /// </summary>
        public InvalidRequestRegionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidRequestRegionException
        /// </summary>
        public InvalidRequestRegionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
