...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class InvalidScopeException : AmazonSSOOIDCException
    {
        ...
        /// Construct instance of InvalidScopeException
        /// </summary>
        public InvalidScopeException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidScopeException
        /// </summary>
        public InvalidScopeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidScopeException
        /// </summary>
        public InvalidScopeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
