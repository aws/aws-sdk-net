...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class InvalidClientException : AmazonSSOOIDCException
    {
        ...
        /// Construct instance of InvalidClientException
        /// </summary>
        public InvalidClientException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidClientException
        /// </summary>
        public InvalidClientException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidClientException
        /// </summary>
        public InvalidClientException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
