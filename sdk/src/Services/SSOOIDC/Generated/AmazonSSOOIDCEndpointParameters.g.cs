...
namespace Amazon.SSOOIDC.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving SSOOIDC endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonSSOOIDCEndpointProvider"/> and <see cref="AmazonSSOOIDCEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class SSOOIDCEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// SSOOIDCEndpointParameters constructor
        /// </summary>
        public SSOOIDCEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
