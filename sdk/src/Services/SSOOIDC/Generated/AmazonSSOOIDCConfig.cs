...
namespace Amazon.SSOOIDC
{
    ...
    public partial class AmazonSSOOIDCConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SSO OIDC", "4.0.100.13");
        ...
        /// </summary>
        public static new string ServiceId => "SSO OIDC";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "oidc";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-06-10";
