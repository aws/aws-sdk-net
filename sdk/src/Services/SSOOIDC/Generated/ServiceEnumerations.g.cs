...
namespace Amazon.SSOOIDC
{
    ...
    public class InvalidRequestExceptionReason : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom InvalidRequestExceptionReason for a value not among the defined constants.
        /// </summary>
        public InvalidRequestExceptionReason(string value) : base(value) { }
