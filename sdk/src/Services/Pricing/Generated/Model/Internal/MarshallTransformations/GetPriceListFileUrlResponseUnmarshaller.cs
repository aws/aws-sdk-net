...
{
    /// <summary>
    /// Response Unmarshaller for GetPriceListFileUrl operation
    /// </summary>  
    public class GetPriceListFileUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPriceListFileUrlResponse response = new GetPriceListFileUrlResponse();
        ...
        private static GetPriceListFileUrlResponseUnmarshaller _instance = new GetPriceListFileUrlResponseUnmarshaller();        

        internal static GetPriceListFileUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPriceListFileUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
