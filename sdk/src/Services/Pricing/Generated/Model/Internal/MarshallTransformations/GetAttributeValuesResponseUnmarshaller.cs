...
{
    /// <summary>
    /// Response Unmarshaller for GetAttributeValues operation
    /// </summary>  
    public class GetAttributeValuesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("AttributeValues", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AttributeValue, AttributeValueUnmarshaller>(AttributeValueUnmarshaller.Instance);
                    response.AttributeValues = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetAttributeValuesResponseUnmarshaller _instance = new GetAttributeValuesResponseUnmarshaller();        

        internal static GetAttributeValuesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAttributeValuesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
