    ...
    public class ListPriceListsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PriceList, PriceListUnmarshaller>(PriceListUnmarshaller.Instance);
                    response.PriceLists = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
