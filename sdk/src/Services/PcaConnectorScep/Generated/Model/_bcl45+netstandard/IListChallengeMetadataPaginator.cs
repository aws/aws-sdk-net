...
namespace Amazon.PcaConnectorScep.Model
{
    ...
    public interface IListChallengeMetadataPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListChallengeMetadataResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the Challenges
        /// </summary>
        IPaginatedEnumerable<ChallengeMetadataSummary> Challenges { get; }
    }
}