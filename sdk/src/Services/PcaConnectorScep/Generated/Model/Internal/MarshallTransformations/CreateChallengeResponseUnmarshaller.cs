...
{
    /// <summary>
    /// Response Unmarshaller for CreateChallenge operation
    /// </summary>  
    public class CreateChallengeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateChallengeResponseUnmarshaller _instance = new CreateChallengeResponseUnmarshaller();        

        internal static CreateChallengeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChallengeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
