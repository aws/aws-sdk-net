...
namespace Amazon.PcaConnectorScep.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonPcaConnectorScepException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static CreateConnectorResponseUnmarshaller _instance = new CreateConnectorResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
