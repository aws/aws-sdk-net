...
{
    /// <summary>
    /// Container for the parameters to the ListIngestConfigurations operation. Lists all
    /// IngestConfigurations in your account, in the AWS region where the API request is processed.
    /// </summary>
    public partial class ListIngestConfigurationsRequest : AmazonIVSRealTimeRequest
    {
        ...
        /// <summary>
        /// Checks to see if the FilterByStageArn property is set.
        /// </summary>
        internal bool IsSetFilterByStageArn() => this.FilterByStageArn != null;
        ...
        /// </para>
        /// </summary>
        public IngestConfigurationState FilterByState { get; set; }
