...
{
    /// <summary>
    /// Container for the parameters to the ImportPublicKey operation. Import a public key
    /// to be used for signing stage participant tokens.
    /// </summary>
    public partial class ImportPublicKeyRequest : AmazonIVSRealTimeRequest
    {
        ...
        /// <summary>
        /// Checks to see if the PublicKeyMaterial property is set.
        /// </summary>
        internal bool IsSetPublicKeyMaterial() => this.PublicKeyMaterial != null;
