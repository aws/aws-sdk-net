...
namespace Amazon.IVSRealTime.Model
{
    ...
    public partial class AutoParticipantRecordingConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public ParticipantRecordingHlsConfiguration HlsConfiguration { get; set; }
        ...
        public List<string> MediaTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the MediaTypes property is set.
        /// </summary>
        internal bool IsSetMediaTypes() => this.MediaTypes != null && (this.MediaTypes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </para>
        /// </summary>
        public bool? RecordParticipantReplicas { get; set; }

        /// <summary>
        /// Checks to see if the RecordParticipantReplicas property is set.
        /// </summary>
        internal bool IsSetRecordParticipantReplicas() => this.RecordParticipantReplicas.HasValue;
        ...
        /// </para>
        /// </summary>
        public ParticipantThumbnailConfiguration ThumbnailConfiguration { get; set; }
