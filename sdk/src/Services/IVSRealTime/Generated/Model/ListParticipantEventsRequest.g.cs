...
{
    /// <summary>
    /// Container for the parameters to the ListParticipantEvents operation. Lists events
    /// for a specified participant that occurred during a specified stage session.
    /// </summary>
