...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportPublicKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportPublicKeyResponse response = new ImportPublicKeyResponse();
        ...
        internal static ImportPublicKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
