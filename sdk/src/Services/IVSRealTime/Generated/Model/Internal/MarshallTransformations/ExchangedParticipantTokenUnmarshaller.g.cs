...
{
    /// <summary>
    /// Response Unmarshaller for ExchangedParticipantToken Object
    /// </summary>
    public partial class ExchangedParticipantTokenUnmarshaller : IJsonUnmarshaller<ExchangedParticipantToken, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ExchangedParticipantToken Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ExchangedParticipantToken();
        ...
        private static ExchangedParticipantTokenUnmarshaller _instance = new ExchangedParticipantTokenUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ExchangedParticipantTokenUnmarshaller Instance => _instance;
    }
}
