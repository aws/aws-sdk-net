...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateStageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateStageResponse();
            ...
            {
                if (context.TestExpression("participantTokens", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ParticipantToken, ParticipantTokenUnmarshaller>(ParticipantTokenUnmarshaller.Instance);
                    unmarshalledObject.ParticipantTokens = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("stage", targetDepth, ref reader))
                {
                    var unmarshaller = StageUnmarshaller.Instance;
        ...
        internal static CreateStageResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateStageResponseUnmarshaller Instance => _instance;
    }
}
