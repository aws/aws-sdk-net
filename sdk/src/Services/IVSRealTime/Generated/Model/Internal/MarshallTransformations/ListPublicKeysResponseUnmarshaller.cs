    ...
    public class ListPublicKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PublicKeySummary, PublicKeySummaryUnmarshaller>(PublicKeySummaryUnmarshaller.Instance);
                    response.PublicKeys = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
