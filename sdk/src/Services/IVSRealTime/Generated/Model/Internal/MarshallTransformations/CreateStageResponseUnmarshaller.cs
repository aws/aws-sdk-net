    ...
    public class CreateStageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ParticipantToken, ParticipantTokenUnmarshaller>(ParticipantTokenUnmarshaller.Instance);
                    response.ParticipantTokens = unmarshaller.Unmarshall(context);
                    continue;
                }
