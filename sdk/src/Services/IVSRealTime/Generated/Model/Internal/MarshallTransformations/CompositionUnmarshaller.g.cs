...
{
    /// <summary>
    /// Response Unmarshaller for Composition Object
    /// </summary>
    public partial class CompositionUnmarshaller : IJsonUnmarshaller<Composition, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Composition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Composition();
        ...
        private static CompositionUnmarshaller _instance = new CompositionUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CompositionUnmarshaller Instance => _instance;
    }
}
