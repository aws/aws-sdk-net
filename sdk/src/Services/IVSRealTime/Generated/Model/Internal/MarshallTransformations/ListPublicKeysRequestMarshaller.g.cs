...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListPublicKeysRequestMarshaller : IMarshaller<IRequest, ListPublicKeysRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListPublicKeysRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ListPublicKeys";
#if !NETFRAMEWORK
        ...
        private static readonly ListPublicKeysRequestMarshaller _instance = new();

        internal static ListPublicKeysRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPublicKeysRequestMarshaller Instance => _instance;
    }
}
