...
{
    /// <summary>
    /// Exception Unmarshaller for PendingVerificationException
    /// </summary>
    public partial class PendingVerificationExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<PendingVerificationException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PendingVerificationException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static PendingVerificationExceptionUnmarshaller Instance => _instance;
    }
}
