...
namespace Amazon.IVSRealTime.Model
{
    ...
    public partial class ListEncoderConfigurationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<EncoderConfigurationSummary> EncoderConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<EncoderConfigurationSummary>() : null;

        /// <summary>
        /// Checks to see if the EncoderConfigurations property is set.
        /// </summary>
        internal bool IsSetEncoderConfigurations() => this.EncoderConfigurations != null && (this.EncoderConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
