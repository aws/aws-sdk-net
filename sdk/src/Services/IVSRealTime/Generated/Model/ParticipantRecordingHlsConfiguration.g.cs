...
namespace Amazon.IVSRealTime.Model
{
    ...
    public partial class ParticipantRecordingHlsConfiguration
    {
        ...
        public int? TargetSegmentDurationSeconds { get; set; }

        /// <summary>
        /// Checks to see if the TargetSegmentDurationSeconds property is set.
        /// </summary>
        internal bool IsSetTargetSegmentDurationSeconds() => this.TargetSegmentDurationSeconds.HasValue;
    }
}
