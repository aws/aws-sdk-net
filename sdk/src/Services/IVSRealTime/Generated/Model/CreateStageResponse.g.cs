...
namespace Amazon.IVSRealTime.Model
{
    ...
    public partial class CreateStageResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ParticipantToken> ParticipantTokens { get; set; } = AWSConfigs.InitializeCollections ? new List<ParticipantToken>() : null;

        /// <summary>
        /// Checks to see if the ParticipantTokens property is set.
        /// </summary>
        internal bool IsSetParticipantTokens() => this.ParticipantTokens != null && (this.ParticipantTokens.Count > 0 || !AWSConfigs.InitializeCollections);
