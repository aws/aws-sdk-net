...
namespace Amazon.IVSRealTime
{
    ...
    public partial class AmazonIVSRealTimeClient : AmazonServiceClient, IAmazonIVSRealTime
    {
        ...
        /// 
        /// </summary>
        public AmazonIVSRealTimeClient() : base(new AmazonIVSRealTimeConfig()) { }
        ...
        public AmazonIVSRealTimeClient(RegionEndpoint region) : base(new AmazonIVSRealTimeConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIVSRealTimeClient(AmazonIVSRealTimeConfig config) : base(config) { }
