...
namespace Amazon.IVSRealTime.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonIVSRealTimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIVSRealTimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IVSRealTime.
        /// </summary>
        public AmazonIVSRealTimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIVSRealTimeAuthSchemeParameters
            {
    ...
    public class AmazonIVSRealTimeAuthSchemeResolver : IAuthSchemeResolver<AmazonIVSRealTimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIVSRealTimeAuthSchemeParameters authParameters)
        {
