...
namespace Amazon.IotData.Model
{
    ...
    internal sealed partial class ListSubscriptionsPaginator : IPaginator<ListSubscriptionsResponse>, IListSubscriptionsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<SubscriptionSummary> Subscriptions => 
            new PaginatedResultKeyResponse<ListSubscriptionsResponse, SubscriptionSummary>(this, (i) => i.Subscriptions ?? new List<SubscriptionSummary>());

        internal ListSubscriptionsPaginator(IAmazonIotData client, ListSubscriptionsRequest request)
        {
            this._client = client;
