...
namespace Amazon.IotData.Model
{
    ...
    public partial class ListSubscriptionsResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// A list of topic filters and their associated Quality of Service (QoS) levels that
        ...
        /// </summary>
        public List<SubscriptionSummary> Subscriptions { get; set; } = AWSConfigs.InitializeCollections ? new List<SubscriptionSummary>() : null;
