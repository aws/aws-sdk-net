...
{
    /// <summary>
    /// Response Unmarshaller for SendDirectMessage operation.
    /// </summary>
    public partial class SendDirectMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SendDirectMessageResponse();
        ...
        private static SendDirectMessageResponseUnmarshaller _instance = new SendDirectMessageResponseUnmarshaller();

        internal static SendDirectMessageResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendDirectMessageResponseUnmarshaller Instance => _instance;
    }
}
