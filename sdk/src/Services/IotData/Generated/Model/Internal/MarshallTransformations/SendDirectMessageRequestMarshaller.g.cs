...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendDirectMessageRequestMarshaller : IMarshaller<IRequest, SendDirectMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(SendDirectMessageRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("confirmation", StringUtils.FromBool(publicRequest.Confirmation.Value));
            }
            ...
            {
                request.Parameters.Add("timeout", StringUtils.FromInt(publicRequest.Timeout.Value));
            }
        ...
        private static readonly SendDirectMessageRequestMarshaller _instance = new();

        internal static SendDirectMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendDirectMessageRequestMarshaller Instance => _instance;
    }
}
