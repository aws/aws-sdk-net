...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GatewayTimeoutExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<GatewayTimeoutException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public GatewayTimeoutException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public GatewayTimeoutException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
