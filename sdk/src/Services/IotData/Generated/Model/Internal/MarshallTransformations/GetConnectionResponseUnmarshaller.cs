...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    public class GetConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("cleanSession", targetDepth))
                {
                ...
                if (context.TestExpression("connectedSince", targetDepth))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.ConnectedSince = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("disconnectedSince", targetDepth))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                ...
                if (context.TestExpression("keepAliveDuration", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.KeepAliveDuration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("sessionExpiry", targetDepth))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                ...
                if (context.TestExpression("targetIp", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
