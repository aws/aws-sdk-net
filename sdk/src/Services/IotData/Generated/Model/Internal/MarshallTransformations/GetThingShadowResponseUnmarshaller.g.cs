...
{
    /// <summary>
    /// Response Unmarshaller for GetThingShadow operation.
    /// </summary>
    public partial class GetThingShadowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetThingShadowResponse();
            var ms = new MemoryStream();
            Amazon.Util.AWSSDKUtils.CopyStream(context.Stream, ms);
            ms.Seek(0, SeekOrigin.Begin);
            if (ms.Length > 0)
            {
                unmarshalledObject.Payload = ms;
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var streamCopy = new MemoryStream(responseBodyBytes))
            {
                using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
                {
                    ...
                    if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedDocumentEncodingException"))
                    {
                        return UnsupportedDocumentEncodingExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
                }
            }
        ...
        private static GetThingShadowResponseUnmarshaller _instance = new GetThingShadowResponseUnmarshaller();

        internal static GetThingShadowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetThingShadowResponseUnmarshaller Instance => _instance;
    }
}
