...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateThingShadowRequestMarshaller : IMarshaller<IRequest, UpdateThingShadowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateThingShadowRequestMarshaller _instance = new();

        internal static UpdateThingShadowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateThingShadowRequestMarshaller Instance => _instance;
    }
}
