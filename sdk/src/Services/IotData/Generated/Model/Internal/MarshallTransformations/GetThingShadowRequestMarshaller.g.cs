...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetThingShadowRequestMarshaller : IMarshaller<IRequest, GetThingShadowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetThingShadowRequestMarshaller _instance = new();

        internal static GetThingShadowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetThingShadowRequestMarshaller Instance => _instance;
    }
}
