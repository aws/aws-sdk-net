...
{
    /// <summary>
    /// Response Unmarshaller for ListRetainedMessages operation
    /// </summary>  
    public class ListRetainedMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRetainedMessagesResponse response = new ListRetainedMessagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("retainedTopics", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RetainedMessageSummary, RetainedMessageSummaryUnmarshaller>(RetainedMessageSummaryUnmarshaller.Instance);
                    response.RetainedTopics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRetainedMessagesResponseUnmarshaller _instance = new ListRetainedMessagesResponseUnmarshaller();        

        internal static ListRetainedMessagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRetainedMessagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
