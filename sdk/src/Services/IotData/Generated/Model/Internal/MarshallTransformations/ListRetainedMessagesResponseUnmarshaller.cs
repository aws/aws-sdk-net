    ...
    public class ListRetainedMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RetainedMessageSummary, RetainedMessageSummaryUnmarshaller>(RetainedMessageSummaryUnmarshaller.Instance);
                    response.RetainedTopics = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
