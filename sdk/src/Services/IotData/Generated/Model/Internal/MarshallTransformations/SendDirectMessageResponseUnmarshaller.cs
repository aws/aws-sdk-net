...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SendDirectMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendDirectMessageResponse response = new SendDirectMessageResponse();
        ...
        internal static SendDirectMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendDirectMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
