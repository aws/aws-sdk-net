...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteThingShadowRequestMarshaller : IMarshaller<IRequest, DeleteThingShadowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteThingShadowRequestMarshaller _instance = new();

        internal static DeleteThingShadowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteThingShadowRequestMarshaller Instance => _instance;
    }
}
