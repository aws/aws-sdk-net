...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    public partial class DeleteConnectionRequestMarshaller : IMarshaller<IRequest, DeleteConnectionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteConnectionRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("cleanSession", StringUtils.FromBool(publicRequest.CleanSession.Value));
            }

            if (publicRequest.IsSetPreventWillMessage())
            {
                request.Parameters.Add("preventWillMessage", StringUtils.FromBool(publicRequest.PreventWillMessage.Value));
            }
