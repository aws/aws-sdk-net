...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListNamedShadowsForThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListNamedShadowsForThingResponse();
        ...
        internal static ListNamedShadowsForThingResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListNamedShadowsForThingResponseUnmarshaller Instance => _instance;
    }
}
