...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateThingShadowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateThingShadowResponse();
        ...
        internal static UpdateThingShadowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateThingShadowResponseUnmarshaller Instance => _instance;
    }
}
