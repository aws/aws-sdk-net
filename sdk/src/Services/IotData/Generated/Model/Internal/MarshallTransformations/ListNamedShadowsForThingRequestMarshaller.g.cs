...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListNamedShadowsForThingRequestMarshaller : IMarshaller<IRequest, ListNamedShadowsForThingRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListNamedShadowsForThingRequestMarshaller _instance = new();

        internal static ListNamedShadowsForThingRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListNamedShadowsForThingRequestMarshaller Instance => _instance;
    }
}
