...
namespace Amazon.IotData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetainedMessageSummaryUnmarshaller : IJsonUnmarshaller<RetainedMessageSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RetainedMessageSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("payloadSize", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.PayloadSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("qos", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.Qos = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
