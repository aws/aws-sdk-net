...
namespace Amazon.IotData
{
    ...
    public partial class AmazonIotDataClient : AmazonServiceClient, IAmazonIotData
    {
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonIotDataAuthSchemeHandler());
        }
        ...
        public virtual SendDirectMessageResponse SendDirectMessage(SendDirectMessageRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
