...
namespace Amazon.IotData
{
    ...
    public partial interface IAmazonIotData : IAmazonService, IDisposable
    {
        ...
        Task<SendDirectMessageResponse> SendDirectMessageAsync(SendDirectMessageRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
