...
namespace Amazon.CleanRoomsML
{
    ...
    /// <summary>
    /// Constants used for properties of type AudienceModelMetricType.
    /// </summary>
    public class AudienceModelMetricType : ConstantClass
    {

        /// <summary>
        /// Constant MEAN_RECIPROCAL_RANK for AudienceModelMetricType
        /// </summary>
        public static readonly AudienceModelMetricType MEAN_RECIPROCAL_RANK = new AudienceModelMetricType("MEAN_RECIPROCAL_RANK");
        /// <summary>
        /// Constant NORMALIZED_DISCOUNTED_CUMULATIVE_GAIN for AudienceModelMetricType
        /// </summary>
        public static readonly AudienceModelMetricType NORMALIZED_DISCOUNTED_CUMULATIVE_GAIN = new AudienceModelMetricType("NORMALIZED_DISCOUNTED_CUMULATIVE_GAIN");
        /// <summary>
        /// Constant PRECISION for AudienceModelMetricType
        /// </summary>
        public static readonly AudienceModelMetricType PRECISION = new AudienceModelMetricType("PRECISION");
        /// <summary>
        /// Constant RECALL for AudienceModelMetricType
        /// </summary>
        public static readonly AudienceModelMetricType RECALL = new AudienceModelMetricType("RECALL");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public AudienceModelMetricType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static AudienceModelMetricType FindValue(string value)
        {
            return FindValue<AudienceModelMetricType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator AudienceModelMetricType(string value)
        {
            return FindValue(value);
        }
    }
