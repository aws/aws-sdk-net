...
{
    /// <summary>
    /// PutMLConfiguration Request Marshaller
    /// </summary>       
    public class PutMLConfigurationRequestMarshaller : IMarshaller<IRequest, PutMLConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutMLConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutMLConfigurationRequest publicRequest)
        {
        ...
        private static PutMLConfigurationRequestMarshaller _instance = new PutMLConfigurationRequestMarshaller();        

        internal static PutMLConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMLConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
