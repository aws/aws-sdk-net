...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteConfiguredAudienceModelRequestMarshaller : IMarshaller<IRequest, DeleteConfiguredAudienceModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteConfiguredAudienceModelRequestMarshaller _instance = new DeleteConfiguredAudienceModelRequestMarshaller();        

        internal static DeleteConfiguredAudienceModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConfiguredAudienceModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
