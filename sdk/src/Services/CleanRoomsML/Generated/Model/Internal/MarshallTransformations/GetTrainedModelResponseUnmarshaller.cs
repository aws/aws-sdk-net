    ...
    public class GetTrainedModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ModelTrainingDataChannel, ModelTrainingDataChannelUnmarshaller>(ModelTrainingDataChannelUnmarshaller.Instance);
                    response.DataChannels = unmarshaller.Unmarshall(context);
                    continue;
                }
