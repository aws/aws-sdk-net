...
{
    /// <summary>
    /// GetMLInputChannel Request Marshaller
    /// </summary>       
    public class GetMLInputChannelRequestMarshaller : IMarshaller<IRequest, GetMLInputChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMLInputChannelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMLInputChannelRequest publicRequest)
        {
        ...
        private static GetMLInputChannelRequestMarshaller _instance = new GetMLInputChannelRequestMarshaller();        

        internal static GetMLInputChannelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLInputChannelRequestMarshaller Instance
        {
            get
            {
                return _instance;
