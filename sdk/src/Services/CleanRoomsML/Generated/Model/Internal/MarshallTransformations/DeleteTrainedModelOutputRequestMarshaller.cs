...
{
    /// <summary>
    /// DeleteTrainedModelOutput Request Marshaller
    /// </summary>       
    public class DeleteTrainedModelOutputRequestMarshaller : IMarshaller<IRequest, DeleteTrainedModelOutputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTrainedModelOutputRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTrainedModelOutputRequest publicRequest)
        {
        ...
        private static DeleteTrainedModelOutputRequestMarshaller _instance = new DeleteTrainedModelOutputRequestMarshaller();        

        internal static DeleteTrainedModelOutputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrainedModelOutputRequestMarshaller Instance
        {
            get
            {
                return _instance;
