...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrainedModelSummaryUnmarshaller : IUnmarshaller<TrainedModelSummary, XmlUnmarshallerContext>, IUnmarshaller<TrainedModelSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TrainedModelSummary IUnmarshaller<TrainedModelSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TrainedModelSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("incrementalTrainingDataChannels", targetDepth))
                {
                    ...
                    unmarshalledObject.IncrementalTrainingDataChannels = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VersionIdentifier = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
