    ...
    public class TrainedModelSummaryUnmarshaller : IJsonUnmarshaller<TrainedModelSummary, JsonUnmarshallerContext>
    {
        ...
        public TrainedModelSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("incrementalTrainingDataChannels", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("mlModelTrainingPayerAccountId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MlModelTrainingPayerAccountId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("versionIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
