...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrainedModelInferenceJobSummaryUnmarshaller : IUnmarshaller<TrainedModelInferenceJobSummary, XmlUnmarshallerContext>, IUnmarshaller<TrainedModelInferenceJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TrainedModelInferenceJobSummary IUnmarshaller<TrainedModelInferenceJobSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TrainedModelInferenceJobSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LogsStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("logsStatusDetails", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LogsStatusDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MetricsStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("metricsStatusDetails", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MetricsStatusDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TrainedModelInferenceJobArn = unmarshaller.Unmarshall(context);
                    continue;
                }
