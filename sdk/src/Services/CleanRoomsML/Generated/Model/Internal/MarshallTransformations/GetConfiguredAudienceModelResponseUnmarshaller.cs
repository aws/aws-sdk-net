...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetConfiguredAudienceModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConfiguredAudienceModelResponse response = new GetConfiguredAudienceModelResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("audienceModelArn", targetDepth))
                {
                    ...
                    response.AudienceModelArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("audienceSizeConfig", targetDepth))
                {
                    var unmarshaller = AudienceSizeConfigUnmarshaller.Instance;
                    response.AudienceSizeConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("childResourceTagOnCreatePolicy", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ChildResourceTagOnCreatePolicy = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("configuredAudienceModelArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConfiguredAudienceModelArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("minMatchingSeedSize", targetDepth))
                {
                    ...
                    response.MinMatchingSeedSize = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("sharedAudienceMetrics", targetDepth))
                {
                    ...
                    response.SharedAudienceMetrics = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static GetConfiguredAudienceModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfiguredAudienceModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
