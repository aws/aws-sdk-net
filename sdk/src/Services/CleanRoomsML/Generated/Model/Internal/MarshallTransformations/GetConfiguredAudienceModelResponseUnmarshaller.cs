        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("audienceModelArn", targetDepth))
                {
                    ...
                    response.AudienceModelArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("audienceSizeConfig", targetDepth))
                {
                    var unmarshaller = AudienceSizeConfigUnmarshaller.Instance;
                    response.AudienceSizeConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("childResourceTagOnCreatePolicy", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ChildResourceTagOnCreatePolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("minMatchingSeedSize", targetDepth))
                {
                    ...
                    response.MinMatchingSeedSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("sharedAudienceMetrics", targetDepth))
                {
                    ...
                    response.SharedAudienceMetrics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
