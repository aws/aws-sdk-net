...
namespace Amazon.KeyspacesStreams
{
    ...
    /// <summary>
    /// Constants used for properties of type IteratorPosition.
    /// </summary>
    public class IteratorPosition : ConstantClass
    {

        /// <summary>
        /// Constant AT_TIP for IteratorPosition
        /// </summary>
        public static readonly IteratorPosition AT_TIP = new IteratorPosition("AT_TIP");
        /// <summary>
        /// Constant BEHIND_TIP for IteratorPosition
        /// </summary>
        public static readonly IteratorPosition BEHIND_TIP = new IteratorPosition("BEHIND_TIP");
        ...
        /// </summary>
        public IteratorPosition(string value)
            : base(value)
        {
        }
        ...
        public static IteratorPosition FindValue(string value)
        {
            return FindValue<IteratorPosition>(value);
        }
        ...
        /// <returns></returns>
        public static implicit operator IteratorPosition(string value)
        {
