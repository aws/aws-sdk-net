...
namespace Amazon.KeyspacesStreams
{
    ...
    public partial class AmazonKeyspacesStreamsClient : AmazonServiceClient, IAmazonKeyspacesStreams
    {
        ...
        public AmazonKeyspacesStreamsClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonKeyspacesStreamsConfig()) { }
        ...
        public AmazonKeyspacesStreamsClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonKeyspacesStreamsConfig{RegionEndpoint = region}) { }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonKeyspacesStreamsEndpointResolver();
