...
namespace Amazon.KeyspacesStreams.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SequenceNumberRangeUnmarshaller : IJsonUnmarshaller<SequenceNumberRange, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SequenceNumberRange Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
