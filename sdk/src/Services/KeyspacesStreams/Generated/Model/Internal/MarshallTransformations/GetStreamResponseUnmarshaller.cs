        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("creationRequestDateTime", targetDepth))
                {
                    ...
                    response.CreationRequestDateTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamLabel = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("streamStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("streamViewType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamViewType = unmarshaller.Unmarshall(context);
                    continue;
                }
