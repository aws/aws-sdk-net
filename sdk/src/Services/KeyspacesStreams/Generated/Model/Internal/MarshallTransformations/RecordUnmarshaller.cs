    ...
    public class RecordUnmarshaller : IUnmarshaller<Record, XmlUnmarshallerContext>, IUnmarshaller<Record, JsonUnmarshallerContext>
    {
        ...
        public Record Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, KeyspacesCellValue, StringUnmarshaller, KeyspacesCellValueUnmarshaller>(StringUnmarshaller.Instance, KeyspacesCellValueUnmarshaller.Instance);
