...
namespace Amazon.ResourceExplorer2
{
    ...
    /// Explorer <a href="https://docs.aws.amazon.com/arexug/mainline/getting-started-terms-and-concepts.html#term-index">creates
    /// and maintains an index</a> in each Region, with the details of that Region's resources.
    /// </para>
    ///  
    /// <para>
    /// You can <a href="https://docs.aws.amazon.com/arexug/mainline/manage-aggregator-region.html">search
    ...
    /// </para>
    ///  <pre><code> &lt;p&gt;For more information about Amazon Web Services Resource Explorer,
    /// including how to enable and configure the service, see the &lt;a href=&quot;https://docs.aws.amazon.com/resource-explorer/latest/userguide/&quot;&gt;Amazon
    /// Web Services Resource Explorer User Guide&lt;/a&gt;.&lt;/p&gt; &lt;note&gt; &lt;p&gt;The
    /// example HTTP query requests and responses in this guide are displayed with the &lt;a
    /// href=&quot;https://json.org&quot;&gt;JSON&lt;/a&gt; formatted across multiple lines
    /// for readability. The actual query responses from the Resource Explorer service do
    /// not include this extra whitespace.&lt;/p&gt; &lt;/note&gt; &lt;p&gt; &lt;b&gt;We want
    /// your feedback about this documentation&lt;/b&gt; &lt;/p&gt; &lt;p&gt;Our goal is to
    /// help you get everything you can from Resource Explorer. If this guide helps you to
    /// do that, then let us know. If the guide isn't helping you, then we want to hear from
    /// you so we can address the issue. Use the &lt;b&gt;Feedback&lt;/b&gt; link that's in
    /// the upper-right corner of every page. That sends your comments directly to the writers
    /// of this guide. We review every submission, looking for opportunities to improve the
    /// documentation. Thank you in advance for your help!&lt;/p&gt; </code></pre>
    /// </summary>
    public partial interface IAmazonResourceExplorer2 : IAmazonService, IDisposable
    {
        ...
        AssociateDefaultViewResponse AssociateDefaultView(AssociateDefaultViewRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/AssociateDefaultView">REST API Reference for AssociateDefaultView Operation</seealso>
        Task<AssociateDefaultViewResponse> AssociateDefaultViewAsync(AssociateDefaultViewRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        BatchGetViewResponse BatchGetView(BatchGetViewRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/BatchGetView">REST API Reference for BatchGetView Operation</seealso>
        Task<BatchGetViewResponse> BatchGetViewAsync(BatchGetViewRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        DisassociateDefaultViewResponse DisassociateDefaultView(DisassociateDefaultViewRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/DisassociateDefaultView">REST API Reference for DisassociateDefaultView Operation</seealso>
        Task<DisassociateDefaultViewResponse> DisassociateDefaultViewAsync(DisassociateDefaultViewRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        GetDefaultViewResponse GetDefaultView(GetDefaultViewRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/GetDefaultView">REST API Reference for GetDefaultView Operation</seealso>
        Task<GetDefaultViewResponse> GetDefaultViewAsync(GetDefaultViewRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/ListIndexes">REST API Reference for ListIndexes Operation</seealso>
        Task<ListIndexesResponse> ListIndexesAsync(ListIndexesRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ListSupportedResourceTypesResponse ListSupportedResourceTypes(ListSupportedResourceTypesRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/ListSupportedResourceTypes">REST API Reference for ListSupportedResourceTypes Operation</seealso>
        Task<ListSupportedResourceTypesResponse> ListSupportedResourceTypesAsync(ListSupportedResourceTypesRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        UpdateIndexTypeResponse UpdateIndexType(UpdateIndexTypeRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/UpdateIndexType">REST API Reference for UpdateIndexType Operation</seealso>
        Task<UpdateIndexTypeResponse> UpdateIndexTypeAsync(UpdateIndexTypeRequest request, CancellationToken cancellationToken = default(CancellationToken));
