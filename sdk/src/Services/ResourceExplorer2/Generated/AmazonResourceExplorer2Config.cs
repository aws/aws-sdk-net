...
namespace Amazon.ResourceExplorer2
{
    ...
    public partial class AmazonResourceExplorer2Config : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Resource Explorer 2", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "Resource Explorer 2";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "resource-explorer-2";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-07-28";
