...
namespace Amazon.ResourceExplorer2
{
    ...
    public partial interface IAmazonResourceExplorer2 : IAmazonService, IDisposable
    {
        ...
        Task<GetAccountLevelServiceConfigurationResponse> GetAccountLevelServiceConfigurationAsync(GetAccountLevelServiceConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetManagedViewResponse> GetManagedViewAsync(GetManagedViewRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListIndexesForMembersResponse> ListIndexesForMembersAsync(ListIndexesForMembersRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListManagedViewsResponse> ListManagedViewsAsync(ListManagedViewsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonResourceExplorer2Config))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonResourceExplorer2Config();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonResourceExplorer2Config;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonResourceExplorer2Config to create AmazonResourceExplorer2Client");
            }

            return awsCredentials == null ? 
                    new AmazonResourceExplorer2Client(serviceClientConfig) :
                    new AmazonResourceExplorer2Client(awsCredentials, serviceClientConfig);
        }
