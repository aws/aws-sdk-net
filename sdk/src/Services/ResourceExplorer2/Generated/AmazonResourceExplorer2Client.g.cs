...
namespace Amazon.ResourceExplorer2
{
    ...
    public partial class AmazonResourceExplorer2Client : AmazonServiceClient, IAmazonResourceExplorer2
    {
        ...
        /// 
        /// </summary>
        public AmazonResourceExplorer2Client() : base(new AmazonResourceExplorer2Config()) { }
        ...
        public AmazonResourceExplorer2Client(RegionEndpoint region) : base(new AmazonResourceExplorer2Config { RegionEndpoint = region }) { }
        ...
        public AmazonResourceExplorer2Client(AmazonResourceExplorer2Config config) : base(config) { }
