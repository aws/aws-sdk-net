...
namespace Amazon.ResourceExplorer2.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving ResourceExplorer2 endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonResourceExplorer2EndpointProvider"/> and <see cref="AmazonResourceExplorer2EndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class ResourceExplorer2EndpointParameters : EndpointParameters
    {
        /// <summary>
        /// ResourceExplorer2EndpointParameters constructor
        /// </summary>
