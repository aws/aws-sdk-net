...
namespace Amazon.ResourceExplorer2.Internal
{
    ...
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for ResourceExplorer2 service requests.
    /// <para />
    /// Collects values for <see cref="ResourceExplorer2EndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonResourceExplorer2EndpointProvider"/>.
    /// <para />
