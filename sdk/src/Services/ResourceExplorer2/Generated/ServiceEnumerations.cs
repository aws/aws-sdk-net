...
namespace Amazon.ResourceExplorer2
{
    ...
    public class OperationStatus : ConstantClass
    {
        ...
        /// <summary>
        /// Constant SKIPPED for OperationStatus
        /// </summary>
        public static readonly OperationStatus SKIPPED = new OperationStatus("SKIPPED");
        /// <summary>
    ...
    /// <summary>
    /// Constants used for properties of type RecorderType.
    /// </summary>
    public class RecorderType : ConstantClass
    {

        /// <summary>
        /// Constant AWS for RecorderType
        /// </summary>
        public static readonly RecorderType AWS = new RecorderType("AWS");
        /// <summary>
        /// Constant THIRD_PARTY for RecorderType
        /// </summary>
        public static readonly RecorderType THIRD_PARTY = new RecorderType("THIRD_PARTY");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public RecorderType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static RecorderType FindValue(string value)
        {
            return FindValue<RecorderType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator RecorderType(string value)
        {
            return FindValue(value);
        }
    }
