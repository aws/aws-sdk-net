...
namespace Amazon.ResourceExplorer2.Model
{
    ...
    public partial class OrgConfiguration
    {
        ...
        public AWSServiceAccessStatus AWSServiceAccessStatus { get; set; }

        /// <summary>
        /// Checks to see if the AWSServiceAccessStatus property is set.
        /// </summary>
        internal bool IsSetAWSServiceAccessStatus() => this.AWSServiceAccessStatus != null;
        ...
        /// <summary>
        /// Checks to see if the ServiceLinkedRole property is set.
        /// </summary>
        internal bool IsSetServiceLinkedRole() => this.ServiceLinkedRole != null;
    }
}
