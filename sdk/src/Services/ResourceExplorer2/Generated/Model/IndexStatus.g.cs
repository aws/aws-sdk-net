...
{
    /// <summary>
    /// Contains information about the status of a Resource Explorer index operation in a
    /// specific Region.
    /// </summary>
    public partial class IndexStatus
    {
        ...
        /// <para>
        /// The current status of the index operation. Valid values are <c>SUCCEEDED</c>, <c>FAILED</c>,
