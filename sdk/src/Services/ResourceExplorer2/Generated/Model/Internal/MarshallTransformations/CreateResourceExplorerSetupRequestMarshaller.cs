...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateResourceExplorerSetupRequestMarshaller : IMarshaller<IRequest, CreateResourceExplorerSetupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateResourceExplorerSetupRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetAggregatorRegions())
                {
                    ...
                    {
                            context.Writer.Write(publicRequestAggregatorRegionsListValue);
                    }
        ...
        private static CreateResourceExplorerSetupRequestMarshaller _instance = new CreateResourceExplorerSetupRequestMarshaller();        

        internal static CreateResourceExplorerSetupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceExplorerSetupRequestMarshaller Instance
        {
            get
            {
                return _instance;
