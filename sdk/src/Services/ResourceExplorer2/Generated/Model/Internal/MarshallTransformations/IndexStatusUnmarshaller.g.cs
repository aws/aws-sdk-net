...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IndexStatusUnmarshaller : IJsonUnmarshaller<IndexStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public IndexStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new IndexStatus();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IndexStatusUnmarshaller Instance => _instance;
    }
}
