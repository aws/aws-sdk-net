...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ViewUnmarshaller : IJsonUnmarshaller<View, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public View Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ViewArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ViewArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ViewName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ViewName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
