...
{
    /// <summary>
    /// Response Unmarshaller for ViewStatus Object
    /// </summary>
    public partial class ViewStatusUnmarshaller : IJsonUnmarshaller<ViewStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ViewStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ViewStatus();
        ...
        private static ViewStatusUnmarshaller _instance = new ViewStatusUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ViewStatusUnmarshaller Instance => _instance;
    }
}
