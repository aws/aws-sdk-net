...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IndexUnmarshaller : IJsonUnmarshaller<Index, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Index();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IndexUnmarshaller Instance => _instance;
    }
}
