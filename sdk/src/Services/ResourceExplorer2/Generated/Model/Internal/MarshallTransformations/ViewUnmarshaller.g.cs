...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ViewUnmarshaller : IJsonUnmarshaller<View, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new View();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ViewUnmarshaller Instance => _instance;
    }
}
