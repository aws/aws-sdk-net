...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ServiceViewUnmarshaller : IJsonUnmarshaller<ServiceView, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ServiceView();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ServiceViewUnmarshaller Instance => _instance;
    }
}
