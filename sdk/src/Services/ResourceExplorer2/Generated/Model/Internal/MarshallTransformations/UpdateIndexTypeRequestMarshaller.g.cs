...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateIndexTypeRequestMarshaller : IMarshaller<IRequest, UpdateIndexTypeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateIndexTypeRequestMarshaller _instance = new();

        internal static UpdateIndexTypeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIndexTypeRequestMarshaller Instance => _instance;
    }
}
