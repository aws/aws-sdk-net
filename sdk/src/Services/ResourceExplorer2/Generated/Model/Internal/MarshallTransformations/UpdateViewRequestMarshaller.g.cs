...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateViewRequestMarshaller : IMarshaller<IRequest, UpdateViewRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateViewRequestMarshaller _instance = new();

        internal static UpdateViewRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateViewRequestMarshaller Instance => _instance;
    }
}
