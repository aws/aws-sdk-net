...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteIndexResponse();
        ...
        internal static DeleteIndexResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteIndexResponseUnmarshaller Instance => _instance;
    }
}
