...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ServiceLinkedRecorderInfoUnmarshaller : IJsonUnmarshaller<ServiceLinkedRecorderInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ServiceLinkedRecorderInfo();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ServiceLinkedRecorderInfoUnmarshaller Instance => _instance;
    }
}
