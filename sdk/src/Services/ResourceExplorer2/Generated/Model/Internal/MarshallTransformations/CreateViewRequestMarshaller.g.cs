...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateViewRequestMarshaller : IMarshaller<IRequest, CreateViewRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateViewRequestMarshaller _instance = new();

        internal static CreateViewRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateViewRequestMarshaller Instance => _instance;
    }
}
