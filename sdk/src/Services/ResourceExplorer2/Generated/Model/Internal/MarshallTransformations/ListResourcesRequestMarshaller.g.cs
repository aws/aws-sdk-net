...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListResourcesRequestMarshaller : IMarshaller<IRequest, ListResourcesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListResourcesRequestMarshaller _instance = new();

        internal static ListResourcesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListResourcesRequestMarshaller Instance => _instance;
    }
}
