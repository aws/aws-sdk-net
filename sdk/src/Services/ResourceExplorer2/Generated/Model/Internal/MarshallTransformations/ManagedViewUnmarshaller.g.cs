...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ManagedViewUnmarshaller : IJsonUnmarshaller<ManagedView, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ManagedView();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ManagedViewUnmarshaller Instance => _instance;
    }
}
