...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAccountLevelServiceConfigurationRequestMarshaller : IMarshaller<IRequest, GetAccountLevelServiceConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAccountLevelServiceConfigurationRequestMarshaller _instance = new();

        internal static GetAccountLevelServiceConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAccountLevelServiceConfigurationRequestMarshaller Instance => _instance;
    }
}
