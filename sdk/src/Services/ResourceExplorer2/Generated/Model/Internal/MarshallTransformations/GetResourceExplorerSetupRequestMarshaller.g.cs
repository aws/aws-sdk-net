...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetResourceExplorerSetupRequestMarshaller : IMarshaller<IRequest, GetResourceExplorerSetupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetResourceExplorerSetupRequestMarshaller _instance = new();

        internal static GetResourceExplorerSetupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetResourceExplorerSetupRequestMarshaller Instance => _instance;
    }
}
