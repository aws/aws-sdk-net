...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIndexType operation
    /// </summary>  
    public class UpdateIndexTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIndexTypeResponse response = new UpdateIndexTypeResponse();
        ...
        private static UpdateIndexTypeResponseUnmarshaller _instance = new UpdateIndexTypeResponseUnmarshaller();        

        internal static UpdateIndexTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIndexTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
