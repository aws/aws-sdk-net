...
{
    /// <summary>
    /// Container for the parameters to the CreateResourceExplorerSetup operation. Creates
    /// a Resource Explorer setup configuration across multiple Amazon Web Services Regions.
    /// This operation sets up indexes and views in the specified Regions. This operation
    ...
    public partial class CreateResourceExplorerSetupRequest : AmazonResourceExplorer2Request
    {
        ...
        public List<string> AggregatorRegions { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AggregatorRegions property is set.
        /// </summary>
        internal bool IsSetAggregatorRegions() => this.AggregatorRegions != null && (this.AggregatorRegions.Count > 0 || !AWSConfigs.InitializeCollections);
