...
namespace Amazon.ResourceExplorer2.Model
{
    ...
    public partial class ResourceCount
    {
        ...
        /// <summary>
        /// Checks to see if the Complete property is set.
        /// </summary>
        internal bool IsSetComplete() => this.Complete.HasValue;
        ...
        /// <summary>
        /// Checks to see if the TotalResources property is set.
        /// </summary>
        internal bool IsSetTotalResources() => this.TotalResources.HasValue;
    }
}
