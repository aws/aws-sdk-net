...
{
    /// <summary>
    /// Container for the parameters to the UpdateView operation. Modifies some of the details
    /// of a view. You can change the filter string and the list of included properties. You
