...
{
    /// <summary>
    /// Container for the parameters to the ListViews operation. Lists the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon
    /// resource names (ARNs)</a> of the views available in the Amazon Web Services Region
    /// in which you call this operation. <note> <para> Always check the <c>NextToken</c>
