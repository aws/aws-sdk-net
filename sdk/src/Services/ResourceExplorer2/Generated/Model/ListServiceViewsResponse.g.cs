...
namespace Amazon.ResourceExplorer2.Model
{
    ...
    public partial class ListServiceViewsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<string> ServiceViews { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ServiceViews property is set.
        /// </summary>
        internal bool IsSetServiceViews() => this.ServiceViews != null && (this.ServiceViews.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
