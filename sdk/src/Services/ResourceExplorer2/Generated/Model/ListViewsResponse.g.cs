...
namespace Amazon.ResourceExplorer2.Model
{
    ...
    public partial class ListViewsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<string> Views { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Views property is set.
        /// </summary>
        internal bool IsSetViews() => this.Views != null && (this.Views.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
