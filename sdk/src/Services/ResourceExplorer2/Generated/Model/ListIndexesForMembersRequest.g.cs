...
{
    /// <summary>
    /// Container for the parameters to the ListIndexesForMembers operation. Retrieves a list
    /// of a member's indexes in all Amazon Web Services Regions that are currently collecting
    /// resource information for Amazon Web Services Resource Explorer. Only the management
    ...
    public partial class ListIndexesForMembersRequest : AmazonResourceExplorer2Request
    {
        ...
        public List<string> AccountIdList { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AccountIdList property is set.
        /// </summary>
        internal bool IsSetAccountIdList() => this.AccountIdList != null && (this.AccountIdList.Count > 0 || !AWSConfigs.InitializeCollections);
