...
namespace Amazon.ResourceExplorer2.Model
{
    ...
    /// </summary>
    internal sealed partial class ListIndexesPaginator : IPaginator<ListIndexesResponse>, IListIndexesPaginator
    {
        private readonly IAmazonResourceExplorer2 _client;
        private readonly ListIndexesRequest _request;
        private int _isPaginatorInUse = 0;

        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListIndexesResponse> Responses => new PaginatedResponse<ListIndexesResponse>(this);
...
#if NETFRAMEWORK
        IEnumerable<ListIndexesResponse> IPaginator<ListIndexesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListIndexes(_request);
        ...
        async IAsyncEnumerable<ListIndexesResponse> IPaginator<ListIndexesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListIndexesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
