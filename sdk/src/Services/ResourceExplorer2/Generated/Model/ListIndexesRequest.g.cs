...
{
    /// <summary>
    /// Container for the parameters to the ListIndexes operation. Retrieves a list of all
    /// of the indexes in Amazon Web Services Regions that are currently collecting resource
