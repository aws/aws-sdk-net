...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("Comprehend", "4.0.0.0");

        private static readonly AmazonComprehendEndpointResolver EndpointResolver =
            new AmazonComprehendEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("Comprehend", "3.7.400.104");
=======
            InternalSDKUtils.BuildUserAgentString("Comprehend", "3.7.400.130");
