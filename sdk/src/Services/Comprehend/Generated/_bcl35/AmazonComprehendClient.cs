...
namespace Amazon.Comprehend
{
    ...
    public partial class AmazonComprehendClient : AmazonServiceClient, IAmazonComprehend
    {
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/DetectToxicContent">REST API Reference for DetectToxicContent Operation</seealso>
        public virtual DetectToxicContentResponse EndDetectToxicContent(IAsyncResult asyncResult)
        {
            return EndInvoke<DetectToxicContentResponse>(asyncResult);
        }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonComprehendEndpointResolver();
