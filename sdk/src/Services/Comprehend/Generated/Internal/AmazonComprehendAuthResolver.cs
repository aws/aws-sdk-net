...
namespace Amazon.Comprehend.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonComprehendAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonComprehendAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Comprehend.
        /// </summary>
        public AmazonComprehendAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonComprehendAuthSchemeParameters
            {
    ...
    public class AmazonComprehendAuthSchemeResolver : IAuthSchemeResolver<AmazonComprehendAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonComprehendAuthSchemeParameters authParameters)
        {
