...
{
    /// <summary>
    /// StartPiiEntitiesDetectionJob Request Marshaller
    /// </summary>       
    public class StartPiiEntitiesDetectionJobRequestMarshaller : IMarshaller<IRequest, StartPiiEntitiesDetectionJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartPiiEntitiesDetectionJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartPiiEntitiesDetectionJobRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetRedactionConfig())
            {
                context.Writer.WritePropertyName("RedactionConfig");
                context.Writer.WriteStartObject();

                var marshaller = RedactionConfigMarshaller.Instance;
                marshaller.Marshall(publicRequest.RedactionConfig, context);
        ...
        private static StartPiiEntitiesDetectionJobRequestMarshaller _instance = new StartPiiEntitiesDetectionJobRequestMarshaller();        

        internal static StartPiiEntitiesDetectionJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPiiEntitiesDetectionJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
