...
{
    /// <summary>
    /// Response Unmarshaller for KeyPhrase Object
    /// </summary>  
    public class KeyPhraseUnmarshaller : IUnmarshaller<KeyPhrase, XmlUnmarshallerContext>, IUnmarshaller<KeyPhrase, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        KeyPhrase IUnmarshaller<KeyPhrase, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static KeyPhraseUnmarshaller _instance = new KeyPhraseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KeyPhraseUnmarshaller Instance
        {
            get
            {
                return _instance;
