...
{
    /// <summary>
    /// UpdateFlywheel Request Marshaller
    /// </summary>       
    public class UpdateFlywheelRequestMarshaller : IMarshaller<IRequest, UpdateFlywheelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFlywheelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFlywheelRequest publicRequest)
        {
        ...
        private static UpdateFlywheelRequestMarshaller _instance = new UpdateFlywheelRequestMarshaller();        

        internal static UpdateFlywheelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlywheelRequestMarshaller Instance
        {
            get
            {
                return _instance;
