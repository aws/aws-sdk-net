...
{
    /// <summary>
    /// Response Unmarshaller for StartKeyPhrasesDetectionJob operation
    /// </summary>  
    public class StartKeyPhrasesDetectionJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartKeyPhrasesDetectionJobResponse response = new StartKeyPhrasesDetectionJobResponse();
        ...
        private static StartKeyPhrasesDetectionJobResponseUnmarshaller _instance = new StartKeyPhrasesDetectionJobResponseUnmarshaller();        

        internal static StartKeyPhrasesDetectionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartKeyPhrasesDetectionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
