...
{
    /// <summary>
    /// Response Unmarshaller for DetectPiiEntities operation
    /// </summary>  
    public class DetectPiiEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetectPiiEntitiesResponse response = new DetectPiiEntitiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PiiEntity, PiiEntityUnmarshaller>(PiiEntityUnmarshaller.Instance);
        ...
        private static DetectPiiEntitiesResponseUnmarshaller _instance = new DetectPiiEntitiesResponseUnmarshaller();        

        internal static DetectPiiEntitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectPiiEntitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
