...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeResourcePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeResourcePolicyResponse response = new DescribeResourcePolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PolicyRevisionId", targetDepth, ref reader))
                {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResourcePolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeResourcePolicyResponseUnmarshaller _instance = new DescribeResourcePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeResourcePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
