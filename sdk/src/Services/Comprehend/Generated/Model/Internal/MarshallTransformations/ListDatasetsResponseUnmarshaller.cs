    ...
    public class ListDatasetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DatasetProperties, DatasetPropertiesUnmarshaller>(DatasetPropertiesUnmarshaller.Instance);
                    response.DatasetPropertiesList = unmarshaller.Unmarshall(context);
                    continue;
                }
