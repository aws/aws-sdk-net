...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatasetPropertiesUnmarshaller : IUnmarshaller<DatasetProperties, XmlUnmarshallerContext>, IUnmarshaller<DatasetProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DatasetProperties IUnmarshaller<DatasetProperties, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DatasetProperties Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DatasetS3Uri = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("NumberOfDocuments", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberOfDocuments = unmarshaller.Unmarshall(context);
                    continue;
                }
