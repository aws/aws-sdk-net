...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EntityRecognizerMetadataEntityTypesListItemUnmarshaller : IJsonUnmarshaller<EntityRecognizerMetadataEntityTypesListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EntityRecognizerMetadataEntityTypesListItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumberOfTrainMentions", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.NumberOfTrainMentions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
