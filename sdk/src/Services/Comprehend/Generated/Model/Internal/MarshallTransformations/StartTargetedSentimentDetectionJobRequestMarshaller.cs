...
{
    /// <summary>
    /// StartTargetedSentimentDetectionJob Request Marshaller
    /// </summary>       
    public class StartTargetedSentimentDetectionJobRequestMarshaller : IMarshaller<IRequest, StartTargetedSentimentDetectionJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartTargetedSentimentDetectionJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartTargetedSentimentDetectionJobRequest publicRequest)
        {
        ...
        private static StartTargetedSentimentDetectionJobRequestMarshaller _instance = new StartTargetedSentimentDetectionJobRequestMarshaller();        

        internal static StartTargetedSentimentDetectionJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTargetedSentimentDetectionJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
