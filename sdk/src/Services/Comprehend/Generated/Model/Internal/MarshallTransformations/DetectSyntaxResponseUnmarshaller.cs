...
{
    /// <summary>
    /// Response Unmarshaller for DetectSyntax operation
    /// </summary>  
    public class DetectSyntaxResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new UnsupportedLanguageException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DetectSyntaxResponseUnmarshaller _instance = new DetectSyntaxResponseUnmarshaller();        

        internal static DetectSyntaxResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectSyntaxResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
