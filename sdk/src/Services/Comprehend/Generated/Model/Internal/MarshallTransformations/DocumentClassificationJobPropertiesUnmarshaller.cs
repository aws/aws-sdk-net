...
{
    /// <summary>
    /// Response Unmarshaller for DocumentClassificationJobProperties Object
    /// </summary>  
    public class DocumentClassificationJobPropertiesUnmarshaller : IJsonUnmarshaller<DocumentClassificationJobProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentClassificationJobProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DocumentClassifierArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DocumentClassifierArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DocumentClassificationJobPropertiesUnmarshaller _instance = new DocumentClassificationJobPropertiesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DocumentClassificationJobPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
