...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("Panorama", "4.0.0.0");

        private static readonly AmazonPanoramaEndpointResolver EndpointResolver =
            new AmazonPanoramaEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("Panorama", "3.7.400.130");
=======
            InternalSDKUtils.BuildUserAgentString("Panorama", "3.7.400.140");
