...
{
    /// <summary>
    /// Response Unmarshaller for ProvisionDevice operation
    /// </summary>  
    public class ProvisionDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ProvisionDeviceResponse response = new ProvisionDeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IotThingName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.IotThingName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ProvisionDeviceResponseUnmarshaller _instance = new ProvisionDeviceResponseUnmarshaller();        

        internal static ProvisionDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProvisionDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
