...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NodeInstanceUnmarshaller : IUnmarshaller<NodeInstance, XmlUnmarshallerContext>, IUnmarshaller<NodeInstance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NodeInstance IUnmarshaller<NodeInstance, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public NodeInstance Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NodeInstanceId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PackagePatchVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
