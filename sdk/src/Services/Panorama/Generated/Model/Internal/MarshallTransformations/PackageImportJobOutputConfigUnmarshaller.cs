...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackageImportJobOutputConfigUnmarshaller : IJsonUnmarshaller<PackageImportJobOutputConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackageImportJobOutputConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("PackageVersionOutputConfig", targetDepth, ref reader))
                {
                    var unmarshaller = PackageVersionOutputConfigUnmarshaller.Instance;
                    unmarshalledObject.PackageVersionOutputConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
