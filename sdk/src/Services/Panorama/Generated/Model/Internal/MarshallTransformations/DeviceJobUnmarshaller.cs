...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceJobUnmarshaller : IJsonUnmarshaller<DeviceJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeviceJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
