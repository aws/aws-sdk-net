    ...
    public class ConflictExceptionUnmarshaller : IErrorResponseUnmarshaller<ConflictException, JsonUnmarshallerContext>
    {
        ...
        public ConflictException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ConflictExceptionErrorArgument, ConflictExceptionErrorArgumentUnmarshaller>(ConflictExceptionErrorArgumentUnmarshaller.Instance);
                    unmarshalledObject.ErrorArguments = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ErrorId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ErrorId = unmarshaller.Unmarshall(context);
                    continue;
                }
