...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDevice operation
    /// </summary>  
    public class DeleteDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteDeviceResponseUnmarshaller _instance = new DeleteDeviceResponseUnmarshaller();        

        internal static DeleteDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
