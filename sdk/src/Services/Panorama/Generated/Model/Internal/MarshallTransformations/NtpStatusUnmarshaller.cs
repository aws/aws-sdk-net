...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NtpStatusUnmarshaller : IJsonUnmarshaller<NtpStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NtpStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NtpServerName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NtpServerName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
