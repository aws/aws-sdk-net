...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LatestDeviceJobUnmarshaller : IJsonUnmarshaller<LatestDeviceJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LatestDeviceJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
