...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    public class DeviceJobConfigMarshaller : IRequestMarshaller<DeviceJobConfig, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DeviceJobConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetOTAJobConfig())
            {
                context.Writer.WritePropertyName("OTAJobConfig");
                context.Writer.WriteStartObject();

                var marshaller = OTAJobConfigMarshaller.Instance;
                marshaller.Marshall(requestObject.OTAJobConfig, context);
