...
{
    /// <summary>
    /// DescribeApplicationInstance Request Marshaller
    /// </summary>       
    public class DescribeApplicationInstanceRequestMarshaller : IMarshaller<IRequest, DescribeApplicationInstanceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeApplicationInstanceRequest)input);
        }
        ...
        private static DescribeApplicationInstanceRequestMarshaller _instance = new DescribeApplicationInstanceRequestMarshaller();        

        internal static DescribeApplicationInstanceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeApplicationInstanceRequestMarshaller Instance
        {
            get
            {
                return _instance;
