...
namespace Amazon.Panorama.Model
{
    ...
    /// </summary>
    public partial class NtpStatus
    {
        private NetworkConnectionStatus _connectionStatus;
        private string _ipAddress;
        private string _ntpServerName;
        ...
        /// <summary>
        /// Gets and sets the property NtpServerName. 
        /// <para>
        ...
        {
            get { return this._ntpServerName; }
            set { this._ntpServerName = value; }
        }

        // Check to see if NtpServerName property is set
        internal bool IsSetNtpServerName()
        {
            return this._ntpServerName != null;
        }
