...
namespace Amazon.Lightsail.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonLightsailAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLightsailAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Lightsail.
        /// </summary>
        public AmazonLightsailAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLightsailAuthSchemeParameters
            {
    ...
    public class AmazonLightsailAuthSchemeResolver : IAuthSchemeResolver<AmazonLightsailAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLightsailAuthSchemeParameters authParameters)
        {
