...
namespace Amazon.Lightsail.Model
{
    ...
    public partial class OperationFailureException : AmazonLightsailException
    {
        ...
        public OperationFailureException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OperationFailureException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
