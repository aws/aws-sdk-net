...
namespace Amazon.Lightsail.Model
{
    ...
    [Serializable]
    #endif
    public partial class OperationFailureException : AmazonLightsailException
    {
        ...
        /// <summary>
        /// Construct instance of OperationFailureException
        /// </summary>
        ...
        public OperationFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OperationFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
            : base(message, errorType, errorCode, requestId, statusCode) {}


#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the OperationFailureException class with serialized data.
        /// </summary>
