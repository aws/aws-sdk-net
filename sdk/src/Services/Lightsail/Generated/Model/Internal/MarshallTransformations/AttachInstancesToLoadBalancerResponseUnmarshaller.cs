...
{
    /// <summary>
    /// Response Unmarshaller for AttachInstancesToLoadBalancer operation
    /// </summary>  
    public class AttachInstancesToLoadBalancerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachInstancesToLoadBalancerResponse response = new AttachInstancesToLoadBalancerResponse();
        ...
        private static AttachInstancesToLoadBalancerResponseUnmarshaller _instance = new AttachInstancesToLoadBalancerResponseUnmarshaller();        

        internal static AttachInstancesToLoadBalancerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachInstancesToLoadBalancerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
