...
{
    /// <summary>
    /// Response Unmarshaller for PeerVpc operation
    /// </summary>  
    public class PeerVpcResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PeerVpcResponse response = new PeerVpcResponse();
        ...
        private static PeerVpcResponseUnmarshaller _instance = new PeerVpcResponseUnmarshaller();        

        internal static PeerVpcResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PeerVpcResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
