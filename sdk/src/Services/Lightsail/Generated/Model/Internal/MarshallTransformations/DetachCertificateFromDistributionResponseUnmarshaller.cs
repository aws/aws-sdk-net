...
{
    /// <summary>
    /// Response Unmarshaller for DetachCertificateFromDistribution operation
    /// </summary>  
    public class DetachCertificateFromDistributionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachCertificateFromDistributionResponse response = new DetachCertificateFromDistributionResponse();
        ...
        private static DetachCertificateFromDistributionResponseUnmarshaller _instance = new DetachCertificateFromDistributionResponseUnmarshaller();        

        internal static DetachCertificateFromDistributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachCertificateFromDistributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
