    ...
    public class GetSetupHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SetupHistory, SetupHistoryUnmarshaller>(SetupHistoryUnmarshaller.Instance);
                    response.SetupHistory = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
