...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBucketAccessKey operation
    /// </summary>  
    public class DeleteBucketAccessKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBucketAccessKeyResponse response = new DeleteBucketAccessKeyResponse();
        ...
        private static DeleteBucketAccessKeyResponseUnmarshaller _instance = new DeleteBucketAccessKeyResponseUnmarshaller();        

        internal static DeleteBucketAccessKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBucketAccessKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
