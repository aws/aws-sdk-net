...
{
    /// <summary>
    /// Response Unmarshaller for CreateBucket operation
    /// </summary>  
    public class CreateBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("bucket", targetDepth))
                {
                    ...
                    response.Bucket = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateBucketResponseUnmarshaller _instance = new CreateBucketResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
