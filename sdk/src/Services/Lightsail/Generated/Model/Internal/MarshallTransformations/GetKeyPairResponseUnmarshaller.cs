...
{
    /// <summary>
    /// Response Unmarshaller for GetKeyPair operation
    /// </summary>  
    public class GetKeyPairResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKeyPairResponse response = new GetKeyPairResponse();
        ...
        private static GetKeyPairResponseUnmarshaller _instance = new GetKeyPairResponseUnmarshaller();        

        internal static GetKeyPairResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKeyPairResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
