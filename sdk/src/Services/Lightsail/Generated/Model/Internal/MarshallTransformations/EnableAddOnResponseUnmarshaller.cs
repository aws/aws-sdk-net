...
{
    /// <summary>
    /// Response Unmarshaller for EnableAddOn operation
    /// </summary>  
    public class EnableAddOnResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableAddOnResponse response = new EnableAddOnResponse();
        ...
        private static EnableAddOnResponseUnmarshaller _instance = new EnableAddOnResponseUnmarshaller();        

        internal static EnableAddOnResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableAddOnResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
