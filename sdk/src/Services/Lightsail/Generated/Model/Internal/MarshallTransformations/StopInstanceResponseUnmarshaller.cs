...
{
    /// <summary>
    /// Response Unmarshaller for StopInstance operation
    /// </summary>  
    public class StopInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StopInstanceResponseUnmarshaller _instance = new StopInstanceResponseUnmarshaller();        

        internal static StopInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
