...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDomainEntry operation
    /// </summary>  
    public class UpdateDomainEntryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDomainEntryResponse response = new UpdateDomainEntryResponse();
        ...
        private static UpdateDomainEntryResponseUnmarshaller _instance = new UpdateDomainEntryResponseUnmarshaller();        

        internal static UpdateDomainEntryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDomainEntryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
