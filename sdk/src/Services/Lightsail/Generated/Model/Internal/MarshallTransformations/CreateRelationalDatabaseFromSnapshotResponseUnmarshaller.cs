...
{
    /// <summary>
    /// Response Unmarshaller for CreateRelationalDatabaseFromSnapshot operation
    /// </summary>  
    public class CreateRelationalDatabaseFromSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRelationalDatabaseFromSnapshotResponse response = new CreateRelationalDatabaseFromSnapshotResponse();
        ...
        private static CreateRelationalDatabaseFromSnapshotResponseUnmarshaller _instance = new CreateRelationalDatabaseFromSnapshotResponseUnmarshaller();        

        internal static CreateRelationalDatabaseFromSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRelationalDatabaseFromSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
