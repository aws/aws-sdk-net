...
{
    /// <summary>
    /// Response Unmarshaller for GetKeyPairs operation
    /// </summary>  
    public class GetKeyPairsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKeyPairsResponse response = new GetKeyPairsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<KeyPair, KeyPairUnmarshaller>(KeyPairUnmarshaller.Instance);
        ...
        private static GetKeyPairsResponseUnmarshaller _instance = new GetKeyPairsResponseUnmarshaller();        

        internal static GetKeyPairsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKeyPairsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
