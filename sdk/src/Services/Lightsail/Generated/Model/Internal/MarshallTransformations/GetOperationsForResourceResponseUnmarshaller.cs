...
{
    /// <summary>
    /// Response Unmarshaller for GetOperationsForResource operation
    /// </summary>  
    public class GetOperationsForResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOperationsForResourceResponse response = new GetOperationsForResourceResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("nextPageCount", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.NextPageCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetOperationsForResourceResponseUnmarshaller _instance = new GetOperationsForResourceResponseUnmarshaller();        

        internal static GetOperationsForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOperationsForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
