...
{
    /// <summary>
    /// Response Unmarshaller for GetInstance operation
    /// </summary>  
    public class GetInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetInstanceResponseUnmarshaller _instance = new GetInstanceResponseUnmarshaller();        

        internal static GetInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
