...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDistributionBundle operation
    /// </summary>  
    public class UpdateDistributionBundleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDistributionBundleResponse response = new UpdateDistributionBundleResponse();
        ...
        private static UpdateDistributionBundleResponseUnmarshaller _instance = new UpdateDistributionBundleResponseUnmarshaller();        

        internal static UpdateDistributionBundleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDistributionBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
