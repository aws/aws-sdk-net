...
{
    /// <summary>
    /// Response Unmarshaller for SetupInstanceHttps operation
    /// </summary>  
    public class SetupInstanceHttpsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetupInstanceHttpsResponse response = new SetupInstanceHttpsResponse();
        ...
        private static SetupInstanceHttpsResponseUnmarshaller _instance = new SetupInstanceHttpsResponseUnmarshaller();        

        internal static SetupInstanceHttpsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetupInstanceHttpsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
