...
{
    /// <summary>
    /// Response Unmarshaller for UpdateInstanceMetadataOptions operation
    /// </summary>  
    public class UpdateInstanceMetadataOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateInstanceMetadataOptionsResponse response = new UpdateInstanceMetadataOptionsResponse();
        ...
        private static UpdateInstanceMetadataOptionsResponseUnmarshaller _instance = new UpdateInstanceMetadataOptionsResponseUnmarshaller();        

        internal static UpdateInstanceMetadataOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInstanceMetadataOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
