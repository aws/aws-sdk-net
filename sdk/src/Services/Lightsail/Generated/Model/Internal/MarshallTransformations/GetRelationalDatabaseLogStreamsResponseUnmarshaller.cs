...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseLogStreams operation
    /// </summary>  
    public class GetRelationalDatabaseLogStreamsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseLogStreamsResponse response = new GetRelationalDatabaseLogStreamsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("logStreams", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.LogStreams = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabaseLogStreamsResponseUnmarshaller _instance = new GetRelationalDatabaseLogStreamsResponseUnmarshaller();        

        internal static GetRelationalDatabaseLogStreamsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseLogStreamsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
