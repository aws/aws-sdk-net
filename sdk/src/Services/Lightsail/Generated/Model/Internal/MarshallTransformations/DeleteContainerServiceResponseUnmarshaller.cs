...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContainerService operation
    /// </summary>  
    public class DeleteContainerServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContainerServiceResponse response = new DeleteContainerServiceResponse();
        ...
        private static DeleteContainerServiceResponseUnmarshaller _instance = new DeleteContainerServiceResponseUnmarshaller();        

        internal static DeleteContainerServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContainerServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
