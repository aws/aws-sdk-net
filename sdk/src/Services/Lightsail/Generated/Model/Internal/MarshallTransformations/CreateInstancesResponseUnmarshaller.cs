...
{
    /// <summary>
    /// Response Unmarshaller for CreateInstances operation
    /// </summary>  
    public class CreateInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateInstancesResponseUnmarshaller _instance = new CreateInstancesResponseUnmarshaller();        

        internal static CreateInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
