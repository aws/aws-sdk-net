...
{
    /// <summary>
    /// Response Unmarshaller for CreateBucketAccessKey operation
    /// </summary>  
    public class CreateBucketAccessKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBucketAccessKeyResponse response = new CreateBucketAccessKeyResponse();
        ...
        private static CreateBucketAccessKeyResponseUnmarshaller _instance = new CreateBucketAccessKeyResponseUnmarshaller();        

        internal static CreateBucketAccessKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBucketAccessKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
