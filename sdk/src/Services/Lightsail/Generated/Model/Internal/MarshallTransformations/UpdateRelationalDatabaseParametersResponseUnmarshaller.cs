...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRelationalDatabaseParameters operation
    /// </summary>  
    public class UpdateRelationalDatabaseParametersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRelationalDatabaseParametersResponse response = new UpdateRelationalDatabaseParametersResponse();
        ...
        private static UpdateRelationalDatabaseParametersResponseUnmarshaller _instance = new UpdateRelationalDatabaseParametersResponseUnmarshaller();        

        internal static UpdateRelationalDatabaseParametersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRelationalDatabaseParametersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
