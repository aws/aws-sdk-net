...
{
    /// <summary>
    /// Response Unmarshaller for CreateCloudFormationStack operation
    /// </summary>  
    public class CreateCloudFormationStackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCloudFormationStackResponse response = new CreateCloudFormationStackResponse();
        ...
        private static CreateCloudFormationStackResponseUnmarshaller _instance = new CreateCloudFormationStackResponseUnmarshaller();        

        internal static CreateCloudFormationStackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCloudFormationStackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
