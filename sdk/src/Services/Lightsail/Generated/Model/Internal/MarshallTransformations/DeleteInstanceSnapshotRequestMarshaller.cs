...
{
    /// <summary>
    /// DeleteInstanceSnapshot Request Marshaller
    /// </summary>       
    public class DeleteInstanceSnapshotRequestMarshaller : IMarshaller<IRequest, DeleteInstanceSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteInstanceSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteInstanceSnapshotRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.DeleteInstanceSnapshot";
