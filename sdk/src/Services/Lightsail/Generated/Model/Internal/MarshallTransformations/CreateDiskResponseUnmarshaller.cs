...
{
    /// <summary>
    /// Response Unmarshaller for CreateDisk operation
    /// </summary>  
    public class CreateDiskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateDiskResponseUnmarshaller _instance = new CreateDiskResponseUnmarshaller();        

        internal static CreateDiskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDiskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
