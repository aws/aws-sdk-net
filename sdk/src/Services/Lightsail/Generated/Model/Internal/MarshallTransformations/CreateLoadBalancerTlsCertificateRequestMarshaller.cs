...
{
    /// <summary>
    /// CreateLoadBalancerTlsCertificate Request Marshaller
    /// </summary>       
    public class CreateLoadBalancerTlsCertificateRequestMarshaller : IMarshaller<IRequest, CreateLoadBalancerTlsCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLoadBalancerTlsCertificateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLoadBalancerTlsCertificateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.CreateLoadBalancerTlsCertificate";
