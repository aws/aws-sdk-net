...
{
    /// <summary>
    /// Response Unmarshaller for GetBuckets operation
    /// </summary>  
    public class GetBucketsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBucketsResponse response = new GetBucketsResponse();
            ...
            {
                if (context.TestExpression("accountLevelBpaSync", targetDepth, ref reader))
                {
                    var unmarshaller = AccountLevelBpaSyncUnmarshaller.Instance;
                    response.AccountLevelBpaSync = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("buckets", targetDepth, ref reader))
                {
                    ...
                    response.Buckets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetBucketsResponseUnmarshaller _instance = new GetBucketsResponseUnmarshaller();        

        internal static GetBucketsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
