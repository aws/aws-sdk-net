...
{
    /// <summary>
    /// Response Unmarshaller for GetBucketMetricData operation
    /// </summary>  
    public class GetBucketMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBucketMetricDataResponse response = new GetBucketMetricDataResponse();
        ...
        private static GetBucketMetricDataResponseUnmarshaller _instance = new GetBucketMetricDataResponseUnmarshaller();        

        internal static GetBucketMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
