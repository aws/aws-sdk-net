...
{
    /// <summary>
    /// Response Unmarshaller for GetProfile operation
    /// </summary>  
    public class GetProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = PartnerInfoUnmarshaller.Instance;
                    response.Partner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("profileType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProfileType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetProfileResponseUnmarshaller _instance = new GetProfileResponseUnmarshaller();        

        internal static GetProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
