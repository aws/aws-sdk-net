...
{
    /// <summary>
    /// GetRelationalDatabaseMetricData Request Marshaller
    /// </summary>       
    public class GetRelationalDatabaseMetricDataRequestMarshaller : IMarshaller<IRequest, GetRelationalDatabaseMetricDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRelationalDatabaseMetricDataRequest)input);
        }
        ...
        private static GetRelationalDatabaseMetricDataRequestMarshaller _instance = new GetRelationalDatabaseMetricDataRequestMarshaller();        

        internal static GetRelationalDatabaseMetricDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseMetricDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
