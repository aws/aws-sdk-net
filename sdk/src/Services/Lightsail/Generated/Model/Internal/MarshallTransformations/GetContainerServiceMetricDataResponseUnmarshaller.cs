...
{
    /// <summary>
    /// Response Unmarshaller for GetContainerServiceMetricData operation
    /// </summary>  
    public class GetContainerServiceMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerServiceMetricDataResponse response = new GetContainerServiceMetricDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("metricData", targetDepth))
                {
                    ...
                    response.MetricData = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetContainerServiceMetricDataResponseUnmarshaller _instance = new GetContainerServiceMetricDataResponseUnmarshaller();        

        internal static GetContainerServiceMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerServiceMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
