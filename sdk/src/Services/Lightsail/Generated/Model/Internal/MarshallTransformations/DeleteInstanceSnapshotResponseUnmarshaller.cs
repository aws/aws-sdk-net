...
{
    /// <summary>
    /// Response Unmarshaller for DeleteInstanceSnapshot operation
    /// </summary>  
    public class DeleteInstanceSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInstanceSnapshotResponse response = new DeleteInstanceSnapshotResponse();
        ...
        private static DeleteInstanceSnapshotResponseUnmarshaller _instance = new DeleteInstanceSnapshotResponseUnmarshaller();        

        internal static DeleteInstanceSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInstanceSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
