...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    public class AutoSnapshotAddOnRequestMarshaller : IRequestMarshaller<AutoSnapshotAddOnRequest, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AutoSnapshotAddOnRequest requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetSnapshotTimeOfDay())
            {
                context.Writer.WritePropertyName("snapshotTimeOfDay");
                context.Writer.WriteStringValue(requestObject.SnapshotTimeOfDay);
            }
