...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RelationalDatabaseEventUnmarshaller : IJsonUnmarshaller<RelationalDatabaseEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RelationalDatabaseEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("eventCategories", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.EventCategories = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
