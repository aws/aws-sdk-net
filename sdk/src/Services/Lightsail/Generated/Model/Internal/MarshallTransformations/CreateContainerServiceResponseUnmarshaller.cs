...
{
    /// <summary>
    /// Response Unmarshaller for CreateContainerService operation
    /// </summary>  
    public class CreateContainerServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContainerServiceResponse response = new CreateContainerServiceResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("containerService", targetDepth, ref reader))
                {
                    var unmarshaller = ContainerServiceUnmarshaller.Instance;
                    response.ContainerService = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateContainerServiceResponseUnmarshaller _instance = new CreateContainerServiceResponseUnmarshaller();        

        internal static CreateContainerServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContainerServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
