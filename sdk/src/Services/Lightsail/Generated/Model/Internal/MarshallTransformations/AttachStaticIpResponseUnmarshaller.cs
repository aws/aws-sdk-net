...
{
    /// <summary>
    /// Response Unmarshaller for AttachStaticIp operation
    /// </summary>  
    public class AttachStaticIpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachStaticIpResponse response = new AttachStaticIpResponse();
        ...
        private static AttachStaticIpResponseUnmarshaller _instance = new AttachStaticIpResponseUnmarshaller();        

        internal static AttachStaticIpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachStaticIpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
