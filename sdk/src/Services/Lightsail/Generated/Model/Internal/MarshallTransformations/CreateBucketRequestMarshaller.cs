...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateBucketRequestMarshaller : IMarshaller<IRequest, CreateBucketRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateBucketRequest publicRequest)
        {
            ...
            string target = "Lightsail_20161128.CreateBucket";
            ...
            if(publicRequest.IsSetEnableObjectVersioning())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.EnableObjectVersioning.Value);
            }
