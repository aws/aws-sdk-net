...
{
    /// <summary>
    /// Response Unmarshaller for UnpeerVpc operation
    /// </summary>  
    public class UnpeerVpcResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UnpeerVpcResponse response = new UnpeerVpcResponse();
        ...
        private static UnpeerVpcResponseUnmarshaller _instance = new UnpeerVpcResponseUnmarshaller();        

        internal static UnpeerVpcResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnpeerVpcResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
