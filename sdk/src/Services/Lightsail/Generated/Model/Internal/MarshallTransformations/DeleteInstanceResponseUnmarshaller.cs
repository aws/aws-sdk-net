...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteInstanceResponseUnmarshaller _instance = new DeleteInstanceResponseUnmarshaller();        

        internal static DeleteInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
