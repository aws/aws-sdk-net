...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBucketBundle operation
    /// </summary>  
    public class UpdateBucketBundleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBucketBundleResponse response = new UpdateBucketBundleResponse();
        ...
        private static UpdateBucketBundleResponseUnmarshaller _instance = new UpdateBucketBundleResponseUnmarshaller();        

        internal static UpdateBucketBundleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBucketBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
