...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseMasterUserPassword operation
    /// </summary>  
    public class GetRelationalDatabaseMasterUserPasswordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseMasterUserPasswordResponse response = new GetRelationalDatabaseMasterUserPasswordResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("masterUserPassword", targetDepth))
                {
                    ...
                    response.MasterUserPassword = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabaseMasterUserPasswordResponseUnmarshaller _instance = new GetRelationalDatabaseMasterUserPasswordResponseUnmarshaller();        

        internal static GetRelationalDatabaseMasterUserPasswordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseMasterUserPasswordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
