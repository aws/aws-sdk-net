...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDomainEntry operation
    /// </summary>  
    public class DeleteDomainEntryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDomainEntryResponse response = new DeleteDomainEntryResponse();
        ...
        private static DeleteDomainEntryResponseUnmarshaller _instance = new DeleteDomainEntryResponseUnmarshaller();        

        internal static DeleteDomainEntryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDomainEntryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
