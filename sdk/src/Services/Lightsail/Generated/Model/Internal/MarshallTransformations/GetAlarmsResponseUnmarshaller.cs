...
{
    /// <summary>
    /// Response Unmarshaller for GetAlarms operation
    /// </summary>  
    public class GetAlarmsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAlarmsResponseUnmarshaller _instance = new GetAlarmsResponseUnmarshaller();        

        internal static GetAlarmsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAlarmsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
