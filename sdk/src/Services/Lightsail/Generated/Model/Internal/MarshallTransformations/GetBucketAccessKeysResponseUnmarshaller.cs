...
{
    /// <summary>
    /// Response Unmarshaller for GetBucketAccessKeys operation
    /// </summary>  
    public class GetBucketAccessKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBucketAccessKeysResponse response = new GetBucketAccessKeysResponse();
            ...
            {
                if (context.TestExpression("accessKeys", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AccessKey, AccessKeyUnmarshaller>(AccessKeyUnmarshaller.Instance);
                    response.AccessKeys = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetBucketAccessKeysResponseUnmarshaller _instance = new GetBucketAccessKeysResponseUnmarshaller();        

        internal static GetBucketAccessKeysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketAccessKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
