    ...
    public class GetBucketAccessKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AccessKey, AccessKeyUnmarshaller>(AccessKeyUnmarshaller.Instance);
                    response.AccessKeys = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
