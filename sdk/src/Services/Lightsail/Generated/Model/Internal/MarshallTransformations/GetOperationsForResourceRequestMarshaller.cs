...
{
    /// <summary>
    /// GetOperationsForResource Request Marshaller
    /// </summary>       
    public class GetOperationsForResourceRequestMarshaller : IMarshaller<IRequest, GetOperationsForResourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetOperationsForResourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetOperationsForResourceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.GetOperationsForResource";
