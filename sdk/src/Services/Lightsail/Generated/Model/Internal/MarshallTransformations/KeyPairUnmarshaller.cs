...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KeyPairUnmarshaller : IJsonUnmarshaller<KeyPair, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KeyPair Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("fingerprint", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
