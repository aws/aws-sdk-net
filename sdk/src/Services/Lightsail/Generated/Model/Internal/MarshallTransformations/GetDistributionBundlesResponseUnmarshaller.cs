...
{
    /// <summary>
    /// Response Unmarshaller for GetDistributionBundles operation
    /// </summary>  
    public class GetDistributionBundlesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDistributionBundlesResponse response = new GetDistributionBundlesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DistributionBundle, DistributionBundleUnmarshaller>(DistributionBundleUnmarshaller.Instance);
        ...
        private static GetDistributionBundlesResponseUnmarshaller _instance = new GetDistributionBundlesResponseUnmarshaller();        

        internal static GetDistributionBundlesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionBundlesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
