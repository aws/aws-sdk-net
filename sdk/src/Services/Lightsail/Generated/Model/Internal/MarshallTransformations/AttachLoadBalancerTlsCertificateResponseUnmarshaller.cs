...
{
    /// <summary>
    /// Response Unmarshaller for AttachLoadBalancerTlsCertificate operation
    /// </summary>  
    public class AttachLoadBalancerTlsCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachLoadBalancerTlsCertificateResponse response = new AttachLoadBalancerTlsCertificateResponse();
        ...
        private static AttachLoadBalancerTlsCertificateResponseUnmarshaller _instance = new AttachLoadBalancerTlsCertificateResponseUnmarshaller();        

        internal static AttachLoadBalancerTlsCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachLoadBalancerTlsCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
