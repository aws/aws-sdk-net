...
{
    /// <summary>
    /// Response Unmarshaller for GetLoadBalancerTlsPolicies operation
    /// </summary>  
    public class GetLoadBalancerTlsPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLoadBalancerTlsPoliciesResponse response = new GetLoadBalancerTlsPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("tlsPolicies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LoadBalancerTlsPolicy, LoadBalancerTlsPolicyUnmarshaller>(LoadBalancerTlsPolicyUnmarshaller.Instance);
                    response.TlsPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return AccountSetupInProgressExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetLoadBalancerTlsPoliciesResponseUnmarshaller _instance = new GetLoadBalancerTlsPoliciesResponseUnmarshaller();        

        internal static GetLoadBalancerTlsPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoadBalancerTlsPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
