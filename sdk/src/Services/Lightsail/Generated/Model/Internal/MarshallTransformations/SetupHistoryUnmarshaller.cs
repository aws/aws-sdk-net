...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetupHistoryUnmarshaller : IUnmarshaller<SetupHistory, XmlUnmarshallerContext>, IUnmarshaller<SetupHistory, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SetupHistory IUnmarshaller<SetupHistory, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SetupHistory Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SetupExecutionDetails, SetupExecutionDetailsUnmarshaller>(SetupExecutionDetailsUnmarshaller.Instance);
