...
{
    /// <summary>
    /// Response Unmarshaller for GetDistributionLatestCacheReset operation
    /// </summary>  
    public class GetDistributionLatestCacheResetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDistributionLatestCacheResetResponse response = new GetDistributionLatestCacheResetResponse();
        ...
        private static GetDistributionLatestCacheResetResponseUnmarshaller _instance = new GetDistributionLatestCacheResetResponseUnmarshaller();        

        internal static GetDistributionLatestCacheResetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionLatestCacheResetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
