...
{
    /// <summary>
    /// Response Unmarshaller for GetInstanceSnapshots operation
    /// </summary>  
    public class GetInstanceSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInstanceSnapshotsResponse response = new GetInstanceSnapshotsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("instanceSnapshots", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<InstanceSnapshot, InstanceSnapshotUnmarshaller>(InstanceSnapshotUnmarshaller.Instance);
                    response.InstanceSnapshots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetInstanceSnapshotsResponseUnmarshaller _instance = new GetInstanceSnapshotsResponseUnmarshaller();        

        internal static GetInstanceSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstanceSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
