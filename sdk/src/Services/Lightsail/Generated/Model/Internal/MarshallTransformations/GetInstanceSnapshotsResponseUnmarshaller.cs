    ...
    public class GetInstanceSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InstanceSnapshot, InstanceSnapshotUnmarshaller>(InstanceSnapshotUnmarshaller.Instance);
                    response.InstanceSnapshots = unmarshaller.Unmarshall(context);
                    continue;
                }
