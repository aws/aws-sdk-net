...
{
    /// <summary>
    /// Response Unmarshaller for SetIpAddressType operation
    /// </summary>  
    public class SetIpAddressTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetIpAddressTypeResponse response = new SetIpAddressTypeResponse();
        ...
        private static SetIpAddressTypeResponseUnmarshaller _instance = new SetIpAddressTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetIpAddressTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
