...
{
    /// <summary>
    /// CreateContainerService Request Marshaller
    /// </summary>       
    public class CreateContainerServiceRequestMarshaller : IMarshaller<IRequest, CreateContainerServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateContainerServiceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateContainerServiceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.CreateContainerService";
        ...
        private static CreateContainerServiceRequestMarshaller _instance = new CreateContainerServiceRequestMarshaller();        

        internal static CreateContainerServiceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContainerServiceRequestMarshaller Instance
        {
            get
            {
                return _instance;
