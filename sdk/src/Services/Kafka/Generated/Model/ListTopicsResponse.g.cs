...
namespace Amazon.Kafka.Model
{
    ...
    public partial class ListTopicsResponse : AmazonWebServiceResponse
    {
        ...
        /// the call returns NextToken in the response. To get another batch of configurations,
        ...
        /// </summary>
        public List<TopicInfo> Topics { get; set; } = AWSConfigs.InitializeCollections ? new List<TopicInfo>() : null;
