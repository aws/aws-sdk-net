...
namespace Amazon.Kafka.Model
{
    ...
    public partial class ListNodesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<NodeInfo> NodeInfoList { get; set; } = AWSConfigs.InitializeCollections ? new List<NodeInfo>() : null;

        /// <summary>
        /// Checks to see if the NodeInfoList property is set.
        /// </summary>
        internal bool IsSetNodeInfoList() => this.NodeInfoList != null && (this.NodeInfoList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
