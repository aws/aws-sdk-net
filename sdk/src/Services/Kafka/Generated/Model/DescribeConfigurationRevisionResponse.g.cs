...
namespace Amazon.Kafka.Model
{
    ...
    public partial class DescribeConfigurationRevisionResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public MemoryStream ServerProperties { get; set; }

        /// <summary>
        /// Checks to see if the ServerProperties property is set.
        /// </summary>
        internal bool IsSetServerProperties() => this.ServerProperties != null;
    }
}
