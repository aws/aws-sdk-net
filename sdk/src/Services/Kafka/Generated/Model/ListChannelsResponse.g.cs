...
namespace Amazon.Kafka.Model
{
    ...
    public partial class ListChannelsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ChannelInfo> Channels { get; set; } = AWSConfigs.InitializeCollections ? new List<ChannelInfo>() : null;
        ...
        /// <para>
        /// If the response from ListChannels is truncated, this token is included. Send it as
        /// the nextToken parameter on a subsequent ListChannels call to retrieve the next page.
        /// </para>
        /// </summary>
