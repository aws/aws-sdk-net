...
{
    /// <summary>
    /// Container for the parameters to the ListClustersV2 operation. Returns a list of all
    ...
    public partial class ListClustersV2Request : AmazonKafkaRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ClusterTypeFilter property is set.
        /// </summary>
        internal bool IsSetClusterTypeFilter() => this.ClusterTypeFilter != null;
