...
namespace Amazon.Kafka.Model
{
    ...
    public partial class DescribeTopicPartitionsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<TopicPartitionInfo> Partitions { get; set; } = AWSConfigs.InitializeCollections ? new List<TopicPartitionInfo>() : null;

        /// <summary>
        /// Checks to see if the Partitions property is set.
        /// </summary>
        internal bool IsSetPartitions() => this.Partitions != null && (this.Partitions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
