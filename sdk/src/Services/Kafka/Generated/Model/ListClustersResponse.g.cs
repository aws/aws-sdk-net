...
namespace Amazon.Kafka.Model
{
    ...
    public partial class ListClustersResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ClusterInfo> ClusterInfoList { get; set; } = AWSConfigs.InitializeCollections ? new List<ClusterInfo>() : null;

        /// <summary>
        /// Checks to see if the ClusterInfoList property is set.
        /// </summary>
        internal bool IsSetClusterInfoList() => this.ClusterInfoList != null && (this.ClusterInfoList.Count > 0 || !AWSConfigs.InitializeCollections);
