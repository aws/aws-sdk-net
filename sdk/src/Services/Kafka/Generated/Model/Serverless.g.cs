...
namespace Amazon.Kafka.Model
{
    ...
    public partial class Serverless
    {
        ...
        /// </para>
        /// </summary>
        public ServerlessConnectivityInfo ConnectivityInfo { get; set; }
        ...
        public List<VpcConfig> VpcConfigs { get; set; } = AWSConfigs.InitializeCollections ? new List<VpcConfig>() : null;

        /// <summary>
        /// Checks to see if the VpcConfigs property is set.
        /// </summary>
        internal bool IsSetVpcConfigs() => this.VpcConfigs != null && (this.VpcConfigs.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
