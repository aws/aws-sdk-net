...
{
    /// <summary>
    /// Container for the parameters to the UpdateClusterConfiguration operation. Updates
    /// the cluster with the configuration that is specified in the request body.
    /// </summary>
