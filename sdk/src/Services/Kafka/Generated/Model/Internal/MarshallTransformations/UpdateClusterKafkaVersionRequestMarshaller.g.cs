...
{
    /// <summary>
    /// UpdateClusterKafkaVersion Request Marshaller
    /// </summary>
    public partial class UpdateClusterKafkaVersionRequestMarshaller : IMarshaller<IRequest, UpdateClusterKafkaVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateClusterKafkaVersionRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateClusterKafkaVersionRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetTargetKafkaVersion())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TargetKafkaVersion);
            }
        ...
        private static readonly UpdateClusterKafkaVersionRequestMarshaller _instance = new();

        internal static UpdateClusterKafkaVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateClusterKafkaVersionRequestMarshaller Instance => _instance;
    }
}
