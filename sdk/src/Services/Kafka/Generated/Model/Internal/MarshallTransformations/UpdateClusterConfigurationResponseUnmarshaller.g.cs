...
{
    /// <summary>
    /// Response Unmarshaller for UpdateClusterConfiguration operation.
    /// </summary>
    public partial class UpdateClusterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateClusterConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ClusterOperationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateClusterConfigurationResponseUnmarshaller _instance = new UpdateClusterConfigurationResponseUnmarshaller();

        internal static UpdateClusterConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateClusterConfigurationResponseUnmarshaller Instance => _instance;
    }
}
