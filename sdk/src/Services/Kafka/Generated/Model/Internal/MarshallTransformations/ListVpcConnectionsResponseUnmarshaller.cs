...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVpcConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVpcConnectionsResponse response = new ListVpcConnectionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("vpcConnections", targetDepth))
                {
                    ...
                    response.VpcConnections = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVpcConnectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
