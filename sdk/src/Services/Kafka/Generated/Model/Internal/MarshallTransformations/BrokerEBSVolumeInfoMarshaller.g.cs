...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BrokerEBSVolumeInfoMarshaller : IRequestMarshaller<BrokerEBSVolumeInfo, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(BrokerEBSVolumeInfo requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetKafkaBrokerNodeId())
            {
                ...
                context.Writer.WriteStringValue(requestObject.KafkaBrokerNodeId);
            }
            ...
            if (requestObject.IsSetVolumeSizeGB())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.VolumeSizeGB.Value);
            }
        }
