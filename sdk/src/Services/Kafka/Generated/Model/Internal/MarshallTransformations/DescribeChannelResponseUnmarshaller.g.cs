...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeChannelResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("icebergDestinationConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IcebergDestinationConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("topicConfigurationList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TopicConfigurationList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeChannelResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelResponseUnmarshaller Instance => _instance;
    }
}
