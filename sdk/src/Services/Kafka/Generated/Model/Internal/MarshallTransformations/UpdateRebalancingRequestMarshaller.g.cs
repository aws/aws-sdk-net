...
{
    /// <summary>
    /// UpdateRebalancing Request Marshaller
    /// </summary>
    public partial class UpdateRebalancingRequestMarshaller : IMarshaller<IRequest, UpdateRebalancingRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRebalancingRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateRebalancingRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/clusters/{ClusterArn}/rebalancing";
#if !NETFRAMEWORK
        ...
        private static readonly UpdateRebalancingRequestMarshaller _instance = new();

        internal static UpdateRebalancingRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRebalancingRequestMarshaller Instance => _instance;
    }
}
