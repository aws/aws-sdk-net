...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetCompatibleKafkaVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetCompatibleKafkaVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("compatibleKafkaVersions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.CompatibleKafkaVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetCompatibleKafkaVersionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetCompatibleKafkaVersionsResponseUnmarshaller Instance => _instance;
    }
}
