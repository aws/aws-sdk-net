...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReplicatorSummaryUnmarshaller : IJsonUnmarshaller<ReplicatorSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ReplicatorSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ReplicatorSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReplicatorSummaryUnmarshaller Instance => _instance;
    }
}
