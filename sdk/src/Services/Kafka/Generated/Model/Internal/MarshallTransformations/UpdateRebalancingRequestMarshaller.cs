...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateRebalancingRequestMarshaller : IMarshaller<IRequest, UpdateRebalancingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateRebalancingRequestMarshaller _instance = new UpdateRebalancingRequestMarshaller();        

        internal static UpdateRebalancingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRebalancingRequestMarshaller Instance
        {
            get
            {
                return _instance;
