...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChannelLoggingInfoUnmarshaller : IJsonUnmarshaller<ChannelLoggingInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ChannelLoggingInfo unmarshalledObject = new ChannelLoggingInfo();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChannelLoggingInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
