...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterOperation operation
    /// </summary>  
    public class DescribeClusterOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClusterOperationResponse response = new DescribeClusterOperationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("clusterOperationInfo", targetDepth))
                {
                    ...
                    response.ClusterOperationInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeClusterOperationResponseUnmarshaller _instance = new DescribeClusterOperationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClusterOperationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
