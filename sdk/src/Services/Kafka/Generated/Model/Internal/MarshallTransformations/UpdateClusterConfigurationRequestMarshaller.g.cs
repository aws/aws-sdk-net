...
{
    /// <summary>
    /// UpdateClusterConfiguration Request Marshaller
    /// </summary>
    public partial class UpdateClusterConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateClusterConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateClusterConfigurationRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateClusterConfigurationRequest publicRequest)
        {
        ...
        private static readonly UpdateClusterConfigurationRequestMarshaller _instance = new();

        internal static UpdateClusterConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateClusterConfigurationRequestMarshaller Instance => _instance;
    }
}
