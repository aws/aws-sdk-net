...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteChannelRequestMarshaller : IMarshaller<IRequest, DeleteChannelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteChannelRequest publicRequest)
        {
            ...
            {
                throw new AmazonKafkaException("Request object does not have required field ChannelArn set");
            }
            ...
            request.ResourcePath = "/v1/clusters/{ClusterArn}/channels/{ChannelArn}";

            return request;
        }

        private static readonly DeleteChannelRequestMarshaller _instance = new();

        internal static DeleteChannelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteChannelRequestMarshaller Instance => _instance;
    }
}
