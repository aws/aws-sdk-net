...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateRebalancingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRebalancingResponse response = new UpdateRebalancingResponse();
        ...
        internal static UpdateRebalancingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRebalancingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
