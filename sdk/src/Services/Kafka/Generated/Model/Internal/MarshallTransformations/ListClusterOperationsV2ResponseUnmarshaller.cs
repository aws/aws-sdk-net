...
{
    /// <summary>
    /// Response Unmarshaller for ListClusterOperationsV2 operation
    /// </summary>  
    public class ListClusterOperationsV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListClusterOperationsV2Response response = new ListClusterOperationsV2Response();
            ...
            {
                if (context.TestExpression("clusterOperationInfoList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ClusterOperationV2Summary, ClusterOperationV2SummaryUnmarshaller>(ClusterOperationV2SummaryUnmarshaller.Instance);
                    response.ClusterOperationInfoList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListClusterOperationsV2ResponseUnmarshaller _instance = new ListClusterOperationsV2ResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClusterOperationsV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
