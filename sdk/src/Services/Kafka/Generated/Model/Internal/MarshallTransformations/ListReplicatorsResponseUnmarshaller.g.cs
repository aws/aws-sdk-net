...
{
    /// <summary>
    /// Response Unmarshaller for ListReplicators operation.
    /// </summary>
    public partial class ListReplicatorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListReplicatorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("replicators", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ReplicatorSummary, ReplicatorSummaryUnmarshaller>(ReplicatorSummaryUnmarshaller.Instance);
                    unmarshalledObject.Replicators = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListReplicatorsResponseUnmarshaller _instance = new ListReplicatorsResponseUnmarshaller();

        internal static ListReplicatorsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListReplicatorsResponseUnmarshaller Instance => _instance;
    }
}
