...
{
    /// <summary>
    /// Response Unmarshaller for ChannelLoggingInfo Object
    /// </summary>
    public partial class ChannelLoggingInfoUnmarshaller : IJsonUnmarshaller<ChannelLoggingInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ChannelLoggingInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ChannelLoggingInfo();
        ...
        private static ChannelLoggingInfoUnmarshaller _instance = new ChannelLoggingInfoUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ChannelLoggingInfoUnmarshaller Instance => _instance;
    }
}
