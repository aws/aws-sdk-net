...
{
    /// <summary>
    /// Response Unmarshaller for DescribeVpcConnection operation.
    /// </summary>
    public partial class DescribeVpcConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeVpcConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("targetClusterArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TargetClusterArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("vpcConnectionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VpcConnectionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeVpcConnectionResponseUnmarshaller _instance = new DescribeVpcConnectionResponseUnmarshaller();

        internal static DescribeVpcConnectionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeVpcConnectionResponseUnmarshaller Instance => _instance;
    }
}
