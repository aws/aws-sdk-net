...
{
    /// <summary>
    /// Response Unmarshaller for BatchAssociateScramSecret operation.
    /// </summary>
    public partial class BatchAssociateScramSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchAssociateScramSecretResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("unprocessedScramSecrets", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.UnprocessedScramSecrets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchAssociateScramSecretResponseUnmarshaller _instance = new BatchAssociateScramSecretResponseUnmarshaller();

        internal static BatchAssociateScramSecretResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchAssociateScramSecretResponseUnmarshaller Instance => _instance;
    }
}
