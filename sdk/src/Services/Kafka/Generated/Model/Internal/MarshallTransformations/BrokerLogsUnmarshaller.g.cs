...
{
    /// <summary>
    /// Response Unmarshaller for BrokerLogs Object
    /// </summary>
    public partial class BrokerLogsUnmarshaller : IJsonUnmarshaller<BrokerLogs, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public BrokerLogs Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new BrokerLogs();
        ...
        private static BrokerLogsUnmarshaller _instance = new BrokerLogsUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BrokerLogsUnmarshaller Instance => _instance;
    }
}
