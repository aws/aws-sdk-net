...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTopicPartitions operation.
    /// </summary>
    public partial class DescribeTopicPartitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeTopicPartitionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TopicPartitionInfo, TopicPartitionInfoUnmarshaller>(TopicPartitionInfoUnmarshaller.Instance);
        ...
        private static DescribeTopicPartitionsResponseUnmarshaller _instance = new DescribeTopicPartitionsResponseUnmarshaller();

        internal static DescribeTopicPartitionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeTopicPartitionsResponseUnmarshaller Instance => _instance;
    }
}
