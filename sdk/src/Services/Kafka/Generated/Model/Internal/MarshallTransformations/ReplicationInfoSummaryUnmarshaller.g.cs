...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReplicationInfoSummaryUnmarshaller : IJsonUnmarshaller<ReplicationInfoSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ReplicationInfoSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ReplicationInfoSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReplicationInfoSummaryUnmarshaller Instance => _instance;
    }
}
