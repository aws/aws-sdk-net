...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    public class CreateTopicRequestMarshaller : IMarshaller<IRequest, CreateTopicRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateTopicRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetConfigs())
            {
                context.Writer.WritePropertyName("configs");
                context.Writer.WriteStringValue(publicRequest.Configs);
            }

            if(publicRequest.IsSetPartitionCount())
            {
                context.Writer.WritePropertyName("partitionCount");
                context.Writer.WriteNumberValue(publicRequest.PartitionCount.Value);
            }
            ...
            if(publicRequest.IsSetTopicName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TopicName);
            }
