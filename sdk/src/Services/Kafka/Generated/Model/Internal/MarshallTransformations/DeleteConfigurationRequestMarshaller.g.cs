...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteConfigurationRequestMarshaller _instance = new();

        internal static DeleteConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteConfigurationRequestMarshaller Instance => _instance;
    }
}
