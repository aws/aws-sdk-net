...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VpcConnectivitySaslUnmarshaller : IJsonUnmarshaller<VpcConnectivitySasl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VpcConnectivitySasl();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("scram", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static VpcConnectivitySaslUnmarshaller Instance => _instance;
    }
}
