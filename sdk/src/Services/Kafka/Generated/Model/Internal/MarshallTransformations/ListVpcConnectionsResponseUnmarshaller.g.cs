...
{
    /// <summary>
    /// Response Unmarshaller for ListVpcConnections operation.
    /// </summary>
    public partial class ListVpcConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListVpcConnectionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VpcConnection, VpcConnectionUnmarshaller>(VpcConnectionUnmarshaller.Instance);
        ...
        private static ListVpcConnectionsResponseUnmarshaller _instance = new ListVpcConnectionsResponseUnmarshaller();

        internal static ListVpcConnectionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListVpcConnectionsResponseUnmarshaller Instance => _instance;
    }
}
