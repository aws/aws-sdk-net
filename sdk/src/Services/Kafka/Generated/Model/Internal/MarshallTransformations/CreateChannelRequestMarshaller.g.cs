...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    public partial class CreateChannelRequestMarshaller : IMarshaller<IRequest, CreateChannelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateChannelRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/clusters/{ClusterArn}/channels";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetLoggingInfo())
            {
                ...
                var marshaller = ChannelLoggingInfoMarshaller.Instance;
            ...
            if (publicRequest.IsSetTopicConfigurationList())
            {
                context.Writer.WritePropertyName("topicConfigurationList");
                context.Writer.WriteStartArray();
                foreach (var publicRequestTopicConfigurationListListValue in publicRequest.TopicConfigurationList)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = TopicConfigurationMarshaller.Instance;
                    marshaller.Marshall(publicRequestTopicConfigurationListListValue, context);
