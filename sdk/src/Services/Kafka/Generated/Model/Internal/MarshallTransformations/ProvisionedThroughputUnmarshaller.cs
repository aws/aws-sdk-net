...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProvisionedThroughputUnmarshaller : IJsonUnmarshaller<ProvisionedThroughput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProvisionedThroughput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("volumeThroughput", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.VolumeThroughput = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
