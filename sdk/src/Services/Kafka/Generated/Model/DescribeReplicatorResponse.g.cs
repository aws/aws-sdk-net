...
namespace Amazon.Kafka.Model
{
    ...
    public partial class DescribeReplicatorResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<KafkaClusterDescription> KafkaClusters { get; set; } = AWSConfigs.InitializeCollections ? new List<KafkaClusterDescription>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ReplicationInfoDescription> ReplicationInfoList { get; set; } = AWSConfigs.InitializeCollections ? new List<ReplicationInfoDescription>() : null;
        ...
        /// </para>
        /// </summary>
        public string ReplicatorDescription { get; set; }

        /// <summary>
        /// Checks to see if the ReplicatorDescription property is set.
        /// </summary>
        internal bool IsSetReplicatorDescription() => this.ReplicatorDescription != null;
        ...
        /// </para>
        /// </summary>
        public ReplicationStateInfo StateInfo { get; set; }
