...
{
    /// <summary>
    /// Container for the parameters to the PutClusterPolicy operation. Creates or updates
    /// the MSK cluster policy specified by the cluster Amazon Resource Name (ARN) in the
    /// request.
    /// </summary>
