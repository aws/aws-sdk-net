...
{
    /// <summary>
    /// Container for the parameters to the UpdateBrokerCount operation. Updates the number
    /// of broker nodes in the cluster.
    /// </summary>
    public partial class UpdateBrokerCountRequest : AmazonKafkaRequest
    {
        ...
        /// <summary>
        /// Checks to see if the TargetNumberOfBrokerNodes property is set.
        /// </summary>
        internal bool IsSetTargetNumberOfBrokerNodes() => this.TargetNumberOfBrokerNodes.HasValue;
    }
}
