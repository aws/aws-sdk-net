...
{
    /// <summary>
    /// Container for the parameters to the UntagResource operation. Removes the tags associated
    /// with the keys that are provided in the query.
    /// </summary>
    public partial class UntagResourceRequest : AmazonKafkaRequest
    {
        ...
        ///  </li> <li> 
        /// <para>
        /// You can't start a tag key with aws: because this prefix is reserved for use by AWS.
