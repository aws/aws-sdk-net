...
namespace Amazon.Kafka.Model
{
    ...
    public partial class ProvisionedThroughput
    {
        ...
        /// </para>
        /// </summary>
        public int? VolumeThroughput { get; set; }

        /// <summary>
        /// Checks to see if the VolumeThroughput property is set.
        /// </summary>
        internal bool IsSetVolumeThroughput() => this.VolumeThroughput.HasValue;
    }
}
