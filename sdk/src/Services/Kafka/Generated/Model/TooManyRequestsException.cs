...
namespace Amazon.Kafka.Model
{
    ...
    [Serializable]
    #endif
    public partial class TooManyRequestsException : AmazonKafkaException
    {
        ...
        public TooManyRequestsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyRequestsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <summary>
        /// Gets and sets the property InvalidParameter.             
        /// <para>
        ...
        {
            get { return this._invalidParameter; }
            set { this._invalidParameter = value; }
        }

        // Check to see if InvalidParameter property is set
        internal bool IsSetInvalidParameter()
        {
            return this._invalidParameter != null;
        }
