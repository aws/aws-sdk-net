...
namespace Amazon.Kafka.Model
{
    ...
    public partial class TableCreation
    {
        ...
        /// </para>
        /// </summary>
        public bool? EnableTableCreation { get; set; }

        /// <summary>
        /// Checks to see if the EnableTableCreation property is set.
        /// </summary>
        internal bool IsSetEnableTableCreation() => this.EnableTableCreation.HasValue;
    }
}
