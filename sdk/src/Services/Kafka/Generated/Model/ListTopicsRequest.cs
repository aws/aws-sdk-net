...
namespace Amazon.Kafka.Model
{
    ...
    /// </summary>
    public partial class ListTopicsRequest : AmazonKafkaRequest
    {
        ...
        {
            get { return this._topicNameFilter; }
            set { this._topicNameFilter = value; }
        }

        // Check to see if TopicNameFilter property is set
        internal bool IsSetTopicNameFilter()
        {
            return this._topicNameFilter != null;
        }
