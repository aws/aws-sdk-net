...
namespace Amazon.Kafka
{
    ...
    public partial class AmazonKafkaClient : AmazonServiceClient, IAmazonKafka
    {
        ...
        /// 
        /// </summary>
        public AmazonKafkaClient() : base(new AmazonKafkaConfig()) { }
        ...
        public AmazonKafkaClient(RegionEndpoint region) : base(new AmazonKafkaConfig { RegionEndpoint = region }) { }
        ...
        public AmazonKafkaClient(AmazonKafkaConfig config) : base(config) { }
