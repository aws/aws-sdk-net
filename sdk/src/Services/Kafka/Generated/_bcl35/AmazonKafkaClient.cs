...
namespace Amazon.Kafka
{
    ...
    public partial class AmazonKafkaClient : AmazonServiceClient, IAmazonKafka
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/DescribeTopicPartitions">REST API Reference for DescribeTopicPartitions Operation</seealso>
        public virtual IAsyncResult BeginDescribeTopicPartitions(DescribeTopicPartitionsRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = DescribeTopicPartitionsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = DescribeTopicPartitionsResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/DescribeTopicPartitions">REST API Reference for DescribeTopicPartitions Operation</seealso>
        public virtual DescribeTopicPartitionsResponse EndDescribeTopicPartitions(IAsyncResult asyncResult)
        {
            return EndInvoke<DescribeTopicPartitionsResponse>(asyncResult);
        }
