...
namespace Amazon.IoTEvents.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonIoTEventsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTEventsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTEvents.
        /// </summary>
        public AmazonIoTEventsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTEventsAuthSchemeParameters
            {
    ...
    public class AmazonIoTEventsAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTEventsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTEventsAuthSchemeParameters authParameters)
        {
