    ...
    public class LoggingOptionsUnmarshaller : IUnmarshaller<LoggingOptions, XmlUnmarshallerContext>, IUnmarshaller<LoggingOptions, JsonUnmarshallerContext>
    {
        ...
        public LoggingOptions Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DetectorDebugOption, DetectorDebugOptionUnmarshaller>(DetectorDebugOptionUnmarshaller.Instance);
                    unmarshalledObject.DetectorDebugOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
