...
namespace Amazon.IoTEvents.Model.Internal.MarshallTransformations
{
    ...
    public class ActionUnmarshaller : IJsonUnmarshaller<Action, JsonUnmarshallerContext>
    {
        ...
        public Action Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("clearTimer", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("resetTimer", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("setTimer", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("setVariable", targetDepth, ref reader))
                {
