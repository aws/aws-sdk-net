...
{
    /// <summary>
    /// Response Unmarshaller for CreateDetectorModel operation
    /// </summary>  
    public class CreateDetectorModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDetectorModelResponse response = new CreateDetectorModelResponse();
        ...
        private static CreateDetectorModelResponseUnmarshaller _instance = new CreateDetectorModelResponseUnmarshaller();        

        internal static CreateDetectorModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDetectorModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
