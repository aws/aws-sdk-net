...
namespace Amazon.IoTEvents.Model.Internal.MarshallTransformations
{
    ...
    public class AlarmRuleUnmarshaller : IJsonUnmarshaller<AlarmRule, JsonUnmarshallerContext>
    {
        ...
        public AlarmRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("simpleRule", targetDepth, ref reader))
                {
        ...
        private static AlarmRuleUnmarshaller _instance = new AlarmRuleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AlarmRuleUnmarshaller Instance
        {
            get
            {
                return _instance;
