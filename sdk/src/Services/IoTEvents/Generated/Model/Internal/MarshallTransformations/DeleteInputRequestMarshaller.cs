...
{
    /// <summary>
    /// DeleteInput Request Marshaller
    /// </summary>       
    public class DeleteInputRequestMarshaller : IMarshaller<IRequest, DeleteInputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteInputRequest)input);
        }
        ...
        private static DeleteInputRequestMarshaller _instance = new DeleteInputRequestMarshaller();        

        internal static DeleteInputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInputRequestMarshaller Instance
        {
            get
            {
                return _instance;
