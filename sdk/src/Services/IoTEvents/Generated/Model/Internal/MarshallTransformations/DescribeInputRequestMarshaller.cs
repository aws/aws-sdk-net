...
{
    /// <summary>
    /// DescribeInput Request Marshaller
    /// </summary>       
    public class DescribeInputRequestMarshaller : IMarshaller<IRequest, DescribeInputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInputRequest)input);
        }
        ...
        private static DescribeInputRequestMarshaller _instance = new DescribeInputRequestMarshaller();        

        internal static DescribeInputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInputRequestMarshaller Instance
        {
            get
            {
                return _instance;
