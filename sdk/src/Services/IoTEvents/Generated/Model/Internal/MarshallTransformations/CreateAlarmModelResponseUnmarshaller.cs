...
{
    /// <summary>
    /// Response Unmarshaller for CreateAlarmModel operation
    /// </summary>  
    public class CreateAlarmModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAlarmModelResponse response = new CreateAlarmModelResponse();
        ...
        private static CreateAlarmModelResponseUnmarshaller _instance = new CreateAlarmModelResponseUnmarshaller();        

        internal static CreateAlarmModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAlarmModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
