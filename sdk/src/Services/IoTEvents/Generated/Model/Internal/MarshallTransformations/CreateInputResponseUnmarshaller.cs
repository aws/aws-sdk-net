...
{
    /// <summary>
    /// Response Unmarshaller for CreateInput operation
    /// </summary>  
    public class CreateInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInputResponse response = new CreateInputResponse();
        ...
        private static CreateInputResponseUnmarshaller _instance = new CreateInputResponseUnmarshaller();        

        internal static CreateInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
