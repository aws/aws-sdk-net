...
namespace Amazon.IoTEvents
{
    ...
    public partial class AmazonIoTEventsClient : AmazonServiceClient, IAmazonIoTEvents
    {
        ...
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the VerifyResourcesExistForTagris operation on AmazonIoTEventsClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/iotevents-2018-07-27/VerifyResourcesExistForTagris">REST API Reference for VerifyResourcesExistForTagris Operation</seealso>
        public virtual IAsyncResult BeginVerifyResourcesExistForTagris(VerifyResourcesExistForTagrisRequest request, AsyncCallback callback, object state)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = VerifyResourcesExistForTagrisRequestMarshaller.Instance;
            options.ResponseUnmarshaller = VerifyResourcesExistForTagrisResponseUnmarshaller.Instance;
        ...
        /// 
        /// <returns>Returns a  VerifyResourcesExistForTagrisResult from IoTEvents.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/iotevents-2018-07-27/VerifyResourcesExistForTagris">REST API Reference for VerifyResourcesExistForTagris Operation</seealso>
        public virtual VerifyResourcesExistForTagrisResponse EndVerifyResourcesExistForTagris(IAsyncResult asyncResult)
        {
            return EndInvoke<VerifyResourcesExistForTagrisResponse>(asyncResult);
        }
