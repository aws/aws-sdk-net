...
namespace Amazon.GuardDuty
{
    ...
    public partial interface IAmazonGuardDuty : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/GetMalwareScan">REST API Reference for GetMalwareScan Operation</seealso>
        Task<GetMalwareScanResponse> GetMalwareScanAsync(GetMalwareScanRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/ListMalwareScans">REST API Reference for ListMalwareScans Operation</seealso>
        Task<ListMalwareScansResponse> ListMalwareScansAsync(ListMalwareScansRequest request, CancellationToken cancellationToken = default(CancellationToken));
