...
{
    /// <summary>
    /// Response Unmarshaller for InviteMembers operation
    /// </summary>  
    public class InviteMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static InviteMembersResponseUnmarshaller _instance = new InviteMembersResponseUnmarshaller();        

        internal static InviteMembersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InviteMembersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
