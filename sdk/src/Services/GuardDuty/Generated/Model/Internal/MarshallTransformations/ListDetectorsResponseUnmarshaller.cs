...
{
    /// <summary>
    /// Response Unmarshaller for ListDetectors operation
    /// </summary>  
    public class ListDetectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDetectorsResponse response = new ListDetectorsResponse();
            ...
            {
                if (context.TestExpression("detectorIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.DetectorIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDetectorsResponseUnmarshaller _instance = new ListDetectorsResponseUnmarshaller();        

        internal static ListDetectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDetectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
