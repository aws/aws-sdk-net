...
{
    /// <summary>
    /// DetectorFeatureConfiguration Marshaller
    /// </summary>
    public class DetectorFeatureConfigurationMarshaller : IRequestMarshaller<DetectorFeatureConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(DetectorFeatureConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetAdditionalConfiguration())
            {
                ...
                foreach(var requestObjectAdditionalConfigurationListValue in requestObject.AdditionalConfiguration)
                {
                    ...
                    var marshaller = DetectorAdditionalConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static DetectorFeatureConfigurationMarshaller Instance = new DetectorFeatureConfigurationMarshaller();
