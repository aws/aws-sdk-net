...
{
    /// <summary>
    /// ListCoverage Request Marshaller
    /// </summary>       
    public class ListCoverageRequestMarshaller : IMarshaller<IRequest, ListCoverageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCoverageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCoverageRequest publicRequest)
        {
        ...
        private static ListCoverageRequestMarshaller _instance = new ListCoverageRequestMarshaller();        

        internal static ListCoverageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCoverageRequestMarshaller Instance
        {
            get
            {
                return _instance;
