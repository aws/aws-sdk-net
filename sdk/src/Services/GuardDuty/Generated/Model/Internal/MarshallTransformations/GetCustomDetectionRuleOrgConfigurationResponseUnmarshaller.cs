...
{
    /// <summary>
    /// Response Unmarshaller for GetCustomDetectionRuleOrgConfiguration operation
    /// </summary>  
    public class GetCustomDetectionRuleOrgConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCustomDetectionRuleOrgConfigurationResponse response = new GetCustomDetectionRuleOrgConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DetectionRuleOrgConfigurationUnmarshaller.Instance;
        ...
        private static GetCustomDetectionRuleOrgConfigurationResponseUnmarshaller _instance = new GetCustomDetectionRuleOrgConfigurationResponseUnmarshaller();        

        internal static GetCustomDetectionRuleOrgConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCustomDetectionRuleOrgConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
