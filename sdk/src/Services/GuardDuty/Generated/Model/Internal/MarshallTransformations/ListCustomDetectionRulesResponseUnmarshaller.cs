...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomDetectionRules operation
    /// </summary>  
    public class ListCustomDetectionRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomDetectionRulesResponse response = new ListCustomDetectionRulesResponse();
        ...
        private static ListCustomDetectionRulesResponseUnmarshaller _instance = new ListCustomDetectionRulesResponseUnmarshaller();        

        internal static ListCustomDetectionRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomDetectionRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
