        ...
        public AdminAccount Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("adminAccountId", targetDepth))
                {
                    ...
                    unmarshalledObject.AdminAccountId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("adminStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AdminStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
