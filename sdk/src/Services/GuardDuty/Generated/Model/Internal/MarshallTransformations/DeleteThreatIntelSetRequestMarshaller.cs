...
{
    /// <summary>
    /// DeleteThreatIntelSet Request Marshaller
    /// </summary>       
    public class DeleteThreatIntelSetRequestMarshaller : IMarshaller<IRequest, DeleteThreatIntelSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteThreatIntelSetRequest)input);
        }
        ...
        private static DeleteThreatIntelSetRequestMarshaller _instance = new DeleteThreatIntelSetRequestMarshaller();        

        internal static DeleteThreatIntelSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThreatIntelSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
