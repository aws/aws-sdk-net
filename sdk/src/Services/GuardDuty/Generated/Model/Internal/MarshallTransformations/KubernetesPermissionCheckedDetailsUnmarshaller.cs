...
namespace Amazon.GuardDuty.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KubernetesPermissionCheckedDetailsUnmarshaller : IJsonUnmarshaller<KubernetesPermissionCheckedDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KubernetesPermissionCheckedDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("verb", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
