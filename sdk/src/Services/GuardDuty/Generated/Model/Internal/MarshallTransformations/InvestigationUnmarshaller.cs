...
{
    /// <summary>
    /// Response Unmarshaller for Investigation Object
    /// </summary>  
    public class InvestigationUnmarshaller : IJsonUnmarshaller<Investigation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Investigation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Investigation unmarshalledObject = new Investigation();
            ...
            {
                if (context.TestExpression("cloud", targetDepth, ref reader))
                {
                    var unmarshaller = CloudDetailsUnmarshaller.Instance;
                    unmarshalledObject.Cloud = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = InvestigationMetadataUnmarshaller.Instance;
        ...
        private static InvestigationUnmarshaller _instance = new InvestigationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvestigationUnmarshaller Instance
        {
            get
            {
                return _instance;
