...
{
    /// <summary>
    /// Response Unmarshaller for ApiCall Object
    /// </summary>  
    public class ApiCallUnmarshaller : IJsonUnmarshaller<ApiCall, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApiCall Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ApiCall unmarshalledObject = new ApiCall();
        ...
        private static ApiCallUnmarshaller _instance = new ApiCallUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ApiCallUnmarshaller Instance
        {
            get
            {
                return _instance;
