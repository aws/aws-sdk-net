...
{
    /// <summary>
    /// Response Unmarshaller for AssociationDetail Object
    /// </summary>  
    public class AssociationDetailUnmarshaller : IJsonUnmarshaller<AssociationDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssociationDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AssociationDetail unmarshalledObject = new AssociationDetail();
        ...
        private static AssociationDetailUnmarshaller _instance = new AssociationDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssociationDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
