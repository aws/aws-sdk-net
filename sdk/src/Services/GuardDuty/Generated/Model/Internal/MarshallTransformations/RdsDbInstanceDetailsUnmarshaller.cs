...
namespace Amazon.GuardDuty.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RdsDbInstanceDetailsUnmarshaller : IUnmarshaller<RdsDbInstanceDetails, XmlUnmarshallerContext>, IUnmarshaller<RdsDbInstanceDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RdsDbInstanceDetails IUnmarshaller<RdsDbInstanceDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RdsDbInstanceDetails Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
