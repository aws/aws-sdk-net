...
{
    /// <summary>
    /// Response Unmarshaller for CreateInvestigation operation
    /// </summary>  
    public class CreateInvestigationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInvestigationResponse response = new CreateInvestigationResponse();
        ...
        private static CreateInvestigationResponseUnmarshaller _instance = new CreateInvestigationResponseUnmarshaller();        

        internal static CreateInvestigationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInvestigationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
