...
namespace Amazon.GuardDuty.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CoverageEc2InstanceDetailsUnmarshaller : IJsonUnmarshaller<CoverageEc2InstanceDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CoverageEc2InstanceDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("agentDetails", targetDepth, ref reader))
                {
                    var unmarshaller = AgentDetailsUnmarshaller.Instance;
                    unmarshalledObject.AgentDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
