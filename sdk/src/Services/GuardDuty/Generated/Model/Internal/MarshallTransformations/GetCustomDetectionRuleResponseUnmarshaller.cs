...
{
    /// <summary>
    /// Response Unmarshaller for GetCustomDetectionRule operation
    /// </summary>  
    public class GetCustomDetectionRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCustomDetectionRuleResponse response = new GetCustomDetectionRuleResponse();
        ...
        private static GetCustomDetectionRuleResponseUnmarshaller _instance = new GetCustomDetectionRuleResponseUnmarshaller();        

        internal static GetCustomDetectionRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCustomDetectionRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
