...
{
    /// <summary>
    /// Response Unmarshaller for ListFilters operation
    /// </summary>  
    public class ListFiltersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFiltersResponse response = new ListFiltersResponse();
            ...
            {
                if (context.TestExpression("filterNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.FilterNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFiltersResponseUnmarshaller _instance = new ListFiltersResponseUnmarshaller();        

        internal static ListFiltersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFiltersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
