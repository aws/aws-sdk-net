...
{
    /// <summary>
    /// Response Unmarshaller for CreateDetector operation
    /// </summary>  
    public class CreateDetectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDetectorResponse response = new CreateDetectorResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("unprocessedDataSources", targetDepth, ref reader))
                {
                    var unmarshaller = UnprocessedDataSourcesResultUnmarshaller.Instance;
                    response.UnprocessedDataSources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateDetectorResponseUnmarshaller _instance = new CreateDetectorResponseUnmarshaller();        

        internal static CreateDetectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDetectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
