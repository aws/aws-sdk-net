...
namespace Amazon.GuardDuty.Model
{
    ...
    internal sealed partial class ListInvestigationsPaginator : IPaginator<ListInvestigationsResponse>, IListInvestigationsPaginator
    {
        ...
        /// <summary>
        /// Enumerable containing all of the Investigations
        /// </summary>
        public IPaginatedEnumerable<InvestigationSummary> Investigations => 
            new PaginatedResultKeyResponse<ListInvestigationsResponse, InvestigationSummary>(this, (i) => i.Investigations ?? new List<InvestigationSummary>());

        internal ListInvestigationsPaginator(IAmazonGuardDuty client, ListInvestigationsRequest request)
        {
            this._client = client;
