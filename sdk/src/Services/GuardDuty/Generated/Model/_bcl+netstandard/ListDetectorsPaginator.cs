...
{
    /// <summary>
    /// Base class for ListDetectors paginators.
    /// </summary>
    internal sealed partial class ListDetectorsPaginator : IPaginator<ListDetectorsResponse>, IListDetectorsPaginator
    {
        private readonly IAmazonGuardDuty _client;
        private readonly ListDetectorsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListDetectorsResponse> Responses => new PaginatedResponse<ListDetectorsResponse>(this);
...
#if BCL
        IEnumerable<ListDetectorsResponse> IPaginator<ListDetectorsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListDetectors(_request);
        ...
        async IAsyncEnumerable<ListDetectorsResponse> IPaginator<ListDetectorsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListDetectorsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
