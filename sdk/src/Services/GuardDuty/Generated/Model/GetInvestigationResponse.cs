...
namespace Amazon.GuardDuty.Model
{
    ...
    public partial class GetInvestigationResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property Investigation. 
        /// <para>
        ...
        {
            get { return this._investigation; }
            set { this._investigation = value; }
        }

        // Check to see if Investigation property is set
        internal bool IsSetInvestigation()
        {
            return this._investigation != null;
        }
