...
namespace Amazon.GuardDuty.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonGuardDutyAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGuardDutyAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GuardDuty.
        /// </summary>
        public AmazonGuardDutyAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGuardDutyAuthSchemeParameters
            {
    ...
    public class AmazonGuardDutyAuthSchemeResolver : IAuthSchemeResolver<AmazonGuardDutyAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGuardDutyAuthSchemeParameters authParameters)
        {
