...
namespace Amazon.PcaConnectorAd.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonPcaConnectorAdAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPcaConnectorAdAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PcaConnectorAd.
        /// </summary>
        public AmazonPcaConnectorAdAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPcaConnectorAdAuthSchemeParameters
            {
    ...
    public class AmazonPcaConnectorAdAuthSchemeResolver : IAuthSchemeResolver<AmazonPcaConnectorAdAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPcaConnectorAdAuthSchemeParameters authParameters)
        {
