...
namespace Amazon.PcaConnectorAd
{
    ...
    public partial interface IAmazonPcaConnectorAd : IAmazonService, IDisposable
    {
        ...
        Task<CreateDirectoryRegistrationResponse> CreateDirectoryRegistrationAsync(CreateDirectoryRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateServicePrincipalNameResponse> CreateServicePrincipalNameAsync(CreateServicePrincipalNameRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateTemplateGroupAccessControlEntryResponse> CreateTemplateGroupAccessControlEntryAsync(CreateTemplateGroupAccessControlEntryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteDirectoryRegistrationResponse> DeleteDirectoryRegistrationAsync(DeleteDirectoryRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteServicePrincipalNameResponse> DeleteServicePrincipalNameAsync(DeleteServicePrincipalNameRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteTemplateGroupAccessControlEntryResponse> DeleteTemplateGroupAccessControlEntryAsync(DeleteTemplateGroupAccessControlEntryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetConnectorResponse> GetConnectorAsync(GetConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetDirectoryRegistrationResponse> GetDirectoryRegistrationAsync(GetDirectoryRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetServicePrincipalNameResponse> GetServicePrincipalNameAsync(GetServicePrincipalNameRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetTemplateGroupAccessControlEntryResponse> GetTemplateGroupAccessControlEntryAsync(GetTemplateGroupAccessControlEntryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListDirectoryRegistrationsResponse> ListDirectoryRegistrationsAsync(ListDirectoryRegistrationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListServicePrincipalNamesResponse> ListServicePrincipalNamesAsync(ListServicePrincipalNamesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListTemplateGroupAccessControlEntriesResponse> ListTemplateGroupAccessControlEntriesAsync(ListTemplateGroupAccessControlEntriesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateTemplateGroupAccessControlEntryResponse> UpdateTemplateGroupAccessControlEntryAsync(UpdateTemplateGroupAccessControlEntryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPcaConnectorAdConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPcaConnectorAdConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPcaConnectorAdConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPcaConnectorAdConfig to create AmazonPcaConnectorAdClient");
            }

            return awsCredentials == null ? 
                    new AmazonPcaConnectorAdClient(serviceClientConfig) :
                    new AmazonPcaConnectorAdClient(awsCredentials, serviceClientConfig);
        }
