    ...
    public class ConnectorSummaryUnmarshaller : IUnmarshaller<ConnectorSummary, XmlUnmarshallerContext>, IUnmarshaller<ConnectorSummary, JsonUnmarshallerContext>
    {
        ...
        public ConnectorSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CertificateEnrollmentPolicyServerEndpoint = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("VpcInformation", targetDepth))
                {
                    ...
                    unmarshalledObject.VpcInformation = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
