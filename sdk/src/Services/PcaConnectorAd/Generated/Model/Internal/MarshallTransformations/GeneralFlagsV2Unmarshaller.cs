...
namespace Amazon.PcaConnectorAd.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeneralFlagsV2Unmarshaller : IUnmarshaller<GeneralFlagsV2, XmlUnmarshallerContext>, IUnmarshaller<GeneralFlagsV2, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeneralFlagsV2 IUnmarshaller<GeneralFlagsV2, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public GeneralFlagsV2 Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
