...
namespace Amazon.PcaConnectorAd.Model.Internal.MarshallTransformations
{
    ...
    public class KeyUsagePropertyFlagsUnmarshaller : IJsonUnmarshaller<KeyUsagePropertyFlags, JsonUnmarshallerContext>
    {
        ...
        public KeyUsagePropertyFlags Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("Decrypt", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Sign", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
        ...
        private static KeyUsagePropertyFlagsUnmarshaller _instance = new KeyUsagePropertyFlagsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KeyUsagePropertyFlagsUnmarshaller Instance
        {
            get
            {
                return _instance;
