...
namespace Amazon.PcaConnectorAd.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubjectNameFlagsV4Unmarshaller : IUnmarshaller<SubjectNameFlagsV4, XmlUnmarshallerContext>, IUnmarshaller<SubjectNameFlagsV4, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SubjectNameFlagsV4 IUnmarshaller<SubjectNameFlagsV4, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SubjectNameFlagsV4 Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
