...
{
    /// <summary>
    /// Response Unmarshaller for GetPartnership operation
    /// </summary>  
    public class GetPartnershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPartnershipResponse response = new GetPartnershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("capabilityOptions", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("partnershipArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PartnershipArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("partnershipId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("tradingPartnerId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static GetPartnershipResponseUnmarshaller _instance = new GetPartnershipResponseUnmarshaller();        

        internal static GetPartnershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartnershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
