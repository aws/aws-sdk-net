...
{
    /// <summary>
    /// Response Unmarshaller for CreateTransformer operation
    /// </summary>  
    public class CreateTransformerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTransformerResponse response = new CreateTransformerResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("transformerArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static CreateTransformerResponseUnmarshaller _instance = new CreateTransformerResponseUnmarshaller();        

        internal static CreateTransformerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransformerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
