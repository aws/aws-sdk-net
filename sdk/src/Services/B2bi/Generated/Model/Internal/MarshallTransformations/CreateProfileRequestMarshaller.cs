...
namespace Amazon.B2bi.Model.Internal.MarshallTransformations
{
    ...
    public class CreateProfileRequestMarshaller : IMarshaller<IRequest, CreateProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateProfileRequest publicRequest)
        {
            ...
            string target = "B2BI.CreateProfile";
            ...
            if(publicRequest.IsSetLogging())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.Logging);
            }
            ...
            if(publicRequest.IsSetPhone())
            {
                context.Writer.WritePropertyName("phone");
                context.Writer.WriteStringValue(publicRequest.Phone);
            }
