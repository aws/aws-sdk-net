...
namespace Amazon.B2bi.Internal
{
    ...
    public class AmazonB2biAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonB2biAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for B2bi.
        /// </summary>
        public AmazonB2biAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonB2biAuthSchemeParameters
            {
    ...
    public class AmazonB2biAuthSchemeResolver : IAuthSchemeResolver<AmazonB2biAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonB2biAuthSchemeParameters authParameters)
        {
