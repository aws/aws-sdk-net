...
namespace Amazon.SupplyChain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataIntegrationFlowSourceUnmarshaller : IUnmarshaller<DataIntegrationFlowSource, XmlUnmarshallerContext>, IUnmarshaller<DataIntegrationFlowSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DataIntegrationFlowSource IUnmarshaller<DataIntegrationFlowSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DataIntegrationFlowSource Unmarshall(JsonUnmarshallerContext context)
        {
