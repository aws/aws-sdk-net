...
namespace Amazon.SupplyChain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataIntegrationEventUnmarshaller : IUnmarshaller<DataIntegrationEvent, XmlUnmarshallerContext>, IUnmarshaller<DataIntegrationEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DataIntegrationEvent IUnmarshaller<DataIntegrationEvent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DataIntegrationEvent Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("datasetTargetDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.DatasetTargetDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
