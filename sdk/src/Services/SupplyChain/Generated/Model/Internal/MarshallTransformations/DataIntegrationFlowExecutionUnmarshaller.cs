...
namespace Amazon.SupplyChain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataIntegrationFlowExecutionUnmarshaller : IUnmarshaller<DataIntegrationFlowExecution, XmlUnmarshallerContext>, IUnmarshaller<DataIntegrationFlowExecution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DataIntegrationFlowExecution IUnmarshaller<DataIntegrationFlowExecution, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DataIntegrationFlowExecution Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("outputMetadata", targetDepth))
                {
                    ...
                    unmarshalledObject.OutputMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
