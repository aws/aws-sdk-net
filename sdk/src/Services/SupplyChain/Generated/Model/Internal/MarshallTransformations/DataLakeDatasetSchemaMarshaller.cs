...
{
    /// <summary>
    /// DataLakeDatasetSchema Marshaller
    /// </summary>
    public class DataLakeDatasetSchemaMarshaller : IRequestMarshaller<DataLakeDatasetSchema, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DataLakeDatasetSchema requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFields())
            {
                ...
                foreach(var requestObjectFieldsListValue in requestObject.Fields)
                {
                    ...
                    var marshaller = DataLakeDatasetSchemaFieldMarshaller.Instance;
        ...
        /// </summary>
        public readonly static DataLakeDatasetSchemaMarshaller Instance = new DataLakeDatasetSchemaMarshaller();
