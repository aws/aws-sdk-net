...
{
    /// <summary>
    /// Container for the parameters to the TagResource operation. The ARN of the media pipeline
    /// that you want to tag. Consists of the pipeline's endpoint region, resource ID, and
    /// pipeline ID.
    /// </summary>
