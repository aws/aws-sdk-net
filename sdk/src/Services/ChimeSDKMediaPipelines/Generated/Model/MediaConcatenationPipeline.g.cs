...
namespace Amazon.ChimeSDKMediaPipelines.Model
{
    ...
    public partial class MediaConcatenationPipeline
    {
        ...
        public List<ConcatenationSink> Sinks { get; set; } = AWSConfigs.InitializeCollections ? new List<ConcatenationSink>() : null;
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 1)]
        public List<ConcatenationSource> Sources { get; set; } = AWSConfigs.InitializeCollections ? new List<ConcatenationSource>() : null;
