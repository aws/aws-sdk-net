...
namespace Amazon.ChimeSDKMediaPipelines.Model
{
    ...
    public partial class KinesisVideoStreamRecordingSourceRuntimeConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the FragmentSelector property is set.
        /// </summary>
        internal bool IsSetFragmentSelector() => this.FragmentSelector != null;
        ...
        public List<RecordingStreamConfiguration> Streams { get; set; } = AWSConfigs.InitializeCollections ? new List<RecordingStreamConfiguration>() : null;
