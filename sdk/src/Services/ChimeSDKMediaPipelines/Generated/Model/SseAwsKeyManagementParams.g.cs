...
namespace Amazon.ChimeSDKMediaPipelines.Model
{
    ...
    public partial class SseAwsKeyManagementParams
    {
        ...
        public string AwsKmsEncryptionContext { get; set; }

        /// <summary>
        /// Checks to see if the AwsKmsEncryptionContext property is set.
        /// </summary>
        internal bool IsSetAwsKmsEncryptionContext() => this.AwsKmsEncryptionContext != null;
        ...
        /// <summary>
        /// Checks to see if the AwsKmsKeyId property is set.
        /// </summary>
        internal bool IsSetAwsKmsKeyId() => this.AwsKmsKeyId != null;
    }
}
