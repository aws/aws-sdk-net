...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMediaCapturePipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListMediaCapturePipelinesResponse();
            ...
            {
                if (context.TestExpression("MediaCapturePipelines", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MediaCapturePipelineSummary, MediaCapturePipelineSummaryUnmarshaller>(MediaCapturePipelineSummaryUnmarshaller.Instance);
                    unmarshalledObject.MediaCapturePipelines = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListMediaCapturePipelinesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMediaCapturePipelinesResponseUnmarshaller Instance => _instance;
    }
}
