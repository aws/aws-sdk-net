...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AmazonTranscribeCallAnalyticsProcessorConfigurationUnmarshaller : IJsonUnmarshaller<AmazonTranscribeCallAnalyticsProcessorConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AmazonTranscribeCallAnalyticsProcessorConfiguration();
            ...
            {
                if (context.TestExpression("CallAnalyticsStreamCategories", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PostCallAnalyticsSettings", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AmazonTranscribeCallAnalyticsProcessorConfigurationUnmarshaller Instance => _instance;
    }
}
