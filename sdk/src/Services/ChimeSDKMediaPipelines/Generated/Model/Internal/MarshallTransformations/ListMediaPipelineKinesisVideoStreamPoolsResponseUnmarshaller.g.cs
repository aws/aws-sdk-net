...
{
    /// <summary>
    /// Response Unmarshaller for ListMediaPipelineKinesisVideoStreamPools operation.
    /// </summary>
    public partial class ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListMediaPipelineKinesisVideoStreamPoolsResponse();
            ...
            {
                if (context.TestExpression("KinesisVideoStreamPools", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<KinesisVideoStreamPoolSummary, KinesisVideoStreamPoolSummaryUnmarshaller>(KinesisVideoStreamPoolSummaryUnmarshaller.Instance);
                    unmarshalledObject.KinesisVideoStreamPools = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var streamCopy = new MemoryStream(responseBodyBytes))
            {
                using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
                {
                    ...
                    {
                        return ThrottledClientExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
        ...
        private static ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller _instance = new ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller();

        internal static ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller Instance => _instance;
    }
}
