...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMediaPipelineKinesisVideoStreamPool operation
    /// </summary>  
    public class DeleteMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMediaPipelineKinesisVideoStreamPoolResponse response = new DeleteMediaPipelineKinesisVideoStreamPoolResponse();
        ...
        private static DeleteMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller _instance = new DeleteMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller();        

        internal static DeleteMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
