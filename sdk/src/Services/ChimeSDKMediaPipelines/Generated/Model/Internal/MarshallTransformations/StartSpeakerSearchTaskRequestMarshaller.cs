...
{
    /// <summary>
    /// StartSpeakerSearchTask Request Marshaller
    /// </summary>       
    public class StartSpeakerSearchTaskRequestMarshaller : IMarshaller<IRequest, StartSpeakerSearchTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartSpeakerSearchTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartSpeakerSearchTaskRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetVoiceProfileDomainArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.VoiceProfileDomainArn);
            }
        ...
        private static StartSpeakerSearchTaskRequestMarshaller _instance = new StartSpeakerSearchTaskRequestMarshaller();        

        internal static StartSpeakerSearchTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSpeakerSearchTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
