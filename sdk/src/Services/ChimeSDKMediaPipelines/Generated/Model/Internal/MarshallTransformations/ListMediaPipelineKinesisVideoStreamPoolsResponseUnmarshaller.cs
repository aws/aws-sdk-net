    ...
    public class ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<KinesisVideoStreamPoolSummary, KinesisVideoStreamPoolSummaryUnmarshaller>(KinesisVideoStreamPoolSummaryUnmarshaller.Instance);
                    response.KinesisVideoStreamPools = unmarshaller.Unmarshall(context);
                    continue;
                }
