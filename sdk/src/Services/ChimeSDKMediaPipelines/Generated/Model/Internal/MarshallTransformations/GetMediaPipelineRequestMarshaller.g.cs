...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMediaPipelineRequestMarshaller : IMarshaller<IRequest, GetMediaPipelineRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetMediaPipelineRequestMarshaller _instance = new();

        internal static GetMediaPipelineRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMediaPipelineRequestMarshaller Instance => _instance;
    }
}
