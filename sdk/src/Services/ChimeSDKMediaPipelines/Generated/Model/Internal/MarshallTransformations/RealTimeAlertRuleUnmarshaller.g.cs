...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RealTimeAlertRuleUnmarshaller : IJsonUnmarshaller<RealTimeAlertRule, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RealTimeAlertRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RealTimeAlertRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RealTimeAlertRuleUnmarshaller Instance => _instance;
    }
}
