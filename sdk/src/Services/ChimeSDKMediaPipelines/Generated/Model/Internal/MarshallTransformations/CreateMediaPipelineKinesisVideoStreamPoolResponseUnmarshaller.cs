...
{
    /// <summary>
    /// Response Unmarshaller for CreateMediaPipelineKinesisVideoStreamPool operation
    /// </summary>  
    public class CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMediaPipelineKinesisVideoStreamPoolResponse response = new CreateMediaPipelineKinesisVideoStreamPoolResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("KinesisVideoStreamPoolConfiguration", targetDepth))
                {
                    ...
                    response.KinesisVideoStreamPoolConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller _instance = new CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller();        

        internal static CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
