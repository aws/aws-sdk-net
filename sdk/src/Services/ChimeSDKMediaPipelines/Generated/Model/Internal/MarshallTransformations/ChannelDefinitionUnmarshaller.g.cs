...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelDefinitionUnmarshaller : IJsonUnmarshaller<ChannelDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ChannelDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ChannelDefinition();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelDefinitionUnmarshaller Instance => _instance;
    }
}
