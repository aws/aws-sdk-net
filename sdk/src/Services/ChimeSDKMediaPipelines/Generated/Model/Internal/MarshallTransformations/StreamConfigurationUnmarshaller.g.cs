...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StreamConfigurationUnmarshaller : IJsonUnmarshaller<StreamConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StreamConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("StreamChannelDefinition", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static StreamConfigurationUnmarshaller Instance => _instance;
    }
}
