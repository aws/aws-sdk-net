...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMediaInsightsPipelineStatus operation
    /// </summary>  
    public class UpdateMediaInsightsPipelineStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMediaInsightsPipelineStatusResponse response = new UpdateMediaInsightsPipelineStatusResponse();
        ...
        private static UpdateMediaInsightsPipelineStatusResponseUnmarshaller _instance = new UpdateMediaInsightsPipelineStatusResponseUnmarshaller();        

        internal static UpdateMediaInsightsPipelineStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMediaInsightsPipelineStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
