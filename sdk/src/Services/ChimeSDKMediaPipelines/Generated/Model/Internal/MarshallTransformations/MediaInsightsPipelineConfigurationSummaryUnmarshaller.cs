...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    public class MediaInsightsPipelineConfigurationSummaryUnmarshaller : IUnmarshaller<MediaInsightsPipelineConfigurationSummary, XmlUnmarshallerContext>, IUnmarshaller<MediaInsightsPipelineConfigurationSummary, JsonUnmarshallerContext>
    {
        ...
        private static MediaInsightsPipelineConfigurationSummaryUnmarshaller _instance = new MediaInsightsPipelineConfigurationSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MediaInsightsPipelineConfigurationSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
