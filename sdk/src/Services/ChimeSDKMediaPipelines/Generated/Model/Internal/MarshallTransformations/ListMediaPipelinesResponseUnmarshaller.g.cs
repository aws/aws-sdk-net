...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMediaPipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListMediaPipelinesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MediaPipelines", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MediaPipelines = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListMediaPipelinesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMediaPipelinesResponseUnmarshaller Instance => _instance;
    }
}
