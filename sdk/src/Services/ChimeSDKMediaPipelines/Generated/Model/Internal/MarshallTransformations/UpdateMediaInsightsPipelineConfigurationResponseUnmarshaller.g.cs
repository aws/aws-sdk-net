...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMediaInsightsPipelineConfiguration operation.
    /// </summary>
    public partial class UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateMediaInsightsPipelineConfigurationResponse();
            ...
            {
                if (context.TestExpression("MediaInsightsPipelineConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = MediaInsightsPipelineConfigurationUnmarshaller.Instance;
                    unmarshalledObject.MediaInsightsPipelineConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller _instance = new UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller();

        internal static UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller Instance => _instance;
    }
}
