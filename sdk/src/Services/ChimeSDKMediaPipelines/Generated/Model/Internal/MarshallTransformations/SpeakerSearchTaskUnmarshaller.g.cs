...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SpeakerSearchTaskUnmarshaller : IJsonUnmarshaller<SpeakerSearchTask, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SpeakerSearchTask Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SpeakerSearchTask();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SpeakerSearchTaskUnmarshaller Instance => _instance;
    }
}
