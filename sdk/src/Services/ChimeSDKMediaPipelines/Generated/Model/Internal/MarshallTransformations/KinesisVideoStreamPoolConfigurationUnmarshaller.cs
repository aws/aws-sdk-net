...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KinesisVideoStreamPoolConfigurationUnmarshaller : IUnmarshaller<KinesisVideoStreamPoolConfiguration, XmlUnmarshallerContext>, IUnmarshaller<KinesisVideoStreamPoolConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        KinesisVideoStreamPoolConfiguration IUnmarshaller<KinesisVideoStreamPoolConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public KinesisVideoStreamPoolConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("PoolSize", targetDepth))
                {
                    ...
                    unmarshalledObject.PoolSize = unmarshaller.Unmarshall(context);
                    continue;
                }
