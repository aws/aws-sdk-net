...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MediaLiveConnectorPipelineUnmarshaller : IJsonUnmarshaller<MediaLiveConnectorPipeline, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public MediaLiveConnectorPipeline Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new MediaLiveConnectorPipeline();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Sinks", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LiveConnectorSinkConfiguration, LiveConnectorSinkConfigurationUnmarshaller>(LiveConnectorSinkConfigurationUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LiveConnectorSourceConfiguration, LiveConnectorSourceConfigurationUnmarshaller>(LiveConnectorSourceConfigurationUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static MediaLiveConnectorPipelineUnmarshaller Instance => _instance;
    }
}
