...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChimeSdkMeetingLiveConnectorConfigurationUnmarshaller : IJsonUnmarshaller<ChimeSdkMeetingLiveConnectorConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ChimeSdkMeetingLiveConnectorConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ChimeSdkMeetingLiveConnectorConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChimeSdkMeetingLiveConnectorConfigurationUnmarshaller Instance => _instance;
    }
}
