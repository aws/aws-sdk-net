...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SentimentConfigurationUnmarshaller : IJsonUnmarshaller<SentimentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SentimentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SentimentType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SentimentType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
