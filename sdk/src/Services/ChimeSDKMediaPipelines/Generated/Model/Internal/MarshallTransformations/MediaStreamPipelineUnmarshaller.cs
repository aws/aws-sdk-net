...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MediaStreamPipelineUnmarshaller : IUnmarshaller<MediaStreamPipeline, XmlUnmarshallerContext>, IUnmarshaller<MediaStreamPipeline, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MediaStreamPipeline IUnmarshaller<MediaStreamPipeline, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public MediaStreamPipeline Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MediaStreamSink, MediaStreamSinkUnmarshaller>(MediaStreamSinkUnmarshaller.Instance);
                    unmarshalledObject.Sinks = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Sources", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<MediaStreamSource, MediaStreamSourceUnmarshaller>(MediaStreamSourceUnmarshaller.Instance);
