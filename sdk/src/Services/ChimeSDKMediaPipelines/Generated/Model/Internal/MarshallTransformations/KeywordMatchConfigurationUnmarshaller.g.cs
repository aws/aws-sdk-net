...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class KeywordMatchConfigurationUnmarshaller : IJsonUnmarshaller<KeywordMatchConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public KeywordMatchConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new KeywordMatchConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static KeywordMatchConfigurationUnmarshaller Instance => _instance;
    }
}
