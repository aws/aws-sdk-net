...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMediaInsightsPipelineConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListMediaInsightsPipelineConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MediaInsightsPipelineConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MediaInsightsPipelineConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListMediaInsightsPipelineConfigurationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMediaInsightsPipelineConfigurationsResponseUnmarshaller Instance => _instance;
    }
}
