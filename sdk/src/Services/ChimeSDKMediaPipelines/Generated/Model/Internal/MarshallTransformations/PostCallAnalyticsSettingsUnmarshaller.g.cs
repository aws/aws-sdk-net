...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PostCallAnalyticsSettingsUnmarshaller : IJsonUnmarshaller<PostCallAnalyticsSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PostCallAnalyticsSettings();
            ...
            {
                if (context.TestExpression("ContentRedactionOutput", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("OutputEncryptionKMSKeyId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static PostCallAnalyticsSettingsUnmarshaller Instance => _instance;
    }
}
