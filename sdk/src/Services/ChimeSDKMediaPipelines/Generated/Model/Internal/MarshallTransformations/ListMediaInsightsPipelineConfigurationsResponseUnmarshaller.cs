...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    public class ListMediaInsightsPipelineConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("MediaInsightsPipelineConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MediaInsightsPipelineConfigurationSummary, MediaInsightsPipelineConfigurationSummaryUnmarshaller>(MediaInsightsPipelineConfigurationSummaryUnmarshaller.Instance);
                    response.MediaInsightsPipelineConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
