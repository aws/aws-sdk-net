...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RealTimeAlertConfigurationUnmarshaller : IJsonUnmarshaller<RealTimeAlertConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RealTimeAlertConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RealTimeAlertRule, RealTimeAlertRuleUnmarshaller>(RealTimeAlertRuleUnmarshaller.Instance);
