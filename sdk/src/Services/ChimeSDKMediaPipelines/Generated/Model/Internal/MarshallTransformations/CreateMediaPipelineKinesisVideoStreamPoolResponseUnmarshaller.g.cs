...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateMediaPipelineKinesisVideoStreamPoolResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("KinesisVideoStreamPoolConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.KinesisVideoStreamPoolConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller Instance => _instance;
    }
}
