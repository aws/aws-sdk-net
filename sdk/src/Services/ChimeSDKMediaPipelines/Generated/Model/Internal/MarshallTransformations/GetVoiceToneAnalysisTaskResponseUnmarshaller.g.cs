...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetVoiceToneAnalysisTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetVoiceToneAnalysisTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VoiceToneAnalysisTask", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VoiceToneAnalysisTask = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetVoiceToneAnalysisTaskResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetVoiceToneAnalysisTaskResponseUnmarshaller Instance => _instance;
    }
}
