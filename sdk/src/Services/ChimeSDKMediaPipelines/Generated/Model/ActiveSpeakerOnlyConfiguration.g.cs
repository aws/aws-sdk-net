...
namespace Amazon.ChimeSDKMediaPipelines.Model
{
    ...
    public partial class ActiveSpeakerOnlyConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public ActiveSpeakerPosition ActiveSpeakerPosition { get; set; }

        /// <summary>
        /// Checks to see if the ActiveSpeakerPosition property is set.
        /// </summary>
        internal bool IsSetActiveSpeakerPosition() => this.ActiveSpeakerPosition != null;
    }
}
