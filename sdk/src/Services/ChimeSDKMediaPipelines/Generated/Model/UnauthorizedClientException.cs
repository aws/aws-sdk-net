...
namespace Amazon.ChimeSDKMediaPipelines.Model
{
    ...
    public partial class UnauthorizedClientException : AmazonChimeSDKMediaPipelinesException
    {
        ...
        public UnauthorizedClientException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnauthorizedClientException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
