...
namespace Amazon.ChimeSDKMediaPipelines
{
    ...
    public partial class AmazonChimeSDKMediaPipelinesClient : AmazonServiceClient, IAmazonChimeSDKMediaPipelines
    {
        ...
        /// 
        /// </summary>
        public AmazonChimeSDKMediaPipelinesClient() : base(new AmazonChimeSDKMediaPipelinesConfig()) { }
        ...
        public AmazonChimeSDKMediaPipelinesClient(RegionEndpoint region) : base(new AmazonChimeSDKMediaPipelinesConfig { RegionEndpoint = region }) { }
        ...
        public AmazonChimeSDKMediaPipelinesClient(AmazonChimeSDKMediaPipelinesConfig config) : base(config) { }
