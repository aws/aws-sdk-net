...
namespace Amazon.ChimeSDKMediaPipelines
{
    ...
    public partial class AmazonChimeSDKMediaPipelinesConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Chime SDK Media Pipelines", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Chime SDK Media Pipelines";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "media-pipelines-chime";
