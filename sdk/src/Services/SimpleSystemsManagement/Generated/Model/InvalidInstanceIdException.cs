...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidInstanceIdException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidInstanceIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidInstanceIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
