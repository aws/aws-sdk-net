...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    /// </summary>
    public partial class ListNodesRequest : AmazonSimpleSystemsManagementRequest
    {
        private List<NodeFilter> _filters = AWSConfigs.InitializeCollections ? new List<NodeFilter>() : null;
        ...
        /// <para>
        /// The name of the resource data sync to retrieve information about. Required for cross-account/cross-Region
        /// configurations. Optional for single account/single-Region configurations.
        /// </para>
        /// </summary>
