...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidActivationIdException : AmazonSimpleSystemsManagementException
    {
        ...
        /// <summary>
        /// Default constructor for InvalidActivationIdException
        /// message.
        /// </summary>
        public InvalidActivationIdException() 
            : base() {}
        ...
        public InvalidActivationIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidActivationIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
