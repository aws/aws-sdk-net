...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class ResumeSessionResponse : AmazonWebServiceResponse
    {
        ...
        /// send commands and receive output from the managed node. Format: <code>wss://ssmmessages.<b>region</b>.amazonaws.com/v1/data-channel/<b>session-id</b>?stream=(input|output)</code>.
        /// </para>
        ///  
        /// <para>
