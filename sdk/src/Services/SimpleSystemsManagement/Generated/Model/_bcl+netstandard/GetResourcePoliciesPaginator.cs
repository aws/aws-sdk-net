...
{
    /// <summary>
    /// Base class for GetResourcePolicies paginators.
    /// </summary>
    internal sealed partial class GetResourcePoliciesPaginator : IPaginator<GetResourcePoliciesResponse>, IGetResourcePoliciesPaginator
    {
        private readonly IAmazonSimpleSystemsManagement _client;
        private readonly GetResourcePoliciesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<GetResourcePoliciesResponse> Responses => new PaginatedResponse<GetResourcePoliciesResponse>(this);
...
#if BCL
        IEnumerable<GetResourcePoliciesResponse> IPaginator<GetResourcePoliciesResponse>.Paginate()
        {
            ...
            GetResourcePoliciesResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.GetResourcePolicies(_request);
        ...
        async IAsyncEnumerable<GetResourcePoliciesResponse> IPaginator<GetResourcePoliciesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.GetResourcePoliciesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
