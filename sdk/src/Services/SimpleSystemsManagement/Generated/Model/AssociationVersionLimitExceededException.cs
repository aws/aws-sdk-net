...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class AssociationVersionLimitExceededException : AmazonSimpleSystemsManagementException
    {
        ...
        public AssociationVersionLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AssociationVersionLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
