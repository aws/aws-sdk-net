...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class DoesNotExistException : AmazonSimpleSystemsManagementException
    {
        ...
        public DoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
