...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NodeOwnerInfoUnmarshaller : IJsonUnmarshaller<NodeOwnerInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NodeOwnerInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OrganizationalUnitPath", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OrganizationalUnitPath = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
