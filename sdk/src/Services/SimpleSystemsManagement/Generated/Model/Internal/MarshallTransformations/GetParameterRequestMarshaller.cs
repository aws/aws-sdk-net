    ...
    public class GetParameterRequestMarshaller : IMarshaller<IRequest, GetParameterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetParameterRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetWithDecryption())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.WithDecryption.Value);
            }
        ...
        private static GetParameterRequestMarshaller _instance = new GetParameterRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetParameterRequestMarshaller Instance
        {
            get
            {
                return _instance;
