...
{
    /// <summary>
    /// GetPatchBaselineForPatchGroup Request Marshaller
    /// </summary>       
    public class GetPatchBaselineForPatchGroupRequestMarshaller : IMarshaller<IRequest, GetPatchBaselineForPatchGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPatchBaselineForPatchGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPatchBaselineForPatchGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.GetPatchBaselineForPatchGroup";
