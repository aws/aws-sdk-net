...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAssociationExecutions operation
    /// </summary>  
    public class DescribeAssociationExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAssociationExecutionsResponse response = new DescribeAssociationExecutionsResponse();
            ...
            {
                if (context.TestExpression("AssociationExecutions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociationExecution, AssociationExecutionUnmarshaller>(AssociationExecutionUnmarshaller.Instance);
                    response.AssociationExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return AssociationDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DescribeAssociationExecutionsResponseUnmarshaller _instance = new DescribeAssociationExecutionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssociationExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
