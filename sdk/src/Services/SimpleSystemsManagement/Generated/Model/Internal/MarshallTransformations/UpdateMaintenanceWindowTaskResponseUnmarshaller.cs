...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMaintenanceWindowTask operation
    /// </summary>  
    public class UpdateMaintenanceWindowTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CutoffBehavior", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("TaskInvocationParameters", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("TaskParameters", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("WindowId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static UpdateMaintenanceWindowTaskResponseUnmarshaller _instance = new UpdateMaintenanceWindowTaskResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMaintenanceWindowTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
