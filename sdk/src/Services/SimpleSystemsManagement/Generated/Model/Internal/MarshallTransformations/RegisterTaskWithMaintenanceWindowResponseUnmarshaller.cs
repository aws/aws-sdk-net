...
{
    /// <summary>
    /// Response Unmarshaller for RegisterTaskWithMaintenanceWindow operation
    /// </summary>  
    public class RegisterTaskWithMaintenanceWindowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterTaskWithMaintenanceWindowResponse response = new RegisterTaskWithMaintenanceWindowResponse();
            ...
            {
                if (context.TestExpression("WindowTaskId", targetDepth, ref reader))
                {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("FeatureNotAvailableException"))
                {
                    return FeatureNotAvailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static RegisterTaskWithMaintenanceWindowResponseUnmarshaller _instance = new RegisterTaskWithMaintenanceWindowResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterTaskWithMaintenanceWindowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
