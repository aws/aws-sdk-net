...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMaintenanceWindowTargets operation
    /// </summary>  
    public class DescribeMaintenanceWindowTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMaintenanceWindowTargetsResponse response = new DescribeMaintenanceWindowTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MaintenanceWindowTarget, MaintenanceWindowTargetUnmarshaller>(MaintenanceWindowTargetUnmarshaller.Instance);
        ...
        private static DescribeMaintenanceWindowTargetsResponseUnmarshaller _instance = new DescribeMaintenanceWindowTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMaintenanceWindowTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
