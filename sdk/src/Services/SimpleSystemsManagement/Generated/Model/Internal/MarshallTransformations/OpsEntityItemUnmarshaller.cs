...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpsEntityItemUnmarshaller : IJsonUnmarshaller<OpsEntityItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpsEntityItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CaptureTime", targetDepth, ref reader))
                {
