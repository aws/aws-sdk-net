...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    public class DocumentRequiresMarshaller : IRequestMarshaller<DocumentRequires, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DocumentRequires requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRequireType())
            {
                ...
                context.Writer.WriteStringValue(requestObject.RequireType);
            }
            ...
            if(requestObject.IsSetVersionName())
            {
                ...
                context.Writer.WriteStringValue(requestObject.VersionName);
            }
