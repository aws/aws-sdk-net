...
{
    /// <summary>
    /// Response Unmarshaller for StartChangeRequestExecution operation
    /// </summary>  
    public class StartChangeRequestExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartChangeRequestExecutionResponse response = new StartChangeRequestExecutionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AutomationExecutionId", targetDepth, ref reader))
                {
                    ...
                    response.AutomationExecutionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("AutomationDefinitionNotApprovedException"))
                {
                    return AutomationDefinitionNotApprovedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("AutomationDefinitionNotFoundException"))
                {
                    return AutomationDefinitionNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("AutomationDefinitionVersionNotFoundException"))
                {
                    return AutomationDefinitionVersionNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("AutomationExecutionLimitExceededException"))
                {
                    return AutomationExecutionLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartChangeRequestExecutionResponseUnmarshaller _instance = new StartChangeRequestExecutionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartChangeRequestExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
