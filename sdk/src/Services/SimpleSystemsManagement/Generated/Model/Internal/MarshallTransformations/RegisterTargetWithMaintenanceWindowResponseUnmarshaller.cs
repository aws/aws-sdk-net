...
{
    /// <summary>
    /// Response Unmarshaller for RegisterTargetWithMaintenanceWindow operation
    /// </summary>  
    public class RegisterTargetWithMaintenanceWindowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterTargetWithMaintenanceWindowResponse response = new RegisterTargetWithMaintenanceWindowResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("WindowTargetId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WindowTargetId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RegisterTargetWithMaintenanceWindowResponseUnmarshaller _instance = new RegisterTargetWithMaintenanceWindowResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterTargetWithMaintenanceWindowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
