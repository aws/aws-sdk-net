...
{
    /// <summary>
    /// Response Unmarshaller for GetPatchBaselineForPatchGroup operation
    /// </summary>  
    public class GetPatchBaselineForPatchGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPatchBaselineForPatchGroupResponse response = new GetPatchBaselineForPatchGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PatchGroup = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetPatchBaselineForPatchGroupResponseUnmarshaller _instance = new GetPatchBaselineForPatchGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPatchBaselineForPatchGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
