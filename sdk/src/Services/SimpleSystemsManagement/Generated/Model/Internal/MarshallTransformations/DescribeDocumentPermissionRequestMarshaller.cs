...
{
    /// <summary>
    /// DescribeDocumentPermission Request Marshaller
    /// </summary>       
    public class DescribeDocumentPermissionRequestMarshaller : IMarshaller<IRequest, DescribeDocumentPermissionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDocumentPermissionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDocumentPermissionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.DescribeDocumentPermission";
