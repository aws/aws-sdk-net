...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MaintenanceWindowExecutionTaskInvocationIdentityUnmarshaller : IUnmarshaller<MaintenanceWindowExecutionTaskInvocationIdentity, XmlUnmarshallerContext>, IUnmarshaller<MaintenanceWindowExecutionTaskInvocationIdentity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MaintenanceWindowExecutionTaskInvocationIdentity IUnmarshaller<MaintenanceWindowExecutionTaskInvocationIdentity, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public MaintenanceWindowExecutionTaskInvocationIdentity Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
