...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParentStepDetailsUnmarshaller : IUnmarshaller<ParentStepDetails, XmlUnmarshallerContext>, IUnmarshaller<ParentStepDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ParentStepDetails IUnmarshaller<ParentStepDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ParentStepDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Iteration", targetDepth))
                {
                    ...
                    unmarshalledObject.Iteration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("IteratorValue", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IteratorValue = unmarshaller.Unmarshall(context);
                    continue;
                }
