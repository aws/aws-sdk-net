...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpsItemSummaryUnmarshaller : IUnmarshaller<OpsItemSummary, XmlUnmarshallerContext>, IUnmarshaller<OpsItemSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        OpsItemSummary IUnmarshaller<OpsItemSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public OpsItemSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
