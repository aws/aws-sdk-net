...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDocumentMetadata operation
    /// </summary>  
    public class UpdateDocumentMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateDocumentMetadataResponseUnmarshaller _instance = new UpdateDocumentMetadataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDocumentMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
