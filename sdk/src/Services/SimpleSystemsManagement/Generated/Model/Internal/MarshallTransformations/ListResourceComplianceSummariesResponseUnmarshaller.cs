    ...
    public class ListResourceComplianceSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ResourceComplianceSummaryItems", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourceComplianceSummaryItem, ResourceComplianceSummaryItemUnmarshaller>(ResourceComplianceSummaryItemUnmarshaller.Instance);
                    response.ResourceComplianceSummaryItems = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
