...
{
    /// <summary>
    /// Response Unmarshaller for GetAutomationExecution operation
    /// </summary>  
    public class GetAutomationExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAutomationExecutionResponse response = new GetAutomationExecutionResponse();
            ...
            {
                if (context.TestExpression("AutomationExecution", targetDepth, ref reader))
                {
                    var unmarshaller = AutomationExecutionUnmarshaller.Instance;
                    response.AutomationExecution = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetAutomationExecutionResponseUnmarshaller _instance = new GetAutomationExecutionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAutomationExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
