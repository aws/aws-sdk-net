...
{
    /// <summary>
    /// Response Unmarshaller for ListDocumentMetadataHistory operation
    /// </summary>  
    public class ListDocumentMetadataHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDocumentMetadataHistoryResponse response = new ListDocumentMetadataHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DocumentMetadataResponseInfoUnmarshaller.Instance;
        ...
        private static ListDocumentMetadataHistoryResponseUnmarshaller _instance = new ListDocumentMetadataHistoryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDocumentMetadataHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
