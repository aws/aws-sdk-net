...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssociationBatch operation
    /// </summary>  
    public class CreateAssociationBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssociationBatchResponse response = new CreateAssociationBatchResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FailedCreateAssociation, FailedCreateAssociationUnmarshaller>(FailedCreateAssociationUnmarshaller.Instance);
                    response.Failed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Successful", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociationDescription, AssociationDescriptionUnmarshaller>(AssociationDescriptionUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return AssociationLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("DuplicateInstanceId"))
                {
                    return DuplicateInstanceIdExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return InvalidOutputLocationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return InvalidScheduleExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidTarget"))
                {
                    return InvalidTargetExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidTargetMaps"))
                {
                    return InvalidTargetMapsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedPlatformType"))
                {
                    return UnsupportedPlatformTypeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static CreateAssociationBatchResponseUnmarshaller _instance = new CreateAssociationBatchResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssociationBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
