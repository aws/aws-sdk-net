    ...
    public class CreateAssociationBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FailedCreateAssociation, FailedCreateAssociationUnmarshaller>(FailedCreateAssociationUnmarshaller.Instance);
                    response.Failed = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Successful", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AssociationDescription, AssociationDescriptionUnmarshaller>(AssociationDescriptionUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new AssociationLimitExceededException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("DuplicateInstanceId"))
            {
                return new DuplicateInstanceIdException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            {
                return new InvalidOutputLocationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            {
                return new UnsupportedPlatformTypeException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
