...
{
    /// <summary>
    /// Response Unmarshaller for ListComplianceSummaries operation
    /// </summary>  
    public class ListComplianceSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListComplianceSummariesResponse response = new ListComplianceSummariesResponse();
            ...
            {
                if (context.TestExpression("ComplianceSummaryItems", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ComplianceSummaryItem, ComplianceSummaryItemUnmarshaller>(ComplianceSummaryItemUnmarshaller.Instance);
                    response.ComplianceSummaryItems = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListComplianceSummariesResponseUnmarshaller _instance = new ListComplianceSummariesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListComplianceSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
