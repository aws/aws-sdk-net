    ...
    public class DescribeInstanceAssociationsStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InstanceAssociationStatusInfo, InstanceAssociationStatusInfoUnmarshaller>(InstanceAssociationStatusInfoUnmarshaller.Instance);
                    response.InstanceAssociationStatusInfos = unmarshaller.Unmarshall(context);
                    continue;
                }
