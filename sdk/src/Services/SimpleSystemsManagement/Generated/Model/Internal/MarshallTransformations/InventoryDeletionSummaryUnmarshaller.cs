...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    public class InventoryDeletionSummaryUnmarshaller : IJsonUnmarshaller<InventoryDeletionSummary, JsonUnmarshallerContext>
    {
        ...
        private static InventoryDeletionSummaryUnmarshaller _instance = new InventoryDeletionSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InventoryDeletionSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
