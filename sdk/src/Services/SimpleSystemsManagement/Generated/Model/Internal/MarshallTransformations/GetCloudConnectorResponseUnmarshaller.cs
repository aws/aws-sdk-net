...
{
    /// <summary>
    /// Response Unmarshaller for GetCloudConnector operation
    /// </summary>  
    public class GetCloudConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCloudConnectorResponse response = new GetCloudConnectorResponse();
            ...
            {
                if (context.TestExpression("CloudConnectorArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CloudConnectorArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ConfigConnectorArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConfigConnectorArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Configuration", targetDepth, ref reader))
                {
                    var unmarshaller = CloudConnectorConfigurationUnmarshaller.Instance;
        ...
        private static GetCloudConnectorResponseUnmarshaller _instance = new GetCloudConnectorResponseUnmarshaller();        

        internal static GetCloudConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
