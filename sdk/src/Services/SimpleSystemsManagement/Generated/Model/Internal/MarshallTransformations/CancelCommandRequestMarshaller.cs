...
{
    /// <summary>
    /// CancelCommand Request Marshaller
    /// </summary>       
    public class CancelCommandRequestMarshaller : IMarshaller<IRequest, CancelCommandRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelCommandRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelCommandRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCommandId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.CommandId);
            }
        ...
        private static CancelCommandRequestMarshaller _instance = new CancelCommandRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelCommandRequestMarshaller Instance
        {
            get
            {
                return _instance;
