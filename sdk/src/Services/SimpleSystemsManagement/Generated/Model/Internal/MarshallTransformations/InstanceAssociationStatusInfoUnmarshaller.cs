...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceAssociationStatusInfoUnmarshaller : IUnmarshaller<InstanceAssociationStatusInfo, XmlUnmarshallerContext>, IUnmarshaller<InstanceAssociationStatusInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InstanceAssociationStatusInfo IUnmarshaller<InstanceAssociationStatusInfo, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public InstanceAssociationStatusInfo Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ExecutionDate", targetDepth))
                {
                    ...
                    unmarshalledObject.ExecutionDate = unmarshaller.Unmarshall(context);
                    continue;
                }
