...
{
    /// <summary>
    /// DeregisterTargetFromMaintenanceWindow Request Marshaller
    /// </summary>       
    public class DeregisterTargetFromMaintenanceWindowRequestMarshaller : IMarshaller<IRequest, DeregisterTargetFromMaintenanceWindowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeregisterTargetFromMaintenanceWindowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeregisterTargetFromMaintenanceWindowRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.DeregisterTargetFromMaintenanceWindow";
            ...
            if(publicRequest.IsSetSafe())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.Safe.Value);
            }
            ...
            if(publicRequest.IsSetWindowTargetId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.WindowTargetId);
            }
