...
namespace Amazon.SimpleSystemsManagement.Internal
{
    /// <summary>
    /// Amazon SimpleSystemsManagement endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for SimpleSystemsManagement service requests.
    /// Collects values for SimpleSystemsManagementEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SimpleSystemsManagementEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonSimpleSystemsManagementEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSimpleSystemsManagementConfig)requestContext.ClientConfig;
            var result = new SimpleSystemsManagementEndpointParameters();
