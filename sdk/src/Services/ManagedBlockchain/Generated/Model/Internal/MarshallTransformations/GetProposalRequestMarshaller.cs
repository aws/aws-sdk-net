...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    public class GetProposalRequestMarshaller : IMarshaller<IRequest, GetProposalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetProposalRequest publicRequest)
        {
            ...
            string uriResourcePath = "/networks/{networkId}/proposals/{proposalId}";
            ...
            uriResourcePath = uriResourcePath.Replace("{proposalId}", StringUtils.FromStringWithSlashEncoding(publicRequest.ProposalId));
