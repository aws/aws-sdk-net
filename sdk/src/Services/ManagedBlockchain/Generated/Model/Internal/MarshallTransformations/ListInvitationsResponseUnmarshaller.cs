...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListInvitationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Invitation, InvitationUnmarshaller>(InvitationUnmarshaller.Instance);
                    response.Invitations = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static ListInvitationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInvitationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
