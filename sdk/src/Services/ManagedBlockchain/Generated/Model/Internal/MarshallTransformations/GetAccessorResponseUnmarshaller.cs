...
{
    /// <summary>
    /// Response Unmarshaller for GetAccessor operation
    /// </summary>  
    public class GetAccessorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("Accessor", targetDepth, ref reader))
                {
                    var unmarshaller = AccessorUnmarshaller.Instance;
                    response.Accessor = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetAccessorResponseUnmarshaller _instance = new GetAccessorResponseUnmarshaller();        

        internal static GetAccessorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
