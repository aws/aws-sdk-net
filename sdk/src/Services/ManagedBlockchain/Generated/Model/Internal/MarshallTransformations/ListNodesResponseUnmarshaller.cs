...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<NodeSummary, NodeSummaryUnmarshaller>(NodeSummaryUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNodesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
