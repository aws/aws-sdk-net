...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NodeFrameworkAttributesUnmarshaller : IJsonUnmarshaller<NodeFrameworkAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NodeFrameworkAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
