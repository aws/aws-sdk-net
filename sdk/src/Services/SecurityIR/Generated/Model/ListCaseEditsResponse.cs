...
{
    /// <summary>
    /// This is the response object from the ListCaseEdits operation.
    /// </summary>
    public partial class ListCaseEditsResponse : AmazonWebServiceResponse
    {
        private List<CaseEditItem> _items = AWSConfigs.InitializeCollections ? new List<CaseEditItem>() : null;
        ...
        /// </summary>
        public List<CaseEditItem> Items
        {
