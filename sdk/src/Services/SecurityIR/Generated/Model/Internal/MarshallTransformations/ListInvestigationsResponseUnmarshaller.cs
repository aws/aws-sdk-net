...
namespace Amazon.SecurityIR.Model.Internal.MarshallTransformations
{
    ...
    public class ListInvestigationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("investigationActions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<InvestigationAction, InvestigationActionUnmarshaller>(InvestigationActionUnmarshaller.Instance);
                    response.InvestigationActions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
