...
{
    /// <summary>
    /// Response Unmarshaller for SendFeedback operation
    /// </summary>  
    public class SendFeedbackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SendFeedbackResponseUnmarshaller _instance = new SendFeedbackResponseUnmarshaller();        

        internal static SendFeedbackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendFeedbackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
