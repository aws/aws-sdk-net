...
{
    /// <summary>
    /// BatchGetMemberAccountDetails Request Marshaller
    /// </summary>       
    public class BatchGetMemberAccountDetailsRequestMarshaller : IMarshaller<IRequest, BatchGetMemberAccountDetailsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchGetMemberAccountDetailsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchGetMemberAccountDetailsRequest publicRequest)
        {
        ...
        private static BatchGetMemberAccountDetailsRequestMarshaller _instance = new BatchGetMemberAccountDetailsRequestMarshaller();        

        internal static BatchGetMemberAccountDetailsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetMemberAccountDetailsRequestMarshaller Instance
        {
            get
            {
                return _instance;
