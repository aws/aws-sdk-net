...
namespace Amazon.SecurityIR.Model.Internal.MarshallTransformations
{
    ...
    public class IncidentResponderUnmarshaller : IJsonUnmarshaller<IncidentResponder, JsonUnmarshallerContext>
    {
        ...
        public IncidentResponder Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("communicationPreferences", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.CommunicationPreferences = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
