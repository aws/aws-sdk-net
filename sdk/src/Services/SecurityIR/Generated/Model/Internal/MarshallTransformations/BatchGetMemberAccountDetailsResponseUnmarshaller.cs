...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetMemberAccountDetails operation
    /// </summary>  
    public class BatchGetMemberAccountDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetMemberAccountDetailsResponse response = new BatchGetMemberAccountDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GetMembershipAccountDetailError, GetMembershipAccountDetailErrorUnmarshaller>(GetMembershipAccountDetailErrorUnmarshaller.Instance);
                    response.Errors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("items", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<GetMembershipAccountDetailItem, GetMembershipAccountDetailItemUnmarshaller>(GetMembershipAccountDetailItemUnmarshaller.Instance);
        ...
        private static BatchGetMemberAccountDetailsResponseUnmarshaller _instance = new BatchGetMemberAccountDetailsResponseUnmarshaller();        

        internal static BatchGetMemberAccountDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetMemberAccountDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
