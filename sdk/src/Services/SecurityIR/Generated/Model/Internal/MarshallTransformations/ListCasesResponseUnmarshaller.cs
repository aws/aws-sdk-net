...
{
    /// <summary>
    /// Response Unmarshaller for ListCases operation
    /// </summary>  
    public class ListCasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCasesResponse response = new ListCasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListCasesItem, ListCasesItemUnmarshaller>(ListCasesItemUnmarshaller.Instance);
        ...
        private static ListCasesResponseUnmarshaller _instance = new ListCasesResponseUnmarshaller();        

        internal static ListCasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
