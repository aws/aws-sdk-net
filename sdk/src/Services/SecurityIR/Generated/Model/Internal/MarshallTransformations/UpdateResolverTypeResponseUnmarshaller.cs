...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResolverType operation
    /// </summary>  
    public class UpdateResolverTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResolverTypeResponse response = new UpdateResolverTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("caseId", targetDepth))
                {
                    ...
                    response.CaseId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateResolverTypeResponseUnmarshaller _instance = new UpdateResolverTypeResponseUnmarshaller();        

        internal static UpdateResolverTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResolverTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
