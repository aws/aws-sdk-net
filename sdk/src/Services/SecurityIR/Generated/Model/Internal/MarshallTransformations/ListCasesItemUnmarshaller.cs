...
namespace Amazon.SecurityIR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListCasesItemUnmarshaller : IUnmarshaller<ListCasesItem, XmlUnmarshallerContext>, IUnmarshaller<ListCasesItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ListCasesItem IUnmarshaller<ListCasesItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ListCasesItem Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("caseArn", targetDepth))
                {
                    ...
                    unmarshalledObject.CaseArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CaseStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EngagementType = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PendingAction = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("resolverType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResolverType = unmarshaller.Unmarshall(context);
                    continue;
                }
