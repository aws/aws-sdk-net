...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCase operation
    /// </summary>  
    public class UpdateCaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateCaseResponseUnmarshaller _instance = new UpdateCaseResponseUnmarshaller();        

        internal static UpdateCaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
