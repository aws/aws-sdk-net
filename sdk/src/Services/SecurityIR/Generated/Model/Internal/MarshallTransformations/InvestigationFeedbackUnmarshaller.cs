...
namespace Amazon.SecurityIR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvestigationFeedbackUnmarshaller : IJsonUnmarshaller<InvestigationFeedback, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InvestigationFeedback Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("usefulness", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Usefulness = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
