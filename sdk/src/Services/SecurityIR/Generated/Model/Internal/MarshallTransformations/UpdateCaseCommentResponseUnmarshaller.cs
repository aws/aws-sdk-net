...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCaseComment operation
    /// </summary>  
    public class UpdateCaseCommentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCaseCommentResponse response = new UpdateCaseCommentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("body", targetDepth, ref reader))
                {
                    ...
                    response.Body = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("commentId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CommentId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateCaseCommentResponseUnmarshaller _instance = new UpdateCaseCommentResponseUnmarshaller();        

        internal static UpdateCaseCommentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCaseCommentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
