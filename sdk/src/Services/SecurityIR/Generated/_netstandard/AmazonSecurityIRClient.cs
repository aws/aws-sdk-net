...
namespace Amazon.SecurityIR
{
    ...
    public partial class AmazonSecurityIRClient : AmazonServiceClient, IAmazonSecurityIR
    {
        ...
        internal virtual ListInvestigationsResponse ListInvestigations(ListInvestigationsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual SendFeedbackResponse SendFeedback(SendFeedbackRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
