...
namespace Amazon.SecurityIR
{
    ...
    public partial interface IAmazonSecurityIR : IAmazonService, IDisposable
    {
        ...
        Task<SendFeedbackResponse> SendFeedbackAsync(SendFeedbackRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
