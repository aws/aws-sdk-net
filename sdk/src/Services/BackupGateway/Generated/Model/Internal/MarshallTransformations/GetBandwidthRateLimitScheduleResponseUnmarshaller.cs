...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBandwidthRateLimitScheduleResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetBandwidthRateLimitSchedule");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "BandwidthRateLimitIntervals":
                        {
                            context.AddPathSegment("BandwidthRateLimitIntervals");
                            var unmarshaller = new CborListUnmarshaller<BandwidthRateLimitInterval, BandwidthRateLimitIntervalUnmarshaller>(BandwidthRateLimitIntervalUnmarshaller.Instance);
