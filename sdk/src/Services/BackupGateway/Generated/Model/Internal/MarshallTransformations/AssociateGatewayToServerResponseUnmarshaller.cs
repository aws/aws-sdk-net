...
{
    /// <summary>
    /// Response Unmarshaller for AssociateGatewayToServer operation
    /// </summary>  
    public class AssociateGatewayToServerResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateGatewayToServerResponse response = new AssociateGatewayToServerResponse();
            var reader = context.Reader;
            context.AddPathSegment("AssociateGatewayToServer");
            reader.ReadStartMap();
        ...
        private static AssociateGatewayToServerResponseUnmarshaller _instance = new AssociateGatewayToServerResponseUnmarshaller();        

        internal static AssociateGatewayToServerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateGatewayToServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
