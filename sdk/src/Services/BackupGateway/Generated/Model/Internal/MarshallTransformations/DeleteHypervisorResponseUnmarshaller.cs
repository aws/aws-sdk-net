...
{
    /// <summary>
    /// Response Unmarshaller for DeleteHypervisor operation
    /// </summary>  
    public class DeleteHypervisorResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteHypervisorResponse response = new DeleteHypervisorResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteHypervisor");
            reader.ReadStartMap();
        ...
        private static DeleteHypervisorResponseUnmarshaller _instance = new DeleteHypervisorResponseUnmarshaller();        

        internal static DeleteHypervisorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHypervisorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
