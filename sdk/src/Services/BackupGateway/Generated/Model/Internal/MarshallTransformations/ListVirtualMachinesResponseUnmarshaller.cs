...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVirtualMachinesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListVirtualMachines");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "VirtualMachines":
                        {
                            context.AddPathSegment("VirtualMachines");
                            var unmarshaller = new CborListUnmarshaller<VirtualMachine, VirtualMachineUnmarshaller>(VirtualMachineUnmarshaller.Instance);
