...
{
    /// <summary>
    /// Response Unmarshaller for GetHypervisor operation
    /// </summary>  
    public class GetHypervisorResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHypervisorResponse response = new GetHypervisorResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetHypervisor");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Hypervisor":
                        {
                            context.AddPathSegment("Hypervisor");
        ...
        private static GetHypervisorResponseUnmarshaller _instance = new GetHypervisorResponseUnmarshaller();        

        internal static GetHypervisorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHypervisorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
