...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VirtualMachineUnmarshaller : IJsonUnmarshaller<VirtualMachine, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VirtualMachine Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LastBackupDate", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.LastBackupDate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
