...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateGatewayFromServer operation
    /// </summary>  
    public class DisassociateGatewayFromServerResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateGatewayFromServerResponse response = new DisassociateGatewayFromServerResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateGatewayFromServer");
            reader.ReadStartMap();
        ...
        private static DisassociateGatewayFromServerResponseUnmarshaller _instance = new DisassociateGatewayFromServerResponseUnmarshaller();        

        internal static DisassociateGatewayFromServerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateGatewayFromServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
