...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListHypervisorsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListHypervisors");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Hypervisors":
                        {
                            context.AddPathSegment("Hypervisors");
                            var unmarshaller = new CborListUnmarshaller<Hypervisor, HypervisorUnmarshaller>(HypervisorUnmarshaller.Instance);
