...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    public class ListHypervisorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("Hypervisors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Hypervisor, HypervisorUnmarshaller>(HypervisorUnmarshaller.Instance);
                    response.Hypervisors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
