...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MaintenanceStartTimeUnmarshaller : ICborUnmarshaller<MaintenanceStartTime, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public MaintenanceStartTime Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "DayOfWeek":
                        {
                            context.AddPathSegment("DayOfWeek");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                    ...
                    case "HourOfDay":
                        {
                            context.AddPathSegment("HourOfDay");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                    ...
                    case "MinuteOfHour":
                        {
                            context.AddPathSegment("MinuteOfHour");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
