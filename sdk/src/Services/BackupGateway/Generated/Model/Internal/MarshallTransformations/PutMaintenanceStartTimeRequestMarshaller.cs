...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    public class PutMaintenanceStartTimeRequestMarshaller : IMarshaller<IRequest, PutMaintenanceStartTimeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutMaintenanceStartTimeRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/BackupOnPremises_v20210101/operation/PutMaintenanceStartTime";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("DayOfMonth");
                    context.Writer.WriteInt32(publicRequest.DayOfMonth.Value);
                }
                if (publicRequest.IsSetDayOfWeek())
                {
                    context.Writer.WriteTextString("DayOfWeek");
                    context.Writer.WriteInt32(publicRequest.DayOfWeek.Value);
                }
                ...
                {
                    context.Writer.WriteTextString("HourOfDay");
                    context.Writer.WriteInt32(publicRequest.HourOfDay.Value);
                }
                if (publicRequest.IsSetMinuteOfHour())
                {
                    context.Writer.WriteTextString("MinuteOfHour");
                    context.Writer.WriteInt32(publicRequest.MinuteOfHour.Value);
                }
                writer.WriteEndMap();
#if !NETFRAMEWORK
