...
{
    /// <summary>
    /// ImportHypervisorConfiguration Request Marshaller
    /// </summary>       
    public class ImportHypervisorConfigurationRequestMarshaller : IMarshaller<IRequest, ImportHypervisorConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ImportHypervisorConfigurationRequest)input);
        }
        ...
        internal static ImportHypervisorConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportHypervisorConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
