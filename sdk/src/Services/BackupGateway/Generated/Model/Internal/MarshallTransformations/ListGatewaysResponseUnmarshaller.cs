...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGatewaysResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListGateways");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Gateways":
                        {
                            context.AddPathSegment("Gateways");
                            var unmarshaller = new CborListUnmarshaller<Gateway, GatewayUnmarshaller>(GatewayUnmarshaller.Instance);
