...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetHypervisorPropertyMappingsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetHypervisorPropertyMappings");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "VmwareToAwsTagMappings":
                        {
                            context.AddPathSegment("VmwareToAwsTagMappings");
                            var unmarshaller = new CborListUnmarshaller<VmwareToAwsTagMapping, VmwareToAwsTagMappingUnmarshaller>(VmwareToAwsTagMappingUnmarshaller.Instance);
