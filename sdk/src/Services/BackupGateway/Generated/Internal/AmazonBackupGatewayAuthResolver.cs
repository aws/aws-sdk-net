...
namespace Amazon.BackupGateway.Internal
{
    ...
    public class AmazonBackupGatewayAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBackupGatewayAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BackupGateway.
        /// </summary>
        public AmazonBackupGatewayAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBackupGatewayAuthSchemeParameters
            {
    ...
    public class AmazonBackupGatewayAuthSchemeResolver : IAuthSchemeResolver<AmazonBackupGatewayAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBackupGatewayAuthSchemeParameters authParameters)
        {
