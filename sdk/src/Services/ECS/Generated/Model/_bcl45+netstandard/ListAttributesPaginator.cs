...
namespace Amazon.ECS.Model
{
    ...
    /// </summary>
    internal sealed partial class ListAttributesPaginator : IPaginator<ListAttributesResponse>, IListAttributesPaginator
    {
        private readonly IAmazonECS _client;
        private readonly ListAttributesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListAttributesResponse> Responses => new PaginatedResponse<ListAttributesResponse>(this);
...
#if BCL
        IEnumerable<ListAttributesResponse> IPaginator<ListAttributesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListAttributes(_request);
        ...
        async IAsyncEnumerable<ListAttributesResponse> IPaginator<ListAttributesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListAttributesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
