...
namespace Amazon.ECS.Model
{
    ...
    public partial class ServiceNotActiveException : AmazonECSException
    {
        ...
        /// <summary>
        /// Default constructor for ServiceNotActiveException
        /// message.
        /// </summary>
        ...
        public ServiceNotActiveException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ServiceNotActiveException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected ServiceNotActiveException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
