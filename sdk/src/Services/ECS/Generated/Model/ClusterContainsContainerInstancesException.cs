...
namespace Amazon.ECS.Model
{
    ...
    public partial class ClusterContainsContainerInstancesException : AmazonECSException
    {
        ...
        public ClusterContainsContainerInstancesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ClusterContainsContainerInstancesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
