...
{
    /// <summary>
    /// ListDaemons Request Marshaller
    /// </summary>       
    public class ListDaemonsRequestMarshaller : IMarshaller<IRequest, ListDaemonsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDaemonsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDaemonsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.ListDaemons";
        ...
        private static ListDaemonsRequestMarshaller _instance = new ListDaemonsRequestMarshaller();        

        internal static ListDaemonsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDaemonsRequestMarshaller Instance
        {
            get
            {
                return _instance;
