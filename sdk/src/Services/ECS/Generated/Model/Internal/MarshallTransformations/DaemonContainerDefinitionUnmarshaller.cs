...
{
    /// <summary>
    /// Response Unmarshaller for DaemonContainerDefinition Object
    /// </summary>  
    public class DaemonContainerDefinitionUnmarshaller : IJsonUnmarshaller<DaemonContainerDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DaemonContainerDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DaemonContainerDefinition unmarshalledObject = new DaemonContainerDefinition();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DaemonLinuxParametersUnmarshaller.Instance;
                ...
                if (context.TestExpression("restartPolicy", targetDepth, ref reader))
                {
        ...
        private static DaemonContainerDefinitionUnmarshaller _instance = new DaemonContainerDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DaemonContainerDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
