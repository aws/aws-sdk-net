...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDaemonTaskDefinition operation
    /// </summary>  
    public class DescribeDaemonTaskDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDaemonTaskDefinitionResponse response = new DescribeDaemonTaskDefinitionResponse();
        ...
        private static DescribeDaemonTaskDefinitionResponseUnmarshaller _instance = new DescribeDaemonTaskDefinitionResponseUnmarshaller();        

        internal static DescribeDaemonTaskDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDaemonTaskDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
