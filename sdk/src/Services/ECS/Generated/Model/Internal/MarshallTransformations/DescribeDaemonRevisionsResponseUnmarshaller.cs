...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDaemonRevisions operation
    /// </summary>  
    public class DescribeDaemonRevisionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDaemonRevisionsResponse response = new DescribeDaemonRevisionsResponse();
            ...
            {
                if (context.TestExpression("daemonRevisions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DaemonRevision, DaemonRevisionUnmarshaller>(DaemonRevisionUnmarshaller.Instance);
                    response.DaemonRevisions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeDaemonRevisionsResponseUnmarshaller _instance = new DescribeDaemonRevisionsResponseUnmarshaller();        

        internal static DescribeDaemonRevisionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDaemonRevisionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
