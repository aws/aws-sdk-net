...
{
    /// <summary>
    /// RegisterDaemonTaskDefinition Request Marshaller
    /// </summary>       
    public class RegisterDaemonTaskDefinitionRequestMarshaller : IMarshaller<IRequest, RegisterDaemonTaskDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RegisterDaemonTaskDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RegisterDaemonTaskDefinitionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.RegisterDaemonTaskDefinition";
            ...
            if(publicRequest.IsSetContainerDefinitions())
            {
                ...
                foreach(var publicRequestContainerDefinitionsListValue in publicRequest.ContainerDefinitions)
                {
                    ...
                    var marshaller = DaemonContainerDefinitionMarshaller.Instance;
            ...
            if(publicRequest.IsSetVolumes())
            {
                ...
                foreach(var publicRequestVolumesListValue in publicRequest.Volumes)
                {
                    ...
                    var marshaller = DaemonVolumeMarshaller.Instance;
        ...
        private static RegisterDaemonTaskDefinitionRequestMarshaller _instance = new RegisterDaemonTaskDefinitionRequestMarshaller();        

        internal static RegisterDaemonTaskDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterDaemonTaskDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
