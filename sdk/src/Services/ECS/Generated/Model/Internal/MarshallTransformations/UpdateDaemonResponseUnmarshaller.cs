...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDaemon operation
    /// </summary>  
    public class UpdateDaemonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDaemonResponse response = new UpdateDaemonResponse();
        ...
        private static UpdateDaemonResponseUnmarshaller _instance = new UpdateDaemonResponseUnmarshaller();        

        internal static UpdateDaemonResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDaemonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
