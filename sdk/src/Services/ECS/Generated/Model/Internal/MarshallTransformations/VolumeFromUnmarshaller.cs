...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VolumeFromUnmarshaller : IJsonUnmarshaller<VolumeFrom, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VolumeFrom Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("sourceContainer", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SourceContainer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
