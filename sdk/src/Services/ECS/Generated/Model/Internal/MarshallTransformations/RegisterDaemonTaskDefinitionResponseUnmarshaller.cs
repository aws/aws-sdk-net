...
{
    /// <summary>
    /// Response Unmarshaller for RegisterDaemonTaskDefinition operation
    /// </summary>  
    public class RegisterDaemonTaskDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterDaemonTaskDefinitionResponse response = new RegisterDaemonTaskDefinitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("daemonTaskDefinitionArn", targetDepth))
                {
                    ...
                    response.DaemonTaskDefinitionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RegisterDaemonTaskDefinitionResponseUnmarshaller _instance = new RegisterDaemonTaskDefinitionResponseUnmarshaller();        

        internal static RegisterDaemonTaskDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterDaemonTaskDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
