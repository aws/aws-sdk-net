...
{
    /// <summary>
    /// Response Unmarshaller for DaemonLinuxParameters Object
    /// </summary>  
    public class DaemonLinuxParametersUnmarshaller : IJsonUnmarshaller<DaemonLinuxParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DaemonLinuxParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DaemonLinuxParameters unmarshalledObject = new DaemonLinuxParameters();
        ...
        private static DaemonLinuxParametersUnmarshaller _instance = new DaemonLinuxParametersUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DaemonLinuxParametersUnmarshaller Instance
        {
            get
            {
                return _instance;
