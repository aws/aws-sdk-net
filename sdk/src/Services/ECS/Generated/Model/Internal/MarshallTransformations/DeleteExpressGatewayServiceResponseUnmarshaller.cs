...
{
    /// <summary>
    /// Response Unmarshaller for DeleteExpressGatewayService operation
    /// </summary>  
    public class DeleteExpressGatewayServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteExpressGatewayServiceResponse response = new DeleteExpressGatewayServiceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ECSExpressGatewayServiceUnmarshaller.Instance;
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ServiceNotActiveExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeleteExpressGatewayServiceResponseUnmarshaller _instance = new DeleteExpressGatewayServiceResponseUnmarshaller();        

        internal static DeleteExpressGatewayServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExpressGatewayServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
