...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteTaskDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTaskDefinitionsResponse response = new DeleteTaskDefinitionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("taskDefinitions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TaskDefinition, TaskDefinitionUnmarshaller>(TaskDefinitionUnmarshaller.Instance);
                    response.TaskDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteTaskDefinitionsResponseUnmarshaller _instance = new DeleteTaskDefinitionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTaskDefinitionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
