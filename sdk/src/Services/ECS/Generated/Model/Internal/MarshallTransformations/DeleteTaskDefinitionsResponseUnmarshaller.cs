    ...
    public class DeleteTaskDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TaskDefinition, TaskDefinitionUnmarshaller>(TaskDefinitionUnmarshaller.Instance);
                    response.TaskDefinitions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
