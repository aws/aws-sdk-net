...
{
    /// <summary>
    /// Response Unmarshaller for ContinueServiceDeployment operation
    /// </summary>  
    public class ContinueServiceDeploymentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ContinueServiceDeploymentResponse response = new ContinueServiceDeploymentResponse();
        ...
        private static ContinueServiceDeploymentResponseUnmarshaller _instance = new ContinueServiceDeploymentResponseUnmarshaller();        

        internal static ContinueServiceDeploymentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ContinueServiceDeploymentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
