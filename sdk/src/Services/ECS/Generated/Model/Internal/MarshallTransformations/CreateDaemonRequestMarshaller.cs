...
{
    /// <summary>
    /// CreateDaemon Request Marshaller
    /// </summary>       
    public class CreateDaemonRequestMarshaller : IMarshaller<IRequest, CreateDaemonRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDaemonRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDaemonRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.CreateDaemon";
        ...
        private static CreateDaemonRequestMarshaller _instance = new CreateDaemonRequestMarshaller();        

        internal static CreateDaemonRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDaemonRequestMarshaller Instance
        {
            get
            {
                return _instance;
