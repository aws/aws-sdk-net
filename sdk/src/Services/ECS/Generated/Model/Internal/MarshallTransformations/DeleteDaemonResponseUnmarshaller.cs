...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDaemon operation
    /// </summary>  
    public class DeleteDaemonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDaemonResponse response = new DeleteDaemonResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("daemonArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DaemonArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DaemonNotActiveException"))
                {
                    return DaemonNotActiveExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("DaemonNotFoundException"))
                {
                    return DaemonNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeleteDaemonResponseUnmarshaller _instance = new DeleteDaemonResponseUnmarshaller();        

        internal static DeleteDaemonResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDaemonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
