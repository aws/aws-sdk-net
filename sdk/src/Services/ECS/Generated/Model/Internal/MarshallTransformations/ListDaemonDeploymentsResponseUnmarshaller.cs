...
{
    /// <summary>
    /// Response Unmarshaller for ListDaemonDeployments operation
    /// </summary>  
    public class ListDaemonDeploymentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDaemonDeploymentsResponse response = new ListDaemonDeploymentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DaemonDeploymentSummary, DaemonDeploymentSummaryUnmarshaller>(DaemonDeploymentSummaryUnmarshaller.Instance);
        ...
        private static ListDaemonDeploymentsResponseUnmarshaller _instance = new ListDaemonDeploymentsResponseUnmarshaller();        

        internal static ListDaemonDeploymentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDaemonDeploymentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
