...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDaemon operation
    /// </summary>  
    public class DescribeDaemonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDaemonResponse response = new DescribeDaemonResponse();
            ...
            {
                if (context.TestExpression("daemon", targetDepth, ref reader))
                {
                    var unmarshaller = DaemonDetailUnmarshaller.Instance;
                    response.Daemon = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeDaemonResponseUnmarshaller _instance = new DescribeDaemonResponseUnmarshaller();        

        internal static DescribeDaemonResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDaemonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
