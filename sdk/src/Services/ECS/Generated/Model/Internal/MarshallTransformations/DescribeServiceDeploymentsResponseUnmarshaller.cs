    ...
    public class DescribeServiceDeploymentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ServiceDeployment, ServiceDeploymentUnmarshaller>(ServiceDeploymentUnmarshaller.Instance);
                    response.ServiceDeployments = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
