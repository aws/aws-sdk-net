...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTaskDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTaskDefinitionsResponse response = new ListTaskDefinitionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("taskDefinitionArns", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.TaskDefinitionArns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTaskDefinitionsResponseUnmarshaller _instance = new ListTaskDefinitionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTaskDefinitionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
