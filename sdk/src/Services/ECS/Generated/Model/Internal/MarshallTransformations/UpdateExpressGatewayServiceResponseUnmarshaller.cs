...
{
    /// <summary>
    /// Response Unmarshaller for UpdateExpressGatewayService operation
    /// </summary>  
    public class UpdateExpressGatewayServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExpressGatewayServiceResponse response = new UpdateExpressGatewayServiceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = UpdatedExpressGatewayServiceUnmarshaller.Instance;
        ...
        private static UpdateExpressGatewayServiceResponseUnmarshaller _instance = new UpdateExpressGatewayServiceResponseUnmarshaller();        

        internal static UpdateExpressGatewayServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExpressGatewayServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
