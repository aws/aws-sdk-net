    ...
    public class MonitoringConfigurationMarshaller : IRequestMarshaller<MonitoringConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(MonitoringConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetMetricConfigurations())
            {
                context.Writer.WritePropertyName("metricConfigurations");
                context.Writer.WriteStartArray();
                foreach(var requestObjectMetricConfigurationsListValue in requestObject.MetricConfigurations)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = MetricConfigurationMarshaller.Instance;
                    marshaller.Marshall(requestObjectMetricConfigurationsListValue, context);
