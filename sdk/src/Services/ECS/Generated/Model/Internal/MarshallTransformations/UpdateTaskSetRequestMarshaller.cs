...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateTaskSetRequestMarshaller : IMarshaller<IRequest, UpdateTaskSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTaskSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTaskSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.UpdateTaskSet";
            ...
            if(publicRequest.IsSetTaskSet())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TaskSet);
            }
        ...
        private static UpdateTaskSetRequestMarshaller _instance = new UpdateTaskSetRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTaskSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
