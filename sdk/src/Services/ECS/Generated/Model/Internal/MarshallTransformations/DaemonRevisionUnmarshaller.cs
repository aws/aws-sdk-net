...
{
    /// <summary>
    /// Response Unmarshaller for DaemonRevision Object
    /// </summary>  
    public class DaemonRevisionUnmarshaller : IJsonUnmarshaller<DaemonRevision, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DaemonRevision Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DaemonRevision unmarshalledObject = new DaemonRevision();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DaemonContainerImage, DaemonContainerImageUnmarshaller>(DaemonContainerImageUnmarshaller.Instance);
                ...
                if (context.TestExpression("daemonRevisionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DaemonRevisionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DaemonRevisionUnmarshaller _instance = new DaemonRevisionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DaemonRevisionUnmarshaller Instance
        {
            get
            {
                return _instance;
