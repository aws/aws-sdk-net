...
{
    /// <summary>
    /// Response Unmarshaller for CreateExpressGatewayService operation
    /// </summary>  
    public class CreateExpressGatewayServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateExpressGatewayServiceResponse response = new CreateExpressGatewayServiceResponse();
        ...
        private static CreateExpressGatewayServiceResponseUnmarshaller _instance = new CreateExpressGatewayServiceResponseUnmarshaller();        

        internal static CreateExpressGatewayServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExpressGatewayServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
