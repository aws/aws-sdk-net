...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateClusterSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateClusterSettingsResponse response = new UpdateClusterSettingsResponse();
        ...
        private static UpdateClusterSettingsResponseUnmarshaller _instance = new UpdateClusterSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateClusterSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
