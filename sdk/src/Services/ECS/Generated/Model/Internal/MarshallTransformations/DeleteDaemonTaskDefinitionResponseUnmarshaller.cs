...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDaemonTaskDefinition operation
    /// </summary>  
    public class DeleteDaemonTaskDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDaemonTaskDefinitionResponse response = new DeleteDaemonTaskDefinitionResponse();
        ...
        private static DeleteDaemonTaskDefinitionResponseUnmarshaller _instance = new DeleteDaemonTaskDefinitionResponseUnmarshaller();        

        internal static DeleteDaemonTaskDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDaemonTaskDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
