...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExpressGatewayContainerUnmarshaller : IJsonUnmarshaller<ExpressGatewayContainer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExpressGatewayContainer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("awsLogsConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = ExpressGatewayServiceAwsLogsConfigurationUnmarshaller.Instance;
                    unmarshalledObject.AwsLogsConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
