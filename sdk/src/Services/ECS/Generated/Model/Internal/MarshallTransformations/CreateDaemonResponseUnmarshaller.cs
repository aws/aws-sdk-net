...
{
    /// <summary>
    /// Response Unmarshaller for CreateDaemon operation
    /// </summary>  
    public class CreateDaemonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDaemonResponse response = new CreateDaemonResponse();
        ...
        private static CreateDaemonResponseUnmarshaller _instance = new CreateDaemonResponseUnmarshaller();        

        internal static CreateDaemonResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDaemonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
