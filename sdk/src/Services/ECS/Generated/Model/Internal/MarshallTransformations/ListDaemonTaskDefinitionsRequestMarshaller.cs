...
{
    /// <summary>
    /// ListDaemonTaskDefinitions Request Marshaller
    /// </summary>       
    public class ListDaemonTaskDefinitionsRequestMarshaller : IMarshaller<IRequest, ListDaemonTaskDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDaemonTaskDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDaemonTaskDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.ListDaemonTaskDefinitions";
        ...
        private static ListDaemonTaskDefinitionsRequestMarshaller _instance = new ListDaemonTaskDefinitionsRequestMarshaller();        

        internal static ListDaemonTaskDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDaemonTaskDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
