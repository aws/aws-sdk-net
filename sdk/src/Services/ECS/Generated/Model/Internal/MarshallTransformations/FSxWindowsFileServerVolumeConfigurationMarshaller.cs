...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    public class FSxWindowsFileServerVolumeConfigurationMarshaller : IRequestMarshaller<FSxWindowsFileServerVolumeConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(FSxWindowsFileServerVolumeConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAuthorizationConfig())
            {
                ...
                var marshaller = FSxWindowsFileServerAuthorizationConfigMarshaller.Instance;
