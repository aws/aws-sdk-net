...
{
    /// <summary>
    /// Response Unmarshaller for DescribeExpressGatewayService operation
    /// </summary>  
    public class DescribeExpressGatewayServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeExpressGatewayServiceResponse response = new DescribeExpressGatewayServiceResponse();
        ...
        private static DescribeExpressGatewayServiceResponseUnmarshaller _instance = new DescribeExpressGatewayServiceResponseUnmarshaller();        

        internal static DescribeExpressGatewayServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeExpressGatewayServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
