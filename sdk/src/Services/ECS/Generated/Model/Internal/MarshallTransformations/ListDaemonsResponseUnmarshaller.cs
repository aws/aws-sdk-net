...
{
    /// <summary>
    /// Response Unmarshaller for ListDaemons operation
    /// </summary>  
    public class ListDaemonsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDaemonsResponse response = new ListDaemonsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("daemonSummariesList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DaemonSummary, DaemonSummaryUnmarshaller>(DaemonSummaryUnmarshaller.Instance);
                    response.DaemonSummariesList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDaemonsResponseUnmarshaller _instance = new ListDaemonsResponseUnmarshaller();        

        internal static ListDaemonsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDaemonsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
