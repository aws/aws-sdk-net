...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    public class MonitoringConfigurationUnmarshaller : IJsonUnmarshaller<MonitoringConfiguration, JsonUnmarshallerContext>
    {
        ...
        public MonitoringConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("metricConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MetricConfiguration, MetricConfigurationUnmarshaller>(MetricConfigurationUnmarshaller.Instance);
                    unmarshalledObject.MetricConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
