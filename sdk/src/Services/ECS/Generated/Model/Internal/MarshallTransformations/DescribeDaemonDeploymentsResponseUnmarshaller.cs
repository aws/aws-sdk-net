...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDaemonDeployments operation
    /// </summary>  
    public class DescribeDaemonDeploymentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDaemonDeploymentsResponse response = new DescribeDaemonDeploymentsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("daemonDeployments", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DaemonDeployment, DaemonDeploymentUnmarshaller>(DaemonDeploymentUnmarshaller.Instance);
                    response.DaemonDeployments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeDaemonDeploymentsResponseUnmarshaller _instance = new DescribeDaemonDeploymentsResponseUnmarshaller();        

        internal static DescribeDaemonDeploymentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDaemonDeploymentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
