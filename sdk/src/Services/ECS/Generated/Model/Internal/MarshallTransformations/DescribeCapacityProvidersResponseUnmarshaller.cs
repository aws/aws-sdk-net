    ...
    public class DescribeCapacityProvidersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CapacityProvider, CapacityProviderUnmarshaller>(CapacityProviderUnmarshaller.Instance);
                    response.CapacityProviders = unmarshaller.Unmarshall(context);
                    continue;
                }
