...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeCapacityProvidersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCapacityProvidersResponse response = new DescribeCapacityProvidersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CapacityProvider, CapacityProviderUnmarshaller>(CapacityProviderUnmarshaller.Instance);
                    response.CapacityProviders = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeCapacityProvidersResponseUnmarshaller _instance = new DescribeCapacityProvidersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCapacityProvidersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
