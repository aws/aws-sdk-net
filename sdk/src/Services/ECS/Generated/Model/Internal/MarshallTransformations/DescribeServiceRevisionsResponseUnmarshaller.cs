    ...
    public class DescribeServiceRevisionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ServiceRevision, ServiceRevisionUnmarshaller>(ServiceRevisionUnmarshaller.Instance);
                    response.ServiceRevisions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
