...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateTaskProtectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTaskProtectionResponse response = new UpdateTaskProtectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProtectedTask, ProtectedTaskUnmarshaller>(ProtectedTaskUnmarshaller.Instance);
                    response.ProtectedTasks = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateTaskProtectionResponseUnmarshaller _instance = new UpdateTaskProtectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTaskProtectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
