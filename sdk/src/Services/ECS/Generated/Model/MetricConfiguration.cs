...
namespace Amazon.ECS.Model
{
    ...
    public partial class MetricConfiguration
    {
        ...
        private int? _resolutionSeconds;

        /// <summary>
        /// Gets and sets the property MetricNames. 
        /// <para>
        /// The list of metric names to configure. The supported metric names are <c>CPUUtilization</c>
        /// and <c>MemoryUtilization</c>.
        /// </para>
        /// <para />
        ...
        /// <summary>
        /// Gets and sets the property ResolutionSeconds. 
        /// <para>
        /// The resolution, in seconds, at which to collect the metrics. The valid values are
        /// <c>20</c> and <c>60</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true, Min=20, Max=60)]
        public int? ResolutionSeconds
        {
            get { return this._resolutionSeconds; }
            set { this._resolutionSeconds = value; }
        }

        // Check to see if ResolutionSeconds property is set
        internal bool IsSetResolutionSeconds()
        {
            return this._resolutionSeconds.HasValue; 
        }
