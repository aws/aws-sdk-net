...
namespace Amazon.ECS.Model
{
    ...
    public partial class HostVolumeProperties
    {
        ...
        /// until you delete it manually. If the <code>sourcePath</code> value doesn't exist on
        /// the host container instance, the Docker daemon creates it. If the location does exist,
        /// the contents of the source path folder are exported.
        /// </para>
        ///  
        /// <para>
        /// If you're using the Fargate launch type, the <code>sourcePath</code> parameter is
        /// not supported.
        /// </para>
        /// </summary>
