...
namespace Amazon.ECS
{
    ...
    /// <summary>
    /// Constants used for properties of type AutoRepairActionsStatus.
    /// </summary>
    public class AutoRepairActionsStatus : ConstantClass
    {

        /// <summary>
        /// Constant DISABLED for AutoRepairActionsStatus
        /// </summary>
        public static readonly AutoRepairActionsStatus DISABLED = new AutoRepairActionsStatus("DISABLED");
        /// <summary>
        /// Constant ENABLED for AutoRepairActionsStatus
        /// </summary>
        public static readonly AutoRepairActionsStatus ENABLED = new AutoRepairActionsStatus("ENABLED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public AutoRepairActionsStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static AutoRepairActionsStatus FindValue(string value)
        {
            return FindValue<AutoRepairActionsStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator AutoRepairActionsStatus(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type ExpressCpuArchitecture.
    /// </summary>
    public class ExpressCpuArchitecture : ConstantClass
    {

        /// <summary>
        /// Constant ARM64 for ExpressCpuArchitecture
        /// </summary>
        public static readonly ExpressCpuArchitecture ARM64 = new ExpressCpuArchitecture("ARM64");
        /// <summary>
        /// Constant X86_64 for ExpressCpuArchitecture
        /// </summary>
        public static readonly ExpressCpuArchitecture X86_64 = new ExpressCpuArchitecture("X86_64");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ExpressCpuArchitecture(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ExpressCpuArchitecture FindValue(string value)
        {
            return FindValue<ExpressCpuArchitecture>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ExpressCpuArchitecture(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type ServiceRevisionCleanup.
    /// </summary>
    public class ServiceRevisionCleanup : ConstantClass
    {

        /// <summary>
        /// Constant BLOCKING for ServiceRevisionCleanup
        /// </summary>
        public static readonly ServiceRevisionCleanup BLOCKING = new ServiceRevisionCleanup("BLOCKING");
        /// <summary>
        /// Constant DEFERRED for ServiceRevisionCleanup
        /// </summary>
        public static readonly ServiceRevisionCleanup DEFERRED = new ServiceRevisionCleanup("DEFERRED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ServiceRevisionCleanup(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ServiceRevisionCleanup FindValue(string value)
        {
            return FindValue<ServiceRevisionCleanup>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ServiceRevisionCleanup(string value)
        {
            return FindValue(value);
        }
    }
