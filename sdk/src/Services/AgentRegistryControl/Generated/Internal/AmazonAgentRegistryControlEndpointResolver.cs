...
{
    /// <summary>
    /// Amazon AgentRegistryControl endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for AgentRegistryControl service requests.
    /// Collects values for AgentRegistryControlEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses AgentRegistryControlEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonAgentRegistryControlEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonAgentRegistryControlConfig)requestContext.ClientConfig;
            var result = new AgentRegistryControlEndpointParameters();
