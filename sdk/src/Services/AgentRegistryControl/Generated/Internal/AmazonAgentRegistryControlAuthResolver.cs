...
namespace Amazon.AgentRegistryControl.Internal
{
    ...
    public class AmazonAgentRegistryControlAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAgentRegistryControlAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AgentRegistryControl.
        /// </summary>
        public AmazonAgentRegistryControlAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAgentRegistryControlAuthSchemeParameters
            {
    ...
    public class AmazonAgentRegistryControlAuthSchemeResolver : IAuthSchemeResolver<AmazonAgentRegistryControlAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAgentRegistryControlAuthSchemeParameters authParameters)
        {
