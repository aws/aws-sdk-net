...
{
    /// <summary>
    /// A credential provider configuration that specifies how to authenticate when fetching
    /// descriptor content from a registry record's source URL.
    /// </summary>
    public partial class RegistryRecordCredentialProviderConfiguration
    {
        ...
        /// <para>
        /// The credential provider details corresponding to the specified credential provider
        /// type.
        /// </para>
        /// </summary>
