...
namespace Amazon.AgentRegistryControl.Model
{
    ...
    public partial class RegistryRecordSummary
    {
        ...
        /// </summary>
        [AWSProperty(Max = 1)]
        public List<ProvenanceSummary> ProvenanceSummaryList { get; set; } = AWSConfigs.InitializeCollections ? new List<ProvenanceSummary>() : null;

        /// <summary>
        /// Checks to see if the ProvenanceSummaryList property is set.
        /// </summary>
        internal bool IsSetProvenanceSummaryList() => this.ProvenanceSummaryList != null && (this.ProvenanceSummaryList.Count > 0 || !AWSConfigs.InitializeCollections);
