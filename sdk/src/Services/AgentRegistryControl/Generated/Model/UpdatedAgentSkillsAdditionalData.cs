...
{
    /// <summary>
    /// The agent skills additional-data patch wrapper. Omit to leave the additional data
    /// unchanged; supply an empty object to remove it; supply optionalValue to patch its
    /// fields.
    /// </summary>
    public partial class UpdatedAgentSkillsAdditionalData
    {
        private UpdatedAgentSkillsAdditionalDataFields _optionalValue;
        ...
        /// </para>
        /// </summary>
        public UpdatedAgentSkillsAdditionalDataFields OptionalValue
        {
