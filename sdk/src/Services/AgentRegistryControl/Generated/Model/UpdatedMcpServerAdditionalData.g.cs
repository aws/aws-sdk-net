...
{
    /// <summary>
    /// The MCP server additional-data patch wrapper. Omit to leave the additional data unchanged;
    /// supply an empty object to remove it; supply optionalValue to patch its fields.
    /// </summary>
    public partial class UpdatedMcpServerAdditionalData
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public UpdatedMcpServerAdditionalDataFields OptionalValue { get; set; }
