...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PrivateEndpointUnmarshaller : IJsonUnmarshaller<PrivateEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PrivateEndpoint();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PrivateEndpointUnmarshaller Instance => _instance;
    }
}
