...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRegistryRecordRequestMarshaller : IMarshaller<IRequest, UpdateRegistryRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateRegistryRecordRequestMarshaller _instance = new();

        internal static UpdateRegistryRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRegistryRecordRequestMarshaller Instance => _instance;
    }
}
