...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthorizerConfigurationUnmarshaller : IJsonUnmarshaller<AuthorizerConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuthorizerConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("customJWTAuthorizer", targetDepth, ref reader))
                {
                    var unmarshaller = CustomJWTAuthorizerConfigurationUnmarshaller.Instance;
                    unmarshalledObject.CustomJWTAuthorizer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
