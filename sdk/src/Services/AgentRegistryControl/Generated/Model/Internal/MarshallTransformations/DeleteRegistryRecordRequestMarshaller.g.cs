...
{
    /// <summary>
    /// DeleteRegistryRecord Request Marshaller
    /// </summary>
    public partial class DeleteRegistryRecordRequestMarshaller : IMarshaller<IRequest, DeleteRegistryRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRegistryRecordRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteRegistryRecordRequest publicRequest)
        {
        ...
        private static readonly DeleteRegistryRecordRequestMarshaller _instance = new();

        internal static DeleteRegistryRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteRegistryRecordRequestMarshaller Instance => _instance;
    }
}
