...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRegistry operation
    /// </summary>  
    public class DeleteRegistryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRegistryResponse response = new DeleteRegistryResponse();
        ...
        private static DeleteRegistryResponseUnmarshaller _instance = new DeleteRegistryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegistryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
