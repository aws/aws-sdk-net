...
{
    /// <summary>
    /// DiscoveryConfiguration Marshaller
    /// </summary>
    public class DiscoveryConfigurationMarshaller : IRequestMarshaller<DiscoveryConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DiscoveryConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAuthorizerType())
            {
                context.Writer.WritePropertyName("authorizerType");
                context.Writer.WriteStringValue(requestObject.AuthorizerType);
            }
        ...
        /// </summary>
        public readonly static DiscoveryConfigurationMarshaller Instance = new DiscoveryConfigurationMarshaller();
