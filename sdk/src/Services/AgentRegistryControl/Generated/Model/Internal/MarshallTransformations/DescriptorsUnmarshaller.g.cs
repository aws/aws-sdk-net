...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescriptorsUnmarshaller : IJsonUnmarshaller<Descriptors, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Descriptors();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DescriptorsUnmarshaller Instance => _instance;
    }
}
