...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRegistryRecordsRequestMarshaller : IMarshaller<IRequest, ListRegistryRecordsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListRegistryRecordsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/registries/{registryId}/records-list";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetFilters())
            {
                ...
                foreach (var publicRequestFiltersListValue in publicRequest.Filters)
                {
                    ...
                    var marshaller = RegistryRecordFilterMarshaller.Instance;
        ...
        private static readonly ListRegistryRecordsRequestMarshaller _instance = new();

        internal static ListRegistryRecordsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRegistryRecordsRequestMarshaller Instance => _instance;
    }
}
