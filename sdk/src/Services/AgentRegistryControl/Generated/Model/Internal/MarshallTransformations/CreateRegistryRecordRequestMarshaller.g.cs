...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateRegistryRecordRequestMarshaller : IMarshaller<IRequest, CreateRegistryRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateRegistryRecordRequestMarshaller _instance = new();

        internal static CreateRegistryRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateRegistryRecordRequestMarshaller Instance => _instance;
    }
}
