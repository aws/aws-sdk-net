...
{
    /// <summary>
    /// Response Unmarshaller for SubmitRegistryRecordForApproval operation
    /// </summary>  
    public class SubmitRegistryRecordForApprovalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubmitRegistryRecordForApprovalResponse response = new SubmitRegistryRecordForApprovalResponse();
        ...
        private static SubmitRegistryRecordForApprovalResponseUnmarshaller _instance = new SubmitRegistryRecordForApprovalResponseUnmarshaller();        

        internal static SubmitRegistryRecordForApprovalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitRegistryRecordForApprovalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
