...
{
    /// <summary>
    /// Descriptors Marshaller
    /// </summary>
    public class DescriptorsMarshaller : IRequestMarshaller<Descriptors, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Descriptors requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetA2aAgentCard())
            {
                ...
                var marshaller = A2aAgentCardDescriptorMarshaller.Instance;
            ...
            if(requestObject.IsSetAgentSkillsDefinition())
            {
                ...
                var marshaller = AgentSkillsDefinitionDescriptorMarshaller.Instance;
            ...
            if(requestObject.IsSetAgui())
            {
                ...
                var marshaller = AgUiDescriptorMarshaller.Instance;
            ...
            if(requestObject.IsSetCustom())
            {
                ...
                var marshaller = CustomDescriptorMarshaller.Instance;
            ...
            if(requestObject.IsSetHttp())
            {
                ...
                var marshaller = HttpDescriptorMarshaller.Instance;
            ...
            if(requestObject.IsSetMcpServer())
            {
                ...
                var marshaller = McpServerDescriptorMarshaller.Instance;
        ...
        /// </summary>
        public readonly static DescriptorsMarshaller Instance = new DescriptorsMarshaller();
