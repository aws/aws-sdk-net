...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuthorizingClaimMatchValueTypeUnmarshaller : IJsonUnmarshaller<AuthorizingClaimMatchValueType, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AuthorizingClaimMatchValueType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AuthorizingClaimMatchValueType();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AuthorizingClaimMatchValueTypeUnmarshaller Instance => _instance;
    }
}
