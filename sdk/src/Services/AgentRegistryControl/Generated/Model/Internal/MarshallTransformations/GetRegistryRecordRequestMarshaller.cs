...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetRegistryRecordRequestMarshaller : IMarshaller<IRequest, GetRegistryRecordRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetRegistryRecordRequestMarshaller _instance = new GetRegistryRecordRequestMarshaller();        

        internal static GetRegistryRecordRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegistryRecordRequestMarshaller Instance
        {
            get
            {
                return _instance;
