...
{
    /// <summary>
    /// Response Unmarshaller for McpToolsDescriptor Object
    /// </summary>  
    public class McpToolsDescriptorUnmarshaller : IJsonUnmarshaller<McpToolsDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public McpToolsDescriptor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            McpToolsDescriptor unmarshalledObject = new McpToolsDescriptor();
        ...
        private static McpToolsDescriptorUnmarshaller _instance = new McpToolsDescriptorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static McpToolsDescriptorUnmarshaller Instance
        {
            get
            {
                return _instance;
