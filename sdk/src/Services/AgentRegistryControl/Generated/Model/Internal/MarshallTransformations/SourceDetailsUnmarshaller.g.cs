...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SourceDetailsUnmarshaller : IJsonUnmarshaller<SourceDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SourceDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AgentCoreGatewaySourceDetailsUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = AgentCoreRuntimeSourceDetailsUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static SourceDetailsUnmarshaller Instance => _instance;
    }
}
