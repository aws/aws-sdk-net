...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegistryRecordSummaryUnmarshaller : IJsonUnmarshaller<RegistryRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RegistryRecordSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RegistryRecordSummaryUnmarshaller Instance => _instance;
    }
}
