...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRegistryRecordStatusRequestMarshaller : IMarshaller<IRequest, UpdateRegistryRecordStatusRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateRegistryRecordStatusRequestMarshaller _instance = new();

        internal static UpdateRegistryRecordStatusRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRegistryRecordStatusRequestMarshaller Instance => _instance;
    }
}
