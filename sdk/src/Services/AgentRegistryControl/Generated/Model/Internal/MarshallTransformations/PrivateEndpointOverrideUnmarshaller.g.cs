...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PrivateEndpointOverrideUnmarshaller : IJsonUnmarshaller<PrivateEndpointOverride, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PrivateEndpointOverride();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PrivateEndpointOverrideUnmarshaller Instance => _instance;
    }
}
