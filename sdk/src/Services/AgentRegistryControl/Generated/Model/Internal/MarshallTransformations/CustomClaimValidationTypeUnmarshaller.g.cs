...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomClaimValidationTypeUnmarshaller : IJsonUnmarshaller<CustomClaimValidationType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomClaimValidationType();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomClaimValidationTypeUnmarshaller Instance => _instance;
    }
}
