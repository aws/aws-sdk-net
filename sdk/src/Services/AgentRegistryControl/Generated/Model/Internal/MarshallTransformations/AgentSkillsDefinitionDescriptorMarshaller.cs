...
{
    /// <summary>
    /// AgentSkillsDefinitionDescriptor Marshaller
    /// </summary>
    public class AgentSkillsDefinitionDescriptorMarshaller : IRequestMarshaller<AgentSkillsDefinitionDescriptor, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AgentSkillsDefinitionDescriptor requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAdditionalData())
            {
                ...
                var marshaller = AgentSkillsAdditionalDataMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AgentSkillsDefinitionDescriptorMarshaller Instance = new AgentSkillsDefinitionDescriptorMarshaller();
