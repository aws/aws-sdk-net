...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRegistryRecord operation
    /// </summary>  
    public class DeleteRegistryRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRegistryRecordResponse response = new DeleteRegistryRecordResponse();
        ...
        private static DeleteRegistryRecordResponseUnmarshaller _instance = new DeleteRegistryRecordResponseUnmarshaller();        

        internal static DeleteRegistryRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegistryRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
