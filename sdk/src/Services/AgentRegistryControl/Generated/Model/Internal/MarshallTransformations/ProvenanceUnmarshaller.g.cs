...
{
    /// <summary>
    /// Response Unmarshaller for Provenance Object
    /// </summary>
    public partial class ProvenanceUnmarshaller : IJsonUnmarshaller<Provenance, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Provenance Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Provenance();
        ...
        private static ProvenanceUnmarshaller _instance = new ProvenanceUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ProvenanceUnmarshaller Instance => _instance;
    }
}
