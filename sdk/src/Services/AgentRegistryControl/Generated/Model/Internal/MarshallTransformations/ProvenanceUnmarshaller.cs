...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProvenanceUnmarshaller : IJsonUnmarshaller<Provenance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            Provenance unmarshalledObject = new Provenance();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProvenanceUnmarshaller Instance
        {
            get
            {
                return _instance;
