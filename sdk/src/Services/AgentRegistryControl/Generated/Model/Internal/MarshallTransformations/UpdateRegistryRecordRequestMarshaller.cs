...
{
    /// <summary>
    /// UpdateRegistryRecord Request Marshaller
    /// </summary>       
    public class UpdateRegistryRecordRequestMarshaller : IMarshaller<IRequest, UpdateRegistryRecordRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRegistryRecordRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRegistryRecordRequest publicRequest)
        {
            ...
            request.ResourcePath = "/registries/{registryId}/records/{recordId}";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetDescriptors())
            {
                ...
                var marshaller = UpdatedDescriptorsMarshaller.Instance;
            ...
            if(publicRequest.IsSetDisplayName())
            {
                ...
                var marshaller = UpdatedDisplayNameMarshaller.Instance;
                marshaller.Marshall(publicRequest.DisplayName, context);
            ...
            if(publicRequest.IsSetTriggerSynchronization())
            {
                context.Writer.WritePropertyName("triggerSynchronization");
                context.Writer.WriteBooleanValue(publicRequest.TriggerSynchronization.Value);
            }
        ...
        private static UpdateRegistryRecordRequestMarshaller _instance = new UpdateRegistryRecordRequestMarshaller();        

        internal static UpdateRegistryRecordRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRegistryRecordRequestMarshaller Instance
        {
            get
            {
                return _instance;
