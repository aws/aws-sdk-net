...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SubmitRegistryRecordForApprovalRequestMarshaller : IMarshaller<IRequest, SubmitRegistryRecordForApprovalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static SubmitRegistryRecordForApprovalRequestMarshaller _instance = new SubmitRegistryRecordForApprovalRequestMarshaller();        

        internal static SubmitRegistryRecordForApprovalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitRegistryRecordForApprovalRequestMarshaller Instance
        {
            get
            {
                return _instance;
