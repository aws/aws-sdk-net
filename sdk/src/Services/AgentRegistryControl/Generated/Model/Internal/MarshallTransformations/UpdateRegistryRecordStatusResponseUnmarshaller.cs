...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRegistryRecordStatus operation
    /// </summary>  
    public class UpdateRegistryRecordStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRegistryRecordStatusResponse response = new UpdateRegistryRecordStatusResponse();
        ...
        private static UpdateRegistryRecordStatusResponseUnmarshaller _instance = new UpdateRegistryRecordStatusResponseUnmarshaller();        

        internal static UpdateRegistryRecordStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRegistryRecordStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
