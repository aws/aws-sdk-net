...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRegistryRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateRegistryRecordResponse();
        ...
        internal static UpdateRegistryRecordResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRegistryRecordResponseUnmarshaller Instance => _instance;
    }
}
