...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegistrySummaryUnmarshaller : IJsonUnmarshaller<RegistrySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RegistrySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("discoveryConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = DiscoveryConfigurationUnmarshaller.Instance;
                    unmarshalledObject.DiscoveryConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
