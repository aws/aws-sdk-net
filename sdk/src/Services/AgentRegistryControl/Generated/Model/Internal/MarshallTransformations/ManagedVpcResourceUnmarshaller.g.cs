...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ManagedVpcResourceUnmarshaller : IJsonUnmarshaller<ManagedVpcResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ManagedVpcResource();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ManagedVpcResourceUnmarshaller Instance => _instance;
    }
}
