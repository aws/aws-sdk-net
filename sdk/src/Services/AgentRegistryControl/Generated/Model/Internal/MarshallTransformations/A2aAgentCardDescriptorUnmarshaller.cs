...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class A2aAgentCardDescriptorUnmarshaller : IJsonUnmarshaller<A2aAgentCardDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            A2aAgentCardDescriptor unmarshalledObject = new A2aAgentCardDescriptor();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static A2aAgentCardDescriptorUnmarshaller Instance
        {
            get
            {
                return _instance;
