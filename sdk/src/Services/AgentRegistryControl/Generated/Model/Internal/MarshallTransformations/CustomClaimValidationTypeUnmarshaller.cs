...
{
    /// <summary>
    /// Response Unmarshaller for CustomClaimValidationType Object
    /// </summary>  
    public class CustomClaimValidationTypeUnmarshaller : IJsonUnmarshaller<CustomClaimValidationType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomClaimValidationType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CustomClaimValidationType unmarshalledObject = new CustomClaimValidationType();
        ...
        private static CustomClaimValidationTypeUnmarshaller _instance = new CustomClaimValidationTypeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomClaimValidationTypeUnmarshaller Instance
        {
            get
            {
                return _instance;
