...
{
    /// <summary>
    /// GetRegistryRecord Request Marshaller
    /// </summary>
    public partial class GetRegistryRecordRequestMarshaller : IMarshaller<IRequest, GetRegistryRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRegistryRecordRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetRegistryRecordRequest publicRequest)
        {
        ...
        private static readonly GetRegistryRecordRequestMarshaller _instance = new();

        internal static GetRegistryRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRegistryRecordRequestMarshaller Instance => _instance;
    }
}
