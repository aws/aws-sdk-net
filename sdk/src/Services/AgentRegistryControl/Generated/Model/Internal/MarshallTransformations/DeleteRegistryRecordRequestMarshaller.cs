...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRegistryRecordRequestMarshaller : IMarshaller<IRequest, DeleteRegistryRecordRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteRegistryRecordRequestMarshaller _instance = new DeleteRegistryRecordRequestMarshaller();        

        internal static DeleteRegistryRecordRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegistryRecordRequestMarshaller Instance
        {
            get
            {
                return _instance;
