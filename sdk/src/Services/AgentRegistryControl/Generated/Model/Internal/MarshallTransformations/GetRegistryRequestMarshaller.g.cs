...
{
    /// <summary>
    /// GetRegistry Request Marshaller
    /// </summary>
    public partial class GetRegistryRequestMarshaller : IMarshaller<IRequest, GetRegistryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRegistryRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetRegistryRequest publicRequest)
        {
        ...
        private static readonly GetRegistryRequestMarshaller _instance = new();

        internal static GetRegistryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRegistryRequestMarshaller Instance => _instance;
    }
}
