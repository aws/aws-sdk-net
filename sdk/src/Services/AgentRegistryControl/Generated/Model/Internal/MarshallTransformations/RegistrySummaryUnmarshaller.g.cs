...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegistrySummaryUnmarshaller : IJsonUnmarshaller<RegistrySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RegistrySummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RegistrySummaryUnmarshaller Instance => _instance;
    }
}
