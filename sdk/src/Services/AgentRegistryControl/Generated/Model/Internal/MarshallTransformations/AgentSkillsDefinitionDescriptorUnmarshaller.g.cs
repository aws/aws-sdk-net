...
namespace Amazon.AgentRegistryControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AgentSkillsDefinitionDescriptorUnmarshaller : IJsonUnmarshaller<AgentSkillsDefinitionDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AgentSkillsDefinitionDescriptor();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AgentSkillsDefinitionDescriptorUnmarshaller Instance => _instance;
    }
}
