...
{
    /// <summary>
    /// Leaf patch wrapper for a descriptor's source configuration. Omit to leave unchanged;
    /// supply an empty object to unset; supply optionalValue to set.
    /// </summary>
    public partial class UpdatedDescriptorSource
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public DescriptorSource OptionalValue { get; set; }
