...
{
    /// <summary>
    /// The agent skills markdown descriptor patch wrapper. Omit to leave the descriptor unchanged;
    /// supply an empty object to remove it; supply optionalValue to patch its fields.
    /// </summary>
    public partial class UpdatedAgentSkillsMdDescriptor
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public UpdatedAgentSkillsMdDescriptorFields OptionalValue { get; set; }
