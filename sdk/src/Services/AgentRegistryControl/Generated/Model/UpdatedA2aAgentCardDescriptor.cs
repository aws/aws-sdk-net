...
{
    /// <summary>
    /// The A2A agent card descriptor patch wrapper. Omit to leave the descriptor unchanged;
    /// supply an empty object to remove it; supply optionalValue to patch its fields.
    /// </summary>
    public partial class UpdatedA2aAgentCardDescriptor
    {
        private UpdatedA2aAgentCardDescriptorFields _optionalValue;
        ...
        /// </para>
        /// </summary>
        public UpdatedA2aAgentCardDescriptorFields OptionalValue
        {
