...
{
    /// <summary>
    /// The MCP server descriptor patch wrapper. Omit to leave the descriptor unchanged; supply
    /// an empty object to remove it; supply optionalValue to patch its fields.
    /// </summary>
    public partial class UpdatedMcpServerDescriptor
    {
        private UpdatedMcpServerDescriptorFields _optionalValue;
        ...
        /// </para>
        /// </summary>
        public UpdatedMcpServerDescriptorFields OptionalValue
        {
