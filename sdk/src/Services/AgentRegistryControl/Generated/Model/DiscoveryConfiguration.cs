...
{
    /// <summary>
    /// Discovery configuration for the registry. Controls how consumers are authorized to
    /// search the registry and invoke its MCP endpoint.
    /// </summary>
    public partial class DiscoveryConfiguration
    {
        ...
        /// <para>
        /// The type of authorizer that controls how consumers access the registry's search and
        /// MCP invoke operations.
        /// </para>
        /// </summary>
