...
{
    /// <summary>
    /// The top-level descriptors patch wrapper used in UpdateRegistryRecord. Omit to leave
    /// the current descriptors unchanged; supply an empty object to clear them; supply optionalValue
    /// to apply a per-field patch.
    /// </summary>
    public partial class UpdatedDescriptors
    {
        private UpdatedDescriptorsFields _optionalValue;
        ...
        /// </para>
        /// </summary>
        public UpdatedDescriptorsFields OptionalValue
        {
