...
namespace Amazon.AgentRegistryControl.Model
{
    ...
    public partial class AuthorizingClaimMatchValueType
    {
        ...
        public ClaimMatchOperatorType ClaimMatchOperator { get; set; }

        /// <summary>
        /// Checks to see if the ClaimMatchOperator property is set.
        /// </summary>
        internal bool IsSetClaimMatchOperator() => this.ClaimMatchOperator != null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public ClaimMatchValueType ClaimMatchValue { get; set; }

        /// <summary>
        /// Checks to see if the ClaimMatchValue property is set.
        /// </summary>
        internal bool IsSetClaimMatchValue() => this.ClaimMatchValue != null;
    }
}
