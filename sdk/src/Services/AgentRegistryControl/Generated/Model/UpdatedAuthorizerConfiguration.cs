...
namespace Amazon.AgentRegistryControl.Model
{
    ...
    /// </summary>
    public partial class UpdatedAuthorizerConfiguration
    {
        private AuthorizerConfiguration _optionalValue;

        /// <summary>
        /// Gets and sets the property OptionalValue. 
        /// <para>
        /// The new authorizer configuration to set. Omit to leave the existing configuration
        /// unchanged.
        /// </para>
        /// </summary>
        public AuthorizerConfiguration OptionalValue
        {
