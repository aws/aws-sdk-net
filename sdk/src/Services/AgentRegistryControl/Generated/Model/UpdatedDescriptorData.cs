...
{
    /// <summary>
    /// Leaf patch wrapper for descriptor data. Omit to leave unchanged; supply an empty object
    /// to unset; supply optionalValue to set.
    /// </summary>
    public partial class UpdatedDescriptorData
    {
