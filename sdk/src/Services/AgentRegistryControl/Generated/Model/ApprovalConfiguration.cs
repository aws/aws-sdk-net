...
namespace Amazon.AgentRegistryControl.Model
{
    ...
    {
        private List<string> _autoApprovalRules = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        {
            get { return this._autoApprovalRules; }
            set { this._autoApprovalRules = value; }
        }

        // Check to see if AutoApprovalRules property is set
        internal bool IsSetAutoApprovalRules()
        {
            return this._autoApprovalRules != null && (this._autoApprovalRules.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
