...
namespace Amazon.AgentRegistryControl
{
    ...
    public partial class AmazonAgentRegistryControlClient : AmazonServiceClient, IAmazonAgentRegistryControl
    {
        ...
        /// 
        /// </summary>
        public AmazonAgentRegistryControlClient() : base(new AmazonAgentRegistryControlConfig()) { }
        ...
        public AmazonAgentRegistryControlClient(RegionEndpoint region) : base(new AmazonAgentRegistryControlConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAgentRegistryControlClient(AmazonAgentRegistryControlConfig config) : base(config) { }
