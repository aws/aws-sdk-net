    ...
    public class RoutingControlUnmarshaller : IUnmarshaller<RoutingControl, XmlUnmarshallerContext>, IUnmarshaller<RoutingControl, JsonUnmarshallerContext>
    {
        ...
        public RoutingControl Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ControlPanelName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutingControlName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RoutingControlState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutingControlState = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
