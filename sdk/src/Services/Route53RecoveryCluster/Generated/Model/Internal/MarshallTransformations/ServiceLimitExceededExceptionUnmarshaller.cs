...
namespace Amazon.Route53RecoveryCluster.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceLimitExceededExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ServiceLimitExceededException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ServiceLimitExceededException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ServiceLimitExceededException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            ServiceLimitExceededException unmarshalledObject = new ServiceLimitExceededException(errorResponse.Message, errorResponse.InnerException,
            ...
            if (context.Stream.Length > 0)
            {
                ...
                {
                    if (context.TestExpression("limitCode", targetDepth, ref reader))
                    {
        ...
        private static ServiceLimitExceededExceptionUnmarshaller _instance = new ServiceLimitExceededExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ServiceLimitExceededExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
