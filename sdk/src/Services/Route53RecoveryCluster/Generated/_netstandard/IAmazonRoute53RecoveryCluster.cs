...
namespace Amazon.Route53RecoveryCluster
{
    ...
    public partial interface IAmazonRoute53RecoveryCluster : IAmazonService, IDisposable
    {
        ...
        Task<ListRoutingControlsResponse> ListRoutingControlsAsync(ListRoutingControlsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRoute53RecoveryClusterConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRoute53RecoveryClusterConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRoute53RecoveryClusterConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRoute53RecoveryClusterConfig to create AmazonRoute53RecoveryClusterClient");
            }

            return awsCredentials == null ? 
                    new AmazonRoute53RecoveryClusterClient(serviceClientConfig) :
                    new AmazonRoute53RecoveryClusterClient(awsCredentials, serviceClientConfig);
        }
