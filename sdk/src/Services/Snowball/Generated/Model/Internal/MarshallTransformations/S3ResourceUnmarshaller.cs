...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ResourceUnmarshaller : ICborUnmarshaller<S3Resource, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3Resource Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "BucketArn":
                        {
                            context.AddPathSegment("BucketArn");
                    ...
                    case "KeyRange":
                        {
                            context.AddPathSegment("KeyRange");
                    ...
                    case "TargetOnDeviceServices":
                        {
                            context.AddPathSegment("TargetOnDeviceServices");
                            var unmarshaller = new CborListUnmarshaller<TargetOnDeviceService, TargetOnDeviceServiceUnmarshaller>(TargetOnDeviceServiceUnmarshaller.Instance);
