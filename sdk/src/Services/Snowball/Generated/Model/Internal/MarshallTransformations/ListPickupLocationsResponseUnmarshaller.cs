...
{
    /// <summary>
    /// Response Unmarshaller for ListPickupLocations operation
    /// </summary>  
    public class ListPickupLocationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPickupLocationsResponse response = new ListPickupLocationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListPickupLocations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Addresses":
                        {
                            context.AddPathSegment("Addresses");
                            var unmarshaller = new CborListUnmarshaller<Address, AddressUnmarshaller>(AddressUnmarshaller.Instance);
        ...
        private static ListPickupLocationsResponseUnmarshaller _instance = new ListPickupLocationsResponseUnmarshaller();        

        internal static ListPickupLocationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPickupLocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
