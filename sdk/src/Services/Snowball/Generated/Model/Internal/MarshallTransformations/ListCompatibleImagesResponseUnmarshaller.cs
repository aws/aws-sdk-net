    ...
    public class ListCompatibleImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CompatibleImage, CompatibleImageUnmarshaller>(CompatibleImageUnmarshaller.Instance);
                    response.CompatibleImages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
