...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListCompatibleImagesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListCompatibleImages");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "CompatibleImages":
                        {
                            context.AddPathSegment("CompatibleImages");
                            var unmarshaller = new CborListUnmarshaller<CompatibleImage, CompatibleImageUnmarshaller>(CompatibleImageUnmarshaller.Instance);
