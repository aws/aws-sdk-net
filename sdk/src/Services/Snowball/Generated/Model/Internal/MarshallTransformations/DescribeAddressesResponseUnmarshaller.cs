...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAddressesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAddresses");
            reader.ReadStartMap();
        ...
        private static DescribeAddressesResponseUnmarshaller _instance = new DescribeAddressesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAddressesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
