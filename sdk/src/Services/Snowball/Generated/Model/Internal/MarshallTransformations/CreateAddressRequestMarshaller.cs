...
{
    /// <summary>
    /// CreateAddress Request Marshaller
    /// </summary>       
    public class CreateAddressRequestMarshaller : IMarshaller<IRequest, CreateAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAddressRequest)input);
        }
        ...
        internal static CreateAddressRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAddressRequestMarshaller Instance
        {
            get
            {
                return _instance;
