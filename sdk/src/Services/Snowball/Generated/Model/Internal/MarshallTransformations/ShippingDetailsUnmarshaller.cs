...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ShippingDetailsUnmarshaller : ICborUnmarshaller<ShippingDetails, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ShippingDetails Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "InboundShipment":
                        {
                            context.AddPathSegment("InboundShipment");
                    ...
                    case "OutboundShipment":
                        {
                            context.AddPathSegment("OutboundShipment");
                            var unmarshaller = ShipmentUnmarshaller.Instance;
