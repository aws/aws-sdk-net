...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DependentServiceUnmarshaller : ICborUnmarshaller<DependentService, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public DependentService Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "ServiceVersion":
                        {
                            context.AddPathSegment("ServiceVersion");
