...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    public class ListServiceVersionsRequestMarshaller : IMarshaller<IRequest, ListServiceVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListServiceVersionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/AWSIESnowballJobManagementService/operation/ListServiceVersions";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("DependentServices");
                    context.Writer.WriteStartArray(publicRequest.DependentServices.Count);
                ...
                if (publicRequest.IsSetServiceName())
                {
                    ...
                    context.Writer.WriteTextString(publicRequest.ServiceName);
                }
                writer.WriteEndMap();
