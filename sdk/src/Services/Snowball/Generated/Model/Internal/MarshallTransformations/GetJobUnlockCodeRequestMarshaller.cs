...
{
    /// <summary>
    /// GetJobUnlockCode Request Marshaller
    /// </summary>       
    public class GetJobUnlockCodeRequestMarshaller : IMarshaller<IRequest, GetJobUnlockCodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetJobUnlockCodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetJobUnlockCodeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Snowball");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/AWSIESnowballJobManagementService/operation/GetJobUnlockCode";
