...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListClustersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ClusterListEntry, ClusterListEntryUnmarshaller>(ClusterListEntryUnmarshaller.Instance);
                    response.ClusterListEntries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
