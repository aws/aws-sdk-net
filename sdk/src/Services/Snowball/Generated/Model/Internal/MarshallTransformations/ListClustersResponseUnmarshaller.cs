...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListClustersResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListClusters");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ClusterListEntries":
                        {
                            context.AddPathSegment("ClusterListEntries");
                            var unmarshaller = new CborListUnmarshaller<ClusterListEntry, ClusterListEntryUnmarshaller>(ClusterListEntryUnmarshaller.Instance);
        ...
        private static ListClustersResponseUnmarshaller _instance = new ListClustersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClustersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
