...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ShipmentUnmarshaller : ICborUnmarshaller<Shipment, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Shipment Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "TrackingNumber":
                        {
                            context.AddPathSegment("TrackingNumber");
                            var unmarshaller = CborStringUnmarshaller.Instance;
