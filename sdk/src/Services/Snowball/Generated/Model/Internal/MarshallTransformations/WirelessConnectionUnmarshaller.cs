...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WirelessConnectionUnmarshaller : ICborUnmarshaller<WirelessConnection, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public WirelessConnection Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "IsWifiEnabled":
                        {
                            context.AddPathSegment("IsWifiEnabled");
