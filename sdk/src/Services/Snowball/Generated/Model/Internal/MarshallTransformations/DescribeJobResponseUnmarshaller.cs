        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("JobMetadata", targetDepth))
                {
                    ...
                    response.JobMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SubJobMetadata", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<JobMetadata, JobMetadataUnmarshaller>(JobMetadataUnmarshaller.Instance);
                    response.SubJobMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
