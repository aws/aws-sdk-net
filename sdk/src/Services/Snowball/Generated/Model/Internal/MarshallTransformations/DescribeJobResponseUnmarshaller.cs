...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeJobResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeJob");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "JobMetadata":
                        {
                            context.AddPathSegment("JobMetadata");
                    ...
                    case "SubJobMetadata":
                        {
                            context.AddPathSegment("SubJobMetadata");
                            var unmarshaller = new CborListUnmarshaller<JobMetadata, JobMetadataUnmarshaller>(JobMetadataUnmarshaller.Instance);
