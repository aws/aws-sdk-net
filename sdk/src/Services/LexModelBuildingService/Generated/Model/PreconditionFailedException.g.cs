...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class PreconditionFailedException : AmazonLexModelBuildingServiceException
    {
        ...
        /// Construct instance of PreconditionFailedException
        /// </summary>
        public PreconditionFailedException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of PreconditionFailedException
        /// </summary>
        public PreconditionFailedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of PreconditionFailedException
        /// </summary>
        public PreconditionFailedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
