...
{
    /// <summary>
    /// Container for the parameters to the GetBots operation. Returns bot information as
    /// follows: <ul> <li> <para> If you provide the <c>nameContains</c> field, the response
    /// includes information for the <c>$LATEST</c> version of all bots whose name contains
    /// the specified string. </para> </li> <li> <para> If you don't specify the <c>nameContains</c>
    /// field, the operation returns information about the <c>$LATEST</c> version of all of
    /// your bots. </para> </li> </ul> <para> This operation requires permission for the <c>lex:GetBots</c>
    /// action. </para>
    /// </summary>
