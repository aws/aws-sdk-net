...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class GetUtterancesViewResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<UtteranceList> Utterances { get; set; } = AWSConfigs.InitializeCollections ? new List<UtteranceList>() : null;

        /// <summary>
        /// Checks to see if the Utterances property is set.
        /// </summary>
        internal bool IsSetUtterances() => this.Utterances != null && (this.Utterances.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
