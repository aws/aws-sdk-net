...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class GetBotChannelAssociationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<BotChannelAssociation> BotChannelAssociations { get; set; } = AWSConfigs.InitializeCollections ? new List<BotChannelAssociation>() : null;

        /// <summary>
        /// Checks to see if the BotChannelAssociations property is set.
        /// </summary>
        internal bool IsSetBotChannelAssociations() => this.BotChannelAssociations != null && (this.BotChannelAssociations.Count > 0 || !AWSConfigs.InitializeCollections);
