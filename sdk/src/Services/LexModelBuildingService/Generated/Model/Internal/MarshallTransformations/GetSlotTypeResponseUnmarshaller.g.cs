...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSlotTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSlotTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("enumerationValues", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EnumerationValues = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("slotTypeConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SlotTypeConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ValueSelectionStrategy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetSlotTypeResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSlotTypeResponseUnmarshaller Instance => _instance;
    }
}
