...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSlotTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSlotTypesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SlotTypeMetadata, SlotTypeMetadataUnmarshaller>(SlotTypeMetadataUnmarshaller.Instance);
        ...
        private static GetSlotTypesResponseUnmarshaller _instance = new GetSlotTypesResponseUnmarshaller();

        internal static GetSlotTypesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSlotTypesResponseUnmarshaller Instance => _instance;
    }
}
