...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBotResponse response = new DeleteBotResponse();
        ...
        private static DeleteBotResponseUnmarshaller _instance = new DeleteBotResponseUnmarshaller();        

        internal static DeleteBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
