...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetBotChannelAssociationRequestMarshaller : IMarshaller<IRequest, GetBotChannelAssociationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetBotChannelAssociationRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetBotChannelAssociationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botName}/aliases/{botAlias}/channels/{name}";

            return request;
        }

        private static readonly GetBotChannelAssociationRequestMarshaller _instance = new();

        internal static GetBotChannelAssociationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetBotChannelAssociationRequestMarshaller Instance => _instance;
    }
}
