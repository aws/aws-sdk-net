...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteIntentVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIntentVersionResponse response = new DeleteIntentVersionResponse();
        ...
        private static DeleteIntentVersionResponseUnmarshaller _instance = new DeleteIntentVersionResponseUnmarshaller();        

        internal static DeleteIntentVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIntentVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
