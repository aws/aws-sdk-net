...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteSlotTypeRequestMarshaller : IMarshaller<IRequest, DeleteSlotTypeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteSlotTypeRequest publicRequest)
        {
            ...
            request.ResourcePath = "/slottypes/{name}";

            return request;
        }

        private static readonly DeleteSlotTypeRequestMarshaller _instance = new();

        internal static DeleteSlotTypeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSlotTypeRequestMarshaller Instance => _instance;
    }
}
