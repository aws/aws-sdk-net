...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetBotChannelAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetBotChannelAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("botConfiguration", targetDepth, ref reader))
                {
        ...
        internal static GetBotChannelAssociationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetBotChannelAssociationResponseUnmarshaller Instance => _instance;
    }
}
