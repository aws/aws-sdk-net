...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBotsResponse response = new GetBotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BotMetadata, BotMetadataUnmarshaller>(BotMetadataUnmarshaller.Instance);
                    response.Bots = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetBotsResponseUnmarshaller _instance = new GetBotsResponseUnmarshaller();        

        internal static GetBotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
