...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteBotVersionRequestMarshaller : IMarshaller<IRequest, DeleteBotVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteBotVersionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{name}/versions/{version}";

            return request;
        }

        private static readonly DeleteBotVersionRequestMarshaller _instance = new();

        internal static DeleteBotVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteBotVersionRequestMarshaller Instance => _instance;
    }
}
