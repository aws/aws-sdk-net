...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteIntentRequestMarshaller : IMarshaller<IRequest, DeleteIntentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteIntentRequestMarshaller _instance = new();

        internal static DeleteIntentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteIntentRequestMarshaller Instance => _instance;
    }
}
