...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteBotVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBotVersionResponse response = new DeleteBotVersionResponse();
        ...
        private static DeleteBotVersionResponseUnmarshaller _instance = new DeleteBotVersionResponseUnmarshaller();        

        internal static DeleteBotVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBotVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
