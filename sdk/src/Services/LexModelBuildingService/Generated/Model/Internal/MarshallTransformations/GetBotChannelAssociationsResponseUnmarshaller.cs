...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBotChannelAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBotChannelAssociationsResponse response = new GetBotChannelAssociationsResponse();
            ...
            {
                if (context.TestExpression("botChannelAssociations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BotChannelAssociation, BotChannelAssociationUnmarshaller>(BotChannelAssociationUnmarshaller.Instance);
                    response.BotChannelAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetBotChannelAssociationsResponseUnmarshaller _instance = new GetBotChannelAssociationsResponseUnmarshaller();        

        internal static GetBotChannelAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBotChannelAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
