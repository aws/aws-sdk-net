...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteUtterancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUtterancesResponse response = new DeleteUtterancesResponse();
        ...
        private static DeleteUtterancesResponseUnmarshaller _instance = new DeleteUtterancesResponseUnmarshaller();        

        internal static DeleteUtterancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUtterancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
