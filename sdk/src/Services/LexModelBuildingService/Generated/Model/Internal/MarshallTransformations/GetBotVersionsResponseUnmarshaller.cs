...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBotVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBotVersionsResponse response = new GetBotVersionsResponse();
        ...
        private static GetBotVersionsResponseUnmarshaller _instance = new GetBotVersionsResponseUnmarshaller();        

        internal static GetBotVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBotVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
