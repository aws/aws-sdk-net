...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBotVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBotVersionResponse response = new CreateBotVersionResponse();
        ...
        private static CreateBotVersionResponseUnmarshaller _instance = new CreateBotVersionResponseUnmarshaller();        

        internal static CreateBotVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBotVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
