...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class GetBotAliasesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<BotAliasMetadata> BotAliases { get; set; } = AWSConfigs.InitializeCollections ? new List<BotAliasMetadata>() : null;

        /// <summary>
        /// Checks to see if the BotAliases property is set.
        /// </summary>
        internal bool IsSetBotAliases() => this.BotAliases != null && (this.BotAliases.Count > 0 || !AWSConfigs.InitializeCollections);
