...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class ConversationLogsResponse
    {
        ...
        /// </summary>
        public List<LogSettingsResponse> LogSettings { get; set; } = AWSConfigs.InitializeCollections ? new List<LogSettingsResponse>() : null;

        /// <summary>
        /// Checks to see if the LogSettings property is set.
        /// </summary>
        internal bool IsSetLogSettings() => this.LogSettings != null && (this.LogSettings.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
