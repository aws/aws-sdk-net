...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class GetMigrationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<MigrationSummary> MigrationSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<MigrationSummary>() : null;

        /// <summary>
        /// Checks to see if the MigrationSummaries property is set.
        /// </summary>
        internal bool IsSetMigrationSummaries() => this.MigrationSummaries != null && (this.MigrationSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
