...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class OutputContext
    {
        ...
        /// <summary>
        /// Checks to see if the TimeToLiveInSeconds property is set.
        /// </summary>
        internal bool IsSetTimeToLiveInSeconds() => this.TimeToLiveInSeconds.HasValue;
        ...
        /// <summary>
        /// Checks to see if the TurnsToLive property is set.
        /// </summary>
        internal bool IsSetTurnsToLive() => this.TurnsToLive.HasValue;
    }
}
