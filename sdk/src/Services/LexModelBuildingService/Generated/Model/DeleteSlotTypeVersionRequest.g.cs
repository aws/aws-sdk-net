...
{
    /// <summary>
    /// Container for the parameters to the DeleteSlotTypeVersion operation. Deletes a specific
    /// version of a slot type. To delete all versions of a slot type, use the <a>DeleteSlotType</a>
    /// operation. <para> This operation requires permissions for the <c>lex:DeleteSlotTypeVersion</c>
    /// action. </para>
    /// </summary>
