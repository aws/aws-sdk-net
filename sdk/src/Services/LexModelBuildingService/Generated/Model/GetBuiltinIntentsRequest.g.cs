...
{
    /// <summary>
    /// Container for the parameters to the GetBuiltinIntents operation. Gets a list of built-in
    /// intents that meet the specified criteria. <para> This operation requires permission
    /// for the <c>lex:GetBuiltinIntents</c> action. </para>
    /// </summary>
