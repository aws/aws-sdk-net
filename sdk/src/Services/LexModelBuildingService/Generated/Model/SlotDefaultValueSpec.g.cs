...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class SlotDefaultValueSpec
    {
        ...
        public List<SlotDefaultValue> DefaultValueList { get; set; } = AWSConfigs.InitializeCollections ? new List<SlotDefaultValue>() : null;

        /// <summary>
        /// Checks to see if the DefaultValueList property is set.
        /// </summary>
        internal bool IsSetDefaultValueList() => this.DefaultValueList != null && (this.DefaultValueList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
