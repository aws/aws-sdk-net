...
{
    /// <summary>
    /// Container for the parameters to the GetMigration operation. Provides details about
    /// an ongoing or complete migration from an Amazon Lex V1 bot to an Amazon Lex V2 bot.
    /// Use this operation to view the migration alerts and warnings related to the migration.
    /// </summary>
