...
namespace Amazon.LexModelBuildingService
{
    ...
    public partial class AmazonLexModelBuildingServiceConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Lex Model Building Service", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Lex Model Building Service";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "models.lex";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2017-04-19";
