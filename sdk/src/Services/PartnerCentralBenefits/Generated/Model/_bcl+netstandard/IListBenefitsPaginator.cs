...
namespace Amazon.PartnerCentralBenefits.Model
{
    ...
    public interface IListBenefitsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListBenefitsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the BenefitSummaries
        /// </summary>
        IPaginatedEnumerable<BenefitSummary> BenefitSummaries { get; }
    }
}