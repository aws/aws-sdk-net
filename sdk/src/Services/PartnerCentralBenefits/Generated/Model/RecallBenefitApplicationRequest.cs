...
{
    /// <summary>
    /// Container for the parameters to the RecallBenefitApplication operation.
    /// Recalls a submitted benefit application, returning it to draft status for further
    /// modifications.
    /// </summary>
    public partial class RecallBenefitApplicationRequest : AmazonPartnerCentralBenefitsRequest
    {
        ...
        /// <para>
        /// A unique, case-sensitive identifier to ensure idempotent processing of the recall
        /// request.
        /// </para>
        /// </summary>
