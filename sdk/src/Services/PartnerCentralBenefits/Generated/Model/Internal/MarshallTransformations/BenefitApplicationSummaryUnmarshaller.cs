...
namespace Amazon.PartnerCentralBenefits.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BenefitApplicationSummaryUnmarshaller : IJsonUnmarshaller<BenefitApplicationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BenefitApplicationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("BenefitApplicationDetails", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.BenefitApplicationDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("BenefitId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("FulfillmentTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
