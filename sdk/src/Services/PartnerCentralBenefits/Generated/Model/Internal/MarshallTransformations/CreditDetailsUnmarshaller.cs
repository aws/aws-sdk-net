...
namespace Amazon.PartnerCentralBenefits.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreditDetailsUnmarshaller : IUnmarshaller<CreditDetails, XmlUnmarshallerContext>, IUnmarshaller<CreditDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CreditDetails IUnmarshaller<CreditDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CreditDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AllocatedAmount", targetDepth))
                {
                    ...
                    unmarshalledObject.AllocatedAmount = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Codes", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<CreditCode, CreditCodeUnmarshaller>(CreditCodeUnmarshaller.Instance);
                    unmarshalledObject.Codes = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("IssuedAmount", targetDepth))
                {
                    var unmarshaller = MonetaryValueUnmarshaller.Instance;
                    unmarshalledObject.IssuedAmount = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
