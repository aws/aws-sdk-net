...
namespace Amazon.PartnerCentralBenefits.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConsumableDetailsUnmarshaller : IUnmarshaller<ConsumableDetails, XmlUnmarshallerContext>, IUnmarshaller<ConsumableDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ConsumableDetails IUnmarshaller<ConsumableDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ConsumableDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("IssuanceDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.IssuanceDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RemainingAmount", targetDepth))
                {
                    var unmarshaller = MonetaryValueUnmarshaller.Instance;
                    unmarshalledObject.RemainingAmount = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("UtilizedAmount", targetDepth))
                {
                    var unmarshaller = MonetaryValueUnmarshaller.Instance;
                    unmarshalledObject.UtilizedAmount = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
