...
namespace Amazon.PartnerCentralBenefits.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisbursementDetailsUnmarshaller : IUnmarshaller<DisbursementDetails, XmlUnmarshallerContext>, IUnmarshaller<DisbursementDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DisbursementDetails IUnmarshaller<DisbursementDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DisbursementDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DisbursedAmount", targetDepth))
                {
                    ...
                    unmarshalledObject.DisbursedAmount = unmarshaller.Unmarshall(context);
                    continue;
                }
