...
namespace Amazon.PartnerCentralBenefits.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FileDetailUnmarshaller : IUnmarshaller<FileDetail, XmlUnmarshallerContext>, IUnmarshaller<FileDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FileDetail IUnmarshaller<FileDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public FileDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BusinessUseCase", targetDepth))
                {
                    ...
                    unmarshalledObject.BusinessUseCase = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FileStatusReason", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileStatusReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileURI = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
