...
{
    /// <summary>
    /// ListBenefits Request Marshaller
    /// </summary>       
    public class ListBenefitsRequestMarshaller : IMarshaller<IRequest, ListBenefitsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListBenefitsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListBenefitsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralBenefits");
            string target = "PartnerCentralBenefitsService.ListBenefits";
        ...
        private static ListBenefitsRequestMarshaller _instance = new ListBenefitsRequestMarshaller();        

        internal static ListBenefitsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBenefitsRequestMarshaller Instance
        {
            get
            {
                return _instance;
