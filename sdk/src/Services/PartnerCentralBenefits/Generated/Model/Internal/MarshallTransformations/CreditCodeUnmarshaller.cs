...
namespace Amazon.PartnerCentralBenefits.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreditCodeUnmarshaller : IUnmarshaller<CreditCode, XmlUnmarshallerContext>, IUnmarshaller<CreditCode, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CreditCode IUnmarshaller<CreditCode, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CreditCode Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AwsCreditCode = unmarshaller.Unmarshall(context);
                    continue;
                }
