...
{
    /// <summary>
    /// This is the response object from the GetBenefit operation.
    /// </summary>
    public partial class GetBenefitResponse : AmazonWebServiceResponse
    {
        private string _arn;
        private Amazon.Runtime.Documents.Document _benefitRequestSchema;
        ...
        /// <summary>
        /// Gets and sets the property BenefitRequestSchema. 
        /// <para>
        /// The schema definition that describes the required fields for requesting this benefit.
        /// </para>
        /// </summary>
        public Amazon.Runtime.Documents.Document BenefitRequestSchema
        {
            get { return this._benefitRequestSchema; }
            set { this._benefitRequestSchema = value; }
        }

        // Check to see if BenefitRequestSchema property is set
        internal bool IsSetBenefitRequestSchema()
        {
            return !this._benefitRequestSchema.IsNull();
        }
