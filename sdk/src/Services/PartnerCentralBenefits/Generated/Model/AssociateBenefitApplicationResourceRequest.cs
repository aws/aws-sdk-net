...
{
    /// <summary>
    /// Container for the parameters to the AssociateBenefitApplicationResource operation.
    /// Links an AWS resource to an existing benefit application for tracking and management
    /// purposes.
    /// </summary>
    public partial class AssociateBenefitApplicationResourceRequest : AmazonPartnerCentralBenefitsRequest
    {
