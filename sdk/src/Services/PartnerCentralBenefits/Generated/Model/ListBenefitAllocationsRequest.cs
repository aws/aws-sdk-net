...
{
    /// <summary>
    /// Container for the parameters to the ListBenefitAllocations operation.
    /// Retrieves a paginated list of benefit allocations based on specified filter criteria.
    /// </summary>
    public partial class ListBenefitAllocationsRequest : AmazonPartnerCentralBenefitsRequest
    {
        private List<string> _benefitApplicationIdentifiers = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property BenefitApplicationIdentifiers. 
        /// <para>
        ...
        public List<string> BenefitApplicationIdentifiers
        {
            get { return this._benefitApplicationIdentifiers; }
            set { this._benefitApplicationIdentifiers = value; }
        }

        // Check to see if BenefitApplicationIdentifiers property is set
        internal bool IsSetBenefitApplicationIdentifiers()
        {
            return this._benefitApplicationIdentifiers != null && (this._benefitApplicationIdentifiers.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
