...
namespace Amazon.PartnerCentralBenefits.Internal
{
    ...
    public class AmazonPartnerCentralBenefitsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPartnerCentralBenefitsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PartnerCentralBenefits.
        /// </summary>
        public AmazonPartnerCentralBenefitsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPartnerCentralBenefitsAuthSchemeParameters
            {
    ...
    public class AmazonPartnerCentralBenefitsAuthSchemeResolver : IAuthSchemeResolver<AmazonPartnerCentralBenefitsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPartnerCentralBenefitsAuthSchemeParameters authParameters)
        {
