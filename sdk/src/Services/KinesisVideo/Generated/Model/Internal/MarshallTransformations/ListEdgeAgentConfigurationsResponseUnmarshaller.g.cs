...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEdgeAgentConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListEdgeAgentConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EdgeConfigs", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EdgeConfigs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListEdgeAgentConfigurationsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEdgeAgentConfigurationsResponseUnmarshaller Instance => _instance;
    }
}
