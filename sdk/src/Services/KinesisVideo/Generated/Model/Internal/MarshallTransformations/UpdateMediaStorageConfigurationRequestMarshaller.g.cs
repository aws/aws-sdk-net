...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateMediaStorageConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateMediaStorageConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateMediaStorageConfigurationRequestMarshaller _instance = new();

        internal static UpdateMediaStorageConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMediaStorageConfigurationRequestMarshaller Instance => _instance;
    }
}
