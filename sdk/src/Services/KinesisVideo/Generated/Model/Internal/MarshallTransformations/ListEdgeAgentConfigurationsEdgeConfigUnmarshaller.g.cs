...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEdgeAgentConfigurationsEdgeConfigUnmarshaller : IJsonUnmarshaller<ListEdgeAgentConfigurationsEdgeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ListEdgeAgentConfigurationsEdgeConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ListEdgeAgentConfigurationsEdgeConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ListEdgeAgentConfigurationsEdgeConfigUnmarshaller Instance => _instance;
    }
}
