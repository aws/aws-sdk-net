...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EdgeConfigUnmarshaller : IJsonUnmarshaller<EdgeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EdgeConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EdgeConfigUnmarshaller Instance => _instance;
    }
}
