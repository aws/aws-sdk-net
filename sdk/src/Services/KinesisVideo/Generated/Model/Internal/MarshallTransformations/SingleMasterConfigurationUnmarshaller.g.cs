...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SingleMasterConfigurationUnmarshaller : IJsonUnmarshaller<SingleMasterConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SingleMasterConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SingleMasterConfigurationUnmarshaller Instance => _instance;
    }
}
