...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    public class ListStreamsRequestMarshaller : IMarshaller<IRequest, ListStreamsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListStreamsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetStreamNameCondition())
            {
                context.Writer.WritePropertyName("StreamNameCondition");
                context.Writer.WriteStartObject();

                var marshaller = StreamNameConditionMarshaller.Instance;
                marshaller.Marshall(publicRequest.StreamNameCondition, context);
