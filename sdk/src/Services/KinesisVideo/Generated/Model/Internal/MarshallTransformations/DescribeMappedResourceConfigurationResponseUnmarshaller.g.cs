...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeMappedResourceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeMappedResourceConfigurationResponse();
            ...
            {
                if (context.TestExpression("MappedResourceConfigurationList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MappedResourceConfigurationListItem, MappedResourceConfigurationListItemUnmarshaller>(MappedResourceConfigurationListItemUnmarshaller.Instance);
                    unmarshalledObject.MappedResourceConfigurationList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeMappedResourceConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeMappedResourceConfigurationResponseUnmarshaller Instance => _instance;
    }
}
