...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StreamInfoUnmarshaller : IJsonUnmarshaller<StreamInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public StreamInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new StreamInfo();
        ...
        private static StreamInfoUnmarshaller _instance = new StreamInfoUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StreamInfoUnmarshaller Instance => _instance;
    }
}
