...
{
    /// <summary>
    /// Response Unmarshaller for DescribeStreamStorageConfiguration operation
    /// </summary>  
    public class DescribeStreamStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeStreamStorageConfigurationResponse response = new DescribeStreamStorageConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("StreamStorageConfiguration", targetDepth))
                {
                    ...
                    response.StreamStorageConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeStreamStorageConfigurationResponseUnmarshaller _instance = new DescribeStreamStorageConfigurationResponseUnmarshaller();        

        internal static DescribeStreamStorageConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStreamStorageConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
