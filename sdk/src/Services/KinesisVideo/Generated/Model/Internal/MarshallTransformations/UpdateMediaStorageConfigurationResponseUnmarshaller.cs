...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateMediaStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMediaStorageConfigurationResponse response = new UpdateMediaStorageConfigurationResponse();
        ...
        private static UpdateMediaStorageConfigurationResponseUnmarshaller _instance = new UpdateMediaStorageConfigurationResponseUnmarshaller();        

        internal static UpdateMediaStorageConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMediaStorageConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
