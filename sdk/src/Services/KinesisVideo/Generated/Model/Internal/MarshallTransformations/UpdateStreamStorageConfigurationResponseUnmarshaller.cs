...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateStreamStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateStreamStorageConfigurationResponse response = new UpdateStreamStorageConfigurationResponse();
        ...
        internal static UpdateStreamStorageConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStreamStorageConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
