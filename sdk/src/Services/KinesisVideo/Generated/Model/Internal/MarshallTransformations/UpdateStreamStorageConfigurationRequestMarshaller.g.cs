...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateStreamStorageConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateStreamStorageConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateStreamStorageConfigurationRequestMarshaller _instance = new();

        internal static UpdateStreamStorageConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateStreamStorageConfigurationRequestMarshaller Instance => _instance;
    }
}
