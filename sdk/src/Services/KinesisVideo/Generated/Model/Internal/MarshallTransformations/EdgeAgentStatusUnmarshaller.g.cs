...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EdgeAgentStatusUnmarshaller : IJsonUnmarshaller<EdgeAgentStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EdgeAgentStatus();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EdgeAgentStatusUnmarshaller Instance => _instance;
    }
}
