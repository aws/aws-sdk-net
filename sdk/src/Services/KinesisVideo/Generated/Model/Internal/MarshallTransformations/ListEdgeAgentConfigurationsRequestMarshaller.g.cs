...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEdgeAgentConfigurationsRequestMarshaller : IMarshaller<IRequest, ListEdgeAgentConfigurationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListEdgeAgentConfigurationsRequestMarshaller _instance = new();

        internal static ListEdgeAgentConfigurationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEdgeAgentConfigurationsRequestMarshaller Instance => _instance;
    }
}
