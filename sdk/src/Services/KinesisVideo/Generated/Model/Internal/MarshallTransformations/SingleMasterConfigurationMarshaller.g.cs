...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SingleMasterConfigurationMarshaller : IRequestMarshaller<SingleMasterConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(SingleMasterConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetMessageTtlSeconds())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.MessageTtlSeconds.Value);
            }
        }
