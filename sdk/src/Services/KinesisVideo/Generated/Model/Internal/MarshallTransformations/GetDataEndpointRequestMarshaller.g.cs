...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDataEndpointRequestMarshaller : IMarshaller<IRequest, GetDataEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetDataEndpointRequest publicRequest)
        {
            ...
            request.ResourcePath = "/getDataEndpoint";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetAPIName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.APIName);
            }
        ...
        private static readonly GetDataEndpointRequestMarshaller _instance = new();

        internal static GetDataEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDataEndpointRequestMarshaller Instance => _instance;
    }
}
