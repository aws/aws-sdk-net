...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDataRetentionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateDataRetentionResponse();
        ...
        private static UpdateDataRetentionResponseUnmarshaller _instance = new UpdateDataRetentionResponseUnmarshaller();

        internal static UpdateDataRetentionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDataRetentionResponseUnmarshaller Instance => _instance;
    }
}
