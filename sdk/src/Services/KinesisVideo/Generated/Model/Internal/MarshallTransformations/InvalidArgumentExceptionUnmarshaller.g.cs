...
{
    /// <summary>
    /// Exception Unmarshaller for InvalidArgumentException
    /// </summary>
    public partial class InvalidArgumentExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidArgumentException, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the exception from the service to the appropriate exception class
        /// </summary>
        public InvalidArgumentException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static InvalidArgumentExceptionUnmarshaller _instance = new InvalidArgumentExceptionUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static InvalidArgumentExceptionUnmarshaller Instance => _instance;
    }
}
