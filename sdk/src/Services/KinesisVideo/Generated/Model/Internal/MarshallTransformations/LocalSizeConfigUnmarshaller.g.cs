...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LocalSizeConfigUnmarshaller : IJsonUnmarshaller<LocalSizeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LocalSizeConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LocalSizeConfigUnmarshaller Instance => _instance;
    }
}
