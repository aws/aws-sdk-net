...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateImageGenerationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateImageGenerationConfigurationResponse response = new UpdateImageGenerationConfigurationResponse();
        ...
        internal static UpdateImageGenerationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateImageGenerationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
