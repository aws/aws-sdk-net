...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateStreamRequestMarshaller : IMarshaller<IRequest, CreateStreamRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateStreamRequestMarshaller _instance = new();

        internal static CreateStreamRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateStreamRequestMarshaller Instance => _instance;
    }
}
