...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateNotificationConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateNotificationConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateNotificationConfigurationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/updateNotificationConfiguration";
#if !NETFRAMEWORK
        ...
        private static readonly UpdateNotificationConfigurationRequestMarshaller _instance = new();

        internal static UpdateNotificationConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateNotificationConfigurationRequestMarshaller Instance => _instance;
    }
}
