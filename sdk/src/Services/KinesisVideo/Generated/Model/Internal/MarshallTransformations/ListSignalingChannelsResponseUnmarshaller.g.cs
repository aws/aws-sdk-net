...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSignalingChannelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListSignalingChannelsResponse();
            ...
            {
                if (context.TestExpression("ChannelInfoList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelInfo, ChannelInfoUnmarshaller>(ChannelInfoUnmarshaller.Instance);
                    unmarshalledObject.ChannelInfoList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListSignalingChannelsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSignalingChannelsResponseUnmarshaller Instance => _instance;
    }
}
