...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeletionConfigUnmarshaller : IJsonUnmarshaller<DeletionConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeletionConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeletionConfigUnmarshaller Instance => _instance;
    }
}
