...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeSignalingChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSignalingChannelResponse response = new DescribeSignalingChannelResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ChannelInfo", targetDepth))
                {
                    ...
                    response.ChannelInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeSignalingChannelResponseUnmarshaller _instance = new DescribeSignalingChannelResponseUnmarshaller();        

        internal static DescribeSignalingChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSignalingChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
