...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSignalingChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSignalingChannelResponse response = new DeleteSignalingChannelResponse();
        ...
        internal static DeleteSignalingChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSignalingChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
