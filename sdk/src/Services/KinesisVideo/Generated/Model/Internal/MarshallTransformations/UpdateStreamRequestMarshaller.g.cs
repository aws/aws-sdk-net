...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateStreamRequestMarshaller : IMarshaller<IRequest, UpdateStreamRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateStreamRequestMarshaller _instance = new();

        internal static UpdateStreamRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateStreamRequestMarshaller Instance => _instance;
    }
}
