...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TagStreamRequestMarshaller : IMarshaller<IRequest, TagStreamRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TagStreamRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(TagStreamRequest publicRequest)
        {
            ...
            request.ResourcePath = "/tagStream";
#if !NETFRAMEWORK
        ...
        private static readonly TagStreamRequestMarshaller _instance = new();

        internal static TagStreamRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TagStreamRequestMarshaller Instance => _instance;
    }
}
