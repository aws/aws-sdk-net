...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    public class ListTagsForStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidResourceFormatException"))
            {
                return new InvalidResourceFormatException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
