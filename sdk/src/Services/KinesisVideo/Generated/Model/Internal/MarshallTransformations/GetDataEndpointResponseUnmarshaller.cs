...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDataEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataEndpointResponse response = new GetDataEndpointResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DataEndpoint", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DataEndpoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDataEndpointResponseUnmarshaller _instance = new GetDataEndpointResponseUnmarshaller();        

        internal static GetDataEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
