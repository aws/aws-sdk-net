...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MediaSourceConfigUnmarshaller : IJsonUnmarshaller<MediaSourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MediaSourceConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MediaSourceConfigUnmarshaller Instance => _instance;
    }
}
