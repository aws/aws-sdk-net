...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSignalingChannelRequestMarshaller : IMarshaller<IRequest, UpdateSignalingChannelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateSignalingChannelRequestMarshaller _instance = new();

        internal static UpdateSignalingChannelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSignalingChannelRequestMarshaller Instance => _instance;
    }
}
