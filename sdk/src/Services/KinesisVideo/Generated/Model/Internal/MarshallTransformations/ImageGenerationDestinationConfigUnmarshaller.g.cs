...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImageGenerationDestinationConfigUnmarshaller : IJsonUnmarshaller<ImageGenerationDestinationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImageGenerationDestinationConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ImageGenerationDestinationConfigUnmarshaller Instance => _instance;
    }
}
