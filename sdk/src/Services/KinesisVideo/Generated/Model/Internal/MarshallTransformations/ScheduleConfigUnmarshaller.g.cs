...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScheduleConfigUnmarshaller : IJsonUnmarshaller<ScheduleConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ScheduleConfig();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScheduleConfigUnmarshaller Instance => _instance;
    }
}
