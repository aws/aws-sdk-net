...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelInfoUnmarshaller : IJsonUnmarshaller<ChannelInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelInfo();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SingleMasterConfiguration", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelInfoUnmarshaller Instance => _instance;
    }
}
