...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NotificationConfigurationMarshaller : IRequestMarshaller<NotificationConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(NotificationConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetDestinationConfig())
            {
                ...
                var marshaller = NotificationDestinationConfigMarshaller.Instance;
