...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeMediaStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeMediaStorageConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MediaStorageConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MediaStorageConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeMediaStorageConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeMediaStorageConfigurationResponseUnmarshaller Instance => _instance;
    }
}
