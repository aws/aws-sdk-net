...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateNotificationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateNotificationConfigurationResponse();
        ...
        private static UpdateNotificationConfigurationResponseUnmarshaller _instance = new UpdateNotificationConfigurationResponseUnmarshaller();

        internal static UpdateNotificationConfigurationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateNotificationConfigurationResponseUnmarshaller Instance => _instance;
    }
}
