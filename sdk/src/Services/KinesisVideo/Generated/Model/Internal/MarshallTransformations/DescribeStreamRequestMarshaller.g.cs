...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeStreamRequestMarshaller : IMarshaller<IRequest, DescribeStreamRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeStreamRequestMarshaller _instance = new();

        internal static DescribeStreamRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeStreamRequestMarshaller Instance => _instance;
    }
}
