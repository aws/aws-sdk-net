...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UntagStreamRequestMarshaller : IMarshaller<IRequest, UntagStreamRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UntagStreamRequestMarshaller _instance = new();

        internal static UntagStreamRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UntagStreamRequestMarshaller Instance => _instance;
    }
}
