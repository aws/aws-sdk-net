...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class ListSignalingChannelsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ChannelInfo> ChannelInfoList { get; set; } = AWSConfigs.InitializeCollections ? new List<ChannelInfo>() : null;

        /// <summary>
        /// Checks to see if the ChannelInfoList property is set.
        /// </summary>
        internal bool IsSetChannelInfoList() => this.ChannelInfoList != null && (this.ChannelInfoList.Count > 0 || !AWSConfigs.InitializeCollections);
