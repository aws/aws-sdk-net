...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class StreamStorageConfiguration
    {
        ...
        public DefaultStorageTier DefaultStorageTier { get; set; }

        /// <summary>
        /// Checks to see if the DefaultStorageTier property is set.
        /// </summary>
        internal bool IsSetDefaultStorageTier() => this.DefaultStorageTier != null;
    }
}
