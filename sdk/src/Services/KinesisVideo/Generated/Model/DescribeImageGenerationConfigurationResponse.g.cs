...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class DescribeImageGenerationConfigurationResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Checks to see if the ImageGenerationConfiguration property is set.
        /// </summary>
        internal bool IsSetImageGenerationConfiguration() => this.ImageGenerationConfiguration != null;
    }
}
