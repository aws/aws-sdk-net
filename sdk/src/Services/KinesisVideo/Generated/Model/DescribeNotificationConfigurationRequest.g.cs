...
{
    /// <summary>
    /// Container for the parameters to the DescribeNotificationConfiguration operation. Gets
    /// the <c>NotificationConfiguration</c> for a given Kinesis video stream.
    /// </summary>
