...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class LocalSizeConfig
    {
        ...
        public int? MaxLocalMediaSizeInMB { get; set; }

        /// <summary>
        /// Checks to see if the MaxLocalMediaSizeInMB property is set.
        /// </summary>
        internal bool IsSetMaxLocalMediaSizeInMB() => this.MaxLocalMediaSizeInMB.HasValue;
        ...
        /// <summary>
        /// Checks to see if the StrategyOnFullSize property is set.
        /// </summary>
        internal bool IsSetStrategyOnFullSize() => this.StrategyOnFullSize != null;
    }
}
