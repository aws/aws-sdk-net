...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class ListStreamsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<StreamInfo> StreamInfoList { get; set; } = AWSConfigs.InitializeCollections ? new List<StreamInfo>() : null;

        /// <summary>
        /// Checks to see if the StreamInfoList property is set.
        /// </summary>
        internal bool IsSetStreamInfoList() => this.StreamInfoList != null && (this.StreamInfoList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
