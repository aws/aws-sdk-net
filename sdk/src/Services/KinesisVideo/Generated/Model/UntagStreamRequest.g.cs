...
{
    /// <summary>
    /// Container for the parameters to the UntagStream operation. Removes one or more tags
    /// from a stream. In the request, specify only a tag key or keys; don't specify the value.
    /// If you specify a tag key that does not exist, it's ignored. <para> In the request,
    /// you must provide the <c>StreamName</c> or <c>StreamARN</c>. </para>
    /// </summary>
