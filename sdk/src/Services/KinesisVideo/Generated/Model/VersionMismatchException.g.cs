...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class VersionMismatchException : AmazonKinesisVideoException
    {
        ...
        /// Construct instance of VersionMismatchException
        /// </summary>
        public VersionMismatchException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of VersionMismatchException
        /// </summary>
        public VersionMismatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of VersionMismatchException
        /// </summary>
        public VersionMismatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
