...
{
    /// <summary>
    /// Container for the parameters to the DescribeStreamStorageConfiguration operation.
    /// Retrieves the current storage configuration for the specified Kinesis video stream.
    /// <para> In the request, you must specify either the <c>StreamName</c> or the <c>StreamARN</c>.
    /// </para> <para> You must have permissions for the <c>KinesisVideo:DescribeStreamStorageConfiguration</c>
    /// action. </para>
    /// </summary>
    public partial class DescribeStreamStorageConfigurationRequest : AmazonKinesisVideoRequest
    {
        /// <summary>
