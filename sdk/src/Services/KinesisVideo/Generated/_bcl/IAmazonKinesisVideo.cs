...
namespace Amazon.KinesisVideo
{
    ...
    public partial interface IAmazonKinesisVideo : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/DescribeStreamStorageConfiguration">REST API Reference for DescribeStreamStorageConfiguration Operation</seealso>
        Task<DescribeStreamStorageConfigurationResponse> DescribeStreamStorageConfigurationAsync(DescribeStreamStorageConfigurationRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/UpdateStreamStorageConfiguration">REST API Reference for UpdateStreamStorageConfiguration Operation</seealso>
        Task<UpdateStreamStorageConfigurationResponse> UpdateStreamStorageConfigurationAsync(UpdateStreamStorageConfigurationRequest request, CancellationToken cancellationToken = default(CancellationToken));
