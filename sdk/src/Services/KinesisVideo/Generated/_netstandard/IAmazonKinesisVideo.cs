...
namespace Amazon.KinesisVideo
{
    ...
    public partial interface IAmazonKinesisVideo : IAmazonService, IDisposable
    {
        ...
        Task<DeleteEdgeConfigurationResponse> DeleteEdgeConfigurationAsync(DeleteEdgeConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListEdgeAgentConfigurationsResponse> ListEdgeAgentConfigurationsAsync(ListEdgeAgentConfigurationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKinesisVideoConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKinesisVideoConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKinesisVideoConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKinesisVideoConfig to create AmazonKinesisVideoClient");
            }

            return awsCredentials == null ? 
                    new AmazonKinesisVideoClient(serviceClientConfig) :
                    new AmazonKinesisVideoClient(awsCredentials, serviceClientConfig);
        }
