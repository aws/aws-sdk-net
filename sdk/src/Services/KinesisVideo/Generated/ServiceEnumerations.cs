...
namespace Amazon.KinesisVideo
{
    ...
    /// <summary>
    /// Constants used for properties of type DefaultStorageTier.
    /// </summary>
    public class DefaultStorageTier : ConstantClass
    {

        /// <summary>
        /// Constant HOT for DefaultStorageTier
        /// </summary>
        public static readonly DefaultStorageTier HOT = new DefaultStorageTier("HOT");
        /// <summary>
        /// Constant WARM for DefaultStorageTier
        /// </summary>
        public static readonly DefaultStorageTier WARM = new DefaultStorageTier("WARM");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public DefaultStorageTier(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static DefaultStorageTier FindValue(string value)
        {
            return FindValue<DefaultStorageTier>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator DefaultStorageTier(string value)
        {
            return FindValue(value);
        }
    }
