...
namespace Amazon.KinesisVideo
{
    ...
    public partial class AmazonKinesisVideoClient : AmazonServiceClient, IAmazonKinesisVideo
    {
        ...
        /// 
        /// </summary>
        public AmazonKinesisVideoClient() : base(new AmazonKinesisVideoConfig()) { }
        ...
        public AmazonKinesisVideoClient(RegionEndpoint region) : base(new AmazonKinesisVideoConfig { RegionEndpoint = region }) { }
        ...
        public AmazonKinesisVideoClient(AmazonKinesisVideoConfig config) : base(config) { }
