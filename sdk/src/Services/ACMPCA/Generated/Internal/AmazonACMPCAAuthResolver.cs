...
namespace Amazon.ACMPCA.Internal
{
    ...
    public class AmazonACMPCAAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonACMPCAAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ACMPCA.
        /// </summary>
        public AmazonACMPCAAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonACMPCAAuthSchemeParameters
            {
    ...
    public class AmazonACMPCAAuthSchemeResolver : IAuthSchemeResolver<AmazonACMPCAAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonACMPCAAuthSchemeParameters authParameters)
        {
