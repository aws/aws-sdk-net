...
namespace Amazon.ACMPCA.Model
{
    ...
    public partial class CertificateMismatchException : AmazonACMPCAException
    {
        ...
        public CertificateMismatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CertificateMismatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
