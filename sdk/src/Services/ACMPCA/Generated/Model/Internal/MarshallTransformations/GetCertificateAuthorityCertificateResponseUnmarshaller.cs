...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCertificateAuthorityCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCertificateAuthorityCertificateResponse response = new GetCertificateAuthorityCertificateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CertificateChain = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCertificateAuthorityCertificateResponseUnmarshaller _instance = new GetCertificateAuthorityCertificateResponseUnmarshaller();        

        internal static GetCertificateAuthorityCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCertificateAuthorityCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
