...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportCertificateAuthorityCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportCertificateAuthorityCertificateResponse response = new ImportCertificateAuthorityCertificateResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CertificateMismatchException"))
                {
                    return CertificateMismatchExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MalformedCertificateException"))
                {
                    return MalformedCertificateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ImportCertificateAuthorityCertificateResponseUnmarshaller _instance = new ImportCertificateAuthorityCertificateResponseUnmarshaller();        

        internal static ImportCertificateAuthorityCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportCertificateAuthorityCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
