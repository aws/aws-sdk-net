    ...
    public class ImportCertificateAuthorityCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return CertificateMismatchExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                {
                    return MalformedCertificateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
