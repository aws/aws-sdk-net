...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    public class DeletePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeletePermissionResponseUnmarshaller _instance = new DeletePermissionResponseUnmarshaller();        

        internal static DeletePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
