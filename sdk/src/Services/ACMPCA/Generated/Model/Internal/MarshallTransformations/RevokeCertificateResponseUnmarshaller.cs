...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RevokeCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeCertificateResponse response = new RevokeCertificateResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("RequestAlreadyProcessedException"))
            {
                return new RequestAlreadyProcessedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static RevokeCertificateResponseUnmarshaller _instance = new RevokeCertificateResponseUnmarshaller();        

        internal static RevokeCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
