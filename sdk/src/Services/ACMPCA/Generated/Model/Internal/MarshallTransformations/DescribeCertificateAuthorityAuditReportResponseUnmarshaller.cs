...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeCertificateAuthorityAuditReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCertificateAuthorityAuditReportResponse response = new DescribeCertificateAuthorityAuditReportResponse();
            ...
            {
                if (context.TestExpression("AuditReportStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AuditReportStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeCertificateAuthorityAuditReportResponseUnmarshaller _instance = new DescribeCertificateAuthorityAuditReportResponseUnmarshaller();        

        internal static DescribeCertificateAuthorityAuditReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCertificateAuthorityAuditReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
