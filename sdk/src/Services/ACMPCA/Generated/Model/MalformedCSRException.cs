...
namespace Amazon.ACMPCA.Model
{
    ...
    public partial class MalformedCSRException : AmazonACMPCAException
    {
        ...
        public MalformedCSRException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MalformedCSRException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
