...
namespace Amazon.ACMPCA.Model
{
    ...
    public partial class RequestInProgressException : AmazonACMPCAException
    {
        ...
        public RequestInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RequestInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
