...
{
    /// <summary>
    /// Response Unmarshaller for CreateHarvestJob operation
    /// </summary>  
    public class CreateHarvestJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHarvestJobResponse response = new CreateHarvestJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("originEndpointId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OriginEndpointId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateHarvestJobResponseUnmarshaller _instance = new CreateHarvestJobResponseUnmarshaller();        

        internal static CreateHarvestJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHarvestJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
