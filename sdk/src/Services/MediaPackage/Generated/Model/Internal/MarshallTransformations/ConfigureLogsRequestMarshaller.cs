...
namespace Amazon.MediaPackage.Model.Internal.MarshallTransformations
{
    ...
    public class ConfigureLogsRequestMarshaller : IMarshaller<IRequest, ConfigureLogsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ConfigureLogsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetIngressAccessLogs())
            {
                context.Writer.WritePropertyName("ingressAccessLogs");
                context.Writer.WriteStartObject();

                var marshaller = IngressAccessLogsMarshaller.Instance;
                marshaller.Marshall(publicRequest.IngressAccessLogs, context);
