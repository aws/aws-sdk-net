...
namespace Amazon.MediaPackage.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CmafEncryptionUnmarshaller : IJsonUnmarshaller<CmafEncryption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CmafEncryption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
