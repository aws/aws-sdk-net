...
{
    /// <summary>
    /// Container for the parameters to the CreateTelemetryPipeline operation. Creates a telemetry
    /// pipeline for processing and transforming telemetry data. The pipeline defines how
    /// data flows from sources through processors to destinations, enabling data transformation
