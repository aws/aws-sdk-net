...
{
    /// <summary>
    /// Container for the parameters to the GetTelemetryRuleForOrganization operation. Retrieves
    /// the details of a specific organization telemetry rule. This operation can only be
