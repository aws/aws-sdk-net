...
namespace Amazon.ObservabilityAdmin.Model
{
    ...
    public partial class StartTelemetryEnrichmentResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        ///  The Amazon Resource Name (ARN) of the Resource Explorer managed view created for
        /// resource tags for telemetry. 
        /// </para>
        /// </summary>
        [AWSProperty(Min = 20, Max = 2048)]
        public string AwsResourceExplorerManagedViewArn { get; set; }

        /// <summary>
        /// Checks to see if the AwsResourceExplorerManagedViewArn property is set.
        /// </summary>
        internal bool IsSetAwsResourceExplorerManagedViewArn() => this.AwsResourceExplorerManagedViewArn != null;
        ...
        /// </para>
        /// </summary>
        public TelemetryEnrichmentStatus Status { get; set; }
