...
namespace Amazon.ObservabilityAdmin.Model
{
    ...
    public partial class ListResourceTelemetryForOrganizationResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<TelemetryConfiguration> TelemetryConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<TelemetryConfiguration>() : null;

        /// <summary>
        /// Checks to see if the TelemetryConfigurations property is set.
        /// </summary>
        internal bool IsSetTelemetryConfigurations() => this.TelemetryConfigurations != null && (this.TelemetryConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
