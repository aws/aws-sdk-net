...
namespace Amazon.ObservabilityAdmin.Model
{
    ...
    public partial class InternalServerException : AmazonObservabilityAdminException
    {
        ...
        /// Construct instance of InternalServerException
        /// </summary>
        public InternalServerException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InternalServerException
        /// </summary>
        public InternalServerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InternalServerException
        /// </summary>
        public InternalServerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
        ...
        /// </para>
        /// </summary>
        public string AmznErrorType { get; set; }

        /// <summary>
        /// Checks to see if the AmznErrorType property is set.
        /// </summary>
        internal bool IsSetAmznErrorType() => this.AmznErrorType != null;
        ...
        /// <summary>
        /// Checks to see if the RetryAfterSeconds property is set.
        /// </summary>
        internal bool IsSetRetryAfterSeconds() => this.RetryAfterSeconds.HasValue;
