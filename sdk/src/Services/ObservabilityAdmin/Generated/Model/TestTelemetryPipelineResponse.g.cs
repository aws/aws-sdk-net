...
{
    /// <summary>
    /// This is the response object from the TestTelemetryPipeline operation.
    /// </summary>
    public partial class TestTelemetryPipelineResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        /// </summary>
        public List<PipelineOutput> Results { get; set; } = AWSConfigs.InitializeCollections ? new List<PipelineOutput>() : null;
