...
namespace Amazon.ObservabilityAdmin.Model
{
    ...
    public partial class AccessDeniedException : AmazonObservabilityAdminException
    {
        ...
        /// Construct instance of AccessDeniedException
        /// </summary>
        public AccessDeniedException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of AccessDeniedException
        /// </summary>
        public AccessDeniedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of AccessDeniedException
        /// </summary>
        public AccessDeniedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
