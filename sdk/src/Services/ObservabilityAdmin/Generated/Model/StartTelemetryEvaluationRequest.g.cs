...
{
    /// <summary>
    /// Container for the parameters to the StartTelemetryEvaluation operation. This action
    /// begins onboarding the caller Amazon Web Services account to the telemetry config feature.
    /// </summary>
