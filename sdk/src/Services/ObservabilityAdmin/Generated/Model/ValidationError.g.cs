...
namespace Amazon.ObservabilityAdmin.Model
{
    ...
    public partial class ValidationError
    {
        ...
        /// </summary>
        public Dictionary<string, string> FieldMap { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the FieldMap property is set.
        /// </summary>
        internal bool IsSetFieldMap() => this.FieldMap != null && (this.FieldMap.Count > 0 || !AWSConfigs.InitializeCollections);
