...
{
    /// <summary>
    /// This is the response object from the GetTelemetryEnrichmentStatus operation.
    /// </summary>
    public partial class GetTelemetryEnrichmentStatusResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        ///  The current status of the resource tags for telemetry feature (<c>Running</c>, <c>Stopped</c>,
        /// or <c>Impaired</c>). 
        /// </para>
        /// </summary>
