...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetTelemetryRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetTelemetryRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IsReplicated", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IsReplicated = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("RegionStatuses", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.RegionStatuses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TelemetryRule", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TelemetryRule = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetTelemetryRuleResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetTelemetryRuleResponseUnmarshaller Instance => _instance;
    }
}
