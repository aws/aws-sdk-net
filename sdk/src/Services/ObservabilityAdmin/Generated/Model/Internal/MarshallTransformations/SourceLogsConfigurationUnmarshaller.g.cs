...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SourceLogsConfigurationUnmarshaller : IJsonUnmarshaller<SourceLogsConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SourceLogsConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SourceLogsConfigurationUnmarshaller Instance => _instance;
    }
}
