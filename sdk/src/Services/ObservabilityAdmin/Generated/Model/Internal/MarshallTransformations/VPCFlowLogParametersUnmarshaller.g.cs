...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VPCFlowLogParametersUnmarshaller : IJsonUnmarshaller<VPCFlowLogParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VPCFlowLogParameters();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MaxAggregationInterval", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("TrafficType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static VPCFlowLogParametersUnmarshaller Instance => _instance;
    }
}
