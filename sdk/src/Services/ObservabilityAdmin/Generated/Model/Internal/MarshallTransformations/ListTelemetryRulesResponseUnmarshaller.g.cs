...
{
    /// <summary>
    /// Response Unmarshaller for ListTelemetryRules operation.
    /// </summary>
    public partial class ListTelemetryRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListTelemetryRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TelemetryRuleSummaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TelemetryRuleSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTelemetryRulesResponseUnmarshaller _instance = new ListTelemetryRulesResponseUnmarshaller();

        internal static ListTelemetryRulesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListTelemetryRulesResponseUnmarshaller Instance => _instance;
    }
}
