...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConditionUnmarshaller : IJsonUnmarshaller<Condition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Condition();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConditionUnmarshaller Instance => _instance;
    }
}
