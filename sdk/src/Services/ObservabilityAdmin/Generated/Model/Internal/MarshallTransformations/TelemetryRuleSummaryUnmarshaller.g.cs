...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TelemetryRuleSummaryUnmarshaller : IJsonUnmarshaller<TelemetryRuleSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TelemetryRuleSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TelemetryRuleSummaryUnmarshaller Instance => _instance;
    }
}
