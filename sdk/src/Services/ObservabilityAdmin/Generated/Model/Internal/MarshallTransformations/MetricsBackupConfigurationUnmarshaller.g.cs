...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MetricsBackupConfigurationUnmarshaller : IJsonUnmarshaller<MetricsBackupConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MetricsBackupConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MetricsBackupConfigurationUnmarshaller Instance => _instance;
    }
}
