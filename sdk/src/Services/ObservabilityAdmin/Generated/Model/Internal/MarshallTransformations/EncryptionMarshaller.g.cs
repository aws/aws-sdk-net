...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EncryptionMarshaller : IRequestMarshaller<Encryption, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(Encryption requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetSseAlgorithm())
            {
                context.Writer.WritePropertyName("SseAlgorithm");
                context.Writer.WriteStringValue(requestObject.SseAlgorithm);
            }
        }
