...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DestinationLogsConfigurationUnmarshaller : IJsonUnmarshaller<DestinationLogsConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DestinationLogsConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("BackupConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LogGroupNameConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LogsEncryptionConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = LogsEncryptionConfigurationUnmarshaller.Instance;
                    unmarshalledObject.LogsEncryptionConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TagPropagationConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = TagPropagationConfigurationUnmarshaller.Instance;
                    unmarshalledObject.TagPropagationConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
