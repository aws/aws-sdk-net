...
{
    /// <summary>
    /// Response Unmarshaller for CreateCentralizationRuleForOrganization operation
    /// </summary>  
    public class CreateCentralizationRuleForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCentralizationRuleForOrganizationResponse response = new CreateCentralizationRuleForOrganizationResponse();
        ...
        private static CreateCentralizationRuleForOrganizationResponseUnmarshaller _instance = new CreateCentralizationRuleForOrganizationResponseUnmarshaller();        

        internal static CreateCentralizationRuleForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCentralizationRuleForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
