...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CentralizationRuleSummaryUnmarshaller : IJsonUnmarshaller<CentralizationRuleSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CentralizationRuleSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CentralizationRuleSummaryUnmarshaller Instance => _instance;
    }
}
