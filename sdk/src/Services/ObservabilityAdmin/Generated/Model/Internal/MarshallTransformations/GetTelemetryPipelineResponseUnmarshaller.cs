...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTelemetryPipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTelemetryPipelineResponse response = new GetTelemetryPipelineResponse();
        ...
        internal static GetTelemetryPipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTelemetryPipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
