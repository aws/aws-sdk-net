...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ValidationErrorUnmarshaller : IJsonUnmarshaller<ValidationError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ValidationError();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ValidationErrorUnmarshaller Instance => _instance;
    }
}
