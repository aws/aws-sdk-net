...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListTelemetryRulesForOrganizationRequestMarshaller : IMarshaller<IRequest, ListTelemetryRulesForOrganizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListTelemetryRulesForOrganizationRequestMarshaller _instance = new();

        internal static ListTelemetryRulesForOrganizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListTelemetryRulesForOrganizationRequestMarshaller Instance => _instance;
    }
}
