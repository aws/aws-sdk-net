...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TelemetryPipelineUnmarshaller : IJsonUnmarshaller<TelemetryPipeline, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TelemetryPipeline Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TelemetryPipeline();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TelemetryPipelineUnmarshaller Instance => _instance;
    }
}
