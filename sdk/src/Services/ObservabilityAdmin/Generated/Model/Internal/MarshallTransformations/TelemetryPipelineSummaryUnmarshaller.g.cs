...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TelemetryPipelineSummaryUnmarshaller : IJsonUnmarshaller<TelemetryPipelineSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TelemetryPipelineSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TelemetryPipelineSummaryUnmarshaller Instance => _instance;
    }
}
