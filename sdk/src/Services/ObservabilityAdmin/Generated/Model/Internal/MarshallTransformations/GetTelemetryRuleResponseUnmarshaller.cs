...
{
    /// <summary>
    /// Response Unmarshaller for GetTelemetryRule operation
    /// </summary>  
    public class GetTelemetryRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTelemetryRuleResponse response = new GetTelemetryRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IsReplicated", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("RegionStatuses", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("TelemetryRule", targetDepth, ref reader))
                {
        ...
        private static GetTelemetryRuleResponseUnmarshaller _instance = new GetTelemetryRuleResponseUnmarshaller();        

        internal static GetTelemetryRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTelemetryRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
