...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartTelemetryEvaluationForOrganizationRequestMarshaller : IMarshaller<IRequest, StartTelemetryEvaluationForOrganizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartTelemetryEvaluationForOrganizationRequestMarshaller _instance = new();

        internal static StartTelemetryEvaluationForOrganizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartTelemetryEvaluationForOrganizationRequestMarshaller Instance => _instance;
    }
}
