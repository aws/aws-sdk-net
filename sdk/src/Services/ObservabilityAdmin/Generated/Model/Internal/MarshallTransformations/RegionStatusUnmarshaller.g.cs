...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegionStatusUnmarshaller : IJsonUnmarshaller<RegionStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RegionStatus();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RegionStatusUnmarshaller Instance => _instance;
    }
}
