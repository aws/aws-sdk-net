...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ValidationErrorUnmarshaller : IJsonUnmarshaller<ValidationError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ValidationError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("FieldMap", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.FieldMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
