...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AdvancedFieldSelectorUnmarshaller : IJsonUnmarshaller<AdvancedFieldSelector, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AdvancedFieldSelector();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AdvancedFieldSelectorUnmarshaller Instance => _instance;
    }
}
