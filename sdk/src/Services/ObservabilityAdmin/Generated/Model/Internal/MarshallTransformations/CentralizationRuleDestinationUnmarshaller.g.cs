...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CentralizationRuleDestinationUnmarshaller : IJsonUnmarshaller<CentralizationRuleDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CentralizationRuleDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CentralizationRuleDestinationUnmarshaller Instance => _instance;
    }
}
