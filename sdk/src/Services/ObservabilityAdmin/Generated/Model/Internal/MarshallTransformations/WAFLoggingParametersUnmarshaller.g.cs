...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WAFLoggingParametersUnmarshaller : IJsonUnmarshaller<WAFLoggingParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public WAFLoggingParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new WAFLoggingParameters();
        ...
        /// Gets the singleton.
        /// </summary>
        public static WAFLoggingParametersUnmarshaller Instance => _instance;
    }
}
