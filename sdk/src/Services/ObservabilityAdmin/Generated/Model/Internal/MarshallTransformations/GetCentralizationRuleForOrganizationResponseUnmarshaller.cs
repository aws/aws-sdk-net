        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CentralizationRule", targetDepth))
                {
                    ...
                    response.CentralizationRule = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CreatedRegion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CreatedRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RuleHealth = unmarshaller.Unmarshall(context);
                    continue;
                }
