...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListResourceTelemetryForOrganizationRequestMarshaller : IMarshaller<IRequest, ListResourceTelemetryForOrganizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListResourceTelemetryForOrganizationRequestMarshaller _instance = new();

        internal static ListResourceTelemetryForOrganizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListResourceTelemetryForOrganizationRequestMarshaller Instance => _instance;
    }
}
