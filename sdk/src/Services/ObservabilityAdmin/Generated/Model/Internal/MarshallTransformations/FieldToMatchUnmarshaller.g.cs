...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FieldToMatchUnmarshaller : IJsonUnmarshaller<FieldToMatch, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FieldToMatch();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SingleHeader", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static FieldToMatchUnmarshaller Instance => _instance;
    }
}
