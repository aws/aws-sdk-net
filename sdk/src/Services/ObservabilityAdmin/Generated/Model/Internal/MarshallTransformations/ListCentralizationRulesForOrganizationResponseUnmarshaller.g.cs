...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListCentralizationRulesForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListCentralizationRulesForOrganizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CentralizationRuleSummaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.CentralizationRuleSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListCentralizationRulesForOrganizationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListCentralizationRulesForOrganizationResponseUnmarshaller Instance => _instance;
    }
}
