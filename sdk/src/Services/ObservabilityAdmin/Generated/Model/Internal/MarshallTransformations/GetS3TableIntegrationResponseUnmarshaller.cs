...
{
    /// <summary>
    /// Response Unmarshaller for GetS3TableIntegration operation
    /// </summary>  
    public class GetS3TableIntegrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetS3TableIntegrationResponse response = new GetS3TableIntegrationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DestinationTableBucketArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Encryption", targetDepth))
                {
                    var unmarshaller = EncryptionUnmarshaller.Instance;
                    response.Encryption = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetS3TableIntegrationResponseUnmarshaller _instance = new GetS3TableIntegrationResponseUnmarshaller();        

        internal static GetS3TableIntegrationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetS3TableIntegrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
