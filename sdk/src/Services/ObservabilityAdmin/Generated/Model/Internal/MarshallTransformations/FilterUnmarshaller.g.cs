...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FilterUnmarshaller : IJsonUnmarshaller<Filter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Filter();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FilterUnmarshaller Instance => _instance;
    }
}
