...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CentralizationRuleDestinationUnmarshaller : IUnmarshaller<CentralizationRuleDestination, XmlUnmarshallerContext>, IUnmarshaller<CentralizationRuleDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CentralizationRuleDestination IUnmarshaller<CentralizationRuleDestination, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CentralizationRuleDestination Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("DestinationLogsConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.DestinationLogsConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
