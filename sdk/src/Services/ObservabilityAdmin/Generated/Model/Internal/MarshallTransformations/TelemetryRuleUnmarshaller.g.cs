...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TelemetryRuleUnmarshaller : IJsonUnmarshaller<TelemetryRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TelemetryRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TelemetryRuleUnmarshaller Instance => _instance;
    }
}
