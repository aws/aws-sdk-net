...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TelemetryPipelineSummaryUnmarshaller : IJsonUnmarshaller<TelemetryPipelineSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TelemetryPipelineSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
