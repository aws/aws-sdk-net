...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TelemetryDestinationConfigurationUnmarshaller : IJsonUnmarshaller<TelemetryDestinationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TelemetryDestinationConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TelemetryDestinationConfigurationUnmarshaller Instance => _instance;
    }
}
