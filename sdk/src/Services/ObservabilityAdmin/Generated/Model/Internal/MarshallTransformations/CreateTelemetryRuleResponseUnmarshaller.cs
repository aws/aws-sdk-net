...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTelemetryRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTelemetryRuleResponse response = new CreateTelemetryRuleResponse();
        ...
        internal static CreateTelemetryRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTelemetryRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
