...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartTelemetryEvaluationRequestMarshaller : IMarshaller<IRequest, StartTelemetryEvaluationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartTelemetryEvaluationRequestMarshaller _instance = new();

        internal static StartTelemetryEvaluationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartTelemetryEvaluationRequestMarshaller Instance => _instance;
    }
}
