...
{
    /// <summary>
    /// Response Unmarshaller for CreateS3TableIntegration operation
    /// </summary>  
    public class CreateS3TableIntegrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateS3TableIntegrationResponse response = new CreateS3TableIntegrationResponse();
        ...
        private static CreateS3TableIntegrationResponseUnmarshaller _instance = new CreateS3TableIntegrationResponseUnmarshaller();        

        internal static CreateS3TableIntegrationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateS3TableIntegrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
