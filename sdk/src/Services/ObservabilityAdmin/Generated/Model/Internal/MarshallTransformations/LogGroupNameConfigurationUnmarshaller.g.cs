...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LogGroupNameConfigurationUnmarshaller : IJsonUnmarshaller<LogGroupNameConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LogGroupNameConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LogGroupNameConfigurationUnmarshaller Instance => _instance;
    }
}
