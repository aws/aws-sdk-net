...
{
    /// <summary>
    /// Response Unmarshaller for PipelineOutput Object
    /// </summary>
    public partial class PipelineOutputUnmarshaller : IJsonUnmarshaller<PipelineOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PipelineOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PipelineOutput();
        ...
        private static PipelineOutputUnmarshaller _instance = new PipelineOutputUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PipelineOutputUnmarshaller Instance => _instance;
    }
}
