...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LoggingFilterUnmarshaller : IJsonUnmarshaller<LoggingFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LoggingFilter();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LoggingFilterUnmarshaller Instance => _instance;
    }
}
