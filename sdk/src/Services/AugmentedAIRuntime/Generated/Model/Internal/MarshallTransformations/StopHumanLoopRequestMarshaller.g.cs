...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StopHumanLoopRequestMarshaller : IMarshaller<IRequest, StopHumanLoopRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StopHumanLoopRequestMarshaller _instance = new();

        internal static StopHumanLoopRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopHumanLoopRequestMarshaller Instance => _instance;
    }
}
