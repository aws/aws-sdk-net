...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartHumanLoopRequestMarshaller : IMarshaller<IRequest, StartHumanLoopRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartHumanLoopRequestMarshaller _instance = new();

        internal static StartHumanLoopRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartHumanLoopRequestMarshaller Instance => _instance;
    }
}
