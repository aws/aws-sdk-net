...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HumanLoopOutputUnmarshaller : IJsonUnmarshaller<HumanLoopOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new HumanLoopOutput();
        ...
        /// Gets the singleton.
        /// </summary>
        public static HumanLoopOutputUnmarshaller Instance => _instance;
    }
}
