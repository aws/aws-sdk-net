...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HumanLoopSummaryUnmarshaller : IJsonUnmarshaller<HumanLoopSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public HumanLoopSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new HumanLoopSummary();
        ...
        private static HumanLoopSummaryUnmarshaller _instance = new HumanLoopSummaryUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static HumanLoopSummaryUnmarshaller Instance => _instance;
    }
}
