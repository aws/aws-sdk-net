...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeHumanLoopRequestMarshaller : IMarshaller<IRequest, DescribeHumanLoopRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeHumanLoopRequestMarshaller _instance = new();

        internal static DescribeHumanLoopRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeHumanLoopRequestMarshaller Instance => _instance;
    }
}
