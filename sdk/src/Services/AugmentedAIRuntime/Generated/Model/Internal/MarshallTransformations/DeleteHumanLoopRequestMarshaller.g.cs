...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteHumanLoopRequestMarshaller : IMarshaller<IRequest, DeleteHumanLoopRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteHumanLoopRequestMarshaller _instance = new();

        internal static DeleteHumanLoopRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteHumanLoopRequestMarshaller Instance => _instance;
    }
}
