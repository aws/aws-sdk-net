...
namespace Amazon.AugmentedAIRuntime.Model
{
    ...
    public partial class HumanLoopDataAttributes
    {
        ...
        public List<string> ContentClassifiers { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ContentClassifiers property is set.
        /// </summary>
        internal bool IsSetContentClassifiers() => this.ContentClassifiers != null && (this.ContentClassifiers.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
