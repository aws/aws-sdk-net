...
namespace Amazon.AugmentedAIRuntime.Model
{
    ...
    /// </summary>
    internal sealed partial class ListHumanLoopsPaginator : IPaginator<ListHumanLoopsResponse>, IListHumanLoopsPaginator
    {
        private readonly IAmazonAugmentedAIRuntime _client;
        private readonly ListHumanLoopsRequest _request;
        private int _isPaginatorInUse = 0;

        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListHumanLoopsResponse> Responses => new PaginatedResponse<ListHumanLoopsResponse>(this);
...
#if NETFRAMEWORK
        IEnumerable<ListHumanLoopsResponse> IPaginator<ListHumanLoopsResponse>.Paginate()
        {
            ...
            ListHumanLoopsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListHumanLoops(_request);
        ...
        async IAsyncEnumerable<ListHumanLoopsResponse> IPaginator<ListHumanLoopsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListHumanLoopsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
