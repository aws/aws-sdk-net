...
{
    /// <summary>
    /// Container for the parameters to the DeleteHumanLoop operation. Deletes the specified
    /// human loop for a flow definition. <para> If the human loop was deleted, this operation
    /// will return a <c>ResourceNotFoundException</c>. </para>
    /// </summary>
