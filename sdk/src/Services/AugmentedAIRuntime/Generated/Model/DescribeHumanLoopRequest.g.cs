...
{
    /// <summary>
    /// Container for the parameters to the DescribeHumanLoop operation. Returns information
    /// about the specified human loop. If the human loop was deleted, this operation will
    /// return a <c>ResourceNotFoundException</c> error.
    /// </summary>
