...
namespace Amazon.AugmentedAIRuntime
{
    ...
    public partial class AmazonAugmentedAIRuntimeClient : AmazonServiceClient, IAmazonAugmentedAIRuntime
    {
        ...
        /// 
        /// </summary>
        public AmazonAugmentedAIRuntimeClient() : base(new AmazonAugmentedAIRuntimeConfig()) { }
        ...
        public AmazonAugmentedAIRuntimeClient(RegionEndpoint region) : base(new AmazonAugmentedAIRuntimeConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAugmentedAIRuntimeClient(AmazonAugmentedAIRuntimeConfig config) : base(config) { }
