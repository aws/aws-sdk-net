...
namespace Amazon.AugmentedAIRuntime
{
    ...
    public class ContentClassifier : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom ContentClassifier for a value not among the defined constants.
        /// </summary>
        public ContentClassifier(string value) : base(value) { }
    ...
    public class HumanLoopStatus : ConstantClass
    {
        ...
        /// <summary>
        /// Constructs a custom HumanLoopStatus for a value not among the defined constants.
        /// </summary>
        public HumanLoopStatus(string value) : base(value) { }
