...
namespace Amazon.AugmentedAIRuntime
{
    ...
    public partial class AmazonAugmentedAIRuntimeException : AmazonServiceException
    {
        ...
        public AmazonAugmentedAIRuntimeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonAugmentedAIRuntimeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
