...
namespace Amazon.AugmentedAIRuntime.Internal
{
    ...
    public class AmazonAugmentedAIRuntimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAugmentedAIRuntimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AugmentedAIRuntime.
        /// </summary>
        public AmazonAugmentedAIRuntimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAugmentedAIRuntimeAuthSchemeParameters
            {
    ...
    public class AmazonAugmentedAIRuntimeAuthSchemeResolver : IAuthSchemeResolver<AmazonAugmentedAIRuntimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAugmentedAIRuntimeAuthSchemeParameters authParameters)
        {
