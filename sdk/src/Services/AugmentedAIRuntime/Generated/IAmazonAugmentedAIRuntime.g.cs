...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAugmentedAIRuntimeConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAugmentedAIRuntimeConfig();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAugmentedAIRuntimeConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAugmentedAIRuntimeConfig to create AmazonAugmentedAIRuntimeClient");
            }

            return awsCredentials == null ?
                    new AmazonAugmentedAIRuntimeClient(serviceClientConfig) :
                    new AmazonAugmentedAIRuntimeClient(awsCredentials, serviceClientConfig);
        }
