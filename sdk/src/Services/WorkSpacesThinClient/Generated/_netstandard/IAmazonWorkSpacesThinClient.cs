...
namespace Amazon.WorkSpacesThinClient
{
    ...
    public partial interface IAmazonWorkSpacesThinClient : IAmazonService, IDisposable
    {
        ...
        Task<DeregisterDeviceResponse> DeregisterDeviceAsync(DeregisterDeviceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetSoftwareSetResponse> GetSoftwareSetAsync(GetSoftwareSetRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSoftwareSetsResponse> ListSoftwareSetsAsync(ListSoftwareSetsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateSoftwareSetResponse> UpdateSoftwareSetAsync(UpdateSoftwareSetRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonWorkSpacesThinClientConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonWorkSpacesThinClientConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonWorkSpacesThinClientConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonWorkSpacesThinClientConfig to create AmazonWorkSpacesThinClientClient");
            }

            return awsCredentials == null ? 
                    new AmazonWorkSpacesThinClientClient(serviceClientConfig) :
                    new AmazonWorkSpacesThinClientClient(awsCredentials, serviceClientConfig);
        }
