...
namespace Amazon.WorkSpacesThinClient
{
    ...
    public partial class AmazonWorkSpacesThinClientConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("WorkSpaces Thin Client", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "WorkSpaces Thin Client";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "thinclient";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2023-08-22";
