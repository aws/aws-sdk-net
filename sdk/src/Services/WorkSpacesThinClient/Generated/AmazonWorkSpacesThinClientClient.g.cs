...
namespace Amazon.WorkSpacesThinClient
{
    ...
    public partial class AmazonWorkSpacesThinClientClient : AmazonServiceClient, IAmazonWorkSpacesThinClient
    {
        ...
        /// 
        /// </summary>
        public AmazonWorkSpacesThinClientClient() : base(new AmazonWorkSpacesThinClientConfig()) { }
        ...
        public AmazonWorkSpacesThinClientClient(RegionEndpoint region) : base(new AmazonWorkSpacesThinClientConfig { RegionEndpoint = region }) { }
        ...
        public AmazonWorkSpacesThinClientClient(AmazonWorkSpacesThinClientConfig config) : base(config) { }
