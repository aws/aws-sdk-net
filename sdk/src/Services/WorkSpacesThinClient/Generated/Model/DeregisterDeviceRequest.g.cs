...
{
    /// <summary>
    /// Container for the parameters to the DeregisterDevice operation. Deregisters a thin
    /// client device.
    /// </summary>
    public partial class DeregisterDeviceRequest : AmazonWorkSpacesThinClientRequest
    {
        ...
        /// </para>
        /// </summary>
        public TargetDeviceStatus TargetDeviceStatus { get; set; }

        /// <summary>
        /// Checks to see if the TargetDeviceStatus property is set.
        /// </summary>
        internal bool IsSetTargetDeviceStatus() => this.TargetDeviceStatus != null;
    }
}
