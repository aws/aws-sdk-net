...
namespace Amazon.WorkSpacesThinClient.Model
{
    ...
    public partial class ListSoftwareSetsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SoftwareSetSummary> SoftwareSets { get; set; } = AWSConfigs.InitializeCollections ? new List<SoftwareSetSummary>() : null;

        /// <summary>
        /// Checks to see if the SoftwareSets property is set.
        /// </summary>
        internal bool IsSetSoftwareSets() => this.SoftwareSets != null && (this.SoftwareSets.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
