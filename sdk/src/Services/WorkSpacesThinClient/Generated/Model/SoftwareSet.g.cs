...
namespace Amazon.WorkSpacesThinClient.Model
{
    ...
    public partial class SoftwareSet
    {
        ...
        /// </summary>
        public List<Software> Software { get; set; } = AWSConfigs.InitializeCollections ? new List<Software>() : null;

        /// <summary>
        /// Checks to see if the Software property is set.
        /// </summary>
        internal bool IsSetSoftware() => this.Software != null && (this.Software.Count > 0 || !AWSConfigs.InitializeCollections);
