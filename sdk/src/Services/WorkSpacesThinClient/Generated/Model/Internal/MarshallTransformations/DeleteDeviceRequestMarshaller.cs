...
{
    /// <summary>
    /// DeleteDevice Request Marshaller
    /// </summary>       
    public class DeleteDeviceRequestMarshaller : IMarshaller<IRequest, DeleteDeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteDeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteDeviceRequest publicRequest)
        {
        ...
        private static DeleteDeviceRequestMarshaller _instance = new DeleteDeviceRequestMarshaller();        

        internal static DeleteDeviceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
