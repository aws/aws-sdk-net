...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSoftwareSetsRequestMarshaller : IMarshaller<IRequest, ListSoftwareSetsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListSoftwareSetsRequestMarshaller _instance = new();

        internal static ListSoftwareSetsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSoftwareSetsRequestMarshaller Instance => _instance;
    }
}
