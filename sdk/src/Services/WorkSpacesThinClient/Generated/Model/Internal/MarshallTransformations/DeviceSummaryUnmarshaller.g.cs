...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeviceSummaryUnmarshaller : IJsonUnmarshaller<DeviceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeviceSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeviceSummaryUnmarshaller Instance => _instance;
    }
}
