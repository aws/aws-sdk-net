...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeviceUnmarshaller : IJsonUnmarshaller<Device, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Device();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeviceUnmarshaller Instance => _instance;
    }
}
