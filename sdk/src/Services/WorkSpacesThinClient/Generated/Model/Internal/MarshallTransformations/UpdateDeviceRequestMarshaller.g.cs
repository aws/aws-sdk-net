...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDeviceRequestMarshaller : IMarshaller<IRequest, UpdateDeviceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateDeviceRequestMarshaller _instance = new();

        internal static UpdateDeviceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDeviceRequestMarshaller Instance => _instance;
    }
}
