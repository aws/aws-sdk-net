...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDeviceRequestMarshaller : IMarshaller<IRequest, GetDeviceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDeviceRequestMarshaller _instance = new();

        internal static GetDeviceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeviceRequestMarshaller Instance => _instance;
    }
}
