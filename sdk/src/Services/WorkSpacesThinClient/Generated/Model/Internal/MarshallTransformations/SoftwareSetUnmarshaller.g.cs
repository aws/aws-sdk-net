...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SoftwareSetUnmarshaller : IJsonUnmarshaller<SoftwareSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SoftwareSet();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("releasedAt", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("supportedUntil", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static SoftwareSetUnmarshaller Instance => _instance;
    }
}
