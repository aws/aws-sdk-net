...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeregisterDeviceRequestMarshaller : IMarshaller<IRequest, DeregisterDeviceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeregisterDeviceRequestMarshaller _instance = new();

        internal static DeregisterDeviceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeregisterDeviceRequestMarshaller Instance => _instance;
    }
}
