...
namespace Amazon.WorkSpacesThinClient.Model
{
    ...
    /// </summary>
    public partial class EmbeddedTag
    {
        private string _internalId;
        private string _resourceArn;

        /// <summary>
        /// Gets and sets the property InternalId. 
        /// <para>
        ...
        // Check to see if InternalId property is set
        internal bool IsSetInternalId()
        {
            return this._internalId != null;
        }
