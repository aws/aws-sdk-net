...
namespace Amazon.LakeFormation
{
    ...
    public partial class AmazonLakeFormationClient : AmazonServiceClient, IAmazonLakeFormation
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/lakeformation-2017-03-31/GetTemporaryDataLocationCredentials">REST API Reference for GetTemporaryDataLocationCredentials Operation</seealso>
        public virtual IAsyncResult BeginGetTemporaryDataLocationCredentials(GetTemporaryDataLocationCredentialsRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetTemporaryDataLocationCredentialsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetTemporaryDataLocationCredentialsResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/lakeformation-2017-03-31/GetTemporaryDataLocationCredentials">REST API Reference for GetTemporaryDataLocationCredentials Operation</seealso>
        public virtual GetTemporaryDataLocationCredentialsResponse EndGetTemporaryDataLocationCredentials(IAsyncResult asyncResult)
        {
            return EndInvoke<GetTemporaryDataLocationCredentialsResponse>(asyncResult);
        }
