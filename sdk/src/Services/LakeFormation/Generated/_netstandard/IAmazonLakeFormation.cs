...
namespace Amazon.LakeFormation
{
    ...
    public partial interface IAmazonLakeFormation : IAmazonService, IDisposable
    {
        ...
        Task<GetTemporaryDataLocationCredentialsResponse> GetTemporaryDataLocationCredentialsAsync(GetTemporaryDataLocationCredentialsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
