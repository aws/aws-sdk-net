...
namespace Amazon.LakeFormation
{
    ...
    public partial class AmazonLakeFormationClient : AmazonServiceClient, IAmazonLakeFormation
    {
        ...
        internal virtual GetTemporaryDataLocationCredentialsResponse GetTemporaryDataLocationCredentials(GetTemporaryDataLocationCredentialsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetTemporaryDataLocationCredentialsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetTemporaryDataLocationCredentialsResponseUnmarshaller.Instance;

            return Invoke<GetTemporaryDataLocationCredentialsResponse>(request, options);
        }
        ...
        public virtual Task<GetTemporaryDataLocationCredentialsResponse> GetTemporaryDataLocationCredentialsAsync(GetTemporaryDataLocationCredentialsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetTemporaryDataLocationCredentialsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetTemporaryDataLocationCredentialsResponseUnmarshaller.Instance;

            return InvokeAsync<GetTemporaryDataLocationCredentialsResponse>(request, options, cancellationToken);
        }
        #endregion
