...
namespace Amazon.LakeFormation.Model
{
    ...
    [Serializable]
    #endif
    public partial class ResourceNotReadyException : AmazonLakeFormationException
    {
        ...
        public ResourceNotReadyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceNotReadyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
