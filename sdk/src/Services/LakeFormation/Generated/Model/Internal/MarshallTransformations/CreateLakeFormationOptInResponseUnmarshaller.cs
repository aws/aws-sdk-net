...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLakeFormationOptInResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLakeFormationOptInResponse response = new CreateLakeFormationOptInResponse();
        ...
        private static CreateLakeFormationOptInResponseUnmarshaller _instance = new CreateLakeFormationOptInResponseUnmarshaller();        

        internal static CreateLakeFormationOptInResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLakeFormationOptInResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
