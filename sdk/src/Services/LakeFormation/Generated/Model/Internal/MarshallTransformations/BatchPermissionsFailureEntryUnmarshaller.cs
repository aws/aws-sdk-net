...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchPermissionsFailureEntryUnmarshaller : IJsonUnmarshaller<BatchPermissionsFailureEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchPermissionsFailureEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RequestEntry", targetDepth, ref reader))
                {
                    var unmarshaller = BatchPermissionsRequestEntryUnmarshaller.Instance;
                    unmarshalledObject.RequestEntry = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
