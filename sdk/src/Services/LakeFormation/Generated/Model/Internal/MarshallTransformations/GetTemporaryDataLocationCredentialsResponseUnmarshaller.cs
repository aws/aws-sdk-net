...
{
    /// <summary>
    /// Response Unmarshaller for GetTemporaryDataLocationCredentials operation
    /// </summary>  
    public class GetTemporaryDataLocationCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTemporaryDataLocationCredentialsResponse response = new GetTemporaryDataLocationCredentialsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AccessibleDataLocations", targetDepth))
                {
                    ...
                    response.AccessibleDataLocations = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("CredentialsScope", targetDepth))
                {
                    ...
                    response.CredentialsScope = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetTemporaryDataLocationCredentialsResponseUnmarshaller _instance = new GetTemporaryDataLocationCredentialsResponseUnmarshaller();        

        internal static GetTemporaryDataLocationCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemporaryDataLocationCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
