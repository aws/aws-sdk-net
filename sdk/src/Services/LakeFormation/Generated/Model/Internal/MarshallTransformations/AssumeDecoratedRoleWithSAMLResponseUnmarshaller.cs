...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssumeDecoratedRoleWithSAMLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssumeDecoratedRoleWithSAMLResponse response = new AssumeDecoratedRoleWithSAMLResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AccessKeyId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AccessKeyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SecretAccessKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SecretAccessKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SessionToken", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SessionToken = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static AssumeDecoratedRoleWithSAMLResponseUnmarshaller _instance = new AssumeDecoratedRoleWithSAMLResponseUnmarshaller();        

        internal static AssumeDecoratedRoleWithSAMLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssumeDecoratedRoleWithSAMLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
