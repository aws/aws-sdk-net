    ...
    public class GetQueryStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ExecutionStatistics", targetDepth))
                {
                    ...
                    response.ExecutionStatistics = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PlanningStatistics", targetDepth))
                {
                    var unmarshaller = PlanningStatisticsUnmarshaller.Instance;
                    response.PlanningStatistics = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return StatisticsNotReadyYetExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
