...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDataLakeSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DataLakeSettings", targetDepth))
                {
                    ...
                    response.DataLakeSettings = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDataLakeSettingsResponseUnmarshaller _instance = new GetDataLakeSettingsResponseUnmarshaller();        

        internal static GetDataLakeSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataLakeSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
