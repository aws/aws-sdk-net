...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLakeFormationIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLakeFormationIdentityCenterConfigurationResponse response = new DescribeLakeFormationIdentityCenterConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CatalogId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ExternalFiltering", targetDepth))
                {
                    ...
                    response.ExternalFiltering = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static DescribeLakeFormationIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLakeFormationIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
