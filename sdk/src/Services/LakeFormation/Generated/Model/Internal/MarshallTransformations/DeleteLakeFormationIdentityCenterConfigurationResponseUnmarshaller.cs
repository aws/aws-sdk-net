...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLakeFormationIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLakeFormationIdentityCenterConfigurationResponse response = new DeleteLakeFormationIdentityCenterConfigurationResponse();
        ...
        private static DeleteLakeFormationIdentityCenterConfigurationResponseUnmarshaller _instance = new DeleteLakeFormationIdentityCenterConfigurationResponseUnmarshaller();        

        internal static DeleteLakeFormationIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLakeFormationIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
