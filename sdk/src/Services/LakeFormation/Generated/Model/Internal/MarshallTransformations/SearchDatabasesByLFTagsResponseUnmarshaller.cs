...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SearchDatabasesByLFTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchDatabasesByLFTagsResponse response = new SearchDatabasesByLFTagsResponse();
            ...
            {
                if (context.TestExpression("DatabaseList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TaggedDatabase, TaggedDatabaseUnmarshaller>(TaggedDatabaseUnmarshaller.Instance);
                    response.DatabaseList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchDatabasesByLFTagsResponseUnmarshaller _instance = new SearchDatabasesByLFTagsResponseUnmarshaller();        

        internal static SearchDatabasesByLFTagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchDatabasesByLFTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
