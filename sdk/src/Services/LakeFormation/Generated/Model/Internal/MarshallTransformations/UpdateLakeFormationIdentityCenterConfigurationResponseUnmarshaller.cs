...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLakeFormationIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLakeFormationIdentityCenterConfigurationResponse response = new UpdateLakeFormationIdentityCenterConfigurationResponse();
        ...
        private static UpdateLakeFormationIdentityCenterConfigurationResponseUnmarshaller _instance = new UpdateLakeFormationIdentityCenterConfigurationResponseUnmarshaller();        

        internal static UpdateLakeFormationIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLakeFormationIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
