...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    public class RedshiftScopeUnionUnmarshaller : IUnmarshaller<RedshiftScopeUnion, XmlUnmarshallerContext>, IUnmarshaller<RedshiftScopeUnion, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        RedshiftScopeUnion IUnmarshaller<RedshiftScopeUnion, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RedshiftScopeUnion Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("RedshiftConnect", targetDepth))
                {
                    ...
                    unmarshalledObject.RedshiftConnect = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
