...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTableObjectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableObjectsResponse response = new GetTableObjectsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Objects", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PartitionObjects, PartitionObjectsUnmarshaller>(PartitionObjectsUnmarshaller.Instance);
                    response.Objects = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTableObjectsResponseUnmarshaller _instance = new GetTableObjectsResponseUnmarshaller();        

        internal static GetTableObjectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableObjectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
