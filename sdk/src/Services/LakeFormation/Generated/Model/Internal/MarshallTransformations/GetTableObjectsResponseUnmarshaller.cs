    ...
    public class GetTableObjectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PartitionObjects, PartitionObjectsUnmarshaller>(PartitionObjectsUnmarshaller.Instance);
                    response.Objects = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
