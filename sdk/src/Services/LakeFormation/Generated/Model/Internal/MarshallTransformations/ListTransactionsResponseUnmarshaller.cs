...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTransactionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Transactions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TransactionDescription, TransactionDescriptionUnmarshaller>(TransactionDescriptionUnmarshaller.Instance);
                    response.Transactions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTransactionsResponseUnmarshaller _instance = new ListTransactionsResponseUnmarshaller();        

        internal static ListTransactionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTransactionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
