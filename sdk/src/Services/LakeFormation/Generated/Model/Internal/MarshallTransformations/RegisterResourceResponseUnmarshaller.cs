...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterResourceResponseUnmarshaller _instance = new RegisterResourceResponseUnmarshaller();        

        internal static RegisterResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
