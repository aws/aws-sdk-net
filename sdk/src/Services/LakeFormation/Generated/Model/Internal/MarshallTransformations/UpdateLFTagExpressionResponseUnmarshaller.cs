...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLFTagExpression operation
    /// </summary>  
    public class UpdateLFTagExpressionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLFTagExpressionResponse response = new UpdateLFTagExpressionResponse();
        ...
        private static UpdateLFTagExpressionResponseUnmarshaller _instance = new UpdateLFTagExpressionResponseUnmarshaller();        

        internal static UpdateLFTagExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLFTagExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
