    ...
    public class ListTableStorageOptimizersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StorageOptimizer, StorageOptimizerUnmarshaller>(StorageOptimizerUnmarshaller.Instance);
                    response.StorageOptimizerList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
