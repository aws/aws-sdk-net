...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetResourceLFTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceLFTagsResponse response = new GetResourceLFTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("LFTagOnDatabase", targetDepth))
                {
                    ...
                    response.LFTagOnDatabase = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("LFTagsOnColumns", targetDepth))
                {
                    ...
                    response.LFTagsOnColumns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("LFTagsOnTable", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<LFTagPair, LFTagPairUnmarshaller>(LFTagPairUnmarshaller.Instance);
                    response.LFTagsOnTable = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetResourceLFTagsResponseUnmarshaller _instance = new GetResourceLFTagsResponseUnmarshaller();        

        internal static GetResourceLFTagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceLFTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
