...
namespace Amazon.ConnectCampaignsV2
{
    ...
    public partial class AmazonConnectCampaignsV2Client : AmazonServiceClient, IAmazonConnectCampaignsV2
    {
        ...
        internal virtual DeleteCampaignEntryLimitsResponse DeleteCampaignEntryLimits(DeleteCampaignEntryLimitsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual UpdateCampaignEntryLimitsResponse UpdateCampaignEntryLimits(UpdateCampaignEntryLimitsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
