    ...
    public class OpenHoursUnmarshaller : IUnmarshaller<OpenHours, XmlUnmarshallerContext>, IUnmarshaller<OpenHours, JsonUnmarshallerContext>
    {
        ...
        public OpenHours Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, List<TimeRange>, StringUnmarshaller, ListUnmarshaller<TimeRange, TimeRangeUnmarshaller>>(StringUnmarshaller.Instance, new ListUnmarshaller<TimeRange, TimeRangeUnmarshaller>(TimeRangeUnmarshaller.Instance));
                    unmarshalledObject.DailyHours = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
