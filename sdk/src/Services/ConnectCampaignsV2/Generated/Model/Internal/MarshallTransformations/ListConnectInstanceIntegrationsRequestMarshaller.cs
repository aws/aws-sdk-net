...
namespace Amazon.ConnectCampaignsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListConnectInstanceIntegrationsRequestMarshaller : IMarshaller<IRequest, ListConnectInstanceIntegrationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListConnectInstanceIntegrationsRequestMarshaller _instance = new ListConnectInstanceIntegrationsRequestMarshaller();        

        internal static ListConnectInstanceIntegrationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListConnectInstanceIntegrationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
