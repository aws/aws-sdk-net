...
namespace Amazon.ConnectCampaignsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PreviewConfigUnmarshaller : IUnmarshaller<PreviewConfig, XmlUnmarshallerContext>, IUnmarshaller<PreviewConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PreviewConfig IUnmarshaller<PreviewConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PreviewConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("agentActions", targetDepth))
                {
                    ...
                    unmarshalledObject.AgentActions = unmarshaller.Unmarshall(context);
                    continue;
                }
