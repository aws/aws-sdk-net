...
namespace Amazon.BedrockAgentCore
{
    ...
    public partial class AmazonBedrockAgentCoreClient : AmazonServiceClient, IAmazonBedrockAgentCore
    {
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the Evaluate operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the Evaluate operation on AmazonBedrockAgentCoreClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndEvaluate
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/Evaluate">REST API Reference for Evaluate Operation</seealso>
        public virtual IAsyncResult BeginEvaluate(EvaluateRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = EvaluateRequestMarshaller.Instance;
            options.ResponseUnmarshaller = EvaluateResponseUnmarshaller.Instance;
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  Evaluate operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginEvaluate.</param>
        /// 
        /// <returns>Returns a  EvaluateResult from BedrockAgentCore.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/Evaluate">REST API Reference for Evaluate Operation</seealso>
        public virtual EvaluateResponse EndEvaluate(IAsyncResult asyncResult)
        {
            return EndInvoke<EvaluateResponse>(asyncResult);
        }
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the InvokeAgentRuntimeCommand operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the InvokeAgentRuntimeCommand operation on AmazonBedrockAgentCoreClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndInvokeAgentRuntimeCommand
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/InvokeAgentRuntimeCommand">REST API Reference for InvokeAgentRuntimeCommand Operation</seealso>
        public virtual IAsyncResult BeginInvokeAgentRuntimeCommand(InvokeAgentRuntimeCommandRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = InvokeAgentRuntimeCommandRequestMarshaller.Instance;
            options.ResponseUnmarshaller = InvokeAgentRuntimeCommandResponseUnmarshaller.Instance;
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  InvokeAgentRuntimeCommand operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginInvokeAgentRuntimeCommand.</param>
        /// 
        /// <returns>Returns a  InvokeAgentRuntimeCommandResult from BedrockAgentCore.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agentcore-2024-02-28/InvokeAgentRuntimeCommand">REST API Reference for InvokeAgentRuntimeCommand Operation</seealso>
        public virtual InvokeAgentRuntimeCommandResponse EndInvokeAgentRuntimeCommand(IAsyncResult asyncResult)
        {
            return EndInvoke<InvokeAgentRuntimeCommandResponse>(asyncResult);
        }
