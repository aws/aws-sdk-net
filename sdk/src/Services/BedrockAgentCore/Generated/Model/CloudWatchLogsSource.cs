...
namespace Amazon.BedrockAgentCore.Model
{
    ...
    public partial class CloudWatchLogsSource
    {
        ...
        /// </para>
        /// </summary>
        public CloudWatchFilterConfig FilterConfig
        {
            get { return this._filterConfig; }
            set { this._filterConfig = value; }
        }

        // Check to see if FilterConfig property is set
        internal bool IsSetFilterConfig()
        {
            return this._filterConfig != null;
        }
