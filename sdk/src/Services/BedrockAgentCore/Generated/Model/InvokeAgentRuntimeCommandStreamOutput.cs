...
namespace Amazon.BedrockAgentCore.Model
{
    ...
    public sealed class InvokeAgentRuntimeCommandStreamOutput : EnumerableEventStream<IEventStreamEvent, BedrockAgentCoreEventStreamException>
    {
        /// <summary>
        ...
        new Dictionary<string,Func<IEventStreamMessage,IEventStreamEvent>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"Chunk", payload => new ResponseChunkUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
        };
        /// <summary>
        ...
        new Dictionary<string,Func<IEventStreamMessage,BedrockAgentCoreEventStreamException>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "RuntimeClientError", payload => new BedrockAgentCoreEventStreamException(Encoding.UTF8.GetString(payload.Payload), new RuntimeClientErrorExceptionUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))) },
        ...
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<ResponseChunk>> ChunkReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public InvokeAgentRuntimeCommandStreamOutput(Stream stream) : this (stream, null)
        {
        }
        ...
        public InvokeAgentRuntimeCommandStreamOutput(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
