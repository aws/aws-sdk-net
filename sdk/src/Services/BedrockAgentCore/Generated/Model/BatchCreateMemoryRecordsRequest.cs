...
{
    /// <summary>
    /// Container for the parameters to the BatchCreateMemoryRecords operation.
    ...
    public partial class BatchCreateMemoryRecordsRequest : AmazonBedrockAgentCoreRequest
    {
        ...
        private List<MemoryRecordCreateInput> _records = AWSConfigs.InitializeCollections ? new List<MemoryRecordCreateInput>() : null;
        ...
        public List<MemoryRecordCreateInput> Records
        {
