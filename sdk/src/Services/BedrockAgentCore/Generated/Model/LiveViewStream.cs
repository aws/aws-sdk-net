...
namespace Amazon.BedrockAgentCore.Model
{
    ...
    /// session in Amazon Bedrock AgentCore. This stream enables agents to observe the current
    /// state of the browser, including rendered web pages, visual elements, and the results
    /// of interactions.
    /// </summary>
