...
{
    /// <summary>
    /// Response Unmarshaller for CreateABTest operation
    /// </summary>  
    public class CreateABTestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateABTestResponse response = new CreateABTestResponse();
        ...
        private static CreateABTestResponseUnmarshaller _instance = new CreateABTestResponseUnmarshaller();        

        internal static CreateABTestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateABTestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
