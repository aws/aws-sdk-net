...
{
    /// <summary>
    /// Response Unmarshaller for DeleteABTest operation
    /// </summary>  
    public class DeleteABTestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteABTestResponse response = new DeleteABTestResponse();
        ...
        private static DeleteABTestResponseUnmarshaller _instance = new DeleteABTestResponseUnmarshaller();        

        internal static DeleteABTestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteABTestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
