...
{
    /// <summary>
    /// Response Unmarshaller for ListMemoryExtractionJobs operation
    /// </summary>  
    public class ListMemoryExtractionJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMemoryExtractionJobsResponse response = new ListMemoryExtractionJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ExtractionJobMetadata, ExtractionJobMetadataUnmarshaller>(ExtractionJobMetadataUnmarshaller.Instance);
        ...
        private static ListMemoryExtractionJobsResponseUnmarshaller _instance = new ListMemoryExtractionJobsResponseUnmarshaller();        

        internal static ListMemoryExtractionJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMemoryExtractionJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
