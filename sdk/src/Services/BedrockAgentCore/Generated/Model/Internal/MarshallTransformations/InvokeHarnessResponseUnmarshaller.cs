...
{
    /// <summary>
    /// Response Unmarshaller for InvokeHarness operation
    /// </summary>  
    public class InvokeHarnessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InvokeHarnessResponse response = new InvokeHarnessResponse();
            response.Stream = new InvokeHarnessStreamOutput(context.Stream);
        ...
        private static InvokeHarnessResponseUnmarshaller _instance = new InvokeHarnessResponseUnmarshaller();        

        internal static InvokeHarnessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeHarnessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
