...
{
    /// <summary>
    /// GetPaymentInstrumentBalance Request Marshaller
    /// </summary>       
    public class GetPaymentInstrumentBalanceRequestMarshaller : IMarshaller<IRequest, GetPaymentInstrumentBalanceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPaymentInstrumentBalanceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPaymentInstrumentBalanceRequest publicRequest)
        {
            ...
            request.ResourcePath = "/payments/getPaymentInstrumentBalance";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetChain())
            {
                context.Writer.WritePropertyName("chain");
                context.Writer.WriteStringValue(publicRequest.Chain);
            }
        ...
        private static GetPaymentInstrumentBalanceRequestMarshaller _instance = new GetPaymentInstrumentBalanceRequestMarshaller();        

        internal static GetPaymentInstrumentBalanceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPaymentInstrumentBalanceRequestMarshaller Instance
        {
            get
            {
                return _instance;
