...
{
    /// <summary>
    /// Response Unmarshaller for IngestData operation
    /// </summary>  
    public class IngestDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            IngestDataResponse response = new IngestDataResponse();
        ...
        private static IngestDataResponseUnmarshaller _instance = new IngestDataResponseUnmarshaller();        

        internal static IngestDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IngestDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
