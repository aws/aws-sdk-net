...
{
    /// <summary>
    /// Response Unmarshaller for LinkedAccount Object
    /// </summary>  
    public class LinkedAccountUnmarshaller : IJsonUnmarshaller<LinkedAccount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LinkedAccount Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            LinkedAccount unmarshalledObject = new LinkedAccount();
        ...
        private static LinkedAccountUnmarshaller _instance = new LinkedAccountUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LinkedAccountUnmarshaller Instance
        {
            get
            {
                return _instance;
