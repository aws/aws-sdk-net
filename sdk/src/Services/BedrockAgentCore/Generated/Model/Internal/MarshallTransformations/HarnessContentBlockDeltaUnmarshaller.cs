...
{
    /// <summary>
    /// Response Unmarshaller for HarnessContentBlockDelta Object
    /// </summary>  
    public class HarnessContentBlockDeltaUnmarshaller : IJsonUnmarshaller<HarnessContentBlockDelta, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessContentBlockDelta Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessContentBlockDelta unmarshalledObject = new HarnessContentBlockDelta();
        ...
        private static HarnessContentBlockDeltaUnmarshaller _instance = new HarnessContentBlockDeltaUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessContentBlockDeltaUnmarshaller Instance
        {
            get
            {
                return _instance;
