...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MemoryRecordOutputUnmarshaller : IJsonUnmarshaller<MemoryRecordOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MemoryRecordOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("memoryRecordId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
