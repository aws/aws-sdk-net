...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PayloadTypeUnmarshaller : IUnmarshaller<PayloadType, XmlUnmarshallerContext>, IUnmarshaller<PayloadType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PayloadType IUnmarshaller<PayloadType, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PayloadType Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("conversational", targetDepth))
                {
                    ...
                    unmarshalledObject.Conversational = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
