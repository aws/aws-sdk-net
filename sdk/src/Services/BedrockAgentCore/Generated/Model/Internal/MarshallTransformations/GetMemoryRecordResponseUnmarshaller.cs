...
{
    /// <summary>
    /// Response Unmarshaller for GetMemoryRecord operation
    /// </summary>  
    public class GetMemoryRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMemoryRecordResponse response = new GetMemoryRecordResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("memoryRecord", targetDepth))
                {
                    ...
                    response.MemoryRecord = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetMemoryRecordResponseUnmarshaller _instance = new GetMemoryRecordResponseUnmarshaller();        

        internal static GetMemoryRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMemoryRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
