...
{
    /// <summary>
    /// Response Unmarshaller for HarnessTokenUsage Object
    /// </summary>  
    public class HarnessTokenUsageUnmarshaller : IJsonUnmarshaller<HarnessTokenUsage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessTokenUsage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessTokenUsage unmarshalledObject = new HarnessTokenUsage();
        ...
        private static HarnessTokenUsageUnmarshaller _instance = new HarnessTokenUsageUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessTokenUsageUnmarshaller Instance
        {
            get
            {
                return _instance;
