...
{
    /// <summary>
    /// Response Unmarshaller for ABTestSummary Object
    /// </summary>  
    public class ABTestSummaryUnmarshaller : IJsonUnmarshaller<ABTestSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ABTestSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ABTestSummary unmarshalledObject = new ABTestSummary();
        ...
        private static ABTestSummaryUnmarshaller _instance = new ABTestSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ABTestSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
