...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeletePaymentSessionRequestMarshaller : IMarshaller<IRequest, DeletePaymentSessionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeletePaymentSessionRequestMarshaller _instance = new DeletePaymentSessionRequestMarshaller();        

        internal static DeletePaymentSessionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePaymentSessionRequestMarshaller Instance
        {
            get
            {
                return _instance;
