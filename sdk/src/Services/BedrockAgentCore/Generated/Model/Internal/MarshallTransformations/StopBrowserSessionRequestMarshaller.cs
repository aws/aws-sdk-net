...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StopBrowserSessionRequestMarshaller : IMarshaller<IRequest, StopBrowserSessionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static StopBrowserSessionRequestMarshaller _instance = new StopBrowserSessionRequestMarshaller();        

        internal static StopBrowserSessionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopBrowserSessionRequestMarshaller Instance
        {
            get
            {
                return _instance;
