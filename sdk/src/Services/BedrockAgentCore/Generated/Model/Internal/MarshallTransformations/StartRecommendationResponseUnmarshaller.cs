...
{
    /// <summary>
    /// Response Unmarshaller for StartRecommendation operation
    /// </summary>  
    public class StartRecommendationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRecommendationResponse response = new StartRecommendationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("recommendationConfig", targetDepth, ref reader))
                {
                    var unmarshaller = RecommendationConfigUnmarshaller.Instance;
                    response.RecommendationConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartRecommendationResponseUnmarshaller _instance = new StartRecommendationResponseUnmarshaller();        

        internal static StartRecommendationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRecommendationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
