...
{
    /// <summary>
    /// Response Unmarshaller for EmbeddedCryptoWallet Object
    /// </summary>  
    public class EmbeddedCryptoWalletUnmarshaller : IJsonUnmarshaller<EmbeddedCryptoWallet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EmbeddedCryptoWallet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EmbeddedCryptoWallet unmarshalledObject = new EmbeddedCryptoWallet();
        ...
        private static EmbeddedCryptoWalletUnmarshaller _instance = new EmbeddedCryptoWalletUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EmbeddedCryptoWalletUnmarshaller Instance
        {
            get
            {
                return _instance;
