...
{
    /// <summary>
    /// Response Unmarshaller for ListActors operation
    /// </summary>  
    public class ListActorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListActorsResponse response = new ListActorsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("actorSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ActorSummary, ActorSummaryUnmarshaller>(ActorSummaryUnmarshaller.Instance);
                    response.ActorSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListActorsResponseUnmarshaller _instance = new ListActorsResponseUnmarshaller();        

        internal static ListActorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListActorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
