...
{
    /// <summary>
    /// GetPaymentInstrument Request Marshaller
    /// </summary>       
    public class GetPaymentInstrumentRequestMarshaller : IMarshaller<IRequest, GetPaymentInstrumentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPaymentInstrumentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPaymentInstrumentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/payments/getPaymentInstrument";
#if !NETFRAMEWORK
        ...
        private static GetPaymentInstrumentRequestMarshaller _instance = new GetPaymentInstrumentRequestMarshaller();        

        internal static GetPaymentInstrumentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPaymentInstrumentRequestMarshaller Instance
        {
            get
            {
                return _instance;
