...
{
    /// <summary>
    /// Response Unmarshaller for GetPaymentInstrument operation
    /// </summary>  
    public class GetPaymentInstrumentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPaymentInstrumentResponse response = new GetPaymentInstrumentResponse();
        ...
        private static GetPaymentInstrumentResponseUnmarshaller _instance = new GetPaymentInstrumentResponseUnmarshaller();        

        internal static GetPaymentInstrumentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPaymentInstrumentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
