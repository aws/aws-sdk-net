...
{
    /// <summary>
    /// Response Unmarshaller for BrowserActionResult Object
    /// </summary>  
    public class BrowserActionResultUnmarshaller : IJsonUnmarshaller<BrowserActionResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BrowserActionResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BrowserActionResult unmarshalledObject = new BrowserActionResult();
        ...
        private static BrowserActionResultUnmarshaller _instance = new BrowserActionResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BrowserActionResultUnmarshaller Instance
        {
            get
            {
                return _instance;
