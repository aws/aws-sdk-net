...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCapacityProviderSession operation
    /// </summary>  
    public class DeleteCapacityProviderSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCapacityProviderSessionResponse response = new DeleteCapacityProviderSessionResponse();
        ...
        private static DeleteCapacityProviderSessionResponseUnmarshaller _instance = new DeleteCapacityProviderSessionResponseUnmarshaller();        

        internal static DeleteCapacityProviderSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCapacityProviderSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
