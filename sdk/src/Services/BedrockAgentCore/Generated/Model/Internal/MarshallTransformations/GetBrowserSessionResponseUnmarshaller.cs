...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBrowserSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBrowserSessionResponse response = new GetBrowserSessionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BrowserExtension, BrowserExtensionUnmarshaller>(BrowserExtensionUnmarshaller.Instance);
                ...
                if (context.TestExpression("proxyConfiguration", targetDepth))
                {
                    ...
                    response.ProxyConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SessionReplayArtifact = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("sessionTimeoutSeconds", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.SessionTimeoutSeconds = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("viewPort", targetDepth))
                {
                    ...
                    response.ViewPort = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static GetBrowserSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBrowserSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
