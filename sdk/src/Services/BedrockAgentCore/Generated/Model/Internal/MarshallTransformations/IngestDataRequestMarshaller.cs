...
{
    /// <summary>
    /// IngestData Request Marshaller
    /// </summary>       
    public class IngestDataRequestMarshaller : IMarshaller<IRequest, IngestDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((IngestDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(IngestDataRequest publicRequest)
        {
            ...
            request.ResourcePath = "/memories/{memoryId}/ingest";
#if !NETFRAMEWORK
        ...
        private static IngestDataRequestMarshaller _instance = new IngestDataRequestMarshaller();        

        internal static IngestDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IngestDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
