...
{
    /// <summary>
    /// DeletePaymentInstrument Request Marshaller
    /// </summary>       
    public class DeletePaymentInstrumentRequestMarshaller : IMarshaller<IRequest, DeletePaymentInstrumentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePaymentInstrumentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePaymentInstrumentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/payments/deletePaymentInstrument";
#if !NETFRAMEWORK
        ...
        private static DeletePaymentInstrumentRequestMarshaller _instance = new DeletePaymentInstrumentRequestMarshaller();        

        internal static DeletePaymentInstrumentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePaymentInstrumentRequestMarshaller Instance
        {
            get
            {
                return _instance;
