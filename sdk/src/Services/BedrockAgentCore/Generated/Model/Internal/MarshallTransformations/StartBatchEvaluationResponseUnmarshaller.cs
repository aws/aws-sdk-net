...
{
    /// <summary>
    /// Response Unmarshaller for StartBatchEvaluation operation
    /// </summary>  
    public class StartBatchEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBatchEvaluationResponse response = new StartBatchEvaluationResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("batchEvaluationArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BatchEvaluationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("batchEvaluationId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BatchEvaluationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("batchEvaluationName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static StartBatchEvaluationResponseUnmarshaller _instance = new StartBatchEvaluationResponseUnmarshaller();        

        internal static StartBatchEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBatchEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
