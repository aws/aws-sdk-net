...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    public class VariantMarshaller : IRequestMarshaller<Variant, JsonMarshallerContext> 
    {
        ...
        public void Marshall(Variant requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetVariantConfiguration())
            {
                context.Writer.WritePropertyName("variantConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = VariantConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.VariantConfiguration, context);
