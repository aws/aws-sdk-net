...
{
    /// <summary>
    /// ListPaymentInstruments Request Marshaller
    /// </summary>       
    public class ListPaymentInstrumentsRequestMarshaller : IMarshaller<IRequest, ListPaymentInstrumentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPaymentInstrumentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPaymentInstrumentsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/payments/listPaymentInstruments";
#if !NETFRAMEWORK
        ...
        private static ListPaymentInstrumentsRequestMarshaller _instance = new ListPaymentInstrumentsRequestMarshaller();        

        internal static ListPaymentInstrumentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPaymentInstrumentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
