...
{
    /// <summary>
    /// MemoryRecordUpdateInput Marshaller
    /// </summary>
    public class MemoryRecordUpdateInputMarshaller : IRequestMarshaller<MemoryRecordUpdateInput, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(MemoryRecordUpdateInput requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMemoryRecordId())
            {
                ...
                context.Writer.Write(requestObject.MemoryRecordId);
            }
        ...
        /// </summary>
        public readonly static MemoryRecordUpdateInputMarshaller Instance = new MemoryRecordUpdateInputMarshaller();
