...
{
    /// <summary>
    /// Response Unmarshaller for SaveBrowserSessionProfile operation
    /// </summary>  
    public class SaveBrowserSessionProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SaveBrowserSessionProfileResponse response = new SaveBrowserSessionProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("profileIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProfileIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SaveBrowserSessionProfileResponseUnmarshaller _instance = new SaveBrowserSessionProfileResponseUnmarshaller();        

        internal static SaveBrowserSessionProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SaveBrowserSessionProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
