...
{
    /// <summary>
    /// Container for the parameters to the GetResourcePaymentToken operation.
    ...
    {
        private PaymentTokenRequestInput _paymentTokenRequest;
        ...
        public PaymentTokenRequestInput PaymentTokenRequest
        {
            get { return this._paymentTokenRequest; }
            set { this._paymentTokenRequest = value; }
        }

        // Check to see if PaymentTokenRequest property is set
        internal bool IsSetPaymentTokenRequest()
        {
            return this._paymentTokenRequest != null;
        }
