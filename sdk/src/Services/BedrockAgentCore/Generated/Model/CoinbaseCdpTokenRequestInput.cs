...
namespace Amazon.BedrockAgentCore.Model
{
    ...
    {
        private bool? _includeWalletAuthToken;
        private string _requestBody;
        private string _requestHost;
        private PaymentHttpMethodType _requestMethod;
        ...
        {
            get { return this._includeWalletAuthToken; }
            set { this._includeWalletAuthToken = value; }
        }

        // Check to see if IncludeWalletAuthToken property is set
        internal bool IsSetIncludeWalletAuthToken()
        {
            return this._includeWalletAuthToken.HasValue; 
        }
        ...
        public PaymentHttpMethodType RequestMethod
        {
