...
{
    /// <summary>
    /// A reference to an insight analysis to run against sessions during batch evaluation.
    /// Insights provide deeper analysis beyond individual evaluator scores, including failure
    /// detection, user intent clustering, and execution summarization.
    /// </summary>
