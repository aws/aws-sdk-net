...
namespace Amazon.BedrockAgentCore.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "InvokeHarnessStreamOutputCollection is not descriptive")]
    ...
    public sealed class InvokeHarnessStreamOutput : EnumerableEventOutputStream<IEventStreamEvent, BedrockAgentCoreEventStreamException>
    {
        /// <summary>
        ...
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<HarnessContentBlockDeltaEvent>> ContentBlockDeltaReceived;
        ///<summary>
        ///Raised when an ContentBlockStart event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<HarnessContentBlockStartEvent>> ContentBlockStartReceived;
        ///<summary>
        ...
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<HarnessMessageStopEvent>> MessageStopReceived;
        ///<summary>
        ///Raised when an Metadata event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<HarnessMetadataEvent>> MetadataReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public InvokeHarnessStreamOutput(Stream stream) : this (stream, null)
        {
        }
        ...
        public InvokeHarnessStreamOutput(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
