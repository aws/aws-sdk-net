...
namespace Amazon.BedrockAgentCore.Model
{
    ...
    public partial class GetRecommendationResponse : AmazonWebServiceResponse
    {
        ...
        private RecommendationResult _recommendationResult;
        ...
        /// <summary>
        /// Gets and sets the property RecommendationResult. 
        /// <para>
        /// The result of the recommendation, containing the optimized system prompt or tool descriptions.
        /// Only present when the recommendation status is <c>COMPLETED</c>.
        /// </para>
        /// </summary>
        public RecommendationResult RecommendationResult
        {
            get { return this._recommendationResult; }
            set { this._recommendationResult = value; }
        }

        // Check to see if RecommendationResult property is set
        internal bool IsSetRecommendationResult()
        {
            return this._recommendationResult != null;
        }
