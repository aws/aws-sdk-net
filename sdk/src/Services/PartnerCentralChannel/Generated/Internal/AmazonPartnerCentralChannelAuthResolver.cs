...
namespace Amazon.PartnerCentralChannel.Internal
{
    ...
    public class AmazonPartnerCentralChannelAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPartnerCentralChannelAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PartnerCentralChannel.
        /// </summary>
        public AmazonPartnerCentralChannelAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPartnerCentralChannelAuthSchemeParameters
            {
    ...
    public class AmazonPartnerCentralChannelAuthSchemeResolver : IAuthSchemeResolver<AmazonPartnerCentralChannelAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPartnerCentralChannelAuthSchemeParameters authParameters)
        {
