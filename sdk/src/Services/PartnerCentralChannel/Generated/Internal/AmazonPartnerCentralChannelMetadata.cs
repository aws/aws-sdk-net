...
{
    /// <summary>
    /// Service metadata for  Amazon PartnerCentralChannel service
    /// </summary>
    public partial class AmazonPartnerCentralChannelMetadata : IServiceMetadata
    {
        /// <summary>
        ...
        public string ServiceFullName
        {
            get
            {
                return "Partner Central Channel API";
            }
        }
