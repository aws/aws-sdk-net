...
{
    /// <summary>
    /// Amazon PartnerCentralChannel endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for PartnerCentralChannel service requests.
    /// Collects values for PartnerCentralChannelEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PartnerCentralChannelEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPartnerCentralChannelEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPartnerCentralChannelConfig)requestContext.ClientConfig;
            var result = new PartnerCentralChannelEndpointParameters();
