...
{
    /// <summary>
    /// GetRelationship Request Marshaller
    /// </summary>       
    public class GetRelationshipRequestMarshaller : IMarshaller<IRequest, GetRelationshipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRelationshipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRelationshipRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralChannel");
            string target = "PartnerCentralChannel.GetRelationship";
            ...
            if(publicRequest.IsSetProgramManagementAccountIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ProgramManagementAccountIdentifier);
            }
        ...
        private static GetRelationshipRequestMarshaller _instance = new GetRelationshipRequestMarshaller();        

        internal static GetRelationshipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationshipRequestMarshaller Instance
        {
            get
            {
                return _instance;
