...
namespace Amazon.PartnerCentralChannel.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RelationshipDetailUnmarshaller : IJsonUnmarshaller<RelationshipDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RelationshipDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("associatedAccountId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("programManagementAccountId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProgramManagementAccountId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("resaleAccountModel", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResaleAccountModel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("sector", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
