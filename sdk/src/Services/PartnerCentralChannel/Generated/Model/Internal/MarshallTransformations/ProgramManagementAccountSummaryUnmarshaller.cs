...
namespace Amazon.PartnerCentralChannel.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProgramManagementAccountSummaryUnmarshaller : IJsonUnmarshaller<ProgramManagementAccountSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProgramManagementAccountSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("program", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Program = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
