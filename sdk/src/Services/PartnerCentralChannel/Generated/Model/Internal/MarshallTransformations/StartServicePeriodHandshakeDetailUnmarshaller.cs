...
namespace Amazon.PartnerCentralChannel.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartServicePeriodHandshakeDetailUnmarshaller : IJsonUnmarshaller<StartServicePeriodHandshakeDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StartServicePeriodHandshakeDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("minimumNoticeDays", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MinimumNoticeDays = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("servicePeriodType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ServicePeriodType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
