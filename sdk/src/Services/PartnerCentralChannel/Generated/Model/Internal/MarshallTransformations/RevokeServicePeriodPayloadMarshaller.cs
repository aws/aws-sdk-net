...
{
    /// <summary>
    /// RevokeServicePeriodPayload Marshaller
    /// </summary>
    public class RevokeServicePeriodPayloadMarshaller : IRequestMarshaller<RevokeServicePeriodPayload, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RevokeServicePeriodPayload requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetProgramManagementAccountIdentifier())
            {
                ...
                context.Writer.Write(requestObject.ProgramManagementAccountIdentifier);
            }
        ...
        /// </summary>
        public readonly static RevokeServicePeriodPayloadMarshaller Instance = new RevokeServicePeriodPayloadMarshaller();
