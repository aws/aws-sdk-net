...
{
    /// <summary>
    /// Response Unmarshaller for RelationshipSummary Object
    /// </summary>  
    public class RelationshipSummaryUnmarshaller : IUnmarshaller<RelationshipSummary, XmlUnmarshallerContext>, IUnmarshaller<RelationshipSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RelationshipSummary IUnmarshaller<RelationshipSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RelationshipSummary Unmarshall(JsonUnmarshallerContext context)
        {
            RelationshipSummary unmarshalledObject = new RelationshipSummary();
        ...
        private static RelationshipSummaryUnmarshaller _instance = new RelationshipSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RelationshipSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
