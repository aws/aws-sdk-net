...
namespace Amazon.PI
{
    ...
    public partial interface IAmazonPI : IAmazonService, IDisposable
    {
        ...
        ListPerformanceAnalysisReportRecommendationsResponse ListPerformanceAnalysisReportRecommendations(ListPerformanceAnalysisReportRecommendationsRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/pi-2018-02-27/ListPerformanceAnalysisReportRecommendations">REST API Reference for ListPerformanceAnalysisReportRecommendations Operation</seealso>
        Task<ListPerformanceAnalysisReportRecommendationsResponse> ListPerformanceAnalysisReportRecommendationsAsync(ListPerformanceAnalysisReportRecommendationsRequest request, CancellationToken cancellationToken = default(CancellationToken));
