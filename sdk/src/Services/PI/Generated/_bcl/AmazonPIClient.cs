...
namespace Amazon.PI
{
    ...
    public partial class AmazonPIClient : AmazonServiceClient, IAmazonPI
    {
        ...
        public virtual ListPerformanceAnalysisReportRecommendationsResponse ListPerformanceAnalysisReportRecommendations(ListPerformanceAnalysisReportRecommendationsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
