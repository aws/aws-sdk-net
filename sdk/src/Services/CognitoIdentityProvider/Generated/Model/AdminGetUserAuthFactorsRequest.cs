...
{
    /// <summary>
    /// Container for the parameters to the AdminGetUserAuthFactors operation.
    ...
    ///  </li> </ul> </note>
    /// </summary>
    public partial class AdminGetUserAuthFactorsRequest : AmazonCognitoIdentityProviderRequest
    {
        ...
        /// <para>
        /// The ID of the user pool where you want to get information about the user's authentication
        /// factors.
        /// </para>
        /// </summary>
