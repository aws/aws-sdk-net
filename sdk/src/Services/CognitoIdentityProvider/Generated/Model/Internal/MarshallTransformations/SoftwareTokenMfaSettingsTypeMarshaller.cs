...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    public class SoftwareTokenMfaSettingsTypeMarshaller : IRequestMarshaller<SoftwareTokenMfaSettingsType, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(SoftwareTokenMfaSettingsType requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPreferredMfa())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.PreferredMfa.Value);
            }
