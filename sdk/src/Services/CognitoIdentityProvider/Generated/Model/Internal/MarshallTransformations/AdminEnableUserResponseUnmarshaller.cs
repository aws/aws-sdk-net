...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminEnableUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminEnableUserResponse response = new AdminEnableUserResponse();
        ...
        private static AdminEnableUserResponseUnmarshaller _instance = new AdminEnableUserResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminEnableUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
