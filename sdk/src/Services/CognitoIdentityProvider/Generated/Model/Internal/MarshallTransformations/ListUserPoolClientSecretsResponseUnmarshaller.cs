...
{
    /// <summary>
    /// Response Unmarshaller for ListUserPoolClientSecrets operation
    /// </summary>  
    public class ListUserPoolClientSecretsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUserPoolClientSecretsResponse response = new ListUserPoolClientSecretsResponse();
            ...
            {
                if (context.TestExpression("ClientSecrets", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ClientSecretDescriptorType, ClientSecretDescriptorTypeUnmarshaller>(ClientSecretDescriptorTypeUnmarshaller.Instance);
                    response.ClientSecrets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListUserPoolClientSecretsResponseUnmarshaller _instance = new ListUserPoolClientSecretsResponseUnmarshaller();        

        internal static ListUserPoolClientSecretsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserPoolClientSecretsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
