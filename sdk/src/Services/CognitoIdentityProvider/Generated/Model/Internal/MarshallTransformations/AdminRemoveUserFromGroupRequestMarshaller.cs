...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminRemoveUserFromGroupRequestMarshaller : IMarshaller<IRequest, AdminRemoveUserFromGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminRemoveUserFromGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminRemoveUserFromGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.AdminRemoveUserFromGroup";
