...
{
    /// <summary>
    /// Response Unmarshaller for CreateUserPoolReplica operation
    /// </summary>  
    public class CreateUserPoolReplicaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUserPoolReplicaResponse response = new CreateUserPoolReplicaResponse();
        ...
        private static CreateUserPoolReplicaResponseUnmarshaller _instance = new CreateUserPoolReplicaResponseUnmarshaller();        

        internal static CreateUserPoolReplicaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserPoolReplicaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
