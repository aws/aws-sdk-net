...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProvisionedLimit operation
    /// </summary>  
    public class UpdateProvisionedLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProvisionedLimitResponse response = new UpdateProvisionedLimitResponse();
        ...
        private static UpdateProvisionedLimitResponseUnmarshaller _instance = new UpdateProvisionedLimitResponseUnmarshaller();        

        internal static UpdateProvisionedLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProvisionedLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
