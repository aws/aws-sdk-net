...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnalyticsConfigurationTypeUnmarshaller : IUnmarshaller<AnalyticsConfigurationType, XmlUnmarshallerContext>, IUnmarshaller<AnalyticsConfigurationType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AnalyticsConfigurationType IUnmarshaller<AnalyticsConfigurationType, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AnalyticsConfigurationType Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("UserDataShared", targetDepth))
                {
                    ...
                    unmarshalledObject.UserDataShared = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
