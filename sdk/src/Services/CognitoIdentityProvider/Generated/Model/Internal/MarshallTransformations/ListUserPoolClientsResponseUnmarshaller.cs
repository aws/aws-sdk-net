...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListUserPoolClientsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUserPoolClientsResponse response = new ListUserPoolClientsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UserPoolClients", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UserPoolClientDescription, UserPoolClientDescriptionUnmarshaller>(UserPoolClientDescriptionUnmarshaller.Instance);
                    response.UserPoolClients = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListUserPoolClientsResponseUnmarshaller _instance = new ListUserPoolClientsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserPoolClientsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
