...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminListGroupsForUserRequestMarshaller : IMarshaller<IRequest, AdminListGroupsForUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminListGroupsForUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminListGroupsForUserRequest publicRequest)
        {
        ...
        private static AdminListGroupsForUserRequestMarshaller _instance = new AdminListGroupsForUserRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminListGroupsForUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
