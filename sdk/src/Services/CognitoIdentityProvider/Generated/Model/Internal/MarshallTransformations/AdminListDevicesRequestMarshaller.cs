...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminListDevicesRequestMarshaller : IMarshaller<IRequest, AdminListDevicesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminListDevicesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminListDevicesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.AdminListDevices";
        ...
        private static AdminListDevicesRequestMarshaller _instance = new AdminListDevicesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminListDevicesRequestMarshaller Instance
        {
            get
            {
                return _instance;
