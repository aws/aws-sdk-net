...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetUserPoolMfaConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetUserPoolMfaConfigResponse response = new SetUserPoolMfaConfigResponse();
        ...
        private static SetUserPoolMfaConfigResponseUnmarshaller _instance = new SetUserPoolMfaConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetUserPoolMfaConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
