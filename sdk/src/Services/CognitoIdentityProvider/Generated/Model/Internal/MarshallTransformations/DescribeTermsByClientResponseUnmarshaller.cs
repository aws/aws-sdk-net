...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTermsByClient operation
    /// </summary>  
    public class DescribeTermsByClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTermsByClientResponse response = new DescribeTermsByClientResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TermsTypeUnmarshaller.Instance;
                    response.Terms = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeTermsByClientResponseUnmarshaller _instance = new DescribeTermsByClientResponseUnmarshaller();        

        internal static DescribeTermsByClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTermsByClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
