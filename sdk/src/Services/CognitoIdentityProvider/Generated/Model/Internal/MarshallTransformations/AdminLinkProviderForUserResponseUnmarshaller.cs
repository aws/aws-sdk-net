...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminLinkProviderForUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminLinkProviderForUserResponse response = new AdminLinkProviderForUserResponse();
        ...
        private static AdminLinkProviderForUserResponseUnmarshaller _instance = new AdminLinkProviderForUserResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminLinkProviderForUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
