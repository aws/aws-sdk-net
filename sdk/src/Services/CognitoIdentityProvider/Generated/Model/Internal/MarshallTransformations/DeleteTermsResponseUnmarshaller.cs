...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTerms operation
    /// </summary>  
    public class DeleteTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTermsResponse response = new DeleteTermsResponse();
        ...
        private static DeleteTermsResponseUnmarshaller _instance = new DeleteTermsResponseUnmarshaller();        

        internal static DeleteTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
