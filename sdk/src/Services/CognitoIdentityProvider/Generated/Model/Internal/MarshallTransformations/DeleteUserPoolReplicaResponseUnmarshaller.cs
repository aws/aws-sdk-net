...
{
    /// <summary>
    /// Response Unmarshaller for DeleteUserPoolReplica operation
    /// </summary>  
    public class DeleteUserPoolReplicaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUserPoolReplicaResponse response = new DeleteUserPoolReplicaResponse();
        ...
        private static DeleteUserPoolReplicaResponseUnmarshaller _instance = new DeleteUserPoolReplicaResponseUnmarshaller();        

        internal static DeleteUserPoolReplicaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserPoolReplicaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
