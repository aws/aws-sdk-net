...
{
    /// <summary>
    /// GetClientToken Request Marshaller
    /// </summary>       
    public class GetClientTokenRequestMarshaller : IMarshaller<IRequest, GetClientTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetClientTokenRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetClientTokenRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.GetClientToken";
        ...
        private static GetClientTokenRequestMarshaller _instance = new GetClientTokenRequestMarshaller();        

        internal static GetClientTokenRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetClientTokenRequestMarshaller Instance
        {
            get
            {
                return _instance;
