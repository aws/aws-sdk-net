...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminDeleteUserAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminDeleteUserAttributesResponse response = new AdminDeleteUserAttributesResponse();
        ...
        private static AdminDeleteUserAttributesResponseUnmarshaller _instance = new AdminDeleteUserAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminDeleteUserAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
