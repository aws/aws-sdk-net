...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminForgetDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminForgetDeviceResponse response = new AdminForgetDeviceResponse();
        ...
        private static AdminForgetDeviceResponseUnmarshaller _instance = new AdminForgetDeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminForgetDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
