...
{
    /// <summary>
    /// Response Unmarshaller for GetClientToken operation
    /// </summary>  
    public class GetClientTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ClientAuthenticationResult", targetDepth, ref reader))
                {
                    var unmarshaller = ClientAuthenticationResultTypeUnmarshaller.Instance;
                    response.ClientAuthenticationResult = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetClientTokenResponseUnmarshaller _instance = new GetClientTokenResponseUnmarshaller();        

        internal static GetClientTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetClientTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
