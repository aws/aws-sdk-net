...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateUserPoolDomainRequestMarshaller : IMarshaller<IRequest, CreateUserPoolDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateUserPoolDomainRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateUserPoolDomainRequest publicRequest)
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                using (StreamWriter streamWriter = new InvariantCultureStreamWriter(memoryStream))
                {
                    ...
                    if(publicRequest.IsSetManagedLoginVersion())
                    {
                        ...
                        context.Writer.Write(publicRequest.ManagedLoginVersion.Value);
                    }
        ...
        private static CreateUserPoolDomainRequestMarshaller _instance = new CreateUserPoolDomainRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserPoolDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
