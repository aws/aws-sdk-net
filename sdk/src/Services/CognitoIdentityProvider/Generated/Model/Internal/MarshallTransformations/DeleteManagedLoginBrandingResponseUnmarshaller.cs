...
{
    /// <summary>
    /// Response Unmarshaller for DeleteManagedLoginBranding operation
    /// </summary>  
    public class DeleteManagedLoginBrandingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteManagedLoginBrandingResponse response = new DeleteManagedLoginBrandingResponse();
        ...
        private static DeleteManagedLoginBrandingResponseUnmarshaller _instance = new DeleteManagedLoginBrandingResponseUnmarshaller();        

        internal static DeleteManagedLoginBrandingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteManagedLoginBrandingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
