...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListUserImportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUserImportJobsResponse response = new ListUserImportJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UserImportJobs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UserImportJobType, UserImportJobTypeUnmarshaller>(UserImportJobTypeUnmarshaller.Instance);
                    response.UserImportJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListUserImportJobsResponseUnmarshaller _instance = new ListUserImportJobsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserImportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
