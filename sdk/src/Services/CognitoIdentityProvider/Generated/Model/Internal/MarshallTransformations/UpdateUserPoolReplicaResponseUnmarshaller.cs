...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUserPoolReplica operation
    /// </summary>  
    public class UpdateUserPoolReplicaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUserPoolReplicaResponse response = new UpdateUserPoolReplicaResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UserPoolReplica", targetDepth, ref reader))
                {
                    var unmarshaller = UserPoolReplicaTypeUnmarshaller.Instance;
                    response.UserPoolReplica = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateUserPoolReplicaResponseUnmarshaller _instance = new UpdateUserPoolReplicaResponseUnmarshaller();        

        internal static UpdateUserPoolReplicaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserPoolReplicaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
