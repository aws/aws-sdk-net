...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateUserPoolDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUserPoolDomainResponse response = new CreateUserPoolDomainResponse();
        ...
        private static CreateUserPoolDomainResponseUnmarshaller _instance = new CreateUserPoolDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserPoolDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
