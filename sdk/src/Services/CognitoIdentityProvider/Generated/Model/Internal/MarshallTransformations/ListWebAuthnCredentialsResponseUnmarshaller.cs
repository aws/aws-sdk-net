...
{
    /// <summary>
    /// Response Unmarshaller for ListWebAuthnCredentials operation
    /// </summary>  
    public class ListWebAuthnCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWebAuthnCredentialsResponse response = new ListWebAuthnCredentialsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WebAuthnCredentialDescription, WebAuthnCredentialDescriptionUnmarshaller>(WebAuthnCredentialDescriptionUnmarshaller.Instance);
        ...
        private static ListWebAuthnCredentialsResponseUnmarshaller _instance = new ListWebAuthnCredentialsResponseUnmarshaller();        

        internal static ListWebAuthnCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWebAuthnCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
