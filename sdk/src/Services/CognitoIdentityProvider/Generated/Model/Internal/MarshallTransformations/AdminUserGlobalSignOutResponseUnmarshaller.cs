...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminUserGlobalSignOutResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminUserGlobalSignOutResponse response = new AdminUserGlobalSignOutResponse();
        ...
        private static AdminUserGlobalSignOutResponseUnmarshaller _instance = new AdminUserGlobalSignOutResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminUserGlobalSignOutResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
