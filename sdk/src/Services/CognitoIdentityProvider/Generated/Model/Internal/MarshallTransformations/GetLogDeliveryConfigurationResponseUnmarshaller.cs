...
{
    /// <summary>
    /// Response Unmarshaller for GetLogDeliveryConfiguration operation
    /// </summary>  
    public class GetLogDeliveryConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLogDeliveryConfigurationResponse response = new GetLogDeliveryConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LogDeliveryConfigurationTypeUnmarshaller.Instance;
        ...
        private static GetLogDeliveryConfigurationResponseUnmarshaller _instance = new GetLogDeliveryConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLogDeliveryConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
