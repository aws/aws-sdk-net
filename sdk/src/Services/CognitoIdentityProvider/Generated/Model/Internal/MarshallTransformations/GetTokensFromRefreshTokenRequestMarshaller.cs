...
{
    /// <summary>
    /// GetTokensFromRefreshToken Request Marshaller
    /// </summary>       
    public class GetTokensFromRefreshTokenRequestMarshaller : IMarshaller<IRequest, GetTokensFromRefreshTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTokensFromRefreshTokenRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTokensFromRefreshTokenRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.GetTokensFromRefreshToken";
        ...
        private static GetTokensFromRefreshTokenRequestMarshaller _instance = new GetTokensFromRefreshTokenRequestMarshaller();        

        internal static GetTokensFromRefreshTokenRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTokensFromRefreshTokenRequestMarshaller Instance
        {
            get
            {
                return _instance;
