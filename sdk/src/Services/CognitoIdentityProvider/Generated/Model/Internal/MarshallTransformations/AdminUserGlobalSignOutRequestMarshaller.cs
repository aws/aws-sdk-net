...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminUserGlobalSignOutRequestMarshaller : IMarshaller<IRequest, AdminUserGlobalSignOutRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminUserGlobalSignOutRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminUserGlobalSignOutRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.AdminUserGlobalSignOut";
