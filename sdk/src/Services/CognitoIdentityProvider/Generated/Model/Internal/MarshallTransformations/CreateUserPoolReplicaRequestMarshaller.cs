...
{
    /// <summary>
    /// CreateUserPoolReplica Request Marshaller
    /// </summary>       
    public class CreateUserPoolReplicaRequestMarshaller : IMarshaller<IRequest, CreateUserPoolReplicaRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateUserPoolReplicaRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateUserPoolReplicaRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.CreateUserPoolReplica";
        ...
        private static CreateUserPoolReplicaRequestMarshaller _instance = new CreateUserPoolReplicaRequestMarshaller();        

        internal static CreateUserPoolReplicaRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserPoolReplicaRequestMarshaller Instance
        {
            get
            {
                return _instance;
