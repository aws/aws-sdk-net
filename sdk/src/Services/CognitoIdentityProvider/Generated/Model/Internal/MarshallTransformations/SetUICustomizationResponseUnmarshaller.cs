...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetUICustomizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetUICustomizationResponse response = new SetUICustomizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("UICustomization", targetDepth))
                {
                    ...
                    response.UICustomization = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static SetUICustomizationResponseUnmarshaller _instance = new SetUICustomizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetUICustomizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
