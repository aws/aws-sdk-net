...
{
    /// <summary>
    /// Response Unmarshaller for UpdateManagedLoginBranding operation
    /// </summary>  
    public class UpdateManagedLoginBrandingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateManagedLoginBrandingResponse response = new UpdateManagedLoginBrandingResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ManagedLoginBranding", targetDepth))
                {
                    ...
                    response.ManagedLoginBranding = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateManagedLoginBrandingResponseUnmarshaller _instance = new UpdateManagedLoginBrandingResponseUnmarshaller();        

        internal static UpdateManagedLoginBrandingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateManagedLoginBrandingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
