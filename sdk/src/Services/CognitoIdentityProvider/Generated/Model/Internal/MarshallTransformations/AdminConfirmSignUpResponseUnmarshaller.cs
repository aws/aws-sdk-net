...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminConfirmSignUpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new TooManyFailedAttemptsException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static AdminConfirmSignUpResponseUnmarshaller _instance = new AdminConfirmSignUpResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminConfirmSignUpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
