...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteResourceServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteResourceServerResponse response = new DeleteResourceServerResponse();
        ...
        private static DeleteResourceServerResponseUnmarshaller _instance = new DeleteResourceServerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteResourceServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
