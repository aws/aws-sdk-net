...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateUserImportJobRequestMarshaller : IMarshaller<IRequest, CreateUserImportJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateUserImportJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateUserImportJobRequest publicRequest)
        {
        ...
        private static CreateUserImportJobRequestMarshaller _instance = new CreateUserImportJobRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserImportJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
