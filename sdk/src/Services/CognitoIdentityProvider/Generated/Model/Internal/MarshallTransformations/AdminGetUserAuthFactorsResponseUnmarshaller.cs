...
{
    /// <summary>
    /// Response Unmarshaller for AdminGetUserAuthFactors operation
    /// </summary>  
    public class AdminGetUserAuthFactorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminGetUserAuthFactorsResponse response = new AdminGetUserAuthFactorsResponse();
        ...
        private static AdminGetUserAuthFactorsResponseUnmarshaller _instance = new AdminGetUserAuthFactorsResponseUnmarshaller();        

        internal static AdminGetUserAuthFactorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminGetUserAuthFactorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
