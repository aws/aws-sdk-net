...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateUserImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUserImportJobResponse response = new CreateUserImportJobResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UserImportJob", targetDepth, ref reader))
                {
                    var unmarshaller = UserImportJobTypeUnmarshaller.Instance;
                    response.UserImportJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateUserImportJobResponseUnmarshaller _instance = new CreateUserImportJobResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
