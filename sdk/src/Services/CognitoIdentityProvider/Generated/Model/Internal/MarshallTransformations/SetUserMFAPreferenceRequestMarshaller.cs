...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetUserMFAPreferenceRequestMarshaller : IMarshaller<IRequest, SetUserMFAPreferenceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetUserMFAPreferenceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SetUserMFAPreferenceRequest publicRequest)
        {
