...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeIdentityProviderRequestMarshaller : IMarshaller<IRequest, DescribeIdentityProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeIdentityProviderRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.DescribeIdentityProvider";
        ...
        private static DescribeIdentityProviderRequestMarshaller _instance = new DescribeIdentityProviderRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIdentityProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
