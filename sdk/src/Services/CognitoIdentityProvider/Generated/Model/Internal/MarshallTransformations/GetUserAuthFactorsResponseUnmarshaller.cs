...
{
    /// <summary>
    /// Response Unmarshaller for GetUserAuthFactors operation
    /// </summary>  
    public class GetUserAuthFactorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUserAuthFactorsResponse response = new GetUserAuthFactorsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ConfiguredUserAuthFactors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ConfiguredUserAuthFactors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetUserAuthFactorsResponseUnmarshaller _instance = new GetUserAuthFactorsResponseUnmarshaller();        

        internal static GetUserAuthFactorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserAuthFactorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
