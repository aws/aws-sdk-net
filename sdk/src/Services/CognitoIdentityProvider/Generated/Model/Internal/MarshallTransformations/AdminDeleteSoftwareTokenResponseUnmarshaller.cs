...
{
    /// <summary>
    /// Response Unmarshaller for AdminDeleteSoftwareToken operation
    /// </summary>  
    public class AdminDeleteSoftwareTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminDeleteSoftwareTokenResponse response = new AdminDeleteSoftwareTokenResponse();
        ...
        private static AdminDeleteSoftwareTokenResponseUnmarshaller _instance = new AdminDeleteSoftwareTokenResponseUnmarshaller();        

        internal static AdminDeleteSoftwareTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminDeleteSoftwareTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
