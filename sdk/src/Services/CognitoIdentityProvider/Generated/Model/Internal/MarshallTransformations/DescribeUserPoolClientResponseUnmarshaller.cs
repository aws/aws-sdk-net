...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeUserPoolClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeUserPoolClientResponse response = new DescribeUserPoolClientResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UserPoolClient", targetDepth, ref reader))
                {
                    var unmarshaller = UserPoolClientTypeUnmarshaller.Instance;
                    response.UserPoolClient = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeUserPoolClientResponseUnmarshaller _instance = new DescribeUserPoolClientResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUserPoolClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
