...
{
    /// <summary>
    /// Response Unmarshaller for ListUserPoolReplicas operation
    /// </summary>  
    public class ListUserPoolReplicasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUserPoolReplicasResponse response = new ListUserPoolReplicasResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UserPoolReplicas", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UserPoolReplicaType, UserPoolReplicaTypeUnmarshaller>(UserPoolReplicaTypeUnmarshaller.Instance);
                    response.UserPoolReplicas = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListUserPoolReplicasResponseUnmarshaller _instance = new ListUserPoolReplicasResponseUnmarshaller();        

        internal static ListUserPoolReplicasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserPoolReplicasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
