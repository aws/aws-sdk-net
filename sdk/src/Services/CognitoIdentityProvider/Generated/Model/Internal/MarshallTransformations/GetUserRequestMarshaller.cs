...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetUserRequestMarshaller : IMarshaller<IRequest, GetUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetUserRequest publicRequest)
        {
        ...
        private static GetUserRequestMarshaller _instance = new GetUserRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
