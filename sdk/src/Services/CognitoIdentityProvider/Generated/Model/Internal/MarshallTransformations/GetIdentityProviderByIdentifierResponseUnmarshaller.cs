...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIdentityProviderByIdentifierResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdentityProviderByIdentifierResponse response = new GetIdentityProviderByIdentifierResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = IdentityProviderTypeUnmarshaller.Instance;
        ...
        private static GetIdentityProviderByIdentifierResponseUnmarshaller _instance = new GetIdentityProviderByIdentifierResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdentityProviderByIdentifierResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
