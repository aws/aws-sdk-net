...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GlobalSignOutResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GlobalSignOutResponse response = new GlobalSignOutResponse();
        ...
        private static GlobalSignOutResponseUnmarshaller _instance = new GlobalSignOutResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GlobalSignOutResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
