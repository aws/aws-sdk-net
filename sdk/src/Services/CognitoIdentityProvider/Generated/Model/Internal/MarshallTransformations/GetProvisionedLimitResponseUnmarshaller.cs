...
{
    /// <summary>
    /// Response Unmarshaller for GetProvisionedLimit operation
    /// </summary>  
    public class GetProvisionedLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProvisionedLimitResponse response = new GetProvisionedLimitResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LimitTypeUnmarshaller.Instance;
                    response.Limit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetProvisionedLimitResponseUnmarshaller _instance = new GetProvisionedLimitResponseUnmarshaller();        

        internal static GetProvisionedLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProvisionedLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
