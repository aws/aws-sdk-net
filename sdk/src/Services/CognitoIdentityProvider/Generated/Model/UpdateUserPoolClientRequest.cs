...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class UpdateUserPoolClientRequest : AmazonCognitoIdentityProviderRequest
    {
        ...
        ///  
        /// <para>
        /// Amazon Cognito requires HTTPS over HTTP except for <c>http://localhost</c> for testing
        /// purposes only.
        /// </para>
        ///  
        /// <para>
        ...
        /// The default unit for RefreshToken is days, and the default for ID and access tokens
        /// is hours.
        /// </para>
        /// </summary>
