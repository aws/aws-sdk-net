...
{
    /// <summary>
    /// <i>This data type is no longer supported.</i> You can use it only for SMS multi-factor
    /// authentication (MFA) configurations. You can't use it for time-based one-time password
