...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    /// </summary>
    public partial class InboundFederationLambdaType
    {
        private string _lambdaArn;
        private InboundFederationLambdaVersionType _lambdaVersion;
        ...
        ///  
        /// <para>
        /// You must use a <c>LambdaVersion</c> of <c>V1_0</c> with an inbound federation function.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public InboundFederationLambdaVersionType LambdaVersion
        {
