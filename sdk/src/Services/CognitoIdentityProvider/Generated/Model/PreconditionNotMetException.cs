...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    [Serializable]
    #endif
    public partial class PreconditionNotMetException : AmazonCognitoIdentityProviderException
    {
        ...
        public PreconditionNotMetException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PreconditionNotMetException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
