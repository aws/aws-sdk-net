...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class InvalidPasswordException : AmazonCognitoIdentityProviderException
    {
        ...
        public InvalidPasswordException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidPasswordException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
