...
namespace Amazon.CognitoIdentityProvider
{
    ...
    public partial class AmazonCognitoIdentityProviderException : AmazonServiceException
    {
        ...
        public AmazonCognitoIdentityProviderException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCognitoIdentityProviderException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        protected AmazonCognitoIdentityProviderException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
#endif
