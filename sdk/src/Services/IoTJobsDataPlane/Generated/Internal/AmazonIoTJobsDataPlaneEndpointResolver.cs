...
{
    /// <summary>
    /// Amazon IoTJobsDataPlane endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IoTJobsDataPlane service requests.
    /// Collects values for IoTJobsDataPlaneEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IoTJobsDataPlaneEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonIoTJobsDataPlaneEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonIoTJobsDataPlaneConfig)requestContext.ClientConfig;
            var result = new IoTJobsDataPlaneEndpointParameters();
