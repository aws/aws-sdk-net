...
namespace Amazon.IoTJobsDataPlane
{
    ...
    public partial class AmazonIoTJobsDataPlaneConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("IoT Jobs Data Plane", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "IoT Jobs Data Plane";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "data.jobs.iot";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2017-09-29";
