...
namespace Amazon.IoTJobsDataPlane.Model
{
    ...
    public partial class InvalidStateTransitionException : AmazonIoTJobsDataPlaneException
    {
        ...
        /// Construct instance of InvalidStateTransitionException
        /// </summary>
        public InvalidStateTransitionException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidStateTransitionException
        /// </summary>
        public InvalidStateTransitionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidStateTransitionException
        /// </summary>
        public InvalidStateTransitionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
