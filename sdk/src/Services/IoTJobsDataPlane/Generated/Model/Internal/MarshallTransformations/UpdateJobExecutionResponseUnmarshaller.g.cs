...
namespace Amazon.IoTJobsDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateJobExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateJobExecutionResponse();
        ...
        internal static UpdateJobExecutionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateJobExecutionResponseUnmarshaller Instance => _instance;
    }
}
