...
namespace Amazon.IoTJobsDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetPendingJobExecutionsRequestMarshaller : IMarshaller<IRequest, GetPendingJobExecutionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetPendingJobExecutionsRequestMarshaller _instance = new();

        internal static GetPendingJobExecutionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPendingJobExecutionsRequestMarshaller Instance => _instance;
    }
}
