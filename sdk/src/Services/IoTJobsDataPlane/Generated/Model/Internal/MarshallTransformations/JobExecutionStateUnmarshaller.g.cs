...
namespace Amazon.IoTJobsDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class JobExecutionStateUnmarshaller : IJsonUnmarshaller<JobExecutionState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new JobExecutionState();
        ...
        /// Gets the singleton.
        /// </summary>
        public static JobExecutionStateUnmarshaller Instance => _instance;
    }
}
