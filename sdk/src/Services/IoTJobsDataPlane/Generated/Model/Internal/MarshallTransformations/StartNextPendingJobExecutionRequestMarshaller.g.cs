...
namespace Amazon.IoTJobsDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartNextPendingJobExecutionRequestMarshaller : IMarshaller<IRequest, StartNextPendingJobExecutionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartNextPendingJobExecutionRequestMarshaller _instance = new();

        internal static StartNextPendingJobExecutionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartNextPendingJobExecutionRequestMarshaller Instance => _instance;
    }
}
