    ...
    public class DescribeEngineDefaultParametersRequestMarshaller : IMarshaller<IRequest, DescribeEngineDefaultParametersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeEngineDefaultParametersRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeEngineDefaultParametersRequestMarshaller _instance = new DescribeEngineDefaultParametersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEngineDefaultParametersRequestMarshaller Instance
        {
            get
            {
                return _instance;
