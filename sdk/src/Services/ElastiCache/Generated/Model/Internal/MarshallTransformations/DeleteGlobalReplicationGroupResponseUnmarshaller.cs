...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGlobalReplicationGroup operation
    /// </summary>  
    public class DeleteGlobalReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGlobalReplicationGroupResponse response = new DeleteGlobalReplicationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteGlobalReplicationGroupResult", 2))
                    {
        ...
        private static DeleteGlobalReplicationGroupResponseUnmarshaller _instance = new DeleteGlobalReplicationGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGlobalReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
