...
{
    /// <summary>
    /// Response Unmarshaller for DescribeServerlessCacheSnapshots operation
    /// </summary>  
    public class DescribeServerlessCacheSnapshotsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeServerlessCacheSnapshotsResponse response = new DescribeServerlessCacheSnapshotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeServerlessCacheSnapshotsResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ServerlessCacheSnapshots/ServerlessCacheSnapshot", targetDepth))
                    {
                        ...
                        if (response.ServerlessCacheSnapshots == null)
                        {
                            response.ServerlessCacheSnapshots = new List<ServerlessCacheSnapshot>();
                        }
                        var item = unmarshaller.Unmarshall(context);
                        response.ServerlessCacheSnapshots.Add(item);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeServerlessCacheSnapshotsResponseUnmarshaller _instance = new DescribeServerlessCacheSnapshotsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServerlessCacheSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
