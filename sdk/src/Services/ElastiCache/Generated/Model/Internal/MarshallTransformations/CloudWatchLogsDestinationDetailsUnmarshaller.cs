...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    public class CloudWatchLogsDestinationDetailsUnmarshaller : IXmlUnmarshaller<CloudWatchLogsDestinationDetails, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CloudWatchLogsDestinationDetails Unmarshall(XmlUnmarshallerContext context)
        {
            CloudWatchLogsDestinationDetails unmarshalledObject = new CloudWatchLogsDestinationDetails();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CloudWatchLogsDestinationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
