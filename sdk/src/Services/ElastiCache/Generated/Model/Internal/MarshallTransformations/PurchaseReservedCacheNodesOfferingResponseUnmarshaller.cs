...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PurchaseReservedCacheNodesOfferingResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return ReservedCacheNodeAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ReservedCacheNodeQuotaExceeded"))
                {
                    return ReservedCacheNodeQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static PurchaseReservedCacheNodesOfferingResponseUnmarshaller _instance = new PurchaseReservedCacheNodesOfferingResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PurchaseReservedCacheNodesOfferingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
