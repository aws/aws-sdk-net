...
{
    /// <summary>
    /// ModifyCacheParameterGroup Request Marshaller
    /// </summary>       
    public class ModifyCacheParameterGroupRequestMarshaller : IMarshaller<IRequest, ModifyCacheParameterGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyCacheParameterGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyCacheParameterGroupRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ModifyCacheParameterGroupRequestMarshaller _instance = new ModifyCacheParameterGroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyCacheParameterGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
