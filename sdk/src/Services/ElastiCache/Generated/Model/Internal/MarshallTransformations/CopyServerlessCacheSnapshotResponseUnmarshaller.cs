...
{
    /// <summary>
    /// Response Unmarshaller for CopyServerlessCacheSnapshot operation
    /// </summary>  
    public class CopyServerlessCacheSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CopyServerlessCacheSnapshotResponse response = new CopyServerlessCacheSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CopyServerlessCacheSnapshotResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CopyServerlessCacheSnapshotResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ServerlessCacheSnapshot", targetDepth))
                    {
                        var unmarshaller = ServerlessCacheSnapshotUnmarshaller.Instance;
                        response.ServerlessCacheSnapshot = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServerlessCacheSnapshotAlreadyExistsFault"))
                {
                    return ServerlessCacheSnapshotAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServerlessCacheSnapshotQuotaExceededFault"))
                {
                    return ServerlessCacheSnapshotQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CopyServerlessCacheSnapshotResponseUnmarshaller _instance = new CopyServerlessCacheSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CopyServerlessCacheSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
