...
{
    /// <summary>
    /// FailoverGlobalReplicationGroup Request Marshaller
    /// </summary>       
    public class FailoverGlobalReplicationGroupRequestMarshaller : IMarshaller<IRequest, FailoverGlobalReplicationGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((FailoverGlobalReplicationGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(FailoverGlobalReplicationGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElastiCache");
            request.Parameters.Add("Action", "FailoverGlobalReplicationGroup");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FailoverGlobalReplicationGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
