...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteCacheParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCacheParameterGroupResponse response = new DeleteCacheParameterGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteCacheParameterGroupResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidCacheParameterGroupStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteCacheParameterGroupResponseUnmarshaller _instance = new DeleteCacheParameterGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCacheParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
