...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCacheClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return CacheClusterAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateCacheClusterResponseUnmarshaller _instance = new CreateCacheClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCacheClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
