...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplicationGroupUnmarshaller : IXmlUnmarshaller<ReplicationGroup, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReplicationGroup Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("EffectiveDurability", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.EffectiveDurability = unmarshaller.Unmarshall(context);
                        continue;
                    }
