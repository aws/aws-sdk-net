...
{
    /// <summary>
    /// Response Unmarshaller for IncreaseNodeGroupsInGlobalReplicationGroup operation
    /// </summary>  
    public class IncreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            IncreaseNodeGroupsInGlobalReplicationGroupResponse response = new IncreaseNodeGroupsInGlobalReplicationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("IncreaseNodeGroupsInGlobalReplicationGroupResult", 2))
                    {
        ...
        private static IncreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller _instance = new IncreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IncreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
