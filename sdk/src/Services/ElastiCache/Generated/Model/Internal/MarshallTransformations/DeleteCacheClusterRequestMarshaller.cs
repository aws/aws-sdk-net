...
{
    /// <summary>
    /// DeleteCacheCluster Request Marshaller
    /// </summary>       
    public class DeleteCacheClusterRequestMarshaller : IMarshaller<IRequest, DeleteCacheClusterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCacheClusterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCacheClusterRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCacheClusterRequestMarshaller Instance
        {
            get
            {
                return _instance;
