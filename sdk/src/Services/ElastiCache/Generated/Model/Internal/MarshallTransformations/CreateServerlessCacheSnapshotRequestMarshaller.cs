...
{
    /// <summary>
    /// CreateServerlessCacheSnapshot Request Marshaller
    /// </summary>       
    public class CreateServerlessCacheSnapshotRequestMarshaller : IMarshaller<IRequest, CreateServerlessCacheSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateServerlessCacheSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateServerlessCacheSnapshotRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElastiCache");
            request.Parameters.Add("Action", "CreateServerlessCacheSnapshot");
            ...
            return request;
                    ...
                    private static CreateServerlessCacheSnapshotRequestMarshaller _instance = new CreateServerlessCacheSnapshotRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServerlessCacheSnapshotRequestMarshaller Instance
        {
            get
            {
                return _instance;
