...
namespace Amazon.ElastiCache.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidVPCNetworkStateException : AmazonElastiCacheException
    {
        ...
        public InvalidVPCNetworkStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidVPCNetworkStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
