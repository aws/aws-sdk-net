...
namespace Amazon.ElastiCache.Model
{
    ...
    internal sealed partial class DescribeServerlessCachesPaginator : IPaginator<DescribeServerlessCachesResponse>, IDescribeServerlessCachesPaginator
    {
        ...
        async IAsyncEnumerable<DescribeServerlessCachesResponse> IPaginator<DescribeServerlessCachesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
