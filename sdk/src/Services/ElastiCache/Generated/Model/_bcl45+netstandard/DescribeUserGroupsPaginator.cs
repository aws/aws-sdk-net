...
namespace Amazon.ElastiCache.Model
{
    ...
    internal sealed partial class DescribeUserGroupsPaginator : IPaginator<DescribeUserGroupsResponse>, IDescribeUserGroupsPaginator
    {
        ...
        public IPaginatedEnumerable<UserGroup> UserGroups => 
            new PaginatedResultKeyResponse<DescribeUserGroupsResponse, UserGroup>(this, (i) => i.UserGroups);
        ...
        async IAsyncEnumerable<DescribeUserGroupsResponse> IPaginator<DescribeUserGroupsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
