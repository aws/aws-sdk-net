...
namespace Amazon.ElastiCache.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonElastiCacheAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonElastiCacheAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ElastiCache.
        /// </summary>
        public AmazonElastiCacheAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonElastiCacheAuthSchemeParameters
            {
    ...
    public class AmazonElastiCacheAuthSchemeResolver : IAuthSchemeResolver<AmazonElastiCacheAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonElastiCacheAuthSchemeParameters authParameters)
        {
