...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TemplateStepSummaryUnmarshaller : IUnmarshaller<TemplateStepSummary, XmlUnmarshallerContext>, IUnmarshaller<TemplateStepSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TemplateStepSummary IUnmarshaller<TemplateStepSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TemplateStepSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StepGroupId = unmarshaller.Unmarshall(context);
                    continue;
                }
