...
{
    /// <summary>
    /// Response Unmarshaller for PluginSummary Object
    /// </summary>  
    public class PluginSummaryUnmarshaller : IJsonUnmarshaller<PluginSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PluginSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("registeredTime", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static PluginSummaryUnmarshaller _instance = new PluginSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PluginSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
