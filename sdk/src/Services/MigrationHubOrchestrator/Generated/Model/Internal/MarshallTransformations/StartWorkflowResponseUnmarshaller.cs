...
{
    /// <summary>
    /// Response Unmarshaller for StartWorkflow operation
    /// </summary>  
    public class StartWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartWorkflowResponseUnmarshaller _instance = new StartWorkflowResponseUnmarshaller();        

        internal static StartWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
