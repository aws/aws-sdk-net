...
{
    /// <summary>
    /// GetTemplateStepGroup Request Marshaller
    /// </summary>       
    public class GetTemplateStepGroupRequestMarshaller : IMarshaller<IRequest, GetTemplateStepGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTemplateStepGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTemplateStepGroupRequest publicRequest)
        {
            ...
            request.ResourcePath = "/templates/{templateId}/stepgroups/{id}";

            return request;
        }
        private static GetTemplateStepGroupRequestMarshaller _instance = new GetTemplateStepGroupRequestMarshaller();        

        internal static GetTemplateStepGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemplateStepGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
