...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkflowStep operation
    /// </summary>  
    public class UpdateWorkflowStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkflowStepResponse response = new UpdateWorkflowStepResponse();
        ...
        private static UpdateWorkflowStepResponseUnmarshaller _instance = new UpdateWorkflowStepResponseUnmarshaller();        

        internal static UpdateWorkflowStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkflowStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
