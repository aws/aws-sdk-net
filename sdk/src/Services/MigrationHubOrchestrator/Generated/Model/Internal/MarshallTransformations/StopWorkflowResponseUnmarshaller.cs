...
{
    /// <summary>
    /// Response Unmarshaller for StopWorkflow operation
    /// </summary>  
    public class StopWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopWorkflowResponse response = new StopWorkflowResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("lastStopTime", targetDepth, ref reader))
                {
        ...
        private static StopWorkflowResponseUnmarshaller _instance = new StopWorkflowResponseUnmarshaller();        

        internal static StopWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
