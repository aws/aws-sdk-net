...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkflowStep operation
    /// </summary>  
    public class CreateWorkflowStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkflowStepResponse response = new CreateWorkflowStepResponse();
        ...
        private static CreateWorkflowStepResponseUnmarshaller _instance = new CreateWorkflowStepResponseUnmarshaller();        

        internal static CreateWorkflowStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkflowStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
