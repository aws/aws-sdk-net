...
{
    /// <summary>
    /// DeleteWorkflowStep Request Marshaller
    /// </summary>       
    public class DeleteWorkflowStepRequestMarshaller : IMarshaller<IRequest, DeleteWorkflowStepRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteWorkflowStepRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteWorkflowStepRequest publicRequest)
        {
        ...
        private static DeleteWorkflowStepRequestMarshaller _instance = new DeleteWorkflowStepRequestMarshaller();        

        internal static DeleteWorkflowStepRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWorkflowStepRequestMarshaller Instance
        {
            get
            {
                return _instance;
