        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("next", targetDepth))
                {
                    ...
                    response.Next = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("noOfSrvCompleted", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.NoOfSrvCompleted = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("noOfSrvFailed", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.NoOfSrvFailed = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("outputs", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<WorkflowStepOutput, WorkflowStepOutputUnmarshaller>(WorkflowStepOutputUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.Previous = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scriptOutputLocation", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScriptOutputLocation = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StepActionType = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("stepGroupId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StepGroupId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.StepTarget = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("totalNoOfSrv", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.TotalNoOfSrv = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("workflowStepAutomationConfiguration", targetDepth))
                {
                    ...
                    response.WorkflowStepAutomationConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
