        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("adsApplicationConfigurationId", targetDepth))
                {
                    ...
                    response.AdsApplicationConfigurationId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("stepTargets", targetDepth))
                {
                    ...
                    response.StepTargets = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, StepInput, StringUnmarshaller, StepInputUnmarshaller>(StringUnmarshaller.Instance, StepInputUnmarshaller.Instance);
                    response.WorkflowInputs = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
