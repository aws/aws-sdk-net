    ...
    public class GetWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AdsApplicationName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("completedSteps", targetDepth))
                {
                    ...
                    response.CompletedSteps = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    response.TotalSteps = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("workflowBucket", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkflowBucket = unmarshaller.Unmarshall(context);
                    continue;
                }
