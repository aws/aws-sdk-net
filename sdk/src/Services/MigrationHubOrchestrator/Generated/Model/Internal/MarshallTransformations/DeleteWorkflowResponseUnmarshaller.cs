...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteWorkflowResponseUnmarshaller _instance = new DeleteWorkflowResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
