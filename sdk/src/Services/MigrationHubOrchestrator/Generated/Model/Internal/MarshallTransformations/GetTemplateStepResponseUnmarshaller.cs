    ...
    public class GetTemplateStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StepOutput, StepOutputUnmarshaller>(StepOutputUnmarshaller.Instance);
                ...
                if (context.TestExpression("stepAutomationConfiguration", targetDepth))
                {
                    ...
                    response.StepAutomationConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
