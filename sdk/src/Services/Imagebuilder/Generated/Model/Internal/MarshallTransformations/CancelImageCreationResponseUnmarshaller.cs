...
{
    /// <summary>
    /// Response Unmarshaller for CancelImageCreation operation
    /// </summary>  
    public class CancelImageCreationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelImageCreationResponse response = new CancelImageCreationResponse();
        ...
        private static CancelImageCreationResponseUnmarshaller _instance = new CancelImageCreationResponseUnmarshaller();        

        internal static CancelImageCreationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelImageCreationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
