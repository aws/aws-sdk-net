    ...
    public class ListLifecycleExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LifecycleExecution, LifecycleExecutionUnmarshaller>(LifecycleExecutionUnmarshaller.Instance);
                    response.LifecycleExecutions = unmarshaller.Unmarshall(context);
                    continue;
                }
