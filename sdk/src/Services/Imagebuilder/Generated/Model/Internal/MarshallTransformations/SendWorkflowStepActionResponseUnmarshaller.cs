...
{
    /// <summary>
    /// Response Unmarshaller for SendWorkflowStepAction operation
    /// </summary>  
    public class SendWorkflowStepActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendWorkflowStepActionResponse response = new SendWorkflowStepActionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StepExecutionId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static SendWorkflowStepActionResponseUnmarshaller _instance = new SendWorkflowStepActionResponseUnmarshaller();        

        internal static SendWorkflowStepActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendWorkflowStepActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
