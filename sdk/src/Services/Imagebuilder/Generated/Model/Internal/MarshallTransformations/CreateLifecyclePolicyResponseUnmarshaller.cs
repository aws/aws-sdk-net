...
{
    /// <summary>
    /// Response Unmarshaller for CreateLifecyclePolicy operation
    /// </summary>  
    public class CreateLifecyclePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLifecyclePolicyResponse response = new CreateLifecyclePolicyResponse();
        ...
        private static CreateLifecyclePolicyResponseUnmarshaller _instance = new CreateLifecyclePolicyResponseUnmarshaller();        

        internal static CreateLifecyclePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLifecyclePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
