...
{
    /// <summary>
    /// Response Unmarshaller for GetContainerRecipePolicy operation
    /// </summary>  
    public class GetContainerRecipePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerRecipePolicyResponse response = new GetContainerRecipePolicyResponse();
        ...
        private static GetContainerRecipePolicyResponseUnmarshaller _instance = new GetContainerRecipePolicyResponseUnmarshaller();        

        internal static GetContainerRecipePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerRecipePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
