...
{
    /// <summary>
    /// Response Unmarshaller for GetLifecycleExecution operation
    /// </summary>  
    public class GetLifecycleExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLifecycleExecutionResponse response = new GetLifecycleExecutionResponse();
            ...
            {
                if (context.TestExpression("lifecycleExecution", targetDepth, ref reader))
                {
                    var unmarshaller = LifecycleExecutionUnmarshaller.Instance;
                    response.LifecycleExecution = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetLifecycleExecutionResponseUnmarshaller _instance = new GetLifecycleExecutionResponseUnmarshaller();        

        internal static GetLifecycleExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLifecycleExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
