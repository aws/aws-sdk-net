...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDistributionConfiguration operation
    /// </summary>  
    public class DeleteDistributionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDistributionConfigurationResponse response = new DeleteDistributionConfigurationResponse();
            ...
            {
                if (context.TestExpression("distributionConfigurationArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DistributionConfigurationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteDistributionConfigurationResponseUnmarshaller _instance = new DeleteDistributionConfigurationResponseUnmarshaller();        

        internal static DeleteDistributionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDistributionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
