...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImage operation
    /// </summary>  
    public class DeleteImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ResourceDependencyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeleteImageResponseUnmarshaller _instance = new DeleteImageResponseUnmarshaller();        

        internal static DeleteImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
