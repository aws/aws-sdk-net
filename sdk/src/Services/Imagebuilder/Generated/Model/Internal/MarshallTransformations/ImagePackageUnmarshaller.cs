...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImagePackageUnmarshaller : IJsonUnmarshaller<ImagePackage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImagePackage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("packageName", targetDepth, ref reader))
                {
