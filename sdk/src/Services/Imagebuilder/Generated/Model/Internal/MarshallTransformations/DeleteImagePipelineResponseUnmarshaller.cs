...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImagePipeline operation
    /// </summary>  
    public class DeleteImagePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImagePipelineResponse response = new DeleteImagePipelineResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("imagePipelineArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImagePipelineArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteImagePipelineResponseUnmarshaller _instance = new DeleteImagePipelineResponseUnmarshaller();        

        internal static DeleteImagePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImagePipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
