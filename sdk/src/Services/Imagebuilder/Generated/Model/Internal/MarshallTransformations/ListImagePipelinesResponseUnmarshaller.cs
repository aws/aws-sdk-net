...
{
    /// <summary>
    /// Response Unmarshaller for ListImagePipelines operation
    /// </summary>  
    public class ListImagePipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImagePipelinesResponse response = new ListImagePipelinesResponse();
            ...
            {
                if (context.TestExpression("imagePipelineList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ImagePipeline, ImagePipelineUnmarshaller>(ImagePipelineUnmarshaller.Instance);
                    response.ImagePipelineList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListImagePipelinesResponseUnmarshaller _instance = new ListImagePipelinesResponseUnmarshaller();        

        internal static ListImagePipelinesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImagePipelinesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
