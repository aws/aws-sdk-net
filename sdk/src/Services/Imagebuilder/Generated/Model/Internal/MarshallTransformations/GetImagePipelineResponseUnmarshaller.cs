...
{
    /// <summary>
    /// Response Unmarshaller for GetImagePipeline operation
    /// </summary>  
    public class GetImagePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImagePipelineResponse response = new GetImagePipelineResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("imagePipeline", targetDepth, ref reader))
                {
                    var unmarshaller = ImagePipelineUnmarshaller.Instance;
                    response.ImagePipeline = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetImagePipelineResponseUnmarshaller _instance = new GetImagePipelineResponseUnmarshaller();        

        internal static GetImagePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImagePipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
