...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDistributionConfiguration operation
    /// </summary>  
    public class UpdateDistributionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDistributionConfigurationResponse response = new UpdateDistributionConfigurationResponse();
        ...
        private static UpdateDistributionConfigurationResponseUnmarshaller _instance = new UpdateDistributionConfigurationResponseUnmarshaller();        

        internal static UpdateDistributionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDistributionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
