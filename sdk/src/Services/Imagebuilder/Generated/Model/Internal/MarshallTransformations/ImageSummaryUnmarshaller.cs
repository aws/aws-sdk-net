...
{
    /// <summary>
    /// Response Unmarshaller for ImageSummary Object
    /// </summary>  
    public class ImageSummaryUnmarshaller : IJsonUnmarshaller<ImageSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImageSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ImageSummary unmarshalledObject = new ImageSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("buildType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("deprecationTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.DeprecationTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("imageSource", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("outputResources", targetDepth, ref reader))
                {
        ...
        private static ImageSummaryUnmarshaller _instance = new ImageSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ImageSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
