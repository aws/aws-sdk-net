...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageSummaryUnmarshaller : IUnmarshaller<ImageSummary, XmlUnmarshallerContext>, IUnmarshaller<ImageSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ImageSummary IUnmarshaller<ImageSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ImageSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
