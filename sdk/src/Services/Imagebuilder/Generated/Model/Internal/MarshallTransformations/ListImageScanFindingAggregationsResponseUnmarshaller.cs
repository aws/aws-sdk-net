    ...
    public class ListImageScanFindingAggregationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImageScanFindingAggregation, ImageScanFindingAggregationUnmarshaller>(ImageScanFindingAggregationUnmarshaller.Instance);
