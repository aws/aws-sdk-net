...
{
    /// <summary>
    /// Response Unmarshaller for GetImage operation
    /// </summary>  
    public class GetImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetImageResponseUnmarshaller _instance = new GetImageResponseUnmarshaller();        

        internal static GetImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
