...
{
    /// <summary>
    /// Response Unmarshaller for ListComponentBuildVersions operation
    /// </summary>  
    public class ListComponentBuildVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListComponentBuildVersionsResponse response = new ListComponentBuildVersionsResponse();
            ...
            {
                if (context.TestExpression("componentSummaryList", targetDepth, ref reader))
                {
                    ...
                    response.ComponentSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListComponentBuildVersionsResponseUnmarshaller _instance = new ListComponentBuildVersionsResponseUnmarshaller();        

        internal static ListComponentBuildVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListComponentBuildVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
