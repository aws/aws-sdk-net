...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    public class ImageRecipeUnmarshaller : IJsonUnmarshaller<ImageRecipe, JsonUnmarshallerContext>
    {
        ...
        public ImageRecipe Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("additionalInstanceConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("amiWatermarks", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AmiWatermarks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
