...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImageRecipe operation
    /// </summary>  
    public class DeleteImageRecipeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImageRecipeResponse response = new DeleteImageRecipeResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("imageRecipeArn", targetDepth, ref reader))
                {
        ...
        private static DeleteImageRecipeResponseUnmarshaller _instance = new DeleteImageRecipeResponseUnmarshaller();        

        internal static DeleteImageRecipeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImageRecipeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
