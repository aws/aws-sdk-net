...
{
    /// <summary>
    /// Response Unmarshaller for CreateImagePipeline operation
    /// </summary>  
    public class CreateImagePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateImagePipelineResponseUnmarshaller _instance = new CreateImagePipelineResponseUnmarshaller();        

        internal static CreateImagePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImagePipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
