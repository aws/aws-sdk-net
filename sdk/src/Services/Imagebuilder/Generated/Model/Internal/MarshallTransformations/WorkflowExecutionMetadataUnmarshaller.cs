...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowExecutionMetadataUnmarshaller : IUnmarshaller<WorkflowExecutionMetadata, XmlUnmarshallerContext>, IUnmarshaller<WorkflowExecutionMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        WorkflowExecutionMetadata IUnmarshaller<WorkflowExecutionMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public WorkflowExecutionMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("retried", targetDepth))
                {
                    ...
                    unmarshalledObject.Retried = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WorkflowBuildVersionArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("workflowExecutionId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WorkflowExecutionId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
