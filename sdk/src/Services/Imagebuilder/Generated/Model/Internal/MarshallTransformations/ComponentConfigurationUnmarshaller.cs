...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentConfigurationUnmarshaller : IJsonUnmarshaller<ComponentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComponentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ComponentParameter, ComponentParameterUnmarshaller>(ComponentParameterUnmarshaller.Instance);
