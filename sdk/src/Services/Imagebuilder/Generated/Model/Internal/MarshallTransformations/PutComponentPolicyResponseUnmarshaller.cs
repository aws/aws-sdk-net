...
{
    /// <summary>
    /// Response Unmarshaller for PutComponentPolicy operation
    /// </summary>  
    public class PutComponentPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutComponentPolicyResponse response = new PutComponentPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("componentArn", targetDepth))
                {
                    ...
                    response.ComponentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static PutComponentPolicyResponseUnmarshaller _instance = new PutComponentPolicyResponseUnmarshaller();        

        internal static PutComponentPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutComponentPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
