...
{
    /// <summary>
    /// Response Unmarshaller for ListLifecyclePolicies operation
    /// </summary>  
    public class ListLifecyclePoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLifecyclePoliciesResponse response = new ListLifecyclePoliciesResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("lifecyclePolicySummaryList", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<LifecyclePolicySummary, LifecyclePolicySummaryUnmarshaller>(LifecyclePolicySummaryUnmarshaller.Instance);
                    response.LifecyclePolicySummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListLifecyclePoliciesResponseUnmarshaller _instance = new ListLifecyclePoliciesResponseUnmarshaller();        

        internal static ListLifecyclePoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLifecyclePoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
