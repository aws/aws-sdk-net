...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    public class ListLifecyclePoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("lifecyclePolicySummaryList", targetDepth, ref reader))
                {
                    ...
                    response.LifecyclePolicySummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
