    ...
    public class ListWorkflowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WorkflowVersion, WorkflowVersionUnmarshaller>(WorkflowVersionUnmarshaller.Instance);
                    response.WorkflowVersionList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
