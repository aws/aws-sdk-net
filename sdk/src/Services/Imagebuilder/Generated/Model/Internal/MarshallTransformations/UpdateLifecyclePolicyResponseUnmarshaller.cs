...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLifecyclePolicy operation
    /// </summary>  
    public class UpdateLifecyclePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLifecyclePolicyResponse response = new UpdateLifecyclePolicyResponse();
            ...
            {
                if (context.TestExpression("lifecyclePolicyArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LifecyclePolicyArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateLifecyclePolicyResponseUnmarshaller _instance = new UpdateLifecyclePolicyResponseUnmarshaller();        

        internal static UpdateLifecyclePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLifecyclePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
