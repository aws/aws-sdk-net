...
{
    /// <summary>
    /// Response Unmarshaller for ListImageScanFindings operation
    /// </summary>  
    public class ListImageScanFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImageScanFindingsResponse response = new ListImageScanFindingsResponse();
        ...
        private static ListImageScanFindingsResponseUnmarshaller _instance = new ListImageScanFindingsResponseUnmarshaller();        

        internal static ListImageScanFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImageScanFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
