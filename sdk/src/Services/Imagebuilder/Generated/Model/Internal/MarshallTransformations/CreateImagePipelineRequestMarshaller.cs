...
{
    /// <summary>
    /// CreateImagePipeline Request Marshaller
    /// </summary>       
    public class CreateImagePipelineRequestMarshaller : IMarshaller<IRequest, CreateImagePipelineRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateImagePipelineRequest)input);
        }
        ...
        private static CreateImagePipelineRequestMarshaller _instance = new CreateImagePipelineRequestMarshaller();        

        internal static CreateImagePipelineRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImagePipelineRequestMarshaller Instance
        {
            get
            {
                return _instance;
