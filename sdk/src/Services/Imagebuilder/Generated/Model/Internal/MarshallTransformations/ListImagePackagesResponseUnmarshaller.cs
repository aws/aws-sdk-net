    ...
    public class ListImagePackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImagePackage, ImagePackageUnmarshaller>(ImagePackageUnmarshaller.Instance);
                    response.ImagePackageList = unmarshaller.Unmarshall(context);
                    continue;
                }
