...
{
    /// <summary>
    /// Response Unmarshaller for ListLifecycleExecutionResources operation
    /// </summary>  
    public class ListLifecycleExecutionResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLifecycleExecutionResourcesResponse response = new ListLifecycleExecutionResourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("lifecycleExecutionId", targetDepth))
                {
                    ...
                    response.LifecycleExecutionId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lifecycleExecutionState", targetDepth))
                {
                    ...
                    response.LifecycleExecutionState = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LifecycleExecutionResource, LifecycleExecutionResourceUnmarshaller>(LifecycleExecutionResourceUnmarshaller.Instance);
        ...
        private static ListLifecycleExecutionResourcesResponseUnmarshaller _instance = new ListLifecycleExecutionResourcesResponseUnmarshaller();        

        internal static ListLifecycleExecutionResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLifecycleExecutionResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
