...
namespace Amazon.Imagebuilder.Model
{
    ...
    public partial class IdempotentParameterMismatchException : AmazonImagebuilderException
    {
        ...
        public IdempotentParameterMismatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IdempotentParameterMismatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
