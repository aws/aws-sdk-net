...
namespace Amazon.Imagebuilder.Model
{
    ...
    public partial class SystemsManagerAgent
    {
        ...
        /// instance, it removes the agent before creating a snapshot for the AMI. To ensure that
        /// the AMI you create includes the SSM agent, set this property to false.
        /// </para>
        /// </summary>
