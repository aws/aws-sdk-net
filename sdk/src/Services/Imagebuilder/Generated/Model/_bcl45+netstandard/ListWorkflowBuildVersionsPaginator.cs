...
namespace Amazon.Imagebuilder.Model
{
    ...
    internal sealed partial class ListWorkflowBuildVersionsPaginator : IPaginator<ListWorkflowBuildVersionsResponse>, IListWorkflowBuildVersionsPaginator
    {
        ...
        async IAsyncEnumerable<ListWorkflowBuildVersionsResponse> IPaginator<ListWorkflowBuildVersionsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
