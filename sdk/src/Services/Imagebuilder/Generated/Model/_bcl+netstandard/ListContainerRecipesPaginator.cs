...
{
    /// <summary>
    /// Base class for ListContainerRecipes paginators.
    /// </summary>
    internal sealed partial class ListContainerRecipesPaginator : IPaginator<ListContainerRecipesResponse>, IListContainerRecipesPaginator
    {
        private readonly IAmazonImagebuilder _client;
        private readonly ListContainerRecipesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListContainerRecipesResponse> Responses => new PaginatedResponse<ListContainerRecipesResponse>(this);
...
#if BCL
        IEnumerable<ListContainerRecipesResponse> IPaginator<ListContainerRecipesResponse>.Paginate()
        {
            ...
            ListContainerRecipesResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListContainerRecipes(_request);
        ...
        async IAsyncEnumerable<ListContainerRecipesResponse> IPaginator<ListContainerRecipesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListContainerRecipesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
