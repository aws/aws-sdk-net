    ...
    public class DeactivatePipelineRequestMarshaller : IMarshaller<IRequest, DeactivatePipelineRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeactivatePipelineRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCancelActive())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.CancelActive.Value);
            }
        ...
        private static DeactivatePipelineRequestMarshaller _instance = new DeactivatePipelineRequestMarshaller();        

        internal static DeactivatePipelineRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivatePipelineRequestMarshaller Instance
        {
            get
            {
                return _instance;
