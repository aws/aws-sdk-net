...
namespace Amazon.DataPipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivatePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return PipelineDeletedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ActivatePipelineResponseUnmarshaller _instance = new ActivatePipelineResponseUnmarshaller();        

        internal static ActivatePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivatePipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
