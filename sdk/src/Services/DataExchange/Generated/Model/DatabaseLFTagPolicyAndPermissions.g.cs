...
namespace Amazon.DataExchange.Model
{
    ...
    public partial class DatabaseLFTagPolicyAndPermissions
    {
        ...
        public List<LFTag> Expression { get; set; } = AWSConfigs.InitializeCollections ? new List<LFTag>() : null;

        /// <summary>
        /// Checks to see if the Expression property is set.
        /// </summary>
        internal bool IsSetExpression() => this.Expression != null && (this.Expression.Count > 0 || !AWSConfigs.InitializeCollections);
