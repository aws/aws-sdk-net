...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssetDetailsUnmarshaller : IJsonUnmarshaller<AssetDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AssetDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AssetDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssetDetailsUnmarshaller Instance => _instance;
    }
}
