...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    public class ImportAssetsFromS3ResponseDetailsUnmarshaller : IJsonUnmarshaller<ImportAssetsFromS3ResponseDetails, JsonUnmarshallerContext>
    {
        ...
        public ImportAssetsFromS3ResponseDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AssetSources", targetDepth, ref reader))
                {
        ...
        private static ImportAssetsFromS3ResponseDetailsUnmarshaller _instance = new ImportAssetsFromS3ResponseDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ImportAssetsFromS3ResponseDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
