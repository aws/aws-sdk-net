...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobErrorUnmarshaller : IJsonUnmarshaller<JobError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DetailsUnmarshaller.Instance;
