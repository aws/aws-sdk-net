...
{
    /// <summary>
    /// Response Unmarshaller for CreateEventAction operation
    /// </summary>  
    public class CreateEventActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEventActionResponse response = new CreateEventActionResponse();
        ...
        private static CreateEventActionResponseUnmarshaller _instance = new CreateEventActionResponseUnmarshaller();        

        internal static CreateEventActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
