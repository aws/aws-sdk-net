...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAssetRequestMarshaller : IMarshaller<IRequest, GetAssetRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAssetRequestMarshaller _instance = new();

        internal static GetAssetRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAssetRequestMarshaller Instance => _instance;
    }
}
