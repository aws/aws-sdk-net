...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    public class ImportAssetFromSignedUrlRequestDetailsMarshaller : IRequestMarshaller<ImportAssetFromSignedUrlRequestDetails, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ImportAssetFromSignedUrlRequestDetails requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMd5Hash())
            {
                context.Writer.WritePropertyName("Md5Hash");
                context.Writer.WriteStringValue(requestObject.Md5Hash);
            }
