...
{
    /// <summary>
    /// GetRevision Request Marshaller
    /// </summary>
    public partial class GetRevisionRequestMarshaller : IMarshaller<IRequest, GetRevisionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRevisionRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetRevisionRequest publicRequest)
        {
        ...
        private static readonly GetRevisionRequestMarshaller _instance = new();

        internal static GetRevisionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRevisionRequestMarshaller Instance => _instance;
    }
}
