...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportAssetFromApiGatewayApiResponseDetailsUnmarshaller : IJsonUnmarshaller<ImportAssetFromApiGatewayApiResponseDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImportAssetFromApiGatewayApiResponseDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ApiSpecificationMd5Hash", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ApiSpecificationUploadUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("ApiSpecificationUploadUrlExpiresAt", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ImportAssetFromApiGatewayApiResponseDetailsUnmarshaller Instance => _instance;
    }
}
