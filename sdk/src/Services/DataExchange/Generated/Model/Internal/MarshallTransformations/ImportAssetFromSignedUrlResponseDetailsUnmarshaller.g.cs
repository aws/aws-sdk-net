...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ImportAssetFromSignedUrlResponseDetailsUnmarshaller : IJsonUnmarshaller<ImportAssetFromSignedUrlResponseDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ImportAssetFromSignedUrlResponseDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Md5Hash", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SignedUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SignedUrlExpiresAt", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ImportAssetFromSignedUrlResponseDetailsUnmarshaller Instance => _instance;
    }
}
