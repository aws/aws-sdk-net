...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteDataGrantRequestMarshaller : IMarshaller<IRequest, DeleteDataGrantRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteDataGrantRequestMarshaller _instance = new();

        internal static DeleteDataGrantRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteDataGrantRequestMarshaller Instance => _instance;
    }
}
