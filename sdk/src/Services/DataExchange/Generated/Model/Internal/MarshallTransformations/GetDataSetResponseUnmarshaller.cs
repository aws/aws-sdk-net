    ...
    public class GetDataSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("OriginDetails", targetDepth, ref reader))
                {
                    var unmarshaller = OriginDetailsUnmarshaller.Instance;
                    response.OriginDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
