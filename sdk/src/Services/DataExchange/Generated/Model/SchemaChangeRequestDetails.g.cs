...
namespace Amazon.DataExchange.Model
{
    ...
    public partial class SchemaChangeRequestDetails
    {
        ...
        /// </summary>
        public List<SchemaChangeDetails> Changes { get; set; } = AWSConfigs.InitializeCollections ? new List<SchemaChangeDetails>() : null;
        ...
        public DateTime? SchemaChangeAt { get; set; }

        /// <summary>
        /// Checks to see if the SchemaChangeAt property is set.
        /// </summary>
        internal bool IsSetSchemaChangeAt() => this.SchemaChangeAt.HasValue;
    }
}
