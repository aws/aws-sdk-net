...
namespace Amazon.DataExchange.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonDataExchangeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDataExchangeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DataExchange.
        /// </summary>
        public AmazonDataExchangeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDataExchangeAuthSchemeParameters
            {
    ...
    public class AmazonDataExchangeAuthSchemeResolver : IAuthSchemeResolver<AmazonDataExchangeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDataExchangeAuthSchemeParameters authParameters)
        {
