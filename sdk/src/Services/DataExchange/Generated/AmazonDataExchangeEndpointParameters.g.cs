...
namespace Amazon.DataExchange.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving DataExchange endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonDataExchangeEndpointProvider"/> and <see cref="AmazonDataExchangeEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class DataExchangeEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// DataExchangeEndpointParameters constructor
        /// </summary>
        public DataExchangeEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
