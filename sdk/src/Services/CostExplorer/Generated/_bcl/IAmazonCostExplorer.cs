...
namespace Amazon.CostExplorer
{
    ...
    public partial interface IAmazonCostExplorer : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetCostAndUsageComparisons">REST API Reference for GetCostAndUsageComparisons Operation</seealso>
        Task<GetCostAndUsageComparisonsResponse> GetCostAndUsageComparisonsAsync(GetCostAndUsageComparisonsRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetCostComparisonDrivers">REST API Reference for GetCostComparisonDrivers Operation</seealso>
        Task<GetCostComparisonDriversResponse> GetCostComparisonDriversAsync(GetCostComparisonDriversRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/ListCostCategoryResourceAssociations">REST API Reference for ListCostCategoryResourceAssociations Operation</seealso>
        Task<ListCostCategoryResourceAssociationsResponse> ListCostCategoryResourceAssociationsAsync(ListCostCategoryResourceAssociationsRequest request, CancellationToken cancellationToken = default(CancellationToken));
