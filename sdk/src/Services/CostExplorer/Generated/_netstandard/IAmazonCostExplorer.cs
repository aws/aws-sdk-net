...
namespace Amazon.CostExplorer
{
    ...
    public partial interface IAmazonCostExplorer : IAmazonService, IDisposable
    {
        ...
        Task<ListCostCategoryResourceAssociationsResponse> ListCostCategoryResourceAssociationsAsync(ListCostCategoryResourceAssociationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
