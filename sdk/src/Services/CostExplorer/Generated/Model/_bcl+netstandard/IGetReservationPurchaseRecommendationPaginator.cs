...
namespace Amazon.CostExplorer.Model
{
    ...
    public interface IGetReservationPurchaseRecommendationPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<GetReservationPurchaseRecommendationResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the Recommendations
        /// </summary>
        IPaginatedEnumerable<ReservationPurchaseRecommendation> Recommendations { get; }
    }
}