...
namespace Amazon.CostExplorer.Model
{
    ...
    internal sealed partial class ListCostAllocationTagBackfillHistoryPaginator : IPaginator<ListCostAllocationTagBackfillHistoryResponse>, IListCostAllocationTagBackfillHistoryPaginator
    {
        ...
        async IAsyncEnumerable<ListCostAllocationTagBackfillHistoryResponse> IPaginator<ListCostAllocationTagBackfillHistoryResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
