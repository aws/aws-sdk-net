...
{
    /// <summary>
    /// Response Unmarshaller for GetSavingsPlansCoverage operation
    /// </summary>  
    public class GetSavingsPlansCoverageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSavingsPlansCoverageResponse response = new GetSavingsPlansCoverageResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SavingsPlansCoverages", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SavingsPlansCoverage, SavingsPlansCoverageUnmarshaller>(SavingsPlansCoverageUnmarshaller.Instance);
                    response.SavingsPlansCoverages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSavingsPlansCoverageResponseUnmarshaller _instance = new GetSavingsPlansCoverageResponseUnmarshaller();        

        internal static GetSavingsPlansCoverageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSavingsPlansCoverageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
