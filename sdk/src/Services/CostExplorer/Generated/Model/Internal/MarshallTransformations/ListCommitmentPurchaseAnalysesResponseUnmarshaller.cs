...
{
    /// <summary>
    /// Response Unmarshaller for ListCommitmentPurchaseAnalyses operation
    /// </summary>  
    public class ListCommitmentPurchaseAnalysesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCommitmentPurchaseAnalysesResponse response = new ListCommitmentPurchaseAnalysesResponse();
        ...
        private static ListCommitmentPurchaseAnalysesResponseUnmarshaller _instance = new ListCommitmentPurchaseAnalysesResponseUnmarshaller();        

        internal static ListCommitmentPurchaseAnalysesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCommitmentPurchaseAnalysesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
