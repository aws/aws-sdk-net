...
{
    /// <summary>
    /// Response Unmarshaller for GetSavingsPlansPurchaseRecommendation operation
    /// </summary>  
    public class GetSavingsPlansPurchaseRecommendationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSavingsPlansPurchaseRecommendationResponse response = new GetSavingsPlansPurchaseRecommendationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SavingsPlansPurchaseRecommendationMetadataUnmarshaller.Instance;
                ...
                if (context.TestExpression("SavingsPlansPurchaseRecommendation", targetDepth, ref reader))
                {
                    var unmarshaller = SavingsPlansPurchaseRecommendationUnmarshaller.Instance;
                    response.SavingsPlansPurchaseRecommendation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSavingsPlansPurchaseRecommendationResponseUnmarshaller _instance = new GetSavingsPlansPurchaseRecommendationResponseUnmarshaller();        

        internal static GetSavingsPlansPurchaseRecommendationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSavingsPlansPurchaseRecommendationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
