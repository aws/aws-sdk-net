...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CostCategoryReferenceUnmarshaller : IUnmarshaller<CostCategoryReference, XmlUnmarshallerContext>, IUnmarshaller<CostCategoryReference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CostCategoryReference IUnmarshaller<CostCategoryReference, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CostCategoryReference Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SupportedResourceTypes", targetDepth))
                {
                    ...
                    unmarshalledObject.SupportedResourceTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
