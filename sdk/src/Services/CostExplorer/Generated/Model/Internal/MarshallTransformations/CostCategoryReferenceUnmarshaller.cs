...
{
    /// <summary>
    /// Response Unmarshaller for CostCategoryReference Object
    /// </summary>  
    public class CostCategoryReferenceUnmarshaller : IJsonUnmarshaller<CostCategoryReference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CostCategoryReference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumberOfRules", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.NumberOfRules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SupportedResourceTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SupportedResourceTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CostCategoryReferenceUnmarshaller _instance = new CostCategoryReferenceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CostCategoryReferenceUnmarshaller Instance
        {
            get
            {
                return _instance;
