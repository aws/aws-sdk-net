...
{
    /// <summary>
    /// Response Unmarshaller for GetReservationPurchaseRecommendation operation
    /// </summary>  
    public class GetReservationPurchaseRecommendationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetReservationPurchaseRecommendationResponse response = new GetReservationPurchaseRecommendationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ReservationPurchaseRecommendation, ReservationPurchaseRecommendationUnmarshaller>(ReservationPurchaseRecommendationUnmarshaller.Instance);
        ...
        private static GetReservationPurchaseRecommendationResponseUnmarshaller _instance = new GetReservationPurchaseRecommendationResponseUnmarshaller();        

        internal static GetReservationPurchaseRecommendationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReservationPurchaseRecommendationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
