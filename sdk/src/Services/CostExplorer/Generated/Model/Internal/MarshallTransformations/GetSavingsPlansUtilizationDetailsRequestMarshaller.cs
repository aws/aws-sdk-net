...
{
    /// <summary>
    /// GetSavingsPlansUtilizationDetails Request Marshaller
    /// </summary>       
    public class GetSavingsPlansUtilizationDetailsRequestMarshaller : IMarshaller<IRequest, GetSavingsPlansUtilizationDetailsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSavingsPlansUtilizationDetailsRequest)input);
        }
        ...
        public IRequest Marshall(GetSavingsPlansUtilizationDetailsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetDataType())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestDataTypeListValue);
                }
        ...
        private static GetSavingsPlansUtilizationDetailsRequestMarshaller _instance = new GetSavingsPlansUtilizationDetailsRequestMarshaller();        

        internal static GetSavingsPlansUtilizationDetailsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSavingsPlansUtilizationDetailsRequestMarshaller Instance
        {
            get
            {
                return _instance;
