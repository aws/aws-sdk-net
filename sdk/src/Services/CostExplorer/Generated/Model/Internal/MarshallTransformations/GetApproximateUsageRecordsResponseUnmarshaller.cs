...
{
    /// <summary>
    /// Response Unmarshaller for GetApproximateUsageRecords operation
    /// </summary>  
    public class GetApproximateUsageRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApproximateUsageRecordsResponse response = new GetApproximateUsageRecordsResponse();
            ...
            {
                if (context.TestExpression("LookbackPeriod", targetDepth, ref reader))
                {
                    var unmarshaller = DateIntervalUnmarshaller.Instance;
                    response.LookbackPeriod = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetApproximateUsageRecordsResponseUnmarshaller _instance = new GetApproximateUsageRecordsResponseUnmarshaller();        

        internal static GetApproximateUsageRecordsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApproximateUsageRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
