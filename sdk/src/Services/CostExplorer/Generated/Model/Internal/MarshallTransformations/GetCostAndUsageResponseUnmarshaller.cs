...
{
    /// <summary>
    /// Response Unmarshaller for GetCostAndUsage operation
    /// </summary>  
    public class GetCostAndUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetCostAndUsageResponseUnmarshaller _instance = new GetCostAndUsageResponseUnmarshaller();        

        internal static GetCostAndUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCostAndUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
