...
{
    /// <summary>
    /// Response Unmarshaller for GetRightsizingRecommendation operation
    /// </summary>  
    public class GetRightsizingRecommendationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRightsizingRecommendationResponse response = new GetRightsizingRecommendationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RightsizingRecommendation, RightsizingRecommendationUnmarshaller>(RightsizingRecommendationUnmarshaller.Instance);
                    response.RightsizingRecommendations = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetRightsizingRecommendationResponseUnmarshaller _instance = new GetRightsizingRecommendationResponseUnmarshaller();        

        internal static GetRightsizingRecommendationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRightsizingRecommendationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
