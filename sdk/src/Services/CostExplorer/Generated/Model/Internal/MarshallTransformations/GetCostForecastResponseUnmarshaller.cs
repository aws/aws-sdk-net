...
{
    /// <summary>
    /// Response Unmarshaller for GetCostForecast operation
    /// </summary>  
    public class GetCostForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetCostForecastResponseUnmarshaller _instance = new GetCostForecastResponseUnmarshaller();        

        internal static GetCostForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCostForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
