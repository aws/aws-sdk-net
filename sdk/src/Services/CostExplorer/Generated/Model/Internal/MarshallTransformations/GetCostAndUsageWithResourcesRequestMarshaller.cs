...
{
    /// <summary>
    /// GetCostAndUsageWithResources Request Marshaller
    /// </summary>       
    public class GetCostAndUsageWithResourcesRequestMarshaller : IMarshaller<IRequest, GetCostAndUsageWithResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCostAndUsageWithResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCostAndUsageWithResourcesRequest publicRequest)
        {
        ...
        private static GetCostAndUsageWithResourcesRequestMarshaller _instance = new GetCostAndUsageWithResourcesRequestMarshaller();        

        internal static GetCostAndUsageWithResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCostAndUsageWithResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
