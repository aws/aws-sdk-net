...
{
    /// <summary>
    /// Response Unmarshaller for GetUsageForecast operation
    /// </summary>  
    public class GetUsageForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUsageForecastResponse response = new GetUsageForecastResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new UnresolvableUsageUnitException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static GetUsageForecastResponseUnmarshaller _instance = new GetUsageForecastResponseUnmarshaller();        

        internal static GetUsageForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUsageForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
