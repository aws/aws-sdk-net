...
{
    /// <summary>
    /// GetRightsizingRecommendation Request Marshaller
    /// </summary>       
    public class GetRightsizingRecommendationRequestMarshaller : IMarshaller<IRequest, GetRightsizingRecommendationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRightsizingRecommendationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRightsizingRecommendationRequest publicRequest)
        {
        ...
        private static GetRightsizingRecommendationRequestMarshaller _instance = new GetRightsizingRecommendationRequestMarshaller();        

        internal static GetRightsizingRecommendationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRightsizingRecommendationRequestMarshaller Instance
        {
            get
            {
                return _instance;
