    ...
    public class GetCostComparisonDriversResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CostComparisonDriver, CostComparisonDriverUnmarshaller>(CostComparisonDriverUnmarshaller.Instance);
                    response.CostComparisonDrivers = unmarshaller.Unmarshall(context);
                    continue;
                }
