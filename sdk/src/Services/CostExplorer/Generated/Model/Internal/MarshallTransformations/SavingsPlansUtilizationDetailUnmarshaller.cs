...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    public class SavingsPlansUtilizationDetailUnmarshaller : IJsonUnmarshaller<SavingsPlansUtilizationDetail, JsonUnmarshallerContext>
    {
        ...
        private static SavingsPlansUtilizationDetailUnmarshaller _instance = new SavingsPlansUtilizationDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SavingsPlansUtilizationDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
