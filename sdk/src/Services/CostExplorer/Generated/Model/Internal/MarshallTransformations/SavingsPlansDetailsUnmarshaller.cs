...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SavingsPlansDetailsUnmarshaller : IJsonUnmarshaller<SavingsPlansDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SavingsPlansDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("InstanceFamily", targetDepth, ref reader))
                {
