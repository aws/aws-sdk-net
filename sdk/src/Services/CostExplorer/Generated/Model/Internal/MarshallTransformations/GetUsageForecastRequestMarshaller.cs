...
{
    /// <summary>
    /// GetUsageForecast Request Marshaller
    /// </summary>       
    public class GetUsageForecastRequestMarshaller : IMarshaller<IRequest, GetUsageForecastRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetUsageForecastRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetUsageForecastRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CostExplorer");
            string target = "AWSInsightsIndexService.GetUsageForecast";
            ...
            if(publicRequest.IsSetPredictionIntervalLevel())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.PredictionIntervalLevel.Value);
            }
        ...
        private static GetUsageForecastRequestMarshaller _instance = new GetUsageForecastRequestMarshaller();        

        internal static GetUsageForecastRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUsageForecastRequestMarshaller Instance
        {
            get
            {
                return _instance;
