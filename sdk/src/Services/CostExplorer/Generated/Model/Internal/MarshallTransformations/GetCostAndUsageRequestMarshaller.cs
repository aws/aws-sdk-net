...
{
    /// <summary>
    /// GetCostAndUsage Request Marshaller
    /// </summary>       
    public class GetCostAndUsageRequestMarshaller : IMarshaller<IRequest, GetCostAndUsageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCostAndUsageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCostAndUsageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CostExplorer");
            string target = "AWSInsightsIndexService.GetCostAndUsage";
