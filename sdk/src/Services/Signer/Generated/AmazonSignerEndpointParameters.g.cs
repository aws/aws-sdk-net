...
namespace Amazon.Signer.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving Signer endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonSignerEndpointProvider"/> and <see cref="AmazonSignerEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class SignerEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// SignerEndpointParameters constructor
        /// </summary>
        public SignerEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
