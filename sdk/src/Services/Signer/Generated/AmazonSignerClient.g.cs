...
namespace Amazon.Signer
{
    ...
    public partial class AmazonSignerClient : AmazonServiceClient, IAmazonSigner
    {
        ...
        /// 
        /// </summary>
        public AmazonSignerClient() : base(new AmazonSignerConfig()) { }
        ...
        public AmazonSignerClient(RegionEndpoint region) : base(new AmazonSignerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSignerClient(AmazonSignerConfig config) : base(config) { }
