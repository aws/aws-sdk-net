...
namespace Amazon.Signer
{
    ...
    public partial class AmazonSignerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("signer", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "signer";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "signer";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2017-08-25";
