...
namespace Amazon.Signer.Model
{
    ...
    public partial class ListProfilePermissionsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Permission> Permissions { get; set; } = AWSConfigs.InitializeCollections ? new List<Permission>() : null;
        ...
        /// </para>
        /// </summary>
        public int? PolicySizeBytes { get; set; }

        /// <summary>
        /// Checks to see if the PolicySizeBytes property is set.
        /// </summary>
        internal bool IsSetPolicySizeBytes() => this.PolicySizeBytes.HasValue;
