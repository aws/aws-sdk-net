...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RevokeSignatureRequestMarshaller : IMarshaller<IRequest, RevokeSignatureRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(RevokeSignatureRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetJobOwner())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.JobOwner);
            }
        ...
        private static readonly RevokeSignatureRequestMarshaller _instance = new();

        internal static RevokeSignatureRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RevokeSignatureRequestMarshaller Instance => _instance;
    }
}
