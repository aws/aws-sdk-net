...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListProfilePermissionsRequestMarshaller : IMarshaller<IRequest, ListProfilePermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListProfilePermissionsRequest)input);
        }
        ...
        private static ListProfilePermissionsRequestMarshaller _instance = new ListProfilePermissionsRequestMarshaller();        

        internal static ListProfilePermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProfilePermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
