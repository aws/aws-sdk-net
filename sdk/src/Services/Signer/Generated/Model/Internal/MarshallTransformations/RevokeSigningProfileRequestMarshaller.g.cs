...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RevokeSigningProfileRequestMarshaller : IMarshaller<IRequest, RevokeSigningProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RevokeSigningProfileRequestMarshaller _instance = new();

        internal static RevokeSigningProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RevokeSigningProfileRequestMarshaller Instance => _instance;
    }
}
