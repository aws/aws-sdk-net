...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartSigningJobRequestMarshaller : IMarshaller<IRequest, StartSigningJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartSigningJobRequestMarshaller _instance = new();

        internal static StartSigningJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartSigningJobRequestMarshaller Instance => _instance;
    }
}
