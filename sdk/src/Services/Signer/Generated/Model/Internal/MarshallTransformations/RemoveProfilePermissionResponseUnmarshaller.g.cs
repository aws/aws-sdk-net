...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RemoveProfilePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RemoveProfilePermissionResponse();
        ...
        private static RemoveProfilePermissionResponseUnmarshaller _instance = new RemoveProfilePermissionResponseUnmarshaller();

        internal static RemoveProfilePermissionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RemoveProfilePermissionResponseUnmarshaller Instance => _instance;
    }
}
