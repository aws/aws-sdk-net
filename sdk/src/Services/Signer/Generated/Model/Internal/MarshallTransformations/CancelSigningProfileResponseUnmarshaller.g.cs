...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CancelSigningProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CancelSigningProfileResponse();
        ...
        internal static CancelSigningProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelSigningProfileResponseUnmarshaller Instance => _instance;
    }
}
