...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelSigningProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelSigningProfileResponse response = new CancelSigningProfileResponse();
        ...
        private static CancelSigningProfileResponseUnmarshaller _instance = new CancelSigningProfileResponseUnmarshaller();        

        internal static CancelSigningProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelSigningProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
