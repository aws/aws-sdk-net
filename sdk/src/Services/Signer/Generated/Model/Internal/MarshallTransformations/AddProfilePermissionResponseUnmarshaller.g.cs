...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddProfilePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AddProfilePermissionResponse();
        ...
        internal static AddProfilePermissionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddProfilePermissionResponseUnmarshaller Instance => _instance;
    }
}
