...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutSigningProfileRequestMarshaller : IMarshaller<IRequest, PutSigningProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutSigningProfileRequestMarshaller _instance = new();

        internal static PutSigningProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutSigningProfileRequestMarshaller Instance => _instance;
    }
}
