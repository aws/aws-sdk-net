...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SigningConfigurationUnmarshaller : IJsonUnmarshaller<SigningConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SigningConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SigningConfigurationUnmarshaller Instance => _instance;
    }
}
