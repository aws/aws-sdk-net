...
{
    /// <summary>
    /// Response Unmarshaller for GetRevocationStatus operation.
    /// </summary>
    public partial class GetRevocationStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetRevocationStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("revokedEntities", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.RevokedEntities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRevocationStatusResponseUnmarshaller _instance = new GetRevocationStatusResponseUnmarshaller();

        internal static GetRevocationStatusResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRevocationStatusResponseUnmarshaller Instance => _instance;
    }
}
