...
{
    /// <summary>
    /// Response Unmarshaller for SignPayload operation
    /// </summary>  
    public class SignPayloadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SignPayloadResponseUnmarshaller _instance = new SignPayloadResponseUnmarshaller();        

        internal static SignPayloadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SignPayloadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
