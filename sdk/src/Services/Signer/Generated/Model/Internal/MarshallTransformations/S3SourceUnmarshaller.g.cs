...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class S3SourceUnmarshaller : IJsonUnmarshaller<S3Source, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new S3Source();
        ...
        /// Gets the singleton.
        /// </summary>
        public static S3SourceUnmarshaller Instance => _instance;
    }
}
