        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("maxSizeInMB", targetDepth))
                {
                    ...
                    response.MaxSizeInMB = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("revocationSupported", targetDepth))
                {
                    ...
                    response.RevocationSupported = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("signingImageFormat", targetDepth))
                {
                    ...
                    response.SigningImageFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
