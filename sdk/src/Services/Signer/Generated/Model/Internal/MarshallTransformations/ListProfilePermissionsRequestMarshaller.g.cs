...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListProfilePermissionsRequestMarshaller : IMarshaller<IRequest, ListProfilePermissionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListProfilePermissionsRequestMarshaller _instance = new();

        internal static ListProfilePermissionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListProfilePermissionsRequestMarshaller Instance => _instance;
    }
}
