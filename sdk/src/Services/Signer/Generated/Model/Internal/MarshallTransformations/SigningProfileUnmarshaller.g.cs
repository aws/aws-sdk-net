...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SigningProfileUnmarshaller : IJsonUnmarshaller<SigningProfile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SigningProfile();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SigningProfileUnmarshaller Instance => _instance;
    }
}
