...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SigningJobUnmarshaller : IJsonUnmarshaller<SigningJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SigningJob();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SigningJobUnmarshaller Instance => _instance;
    }
}
