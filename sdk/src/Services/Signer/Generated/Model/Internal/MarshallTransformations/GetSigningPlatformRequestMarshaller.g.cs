...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSigningPlatformRequestMarshaller : IMarshaller<IRequest, GetSigningPlatformRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSigningPlatformRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetSigningPlatformRequest publicRequest)
        {
        ...
        private static readonly GetSigningPlatformRequestMarshaller _instance = new();

        internal static GetSigningPlatformRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSigningPlatformRequestMarshaller Instance => _instance;
    }
}
