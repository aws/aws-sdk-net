...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListProfilePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListProfilePermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("policySizeBytes", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.PolicySizeBytes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListProfilePermissionsResponseUnmarshaller _instance = new ListProfilePermissionsResponseUnmarshaller();

        internal static ListProfilePermissionsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListProfilePermissionsResponseUnmarshaller Instance => _instance;
    }
}
