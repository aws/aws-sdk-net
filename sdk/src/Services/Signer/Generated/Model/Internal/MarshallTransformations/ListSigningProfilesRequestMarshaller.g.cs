...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSigningProfilesRequestMarshaller : IMarshaller<IRequest, ListSigningProfilesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListSigningProfilesRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("includeCanceled", StringUtils.FromBool(publicRequest.IncludeCanceled.Value));
            }
        ...
        private static readonly ListSigningProfilesRequestMarshaller _instance = new();

        internal static ListSigningProfilesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSigningProfilesRequestMarshaller Instance => _instance;
    }
}
