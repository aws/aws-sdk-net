...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SigningConfigurationOverridesUnmarshaller : IJsonUnmarshaller<SigningConfigurationOverrides, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SigningConfigurationOverrides();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SigningConfigurationOverridesUnmarshaller Instance => _instance;
    }
}
