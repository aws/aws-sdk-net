...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SigningPlatformOverridesUnmarshaller : IJsonUnmarshaller<SigningPlatformOverrides, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SigningPlatformOverrides();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SigningPlatformOverridesUnmarshaller Instance => _instance;
    }
}
