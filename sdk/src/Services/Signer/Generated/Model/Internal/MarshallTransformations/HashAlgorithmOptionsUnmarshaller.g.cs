...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HashAlgorithmOptionsUnmarshaller : IJsonUnmarshaller<HashAlgorithmOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new HashAlgorithmOptions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static HashAlgorithmOptionsUnmarshaller Instance => _instance;
    }
}
