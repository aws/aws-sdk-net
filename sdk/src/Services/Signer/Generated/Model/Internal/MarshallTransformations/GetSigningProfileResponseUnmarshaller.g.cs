...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSigningProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSigningProfileResponse();
        ...
        internal static GetSigningProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSigningProfileResponseUnmarshaller Instance => _instance;
    }
}
