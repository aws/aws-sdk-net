...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EncryptionAlgorithmOptionsUnmarshaller : IJsonUnmarshaller<EncryptionAlgorithmOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public EncryptionAlgorithmOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new EncryptionAlgorithmOptions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EncryptionAlgorithmOptionsUnmarshaller Instance => _instance;
    }
}
