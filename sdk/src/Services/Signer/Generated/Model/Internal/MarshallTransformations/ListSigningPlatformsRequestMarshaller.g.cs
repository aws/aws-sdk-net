...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSigningPlatformsRequestMarshaller : IMarshaller<IRequest, ListSigningPlatformsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListSigningPlatformsRequestMarshaller _instance = new();

        internal static ListSigningPlatformsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSigningPlatformsRequestMarshaller Instance => _instance;
    }
}
