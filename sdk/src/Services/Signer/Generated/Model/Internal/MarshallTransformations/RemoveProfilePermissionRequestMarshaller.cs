...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveProfilePermissionRequestMarshaller : IMarshaller<IRequest, RemoveProfilePermissionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static RemoveProfilePermissionRequestMarshaller _instance = new RemoveProfilePermissionRequestMarshaller();        

        internal static RemoveProfilePermissionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveProfilePermissionRequestMarshaller Instance
        {
            get
            {
                return _instance;
