...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SignPayloadRequestMarshaller : IMarshaller<IRequest, SignPayloadRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SignPayloadRequestMarshaller _instance = new();

        internal static SignPayloadRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SignPayloadRequestMarshaller Instance => _instance;
    }
}
