...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddProfilePermissionRequestMarshaller : IMarshaller<IRequest, AddProfilePermissionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AddProfilePermissionRequestMarshaller _instance = new();

        internal static AddProfilePermissionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddProfilePermissionRequestMarshaller Instance => _instance;
    }
}
