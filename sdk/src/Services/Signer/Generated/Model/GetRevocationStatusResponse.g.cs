...
namespace Amazon.Signer.Model
{
    ...
    public partial class GetRevocationStatusResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<string> RevokedEntities { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the RevokedEntities property is set.
        /// </summary>
        internal bool IsSetRevokedEntities() => this.RevokedEntities != null && (this.RevokedEntities.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
