...
namespace Amazon.Signer.Model
{
    ...
    public partial class SigningImageFormat
    {
        ...
        /// </summary>
        internal bool IsSetDefaultFormat() => this.DefaultFormat != null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<string> SupportedFormats { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SupportedFormats property is set.
        /// </summary>
        internal bool IsSetSupportedFormats() => this.SupportedFormats != null && (this.SupportedFormats.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
