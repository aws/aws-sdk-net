...
{
    /// <summary>
    /// Container for the parameters to the DescribeSigningJob operation. Returns information
    /// about a specific code signing job. You specify the job by using the <c>jobId</c> value
