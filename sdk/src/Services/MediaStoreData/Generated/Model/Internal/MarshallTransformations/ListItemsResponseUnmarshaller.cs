...
namespace Amazon.MediaStoreData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListItemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return ContainerNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ListItemsResponseUnmarshaller _instance = new ListItemsResponseUnmarshaller();        

        internal static ListItemsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListItemsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
