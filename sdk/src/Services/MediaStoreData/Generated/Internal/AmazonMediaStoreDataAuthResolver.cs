...
namespace Amazon.MediaStoreData.Internal
{
    ...
    public class AmazonMediaStoreDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMediaStoreDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MediaStoreData.
        /// </summary>
        public AmazonMediaStoreDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMediaStoreDataAuthSchemeParameters
            {
    ...
    public class AmazonMediaStoreDataAuthSchemeResolver : IAuthSchemeResolver<AmazonMediaStoreDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMediaStoreDataAuthSchemeParameters authParameters)
        {
