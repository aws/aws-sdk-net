...
namespace Amazon.WAFV2
{
    ...
    public partial class AmazonWAFV2Client : AmazonServiceClient, IAmazonWAFV2
    {
        ...
        internal virtual GetRevenueStatisticsResponse GetRevenueStatistics(GetRevenueStatisticsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetRevenueStatisticsSummaryResponse GetRevenueStatisticsSummary(GetRevenueStatisticsSummaryRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetRevenueStatisticsTimeSeriesResponse GetRevenueStatisticsTimeSeries(GetRevenueStatisticsTimeSeriesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetTopPathStatisticsByTrafficResponse GetTopPathStatisticsByTraffic(GetTopPathStatisticsByTrafficRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListSettlementRecordsResponse ListSettlementRecords(ListSettlementRecordsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
