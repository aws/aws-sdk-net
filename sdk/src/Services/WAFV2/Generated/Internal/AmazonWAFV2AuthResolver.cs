...
namespace Amazon.WAFV2.Internal
{
    ...
    public class AmazonWAFV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWAFV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WAFV2.
        /// </summary>
        public AmazonWAFV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWAFV2AuthSchemeParameters
            {
    ...
    public class AmazonWAFV2AuthSchemeResolver : IAuthSchemeResolver<AmazonWAFV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWAFV2AuthSchemeParameters authParameters)
        {
