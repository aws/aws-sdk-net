...
namespace Amazon.WAFV2
{
    ...
    public partial class AmazonWAFV2Client : AmazonServiceClient, IAmazonWAFV2
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/GetTopPathStatisticsByTraffic">REST API Reference for GetTopPathStatisticsByTraffic Operation</seealso>
        public virtual IAsyncResult BeginGetTopPathStatisticsByTraffic(GetTopPathStatisticsByTrafficRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetTopPathStatisticsByTrafficRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetTopPathStatisticsByTrafficResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/GetTopPathStatisticsByTraffic">REST API Reference for GetTopPathStatisticsByTraffic Operation</seealso>
        public virtual GetTopPathStatisticsByTrafficResponse EndGetTopPathStatisticsByTraffic(IAsyncResult asyncResult)
        {
            return EndInvoke<GetTopPathStatisticsByTrafficResponse>(asyncResult);
        }
