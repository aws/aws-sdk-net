...
{
    /// <summary>
    /// This is the response object from the GetRevenueStatisticsTimeSeries operation.
    /// </summary>
    public partial class GetRevenueStatisticsTimeSeriesResponse : AmazonWebServiceResponse
    {
        private List<DataPointEntry> _dataPoints = AWSConfigs.InitializeCollections ? new List<DataPointEntry>() : null;
        ...
        /// </summary>
        public List<DataPointEntry> DataPoints
        {
