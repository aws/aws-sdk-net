...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFirewallManagerRuleGroups operation
    /// </summary>  
    public class DeleteFirewallManagerRuleGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFirewallManagerRuleGroupsResponse response = new DeleteFirewallManagerRuleGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("NextWebACLLockToken", targetDepth))
                {
                    ...
                    response.NextWebACLLockToken = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DeleteFirewallManagerRuleGroupsResponseUnmarshaller _instance = new DeleteFirewallManagerRuleGroupsResponseUnmarshaller();        

        internal static DeleteFirewallManagerRuleGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFirewallManagerRuleGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
