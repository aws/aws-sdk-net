...
{
    /// <summary>
    /// Response Unmarshaller for ListAvailableManagedRuleGroupVersions operation
    /// </summary>  
    public class ListAvailableManagedRuleGroupVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAvailableManagedRuleGroupVersionsResponse response = new ListAvailableManagedRuleGroupVersionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CurrentDefaultVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CurrentDefaultVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ManagedRuleGroupVersion, ManagedRuleGroupVersionUnmarshaller>(ManagedRuleGroupVersionUnmarshaller.Instance);
        ...
        private static ListAvailableManagedRuleGroupVersionsResponseUnmarshaller _instance = new ListAvailableManagedRuleGroupVersionsResponseUnmarshaller();        

        internal static ListAvailableManagedRuleGroupVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAvailableManagedRuleGroupVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
