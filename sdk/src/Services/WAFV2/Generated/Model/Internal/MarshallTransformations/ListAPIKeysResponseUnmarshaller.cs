    ...
    public class ListAPIKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<APIKeySummary, APIKeySummaryUnmarshaller>(APIKeySummaryUnmarshaller.Instance);
                    response.APIKeySummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
