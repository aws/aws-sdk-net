...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAllManagedProducts operation
    /// </summary>  
    public class DescribeAllManagedProductsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAllManagedProductsResponse response = new DescribeAllManagedProductsResponse();
            ...
            {
                if (context.TestExpression("ManagedProducts", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ManagedProductDescriptor, ManagedProductDescriptorUnmarshaller>(ManagedProductDescriptorUnmarshaller.Instance);
                    response.ManagedProducts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeAllManagedProductsResponseUnmarshaller _instance = new DescribeAllManagedProductsResponseUnmarshaller();        

        internal static DescribeAllManagedProductsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAllManagedProductsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
