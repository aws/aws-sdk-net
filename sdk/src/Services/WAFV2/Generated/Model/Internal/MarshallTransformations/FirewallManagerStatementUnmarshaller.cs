...
{
    /// <summary>
    /// Response Unmarshaller for FirewallManagerStatement Object
    /// </summary>  
    public class FirewallManagerStatementUnmarshaller : IUnmarshaller<FirewallManagerStatement, XmlUnmarshallerContext>, IUnmarshaller<FirewallManagerStatement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FirewallManagerStatement IUnmarshaller<FirewallManagerStatement, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static FirewallManagerStatementUnmarshaller _instance = new FirewallManagerStatementUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FirewallManagerStatementUnmarshaller Instance
        {
            get
            {
                return _instance;
