...
{
    /// <summary>
    /// Response Unmarshaller for GetRevenueStatisticsSummary operation
    /// </summary>  
    public class GetRevenueStatisticsSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRevenueStatisticsSummaryResponse response = new GetRevenueStatisticsSummaryResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("RevenueBreakdown", targetDepth, ref reader))
                {
                    var unmarshaller = RevenueBreakdownUnmarshaller.Instance;
                    response.RevenueBreakdown = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRevenueStatisticsSummaryResponseUnmarshaller _instance = new GetRevenueStatisticsSummaryResponseUnmarshaller();        

        internal static GetRevenueStatisticsSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueStatisticsSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
