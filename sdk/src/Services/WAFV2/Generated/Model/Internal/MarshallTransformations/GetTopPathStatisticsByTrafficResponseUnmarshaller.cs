...
{
    /// <summary>
    /// Response Unmarshaller for GetTopPathStatisticsByTraffic operation
    /// </summary>  
    public class GetTopPathStatisticsByTrafficResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTopPathStatisticsByTrafficResponse response = new GetTopPathStatisticsByTrafficResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PathStatistics, PathStatisticsUnmarshaller>(PathStatisticsUnmarshaller.Instance);
                    response.PathStatistics = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TopCategories", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<PathStatistics, PathStatisticsUnmarshaller>(PathStatisticsUnmarshaller.Instance);
                    response.TopCategories = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TotalRequestCount", targetDepth))
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    response.TotalRequestCount = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return WAFFeatureNotIncludedInPricingPlanExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static GetTopPathStatisticsByTrafficResponseUnmarshaller _instance = new GetTopPathStatisticsByTrafficResponseUnmarshaller();        

        internal static GetTopPathStatisticsByTrafficResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTopPathStatisticsByTrafficResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
