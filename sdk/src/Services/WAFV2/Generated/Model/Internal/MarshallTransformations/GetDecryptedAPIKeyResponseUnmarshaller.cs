...
{
    /// <summary>
    /// Response Unmarshaller for GetDecryptedAPIKey operation
    /// </summary>  
    public class GetDecryptedAPIKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDecryptedAPIKeyResponse response = new GetDecryptedAPIKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TokenDomains", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.TokenDomains = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDecryptedAPIKeyResponseUnmarshaller _instance = new GetDecryptedAPIKeyResponseUnmarshaller();        

        internal static GetDecryptedAPIKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDecryptedAPIKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
