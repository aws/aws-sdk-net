...
{
    /// <summary>
    /// Response Unmarshaller for GetRevenueStatistics operation
    /// </summary>  
    public class GetRevenueStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRevenueStatisticsResponse response = new GetRevenueStatisticsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RevenuePathStatistics", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RevenuePathStatistics, RevenuePathStatisticsUnmarshaller>(RevenuePathStatisticsUnmarshaller.Instance);
                    response.RevenuePathStatistics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SourceStatistics", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SourceStatistics, SourceStatisticsUnmarshaller>(SourceStatisticsUnmarshaller.Instance);
                    response.SourceStatistics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRevenueStatisticsResponseUnmarshaller _instance = new GetRevenueStatisticsResponseUnmarshaller();        

        internal static GetRevenueStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
