    ...
    public class ByteMatchStatementUnmarshaller : IJsonUnmarshaller<ByteMatchStatement, JsonUnmarshallerContext>
    {
        ...
        public ByteMatchStatement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SearchString", targetDepth, ref reader))
                {
        ...
        private static ByteMatchStatementUnmarshaller _instance = new ByteMatchStatementUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ByteMatchStatementUnmarshaller Instance
        {
            get
            {
                return _instance;
