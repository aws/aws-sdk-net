...
{
    /// <summary>
    /// Response Unmarshaller for ListSettlementRecords operation
    /// </summary>  
    public class ListSettlementRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSettlementRecordsResponse response = new ListSettlementRecordsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Settlements", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SettlementRecord, SettlementRecordUnmarshaller>(SettlementRecordUnmarshaller.Instance);
                    response.Settlements = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSettlementRecordsResponseUnmarshaller _instance = new ListSettlementRecordsResponseUnmarshaller();        

        internal static ListSettlementRecordsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSettlementRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
