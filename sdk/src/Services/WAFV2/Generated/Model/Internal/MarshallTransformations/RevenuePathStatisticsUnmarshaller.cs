...
{
    /// <summary>
    /// Response Unmarshaller for RevenuePathStatistics Object
    /// </summary>  
    public class RevenuePathStatisticsUnmarshaller : IJsonUnmarshaller<RevenuePathStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RevenuePathStatistics Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RevenuePathStatistics unmarshalledObject = new RevenuePathStatistics();
        ...
        private static RevenuePathStatisticsUnmarshaller _instance = new RevenuePathStatisticsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RevenuePathStatisticsUnmarshaller Instance
        {
            get
            {
                return _instance;
