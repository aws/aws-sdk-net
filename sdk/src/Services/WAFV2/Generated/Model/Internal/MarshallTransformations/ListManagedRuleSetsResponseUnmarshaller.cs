    ...
    public class ListManagedRuleSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ManagedRuleSetSummary, ManagedRuleSetSummaryUnmarshaller>(ManagedRuleSetSummaryUnmarshaller.Instance);
                    response.ManagedRuleSets = unmarshaller.Unmarshall(context);
                    continue;
                }
