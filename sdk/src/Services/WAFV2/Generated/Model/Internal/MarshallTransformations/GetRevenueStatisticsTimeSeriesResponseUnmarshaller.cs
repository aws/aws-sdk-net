...
{
    /// <summary>
    /// Response Unmarshaller for GetRevenueStatisticsTimeSeries operation
    /// </summary>  
    public class GetRevenueStatisticsTimeSeriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRevenueStatisticsTimeSeriesResponse response = new GetRevenueStatisticsTimeSeriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DataPointEntry, DataPointEntryUnmarshaller>(DataPointEntryUnmarshaller.Instance);
        ...
        private static GetRevenueStatisticsTimeSeriesResponseUnmarshaller _instance = new GetRevenueStatisticsTimeSeriesResponseUnmarshaller();        

        internal static GetRevenueStatisticsTimeSeriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueStatisticsTimeSeriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
