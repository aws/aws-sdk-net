...
{
    /// <summary>
    /// Container for the parameters to the ListSettlementRecords operation.
    ...
    /// value <c>TEST</c>.
    /// </summary>
    public partial class ListSettlementRecordsRequest : AmazonWAFV2Request
    {
        ...
        private SettlementSortBy _sortBy;
        ...
        /// <para>
        /// The field to sort settlement records by: <c>TIMESTAMP</c>, <c>AMOUNT</c>, <c>NAME</c>,
        /// or <c>STATUS</c>.
        /// </para>
        /// </summary>
        public SettlementSortBy SortBy
        {
