...
namespace Amazon.WAFV2.Model
{
    ...
    public partial class Headers
    {
        ...
        /// WAF does not support inspecting the entire contents of request headers when they exceed
        /// 8 KB (8192 bytes) or 200 total headers. The underlying host service forwards a maximum
        /// of 200 headers and at most 8 KB of header contents to WAF. 
        /// </para>
        ///  
        /// <para>
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <code>CONTINUE</code> - Inspect the headers normally, according to the rule inspection
        /// criteria. 
        /// </para>
        ///  </li> <li> 
        /// <para>
