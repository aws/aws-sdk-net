...
{
    /// <summary>
    /// Use the request's JA3 fingerprint derived from the TLS Client Hello of an incoming
    /// request as an aggregate key. If you use a single JA3 fingerprint as your custom key,
    /// then each value fully defines an aggregation instance.
    /// </summary>
    public partial class RateLimitJA3Fingerprint
    {
        ...
        /// Hello information to compute the JA3 fingerprint.
        /// </para>
        ///  
        /// <para>
