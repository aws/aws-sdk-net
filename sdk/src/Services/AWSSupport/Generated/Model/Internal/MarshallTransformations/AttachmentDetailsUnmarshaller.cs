...
namespace Amazon.AWSSupport.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttachmentDetailsUnmarshaller : IJsonUnmarshaller<AttachmentDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AttachmentDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("fileName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
