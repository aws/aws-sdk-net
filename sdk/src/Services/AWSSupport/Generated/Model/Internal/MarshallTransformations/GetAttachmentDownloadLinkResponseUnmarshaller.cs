...
{
    /// <summary>
    /// Response Unmarshaller for GetAttachmentDownloadLink operation
    /// </summary>  
    public class GetAttachmentDownloadLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAttachmentDownloadLinkResponse response = new GetAttachmentDownloadLinkResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DownloadUrlUnmarshaller.Instance;
        ...
        private static GetAttachmentDownloadLinkResponseUnmarshaller _instance = new GetAttachmentDownloadLinkResponseUnmarshaller();        

        internal static GetAttachmentDownloadLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAttachmentDownloadLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
