...
namespace Amazon.BCMRecommendedActions
{
    ...
    public partial class AmazonBCMRecommendedActionsClient : AmazonServiceClient, IAmazonBCMRecommendedActions
    {
        ...
        public AmazonBCMRecommendedActionsClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonBCMRecommendedActionsConfig()) { }
        ...
        public AmazonBCMRecommendedActionsClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonBCMRecommendedActionsConfig{RegionEndpoint = region}) { }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonBCMRecommendedActionsEndpointResolver();
