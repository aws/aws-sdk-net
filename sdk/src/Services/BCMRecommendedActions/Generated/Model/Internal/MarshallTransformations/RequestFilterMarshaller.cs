...
{
    /// <summary>
    /// RequestFilter Marshaller
    /// </summary>
    public class RequestFilterMarshaller : IRequestMarshaller<RequestFilter, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RequestFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetActions())
            {
                ...
                foreach(var requestObjectActionsListValue in requestObject.Actions)
                {
                    ...
                    var marshaller = ActionFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RequestFilterMarshaller Instance = new RequestFilterMarshaller();
