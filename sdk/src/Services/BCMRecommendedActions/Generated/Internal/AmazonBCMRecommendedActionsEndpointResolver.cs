...
namespace Amazon.BCMRecommendedActions.Internal
{
    /// <summary>
    /// Amazon BCMRecommendedActions endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for BCMRecommendedActions service requests.
    /// Collects values for BCMRecommendedActionsEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses BCMRecommendedActionsEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonBCMRecommendedActionsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonBCMRecommendedActionsConfig)requestContext.ClientConfig;
            var result = new BCMRecommendedActionsEndpointParameters();
