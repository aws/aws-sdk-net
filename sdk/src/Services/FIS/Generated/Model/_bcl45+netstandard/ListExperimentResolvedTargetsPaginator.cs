...
namespace Amazon.FIS.Model
{
    ...
    internal sealed partial class ListExperimentResolvedTargetsPaginator : IPaginator<ListExperimentResolvedTargetsResponse>, IListExperimentResolvedTargetsPaginator
    {
        ...
        async IAsyncEnumerable<ListExperimentResolvedTargetsResponse> IPaginator<ListExperimentResolvedTargetsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
