...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentReportStateUnmarshaller : IJsonUnmarshaller<ExperimentReportState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentReportState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
