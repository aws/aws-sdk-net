...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSafetyLeverRequestMarshaller : IMarshaller<IRequest, GetSafetyLeverRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSafetyLeverRequestMarshaller _instance = new GetSafetyLeverRequestMarshaller();        

        internal static GetSafetyLeverRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSafetyLeverRequestMarshaller Instance
        {
            get
            {
                return _instance;
