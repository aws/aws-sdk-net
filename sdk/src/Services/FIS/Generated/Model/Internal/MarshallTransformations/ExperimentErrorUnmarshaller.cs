...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentErrorUnmarshaller : IJsonUnmarshaller<ExperimentError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
