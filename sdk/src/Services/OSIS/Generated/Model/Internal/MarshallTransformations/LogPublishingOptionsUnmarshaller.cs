...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogPublishingOptionsUnmarshaller : IUnmarshaller<LogPublishingOptions, XmlUnmarshallerContext>, IUnmarshaller<LogPublishingOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LogPublishingOptions IUnmarshaller<LogPublishingOptions, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public LogPublishingOptions Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CloudWatchLogDestination", targetDepth))
                {
                    ...
                    unmarshalledObject.CloudWatchLogDestination = unmarshaller.Unmarshall(context);
                    continue;
                }
