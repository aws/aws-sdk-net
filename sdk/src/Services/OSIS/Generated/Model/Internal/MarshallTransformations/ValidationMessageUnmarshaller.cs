...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ValidationMessageUnmarshaller : IJsonUnmarshaller<ValidationMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ValidationMessage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
