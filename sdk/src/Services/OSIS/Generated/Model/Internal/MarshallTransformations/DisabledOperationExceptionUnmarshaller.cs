...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisabledOperationExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<DisabledOperationException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DisabledOperationException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public DisabledOperationException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
