...
{
    /// <summary>
    /// StopPipeline Request Marshaller
    /// </summary>       
    public class StopPipelineRequestMarshaller : IMarshaller<IRequest, StopPipelineRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopPipelineRequest)input);
        }
        ...
        public IRequest Marshall(StopPipelineRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2022-01-01/osis/stopPipeline/{PipelineName}";

            return request;
        }
        private static StopPipelineRequestMarshaller _instance = new StopPipelineRequestMarshaller();        

        internal static StopPipelineRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopPipelineRequestMarshaller Instance
        {
            get
            {
                return _instance;
