...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChangeProgressStatusUnmarshaller : IJsonUnmarshaller<ChangeProgressStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChangeProgressStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
