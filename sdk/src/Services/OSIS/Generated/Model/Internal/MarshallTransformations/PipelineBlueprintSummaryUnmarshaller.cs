...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineBlueprintSummaryUnmarshaller : IUnmarshaller<PipelineBlueprintSummary, XmlUnmarshallerContext>, IUnmarshaller<PipelineBlueprintSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PipelineBlueprintSummary IUnmarshaller<PipelineBlueprintSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
