...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeletePipelineEndpointRequestMarshaller : IMarshaller<IRequest, DeletePipelineEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeletePipelineEndpointRequestMarshaller _instance = new DeletePipelineEndpointRequestMarshaller();        

        internal static DeletePipelineEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePipelineEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
