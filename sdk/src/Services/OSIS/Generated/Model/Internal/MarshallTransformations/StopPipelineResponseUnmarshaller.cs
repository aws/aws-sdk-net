...
{
    /// <summary>
    /// Response Unmarshaller for StopPipeline operation
    /// </summary>  
    public class StopPipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopPipelineResponse response = new StopPipelineResponse();
        ...
        private static StopPipelineResponseUnmarshaller _instance = new StopPipelineResponseUnmarshaller();        

        internal static StopPipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopPipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
