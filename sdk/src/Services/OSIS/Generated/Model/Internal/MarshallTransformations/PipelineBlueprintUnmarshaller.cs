...
{
    /// <summary>
    /// Response Unmarshaller for PipelineBlueprint Object
    /// </summary>  
    public class PipelineBlueprintUnmarshaller : IUnmarshaller<PipelineBlueprint, XmlUnmarshallerContext>, IUnmarshaller<PipelineBlueprint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PipelineBlueprint IUnmarshaller<PipelineBlueprint, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static PipelineBlueprintUnmarshaller _instance = new PipelineBlueprintUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PipelineBlueprintUnmarshaller Instance
        {
            get
            {
                return _instance;
