...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineBlueprintUnmarshaller : IJsonUnmarshaller<PipelineBlueprint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PipelineBlueprint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
