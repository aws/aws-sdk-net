...
namespace Amazon.OSIS.Model
{
    ...
    public interface IListPipelineEndpointsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListPipelineEndpointsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the PipelineEndpoints
        /// </summary>
        IPaginatedEnumerable<PipelineEndpoint> PipelineEndpoints { get; }
    }
}