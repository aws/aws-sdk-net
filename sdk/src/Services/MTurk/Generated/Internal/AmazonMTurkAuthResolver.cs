...
namespace Amazon.MTurk.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonMTurkAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMTurkAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MTurk.
        /// </summary>
        public AmazonMTurkAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMTurkAuthSchemeParameters
            {
    ...
    public class AmazonMTurkAuthSchemeResolver : IAuthSchemeResolver<AmazonMTurkAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMTurkAuthSchemeParameters authParameters)
        {
