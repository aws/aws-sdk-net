...
{
    /// <summary>
    /// Response Unmarshaller for CreateHITType operation
    /// </summary>  
    public class CreateHITTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHITTypeResponse response = new CreateHITTypeResponse();
            ...
            {
                if (context.TestExpression("HITTypeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HITTypeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateHITTypeResponseUnmarshaller _instance = new CreateHITTypeResponseUnmarshaller();        

        internal static CreateHITTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHITTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
