...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNotificationSettings operation
    /// </summary>  
    public class UpdateNotificationSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateNotificationSettingsResponseUnmarshaller _instance = new UpdateNotificationSettingsResponseUnmarshaller();        

        internal static UpdateNotificationSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNotificationSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
