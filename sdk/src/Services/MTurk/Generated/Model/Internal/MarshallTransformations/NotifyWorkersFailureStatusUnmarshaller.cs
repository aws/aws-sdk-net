...
namespace Amazon.MTurk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NotifyWorkersFailureStatusUnmarshaller : IUnmarshaller<NotifyWorkersFailureStatus, XmlUnmarshallerContext>, IUnmarshaller<NotifyWorkersFailureStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NotifyWorkersFailureStatus IUnmarshaller<NotifyWorkersFailureStatus, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public NotifyWorkersFailureStatus Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("NotifyWorkersFailureCode", targetDepth))
                {
                    ...
                    unmarshalledObject.NotifyWorkersFailureCode = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("NotifyWorkersFailureMessage", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NotifyWorkersFailureMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
