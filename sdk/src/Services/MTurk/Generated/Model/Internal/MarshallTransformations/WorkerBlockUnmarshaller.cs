...
namespace Amazon.MTurk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkerBlockUnmarshaller : IJsonUnmarshaller<WorkerBlock, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkerBlock Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WorkerId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
