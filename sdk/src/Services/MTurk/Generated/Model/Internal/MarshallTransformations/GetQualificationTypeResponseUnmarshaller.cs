...
{
    /// <summary>
    /// Response Unmarshaller for GetQualificationType operation
    /// </summary>  
    public class GetQualificationTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQualificationTypeResponse response = new GetQualificationTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("QualificationType", targetDepth))
                {
                    ...
                    response.QualificationType = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetQualificationTypeResponseUnmarshaller _instance = new GetQualificationTypeResponseUnmarshaller();        

        internal static GetQualificationTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQualificationTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
