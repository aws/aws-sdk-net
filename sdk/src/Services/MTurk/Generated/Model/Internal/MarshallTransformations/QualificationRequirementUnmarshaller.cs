...
namespace Amazon.MTurk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QualificationRequirementUnmarshaller : IJsonUnmarshaller<QualificationRequirement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QualificationRequirement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
