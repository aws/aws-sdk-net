...
{
    /// <summary>
    /// ListWorkersWithQualificationType Request Marshaller
    /// </summary>       
    public class ListWorkersWithQualificationTypeRequestMarshaller : IMarshaller<IRequest, ListWorkersWithQualificationTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListWorkersWithQualificationTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListWorkersWithQualificationTypeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.ListWorkersWithQualificationType";
            ...
            if(publicRequest.IsSetQualificationTypeId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.QualificationTypeId);
            }
