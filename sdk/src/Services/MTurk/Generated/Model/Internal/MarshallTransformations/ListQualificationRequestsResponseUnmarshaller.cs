    ...
    public class ListQualificationRequestsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<QualificationRequest, QualificationRequestUnmarshaller>(QualificationRequestUnmarshaller.Instance);
                    response.QualificationRequests = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
