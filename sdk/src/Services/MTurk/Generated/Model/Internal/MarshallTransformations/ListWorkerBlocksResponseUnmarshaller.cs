...
{
    /// <summary>
    /// Response Unmarshaller for ListWorkerBlocks operation
    /// </summary>  
    public class ListWorkerBlocksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWorkerBlocksResponse response = new ListWorkerBlocksResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WorkerBlocks", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkerBlock, WorkerBlockUnmarshaller>(WorkerBlockUnmarshaller.Instance);
                    response.WorkerBlocks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListWorkerBlocksResponseUnmarshaller _instance = new ListWorkerBlocksResponseUnmarshaller();        

        internal static ListWorkerBlocksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkerBlocksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
