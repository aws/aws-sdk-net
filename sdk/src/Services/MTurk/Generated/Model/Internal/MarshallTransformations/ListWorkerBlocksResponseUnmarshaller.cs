    ...
    public class ListWorkerBlocksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WorkerBlock, WorkerBlockUnmarshaller>(WorkerBlockUnmarshaller.Instance);
                    response.WorkerBlocks = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
