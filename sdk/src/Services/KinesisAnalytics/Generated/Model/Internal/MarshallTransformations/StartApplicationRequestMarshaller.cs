...
namespace Amazon.KinesisAnalytics.Model.Internal.MarshallTransformations
{
    ...
    public class StartApplicationRequestMarshaller : IMarshaller<IRequest, StartApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartApplicationRequest publicRequest)
        {
            ...
            string target = "KinesisAnalytics_20150814.StartApplication";
            ...
            if(publicRequest.IsSetInputConfigurations())
            {
                context.Writer.WritePropertyName("InputConfigurations");
                context.Writer.WriteStartArray();
                foreach(var publicRequestInputConfigurationsListValue in publicRequest.InputConfigurations)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = InputConfigurationMarshaller.Instance;
                    marshaller.Marshall(publicRequestInputConfigurationsListValue, context);
