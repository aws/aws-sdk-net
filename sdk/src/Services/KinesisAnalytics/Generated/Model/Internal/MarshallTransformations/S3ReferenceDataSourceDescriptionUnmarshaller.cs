...
namespace Amazon.KinesisAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ReferenceDataSourceDescriptionUnmarshaller : IJsonUnmarshaller<S3ReferenceDataSourceDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3ReferenceDataSourceDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FileKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ReferenceRoleARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReferenceRoleARN = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
