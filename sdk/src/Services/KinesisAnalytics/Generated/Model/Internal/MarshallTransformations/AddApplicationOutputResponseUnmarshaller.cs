...
{
    /// <summary>
    /// Response Unmarshaller for AddApplicationOutput operation
    /// </summary>  
    public class AddApplicationOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddApplicationOutputResponse response = new AddApplicationOutputResponse();
        ...
        private static AddApplicationOutputResponseUnmarshaller _instance = new AddApplicationOutputResponseUnmarshaller();        

        internal static AddApplicationOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddApplicationOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
