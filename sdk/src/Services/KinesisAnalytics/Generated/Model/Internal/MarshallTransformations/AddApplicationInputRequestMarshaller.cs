...
{
    /// <summary>
    /// AddApplicationInput Request Marshaller
    /// </summary>       
    public class AddApplicationInputRequestMarshaller : IMarshaller<IRequest, AddApplicationInputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddApplicationInputRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddApplicationInputRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KinesisAnalytics");
            string target = "KinesisAnalytics_20150814.AddApplicationInput";
