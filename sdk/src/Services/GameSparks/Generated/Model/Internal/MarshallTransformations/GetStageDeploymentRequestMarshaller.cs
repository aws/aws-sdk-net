...
{
    /// <summary>
    /// GetStageDeployment Request Marshaller
    /// </summary>       
    public class GetStageDeploymentRequestMarshaller : IMarshaller<IRequest, GetStageDeploymentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetStageDeploymentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetStageDeploymentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/game/{GameName}/stage/{StageName}/deployment";
            request.UseQueryString = true;

            return request;
        }
        private static GetStageDeploymentRequestMarshaller _instance = new GetStageDeploymentRequestMarshaller();        

        internal static GetStageDeploymentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStageDeploymentRequestMarshaller Instance
        {
            get
            {
                return _instance;
