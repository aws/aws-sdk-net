...
{
    /// <summary>
    /// UpdateGame Request Marshaller
    /// </summary>       
    public class UpdateGameRequestMarshaller : IMarshaller<IRequest, UpdateGameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateGameRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateGameRequest publicRequest)
        {
        ...
        private static UpdateGameRequestMarshaller _instance = new UpdateGameRequestMarshaller();        

        internal static UpdateGameRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGameRequestMarshaller Instance
        {
            get
            {
                return _instance;
