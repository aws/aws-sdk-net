...
{
    /// <summary>
    /// GetGeneratedCodeJob Request Marshaller
    /// </summary>       
    public class GetGeneratedCodeJobRequestMarshaller : IMarshaller<IRequest, GetGeneratedCodeJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetGeneratedCodeJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetGeneratedCodeJobRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetJobId())
                throw new AmazonGameSparksException("Request object does not have required field JobId set");
            ...
            request.ResourcePath = "/game/{GameName}/snapshot/{SnapshotId}/generated-sdk-code-job/{JobId}";

            return request;
        }
        private static GetGeneratedCodeJobRequestMarshaller _instance = new GetGeneratedCodeJobRequestMarshaller();        

        internal static GetGeneratedCodeJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGeneratedCodeJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
