...
{
    /// <summary>
    /// StartStageDeployment Request Marshaller
    /// </summary>       
    public class StartStageDeploymentRequestMarshaller : IMarshaller<IRequest, StartStageDeploymentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartStageDeploymentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartStageDeploymentRequest publicRequest)
        {
        ...
        private static StartStageDeploymentRequestMarshaller _instance = new StartStageDeploymentRequestMarshaller();        

        internal static StartStageDeploymentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartStageDeploymentRequestMarshaller Instance
        {
            get
            {
                return _instance;
