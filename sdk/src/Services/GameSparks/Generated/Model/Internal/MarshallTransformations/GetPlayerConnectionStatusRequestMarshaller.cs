...
{
    /// <summary>
    /// GetPlayerConnectionStatus Request Marshaller
    /// </summary>       
    public class GetPlayerConnectionStatusRequestMarshaller : IMarshaller<IRequest, GetPlayerConnectionStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPlayerConnectionStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPlayerConnectionStatusRequest publicRequest)
        {
            ...
            request.ResourcePath = "/runtime/game/{GameName}/stage/{StageName}/player/{PlayerId}/connection";

            return request;
        }
        private static GetPlayerConnectionStatusRequestMarshaller _instance = new GetPlayerConnectionStatusRequestMarshaller();        

        internal static GetPlayerConnectionStatusRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPlayerConnectionStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
