...
{
    /// <summary>
    /// ExportSnapshot Request Marshaller
    /// </summary>       
    public class ExportSnapshotRequestMarshaller : IMarshaller<IRequest, ExportSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportSnapshotRequest publicRequest)
        {
            ...
            request.ResourcePath = "/game/{GameName}/snapshot/{SnapshotId}/export";

            return request;
        }
        private static ExportSnapshotRequestMarshaller _instance = new ExportSnapshotRequestMarshaller();        

        internal static ExportSnapshotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportSnapshotRequestMarshaller Instance
        {
            get
            {
                return _instance;
