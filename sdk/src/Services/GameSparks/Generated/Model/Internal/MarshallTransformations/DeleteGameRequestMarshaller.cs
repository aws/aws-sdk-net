...
{
    /// <summary>
    /// DeleteGame Request Marshaller
    /// </summary>       
    public class DeleteGameRequestMarshaller : IMarshaller<IRequest, DeleteGameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteGameRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteGameRequest publicRequest)
        {
            ...
            request.ResourcePath = "/game/{GameName}";

            return request;
        }
        private static DeleteGameRequestMarshaller _instance = new DeleteGameRequestMarshaller();        

        internal static DeleteGameRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGameRequestMarshaller Instance
        {
            get
            {
                return _instance;
