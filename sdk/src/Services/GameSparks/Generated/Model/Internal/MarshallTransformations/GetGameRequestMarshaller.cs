...
{
    /// <summary>
    /// GetGame Request Marshaller
    /// </summary>       
    public class GetGameRequestMarshaller : IMarshaller<IRequest, GetGameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetGameRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetGameRequest publicRequest)
        {
        ...
        private static GetGameRequestMarshaller _instance = new GetGameRequestMarshaller();        

        internal static GetGameRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGameRequestMarshaller Instance
        {
            get
            {
                return _instance;
