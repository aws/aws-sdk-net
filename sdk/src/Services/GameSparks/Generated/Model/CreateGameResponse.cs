...
{
    /// <summary>
    /// This is the response object from the CreateGame operation.
    /// </summary>
    public partial class CreateGameResponse : AmazonWebServiceResponse
    {
        private GameDetails _game;

        /// <summary>
        /// Gets and sets the property Game. 
        /// <para>
        ...
        // Check to see if Game property is set
        internal bool IsSetGame()
        {
