...
{
    /// <summary>
    /// This is the response object from the ListSnapshots operation.
    /// </summary>
    public partial class ListSnapshotsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<SnapshotSummary> _snapshots = new List<SnapshotSummary>();
        ...
        /// </para>
        /// </summary>
        public List<SnapshotSummary> Snapshots
        {
