...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNetworkConnector operation
    /// </summary>  
    public class UpdateNetworkConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateNetworkConnectorResponse response = new UpdateNetworkConnectorResponse();
        ...
        private static UpdateNetworkConnectorResponseUnmarshaller _instance = new UpdateNetworkConnectorResponseUnmarshaller();        

        internal static UpdateNetworkConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNetworkConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
