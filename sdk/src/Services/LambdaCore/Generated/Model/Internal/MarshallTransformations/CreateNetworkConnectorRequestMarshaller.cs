...
{
    /// <summary>
    /// CreateNetworkConnector Request Marshaller
    /// </summary>       
    public class CreateNetworkConnectorRequestMarshaller : IMarshaller<IRequest, CreateNetworkConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateNetworkConnectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateNetworkConnectorRequest publicRequest)
        {
        ...
        private static CreateNetworkConnectorRequestMarshaller _instance = new CreateNetworkConnectorRequestMarshaller();        

        internal static CreateNetworkConnectorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNetworkConnectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
