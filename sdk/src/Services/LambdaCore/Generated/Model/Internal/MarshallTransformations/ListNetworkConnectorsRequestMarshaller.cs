...
namespace Amazon.LambdaCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListNetworkConnectorsRequestMarshaller : IMarshaller<IRequest, ListNetworkConnectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListNetworkConnectorsRequestMarshaller _instance = new ListNetworkConnectorsRequestMarshaller();        

        internal static ListNetworkConnectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNetworkConnectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
