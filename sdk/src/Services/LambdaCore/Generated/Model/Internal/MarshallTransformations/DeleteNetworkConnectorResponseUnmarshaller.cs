...
{
    /// <summary>
    /// Response Unmarshaller for DeleteNetworkConnector operation
    /// </summary>  
    public class DeleteNetworkConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteNetworkConnectorResponse response = new DeleteNetworkConnectorResponse();
        ...
        private static DeleteNetworkConnectorResponseUnmarshaller _instance = new DeleteNetworkConnectorResponseUnmarshaller();        

        internal static DeleteNetworkConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNetworkConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
