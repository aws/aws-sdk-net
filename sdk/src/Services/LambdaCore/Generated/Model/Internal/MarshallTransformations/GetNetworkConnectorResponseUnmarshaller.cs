...
{
    /// <summary>
    /// Response Unmarshaller for GetNetworkConnector operation
    /// </summary>  
    public class GetNetworkConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetNetworkConnectorResponse response = new GetNetworkConnectorResponse();
        ...
        private static GetNetworkConnectorResponseUnmarshaller _instance = new GetNetworkConnectorResponseUnmarshaller();        

        internal static GetNetworkConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNetworkConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
