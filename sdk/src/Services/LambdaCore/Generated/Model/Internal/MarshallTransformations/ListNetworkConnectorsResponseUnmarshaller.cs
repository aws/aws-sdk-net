...
{
    /// <summary>
    /// Response Unmarshaller for ListNetworkConnectors operation
    /// </summary>  
    public class ListNetworkConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListNetworkConnectorsResponse response = new ListNetworkConnectorsResponse();
            ...
            {
                if (context.TestExpression("NetworkConnectors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<NetworkConnectorSummary, NetworkConnectorSummaryUnmarshaller>(NetworkConnectorSummaryUnmarshaller.Instance);
                    response.NetworkConnectors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListNetworkConnectorsResponseUnmarshaller _instance = new ListNetworkConnectorsResponseUnmarshaller();        

        internal static ListNetworkConnectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNetworkConnectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
