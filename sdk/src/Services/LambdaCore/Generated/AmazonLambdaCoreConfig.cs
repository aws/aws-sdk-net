...
{
    /// <summary>
    /// Configuration for accessing Amazon LambdaCore service
    /// </summary>
    public partial class AmazonLambdaCoreConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Lambda Core", "4.0.100.11");
        ...
        /// Default constructor
        /// </summary>
        public AmazonLambdaCoreConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonLambdaCoreDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Lambda Core";
            this.AuthenticationServiceName = "lambda";
            this.EndpointProvider = new AmazonLambdaCoreEndpointProvider();
        }
