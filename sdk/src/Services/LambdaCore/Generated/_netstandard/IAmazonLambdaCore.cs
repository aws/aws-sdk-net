...
namespace Amazon.LambdaCore
{
    ...
    public partial interface IAmazonLambdaCore : IAmazonService, IDisposable
    {
        ...
        Task<CreateNetworkConnectorResponse> CreateNetworkConnectorAsync(CreateNetworkConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteNetworkConnectorResponse> DeleteNetworkConnectorAsync(DeleteNetworkConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetNetworkConnectorResponse> GetNetworkConnectorAsync(GetNetworkConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListNetworkConnectorsResponse> ListNetworkConnectorsAsync(ListNetworkConnectorsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateNetworkConnectorResponse> UpdateNetworkConnectorAsync(UpdateNetworkConnectorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonLambdaCoreConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonLambdaCoreConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonLambdaCoreConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonLambdaCoreConfig to create AmazonLambdaCoreClient");
            }

            return awsCredentials == null ? 
                    new AmazonLambdaCoreClient(serviceClientConfig) :
                    new AmazonLambdaCoreClient(awsCredentials, serviceClientConfig);
        }
