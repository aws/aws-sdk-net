...
namespace Amazon.LambdaCore.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonLambdaCoreAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLambdaCoreAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LambdaCore.
        /// </summary>
        public AmazonLambdaCoreAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLambdaCoreAuthSchemeParameters
            {
    ...
    public class AmazonLambdaCoreAuthSchemeResolver : IAuthSchemeResolver<AmazonLambdaCoreAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLambdaCoreAuthSchemeParameters authParameters)
        {
