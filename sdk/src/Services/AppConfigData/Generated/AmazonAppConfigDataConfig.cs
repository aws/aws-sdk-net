...
namespace Amazon.AppConfigData
{
    ...
    public partial class AmazonAppConfigDataConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("AppConfigData", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "AppConfigData";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "appconfigdata";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-11-11";
