...
namespace Amazon.AppConfigData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartConfigurationSessionRequestMarshaller : IMarshaller<IRequest, StartConfigurationSessionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartConfigurationSessionRequestMarshaller _instance = new();

        internal static StartConfigurationSessionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartConfigurationSessionRequestMarshaller Instance => _instance;
    }
}
