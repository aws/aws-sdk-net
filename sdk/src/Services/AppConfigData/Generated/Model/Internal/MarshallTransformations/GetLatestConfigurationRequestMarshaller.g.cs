...
namespace Amazon.AppConfigData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetLatestConfigurationRequestMarshaller : IMarshaller<IRequest, GetLatestConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetLatestConfigurationRequestMarshaller _instance = new();

        internal static GetLatestConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetLatestConfigurationRequestMarshaller Instance => _instance;
    }
}
