...
namespace Amazon.AppConfigData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InvalidParameterDetailUnmarshaller : IJsonUnmarshaller<InvalidParameterDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InvalidParameterDetail();
        ...
        /// Gets the singleton.
        /// </summary>
        public static InvalidParameterDetailUnmarshaller Instance => _instance;
    }
}
