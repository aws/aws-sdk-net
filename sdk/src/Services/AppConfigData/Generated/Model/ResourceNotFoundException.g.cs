...
namespace Amazon.AppConfigData.Model
{
    ...
    public partial class ResourceNotFoundException : AmazonAppConfigDataException
    {
        ...
        /// </summary>
        public Dictionary<string, string> ReferencedBy { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the ReferencedBy property is set.
        /// </summary>
        internal bool IsSetReferencedBy() => this.ReferencedBy != null && (this.ReferencedBy.Count > 0 || !AWSConfigs.InitializeCollections);
