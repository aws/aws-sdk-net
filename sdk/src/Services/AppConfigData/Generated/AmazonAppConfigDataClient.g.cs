...
namespace Amazon.AppConfigData
{
    ...
    public partial class AmazonAppConfigDataClient : AmazonServiceClient, IAmazonAppConfigData
    {
        ...
        /// 
        /// </summary>
        public AmazonAppConfigDataClient() : base(new AmazonAppConfigDataConfig()) { }
        ...
        public AmazonAppConfigDataClient(RegionEndpoint region) : base(new AmazonAppConfigDataConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAppConfigDataClient(AmazonAppConfigDataConfig config) : base(config) { }
