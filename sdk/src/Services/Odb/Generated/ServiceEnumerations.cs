...
namespace Amazon.Odb
{
    ...
    /// <summary>
    /// Constants used for properties of type HardwareType.
    /// </summary>
    public class HardwareType : ConstantClass
    {

        /// <summary>
        /// Constant CELL for HardwareType
        /// </summary>
        public static readonly HardwareType CELL = new HardwareType("CELL");
        /// <summary>
        /// Constant COMPUTE for HardwareType
        /// </summary>
        public static readonly HardwareType COMPUTE = new HardwareType("COMPUTE");
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static HardwareType FindValue(string value)
        {
            return FindValue<HardwareType>(value);
        }
