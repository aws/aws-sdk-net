...
namespace Amazon.Odb.Model
{
    ...
    public partial class StopDbNodeRequest : AmazonOdbRequest
    {
        ...
        /// <para>
        /// The unique identifier of the VM cluster that contains the DB node to stop. You must
        ...
        /// <para>
        /// The unique identifier of the Exascale VM cluster that contains the DB node to stop.
