...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutonomousDatabaseBackup operation
    /// </summary>  
    public class CreateAutonomousDatabaseBackupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutonomousDatabaseBackupResponse response = new CreateAutonomousDatabaseBackupResponse();
        ...
        private static CreateAutonomousDatabaseBackupResponseUnmarshaller _instance = new CreateAutonomousDatabaseBackupResponseUnmarshaller();        

        internal static CreateAutonomousDatabaseBackupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutonomousDatabaseBackupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
