...
{
    /// <summary>
    /// Response Unmarshaller for RebootDbNode operation
    /// </summary>  
    public class RebootDbNodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootDbNodeResponse response = new RebootDbNodeResponse();
            ...
            {
                if (context.TestExpression("dbNodeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DbNodeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RebootDbNodeResponseUnmarshaller _instance = new RebootDbNodeResponseUnmarshaller();        

        internal static RebootDbNodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootDbNodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
