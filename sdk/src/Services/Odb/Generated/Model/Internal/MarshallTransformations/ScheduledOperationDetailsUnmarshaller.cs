...
{
    /// <summary>
    /// Response Unmarshaller for ScheduledOperationDetails Object
    /// </summary>  
    public class ScheduledOperationDetailsUnmarshaller : IJsonUnmarshaller<ScheduledOperationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduledOperationDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ScheduledOperationDetails unmarshalledObject = new ScheduledOperationDetails();
        ...
        private static ScheduledOperationDetailsUnmarshaller _instance = new ScheduledOperationDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ScheduledOperationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
