...
{
    /// <summary>
    /// Response Unmarshaller for DeleteExadbVmCluster operation
    /// </summary>  
    public class DeleteExadbVmClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteExadbVmClusterResponse response = new DeleteExadbVmClusterResponse();
        ...
        private static DeleteExadbVmClusterResponseUnmarshaller _instance = new DeleteExadbVmClusterResponseUnmarshaller();        

        internal static DeleteExadbVmClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExadbVmClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
