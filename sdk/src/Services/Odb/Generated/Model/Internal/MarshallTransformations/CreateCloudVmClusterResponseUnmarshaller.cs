...
{
    /// <summary>
    /// Response Unmarshaller for CreateCloudVmCluster operation
    /// </summary>  
    public class CreateCloudVmClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCloudVmClusterResponse response = new CreateCloudVmClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("cloudVmClusterId", targetDepth))
                {
                    ...
                    response.CloudVmClusterId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateCloudVmClusterResponseUnmarshaller _instance = new CreateCloudVmClusterResponseUnmarshaller();        

        internal static CreateCloudVmClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCloudVmClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
