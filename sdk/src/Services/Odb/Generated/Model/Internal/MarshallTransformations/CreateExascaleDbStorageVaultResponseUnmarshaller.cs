...
{
    /// <summary>
    /// Response Unmarshaller for CreateExascaleDbStorageVault operation
    /// </summary>  
    public class CreateExascaleDbStorageVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateExascaleDbStorageVaultResponse response = new CreateExascaleDbStorageVaultResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExascaleDbStorageVaultId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateExascaleDbStorageVaultResponseUnmarshaller _instance = new CreateExascaleDbStorageVaultResponseUnmarshaller();        

        internal static CreateExascaleDbStorageVaultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExascaleDbStorageVaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
