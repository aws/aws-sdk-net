...
{
    /// <summary>
    /// UpdateExascaleDbStorageVault Request Marshaller
    /// </summary>       
    public class UpdateExascaleDbStorageVaultRequestMarshaller : IMarshaller<IRequest, UpdateExascaleDbStorageVaultRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateExascaleDbStorageVaultRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateExascaleDbStorageVaultRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Odb");
            string target = "Odb.UpdateExascaleDbStorageVault";
        ...
        private static UpdateExascaleDbStorageVaultRequestMarshaller _instance = new UpdateExascaleDbStorageVaultRequestMarshaller();        

        internal static UpdateExascaleDbStorageVaultRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExascaleDbStorageVaultRequestMarshaller Instance
        {
            get
            {
                return _instance;
