...
{
    /// <summary>
    /// UpdateAutonomousDatabase Request Marshaller
    /// </summary>       
    public class UpdateAutonomousDatabaseRequestMarshaller : IMarshaller<IRequest, UpdateAutonomousDatabaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAutonomousDatabaseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAutonomousDatabaseRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Odb");
            string target = "Odb.UpdateAutonomousDatabase";
            ...
            if(publicRequest.IsSetAutoRefreshFrequencyInSeconds())
            {
                context.Writer.WritePropertyName("autoRefreshFrequencyInSeconds");
                context.Writer.WriteNumberValue(publicRequest.AutoRefreshFrequencyInSeconds.Value);
            }

            if(publicRequest.IsSetAutoRefreshPointLagInSeconds())
            {
                context.Writer.WritePropertyName("autoRefreshPointLagInSeconds");
                context.Writer.WriteNumberValue(publicRequest.AutoRefreshPointLagInSeconds.Value);
            }
            ...
            if(publicRequest.IsSetIsDisconnectPeer())
            {
                context.Writer.WritePropertyName("isDisconnectPeer");
                context.Writer.WriteBooleanValue(publicRequest.IsDisconnectPeer.Value);
            }
            ...
            if(publicRequest.IsSetIsRefreshableClone())
            {
                context.Writer.WritePropertyName("isRefreshableClone");
                context.Writer.WriteBooleanValue(publicRequest.IsRefreshableClone.Value);
            }
            ...
            if(publicRequest.IsSetLocalAdgAutoFailoverMaxDataLossLimit())
            {
                context.Writer.WritePropertyName("localAdgAutoFailoverMaxDataLossLimit");
                context.Writer.WriteNumberValue(publicRequest.LocalAdgAutoFailoverMaxDataLossLimit.Value);
            }

            if(publicRequest.IsSetLongTermBackupSchedule())
            {
                context.Writer.WritePropertyName("longTermBackupSchedule");
                context.Writer.WriteStartObject();

                var marshaller = LongTermBackupScheduleMarshaller.Instance;
                marshaller.Marshall(publicRequest.LongTermBackupSchedule, context);

                context.Writer.WriteEndObject();
            }

            if(publicRequest.IsSetOpenMode())
            {
                context.Writer.WritePropertyName("openMode");
                context.Writer.WriteStringValue(publicRequest.OpenMode);
            }

            if(publicRequest.IsSetPeerDbId())
            {
                context.Writer.WritePropertyName("peerDbId");
                context.Writer.WriteStringValue(publicRequest.PeerDbId);
            }

            if(publicRequest.IsSetPermissionLevel())
            {
                context.Writer.WritePropertyName("permissionLevel");
                context.Writer.WriteStringValue(publicRequest.PermissionLevel);
            }
            ...
            if(publicRequest.IsSetRefreshableMode())
            {
                context.Writer.WritePropertyName("refreshableMode");
                context.Writer.WriteStringValue(publicRequest.RefreshableMode);
            }
            ...
            if(publicRequest.IsSetTimeOfAutoRefreshStart())
            {
                context.Writer.WritePropertyName("timeOfAutoRefreshStart");
                context.Writer.WriteStringValue(StringUtils.FromDateTimeToISO8601WithOptionalMs(publicRequest.TimeOfAutoRefreshStart));
            }
        ...
        private static UpdateAutonomousDatabaseRequestMarshaller _instance = new UpdateAutonomousDatabaseRequestMarshaller();        

        internal static UpdateAutonomousDatabaseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAutonomousDatabaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
