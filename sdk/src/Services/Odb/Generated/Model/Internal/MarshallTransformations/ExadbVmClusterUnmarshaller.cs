...
{
    /// <summary>
    /// Response Unmarshaller for ExadbVmCluster Object
    /// </summary>  
    public class ExadbVmClusterUnmarshaller : IJsonUnmarshaller<ExadbVmCluster, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExadbVmCluster Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ExadbVmCluster unmarshalledObject = new ExadbVmCluster();
        ...
        private static ExadbVmClusterUnmarshaller _instance = new ExadbVmClusterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ExadbVmClusterUnmarshaller Instance
        {
            get
            {
                return _instance;
