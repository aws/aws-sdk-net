...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAutonomousDatabase operation
    /// </summary>  
    public class UpdateAutonomousDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAutonomousDatabaseResponse response = new UpdateAutonomousDatabaseResponse();
        ...
        private static UpdateAutonomousDatabaseResponseUnmarshaller _instance = new UpdateAutonomousDatabaseResponseUnmarshaller();        

        internal static UpdateAutonomousDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAutonomousDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
