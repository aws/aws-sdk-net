...
{
    /// <summary>
    /// Response Unmarshaller for CloudVmClusterSummary Object
    /// </summary>  
    public class CloudVmClusterSummaryUnmarshaller : IUnmarshaller<CloudVmClusterSummary, XmlUnmarshallerContext>, IUnmarshaller<CloudVmClusterSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CloudVmClusterSummary IUnmarshaller<CloudVmClusterSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CloudVmClusterSummary Unmarshall(JsonUnmarshallerContext context)
        {
            CloudVmClusterSummary unmarshalledObject = new CloudVmClusterSummary();
        ...
        private static CloudVmClusterSummaryUnmarshaller _instance = new CloudVmClusterSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CloudVmClusterSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
