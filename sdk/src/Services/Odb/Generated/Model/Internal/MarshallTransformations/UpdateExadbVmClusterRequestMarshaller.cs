...
{
    /// <summary>
    /// UpdateExadbVmCluster Request Marshaller
    /// </summary>       
    public class UpdateExadbVmClusterRequestMarshaller : IMarshaller<IRequest, UpdateExadbVmClusterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateExadbVmClusterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateExadbVmClusterRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Odb");
            string target = "Odb.UpdateExadbVmCluster";
            ...
            if(publicRequest.IsSetUpdateAction())
            {
                context.Writer.WritePropertyName("updateAction");
                context.Writer.WriteStringValue(publicRequest.UpdateAction);
            }
        ...
        private static UpdateExadbVmClusterRequestMarshaller _instance = new UpdateExadbVmClusterRequestMarshaller();        

        internal static UpdateExadbVmClusterRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExadbVmClusterRequestMarshaller Instance
        {
            get
            {
                return _instance;
