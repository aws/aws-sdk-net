...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutonomousDatabase operation
    /// </summary>  
    public class CreateAutonomousDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutonomousDatabaseResponse response = new CreateAutonomousDatabaseResponse();
        ...
        private static CreateAutonomousDatabaseResponseUnmarshaller _instance = new CreateAutonomousDatabaseResponseUnmarshaller();        

        internal static CreateAutonomousDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutonomousDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
