...
{
    /// <summary>
    /// Response Unmarshaller for UpdateExascaleDbStorageVault operation
    /// </summary>  
    public class UpdateExascaleDbStorageVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExascaleDbStorageVaultResponse response = new UpdateExascaleDbStorageVaultResponse();
        ...
        private static UpdateExascaleDbStorageVaultResponseUnmarshaller _instance = new UpdateExascaleDbStorageVaultResponseUnmarshaller();        

        internal static UpdateExascaleDbStorageVaultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExascaleDbStorageVaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
