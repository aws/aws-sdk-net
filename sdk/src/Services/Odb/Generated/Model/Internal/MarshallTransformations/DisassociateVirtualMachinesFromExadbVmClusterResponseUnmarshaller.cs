...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateVirtualMachinesFromExadbVmCluster operation
    /// </summary>  
    public class DisassociateVirtualMachinesFromExadbVmClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateVirtualMachinesFromExadbVmClusterResponse response = new DisassociateVirtualMachinesFromExadbVmClusterResponse();
        ...
        private static DisassociateVirtualMachinesFromExadbVmClusterResponseUnmarshaller _instance = new DisassociateVirtualMachinesFromExadbVmClusterResponseUnmarshaller();        

        internal static DisassociateVirtualMachinesFromExadbVmClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateVirtualMachinesFromExadbVmClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
