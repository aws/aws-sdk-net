        ...
        public IRequest Marshall(CreateCloudVmClusterRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetCpuCoreCount())
                {
                    ...
                    context.Writer.Write(publicRequest.CpuCoreCount);
                }
                ...
                if(publicRequest.IsSetDataStorageSizeInTBs())
                {
                    ...
                    if(StringUtils.IsSpecialDoubleValue(publicRequest.DataStorageSizeInTBs))
                    {
                        context.Writer.Write(StringUtils.FromSpecialDoubleValue(publicRequest.DataStorageSizeInTBs));
                    }
                    else
                    {
                        context.Writer.Write(publicRequest.DataStorageSizeInTBs);
                    }
                }
                ...
                if(publicRequest.IsSetDbNodeStorageSizeInGBs())
                {
                    ...
                    context.Writer.Write(publicRequest.DbNodeStorageSizeInGBs);
                }
                ...
                if(publicRequest.IsSetGiVersion())
                {
                    ...
                    context.Writer.Write(publicRequest.GiVersion);
                }
                ...
                if(publicRequest.IsSetIsLocalBackupEnabled())
                {
                    ...
                    context.Writer.Write(publicRequest.IsLocalBackupEnabled);
                }

                if(publicRequest.IsSetIsSparseDiskgroupEnabled())
                {
                    context.Writer.WritePropertyName("isSparseDiskgroupEnabled");
                    context.Writer.Write(publicRequest.IsSparseDiskgroupEnabled);
                }
                ...
                if(publicRequest.IsSetMemorySizeInGBs())
                {
                    ...
                    context.Writer.Write(publicRequest.MemorySizeInGBs);
                }
                ...
                if(publicRequest.IsSetScanListenerPortTcp())
                {
                    ...
                    context.Writer.Write(publicRequest.ScanListenerPortTcp);
                }
                ...
                if(publicRequest.IsSetSshPublicKeys())
                {
                    ...
                    {
                            context.Writer.Write(publicRequestSshPublicKeysListValue);
                    }
                    context.Writer.WriteArrayEnd();
                }
                ...
                if(publicRequest.IsSetSystemVersion())
                {
                    ...
                    context.Writer.Write(publicRequest.SystemVersion);
                }
