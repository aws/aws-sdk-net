...
{
    /// <summary>
    /// ListGiMinorVersions Request Marshaller
    /// </summary>       
    public class ListGiMinorVersionsRequestMarshaller : IMarshaller<IRequest, ListGiMinorVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListGiMinorVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListGiMinorVersionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Odb");
            string target = "Odb.ListGiMinorVersions";
        ...
        private static ListGiMinorVersionsRequestMarshaller _instance = new ListGiMinorVersionsRequestMarshaller();        

        internal static ListGiMinorVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGiMinorVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
