...
{
    /// <summary>
    /// Response Unmarshaller for CreateExadbVmCluster operation
    /// </summary>  
    public class CreateExadbVmClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateExadbVmClusterResponse response = new CreateExadbVmClusterResponse();
        ...
        private static CreateExadbVmClusterResponseUnmarshaller _instance = new CreateExadbVmClusterResponseUnmarshaller();        

        internal static CreateExadbVmClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExadbVmClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
