...
namespace Amazon.Odb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CrossRegionS3RestoreSourcesAccessUnmarshaller : IJsonUnmarshaller<CrossRegionS3RestoreSourcesAccess, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CrossRegionS3RestoreSourcesAccess Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
