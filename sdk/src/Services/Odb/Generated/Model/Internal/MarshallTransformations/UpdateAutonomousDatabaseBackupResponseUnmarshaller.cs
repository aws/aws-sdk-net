...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAutonomousDatabaseBackup operation
    /// </summary>  
    public class UpdateAutonomousDatabaseBackupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAutonomousDatabaseBackupResponse response = new UpdateAutonomousDatabaseBackupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("autonomousDatabaseBackupId", targetDepth, ref reader))
                {
                    ...
                    response.AutonomousDatabaseBackupId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAutonomousDatabaseBackupResponseUnmarshaller _instance = new UpdateAutonomousDatabaseBackupResponseUnmarshaller();        

        internal static UpdateAutonomousDatabaseBackupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAutonomousDatabaseBackupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
