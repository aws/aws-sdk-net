...
{
    /// <summary>
    /// Response Unmarshaller for DisasterRecoveryConfiguration Object
    /// </summary>  
    public class DisasterRecoveryConfigurationUnmarshaller : IJsonUnmarshaller<DisasterRecoveryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DisasterRecoveryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DisasterRecoveryConfiguration unmarshalledObject = new DisasterRecoveryConfiguration();
        ...
        private static DisasterRecoveryConfigurationUnmarshaller _instance = new DisasterRecoveryConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DisasterRecoveryConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
