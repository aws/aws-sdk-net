...
{
    /// <summary>
    /// Response Unmarshaller for DatabaseStandbySummary Object
    /// </summary>  
    public class DatabaseStandbySummaryUnmarshaller : IJsonUnmarshaller<DatabaseStandbySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatabaseStandbySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DatabaseStandbySummary unmarshalledObject = new DatabaseStandbySummary();
            ...
            {
                if (context.TestExpression("availabilityDomain", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AvailabilityDomain = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("lagTimeInSeconds", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.LagTimeInSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DatabaseStandbySummaryUnmarshaller _instance = new DatabaseStandbySummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DatabaseStandbySummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
