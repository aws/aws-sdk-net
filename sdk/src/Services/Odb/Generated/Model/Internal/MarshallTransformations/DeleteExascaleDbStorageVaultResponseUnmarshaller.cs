...
{
    /// <summary>
    /// Response Unmarshaller for DeleteExascaleDbStorageVault operation
    /// </summary>  
    public class DeleteExascaleDbStorageVaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteExascaleDbStorageVaultResponse response = new DeleteExascaleDbStorageVaultResponse();
        ...
        private static DeleteExascaleDbStorageVaultResponseUnmarshaller _instance = new DeleteExascaleDbStorageVaultResponseUnmarshaller();        

        internal static DeleteExascaleDbStorageVaultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExascaleDbStorageVaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
