...
namespace Amazon.Odb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutonomousVirtualMachineSummaryUnmarshaller : IUnmarshaller<AutonomousVirtualMachineSummary, XmlUnmarshallerContext>, IUnmarshaller<AutonomousVirtualMachineSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutonomousVirtualMachineSummary IUnmarshaller<AutonomousVirtualMachineSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AutonomousVirtualMachineSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("autonomousVirtualMachineId", targetDepth))
                {
                    ...
                    unmarshalledObject.AutonomousVirtualMachineId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("clientIpAddress", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ClientIpAddress = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DbServerDisplayName = unmarshaller.Unmarshall(context);
                    continue;
                }
