...
{
    /// <summary>
    /// Response Unmarshaller for AssociateVirtualMachinesToExadbVmCluster operation
    /// </summary>  
    public class AssociateVirtualMachinesToExadbVmClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateVirtualMachinesToExadbVmClusterResponse response = new AssociateVirtualMachinesToExadbVmClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExadbVmClusterId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static AssociateVirtualMachinesToExadbVmClusterResponseUnmarshaller _instance = new AssociateVirtualMachinesToExadbVmClusterResponseUnmarshaller();        

        internal static AssociateVirtualMachinesToExadbVmClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateVirtualMachinesToExadbVmClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
