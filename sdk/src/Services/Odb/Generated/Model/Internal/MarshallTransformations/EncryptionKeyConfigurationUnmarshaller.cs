...
{
    /// <summary>
    /// Response Unmarshaller for EncryptionKeyConfiguration Object
    /// </summary>  
    public class EncryptionKeyConfigurationUnmarshaller : IJsonUnmarshaller<EncryptionKeyConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EncryptionKeyConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EncryptionKeyConfiguration unmarshalledObject = new EncryptionKeyConfiguration();
        ...
        private static EncryptionKeyConfigurationUnmarshaller _instance = new EncryptionKeyConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EncryptionKeyConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
