...
{
    /// <summary>
    /// Response Unmarshaller for UpdateExadbVmCluster operation
    /// </summary>  
    public class UpdateExadbVmClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExadbVmClusterResponse response = new UpdateExadbVmClusterResponse();
        ...
        private static UpdateExadbVmClusterResponseUnmarshaller _instance = new UpdateExadbVmClusterResponseUnmarshaller();        

        internal static UpdateExadbVmClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExadbVmClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
