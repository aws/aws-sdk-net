...
namespace Amazon.Odb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DbNodeUnmarshaller : IUnmarshaller<DbNode, XmlUnmarshallerContext>, IUnmarshaller<DbNode, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DbNode IUnmarshaller<DbNode, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DbNode Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.BackupIpId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("backupVnic2Id", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.BackupVnic2Id = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("backupVnicId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.BackupVnicId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DbNodeArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("dbNodeId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DbNodeId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FaultDomain = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("floatingIpAddress", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FloatingIpAddress = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("hostIpId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HostIpId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MaintenanceType = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.SoftwareStorageSizeInGB = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TimeMaintenanceWindowEnd = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("timeMaintenanceWindowStart", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TimeMaintenanceWindowStart = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("totalCpuCoreCount", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.TotalCpuCoreCount = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("vnic2Id", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Vnic2Id = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("vnicId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VnicId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
