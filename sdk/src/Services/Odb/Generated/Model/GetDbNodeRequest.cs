...
namespace Amazon.Odb.Model
{
    ...
    public partial class GetDbNodeRequest : AmazonOdbRequest
    {
        ...
        /// <para>
        /// The unique identifier of the VM cluster that contains the DB node. You must specify
        /// either this parameter or <c>exadbVmClusterId</c>.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The unique identifier of the Exascale VM cluster that contains the DB node. You must
        /// specify either this parameter or <c>cloudVmClusterId</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Min=6, Max=64)]
