...
{
    /// <summary>
    /// Container for the parameters to the ListFlexComponents operation.
    /// Returns information about the flex components that are available for an Exadata infrastructure.
    /// </summary>
    public partial class ListFlexComponentsRequest : AmazonOdbRequest
    {
        ...
        /// <para>
        /// The shape to return flex components for. For a list of valid shapes, use the <c>ListDbSystemShapes</c>
        /// operation.
        /// </para>
        /// </summary>
