...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackageDescriptionUnmarshaller : IJsonUnmarshaller<PackageDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackageDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("originConfiguration", targetDepth, ref reader))
                {
