...
{
    /// <summary>
    /// Response Unmarshaller for GetPackageVersionReadme operation
    /// </summary>  
    public class GetPackageVersionReadmeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPackageVersionReadmeResponse response = new GetPackageVersionReadmeResponse();
        ...
        private static GetPackageVersionReadmeResponseUnmarshaller _instance = new GetPackageVersionReadmeResponseUnmarshaller();        

        internal static GetPackageVersionReadmeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPackageVersionReadmeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
