...
{
    /// <summary>
    /// Response Unmarshaller for AssociateExternalConnection operation
    /// </summary>  
    public class AssociateExternalConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateExternalConnectionResponse response = new AssociateExternalConnectionResponse();
        ...
        private static AssociateExternalConnectionResponseUnmarshaller _instance = new AssociateExternalConnectionResponseUnmarshaller();        

        internal static AssociateExternalConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateExternalConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
