...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    public class DisassociateExternalConnectionRequestMarshaller : IMarshaller<IRequest, DisassociateExternalConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DisassociateExternalConnectionRequest publicRequest)
        {
            ...
            if (string.IsNullOrEmpty(publicRequest.ExternalConnection))
                throw new AmazonCodeArtifactException("Request object does not have required field ExternalConnection set");
