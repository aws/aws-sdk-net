...
{
    /// <summary>
    /// ListPackageVersionDependencies Request Marshaller
    /// </summary>       
    public class ListPackageVersionDependenciesRequestMarshaller : IMarshaller<IRequest, ListPackageVersionDependenciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPackageVersionDependenciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPackageVersionDependenciesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/package/version/dependencies";
            request.UseQueryString = true;

            return request;
        }
        private static ListPackageVersionDependenciesRequestMarshaller _instance = new ListPackageVersionDependenciesRequestMarshaller();        

        internal static ListPackageVersionDependenciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPackageVersionDependenciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
