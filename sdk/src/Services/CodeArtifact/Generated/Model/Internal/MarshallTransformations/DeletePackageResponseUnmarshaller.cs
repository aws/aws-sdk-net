...
{
    /// <summary>
    /// Response Unmarshaller for DeletePackage operation
    /// </summary>  
    public class DeletePackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("deletedPackage", targetDepth))
                {
                    ...
                    response.DeletedPackage = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DeletePackageResponseUnmarshaller _instance = new DeletePackageResponseUnmarshaller();        

        internal static DeletePackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
