...
{
    /// <summary>
    /// GetPackageVersionReadme Request Marshaller
    /// </summary>       
    public class GetPackageVersionReadmeRequestMarshaller : IMarshaller<IRequest, GetPackageVersionReadmeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPackageVersionReadmeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPackageVersionReadmeRequest publicRequest)
        {
        ...
        private static GetPackageVersionReadmeRequestMarshaller _instance = new GetPackageVersionReadmeRequestMarshaller();        

        internal static GetPackageVersionReadmeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPackageVersionReadmeRequestMarshaller Instance
        {
            get
            {
                return _instance;
