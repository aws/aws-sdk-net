...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRepositoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListRepositoriesResponseUnmarshaller _instance = new ListRepositoriesResponseUnmarshaller();        

        internal static ListRepositoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRepositoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
