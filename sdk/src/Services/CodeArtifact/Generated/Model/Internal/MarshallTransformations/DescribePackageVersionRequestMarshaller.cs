...
{
    /// <summary>
    /// DescribePackageVersion Request Marshaller
    /// </summary>       
    public class DescribePackageVersionRequestMarshaller : IMarshaller<IRequest, DescribePackageVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribePackageVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribePackageVersionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/package/version";
            request.UseQueryString = true;

            return request;
        }
        private static DescribePackageVersionRequestMarshaller _instance = new DescribePackageVersionRequestMarshaller();        

        internal static DescribePackageVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePackageVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
