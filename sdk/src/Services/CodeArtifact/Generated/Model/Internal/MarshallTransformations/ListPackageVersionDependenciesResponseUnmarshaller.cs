...
{
    /// <summary>
    /// Response Unmarshaller for ListPackageVersionDependencies operation
    /// </summary>  
    public class ListPackageVersionDependenciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPackageVersionDependenciesResponse response = new ListPackageVersionDependenciesResponse();
            ...
            {
                if (context.TestExpression("dependencies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PackageDependency, PackageDependencyUnmarshaller>(PackageDependencyUnmarshaller.Instance);
                    response.Dependencies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("versionRevision", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VersionRevision = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListPackageVersionDependenciesResponseUnmarshaller _instance = new ListPackageVersionDependenciesResponseUnmarshaller();        

        internal static ListPackageVersionDependenciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPackageVersionDependenciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
