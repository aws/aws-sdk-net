...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePackageGroup operation
    /// </summary>  
    public class UpdatePackageGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePackageGroupResponse response = new UpdatePackageGroupResponse();
        ...
        private static UpdatePackageGroupResponseUnmarshaller _instance = new UpdatePackageGroupResponseUnmarshaller();        

        internal static UpdatePackageGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePackageGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
