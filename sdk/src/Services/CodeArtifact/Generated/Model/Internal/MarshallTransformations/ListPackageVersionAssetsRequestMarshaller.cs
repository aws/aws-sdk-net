...
{
    /// <summary>
    /// ListPackageVersionAssets Request Marshaller
    /// </summary>       
    public class ListPackageVersionAssetsRequestMarshaller : IMarshaller<IRequest, ListPackageVersionAssetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPackageVersionAssetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPackageVersionAssetsRequest publicRequest)
        {
        ...
        private static ListPackageVersionAssetsRequestMarshaller _instance = new ListPackageVersionAssetsRequestMarshaller();        

        internal static ListPackageVersionAssetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPackageVersionAssetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
