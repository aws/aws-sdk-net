...
namespace Amazon.CodeArtifact
{
    ...
    public partial interface IAmazonCodeArtifact : IAmazonService, IDisposable
    {
        ...
        Task<PublishPackageVersionResponse> PublishPackageVersionAsync(PublishPackageVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCodeArtifactConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCodeArtifactConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCodeArtifactConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCodeArtifactConfig to create AmazonCodeArtifactClient");
            }

            return awsCredentials == null ? 
                    new AmazonCodeArtifactClient(serviceClientConfig) :
                    new AmazonCodeArtifactClient(awsCredentials, serviceClientConfig);
        }
