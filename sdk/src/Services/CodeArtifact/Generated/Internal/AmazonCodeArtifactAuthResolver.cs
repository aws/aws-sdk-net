...
namespace Amazon.CodeArtifact.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonCodeArtifactAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeArtifactAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeArtifact.
        /// </summary>
        public AmazonCodeArtifactAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeArtifactAuthSchemeParameters
            {
    ...
    public class AmazonCodeArtifactAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeArtifactAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeArtifactAuthSchemeParameters authParameters)
        {
