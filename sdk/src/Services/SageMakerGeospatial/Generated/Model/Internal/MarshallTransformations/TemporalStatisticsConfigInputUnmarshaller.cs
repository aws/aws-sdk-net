...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TemporalStatisticsConfigInputUnmarshaller : IUnmarshaller<TemporalStatisticsConfigInput, XmlUnmarshallerContext>, IUnmarshaller<TemporalStatisticsConfigInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TemporalStatisticsConfigInput IUnmarshaller<TemporalStatisticsConfigInput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TemporalStatisticsConfigInput Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
