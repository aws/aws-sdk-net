...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetRepositoryPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetRepositoryPolicyResponse response = new SetRepositoryPolicyResponse();
        ...
        private static SetRepositoryPolicyResponseUnmarshaller _instance = new SetRepositoryPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetRepositoryPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
