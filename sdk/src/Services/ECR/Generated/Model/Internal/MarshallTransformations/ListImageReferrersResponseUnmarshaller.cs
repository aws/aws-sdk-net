...
{
    /// <summary>
    /// Response Unmarshaller for ListImageReferrers operation
    /// </summary>  
    public class ListImageReferrersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImageReferrersResponse response = new ListImageReferrersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImageReferrer, ImageReferrerUnmarshaller>(ImageReferrerUnmarshaller.Instance);
                    response.Referrers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListImageReferrersResponseUnmarshaller _instance = new ListImageReferrersResponseUnmarshaller();        

        internal static ListImageReferrersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImageReferrersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
