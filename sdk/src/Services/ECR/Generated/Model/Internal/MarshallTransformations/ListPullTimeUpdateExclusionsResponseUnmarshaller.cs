...
{
    /// <summary>
    /// Response Unmarshaller for ListPullTimeUpdateExclusions operation
    /// </summary>  
    public class ListPullTimeUpdateExclusionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPullTimeUpdateExclusionsResponse response = new ListPullTimeUpdateExclusionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("pullTimeUpdateExclusions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.PullTimeUpdateExclusions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListPullTimeUpdateExclusionsResponseUnmarshaller _instance = new ListPullTimeUpdateExclusionsResponseUnmarshaller();        

        internal static ListPullTimeUpdateExclusionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPullTimeUpdateExclusionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
