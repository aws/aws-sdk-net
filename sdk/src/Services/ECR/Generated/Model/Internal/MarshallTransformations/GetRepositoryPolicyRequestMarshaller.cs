...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetRepositoryPolicyRequestMarshaller : IMarshaller<IRequest, GetRepositoryPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRepositoryPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRepositoryPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.GetRepositoryPolicy";
        ...
        private static GetRepositoryPolicyRequestMarshaller _instance = new GetRepositoryPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRepositoryPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
