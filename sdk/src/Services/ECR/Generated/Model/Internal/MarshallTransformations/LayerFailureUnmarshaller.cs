...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LayerFailureUnmarshaller : IUnmarshaller<LayerFailure, XmlUnmarshallerContext>, IUnmarshaller<LayerFailure, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LayerFailure IUnmarshaller<LayerFailure, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
