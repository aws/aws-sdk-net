...
{
    /// <summary>
    /// Response Unmarshaller for PutSigningConfiguration operation
    /// </summary>  
    public class PutSigningConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSigningConfigurationResponse response = new PutSigningConfigurationResponse();
        ...
        private static PutSigningConfigurationResponseUnmarshaller _instance = new PutSigningConfigurationResponseUnmarshaller();        

        internal static PutSigningConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSigningConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
