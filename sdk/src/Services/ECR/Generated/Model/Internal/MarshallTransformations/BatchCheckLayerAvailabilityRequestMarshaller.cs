...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchCheckLayerAvailabilityRequestMarshaller : IMarshaller<IRequest, BatchCheckLayerAvailabilityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchCheckLayerAvailabilityRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchCheckLayerAvailabilityRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.BatchCheckLayerAvailability";
            ...
            if(publicRequest.IsSetLayerDigests())
            {
                context.Writer.WritePropertyName("layerDigests");
                context.Writer.WriteStartArray();
                foreach(var publicRequestLayerDigestsListValue in publicRequest.LayerDigests)
                {
                        context.Writer.WriteStringValue(publicRequestLayerDigestsListValue);
                }
