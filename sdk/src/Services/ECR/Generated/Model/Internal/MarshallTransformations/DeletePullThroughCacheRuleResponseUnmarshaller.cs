...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeletePullThroughCacheRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePullThroughCacheRuleResponse response = new DeletePullThroughCacheRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UpstreamRegistryUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeletePullThroughCacheRuleResponseUnmarshaller _instance = new DeletePullThroughCacheRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePullThroughCacheRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
