...
{
    /// <summary>
    /// Response Unmarshaller for GetSigningConfiguration operation
    /// </summary>  
    public class GetSigningConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSigningConfigurationResponse response = new GetSigningConfigurationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SigningConfigurationNotFoundException"))
                {
                    return SigningConfigurationNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetSigningConfigurationResponseUnmarshaller _instance = new GetSigningConfigurationResponseUnmarshaller();        

        internal static GetSigningConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSigningConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
