    ...
    public class BatchGetRepositoryScanningConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RepositoryScanningConfigurationFailure, RepositoryScanningConfigurationFailureUnmarshaller>(RepositoryScanningConfigurationFailureUnmarshaller.Instance);
                    response.Failures = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("scanningConfigurations", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<RepositoryScanningConfiguration, RepositoryScanningConfigurationUnmarshaller>(RepositoryScanningConfigurationUnmarshaller.Instance);
                    response.ScanningConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
