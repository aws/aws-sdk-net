    ...
    public class AwsEcrContainerImageDetailsUnmarshaller : IUnmarshaller<AwsEcrContainerImageDetails, XmlUnmarshallerContext>, IUnmarshaller<AwsEcrContainerImageDetails, JsonUnmarshallerContext>
    {
        ...
        public AwsEcrContainerImageDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ImageHash = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("pushedAt", targetDepth))
                {
                    ...
                    unmarshalledObject.PushedAt = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("registry", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Registry = unmarshaller.Unmarshall(context);
                    continue;
                }
