    ...
    public class BatchDeleteImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImageFailure, ImageFailureUnmarshaller>(ImageFailureUnmarshaller.Instance);
                    response.Failures = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("imageIds", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ImageIdentifier, ImageIdentifierUnmarshaller>(ImageIdentifierUnmarshaller.Instance);
                    response.ImageIds = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
