...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetDownloadUrlForLayerRequestMarshaller : IMarshaller<IRequest, GetDownloadUrlForLayerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDownloadUrlForLayerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDownloadUrlForLayerRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetLayerDigest())
            {
                context.Writer.WritePropertyName("layerDigest");
                context.Writer.WriteStringValue(publicRequest.LayerDigest);
            }
