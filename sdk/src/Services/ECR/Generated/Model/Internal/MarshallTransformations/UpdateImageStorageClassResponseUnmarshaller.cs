...
{
    /// <summary>
    /// Response Unmarshaller for UpdateImageStorageClass operation
    /// </summary>  
    public class UpdateImageStorageClassResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateImageStorageClassResponse response = new UpdateImageStorageClassResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ImageStorageClassUpdateNotSupportedException"))
                {
                    return ImageStorageClassUpdateNotSupportedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateImageStorageClassResponseUnmarshaller _instance = new UpdateImageStorageClassResponseUnmarshaller();        

        internal static UpdateImageStorageClassResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateImageStorageClassResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
