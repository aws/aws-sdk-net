...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageFailureUnmarshaller : IUnmarshaller<ImageFailure, XmlUnmarshallerContext>, IUnmarshaller<ImageFailure, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ImageFailure IUnmarshaller<ImageFailure, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static ImageFailureUnmarshaller _instance = new ImageFailureUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ImageFailureUnmarshaller Instance
        {
            get
            {
                return _instance;
