...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageFailureUnmarshaller : IJsonUnmarshaller<ImageFailure, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImageFailure Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
