...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SigningRuleUnmarshaller : IJsonUnmarshaller<SigningRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SigningRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SigningRepositoryFilter, SigningRepositoryFilterUnmarshaller>(SigningRepositoryFilterUnmarshaller.Instance);
