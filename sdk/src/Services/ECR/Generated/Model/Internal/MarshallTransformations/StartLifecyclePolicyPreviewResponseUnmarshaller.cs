...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartLifecyclePolicyPreviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartLifecyclePolicyPreviewResponse response = new StartLifecyclePolicyPreviewResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("LifecyclePolicyPreviewInProgressException"))
            {
                return new LifecyclePolicyPreviewInProgressException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static StartLifecyclePolicyPreviewResponseUnmarshaller _instance = new StartLifecyclePolicyPreviewResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartLifecyclePolicyPreviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
