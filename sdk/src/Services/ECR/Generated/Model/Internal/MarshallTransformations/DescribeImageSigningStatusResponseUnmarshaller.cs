    ...
    public class DescribeImageSigningStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImageSigningStatus, ImageSigningStatusUnmarshaller>(ImageSigningStatusUnmarshaller.Instance);
                    response.SigningStatuses = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
