...
{
    /// <summary>
    /// Response Unmarshaller for DescribeImageSigningStatus operation
    /// </summary>  
    public class DescribeImageSigningStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeImageSigningStatusResponse response = new DescribeImageSigningStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("signingStatuses", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ImageSigningStatus, ImageSigningStatusUnmarshaller>(ImageSigningStatusUnmarshaller.Instance);
                    response.SigningStatuses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeImageSigningStatusResponseUnmarshaller _instance = new DescribeImageSigningStatusResponseUnmarshaller();        

        internal static DescribeImageSigningStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImageSigningStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
