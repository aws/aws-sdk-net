    ...
    public class DescribePullThroughCacheRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PullThroughCacheRule, PullThroughCacheRuleUnmarshaller>(PullThroughCacheRuleUnmarshaller.Instance);
                    response.PullThroughCacheRules = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
