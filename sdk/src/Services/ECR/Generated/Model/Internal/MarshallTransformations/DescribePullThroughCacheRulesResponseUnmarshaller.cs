...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribePullThroughCacheRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePullThroughCacheRulesResponse response = new DescribePullThroughCacheRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("pullThroughCacheRules", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PullThroughCacheRule, PullThroughCacheRuleUnmarshaller>(PullThroughCacheRuleUnmarshaller.Instance);
                    response.PullThroughCacheRules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return PullThroughCacheRuleNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DescribePullThroughCacheRulesResponseUnmarshaller _instance = new DescribePullThroughCacheRulesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePullThroughCacheRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
