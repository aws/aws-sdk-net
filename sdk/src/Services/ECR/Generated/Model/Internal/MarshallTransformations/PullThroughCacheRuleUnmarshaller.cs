...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PullThroughCacheRuleUnmarshaller : IJsonUnmarshaller<PullThroughCacheRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PullThroughCacheRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("upstreamRegistry", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpstreamRegistry = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
