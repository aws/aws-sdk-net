...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PullThroughCacheRuleUnmarshaller : IUnmarshaller<PullThroughCacheRule, XmlUnmarshallerContext>, IUnmarshaller<PullThroughCacheRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PullThroughCacheRule IUnmarshaller<PullThroughCacheRule, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PullThroughCacheRule Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EcrRepositoryPrefix = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpstreamRegistry = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("upstreamRegistryUrl", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpstreamRegistryUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("upstreamRepositoryPrefix", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpstreamRepositoryPrefix = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static PullThroughCacheRuleUnmarshaller _instance = new PullThroughCacheRuleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PullThroughCacheRuleUnmarshaller Instance
        {
            get
            {
                return _instance;
