...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeImageReplicationStatusRequestMarshaller : IMarshaller<IRequest, DescribeImageReplicationStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeImageReplicationStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeImageReplicationStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.DescribeImageReplicationStatus";
        ...
        private static DescribeImageReplicationStatusRequestMarshaller _instance = new DescribeImageReplicationStatusRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImageReplicationStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
