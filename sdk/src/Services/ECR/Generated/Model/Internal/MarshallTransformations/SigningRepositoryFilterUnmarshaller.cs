...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SigningRepositoryFilterUnmarshaller : IJsonUnmarshaller<SigningRepositoryFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SigningRepositoryFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
