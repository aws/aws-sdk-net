...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartImageScanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartImageScanResponse response = new StartImageScanResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("imageScanStatus", targetDepth, ref reader))
                {
                    var unmarshaller = ImageScanStatusUnmarshaller.Instance;
                    response.ImageScanStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ImageArchivedException"))
                {
                    return ImageArchivedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ImageNotFoundException"))
                {
                    return ImageNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedImageTypeException"))
                {
                    return UnsupportedImageTypeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartImageScanResponseUnmarshaller _instance = new StartImageScanResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartImageScanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
