...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageReferrerUnmarshaller : IJsonUnmarshaller<ImageReferrer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImageReferrer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("artifactStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ArtifactStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
