...
{
    /// <summary>
    /// Container for the parameters to the ListPullTimeUpdateExclusions operation.
    /// Lists the IAM principals that are excluded from having their image pull times recorded.
    /// </summary>
    public partial class ListPullTimeUpdateExclusionsRequest : AmazonECRRequest
    {
        ...
        /// <para>
        /// The maximum number of pull time update exclusion results returned by <c>ListPullTimeUpdateExclusions</c>
        ...
        /// <para>
        /// The <c>nextToken</c> value returned from a previous paginated <c>ListPullTimeUpdateExclusions</c>
