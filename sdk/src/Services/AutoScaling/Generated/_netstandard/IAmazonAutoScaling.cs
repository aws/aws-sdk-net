...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAutoScalingConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAutoScalingConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAutoScalingConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAutoScalingConfig to create AmazonAutoScalingClient");
            }

            return awsCredentials == null ? 
                    new AmazonAutoScalingClient(serviceClientConfig) :
                    new AmazonAutoScalingClient(awsCredentials, serviceClientConfig);
        }
