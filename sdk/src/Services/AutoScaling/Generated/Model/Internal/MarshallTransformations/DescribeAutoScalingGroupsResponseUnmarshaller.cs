...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAutoScalingGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AutoScalingGroups/member", targetDepth))
                    {
                        ...
                        {
                            response.AutoScalingGroups = new List<AutoScalingGroup>();
                        }
        ...
        private static DescribeAutoScalingGroupsResponseUnmarshaller _instance = new DescribeAutoScalingGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAutoScalingGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
