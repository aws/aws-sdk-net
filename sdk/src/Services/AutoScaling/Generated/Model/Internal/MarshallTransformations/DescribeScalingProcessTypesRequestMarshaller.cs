    ...
    public class DescribeScalingProcessTypesRequestMarshaller : IMarshaller<IRequest, DescribeScalingProcessTypesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeScalingProcessTypesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeScalingProcessTypesRequestMarshaller _instance = new DescribeScalingProcessTypesRequestMarshaller();        

        internal static DescribeScalingProcessTypesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeScalingProcessTypesRequestMarshaller Instance
        {
            get
            {
                return _instance;
