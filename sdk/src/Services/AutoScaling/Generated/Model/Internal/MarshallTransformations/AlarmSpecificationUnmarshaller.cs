...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    public class AlarmSpecificationUnmarshaller : IXmlUnmarshaller<AlarmSpecification, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AlarmSpecification Unmarshall(XmlUnmarshallerContext context)
        {
            AlarmSpecification unmarshalledObject = new AlarmSpecification();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("Alarms/member", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Alarms = new List<string>();
                        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AlarmSpecificationUnmarshaller Instance
        {
            get
            {
                return _instance;
