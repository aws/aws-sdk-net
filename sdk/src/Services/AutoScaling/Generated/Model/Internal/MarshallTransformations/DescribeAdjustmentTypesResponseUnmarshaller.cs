...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAdjustmentTypesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AdjustmentTypes/member", targetDepth))
                    {
                        ...
                        if (response.AdjustmentTypes == null)
                        {
                            response.AdjustmentTypes = new List<AdjustmentType>();
                        }
        ...
        private static DescribeAdjustmentTypesResponseUnmarshaller _instance = new DescribeAdjustmentTypesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAdjustmentTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
