...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribePoliciesRequestMarshaller : IMarshaller<IRequest, DescribePoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribePoliciesRequest)input);
        }
        ...
        public IRequest Marshall(DescribePoliciesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribePoliciesRequestMarshaller _instance = new DescribePoliciesRequestMarshaller();        

        internal static DescribePoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
