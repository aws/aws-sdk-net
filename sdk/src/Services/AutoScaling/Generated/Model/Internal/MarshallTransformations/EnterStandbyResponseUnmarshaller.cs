...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnterStandbyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnterStandbyResponse response = new EnterStandbyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnterStandbyResult", 2))
                    {
        ...
        private static EnterStandbyResponseUnmarshaller _instance = new EnterStandbyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnterStandbyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
