...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeLifecycleHookTypesResponseUnmarshaller : XmlResponseUnmarshaller
    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("LifecycleHookTypes/member", targetDepth))
                    {
                        ...
                        if (response.LifecycleHookTypes == null)
                        {
                            response.LifecycleHookTypes = new List<string>();
                        }
                        var item = unmarshaller.Unmarshall(context);
                        response.LifecycleHookTypes.Add(item);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeLifecycleHookTypesResponseUnmarshaller _instance = new DescribeLifecycleHookTypesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLifecycleHookTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
