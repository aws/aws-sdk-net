...
namespace Amazon.AutoScaling.Model
{
    ...
    public partial class IrreversibleInstanceRefreshException : AmazonAutoScalingException
    {
        ...
        public IrreversibleInstanceRefreshException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IrreversibleInstanceRefreshException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
