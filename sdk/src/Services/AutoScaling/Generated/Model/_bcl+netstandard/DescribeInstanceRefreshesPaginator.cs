...
namespace Amazon.AutoScaling.Model
{
    ...
    internal sealed partial class DescribeInstanceRefreshesPaginator : IPaginator<DescribeInstanceRefreshesResponse>, IDescribeInstanceRefreshesPaginator
    {
        ...
        async IAsyncEnumerable<DescribeInstanceRefreshesResponse> IPaginator<DescribeInstanceRefreshesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
