...
namespace Amazon.AutoScaling.Model
{
    ...
    internal sealed partial class DescribeScalingActivitiesPaginator : IPaginator<DescribeScalingActivitiesResponse>, IDescribeScalingActivitiesPaginator
    {
        ...
        public IPaginatedEnumerable<Activity> Activities => 
            new PaginatedResultKeyResponse<DescribeScalingActivitiesResponse, Activity>(this, (i) => i.Activities ?? new List<Activity>());
        ...
        async IAsyncEnumerable<DescribeScalingActivitiesResponse> IPaginator<DescribeScalingActivitiesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
