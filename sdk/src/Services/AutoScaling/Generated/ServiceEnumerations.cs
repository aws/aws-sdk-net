...
namespace Amazon.AutoScaling
{
    ...
    public class DeletionProtection : ConstantClass
    {
        ...
        /// <summary>
        /// Constant None for DeletionProtection
        /// </summary>
        public static readonly DeletionProtection None = new DeletionProtection("none");
        /// <summary>
        /// Constant PreventAllDeletion for DeletionProtection
        /// </summary>
        public static readonly DeletionProtection PreventAllDeletion = new DeletionProtection("prevent-all-deletion");
        /// <summary>
        /// Constant PreventForceDeletion for DeletionProtection
        /// </summary>
        public static readonly DeletionProtection PreventForceDeletion = new DeletionProtection("prevent-force-deletion");
    ...
    /// <summary>
    /// Constants used for properties of type TargetCapacityType.
    /// </summary>
    public class TargetCapacityType : ConstantClass
    {

        /// <summary>
        /// Constant CapacityBlock for TargetCapacityType
        /// </summary>
        public static readonly TargetCapacityType CapacityBlock = new TargetCapacityType("capacity-block");
        /// <summary>
        /// Constant InterruptibleCapacityReservation for TargetCapacityType
        /// </summary>
        public static readonly TargetCapacityType InterruptibleCapacityReservation = new TargetCapacityType("interruptible-capacity-reservation");
        /// <summary>
        /// Constant OnDemand for TargetCapacityType
        /// </summary>
        public static readonly TargetCapacityType OnDemand = new TargetCapacityType("on-demand");
        /// <summary>
        /// Constant OnDemandCapacityReservation for TargetCapacityType
        /// </summary>
        public static readonly TargetCapacityType OnDemandCapacityReservation = new TargetCapacityType("on-demand-capacity-reservation");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public TargetCapacityType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static TargetCapacityType FindValue(string value)
        {
            return FindValue<TargetCapacityType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator TargetCapacityType(string value)
        {
            return FindValue(value);
        }
    }
