...
namespace Amazon.AutoScaling.Internal
{
    ...
    public class AutoScalingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IRequestContext requestContext)
        {
            ...
            return authResolver.ResolveAuthScheme(mappedParameters);
        }
    }

    public class AutoScalingAuthSchemeResolver : IAuthSchemeResolver<AutoScalingAuthSchemeParameters>
    {
