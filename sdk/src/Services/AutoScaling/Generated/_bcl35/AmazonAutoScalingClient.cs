...
namespace Amazon.AutoScaling
{
    ...
    public partial class AmazonAutoScalingClient : AmazonServiceClient, IAmazonAutoScaling
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/LaunchInstances">REST API Reference for LaunchInstances Operation</seealso>
        public virtual IAsyncResult BeginLaunchInstances(LaunchInstancesRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = LaunchInstancesRequestMarshaller.Instance;
            options.ResponseUnmarshaller = LaunchInstancesResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/LaunchInstances">REST API Reference for LaunchInstances Operation</seealso>
        public virtual LaunchInstancesResponse EndLaunchInstances(IAsyncResult asyncResult)
        {
            return EndInvoke<LaunchInstancesResponse>(asyncResult);
        }
