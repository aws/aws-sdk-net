...
{
    /// <summary>
    /// Contains configuration and status information for an Amazon Redshift Query Editor
    /// (QEV2) application that is registered with IAM Identity Center.
    /// </summary>
    public partial class Qev2IdcApplication
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) for the IAM Identity Center instance that the Amazon
        /// Redshift Query Editor (QEV2) application integrates with.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) for the Amazon Redshift Query Editor (QEV2) IAM Identity
        ...
        /// <para>
        /// The onboarding status for the Amazon Redshift Query Editor (QEV2) IAM Identity Center
        /// application.
        /// </para>
        /// </summary>
        [AWSProperty(Max=2147483647)]
        ...
        /// <para>
        /// A list of tags associated with the application. Tags are key-value pairs that you
