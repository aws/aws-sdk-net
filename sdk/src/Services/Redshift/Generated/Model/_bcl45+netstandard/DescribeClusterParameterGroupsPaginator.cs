...
namespace Amazon.Redshift.Model
{
    ...
    internal sealed partial class DescribeClusterParameterGroupsPaginator : IPaginator<DescribeClusterParameterGroupsResponse>, IDescribeClusterParameterGroupsPaginator
    {
        ...
        public IPaginatedEnumerable<ClusterParameterGroup> ParameterGroups => 
            new PaginatedResultKeyResponse<DescribeClusterParameterGroupsResponse, ClusterParameterGroup>(this, (i) => i.ParameterGroups ?? new List<ClusterParameterGroup>());
        ...
        async IAsyncEnumerable<DescribeClusterParameterGroupsResponse> IPaginator<DescribeClusterParameterGroupsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
