...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class AuthorizedTokenIssuerUnmarshaller : IXmlUnmarshaller<AuthorizedTokenIssuer, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AuthorizedTokenIssuer Unmarshall(XmlUnmarshallerContext context)
        {
            AuthorizedTokenIssuer unmarshalledObject = new AuthorizedTokenIssuer();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.TrustedTokenIssuerArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AuthorizedTokenIssuerUnmarshaller Instance
        {
            get
            {
                return _instance;
