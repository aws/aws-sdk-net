...
{
    /// <summary>
    /// Response Unmarshaller for DescribeStorage operation
    /// </summary>  
    public class DescribeStorageResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeStorageResponse response = new DescribeStorageResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeStorageResult", 2))
                    {
        ...
        private static DescribeStorageResponseUnmarshaller _instance = new DescribeStorageResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStorageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
