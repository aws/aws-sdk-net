...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class MaintenanceTrackUnmarshaller : IXmlUnmarshaller<MaintenanceTrack, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public MaintenanceTrack Unmarshall(XmlUnmarshallerContext context)
        {
            MaintenanceTrack unmarshalledObject = new MaintenanceTrack();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = UpdateTargetUnmarshaller.Instance;
                        if (unmarshalledObject.UpdateTargets == null)
                        {
                            unmarshalledObject.UpdateTargets = new List<UpdateTarget>();
                        }
                        var item = unmarshaller.Unmarshall(context);
                        unmarshalledObject.UpdateTargets.Add(item);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MaintenanceTrackUnmarshaller Instance
        {
            get
            {
                return _instance;
