...
{
    /// <summary>
    /// RegisterNamespace Request Marshaller
    /// </summary>       
    public class RegisterNamespaceRequestMarshaller : IMarshaller<IRequest, RegisterNamespaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RegisterNamespaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RegisterNamespaceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "RegisterNamespace");
        ...
        internal static RegisterNamespaceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterNamespaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
