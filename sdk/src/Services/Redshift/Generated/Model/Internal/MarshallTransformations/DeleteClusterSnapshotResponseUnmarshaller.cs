...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteClusterSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteClusterSnapshotResponse response = new DeleteClusterSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteClusterSnapshotResult", 2))
                    {
        ...
        private static DeleteClusterSnapshotResponseUnmarshaller _instance = new DeleteClusterSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteClusterSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
