...
{
    /// <summary>
    /// Response Unmarshaller for GetReservedNodeExchangeOfferings operation
    /// </summary>  
    public class GetReservedNodeExchangeOfferingsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetReservedNodeExchangeOfferingsResponse response = new GetReservedNodeExchangeOfferingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetReservedNodeExchangeOfferingsResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new InvalidReservedNodeStateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("ReservedNodeAlreadyMigrated"))
            {
                return new ReservedNodeAlreadyMigratedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static GetReservedNodeExchangeOfferingsResponseUnmarshaller _instance = new GetReservedNodeExchangeOfferingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReservedNodeExchangeOfferingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
