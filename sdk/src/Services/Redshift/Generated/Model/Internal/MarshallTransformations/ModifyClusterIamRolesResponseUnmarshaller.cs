...
{
    /// <summary>
    /// Response Unmarshaller for ModifyClusterIamRoles operation
    /// </summary>  
    public class ModifyClusterIamRolesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyClusterIamRolesResponse response = new ModifyClusterIamRolesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyClusterIamRolesResult", 2))
                    {
        ...
        private static ModifyClusterIamRolesResponseUnmarshaller _instance = new ModifyClusterIamRolesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyClusterIamRolesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
