...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeClustersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClustersResponse response = new DescribeClustersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeClustersResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Clusters/Cluster", targetDepth))
                    {
                        ...
                        {
                            response.Clusters = new List<Cluster>();
                        }
                        var item = unmarshaller.Unmarshall(context);
                        response.Clusters.Add(item);
                        continue;
                    }
        ...
        private static DescribeClustersResponseUnmarshaller _instance = new DescribeClustersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClustersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
