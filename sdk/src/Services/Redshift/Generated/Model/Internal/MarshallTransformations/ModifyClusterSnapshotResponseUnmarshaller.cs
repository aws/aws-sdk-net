...
{
    /// <summary>
    /// Response Unmarshaller for ModifyClusterSnapshot operation
    /// </summary>  
    public class ModifyClusterSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyClusterSnapshotResponse response = new ModifyClusterSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyClusterSnapshotResult", 2))
                    {
        ...
        private static ModifyClusterSnapshotResponseUnmarshaller _instance = new ModifyClusterSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyClusterSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
