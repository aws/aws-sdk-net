...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class PartnerIntegrationInfoUnmarshaller : IXmlUnmarshaller<PartnerIntegrationInfo, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PartnerIntegrationInfo Unmarshall(XmlUnmarshallerContext context)
        {
            PartnerIntegrationInfo unmarshalledObject = new PartnerIntegrationInfo();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PartnerIntegrationInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
