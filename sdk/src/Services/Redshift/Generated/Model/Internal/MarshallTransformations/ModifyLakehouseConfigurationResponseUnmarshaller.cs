...
{
    /// <summary>
    /// Response Unmarshaller for ModifyLakehouseConfiguration operation
    /// </summary>  
    public class ModifyLakehouseConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyLakehouseConfigurationResponse response = new ModifyLakehouseConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyLakehouseConfigurationResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ModifyLakehouseConfigurationResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("CatalogArn", targetDepth))
                    {
                        ...
                        response.CatalogArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    if (context.TestExpression("LakehouseIdcApplicationArn", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.LakehouseIdcApplicationArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("LakehouseRegistrationStatus", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.LakehouseRegistrationStatus = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyLakehouseConfigurationResponseUnmarshaller _instance = new ModifyLakehouseConfigurationResponseUnmarshaller();        

        internal static ModifyLakehouseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyLakehouseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
