...
{
    /// <summary>
    /// Response Unmarshaller for DeauthorizeDataShare operation
    /// </summary>  
    public class DeauthorizeDataShareResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeauthorizeDataShareResponse response = new DeauthorizeDataShareResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeauthorizeDataShareResult", 2))
                    {
        ...
        private static DeauthorizeDataShareResponseUnmarshaller _instance = new DeauthorizeDataShareResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeauthorizeDataShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
