...
{
    /// <summary>
    /// Response Unmarshaller for CreateSnapshotSchedule operation
    /// </summary>  
    public class CreateSnapshotScheduleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSnapshotScheduleResponse response = new CreateSnapshotScheduleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateSnapshotScheduleResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new ScheduleDefinitionTypeUnsupportedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("SnapshotScheduleAlreadyExists"))
            {
                return new SnapshotScheduleAlreadyExistsException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("SnapshotScheduleQuotaExceeded"))
            {
                return new SnapshotScheduleQuotaExceededException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static CreateSnapshotScheduleResponseUnmarshaller _instance = new CreateSnapshotScheduleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSnapshotScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
