...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class ClusterIamRoleUnmarshaller : IXmlUnmarshaller<ClusterIamRole, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ClusterIamRole Unmarshall(XmlUnmarshallerContext context)
        {
            ClusterIamRole unmarshalledObject = new ClusterIamRole();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("ApplyStatus", targetDepth))
                    {
                        ...
                        unmarshalledObject.ApplyStatus = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ClusterIamRoleUnmarshaller Instance
        {
            get
            {
                return _instance;
