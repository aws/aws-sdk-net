...
{
    /// <summary>
    /// Response Unmarshaller for ModifyClusterDbRevision operation
    /// </summary>  
    public class ModifyClusterDbRevisionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyClusterDbRevisionResponse response = new ModifyClusterDbRevisionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyClusterDbRevisionResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("ClusterOnLatestRevision"))
            {
                return new ClusterOnLatestRevisionException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static ModifyClusterDbRevisionResponseUnmarshaller _instance = new ModifyClusterDbRevisionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyClusterDbRevisionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
