...
{
    /// <summary>
    /// Response Unmarshaller for ModifyRedshiftIdcApplication operation
    /// </summary>  
    public class ModifyRedshiftIdcApplicationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyRedshiftIdcApplicationResponse response = new ModifyRedshiftIdcApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyRedshiftIdcApplicationResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ModifyRedshiftIdcApplicationResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("RedshiftIdcApplication", targetDepth))
                    {
                        var unmarshaller = RedshiftIdcApplicationUnmarshaller.Instance;
                        response.RedshiftIdcApplication = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyRedshiftIdcApplicationResponseUnmarshaller _instance = new ModifyRedshiftIdcApplicationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyRedshiftIdcApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
