...
{
    /// <summary>
    /// Response Unmarshaller for BatchModifyClusterSnapshots operation
    /// </summary>  
    public class BatchModifyClusterSnapshotsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchModifyClusterSnapshotsResponse response = new BatchModifyClusterSnapshotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("BatchModifyClusterSnapshotsResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new BatchModifyClusterSnapshotsLimitExceededException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static BatchModifyClusterSnapshotsResponseUnmarshaller _instance = new BatchModifyClusterSnapshotsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchModifyClusterSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
