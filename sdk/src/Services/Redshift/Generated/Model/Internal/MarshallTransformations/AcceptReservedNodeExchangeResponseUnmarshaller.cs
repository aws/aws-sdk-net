...
{
    /// <summary>
    /// Response Unmarshaller for AcceptReservedNodeExchange operation
    /// </summary>  
    public class AcceptReservedNodeExchangeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptReservedNodeExchangeResponse response = new AcceptReservedNodeExchangeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AcceptReservedNodeExchangeResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AcceptReservedNodeExchangeResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ExchangedReservedNode", targetDepth))
                    {
                        var unmarshaller = ReservedNodeUnmarshaller.Instance;
                        response.ExchangedReservedNode = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static AcceptReservedNodeExchangeResponseUnmarshaller _instance = new AcceptReservedNodeExchangeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptReservedNodeExchangeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
