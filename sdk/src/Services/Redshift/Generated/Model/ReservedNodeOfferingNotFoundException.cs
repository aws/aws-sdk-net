...
namespace Amazon.Redshift.Model
{
    ...
    [Serializable]
    #endif
    public partial class ReservedNodeOfferingNotFoundException : AmazonRedshiftException
    {
        ...
        public ReservedNodeOfferingNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ReservedNodeOfferingNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
