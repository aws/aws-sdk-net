...
namespace Amazon.Interconnect
{
    ...
    public partial class AmazonInterconnectConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Interconnect", "4.0.100.12");
        ...
        /// Default constructor
        /// </summary>
        public AmazonInterconnectConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonInterconnectDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Interconnect";
            this.AuthenticationServiceName = "interconnect";
            this.EndpointProvider = new AmazonInterconnectEndpointProvider();
        }
