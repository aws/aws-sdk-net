...
namespace Amazon.Interconnect.Model
{
    ...
    ///</summary>
    public class InterconnectPaginatorFactory : IInterconnectPaginatorFactory
    {
        private readonly IAmazonInterconnect client;

        internal InterconnectPaginatorFactory(IAmazonInterconnect client) 
        {
            this.client = client;
        }
        ...
        ///</summary>
        public IListAttachPointsPaginator ListAttachPoints(ListAttachPointsRequest request) 
        {
            return new ListAttachPointsPaginator(this.client, request);
        }
