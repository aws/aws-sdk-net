...
namespace Amazon.Interconnect.Model
{
    ...
    internal sealed partial class ListConnectionsPaginator : IPaginator<ListConnectionsResponse>, IListConnectionsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ConnectionSummary> Connections => 
            new PaginatedResultKeyResponse<ListConnectionsResponse, ConnectionSummary>(this, (i) => i.Connections ?? new List<ConnectionSummary>());

        internal ListConnectionsPaginator(IAmazonInterconnect client, ListConnectionsRequest request)
        {
            this._client = client;
