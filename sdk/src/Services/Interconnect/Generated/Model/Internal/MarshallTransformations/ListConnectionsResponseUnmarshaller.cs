...
namespace Amazon.Interconnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListConnectionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListConnections");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "connections":
                        {
                            context.AddPathSegment("Connections");
                            var unmarshaller = new CborListUnmarshaller<ConnectionSummary, ConnectionSummaryUnmarshaller>(ConnectionSummaryUnmarshaller.Instance);
