...
{
    /// <summary>
    /// ListAttachPoints Request Marshaller
    /// </summary>       
    public class ListAttachPointsRequestMarshaller : IMarshaller<IRequest, ListAttachPointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAttachPointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAttachPointsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Interconnect");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/Interconnect/operation/ListAttachPoints";
        ...
        private static ListAttachPointsRequestMarshaller _instance = new ListAttachPointsRequestMarshaller();        

        internal static ListAttachPointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachPointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
