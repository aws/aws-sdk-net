...
{
    /// <summary>
    /// AcceptConnectionProposal Request Marshaller
    /// </summary>       
    public class AcceptConnectionProposalRequestMarshaller : IMarshaller<IRequest, AcceptConnectionProposalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AcceptConnectionProposalRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AcceptConnectionProposalRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Interconnect");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/Interconnect/operation/AcceptConnectionProposal";
        ...
        private static AcceptConnectionProposalRequestMarshaller _instance = new AcceptConnectionProposalRequestMarshaller();        

        internal static AcceptConnectionProposalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptConnectionProposalRequestMarshaller Instance
        {
            get
            {
                return _instance;
