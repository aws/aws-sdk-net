...
namespace Amazon.Interconnect.Internal
{
    ...
    public class AmazonInterconnectAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonInterconnectAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Interconnect.
        /// </summary>
        public AmazonInterconnectAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonInterconnectAuthSchemeParameters
            {
    ...
    public class AmazonInterconnectAuthSchemeResolver : IAuthSchemeResolver<AmazonInterconnectAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonInterconnectAuthSchemeParameters authParameters)
        {
