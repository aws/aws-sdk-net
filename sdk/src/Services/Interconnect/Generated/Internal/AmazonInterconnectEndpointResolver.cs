...
using Amazon.Util;
using Amazon.Interconnect.Endpoints;

#pragma warning disable 1591

namespace Amazon.Interconnect.Internal
{
    /// <summary>
    /// Amazon Interconnect endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Interconnect service requests.
    /// Collects values for InterconnectEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses InterconnectEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonInterconnectEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonInterconnectConfig)requestContext.ClientConfig;
            var result = new InterconnectEndpointParameters();
