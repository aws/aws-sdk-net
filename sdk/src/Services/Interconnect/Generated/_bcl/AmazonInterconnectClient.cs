...
namespace Amazon.Interconnect
{
    ...
    public partial class AmazonInterconnectClient : AmazonServiceClient, IAmazonInterconnect
    {
        ...
        public virtual AcceptConnectionProposalResponse AcceptConnectionProposal(AcceptConnectionProposalRequest request)
        {
        ...
        public virtual DescribeConnectionProposalResponse DescribeConnectionProposal(DescribeConnectionProposalRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual ListAttachPointsResponse ListAttachPoints(ListAttachPointsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
