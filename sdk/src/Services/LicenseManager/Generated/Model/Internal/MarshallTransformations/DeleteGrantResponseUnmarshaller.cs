...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGrantResponse response = new DeleteGrantResponse();
        ...
        private static DeleteGrantResponseUnmarshaller _instance = new DeleteGrantResponseUnmarshaller();        

        internal static DeleteGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
