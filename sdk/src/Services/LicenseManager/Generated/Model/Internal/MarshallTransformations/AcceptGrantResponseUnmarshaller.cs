...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AcceptGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptGrantResponse response = new AcceptGrantResponse();
        ...
        private static AcceptGrantResponseUnmarshaller _instance = new AcceptGrantResponseUnmarshaller();        

        internal static AcceptGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
