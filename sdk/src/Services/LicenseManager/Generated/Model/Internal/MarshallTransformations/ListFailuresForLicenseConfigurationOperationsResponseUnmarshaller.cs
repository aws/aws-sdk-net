...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    public class ListFailuresForLicenseConfigurationOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("LicenseOperationFailureList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LicenseOperationFailure, LicenseOperationFailureUnmarshaller>(LicenseOperationFailureUnmarshaller.Instance);
                    response.LicenseOperationFailureList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
