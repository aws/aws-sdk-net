...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceRuleStatementUnmarshaller : IJsonUnmarshaller<InstanceRuleStatement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceRuleStatement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ScriptRuleStatement", targetDepth, ref reader))
                {
                    var unmarshaller = ScriptRuleStatementUnmarshaller.Instance;
                    unmarshalledObject.ScriptRuleStatement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
