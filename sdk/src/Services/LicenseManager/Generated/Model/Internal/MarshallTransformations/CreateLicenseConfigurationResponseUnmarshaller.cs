...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLicenseConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLicenseConfigurationResponse response = new CreateLicenseConfigurationResponse();
        ...
        private static CreateLicenseConfigurationResponseUnmarshaller _instance = new CreateLicenseConfigurationResponseUnmarshaller();        

        internal static CreateLicenseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLicenseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
