    ...
    public class ListLicenseConversionTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LicenseConversionTask, LicenseConversionTaskUnmarshaller>(LicenseConversionTaskUnmarshaller.Instance);
                    response.LicenseConversionTasks = unmarshaller.Unmarshall(context);
                    continue;
                }
