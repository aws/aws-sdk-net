...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLicenseConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLicenseConfigurationResponse response = new UpdateLicenseConfigurationResponse();
        ...
        private static UpdateLicenseConfigurationResponseUnmarshaller _instance = new UpdateLicenseConfigurationResponseUnmarshaller();        

        internal static UpdateLicenseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLicenseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
