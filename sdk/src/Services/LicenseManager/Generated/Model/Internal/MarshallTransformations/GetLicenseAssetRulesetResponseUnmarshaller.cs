...
{
    /// <summary>
    /// Response Unmarshaller for GetLicenseAssetRuleset operation
    /// </summary>  
    public class GetLicenseAssetRulesetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLicenseAssetRulesetResponse response = new GetLicenseAssetRulesetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LicenseAssetRuleset", targetDepth))
                {
                    ...
                    response.LicenseAssetRuleset = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetLicenseAssetRulesetResponseUnmarshaller _instance = new GetLicenseAssetRulesetResponseUnmarshaller();        

        internal static GetLicenseAssetRulesetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLicenseAssetRulesetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
