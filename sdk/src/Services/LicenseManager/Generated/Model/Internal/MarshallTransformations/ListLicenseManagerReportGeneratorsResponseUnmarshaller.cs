    ...
    public class ListLicenseManagerReportGeneratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ReportGenerator, ReportGeneratorUnmarshaller>(ReportGeneratorUnmarshaller.Instance);
                    response.ReportGenerators = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
