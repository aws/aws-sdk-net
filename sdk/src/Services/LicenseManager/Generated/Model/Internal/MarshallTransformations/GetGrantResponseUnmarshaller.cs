...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Grant", targetDepth))
                {
                    ...
                    response.Grant = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetGrantResponseUnmarshaller _instance = new GetGrantResponseUnmarshaller();        

        internal static GetGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
