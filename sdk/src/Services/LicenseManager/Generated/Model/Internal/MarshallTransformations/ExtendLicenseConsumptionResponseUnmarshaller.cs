...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExtendLicenseConsumptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExtendLicenseConsumptionResponse response = new ExtendLicenseConsumptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LicenseConsumptionToken = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ExtendLicenseConsumptionResponseUnmarshaller _instance = new ExtendLicenseConsumptionResponseUnmarshaller();        

        internal static ExtendLicenseConsumptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExtendLicenseConsumptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
