...
{
    /// <summary>
    /// Response Unmarshaller for CreateLicenseAssetGroup operation
    /// </summary>  
    public class CreateLicenseAssetGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLicenseAssetGroupResponse response = new CreateLicenseAssetGroupResponse();
        ...
        private static CreateLicenseAssetGroupResponseUnmarshaller _instance = new CreateLicenseAssetGroupResponseUnmarshaller();        

        internal static CreateLicenseAssetGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLicenseAssetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
