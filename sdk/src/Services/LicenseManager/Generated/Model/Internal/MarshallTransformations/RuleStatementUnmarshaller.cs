...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuleStatementUnmarshaller : IUnmarshaller<RuleStatement, XmlUnmarshallerContext>, IUnmarshaller<RuleStatement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RuleStatement IUnmarshaller<RuleStatement, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RuleStatement Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("InstanceRuleStatement", targetDepth))
                {
                    ...
                    unmarshalledObject.InstanceRuleStatement = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LicenseConfigurationRuleStatement", targetDepth))
                {
                    ...
                    unmarshalledObject.LicenseConfigurationRuleStatement = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LicenseRuleStatement", targetDepth))
                {
                    var unmarshaller = LicenseRuleStatementUnmarshaller.Instance;
                    unmarshalledObject.LicenseRuleStatement = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
