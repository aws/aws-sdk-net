...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateGrantVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGrantVersionResponse response = new CreateGrantVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GrantArn", targetDepth))
                {
                    ...
                    response.GrantArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateGrantVersionResponseUnmarshaller _instance = new CreateGrantVersionResponseUnmarshaller();        

        internal static CreateGrantVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGrantVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
