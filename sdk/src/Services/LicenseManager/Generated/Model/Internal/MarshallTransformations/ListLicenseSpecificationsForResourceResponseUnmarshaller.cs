...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLicenseSpecificationsForResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLicenseSpecificationsForResourceResponse response = new ListLicenseSpecificationsForResourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LicenseSpecification, LicenseSpecificationUnmarshaller>(LicenseSpecificationUnmarshaller.Instance);
                    response.LicenseSpecifications = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListLicenseSpecificationsForResourceResponseUnmarshaller _instance = new ListLicenseSpecificationsForResourceResponseUnmarshaller();        

        internal static ListLicenseSpecificationsForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLicenseSpecificationsForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
