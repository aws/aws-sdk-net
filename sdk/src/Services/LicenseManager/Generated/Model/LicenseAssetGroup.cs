...
namespace Amazon.LicenseManager.Model
{
    ...
    /// License asset group.
    /// </summary>
    public partial class LicenseAssetGroup
    {
        private List<string> _associatedLicenseAssetRulesetARNs = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private string _description;
        private DateTime? _latestResourceDiscoveryTime;
        private DateTime? _latestUsageAnalysisTime;
        ...
        /// <summary>
        /// Gets and sets the property LatestResourceDiscoveryTime. 
        /// <para>
        /// Latest resource discovery time.
        /// </para>
        /// </summary>
        public DateTime LatestResourceDiscoveryTime
        {
            get { return this._latestResourceDiscoveryTime.GetValueOrDefault(); }
            set { this._latestResourceDiscoveryTime = value; }
        }

        // Check to see if LatestResourceDiscoveryTime property is set
        internal bool IsSetLatestResourceDiscoveryTime()
        {
            return this._latestResourceDiscoveryTime.HasValue; 
        }

        /// <summary>
        /// Gets and sets the property LatestUsageAnalysisTime. 
        /// <para>
        /// Latest usage analysis time.
        /// </para>
        /// </summary>
        public DateTime LatestUsageAnalysisTime
        {
            get { return this._latestUsageAnalysisTime.GetValueOrDefault(); }
            set { this._latestUsageAnalysisTime = value; }
        }

        // Check to see if LatestUsageAnalysisTime property is set
        internal bool IsSetLatestUsageAnalysisTime()
        {
            return this._latestUsageAnalysisTime.HasValue; 
        }
