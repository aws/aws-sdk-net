...
{
    /// <summary>
    /// Information about a quote for an Outpost. A quote provides pricing and configuration
    /// options based on the requested capacity.
    /// </summary>
    public partial class Quote
    {
        ...
        private List<OrderingRequirement> _orderingRequirements = AWSConfigs.InitializeCollections ? new List<OrderingRequirement>() : null;
        ...
        /// <summary>
        /// Gets and sets the property OrderingRequirements. 
        /// <para>
        ...
        /// </summary>
        [AWSProperty(Max=50)]
        public List<OrderingRequirement> OrderingRequirements
        {
            get { return this._orderingRequirements; }
            set { this._orderingRequirements = value; }
        }

        // Check to see if OrderingRequirements property is set
        internal bool IsSetOrderingRequirements()
        {
            return this._orderingRequirements != null && (this._orderingRequirements.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
        ...
        /// <para>
        /// The configuration and pricing options for the quote. Each option includes capacity
        /// details, physical specifications, and pricing information.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <c>CREATED</c> - The quote has been created and is available for review.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>ORDER_SUBMITTED</c> - An order has been submitted for the quote.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>EXPIRED</c> - The quote has expired and can no longer be used to submit an order.
        /// </para>
        ///  </li> </ul>
        /// </summary>
