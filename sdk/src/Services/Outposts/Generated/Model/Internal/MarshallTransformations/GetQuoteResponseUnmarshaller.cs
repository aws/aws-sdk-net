...
{
    /// <summary>
    /// Response Unmarshaller for GetQuote operation
    /// </summary>  
    public class GetQuoteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetQuoteResponseUnmarshaller _instance = new GetQuoteResponseUnmarshaller();        

        internal static GetQuoteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQuoteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
