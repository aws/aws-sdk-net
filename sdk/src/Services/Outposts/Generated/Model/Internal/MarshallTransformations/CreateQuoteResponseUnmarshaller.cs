...
{
    /// <summary>
    /// Response Unmarshaller for CreateQuote operation
    /// </summary>  
    public class CreateQuoteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateQuoteResponseUnmarshaller _instance = new CreateQuoteResponseUnmarshaller();        

        internal static CreateQuoteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQuoteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
