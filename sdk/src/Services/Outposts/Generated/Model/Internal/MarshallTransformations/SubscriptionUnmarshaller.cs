        ...
        public Subscription Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("BeginDate", targetDepth))
                {
                    ...
                    unmarshalledObject.BeginDate = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("MonthlyRecurringPrice", targetDepth))
                {
                    ...
                    unmarshalledObject.MonthlyRecurringPrice = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("OrderIds", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.OrderIds = unmarshaller.Unmarshall(context);
                    continue;
                }
