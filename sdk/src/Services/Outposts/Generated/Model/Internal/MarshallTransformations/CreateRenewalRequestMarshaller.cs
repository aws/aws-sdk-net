...
{
    /// <summary>
    /// CreateRenewal Request Marshaller
    /// </summary>       
    public class CreateRenewalRequestMarshaller : IMarshaller<IRequest, CreateRenewalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRenewalRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateRenewalRequest publicRequest)
        {
        ...
        private static CreateRenewalRequestMarshaller _instance = new CreateRenewalRequestMarshaller();        

        internal static CreateRenewalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRenewalRequestMarshaller Instance
        {
            get
            {
                return _instance;
