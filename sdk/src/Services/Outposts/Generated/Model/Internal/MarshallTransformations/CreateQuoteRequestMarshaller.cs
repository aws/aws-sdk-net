...
{
    /// <summary>
    /// CreateQuote Request Marshaller
    /// </summary>       
    public class CreateQuoteRequestMarshaller : IMarshaller<IRequest, CreateQuoteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateQuoteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateQuoteRequest publicRequest)
        {
        ...
        private static CreateQuoteRequestMarshaller _instance = new CreateQuoteRequestMarshaller();        

        internal static CreateQuoteRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQuoteRequestMarshaller Instance
        {
            get
            {
                return _instance;
