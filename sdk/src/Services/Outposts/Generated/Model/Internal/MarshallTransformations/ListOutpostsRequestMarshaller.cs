...
{
    /// <summary>
    /// ListOutposts Request Marshaller
    /// </summary>       
    public class ListOutpostsRequestMarshaller : IMarshaller<IRequest, ListOutpostsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListOutpostsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListOutpostsRequest publicRequest)
        {
        ...
        private static ListOutpostsRequestMarshaller _instance = new ListOutpostsRequestMarshaller();        

        internal static ListOutpostsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOutpostsRequestMarshaller Instance
        {
            get
            {
                return _instance;
