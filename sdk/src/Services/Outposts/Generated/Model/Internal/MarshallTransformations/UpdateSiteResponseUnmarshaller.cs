...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSite operation
    /// </summary>  
    public class UpdateSiteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("Site", targetDepth, ref reader))
                {
                    var unmarshaller = SiteUnmarshaller.Instance;
                    response.Site = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateSiteResponseUnmarshaller _instance = new UpdateSiteResponseUnmarshaller();        

        internal static UpdateSiteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSiteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
