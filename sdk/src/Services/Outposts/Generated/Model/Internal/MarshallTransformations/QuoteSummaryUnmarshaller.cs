...
{
    /// <summary>
    /// Response Unmarshaller for QuoteSummary Object
    /// </summary>  
    public class QuoteSummaryUnmarshaller : IJsonUnmarshaller<QuoteSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QuoteSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QuoteSummary unmarshalledObject = new QuoteSummary();
        ...
        private static QuoteSummaryUnmarshaller _instance = new QuoteSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QuoteSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
