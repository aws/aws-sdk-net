...
{
    /// <summary>
    /// Response Unmarshaller for DetailedInstanceTypeItem Object
    /// </summary>  
    public class DetailedInstanceTypeItemUnmarshaller : IJsonUnmarshaller<DetailedInstanceTypeItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DetailedInstanceTypeItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DetailedInstanceTypeItem unmarshalledObject = new DetailedInstanceTypeItem();
        ...
        private static DetailedInstanceTypeItemUnmarshaller _instance = new DetailedInstanceTypeItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DetailedInstanceTypeItemUnmarshaller Instance
        {
            get
            {
                return _instance;
