...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQuote operation
    /// </summary>  
    public class UpdateQuoteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQuoteResponse response = new UpdateQuoteResponse();
        ...
        private static UpdateQuoteResponseUnmarshaller _instance = new UpdateQuoteResponseUnmarshaller();        

        internal static UpdateQuoteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQuoteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
