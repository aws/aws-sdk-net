    ...
    public class OutpostUnmarshaller : IJsonUnmarshaller<Outpost, JsonUnmarshallerContext>
    {
        ...
        public Outpost Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RackScalingType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RackScalingType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SupportedHardwareType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
