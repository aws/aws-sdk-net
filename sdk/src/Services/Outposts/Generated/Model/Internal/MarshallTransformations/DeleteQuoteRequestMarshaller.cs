...
namespace Amazon.Outposts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteQuoteRequestMarshaller : IMarshaller<IRequest, DeleteQuoteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteQuoteRequestMarshaller _instance = new DeleteQuoteRequestMarshaller();        

        internal static DeleteQuoteRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteQuoteRequestMarshaller Instance
        {
            get
            {
                return _instance;
