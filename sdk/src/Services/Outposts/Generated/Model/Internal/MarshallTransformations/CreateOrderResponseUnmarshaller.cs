...
{
    /// <summary>
    /// Response Unmarshaller for CreateOrder operation
    /// </summary>  
    public class CreateOrderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateOrderResponseUnmarshaller _instance = new CreateOrderResponseUnmarshaller();        

        internal static CreateOrderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOrderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
