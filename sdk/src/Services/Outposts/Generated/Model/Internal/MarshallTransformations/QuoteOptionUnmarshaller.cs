...
{
    /// <summary>
    /// Response Unmarshaller for QuoteOption Object
    /// </summary>  
    public class QuoteOptionUnmarshaller : IJsonUnmarshaller<QuoteOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QuoteOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QuoteOption unmarshalledObject = new QuoteOption();
        ...
        private static QuoteOptionUnmarshaller _instance = new QuoteOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QuoteOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
