...
{
    /// <summary>
    /// GetCapacityTask Request Marshaller
    /// </summary>       
    public class GetCapacityTaskRequestMarshaller : IMarshaller<IRequest, GetCapacityTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCapacityTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCapacityTaskRequest publicRequest)
        {
            ...
            request.ResourcePath = "/outposts/{OutpostId}/capacity/{CapacityTaskId}";

            return request;
        }
        private static GetCapacityTaskRequestMarshaller _instance = new GetCapacityTaskRequestMarshaller();        

        internal static GetCapacityTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCapacityTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
