...
namespace Amazon.Outposts.Internal
{
    ...
    public class AmazonOutpostsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOutpostsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Outposts.
        /// </summary>
        public AmazonOutpostsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOutpostsAuthSchemeParameters
            {
    ...
    public class AmazonOutpostsAuthSchemeResolver : IAuthSchemeResolver<AmazonOutpostsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOutpostsAuthSchemeParameters authParameters)
        {
