...
namespace Amazon.Outposts.Internal
{
    /// <summary>
    /// Amazon Outposts endpoint provider.
    /// Resolves endpoint for given set of OutpostsEndpointParameters.
    /// Can throw AmazonClientException if endpoint resolution is unsuccessful.
    /// </summary>
    public class AmazonOutpostsEndpointProvider : IEndpointProvider
    {
        /// <summary>
        /// Resolve endpoint for OutpostsEndpointParameters
        /// </summary>
        public Endpoint ResolveEndpoint(EndpointParameters parameters)
        {
            ...
            if ((refs["PartitionResult"] = Partition((string)refs["Region"])) != null)
            {
                ...
                if (Equals(refs["UseFIPS"], true) && Equals(refs["UseDualStack"], true))
                {
                    ...
                    {
                        return new Endpoint(Interpolate(@"https://outposts-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", refs), InterpolateJson(@"", refs), InterpolateJson(@"", refs));
                    }
