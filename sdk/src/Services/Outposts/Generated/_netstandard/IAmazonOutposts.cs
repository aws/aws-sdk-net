...
namespace Amazon.Outposts
{
    ...
    public partial interface IAmazonOutposts : IAmazonService, IDisposable
    {
        ...
        Task<CreateQuoteResponse> CreateQuoteAsync(CreateQuoteRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteQuoteResponse> DeleteQuoteAsync(DeleteQuoteRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetQuoteResponse> GetQuoteAsync(GetQuoteRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListOrderableInstanceTypesResponse> ListOrderableInstanceTypesAsync(ListOrderableInstanceTypesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListQuotesResponse> ListQuotesAsync(ListQuotesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateQuoteResponse> UpdateQuoteAsync(UpdateQuoteRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
