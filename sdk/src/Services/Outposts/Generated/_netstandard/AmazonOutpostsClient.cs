...
namespace Amazon.Outposts
{
    ...
    public partial class AmazonOutpostsClient : AmazonServiceClient, IAmazonOutposts
    {
        ...
        internal virtual CreatePrivateConnectivityConfigResponse CreatePrivateConnectivityConfig(CreatePrivateConnectivityConfigRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetPrivateConnectivityConfigResponse GetPrivateConnectivityConfig(GetPrivateConnectivityConfigRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual StartOutpostDecommissionResponse StartOutpostDecommission(StartOutpostDecommissionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
