...
namespace Amazon.Outposts
{
    ...
    /// <summary>
    /// Constants used for properties of type PrivateConnectivityStatus.
    /// </summary>
    public class PrivateConnectivityStatus : ConstantClass
    {

        /// <summary>
        /// Constant DISABLED for PrivateConnectivityStatus
        /// </summary>
        public static readonly PrivateConnectivityStatus DISABLED = new PrivateConnectivityStatus("DISABLED");
        /// <summary>
        /// Constant ENABLED for PrivateConnectivityStatus
        /// </summary>
        public static readonly PrivateConnectivityStatus ENABLED = new PrivateConnectivityStatus("ENABLED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public PrivateConnectivityStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static PrivateConnectivityStatus FindValue(string value)
        {
            return FindValue<PrivateConnectivityStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator PrivateConnectivityStatus(string value)
        {
            return FindValue(value);
        }
    }
