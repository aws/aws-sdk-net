...
namespace Amazon.GeoMaps
{
    ...
    public partial class AmazonGeoMapsClient : AmazonServiceClient, IAmazonGeoMaps
    {
        ...
        /// 
        /// </summary>
        public AmazonGeoMapsClient() : base(new AmazonGeoMapsConfig()) { }
        ...
        public AmazonGeoMapsClient(RegionEndpoint region) : base(new AmazonGeoMapsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonGeoMapsClient(AmazonGeoMapsConfig config) : base(config) { }
