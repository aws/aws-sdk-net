...
namespace Amazon.GeoMaps
{
    ...
    public partial class AmazonGeoMapsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Geo Maps", "4.0.101.5");
        ...
        /// </summary>
        public static new string ServiceId => "Geo Maps";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "geo-maps";
