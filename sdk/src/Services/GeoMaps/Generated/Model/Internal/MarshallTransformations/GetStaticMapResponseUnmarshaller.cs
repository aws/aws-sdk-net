...
{
    /// <summary>
    /// Response Unmarshaller for GetStaticMap operation
    /// </summary>  
    public class GetStaticMapResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStaticMapResponse response = new GetStaticMapResponse();
        ...
        private static GetStaticMapResponseUnmarshaller _instance = new GetStaticMapResponseUnmarshaller();        

        internal static GetStaticMapResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStaticMapResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
