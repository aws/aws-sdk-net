...
{
    /// <summary>
    /// Response Unmarshaller for GetStyleDescriptor operation.
    /// </summary>
    public partial class GetStyleDescriptorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetStyleDescriptorResponse();
            var ms = new MemoryStream();
            Amazon.Util.AWSSDKUtils.CopyStream(context.Stream, ms);
            ms.Seek(0, SeekOrigin.Begin);
            if (ms.Length > 0)
            {
                unmarshalledObject.Blob = ms;
            }
        ...
        private static GetStyleDescriptorResponseUnmarshaller _instance = new GetStyleDescriptorResponseUnmarshaller();

        internal static GetStyleDescriptorResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetStyleDescriptorResponseUnmarshaller Instance => _instance;
    }
}
