...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetStaticMapResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetStaticMapResponse();
        ...
        internal static GetStaticMapResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetStaticMapResponseUnmarshaller Instance => _instance;
    }
}
