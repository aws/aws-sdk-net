...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetStaticMapRequestMarshaller : IMarshaller<IRequest, GetStaticMapRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetStaticMapRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("crop-labels", StringUtils.FromBool(publicRequest.CropLabels.Value));
            }
            ...
            {
                request.Parameters.Add("height", StringUtils.FromInt(publicRequest.Height.Value));
            }
            ...
            {
                request.Parameters.Add("padding", StringUtils.FromInt(publicRequest.Padding.Value));
            }
            ...
            {
                request.Parameters.Add("radius", StringUtils.FromLong(publicRequest.Radius.Value));
            }
            ...
            {
                request.Parameters.Add("width", StringUtils.FromInt(publicRequest.Width.Value));
            }

            if (publicRequest.IsSetZoom())
            {
                request.Parameters.Add("zoom", StringUtils.FromFloat(publicRequest.Zoom.Value));
            }
        ...
        private static readonly GetStaticMapRequestMarshaller _instance = new();

        internal static GetStaticMapRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetStaticMapRequestMarshaller Instance => _instance;
    }
}
