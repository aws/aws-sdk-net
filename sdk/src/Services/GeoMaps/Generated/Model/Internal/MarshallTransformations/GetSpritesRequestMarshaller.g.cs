...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSpritesRequestMarshaller : IMarshaller<IRequest, GetSpritesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSpritesRequestMarshaller _instance = new();

        internal static GetSpritesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSpritesRequestMarshaller Instance => _instance;
    }
}
