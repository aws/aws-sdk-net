...
{
    /// <summary>
    /// Response Unmarshaller for GetTile operation
    /// </summary>  
    public class GetTileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTileResponse response = new GetTileResponse();
        ...
        private static GetTileResponseUnmarshaller _instance = new GetTileResponseUnmarshaller();        

        internal static GetTileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
