...
{
    /// <summary>
    /// Response Unmarshaller for GetSprites operation.
    /// </summary>
    public partial class GetSpritesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSpritesResponse();
        ...
        private static GetSpritesResponseUnmarshaller _instance = new GetSpritesResponseUnmarshaller();

        internal static GetSpritesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSpritesResponseUnmarshaller Instance => _instance;
    }
}
