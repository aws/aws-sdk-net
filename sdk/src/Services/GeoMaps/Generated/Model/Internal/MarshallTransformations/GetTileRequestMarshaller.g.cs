...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetTileRequestMarshaller : IMarshaller<IRequest, GetTileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetTileRequestMarshaller _instance = new();

        internal static GetTileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetTileRequestMarshaller Instance => _instance;
    }
}
