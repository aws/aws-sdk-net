...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetStyleDescriptorRequestMarshaller : IMarshaller<IRequest, GetStyleDescriptorRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetStyleDescriptorRequestMarshaller _instance = new();

        internal static GetStyleDescriptorRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetStyleDescriptorRequestMarshaller Instance => _instance;
    }
}
