...
{
    /// <summary>
    /// Container for the parameters to the GetSprites operation. <c>GetSprites</c> returns
    /// the map's sprites. <para> For more information, see <a href="https://docs.aws.amazon.com/location/latest/developerguide/styling-iconography-with-sprites.html">Style
    ...
    public partial class GetSpritesRequest : AmazonGeoMapsRequest
    {
        ...
        /// <summary>
        /// Checks to see if the Variant property is set.
        /// </summary>
        internal bool IsSetVariant() => this.Variant != null;
    }
}
