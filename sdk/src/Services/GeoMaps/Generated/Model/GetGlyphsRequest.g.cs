...
{
    /// <summary>
    /// Container for the parameters to the GetGlyphs operation. <c>GetGlyphs</c> returns
    /// the map's glyphs. <para> For more information, see <a href="https://docs.aws.amazon.com/location/latest/developerguide/styling-labels-with-glyphs.html">Style
    /// labels with glyphs</a> in the <i>Amazon Location Service Developer Guide</i>. </para>
    /// </summary>
