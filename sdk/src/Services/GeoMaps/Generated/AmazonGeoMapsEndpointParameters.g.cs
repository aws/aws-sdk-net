...
namespace Amazon.GeoMaps.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving GeoMaps endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonGeoMapsEndpointProvider"/> and <see cref="AmazonGeoMapsEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class GeoMapsEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// GeoMapsEndpointParameters constructor
        /// </summary>
        public GeoMapsEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
