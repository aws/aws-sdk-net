...
namespace Amazon.Evs
{
    ...
    public partial interface IAmazonEvs : IAmazonService, IDisposable
    {
        ...
        Task<GetDepotUrlResponse> GetDepotUrlAsync(GetDepotUrlRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetVersionsResponse> GetVersionsAsync(GetVersionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
