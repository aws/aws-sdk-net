...
namespace Amazon.Evs.Model
{
    ...
    /// </summary>
    public partial class DeleteEntitlementResponse : AmazonWebServiceResponse
    {
        private List<VmEntitlement> _entitlements = AWSConfigs.InitializeCollections ? new List<VmEntitlement>() : null;
        ...
        /// </summary>
        public List<VmEntitlement> Entitlements
        {
