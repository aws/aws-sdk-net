...
namespace Amazon.Evs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceTypeEsxVersionsInfoUnmarshaller : IJsonUnmarshaller<InstanceTypeEsxVersionsInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceTypeEsxVersionsInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("esxVersions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.EsxVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
