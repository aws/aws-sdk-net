...
{
    /// <summary>
    /// CreateEnvironmentConnector Request Marshaller
    /// </summary>       
    public class CreateEnvironmentConnectorRequestMarshaller : IMarshaller<IRequest, CreateEnvironmentConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEnvironmentConnectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEnvironmentConnectorRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Evs");
            string target = "AmazonElasticVMwareService.CreateEnvironmentConnector";
        ...
        private static CreateEnvironmentConnectorRequestMarshaller _instance = new CreateEnvironmentConnectorRequestMarshaller();        

        internal static CreateEnvironmentConnectorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEnvironmentConnectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
