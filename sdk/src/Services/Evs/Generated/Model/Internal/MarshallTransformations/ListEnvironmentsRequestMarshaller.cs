...
namespace Amazon.Evs.Model.Internal.MarshallTransformations
{
    ...
    public class ListEnvironmentsRequestMarshaller : IMarshaller<IRequest, ListEnvironmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListEnvironmentsRequest publicRequest)
        {
            ...
            string target = "AmazonElasticVMwareService.ListEnvironments";
            ...
            if(publicRequest.IsSetState())
            {
                ...
                foreach(var publicRequestStateListValue in publicRequest.State)
                {
                        context.Writer.WriteStringValue(publicRequestStateListValue);
                }
