    ...
    public class EnvironmentUnmarshaller : IUnmarshaller<Environment, XmlUnmarshallerContext>, IUnmarshaller<Environment, JsonUnmarshallerContext>
    {
        ...
        public Environment Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Check, CheckUnmarshaller>(CheckUnmarshaller.Instance);
                    unmarshalledObject.Checks = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("serviceAccessSecurityGroups", targetDepth))
                {
                    ...
                    unmarshalledObject.ServiceAccessSecurityGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("serviceAccessSubnetId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ServiceAccessSubnetId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("termsAccepted", targetDepth))
                {
                    ...
                    unmarshalledObject.TermsAccepted = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("vcfHostnames", targetDepth))
                {
                    var unmarshaller = VcfHostnamesUnmarshaller.Instance;
                    unmarshalledObject.VcfHostnames = unmarshaller.Unmarshall(context);
                    continue;
                }
