...
namespace Amazon.Evs.Model
{
    ...
    {
        private List<AccountSetting> _settings = AWSConfigs.InitializeCollections ? new List<AccountSetting>() : null;

        /// <summary>
        /// Gets and sets the property Settings. 
        /// <para>
        /// A list of regional account-level EVS settings for the account. EVS settings that have
        /// never been explicitly set are omitted from the response.
        /// </para>
        /// <para />
