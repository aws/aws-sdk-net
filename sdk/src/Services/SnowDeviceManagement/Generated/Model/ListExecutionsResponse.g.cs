...
namespace Amazon.SnowDeviceManagement.Model
{
    ...
    public partial class ListExecutionsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ExecutionSummary> Executions { get; set; } = AWSConfigs.InitializeCollections ? new List<ExecutionSummary>() : null;

        /// <summary>
        /// Checks to see if the Executions property is set.
        /// </summary>
        internal bool IsSetExecutions() => this.Executions != null && (this.Executions.Count > 0 || !AWSConfigs.InitializeCollections);
