...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeDeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("associatedWithJob", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AssociatedWithJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("deviceCapacities", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DeviceCapacities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("lastReachedOutAt", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.LastReachedOutAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ManagedDeviceArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ManagedDeviceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("physicalNetworkInterfaces", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PhysicalNetworkInterfaces = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeDeviceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeDeviceResponseUnmarshaller Instance => _instance;
    }
}
