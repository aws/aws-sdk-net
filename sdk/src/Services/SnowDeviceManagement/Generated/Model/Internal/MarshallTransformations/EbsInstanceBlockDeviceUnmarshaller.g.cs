...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EbsInstanceBlockDeviceUnmarshaller : IJsonUnmarshaller<EbsInstanceBlockDevice, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EbsInstanceBlockDevice();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EbsInstanceBlockDeviceUnmarshaller Instance => _instance;
    }
}
