...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListDeviceResourcesRequestMarshaller : IMarshaller<IRequest, ListDeviceResourcesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDeviceResourcesRequest)input);
        }
        ...
        public IRequest Marshall(ListDeviceResourcesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/managed-device/{managedDeviceId}/resources";
        ...
        private static readonly ListDeviceResourcesRequestMarshaller _instance = new();

        internal static ListDeviceResourcesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListDeviceResourcesRequestMarshaller Instance => _instance;
    }
}
