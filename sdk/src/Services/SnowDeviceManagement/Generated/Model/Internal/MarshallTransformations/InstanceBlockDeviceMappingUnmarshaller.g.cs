...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InstanceBlockDeviceMappingUnmarshaller : IJsonUnmarshaller<InstanceBlockDeviceMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InstanceBlockDeviceMapping();
        ...
        /// Gets the singleton.
        /// </summary>
        public static InstanceBlockDeviceMappingUnmarshaller Instance => _instance;
    }
}
