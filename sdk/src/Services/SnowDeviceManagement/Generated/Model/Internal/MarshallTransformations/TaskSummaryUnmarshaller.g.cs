...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TaskSummaryUnmarshaller : IJsonUnmarshaller<TaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public TaskSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new TaskSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TaskSummaryUnmarshaller Instance => _instance;
    }
}
