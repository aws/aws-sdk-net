...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CancelTaskRequestMarshaller : IMarshaller<IRequest, CancelTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CancelTaskRequestMarshaller _instance = new();

        internal static CancelTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelTaskRequestMarshaller Instance => _instance;
    }
}
