...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDeviceEc2InstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDeviceEc2InstancesResponse response = new DescribeDeviceEc2InstancesResponse();
        ...
        private static DescribeDeviceEc2InstancesResponseUnmarshaller _instance = new DescribeDeviceEc2InstancesResponseUnmarshaller();        

        internal static DescribeDeviceEc2InstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDeviceEc2InstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
