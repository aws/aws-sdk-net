...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeDeviceEc2InstancesRequestMarshaller : IMarshaller<IRequest, DescribeDeviceEc2InstancesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeDeviceEc2InstancesRequestMarshaller _instance = new();

        internal static DescribeDeviceEc2InstancesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeDeviceEc2InstancesRequestMarshaller Instance => _instance;
    }
}
