...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CpuOptionsUnmarshaller : IJsonUnmarshaller<CpuOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CpuOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CpuOptions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CpuOptionsUnmarshaller Instance => _instance;
    }
}
