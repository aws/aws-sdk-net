...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateTaskRequestMarshaller : IMarshaller<IRequest, CreateTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateTaskRequestMarshaller _instance = new();

        internal static CreateTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateTaskRequestMarshaller Instance => _instance;
    }
}
