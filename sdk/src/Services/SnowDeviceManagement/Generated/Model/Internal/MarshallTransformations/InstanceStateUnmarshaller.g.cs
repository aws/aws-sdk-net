...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InstanceStateUnmarshaller : IJsonUnmarshaller<InstanceState, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public InstanceState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new InstanceState();
        ...
        /// Gets the singleton.
        /// </summary>
        public static InstanceStateUnmarshaller Instance => _instance;
    }
}
