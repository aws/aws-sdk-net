...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDeviceResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDeviceResourcesResponse response = new ListDeviceResourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourceSummary, ResourceSummaryUnmarshaller>(ResourceSummaryUnmarshaller.Instance);
        ...
        private static ListDeviceResourcesResponseUnmarshaller _instance = new ListDeviceResourcesResponseUnmarshaller();        

        internal static ListDeviceResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDeviceResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
