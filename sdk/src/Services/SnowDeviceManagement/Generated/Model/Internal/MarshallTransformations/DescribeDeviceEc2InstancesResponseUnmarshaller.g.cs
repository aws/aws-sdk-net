...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeDeviceEc2InstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeDeviceEc2InstancesResponse();
        ...
        internal static DescribeDeviceEc2InstancesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeDeviceEc2InstancesResponseUnmarshaller Instance => _instance;
    }
}
