...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CancelTaskResponseUnmarshaller _instance = new CancelTaskResponseUnmarshaller();        

        internal static CancelTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
