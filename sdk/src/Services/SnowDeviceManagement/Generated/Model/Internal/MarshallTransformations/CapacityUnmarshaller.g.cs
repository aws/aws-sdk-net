...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CapacityUnmarshaller : IJsonUnmarshaller<Capacity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Capacity();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CapacityUnmarshaller Instance => _instance;
    }
}
