...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    public partial class TagResourceRequestMarshaller : IMarshaller<IRequest, TagResourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(TagResourceRequest publicRequest)
        {
            ...
            {
                throw new AmazonSnowDeviceManagementException("Request object does not have required field ResourceArn set");
            }
        ...
        private static readonly TagResourceRequestMarshaller _instance = new();

        internal static TagResourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static TagResourceRequestMarshaller Instance => _instance;
    }
}
