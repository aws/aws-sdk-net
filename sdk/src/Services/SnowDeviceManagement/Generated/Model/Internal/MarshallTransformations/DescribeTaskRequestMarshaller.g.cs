...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeTaskRequestMarshaller : IMarshaller<IRequest, DescribeTaskRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeTaskRequestMarshaller _instance = new();

        internal static DescribeTaskRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeTaskRequestMarshaller Instance => _instance;
    }
}
