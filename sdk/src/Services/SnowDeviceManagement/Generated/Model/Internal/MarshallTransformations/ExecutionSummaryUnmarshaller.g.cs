...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExecutionSummaryUnmarshaller : IJsonUnmarshaller<ExecutionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExecutionSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExecutionSummaryUnmarshaller Instance => _instance;
    }
}
