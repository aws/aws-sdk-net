...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceSummaryUnmarshaller : IJsonUnmarshaller<ResourceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
