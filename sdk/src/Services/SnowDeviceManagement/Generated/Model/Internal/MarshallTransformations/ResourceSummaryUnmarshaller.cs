...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceSummaryUnmarshaller : IUnmarshaller<ResourceSummary, XmlUnmarshallerContext>, IUnmarshaller<ResourceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ResourceSummary IUnmarshaller<ResourceSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static ResourceSummaryUnmarshaller _instance = new ResourceSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResourceSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
