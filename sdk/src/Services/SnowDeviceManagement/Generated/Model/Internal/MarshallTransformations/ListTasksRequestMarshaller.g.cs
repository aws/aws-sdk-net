...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListTasksRequestMarshaller : IMarshaller<IRequest, ListTasksRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListTasksRequestMarshaller _instance = new();

        internal static ListTasksRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListTasksRequestMarshaller Instance => _instance;
    }
}
