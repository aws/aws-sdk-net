...
namespace Amazon.SnowDeviceManagement
{
    ...
    public partial class AmazonSnowDeviceManagementClient : AmazonServiceClient, IAmazonSnowDeviceManagement
    {
        ...
        /// 
        /// </summary>
        public AmazonSnowDeviceManagementClient() : base(new AmazonSnowDeviceManagementConfig()) { }
        ...
        public AmazonSnowDeviceManagementClient(RegionEndpoint region) : base(new AmazonSnowDeviceManagementConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSnowDeviceManagementClient(AmazonSnowDeviceManagementConfig config) : base(config) { }
