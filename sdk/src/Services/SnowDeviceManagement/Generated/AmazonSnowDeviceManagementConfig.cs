...
namespace Amazon.SnowDeviceManagement
{
    ...
    public partial class AmazonSnowDeviceManagementConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Snow Device Management", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "Snow Device Management";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "snow-device-management";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-08-04";
