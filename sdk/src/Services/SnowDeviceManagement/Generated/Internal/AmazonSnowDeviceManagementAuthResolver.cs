...
namespace Amazon.SnowDeviceManagement.Internal
{
    ...
    public class AmazonSnowDeviceManagementAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSnowDeviceManagementAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SnowDeviceManagement.
        /// </summary>
        public AmazonSnowDeviceManagementAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSnowDeviceManagementAuthSchemeParameters
            {
    ...
    public class AmazonSnowDeviceManagementAuthSchemeResolver : IAuthSchemeResolver<AmazonSnowDeviceManagementAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSnowDeviceManagementAuthSchemeParameters authParameters)
        {
