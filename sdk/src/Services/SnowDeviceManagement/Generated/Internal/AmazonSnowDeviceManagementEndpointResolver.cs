...
{
    /// <summary>
    /// Amazon SnowDeviceManagement endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for SnowDeviceManagement service requests.
    /// Collects values for SnowDeviceManagementEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SnowDeviceManagementEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonSnowDeviceManagementEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSnowDeviceManagementConfig)requestContext.ClientConfig;
            var result = new SnowDeviceManagementEndpointParameters();
