...
namespace Amazon.DirectoryService.Model
{
    ...
    internal sealed partial class DescribeSnapshotsPaginator : IPaginator<DescribeSnapshotsResponse>, IDescribeSnapshotsPaginator
    {
        ...
        internal DescribeSnapshotsPaginator(IAmazonDirectoryService client, DescribeSnapshotsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<DescribeSnapshotsResponse> IPaginator<DescribeSnapshotsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
