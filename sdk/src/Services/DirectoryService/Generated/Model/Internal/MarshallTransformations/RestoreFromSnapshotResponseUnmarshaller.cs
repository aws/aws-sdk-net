...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RestoreFromSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreFromSnapshotResponse response = new RestoreFromSnapshotResponse();
        ...
        private static RestoreFromSnapshotResponseUnmarshaller _instance = new RestoreFromSnapshotResponseUnmarshaller();        

        internal static RestoreFromSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreFromSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
