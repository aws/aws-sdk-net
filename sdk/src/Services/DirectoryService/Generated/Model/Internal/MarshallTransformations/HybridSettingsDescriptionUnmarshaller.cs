...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HybridSettingsDescriptionUnmarshaller : IUnmarshaller<HybridSettingsDescription, XmlUnmarshallerContext>, IUnmarshaller<HybridSettingsDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HybridSettingsDescription IUnmarshaller<HybridSettingsDescription, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public HybridSettingsDescription Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SelfManagedDnsIpAddrs", targetDepth))
                {
                    ...
                    unmarshalledObject.SelfManagedDnsIpAddrs = unmarshaller.Unmarshall(context);
                    continue;
                }
