...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDirectoryLimitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDirectoryLimitsResponse response = new GetDirectoryLimitsResponse();
            ...
            {
                if (context.TestExpression("DirectoryLimits", targetDepth, ref reader))
                {
                    var unmarshaller = DirectoryLimitsUnmarshaller.Instance;
                    response.DirectoryLimits = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDirectoryLimitsResponseUnmarshaller _instance = new GetDirectoryLimitsResponseUnmarshaller();        

        internal static GetDirectoryLimitsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDirectoryLimitsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
