...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDirectoryDataAccess operation
    /// </summary>  
    public class DescribeDirectoryDataAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDirectoryDataAccessResponse response = new DescribeDirectoryDataAccessResponse();
            ...
            {
                if (context.TestExpression("DataAccessStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DataAccessStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeDirectoryDataAccessResponseUnmarshaller _instance = new DescribeDirectoryDataAccessResponseUnmarshaller();        

        internal static DescribeDirectoryDataAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDirectoryDataAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
