...
{
    /// <summary>
    /// DeleteConditionalForwarder Request Marshaller
    /// </summary>       
    public class DeleteConditionalForwarderRequestMarshaller : IMarshaller<IRequest, DeleteConditionalForwarderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteConditionalForwarderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteConditionalForwarderRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectoryService");
            string target = "DirectoryService_20150416.DeleteConditionalForwarder";
