...
{
    /// <summary>
    /// Response Unmarshaller for ShareDirectory operation
    /// </summary>  
    public class ShareDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SharedDirectoryId", targetDepth))
                {
                    ...
                    response.SharedDirectoryId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("DirectoryAlreadySharedException"))
            {
                return new DirectoryAlreadySharedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("OrganizationsException"))
            {
                return new OrganizationsException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("ShareLimitExceededException"))
            {
                return new ShareLimitExceededException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static ShareDirectoryResponseUnmarshaller _instance = new ShareDirectoryResponseUnmarshaller();        

        internal static ShareDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ShareDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
