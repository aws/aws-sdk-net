...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateInfoEntryUnmarshaller : IJsonUnmarshaller<UpdateInfoEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UpdateInfoEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("InitiatedBy", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("PreviousValue", targetDepth, ref reader))
                {
                    var unmarshaller = UpdateValueUnmarshaller.Instance;
