...
{
    /// <summary>
    /// Response Unmarshaller for DeleteADAssessment operation
    /// </summary>  
    public class DeleteADAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteADAssessmentResponse response = new DeleteADAssessmentResponse();
        ...
        private static DeleteADAssessmentResponseUnmarshaller _instance = new DeleteADAssessmentResponseUnmarshaller();        

        internal static DeleteADAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteADAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
