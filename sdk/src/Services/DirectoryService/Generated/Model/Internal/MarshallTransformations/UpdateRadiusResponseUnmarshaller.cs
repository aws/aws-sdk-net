...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateRadiusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRadiusResponse response = new UpdateRadiusResponse();
        ...
        private static UpdateRadiusResponseUnmarshaller _instance = new UpdateRadiusResponseUnmarshaller();        

        internal static UpdateRadiusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRadiusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
