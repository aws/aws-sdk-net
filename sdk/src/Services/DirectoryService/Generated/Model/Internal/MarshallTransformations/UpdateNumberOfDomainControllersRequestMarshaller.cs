...
{
    /// <summary>
    /// UpdateNumberOfDomainControllers Request Marshaller
    /// </summary>       
    public class UpdateNumberOfDomainControllersRequestMarshaller : IMarshaller<IRequest, UpdateNumberOfDomainControllersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateNumberOfDomainControllersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateNumberOfDomainControllersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectoryService");
            string target = "DirectoryService_20150416.UpdateNumberOfDomainControllers";
            ...
            if(publicRequest.IsSetDesiredNumber())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.DesiredNumber.Value);
            }
