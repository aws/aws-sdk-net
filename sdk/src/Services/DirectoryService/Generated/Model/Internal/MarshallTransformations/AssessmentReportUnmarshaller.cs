        ...
        public AssessmentReport Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DomainControllerIp", targetDepth))
                {
                    ...
                    unmarshalledObject.DomainControllerIp = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Validations", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AssessmentValidation, AssessmentValidationUnmarshaller>(AssessmentValidationUnmarshaller.Instance);
