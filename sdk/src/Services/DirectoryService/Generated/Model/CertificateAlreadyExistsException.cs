...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class CertificateAlreadyExistsException : AmazonDirectoryServiceException
    {
        ...
        /// <summary>
        /// Default constructor for CertificateAlreadyExistsException
        /// message.
        /// </summary>
        ...
        public CertificateAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CertificateAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
