...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class DomainControllerLimitExceededException : AmazonDirectoryServiceException
    {
        ...
        /// <summary>
        /// Default constructor for DomainControllerLimitExceededException
        /// message.
        /// </summary>
        public DomainControllerLimitExceededException() 
            : base() {}
        ...
        public DomainControllerLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DomainControllerLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
