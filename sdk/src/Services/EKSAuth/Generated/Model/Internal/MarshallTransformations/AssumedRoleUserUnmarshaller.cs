...
namespace Amazon.EKSAuth.Model.Internal.MarshallTransformations
{
    ...
    public class AssumedRoleUserUnmarshaller : IUnmarshaller<AssumedRoleUser, XmlUnmarshallerContext>, IUnmarshaller<AssumedRoleUser, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        AssumedRoleUser IUnmarshaller<AssumedRoleUser, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AssumedRoleUser Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AssumeRoleId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
