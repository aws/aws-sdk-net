...
namespace Amazon.EKSAuth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubjectUnmarshaller : IUnmarshaller<Subject, XmlUnmarshallerContext>, IUnmarshaller<Subject, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Subject IUnmarshaller<Subject, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static SubjectUnmarshaller _instance = new SubjectUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SubjectUnmarshaller Instance
        {
            get
            {
                return _instance;
