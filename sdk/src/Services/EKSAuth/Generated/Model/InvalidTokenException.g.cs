...
namespace Amazon.EKSAuth.Model
{
    ...
    public partial class InvalidTokenException : AmazonEKSAuthException
    {
        ...
        /// Construct instance of InvalidTokenException
        /// </summary>
        public InvalidTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidTokenException
        /// </summary>
        public InvalidTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
