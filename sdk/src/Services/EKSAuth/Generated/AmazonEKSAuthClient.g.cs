...
namespace Amazon.EKSAuth
{
    ...
    public partial class AmazonEKSAuthClient : AmazonServiceClient, IAmazonEKSAuth
    {
        ...
        /// 
        /// </summary>
        public AmazonEKSAuthClient() : base(new AmazonEKSAuthConfig()) { }
        ...
        public AmazonEKSAuthClient(RegionEndpoint region) : base(new AmazonEKSAuthConfig { RegionEndpoint = region }) { }
        ...
        public AmazonEKSAuthClient(AmazonEKSAuthConfig config) : base(config) { }
