...
namespace Amazon.EKSAuth.Internal
{
    ...
    public class AmazonEKSAuthAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEKSAuthAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EKSAuth.
        /// </summary>
        public AmazonEKSAuthAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEKSAuthAuthSchemeParameters
            {
    ...
    public class AmazonEKSAuthAuthSchemeResolver : IAuthSchemeResolver<AmazonEKSAuthAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEKSAuthAuthSchemeParameters authParameters)
        {
