...
namespace Amazon.EKSAuth.Internal
{
    ...
    /// </summary>
    public class AmazonEKSAuthEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonEKSAuthConfig)requestContext.ClientConfig;
            var result = new EKSAuthEndpointParameters();
