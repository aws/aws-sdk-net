...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEKSAuthConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEKSAuthConfig();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEKSAuthConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEKSAuthConfig to create AmazonEKSAuthClient");
            }

            return awsCredentials == null ?
                    new AmazonEKSAuthClient(serviceClientConfig) :
                    new AmazonEKSAuthClient(awsCredentials, serviceClientConfig);
        }
