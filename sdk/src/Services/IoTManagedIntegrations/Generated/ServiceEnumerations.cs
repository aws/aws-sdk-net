...
namespace Amazon.IoTManagedIntegrations
{
    ...
    /// <summary>
    /// Constants used for properties of type ProvisioningProfileStatus.
    /// </summary>
    public class ProvisioningProfileStatus : ConstantClass
    {

        /// <summary>
        /// Constant CREATE_FAILED for ProvisioningProfileStatus
        /// </summary>
        public static readonly ProvisioningProfileStatus CREATE_FAILED = new ProvisioningProfileStatus("CREATE_FAILED");
        /// <summary>
        /// Constant CREATE_IN_PROGRESS for ProvisioningProfileStatus
        /// </summary>
        public static readonly ProvisioningProfileStatus CREATE_IN_PROGRESS = new ProvisioningProfileStatus("CREATE_IN_PROGRESS");
        /// <summary>
        /// Constant CREATED for ProvisioningProfileStatus
        /// </summary>
        public static readonly ProvisioningProfileStatus CREATED = new ProvisioningProfileStatus("CREATED");
        /// <summary>
        /// Constant DELETE_FAILED for ProvisioningProfileStatus
        /// </summary>
        public static readonly ProvisioningProfileStatus DELETE_FAILED = new ProvisioningProfileStatus("DELETE_FAILED");
        /// <summary>
        /// Constant DELETE_IN_PROGRESS for ProvisioningProfileStatus
        /// </summary>
        public static readonly ProvisioningProfileStatus DELETE_IN_PROGRESS = new ProvisioningProfileStatus("DELETE_IN_PROGRESS");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ProvisioningProfileStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ProvisioningProfileStatus FindValue(string value)
        {
            return FindValue<ProvisioningProfileStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ProvisioningProfileStatus(string value)
        {
            return FindValue(value);
        }
    }
