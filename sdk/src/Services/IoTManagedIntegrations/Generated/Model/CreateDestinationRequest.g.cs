...
{
    /// <summary>
    /// Container for the parameters to the CreateDestination operation. Create a notification
    /// destination such as Kinesis Data Streams that receive events and notifications from
    /// Managed integrations. Managed integrations uses the destination to determine where
