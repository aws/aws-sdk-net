...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    /// </summary>
    public partial class MatterEndpoint
    {
        private List<MatterCluster> _clusters = AWSConfigs.InitializeCollections ? new List<MatterCluster>() : null;
        private string _id;
        ...
        public List<MatterCluster> Clusters
        {
