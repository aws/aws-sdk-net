...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccountAssociation operation.
    /// </summary>
    public partial class CreateAccountAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAccountAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OAuthAuthorizationUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAccountAssociationResponseUnmarshaller _instance = new CreateAccountAssociationResponseUnmarshaller();

        internal static CreateAccountAssociationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAccountAssociationResponseUnmarshaller Instance => _instance;
    }
}
