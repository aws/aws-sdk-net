...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthMaterialUnmarshaller : IJsonUnmarshaller<AuthMaterial, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuthMaterial Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AuthMaterialName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AuthMaterialName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
