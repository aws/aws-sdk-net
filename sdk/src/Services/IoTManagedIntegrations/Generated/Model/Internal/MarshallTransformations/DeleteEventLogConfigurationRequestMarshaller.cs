...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteEventLogConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteEventLogConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteEventLogConfigurationRequestMarshaller _instance = new DeleteEventLogConfigurationRequestMarshaller();        

        internal static DeleteEventLogConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventLogConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
