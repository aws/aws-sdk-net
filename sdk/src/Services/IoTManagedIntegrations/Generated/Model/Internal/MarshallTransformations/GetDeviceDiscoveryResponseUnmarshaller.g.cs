...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDeviceDiscoveryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDeviceDiscoveryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConnectorAssociationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ControllerId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetDeviceDiscoveryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeviceDiscoveryResponseUnmarshaller Instance => _instance;
    }
}
