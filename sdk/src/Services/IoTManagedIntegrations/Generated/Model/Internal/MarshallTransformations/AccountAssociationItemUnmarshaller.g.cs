...
{
    /// <summary>
    /// Response Unmarshaller for AccountAssociationItem Object
    /// </summary>
    public partial class AccountAssociationItemUnmarshaller : IJsonUnmarshaller<AccountAssociationItem, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AccountAssociationItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AccountAssociationItem();
        ...
        private static AccountAssociationItemUnmarshaller _instance = new AccountAssociationItemUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AccountAssociationItemUnmarshaller Instance => _instance;
    }
}
