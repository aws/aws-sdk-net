...
{
    /// <summary>
    /// CapabilityReport Marshaller
    /// </summary>
    public partial class CapabilityReportMarshaller : IRequestMarshaller<CapabilityReport, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(CapabilityReport requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetEndpoints())
            {
                ...
                foreach (var requestObjectEndpointsListValue in requestObject.Endpoints)
                {
                    ...
                    var marshaller = CapabilityReportEndpointMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CapabilityReportMarshaller Instance = new CapabilityReportMarshaller();
    }
}
