...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    public class ExponentialRolloutRateUnmarshaller : IJsonUnmarshaller<ExponentialRolloutRate, JsonUnmarshallerContext>
    {
        ...
        private static ExponentialRolloutRateUnmarshaller _instance = new ExponentialRolloutRateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ExponentialRolloutRateUnmarshaller Instance
        {
            get
            {
                return _instance;
