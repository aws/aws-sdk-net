...
{
    /// <summary>
    /// Response Unmarshaller for GetManagedThingState operation
    /// </summary>  
    public class GetManagedThingStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetManagedThingStateResponse response = new GetManagedThingStateResponse();
        ...
        private static GetManagedThingStateResponseUnmarshaller _instance = new GetManagedThingStateResponseUnmarshaller();        

        internal static GetManagedThingStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetManagedThingStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
    ...
    public class GetManagedThingStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Endpoints", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<StateEndpoint, StateEndpointUnmarshaller>(StateEndpointUnmarshaller.Instance);
