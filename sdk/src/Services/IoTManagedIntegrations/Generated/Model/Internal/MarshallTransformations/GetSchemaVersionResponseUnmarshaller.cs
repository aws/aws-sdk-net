...
{
    /// <summary>
    /// Response Unmarshaller for GetSchemaVersion operation
    /// </summary>  
    public class GetSchemaVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSchemaVersionResponse response = new GetSchemaVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SchemaId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetSchemaVersionResponseUnmarshaller _instance = new GetSchemaVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSchemaVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
    ...
    public class GetSchemaVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SchemaId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SemanticVersion", targetDepth))
                {
