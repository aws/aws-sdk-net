...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SchemaVersionListItemUnmarshaller : IJsonUnmarshaller<SchemaVersionListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SchemaVersionListItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SchemaVersionListItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SchemaVersionListItemUnmarshaller Instance => _instance;
    }
}
