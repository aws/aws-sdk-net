...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OAuthConfigUnmarshaller : IUnmarshaller<OAuthConfig, XmlUnmarshallerContext>, IUnmarshaller<OAuthConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        OAuthConfig IUnmarshaller<OAuthConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public OAuthConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OAuthCompleteRedirectUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("proactiveRefreshTokenRenewal", targetDepth))
                {
                    ...
                    unmarshalledObject.ProactiveRefreshTokenRenewal = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TokenEndpointAuthenticationScheme = unmarshaller.Unmarshall(context);
                    continue;
                }
