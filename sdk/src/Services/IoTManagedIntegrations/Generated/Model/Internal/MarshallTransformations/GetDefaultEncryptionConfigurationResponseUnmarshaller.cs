...
{
    /// <summary>
    /// Response Unmarshaller for GetDefaultEncryptionConfiguration operation
    /// </summary>  
    public class GetDefaultEncryptionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDefaultEncryptionConfigurationResponse response = new GetDefaultEncryptionConfigurationResponse();
        ...
        private static GetDefaultEncryptionConfigurationResponseUnmarshaller _instance = new GetDefaultEncryptionConfigurationResponseUnmarshaller();        

        internal static GetDefaultEncryptionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDefaultEncryptionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
