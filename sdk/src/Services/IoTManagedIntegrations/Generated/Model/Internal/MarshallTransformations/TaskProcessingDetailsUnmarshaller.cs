...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// Response Unmarshaller for TaskProcessingDetails Object
    /// </summary>  
    public class TaskProcessingDetailsUnmarshaller : IUnmarshaller<TaskProcessingDetails, XmlUnmarshallerContext>, IUnmarshaller<TaskProcessingDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshaller the response from the service to the response class.
        /// </summary>  
        /// <param name="context"></param>
        /// <returns></returns>
        TaskProcessingDetails IUnmarshaller<TaskProcessingDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns>The unmarshalled object</returns>
        public TaskProcessingDetails Unmarshall(JsonUnmarshallerContext context)
        {
            TaskProcessingDetails unmarshalledObject = new TaskProcessingDetails();
            if (context.IsEmptyResponse)
                return null;
