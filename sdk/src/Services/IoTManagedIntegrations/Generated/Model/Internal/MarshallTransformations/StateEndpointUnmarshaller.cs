...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// Response Unmarshaller for StateEndpoint Object
    /// </summary>  
    public class StateEndpointUnmarshaller : IUnmarshaller<StateEndpoint, XmlUnmarshallerContext>, IUnmarshaller<StateEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshaller the response from the service to the response class.
        /// </summary>  
        /// <param name="context"></param>
        /// <returns></returns>
        StateEndpoint IUnmarshaller<StateEndpoint, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns>The unmarshalled object</returns>
        public StateEndpoint Unmarshall(JsonUnmarshallerContext context)
        {
            StateEndpoint unmarshalledObject = new StateEndpoint();
            if (context.IsEmptyResponse)
                return null;
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("capabilities", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<StateCapability, StateCapabilityUnmarshaller>(StateCapabilityUnmarshaller.Instance);
