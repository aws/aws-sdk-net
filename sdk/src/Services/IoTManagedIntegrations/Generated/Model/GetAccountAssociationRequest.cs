...
{
    /// <summary>
    /// Container for the parameters to the GetAccountAssociation operation.
    /// Get an account association for an Amazon Web Services account linked to a customer-managed
    /// destination.
    /// </summary>
    public partial class GetAccountAssociationRequest : AmazonIoTManagedIntegrationsRequest
    {
