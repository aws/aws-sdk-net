...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    public partial class GetRuntimeLogConfigurationResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public RuntimeLogConfigurations RuntimeLogConfigurations { get; set; }

        /// <summary>
        /// Checks to see if the RuntimeLogConfigurations property is set.
        /// </summary>
        internal bool IsSetRuntimeLogConfigurations() => this.RuntimeLogConfigurations != null;
    }
}
