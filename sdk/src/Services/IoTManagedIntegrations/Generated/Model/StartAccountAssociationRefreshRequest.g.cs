...
{
    /// <summary>
    /// Container for the parameters to the StartAccountAssociationRefresh operation. Initiates
    /// a refresh of an existing account association to update its authorization and connection
    /// status.
    /// </summary>
