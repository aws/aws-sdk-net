...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    public partial class OtaTaskExecutionRolloutConfig
    {
        ...
        /// </para>
        /// </summary>
        public ExponentialRolloutRate ExponentialRolloutRate { get; set; }

        /// <summary>
        /// Checks to see if the ExponentialRolloutRate property is set.
        /// </summary>
        internal bool IsSetExponentialRolloutRate() => this.ExponentialRolloutRate != null;
        ...
        /// <summary>
        /// Checks to see if the MaximumPerMinute property is set.
        /// </summary>
        internal bool IsSetMaximumPerMinute() => this.MaximumPerMinute.HasValue;
    }
}
