...
{
    /// <summary>
    /// This is the response object from the ListDestinations operation.
    /// </summary>
    public partial class ListDestinationsResponse : AmazonWebServiceResponse
    {
        private List<DestinationSummary> _destinationList = AWSConfigs.InitializeCollections ? new List<DestinationSummary>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property DestinationList. 
        /// <para>
        ...
        /// </summary>
        public List<DestinationSummary> DestinationList
        {
