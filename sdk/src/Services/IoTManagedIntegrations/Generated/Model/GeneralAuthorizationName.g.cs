...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    public partial class GeneralAuthorizationName
    {
        ...
        public string AuthMaterialName { get; set; }

        /// <summary>
        /// Checks to see if the AuthMaterialName property is set.
        /// </summary>
        internal bool IsSetAuthMaterialName() => this.AuthMaterialName != null;
    }
}
