...
{
    /// <summary>
    /// Container for the parameters to the CreateNotificationConfiguration operation. Creates
    /// a notification configuration. A configuration is a connection between an event type
    /// and a destination that you have already created.
    /// </summary>
    public partial class CreateNotificationConfigurationRequest : AmazonIoTManagedIntegrationsRequest
    {
        /// <summary>
