...
{
    /// <summary>
    /// Container for the parameters to the CreateAccountAssociation operation. Creates a
    /// new account association via the destination id.
    /// </summary>
    public partial class CreateAccountAssociationRequest : AmazonIoTManagedIntegrationsRequest
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public GeneralAuthorizationName GeneralAuthorization { get; set; }

        /// <summary>
        /// Checks to see if the GeneralAuthorization property is set.
        /// </summary>
        internal bool IsSetGeneralAuthorization() => this.GeneralAuthorization != null;
