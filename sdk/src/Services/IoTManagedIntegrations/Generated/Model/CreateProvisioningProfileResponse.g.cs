...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    public partial class CreateProvisioningProfileResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// The private key of the claim certificate. This may be stored securely on the device
        /// for validating the connection endpoint with IoT managed integrations using the public
        /// key.
        /// </para>
        /// </summary>
        [AWSProperty(Sensitive = true)]
        public string ClaimCertificatePrivateKey { get; set; }

        /// <summary>
        /// Checks to see if the ClaimCertificatePrivateKey property is set.
        /// </summary>
        internal bool IsSetClaimCertificatePrivateKey() => this.ClaimCertificatePrivateKey != null;
