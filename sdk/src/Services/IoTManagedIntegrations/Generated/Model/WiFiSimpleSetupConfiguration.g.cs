...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    public partial class WiFiSimpleSetupConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public bool? EnableAsProvisionee { get; set; }

        /// <summary>
        /// Checks to see if the EnableAsProvisionee property is set.
        /// </summary>
        internal bool IsSetEnableAsProvisionee() => this.EnableAsProvisionee.HasValue;
        ...
        /// </para>
        /// </summary>
        public bool? EnableAsProvisioner { get; set; }

        /// <summary>
        /// Checks to see if the EnableAsProvisioner property is set.
        /// </summary>
        internal bool IsSetEnableAsProvisioner() => this.EnableAsProvisioner.HasValue;
