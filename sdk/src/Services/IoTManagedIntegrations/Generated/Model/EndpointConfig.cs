...
{
    /// <summary>
    /// The configuration details for an endpoint, which defines how to connect to and communicate
    /// with external services.
    /// </summary>
    public partial class EndpointConfig
    {
        private LambdaConfig _lambda;

        /// <summary>
        /// Gets and sets the property Lambda. 
        /// <para>
        /// The Lambda function configuration for the endpoint, used when the endpoint communicates
        /// through an AWS Lambda function.
        /// </para>
        /// </summary>
        public LambdaConfig Lambda
        {
