...
{
    /// <summary>
    /// Container for the parameters to the DeleteManagedThing operation. Delete a managed
    /// thing. For direct-connected and hub-connected devices connecting with Managed integrations
    /// via a controller, all of the devices connected to it will have their status changed
    /// to <c>PENDING</c>. It is not possible to remove a cloud-to-cloud device.
    /// </summary>
