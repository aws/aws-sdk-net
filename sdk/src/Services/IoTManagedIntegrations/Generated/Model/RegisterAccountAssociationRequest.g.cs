...
{
    /// <summary>
    /// Container for the parameters to the RegisterAccountAssociation operation. Registers
    /// an account association with a managed thing, establishing a connection between a device
