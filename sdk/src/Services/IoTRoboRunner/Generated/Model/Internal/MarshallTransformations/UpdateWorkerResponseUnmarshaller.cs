    ...
    public class UpdateWorkerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AdditionalTransientProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("orientation", targetDepth))
                {
                    ...
                    response.Orientation = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("vendorProperties", targetDepth))
                {
                    ...
                    response.VendorProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
