...
namespace Amazon.IoTRoboRunner.Model
{
    ...
    internal sealed partial class ListDestinationsPaginator : IPaginator<ListDestinationsResponse>, IListDestinationsPaginator
    {
        ...
        public IPaginatedEnumerable<Destination> Destinations => 
            new PaginatedResultKeyResponse<ListDestinationsResponse, Destination>(this, (i) => i.Destinations);

        internal ListDestinationsPaginator(IAmazonIoTRoboRunner client, ListDestinationsRequest request)
        {
            this._client = client;
