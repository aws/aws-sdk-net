...
namespace Amazon.IoTRoboRunner
{
    ...
    public partial class AmazonIoTRoboRunnerClient : AmazonServiceClient, IAmazonIoTRoboRunner
    {
        ...
        internal virtual CreateWorkerFleetResponse CreateWorkerFleet(CreateWorkerFleetRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual DeleteWorkerFleetResponse DeleteWorkerFleet(DeleteWorkerFleetRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual GetWorkerFleetResponse GetWorkerFleet(GetWorkerFleetRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual ListWorkerFleetsResponse ListWorkerFleets(ListWorkerFleetsRequest request)
        {
            var options = new InvokeOptions();
        ...
        internal virtual UpdateWorkerFleetResponse UpdateWorkerFleet(UpdateWorkerFleetRequest request)
        {
            var options = new InvokeOptions();
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonIoTRoboRunnerEndpointResolver();
