...
{
    /// <summary>
    /// Container for the parameters to the BatchGetUserAccessTasks operation. Gets user access
    /// details in a batch request. <para> This action polls data from the tasks that are
    /// kicked off by the <c>StartUserAccessTasks</c> action. </para>
    /// </summary>
    public partial class BatchGetUserAccessTasksRequest : AmazonAppFabricRequest
    {
        ...
        public List<string> TaskIdList { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the TaskIdList property is set.
        /// </summary>
        internal bool IsSetTaskIdList() => this.TaskIdList != null && (this.TaskIdList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
