...
namespace Amazon.AppFabric.Model
{
    ...
    public partial class ListIngestionsResponse : AmazonWebServiceResponse
    {
        ...
        public List<IngestionSummary> Ingestions { get; set; } = AWSConfigs.InitializeCollections ? new List<IngestionSummary>() : null;

        /// <summary>
        /// Checks to see if the Ingestions property is set.
        /// </summary>
        internal bool IsSetIngestions() => this.Ingestions != null && (this.Ingestions.Count > 0 || !AWSConfigs.InitializeCollections);
