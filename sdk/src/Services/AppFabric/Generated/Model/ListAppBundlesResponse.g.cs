...
namespace Amazon.AppFabric.Model
{
    ...
    public partial class ListAppBundlesResponse : AmazonWebServiceResponse
    {
        ...
        public List<AppBundleSummary> AppBundleSummaryList { get; set; } = AWSConfigs.InitializeCollections ? new List<AppBundleSummary>() : null;

        /// <summary>
        /// Checks to see if the AppBundleSummaryList property is set.
        /// </summary>
        internal bool IsSetAppBundleSummaryList() => this.AppBundleSummaryList != null && (this.AppBundleSummaryList.Count > 0 || !AWSConfigs.InitializeCollections);
