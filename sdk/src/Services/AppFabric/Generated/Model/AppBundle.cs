...
namespace Amazon.AppFabric.Model
{
    ...
    {
        private string _arn;
        private string _customerManagedKeyArn;
        ...
        {
            get { return this._customerManagedKeyArn; }
            set { this._customerManagedKeyArn = value; }
        }

        // Check to see if CustomerManagedKeyArn property is set
        internal bool IsSetCustomerManagedKeyArn()
        {
            return this._customerManagedKeyArn != null;
        }
