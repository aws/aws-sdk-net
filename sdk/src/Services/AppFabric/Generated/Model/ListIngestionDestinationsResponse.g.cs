...
namespace Amazon.AppFabric.Model
{
    ...
    public partial class ListIngestionDestinationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<IngestionDestinationSummary> IngestionDestinations { get; set; } = AWSConfigs.InitializeCollections ? new List<IngestionDestinationSummary>() : null;

        /// <summary>
        /// Checks to see if the IngestionDestinations property is set.
        /// </summary>
        internal bool IsSetIngestionDestinations() => this.IngestionDestinations != null && (this.IngestionDestinations.Count > 0 || !AWSConfigs.InitializeCollections);
