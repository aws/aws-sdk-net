...
{
    /// <summary>
    /// Container for the parameters to the StartUserAccessTasks operation. Starts the tasks
    /// to search user access status for a specific email address. <para> The tasks are stopped
    /// when the user access status data is found. The tasks are terminated when the API calls
    /// to the application time out. </para>
    /// </summary>
    public partial class StartUserAccessTasksRequest : AmazonAppFabricRequest
    {
        ...
        /// </para>
        /// </summary>
        [AWSProperty(Required = true, Sensitive = true, Max = 320)]
