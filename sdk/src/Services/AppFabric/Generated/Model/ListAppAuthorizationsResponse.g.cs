...
namespace Amazon.AppFabric.Model
{
    ...
    public partial class ListAppAuthorizationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<AppAuthorizationSummary> AppAuthorizationSummaryList { get; set; } = AWSConfigs.InitializeCollections ? new List<AppAuthorizationSummary>() : null;

        /// <summary>
        /// Checks to see if the AppAuthorizationSummaryList property is set.
        /// </summary>
        internal bool IsSetAppAuthorizationSummaryList() => this.AppAuthorizationSummaryList != null && (this.AppAuthorizationSummaryList.Count > 0 || !AWSConfigs.InitializeCollections);
