...
{
    /// <summary>
    /// Container for the parameters to the CreateAppAuthorization operation. Creates an app
    /// authorization within an app bundle, which allows AppFabric to connect to an application.
    /// </summary>
    public partial class CreateAppAuthorizationRequest : AmazonAppFabricRequest
    {
        /// <summary>
        ...
        ///  
        /// <para>
        /// Specify credentials that match the authorization type for your request. For example,
        /// if the authorization type for your request is OAuth2 (<c>oauth2</c>), then you should
