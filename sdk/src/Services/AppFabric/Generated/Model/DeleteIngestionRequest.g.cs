...
{
    /// <summary>
    /// Container for the parameters to the DeleteIngestion operation. Deletes an ingestion.
    /// You must stop (disable) the ingestion and you must delete all associated ingestion
