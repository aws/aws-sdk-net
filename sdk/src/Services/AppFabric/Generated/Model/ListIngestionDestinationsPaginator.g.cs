...
namespace Amazon.AppFabric.Model
{
    ...
    /// </summary>
    internal sealed partial class ListIngestionDestinationsPaginator : IPaginator<ListIngestionDestinationsResponse>, IListIngestionDestinationsPaginator
    {
        private readonly IAmazonAppFabric _client;
        private readonly ListIngestionDestinationsRequest _request;
        private int _isPaginatorInUse = 0;

        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListIngestionDestinationsResponse> Responses => new PaginatedResponse<ListIngestionDestinationsResponse>(this);
...
#if NETFRAMEWORK
        IEnumerable<ListIngestionDestinationsResponse> IPaginator<ListIngestionDestinationsResponse>.Paginate()
        {
            ...
            ListIngestionDestinationsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListIngestionDestinations(_request);
        ...
        async IAsyncEnumerable<ListIngestionDestinationsResponse> IPaginator<ListIngestionDestinationsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListIngestionDestinationsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
