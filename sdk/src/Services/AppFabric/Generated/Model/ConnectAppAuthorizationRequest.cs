...
{
    /// <summary>
    /// Container for the parameters to the ConnectAppAuthorization operation.
    ...
    /// </summary>
    public partial class ConnectAppAuthorizationRequest : AmazonAppFabricRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property AuthRequest. 
        /// <para>
        ...
        {
            get { return this._authRequest; }
            set { this._authRequest = value; }
        }

        // Check to see if AuthRequest property is set
        internal bool IsSetAuthRequest()
        {
