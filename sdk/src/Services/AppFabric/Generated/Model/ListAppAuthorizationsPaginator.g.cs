...
namespace Amazon.AppFabric.Model
{
    ...
    /// </summary>
    internal sealed partial class ListAppAuthorizationsPaginator : IPaginator<ListAppAuthorizationsResponse>, IListAppAuthorizationsPaginator
    {
        private readonly IAmazonAppFabric _client;
        private readonly ListAppAuthorizationsRequest _request;
        private int _isPaginatorInUse = 0;

        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListAppAuthorizationsResponse> Responses => new PaginatedResponse<ListAppAuthorizationsResponse>(this);
...
#if NETFRAMEWORK
        IEnumerable<ListAppAuthorizationsResponse> IPaginator<ListAppAuthorizationsResponse>.Paginate()
        {
            ...
            ListAppAuthorizationsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListAppAuthorizations(_request);
        ...
        async IAsyncEnumerable<ListAppAuthorizationsResponse> IPaginator<ListAppAuthorizationsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListAppAuthorizationsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
