...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAppBundleRequestMarshaller : IMarshaller<IRequest, CreateAppBundleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateAppBundleRequestMarshaller _instance = new();

        internal static CreateAppBundleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAppBundleRequestMarshaller Instance => _instance;
    }
}
