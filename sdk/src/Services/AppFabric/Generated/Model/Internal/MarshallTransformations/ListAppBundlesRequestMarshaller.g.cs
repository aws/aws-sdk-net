...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppBundlesRequestMarshaller : IMarshaller<IRequest, ListAppBundlesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppBundlesRequestMarshaller _instance = new();

        internal static ListAppBundlesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppBundlesRequestMarshaller Instance => _instance;
    }
}
