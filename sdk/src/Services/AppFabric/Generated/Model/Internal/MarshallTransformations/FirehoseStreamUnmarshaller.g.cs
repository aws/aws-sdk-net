...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FirehoseStreamUnmarshaller : IJsonUnmarshaller<FirehoseStream, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FirehoseStream();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FirehoseStreamUnmarshaller Instance => _instance;
    }
}
