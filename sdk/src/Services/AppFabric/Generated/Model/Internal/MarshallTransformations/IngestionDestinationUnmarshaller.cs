...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IngestionDestinationUnmarshaller : IJsonUnmarshaller<IngestionDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IngestionDestination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ingestionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IngestionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
