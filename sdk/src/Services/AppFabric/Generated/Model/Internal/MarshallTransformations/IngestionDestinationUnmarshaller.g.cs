...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IngestionDestinationUnmarshaller : IJsonUnmarshaller<IngestionDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IngestionDestination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IngestionDestinationUnmarshaller Instance => _instance;
    }
}
