...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateIngestionRequestMarshaller : IMarshaller<IRequest, CreateIngestionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateIngestionRequestMarshaller _instance = new();

        internal static CreateIngestionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateIngestionRequestMarshaller Instance => _instance;
    }
}
