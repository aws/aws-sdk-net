...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DestinationUnmarshaller : IJsonUnmarshaller<Destination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Destination();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DestinationUnmarshaller Instance => _instance;
    }
}
