...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAppAuthorizationRequestMarshaller : IMarshaller<IRequest, GetAppAuthorizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAppAuthorizationRequestMarshaller _instance = new();

        internal static GetAppAuthorizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAppAuthorizationRequestMarshaller Instance => _instance;
    }
}
