...
{
    /// <summary>
    /// GetIngestionDestination Request Marshaller
    /// </summary>       
    public class GetIngestionDestinationRequestMarshaller : IMarshaller<IRequest, GetIngestionDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIngestionDestinationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIngestionDestinationRequest publicRequest)
        {
        ...
        private static GetIngestionDestinationRequestMarshaller _instance = new GetIngestionDestinationRequestMarshaller();        

        internal static GetIngestionDestinationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIngestionDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
