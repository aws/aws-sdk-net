...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuditLogDestinationConfigurationUnmarshaller : IJsonUnmarshaller<AuditLogDestinationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AuditLogDestinationConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AuditLogDestinationConfigurationUnmarshaller Instance => _instance;
    }
}
