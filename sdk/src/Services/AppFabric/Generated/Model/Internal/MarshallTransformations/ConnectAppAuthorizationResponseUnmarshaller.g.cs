...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectAppAuthorizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ConnectAppAuthorizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("appAuthorizationSummary", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AppAuthorizationSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ConnectAppAuthorizationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ConnectAppAuthorizationResponseUnmarshaller Instance => _instance;
    }
}
