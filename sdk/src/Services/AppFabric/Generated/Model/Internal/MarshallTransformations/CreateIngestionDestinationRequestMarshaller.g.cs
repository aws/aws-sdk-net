...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateIngestionDestinationRequestMarshaller : IMarshaller<IRequest, CreateIngestionDestinationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateIngestionDestinationRequestMarshaller _instance = new();

        internal static CreateIngestionDestinationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateIngestionDestinationRequestMarshaller Instance => _instance;
    }
}
