...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIngestionDestination operation
    /// </summary>  
    public class UpdateIngestionDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIngestionDestinationResponse response = new UpdateIngestionDestinationResponse();
        ...
        private static UpdateIngestionDestinationResponseUnmarshaller _instance = new UpdateIngestionDestinationResponseUnmarshaller();        

        internal static UpdateIngestionDestinationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIngestionDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
