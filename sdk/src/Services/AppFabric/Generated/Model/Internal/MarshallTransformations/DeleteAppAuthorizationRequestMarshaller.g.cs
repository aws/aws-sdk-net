...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAppAuthorizationRequestMarshaller : IMarshaller<IRequest, DeleteAppAuthorizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAppAuthorizationRequestMarshaller _instance = new();

        internal static DeleteAppAuthorizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAppAuthorizationRequestMarshaller Instance => _instance;
    }
}
