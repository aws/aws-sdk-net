...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetIngestionDestinationRequestMarshaller : IMarshaller<IRequest, GetIngestionDestinationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetIngestionDestinationRequestMarshaller _instance = new();

        internal static GetIngestionDestinationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetIngestionDestinationRequestMarshaller Instance => _instance;
    }
}
