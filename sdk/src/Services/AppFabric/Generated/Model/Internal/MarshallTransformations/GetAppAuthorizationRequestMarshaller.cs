...
{
    /// <summary>
    /// GetAppAuthorization Request Marshaller
    /// </summary>       
    public class GetAppAuthorizationRequestMarshaller : IMarshaller<IRequest, GetAppAuthorizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAppAuthorizationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAppAuthorizationRequest publicRequest)
        {
        ...
        private static GetAppAuthorizationRequestMarshaller _instance = new GetAppAuthorizationRequestMarshaller();        

        internal static GetAppAuthorizationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAppAuthorizationRequestMarshaller Instance
        {
            get
            {
                return _instance;
