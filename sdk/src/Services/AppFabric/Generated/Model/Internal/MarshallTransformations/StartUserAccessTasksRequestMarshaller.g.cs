...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartUserAccessTasksRequestMarshaller : IMarshaller<IRequest, StartUserAccessTasksRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartUserAccessTasksRequestMarshaller _instance = new();

        internal static StartUserAccessTasksRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartUserAccessTasksRequestMarshaller Instance => _instance;
    }
}
