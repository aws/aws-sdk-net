...
{
    /// <summary>
    /// ListIngestions Request Marshaller
    /// </summary>
    public partial class ListIngestionsRequestMarshaller : IMarshaller<IRequest, ListIngestionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListIngestionsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListIngestionsRequest publicRequest)
        {
        ...
        private static readonly ListIngestionsRequestMarshaller _instance = new();

        internal static ListIngestionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListIngestionsRequestMarshaller Instance => _instance;
    }
}
