...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetIngestionRequestMarshaller : IMarshaller<IRequest, GetIngestionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetIngestionRequestMarshaller _instance = new();

        internal static GetIngestionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetIngestionRequestMarshaller Instance => _instance;
    }
}
