...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAppAuthorizationRequestMarshaller : IMarshaller<IRequest, CreateAppAuthorizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateAppAuthorizationRequestMarshaller _instance = new();

        internal static CreateAppAuthorizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAppAuthorizationRequestMarshaller Instance => _instance;
    }
}
