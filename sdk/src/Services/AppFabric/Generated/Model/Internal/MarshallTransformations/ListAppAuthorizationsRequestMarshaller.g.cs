...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppAuthorizationsRequestMarshaller : IMarshaller<IRequest, ListAppAuthorizationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppAuthorizationsRequestMarshaller _instance = new();

        internal static ListAppAuthorizationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppAuthorizationsRequestMarshaller Instance => _instance;
    }
}
