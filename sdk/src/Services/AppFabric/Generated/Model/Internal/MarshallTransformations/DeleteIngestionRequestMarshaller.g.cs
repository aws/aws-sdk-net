...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteIngestionRequestMarshaller : IMarshaller<IRequest, DeleteIngestionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteIngestionRequestMarshaller _instance = new();

        internal static DeleteIngestionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteIngestionRequestMarshaller Instance => _instance;
    }
}
