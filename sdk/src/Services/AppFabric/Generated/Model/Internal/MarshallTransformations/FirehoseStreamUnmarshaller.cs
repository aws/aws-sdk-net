...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FirehoseStreamUnmarshaller : IJsonUnmarshaller<FirehoseStream, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FirehoseStream Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
