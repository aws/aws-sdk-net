...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateIngestionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateIngestionResponse();
            ...
            {
                if (context.TestExpression("ingestion", targetDepth, ref reader))
                {
                    var unmarshaller = IngestionUnmarshaller.Instance;
                    unmarshalledObject.Ingestion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateIngestionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateIngestionResponseUnmarshaller Instance => _instance;
    }
}
