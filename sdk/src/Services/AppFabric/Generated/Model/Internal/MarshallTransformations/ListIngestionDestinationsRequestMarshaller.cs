...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListIngestionDestinationsRequestMarshaller : IMarshaller<IRequest, ListIngestionDestinationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListIngestionDestinationsRequestMarshaller _instance = new ListIngestionDestinationsRequestMarshaller();        

        internal static ListIngestionDestinationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIngestionDestinationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
