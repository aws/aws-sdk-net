...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectAppAuthorizationRequestMarshaller : IMarshaller<IRequest, ConnectAppAuthorizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ConnectAppAuthorizationRequestMarshaller _instance = new();

        internal static ConnectAppAuthorizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ConnectAppAuthorizationRequestMarshaller Instance => _instance;
    }
}
