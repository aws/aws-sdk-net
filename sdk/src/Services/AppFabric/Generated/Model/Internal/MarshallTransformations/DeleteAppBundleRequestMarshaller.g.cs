...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAppBundleRequestMarshaller : IMarshaller<IRequest, DeleteAppBundleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAppBundleRequestMarshaller _instance = new();

        internal static DeleteAppBundleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAppBundleRequestMarshaller Instance => _instance;
    }
}
