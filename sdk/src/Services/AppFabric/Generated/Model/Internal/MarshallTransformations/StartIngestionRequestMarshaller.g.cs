...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartIngestionRequestMarshaller : IMarshaller<IRequest, StartIngestionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartIngestionRequestMarshaller _instance = new();

        internal static StartIngestionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartIngestionRequestMarshaller Instance => _instance;
    }
}
