...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StopIngestionRequestMarshaller : IMarshaller<IRequest, StopIngestionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StopIngestionRequestMarshaller _instance = new();

        internal static StopIngestionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopIngestionRequestMarshaller Instance => _instance;
    }
}
