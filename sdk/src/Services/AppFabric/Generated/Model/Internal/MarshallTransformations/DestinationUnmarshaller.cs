...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DestinationUnmarshaller : IJsonUnmarshaller<Destination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Destination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("firehoseStream", targetDepth, ref reader))
                {
                    var unmarshaller = FirehoseStreamUnmarshaller.Instance;
                    unmarshalledObject.FirehoseStream = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
