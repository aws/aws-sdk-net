...
{
    /// <summary>
    /// ListIngestionDestinations Request Marshaller
    /// </summary>
    public partial class ListIngestionDestinationsRequestMarshaller : IMarshaller<IRequest, ListIngestionDestinationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListIngestionDestinationsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListIngestionDestinationsRequest publicRequest)
        {
        ...
        private static readonly ListIngestionDestinationsRequestMarshaller _instance = new();

        internal static ListIngestionDestinationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListIngestionDestinationsRequestMarshaller Instance => _instance;
    }
}
