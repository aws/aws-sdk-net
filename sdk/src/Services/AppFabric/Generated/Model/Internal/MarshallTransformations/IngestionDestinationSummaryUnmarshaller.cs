...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IngestionDestinationSummaryUnmarshaller : IJsonUnmarshaller<IngestionDestinationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IngestionDestinationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
