...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AuditLogProcessingConfigurationUnmarshaller : IJsonUnmarshaller<AuditLogProcessingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AuditLogProcessingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AuditLogProcessingConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AuditLogProcessingConfigurationUnmarshaller Instance => _instance;
    }
}
