...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAppAuthorizationRequestMarshaller : IMarshaller<IRequest, UpdateAppAuthorizationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAppAuthorizationRequestMarshaller _instance = new();

        internal static UpdateAppAuthorizationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAppAuthorizationRequestMarshaller Instance => _instance;
    }
}
