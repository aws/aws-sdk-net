...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetUserAccessTasksRequestMarshaller : IMarshaller<IRequest, BatchGetUserAccessTasksRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchGetUserAccessTasksRequestMarshaller _instance = new();

        internal static BatchGetUserAccessTasksRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetUserAccessTasksRequestMarshaller Instance => _instance;
    }
}
