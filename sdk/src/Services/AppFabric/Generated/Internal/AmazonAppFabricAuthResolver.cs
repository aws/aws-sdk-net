...
namespace Amazon.AppFabric.Internal
{
    ...
    public class AmazonAppFabricAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppFabricAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppFabric.
        /// </summary>
        public AmazonAppFabricAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppFabricAuthSchemeParameters
            {
    ...
    public class AmazonAppFabricAuthSchemeResolver : IAuthSchemeResolver<AmazonAppFabricAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppFabricAuthSchemeParameters authParameters)
        {
