...
namespace Amazon.AppFabric
{
    ...
    public partial class AmazonAppFabricConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("AppFabric", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "AppFabric";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "appfabric";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2023-05-19";
