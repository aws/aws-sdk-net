...
namespace Amazon.Macie.Model.Internal.MarshallTransformations
{
    ...
    public class S3ResourceClassificationMarshaller : IRequestMarshaller<S3ResourceClassification, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(S3ResourceClassification requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetClassificationType())
            {
                context.Writer.WritePropertyName("classificationType");
                context.Writer.WriteObjectStart();

                var marshaller = ClassificationTypeMarshaller.Instance;
                marshaller.Marshall(requestObject.ClassificationType, context);
