...
namespace Amazon.LaunchWizard.Model
{
    ...
    {
        /// <summary>
        /// Gets and sets the property ServicePrincipal. The service principal for which the account
        /// must be a delegated administrator. For example, `stacksets.cloudformation.amazonaws.com`.
        /// </summary>
