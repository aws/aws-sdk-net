...
{
    /// <summary>
    /// Base class for ListWorkloads paginators.
    /// </summary>
    internal sealed partial class ListWorkloadsPaginator : IPaginator<ListWorkloadsResponse>, IListWorkloadsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ListWorkloadsResponse> Responses => new PaginatedResponse<ListWorkloadsResponse>(this);
...
#if BCL
        IEnumerable<ListWorkloadsResponse> IPaginator<ListWorkloadsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListWorkloads(_request);
        ...
        async IAsyncEnumerable<ListWorkloadsResponse> IPaginator<ListWorkloadsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
