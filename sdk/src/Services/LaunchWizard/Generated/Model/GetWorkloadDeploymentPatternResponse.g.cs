...
namespace Amazon.LaunchWizard.Model
{
    ...
    public partial class GetWorkloadDeploymentPatternResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public WorkloadDeploymentPatternData WorkloadDeploymentPattern { get; set; }

        /// <summary>
        /// Checks to see if the WorkloadDeploymentPattern property is set.
        /// </summary>
        internal bool IsSetWorkloadDeploymentPattern() => this.WorkloadDeploymentPattern != null;
    }
}
