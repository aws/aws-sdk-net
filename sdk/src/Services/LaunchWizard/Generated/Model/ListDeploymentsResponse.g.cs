...
namespace Amazon.LaunchWizard.Model
{
    ...
    public partial class ListDeploymentsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<DeploymentDataSummary> Deployments { get; set; } = AWSConfigs.InitializeCollections ? new List<DeploymentDataSummary>() : null;

        /// <summary>
        /// Checks to see if the Deployments property is set.
        /// </summary>
        internal bool IsSetDeployments() => this.Deployments != null && (this.Deployments.Count > 0 || !AWSConfigs.InitializeCollections);
