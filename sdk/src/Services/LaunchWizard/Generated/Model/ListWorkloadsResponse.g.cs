...
namespace Amazon.LaunchWizard.Model
{
    ...
    public partial class ListWorkloadsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<WorkloadDataSummary> Workloads { get; set; } = AWSConfigs.InitializeCollections ? new List<WorkloadDataSummary>() : null;

        /// <summary>
        /// Checks to see if the Workloads property is set.
        /// </summary>
        internal bool IsSetWorkloads() => this.Workloads != null && (this.Workloads.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
