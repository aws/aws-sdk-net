...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDeploymentRequestMarshaller : IMarshaller<IRequest, GetDeploymentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDeploymentRequestMarshaller _instance = new();

        internal static GetDeploymentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeploymentRequestMarshaller Instance => _instance;
    }
}
