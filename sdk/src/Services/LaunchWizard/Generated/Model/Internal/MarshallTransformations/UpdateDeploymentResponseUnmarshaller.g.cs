...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDeploymentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateDeploymentResponse();
        ...
        internal static UpdateDeploymentResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDeploymentResponseUnmarshaller Instance => _instance;
    }
}
