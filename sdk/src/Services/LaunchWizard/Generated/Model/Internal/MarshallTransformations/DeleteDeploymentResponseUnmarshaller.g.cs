...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteDeploymentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteDeploymentResponse();
        ...
        internal static DeleteDeploymentResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteDeploymentResponseUnmarshaller Instance => _instance;
    }
}
