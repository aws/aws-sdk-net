...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteDeploymentRequestMarshaller : IMarshaller<IRequest, DeleteDeploymentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteDeploymentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/deleteDeployment";
#if !NETFRAMEWORK
        ...
        private static readonly DeleteDeploymentRequestMarshaller _instance = new();

        internal static DeleteDeploymentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteDeploymentRequestMarshaller Instance => _instance;
    }
}
