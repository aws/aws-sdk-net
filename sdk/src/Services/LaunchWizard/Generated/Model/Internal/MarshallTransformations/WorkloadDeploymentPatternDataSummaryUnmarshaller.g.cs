...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WorkloadDeploymentPatternDataSummaryUnmarshaller : IJsonUnmarshaller<WorkloadDeploymentPatternDataSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WorkloadDeploymentPatternDataSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static WorkloadDeploymentPatternDataSummaryUnmarshaller Instance => _instance;
    }
}
