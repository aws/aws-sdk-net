...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WorkloadDataSummaryUnmarshaller : IJsonUnmarshaller<WorkloadDataSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WorkloadDataSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static WorkloadDataSummaryUnmarshaller Instance => _instance;
    }
}
