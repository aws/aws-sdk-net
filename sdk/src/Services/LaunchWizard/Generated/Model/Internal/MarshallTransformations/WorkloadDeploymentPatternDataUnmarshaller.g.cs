...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WorkloadDeploymentPatternDataUnmarshaller : IJsonUnmarshaller<WorkloadDeploymentPatternData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WorkloadDeploymentPatternData();
        ...
        /// Gets the singleton.
        /// </summary>
        public static WorkloadDeploymentPatternDataUnmarshaller Instance => _instance;
    }
}
