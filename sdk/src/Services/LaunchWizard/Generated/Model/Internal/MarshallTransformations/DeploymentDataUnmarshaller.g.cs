...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeploymentDataUnmarshaller : IJsonUnmarshaller<DeploymentData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeploymentData();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeploymentDataUnmarshaller Instance => _instance;
    }
}
