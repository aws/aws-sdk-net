...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeploymentSpecificationsFieldUnmarshaller : IUnmarshaller<DeploymentSpecificationsField, XmlUnmarshallerContext>, IUnmarshaller<DeploymentSpecificationsField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DeploymentSpecificationsField IUnmarshaller<DeploymentSpecificationsField, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DeploymentSpecificationsField Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DeploymentConditionalField, DeploymentConditionalFieldUnmarshaller>(DeploymentConditionalFieldUnmarshaller.Instance);
                    unmarshalledObject.Conditionals = unmarshaller.Unmarshall(context);
                    continue;
                }
