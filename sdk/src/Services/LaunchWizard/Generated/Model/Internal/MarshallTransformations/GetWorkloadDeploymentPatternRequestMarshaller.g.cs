...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetWorkloadDeploymentPatternRequestMarshaller : IMarshaller<IRequest, GetWorkloadDeploymentPatternRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetWorkloadDeploymentPatternRequestMarshaller _instance = new();

        internal static GetWorkloadDeploymentPatternRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetWorkloadDeploymentPatternRequestMarshaller Instance => _instance;
    }
}
