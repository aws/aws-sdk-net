...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeploymentSpecificationsFieldUnmarshaller : IJsonUnmarshaller<DeploymentSpecificationsField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeploymentSpecificationsField();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("conditionals", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeploymentSpecificationsFieldUnmarshaller Instance => _instance;
    }
}
