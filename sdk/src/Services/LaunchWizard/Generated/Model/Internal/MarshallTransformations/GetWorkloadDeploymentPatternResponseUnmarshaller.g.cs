...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetWorkloadDeploymentPatternResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetWorkloadDeploymentPatternResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("workloadDeploymentPattern", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.WorkloadDeploymentPattern = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetWorkloadDeploymentPatternResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetWorkloadDeploymentPatternResponseUnmarshaller Instance => _instance;
    }
}
