...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ManagementAccountConstraintUnmarshaller : IJsonUnmarshaller<ManagementAccountConstraint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ManagementAccountConstraint();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ManagementAccountConstraintUnmarshaller Instance => _instance;
    }
}
