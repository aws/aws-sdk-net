...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDeploymentRequestMarshaller : IMarshaller<IRequest, UpdateDeploymentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateDeploymentRequestMarshaller _instance = new();

        internal static UpdateDeploymentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDeploymentRequestMarshaller Instance => _instance;
    }
}
