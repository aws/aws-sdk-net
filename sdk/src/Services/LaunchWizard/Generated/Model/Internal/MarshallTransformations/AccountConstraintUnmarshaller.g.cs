...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AccountConstraintUnmarshaller : IJsonUnmarshaller<AccountConstraint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AccountConstraint();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AccountConstraintUnmarshaller Instance => _instance;
    }
}
