...
namespace Amazon.LaunchWizard.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDeploymentPatternVersionRequestMarshaller : IMarshaller<IRequest, GetDeploymentPatternVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDeploymentPatternVersionRequestMarshaller _instance = new();

        internal static GetDeploymentPatternVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDeploymentPatternVersionRequestMarshaller Instance => _instance;
    }
}
