...
namespace Amazon.LaunchWizard
{
    ...
    public partial class AmazonLaunchWizardClient : AmazonServiceClient, IAmazonLaunchWizard
    {
        ...
        /// 
        /// </summary>
        public AmazonLaunchWizardClient() : base(new AmazonLaunchWizardConfig()) { }
        ...
        public AmazonLaunchWizardClient(RegionEndpoint region) : base(new AmazonLaunchWizardConfig { RegionEndpoint = region }) { }
        ...
        public AmazonLaunchWizardClient(AmazonLaunchWizardConfig config) : base(config) { }
