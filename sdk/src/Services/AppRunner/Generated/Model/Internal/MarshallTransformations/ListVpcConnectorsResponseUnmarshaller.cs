    ...
    public class ListVpcConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VpcConnectors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<VpcConnector, VpcConnectorUnmarshaller>(VpcConnectorUnmarshaller.Instance);
                    response.VpcConnectors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
