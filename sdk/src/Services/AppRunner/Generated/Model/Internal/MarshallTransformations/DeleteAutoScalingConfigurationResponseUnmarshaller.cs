...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAutoScalingConfiguration operation
    /// </summary>  
    public class DeleteAutoScalingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAutoScalingConfigurationResponse response = new DeleteAutoScalingConfigurationResponse();
        ...
        private static DeleteAutoScalingConfigurationResponseUnmarshaller _instance = new DeleteAutoScalingConfigurationResponseUnmarshaller();        

        internal static DeleteAutoScalingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAutoScalingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
