...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDefaultAutoScalingConfiguration operation
    /// </summary>  
    public class UpdateDefaultAutoScalingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDefaultAutoScalingConfigurationResponse response = new UpdateDefaultAutoScalingConfigurationResponse();
        ...
        private static UpdateDefaultAutoScalingConfigurationResponseUnmarshaller _instance = new UpdateDefaultAutoScalingConfigurationResponseUnmarshaller();        

        internal static UpdateDefaultAutoScalingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDefaultAutoScalingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
