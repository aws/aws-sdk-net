...
{
    /// <summary>
    /// Response Unmarshaller for CreateVpcConnector operation
    /// </summary>  
    public class CreateVpcConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateVpcConnectorResponse response = new CreateVpcConnectorResponse();
        ...
        private static CreateVpcConnectorResponseUnmarshaller _instance = new CreateVpcConnectorResponseUnmarshaller();        

        internal static CreateVpcConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVpcConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
