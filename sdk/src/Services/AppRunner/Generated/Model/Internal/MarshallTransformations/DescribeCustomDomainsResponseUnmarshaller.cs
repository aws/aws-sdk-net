    ...
    public class DescribeCustomDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CustomDomain, CustomDomainUnmarshaller>(CustomDomainUnmarshaller.Instance);
                    response.CustomDomains = unmarshaller.Unmarshall(context);
                    continue;
                }
