...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceConfigurationUnmarshaller : IJsonUnmarshaller<InstanceConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("InstanceRoleArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
