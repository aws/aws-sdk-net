...
{
    /// <summary>
    /// CreateExport Request Marshaller
    /// </summary>       
    public class CreateExportRequestMarshaller : IMarshaller<IRequest, CreateExportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateExportRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateExportRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.BCMDataExports");
            string target = "AWSBillingAndCostManagementDataExports.CreateExport";
        ...
        private static CreateExportRequestMarshaller _instance = new CreateExportRequestMarshaller();        

        internal static CreateExportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExportRequestMarshaller Instance
        {
            get
            {
                return _instance;
