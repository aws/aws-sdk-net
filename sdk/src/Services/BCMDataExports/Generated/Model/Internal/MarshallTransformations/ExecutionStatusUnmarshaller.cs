...
namespace Amazon.BCMDataExports.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionStatusUnmarshaller : IJsonUnmarshaller<ExecutionStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExecutionStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
