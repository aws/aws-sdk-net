...
namespace Amazon.BCMDataExports.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ColumnUnmarshaller : IJsonUnmarshaller<Column, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Column Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
