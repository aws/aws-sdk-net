    ...
    public class TableUnmarshaller : IUnmarshaller<Table, XmlUnmarshallerContext>, IUnmarshaller<Table, JsonUnmarshallerContext>
    {
        ...
        public Table Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TablePropertyDescription, TablePropertyDescriptionUnmarshaller>(TablePropertyDescriptionUnmarshaller.Instance);
                    unmarshalledObject.TableProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
