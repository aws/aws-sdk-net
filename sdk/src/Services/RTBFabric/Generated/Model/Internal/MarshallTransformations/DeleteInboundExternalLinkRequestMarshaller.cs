...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteInboundExternalLinkRequestMarshaller : IMarshaller<IRequest, DeleteInboundExternalLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteInboundExternalLinkRequestMarshaller _instance = new DeleteInboundExternalLinkRequestMarshaller();        

        internal static DeleteInboundExternalLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInboundExternalLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
