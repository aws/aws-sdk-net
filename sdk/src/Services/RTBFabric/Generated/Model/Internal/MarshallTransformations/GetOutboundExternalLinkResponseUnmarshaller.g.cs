...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetOutboundExternalLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetOutboundExternalLinkResponse();
        ...
        internal static GetOutboundExternalLinkResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOutboundExternalLinkResponseUnmarshaller Instance => _instance;
    }
}
