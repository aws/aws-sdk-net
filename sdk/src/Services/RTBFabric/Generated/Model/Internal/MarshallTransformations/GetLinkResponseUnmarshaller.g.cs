...
{
    /// <summary>
    /// Response Unmarshaller for GetLink operation.
    /// </summary>
    public partial class GetLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetLinkResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("httpResponderAllowed", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.HttpResponderAllowed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetLinkResponseUnmarshaller _instance = new GetLinkResponseUnmarshaller();

        internal static GetLinkResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetLinkResponseUnmarshaller Instance => _instance;
    }
}
