...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterCriterionUnmarshaller : IJsonUnmarshaller<FilterCriterion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterCriterion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
