...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OpenRtbAttributeModuleParametersUnmarshaller : IJsonUnmarshaller<OpenRtbAttributeModuleParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new OpenRtbAttributeModuleParameters();
        ...
        /// Gets the singleton.
        /// </summary>
        public static OpenRtbAttributeModuleParametersUnmarshaller Instance => _instance;
    }
}
