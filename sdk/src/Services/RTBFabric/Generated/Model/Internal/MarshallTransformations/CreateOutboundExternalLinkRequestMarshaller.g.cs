...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateOutboundExternalLinkRequestMarshaller : IMarshaller<IRequest, CreateOutboundExternalLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateOutboundExternalLinkRequestMarshaller _instance = new();

        internal static CreateOutboundExternalLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateOutboundExternalLinkRequestMarshaller Instance => _instance;
    }
}
