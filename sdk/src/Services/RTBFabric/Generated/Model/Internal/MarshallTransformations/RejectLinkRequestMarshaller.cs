...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RejectLinkRequestMarshaller : IMarshaller<IRequest, RejectLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static RejectLinkRequestMarshaller _instance = new RejectLinkRequestMarshaller();        

        internal static RejectLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
