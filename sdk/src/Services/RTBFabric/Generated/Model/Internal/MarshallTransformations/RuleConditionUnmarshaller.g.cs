...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RuleConditionUnmarshaller : IJsonUnmarshaller<RuleCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RuleCondition();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RuleConditionUnmarshaller Instance => _instance;
    }
}
