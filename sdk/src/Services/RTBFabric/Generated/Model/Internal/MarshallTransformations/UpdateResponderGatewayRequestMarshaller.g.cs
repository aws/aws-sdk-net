...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateResponderGatewayRequestMarshaller : IMarshaller<IRequest, UpdateResponderGatewayRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateResponderGatewayRequestMarshaller _instance = new();

        internal static UpdateResponderGatewayRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateResponderGatewayRequestMarshaller Instance => _instance;
    }
}
