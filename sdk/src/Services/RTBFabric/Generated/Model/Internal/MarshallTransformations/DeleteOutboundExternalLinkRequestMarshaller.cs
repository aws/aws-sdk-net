...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteOutboundExternalLinkRequestMarshaller : IMarshaller<IRequest, DeleteOutboundExternalLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteOutboundExternalLinkRequestMarshaller _instance = new DeleteOutboundExternalLinkRequestMarshaller();        

        internal static DeleteOutboundExternalLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOutboundExternalLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
