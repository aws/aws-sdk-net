...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateInboundExternalLinkRequestMarshaller : IMarshaller<IRequest, CreateInboundExternalLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateInboundExternalLinkRequestMarshaller _instance = new CreateInboundExternalLinkRequestMarshaller();        

        internal static CreateInboundExternalLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInboundExternalLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
