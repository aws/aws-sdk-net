...
{
    /// <summary>
    /// GetLinkRoutingRule Request Marshaller
    /// </summary>       
    public class GetLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, GetLinkRoutingRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetLinkRoutingRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetLinkRoutingRuleRequest publicRequest)
        {
        ...
        private static GetLinkRoutingRuleRequestMarshaller _instance = new GetLinkRoutingRuleRequestMarshaller();        

        internal static GetLinkRoutingRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLinkRoutingRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
