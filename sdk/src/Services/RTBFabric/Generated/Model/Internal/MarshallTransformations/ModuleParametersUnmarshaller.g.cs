...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ModuleParametersUnmarshaller : IJsonUnmarshaller<ModuleParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ModuleParameters();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ModuleParametersUnmarshaller Instance => _instance;
    }
}
