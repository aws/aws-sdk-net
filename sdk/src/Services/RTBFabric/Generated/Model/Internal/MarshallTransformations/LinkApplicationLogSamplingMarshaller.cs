    ...
    public class LinkApplicationLogSamplingMarshaller : IRequestMarshaller<LinkApplicationLogSampling, JsonMarshallerContext> 
    {
        ...
        public void Marshall(LinkApplicationLogSampling requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetErrorLog())
            {
                ...
                if(StringUtils.IsSpecialDoubleValue(requestObject.ErrorLog))
                {
                    context.Writer.Write(StringUtils.FromSpecialDoubleValue(requestObject.ErrorLog));
                }
                else
                {
                    context.Writer.Write(requestObject.ErrorLog);
                }
            }
            ...
            if(requestObject.IsSetFilterLog())
            {
                ...
                if(StringUtils.IsSpecialDoubleValue(requestObject.FilterLog))
                {
                    context.Writer.Write(StringUtils.FromSpecialDoubleValue(requestObject.FilterLog));
                }
                else
                {
                    context.Writer.Write(requestObject.FilterLog);
                }
            }
