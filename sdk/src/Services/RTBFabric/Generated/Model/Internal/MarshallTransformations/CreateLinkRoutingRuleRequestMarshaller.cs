...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, CreateLinkRoutingRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateLinkRoutingRuleRequestMarshaller _instance = new CreateLinkRoutingRuleRequestMarshaller();        

        internal static CreateLinkRoutingRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLinkRoutingRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
