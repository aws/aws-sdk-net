...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpenRtbAttributeModuleParametersUnmarshaller : IJsonUnmarshaller<OpenRtbAttributeModuleParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpenRtbAttributeModuleParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
