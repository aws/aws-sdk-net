...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateLinkModuleFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateLinkModuleFlowResponse();
        ...
        internal static UpdateLinkModuleFlowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateLinkModuleFlowResponseUnmarshaller Instance => _instance;
    }
}
