...
{
    /// <summary>
    /// Response Unmarshaller for CreateLinkRoutingRule operation
    /// </summary>  
    public class CreateLinkRoutingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLinkRoutingRuleResponse response = new CreateLinkRoutingRuleResponse();
        ...
        private static CreateLinkRoutingRuleResponseUnmarshaller _instance = new CreateLinkRoutingRuleResponseUnmarshaller();        

        internal static CreateLinkRoutingRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLinkRoutingRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
