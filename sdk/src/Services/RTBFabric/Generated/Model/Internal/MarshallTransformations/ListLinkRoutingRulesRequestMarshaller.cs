...
{
    /// <summary>
    /// ListLinkRoutingRules Request Marshaller
    /// </summary>       
    public class ListLinkRoutingRulesRequestMarshaller : IMarshaller<IRequest, ListLinkRoutingRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLinkRoutingRulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListLinkRoutingRulesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/responder-gateway/{gatewayId}/link/{linkId}/routing-rules";
            request.UseQueryString = true;

            return request;
        }
        private static ListLinkRoutingRulesRequestMarshaller _instance = new ListLinkRoutingRulesRequestMarshaller();        

        internal static ListLinkRoutingRulesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLinkRoutingRulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
