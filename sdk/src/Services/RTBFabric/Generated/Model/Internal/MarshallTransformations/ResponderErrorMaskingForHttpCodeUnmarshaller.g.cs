...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResponderErrorMaskingForHttpCodeUnmarshaller : IJsonUnmarshaller<ResponderErrorMaskingForHttpCode, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ResponderErrorMaskingForHttpCode();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResponderErrorMaskingForHttpCodeUnmarshaller Instance => _instance;
    }
}
