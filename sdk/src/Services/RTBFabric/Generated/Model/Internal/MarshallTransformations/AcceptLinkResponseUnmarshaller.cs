...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AcceptLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptLinkResponse response = new AcceptLinkResponse();
        ...
        internal static AcceptLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
