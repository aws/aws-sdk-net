...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, GetLinkRoutingRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetLinkRoutingRuleRequestMarshaller _instance = new();

        internal static GetLinkRoutingRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetLinkRoutingRuleRequestMarshaller Instance => _instance;
    }
}
