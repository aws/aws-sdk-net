...
{
    /// <summary>
    /// RejectLink Request Marshaller
    /// </summary>
    public partial class RejectLinkRequestMarshaller : IMarshaller<IRequest, RejectLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RejectLinkRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(RejectLinkRequest publicRequest)
        {
            ...
            request.ResourcePath = "/gateway/{gatewayId}/link/{linkId}/reject";

            return request;
        }

        private static readonly RejectLinkRequestMarshaller _instance = new();

        internal static RejectLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RejectLinkRequestMarshaller Instance => _instance;
    }
}
