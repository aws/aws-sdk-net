...
{
    /// <summary>
    /// CreateLinkRoutingRule Request Marshaller
    /// </summary>
    public partial class CreateLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, CreateLinkRoutingRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLinkRoutingRuleRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateLinkRoutingRuleRequest publicRequest)
        {
            ...
            request.ResourcePath = "/responder-gateway/{gatewayId}/link/{linkId}/routing-rule";
#if !NETFRAMEWORK
        ...
        private static readonly CreateLinkRoutingRuleRequestMarshaller _instance = new();

        internal static CreateLinkRoutingRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateLinkRoutingRuleRequestMarshaller Instance => _instance;
    }
}
