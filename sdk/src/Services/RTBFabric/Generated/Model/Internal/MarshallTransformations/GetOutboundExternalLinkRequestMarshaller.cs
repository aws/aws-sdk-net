...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetOutboundExternalLinkRequestMarshaller : IMarshaller<IRequest, GetOutboundExternalLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetOutboundExternalLinkRequestMarshaller _instance = new GetOutboundExternalLinkRequestMarshaller();        

        internal static GetOutboundExternalLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOutboundExternalLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
