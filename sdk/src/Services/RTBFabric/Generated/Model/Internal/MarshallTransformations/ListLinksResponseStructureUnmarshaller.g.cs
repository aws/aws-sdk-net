...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListLinksResponseStructureUnmarshaller : IJsonUnmarshaller<ListLinksResponseStructure, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListLinksResponseStructure();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ListLinksResponseStructureUnmarshaller Instance => _instance;
    }
}
