...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class QueryStringKeyValuePairUnmarshaller : IJsonUnmarshaller<QueryStringKeyValuePair, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new QueryStringKeyValuePair();
        ...
        /// Gets the singleton.
        /// </summary>
        public static QueryStringKeyValuePairUnmarshaller Instance => _instance;
    }
}
