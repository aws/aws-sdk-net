...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateResponderGatewayRequestMarshaller : IMarshaller<IRequest, CreateResponderGatewayRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateResponderGatewayRequestMarshaller _instance = new();

        internal static CreateResponderGatewayRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateResponderGatewayRequestMarshaller Instance => _instance;
    }
}
