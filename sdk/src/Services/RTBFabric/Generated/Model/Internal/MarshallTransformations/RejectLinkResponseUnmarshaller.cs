...
{
    /// <summary>
    /// Response Unmarshaller for RejectLink operation
    /// </summary>  
    public class RejectLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectLinkResponse response = new RejectLinkResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("direction", targetDepth))
                {
                    ...
                    response.Direction = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("flowModules", targetDepth))
                {
                    ...
                    response.FlowModules = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LinkId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("peerGatewayId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PeerGatewayId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("pendingFlowModules", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ModuleConfiguration, ModuleConfigurationUnmarshaller>(ModuleConfigurationUnmarshaller.Instance);
                    response.PendingFlowModules = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static RejectLinkResponseUnmarshaller _instance = new RejectLinkResponseUnmarshaller();        

        internal static RejectLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
