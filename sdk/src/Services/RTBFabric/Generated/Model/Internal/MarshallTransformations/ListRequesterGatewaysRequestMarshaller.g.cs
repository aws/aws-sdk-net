...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRequesterGatewaysRequestMarshaller : IMarshaller<IRequest, ListRequesterGatewaysRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListRequesterGatewaysRequestMarshaller _instance = new();

        internal static ListRequesterGatewaysRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRequesterGatewaysRequestMarshaller Instance => _instance;
    }
}
