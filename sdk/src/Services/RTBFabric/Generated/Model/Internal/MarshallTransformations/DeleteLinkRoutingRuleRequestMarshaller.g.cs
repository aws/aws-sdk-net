...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, DeleteLinkRoutingRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteLinkRoutingRuleRequestMarshaller _instance = new();

        internal static DeleteLinkRoutingRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteLinkRoutingRuleRequestMarshaller Instance => _instance;
    }
}
