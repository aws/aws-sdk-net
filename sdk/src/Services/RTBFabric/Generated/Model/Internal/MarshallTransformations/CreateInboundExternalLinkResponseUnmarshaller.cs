...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateInboundExternalLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInboundExternalLinkResponse response = new CreateInboundExternalLinkResponse();
        ...
        internal static CreateInboundExternalLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInboundExternalLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
