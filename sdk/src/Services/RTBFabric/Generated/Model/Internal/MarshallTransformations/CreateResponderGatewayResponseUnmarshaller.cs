...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateResponderGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResponderGatewayResponse response = new CreateResponderGatewayResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("clientRoutingPolicy", targetDepth, ref reader))
                {
                    ...
                    response.ClientRoutingPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateResponderGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResponderGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
