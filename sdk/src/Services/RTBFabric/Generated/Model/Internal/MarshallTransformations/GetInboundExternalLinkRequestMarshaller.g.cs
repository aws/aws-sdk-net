...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetInboundExternalLinkRequestMarshaller : IMarshaller<IRequest, GetInboundExternalLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetInboundExternalLinkRequestMarshaller _instance = new();

        internal static GetInboundExternalLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInboundExternalLinkRequestMarshaller Instance => _instance;
    }
}
