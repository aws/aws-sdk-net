...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRequesterGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRequesterGatewayResponse response = new GetRequesterGatewayResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("activeLinksCount", targetDepth))
                {
                    ...
                    response.ActiveLinksCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.TotalLinksCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetRequesterGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRequesterGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
