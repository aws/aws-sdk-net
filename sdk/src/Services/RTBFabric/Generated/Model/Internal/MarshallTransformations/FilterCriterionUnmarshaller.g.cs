...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FilterCriterionUnmarshaller : IJsonUnmarshaller<FilterCriterion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FilterCriterion();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FilterCriterionUnmarshaller Instance => _instance;
    }
}
