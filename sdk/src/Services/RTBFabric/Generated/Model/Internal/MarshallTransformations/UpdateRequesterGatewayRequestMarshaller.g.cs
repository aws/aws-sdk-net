...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRequesterGatewayRequestMarshaller : IMarshaller<IRequest, UpdateRequesterGatewayRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateRequesterGatewayRequestMarshaller _instance = new();

        internal static UpdateRequesterGatewayRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRequesterGatewayRequestMarshaller Instance => _instance;
    }
}
