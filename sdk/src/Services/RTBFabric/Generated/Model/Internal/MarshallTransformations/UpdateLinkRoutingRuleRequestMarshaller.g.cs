...
{
    /// <summary>
    /// UpdateLinkRoutingRule Request Marshaller
    /// </summary>
    public partial class UpdateLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, UpdateLinkRoutingRuleRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateLinkRoutingRuleRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateLinkRoutingRuleRequest publicRequest)
        {
        ...
        private static readonly UpdateLinkRoutingRuleRequestMarshaller _instance = new();

        internal static UpdateLinkRoutingRuleRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateLinkRoutingRuleRequestMarshaller Instance => _instance;
    }
}
