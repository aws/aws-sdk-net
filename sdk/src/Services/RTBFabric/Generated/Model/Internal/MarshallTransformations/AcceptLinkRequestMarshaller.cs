...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AcceptLinkRequestMarshaller : IMarshaller<IRequest, AcceptLinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AcceptLinkRequestMarshaller _instance = new AcceptLinkRequestMarshaller();        

        internal static AcceptLinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptLinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
