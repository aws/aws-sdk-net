...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateRequesterGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRequesterGatewayResponse response = new CreateRequesterGatewayResponse();
        ...
        internal static CreateRequesterGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRequesterGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
