...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ActionUnmarshaller : IJsonUnmarshaller<Action, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Action();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ActionUnmarshaller Instance => _instance;
    }
}
