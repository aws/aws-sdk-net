...
{
    /// <summary>
    /// CreateInboundExternalLink Request Marshaller
    /// </summary>
    public partial class CreateInboundExternalLinkRequestMarshaller : IMarshaller<IRequest, CreateInboundExternalLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateInboundExternalLinkRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateInboundExternalLinkRequest publicRequest)
        {
            ...
            request.ResourcePath = "/responder-gateway/{gatewayId}/inbound-external-link";
#if !NETFRAMEWORK
        ...
        private static readonly CreateInboundExternalLinkRequestMarshaller _instance = new();

        internal static CreateInboundExternalLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateInboundExternalLinkRequestMarshaller Instance => _instance;
    }
}
