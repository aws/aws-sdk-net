...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResponderErrorMaskingForHttpCodeMarshaller : IRequestMarshaller<ResponderErrorMaskingForHttpCode, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ResponderErrorMaskingForHttpCode requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetHttpCode())
            {
                ...
                context.Writer.WriteStringValue(requestObject.HttpCode);
            }
            ...
            if (requestObject.IsSetLoggingTypes())
            {
                ...
                {
                    context.Writer.WriteStringValue(requestObjectLoggingTypesListValue);
                }
            ...
            if (requestObject.IsSetResponseLoggingPercentage())
            {
                ...
                if (StringUtils.IsSpecialFloatValue(requestObject.ResponseLoggingPercentage.Value))
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialFloatValue(requestObject.ResponseLoggingPercentage.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(requestObject.ResponseLoggingPercentage.Value);
                }
            }
        }
