...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteLinkRequestMarshaller : IMarshaller<IRequest, DeleteLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteLinkRequestMarshaller _instance = new();

        internal static DeleteLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteLinkRequestMarshaller Instance => _instance;
    }
}
