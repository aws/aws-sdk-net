...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateLinkRoutingRuleRequestMarshaller : IMarshaller<IRequest, UpdateLinkRoutingRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateLinkRoutingRuleRequestMarshaller _instance = new UpdateLinkRoutingRuleRequestMarshaller();        

        internal static UpdateLinkRoutingRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLinkRoutingRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
