...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLinkModuleFlow operation
    /// </summary>  
    public class UpdateLinkModuleFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLinkModuleFlowResponse response = new UpdateLinkModuleFlowResponse();
        ...
        private static UpdateLinkModuleFlowResponseUnmarshaller _instance = new UpdateLinkModuleFlowResponseUnmarshaller();        

        internal static UpdateLinkModuleFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLinkModuleFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
