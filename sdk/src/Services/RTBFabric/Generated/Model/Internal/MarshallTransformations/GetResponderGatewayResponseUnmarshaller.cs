        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("managedEndpointConfiguration", targetDepth))
                {
                    ...
                    response.ManagedEndpointConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("trustStoreConfiguration", targetDepth))
                {
                    ...
                    response.TrustStoreConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
