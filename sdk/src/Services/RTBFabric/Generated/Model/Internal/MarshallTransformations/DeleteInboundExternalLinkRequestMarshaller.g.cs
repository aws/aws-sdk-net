...
{
    /// <summary>
    /// DeleteInboundExternalLink Request Marshaller
    /// </summary>
    public partial class DeleteInboundExternalLinkRequestMarshaller : IMarshaller<IRequest, DeleteInboundExternalLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteInboundExternalLinkRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteInboundExternalLinkRequest publicRequest)
        {
        ...
        private static readonly DeleteInboundExternalLinkRequestMarshaller _instance = new();

        internal static DeleteInboundExternalLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteInboundExternalLinkRequestMarshaller Instance => _instance;
    }
}
