...
{
    /// <summary>
    /// AcceptLink Request Marshaller
    /// </summary>
    public partial class AcceptLinkRequestMarshaller : IMarshaller<IRequest, AcceptLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AcceptLinkRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(AcceptLinkRequest publicRequest)
        {
            ...
            request.ResourcePath = "/gateway/{gatewayId}/link/{linkId}/accept";
#if !NETFRAMEWORK
        ...
        private static readonly AcceptLinkRequestMarshaller _instance = new();

        internal static AcceptLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AcceptLinkRequestMarshaller Instance => _instance;
    }
}
