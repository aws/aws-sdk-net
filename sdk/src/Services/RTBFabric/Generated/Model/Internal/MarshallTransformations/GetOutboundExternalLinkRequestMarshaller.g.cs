...
{
    /// <summary>
    /// GetOutboundExternalLink Request Marshaller
    /// </summary>
    public partial class GetOutboundExternalLinkRequestMarshaller : IMarshaller<IRequest, GetOutboundExternalLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetOutboundExternalLinkRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetOutboundExternalLinkRequest publicRequest)
        {
        ...
        private static readonly GetOutboundExternalLinkRequestMarshaller _instance = new();

        internal static GetOutboundExternalLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOutboundExternalLinkRequestMarshaller Instance => _instance;
    }
}
