...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateOutboundExternalLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateOutboundExternalLinkResponse();
        ...
        internal static CreateOutboundExternalLinkResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateOutboundExternalLinkResponseUnmarshaller Instance => _instance;
    }
}
