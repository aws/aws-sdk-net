...
{
    /// <summary>
    /// Response Unmarshaller for GetInboundExternalLink operation
    /// </summary>  
    public class GetInboundExternalLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInboundExternalLinkResponse response = new GetInboundExternalLinkResponse();
        ...
        private static GetInboundExternalLinkResponseUnmarshaller _instance = new GetInboundExternalLinkResponseUnmarshaller();        

        internal static GetInboundExternalLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInboundExternalLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
