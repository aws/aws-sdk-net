...
namespace Amazon.RTBFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetInboundExternalLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetInboundExternalLinkResponse();
        ...
        internal static GetInboundExternalLinkResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInboundExternalLinkResponseUnmarshaller Instance => _instance;
    }
}
