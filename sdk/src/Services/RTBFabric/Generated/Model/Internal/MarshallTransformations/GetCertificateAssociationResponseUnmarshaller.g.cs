...
{
    /// <summary>
    /// Response Unmarshaller for GetCertificateAssociation operation.
    /// </summary>
    public partial class GetCertificateAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetCertificateAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("associatedAt", targetDepth, ref reader))
                {
        ...
        private static GetCertificateAssociationResponseUnmarshaller _instance = new GetCertificateAssociationResponseUnmarshaller();

        internal static GetCertificateAssociationResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetCertificateAssociationResponseUnmarshaller Instance => _instance;
    }
}
