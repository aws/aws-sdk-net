...
{
    /// <summary>
    /// Container for the parameters to the UpdateLinkModuleFlow operation. Updates a link
    /// module flow.
    /// </summary>
    public partial class UpdateLinkModuleFlowRequest : AmazonRTBFabricRequest
    {
        ...
        public List<ModuleConfiguration> Modules { get; set; } = AWSConfigs.InitializeCollections ? new List<ModuleConfiguration>() : null;

        /// <summary>
        /// Checks to see if the Modules property is set.
        /// </summary>
        internal bool IsSetModules() => this.Modules != null && (this.Modules.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
