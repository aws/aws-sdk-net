...
namespace Amazon.RTBFabric.Model
{
    ...
    {
        private List<ListLinksResponseStructure> _links = AWSConfigs.InitializeCollections ? new List<ListLinksResponseStructure>() : null;
        ...
        /// </para>
        /// </summary>
        public List<ListLinksResponseStructure> Links
        {
