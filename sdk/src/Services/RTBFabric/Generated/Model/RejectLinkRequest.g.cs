...
{
    /// <summary>
    /// Container for the parameters to the RejectLink operation. Rejects a link request between
    /// gateways. <para> When a requester gateway requests to link with a responder gateway,
    /// the responder can use this operation to decline the link request. </para>
    /// </summary>
