...
{
    /// <summary>
    /// Container for the parameters to the ListLinks operation. Lists links associated with
    /// gateways. <para> Returns a list of all links for the specified gateways, including
    /// their status and configuration details. </para>
    /// </summary>
