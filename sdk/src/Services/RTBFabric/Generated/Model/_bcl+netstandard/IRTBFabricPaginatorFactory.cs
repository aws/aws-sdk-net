...
namespace Amazon.RTBFabric.Model
{
    ...
    public partial interface IRTBFabricPaginatorFactory
    {
        ...
        IListRequesterGatewaysPaginator ListRequesterGateways(ListRequesterGatewaysRequest request);
        ...
        IListResponderGatewaysPaginator ListResponderGateways(ListResponderGatewaysRequest request);
    }
}