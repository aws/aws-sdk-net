...
namespace Amazon.RTBFabric.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for RTBFabric service requests.
    /// Collects values for RTBFabricEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses RTBFabricEndpointProvider.
