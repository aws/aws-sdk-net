...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeletePartnerEventSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePartnerEventSourceResponse response = new DeletePartnerEventSourceResponse();
        ...
        private static DeletePartnerEventSourceResponseUnmarshaller _instance = new DeletePartnerEventSourceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePartnerEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
