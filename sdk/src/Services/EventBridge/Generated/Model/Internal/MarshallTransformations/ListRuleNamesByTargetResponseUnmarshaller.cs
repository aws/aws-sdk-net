...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRuleNamesByTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRuleNamesByTargetResponse response = new ListRuleNamesByTargetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RuleNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.RuleNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRuleNamesByTargetResponseUnmarshaller _instance = new ListRuleNamesByTargetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRuleNamesByTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
