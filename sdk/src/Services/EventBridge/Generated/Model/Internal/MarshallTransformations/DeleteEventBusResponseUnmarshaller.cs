...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteEventBusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEventBusResponse response = new DeleteEventBusResponse();
        ...
        private static DeleteEventBusResponseUnmarshaller _instance = new DeleteEventBusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventBusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
