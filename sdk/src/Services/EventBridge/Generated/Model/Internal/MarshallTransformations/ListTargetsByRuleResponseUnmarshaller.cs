...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTargetsByRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTargetsByRuleResponse response = new ListTargetsByRuleResponse();
        ...
        private static ListTargetsByRuleResponseUnmarshaller _instance = new ListTargetsByRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTargetsByRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
