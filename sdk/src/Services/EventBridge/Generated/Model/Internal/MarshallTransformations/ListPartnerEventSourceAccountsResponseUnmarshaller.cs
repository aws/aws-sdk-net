    ...
    public class ListPartnerEventSourceAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PartnerEventSourceAccount, PartnerEventSourceAccountUnmarshaller>(PartnerEventSourceAccountUnmarshaller.Instance);
                    response.PartnerEventSourceAccounts = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
