...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutTargetsResultEntryUnmarshaller : IJsonUnmarshaller<PutTargetsResultEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PutTargetsResultEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
