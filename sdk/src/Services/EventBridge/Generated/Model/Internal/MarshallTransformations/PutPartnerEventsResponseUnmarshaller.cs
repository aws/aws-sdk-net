...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutPartnerEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutPartnerEventsResponse response = new PutPartnerEventsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PutPartnerEventsResultEntry, PutPartnerEventsResultEntryUnmarshaller>(PutPartnerEventsResultEntryUnmarshaller.Instance);
        ...
        private static PutPartnerEventsResponseUnmarshaller _instance = new PutPartnerEventsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutPartnerEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
