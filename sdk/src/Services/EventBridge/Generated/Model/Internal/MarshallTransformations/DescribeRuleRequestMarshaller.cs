...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeRuleRequestMarshaller : IMarshaller<IRequest, DescribeRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeRuleRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EventBridge");
            string target = "AWSEvents.DescribeRule";
        ...
        private static DescribeRuleRequestMarshaller _instance = new DescribeRuleRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
