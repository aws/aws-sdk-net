...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutTargetsRequestMarshaller : IMarshaller<IRequest, PutTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutTargetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutTargetsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EventBridge");
            string target = "AWSEvents.PutTargets";
