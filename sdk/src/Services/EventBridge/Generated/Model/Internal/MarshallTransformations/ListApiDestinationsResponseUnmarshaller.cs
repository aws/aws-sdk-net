...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListApiDestinationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApiDestinationsResponse response = new ListApiDestinationsResponse();
            ...
            {
                if (context.TestExpression("ApiDestinations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ApiDestination, ApiDestinationUnmarshaller>(ApiDestinationUnmarshaller.Instance);
                    response.ApiDestinations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListApiDestinationsResponseUnmarshaller _instance = new ListApiDestinationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApiDestinationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
