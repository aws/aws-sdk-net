...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionHeaderParameterUnmarshaller : IJsonUnmarshaller<ConnectionHeaderParameter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionHeaderParameter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("IsValueSecret", targetDepth, ref reader))
                {
