...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchParametersUnmarshaller : IUnmarshaller<BatchParameters, XmlUnmarshallerContext>, IUnmarshaller<BatchParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BatchParameters IUnmarshaller<BatchParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
