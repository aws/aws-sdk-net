...
namespace Amazon.EC2InstanceConnect.Model
{
    ...
    public partial class SerialConsoleAccessDisabledException : AmazonEC2InstanceConnectException
    {
        ...
        public SerialConsoleAccessDisabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SerialConsoleAccessDisabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
