...
namespace Amazon.EC2InstanceConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EC2InstanceNotFoundExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<EC2InstanceNotFoundException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public EC2InstanceNotFoundException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public EC2InstanceNotFoundException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
