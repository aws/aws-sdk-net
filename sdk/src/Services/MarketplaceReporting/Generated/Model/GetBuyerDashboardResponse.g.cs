...
namespace Amazon.MarketplaceReporting.Model
{
    ...
    public partial class GetBuyerDashboardResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> EmbeddingDomains { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the EmbeddingDomains property is set.
        /// </summary>
        internal bool IsSetEmbeddingDomains() => this.EmbeddingDomains != null && (this.EmbeddingDomains.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
