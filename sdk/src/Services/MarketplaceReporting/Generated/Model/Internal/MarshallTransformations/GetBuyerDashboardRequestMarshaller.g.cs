...
namespace Amazon.MarketplaceReporting.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetBuyerDashboardRequestMarshaller : IMarshaller<IRequest, GetBuyerDashboardRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetBuyerDashboardRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetDashboardIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.DashboardIdentifier);
            }
            if (publicRequest.IsSetEmbeddingDomains())
            {
                ...
                {
                    context.Writer.WriteStringValue(publicRequestEmbeddingDomainsListValue);
                }
        ...
        private static readonly GetBuyerDashboardRequestMarshaller _instance = new();

        internal static GetBuyerDashboardRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetBuyerDashboardRequestMarshaller Instance => _instance;
    }
}
