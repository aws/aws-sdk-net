...
namespace Amazon.MarketplaceReporting.Model.Internal.MarshallTransformations
{
    ...
    public partial class InternalServerExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InternalServerException, JsonUnmarshallerContext>
    {
        ...
        {
            InternalServerException unmarshalledObject = new InternalServerException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
