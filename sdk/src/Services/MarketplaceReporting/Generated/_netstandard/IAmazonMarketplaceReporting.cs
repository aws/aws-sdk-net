...
namespace Amazon.MarketplaceReporting
{
    ...
    public partial interface IAmazonMarketplaceReporting : IAmazonService, IDisposable
    {
        ...
        Task<GetBuyerDashboardResponse> GetBuyerDashboardAsync(GetBuyerDashboardRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMarketplaceReportingConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMarketplaceReportingConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMarketplaceReportingConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMarketplaceReportingConfig to create AmazonMarketplaceReportingClient");
            }

            return awsCredentials == null ? 
                    new AmazonMarketplaceReportingClient(serviceClientConfig) :
                    new AmazonMarketplaceReportingClient(awsCredentials, serviceClientConfig);
        }
