...
namespace Amazon.MarketplaceReporting
{
    ...
    public partial class AmazonMarketplaceReportingConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Marketplace Reporting", "4.0.100.11");
        ...
        /// </summary>
        public static new string ServiceId => "Marketplace Reporting";

        /// <summary>
        /// Default constructor
        /// </summary>
        public AmazonMarketplaceReportingConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonMarketplaceReportingDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Marketplace Reporting";
            this.AuthenticationServiceName = "aws-marketplace";
            this.EndpointProvider = new AmazonMarketplaceReportingEndpointProvider();
        }

        /// <summary>
        /// The constant used to lookup in the region hash the endpoint.
        /// </summary>
        public override string RegionEndpointServiceName => "reporting-marketplace";
