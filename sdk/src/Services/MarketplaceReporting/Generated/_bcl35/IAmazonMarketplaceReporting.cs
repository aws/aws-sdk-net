...
namespace Amazon.MarketplaceReporting
{
    ...
    public partial interface IAmazonMarketplaceReporting : IAmazonService, IDisposable
    {
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GetBuyerDashboard operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GetBuyerDashboard operation on AmazonMarketplaceReportingClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGetBuyerDashboard
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-reporting-2018-05-10/GetBuyerDashboard">REST API Reference for GetBuyerDashboard Operation</seealso>
        IAsyncResult BeginGetBuyerDashboard(GetBuyerDashboardRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  GetBuyerDashboard operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetBuyerDashboard.</param>
        /// 
        /// <returns>Returns a  GetBuyerDashboardResult from MarketplaceReporting.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-reporting-2018-05-10/GetBuyerDashboard">REST API Reference for GetBuyerDashboard Operation</seealso>
        GetBuyerDashboardResponse EndGetBuyerDashboard(IAsyncResult asyncResult);
