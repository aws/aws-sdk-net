...
namespace Amazon.MarketplaceReporting
{
    ...
    public partial class AmazonMarketplaceReportingClient : AmazonServiceClient, IAmazonMarketplaceReporting
    {
        ...
        /// 
        /// </summary>
        public AmazonMarketplaceReportingClient() : base(new AmazonMarketplaceReportingConfig()) { }
        ...
        public AmazonMarketplaceReportingClient(RegionEndpoint region) : base(new AmazonMarketplaceReportingConfig { RegionEndpoint = region }) { }
        ...
        public AmazonMarketplaceReportingClient(AmazonMarketplaceReportingConfig config) : base(config) { }
