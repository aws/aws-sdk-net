...
namespace Amazon.SSO
{
    ...
    public partial class AmazonSSOClient : AmazonServiceClient, IAmazonSSO
    {
        ...
        /// 
        /// </summary>
        public AmazonSSOClient() : base(new AmazonSSOConfig()) { }
        ...
        public AmazonSSOClient(RegionEndpoint region) : base(new AmazonSSOConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSSOClient(AmazonSSOConfig config) : base(config) { }
