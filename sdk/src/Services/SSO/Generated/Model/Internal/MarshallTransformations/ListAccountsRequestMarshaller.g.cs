...
namespace Amazon.SSO.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAccountsRequestMarshaller : IMarshaller<IRequest, ListAccountsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAccountsRequestMarshaller _instance = new();

        internal static ListAccountsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAccountsRequestMarshaller Instance => _instance;
    }
}
