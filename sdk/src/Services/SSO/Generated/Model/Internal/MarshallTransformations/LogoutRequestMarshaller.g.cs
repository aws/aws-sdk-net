...
namespace Amazon.SSO.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LogoutRequestMarshaller : IMarshaller<IRequest, LogoutRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly LogoutRequestMarshaller _instance = new();

        internal static LogoutRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static LogoutRequestMarshaller Instance => _instance;
    }
}
