...
namespace Amazon.SSO.Model
{
    ...
    public partial class ListAccountRolesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<RoleInfo> RoleList { get; set; } = AWSConfigs.InitializeCollections ? new List<RoleInfo>() : null;

        /// <summary>
        /// Checks to see if the RoleList property is set.
        /// </summary>
        internal bool IsSetRoleList() => this.RoleList != null && (this.RoleList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
