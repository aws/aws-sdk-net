...
{
    /// <summary>
    /// Base class for ListAccounts paginators.
    /// </summary>
    internal sealed partial class ListAccountsPaginator : IPaginator<ListAccountsResponse>, IListAccountsPaginator
    {
        private readonly IAmazonSSO _client;
        private readonly ListAccountsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListAccountsResponse> Responses => new PaginatedResponse<ListAccountsResponse>(this);
...
#if BCL
        IEnumerable<ListAccountsResponse> IPaginator<ListAccountsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListAccounts(_request);
        ...
        async IAsyncEnumerable<ListAccountsResponse> IPaginator<ListAccountsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListAccountsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
