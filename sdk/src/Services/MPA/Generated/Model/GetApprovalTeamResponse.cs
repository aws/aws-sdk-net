...
namespace Amazon.MPA.Model
{
    ...
    public partial class GetApprovalTeamResponse : AmazonWebServiceResponse
    {
        ...
        private string _updateSessionArn;
        ...
        {
            get { return this._pendingUpdate; }
            set { this._pendingUpdate = value; }
        }

        // Check to see if PendingUpdate property is set
        internal bool IsSetPendingUpdate()
        {
        ...
        /// </summary>
        [AWSProperty(Min=0, Max=1000)]
        public string UpdateSessionArn
        {
            get { return this._updateSessionArn; }
            set { this._updateSessionArn = value; }
        }

        // Check to see if UpdateSessionArn property is set
        internal bool IsSetUpdateSessionArn()
        {
            return this._updateSessionArn != null;
        }
