...
namespace Amazon.MPA.Model
{
    ...
    {
        private DateTime? _deletionCompletionTime;
        ...
        /// </para>
        /// </summary>
        public DateTime DeletionCompletionTime
        {
            get { return this._deletionCompletionTime.GetValueOrDefault(); }
            set { this._deletionCompletionTime = value; }
        }

        // Check to see if DeletionCompletionTime property is set
        internal bool IsSetDeletionCompletionTime()
        {
            return this._deletionCompletionTime.HasValue; 
        }
