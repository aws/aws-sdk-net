...
namespace Amazon.MPA.Model
{
    ...
    [Serializable]
    #endif
    public partial class TooManyTagsException : AmazonMPAException
    {
        ...
        public TooManyTagsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyTagsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <para>
        /// Name of the resource for the <c>TooManyTagsException</c> error.
        /// </para>
        /// </summary>
