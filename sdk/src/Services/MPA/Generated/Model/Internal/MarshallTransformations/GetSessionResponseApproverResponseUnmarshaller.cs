...
namespace Amazon.MPA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSessionResponseApproverResponseUnmarshaller : IJsonUnmarshaller<GetSessionResponseApproverResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GetSessionResponseApproverResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IdentityId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IdentityId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("IdentitySourceArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IdentitySourceArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
