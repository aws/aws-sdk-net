    ...
    public class ListSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ListSessionsResponseSession, ListSessionsResponseSessionUnmarshaller>(ListSessionsResponseSessionUnmarshaller.Instance);
