...
namespace Amazon.MPA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IamIdentityCenterForGetUnmarshaller : IUnmarshaller<IamIdentityCenterForGet, XmlUnmarshallerContext>, IUnmarshaller<IamIdentityCenterForGet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        IamIdentityCenterForGet IUnmarshaller<IamIdentityCenterForGet, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public IamIdentityCenterForGet Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ApprovalPortalUrl", targetDepth))
                {
                    ...
                    unmarshalledObject.ApprovalPortalUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
