        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ActionCompletionStrategy", targetDepth))
                {
                    ...
                    response.ActionCompletionStrategy = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("AdditionalSecurityRequirements", targetDepth))
                {
                    ...
                    response.AdditionalSecurityRequirements = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ApprovalTeamArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ApprovalTeamName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ApprovalTeamName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ApproverResponses", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<GetSessionResponseApproverResponse, GetSessionResponseApproverResponseUnmarshaller>(GetSessionResponseApproverResponseUnmarshaller.Instance);
                    response.ApproverResponses = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.InitiationTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProtectedResourceArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RequesterAccountId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequesterAccountId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RequesterComment", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequesterComment = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RequesterPrincipalArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequesterPrincipalArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RequesterRegion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequesterRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RequesterServicePrincipal", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequesterServicePrincipal = unmarshaller.Unmarshall(context);
                    continue;
                }
