...
namespace Amazon.MPA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListPolicyVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PolicyVersionSummary, PolicyVersionSummaryUnmarshaller>(PolicyVersionSummaryUnmarshaller.Instance);
        ...
        private static ListPolicyVersionsResponseUnmarshaller _instance = new ListPolicyVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPolicyVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
