...
namespace Amazon.MPA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MfaMethodUnmarshaller : IJsonUnmarshaller<MfaMethod, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MfaMethod Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
