...
namespace Amazon.MPA
{
    ...
    public partial interface IAmazonMPA : IAmazonService, IDisposable
    {
        ...
        Task<StartApprovalTeamBaselineResponse> StartApprovalTeamBaselineAsync(StartApprovalTeamBaselineRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
