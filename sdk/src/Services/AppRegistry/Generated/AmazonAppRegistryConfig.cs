...
namespace Amazon.AppRegistry
{
    ...
    public partial class AmazonAppRegistryConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Service Catalog AppRegistry", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Service Catalog AppRegistry";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "servicecatalog-appregistry";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-06-24";
