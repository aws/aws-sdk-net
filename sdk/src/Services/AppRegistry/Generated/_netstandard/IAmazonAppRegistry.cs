...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAppRegistryConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAppRegistryConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAppRegistryConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAppRegistryConfig to create AmazonAppRegistryClient");
            }

            return awsCredentials == null ? 
                    new AmazonAppRegistryClient(serviceClientConfig) :
                    new AmazonAppRegistryClient(awsCredentials, serviceClientConfig);
        }
