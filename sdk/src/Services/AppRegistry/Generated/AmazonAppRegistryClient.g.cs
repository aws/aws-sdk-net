...
namespace Amazon.AppRegistry
{
    ...
    public partial class AmazonAppRegistryClient : AmazonServiceClient, IAmazonAppRegistry
    {
        ...
        /// 
        /// </summary>
        public AmazonAppRegistryClient() : base(new AmazonAppRegistryConfig()) { }
        ...
        public AmazonAppRegistryClient(RegionEndpoint region) : base(new AmazonAppRegistryConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAppRegistryClient(AmazonAppRegistryConfig config) : base(config) { }
