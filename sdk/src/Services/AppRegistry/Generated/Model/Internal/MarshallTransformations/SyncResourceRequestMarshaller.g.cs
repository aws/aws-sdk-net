...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SyncResourceRequestMarshaller : IMarshaller<IRequest, SyncResourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SyncResourceRequestMarshaller _instance = new();

        internal static SyncResourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SyncResourceRequestMarshaller Instance => _instance;
    }
}
