...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAssociatedResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAssociatedResourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("applicationTagResult", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ApplicationTagResult = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetAssociatedResourceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAssociatedResourceResponseUnmarshaller Instance => _instance;
    }
}
