...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResourceDetailsUnmarshaller : IJsonUnmarshaller<ResourceDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ResourceDetails();
            ...
            {
                if (context.TestExpression("tagValue", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResourceDetailsUnmarshaller Instance => _instance;
    }
}
