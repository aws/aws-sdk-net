...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateResourceRequestMarshaller : IMarshaller<IRequest, DisassociateResourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateResourceRequestMarshaller _instance = new();

        internal static DisassociateResourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateResourceRequestMarshaller Instance => _instance;
    }
}
