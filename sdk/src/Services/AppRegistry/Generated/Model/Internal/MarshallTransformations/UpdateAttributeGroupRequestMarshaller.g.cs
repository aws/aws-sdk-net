...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAttributeGroupRequestMarshaller : IMarshaller<IRequest, UpdateAttributeGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateAttributeGroupRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetAttributes())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.Attributes);
            }
        ...
        private static readonly UpdateAttributeGroupRequestMarshaller _instance = new();

        internal static UpdateAttributeGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAttributeGroupRequestMarshaller Instance => _instance;
    }
}
