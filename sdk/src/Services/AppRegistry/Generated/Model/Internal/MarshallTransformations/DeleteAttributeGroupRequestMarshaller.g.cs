...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAttributeGroupRequestMarshaller : IMarshaller<IRequest, DeleteAttributeGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAttributeGroupRequestMarshaller _instance = new();

        internal static DeleteAttributeGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAttributeGroupRequestMarshaller Instance => _instance;
    }
}
