...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ApplicationUnmarshaller : IJsonUnmarshaller<Application, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Application Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("applicationTag", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ApplicationUnmarshaller Instance => _instance;
    }
}
