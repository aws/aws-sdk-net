...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAssociatedResourceRequestMarshaller : IMarshaller<IRequest, GetAssociatedResourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAssociatedResourceRequestMarshaller _instance = new();

        internal static GetAssociatedResourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAssociatedResourceRequestMarshaller Instance => _instance;
    }
}
