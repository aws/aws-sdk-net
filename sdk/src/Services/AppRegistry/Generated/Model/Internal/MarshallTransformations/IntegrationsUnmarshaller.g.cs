...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IntegrationsUnmarshaller : IJsonUnmarshaller<Integrations, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Integrations Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Integrations();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IntegrationsUnmarshaller Instance => _instance;
    }
}
