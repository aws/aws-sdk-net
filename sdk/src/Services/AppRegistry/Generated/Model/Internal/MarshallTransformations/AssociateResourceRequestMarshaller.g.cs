...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociateResourceRequestMarshaller : IMarshaller<IRequest, AssociateResourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AssociateResourceRequestMarshaller _instance = new();

        internal static AssociateResourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AssociateResourceRequestMarshaller Instance => _instance;
    }
}
