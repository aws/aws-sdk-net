...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetApplicationRequestMarshaller : IMarshaller<IRequest, GetApplicationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetApplicationRequestMarshaller _instance = new();

        internal static GetApplicationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetApplicationRequestMarshaller Instance => _instance;
    }
}
