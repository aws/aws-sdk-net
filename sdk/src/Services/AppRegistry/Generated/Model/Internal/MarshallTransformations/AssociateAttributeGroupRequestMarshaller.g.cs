...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociateAttributeGroupRequestMarshaller : IMarshaller<IRequest, AssociateAttributeGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AssociateAttributeGroupRequestMarshaller _instance = new();

        internal static AssociateAttributeGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AssociateAttributeGroupRequestMarshaller Instance => _instance;
    }
}
