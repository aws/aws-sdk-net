...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResourcesListItemUnmarshaller : IJsonUnmarshaller<ResourcesListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ResourcesListItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ResourcesListItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResourcesListItemUnmarshaller Instance => _instance;
    }
}
