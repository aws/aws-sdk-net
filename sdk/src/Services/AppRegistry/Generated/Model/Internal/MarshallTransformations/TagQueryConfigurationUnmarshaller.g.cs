...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TagQueryConfigurationUnmarshaller : IJsonUnmarshaller<TagQueryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TagQueryConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TagQueryConfigurationUnmarshaller Instance => _instance;
    }
}
