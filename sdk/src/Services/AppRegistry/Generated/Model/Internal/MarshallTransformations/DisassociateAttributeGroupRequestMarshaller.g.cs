...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateAttributeGroupRequestMarshaller : IMarshaller<IRequest, DisassociateAttributeGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateAttributeGroupRequestMarshaller _instance = new();

        internal static DisassociateAttributeGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateAttributeGroupRequestMarshaller Instance => _instance;
    }
}
