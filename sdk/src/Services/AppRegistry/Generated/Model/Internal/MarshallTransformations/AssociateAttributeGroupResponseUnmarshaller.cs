...
{
    /// <summary>
    /// Response Unmarshaller for AssociateAttributeGroup operation
    /// </summary>  
    public class AssociateAttributeGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateAttributeGroupResponse response = new AssociateAttributeGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AttributeGroupArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static AssociateAttributeGroupResponseUnmarshaller _instance = new AssociateAttributeGroupResponseUnmarshaller();        

        internal static AssociateAttributeGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAttributeGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
