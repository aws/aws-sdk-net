...
{
    /// <summary>
    /// GetAssociatedResource Request Marshaller
    /// </summary>       
    public class GetAssociatedResourceRequestMarshaller : IMarshaller<IRequest, GetAssociatedResourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAssociatedResourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAssociatedResourceRequest publicRequest)
        {
        ...
        private static GetAssociatedResourceRequestMarshaller _instance = new GetAssociatedResourceRequestMarshaller();        

        internal static GetAssociatedResourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssociatedResourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
