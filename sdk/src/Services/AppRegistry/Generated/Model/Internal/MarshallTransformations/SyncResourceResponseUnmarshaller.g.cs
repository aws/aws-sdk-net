...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SyncResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SyncResourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("actionTaken", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ActionTaken = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static SyncResourceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SyncResourceResponseUnmarshaller Instance => _instance;
    }
}
