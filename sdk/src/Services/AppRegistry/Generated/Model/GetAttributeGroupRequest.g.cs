...
{
    /// <summary>
    /// Container for the parameters to the GetAttributeGroup operation. Retrieves an attribute
    /// group by its ARN, ID, or name. The attribute group can be specified by its ARN, ID,
    /// or name.
    /// </summary>
