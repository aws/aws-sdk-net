...
{
    /// <summary>
    /// Container for the parameters to the GetAssociatedResource operation. Gets the resource
    ...
    public partial class GetAssociatedResourceRequest : AmazonAppRegistryRequest
    {
        ...
        public List<string> ResourceTagStatus { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ResourceTagStatus property is set.
        /// </summary>
        internal bool IsSetResourceTagStatus() => this.ResourceTagStatus != null && (this.ResourceTagStatus.Count > 0 || !AWSConfigs.InitializeCollections);
