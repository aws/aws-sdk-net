...
namespace Amazon.AppRegistry.Model
{
    ...
    public partial class GetApplicationResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public Dictionary<string, string> ApplicationTag { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the ApplicationTag property is set.
        /// </summary>
        internal bool IsSetApplicationTag() => this.ApplicationTag != null && (this.ApplicationTag.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </summary>
        [AWSProperty(Min = 0)]
        public int? AssociatedResourceCount { get; set; }

        /// <summary>
        /// Checks to see if the AssociatedResourceCount property is set.
        /// </summary>
        internal bool IsSetAssociatedResourceCount() => this.AssociatedResourceCount.HasValue;
