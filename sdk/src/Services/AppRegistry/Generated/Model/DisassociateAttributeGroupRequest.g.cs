...
{
    /// <summary>
    /// Container for the parameters to the DisassociateAttributeGroup operation. Disassociates
    /// an attribute group from an application to remove the extra attributes contained in
    /// the attribute group from the application's metadata. This operation reverts <c>AssociateAttributeGroup</c>.
    /// </summary>
