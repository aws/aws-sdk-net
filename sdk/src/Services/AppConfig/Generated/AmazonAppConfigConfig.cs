...
namespace Amazon.AppConfig
{
    ...
    public partial class AmazonAppConfigConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("AppConfig", "4.0.101.11");
        ...
        /// </summary>
        public static new string ServiceId => "AppConfig";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "appconfig";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-10-09";
