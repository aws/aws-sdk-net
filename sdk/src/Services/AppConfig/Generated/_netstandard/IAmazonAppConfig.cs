...
namespace Amazon.AppConfig
{
    ...
    public partial interface IAmazonAppConfig : IAmazonService, IDisposable
    {
        ...
        Task<CreateExperimentDefinitionResponse> CreateExperimentDefinitionAsync(CreateExperimentDefinitionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateExtensionResponse> CreateExtensionAsync(CreateExtensionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateExtensionAssociationResponse> CreateExtensionAssociationAsync(CreateExtensionAssociationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteExperimentDefinitionResponse> DeleteExperimentDefinitionAsync(DeleteExperimentDefinitionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteExtensionResponse> DeleteExtensionAsync(DeleteExtensionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteExtensionAssociationResponse> DeleteExtensionAssociationAsync(DeleteExtensionAssociationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetExperimentDefinitionResponse> GetExperimentDefinitionAsync(GetExperimentDefinitionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetExperimentRunResponse> GetExperimentRunAsync(GetExperimentRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetExtensionAssociationResponse> GetExtensionAssociationAsync(GetExtensionAssociationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListExperimentDefinitionsResponse> ListExperimentDefinitionsAsync(ListExperimentDefinitionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListExperimentRunEventsResponse> ListExperimentRunEventsAsync(ListExperimentRunEventsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListExperimentRunsResponse> ListExperimentRunsAsync(ListExperimentRunsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListExtensionAssociationsResponse> ListExtensionAssociationsAsync(ListExtensionAssociationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartExperimentRunResponse> StartExperimentRunAsync(StartExperimentRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopExperimentRunResponse> StopExperimentRunAsync(StopExperimentRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateExperimentDefinitionResponse> UpdateExperimentDefinitionAsync(UpdateExperimentDefinitionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateExperimentRunResponse> UpdateExperimentRunAsync(UpdateExperimentRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateExtensionResponse> UpdateExtensionAsync(UpdateExtensionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateExtensionAssociationResponse> UpdateExtensionAssociationAsync(UpdateExtensionAssociationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAppConfigConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAppConfigConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAppConfigConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAppConfigConfig to create AmazonAppConfigClient");
            }

            return awsCredentials == null ? 
                    new AmazonAppConfigClient(serviceClientConfig) :
                    new AmazonAppConfigClient(awsCredentials, serviceClientConfig);
        }
