...
{
    /// <summary>
    /// Container for the parameters to the DeleteExperimentDefinition operation. Deletes
    /// an experiment definition. You can archive the definition to hide it from the active
    /// list while preserving it for future reference, or permanently delete it along with
