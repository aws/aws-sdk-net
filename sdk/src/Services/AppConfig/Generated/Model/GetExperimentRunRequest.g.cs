...
{
    /// <summary>
    /// Container for the parameters to the GetExperimentRun operation. Retrieves information
    /// about an experiment run, including its status, start time, and exposure settings.
    /// </summary>
    public partial class GetExperimentRunRequest : AmazonAppConfigRequest
    {
        /// <summary>
