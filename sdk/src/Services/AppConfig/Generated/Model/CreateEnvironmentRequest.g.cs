...
namespace Amazon.AppConfig.Model
{
    ...
    /// For each application, you define one or more environments. An environment is a deployment
    /// group of AppConfig targets, such as applications in a <c>Beta</c> or <c>Production</c>
    /// environment. You can also define environments for application subcomponents such as
    /// the <c>Web</c>, <c>Mobile</c> and <c>Back-end</c> components for your application.
