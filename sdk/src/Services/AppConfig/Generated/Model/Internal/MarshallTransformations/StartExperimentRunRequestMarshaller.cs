...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartExperimentRunRequestMarshaller : IMarshaller<IRequest, StartExperimentRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static StartExperimentRunRequestMarshaller _instance = new StartExperimentRunRequestMarshaller();        

        internal static StartExperimentRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExperimentRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
