...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteExtensionAssociationRequestMarshaller : IMarshaller<IRequest, DeleteExtensionAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteExtensionAssociationRequest publicRequest)
        {
        ...
        private static DeleteExtensionAssociationRequestMarshaller _instance = new DeleteExtensionAssociationRequestMarshaller();        

        internal static DeleteExtensionAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExtensionAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
