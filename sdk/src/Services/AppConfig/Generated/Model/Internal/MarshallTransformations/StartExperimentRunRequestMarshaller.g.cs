...
{
    /// <summary>
    /// StartExperimentRun Request Marshaller
    /// </summary>
    public partial class StartExperimentRunRequestMarshaller : IMarshaller<IRequest, StartExperimentRunRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartExperimentRunRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(StartExperimentRunRequest publicRequest)
        {
            ...
            request.ResourcePath = "/applications/{ApplicationIdentifier}/experimentdefinitions/{ExperimentDefinitionIdentifier}/experimentruns";
#if !NETFRAMEWORK
        ...
        private static readonly StartExperimentRunRequestMarshaller _instance = new();

        internal static StartExperimentRunRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartExperimentRunRequestMarshaller Instance => _instance;
    }
}
