...
{
    /// <summary>
    /// GetExperimentRun Request Marshaller
    /// </summary>
    public partial class GetExperimentRunRequestMarshaller : IMarshaller<IRequest, GetExperimentRunRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetExperimentRunRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetExperimentRunRequest publicRequest)
        {
            ...
            request.ResourcePath = "/applications/{ApplicationIdentifier}/experimentdefinitions/{ExperimentDefinitionIdentifier}/experimentruns/{Run}";

            return request;
        }

        private static readonly GetExperimentRunRequestMarshaller _instance = new();

        internal static GetExperimentRunRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetExperimentRunRequestMarshaller Instance => _instance;
    }
}
