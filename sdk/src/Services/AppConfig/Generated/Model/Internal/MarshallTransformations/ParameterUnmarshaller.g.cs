...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ParameterUnmarshaller : IJsonUnmarshaller<Parameter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Parameter();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Dynamic", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ParameterUnmarshaller Instance => _instance;
    }
}
