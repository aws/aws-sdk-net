...
{
    /// <summary>
    /// DeleteExperimentDefinition Request Marshaller
    /// </summary>       
    public class DeleteExperimentDefinitionRequestMarshaller : IMarshaller<IRequest, DeleteExperimentDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteExperimentDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteExperimentDefinitionRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetDeleteType())
                request.Parameters.Add("delete_type", StringUtils.FromString(publicRequest.DeleteType));
            request.ResourcePath = "/applications/{ApplicationIdentifier}/experimentdefinitions/{ExperimentDefinitionIdentifier}";
            request.UseQueryString = true;

            return request;
        }
        private static DeleteExperimentDefinitionRequestMarshaller _instance = new DeleteExperimentDefinitionRequestMarshaller();        

        internal static DeleteExperimentDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExperimentDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
