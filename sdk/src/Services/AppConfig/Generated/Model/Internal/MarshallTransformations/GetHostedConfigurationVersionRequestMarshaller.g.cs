...
{
    /// <summary>
    /// GetHostedConfigurationVersion Request Marshaller
    /// </summary>
    public partial class GetHostedConfigurationVersionRequestMarshaller : IMarshaller<IRequest, GetHostedConfigurationVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetHostedConfigurationVersionRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetHostedConfigurationVersionRequest publicRequest)
        {
            ...
            request.AddPathResource("{VersionNumber}", StringUtils.FromInt(publicRequest.VersionNumber.Value));
        ...
        private static readonly GetHostedConfigurationVersionRequestMarshaller _instance = new();

        internal static GetHostedConfigurationVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetHostedConfigurationVersionRequestMarshaller Instance => _instance;
    }
}
