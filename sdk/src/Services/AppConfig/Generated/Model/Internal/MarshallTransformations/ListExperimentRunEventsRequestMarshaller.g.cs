...
{
    /// <summary>
    /// ListExperimentRunEvents Request Marshaller
    /// </summary>
    public partial class ListExperimentRunEventsRequestMarshaller : IMarshaller<IRequest, ListExperimentRunEventsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListExperimentRunEventsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListExperimentRunEventsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/applications/{ApplicationIdentifier}/experimentdefinitions/{ExperimentDefinitionIdentifier}/experimentruns/{Run}/events";
        ...
        private static readonly ListExperimentRunEventsRequestMarshaller _instance = new();

        internal static ListExperimentRunEventsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListExperimentRunEventsRequestMarshaller Instance => _instance;
    }
}
