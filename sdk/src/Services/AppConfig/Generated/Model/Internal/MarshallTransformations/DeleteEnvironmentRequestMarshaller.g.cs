...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteEnvironmentRequestMarshaller : IMarshaller<IRequest, DeleteEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteEnvironmentRequestMarshaller _instance = new();

        internal static DeleteEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteEnvironmentRequestMarshaller Instance => _instance;
    }
}
