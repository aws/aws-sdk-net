...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetExperimentRunRequestMarshaller : IMarshaller<IRequest, GetExperimentRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetExperimentRunRequestMarshaller _instance = new GetExperimentRunRequestMarshaller();        

        internal static GetExperimentRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExperimentRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
