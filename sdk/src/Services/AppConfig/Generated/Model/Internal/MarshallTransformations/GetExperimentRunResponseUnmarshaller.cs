...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetExperimentRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetExperimentRunResponse response = new GetExperimentRunResponse();
        ...
        internal static GetExperimentRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExperimentRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
