...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateConfigurationProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateConfigurationProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RetrievalRoleArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RetrievalRoleArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateConfigurationProfileResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateConfigurationProfileResponseUnmarshaller Instance => _instance;
    }
}
