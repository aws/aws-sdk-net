...
{
    /// <summary>
    /// Response Unmarshaller for UpdateExperimentRun operation
    /// </summary>  
    public class UpdateExperimentRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExperimentRunResponse response = new UpdateExperimentRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExperimentDefinitionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExperimentDefinitionSnapshot", targetDepth, ref reader))
                {
                    ...
                    response.ExperimentDefinitionSnapshot = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExposurePercentage", targetDepth, ref reader))
                {
                    var unmarshaller = NullableFloatUnmarshaller.Instance;
                    response.ExposurePercentage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("Run", targetDepth, ref reader))
                {
                    ...
                    response.Run = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TreatmentOverrides", targetDepth, ref reader))
                {
                    ...
                    response.TreatmentOverrides = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateExperimentRunResponseUnmarshaller _instance = new UpdateExperimentRunResponseUnmarshaller();        

        internal static UpdateExperimentRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExperimentRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
