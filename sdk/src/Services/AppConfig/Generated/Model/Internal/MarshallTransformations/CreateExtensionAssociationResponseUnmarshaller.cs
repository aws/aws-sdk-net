    ...
    public class CreateExtensionAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ExtensionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExtensionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExtensionVersionNumber", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.ExtensionVersionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateExtensionAssociationResponseUnmarshaller _instance = new CreateExtensionAssociationResponseUnmarshaller();        

        internal static CreateExtensionAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExtensionAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
