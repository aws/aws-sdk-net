...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BadRequestDetailsUnmarshaller : IJsonUnmarshaller<BadRequestDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public BadRequestDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new BadRequestDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static BadRequestDetailsUnmarshaller Instance => _instance;
    }
}
