...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopExperimentRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopExperimentRunResponse response = new StopExperimentRunResponse();
        ...
        internal static StopExperimentRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopExperimentRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
