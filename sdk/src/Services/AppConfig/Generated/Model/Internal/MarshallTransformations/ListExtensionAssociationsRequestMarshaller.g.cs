...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListExtensionAssociationsRequestMarshaller : IMarshaller<IRequest, ListExtensionAssociationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListExtensionAssociationsRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("extension_version_number", StringUtils.FromInt(publicRequest.ExtensionVersionNumber.Value));
            }
        ...
        private static readonly ListExtensionAssociationsRequestMarshaller _instance = new();

        internal static ListExtensionAssociationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListExtensionAssociationsRequestMarshaller Instance => _instance;
    }
}
