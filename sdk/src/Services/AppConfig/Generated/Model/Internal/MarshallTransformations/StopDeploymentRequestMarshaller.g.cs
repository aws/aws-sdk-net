...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StopDeploymentRequestMarshaller : IMarshaller<IRequest, StopDeploymentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(StopDeploymentRequest publicRequest)
        {
            ...
            {
                request.Headers["Allow-Revert"] = StringUtils.FromBool(publicRequest.AllowRevert.Value);
            }
        ...
        private static readonly StopDeploymentRequestMarshaller _instance = new();

        internal static StopDeploymentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopDeploymentRequestMarshaller Instance => _instance;
    }
}
