...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetExtensionRequestMarshaller : IMarshaller<IRequest, GetExtensionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetExtensionRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("version_number", StringUtils.FromInt(publicRequest.VersionNumber.Value));
            }
        ...
        private static readonly GetExtensionRequestMarshaller _instance = new();

        internal static GetExtensionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetExtensionRequestMarshaller Instance => _instance;
    }
}
