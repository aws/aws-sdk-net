...
{
    /// <summary>
    /// Response Unmarshaller for GetExperimentDefinition operation
    /// </summary>  
    public class GetExperimentDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetExperimentDefinitionResponse response = new GetExperimentDefinitionResponse();
        ...
        private static GetExperimentDefinitionResponseUnmarshaller _instance = new GetExperimentDefinitionResponseUnmarshaller();        

        internal static GetExperimentDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExperimentDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
