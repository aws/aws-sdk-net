...
{
    /// <summary>
    /// Response Unmarshaller for StartExperimentRun operation
    /// </summary>  
    public class StartExperimentRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartExperimentRunResponse response = new StartExperimentRunResponse();
        ...
        private static StartExperimentRunResponseUnmarshaller _instance = new StartExperimentRunResponseUnmarshaller();        

        internal static StartExperimentRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExperimentRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
