...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteExtensionRequestMarshaller : IMarshaller<IRequest, DeleteExtensionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteExtensionRequest publicRequest)
        {
            ...
            {
                request.Parameters.Add("version", StringUtils.FromInt(publicRequest.VersionNumber.Value));
            }
        ...
        private static readonly DeleteExtensionRequestMarshaller _instance = new();

        internal static DeleteExtensionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteExtensionRequestMarshaller Instance => _instance;
    }
}
