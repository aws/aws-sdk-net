...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListExperimentRunEventsRequestMarshaller : IMarshaller<IRequest, ListExperimentRunEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListExperimentRunEventsRequestMarshaller _instance = new ListExperimentRunEventsRequestMarshaller();        

        internal static ListExperimentRunEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExperimentRunEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
