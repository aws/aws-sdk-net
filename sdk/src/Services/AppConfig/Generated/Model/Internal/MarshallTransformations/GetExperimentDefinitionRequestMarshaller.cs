...
{
    /// <summary>
    /// GetExperimentDefinition Request Marshaller
    /// </summary>       
    public class GetExperimentDefinitionRequestMarshaller : IMarshaller<IRequest, GetExperimentDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetExperimentDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetExperimentDefinitionRequest publicRequest)
        {
        ...
        private static GetExperimentDefinitionRequestMarshaller _instance = new GetExperimentDefinitionRequestMarshaller();        

        internal static GetExperimentDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExperimentDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
