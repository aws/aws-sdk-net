...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateExperimentDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExperimentDefinitionResponse response = new UpdateExperimentDefinitionResponse();
        ...
        internal static UpdateExperimentDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExperimentDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
