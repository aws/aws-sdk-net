...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListExperimentRunsRequestMarshaller : IMarshaller<IRequest, ListExperimentRunsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListExperimentRunsRequestMarshaller _instance = new ListExperimentRunsRequestMarshaller();        

        internal static ListExperimentRunsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExperimentRunsRequestMarshaller Instance
        {
            get
            {
                return _instance;
