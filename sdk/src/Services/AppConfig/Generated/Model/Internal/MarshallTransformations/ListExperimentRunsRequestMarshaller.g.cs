...
{
    /// <summary>
    /// ListExperimentRuns Request Marshaller
    /// </summary>
    public partial class ListExperimentRunsRequestMarshaller : IMarshaller<IRequest, ListExperimentRunsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListExperimentRunsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListExperimentRunsRequest publicRequest)
        {
        ...
        private static readonly ListExperimentRunsRequestMarshaller _instance = new();

        internal static ListExperimentRunsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListExperimentRunsRequestMarshaller Instance => _instance;
    }
}
