...
{
    /// <summary>
    /// Container for the parameters to the DeleteEnvironment operation. Deletes an environment.
    /// <para> To prevent users from unintentionally deleting actively-used environments,
    ...
    public partial class DeleteEnvironmentRequest : AmazonAppConfigRequest
    {
        ...
        /// <summary>
        /// Checks to see if the DeletionProtectionCheck property is set.
        /// </summary>
        internal bool IsSetDeletionProtectionCheck() => this.DeletionProtectionCheck != null;
