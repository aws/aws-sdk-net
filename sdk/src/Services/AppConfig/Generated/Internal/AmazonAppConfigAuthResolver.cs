...
namespace Amazon.AppConfig.Internal
{
    ...
    public class AmazonAppConfigAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppConfigAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppConfig.
        /// </summary>
        public AmazonAppConfigAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppConfigAuthSchemeParameters
            {
    ...
    public class AmazonAppConfigAuthSchemeResolver : IAuthSchemeResolver<AmazonAppConfigAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppConfigAuthSchemeParameters authParameters)
        {
