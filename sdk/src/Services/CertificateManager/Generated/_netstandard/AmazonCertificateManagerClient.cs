...
namespace Amazon.CertificateManager
{
    ...
    public partial class AmazonCertificateManagerClient : AmazonServiceClient, IAmazonCertificateManager
    {
        ...
        internal virtual ListCertificateDomainValidationsResponse ListCertificateDomainValidations(ListCertificateDomainValidationsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListCertificateDomainValidationsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListCertificateDomainValidationsResponseUnmarshaller.Instance;

            return Invoke<ListCertificateDomainValidationsResponse>(request, options);
        }
        ...
        public virtual Task<ListCertificateDomainValidationsResponse> ListCertificateDomainValidationsAsync(ListCertificateDomainValidationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListCertificateDomainValidationsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListCertificateDomainValidationsResponseUnmarshaller.Instance;

            return InvokeAsync<ListCertificateDomainValidationsResponse>(request, options, cancellationToken);
        }
        #endregion
