...
namespace Amazon.CertificateManager.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidArgsException : AmazonCertificateManagerException
    {
        ...
        public InvalidArgsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidArgsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
