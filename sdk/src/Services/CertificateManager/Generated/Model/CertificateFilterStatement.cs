...
{
    /// <summary>
    /// A filter statement used to search for certificates. Can contain AND, OR, NOT logical
    /// operators or a single filter.
    /// </summary>
    public partial class CertificateFilterStatement
    {
        private List<CertificateFilterStatement> _and = AWSConfigs.InitializeCollections ? new List<CertificateFilterStatement>() : null;
        private CertificateFilter _filter;
        private CertificateFilterStatement _not;
        private List<CertificateFilterStatement> _or = AWSConfigs.InitializeCollections ? new List<CertificateFilterStatement>() : null;
        ...
        public List<CertificateFilterStatement> And
        {
        ...
        /// </para>
        /// </summary>
        public CertificateFilterStatement Not
        {
        ...
        /// </summary>
        [AWSProperty(Min=1, Max=15)]
        public List<CertificateFilterStatement> Or
        {
            get { return this._or; }
            set { this._or = value; }
        }
