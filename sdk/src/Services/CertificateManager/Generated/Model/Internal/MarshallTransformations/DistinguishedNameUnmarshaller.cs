...
{
    /// <summary>
    /// Response Unmarshaller for DistinguishedName Object
    /// </summary>  
    public class DistinguishedNameUnmarshaller : IJsonUnmarshaller<DistinguishedName, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DistinguishedName Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DistinguishedName unmarshalledObject = new DistinguishedName();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DistinguishedNameQualifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DistinguishedNameQualifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DomainComponents", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.DomainComponents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("GenerationQualifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("Pseudonym", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static DistinguishedNameUnmarshaller _instance = new DistinguishedNameUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DistinguishedNameUnmarshaller Instance
        {
            get
            {
                return _instance;
