...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    public class CertificateAuthorityUnmarshaller : IJsonUnmarshaller<CertificateAuthority, JsonUnmarshallerContext>
    {
        ...
        public CertificateAuthority Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("PublicCertificateAuthority", targetDepth, ref reader))
                {
                    var unmarshaller = PublicCertificateAuthorityUnmarshaller.Instance;
                    unmarshalledObject.PublicCertificateAuthority = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
