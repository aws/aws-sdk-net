...
{
    /// <summary>
    /// UpdateAcmeEndpoint Request Marshaller
    /// </summary>       
    public class UpdateAcmeEndpointRequestMarshaller : IMarshaller<IRequest, UpdateAcmeEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAcmeEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAcmeEndpointRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CertificateManager");
            string target = "CertificateManager.UpdateAcmeEndpoint";
        ...
        private static UpdateAcmeEndpointRequestMarshaller _instance = new UpdateAcmeEndpointRequestMarshaller();        

        internal static UpdateAcmeEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAcmeEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
