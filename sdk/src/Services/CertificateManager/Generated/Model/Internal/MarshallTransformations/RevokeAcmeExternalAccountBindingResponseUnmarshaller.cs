...
{
    /// <summary>
    /// Response Unmarshaller for RevokeAcmeExternalAccountBinding operation
    /// </summary>  
    public class RevokeAcmeExternalAccountBindingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeAcmeExternalAccountBindingResponse response = new RevokeAcmeExternalAccountBindingResponse();
        ...
        private static RevokeAcmeExternalAccountBindingResponseUnmarshaller _instance = new RevokeAcmeExternalAccountBindingResponseUnmarshaller();        

        internal static RevokeAcmeExternalAccountBindingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeAcmeExternalAccountBindingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
