...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAcmeEndpoint operation
    /// </summary>  
    public class UpdateAcmeEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAcmeEndpointResponse response = new UpdateAcmeEndpointResponse();
        ...
        private static UpdateAcmeEndpointResponseUnmarshaller _instance = new UpdateAcmeEndpointResponseUnmarshaller();        

        internal static UpdateAcmeEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAcmeEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
