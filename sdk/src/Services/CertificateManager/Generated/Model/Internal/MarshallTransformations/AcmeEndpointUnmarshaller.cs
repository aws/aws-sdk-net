...
{
    /// <summary>
    /// Response Unmarshaller for AcmeEndpoint Object
    /// </summary>  
    public class AcmeEndpointUnmarshaller : IJsonUnmarshaller<AcmeEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AcmeEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AcmeEndpoint unmarshalledObject = new AcmeEndpoint();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AuthorizationBehavior", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AuthorizationBehavior = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("CertificateTags", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Tag, TagUnmarshaller>(TagUnmarshaller.Instance);
                    unmarshalledObject.CertificateTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static AcmeEndpointUnmarshaller _instance = new AcmeEndpointUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AcmeEndpointUnmarshaller Instance
        {
            get
            {
                return _instance;
