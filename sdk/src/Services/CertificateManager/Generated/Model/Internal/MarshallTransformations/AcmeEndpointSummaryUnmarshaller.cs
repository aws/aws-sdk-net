...
{
    /// <summary>
    /// Response Unmarshaller for AcmeEndpointSummary Object
    /// </summary>  
    public class AcmeEndpointSummaryUnmarshaller : IJsonUnmarshaller<AcmeEndpointSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AcmeEndpointSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AcmeEndpointSummary unmarshalledObject = new AcmeEndpointSummary();
        ...
        private static AcmeEndpointSummaryUnmarshaller _instance = new AcmeEndpointSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AcmeEndpointSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
