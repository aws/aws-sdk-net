...
{
    /// <summary>
    /// Response Unmarshaller for AcmeExternalAccountBindingSummary Object
    /// </summary>  
    public class AcmeExternalAccountBindingSummaryUnmarshaller : IJsonUnmarshaller<AcmeExternalAccountBindingSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AcmeExternalAccountBindingSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AcmeExternalAccountBindingSummary unmarshalledObject = new AcmeExternalAccountBindingSummary();
        ...
        private static AcmeExternalAccountBindingSummaryUnmarshaller _instance = new AcmeExternalAccountBindingSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AcmeExternalAccountBindingSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
