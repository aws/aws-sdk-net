...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTagsForCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTagsForCertificateResponse response = new ListTagsForCertificateResponse();
        ...
        private static ListTagsForCertificateResponseUnmarshaller _instance = new ListTagsForCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTagsForCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
