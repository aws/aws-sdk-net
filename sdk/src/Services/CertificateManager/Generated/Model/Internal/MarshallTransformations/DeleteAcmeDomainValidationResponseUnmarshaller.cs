...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAcmeDomainValidation operation
    /// </summary>  
    public class DeleteAcmeDomainValidationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAcmeDomainValidationResponse response = new DeleteAcmeDomainValidationResponse();
        ...
        private static DeleteAcmeDomainValidationResponseUnmarshaller _instance = new DeleteAcmeDomainValidationResponseUnmarshaller();        

        internal static DeleteAcmeDomainValidationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAcmeDomainValidationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
