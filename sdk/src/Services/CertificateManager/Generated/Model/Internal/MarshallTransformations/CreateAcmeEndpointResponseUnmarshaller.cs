...
{
    /// <summary>
    /// Response Unmarshaller for CreateAcmeEndpoint operation
    /// </summary>  
    public class CreateAcmeEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAcmeEndpointResponse response = new CreateAcmeEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AcmeEndpointArn", targetDepth, ref reader))
                {
                    ...
                    response.AcmeEndpointArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAcmeEndpointResponseUnmarshaller _instance = new CreateAcmeEndpointResponseUnmarshaller();        

        internal static CreateAcmeEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAcmeEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
