...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAcmeEndpoint operation
    /// </summary>  
    public class DeleteAcmeEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAcmeEndpointResponse response = new DeleteAcmeEndpointResponse();
        ...
        private static DeleteAcmeEndpointResponseUnmarshaller _instance = new DeleteAcmeEndpointResponseUnmarshaller();        

        internal static DeleteAcmeEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAcmeEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
