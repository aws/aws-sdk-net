...
{
    /// <summary>
    /// CertificateFilterStatement Marshaller
    /// </summary>
    public class CertificateFilterStatementMarshaller : IRequestMarshaller<CertificateFilterStatement, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CertificateFilterStatement requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFilter())
            {
                ...
                var marshaller = CertificateFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CertificateFilterStatementMarshaller Instance = new CertificateFilterStatementMarshaller();
