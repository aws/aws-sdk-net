...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceRecordUnmarshaller : IJsonUnmarshaller<ResourceRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceRecord Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
