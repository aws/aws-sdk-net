...
{
    /// <summary>
    /// Response Unmarshaller for CertificateSearchResult Object
    /// </summary>  
    public class CertificateSearchResultUnmarshaller : IJsonUnmarshaller<CertificateSearchResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CertificateSearchResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CertificateSearchResult unmarshalledObject = new CertificateSearchResult();
        ...
        private static CertificateSearchResultUnmarshaller _instance = new CertificateSearchResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CertificateSearchResultUnmarshaller Instance
        {
            get
            {
                return _instance;
