...
namespace Amazon.CertificateManager.Model
{
    ...
    /// </summary>
    internal sealed partial class ListCertificatesPaginator : IPaginator<ListCertificatesResponse>, IListCertificatesPaginator
    {
        private readonly IAmazonCertificateManager _client;
        private readonly ListCertificatesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListCertificatesResponse> Responses => new PaginatedResponse<ListCertificatesResponse>(this);
...
#if BCL
        IEnumerable<ListCertificatesResponse> IPaginator<ListCertificatesResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListCertificates(_request);
        ...
        async IAsyncEnumerable<ListCertificatesResponse> IPaginator<ListCertificatesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListCertificatesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
