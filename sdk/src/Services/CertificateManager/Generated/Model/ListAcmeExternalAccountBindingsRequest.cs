...
{
    /// <summary>
    /// Container for the parameters to the ListAcmeExternalAccountBindings operation.
    /// Retrieves a list of external account bindings for the specified ACME endpoint.
    /// </summary>
    public partial class ListAcmeExternalAccountBindingsRequest : AmazonCertificateManagerRequest
    {
