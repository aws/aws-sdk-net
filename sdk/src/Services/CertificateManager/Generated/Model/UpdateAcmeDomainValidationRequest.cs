...
{
    /// <summary>
    /// Container for the parameters to the UpdateAcmeDomainValidation operation.
    /// Updates the prevalidation configuration of an existing domain validation.
    /// </summary>
    public partial class UpdateAcmeDomainValidationRequest : AmazonCertificateManagerRequest
    {
