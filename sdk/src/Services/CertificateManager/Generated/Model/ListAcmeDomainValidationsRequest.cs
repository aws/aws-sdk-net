...
{
    /// <summary>
    /// Container for the parameters to the ListAcmeDomainValidations operation.
    /// Retrieves a list of domain validations for the specified ACME endpoint.
    /// </summary>
    public partial class ListAcmeDomainValidationsRequest : AmazonCertificateManagerRequest
    {
