...
namespace Amazon.SignerData
{
    ...
    public partial class AmazonSignerDataClient : AmazonServiceClient, IAmazonSignerData
    {
        ...
        /// 
        /// </summary>
        public AmazonSignerDataClient() : base(new AmazonSignerDataConfig()) { }
        ...
        public AmazonSignerDataClient(RegionEndpoint region) : base(new AmazonSignerDataConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSignerDataClient(AmazonSignerDataConfig config) : base(config) { }
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonSignerDataAuthSchemeHandler());
        }
