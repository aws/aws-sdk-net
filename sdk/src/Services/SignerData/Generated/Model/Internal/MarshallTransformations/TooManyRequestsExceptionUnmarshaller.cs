...
namespace Amazon.SignerData.Model.Internal.MarshallTransformations
{
    /// <summary>
    /// Response Unmarshaller for TooManyRequestsException Object
    /// </summary>  
    public class TooManyRequestsExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<TooManyRequestsException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public TooManyRequestsException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public TooManyRequestsException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
