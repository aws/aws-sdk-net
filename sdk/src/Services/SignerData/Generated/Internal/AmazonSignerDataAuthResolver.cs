...
namespace Amazon.SignerData.Internal
{
    ...
    public class AmazonSignerDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSignerDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SignerData.
        /// </summary>
        public AmazonSignerDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSignerDataAuthSchemeParameters
            {
    ...
    public class AmazonSignerDataAuthSchemeResolver : IAuthSchemeResolver<AmazonSignerDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSignerDataAuthSchemeParameters authParameters)
        {
