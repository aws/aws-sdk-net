...
namespace Amazon.DynamoDBv2.Internal
{
    ...
    public class AmazonDynamoDBAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDynamoDBAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DynamoDB.
        /// </summary>
        public AmazonDynamoDBAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDynamoDBAuthSchemeParameters
            {
    ...
    public class AmazonDynamoDBAuthSchemeResolver : IAuthSchemeResolver<AmazonDynamoDBAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDynamoDBAuthSchemeParameters authParameters)
        {
