...
namespace Amazon.DynamoDBv2.Model
{
    ...
    internal sealed partial class ListExportsPaginator : IPaginator<ListExportsResponse>, IListExportsPaginator
    {
        ...
        internal ListExportsPaginator(IAmazonDynamoDB client, ListExportsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListExportsResponse> IPaginator<ListExportsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
