...
namespace Amazon.DynamoDBv2.Model
{
    ...
    public partial class PointInTimeRecoveryUnavailableException : AmazonDynamoDBException
    {
        ...
        public PointInTimeRecoveryUnavailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PointInTimeRecoveryUnavailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
