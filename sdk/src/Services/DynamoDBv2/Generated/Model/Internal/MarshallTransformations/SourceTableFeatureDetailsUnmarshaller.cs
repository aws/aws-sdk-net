...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceTableFeatureDetailsUnmarshaller : IUnmarshaller<SourceTableFeatureDetails, XmlUnmarshallerContext>, IUnmarshaller<SourceTableFeatureDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SourceTableFeatureDetails IUnmarshaller<SourceTableFeatureDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SourceTableFeatureDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GlobalSecondaryIndexInfo, GlobalSecondaryIndexInfoUnmarshaller>(GlobalSecondaryIndexInfoUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LocalSecondaryIndexInfo, LocalSecondaryIndexInfoUnmarshaller>(LocalSecondaryIndexInfoUnmarshaller.Instance);
                ...
                if (context.TestExpression("StreamDescription", targetDepth))
                {
                    ...
                    unmarshalledObject.StreamDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TimeToLiveDescription", targetDepth))
                {
                    var unmarshaller = TimeToLiveDescriptionUnmarshaller.Instance;
                    unmarshalledObject.TimeToLiveDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
