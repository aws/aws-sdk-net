...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateTimeToLiveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("TimeToLiveSpecification", targetDepth, ref reader))
                {
                    var unmarshaller = TimeToLiveSpecificationUnmarshaller.Instance;
                    response.TimeToLiveSpecification = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateTimeToLiveResponseUnmarshaller _instance = new UpdateTimeToLiveResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTimeToLiveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
