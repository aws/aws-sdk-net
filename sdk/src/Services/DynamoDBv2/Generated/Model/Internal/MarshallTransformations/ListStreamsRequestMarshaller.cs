...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    public class ListStreamsRequestMarshaller : IMarshaller<IRequest, ListStreamsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListStreamsRequest publicRequest)
        {
            ...
            string target = "DynamoDBStreams_20120810.ListStreams";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetExclusiveStartStreamArn())
                {
                    context.Writer.WritePropertyName("ExclusiveStartStreamArn");
                    context.Writer.Write(publicRequest.ExclusiveStartStreamArn);
                }
