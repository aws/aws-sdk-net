...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LocalSecondaryIndexInfoUnmarshaller : IUnmarshaller<LocalSecondaryIndexInfo, XmlUnmarshallerContext>, IUnmarshaller<LocalSecondaryIndexInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LocalSecondaryIndexInfo IUnmarshaller<LocalSecondaryIndexInfo, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public LocalSecondaryIndexInfo Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            LocalSecondaryIndexInfo unmarshalledObject = new LocalSecondaryIndexInfo();
        ...
        private static LocalSecondaryIndexInfoUnmarshaller _instance = new LocalSecondaryIndexInfoUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LocalSecondaryIndexInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
