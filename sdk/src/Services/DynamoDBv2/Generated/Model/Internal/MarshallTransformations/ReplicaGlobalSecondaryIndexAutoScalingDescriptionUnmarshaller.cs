...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    public class ReplicaGlobalSecondaryIndexAutoScalingDescriptionUnmarshaller : IJsonUnmarshaller<ReplicaGlobalSecondaryIndexAutoScalingDescription, JsonUnmarshallerContext>
    {
        ...
        private static ReplicaGlobalSecondaryIndexAutoScalingDescriptionUnmarshaller _instance = new ReplicaGlobalSecondaryIndexAutoScalingDescriptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReplicaGlobalSecondaryIndexAutoScalingDescriptionUnmarshaller Instance
        {
            get
            {
                return _instance;
