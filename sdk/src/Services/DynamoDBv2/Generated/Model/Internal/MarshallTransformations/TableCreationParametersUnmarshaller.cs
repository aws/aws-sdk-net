...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TableCreationParametersUnmarshaller : IUnmarshaller<TableCreationParameters, XmlUnmarshallerContext>, IUnmarshaller<TableCreationParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TableCreationParameters IUnmarshaller<TableCreationParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TableCreationParameters Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GlobalSecondaryIndex, GlobalSecondaryIndexUnmarshaller>(GlobalSecondaryIndexUnmarshaller.Instance);
