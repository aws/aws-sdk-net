...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateGlobalTableRequestMarshaller : IMarshaller<IRequest, CreateGlobalTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateGlobalTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateGlobalTableRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DynamoDBv2");
            string target = "DynamoDB_20120810.CreateGlobalTable";
        ...
        private static CreateGlobalTableRequestMarshaller _instance = new CreateGlobalTableRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlobalTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
