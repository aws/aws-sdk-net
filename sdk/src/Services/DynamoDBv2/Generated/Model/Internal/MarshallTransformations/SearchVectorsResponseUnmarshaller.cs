...
{
    /// <summary>
    /// Response Unmarshaller for SearchVectors operation
    /// </summary>  
    public class SearchVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchVectorsResponse response = new SearchVectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = VectorCapacityUnmarshaller.Instance;
        ...
        private static SearchVectorsResponseUnmarshaller _instance = new SearchVectorsResponseUnmarshaller();        

        internal static SearchVectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchVectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
