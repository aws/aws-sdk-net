...
namespace Amazon.DynamoDBv2.Model
{
    ...
    /// will need to delete the item, and then use <i>PutItem</i> to create a new item with
    /// new attributes.
    /// </para>
    ///  </note> 
    /// <para>
    ...
    /// values will be rejected with a <i>ValidationException</i> exception.
    /// </para>
    /// </summary>
    public partial class AttributeValueUpdate
    {
        ...
        /// the <i>DELETE</i> action specified <code>[a,c]</code>, then the final attribute value
        /// would be <code>[b]</code>. Specifying an empty set is an error.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ...
        /// the <i>Value</i> is mathematically added to the existing attribute. If <i>Value</i>
        ...
        /// <i>Value</i> is added to the existing set. (This is a <i>set</i> operation, not mathematical
        /// addition.) For example, if the attribute value was the set <code>[1,2]</code>, and
        /// the <code>ADD</code> action specified <code>[3]</code>, then the final attribute value
        /// would be <code>[1,2,3]</code>. An error occurs if an Add action is specified for a
