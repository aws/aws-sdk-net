...
namespace Amazon.DynamoDBv2
{
    ...
    public partial interface IAmazonDynamoDB : IAmazonService, IDisposable
    {
        ...
        void DescribeGlobalTableSettingsAsync(DescribeGlobalTableSettingsRequest request, AmazonServiceCallback<DescribeGlobalTableSettingsRequest, DescribeGlobalTableSettingsResponse> callback, AsyncOptions options = null);
        ...
        void DescribeTimeToLiveAsync(string tableName,  AmazonServiceCallback<DescribeTimeToLiveRequest, DescribeTimeToLiveResponse> callback, AsyncOptions options = null);
        ...
        ///          procedure using the AsyncState property.</param>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeTimeToLive">REST API Reference for DescribeTimeToLive Operation</seealso>
        void DescribeTimeToLiveAsync(DescribeTimeToLiveRequest request, AmazonServiceCallback<DescribeTimeToLiveRequest, DescribeTimeToLiveResponse> callback, AsyncOptions options = null);
        ...
        void ListTagsOfResourceAsync(ListTagsOfResourceRequest request, AmazonServiceCallback<ListTagsOfResourceRequest, ListTagsOfResourceResponse> callback, AsyncOptions options = null);
        ...
        void RestoreTableToPointInTimeAsync(RestoreTableToPointInTimeRequest request, AmazonServiceCallback<RestoreTableToPointInTimeRequest, RestoreTableToPointInTimeResponse> callback, AsyncOptions options = null);
        ...
        void TransactGetItemsAsync(TransactGetItemsRequest request, AmazonServiceCallback<TransactGetItemsRequest, TransactGetItemsResponse> callback, AsyncOptions options = null);
        ...
        void TransactWriteItemsAsync(TransactWriteItemsRequest request, AmazonServiceCallback<TransactWriteItemsRequest, TransactWriteItemsResponse> callback, AsyncOptions options = null);
        ...
        void UpdateGlobalTableSettingsAsync(UpdateGlobalTableSettingsRequest request, AmazonServiceCallback<UpdateGlobalTableSettingsRequest, UpdateGlobalTableSettingsResponse> callback, AsyncOptions options = null);
        ...
        void UpdateTimeToLiveAsync(UpdateTimeToLiveRequest request, AmazonServiceCallback<UpdateTimeToLiveRequest, UpdateTimeToLiveResponse> callback, AsyncOptions options = null);
