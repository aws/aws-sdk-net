...
namespace Amazon.DynamoDBv2
{
    ...
    /// <summary>
    /// Constants used for properties of type GlobalTableSettingsReplicationMode.
    /// </summary>
    public class GlobalTableSettingsReplicationMode : ConstantClass
    {

        /// <summary>
        /// Constant DISABLED for GlobalTableSettingsReplicationMode
        /// </summary>
        public static readonly GlobalTableSettingsReplicationMode DISABLED = new GlobalTableSettingsReplicationMode("DISABLED");
        /// <summary>
        /// Constant ENABLED for GlobalTableSettingsReplicationMode
        /// </summary>
        public static readonly GlobalTableSettingsReplicationMode ENABLED = new GlobalTableSettingsReplicationMode("ENABLED");
        /// <summary>
        /// Constant ENABLED_WITH_OVERRIDES for GlobalTableSettingsReplicationMode
        /// </summary>
        public static readonly GlobalTableSettingsReplicationMode ENABLED_WITH_OVERRIDES = new GlobalTableSettingsReplicationMode("ENABLED_WITH_OVERRIDES");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public GlobalTableSettingsReplicationMode(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static GlobalTableSettingsReplicationMode FindValue(string value)
        {
            return FindValue<GlobalTableSettingsReplicationMode>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator GlobalTableSettingsReplicationMode(string value)
        {
            return FindValue(value);
        }
    }
