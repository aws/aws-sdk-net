...
#if BCL
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (4.6.2) - Amazon DynamoDB. Amazon DynamoDB is a fast and flexible NoSQL database service for all applications that need consistent, single-digit millisecond latency at any scale.")]
#elif NETSTANDARD20
