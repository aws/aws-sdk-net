...
{
    /// <summary>
    /// Additional input for the FromSearchVectors operation in the object-persistence programming model. This supplements
    /// <see cref="SearchVectorsConfig"/>, which is shared between the document and object-persistence models.
    /// </summary>
    public class FromSearchVectorsConfig : BaseOperationConfig
    {
        /// <summary>
