...
namespace Amazon.DynamoDBv2.DataModel
{
    ...
    /// <item><description><see cref="TimestampMode.Update"/>: Set only when the item is updated.</description></item>
    /// <item><description><see cref="TimestampMode.Always"/>: Set on both create and update.</description></item>
    /// </list>
    /// </remarks>
    [AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, Inherited = true, AllowMultiple = false)]
    public sealed class AutoGeneratedTimestampAttribute : DynamoDBPropertyAttribute
    {
        /// <summary>
        ...
        /// </summary>
        public AutoGeneratedTimestampAttribute()
            : base()
        {
        ...
        public AutoGeneratedTimestampAttribute(TimestampMode mode)
            : base()
        {
            Mode = mode;
        }
        ...
        public AutoGeneratedTimestampAttribute(string attributeName)
            : base(attributeName)
        {
            Mode = TimestampMode.Always;
        }
        ...
        /// <param name="attributeName">Name of attribute to be associated with property or field.</param>
        /// <param name="mode">Specifies when the timestamp should be generated.</param>
        public AutoGeneratedTimestampAttribute(string attributeName, TimestampMode mode)
            : base(attributeName)
        {
            Mode = mode;
        }
        ...
        /// </summary>
        /// <param name="converter">Custom converter type.</param>
        public AutoGeneratedTimestampAttribute([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.Interfaces)] Type converter)
            : base(converter)
        {
            Mode = TimestampMode.Always;
        }
        ...
        /// <param name="converter">Custom converter type.</param>
        /// <param name="mode">Specifies when the timestamp should be generated.</param>
        public AutoGeneratedTimestampAttribute([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.Interfaces)] Type converter, TimestampMode mode)
            : base(converter)
        {
            Mode = mode;
        }
        ...
        /// <param name="attributeName">Name of attribute to be associated with property or field.</param>
        /// <param name="converter">Custom converter type.</param>
        public AutoGeneratedTimestampAttribute(string attributeName, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.Interfaces)] Type converter)
            : base(attributeName, converter)
        {
            Mode = TimestampMode.Always;
        }
        ...
        /// <param name="converter">Custom converter type.</param>
        /// <param name="mode">Specifies when the timestamp should be generated.</param>
        public AutoGeneratedTimestampAttribute(string attributeName, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.Interfaces)] Type converter, TimestampMode mode)
            : base(attributeName, converter)
        {
            Mode = mode;
        }
    ...
    public enum TimestampMode
    {
        ...
        Create,
        /// <summary>
        /// Set the timestamp only when the item is updated.
        /// </summary>
        Update,
        /// <summary>
