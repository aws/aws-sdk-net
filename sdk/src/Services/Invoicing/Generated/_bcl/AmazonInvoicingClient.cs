...
namespace Amazon.Invoicing
{
    ...
    public partial class AmazonInvoicingClient : AmazonServiceClient, IAmazonInvoicing
    {
        ...
        public virtual SendProcurementPortalValidationResponse SendProcurementPortalValidation(SendProcurementPortalValidationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual VerifyProcurementPortalValidationResponse VerifyProcurementPortalValidation(VerifyProcurementPortalValidationRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
