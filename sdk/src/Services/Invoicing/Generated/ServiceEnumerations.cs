...
namespace Amazon.Invoicing
{
    ...
    /// <summary>
    /// Constants used for properties of type ProcurementPortalEnv.
    /// </summary>
    public class ProcurementPortalEnv : ConstantClass
    {

        /// <summary>
        /// Constant PROD for ProcurementPortalEnv
        /// </summary>
        public static readonly ProcurementPortalEnv PROD = new ProcurementPortalEnv("PROD");
        /// <summary>
        /// Constant TEST for ProcurementPortalEnv
        /// </summary>
        public static readonly ProcurementPortalEnv TEST = new ProcurementPortalEnv("TEST");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ProcurementPortalEnv(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ProcurementPortalEnv FindValue(string value)
        {
            return FindValue<ProcurementPortalEnv>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ProcurementPortalEnv(string value)
        {
            return FindValue(value);
        }
    }
