...
namespace Amazon.Invoicing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvoiceCurrencyAmountUnmarshaller : IUnmarshaller<InvoiceCurrencyAmount, XmlUnmarshallerContext>, IUnmarshaller<InvoiceCurrencyAmount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InvoiceCurrencyAmount IUnmarshaller<InvoiceCurrencyAmount, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InvoiceCurrencyAmount Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AmountBreakdown", targetDepth))
                {
                    ...
                    unmarshalledObject.AmountBreakdown = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("CurrencyExchangeDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.CurrencyExchangeDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TotalAmountBeforeTax = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
