...
namespace Amazon.Invoicing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaxesBreakdownUnmarshaller : IUnmarshaller<TaxesBreakdown, XmlUnmarshallerContext>, IUnmarshaller<TaxesBreakdown, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TaxesBreakdown IUnmarshaller<TaxesBreakdown, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TaxesBreakdown Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TaxesBreakdownAmount, TaxesBreakdownAmountUnmarshaller>(TaxesBreakdownAmountUnmarshaller.Instance);
