...
{
    /// <summary>
    /// Response Unmarshaller for ProcurementPortalSupplier Object
    /// </summary>  
    public class ProcurementPortalSupplierUnmarshaller : IJsonUnmarshaller<ProcurementPortalSupplier, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProcurementPortalSupplier Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ProcurementPortalSupplier unmarshalledObject = new ProcurementPortalSupplier();
        ...
        private static ProcurementPortalSupplierUnmarshaller _instance = new ProcurementPortalSupplierUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProcurementPortalSupplierUnmarshaller Instance
        {
            get
            {
                return _instance;
