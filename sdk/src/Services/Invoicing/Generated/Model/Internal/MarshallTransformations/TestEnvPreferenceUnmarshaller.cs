...
namespace Amazon.Invoicing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestEnvPreferenceUnmarshaller : IJsonUnmarshaller<TestEnvPreference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TestEnvPreference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
