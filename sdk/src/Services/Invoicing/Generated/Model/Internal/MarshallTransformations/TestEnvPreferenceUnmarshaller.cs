...
{
    /// <summary>
    /// Response Unmarshaller for TestEnvPreference Object
    /// </summary>  
    public class TestEnvPreferenceUnmarshaller : IUnmarshaller<TestEnvPreference, XmlUnmarshallerContext>, IUnmarshaller<TestEnvPreference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TestEnvPreference IUnmarshaller<TestEnvPreference, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TestEnvPreference Unmarshall(JsonUnmarshallerContext context)
        {
            TestEnvPreference unmarshalledObject = new TestEnvPreference();
        ...
        private static TestEnvPreferenceUnmarshaller _instance = new TestEnvPreferenceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TestEnvPreferenceUnmarshaller Instance
        {
            get
            {
                return _instance;
