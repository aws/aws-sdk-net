...
namespace Amazon.Invoicing.Model
{
    ...
    public interface IListProcurementPortalPreferencesPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListProcurementPortalPreferencesResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the ProcurementPortalPreferences
        /// </summary>
        IPaginatedEnumerable<ProcurementPortalPreferenceSummary> ProcurementPortalPreferences { get; }
    }
}