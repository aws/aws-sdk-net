...
{
    /// <summary>
    /// Container for the parameters to the AddBridgeOutputs operation. Adds outputs to an
    /// existing bridge.
    /// </summary>
    public partial class AddBridgeOutputsRequest : AmazonMediaConnectRequest
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<AddBridgeOutputRequest> Outputs { get; set; } = AWSConfigs.InitializeCollections ? new List<AddBridgeOutputRequest>() : null;
