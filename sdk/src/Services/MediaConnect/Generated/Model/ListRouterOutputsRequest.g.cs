...
{
    /// <summary>
    /// Container for the parameters to the ListRouterOutputs operation. Retrieves a list
    /// of router outputs in AWS Elemental MediaConnect.
    /// </summary>
    public partial class ListRouterOutputsRequest : AmazonMediaConnectRequest
    {
        ...
        /// </summary>
        public List<RouterOutputFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<RouterOutputFilter>() : null;
