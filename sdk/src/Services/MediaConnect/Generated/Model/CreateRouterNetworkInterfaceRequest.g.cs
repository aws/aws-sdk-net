...
{
    /// <summary>
    /// Container for the parameters to the CreateRouterNetworkInterface operation. Creates
    /// a new router network interface in AWS Elemental MediaConnect.
    /// </summary>
    public partial class CreateRouterNetworkInterfaceRequest : AmazonMediaConnectRequest
    {
        ...
        public RouterNetworkInterfaceConfiguration Configuration { get; set; }
