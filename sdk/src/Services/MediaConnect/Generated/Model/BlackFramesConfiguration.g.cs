...
{
    /// <summary>
    /// Detects black frames in the router input's source content and reports them through
    /// a CloudWatch metric, an EventBridge event, and a router input message.
    /// </summary>
    public partial class BlackFramesConfiguration
    {
        /// <summary>
        ...
        /// <para>
        /// The number of consecutive seconds of black frames that MediaConnect must detect before
        /// it reports an issue.
        /// </para>
        /// </summary>
