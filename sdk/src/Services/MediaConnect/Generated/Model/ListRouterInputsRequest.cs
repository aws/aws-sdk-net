...
{
    /// <summary>
    /// Container for the parameters to the ListRouterInputs operation.
    ...
    {
        private List<RouterInputFilter> _filters = AWSConfigs.InitializeCollections ? new List<RouterInputFilter>() : null;
        ...
        /// </para>
        /// </summary>
        public List<RouterInputFilter> Filters
        {
