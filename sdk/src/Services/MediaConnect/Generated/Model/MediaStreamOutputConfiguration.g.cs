...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class MediaStreamOutputConfiguration
    {
        ...
        /// </summary>
        public List<DestinationConfiguration> DestinationConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<DestinationConfiguration>() : null;

        /// <summary>
        /// Checks to see if the DestinationConfigurations property is set.
        /// </summary>
        internal bool IsSetDestinationConfigurations() => this.DestinationConfigurations != null && (this.DestinationConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the EncodingParameters property is set.
        /// </summary>
        internal bool IsSetEncodingParameters() => this.EncodingParameters != null;
