...
{
    /// <summary>
    /// Detects frozen video frames in the router input's source content and reports them
    /// through a CloudWatch metric, an EventBridge event, and a router input message.
    /// </summary>
    public partial class FrozenFramesConfiguration
    {
        /// <summary>
        ...
        /// <para>
        /// The number of consecutive seconds of a frozen frame that MediaConnect must detect
