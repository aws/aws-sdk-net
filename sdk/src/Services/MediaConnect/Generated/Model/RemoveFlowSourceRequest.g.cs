...
{
    /// <summary>
    /// Container for the parameters to the RemoveFlowSource operation. Removes a source from
    /// an existing flow. This request can be made only if there is more than one source on
    /// the flow.
    /// </summary>
