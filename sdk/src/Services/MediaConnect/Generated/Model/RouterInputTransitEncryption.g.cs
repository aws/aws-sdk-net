...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class RouterInputTransitEncryption
    {
        ...
        public RouterInputTransitEncryptionKeyConfiguration EncryptionKeyConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the EncryptionKeyConfiguration property is set.
        /// </summary>
        internal bool IsSetEncryptionKeyConfiguration() => this.EncryptionKeyConfiguration != null;
        ...
        /// </para>
        /// </summary>
        public RouterInputTransitEncryptionKeyType EncryptionKeyType { get; set; }
