...
{
    /// <summary>
    /// Container for the parameters to the UpdateBridgeOutput operation. Updates an existing
    /// bridge output.
    /// </summary>
    public partial class UpdateBridgeOutputRequest : AmazonMediaConnectRequest
    {
        ...
        /// <summary>
        /// Checks to see if the OutputName property is set.
        /// </summary>
        internal bool IsSetOutputName() => this.OutputName != null;
    }
}
