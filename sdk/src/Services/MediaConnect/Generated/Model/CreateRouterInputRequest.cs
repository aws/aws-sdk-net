...
{
    /// <summary>
    /// Container for the parameters to the CreateRouterInput operation.
    /// Creates a new router input in AWS Elemental MediaConnect.
    /// </summary>
    public partial class CreateRouterInputRequest : AmazonMediaConnectRequest
    {
        ...
        /// <para>
        /// The Availability Zone where you want to create the router input. This must be a valid
        ...
        /// <para>
        /// The configuration settings for the router input, which can include the protocol, network
        /// interface, and other details.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The maintenance configuration settings for the router input, including preferred maintenance
        ...
        /// REGIONAL (default) - connects only to outputs in same Region. GLOBAL - connects to
        /// outputs in any Region.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
