...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class EncodingConfig
    {
        ...
        /// <summary>
        /// Checks to see if the EncodingProfile property is set.
        /// </summary>
        internal bool IsSetEncodingProfile() => this.EncodingProfile != null;
        ...
        /// <summary>
        /// Checks to see if the VideoMaxBitrate property is set.
        /// </summary>
        internal bool IsSetVideoMaxBitrate() => this.VideoMaxBitrate.HasValue;
    }
}
