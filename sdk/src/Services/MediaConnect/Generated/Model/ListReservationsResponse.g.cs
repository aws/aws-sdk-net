...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class ListReservationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Reservation> Reservations { get; set; } = AWSConfigs.InitializeCollections ? new List<Reservation>() : null;

        /// <summary>
        /// Checks to see if the Reservations property is set.
        /// </summary>
        internal bool IsSetReservations() => this.Reservations != null && (this.Reservations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
