...
{
    /// <summary>
    /// Container for the parameters to the DescribeOffering operation. Displays the details
    /// of an offering. The response includes the offering description, duration, outbound
