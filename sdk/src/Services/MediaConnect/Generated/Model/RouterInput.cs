...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class RouterInput
    {
        ...
        private int? _maximumRoutedOutputs;
        private List<RouterInputMessage> _messages = AWSConfigs.InitializeCollections ? new List<RouterInputMessage>() : null;
        private string _name;
        private string _regionName;
        private int? _routedOutputs;
        private RoutingScope _routingScope;
        private RouterInputState _state;
        private RouterInputStreamDetails _streamDetails;
        ...
        /// </para>
        /// </summary>
        public int MaximumRoutedOutputs
        {
            get { return this._maximumRoutedOutputs.GetValueOrDefault(); }
            set { this._maximumRoutedOutputs = value; }
        }

        // Check to see if MaximumRoutedOutputs property is set
        internal bool IsSetMaximumRoutedOutputs()
        {
            return this._maximumRoutedOutputs.HasValue; 
        }
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<RouterInputMessage> Messages
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public RouterInputStreamDetails StreamDetails
        {
