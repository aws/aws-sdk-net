...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class RouterOutputFilter
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> OutputTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the OutputTypes property is set.
        /// </summary>
        internal bool IsSetOutputTypes() => this.OutputTypes != null && (this.OutputTypes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> RoutedInputArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the RoutedInputArns property is set.
        /// </summary>
        internal bool IsSetRoutedInputArns() => this.RoutedInputArns != null && (this.RoutedInputArns.Count > 0 || !AWSConfigs.InitializeCollections);
