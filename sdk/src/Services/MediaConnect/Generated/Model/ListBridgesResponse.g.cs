...
{
    /// <summary>
    /// This is the response object from the ListBridges operation.
    /// </summary>
    public partial class ListBridgesResponse : AmazonWebServiceResponse
    {
        /// <summary>
        /// Gets and sets the property Bridges. 
        /// <para>
        ...
        /// </summary>
        public List<ListedBridge> Bridges { get; set; } = AWSConfigs.InitializeCollections ? new List<ListedBridge>() : null;

        /// <summary>
        /// Checks to see if the Bridges property is set.
        /// </summary>
        internal bool IsSetBridges() => this.Bridges != null && (this.Bridges.Count > 0 || !AWSConfigs.InitializeCollections);
