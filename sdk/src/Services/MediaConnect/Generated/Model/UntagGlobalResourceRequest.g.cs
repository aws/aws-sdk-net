...
{
    /// <summary>
    /// Container for the parameters to the UntagGlobalResource operation. Removes tags from
    /// a global resource in AWS Elemental MediaConnect. The API supports the following global
    /// resources: router inputs, router outputs and router network interfaces.
    /// </summary>
    public partial class UntagGlobalResourceRequest : AmazonMediaConnectRequest
    {
        /// <summary>
