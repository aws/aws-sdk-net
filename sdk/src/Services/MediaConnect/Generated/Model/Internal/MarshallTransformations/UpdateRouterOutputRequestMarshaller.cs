...
{
    /// <summary>
    /// UpdateRouterOutput Request Marshaller
    /// </summary>       
    public class UpdateRouterOutputRequestMarshaller : IMarshaller<IRequest, UpdateRouterOutputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRouterOutputRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRouterOutputRequest publicRequest)
        {
        ...
        private static UpdateRouterOutputRequestMarshaller _instance = new UpdateRouterOutputRequestMarshaller();        

        internal static UpdateRouterOutputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRouterOutputRequestMarshaller Instance
        {
            get
            {
                return _instance;
