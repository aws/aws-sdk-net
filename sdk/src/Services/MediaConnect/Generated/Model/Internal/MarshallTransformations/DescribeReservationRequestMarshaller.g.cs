...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeReservationRequestMarshaller : IMarshaller<IRequest, DescribeReservationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeReservationRequestMarshaller _instance = new();

        internal static DescribeReservationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeReservationRequestMarshaller Instance => _instance;
    }
}
