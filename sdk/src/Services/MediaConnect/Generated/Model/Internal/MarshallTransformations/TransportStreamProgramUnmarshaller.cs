...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransportStreamProgramUnmarshaller : IUnmarshaller<TransportStreamProgram, XmlUnmarshallerContext>, IUnmarshaller<TransportStreamProgram, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TransportStreamProgram IUnmarshaller<TransportStreamProgram, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TransportStreamProgram Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TransportStream, TransportStreamUnmarshaller>(TransportStreamUnmarshaller.Instance);
