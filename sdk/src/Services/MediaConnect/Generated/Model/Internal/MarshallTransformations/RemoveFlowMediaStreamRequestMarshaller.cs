...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveFlowMediaStreamRequestMarshaller : IMarshaller<IRequest, RemoveFlowMediaStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static RemoveFlowMediaStreamRequestMarshaller _instance = new RemoveFlowMediaStreamRequestMarshaller();        

        internal static RemoveFlowMediaStreamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveFlowMediaStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
