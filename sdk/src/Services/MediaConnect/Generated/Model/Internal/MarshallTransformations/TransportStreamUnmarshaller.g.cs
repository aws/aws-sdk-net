...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TransportStreamUnmarshaller : IJsonUnmarshaller<TransportStream, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TransportStream();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("frameResolution", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("streamType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static TransportStreamUnmarshaller Instance => _instance;
    }
}
