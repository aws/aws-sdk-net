...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RestartRouterInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestartRouterInputResponse response = new RestartRouterInputResponse();
        ...
        internal static RestartRouterInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestartRouterInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
