...
{
    /// <summary>
    /// AddBridgeSources Request Marshaller
    /// </summary>
    public partial class AddBridgeSourcesRequestMarshaller : IMarshaller<IRequest, AddBridgeSourcesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddBridgeSourcesRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(AddBridgeSourcesRequest publicRequest)
        {
        ...
        private static readonly AddBridgeSourcesRequestMarshaller _instance = new();

        internal static AddBridgeSourcesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddBridgeSourcesRequestMarshaller Instance => _instance;
    }
}
