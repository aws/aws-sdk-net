...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MaintenanceConfigurationUnmarshaller : IJsonUnmarshaller<MaintenanceConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MaintenanceConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("preferredDayTime", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static MaintenanceConfigurationUnmarshaller Instance => _instance;
    }
}
