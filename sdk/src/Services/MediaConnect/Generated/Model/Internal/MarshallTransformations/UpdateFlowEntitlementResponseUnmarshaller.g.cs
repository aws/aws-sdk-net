...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFlowEntitlement operation.
    /// </summary>
    public partial class UpdateFlowEntitlementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateFlowEntitlementResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("entitlement", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Entitlement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateFlowEntitlementResponseUnmarshaller _instance = new UpdateFlowEntitlementResponseUnmarshaller();

        internal static UpdateFlowEntitlementResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateFlowEntitlementResponseUnmarshaller Instance => _instance;
    }
}
