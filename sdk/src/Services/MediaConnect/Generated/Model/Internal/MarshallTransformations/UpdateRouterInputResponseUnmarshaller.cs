...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateRouterInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRouterInputResponse response = new UpdateRouterInputResponse();
        ...
        internal static UpdateRouterInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRouterInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
