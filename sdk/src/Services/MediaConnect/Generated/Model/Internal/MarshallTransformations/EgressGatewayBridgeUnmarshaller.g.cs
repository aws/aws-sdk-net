...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EgressGatewayBridgeUnmarshaller : IJsonUnmarshaller<EgressGatewayBridge, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public EgressGatewayBridge Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new EgressGatewayBridge();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EgressGatewayBridgeUnmarshaller Instance => _instance;
    }
}
