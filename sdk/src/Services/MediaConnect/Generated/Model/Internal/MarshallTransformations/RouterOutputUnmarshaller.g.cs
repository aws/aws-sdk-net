...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RouterOutputUnmarshaller : IJsonUnmarshaller<RouterOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RouterOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RouterOutput();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("maintenanceConfiguration", targetDepth, ref reader))
                {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RouterOutputMessage, RouterOutputMessageUnmarshaller>(RouterOutputMessageUnmarshaller.Instance);
                ...
                if (context.TestExpression("routedInputArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutedInputArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("routedState", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutedState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("streamDetails", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RouterOutputUnmarshaller Instance => _instance;
    }
}
