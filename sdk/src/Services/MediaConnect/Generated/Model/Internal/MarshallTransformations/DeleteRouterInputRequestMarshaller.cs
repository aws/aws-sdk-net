...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRouterInputRequestMarshaller : IMarshaller<IRequest, DeleteRouterInputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteRouterInputRequestMarshaller _instance = new DeleteRouterInputRequestMarshaller();        

        internal static DeleteRouterInputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRouterInputRequestMarshaller Instance
        {
            get
            {
                return _instance;
