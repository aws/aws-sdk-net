...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListFlowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListFlowsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListedFlow, ListedFlowUnmarshaller>(ListedFlowUnmarshaller.Instance);
                    unmarshalledObject.Flows = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListFlowsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListFlowsResponseUnmarshaller Instance => _instance;
    }
}
