...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeFlowSourceThumbnailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeFlowSourceThumbnailResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("thumbnailDetails", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ThumbnailDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeFlowSourceThumbnailResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeFlowSourceThumbnailResponseUnmarshaller Instance => _instance;
    }
}
