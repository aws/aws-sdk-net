...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRouterInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRouterInputResponse response = new GetRouterInputResponse();
        ...
        internal static GetRouterInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRouterInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
