...
{
    /// <summary>
    /// Response Unmarshaller for RouterOutput Object
    /// </summary>  
    public class RouterOutputUnmarshaller : IUnmarshaller<RouterOutput, XmlUnmarshallerContext>, IUnmarshaller<RouterOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RouterOutput IUnmarshaller<RouterOutput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RouterOutput Unmarshall(JsonUnmarshallerContext context)
        {
            RouterOutput unmarshalledObject = new RouterOutput();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = RouterOutputConfigurationUnmarshaller.Instance;
                ...
                if (context.TestExpression("maintenanceConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.MaintenanceConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RouterOutputMessage, RouterOutputMessageUnmarshaller>(RouterOutputMessageUnmarshaller.Instance);
                ...
                if (context.TestExpression("routedInputArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutedInputArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("routedState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutedState = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = RouterOutputStreamDetailsUnmarshaller.Instance;
                    unmarshalledObject.StreamDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static RouterOutputUnmarshaller _instance = new RouterOutputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RouterOutputUnmarshaller Instance
        {
            get
            {
                return _instance;
