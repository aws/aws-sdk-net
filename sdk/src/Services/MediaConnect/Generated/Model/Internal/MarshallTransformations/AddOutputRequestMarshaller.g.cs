...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddOutputRequestMarshaller : IRequestMarshaller<AddOutputRequest, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(AddOutputRequest requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetNdiOutputTimecodeSource())
            {
                context.Writer.WritePropertyName("ndiOutputTimecodeSource");
                context.Writer.WriteStringValue(requestObject.NdiOutputTimecodeSource);
            }
