...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteRouterInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRouterInputResponse response = new DeleteRouterInputResponse();
        ...
        internal static DeleteRouterInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRouterInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
