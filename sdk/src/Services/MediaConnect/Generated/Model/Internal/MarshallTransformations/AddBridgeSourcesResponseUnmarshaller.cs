...
{
    /// <summary>
    /// Response Unmarshaller for AddBridgeSources operation
    /// </summary>  
    public class AddBridgeSourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddBridgeSourcesResponse response = new AddBridgeSourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("bridgeArn", targetDepth))
                {
                    ...
                    response.BridgeArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static AddBridgeSourcesResponseUnmarshaller _instance = new AddBridgeSourcesResponseUnmarshaller();        

        internal static AddBridgeSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddBridgeSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
