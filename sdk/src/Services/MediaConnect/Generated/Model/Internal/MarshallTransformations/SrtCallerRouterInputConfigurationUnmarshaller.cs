...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SrtCallerRouterInputConfigurationUnmarshaller : IJsonUnmarshaller<SrtCallerRouterInputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SrtCallerRouterInputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("decryptionConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = SrtDecryptionConfigurationUnmarshaller.Instance;
                    unmarshalledObject.DecryptionConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
