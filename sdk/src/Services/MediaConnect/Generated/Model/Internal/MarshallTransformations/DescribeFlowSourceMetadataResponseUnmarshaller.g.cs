...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeFlowSourceMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeFlowSourceMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ndiInfo", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.NdiInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("transportMediaInfo", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TransportMediaInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeFlowSourceMetadataResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeFlowSourceMetadataResponseUnmarshaller Instance => _instance;
    }
}
