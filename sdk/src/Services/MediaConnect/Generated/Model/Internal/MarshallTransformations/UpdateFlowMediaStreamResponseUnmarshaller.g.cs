...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateFlowMediaStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateFlowMediaStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("mediaStream", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MediaStream = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static UpdateFlowMediaStreamResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateFlowMediaStreamResponseUnmarshaller Instance => _instance;
    }
}
