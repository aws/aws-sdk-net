...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PurchaseOfferingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PurchaseOfferingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("reservation", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Reservation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static PurchaseOfferingResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PurchaseOfferingResponseUnmarshaller Instance => _instance;
    }
}
