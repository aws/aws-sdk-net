...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RouterNetworkInterfaceFilterMarshaller : IRequestMarshaller<RouterNetworkInterfaceFilter, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(RouterNetworkInterfaceFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetNetworkInterfaceTypes())
            {
                ...
                {
                    context.Writer.WriteStringValue(requestObjectNetworkInterfaceTypesListValue);
                }
                context.Writer.WriteEndArray();
            }
