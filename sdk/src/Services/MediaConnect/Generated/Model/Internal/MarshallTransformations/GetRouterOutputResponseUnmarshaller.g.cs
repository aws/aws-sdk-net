...
{
    /// <summary>
    /// Response Unmarshaller for GetRouterOutput operation.
    /// </summary>
    public partial class GetRouterOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetRouterOutputResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("routerOutput", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.RouterOutput = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRouterOutputResponseUnmarshaller _instance = new GetRouterOutputResponseUnmarshaller();

        internal static GetRouterOutputResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRouterOutputResponseUnmarshaller Instance => _instance;
    }
}
