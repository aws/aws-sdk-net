...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBridge operation
    /// </summary>  
    public class UpdateBridgeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBridgeResponse response = new UpdateBridgeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("bridge", targetDepth, ref reader))
                {
                    ...
                    response.Bridge = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateBridgeResponseUnmarshaller _instance = new UpdateBridgeResponseUnmarshaller();        

        internal static UpdateBridgeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBridgeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
