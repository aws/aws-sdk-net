...
{
    /// <summary>
    /// AddFlowMediaStreams Request Marshaller
    /// </summary>       
    public class AddFlowMediaStreamsRequestMarshaller : IMarshaller<IRequest, AddFlowMediaStreamsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddFlowMediaStreamsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddFlowMediaStreamsRequest publicRequest)
        {
        ...
        private static AddFlowMediaStreamsRequestMarshaller _instance = new AddFlowMediaStreamsRequestMarshaller();        

        internal static AddFlowMediaStreamsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddFlowMediaStreamsRequestMarshaller Instance
        {
            get
            {
                return _instance;
