...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NdiConfigUnmarshaller : IJsonUnmarshaller<NdiConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new NdiConfig();
            ...
            {
                if (context.TestExpression("machineName", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ndiDiscoveryServers", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ndiState", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static NdiConfigUnmarshaller _instance = new NdiConfigUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static NdiConfigUnmarshaller Instance => _instance;
    }
}
