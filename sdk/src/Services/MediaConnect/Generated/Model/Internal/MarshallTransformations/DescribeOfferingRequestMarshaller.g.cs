...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeOfferingRequestMarshaller : IMarshaller<IRequest, DescribeOfferingRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeOfferingRequestMarshaller _instance = new();

        internal static DescribeOfferingRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeOfferingRequestMarshaller Instance => _instance;
    }
}
