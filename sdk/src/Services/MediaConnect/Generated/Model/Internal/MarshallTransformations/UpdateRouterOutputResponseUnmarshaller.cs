...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRouterOutput operation
    /// </summary>  
    public class UpdateRouterOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRouterOutputResponse response = new UpdateRouterOutputResponse();
        ...
        private static UpdateRouterOutputResponseUnmarshaller _instance = new UpdateRouterOutputResponseUnmarshaller();        

        internal static UpdateRouterOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRouterOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
