...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartRouterOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRouterOutputResponse response = new StartRouterOutputResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MaintenanceScheduleType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static StartRouterOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRouterOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
