...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeGatewayRequestMarshaller : IMarshaller<IRequest, DescribeGatewayRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeGatewayRequestMarshaller _instance = new();

        internal static DescribeGatewayRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeGatewayRequestMarshaller Instance => _instance;
    }
}
