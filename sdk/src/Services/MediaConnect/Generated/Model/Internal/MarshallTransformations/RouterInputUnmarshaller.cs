...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouterInputUnmarshaller : IUnmarshaller<RouterInput, XmlUnmarshallerContext>, IUnmarshaller<RouterInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RouterInput IUnmarshaller<RouterInput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RouterInput Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("maximumRoutedOutputs", targetDepth))
                {
                    ...
                    unmarshalledObject.MaximumRoutedOutputs = unmarshaller.Unmarshall(context);
                    continue;
                }
