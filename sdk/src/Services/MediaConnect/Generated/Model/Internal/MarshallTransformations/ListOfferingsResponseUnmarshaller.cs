...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListOfferingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("offerings", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Offering, OfferingUnmarshaller>(OfferingUnmarshaller.Instance);
                    response.Offerings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListOfferingsResponseUnmarshaller _instance = new ListOfferingsResponseUnmarshaller();        

        internal static ListOfferingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOfferingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
