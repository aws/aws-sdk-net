...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetRouterOutput operation
    /// </summary>  
    public class BatchGetRouterOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetRouterOutputResponse response = new BatchGetRouterOutputResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchGetRouterOutputError, BatchGetRouterOutputErrorUnmarshaller>(BatchGetRouterOutputErrorUnmarshaller.Instance);
                    response.Errors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("routerOutputs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RouterOutput, RouterOutputUnmarshaller>(RouterOutputUnmarshaller.Instance);
                    response.RouterOutputs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchGetRouterOutputResponseUnmarshaller _instance = new BatchGetRouterOutputResponseUnmarshaller();        

        internal static BatchGetRouterOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetRouterOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
