...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRouterOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRouterOutputResponse response = new GetRouterOutputResponse();
        ...
        internal static GetRouterOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRouterOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
