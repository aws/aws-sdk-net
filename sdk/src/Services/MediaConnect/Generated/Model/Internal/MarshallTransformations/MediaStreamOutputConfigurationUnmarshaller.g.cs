...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MediaStreamOutputConfigurationUnmarshaller : IJsonUnmarshaller<MediaStreamOutputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MediaStreamOutputConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("encodingParameters", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static MediaStreamOutputConfigurationUnmarshaller Instance => _instance;
    }
}
