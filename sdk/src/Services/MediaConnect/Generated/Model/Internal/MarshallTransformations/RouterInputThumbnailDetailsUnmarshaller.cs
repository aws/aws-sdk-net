...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouterInputThumbnailDetailsUnmarshaller : IJsonUnmarshaller<RouterInputThumbnailDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouterInputThumbnailDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("thumbnailMessages", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ThumbnailMessages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
