...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class InputConfigurationUnmarshaller : IJsonUnmarshaller<InputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new InputConfiguration();
            ...
            {
                if (context.TestExpression("inputIp", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("inputPort", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static InputConfigurationUnmarshaller Instance => _instance;
    }
}
