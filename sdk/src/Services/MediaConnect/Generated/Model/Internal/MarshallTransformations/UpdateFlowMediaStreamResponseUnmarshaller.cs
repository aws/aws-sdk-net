...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFlowMediaStream operation
    /// </summary>  
    public class UpdateFlowMediaStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFlowMediaStreamResponse response = new UpdateFlowMediaStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("mediaStream", targetDepth, ref reader))
                {
                    var unmarshaller = MediaStreamUnmarshaller.Instance;
                    response.MediaStream = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateFlowMediaStreamResponseUnmarshaller _instance = new UpdateFlowMediaStreamResponseUnmarshaller();        

        internal static UpdateFlowMediaStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowMediaStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
