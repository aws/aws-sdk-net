...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRouterInput operation.
    /// </summary>
    public partial class UpdateRouterInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateRouterInputResponse();
            ...
            {
                if (context.TestExpression("routerInput", targetDepth, ref reader))
                {
                    var unmarshaller = RouterInputUnmarshaller.Instance;
                    unmarshalledObject.RouterInput = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateRouterInputResponseUnmarshaller _instance = new UpdateRouterInputResponseUnmarshaller();

        internal static UpdateRouterInputResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRouterInputResponseUnmarshaller Instance => _instance;
    }
}
