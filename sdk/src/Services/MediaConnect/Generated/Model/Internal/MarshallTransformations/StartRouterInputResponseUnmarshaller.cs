...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartRouterInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRouterInputResponse response = new StartRouterInputResponse();
        ...
        internal static StartRouterInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRouterInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
