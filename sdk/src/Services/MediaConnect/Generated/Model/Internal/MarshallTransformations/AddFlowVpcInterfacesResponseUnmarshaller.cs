...
{
    /// <summary>
    /// Response Unmarshaller for AddFlowVpcInterfaces operation
    /// </summary>  
    public class AddFlowVpcInterfacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddFlowVpcInterfacesResponse response = new AddFlowVpcInterfacesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("flowArn", targetDepth))
                {
                    ...
                    response.FlowArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("vpcInterfaces", targetDepth))
                {
                    ...
                    response.VpcInterfaces = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static AddFlowVpcInterfacesResponseUnmarshaller _instance = new AddFlowVpcInterfacesResponseUnmarshaller();        

        internal static AddFlowVpcInterfacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddFlowVpcInterfacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
