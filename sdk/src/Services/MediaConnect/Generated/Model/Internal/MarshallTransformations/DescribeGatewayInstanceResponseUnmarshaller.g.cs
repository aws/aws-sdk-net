...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeGatewayInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeGatewayInstanceResponse();
            ...
            {
                if (context.TestExpression("gatewayInstance", targetDepth, ref reader))
                {
                    var unmarshaller = GatewayInstanceUnmarshaller.Instance;
                    unmarshalledObject.GatewayInstance = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeGatewayInstanceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeGatewayInstanceResponseUnmarshaller Instance => _instance;
    }
}
