...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBridgeOutput operation.
    /// </summary>
    public partial class UpdateBridgeOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateBridgeOutputResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = BridgeOutputUnmarshaller.Instance;
        ...
        private static UpdateBridgeOutputResponseUnmarshaller _instance = new UpdateBridgeOutputResponseUnmarshaller();

        internal static UpdateBridgeOutputResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateBridgeOutputResponseUnmarshaller Instance => _instance;
    }
}
