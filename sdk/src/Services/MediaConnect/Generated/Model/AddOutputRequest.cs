...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class AddOutputRequest
    {
        ...
        /// specify this field, MediaConnect uses <c>EMBEDDED_TIMECODE</c>.
        /// </para>
        ///  <ul> <li> 
        /// <para>
        ///  <c>EMBEDDED_TIMECODE</c> (default) - Preserves timecodes from the input transport
        /// stream. The timecodes must be embedded in the video stream as SEI timing messages.
        /// If no embedded timecode is detected, MediaConnect uses the UTC system time instead.
        /// </para>
        ///  </li> <li> 
        /// <para>
