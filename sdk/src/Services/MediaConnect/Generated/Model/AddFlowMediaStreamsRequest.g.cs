...
{
    /// <summary>
    /// Container for the parameters to the AddFlowMediaStreams operation. Adds media streams
    /// to an existing flow. After you add a media stream to a flow, you can associate it
