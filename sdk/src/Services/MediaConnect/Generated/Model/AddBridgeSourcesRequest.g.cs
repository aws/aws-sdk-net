...
{
    /// <summary>
    /// Container for the parameters to the AddBridgeSources operation. Adds sources to an
    /// existing bridge.
    /// </summary>
    public partial class AddBridgeSourcesRequest : AmazonMediaConnectRequest
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<AddBridgeSourceRequest> Sources { get; set; } = AWSConfigs.InitializeCollections ? new List<AddBridgeSourceRequest>() : null;
