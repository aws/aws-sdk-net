...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class VpcInterfaceRequest
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public Dictionary<string, string> VpcInterfaceTags { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the VpcInterfaceTags property is set.
        /// </summary>
        internal bool IsSetVpcInterfaceTags() => this.VpcInterfaceTags != null && (this.VpcInterfaceTags.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
