...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class AddOutputRequest
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public Dictionary<string, string> OutputTags { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the OutputTags property is set.
        /// </summary>
        internal bool IsSetOutputTags() => this.OutputTags != null && (this.OutputTags.Count > 0 || !AWSConfigs.InitializeCollections);
