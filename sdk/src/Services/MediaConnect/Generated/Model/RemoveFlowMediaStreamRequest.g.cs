...
{
    /// <summary>
    /// Container for the parameters to the RemoveFlowMediaStream operation. Removes a media
    /// stream from a flow. This action is only available if the media stream is not associated
    /// with a source or output.
    /// </summary>
