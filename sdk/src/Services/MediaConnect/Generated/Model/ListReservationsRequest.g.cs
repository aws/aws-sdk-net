...
{
    /// <summary>
    /// Container for the parameters to the ListReservations operation. Displays a list of
    /// all reservations that have been purchased by this account in the current Amazon Web
    /// Services Region. This list includes all reservations in all states (such as active
    /// and expired).
    /// </summary>
    public partial class ListReservationsRequest : AmazonMediaConnectRequest
    {
        /// <summary>
