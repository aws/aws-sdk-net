...
namespace Amazon.MediaConnect.Model
{
    ...
    {
        private FabricLatencyMode _recoveryLatencyMode;
        ...
        public FabricLatencyMode RecoveryLatencyMode
        {
            get { return this._recoveryLatencyMode; }
            set { this._recoveryLatencyMode = value; }
        }

        // Check to see if RecoveryLatencyMode property is set
        internal bool IsSetRecoveryLatencyMode()
        {
            return this._recoveryLatencyMode != null;
        }
