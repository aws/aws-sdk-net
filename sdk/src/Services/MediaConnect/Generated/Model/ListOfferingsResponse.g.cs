...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class ListOfferingsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Offering> Offerings { get; set; } = AWSConfigs.InitializeCollections ? new List<Offering>() : null;

        /// <summary>
        /// Checks to see if the Offerings property is set.
        /// </summary>
        internal bool IsSetOfferings() => this.Offerings != null && (this.Offerings.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
