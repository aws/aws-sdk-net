...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class ListFlowsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ListedFlow> Flows { get; set; } = AWSConfigs.InitializeCollections ? new List<ListedFlow>() : null;

        /// <summary>
        /// Checks to see if the Flows property is set.
        /// </summary>
        internal bool IsSetFlows() => this.Flows != null && (this.Flows.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        ///  
        /// <para>
        /// For example, you submit a <c>ListFlows</c> request with MaxResults set at 5. The service
