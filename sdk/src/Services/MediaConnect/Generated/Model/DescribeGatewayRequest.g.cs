...
{
    /// <summary>
    /// Container for the parameters to the DescribeGateway operation. Displays the details
    /// of a gateway. The response includes the gateway Amazon Resource Name (ARN), name,
