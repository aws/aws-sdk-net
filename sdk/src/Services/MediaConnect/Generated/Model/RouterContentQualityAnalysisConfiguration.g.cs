...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class RouterContentQualityAnalysisConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public ContentQualityAnalysisFeatureConfiguration ContentLevel { get; set; }

        /// <summary>
        /// Checks to see if the ContentLevel property is set.
        /// </summary>
        internal bool IsSetContentLevel() => this.ContentLevel != null;
    }
}
