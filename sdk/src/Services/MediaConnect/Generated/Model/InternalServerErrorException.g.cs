...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class InternalServerErrorException : AmazonMediaConnectException
    {
        ...
        /// Construct instance of InternalServerErrorException
        /// </summary>
        public InternalServerErrorException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InternalServerErrorException
        /// </summary>
        public InternalServerErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InternalServerErrorException
        /// </summary>
        public InternalServerErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
