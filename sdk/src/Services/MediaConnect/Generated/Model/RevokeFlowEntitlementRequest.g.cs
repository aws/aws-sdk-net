...
{
    /// <summary>
    /// Container for the parameters to the RevokeFlowEntitlement operation. Revokes an entitlement
    /// from a flow. Once an entitlement is revoked, the content becomes unavailable to the
