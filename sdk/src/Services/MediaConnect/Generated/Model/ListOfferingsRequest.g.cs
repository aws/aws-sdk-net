...
{
    /// <summary>
    /// Container for the parameters to the ListOfferings operation. Displays a list of all
    /// offerings that are available to this account in the current Amazon Web Services Region.
    /// If you have an active reservation (which means you've purchased an offering that has
