...
{
    /// <summary>
    /// Container for the parameters to the ListBridges operation. Displays a list of bridges
    /// that are associated with this account and an optionally specified Amazon Resource
    /// Name (ARN). This request returns a paginated result.
    /// </summary>
