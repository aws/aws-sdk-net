...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class BatchGetRouterInputResponse : AmazonWebServiceResponse
    {
        ...
        public List<BatchGetRouterInputError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchGetRouterInputError>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<RouterInput> RouterInputs { get; set; } = AWSConfigs.InitializeCollections ? new List<RouterInput>() : null;
