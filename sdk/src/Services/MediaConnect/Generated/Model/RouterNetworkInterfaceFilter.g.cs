...
namespace Amazon.MediaConnect.Model
{
    ...
    public partial class RouterNetworkInterfaceFilter
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> NetworkInterfaceTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the NetworkInterfaceTypes property is set.
        /// </summary>
        internal bool IsSetNetworkInterfaceTypes() => this.NetworkInterfaceTypes != null && (this.NetworkInterfaceTypes.Count > 0 || !AWSConfigs.InitializeCollections);
