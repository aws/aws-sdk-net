...
namespace Amazon.MediaConnect
{
    ...
    public partial class AmazonMediaConnectConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("MediaConnect", "4.0.101.3");
        ...
        /// </summary>
        public static new string ServiceId => "MediaConnect";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "mediaconnect";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2018-11-14";
