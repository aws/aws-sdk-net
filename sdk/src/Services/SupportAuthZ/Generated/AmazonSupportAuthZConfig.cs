...
namespace Amazon.SupportAuthZ
{
    ...
    public partial class AmazonSupportAuthZConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SupportAuthZ", "4.0.100.10");
        ...
        /// Default constructor
        /// </summary>
        public AmazonSupportAuthZConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonSupportAuthZDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "SupportAuthZ";
            this.AuthenticationServiceName = "supportauthz";
            this.EndpointProvider = new AmazonSupportAuthZEndpointProvider();
        }
