...
namespace Amazon.SupportAuthZ.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationException : AmazonSupportAuthZException
    {
        ...
        /// <para>
        /// A list of fields that fail validation. Each entry identifies the field and the reason
