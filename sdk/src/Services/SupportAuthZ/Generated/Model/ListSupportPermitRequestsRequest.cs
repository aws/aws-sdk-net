...
{
    /// <summary>
    /// Container for the parameters to the ListSupportPermitRequests operation.
    /// Lists permit requests from AWS support operators. Use pagination to ensure that the
    /// operation returns quickly and successfully.
    /// </summary>
    public partial class ListSupportPermitRequestsRequest : AmazonSupportAuthZRequest
    {
