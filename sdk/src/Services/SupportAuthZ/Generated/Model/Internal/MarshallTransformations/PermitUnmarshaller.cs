...
{
    /// <summary>
    /// Response Unmarshaller for Permit Object
    /// </summary>  
    public class PermitUnmarshaller : IJsonUnmarshaller<Permit, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Permit Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Permit unmarshalledObject = new Permit();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ActionSetUnmarshaller.Instance;
        ...
        private static PermitUnmarshaller _instance = new PermitUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PermitUnmarshaller Instance
        {
            get
            {
                return _instance;
