...
{
    /// <summary>
    /// DeleteSupportPermit Request Marshaller
    /// </summary>       
    public class DeleteSupportPermitRequestMarshaller : IMarshaller<IRequest, DeleteSupportPermitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSupportPermitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSupportPermitRequest publicRequest)
        {
        ...
        private static DeleteSupportPermitRequestMarshaller _instance = new DeleteSupportPermitRequestMarshaller();        

        internal static DeleteSupportPermitRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSupportPermitRequestMarshaller Instance
        {
            get
            {
                return _instance;
