    ...
    public class ResourceSetMarshaller : IRequestMarshaller<ResourceSet, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ResourceSet requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAllResourcesInRegion())
            {
                context.Writer.WritePropertyName("allResourcesInRegion");
                context.Writer.WriteStartObject();

                var marshaller = UnitMarshaller.Instance;
                marshaller.Marshall(requestObject.AllResourcesInRegion, context);
