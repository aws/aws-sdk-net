...
{
    /// <summary>
    /// ActionSet Marshaller
    /// </summary>
    public class ActionSetMarshaller : IRequestMarshaller<ActionSet, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ActionSet requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAllActions())
            {
                context.Writer.WritePropertyName("allActions");
                context.Writer.WriteStartObject();

                var marshaller = UnitMarshaller.Instance;
                marshaller.Marshall(requestObject.AllActions, context);
        ...
        /// </summary>
        public readonly static ActionSetMarshaller Instance = new ActionSetMarshaller();
