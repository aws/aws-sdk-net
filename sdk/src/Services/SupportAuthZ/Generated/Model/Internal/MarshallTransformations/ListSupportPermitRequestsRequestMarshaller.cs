...
namespace Amazon.SupportAuthZ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListSupportPermitRequestsRequestMarshaller : IMarshaller<IRequest, ListSupportPermitRequestsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListSupportPermitRequestsRequestMarshaller _instance = new ListSupportPermitRequestsRequestMarshaller();        

        internal static ListSupportPermitRequestsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSupportPermitRequestsRequestMarshaller Instance
        {
            get
            {
                return _instance;
