...
namespace Amazon.SupportAuthZ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSupportPermitRequestMarshaller : IMarshaller<IRequest, GetSupportPermitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSupportPermitRequestMarshaller _instance = new GetSupportPermitRequestMarshaller();        

        internal static GetSupportPermitRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSupportPermitRequestMarshaller Instance
        {
            get
            {
                return _instance;
