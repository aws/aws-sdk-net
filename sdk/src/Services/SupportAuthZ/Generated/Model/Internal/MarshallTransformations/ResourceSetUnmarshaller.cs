...
namespace Amazon.SupportAuthZ.Model.Internal.MarshallTransformations
{
    ...
    public class ResourceSetUnmarshaller : IJsonUnmarshaller<ResourceSet, JsonUnmarshallerContext>
    {
        ...
        public ResourceSet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("allResourcesInRegion", targetDepth, ref reader))
                {
                    var unmarshaller = UnitUnmarshaller.Instance;
                    unmarshalledObject.AllResourcesInRegion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
