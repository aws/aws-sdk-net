...
namespace Amazon.SupportAuthZ.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonSupportAuthZAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSupportAuthZAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SupportAuthZ.
        /// </summary>
        public AmazonSupportAuthZAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSupportAuthZAuthSchemeParameters
            {
    ...
    public class AmazonSupportAuthZAuthSchemeResolver : IAuthSchemeResolver<AmazonSupportAuthZAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSupportAuthZAuthSchemeParameters authParameters)
        {
