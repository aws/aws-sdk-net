...
namespace Amazon.SupportAuthZ
{
    ...
    public partial class AmazonSupportAuthZClient : AmazonServiceClient, IAmazonSupportAuthZ
    {
        ...
        internal virtual CreateSupportPermitResponse CreateSupportPermit(CreateSupportPermitRequest request)
        {
        ...
        internal virtual DeleteSupportPermitResponse DeleteSupportPermit(DeleteSupportPermitRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetSupportPermitResponse GetSupportPermit(GetSupportPermitRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListSupportPermitRequestsResponse ListSupportPermitRequests(ListSupportPermitRequestsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListSupportPermitsResponse ListSupportPermits(ListSupportPermitsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual RejectSupportPermitRequestResponse RejectSupportPermitRequest(RejectSupportPermitRequestRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
