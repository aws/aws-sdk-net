...
{
    /// <summary>
    /// StartQueryWorkloadInsightsTopContributorsData Request Marshaller
    /// </summary>       
    public class StartQueryWorkloadInsightsTopContributorsDataRequestMarshaller : IMarshaller<IRequest, StartQueryWorkloadInsightsTopContributorsDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartQueryWorkloadInsightsTopContributorsDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartQueryWorkloadInsightsTopContributorsDataRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workloadInsights/{scopeId}/topContributorsDataQueries";
#if !NETFRAMEWORK
        ...
        private static StartQueryWorkloadInsightsTopContributorsDataRequestMarshaller _instance = new StartQueryWorkloadInsightsTopContributorsDataRequestMarshaller();        

        internal static StartQueryWorkloadInsightsTopContributorsDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQueryWorkloadInsightsTopContributorsDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
