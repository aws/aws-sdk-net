...
namespace Amazon.NetworkFlowMonitor.Internal
{
    ...
    public class AmazonNetworkFlowMonitorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNetworkFlowMonitorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for NetworkFlowMonitor.
        /// </summary>
        public AmazonNetworkFlowMonitorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNetworkFlowMonitorAuthSchemeParameters
            {
    ...
    public class AmazonNetworkFlowMonitorAuthSchemeResolver : IAuthSchemeResolver<AmazonNetworkFlowMonitorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNetworkFlowMonitorAuthSchemeParameters authParameters)
        {
