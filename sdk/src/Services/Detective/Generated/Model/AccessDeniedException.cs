...
namespace Amazon.Detective.Model
{
    ...
    public partial class AccessDeniedException : AmazonDetectiveException
    {
            ...
            : base(info, context)
        {
            ...
            this.SubErrorCode = (ErrorCode)info.GetValue("SubErrorCode", typeof(ErrorCode));
            this.SubErrorCodeReason = (string)info.GetValue("SubErrorCodeReason", typeof(string));
        }
        ...
        /// <summary>
        /// Gets and sets the property SubErrorCode. 
        /// <para>
        ...
        {
            get { return this._subErrorCode; }
            set { this._subErrorCode = value; }
        }

        // Check to see if SubErrorCode property is set
        internal bool IsSetSubErrorCode()
        {
            return this._subErrorCode != null;
        }

        /// <summary>
        /// Gets and sets the property SubErrorCodeReason. 
        /// <para>
        ...
        {
            get { return this._subErrorCodeReason; }
            set { this._subErrorCodeReason = value; }
        }

        // Check to see if SubErrorCodeReason property is set
        internal bool IsSetSubErrorCodeReason()
        {
            return this._subErrorCodeReason != null;
        }
