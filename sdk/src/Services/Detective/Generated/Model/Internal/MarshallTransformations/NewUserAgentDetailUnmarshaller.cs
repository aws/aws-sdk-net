...
namespace Amazon.Detective.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NewUserAgentDetailUnmarshaller : IJsonUnmarshaller<NewUserAgentDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NewUserAgentDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
