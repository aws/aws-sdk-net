...
namespace Amazon.Detective.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdministratorUnmarshaller : IJsonUnmarshaller<Administrator, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Administrator Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DelegationTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.DelegationTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
