...
{
    /// <summary>
    /// Response Unmarshaller for GetInvestigation operation
    /// </summary>  
    public class GetInvestigationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInvestigationResponse response = new GetInvestigationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EntityArn", targetDepth, ref reader))
                {
                    ...
                    response.EntityArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ScopeEndTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.ScopeEndTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ScopeStartTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.ScopeStartTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetInvestigationResponseUnmarshaller _instance = new GetInvestigationResponseUnmarshaller();        

        internal static GetInvestigationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInvestigationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
