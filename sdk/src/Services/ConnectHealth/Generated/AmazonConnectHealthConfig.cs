...
namespace Amazon.ConnectHealth
{
    ...
    public partial class AmazonConnectHealthConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("ConnectHealth", "4.0.100.11");
        ...
        /// Default constructor
        /// </summary>
        public AmazonConnectHealthConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonConnectHealthDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "ConnectHealth";
            this.AuthenticationServiceName = "health-agent";
            this.EndpointProvider = new AmazonConnectHealthEndpointProvider();
        }
