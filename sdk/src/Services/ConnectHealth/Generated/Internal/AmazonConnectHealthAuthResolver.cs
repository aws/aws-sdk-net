...
namespace Amazon.ConnectHealth.Internal
{
    ...
    public class AmazonConnectHealthAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonConnectHealthAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ConnectHealth.
        /// </summary>
        public AmazonConnectHealthAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonConnectHealthAuthSchemeParameters
            {
    ...
    public class AmazonConnectHealthAuthSchemeResolver : IAuthSchemeResolver<AmazonConnectHealthAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonConnectHealthAuthSchemeParameters authParameters)
        {
