...
{
    /// <summary>
    /// Container for the parameters to the GetMedicalScribeListeningSession operation.
    /// Retrieves details about an existing Medical Scribe listening session
    /// </summary>
    public partial class GetMedicalScribeListeningSessionRequest : AmazonConnectHealthRequest
    {
