...
namespace Amazon.ConnectHealth.Model
{
    ...
    public partial class SubscriptionDescription
    {
        ...
        /// <summary>
        /// Gets and sets the property DeactivatedAt.
        /// </summary>
        public DateTime? DeactivatedAt
        {
            get { return this._deactivatedAt; }
            set { this._deactivatedAt = value; }
        }

        // Check to see if DeactivatedAt property is set
        internal bool IsSetDeactivatedAt()
        {
            return this._deactivatedAt.HasValue; 
        }
