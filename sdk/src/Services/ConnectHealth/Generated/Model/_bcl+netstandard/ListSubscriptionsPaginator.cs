...
namespace Amazon.ConnectHealth.Model
{
    ...
    internal sealed partial class ListSubscriptionsPaginator : IPaginator<ListSubscriptionsResponse>, IListSubscriptionsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<SubscriptionDescription> Subscriptions => 
            new PaginatedResultKeyResponse<ListSubscriptionsResponse, SubscriptionDescription>(this, (i) => i.Subscriptions ?? new List<SubscriptionDescription>());

        internal ListSubscriptionsPaginator(IAmazonConnectHealth client, ListSubscriptionsRequest request)
        {
            this._client = client;
