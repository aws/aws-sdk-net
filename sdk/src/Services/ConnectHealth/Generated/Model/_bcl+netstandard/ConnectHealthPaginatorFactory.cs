...
namespace Amazon.ConnectHealth.Model
{
    ...
    ///</summary>
    public class ConnectHealthPaginatorFactory : IConnectHealthPaginatorFactory
    {
        private readonly IAmazonConnectHealth client;

        internal ConnectHealthPaginatorFactory(IAmazonConnectHealth client) 
        {
            this.client = client;
        }
