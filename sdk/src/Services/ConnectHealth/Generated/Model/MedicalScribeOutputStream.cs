...
namespace Amazon.ConnectHealth.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "MedicalScribeOutputStreamCollection is not descriptive")]
    ...
    public sealed class MedicalScribeOutputStream : EnumerableEventOutputStream<IEventStreamEvent, ConnectHealthEventStreamException>
    {
        /// <summary>
            ...
            {"TranscriptEvent", payload => 
                {
                    ...
                    return new MedicalScribeTranscriptEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
        };
        /// <summary>
        ...
        /// </summary>
        protected override IDictionary<string,Func<IEventStreamMessage,ConnectHealthEventStreamException>> ExceptionMapping {get;} =
        new Dictionary<string,Func<IEventStreamMessage,ConnectHealthEventStreamException>>(StringComparer.OrdinalIgnoreCase)
        {
                    {"InternalFailureException", payload => 
                        {
                            var context = EventStreamUtils.ConvertMessageToJsonContext(payload);
                            var reader = new StreamingUtf8JsonReader(context.Stream);
                            return new ConnectHealthEventStreamException(Encoding.UTF8.GetString(payload.Payload), new InternalServerExceptionUnmarshaller().Unmarshall(context, ref reader));
                        }
                    },
                    {"ValidationException", payload => 
                        {
                            var context = EventStreamUtils.ConvertMessageToJsonContext(payload);
                            var reader = new StreamingUtf8JsonReader(context.Stream);
                            return new ConnectHealthEventStreamException(Encoding.UTF8.GetString(payload.Payload), new ValidationExceptionUnmarshaller().Unmarshall(context, ref reader));
                        }
                    },
        };
        ...
        /// </summary>
        public override event EventHandler<EventStreamExceptionReceivedArgs<ConnectHealthEventStreamException>> ExceptionReceived;
        /// <summary>
        ...
        ///<summary>
        ///Raised when an TranscriptEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<MedicalScribeTranscriptEvent>> TranscriptEventReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public MedicalScribeOutputStream(Stream stream) : this (stream, null)
        {
        }
        ...
        public MedicalScribeOutputStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
            ...
            Decoder.MessageReceived += (sender, args) =>
            {
                ...
                var _ =
                    ...
                    RaiseEvent(TranscriptEventReceived,ev);
            };       
        }
