...
namespace Amazon.ConnectHealth.Model
{
    ...
    public partial class CreateWebAppConfiguration
    {
        ...
        public string IdcInstanceId
        {
            get { return this._idcInstanceId; }
            set { this._idcInstanceId = value; }
        }

        // Check to see if IdcInstanceId property is set
        internal bool IsSetIdcInstanceId()
        {
            return this._idcInstanceId != null;
        }
