...
{
    /// <summary>
    /// DeactivateSubscription Request Marshaller
    /// </summary>       
    public class DeactivateSubscriptionRequestMarshaller : IMarshaller<IRequest, DeactivateSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeactivateSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeactivateSubscriptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/domains/{domainId}/subscriptions/{subscriptionId}/deactivate";

            return request;
        }
        private static DeactivateSubscriptionRequestMarshaller _instance = new DeactivateSubscriptionRequestMarshaller();        

        internal static DeactivateSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
