...
namespace Amazon.ConnectHealth.Model.Internal.MarshallTransformations
{
    ...
    public class CreateDomainRequestMarshaller : IMarshaller<IRequest, CreateDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateDomainRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetWebAppSetupConfiguration())
            {
                context.Writer.WritePropertyName("webAppSetupConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = CreateWebAppConfigurationMarshaller.Instance;
                marshaller.Marshall(publicRequest.WebAppSetupConfiguration, context);
