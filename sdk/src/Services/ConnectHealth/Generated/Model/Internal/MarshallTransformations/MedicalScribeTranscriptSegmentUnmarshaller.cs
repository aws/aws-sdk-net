...
namespace Amazon.ConnectHealth.Model.Internal.MarshallTransformations
{
    ...
    public class MedicalScribeTranscriptSegmentUnmarshaller : IJsonUnmarshaller<MedicalScribeTranscriptSegment, JsonUnmarshallerContext>
    {
        ...
        public MedicalScribeTranscriptSegment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("audioBeginOffset", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.AudioBeginOffset = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("audioEndOffset", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.AudioEndOffset = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
