...
namespace Amazon.ConnectHealth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetPatientInsightsJobRequestMarshaller : IMarshaller<IRequest, GetPatientInsightsJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetPatientInsightsJobRequestMarshaller _instance = new GetPatientInsightsJobRequestMarshaller();        

        internal static GetPatientInsightsJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPatientInsightsJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
