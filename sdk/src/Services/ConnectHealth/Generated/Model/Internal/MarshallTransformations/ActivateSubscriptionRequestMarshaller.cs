...
{
    /// <summary>
    /// ActivateSubscription Request Marshaller
    /// </summary>       
    public class ActivateSubscriptionRequestMarshaller : IMarshaller<IRequest, ActivateSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ActivateSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ActivateSubscriptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/domains/{domainId}/subscriptions/{subscriptionId}/activate";

            return request;
        }
        private static ActivateSubscriptionRequestMarshaller _instance = new ActivateSubscriptionRequestMarshaller();        

        internal static ActivateSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivateSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
