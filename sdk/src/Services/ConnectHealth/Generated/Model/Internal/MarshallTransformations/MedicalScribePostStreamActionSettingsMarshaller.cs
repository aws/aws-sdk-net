...
{
    /// <summary>
    /// MedicalScribePostStreamActionSettings Marshaller
    /// </summary>
    public class MedicalScribePostStreamActionSettingsMarshaller : IRequestMarshaller<MedicalScribePostStreamActionSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(MedicalScribePostStreamActionSettings requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static MedicalScribePostStreamActionSettingsMarshaller Instance = new MedicalScribePostStreamActionSettingsMarshaller();
