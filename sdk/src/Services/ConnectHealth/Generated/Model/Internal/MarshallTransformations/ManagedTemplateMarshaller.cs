...
{
    /// <summary>
    /// ManagedTemplate Marshaller
    /// </summary>
    public class ManagedTemplateMarshaller : IRequestMarshaller<ManagedTemplate, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ManagedTemplate requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static ManagedTemplateMarshaller Instance = new ManagedTemplateMarshaller();
