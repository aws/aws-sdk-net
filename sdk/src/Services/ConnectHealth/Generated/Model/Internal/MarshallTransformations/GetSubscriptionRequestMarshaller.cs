...
namespace Amazon.ConnectHealth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSubscriptionRequestMarshaller : IMarshaller<IRequest, GetSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetSubscriptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/domains/{domainId}/subscriptions/{subscriptionId}";

            return request;
        }
        private static GetSubscriptionRequestMarshaller _instance = new GetSubscriptionRequestMarshaller();        

        internal static GetSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
