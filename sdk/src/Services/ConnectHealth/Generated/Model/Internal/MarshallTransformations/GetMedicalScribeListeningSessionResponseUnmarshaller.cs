...
{
    /// <summary>
    /// Response Unmarshaller for GetMedicalScribeListeningSession operation
    /// </summary>  
    public class GetMedicalScribeListeningSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMedicalScribeListeningSessionResponse response = new GetMedicalScribeListeningSessionResponse();
        ...
        private static GetMedicalScribeListeningSessionResponseUnmarshaller _instance = new GetMedicalScribeListeningSessionResponseUnmarshaller();        

        internal static GetMedicalScribeListeningSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMedicalScribeListeningSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
