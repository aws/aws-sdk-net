...
{
    /// <summary>
    /// GetDomain Request Marshaller
    /// </summary>       
    public class GetDomainRequestMarshaller : IMarshaller<IRequest, GetDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDomainRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDomainRequest publicRequest)
        {
            ...
            request.ResourcePath = "/domain/{domainId}";

            return request;
        }
        private static GetDomainRequestMarshaller _instance = new GetDomainRequestMarshaller();        

        internal static GetDomainRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
