    ...
    public class CreateDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = EncryptionContextUnmarshaller.Instance;
                    response.EncryptionContext = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("webAppConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = WebAppConfigurationUnmarshaller.Instance;
                    response.WebAppConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("webAppUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WebAppUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
