...
{
    /// <summary>
    /// Response Unmarshaller for NoteTemplateSettingsResponse Object
    /// </summary>  
    public class NoteTemplateSettingsResponseUnmarshaller : IJsonUnmarshaller<NoteTemplateSettingsResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NoteTemplateSettingsResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            NoteTemplateSettingsResponse unmarshalledObject = new NoteTemplateSettingsResponse();
        ...
        private static NoteTemplateSettingsResponseUnmarshaller _instance = new NoteTemplateSettingsResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NoteTemplateSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
