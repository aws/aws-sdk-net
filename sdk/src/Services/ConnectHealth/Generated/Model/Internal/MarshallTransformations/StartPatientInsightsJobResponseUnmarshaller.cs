...
{
    /// <summary>
    /// Response Unmarshaller for StartPatientInsightsJob operation
    /// </summary>  
    public class StartPatientInsightsJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartPatientInsightsJobResponse response = new StartPatientInsightsJobResponse();
        ...
        private static StartPatientInsightsJobResponseUnmarshaller _instance = new StartPatientInsightsJobResponseUnmarshaller();        

        internal static StartPatientInsightsJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPatientInsightsJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
