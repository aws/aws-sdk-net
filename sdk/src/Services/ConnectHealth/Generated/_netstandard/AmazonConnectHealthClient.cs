...
namespace Amazon.ConnectHealth
{
    ...
    /// It provides pre-built agents that automate patient engagement workflows and support
    /// clinical documentation at the point of care.
    /// 
    ///  
    /// <para>
    /// You can use the Amazon Connect Health API to programmatically manage domains, configure
    /// patient engagement agents, run patient insights jobs, and stream ambient documentation
    /// sessions. This API reference describes the available API operations and data types
    /// for Amazon Connect Health.
    /// </para>
    ///  
    /// <para>
    /// We recommend that you use the AWS SDKs to make programmatic API calls to Amazon Connect
    /// Health.
    /// </para>
    /// </summary>
    public partial class AmazonConnectHealthClient : AmazonServiceClient, IAmazonConnectHealth
    {
        ...
        internal virtual ActivateSubscriptionResponse ActivateSubscription(ActivateSubscriptionRequest request)
        {
        ...
        internal virtual DeactivateSubscriptionResponse DeactivateSubscription(DeactivateSubscriptionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetMedicalScribeListeningSessionResponse GetMedicalScribeListeningSession(GetMedicalScribeListeningSessionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetPatientInsightsJobResponse GetPatientInsightsJob(GetPatientInsightsJobRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual StartMedicalScribeListeningSessionResponse StartMedicalScribeListeningSession(StartMedicalScribeListeningSessionRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = StartMedicalScribeListeningSessionRequestMarshaller.Instance;
            options.ResponseUnmarshaller = StartMedicalScribeListeningSessionResponseUnmarshaller.Instance;

            return Invoke<StartMedicalScribeListeningSessionResponse>(request, options);
        }
        ...
        public virtual Task<StartMedicalScribeListeningSessionResponse> StartMedicalScribeListeningSessionAsync(StartMedicalScribeListeningSessionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = StartMedicalScribeListeningSessionRequestMarshaller.Instance;
            options.ResponseUnmarshaller = StartMedicalScribeListeningSessionResponseUnmarshaller.Instance;

            return InvokeAsync<StartMedicalScribeListeningSessionResponse>(request, options, cancellationToken);
        }
#endif
        #endregion
        ...
        internal virtual StartPatientInsightsJobResponse StartPatientInsightsJob(StartPatientInsightsJobRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
