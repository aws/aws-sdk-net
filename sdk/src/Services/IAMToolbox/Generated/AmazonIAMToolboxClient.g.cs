...
namespace Amazon.IAMToolbox
{
    ...
    public partial class AmazonIAMToolboxClient : AmazonServiceClient, IAmazonIAMToolbox
    {
        ...
        /// 
        /// </summary>
        public AmazonIAMToolboxClient() : base(new AmazonIAMToolboxConfig()) { }
        ...
        public AmazonIAMToolboxClient(RegionEndpoint region) : base(new AmazonIAMToolboxConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIAMToolboxClient(AmazonIAMToolboxConfig config) : base(config) { }
...
#else
        internal virtual GetRequestAuthorizationDetailsResponse GetRequestAuthorizationDetails(GetRequestAuthorizationDetailsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = GetRequestAuthorizationDetailsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetRequestAuthorizationDetailsResponseUnmarshaller.Instance;
