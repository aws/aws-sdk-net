...
namespace Amazon.IAMToolbox.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IAMToolbox service requests.
    /// Collects values for IAMToolboxEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IAMToolboxEndpointProvider.
