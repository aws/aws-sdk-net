...
namespace Amazon.IAMToolbox.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRequestAuthorizationDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRequestAuthorizationDetailsResponse response = new GetRequestAuthorizationDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("evaluations", targetDepth, ref reader))
                {
                    ...
                    response.Evaluations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("requestContext", targetDepth, ref reader))
                {
                    ...
                    response.RequestContext = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetRequestAuthorizationDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRequestAuthorizationDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
