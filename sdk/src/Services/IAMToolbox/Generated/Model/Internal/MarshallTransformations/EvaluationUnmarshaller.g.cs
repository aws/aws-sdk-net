...
namespace Amazon.IAMToolbox.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EvaluationUnmarshaller : IJsonUnmarshaller<Evaluation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Evaluation();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("matchedPolicies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MatchedPolicy, MatchedPolicyUnmarshaller>(MatchedPolicyUnmarshaller.Instance);
                    unmarshalledObject.MatchedPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static EvaluationUnmarshaller Instance => _instance;
    }
}
