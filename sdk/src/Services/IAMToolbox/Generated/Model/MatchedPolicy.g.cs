...
namespace Amazon.IAMToolbox.Model
{
    ...
    public partial class MatchedPolicy
    {
        ...
        /// </summary>
        public List<MatchedStatement> MatchedStatements { get; set; } = AWSConfigs.InitializeCollections ? new List<MatchedStatement>() : null;

        /// <summary>
        /// Checks to see if the MatchedStatements property is set.
        /// </summary>
        internal bool IsSetMatchedStatements() => this.MatchedStatements != null && (this.MatchedStatements.Count > 0 || !AWSConfigs.InitializeCollections);
