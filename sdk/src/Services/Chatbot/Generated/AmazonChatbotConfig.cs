...
namespace Amazon.Chatbot
{
    ...
    public partial class AmazonChatbotConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("chatbot", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "chatbot";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "chatbot";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2017-10-11";
