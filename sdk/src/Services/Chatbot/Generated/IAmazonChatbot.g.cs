...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonChatbotConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonChatbotConfig();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonChatbotConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonChatbotConfig to create AmazonChatbotClient");
            }

            return awsCredentials == null ?
                    new AmazonChatbotClient(serviceClientConfig) :
                    new AmazonChatbotClient(awsCredentials, serviceClientConfig);
        }
