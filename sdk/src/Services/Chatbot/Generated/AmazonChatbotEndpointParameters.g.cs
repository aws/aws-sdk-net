...
namespace Amazon.Chatbot.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving Chatbot endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonChatbotEndpointProvider"/> and <see cref="AmazonChatbotEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class ChatbotEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// ChatbotEndpointParameters constructor
        /// </summary>
        public ChatbotEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
