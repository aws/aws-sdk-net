...
{
    /// <summary>
    /// Container for the parameters to the UntagResource operation. Detaches a key-value
    /// pair from a resource, as identified by its Amazon Resource Name (ARN). Resources are
    /// users, servers, roles, and other entities.
    /// </summary>
