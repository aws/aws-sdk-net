...
namespace Amazon.Chatbot.Model
{
    ...
    public partial class ListCustomActionsResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> CustomActions { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the CustomActions property is set.
        /// </summary>
        internal bool IsSetCustomActions() => this.CustomActions != null && (this.CustomActions.Count > 0 || !AWSConfigs.InitializeCollections);
