...
{
    /// <summary>
    /// Container for the parameters to the DisassociateFromConfiguration operation. Unlink
    /// a resource, for example a custom action, from a channel configuration.
    /// </summary>
    public partial class DisassociateFromConfigurationRequest : AmazonChatbotRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ChatConfiguration property is set.
        /// </summary>
        internal bool IsSetChatConfiguration() => this.ChatConfiguration != null;
