...
namespace Amazon.Chatbot.Model
{
    ...
    public partial class ListMicrosoftTeamsChannelConfigurationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<TeamsChannelConfiguration> TeamChannelConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<TeamsChannelConfiguration>() : null;

        /// <summary>
        /// Checks to see if the TeamChannelConfigurations property is set.
        /// </summary>
        internal bool IsSetTeamChannelConfigurations() => this.TeamChannelConfigurations != null && (this.TeamChannelConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
