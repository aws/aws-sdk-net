...
namespace Amazon.Chatbot.Model
{
    ...
    internal sealed partial class ListMicrosoftTeamsUserIdentitiesPaginator : IPaginator<ListMicrosoftTeamsUserIdentitiesResponse>, IListMicrosoftTeamsUserIdentitiesPaginator
    {
        ...
        async IAsyncEnumerable<ListMicrosoftTeamsUserIdentitiesResponse> IPaginator<ListMicrosoftTeamsUserIdentitiesResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
