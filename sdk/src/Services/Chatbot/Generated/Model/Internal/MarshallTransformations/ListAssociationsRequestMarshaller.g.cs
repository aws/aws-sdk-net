...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAssociationsRequestMarshaller : IMarshaller<IRequest, ListAssociationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListAssociationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/list-associations";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetChatConfiguration())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ChatConfiguration);
            }
        ...
        private static readonly ListAssociationsRequestMarshaller _instance = new();

        internal static ListAssociationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAssociationsRequestMarshaller Instance => _instance;
    }
}
