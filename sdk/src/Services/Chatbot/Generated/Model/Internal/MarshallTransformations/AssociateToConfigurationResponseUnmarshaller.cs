...
{
    /// <summary>
    /// Response Unmarshaller for AssociateToConfiguration operation
    /// </summary>  
    public class AssociateToConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateToConfigurationResponse response = new AssociateToConfigurationResponse();
        ...
        private static AssociateToConfigurationResponseUnmarshaller _instance = new AssociateToConfigurationResponseUnmarshaller();        

        internal static AssociateToConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateToConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
