...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateSlackChannelConfigurationRequestMarshaller : IMarshaller<IRequest, CreateSlackChannelConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateSlackChannelConfigurationRequestMarshaller _instance = new();

        internal static CreateSlackChannelConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSlackChannelConfigurationRequestMarshaller Instance => _instance;
    }
}
