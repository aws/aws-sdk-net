...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetCustomActionRequestMarshaller : IMarshaller<IRequest, GetCustomActionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetCustomActionRequestMarshaller _instance = new();

        internal static GetCustomActionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetCustomActionRequestMarshaller Instance => _instance;
    }
}
