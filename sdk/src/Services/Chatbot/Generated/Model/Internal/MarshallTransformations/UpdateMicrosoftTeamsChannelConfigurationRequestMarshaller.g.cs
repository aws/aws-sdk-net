...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateMicrosoftTeamsChannelConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateMicrosoftTeamsChannelConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateMicrosoftTeamsChannelConfigurationRequestMarshaller _instance = new();

        internal static UpdateMicrosoftTeamsChannelConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateMicrosoftTeamsChannelConfigurationRequestMarshaller Instance => _instance;
    }
}
