...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SlackWorkspaceUnmarshaller : IJsonUnmarshaller<SlackWorkspace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SlackWorkspace();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SlackWorkspaceUnmarshaller Instance => _instance;
    }
}
