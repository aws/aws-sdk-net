...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAccountPreferencesRequestMarshaller : IMarshaller<IRequest, UpdateAccountPreferencesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateAccountPreferencesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetTrainingDataCollectionEnabled())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.TrainingDataCollectionEnabled.Value);
            }
        ...
        private static readonly UpdateAccountPreferencesRequestMarshaller _instance = new();

        internal static UpdateAccountPreferencesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAccountPreferencesRequestMarshaller Instance => _instance;
    }
}
