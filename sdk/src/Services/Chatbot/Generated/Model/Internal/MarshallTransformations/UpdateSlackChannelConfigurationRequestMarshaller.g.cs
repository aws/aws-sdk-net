...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateSlackChannelConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateSlackChannelConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateSlackChannelConfigurationRequestMarshaller _instance = new();

        internal static UpdateSlackChannelConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSlackChannelConfigurationRequestMarshaller Instance => _instance;
    }
}
