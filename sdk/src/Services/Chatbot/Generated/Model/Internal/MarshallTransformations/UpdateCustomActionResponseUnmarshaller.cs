...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCustomAction operation
    /// </summary>  
    public class UpdateCustomActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCustomActionResponse response = new UpdateCustomActionResponse();
            ...
            {
                if (context.TestExpression("CustomActionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CustomActionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateCustomActionResponseUnmarshaller _instance = new UpdateCustomActionResponseUnmarshaller();        

        internal static UpdateCustomActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCustomActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
