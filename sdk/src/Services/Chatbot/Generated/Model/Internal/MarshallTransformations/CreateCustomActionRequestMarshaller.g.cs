...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateCustomActionRequestMarshaller : IMarshaller<IRequest, CreateCustomActionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateCustomActionRequestMarshaller _instance = new();

        internal static CreateCustomActionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateCustomActionRequestMarshaller Instance => _instance;
    }
}
