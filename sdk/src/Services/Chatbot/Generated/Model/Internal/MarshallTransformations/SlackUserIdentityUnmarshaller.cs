...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SlackUserIdentityUnmarshaller : IUnmarshaller<SlackUserIdentity, XmlUnmarshallerContext>, IUnmarshaller<SlackUserIdentity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SlackUserIdentity IUnmarshaller<SlackUserIdentity, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SlackUserIdentity Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SlackUserId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
