...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomActions operation
    /// </summary>  
    public class ListCustomActionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomActionsResponse response = new ListCustomActionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CustomActions", targetDepth))
                {
                    ...
                    response.CustomActions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCustomActionsResponseUnmarshaller _instance = new ListCustomActionsResponseUnmarshaller();        

        internal static ListCustomActionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
