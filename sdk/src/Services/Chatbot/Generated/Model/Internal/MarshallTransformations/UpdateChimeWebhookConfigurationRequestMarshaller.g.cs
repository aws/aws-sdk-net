...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateChimeWebhookConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateChimeWebhookConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateChimeWebhookConfigurationRequestMarshaller _instance = new();

        internal static UpdateChimeWebhookConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateChimeWebhookConfigurationRequestMarshaller Instance => _instance;
    }
}
