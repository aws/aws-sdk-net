...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateChimeWebhookConfigurationRequestMarshaller : IMarshaller<IRequest, CreateChimeWebhookConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateChimeWebhookConfigurationRequestMarshaller _instance = new();

        internal static CreateChimeWebhookConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChimeWebhookConfigurationRequestMarshaller Instance => _instance;
    }
}
