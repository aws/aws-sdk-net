...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TeamsChannelConfigurationUnmarshaller : IJsonUnmarshaller<TeamsChannelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TeamsChannelConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TeamsChannelConfigurationUnmarshaller Instance => _instance;
    }
}
