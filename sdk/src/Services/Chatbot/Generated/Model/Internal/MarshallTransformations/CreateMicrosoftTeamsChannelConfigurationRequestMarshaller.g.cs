...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMicrosoftTeamsChannelConfigurationRequestMarshaller : IMarshaller<IRequest, CreateMicrosoftTeamsChannelConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateMicrosoftTeamsChannelConfigurationRequestMarshaller _instance = new();

        internal static CreateMicrosoftTeamsChannelConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMicrosoftTeamsChannelConfigurationRequestMarshaller Instance => _instance;
    }
}
