...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteSlackUserIdentityRequestMarshaller : IMarshaller<IRequest, DeleteSlackUserIdentityRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteSlackUserIdentityRequestMarshaller _instance = new();

        internal static DeleteSlackUserIdentityRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSlackUserIdentityRequestMarshaller Instance => _instance;
    }
}
