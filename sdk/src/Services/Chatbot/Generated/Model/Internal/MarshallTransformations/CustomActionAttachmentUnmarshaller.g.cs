...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomActionAttachmentUnmarshaller : IJsonUnmarshaller<CustomActionAttachment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomActionAttachment();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomActionAttachmentUnmarshaller Instance => _instance;
    }
}
