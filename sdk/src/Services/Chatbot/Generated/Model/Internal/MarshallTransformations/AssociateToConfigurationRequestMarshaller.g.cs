...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociateToConfigurationRequestMarshaller : IMarshaller<IRequest, AssociateToConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AssociateToConfigurationRequestMarshaller _instance = new();

        internal static AssociateToConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AssociateToConfigurationRequestMarshaller Instance => _instance;
    }
}
