...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChimeWebhookConfigurationsRequestMarshaller : IMarshaller<IRequest, DescribeChimeWebhookConfigurationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChimeWebhookConfigurationsRequestMarshaller _instance = new();

        internal static DescribeChimeWebhookConfigurationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChimeWebhookConfigurationsRequestMarshaller Instance => _instance;
    }
}
