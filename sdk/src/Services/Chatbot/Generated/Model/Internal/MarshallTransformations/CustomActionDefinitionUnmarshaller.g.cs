...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomActionDefinitionUnmarshaller : IJsonUnmarshaller<CustomActionDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomActionDefinition();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomActionDefinitionUnmarshaller Instance => _instance;
    }
}
