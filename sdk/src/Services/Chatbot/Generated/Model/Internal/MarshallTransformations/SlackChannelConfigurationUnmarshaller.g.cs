...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SlackChannelConfigurationUnmarshaller : IJsonUnmarshaller<SlackChannelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SlackChannelConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SlackChannelConfigurationUnmarshaller Instance => _instance;
    }
}
