...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMicrosoftTeamsConfiguredTeamsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListMicrosoftTeamsConfiguredTeamsResponse();
            ...
            {
                if (context.TestExpression("ConfiguredTeams", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ConfiguredTeam, ConfiguredTeamUnmarshaller>(ConfiguredTeamUnmarshaller.Instance);
                    unmarshalledObject.ConfiguredTeams = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListMicrosoftTeamsConfiguredTeamsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMicrosoftTeamsConfiguredTeamsResponseUnmarshaller Instance => _instance;
    }
}
