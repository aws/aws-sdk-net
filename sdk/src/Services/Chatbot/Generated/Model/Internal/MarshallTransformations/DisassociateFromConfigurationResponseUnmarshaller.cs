...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateFromConfiguration operation
    /// </summary>  
    public class DisassociateFromConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateFromConfigurationResponse response = new DisassociateFromConfigurationResponse();
        ...
        private static DisassociateFromConfigurationResponseUnmarshaller _instance = new DisassociateFromConfigurationResponseUnmarshaller();        

        internal static DisassociateFromConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateFromConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
