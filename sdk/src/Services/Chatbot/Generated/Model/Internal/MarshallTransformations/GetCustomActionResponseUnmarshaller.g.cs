...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetCustomActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetCustomActionResponse();
            ...
            {
                if (context.TestExpression("CustomAction", targetDepth, ref reader))
                {
                    var unmarshaller = CustomActionUnmarshaller.Instance;
                    unmarshalledObject.CustomAction = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetCustomActionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetCustomActionResponseUnmarshaller Instance => _instance;
    }
}
