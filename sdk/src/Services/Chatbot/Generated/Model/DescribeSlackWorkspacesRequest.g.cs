...
{
    /// <summary>
    /// Container for the parameters to the DescribeSlackWorkspaces operation. List all authorized
    /// Slack workspaces connected to the AWS Account onboarded with AWS Chatbot.
    /// </summary>
