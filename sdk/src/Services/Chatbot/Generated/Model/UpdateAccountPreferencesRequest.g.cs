...
{
    /// <summary>
    /// Container for the parameters to the UpdateAccountPreferences operation. Updates AWS
    /// Chatbot account preferences.
    /// </summary>
    public partial class UpdateAccountPreferencesRequest : AmazonChatbotRequest
    {
        ...
        /// <summary>
        /// Checks to see if the TrainingDataCollectionEnabled property is set.
        /// </summary>
        internal bool IsSetTrainingDataCollectionEnabled() => this.TrainingDataCollectionEnabled.HasValue;
