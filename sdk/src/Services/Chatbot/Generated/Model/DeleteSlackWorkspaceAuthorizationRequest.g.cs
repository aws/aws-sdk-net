...
{
    /// <summary>
    /// Container for the parameters to the DeleteSlackWorkspaceAuthorization operation. Deletes
    /// the Slack workspace authorization that allows channels to be configured in that workspace.
