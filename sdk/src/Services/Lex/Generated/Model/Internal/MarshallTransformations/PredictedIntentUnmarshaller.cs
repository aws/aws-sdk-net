...
namespace Amazon.Lex.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredictedIntentUnmarshaller : IJsonUnmarshaller<PredictedIntent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PredictedIntent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
