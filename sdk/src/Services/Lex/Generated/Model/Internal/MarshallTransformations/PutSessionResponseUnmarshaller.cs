...
namespace Amazon.Lex.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return NotAcceptableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        internal static PutSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
