...
namespace Amazon.Lex
{
    ...
    public partial interface IAmazonLex : IAmazonService, IDisposable
    {
        ...
        Task<PostContentResponse> PostContentAsync(PostContentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutSessionResponse> PutSessionAsync(PutSessionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonLexConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonLexConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonLexConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonLexConfig to create AmazonLexClient");
            }

            return awsCredentials == null ? 
                    new AmazonLexClient(serviceClientConfig) :
                    new AmazonLexClient(awsCredentials, serviceClientConfig);
        }
