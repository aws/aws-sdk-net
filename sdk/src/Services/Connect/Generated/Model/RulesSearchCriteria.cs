...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class RulesSearchCriteria
    {
        private List<RulesSearchCriteria> _andConditions = AWSConfigs.InitializeCollections ? new List<RulesSearchCriteria>() : null;
        private List<RulesSearchCriteria> _orConditions = AWSConfigs.InitializeCollections ? new List<RulesSearchCriteria>() : null;
        ...
        /// </summary>
        public List<RulesSearchCriteria> AndConditions
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<RulesSearchCriteria> OrConditions
        {
        ...
        ///  <note> 
        /// <para>
        /// The currently supported values for <c>FieldName</c> are <c>Name</c>, <c>PublishStatus</c>,
        /// <c>EventSourceName</c>, <c>RuleId</c>, <c>IntegrationAssociationId</c>, <c>ActionSummaries</c>,
        /// and <c>RuleCapabilityTiers</c>.
        /// </para>
        ///  </note>
        /// </summary>
