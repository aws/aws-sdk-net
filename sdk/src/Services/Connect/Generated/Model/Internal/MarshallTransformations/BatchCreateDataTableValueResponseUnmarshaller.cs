...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreateDataTableValue operation
    /// </summary>  
    public class BatchCreateDataTableValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreateDataTableValueResponse response = new BatchCreateDataTableValueResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchCreateDataTableValueFailureResult, BatchCreateDataTableValueFailureResultUnmarshaller>(BatchCreateDataTableValueFailureResultUnmarshaller.Instance);
                    response.Failed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Successful", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchCreateDataTableValueSuccessResult, BatchCreateDataTableValueSuccessResultUnmarshaller>(BatchCreateDataTableValueSuccessResultUnmarshaller.Instance);
        ...
        private static BatchCreateDataTableValueResponseUnmarshaller _instance = new BatchCreateDataTableValueResponseUnmarshaller();        

        internal static BatchCreateDataTableValueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateDataTableValueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
