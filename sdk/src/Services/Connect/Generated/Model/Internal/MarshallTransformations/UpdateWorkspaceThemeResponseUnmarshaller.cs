...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspaceTheme operation
    /// </summary>  
    public class UpdateWorkspaceThemeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkspaceThemeResponse response = new UpdateWorkspaceThemeResponse();
        ...
        private static UpdateWorkspaceThemeResponseUnmarshaller _instance = new UpdateWorkspaceThemeResponseUnmarshaller();        

        internal static UpdateWorkspaceThemeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspaceThemeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
