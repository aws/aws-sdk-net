...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataTableAttribute operation
    /// </summary>  
    public class CreateDataTableAttributeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataTableAttributeResponse response = new CreateDataTableAttributeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AttributeId", targetDepth))
                {
                    ...
                    response.AttributeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateDataTableAttributeResponseUnmarshaller _instance = new CreateDataTableAttributeResponseUnmarshaller();        

        internal static CreateDataTableAttributeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataTableAttributeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
