    ...
    public class CreateNotificationRequestMarshaller : IMarshaller<IRequest, CreateNotificationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateNotificationRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetContent())
            {
                ...
                foreach (var publicRequestContentKvp in publicRequest.Content)
                {
                    context.Writer.WritePropertyName(publicRequestContentKvp.Key);
                    var publicRequestContentValue = publicRequestContentKvp.Value;

                        context.Writer.WriteStringValue(publicRequestContentValue);
                }
            ...
            if(publicRequest.IsSetPredefinedNotificationId())
            {
                context.Writer.WritePropertyName("PredefinedNotificationId");
                context.Writer.WriteStringValue(publicRequest.PredefinedNotificationId);
            }
            ...
            if(publicRequest.IsSetRecipients())
            {
                context.Writer.WritePropertyName("Recipients");
                context.Writer.WriteStartArray();
                foreach(var publicRequestRecipientsListValue in publicRequest.Recipients)
                {
                        context.Writer.WriteStringValue(publicRequestRecipientsListValue);
                }
