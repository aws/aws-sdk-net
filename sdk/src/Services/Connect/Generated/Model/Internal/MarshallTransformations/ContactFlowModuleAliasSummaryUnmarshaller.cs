...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactFlowModuleAliasSummaryUnmarshaller : IJsonUnmarshaller<ContactFlowModuleAliasSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContactFlowModuleAliasSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AliasDescription", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AliasDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AliasId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AliasId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
