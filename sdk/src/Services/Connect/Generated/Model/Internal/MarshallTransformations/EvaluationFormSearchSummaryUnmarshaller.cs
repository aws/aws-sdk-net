...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluationFormSearchSummaryUnmarshaller : IJsonUnmarshaller<EvaluationFormSearchSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationFormSearchSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EvaluationFormLanguage", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EvaluationFormLanguage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
