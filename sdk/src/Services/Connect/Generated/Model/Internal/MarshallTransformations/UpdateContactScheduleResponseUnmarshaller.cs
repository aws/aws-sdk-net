...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactSchedule operation
    /// </summary>  
    public class UpdateContactScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactScheduleResponse response = new UpdateContactScheduleResponse();
        ...
        private static UpdateContactScheduleResponseUnmarshaller _instance = new UpdateContactScheduleResponseUnmarshaller();        

        internal static UpdateContactScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
