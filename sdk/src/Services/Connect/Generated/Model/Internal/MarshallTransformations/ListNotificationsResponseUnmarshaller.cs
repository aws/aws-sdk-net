...
{
    /// <summary>
    /// Response Unmarshaller for ListNotifications operation
    /// </summary>  
    public class ListNotificationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NotificationSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Notification, NotificationUnmarshaller>(NotificationUnmarshaller.Instance);
                    response.NotificationSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListNotificationsResponseUnmarshaller _instance = new ListNotificationsResponseUnmarshaller();        

        internal static ListNotificationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNotificationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
