...
{
    /// <summary>
    /// Response Unmarshaller for ClaimPhoneNumber operation
    /// </summary>  
    public class ClaimPhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ClaimPhoneNumberResponse response = new ClaimPhoneNumberResponse();
        ...
        private static ClaimPhoneNumberResponseUnmarshaller _instance = new ClaimPhoneNumberResponseUnmarshaller();        

        internal static ClaimPhoneNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ClaimPhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
