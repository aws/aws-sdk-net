...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMetricContent operation
    /// </summary>  
    public class UpdateMetricContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMetricContentResponse response = new UpdateMetricContentResponse();
        ...
        private static UpdateMetricContentResponseUnmarshaller _instance = new UpdateMetricContentResponseUnmarshaller();        

        internal static UpdateMetricContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMetricContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
