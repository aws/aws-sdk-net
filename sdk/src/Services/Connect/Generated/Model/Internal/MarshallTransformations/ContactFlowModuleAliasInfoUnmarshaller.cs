...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactFlowModuleAliasInfoUnmarshaller : IJsonUnmarshaller<ContactFlowModuleAliasInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContactFlowModuleAliasInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ContactFlowModuleArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ContactFlowModuleArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ContactFlowModuleId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ContactFlowModuleId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
