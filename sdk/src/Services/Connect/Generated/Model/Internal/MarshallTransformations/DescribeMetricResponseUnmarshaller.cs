...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMetric operation
    /// </summary>  
    public class DescribeMetricResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMetricResponse response = new DescribeMetricResponse();
        ...
        private static DescribeMetricResponseUnmarshaller _instance = new DescribeMetricResponseUnmarshaller();        

        internal static DescribeMetricResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMetricResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
