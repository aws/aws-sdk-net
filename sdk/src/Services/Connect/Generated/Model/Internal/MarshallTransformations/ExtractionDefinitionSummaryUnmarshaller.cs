...
{
    /// <summary>
    /// Response Unmarshaller for ExtractionDefinitionSummary Object
    /// </summary>  
    public class ExtractionDefinitionSummaryUnmarshaller : IJsonUnmarshaller<ExtractionDefinitionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExtractionDefinitionSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ExtractionDefinitionSummary unmarshalledObject = new ExtractionDefinitionSummary();
        ...
        private static ExtractionDefinitionSummaryUnmarshaller _instance = new ExtractionDefinitionSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ExtractionDefinitionSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
