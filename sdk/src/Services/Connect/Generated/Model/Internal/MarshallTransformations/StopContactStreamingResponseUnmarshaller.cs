...
{
    /// <summary>
    /// Response Unmarshaller for StopContactStreaming operation
    /// </summary>  
    public class StopContactStreamingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopContactStreamingResponse response = new StopContactStreamingResponse();
        ...
        private static StopContactStreamingResponseUnmarshaller _instance = new StopContactStreamingResponseUnmarshaller();        

        internal static StopContactStreamingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopContactStreamingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
