...
{
    /// <summary>
    /// Response Unmarshaller for SearchContactFlowModules operation
    /// </summary>  
    public class SearchContactFlowModulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchContactFlowModulesResponse response = new SearchContactFlowModulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ContactFlowModules", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ContactFlowModule, ContactFlowModuleUnmarshaller>(ContactFlowModuleUnmarshaller.Instance);
                    response.ContactFlowModules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchContactFlowModulesResponseUnmarshaller _instance = new SearchContactFlowModulesResponseUnmarshaller();        

        internal static SearchContactFlowModulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchContactFlowModulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
