...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluationFormItemEnablementConditionUnmarshaller : IJsonUnmarshaller<EvaluationFormItemEnablementCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationFormItemEnablementCondition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EvaluationFormItemEnablementConditionOperand, EvaluationFormItemEnablementConditionOperandUnmarshaller>(EvaluationFormItemEnablementConditionOperandUnmarshaller.Instance);
