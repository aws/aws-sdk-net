...
{
    /// <summary>
    /// RuleAttributeFilter Marshaller
    /// </summary>
    public class RuleAttributeFilterMarshaller : IRequestMarshaller<RuleAttributeFilter, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RuleAttributeFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAndCondition())
            {
                ...
                var marshaller = RuleAttributeAndConditionMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RuleAttributeFilterMarshaller Instance = new RuleAttributeFilterMarshaller();
