...
{
    /// <summary>
    /// Response Unmarshaller for CreateContactFlowModuleVersion operation
    /// </summary>  
    public class CreateContactFlowModuleVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContactFlowModuleVersionResponse response = new CreateContactFlowModuleVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContactFlowModuleArn", targetDepth))
                {
                    ...
                    response.ContactFlowModuleArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateContactFlowModuleVersionResponseUnmarshaller _instance = new CreateContactFlowModuleVersionResponseUnmarshaller();        

        internal static CreateContactFlowModuleVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContactFlowModuleVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
