        ...
        public Contact Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ChatMetrics", targetDepth))
                {
                    ...
                    unmarshalledObject.ChatMetrics = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ContactDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.ContactDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ContactEvaluations", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ContactEvaluation, StringUnmarshaller, ContactEvaluationUnmarshaller>(StringUnmarshaller.Instance, ContactEvaluationUnmarshaller.Instance);
                    unmarshalledObject.ContactEvaluations = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<NextContactEntry, NextContactEntryUnmarshaller>(NextContactEntryUnmarshaller.Instance);
                    unmarshalledObject.NextContacts = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("OutboundStrategy", targetDepth))
                {
                    var unmarshaller = OutboundStrategyUnmarshaller.Instance;
                    unmarshalledObject.OutboundStrategy = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RecordingInfo, RecordingInfoUnmarshaller>(RecordingInfoUnmarshaller.Instance);
                    unmarshalledObject.Recordings = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.RingStartTimestamp = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("TaskTemplateInfo", targetDepth))
                {
                    ...
                    unmarshalledObject.TaskTemplateInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
