    ...
    public class SummaryConfigurationMarshaller : IRequestMarshaller<SummaryConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(SummaryConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetSummaryModes())
            {
                context.Writer.WritePropertyName("SummaryModes");
                context.Writer.WriteStartArray();
                foreach(var requestObjectSummaryModesListValue in requestObject.SummaryModes)
                {
                        context.Writer.WriteStringValue(requestObjectSummaryModesListValue);
                }
