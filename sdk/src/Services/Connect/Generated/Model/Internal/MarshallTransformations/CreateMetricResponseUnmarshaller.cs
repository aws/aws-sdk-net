...
{
    /// <summary>
    /// Response Unmarshaller for CreateMetric operation
    /// </summary>  
    public class CreateMetricResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MetricId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateMetricResponseUnmarshaller _instance = new CreateMetricResponseUnmarshaller();        

        internal static CreateMetricResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMetricResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
