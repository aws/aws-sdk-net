...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTaskTemplate operation
    /// </summary>  
    public class DeleteTaskTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTaskTemplateResponse response = new DeleteTaskTemplateResponse();
        ...
        private static DeleteTaskTemplateResponseUnmarshaller _instance = new DeleteTaskTemplateResponseUnmarshaller();        

        internal static DeleteTaskTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTaskTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
