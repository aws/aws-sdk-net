...
{
    /// <summary>
    /// Response Unmarshaller for ListViewVersions operation
    /// </summary>  
    public class ListViewVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListViewVersionsResponse response = new ListViewVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ViewVersionSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ViewVersionSummary, ViewVersionSummaryUnmarshaller>(ViewVersionSummaryUnmarshaller.Instance);
                    response.ViewVersionSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListViewVersionsResponseUnmarshaller _instance = new ListViewVersionsResponseUnmarshaller();        

        internal static ListViewVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListViewVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
