...
{
    /// <summary>
    /// Response Unmarshaller for StartTestCaseExecution operation
    /// </summary>  
    public class StartTestCaseExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTestCaseExecutionResponse response = new StartTestCaseExecutionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestCaseExecutionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartTestCaseExecutionResponseUnmarshaller _instance = new StartTestCaseExecutionResponseUnmarshaller();        

        internal static StartTestCaseExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTestCaseExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
