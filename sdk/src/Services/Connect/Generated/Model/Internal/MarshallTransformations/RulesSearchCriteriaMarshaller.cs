...
{
    /// <summary>
    /// RulesSearchCriteria Marshaller
    /// </summary>
    public class RulesSearchCriteriaMarshaller : IRequestMarshaller<RulesSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RulesSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAndConditions())
            {
                ...
                foreach(var requestObjectAndConditionsListValue in requestObject.AndConditions)
                {
                    ...
                    var marshaller = RulesSearchCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RulesSearchCriteriaMarshaller Instance = new RulesSearchCriteriaMarshaller();
