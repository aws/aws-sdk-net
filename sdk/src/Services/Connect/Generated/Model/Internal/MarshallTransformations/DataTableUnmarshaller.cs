...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataTableUnmarshaller : IJsonUnmarshaller<DataTable, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataTable Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ValueLockLevel", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ValueLockLevel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
