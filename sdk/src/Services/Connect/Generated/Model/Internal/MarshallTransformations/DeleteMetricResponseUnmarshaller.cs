...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMetric operation
    /// </summary>  
    public class DeleteMetricResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMetricResponse response = new DeleteMetricResponse();
        ...
        private static DeleteMetricResponseUnmarshaller _instance = new DeleteMetricResponseUnmarshaller();        

        internal static DeleteMetricResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMetricResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
