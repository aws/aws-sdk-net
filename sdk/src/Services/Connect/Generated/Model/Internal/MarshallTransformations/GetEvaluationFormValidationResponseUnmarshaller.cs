...
{
    /// <summary>
    /// Response Unmarshaller for GetEvaluationFormValidation operation
    /// </summary>  
    public class GetEvaluationFormValidationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEvaluationFormValidationResponse response = new GetEvaluationFormValidationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EvaluationFormValidationFinding, EvaluationFormValidationFindingUnmarshaller>(EvaluationFormValidationFindingUnmarshaller.Instance);
        ...
        private static GetEvaluationFormValidationResponseUnmarshaller _instance = new GetEvaluationFormValidationResponseUnmarshaller();        

        internal static GetEvaluationFormValidationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEvaluationFormValidationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
