...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataTableAttributeUnmarshaller : IUnmarshaller<DataTableAttribute, XmlUnmarshallerContext>, IUnmarshaller<DataTableAttribute, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DataTableAttribute IUnmarshaller<DataTableAttribute, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DataTableAttribute Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataTableArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DataTableId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataTableId = unmarshaller.Unmarshall(context);
                    continue;
                }
