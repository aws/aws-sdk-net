...
{
    /// <summary>
    /// Response Unmarshaller for SearchEvaluationForms operation
    /// </summary>  
    public class SearchEvaluationFormsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchEvaluationFormsResponse response = new SearchEvaluationFormsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EvaluationFormSearchSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<EvaluationFormSearchSummary, EvaluationFormSearchSummaryUnmarshaller>(EvaluationFormSearchSummaryUnmarshaller.Instance);
                    response.EvaluationFormSearchSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchEvaluationFormsResponseUnmarshaller _instance = new SearchEvaluationFormsResponseUnmarshaller();        

        internal static SearchEvaluationFormsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchEvaluationFormsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
