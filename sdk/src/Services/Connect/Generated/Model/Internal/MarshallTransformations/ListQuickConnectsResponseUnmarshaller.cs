...
{
    /// <summary>
    /// Response Unmarshaller for ListQuickConnects operation
    /// </summary>  
    public class ListQuickConnectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListQuickConnectsResponse response = new ListQuickConnectsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("QuickConnectSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<QuickConnectSummary, QuickConnectSummaryUnmarshaller>(QuickConnectSummaryUnmarshaller.Instance);
                    response.QuickConnectSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListQuickConnectsResponseUnmarshaller _instance = new ListQuickConnectsResponseUnmarshaller();        

        internal static ListQuickConnectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListQuickConnectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
