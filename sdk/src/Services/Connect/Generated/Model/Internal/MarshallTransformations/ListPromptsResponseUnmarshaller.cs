...
{
    /// <summary>
    /// Response Unmarshaller for ListPrompts operation
    /// </summary>  
    public class ListPromptsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPromptsResponse response = new ListPromptsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PromptSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PromptSummary, PromptSummaryUnmarshaller>(PromptSummaryUnmarshaller.Instance);
                    response.PromptSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListPromptsResponseUnmarshaller _instance = new ListPromptsResponseUnmarshaller();        

        internal static ListPromptsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPromptsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
