...
{
    /// <summary>
    /// Response Unmarshaller for StartEvaluationFormValidation operation
    /// </summary>  
    public class StartEvaluationFormValidationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartEvaluationFormValidationResponse response = new StartEvaluationFormValidationResponse();
        ...
        private static StartEvaluationFormValidationResponseUnmarshaller _instance = new StartEvaluationFormValidationResponseUnmarshaller();        

        internal static StartEvaluationFormValidationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartEvaluationFormValidationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
