...
{
    /// <summary>
    /// Response Unmarshaller for AssociateSecurityKey operation
    /// </summary>  
    public class AssociateSecurityKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateSecurityKeyResponse response = new AssociateSecurityKeyResponse();
        ...
        private static AssociateSecurityKeyResponseUnmarshaller _instance = new AssociateSecurityKeyResponseUnmarshaller();        

        internal static AssociateSecurityKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateSecurityKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
