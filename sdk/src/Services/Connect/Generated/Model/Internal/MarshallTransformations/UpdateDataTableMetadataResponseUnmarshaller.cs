...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDataTableMetadata operation
    /// </summary>  
    public class UpdateDataTableMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDataTableMetadataResponse response = new UpdateDataTableMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LockVersion", targetDepth))
                {
                    ...
                    response.LockVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateDataTableMetadataResponseUnmarshaller _instance = new UpdateDataTableMetadataResponseUnmarshaller();        

        internal static UpdateDataTableMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataTableMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
