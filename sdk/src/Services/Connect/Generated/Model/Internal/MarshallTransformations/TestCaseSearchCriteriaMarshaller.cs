...
{
    /// <summary>
    /// TestCaseSearchCriteria Marshaller
    /// </summary>
    public class TestCaseSearchCriteriaMarshaller : IRequestMarshaller<TestCaseSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TestCaseSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAndConditions())
            {
                ...
                foreach(var requestObjectAndConditionsListValue in requestObject.AndConditions)
                {
                    ...
                    var marshaller = TestCaseSearchCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static TestCaseSearchCriteriaMarshaller Instance = new TestCaseSearchCriteriaMarshaller();
