...
{
    /// <summary>
    /// Response Unmarshaller for DeleteExtractionDefinition operation
    /// </summary>  
    public class DeleteExtractionDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteExtractionDefinitionResponse response = new DeleteExtractionDefinitionResponse();
        ...
        private static DeleteExtractionDefinitionResponseUnmarshaller _instance = new DeleteExtractionDefinitionResponseUnmarshaller();        

        internal static DeleteExtractionDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExtractionDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
