...
{
    /// <summary>
    /// Response Unmarshaller for SearchTestCases operation
    /// </summary>  
    public class SearchTestCasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchTestCasesResponse response = new SearchTestCasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TestCases", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TestCase, TestCaseUnmarshaller>(TestCaseUnmarshaller.Instance);
        ...
        private static SearchTestCasesResponseUnmarshaller _instance = new SearchTestCasesResponseUnmarshaller();        

        internal static SearchTestCasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTestCasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
