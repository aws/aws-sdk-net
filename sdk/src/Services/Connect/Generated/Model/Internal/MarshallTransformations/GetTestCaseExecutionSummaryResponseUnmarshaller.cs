...
{
    /// <summary>
    /// Response Unmarshaller for GetTestCaseExecutionSummary operation
    /// </summary>  
    public class GetTestCaseExecutionSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTestCaseExecutionSummaryResponse response = new GetTestCaseExecutionSummaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ObservationSummary", targetDepth, ref reader))
                {
                    var unmarshaller = ObservationSummaryUnmarshaller.Instance;
                    response.ObservationSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetTestCaseExecutionSummaryResponseUnmarshaller _instance = new GetTestCaseExecutionSummaryResponseUnmarshaller();        

        internal static GetTestCaseExecutionSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTestCaseExecutionSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
