...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class HoursOfOperationConfigMarshaller : IRequestMarshaller<HoursOfOperationConfig, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(HoursOfOperationConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetDay())
            {
                context.Writer.WritePropertyName("Day");
                context.Writer.WriteStringValue(requestObject.Day);
            }
            ...
            if(requestObject.IsSetEndTime())
            {
                ...
                var marshaller = HoursOfOperationTimeSliceMarshaller.Instance;
