...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class EvaluationFormContentUnmarshaller : IJsonUnmarshaller<EvaluationFormContent, JsonUnmarshallerContext>
    {
        ...
        public EvaluationFormContent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AIVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AIVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AutoEvaluationConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ReviewConfiguration", targetDepth, ref reader))
                {
