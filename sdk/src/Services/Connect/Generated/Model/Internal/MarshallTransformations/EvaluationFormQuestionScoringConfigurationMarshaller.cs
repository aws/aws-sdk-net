...
{
    /// <summary>
    /// EvaluationFormQuestionScoringConfiguration Marshaller
    /// </summary>
    public class EvaluationFormQuestionScoringConfigurationMarshaller : IRequestMarshaller<EvaluationFormQuestionScoringConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EvaluationFormQuestionScoringConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPointsConfiguration())
            {
                ...
                var marshaller = QuestionPointsConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static EvaluationFormQuestionScoringConfigurationMarshaller Instance = new EvaluationFormQuestionScoringConfigurationMarshaller();
