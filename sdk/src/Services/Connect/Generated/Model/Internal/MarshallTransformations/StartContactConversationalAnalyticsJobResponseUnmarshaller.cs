...
{
    /// <summary>
    /// Response Unmarshaller for StartContactConversationalAnalyticsJob operation
    /// </summary>  
    public class StartContactConversationalAnalyticsJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartContactConversationalAnalyticsJobResponse response = new StartContactConversationalAnalyticsJobResponse();
        ...
        private static StartContactConversationalAnalyticsJobResponseUnmarshaller _instance = new StartContactConversationalAnalyticsJobResponseUnmarshaller();        

        internal static StartContactConversationalAnalyticsJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartContactConversationalAnalyticsJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
