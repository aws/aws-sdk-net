...
{
    /// <summary>
    /// Response Unmarshaller for GetCrossRegionRouting operation
    /// </summary>  
    public class GetCrossRegionRoutingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCrossRegionRoutingResponse response = new GetCrossRegionRoutingResponse();
            ...
            {
                if (context.TestExpression("IsolatedRegions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.IsolatedRegions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCrossRegionRoutingResponseUnmarshaller _instance = new GetCrossRegionRoutingResponseUnmarshaller();        

        internal static GetCrossRegionRoutingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCrossRegionRoutingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
