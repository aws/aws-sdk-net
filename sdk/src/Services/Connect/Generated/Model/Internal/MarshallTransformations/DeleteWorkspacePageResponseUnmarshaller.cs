...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWorkspacePage operation
    /// </summary>  
    public class DeleteWorkspacePageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWorkspacePageResponse response = new DeleteWorkspacePageResponse();
        ...
        private static DeleteWorkspacePageResponseUnmarshaller _instance = new DeleteWorkspacePageResponseUnmarshaller();        

        internal static DeleteWorkspacePageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWorkspacePageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
