...
{
    /// <summary>
    /// Response Unmarshaller for DescribePrompt operation
    /// </summary>  
    public class DescribePromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePromptResponse response = new DescribePromptResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Prompt", targetDepth))
                {
                    ...
                    response.Prompt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribePromptResponseUnmarshaller _instance = new DescribePromptResponseUnmarshaller();        

        internal static DescribePromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
