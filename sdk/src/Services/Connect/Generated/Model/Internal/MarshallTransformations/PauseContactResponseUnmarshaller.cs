...
{
    /// <summary>
    /// Response Unmarshaller for PauseContact operation
    /// </summary>  
    public class PauseContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PauseContactResponse response = new PauseContactResponse();
        ...
        private static PauseContactResponseUnmarshaller _instance = new PauseContactResponseUnmarshaller();        

        internal static PauseContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PauseContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
