...
{
    /// <summary>
    /// Response Unmarshaller for SearchEmailAddresses operation
    /// </summary>  
    public class SearchEmailAddressesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchEmailAddressesResponse response = new SearchEmailAddressesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EmailAddresses", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<EmailAddressMetadata, EmailAddressMetadataUnmarshaller>(EmailAddressMetadataUnmarshaller.Instance);
                    response.EmailAddresses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchEmailAddressesResponseUnmarshaller _instance = new SearchEmailAddressesResponseUnmarshaller();        

        internal static SearchEmailAddressesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchEmailAddressesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
