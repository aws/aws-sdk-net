...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactFlowModuleAlias operation
    /// </summary>  
    public class UpdateContactFlowModuleAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactFlowModuleAliasResponse response = new UpdateContactFlowModuleAliasResponse();
        ...
        private static UpdateContactFlowModuleAliasResponseUnmarshaller _instance = new UpdateContactFlowModuleAliasResponseUnmarshaller();        

        internal static UpdateContactFlowModuleAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactFlowModuleAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
