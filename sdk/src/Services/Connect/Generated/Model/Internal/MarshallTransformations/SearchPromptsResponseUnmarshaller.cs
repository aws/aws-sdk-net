...
{
    /// <summary>
    /// Response Unmarshaller for SearchPrompts operation
    /// </summary>  
    public class SearchPromptsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchPromptsResponse response = new SearchPromptsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Prompts", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Prompt, PromptUnmarshaller>(PromptUnmarshaller.Instance);
                    response.Prompts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static SearchPromptsResponseUnmarshaller _instance = new SearchPromptsResponseUnmarshaller();        

        internal static SearchPromptsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchPromptsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
