    ...
    public class FiltersMarshaller : IRequestMarshaller<Filters, JsonMarshallerContext> 
    {
        ...
        public void Marshall(Filters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAgentStatuses())
            {
                ...
                {
                        context.Writer.Write(requestObjectAgentStatusesListValue);
                }
            ...
            if(requestObject.IsSetSubtypes())
            {
                ...
                {
                        context.Writer.Write(requestObjectSubtypesListValue);
                }
                context.Writer.WriteArrayEnd();
            }
            ...
            if(requestObject.IsSetValidationTestTypes())
            {
                ...
                {
                        context.Writer.Write(requestObjectValidationTestTypesListValue);
                }
                context.Writer.WriteArrayEnd();
            }
