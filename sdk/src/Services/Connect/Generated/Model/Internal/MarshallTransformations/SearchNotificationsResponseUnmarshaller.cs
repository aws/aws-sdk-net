...
{
    /// <summary>
    /// Response Unmarshaller for SearchNotifications operation
    /// </summary>  
    public class SearchNotificationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<NotificationSearchSummary, NotificationSearchSummaryUnmarshaller>(NotificationSearchSummaryUnmarshaller.Instance);
        ...
        private static SearchNotificationsResponseUnmarshaller _instance = new SearchNotificationsResponseUnmarshaller();        

        internal static SearchNotificationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchNotificationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
