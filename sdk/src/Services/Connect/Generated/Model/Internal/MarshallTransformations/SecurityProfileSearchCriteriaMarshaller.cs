...
{
    /// <summary>
    /// SecurityProfileSearchCriteria Marshaller
    /// </summary>
    public class SecurityProfileSearchCriteriaMarshaller : IRequestMarshaller<SecurityProfileSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SecurityProfileSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAndConditions())
            {
                ...
                foreach(var requestObjectAndConditionsListValue in requestObject.AndConditions)
                {
                    ...
                    var marshaller = SecurityProfileSearchCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static SecurityProfileSearchCriteriaMarshaller Instance = new SecurityProfileSearchCriteriaMarshaller();
