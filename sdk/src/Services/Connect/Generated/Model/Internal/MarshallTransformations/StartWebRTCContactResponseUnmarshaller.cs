        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ConnectionData", targetDepth))
                {
                    ...
                    response.ConnectionData = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ParticipantId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ParticipantToken", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ParticipantToken = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
