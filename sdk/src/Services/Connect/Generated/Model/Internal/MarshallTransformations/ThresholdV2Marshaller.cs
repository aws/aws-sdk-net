...
{
    /// <summary>
    /// ThresholdV2 Marshaller
    /// </summary>
    public class ThresholdV2Marshaller : IRequestMarshaller<ThresholdV2, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(ThresholdV2 requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetThresholdValue())
            {
                ...
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(requestObject.ThresholdValue.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(requestObject.ThresholdValue.Value);
                }
            }
        ...
        /// </summary>
        public readonly static ThresholdV2Marshaller Instance = new ThresholdV2Marshaller();
