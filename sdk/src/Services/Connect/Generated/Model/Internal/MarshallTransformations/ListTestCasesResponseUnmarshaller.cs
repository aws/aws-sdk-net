    ...
    public class ListTestCasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TestCaseSummary, TestCaseSummaryUnmarshaller>(TestCaseSummaryUnmarshaller.Instance);
                    response.TestCaseSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
