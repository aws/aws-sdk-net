...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DefaultVocabularyUnmarshaller : IUnmarshaller<DefaultVocabulary, XmlUnmarshallerContext>, IUnmarshaller<DefaultVocabulary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DefaultVocabulary IUnmarshaller<DefaultVocabulary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DefaultVocabulary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VocabularyId = unmarshaller.Unmarshall(context);
                    continue;
                }
