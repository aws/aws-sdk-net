...
{
    /// <summary>
    /// Response Unmarshaller for CreateAuthCode operation
    /// </summary>  
    public class CreateAuthCodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAuthCodeResponse response = new CreateAuthCodeResponse();
        ...
        private static CreateAuthCodeResponseUnmarshaller _instance = new CreateAuthCodeResponseUnmarshaller();        

        internal static CreateAuthCodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAuthCodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
