...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTestCase operation
    /// </summary>  
    public class DescribeTestCaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTestCaseResponse response = new DescribeTestCaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TestCaseUnmarshaller.Instance;
                    response.TestCase = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeTestCaseResponseUnmarshaller _instance = new DescribeTestCaseResponseUnmarshaller();        

        internal static DescribeTestCaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTestCaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
