...
{
    /// <summary>
    /// MetricSearchCriteria Marshaller
    /// </summary>
    public class MetricSearchCriteriaMarshaller : IRequestMarshaller<MetricSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(MetricSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetBooleanCondition())
            {
                context.Writer.WritePropertyName("BooleanCondition");
                context.Writer.WriteStartObject();

                var marshaller = BooleanConditionMarshaller.Instance;
                marshaller.Marshall(requestObject.BooleanCondition, context);
        ...
        /// </summary>
        public readonly static MetricSearchCriteriaMarshaller Instance = new MetricSearchCriteriaMarshaller();
