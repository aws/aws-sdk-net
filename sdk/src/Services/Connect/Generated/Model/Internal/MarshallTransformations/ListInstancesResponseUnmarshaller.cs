...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("InstanceSummaryList", targetDepth, ref reader))
                {
                    ...
                    response.InstanceSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListInstancesResponseUnmarshaller _instance = new ListInstancesResponseUnmarshaller();        

        internal static ListInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
