    ...
    public class ListQueuesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("QueueSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<QueueSummary, QueueSummaryUnmarshaller>(QueueSummaryUnmarshaller.Instance);
                    response.QueueSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
