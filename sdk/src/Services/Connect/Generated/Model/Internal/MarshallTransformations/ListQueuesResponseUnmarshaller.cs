    ...
    public class ListQueuesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<QueueSummary, QueueSummaryUnmarshaller>(QueueSummaryUnmarshaller.Instance);
                    response.QueueSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
