...
{
    /// <summary>
    /// Response Unmarshaller for CreateAgentStatus operation
    /// </summary>  
    public class CreateAgentStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAgentStatusResponse response = new CreateAgentStatusResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AgentStatusARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AgentStatusARN = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AgentStatusId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AgentStatusId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAgentStatusResponseUnmarshaller _instance = new CreateAgentStatusResponseUnmarshaller();        

        internal static CreateAgentStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
