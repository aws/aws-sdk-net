...
{
    /// <summary>
    /// Response Unmarshaller for AssociateApprovedOrigin operation
    /// </summary>  
    public class AssociateApprovedOriginResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateApprovedOriginResponse response = new AssociateApprovedOriginResponse();
        ...
        private static AssociateApprovedOriginResponseUnmarshaller _instance = new AssociateApprovedOriginResponseUnmarshaller();        

        internal static AssociateApprovedOriginResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateApprovedOriginResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
