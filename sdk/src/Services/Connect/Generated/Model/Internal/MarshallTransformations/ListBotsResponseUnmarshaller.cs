...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListBotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBotsResponse response = new ListBotsResponse();
            ...
            {
                if (context.TestExpression("LexBots", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<LexBotConfig, LexBotConfigUnmarshaller>(LexBotConfigUnmarshaller.Instance);
                    response.LexBots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListBotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
