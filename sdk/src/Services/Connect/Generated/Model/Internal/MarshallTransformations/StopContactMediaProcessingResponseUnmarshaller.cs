...
{
    /// <summary>
    /// Response Unmarshaller for StopContactMediaProcessing operation
    /// </summary>  
    public class StopContactMediaProcessingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopContactMediaProcessingResponse response = new StopContactMediaProcessingResponse();
        ...
        private static StopContactMediaProcessingResponseUnmarshaller _instance = new StopContactMediaProcessingResponseUnmarshaller();        

        internal static StopContactMediaProcessingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopContactMediaProcessingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
