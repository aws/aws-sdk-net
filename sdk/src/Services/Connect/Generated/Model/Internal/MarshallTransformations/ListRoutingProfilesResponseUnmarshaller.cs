...
{
    /// <summary>
    /// Response Unmarshaller for ListRoutingProfiles operation
    /// </summary>  
    public class ListRoutingProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRoutingProfilesResponse response = new ListRoutingProfilesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RoutingProfileSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RoutingProfileSummary, RoutingProfileSummaryUnmarshaller>(RoutingProfileSummaryUnmarshaller.Instance);
                    response.RoutingProfileSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRoutingProfilesResponseUnmarshaller _instance = new ListRoutingProfilesResponseUnmarshaller();        

        internal static ListRoutingProfilesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRoutingProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
