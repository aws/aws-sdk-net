...
{
    /// <summary>
    /// Response Unmarshaller for CreatePrompt operation
    /// </summary>  
    public class CreatePromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePromptResponse response = new CreatePromptResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PromptARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromptARN = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PromptId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromptId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreatePromptResponseUnmarshaller _instance = new CreatePromptResponseUnmarshaller();        

        internal static CreatePromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
