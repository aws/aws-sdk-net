    ...
    public class ListSecurityProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SecurityProfileSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SecurityProfileSummary, SecurityProfileSummaryUnmarshaller>(SecurityProfileSummaryUnmarshaller.Instance);
                    response.SecurityProfileSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
