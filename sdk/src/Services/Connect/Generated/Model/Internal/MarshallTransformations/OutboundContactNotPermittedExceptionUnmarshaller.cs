...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OutboundContactNotPermittedExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<OutboundContactNotPermittedException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public OutboundContactNotPermittedException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public OutboundContactNotPermittedException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
