...
{
    /// <summary>
    /// Response Unmarshaller for ListTestCaseExecutions operation
    /// </summary>  
    public class ListTestCaseExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTestCaseExecutionsResponse response = new ListTestCaseExecutionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TestCaseExecutions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TestCaseExecution, TestCaseExecutionUnmarshaller>(TestCaseExecutionUnmarshaller.Instance);
                    response.TestCaseExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTestCaseExecutionsResponseUnmarshaller _instance = new ListTestCaseExecutionsResponseUnmarshaller();        

        internal static ListTestCaseExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTestCaseExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
