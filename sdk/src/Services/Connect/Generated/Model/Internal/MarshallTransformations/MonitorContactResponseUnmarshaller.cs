...
{
    /// <summary>
    /// Response Unmarshaller for MonitorContact operation
    /// </summary>  
    public class MonitorContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            MonitorContactResponse response = new MonitorContactResponse();
        ...
        private static MonitorContactResponseUnmarshaller _instance = new MonitorContactResponseUnmarshaller();        

        internal static MonitorContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MonitorContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
