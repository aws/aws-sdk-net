...
{
    /// <summary>
    /// Response Unmarshaller for StartOutboundChatContact operation
    /// </summary>  
    public class StartOutboundChatContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartOutboundChatContactResponse response = new StartOutboundChatContactResponse();
        ...
        private static StartOutboundChatContactResponseUnmarshaller _instance = new StartOutboundChatContactResponseUnmarshaller();        

        internal static StartOutboundChatContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartOutboundChatContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
