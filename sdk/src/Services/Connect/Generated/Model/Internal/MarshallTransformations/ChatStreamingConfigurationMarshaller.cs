...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class ChatStreamingConfigurationMarshaller : IRequestMarshaller<ChatStreamingConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ChatStreamingConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetStreamingEndpointArn())
            {
                context.Writer.WritePropertyName("StreamingEndpointArn");
                context.Writer.WriteStringValue(requestObject.StreamingEndpointArn);
            }
