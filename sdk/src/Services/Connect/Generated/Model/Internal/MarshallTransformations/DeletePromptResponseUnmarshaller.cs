...
{
    /// <summary>
    /// Response Unmarshaller for DeletePrompt operation
    /// </summary>  
    public class DeletePromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePromptResponse response = new DeletePromptResponse();
        ...
        private static DeletePromptResponseUnmarshaller _instance = new DeletePromptResponseUnmarshaller();        

        internal static DeletePromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
