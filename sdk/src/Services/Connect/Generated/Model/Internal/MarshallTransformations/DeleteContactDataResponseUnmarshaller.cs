...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactData operation
    /// </summary>  
    public class DeleteContactDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactDataResponse response = new DeleteContactDataResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ContactNotTerminatedException"))
                {
                    return ContactNotTerminatedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeleteContactDataResponseUnmarshaller _instance = new DeleteContactDataResponseUnmarshaller();        

        internal static DeleteContactDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
