    ...
    public class SearchAvailablePhoneNumbersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AvailableNumberSummary, AvailableNumberSummaryUnmarshaller>(AvailableNumberSummaryUnmarshaller.Instance);
                    response.AvailableNumbersList = unmarshaller.Unmarshall(context);
                    continue;
                }
