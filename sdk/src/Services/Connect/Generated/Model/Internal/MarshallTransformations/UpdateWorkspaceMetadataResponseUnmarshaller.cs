...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspaceMetadata operation
    /// </summary>  
    public class UpdateWorkspaceMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkspaceMetadataResponse response = new UpdateWorkspaceMetadataResponse();
        ...
        private static UpdateWorkspaceMetadataResponseUnmarshaller _instance = new UpdateWorkspaceMetadataResponseUnmarshaller();        

        internal static UpdateWorkspaceMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspaceMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
