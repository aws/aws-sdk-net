...
{
    /// <summary>
    /// Response Unmarshaller for SearchRules operation
    /// </summary>  
    public class SearchRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RuleSearchSummary, RuleSearchSummaryUnmarshaller>(RuleSearchSummaryUnmarshaller.Instance);
        ...
        private static SearchRulesResponseUnmarshaller _instance = new SearchRulesResponseUnmarshaller();        

        internal static SearchRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
