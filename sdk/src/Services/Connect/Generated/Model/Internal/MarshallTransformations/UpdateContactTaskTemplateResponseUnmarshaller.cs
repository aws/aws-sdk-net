...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactTaskTemplate operation
    /// </summary>  
    public class UpdateContactTaskTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactTaskTemplateResponse response = new UpdateContactTaskTemplateResponse();
        ...
        private static UpdateContactTaskTemplateResponseUnmarshaller _instance = new UpdateContactTaskTemplateResponseUnmarshaller();        

        internal static UpdateContactTaskTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactTaskTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
