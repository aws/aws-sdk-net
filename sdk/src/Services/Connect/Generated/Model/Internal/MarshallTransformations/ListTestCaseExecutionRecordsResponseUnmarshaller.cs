...
{
    /// <summary>
    /// Response Unmarshaller for ListTestCaseExecutionRecords operation
    /// </summary>  
    public class ListTestCaseExecutionRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTestCaseExecutionRecordsResponse response = new ListTestCaseExecutionRecordsResponse();
            ...
            {
                if (context.TestExpression("ExecutionRecords", targetDepth, ref reader))
                {
                    ...
                    response.ExecutionRecords = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListTestCaseExecutionRecordsResponseUnmarshaller _instance = new ListTestCaseExecutionRecordsResponseUnmarshaller();        

        internal static ListTestCaseExecutionRecordsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTestCaseExecutionRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
