...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluationFormSingleSelectQuestionAutomationOptionUnmarshaller : IJsonUnmarshaller<EvaluationFormSingleSelectQuestionAutomationOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationFormSingleSelectQuestionAutomationOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("RuleCategory", targetDepth, ref reader))
                {
                    var unmarshaller = SingleSelectQuestionRuleCategoryAutomationUnmarshaller.Instance;
                    unmarshalledObject.RuleCategory = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
