...
{
    /// <summary>
    /// Response Unmarshaller for DescribeView operation
    /// </summary>  
    public class DescribeViewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeViewResponse response = new DescribeViewResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("View", targetDepth))
                {
                    ...
                    response.View = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeViewResponseUnmarshaller _instance = new DescribeViewResponseUnmarshaller();        

        internal static DescribeViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
