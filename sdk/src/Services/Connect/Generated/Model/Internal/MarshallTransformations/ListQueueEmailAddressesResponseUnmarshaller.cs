...
{
    /// <summary>
    /// Response Unmarshaller for ListQueueEmailAddresses operation
    /// </summary>  
    public class ListQueueEmailAddressesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListQueueEmailAddressesResponse response = new ListQueueEmailAddressesResponse();
            ...
            {
                if (context.TestExpression("EmailAddressMetadataList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<EmailAddressSummary, EmailAddressSummaryUnmarshaller>(EmailAddressSummaryUnmarshaller.Instance);
                    response.EmailAddressMetadataList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListQueueEmailAddressesResponseUnmarshaller _instance = new ListQueueEmailAddressesResponseUnmarshaller();        

        internal static ListQueueEmailAddressesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListQueueEmailAddressesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
