...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspacePage operation
    /// </summary>  
    public class UpdateWorkspacePageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkspacePageResponse response = new UpdateWorkspacePageResponse();
        ...
        private static UpdateWorkspacePageResponseUnmarshaller _instance = new UpdateWorkspacePageResponseUnmarshaller();        

        internal static UpdateWorkspacePageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspacePageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
