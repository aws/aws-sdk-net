...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HistoricalMetricResultUnmarshaller : IJsonUnmarshaller<HistoricalMetricResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HistoricalMetricResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HistoricalMetricData, HistoricalMetricDataUnmarshaller>(HistoricalMetricDataUnmarshaller.Instance);
