...
{
    /// <summary>
    /// Response Unmarshaller for ListWorkspacePages operation
    /// </summary>  
    public class ListWorkspacePagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWorkspacePagesResponse response = new ListWorkspacePagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WorkspacePageList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkspacePage, WorkspacePageUnmarshaller>(WorkspacePageUnmarshaller.Instance);
                    response.WorkspacePageList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListWorkspacePagesResponseUnmarshaller _instance = new ListWorkspacePagesResponseUnmarshaller();        

        internal static ListWorkspacePagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkspacePagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
