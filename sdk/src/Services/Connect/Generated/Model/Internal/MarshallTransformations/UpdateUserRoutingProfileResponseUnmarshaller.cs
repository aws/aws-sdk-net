...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUserRoutingProfile operation
    /// </summary>  
    public class UpdateUserRoutingProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUserRoutingProfileResponse response = new UpdateUserRoutingProfileResponse();
        ...
        private static UpdateUserRoutingProfileResponseUnmarshaller _instance = new UpdateUserRoutingProfileResponseUnmarshaller();        

        internal static UpdateUserRoutingProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserRoutingProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
