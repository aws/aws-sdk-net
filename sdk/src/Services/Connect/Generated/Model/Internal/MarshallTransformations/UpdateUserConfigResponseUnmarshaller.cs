...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUserConfig operation
    /// </summary>  
    public class UpdateUserConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUserConfigResponse response = new UpdateUserConfigResponse();
        ...
        private static UpdateUserConfigResponseUnmarshaller _instance = new UpdateUserConfigResponseUnmarshaller();        

        internal static UpdateUserConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
