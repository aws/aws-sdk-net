...
{
    /// <summary>
    /// Response Unmarshaller for AssociateContactWithUser operation
    /// </summary>  
    public class AssociateContactWithUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateContactWithUserResponse response = new AssociateContactWithUserResponse();
        ...
        private static AssociateContactWithUserResponseUnmarshaller _instance = new AssociateContactWithUserResponseUnmarshaller();        

        internal static AssociateContactWithUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateContactWithUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
