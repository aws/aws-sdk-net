...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class ListMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("MetricSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MetricSummary, MetricSummaryUnmarshaller>(MetricSummaryUnmarshaller.Instance);
                    response.MetricSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
