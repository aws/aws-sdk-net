...
{
    /// <summary>
    /// Response Unmarshaller for DescribeNotification operation
    /// </summary>  
    public class DescribeNotificationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeNotificationResponse response = new DescribeNotificationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Notification", targetDepth))
                {
                    ...
                    response.Notification = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeNotificationResponseUnmarshaller _instance = new DescribeNotificationResponseUnmarshaller();        

        internal static DescribeNotificationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNotificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
