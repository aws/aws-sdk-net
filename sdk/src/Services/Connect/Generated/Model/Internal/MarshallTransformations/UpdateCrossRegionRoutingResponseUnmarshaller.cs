...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCrossRegionRouting operation
    /// </summary>  
    public class UpdateCrossRegionRoutingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCrossRegionRoutingResponse response = new UpdateCrossRegionRoutingResponse();
        ...
        private static UpdateCrossRegionRoutingResponseUnmarshaller _instance = new UpdateCrossRegionRoutingResponseUnmarshaller();        

        internal static UpdateCrossRegionRoutingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCrossRegionRoutingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
