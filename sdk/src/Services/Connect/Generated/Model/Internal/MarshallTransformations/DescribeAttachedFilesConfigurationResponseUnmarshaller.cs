...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAttachedFilesConfiguration operation
    /// </summary>  
    public class DescribeAttachedFilesConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAttachedFilesConfigurationResponse response = new DescribeAttachedFilesConfigurationResponse();
        ...
        private static DescribeAttachedFilesConfigurationResponseUnmarshaller _instance = new DescribeAttachedFilesConfigurationResponseUnmarshaller();        

        internal static DescribeAttachedFilesConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAttachedFilesConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
