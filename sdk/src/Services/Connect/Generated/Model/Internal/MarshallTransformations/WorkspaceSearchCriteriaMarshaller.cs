...
{
    /// <summary>
    /// WorkspaceSearchCriteria Marshaller
    /// </summary>
    public class WorkspaceSearchCriteriaMarshaller : IRequestMarshaller<WorkspaceSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(WorkspaceSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAndConditions())
            {
                ...
                foreach(var requestObjectAndConditionsListValue in requestObject.AndConditions)
                {
                    ...
                    var marshaller = WorkspaceSearchCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static WorkspaceSearchCriteriaMarshaller Instance = new WorkspaceSearchCriteriaMarshaller();
