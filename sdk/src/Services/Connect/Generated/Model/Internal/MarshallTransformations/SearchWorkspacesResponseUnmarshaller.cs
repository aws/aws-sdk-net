...
{
    /// <summary>
    /// Response Unmarshaller for SearchWorkspaces operation
    /// </summary>  
    public class SearchWorkspacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchWorkspacesResponse response = new SearchWorkspacesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkspaceSearchSummary, WorkspaceSearchSummaryUnmarshaller>(WorkspaceSearchSummaryUnmarshaller.Instance);
        ...
        private static SearchWorkspacesResponseUnmarshaller _instance = new SearchWorkspacesResponseUnmarshaller();        

        internal static SearchWorkspacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchWorkspacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
