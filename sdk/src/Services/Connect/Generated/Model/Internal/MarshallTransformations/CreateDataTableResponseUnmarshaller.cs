...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataTable operation
    /// </summary>  
    public class CreateDataTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataTableResponse response = new CreateDataTableResponse();
        ...
        private static CreateDataTableResponseUnmarshaller _instance = new CreateDataTableResponseUnmarshaller();        

        internal static CreateDataTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
