...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEmailAddress operation
    /// </summary>  
    public class DeleteEmailAddressResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEmailAddressResponse response = new DeleteEmailAddressResponse();
        ...
        private static DeleteEmailAddressResponseUnmarshaller _instance = new DeleteEmailAddressResponseUnmarshaller();        

        internal static DeleteEmailAddressResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEmailAddressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
