...
{
    /// <summary>
    /// CalculationComponent Marshaller
    /// </summary>
    public class CalculationComponentMarshaller : IRequestMarshaller<CalculationComponent, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CalculationComponent requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMetricFilters())
            {
                ...
                foreach(var requestObjectMetricFiltersListValue in requestObject.MetricFilters)
                {
                    ...
                    var marshaller = MetricFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CalculationComponentMarshaller Instance = new CalculationComponentMarshaller();
