...
{
    /// <summary>
    /// Response Unmarshaller for ListSecurityProfilePermissions operation
    /// </summary>  
    public class ListSecurityProfilePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSecurityProfilePermissionsResponse response = new ListSecurityProfilePermissionsResponse();
        ...
        private static ListSecurityProfilePermissionsResponseUnmarshaller _instance = new ListSecurityProfilePermissionsResponseUnmarshaller();        

        internal static ListSecurityProfilePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecurityProfilePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
