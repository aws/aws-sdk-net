...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class QuickConnectConfigUnmarshaller : IUnmarshaller<QuickConnectConfig, XmlUnmarshallerContext>, IUnmarshaller<QuickConnectConfig, JsonUnmarshallerContext>
    {
        ...
        public QuickConnectConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("FlowConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.FlowConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static QuickConnectConfigUnmarshaller _instance = new QuickConnectConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QuickConnectConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
