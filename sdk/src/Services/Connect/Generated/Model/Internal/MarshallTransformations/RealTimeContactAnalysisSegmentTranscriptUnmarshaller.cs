...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RealTimeContactAnalysisSegmentTranscriptUnmarshaller : IJsonUnmarshaller<RealTimeContactAnalysisSegmentTranscript, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RealTimeContactAnalysisSegmentTranscript Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Redaction", targetDepth, ref reader))
                {
                    var unmarshaller = RealTimeContactAnalysisTranscriptItemRedactionUnmarshaller.Instance;
                    unmarshalledObject.Redaction = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
