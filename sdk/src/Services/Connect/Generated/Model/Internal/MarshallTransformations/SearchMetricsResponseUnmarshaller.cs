...
{
    /// <summary>
    /// Response Unmarshaller for SearchMetrics operation
    /// </summary>  
    public class SearchMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchMetricsResponse response = new SearchMetricsResponse();
        ...
        private static SearchMetricsResponseUnmarshaller _instance = new SearchMetricsResponseUnmarshaller();        

        internal static SearchMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
