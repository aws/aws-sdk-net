...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMetricMetadata operation
    /// </summary>  
    public class UpdateMetricMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMetricMetadataResponse response = new UpdateMetricMetadataResponse();
        ...
        private static UpdateMetricMetadataResponseUnmarshaller _instance = new UpdateMetricMetadataResponseUnmarshaller();        

        internal static UpdateMetricMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMetricMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
