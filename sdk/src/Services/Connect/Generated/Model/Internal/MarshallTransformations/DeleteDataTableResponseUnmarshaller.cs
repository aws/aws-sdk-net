...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDataTable operation
    /// </summary>  
    public class DeleteDataTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDataTableResponse response = new DeleteDataTableResponse();
        ...
        private static DeleteDataTableResponseUnmarshaller _instance = new DeleteDataTableResponseUnmarshaller();        

        internal static DeleteDataTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDataTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
