...
{
    /// <summary>
    /// NotificationSearchCriteria Marshaller
    /// </summary>
    public class NotificationSearchCriteriaMarshaller : IRequestMarshaller<NotificationSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(NotificationSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAndConditions())
            {
                ...
                foreach(var requestObjectAndConditionsListValue in requestObject.AndConditions)
                {
                    ...
                    var marshaller = NotificationSearchCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static NotificationSearchCriteriaMarshaller Instance = new NotificationSearchCriteriaMarshaller();
