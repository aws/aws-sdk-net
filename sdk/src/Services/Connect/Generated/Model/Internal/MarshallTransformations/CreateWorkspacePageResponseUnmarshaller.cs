...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkspacePage operation
    /// </summary>  
    public class CreateWorkspacePageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkspacePageResponse response = new CreateWorkspacePageResponse();
        ...
        private static CreateWorkspacePageResponseUnmarshaller _instance = new CreateWorkspacePageResponseUnmarshaller();        

        internal static CreateWorkspacePageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkspacePageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
