...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecordingInfoUnmarshaller : IUnmarshaller<RecordingInfo, XmlUnmarshallerContext>, IUnmarshaller<RecordingInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RecordingInfo IUnmarshaller<RecordingInfo, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RecordingInfo Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DeletionReason", targetDepth))
                {
                    ...
                    unmarshalledObject.DeletionReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FragmentStartNumber", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FragmentStartNumber = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FragmentStopNumber", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FragmentStopNumber = unmarshaller.Unmarshall(context);
                    continue;
                }
