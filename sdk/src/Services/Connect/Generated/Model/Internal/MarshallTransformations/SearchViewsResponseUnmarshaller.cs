...
{
    /// <summary>
    /// Response Unmarshaller for SearchViews operation
    /// </summary>  
    public class SearchViewsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchViewsResponse response = new SearchViewsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Views", targetDepth, ref reader))
                {
                    ...
                    response.Views = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static SearchViewsResponseUnmarshaller _instance = new SearchViewsResponseUnmarshaller();        

        internal static SearchViewsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchViewsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
