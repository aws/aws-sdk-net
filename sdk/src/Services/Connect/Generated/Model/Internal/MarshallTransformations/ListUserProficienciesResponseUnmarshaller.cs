...
{
    /// <summary>
    /// Response Unmarshaller for ListUserProficiencies operation
    /// </summary>  
    public class ListUserProficienciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUserProficienciesResponse response = new ListUserProficienciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UserProficiencyList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<UserProficiency, UserProficiencyUnmarshaller>(UserProficiencyUnmarshaller.Instance);
                    response.UserProficiencyList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListUserProficienciesResponseUnmarshaller _instance = new ListUserProficienciesResponseUnmarshaller();        

        internal static ListUserProficienciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserProficienciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
