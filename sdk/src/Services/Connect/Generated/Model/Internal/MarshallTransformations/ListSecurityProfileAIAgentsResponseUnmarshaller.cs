...
{
    /// <summary>
    /// Response Unmarshaller for ListSecurityProfileAIAgents operation
    /// </summary>  
    public class ListSecurityProfileAIAgentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSecurityProfileAIAgentsResponse response = new ListSecurityProfileAIAgentsResponse();
            ...
            {
                if (context.TestExpression("AllowedAIAgents", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AIAgent, AIAgentUnmarshaller>(AIAgentUnmarshaller.Instance);
                    response.AllowedAIAgents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListSecurityProfileAIAgentsResponseUnmarshaller _instance = new ListSecurityProfileAIAgentsResponseUnmarshaller();        

        internal static ListSecurityProfileAIAgentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecurityProfileAIAgentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
