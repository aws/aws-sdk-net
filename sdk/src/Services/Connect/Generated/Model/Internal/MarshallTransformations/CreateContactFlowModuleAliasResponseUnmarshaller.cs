...
{
    /// <summary>
    /// Response Unmarshaller for CreateContactFlowModuleAlias operation
    /// </summary>  
    public class CreateContactFlowModuleAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContactFlowModuleAliasResponse response = new CreateContactFlowModuleAliasResponse();
        ...
        private static CreateContactFlowModuleAliasResponseUnmarshaller _instance = new CreateContactFlowModuleAliasResponseUnmarshaller();        

        internal static CreateContactFlowModuleAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContactFlowModuleAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
