...
{
    /// <summary>
    /// Response Unmarshaller for DeleteHoursOfOperation operation
    /// </summary>  
    public class DeleteHoursOfOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteHoursOfOperationResponse response = new DeleteHoursOfOperationResponse();
        ...
        private static DeleteHoursOfOperationResponseUnmarshaller _instance = new DeleteHoursOfOperationResponseUnmarshaller();        

        internal static DeleteHoursOfOperationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHoursOfOperationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
