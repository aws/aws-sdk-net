...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEvaluationForm operation
    /// </summary>  
    public class DescribeEvaluationFormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEvaluationFormResponse response = new DescribeEvaluationFormResponse();
            ...
            {
                if (context.TestExpression("EvaluationForm", targetDepth, ref reader))
                {
                    var unmarshaller = EvaluationFormUnmarshaller.Instance;
                    response.EvaluationForm = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeEvaluationFormResponseUnmarshaller _instance = new DescribeEvaluationFormResponseUnmarshaller();        

        internal static DescribeEvaluationFormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEvaluationFormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
