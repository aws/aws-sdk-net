...
namespace Amazon.Connect.Model
{
    ...
    {
        private List<string> _attributeIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property AttributeIds. 
        /// <para>
        /// Optional list of specific attribute IDs to retrieve. Used for CloudFormation to effectively
        /// describe attributes by ID. If NextToken is provided, this parameter is ignored.
        /// </para>
        /// </summary>
        ...
        // Check to see if AttributeIds property is set
        internal bool IsSetAttributeIds()
        {
            return this._attributeIds != null && (this._attributeIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
