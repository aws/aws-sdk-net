...
{
    /// <summary>
    /// This is the response object from the ListWorkspaceMedia operation.
    /// </summary>
    public partial class ListWorkspaceMediaResponse : AmazonWebServiceResponse
    {
        private List<MediaItem> _media = AWSConfigs.InitializeCollections ? new List<MediaItem>() : null;
