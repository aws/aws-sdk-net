...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class ViewSearchCriteria
    {
        private List<ViewSearchCriteria> _andConditions = AWSConfigs.InitializeCollections ? new List<ViewSearchCriteria>() : null;
        private List<ViewSearchCriteria> _orConditions = AWSConfigs.InitializeCollections ? new List<ViewSearchCriteria>() : null;
        private StringCondition _stringCondition;
        private ViewStatus _viewStatusCondition;
        private ViewType _viewTypeCondition;
        ...
        /// </summary>
        public List<ViewSearchCriteria> AndConditions
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ViewSearchCriteria> OrConditions
        {
        ...
        /// <summary>
        /// Gets and sets the property ViewStatusCondition. 
        /// <para>
        /// A condition that filters views by their status.
        /// </para>
        /// </summary>
        public ViewStatus ViewStatusCondition
        {
            get { return this._viewStatusCondition; }
            set { this._viewStatusCondition = value; }
        }

        // Check to see if ViewStatusCondition property is set
        internal bool IsSetViewStatusCondition()
        {
            return this._viewStatusCondition != null;
        }

        /// <summary>
        /// Gets and sets the property ViewTypeCondition. 
        /// <para>
        /// A condition that filters views by their type.
        /// </para>
        /// </summary>
        public ViewType ViewTypeCondition
        {
            get { return this._viewTypeCondition; }
            set { this._viewTypeCondition = value; }
        }

        // Check to see if ViewTypeCondition property is set
        internal bool IsSetViewTypeCondition()
        {
            return this._viewTypeCondition != null;
        }
