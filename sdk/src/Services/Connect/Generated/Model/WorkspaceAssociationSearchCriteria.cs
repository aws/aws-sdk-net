...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class WorkspaceAssociationSearchCriteria
    {
        private List<WorkspaceAssociationSearchCriteria> _andConditions = AWSConfigs.InitializeCollections ? new List<WorkspaceAssociationSearchCriteria>() : null;
        private List<WorkspaceAssociationSearchCriteria> _orConditions = AWSConfigs.InitializeCollections ? new List<WorkspaceAssociationSearchCriteria>() : null;
        ...
        /// </para>
        /// </summary>
        public List<WorkspaceAssociationSearchCriteria> AndConditions
        {
        ...
        /// </para>
        /// </summary>
        public List<WorkspaceAssociationSearchCriteria> OrConditions
        {
