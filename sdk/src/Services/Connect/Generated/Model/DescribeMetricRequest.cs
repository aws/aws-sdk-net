...
{
    /// <summary>
    /// Container for the parameters to the DescribeMetric operation.
    /// Retrieves the full definition of an existing metric from the specified Connect Customer
    /// instance.
    /// </summary>
    public partial class DescribeMetricRequest : AmazonConnectRequest
    {
        ...
        /// <para>
        /// The identifier of the metric to describe. Adding the <c>$SAVED</c> qualifier will
        /// describe the saved version of the metric. Adding <c>$LATEST</c> or omitting a qualifier
        /// will describe the published version.
        /// </para>
        /// </summary>
