...
{
    /// <summary>
    /// Container for the parameters to the DisassociateUserProficiencies operation.
    /// Disassociates a set of proficiencies from a user.
    /// </summary>
    public partial class DisassociateUserProficienciesRequest : AmazonConnectRequest
    {
        private string _instanceId;
        private string _userId;
        private List<UserProficiencyDisassociate> _userProficiencies = AWSConfigs.InitializeCollections ? new List<UserProficiencyDisassociate>() : null;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<UserProficiencyDisassociate> UserProficiencies
        {
