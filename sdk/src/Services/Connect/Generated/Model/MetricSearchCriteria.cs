...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class MetricSearchCriteria
    {
        private List<MetricSearchCriteria> _andConditions = AWSConfigs.InitializeCollections ? new List<MetricSearchCriteria>() : null;
        private BooleanCondition _booleanCondition;
        private List<MetricSearchCriteria> _orConditions = AWSConfigs.InitializeCollections ? new List<MetricSearchCriteria>() : null;
        ...
        /// </summary>
        public List<MetricSearchCriteria> AndConditions
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<MetricSearchCriteria> OrConditions
        {
