...
{
    /// <summary>
    /// Container for the parameters to the UpdateWorkspacePage operation.
    /// Updates the configuration of a page in a workspace, including the associated view
    /// and input data.
    /// </summary>
    public partial class UpdateWorkspacePageRequest : AmazonConnectRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property NewPage. 
        /// <para>
        ...
        {
            get { return this._newPage; }
            set { this._newPage = value; }
        }

        // Check to see if NewPage property is set
        internal bool IsSetNewPage()
        {
