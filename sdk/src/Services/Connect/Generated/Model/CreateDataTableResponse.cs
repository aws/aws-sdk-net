...
{
    /// <summary>
    /// This is the response object from the CreateDataTable operation.
    /// </summary>
    public partial class CreateDataTableResponse : AmazonWebServiceResponse
    {
        private string _arn;
        private string _id;
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) for the created data table. Does not include the version
        /// alias.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The lock version information for the created data table, used for optimistic locking
