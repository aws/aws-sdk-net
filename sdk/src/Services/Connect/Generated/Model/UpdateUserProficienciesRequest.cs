...
{
    /// <summary>
    /// Container for the parameters to the UpdateUserProficiencies operation.
    /// Updates the properties associated with the proficiencies of a user.
    /// </summary>
    public partial class UpdateUserProficienciesRequest : AmazonConnectRequest
    {
        ...
        /// <para>
        /// The proficiencies to be updated for the user. Proficiencies must first be associated
        /// to the user. You can do this using AssociateUserProficiencies API.
        /// </para>
        /// <para />
