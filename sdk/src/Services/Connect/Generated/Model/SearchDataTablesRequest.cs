...
{
    /// <summary>
    /// Container for the parameters to the SearchDataTables operation.
    /// Searches for data tables based on the table's ID, name, and description. In the future,
    /// this operation can support searching on attribute names and possibly primary values.
    /// Follows other search operations closely and supports both search criteria and filters.
    /// </summary>
    public partial class SearchDataTablesRequest : AmazonConnectRequest
    {
        private string _instanceId;
        private int? _maxResults;
        private string _nextToken;
        private DataTableSearchCriteria _searchCriteria;
        private DataTableSearchFilter _searchFilter;
        ...
        /// <para>
        /// Search criteria including string conditions for matching table names, descriptions,
        /// or resource IDs. Supports STARTS_WITH, CONTAINS, and EXACT comparison types.
        /// </para>
        /// </summary>
        public DataTableSearchCriteria SearchCriteria
        {
        ...
        /// </para>
        /// </summary>
        public DataTableSearchFilter SearchFilter
        {
