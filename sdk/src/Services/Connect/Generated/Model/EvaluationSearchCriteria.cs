...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class EvaluationSearchCriteria
    {
        private List<EvaluationSearchCriteria> _andConditions = AWSConfigs.InitializeCollections ? new List<EvaluationSearchCriteria>() : null;
        private BooleanCondition _booleanCondition;
        private DateTimeCondition _dateTimeCondition;
        private DecimalCondition _decimalCondition;
        private NumberCondition _numberCondition;
        private List<EvaluationSearchCriteria> _orConditions = AWSConfigs.InitializeCollections ? new List<EvaluationSearchCriteria>() : null;
        ...
        /// </summary>
        public List<EvaluationSearchCriteria> AndConditions
        {
        ...
        /// </para>
        /// </summary>
        public DecimalCondition DecimalCondition
        {
            get { return this._decimalCondition; }
            set { this._decimalCondition = value; }
        }

        // Check to see if DecimalCondition property is set
        internal bool IsSetDecimalCondition()
        {
            return this._decimalCondition != null;
        }
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<EvaluationSearchCriteria> OrConditions
        {
