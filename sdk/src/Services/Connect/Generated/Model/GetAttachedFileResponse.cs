...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class GetAttachedFileResponse : AmazonWebServiceResponse
    {
        private string _associatedResourceArn;
        private CreatedByInfo _createdBy;
        private string _creationTime;
        private DownloadUrlMetadata _downloadUrlMetadata;
        ...
        /// <summary>
        /// Gets and sets the property DownloadUrlMetadata. 
        /// <para>
        ...
        {
            get { return this._downloadUrlMetadata; }
            set { this._downloadUrlMetadata = value; }
        }

        // Check to see if DownloadUrlMetadata property is set
        internal bool IsSetDownloadUrlMetadata()
        {
            return this._downloadUrlMetadata != null;
        }
