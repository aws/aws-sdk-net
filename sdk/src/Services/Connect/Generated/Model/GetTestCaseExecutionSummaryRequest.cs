...
{
    /// <summary>
    /// Container for the parameters to the GetTestCaseExecutionSummary operation.
    /// Retrieves an overview of a test execution that includes the status of the execution,
    /// start and end time, and observation summary.
    /// </summary>
    public partial class GetTestCaseExecutionSummaryRequest : AmazonConnectRequest
    {
