...
namespace Amazon.Connect.Model
{
    ...
    {
        private List<EmailAddressSearchCriteria> _andConditions = AWSConfigs.InitializeCollections ? new List<EmailAddressSearchCriteria>() : null;
        private List<EmailAddressSearchCriteria> _orConditions = AWSConfigs.InitializeCollections ? new List<EmailAddressSearchCriteria>() : null;
