...
namespace Amazon.Connect.Model
{
    ...
    internal sealed partial class GetMetricDataV2Paginator : IPaginator<GetMetricDataV2Response>, IGetMetricDataV2Paginator
    {
        ...
        async IAsyncEnumerable<GetMetricDataV2Response> IPaginator<GetMetricDataV2Response>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
