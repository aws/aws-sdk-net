...
namespace Amazon.Connect.Model
{
    ...
    internal sealed partial class ListWorkspacesPaginator : IPaginator<ListWorkspacesResponse>, IListWorkspacesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<WorkspaceSummary> WorkspaceSummaryList => 
            new PaginatedResultKeyResponse<ListWorkspacesResponse, WorkspaceSummary>(this, (i) => i.WorkspaceSummaryList ?? new List<WorkspaceSummary>());

        internal ListWorkspacesPaginator(IAmazonConnect client, ListWorkspacesRequest request)
        {
            this._client = client;
