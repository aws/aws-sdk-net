...
namespace Amazon.Connect.Model
{
    ...
    internal sealed partial class ListMetricsPaginator : IPaginator<ListMetricsResponse>, IListMetricsPaginator
    {
        ...
        /// <summary>
        /// Enumerable containing all of the MetricSummaryList
        /// </summary>
        public IPaginatedEnumerable<MetricSummary> MetricSummaryList => 
            new PaginatedResultKeyResponse<ListMetricsResponse, MetricSummary>(this, (i) => i.MetricSummaryList ?? new List<MetricSummary>());

        internal ListMetricsPaginator(IAmazonConnect client, ListMetricsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListMetricsResponse> IPaginator<ListMetricsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
