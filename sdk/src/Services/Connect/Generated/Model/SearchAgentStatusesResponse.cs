...
{
    /// <summary>
    /// This is the response object from the SearchAgentStatuses operation.
    /// </summary>
    public partial class SearchAgentStatusesResponse : AmazonWebServiceResponse
    {
        private List<AgentStatus> _agentStatuses = AWSConfigs.InitializeCollections ? new List<AgentStatus>() : null;
