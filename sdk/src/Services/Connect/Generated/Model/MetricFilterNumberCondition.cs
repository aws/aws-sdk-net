...
namespace Amazon.Connect.Model
{
    ...
    /// </summary>
    public partial class MetricFilterNumberCondition
    {
        private MetricFilterNumberConditionComparison _comparison;
        private List<double> _values = AWSConfigs.InitializeCollections ? new List<double>() : null;

        /// <summary>
        /// Gets and sets the property Comparison. 
        /// <para>
        /// The comparison operator. Valid values: <c>LESSER</c> (less than) | <c>LESSER_OR_EQUAL</c>
        /// (less than or equal to) | <c>GREATER</c> (greater than) | <c>GREATER_OR_EQUAL</c>
        /// (greater than or equal to).
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public MetricFilterNumberConditionComparison Comparison
        {
