...
{
    /// <summary>
    /// Response Unmarshaller for EnabledBaselineSummary Object
    /// </summary>  
    public class EnabledBaselineSummaryUnmarshaller : IUnmarshaller<EnabledBaselineSummary, XmlUnmarshallerContext>, IUnmarshaller<EnabledBaselineSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        EnabledBaselineSummary IUnmarshaller<EnabledBaselineSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public EnabledBaselineSummary Unmarshall(JsonUnmarshallerContext context)
        {
            EnabledBaselineSummary unmarshalledObject = new EnabledBaselineSummary();
        ...
        private static EnabledBaselineSummaryUnmarshaller _instance = new EnabledBaselineSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EnabledBaselineSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
