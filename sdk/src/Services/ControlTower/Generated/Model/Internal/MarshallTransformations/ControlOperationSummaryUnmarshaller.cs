...
namespace Amazon.ControlTower.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ControlOperationSummaryUnmarshaller : IJsonUnmarshaller<ControlOperationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ControlOperationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("controlIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ControlIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("enabledControlIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EnabledControlIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OperationIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
