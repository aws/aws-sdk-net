...
namespace Amazon.ControlTower.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonControlTowerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonControlTowerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ControlTower.
        /// </summary>
        public AmazonControlTowerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonControlTowerAuthSchemeParameters
            {
    ...
    public class AmazonControlTowerAuthSchemeResolver : IAuthSchemeResolver<AmazonControlTowerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonControlTowerAuthSchemeParameters authParameters)
        {
