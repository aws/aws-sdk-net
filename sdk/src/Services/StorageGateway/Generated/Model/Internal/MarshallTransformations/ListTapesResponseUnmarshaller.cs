...
{
    /// <summary>
    /// Response Unmarshaller for ListTapes operation
    /// </summary>  
    public class ListTapesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTapesResponse response = new ListTapesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TapeInfos", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TapeInfo, TapeInfoUnmarshaller>(TapeInfoUnmarshaller.Instance);
                    response.TapeInfos = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTapesResponseUnmarshaller _instance = new ListTapesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTapesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
