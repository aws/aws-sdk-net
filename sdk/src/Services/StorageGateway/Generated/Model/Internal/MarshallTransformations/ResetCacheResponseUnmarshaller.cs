...
{
    /// <summary>
    /// Response Unmarshaller for ResetCache operation
    /// </summary>  
    public class ResetCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetCacheResponse response = new ResetCacheResponse();
        ...
        private static ResetCacheResponseUnmarshaller _instance = new ResetCacheResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
