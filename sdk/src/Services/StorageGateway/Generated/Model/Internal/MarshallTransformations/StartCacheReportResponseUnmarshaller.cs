...
{
    /// <summary>
    /// Response Unmarshaller for StartCacheReport operation
    /// </summary>  
    public class StartCacheReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartCacheReportResponse response = new StartCacheReportResponse();
        ...
        private static StartCacheReportResponseUnmarshaller _instance = new StartCacheReportResponseUnmarshaller();        

        internal static StartCacheReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartCacheReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
