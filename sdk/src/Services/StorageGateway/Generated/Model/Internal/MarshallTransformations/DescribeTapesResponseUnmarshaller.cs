...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeTapesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Tapes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Tape, TapeUnmarshaller>(TapeUnmarshaller.Instance);
                    response.Tapes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeTapesResponseUnmarshaller _instance = new DescribeTapesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTapesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
