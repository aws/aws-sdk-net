...
{
    /// <summary>
    /// RefreshCache Request Marshaller
    /// </summary>       
    public class RefreshCacheRequestMarshaller : IMarshaller<IRequest, RefreshCacheRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RefreshCacheRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RefreshCacheRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetFolderList())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestFolderListListValue);
                }
            ...
            if(publicRequest.IsSetRecursive())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.Recursive.Value);
            }
        ...
        private static RefreshCacheRequestMarshaller _instance = new RefreshCacheRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RefreshCacheRequestMarshaller Instance
        {
            get
            {
                return _instance;
