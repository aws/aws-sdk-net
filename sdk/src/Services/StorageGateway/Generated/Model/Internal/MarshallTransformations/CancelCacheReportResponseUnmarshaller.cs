...
{
    /// <summary>
    /// Response Unmarshaller for CancelCacheReport operation
    /// </summary>  
    public class CancelCacheReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelCacheReportResponse response = new CancelCacheReportResponse();
            ...
            {
                if (context.TestExpression("CacheReportARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CacheReportARN = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CancelCacheReportResponseUnmarshaller _instance = new CancelCacheReportResponseUnmarshaller();        

        internal static CancelCacheReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelCacheReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
