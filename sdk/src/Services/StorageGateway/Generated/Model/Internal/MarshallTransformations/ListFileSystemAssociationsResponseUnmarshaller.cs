...
{
    /// <summary>
    /// Response Unmarshaller for ListFileSystemAssociations operation
    /// </summary>  
    public class ListFileSystemAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("FileSystemAssociationSummaryList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FileSystemAssociationSummary, FileSystemAssociationSummaryUnmarshaller>(FileSystemAssociationSummaryUnmarshaller.Instance);
                    response.FileSystemAssociationSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFileSystemAssociationsResponseUnmarshaller _instance = new ListFileSystemAssociationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFileSystemAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
