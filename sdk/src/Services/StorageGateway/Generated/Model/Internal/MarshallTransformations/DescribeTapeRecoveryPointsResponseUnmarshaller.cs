...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTapeRecoveryPoints operation
    /// </summary>  
    public class DescribeTapeRecoveryPointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTapeRecoveryPointsResponse response = new DescribeTapeRecoveryPointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TapeRecoveryPointInfos", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<TapeRecoveryPointInfo, TapeRecoveryPointInfoUnmarshaller>(TapeRecoveryPointInfoUnmarshaller.Instance);
                    response.TapeRecoveryPointInfos = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeTapeRecoveryPointsResponseUnmarshaller _instance = new DescribeTapeRecoveryPointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTapeRecoveryPointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
