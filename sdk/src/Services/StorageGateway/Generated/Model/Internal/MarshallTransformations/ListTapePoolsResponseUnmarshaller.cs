...
{
    /// <summary>
    /// Response Unmarshaller for ListTapePools operation
    /// </summary>  
    public class ListTapePoolsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTapePoolsResponse response = new ListTapePoolsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PoolInfos", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PoolInfo, PoolInfoUnmarshaller>(PoolInfoUnmarshaller.Instance);
                    response.PoolInfos = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTapePoolsResponseUnmarshaller _instance = new ListTapePoolsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTapePoolsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
