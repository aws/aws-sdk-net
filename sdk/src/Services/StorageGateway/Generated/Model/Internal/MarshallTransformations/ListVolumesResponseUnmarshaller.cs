...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVolumesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VolumeInfos", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<VolumeInfo, VolumeInfoUnmarshaller>(VolumeInfoUnmarshaller.Instance);
                    response.VolumeInfos = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListVolumesResponseUnmarshaller _instance = new ListVolumesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVolumesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
