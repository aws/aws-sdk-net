...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteChapCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("InitiatorName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InitiatorName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteChapCredentialsResponseUnmarshaller _instance = new DeleteChapCredentialsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChapCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
