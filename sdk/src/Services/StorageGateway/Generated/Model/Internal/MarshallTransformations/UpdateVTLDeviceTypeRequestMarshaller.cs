...
{
    /// <summary>
    /// UpdateVTLDeviceType Request Marshaller
    /// </summary>       
    public class UpdateVTLDeviceTypeRequestMarshaller : IMarshaller<IRequest, UpdateVTLDeviceTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateVTLDeviceTypeRequest publicRequest)
        {
            ...
            string target = "StorageGateway_20130630.UpdateVTLDeviceType";
            ...
            if(publicRequest.IsSetVTLDeviceARN())
            {
                context.Writer.WritePropertyName("VTLDeviceARN");
                context.Writer.WriteStringValue(publicRequest.VTLDeviceARN);
            }
