...
{
    /// <summary>
    /// Response Unmarshaller for ListLocalDisks operation
    /// </summary>  
    public class ListLocalDisksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Disks", targetDepth))
                {
                    ...
                    response.Disks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListLocalDisksResponseUnmarshaller _instance = new ListLocalDisksResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLocalDisksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
