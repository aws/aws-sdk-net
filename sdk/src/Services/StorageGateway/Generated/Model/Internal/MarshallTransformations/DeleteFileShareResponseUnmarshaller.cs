...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFileShare operation
    /// </summary>  
    public class DeleteFileShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFileShareResponse response = new DeleteFileShareResponse();
            ...
            {
                if (context.TestExpression("FileShareARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FileShareARN = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteFileShareResponseUnmarshaller _instance = new DeleteFileShareResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFileShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
