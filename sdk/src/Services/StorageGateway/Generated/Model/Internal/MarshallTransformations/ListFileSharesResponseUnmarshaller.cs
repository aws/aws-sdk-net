...
{
    /// <summary>
    /// Response Unmarshaller for ListFileShares operation
    /// </summary>  
    public class ListFileSharesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFileSharesResponse response = new ListFileSharesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FileShareInfoList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FileShareInfo, FileShareInfoUnmarshaller>(FileShareInfoUnmarshaller.Instance);
                    response.FileShareInfoList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFileSharesResponseUnmarshaller _instance = new ListFileSharesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFileSharesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
