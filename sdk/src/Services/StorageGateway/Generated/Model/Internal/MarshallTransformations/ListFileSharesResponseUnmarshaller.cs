    ...
    public class ListFileSharesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FileShareInfo, FileShareInfoUnmarshaller>(FileShareInfoUnmarshaller.Instance);
                    response.FileShareInfoList = unmarshaller.Unmarshall(context);
                    continue;
                }
