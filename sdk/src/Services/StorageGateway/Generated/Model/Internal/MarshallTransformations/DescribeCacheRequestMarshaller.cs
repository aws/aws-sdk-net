...
{
    /// <summary>
    /// DescribeCache Request Marshaller
    /// </summary>       
    public class DescribeCacheRequestMarshaller : IMarshaller<IRequest, DescribeCacheRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeCacheRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeCacheRequest publicRequest)
        {
