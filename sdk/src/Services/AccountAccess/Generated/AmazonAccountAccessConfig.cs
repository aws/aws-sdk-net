...
namespace Amazon.AccountAccess
{
    ...
    public partial class AmazonAccountAccessConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Account Access", "4.0.101.2");
        ...
        /// Default constructor
        /// </summary>
        public AmazonAccountAccessConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonAccountAccessDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Account Access";
            this.AuthenticationServiceName = "account-access";
            this.EndpointProvider = new AmazonAccountAccessEndpointProvider();
        }
