...
{
    /// <summary>
    /// Paginators for the AccountAccess service
    ///</summary>
    public class AccountAccessPaginatorFactory : IAccountAccessPaginatorFactory
    {
        private readonly IAmazonAccountAccess client;

        internal AccountAccessPaginatorFactory(IAmazonAccountAccess client) 
        {
            this.client = client;
        }
