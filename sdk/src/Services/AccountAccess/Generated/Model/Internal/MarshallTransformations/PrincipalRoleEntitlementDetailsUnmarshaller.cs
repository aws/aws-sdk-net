...
{
    /// <summary>
    /// Response Unmarshaller for PrincipalRoleEntitlementDetails Object
    /// </summary>  
    public class PrincipalRoleEntitlementDetailsUnmarshaller : IJsonUnmarshaller<PrincipalRoleEntitlementDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PrincipalRoleEntitlementDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PrincipalRoleEntitlementDetails unmarshalledObject = new PrincipalRoleEntitlementDetails();
        ...
        private static PrincipalRoleEntitlementDetailsUnmarshaller _instance = new PrincipalRoleEntitlementDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PrincipalRoleEntitlementDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
