...
{
    /// <summary>
    /// Response Unmarshaller for GetEntitlement operation
    /// </summary>  
    public class GetEntitlementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = EntitlementDetailsUnmarshaller.Instance;
                    response.Entitlement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("entitlementId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EntitlementId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonAccountAccessException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static GetEntitlementResponseUnmarshaller _instance = new GetEntitlementResponseUnmarshaller();        

        internal static GetEntitlementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEntitlementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
