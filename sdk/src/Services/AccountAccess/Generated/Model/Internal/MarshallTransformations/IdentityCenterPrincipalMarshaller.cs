...
{
    /// <summary>
    /// IdentityCenterPrincipal Marshaller
    /// </summary>
    public class IdentityCenterPrincipalMarshaller : IRequestMarshaller<IdentityCenterPrincipal, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IdentityCenterPrincipal requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static IdentityCenterPrincipalMarshaller Instance = new IdentityCenterPrincipalMarshaller();
