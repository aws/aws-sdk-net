...
namespace Amazon.AccountAccess.Model.Internal.MarshallTransformations
{
    ...
    public class EntitlementMarshaller : IRequestMarshaller<Entitlement, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(Entitlement requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetPrincipalRole())
            {
                context.Writer.WritePropertyName("principalRole");
                context.Writer.WriteStartObject();

                var marshaller = PrincipalRoleEntitlementMarshaller.Instance;
                marshaller.Marshall(requestObject.PrincipalRole, context);
