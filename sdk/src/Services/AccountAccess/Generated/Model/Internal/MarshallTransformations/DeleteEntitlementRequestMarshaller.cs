...
{
    /// <summary>
    /// DeleteEntitlement Request Marshaller
    /// </summary>       
    public class DeleteEntitlementRequestMarshaller : IMarshaller<IRequest, DeleteEntitlementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteEntitlementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteEntitlementRequest publicRequest)
        {
        ...
        private static DeleteEntitlementRequestMarshaller _instance = new DeleteEntitlementRequestMarshaller();        

        internal static DeleteEntitlementRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEntitlementRequestMarshaller Instance
        {
            get
            {
                return _instance;
