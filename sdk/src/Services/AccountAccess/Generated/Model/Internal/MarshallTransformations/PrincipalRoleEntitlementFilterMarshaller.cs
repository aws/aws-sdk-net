...
{
    /// <summary>
    /// PrincipalRoleEntitlementFilter Marshaller
    /// </summary>
    public class PrincipalRoleEntitlementFilterMarshaller : IRequestMarshaller<PrincipalRoleEntitlementFilter, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PrincipalRoleEntitlementFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPrincipal())
            {
                ...
                var marshaller = PrincipalFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static PrincipalRoleEntitlementFilterMarshaller Instance = new PrincipalRoleEntitlementFilterMarshaller();
