...
{
    /// <summary>
    /// Response Unmarshaller for PrincipalRoleEntitlementSummary Object
    /// </summary>  
    public class PrincipalRoleEntitlementSummaryUnmarshaller : IJsonUnmarshaller<PrincipalRoleEntitlementSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PrincipalRoleEntitlementSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PrincipalRoleEntitlementSummary unmarshalledObject = new PrincipalRoleEntitlementSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = PrincipalUnmarshaller.Instance;
        ...
        private static PrincipalRoleEntitlementSummaryUnmarshaller _instance = new PrincipalRoleEntitlementSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PrincipalRoleEntitlementSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
