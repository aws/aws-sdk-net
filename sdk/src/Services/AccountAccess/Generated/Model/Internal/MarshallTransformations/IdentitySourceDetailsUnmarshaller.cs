...
namespace Amazon.AccountAccess.Model.Internal.MarshallTransformations
{
    ...
    public class IdentitySourceDetailsUnmarshaller : IJsonUnmarshaller<IdentitySourceDetails, JsonUnmarshallerContext>
    {
        ...
        public IdentitySourceDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("identityCenter", targetDepth, ref reader))
                {
                    var unmarshaller = IdentityCenterDetailsUnmarshaller.Instance;
                    unmarshalledObject.IdentityCenter = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
