...
namespace Amazon.AccountAccess.Model
{
    ...
    {
        private List<EntitlementsListMember> _entitlements = AWSConfigs.InitializeCollections ? new List<EntitlementsListMember>() : null;
        ...
        public List<EntitlementsListMember> Entitlements
        {
