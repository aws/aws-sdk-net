...
{
    /// <summary>
    /// Specifies the entitlement configuration for an account access manager application,
    /// defining which principal can assume which IAM role.
    /// </summary>
    public partial class Entitlement
    {
        private PrincipalRoleEntitlement _principalRole;
        ...
        /// </para>
        /// </summary>
        public PrincipalRoleEntitlement PrincipalRole
        {
