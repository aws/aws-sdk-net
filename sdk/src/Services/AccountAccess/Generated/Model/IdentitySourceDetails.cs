...
namespace Amazon.AccountAccess.Model
{
    ...
    {
        private IdentityCenterDetails _identityCenter;

        /// <summary>
        /// Gets and sets the property IdentityCenter. 
        /// <para>
        /// The IAM Identity Center configuration details for the identity source.
        /// </para>
        /// </summary>
        public IdentityCenterDetails IdentityCenter
        {
            get { return this._identityCenter; }
            set { this._identityCenter = value; }
        }

        // Check to see if IdentityCenter property is set
        internal bool IsSetIdentityCenter()
        {
            return this._identityCenter != null;
        }
