...
namespace Amazon.AccountAccess.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonAccountAccessAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAccountAccessAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AccountAccess.
        /// </summary>
        public AmazonAccountAccessAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAccountAccessAuthSchemeParameters
            {
    ...
    public class AmazonAccountAccessAuthSchemeResolver : IAuthSchemeResolver<AmazonAccountAccessAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAccountAccessAuthSchemeParameters authParameters)
        {
