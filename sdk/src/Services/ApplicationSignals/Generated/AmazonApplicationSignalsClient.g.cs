...
namespace Amazon.ApplicationSignals
{
    ...
    public partial class AmazonApplicationSignalsClient : AmazonServiceClient, IAmazonApplicationSignals
    {
        ...
        /// 
        /// </summary>
        public AmazonApplicationSignalsClient() : base(new AmazonApplicationSignalsConfig()) { }
        ...
        public AmazonApplicationSignalsClient(RegionEndpoint region) : base(new AmazonApplicationSignalsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonApplicationSignalsClient(AmazonApplicationSignalsConfig config) : base(config) { }
