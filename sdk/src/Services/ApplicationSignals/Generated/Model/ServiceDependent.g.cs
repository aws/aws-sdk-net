...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ServiceDependent
    {
        ...
        public Dictionary<string, string> DependentKeyAttributes { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the DependentKeyAttributes property is set.
        /// </summary>
        internal bool IsSetDependentKeyAttributes() => this.DependentKeyAttributes != null && (this.DependentKeyAttributes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public string DependentOperationName { get; set; }

        /// <summary>
        /// Checks to see if the DependentOperationName property is set.
        /// </summary>
        internal bool IsSetDependentOperationName() => this.DependentOperationName != null;
