...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListServiceStatesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        [AWSProperty(Required = true, Max = 250)]
        public List<ServiceState> ServiceStates { get; set; } = AWSConfigs.InitializeCollections ? new List<ServiceState>() : null;

        /// <summary>
        /// Checks to see if the ServiceStates property is set.
        /// </summary>
        internal bool IsSetServiceStates() => this.ServiceStates != null && (this.ServiceStates.Count > 0 || !AWSConfigs.InitializeCollections);
