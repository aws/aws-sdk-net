...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListAuditFindingsResponse : AmazonWebServiceResponse
    {
        ...
        public List<AuditFinding> AuditFindings { get; set; } = AWSConfigs.InitializeCollections ? new List<AuditFinding>() : null;

        /// <summary>
        /// Checks to see if the AuditFindings property is set.
        /// </summary>
        internal bool IsSetAuditFindings() => this.AuditFindings != null && (this.AuditFindings.Count > 0 || !AWSConfigs.InitializeCollections);
