...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListServiceDependenciesResponse : AmazonWebServiceResponse
    {
        ...
        public List<ServiceDependency> ServiceDependencies { get; set; } = AWSConfigs.InitializeCollections ? new List<ServiceDependency>() : null;

        /// <summary>
        /// Checks to see if the ServiceDependencies property is set.
        /// </summary>
        internal bool IsSetServiceDependencies() => this.ServiceDependencies != null && (this.ServiceDependencies.Count > 0 || !AWSConfigs.InitializeCollections);
