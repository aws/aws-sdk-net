...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class RequestBasedServiceLevelIndicatorConfig
    {
        ...
        public RequestBasedServiceLevelIndicatorMetricConfig RequestBasedSliMetricConfig { get; set; }

        /// <summary>
        /// Checks to see if the RequestBasedSliMetricConfig property is set.
        /// </summary>
        internal bool IsSetRequestBasedSliMetricConfig() => this.RequestBasedSliMetricConfig != null;
    }
}
