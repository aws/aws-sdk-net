...
namespace Amazon.ApplicationSignals.Model
{
    ...
    /// (key-value pairs) to the specified CloudWatch resource, such as a service level objective.
    /// <para> Tags can help you organize and categorize your resources. You can also use
    /// them to scope user permissions by granting a user permission to access or change only
    /// resources with certain tag values. </para> <para> Tags don't have any semantic meaning
    /// to Amazon Web Services and are interpreted strictly as strings of characters. </para>
    /// <para> You can use the <c>TagResource</c> action with an alarm that already has tags.
    /// If you specify a new tag key for the alarm, this tag is appended to the list of tags
    /// associated with the alarm. If you specify a tag key that is already associated with
    /// the alarm, the new tag value that you specify replaces the previous value for that
    /// tag. </para> <para> You can associate as many as 50 tags with a CloudWatch resource.
    /// </para>
    /// </summary>
