...
{
    /// <summary>
    /// Container for the parameters to the GetService operation. Returns information about
    /// a service discovered by Application Signals.
    /// </summary>
    public partial class GetServiceRequest : AmazonApplicationSignalsRequest
    {
        /// <summary>
        ...
        /// <para>
        /// Use this field to specify which service you want to retrieve information for. You
        /// must specify at least the <c>Type</c>, <c>Name</c>, and <c>Environment</c> attributes.
        /// </para>
        ///  
        /// <para>
