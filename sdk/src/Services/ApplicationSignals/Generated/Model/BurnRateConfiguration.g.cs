...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class BurnRateConfiguration
    {
        ...
        public int? LookBackWindowMinutes { get; set; }

        /// <summary>
        /// Checks to see if the LookBackWindowMinutes property is set.
        /// </summary>
        internal bool IsSetLookBackWindowMinutes() => this.LookBackWindowMinutes.HasValue;
    }
}
