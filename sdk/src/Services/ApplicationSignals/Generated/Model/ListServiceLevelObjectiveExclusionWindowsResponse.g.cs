...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListServiceLevelObjectiveExclusionWindowsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ExclusionWindow> ExclusionWindows { get; set; } = AWSConfigs.InitializeCollections ? new List<ExclusionWindow>() : null;

        /// <summary>
        /// Checks to see if the ExclusionWindows property is set.
        /// </summary>
        internal bool IsSetExclusionWindows() => this.ExclusionWindows != null && (this.ExclusionWindows.Count > 0 || !AWSConfigs.InitializeCollections);
