...
{
    /// <summary>
    /// Container for the parameters to the ListAuditFindings operation. Returns a list of
    /// audit findings that provide automated analysis of service behavior and root cause
    /// analysis. These findings help identify the most significant observations about your
    /// services, including performance issues, anomalies, and potential problems. The findings
    ...
    public partial class ListAuditFindingsRequest : AmazonApplicationSignalsRequest
    {
        ...
        public List<AuditTarget> AuditTargets { get; set; } = AWSConfigs.InitializeCollections ? new List<AuditTarget>() : null;

        /// <summary>
        /// Checks to see if the AuditTargets property is set.
        /// </summary>
        internal bool IsSetAuditTargets() => this.AuditTargets != null && (this.AuditTargets.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> Auditors { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the Auditors property is set.
        /// </summary>
        internal bool IsSetAuditors() => this.Auditors != null && (this.Auditors.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the DetailLevel property is set.
        /// </summary>
        internal bool IsSetDetailLevel() => this.DetailLevel != null;
