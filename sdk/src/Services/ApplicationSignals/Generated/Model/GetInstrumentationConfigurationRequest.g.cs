...
{
    /// <summary>
    /// Container for the parameters to the GetInstrumentationConfiguration operation. Returns
    /// the details of a single instrumentation configuration identified by service, environment,
    /// signal type, and location. Use this to audit or display configuration details.
    /// </summary>
