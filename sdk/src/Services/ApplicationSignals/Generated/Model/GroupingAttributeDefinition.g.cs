...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class GroupingAttributeDefinition
    {
        ...
        /// <summary>
        /// Checks to see if the DefaultGroupingValue property is set.
        /// </summary>
        internal bool IsSetDefaultGroupingValue() => this.DefaultGroupingValue != null;
        ...
        /// <summary>
        /// Checks to see if the GroupingName property is set.
        /// </summary>
        internal bool IsSetGroupingName() => this.GroupingName != null;
        ...
        /// </summary>
        public List<string> GroupingSourceKeys { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the GroupingSourceKeys property is set.
        /// </summary>
        internal bool IsSetGroupingSourceKeys() => this.GroupingSourceKeys != null && (this.GroupingSourceKeys.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
