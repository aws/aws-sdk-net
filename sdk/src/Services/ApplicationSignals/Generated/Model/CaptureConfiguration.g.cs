...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class CaptureConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public CodeCaptureConfiguration CodeCapture { get; set; }

        /// <summary>
        /// Checks to see if the CodeCapture property is set.
        /// </summary>
        internal bool IsSetCodeCapture() => this.CodeCapture != null;
    }
}
