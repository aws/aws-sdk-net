...
{
    /// <summary>
    /// Container for the parameters to the ListServiceOperations operation. Returns a list
    /// of the <i>operations</i> of this service that have been discovered by Application
    /// Signals. Only the operations that were invoked during the specified time range are
    /// returned.
    /// </summary>
    public partial class ListServiceOperationsRequest : AmazonApplicationSignalsRequest
    {
        /// <summary>
