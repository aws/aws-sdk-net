...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class MonitoredRequestCountMetricDataQueries
    {
        ...
        /// </summary>
        public List<MetricDataQuery> BadCountMetric { get; set; } = AWSConfigs.InitializeCollections ? new List<MetricDataQuery>() : null;

        /// <summary>
        /// Checks to see if the BadCountMetric property is set.
        /// </summary>
        internal bool IsSetBadCountMetric() => this.BadCountMetric != null && (this.BadCountMetric.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<MetricDataQuery> GoodCountMetric { get; set; } = AWSConfigs.InitializeCollections ? new List<MetricDataQuery>() : null;

        /// <summary>
        /// Checks to see if the GoodCountMetric property is set.
        /// </summary>
        internal bool IsSetGoodCountMetric() => this.GoodCountMetric != null && (this.GoodCountMetric.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
