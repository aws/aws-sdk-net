...
{
    /// <summary>
    /// Response Unmarshaller for CreateInstrumentationConfiguration operation
    /// </summary>  
    public class CreateInstrumentationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInstrumentationConfigurationResponse response = new CreateInstrumentationConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AttributeFilters", targetDepth, ref reader))
                {
                    ...
                    response.AttributeFilters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("CaptureConfiguration", targetDepth, ref reader))
                {
                    ...
                    response.CaptureConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InstrumentationType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LocationHash = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SignalType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateInstrumentationConfigurationResponseUnmarshaller _instance = new CreateInstrumentationConfigurationResponseUnmarshaller();        

        internal static CreateInstrumentationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInstrumentationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
