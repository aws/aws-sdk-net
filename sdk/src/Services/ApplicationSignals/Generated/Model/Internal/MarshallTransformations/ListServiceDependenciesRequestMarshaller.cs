...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListServiceDependenciesRequestMarshaller : IMarshaller<IRequest, ListServiceDependenciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListServiceDependenciesRequestMarshaller _instance = new ListServiceDependenciesRequestMarshaller();        

        internal static ListServiceDependenciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceDependenciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
