...
{
    /// <summary>
    /// DeleteInstrumentationConfiguration Request Marshaller
    /// </summary>       
    public class DeleteInstrumentationConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteInstrumentationConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteInstrumentationConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteInstrumentationConfigurationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/delete-instrumentation-configuration";
#if !NETFRAMEWORK
        ...
        private static DeleteInstrumentationConfigurationRequestMarshaller _instance = new DeleteInstrumentationConfigurationRequestMarshaller();        

        internal static DeleteInstrumentationConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInstrumentationConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
