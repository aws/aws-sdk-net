...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteInstrumentationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInstrumentationConfigurationResponse response = new DeleteInstrumentationConfigurationResponse();
        ...
        internal static DeleteInstrumentationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInstrumentationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
