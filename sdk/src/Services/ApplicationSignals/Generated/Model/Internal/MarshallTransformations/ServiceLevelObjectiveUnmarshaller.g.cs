...
{
    /// <summary>
    /// Response Unmarshaller for ServiceLevelObjective Object
    /// </summary>
    public partial class ServiceLevelObjectiveUnmarshaller : IJsonUnmarshaller<ServiceLevelObjective, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ServiceLevelObjective Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ServiceLevelObjective();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AutoInvestigationEnabled", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("BurnRateConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BurnRateConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("MetricSourceType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static ServiceLevelObjectiveUnmarshaller _instance = new ServiceLevelObjectiveUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ServiceLevelObjectiveUnmarshaller Instance => _instance;
    }
}
