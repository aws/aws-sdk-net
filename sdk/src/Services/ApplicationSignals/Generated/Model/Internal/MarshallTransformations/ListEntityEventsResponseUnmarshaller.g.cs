...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEntityEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListEntityEventsResponse();
            ...
            {
                if (context.TestExpression("ChangeEvents", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ChangeEvent, ChangeEventUnmarshaller>(ChangeEventUnmarshaller.Instance);
                    unmarshalledObject.ChangeEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListEntityEventsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEntityEventsResponseUnmarshaller Instance => _instance;
    }
}
