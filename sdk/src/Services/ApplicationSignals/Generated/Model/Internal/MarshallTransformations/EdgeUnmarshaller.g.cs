...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EdgeUnmarshaller : IJsonUnmarshaller<Edge, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Edge Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DestinationNodeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SourceNodeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
