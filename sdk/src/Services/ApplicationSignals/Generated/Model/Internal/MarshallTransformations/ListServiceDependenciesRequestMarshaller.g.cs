...
{
    /// <summary>
    /// ListServiceDependencies Request Marshaller
    /// </summary>
    public partial class ListServiceDependenciesRequestMarshaller : IMarshaller<IRequest, ListServiceDependenciesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListServiceDependenciesRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListServiceDependenciesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/service-dependencies";
#if !NETFRAMEWORK
        ...
        private static readonly ListServiceDependenciesRequestMarshaller _instance = new();

        internal static ListServiceDependenciesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListServiceDependenciesRequestMarshaller Instance => _instance;
    }
}
