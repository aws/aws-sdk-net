...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetInstrumentationConfigurationRequestMarshaller : IMarshaller<IRequest, GetInstrumentationConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetInstrumentationConfigurationRequestMarshaller _instance = new GetInstrumentationConfigurationRequestMarshaller();        

        internal static GetInstrumentationConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstrumentationConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
