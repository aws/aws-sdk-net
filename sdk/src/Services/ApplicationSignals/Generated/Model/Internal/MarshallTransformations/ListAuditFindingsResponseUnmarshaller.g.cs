...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAuditFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAuditFindingsResponse();
            ...
            {
                if (context.TestExpression("AuditFindings", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AuditFinding, AuditFindingUnmarshaller>(AuditFindingUnmarshaller.Instance);
                    unmarshalledObject.AuditFindings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAuditFindingsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAuditFindingsResponseUnmarshaller Instance => _instance;
    }
}
