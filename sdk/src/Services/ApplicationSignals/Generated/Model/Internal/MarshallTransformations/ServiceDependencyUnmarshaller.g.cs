...
{
    /// <summary>
    /// Response Unmarshaller for ServiceDependency Object
    /// </summary>
    public partial class ServiceDependencyUnmarshaller : IJsonUnmarshaller<ServiceDependency, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ServiceDependency Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ServiceDependency();
        ...
        private static ServiceDependencyUnmarshaller _instance = new ServiceDependencyUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ServiceDependencyUnmarshaller Instance => _instance;
    }
}
