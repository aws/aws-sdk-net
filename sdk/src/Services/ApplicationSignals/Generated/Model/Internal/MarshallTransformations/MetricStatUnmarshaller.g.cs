...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MetricStatUnmarshaller : IJsonUnmarshaller<MetricStat, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MetricStat();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Stat", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static MetricStatUnmarshaller Instance => _instance;
    }
}
