...
{
    /// <summary>
    /// GetInstrumentationConfiguration Request Marshaller
    /// </summary>
    public partial class GetInstrumentationConfigurationRequestMarshaller : IMarshaller<IRequest, GetInstrumentationConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetInstrumentationConfigurationRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetInstrumentationConfigurationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/get-instrumentation-configuration";
#if !NETFRAMEWORK
        ...
        private static readonly GetInstrumentationConfigurationRequestMarshaller _instance = new();

        internal static GetInstrumentationConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInstrumentationConfigurationRequestMarshaller Instance => _instance;
    }
}
