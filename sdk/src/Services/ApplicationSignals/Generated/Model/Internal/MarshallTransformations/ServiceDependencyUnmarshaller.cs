...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceDependencyUnmarshaller : IUnmarshaller<ServiceDependency, XmlUnmarshallerContext>, IUnmarshaller<ServiceDependency, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ServiceDependency IUnmarshaller<ServiceDependency, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ServiceDependency Unmarshall(JsonUnmarshallerContext context)
        {
            ServiceDependency unmarshalledObject = new ServiceDependency();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ServiceDependencyUnmarshaller Instance
        {
            get
            {
                return _instance;
