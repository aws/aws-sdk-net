...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ServiceLevelIndicatorConfig
    {
        ...
        public ServiceLevelIndicatorMetricConfig SliMetricConfig { get; set; }

        /// <summary>
        /// Checks to see if the SliMetricConfig property is set.
        /// </summary>
        internal bool IsSetSliMetricConfig() => this.SliMetricConfig != null;
    }
}
