...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListServicesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<ServiceSummary> ServiceSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ServiceSummary>() : null;

        /// <summary>
        /// Checks to see if the ServiceSummaries property is set.
        /// </summary>
        internal bool IsSetServiceSummaries() => this.ServiceSummaries != null && (this.ServiceSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
