...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListEntityEventsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ChangeEvent> ChangeEvents { get; set; } = AWSConfigs.InitializeCollections ? new List<ChangeEvent>() : null;

        /// <summary>
        /// Checks to see if the ChangeEvents property is set.
        /// </summary>
        internal bool IsSetChangeEvents() => this.ChangeEvents != null && (this.ChangeEvents.Count > 0 || !AWSConfigs.InitializeCollections);
