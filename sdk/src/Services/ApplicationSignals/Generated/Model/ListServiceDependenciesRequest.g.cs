...
{
    /// <summary>
    /// Container for the parameters to the ListServiceDependencies operation. Returns a list
    /// of service dependencies of the service that you specify. A dependency is an infrastructure
    /// component that an operation of this service connects with. Dependencies can include
    /// Amazon Web Services services, Amazon Web Services resources, and third-party services.
    /// </summary>
    public partial class ListServiceDependenciesRequest : AmazonApplicationSignalsRequest
    {
        /// <summary>
