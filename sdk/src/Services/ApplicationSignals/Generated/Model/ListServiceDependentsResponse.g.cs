...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListServiceDependentsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ServiceDependent> ServiceDependents { get; set; } = AWSConfigs.InitializeCollections ? new List<ServiceDependent>() : null;

        /// <summary>
        /// Checks to see if the ServiceDependents property is set.
        /// </summary>
        internal bool IsSetServiceDependents() => this.ServiceDependents != null && (this.ServiceDependents.Count > 0 || !AWSConfigs.InitializeCollections);
