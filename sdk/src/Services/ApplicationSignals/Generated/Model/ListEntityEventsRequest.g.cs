...
{
    /// <summary>
    /// Container for the parameters to the ListEntityEvents operation. Returns a list of
    /// change events for a specific entity, such as deployments, configuration changes, or
    /// other state-changing activities. This operation helps track the history of changes
    /// that may have affected service performance.
    /// </summary>
