...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ServiceDependency
    {
        ...
        public Dictionary<string, string> DependencyKeyAttributes { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the DependencyKeyAttributes property is set.
        /// </summary>
        internal bool IsSetDependencyKeyAttributes() => this.DependencyKeyAttributes != null && (this.DependencyKeyAttributes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the DependencyOperationName property is set.
        /// </summary>
        internal bool IsSetDependencyOperationName() => this.DependencyOperationName != null;
