...
{
    /// <summary>
    /// ListInstanceTypes Request Marshaller
    /// </summary>       
    public class ListInstanceTypesRequestMarshaller : IMarshaller<IRequest, ListInstanceTypesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInstanceTypesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInstanceTypesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkspacesInstances");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/EUCMIFrontendAPIService/operation/ListInstanceTypes";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("InstanceConfigurationFilter");
        ...
        private static ListInstanceTypesRequestMarshaller _instance = new ListInstanceTypesRequestMarshaller();        

        internal static ListInstanceTypesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInstanceTypesRequestMarshaller Instance
        {
            get
            {
                return _instance;
