...
namespace Amazon.WorkspacesInstances.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceTypeInfoUnmarshaller : ICborUnmarshaller<InstanceTypeInfo, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceTypeInfo Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "SupportedInstanceConfigurations":
                        {
                            context.AddPathSegment("SupportedInstanceConfigurations");
                            var unmarshaller = new CborListUnmarshaller<SupportedInstanceConfiguration, SupportedInstanceConfigurationUnmarshaller>(SupportedInstanceConfigurationUnmarshaller.Instance);
