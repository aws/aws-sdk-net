...
namespace Amazon.WorkspacesInstances.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRegionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListRegions");
            reader.ReadStartMap();
                    ...
                    case "Regions":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<Region, RegionUnmarshaller>(RegionUnmarshaller.Instance);
