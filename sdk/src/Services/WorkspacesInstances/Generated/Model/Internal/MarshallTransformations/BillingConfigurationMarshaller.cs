...
namespace Amazon.WorkspacesInstances.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class BillingConfigurationMarshaller : IRequestMarshaller<BillingConfiguration, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(BillingConfiguration requestObject, CborMarshallerContext context)
        {
