...
{
    /// <summary>
    /// BillingConfiguration Marshaller
    /// </summary>
    public class BillingConfigurationMarshaller : IRequestMarshaller<BillingConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(BillingConfiguration requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static BillingConfigurationMarshaller Instance = new BillingConfigurationMarshaller();
