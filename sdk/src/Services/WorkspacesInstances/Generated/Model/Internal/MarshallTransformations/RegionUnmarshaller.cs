...
namespace Amazon.WorkspacesInstances.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegionUnmarshaller : ICborUnmarshaller<Region, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Region Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "RegionName":
                        {
                            context.AddPathSegment("RegionName");
