...
namespace Amazon.WorkspacesInstances.Model
{
    ...
    {
        private readonly IAmazonWorkspacesInstances _client;
        ...
        internal ListRegionsPaginator(IAmazonWorkspacesInstances client, ListRegionsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListRegionsResponse> IPaginator<ListRegionsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
