...
namespace Amazon.WorkspacesInstances
{
    ...
    /// <summary>
    /// Constants used for properties of type NestedVirtualizationEnum.
    /// </summary>
    public class NestedVirtualizationEnum : ConstantClass
    {

        /// <summary>
        /// Constant Disabled for NestedVirtualizationEnum
        /// </summary>
        public static readonly NestedVirtualizationEnum Disabled = new NestedVirtualizationEnum("disabled");
        /// <summary>
        /// Constant Enabled for NestedVirtualizationEnum
        /// </summary>
        public static readonly NestedVirtualizationEnum Enabled = new NestedVirtualizationEnum("enabled");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public NestedVirtualizationEnum(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static NestedVirtualizationEnum FindValue(string value)
        {
            return FindValue<NestedVirtualizationEnum>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator NestedVirtualizationEnum(string value)
        {
            return FindValue(value);
        }
    }
