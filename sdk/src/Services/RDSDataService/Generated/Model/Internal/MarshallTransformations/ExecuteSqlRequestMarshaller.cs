...
{
    /// <summary>
    /// ExecuteSql Request Marshaller
    /// </summary>       
    public class ExecuteSqlRequestMarshaller : IMarshaller<IRequest, ExecuteSqlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExecuteSqlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExecuteSqlRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAwsSecretStoreArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AwsSecretStoreArn);
            }
            ...
            if(publicRequest.IsSetDbClusterOrInstanceArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.DbClusterOrInstanceArn);
            }
            ...
            if(publicRequest.IsSetSqlStatements())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SqlStatements);
            }
        ...
        private static ExecuteSqlRequestMarshaller _instance = new ExecuteSqlRequestMarshaller();        

        internal static ExecuteSqlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteSqlRequestMarshaller Instance
        {
            get
            {
                return _instance;
