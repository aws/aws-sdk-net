...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRDSDataServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRDSDataServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRDSDataServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRDSDataServiceConfig to create AmazonRDSDataServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonRDSDataServiceClient(serviceClientConfig) :
                    new AmazonRDSDataServiceClient(awsCredentials, serviceClientConfig);
        }
