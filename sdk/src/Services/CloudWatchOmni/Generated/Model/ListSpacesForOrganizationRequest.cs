...
{
    /// <summary>
    /// Container for the parameters to the ListSpacesForOrganization operation.
    /// Returns the spaces across all member accounts in the organization.
    /// </summary>
    public partial class ListSpacesForOrganizationRequest : AmazonCloudWatchOmniRequest
    {
