...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDomain operation
    /// </summary>  
    public class UpdateDomainResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("UpdateDomain");
            reader.ReadStartMap();
        ...
        private static UpdateDomainResponseUnmarshaller _instance = new UpdateDomainResponseUnmarshaller();        

        internal static UpdateDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
