...
{
    /// <summary>
    /// Response Unmarshaller for AccessGrant Object
    /// </summary>  
    public class AccessGrantUnmarshaller : ICborUnmarshaller<AccessGrant, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccessGrant Unmarshall(CborUnmarshallerContext context)
        {
            AccessGrant unmarshalledObject = new AccessGrant();
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "scopedActions":
                        {
                            context.AddPathSegment("ScopedActions");
                            var unmarshaller = new CborListUnmarshaller<ScopedActions, ScopedActionsUnmarshaller>(ScopedActionsUnmarshaller.Instance);
                            unmarshalledObject.ScopedActions = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "spaceId":
        ...
        private static AccessGrantUnmarshaller _instance = new AccessGrantUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AccessGrantUnmarshaller Instance
        {
            get
            {
                return _instance;
