...
{
    /// <summary>
    /// GetOmniDashboard Request Marshaller
    /// </summary>       
    public class GetOmniDashboardRequestMarshaller : IMarshaller<IRequest, GetOmniDashboardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetOmniDashboardRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetOmniDashboardRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/GetOmniDashboard";
        ...
        private static GetOmniDashboardRequestMarshaller _instance = new GetOmniDashboardRequestMarshaller();        

        internal static GetOmniDashboardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOmniDashboardRequestMarshaller Instance
        {
            get
            {
                return _instance;
