...
{
    /// <summary>
    /// ListAccessProfiles Request Marshaller
    /// </summary>       
    public class ListAccessProfilesRequestMarshaller : IMarshaller<IRequest, ListAccessProfilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAccessProfilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAccessProfilesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/ListAccessProfiles";
        ...
        private static ListAccessProfilesRequestMarshaller _instance = new ListAccessProfilesRequestMarshaller();        

        internal static ListAccessProfilesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessProfilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
