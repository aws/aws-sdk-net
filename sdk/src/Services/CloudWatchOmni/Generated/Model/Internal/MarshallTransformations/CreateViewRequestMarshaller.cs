...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    public class CreateViewRequestMarshaller : IMarshaller<IRequest, CreateViewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateViewRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/CreateView";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("definition");
                    context.Writer.WriteTextString(publicRequest.Definition);
                }
