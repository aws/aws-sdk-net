...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// RowScope Marshaller
    /// </summary>
    public class RowScopeMarshaller : IRequestMarshaller<RowScope, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RowScope requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("field");
                context.Writer.WriteTextString(requestObject.Field);
            }
        ...
        /// </summary>
        public readonly static RowScopeMarshaller Instance = new RowScopeMarshaller();
