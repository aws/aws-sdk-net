...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDomainsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListDomains");
            reader.ReadStartMap();
                    ...
                    case "items":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<DomainSummary, DomainSummaryUnmarshaller>(DomainSummaryUnmarshaller.Instance);
