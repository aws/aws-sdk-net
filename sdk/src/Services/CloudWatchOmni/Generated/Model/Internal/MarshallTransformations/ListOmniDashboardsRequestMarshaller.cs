...
{
    /// <summary>
    /// ListOmniDashboards Request Marshaller
    /// </summary>       
    public class ListOmniDashboardsRequestMarshaller : IMarshaller<IRequest, ListOmniDashboardsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListOmniDashboardsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListOmniDashboardsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/ListOmniDashboards";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("namePrefix");
                    context.Writer.WriteTextString(publicRequest.NamePrefix);
                }
        ...
        private static ListOmniDashboardsRequestMarshaller _instance = new ListOmniDashboardsRequestMarshaller();        

        internal static ListOmniDashboardsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOmniDashboardsRequestMarshaller Instance
        {
            get
            {
                return _instance;
