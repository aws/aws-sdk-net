...
{
    /// <summary>
    /// CreateOmniDashboard Request Marshaller
    /// </summary>       
    public class CreateOmniDashboardRequestMarshaller : IMarshaller<IRequest, CreateOmniDashboardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateOmniDashboardRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateOmniDashboardRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/CreateOmniDashboard";
        ...
        private static CreateOmniDashboardRequestMarshaller _instance = new CreateOmniDashboardRequestMarshaller();        

        internal static CreateOmniDashboardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOmniDashboardRequestMarshaller Instance
        {
            get
            {
                return _instance;
