...
{
    /// <summary>
    /// ListAlerts Request Marshaller
    /// </summary>       
    public class ListAlertsRequestMarshaller : IMarshaller<IRequest, ListAlertsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAlertsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAlertsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/ListAlerts";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("filterCriteria");
                    context.Writer.WriteStartMap(null);

                    var marshaller = AlertFilterCriteriaMarshaller.Instance;
        ...
        private static ListAlertsRequestMarshaller _instance = new ListAlertsRequestMarshaller();        

        internal static ListAlertsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAlertsRequestMarshaller Instance
        {
            get
            {
                return _instance;
