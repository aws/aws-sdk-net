...
{
    /// <summary>
    /// AccessGrantPrincipal Marshaller
    /// </summary>
    public class AccessGrantPrincipalMarshaller : IRequestMarshaller<AccessGrantPrincipal, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AccessGrantPrincipal requestObject, CborMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static AccessGrantPrincipalMarshaller Instance = new AccessGrantPrincipalMarshaller();
