...
{
    /// <summary>
    /// UpdateOmniDashboard Request Marshaller
    /// </summary>       
    public class UpdateOmniDashboardRequestMarshaller : IMarshaller<IRequest, UpdateOmniDashboardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateOmniDashboardRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateOmniDashboardRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/UpdateOmniDashboard";
            ...
            try
            {
                ...
                if (publicRequest.IsSetBody())
                {
                    ...
                    context.Writer.WriteTextString(publicRequest.Body);
                }
        ...
        private static UpdateOmniDashboardRequestMarshaller _instance = new UpdateOmniDashboardRequestMarshaller();        

        internal static UpdateOmniDashboardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateOmniDashboardRequestMarshaller Instance
        {
            get
            {
                return _instance;
