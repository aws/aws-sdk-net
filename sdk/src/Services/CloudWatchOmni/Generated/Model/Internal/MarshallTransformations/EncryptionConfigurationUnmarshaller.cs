...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EncryptionConfigurationUnmarshaller : ICborUnmarshaller<EncryptionConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EncryptionConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "encryptionStrategy":
                        {
                            context.AddPathSegment("EncryptionStrategy");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.EncryptionStrategy = unmarshaller.Unmarshall(context);
