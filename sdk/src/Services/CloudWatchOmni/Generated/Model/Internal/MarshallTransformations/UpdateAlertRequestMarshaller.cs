...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateAlertRequestMarshaller : IMarshaller<IRequest, UpdateAlertRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateAlertRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/UpdateAlert";
            ...
            try
            {
                ...
                if (publicRequest.IsSetAlertId())
                {
                    context.Writer.WriteTextString("alertId");
                    context.Writer.WriteTextString(publicRequest.AlertId);
                }
