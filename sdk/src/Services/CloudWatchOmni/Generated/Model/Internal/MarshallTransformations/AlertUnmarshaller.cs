...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlertUnmarshaller : ICborUnmarshaller<Alert, CborUnmarshallerContext>
    {
        /// <summary>
                    ...
                    case "notificationRules":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<NotificationRule, NotificationRuleUnmarshaller>(NotificationRuleUnmarshaller.Instance);
                            unmarshalledObject.NotificationRules = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
