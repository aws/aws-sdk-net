...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FieldUnmarshaller : ICborUnmarshaller<Field, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Field Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "children":
                        {
                            context.AddPathSegment("Children");
                            var unmarshaller = new CborListUnmarshaller<Field, FieldUnmarshaller>(FieldUnmarshaller.Instance);
