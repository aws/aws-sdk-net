...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListTelemetryFieldsRequestMarshaller : IMarshaller<IRequest, ListTelemetryFieldsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListTelemetryFieldsRequestMarshaller _instance = new ListTelemetryFieldsRequestMarshaller();        

        internal static ListTelemetryFieldsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTelemetryFieldsRequestMarshaller Instance
        {
            get
            {
                return _instance;
