...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdentityProviderConfigurationUnmarshaller : ICborUnmarshaller<IdentityProviderConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentityProviderConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "identityCenterConfiguration":
                        {
                            context.AddPathSegment("IdentityCenterConfiguration");
