...
{
    /// <summary>
    /// CreateAccessProfile Request Marshaller
    /// </summary>       
    public class CreateAccessProfileRequestMarshaller : IMarshaller<IRequest, CreateAccessProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccessProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccessProfileRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/CreateAccessProfile";
        ...
        private static CreateAccessProfileRequestMarshaller _instance = new CreateAccessProfileRequestMarshaller();        

        internal static CreateAccessProfileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
