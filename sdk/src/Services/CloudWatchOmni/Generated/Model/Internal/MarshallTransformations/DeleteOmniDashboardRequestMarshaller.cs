...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteOmniDashboardRequestMarshaller : IMarshaller<IRequest, DeleteOmniDashboardRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteOmniDashboardRequestMarshaller _instance = new DeleteOmniDashboardRequestMarshaller();        

        internal static DeleteOmniDashboardRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOmniDashboardRequestMarshaller Instance
        {
            get
            {
                return _instance;
