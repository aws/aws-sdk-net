...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsCredentialsUnmarshaller : ICborUnmarshaller<AwsCredentials, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsCredentials Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "accessKeyId":
                        {
                            context.AddPathSegment("AccessKeyId");
                    ...
                    case "secretAccessKey":
                        {
                            context.AddPathSegment("SecretAccessKey");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "sessionToken":
                        {
                            context.AddPathSegment("SessionToken");
                            var unmarshaller = CborStringUnmarshaller.Instance;
