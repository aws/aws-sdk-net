...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    public class CreateSpaceRequestMarshaller : IMarshaller<IRequest, CreateSpaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateSpaceRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/CreateSpace";
            ...
            try
            {
                ...
                if (publicRequest.IsSetAgentCoreEvaluationRoleArn())
                {
                    context.Writer.WriteTextString("agentCoreEvaluationRoleArn");
                    context.Writer.WriteTextString(publicRequest.AgentCoreEvaluationRoleArn);
                }
