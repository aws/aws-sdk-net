...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetViewResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetView");
            reader.ReadStartMap();
        ...
        internal static GetViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
