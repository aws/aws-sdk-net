...
{
    /// <summary>
    /// ListDomainAccessGrantsForOrganization Request Marshaller
    /// </summary>       
    public class ListDomainAccessGrantsForOrganizationRequestMarshaller : IMarshaller<IRequest, ListDomainAccessGrantsForOrganizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDomainAccessGrantsForOrganizationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDomainAccessGrantsForOrganizationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/ListDomainAccessGrantsForOrganization";
            ...
            try
            {
                ...
                if (publicRequest.IsSetPrincipalId())
                {
                    ...
                    context.Writer.WriteTextString(publicRequest.PrincipalId);
                }
                if (publicRequest.IsSetPrincipalType())
                {
                    context.Writer.WriteTextString("principalType");
                    context.Writer.WriteTextString(publicRequest.PrincipalType);
                }
                writer.WriteEndMap();
#if !NETFRAMEWORK
        ...
        private static ListDomainAccessGrantsForOrganizationRequestMarshaller _instance = new ListDomainAccessGrantsForOrganizationRequestMarshaller();        

        internal static ListDomainAccessGrantsForOrganizationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDomainAccessGrantsForOrganizationRequestMarshaller Instance
        {
            get
            {
                return _instance;
