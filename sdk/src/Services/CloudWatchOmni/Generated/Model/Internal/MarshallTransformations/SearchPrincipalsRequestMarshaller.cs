...
{
    /// <summary>
    /// SearchPrincipals Request Marshaller
    /// </summary>       
    public class SearchPrincipalsRequestMarshaller : IMarshaller<IRequest, SearchPrincipalsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchPrincipalsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchPrincipalsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchOmni");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/SearchPrincipals";
        ...
        private static SearchPrincipalsRequestMarshaller _instance = new SearchPrincipalsRequestMarshaller();        

        internal static SearchPrincipalsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchPrincipalsRequestMarshaller Instance
        {
            get
            {
                return _instance;
