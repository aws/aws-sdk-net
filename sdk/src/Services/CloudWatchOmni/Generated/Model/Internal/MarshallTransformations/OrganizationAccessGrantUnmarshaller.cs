...
{
    /// <summary>
    /// Response Unmarshaller for OrganizationAccessGrant Object
    /// </summary>  
    public class OrganizationAccessGrantUnmarshaller : ICborUnmarshaller<OrganizationAccessGrant, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public OrganizationAccessGrant Unmarshall(CborUnmarshallerContext context)
        {
            OrganizationAccessGrant unmarshalledObject = new OrganizationAccessGrant();
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "createdBy":
                        {
                            context.AddPathSegment("CreatedBy");
        ...
        private static OrganizationAccessGrantUnmarshaller _instance = new OrganizationAccessGrantUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OrganizationAccessGrantUnmarshaller Instance
        {
            get
            {
                return _instance;
