...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateIntegrationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("UpdateIntegration");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "integration":
                        {
                            context.AddPathSegment("Integration");
                            var unmarshaller = IntegrationUnmarshaller.Instance;
                            response.Integration = unmarshaller.Unmarshall(context);
