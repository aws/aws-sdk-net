...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateDomainRequestMarshaller : IMarshaller<IRequest, UpdateDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateDomainRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/UpdateDomain";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("identityProviderConfiguration");
                ...
                if (publicRequest.IsSetIdentityProviders())
                {
                    context.Writer.WriteTextString("identityProviders");
                    context.Writer.WriteStartArray(publicRequest.IdentityProviders.Count);
                    foreach(var publicRequestIdentityProvidersListValue in publicRequest.IdentityProviders)
                    {
                            context.Writer.WriteTextString(publicRequestIdentityProvidersListValue);
                    }
