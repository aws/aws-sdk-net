...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SessionSummaryUnmarshaller : ICborUnmarshaller<SessionSummary, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public SessionSummary Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "lastActivityAt":
                        {
                            context.AddPathSegment("LastActivityAt");
                            var unmarshaller = CborNullableDateTimeUnmarshaller.Instance;
                            unmarshalledObject.LastActivityAt = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "sessionId":
                    ...
                    case "sessionName":
                        {
                            context.AddPathSegment("SessionName");
                            var unmarshaller = CborStringUnmarshaller.Instance;
