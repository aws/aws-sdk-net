...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccessGrantSummaryUnmarshaller : ICborUnmarshaller<AccessGrantSummary, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            AccessGrantSummary unmarshalledObject = new AccessGrantSummary();
                    ...
                    case "principal":
                        {
                            ...
                            var unmarshaller = AccessGrantPrincipalUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AccessGrantSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
