...
{
    /// <summary>
    /// Response Unmarshaller for OrganizationAccessGrantPrincipal Object
    /// </summary>  
    public class OrganizationAccessGrantPrincipalUnmarshaller : ICborUnmarshaller<OrganizationAccessGrantPrincipal, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public OrganizationAccessGrantPrincipal Unmarshall(CborUnmarshallerContext context)
        {
            OrganizationAccessGrantPrincipal unmarshalledObject = new OrganizationAccessGrantPrincipal();
        ...
        private static OrganizationAccessGrantPrincipalUnmarshaller _instance = new OrganizationAccessGrantPrincipalUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OrganizationAccessGrantPrincipalUnmarshaller Instance
        {
            get
            {
                return _instance;
