...
namespace Amazon.CloudWatchOmni.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAccessGrantRequestMarshaller : IMarshaller<IRequest, CreateAccessGrantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateAccessGrantRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/CloudWatchOmniFrontend/operation/CreateAccessGrant";
            ...
            try
            {
                ...
                if (publicRequest.IsSetPrincipal())
                {
                    ...
                    var marshaller = AccessGrantPrincipalMarshaller.Instance;
                    marshaller.Marshall(publicRequest.Principal, context);

                    context.Writer.WriteEndMap();
                }
                if (publicRequest.IsSetScopedActions())
                {
                    context.Writer.WriteTextString("scopedActions");
                    context.Writer.WriteStartArray(publicRequest.ScopedActions.Count);
                    foreach(var publicRequestScopedActionsListValue in publicRequest.ScopedActions)
                    {
                        context.Writer.WriteStartMap(null);

                        var marshaller = ScopedActionsMarshaller.Instance;
                        marshaller.Marshall(publicRequestScopedActionsListValue, context);
