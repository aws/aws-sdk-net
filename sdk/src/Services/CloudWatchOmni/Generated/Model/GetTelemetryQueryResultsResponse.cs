...
{
    /// <summary>
    /// This is the response object from the GetTelemetryQueryResults operation.
    /// </summary>
    public partial class GetTelemetryQueryResultsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<Dictionary<string, string>> _rows = AWSConfigs.InitializeCollections ? new List<Dictionary<string, string>>() : null;
