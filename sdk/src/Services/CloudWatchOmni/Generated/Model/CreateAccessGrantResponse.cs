...
namespace Amazon.CloudWatchOmni.Model
{
    ...
    public partial class CreateAccessGrantResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property AccessGrant. 
        /// <para>
        ...
        {
            get { return this._accessGrant; }
            set { this._accessGrant = value; }
        }

        // Check to see if AccessGrant property is set
        internal bool IsSetAccessGrant()
        {
            return this._accessGrant != null;
        }
