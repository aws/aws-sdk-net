...
{
    /// <summary>
    /// Container for the parameters to the GetDomainAccessGrantForOrganization operation.
    /// Retrieves the full detail of a single organization access grant by ID.
    /// </summary>
    public partial class GetDomainAccessGrantForOrganizationRequest : AmazonCloudWatchOmniRequest
    {
