...
{
    /// <summary>
    /// Container for the parameters to the ListOmniDashboards operation.
    /// Returns the dashboards in a space, optionally filtered by name prefix.
    /// </summary>
    public partial class ListOmniDashboardsRequest : AmazonCloudWatchOmniRequest
    {
        ...
        /// <para>
        /// The maximum number of dashboards to return per page. Defaults to 100. A page can contain
