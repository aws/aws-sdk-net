...
namespace Amazon.CloudWatchOmni.Internal
{
    ...
    public class AmazonCloudWatchOmniAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudWatchOmniAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudWatchOmni.
        /// </summary>
        public AmazonCloudWatchOmniAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudWatchOmniAuthSchemeParameters
            {
    ...
    public class AmazonCloudWatchOmniAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudWatchOmniAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudWatchOmniAuthSchemeParameters authParameters)
        {
