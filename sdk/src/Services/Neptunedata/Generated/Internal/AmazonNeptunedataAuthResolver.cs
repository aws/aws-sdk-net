...
namespace Amazon.Neptunedata.Internal
{
    ...
    public class AmazonNeptunedataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNeptunedataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Neptunedata.
        /// </summary>
        public AmazonNeptunedataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNeptunedataAuthSchemeParameters
            {
    ...
    public class AmazonNeptunedataAuthSchemeResolver : IAuthSchemeResolver<AmazonNeptunedataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNeptunedataAuthSchemeParameters authParameters)
        {
