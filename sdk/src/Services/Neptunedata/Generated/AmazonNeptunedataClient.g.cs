...
namespace Amazon.Neptunedata
{
    ...
    public partial class AmazonNeptunedataClient : AmazonServiceClient, IAmazonNeptunedata
    {
        ...
        /// 
        /// </summary>
        public AmazonNeptunedataClient() : base(new AmazonNeptunedataConfig()) { }
        ...
        public AmazonNeptunedataClient(RegionEndpoint region) : base(new AmazonNeptunedataConfig { RegionEndpoint = region }) { }
        ...
        public AmazonNeptunedataClient(AmazonNeptunedataConfig config) : base(config) { }
