...
{
    /// <summary>
    /// Container for the parameters to the GetOpenCypherQueryStatus operation. Retrieves
    /// the status of a specified openCypher query. <para> When invoking this operation in
