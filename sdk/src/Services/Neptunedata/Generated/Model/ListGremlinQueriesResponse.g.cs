...
namespace Amazon.Neptunedata.Model
{
    ...
    public partial class ListGremlinQueriesResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public int? AcceptedQueryCount { get; set; }

        /// <summary>
        /// Checks to see if the AcceptedQueryCount property is set.
        /// </summary>
        internal bool IsSetAcceptedQueryCount() => this.AcceptedQueryCount.HasValue;
        ...
        /// </summary>
        public List<GremlinQueryStatus> Queries { get; set; } = AWSConfigs.InitializeCollections ? new List<GremlinQueryStatus>() : null;
        ...
        /// </para>
        /// </summary>
        public int? RunningQueryCount { get; set; }

        /// <summary>
        /// Checks to see if the RunningQueryCount property is set.
        /// </summary>
        internal bool IsSetRunningQueryCount() => this.RunningQueryCount.HasValue;
    }
}
