...
{
    /// <summary>
    /// Container for the parameters to the ListGremlinQueries operation. Lists active Gremlin
    /// queries. See <a href="https://docs.aws.amazon.com/neptune/latest/userguide/gremlin-api-status.html">Gremlin
    /// query status API</a> for details about the output. <para> When invoking this operation
    /// in a Neptune cluster that has IAM authentication enabled, the IAM user or role making
    /// the request must have a policy attached that allows the <a href="https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getquerystatus">neptune-db:GetQueryStatus</a>
    ...
    public partial class ListGremlinQueriesRequest : AmazonNeptunedataRequest
    {
        ...
        /// <summary>
        /// Checks to see if the IncludeWaiting property is set.
        /// </summary>
        internal bool IsSetIncludeWaiting() => this.IncludeWaiting.HasValue;
    }
}
