...
namespace Amazon.Neptunedata.Model
{
    ...
    [Serializable]
#endif
    public partial class InvalidArgumentException : AmazonNeptunedataException
    {
        /// <summary>
        ...
        /// Construct instance of InvalidArgumentException
        /// </summary>
        public InvalidArgumentException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InvalidArgumentException
        /// </summary>
        public InvalidArgumentException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidArgumentException
        /// </summary>
        public InvalidArgumentException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
