...
{
    /// <summary>
    /// Container for the parameters to the GetGremlinQueryStatus operation. Gets the status
    /// of a specified Gremlin query. <para> When invoking this operation in a Neptune cluster
