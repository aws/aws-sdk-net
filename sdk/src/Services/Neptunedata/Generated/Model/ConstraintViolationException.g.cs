...
namespace Amazon.Neptunedata.Model
{
    ...
    public partial class ConstraintViolationException : AmazonNeptunedataException
    {
        ...
        /// Construct instance of ConstraintViolationException
        /// </summary>
        public ConstraintViolationException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ConstraintViolationException
        /// </summary>
        public ConstraintViolationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ConstraintViolationException
        /// </summary>
        public ConstraintViolationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
