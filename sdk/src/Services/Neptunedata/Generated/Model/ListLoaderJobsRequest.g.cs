...
{
    /// <summary>
    /// Container for the parameters to the ListLoaderJobs operation. Retrieves a list of
    /// the <c>loadIds</c> for all active loader jobs. <para> When invoking this operation
    /// in a Neptune cluster that has IAM authentication enabled, the IAM user or role making
    /// the request must have a policy attached that allows the <a href="https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#listloaderjobs">neptune-db:ListLoaderJobs</a>
    ...
    public partial class ListLoaderJobsRequest : AmazonNeptunedataRequest
    {
        ...
        /// <summary>
        /// Checks to see if the IncludeQueuedLoads property is set.
        /// </summary>
        internal bool IsSetIncludeQueuedLoads() => this.IncludeQueuedLoads.HasValue;
