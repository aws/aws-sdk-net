...
{
    /// <summary>
    /// Container for the parameters to the GetPropertygraphSummary operation. Gets a graph
    /// summary for a property graph. <para> When invoking this operation in a Neptune cluster
    /// that has IAM authentication enabled, the IAM user or role making the request must
    ...
    public partial class GetPropertygraphSummaryRequest : AmazonNeptunedataRequest
    {
        ...
        /// </para>
        /// </summary>
        public GraphSummaryType Mode { get; set; }
