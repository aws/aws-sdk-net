...
namespace Amazon.Neptunedata.Model
{
    ...
    [Serializable]
    #endif
    public partial class ClientTimeoutException : AmazonNeptunedataException
    {
        ...
        /// <summary>
        /// Construct instance of ClientTimeoutException
        /// </summary>
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public ClientTimeoutException(Exception innerException) 
            : base(innerException) {}
        ...
        public ClientTimeoutException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ClientTimeoutException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
            : base(message, errorType, errorCode, requestId, statusCode) {}


#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the ClientTimeoutException class with serialized data.
        /// </summary>
