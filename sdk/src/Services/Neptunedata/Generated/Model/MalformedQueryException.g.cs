...
namespace Amazon.Neptunedata.Model
{
    ...
    [Serializable]
#endif
    public partial class MalformedQueryException : AmazonNeptunedataException
    {
        /// <summary>
        /// Default constructor for MalformedQueryException
        /// message.
        /// </summary>
        public MalformedQueryException() : base() { }
        ...
        /// Construct instance of MalformedQueryException
        /// </summary>
        public MalformedQueryException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of MalformedQueryException
        /// </summary>
        public MalformedQueryException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of MalformedQueryException
        /// </summary>
        public MalformedQueryException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
        ...
        /// <summary>
        /// Checks to see if the DetailedMessage property is set.
        /// </summary>
        internal bool IsSetDetailedMessage() => this.DetailedMessage != null;
