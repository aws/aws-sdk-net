...
namespace Amazon.Neptunedata.Model
{
    ...
    [Serializable]
#endif
    public partial class IllegalArgumentException : AmazonNeptunedataException
    {
        /// <summary>
        ...
        /// Construct instance of IllegalArgumentException
        /// </summary>
        public IllegalArgumentException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of IllegalArgumentException
        /// </summary>
        public IllegalArgumentException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of IllegalArgumentException
        /// </summary>
        public IllegalArgumentException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
