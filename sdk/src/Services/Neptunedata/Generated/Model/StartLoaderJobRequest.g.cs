...
{
    /// <summary>
    /// Container for the parameters to the StartLoaderJob operation. Starts a Neptune bulk
    /// loader job to load data from an Amazon S3 bucket into a Neptune DB instance. See <a
    /// href="https://docs.aws.amazon.com/neptune/latest/userguide/bulk-load.html">Using the
    /// Amazon Neptune Bulk Loader to Ingest Data</a>. <para> When invoking this operation
    /// in a Neptune cluster that has IAM authentication enabled, the IAM user or role making
    /// the request must have a policy attached that allows the <a href="https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#startloaderjob">neptune-db:StartLoaderJob</a>
    ...
    public partial class StartLoaderJobRequest : AmazonNeptunedataRequest
    {
        ...
        /// </summary>
        public List<string> Dependencies { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Checks to see if the EdgeOnlyLoad property is set.
        /// </summary>
        internal bool IsSetEdgeOnlyLoad() => this.EdgeOnlyLoad.HasValue;
        ...
        ///  </li> <li> 
        /// <para>
        ///  <c>HIGH</c> – The number of threads used is the same as the number of available vCPUs.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ...
        /// <summary>
        /// Checks to see if the Parallelism property is set.
        /// </summary>
        internal bool IsSetParallelism() => this.Parallelism != null;

        /// <summary>
        /// Gets and sets the property ParserConfiguration. 
        /// <para>
        ///  <b> <c>parserConfiguration</c> </b> – An optional object with additional parser configuration
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public Dictionary<string, string> ParserConfiguration { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the ParserConfiguration property is set.
        /// </summary>
        internal bool IsSetParserConfiguration() => this.ParserConfiguration != null && (this.ParserConfiguration.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the QueueRequest property is set.
        /// </summary>
        internal bool IsSetQueueRequest() => this.QueueRequest.HasValue;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public S3BucketRegion S3BucketRegion { get; set; }

        /// <summary>
        /// Checks to see if the S3BucketRegion property is set.
        /// </summary>
        internal bool IsSetS3BucketRegion() => this.S3BucketRegion != null;
        ...
        /// <summary>
        /// Checks to see if the UpdateSingleCardinalityProperties property is set.
        /// </summary>
        internal bool IsSetUpdateSingleCardinalityProperties() => this.UpdateSingleCardinalityProperties.HasValue;
        ...
        /// <summary>
        /// Checks to see if the UserProvidedEdgeIds property is set.
        /// </summary>
        internal bool IsSetUserProvidedEdgeIds() => this.UserProvidedEdgeIds.HasValue;
    }
}
