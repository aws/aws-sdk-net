...
namespace Amazon.Neptunedata.Model
{
    ...
    public partial class ClientTimeoutException : AmazonNeptunedataException
    {
        ...
        /// Construct instance of ClientTimeoutException
        /// </summary>
        public ClientTimeoutException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ClientTimeoutException
        /// </summary>
        public ClientTimeoutException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ClientTimeoutException
        /// </summary>
        public ClientTimeoutException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
