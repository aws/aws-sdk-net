...
namespace Amazon.Neptunedata.Model
{
    ...
    public partial class ExecuteGremlinQueryResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public Amazon.Runtime.Documents.Document Meta { get; set; }

        /// <summary>
        /// Checks to see if the Meta property is set.
        /// </summary>
        internal bool IsSetMeta() => !this.Meta.IsNull();
        ...
        /// </para>
        /// </summary>
        public Amazon.Runtime.Documents.Document Result { get; set; }

        /// <summary>
        /// Checks to see if the Result property is set.
        /// </summary>
        internal bool IsSetResult() => !this.Result.IsNull();
        ...
        /// </para>
        /// </summary>
        public GremlinQueryStatusAttributes Status { get; set; }
