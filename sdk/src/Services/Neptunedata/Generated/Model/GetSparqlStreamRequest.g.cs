...
{
    /// <summary>
    /// Container for the parameters to the GetSparqlStream operation. Gets a stream for an
    /// RDF graph. <para> With the Neptune Streams feature, you can generate a complete sequence
    /// of change-log entries that record every change made to your graph data as it happens.
    /// <c>GetSparqlStream</c> lets you collect these change-log entries for an RDF graph.
    /// </para> <para> The Neptune streams feature needs to be enabled on your Neptune DBcluster.
    /// To enable streams, set the <a href="https://docs.aws.amazon.com/neptune/latest/userguide/parameters.html#parameters-db-cluster-parameters-neptune_streams">neptune_streams</a>
    ...
    /// IAM action in that cluster. </para> <para> Note that the <a href="https://docs.aws.amazon.com/neptune/latest/userguide/iam-data-condition-keys.html#iam-neptune-condition-keys">neptune-db:QueryLanguage:Sparql</a>
