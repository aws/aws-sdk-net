...
namespace Amazon.Neptunedata.Model
{
    ...
    public partial class MemoryLimitExceededException : AmazonNeptunedataException
    {
        ...
        /// Construct instance of MemoryLimitExceededException
        /// </summary>
        public MemoryLimitExceededException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of MemoryLimitExceededException
        /// </summary>
        public MemoryLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of MemoryLimitExceededException
        /// </summary>
        public MemoryLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
