...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMLModelTrainingJobsRequestMarshaller : IMarshaller<IRequest, ListMLModelTrainingJobsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListMLModelTrainingJobsRequestMarshaller _instance = new();

        internal static ListMLModelTrainingJobsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMLModelTrainingJobsRequestMarshaller Instance => _instance;
    }
}
