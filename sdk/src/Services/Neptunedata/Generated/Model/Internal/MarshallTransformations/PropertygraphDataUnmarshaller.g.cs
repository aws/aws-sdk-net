...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PropertygraphDataUnmarshaller : IJsonUnmarshaller<PropertygraphData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PropertygraphData();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PropertygraphDataUnmarshaller Instance => _instance;
    }
}
