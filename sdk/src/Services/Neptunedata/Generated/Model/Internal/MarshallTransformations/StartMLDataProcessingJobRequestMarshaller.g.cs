...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartMLDataProcessingJobRequestMarshaller : IMarshaller<IRequest, StartMLDataProcessingJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartMLDataProcessingJobRequestMarshaller _instance = new();

        internal static StartMLDataProcessingJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartMLDataProcessingJobRequestMarshaller Instance => _instance;
    }
}
