...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ManageSparqlStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ManageSparqlStatisticsResponse();
        ...
        internal static ManageSparqlStatisticsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ManageSparqlStatisticsResponseUnmarshaller Instance => _instance;
    }
}
