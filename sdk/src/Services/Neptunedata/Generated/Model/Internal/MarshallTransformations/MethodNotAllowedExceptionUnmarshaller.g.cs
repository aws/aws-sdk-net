...
{
    /// <summary>
    /// Exception Unmarshaller for MethodNotAllowedException
    /// </summary>
    public partial class MethodNotAllowedExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<MethodNotAllowedException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MethodNotAllowedException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static MethodNotAllowedExceptionUnmarshaller Instance => _instance;
    }
}
