...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExecuteGremlinQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExecuteGremlinQueryResponse();
            ...
            {
                if (context.TestExpression("meta", targetDepth, ref reader))
                {
                    var unmarshaller = Amazon.Runtime.Documents.Internal.Transform.DocumentUnmarshaller.Instance;
                    unmarshalledObject.Meta = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ExecuteGremlinQueryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ExecuteGremlinQueryResponseUnmarshaller Instance => _instance;
    }
}
