...
{
    /// <summary>
    /// Response Unmarshaller for ListMLDataProcessingJobs operation
    /// </summary>  
    public class ListMLDataProcessingJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMLDataProcessingJobsResponse response = new ListMLDataProcessingJobsResponse();
            ...
            {
                if (context.TestExpression("ids", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.Ids = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListMLDataProcessingJobsResponseUnmarshaller _instance = new ListMLDataProcessingJobsResponseUnmarshaller();        

        internal static ListMLDataProcessingJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMLDataProcessingJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
