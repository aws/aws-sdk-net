...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RDFGraphSummaryValueMapUnmarshaller : IJsonUnmarshaller<RDFGraphSummaryValueMap, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RDFGraphSummaryValueMap Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RDFGraphSummaryValueMap();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RDFGraphSummaryValueMapUnmarshaller Instance => _instance;
    }
}
