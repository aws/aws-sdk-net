...
{
    /// <summary>
    /// Response Unmarshaller for CancelOpenCypherQuery operation
    /// </summary>  
    public class CancelOpenCypherQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelOpenCypherQueryResponse response = new CancelOpenCypherQueryResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidNumericDataException"))
                {
                    return InvalidNumericDataExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CancelOpenCypherQueryResponseUnmarshaller _instance = new CancelOpenCypherQueryResponseUnmarshaller();        

        internal static CancelOpenCypherQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelOpenCypherQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
