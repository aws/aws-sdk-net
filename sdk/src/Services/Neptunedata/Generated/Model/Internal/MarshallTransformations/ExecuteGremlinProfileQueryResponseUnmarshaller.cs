...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecuteGremlinProfileQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExecuteGremlinProfileQueryResponse response = new ExecuteGremlinProfileQueryResponse();
        ...
        internal static ExecuteGremlinProfileQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteGremlinProfileQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
