...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExecuteGremlinExplainQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExecuteGremlinExplainQueryResponse();
        ...
        internal static ExecuteGremlinExplainQueryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ExecuteGremlinExplainQueryResponseUnmarshaller Instance => _instance;
    }
}
