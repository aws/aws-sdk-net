...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartMLDataProcessingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMLDataProcessingJobResponse response = new StartMLDataProcessingJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("creationTimeInMillis", targetDepth))
                {
                    ...
                    response.CreationTimeInMillis = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static StartMLDataProcessingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMLDataProcessingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
