...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMLModelTrainingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetMLModelTrainingJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("hpoJob", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.HpoJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("mlModels", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MlModels = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                    unmarshalledObject.ModelTransformJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetMLModelTrainingJobResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMLModelTrainingJobResponseUnmarshaller Instance => _instance;
    }
}
