...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RDFGraphSummaryUnmarshaller : IJsonUnmarshaller<RDFGraphSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RDFGraphSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RDFGraphSummaryUnmarshaller Instance => _instance;
    }
}
