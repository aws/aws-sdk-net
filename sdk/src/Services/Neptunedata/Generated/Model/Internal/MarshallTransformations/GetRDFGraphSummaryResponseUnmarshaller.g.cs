...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetRDFGraphSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetRDFGraphSummaryResponse();
        ...
        internal static GetRDFGraphSummaryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRDFGraphSummaryResponseUnmarshaller Instance => _instance;
    }
}
