        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("hpoJob", targetDepth))
                {
                    ...
                    response.HpoJob = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MlConfigDefinition, MlConfigDefinitionUnmarshaller>(MlConfigDefinitionUnmarshaller.Instance);
                    response.MlModels = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("modelTransformJob", targetDepth))
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                    response.ModelTransformJob = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("processingJob", targetDepth))
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                    response.ProcessingJob = unmarshaller.Unmarshall(context);
                    continue;
                }
