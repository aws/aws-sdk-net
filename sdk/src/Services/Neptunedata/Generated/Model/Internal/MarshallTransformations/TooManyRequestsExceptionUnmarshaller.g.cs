...
{
    /// <summary>
    /// Exception Unmarshaller for TooManyRequestsException
    /// </summary>
    public partial class TooManyRequestsExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<TooManyRequestsException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TooManyRequestsException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static TooManyRequestsExceptionUnmarshaller Instance => _instance;
    }
}
