...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartMLModelTransformJobRequestMarshaller : IMarshaller<IRequest, StartMLModelTransformJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartMLModelTransformJobRequestMarshaller _instance = new();

        internal static StartMLModelTransformJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartMLModelTransformJobRequestMarshaller Instance => _instance;
    }
}
