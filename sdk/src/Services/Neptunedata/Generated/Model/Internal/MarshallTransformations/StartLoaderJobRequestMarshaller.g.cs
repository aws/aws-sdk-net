...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartLoaderJobRequestMarshaller : IMarshaller<IRequest, StartLoaderJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(StartLoaderJobRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetEdgeOnlyLoad())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.EdgeOnlyLoad.Value);
            }
        ...
        private static readonly StartLoaderJobRequestMarshaller _instance = new();

        internal static StartLoaderJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartLoaderJobRequestMarshaller Instance => _instance;
    }
}
