...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetOpenCypherQueryStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetOpenCypherQueryStatusResponse();
        ...
        internal static GetOpenCypherQueryStatusResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetOpenCypherQueryStatusResponseUnmarshaller Instance => _instance;
    }
}
