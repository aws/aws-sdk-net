...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NodeStructureUnmarshaller : IJsonUnmarshaller<NodeStructure, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new NodeStructure();
        ...
        /// Gets the singleton.
        /// </summary>
        public static NodeStructureUnmarshaller Instance => _instance;
    }
}
