...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CancelOpenCypherQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CancelOpenCypherQueryResponse();
        ...
        internal static CancelOpenCypherQueryResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelOpenCypherQueryResponseUnmarshaller Instance => _instance;
    }
}
