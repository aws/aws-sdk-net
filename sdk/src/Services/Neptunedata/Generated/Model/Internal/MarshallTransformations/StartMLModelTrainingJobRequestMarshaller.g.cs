...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartMLModelTrainingJobRequestMarshaller : IMarshaller<IRequest, StartMLModelTrainingJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartMLModelTrainingJobRequestMarshaller _instance = new();

        internal static StartMLModelTrainingJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartMLModelTrainingJobRequestMarshaller Instance => _instance;
    }
}
