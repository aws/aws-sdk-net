...
{
    /// <summary>
    /// Response Unmarshaller for GetSparqlStatistics operation
    /// </summary>  
    public class GetSparqlStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSparqlStatisticsResponse response = new GetSparqlStatisticsResponse();
        ...
        private static GetSparqlStatisticsResponseUnmarshaller _instance = new GetSparqlStatisticsResponseUnmarshaller();        

        internal static GetSparqlStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSparqlStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
