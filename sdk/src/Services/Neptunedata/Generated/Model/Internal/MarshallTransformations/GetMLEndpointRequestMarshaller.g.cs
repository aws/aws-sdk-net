...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetMLEndpointRequestMarshaller : IMarshaller<IRequest, GetMLEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetMLEndpointRequestMarshaller _instance = new();

        internal static GetMLEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMLEndpointRequestMarshaller Instance => _instance;
    }
}
