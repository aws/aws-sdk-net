...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExecuteOpenCypherExplainQueryRequestMarshaller : IMarshaller<IRequest, ExecuteOpenCypherExplainQueryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ExecuteOpenCypherExplainQueryRequestMarshaller _instance = new();

        internal static ExecuteOpenCypherExplainQueryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ExecuteOpenCypherExplainQueryRequestMarshaller Instance => _instance;
    }
}
