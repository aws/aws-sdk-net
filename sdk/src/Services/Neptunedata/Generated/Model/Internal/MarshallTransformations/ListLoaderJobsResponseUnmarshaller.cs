...
{
    /// <summary>
    /// Response Unmarshaller for ListLoaderJobs operation
    /// </summary>  
    public class ListLoaderJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLoaderJobsResponse response = new ListLoaderJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LoaderIdResultUnmarshaller.Instance;
        ...
        private static ListLoaderJobsResponseUnmarshaller _instance = new ListLoaderJobsResponseUnmarshaller();        

        internal static ListLoaderJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLoaderJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
