...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MlResourceDefinitionUnmarshaller : IJsonUnmarshaller<MlResourceDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MlResourceDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("cloudwatchLogUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CloudwatchLogUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
