...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetGremlinQueryStatusRequestMarshaller : IMarshaller<IRequest, GetGremlinQueryStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetGremlinQueryStatusRequestMarshaller _instance = new GetGremlinQueryStatusRequestMarshaller();        

        internal static GetGremlinQueryStatusRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGremlinQueryStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
