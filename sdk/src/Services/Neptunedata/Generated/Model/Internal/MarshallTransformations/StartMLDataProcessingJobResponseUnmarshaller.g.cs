...
{
    /// <summary>
    /// Response Unmarshaller for StartMLDataProcessingJob operation.
    /// </summary>
    public partial class StartMLDataProcessingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StartMLDataProcessingJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("creationTimeInMillis", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.CreationTimeInMillis = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartMLDataProcessingJobResponseUnmarshaller _instance = new StartMLDataProcessingJobResponseUnmarshaller();

        internal static StartMLDataProcessingJobResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartMLDataProcessingJobResponseUnmarshaller Instance => _instance;
    }
}
