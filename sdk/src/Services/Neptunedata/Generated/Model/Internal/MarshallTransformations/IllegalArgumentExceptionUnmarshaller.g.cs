...
{
    /// <summary>
    /// Exception Unmarshaller for IllegalArgumentException
    /// </summary>
    public partial class IllegalArgumentExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<IllegalArgumentException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IllegalArgumentException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static IllegalArgumentExceptionUnmarshaller Instance => _instance;
    }
}
