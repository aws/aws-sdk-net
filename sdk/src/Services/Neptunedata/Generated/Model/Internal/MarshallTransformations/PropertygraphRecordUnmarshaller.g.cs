...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PropertygraphRecordUnmarshaller : IJsonUnmarshaller<PropertygraphRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PropertygraphRecord();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PropertygraphRecordUnmarshaller Instance => _instance;
    }
}
