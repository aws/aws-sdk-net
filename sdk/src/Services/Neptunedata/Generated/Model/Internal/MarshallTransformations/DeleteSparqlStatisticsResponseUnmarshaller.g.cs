...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteSparqlStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteSparqlStatisticsResponse();
        ...
        internal static DeleteSparqlStatisticsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSparqlStatisticsResponseUnmarshaller Instance => _instance;
    }
}
