...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMLEndpointRequestMarshaller : IMarshaller<IRequest, CreateMLEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateMLEndpointRequestMarshaller _instance = new();

        internal static CreateMLEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMLEndpointRequestMarshaller Instance => _instance;
    }
}
