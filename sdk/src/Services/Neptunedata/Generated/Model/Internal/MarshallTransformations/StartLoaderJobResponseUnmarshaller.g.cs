...
{
    /// <summary>
    /// Response Unmarshaller for StartLoaderJob operation.
    /// </summary>
    public partial class StartLoaderJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StartLoaderJobResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var streamCopy = new MemoryStream(responseBodyBytes))
            {
                using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
                {
                    ...
                    if (errorResponse.Code != null && errorResponse.Code.Equals("BulkLoadIdNotFoundException"))
                    {
                        return BulkLoadIdNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
                    ...
                    if (errorResponse.Code != null && errorResponse.Code.Equals("LoadUrlAccessDeniedException"))
                    {
                        return LoadUrlAccessDeniedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
                    ...
                    if (errorResponse.Code != null && errorResponse.Code.Equals("S3Exception"))
                    {
                        return S3ExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                    }
        ...
        private static StartLoaderJobResponseUnmarshaller _instance = new StartLoaderJobResponseUnmarshaller();

        internal static StartLoaderJobResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartLoaderJobResponseUnmarshaller Instance => _instance;
    }
}
