...
{
    /// <summary>
    /// Response Unmarshaller for GetMLEndpoint operation
    /// </summary>  
    public class GetMLEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLEndpointResponse response = new GetMLEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = MlConfigDefinitionUnmarshaller.Instance;
                    response.EndpointConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MLResourceNotFoundException"))
                {
                    return MLResourceNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetMLEndpointResponseUnmarshaller _instance = new GetMLEndpointResponseUnmarshaller();        

        internal static GetMLEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
