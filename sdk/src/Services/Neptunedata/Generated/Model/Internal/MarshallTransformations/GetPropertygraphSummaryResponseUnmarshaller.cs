    ...
    public class GetPropertygraphSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return ReadOnlyViolationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("StatisticsNotAvailableException"))
                {
                    return StatisticsNotAvailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
