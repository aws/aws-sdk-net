...
{
    /// <summary>
    /// Response Unmarshaller for GetPropertygraphSummary operation
    /// </summary>  
    public class GetPropertygraphSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPropertygraphSummaryResponse response = new GetPropertygraphSummaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = PropertygraphSummaryValueMapUnmarshaller.Instance;
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ReadOnlyViolationException"))
                {
                    return ReadOnlyViolationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("StatisticsNotAvailableException"))
                {
                    return StatisticsNotAvailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetPropertygraphSummaryResponseUnmarshaller _instance = new GetPropertygraphSummaryResponseUnmarshaller();        

        internal static GetPropertygraphSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPropertygraphSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
