...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListGremlinQueriesRequestMarshaller : IMarshaller<IRequest, ListGremlinQueriesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListGremlinQueriesRequestMarshaller _instance = new();

        internal static ListGremlinQueriesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListGremlinQueriesRequestMarshaller Instance => _instance;
    }
}
