...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PropertygraphSummaryValueMapUnmarshaller : IJsonUnmarshaller<PropertygraphSummaryValueMap, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PropertygraphSummaryValueMap Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
