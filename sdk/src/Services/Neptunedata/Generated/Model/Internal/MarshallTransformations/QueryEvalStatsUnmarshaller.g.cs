...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class QueryEvalStatsUnmarshaller : IJsonUnmarshaller<QueryEvalStats, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new QueryEvalStats();
        ...
        /// Gets the singleton.
        /// </summary>
        public static QueryEvalStatsUnmarshaller Instance => _instance;
    }
}
