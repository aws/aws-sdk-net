...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CancelMLModelTrainingJobRequestMarshaller : IMarshaller<IRequest, CancelMLModelTrainingJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CancelMLModelTrainingJobRequestMarshaller _instance = new();

        internal static CancelMLModelTrainingJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CancelMLModelTrainingJobRequestMarshaller Instance => _instance;
    }
}
