...
{
    /// <summary>
    /// Response Unmarshaller for GetMLModelTransformJob operation.
    /// </summary>
    public partial class GetMLModelTransformJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetMLModelTransformJobResponse();
            ...
            {
                if (context.TestExpression("baseProcessingJob", targetDepth, ref reader))
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                    unmarshalledObject.BaseProcessingJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("remoteModelTransformJob", targetDepth, ref reader))
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                    unmarshalledObject.RemoteModelTransformJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetMLModelTransformJobResponseUnmarshaller _instance = new GetMLModelTransformJobResponseUnmarshaller();

        internal static GetMLModelTransformJobResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMLModelTransformJobResponseUnmarshaller Instance => _instance;
    }
}
