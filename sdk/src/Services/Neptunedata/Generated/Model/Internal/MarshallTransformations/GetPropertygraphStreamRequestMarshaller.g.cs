...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetPropertygraphStreamRequestMarshaller : IMarshaller<IRequest, GetPropertygraphStreamRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetPropertygraphStreamRequestMarshaller _instance = new();

        internal static GetPropertygraphStreamRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPropertygraphStreamRequestMarshaller Instance => _instance;
    }
}
