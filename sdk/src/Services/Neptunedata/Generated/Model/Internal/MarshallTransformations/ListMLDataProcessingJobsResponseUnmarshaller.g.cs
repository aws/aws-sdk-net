...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListMLDataProcessingJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListMLDataProcessingJobsResponse();
        ...
        internal static ListMLDataProcessingJobsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListMLDataProcessingJobsResponseUnmarshaller Instance => _instance;
    }
}
