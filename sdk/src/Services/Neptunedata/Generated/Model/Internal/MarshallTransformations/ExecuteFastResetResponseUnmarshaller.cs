...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteFastReset operation
    /// </summary>  
    public class ExecuteFastResetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExecuteFastResetResponse response = new ExecuteFastResetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = FastResetTokenUnmarshaller.Instance;
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServerShutdownException"))
                {
                    return ServerShutdownExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ExecuteFastResetResponseUnmarshaller _instance = new ExecuteFastResetResponseUnmarshaller();        

        internal static ExecuteFastResetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteFastResetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
