...
namespace Amazon.Neptunedata.Model
{
    ...
    public partial class FailureByQueryException : AmazonNeptunedataException
    {
        ...
        public FailureByQueryException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public FailureByQueryException(Exception innerException) 
            : base(innerException) {}
        ...
        public FailureByQueryException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FailureByQueryException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
