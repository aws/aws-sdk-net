...
namespace Amazon.SageMakerFeatureStoreRuntime
{
    ...
    public partial interface IAmazonSageMakerFeatureStoreRuntime : IAmazonService, IDisposable
    {
        ...
        /// </summary>
        ISageMakerFeatureStoreRuntimePaginatorFactory Paginators { get; }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-featurestore-runtime-2020-07-01/BatchGetRecord">REST API Reference for BatchGetRecord Operation</seealso>
        Task<BatchGetRecordResponse> BatchGetRecordAsync(BatchGetRecordRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        BatchWriteRecordResponse BatchWriteRecord(BatchWriteRecordRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-featurestore-runtime-2020-07-01/BatchWriteRecord">REST API Reference for BatchWriteRecord Operation</seealso>
        Task<BatchWriteRecordResponse> BatchWriteRecordAsync(BatchWriteRecordRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-featurestore-runtime-2020-07-01/DeleteRecord">REST API Reference for DeleteRecord Operation</seealso>
        Task<DeleteRecordResponse> DeleteRecordAsync(DeleteRecordRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-featurestore-runtime-2020-07-01/GetRecord">REST API Reference for GetRecord Operation</seealso>
        Task<GetRecordResponse> GetRecordAsync(GetRecordRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-featurestore-runtime-2020-07-01/UpdateRecord">REST API Reference for UpdateRecord Operation</seealso>
        Task<UpdateRecordResponse> UpdateRecordAsync(UpdateRecordRequest request, CancellationToken cancellationToken = default(CancellationToken));
