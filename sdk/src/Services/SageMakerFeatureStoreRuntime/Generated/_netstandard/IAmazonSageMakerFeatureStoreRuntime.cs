...
namespace Amazon.SageMakerFeatureStoreRuntime
{
    ...
    public partial interface IAmazonSageMakerFeatureStoreRuntime : IAmazonService, IDisposable
    {
        ...
        Task<BatchWriteRecordResponse> BatchWriteRecordAsync(BatchWriteRecordRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
