...
{
    /// <summary>
    /// Container for the parameters to the BatchGetRecord operation. Retrieves a batch of
    /// <c>Records</c> from a <c>FeatureGroup</c>.
    /// </summary>
    public partial class BatchGetRecordRequest : AmazonSageMakerFeatureStoreRuntimeRequest
    {
        ...
        public List<BatchGetRecordIdentifier> Identifiers { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchGetRecordIdentifier>() : null;
