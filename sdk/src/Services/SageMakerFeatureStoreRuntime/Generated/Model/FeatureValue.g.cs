...
namespace Amazon.SageMakerFeatureStoreRuntime.Model
{
    ...
    public partial class FeatureValue
    {
        ...
        /// <summary>
        /// Checks to see if the ValueAsString property is set.
        /// </summary>
        internal bool IsSetValueAsString() => this.ValueAsString != null;
        ...
        /// </summary>
        [AWSProperty(Min = 0, Max = 358400)]
        public List<string> ValueAsStringList { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ValueAsStringList property is set.
        /// </summary>
        internal bool IsSetValueAsStringList() => this.ValueAsStringList != null && (this.ValueAsStringList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
