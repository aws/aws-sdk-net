...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchWriteRecordRequestMarshaller : IMarshaller<IRequest, BatchWriteRecordRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static BatchWriteRecordRequestMarshaller _instance = new BatchWriteRecordRequestMarshaller();        

        internal static BatchWriteRecordRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchWriteRecordRequestMarshaller Instance
        {
            get
            {
                return _instance;
