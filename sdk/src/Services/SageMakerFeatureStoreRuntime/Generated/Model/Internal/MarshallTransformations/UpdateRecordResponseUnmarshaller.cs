...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static UpdateRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
