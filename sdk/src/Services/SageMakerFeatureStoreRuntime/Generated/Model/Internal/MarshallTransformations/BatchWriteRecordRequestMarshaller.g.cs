...
{
    /// <summary>
    /// BatchWriteRecord Request Marshaller
    /// </summary>
    public partial class BatchWriteRecordRequestMarshaller : IMarshaller<IRequest, BatchWriteRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchWriteRecordRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(BatchWriteRecordRequest publicRequest)
        {
            ...
            request.ResourcePath = "/BatchWriteRecord";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetEntries())
            {
                ...
                foreach (var publicRequestEntriesListValue in publicRequest.Entries)
                {
                    ...
                    var marshaller = BatchWriteRecordEntryMarshaller.Instance;
        ...
        private static readonly BatchWriteRecordRequestMarshaller _instance = new();

        internal static BatchWriteRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchWriteRecordRequestMarshaller Instance => _instance;
    }
}
