...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetRecordResultDetailUnmarshaller : IJsonUnmarshaller<BatchGetRecordResultDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetRecordResultDetail();
        ...
        /// Gets the singleton.
        /// </summary>
        public static BatchGetRecordResultDetailUnmarshaller Instance => _instance;
    }
}
