...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRecordRequestMarshaller : IMarshaller<IRequest, UpdateRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateRecordRequestMarshaller _instance = new();

        internal static UpdateRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRecordRequestMarshaller Instance => _instance;
    }
}
