...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchWriteRecordEntryUnmarshaller : IJsonUnmarshaller<BatchWriteRecordEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchWriteRecordEntry();
        ...
        /// Gets the singleton.
        /// </summary>
        public static BatchWriteRecordEntryUnmarshaller Instance => _instance;
    }
}
