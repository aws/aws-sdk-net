...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetRecordErrorUnmarshaller : IJsonUnmarshaller<BatchGetRecordError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetRecordError();
        ...
        /// Gets the singleton.
        /// </summary>
        public static BatchGetRecordErrorUnmarshaller Instance => _instance;
    }
}
