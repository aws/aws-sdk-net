...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutRecordRequestMarshaller : IMarshaller<IRequest, PutRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutRecordRequestMarshaller _instance = new();

        internal static PutRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutRecordRequestMarshaller Instance => _instance;
    }
}
