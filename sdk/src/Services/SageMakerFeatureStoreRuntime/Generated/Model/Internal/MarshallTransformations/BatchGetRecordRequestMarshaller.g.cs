...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchGetRecordRequestMarshaller : IMarshaller<IRequest, BatchGetRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchGetRecordRequestMarshaller _instance = new();

        internal static BatchGetRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetRecordRequestMarshaller Instance => _instance;
    }
}
