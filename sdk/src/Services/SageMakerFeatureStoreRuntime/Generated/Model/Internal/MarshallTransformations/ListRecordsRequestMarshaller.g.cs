...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRecordsRequestMarshaller : IMarshaller<IRequest, ListRecordsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListRecordsRequestMarshaller _instance = new();

        internal static ListRecordsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRecordsRequestMarshaller Instance => _instance;
    }
}
