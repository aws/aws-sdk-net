...
namespace Amazon.SageMakerFeatureStoreRuntime.Model
{
    ...
    public partial class ListRecordsResponse : AmazonWebServiceResponse
    {
        ...
        private List<string> _recordIdentifiers = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        {
            get { return this._recordIdentifiers; }
            set { this._recordIdentifiers = value; }
        }

        // Check to see if RecordIdentifiers property is set
        internal bool IsSetRecordIdentifiers()
        {
            return this._recordIdentifiers != null && (this._recordIdentifiers.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
