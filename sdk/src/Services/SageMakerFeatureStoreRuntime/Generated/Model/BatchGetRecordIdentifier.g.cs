...
namespace Amazon.SageMakerFeatureStoreRuntime.Model
{
    ...
    public partial class BatchGetRecordIdentifier
    {
        ...
        public List<string> RecordIdentifiersValueAsString { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the RecordIdentifiersValueAsString property is set.
        /// </summary>
        internal bool IsSetRecordIdentifiersValueAsString() => this.RecordIdentifiersValueAsString != null && (this.RecordIdentifiersValueAsString.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
