...
namespace Amazon.SageMakerFeatureStoreRuntime.Model
{
    ...
    public partial class BatchWriteRecordResponse : AmazonWebServiceResponse
    {
        ...
        public List<BatchWriteRecordError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchWriteRecordError>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true, Min = 0)]
        public List<BatchWriteRecordEntry> UnprocessedEntries { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchWriteRecordEntry>() : null;

        /// <summary>
        /// Checks to see if the UnprocessedEntries property is set.
        /// </summary>
        internal bool IsSetUnprocessedEntries() => this.UnprocessedEntries != null && (this.UnprocessedEntries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
