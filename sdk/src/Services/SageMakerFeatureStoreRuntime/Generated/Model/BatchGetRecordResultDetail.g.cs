...
namespace Amazon.SageMakerFeatureStoreRuntime.Model
{
    ...
    public partial class BatchGetRecordResultDetail
    {
        ...
        public List<FeatureValue> Record { get; set; } = AWSConfigs.InitializeCollections ? new List<FeatureValue>() : null;

        /// <summary>
        /// Checks to see if the Record property is set.
        /// </summary>
        internal bool IsSetRecord() => this.Record != null && (this.Record.Count > 0 || !AWSConfigs.InitializeCollections);
