...
namespace Amazon.SageMakerFeatureStoreRuntime
{
    ...
    public partial class AmazonSageMakerFeatureStoreRuntimeClient : AmazonServiceClient, IAmazonSageMakerFeatureStoreRuntime
    {
        ...
        /// 
        /// </summary>
        public AmazonSageMakerFeatureStoreRuntimeClient() : base(new AmazonSageMakerFeatureStoreRuntimeConfig()) { }
        ...
        public AmazonSageMakerFeatureStoreRuntimeClient(RegionEndpoint region) : base(new AmazonSageMakerFeatureStoreRuntimeConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSageMakerFeatureStoreRuntimeClient(AmazonSageMakerFeatureStoreRuntimeConfig config) : base(config) { }
...
#else
        internal virtual BatchWriteRecordResponse BatchWriteRecord(BatchWriteRecordRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = BatchWriteRecordRequestMarshaller.Instance;
            options.ResponseUnmarshaller = BatchWriteRecordResponseUnmarshaller.Instance;
...
#else
        internal virtual UpdateRecordResponse UpdateRecord(UpdateRecordRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateRecordRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateRecordResponseUnmarshaller.Instance;
