...
namespace Amazon.SageMakerFeatureStoreRuntime
{
    ...
    public partial class AmazonSageMakerFeatureStoreRuntimeClient : AmazonServiceClient, IAmazonSageMakerFeatureStoreRuntime
    {
        ...
        public virtual UpdateRecordResponse UpdateRecord(UpdateRecordRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateRecordRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateRecordResponseUnmarshaller.Instance;

            return Invoke<UpdateRecordResponse>(request, options);
        }
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-featurestore-runtime-2020-07-01/UpdateRecord">REST API Reference for UpdateRecord Operation</seealso>
        public virtual Task<UpdateRecordResponse> UpdateRecordAsync(UpdateRecordRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken))
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateRecordRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateRecordResponseUnmarshaller.Instance;
            
            return InvokeAsync<UpdateRecordResponse>(request, options, cancellationToken);
        }
