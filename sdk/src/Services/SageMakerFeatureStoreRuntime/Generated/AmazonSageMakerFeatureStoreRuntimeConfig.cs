...
namespace Amazon.SageMakerFeatureStoreRuntime
{
    ...
    public partial class AmazonSageMakerFeatureStoreRuntimeConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SageMaker FeatureStore Runtime", "4.0.101.2");
        ...
        /// </summary>
        public static new string ServiceId => "SageMaker FeatureStore Runtime";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "featurestore-runtime.sagemaker";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-07-01";
