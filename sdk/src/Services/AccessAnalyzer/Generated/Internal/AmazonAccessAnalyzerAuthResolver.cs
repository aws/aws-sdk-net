...
namespace Amazon.AccessAnalyzer.Internal
{
    ...
    public class AmazonAccessAnalyzerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAccessAnalyzerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AccessAnalyzer.
        /// </summary>
        public AmazonAccessAnalyzerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAccessAnalyzerAuthSchemeParameters
            {
    ...
    public class AmazonAccessAnalyzerAuthSchemeResolver : IAuthSchemeResolver<AmazonAccessAnalyzerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAccessAnalyzerAuthSchemeParameters authParameters)
        {
