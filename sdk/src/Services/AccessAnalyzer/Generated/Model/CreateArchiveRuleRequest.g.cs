...
{
    /// <summary>
    /// Container for the parameters to the CreateArchiveRule operation. Creates an archive
    /// rule for the specified analyzer. Archive rules automatically archive new findings
    /// that meet the criteria you define when you create the rule. <para> To learn about
    /// filter keys that you can use to create an archive rule, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-reference-filter-keys.html">IAM
