...
{
    /// <summary>
    /// Container for the parameters to the ApplyArchiveRule operation. Retroactively applies
    /// the archive rule to existing findings that meet the archive rule criteria.
    /// </summary>
