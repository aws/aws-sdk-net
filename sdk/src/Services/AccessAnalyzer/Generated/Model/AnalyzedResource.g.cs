...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class AnalyzedResource
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> SharedVia { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SharedVia property is set.
        /// </summary>
        internal bool IsSetSharedVia() => this.SharedVia != null && (this.SharedVia.Count > 0 || !AWSConfigs.InitializeCollections);
