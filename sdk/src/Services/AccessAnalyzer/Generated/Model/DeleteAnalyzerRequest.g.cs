...
{
    /// <summary>
    /// Container for the parameters to the DeleteAnalyzer operation. Deletes the specified
    /// analyzer. When you delete an analyzer, IAM Access Analyzer is disabled for the account
    /// or organization in the current or specific Region. All findings that were generated
