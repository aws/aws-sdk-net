...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class AnalysisRule
    {
        ...
        /// </summary>
        public List<AnalysisRuleCriteria> Exclusions { get; set; } = AWSConfigs.InitializeCollections ? new List<AnalysisRuleCriteria>() : null;

        /// <summary>
        /// Checks to see if the Exclusions property is set.
        /// </summary>
        internal bool IsSetExclusions() => this.Exclusions != null && (this.Exclusions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
