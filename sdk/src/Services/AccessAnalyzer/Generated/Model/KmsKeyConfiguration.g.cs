...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class KmsKeyConfiguration
    {
        ...
        /// </summary>
        public List<KmsGrantConfiguration> Grants { get; set; } = AWSConfigs.InitializeCollections ? new List<KmsGrantConfiguration>() : null;

        /// <summary>
        /// Checks to see if the Grants property is set.
        /// </summary>
        internal bool IsSetGrants() => this.Grants != null && (this.Grants.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public Dictionary<string, string> KeyPolicies { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the KeyPolicies property is set.
        /// </summary>
        internal bool IsSetKeyPolicies() => this.KeyPolicies != null && (this.KeyPolicies.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
