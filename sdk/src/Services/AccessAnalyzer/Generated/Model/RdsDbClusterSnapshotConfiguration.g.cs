...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class RdsDbClusterSnapshotConfiguration
    {
        ...
        /// </summary>
        public Dictionary<string, RdsDbClusterSnapshotAttributeValue> Attributes { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, RdsDbClusterSnapshotAttributeValue>() : null;
