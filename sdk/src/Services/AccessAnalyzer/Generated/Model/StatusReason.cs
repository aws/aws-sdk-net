...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    /// creation for the analyzer fails, a <code>Failed</code> status is displayed. For an
    /// analyzer with organization as the type, this failure can be due to an issue with creating
    /// the service-linked roles required in the member accounts of the AWS organization.
    /// </summary>
