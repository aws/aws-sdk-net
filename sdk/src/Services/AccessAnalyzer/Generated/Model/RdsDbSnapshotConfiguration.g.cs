...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class RdsDbSnapshotConfiguration
    {
        ...
        /// </summary>
        public Dictionary<string, RdsDbSnapshotAttributeValue> Attributes { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, RdsDbSnapshotAttributeValue>() : null;
