...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class CheckAccessNotGrantedResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ReasonSummary> Reasons { get; set; } = AWSConfigs.InitializeCollections ? new List<ReasonSummary>() : null;
        ...
        /// </para>
        /// </summary>
        public CheckAccessNotGrantedResult Result { get; set; }
