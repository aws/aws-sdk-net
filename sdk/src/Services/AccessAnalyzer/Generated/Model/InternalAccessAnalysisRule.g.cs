...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class InternalAccessAnalysisRule
    {
        ...
        /// </summary>
        public List<InternalAccessAnalysisRuleCriteria> Inclusions { get; set; } = AWSConfigs.InitializeCollections ? new List<InternalAccessAnalysisRuleCriteria>() : null;

        /// <summary>
        /// Checks to see if the Inclusions property is set.
        /// </summary>
        internal bool IsSetInclusions() => this.Inclusions != null && (this.Inclusions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
