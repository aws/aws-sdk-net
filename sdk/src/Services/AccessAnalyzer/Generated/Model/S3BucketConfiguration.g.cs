...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    public partial class S3BucketConfiguration
    {
        ...
        /// </summary>
        public Dictionary<string, S3AccessPointConfiguration> AccessPoints { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, S3AccessPointConfiguration>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<S3BucketAclGrantConfiguration> BucketAclGrants { get; set; } = AWSConfigs.InitializeCollections ? new List<S3BucketAclGrantConfiguration>() : null;

        /// <summary>
        /// Checks to see if the BucketAclGrants property is set.
        /// </summary>
        internal bool IsSetBucketAclGrants() => this.BucketAclGrants != null && (this.BucketAclGrants.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the BucketPublicAccessBlock property is set.
        /// </summary>
        internal bool IsSetBucketPublicAccessBlock() => this.BucketPublicAccessBlock != null;
    }
}
