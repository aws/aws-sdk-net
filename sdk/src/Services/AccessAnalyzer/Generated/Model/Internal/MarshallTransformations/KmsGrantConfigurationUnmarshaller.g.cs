...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class KmsGrantConfigurationUnmarshaller : IJsonUnmarshaller<KmsGrantConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new KmsGrantConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("granteePrincipal", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("issuingAccount", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("retiringPrincipal", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static KmsGrantConfigurationUnmarshaller _instance = new KmsGrantConfigurationUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static KmsGrantConfigurationUnmarshaller Instance => _instance;
    }
}
