...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnalysisRuleCriteriaUnmarshaller : IJsonUnmarshaller<AnalysisRuleCriteria, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AnalysisRuleCriteria Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AnalysisRuleCriteria();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnalysisRuleCriteriaUnmarshaller Instance => _instance;
    }
}
