...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnalyzedResourceSummaryUnmarshaller : IJsonUnmarshaller<AnalyzedResourceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public AnalyzedResourceSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new AnalyzedResourceSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnalyzedResourceSummaryUnmarshaller Instance => _instance;
    }
}
