...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubstringUnmarshaller : IJsonUnmarshaller<Substring, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Substring Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("length", targetDepth, ref reader))
                {
