...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UnusedAccessFindingsStatisticsUnmarshaller : IJsonUnmarshaller<UnusedAccessFindingsStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UnusedAccessFindingsStatistics();
            ...
            {
                if (context.TestExpression("topAccounts", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("unusedAccessTypeStatistics", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static UnusedAccessFindingsStatisticsUnmarshaller Instance => _instance;
    }
}
