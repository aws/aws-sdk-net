...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FindingsStatisticsUnmarshaller : IUnmarshaller<FindingsStatistics, XmlUnmarshallerContext>, IUnmarshaller<FindingsStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FindingsStatistics IUnmarshaller<FindingsStatistics, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public FindingsStatistics Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("unusedAccessFindingsStatistics", targetDepth))
                {
                    ...
                    unmarshalledObject.UnusedAccessFindingsStatistics = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
