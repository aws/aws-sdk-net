...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAnalyzerRequestMarshaller : IMarshaller<IRequest, CreateAnalyzerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateAnalyzerRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetAnalyzerName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AnalyzerName);
            }
        ...
        private static readonly CreateAnalyzerRequestMarshaller _instance = new();

        internal static CreateAnalyzerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAnalyzerRequestMarshaller Instance => _instance;
    }
}
