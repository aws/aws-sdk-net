...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExternalAccessFindingsStatisticsUnmarshaller : IUnmarshaller<ExternalAccessFindingsStatistics, XmlUnmarshallerContext>, IUnmarshaller<ExternalAccessFindingsStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ExternalAccessFindingsStatistics IUnmarshaller<ExternalAccessFindingsStatistics, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ExternalAccessFindingsStatistics Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ResourceTypeDetails, StringUnmarshaller, ResourceTypeDetailsUnmarshaller>(StringUnmarshaller.Instance, ResourceTypeDetailsUnmarshaller.Instance);
