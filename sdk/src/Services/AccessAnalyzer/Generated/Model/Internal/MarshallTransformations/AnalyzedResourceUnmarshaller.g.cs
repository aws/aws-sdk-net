...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnalyzedResourceUnmarshaller : IJsonUnmarshaller<AnalyzedResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AnalyzedResource();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("sharedVia", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnalyzedResourceUnmarshaller Instance => _instance;
    }
}
