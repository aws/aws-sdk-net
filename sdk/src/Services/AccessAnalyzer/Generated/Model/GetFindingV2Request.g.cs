...
{
    /// <summary>
    /// Container for the parameters to the GetFindingV2 operation. Retrieves information
    /// about the specified finding. GetFinding and GetFindingV2 both use <c>access-analyzer:GetFinding</c>
    /// in the <c>Action</c> element of an IAM policy statement. You must have permission
    /// to perform the <c>access-analyzer:GetFinding</c> action.
    /// </summary>
