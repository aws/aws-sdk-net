...
{
    /// <summary>
    /// Container for the parameters to the GetFindingsStatistics operation. Retrieves a list
    /// of aggregated finding statistics for an external access or unused access analyzer.
    /// </summary>
