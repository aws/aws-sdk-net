...
namespace Amazon.AccessAnalyzer
{
    ...
    public partial class AmazonAccessAnalyzerClient : AmazonServiceClient, IAmazonAccessAnalyzer
    {
        ...
        /// 
        /// </summary>
        public AmazonAccessAnalyzerClient() : base(new AmazonAccessAnalyzerConfig()) { }
        ...
        public AmazonAccessAnalyzerClient(RegionEndpoint region) : base(new AmazonAccessAnalyzerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAccessAnalyzerClient(AmazonAccessAnalyzerConfig config) : base(config) { }
...
#else
        internal virtual CreateServiceLinkedAnalyzerResponse CreateServiceLinkedAnalyzer(CreateServiceLinkedAnalyzerRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = CreateServiceLinkedAnalyzerRequestMarshaller.Instance;
            options.ResponseUnmarshaller = CreateServiceLinkedAnalyzerResponseUnmarshaller.Instance;
...
#else
        internal virtual DeleteServiceLinkedAnalyzerResponse DeleteServiceLinkedAnalyzer(DeleteServiceLinkedAnalyzerRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = DeleteServiceLinkedAnalyzerRequestMarshaller.Instance;
            options.ResponseUnmarshaller = DeleteServiceLinkedAnalyzerResponseUnmarshaller.Instance;
