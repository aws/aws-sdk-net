...
namespace Amazon.AccessAnalyzer
{
    ...
    public partial class AmazonAccessAnalyzerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("AccessAnalyzer", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "AccessAnalyzer";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "access-analyzer";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-11-01";
