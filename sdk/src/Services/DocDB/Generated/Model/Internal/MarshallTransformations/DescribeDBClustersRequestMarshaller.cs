...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDBClustersRequestMarshaller : IMarshaller<IRequest, DescribeDBClustersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBClustersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBClustersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DocDB");
            request.Parameters.Add("Action", "DescribeDBClusters");
            ...
            return request;
                    ...
                    private static DescribeDBClustersRequestMarshaller _instance = new DescribeDBClustersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClustersRequestMarshaller Instance
        {
            get
            {
                return _instance;
