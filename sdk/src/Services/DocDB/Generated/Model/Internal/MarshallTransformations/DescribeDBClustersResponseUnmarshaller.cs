...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDBClustersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBClustersResponse response = new DescribeDBClustersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBClustersResult", 2))
                    {
        ...
        private static DescribeDBClustersResponseUnmarshaller _instance = new DescribeDBClustersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClustersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
