...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDBClusterSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDBClusterSnapshotResponse response = new DeleteDBClusterSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDBClusterSnapshotResult", 2))
                    {
        ...
        private static DeleteDBClusterSnapshotResponseUnmarshaller _instance = new DeleteDBClusterSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBClusterSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
