...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDBInstancesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("DBInstances/DBInstance", targetDepth))
                    {
                        ...
                        {
                            response.DBInstances = new List<DBInstance>();
                        }
        ...
        private static DescribeDBInstancesResponseUnmarshaller _instance = new DescribeDBInstancesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
