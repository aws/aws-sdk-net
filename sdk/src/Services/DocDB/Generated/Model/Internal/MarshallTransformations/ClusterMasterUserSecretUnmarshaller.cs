...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    public class ClusterMasterUserSecretUnmarshaller : IXmlUnmarshaller<ClusterMasterUserSecret, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ClusterMasterUserSecret Unmarshall(XmlUnmarshallerContext context)
        {
            ClusterMasterUserSecret unmarshalledObject = new ClusterMasterUserSecret();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("SecretStatus", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.SecretStatus = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ClusterMasterUserSecretUnmarshaller Instance
        {
            get
            {
                return _instance;
