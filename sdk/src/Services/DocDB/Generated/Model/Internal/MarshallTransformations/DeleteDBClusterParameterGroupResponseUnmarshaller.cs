...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDBClusterParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDBClusterParameterGroupResponse response = new DeleteDBClusterParameterGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDBClusterParameterGroupResult", 2))
                    {
        ...
        private static DeleteDBClusterParameterGroupResponseUnmarshaller _instance = new DeleteDBClusterParameterGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBClusterParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
