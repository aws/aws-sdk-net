...
namespace Amazon.DocDB.Model
{
    ...
    [Serializable]
    #endif
    public partial class SubscriptionNotFoundException : AmazonDocDBException
    {
        ...
        public SubscriptionNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SubscriptionNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
