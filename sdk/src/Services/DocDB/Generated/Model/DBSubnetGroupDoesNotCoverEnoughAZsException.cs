...
namespace Amazon.DocDB.Model
{
    ...
    public partial class DBSubnetGroupDoesNotCoverEnoughAZsException : AmazonDocDBException
    {
        ...
        /// <summary>
        /// Default constructor for DBSubnetGroupDoesNotCoverEnoughAZsException
        /// message.
        /// </summary>
        public DBSubnetGroupDoesNotCoverEnoughAZsException() 
            : base() {}
        ...
        public DBSubnetGroupDoesNotCoverEnoughAZsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DBSubnetGroupDoesNotCoverEnoughAZsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected DBSubnetGroupDoesNotCoverEnoughAZsException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
