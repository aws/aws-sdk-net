...
namespace Amazon.DocDB.Model
{
    ...
    internal sealed partial class DescribeGlobalClustersPaginator : IPaginator<DescribeGlobalClustersResponse>, IDescribeGlobalClustersPaginator
    {
        ...
        async IAsyncEnumerable<DescribeGlobalClustersResponse> IPaginator<DescribeGlobalClustersResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
