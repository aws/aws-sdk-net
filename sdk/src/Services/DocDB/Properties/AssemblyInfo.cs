...
#elif NET6_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 6.0) - Amazon DocumentDB with MongoDB compatibility. Amazon DocumentDB is a fast, reliable, and fully managed MongoDB compatible database service.")]
#else
