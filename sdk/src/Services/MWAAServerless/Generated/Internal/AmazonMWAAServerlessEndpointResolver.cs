...
using Amazon.Util;
using Amazon.MWAAServerless.Endpoints;
...
{
    /// <summary>
    /// Amazon MWAAServerless endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for MWAAServerless service requests.
    /// Collects values for MWAAServerlessEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses MWAAServerlessEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonMWAAServerlessEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonMWAAServerlessConfig)requestContext.ClientConfig;
            var result = new MWAAServerlessEndpointParameters();
