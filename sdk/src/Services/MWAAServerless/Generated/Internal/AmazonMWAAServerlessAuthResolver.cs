...
namespace Amazon.MWAAServerless.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonMWAAServerlessAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMWAAServerlessAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MWAAServerless.
        /// </summary>
        public AmazonMWAAServerlessAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMWAAServerlessAuthSchemeParameters
            {
    ...
    public class AmazonMWAAServerlessAuthSchemeResolver : IAuthSchemeResolver<AmazonMWAAServerlessAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMWAAServerlessAuthSchemeParameters authParameters)
        {
