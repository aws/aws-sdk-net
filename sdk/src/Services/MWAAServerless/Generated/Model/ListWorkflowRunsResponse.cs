...
namespace Amazon.MWAAServerless.Model
{
    ...
    public partial class ListWorkflowRunsResponse : AmazonWebServiceResponse
    {
        ...
        private List<WorkflowRunSummary> _workflowRuns = AWSConfigs.InitializeCollections ? new List<WorkflowRunSummary>() : null;
        ...
        /// <summary>
        /// Gets and sets the property WorkflowRuns. 
        /// <para>
        ...
        /// </summary>
        public List<WorkflowRunSummary> WorkflowRuns
        {
            get { return this._workflowRuns; }
            set { this._workflowRuns = value; }
        }

        // Check to see if WorkflowRuns property is set
        internal bool IsSetWorkflowRuns()
        {
            return this._workflowRuns != null && (this._workflowRuns.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
