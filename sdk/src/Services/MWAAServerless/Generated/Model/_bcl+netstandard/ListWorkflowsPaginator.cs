...
namespace Amazon.MWAAServerless.Model
{
    ...
    internal sealed partial class ListWorkflowsPaginator : IPaginator<ListWorkflowsResponse>, IListWorkflowsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<WorkflowSummary> Workflows => 
            new PaginatedResultKeyResponse<ListWorkflowsResponse, WorkflowSummary>(this, (i) => i.Workflows ?? new List<WorkflowSummary>());

        internal ListWorkflowsPaginator(IAmazonMWAAServerless client, ListWorkflowsRequest request)
        {
            this._client = client;
