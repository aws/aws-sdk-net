...
{
    /// <summary>
    /// Summary information about a workflow run, including basic identification and status
    /// information.
    /// </summary>
    public partial class WorkflowRunSummary
    {
        private RunDetailSummary _runDetailSummary;
        ...
        /// <summary>
        /// Gets and sets the property RunDetailSummary. 
        /// <para>
        /// Summary details about the workflow run execution.
        /// </para>
        /// </summary>
        public RunDetailSummary RunDetailSummary
        {
            get { return this._runDetailSummary; }
            set { this._runDetailSummary = value; }
        }

        // Check to see if RunDetailSummary property is set
        internal bool IsSetRunDetailSummary()
        {
            return this._runDetailSummary != null;
        }
