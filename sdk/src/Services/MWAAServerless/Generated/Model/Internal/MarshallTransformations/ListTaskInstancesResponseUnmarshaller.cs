    ...
    public class ListTaskInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TaskInstanceSummary, TaskInstanceSummaryUnmarshaller>(TaskInstanceSummaryUnmarshaller.Instance);
                    response.TaskInstances = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
