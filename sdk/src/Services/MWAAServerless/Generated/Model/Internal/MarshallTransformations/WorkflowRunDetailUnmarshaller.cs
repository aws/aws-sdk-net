...
namespace Amazon.MWAAServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowRunDetailUnmarshaller : IUnmarshaller<WorkflowRunDetail, XmlUnmarshallerContext>, IUnmarshaller<WorkflowRunDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        WorkflowRunDetail IUnmarshaller<WorkflowRunDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public WorkflowRunDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RunState = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("TaskInstances", targetDepth))
                {
                    ...
                    unmarshalledObject.TaskInstances = unmarshaller.Unmarshall(context);
                    continue;
                }
