    ...
    public class ListWorkflowVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WorkflowVersionSummary, WorkflowVersionSummaryUnmarshaller>(WorkflowVersionSummaryUnmarshaller.Instance);
                    response.WorkflowVersions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
