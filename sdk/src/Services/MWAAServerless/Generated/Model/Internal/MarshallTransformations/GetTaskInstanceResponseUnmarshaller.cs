    ...
    public class GetTaskInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OperatorName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TaskInstanceId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("WorkflowArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkflowArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("WorkflowVersion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkflowVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Xcom", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    response.Xcom = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
