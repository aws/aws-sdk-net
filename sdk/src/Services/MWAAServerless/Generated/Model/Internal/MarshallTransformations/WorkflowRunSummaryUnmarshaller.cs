...
namespace Amazon.MWAAServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowRunSummaryUnmarshaller : IJsonUnmarshaller<WorkflowRunSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkflowRunSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("RunDetailSummary", targetDepth, ref reader))
                {
                    var unmarshaller = RunDetailSummaryUnmarshaller.Instance;
                    unmarshalledObject.RunDetailSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("RunType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
