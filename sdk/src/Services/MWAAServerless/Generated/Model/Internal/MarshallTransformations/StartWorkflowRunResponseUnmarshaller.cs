...
{
    /// <summary>
    /// Response Unmarshaller for StartWorkflowRun operation
    /// </summary>  
    public class StartWorkflowRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartWorkflowRunResponse response = new StartWorkflowRunResponse();
        ...
        private static StartWorkflowRunResponseUnmarshaller _instance = new StartWorkflowRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartWorkflowRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
