...
namespace Amazon.MWAAServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowVersionSummaryUnmarshaller : IUnmarshaller<WorkflowVersionSummary, XmlUnmarshallerContext>, IUnmarshaller<WorkflowVersionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        WorkflowVersionSummary IUnmarshaller<WorkflowVersionSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public WorkflowVersionSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("DefinitionS3Location", targetDepth))
                {
                    ...
                    unmarshalledObject.DefinitionS3Location = unmarshaller.Unmarshall(context);
                    continue;
                }
