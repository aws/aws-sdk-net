...
{
    /// <summary>
    /// Container for the parameters to the ListTaskInstances operation.
    /// Lists all task instances for a specific workflow run, with optional pagination support.
    /// </summary>
    public partial class ListTaskInstancesRequest : AmazonMWAAServerlessRequest
    {
        ...
        /// is returned from a previous call to <c>ListTaskInstances</c>.
        /// </para>
        /// </summary>
