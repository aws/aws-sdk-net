...
namespace Amazon.MWAAServerless
{
    ...
    public partial class AmazonMWAAServerlessClient : AmazonServiceClient, IAmazonMWAAServerless
    {
        ...
        internal virtual GetTaskInstanceResponse GetTaskInstance(GetTaskInstanceRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListTaskInstancesResponse ListTaskInstances(ListTaskInstancesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
