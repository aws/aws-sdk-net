...
namespace Amazon.SSMIncidents
{
    ...
    public partial class AmazonSSMIncidentsClient : AmazonServiceClient, IAmazonSSMIncidents
    {
        ...
        /// 
        /// </summary>
        public AmazonSSMIncidentsClient() : base(new AmazonSSMIncidentsConfig()) { }
        ...
        public AmazonSSMIncidentsClient(RegionEndpoint region) : base(new AmazonSSMIncidentsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSSMIncidentsClient(AmazonSSMIncidentsConfig config) : base(config) { }
