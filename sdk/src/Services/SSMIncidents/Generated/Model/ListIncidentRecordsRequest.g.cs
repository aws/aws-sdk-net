...
{
    /// <summary>
    /// Container for the parameters to the ListIncidentRecords operation. Lists all incident
    /// records in your account. Use this command to retrieve the Amazon Resource Name (ARN)
    /// of the incident record you want to update.
    /// </summary>
