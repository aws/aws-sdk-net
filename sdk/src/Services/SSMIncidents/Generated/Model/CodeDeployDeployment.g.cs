...
namespace Amazon.SSMIncidents.Model
{
    ...
    public partial class CodeDeployDeployment
    {
        ...
        public string DeploymentGroupArn { get; set; }

        /// <summary>
        /// Checks to see if the DeploymentGroupArn property is set.
        /// </summary>
        internal bool IsSetDeploymentGroupArn() => this.DeploymentGroupArn != null;
