...
namespace Amazon.SSMIncidents.Model
{
    ...
    public partial class ListTimelineEventsResponse : AmazonWebServiceResponse
    {
        ...
        public List<EventSummary> EventSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<EventSummary>() : null;

        /// <summary>
        /// Checks to see if the EventSummaries property is set.
        /// </summary>
        internal bool IsSetEventSummaries() => this.EventSummaries != null && (this.EventSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
