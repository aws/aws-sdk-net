...
namespace Amazon.SSMIncidents.Model
{
    ...
    public partial class ChatChannel
    {
        ...
        public List<string> ChatbotSns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ChatbotSns property is set.
        /// </summary>
        internal bool IsSetChatbotSns() => this.ChatbotSns != null && (this.ChatbotSns.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the Empty property is set.
        /// </summary>
        internal bool IsSetEmpty() => this.Empty != null;
    }
}
