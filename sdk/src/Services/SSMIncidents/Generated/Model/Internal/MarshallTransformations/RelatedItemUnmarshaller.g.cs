...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RelatedItemUnmarshaller : IJsonUnmarshaller<RelatedItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RelatedItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RelatedItemUnmarshaller Instance => _instance;
    }
}
