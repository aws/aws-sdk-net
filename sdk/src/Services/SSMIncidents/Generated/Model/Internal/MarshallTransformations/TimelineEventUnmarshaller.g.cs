...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TimelineEventUnmarshaller : IJsonUnmarshaller<TimelineEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TimelineEvent();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TimelineEventUnmarshaller Instance => _instance;
    }
}
