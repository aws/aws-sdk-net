...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRelatedItemsRequestMarshaller : IMarshaller<IRequest, ListRelatedItemsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListRelatedItemsRequestMarshaller _instance = new();

        internal static ListRelatedItemsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRelatedItemsRequestMarshaller Instance => _instance;
    }
}
