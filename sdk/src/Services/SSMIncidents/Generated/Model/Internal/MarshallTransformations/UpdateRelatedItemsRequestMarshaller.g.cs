...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateRelatedItemsRequestMarshaller : IMarshaller<IRequest, UpdateRelatedItemsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateRelatedItemsRequestMarshaller _instance = new();

        internal static UpdateRelatedItemsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateRelatedItemsRequestMarshaller Instance => _instance;
    }
}
