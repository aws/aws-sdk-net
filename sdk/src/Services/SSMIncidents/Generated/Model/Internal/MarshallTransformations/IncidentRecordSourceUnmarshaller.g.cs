...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IncidentRecordSourceUnmarshaller : IJsonUnmarshaller<IncidentRecordSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IncidentRecordSource();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IncidentRecordSourceUnmarshaller Instance => _instance;
    }
}
