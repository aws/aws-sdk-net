...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartIncidentRequestMarshaller : IMarshaller<IRequest, StartIncidentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartIncidentRequestMarshaller _instance = new();

        internal static StartIncidentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartIncidentRequestMarshaller Instance => _instance;
    }
}
