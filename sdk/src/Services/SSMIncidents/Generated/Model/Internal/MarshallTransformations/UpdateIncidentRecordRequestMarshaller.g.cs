...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateIncidentRecordRequestMarshaller : IMarshaller<IRequest, UpdateIncidentRecordRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateIncidentRecordRequestMarshaller _instance = new();

        internal static UpdateIncidentRecordRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateIncidentRecordRequestMarshaller Instance => _instance;
    }
}
