...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IncidentRecordUnmarshaller : IJsonUnmarshaller<IncidentRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IncidentRecord();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IncidentRecordUnmarshaller Instance => _instance;
    }
}
