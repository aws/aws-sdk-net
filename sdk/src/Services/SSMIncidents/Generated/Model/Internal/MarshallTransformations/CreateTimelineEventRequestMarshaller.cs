...
{
    /// <summary>
    /// CreateTimelineEvent Request Marshaller
    /// </summary>       
    public class CreateTimelineEventRequestMarshaller : IMarshaller<IRequest, CreateTimelineEventRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTimelineEventRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTimelineEventRequest publicRequest)
        {
        ...
        private static CreateTimelineEventRequestMarshaller _instance = new CreateTimelineEventRequestMarshaller();        

        internal static CreateTimelineEventRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTimelineEventRequestMarshaller Instance
        {
            get
            {
                return _instance;
