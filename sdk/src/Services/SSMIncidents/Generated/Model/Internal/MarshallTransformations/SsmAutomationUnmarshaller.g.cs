...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SsmAutomationUnmarshaller : IJsonUnmarshaller<SsmAutomation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SsmAutomation();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SsmAutomationUnmarshaller Instance => _instance;
    }
}
