...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PagerDutyConfigurationUnmarshaller : IJsonUnmarshaller<PagerDutyConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PagerDutyConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PagerDutyConfigurationUnmarshaller Instance => _instance;
    }
}
