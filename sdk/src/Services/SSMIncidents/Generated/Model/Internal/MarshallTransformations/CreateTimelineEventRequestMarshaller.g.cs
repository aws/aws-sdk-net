...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateTimelineEventRequestMarshaller : IMarshaller<IRequest, CreateTimelineEventRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateTimelineEventRequestMarshaller _instance = new();

        internal static CreateTimelineEventRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateTimelineEventRequestMarshaller Instance => _instance;
    }
}
