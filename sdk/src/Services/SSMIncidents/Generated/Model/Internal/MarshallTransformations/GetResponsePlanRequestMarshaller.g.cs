...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetResponsePlanRequestMarshaller : IMarshaller<IRequest, GetResponsePlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetResponsePlanRequestMarshaller _instance = new();

        internal static GetResponsePlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetResponsePlanRequestMarshaller Instance => _instance;
    }
}
