...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FindingDetailsUnmarshaller : IJsonUnmarshaller<FindingDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FindingDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FindingDetailsUnmarshaller Instance => _instance;
    }
}
