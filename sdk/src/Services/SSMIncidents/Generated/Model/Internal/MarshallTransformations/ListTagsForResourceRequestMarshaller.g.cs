...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListTagsForResourceRequestMarshaller : IMarshaller<IRequest, ListTagsForResourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListTagsForResourceRequest publicRequest)
        {
            ...
            {
                throw new AmazonSSMIncidentsException("Request object does not have required field ResourceArn set");
            }
        ...
        private static readonly ListTagsForResourceRequestMarshaller _instance = new();

        internal static ListTagsForResourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListTagsForResourceRequestMarshaller Instance => _instance;
    }
}
