...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateTimelineEventRequestMarshaller : IMarshaller<IRequest, UpdateTimelineEventRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateTimelineEventRequestMarshaller _instance = new();

        internal static UpdateTimelineEventRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateTimelineEventRequestMarshaller Instance => _instance;
    }
}
