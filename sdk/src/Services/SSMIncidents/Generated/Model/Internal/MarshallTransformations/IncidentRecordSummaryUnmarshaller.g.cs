...
{
    /// <summary>
    /// Response Unmarshaller for IncidentRecordSummary Object
    /// </summary>
    public partial class IncidentRecordSummaryUnmarshaller : IJsonUnmarshaller<IncidentRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public IncidentRecordSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new IncidentRecordSummary();
        ...
        private static IncidentRecordSummaryUnmarshaller _instance = new IncidentRecordSummaryUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static IncidentRecordSummaryUnmarshaller Instance => _instance;
    }
}
