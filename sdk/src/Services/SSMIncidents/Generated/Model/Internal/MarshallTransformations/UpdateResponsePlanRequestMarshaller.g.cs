...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateResponsePlanRequestMarshaller : IMarshaller<IRequest, UpdateResponsePlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateResponsePlanRequestMarshaller _instance = new();

        internal static UpdateResponsePlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateResponsePlanRequestMarshaller Instance => _instance;
    }
}
