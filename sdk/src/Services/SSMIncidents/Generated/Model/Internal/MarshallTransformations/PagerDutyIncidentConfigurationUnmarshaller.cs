...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PagerDutyIncidentConfigurationUnmarshaller : IJsonUnmarshaller<PagerDutyIncidentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PagerDutyIncidentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
