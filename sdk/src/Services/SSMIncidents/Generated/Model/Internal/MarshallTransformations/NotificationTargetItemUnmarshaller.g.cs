...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class NotificationTargetItemUnmarshaller : IJsonUnmarshaller<NotificationTargetItem, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public NotificationTargetItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new NotificationTargetItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static NotificationTargetItemUnmarshaller Instance => _instance;
    }
}
