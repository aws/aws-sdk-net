    ...
    public class GetResourcePoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourcePolicy, ResourcePolicyUnmarshaller>(ResourcePolicyUnmarshaller.Instance);
                    response.ResourcePolicies = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
