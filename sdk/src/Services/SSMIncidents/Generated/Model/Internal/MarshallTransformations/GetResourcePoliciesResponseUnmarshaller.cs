    ...
    public class GetResourcePoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resourcePolicies", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourcePolicy, ResourcePolicyUnmarshaller>(ResourcePolicyUnmarshaller.Instance);
                    response.ResourcePolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
