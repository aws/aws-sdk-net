...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IncidentTemplateUnmarshaller : IJsonUnmarshaller<IncidentTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IncidentTemplate();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("incidentTags", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static IncidentTemplateUnmarshaller Instance => _instance;
    }
}
