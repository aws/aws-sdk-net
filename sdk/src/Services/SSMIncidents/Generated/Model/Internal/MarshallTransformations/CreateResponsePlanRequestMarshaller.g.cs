...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateResponsePlanRequestMarshaller : IMarshaller<IRequest, CreateResponsePlanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateResponsePlanRequestMarshaller _instance = new();

        internal static CreateResponsePlanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateResponsePlanRequestMarshaller Instance => _instance;
    }
}
