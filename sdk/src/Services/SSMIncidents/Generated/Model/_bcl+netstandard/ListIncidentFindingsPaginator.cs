...
namespace Amazon.SSMIncidents.Model
{
    ...
    internal sealed partial class ListIncidentFindingsPaginator : IPaginator<ListIncidentFindingsResponse>, IListIncidentFindingsPaginator
    {
        ...
        public IPaginatedEnumerable<FindingSummary> Findings => 
            new PaginatedResultKeyResponse<ListIncidentFindingsResponse, FindingSummary>(this, (i) => i.Findings);
        ...
        async IAsyncEnumerable<ListIncidentFindingsResponse> IPaginator<ListIncidentFindingsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
