...
namespace Amazon.SSMIncidents
{
    ...
    public partial interface IAmazonSSMIncidents : IAmazonService, IDisposable
    {
        ...
        Task<BatchGetIncidentFindingsResponse> BatchGetIncidentFindingsAsync(BatchGetIncidentFindingsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListIncidentFindingsResponse> ListIncidentFindingsAsync(ListIncidentFindingsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
