...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSSMIncidentsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSSMIncidentsConfig();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSSMIncidentsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSSMIncidentsConfig to create AmazonSSMIncidentsClient");
            }

            return awsCredentials == null ?
                    new AmazonSSMIncidentsClient(serviceClientConfig) :
                    new AmazonSSMIncidentsClient(awsCredentials, serviceClientConfig);
        }
