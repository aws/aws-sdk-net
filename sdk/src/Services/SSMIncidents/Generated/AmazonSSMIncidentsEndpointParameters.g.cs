...
namespace Amazon.SSMIncidents.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving SSMIncidents endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonSSMIncidentsEndpointProvider"/> and <see cref="AmazonSSMIncidentsEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class SSMIncidentsEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// SSMIncidentsEndpointParameters constructor
        /// </summary>
        public SSMIncidentsEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
