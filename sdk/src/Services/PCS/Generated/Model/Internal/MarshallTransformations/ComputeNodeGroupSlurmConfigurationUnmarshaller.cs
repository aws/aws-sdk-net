...
namespace Amazon.PCS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComputeNodeGroupSlurmConfigurationUnmarshaller : IJsonUnmarshaller<ComputeNodeGroupSlurmConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComputeNodeGroupSlurmConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("gresCustomSettings", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.GresCustomSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
