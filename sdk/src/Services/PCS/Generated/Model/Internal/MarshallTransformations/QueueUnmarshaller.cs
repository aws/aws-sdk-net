    ...
    public class QueueUnmarshaller : IUnmarshaller<Queue, XmlUnmarshallerContext>, IUnmarshaller<Queue, JsonUnmarshallerContext>
    {
        ...
        public Queue Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ComputeNodeGroupConfiguration, ComputeNodeGroupConfigurationUnmarshaller>(ComputeNodeGroupConfigurationUnmarshaller.Instance);
                    unmarshalledObject.ComputeNodeGroupConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
