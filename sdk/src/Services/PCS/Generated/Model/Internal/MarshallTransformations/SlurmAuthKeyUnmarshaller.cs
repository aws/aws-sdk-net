...
namespace Amazon.PCS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SlurmAuthKeyUnmarshaller : IJsonUnmarshaller<SlurmAuthKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SlurmAuthKey Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("secretVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecretVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
