...
namespace Amazon.PCS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JwtAuthUnmarshaller : IJsonUnmarshaller<JwtAuth, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JwtAuth Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("jwtKey", targetDepth, ref reader))
                {
                    var unmarshaller = JwtKeyUnmarshaller.Instance;
                    unmarshalledObject.JwtKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
