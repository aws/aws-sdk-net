...
namespace Amazon.PCS.Model
{
    ...
    public partial class CreateComputeNodeGroupRequest : AmazonPCSRequest
    {
        ...
        /// <c>pcs:RegisterComputeNodeGroupInstance</c> permissions attached in order to provision
        /// instances correctly. The resource identifier of the ARN must start with <c>AWSPCS</c>.
        /// For example, <c>arn:aws:iam:123456789012:instance-profile/AWSPCSMyComputeNodeInstanceProfile</c>.
        /// 
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
