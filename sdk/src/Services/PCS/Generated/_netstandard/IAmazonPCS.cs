...
namespace Amazon.PCS
{
    ...
    public partial interface IAmazonPCS : IAmazonService, IDisposable
    {
        ...
        Task<CreateComputeNodeGroupResponse> CreateComputeNodeGroupAsync(CreateComputeNodeGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteComputeNodeGroupResponse> DeleteComputeNodeGroupAsync(DeleteComputeNodeGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetComputeNodeGroupResponse> GetComputeNodeGroupAsync(GetComputeNodeGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListComputeNodeGroupsResponse> ListComputeNodeGroupsAsync(ListComputeNodeGroupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateComputeNodeGroupResponse> UpdateComputeNodeGroupAsync(UpdateComputeNodeGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPCSConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPCSConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPCSConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPCSConfig to create AmazonPCSClient");
            }

            return awsCredentials == null ? 
                    new AmazonPCSClient(serviceClientConfig) :
                    new AmazonPCSClient(awsCredentials, serviceClientConfig);
        }
