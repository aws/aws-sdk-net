...
namespace Amazon.PCS.Internal
{
    ...
    public class AmazonPCSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPCSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PCS.
        /// </summary>
        public AmazonPCSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPCSAuthSchemeParameters
            {
    ...
    public class AmazonPCSAuthSchemeResolver : IAuthSchemeResolver<AmazonPCSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPCSAuthSchemeParameters authParameters)
        {
