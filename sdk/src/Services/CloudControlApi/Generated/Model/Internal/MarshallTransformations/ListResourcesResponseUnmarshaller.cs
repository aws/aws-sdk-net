    ...
    public class ListResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceDescription, ResourceDescriptionUnmarshaller>(ResourceDescriptionUnmarshaller.Instance);
                    response.ResourceDescriptions = unmarshaller.Unmarshall(context);
                    continue;
                }
