...
namespace Amazon.DataZone
{
    ...
    public partial class AmazonDataZoneClient : AmazonServiceClient, IAmazonDataZone
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/QueryGraph">REST API Reference for QueryGraph Operation</seealso>
        public virtual IAsyncResult BeginQueryGraph(QueryGraphRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = QueryGraphRequestMarshaller.Instance;
            options.ResponseUnmarshaller = QueryGraphResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/QueryGraph">REST API Reference for QueryGraph Operation</seealso>
        public virtual QueryGraphResponse EndQueryGraph(IAsyncResult asyncResult)
        {
            return EndInvoke<QueryGraphResponse>(asyncResult);
        }
