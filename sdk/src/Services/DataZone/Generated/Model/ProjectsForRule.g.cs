...
namespace Amazon.DataZone.Model
{
    ...
    public partial class ProjectsForRule
    {
        ...
        /// </summary>
        [AWSProperty(Min = 1)]
        public List<string> SpecificProjects { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SpecificProjects property is set.
        /// </summary>
        internal bool IsSetSpecificProjects() => this.SpecificProjects != null && (this.SpecificProjects.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
