...
{
    /// <summary>
    /// This is the response object from the ListMetadataGenerationRuns operation.
    /// </summary>
    public partial class ListMetadataGenerationRunsResponse : AmazonWebServiceResponse
    {
        private List<MetadataGenerationRunItem> _items = AWSConfigs.InitializeCollections ? new List<MetadataGenerationRunItem>() : null;
        ...
        /// </summary>
        public List<MetadataGenerationRunItem> Items
        {
