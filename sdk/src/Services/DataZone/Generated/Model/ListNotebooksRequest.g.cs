...
{
    /// <summary>
    /// Container for the parameters to the ListNotebooks operation. Lists <a href="https://docs.aws.amazon.com/sagemaker-unified-studio/latest/userguide/notebooks.html">notebooks</a>
    /// in Amazon SageMaker Unified Studio.
    /// </summary>
    public partial class ListNotebooksRequest : AmazonDataZoneRequest
    {
        /// <summary>
        ...
        /// <para>
        /// The maximum number of notebooks to return in a single call. When the number of notebooks
        /// exceeds the value of <c>MaxResults</c>, the response contains a <c>NextToken</c> value.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// When the number of notebooks is greater than the default value for the <c>MaxResults</c>
        ...
        /// to list the next set of notebooks.
        /// </para>
        /// </summary>
