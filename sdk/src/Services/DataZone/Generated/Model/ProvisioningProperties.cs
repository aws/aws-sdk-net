...
namespace Amazon.DataZone.Model
{
    ...
    /// </summary>
    public partial class ProvisioningProperties
    {
        private CloudFormationProperties _cloudFormation;

        /// <summary>
        /// Gets and sets the property CloudFormation. 
        /// <para>
        /// The cloud formation properties included as part of the provisioning properties of
        /// an environment blueprint.
        /// </para>
        /// </summary>
        public CloudFormationProperties CloudFormation
        {
