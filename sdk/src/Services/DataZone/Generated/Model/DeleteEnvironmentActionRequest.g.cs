...
{
    /// <summary>
    /// Container for the parameters to the DeleteEnvironmentAction operation. Deletes an
    /// action for the environment, for example, deletes a console link for an analytics tool
