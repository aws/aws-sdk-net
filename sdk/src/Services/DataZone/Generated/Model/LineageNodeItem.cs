...
namespace Amazon.DataZone.Model
{
    ...
    /// </summary>
    public partial class LineageNodeItem
    {
        private DateTime? _createdAt;
        private string _createdBy;
        private string _description;
        private string _domainId;
        private List<string> _downstreamLineageNodeIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        private List<string> _upstreamLineageNodeIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property DownstreamLineageNodeIds. 
        /// <para>
        ...
        /// </summary>
        public List<string> DownstreamLineageNodeIds
        {
            get { return this._downstreamLineageNodeIds; }
            set { this._downstreamLineageNodeIds = value; }
        }

        // Check to see if DownstreamLineageNodeIds property is set
        internal bool IsSetDownstreamLineageNodeIds()
        {
            return this._downstreamLineageNodeIds != null && (this._downstreamLineageNodeIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
        ...
        /// <summary>
        /// Gets and sets the property UpstreamLineageNodeIds. 
        /// <para>
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> UpstreamLineageNodeIds
        {
            get { return this._upstreamLineageNodeIds; }
            set { this._upstreamLineageNodeIds = value; }
        }

        // Check to see if UpstreamLineageNodeIds property is set
        internal bool IsSetUpstreamLineageNodeIds()
        {
            return this._upstreamLineageNodeIds != null && (this._upstreamLineageNodeIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
