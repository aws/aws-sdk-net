...
namespace Amazon.DataZone.Model
{
    ...
    public partial class GetMetadataGenerationRunResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<MetadataGenerationRunTypeStat> TypeStats { get; set; } = AWSConfigs.InitializeCollections ? new List<MetadataGenerationRunTypeStat>() : null;

        /// <summary>
        /// Checks to see if the TypeStats property is set.
        /// </summary>
        internal bool IsSetTypeStats() => this.TypeStats != null && (this.TypeStats.Count > 0 || !AWSConfigs.InitializeCollections);
