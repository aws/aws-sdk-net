...
{
    /// <summary>
    /// Container for the parameters to the GetRule operation. Gets the details of a rule
    /// in Amazon DataZone. A rule is a formal agreement that enforces specific requirements
    ...
    /// </summary>
    public partial class GetRuleRequest : AmazonDataZoneRequest
    {
        /// <summary>
        /// Gets and sets the property DomainIdentifier. 
        /// <para>
        /// The ID of the domain where the <c>GetRule</c> action is to be invoked.
        /// </para>
        /// </summary>
