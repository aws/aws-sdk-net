...
namespace Amazon.DataZone.Model
{
    ...
    public partial class BatchPutAttributesMetadataResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<BatchPutAttributeOutput> Attributes { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchPutAttributeOutput>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<AttributeError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<AttributeError>() : null;
