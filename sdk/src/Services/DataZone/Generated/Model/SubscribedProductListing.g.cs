...
namespace Amazon.DataZone.Model
{
    ...
    public partial class SubscribedProductListing
    {
        ...
        /// </summary>
        public List<AssetInDataProductListingItem> AssetListings { get; set; } = AWSConfigs.InitializeCollections ? new List<AssetInDataProductListingItem>() : null;

        /// <summary>
        /// Checks to see if the AssetListings property is set.
        /// </summary>
        internal bool IsSetAssetListings() => this.AssetListings != null && (this.AssetListings.Count > 0 || !AWSConfigs.InitializeCollections);
