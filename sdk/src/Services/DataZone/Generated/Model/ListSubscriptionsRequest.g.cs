...
{
    /// <summary>
    /// Container for the parameters to the ListSubscriptions operation. Lists subscriptions
    /// in Amazon DataZone.
    /// </summary>
    public partial class ListSubscriptionsRequest : AmazonDataZoneRequest
    {
        ...
        /// <summary>
        /// Checks to see if the SubscriptionRequestIdentifier property is set.
        /// </summary>
        internal bool IsSetSubscriptionRequestIdentifier() => this.SubscriptionRequestIdentifier != null;
    }
}
