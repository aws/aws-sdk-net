...
{
    /// <summary>
    /// Container for the parameters to the AssociateEnvironmentRole operation. Associates
    /// the environment role in Amazon DataZone.
    /// </summary>
    public partial class AssociateEnvironmentRoleRequest : AmazonDataZoneRequest
    {
        ...
        /// <summary>
        /// Checks to see if the EnvironmentRoleArn property is set.
        /// </summary>
        internal bool IsSetEnvironmentRoleArn() => this.EnvironmentRoleArn != null;
    }
}
