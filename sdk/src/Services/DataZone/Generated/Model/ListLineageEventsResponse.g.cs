...
{
    /// <summary>
    /// This is the response object from the ListLineageEvents operation.
    /// </summary>
    public partial class ListLineageEventsResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        /// </summary>
        public List<LineageEventSummary> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<LineageEventSummary>() : null;
