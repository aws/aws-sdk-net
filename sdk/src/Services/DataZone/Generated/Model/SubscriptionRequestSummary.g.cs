...
namespace Amazon.DataZone.Model
{
    ...
    public partial class SubscriptionRequestSummary
    {
        ...
        /// </summary>
        public List<MetadataFormSummary> MetadataFormsSummary { get; set; } = AWSConfigs.InitializeCollections ? new List<MetadataFormSummary>() : null;

        /// <summary>
        /// Checks to see if the MetadataFormsSummary property is set.
        /// </summary>
        internal bool IsSetMetadataFormsSummary() => this.MetadataFormsSummary != null && (this.MetadataFormsSummary.Count > 0 || !AWSConfigs.InitializeCollections);
