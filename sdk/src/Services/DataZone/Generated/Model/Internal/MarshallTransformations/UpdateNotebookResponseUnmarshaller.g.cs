...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNotebook operation.
    /// </summary>
    public partial class UpdateNotebookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateNotebookResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("computeId", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ComputeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("gitMetadata", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.GitMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.LockExpiresAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.LockedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LockedBy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateNotebookResponseUnmarshaller _instance = new UpdateNotebookResponseUnmarshaller();

        internal static UpdateNotebookResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateNotebookResponseUnmarshaller Instance => _instance;
    }
}
