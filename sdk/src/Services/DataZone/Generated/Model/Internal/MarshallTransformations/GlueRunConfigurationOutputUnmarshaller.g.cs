...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GlueRunConfigurationOutputUnmarshaller : IJsonUnmarshaller<GlueRunConfigurationOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GlueRunConfigurationOutput();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("autoImportDataQualityResult", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static GlueRunConfigurationOutputUnmarshaller Instance => _instance;
    }
}
