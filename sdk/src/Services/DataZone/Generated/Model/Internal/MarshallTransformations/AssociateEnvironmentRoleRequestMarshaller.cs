...
{
    /// <summary>
    /// AssociateEnvironmentRole Request Marshaller
    /// </summary>       
    public class AssociateEnvironmentRoleRequestMarshaller : IMarshaller<IRequest, AssociateEnvironmentRoleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateEnvironmentRoleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateEnvironmentRoleRequest publicRequest)
        {
        ...
        private static AssociateEnvironmentRoleRequestMarshaller _instance = new AssociateEnvironmentRoleRequestMarshaller();        

        internal static AssociateEnvironmentRoleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateEnvironmentRoleRequestMarshaller Instance
        {
            get
            {
                return _instance;
