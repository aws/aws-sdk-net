...
{
    /// <summary>
    /// Response Unmarshaller for GetAccountPool operation
    /// </summary>  
    public class GetAccountPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccountPoolResponse response = new GetAccountPoolResponse();
        ...
        private static GetAccountPoolResponseUnmarshaller _instance = new GetAccountPoolResponseUnmarshaller();        

        internal static GetAccountPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
