        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assetFormsOutput", targetDepth))
                {
                    ...
                    response.AssetFormsOutput = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EnableSetting = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.LastRunAt = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastRunErrorMessage", targetDepth))
                {
                    var unmarshaller = DataSourceErrorMessageUnmarshaller.Instance;
                    response.LastRunErrorMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastRunStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastRunStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("recommendation", targetDepth))
                {
                    ...
                    response.Recommendation = unmarshaller.Unmarshall(context);
                    continue;
                }
