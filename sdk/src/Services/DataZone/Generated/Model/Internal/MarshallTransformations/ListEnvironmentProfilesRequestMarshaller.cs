...
{
    /// <summary>
    /// ListEnvironmentProfiles Request Marshaller
    /// </summary>       
    public class ListEnvironmentProfilesRequestMarshaller : IMarshaller<IRequest, ListEnvironmentProfilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListEnvironmentProfilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListEnvironmentProfilesRequest publicRequest)
        {
        ...
        private static ListEnvironmentProfilesRequestMarshaller _instance = new ListEnvironmentProfilesRequestMarshaller();        

        internal static ListEnvironmentProfilesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEnvironmentProfilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
