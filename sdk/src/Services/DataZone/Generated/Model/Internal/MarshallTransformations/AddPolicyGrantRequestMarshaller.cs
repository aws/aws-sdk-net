...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AddPolicyGrantRequestMarshaller : IMarshaller<IRequest, AddPolicyGrantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AddPolicyGrantRequestMarshaller _instance = new AddPolicyGrantRequestMarshaller();        

        internal static AddPolicyGrantRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddPolicyGrantRequestMarshaller Instance
        {
            get
            {
                return _instance;
