        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("environmentActions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EnvironmentActions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("lastDeployment", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.LastDeployment = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("provisionedResources", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ProvisionedResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
