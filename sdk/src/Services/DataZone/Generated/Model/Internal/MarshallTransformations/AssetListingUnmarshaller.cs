...
{
    /// <summary>
    /// Response Unmarshaller for AssetListing Object
    /// </summary>  
    public class AssetListingUnmarshaller : IUnmarshaller<AssetListing, XmlUnmarshallerContext>, IUnmarshaller<AssetListing, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AssetListing IUnmarshaller<AssetListing, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AssetListing Unmarshall(JsonUnmarshallerContext context)
        {
            AssetListing unmarshalledObject = new AssetListing();
        ...
        private static AssetListingUnmarshaller _instance = new AssetListingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssetListingUnmarshaller Instance
        {
            get
            {
                return _instance;
