...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLineageEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLineageEventResponse response = new DeleteLineageEventResponse();
        ...
        internal static DeleteLineageEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLineageEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
