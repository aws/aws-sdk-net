...
{
    /// <summary>
    /// Response Unmarshaller for GetNotebookRun operation
    /// </summary>  
    public class GetNotebookRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetNotebookRunResponse response = new GetNotebookRunResponse();
        ...
        private static GetNotebookRunResponseUnmarshaller _instance = new GetNotebookRunResponseUnmarshaller();        

        internal static GetNotebookRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNotebookRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
