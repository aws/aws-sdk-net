...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RedshiftStorageUnmarshaller : IJsonUnmarshaller<RedshiftStorage, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RedshiftStorage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RedshiftStorage();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RedshiftStorageUnmarshaller Instance => _instance;
    }
}
