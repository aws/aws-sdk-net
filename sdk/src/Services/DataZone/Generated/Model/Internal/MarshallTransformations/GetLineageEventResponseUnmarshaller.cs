...
{
    /// <summary>
    /// Response Unmarshaller for GetLineageEvent operation
    /// </summary>  
    public class GetLineageEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLineageEventResponse response = new GetLineageEventResponse();
            ...
            if (context.ResponseData.IsHeaderPresent("Processing-Status"))
                response.ProcessingStatus = context.ResponseData.GetHeaderValue("Processing-Status");
        ...
        private static GetLineageEventResponseUnmarshaller _instance = new GetLineageEventResponseUnmarshaller();        

        internal static GetLineageEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLineageEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
