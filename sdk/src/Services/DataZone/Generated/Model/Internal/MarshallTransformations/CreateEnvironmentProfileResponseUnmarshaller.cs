...
{
    /// <summary>
    /// Response Unmarshaller for CreateEnvironmentProfile operation
    /// </summary>  
    public class CreateEnvironmentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEnvironmentProfileResponse response = new CreateEnvironmentProfileResponse();
        ...
        private static CreateEnvironmentProfileResponseUnmarshaller _instance = new CreateEnvironmentProfileResponseUnmarshaller();        

        internal static CreateEnvironmentProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEnvironmentProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
