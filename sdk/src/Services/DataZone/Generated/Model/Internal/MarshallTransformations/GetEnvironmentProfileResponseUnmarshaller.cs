...
{
    /// <summary>
    /// Response Unmarshaller for GetEnvironmentProfile operation
    /// </summary>  
    public class GetEnvironmentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEnvironmentProfileResponse response = new GetEnvironmentProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AwsAccountRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetEnvironmentProfileResponseUnmarshaller _instance = new GetEnvironmentProfileResponseUnmarshaller();        

        internal static GetEnvironmentProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEnvironmentProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
