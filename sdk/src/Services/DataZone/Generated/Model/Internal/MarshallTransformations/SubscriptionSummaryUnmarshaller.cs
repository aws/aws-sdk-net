...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubscriptionSummaryUnmarshaller : IUnmarshaller<SubscriptionSummary, XmlUnmarshallerContext>, IUnmarshaller<SubscriptionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SubscriptionSummary IUnmarshaller<SubscriptionSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SubscriptionSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("retainPermissions", targetDepth))
                {
                    ...
                    unmarshalledObject.RetainPermissions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("subscribedListing", targetDepth))
                {
                    ...
                    unmarshalledObject.SubscribedListing = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("subscribedPrincipal", targetDepth))
                {
                    var unmarshaller = SubscribedPrincipalUnmarshaller.Instance;
                    unmarshalledObject.SubscribedPrincipal = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("subscriptionRequestId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SubscriptionRequestId = unmarshaller.Unmarshall(context);
                    continue;
                }
