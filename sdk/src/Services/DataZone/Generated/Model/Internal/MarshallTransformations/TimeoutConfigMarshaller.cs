    ...
    public class TimeoutConfigMarshaller : IRequestMarshaller<TimeoutConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(TimeoutConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetRunTimeoutInMinutes())
            {
                context.Writer.WritePropertyName("runTimeoutInMinutes");
                context.Writer.WriteNumberValue(requestObject.RunTimeoutInMinutes.Value);
            }
