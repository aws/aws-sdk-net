    ...
    public class CreateProjectProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EnvironmentConfiguration, EnvironmentConfigurationUnmarshaller>(EnvironmentConfigurationUnmarshaller.Instance);
                    response.EnvironmentConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
