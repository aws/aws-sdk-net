...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateListingChangeSetRequestMarshaller : IMarshaller<IRequest, CreateListingChangeSetRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateListingChangeSetRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetEntityIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.EntityIdentifier);
            }
            if (publicRequest.IsSetEntityRevision())
            {
                context.Writer.WritePropertyName("entityRevision");
                context.Writer.WriteStringValue(publicRequest.EntityRevision);
            }
        ...
        private static readonly CreateListingChangeSetRequestMarshaller _instance = new();

        internal static CreateListingChangeSetRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateListingChangeSetRequestMarshaller Instance => _instance;
    }
}
