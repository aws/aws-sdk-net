...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataProduct operation.
    /// </summary>
    public partial class CreateDataProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateDataProductResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DataProductItem, DataProductItemUnmarshaller>(DataProductItemUnmarshaller.Instance);
        ...
        private static CreateDataProductResponseUnmarshaller _instance = new CreateDataProductResponseUnmarshaller();

        internal static CreateDataProductResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateDataProductResponseUnmarshaller Instance => _instance;
    }
}
