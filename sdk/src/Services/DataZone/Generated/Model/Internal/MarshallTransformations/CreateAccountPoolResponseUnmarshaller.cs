...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccountPool operation
    /// </summary>  
    public class CreateAccountPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAccountPoolResponse response = new CreateAccountPoolResponse();
            ...
            {
                if (context.TestExpression("accountSource", targetDepth, ref reader))
                {
                    var unmarshaller = AccountSourceUnmarshaller.Instance;
                    response.AccountSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("resolutionStrategy", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResolutionStrategy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateAccountPoolResponseUnmarshaller _instance = new CreateAccountPoolResponseUnmarshaller();        

        internal static CreateAccountPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
