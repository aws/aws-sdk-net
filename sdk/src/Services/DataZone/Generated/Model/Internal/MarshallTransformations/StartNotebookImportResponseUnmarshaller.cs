...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartNotebookImportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartNotebookImportResponse response = new StartNotebookImportResponse();
        ...
        internal static StartNotebookImportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartNotebookImportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
