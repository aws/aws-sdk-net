...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSubscriptionGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSubscriptionGrantResponse response = new GetSubscriptionGrantResponse();
        ...
        internal static GetSubscriptionGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubscriptionGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
