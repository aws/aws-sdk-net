...
{
    /// <summary>
    /// Response Unmarshaller for AcceptSubscriptionRequest operation
    /// </summary>  
    public class AcceptSubscriptionRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptSubscriptionRequestResponse response = new AcceptSubscriptionRequestResponse();
        ...
        private static AcceptSubscriptionRequestResponseUnmarshaller _instance = new AcceptSubscriptionRequestResponseUnmarshaller();        

        internal static AcceptSubscriptionRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptSubscriptionRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
