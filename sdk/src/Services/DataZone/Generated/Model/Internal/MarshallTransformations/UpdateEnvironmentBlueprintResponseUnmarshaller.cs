...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEnvironmentBlueprint operation
    /// </summary>  
    public class UpdateEnvironmentBlueprintResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEnvironmentBlueprintResponse response = new UpdateEnvironmentBlueprintResponse();
        ...
        private static UpdateEnvironmentBlueprintResponseUnmarshaller _instance = new UpdateEnvironmentBlueprintResponseUnmarshaller();        

        internal static UpdateEnvironmentBlueprintResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEnvironmentBlueprintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
