...
{
    /// <summary>
    /// Response Unmarshaller for GetNotebook operation
    /// </summary>  
    public class GetNotebookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetNotebookResponse response = new GetNotebookResponse();
        ...
        private static GetNotebookResponseUnmarshaller _instance = new GetNotebookResponseUnmarshaller();        

        internal static GetNotebookResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNotebookResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
