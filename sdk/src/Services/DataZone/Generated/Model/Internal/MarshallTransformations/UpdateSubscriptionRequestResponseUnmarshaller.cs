...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSubscriptionRequest operation
    /// </summary>  
    public class UpdateSubscriptionRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSubscriptionRequestResponse response = new UpdateSubscriptionRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("decisionComment", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("existingSubscriptionId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("metadataForms", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("requestReason", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequestReason = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("reviewerId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("subscribedListings", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("subscribedPrincipals", targetDepth, ref reader))
                {
        ...
        private static UpdateSubscriptionRequestResponseUnmarshaller _instance = new UpdateSubscriptionRequestResponseUnmarshaller();        

        internal static UpdateSubscriptionRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubscriptionRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
