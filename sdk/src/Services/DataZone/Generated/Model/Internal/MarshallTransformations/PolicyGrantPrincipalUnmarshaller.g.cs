...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PolicyGrantPrincipalUnmarshaller : IJsonUnmarshaller<PolicyGrantPrincipal, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PolicyGrantPrincipal Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PolicyGrantPrincipal();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PolicyGrantPrincipalUnmarshaller Instance => _instance;
    }
}
