...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetTypeItemUnmarshaller : IUnmarshaller<AssetTypeItem, XmlUnmarshallerContext>, IUnmarshaller<AssetTypeItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AssetTypeItem IUnmarshaller<AssetTypeItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AssetTypeItem Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
