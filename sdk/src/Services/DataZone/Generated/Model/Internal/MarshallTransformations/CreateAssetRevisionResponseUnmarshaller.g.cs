...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAssetRevisionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAssetRevisionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("predictionConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PredictionConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateAssetRevisionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAssetRevisionResponseUnmarshaller Instance => _instance;
    }
}
