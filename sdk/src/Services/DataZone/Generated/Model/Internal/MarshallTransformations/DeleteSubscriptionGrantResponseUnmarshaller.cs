...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSubscriptionGrant operation
    /// </summary>  
    public class DeleteSubscriptionGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSubscriptionGrantResponse response = new DeleteSubscriptionGrantResponse();
        ...
        private static DeleteSubscriptionGrantResponseUnmarshaller _instance = new DeleteSubscriptionGrantResponseUnmarshaller();        

        internal static DeleteSubscriptionGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSubscriptionGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
