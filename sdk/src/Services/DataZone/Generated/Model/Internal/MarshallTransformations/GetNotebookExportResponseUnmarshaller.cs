...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetNotebookExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetNotebookExportResponse response = new GetNotebookExportResponse();
        ...
        internal static GetNotebookExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNotebookExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
