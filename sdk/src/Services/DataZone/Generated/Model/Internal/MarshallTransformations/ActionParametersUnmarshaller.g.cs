...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ActionParametersUnmarshaller : IJsonUnmarshaller<ActionParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ActionParameters();
            ...
            {
                if (context.TestExpression("awsConsoleLink", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ActionParametersUnmarshaller Instance => _instance;
    }
}
