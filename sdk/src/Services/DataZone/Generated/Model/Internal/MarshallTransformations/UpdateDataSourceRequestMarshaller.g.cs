...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateDataSourceRequestMarshaller : IMarshaller<IRequest, UpdateDataSourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateDataSourceRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetRetainPermissionsOnRevokeFailure())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.RetainPermissionsOnRevokeFailure.Value);
            }
        ...
        private static readonly UpdateDataSourceRequestMarshaller _instance = new();

        internal static UpdateDataSourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDataSourceRequestMarshaller Instance => _instance;
    }
}
