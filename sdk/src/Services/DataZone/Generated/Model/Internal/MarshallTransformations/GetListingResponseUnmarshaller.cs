...
{
    /// <summary>
    /// Response Unmarshaller for GetListing operation
    /// </summary>  
    public class GetListingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ListingItemUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ListingRevision = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetListingResponseUnmarshaller _instance = new GetListingResponseUnmarshaller();        

        internal static GetListingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetListingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
