...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssetScopeUnmarshaller : IJsonUnmarshaller<AssetScope, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AssetScope();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("filterIds", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AssetScopeUnmarshaller Instance => _instance;
    }
}
