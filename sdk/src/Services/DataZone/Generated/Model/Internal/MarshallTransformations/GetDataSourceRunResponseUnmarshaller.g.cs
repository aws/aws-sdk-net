...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDataSourceRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDataSourceRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataSourceConfigurationSnapshot", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DataSourceConfigurationSnapshot = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetDataSourceRunResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDataSourceRunResponseUnmarshaller Instance => _instance;
    }
}
