...
{
    /// <summary>
    /// SearchTypes Request Marshaller
    /// </summary>
    public partial class SearchTypesRequestMarshaller : IMarshaller<IRequest, SearchTypesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchTypesRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(SearchTypesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetManaged())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.Managed.Value);
            }
        ...
        private static readonly SearchTypesRequestMarshaller _instance = new();

        internal static SearchTypesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchTypesRequestMarshaller Instance => _instance;
    }
}
