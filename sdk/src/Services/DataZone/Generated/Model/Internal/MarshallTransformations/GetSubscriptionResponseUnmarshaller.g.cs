...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSubscriptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("retainPermissions", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("subscribedListing", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("subscribedPrincipal", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("subscriptionRequestId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        internal static GetSubscriptionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSubscriptionResponseUnmarshaller Instance => _instance;
    }
}
