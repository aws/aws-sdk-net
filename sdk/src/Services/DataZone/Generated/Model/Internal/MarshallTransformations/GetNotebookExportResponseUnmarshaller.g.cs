...
{
    /// <summary>
    /// Response Unmarshaller for GetNotebookExport operation.
    /// </summary>
    public partial class GetNotebookExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetNotebookExportResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NotebookExportErrorUnmarshaller.Instance;
        ...
        private static GetNotebookExportResponseUnmarshaller _instance = new GetNotebookExportResponseUnmarshaller();

        internal static GetNotebookExportResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetNotebookExportResponseUnmarshaller Instance => _instance;
    }
}
