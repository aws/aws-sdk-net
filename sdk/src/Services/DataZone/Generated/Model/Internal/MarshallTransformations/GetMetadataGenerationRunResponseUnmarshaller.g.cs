...
{
    /// <summary>
    /// Response Unmarshaller for GetMetadataGenerationRun operation.
    /// </summary>
    public partial class GetMetadataGenerationRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetMetadataGenerationRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("typeStats", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MetadataGenerationRunTypeStat, MetadataGenerationRunTypeStatUnmarshaller>(MetadataGenerationRunTypeStatUnmarshaller.Instance);
                    unmarshalledObject.TypeStats = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetMetadataGenerationRunResponseUnmarshaller _instance = new GetMetadataGenerationRunResponseUnmarshaller();

        internal static GetMetadataGenerationRunResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMetadataGenerationRunResponseUnmarshaller Instance => _instance;
    }
}
