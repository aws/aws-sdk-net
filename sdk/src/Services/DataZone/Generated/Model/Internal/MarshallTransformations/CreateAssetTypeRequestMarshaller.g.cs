...
{
    /// <summary>
    /// CreateAssetType Request Marshaller
    /// </summary>
    public partial class CreateAssetTypeRequestMarshaller : IMarshaller<IRequest, CreateAssetTypeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAssetTypeRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateAssetTypeRequest publicRequest)
        {
        ...
        private static readonly CreateAssetTypeRequestMarshaller _instance = new();

        internal static CreateAssetTypeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAssetTypeRequestMarshaller Instance => _instance;
    }
}
