        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("connectionCredentials", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConnectionCredentials = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("environmentUserRole", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EnvironmentUserRole = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
