...
{
    /// <summary>
    /// Response Unmarshaller for GetAssetType operation
    /// </summary>  
    public class GetAssetTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAssetTypeResponse response = new GetAssetTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, FormEntryOutput, StringUnmarshaller, FormEntryOutputUnmarshaller>(StringUnmarshaller.Instance, FormEntryOutputUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OriginDomainId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("originProjectId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OriginProjectId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetAssetTypeResponseUnmarshaller _instance = new GetAssetTypeResponseUnmarshaller();        

        internal static GetAssetTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssetTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
