...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RunStatisticsForAssetsUnmarshaller : IUnmarshaller<RunStatisticsForAssets, XmlUnmarshallerContext>, IUnmarshaller<RunStatisticsForAssets, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RunStatisticsForAssets IUnmarshaller<RunStatisticsForAssets, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RunStatisticsForAssets Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("added", targetDepth))
                {
                    ...
                    unmarshalledObject.Added = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.Unchanged = unmarshaller.Unmarshall(context);
                    continue;
                }
