        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("applicableAssetTypes", targetDepth))
                {
                    ...
                    response.ApplicableAssetTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("authorizedPrincipals", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.AuthorizedPrincipals = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ManageAccessRole = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("subscriptionTargetConfig", targetDepth))
                {
                    ...
                    response.SubscriptionTargetConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
