...
{
    /// <summary>
    /// ConnectivityPropertiesPatch Marshaller
    /// </summary>
    public class ConnectivityPropertiesPatchMarshaller : IRequestMarshaller<ConnectivityPropertiesPatch, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ConnectivityPropertiesPatch requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAuthenticationConfiguration())
            {
                ...
                var marshaller = AuthenticationConfigurationPatchMarshaller.Instance;
        ...
        /// </summary>
        public readonly static ConnectivityPropertiesPatchMarshaller Instance = new ConnectivityPropertiesPatchMarshaller();
