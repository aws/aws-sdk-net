...
{
    /// <summary>
    /// DomainUnitPolicyGrantPrincipal Marshaller
    /// </summary>
    public class DomainUnitPolicyGrantPrincipalMarshaller : IRequestMarshaller<DomainUnitPolicyGrantPrincipal, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DomainUnitPolicyGrantPrincipal requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static DomainUnitPolicyGrantPrincipalMarshaller Instance = new DomainUnitPolicyGrantPrincipalMarshaller();
