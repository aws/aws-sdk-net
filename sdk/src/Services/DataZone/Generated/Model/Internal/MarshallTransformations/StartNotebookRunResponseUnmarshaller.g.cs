...
{
    /// <summary>
    /// Response Unmarshaller for StartNotebookRun operation.
    /// </summary>
    public partial class StartNotebookRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StartNotebookRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("cellOrder", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.CellOrder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = ComputeConfigUnmarshaller.Instance;
                ...
                if (context.TestExpression("environmentConfiguration", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EnvironmentConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("error", targetDepth, ref reader))
                {
                    var unmarshaller = NotebookRunErrorUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NotebookId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StorageConfigUnmarshaller.Instance;
                    unmarshalledObject.StorageConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("timeoutConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("triggerSource", targetDepth, ref reader))
                {
                    var unmarshaller = TriggerSourceUnmarshaller.Instance;
                    unmarshalledObject.TriggerSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartNotebookRunResponseUnmarshaller _instance = new StartNotebookRunResponseUnmarshaller();

        internal static StartNotebookRunResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartNotebookRunResponseUnmarshaller Instance => _instance;
    }
}
