...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SearchInventoryResultItem, SearchInventoryResultItemUnmarshaller>(SearchInventoryResultItemUnmarshaller.Instance);
                ...
                if (context.TestExpression("totalMatchCount", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TotalMatchCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static SearchResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchResponseUnmarshaller Instance => _instance;
    }
}
