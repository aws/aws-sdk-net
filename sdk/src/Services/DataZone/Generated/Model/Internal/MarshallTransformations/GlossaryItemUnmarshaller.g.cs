...
{
    /// <summary>
    /// Response Unmarshaller for GlossaryItem Object
    /// </summary>
    public partial class GlossaryItemUnmarshaller : IJsonUnmarshaller<GlossaryItem, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public GlossaryItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new GlossaryItem();
        ...
        private static GlossaryItemUnmarshaller _instance = new GlossaryItemUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GlossaryItemUnmarshaller Instance => _instance;
    }
}
