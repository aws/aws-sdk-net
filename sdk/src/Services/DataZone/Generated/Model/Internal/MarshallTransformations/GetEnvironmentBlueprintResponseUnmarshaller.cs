...
{
    /// <summary>
    /// Response Unmarshaller for GetEnvironmentBlueprint operation
    /// </summary>  
    public class GetEnvironmentBlueprintResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEnvironmentBlueprintResponse response = new GetEnvironmentBlueprintResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("deploymentProperties", targetDepth, ref reader))
                {
                    var unmarshaller = DeploymentPropertiesUnmarshaller.Instance;
                    response.DeploymentProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("provisioningProperties", targetDepth, ref reader))
                {
                    ...
                    response.ProvisioningProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetEnvironmentBlueprintResponseUnmarshaller _instance = new GetEnvironmentBlueprintResponseUnmarshaller();        

        internal static GetEnvironmentBlueprintResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEnvironmentBlueprintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
