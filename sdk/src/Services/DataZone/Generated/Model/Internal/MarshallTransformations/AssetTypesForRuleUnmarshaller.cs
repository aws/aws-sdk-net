...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetTypesForRuleUnmarshaller : IJsonUnmarshaller<AssetTypesForRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetTypesForRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("specificAssetTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SpecificAssetTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
