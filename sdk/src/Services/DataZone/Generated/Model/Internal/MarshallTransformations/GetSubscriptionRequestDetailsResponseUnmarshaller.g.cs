...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSubscriptionRequestDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSubscriptionRequestDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("metadataForms", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MetadataForms = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetSubscriptionRequestDetailsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSubscriptionRequestDetailsResponseUnmarshaller Instance => _instance;
    }
}
