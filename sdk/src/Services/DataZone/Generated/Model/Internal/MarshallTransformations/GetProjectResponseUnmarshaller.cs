...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetProjectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("environmentDeploymentDetails", targetDepth, ref reader))
                {
                    ...
                    response.EnvironmentDeploymentDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProjectProfileId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("resourceTags", targetDepth, ref reader))
                {
                    ...
                    response.ResourceTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetProjectResponseUnmarshaller _instance = new GetProjectResponseUnmarshaller();        

        internal static GetProjectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProjectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
