...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartNotebookExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartNotebookExportResponse response = new StartNotebookExportResponse();
        ...
        internal static StartNotebookExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartNotebookExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
