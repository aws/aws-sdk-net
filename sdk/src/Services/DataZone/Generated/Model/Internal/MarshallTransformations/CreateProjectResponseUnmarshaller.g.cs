...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateProjectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateProjectResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("environmentDeploymentDetails", targetDepth, ref reader))
                {
                    var unmarshaller = EnvironmentDeploymentDetailsUnmarshaller.Instance;
                    unmarshalledObject.EnvironmentDeploymentDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("projectProfileId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProjectProfileId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EnvironmentConfigurationUserParameter, EnvironmentConfigurationUserParameterUnmarshaller>(EnvironmentConfigurationUserParameterUnmarshaller.Instance);
                    unmarshalledObject.UserParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateProjectResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateProjectResponseUnmarshaller Instance => _instance;
    }
}
