...
{
    /// <summary>
    /// Response Unmarshaller for StopNotebookRun operation
    /// </summary>  
    public class StopNotebookRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopNotebookRunResponse response = new StopNotebookRunResponse();
        ...
        private static StopNotebookRunResponseUnmarshaller _instance = new StopNotebookRunResponseUnmarshaller();        

        internal static StopNotebookRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopNotebookRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
