...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomAccountPoolHandlerUnmarshaller : IJsonUnmarshaller<CustomAccountPoolHandler, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomAccountPoolHandler Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("lambdaExecutionRoleArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LambdaExecutionRoleArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
