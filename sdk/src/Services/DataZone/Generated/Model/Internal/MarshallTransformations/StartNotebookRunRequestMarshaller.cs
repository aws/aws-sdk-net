...
{
    /// <summary>
    /// StartNotebookRun Request Marshaller
    /// </summary>       
    public class StartNotebookRunRequestMarshaller : IMarshaller<IRequest, StartNotebookRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartNotebookRunRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartNotebookRunRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/domains/{domainIdentifier}/notebook-runs";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetNotebookIdentifier())
            {
            ...
            {
                context.Writer.WritePropertyName("scheduleIdentifier");
                context.Writer.WriteStringValue(publicRequest.ScheduleIdentifier);
            }

            if(publicRequest.IsSetTimeoutConfiguration())
            {
                context.Writer.WritePropertyName("timeoutConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = TimeoutConfigMarshaller.Instance;
                marshaller.Marshall(publicRequest.TimeoutConfiguration, context);

                context.Writer.WriteEndObject();
            }

            if(publicRequest.IsSetTriggerSource())
            {
                context.Writer.WritePropertyName("triggerSource");
                context.Writer.WriteStartObject();

                var marshaller = TriggerSourceMarshaller.Instance;
                marshaller.Marshall(publicRequest.TriggerSource, context);
        ...
        private static StartNotebookRunRequestMarshaller _instance = new StartNotebookRunRequestMarshaller();        

        internal static StartNotebookRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartNotebookRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
