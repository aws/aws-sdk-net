...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EnvironmentBlueprintConfigurationItemUnmarshaller : IJsonUnmarshaller<EnvironmentBlueprintConfigurationItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EnvironmentBlueprintConfigurationItem();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("allowUserProvidedConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AllowUserProvidedConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("resourceConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ResourceConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static EnvironmentBlueprintConfigurationItemUnmarshaller Instance => _instance;
    }
}
