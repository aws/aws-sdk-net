...
{
    /// <summary>
    /// Response Unmarshaller for CreateGroupProfile operation
    /// </summary>  
    public class CreateGroupProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGroupProfileResponse response = new CreateGroupProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GroupName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("rolePrincipalArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RolePrincipalArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("rolePrincipalId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RolePrincipalId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateGroupProfileResponseUnmarshaller _instance = new CreateGroupProfileResponseUnmarshaller();        

        internal static CreateGroupProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGroupProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
