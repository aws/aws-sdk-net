...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListPolicyGrantsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListPolicyGrantsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("grantList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.GrantList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListPolicyGrantsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListPolicyGrantsResponseUnmarshaller Instance => _instance;
    }
}
