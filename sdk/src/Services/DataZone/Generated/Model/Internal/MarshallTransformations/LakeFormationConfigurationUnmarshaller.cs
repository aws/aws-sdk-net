        ...
        public LakeFormationConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("locationRegistrationExcludeS3Locations", targetDepth))
                {
                    ...
                    unmarshalledObject.LocationRegistrationExcludeS3Locations = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("locationRegistrationRole", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LocationRegistrationRole = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
