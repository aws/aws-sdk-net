    ...
    public class NetworkConfigMarshaller : IRequestMarshaller<NetworkConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(NetworkConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetNetworkAccessType())
            {
                context.Writer.WritePropertyName("networkAccessType");
                context.Writer.WriteStringValue(requestObject.NetworkAccessType);
            }
