...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HyperPodPropertiesOutputUnmarshaller : IJsonUnmarshaller<HyperPodPropertiesOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HyperPodPropertiesOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Orchestrator = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
