...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSubscriptionGrantStatus operation
    /// </summary>  
    public class UpdateSubscriptionGrantStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSubscriptionGrantStatusResponse response = new UpdateSubscriptionGrantStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("assets", targetDepth, ref reader))
                {
                    ...
                    response.Assets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("grantedEntity", targetDepth, ref reader))
                {
                    var unmarshaller = GrantedEntityUnmarshaller.Instance;
                    response.GrantedEntity = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("subscriptionTargetId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SubscriptionTargetId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateSubscriptionGrantStatusResponseUnmarshaller _instance = new UpdateSubscriptionGrantStatusResponseUnmarshaller();        

        internal static UpdateSubscriptionGrantStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubscriptionGrantStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
