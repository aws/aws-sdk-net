        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assets", targetDepth))
                {
                    ...
                    response.Assets = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("grantedEntity", targetDepth))
                {
                    ...
                    response.GrantedEntity = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SubscriptionId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("subscriptionTargetId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SubscriptionTargetId = unmarshaller.Unmarshall(context);
                    continue;
                }
