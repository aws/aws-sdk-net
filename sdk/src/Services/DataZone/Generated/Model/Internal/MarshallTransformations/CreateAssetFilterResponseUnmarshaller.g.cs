...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssetFilter operation.
    /// </summary>
    public partial class CreateAssetFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAssetFilterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AssetFilterConfigurationUnmarshaller.Instance;
                ...
                if (context.TestExpression("effectiveColumnNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.EffectiveColumnNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("effectiveRowFilter", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EffectiveRowFilter = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateAssetFilterResponseUnmarshaller _instance = new CreateAssetFilterResponseUnmarshaller();

        internal static CreateAssetFilterResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAssetFilterResponseUnmarshaller Instance => _instance;
    }
}
