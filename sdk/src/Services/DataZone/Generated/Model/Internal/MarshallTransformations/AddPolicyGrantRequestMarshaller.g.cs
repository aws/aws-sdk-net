...
{
    /// <summary>
    /// AddPolicyGrant Request Marshaller
    /// </summary>
    public partial class AddPolicyGrantRequestMarshaller : IMarshaller<IRequest, AddPolicyGrantRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddPolicyGrantRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(AddPolicyGrantRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/domains/{domainIdentifier}/policies/managed/{entityType}/{entityIdentifier}/addGrant";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetDetail())
            {
                ...
                var marshaller = PolicyGrantDetailMarshaller.Instance;
        ...
        private static readonly AddPolicyGrantRequestMarshaller _instance = new();

        internal static AddPolicyGrantRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddPolicyGrantRequestMarshaller Instance => _instance;
    }
}
