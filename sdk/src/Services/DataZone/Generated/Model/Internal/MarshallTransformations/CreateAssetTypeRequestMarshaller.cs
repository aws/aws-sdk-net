...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAssetTypeRequestMarshaller : IMarshaller<IRequest, CreateAssetTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateAssetTypeRequestMarshaller _instance = new CreateAssetTypeRequestMarshaller();        

        internal static CreateAssetTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssetTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
