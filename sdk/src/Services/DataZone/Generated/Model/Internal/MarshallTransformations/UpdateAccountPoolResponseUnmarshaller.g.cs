...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAccountPool operation.
    /// </summary>
    public partial class UpdateAccountPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateAccountPoolResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("accountSource", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AccountSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAccountPoolResponseUnmarshaller _instance = new UpdateAccountPoolResponseUnmarshaller();

        internal static UpdateAccountPoolResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAccountPoolResponseUnmarshaller Instance => _instance;
    }
}
