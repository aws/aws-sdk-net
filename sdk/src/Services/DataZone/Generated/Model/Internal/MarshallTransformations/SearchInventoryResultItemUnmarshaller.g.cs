...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchInventoryResultItemUnmarshaller : IJsonUnmarshaller<SearchInventoryResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchInventoryResultItem();
            ...
            {
                if (context.TestExpression("assetItem", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("dataProductItem", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("glossaryItem", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("glossaryTermItem", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static SearchInventoryResultItemUnmarshaller Instance => _instance;
    }
}
