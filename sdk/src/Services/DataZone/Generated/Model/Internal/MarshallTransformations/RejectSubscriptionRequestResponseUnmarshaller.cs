...
{
    /// <summary>
    /// Response Unmarshaller for RejectSubscriptionRequest operation
    /// </summary>  
    public class RejectSubscriptionRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectSubscriptionRequestResponse response = new RejectSubscriptionRequestResponse();
        ...
        private static RejectSubscriptionRequestResponseUnmarshaller _instance = new RejectSubscriptionRequestResponseUnmarshaller();        

        internal static RejectSubscriptionRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectSubscriptionRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
