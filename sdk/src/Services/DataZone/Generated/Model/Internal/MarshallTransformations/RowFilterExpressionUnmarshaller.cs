...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RowFilterExpressionUnmarshaller : IUnmarshaller<RowFilterExpression, XmlUnmarshallerContext>, IUnmarshaller<RowFilterExpression, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RowFilterExpression IUnmarshaller<RowFilterExpression, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RowFilterExpression Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("greaterThanOrEqualTo", targetDepth))
                {
                    ...
                    unmarshalledObject.GreaterThanOrEqualTo = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("isNotNull", targetDepth))
                {
                    ...
                    unmarshalledObject.IsNotNull = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("lessThanOrEqualTo", targetDepth))
                {
                    ...
                    unmarshalledObject.LessThanOrEqualTo = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("like", targetDepth))
                {
                    var unmarshaller = LikeExpressionUnmarshaller.Instance;
                    unmarshalledObject.Like = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("notLike", targetDepth))
                {
                    ...
                    unmarshalledObject.NotLike = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
