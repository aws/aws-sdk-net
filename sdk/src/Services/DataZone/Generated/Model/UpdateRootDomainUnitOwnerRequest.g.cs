...
{
    /// <summary>
    /// Container for the parameters to the UpdateRootDomainUnitOwner operation. Updates the
    /// owner of the root domain unit.
    /// </summary>
    public partial class UpdateRootDomainUnitOwnerRequest : AmazonDataZoneRequest
    {
        ...
        /// <summary>
        /// Checks to see if the CurrentOwner property is set.
        /// </summary>
        internal bool IsSetCurrentOwner() => this.CurrentOwner != null;
        ...
        /// <summary>
        /// Checks to see if the NewOwner property is set.
        /// </summary>
        internal bool IsSetNewOwner() => this.NewOwner != null;
    }
}
