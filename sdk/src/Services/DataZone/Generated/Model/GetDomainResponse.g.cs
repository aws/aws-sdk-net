...
namespace Amazon.DataZone.Model
{
    ...
    public partial class GetDomainResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public DeleteProgress DeleteProgress { get; set; }

        /// <summary>
        /// Checks to see if the DeleteProgress property is set.
        /// </summary>
        internal bool IsSetDeleteProgress() => this.DeleteProgress != null;
        ...
        /// </summary>
        public List<FailureReason> FailureReasons { get; set; } = AWSConfigs.InitializeCollections ? new List<FailureReason>() : null;
