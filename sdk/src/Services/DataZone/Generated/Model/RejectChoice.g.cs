...
namespace Amazon.DataZone.Model
{
    ...
    public partial class RejectChoice
    {
        ...
        /// </summary>
        public List<int> PredictionChoices { get; set; } = AWSConfigs.InitializeCollections ? new List<int>() : null;

        /// <summary>
        /// Checks to see if the PredictionChoices property is set.
        /// </summary>
        internal bool IsSetPredictionChoices() => this.PredictionChoices != null && (this.PredictionChoices.Count > 0 || !AWSConfigs.InitializeCollections);
