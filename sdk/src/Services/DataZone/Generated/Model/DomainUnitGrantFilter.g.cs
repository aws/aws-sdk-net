...
namespace Amazon.DataZone.Model
{
    ...
    public partial class DomainUnitGrantFilter
    {
        ...
        /// </para>
        /// </summary>
        public AllDomainUnitsGrantFilter AllDomainUnitsGrantFilter { get; set; }

        /// <summary>
        /// Checks to see if the AllDomainUnitsGrantFilter property is set.
        /// </summary>
        internal bool IsSetAllDomainUnitsGrantFilter() => this.AllDomainUnitsGrantFilter != null;
    }
}
