...
{
    /// <summary>
    /// Container for the parameters to the DisassociateGovernedTerms operation. Disassociates
    /// restricted terms from an asset.
    /// </summary>
    public partial class DisassociateGovernedTermsRequest : AmazonDataZoneRequest
    {
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public GovernedEntityType EntityType { get; set; }
