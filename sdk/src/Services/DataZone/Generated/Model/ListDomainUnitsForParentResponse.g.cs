...
{
    /// <summary>
    /// This is the response object from the ListDomainUnitsForParent operation.
    /// </summary>
    public partial class ListDomainUnitsForParentResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        public List<DomainUnitSummary> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<DomainUnitSummary>() : null;
