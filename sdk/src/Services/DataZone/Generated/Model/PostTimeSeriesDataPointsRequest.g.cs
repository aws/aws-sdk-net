...
{
    /// <summary>
    /// Container for the parameters to the PostTimeSeriesDataPoints operation. Posts time
    /// series data points to Amazon DataZone for the specified asset.
    /// </summary>
    public partial class PostTimeSeriesDataPointsRequest : AmazonDataZoneRequest
    {
        /// <summary>
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public List<TimeSeriesDataPointFormInput> Forms { get; set; } = AWSConfigs.InitializeCollections ? new List<TimeSeriesDataPointFormInput>() : null;
