...
{
    /// <summary>
    /// Container for the parameters to the CreateEnvironmentAction operation. Creates an
    /// action for the environment, for example, creates a console link for an analytics tool
