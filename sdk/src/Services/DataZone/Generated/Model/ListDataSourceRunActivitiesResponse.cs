...
namespace Amazon.DataZone.Model
{
    ...
    {
        private List<DataSourceRunActivity> _items = new List<DataSourceRunActivity>();
        ...
        /// <para>
        /// When the number of activities is greater than the default value for the <code>MaxResults</code>
