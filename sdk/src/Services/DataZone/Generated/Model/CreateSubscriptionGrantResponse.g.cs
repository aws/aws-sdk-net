...
{
    /// <summary>
    /// This is the response object from the CreateSubscriptionGrant operation.
    /// </summary>
    public partial class CreateSubscriptionGrantResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        /// </summary>
        public List<SubscribedAsset> Assets { get; set; } = AWSConfigs.InitializeCollections ? new List<SubscribedAsset>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public GrantedEntity GrantedEntity { get; set; }
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public SubscriptionGrantOverallStatus Status { get; set; }
