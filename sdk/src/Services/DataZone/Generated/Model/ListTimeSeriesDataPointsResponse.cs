...
{
    /// <summary>
    /// This is the response object from the ListTimeSeriesDataPoints operation.
    /// </summary>
    public partial class ListTimeSeriesDataPointsResponse : AmazonWebServiceResponse
    {
        private List<TimeSeriesDataPointSummaryFormOutput> _items = AWSConfigs.InitializeCollections ? new List<TimeSeriesDataPointSummaryFormOutput>() : null;
        ...
        /// </summary>
        public List<TimeSeriesDataPointSummaryFormOutput> Items
        {
