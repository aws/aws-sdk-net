...
namespace Amazon.DataZone.Model
{
    ...
    public partial class SageMakerRunConfigurationOutput
    {
        ...
        public Dictionary<string, List<string>> TrackingAssets { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, List<string>>() : null;

        /// <summary>
        /// Checks to see if the TrackingAssets property is set.
        /// </summary>
        internal bool IsSetTrackingAssets() => this.TrackingAssets != null && (this.TrackingAssets.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
