...
namespace Amazon.DataZone.Model
{
    ...
    public partial class LineageNodeItem
    {
        ...
        /// </summary>
        public List<string> DownstreamLineageNodeIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the DownstreamLineageNodeIds property is set.
        /// </summary>
        internal bool IsSetDownstreamLineageNodeIds() => this.DownstreamLineageNodeIds != null && (this.DownstreamLineageNodeIds.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> UpstreamLineageNodeIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the UpstreamLineageNodeIds property is set.
        /// </summary>
        internal bool IsSetUpstreamLineageNodeIds() => this.UpstreamLineageNodeIds != null && (this.UpstreamLineageNodeIds.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
