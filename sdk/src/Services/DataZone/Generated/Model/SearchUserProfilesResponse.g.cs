...
{
    /// <summary>
    /// This is the response object from the SearchUserProfiles operation.
    /// </summary>
    public partial class SearchUserProfilesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<UserProfileSummary> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<UserProfileSummary>() : null;
