...
{
    /// <summary>
    /// This is the response object from the QueryGraph operation.
    /// </summary>
    public partial class QueryGraphResponse : AmazonWebServiceResponse
    {
        /// <summary>
        /// Gets and sets the property Items. 
        /// <para>
        /// The results of the <c>QueryGraph</c> action.
        /// </para>
        /// <para />
        ...
        /// </summary>
        public List<ResultItem> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<ResultItem>() : null;
