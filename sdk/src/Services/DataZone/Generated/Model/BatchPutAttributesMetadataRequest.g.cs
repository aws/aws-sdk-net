...
{
    /// <summary>
    /// Container for the parameters to the BatchPutAttributesMetadata operation. Writes the
    /// attribute metadata.
    /// </summary>
    public partial class BatchPutAttributesMetadataRequest : AmazonDataZoneRequest
    {
        ...
        public List<AttributeInput> Attributes { get; set; } = AWSConfigs.InitializeCollections ? new List<AttributeInput>() : null;
