...
namespace Amazon.DataZone.Model
{
    ...
    public partial class TimeoutConfig
    {
        ...
        public int? RunTimeoutInMinutes { get; set; }

        /// <summary>
        /// Checks to see if the RunTimeoutInMinutes property is set.
        /// </summary>
        internal bool IsSetRunTimeoutInMinutes() => this.RunTimeoutInMinutes.HasValue;
    }
}
