...
{
    /// <summary>
    /// Container for the parameters to the GetConnection operation. Gets a connection. In
    /// Amazon DataZone, a connection enables you to connect your resources (domains, projects,
    ...
    public partial class GetConnectionRequest : AmazonDataZoneRequest
    {
        ...
        /// <summary>
        /// Checks to see if the WithSecret property is set.
        /// </summary>
        internal bool IsSetWithSecret() => this.WithSecret.HasValue;
    }
}
