...
namespace Amazon.DataZone.Model
{
    ...
    public partial class FilterClause
    {
        ...
        public List<FilterClause> And { get; set; } = AWSConfigs.InitializeCollections ? new List<FilterClause>() : null;
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 100)]
        public List<FilterClause> Or { get; set; } = AWSConfigs.InitializeCollections ? new List<FilterClause>() : null;
