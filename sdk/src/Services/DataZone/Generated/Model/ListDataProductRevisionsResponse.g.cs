...
{
    /// <summary>
    /// This is the response object from the ListDataProductRevisions operation.
    /// </summary>
    public partial class ListDataProductRevisionsResponse : AmazonWebServiceResponse
    {
        /// <summary>
        /// Gets and sets the property Items. 
        /// <para>
        /// The results of the <c>ListDataProductRevisions</c> action.
        /// </para>
        /// <para />
        ...
        public List<DataProductRevision> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<DataProductRevision>() : null;
