...
namespace Amazon.DataZone.Model
{
    ...
    public partial class RelationalFilterConfiguration
    {
        ...
        /// </summary>
        public List<FilterExpression> FilterExpressions { get; set; } = AWSConfigs.InitializeCollections ? new List<FilterExpression>() : null;

        /// <summary>
        /// Checks to see if the FilterExpressions property is set.
        /// </summary>
        internal bool IsSetFilterExpressions() => this.FilterExpressions != null && (this.FilterExpressions.Count > 0 || !AWSConfigs.InitializeCollections);
