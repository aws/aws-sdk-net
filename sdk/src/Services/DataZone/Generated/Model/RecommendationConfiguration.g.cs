...
namespace Amazon.DataZone.Model
{
    ...
    public partial class RecommendationConfiguration
    {
        ...
        /// </para>
        /// </summary>
        public bool? EnableBusinessNameGeneration { get; set; }

        /// <summary>
        /// Checks to see if the EnableBusinessNameGeneration property is set.
        /// </summary>
        internal bool IsSetEnableBusinessNameGeneration() => this.EnableBusinessNameGeneration.HasValue;
    }
}
