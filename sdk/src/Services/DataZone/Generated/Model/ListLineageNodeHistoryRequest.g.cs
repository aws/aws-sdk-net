...
{
    /// <summary>
    /// Container for the parameters to the ListLineageNodeHistory operation. Lists the history
    /// of the specified data lineage node.
    /// </summary>
    public partial class ListLineageNodeHistoryRequest : AmazonDataZoneRequest
    {
        ...
        /// </para>
        /// </summary>
        public DateTime? EventTimestampGTE { get; set; }

        /// <summary>
        /// Checks to see if the EventTimestampGTE property is set.
        /// </summary>
        internal bool IsSetEventTimestampGTE() => this.EventTimestampGTE.HasValue;
        ...
        /// </para>
        /// </summary>
        public DateTime? EventTimestampLTE { get; set; }

        /// <summary>
        /// Checks to see if the EventTimestampLTE property is set.
        /// </summary>
        internal bool IsSetEventTimestampLTE() => this.EventTimestampLTE.HasValue;
