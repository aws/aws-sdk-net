...
namespace Amazon.DataZone.Model
{
    ...
    public partial class AssetTypesForRule
    {
        ...
        public RuleScopeSelectionMode SelectionMode { get; set; }
        ...
        /// </summary>
        [AWSProperty(Min = 1)]
        public List<string> SpecificAssetTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the SpecificAssetTypes property is set.
        /// </summary>
        internal bool IsSetSpecificAssetTypes() => this.SpecificAssetTypes != null && (this.SpecificAssetTypes.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
