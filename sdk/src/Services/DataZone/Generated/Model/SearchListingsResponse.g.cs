...
namespace Amazon.DataZone.Model
{
    ...
    public partial class SearchListingsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<AggregationOutput> Aggregates { get; set; } = AWSConfigs.InitializeCollections ? new List<AggregationOutput>() : null;

        /// <summary>
        /// Checks to see if the Aggregates property is set.
        /// </summary>
        internal bool IsSetAggregates() => this.Aggregates != null && (this.Aggregates.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<SearchResultItem> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<SearchResultItem>() : null;
