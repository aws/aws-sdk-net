...
{
    /// <summary>
    /// Container for the parameters to the CreateListingChangeSet operation. Publishes a
    /// listing (a record of an asset at a given time) or removes a listing from the catalog.
    /// </summary>
