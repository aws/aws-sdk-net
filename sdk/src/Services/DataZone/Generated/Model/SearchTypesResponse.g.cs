...
namespace Amazon.DataZone.Model
{
    ...
    public partial class SearchTypesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SearchTypesResultItem> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<SearchTypesResultItem>() : null;
        ...
        /// <summary>
        /// Checks to see if the TotalMatchCount property is set.
        /// </summary>
        internal bool IsSetTotalMatchCount() => this.TotalMatchCount.HasValue;
    }
}
