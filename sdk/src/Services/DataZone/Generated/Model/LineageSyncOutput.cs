...
{
    /// <summary>
    /// Contains the current state of lineage sync for a Snowflake connection, including the
    /// schedule, timezone, enabled state, and the ID of the associated lineage job.
    /// </summary>
    public partial class LineageSyncOutput
    {
