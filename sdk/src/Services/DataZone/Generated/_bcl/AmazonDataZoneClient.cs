...
namespace Amazon.DataZone
{
    ...
    public partial class AmazonDataZoneClient : AmazonServiceClient, IAmazonDataZone
    {
        ...
        public virtual QueryGraphResponse QueryGraph(QueryGraphRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual StartNotebookSyncResponse StartNotebookSync(StartNotebookSyncRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
