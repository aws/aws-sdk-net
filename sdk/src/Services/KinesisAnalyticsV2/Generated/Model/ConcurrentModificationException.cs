...
namespace Amazon.KinesisAnalyticsV2.Model
{
    ...
    public partial class ConcurrentModificationException : AmazonKinesisAnalyticsV2Exception
    {
        ...
        public ConcurrentModificationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConcurrentModificationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
