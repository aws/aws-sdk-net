...
namespace Amazon.KinesisAnalyticsV2.Model
{
    ...
    public partial class ApplicationSystemRollbackConfiguration
    {
        ...
        {
            get { return this._rollbackEnabled.GetValueOrDefault(); }
            set { this._rollbackEnabled = value; }
        }

        // Check to see if RollbackEnabled property is set
        internal bool IsSetRollbackEnabled()
        {
            return this._rollbackEnabled.HasValue; 
        }
