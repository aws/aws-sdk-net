...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    public class ZeppelinApplicationConfigurationDescriptionUnmarshaller : IJsonUnmarshaller<ZeppelinApplicationConfigurationDescription, JsonUnmarshallerContext>
    {
        ...
        private static ZeppelinApplicationConfigurationDescriptionUnmarshaller _instance = new ZeppelinApplicationConfigurationDescriptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ZeppelinApplicationConfigurationDescriptionUnmarshaller Instance
        {
            get
            {
                return _instance;
