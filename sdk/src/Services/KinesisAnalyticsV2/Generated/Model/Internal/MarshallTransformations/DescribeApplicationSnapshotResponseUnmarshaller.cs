...
{
    /// <summary>
    /// Response Unmarshaller for DescribeApplicationSnapshot operation
    /// </summary>  
    public class DescribeApplicationSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeApplicationSnapshotResponse response = new DescribeApplicationSnapshotResponse();
            ...
            {
                if (context.TestExpression("SnapshotDetails", targetDepth, ref reader))
                {
                    var unmarshaller = SnapshotDetailsUnmarshaller.Instance;
                    response.SnapshotDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeApplicationSnapshotResponseUnmarshaller _instance = new DescribeApplicationSnapshotResponseUnmarshaller();        

        internal static DescribeApplicationSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeApplicationSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
