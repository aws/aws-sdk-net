...
{
    /// <summary>
    /// Response Unmarshaller for CreateApplicationSnapshot operation
    /// </summary>  
    public class CreateApplicationSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateApplicationSnapshotResponse response = new CreateApplicationSnapshotResponse();
        ...
        private static CreateApplicationSnapshotResponseUnmarshaller _instance = new CreateApplicationSnapshotResponseUnmarshaller();        

        internal static CreateApplicationSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApplicationSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
