...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApplicationReferenceDataSource operation
    /// </summary>  
    public class DeleteApplicationReferenceDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApplicationReferenceDataSourceResponse response = new DeleteApplicationReferenceDataSourceResponse();
        ...
        private static DeleteApplicationReferenceDataSourceResponseUnmarshaller _instance = new DeleteApplicationReferenceDataSourceResponseUnmarshaller();        

        internal static DeleteApplicationReferenceDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApplicationReferenceDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
