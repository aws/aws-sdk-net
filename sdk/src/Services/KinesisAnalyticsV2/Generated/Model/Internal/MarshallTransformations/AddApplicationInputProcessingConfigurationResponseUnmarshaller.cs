...
{
    /// <summary>
    /// Response Unmarshaller for AddApplicationInputProcessingConfiguration operation
    /// </summary>  
    public class AddApplicationInputProcessingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddApplicationInputProcessingConfigurationResponse response = new AddApplicationInputProcessingConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InputId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("InputProcessingConfigurationDescription", targetDepth))
                {
                    ...
                    response.InputProcessingConfigurationDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static AddApplicationInputProcessingConfigurationResponseUnmarshaller _instance = new AddApplicationInputProcessingConfigurationResponseUnmarshaller();        

        internal static AddApplicationInputProcessingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddApplicationInputProcessingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
