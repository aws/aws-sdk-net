...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    public class InputParallelismUpdateMarshaller : IRequestMarshaller<InputParallelismUpdate, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(InputParallelismUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCountUpdate())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.CountUpdate.Value);
            }
