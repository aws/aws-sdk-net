...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CloudWatchLoggingOptionDescriptionUnmarshaller : IJsonUnmarshaller<CloudWatchLoggingOptionDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CloudWatchLoggingOptionDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CloudWatchLoggingOptionId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CloudWatchLoggingOptionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
