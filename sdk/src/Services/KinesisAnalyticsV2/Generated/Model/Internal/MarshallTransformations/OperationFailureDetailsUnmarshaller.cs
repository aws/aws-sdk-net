...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OperationFailureDetailsUnmarshaller : IUnmarshaller<OperationFailureDetails, XmlUnmarshallerContext>, IUnmarshaller<OperationFailureDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        OperationFailureDetails IUnmarshaller<OperationFailureDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public OperationFailureDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("RollbackOperationId", targetDepth))
                {
                    ...
                    unmarshalledObject.RollbackOperationId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
