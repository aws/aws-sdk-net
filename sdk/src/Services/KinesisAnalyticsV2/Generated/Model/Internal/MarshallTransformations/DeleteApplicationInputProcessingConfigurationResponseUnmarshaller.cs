...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApplicationInputProcessingConfiguration operation
    /// </summary>  
    public class DeleteApplicationInputProcessingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApplicationInputProcessingConfigurationResponse response = new DeleteApplicationInputProcessingConfigurationResponse();
        ...
        private static DeleteApplicationInputProcessingConfigurationResponseUnmarshaller _instance = new DeleteApplicationInputProcessingConfigurationResponseUnmarshaller();        

        internal static DeleteApplicationInputProcessingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApplicationInputProcessingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
