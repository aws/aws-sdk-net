...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationOperationInfoDetailsUnmarshaller : IUnmarshaller<ApplicationOperationInfoDetails, XmlUnmarshallerContext>, IUnmarshaller<ApplicationOperationInfoDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ApplicationOperationInfoDetails IUnmarshaller<ApplicationOperationInfoDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ApplicationOperationInfoDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ApplicationVersionChangeDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.ApplicationVersionChangeDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("OperationFailureDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.OperationFailureDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
