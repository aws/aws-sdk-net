...
namespace Amazon.Textract.Internal
{
    /// <summary>
    ...
    /// </summary>
    public class AmazonTextractEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonTextractConfig)requestContext.ClientConfig;
            var result = new TextractEndpointParameters();
