...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdapterOverviewUnmarshaller : IUnmarshaller<AdapterOverview, XmlUnmarshallerContext>, IUnmarshaller<AdapterOverview, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AdapterOverview IUnmarshaller<AdapterOverview, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AdapterOverview Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AdapterName = unmarshaller.Unmarshall(context);
                    continue;
                }
