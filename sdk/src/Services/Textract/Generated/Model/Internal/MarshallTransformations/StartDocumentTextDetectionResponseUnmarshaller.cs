...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartDocumentTextDetectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDocumentTextDetectionResponse response = new StartDocumentTextDetectionResponse();
        ...
        private static StartDocumentTextDetectionResponseUnmarshaller _instance = new StartDocumentTextDetectionResponseUnmarshaller();        

        internal static StartDocumentTextDetectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDocumentTextDetectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
