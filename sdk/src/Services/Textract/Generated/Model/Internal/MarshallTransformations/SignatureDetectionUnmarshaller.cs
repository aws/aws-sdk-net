...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SignatureDetectionUnmarshaller : IJsonUnmarshaller<SignatureDetection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SignatureDetection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
