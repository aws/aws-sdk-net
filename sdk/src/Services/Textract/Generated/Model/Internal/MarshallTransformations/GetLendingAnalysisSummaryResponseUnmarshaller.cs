...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLendingAnalysisSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLendingAnalysisSummaryResponse response = new GetLendingAnalysisSummaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LendingSummaryUnmarshaller.Instance;
        ...
        private static GetLendingAnalysisSummaryResponseUnmarshaller _instance = new GetLendingAnalysisSummaryResponseUnmarshaller();        

        internal static GetLendingAnalysisSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLendingAnalysisSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
