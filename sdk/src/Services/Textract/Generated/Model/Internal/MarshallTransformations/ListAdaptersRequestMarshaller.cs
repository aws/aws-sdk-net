...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListAdaptersRequestMarshaller : IMarshaller<IRequest, ListAdaptersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAdaptersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAdaptersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Textract");
            string target = "Textract.ListAdapters";
        ...
        private static ListAdaptersRequestMarshaller _instance = new ListAdaptersRequestMarshaller();        

        internal static ListAdaptersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAdaptersRequestMarshaller Instance
        {
            get
            {
                return _instance;
