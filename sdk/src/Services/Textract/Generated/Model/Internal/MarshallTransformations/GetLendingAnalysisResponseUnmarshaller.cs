        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AnalyzeLendingModelVersion", targetDepth))
                {
                    ...
                    response.AnalyzeLendingModelVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LendingResult, LendingResultUnmarshaller>(LendingResultUnmarshaller.Instance);
