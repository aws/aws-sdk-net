...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLendingAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLendingAnalysisResponse response = new GetLendingAnalysisResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AnalyzeLendingModelVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AnalyzeLendingModelVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LendingResult, LendingResultUnmarshaller>(LendingResultUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InvalidJobIdExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidKMSKeyException"))
                {
                    return InvalidKMSKeyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetLendingAnalysisResponseUnmarshaller _instance = new GetLendingAnalysisResponseUnmarshaller();        

        internal static GetLendingAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLendingAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
