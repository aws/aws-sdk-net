...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdapterVersionEvaluationMetricUnmarshaller : IUnmarshaller<AdapterVersionEvaluationMetric, XmlUnmarshallerContext>, IUnmarshaller<AdapterVersionEvaluationMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AdapterVersionEvaluationMetric IUnmarshaller<AdapterVersionEvaluationMetric, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AdapterVersionEvaluationMetric Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = EvaluationMetricUnmarshaller.Instance;
                    unmarshalledObject.Baseline = unmarshaller.Unmarshall(context);
                    continue;
                }
