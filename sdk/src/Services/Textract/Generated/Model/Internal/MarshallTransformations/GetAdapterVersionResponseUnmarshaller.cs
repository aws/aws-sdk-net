        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("DatasetConfig", targetDepth))
                {
                    ...
                    response.DatasetConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("EvaluationMetrics", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AdapterVersionEvaluationMetric, AdapterVersionEvaluationMetricUnmarshaller>(AdapterVersionEvaluationMetricUnmarshaller.Instance);
