...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LendingDetectionUnmarshaller : IJsonUnmarshaller<LendingDetection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LendingDetection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            LendingDetection unmarshalledObject = new LendingDetection();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SelectionStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SelectionStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static LendingDetectionUnmarshaller _instance = new LendingDetectionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LendingDetectionUnmarshaller Instance
        {
            get
            {
                return _instance;
