...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListAdapterVersionsRequestMarshaller : IMarshaller<IRequest, ListAdapterVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAdapterVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAdapterVersionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Textract");
            string target = "Textract.ListAdapterVersions";
            ...
            if(publicRequest.IsSetAdapterId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AdapterId);
            }
        ...
        private static ListAdapterVersionsRequestMarshaller _instance = new ListAdapterVersionsRequestMarshaller();        

        internal static ListAdapterVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAdapterVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
