...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TranscriptUnmarshaller : ICborUnmarshaller<Transcript, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Transcript Unmarshall(CborUnmarshallerContext context)
        {
                    ...
                    case "Results":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<Result, ResultUnmarshaller>(ResultUnmarshaller.Instance);
