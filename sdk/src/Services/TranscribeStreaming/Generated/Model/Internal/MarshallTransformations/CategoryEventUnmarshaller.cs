...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CategoryEventUnmarshaller : ICborUnmarshaller<CategoryEvent, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public CategoryEvent Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "MatchedCategories":
                        {
                            context.AddPathSegment("MatchedCategories");
                    ...
                    case "MatchedDetails":
                        {
                            context.AddPathSegment("MatchedDetails");
                            var unmarshaller = new CborDictionaryUnmarshaller<string, PointsOfInterest, CborStringUnmarshaller, PointsOfInterestUnmarshaller>(CborStringUnmarshaller.Instance, PointsOfInterestUnmarshaller.Instance);
