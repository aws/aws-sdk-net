...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CharacterOffsetsUnmarshaller : IJsonUnmarshaller<CharacterOffsets, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CharacterOffsets Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("Begin", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.Begin = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
