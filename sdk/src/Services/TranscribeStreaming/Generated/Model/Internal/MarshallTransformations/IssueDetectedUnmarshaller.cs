...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IssueDetectedUnmarshaller : ICborUnmarshaller<IssueDetected, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public IssueDetected Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "CharacterOffsets":
                        {
                            context.AddPathSegment("CharacterOffsets");
