...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlternativeUnmarshaller : IJsonUnmarshaller<Alternative, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Alternative Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
