...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResultUnmarshaller : ICborUnmarshaller<Result, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Result Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Alternatives":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<Alternative, AlternativeUnmarshaller>(AlternativeUnmarshaller.Instance);
                    ...
                    case "LanguageIdentification":
                        {
                            context.AddPathSegment("LanguageIdentification");
                            var unmarshaller = new CborListUnmarshaller<LanguageWithScore, LanguageWithScoreUnmarshaller>(LanguageWithScoreUnmarshaller.Instance);
                            unmarshalledObject.LanguageIdentification = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "ResultId":
