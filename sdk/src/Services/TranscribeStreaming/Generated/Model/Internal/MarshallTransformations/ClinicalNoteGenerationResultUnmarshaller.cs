...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClinicalNoteGenerationResultUnmarshaller : ICborUnmarshaller<ClinicalNoteGenerationResult, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClinicalNoteGenerationResult Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ClinicalNoteOutputLocation":
                        {
                            context.AddPathSegment("ClinicalNoteOutputLocation");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.ClinicalNoteOutputLocation = unmarshaller.Unmarshall(context);
                    ...
                    case "TranscriptOutputLocation":
                        {
                            context.AddPathSegment("TranscriptOutputLocation");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.TranscriptOutputLocation = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
