...
{
    /// <summary>
    /// This is the response object from the ListSearchJobResults operation.
    /// </summary>
    public partial class ListSearchJobResultsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<ResultItem> _results = AWSConfigs.InitializeCollections ? new List<ResultItem>() : null;
