...
{
    /// <summary>
    /// GetSearchJob Request Marshaller
    /// </summary>       
    public class GetSearchJobRequestMarshaller : IMarshaller<IRequest, GetSearchJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSearchJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSearchJobRequest publicRequest)
        {
            ...
            request.ResourcePath = "/search-jobs/{SearchJobIdentifier}";

            return request;
        }
        private static GetSearchJobRequestMarshaller _instance = new GetSearchJobRequestMarshaller();        

        internal static GetSearchJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSearchJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
