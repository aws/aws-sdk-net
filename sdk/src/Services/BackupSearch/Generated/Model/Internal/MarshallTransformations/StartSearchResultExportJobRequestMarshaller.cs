...
namespace Amazon.BackupSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartSearchResultExportJobRequestMarshaller : IMarshaller<IRequest, StartSearchResultExportJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                using (StreamWriter streamWriter = new InvariantCultureStreamWriter(memoryStream))
                {
                    ...
                    if(publicRequest.IsSetSearchJobIdentifier())
                    {
                        ...
                        context.Writer.Write(publicRequest.SearchJobIdentifier);
                    }
        ...
        private static StartSearchResultExportJobRequestMarshaller _instance = new StartSearchResultExportJobRequestMarshaller();        

        internal static StartSearchResultExportJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSearchResultExportJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
