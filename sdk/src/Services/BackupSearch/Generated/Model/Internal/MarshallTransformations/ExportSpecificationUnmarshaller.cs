...
namespace Amazon.BackupSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExportSpecificationUnmarshaller : IJsonUnmarshaller<ExportSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExportSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
