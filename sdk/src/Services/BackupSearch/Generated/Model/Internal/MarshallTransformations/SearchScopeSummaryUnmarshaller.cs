...
namespace Amazon.BackupSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SearchScopeSummaryUnmarshaller : IJsonUnmarshaller<SearchScopeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SearchScopeSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
