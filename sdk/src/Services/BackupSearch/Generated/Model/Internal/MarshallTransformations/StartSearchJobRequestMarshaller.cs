...
{
    /// <summary>
    /// StartSearchJob Request Marshaller
    /// </summary>       
    public class StartSearchJobRequestMarshaller : IMarshaller<IRequest, StartSearchJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartSearchJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartSearchJobRequest publicRequest)
        {
        ...
        private static StartSearchJobRequestMarshaller _instance = new StartSearchJobRequestMarshaller();        

        internal static StartSearchJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSearchJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
