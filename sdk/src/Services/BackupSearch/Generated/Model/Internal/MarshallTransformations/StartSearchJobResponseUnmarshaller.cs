...
{
    /// <summary>
    /// Response Unmarshaller for StartSearchJob operation
    /// </summary>  
    public class StartSearchJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSearchJobResponse response = new StartSearchJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SearchJobIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartSearchJobResponseUnmarshaller _instance = new StartSearchJobResponseUnmarshaller();        

        internal static StartSearchJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSearchJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
