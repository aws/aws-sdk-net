...
{
    /// <summary>
    /// Response Unmarshaller for ListSearchJobs operation
    /// </summary>  
    public class ListSearchJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSearchJobsResponse response = new ListSearchJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SearchJobs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SearchJobSummary, SearchJobSummaryUnmarshaller>(SearchJobSummaryUnmarshaller.Instance);
                    response.SearchJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSearchJobsResponseUnmarshaller _instance = new ListSearchJobsResponseUnmarshaller();        

        internal static ListSearchJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSearchJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
