...
namespace Amazon.BackupSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListSearchJobsRequestMarshaller : IMarshaller<IRequest, ListSearchJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListSearchJobsRequestMarshaller _instance = new ListSearchJobsRequestMarshaller();        

        internal static ListSearchJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSearchJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
