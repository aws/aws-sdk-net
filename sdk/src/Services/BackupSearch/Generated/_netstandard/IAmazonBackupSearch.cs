...
namespace Amazon.BackupSearch
{
    ...
    public partial interface IAmazonBackupSearch : IAmazonService, IDisposable
    {
        ...
        Task<GetSearchJobResponse> GetSearchJobAsync(GetSearchJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetSearchResultExportJobResponse> GetSearchResultExportJobAsync(GetSearchResultExportJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSearchJobBackupsResponse> ListSearchJobBackupsAsync(ListSearchJobBackupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSearchJobResultsResponse> ListSearchJobResultsAsync(ListSearchJobResultsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSearchJobsResponse> ListSearchJobsAsync(ListSearchJobsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSearchResultExportJobsResponse> ListSearchResultExportJobsAsync(ListSearchResultExportJobsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartSearchJobResponse> StartSearchJobAsync(StartSearchJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartSearchResultExportJobResponse> StartSearchResultExportJobAsync(StartSearchResultExportJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopSearchJobResponse> StopSearchJobAsync(StopSearchJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonBackupSearchConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonBackupSearchConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonBackupSearchConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonBackupSearchConfig to create AmazonBackupSearchClient");
            }

            return awsCredentials == null ? 
                    new AmazonBackupSearchClient(serviceClientConfig) :
                    new AmazonBackupSearchClient(awsCredentials, serviceClientConfig);
        }
