...
namespace Amazon.BackupSearch.Internal
{
    ...
    public class AmazonBackupSearchAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBackupSearchAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BackupSearch.
        /// </summary>
        public AmazonBackupSearchAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBackupSearchAuthSchemeParameters
            {
    ...
    public class AmazonBackupSearchAuthSchemeResolver : IAuthSchemeResolver<AmazonBackupSearchAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBackupSearchAuthSchemeParameters authParameters)
        {
