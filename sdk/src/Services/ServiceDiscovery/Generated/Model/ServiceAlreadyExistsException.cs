...
namespace Amazon.ServiceDiscovery.Model
{
    ...
    public partial class ServiceAlreadyExistsException : AmazonServiceDiscoveryException
    {
        ...
        public ServiceAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ServiceAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
