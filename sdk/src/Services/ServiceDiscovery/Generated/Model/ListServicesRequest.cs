...
namespace Amazon.ServiceDiscovery.Model
{
    ...
    {
        private List<ServiceFilter> _filters = AWSConfigs.InitializeCollections ? new List<ServiceFilter>() : null;
        ...
        /// <para>
        /// For the first <c>ListServices</c> request, omit this value.
        /// </para>
        ///  
        /// <para>
