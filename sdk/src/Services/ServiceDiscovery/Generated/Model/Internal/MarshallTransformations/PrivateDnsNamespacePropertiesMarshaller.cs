...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    public class PrivateDnsNamespacePropertiesMarshaller : IRequestMarshaller<PrivateDnsNamespaceProperties, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(PrivateDnsNamespaceProperties requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDnsProperties())
            {
                ...
                var marshaller = PrivateDnsPropertiesMutableMarshaller.Instance;
