...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    public class DuplicateRequestExceptionUnmarshaller : IErrorResponseUnmarshaller<DuplicateRequestException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DuplicateRequestException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DuplicateOperationId", targetDepth))
                {
                    ...
                    unmarshalledObject.DuplicateOperationId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
