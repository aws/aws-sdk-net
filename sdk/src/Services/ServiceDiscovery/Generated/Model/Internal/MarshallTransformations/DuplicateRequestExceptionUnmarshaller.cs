...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DuplicateRequestExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<DuplicateRequestException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DuplicateRequestException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public DuplicateRequestException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
