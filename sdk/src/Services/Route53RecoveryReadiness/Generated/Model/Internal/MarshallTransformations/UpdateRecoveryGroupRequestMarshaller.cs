...
{
    /// <summary>
    /// UpdateRecoveryGroup Request Marshaller
    /// </summary>       
    public class UpdateRecoveryGroupRequestMarshaller : IMarshaller<IRequest, UpdateRecoveryGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRecoveryGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRecoveryGroupRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCells())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestCellsListValue);
                }
        ...
        private static UpdateRecoveryGroupRequestMarshaller _instance = new UpdateRecoveryGroupRequestMarshaller();        

        internal static UpdateRecoveryGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecoveryGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
