...
namespace Amazon.Route53RecoveryReadiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecoveryGroupOutputUnmarshaller : IUnmarshaller<RecoveryGroupOutput, XmlUnmarshallerContext>, IUnmarshaller<RecoveryGroupOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RecoveryGroupOutput IUnmarshaller<RecoveryGroupOutput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RecoveryGroupOutput Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("recoveryGroupArn", targetDepth))
                {
                    ...
                    unmarshalledObject.RecoveryGroupArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("recoveryGroupName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RecoveryGroupName = unmarshaller.Unmarshall(context);
                    continue;
                }
