...
namespace Amazon.Route53RecoveryReadiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReadinessCheckSummaryUnmarshaller : IJsonUnmarshaller<ReadinessCheckSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReadinessCheckSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
