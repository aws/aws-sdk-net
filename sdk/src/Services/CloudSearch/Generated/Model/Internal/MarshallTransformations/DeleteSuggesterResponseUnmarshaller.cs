...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSuggester operation
    /// </summary>  
    public class DeleteSuggesterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSuggesterResponse response = new DeleteSuggesterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteSuggesterResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeleteSuggesterResponse response)
        {
        ...
        private static DeleteSuggesterResponseUnmarshaller _instance = new DeleteSuggesterResponseUnmarshaller();        

        internal static DeleteSuggesterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSuggesterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
