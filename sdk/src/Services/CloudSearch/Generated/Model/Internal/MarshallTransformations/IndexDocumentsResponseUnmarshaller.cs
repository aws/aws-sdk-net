...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IndexDocumentsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static IndexDocumentsResponseUnmarshaller _instance = new IndexDocumentsResponseUnmarshaller();        

        internal static IndexDocumentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IndexDocumentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
