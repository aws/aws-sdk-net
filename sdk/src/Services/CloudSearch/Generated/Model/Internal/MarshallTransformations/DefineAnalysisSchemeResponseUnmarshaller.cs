...
{
    /// <summary>
    /// Response Unmarshaller for DefineAnalysisScheme operation
    /// </summary>  
    public class DefineAnalysisSchemeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DefineAnalysisSchemeResponse response = new DefineAnalysisSchemeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DefineAnalysisSchemeResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DefineAnalysisSchemeResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AnalysisScheme", targetDepth))
                    {
                        ...
                        response.AnalysisScheme = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static DefineAnalysisSchemeResponseUnmarshaller _instance = new DefineAnalysisSchemeResponseUnmarshaller();        

        internal static DefineAnalysisSchemeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DefineAnalysisSchemeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
