...
{
    /// <summary>
    /// Response Unmarshaller for DefineSuggester operation
    /// </summary>  
    public class DefineSuggesterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DefineSuggesterResponse response = new DefineSuggesterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DefineSuggesterResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DefineSuggesterResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Suggester", targetDepth))
                    {
                        ...
                        response.Suggester = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static DefineSuggesterResponseUnmarshaller _instance = new DefineSuggesterResponseUnmarshaller();        

        internal static DefineSuggesterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DefineSuggesterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
