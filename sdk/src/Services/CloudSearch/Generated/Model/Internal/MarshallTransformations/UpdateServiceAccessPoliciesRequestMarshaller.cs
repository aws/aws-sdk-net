    ...
    public class UpdateServiceAccessPoliciesRequestMarshaller : IMarshaller<IRequest, UpdateServiceAccessPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateServiceAccessPoliciesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static UpdateServiceAccessPoliciesRequestMarshaller _instance = new UpdateServiceAccessPoliciesRequestMarshaller();        

        internal static UpdateServiceAccessPoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceAccessPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
