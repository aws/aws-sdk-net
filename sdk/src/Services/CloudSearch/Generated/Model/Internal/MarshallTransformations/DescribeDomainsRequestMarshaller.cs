    ...
    public class DescribeDomainsRequestMarshaller : IMarshaller<IRequest, DescribeDomainsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeDomainsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeDomainsRequestMarshaller _instance = new DescribeDomainsRequestMarshaller();        

        internal static DescribeDomainsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDomainsRequestMarshaller Instance
        {
            get
            {
                return _instance;
