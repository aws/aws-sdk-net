...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAnalysisScheme operation
    /// </summary>  
    public class DeleteAnalysisSchemeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAnalysisSchemeResponse response = new DeleteAnalysisSchemeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteAnalysisSchemeResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeleteAnalysisSchemeResponse response)
        {
        ...
        private static DeleteAnalysisSchemeResponseUnmarshaller _instance = new DeleteAnalysisSchemeResponseUnmarshaller();        

        internal static DeleteAnalysisSchemeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAnalysisSchemeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
