...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeIndexFieldsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeIndexFieldsResponse response = new DescribeIndexFieldsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeIndexFieldsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeIndexFieldsResponse response)
        {
        ...
        private static DescribeIndexFieldsResponseUnmarshaller _instance = new DescribeIndexFieldsResponseUnmarshaller();        

        internal static DescribeIndexFieldsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIndexFieldsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
