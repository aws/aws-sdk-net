...
namespace Amazon.Translate.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonTranslateAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonTranslateAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Translate.
        /// </summary>
        public AmazonTranslateAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonTranslateAuthSchemeParameters
            {
    ...
    public class AmazonTranslateAuthSchemeResolver : IAuthSchemeResolver<AmazonTranslateAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonTranslateAuthSchemeParameters authParameters)
        {
