...
{
    /// <summary>
    /// Response Unmarshaller for DescribeScalingPolicies operation
    /// </summary>  
    public class DescribeScalingPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeScalingPoliciesResponse response = new DescribeScalingPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ScalingPolicies", targetDepth))
                {
                    ...
                    response.ScalingPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ConcurrentUpdateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("FailedResourceAccessException"))
                {
                    return FailedResourceAccessExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DescribeScalingPoliciesResponseUnmarshaller _instance = new DescribeScalingPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeScalingPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
