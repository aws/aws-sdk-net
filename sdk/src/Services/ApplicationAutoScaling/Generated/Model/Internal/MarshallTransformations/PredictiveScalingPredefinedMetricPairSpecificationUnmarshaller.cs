...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredictiveScalingPredefinedMetricPairSpecificationUnmarshaller : IJsonUnmarshaller<PredictiveScalingPredefinedMetricPairSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PredictiveScalingPredefinedMetricPairSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("PredefinedMetricType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PredefinedMetricType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
