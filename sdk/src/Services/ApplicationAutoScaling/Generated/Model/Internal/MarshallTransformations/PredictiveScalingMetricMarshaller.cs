...
{
    /// <summary>
    /// PredictiveScalingMetric Marshaller
    /// </summary>
    public class PredictiveScalingMetricMarshaller : IRequestMarshaller<PredictiveScalingMetric, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PredictiveScalingMetric requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDimensions())
            {
                ...
                foreach(var requestObjectDimensionsListValue in requestObject.Dimensions)
                {
                    ...
                    var marshaller = PredictiveScalingMetricDimensionMarshaller.Instance;
        ...
        /// </summary>
        public readonly static PredictiveScalingMetricMarshaller Instance = new PredictiveScalingMetricMarshaller();
