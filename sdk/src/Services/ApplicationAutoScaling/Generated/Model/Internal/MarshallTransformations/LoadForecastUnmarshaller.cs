...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LoadForecastUnmarshaller : IJsonUnmarshaller<LoadForecast, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LoadForecast Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("MetricSpecification", targetDepth, ref reader))
                {
