...
namespace Amazon.Ivschat.Internal
{
    ...
    public class AmazonIvschatAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIvschatAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Ivschat.
        /// </summary>
        public AmazonIvschatAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIvschatAuthSchemeParameters
            {
    ...
    public class AmazonIvschatAuthSchemeResolver : IAuthSchemeResolver<AmazonIvschatAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIvschatAuthSchemeParameters authParameters)
        {
