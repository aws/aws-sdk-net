...
namespace Amazon.Ivschat
{
    ...
    public partial class AmazonIvschatClient : AmazonServiceClient, IAmazonIvschat
    {
        ...
        /// 
        /// </summary>
        public AmazonIvschatClient() : base(new AmazonIvschatConfig()) { }
        ...
        public AmazonIvschatClient(RegionEndpoint region) : base(new AmazonIvschatConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIvschatClient(AmazonIvschatConfig config) : base(config) { }
