...
{
    /// <summary>
    /// Container for the parameters to the DeleteMessage operation. Sends an event to a specific
    /// room which directs clients to delete a specific message; that is, unrender it from
    /// view and delete it from the client’s chat history. This event’s <c>EventName</c> is
    /// <c>aws:DELETE_MESSAGE</c>. This replicates the <a href="https://docs.aws.amazon.com/ivs/latest/chatmsgapireference/actions-deletemessage-publish.html">
