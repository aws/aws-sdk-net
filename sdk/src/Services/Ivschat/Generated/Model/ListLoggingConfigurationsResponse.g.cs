...
namespace Amazon.Ivschat.Model
{
    ...
    public partial class ListLoggingConfigurationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<LoggingConfigurationSummary> LoggingConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<LoggingConfigurationSummary>() : null;

        /// <summary>
        /// Checks to see if the LoggingConfigurations property is set.
        /// </summary>
        internal bool IsSetLoggingConfigurations() => this.LoggingConfigurations != null && (this.LoggingConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
