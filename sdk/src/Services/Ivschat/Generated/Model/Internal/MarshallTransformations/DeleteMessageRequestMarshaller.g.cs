...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteMessageRequestMarshaller : IMarshaller<IRequest, DeleteMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteMessageRequestMarshaller _instance = new();

        internal static DeleteMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteMessageRequestMarshaller Instance => _instance;
    }
}
