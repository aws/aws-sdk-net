...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateChatTokenRequestMarshaller : IMarshaller<IRequest, CreateChatTokenRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateChatTokenRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetRoomIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.RoomIdentifier);
            }
        ...
        private static readonly CreateChatTokenRequestMarshaller _instance = new();

        internal static CreateChatTokenRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChatTokenRequestMarshaller Instance => _instance;
    }
}
