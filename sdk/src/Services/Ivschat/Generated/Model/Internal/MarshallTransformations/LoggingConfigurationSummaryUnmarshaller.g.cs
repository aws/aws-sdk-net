...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LoggingConfigurationSummaryUnmarshaller : IJsonUnmarshaller<LoggingConfigurationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LoggingConfigurationSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LoggingConfigurationSummaryUnmarshaller Instance => _instance;
    }
}
