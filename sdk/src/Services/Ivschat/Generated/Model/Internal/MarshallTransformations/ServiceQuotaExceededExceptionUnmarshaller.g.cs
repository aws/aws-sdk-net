...
{
    /// <summary>
    /// Exception Unmarshaller for ServiceQuotaExceededException
    /// </summary>
    public partial class ServiceQuotaExceededExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ServiceQuotaExceededException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ServiceQuotaExceededException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static ServiceQuotaExceededExceptionUnmarshaller Instance => _instance;
    }
}
