...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RoomSummaryUnmarshaller : IUnmarshaller<RoomSummary, XmlUnmarshallerContext>, IUnmarshaller<RoomSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RoomSummary IUnmarshaller<RoomSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RoomSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("messageReviewHandler", targetDepth))
                {
                    ...
                    unmarshalledObject.MessageReviewHandler = unmarshaller.Unmarshall(context);
                    continue;
                }
