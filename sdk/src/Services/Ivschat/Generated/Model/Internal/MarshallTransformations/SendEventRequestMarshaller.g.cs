...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendEventRequestMarshaller : IMarshaller<IRequest, SendEventRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SendEventRequestMarshaller _instance = new();

        internal static SendEventRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendEventRequestMarshaller Instance => _instance;
    }
}
