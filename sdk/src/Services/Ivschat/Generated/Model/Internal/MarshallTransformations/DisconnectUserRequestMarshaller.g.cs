...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisconnectUserRequestMarshaller : IMarshaller<IRequest, DisconnectUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisconnectUserRequestMarshaller _instance = new();

        internal static DisconnectUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisconnectUserRequestMarshaller Instance => _instance;
    }
}
