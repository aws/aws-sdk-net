...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetRoomRequestMarshaller : IMarshaller<IRequest, GetRoomRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetRoomRequestMarshaller _instance = new();

        internal static GetRoomRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRoomRequestMarshaller Instance => _instance;
    }
}
