...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLoggingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLoggingConfigurationResponse response = new UpdateLoggingConfigurationResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLoggingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
