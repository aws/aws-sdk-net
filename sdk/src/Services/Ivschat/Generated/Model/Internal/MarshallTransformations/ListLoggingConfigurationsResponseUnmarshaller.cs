    ...
    public class ListLoggingConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LoggingConfigurationSummary, LoggingConfigurationSummaryUnmarshaller>(LoggingConfigurationSummaryUnmarshaller.Instance);
