...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteRoomResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static DeleteRoomResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoomResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
