...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRoomsRequestMarshaller : IMarshaller<IRequest, ListRoomsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListRoomsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetLoggingConfigurationIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.LoggingConfigurationIdentifier);
            }
            ...
            if (publicRequest.IsSetMessageReviewHandlerUri())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.MessageReviewHandlerUri);
            }
        ...
        private static readonly ListRoomsRequestMarshaller _instance = new();

        internal static ListRoomsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRoomsRequestMarshaller Instance => _instance;
    }
}
