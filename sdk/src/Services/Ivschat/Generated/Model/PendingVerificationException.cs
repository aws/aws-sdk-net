...
namespace Amazon.Ivschat.Model
{
    ...
    [Serializable]
    #endif
    public partial class PendingVerificationException : AmazonIvschatException
    {
        ...
        public PendingVerificationException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public PendingVerificationException(Exception innerException) 
            : base(innerException) {}
        ...
        public PendingVerificationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PendingVerificationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
