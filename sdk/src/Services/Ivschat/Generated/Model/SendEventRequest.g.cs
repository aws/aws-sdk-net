...
{
    /// <summary>
    /// Container for the parameters to the SendEvent operation. Sends an event to a room.
    /// Use this within your application’s business logic to send events to clients of a room;
