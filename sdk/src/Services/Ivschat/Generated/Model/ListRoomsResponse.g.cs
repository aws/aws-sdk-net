...
namespace Amazon.Ivschat.Model
{
    ...
    public partial class ListRoomsResponse : AmazonWebServiceResponse
    {
        ...
        public List<RoomSummary> Rooms { get; set; } = AWSConfigs.InitializeCollections ? new List<RoomSummary>() : null;

        /// <summary>
        /// Checks to see if the Rooms property is set.
        /// </summary>
        internal bool IsSetRooms() => this.Rooms != null && (this.Rooms.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
