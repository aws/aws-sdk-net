...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("ivschat", "4.0.0.0");

        private static readonly AmazonIvschatEndpointResolver EndpointResolver =
            new AmazonIvschatEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("ivschat", "3.7.400.104");
=======
            InternalSDKUtils.BuildUserAgentString("ivschat", "3.7.400.118");
