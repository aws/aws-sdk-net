...
{
    /// <summary>
    /// GetQApp Request Marshaller
    /// </summary>       
    public class GetQAppRequestMarshaller : IMarshaller<IRequest, GetQAppRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetQAppRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetQAppRequest publicRequest)
        {
        ...
        private static GetQAppRequestMarshaller _instance = new GetQAppRequestMarshaller();        

        internal static GetQAppRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQAppRequestMarshaller Instance
        {
            get
            {
                return _instance;
