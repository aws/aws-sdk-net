...
{
    /// <summary>
    /// UpdateQApp Request Marshaller
    /// </summary>       
    public class UpdateQAppRequestMarshaller : IMarshaller<IRequest, UpdateQAppRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateQAppRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateQAppRequest publicRequest)
        {
        ...
        private static UpdateQAppRequestMarshaller _instance = new UpdateQAppRequestMarshaller();        

        internal static UpdateQAppRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQAppRequestMarshaller Instance
        {
            get
            {
                return _instance;
