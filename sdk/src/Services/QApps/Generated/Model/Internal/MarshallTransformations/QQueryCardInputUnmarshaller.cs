...
namespace Amazon.QApps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QQueryCardInputUnmarshaller : IUnmarshaller<QQueryCardInput, XmlUnmarshallerContext>, IUnmarshaller<QQueryCardInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        QQueryCardInput IUnmarshaller<QQueryCardInput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public QQueryCardInput Unmarshall(JsonUnmarshallerContext context)
        {
