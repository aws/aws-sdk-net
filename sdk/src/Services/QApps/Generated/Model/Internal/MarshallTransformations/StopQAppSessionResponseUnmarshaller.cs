...
{
    /// <summary>
    /// Response Unmarshaller for StopQAppSession operation
    /// </summary>  
    public class StopQAppSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopQAppSessionResponse response = new StopQAppSessionResponse();
        ...
        private static StopQAppSessionResponseUnmarshaller _instance = new StopQAppSessionResponseUnmarshaller();        

        internal static StopQAppSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopQAppSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
