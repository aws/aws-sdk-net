...
namespace Amazon.QApps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CategoryUnmarshaller : IJsonUnmarshaller<Category, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Category Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("appCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.AppCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
