...
{
    /// <summary>
    /// Container for the parameters to the BatchCreateCategory operation.
    ...
    /// </summary>
    public partial class BatchCreateCategoryRequest : AmazonQAppsRequest
    {
        private List<BatchCreateCategoryInputCategory> _categories = AWSConfigs.InitializeCollections ? new List<BatchCreateCategoryInputCategory>() : null;
        ...
        public List<BatchCreateCategoryInputCategory> Categories
        {
