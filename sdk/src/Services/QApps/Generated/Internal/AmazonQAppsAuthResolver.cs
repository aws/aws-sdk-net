...
namespace Amazon.QApps.Internal
{
    ...
    public class AmazonQAppsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQAppsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QApps.
        /// </summary>
        public AmazonQAppsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQAppsAuthSchemeParameters
            {
    ...
    public class AmazonQAppsAuthSchemeResolver : IAuthSchemeResolver<AmazonQAppsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQAppsAuthSchemeParameters authParameters)
        {
