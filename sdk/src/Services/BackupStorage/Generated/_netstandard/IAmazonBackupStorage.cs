...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonBackupStorageConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonBackupStorageConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonBackupStorageConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonBackupStorageConfig to create AmazonBackupStorageClient");
            }

            return awsCredentials == null ? 
                    new AmazonBackupStorageClient(serviceClientConfig) :
                    new AmazonBackupStorageClient(awsCredentials, serviceClientConfig);
        }
