...
namespace Amazon.BackupStorage.Model
{
    ...
    public partial class ServiceInternalException : AmazonBackupStorageException
    {
        ...
        public ServiceInternalException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ServiceInternalException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
