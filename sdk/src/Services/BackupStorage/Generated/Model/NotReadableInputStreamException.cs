...
namespace Amazon.BackupStorage.Model
{
    ...
    public partial class NotReadableInputStreamException : AmazonBackupStorageException
    {
        ...
        public NotReadableInputStreamException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotReadableInputStreamException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
