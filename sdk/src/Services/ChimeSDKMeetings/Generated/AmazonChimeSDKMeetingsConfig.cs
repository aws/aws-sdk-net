...
namespace Amazon.ChimeSDKMeetings
{
    ...
    public partial class AmazonChimeSDKMeetingsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Chime SDK Meetings", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Chime SDK Meetings";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "meetings-chime";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-07-15";
