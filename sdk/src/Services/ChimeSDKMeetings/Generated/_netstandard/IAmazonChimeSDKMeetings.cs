...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonChimeSDKMeetingsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonChimeSDKMeetingsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonChimeSDKMeetingsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonChimeSDKMeetingsConfig to create AmazonChimeSDKMeetingsClient");
            }

            return awsCredentials == null ? 
                    new AmazonChimeSDKMeetingsClient(serviceClientConfig) :
                    new AmazonChimeSDKMeetingsClient(awsCredentials, serviceClientConfig);
        }
