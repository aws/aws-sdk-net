...
{
    /// <summary>
    /// Amazon ChimeSDKMeetings endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ChimeSDKMeetings service requests.
    /// Collects values for ChimeSDKMeetingsEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ChimeSDKMeetingsEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonChimeSDKMeetingsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonChimeSDKMeetingsConfig)requestContext.ClientConfig;
            var result = new ChimeSDKMeetingsEndpointParameters();
