...
namespace Amazon.ChimeSDKMeetings
{
    ...
    public partial class AmazonChimeSDKMeetingsClient : AmazonServiceClient, IAmazonChimeSDKMeetings
    {
        ...
        /// 
        /// </summary>
        public AmazonChimeSDKMeetingsClient() : base(new AmazonChimeSDKMeetingsConfig()) { }
        ...
        public AmazonChimeSDKMeetingsClient(RegionEndpoint region) : base(new AmazonChimeSDKMeetingsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonChimeSDKMeetingsClient(AmazonChimeSDKMeetingsConfig config) : base(config) { }
