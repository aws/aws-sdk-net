...
namespace Amazon.ChimeSDKMeetings.Model
{
    ...
    public partial class BatchCreateAttendeeResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<Attendee> Attendees { get; set; } = AWSConfigs.InitializeCollections ? new List<Attendee>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<CreateAttendeeError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<CreateAttendeeError>() : null;
