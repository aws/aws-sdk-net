...
{
    /// <summary>
    /// Container for the parameters to the GetAttendee operation. Gets the Amazon Chime SDK
    /// attendee details for a specified meeting ID and attendee ID. For more information
