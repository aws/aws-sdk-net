...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMeetingWithAttendeesRequestMarshaller : IMarshaller<IRequest, CreateMeetingWithAttendeesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateMeetingWithAttendeesRequestMarshaller _instance = new();

        internal static CreateMeetingWithAttendeesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMeetingWithAttendeesRequestMarshaller Instance => _instance;
    }
}
