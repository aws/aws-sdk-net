...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAttendeeRequestMarshaller : IMarshaller<IRequest, DeleteAttendeeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAttendeeRequestMarshaller _instance = new();

        internal static DeleteAttendeeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAttendeeRequestMarshaller Instance => _instance;
    }
}
