...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAttendeesRequestMarshaller : IMarshaller<IRequest, ListAttendeesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAttendeesRequestMarshaller _instance = new();

        internal static ListAttendeesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAttendeesRequestMarshaller Instance => _instance;
    }
}
