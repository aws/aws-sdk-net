...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAttendeeCapabilitiesRequestMarshaller : IMarshaller<IRequest, UpdateAttendeeCapabilitiesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAttendeeCapabilitiesRequestMarshaller _instance = new();

        internal static UpdateAttendeeCapabilitiesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAttendeeCapabilitiesRequestMarshaller Instance => _instance;
    }
}
