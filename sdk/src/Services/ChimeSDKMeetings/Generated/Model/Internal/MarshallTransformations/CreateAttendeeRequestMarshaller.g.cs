...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAttendeeRequestMarshaller : IMarshaller<IRequest, CreateAttendeeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateAttendeeRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetExternalUserId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ExternalUserId);
            }
        ...
        private static readonly CreateAttendeeRequestMarshaller _instance = new();

        internal static CreateAttendeeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAttendeeRequestMarshaller Instance => _instance;
    }
}
