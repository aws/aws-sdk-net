...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MeetingUnmarshaller : IJsonUnmarshaller<Meeting, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Meeting();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MeetingUnmarshaller Instance => _instance;
    }
}
