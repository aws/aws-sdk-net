...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateMeetingRequestMarshaller : IMarshaller<IRequest, CreateMeetingRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateMeetingRequestMarshaller _instance = new();

        internal static CreateMeetingRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateMeetingRequestMarshaller Instance => _instance;
    }
}
