...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AttendeeCapabilitiesUnmarshaller : IJsonUnmarshaller<AttendeeCapabilities, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AttendeeCapabilities();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AttendeeCapabilitiesUnmarshaller Instance => _instance;
    }
}
