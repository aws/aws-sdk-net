...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAttendeeErrorUnmarshaller : IJsonUnmarshaller<CreateAttendeeError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAttendeeError();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CreateAttendeeErrorUnmarshaller Instance => _instance;
    }
}
