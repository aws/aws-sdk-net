...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAttendeeCapabilitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateAttendeeCapabilitiesResponse();
        ...
        internal static UpdateAttendeeCapabilitiesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAttendeeCapabilitiesResponseUnmarshaller Instance => _instance;
    }
}
