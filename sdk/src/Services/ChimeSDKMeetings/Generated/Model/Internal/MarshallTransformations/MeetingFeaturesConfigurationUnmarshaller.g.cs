...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MeetingFeaturesConfigurationUnmarshaller : IJsonUnmarshaller<MeetingFeaturesConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MeetingFeaturesConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MeetingFeaturesConfigurationUnmarshaller Instance => _instance;
    }
}
