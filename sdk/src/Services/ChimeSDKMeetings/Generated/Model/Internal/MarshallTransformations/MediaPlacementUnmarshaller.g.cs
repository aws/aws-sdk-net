...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MediaPlacementUnmarshaller : IJsonUnmarshaller<MediaPlacement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MediaPlacement();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MediaPlacementUnmarshaller Instance => _instance;
    }
}
