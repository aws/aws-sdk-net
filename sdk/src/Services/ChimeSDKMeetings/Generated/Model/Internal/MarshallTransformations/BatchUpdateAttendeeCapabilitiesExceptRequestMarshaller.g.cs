...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchUpdateAttendeeCapabilitiesExceptRequestMarshaller : IMarshaller<IRequest, BatchUpdateAttendeeCapabilitiesExceptRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchUpdateAttendeeCapabilitiesExceptRequestMarshaller _instance = new();

        internal static BatchUpdateAttendeeCapabilitiesExceptRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchUpdateAttendeeCapabilitiesExceptRequestMarshaller Instance => _instance;
    }
}
