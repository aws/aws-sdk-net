...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAttendeeResponse();
        ...
        internal static GetAttendeeResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAttendeeResponseUnmarshaller Instance => _instance;
    }
}
