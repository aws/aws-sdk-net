...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AttendeeUnmarshaller : IJsonUnmarshaller<Attendee, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Attendee();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AttendeeUnmarshaller Instance => _instance;
    }
}
