...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAttendeeRequestMarshaller : IMarshaller<IRequest, GetAttendeeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetAttendeeRequestMarshaller _instance = new();

        internal static GetAttendeeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAttendeeRequestMarshaller Instance => _instance;
    }
}
