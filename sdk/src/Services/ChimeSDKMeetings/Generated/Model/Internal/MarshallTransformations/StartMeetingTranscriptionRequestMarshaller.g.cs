...
namespace Amazon.ChimeSDKMeetings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartMeetingTranscriptionRequestMarshaller : IMarshaller<IRequest, StartMeetingTranscriptionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartMeetingTranscriptionRequestMarshaller _instance = new();

        internal static StartMeetingTranscriptionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartMeetingTranscriptionRequestMarshaller Instance => _instance;
    }
}
