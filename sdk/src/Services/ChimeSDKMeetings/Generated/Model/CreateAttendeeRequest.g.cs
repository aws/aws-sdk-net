...
{
    /// <summary>
    /// Container for the parameters to the CreateAttendee operation. Creates a new attendee
    /// for an active Amazon Chime SDK meeting. For more information about the Amazon Chime
