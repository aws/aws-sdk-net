...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NatGatewayUnmarshaller : IJsonUnmarshaller<NatGateway, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NatGateway Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NatGatewayConfigurationUnmarshaller.Instance;
