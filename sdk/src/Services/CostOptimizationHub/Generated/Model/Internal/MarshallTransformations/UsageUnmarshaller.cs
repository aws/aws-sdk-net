...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageUnmarshaller : IJsonUnmarshaller<Usage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Usage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("usageAmount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.UsageAmount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
