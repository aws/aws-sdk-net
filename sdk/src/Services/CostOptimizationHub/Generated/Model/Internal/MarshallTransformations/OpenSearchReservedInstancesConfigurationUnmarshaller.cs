    ...
    public class OpenSearchReservedInstancesConfigurationUnmarshaller : IJsonUnmarshaller<OpenSearchReservedInstancesConfiguration, JsonUnmarshallerContext>
    {
        ...
        public OpenSearchReservedInstancesConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("monthlyRecurringCost", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MonthlyRecurringCost = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("normalizedUnitsToPurchase", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NormalizedUnitsToPurchase = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("numberOfInstancesToPurchase", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("reservedInstancesRegion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static OpenSearchReservedInstancesConfigurationUnmarshaller _instance = new OpenSearchReservedInstancesConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OpenSearchReservedInstancesConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
