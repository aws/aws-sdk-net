...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricsByTimeUnmarshaller : IJsonUnmarshaller<MetricsByTime, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricsByTime Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("spend", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.Spend = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
