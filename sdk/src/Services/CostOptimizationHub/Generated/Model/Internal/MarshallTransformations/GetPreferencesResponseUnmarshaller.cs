    ...
    public class GetPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SavingsEstimationMode = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetPreferencesResponseUnmarshaller _instance = new GetPreferencesResponseUnmarshaller();        

        internal static GetPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
