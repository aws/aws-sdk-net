...
namespace Amazon.CostOptimizationHub.Model
{
    ...
    public partial class GetRecommendationResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._costCalculationLookbackPeriodInDays.GetValueOrDefault(); }
        ...
        {
            get { return this._estimatedSavingsOverCostCalculationLookbackPeriod.GetValueOrDefault(); }
