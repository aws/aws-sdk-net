...
namespace Amazon.CostOptimizationHub.Model
{
    ...
    public partial class NatGatewayConfiguration
    {
        ...
        {
            get { return this._activeConnectionCount.GetValueOrDefault(); }
        ...
        {
            get { return this._packetsInFromDestination.GetValueOrDefault(); }
        ...
        {
            get { return this._packetsInFromSource.GetValueOrDefault(); }
