...
namespace Amazon.CostOptimizationHub
{
    ...
    public partial interface IAmazonCostOptimizationHub : IAmazonService, IDisposable
    {
        ...
        Task<GetRecommendationResponse> GetRecommendationAsync(GetRecommendationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListEfficiencyMetricsResponse> ListEfficiencyMetricsAsync(ListEfficiencyMetricsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListEnrollmentStatusesResponse> ListEnrollmentStatusesAsync(ListEnrollmentStatusesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListRecommendationSummariesResponse> ListRecommendationSummariesAsync(ListRecommendationSummariesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCostOptimizationHubConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCostOptimizationHubConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCostOptimizationHubConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCostOptimizationHubConfig to create AmazonCostOptimizationHubClient");
            }

            return awsCredentials == null ? 
                    new AmazonCostOptimizationHubClient(serviceClientConfig) :
                    new AmazonCostOptimizationHubClient(awsCredentials, serviceClientConfig);
        }
