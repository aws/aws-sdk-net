...
namespace Amazon.Synthetics.Model.Internal.MarshallTransformations
{
    ...
    public class ReplicaUnmarshaller : IJsonUnmarshaller<Replica, JsonUnmarshallerContext>
    {
        ...
        public Replica Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CanaryState", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CanaryState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = ReplicationStatusUnmarshaller.Instance;
