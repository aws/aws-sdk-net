...
{
    /// <summary>
    /// Response Unmarshaller for QuickResponseSearchResultData Object
    /// </summary>  
    public class QuickResponseSearchResultDataUnmarshaller : IUnmarshaller<QuickResponseSearchResultData, XmlUnmarshallerContext>, IUnmarshaller<QuickResponseSearchResultData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        QuickResponseSearchResultData IUnmarshaller<QuickResponseSearchResultData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public QuickResponseSearchResultData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("attributesInterpolated", targetDepth))
                {
                    ...
                    unmarshalledObject.AttributesInterpolated = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("attributesNotInterpolated", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AttributesNotInterpolated = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("contents", targetDepth))
                {
                    ...
                    unmarshalledObject.Contents = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QuickResponseArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("quickResponseId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QuickResponseId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("shortcutKey", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ShortcutKey = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static QuickResponseSearchResultDataUnmarshaller _instance = new QuickResponseSearchResultDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QuickResponseSearchResultDataUnmarshaller Instance
        {
            get
            {
                return _instance;
