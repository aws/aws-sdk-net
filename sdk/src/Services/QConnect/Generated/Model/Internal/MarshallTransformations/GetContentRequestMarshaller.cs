...
{
    /// <summary>
    /// GetContent Request Marshaller
    /// </summary>       
    public class GetContentRequestMarshaller : IMarshaller<IRequest, GetContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetContentRequest publicRequest)
        {
        ...
        private static GetContentRequestMarshaller _instance = new GetContentRequestMarshaller();        

        internal static GetContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
