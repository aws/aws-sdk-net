...
{
    /// <summary>
    /// DeleteAIGuardrailVersion Request Marshaller
    /// </summary>       
    public class DeleteAIGuardrailVersionRequestMarshaller : IMarshaller<IRequest, DeleteAIGuardrailVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAIGuardrailVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAIGuardrailVersionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/assistants/{assistantId}/aiguardrails/{aiGuardrailId}/versions/{versionNumber}";

            return request;
        }
        private static DeleteAIGuardrailVersionRequestMarshaller _instance = new DeleteAIGuardrailVersionRequestMarshaller();        

        internal static DeleteAIGuardrailVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAIGuardrailVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
