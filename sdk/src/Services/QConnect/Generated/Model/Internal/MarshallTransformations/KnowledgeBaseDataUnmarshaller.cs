...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KnowledgeBaseDataUnmarshaller : IUnmarshaller<KnowledgeBaseData, XmlUnmarshallerContext>, IUnmarshaller<KnowledgeBaseData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        KnowledgeBaseData IUnmarshaller<KnowledgeBaseData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public KnowledgeBaseData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ingestionFailureReasons", targetDepth))
                {
                    ...
                    unmarshalledObject.IngestionFailureReasons = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("lastContentModificationTime", targetDepth))
                {
                    ...
                    unmarshalledObject.LastContentModificationTime = unmarshaller.Unmarshall(context);
                    continue;
                }
