...
{
    /// <summary>
    /// QuickResponseQueryField Marshaller
    /// </summary>
    public class QuickResponseQueryFieldMarshaller : IRequestMarshaller<QuickResponseQueryField, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(QuickResponseQueryField requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAllowFuzziness())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.AllowFuzziness.Value);
            }
        ...
        /// </summary>
        public readonly static QuickResponseQueryFieldMarshaller Instance = new QuickResponseQueryFieldMarshaller();
