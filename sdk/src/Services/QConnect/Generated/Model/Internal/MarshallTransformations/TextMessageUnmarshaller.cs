...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TextMessageUnmarshaller : IJsonUnmarshaller<TextMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TextMessage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("aiGuardrailAssessment", targetDepth, ref reader))
                {
