...
{
    /// <summary>
    /// ToolUseResultData Marshaller
    /// </summary>
    public class ToolUseResultDataMarshaller : IRequestMarshaller<ToolUseResultData, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ToolUseResultData requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetToolResult())
            {
                ...
                Amazon.Runtime.Documents.Internal.Transform.DocumentMarshaller.Instance.Write(context.Writer, requestObject.ToolResult);
            }
        ...
        /// </summary>
        public readonly static ToolUseResultDataMarshaller Instance = new ToolUseResultDataMarshaller();
