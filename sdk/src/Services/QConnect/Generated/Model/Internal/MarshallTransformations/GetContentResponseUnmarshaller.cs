...
{
    /// <summary>
    /// Response Unmarshaller for GetContent operation
    /// </summary>  
    public class GetContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetContentResponseUnmarshaller _instance = new GetContentResponseUnmarshaller();        

        internal static GetContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
