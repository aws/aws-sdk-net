...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class MessageDataUnmarshaller : IUnmarshaller<MessageData, XmlUnmarshallerContext>, IUnmarshaller<MessageData, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        MessageData IUnmarshaller<MessageData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MessageData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("toolUseResult", targetDepth))
                {
                    ...
                    unmarshalledObject.ToolUseResult = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
