...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpanAttributesUnmarshaller : IUnmarshaller<SpanAttributes, XmlUnmarshallerContext>, IUnmarshaller<SpanAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SpanAttributes IUnmarshaller<SpanAttributes, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SpanAttributes Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AiAgentInvoker = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aiAgentName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AiAgentName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aiAgentOrchestratorUseCase", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AiAgentOrchestratorUseCase = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aiAgentType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AiAgentType = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aiAgentVersion", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.AiAgentVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SpanMessage, SpanMessageUnmarshaller>(SpanMessageUnmarshaller.Instance);
                    unmarshalledObject.InputMessages = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SpanMessage, SpanMessageUnmarshaller>(SpanMessageUnmarshaller.Instance);
                    unmarshalledObject.OutputMessages = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PromptName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.PromptVersion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.RequestMaxTokens = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("requestModel", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RequestModel = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("responseFinishReasons", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.ResponseFinishReasons = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("responseModel", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResponseModel = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("systemInstructions", targetDepth))
                {
                    ...
                    unmarshalledObject.SystemInstructions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.UsageInputTokens = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("usageOutputTokens", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.UsageOutputTokens = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("usageTotalTokens", targetDepth))
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.UsageTotalTokens = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
