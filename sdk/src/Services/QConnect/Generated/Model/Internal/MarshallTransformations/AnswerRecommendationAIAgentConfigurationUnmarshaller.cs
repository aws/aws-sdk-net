...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnswerRecommendationAIAgentConfigurationUnmarshaller : IUnmarshaller<AnswerRecommendationAIAgentConfiguration, XmlUnmarshallerContext>, IUnmarshaller<AnswerRecommendationAIAgentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AnswerRecommendationAIAgentConfiguration IUnmarshaller<AnswerRecommendationAIAgentConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AnswerRecommendationAIAgentConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IntentLabelingGenerationAIPromptId = unmarshaller.Unmarshall(context);
                    continue;
                }
