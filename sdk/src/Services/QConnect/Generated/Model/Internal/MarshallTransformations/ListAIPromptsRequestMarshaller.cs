...
{
    /// <summary>
    /// ListAIPrompts Request Marshaller
    /// </summary>       
    public class ListAIPromptsRequestMarshaller : IMarshaller<IRequest, ListAIPromptsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAIPromptsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAIPromptsRequest publicRequest)
        {
        ...
        private static ListAIPromptsRequestMarshaller _instance = new ListAIPromptsRequestMarshaller();        

        internal static ListAIPromptsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAIPromptsRequestMarshaller Instance
        {
            get
            {
                return _instance;
