...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MessageOutputUnmarshaller : IUnmarshaller<MessageOutput, XmlUnmarshallerContext>, IUnmarshaller<MessageOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MessageOutput IUnmarshaller<MessageOutput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MessageOutput Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Participant = unmarshaller.Unmarshall(context);
                    continue;
                }
