...
{
    /// <summary>
    /// UpdateAIAgent Request Marshaller
    /// </summary>       
    public class UpdateAIAgentRequestMarshaller : IMarshaller<IRequest, UpdateAIAgentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAIAgentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAIAgentRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetConfiguration())
            {
                ...
                var marshaller = AIAgentConfigurationMarshaller.Instance;
        ...
        private static UpdateAIAgentRequestMarshaller _instance = new UpdateAIAgentRequestMarshaller();        

        internal static UpdateAIAgentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAIAgentRequestMarshaller Instance
        {
            get
            {
                return _instance;
