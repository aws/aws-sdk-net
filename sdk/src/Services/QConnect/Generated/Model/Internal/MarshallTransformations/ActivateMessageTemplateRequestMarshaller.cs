...
{
    /// <summary>
    /// ActivateMessageTemplate Request Marshaller
    /// </summary>       
    public class ActivateMessageTemplateRequestMarshaller : IMarshaller<IRequest, ActivateMessageTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ActivateMessageTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ActivateMessageTemplateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/knowledgeBases/{knowledgeBaseId}/messageTemplates/{messageTemplateId}/activate";
#if !NETFRAMEWORK
        ...
        private static ActivateMessageTemplateRequestMarshaller _instance = new ActivateMessageTemplateRequestMarshaller();        

        internal static ActivateMessageTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivateMessageTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
