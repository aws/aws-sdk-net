...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetrieveResultUnmarshaller : IJsonUnmarshaller<RetrieveResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RetrieveResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("contentText", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ContentText = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
