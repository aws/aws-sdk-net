...
{
    /// <summary>
    /// Response Unmarshaller for StartContentUpload operation
    /// </summary>  
    public class StartContentUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartContentUploadResponse response = new StartContentUploadResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("headersToInclude", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    response.HeadersToInclude = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartContentUploadResponseUnmarshaller _instance = new StartContentUploadResponseUnmarshaller();        

        internal static StartContentUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartContentUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
