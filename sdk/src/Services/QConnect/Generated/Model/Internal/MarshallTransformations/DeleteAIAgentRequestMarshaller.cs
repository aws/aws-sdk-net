...
{
    /// <summary>
    /// DeleteAIAgent Request Marshaller
    /// </summary>       
    public class DeleteAIAgentRequestMarshaller : IMarshaller<IRequest, DeleteAIAgentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAIAgentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAIAgentRequest publicRequest)
        {
        ...
        private static DeleteAIAgentRequestMarshaller _instance = new DeleteAIAgentRequestMarshaller();        

        internal static DeleteAIAgentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAIAgentRequestMarshaller Instance
        {
            get
            {
                return _instance;
