...
{
    /// <summary>
    /// ListSpans Request Marshaller
    /// </summary>       
    public class ListSpansRequestMarshaller : IMarshaller<IRequest, ListSpansRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSpansRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSpansRequest publicRequest)
        {
            ...
            request.ResourcePath = "/assistants/{assistantId}/sessions/{sessionId}/spans";
            request.UseQueryString = true;

            return request;
        }
        private static ListSpansRequestMarshaller _instance = new ListSpansRequestMarshaller();        

        internal static ListSpansRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSpansRequestMarshaller Instance
        {
            get
            {
                return _instance;
