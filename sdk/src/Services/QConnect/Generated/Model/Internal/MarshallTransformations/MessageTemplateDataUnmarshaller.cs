...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MessageTemplateDataUnmarshaller : IUnmarshaller<MessageTemplateData, XmlUnmarshallerContext>, IUnmarshaller<MessageTemplateData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MessageTemplateData IUnmarshaller<MessageTemplateData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MessageTemplateData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("attributeTypes", targetDepth))
                {
                    ...
                    unmarshalledObject.AttributeTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("groupingConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.GroupingConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MessageTemplateContentSha256 = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("sourceConfigurationSummary", targetDepth))
                {
                    ...
                    unmarshalledObject.SourceConfigurationSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
