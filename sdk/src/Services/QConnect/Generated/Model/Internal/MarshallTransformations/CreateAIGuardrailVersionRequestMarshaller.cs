...
{
    /// <summary>
    /// CreateAIGuardrailVersion Request Marshaller
    /// </summary>       
    public class CreateAIGuardrailVersionRequestMarshaller : IMarshaller<IRequest, CreateAIGuardrailVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAIGuardrailVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAIGuardrailVersionRequest publicRequest)
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                using (StreamWriter streamWriter = new InvariantCultureStreamWriter(memoryStream))
                {
                    ...
                    if(publicRequest.IsSetModifiedTime())
                    {
                        ...
                        context.Writer.Write(publicRequest.ModifiedTime.Value);
                    }
        ...
        private static CreateAIGuardrailVersionRequestMarshaller _instance = new CreateAIGuardrailVersionRequestMarshaller();        

        internal static CreateAIGuardrailVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIGuardrailVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
