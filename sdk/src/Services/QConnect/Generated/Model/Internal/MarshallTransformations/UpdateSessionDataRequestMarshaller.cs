...
{
    /// <summary>
    /// UpdateSessionData Request Marshaller
    /// </summary>       
    public class UpdateSessionDataRequestMarshaller : IMarshaller<IRequest, UpdateSessionDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSessionDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSessionDataRequest publicRequest)
        {
        ...
        private static UpdateSessionDataRequestMarshaller _instance = new UpdateSessionDataRequestMarshaller();        

        internal static UpdateSessionDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSessionDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
