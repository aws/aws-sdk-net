...
{
    /// <summary>
    /// CreateQuickResponse Request Marshaller
    /// </summary>       
    public class CreateQuickResponseRequestMarshaller : IMarshaller<IRequest, CreateQuickResponseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateQuickResponseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateQuickResponseRequest publicRequest)
        {
        ...
        private static CreateQuickResponseRequestMarshaller _instance = new CreateQuickResponseRequestMarshaller();        

        internal static CreateQuickResponseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQuickResponseRequestMarshaller Instance
        {
            get
            {
                return _instance;
