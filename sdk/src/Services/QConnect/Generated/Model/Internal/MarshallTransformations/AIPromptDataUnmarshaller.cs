...
{
    /// <summary>
    /// Response Unmarshaller for AIPromptData Object
    /// </summary>  
    public class AIPromptDataUnmarshaller : IUnmarshaller<AIPromptData, XmlUnmarshallerContext>, IUnmarshaller<AIPromptData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AIPromptData IUnmarshaller<AIPromptData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AIPromptData Unmarshall(JsonUnmarshallerContext context)
        {
            AIPromptData unmarshalledObject = new AIPromptData();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("aiPromptArn", targetDepth))
                {
                    ...
                    unmarshalledObject.AiPromptArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aiPromptId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AiPromptId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("apiFormat", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ApiFormat = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = AIPromptTemplateConfigurationUnmarshaller.Instance;
        ...
        private static AIPromptDataUnmarshaller _instance = new AIPromptDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AIPromptDataUnmarshaller Instance
        {
            get
            {
                return _instance;
