...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAIGuardrailRequestMarshaller : IMarshaller<IRequest, GetAIGuardrailRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetAIGuardrailRequestMarshaller _instance = new GetAIGuardrailRequestMarshaller();        

        internal static GetAIGuardrailRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAIGuardrailRequestMarshaller Instance
        {
            get
            {
                return _instance;
