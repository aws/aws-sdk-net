...
{
    /// <summary>
    /// ListAIAgentVersions Request Marshaller
    /// </summary>       
    public class ListAIAgentVersionsRequestMarshaller : IMarshaller<IRequest, ListAIAgentVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAIAgentVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAIAgentVersionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/assistants/{assistantId}/aiagents/{aiAgentId}/versions";
            request.UseQueryString = true;

            return request;
        }
        private static ListAIAgentVersionsRequestMarshaller _instance = new ListAIAgentVersionsRequestMarshaller();        

        internal static ListAIAgentVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAIAgentVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
