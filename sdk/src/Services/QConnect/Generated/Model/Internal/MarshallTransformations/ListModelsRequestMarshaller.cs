...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class ListModelsRequestMarshaller : IMarshaller<IRequest, ListModelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListModelsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetAiPromptType())
                request.Parameters.Add("aiPromptType", StringUtils.FromString(publicRequest.AiPromptType));
            
            if (publicRequest.IsSetMaxResults())
                request.Parameters.Add("maxResults", StringUtils.FromInt(publicRequest.MaxResults));
            
            if (publicRequest.IsSetModelLifecycle())
                request.Parameters.Add("modelLifecycle", StringUtils.FromString(publicRequest.ModelLifecycle));
            
            if (publicRequest.IsSetNextToken())
                request.Parameters.Add("nextToken", StringUtils.FromString(publicRequest.NextToken));
            request.ResourcePath = "/assistants/{assistantId}/models";
