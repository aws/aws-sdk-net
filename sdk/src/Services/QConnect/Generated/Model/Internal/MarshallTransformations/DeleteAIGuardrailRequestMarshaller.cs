...
{
    /// <summary>
    /// DeleteAIGuardrail Request Marshaller
    /// </summary>       
    public class DeleteAIGuardrailRequestMarshaller : IMarshaller<IRequest, DeleteAIGuardrailRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAIGuardrailRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAIGuardrailRequest publicRequest)
        {
        ...
        private static DeleteAIGuardrailRequestMarshaller _instance = new DeleteAIGuardrailRequestMarshaller();        

        internal static DeleteAIGuardrailRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAIGuardrailRequestMarshaller Instance
        {
            get
            {
                return _instance;
