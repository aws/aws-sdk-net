...
{
    /// <summary>
    /// Response Unmarshaller for GetQuickResponse operation
    /// </summary>  
    public class GetQuickResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQuickResponseResponse response = new GetQuickResponseResponse();
        ...
        private static GetQuickResponseResponseUnmarshaller _instance = new GetQuickResponseResponseUnmarshaller();        

        internal static GetQuickResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQuickResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
