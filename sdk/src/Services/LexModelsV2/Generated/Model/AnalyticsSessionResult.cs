...
namespace Amazon.LexModelsV2.Model
{
    ...
    public partial class AnalyticsSessionResult
    {
        ...
        private List<AnalyticsSessionGroupByKey> _groupByKeys = new List<AnalyticsSessionGroupByKey>();
        private List<AnalyticsSessionMetricResult> _metricsResults = new List<AnalyticsSessionMetricResult>();
