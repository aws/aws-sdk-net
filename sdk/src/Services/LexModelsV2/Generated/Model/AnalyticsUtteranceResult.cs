...
{
    /// <summary>
    /// An object containing the results for the utterance metrics you requested and the bin
    /// and/or group(s) they refer to, if applicable.
    /// </summary>
    public partial class AnalyticsUtteranceResult
    {
        ...
        /// <para>
        /// A list of objects containing information about the last used intent at the time of
        /// an utterance.
        /// </para>
        /// <para />
        ...
        /// </summary>
        public List<AnalyticsUtteranceAttributeResult> AttributeResults
        {
            get { return this._attributeResults; }
            set { this._attributeResults = value; }
        }
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<AnalyticsUtteranceGroupByKey> GroupByKeys
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<AnalyticsUtteranceMetricResult> MetricsResults
        {
