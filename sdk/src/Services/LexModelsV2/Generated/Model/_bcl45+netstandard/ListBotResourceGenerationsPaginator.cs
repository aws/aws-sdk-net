...
namespace Amazon.LexModelsV2.Model
{
    ...
    internal sealed partial class ListBotResourceGenerationsPaginator : IPaginator<ListBotResourceGenerationsResponse>, IListBotResourceGenerationsPaginator
    {
        ...
        async IAsyncEnumerable<ListBotResourceGenerationsResponse> IPaginator<ListBotResourceGenerationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
