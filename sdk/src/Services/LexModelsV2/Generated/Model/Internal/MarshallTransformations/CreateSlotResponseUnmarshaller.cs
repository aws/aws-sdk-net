...
{
    /// <summary>
    /// Response Unmarshaller for CreateSlot operation
    /// </summary>  
    public class CreateSlotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("multipleValuesSetting", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("slotName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("subSlotSetting", targetDepth, ref reader))
                {
                    var unmarshaller = SubSlotSettingUnmarshaller.Instance;
                    response.SubSlotSetting = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("valueElicitationSetting", targetDepth, ref reader))
                {
        ...
        private static CreateSlotResponseUnmarshaller _instance = new CreateSlotResponseUnmarshaller();        

        internal static CreateSlotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSlotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
