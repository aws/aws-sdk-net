    ...
    public class IntentLevelSlotResolutionTestResultItemUnmarshaller : IJsonUnmarshaller<IntentLevelSlotResolutionTestResultItem, JsonUnmarshallerContext>
    {
        ...
        public IntentLevelSlotResolutionTestResultItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("multiTurnConversation", targetDepth, ref reader))
                {
        ...
        private static IntentLevelSlotResolutionTestResultItemUnmarshaller _instance = new IntentLevelSlotResolutionTestResultItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IntentLevelSlotResolutionTestResultItemUnmarshaller Instance
        {
            get
            {
                return _instance;
