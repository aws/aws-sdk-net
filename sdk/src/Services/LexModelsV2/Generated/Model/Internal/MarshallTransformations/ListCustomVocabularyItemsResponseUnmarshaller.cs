...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomVocabularyItems operation
    /// </summary>  
    public class ListCustomVocabularyItemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomVocabularyItemsResponse response = new ListCustomVocabularyItemsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("customVocabularyItems", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CustomVocabularyItem, CustomVocabularyItemUnmarshaller>(CustomVocabularyItemUnmarshaller.Instance);
                    response.CustomVocabularyItems = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCustomVocabularyItemsResponseUnmarshaller _instance = new ListCustomVocabularyItemsResponseUnmarshaller();        

        internal static ListCustomVocabularyItemsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomVocabularyItemsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
