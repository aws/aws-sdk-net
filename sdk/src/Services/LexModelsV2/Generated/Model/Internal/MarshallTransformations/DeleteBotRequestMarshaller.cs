...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteBotRequestMarshaller : IMarshaller<IRequest, DeleteBotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteBotRequestMarshaller _instance = new DeleteBotRequestMarshaller();        

        internal static DeleteBotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBotRequestMarshaller Instance
        {
            get
            {
                return _instance;
