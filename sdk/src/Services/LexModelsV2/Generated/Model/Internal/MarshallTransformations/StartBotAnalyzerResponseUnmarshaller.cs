...
{
    /// <summary>
    /// Response Unmarshaller for StartBotAnalyzer operation
    /// </summary>  
    public class StartBotAnalyzerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBotAnalyzerResponse response = new StartBotAnalyzerResponse();
            ...
            {
                if (context.TestExpression("botAnalyzerRequestId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BotAnalyzerRequestId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("botAnalyzerStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BotAnalyzerStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartBotAnalyzerResponseUnmarshaller _instance = new StartBotAnalyzerResponseUnmarshaller();        

        internal static StartBotAnalyzerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBotAnalyzerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
