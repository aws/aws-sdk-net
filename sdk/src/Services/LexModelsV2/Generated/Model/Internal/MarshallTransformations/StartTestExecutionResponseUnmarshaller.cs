...
{
    /// <summary>
    /// Response Unmarshaller for StartTestExecution operation
    /// </summary>  
    public class StartTestExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTestExecutionResponse response = new StartTestExecutionResponse();
            ...
            {
                if (context.TestExpression("apiMode", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("testExecutionId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestExecutionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("testExecutionModality", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static StartTestExecutionResponseUnmarshaller _instance = new StartTestExecutionResponseUnmarshaller();        

        internal static StartTestExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTestExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
