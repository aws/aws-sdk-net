...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImport operation
    /// </summary>  
    public class DeleteImportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImportResponse response = new DeleteImportResponse();
        ...
        private static DeleteImportResponseUnmarshaller _instance = new DeleteImportResponseUnmarshaller();        

        internal static DeleteImportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
