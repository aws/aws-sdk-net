...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SlotResolutionTestResultItemUnmarshaller : IJsonUnmarshaller<SlotResolutionTestResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SlotResolutionTestResultItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("resultCounts", targetDepth, ref reader))
                {
                    var unmarshaller = SlotResolutionTestResultItemCountsUnmarshaller.Instance;
                    unmarshalledObject.ResultCounts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
