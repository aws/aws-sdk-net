...
{
    /// <summary>
    /// ListIntentPaths Request Marshaller
    /// </summary>       
    public class ListIntentPathsRequestMarshaller : IMarshaller<IRequest, ListIntentPathsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListIntentPathsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListIntentPathsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetIntentPath())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.IntentPath);
            }
        ...
        private static ListIntentPathsRequestMarshaller _instance = new ListIntentPathsRequestMarshaller();        

        internal static ListIntentPathsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentPathsRequestMarshaller Instance
        {
            get
            {
                return _instance;
