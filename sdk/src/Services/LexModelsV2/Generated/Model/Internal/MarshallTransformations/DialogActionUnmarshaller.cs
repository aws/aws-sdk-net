...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DialogActionUnmarshaller : IJsonUnmarshaller<DialogAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DialogAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("suppressNextMessage", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.SuppressNextMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
