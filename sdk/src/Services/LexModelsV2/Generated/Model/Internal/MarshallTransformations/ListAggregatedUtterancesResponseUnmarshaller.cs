...
{
    /// <summary>
    /// Response Unmarshaller for ListAggregatedUtterances operation
    /// </summary>  
    public class ListAggregatedUtterancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAggregatedUtterancesResponse response = new ListAggregatedUtterancesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AggregatedUtterancesSummary, AggregatedUtterancesSummaryUnmarshaller>(AggregatedUtterancesSummaryUnmarshaller.Instance);
                    response.AggregatedUtterancesSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aggregationDuration", targetDepth))
                {
                    ...
                    response.AggregationDuration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aggregationLastRefreshedDateTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.AggregationLastRefreshedDateTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aggregationWindowEndTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.AggregationWindowEndTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("aggregationWindowStartTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.AggregationWindowStartTime = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAggregatedUtterancesResponseUnmarshaller _instance = new ListAggregatedUtterancesResponseUnmarshaller();        

        internal static ListAggregatedUtterancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAggregatedUtterancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
