...
{
    /// <summary>
    /// Response Unmarshaller for ListBotAliases operation
    /// </summary>  
    public class ListBotAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBotAliasesResponse response = new ListBotAliasesResponse();
            ...
            {
                if (context.TestExpression("botAliasSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BotAliasSummary, BotAliasSummaryUnmarshaller>(BotAliasSummaryUnmarshaller.Instance);
                    response.BotAliasSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListBotAliasesResponseUnmarshaller _instance = new ListBotAliasesResponseUnmarshaller();        

        internal static ListBotAliasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBotAliasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
