...
{
    /// <summary>
    /// Response Unmarshaller for ListSessionAnalyticsData operation
    /// </summary>  
    public class ListSessionAnalyticsDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSessionAnalyticsDataResponse response = new ListSessionAnalyticsDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SessionSpecification, SessionSpecificationUnmarshaller>(SessionSpecificationUnmarshaller.Instance);
        ...
        private static ListSessionAnalyticsDataResponseUnmarshaller _instance = new ListSessionAnalyticsDataResponseUnmarshaller();        

        internal static ListSessionAnalyticsDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSessionAnalyticsDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
