...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTestSet operation
    /// </summary>  
    public class DeleteTestSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTestSetResponse response = new DeleteTestSetResponse();
        ...
        private static DeleteTestSetResponseUnmarshaller _instance = new DeleteTestSetResponseUnmarshaller();        

        internal static DeleteTestSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTestSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
