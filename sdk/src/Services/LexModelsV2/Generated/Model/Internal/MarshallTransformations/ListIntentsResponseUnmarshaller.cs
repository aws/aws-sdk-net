...
{
    /// <summary>
    /// Response Unmarshaller for ListIntents operation
    /// </summary>  
    public class ListIntentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("intentSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<IntentSummary, IntentSummaryUnmarshaller>(IntentSummaryUnmarshaller.Instance);
                    response.IntentSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListIntentsResponseUnmarshaller _instance = new ListIntentsResponseUnmarshaller();        

        internal static ListIntentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
