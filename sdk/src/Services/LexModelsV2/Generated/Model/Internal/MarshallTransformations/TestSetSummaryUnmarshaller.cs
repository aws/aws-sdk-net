...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestSetSummaryUnmarshaller : IUnmarshaller<TestSetSummary, XmlUnmarshallerContext>, IUnmarshaller<TestSetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TestSetSummary IUnmarshaller<TestSetSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TestSetSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("numTurns", targetDepth))
                {
                    ...
                    unmarshalledObject.NumTurns = unmarshaller.Unmarshall(context);
                    continue;
                }
