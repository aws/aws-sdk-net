...
{
    /// <summary>
    /// StartTestExecution Request Marshaller
    /// </summary>       
    public class StartTestExecutionRequestMarshaller : IMarshaller<IRequest, StartTestExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartTestExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartTestExecutionRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetApiMode())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ApiMode);
            }
            ...
            if(publicRequest.IsSetTestExecutionModality())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TestExecutionModality);
            }
        ...
        private static StartTestExecutionRequestMarshaller _instance = new StartTestExecutionRequestMarshaller();        

        internal static StartTestExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTestExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
