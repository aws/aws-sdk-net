...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTestSet operation
    /// </summary>  
    public class UpdateTestSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTestSetResponse response = new UpdateTestSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Modality = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("numTurns", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.NumTurns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateTestSetResponseUnmarshaller _instance = new UpdateTestSetResponseUnmarshaller();        

        internal static UpdateTestSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTestSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
