...
{
    /// <summary>
    /// ListBotLocales Request Marshaller
    /// </summary>       
    public class ListBotLocalesRequestMarshaller : IMarshaller<IRequest, ListBotLocalesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListBotLocalesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListBotLocalesRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetFilters())
            {
                ...
                foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                {
                    ...
                    var marshaller = BotLocaleFilterMarshaller.Instance;
            ...
            if(publicRequest.IsSetSortBy())
            {
                ...
                var marshaller = BotLocaleSortByMarshaller.Instance;
        ...
        private static ListBotLocalesRequestMarshaller _instance = new ListBotLocalesRequestMarshaller();        

        internal static ListBotLocalesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBotLocalesRequestMarshaller Instance
        {
            get
            {
                return _instance;
