...
{
    /// <summary>
    /// Response Unmarshaller for StartTestSetGeneration operation
    /// </summary>  
    public class StartTestSetGenerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTestSetGenerationResponse response = new StartTestSetGenerationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("generationDataSource", targetDepth, ref reader))
                {
                    var unmarshaller = TestSetGenerationDataSourceUnmarshaller.Instance;
                    response.GenerationDataSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("testSetGenerationId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestSetGenerationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("testSetGenerationStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestSetGenerationStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("testSetTags", targetDepth, ref reader))
                {
                    ...
                    response.TestSetTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartTestSetGenerationResponseUnmarshaller _instance = new StartTestSetGenerationResponseUnmarshaller();        

        internal static StartTestSetGenerationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTestSetGenerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
