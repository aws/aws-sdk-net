...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpecificationsUnmarshaller : IUnmarshaller<Specifications, XmlUnmarshallerContext>, IUnmarshaller<Specifications, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Specifications IUnmarshaller<Specifications, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Specifications Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("valueElicitationSetting", targetDepth))
                {
                    ...
                    unmarshalledObject.ValueElicitationSetting = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
