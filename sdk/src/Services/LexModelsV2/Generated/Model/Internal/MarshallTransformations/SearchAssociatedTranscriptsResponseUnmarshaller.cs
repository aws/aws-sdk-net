    ...
    public class SearchAssociatedTranscriptsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AssociatedTranscript, AssociatedTranscriptUnmarshaller>(AssociatedTranscriptUnmarshaller.Instance);
                    response.AssociatedTranscripts = unmarshaller.Unmarshall(context);
                    continue;
                }
