...
{
    /// <summary>
    /// UpdateTestSet Request Marshaller
    /// </summary>       
    public class UpdateTestSetRequestMarshaller : IMarshaller<IRequest, UpdateTestSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTestSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTestSetRequest publicRequest)
        {
        ...
        private static UpdateTestSetRequestMarshaller _instance = new UpdateTestSetRequestMarshaller();        

        internal static UpdateTestSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTestSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
