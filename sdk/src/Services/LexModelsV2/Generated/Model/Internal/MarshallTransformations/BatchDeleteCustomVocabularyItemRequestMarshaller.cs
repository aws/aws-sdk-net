...
{
    /// <summary>
    /// BatchDeleteCustomVocabularyItem Request Marshaller
    /// </summary>       
    public class BatchDeleteCustomVocabularyItemRequestMarshaller : IMarshaller<IRequest, BatchDeleteCustomVocabularyItemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchDeleteCustomVocabularyItemRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchDeleteCustomVocabularyItemRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/batchdelete";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetCustomVocabularyItemList())
            {
                ...
                foreach(var publicRequestCustomVocabularyItemListListValue in publicRequest.CustomVocabularyItemList)
                {
                    ...
                    var marshaller = CustomVocabularyEntryIdMarshaller.Instance;
        ...
        private static BatchDeleteCustomVocabularyItemRequestMarshaller _instance = new BatchDeleteCustomVocabularyItemRequestMarshaller();        

        internal static BatchDeleteCustomVocabularyItemRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteCustomVocabularyItemRequestMarshaller Instance
        {
            get
            {
                return _instance;
