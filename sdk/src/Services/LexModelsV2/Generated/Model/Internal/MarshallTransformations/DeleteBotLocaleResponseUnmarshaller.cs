...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBotLocale operation
    /// </summary>  
    public class DeleteBotLocaleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBotLocaleResponse response = new DeleteBotLocaleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("botLocaleStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BotLocaleStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteBotLocaleResponseUnmarshaller _instance = new DeleteBotLocaleResponseUnmarshaller();        

        internal static DeleteBotLocaleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBotLocaleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
