...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListImportsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("importSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ImportSummary, ImportSummaryUnmarshaller>(ImportSummaryUnmarshaller.Instance);
                    response.ImportSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
