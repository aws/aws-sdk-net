        ...
        public DataSourceConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("bedrockKnowledgeStoreConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.BedrockKnowledgeStoreConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("kendraConfiguration", targetDepth))
                {
                    var unmarshaller = QnAKendraConfigurationUnmarshaller.Instance;
                    unmarshalledObject.KendraConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("opensearchConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.OpensearchConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
