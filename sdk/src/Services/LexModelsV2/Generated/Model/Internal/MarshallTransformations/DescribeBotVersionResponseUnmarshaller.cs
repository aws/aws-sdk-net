...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBotVersion operation
    /// </summary>  
    public class DescribeBotVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBotVersionResponse response = new DescribeBotVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("botMembers", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("botStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BotStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("botType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("dataPrivacy", targetDepth, ref reader))
                {
        ...
        private static DescribeBotVersionResponseUnmarshaller _instance = new DescribeBotVersionResponseUnmarshaller();        

        internal static DescribeBotVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBotVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
