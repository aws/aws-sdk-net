...
{
    /// <summary>
    /// DeleteBotLocale Request Marshaller
    /// </summary>       
    public class DeleteBotLocaleRequestMarshaller : IMarshaller<IRequest, DeleteBotLocaleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteBotLocaleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBotLocaleRequest publicRequest)
        {
        ...
        private static DeleteBotLocaleRequestMarshaller _instance = new DeleteBotLocaleRequestMarshaller();        

        internal static DeleteBotLocaleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBotLocaleRequestMarshaller Instance
        {
            get
            {
                return _instance;
