...
{
    /// <summary>
    /// Response Unmarshaller for StartBotRecommendation operation
    /// </summary>  
    public class StartBotRecommendationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBotRecommendationResponse response = new StartBotRecommendationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("botRecommendationStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("encryptionSetting", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("transcriptSourceSetting", targetDepth, ref reader))
                {
        ...
        private static StartBotRecommendationResponseUnmarshaller _instance = new StartBotRecommendationResponseUnmarshaller();        

        internal static StartBotRecommendationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBotRecommendationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
