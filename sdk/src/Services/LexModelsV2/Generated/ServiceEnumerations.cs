...
namespace Amazon.LexModelsV2
{
    ...
    /// <summary>
    /// Constants used for properties of type AssistedNluMode.
    /// </summary>
    public class AssistedNluMode : ConstantClass
    {

        /// <summary>
        /// Constant Fallback for AssistedNluMode
        /// </summary>
        public static readonly AssistedNluMode Fallback = new AssistedNluMode("Fallback");
        /// <summary>
        /// Constant Primary for AssistedNluMode
        /// </summary>
        public static readonly AssistedNluMode Primary = new AssistedNluMode("Primary");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public AssistedNluMode(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static AssistedNluMode FindValue(string value)
        {
            return FindValue<AssistedNluMode>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator AssistedNluMode(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type SpeechDetectionSensitivity.
    /// </summary>
    public class SpeechDetectionSensitivity : ConstantClass
    {

        /// <summary>
        /// Constant Default for SpeechDetectionSensitivity
        /// </summary>
        public static readonly SpeechDetectionSensitivity Default = new SpeechDetectionSensitivity("Default");
        /// <summary>
        /// Constant HighNoiseTolerance for SpeechDetectionSensitivity
        /// </summary>
        public static readonly SpeechDetectionSensitivity HighNoiseTolerance = new SpeechDetectionSensitivity("HighNoiseTolerance");
        /// <summary>
        /// Constant MaximumNoiseTolerance for SpeechDetectionSensitivity
        /// </summary>
        public static readonly SpeechDetectionSensitivity MaximumNoiseTolerance = new SpeechDetectionSensitivity("MaximumNoiseTolerance");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public SpeechDetectionSensitivity(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static SpeechDetectionSensitivity FindValue(string value)
        {
            return FindValue<SpeechDetectionSensitivity>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator SpeechDetectionSensitivity(string value)
        {
            return FindValue(value);
        }
    }
