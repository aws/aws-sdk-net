...
namespace Amazon.ApiGatewayManagementApi.Model
{
    ...
    public partial class LimitExceededException : AmazonApiGatewayManagementApiException
    {
        ...
        /// Construct instance of LimitExceededException
        /// </summary>
        public LimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of LimitExceededException
        /// </summary>
        public LimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
