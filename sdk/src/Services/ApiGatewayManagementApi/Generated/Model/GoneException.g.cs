...
namespace Amazon.ApiGatewayManagementApi.Model
{
    ...
    public partial class GoneException : AmazonApiGatewayManagementApiException
    {
        ...
        /// Construct instance of GoneException
        /// </summary>
        public GoneException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of GoneException
        /// </summary>
        public GoneException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of GoneException
        /// </summary>
        public GoneException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
