...
namespace Amazon.ApiGatewayManagementApi.Model
{
    ...
    public partial class PayloadTooLargeException : AmazonApiGatewayManagementApiException
    {
        ...
        /// Construct instance of PayloadTooLargeException
        /// </summary>
        public PayloadTooLargeException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of PayloadTooLargeException
        /// </summary>
        public PayloadTooLargeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of PayloadTooLargeException
        /// </summary>
        public PayloadTooLargeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
