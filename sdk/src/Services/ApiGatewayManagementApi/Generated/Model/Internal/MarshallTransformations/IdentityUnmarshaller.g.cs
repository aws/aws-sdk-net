...
namespace Amazon.ApiGatewayManagementApi.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IdentityUnmarshaller : IJsonUnmarshaller<Identity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Identity();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IdentityUnmarshaller Instance => _instance;
    }
}
