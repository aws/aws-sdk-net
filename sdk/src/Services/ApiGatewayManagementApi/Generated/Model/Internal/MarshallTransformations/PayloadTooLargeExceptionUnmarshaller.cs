...
namespace Amazon.ApiGatewayManagementApi.Model.Internal.MarshallTransformations
{
    ...
    public class PayloadTooLargeExceptionUnmarshaller : IErrorResponseUnmarshaller<PayloadTooLargeException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PayloadTooLargeException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PayloadTooLargeExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
