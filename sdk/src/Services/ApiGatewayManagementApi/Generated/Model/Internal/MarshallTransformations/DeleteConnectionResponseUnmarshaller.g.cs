...
namespace Amazon.ApiGatewayManagementApi.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeleteConnectionResponse();
        ...
        internal static DeleteConnectionResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteConnectionResponseUnmarshaller Instance => _instance;
    }
}
