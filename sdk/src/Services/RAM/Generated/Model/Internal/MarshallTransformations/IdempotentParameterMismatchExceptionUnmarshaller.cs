...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdempotentParameterMismatchExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<IdempotentParameterMismatchException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IdempotentParameterMismatchException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
