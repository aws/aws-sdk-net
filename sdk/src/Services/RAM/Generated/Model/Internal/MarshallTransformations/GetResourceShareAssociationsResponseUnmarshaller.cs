...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceShareAssociations operation
    /// </summary>  
    public class GetResourceShareAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceShareAssociationsResponse response = new GetResourceShareAssociationsResponse();
        ...
        private static GetResourceShareAssociationsResponseUnmarshaller _instance = new GetResourceShareAssociationsResponseUnmarshaller();        

        internal static GetResourceShareAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceShareAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
