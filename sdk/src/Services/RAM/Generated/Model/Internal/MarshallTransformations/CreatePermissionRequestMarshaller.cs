...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    public class CreatePermissionRequestMarshaller : IMarshaller<IRequest, CreatePermissionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePermissionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/createpermission";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetPolicyTemplate())
            {
                context.Writer.WritePropertyName("policyTemplate");
                context.Writer.WriteStringValue(publicRequest.PolicyTemplate);
            }
        ...
        private static CreatePermissionRequestMarshaller _instance = new CreatePermissionRequestMarshaller();        

        internal static CreatePermissionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePermissionRequestMarshaller Instance
        {
            get
            {
                return _instance;
