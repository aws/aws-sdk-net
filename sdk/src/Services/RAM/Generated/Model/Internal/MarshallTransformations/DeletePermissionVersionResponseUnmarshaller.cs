...
{
    /// <summary>
    /// Response Unmarshaller for DeletePermissionVersion operation
    /// </summary>  
    public class DeletePermissionVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePermissionVersionResponse response = new DeletePermissionVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("permissionStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PermissionStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("returnValue", targetDepth, ref reader))
                {
        ...
        private static DeletePermissionVersionResponseUnmarshaller _instance = new DeletePermissionVersionResponseUnmarshaller();        

        internal static DeletePermissionVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePermissionVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
