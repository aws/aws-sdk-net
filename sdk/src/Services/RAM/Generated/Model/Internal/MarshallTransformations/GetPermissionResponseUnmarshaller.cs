...
{
    /// <summary>
    /// Response Unmarshaller for GetPermission operation
    /// </summary>  
    public class GetPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetPermissionResponseUnmarshaller _instance = new GetPermissionResponseUnmarshaller();        

        internal static GetPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
