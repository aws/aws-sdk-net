...
{
    /// <summary>
    /// Response Unmarshaller for AcceptResourceShareInvitation operation
    /// </summary>  
    public class AcceptResourceShareInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptResourceShareInvitationResponse response = new AcceptResourceShareInvitationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resourceShareInvitation", targetDepth, ref reader))
                {
                    var unmarshaller = ResourceShareInvitationUnmarshaller.Instance;
                    response.ResourceShareInvitation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ResourceShareInvitationAlreadyAcceptedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResourceShareInvitationAlreadyRejectedException"))
                {
                    return ResourceShareInvitationAlreadyRejectedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResourceShareInvitationArnNotFoundException"))
                {
                    return ResourceShareInvitationArnNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResourceShareInvitationExpiredException"))
                {
                    return ResourceShareInvitationExpiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static AcceptResourceShareInvitationResponseUnmarshaller _instance = new AcceptResourceShareInvitationResponseUnmarshaller();        

        internal static AcceptResourceShareInvitationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptResourceShareInvitationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
