...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateResourceShare operation
    /// </summary>  
    public class DisassociateResourceShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateResourceShareResponse response = new DisassociateResourceShareResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resourceShareAssociations", targetDepth, ref reader))
                {
                    ...
                    response.ResourceShareAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return ResourceShareLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServerInternalException"))
                {
                    return ServerInternalExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DisassociateResourceShareResponseUnmarshaller _instance = new DisassociateResourceShareResponseUnmarshaller();        

        internal static DisassociateResourceShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateResourceShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
