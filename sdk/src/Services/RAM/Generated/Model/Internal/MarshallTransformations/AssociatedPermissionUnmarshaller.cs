...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociatedPermissionUnmarshaller : IJsonUnmarshaller<AssociatedPermission, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssociatedPermission Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("permissionVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PermissionVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
