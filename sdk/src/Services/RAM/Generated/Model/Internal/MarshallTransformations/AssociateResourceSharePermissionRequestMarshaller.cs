...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateResourceSharePermissionRequestMarshaller : IMarshaller<IRequest, AssociateResourceSharePermissionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AssociateResourceSharePermissionRequestMarshaller _instance = new AssociateResourceSharePermissionRequestMarshaller();        

        internal static AssociateResourceSharePermissionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateResourceSharePermissionRequestMarshaller Instance
        {
            get
            {
                return _instance;
