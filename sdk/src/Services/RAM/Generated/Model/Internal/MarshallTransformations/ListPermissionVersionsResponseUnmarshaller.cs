...
{
    /// <summary>
    /// Response Unmarshaller for ListPermissionVersions operation
    /// </summary>  
    public class ListPermissionVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPermissionVersionsResponse response = new ListPermissionVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourceSharePermissionSummary, ResourceSharePermissionSummaryUnmarshaller>(ResourceSharePermissionSummaryUnmarshaller.Instance);
        ...
        private static ListPermissionVersionsResponseUnmarshaller _instance = new ListPermissionVersionsResponseUnmarshaller();        

        internal static ListPermissionVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPermissionVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
