...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceShares operation
    /// </summary>  
    public class GetResourceSharesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceSharesResponse response = new GetResourceSharesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resourceShares", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourceShare, ResourceShareUnmarshaller>(ResourceShareUnmarshaller.Instance);
                    response.ResourceShares = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetResourceSharesResponseUnmarshaller _instance = new GetResourceSharesResponseUnmarshaller();        

        internal static GetResourceSharesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceSharesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
