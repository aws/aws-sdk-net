    ...
    public class GetResourceSharesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceShare, ResourceShareUnmarshaller>(ResourceShareUnmarshaller.Instance);
                    response.ResourceShares = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
