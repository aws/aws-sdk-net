...
{
    /// <summary>
    /// Response Unmarshaller for AssociatedSource Object
    /// </summary>  
    public class AssociatedSourceUnmarshaller : IJsonUnmarshaller<AssociatedSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssociatedSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AssociatedSource unmarshalledObject = new AssociatedSource();
        ...
        private static AssociatedSourceUnmarshaller _instance = new AssociatedSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssociatedSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
