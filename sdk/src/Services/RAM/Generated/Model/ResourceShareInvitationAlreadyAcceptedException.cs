...
namespace Amazon.RAM.Model
{
    ...
    public partial class ResourceShareInvitationAlreadyAcceptedException : AmazonRAMException
    {
        ...
        /// <summary>
        /// Default constructor for ResourceShareInvitationAlreadyAcceptedException
        /// message.
        /// </summary>
        public ResourceShareInvitationAlreadyAcceptedException() 
            : base() {}
        ...
        public ResourceShareInvitationAlreadyAcceptedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceShareInvitationAlreadyAcceptedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
