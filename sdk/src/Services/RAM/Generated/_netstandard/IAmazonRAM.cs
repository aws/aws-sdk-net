...
namespace Amazon.RAM
{
    ...
    public partial interface IAmazonRAM : IAmazonService, IDisposable
    {
        ...
        Task<ListSourceAssociationsResponse> ListSourceAssociationsAsync(ListSourceAssociationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
