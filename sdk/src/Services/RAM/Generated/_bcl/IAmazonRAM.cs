...
namespace Amazon.RAM
{
    ...
    public partial interface IAmazonRAM : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ram-2018-01-04/ListSourceAssociations">REST API Reference for ListSourceAssociations Operation</seealso>
        Task<ListSourceAssociationsResponse> ListSourceAssociationsAsync(ListSourceAssociationsRequest request, CancellationToken cancellationToken = default(CancellationToken));
