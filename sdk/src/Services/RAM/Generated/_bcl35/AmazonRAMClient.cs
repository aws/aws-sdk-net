...
namespace Amazon.RAM
{
    ...
    public partial class AmazonRAMClient : AmazonServiceClient, IAmazonRAM
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ram-2018-01-04/ListSourceAssociations">REST API Reference for ListSourceAssociations Operation</seealso>
        public virtual IAsyncResult BeginListSourceAssociations(ListSourceAssociationsRequest request, AsyncCallback callback, object state)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListSourceAssociationsRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListSourceAssociationsResponseUnmarshaller.Instance;
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ram-2018-01-04/ListSourceAssociations">REST API Reference for ListSourceAssociations Operation</seealso>
        public virtual ListSourceAssociationsResponse EndListSourceAssociations(IAsyncResult asyncResult)
        {
            return EndInvoke<ListSourceAssociationsResponse>(asyncResult);
        }
