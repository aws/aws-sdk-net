...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetOutputVectorUnmarshaller : IJsonUnmarshaller<GetOutputVector, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GetOutputVector Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
