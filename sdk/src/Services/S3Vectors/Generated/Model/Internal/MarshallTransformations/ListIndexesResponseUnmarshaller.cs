...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListIndexesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IndexSummary, IndexSummaryUnmarshaller>(IndexSummaryUnmarshaller.Instance);
                    response.Indexes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListIndexesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIndexesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
