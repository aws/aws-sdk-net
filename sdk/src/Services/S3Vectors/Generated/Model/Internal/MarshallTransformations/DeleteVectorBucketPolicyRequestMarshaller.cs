...
{
    /// <summary>
    /// DeleteVectorBucketPolicy Request Marshaller
    /// </summary>       
    public class DeleteVectorBucketPolicyRequestMarshaller : IMarshaller<IRequest, DeleteVectorBucketPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVectorBucketPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVectorBucketPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/DeleteVectorBucketPolicy";
#if !NETFRAMEWORK
        ...
        private static DeleteVectorBucketPolicyRequestMarshaller _instance = new DeleteVectorBucketPolicyRequestMarshaller();        

        internal static DeleteVectorBucketPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVectorBucketPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
