...
{
    /// <summary>
    /// Response Unmarshaller for GetVectorBucketPolicy operation
    /// </summary>  
    public class GetVectorBucketPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVectorBucketPolicyResponse response = new GetVectorBucketPolicyResponse();
        ...
        private static GetVectorBucketPolicyResponseUnmarshaller _instance = new GetVectorBucketPolicyResponseUnmarshaller();        

        internal static GetVectorBucketPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVectorBucketPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
