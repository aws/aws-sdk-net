...
{
    /// <summary>
    /// Response Unmarshaller for PutVectors operation
    /// </summary>  
    public class PutVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static PutVectorsResponseUnmarshaller _instance = new PutVectorsResponseUnmarshaller();        

        internal static PutVectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
