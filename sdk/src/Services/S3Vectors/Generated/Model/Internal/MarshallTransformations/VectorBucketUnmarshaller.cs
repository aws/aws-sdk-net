...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VectorBucketUnmarshaller : IJsonUnmarshaller<VectorBucket, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VectorBucket Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
