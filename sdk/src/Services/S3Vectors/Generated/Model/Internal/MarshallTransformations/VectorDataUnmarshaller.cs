...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VectorDataUnmarshaller : IUnmarshaller<VectorData, XmlUnmarshallerContext>, IUnmarshaller<VectorData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VectorData IUnmarshaller<VectorData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public VectorData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<float, FloatUnmarshaller>(FloatUnmarshaller.Instance);
                    unmarshalledObject.Float32 = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
