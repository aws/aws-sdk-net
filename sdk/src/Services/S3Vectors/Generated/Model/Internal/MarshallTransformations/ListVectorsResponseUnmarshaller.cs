    ...
    public class ListVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ListOutputVector, ListOutputVectorUnmarshaller>(ListOutputVectorUnmarshaller.Instance);
                    response.Vectors = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
