...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class QueryVectorsRequestMarshaller : IMarshaller<IRequest, QueryVectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(QueryVectorsRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetIndexArn())
                {
                    ...
                    context.Writer.Write(publicRequest.IndexArn);
                }
        ...
        private static QueryVectorsRequestMarshaller _instance = new QueryVectorsRequestMarshaller();        

        internal static QueryVectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryVectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
