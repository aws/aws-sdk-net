...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IndexUnmarshaller : IUnmarshaller<Index, XmlUnmarshallerContext>, IUnmarshaller<Index, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Index IUnmarshaller<Index, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Index Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VectorBucketName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
