...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVectors operation
    /// </summary>  
    public class DeleteVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteVectorsResponseUnmarshaller _instance = new DeleteVectorsResponseUnmarshaller();        

        internal static DeleteVectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
