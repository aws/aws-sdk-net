...
{
    /// <summary>
    /// GetVectorBucket Request Marshaller
    /// </summary>       
    public class GetVectorBucketRequestMarshaller : IMarshaller<IRequest, GetVectorBucketRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetVectorBucketRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetVectorBucketRequest publicRequest)
        {
            ...
            request.ResourcePath = "/GetVectorBucket";
#if !NETFRAMEWORK
        ...
        private static GetVectorBucketRequestMarshaller _instance = new GetVectorBucketRequestMarshaller();        

        internal static GetVectorBucketRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVectorBucketRequestMarshaller Instance
        {
            get
            {
                return _instance;
