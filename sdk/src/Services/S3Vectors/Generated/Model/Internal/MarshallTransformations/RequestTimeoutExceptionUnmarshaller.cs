...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RequestTimeoutExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<RequestTimeoutException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public RequestTimeoutException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public RequestTimeoutException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            RequestTimeoutException unmarshalledObject = new RequestTimeoutException(errorResponse.Message, errorResponse.InnerException,
