...
namespace Amazon.S3Vectors.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationException : AmazonS3VectorsException
    {
        ...
        /// Each entry in the list contains a path to the field that failed validation and a detailed
        /// message that explains why the validation failed. To satisfy multiple constraints,
        /// a field can appear multiple times in this list if it failed. You can use the information
        /// to identify and fix the specific validation issues in your request.
        /// </para>
        /// <para />
