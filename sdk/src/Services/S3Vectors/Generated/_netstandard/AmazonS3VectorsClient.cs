...
namespace Amazon.S3Vectors
{
    ...
    public partial class AmazonS3VectorsClient : AmazonServiceClient, IAmazonS3Vectors
    {
        ...
        public AmazonS3VectorsClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonS3VectorsConfig()) { }
        ...
        public AmazonS3VectorsClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonS3VectorsConfig{RegionEndpoint = region}) { }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonS3VectorsEndpointResolver();
