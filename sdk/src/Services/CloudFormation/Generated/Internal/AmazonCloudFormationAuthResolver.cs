...
namespace Amazon.CloudFormation.Internal
{
    ...
    public class AmazonCloudFormationAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudFormationAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudFormation.
        /// </summary>
        public AmazonCloudFormationAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudFormationAuthSchemeParameters
            {
    ...
    public class AmazonCloudFormationAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudFormationAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudFormationAuthSchemeParameters authParameters)
        {
