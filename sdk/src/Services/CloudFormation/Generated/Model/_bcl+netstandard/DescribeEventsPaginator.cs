...
namespace Amazon.CloudFormation.Model
{
    ...
    internal sealed partial class DescribeEventsPaginator : IPaginator<DescribeEventsResponse>, IDescribeEventsPaginator
    {
        ...
        public IPaginatedEnumerable<OperationEvent> OperationEvents => 
            new PaginatedResultKeyResponse<DescribeEventsResponse, OperationEvent>(this, (i) => i.OperationEvents ?? new List<OperationEvent>());

        internal DescribeEventsPaginator(IAmazonCloudFormation client, DescribeEventsRequest request)
        {
            this._client = client;
