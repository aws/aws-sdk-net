...
{
    /// <summary>
    /// Base class for DescribeStackEvents paginators.
    /// </summary>
    internal sealed partial class DescribeStackEventsPaginator : IPaginator<DescribeStackEventsResponse>, IDescribeStackEventsPaginator
    {
        private readonly IAmazonCloudFormation _client;
        private readonly DescribeStackEventsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<DescribeStackEventsResponse> Responses => new PaginatedResponse<DescribeStackEventsResponse>(this);
