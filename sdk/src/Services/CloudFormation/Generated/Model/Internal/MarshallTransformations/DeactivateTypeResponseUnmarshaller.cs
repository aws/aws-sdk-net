...
{
    /// <summary>
    /// Response Unmarshaller for DeactivateType operation
    /// </summary>  
    public class DeactivateTypeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeactivateTypeResponse response = new DeactivateTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeactivateTypeResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeactivateTypeResponse response)
        {
        ...
        private static DeactivateTypeResponseUnmarshaller _instance = new DeactivateTypeResponseUnmarshaller();        

        internal static DeactivateTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
