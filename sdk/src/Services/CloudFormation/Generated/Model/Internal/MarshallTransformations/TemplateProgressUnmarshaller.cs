...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    public class TemplateProgressUnmarshaller : IXmlUnmarshaller<TemplateProgress, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TemplateProgress Unmarshall(XmlUnmarshallerContext context)
        {
            TemplateProgress unmarshalledObject = new TemplateProgress();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TemplateProgressUnmarshaller Instance
        {
            get
            {
                return _instance;
