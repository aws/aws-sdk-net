...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListStackResourcesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListStackResourcesResponseUnmarshaller _instance = new ListStackResourcesResponseUnmarshaller();        

        internal static ListStackResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStackResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
