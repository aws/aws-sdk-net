...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    public class ChangeSetHookUnmarshaller : IXmlUnmarshaller<ChangeSetHook, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ChangeSetHook Unmarshall(XmlUnmarshallerContext context)
        {
            ChangeSetHook unmarshalledObject = new ChangeSetHook();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ChangeSetHookTargetDetailsUnmarshaller.Instance;
                        unmarshalledObject.TargetDetails = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChangeSetHookUnmarshaller Instance
        {
            get
            {
                return _instance;
