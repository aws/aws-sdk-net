...
{
    /// <summary>
    /// CreateGeneratedTemplate Request Marshaller
    /// </summary>       
    public class CreateGeneratedTemplateRequestMarshaller : IMarshaller<IRequest, CreateGeneratedTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateGeneratedTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateGeneratedTemplateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudFormation");
            request.Parameters.Add("Action", "CreateGeneratedTemplate");
            ...
            return request;
                    ...
                    private static CreateGeneratedTemplateRequestMarshaller _instance = new CreateGeneratedTemplateRequestMarshaller();        

        internal static CreateGeneratedTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGeneratedTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
