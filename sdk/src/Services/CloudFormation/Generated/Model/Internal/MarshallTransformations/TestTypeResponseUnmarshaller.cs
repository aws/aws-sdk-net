...
{
    /// <summary>
    /// Response Unmarshaller for TestType operation
    /// </summary>  
    public class TestTypeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TestTypeResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, TestTypeResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("TypeVersionArn", targetDepth))
                    {
                        ...
                        response.TypeVersionArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static TestTypeResponseUnmarshaller _instance = new TestTypeResponseUnmarshaller();        

        internal static TestTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
