...
{
    /// <summary>
    /// CreateStackRefactor Request Marshaller
    /// </summary>       
    public class CreateStackRefactorRequestMarshaller : IMarshaller<IRequest, CreateStackRefactorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateStackRefactorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateStackRefactorRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudFormation");
            request.Parameters.Add("Action", "CreateStackRefactor");
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetEnableStackCreation())
                {
                    request.Parameters.Add("EnableStackCreation", StringUtils.FromBool(publicRequest.EnableStackCreation));
                }
        ...
        internal static CreateStackRefactorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStackRefactorRequestMarshaller Instance
        {
            get
            {
                return _instance;
