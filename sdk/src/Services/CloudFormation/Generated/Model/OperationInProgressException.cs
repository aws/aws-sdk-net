...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class OperationInProgressException : AmazonCloudFormationException
    {
        ...
        public OperationInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OperationInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
