...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class StackNotFoundException : AmazonCloudFormationException
    {
        ...
        /// <summary>
        /// Default constructor for StackNotFoundException
        /// message.
        /// </summary>
        ...
        public StackNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public StackNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
