...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class InvalidChangeSetStatusException : AmazonCloudFormationException
    {
        ...
        public InvalidChangeSetStatusException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidChangeSetStatusException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
