...
{
    /// <summary>
    /// Container for the parameters to the ListClusterAlerts operation.
    /// List the alerts for a cluster with optional filtering based on alert state.
    /// </summary>
    public partial class ListClusterAlertsRequest : AmazonMediaLiveRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property ClusterId. The unique ID of the cluster
        /// </summary>
