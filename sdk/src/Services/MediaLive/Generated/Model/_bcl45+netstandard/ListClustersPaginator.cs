...
namespace Amazon.MediaLive.Model
{
    ...
    internal sealed partial class ListClustersPaginator : IPaginator<ListClustersResponse>, IListClustersPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<DescribeClusterSummary> Clusters => 
            new PaginatedResultKeyResponse<ListClustersResponse, DescribeClusterSummary>(this, (i) => i.Clusters ?? new List<DescribeClusterSummary>());

        internal ListClustersPaginator(IAmazonMediaLive client, ListClustersRequest request)
        {
            this._client = client;
