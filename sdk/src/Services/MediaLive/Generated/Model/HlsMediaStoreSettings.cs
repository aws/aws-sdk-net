...
namespace Amazon.MediaLive.Model
{
    ...
    public partial class HlsMediaStoreSettings
    {
        ...
        private HlsMediaStoreStorageClass _mediaStoreStorageClass;
        ...
        /// <summary>
        /// Gets and sets the property MediaStoreStorageClass. When set to temporal, output files
        ...
        {
            get { return this._mediaStoreStorageClass; }
            set { this._mediaStoreStorageClass = value; }
        }

        // Check to see if MediaStoreStorageClass property is set
        internal bool IsSetMediaStoreStorageClass()
        {
            return this._mediaStoreStorageClass != null;
        }
