...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class NielsenCBETUnmarshaller : IJsonUnmarshaller<NielsenCBET, JsonUnmarshallerContext>
    {
        ...
        public NielsenCBET Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("cbetCheckDigitString", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CbetCheckDigitString = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("cbetStepaside", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CbetStepaside = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("csid", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static NielsenCBETUnmarshaller _instance = new NielsenCBETUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NielsenCBETUnmarshaller Instance
        {
            get
            {
                return _instance;
