...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DvbSubSourceSettingsUnmarshaller : IJsonUnmarshaller<DvbSubSourceSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DvbSubSourceSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ocrLanguage", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OcrLanguage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
