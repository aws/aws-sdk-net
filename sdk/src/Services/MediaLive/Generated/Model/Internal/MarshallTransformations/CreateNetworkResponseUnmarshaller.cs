...
{
    /// <summary>
    /// Response Unmarshaller for CreateNetwork operation
    /// </summary>  
    public class CreateNetworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("associatedClusterIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.AssociatedClusterIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ipPools", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<IpPool, IpPoolUnmarshaller>(IpPoolUnmarshaller.Instance);
                    response.IpPools = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateNetworkResponseUnmarshaller _instance = new CreateNetworkResponseUnmarshaller();        

        internal static CreateNetworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNetworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
