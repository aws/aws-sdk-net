...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PurchaseOfferingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PurchaseOfferingResponse response = new PurchaseOfferingResponse();
        ...
        private static PurchaseOfferingResponseUnmarshaller _instance = new PurchaseOfferingResponseUnmarshaller();        

        internal static PurchaseOfferingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PurchaseOfferingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
