...
{
    /// <summary>
    /// Response Unmarshaller for UpdateInputSecurityGroup operation
    /// </summary>  
    public class UpdateInputSecurityGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateInputSecurityGroupResponse response = new UpdateInputSecurityGroupResponse();
        ...
        private static UpdateInputSecurityGroupResponseUnmarshaller _instance = new UpdateInputSecurityGroupResponseUnmarshaller();        

        internal static UpdateInputSecurityGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInputSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
