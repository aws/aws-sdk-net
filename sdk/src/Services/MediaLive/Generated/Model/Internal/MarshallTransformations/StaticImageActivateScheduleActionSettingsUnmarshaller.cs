...
{
    /// <summary>
    /// Response Unmarshaller for StaticImageActivateScheduleActionSettings Object
    /// </summary>  
    public class StaticImageActivateScheduleActionSettingsUnmarshaller : IUnmarshaller<StaticImageActivateScheduleActionSettings, XmlUnmarshallerContext>, IUnmarshaller<StaticImageActivateScheduleActionSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        StaticImageActivateScheduleActionSettings IUnmarshaller<StaticImageActivateScheduleActionSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public StaticImageActivateScheduleActionSettings Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            StaticImageActivateScheduleActionSettings unmarshalledObject = new StaticImageActivateScheduleActionSettings();
        ...
        private static StaticImageActivateScheduleActionSettingsUnmarshaller _instance = new StaticImageActivateScheduleActionSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static StaticImageActivateScheduleActionSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
