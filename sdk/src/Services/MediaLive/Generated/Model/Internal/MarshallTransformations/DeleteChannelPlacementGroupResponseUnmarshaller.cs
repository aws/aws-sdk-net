...
{
    /// <summary>
    /// Response Unmarshaller for DeleteChannelPlacementGroup operation
    /// </summary>  
    public class DeleteChannelPlacementGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteChannelPlacementGroupResponse response = new DeleteChannelPlacementGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("channels", targetDepth))
                {
                    ...
                    response.Channels = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteChannelPlacementGroupResponseUnmarshaller _instance = new DeleteChannelPlacementGroupResponseUnmarshaller();        

        internal static DeleteChannelPlacementGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelPlacementGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
