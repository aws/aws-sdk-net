...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputChannelLevelUnmarshaller : IUnmarshaller<InputChannelLevel, XmlUnmarshallerContext>, IUnmarshaller<InputChannelLevel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InputChannelLevel IUnmarshaller<InputChannelLevel, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public InputChannelLevel Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
