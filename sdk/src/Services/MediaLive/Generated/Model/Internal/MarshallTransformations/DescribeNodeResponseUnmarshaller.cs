...
{
    /// <summary>
    /// Response Unmarshaller for DescribeNode operation
    /// </summary>  
    public class DescribeNodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeNodeResponse response = new DescribeNodeResponse();
        ...
        private static DescribeNodeResponseUnmarshaller _instance = new DescribeNodeResponseUnmarshaller();        

        internal static DescribeNodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
