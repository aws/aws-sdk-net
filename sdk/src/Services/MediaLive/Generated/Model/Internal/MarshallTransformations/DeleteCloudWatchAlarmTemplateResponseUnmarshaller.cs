...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCloudWatchAlarmTemplate operation
    /// </summary>  
    public class DeleteCloudWatchAlarmTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCloudWatchAlarmTemplateResponse response = new DeleteCloudWatchAlarmTemplateResponse();
        ...
        private static DeleteCloudWatchAlarmTemplateResponseUnmarshaller _instance = new DeleteCloudWatchAlarmTemplateResponseUnmarshaller();        

        internal static DeleteCloudWatchAlarmTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCloudWatchAlarmTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
