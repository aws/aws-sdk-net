...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCloudWatchAlarmTemplateGroup operation
    /// </summary>  
    public class DeleteCloudWatchAlarmTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCloudWatchAlarmTemplateGroupResponse response = new DeleteCloudWatchAlarmTemplateGroupResponse();
        ...
        private static DeleteCloudWatchAlarmTemplateGroupResponseUnmarshaller _instance = new DeleteCloudWatchAlarmTemplateGroupResponseUnmarshaller();        

        internal static DeleteCloudWatchAlarmTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCloudWatchAlarmTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
