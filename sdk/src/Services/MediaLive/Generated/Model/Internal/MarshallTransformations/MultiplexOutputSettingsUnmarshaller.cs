...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MultiplexOutputSettingsUnmarshaller : IJsonUnmarshaller<MultiplexOutputSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MultiplexOutputSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = MultiplexContainerSettingsUnmarshaller.Instance;
