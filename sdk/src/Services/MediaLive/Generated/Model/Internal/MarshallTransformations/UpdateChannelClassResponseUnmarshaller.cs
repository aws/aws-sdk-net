...
{
    /// <summary>
    /// Response Unmarshaller for UpdateChannelClass operation
    /// </summary>  
    public class UpdateChannelClassResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateChannelClassResponse response = new UpdateChannelClassResponse();
        ...
        private static UpdateChannelClassResponseUnmarshaller _instance = new UpdateChannelClassResponseUnmarshaller();        

        internal static UpdateChannelClassResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChannelClassResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
