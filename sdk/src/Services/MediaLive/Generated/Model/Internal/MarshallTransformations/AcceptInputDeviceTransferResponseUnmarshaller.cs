...
{
    /// <summary>
    /// Response Unmarshaller for AcceptInputDeviceTransfer operation
    /// </summary>  
    public class AcceptInputDeviceTransferResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptInputDeviceTransferResponse response = new AcceptInputDeviceTransferResponse();
        ...
        private static AcceptInputDeviceTransferResponseUnmarshaller _instance = new AcceptInputDeviceTransferResponseUnmarshaller();        

        internal static AcceptInputDeviceTransferResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptInputDeviceTransferResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
