...
{
    /// <summary>
    /// Response Unmarshaller for CreatePartnerInput operation
    /// </summary>  
    public class CreatePartnerInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePartnerInputResponse response = new CreatePartnerInputResponse();
        ...
        private static CreatePartnerInputResponseUnmarshaller _instance = new CreatePartnerInputResponseUnmarshaller();        

        internal static CreatePartnerInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePartnerInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
