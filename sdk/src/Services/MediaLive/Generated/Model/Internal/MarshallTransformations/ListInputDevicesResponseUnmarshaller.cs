...
{
    /// <summary>
    /// Response Unmarshaller for ListInputDevices operation
    /// </summary>  
    public class ListInputDevicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListInputDevicesResponse response = new ListInputDevicesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InputDeviceSummary, InputDeviceSummaryUnmarshaller>(InputDeviceSummaryUnmarshaller.Instance);
        ...
        private static ListInputDevicesResponseUnmarshaller _instance = new ListInputDevicesResponseUnmarshaller();        

        internal static ListInputDevicesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInputDevicesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
