...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StaticImageOutputDeactivateScheduleActionSettingsUnmarshaller : IJsonUnmarshaller<StaticImageOutputDeactivateScheduleActionSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StaticImageOutputDeactivateScheduleActionSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("outputNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.OutputNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
