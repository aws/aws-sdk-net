...
{
    /// <summary>
    /// RouterSettings Marshaller
    /// </summary>
    public class RouterSettingsMarshaller : IRequestMarshaller<RouterSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RouterSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDestinations())
            {
                ...
                foreach(var requestObjectDestinationsListValue in requestObject.Destinations)
                {
                    ...
                    var marshaller = RouterDestinationSettingsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RouterSettingsMarshaller Instance = new RouterSettingsMarshaller();
