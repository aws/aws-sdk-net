...
{
    /// <summary>
    /// Response Unmarshaller for StartInputDevice operation
    /// </summary>  
    public class StartInputDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartInputDeviceResponse response = new StartInputDeviceResponse();
        ...
        private static StartInputDeviceResponseUnmarshaller _instance = new StartInputDeviceResponseUnmarshaller();        

        internal static StartInputDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartInputDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
