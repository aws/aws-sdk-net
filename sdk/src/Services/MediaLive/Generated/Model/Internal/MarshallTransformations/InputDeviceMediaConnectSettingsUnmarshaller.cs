...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputDeviceMediaConnectSettingsUnmarshaller : IUnmarshaller<InputDeviceMediaConnectSettings, XmlUnmarshallerContext>, IUnmarshaller<InputDeviceMediaConnectSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InputDeviceMediaConnectSettings IUnmarshaller<InputDeviceMediaConnectSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public InputDeviceMediaConnectSettings Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
