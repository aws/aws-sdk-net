...
{
    /// <summary>
    /// Response Unmarshaller for StopInputDevice operation
    /// </summary>  
    public class StopInputDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopInputDeviceResponse response = new StopInputDeviceResponse();
        ...
        private static StopInputDeviceResponseUnmarshaller _instance = new StopInputDeviceResponseUnmarshaller();        

        internal static StopInputDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopInputDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
