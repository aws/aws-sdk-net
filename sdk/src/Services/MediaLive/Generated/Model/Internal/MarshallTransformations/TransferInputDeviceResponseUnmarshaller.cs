...
{
    /// <summary>
    /// Response Unmarshaller for TransferInputDevice operation
    /// </summary>  
    public class TransferInputDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TransferInputDeviceResponse response = new TransferInputDeviceResponse();
        ...
        private static TransferInputDeviceResponseUnmarshaller _instance = new TransferInputDeviceResponseUnmarshaller();        

        internal static TransferInputDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransferInputDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
