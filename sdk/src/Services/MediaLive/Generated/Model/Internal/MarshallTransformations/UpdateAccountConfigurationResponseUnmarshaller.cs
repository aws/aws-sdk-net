...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAccountConfiguration operation
    /// </summary>  
    public class UpdateAccountConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAccountConfigurationResponse response = new UpdateAccountConfigurationResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("accountConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = AccountConfigurationUnmarshaller.Instance;
                    response.AccountConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateAccountConfigurationResponseUnmarshaller _instance = new UpdateAccountConfigurationResponseUnmarshaller();        

        internal static UpdateAccountConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccountConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
