...
{
    /// <summary>
    /// Response Unmarshaller for ListMultiplexAlerts operation
    /// </summary>  
    public class ListMultiplexAlertsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMultiplexAlertsResponse response = new ListMultiplexAlertsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MultiplexAlert, MultiplexAlertUnmarshaller>(MultiplexAlertUnmarshaller.Instance);
        ...
        private static ListMultiplexAlertsResponseUnmarshaller _instance = new ListMultiplexAlertsResponseUnmarshaller();        

        internal static ListMultiplexAlertsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMultiplexAlertsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
