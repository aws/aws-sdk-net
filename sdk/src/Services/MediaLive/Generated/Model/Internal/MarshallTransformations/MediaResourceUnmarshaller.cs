...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MediaResourceUnmarshaller : IJsonUnmarshaller<MediaResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MediaResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MediaResourceNeighbor, MediaResourceNeighborUnmarshaller>(MediaResourceNeighborUnmarshaller.Instance);
