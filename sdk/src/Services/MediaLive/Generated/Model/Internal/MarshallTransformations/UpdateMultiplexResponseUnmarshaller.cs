...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMultiplex operation
    /// </summary>  
    public class UpdateMultiplexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMultiplexResponse response = new UpdateMultiplexResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("multiplex", targetDepth, ref reader))
                {
                    var unmarshaller = MultiplexUnmarshaller.Instance;
                    response.Multiplex = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateMultiplexResponseUnmarshaller _instance = new UpdateMultiplexResponseUnmarshaller();        

        internal static UpdateMultiplexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMultiplexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
