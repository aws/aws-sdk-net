...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeInferenceSettingsUnmarshaller : IJsonUnmarshaller<DescribeInferenceSettings, JsonUnmarshallerContext>
    {
        ...
        public DescribeInferenceSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("audioFeedInputs", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("enrichmentMethods", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.EnrichmentMethods = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("feedArn", targetDepth, ref reader))
                {
