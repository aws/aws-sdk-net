...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSchedule operation
    /// </summary>  
    public class DescribeScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("scheduleActions", targetDepth))
                {
                    ...
                    response.ScheduleActions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeScheduleResponseUnmarshaller _instance = new DescribeScheduleResponseUnmarshaller();        

        internal static DescribeScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
