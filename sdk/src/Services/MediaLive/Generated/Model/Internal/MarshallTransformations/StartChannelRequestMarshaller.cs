...
{
    /// <summary>
    /// StartChannel Request Marshaller
    /// </summary>       
    public class StartChannelRequestMarshaller : IMarshaller<IRequest, StartChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartChannelRequest)input);
        }
        ...
        private static StartChannelRequestMarshaller _instance = new StartChannelRequestMarshaller();        

        internal static StartChannelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartChannelRequestMarshaller Instance
        {
            get
            {
                return _instance;
