        ...
        public ChannelSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("channelSecurityGroups", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChannelSecurityGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("usedChannelEngineVersions", targetDepth, ref reader))
                {
