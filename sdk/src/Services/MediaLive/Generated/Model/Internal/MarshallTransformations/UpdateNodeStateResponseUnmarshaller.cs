        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("channelPlacementGroups", targetDepth))
                {
                    ...
                    response.ChannelPlacementGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("nodeInterfaceMappings", targetDepth))
                {
                    ...
                    response.NodeInterfaceMappings = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("sdiSourceMappings", targetDepth))
                {
                    ...
                    response.SdiSourceMappings = unmarshaller.Unmarshall(context);
                    continue;
                }
