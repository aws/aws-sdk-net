...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNodeState operation
    /// </summary>  
    public class UpdateNodeStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateNodeStateResponse response = new UpdateNodeStateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("channelPlacementGroups", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("nodeInterfaceMappings", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("sdiSourceMappings", targetDepth, ref reader))
                {
        ...
        private static UpdateNodeStateResponseUnmarshaller _instance = new UpdateNodeStateResponseUnmarshaller();        

        internal static UpdateNodeStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNodeStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
