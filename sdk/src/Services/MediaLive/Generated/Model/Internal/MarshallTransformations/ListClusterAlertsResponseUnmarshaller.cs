...
{
    /// <summary>
    /// Response Unmarshaller for ListClusterAlerts operation
    /// </summary>  
    public class ListClusterAlertsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListClusterAlertsResponse response = new ListClusterAlertsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ClusterAlert, ClusterAlertUnmarshaller>(ClusterAlertUnmarshaller.Instance);
        ...
        private static ListClusterAlertsResponseUnmarshaller _instance = new ListClusterAlertsResponseUnmarshaller();        

        internal static ListClusterAlertsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClusterAlertsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
