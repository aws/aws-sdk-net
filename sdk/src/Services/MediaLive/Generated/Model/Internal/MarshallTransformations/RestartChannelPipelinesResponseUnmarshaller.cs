...
{
    /// <summary>
    /// Response Unmarshaller for RestartChannelPipelines operation
    /// </summary>  
    public class RestartChannelPipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestartChannelPipelinesResponse response = new RestartChannelPipelinesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("maintenanceStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MaintenanceStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RestartChannelPipelinesResponseUnmarshaller _instance = new RestartChannelPipelinesResponseUnmarshaller();        

        internal static RestartChannelPipelinesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestartChannelPipelinesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
