...
{
    /// <summary>
    /// Response Unmarshaller for BatchStop operation
    /// </summary>  
    public class BatchStopResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchStopResponse response = new BatchStopResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchFailedResultModel, BatchFailedResultModelUnmarshaller>(BatchFailedResultModelUnmarshaller.Instance);
                    response.Failed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("successful", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchSuccessfulResultModel, BatchSuccessfulResultModelUnmarshaller>(BatchSuccessfulResultModelUnmarshaller.Instance);
        ...
        private static BatchStopResponseUnmarshaller _instance = new BatchStopResponseUnmarshaller();        

        internal static BatchStopResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchStopResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
