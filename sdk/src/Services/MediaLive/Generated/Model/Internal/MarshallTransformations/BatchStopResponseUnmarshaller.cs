    ...
    public class BatchStopResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchFailedResultModel, BatchFailedResultModelUnmarshaller>(BatchFailedResultModelUnmarshaller.Instance);
                    response.Failed = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("successful", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<BatchSuccessfulResultModel, BatchSuccessfulResultModelUnmarshaller>(BatchSuccessfulResultModelUnmarshaller.Instance);
