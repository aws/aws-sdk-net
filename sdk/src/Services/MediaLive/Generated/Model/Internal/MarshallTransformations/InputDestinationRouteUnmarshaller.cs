...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputDestinationRouteUnmarshaller : IJsonUnmarshaller<InputDestinationRoute, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InputDestinationRoute Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("gateway", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Gateway = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
