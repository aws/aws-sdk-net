...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMultiplexProgram operation
    /// </summary>  
    public class DeleteMultiplexProgramResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMultiplexProgramResponse response = new DeleteMultiplexProgramResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("multiplexProgramSettings", targetDepth))
                {
                    ...
                    response.MultiplexProgramSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("packetIdentifiersMap", targetDepth))
                {
                    ...
                    response.PacketIdentifiersMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProgramName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteMultiplexProgramResponseUnmarshaller _instance = new DeleteMultiplexProgramResponseUnmarshaller();        

        internal static DeleteMultiplexProgramResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMultiplexProgramResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
