...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OutputDestinationSettingsUnmarshaller : IJsonUnmarshaller<OutputDestinationSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OutputDestinationSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("passwordParam", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("virtualSourceAddress", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VirtualSourceAddress = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
