...
{
    /// <summary>
    /// DescribeNode Request Marshaller
    /// </summary>       
    public class DescribeNodeRequestMarshaller : IMarshaller<IRequest, DescribeNodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeNodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeNodeRequest publicRequest)
        {
        ...
        private static DescribeNodeRequestMarshaller _instance = new DescribeNodeRequestMarshaller();        

        internal static DescribeNodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
