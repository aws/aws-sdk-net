...
namespace Amazon.MediaLive.Model
{
    ...
    /// </summary>
    public partial class SignalMapSummary
    {
        private string _arn;
        ...
        private SignalMapMonitorDeploymentStatus _monitorDeploymentStatus;
        ...
        /// <summary>
        /// Gets and sets the property MonitorDeploymentStatus.
        /// </summary>
        [AWSProperty(Required=true)]
        public SignalMapMonitorDeploymentStatus MonitorDeploymentStatus
        {
            get { return this._monitorDeploymentStatus; }
            set { this._monitorDeploymentStatus = value; }
        }

        // Check to see if MonitorDeploymentStatus property is set
        internal bool IsSetMonitorDeploymentStatus()
        {
            return this._monitorDeploymentStatus != null;
        }
