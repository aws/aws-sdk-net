...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonIoT1ClickProjectsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonIoT1ClickProjectsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonIoT1ClickProjectsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonIoT1ClickProjectsConfig to create AmazonIoT1ClickProjectsClient");
            }

            return awsCredentials == null ? 
                    new AmazonIoT1ClickProjectsClient(serviceClientConfig) :
                    new AmazonIoT1ClickProjectsClient(awsCredentials, serviceClientConfig);
        }
