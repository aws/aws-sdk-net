...
namespace Amazon.IoT1ClickProjects.Internal
{
    ...
    public class AmazonIoT1ClickProjectsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoT1ClickProjectsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoT1ClickProjects.
        /// </summary>
        public AmazonIoT1ClickProjectsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoT1ClickProjectsAuthSchemeParameters
            {
    ...
    public class AmazonIoT1ClickProjectsAuthSchemeResolver : IAuthSchemeResolver<AmazonIoT1ClickProjectsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoT1ClickProjectsAuthSchemeParameters authParameters)
        {
