...
namespace Amazon.IoT1ClickProjects.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceConflictExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ResourceConflictException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ResourceConflictException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ResourceConflictException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
