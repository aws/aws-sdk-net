...
namespace Amazon.IoT1ClickProjects.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlacementTemplateUnmarshaller : IJsonUnmarshaller<PlacementTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PlacementTemplate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, DeviceTemplate, StringUnmarshaller, DeviceTemplateUnmarshaller>(StringUnmarshaller.Instance, DeviceTemplateUnmarshaller.Instance);
                    unmarshalledObject.DeviceTemplates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
