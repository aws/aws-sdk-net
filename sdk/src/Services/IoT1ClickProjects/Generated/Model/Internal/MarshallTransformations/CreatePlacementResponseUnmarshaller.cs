...
{
    /// <summary>
    /// Response Unmarshaller for CreatePlacement operation
    /// </summary>  
    public class CreatePlacementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePlacementResponse response = new CreatePlacementResponse();
        ...
        private static CreatePlacementResponseUnmarshaller _instance = new CreatePlacementResponseUnmarshaller();        

        internal static CreatePlacementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePlacementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
