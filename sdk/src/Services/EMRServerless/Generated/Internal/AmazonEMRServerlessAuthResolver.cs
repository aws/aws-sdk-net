...
namespace Amazon.EMRServerless.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonEMRServerlessAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEMRServerlessAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EMRServerless.
        /// </summary>
        public AmazonEMRServerlessAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEMRServerlessAuthSchemeParameters
            {
    ...
    public class AmazonEMRServerlessAuthSchemeResolver : IAuthSchemeResolver<AmazonEMRServerlessAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEMRServerlessAuthSchemeParameters authParameters)
        {
