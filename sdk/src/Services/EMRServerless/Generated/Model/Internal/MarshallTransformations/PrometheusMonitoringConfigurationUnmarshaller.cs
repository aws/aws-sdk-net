...
namespace Amazon.EMRServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PrometheusMonitoringConfigurationUnmarshaller : IJsonUnmarshaller<PrometheusMonitoringConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PrometheusMonitoringConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("remoteWriteUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RemoteWriteUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
