...
namespace Amazon.EMRServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ManagedPersistenceMonitoringConfigurationUnmarshaller : IJsonUnmarshaller<ManagedPersistenceMonitoringConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ManagedPersistenceMonitoringConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
