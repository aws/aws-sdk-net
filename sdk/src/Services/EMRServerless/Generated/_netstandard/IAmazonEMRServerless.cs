...
namespace Amazon.EMRServerless
{
    ...
    public partial interface IAmazonEMRServerless : IAmazonService, IDisposable
    {
        ...
        Task<GetResourceDashboardResponse> GetResourceDashboardAsync(GetResourceDashboardRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetSessionEndpointResponse> GetSessionEndpointAsync(GetSessionEndpointRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListJobRunAttemptsResponse> ListJobRunAttemptsAsync(ListJobRunAttemptsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEMRServerlessConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEMRServerlessConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEMRServerlessConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEMRServerlessConfig to create AmazonEMRServerlessClient");
            }

            return awsCredentials == null ? 
                    new AmazonEMRServerlessClient(serviceClientConfig) :
                    new AmazonEMRServerlessClient(awsCredentials, serviceClientConfig);
        }
