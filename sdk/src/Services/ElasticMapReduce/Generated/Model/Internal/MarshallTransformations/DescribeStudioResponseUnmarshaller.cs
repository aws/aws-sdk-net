...
{
    /// <summary>
    /// Response Unmarshaller for DescribeStudio operation
    /// </summary>  
    public class DescribeStudioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeStudioResponse response = new DescribeStudioResponse();
        ...
        private static DescribeStudioResponseUnmarshaller _instance = new DescribeStudioResponseUnmarshaller();        

        internal static DescribeStudioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStudioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
