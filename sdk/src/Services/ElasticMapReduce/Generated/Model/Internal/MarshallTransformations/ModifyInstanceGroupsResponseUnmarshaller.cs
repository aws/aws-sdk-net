...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class ModifyInstanceGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ModifyInstanceGroupsResponseUnmarshaller _instance = new ModifyInstanceGroupsResponseUnmarshaller();        

        internal static ModifyInstanceGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyInstanceGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
