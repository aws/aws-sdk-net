...
{
    /// <summary>
    /// Response Unmarshaller for ListNotebookExecutions operation
    /// </summary>  
    public class ListNotebookExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NotebookExecutions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<NotebookExecutionSummary, NotebookExecutionSummaryUnmarshaller>(NotebookExecutionSummaryUnmarshaller.Instance);
                    response.NotebookExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListNotebookExecutionsResponseUnmarshaller _instance = new ListNotebookExecutionsResponseUnmarshaller();        

        internal static ListNotebookExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNotebookExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
