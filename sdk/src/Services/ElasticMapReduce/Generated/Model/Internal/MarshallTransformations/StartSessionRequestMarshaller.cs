...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class StartSessionRequestMarshaller : IMarshaller<IRequest, StartSessionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartSessionRequest publicRequest)
        {
            ...
            string target = "ElasticMapReduce.StartSession";
            ...
            if(publicRequest.IsSetEngineConfigurations())
            {
                context.Writer.WritePropertyName("EngineConfigurations");
                context.Writer.WriteStartArray();
                foreach(var publicRequestEngineConfigurationsListValue in publicRequest.EngineConfigurations)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = ConfigurationMarshaller.Instance;
                    marshaller.Marshall(publicRequestEngineConfigurationsListValue, context);
            ...
            if(publicRequest.IsSetMonitoringConfiguration())
            {
                ...
                var marshaller = SessionMonitoringConfigurationMarshaller.Instance;
