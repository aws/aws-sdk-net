...
{
    /// <summary>
    /// Response Unmarshaller for SessionMonitoringConfiguration Object
    /// </summary>  
    public class SessionMonitoringConfigurationUnmarshaller : IJsonUnmarshaller<SessionMonitoringConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SessionMonitoringConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SessionMonitoringConfiguration unmarshalledObject = new SessionMonitoringConfiguration();
        ...
        private static SessionMonitoringConfigurationUnmarshaller _instance = new SessionMonitoringConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SessionMonitoringConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
