...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceStatusUnmarshaller : IJsonUnmarshaller<InstanceStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = InstanceStateChangeReasonUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = InstanceTimelineUnmarshaller.Instance;
