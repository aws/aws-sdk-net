...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class ListSessionsRequestMarshaller : IMarshaller<IRequest, ListSessionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListSessionsRequest publicRequest)
        {
            ...
            string target = "ElasticMapReduce.ListSessions";
            ...
            if(publicRequest.IsSetSessionStates())
            {
                context.Writer.WritePropertyName("SessionStates");
                context.Writer.WriteStartArray();
                foreach(var publicRequestSessionStatesListValue in publicRequest.SessionStates)
                {
                        context.Writer.WriteStringValue(publicRequestSessionStatesListValue);
                }
