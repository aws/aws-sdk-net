...
{
    /// <summary>
    /// Amazon ElasticMapReduce endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ElasticMapReduce service requests.
    /// Collects values for ElasticMapReduceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ElasticMapReduceEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonElasticMapReduceEndpointResolver : BaseEndpointResolver
    {
