...
namespace Amazon.KinesisVideoWebRTCStorage.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class JoinStorageSessionAsViewerRequestMarshaller : IMarshaller<IRequest, JoinStorageSessionAsViewerRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly JoinStorageSessionAsViewerRequestMarshaller _instance = new();

        internal static JoinStorageSessionAsViewerRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static JoinStorageSessionAsViewerRequestMarshaller Instance => _instance;
    }
}
