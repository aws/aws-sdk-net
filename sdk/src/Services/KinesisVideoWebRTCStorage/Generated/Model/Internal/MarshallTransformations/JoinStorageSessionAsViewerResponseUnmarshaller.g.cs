...
namespace Amazon.KinesisVideoWebRTCStorage.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class JoinStorageSessionAsViewerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static JoinStorageSessionAsViewerResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static JoinStorageSessionAsViewerResponseUnmarshaller Instance => _instance;
    }
}
