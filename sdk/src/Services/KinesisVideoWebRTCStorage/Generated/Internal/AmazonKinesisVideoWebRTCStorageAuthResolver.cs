...
namespace Amazon.KinesisVideoWebRTCStorage.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonKinesisVideoWebRTCStorageAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKinesisVideoWebRTCStorageAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for KinesisVideoWebRTCStorage.
        /// </summary>
        public AmazonKinesisVideoWebRTCStorageAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKinesisVideoWebRTCStorageAuthSchemeParameters
            {
    ...
    public class AmazonKinesisVideoWebRTCStorageAuthSchemeResolver : IAuthSchemeResolver<AmazonKinesisVideoWebRTCStorageAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKinesisVideoWebRTCStorageAuthSchemeParameters authParameters)
        {
