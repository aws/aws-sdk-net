...
namespace Amazon.KinesisVideoWebRTCStorage
{
    ...
    public partial class AmazonKinesisVideoWebRTCStorageClient : AmazonServiceClient, IAmazonKinesisVideoWebRTCStorage
    {
        ...
        /// 
        /// </summary>
        public AmazonKinesisVideoWebRTCStorageClient() : base(new AmazonKinesisVideoWebRTCStorageConfig()) { }
        ...
        public AmazonKinesisVideoWebRTCStorageClient(RegionEndpoint region) : base(new AmazonKinesisVideoWebRTCStorageConfig { RegionEndpoint = region }) { }
        ...
        public AmazonKinesisVideoWebRTCStorageClient(AmazonKinesisVideoWebRTCStorageConfig config) : base(config) { }
