...
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - Amazon QLDB Session. Amazon QLDB introduces the SendCommand API to interact with data in Amazon QLDB ledgers.")]
#else
