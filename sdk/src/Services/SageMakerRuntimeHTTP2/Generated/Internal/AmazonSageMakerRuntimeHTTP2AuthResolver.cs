...
namespace Amazon.SageMakerRuntimeHTTP2.Internal
{
    ...
    public class AmazonSageMakerRuntimeHTTP2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSageMakerRuntimeHTTP2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SageMakerRuntimeHTTP2.
        /// </summary>
        public AmazonSageMakerRuntimeHTTP2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSageMakerRuntimeHTTP2AuthSchemeParameters
            {
    ...
    public class AmazonSageMakerRuntimeHTTP2AuthSchemeResolver : IAuthSchemeResolver<AmazonSageMakerRuntimeHTTP2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSageMakerRuntimeHTTP2AuthSchemeParameters authParameters)
        {
