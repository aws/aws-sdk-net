...
namespace Amazon.SageMakerRuntimeHTTP2.Model.Internal.MarshallTransformations
{
    ...
    public partial class RequestStreamEventPublisherMarshaller : EventStreamPublisher
    {
        ...
        public RequestStreamEventPublisherMarshaller(Func<Task<IRequestStreamEventEvent>> publisher)
        {
        ...
        public override async Task<IEventStreamMessage> NextEventAsync()
        {
            ...
            if (evnt is RequestPayloadPart)
            {
                var memoryStream = new MemoryStream();
                var context = CreateJsonMarshallerContext(memoryStream);
                context.Writer.WriteStartObject();
                RequestPayloadPartMarshaller.Instance.Marshall((RequestPayloadPart)evnt, context);
                eventHeaders = context.Request.EventHeaders;
                context.Writer.WriteEndObject();
                context.Writer.Flush();

                eventType = "PayloadPart";
