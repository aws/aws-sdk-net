...
{
    /// <summary>
    /// Response Unmarshaller for InvokeEndpointWithBidirectionalStream operation
    /// </summary>  
    public class InvokeEndpointWithBidirectionalStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InvokeEndpointWithBidirectionalStreamResponse response = new InvokeEndpointWithBidirectionalStreamResponse();
            response.Body = new ResponseStreamEvent(context.Stream);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InputValidationError"))
                {
                    return InputValidationErrorExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            ...
            return new AmazonSageMakerRuntimeHTTP2Exception(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static InvokeEndpointWithBidirectionalStreamResponseUnmarshaller _instance = new InvokeEndpointWithBidirectionalStreamResponseUnmarshaller();        

        internal static InvokeEndpointWithBidirectionalStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeEndpointWithBidirectionalStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
