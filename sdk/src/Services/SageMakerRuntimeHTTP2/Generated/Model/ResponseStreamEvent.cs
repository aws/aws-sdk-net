...
namespace Amazon.SageMakerRuntimeHTTP2.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "ResponseStreamEventCollection is not descriptive")]
    ...
    public sealed class ResponseStreamEvent : EnumerableEventOutputStream<IEventStreamEvent, SageMakerRuntimeHTTP2EventStreamException>
    {
        /// <summary>
        ...
        /// </summary>
        protected override IDictionary<string,Func<IEventStreamMessage,SageMakerRuntimeHTTP2EventStreamException>> ExceptionMapping {get;} =
        new Dictionary<string,Func<IEventStreamMessage,SageMakerRuntimeHTTP2EventStreamException>>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        /// </summary>
        public override event EventHandler<EventStreamExceptionReceivedArgs<SageMakerRuntimeHTTP2EventStreamException>> ExceptionReceived;
        /// <summary>
        ...
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<ResponsePayloadPart>> PayloadPartReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public ResponseStreamEvent(Stream stream) : this (stream, null)
        {
        }
        ...
        public ResponseStreamEvent(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
