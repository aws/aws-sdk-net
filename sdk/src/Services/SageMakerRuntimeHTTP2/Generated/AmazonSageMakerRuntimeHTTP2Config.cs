...
namespace Amazon.SageMakerRuntimeHTTP2
{
    ...
    public partial class AmazonSageMakerRuntimeHTTP2Config : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SageMaker Runtime HTTP2", "4.0.100.12");
        ...
        /// Default constructor
        /// </summary>
        public AmazonSageMakerRuntimeHTTP2Config()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonSageMakerRuntimeHTTP2DefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "SageMaker Runtime HTTP2";
            this.AuthenticationServiceName = "sagemaker";
            this.EndpointProvider = new AmazonSageMakerRuntimeHTTP2EndpointProvider();
        }
