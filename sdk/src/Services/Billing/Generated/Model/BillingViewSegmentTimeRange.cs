...
namespace Amazon.Billing.Model
{
    ...
    /// </summary>
    public partial class BillingViewSegmentTimeRange
    {
        private DateTime? _beginDateInclusive;
        private DateTime? _endDateExclusive;
        ...
        /// <para>
        ///  The exclusive end of the time range. This value must be after <c>beginDateInclusive</c>.
        /// 
        /// </para>
        /// </summary>
        public DateTime? EndDateExclusive
        {
        ...
        {
            return this._endDateExclusive.HasValue; 
        }
