...
{
    /// <summary>
    /// GetCredits Request Marshaller
    /// </summary>       
    public class GetCreditsRequestMarshaller : IMarshaller<IRequest, GetCreditsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCreditsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCreditsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Billing");
            string target = "AWSBilling.GetCredits";
            ...
            {
                context.Writer.WritePropertyName("payerAccountFlag");
                context.Writer.WriteBooleanValue(publicRequest.PayerAccountFlag.Value);
            }
        ...
        private static GetCreditsRequestMarshaller _instance = new GetCreditsRequestMarshaller();        

        internal static GetCreditsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCreditsRequestMarshaller Instance
        {
            get
            {
                return _instance;
