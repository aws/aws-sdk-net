...
{
    /// <summary>
    /// Response Unmarshaller for ListBillingViewSegments operation
    /// </summary>  
    public class ListBillingViewSegmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBillingViewSegmentsResponse response = new ListBillingViewSegmentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BillingViewSegmentsListElement, BillingViewSegmentsListElementUnmarshaller>(BillingViewSegmentsListElementUnmarshaller.Instance);
        ...
        private static ListBillingViewSegmentsResponseUnmarshaller _instance = new ListBillingViewSegmentsResponseUnmarshaller();        

        internal static ListBillingViewSegmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBillingViewSegmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
