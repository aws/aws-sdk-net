...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBillingPreferences operation
    /// </summary>  
    public class UpdateBillingPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBillingPreferencesResponse response = new UpdateBillingPreferencesResponse();
        ...
        private static UpdateBillingPreferencesResponseUnmarshaller _instance = new UpdateBillingPreferencesResponseUnmarshaller();        

        internal static UpdateBillingPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBillingPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
