...
namespace Amazon.Billing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BillingViewListElementUnmarshaller : IJsonUnmarshaller<BillingViewListElement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BillingViewListElement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("billingViewType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
