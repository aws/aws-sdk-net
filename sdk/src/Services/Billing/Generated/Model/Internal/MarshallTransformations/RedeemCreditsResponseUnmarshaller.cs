...
{
    /// <summary>
    /// Response Unmarshaller for RedeemCredits operation
    /// </summary>  
    public class RedeemCreditsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RedeemCreditsResponse response = new RedeemCreditsResponse();
        ...
        private static RedeemCreditsResponseUnmarshaller _instance = new RedeemCreditsResponseUnmarshaller();        

        internal static RedeemCreditsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RedeemCreditsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
