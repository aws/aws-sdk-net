...
{
    /// <summary>
    /// Response Unmarshaller for GetCredits operation
    /// </summary>  
    public class GetCreditsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("credits", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CreditData, CreditDataUnmarshaller>(CreditDataUnmarshaller.Instance);
                    response.Credits = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCreditsResponseUnmarshaller _instance = new GetCreditsResponseUnmarshaller();        

        internal static GetCreditsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCreditsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
