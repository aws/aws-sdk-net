...
namespace Amazon.Billing.Model
{
    ...
    /// </summary>
    public partial class ListEnterpriseSupportLinkedAccountChargesResponse : AmazonWebServiceResponse
    {
        private List<LinkedAccountCharge> _linkedAccount = AWSConfigs.InitializeCollections ? new List<LinkedAccountCharge>() : null;
        ...
        public List<LinkedAccountCharge> LinkedAccount
        {
        ...
        {
            return this._linkedAccount != null && (this._linkedAccount.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
