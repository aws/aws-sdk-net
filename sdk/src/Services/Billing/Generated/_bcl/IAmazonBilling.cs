...
namespace Amazon.Billing
{
    ...
    public partial interface IAmazonBilling : IAmazonService, IDisposable
    {
        ...
        ListBillingViewSegmentsResponse ListBillingViewSegments(ListBillingViewSegmentsRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/billing-2023-09-07/ListBillingViewSegments">REST API Reference for ListBillingViewSegments Operation</seealso>
        Task<ListBillingViewSegmentsResponse> ListBillingViewSegmentsAsync(ListBillingViewSegmentsRequest request, CancellationToken cancellationToken = default(CancellationToken));
