...
namespace Amazon.Billing
{
    ...
    public partial interface IAmazonBilling : IAmazonService, IDisposable
    {
        ...
        Task<GetBillingPreferencesResponse> GetBillingPreferencesAsync(GetBillingPreferencesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetCreditAllocationHistoryResponse> GetCreditAllocationHistoryAsync(GetCreditAllocationHistoryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetCreditsResponse> GetCreditsAsync(GetCreditsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetEnterpriseSupportChargeSummaryResponse> GetEnterpriseSupportChargeSummaryAsync(GetEnterpriseSupportChargeSummaryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetEnterpriseSupportContractDetailsResponse> GetEnterpriseSupportContractDetailsAsync(GetEnterpriseSupportContractDetailsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListEnterpriseSupportLinkedAccountChargesResponse> ListEnterpriseSupportLinkedAccountChargesAsync(ListEnterpriseSupportLinkedAccountChargesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<RedeemCreditsResponse> RedeemCreditsAsync(RedeemCreditsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateBillingPreferencesResponse> UpdateBillingPreferencesAsync(UpdateBillingPreferencesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
