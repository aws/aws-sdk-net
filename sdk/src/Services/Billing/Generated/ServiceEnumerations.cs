...
namespace Amazon.Billing
{
    ...
    /// <summary>
    /// Constants used for properties of type BillingDomain.
    /// </summary>
    public class BillingDomain : ConstantClass
    {

        /// <summary>
        /// Constant BILLABLE for BillingDomain
        /// </summary>
        public static readonly BillingDomain BILLABLE = new BillingDomain("BILLABLE");
        /// <summary>
        /// Constant PRO_FORMA for BillingDomain
        /// </summary>
        public static readonly BillingDomain PRO_FORMA = new BillingDomain("PRO_FORMA");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public BillingDomain(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static BillingDomain FindValue(string value)
        {
            return FindValue<BillingDomain>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator BillingDomain(string value)
        {
            return FindValue(value);
        }
    }
