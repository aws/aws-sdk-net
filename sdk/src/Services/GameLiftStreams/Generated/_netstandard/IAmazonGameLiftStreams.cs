...
namespace Amazon.GameLiftStreams
{
    ...
    public partial interface IAmazonGameLiftStreams : IAmazonService, IDisposable
    {
        ...
        Task<AddStreamGroupLocationsResponse> AddStreamGroupLocationsAsync(AddStreamGroupLocationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateStreamGroupResponse> CreateStreamGroupAsync(CreateStreamGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateStreamSessionAdminShellResponse> CreateStreamSessionAdminShellAsync(CreateStreamSessionAdminShellRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateStreamSessionConnectionResponse> CreateStreamSessionConnectionAsync(CreateStreamSessionConnectionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateStreamUrlResponse> CreateStreamUrlAsync(CreateStreamUrlRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteStreamGroupResponse> DeleteStreamGroupAsync(DeleteStreamGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ExportStreamSessionFilesResponse> ExportStreamSessionFilesAsync(ExportStreamSessionFilesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetStreamGroupResponse> GetStreamGroupAsync(GetStreamGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetStreamUrlResponse> GetStreamUrlAsync(GetStreamUrlRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListApplicationShaderCachesResponse> ListApplicationShaderCachesAsync(ListApplicationShaderCachesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListStreamGroupsResponse> ListStreamGroupsAsync(ListStreamGroupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListStreamSessionsByAccountResponse> ListStreamSessionsByAccountAsync(ListStreamSessionsByAccountRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListStreamUrlsResponse> ListStreamUrlsAsync(ListStreamUrlsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<RemoveStreamGroupLocationsResponse> RemoveStreamGroupLocationsAsync(RemoveStreamGroupLocationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<RevokeStreamUrlResponse> RevokeStreamUrlAsync(RevokeStreamUrlRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartStreamSessionResponse> StartStreamSessionAsync(StartStreamSessionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<TerminateStreamSessionResponse> TerminateStreamSessionAsync(TerminateStreamSessionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateStreamGroupResponse> UpdateStreamGroupAsync(UpdateStreamGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonGameLiftStreamsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonGameLiftStreamsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonGameLiftStreamsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonGameLiftStreamsConfig to create AmazonGameLiftStreamsClient");
            }

            return awsCredentials == null ? 
                    new AmazonGameLiftStreamsClient(serviceClientConfig) :
                    new AmazonGameLiftStreamsClient(awsCredentials, serviceClientConfig);
        }
