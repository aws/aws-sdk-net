...
namespace Amazon.GameLiftStreams
{
    ...
    public partial interface IAmazonGameLiftStreams : IAmazonService, IDisposable
    {
        ...
        CreateStreamSessionAdminShellResponse CreateStreamSessionAdminShell(CreateStreamSessionAdminShellRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/gameliftstreams-2018-05-10/CreateStreamSessionAdminShell">REST API Reference for CreateStreamSessionAdminShell Operation</seealso>
        Task<CreateStreamSessionAdminShellResponse> CreateStreamSessionAdminShellAsync(CreateStreamSessionAdminShellRequest request, CancellationToken cancellationToken = default(CancellationToken));
