...
namespace Amazon.GameLiftStreams.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VpcTransitConfigurationResponseUnmarshaller : IJsonUnmarshaller<VpcTransitConfigurationResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VpcTransitConfigurationResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
