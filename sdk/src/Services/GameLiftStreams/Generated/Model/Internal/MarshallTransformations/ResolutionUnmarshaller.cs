...
namespace Amazon.GameLiftStreams.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResolutionUnmarshaller : IJsonUnmarshaller<Resolution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Resolution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Resolution unmarshalledObject = new Resolution();
        ...
        private static ResolutionUnmarshaller _instance = new ResolutionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResolutionUnmarshaller Instance
        {
            get
            {
                return _instance;
