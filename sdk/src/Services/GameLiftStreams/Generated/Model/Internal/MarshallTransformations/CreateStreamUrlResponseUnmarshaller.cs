...
namespace Amazon.GameLiftStreams.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateStreamUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateStreamUrlResponse response = new CreateStreamUrlResponse();
        ...
        internal static CreateStreamUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStreamUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
