...
{
    /// <summary>
    /// Response Unmarshaller for CreateStreamGroup operation
    /// </summary>  
    public class CreateStreamGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateStreamGroupResponse response = new CreateStreamGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DefaultApplication", targetDepth))
                {
                    var unmarshaller = DefaultApplicationUnmarshaller.Instance;
                    response.DefaultApplication = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("LocationStates", targetDepth))
                {
                    ...
                    response.LocationStates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("StreamClass", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamClass = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateStreamGroupResponseUnmarshaller _instance = new CreateStreamGroupResponseUnmarshaller();        

        internal static CreateStreamGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStreamGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("AssociatedApplications", targetDepth))
                {
                    ...
                    response.AssociatedApplications = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CreatedAt", targetDepth))
                {
                ...
                {
                    var unmarshaller = DefaultApplicationUnmarshaller.Instance;
                    response.DefaultApplication = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Description", targetDepth))
                {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamClass = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
