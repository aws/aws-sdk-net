...
{
    /// <summary>
    /// Response Unmarshaller for RevokeStreamUrl operation
    /// </summary>  
    public class RevokeStreamUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeStreamUrlResponse response = new RevokeStreamUrlResponse();
        ...
        private static RevokeStreamUrlResponseUnmarshaller _instance = new RevokeStreamUrlResponseUnmarshaller();        

        internal static RevokeStreamUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeStreamUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
