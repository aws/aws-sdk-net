...
{
    /// <summary>
    /// Response Unmarshaller for ListStreamUrls operation
    /// </summary>  
    public class ListStreamUrlsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListStreamUrlsResponse response = new ListStreamUrlsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<StreamUrlSummary, StreamUrlSummaryUnmarshaller>(StreamUrlSummaryUnmarshaller.Instance);
        ...
        private static ListStreamUrlsResponseUnmarshaller _instance = new ListStreamUrlsResponseUnmarshaller();        

        internal static ListStreamUrlsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStreamUrlsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
