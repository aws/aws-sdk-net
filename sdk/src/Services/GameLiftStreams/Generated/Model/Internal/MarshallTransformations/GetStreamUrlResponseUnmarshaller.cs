...
{
    /// <summary>
    /// Response Unmarshaller for GetStreamUrl operation
    /// </summary>  
    public class GetStreamUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStreamUrlResponse response = new GetStreamUrlResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RemainingUses", targetDepth, ref reader))
                {
                    ...
                    response.RemainingUses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamGroupArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StreamUrlId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetStreamUrlResponseUnmarshaller _instance = new GetStreamUrlResponseUnmarshaller();        

        internal static GetStreamUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStreamUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
