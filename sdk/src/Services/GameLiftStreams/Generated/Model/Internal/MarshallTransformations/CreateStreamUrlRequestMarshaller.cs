...
{
    /// <summary>
    /// CreateStreamUrl Request Marshaller
    /// </summary>       
    public class CreateStreamUrlRequestMarshaller : IMarshaller<IRequest, CreateStreamUrlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateStreamUrlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateStreamUrlRequest publicRequest)
        {
            ...
            request.ResourcePath = "/streamgroups/{Identifier}/streamurls";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetUrlExpiresAfterMinutes())
            {
                context.Writer.WritePropertyName("UrlExpiresAfterMinutes");
                context.Writer.WriteNumberValue(publicRequest.UrlExpiresAfterMinutes.Value);
            }

            if(publicRequest.IsSetUsageLimit())
            {
                context.Writer.WritePropertyName("UsageLimit");
                context.Writer.WriteNumberValue(publicRequest.UsageLimit.Value);
            }
        ...
        private static CreateStreamUrlRequestMarshaller _instance = new CreateStreamUrlRequestMarshaller();        

        internal static CreateStreamUrlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStreamUrlRequestMarshaller Instance
        {
            get
            {
                return _instance;
