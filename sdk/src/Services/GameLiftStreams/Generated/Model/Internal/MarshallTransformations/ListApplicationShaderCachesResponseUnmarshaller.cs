...
{
    /// <summary>
    /// Response Unmarshaller for ListApplicationShaderCaches operation
    /// </summary>  
    public class ListApplicationShaderCachesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApplicationShaderCachesResponse response = new ListApplicationShaderCachesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ShaderCacheSummary, ShaderCacheSummaryUnmarshaller>(ShaderCacheSummaryUnmarshaller.Instance);
        ...
        private static ListApplicationShaderCachesResponseUnmarshaller _instance = new ListApplicationShaderCachesResponseUnmarshaller();        

        internal static ListApplicationShaderCachesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationShaderCachesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
