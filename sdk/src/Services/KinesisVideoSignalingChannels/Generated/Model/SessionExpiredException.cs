...
namespace Amazon.KinesisVideoSignalingChannels.Model
{
    ...
    public partial class SessionExpiredException : AmazonKinesisVideoSignalingChannelsException
    {
        ...
        public SessionExpiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SessionExpiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
