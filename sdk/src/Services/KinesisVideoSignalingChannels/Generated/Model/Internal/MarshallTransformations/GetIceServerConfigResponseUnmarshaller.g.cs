...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetIceServerConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetIceServerConfigResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IceServerList", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.IceServerList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetIceServerConfigResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetIceServerConfigResponseUnmarshaller Instance => _instance;
    }
}
