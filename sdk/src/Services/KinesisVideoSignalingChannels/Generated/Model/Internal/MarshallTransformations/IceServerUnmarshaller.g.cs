...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IceServerUnmarshaller : IJsonUnmarshaller<IceServer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new IceServer();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IceServerUnmarshaller Instance => _instance;
    }
}
