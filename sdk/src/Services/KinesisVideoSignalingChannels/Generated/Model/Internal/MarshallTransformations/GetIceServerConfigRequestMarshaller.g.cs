...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetIceServerConfigRequestMarshaller : IMarshaller<IRequest, GetIceServerConfigRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIceServerConfigRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetIceServerConfigRequest publicRequest)
        {
        ...
        private static readonly GetIceServerConfigRequestMarshaller _instance = new();

        internal static GetIceServerConfigRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetIceServerConfigRequestMarshaller Instance => _instance;
    }
}
