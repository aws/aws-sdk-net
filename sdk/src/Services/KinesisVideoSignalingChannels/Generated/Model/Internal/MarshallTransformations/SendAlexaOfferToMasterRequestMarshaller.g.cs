...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendAlexaOfferToMasterRequestMarshaller : IMarshaller<IRequest, SendAlexaOfferToMasterRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SendAlexaOfferToMasterRequestMarshaller _instance = new();

        internal static SendAlexaOfferToMasterRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendAlexaOfferToMasterRequestMarshaller Instance => _instance;
    }
}
