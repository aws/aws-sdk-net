...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendAlexaOfferToMasterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SendAlexaOfferToMasterResponse();
        ...
        internal static SendAlexaOfferToMasterResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendAlexaOfferToMasterResponseUnmarshaller Instance => _instance;
    }
}
