...
namespace Amazon.KinesisVideoSignalingChannels.Model
{
    ...
    public partial class SessionExpiredException : AmazonKinesisVideoSignalingChannelsException
    {
        ...
        /// Construct instance of SessionExpiredException
        /// </summary>
        public SessionExpiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of SessionExpiredException
        /// </summary>
        public SessionExpiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
