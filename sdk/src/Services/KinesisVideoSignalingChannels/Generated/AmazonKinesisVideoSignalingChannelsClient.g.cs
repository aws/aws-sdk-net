...
namespace Amazon.KinesisVideoSignalingChannels
{
    ...
    public partial class AmazonKinesisVideoSignalingChannelsClient : AmazonServiceClient, IAmazonKinesisVideoSignalingChannels
    {
        ...
        /// 
        /// </summary>
        public AmazonKinesisVideoSignalingChannelsClient() : base(new AmazonKinesisVideoSignalingChannelsConfig()) { }
        ...
        public AmazonKinesisVideoSignalingChannelsClient(RegionEndpoint region) : base(new AmazonKinesisVideoSignalingChannelsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonKinesisVideoSignalingChannelsClient(AmazonKinesisVideoSignalingChannelsConfig config) : base(config) { }
