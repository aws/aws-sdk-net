...
namespace Amazon.MemoryDB
{
    ...
    public partial interface IAmazonMemoryDB : IAmazonService, IDisposable
    {
        ...
        DescribeMultiRegionParameterGroupsResponse DescribeMultiRegionParameterGroups(DescribeMultiRegionParameterGroupsRequest request);

        /// <summary>
        /// Initiates the asynchronous execution of the DescribeMultiRegionParameterGroups operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the DescribeMultiRegionParameterGroups operation on AmazonMemoryDBClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndDescribeMultiRegionParameterGroups
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/DescribeMultiRegionParameterGroups">REST API Reference for DescribeMultiRegionParameterGroups Operation</seealso>
        IAsyncResult BeginDescribeMultiRegionParameterGroups(DescribeMultiRegionParameterGroupsRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  DescribeMultiRegionParameterGroups operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginDescribeMultiRegionParameterGroups.</param>
        /// 
        /// <returns>Returns a  DescribeMultiRegionParameterGroupsResult from MemoryDB.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/DescribeMultiRegionParameterGroups">REST API Reference for DescribeMultiRegionParameterGroups Operation</seealso>
        DescribeMultiRegionParameterGroupsResponse EndDescribeMultiRegionParameterGroups(IAsyncResult asyncResult);
        ...
        DescribeMultiRegionParametersResponse DescribeMultiRegionParameters(DescribeMultiRegionParametersRequest request);

        /// <summary>
        /// Initiates the asynchronous execution of the DescribeMultiRegionParameters operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the DescribeMultiRegionParameters operation on AmazonMemoryDBClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndDescribeMultiRegionParameters
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/DescribeMultiRegionParameters">REST API Reference for DescribeMultiRegionParameters Operation</seealso>
        IAsyncResult BeginDescribeMultiRegionParameters(DescribeMultiRegionParametersRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  DescribeMultiRegionParameters operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginDescribeMultiRegionParameters.</param>
        /// 
        /// <returns>Returns a  DescribeMultiRegionParametersResult from MemoryDB.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/DescribeMultiRegionParameters">REST API Reference for DescribeMultiRegionParameters Operation</seealso>
        DescribeMultiRegionParametersResponse EndDescribeMultiRegionParameters(IAsyncResult asyncResult);
