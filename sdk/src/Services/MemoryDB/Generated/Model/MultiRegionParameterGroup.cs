...
{
    /// <summary>
    /// Represents the output of a CreateMultiRegionParameterGroup operation. A multi-region
    /// parameter group represents a collection of parameters that can be applied to clusters
    /// across multiple regions.
    /// </summary>
    public partial class MultiRegionParameterGroup
    {
        private string _arn;
        ...
        /// <para>
        /// The name of the parameter group family that this multi-region parameter group is compatible
        /// with.
        /// </para>
        /// </summary>
