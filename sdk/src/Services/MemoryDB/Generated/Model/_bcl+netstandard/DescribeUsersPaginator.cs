...
namespace Amazon.MemoryDB.Model
{
    ...
    internal sealed partial class DescribeUsersPaginator : IPaginator<DescribeUsersResponse>, IDescribeUsersPaginator
    {
        ...
        internal DescribeUsersPaginator(IAmazonMemoryDB client, DescribeUsersRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<DescribeUsersResponse> IPaginator<DescribeUsersResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
