...
{
    /// <summary>
    /// Response Unmarshaller for CreateMultiRegionCluster operation
    /// </summary>  
    public class CreateMultiRegionClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMultiRegionClusterResponse response = new CreateMultiRegionClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("MultiRegionCluster", targetDepth))
                {
                    ...
                    response.MultiRegionCluster = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MultiRegionClusterAlreadyExistsFault"))
                {
                    return MultiRegionClusterAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateMultiRegionClusterResponseUnmarshaller _instance = new CreateMultiRegionClusterResponseUnmarshaller();        

        internal static CreateMultiRegionClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultiRegionClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
