...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PendingModifiedServiceUpdateUnmarshaller : IUnmarshaller<PendingModifiedServiceUpdate, XmlUnmarshallerContext>, IUnmarshaller<PendingModifiedServiceUpdate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PendingModifiedServiceUpdate IUnmarshaller<PendingModifiedServiceUpdate, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PendingModifiedServiceUpdate Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
