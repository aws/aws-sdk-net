...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MultiRegionParameterGroupUnmarshaller : IJsonUnmarshaller<MultiRegionParameterGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MultiRegionParameterGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
