...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReshardingStatusUnmarshaller : IJsonUnmarshaller<ReshardingStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReshardingStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ReshardingStatus unmarshalledObject = new ReshardingStatus();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReshardingStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
