    ...
    public class DescribeReservedNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ReservedNode, ReservedNodeUnmarshaller>(ReservedNodeUnmarshaller.Instance);
                    response.ReservedNodes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
