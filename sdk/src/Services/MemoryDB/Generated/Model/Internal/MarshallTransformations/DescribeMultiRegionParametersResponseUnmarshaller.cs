...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMultiRegionParameters operation
    /// </summary>  
    public class DescribeMultiRegionParametersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMultiRegionParametersResponse response = new DescribeMultiRegionParametersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MultiRegionParameter, MultiRegionParameterUnmarshaller>(MultiRegionParameterUnmarshaller.Instance);
                    response.MultiRegionParameters = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeMultiRegionParametersResponseUnmarshaller _instance = new DescribeMultiRegionParametersResponseUnmarshaller();        

        internal static DescribeMultiRegionParametersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMultiRegionParametersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
