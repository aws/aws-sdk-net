...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMultiRegionParameterGroups operation
    /// </summary>  
    public class DescribeMultiRegionParameterGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMultiRegionParameterGroupsResponse response = new DescribeMultiRegionParameterGroupsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MultiRegionParameterGroups", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MultiRegionParameterGroup, MultiRegionParameterGroupUnmarshaller>(MultiRegionParameterGroupUnmarshaller.Instance);
                    response.MultiRegionParameterGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeMultiRegionParameterGroupsResponseUnmarshaller _instance = new DescribeMultiRegionParameterGroupsResponseUnmarshaller();        

        internal static DescribeMultiRegionParameterGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMultiRegionParameterGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
