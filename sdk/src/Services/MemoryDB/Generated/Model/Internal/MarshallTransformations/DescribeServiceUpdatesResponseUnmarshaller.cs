...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeServiceUpdatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceUpdate, ServiceUpdateUnmarshaller>(ServiceUpdateUnmarshaller.Instance);
                    response.ServiceUpdates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
