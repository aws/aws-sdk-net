    ...
    public class DescribeServiceUpdatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ServiceUpdate, ServiceUpdateUnmarshaller>(ServiceUpdateUnmarshaller.Instance);
                    response.ServiceUpdates = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
