...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSubnetGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSubnetGroupResponse response = new CreateSubnetGroupResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SubnetGroupAlreadyExistsFault"))
                {
                    return SubnetGroupAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("SubnetGroupQuotaExceededFault"))
                {
                    return SubnetGroupQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateSubnetGroupResponseUnmarshaller _instance = new CreateSubnetGroupResponseUnmarshaller();        

        internal static CreateSubnetGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubnetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
