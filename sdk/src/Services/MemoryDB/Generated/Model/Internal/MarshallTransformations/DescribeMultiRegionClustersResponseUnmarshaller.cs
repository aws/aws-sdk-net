    ...
    public class DescribeMultiRegionClustersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MultiRegionCluster, MultiRegionClusterUnmarshaller>(MultiRegionClusterUnmarshaller.Instance);
                    response.MultiRegionClusters = unmarshaller.Unmarshall(context);
                    continue;
                }
