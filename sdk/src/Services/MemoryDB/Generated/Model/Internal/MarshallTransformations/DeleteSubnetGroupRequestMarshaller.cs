...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSubnetGroupRequestMarshaller : IMarshaller<IRequest, DeleteSubnetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSubnetGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSubnetGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MemoryDB");
            string target = "AmazonMemoryDB.DeleteSubnetGroup";
