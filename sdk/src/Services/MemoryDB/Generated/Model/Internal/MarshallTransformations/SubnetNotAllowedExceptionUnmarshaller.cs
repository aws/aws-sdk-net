...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubnetNotAllowedExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<SubnetNotAllowedException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public SubnetNotAllowedException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public SubnetNotAllowedException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
