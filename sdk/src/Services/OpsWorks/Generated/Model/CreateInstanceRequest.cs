...
namespace Amazon.OpsWorks.Model
{
    ...
    public partial class CreateInstanceRequest : AmazonOpsWorksRequest
    {
        ...
        ///  <note> 
        /// <para>
        /// If you specify a custom AMI, you must set <c>Os</c> to <c>Custom</c>.
        /// </para>
        ///  </note>
        /// </summary>
        public string AmiId
        ...
        /// <para>
        /// The instance architecture. The default option is <c>x86_64</c>. Instance types do
        ...
        /// <para>
        /// An array of <c>BlockDeviceMapping</c> objects that specify the instance's block devices.
