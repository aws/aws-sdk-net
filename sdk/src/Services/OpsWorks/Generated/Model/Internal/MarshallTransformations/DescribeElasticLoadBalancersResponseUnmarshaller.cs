    ...
    public class DescribeElasticLoadBalancersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ElasticLoadBalancer, ElasticLoadBalancerUnmarshaller>(ElasticLoadBalancerUnmarshaller.Instance);
                    response.ElasticLoadBalancers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
