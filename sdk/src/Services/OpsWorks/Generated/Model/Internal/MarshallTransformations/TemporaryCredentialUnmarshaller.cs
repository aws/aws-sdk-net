...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TemporaryCredentialUnmarshaller : IJsonUnmarshaller<TemporaryCredential, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TemporaryCredential Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ValidForInMinutes", targetDepth))
                {
                    ...
                    unmarshalledObject.ValidForInMinutes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
