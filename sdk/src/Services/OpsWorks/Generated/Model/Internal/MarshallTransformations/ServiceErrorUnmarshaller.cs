...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceErrorUnmarshaller : IJsonUnmarshaller<ServiceError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ServiceErrorId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
