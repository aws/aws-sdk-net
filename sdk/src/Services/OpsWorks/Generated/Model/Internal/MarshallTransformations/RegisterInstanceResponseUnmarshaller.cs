...
{
    /// <summary>
    /// Response Unmarshaller for RegisterInstance operation
    /// </summary>  
    public class RegisterInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterInstanceResponseUnmarshaller _instance = new RegisterInstanceResponseUnmarshaller();        

        internal static RegisterInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
