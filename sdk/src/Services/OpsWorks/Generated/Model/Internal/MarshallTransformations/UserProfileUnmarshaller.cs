...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UserProfileUnmarshaller : IJsonUnmarshaller<UserProfile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UserProfile Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AllowSelfManagement", targetDepth))
                {
                    ...
                    unmarshalledObject.AllowSelfManagement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
