    ...
    public class DescribeServiceErrorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceError, ServiceErrorUnmarshaller>(ServiceErrorUnmarshaller.Instance);
                    response.ServiceErrors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
