...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribePermissionsResponseUnmarshaller _instance = new DescribePermissionsResponseUnmarshaller();        

        internal static DescribePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
