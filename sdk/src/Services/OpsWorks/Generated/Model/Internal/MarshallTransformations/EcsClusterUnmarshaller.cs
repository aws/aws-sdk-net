...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EcsClusterUnmarshaller : IUnmarshaller<EcsCluster, XmlUnmarshallerContext>, IUnmarshaller<EcsCluster, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        EcsCluster IUnmarshaller<EcsCluster, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public EcsCluster Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EcsClusterName = unmarshaller.Unmarshall(context);
                    continue;
                }
