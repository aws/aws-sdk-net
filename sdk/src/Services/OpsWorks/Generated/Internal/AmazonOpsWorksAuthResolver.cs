...
namespace Amazon.OpsWorks.Internal
{
    ...
    public class AmazonOpsWorksAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOpsWorksAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for OpsWorks.
        /// </summary>
        public AmazonOpsWorksAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOpsWorksAuthSchemeParameters
            {
    ...
    public class AmazonOpsWorksAuthSchemeResolver : IAuthSchemeResolver<AmazonOpsWorksAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOpsWorksAuthSchemeParameters authParameters)
        {
