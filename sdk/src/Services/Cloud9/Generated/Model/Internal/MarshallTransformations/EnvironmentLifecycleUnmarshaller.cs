...
namespace Amazon.Cloud9.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnvironmentLifecycleUnmarshaller : IJsonUnmarshaller<EnvironmentLifecycle, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EnvironmentLifecycle Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("failureResource", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FailureResource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
