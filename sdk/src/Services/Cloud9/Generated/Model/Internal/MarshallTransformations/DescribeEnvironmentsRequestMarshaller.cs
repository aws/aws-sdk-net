...
namespace Amazon.Cloud9.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeEnvironmentsRequestMarshaller : IMarshaller<IRequest, DescribeEnvironmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeEnvironmentsRequest publicRequest)
        {
            ...
            {
                context.Writer.WritePropertyName("environmentIds");
                context.Writer.WriteStartArray();
                foreach(var publicRequestEnvironmentIdsListValue in publicRequest.EnvironmentIds)
                {
                        context.Writer.WriteStringValue(publicRequestEnvironmentIdsListValue);
                }
