...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEnvironmentStatus operation
    /// </summary>  
    public class DescribeEnvironmentStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEnvironmentStatusResponse response = new DescribeEnvironmentStatusResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonCloud9Exception(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static DescribeEnvironmentStatusResponseUnmarshaller _instance = new DescribeEnvironmentStatusResponseUnmarshaller();        

        internal static DescribeEnvironmentStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEnvironmentStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
