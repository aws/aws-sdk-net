...
namespace Amazon.CloudTrailData
{
    ...
    public partial class AmazonCloudTrailDataConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CloudTrail Data", "4.0.100.11");
        ...
        /// </summary>
        public static new string ServiceId => "CloudTrail Data";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "cloudtrail-data";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-08-11";
