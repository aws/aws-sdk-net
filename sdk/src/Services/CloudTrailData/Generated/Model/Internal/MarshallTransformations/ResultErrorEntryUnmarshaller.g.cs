...
namespace Amazon.CloudTrailData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResultErrorEntryUnmarshaller : IJsonUnmarshaller<ResultErrorEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ResultErrorEntry();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResultErrorEntryUnmarshaller Instance => _instance;
    }
}
