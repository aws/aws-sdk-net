...
namespace Amazon.CloudTrailData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutAuditEventsRequestMarshaller : IMarshaller<IRequest, PutAuditEventsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutAuditEventsRequestMarshaller _instance = new();

        internal static PutAuditEventsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutAuditEventsRequestMarshaller Instance => _instance;
    }
}
