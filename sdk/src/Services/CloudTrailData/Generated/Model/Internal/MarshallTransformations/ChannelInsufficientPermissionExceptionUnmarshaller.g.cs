...
{
    /// <summary>
    /// Exception Unmarshaller for ChannelInsufficientPermissionException
    /// </summary>
    public partial class ChannelInsufficientPermissionExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ChannelInsufficientPermissionException, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the exception from the service to the appropriate exception class
        /// </summary>
        public ChannelInsufficientPermissionException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelInsufficientPermissionExceptionUnmarshaller Instance => _instance;
    }
}
