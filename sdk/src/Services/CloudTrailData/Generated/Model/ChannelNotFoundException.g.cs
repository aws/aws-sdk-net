...
namespace Amazon.CloudTrailData.Model
{
    ...
    public partial class ChannelNotFoundException : AmazonCloudTrailDataException
    {
        ...
        /// Construct instance of ChannelNotFoundException
        /// </summary>
        public ChannelNotFoundException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ChannelNotFoundException
        /// </summary>
        public ChannelNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ChannelNotFoundException
        /// </summary>
        public ChannelNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
