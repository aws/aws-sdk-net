...
namespace Amazon.CloudTrailData.Model
{
    ...
    public partial class DuplicatedAuditEventIdException : AmazonCloudTrailDataException
    {
        ...
        public DuplicatedAuditEventIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicatedAuditEventIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
