...
namespace Amazon.CloudTrailData
{
    ...
    public partial class AmazonCloudTrailDataClient : AmazonServiceClient, IAmazonCloudTrailData
    {
        ...
        /// 
        /// </summary>
        public AmazonCloudTrailDataClient() : base(new AmazonCloudTrailDataConfig()) { }
        ...
        public AmazonCloudTrailDataClient(RegionEndpoint region) : base(new AmazonCloudTrailDataConfig { RegionEndpoint = region }) { }
        ...
        public AmazonCloudTrailDataClient(AmazonCloudTrailDataConfig config) : base(config) { }
