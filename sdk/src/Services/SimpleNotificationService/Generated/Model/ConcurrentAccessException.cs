...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    [Serializable]
    #endif
    public partial class ConcurrentAccessException : AmazonSimpleNotificationServiceException
    {
        ...
        public ConcurrentAccessException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConcurrentAccessException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
