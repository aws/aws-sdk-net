    ...
    public class ListPlatformApplicationsRequestMarshaller : IMarshaller<IRequest, ListPlatformApplicationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListPlatformApplicationsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ListPlatformApplicationsRequestMarshaller _instance = new ListPlatformApplicationsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPlatformApplicationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
