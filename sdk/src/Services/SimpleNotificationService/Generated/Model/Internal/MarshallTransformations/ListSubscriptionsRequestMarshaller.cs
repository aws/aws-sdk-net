    ...
    public class ListSubscriptionsRequestMarshaller : IMarshaller<IRequest, ListSubscriptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListSubscriptionsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ListSubscriptionsRequestMarshaller _instance = new ListSubscriptionsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSubscriptionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
