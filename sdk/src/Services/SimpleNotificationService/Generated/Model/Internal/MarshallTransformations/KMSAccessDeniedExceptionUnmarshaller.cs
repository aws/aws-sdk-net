...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    public class KMSAccessDeniedExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<KMSAccessDeniedException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public KMSAccessDeniedException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public KMSAccessDeniedException Unmarshall(XmlUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            KMSAccessDeniedException response = new KMSAccessDeniedException(errorResponse.Message, errorResponse.InnerException, 
