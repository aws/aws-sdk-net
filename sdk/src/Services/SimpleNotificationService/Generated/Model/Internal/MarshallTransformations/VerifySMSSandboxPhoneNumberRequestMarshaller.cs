...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class VerifySMSSandboxPhoneNumberRequestMarshaller : IMarshaller<IRequest, VerifySMSSandboxPhoneNumberRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((VerifySMSSandboxPhoneNumberRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(VerifySMSSandboxPhoneNumberRequest publicRequest)
        {
            ...
            {
                if(publicRequest.IsSetOneTimePassword())
                {
                    request.Parameters.Add("OneTimePassword", StringUtils.FromString(publicRequest.OneTimePassword));
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifySMSSandboxPhoneNumberRequestMarshaller Instance
        {
            get
            {
                return _instance;
