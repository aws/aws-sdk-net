...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    public class SMSSandboxPhoneNumberUnmarshaller : IXmlUnmarshaller<SMSSandboxPhoneNumber, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SMSSandboxPhoneNumber Unmarshall(XmlUnmarshallerContext context)
        {
            SMSSandboxPhoneNumber unmarshalledObject = new SMSSandboxPhoneNumber();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SMSSandboxPhoneNumberUnmarshaller Instance
        {
            get
            {
                return _instance;
