    ...
    public class GetPlatformApplicationAttributesRequestMarshaller : IMarshaller<IRequest, GetPlatformApplicationAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetPlatformApplicationAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static GetPlatformApplicationAttributesRequestMarshaller _instance = new GetPlatformApplicationAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPlatformApplicationAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
