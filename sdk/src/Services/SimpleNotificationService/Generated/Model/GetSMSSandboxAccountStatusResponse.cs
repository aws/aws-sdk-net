...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    /// </summary>
    public partial class GetSMSSandboxAccountStatusResponse : AmazonWebServiceResponse
    {
        private bool? _isInSandbox;
        ...
        // Check to see if IsInSandbox property is set
        internal bool IsSetIsInSandbox()
        {
            return this._isInSandbox.HasValue; 
        }
