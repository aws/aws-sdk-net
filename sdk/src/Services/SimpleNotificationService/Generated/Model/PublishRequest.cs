...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class PublishRequest : AmazonSimpleNotificationServiceRequest
    {
        ...
        ///  <ul> <li> 
        /// <para>
        /// With the exception of SMS, messages must be UTF-8 encoded strings. By default, a message
        /// can be at most 256 KiB in size (262,144 bytes, not 262,144 characters).
        /// </para>
        ///  
        /// <para>
        /// When you publish to a topic, the maximum size is determined by the topic's <c>MaximumMessageSize</c>
        ...
        /// returns an <c>InvalidParameter</c> error if the limit is exceeded.
        /// </para>
        ///  
        /// <para>
