...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    [Serializable]
    #endif
    public partial class KMSThrottlingException : AmazonSimpleNotificationServiceException
    {
        ...
        public KMSThrottlingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KMSThrottlingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
