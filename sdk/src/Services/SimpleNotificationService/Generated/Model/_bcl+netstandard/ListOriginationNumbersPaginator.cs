...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    /// </summary>
    internal sealed partial class ListOriginationNumbersPaginator : IPaginator<ListOriginationNumbersResponse>, IListOriginationNumbersPaginator
    {
        private readonly IAmazonSimpleNotificationService _client;
        private readonly ListOriginationNumbersRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListOriginationNumbersResponse> Responses => new PaginatedResponse<ListOriginationNumbersResponse>(this);
...
#if BCL
        IEnumerable<ListOriginationNumbersResponse> IPaginator<ListOriginationNumbersResponse>.Paginate()
        {
            ...
            ListOriginationNumbersResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListOriginationNumbers(_request);
        ...
        async IAsyncEnumerable<ListOriginationNumbersResponse> IPaginator<ListOriginationNumbersResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListOriginationNumbersAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
