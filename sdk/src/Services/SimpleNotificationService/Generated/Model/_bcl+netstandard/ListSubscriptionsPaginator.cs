...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    internal sealed partial class ListSubscriptionsPaginator : IPaginator<ListSubscriptionsResponse>, IListSubscriptionsPaginator
    {
        ...
        public IPaginatedEnumerable<Subscription> Subscriptions => 
            new PaginatedResultKeyResponse<ListSubscriptionsResponse, Subscription>(this, (i) => i.Subscriptions ?? new List<Subscription>());
        ...
        async IAsyncEnumerable<ListSubscriptionsResponse> IPaginator<ListSubscriptionsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
