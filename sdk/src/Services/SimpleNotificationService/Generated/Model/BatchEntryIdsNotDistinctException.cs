...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class BatchEntryIdsNotDistinctException : AmazonSimpleNotificationServiceException
    {
        ...
        public BatchEntryIdsNotDistinctException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public BatchEntryIdsNotDistinctException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
