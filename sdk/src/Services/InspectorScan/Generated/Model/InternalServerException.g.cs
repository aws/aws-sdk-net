...
namespace Amazon.InspectorScan.Model
{
    ...
    [Serializable]
#endif
    public partial class InternalServerException : AmazonInspectorScanException
    {
        /// <summary>
        ...
        public InternalServerExceptionReason Reason { get; set; }
        ...
        protected InternalServerException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.Reason = (InternalServerExceptionReason)info.GetValue("Reason", typeof(InternalServerExceptionReason));
