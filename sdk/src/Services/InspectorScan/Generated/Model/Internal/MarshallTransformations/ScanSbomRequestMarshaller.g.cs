...
namespace Amazon.InspectorScan.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScanSbomRequestMarshaller : IMarshaller<IRequest, ScanSbomRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ScanSbomRequestMarshaller _instance = new();

        internal static ScanSbomRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ScanSbomRequestMarshaller Instance => _instance;
    }
}
