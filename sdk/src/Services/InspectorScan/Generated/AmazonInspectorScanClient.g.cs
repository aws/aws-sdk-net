...
namespace Amazon.InspectorScan
{
    ...
    public partial class AmazonInspectorScanClient : AmazonServiceClient, IAmazonInspectorScan
    {
        ...
        /// 
        /// </summary>
        public AmazonInspectorScanClient() : base(new AmazonInspectorScanConfig()) { }
        ...
        public AmazonInspectorScanClient(RegionEndpoint region) : base(new AmazonInspectorScanConfig { RegionEndpoint = region }) { }
        ...
        public AmazonInspectorScanClient(AmazonInspectorScanConfig config) : base(config) { }
