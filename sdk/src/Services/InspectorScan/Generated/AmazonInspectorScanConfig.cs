...
namespace Amazon.InspectorScan
{
    ...
    public partial class AmazonInspectorScanConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Inspector Scan", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "Inspector Scan";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "inspector-scan";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2023-08-08";
