...
{
    /// <summary>
    /// Container for the parameters to the UpdateAppVersionResource operation. Updates the
    /// resource details in the Resilience Hub application. <note> <ul> <li> <para> This action
    /// has no effect outside Resilience Hub. </para> </li> <li> <para> This API updates the
    /// Resilience Hub application draft version. To use this resource for running resiliency
    /// assessments, you must publish the Resilience Hub application using the <c>PublishAppVersion</c>
    /// API. </para> </li> <li> <para> To update application version with new <c>physicalResourceID</c>,
    /// you must call <c>ResolveAppVersionResources</c> API. </para> </li> </ul> </note>
    /// </summary>
