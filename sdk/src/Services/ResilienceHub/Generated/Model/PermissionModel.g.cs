...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class PermissionModel
    {
        ...
        public List<string> CrossAccountRoleArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the CrossAccountRoleArns property is set.
        /// </summary>
        internal bool IsSetCrossAccountRoleArns() => this.CrossAccountRoleArns != null && (this.CrossAccountRoleArns.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the InvokerRoleName property is set.
        /// </summary>
        internal bool IsSetInvokerRoleName() => this.InvokerRoleName != null;
        ...
        public PermissionModelType Type { get; set; }
