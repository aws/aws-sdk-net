...
{
    /// <summary>
    /// Container for the parameters to the UpdateAppVersion operation. Updates the Resilience
    /// Hub application version. <note> <para> This API updates the Resilience Hub application
    /// draft version. To use this information for running resiliency assessments, you must
    /// publish the Resilience Hub application using the <c>PublishAppVersion</c> API. </para>
    /// </note>
    /// </summary>
