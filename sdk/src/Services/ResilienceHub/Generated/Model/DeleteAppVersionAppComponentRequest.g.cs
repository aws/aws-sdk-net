...
{
    /// <summary>
    /// Container for the parameters to the DeleteAppVersionAppComponent operation. Deletes
    /// an Application Component from the Resilience Hub application. <note> <ul> <li> <para>
    ...
    /// using the <c>PublishAppVersion</c> API. </para> </li> <li> <para> You will not be
    /// able to delete an Application Component if it has resources associated with it. </para>
    /// </li> </ul> </note>
    /// </summary>
