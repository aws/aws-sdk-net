...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class ListAppAssessmentsResponse : AmazonWebServiceResponse
    {
        ...
        public List<AppAssessmentSummary> AssessmentSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<AppAssessmentSummary>() : null;

        /// <summary>
        /// Checks to see if the AssessmentSummaries property is set.
        /// </summary>
        internal bool IsSetAssessmentSummaries() => this.AssessmentSummaries != null && (this.AssessmentSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
