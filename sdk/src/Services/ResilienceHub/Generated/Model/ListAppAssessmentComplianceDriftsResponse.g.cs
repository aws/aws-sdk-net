...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class ListAppAssessmentComplianceDriftsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ComplianceDrift> ComplianceDrifts { get; set; } = AWSConfigs.InitializeCollections ? new List<ComplianceDrift>() : null;

        /// <summary>
        /// Checks to see if the ComplianceDrifts property is set.
        /// </summary>
        internal bool IsSetComplianceDrifts() => this.ComplianceDrifts != null && (this.ComplianceDrifts.Count > 0 || !AWSConfigs.InitializeCollections);
