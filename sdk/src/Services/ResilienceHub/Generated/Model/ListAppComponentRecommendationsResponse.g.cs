...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class ListAppComponentRecommendationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ComponentRecommendation> ComponentRecommendations { get; set; } = AWSConfigs.InitializeCollections ? new List<ComponentRecommendation>() : null;

        /// <summary>
        /// Checks to see if the ComponentRecommendations property is set.
        /// </summary>
        internal bool IsSetComponentRecommendations() => this.ComponentRecommendations != null && (this.ComponentRecommendations.Count > 0 || !AWSConfigs.InitializeCollections);
