...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class ListAlarmRecommendationsResponse : AmazonWebServiceResponse
    {
        ...
        public List<AlarmRecommendation> AlarmRecommendations { get; set; } = AWSConfigs.InitializeCollections ? new List<AlarmRecommendation>() : null;

        /// <summary>
        /// Checks to see if the AlarmRecommendations property is set.
        /// </summary>
        internal bool IsSetAlarmRecommendations() => this.AlarmRecommendations != null && (this.AlarmRecommendations.Count > 0 || !AWSConfigs.InitializeCollections);
