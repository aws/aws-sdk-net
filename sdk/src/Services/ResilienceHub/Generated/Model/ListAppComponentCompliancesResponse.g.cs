...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class ListAppComponentCompliancesResponse : AmazonWebServiceResponse
    {
        ...
        public List<AppComponentCompliance> ComponentCompliances { get; set; } = AWSConfigs.InitializeCollections ? new List<AppComponentCompliance>() : null;

        /// <summary>
        /// Checks to see if the ComponentCompliances property is set.
        /// </summary>
        internal bool IsSetComponentCompliances() => this.ComponentCompliances != null && (this.ComponentCompliances.Count > 0 || !AWSConfigs.InitializeCollections);
