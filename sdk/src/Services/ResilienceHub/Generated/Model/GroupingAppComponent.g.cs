...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class GroupingAppComponent
    {
        ...
        public string AppComponentType { get; set; }

        /// <summary>
        /// Checks to see if the AppComponentType property is set.
        /// </summary>
        internal bool IsSetAppComponentType() => this.AppComponentType != null;
    }
}
