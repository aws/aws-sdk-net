...
{
    /// <summary>
    /// Container for the parameters to the ListAppInputSources operation. Lists all the input
    /// sources of the Resilience Hub application. For more information about the input sources
    /// supported by Resilience Hub, see <a href="https://docs.aws.amazon.com/resilience-hub/latest/userguide/discover-structure.html">Discover
