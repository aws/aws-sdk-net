...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class ListUnsupportedAppVersionResourcesResponse : AmazonWebServiceResponse
    {
        ...
        public List<UnsupportedResource> UnsupportedResources { get; set; } = AWSConfigs.InitializeCollections ? new List<UnsupportedResource>() : null;

        /// <summary>
        /// Checks to see if the UnsupportedResources property is set.
        /// </summary>
        internal bool IsSetUnsupportedResources() => this.UnsupportedResources != null && (this.UnsupportedResources.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
