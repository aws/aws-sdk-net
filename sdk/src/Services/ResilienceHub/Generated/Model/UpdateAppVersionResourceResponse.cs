...
{
    /// <summary>
    /// This is the response object from the UpdateAppVersionResource operation.
    /// </summary>
    public partial class UpdateAppVersionResourceResponse : AmazonWebServiceResponse
    {
        private string _appArn;
        private string _appVersion;
        private PhysicalResource _physicalResource;
        ...
        {
            get { return this._physicalResource; }
            set { this._physicalResource = value; }
        }

        // Check to see if PhysicalResource property is set
        internal bool IsSetPhysicalResource()
        {
            return this._physicalResource != null;
        }
