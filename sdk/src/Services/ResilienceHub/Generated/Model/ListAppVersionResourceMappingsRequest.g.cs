...
{
    /// <summary>
    /// Container for the parameters to the ListAppVersionResourceMappings operation. Lists
    /// how the resources in an application version are mapped/sourced from. Mappings can
    /// be physical resource identifiers, CloudFormation stacks, resource-groups, or an application
    /// registry app.
    /// </summary>
