...
{
    /// <summary>
    /// This is the response object from the DescribeDraftAppVersionResourcesImportStatus
    /// operation.
    /// </summary>
    public partial class DescribeDraftAppVersionResourcesImportStatusResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Checks to see if the StatusChangeTime property is set.
        /// </summary>
        internal bool IsSetStatusChangeTime() => this.StatusChangeTime.HasValue;
    }
}
