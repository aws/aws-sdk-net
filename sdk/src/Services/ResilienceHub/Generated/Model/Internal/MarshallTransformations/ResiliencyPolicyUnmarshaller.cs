...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResiliencyPolicyUnmarshaller : IUnmarshaller<ResiliencyPolicy, XmlUnmarshallerContext>, IUnmarshaller<ResiliencyPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ResiliencyPolicy IUnmarshaller<ResiliencyPolicy, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ResiliencyPolicy Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("dataLocationConstraint", targetDepth))
                {
                    ...
                    unmarshalledObject.DataLocationConstraint = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("estimatedCostTier", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EstimatedCostTier = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("policy", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, FailurePolicy, StringUnmarshaller, FailurePolicyUnmarshaller>(StringUnmarshaller.Instance, FailurePolicyUnmarshaller.Instance);
