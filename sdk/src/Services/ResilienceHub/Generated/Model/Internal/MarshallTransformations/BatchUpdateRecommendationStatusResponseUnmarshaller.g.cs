...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchUpdateRecommendationStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchUpdateRecommendationStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("successfulEntries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SuccessfulEntries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static BatchUpdateRecommendationStatusResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchUpdateRecommendationStatusResponseUnmarshaller Instance => _instance;
    }
}
