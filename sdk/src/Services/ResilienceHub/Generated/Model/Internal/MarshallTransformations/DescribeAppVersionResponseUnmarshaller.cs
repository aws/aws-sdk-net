...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAppVersion operation
    /// </summary>  
    public class DescribeAppVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAppVersionResponse response = new DescribeAppVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("additionalInfo", targetDepth, ref reader))
                {
                    ...
                    response.AdditionalInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAppVersionResponseUnmarshaller _instance = new DescribeAppVersionResponseUnmarshaller();        

        internal static DescribeAppVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAppVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
