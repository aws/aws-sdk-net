...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlarmRecommendationUnmarshaller : IJsonUnmarshaller<AlarmRecommendation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AlarmRecommendation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("appComponentNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AppComponentNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
