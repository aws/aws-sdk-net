...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateRecommendationTemplateRequestMarshaller : IMarshaller<IRequest, CreateRecommendationTemplateRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateRecommendationTemplateRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetRecommendationTypes())
            {
                ...
                {
                    context.Writer.WriteStringValue(publicRequestRecommendationTypesListValue);
                }
                context.Writer.WriteEndArray();
            }
        ...
        private static readonly CreateRecommendationTemplateRequestMarshaller _instance = new();

        internal static CreateRecommendationTemplateRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateRecommendationTemplateRequestMarshaller Instance => _instance;
    }
}
