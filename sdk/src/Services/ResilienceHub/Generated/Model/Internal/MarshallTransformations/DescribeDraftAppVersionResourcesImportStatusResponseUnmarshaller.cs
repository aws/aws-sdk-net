...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDraftAppVersionResourcesImportStatus operation
    /// </summary>  
    public class DescribeDraftAppVersionResourcesImportStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDraftAppVersionResourcesImportStatusResponse response = new DescribeDraftAppVersionResourcesImportStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("appVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AppVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("statusChangeTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.StatusChangeTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeDraftAppVersionResourcesImportStatusResponseUnmarshaller _instance = new DescribeDraftAppVersionResourcesImportStatusResponseUnmarshaller();        

        internal static DescribeDraftAppVersionResourcesImportStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDraftAppVersionResourcesImportStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
