...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnsupportedResourceUnmarshaller : IUnmarshaller<UnsupportedResource, XmlUnmarshallerContext>, IUnmarshaller<UnsupportedResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        UnsupportedResource IUnmarshaller<UnsupportedResource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public UnsupportedResource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UnsupportedResourceStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
