...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RecommendationTemplateUnmarshaller : IJsonUnmarshaller<RecommendationTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RecommendationTemplate();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("needsReplacements", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("recommendationTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                ...
                if (context.TestExpression("templatesLocation", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RecommendationTemplateUnmarshaller Instance => _instance;
    }
}
