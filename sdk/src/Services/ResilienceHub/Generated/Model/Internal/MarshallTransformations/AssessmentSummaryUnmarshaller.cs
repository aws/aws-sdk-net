    ...
    public class AssessmentSummaryUnmarshaller : IUnmarshaller<AssessmentSummary, XmlUnmarshallerContext>, IUnmarshaller<AssessmentSummary, JsonUnmarshallerContext>
    {
        ...
        public AssessmentSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AssessmentRiskRecommendation, AssessmentRiskRecommendationUnmarshaller>(AssessmentRiskRecommendationUnmarshaller.Instance);
                    unmarshalledObject.RiskRecommendations = unmarshaller.Unmarshall(context);
                    continue;
                }
