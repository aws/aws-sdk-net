...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppAssessmentUnmarshaller : IJsonUnmarshaller<AppAssessment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppAssessment();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resourceErrorsDetails", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppAssessmentUnmarshaller Instance => _instance;
    }
}
