...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppAssessmentSummaryUnmarshaller : IJsonUnmarshaller<AppAssessmentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppAssessmentSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("invoker", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("resiliencyScore", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppAssessmentSummaryUnmarshaller Instance => _instance;
    }
}
