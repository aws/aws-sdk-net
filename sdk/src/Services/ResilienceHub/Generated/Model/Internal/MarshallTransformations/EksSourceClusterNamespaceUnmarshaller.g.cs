...
namespace Amazon.ResilienceHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EksSourceClusterNamespaceUnmarshaller : IJsonUnmarshaller<EksSourceClusterNamespace, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public EksSourceClusterNamespace Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new EksSourceClusterNamespace();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EksSourceClusterNamespaceUnmarshaller Instance => _instance;
    }
}
