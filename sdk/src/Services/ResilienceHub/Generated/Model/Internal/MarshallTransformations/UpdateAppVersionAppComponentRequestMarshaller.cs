...
{
    /// <summary>
    /// UpdateAppVersionAppComponent Request Marshaller
    /// </summary>       
    public class UpdateAppVersionAppComponentRequestMarshaller : IMarshaller<IRequest, UpdateAppVersionAppComponentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAppVersionAppComponentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAppVersionAppComponentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/update-app-version-app-component";
#if !NETFRAMEWORK
        ...
        private static UpdateAppVersionAppComponentRequestMarshaller _instance = new UpdateAppVersionAppComponentRequestMarshaller();        

        internal static UpdateAppVersionAppComponentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAppVersionAppComponentRequestMarshaller Instance
        {
            get
            {
                return _instance;
