...
{
    /// <summary>
    /// Container for the parameters to the CreateResiliencyPolicy operation. Creates a resiliency
    /// policy for an application. <note> <para> Resilience Hub allows you to provide a value
    /// of zero for <c>rtoInSecs</c> and <c>rpoInSecs</c> of your resiliency policy. But,
    /// while assessing your application, the lowest possible assessment result is near zero.
    /// Hence, if you provide value zero for <c>rtoInSecs</c> and <c>rpoInSecs</c>, the estimated
    /// workload RTO and estimated workload RPO result will be near zero and the <b>Compliance
    /// status</b> for your application will be set to <b>Policy breached</b>. </para> </note>
    /// </summary>
