...
{
    /// <summary>
    /// Container for the parameters to the UpdateAppVersionAppComponent operation. Updates
    /// an existing Application Component in the Resilience Hub application. <note> <para>
    ...
    /// using the <c>PublishAppVersion</c> API. </para> </note>
    /// </summary>
