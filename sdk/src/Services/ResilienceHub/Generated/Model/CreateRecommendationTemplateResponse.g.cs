...
namespace Amazon.ResilienceHub.Model
{
    ...
    public partial class CreateRecommendationTemplateResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public RecommendationTemplate RecommendationTemplate { get; set; }

        /// <summary>
        /// Checks to see if the RecommendationTemplate property is set.
        /// </summary>
        internal bool IsSetRecommendationTemplate() => this.RecommendationTemplate != null;
    }
}
