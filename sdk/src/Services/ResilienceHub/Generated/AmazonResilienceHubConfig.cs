...
namespace Amazon.ResilienceHub
{
    ...
    public partial class AmazonResilienceHubConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("resiliencehub", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "resiliencehub";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "resiliencehub";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-04-30";
