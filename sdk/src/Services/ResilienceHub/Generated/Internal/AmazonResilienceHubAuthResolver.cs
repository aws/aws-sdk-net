...
namespace Amazon.ResilienceHub.Internal
{
    ...
    public class AmazonResilienceHubAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonResilienceHubAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ResilienceHub.
        /// </summary>
        public AmazonResilienceHubAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonResilienceHubAuthSchemeParameters
            {
    ...
    public class AmazonResilienceHubAuthSchemeResolver : IAuthSchemeResolver<AmazonResilienceHubAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonResilienceHubAuthSchemeParameters authParameters)
        {
