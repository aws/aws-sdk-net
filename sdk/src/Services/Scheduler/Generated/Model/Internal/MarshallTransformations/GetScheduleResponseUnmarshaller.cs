        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ActionAfterCompletion", targetDepth))
                {
                    ...
                    response.ActionAfterCompletion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("FlexibleTimeWindow", targetDepth))
                {
                    ...
                    response.FlexibleTimeWindow = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScheduleExpressionTimezone = unmarshaller.Unmarshall(context);
                    continue;
                }
