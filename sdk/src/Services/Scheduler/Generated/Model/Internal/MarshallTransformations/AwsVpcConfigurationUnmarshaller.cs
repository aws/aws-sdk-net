...
namespace Amazon.Scheduler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsVpcConfigurationUnmarshaller : IJsonUnmarshaller<AwsVpcConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsVpcConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AssignPublicIp", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AssignPublicIp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
