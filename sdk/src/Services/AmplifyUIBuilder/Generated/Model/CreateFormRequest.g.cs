...
{
    /// <summary>
    /// Container for the parameters to the CreateForm operation. Creates a new form for an
    /// Amplify app.
    /// </summary>
    public partial class CreateFormRequest : AmazonAmplifyUIBuilderRequest
    {
        ...
        /// <summary>
        /// Checks to see if the FormToCreate property is set.
        /// </summary>
        internal bool IsSetFormToCreate() => this.FormToCreate != null;
    }
}
