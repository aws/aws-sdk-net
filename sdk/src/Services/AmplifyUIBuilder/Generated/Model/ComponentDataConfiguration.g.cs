...
namespace Amazon.AmplifyUIBuilder.Model
{
    ...
    public partial class ComponentDataConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the Predicate property is set.
        /// </summary>
        internal bool IsSetPredicate() => this.Predicate != null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<SortProperty> Sort { get; set; } = AWSConfigs.InitializeCollections ? new List<SortProperty>() : null;
