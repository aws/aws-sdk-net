...
{
    /// <summary>
    /// Container for the parameters to the UpdateTheme operation. Updates an existing theme.
    /// </summary>
    public partial class UpdateThemeRequest : AmazonAmplifyUIBuilderRequest
    {
        ...
        /// <summary>
        /// Checks to see if the UpdatedTheme property is set.
        /// </summary>
        internal bool IsSetUpdatedTheme() => this.UpdatedTheme != null;
    }
}
