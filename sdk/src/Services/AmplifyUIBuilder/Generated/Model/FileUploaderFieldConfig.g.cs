...
namespace Amazon.AmplifyUIBuilder.Model
{
    ...
    public partial class FileUploaderFieldConfig
    {
        ...
        public List<string> AcceptedFileTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the AcceptedFileTypes property is set.
        /// </summary>
        internal bool IsSetAcceptedFileTypes() => this.AcceptedFileTypes != null && (this.AcceptedFileTypes.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the IsResumable property is set.
        /// </summary>
        internal bool IsSetIsResumable() => this.IsResumable.HasValue;
        ...
        /// <summary>
        /// Checks to see if the MaxFileCount property is set.
        /// </summary>
        internal bool IsSetMaxFileCount() => this.MaxFileCount.HasValue;
        ...
        /// </summary>
        internal bool IsSetMaxSize() => this.MaxSize.HasValue;
        ...
        /// <summary>
        /// Checks to see if the ShowThumbnails property is set.
        /// </summary>
        internal bool IsSetShowThumbnails() => this.ShowThumbnails.HasValue;
    }
}
