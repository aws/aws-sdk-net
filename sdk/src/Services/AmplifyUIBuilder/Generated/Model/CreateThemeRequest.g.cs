...
{
    /// <summary>
    /// Container for the parameters to the CreateTheme operation. Creates a theme to apply
    /// to the components in an Amplify app.
    /// </summary>
    public partial class CreateThemeRequest : AmazonAmplifyUIBuilderRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ThemeToCreate property is set.
        /// </summary>
        internal bool IsSetThemeToCreate() => this.ThemeToCreate != null;
    }
}
