...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PredicateUnmarshaller : IJsonUnmarshaller<Predicate, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public Predicate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new Predicate();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PredicateUnmarshaller Instance => _instance;
    }
}
