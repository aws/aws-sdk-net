...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodegenGenericDataModelMarshaller : IRequestMarshaller<CodegenGenericDataModel, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(CodegenGenericDataModel requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetIsJoinTable())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.IsJoinTable.Value);
            }
            ...
            if (requestObject.IsSetPrimaryKeys())
            {
                ...
                {
                    context.Writer.WriteStringValue(requestObjectPrimaryKeysListValue);
                }
