...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ComponentChildUnmarshaller : IJsonUnmarshaller<ComponentChild, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ComponentChild Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ComponentChild();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ComponentChildUnmarshaller Instance => _instance;
    }
}
