...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListFormsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListFormsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FormSummary, FormSummaryUnmarshaller>(FormSummaryUnmarshaller.Instance);
        ...
        internal static ListFormsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListFormsResponseUnmarshaller Instance => _instance;
    }
}
