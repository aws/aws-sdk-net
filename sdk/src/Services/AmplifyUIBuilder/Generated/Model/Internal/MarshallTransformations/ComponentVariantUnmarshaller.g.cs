...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ComponentVariantUnmarshaller : IJsonUnmarshaller<ComponentVariant, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ComponentVariant();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("variantValues", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ComponentVariantUnmarshaller Instance => _instance;
    }
}
