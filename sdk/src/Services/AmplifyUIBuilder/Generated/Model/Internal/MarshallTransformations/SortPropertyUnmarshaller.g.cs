...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SortPropertyUnmarshaller : IJsonUnmarshaller<SortProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SortProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SortProperty();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SortPropertyUnmarshaller Instance => _instance;
    }
}
