...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodegenJobSummaryUnmarshaller : IJsonUnmarshaller<CodegenJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CodegenJobSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CodegenJobSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CodegenJobSummaryUnmarshaller Instance => _instance;
    }
}
