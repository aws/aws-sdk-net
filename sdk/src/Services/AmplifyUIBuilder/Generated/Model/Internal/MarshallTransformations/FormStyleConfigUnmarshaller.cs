...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FormStyleConfigUnmarshaller : IJsonUnmarshaller<FormStyleConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FormStyleConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("tokenReference", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TokenReference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
