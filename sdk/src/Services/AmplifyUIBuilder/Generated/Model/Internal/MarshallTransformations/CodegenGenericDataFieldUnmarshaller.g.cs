...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CodegenGenericDataFieldUnmarshaller : IJsonUnmarshaller<CodegenGenericDataField, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public CodegenGenericDataField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new CodegenGenericDataField();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CodegenGenericDataFieldUnmarshaller Instance => _instance;
    }
}
