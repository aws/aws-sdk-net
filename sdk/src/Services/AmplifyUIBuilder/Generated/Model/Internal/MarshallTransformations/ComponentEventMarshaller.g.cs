...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ComponentEventMarshaller : IRequestMarshaller<ComponentEvent, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ComponentEvent requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetBindingEvent())
            {
                ...
                context.Writer.WriteStringValue(requestObject.BindingEvent);
            }
