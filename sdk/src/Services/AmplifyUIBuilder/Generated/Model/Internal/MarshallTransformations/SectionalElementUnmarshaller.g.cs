...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SectionalElementUnmarshaller : IJsonUnmarshaller<SectionalElement, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SectionalElement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SectionalElement();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SectionalElementUnmarshaller Instance => _instance;
    }
}
