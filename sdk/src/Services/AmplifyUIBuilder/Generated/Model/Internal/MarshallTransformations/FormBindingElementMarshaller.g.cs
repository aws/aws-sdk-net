...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FormBindingElementMarshaller : IRequestMarshaller<FormBindingElement, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(FormBindingElement requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetElement())
            {
                ...
                context.Writer.WriteStringValue(requestObject.Element);
            }
