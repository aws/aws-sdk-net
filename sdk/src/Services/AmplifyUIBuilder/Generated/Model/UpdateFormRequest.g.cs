...
{
    /// <summary>
    /// Container for the parameters to the UpdateForm operation. Updates an existing form.
    /// </summary>
    public partial class UpdateFormRequest : AmazonAmplifyUIBuilderRequest
    {
        ...
        /// <summary>
        /// Checks to see if the UpdatedForm property is set.
        /// </summary>
        internal bool IsSetUpdatedForm() => this.UpdatedForm != null;
    }
}
