...
namespace Amazon.AmplifyUIBuilder.Model
{
    ...
    public partial class ComponentVariant
    {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public Dictionary<string, string> VariantValues { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the VariantValues property is set.
        /// </summary>
        internal bool IsSetVariantValues() => this.VariantValues != null && (this.VariantValues.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
