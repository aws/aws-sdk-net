...
{
    /// <summary>
    /// Container for the parameters to the RefreshToken operation. <note> <para> This is
    /// for internal use. </para> </note> <para> Amplify uses this action to refresh a previously
    /// issued access token that might have expired. </para>
    /// </summary>
    public partial class RefreshTokenRequest : AmazonAmplifyUIBuilderRequest
    {
        ...
        /// <summary>
        /// Checks to see if the RefreshTokenBody property is set.
        /// </summary>
        internal bool IsSetRefreshTokenBody() => this.RefreshTokenBody != null;
    }
}
