...
namespace Amazon.AmplifyUIBuilder.Model
{
    ...
    public partial class ResourceConflictException : AmazonAmplifyUIBuilderException
    {
        ...
        /// Construct instance of ResourceConflictException
        /// </summary>
        public ResourceConflictException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ResourceConflictException
        /// </summary>
        public ResourceConflictException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
