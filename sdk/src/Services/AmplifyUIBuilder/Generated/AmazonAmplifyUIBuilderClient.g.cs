...
namespace Amazon.AmplifyUIBuilder
{
    ...
    public partial class AmazonAmplifyUIBuilderClient : AmazonServiceClient, IAmazonAmplifyUIBuilder
    {
        ...
        /// 
        /// </summary>
        public AmazonAmplifyUIBuilderClient() : base(new AmazonAmplifyUIBuilderConfig()) { }
        ...
        public AmazonAmplifyUIBuilderClient(RegionEndpoint region) : base(new AmazonAmplifyUIBuilderConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAmplifyUIBuilderClient(AmazonAmplifyUIBuilderConfig config) : base(config) { }
