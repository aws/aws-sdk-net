...
namespace Amazon.DirectoryServiceData
{
    ...
    public partial class AmazonDirectoryServiceDataClient : AmazonServiceClient, IAmazonDirectoryServiceData
    {
        ...
        /// 
        /// </summary>
        public AmazonDirectoryServiceDataClient() : base(new AmazonDirectoryServiceDataConfig()) { }
        ...
        public AmazonDirectoryServiceDataClient(RegionEndpoint region) : base(new AmazonDirectoryServiceDataConfig { RegionEndpoint = region }) { }
        ...
        public AmazonDirectoryServiceDataClient(AmazonDirectoryServiceDataConfig config) : base(config) { }
