...
namespace Amazon.DirectoryServiceData.Model
{
    ...
    internal sealed partial class ListUsersPaginator : IPaginator<ListUsersResponse>, IListUsersPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<UserSummary> Users =>
            new PaginatedResultKeyResponse<ListUsersResponse, UserSummary>(this, (i) => i.Users ?? new List<UserSummary>());

        internal ListUsersPaginator(IAmazonDirectoryServiceData client, ListUsersRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListUsersResponse> IPaginator<ListUsersResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
