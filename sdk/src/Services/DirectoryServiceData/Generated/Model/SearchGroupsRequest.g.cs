...
{
    /// <summary>
    /// Container for the parameters to the SearchGroups operation. Searches the specified
    /// directory for a group. You can find groups that match the <c>SearchString</c> parameter
    ...
    /// and response parameters. If more results are available, the <c>SearchGroups.NextToken</c>
    ...
    /// </summary>
    public partial class SearchGroupsRequest : AmazonDirectoryServiceDataRequest
    {
        /// <summary>
