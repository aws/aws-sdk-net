...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchUsersRequestMarshaller : IMarshaller<IRequest, SearchUsersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(SearchUsersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/Users/SearchUsers";
#if !NETFRAMEWORK
        ...
        private static readonly SearchUsersRequestMarshaller _instance = new();

        internal static SearchUsersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchUsersRequestMarshaller Instance => _instance;
    }
}
