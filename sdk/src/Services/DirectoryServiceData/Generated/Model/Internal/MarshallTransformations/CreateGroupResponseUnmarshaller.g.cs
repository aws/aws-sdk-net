...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateGroupResponse();
        ...
        private static CreateGroupResponseUnmarshaller _instance = new CreateGroupResponseUnmarshaller();

        internal static CreateGroupResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateGroupResponseUnmarshaller Instance => _instance;
    }
}
