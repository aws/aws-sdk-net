...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RemoveGroupMemberRequestMarshaller : IMarshaller<IRequest, RemoveGroupMemberRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RemoveGroupMemberRequestMarshaller _instance = new();

        internal static RemoveGroupMemberRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RemoveGroupMemberRequestMarshaller Instance => _instance;
    }
}
