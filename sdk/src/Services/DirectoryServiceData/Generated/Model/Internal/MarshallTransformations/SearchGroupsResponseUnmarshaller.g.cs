...
{
    /// <summary>
    /// Response Unmarshaller for SearchGroups operation.
    /// </summary>
    public partial class SearchGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchGroupsResponse();
        ...
        private static SearchGroupsResponseUnmarshaller _instance = new SearchGroupsResponseUnmarshaller();

        internal static SearchGroupsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchGroupsResponseUnmarshaller Instance => _instance;
    }
}
