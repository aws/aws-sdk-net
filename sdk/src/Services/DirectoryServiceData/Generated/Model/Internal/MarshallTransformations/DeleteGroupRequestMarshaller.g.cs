...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteGroupRequestMarshaller : IMarshaller<IRequest, DeleteGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteGroupRequestMarshaller _instance = new();

        internal static DeleteGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteGroupRequestMarshaller Instance => _instance;
    }
}
