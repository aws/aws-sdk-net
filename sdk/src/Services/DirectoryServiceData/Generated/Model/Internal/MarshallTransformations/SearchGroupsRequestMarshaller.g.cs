...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchGroupsRequestMarshaller : IMarshaller<IRequest, SearchGroupsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SearchGroupsRequestMarshaller _instance = new();

        internal static SearchGroupsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchGroupsRequestMarshaller Instance => _instance;
    }
}
