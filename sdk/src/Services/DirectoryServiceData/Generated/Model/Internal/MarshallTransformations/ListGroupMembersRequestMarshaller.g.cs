...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListGroupMembersRequestMarshaller : IMarshaller<IRequest, ListGroupMembersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListGroupMembersRequestMarshaller _instance = new();

        internal static ListGroupMembersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListGroupMembersRequestMarshaller Instance => _instance;
    }
}
