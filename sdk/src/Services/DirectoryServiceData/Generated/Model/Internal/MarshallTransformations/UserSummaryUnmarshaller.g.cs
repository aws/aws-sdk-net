...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UserSummaryUnmarshaller : IJsonUnmarshaller<UserSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UserSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static UserSummaryUnmarshaller Instance => _instance;
    }
}
