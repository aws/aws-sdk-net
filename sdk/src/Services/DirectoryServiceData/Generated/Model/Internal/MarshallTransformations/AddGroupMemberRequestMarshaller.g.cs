...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddGroupMemberRequestMarshaller : IMarshaller<IRequest, AddGroupMemberRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AddGroupMemberRequestMarshaller _instance = new();

        internal static AddGroupMemberRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AddGroupMemberRequestMarshaller Instance => _instance;
    }
}
