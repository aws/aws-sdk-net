...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AttributeValueUnmarshaller : IJsonUnmarshaller<AttributeValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AttributeValue();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AttributeValueUnmarshaller Instance => _instance;
    }
}
