...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeGroupRequestMarshaller : IMarshaller<IRequest, DescribeGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DescribeGroupRequest publicRequest)
        {
            ...
            request.ResourcePath = "/Groups/DescribeGroup";
#if !NETFRAMEWORK
        ...
        private static readonly DescribeGroupRequestMarshaller _instance = new();

        internal static DescribeGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeGroupRequestMarshaller Instance => _instance;
    }
}
