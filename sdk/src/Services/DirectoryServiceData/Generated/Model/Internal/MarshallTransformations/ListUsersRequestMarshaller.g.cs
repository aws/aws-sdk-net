...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListUsersRequestMarshaller : IMarshaller<IRequest, ListUsersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListUsersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/Users/ListUsers";
#if !NETFRAMEWORK
        ...
        private static readonly ListUsersRequestMarshaller _instance = new();

        internal static ListUsersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListUsersRequestMarshaller Instance => _instance;
    }
}
