...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisableUserRequestMarshaller : IMarshaller<IRequest, DisableUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DisableUserRequest publicRequest)
        {
            ...
            request.ResourcePath = "/Users/DisableUser";
#if !NETFRAMEWORK
        ...
        private static readonly DisableUserRequestMarshaller _instance = new();

        internal static DisableUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisableUserRequestMarshaller Instance => _instance;
    }
}
