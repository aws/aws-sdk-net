...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MemberUnmarshaller : IJsonUnmarshaller<Member, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Member();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MemberUnmarshaller Instance => _instance;
    }
}
