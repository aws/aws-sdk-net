...
namespace Amazon.DirectoryServiceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListGroupsForMemberRequestMarshaller : IMarshaller<IRequest, ListGroupsForMemberRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListGroupsForMemberRequestMarshaller _instance = new();

        internal static ListGroupsForMemberRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListGroupsForMemberRequestMarshaller Instance => _instance;
    }
}
