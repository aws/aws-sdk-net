...
{
    /// <summary>
    /// Container for the parameters to the ListGroups operation. Returns group information
    ...
    /// the <c>ListGroups.NextToken</c> member contains a token that you pass in the next
    /// call to <c>ListGroups</c>. This retrieves the next set of items. </para> <para> You
    /// can also specify a maximum number of return results with the <c>MaxResults</c> parameter.
    /// </para>
    /// </summary>
