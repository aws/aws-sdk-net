...
namespace Amazon.DirectoryServiceData
{
    ...
    public partial class AmazonDirectoryServiceDataConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Directory Service Data", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Directory Service Data";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "ds-data";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2023-05-31";
