...
{
    /// <summary>
    /// Container for the parameters to the ListSyslogConfigurations operation.
    /// Returns a list of syslog configurations. You can optionally filter the results by
    /// log group or VPC endpoint.
    /// </summary>
    public partial class ListSyslogConfigurationsRequest : AmazonCloudWatchLogsRequest
    {
