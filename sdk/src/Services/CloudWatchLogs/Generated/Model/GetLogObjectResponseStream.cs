...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    public sealed class GetLogObjectResponseStream : EnumerableEventStream<IEventStreamEvent, CloudWatchLogsEventStreamException>
    {
        /// <summary>
        ...
        new Dictionary<string,Func<IEventStreamMessage,IEventStreamEvent>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"Fields", payload => new FieldsDataUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))},
        };
        /// <summary>
        ...
        {
            { "InternalStreamingException", payload => new CloudWatchLogsEventStreamException(Encoding.UTF8.GetString(payload.Payload), new InternalStreamingExceptionUnmarshaller().Unmarshall(EventStreamUtils.ConvertMessageToJsonContext(payload))) },
        };
