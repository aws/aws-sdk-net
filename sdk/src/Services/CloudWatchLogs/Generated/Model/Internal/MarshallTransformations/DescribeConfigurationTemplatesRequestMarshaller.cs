...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeConfigurationTemplatesRequestMarshaller : IMarshaller<IRequest, DescribeConfigurationTemplatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeConfigurationTemplatesRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/DescribeConfigurationTemplates";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("deliveryDestinationTypes");
                    context.Writer.WriteStartArray(publicRequest.DeliveryDestinationTypes.Count);
                    foreach(var publicRequestDeliveryDestinationTypesListValue in publicRequest.DeliveryDestinationTypes)
                    {
                            context.Writer.WriteTextString(publicRequestDeliveryDestinationTypesListValue);
                    }
                ...
                {
                    context.Writer.WriteTextString("logTypes");
                    context.Writer.WriteStartArray(publicRequest.LogTypes.Count);
                    foreach(var publicRequestLogTypesListValue in publicRequest.LogTypes)
                    {
                            context.Writer.WriteTextString(publicRequestLogTypesListValue);
                    }
                    context.Writer.WriteEndArray();
                }
                ...
                {
                    context.Writer.WriteTextString("resourceTypes");
                    context.Writer.WriteStartArray(publicRequest.ResourceTypes.Count);
                    foreach(var publicRequestResourceTypesListValue in publicRequest.ResourceTypes)
                    {
                            context.Writer.WriteTextString(publicRequestResourceTypesListValue);
                    }
                    context.Writer.WriteEndArray();
                }
                if (publicRequest.IsSetService())
                {
                    context.Writer.WriteTextString("service");
                    context.Writer.WriteTextString(publicRequest.Service);
                }
                writer.WriteEndMap();
