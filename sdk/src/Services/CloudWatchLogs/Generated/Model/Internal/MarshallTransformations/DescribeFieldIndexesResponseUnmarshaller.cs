...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeFieldIndexesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeFieldIndexes");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "fieldIndexes":
                        {
                            context.AddPathSegment("FieldIndexes");
                            var unmarshaller = new CborListUnmarshaller<FieldIndex, FieldIndexUnmarshaller>(FieldIndexUnmarshaller.Instance);
                            response.FieldIndexes = unmarshaller.Unmarshall(context);
