...
{
    /// <summary>
    /// Response Unmarshaller for GetLookupTable operation
    /// </summary>  
    public class GetLookupTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLookupTableResponse response = new GetLookupTableResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LookupTableName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("tableBody", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TableBody = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetLookupTableResponseUnmarshaller _instance = new GetLookupTableResponseUnmarshaller();        

        internal static GetLookupTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLookupTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
