...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDeliveryDestinationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeDeliveryDestinations");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "deliveryDestinations":
                        {
                            context.AddPathSegment("DeliveryDestinations");
                            var unmarshaller = new CborListUnmarshaller<DeliveryDestination, DeliveryDestinationUnmarshaller>(DeliveryDestinationUnmarshaller.Instance);
