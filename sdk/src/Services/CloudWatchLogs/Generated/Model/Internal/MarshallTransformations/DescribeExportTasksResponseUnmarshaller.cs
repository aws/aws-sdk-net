...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeExportTasksResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeExportTasks");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "exportTasks":
                        {
                            context.AddPathSegment("ExportTasks");
                            var unmarshaller = new CborListUnmarshaller<ExportTask, ExportTaskUnmarshaller>(ExportTaskUnmarshaller.Instance);
