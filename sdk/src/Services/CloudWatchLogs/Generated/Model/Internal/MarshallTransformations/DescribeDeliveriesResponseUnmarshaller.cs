...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDeliveriesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeDeliveries");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "deliveries":
                        {
                            context.AddPathSegment("Deliveries");
                            var unmarshaller = new CborListUnmarshaller<Delivery, DeliveryUnmarshaller>(DeliveryUnmarshaller.Instance);
                            response.Deliveries = unmarshaller.Unmarshall(context);
