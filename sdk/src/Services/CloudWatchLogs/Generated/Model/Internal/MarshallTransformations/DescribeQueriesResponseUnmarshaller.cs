...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeQueriesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeQueriesResponse response = new DescribeQueriesResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeQueries");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "queries":
                        {
                            context.AddPathSegment("Queries");
                            var unmarshaller = new CborListUnmarshaller<QueryInfo, QueryInfoUnmarshaller>(QueryInfoUnmarshaller.Instance);
                            response.Queries = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static DescribeQueriesResponseUnmarshaller _instance = new DescribeQueriesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQueriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
