...
{
    /// <summary>
    /// Response Unmarshaller for TestTransformer operation
    /// </summary>  
    public class TestTransformerResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestTransformerResponse response = new TestTransformerResponse();
            var reader = context.Reader;
            context.AddPathSegment("TestTransformer");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "transformedLogs":
                        {
                            context.AddPathSegment("TransformedLogs");
                            var unmarshaller = new CborListUnmarshaller<TransformedLogRecord, TransformedLogRecordUnmarshaller>(TransformedLogRecordUnmarshaller.Instance);
                            response.TransformedLogs = unmarshaller.Unmarshall(context);
        ...
        private static TestTransformerResponseUnmarshaller _instance = new TestTransformerResponseUnmarshaller();        

        internal static TestTransformerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestTransformerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
