...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDeliverySourceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeliverySourceResponse response = new GetDeliverySourceResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetDeliverySource");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "deliverySource":
                        {
                            context.AddPathSegment("DeliverySource");
                            var unmarshaller = DeliverySourceUnmarshaller.Instance;
                            response.DeliverySource = unmarshaller.Unmarshall(context);
        ...
        private static GetDeliverySourceResponseUnmarshaller _instance = new GetDeliverySourceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeliverySourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
