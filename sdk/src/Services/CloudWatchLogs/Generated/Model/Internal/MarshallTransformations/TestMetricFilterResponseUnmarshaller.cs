...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestMetricFilterResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("TestMetricFilter");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "matches":
                        {
                            context.AddPathSegment("Matches");
                            var unmarshaller = new CborListUnmarshaller<MetricFilterMatchRecord, MetricFilterMatchRecordUnmarshaller>(MetricFilterMatchRecordUnmarshaller.Instance);
