...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeSubscriptionFiltersResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSubscriptionFiltersResponse response = new DescribeSubscriptionFiltersResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeSubscriptionFilters");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "subscriptionFilters":
                        {
                            context.AddPathSegment("SubscriptionFilters");
                            var unmarshaller = new CborListUnmarshaller<SubscriptionFilter, SubscriptionFilterUnmarshaller>(SubscriptionFilterUnmarshaller.Instance);
                            response.SubscriptionFilters = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static DescribeSubscriptionFiltersResponseUnmarshaller _instance = new DescribeSubscriptionFiltersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSubscriptionFiltersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
