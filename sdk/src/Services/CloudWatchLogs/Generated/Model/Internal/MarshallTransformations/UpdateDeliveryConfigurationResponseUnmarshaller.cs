...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDeliveryConfiguration operation
    /// </summary>  
    public class UpdateDeliveryConfigurationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDeliveryConfigurationResponse response = new UpdateDeliveryConfigurationResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateDeliveryConfiguration");
        ...
        private static UpdateDeliveryConfigurationResponseUnmarshaller _instance = new UpdateDeliveryConfigurationResponseUnmarshaller();        

        internal static UpdateDeliveryConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDeliveryConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
