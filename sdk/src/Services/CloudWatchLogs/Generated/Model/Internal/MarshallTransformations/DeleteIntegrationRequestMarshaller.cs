...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteIntegrationRequestMarshaller : IMarshaller<IRequest, DeleteIntegrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteIntegrationRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/DeleteIntegration";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("force");
                    context.Writer.WriteBoolean(publicRequest.Force.Value);
                }
                if (publicRequest.IsSetIntegrationName())
                {
                    context.Writer.WriteTextString("integrationName");
                    context.Writer.WriteTextString(publicRequest.IntegrationName);
                }
                writer.WriteEndMap();
