...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLogStreamsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeLogStreams");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "logStreams":
                        {
                            context.AddPathSegment("LogStreams");
                            var unmarshaller = new CborListUnmarshaller<LogStream, LogStreamUnmarshaller>(LogStreamUnmarshaller.Instance);
