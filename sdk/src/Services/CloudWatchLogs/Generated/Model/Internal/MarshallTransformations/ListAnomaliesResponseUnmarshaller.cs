...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAnomaliesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAnomaliesResponse response = new ListAnomaliesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAnomalies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "anomalies":
                        {
                            context.AddPathSegment("Anomalies");
                            var unmarshaller = new CborListUnmarshaller<Anomaly, AnomalyUnmarshaller>(AnomalyUnmarshaller.Instance);
        ...
        private static ListAnomaliesResponseUnmarshaller _instance = new ListAnomaliesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAnomaliesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
