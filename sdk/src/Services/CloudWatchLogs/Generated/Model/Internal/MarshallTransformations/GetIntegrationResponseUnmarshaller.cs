            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "integrationDetails":
                        {
                            context.AddPathSegment("IntegrationDetails");
                            var unmarshaller = IntegrationDetailsUnmarshaller.Instance;
                            response.IntegrationDetails = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "integrationName":
                        {
                            context.AddPathSegment("IntegrationName");
                    ...
                    case "integrationStatus":
                        {
                            context.AddPathSegment("IntegrationStatus");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.IntegrationStatus = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
