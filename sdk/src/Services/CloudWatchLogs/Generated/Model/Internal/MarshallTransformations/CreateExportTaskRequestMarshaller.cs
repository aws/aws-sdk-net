...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class CreateExportTaskRequestMarshaller : IMarshaller<IRequest, CreateExportTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateExportTaskRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/CreateExportTask";
            ...
            try
            {
                ...
                if (publicRequest.IsSetDestination())
                {
                    ...
                    context.Writer.WriteTextString(publicRequest.Destination);
                }
                if (publicRequest.IsSetDestinationPrefix())
                {
                    context.Writer.WriteTextString("destinationPrefix");
                    context.Writer.WriteTextString(publicRequest.DestinationPrefix);
                }
                if (publicRequest.IsSetFrom())
                {
                    context.Writer.WriteTextString("from");
                    context.Writer.WriteInt64(publicRequest.From.Value);
                }
                ...
                {
                    context.Writer.WriteTextString("taskName");
                    context.Writer.WriteTextString(publicRequest.TaskName);
                }
                if (publicRequest.IsSetTo())
                {
                    context.Writer.WriteTextString("to");
                    context.Writer.WriteInt64(publicRequest.To.Value);
                }
                writer.WriteEndMap();
