...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutAccountPolicyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("PutAccountPolicy");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "accountPolicy":
                        {
                            context.AddPathSegment("AccountPolicy");
                            var unmarshaller = AccountPolicyUnmarshaller.Instance;
                            response.AccountPolicy = unmarshaller.Unmarshall(context);
