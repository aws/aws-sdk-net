...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAccountPoliciesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAccountPolicies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "accountPolicies":
                        {
                            context.AddPathSegment("AccountPolicies");
                            var unmarshaller = new CborListUnmarshaller<AccountPolicy, AccountPolicyUnmarshaller>(AccountPolicyUnmarshaller.Instance);
                            response.AccountPolicies = unmarshaller.Unmarshall(context);
