...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutDeliveryDestinationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDeliveryDestinationResponse response = new PutDeliveryDestinationResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutDeliveryDestination");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "deliveryDestination":
                        {
                            context.AddPathSegment("DeliveryDestination");
                            var unmarshaller = DeliveryDestinationUnmarshaller.Instance;
                            response.DeliveryDestination = unmarshaller.Unmarshall(context);
        ...
        private static PutDeliveryDestinationResponseUnmarshaller _instance = new PutDeliveryDestinationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDeliveryDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
