...
{
    /// <summary>
    /// Response Unmarshaller for GetScheduledQuery operation
    /// </summary>  
    public class GetScheduledQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetScheduledQueryResponse response = new GetScheduledQueryResponse();
        ...
        private static GetScheduledQueryResponseUnmarshaller _instance = new GetScheduledQueryResponseUnmarshaller();        

        internal static GetScheduledQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetScheduledQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
