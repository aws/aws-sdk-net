...
{
    /// <summary>
    /// Response Unmarshaller for CreateImportTask operation
    /// </summary>  
    public class CreateImportTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateImportTaskResponse response = new CreateImportTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("importDestinationArn", targetDepth))
                {
                    ...
                    response.ImportDestinationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateImportTaskResponseUnmarshaller _instance = new CreateImportTaskResponseUnmarshaller();        

        internal static CreateImportTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImportTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
