...
{
    /// <summary>
    /// Response Unmarshaller for GetLogFields operation
    /// </summary>  
    public class GetLogFieldsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLogFieldsResponse response = new GetLogFieldsResponse();
            ...
            {
                if (context.TestExpression("logFields", targetDepth, ref reader))
                {
                    ...
                    response.LogFields = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetLogFieldsResponseUnmarshaller _instance = new GetLogFieldsResponseUnmarshaller();        

        internal static GetLogFieldsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLogFieldsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
