    ...
    public class UpdateScheduledQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastExecutionStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastTriggeredTime", targetDepth))
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    response.LastTriggeredTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    response.ScheduleEndTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    response.ScheduleStartTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("startTimeOffset", targetDepth))
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    response.StartTimeOffset = unmarshaller.Unmarshall(context);
                    continue;
                }
