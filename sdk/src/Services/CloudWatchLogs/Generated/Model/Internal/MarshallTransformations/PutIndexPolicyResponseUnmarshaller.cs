...
{
    /// <summary>
    /// Response Unmarshaller for PutIndexPolicy operation
    /// </summary>  
    public class PutIndexPolicyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutIndexPolicyResponse response = new PutIndexPolicyResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutIndexPolicy");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "indexPolicy":
                        {
                            context.AddPathSegment("IndexPolicy");
                            var unmarshaller = IndexPolicyUnmarshaller.Instance;
                            response.IndexPolicy = unmarshaller.Unmarshall(context);
        ...
        private static PutIndexPolicyResponseUnmarshaller _instance = new PutIndexPolicyResponseUnmarshaller();        

        internal static PutIndexPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutIndexPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
