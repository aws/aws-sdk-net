...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMetricFiltersResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeMetricFilters");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "metricFilters":
                        {
                            context.AddPathSegment("MetricFilters");
                            var unmarshaller = new CborListUnmarshaller<MetricFilter, MetricFilterUnmarshaller>(MetricFilterUnmarshaller.Instance);
