...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLookupTable operation
    /// </summary>  
    public class UpdateLookupTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLookupTableResponse response = new UpdateLookupTableResponse();
        ...
        private static UpdateLookupTableResponseUnmarshaller _instance = new UpdateLookupTableResponseUnmarshaller();        

        internal static UpdateLookupTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLookupTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
