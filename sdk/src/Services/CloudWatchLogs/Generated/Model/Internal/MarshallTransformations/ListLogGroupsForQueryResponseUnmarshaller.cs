...
{
    /// <summary>
    /// Response Unmarshaller for ListLogGroupsForQuery operation
    /// </summary>  
    public class ListLogGroupsForQueryResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLogGroupsForQueryResponse response = new ListLogGroupsForQueryResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListLogGroupsForQuery");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "logGroupIdentifiers":
                        {
                            context.AddPathSegment("LogGroupIdentifiers");
                            var unmarshaller = new CborListUnmarshaller<string, CborStringUnmarshaller>(CborStringUnmarshaller.Instance);
                            response.LogGroupIdentifiers = unmarshaller.Unmarshall(context);
        ...
        private static ListLogGroupsForQueryResponseUnmarshaller _instance = new ListLogGroupsForQueryResponseUnmarshaller();        

        internal static ListLogGroupsForQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLogGroupsForQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
