...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDeliveryDestinationPolicyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeliveryDestinationPolicyResponse response = new GetDeliveryDestinationPolicyResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetDeliveryDestinationPolicy");
            reader.ReadStartMap();
        ...
        private static GetDeliveryDestinationPolicyResponseUnmarshaller _instance = new GetDeliveryDestinationPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeliveryDestinationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
