...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateAnomalyRequestMarshaller : IMarshaller<IRequest, UpdateAnomalyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateAnomalyRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/UpdateAnomaly";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("anomalyId");
                    context.Writer.WriteTextString(publicRequest.AnomalyId);
                }
                if (publicRequest.IsSetBaseline())
                {
                    context.Writer.WriteTextString("baseline");
                    context.Writer.WriteBoolean(publicRequest.Baseline.Value);
                }
                if (publicRequest.IsSetPatternId())
                {
                    context.Writer.WriteTextString("patternId");
                    context.Writer.WriteTextString(publicRequest.PatternId);
                }
                if (publicRequest.IsSetSuppressionPeriod())
                {
                    context.Writer.WriteTextString("suppressionPeriod");
                ...
                {
                    context.Writer.WriteTextString("suppressionType");
                    context.Writer.WriteTextString(publicRequest.SuppressionType);
                }
                writer.WriteEndMap();
