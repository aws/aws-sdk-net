...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeMetricFiltersRequestMarshaller : IMarshaller<IRequest, DescribeMetricFiltersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMetricFiltersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMetricFiltersRequest publicRequest)
        {
            ...
            {
                context.Writer.WritePropertyName("filterNamePrefix");
                context.Writer.WriteStringValue(publicRequest.FilterNamePrefix);
            }
            ...
            if(publicRequest.IsSetMetricNamespace())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.MetricNamespace);
            }
        ...
        private static DescribeMetricFiltersRequestMarshaller _instance = new DescribeMetricFiltersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMetricFiltersRequestMarshaller Instance
        {
            get
            {
                return _instance;
