...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class PutSubscriptionFilterRequestMarshaller : IMarshaller<IRequest, PutSubscriptionFilterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutSubscriptionFilterRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/PutSubscriptionFilter";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("destinationArn");
                    context.Writer.WriteTextString(publicRequest.DestinationArn);
                }
                if (publicRequest.IsSetDistribution())
                {
                    context.Writer.WriteTextString("distribution");
                    context.Writer.WriteTextString(publicRequest.Distribution);
                }
                if (publicRequest.IsSetFilterName())
                {
                    context.Writer.WriteTextString("filterName");
                    context.Writer.WriteTextString(publicRequest.FilterName);
                }
