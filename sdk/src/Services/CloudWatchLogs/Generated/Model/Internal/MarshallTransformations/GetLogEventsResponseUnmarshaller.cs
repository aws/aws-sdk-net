...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLogEventsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetLogEvents");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "events":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<OutputLogEvent, OutputLogEventUnmarshaller>(OutputLogEventUnmarshaller.Instance);
                    ...
                    case "nextBackwardToken":
                        {
                            context.AddPathSegment("NextBackwardToken");
                    ...
                    case "nextForwardToken":
                        {
                            context.AddPathSegment("NextForwardToken");
                            var unmarshaller = CborStringUnmarshaller.Instance;
