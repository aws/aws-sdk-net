...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLogGroupsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeLogGroups");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "logGroups":
                        {
                            context.AddPathSegment("LogGroups");
                            var unmarshaller = new CborListUnmarshaller<LogGroup, LogGroupUnmarshaller>(LogGroupUnmarshaller.Instance);
