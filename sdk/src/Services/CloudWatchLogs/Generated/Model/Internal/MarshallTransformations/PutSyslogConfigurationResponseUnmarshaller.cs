...
{
    /// <summary>
    /// Response Unmarshaller for PutSyslogConfiguration operation
    /// </summary>  
    public class PutSyslogConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSyslogConfigurationResponse response = new PutSyslogConfigurationResponse();
        ...
        private static PutSyslogConfigurationResponseUnmarshaller _instance = new PutSyslogConfigurationResponseUnmarshaller();        

        internal static PutSyslogConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSyslogConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
