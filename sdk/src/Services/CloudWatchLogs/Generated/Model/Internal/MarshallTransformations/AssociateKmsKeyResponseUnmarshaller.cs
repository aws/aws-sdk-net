...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateKmsKeyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateKmsKeyResponse response = new AssociateKmsKeyResponse();
            var reader = context.Reader;
            context.AddPathSegment("AssociateKmsKey");
        ...
        private static AssociateKmsKeyResponseUnmarshaller _instance = new AssociateKmsKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateKmsKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
