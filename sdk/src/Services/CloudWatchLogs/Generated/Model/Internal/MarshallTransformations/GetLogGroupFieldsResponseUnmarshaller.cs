...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLogGroupFieldsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetLogGroupFields");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "logGroupFields":
                        {
                            context.AddPathSegment("LogGroupFields");
                            var unmarshaller = new CborListUnmarshaller<LogGroupField, LogGroupFieldUnmarshaller>(LogGroupFieldUnmarshaller.Instance);
