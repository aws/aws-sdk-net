...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutMetricFilterResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutMetricFilterResponse response = new PutMetricFilterResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutMetricFilter");
        ...
        private static PutMetricFilterResponseUnmarshaller _instance = new PutMetricFilterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMetricFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
