...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParseToOCSFUnmarshaller : ICborUnmarshaller<ParseToOCSF, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ParseToOCSF Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "eventSource":
                        {
                            context.AddPathSegment("EventSource");
                    ...
                    case "ocsfVersion":
                        {
                            context.AddPathSegment("OcsfVersion");
                            var unmarshaller = CborStringUnmarshaller.Instance;
