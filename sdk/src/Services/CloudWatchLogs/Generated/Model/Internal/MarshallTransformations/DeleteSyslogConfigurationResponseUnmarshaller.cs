...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSyslogConfiguration operation
    /// </summary>  
    public class DeleteSyslogConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSyslogConfigurationResponse response = new DeleteSyslogConfigurationResponse();
        ...
        private static DeleteSyslogConfigurationResponseUnmarshaller _instance = new DeleteSyslogConfigurationResponseUnmarshaller();        

        internal static DeleteSyslogConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSyslogConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
