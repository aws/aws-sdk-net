...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CSVUnmarshaller : ICborUnmarshaller<CSV, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public CSV Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "columns":
                        {
                            context.AddPathSegment("Columns");
                    ...
                    case "delimiter":
                        {
                            context.AddPathSegment("Delimiter");
                    ...
                    case "quoteCharacter":
                        {
                            context.AddPathSegment("QuoteCharacter");
                            var unmarshaller = CborStringUnmarshaller.Instance;
