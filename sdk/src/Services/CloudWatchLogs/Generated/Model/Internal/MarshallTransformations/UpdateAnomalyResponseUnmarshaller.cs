...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAnomalyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAnomalyResponse response = new UpdateAnomalyResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateAnomaly");
        ...
        private static UpdateAnomalyResponseUnmarshaller _instance = new UpdateAnomalyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAnomalyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
