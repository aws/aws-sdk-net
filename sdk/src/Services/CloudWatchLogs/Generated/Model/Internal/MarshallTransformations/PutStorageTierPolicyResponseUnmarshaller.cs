...
{
    /// <summary>
    /// Response Unmarshaller for PutStorageTierPolicy operation
    /// </summary>  
    public class PutStorageTierPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutStorageTierPolicyResponse response = new PutStorageTierPolicyResponse();
        ...
        private static PutStorageTierPolicyResponseUnmarshaller _instance = new PutStorageTierPolicyResponseUnmarshaller();        

        internal static PutStorageTierPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutStorageTierPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
