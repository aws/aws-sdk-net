...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLogRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLogRecordResponse response = new GetLogRecordResponse();
            ...
            {
                if (context.TestExpression("logRecord", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    response.LogRecord = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetLogRecordResponseUnmarshaller _instance = new GetLogRecordResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLogRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
