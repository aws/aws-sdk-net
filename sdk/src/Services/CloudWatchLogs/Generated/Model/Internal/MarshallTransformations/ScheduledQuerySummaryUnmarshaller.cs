...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduledQuerySummaryUnmarshaller : IJsonUnmarshaller<ScheduledQuerySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduledQuerySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.LastTriggeredTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
