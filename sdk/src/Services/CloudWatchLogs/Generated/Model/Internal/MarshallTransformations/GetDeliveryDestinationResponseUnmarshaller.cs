...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDeliveryDestinationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeliveryDestinationResponse response = new GetDeliveryDestinationResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetDeliveryDestination");
            reader.ReadStartMap();
        ...
        private static GetDeliveryDestinationResponseUnmarshaller _instance = new GetDeliveryDestinationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeliveryDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
