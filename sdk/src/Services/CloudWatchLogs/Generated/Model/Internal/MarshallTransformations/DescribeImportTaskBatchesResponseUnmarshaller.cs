...
{
    /// <summary>
    /// Response Unmarshaller for DescribeImportTaskBatches operation
    /// </summary>  
    public class DescribeImportTaskBatchesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeImportTaskBatchesResponse response = new DescribeImportTaskBatchesResponse();
            ...
            {
                if (context.TestExpression("importBatches", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ImportBatch, ImportBatchUnmarshaller>(ImportBatchUnmarshaller.Instance);
                    response.ImportBatches = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("importSourceArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImportSourceArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeImportTaskBatchesResponseUnmarshaller _instance = new DescribeImportTaskBatchesResponseUnmarshaller();        

        internal static DescribeImportTaskBatchesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImportTaskBatchesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
