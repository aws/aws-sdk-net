...
{
    /// <summary>
    /// Response Unmarshaller for GetLogObject operation
    /// </summary>  
    public class GetLogObjectResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLogObjectResponse response = new GetLogObjectResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetLogObject");
            response.FieldStream = new GetLogObjectResponseStream(context.Stream);
        ...
        private static GetLogObjectResponseUnmarshaller _instance = new GetLogObjectResponseUnmarshaller();        

        internal static GetLogObjectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLogObjectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
