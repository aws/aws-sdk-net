...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class PutDestinationRequestMarshaller : IMarshaller<IRequest, PutDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutDestinationRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/PutDestination";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("destinationName");
                    context.Writer.WriteTextString(publicRequest.DestinationName);
                }
                ...
                {
                    context.Writer.WriteTextString("targetArn");
                    context.Writer.WriteTextString(publicRequest.TargetArn);
                }
                writer.WriteEndMap();
