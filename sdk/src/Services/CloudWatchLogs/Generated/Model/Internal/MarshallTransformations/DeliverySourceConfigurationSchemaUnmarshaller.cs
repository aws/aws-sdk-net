...
{
    /// <summary>
    /// Response Unmarshaller for DeliverySourceConfigurationSchema Object
    /// </summary>  
    public class DeliverySourceConfigurationSchemaUnmarshaller : IJsonUnmarshaller<DeliverySourceConfigurationSchema, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeliverySourceConfigurationSchema Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DeliverySourceConfigurationSchema unmarshalledObject = new DeliverySourceConfigurationSchema();
        ...
        private static DeliverySourceConfigurationSchemaUnmarshaller _instance = new DeliverySourceConfigurationSchemaUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DeliverySourceConfigurationSchemaUnmarshaller Instance
        {
            get
            {
                return _instance;
