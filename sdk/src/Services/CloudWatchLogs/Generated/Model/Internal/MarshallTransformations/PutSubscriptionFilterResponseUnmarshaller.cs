...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutSubscriptionFilterResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSubscriptionFilterResponse response = new PutSubscriptionFilterResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutSubscriptionFilter");
        ...
        private static PutSubscriptionFilterResponseUnmarshaller _instance = new PutSubscriptionFilterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSubscriptionFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
