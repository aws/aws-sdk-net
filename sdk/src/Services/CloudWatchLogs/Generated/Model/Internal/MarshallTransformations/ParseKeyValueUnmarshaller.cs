...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParseKeyValueUnmarshaller : IUnmarshaller<ParseKeyValue, XmlUnmarshallerContext>, IUnmarshaller<ParseKeyValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ParseKeyValue IUnmarshaller<ParseKeyValue, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ParseKeyValue Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.KeyValueDelimiter = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("nonMatchValue", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NonMatchValue = unmarshaller.Unmarshall(context);
                    continue;
                }
