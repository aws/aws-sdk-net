...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParseKeyValueUnmarshaller : ICborUnmarshaller<ParseKeyValue, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ParseKeyValue Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "keyPrefix":
                        {
                            context.AddPathSegment("KeyPrefix");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "keyValueDelimiter":
                        {
                            context.AddPathSegment("KeyValueDelimiter");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "nonMatchValue":
                        {
                            context.AddPathSegment("NonMatchValue");
                            var unmarshaller = CborStringUnmarshaller.Instance;
