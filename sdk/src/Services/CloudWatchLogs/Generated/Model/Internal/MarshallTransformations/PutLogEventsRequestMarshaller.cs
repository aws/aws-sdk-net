...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    public class PutLogEventsRequestMarshaller : IMarshaller<IRequest, PutLogEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutLogEventsRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/Logs_20140328/operation/PutLogEvents";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("logEvents");
                    context.Writer.WriteStartArray(publicRequest.LogEvents.Count);
                ...
                {
                    context.Writer.WriteTextString("sequenceToken");
                    context.Writer.WriteTextString(publicRequest.SequenceToken);
                }
                writer.WriteEndMap();
