...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDeliveryDestinationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDeliveryDestinationResponse response = new DeleteDeliveryDestinationResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteDeliveryDestination");
        ...
        private static DeleteDeliveryDestinationResponseUnmarshaller _instance = new DeleteDeliveryDestinationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeliveryDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
