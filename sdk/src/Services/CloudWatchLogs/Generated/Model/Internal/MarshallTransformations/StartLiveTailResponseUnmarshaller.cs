...
{
    /// <summary>
    /// Response Unmarshaller for StartLiveTail operation
    /// </summary>  
    public class StartLiveTailResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartLiveTailResponse response = new StartLiveTailResponse();
            var reader = context.Reader;
            context.AddPathSegment("StartLiveTail");
            response.ResponseStream = new StartLiveTailResponseStream(context.Stream);
        ...
        private static StartLiveTailResponseUnmarshaller _instance = new StartLiveTailResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartLiveTailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
