...
{
    /// <summary>
    /// Response Unmarshaller for GetStorageTierPolicy operation
    /// </summary>  
    public class GetStorageTierPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStorageTierPolicyResponse response = new GetStorageTierPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("storageTier", targetDepth, ref reader))
                {
        ...
        private static GetStorageTierPolicyResponseUnmarshaller _instance = new GetStorageTierPolicyResponseUnmarshaller();        

        internal static GetStorageTierPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStorageTierPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
