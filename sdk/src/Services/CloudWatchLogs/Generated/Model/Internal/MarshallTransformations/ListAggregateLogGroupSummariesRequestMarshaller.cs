...
{
    /// <summary>
    /// ListAggregateLogGroupSummaries Request Marshaller
    /// </summary>       
    public class ListAggregateLogGroupSummariesRequestMarshaller : IMarshaller<IRequest, ListAggregateLogGroupSummariesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAggregateLogGroupSummariesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAggregateLogGroupSummariesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchLogs");
            string target = "Logs_20140328.ListAggregateLogGroupSummaries";
        ...
        private static ListAggregateLogGroupSummariesRequestMarshaller _instance = new ListAggregateLogGroupSummariesRequestMarshaller();        

        internal static ListAggregateLogGroupSummariesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAggregateLogGroupSummariesRequestMarshaller Instance
        {
            get
            {
                return _instance;
