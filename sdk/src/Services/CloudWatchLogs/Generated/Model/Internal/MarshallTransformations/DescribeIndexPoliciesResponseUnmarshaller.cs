...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeIndexPoliciesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeIndexPolicies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "indexPolicies":
                        {
                            context.AddPathSegment("IndexPolicies");
                            var unmarshaller = new CborListUnmarshaller<IndexPolicy, IndexPolicyUnmarshaller>(IndexPolicyUnmarshaller.Instance);
                            response.IndexPolicies = unmarshaller.Unmarshall(context);
