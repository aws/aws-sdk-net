...
{
    /// <summary>
    /// Response Unmarshaller for PutBearerTokenAuthentication operation
    /// </summary>  
    public class PutBearerTokenAuthenticationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutBearerTokenAuthenticationResponse response = new PutBearerTokenAuthenticationResponse();
        ...
        private static PutBearerTokenAuthenticationResponseUnmarshaller _instance = new PutBearerTokenAuthenticationResponseUnmarshaller();        

        internal static PutBearerTokenAuthenticationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutBearerTokenAuthenticationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
