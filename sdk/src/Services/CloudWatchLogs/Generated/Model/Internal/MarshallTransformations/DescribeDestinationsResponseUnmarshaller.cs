...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDestinationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeDestinations");
            reader.ReadStartMap();
                    ...
                    case "destinations":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<Destination, DestinationUnmarshaller>(DestinationUnmarshaller.Instance);
        ...
        private static DescribeDestinationsResponseUnmarshaller _instance = new DescribeDestinationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDestinationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
