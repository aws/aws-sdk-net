...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeQueryDefinitionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeQueryDefinitions");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "queryDefinitions":
                        {
                            context.AddPathSegment("QueryDefinitions");
                            var unmarshaller = new CborListUnmarshaller<QueryDefinition, QueryDefinitionUnmarshaller>(QueryDefinitionUnmarshaller.Instance);
