...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3TableIntegrationSourceUnmarshaller : IJsonUnmarshaller<S3TableIntegrationSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3TableIntegrationSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("parentSourceIdentifier", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ParentSourceIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
