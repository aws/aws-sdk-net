...
{
    /// <summary>
    /// Response Unmarshaller for CreateLookupTable operation
    /// </summary>  
    public class CreateLookupTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLookupTableResponse response = new CreateLookupTableResponse();
        ...
        private static CreateLookupTableResponseUnmarshaller _instance = new CreateLookupTableResponseUnmarshaller();        

        internal static CreateLookupTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLookupTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
