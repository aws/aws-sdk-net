...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisassociateKmsKeyResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateKmsKeyResponse response = new DisassociateKmsKeyResponse();
            var reader = context.Reader;
            context.AddPathSegment("DisassociateKmsKey");
        ...
        private static DisassociateKmsKeyResponseUnmarshaller _instance = new DisassociateKmsKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateKmsKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
