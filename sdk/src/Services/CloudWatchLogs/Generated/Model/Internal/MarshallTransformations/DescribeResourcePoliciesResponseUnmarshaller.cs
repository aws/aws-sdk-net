...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeResourcePoliciesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeResourcePolicies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "resourcePolicies":
                        {
                            context.AddPathSegment("ResourcePolicies");
                            var unmarshaller = new CborListUnmarshaller<ResourcePolicy, ResourcePolicyUnmarshaller>(ResourcePolicyUnmarshaller.Instance);
