...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutQueryDefinitionResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutQueryDefinitionResponse response = new PutQueryDefinitionResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutQueryDefinition");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "queryDefinitionId":
                        {
                            context.AddPathSegment("QueryDefinitionId");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.QueryDefinitionId = unmarshaller.Unmarshall(context);
        ...
        private static PutQueryDefinitionResponseUnmarshaller _instance = new PutQueryDefinitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutQueryDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
