...
{
    /// <summary>
    /// UpdateScheduledQuery Request Marshaller
    /// </summary>       
    public class UpdateScheduledQueryRequestMarshaller : IMarshaller<IRequest, UpdateScheduledQueryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateScheduledQueryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchLogs");
            string target = "Logs_20140328.UpdateScheduledQuery";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetScheduleEndTime())
                {
                    ...
                    context.Writer.Write(publicRequest.ScheduleEndTime);
                }
                ...
                if(publicRequest.IsSetScheduleStartTime())
                {
                    ...
                    context.Writer.Write(publicRequest.ScheduleStartTime);
                }

                if(publicRequest.IsSetStartTimeOffset())
                {
                    context.Writer.WritePropertyName("startTimeOffset");
                    context.Writer.Write(publicRequest.StartTimeOffset);
                }
        ...
        private static UpdateScheduledQueryRequestMarshaller _instance = new UpdateScheduledQueryRequestMarshaller();        

        internal static UpdateScheduledQueryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateScheduledQueryRequestMarshaller Instance
        {
            get
            {
                return _instance;
