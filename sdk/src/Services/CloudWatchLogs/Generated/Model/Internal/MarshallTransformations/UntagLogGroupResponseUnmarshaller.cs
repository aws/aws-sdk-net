...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UntagLogGroupResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagLogGroupResponse response = new UntagLogGroupResponse();
            var reader = context.Reader;
            context.AddPathSegment("UntagLogGroup");
        ...
        private static UntagLogGroupResponseUnmarshaller _instance = new UntagLogGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagLogGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
