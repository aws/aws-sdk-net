...
{
    /// <summary>
    /// Response Unmarshaller for ListSyslogConfigurations operation
    /// </summary>  
    public class ListSyslogConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSyslogConfigurationsResponse response = new ListSyslogConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("syslogConfigurations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SyslogConfiguration, SyslogConfigurationUnmarshaller>(SyslogConfigurationUnmarshaller.Instance);
                    response.SyslogConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListSyslogConfigurationsResponseUnmarshaller _instance = new ListSyslogConfigurationsResponseUnmarshaller();        

        internal static ListSyslogConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSyslogConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
