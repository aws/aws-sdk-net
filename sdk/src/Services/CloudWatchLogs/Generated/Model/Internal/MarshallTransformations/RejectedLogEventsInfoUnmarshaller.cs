...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RejectedLogEventsInfoUnmarshaller : ICborUnmarshaller<RejectedLogEventsInfo, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RejectedLogEventsInfo Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "expiredLogEventEndIndex":
                        {
                            context.AddPathSegment("ExpiredLogEventEndIndex");
                    ...
                    case "tooNewLogEventStartIndex":
                        {
                            context.AddPathSegment("TooNewLogEventStartIndex");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                    ...
                    case "tooOldLogEventEndIndex":
                        {
                            context.AddPathSegment("TooOldLogEventEndIndex");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
