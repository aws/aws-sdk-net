...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDeliverySourcesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeDeliverySources");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "deliverySources":
                        {
                            context.AddPathSegment("DeliverySources");
                            var unmarshaller = new CborListUnmarshaller<DeliverySource, DeliverySourceUnmarshaller>(DeliverySourceUnmarshaller.Instance);
                            response.DeliverySources = unmarshaller.Unmarshall(context);
