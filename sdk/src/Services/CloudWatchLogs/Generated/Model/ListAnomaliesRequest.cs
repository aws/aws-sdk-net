...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    /// section.
    /// </summary>
    public partial class ListAnomaliesRequest : AmazonCloudWatchLogsRequest
    {
        ...
        /// </para>
        /// </summary>
        public SuppressionState SuppressionState
        {
            get { return this._suppressionState; }
            set { this._suppressionState = value; }
        }

        // Check to see if SuppressionState property is set
        internal bool IsSetSuppressionState()
        {
            return this._suppressionState != null;
        }
