...
namespace Amazon.Neptune.Model
{
    ...
    internal sealed partial class DescribeDBClusterParametersPaginator : IPaginator<DescribeDBClusterParametersResponse>, IDescribeDBClusterParametersPaginator
    {
        ...
        public IPaginatedEnumerable<Parameter> Parameters => 
            new PaginatedResultKeyResponse<DescribeDBClusterParametersResponse, Parameter>(this, (i) => i.Parameters);

        internal DescribeDBClusterParametersPaginator(IAmazonNeptune client, DescribeDBClusterParametersRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<DescribeDBClusterParametersResponse> IPaginator<DescribeDBClusterParametersResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
