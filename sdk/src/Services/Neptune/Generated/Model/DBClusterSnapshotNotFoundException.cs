...
namespace Amazon.Neptune.Model
{
    ...
    public partial class DBClusterSnapshotNotFoundException : AmazonNeptuneException
    {
        ...
        public DBClusterSnapshotNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DBClusterSnapshotNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
