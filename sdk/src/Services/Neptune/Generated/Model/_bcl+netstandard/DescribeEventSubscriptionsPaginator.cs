...
namespace Amazon.Neptune.Model
{
    ...
    internal sealed partial class DescribeEventSubscriptionsPaginator : IPaginator<DescribeEventSubscriptionsResponse>, IDescribeEventSubscriptionsPaginator
    {
        ...
        internal DescribeEventSubscriptionsPaginator(IAmazonNeptune client, DescribeEventSubscriptionsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<DescribeEventSubscriptionsResponse> IPaginator<DescribeEventSubscriptionsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
