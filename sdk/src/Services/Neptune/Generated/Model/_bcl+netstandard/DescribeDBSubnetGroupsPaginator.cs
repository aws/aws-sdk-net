...
namespace Amazon.Neptune.Model
{
    ...
    internal sealed partial class DescribeDBSubnetGroupsPaginator : IPaginator<DescribeDBSubnetGroupsResponse>, IDescribeDBSubnetGroupsPaginator
    {
        ...
        internal DescribeDBSubnetGroupsPaginator(IAmazonNeptune client, DescribeDBSubnetGroupsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<DescribeDBSubnetGroupsResponse> IPaginator<DescribeDBSubnetGroupsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
