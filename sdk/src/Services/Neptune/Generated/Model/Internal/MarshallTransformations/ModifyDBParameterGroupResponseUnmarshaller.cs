...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyDBParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidDBParameterGroupStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static ModifyDBParameterGroupResponseUnmarshaller _instance = new ModifyDBParameterGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
