...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DBClusterSnapshotAttributeUnmarshaller : IXmlUnmarshaller<DBClusterSnapshotAttribute, XmlUnmarshallerContext>
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AttributeValues/AttributeValue", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.AttributeValues = new List<string>();
                        }
