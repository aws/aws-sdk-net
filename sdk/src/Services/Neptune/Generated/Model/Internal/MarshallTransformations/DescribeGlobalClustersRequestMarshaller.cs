...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeGlobalClustersRequestMarshaller : IMarshaller<IRequest, DescribeGlobalClustersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeGlobalClustersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeGlobalClustersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Neptune");
            request.Parameters.Add("Action", "DescribeGlobalClusters");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGlobalClustersRequestMarshaller Instance
        {
            get
            {
                return _instance;
