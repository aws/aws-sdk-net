...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveSourceIdentifierFromSubscriptionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveSourceIdentifierFromSubscriptionResponse response = new RemoveSourceIdentifierFromSubscriptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RemoveSourceIdentifierFromSubscriptionResult", 2))
                    {
        ...
        private static RemoveSourceIdentifierFromSubscriptionResponseUnmarshaller _instance = new RemoveSourceIdentifierFromSubscriptionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveSourceIdentifierFromSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
