...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeEngineDefaultClusterParametersRequestMarshaller : IMarshaller<IRequest, DescribeEngineDefaultClusterParametersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeEngineDefaultClusterParametersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeEngineDefaultClusterParametersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Neptune");
            request.Parameters.Add("Action", "DescribeEngineDefaultClusterParameters");
            ...
            return request;
                    ...
                    private static DescribeEngineDefaultClusterParametersRequestMarshaller _instance = new DescribeEngineDefaultClusterParametersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEngineDefaultClusterParametersRequestMarshaller Instance
        {
            get
            {
                return _instance;
