...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveRoleFromDBClusterRequestMarshaller : IMarshaller<IRequest, RemoveRoleFromDBClusterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveRoleFromDBClusterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveRoleFromDBClusterRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Neptune");
            request.Parameters.Add("Action", "RemoveRoleFromDBCluster");
