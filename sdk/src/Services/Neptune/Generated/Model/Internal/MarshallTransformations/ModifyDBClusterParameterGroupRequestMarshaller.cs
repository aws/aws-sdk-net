...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ModifyDBClusterParameterGroupRequestMarshaller : IMarshaller<IRequest, ModifyDBClusterParameterGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyDBClusterParameterGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyDBClusterParameterGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Neptune");
            request.Parameters.Add("Action", "ModifyDBClusterParameterGroup");
            ...
            return request;
                    ...
                    private static ModifyDBClusterParameterGroupRequestMarshaller _instance = new ModifyDBClusterParameterGroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBClusterParameterGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
