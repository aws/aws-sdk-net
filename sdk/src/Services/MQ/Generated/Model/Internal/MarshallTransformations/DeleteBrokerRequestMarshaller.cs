...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteBrokerRequestMarshaller : IMarshaller<IRequest, DeleteBrokerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteBrokerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBrokerRequest publicRequest)
        {
        ...
        private static DeleteBrokerRequestMarshaller _instance = new DeleteBrokerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBrokerRequestMarshaller Instance
        {
            get
            {
                return _instance;
