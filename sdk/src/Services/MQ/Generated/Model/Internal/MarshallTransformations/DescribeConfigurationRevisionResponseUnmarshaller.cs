...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeConfigurationRevisionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeConfigurationRevisionResponse response = new DescribeConfigurationRevisionResponse();
        ...
        private static DescribeConfigurationRevisionResponseUnmarshaller _instance = new DescribeConfigurationRevisionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConfigurationRevisionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
