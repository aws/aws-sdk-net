...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBrokerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBrokerResponse response = new CreateBrokerResponse();
        ...
        private static CreateBrokerResponseUnmarshaller _instance = new CreateBrokerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBrokerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
