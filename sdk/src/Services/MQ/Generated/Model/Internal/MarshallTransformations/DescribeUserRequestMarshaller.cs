...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeUserRequestMarshaller : IMarshaller<IRequest, DescribeUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeUserRequestMarshaller _instance = new DescribeUserRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
