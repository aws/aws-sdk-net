...
namespace Amazon.MQ.Model
{
    ...
    [Serializable]
    #endif
    public partial class UnauthorizedException : AmazonMQException
    {
        ...
        public UnauthorizedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnauthorizedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        {
            get { return this._errorAttribute; }
            set { this._errorAttribute = value; }
        }

        // Check to see if ErrorAttribute property is set
