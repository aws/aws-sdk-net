...
{
    /// <summary>
    /// Container for the parameters to the DescribeSharedResources operation.
    /// Returns the resources shared to a broker.
    /// </summary>
    public partial class DescribeSharedResourcesRequest : AmazonMQRequest
    {
        ...
        /// <para>
        /// The maximum number of resources that Amazon MQ can return per page (20 by default).
