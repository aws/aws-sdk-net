...
namespace Amazon.LookoutMetrics.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonLookoutMetricsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLookoutMetricsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LookoutMetrics.
        /// </summary>
        public AmazonLookoutMetricsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLookoutMetricsAuthSchemeParameters
            {
    ...
    public class AmazonLookoutMetricsAuthSchemeResolver : IAuthSchemeResolver<AmazonLookoutMetricsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLookoutMetricsAuthSchemeParameters authParameters)
        {
