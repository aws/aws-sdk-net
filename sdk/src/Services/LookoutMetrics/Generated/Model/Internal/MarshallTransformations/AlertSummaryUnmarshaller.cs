...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlertSummaryUnmarshaller : IUnmarshaller<AlertSummary, XmlUnmarshallerContext>, IUnmarshaller<AlertSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AlertSummary IUnmarshaller<AlertSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AlertSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
