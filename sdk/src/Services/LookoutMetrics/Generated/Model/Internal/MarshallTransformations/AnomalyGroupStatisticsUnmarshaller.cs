...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnomalyGroupStatisticsUnmarshaller : IJsonUnmarshaller<AnomalyGroupStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnomalyGroupStatistics Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EvaluationStartDate", targetDepth))
                {
                    ...
                    unmarshalledObject.EvaluationStartDate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ItemizedMetricStatsList", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ItemizedMetricStats, ItemizedMetricStatsUnmarshaller>(ItemizedMetricStatsUnmarshaller.Instance);
                    unmarshalledObject.ItemizedMetricStatsList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
