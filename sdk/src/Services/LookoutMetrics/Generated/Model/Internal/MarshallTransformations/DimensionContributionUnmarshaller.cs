...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DimensionContributionUnmarshaller : IJsonUnmarshaller<DimensionContribution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DimensionContribution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DimensionValueContribution, DimensionValueContributionUnmarshaller>(DimensionValueContributionUnmarshaller.Instance);
                    unmarshalledObject.DimensionValueContributionList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
