...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3SourceConfigUnmarshaller : IJsonUnmarshaller<S3SourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3SourceConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FileFormatDescriptor", targetDepth))
                {
                    ...
                    unmarshalledObject.FileFormatDescriptor = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("HistoricalDataPathList", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.HistoricalDataPathList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.TemplatedPathList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
