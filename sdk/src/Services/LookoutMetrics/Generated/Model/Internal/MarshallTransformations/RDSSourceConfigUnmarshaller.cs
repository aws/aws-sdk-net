...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RDSSourceConfigUnmarshaller : IUnmarshaller<RDSSourceConfig, XmlUnmarshallerContext>, IUnmarshaller<RDSSourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RDSSourceConfig IUnmarshaller<RDSSourceConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RDSSourceConfig Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
