...
{
    /// <summary>
    /// Response Unmarshaller for RDSSourceConfig Object
    /// </summary>  
    public class RDSSourceConfigUnmarshaller : IJsonUnmarshaller<RDSSourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RDSSourceConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RDSSourceConfig unmarshalledObject = new RDSSourceConfig();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DatabaseHost", targetDepth))
                {
                    ...
                    unmarshalledObject.DatabaseHost = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("DatabasePort", targetDepth))
                {
                    ...
                    unmarshalledObject.DatabasePort = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RDSSourceConfigUnmarshaller _instance = new RDSSourceConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RDSSourceConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
