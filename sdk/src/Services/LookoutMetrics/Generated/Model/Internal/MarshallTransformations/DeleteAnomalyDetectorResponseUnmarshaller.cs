...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAnomalyDetectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAnomalyDetectorResponse response = new DeleteAnomalyDetectorResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAnomalyDetectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
