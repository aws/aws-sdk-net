...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    public class ActionUnmarshaller : IJsonUnmarshaller<Action, JsonUnmarshallerContext>
    {
        ...
        public Action Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("LambdaConfiguration", targetDepth))
                {
                    var unmarshaller = LambdaConfigurationUnmarshaller.Instance;
                    unmarshalledObject.LambdaConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
