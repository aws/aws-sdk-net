...
namespace Amazon.EventBridgeV2.Internal
{
    ...
    public class AmazonEventBridgeV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEventBridgeV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EventBridgeV2.
        /// </summary>
        public AmazonEventBridgeV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEventBridgeV2AuthSchemeParameters
            {
    ...
    public class AmazonEventBridgeV2AuthSchemeResolver : IAuthSchemeResolver<AmazonEventBridgeV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEventBridgeV2AuthSchemeParameters authParameters)
        {
