...
{
    /// <summary>
    /// Configuration for accessing Amazon EventBridgeV2 service
    /// </summary>
    public partial class AmazonEventBridgeV2Config : ClientConfig
    {
        ...
        /// Default constructor
        /// </summary>
        public AmazonEventBridgeV2Config()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonEventBridgeV2DefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "EventBridgeV2";
            this.AuthenticationServiceName = "events";
            this.EndpointProvider = new AmazonEventBridgeV2EndpointProvider();
        }
