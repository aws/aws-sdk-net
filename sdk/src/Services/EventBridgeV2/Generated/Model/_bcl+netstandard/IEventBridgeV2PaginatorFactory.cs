...
namespace Amazon.EventBridgeV2.Model
{
    ...
    ///</summary>
    public interface IEventBridgeV2PaginatorFactory
    {
        ...
        IListEventBusesPaginator ListEventBuses(ListEventBusesRequest request);
        ...
        IListEventSourcesPaginator ListEventSources(ListEventSourcesRequest request);
