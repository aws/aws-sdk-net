...
namespace Amazon.EventBridgeV2.Model
{
    ...
    internal sealed partial class ListResourcePoliciesPaginator : IPaginator<ListResourcePoliciesResponse>, IListResourcePoliciesPaginator
    {
        ...
        /// <summary>
        /// Enumerable containing all of the PolicySummaries
        /// </summary>
        public IPaginatedEnumerable<ResourcePolicySummary> PolicySummaries => 
            new PaginatedResultKeyResponse<ListResourcePoliciesResponse, ResourcePolicySummary>(this, (i) => i.PolicySummaries ?? new List<ResourcePolicySummary>());

        internal ListResourcePoliciesPaginator(IAmazonEventBridgeV2 client, ListResourcePoliciesRequest request)
        {
            this._client = client;
