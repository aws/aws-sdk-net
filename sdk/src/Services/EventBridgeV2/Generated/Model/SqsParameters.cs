...
{
    /// <summary>
    /// SQS invocation parameters for subscribers. Values are forwarded to the SQS SendMessageBatch
    ...
    public partial class SqsParameters
    {
        ...
        private Dictionary<string, SqsMessageAttributeValue> _messageAttributes = AWSConfigs.InitializeCollections ? new Dictionary<string, SqsMessageAttributeValue>() : null;
        private string _messageDeduplicationId;
        private string _messageGroupId;
        private Dictionary<string, SqsMessageAttributeValue> _messageSystemAttributes = AWSConfigs.InitializeCollections ? new Dictionary<string, SqsMessageAttributeValue>() : null;

        /// <summary>
        /// Gets and sets the property DelaySeconds. 
        /// <para>
        /// Delay in seconds before the message becomes visible, standard queues only. Accepts
        /// JSONata expression.
        /// </para>
        /// </summary>
        ...
        public Dictionary<string, SqsMessageAttributeValue> MessageAttributes
        {
        ...
        /// </summary>
        [AWSProperty(Min=0, Max=50)]
        public Dictionary<string, SqsMessageAttributeValue> MessageSystemAttributes
        {
