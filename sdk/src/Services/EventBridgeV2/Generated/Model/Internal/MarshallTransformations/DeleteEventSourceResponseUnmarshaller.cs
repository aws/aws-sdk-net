...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEventSource operation
    /// </summary>  
    public class DeleteEventSourceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEventSourceResponse response = new DeleteEventSourceResponse();
            var reader = context.Reader;
            context.AddPathSegment("DeleteEventSource");
        ...
        private static DeleteEventSourceResponseUnmarshaller _instance = new DeleteEventSourceResponseUnmarshaller();        

        internal static DeleteEventSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
