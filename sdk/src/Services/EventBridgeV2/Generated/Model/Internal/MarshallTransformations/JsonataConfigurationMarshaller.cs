...
{
    /// <summary>
    /// JsonataConfiguration Marshaller
    /// </summary>
    public class JsonataConfigurationMarshaller : IRequestMarshaller<JsonataConfiguration, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(JsonataConfiguration requestObject, CborMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static JsonataConfigurationMarshaller Instance = new JsonataConfigurationMarshaller();
