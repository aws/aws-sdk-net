...
{
    /// <summary>
    /// Response Unmarshaller for CreateEventSource operation
    /// </summary>  
    public class CreateEventSourceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEventSourceResponse response = new CreateEventSourceResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateEventSource");
            reader.ReadStartMap();
        ...
        private static CreateEventSourceResponseUnmarshaller _instance = new CreateEventSourceResponseUnmarshaller();        

        internal static CreateEventSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
