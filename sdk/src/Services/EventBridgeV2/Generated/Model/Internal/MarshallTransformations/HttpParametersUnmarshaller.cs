...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HttpParametersUnmarshaller : ICborUnmarshaller<HttpParameters, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public HttpParameters Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "HeaderParameters":
                        {
                            context.AddPathSegment("HeaderParameters");
                    ...
                    case "PathParameterValues":
                        {
                            context.AddPathSegment("PathParameterValues");
                    ...
                    case "QueryStringParameters":
                        {
                            context.AddPathSegment("QueryStringParameters");
                            var unmarshaller = new CborDictionaryUnmarshaller<string, string, CborStringUnmarshaller, CborStringUnmarshaller>(CborStringUnmarshaller.Instance, CborStringUnmarshaller.Instance);
