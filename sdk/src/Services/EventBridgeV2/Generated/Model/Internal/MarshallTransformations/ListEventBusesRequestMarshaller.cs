...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    public class ListEventBusesRequestMarshaller : IMarshaller<IRequest, ListEventBusesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListEventBusesRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/AWSEventsV2/operation/ListEventBuses";
            ...
            try
            {
                ...
                if (publicRequest.IsSetEventBusAccountId())
                {
                    context.Writer.WriteTextString("EventBusAccountId");
                    context.Writer.WriteTextString(publicRequest.EventBusAccountId);
                }
