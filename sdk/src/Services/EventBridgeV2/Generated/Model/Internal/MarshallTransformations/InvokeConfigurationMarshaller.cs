...
{
    /// <summary>
    /// InvokeConfiguration Marshaller
    /// </summary>
    public class InvokeConfigurationMarshaller : IRequestMarshaller<InvokeConfiguration, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(InvokeConfiguration requestObject, CborMarshallerContext context)
        {
            ...
            if (requestObject.IsSetTargetArn())
            {
                ...
                context.Writer.WriteTextString(requestObject.TargetArn);
            }
        ...
        /// </summary>
        public readonly static InvokeConfigurationMarshaller Instance = new InvokeConfigurationMarshaller();
