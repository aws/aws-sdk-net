...
{
    /// <summary>
    /// Response Unmarshaller for EventSourceSummary Object
    /// </summary>  
    public class EventSourceSummaryUnmarshaller : ICborUnmarshaller<EventSourceSummary, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventSourceSummary Unmarshall(CborUnmarshallerContext context)
        {
            EventSourceSummary unmarshalledObject = new EventSourceSummary();
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "EventSourceAccountId":
                        {
                            context.AddPathSegment("EventSourceAccountId");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.EventSourceAccountId = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "EventSourceArn":
        ...
        private static EventSourceSummaryUnmarshaller _instance = new EventSourceSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EventSourceSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
