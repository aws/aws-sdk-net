...
{
    /// <summary>
    /// Response Unmarshaller for RevokeResource operation
    /// </summary>  
    public class RevokeResourceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeResourceResponse response = new RevokeResourceResponse();
            var reader = context.Reader;
            context.AddPathSegment("RevokeResource");
            reader.ReadStartMap();
        ...
        private static RevokeResourceResponseUnmarshaller _instance = new RevokeResourceResponseUnmarshaller();        

        internal static RevokeResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
