...
{
    /// <summary>
    /// PutRawEventsRequestEntry Marshaller
    /// </summary>
    public class PutRawEventsRequestEntryMarshaller : IRequestMarshaller<PutRawEventsRequestEntry, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PutRawEventsRequestEntry requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("Data");
                context.Writer.WriteByteString(requestObject.Data);
            }
            ...
            if (requestObject.IsSetSystemMetadata())
            {
                ...
                var marshaller = PutRawEventsSystemMetadataMarshaller.Instance;
        ...
        /// </summary>
        public readonly static PutRawEventsRequestEntryMarshaller Instance = new PutRawEventsRequestEntryMarshaller();
