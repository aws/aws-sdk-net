...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeEventSourceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEventSourceResponse response = new DescribeEventSourceResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeEventSource");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Configuration":
                        {
                            ...
                            var unmarshaller = EventSourceConfigurationUnmarshaller.Instance;
                    ...
                    case "EventSourceArn":
                        {
                            context.AddPathSegment("EventSourceArn");
                            var unmarshaller = CborStringUnmarshaller.Instance;
        ...
        private static DescribeEventSourceResponseUnmarshaller _instance = new DescribeEventSourceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
