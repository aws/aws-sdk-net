...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KinesisParametersUnmarshaller : ICborUnmarshaller<KinesisParameters, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public KinesisParameters Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ExplicitHashKey":
                        {
                            context.AddPathSegment("ExplicitHashKey");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.ExplicitHashKey = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "PartitionKey":
                        {
                            context.AddPathSegment("PartitionKey");
                            var unmarshaller = CborStringUnmarshaller.Instance;
