...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListEventBusesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListEventBuses");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EventBuses":
                        {
                            context.AddPathSegment("EventBuses");
                            var unmarshaller = new CborListUnmarshaller<EventBusSummary, EventBusSummaryUnmarshaller>(EventBusSummaryUnmarshaller.Instance);
