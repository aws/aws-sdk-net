...
{
    /// <summary>
    /// Response Unmarshaller for PutRawEvents operation
    /// </summary>  
    public class PutRawEventsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRawEventsResponse response = new PutRawEventsResponse();
            var reader = context.Reader;
            context.AddPathSegment("PutRawEvents");
            reader.ReadStartMap();
                    ...
                    case "Entries":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<PutRawEventsResultEntry, PutRawEventsResultEntryUnmarshaller>(PutRawEventsResultEntryUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new CborUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SchemaRegistryUnavailableException"))
                {
                    return SchemaRegistryUnavailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static PutRawEventsResponseUnmarshaller _instance = new PutRawEventsResponseUnmarshaller();        

        internal static PutRawEventsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRawEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
