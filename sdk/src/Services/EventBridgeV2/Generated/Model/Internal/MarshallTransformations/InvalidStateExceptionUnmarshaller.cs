...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidStateExceptionUnmarshaller : ICborErrorResponseUnmarshaller<InvalidStateException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidStateException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidStateException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("InvalidStateException");
            reader.ReadStartMap();
