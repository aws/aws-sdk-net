...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceInUseExceptionUnmarshaller : ICborErrorResponseUnmarshaller<ResourceInUseException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ResourceInUseException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ResourceInUseException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("ResourceInUseException");
            reader.ReadStartMap();
