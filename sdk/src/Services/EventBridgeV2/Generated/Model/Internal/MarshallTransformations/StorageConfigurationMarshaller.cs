...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class StorageConfigurationMarshaller : IRequestMarshaller<StorageConfiguration, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(StorageConfiguration requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("RetentionPeriodInDays");
                context.Writer.WriteInt32(requestObject.RetentionPeriodInDays.Value);
            }
        }
