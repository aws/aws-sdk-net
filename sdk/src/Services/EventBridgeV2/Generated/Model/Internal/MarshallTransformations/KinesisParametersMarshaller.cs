...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class KinesisParametersMarshaller : IRequestMarshaller<KinesisParameters, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(KinesisParameters requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("ExplicitHashKey");
                context.Writer.WriteTextString(requestObject.ExplicitHashKey);
            }
            if (requestObject.IsSetPartitionKey())
            {
                context.Writer.WriteTextString("PartitionKey");
                context.Writer.WriteTextString(requestObject.PartitionKey);
            }
        }
