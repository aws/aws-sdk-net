...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSubscriberResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DeleteSubscriber");
        ...
        private static DeleteSubscriberResponseUnmarshaller _instance = new DeleteSubscriberResponseUnmarshaller();        

        internal static DeleteSubscriberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSubscriberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
