...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateEventBusRequestMarshaller : IMarshaller<IRequest, UpdateEventBusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateEventBusRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/AWSEventsV2/operation/UpdateEventBus";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("EncryptionConfiguration");
                ...
                {
                    context.Writer.WriteTextString("StorageConfiguration");
                    context.Writer.WriteStartMap(null);
