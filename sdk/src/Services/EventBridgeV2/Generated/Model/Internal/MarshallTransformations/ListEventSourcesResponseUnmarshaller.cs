...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListEventSourcesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListEventSources");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EventSources":
                        {
                            context.AddPathSegment("EventSources");
                            var unmarshaller = new CborListUnmarshaller<EventSourceSummary, EventSourceSummaryUnmarshaller>(EventSourceSummaryUnmarshaller.Instance);
