...
{
    /// <summary>
    /// PutRawEventsSystemMetadata Marshaller
    /// </summary>
    public class PutRawEventsSystemMetadataMarshaller : IRequestMarshaller<PutRawEventsSystemMetadata, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PutRawEventsSystemMetadata requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("ContentType");
                context.Writer.WriteTextString(requestObject.ContentType);
            }
        ...
        /// </summary>
        public readonly static PutRawEventsSystemMetadataMarshaller Instance = new PutRawEventsSystemMetadataMarshaller();
