...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeEventBusResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEventBusResponse response = new DescribeEventBusResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeEventBus");
            reader.ReadStartMap();
                    ...
                    case "StorageConfiguration":
                        {
                            ...
                            var unmarshaller = StorageConfigurationOutputUnmarshaller.Instance;
                            response.StorageConfiguration = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static DescribeEventBusResponseUnmarshaller _instance = new DescribeEventBusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEventBusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
