...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteResourcePolicyRequestMarshaller : IMarshaller<IRequest, DeleteResourcePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteResourcePolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/AWSEventsV2/operation/DeleteResourcePolicy";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("ExpectedRevisionId");
                    context.Writer.WriteTextString(publicRequest.ExpectedRevisionId);
                }
