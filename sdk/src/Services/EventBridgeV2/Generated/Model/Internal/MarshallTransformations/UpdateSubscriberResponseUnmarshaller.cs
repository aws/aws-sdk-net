...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSubscriberResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("UpdateSubscriber");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "PointInTimeConfiguration":
                        {
                            context.AddPathSegment("PointInTimeConfiguration");
                            var unmarshaller = PointInTimeConfigurationUnmarshaller.Instance;
                            response.PointInTimeConfiguration = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "StartingPosition":
                        {
                            context.AddPathSegment("StartingPosition");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "SubscriberArn":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.SubscriberArn = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "Type":
        ...
        public override AmazonServiceException UnmarshallException(CborUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonEventBridgeV2Exception(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static UpdateSubscriberResponseUnmarshaller _instance = new UpdateSubscriberResponseUnmarshaller();        

        internal static UpdateSubscriberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubscriberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
