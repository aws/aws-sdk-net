...
{
    /// <summary>
    /// EventBusV2SystemMetadata Marshaller
    /// </summary>
    public class EventBusV2SystemMetadataMarshaller : IRequestMarshaller<EventBusV2SystemMetadata, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EventBusV2SystemMetadata requestObject, CborMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static EventBusV2SystemMetadataMarshaller Instance = new EventBusV2SystemMetadataMarshaller();
