...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetryPolicyUnmarshaller : ICborUnmarshaller<RetryPolicy, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RetryPolicy Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "MaxEventAgeInSeconds":
                        {
                            context.AddPathSegment("MaxEventAgeInSeconds");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            unmarshalledObject.MaxEventAgeInSeconds = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "MaxRetryAttempts":
                        {
                            context.AddPathSegment("MaxRetryAttempts");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            unmarshalledObject.MaxRetryAttempts = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "RetryStrategy":
                        {
                            context.AddPathSegment("RetryStrategy");
