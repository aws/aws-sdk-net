...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSubscribersResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListSubscribers");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "Subscribers":
                        {
                            context.AddPathSegment("Subscribers");
                            var unmarshaller = new CborListUnmarshaller<SubscriberSummary, SubscriberSummaryUnmarshaller>(SubscriberSummaryUnmarshaller.Instance);
