...
{
    /// <summary>
    /// CreateEventSource Request Marshaller
    /// </summary>       
    public class CreateEventSourceRequestMarshaller : IMarshaller<IRequest, CreateEventSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEventSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEventSourceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EventBridgeV2");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/AWSEventsV2/operation/CreateEventSource";
        ...
        private static CreateEventSourceRequestMarshaller _instance = new CreateEventSourceRequestMarshaller();        

        internal static CreateEventSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
