...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class EncryptionConfigurationMarshaller : IRequestMarshaller<EncryptionConfiguration, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EncryptionConfiguration requestObject, CborMarshallerContext context)
        {
