...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class SqsParametersMarshaller : IRequestMarshaller<SqsParameters, CborMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SqsParameters requestObject, CborMarshallerContext context)
        {
            ...
            {
                context.Writer.WriteTextString("DelaySeconds");
                context.Writer.WriteTextString(requestObject.DelaySeconds);
            }
            if (requestObject.IsSetMessageAttributes())
            {
                ...
                foreach (var requestObjectMessageAttributesKvp in requestObject.MessageAttributes)
                {
                    ...
                    var marshaller = SqsMessageAttributeValueMarshaller.Instance;
            ...
            {
                context.Writer.WriteTextString("MessageSystemAttributes");
                context.Writer.WriteStartMap(null);
                foreach (var requestObjectMessageSystemAttributesKvp in requestObject.MessageSystemAttributes)
                {
                    context.Writer.WriteTextString(requestObjectMessageSystemAttributesKvp.Key);
