...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEventSource operation
    /// </summary>  
    public class UpdateEventSourceResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEventSourceResponse response = new UpdateEventSourceResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateEventSource");
            reader.ReadStartMap();
        ...
        private static UpdateEventSourceResponseUnmarshaller _instance = new UpdateEventSourceResponseUnmarshaller();        

        internal static UpdateEventSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
