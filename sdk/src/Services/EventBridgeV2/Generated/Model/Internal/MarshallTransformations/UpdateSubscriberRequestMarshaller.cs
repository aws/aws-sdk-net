...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateSubscriberRequestMarshaller : IMarshaller<IRequest, UpdateSubscriberRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateSubscriberRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/AWSEventsV2/operation/UpdateSubscriber";
            ...
            try
            {
                ...
                if (publicRequest.IsSetInvokeConfiguration())
                {
                    ...
                    var marshaller = UpdateInvokeConfigurationMarshaller.Instance;
                ...
                if (publicRequest.IsSetResumePosition())
                {
                    context.Writer.WriteTextString("ResumePosition");
                    context.Writer.WriteTextString(publicRequest.ResumePosition);
                }
