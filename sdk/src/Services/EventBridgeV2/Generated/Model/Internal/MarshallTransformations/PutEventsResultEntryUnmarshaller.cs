...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutEventsResultEntryUnmarshaller : ICborUnmarshaller<PutEventsResultEntry, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public PutEventsResultEntry Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "SequenceNumber":
                        {
                            context.AddPathSegment("SequenceNumber");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "SuccessCode":
                        {
                            context.AddPathSegment("SuccessCode");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.SuccessCode = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
