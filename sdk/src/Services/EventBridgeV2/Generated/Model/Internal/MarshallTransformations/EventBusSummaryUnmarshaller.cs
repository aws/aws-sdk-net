...
{
    /// <summary>
    /// Response Unmarshaller for EventBusSummary Object
    /// </summary>  
    public class EventBusSummaryUnmarshaller : ICborUnmarshaller<EventBusSummary, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventBusSummary Unmarshall(CborUnmarshallerContext context)
        {
            EventBusSummary unmarshalledObject = new EventBusSummary();
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "EventBusAccountId":
                        {
                            context.AddPathSegment("EventBusAccountId");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.EventBusAccountId = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "EventBusArn":
        ...
        private static EventBusSummaryUnmarshaller _instance = new EventBusSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EventBusSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
