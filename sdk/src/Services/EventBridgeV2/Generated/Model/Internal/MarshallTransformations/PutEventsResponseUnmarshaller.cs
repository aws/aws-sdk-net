...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutEventsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("PutEvents");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Entries":
                        {
                            context.AddPathSegment("Entries");
                            var unmarshaller = new CborListUnmarshaller<PutEventsResultEntry, PutEventsResultEntryUnmarshaller>(PutEventsResultEntryUnmarshaller.Instance);
                    ...
                    case "FailedEntryCount":
                        {
                            context.AddPathSegment("FailedEntryCount");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            response.FailedEntryCount = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
