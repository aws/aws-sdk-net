...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListResourcePoliciesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListResourcePolicies");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "PolicySummaries":
                        {
                            context.AddPathSegment("PolicySummaries");
                            var unmarshaller = new CborListUnmarshaller<ResourcePolicySummary, ResourcePolicySummaryUnmarshaller>(ResourcePolicySummaryUnmarshaller.Instance);
                            response.PolicySummaries = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
