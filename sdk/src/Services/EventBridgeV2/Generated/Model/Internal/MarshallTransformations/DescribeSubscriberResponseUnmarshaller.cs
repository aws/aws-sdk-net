...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSubscriber operation
    /// </summary>  
    public class DescribeSubscriberResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSubscriberResponse response = new DescribeSubscriberResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeSubscriber");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "BatchConfiguration":
                        {
                            context.AddPathSegment("BatchConfiguration");
                            var unmarshaller = BatchConfigurationUnmarshaller.Instance;
                            response.BatchConfiguration = unmarshaller.Unmarshall(context);
                    ...
                    case "FilterConfiguration":
                        {
                            ...
                            response.FilterConfiguration = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "InvokeConfiguration":
                        {
                            context.AddPathSegment("InvokeConfiguration");
                            var unmarshaller = InvokeConfigurationUnmarshaller.Instance;
                            response.InvokeConfiguration = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    ...
                    case "OnFailureConfiguration":
                        {
                            ...
                            response.OnFailureConfiguration = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    ...
                    case "RetryPolicy":
                        {
                            context.AddPathSegment("RetryPolicy");
                            var unmarshaller = RetryPolicyUnmarshaller.Instance;
                            response.RetryPolicy = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "Revoked":
                    ...
                    case "Transformer":
                        {
                            context.AddPathSegment("Transformer");
                            var unmarshaller = TransformerUnmarshaller.Instance;
                            response.Transformer = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "Type":
        ...
        private static DescribeSubscriberResponseUnmarshaller _instance = new DescribeSubscriberResponseUnmarshaller();        

        internal static DescribeSubscriberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSubscriberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
