...
namespace Amazon.EventBridgeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidInputExceptionUnmarshaller : ICborErrorResponseUnmarshaller<InvalidInputException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidInputException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidInputException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("InvalidInputException");
            reader.ReadStartMap();
