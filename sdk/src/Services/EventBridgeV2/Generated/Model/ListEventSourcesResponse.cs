...
namespace Amazon.EventBridgeV2.Model
{
    ...
    {
        private List<EventSourceSummary> _eventSources = AWSConfigs.InitializeCollections ? new List<EventSourceSummary>() : null;
        ...
        /// </summary>
        public List<EventSourceSummary> EventSources
        {
