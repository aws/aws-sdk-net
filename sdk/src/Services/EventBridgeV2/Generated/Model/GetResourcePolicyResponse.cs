...
{
    /// <summary>
    /// Returned only when the named policy exists. A missing event bus or a missing named
    /// policy fails with ResourceNotFoundException rather than returning an empty or null
    /// policy document. Every member is therefore always present on a successful response.
    /// </summary>
