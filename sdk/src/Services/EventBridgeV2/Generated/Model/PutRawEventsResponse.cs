...
{
    /// <summary>
    /// This is the response object from the PutRawEvents operation.
    /// </summary>
    public partial class PutRawEventsResponse : AmazonWebServiceResponse
    {
        private List<PutRawEventsResultEntry> _entries = AWSConfigs.InitializeCollections ? new List<PutRawEventsResultEntry>() : null;
        ...
        /// </summary>
        public List<PutRawEventsResultEntry> Entries
        {
