...
{
    /// <summary>
    /// Container for the parameters to the PutRawEvents operation.
    /// Publishes pre-shaped events to an event bus.
    /// </summary>
    public partial class PutRawEventsRequest : AmazonEventBridgeV2Request
    {
        private DeduplicationConfiguration _deduplicationConfiguration;
        private List<PutRawEventsRequestEntry> _entries = AWSConfigs.InitializeCollections ? new List<PutRawEventsRequestEntry>() : null;
        private string _eventBusArn;
        private SchemaRegistryConfiguration _schemaRegistryConfiguration;
        ...
        public List<PutRawEventsRequestEntry> Entries
        {
        ...
        /// <summary>
        /// Gets and sets the property SchemaRegistryConfiguration. 
        /// <para>
        /// Schema-registry settings for encoding open-format (Avro/Protobuf) events. Required
        /// for open-format entries; ignored for JSON entries. The registry is read with the caller's
        /// credentials, so the caller needs read access to the registry it references.
        /// </para>
        /// </summary>
        public SchemaRegistryConfiguration SchemaRegistryConfiguration
        {
            get { return this._schemaRegistryConfiguration; }
            set { this._schemaRegistryConfiguration = value; }
        }

        // Check to see if SchemaRegistryConfiguration property is set
        internal bool IsSetSchemaRegistryConfiguration()
        {
            return this._schemaRegistryConfiguration != null;
        }
