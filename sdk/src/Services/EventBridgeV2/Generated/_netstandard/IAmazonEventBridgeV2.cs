...
namespace Amazon.EventBridgeV2
{
    ...
    public partial interface IAmazonEventBridgeV2 : IAmazonService, IDisposable
    {
        ...
        Task<CreateEventSourceResponse> CreateEventSourceAsync(CreateEventSourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteEventSourceResponse> DeleteEventSourceAsync(DeleteEventSourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeSubscriberResponse> DescribeSubscriberAsync(DescribeSubscriberRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutRawEventsResponse> PutRawEventsAsync(PutRawEventsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<RevokeResourceResponse> RevokeResourceAsync(RevokeResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateEventSourceResponse> UpdateEventSourceAsync(UpdateEventSourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEventBridgeV2Config))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEventBridgeV2Config();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEventBridgeV2Config;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEventBridgeV2Config to create AmazonEventBridgeV2Client");
            }

            return awsCredentials == null ? 
                    new AmazonEventBridgeV2Client(serviceClientConfig) :
                    new AmazonEventBridgeV2Client(awsCredentials, serviceClientConfig);
        }
