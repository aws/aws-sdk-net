...
{
    /// <summary>
    /// CreateVariable Request Marshaller
    /// </summary>       
    public class CreateVariableRequestMarshaller : IMarshaller<IRequest, CreateVariableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateVariableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateVariableRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.FraudDetector");
            string target = "AWSHawksNestServiceFacade.CreateVariable";
        ...
        private static CreateVariableRequestMarshaller _instance = new CreateVariableRequestMarshaller();        

        internal static CreateVariableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVariableRequestMarshaller Instance
        {
            get
            {
                return _instance;
