...
{
    /// <summary>
    /// Response Unmarshaller for GetPrediction operation
    /// </summary>  
    public class GetPredictionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetPredictionResponseUnmarshaller _instance = new GetPredictionResponseUnmarshaller();        

        internal static GetPredictionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPredictionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
