...
namespace Amazon.FraudDetector.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteEventRequestMarshaller : IMarshaller<IRequest, DeleteEventRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteEventRequest publicRequest)
        {
            ...
            string target = "AWSHawksNestServiceFacade.DeleteEvent";
            ...
            if(publicRequest.IsSetDeleteAuditHistory())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.DeleteAuditHistory.Value);
            }
        ...
        private static DeleteEventRequestMarshaller _instance = new DeleteEventRequestMarshaller();        

        internal static DeleteEventRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventRequestMarshaller Instance
        {
            get
            {
                return _instance;
