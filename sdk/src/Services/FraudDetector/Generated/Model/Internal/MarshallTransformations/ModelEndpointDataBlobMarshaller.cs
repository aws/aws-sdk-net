...
namespace Amazon.FraudDetector.Model.Internal.MarshallTransformations
{
    ...
    public class ModelEndpointDataBlobMarshaller : IRequestMarshaller<ModelEndpointDataBlob, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ModelEndpointDataBlob requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetByteBuffer())
            {
                context.Writer.WritePropertyName("byteBuffer");
                context.Writer.Write(StringUtils.FromMemoryStream(requestObject.ByteBuffer));
            }
