...
namespace Amazon.FraudDetector.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UncertaintyRangeUnmarshaller : IJsonUnmarshaller<UncertaintyRange, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UncertaintyRange Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("lowerBoundValue", targetDepth, ref reader))
                {
                    var unmarshaller = NullableFloatUnmarshaller.Instance;
                    unmarshalledObject.LowerBoundValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("upperBoundValue", targetDepth, ref reader))
                {
                    var unmarshaller = NullableFloatUnmarshaller.Instance;
