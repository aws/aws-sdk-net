...
{
    /// <summary>
    /// Response Unmarshaller for GetVariables operation
    /// </summary>  
    public class GetVariablesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetVariablesResponseUnmarshaller _instance = new GetVariablesResponseUnmarshaller();        

        internal static GetVariablesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVariablesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
