...
{
    /// <summary>
    /// CreateModelVersion Request Marshaller
    /// </summary>       
    public class CreateModelVersionRequestMarshaller : IMarshaller<IRequest, CreateModelVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateModelVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateModelVersionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.FraudDetector");
            string target = "AWSHawksNestServiceFacade.CreateModelVersion";
            ...
            if(publicRequest.IsSetTrainingDataSource())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TrainingDataSource);
            }
        ...
        private static CreateModelVersionRequestMarshaller _instance = new CreateModelVersionRequestMarshaller();        

        internal static CreateModelVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
