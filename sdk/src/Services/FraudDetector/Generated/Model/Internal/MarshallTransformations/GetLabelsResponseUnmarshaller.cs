...
{
    /// <summary>
    /// Response Unmarshaller for GetLabels operation
    /// </summary>  
    public class GetLabelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetLabelsResponseUnmarshaller _instance = new GetLabelsResponseUnmarshaller();        

        internal static GetLabelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLabelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
