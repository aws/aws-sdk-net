...
namespace Amazon.FraudDetector.Model
{
    ...
    public partial class ResourceUnavailableException : AmazonFraudDetectorException
    {
        ...
        public ResourceUnavailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceUnavailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
