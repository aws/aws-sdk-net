...
namespace Amazon.FraudDetector
{
    ...
    public partial interface IAmazonFraudDetector : IAmazonService, IDisposable
    {
        ...
        Task<DeleteRuleVersionResponse> DeleteRuleVersionAsync(DeleteRuleVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetPredictionResponse> GetPredictionAsync(GetPredictionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutModelResponse> PutModelAsync(PutModelRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
