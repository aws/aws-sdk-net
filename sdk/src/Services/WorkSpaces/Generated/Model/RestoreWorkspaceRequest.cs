...
namespace Amazon.WorkSpaces.Model
{
    ...
    {
        private bool? _snapshotCurrentVolumes;
        private string _workspaceId;

        /// <summary>
        /// Gets and sets the property SnapshotCurrentVolumes. 
        /// <para>
        /// Indicates whether to create snapshots of the root volume and user volume before restoring
        /// the WorkSpace.
        /// </para>
        /// </summary>
        public bool SnapshotCurrentVolumes
        {
            get { return this._snapshotCurrentVolumes.GetValueOrDefault(); }
            set { this._snapshotCurrentVolumes = value; }
        }

        // Check to see if SnapshotCurrentVolumes property is set
        internal bool IsSetSnapshotCurrentVolumes()
        {
            return this._snapshotCurrentVolumes.HasValue; 
        }
