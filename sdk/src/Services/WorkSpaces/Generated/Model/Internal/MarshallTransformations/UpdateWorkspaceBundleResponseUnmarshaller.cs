...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspaceBundle operation
    /// </summary>  
    public class UpdateWorkspaceBundleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkspaceBundleResponse response = new UpdateWorkspaceBundleResponse();
        ...
        private static UpdateWorkspaceBundleResponseUnmarshaller _instance = new UpdateWorkspaceBundleResponseUnmarshaller();        

        internal static UpdateWorkspaceBundleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspaceBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
