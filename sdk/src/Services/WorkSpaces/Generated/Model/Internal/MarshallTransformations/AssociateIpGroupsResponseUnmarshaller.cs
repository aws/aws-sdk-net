...
{
    /// <summary>
    /// Response Unmarshaller for AssociateIpGroups operation
    /// </summary>  
    public class AssociateIpGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateIpGroupsResponse response = new AssociateIpGroupsResponse();
        ...
        private static AssociateIpGroupsResponseUnmarshaller _instance = new AssociateIpGroupsResponseUnmarshaller();        

        internal static AssociateIpGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateIpGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
