...
{
    /// <summary>
    /// Response Unmarshaller for CreateIpGroup operation
    /// </summary>  
    public class CreateIpGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateIpGroupResponse response = new CreateIpGroupResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new ResourceCreationFailedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static CreateIpGroupResponseUnmarshaller _instance = new CreateIpGroupResponseUnmarshaller();        

        internal static CreateIpGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIpGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
