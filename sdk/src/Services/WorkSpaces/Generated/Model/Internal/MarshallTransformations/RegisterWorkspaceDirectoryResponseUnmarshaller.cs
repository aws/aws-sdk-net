...
namespace Amazon.WorkSpaces.Model.Internal.MarshallTransformations
{
    ...
    public class RegisterWorkspaceDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new UnsupportedNetworkConfigurationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("WorkspacesDefaultRoleNotFoundException"))
            {
                return new WorkspacesDefaultRoleNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
