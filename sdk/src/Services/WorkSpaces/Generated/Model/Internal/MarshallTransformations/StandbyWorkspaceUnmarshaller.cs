...
namespace Amazon.WorkSpaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StandbyWorkspaceUnmarshaller : IJsonUnmarshaller<StandbyWorkspace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StandbyWorkspace Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PrimaryWorkspaceId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrimaryWorkspaceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("VolumeEncryptionKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
