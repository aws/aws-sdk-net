...
{
    /// <summary>
    /// RebuildWorkspaces Request Marshaller
    /// </summary>       
    public class RebuildWorkspacesRequestMarshaller : IMarshaller<IRequest, RebuildWorkspacesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RebuildWorkspacesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RebuildWorkspacesRequest publicRequest)
        {
        ...
        private static RebuildWorkspacesRequestMarshaller _instance = new RebuildWorkspacesRequestMarshaller();        

        internal static RebuildWorkspacesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebuildWorkspacesRequestMarshaller Instance
        {
            get
            {
                return _instance;
