...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWorkspaces operation
    /// </summary>  
    public class DescribeWorkspacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWorkspacesResponse response = new DescribeWorkspacesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Workspaces", targetDepth))
                {
                    ...
                    response.Workspaces = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeWorkspacesResponseUnmarshaller _instance = new DescribeWorkspacesResponseUnmarshaller();        

        internal static DescribeWorkspacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkspacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
