...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateConnectionAlias operation
    /// </summary>  
    public class DisassociateConnectionAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateConnectionAliasResponse response = new DisassociateConnectionAliasResponse();
        ...
        private static DisassociateConnectionAliasResponseUnmarshaller _instance = new DisassociateConnectionAliasResponseUnmarshaller();        

        internal static DisassociateConnectionAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateConnectionAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
