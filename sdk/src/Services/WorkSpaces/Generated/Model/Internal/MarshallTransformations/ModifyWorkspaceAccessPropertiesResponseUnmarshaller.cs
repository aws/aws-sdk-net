...
{
    /// <summary>
    /// Response Unmarshaller for ModifyWorkspaceAccessProperties operation
    /// </summary>  
    public class ModifyWorkspaceAccessPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyWorkspaceAccessPropertiesResponse response = new ModifyWorkspaceAccessPropertiesResponse();
        ...
        private static ModifyWorkspaceAccessPropertiesResponseUnmarshaller _instance = new ModifyWorkspaceAccessPropertiesResponseUnmarshaller();        

        internal static ModifyWorkspaceAccessPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyWorkspaceAccessPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
