...
{
    /// <summary>
    /// Response Unmarshaller for CreateUpdatedWorkspaceImage operation
    /// </summary>  
    public class CreateUpdatedWorkspaceImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUpdatedWorkspaceImageResponse response = new CreateUpdatedWorkspaceImageResponse();
        ...
        private static CreateUpdatedWorkspaceImageResponseUnmarshaller _instance = new CreateUpdatedWorkspaceImageResponseUnmarshaller();        

        internal static CreateUpdatedWorkspaceImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUpdatedWorkspaceImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
