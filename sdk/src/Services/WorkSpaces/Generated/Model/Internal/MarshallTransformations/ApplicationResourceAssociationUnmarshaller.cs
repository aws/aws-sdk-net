...
namespace Amazon.WorkSpaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationResourceAssociationUnmarshaller : IJsonUnmarshaller<ApplicationResourceAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationResourceAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AssociatedResourceId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AssociatedResourceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AssociatedResourceType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
