...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateWorkspaceApplication operation
    /// </summary>  
    public class DisassociateWorkspaceApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateWorkspaceApplicationResponse response = new DisassociateWorkspaceApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = WorkspaceResourceAssociationUnmarshaller.Instance;
        ...
        private static DisassociateWorkspaceApplicationResponseUnmarshaller _instance = new DisassociateWorkspaceApplicationResponseUnmarshaller();        

        internal static DisassociateWorkspaceApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateWorkspaceApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
