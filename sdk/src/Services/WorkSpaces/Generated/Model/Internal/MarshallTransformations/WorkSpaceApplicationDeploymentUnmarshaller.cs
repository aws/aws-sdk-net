...
namespace Amazon.WorkSpaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkSpaceApplicationDeploymentUnmarshaller : IUnmarshaller<WorkSpaceApplicationDeployment, XmlUnmarshallerContext>, IUnmarshaller<WorkSpaceApplicationDeployment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        WorkSpaceApplicationDeployment IUnmarshaller<WorkSpaceApplicationDeployment, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public WorkSpaceApplicationDeployment Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WorkspaceResourceAssociation, WorkspaceResourceAssociationUnmarshaller>(WorkspaceResourceAssociationUnmarshaller.Instance);
