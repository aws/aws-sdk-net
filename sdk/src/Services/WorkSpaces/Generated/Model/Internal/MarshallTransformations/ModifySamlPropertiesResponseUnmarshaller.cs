...
{
    /// <summary>
    /// Response Unmarshaller for ModifySamlProperties operation
    /// </summary>  
    public class ModifySamlPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifySamlPropertiesResponse response = new ModifySamlPropertiesResponse();
        ...
        private static ModifySamlPropertiesResponseUnmarshaller _instance = new ModifySamlPropertiesResponseUnmarshaller();        

        internal static ModifySamlPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifySamlPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
