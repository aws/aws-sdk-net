...
{
    /// <summary>
    /// Response Unmarshaller for ModifySelfservicePermissions operation
    /// </summary>  
    public class ModifySelfservicePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifySelfservicePermissionsResponse response = new ModifySelfservicePermissionsResponse();
        ...
        private static ModifySelfservicePermissionsResponseUnmarshaller _instance = new ModifySelfservicePermissionsResponseUnmarshaller();        

        internal static ModifySelfservicePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifySelfservicePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
