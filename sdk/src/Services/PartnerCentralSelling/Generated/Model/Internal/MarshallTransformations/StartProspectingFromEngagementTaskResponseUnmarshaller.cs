...
{
    /// <summary>
    /// Response Unmarshaller for StartProspectingFromEngagementTask operation
    /// </summary>  
    public class StartProspectingFromEngagementTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartProspectingFromEngagementTaskResponse response = new StartProspectingFromEngagementTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Identifiers", targetDepth, ref reader))
                {
                    ...
                    response.Identifiers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TaskName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartProspectingFromEngagementTaskResponseUnmarshaller _instance = new StartProspectingFromEngagementTaskResponseUnmarshaller();        

        internal static StartProspectingFromEngagementTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartProspectingFromEngagementTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
