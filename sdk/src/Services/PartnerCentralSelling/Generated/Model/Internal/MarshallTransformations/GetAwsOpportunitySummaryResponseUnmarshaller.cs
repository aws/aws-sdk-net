    ...
    public class GetAwsOpportunitySummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InvolvementType = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("InvolvementTypeChangeReason", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InvolvementTypeChangeReason = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("RelatedEntityIds", targetDepth))
                {
                    ...
                    response.RelatedEntityIds = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RelatedOpportunityId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RelatedOpportunityId = unmarshaller.Unmarshall(context);
                    continue;
                }
