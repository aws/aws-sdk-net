...
namespace Amazon.PartnerCentralSelling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccountSummaryUnmarshaller : IJsonUnmarshaller<AccountSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccountSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OtherIndustry", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OtherIndustry = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
