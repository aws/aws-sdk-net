...
namespace Amazon.PartnerCentralSelling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LeadInteractionUnmarshaller : IUnmarshaller<LeadInteraction, XmlUnmarshallerContext>, IUnmarshaller<LeadInteraction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LeadInteraction IUnmarshaller<LeadInteraction, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public LeadInteraction Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("InteractionDate", targetDepth))
                {
                    ...
                    unmarshalledObject.InteractionDate = unmarshaller.Unmarshall(context);
                    continue;
                }
