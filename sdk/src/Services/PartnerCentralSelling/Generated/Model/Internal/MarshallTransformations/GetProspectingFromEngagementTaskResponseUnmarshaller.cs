...
{
    /// <summary>
    /// Response Unmarshaller for GetProspectingFromEngagementTask operation
    /// </summary>  
    public class GetProspectingFromEngagementTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProspectingFromEngagementTaskResponse response = new GetProspectingFromEngagementTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EngagementProspectingResult, EngagementProspectingResultUnmarshaller>(EngagementProspectingResultUnmarshaller.Instance);
        ...
        private static GetProspectingFromEngagementTaskResponseUnmarshaller _instance = new GetProspectingFromEngagementTaskResponseUnmarshaller();        

        internal static GetProspectingFromEngagementTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProspectingFromEngagementTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
