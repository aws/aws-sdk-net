...
{
    /// <summary>
    /// ListResourceSnapshots Request Marshaller
    /// </summary>       
    public class ListResourceSnapshotsRequestMarshaller : IMarshaller<IRequest, ListResourceSnapshotsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListResourceSnapshotsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListResourceSnapshotsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralSelling");
            string target = "AWSPartnerCentralSelling.ListResourceSnapshots";
            ...
            if(publicRequest.IsSetCreatedBy())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.CreatedBy);
            }
            ...
            if(publicRequest.IsSetResourceSnapshotTemplateIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ResourceSnapshotTemplateIdentifier);
            }
        ...
        private static ListResourceSnapshotsRequestMarshaller _instance = new ListResourceSnapshotsRequestMarshaller();        

        internal static ListResourceSnapshotsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourceSnapshotsRequestMarshaller Instance
        {
            get
            {
                return _instance;
