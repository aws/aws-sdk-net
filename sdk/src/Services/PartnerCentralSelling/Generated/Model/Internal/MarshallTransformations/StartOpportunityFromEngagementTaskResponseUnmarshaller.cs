...
{
    /// <summary>
    /// Response Unmarshaller for StartOpportunityFromEngagementTask operation
    /// </summary>  
    public class StartOpportunityFromEngagementTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartOpportunityFromEngagementTaskResponse response = new StartOpportunityFromEngagementTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContextId", targetDepth))
                {
                    ...
                    response.ContextId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartOpportunityFromEngagementTaskResponseUnmarshaller _instance = new StartOpportunityFromEngagementTaskResponseUnmarshaller();        

        internal static StartOpportunityFromEngagementTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartOpportunityFromEngagementTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
