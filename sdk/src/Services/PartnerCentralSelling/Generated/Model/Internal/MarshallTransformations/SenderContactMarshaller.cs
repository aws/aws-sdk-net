...
{
    /// <summary>
    /// SenderContact Marshaller
    /// </summary>
    public class SenderContactMarshaller : IRequestMarshaller<SenderContact, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SenderContact requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetBusinessTitle())
            {
                ...
                context.Writer.Write(requestObject.BusinessTitle);
            }
            ...
            if(requestObject.IsSetPhone())
            {
                ...
                context.Writer.Write(requestObject.Phone);
            }
        ...
        /// </summary>
        public readonly static SenderContactMarshaller Instance = new SenderContactMarshaller();
