...
namespace Amazon.PartnerCentralSelling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListEngagementByAcceptingInvitationTaskSummaryUnmarshaller : IUnmarshaller<ListEngagementByAcceptingInvitationTaskSummary, XmlUnmarshallerContext>, IUnmarshaller<ListEngagementByAcceptingInvitationTaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ListEngagementByAcceptingInvitationTaskSummary IUnmarshaller<ListEngagementByAcceptingInvitationTaskSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ListEngagementByAcceptingInvitationTaskSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("EngagementInvitationId", targetDepth))
                {
                    ...
                    unmarshalledObject.EngagementInvitationId = unmarshaller.Unmarshall(context);
                    continue;
                }
