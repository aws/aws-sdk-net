...
{
    /// <summary>
    /// LeadInvitationInteraction Marshaller
    /// </summary>
    public class LeadInvitationInteractionMarshaller : IRequestMarshaller<LeadInvitationInteraction, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(LeadInvitationInteraction requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetContactBusinessTitle())
            {
                context.Writer.WritePropertyName("ContactBusinessTitle");
                context.Writer.WriteStringValue(requestObject.ContactBusinessTitle);
            }
        ...
        /// </summary>
        public readonly static LeadInvitationInteractionMarshaller Instance = new LeadInvitationInteractionMarshaller();
