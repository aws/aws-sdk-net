...
{
    /// <summary>
    /// Response Unmarshaller for ProspectingResultAws Object
    /// </summary>  
    public class ProspectingResultAwsUnmarshaller : IJsonUnmarshaller<ProspectingResultAws, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProspectingResultAws Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ProspectingResultAws unmarshalledObject = new ProspectingResultAws();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ProspectingResultCustomerUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = ProspectingInsightsUnmarshaller.Instance;
        ...
        private static ProspectingResultAwsUnmarshaller _instance = new ProspectingResultAwsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProspectingResultAwsUnmarshaller Instance
        {
            get
            {
                return _instance;
