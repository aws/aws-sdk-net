...
{
    /// <summary>
    /// Response Unmarshaller for CreateOpportunity operation
    /// </summary>  
    public class CreateOpportunityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateOpportunityResponseUnmarshaller _instance = new CreateOpportunityResponseUnmarshaller();        

        internal static CreateOpportunityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOpportunityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
