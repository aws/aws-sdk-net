...
{
    /// <summary>
    /// ListOpportunityFromEngagementTasks Request Marshaller
    /// </summary>       
    public class ListOpportunityFromEngagementTasksRequestMarshaller : IMarshaller<IRequest, ListOpportunityFromEngagementTasksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListOpportunityFromEngagementTasksRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListOpportunityFromEngagementTasksRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralSelling");
            string target = "AWSPartnerCentralSelling.ListOpportunityFromEngagementTasks";
            ...
            if(publicRequest.IsSetContextIdentifier())
            {
                ...
                foreach(var publicRequestContextIdentifierListValue in publicRequest.ContextIdentifier)
                {
                        context.Writer.WriteStringValue(publicRequestContextIdentifierListValue);
                }
        ...
        private static ListOpportunityFromEngagementTasksRequestMarshaller _instance = new ListOpportunityFromEngagementTasksRequestMarshaller();        

        internal static ListOpportunityFromEngagementTasksRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOpportunityFromEngagementTasksRequestMarshaller Instance
        {
            get
            {
                return _instance;
