...
namespace Amazon.PartnerCentralSelling.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationException : AmazonPartnerCentralSellingException
    {
        private List<ValidationExceptionError> _errorList = AWSConfigs.InitializeCollections ? new List<ValidationExceptionError>() : null;
        ...
        protected ValidationException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.ErrorList = (List<ValidationExceptionError>)info.GetValue("ErrorList", typeof(List<ValidationExceptionError>));
        ...
        ///  </li> <li> 
        /// <para>
        ///  <i>BUSINESS_VALIDATION_FAILED:</i> The requested change doesn't pass the business
        /// validation rules.
        /// </para>
        ///  
        /// <para>
