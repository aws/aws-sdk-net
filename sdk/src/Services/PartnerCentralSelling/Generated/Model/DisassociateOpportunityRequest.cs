...
namespace Amazon.PartnerCentralSelling.Model
{
    ...
    public partial class DisassociateOpportunityRequest : AmazonPartnerCentralSellingRequest
    {
        ...
        /// especially in environments with numerous opportunities. 
        /// </para>
        ///  
        /// <para>
        /// Validation: Ensure that the identifier provided corresponds to an existing opportunity
        ...
        ///  
        /// <para>
        /// Validation: Ensure the identifier or ARN is valid and corresponds to an existing related
        ...
        /// and ensures that the right connections are removed. 
        /// </para>
        ///  
        /// <para>
        ...
        ///  
        /// <para>
        /// Validation: Provide a valid entity type to ensure successful disassociation. Invalid
        /// or incorrect entity types result in an error. 
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
