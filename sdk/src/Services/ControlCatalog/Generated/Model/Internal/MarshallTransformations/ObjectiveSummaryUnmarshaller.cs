...
namespace Amazon.ControlCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ObjectiveSummaryUnmarshaller : IJsonUnmarshaller<ObjectiveSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ObjectiveSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
