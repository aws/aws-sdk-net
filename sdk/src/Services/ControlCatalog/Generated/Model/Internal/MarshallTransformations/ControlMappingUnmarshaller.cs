...
namespace Amazon.ControlCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ControlMappingUnmarshaller : IJsonUnmarshaller<ControlMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ControlMapping Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
