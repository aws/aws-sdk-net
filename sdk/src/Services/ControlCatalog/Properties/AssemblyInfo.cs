...
#elif NET10_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 10.0) - AWS Control Catalog. This is the initial SDK release for AWS Control Catalog, a central catalog for AWS managed controls. This release includes 3 new APIs - ListDomains, ListObjectives, and ListCommonControls - that vend high-level data to categorize controls across the AWS platform.")]

#elif NET11_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 11.0) - AWS Control Catalog. This is the initial SDK release for AWS Control Catalog, a central catalog for AWS managed controls. This release includes 3 new APIs - ListDomains, ListObjectives, and ListCommonControls - that vend high-level data to categorize controls across the AWS platform.")]
