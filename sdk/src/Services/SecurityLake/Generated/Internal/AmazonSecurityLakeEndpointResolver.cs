...
namespace Amazon.SecurityLake.Internal
{
    /// <summary>
    ...
    /// </summary>
    public class AmazonSecurityLakeEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSecurityLakeConfig)requestContext.ClientConfig;
            var result = new SecurityLakeEndpointParameters();
