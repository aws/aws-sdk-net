...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSubscriptionNotificationConfiguration operation
    /// </summary>  
    public class UpdateSubscriptionNotificationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSubscriptionNotificationConfigurationResponse response = new UpdateSubscriptionNotificationConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("queueArn", targetDepth))
                {
                    ...
                    response.QueueArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateSubscriptionNotificationConfigurationResponseUnmarshaller _instance = new UpdateSubscriptionNotificationConfigurationResponseUnmarshaller();        

        internal static UpdateSubscriptionNotificationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubscriptionNotificationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
