...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSubscriptionNotificationConfiguration operation
    /// </summary>  
    public class DeleteSubscriptionNotificationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSubscriptionNotificationConfigurationResponse response = new DeleteSubscriptionNotificationConfigurationResponse();
        ...
        private static DeleteSubscriptionNotificationConfigurationResponseUnmarshaller _instance = new DeleteSubscriptionNotificationConfigurationResponseUnmarshaller();        

        internal static DeleteSubscriptionNotificationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSubscriptionNotificationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
