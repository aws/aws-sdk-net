...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSubscriberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSubscriberResponse response = new CreateSubscriberResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SnsArn = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CreateSubscriberResponseUnmarshaller _instance = new CreateSubscriberResponseUnmarshaller();        

        internal static CreateSubscriberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
