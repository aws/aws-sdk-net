...
{
    /// <summary>
    /// Response Unmarshaller for CreateSubscriptionNotificationConfiguration operation
    /// </summary>  
    public class CreateSubscriptionNotificationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSubscriptionNotificationConfigurationResponse response = new CreateSubscriptionNotificationConfigurationResponse();
        ...
        private static CreateSubscriptionNotificationConfigurationResponseUnmarshaller _instance = new CreateSubscriptionNotificationConfigurationResponseUnmarshaller();        

        internal static CreateSubscriptionNotificationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriptionNotificationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
