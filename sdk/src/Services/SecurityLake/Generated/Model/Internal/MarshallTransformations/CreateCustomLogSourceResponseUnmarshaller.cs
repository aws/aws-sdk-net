...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCustomLogSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomLogSourceResponse response = new CreateCustomLogSourceResponse();
        ...
        private static CreateCustomLogSourceResponseUnmarshaller _instance = new CreateCustomLogSourceResponseUnmarshaller();        

        internal static CreateCustomLogSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomLogSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
