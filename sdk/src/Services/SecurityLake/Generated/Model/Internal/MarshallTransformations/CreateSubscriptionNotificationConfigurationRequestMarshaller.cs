...
{
    /// <summary>
    /// CreateSubscriptionNotificationConfiguration Request Marshaller
    /// </summary>       
    public class CreateSubscriptionNotificationConfigurationRequestMarshaller : IMarshaller<IRequest, CreateSubscriptionNotificationConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSubscriptionNotificationConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSubscriptionNotificationConfigurationRequest publicRequest)
        {
        ...
        private static CreateSubscriptionNotificationConfigurationRequestMarshaller _instance = new CreateSubscriptionNotificationConfigurationRequestMarshaller();        

        internal static CreateSubscriptionNotificationConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriptionNotificationConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
