...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    public class CustomLogSourceResourceUnmarshaller : IJsonUnmarshaller<CustomLogSourceResource, JsonUnmarshallerContext>
    {
        ...
        private static CustomLogSourceResourceUnmarshaller _instance = new CustomLogSourceResourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomLogSourceResourceUnmarshaller Instance
        {
            get
            {
                return _instance;
