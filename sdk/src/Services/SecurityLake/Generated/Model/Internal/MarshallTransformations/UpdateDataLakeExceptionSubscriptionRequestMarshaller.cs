...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateDataLakeExceptionSubscriptionRequestMarshaller : IMarshaller<IRequest, UpdateDataLakeExceptionSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateDataLakeExceptionSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateDataLakeExceptionSubscriptionRequest publicRequest)
        {
        ...
        private static UpdateDataLakeExceptionSubscriptionRequestMarshaller _instance = new UpdateDataLakeExceptionSubscriptionRequestMarshaller();        

        internal static UpdateDataLakeExceptionSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataLakeExceptionSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
