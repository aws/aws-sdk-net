...
namespace Amazon.SecurityLake.Model
{
    ...
    /// </summary>
    internal sealed partial class ListSubscribersPaginator : IPaginator<ListSubscribersResponse>, IListSubscribersPaginator
    {
        private readonly IAmazonSecurityLake _client;
        private readonly ListSubscribersRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListSubscribersResponse> Responses => new PaginatedResponse<ListSubscribersResponse>(this);
...
#if BCL
        IEnumerable<ListSubscribersResponse> IPaginator<ListSubscribersResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListSubscribers(_request);
        ...
        async IAsyncEnumerable<ListSubscribersResponse> IPaginator<ListSubscribersResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListSubscribersAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
