...
{
    /// <summary>
    /// Container for the parameters to the ListConfigurationBundleVersions operation.
    /// Lists all versions of a configuration bundle, with optional filtering by branch name
    /// or creation source.
    /// </summary>
    public partial class ListConfigurationBundleVersionsRequest : AmazonBedrockAgentCoreControlRequest
    {
        private string _bundleId;
        private VersionFilter _filter;
        ...
        /// <para>
        /// An optional filter for listing versions, including branch name, creation source, and
        /// whether to return only the latest version per branch.
        /// </para>
        /// </summary>
