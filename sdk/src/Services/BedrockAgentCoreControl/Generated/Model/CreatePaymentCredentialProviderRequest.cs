...
{
    /// <summary>
    /// Container for the parameters to the CreatePaymentCredentialProvider operation.
    ...
    /// </summary>
    public partial class CreatePaymentCredentialProviderRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public PaymentProviderConfigurationInput ProviderConfigurationInput
        {
            get { return this._providerConfigurationInput; }
            set { this._providerConfigurationInput = value; }
        }

        // Check to see if ProviderConfigurationInput property is set
        internal bool IsSetProviderConfigurationInput()
        {
            return this._providerConfigurationInput != null;
        }
