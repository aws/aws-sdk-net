...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    public partial class GetRegistryRecordResponse : AmazonWebServiceResponse
    {
        ...
        /// For details, see the <c>Descriptors</c> data type.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <c>UPDATING</c>, <c>CREATE_FAILED</c>, and <c>UPDATE_FAILED</c>. A record transitions
        /// from <c>CREATING</c> to <c>DRAFT</c>, then to <c>PENDING_APPROVAL</c> (via <c>SubmitRegistryRecordForApproval</c>),
        /// and finally to <c>APPROVED</c> upon approval.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
