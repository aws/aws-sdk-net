...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    /// </summary>
    public partial class EpisodicMemoryStrategyInput
    {
        ...
        /// <summary>
        /// Gets and sets the property ReflectionConfiguration. 
        /// <para>
        /// The configuration for the reflections created with the episodic memory strategy.
        /// </para>
        /// </summary>
        public EpisodicReflectionConfigurationInput ReflectionConfiguration
        {
            get { return this._reflectionConfiguration; }
            set { this._reflectionConfiguration = value; }
        }

        // Check to see if ReflectionConfiguration property is set
        internal bool IsSetReflectionConfiguration()
        {
            return this._reflectionConfiguration != null;
        }
