...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    public partial class DeleteRegistryResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// The current status of the registry, set to <c>DELETING</c> when deletion is initiated.
        /// For a list of all possible registry statuses, see the <c>RegistryStatus</c> data type.
        /// </para>
        /// </summary>
