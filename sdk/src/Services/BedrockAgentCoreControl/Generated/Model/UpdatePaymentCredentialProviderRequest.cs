...
{
    /// <summary>
    /// Container for the parameters to the UpdatePaymentCredentialProvider operation.
    /// Updates an existing payment credential provider with new authentication credentials.
    /// </summary>
    public partial class UpdatePaymentCredentialProviderRequest : AmazonBedrockAgentCoreControlRequest
    {
