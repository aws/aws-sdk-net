...
{
    /// <summary>
    /// Container for the parameters to the CreateBrowserProfile operation.
    ...
    /// </summary>
    public partial class CreateBrowserProfileRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// A description of the browser profile. Use this field to describe the purpose or contents
        /// of the profile.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The name of the browser profile. The name must be unique within your account and can
        ...
        /// <para>
        /// A map of tag keys and values to assign to the browser profile. Tags enable you to
