...
{
    /// <summary>
    /// A summary of a capacity provider, as returned by <c>ListCapacityProviders</c>. Each
    /// summary includes the capacity provider identifier, Amazon Resource Name (ARN), name,
    /// status, and last-updated timestamp.
    /// </summary>
    public partial class CapacityProviderSummary
    {
