...
{
    /// <summary>
    /// Container for the parameters to the ListGatewayRateLimits operation.
    /// Lists all rate limits for a gateway. Results are paginated. Use the <c>nextToken</c>
    /// parameter to retrieve additional results.
    /// </summary>
    public partial class ListGatewayRateLimitsRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The token to use to retrieve the next page of results. Use the value returned in a
        /// previous <c>ListGatewayRateLimits</c> response.
        /// </para>
        /// </summary>
