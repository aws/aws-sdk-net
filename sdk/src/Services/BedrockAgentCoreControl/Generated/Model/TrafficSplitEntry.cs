...
{
    /// <summary>
    /// An entry in a traffic split configuration, defining a named variant with a weight
    /// and configuration bundle reference.
    /// </summary>
    public partial class TrafficSplitEntry
    {
        private ConfigurationBundleReference _configurationBundle;
        ...
        public ConfigurationBundleReference ConfigurationBundle
        {
        ...
        /// <para>
        /// The percentage of traffic to route to this variant. Weights across all entries must
        /// sum to 100.
        /// </para>
        /// </summary>
