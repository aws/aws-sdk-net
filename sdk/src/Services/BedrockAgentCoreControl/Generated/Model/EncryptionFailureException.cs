...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    [Serializable]
    #endif
    public partial class EncryptionFailureException : AmazonBedrockAgentCoreControlException
    {
        ...
        public EncryptionFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EncryptionFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
