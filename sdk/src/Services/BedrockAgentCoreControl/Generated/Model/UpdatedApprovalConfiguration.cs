...
{
    /// <summary>
    /// Wrapper for updating an optional approval configuration field with PATCH semantics.
    /// When present in an update request, the approval configuration is replaced with the
    /// provided value. When absent, the approval configuration is left unchanged.
    /// </summary>
    public partial class UpdatedApprovalConfiguration
    {
        ...
        /// <para>
        /// The updated approval configuration value. Set to <c>null</c> to unset the approval
        /// configuration.
        /// </para>
        /// </summary>
