...
{
    /// <summary>
    /// The server definition for an MCP descriptor. Contains the schema version and inline
    /// content for the MCP server configuration.
    /// </summary>
    public partial class ServerDefinition
    {
        ...
        /// <para>
        /// The JSON content containing the MCP server definition, conforming to the MCP protocol
        /// specification.
        /// </para>
        /// </summary>
