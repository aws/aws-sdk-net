...
{
    /// <summary>
    /// Configuration for periodic batch evaluation clustering, specifying how often clustering
    /// jobs run.
    /// </summary>
    public partial class ClusteringConfig
    {
        private List<string> _frequencies = AWSConfigs.InitializeCollections ? new List<string>() : null;
