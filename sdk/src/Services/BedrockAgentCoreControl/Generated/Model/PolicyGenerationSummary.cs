...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    /// contains resource identifiers, status, timestamps, and findings without customer-encrypted
    /// fields such as status reasons. Policy generation summaries are returned by operations
    /// that do not require access to the customer's KMS key.
    /// </summary>
    public partial class PolicyGenerationSummary
    {
