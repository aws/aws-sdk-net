...
{
    /// <summary>
    /// Container for the parameters to the DeleteRegistryRecord operation.
    /// Deletes a registry record. The record's status transitions to <c>DELETING</c> and
    /// the record is removed asynchronously.
    /// </summary>
    public partial class DeleteRegistryRecordRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The identifier of the registry record to delete. You can specify either the Amazon
