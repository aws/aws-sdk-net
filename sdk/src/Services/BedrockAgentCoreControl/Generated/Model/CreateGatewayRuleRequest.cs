...
{
    /// <summary>
    /// Container for the parameters to the CreateGatewayRule operation.
    ...
    /// </summary>
    public partial class CreateGatewayRuleRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The actions to take when the rule conditions are met. Actions can route to a specific
        /// target or apply a configuration bundle override.
        /// </para>
        /// <para />
        ...
        /// <para>
        /// The conditions that must be met for the rule to apply. Conditions can match on principals
        /// (IAM ARNs) or request paths.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        ...
        /// evaluated first. Must be between 1 and 1,000,000.
        /// </para>
        /// </summary>
