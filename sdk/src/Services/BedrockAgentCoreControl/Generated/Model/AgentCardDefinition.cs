...
{
    /// <summary>
    /// The agent card definition for an A2A descriptor. Contains the schema version and inline
    /// content for the agent card.
    /// </summary>
    public partial class AgentCardDefinition
    {
        ...
        /// <para>
        /// The JSON content containing the A2A agent card definition, conforming to the A2A protocol
        /// specification.
        /// </para>
        /// </summary>
