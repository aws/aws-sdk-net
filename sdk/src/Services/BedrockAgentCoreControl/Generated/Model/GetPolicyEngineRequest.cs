...
{
    /// <summary>
    /// Container for the parameters to the GetPolicyEngine operation.
    ...
    /// </summary>
    public partial class GetPolicyEngineRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The unique identifier of the policy engine to be retrieved. This must be a valid policy
