...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    internal sealed partial class ListCapacityProvidersPaginator : IPaginator<ListCapacityProvidersResponse>, IListCapacityProvidersPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<CapacityProviderSummary> CapacityProviders => 
            new PaginatedResultKeyResponse<ListCapacityProvidersResponse, CapacityProviderSummary>(this, (i) => i.CapacityProviders ?? new List<CapacityProviderSummary>());

        internal ListCapacityProvidersPaginator(IAmazonBedrockAgentCoreControl client, ListCapacityProvidersRequest request)
        {
            this._client = client;
