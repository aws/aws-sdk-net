...
{
    /// <summary>
    /// Container for the parameters to the CreateConsentPortal operation.
    /// Creates a new consent portal.
    /// </summary>
    public partial class CreateConsentPortalRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The resources served by the consent portal. Currently, we only support type <c>agentcore-gateway</c>.
        /// </para>
        /// <para />
        ...
        /// <para>
        /// A map of tag keys and values to assign to the consent portal. Tags enable you to categorize
