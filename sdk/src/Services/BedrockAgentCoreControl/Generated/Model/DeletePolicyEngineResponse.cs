...
{
    /// <summary>
    /// This is the response object from the DeletePolicyEngine operation.
    /// </summary>
    public partial class DeletePolicyEngineResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) of the deleted policy engine. This globally unique
        /// identifier confirms which policy engine resource was successfully removed.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The unique identifier of the policy engine being deleted. This confirms which policy
        /// engine the deletion operation targets.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The status of the policy engine deletion operation. This provides status about any
        /// issues that occurred during the deletion process.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// Additional information about the deletion status. This provides details about the
        /// deletion process or any issues that may have occurred.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// The timestamp when the deleted policy engine was last modified before deletion. This
        /// tracks the final state of the policy engine before it was removed from the system.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
