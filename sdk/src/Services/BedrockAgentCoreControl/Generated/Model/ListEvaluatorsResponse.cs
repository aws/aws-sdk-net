...
{
    /// <summary>
    /// This is the response object from the ListEvaluators operation.
    /// </summary>
    public partial class ListEvaluatorsResponse : AmazonWebServiceResponse
    {
        private List<EvaluatorSummary> _evaluators = AWSConfigs.InitializeCollections ? new List<EvaluatorSummary>() : null;
        ...
        public List<EvaluatorSummary> Evaluators
        {
