...
{
    /// <summary>
    /// This is the response object from the ListConfigurationBundles operation.
    /// </summary>
    public partial class ListConfigurationBundlesResponse : AmazonWebServiceResponse
    {
        private List<ConfigurationBundleSummary> _bundles = AWSConfigs.InitializeCollections ? new List<ConfigurationBundleSummary>() : null;
        ...
        public List<ConfigurationBundleSummary> Bundles
        {
