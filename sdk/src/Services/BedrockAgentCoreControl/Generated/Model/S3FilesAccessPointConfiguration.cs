...
{
    /// <summary>
    /// Configuration for an Amazon S3 Files access point filesystem mounted into the AgentCore
    /// Runtime. S3 Files access points provide shared file storage accessible from your AgentCore
    /// Runtime sessions.
    /// </summary>
    public partial class S3FilesAccessPointConfiguration
    {
        ...
        /// <para>
        /// The mount path for the S3 Files access point inside the AgentCore Runtime. The path
        /// must be under <c>/mnt</c> with exactly one subdirectory level (for example, <c>/mnt/data</c>).
        /// </para>
        /// </summary>
