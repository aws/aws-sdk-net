...
{
    /// <summary>
    /// Configuration for an inline function tool. When the agent calls this tool, the tool
    /// call is returned to the caller for external execution.
    /// </summary>
    public partial class HarnessInlineFunctionConfig
    {
