...
{
    /// <summary>
    /// Container for the parameters to the CreateCodeInterpreter operation.
    /// Creates a custom code interpreter.
    /// </summary>
    public partial class CreateCodeInterpreterRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) of the IAM role that provides permissions for the code
        /// interpreter to access Amazon Web Services services.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The file system configurations to mount into the code interpreter. Use these configurations
        ...
        /// you don't specify this field, no file systems are mounted.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        ...
        /// <para>
        /// The network configuration for the code interpreter. This configuration specifies the
        /// network mode for the code interpreter.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// A map of tag keys and values to assign to the code interpreter. Tags enable you to
