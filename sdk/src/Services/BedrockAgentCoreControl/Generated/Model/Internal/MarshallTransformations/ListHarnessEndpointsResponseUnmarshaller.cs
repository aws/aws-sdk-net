...
{
    /// <summary>
    /// Response Unmarshaller for ListHarnessEndpoints operation
    /// </summary>  
    public class ListHarnessEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListHarnessEndpointsResponse response = new ListHarnessEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HarnessEndpoint, HarnessEndpointUnmarshaller>(HarnessEndpointUnmarshaller.Instance);
        ...
        private static ListHarnessEndpointsResponseUnmarshaller _instance = new ListHarnessEndpointsResponseUnmarshaller();        

        internal static ListHarnessEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHarnessEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
