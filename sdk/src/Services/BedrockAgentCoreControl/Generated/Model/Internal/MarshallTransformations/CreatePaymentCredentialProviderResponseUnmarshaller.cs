...
{
    /// <summary>
    /// Response Unmarshaller for CreatePaymentCredentialProvider operation
    /// </summary>  
    public class CreatePaymentCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePaymentCredentialProviderResponse response = new CreatePaymentCredentialProviderResponse();
        ...
        private static CreatePaymentCredentialProviderResponseUnmarshaller _instance = new CreatePaymentCredentialProviderResponseUnmarshaller();        

        internal static CreatePaymentCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePaymentCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
