    ...
    public class GetAgentRuntimeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("agentRuntimeArtifact", targetDepth, ref reader))
                {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PlatformVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("requestHeaderConfiguration", targetDepth, ref reader))
                {
