        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("agentRuntimeArtifact", targetDepth))
                {
                    ...
                    response.AgentRuntimeArtifact = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AgentRuntimeName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FilesystemConfiguration, FilesystemConfigurationUnmarshaller>(FilesystemConfigurationUnmarshaller.Instance);
                    response.FilesystemConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("requestHeaderConfiguration", targetDepth))
                {
                    ...
                    response.RequestHeaderConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
