...
{
    /// <summary>
    /// DeletePaymentConnector Request Marshaller
    /// </summary>       
    public class DeletePaymentConnectorRequestMarshaller : IMarshaller<IRequest, DeletePaymentConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePaymentConnectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePaymentConnectorRequest publicRequest)
        {
        ...
        private static DeletePaymentConnectorRequestMarshaller _instance = new DeletePaymentConnectorRequestMarshaller();        

        internal static DeletePaymentConnectorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePaymentConnectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
