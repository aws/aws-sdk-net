...
{
    /// <summary>
    /// Response Unmarshaller for GetPaymentManager operation
    /// </summary>  
    public class GetPaymentManagerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPaymentManagerResponse response = new GetPaymentManagerResponse();
        ...
        private static GetPaymentManagerResponseUnmarshaller _instance = new GetPaymentManagerResponseUnmarshaller();        

        internal static GetPaymentManagerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPaymentManagerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
