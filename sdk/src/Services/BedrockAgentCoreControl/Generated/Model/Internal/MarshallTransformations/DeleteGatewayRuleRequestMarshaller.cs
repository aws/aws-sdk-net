...
{
    /// <summary>
    /// DeleteGatewayRule Request Marshaller
    /// </summary>       
    public class DeleteGatewayRuleRequestMarshaller : IMarshaller<IRequest, DeleteGatewayRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteGatewayRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteGatewayRuleRequest publicRequest)
        {
        ...
        private static DeleteGatewayRuleRequestMarshaller _instance = new DeleteGatewayRuleRequestMarshaller();        

        internal static DeleteGatewayRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGatewayRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
