...
{
    /// <summary>
    /// Response Unmarshaller for CreateMemory operation
    /// </summary>  
    public class CreateMemoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMemoryResponse response = new CreateMemoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = MemoryUnmarshaller.Instance;
                    response.Memory = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateMemoryResponseUnmarshaller _instance = new CreateMemoryResponseUnmarshaller();        

        internal static CreateMemoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMemoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
