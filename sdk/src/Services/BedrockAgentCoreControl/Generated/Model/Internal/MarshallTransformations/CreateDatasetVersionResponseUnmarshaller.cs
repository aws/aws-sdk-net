...
{
    /// <summary>
    /// Response Unmarshaller for CreateDatasetVersion operation
    /// </summary>  
    public class CreateDatasetVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateDatasetVersionResponseUnmarshaller _instance = new CreateDatasetVersionResponseUnmarshaller();        

        internal static CreateDatasetVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDatasetVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
