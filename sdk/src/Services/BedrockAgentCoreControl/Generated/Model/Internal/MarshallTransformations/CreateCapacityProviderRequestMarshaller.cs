...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    public class CreateCapacityProviderRequestMarshaller : IMarshaller<IRequest, CreateCapacityProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateCapacityProviderRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetPermissionsConfiguration())
            {
                context.Writer.WritePropertyName("permissionsConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = PermissionsConfigurationMarshaller.Instance;
                marshaller.Marshall(publicRequest.PermissionsConfiguration, context);
