...
{
    /// <summary>
    /// Response Unmarshaller for GetOauth2CredentialProvider operation
    /// </summary>  
    public class GetOauth2CredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOauth2CredentialProviderResponse response = new GetOauth2CredentialProviderResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return DecryptionFailureExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetOauth2CredentialProviderResponseUnmarshaller _instance = new GetOauth2CredentialProviderResponseUnmarshaller();        

        internal static GetOauth2CredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOauth2CredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
