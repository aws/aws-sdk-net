...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateCapacityProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCapacityProviderResponse response = new UpdateCapacityProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("capacityProviderId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CapacityProviderId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateCapacityProviderResponseUnmarshaller _instance = new UpdateCapacityProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCapacityProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
