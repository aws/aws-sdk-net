...
{
    /// <summary>
    /// EphemeralEBSVolumeConfiguration Marshaller
    /// </summary>
    public class EphemeralEBSVolumeConfigurationMarshaller : IRequestMarshaller<EphemeralEBSVolumeConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EphemeralEBSVolumeConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetEbsCardIndex())
            {
                context.Writer.WritePropertyName("ebsCardIndex");
                context.Writer.WriteNumberValue(requestObject.EbsCardIndex.Value);
            }
        ...
        /// </summary>
        public readonly static EphemeralEBSVolumeConfigurationMarshaller Instance = new EphemeralEBSVolumeConfigurationMarshaller();
