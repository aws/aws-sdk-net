...
{
    /// <summary>
    /// UpdateGatewayRule Request Marshaller
    /// </summary>       
    public class UpdateGatewayRuleRequestMarshaller : IMarshaller<IRequest, UpdateGatewayRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateGatewayRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateGatewayRuleRequest publicRequest)
        {
        ...
        private static UpdateGatewayRuleRequestMarshaller _instance = new UpdateGatewayRuleRequestMarshaller();        

        internal static UpdateGatewayRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGatewayRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
