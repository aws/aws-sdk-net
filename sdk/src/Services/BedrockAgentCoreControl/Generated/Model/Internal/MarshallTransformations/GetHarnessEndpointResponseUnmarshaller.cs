...
{
    /// <summary>
    /// Response Unmarshaller for GetHarnessEndpoint operation
    /// </summary>  
    public class GetHarnessEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHarnessEndpointResponse response = new GetHarnessEndpointResponse();
        ...
        private static GetHarnessEndpointResponseUnmarshaller _instance = new GetHarnessEndpointResponseUnmarshaller();        

        internal static GetHarnessEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHarnessEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
