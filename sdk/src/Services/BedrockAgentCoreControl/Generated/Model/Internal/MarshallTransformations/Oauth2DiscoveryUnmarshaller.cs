...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class Oauth2DiscoveryUnmarshaller : IUnmarshaller<Oauth2Discovery, XmlUnmarshallerContext>, IUnmarshaller<Oauth2Discovery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Oauth2Discovery IUnmarshaller<Oauth2Discovery, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Oauth2Discovery Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("authorizationServerMetadata", targetDepth))
                {
                    ...
                    unmarshalledObject.AuthorizationServerMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
