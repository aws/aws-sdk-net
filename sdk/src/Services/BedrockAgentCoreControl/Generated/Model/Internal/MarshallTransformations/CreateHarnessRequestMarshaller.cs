...
{
    /// <summary>
    /// CreateHarness Request Marshaller
    /// </summary>       
    public class CreateHarnessRequestMarshaller : IMarshaller<IRequest, CreateHarnessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateHarnessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateHarnessRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetHarnessName())
            {
                context.Writer.WritePropertyName("harnessName");
            ...
            if(publicRequest.IsSetMemory())
            {
                ...
                var marshaller = HarnessMemoryConfigurationMarshaller.Instance;
        ...
        private static CreateHarnessRequestMarshaller _instance = new CreateHarnessRequestMarshaller();        

        internal static CreateHarnessRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHarnessRequestMarshaller Instance
        {
            get
            {
                return _instance;
