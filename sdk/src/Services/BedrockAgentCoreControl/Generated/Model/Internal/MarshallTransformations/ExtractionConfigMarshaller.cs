    ...
    public class ExtractionConfigMarshaller : IRequestMarshaller<ExtractionConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ExtractionConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetLlmExtractionConfig())
            {
                context.Writer.WritePropertyName("llmExtractionConfig");
                context.Writer.WriteStartObject();

                var marshaller = LlmExtractionConfigMarshaller.Instance;
                marshaller.Marshall(requestObject.LlmExtractionConfig, context);
