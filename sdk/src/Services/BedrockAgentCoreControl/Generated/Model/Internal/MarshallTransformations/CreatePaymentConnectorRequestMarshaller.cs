...
{
    /// <summary>
    /// CreatePaymentConnector Request Marshaller
    /// </summary>       
    public class CreatePaymentConnectorRequestMarshaller : IMarshaller<IRequest, CreatePaymentConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePaymentConnectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePaymentConnectorRequest publicRequest)
        {
            ...
            request.ResourcePath = "/payments/managers/{paymentManagerId}/connectors";
#if !NETFRAMEWORK
        ...
        private static CreatePaymentConnectorRequestMarshaller _instance = new CreatePaymentConnectorRequestMarshaller();        

        internal static CreatePaymentConnectorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePaymentConnectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
