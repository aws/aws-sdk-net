...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationBundle operation
    /// </summary>  
    public class UpdateConfigurationBundleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationBundleResponse response = new UpdateConfigurationBundleResponse();
        ...
        private static UpdateConfigurationBundleResponseUnmarshaller _instance = new UpdateConfigurationBundleResponseUnmarshaller();        

        internal static UpdateConfigurationBundleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
