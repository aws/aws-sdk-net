...
{
    /// <summary>
    /// UpdateHarnessEndpoint Request Marshaller
    /// </summary>       
    public class UpdateHarnessEndpointRequestMarshaller : IMarshaller<IRequest, UpdateHarnessEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateHarnessEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateHarnessEndpointRequest publicRequest)
        {
        ...
        private static UpdateHarnessEndpointRequestMarshaller _instance = new UpdateHarnessEndpointRequestMarshaller();        

        internal static UpdateHarnessEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHarnessEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
