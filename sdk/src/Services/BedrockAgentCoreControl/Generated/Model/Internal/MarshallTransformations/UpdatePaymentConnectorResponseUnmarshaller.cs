...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePaymentConnector operation
    /// </summary>  
    public class UpdatePaymentConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePaymentConnectorResponse response = new UpdatePaymentConnectorResponse();
        ...
        private static UpdatePaymentConnectorResponseUnmarshaller _instance = new UpdatePaymentConnectorResponseUnmarshaller();        

        internal static UpdatePaymentConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePaymentConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
