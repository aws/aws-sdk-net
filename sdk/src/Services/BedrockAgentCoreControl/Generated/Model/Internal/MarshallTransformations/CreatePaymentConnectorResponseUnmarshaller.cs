...
{
    /// <summary>
    /// Response Unmarshaller for CreatePaymentConnector operation
    /// </summary>  
    public class CreatePaymentConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePaymentConnectorResponse response = new CreatePaymentConnectorResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SubscriptionRequiredException"))
                {
                    return SubscriptionRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreatePaymentConnectorResponseUnmarshaller _instance = new CreatePaymentConnectorResponseUnmarshaller();        

        internal static CreatePaymentConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePaymentConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
