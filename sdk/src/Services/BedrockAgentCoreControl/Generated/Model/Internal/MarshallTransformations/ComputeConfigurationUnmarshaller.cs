...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComputeConfigurationUnmarshaller : IJsonUnmarshaller<ComputeConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComputeConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = Ec2ConfigurationUnmarshaller.Instance;
