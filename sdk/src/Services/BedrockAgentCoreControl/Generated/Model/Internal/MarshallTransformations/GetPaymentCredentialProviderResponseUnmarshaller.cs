...
{
    /// <summary>
    /// Response Unmarshaller for GetPaymentCredentialProvider operation
    /// </summary>  
    public class GetPaymentCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPaymentCredentialProviderResponse response = new GetPaymentCredentialProviderResponse();
        ...
        private static GetPaymentCredentialProviderResponseUnmarshaller _instance = new GetPaymentCredentialProviderResponseUnmarshaller();        

        internal static GetPaymentCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPaymentCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
