...
{
    /// <summary>
    /// GetPaymentConnector Request Marshaller
    /// </summary>       
    public class GetPaymentConnectorRequestMarshaller : IMarshaller<IRequest, GetPaymentConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPaymentConnectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPaymentConnectorRequest publicRequest)
        {
        ...
        private static GetPaymentConnectorRequestMarshaller _instance = new GetPaymentConnectorRequestMarshaller();        

        internal static GetPaymentConnectorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPaymentConnectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
