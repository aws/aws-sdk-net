...
{
    /// <summary>
    /// Response Unmarshaller for HarnessToolConfiguration Object
    /// </summary>  
    public class HarnessToolConfigurationUnmarshaller : IJsonUnmarshaller<HarnessToolConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessToolConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessToolConfiguration unmarshalledObject = new HarnessToolConfiguration();
        ...
        private static HarnessToolConfigurationUnmarshaller _instance = new HarnessToolConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessToolConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
