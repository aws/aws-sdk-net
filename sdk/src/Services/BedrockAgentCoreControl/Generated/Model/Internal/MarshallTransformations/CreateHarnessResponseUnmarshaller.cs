...
{
    /// <summary>
    /// Response Unmarshaller for CreateHarness operation
    /// </summary>  
    public class CreateHarnessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHarnessResponse response = new CreateHarnessResponse();
        ...
        private static CreateHarnessResponseUnmarshaller _instance = new CreateHarnessResponseUnmarshaller();        

        internal static CreateHarnessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHarnessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
