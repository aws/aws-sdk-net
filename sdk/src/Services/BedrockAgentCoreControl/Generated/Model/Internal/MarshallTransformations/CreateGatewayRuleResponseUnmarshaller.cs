...
{
    /// <summary>
    /// Response Unmarshaller for CreateGatewayRule operation
    /// </summary>  
    public class CreateGatewayRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGatewayRuleResponse response = new CreateGatewayRuleResponse();
        ...
        private static CreateGatewayRuleResponseUnmarshaller _instance = new CreateGatewayRuleResponseUnmarshaller();        

        internal static CreateGatewayRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGatewayRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
