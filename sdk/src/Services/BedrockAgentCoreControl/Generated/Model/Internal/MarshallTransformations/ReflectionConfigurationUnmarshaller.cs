...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReflectionConfigurationUnmarshaller : IUnmarshaller<ReflectionConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ReflectionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReflectionConfiguration IUnmarshaller<ReflectionConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ReflectionConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("customReflectionConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomReflectionConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("episodicReflectionConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.EpisodicReflectionConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
