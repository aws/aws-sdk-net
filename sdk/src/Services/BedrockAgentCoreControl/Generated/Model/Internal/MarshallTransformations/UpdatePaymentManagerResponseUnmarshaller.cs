...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePaymentManager operation
    /// </summary>  
    public class UpdatePaymentManagerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePaymentManagerResponse response = new UpdatePaymentManagerResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("paymentManagerArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PaymentManagerArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdatePaymentManagerResponseUnmarshaller _instance = new UpdatePaymentManagerResponseUnmarshaller();        

        internal static UpdatePaymentManagerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePaymentManagerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
