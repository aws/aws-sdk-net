...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkConfigurationUnmarshaller : IJsonUnmarshaller<NetworkConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("networkModeConfig", targetDepth, ref reader))
                {
                    var unmarshaller = VpcConfigUnmarshaller.Instance;
                    unmarshalledObject.NetworkModeConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
