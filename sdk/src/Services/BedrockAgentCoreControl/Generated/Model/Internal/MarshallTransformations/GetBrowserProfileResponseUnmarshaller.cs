    ...
    public class GetBrowserProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.LastSavedAt = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastSavedBrowserId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastSavedBrowserId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastSavedBrowserSessionId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastSavedBrowserSessionId = unmarshaller.Unmarshall(context);
                    continue;
                }
