...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRegistryRequestMarshaller : IMarshaller<IRequest, DeleteRegistryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteRegistryRequestMarshaller _instance = new DeleteRegistryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegistryRequestMarshaller Instance
        {
            get
            {
                return _instance;
