        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("authorizerConfiguration", targetDepth))
                {
                    ...
                    response.AuthorizerConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("exceptionLevel", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExceptionLevel = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("gatewayUrl", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("protocolConfiguration", targetDepth))
                {
                    ...
                    response.ProtocolConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("statusReasons", targetDepth))
                {
                    ...
                    response.StatusReasons = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("workloadIdentityDetails", targetDepth))
                {
                    ...
                    response.WorkloadIdentityDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
