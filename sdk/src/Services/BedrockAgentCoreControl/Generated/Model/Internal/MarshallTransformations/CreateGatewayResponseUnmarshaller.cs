...
{
    /// <summary>
    /// Response Unmarshaller for CreateGateway operation
    /// </summary>  
    public class CreateGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("customTransformConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = CustomTransformConfigurationUnmarshaller.Instance;
                    response.CustomTransformConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("exceptionLevel", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExceptionLevel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("gatewayUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GatewayUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("interceptorConfigurations", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("policyEngineConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("wafConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = WafConfigurationUnmarshaller.Instance;
                    response.WafConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("workloadIdentityDetails", targetDepth, ref reader))
                {
        ...
        private static CreateGatewayResponseUnmarshaller _instance = new CreateGatewayResponseUnmarshaller();        

        internal static CreateGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
