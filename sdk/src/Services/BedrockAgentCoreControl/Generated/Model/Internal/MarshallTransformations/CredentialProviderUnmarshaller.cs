...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CredentialProviderUnmarshaller : IUnmarshaller<CredentialProvider, XmlUnmarshallerContext>, IUnmarshaller<CredentialProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CredentialProvider IUnmarshaller<CredentialProvider, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CredentialProvider Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("apiKeyCredentialProvider", targetDepth))
                {
                    ...
                    unmarshalledObject.ApiKeyCredentialProvider = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("oauthCredentialProvider", targetDepth))
                {
                    ...
                    unmarshalledObject.OauthCredentialProvider = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
