...
{
    /// <summary>
    /// Response Unmarshaller for CreateHarnessEndpoint operation
    /// </summary>  
    public class CreateHarnessEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHarnessEndpointResponse response = new CreateHarnessEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = HarnessEndpointUnmarshaller.Instance;
        ...
        private static CreateHarnessEndpointResponseUnmarshaller _instance = new CreateHarnessEndpointResponseUnmarshaller();        

        internal static CreateHarnessEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHarnessEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
