...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGatewayRule operation
    /// </summary>  
    public class UpdateGatewayRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGatewayRuleResponse response = new UpdateGatewayRuleResponse();
        ...
        private static UpdateGatewayRuleResponseUnmarshaller _instance = new UpdateGatewayRuleResponseUnmarshaller();        

        internal static UpdateGatewayRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGatewayRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
