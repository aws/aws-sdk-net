...
{
    /// <summary>
    /// DeleteGatewayTarget Request Marshaller
    /// </summary>       
    public class DeleteGatewayTargetRequestMarshaller : IMarshaller<IRequest, DeleteGatewayTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteGatewayTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteGatewayTargetRequest publicRequest)
        {
        ...
        private static DeleteGatewayTargetRequestMarshaller _instance = new DeleteGatewayTargetRequestMarshaller();        

        internal static DeleteGatewayTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGatewayTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
