...
{
    /// <summary>
    /// Response Unmarshaller for ListDatasetExamples operation
    /// </summary>  
    public class ListDatasetExamplesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDatasetExamplesResponse response = new ListDatasetExamplesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("examples", targetDepth, ref reader))
                {
                    ...
                    response.Examples = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDatasetExamplesResponseUnmarshaller _instance = new ListDatasetExamplesResponseUnmarshaller();        

        internal static ListDatasetExamplesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDatasetExamplesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
