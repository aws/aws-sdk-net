    ...
    public class ActionMarshaller : IRequestMarshaller<Action, JsonMarshallerContext> 
    {
        ...
        public void Marshall(Action requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetConfigurationBundle())
            {
                ...
                var marshaller = ConfigurationBundleActionMarshaller.Instance;
                marshaller.Marshall(requestObject.ConfigurationBundle, context);

                context.Writer.WriteEndObject();
            }

            if(requestObject.IsSetRouteToTarget())
            {
                context.Writer.WritePropertyName("routeToTarget");
                context.Writer.WriteStartObject();

                var marshaller = RouteToTargetActionMarshaller.Instance;
                marshaller.Marshall(requestObject.RouteToTarget, context);
