...
{
    /// <summary>
    /// Response Unmarshaller for GetPolicySummary operation
    /// </summary>  
    public class GetPolicySummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPolicySummaryResponse response = new GetPolicySummaryResponse();
        ...
        private static GetPolicySummaryResponseUnmarshaller _instance = new GetPolicySummaryResponseUnmarshaller();        

        internal static GetPolicySummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPolicySummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
