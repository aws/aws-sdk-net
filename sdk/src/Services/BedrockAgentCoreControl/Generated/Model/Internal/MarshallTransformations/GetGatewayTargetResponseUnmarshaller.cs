        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("credentialProviderConfigurations", targetDepth))
                {
                    ...
                    response.CredentialProviderConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.LastSynchronizedAt = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("targetConfiguration", targetDepth))
                {
                    ...
                    response.TargetConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
