...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRegistry operation
    /// </summary>  
    public class UpdateRegistryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRegistryResponse response = new UpdateRegistryResponse();
            ...
            {
                if (context.TestExpression("approvalConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = ApprovalConfigurationUnmarshaller.Instance;
        ...
        private static UpdateRegistryResponseUnmarshaller _instance = new UpdateRegistryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRegistryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
