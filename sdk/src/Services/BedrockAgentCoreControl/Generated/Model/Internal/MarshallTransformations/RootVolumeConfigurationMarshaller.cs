...
{
    /// <summary>
    /// RootVolumeConfiguration Marshaller
    /// </summary>
    public class RootVolumeConfigurationMarshaller : IRequestMarshaller<RootVolumeConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RootVolumeConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFreeSpaceGiB())
            {
                context.Writer.WritePropertyName("freeSpaceGiB");
                context.Writer.WriteNumberValue(requestObject.FreeSpaceGiB.Value);
            }
        ...
        /// </summary>
        public readonly static RootVolumeConfigurationMarshaller Instance = new RootVolumeConfigurationMarshaller();
