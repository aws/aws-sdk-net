...
{
    /// <summary>
    /// Response Unmarshaller for DeletePaymentCredentialProvider operation
    /// </summary>  
    public class DeletePaymentCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePaymentCredentialProviderResponse response = new DeletePaymentCredentialProviderResponse();
        ...
        private static DeletePaymentCredentialProviderResponseUnmarshaller _instance = new DeletePaymentCredentialProviderResponseUnmarshaller();        

        internal static DeletePaymentCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePaymentCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
