...
{
    /// <summary>
    /// DeleteHarnessEndpoint Request Marshaller
    /// </summary>       
    public class DeleteHarnessEndpointRequestMarshaller : IMarshaller<IRequest, DeleteHarnessEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteHarnessEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteHarnessEndpointRequest publicRequest)
        {
        ...
        private static DeleteHarnessEndpointRequestMarshaller _instance = new DeleteHarnessEndpointRequestMarshaller();        

        internal static DeleteHarnessEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHarnessEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
