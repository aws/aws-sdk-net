...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    public class CustomJWTAuthorizerConfigurationUnmarshaller : IJsonUnmarshaller<CustomJWTAuthorizerConfiguration, JsonUnmarshallerContext>
    {
        ...
        public CustomJWTAuthorizerConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("advertisedScopeMapping", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.AdvertisedScopeMapping = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("allowedWorkloadConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = AllowedWorkloadConfigurationUnmarshaller.Instance;
                    unmarshalledObject.AllowedWorkloadConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
