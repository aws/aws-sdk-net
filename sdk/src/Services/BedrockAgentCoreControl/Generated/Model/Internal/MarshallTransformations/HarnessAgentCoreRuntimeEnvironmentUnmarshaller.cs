...
{
    /// <summary>
    /// Response Unmarshaller for HarnessAgentCoreRuntimeEnvironment Object
    /// </summary>  
    public class HarnessAgentCoreRuntimeEnvironmentUnmarshaller : IJsonUnmarshaller<HarnessAgentCoreRuntimeEnvironment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessAgentCoreRuntimeEnvironment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessAgentCoreRuntimeEnvironment unmarshalledObject = new HarnessAgentCoreRuntimeEnvironment();
        ...
        private static HarnessAgentCoreRuntimeEnvironmentUnmarshaller _instance = new HarnessAgentCoreRuntimeEnvironmentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessAgentCoreRuntimeEnvironmentUnmarshaller Instance
        {
            get
            {
                return _instance;
