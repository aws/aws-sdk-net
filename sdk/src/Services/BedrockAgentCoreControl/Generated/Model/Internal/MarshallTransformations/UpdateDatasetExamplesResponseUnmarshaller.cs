...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDatasetExamples operation
    /// </summary>  
    public class UpdateDatasetExamplesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDatasetExamplesResponse response = new UpdateDatasetExamplesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("updatedCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.UpdatedCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateDatasetExamplesResponseUnmarshaller _instance = new UpdateDatasetExamplesResponseUnmarshaller();        

        internal static UpdateDatasetExamplesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDatasetExamplesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
