...
{
    /// <summary>
    /// Response Unmarshaller for GetCapacityProvider operation
    /// </summary>  
    public class GetCapacityProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCapacityProviderResponse response = new GetCapacityProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("permissionsConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = PermissionsConfigurationUnmarshaller.Instance;
                    response.PermissionsConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetCapacityProviderResponseUnmarshaller _instance = new GetCapacityProviderResponseUnmarshaller();        

        internal static GetCapacityProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCapacityProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
