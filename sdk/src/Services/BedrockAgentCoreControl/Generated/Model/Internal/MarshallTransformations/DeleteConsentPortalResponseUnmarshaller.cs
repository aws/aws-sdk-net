...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConsentPortal operation
    /// </summary>  
    public class DeleteConsentPortalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConsentPortalResponse response = new DeleteConsentPortalResponse();
        ...
        private static DeleteConsentPortalResponseUnmarshaller _instance = new DeleteConsentPortalResponseUnmarshaller();        

        internal static DeleteConsentPortalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConsentPortalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
