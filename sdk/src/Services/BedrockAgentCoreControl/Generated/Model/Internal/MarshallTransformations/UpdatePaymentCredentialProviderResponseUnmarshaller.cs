...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePaymentCredentialProvider operation
    /// </summary>  
    public class UpdatePaymentCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePaymentCredentialProviderResponse response = new UpdatePaymentCredentialProviderResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return EncryptionFailureExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdatePaymentCredentialProviderResponseUnmarshaller _instance = new UpdatePaymentCredentialProviderResponseUnmarshaller();        

        internal static UpdatePaymentCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePaymentCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
