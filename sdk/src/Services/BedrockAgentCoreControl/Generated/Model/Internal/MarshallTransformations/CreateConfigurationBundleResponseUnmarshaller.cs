...
{
    /// <summary>
    /// Response Unmarshaller for CreateConfigurationBundle operation
    /// </summary>  
    public class CreateConfigurationBundleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConfigurationBundleResponse response = new CreateConfigurationBundleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BundleId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateConfigurationBundleResponseUnmarshaller _instance = new CreateConfigurationBundleResponseUnmarshaller();        

        internal static CreateConfigurationBundleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigurationBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
