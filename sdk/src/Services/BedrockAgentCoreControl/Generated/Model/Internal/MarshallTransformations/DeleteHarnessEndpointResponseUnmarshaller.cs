...
{
    /// <summary>
    /// Response Unmarshaller for DeleteHarnessEndpoint operation
    /// </summary>  
    public class DeleteHarnessEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteHarnessEndpointResponse response = new DeleteHarnessEndpointResponse();
        ...
        private static DeleteHarnessEndpointResponseUnmarshaller _instance = new DeleteHarnessEndpointResponseUnmarshaller();        

        internal static DeleteHarnessEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHarnessEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
