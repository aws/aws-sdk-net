...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGatewayRule operation
    /// </summary>  
    public class DeleteGatewayRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGatewayRuleResponse response = new DeleteGatewayRuleResponse();
        ...
        private static DeleteGatewayRuleResponseUnmarshaller _instance = new DeleteGatewayRuleResponseUnmarshaller();        

        internal static DeleteGatewayRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGatewayRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
