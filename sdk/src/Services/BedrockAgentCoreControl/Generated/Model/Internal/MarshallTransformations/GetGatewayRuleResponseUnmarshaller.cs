...
{
    /// <summary>
    /// Response Unmarshaller for GetGatewayRule operation
    /// </summary>  
    public class GetGatewayRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGatewayRuleResponse response = new GetGatewayRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SystemManagedBlockUnmarshaller.Instance;
                    response.System = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetGatewayRuleResponseUnmarshaller _instance = new GetGatewayRuleResponseUnmarshaller();        

        internal static GetGatewayRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGatewayRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
