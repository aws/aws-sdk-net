...
{
    /// <summary>
    /// UpdatePaymentManager Request Marshaller
    /// </summary>       
    public class UpdatePaymentManagerRequestMarshaller : IMarshaller<IRequest, UpdatePaymentManagerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePaymentManagerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePaymentManagerRequest publicRequest)
        {
        ...
        private static UpdatePaymentManagerRequestMarshaller _instance = new UpdatePaymentManagerRequestMarshaller();        

        internal static UpdatePaymentManagerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePaymentManagerRequestMarshaller Instance
        {
            get
            {
                return _instance;
