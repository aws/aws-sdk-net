...
{
    /// <summary>
    /// Response Unmarshaller for EphemeralEBSVolumeConfiguration Object
    /// </summary>  
    public class EphemeralEBSVolumeConfigurationUnmarshaller : IJsonUnmarshaller<EphemeralEBSVolumeConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EphemeralEBSVolumeConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EphemeralEBSVolumeConfiguration unmarshalledObject = new EphemeralEBSVolumeConfiguration();
            ...
            {
                if (context.TestExpression("ebsCardIndex", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.EbsCardIndex = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("volumeInitializationRate", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        private static EphemeralEBSVolumeConfigurationUnmarshaller _instance = new EphemeralEBSVolumeConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EphemeralEBSVolumeConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
