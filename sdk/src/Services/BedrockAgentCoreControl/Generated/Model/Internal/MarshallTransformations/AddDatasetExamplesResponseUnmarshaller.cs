...
{
    /// <summary>
    /// Response Unmarshaller for AddDatasetExamples operation
    /// </summary>  
    public class AddDatasetExamplesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddDatasetExamplesResponse response = new AddDatasetExamplesResponse();
            ...
            {
                if (context.TestExpression("addedCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.AddedCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("exampleIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ExampleIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static AddDatasetExamplesResponseUnmarshaller _instance = new AddDatasetExamplesResponseUnmarshaller();        

        internal static AddDatasetExamplesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddDatasetExamplesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
