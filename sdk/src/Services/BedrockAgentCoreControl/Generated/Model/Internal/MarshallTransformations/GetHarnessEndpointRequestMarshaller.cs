...
{
    /// <summary>
    /// GetHarnessEndpoint Request Marshaller
    /// </summary>       
    public class GetHarnessEndpointRequestMarshaller : IMarshaller<IRequest, GetHarnessEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetHarnessEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetHarnessEndpointRequest publicRequest)
        {
            ...
            request.ResourcePath = "/harnesses/{harnessId}/endpoints/{endpointName}";

            return request;
        }
        private static GetHarnessEndpointRequestMarshaller _instance = new GetHarnessEndpointRequestMarshaller();        

        internal static GetHarnessEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHarnessEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
