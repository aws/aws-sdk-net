...
{
    /// <summary>
    /// CreateGatewayRule Request Marshaller
    /// </summary>       
    public class CreateGatewayRuleRequestMarshaller : IMarshaller<IRequest, CreateGatewayRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateGatewayRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateGatewayRuleRequest publicRequest)
        {
        ...
        private static CreateGatewayRuleRequestMarshaller _instance = new CreateGatewayRuleRequestMarshaller();        

        internal static CreateGatewayRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGatewayRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
