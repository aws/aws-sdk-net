...
{
    /// <summary>
    /// Response Unmarshaller for HarnessGeminiModelConfig Object
    /// </summary>  
    public class HarnessGeminiModelConfigUnmarshaller : IJsonUnmarshaller<HarnessGeminiModelConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessGeminiModelConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessGeminiModelConfig unmarshalledObject = new HarnessGeminiModelConfig();
        ...
        private static HarnessGeminiModelConfigUnmarshaller _instance = new HarnessGeminiModelConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessGeminiModelConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
