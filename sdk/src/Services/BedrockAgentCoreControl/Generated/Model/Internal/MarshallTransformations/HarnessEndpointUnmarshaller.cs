...
{
    /// <summary>
    /// Response Unmarshaller for HarnessEndpoint Object
    /// </summary>  
    public class HarnessEndpointUnmarshaller : IJsonUnmarshaller<HarnessEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessEndpoint unmarshalledObject = new HarnessEndpoint();
        ...
        private static HarnessEndpointUnmarshaller _instance = new HarnessEndpointUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessEndpointUnmarshaller Instance
        {
            get
            {
                return _instance;
