...
{
    /// <summary>
    /// Response Unmarshaller for HarnessModelConfiguration Object
    /// </summary>  
    public class HarnessModelConfigurationUnmarshaller : IJsonUnmarshaller<HarnessModelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessModelConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessModelConfiguration unmarshalledObject = new HarnessModelConfiguration();
        ...
        private static HarnessModelConfigurationUnmarshaller _instance = new HarnessModelConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessModelConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
