...
{
    /// <summary>
    /// Response Unmarshaller for GetAgentRuntimeEndpoint operation
    /// </summary>  
    public class GetAgentRuntimeEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgentRuntimeEndpointResponse response = new GetAgentRuntimeEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("agentRuntimeEndpointArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AgentRuntimeEndpointArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("liveVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LiveVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetAgentRuntimeEndpointResponseUnmarshaller _instance = new GetAgentRuntimeEndpointResponseUnmarshaller();        

        internal static GetAgentRuntimeEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentRuntimeEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
