...
{
    /// <summary>
    /// GetPolicySummary Request Marshaller
    /// </summary>       
    public class GetPolicySummaryRequestMarshaller : IMarshaller<IRequest, GetPolicySummaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPolicySummaryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPolicySummaryRequest publicRequest)
        {
            ...
            request.ResourcePath = "/policy-engines/{policyEngineId}/policy-summaries/{policyId}";

            return request;
        }
        private static GetPolicySummaryRequestMarshaller _instance = new GetPolicySummaryRequestMarshaller();        

        internal static GetPolicySummaryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPolicySummaryRequestMarshaller Instance
        {
            get
            {
                return _instance;
