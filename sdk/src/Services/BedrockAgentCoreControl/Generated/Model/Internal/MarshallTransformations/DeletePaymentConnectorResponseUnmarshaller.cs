...
{
    /// <summary>
    /// Response Unmarshaller for DeletePaymentConnector operation
    /// </summary>  
    public class DeletePaymentConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePaymentConnectorResponse response = new DeletePaymentConnectorResponse();
        ...
        private static DeletePaymentConnectorResponseUnmarshaller _instance = new DeletePaymentConnectorResponseUnmarshaller();        

        internal static DeletePaymentConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePaymentConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
