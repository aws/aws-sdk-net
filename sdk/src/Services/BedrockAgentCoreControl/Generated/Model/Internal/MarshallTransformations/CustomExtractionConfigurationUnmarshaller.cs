...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomExtractionConfigurationUnmarshaller : IUnmarshaller<CustomExtractionConfiguration, XmlUnmarshallerContext>, IUnmarshaller<CustomExtractionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CustomExtractionConfiguration IUnmarshaller<CustomExtractionConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CustomExtractionConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("episodicExtractionOverride", targetDepth))
                {
                    ...
                    unmarshalledObject.EpisodicExtractionOverride = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("semanticExtractionOverride", targetDepth))
                {
                    ...
                    unmarshalledObject.SemanticExtractionOverride = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("userPreferenceExtractionOverride", targetDepth))
                {
                    ...
                    unmarshalledObject.UserPreferenceExtractionOverride = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
