...
{
    /// <summary>
    /// Response Unmarshaller for HarnessAgentCoreMemoryConfiguration Object
    /// </summary>  
    public class HarnessAgentCoreMemoryConfigurationUnmarshaller : IJsonUnmarshaller<HarnessAgentCoreMemoryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarnessAgentCoreMemoryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarnessAgentCoreMemoryConfiguration unmarshalledObject = new HarnessAgentCoreMemoryConfiguration();
        ...
        private static HarnessAgentCoreMemoryConfigurationUnmarshaller _instance = new HarnessAgentCoreMemoryConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarnessAgentCoreMemoryConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
