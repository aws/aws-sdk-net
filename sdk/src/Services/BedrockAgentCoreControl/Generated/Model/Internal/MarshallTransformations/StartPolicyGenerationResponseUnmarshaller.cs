...
{
    /// <summary>
    /// Response Unmarshaller for StartPolicyGeneration operation
    /// </summary>  
    public class StartPolicyGenerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartPolicyGenerationResponse response = new StartPolicyGenerationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("policyEngineId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyEngineId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("policyGenerationArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyGenerationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("policyGenerationId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyGenerationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartPolicyGenerationResponseUnmarshaller _instance = new StartPolicyGenerationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPolicyGenerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
