    ...
    public class StartPolicyGenerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyEngineId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("policyGenerationArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyGenerationArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("policyGenerationId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyGenerationId = unmarshaller.Unmarshall(context);
                    continue;
                }
