...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMemory operation
    /// </summary>  
    public class UpdateMemoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMemoryResponse response = new UpdateMemoryResponse();
        ...
        private static UpdateMemoryResponseUnmarshaller _instance = new UpdateMemoryResponseUnmarshaller();        

        internal static UpdateMemoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMemoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
