...
{
    /// <summary>
    /// OpenResponsesEvaluatorModelConfig Marshaller
    /// </summary>
    public class OpenResponsesEvaluatorModelConfigMarshaller : IRequestMarshaller<OpenResponsesEvaluatorModelConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(OpenResponsesEvaluatorModelConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetMaxOutputTokens())
            {
                context.Writer.WritePropertyName("maxOutputTokens");
                context.Writer.WriteNumberValue(requestObject.MaxOutputTokens.Value);
            }
            ...
            if(requestObject.IsSetReasoning())
            {
                context.Writer.WritePropertyName("reasoning");
                context.Writer.WriteStartObject();

                var marshaller = ReasoningConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.Reasoning, context);
        ...
        /// </summary>
        public readonly static OpenResponsesEvaluatorModelConfigMarshaller Instance = new OpenResponsesEvaluatorModelConfigMarshaller();
