...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class A2aDescriptorUnmarshaller : IJsonUnmarshaller<A2aDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            A2aDescriptor unmarshalledObject = new A2aDescriptor();
            ...
            {
                if (context.TestExpression("agentCard", targetDepth))
                {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static A2aDescriptorUnmarshaller Instance
        {
            get
            {
                return _instance;
