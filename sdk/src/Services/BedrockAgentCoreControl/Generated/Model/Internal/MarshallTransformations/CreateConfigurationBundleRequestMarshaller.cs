...
{
    /// <summary>
    /// CreateConfigurationBundle Request Marshaller
    /// </summary>       
    public class CreateConfigurationBundleRequestMarshaller : IMarshaller<IRequest, CreateConfigurationBundleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateConfigurationBundleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateConfigurationBundleRequest publicRequest)
        {
            ...
            request.ResourcePath = "/configuration-bundles/create";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetCreatedBy())
            {
                ...
                var marshaller = VersionCreatedBySourceMarshaller.Instance;
        ...
        private static CreateConfigurationBundleRequestMarshaller _instance = new CreateConfigurationBundleRequestMarshaller();        

        internal static CreateConfigurationBundleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigurationBundleRequestMarshaller Instance
        {
            get
            {
                return _instance;
