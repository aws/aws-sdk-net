...
{
    /// <summary>
    /// Response Unmarshaller for ListPolicySummaries operation
    /// </summary>  
    public class ListPolicySummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPolicySummariesResponse response = new ListPolicySummariesResponse();
        ...
        private static ListPolicySummariesResponseUnmarshaller _instance = new ListPolicySummariesResponseUnmarshaller();        

        internal static ListPolicySummariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPolicySummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
