...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PolicyGenerationAssetUnmarshaller : IUnmarshaller<PolicyGenerationAsset, XmlUnmarshallerContext>, IUnmarshaller<PolicyGenerationAsset, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PolicyGenerationAsset IUnmarshaller<PolicyGenerationAsset, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PolicyGenerationAsset Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("policyGenerationAssetId", targetDepth))
                {
                    ...
                    unmarshalledObject.PolicyGenerationAssetId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("rawTextFragment", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RawTextFragment = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
