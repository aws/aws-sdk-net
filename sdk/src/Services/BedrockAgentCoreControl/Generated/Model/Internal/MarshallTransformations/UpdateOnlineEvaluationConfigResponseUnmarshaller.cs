...
{
    /// <summary>
    /// Response Unmarshaller for UpdateOnlineEvaluationConfig operation
    /// </summary>  
    public class UpdateOnlineEvaluationConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateOnlineEvaluationConfigResponse response = new UpdateOnlineEvaluationConfigResponse();
        ...
        private static UpdateOnlineEvaluationConfigResponseUnmarshaller _instance = new UpdateOnlineEvaluationConfigResponseUnmarshaller();        

        internal static UpdateOnlineEvaluationConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateOnlineEvaluationConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
