        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("dataSourceConfig", targetDepth))
                {
                    ...
                    response.DataSourceConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EvaluationExecutionRoleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("evaluators", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<EvaluatorReference, EvaluatorReferenceUnmarshaller>(EvaluatorReferenceUnmarshaller.Instance);
                    response.Evaluators = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OnlineEvaluationConfigArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("onlineEvaluationConfigId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OnlineEvaluationConfigId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("onlineEvaluationConfigName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OnlineEvaluationConfigName = unmarshaller.Unmarshall(context);
                    continue;
                }
