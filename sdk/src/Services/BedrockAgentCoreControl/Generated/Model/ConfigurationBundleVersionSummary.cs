...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    /// </summary>
    public partial class ConfigurationBundleVersionSummary
    {
        ...
        /// <summary>
        /// Gets and sets the property VersionCreatedAt. 
        /// <para>
        ...
        {
            get { return this._versionCreatedAt; }
            set { this._versionCreatedAt = value; }
        }

        // Check to see if VersionCreatedAt property is set
        internal bool IsSetVersionCreatedAt()
        {
            return this._versionCreatedAt.HasValue; 
        }
