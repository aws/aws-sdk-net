...
namespace Amazon.PersonalizeEvents
{
    ...
    public partial class AmazonPersonalizeEventsClient : AmazonServiceClient, IAmazonPersonalizeEvents
    {
        ...
        /// 
        /// </summary>
        public AmazonPersonalizeEventsClient() : base(new AmazonPersonalizeEventsConfig()) { }
        ...
        public AmazonPersonalizeEventsClient(RegionEndpoint region) : base(new AmazonPersonalizeEventsConfig { RegionEndpoint = region }) { }
        ...
        public AmazonPersonalizeEventsClient(AmazonPersonalizeEventsConfig config) : base(config) { }
