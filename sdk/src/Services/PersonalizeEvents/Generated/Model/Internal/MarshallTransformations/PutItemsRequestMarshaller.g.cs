...
namespace Amazon.PersonalizeEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutItemsRequestMarshaller : IMarshaller<IRequest, PutItemsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutItemsRequestMarshaller _instance = new();

        internal static PutItemsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutItemsRequestMarshaller Instance => _instance;
    }
}
