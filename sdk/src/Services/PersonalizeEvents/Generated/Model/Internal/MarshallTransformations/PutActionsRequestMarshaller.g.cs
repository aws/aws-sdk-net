...
namespace Amazon.PersonalizeEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutActionsRequestMarshaller : IMarshaller<IRequest, PutActionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutActionsRequestMarshaller _instance = new();

        internal static PutActionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutActionsRequestMarshaller Instance => _instance;
    }
}
