...
namespace Amazon.PersonalizeEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutUsersRequestMarshaller : IMarshaller<IRequest, PutUsersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutUsersRequestMarshaller _instance = new();

        internal static PutUsersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutUsersRequestMarshaller Instance => _instance;
    }
}
