...
namespace Amazon.PersonalizeEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutActionInteractionsRequestMarshaller : IMarshaller<IRequest, PutActionInteractionsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutActionInteractionsRequestMarshaller _instance = new();

        internal static PutActionInteractionsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutActionInteractionsRequestMarshaller Instance => _instance;
    }
}
