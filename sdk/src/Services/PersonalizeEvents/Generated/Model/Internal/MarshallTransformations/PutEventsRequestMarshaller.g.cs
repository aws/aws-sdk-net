...
namespace Amazon.PersonalizeEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutEventsRequestMarshaller : IMarshaller<IRequest, PutEventsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutEventsRequestMarshaller _instance = new();

        internal static PutEventsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutEventsRequestMarshaller Instance => _instance;
    }
}
