...
{
    /// <summary>
    /// Container for the parameters to the PutEvents operation. Records item interaction
    /// event data. For more information see <a href="https://docs.aws.amazon.com/personalize/latest/dg/recording-item-interaction-events.html">Recording
    ...
    public partial class PutEventsRequest : AmazonPersonalizeEventsRequest
    {
        ...
        public List<Event> EventList { get; set; } = AWSConfigs.InitializeCollections ? new List<Event>() : null;

        /// <summary>
        /// Checks to see if the EventList property is set.
        /// </summary>
        internal bool IsSetEventList() => this.EventList != null && (this.EventList.Count > 0 || !AWSConfigs.InitializeCollections);
