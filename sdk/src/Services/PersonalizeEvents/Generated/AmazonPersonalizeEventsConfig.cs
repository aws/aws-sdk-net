...
namespace Amazon.PersonalizeEvents
{
    ...
    public partial class AmazonPersonalizeEventsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Personalize Events", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Personalize Events";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "personalize-events";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2018-03-22";
