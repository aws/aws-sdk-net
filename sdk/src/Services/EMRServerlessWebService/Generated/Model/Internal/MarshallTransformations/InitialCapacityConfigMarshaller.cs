...
{
    /// <summary>
    /// InitialCapacityConfig Marshaller
    /// </summary>
    public class InitialCapacityConfigMarshaller : IRequestMarshaller<InitialCapacityConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(InitialCapacityConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetWorkerConfiguration())
            {
                ...
                var marshaller = WorkerResourceConfigMarshaller.Instance;
                marshaller.Marshall(requestObject.WorkerConfiguration, context);
        ...
        /// </summary>
        public readonly static InitialCapacityConfigMarshaller Instance = new InitialCapacityConfigMarshaller();
