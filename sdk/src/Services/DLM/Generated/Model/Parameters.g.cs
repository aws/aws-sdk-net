...
namespace Amazon.DLM.Model
{
    ...
    public partial class Parameters
    {
        ...
        /// <summary>
        /// Checks to see if the ExcludeBootVolume property is set.
        /// </summary>
        internal bool IsSetExcludeBootVolume() => this.ExcludeBootVolume.HasValue;
        ...
        public List<Tag> ExcludeDataVolumeTags { get; set; } = AWSConfigs.InitializeCollections ? new List<Tag>() : null;

        /// <summary>
        /// Checks to see if the ExcludeDataVolumeTags property is set.
        /// </summary>
        internal bool IsSetExcludeDataVolumeTags() => this.ExcludeDataVolumeTags != null && (this.ExcludeDataVolumeTags.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the NoReboot property is set.
        /// </summary>
        internal bool IsSetNoReboot() => this.NoReboot.HasValue;
    }
}
