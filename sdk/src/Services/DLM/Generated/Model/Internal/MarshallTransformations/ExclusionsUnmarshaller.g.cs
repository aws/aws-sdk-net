...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExclusionsUnmarshaller : IJsonUnmarshaller<Exclusions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Exclusions();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExclusionsUnmarshaller Instance => _instance;
    }
}
