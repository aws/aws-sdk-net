...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeprecateRuleUnmarshaller : IUnmarshaller<DeprecateRule, XmlUnmarshallerContext>, IUnmarshaller<DeprecateRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DeprecateRule IUnmarshaller<DeprecateRule, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DeprecateRule Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
