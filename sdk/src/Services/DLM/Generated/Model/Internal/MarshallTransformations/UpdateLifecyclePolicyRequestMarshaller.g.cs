...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateLifecyclePolicyRequestMarshaller : IMarshaller<IRequest, UpdateLifecyclePolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateLifecyclePolicyRequestMarshaller _instance = new();

        internal static UpdateLifecyclePolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateLifecyclePolicyRequestMarshaller Instance => _instance;
    }
}
