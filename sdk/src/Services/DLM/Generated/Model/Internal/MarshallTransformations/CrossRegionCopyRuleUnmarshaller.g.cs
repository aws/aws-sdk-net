...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CrossRegionCopyRuleUnmarshaller : IJsonUnmarshaller<CrossRegionCopyRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CrossRegionCopyRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CrossRegionCopyRuleUnmarshaller Instance => _instance;
    }
}
