...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeprecateRuleUnmarshaller : IJsonUnmarshaller<DeprecateRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeprecateRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static DeprecateRuleUnmarshaller Instance => _instance;
    }
}
