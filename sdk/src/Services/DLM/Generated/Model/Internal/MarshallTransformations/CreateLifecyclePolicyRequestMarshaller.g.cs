...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateLifecyclePolicyRequestMarshaller : IMarshaller<IRequest, CreateLifecyclePolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateLifecyclePolicyRequestMarshaller _instance = new();

        internal static CreateLifecyclePolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateLifecyclePolicyRequestMarshaller Instance => _instance;
    }
}
