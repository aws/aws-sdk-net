...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LifecyclePolicyUnmarshaller : IJsonUnmarshaller<LifecyclePolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LifecyclePolicy();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LifecyclePolicyUnmarshaller Instance => _instance;
    }
}
