...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ArchiveRuleUnmarshaller : IJsonUnmarshaller<ArchiveRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ArchiveRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ArchiveRuleUnmarshaller Instance => _instance;
    }
}
