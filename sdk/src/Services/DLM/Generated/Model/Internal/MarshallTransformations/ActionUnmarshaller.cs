    ...
    public class ActionUnmarshaller : IUnmarshaller<Action, XmlUnmarshallerContext>, IUnmarshaller<Action, JsonUnmarshallerContext>
    {
        ...
        public Action Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CrossRegionCopyAction, CrossRegionCopyActionUnmarshaller>(CrossRegionCopyActionUnmarshaller.Instance);
                    unmarshalledObject.CrossRegionCopy = unmarshaller.Unmarshall(context);
                    continue;
                }
