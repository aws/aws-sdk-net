...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteLifecyclePolicyRequestMarshaller : IMarshaller<IRequest, DeleteLifecyclePolicyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteLifecyclePolicyRequestMarshaller _instance = new();

        internal static DeleteLifecyclePolicyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteLifecyclePolicyRequestMarshaller Instance => _instance;
    }
}
