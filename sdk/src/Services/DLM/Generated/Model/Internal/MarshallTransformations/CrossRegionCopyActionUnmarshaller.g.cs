...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CrossRegionCopyActionUnmarshaller : IJsonUnmarshaller<CrossRegionCopyAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CrossRegionCopyAction();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CrossRegionCopyActionUnmarshaller Instance => _instance;
    }
}
