...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FastRestoreRuleUnmarshaller : IJsonUnmarshaller<FastRestoreRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FastRestoreRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
