...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FastRestoreRuleUnmarshaller : IJsonUnmarshaller<FastRestoreRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new FastRestoreRule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FastRestoreRuleUnmarshaller Instance => _instance;
    }
}
