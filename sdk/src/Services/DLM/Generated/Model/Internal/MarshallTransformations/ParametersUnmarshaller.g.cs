...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ParametersUnmarshaller : IJsonUnmarshaller<Parameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Parameters();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ParametersUnmarshaller Instance => _instance;
    }
}
