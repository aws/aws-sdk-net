...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ScheduleUnmarshaller : IJsonUnmarshaller<Schedule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Schedule();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ScheduleUnmarshaller Instance => _instance;
    }
}
