...
namespace Amazon.DLM.Model
{
    ...
    public partial class Exclusions
    {
        ...
        /// <summary>
        /// Checks to see if the ExcludeBootVolumes property is set.
        /// </summary>
        internal bool IsSetExcludeBootVolumes() => this.ExcludeBootVolumes.HasValue;
        ...
        public List<Tag> ExcludeTags { get; set; } = AWSConfigs.InitializeCollections ? new List<Tag>() : null;

        /// <summary>
        /// Checks to see if the ExcludeTags property is set.
        /// </summary>
        internal bool IsSetExcludeTags() => this.ExcludeTags != null && (this.ExcludeTags.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        public List<string> ExcludeVolumeTypes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ExcludeVolumeTypes property is set.
        /// </summary>
        internal bool IsSetExcludeVolumeTypes() => this.ExcludeVolumeTypes != null && (this.ExcludeVolumeTypes.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
