...
{
    /// <summary>
    /// Container for the parameters to the DeleteLifecyclePolicy operation. Deletes the specified
    /// lifecycle policy and halts the automated operations that the policy specified. <para>
