...
namespace Amazon.DLM
{
    ...
    public partial class AmazonDLMConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("DLM", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "DLM";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "dlm";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2018-01-12";
