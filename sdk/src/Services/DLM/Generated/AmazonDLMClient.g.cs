...
namespace Amazon.DLM
{
    ...
    public partial class AmazonDLMClient : AmazonServiceClient, IAmazonDLM
    {
        ...
        /// 
        /// </summary>
        public AmazonDLMClient() : base(new AmazonDLMConfig()) { }
        ...
        public AmazonDLMClient(RegionEndpoint region) : base(new AmazonDLMConfig { RegionEndpoint = region }) { }
        ...
        public AmazonDLMClient(AmazonDLMConfig config) : base(config) { }
