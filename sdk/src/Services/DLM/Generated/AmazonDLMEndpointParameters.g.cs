...
namespace Amazon.DLM.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving DLM endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonDLMEndpointProvider"/> and <see cref="AmazonDLMEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class DLMEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// DLMEndpointParameters constructor
        /// </summary>
        public DLMEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
