...
{
    /// <summary>
    /// This is the response object from the ListAccessTokens operation.
    /// </summary>
    public partial class ListAccessTokensResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        public List<AccessTokenSummary> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<AccessTokenSummary>() : null;
