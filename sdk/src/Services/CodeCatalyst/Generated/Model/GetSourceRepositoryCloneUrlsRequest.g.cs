...
{
    /// <summary>
    /// Container for the parameters to the GetSourceRepositoryCloneUrls operation. Returns
    /// information about the URLs that can be used with a Git client to clone a source repository.
    /// </summary>
