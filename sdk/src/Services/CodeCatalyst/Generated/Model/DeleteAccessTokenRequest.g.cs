...
{
    /// <summary>
    /// Container for the parameters to the DeleteAccessToken operation. Deletes a specified
    /// personal access token (PAT). A personal access token can only be deleted by the user
    /// who created it.
    /// </summary>
