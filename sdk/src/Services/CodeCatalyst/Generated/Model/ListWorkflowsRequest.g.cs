...
{
    /// <summary>
    /// Container for the parameters to the ListWorkflows operation. Retrieves a list of workflows
    ...
    public partial class ListWorkflowsRequest : AmazonCodeCatalystRequest
    {
        ...
        /// </summary>
        [AWSProperty(Max = 1)]
        public List<WorkflowSortCriteria> SortBy { get; set; } = AWSConfigs.InitializeCollections ? new List<WorkflowSortCriteria>() : null;
