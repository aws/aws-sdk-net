...
{
    /// <summary>
    /// Container for the parameters to the ListProjects operation. Retrieves a list of projects.
    /// </summary>
    public partial class ListProjectsRequest : AmazonCodeCatalystRequest
    {
        ...
        /// </summary>
        public List<ProjectListFilter> Filters { get; set; } = AWSConfigs.InitializeCollections ? new List<ProjectListFilter>() : null;
