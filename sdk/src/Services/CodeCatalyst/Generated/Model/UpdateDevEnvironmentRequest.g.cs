...
{
    /// <summary>
    /// Container for the parameters to the UpdateDevEnvironment operation. Changes one or
    /// more values for a Dev Environment. Updating certain values of the Dev Environment
