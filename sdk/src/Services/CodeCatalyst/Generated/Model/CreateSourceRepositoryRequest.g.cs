...
{
    /// <summary>
    /// Container for the parameters to the CreateSourceRepository operation. Creates an empty
    /// Git-based source repository in a specified project. The repository is created with
    /// an initial empty commit with a default branch named <c>main</c>.
    /// </summary>
