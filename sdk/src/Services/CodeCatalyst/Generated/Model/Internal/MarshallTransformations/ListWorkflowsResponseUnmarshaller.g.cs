...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWorkflowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListWorkflowsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkflowSummary, WorkflowSummaryUnmarshaller>(WorkflowSummaryUnmarshaller.Instance);
        ...
        private static ListWorkflowsResponseUnmarshaller _instance = new ListWorkflowsResponseUnmarshaller();

        internal static ListWorkflowsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWorkflowsResponseUnmarshaller Instance => _instance;
    }
}
