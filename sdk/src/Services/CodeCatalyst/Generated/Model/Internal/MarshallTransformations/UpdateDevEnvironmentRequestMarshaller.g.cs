...
{
    /// <summary>
    /// UpdateDevEnvironment Request Marshaller
    /// </summary>
    public partial class UpdateDevEnvironmentRequestMarshaller : IMarshaller<IRequest, UpdateDevEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateDevEnvironmentRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(UpdateDevEnvironmentRequest publicRequest)
        {
        ...
        private static readonly UpdateDevEnvironmentRequestMarshaller _instance = new();

        internal static UpdateDevEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateDevEnvironmentRequestMarshaller Instance => _instance;
    }
}
