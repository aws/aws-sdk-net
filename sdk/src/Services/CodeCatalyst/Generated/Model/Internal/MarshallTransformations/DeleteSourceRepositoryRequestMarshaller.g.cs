...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteSourceRepositoryRequestMarshaller : IMarshaller<IRequest, DeleteSourceRepositoryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteSourceRepositoryRequestMarshaller _instance = new();

        internal static DeleteSourceRepositoryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteSourceRepositoryRequestMarshaller Instance => _instance;
    }
}
