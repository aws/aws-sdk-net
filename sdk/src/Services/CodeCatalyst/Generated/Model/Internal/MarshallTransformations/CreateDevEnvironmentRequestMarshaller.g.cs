...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateDevEnvironmentRequestMarshaller : IMarshaller<IRequest, CreateDevEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateDevEnvironmentRequestMarshaller _instance = new();

        internal static CreateDevEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateDevEnvironmentRequestMarshaller Instance => _instance;
    }
}
