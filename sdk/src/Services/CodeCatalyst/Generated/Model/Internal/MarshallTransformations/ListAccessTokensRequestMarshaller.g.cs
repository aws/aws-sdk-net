...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAccessTokensRequestMarshaller : IMarshaller<IRequest, ListAccessTokensRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAccessTokensRequestMarshaller _instance = new();

        internal static ListAccessTokensRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAccessTokensRequestMarshaller Instance => _instance;
    }
}
