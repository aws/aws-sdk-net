...
{
    /// <summary>
    /// StopDevEnvironment Request Marshaller
    /// </summary>
    public partial class StopDevEnvironmentRequestMarshaller : IMarshaller<IRequest, StopDevEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopDevEnvironmentRequest)input);
        }
        ...
        public IRequest Marshall(StopDevEnvironmentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/spaces/{spaceName}/projects/{projectName}/devEnvironments/{id}/stop";

            return request;
        }

        private static readonly StopDevEnvironmentRequestMarshaller _instance = new();

        internal static StopDevEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopDevEnvironmentRequestMarshaller Instance => _instance;
    }
}
