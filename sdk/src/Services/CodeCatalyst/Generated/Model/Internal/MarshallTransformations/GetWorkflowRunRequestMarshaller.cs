...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetWorkflowRunRequestMarshaller : IMarshaller<IRequest, GetWorkflowRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetWorkflowRunRequestMarshaller _instance = new GetWorkflowRunRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
