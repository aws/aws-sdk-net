...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DevEnvironmentAccessDetailsUnmarshaller : IJsonUnmarshaller<DevEnvironmentAccessDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DevEnvironmentAccessDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("tokenValue", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TokenValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
