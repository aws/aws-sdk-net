...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartDevEnvironmentSessionRequestMarshaller : IMarshaller<IRequest, StartDevEnvironmentSessionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartDevEnvironmentSessionRequestMarshaller _instance = new();

        internal static StartDevEnvironmentSessionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartDevEnvironmentSessionRequestMarshaller Instance => _instance;
    }
}
