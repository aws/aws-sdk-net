...
{
    /// <summary>
    /// Response Unmarshaller for CreateDevEnvironment operation.
    /// </summary>
    public partial class CreateDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateDevEnvironmentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("vpcConnectionName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static CreateDevEnvironmentResponseUnmarshaller _instance = new CreateDevEnvironmentResponseUnmarshaller();

        internal static CreateDevEnvironmentResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateDevEnvironmentResponseUnmarshaller Instance => _instance;
    }
}
