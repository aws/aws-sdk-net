...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DevEnvironmentSummaryUnmarshaller : IJsonUnmarshaller<DevEnvironmentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DevEnvironmentSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ides", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("inactivityTimeoutMinutes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("persistentStorage", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DevEnvironmentSummaryUnmarshaller Instance => _instance;
    }
}
