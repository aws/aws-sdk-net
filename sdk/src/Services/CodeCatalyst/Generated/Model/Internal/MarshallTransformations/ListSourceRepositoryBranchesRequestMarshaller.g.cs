...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSourceRepositoryBranchesRequestMarshaller : IMarshaller<IRequest, ListSourceRepositoryBranchesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListSourceRepositoryBranchesRequestMarshaller _instance = new();

        internal static ListSourceRepositoryBranchesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSourceRepositoryBranchesRequestMarshaller Instance => _instance;
    }
}
