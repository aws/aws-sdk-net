...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteDevEnvironmentRequestMarshaller : IMarshaller<IRequest, DeleteDevEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteDevEnvironmentRequestMarshaller _instance = new();

        internal static DeleteDevEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteDevEnvironmentRequestMarshaller Instance => _instance;
    }
}
