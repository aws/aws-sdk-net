    ...
    public class GetDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CreatorId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("persistentStorage", targetDepth))
                {
                    ...
                    response.PersistentStorage = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VpcConnectionName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
