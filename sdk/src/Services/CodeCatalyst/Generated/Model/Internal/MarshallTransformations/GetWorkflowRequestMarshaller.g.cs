...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetWorkflowRequestMarshaller : IMarshaller<IRequest, GetWorkflowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetWorkflowRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/spaces/{spaceName}/projects/{projectName}/workflows/{id}";

            return request;
        }

        private static readonly GetWorkflowRequestMarshaller _instance = new();

        internal static GetWorkflowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetWorkflowRequestMarshaller Instance => _instance;
    }
}
