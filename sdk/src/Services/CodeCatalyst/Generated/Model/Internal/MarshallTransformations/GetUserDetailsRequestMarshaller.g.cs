...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetUserDetailsRequestMarshaller : IMarshaller<IRequest, GetUserDetailsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetUserDetailsRequestMarshaller _instance = new();

        internal static GetUserDetailsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetUserDetailsRequestMarshaller Instance => _instance;
    }
}
