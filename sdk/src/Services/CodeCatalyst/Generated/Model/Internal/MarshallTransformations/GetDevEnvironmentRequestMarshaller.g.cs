...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDevEnvironmentRequestMarshaller : IMarshaller<IRequest, GetDevEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDevEnvironmentRequestMarshaller _instance = new();

        internal static GetDevEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDevEnvironmentRequestMarshaller Instance => _instance;
    }
}
