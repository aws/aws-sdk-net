...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ProjectInformationUnmarshaller : IJsonUnmarshaller<ProjectInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ProjectInformation();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ProjectInformationUnmarshaller Instance => _instance;
    }
}
