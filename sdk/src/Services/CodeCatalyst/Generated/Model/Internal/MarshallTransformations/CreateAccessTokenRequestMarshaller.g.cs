...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAccessTokenRequestMarshaller : IMarshaller<IRequest, CreateAccessTokenRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateAccessTokenRequestMarshaller _instance = new();

        internal static CreateAccessTokenRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAccessTokenRequestMarshaller Instance => _instance;
    }
}
