...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WorkflowRunSummaryUnmarshaller : IJsonUnmarshaller<WorkflowRunSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WorkflowRunSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkflowRunStatusReason, WorkflowRunStatusReasonUnmarshaller>(WorkflowRunStatusReasonUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static WorkflowRunSummaryUnmarshaller Instance => _instance;
    }
}
