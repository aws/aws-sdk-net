...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartWorkflowRunRequestMarshaller : IMarshaller<IRequest, StartWorkflowRunRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartWorkflowRunRequestMarshaller _instance = new();

        internal static StartWorkflowRunRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartWorkflowRunRequestMarshaller Instance => _instance;
    }
}
