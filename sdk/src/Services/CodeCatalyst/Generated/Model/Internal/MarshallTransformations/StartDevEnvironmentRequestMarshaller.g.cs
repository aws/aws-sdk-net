...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StartDevEnvironmentRequestMarshaller : IMarshaller<IRequest, StartDevEnvironmentRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StartDevEnvironmentRequestMarshaller _instance = new();

        internal static StartDevEnvironmentRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StartDevEnvironmentRequestMarshaller Instance => _instance;
    }
}
