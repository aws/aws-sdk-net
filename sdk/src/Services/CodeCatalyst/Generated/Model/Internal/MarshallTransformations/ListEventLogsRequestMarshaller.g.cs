...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListEventLogsRequestMarshaller : IMarshaller<IRequest, ListEventLogsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListEventLogsRequestMarshaller _instance = new();

        internal static ListEventLogsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListEventLogsRequestMarshaller Instance => _instance;
    }
}
