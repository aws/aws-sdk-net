...
{
    /// <summary>
    /// GetWorkflowRun Request Marshaller
    /// </summary>
    public partial class GetWorkflowRunRequestMarshaller : IMarshaller<IRequest, GetWorkflowRunRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetWorkflowRunRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetWorkflowRunRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/spaces/{spaceName}/projects/{projectName}/workflowRuns/{id}";

            return request;
        }

        private static readonly GetWorkflowRunRequestMarshaller _instance = new();

        internal static GetWorkflowRunRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetWorkflowRunRequestMarshaller Instance => _instance;
    }
}
