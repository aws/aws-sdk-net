...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSourceRepositoryRequestMarshaller : IMarshaller<IRequest, GetSourceRepositoryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSourceRepositoryRequestMarshaller _instance = new();

        internal static GetSourceRepositoryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSourceRepositoryRequestMarshaller Instance => _instance;
    }
}
