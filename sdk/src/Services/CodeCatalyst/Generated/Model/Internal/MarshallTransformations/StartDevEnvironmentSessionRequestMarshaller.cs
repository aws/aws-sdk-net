...
{
    /// <summary>
    /// StartDevEnvironmentSession Request Marshaller
    /// </summary>       
    public class StartDevEnvironmentSessionRequestMarshaller : IMarshaller<IRequest, StartDevEnvironmentSessionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDevEnvironmentSessionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDevEnvironmentSessionRequest publicRequest)
        {
        ...
        private static StartDevEnvironmentSessionRequestMarshaller _instance = new StartDevEnvironmentSessionRequestMarshaller();        

        internal static StartDevEnvironmentSessionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDevEnvironmentSessionRequestMarshaller Instance
        {
            get
            {
                return _instance;
