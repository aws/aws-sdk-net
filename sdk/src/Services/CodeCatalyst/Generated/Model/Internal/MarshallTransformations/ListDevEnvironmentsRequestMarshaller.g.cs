...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListDevEnvironmentsRequestMarshaller : IMarshaller<IRequest, ListDevEnvironmentsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListDevEnvironmentsRequestMarshaller _instance = new();

        internal static ListDevEnvironmentsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListDevEnvironmentsRequestMarshaller Instance => _instance;
    }
}
