...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAccessTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAccessTokenResponse();
            ...
            {
                if (context.TestExpression("accessTokenId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AccessTokenId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateAccessTokenResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAccessTokenResponseUnmarshaller Instance => _instance;
    }
}
