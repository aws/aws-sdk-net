...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateSourceRepositoryRequestMarshaller : IMarshaller<IRequest, CreateSourceRepositoryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateSourceRepositoryRequestMarshaller _instance = new();

        internal static CreateSourceRepositoryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateSourceRepositoryRequestMarshaller Instance => _instance;
    }
}
