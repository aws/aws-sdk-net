...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StopDevEnvironmentSessionRequestMarshaller : IMarshaller<IRequest, StopDevEnvironmentSessionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly StopDevEnvironmentSessionRequestMarshaller _instance = new();

        internal static StopDevEnvironmentSessionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static StopDevEnvironmentSessionRequestMarshaller Instance => _instance;
    }
}
