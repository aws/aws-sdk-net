...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAccessTokenRequestMarshaller : IMarshaller<IRequest, DeleteAccessTokenRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAccessTokenRequestMarshaller _instance = new();

        internal static DeleteAccessTokenRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAccessTokenRequestMarshaller Instance => _instance;
    }
}
