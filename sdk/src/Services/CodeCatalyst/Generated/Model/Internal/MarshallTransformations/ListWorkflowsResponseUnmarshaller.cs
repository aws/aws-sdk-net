...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListWorkflowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WorkflowSummary, WorkflowSummaryUnmarshaller>(WorkflowSummaryUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkflowsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
