...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSourceRepositoryCloneUrlsRequestMarshaller : IMarshaller<IRequest, GetSourceRepositoryCloneUrlsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetSourceRepositoryCloneUrlsRequestMarshaller _instance = new();

        internal static GetSourceRepositoryCloneUrlsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSourceRepositoryCloneUrlsRequestMarshaller Instance => _instance;
    }
}
