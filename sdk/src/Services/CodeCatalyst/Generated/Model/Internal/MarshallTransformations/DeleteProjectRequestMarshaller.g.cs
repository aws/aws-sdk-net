...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteProjectRequestMarshaller : IMarshaller<IRequest, DeleteProjectRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteProjectRequestMarshaller _instance = new();

        internal static DeleteProjectRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteProjectRequestMarshaller Instance => _instance;
    }
}
