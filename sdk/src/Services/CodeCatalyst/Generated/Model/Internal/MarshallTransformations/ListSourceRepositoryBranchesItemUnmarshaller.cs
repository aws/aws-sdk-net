...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSourceRepositoryBranchesItemUnmarshaller : IJsonUnmarshaller<ListSourceRepositoryBranchesItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListSourceRepositoryBranchesItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
