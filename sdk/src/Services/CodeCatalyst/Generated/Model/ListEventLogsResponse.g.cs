...
{
    /// <summary>
    /// This is the response object from the ListEventLogs operation.
    /// </summary>
    public partial class ListEventLogsResponse : AmazonWebServiceResponse
    {
        /// <summary>
        ...
        public List<EventLogEntry> Items { get; set; } = AWSConfigs.InitializeCollections ? new List<EventLogEntry>() : null;
