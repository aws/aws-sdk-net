...
{
    /// <summary>
    /// Container for the parameters to the ListWorkflowRuns operation. Retrieves a list of
    /// workflow runs of a specified workflow.
    /// </summary>
    public partial class ListWorkflowRunsRequest : AmazonCodeCatalystRequest
    {
        ...
        /// </summary>
        [AWSProperty(Max = 1)]
        public List<WorkflowRunSortCriteria> SortBy { get; set; } = AWSConfigs.InitializeCollections ? new List<WorkflowRunSortCriteria>() : null;

        /// <summary>
        /// Checks to see if the SortBy property is set.
        /// </summary>
        internal bool IsSetSortBy() => this.SortBy != null && (this.SortBy.Count > 0 || !AWSConfigs.InitializeCollections);
