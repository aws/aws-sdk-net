...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("CodeCatalyst", "4.0.0.0");

        private static readonly AmazonCodeCatalystEndpointResolver EndpointResolver =
            new AmazonCodeCatalystEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("CodeCatalyst", "3.7.400.88");
=======
            InternalSDKUtils.BuildUserAgentString("CodeCatalyst", "3.7.400.104");
>>>>>>> 73f5e3892bfceb07920f41e41a4aebe3a70c615b
        ...
        {
            var requestContext = new RequestContext(false, new BearerTokenSigner())
            {
                ClientConfig = this,
