...
namespace Amazon.CodeCatalyst
{
    ...
    public partial class AmazonCodeCatalystConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CodeCatalyst", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "CodeCatalyst";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "codecatalyst";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-09-28";
