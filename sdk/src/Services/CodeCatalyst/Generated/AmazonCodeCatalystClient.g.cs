...
namespace Amazon.CodeCatalyst
{
    ...
    public partial class AmazonCodeCatalystClient : AmazonServiceClient, IAmazonCodeCatalyst
    {
        ...
        /// 
        /// </summary>
        public AmazonCodeCatalystClient() : base(new AmazonCodeCatalystConfig()) { }
        ...
        public AmazonCodeCatalystClient(RegionEndpoint region) : base(new AmazonCodeCatalystConfig { RegionEndpoint = region }) { }
        ...
        public AmazonCodeCatalystClient(AmazonCodeCatalystConfig config) : base(config) { }
