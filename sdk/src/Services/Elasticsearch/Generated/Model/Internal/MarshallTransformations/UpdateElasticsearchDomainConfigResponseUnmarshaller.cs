...
{
    /// <summary>
    /// Response Unmarshaller for UpdateElasticsearchDomainConfig operation
    /// </summary>  
    public class UpdateElasticsearchDomainConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateElasticsearchDomainConfigResponse response = new UpdateElasticsearchDomainConfigResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonElasticsearchException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }

        private static UpdateElasticsearchDomainConfigResponseUnmarshaller _instance = new UpdateElasticsearchDomainConfigResponseUnmarshaller();        

        internal static UpdateElasticsearchDomainConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateElasticsearchDomainConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
