...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DomainInfoUnmarshaller : IJsonUnmarshaller<DomainInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DomainInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
