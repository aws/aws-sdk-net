...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InboundCrossClusterSearchConnectionUnmarshaller : IJsonUnmarshaller<InboundCrossClusterSearchConnection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InboundCrossClusterSearchConnection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
