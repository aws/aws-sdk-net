...
{
    /// <summary>
    /// Response Unmarshaller for DeleteElasticsearchDomain operation
    /// </summary>  
    public class DeleteElasticsearchDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteElasticsearchDomainResponse response = new DeleteElasticsearchDomainResponse();
        ...
        private static DeleteElasticsearchDomainResponseUnmarshaller _instance = new DeleteElasticsearchDomainResponseUnmarshaller();        

        internal static DeleteElasticsearchDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteElasticsearchDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
