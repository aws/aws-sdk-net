...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDomainAutoTunes operation
    /// </summary>  
    public class DescribeDomainAutoTunesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDomainAutoTunesResponse response = new DescribeDomainAutoTunesResponse();
            ...
            {
                if (context.TestExpression("AutoTunes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AutoTune, AutoTuneUnmarshaller>(AutoTuneUnmarshaller.Instance);
                    response.AutoTunes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeDomainAutoTunesResponseUnmarshaller _instance = new DescribeDomainAutoTunesResponseUnmarshaller();        

        internal static DescribeDomainAutoTunesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDomainAutoTunesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
