...
{
    /// <summary>
    /// Response Unmarshaller for RevokeVpcEndpointAccess operation
    /// </summary>  
    public class RevokeVpcEndpointAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeVpcEndpointAccessResponse response = new RevokeVpcEndpointAccessResponse();
        ...
        private static RevokeVpcEndpointAccessResponseUnmarshaller _instance = new RevokeVpcEndpointAccessResponseUnmarshaller();        

        internal static RevokeVpcEndpointAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeVpcEndpointAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
