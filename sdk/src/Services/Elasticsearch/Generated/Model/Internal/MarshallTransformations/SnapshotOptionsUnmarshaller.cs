...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnapshotOptionsUnmarshaller : IJsonUnmarshaller<SnapshotOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnapshotOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
