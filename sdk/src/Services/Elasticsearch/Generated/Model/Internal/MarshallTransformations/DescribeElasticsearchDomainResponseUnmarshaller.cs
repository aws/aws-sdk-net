...
{
    /// <summary>
    /// Response Unmarshaller for DescribeElasticsearchDomain operation
    /// </summary>  
    public class DescribeElasticsearchDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeElasticsearchDomainResponse response = new DescribeElasticsearchDomainResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ElasticsearchDomainStatusUnmarshaller.Instance;
                    response.DomainStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeElasticsearchDomainResponseUnmarshaller _instance = new DescribeElasticsearchDomainResponseUnmarshaller();        

        internal static DescribeElasticsearchDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeElasticsearchDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
