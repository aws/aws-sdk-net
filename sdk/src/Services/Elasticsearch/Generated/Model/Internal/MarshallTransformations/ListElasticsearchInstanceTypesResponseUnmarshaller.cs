...
{
    /// <summary>
    /// Response Unmarshaller for ListElasticsearchInstanceTypes operation
    /// </summary>  
    public class ListElasticsearchInstanceTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListElasticsearchInstanceTypesResponse response = new ListElasticsearchInstanceTypesResponse();
            ...
            {
                if (context.TestExpression("ElasticsearchInstanceTypes", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ElasticsearchInstanceTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListElasticsearchInstanceTypesResponseUnmarshaller _instance = new ListElasticsearchInstanceTypesResponseUnmarshaller();        

        internal static ListElasticsearchInstanceTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListElasticsearchInstanceTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
