...
{
    /// <summary>
    /// Response Unmarshaller for DescribeElasticsearchDomainConfig operation
    /// </summary>  
    public class DescribeElasticsearchDomainConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeElasticsearchDomainConfigResponse response = new DescribeElasticsearchDomainConfigResponse();
        ...
        private static DescribeElasticsearchDomainConfigResponseUnmarshaller _instance = new DescribeElasticsearchDomainConfigResponseUnmarshaller();        

        internal static DescribeElasticsearchDomainConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeElasticsearchDomainConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
