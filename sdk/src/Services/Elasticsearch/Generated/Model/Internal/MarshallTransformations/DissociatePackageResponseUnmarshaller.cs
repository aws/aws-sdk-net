...
{
    /// <summary>
    /// Response Unmarshaller for DissociatePackage operation
    /// </summary>  
    public class DissociatePackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DissociatePackageResponse response = new DissociatePackageResponse();
            ...
            {
                if (context.TestExpression("DomainPackageDetails", targetDepth, ref reader))
                {
                    var unmarshaller = DomainPackageDetailsUnmarshaller.Instance;
                    response.DomainPackageDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DissociatePackageResponseUnmarshaller _instance = new DissociatePackageResponseUnmarshaller();        

        internal static DissociatePackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DissociatePackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
