    ...
    public class ListVpcEndpointAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AuthorizedPrincipal, AuthorizedPrincipalUnmarshaller>(AuthorizedPrincipalUnmarshaller.Instance);
                    response.AuthorizedPrincipalList = unmarshaller.Unmarshall(context);
                    continue;
                }
