...
{
    /// <summary>
    /// Response Unmarshaller for ListElasticsearchVersions operation
    /// </summary>  
    public class ListElasticsearchVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListElasticsearchVersionsResponse response = new ListElasticsearchVersionsResponse();
            ...
            {
                if (context.TestExpression("ElasticsearchVersions", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ElasticsearchVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListElasticsearchVersionsResponseUnmarshaller _instance = new ListElasticsearchVersionsResponseUnmarshaller();        

        internal static ListElasticsearchVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListElasticsearchVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
