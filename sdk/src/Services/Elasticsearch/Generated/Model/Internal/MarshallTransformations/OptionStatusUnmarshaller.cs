...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OptionStatusUnmarshaller : IJsonUnmarshaller<OptionStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OptionStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PendingDeletion", targetDepth))
                {
                    ...
                    unmarshalledObject.PendingDeletion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
