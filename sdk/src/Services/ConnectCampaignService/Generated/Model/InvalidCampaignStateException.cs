...
namespace Amazon.ConnectCampaignService.Model
{
    ...
    public partial class InvalidCampaignStateException : AmazonConnectCampaignServiceException
    {
        ...
        public InvalidCampaignStateException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCampaignStateException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
