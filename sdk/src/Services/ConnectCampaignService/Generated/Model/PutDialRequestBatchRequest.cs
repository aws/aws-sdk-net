...
{
    /// <summary>
    /// Container for the parameters to the PutDialRequestBatch operation.
    ...
    public partial class PutDialRequestBatchRequest : AmazonConnectCampaignServiceRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property DialRequests.
        /// <para />
        ...
        public List<DialRequest> DialRequests
        {
            get { return this._dialRequests; }
            set { this._dialRequests = value; }
        }
