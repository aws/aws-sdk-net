...
namespace Amazon.ConnectCampaignService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredictiveDialerConfigUnmarshaller : IJsonUnmarshaller<PredictiveDialerConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PredictiveDialerConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
