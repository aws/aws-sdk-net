...
namespace Amazon.ConnectCampaignService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OutboundCallConfigUnmarshaller : IJsonUnmarshaller<OutboundCallConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OutboundCallConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
