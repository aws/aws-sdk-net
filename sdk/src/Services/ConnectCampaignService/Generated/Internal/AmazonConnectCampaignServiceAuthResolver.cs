...
namespace Amazon.ConnectCampaignService.Internal
{
    ...
    public class AmazonConnectCampaignServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonConnectCampaignServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ConnectCampaignService.
        /// </summary>
        public AmazonConnectCampaignServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonConnectCampaignServiceAuthSchemeParameters
            {
    ...
    public class AmazonConnectCampaignServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonConnectCampaignServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonConnectCampaignServiceAuthSchemeParameters authParameters)
        {
