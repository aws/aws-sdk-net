...
namespace Amazon.RecycleBin.Model
{
    ...
    ///</summary>
    public partial class RecycleBinPaginatorFactory : IRecycleBinPaginatorFactory
    {
        private readonly IAmazonRecycleBin client;

        internal RecycleBinPaginatorFactory(IAmazonRecycleBin client) 
        {
            this.client = client;
        }
