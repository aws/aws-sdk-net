...
{
    /// <summary>
    /// UnlockRule Request Marshaller
    /// </summary>       
    public class UnlockRuleRequestMarshaller : IMarshaller<IRequest, UnlockRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UnlockRuleRequest)input);
        }
        ...
        public IRequest Marshall(UnlockRuleRequest publicRequest)
        {
            ...
            request.ResourcePath = "/rules/{identifier}/unlock";

            return request;
        }
        private static UnlockRuleRequestMarshaller _instance = new UnlockRuleRequestMarshaller();        

        internal static UnlockRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnlockRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
