...
namespace Amazon.RecycleBin
{
    ...
    /// deleted EBS volumes, EBS snapshots, and EBS-backed AMIs. When using Recycle Bin, if
    /// your resources are deleted, they are retained in the Recycle Bin for a time period
    /// that you specify.
    /// </para>
    ///  
    /// <para>
    ...
    public partial class AmazonRecycleBinClient : AmazonServiceClient, IAmazonRecycleBin
    {
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonRecycleBinEndpointResolver();
