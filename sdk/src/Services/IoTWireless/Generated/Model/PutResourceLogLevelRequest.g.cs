...
{
    /// <summary>
    /// Container for the parameters to the PutResourceLogLevel operation. Sets the log-level
    /// override for a resource ID and resource type. A limit of 200 log level override can
    /// be set per account.
    /// </summary>
