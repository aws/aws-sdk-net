...
{
    /// <summary>
    /// Container for the parameters to the ListDeviceProfiles operation. Lists the device
    ...
    public partial class ListDeviceProfilesRequest : AmazonIoTWirelessRequest
    {
        ...
        /// </para>
        /// </summary>
        public DeviceProfileType DeviceProfileType { get; set; }

        /// <summary>
        /// Checks to see if the DeviceProfileType property is set.
        /// </summary>
        internal bool IsSetDeviceProfileType() => this.DeviceProfileType != null;
