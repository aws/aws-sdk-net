...
{
    /// <summary>
    /// Container for the parameters to the StartWirelessDeviceImportTask operation. Start
    /// import task for provisioning Sidewalk devices in bulk using an S3 CSV file.
    /// </summary>
