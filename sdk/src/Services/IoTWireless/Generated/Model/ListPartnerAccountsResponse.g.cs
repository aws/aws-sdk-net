...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class ListPartnerAccountsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SidewalkAccountInfoWithFingerprint> Sidewalk { get; set; } = AWSConfigs.InitializeCollections ? new List<SidewalkAccountInfoWithFingerprint>() : null;

        /// <summary>
        /// Checks to see if the Sidewalk property is set.
        /// </summary>
        internal bool IsSetSidewalk() => this.Sidewalk != null && (this.Sidewalk.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
