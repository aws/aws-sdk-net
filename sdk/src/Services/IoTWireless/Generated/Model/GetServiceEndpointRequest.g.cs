...
{
    /// <summary>
    /// Container for the parameters to the GetServiceEndpoint operation. Gets the account-specific
    /// endpoint for Configuration and Update Server (CUPS) protocol or LoRaWAN Network Server
    /// (LNS) connections.
    /// </summary>
