...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class ListDevicesForWirelessDeviceImportTaskResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ImportedWirelessDevice> ImportedWirelessDeviceList { get; set; } = AWSConfigs.InitializeCollections ? new List<ImportedWirelessDevice>() : null;

        /// <summary>
        /// Checks to see if the ImportedWirelessDeviceList property is set.
        /// </summary>
        internal bool IsSetImportedWirelessDeviceList() => this.ImportedWirelessDeviceList != null && (this.ImportedWirelessDeviceList.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// </para>
        /// </summary>
        public SidewalkListDevicesForImportInfo Sidewalk { get; set; }
