...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class LoRaWANMulticastGet
    {
        ...
        /// </summary>
        public int? NumberOfDevicesInGroup { get; set; }

        /// <summary>
        /// Checks to see if the NumberOfDevicesInGroup property is set.
        /// </summary>
        internal bool IsSetNumberOfDevicesInGroup() => this.NumberOfDevicesInGroup.HasValue;

        /// <summary>
        /// Gets and sets the property NumberOfDevicesRequested.
        /// </summary>
        public int? NumberOfDevicesRequested { get; set; }

        /// <summary>
        /// Checks to see if the NumberOfDevicesRequested property is set.
        /// </summary>
        internal bool IsSetNumberOfDevicesRequested() => this.NumberOfDevicesRequested.HasValue;
