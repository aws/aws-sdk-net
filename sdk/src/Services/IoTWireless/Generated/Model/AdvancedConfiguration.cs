...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class AdvancedConfiguration
    {
        ...
        {
            get { return this._wiFiCellular; }
            set { this._wiFiCellular = value; }
        }

        // Check to see if WiFiCellular property is set
        internal bool IsSetWiFiCellular()
        {
            return this._wiFiCellular != null;
        }
