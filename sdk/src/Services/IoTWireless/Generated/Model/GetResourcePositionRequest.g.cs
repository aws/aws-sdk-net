...
{
    /// <summary>
    /// Container for the parameters to the GetResourcePosition operation. Get the position
    /// information for a given wireless device or a wireless gateway resource. The position
