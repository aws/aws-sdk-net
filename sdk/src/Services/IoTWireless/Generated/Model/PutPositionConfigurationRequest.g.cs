...
{
    /// <summary>
    /// Container for the parameters to the PutPositionConfiguration operation. Put position
    /// configuration for a given resource. <important> <para> This action is no longer supported.
    /// Calls to update the position configuration should use the <a href="https://docs.aws.amazon.com/iot-wireless/latest/apireference/API_UpdateResourcePosition.html">UpdateResourcePosition</a>
