...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class WirelessGatewayLogOption
    {
        ...
        /// </summary>
        public List<WirelessGatewayEventLogOption> Events { get; set; } = AWSConfigs.InitializeCollections ? new List<WirelessGatewayEventLogOption>() : null;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public WirelessGatewayType Type { get; set; }
