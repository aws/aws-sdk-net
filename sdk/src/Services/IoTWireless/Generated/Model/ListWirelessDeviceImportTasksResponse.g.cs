...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class ListWirelessDeviceImportTasksResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<WirelessDeviceImportTask> WirelessDeviceImportTaskList { get; set; } = AWSConfigs.InitializeCollections ? new List<WirelessDeviceImportTask>() : null;

        /// <summary>
        /// Checks to see if the WirelessDeviceImportTaskList property is set.
        /// </summary>
        internal bool IsSetWirelessDeviceImportTaskList() => this.WirelessDeviceImportTaskList != null && (this.WirelessDeviceImportTaskList.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
