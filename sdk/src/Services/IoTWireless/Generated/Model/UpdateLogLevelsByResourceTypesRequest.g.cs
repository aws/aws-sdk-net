...
{
    /// <summary>
    /// Container for the parameters to the UpdateLogLevelsByResourceTypes operation. Set
    /// default log level, or log levels by resource types. This can be for wireless device,
