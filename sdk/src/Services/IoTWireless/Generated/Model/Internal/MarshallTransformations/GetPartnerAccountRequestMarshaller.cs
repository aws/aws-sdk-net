...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetPartnerAccountRequestMarshaller : IMarshaller<IRequest, GetPartnerAccountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetPartnerAccountRequestMarshaller _instance = new GetPartnerAccountRequestMarshaller();        

        internal static GetPartnerAccountRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartnerAccountRequestMarshaller Instance
        {
            get
            {
                return _instance;
