...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LoRaWANConnectionStatusResourceTypeEventConfigurationUnmarshaller : IUnmarshaller<LoRaWANConnectionStatusResourceTypeEventConfiguration, XmlUnmarshallerContext>, IUnmarshaller<LoRaWANConnectionStatusResourceTypeEventConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LoRaWANConnectionStatusResourceTypeEventConfiguration IUnmarshaller<LoRaWANConnectionStatusResourceTypeEventConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public LoRaWANConnectionStatusResourceTypeEventConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("WirelessGatewayEventTopic", targetDepth))
                {
                    ...
                    unmarshalledObject.WirelessGatewayEventTopic = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
