...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendDataToWirelessDeviceRequestMarshaller : IMarshaller<IRequest, SendDataToWirelessDeviceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(SendDataToWirelessDeviceRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetPayloadData())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.PayloadData);
            }
            if (publicRequest.IsSetTransmitMode())
            {
                context.Writer.WritePropertyName("TransmitMode");
                context.Writer.WriteNumberValue(publicRequest.TransmitMode.Value);
            }
        ...
        private static readonly SendDataToWirelessDeviceRequestMarshaller _instance = new();

        internal static SendDataToWirelessDeviceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendDataToWirelessDeviceRequestMarshaller Instance => _instance;
    }
}
