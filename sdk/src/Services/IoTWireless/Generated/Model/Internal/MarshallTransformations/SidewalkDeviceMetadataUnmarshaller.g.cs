...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SidewalkDeviceMetadataUnmarshaller : IJsonUnmarshaller<SidewalkDeviceMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SidewalkDeviceMetadata();
            ...
            {
                if (context.TestExpression("BatteryLevel", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Rssi", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static SidewalkDeviceMetadataUnmarshaller Instance => _instance;
    }
}
