...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PositionSolverDetailsUnmarshaller : IJsonUnmarshaller<PositionSolverDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PositionSolverDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PositionSolverDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PositionSolverDetailsUnmarshaller Instance => _instance;
    }
}
