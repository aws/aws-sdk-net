...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetServiceProfileRequestMarshaller : IMarshaller<IRequest, GetServiceProfileRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetServiceProfileRequestMarshaller _instance = new();

        internal static GetServiceProfileRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetServiceProfileRequestMarshaller Instance => _instance;
    }
}
