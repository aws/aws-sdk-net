...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDestinationRequestMarshaller : IMarshaller<IRequest, GetDestinationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDestinationRequestMarshaller _instance = new();

        internal static GetDestinationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDestinationRequestMarshaller Instance => _instance;
    }
}
