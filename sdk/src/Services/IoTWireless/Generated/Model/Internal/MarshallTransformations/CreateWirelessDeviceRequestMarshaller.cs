...
{
    /// <summary>
    /// CreateWirelessDevice Request Marshaller
    /// </summary>       
    public class CreateWirelessDeviceRequestMarshaller : IMarshaller<IRequest, CreateWirelessDeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateWirelessDeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateWirelessDeviceRequest publicRequest)
        {
        ...
        private static CreateWirelessDeviceRequestMarshaller _instance = new CreateWirelessDeviceRequestMarshaller();        

        internal static CreateWirelessDeviceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWirelessDeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
