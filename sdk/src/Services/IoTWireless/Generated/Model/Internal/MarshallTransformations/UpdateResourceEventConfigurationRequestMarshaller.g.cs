...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateResourceEventConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateResourceEventConfigurationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateResourceEventConfigurationRequest publicRequest)
        {
            ...
            if (string.IsNullOrEmpty(publicRequest.IdentifierType))
            {
                throw new AmazonIoTWirelessException("Request object does not have required field IdentifierType set");
            }
        ...
        private static readonly UpdateResourceEventConfigurationRequestMarshaller _instance = new();

        internal static UpdateResourceEventConfigurationRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateResourceEventConfigurationRequestMarshaller Instance => _instance;
    }
}
