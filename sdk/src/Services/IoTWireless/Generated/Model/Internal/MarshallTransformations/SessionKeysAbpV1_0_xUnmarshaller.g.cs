...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SessionKeysAbpV1_0_xUnmarshaller : IJsonUnmarshaller<SessionKeysAbpV1_0_x, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SessionKeysAbpV1_0_x();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NwkSKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static SessionKeysAbpV1_0_xUnmarshaller Instance => _instance;
    }
}
