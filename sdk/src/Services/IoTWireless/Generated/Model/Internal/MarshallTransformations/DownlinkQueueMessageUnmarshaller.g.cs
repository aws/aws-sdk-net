...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DownlinkQueueMessageUnmarshaller : IJsonUnmarshaller<DownlinkQueueMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DownlinkQueueMessage();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TransmitMode", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DownlinkQueueMessageUnmarshaller Instance => _instance;
    }
}
