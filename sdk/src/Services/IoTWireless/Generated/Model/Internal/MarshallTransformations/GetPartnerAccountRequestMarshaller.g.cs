...
{
    /// <summary>
    /// GetPartnerAccount Request Marshaller
    /// </summary>
    public partial class GetPartnerAccountRequestMarshaller : IMarshaller<IRequest, GetPartnerAccountRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPartnerAccountRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetPartnerAccountRequest publicRequest)
        {
        ...
        private static readonly GetPartnerAccountRequestMarshaller _instance = new();

        internal static GetPartnerAccountRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPartnerAccountRequestMarshaller Instance => _instance;
    }
}
