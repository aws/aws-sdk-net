...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DakCertificateMetadataUnmarshaller : IJsonUnmarshaller<DakCertificateMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DakCertificateMetadata();
            ...
            {
                if (context.TestExpression("ApId", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("DeviceTypeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("FactorySupport", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("MaxAllowedSignature", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DakCertificateMetadataUnmarshaller Instance => _instance;
    }
}
