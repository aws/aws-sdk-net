...
{
    /// <summary>
    /// CreateNetworkAnalyzerConfiguration Request Marshaller
    /// </summary>       
    public class CreateNetworkAnalyzerConfigurationRequestMarshaller : IMarshaller<IRequest, CreateNetworkAnalyzerConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateNetworkAnalyzerConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateNetworkAnalyzerConfigurationRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetMulticastGroups())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestMulticastGroupsListValue);
                }
            ...
            if(publicRequest.IsSetWirelessDevices())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestWirelessDevicesListValue);
                }
                context.Writer.WriteEndArray();
            }
            ...
            if(publicRequest.IsSetWirelessGateways())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestWirelessGatewaysListValue);
                }
                context.Writer.WriteEndArray();
            }
        ...
        private static CreateNetworkAnalyzerConfigurationRequestMarshaller _instance = new CreateNetworkAnalyzerConfigurationRequestMarshaller();        

        internal static CreateNetworkAnalyzerConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNetworkAnalyzerConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
