...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class WirelessDeviceStatisticsUnmarshaller : IJsonUnmarshaller<WirelessDeviceStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new WirelessDeviceStatistics();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FuotaDeviceStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("McGroupId", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("MulticastDeviceStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static WirelessDeviceStatisticsUnmarshaller Instance => _instance;
    }
}
