...
namespace Amazon.IoTWireless.Model
{
    ...
    public partial class FPorts
    {
        ...
        /// </summary>
        public List<ApplicationConfig> Applications { get; set; } = AWSConfigs.InitializeCollections ? new List<ApplicationConfig>() : null;
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 223)]
        public int? Fuota { get; set; }

        /// <summary>
        /// Checks to see if the Fuota property is set.
        /// </summary>
        internal bool IsSetFuota() => this.Fuota.HasValue;
        ...
        /// <summary>
        /// Checks to see if the Multicast property is set.
        /// </summary>
        internal bool IsSetMulticast() => this.Multicast.HasValue;
