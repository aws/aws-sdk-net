...
{
    /// <summary>
    /// Container for the parameters to the UpdatePartnerAccount operation. Updates properties
    ...
    public partial class UpdatePartnerAccountRequest : AmazonIoTWirelessRequest
    {
        ...
        /// <summary>
        /// Checks to see if the PartnerAccountId property is set.
        /// </summary>
        internal bool IsSetPartnerAccountId() => this.PartnerAccountId != null;
