...
namespace Amazon.IoTWireless
{
    ...
    /// and <a href="https://docs.aws.amazon.com/iot-wireless/latest/developerguide/iot-sidewalk.html">Sidewalk</a>
    /// devices to AWS IoT, use the IoT Wireless API. These wireless devices use the Low Power
    /// Wide Area Networking (LPWAN) communication protocol to communicate with AWS IoT. 
    /// 
    ///  
    /// <para>
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonIoTWirelessConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonIoTWirelessConfig();
        ...
        {
            var serviceClientConfig = clientConfig as AmazonIoTWirelessConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonIoTWirelessConfig to create AmazonIoTWirelessClient");
            }

            return awsCredentials == null ?
                    new AmazonIoTWirelessClient(serviceClientConfig) :
                    new AmazonIoTWirelessClient(awsCredentials, serviceClientConfig);
        }
