...
namespace Amazon.IoTWireless
{
    ...
    public partial class AmazonIoTWirelessConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("IoT Wireless", "4.0.102.1");
        ...
        /// </summary>
        public static new string ServiceId => "IoT Wireless";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "api.iotwireless";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-11-22";
