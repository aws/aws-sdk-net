...
namespace Amazon.IoTWireless
{
    ...
    public partial class AmazonIoTWirelessClient : AmazonServiceClient, IAmazonIoTWireless
    {
        ...
        /// 
        /// </summary>
        public AmazonIoTWirelessClient() : base(new AmazonIoTWirelessConfig()) { }
        ...
        public AmazonIoTWirelessClient(RegionEndpoint region) : base(new AmazonIoTWirelessConfig { RegionEndpoint = region }) { }
        ...
        public AmazonIoTWirelessClient(AmazonIoTWirelessConfig config) : base(config) { }
