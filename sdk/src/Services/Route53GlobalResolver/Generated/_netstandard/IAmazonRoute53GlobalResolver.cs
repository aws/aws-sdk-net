...
namespace Amazon.Route53GlobalResolver
{
    ...
    public partial interface IAmazonRoute53GlobalResolver : IAmazonService, IDisposable
    {
        ...
        Task<ListSharedDNSViewsResponse> ListSharedDNSViewsAsync(ListSharedDNSViewsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
