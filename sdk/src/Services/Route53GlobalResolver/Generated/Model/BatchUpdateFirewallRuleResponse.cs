...
namespace Amazon.Route53GlobalResolver.Model
{
    ...
    {
        private List<BatchUpdateFirewallRuleOutputItem> _failures = AWSConfigs.InitializeCollections ? new List<BatchUpdateFirewallRuleOutputItem>() : null;
        private List<BatchUpdateFirewallRuleOutputItem> _successes = AWSConfigs.InitializeCollections ? new List<BatchUpdateFirewallRuleOutputItem>() : null;
        ...
        public List<BatchUpdateFirewallRuleOutputItem> Failures
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<BatchUpdateFirewallRuleOutputItem> Successes
        {
