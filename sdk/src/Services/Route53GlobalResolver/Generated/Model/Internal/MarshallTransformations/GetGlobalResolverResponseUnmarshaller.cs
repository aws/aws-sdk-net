...
{
    /// <summary>
    /// Response Unmarshaller for GetGlobalResolver operation
    /// </summary>  
    public class GetGlobalResolverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGlobalResolverResponse response = new GetGlobalResolverResponse();
        ...
        private static GetGlobalResolverResponseUnmarshaller _instance = new GetGlobalResolverResponseUnmarshaller();        

        internal static GetGlobalResolverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGlobalResolverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
