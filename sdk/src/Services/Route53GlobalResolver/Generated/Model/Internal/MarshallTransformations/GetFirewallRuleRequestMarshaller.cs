...
{
    /// <summary>
    /// GetFirewallRule Request Marshaller
    /// </summary>       
    public class GetFirewallRuleRequestMarshaller : IMarshaller<IRequest, GetFirewallRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFirewallRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetFirewallRuleRequest publicRequest)
        {
        ...
        private static GetFirewallRuleRequestMarshaller _instance = new GetFirewallRuleRequestMarshaller();        

        internal static GetFirewallRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFirewallRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
