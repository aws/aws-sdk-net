...
{
    /// <summary>
    /// Response Unmarshaller for CreateDNSView operation
    /// </summary>  
    public class CreateDNSViewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDNSViewResponse response = new CreateDNSViewResponse();
        ...
        private static CreateDNSViewResponseUnmarshaller _instance = new CreateDNSViewResponseUnmarshaller();        

        internal static CreateDNSViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDNSViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
