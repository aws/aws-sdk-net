...
{
    /// <summary>
    /// GetDNSView Request Marshaller
    /// </summary>       
    public class GetDNSViewRequestMarshaller : IMarshaller<IRequest, GetDNSViewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDNSViewRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDNSViewRequest publicRequest)
        {
        ...
        private static GetDNSViewRequestMarshaller _instance = new GetDNSViewRequestMarshaller();        

        internal static GetDNSViewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDNSViewRequestMarshaller Instance
        {
            get
            {
                return _instance;
