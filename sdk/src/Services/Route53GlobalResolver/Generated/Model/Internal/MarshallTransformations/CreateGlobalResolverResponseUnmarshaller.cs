...
{
    /// <summary>
    /// Response Unmarshaller for CreateGlobalResolver operation
    /// </summary>  
    public class CreateGlobalResolverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGlobalResolverResponse response = new CreateGlobalResolverResponse();
        ...
        private static CreateGlobalResolverResponseUnmarshaller _instance = new CreateGlobalResolverResponseUnmarshaller();        

        internal static CreateGlobalResolverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlobalResolverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
