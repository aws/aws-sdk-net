...
namespace Amazon.Route53GlobalResolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccessSourcesItemUnmarshaller : IJsonUnmarshaller<AccessSourcesItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccessSourcesItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
