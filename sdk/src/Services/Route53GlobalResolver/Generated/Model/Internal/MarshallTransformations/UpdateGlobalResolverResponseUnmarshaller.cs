...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGlobalResolver operation
    /// </summary>  
    public class UpdateGlobalResolverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGlobalResolverResponse response = new UpdateGlobalResolverResponse();
        ...
        private static UpdateGlobalResolverResponseUnmarshaller _instance = new UpdateGlobalResolverResponseUnmarshaller();        

        internal static UpdateGlobalResolverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGlobalResolverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
