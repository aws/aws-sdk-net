...
namespace Amazon.Route53GlobalResolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchCreateFirewallRuleResultUnmarshaller : IJsonUnmarshaller<BatchCreateFirewallRuleResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchCreateFirewallRuleResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("managedDomainListName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ManagedDomainListName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
