...
{
    /// <summary>
    /// Response Unmarshaller for AssociateHostedZone operation
    /// </summary>  
    public class AssociateHostedZoneResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateHostedZoneResponse response = new AssociateHostedZoneResponse();
        ...
        private static AssociateHostedZoneResponseUnmarshaller _instance = new AssociateHostedZoneResponseUnmarshaller();        

        internal static AssociateHostedZoneResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateHostedZoneResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
