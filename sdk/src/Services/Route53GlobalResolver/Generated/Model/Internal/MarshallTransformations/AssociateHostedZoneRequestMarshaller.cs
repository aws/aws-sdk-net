...
{
    /// <summary>
    /// AssociateHostedZone Request Marshaller
    /// </summary>       
    public class AssociateHostedZoneRequestMarshaller : IMarshaller<IRequest, AssociateHostedZoneRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateHostedZoneRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateHostedZoneRequest publicRequest)
        {
            ...
            request.ResourcePath = "/hosted-zone-associations/{hostedZoneId}";
#if !NETFRAMEWORK
        ...
        private static AssociateHostedZoneRequestMarshaller _instance = new AssociateHostedZoneRequestMarshaller();        

        internal static AssociateHostedZoneRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateHostedZoneRequestMarshaller Instance
        {
            get
            {
                return _instance;
