...
{
    /// <summary>
    /// DisableDNSView Request Marshaller
    /// </summary>       
    public class DisableDNSViewRequestMarshaller : IMarshaller<IRequest, DisableDNSViewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisableDNSViewRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisableDNSViewRequest publicRequest)
        {
            ...
            request.ResourcePath = "/dns-views/{dnsViewId}/disable";

            return request;
        }
        private static DisableDNSViewRequestMarshaller _instance = new DisableDNSViewRequestMarshaller();        

        internal static DisableDNSViewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableDNSViewRequestMarshaller Instance
        {
            get
            {
                return _instance;
