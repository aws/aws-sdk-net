...
{
    /// <summary>
    /// Response Unmarshaller for ImportFirewallDomains operation
    /// </summary>  
    public class ImportFirewallDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportFirewallDomainsResponse response = new ImportFirewallDomainsResponse();
        ...
        private static ImportFirewallDomainsResponseUnmarshaller _instance = new ImportFirewallDomainsResponseUnmarshaller();        

        internal static ImportFirewallDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportFirewallDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
