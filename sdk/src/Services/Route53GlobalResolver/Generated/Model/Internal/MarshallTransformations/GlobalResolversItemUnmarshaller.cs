...
{
    /// <summary>
    /// Response Unmarshaller for GlobalResolversItem Object
    /// </summary>  
    public class GlobalResolversItemUnmarshaller : IUnmarshaller<GlobalResolversItem, XmlUnmarshallerContext>, IUnmarshaller<GlobalResolversItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GlobalResolversItem IUnmarshaller<GlobalResolversItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GlobalResolversItem Unmarshall(JsonUnmarshallerContext context)
        {
            GlobalResolversItem unmarshalledObject = new GlobalResolversItem();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ObservabilityRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GlobalResolversItemUnmarshaller _instance = new GlobalResolversItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GlobalResolversItemUnmarshaller Instance
        {
            get
            {
                return _instance;
