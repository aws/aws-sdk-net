...
namespace Amazon.Route53GlobalResolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GlobalResolversItemUnmarshaller : IJsonUnmarshaller<GlobalResolversItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GlobalResolversItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ObservabilityRegion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
