...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAccessSource operation
    /// </summary>  
    public class UpdateAccessSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAccessSourceResponse response = new UpdateAccessSourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Cidr = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAccessSourceResponseUnmarshaller _instance = new UpdateAccessSourceResponseUnmarshaller();        

        internal static UpdateAccessSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccessSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
