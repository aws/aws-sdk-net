...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateHostedZone operation
    /// </summary>  
    public class DisassociateHostedZoneResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateHostedZoneResponse response = new DisassociateHostedZoneResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hostedZoneId", targetDepth, ref reader))
                {
                    ...
                    response.HostedZoneId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("hostedZoneName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HostedZoneName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DisassociateHostedZoneResponseUnmarshaller _instance = new DisassociateHostedZoneResponseUnmarshaller();        

        internal static DisassociateHostedZoneResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateHostedZoneResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
