...
namespace Amazon.Route53GlobalResolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAccessTokenRequestMarshaller : IMarshaller<IRequest, GetAccessTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAccessTokenRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAccessTokenRequest publicRequest)
        {
        ...
        private static GetAccessTokenRequestMarshaller _instance = new GetAccessTokenRequestMarshaller();        

        internal static GetAccessTokenRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessTokenRequestMarshaller Instance
        {
            get
            {
                return _instance;
