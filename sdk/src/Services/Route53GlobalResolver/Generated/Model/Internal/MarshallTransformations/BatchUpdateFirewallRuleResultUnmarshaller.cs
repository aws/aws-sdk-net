...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdateFirewallRuleResult Object
    /// </summary>  
    public class BatchUpdateFirewallRuleResultUnmarshaller : IUnmarshaller<BatchUpdateFirewallRuleResult, XmlUnmarshallerContext>, IUnmarshaller<BatchUpdateFirewallRuleResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BatchUpdateFirewallRuleResult IUnmarshaller<BatchUpdateFirewallRuleResult, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public BatchUpdateFirewallRuleResult Unmarshall(JsonUnmarshallerContext context)
        {
            BatchUpdateFirewallRuleResult unmarshalledObject = new BatchUpdateFirewallRuleResult();
        ...
        private static BatchUpdateFirewallRuleResultUnmarshaller _instance = new BatchUpdateFirewallRuleResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateFirewallRuleResultUnmarshaller Instance
        {
            get
            {
                return _instance;
