...
{
    /// <summary>
    /// Response Unmarshaller for ListAccessSources operation
    /// </summary>  
    public class ListAccessSourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccessSourcesResponse response = new ListAccessSourcesResponse();
            ...
            {
                if (context.TestExpression("accessSources", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AccessSourcesItem, AccessSourcesItemUnmarshaller>(AccessSourcesItemUnmarshaller.Instance);
                    response.AccessSources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAccessSourcesResponseUnmarshaller _instance = new ListAccessSourcesResponseUnmarshaller();        

        internal static ListAccessSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
