...
{
    /// <summary>
    /// Response Unmarshaller for ListSharedDNSViews operation
    /// </summary>  
    public class ListSharedDNSViewsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSharedDNSViewsResponse response = new ListSharedDNSViewsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SharedDNSViewSummary, SharedDNSViewSummaryUnmarshaller>(SharedDNSViewSummaryUnmarshaller.Instance);
        ...
        private static ListSharedDNSViewsResponseUnmarshaller _instance = new ListSharedDNSViewsResponseUnmarshaller();        

        internal static ListSharedDNSViewsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSharedDNSViewsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
