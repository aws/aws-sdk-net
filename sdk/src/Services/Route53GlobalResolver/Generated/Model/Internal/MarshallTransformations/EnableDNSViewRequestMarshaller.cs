...
namespace Amazon.Route53GlobalResolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class EnableDNSViewRequestMarshaller : IMarshaller<IRequest, EnableDNSViewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static EnableDNSViewRequestMarshaller _instance = new EnableDNSViewRequestMarshaller();        

        internal static EnableDNSViewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableDNSViewRequestMarshaller Instance
        {
            get
            {
                return _instance;
