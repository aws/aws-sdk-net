...
{
    /// <summary>
    /// DeleteFirewallRule Request Marshaller
    /// </summary>       
    public class DeleteFirewallRuleRequestMarshaller : IMarshaller<IRequest, DeleteFirewallRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteFirewallRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteFirewallRuleRequest publicRequest)
        {
        ...
        private static DeleteFirewallRuleRequestMarshaller _instance = new DeleteFirewallRuleRequestMarshaller();        

        internal static DeleteFirewallRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFirewallRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
