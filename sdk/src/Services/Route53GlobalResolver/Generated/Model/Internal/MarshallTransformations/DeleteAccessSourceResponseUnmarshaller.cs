...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAccessSource operation
    /// </summary>  
    public class DeleteAccessSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccessSourceResponse response = new DeleteAccessSourceResponse();
        ...
        private static DeleteAccessSourceResponseUnmarshaller _instance = new DeleteAccessSourceResponseUnmarshaller();        

        internal static DeleteAccessSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
