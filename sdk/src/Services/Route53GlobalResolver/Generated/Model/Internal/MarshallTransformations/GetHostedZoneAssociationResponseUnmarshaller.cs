...
{
    /// <summary>
    /// Response Unmarshaller for GetHostedZoneAssociation operation
    /// </summary>  
    public class GetHostedZoneAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHostedZoneAssociationResponse response = new GetHostedZoneAssociationResponse();
        ...
        private static GetHostedZoneAssociationResponseUnmarshaller _instance = new GetHostedZoneAssociationResponseUnmarshaller();        

        internal static GetHostedZoneAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHostedZoneAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
