...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHostedZoneAssociation operation
    /// </summary>  
    public class UpdateHostedZoneAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHostedZoneAssociationResponse response = new UpdateHostedZoneAssociationResponse();
        ...
        private static UpdateHostedZoneAssociationResponseUnmarshaller _instance = new UpdateHostedZoneAssociationResponseUnmarshaller();        

        internal static UpdateHostedZoneAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHostedZoneAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
