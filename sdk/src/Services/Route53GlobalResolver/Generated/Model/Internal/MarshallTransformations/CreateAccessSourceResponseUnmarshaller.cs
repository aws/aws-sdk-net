...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccessSource operation
    /// </summary>  
    public class CreateAccessSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAccessSourceResponse response = new CreateAccessSourceResponse();
        ...
        private static CreateAccessSourceResponseUnmarshaller _instance = new CreateAccessSourceResponseUnmarshaller();        

        internal static CreateAccessSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
