...
{
    /// <summary>
    /// CreateAccessSource Request Marshaller
    /// </summary>       
    public class CreateAccessSourceRequestMarshaller : IMarshaller<IRequest, CreateAccessSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccessSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccessSourceRequest publicRequest)
        {
        ...
        private static CreateAccessSourceRequestMarshaller _instance = new CreateAccessSourceRequestMarshaller();        

        internal static CreateAccessSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
