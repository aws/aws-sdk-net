...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGlobalResolver operation
    /// </summary>  
    public class DeleteGlobalResolverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGlobalResolverResponse response = new DeleteGlobalResolverResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ipv4Addresses", targetDepth))
                {
                    ...
                    response.Ipv4Addresses = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ipv6Addresses", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.Ipv6Addresses = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("observabilityRegion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ObservabilityRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DeleteGlobalResolverResponseUnmarshaller _instance = new DeleteGlobalResolverResponseUnmarshaller();        

        internal static DeleteGlobalResolverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGlobalResolverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
