...
{
    /// <summary>
    /// Response Unmarshaller for FirewallRulesItem Object
    /// </summary>  
    public class FirewallRulesItemUnmarshaller : IUnmarshaller<FirewallRulesItem, XmlUnmarshallerContext>, IUnmarshaller<FirewallRulesItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FirewallRulesItem IUnmarshaller<FirewallRulesItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public FirewallRulesItem Unmarshall(JsonUnmarshallerContext context)
        {
            FirewallRulesItem unmarshalledObject = new FirewallRulesItem();
        ...
        private static FirewallRulesItemUnmarshaller _instance = new FirewallRulesItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FirewallRulesItemUnmarshaller Instance
        {
            get
            {
                return _instance;
