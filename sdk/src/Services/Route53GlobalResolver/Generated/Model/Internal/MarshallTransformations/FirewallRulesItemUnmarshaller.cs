...
namespace Amazon.Route53GlobalResolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FirewallRulesItemUnmarshaller : IJsonUnmarshaller<FirewallRulesItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FirewallRulesItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DnsAdvancedProtection = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
