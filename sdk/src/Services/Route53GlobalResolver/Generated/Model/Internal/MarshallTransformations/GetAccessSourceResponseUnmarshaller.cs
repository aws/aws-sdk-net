...
{
    /// <summary>
    /// Response Unmarshaller for GetAccessSource operation
    /// </summary>  
    public class GetAccessSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccessSourceResponse response = new GetAccessSourceResponse();
        ...
        private static GetAccessSourceResponseUnmarshaller _instance = new GetAccessSourceResponseUnmarshaller();        

        internal static GetAccessSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
