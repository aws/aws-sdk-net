...
{
    /// <summary>
    /// Response Unmarshaller for ListFirewallDomains operation
    /// </summary>  
    public class ListFirewallDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFirewallDomainsResponse response = new ListFirewallDomainsResponse();
        ...
        private static ListFirewallDomainsResponseUnmarshaller _instance = new ListFirewallDomainsResponseUnmarshaller();        

        internal static ListFirewallDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFirewallDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
