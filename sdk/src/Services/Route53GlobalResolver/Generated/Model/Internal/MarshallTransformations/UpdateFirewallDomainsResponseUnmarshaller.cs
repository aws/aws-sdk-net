...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFirewallDomains operation
    /// </summary>  
    public class UpdateFirewallDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFirewallDomainsResponse response = new UpdateFirewallDomainsResponse();
        ...
        private static UpdateFirewallDomainsResponseUnmarshaller _instance = new UpdateFirewallDomainsResponseUnmarshaller();        

        internal static UpdateFirewallDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
