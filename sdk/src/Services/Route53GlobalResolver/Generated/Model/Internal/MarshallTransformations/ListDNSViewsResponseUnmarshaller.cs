...
{
    /// <summary>
    /// Response Unmarshaller for ListDNSViews operation
    /// </summary>  
    public class ListDNSViewsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDNSViewsResponse response = new ListDNSViewsResponse();
            ...
            {
                if (context.TestExpression("dnsViews", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DNSViewSummary, DNSViewSummaryUnmarshaller>(DNSViewSummaryUnmarshaller.Instance);
                    response.DnsViews = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDNSViewsResponseUnmarshaller _instance = new ListDNSViewsResponseUnmarshaller();        

        internal static ListDNSViewsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDNSViewsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
