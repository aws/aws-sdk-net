...
namespace Amazon.Route53GlobalResolver.Model
{
    ...
    public partial interface IListHostedZoneAssociationsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListHostedZoneAssociationsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the HostedZoneAssociations
        /// </summary>
        IPaginatedEnumerable<HostedZoneAssociationSummary> HostedZoneAssociations { get; }
    }
}