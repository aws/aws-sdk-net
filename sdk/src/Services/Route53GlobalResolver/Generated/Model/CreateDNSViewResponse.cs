...
{
    /// <summary>
    /// This is the response object from the CreateDNSView operation.
    /// </summary>
    public partial class CreateDNSViewResponse : AmazonWebServiceResponse
    {
        private string _arn;
        ...
        /// <para>
        /// The behavior when Route 53 Global Resolver cannot apply DNS firewall rules due to
        /// service impairment.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
