...
namespace Amazon.Route53GlobalResolver.Model
{
    ...
    {
        private List<BatchCreateFirewallRuleOutputItem> _failures = AWSConfigs.InitializeCollections ? new List<BatchCreateFirewallRuleOutputItem>() : null;
        private List<BatchCreateFirewallRuleOutputItem> _successes = AWSConfigs.InitializeCollections ? new List<BatchCreateFirewallRuleOutputItem>() : null;
        ...
        public List<BatchCreateFirewallRuleOutputItem> Failures
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<BatchCreateFirewallRuleOutputItem> Successes
        {
