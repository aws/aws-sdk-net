...
namespace Amazon.Route53GlobalResolver.Internal
{
    ...
    public class AmazonRoute53GlobalResolverAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRoute53GlobalResolverAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Route53GlobalResolver.
        /// </summary>
        public AmazonRoute53GlobalResolverAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRoute53GlobalResolverAuthSchemeParameters
            {
    ...
    public class AmazonRoute53GlobalResolverAuthSchemeResolver : IAuthSchemeResolver<AmazonRoute53GlobalResolverAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRoute53GlobalResolverAuthSchemeParameters authParameters)
        {
