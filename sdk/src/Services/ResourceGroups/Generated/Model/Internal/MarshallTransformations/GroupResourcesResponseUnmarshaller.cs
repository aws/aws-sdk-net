...
{
    /// <summary>
    /// Response Unmarshaller for GroupResources operation
    /// </summary>  
    public class GroupResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GroupResourcesResponse response = new GroupResourcesResponse();
        ...
        private static GroupResourcesResponseUnmarshaller _instance = new GroupResourcesResponseUnmarshaller();        

        internal static GroupResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GroupResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
