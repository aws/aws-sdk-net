...
{
    /// <summary>
    /// Response Unmarshaller for GetGroupConfiguration operation
    /// </summary>  
    public class GetGroupConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGroupConfigurationResponse response = new GetGroupConfigurationResponse();
        ...
        private static GetGroupConfigurationResponseUnmarshaller _instance = new GetGroupConfigurationResponseUnmarshaller();        

        internal static GetGroupConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGroupConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
