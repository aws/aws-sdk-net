    ...
    public class ListTagSyncTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TagSyncTaskItem, TagSyncTaskItemUnmarshaller>(TagSyncTaskItemUnmarshaller.Instance);
                    response.TagSyncTasks = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
