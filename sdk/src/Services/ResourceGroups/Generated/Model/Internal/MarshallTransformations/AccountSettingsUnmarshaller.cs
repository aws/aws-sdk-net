        ...
        public AccountSettings Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("GroupLifecycleEventsDesiredStatus", targetDepth))
                {
                    ...
                    unmarshalledObject.GroupLifecycleEventsDesiredStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("GroupLifecycleEventsStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.GroupLifecycleEventsStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("GroupLifecycleEventsStatusMessage", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.GroupLifecycleEventsStatusMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
