...
namespace Amazon.ResourceGroups.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGroupResourcesItemUnmarshaller : IJsonUnmarshaller<ListGroupResourcesItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListGroupResourcesItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
