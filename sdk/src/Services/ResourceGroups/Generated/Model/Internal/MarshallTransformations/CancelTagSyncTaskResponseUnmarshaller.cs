...
{
    /// <summary>
    /// Response Unmarshaller for CancelTagSyncTask operation
    /// </summary>  
    public class CancelTagSyncTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelTagSyncTaskResponse response = new CancelTagSyncTaskResponse();
        ...
        private static CancelTagSyncTaskResponseUnmarshaller _instance = new CancelTagSyncTaskResponseUnmarshaller();        

        internal static CancelTagSyncTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelTagSyncTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
