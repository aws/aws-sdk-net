...
namespace Amazon.Appflow.Model
{
    ...
    public partial class ListConnectorEntitiesResponse : AmazonWebServiceResponse
    {
        ...
        public Dictionary<string, List<ConnectorEntity>> ConnectorEntityMap { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, List<ConnectorEntity>>() : null;

        /// <summary>
        /// Checks to see if the ConnectorEntityMap property is set.
        /// </summary>
        internal bool IsSetConnectorEntityMap() => this.ConnectorEntityMap != null && (this.ConnectorEntityMap.Count > 0 || !AWSConfigs.InitializeCollections);
