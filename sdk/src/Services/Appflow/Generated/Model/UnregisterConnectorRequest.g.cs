...
{
    /// <summary>
    /// Container for the parameters to the UnregisterConnector operation. Unregisters the
    /// custom connector registered in your account that matches the connector label provided
    /// in the request.
    /// </summary>
    public partial class UnregisterConnectorRequest : AmazonAppflowRequest
    {
        ...
        /// <summary>
        /// Checks to see if the ForceDelete property is set.
        /// </summary>
        internal bool IsSetForceDelete() => this.ForceDelete.HasValue;
    }
}
