...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PardotConnectorProfilePropertiesMarshaller : IRequestMarshaller<PardotConnectorProfileProperties, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(PardotConnectorProfileProperties requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetBusinessUnitId())
            {
                ...
                context.Writer.WriteStringValue(requestObject.BusinessUnitId);
            }
            ...
            if (requestObject.IsSetIsSandboxEnvironment())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.IsSandboxEnvironment.Value);
            }
        }
