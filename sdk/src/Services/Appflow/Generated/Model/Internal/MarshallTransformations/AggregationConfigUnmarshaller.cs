...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AggregationConfigUnmarshaller : IJsonUnmarshaller<AggregationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AggregationConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("targetFileSize", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.TargetFileSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
