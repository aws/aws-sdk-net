...
{
    /// <summary>
    /// Response Unmarshaller for DescribeConnectors operation
    /// </summary>  
    public class DescribeConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeConnectorsResponseUnmarshaller _instance = new DescribeConnectorsResponseUnmarshaller();        

        internal static DescribeConnectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConnectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
