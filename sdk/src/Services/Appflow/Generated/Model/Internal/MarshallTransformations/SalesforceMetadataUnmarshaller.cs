...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SalesforceMetadataUnmarshaller : IJsonUnmarshaller<SalesforceMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SalesforceMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("dataTransferApis", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.DataTransferApis = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
