...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DestinationConnectorPropertiesUnmarshaller : IJsonUnmarshaller<DestinationConnectorProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DestinationConnectorProperties();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LookoutMetrics", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static DestinationConnectorPropertiesUnmarshaller Instance => _instance;
    }
}
