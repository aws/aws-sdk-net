...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeConnectorEntityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeConnectorEntityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("connectorEntityFields", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConnectorEntityFields = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeConnectorEntityResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeConnectorEntityResponseUnmarshaller Instance => _instance;
    }
}
