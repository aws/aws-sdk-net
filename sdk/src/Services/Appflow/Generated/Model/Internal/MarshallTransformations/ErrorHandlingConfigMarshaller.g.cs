...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ErrorHandlingConfigMarshaller : IRequestMarshaller<ErrorHandlingConfig, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ErrorHandlingConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetFailOnFirstDestinationError())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.FailOnFirstDestinationError.Value);
            }
        }
