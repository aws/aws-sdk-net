...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteFlowRequestMarshaller : IMarshaller<IRequest, DeleteFlowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteFlowRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetForceDelete())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.ForceDelete.Value);
            }
        ...
        private static readonly DeleteFlowRequestMarshaller _instance = new();

        internal static DeleteFlowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteFlowRequestMarshaller Instance => _instance;
    }
}
