...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectorDetailUnmarshaller : IJsonUnmarshaller<ConnectorDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ConnectorDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ConnectorDetail();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConnectorDetailUnmarshaller Instance => _instance;
    }
}
