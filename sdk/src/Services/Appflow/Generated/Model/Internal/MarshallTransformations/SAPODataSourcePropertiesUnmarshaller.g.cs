...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SAPODataSourcePropertiesUnmarshaller : IJsonUnmarshaller<SAPODataSourceProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SAPODataSourceProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SAPODataSourceProperties();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SAPODataSourcePropertiesUnmarshaller Instance => _instance;
    }
}
