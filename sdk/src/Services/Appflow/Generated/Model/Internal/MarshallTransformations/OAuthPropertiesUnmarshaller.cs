...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OAuthPropertiesUnmarshaller : IJsonUnmarshaller<OAuthProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OAuthProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("authCodeUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AuthCodeUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
