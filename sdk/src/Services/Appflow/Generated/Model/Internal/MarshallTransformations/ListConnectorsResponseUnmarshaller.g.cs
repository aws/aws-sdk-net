...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListConnectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("connectors", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Connectors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListConnectorsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListConnectorsResponseUnmarshaller Instance => _instance;
    }
}
