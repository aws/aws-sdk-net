...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ExecutionRecordUnmarshaller : IJsonUnmarshaller<ExecutionRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ExecutionRecord();
            ...
            {
                if (context.TestExpression("dataPullEndTime", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("dataPullStartTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                ...
                if (context.TestExpression("metadataCatalogDetails", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ExecutionRecordUnmarshaller Instance => _instance;
    }
}
