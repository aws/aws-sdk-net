...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeConnectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeConnectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("connectorConfigurations", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ConnectorConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static DescribeConnectorsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeConnectorsResponseUnmarshaller Instance => _instance;
    }
}
