...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectorEntityFieldUnmarshaller : IJsonUnmarshaller<ConnectorEntityField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ConnectorEntityField();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("destinationProperties", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("isDeprecated", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("isPrimaryKey", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                ...
                if (context.TestExpression("supportedFieldTypeDetails", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConnectorEntityFieldUnmarshaller Instance => _instance;
    }
}
