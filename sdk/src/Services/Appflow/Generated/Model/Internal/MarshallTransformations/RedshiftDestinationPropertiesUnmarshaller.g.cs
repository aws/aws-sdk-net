...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RedshiftDestinationPropertiesUnmarshaller : IJsonUnmarshaller<RedshiftDestinationProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RedshiftDestinationProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RedshiftDestinationProperties();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RedshiftDestinationPropertiesUnmarshaller Instance => _instance;
    }
}
