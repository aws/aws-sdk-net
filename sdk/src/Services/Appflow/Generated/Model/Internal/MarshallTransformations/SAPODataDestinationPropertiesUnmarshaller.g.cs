...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SAPODataDestinationPropertiesUnmarshaller : IJsonUnmarshaller<SAPODataDestinationProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SAPODataDestinationProperties();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("successResponseHandlingConfig", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static SAPODataDestinationPropertiesUnmarshaller Instance => _instance;
    }
}
