...
namespace Amazon.Appflow.Model
{
    ...
    public partial class CancelFlowExecutionsResponse : AmazonWebServiceResponse
    {
        ...
        public List<string> InvalidExecutions { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the InvalidExecutions property is set.
        /// </summary>
        internal bool IsSetInvalidExecutions() => this.InvalidExecutions != null && (this.InvalidExecutions.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
