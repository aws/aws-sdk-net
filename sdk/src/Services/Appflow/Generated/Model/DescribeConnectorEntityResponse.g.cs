...
namespace Amazon.Appflow.Model
{
    ...
    public partial class DescribeConnectorEntityResponse : AmazonWebServiceResponse
    {
        ...
        public List<ConnectorEntityField> ConnectorEntityFields { get; set; } = AWSConfigs.InitializeCollections ? new List<ConnectorEntityField>() : null;

        /// <summary>
        /// Checks to see if the ConnectorEntityFields property is set.
        /// </summary>
        internal bool IsSetConnectorEntityFields() => this.ConnectorEntityFields != null && (this.ConnectorEntityFields.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
