...
namespace Amazon.Appflow
{
    ...
    public partial class AmazonAppflowConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Appflow", "4.0.101.2");
        ...
        /// </summary>
        public static new string ServiceId => "Appflow";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "appflow";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-08-23";
