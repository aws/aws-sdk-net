...
namespace Amazon.Appflow.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonAppflowAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppflowAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Appflow.
        /// </summary>
        public AmazonAppflowAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppflowAuthSchemeParameters
            {
    ...
    public class AmazonAppflowAuthSchemeResolver : IAuthSchemeResolver<AmazonAppflowAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppflowAuthSchemeParameters authParameters)
        {
