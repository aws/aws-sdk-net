...
namespace Amazon.Appflow
{
    ...
    public partial class AmazonAppflowClient : AmazonServiceClient, IAmazonAppflow
    {
        ...
        /// 
        /// </summary>
        public AmazonAppflowClient() : base(new AmazonAppflowConfig()) { }
        ...
        public AmazonAppflowClient(RegionEndpoint region) : base(new AmazonAppflowConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAppflowClient(AmazonAppflowConfig config) : base(config) { }
