...
namespace Amazon.NetworkSecurityManager.Internal
{
    /// <summary>
    /// Amazon NetworkSecurityManager endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for NetworkSecurityManager service requests.
    /// Collects values for NetworkSecurityManagerEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses NetworkSecurityManagerEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonNetworkSecurityManagerEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonNetworkSecurityManagerConfig)requestContext.ClientConfig;
            var result = new NetworkSecurityManagerEndpointParameters();
