...
{
    /// <summary>
    /// Remediation issue details for a resource, or a marker indicating that the details
    /// are not visible. Exactly one member is set.
    /// </summary>
    public partial class RemediationIssuesView
    {
        private Dictionary<string, RemediationIssueDetails> _issues = AWSConfigs.InitializeCollections ? new Dictionary<string, RemediationIssueDetails>() : null;
        ...
        public Dictionary<string, RemediationIssueDetails> Issues
        {
