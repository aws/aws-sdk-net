...
{
    /// <summary>
    /// CreateRuleSnapshot Request Marshaller
    /// </summary>       
    public class CreateRuleSnapshotRequestMarshaller : IMarshaller<IRequest, CreateRuleSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRuleSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateRuleSnapshotRequest publicRequest)
        {
        ...
        private static CreateRuleSnapshotRequestMarshaller _instance = new CreateRuleSnapshotRequestMarshaller();        

        internal static CreateRuleSnapshotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRuleSnapshotRequestMarshaller Instance
        {
            get
            {
                return _instance;
