...
{
    /// <summary>
    /// Response Unmarshaller for ListAdminAccounts operation
    /// </summary>  
    public class ListAdminAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAdminAccountsResponse response = new ListAdminAccountsResponse();
        ...
        private static ListAdminAccountsResponseUnmarshaller _instance = new ListAdminAccountsResponseUnmarshaller();        

        internal static ListAdminAccountsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAdminAccountsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
