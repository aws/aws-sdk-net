...
{
    /// <summary>
    /// Response Unmarshaller for ListTemplateSnapshots operation
    /// </summary>  
    public class ListTemplateSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTemplateSnapshotsResponse response = new ListTemplateSnapshotsResponse();
        ...
        private static ListTemplateSnapshotsResponseUnmarshaller _instance = new ListTemplateSnapshotsResponseUnmarshaller();        

        internal static ListTemplateSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTemplateSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
