...
{
    /// <summary>
    /// Response Unmarshaller for ListScopeSnapshots operation
    /// </summary>  
    public class ListScopeSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListScopeSnapshotsResponse response = new ListScopeSnapshotsResponse();
        ...
        private static ListScopeSnapshotsResponseUnmarshaller _instance = new ListScopeSnapshotsResponseUnmarshaller();        

        internal static ListScopeSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListScopeSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
