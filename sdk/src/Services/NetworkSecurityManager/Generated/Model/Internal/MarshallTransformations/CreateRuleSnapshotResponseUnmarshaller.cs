...
{
    /// <summary>
    /// Response Unmarshaller for CreateRuleSnapshot operation
    /// </summary>  
    public class CreateRuleSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRuleSnapshotResponse response = new CreateRuleSnapshotResponse();
        ...
        private static CreateRuleSnapshotResponseUnmarshaller _instance = new CreateRuleSnapshotResponseUnmarshaller();        

        internal static CreateRuleSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRuleSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
