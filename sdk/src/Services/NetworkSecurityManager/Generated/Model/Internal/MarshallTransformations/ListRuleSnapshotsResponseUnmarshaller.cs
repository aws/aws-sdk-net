...
{
    /// <summary>
    /// Response Unmarshaller for ListRuleSnapshots operation
    /// </summary>  
    public class ListRuleSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRuleSnapshotsResponse response = new ListRuleSnapshotsResponse();
        ...
        private static ListRuleSnapshotsResponseUnmarshaller _instance = new ListRuleSnapshotsResponseUnmarshaller();        

        internal static ListRuleSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRuleSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
