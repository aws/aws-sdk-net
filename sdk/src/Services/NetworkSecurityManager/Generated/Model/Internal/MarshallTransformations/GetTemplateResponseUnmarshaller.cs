...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    public class GetTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("associatedRuleList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociatedRule, AssociatedRuleUnmarshaller>(AssociatedRuleUnmarshaller.Instance);
                    response.AssociatedRuleList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("firewallType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FirewallType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TemplateDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
