...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    public class UpdatePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("associatedTemplateAndRuleList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociatedTemplateOrRule, AssociatedTemplateOrRuleUnmarshaller>(AssociatedTemplateOrRuleUnmarshaller.Instance);
                    response.AssociatedTemplateAndRuleList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("policyConfiguration", targetDepth, ref reader))
                {
                    var unmarshaller = PolicyConfigurationUnmarshaller.Instance;
                    response.PolicyConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("policyDescription", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PolicyDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
