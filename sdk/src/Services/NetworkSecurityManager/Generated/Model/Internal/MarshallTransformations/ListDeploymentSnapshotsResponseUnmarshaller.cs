...
{
    /// <summary>
    /// Response Unmarshaller for ListDeploymentSnapshots operation
    /// </summary>  
    public class ListDeploymentSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDeploymentSnapshotsResponse response = new ListDeploymentSnapshotsResponse();
        ...
        private static ListDeploymentSnapshotsResponseUnmarshaller _instance = new ListDeploymentSnapshotsResponseUnmarshaller();        

        internal static ListDeploymentSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDeploymentSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
