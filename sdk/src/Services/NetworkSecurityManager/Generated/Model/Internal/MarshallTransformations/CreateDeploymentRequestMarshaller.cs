...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    public class CreateDeploymentRequestMarshaller : IMarshaller<IRequest, CreateDeploymentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateDeploymentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/deployments";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetAssociatedPolicyList())
            {
                context.Writer.WritePropertyName("associatedPolicyList");
                context.Writer.WriteStartArray();
                foreach(var publicRequestAssociatedPolicyListListValue in publicRequest.AssociatedPolicyList)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = PolicyReferenceMarshaller.Instance;
                    marshaller.Marshall(publicRequestAssociatedPolicyListListValue, context);
            ...
            if(publicRequest.IsSetAssociatedScopeList())
            {
                context.Writer.WritePropertyName("associatedScopeList");
                context.Writer.WriteStartArray();
                foreach(var publicRequestAssociatedScopeListListValue in publicRequest.AssociatedScopeList)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = ScopeReferenceMarshaller.Instance;
                    marshaller.Marshall(publicRequestAssociatedScopeListListValue, context);
            ...
            if(publicRequest.IsSetDeploymentDescription())
            {
                context.Writer.WritePropertyName("deploymentDescription");
                context.Writer.WriteStringValue(publicRequest.DeploymentDescription);
            }
