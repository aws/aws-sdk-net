...
{
    /// <summary>
    /// Response Unmarshaller for AccountSet Object
    /// </summary>  
    public class AccountSetUnmarshaller : IJsonUnmarshaller<AccountSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccountSet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AccountSet unmarshalledObject = new AccountSet();
        ...
        private static AccountSetUnmarshaller _instance = new AccountSetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AccountSetUnmarshaller Instance
        {
            get
            {
                return _instance;
