...
{
    /// <summary>
    /// Response Unmarshaller for CreatePolicySnapshot operation
    /// </summary>  
    public class CreatePolicySnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePolicySnapshotResponse response = new CreatePolicySnapshotResponse();
        ...
        private static CreatePolicySnapshotResponseUnmarshaller _instance = new CreatePolicySnapshotResponseUnmarshaller();        

        internal static CreatePolicySnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePolicySnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
