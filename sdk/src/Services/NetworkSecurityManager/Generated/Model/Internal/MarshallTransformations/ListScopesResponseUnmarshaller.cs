...
{
    /// <summary>
    /// Response Unmarshaller for ListScopes operation
    /// </summary>  
    public class ListScopesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListScopesResponse response = new ListScopesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ScopeSummary, ScopeSummaryUnmarshaller>(ScopeSummaryUnmarshaller.Instance);
        ...
        private static ListScopesResponseUnmarshaller _instance = new ListScopesResponseUnmarshaller();        

        internal static ListScopesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListScopesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
