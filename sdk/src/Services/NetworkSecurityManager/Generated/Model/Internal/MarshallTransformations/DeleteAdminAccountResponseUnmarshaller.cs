...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAdminAccount operation
    /// </summary>  
    public class DeleteAdminAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAdminAccountResponse response = new DeleteAdminAccountResponse();
        ...
        private static DeleteAdminAccountResponseUnmarshaller _instance = new DeleteAdminAccountResponseUnmarshaller();        

        internal static DeleteAdminAccountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAdminAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
