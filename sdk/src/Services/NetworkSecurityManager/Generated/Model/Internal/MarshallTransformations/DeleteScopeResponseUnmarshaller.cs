...
{
    /// <summary>
    /// Response Unmarshaller for DeleteScope operation
    /// </summary>  
    public class DeleteScopeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteScopeResponse response = new DeleteScopeResponse();
        ...
        private static DeleteScopeResponseUnmarshaller _instance = new DeleteScopeResponseUnmarshaller();        

        internal static DeleteScopeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteScopeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
