...
{
    /// <summary>
    /// Response Unmarshaller for CreateDeploymentSnapshot operation
    /// </summary>  
    public class CreateDeploymentSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDeploymentSnapshotResponse response = new CreateDeploymentSnapshotResponse();
        ...
        private static CreateDeploymentSnapshotResponseUnmarshaller _instance = new CreateDeploymentSnapshotResponseUnmarshaller();        

        internal static CreateDeploymentSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDeploymentSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
