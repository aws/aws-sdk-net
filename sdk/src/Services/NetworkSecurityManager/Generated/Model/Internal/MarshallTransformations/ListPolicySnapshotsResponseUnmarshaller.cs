...
{
    /// <summary>
    /// Response Unmarshaller for ListPolicySnapshots operation
    /// </summary>  
    public class ListPolicySnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPolicySnapshotsResponse response = new ListPolicySnapshotsResponse();
        ...
        private static ListPolicySnapshotsResponseUnmarshaller _instance = new ListPolicySnapshotsResponseUnmarshaller();        

        internal static ListPolicySnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPolicySnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
