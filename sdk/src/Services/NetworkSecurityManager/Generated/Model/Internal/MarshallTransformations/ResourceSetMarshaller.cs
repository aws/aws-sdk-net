    ...
    public class ResourceSetMarshaller : IRequestMarshaller<ResourceSet, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ResourceSet requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetExplicitArns())
            {
                context.Writer.WritePropertyName("explicitArns");
                context.Writer.WriteStartArray();
                foreach(var requestObjectExplicitArnsListValue in requestObject.ExplicitArns)
                {
                        context.Writer.WriteStringValue(requestObjectExplicitArnsListValue);
                }
