...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    public class PolicyConfigurationMarshaller : IRequestMarshaller<PolicyConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(PolicyConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetResourcesCleanUp())
            {
                context.Writer.WritePropertyName("resourcesCleanUp");
                context.Writer.WriteBooleanValue(requestObject.ResourcesCleanUp.Value);
            }

            if(requestObject.IsSetWafConfig())
            {
                context.Writer.WritePropertyName("wafConfig");
                context.Writer.WriteStartObject();

                var marshaller = WafConfigMarshaller.Instance;
                marshaller.Marshall(requestObject.WafConfig, context);
