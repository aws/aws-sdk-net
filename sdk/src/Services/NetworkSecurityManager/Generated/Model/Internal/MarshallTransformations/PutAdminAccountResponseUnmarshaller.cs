...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    public class PutAdminAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("adminAccountDetails", targetDepth, ref reader))
                {
                    var unmarshaller = AdminAccountDetailsUnmarshaller.Instance;
                    response.AdminAccountDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
