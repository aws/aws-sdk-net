...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceScopeUnmarshaller : IJsonUnmarshaller<ResourceScope, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceScope Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
