...
namespace Amazon.NetworkSecurityManager.Model.Internal.MarshallTransformations
{
    ...
    public class DeploymentConfigurationUnmarshaller : IJsonUnmarshaller<DeploymentConfiguration, JsonUnmarshallerContext>
    {
        ...
        public DeploymentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("enableCrossAccountVisibility", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.EnableCrossAccountVisibility = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
