...
{
    /// <summary>
    /// Response Unmarshaller for GenerateRuleConfiguration operation
    /// </summary>  
    public class GenerateRuleConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateRuleConfigurationResponse response = new GenerateRuleConfigurationResponse();
        ...
        private static GenerateRuleConfigurationResponseUnmarshaller _instance = new GenerateRuleConfigurationResponseUnmarshaller();        

        internal static GenerateRuleConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateRuleConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
