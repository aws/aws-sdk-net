...
{
    /// <summary>
    /// Response Unmarshaller for GetScope operation
    /// </summary>  
    public class GetScopeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetScopeResponse response = new GetScopeResponse();
        ...
        private static GetScopeResponseUnmarshaller _instance = new GetScopeResponseUnmarshaller();        

        internal static GetScopeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetScopeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
