...
{
    /// <summary>
    /// Response Unmarshaller for CreateScopeSnapshot operation
    /// </summary>  
    public class CreateScopeSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateScopeSnapshotResponse response = new CreateScopeSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("scopeArn", targetDepth, ref reader))
                {
                    ...
                    response.ScopeArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("scopeConfiguration", targetDepth, ref reader))
                {
                    ...
                    response.ScopeConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("scopeDescription", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScopeDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("scopeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScopeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("scopeName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScopeName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateScopeSnapshotResponseUnmarshaller _instance = new CreateScopeSnapshotResponseUnmarshaller();        

        internal static CreateScopeSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateScopeSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
