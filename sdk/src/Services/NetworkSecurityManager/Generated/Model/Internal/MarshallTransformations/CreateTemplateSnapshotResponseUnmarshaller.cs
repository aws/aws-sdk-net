...
{
    /// <summary>
    /// Response Unmarshaller for CreateTemplateSnapshot operation
    /// </summary>  
    public class CreateTemplateSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTemplateSnapshotResponse response = new CreateTemplateSnapshotResponse();
        ...
        private static CreateTemplateSnapshotResponseUnmarshaller _instance = new CreateTemplateSnapshotResponseUnmarshaller();        

        internal static CreateTemplateSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTemplateSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
