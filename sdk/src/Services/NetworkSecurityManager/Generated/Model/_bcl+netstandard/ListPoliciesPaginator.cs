...
namespace Amazon.NetworkSecurityManager.Model
{
    ...
    internal sealed partial class ListPoliciesPaginator : IPaginator<ListPoliciesResponse>, IListPoliciesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<PolicySummary> Policies => 
            new PaginatedResultKeyResponse<ListPoliciesResponse, PolicySummary>(this, (i) => i.Policies ?? new List<PolicySummary>());

        internal ListPoliciesPaginator(IAmazonNetworkSecurityManager client, ListPoliciesRequest request)
        {
            this._client = client;
