...
{
    /// <summary>
    /// Container for the parameters to the CreateDeploymentSnapshot operation.
    /// Creates a snapshot of the current published version of the specified deployment.
    /// </summary>
    public partial class CreateDeploymentSnapshotRequest : AmazonNetworkSecurityManagerRequest
    {
