...
{
    /// <summary>
    /// An association between a policy and either a template or a rule, as returned in outputs.
    /// Exactly one of <c>templateArn</c> or <c>ruleArn</c> is set. The corresponding request
    /// structure is <c>TemplateOrRuleReference</c>.
    /// </summary>
    public partial class AssociatedTemplateOrRule
    {
