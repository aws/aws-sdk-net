...
namespace Amazon.Rekognition.Internal
{
    ...
    public class AmazonRekognitionAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRekognitionAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Rekognition.
        /// </summary>
        public AmazonRekognitionAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRekognitionAuthSchemeParameters
            {
    ...
    public class AmazonRekognitionAuthSchemeResolver : IAuthSchemeResolver<AmazonRekognitionAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRekognitionAuthSchemeParameters authParameters)
        {
