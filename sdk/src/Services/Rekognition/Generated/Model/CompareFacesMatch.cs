...
{
    /// <summary>
    /// Provide the bounding box, confidence that the bounding box actually contains a face,
    /// and the similarity between the face in the bounding box and the face in the source
    /// image.
    /// </summary>
