        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SearchedFace", targetDepth))
                {
                    ...
                    response.SearchedFace = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("UnsearchedFaces", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<UnsearchedFace, UnsearchedFaceUnmarshaller>(UnsearchedFaceUnmarshaller.Instance);
                    response.UnsearchedFaces = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("UserMatches", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<UserMatch, UserMatchUnmarshaller>(UserMatchUnmarshaller.Instance);
                    response.UserMatches = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
