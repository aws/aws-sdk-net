...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CopyProjectVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CopyProjectVersionResponse response = new CopyProjectVersionResponse();
            ...
            {
                if (context.TestExpression("ProjectVersionArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProjectVersionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CopyProjectVersionResponseUnmarshaller _instance = new CopyProjectVersionResponseUnmarshaller();        

        internal static CopyProjectVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CopyProjectVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
