...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartStreamProcessorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartStreamProcessorResponseUnmarshaller _instance = new StartStreamProcessorResponseUnmarshaller();        

        internal static StartStreamProcessorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartStreamProcessorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
