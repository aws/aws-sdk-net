        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CompletionTimestamp", targetDepth))
                {
                    ...
                    response.CompletionTimestamp = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("FailureDetails", targetDepth))
                {
                    ...
                    response.FailureDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ManifestSummary", targetDepth))
                {
                    ...
                    response.ManifestSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("OperationsConfig", targetDepth))
                {
                    ...
                    response.OperationsConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
