...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCelebrityInfoRequestMarshaller : IMarshaller<IRequest, GetCelebrityInfoRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCelebrityInfoRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCelebrityInfoRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.GetCelebrityInfo";
