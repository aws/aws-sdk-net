...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FaceRecordUnmarshaller : IJsonUnmarshaller<FaceRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FaceRecord Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FaceDetail", targetDepth, ref reader))
                {
                    var unmarshaller = FaceDetailUnmarshaller.Instance;
                    unmarshalledObject.FaceDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
