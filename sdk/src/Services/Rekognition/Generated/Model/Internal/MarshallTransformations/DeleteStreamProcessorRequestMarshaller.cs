...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteStreamProcessorRequestMarshaller : IMarshaller<IRequest, DeleteStreamProcessorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteStreamProcessorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteStreamProcessorRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.DeleteStreamProcessor";
