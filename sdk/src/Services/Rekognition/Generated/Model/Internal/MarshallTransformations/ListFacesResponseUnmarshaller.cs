...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListFacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFacesResponse response = new ListFacesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Faces", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Face, FaceUnmarshaller>(FaceUnmarshaller.Instance);
                    response.Faces = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFacesResponseUnmarshaller _instance = new ListFacesResponseUnmarshaller();        

        internal static ListFacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
