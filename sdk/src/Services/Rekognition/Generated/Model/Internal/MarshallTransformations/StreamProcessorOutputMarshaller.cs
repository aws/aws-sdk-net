...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    public class StreamProcessorOutputMarshaller : IRequestMarshaller<StreamProcessorOutput, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(StreamProcessorOutput requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetKinesisDataStream())
            {
                context.Writer.WritePropertyName("KinesisDataStream");
                context.Writer.WriteStartObject();

                var marshaller = KinesisDataStreamMarshaller.Instance;
                marshaller.Marshall(requestObject.KinesisDataStream, context);
