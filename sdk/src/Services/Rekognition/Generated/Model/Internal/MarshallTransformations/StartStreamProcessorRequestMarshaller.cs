...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartStreamProcessorRequestMarshaller : IMarshaller<IRequest, StartStreamProcessorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartStreamProcessorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartStreamProcessorRequest publicRequest)
        {
        ...
        private static StartStreamProcessorRequestMarshaller _instance = new StartStreamProcessorRequestMarshaller();        

        internal static StartStreamProcessorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartStreamProcessorRequestMarshaller Instance
        {
            get
            {
                return _instance;
