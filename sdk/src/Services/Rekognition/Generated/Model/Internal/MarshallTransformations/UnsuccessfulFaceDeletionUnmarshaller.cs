...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnsuccessfulFaceDeletionUnmarshaller : IJsonUnmarshaller<UnsuccessfulFaceDeletion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UnsuccessfulFaceDeletion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("FaceId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FaceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
