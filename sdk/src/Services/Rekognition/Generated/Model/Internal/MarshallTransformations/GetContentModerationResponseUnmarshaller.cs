...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetContentModerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("GetRequestMetadata", targetDepth, ref reader))
                {
                    var unmarshaller = GetContentModerationRequestMetadataUnmarshaller.Instance;
                    response.GetRequestMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ContentModerationDetection, ContentModerationDetectionUnmarshaller>(ContentModerationDetectionUnmarshaller.Instance);
        ...
        private static GetContentModerationResponseUnmarshaller _instance = new GetContentModerationResponseUnmarshaller();        

        internal static GetContentModerationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContentModerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
