...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartPersonTrackingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartPersonTrackingResponseUnmarshaller _instance = new StartPersonTrackingResponseUnmarshaller();        

        internal static StartPersonTrackingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPersonTrackingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
