...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCollectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateCollectionResponseUnmarshaller _instance = new CreateCollectionResponseUnmarshaller();        

        internal static CreateCollectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCollectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
