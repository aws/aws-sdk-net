...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopProjectVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopProjectVersionResponse response = new StopProjectVersionResponse();
        ...
        private static StopProjectVersionResponseUnmarshaller _instance = new StopProjectVersionResponseUnmarshaller();        

        internal static StopProjectVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopProjectVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
