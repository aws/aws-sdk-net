...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    public class ListDatasetEntriesRequestMarshaller : IMarshaller<IRequest, ListDatasetEntriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListDatasetEntriesRequest publicRequest)
        {
            ...
            string target = "RekognitionService.ListDatasetEntries";
            ...
            if(publicRequest.IsSetContainsLabels())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestContainsLabelsListValue);
                }
            ...
            if(publicRequest.IsSetHasErrors())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.HasErrors.Value);
            }

            if(publicRequest.IsSetLabeled())
            {
                context.Writer.WritePropertyName("Labeled");
                context.Writer.WriteBooleanValue(publicRequest.Labeled.Value);
            }
            ...
            if(publicRequest.IsSetSourceRefContains())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SourceRefContains);
            }
