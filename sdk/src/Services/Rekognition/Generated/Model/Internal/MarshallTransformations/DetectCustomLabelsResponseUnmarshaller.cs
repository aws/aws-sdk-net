...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectCustomLabelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetectCustomLabelsResponse response = new DetectCustomLabelsResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CustomLabels", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<CustomLabel, CustomLabelUnmarshaller>(CustomLabelUnmarshaller.Instance);
                    response.CustomLabels = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new ResourceNotReadyException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DetectCustomLabelsResponseUnmarshaller _instance = new DetectCustomLabelsResponseUnmarshaller();        

        internal static DetectCustomLabelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectCustomLabelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
