...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DistributeDatasetEntriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DistributeDatasetEntriesResponse response = new DistributeDatasetEntriesResponse();
        ...
        private static DistributeDatasetEntriesResponseUnmarshaller _instance = new DistributeDatasetEntriesResponseUnmarshaller();        

        internal static DistributeDatasetEntriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DistributeDatasetEntriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
