...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    public class DatasetLabelStatsUnmarshaller : IJsonUnmarshaller<DatasetLabelStats, JsonUnmarshallerContext>
    {
        ...
        public DatasetLabelStats Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("BoundingBoxCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.BoundingBoxCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EntryCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        private static DatasetLabelStatsUnmarshaller _instance = new DatasetLabelStatsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DatasetLabelStatsUnmarshaller Instance
        {
            get
            {
                return _instance;
