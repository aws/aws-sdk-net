...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CelebrityDetailUnmarshaller : IUnmarshaller<CelebrityDetail, XmlUnmarshallerContext>, IUnmarshaller<CelebrityDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CelebrityDetail IUnmarshaller<CelebrityDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CelebrityDetail Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            CelebrityDetail unmarshalledObject = new CelebrityDetail();
        ...
        private static CelebrityDetailUnmarshaller _instance = new CelebrityDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CelebrityDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
