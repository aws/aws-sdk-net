...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteFacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteFacesResponseUnmarshaller _instance = new DeleteFacesResponseUnmarshaller();        

        internal static DeleteFacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
