...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SearchFacesByImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SearchFacesByImageResponseUnmarshaller _instance = new SearchFacesByImageResponseUnmarshaller();        

        internal static SearchFacesByImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchFacesByImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
