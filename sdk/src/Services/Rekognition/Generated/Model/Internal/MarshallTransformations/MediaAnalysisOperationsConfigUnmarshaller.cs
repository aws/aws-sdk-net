...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    public class MediaAnalysisOperationsConfigUnmarshaller : IJsonUnmarshaller<MediaAnalysisOperationsConfig, JsonUnmarshallerContext>
    {
        ...
        private static MediaAnalysisOperationsConfigUnmarshaller _instance = new MediaAnalysisOperationsConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MediaAnalysisOperationsConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
