    ...
    public class ListProjectPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProjectPolicy, ProjectPolicyUnmarshaller>(ProjectPolicyUnmarshaller.Instance);
                    response.ProjectPolicies = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
