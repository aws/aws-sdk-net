...
namespace Amazon.PartnerCentralRevenueMeasurement
{
    ...
    public partial class AmazonPartnerCentralRevenueMeasurementConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("PartnerCentral Revenue Measurement", "4.0.100.10");
        ...
        /// Default constructor
        /// </summary>
        public AmazonPartnerCentralRevenueMeasurementConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonPartnerCentralRevenueMeasurementDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "PartnerCentral Revenue Measurement";
            this.AuthenticationServiceName = "partnercentral";
            this.EndpointProvider = new AmazonPartnerCentralRevenueMeasurementEndpointProvider();
        }
