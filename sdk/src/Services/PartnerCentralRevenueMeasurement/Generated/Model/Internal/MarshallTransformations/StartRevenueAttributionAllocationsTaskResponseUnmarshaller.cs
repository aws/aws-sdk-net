...
{
    /// <summary>
    /// Response Unmarshaller for StartRevenueAttributionAllocationsTask operation
    /// </summary>  
    public class StartRevenueAttributionAllocationsTaskResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRevenueAttributionAllocationsTaskResponse response = new StartRevenueAttributionAllocationsTaskResponse();
            var reader = context.Reader;
            context.AddPathSegment("StartRevenueAttributionAllocationsTask");
            reader.ReadStartMap();
        ...
        private static StartRevenueAttributionAllocationsTaskResponseUnmarshaller _instance = new StartRevenueAttributionAllocationsTaskResponseUnmarshaller();        

        internal static StartRevenueAttributionAllocationsTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRevenueAttributionAllocationsTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
