...
{
    /// <summary>
    /// Response Unmarshaller for ListRevenueAttributions operation
    /// </summary>  
    public class ListRevenueAttributionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRevenueAttributionsResponse response = new ListRevenueAttributionsResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListRevenueAttributions");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "RevenueAttributionSummaries":
                        {
                            context.AddPathSegment("RevenueAttributionSummaries");
                            var unmarshaller = new CborListUnmarshaller<AttributionSummary, AttributionSummaryUnmarshaller>(AttributionSummaryUnmarshaller.Instance);
                            response.RevenueAttributionSummaries = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static ListRevenueAttributionsResponseUnmarshaller _instance = new ListRevenueAttributionsResponseUnmarshaller();        

        internal static ListRevenueAttributionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRevenueAttributionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
