...
{
    /// <summary>
    /// Response Unmarshaller for GetRevenueAttribution operation
    /// </summary>  
    public class GetRevenueAttributionResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRevenueAttributionResponse response = new GetRevenueAttributionResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetRevenueAttribution");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "MarketplaceProduct":
                        {
                            ...
                            response.MarketplaceProduct = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "Name":
                    ...
                    case "Revision":
                        {
                            context.AddPathSegment("Revision");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "TenancyModel":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.TenancyModel = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "TotalActiveRevenueAttributionAllocationCount":
                        {
                            ...
                            response.TotalActiveRevenueAttributionAllocationCount = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "TotalRevenueAttributionAllocationCount":
                        {
                            ...
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            response.TotalRevenueAttributionAllocationCount = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static GetRevenueAttributionResponseUnmarshaller _instance = new GetRevenueAttributionResponseUnmarshaller();        

        internal static GetRevenueAttributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueAttributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
