...
{
    /// <summary>
    /// Response Unmarshaller for GetRevenueAttributionAllocationsTask operation
    /// </summary>  
    public class GetRevenueAttributionAllocationsTaskResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "EndedAt":
                        {
                            context.AddPathSegment("EndedAt");
                    ...
                    case "ErrorDetailList":
                        {
                            context.AddPathSegment("ErrorDetailList");
                            var unmarshaller = new CborListUnmarshaller<RevenueAttributionAllocationErrorDetail, RevenueAttributionAllocationErrorDetailUnmarshaller>(RevenueAttributionAllocationErrorDetailUnmarshaller.Instance);
                            response.ErrorDetailList = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "RevenueAttributionArn":
                        {
                            context.AddPathSegment("RevenueAttributionArn");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.RevenueAttributionArn = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "RevenueAttributionLatestRevision":
                        {
                            context.AddPathSegment("RevenueAttributionLatestRevision");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.RevenueAttributionLatestRevision = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "StartedAt":
                    ...
                    case "TotalRevenueAttributionAllocationRecords":
                        {
                            context.AddPathSegment("TotalRevenueAttributionAllocationRecords");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            response.TotalRevenueAttributionAllocationRecords = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static GetRevenueAttributionAllocationsTaskResponseUnmarshaller _instance = new GetRevenueAttributionAllocationsTaskResponseUnmarshaller();        

        internal static GetRevenueAttributionAllocationsTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueAttributionAllocationsTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
