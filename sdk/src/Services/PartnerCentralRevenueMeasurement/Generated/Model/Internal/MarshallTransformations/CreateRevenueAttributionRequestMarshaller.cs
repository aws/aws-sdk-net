...
{
    /// <summary>
    /// CreateRevenueAttribution Request Marshaller
    /// </summary>       
    public class CreateRevenueAttributionRequestMarshaller : IMarshaller<IRequest, CreateRevenueAttributionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRevenueAttributionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateRevenueAttributionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/CreateRevenueAttribution";
            ...
            try
            {
                ...
                if (publicRequest.IsSetProductIdentifier())
                {
                    context.Writer.WriteTextString("ProductIdentifier");
                    context.Writer.WriteTextString(publicRequest.ProductIdentifier);
                }
                ...
                if (publicRequest.IsSetTenancyModel())
                {
                    context.Writer.WriteTextString("TenancyModel");
                    context.Writer.WriteTextString(publicRequest.TenancyModel);
                }
                writer.WriteEndMap();
#if !NETFRAMEWORK
        ...
        private static CreateRevenueAttributionRequestMarshaller _instance = new CreateRevenueAttributionRequestMarshaller();        

        internal static CreateRevenueAttributionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRevenueAttributionRequestMarshaller Instance
        {
            get
            {
                return _instance;
