...
{
    /// <summary>
    /// GetRevenueAttribution Request Marshaller
    /// </summary>       
    public class GetRevenueAttributionRequestMarshaller : IMarshaller<IRequest, GetRevenueAttributionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRevenueAttributionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRevenueAttributionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/GetRevenueAttribution";
            ...
            try
            {
                ...
                if (publicRequest.IsSetRevision())
                {
                    ...
                    context.Writer.WriteTextString(publicRequest.Revision);
                }
                writer.WriteEndMap();
#if !NETFRAMEWORK
        ...
        private static GetRevenueAttributionRequestMarshaller _instance = new GetRevenueAttributionRequestMarshaller();        

        internal static GetRevenueAttributionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueAttributionRequestMarshaller Instance
        {
            get
            {
                return _instance;
