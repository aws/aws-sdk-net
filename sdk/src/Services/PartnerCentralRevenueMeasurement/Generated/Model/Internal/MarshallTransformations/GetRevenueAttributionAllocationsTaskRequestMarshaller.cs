...
{
    /// <summary>
    /// GetRevenueAttributionAllocationsTask Request Marshaller
    /// </summary>       
    public class GetRevenueAttributionAllocationsTaskRequestMarshaller : IMarshaller<IRequest, GetRevenueAttributionAllocationsTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRevenueAttributionAllocationsTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRevenueAttributionAllocationsTaskRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/GetRevenueAttributionAllocationsTask";
        ...
        private static GetRevenueAttributionAllocationsTaskRequestMarshaller _instance = new GetRevenueAttributionAllocationsTaskRequestMarshaller();        

        internal static GetRevenueAttributionAllocationsTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueAttributionAllocationsTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
