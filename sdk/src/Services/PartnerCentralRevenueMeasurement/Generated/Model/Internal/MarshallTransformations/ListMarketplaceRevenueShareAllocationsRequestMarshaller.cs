...
{
    /// <summary>
    /// ListMarketplaceRevenueShareAllocations Request Marshaller
    /// </summary>       
    public class ListMarketplaceRevenueShareAllocationsRequestMarshaller : IMarshaller<IRequest, ListMarketplaceRevenueShareAllocationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListMarketplaceRevenueShareAllocationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListMarketplaceRevenueShareAllocationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/ListMarketplaceRevenueShareAllocations";
        ...
        private static ListMarketplaceRevenueShareAllocationsRequestMarshaller _instance = new ListMarketplaceRevenueShareAllocationsRequestMarshaller();        

        internal static ListMarketplaceRevenueShareAllocationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMarketplaceRevenueShareAllocationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
