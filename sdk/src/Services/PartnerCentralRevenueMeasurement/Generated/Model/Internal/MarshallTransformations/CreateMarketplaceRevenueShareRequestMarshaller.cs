...
{
    /// <summary>
    /// CreateMarketplaceRevenueShare Request Marshaller
    /// </summary>       
    public class CreateMarketplaceRevenueShareRequestMarshaller : IMarshaller<IRequest, CreateMarketplaceRevenueShareRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMarketplaceRevenueShareRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMarketplaceRevenueShareRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/CreateMarketplaceRevenueShare";
        ...
        private static CreateMarketplaceRevenueShareRequestMarshaller _instance = new CreateMarketplaceRevenueShareRequestMarshaller();        

        internal static CreateMarketplaceRevenueShareRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMarketplaceRevenueShareRequestMarshaller Instance
        {
            get
            {
                return _instance;
