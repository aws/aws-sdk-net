...
{
    /// <summary>
    /// ListMarketplaceRevenueShares Request Marshaller
    /// </summary>       
    public class ListMarketplaceRevenueSharesRequestMarshaller : IMarshaller<IRequest, ListMarketplaceRevenueSharesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListMarketplaceRevenueSharesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListMarketplaceRevenueSharesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/ListMarketplaceRevenueShares";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("ProductCodes");
                    context.Writer.WriteStartArray(publicRequest.ProductCodes.Count);
                    foreach(var publicRequestProductCodesListValue in publicRequest.ProductCodes)
                    {
                            context.Writer.WriteTextString(publicRequestProductCodesListValue);
                    }
                    context.Writer.WriteEndArray();
                }
                if (publicRequest.IsSetProductIds())
                {
                    context.Writer.WriteTextString("ProductIds");
                    context.Writer.WriteStartArray(publicRequest.ProductIds.Count);
                    foreach(var publicRequestProductIdsListValue in publicRequest.ProductIds)
                    {
                            context.Writer.WriteTextString(publicRequestProductIdsListValue);
                    }
                    context.Writer.WriteEndArray();
                }
        ...
        private static ListMarketplaceRevenueSharesRequestMarshaller _instance = new ListMarketplaceRevenueSharesRequestMarshaller();        

        internal static ListMarketplaceRevenueSharesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMarketplaceRevenueSharesRequestMarshaller Instance
        {
            get
            {
                return _instance;
