...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMarketplaceRevenueShareAllocation operation
    /// </summary>  
    public class UpdateMarketplaceRevenueShareAllocationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMarketplaceRevenueShareAllocationResponse response = new UpdateMarketplaceRevenueShareAllocationResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateMarketplaceRevenueShareAllocation");
            reader.ReadStartMap();
        ...
        private static UpdateMarketplaceRevenueShareAllocationResponseUnmarshaller _instance = new UpdateMarketplaceRevenueShareAllocationResponseUnmarshaller();        

        internal static UpdateMarketplaceRevenueShareAllocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMarketplaceRevenueShareAllocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
