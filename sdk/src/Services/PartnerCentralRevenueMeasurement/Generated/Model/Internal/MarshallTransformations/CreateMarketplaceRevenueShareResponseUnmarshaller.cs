...
{
    /// <summary>
    /// Response Unmarshaller for CreateMarketplaceRevenueShare operation
    /// </summary>  
    public class CreateMarketplaceRevenueShareResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateMarketplaceRevenueShareResponseUnmarshaller _instance = new CreateMarketplaceRevenueShareResponseUnmarshaller();        

        internal static CreateMarketplaceRevenueShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMarketplaceRevenueShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
