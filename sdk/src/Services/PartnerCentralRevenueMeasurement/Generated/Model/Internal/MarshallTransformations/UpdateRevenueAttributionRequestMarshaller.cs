...
{
    /// <summary>
    /// UpdateRevenueAttribution Request Marshaller
    /// </summary>       
    public class UpdateRevenueAttributionRequestMarshaller : IMarshaller<IRequest, UpdateRevenueAttributionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRevenueAttributionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRevenueAttributionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralRevenueMeasurement");
            request.Headers["smithy-protocol"] = "rpc-v2-cbor";
            request.ResourcePath = "service/PartnerCentralRevenueMeasurement/operation/UpdateRevenueAttribution";
        ...
        private static UpdateRevenueAttributionRequestMarshaller _instance = new UpdateRevenueAttributionRequestMarshaller();        

        internal static UpdateRevenueAttributionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRevenueAttributionRequestMarshaller Instance
        {
            get
            {
                return _instance;
