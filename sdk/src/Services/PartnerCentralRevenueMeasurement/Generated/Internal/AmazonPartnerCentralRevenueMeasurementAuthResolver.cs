...
namespace Amazon.PartnerCentralRevenueMeasurement.Internal
{
    ...
    public class AmazonPartnerCentralRevenueMeasurementAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPartnerCentralRevenueMeasurementAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PartnerCentralRevenueMeasurement.
        /// </summary>
        public AmazonPartnerCentralRevenueMeasurementAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPartnerCentralRevenueMeasurementAuthSchemeParameters
            {
    ...
    public class AmazonPartnerCentralRevenueMeasurementAuthSchemeResolver : IAuthSchemeResolver<AmazonPartnerCentralRevenueMeasurementAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPartnerCentralRevenueMeasurementAuthSchemeParameters authParameters)
        {
