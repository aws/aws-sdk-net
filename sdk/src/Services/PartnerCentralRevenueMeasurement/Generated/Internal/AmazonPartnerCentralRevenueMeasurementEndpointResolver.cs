...
using Amazon.Util;
using Amazon.PartnerCentralRevenueMeasurement.Endpoints;
...
{
    /// <summary>
    /// Amazon PartnerCentralRevenueMeasurement endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for PartnerCentralRevenueMeasurement service requests.
    /// Collects values for PartnerCentralRevenueMeasurementEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PartnerCentralRevenueMeasurementEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonPartnerCentralRevenueMeasurementEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPartnerCentralRevenueMeasurementConfig)requestContext.ClientConfig;
            var result = new PartnerCentralRevenueMeasurementEndpointParameters();
