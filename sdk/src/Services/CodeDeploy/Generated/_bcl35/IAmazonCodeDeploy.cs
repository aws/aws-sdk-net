...
namespace Amazon.CodeDeploy
{
    ...
    public partial interface IAmazonCodeDeploy : IAmazonService, IDisposable
    {
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/BatchGetDeploymentTargets">REST API Reference for BatchGetDeploymentTargets Operation</seealso>
        IAsyncResult BeginBatchGetDeploymentTargets(BatchGetDeploymentTargetsRequest request, AsyncCallback callback, object state);
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/BatchGetDeploymentTargets">REST API Reference for BatchGetDeploymentTargets Operation</seealso>
        BatchGetDeploymentTargetsResponse EndBatchGetDeploymentTargets(IAsyncResult asyncResult);
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the DeleteResourcesByExternalId operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the DeleteResourcesByExternalId operation on AmazonCodeDeployClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndDeleteResourcesByExternalId
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/DeleteResourcesByExternalId">REST API Reference for DeleteResourcesByExternalId Operation</seealso>
        IAsyncResult BeginDeleteResourcesByExternalId(DeleteResourcesByExternalIdRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  DeleteResourcesByExternalId operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginDeleteResourcesByExternalId.</param>
        /// 
        /// <returns>Returns a  DeleteResourcesByExternalIdResult from CodeDeploy.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/DeleteResourcesByExternalId">REST API Reference for DeleteResourcesByExternalId Operation</seealso>
        DeleteResourcesByExternalIdResponse EndDeleteResourcesByExternalId(IAsyncResult asyncResult);
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/GetDeploymentTarget">REST API Reference for GetDeploymentTarget Operation</seealso>
        IAsyncResult BeginGetDeploymentTarget(GetDeploymentTargetRequest request, AsyncCallback callback, object state);
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/GetDeploymentTarget">REST API Reference for GetDeploymentTarget Operation</seealso>
        GetDeploymentTargetResponse EndGetDeploymentTarget(IAsyncResult asyncResult);
        ...
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/ListDeploymentTargets">REST API Reference for ListDeploymentTargets Operation</seealso>
        IAsyncResult BeginListDeploymentTargets(ListDeploymentTargetsRequest request, AsyncCallback callback, object state);
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/codedeploy-2014-10-06/ListDeploymentTargets">REST API Reference for ListDeploymentTargets Operation</seealso>
        ListDeploymentTargetsResponse EndListDeploymentTargets(IAsyncResult asyncResult);
