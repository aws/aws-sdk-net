...
namespace Amazon.CodeDeploy.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonCodeDeployAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeDeployAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeDeploy.
        /// </summary>
        public AmazonCodeDeployAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeDeployAuthSchemeParameters
            {
    ...
    public class AmazonCodeDeployAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeDeployAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeDeployAuthSchemeParameters authParameters)
        {
