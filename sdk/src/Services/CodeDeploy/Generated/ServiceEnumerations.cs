...
namespace Amazon.CodeDeploy
{
    ...
    public class DeploymentMode : ConstantClass
    {
        ...
        /// <summary>
        /// Constant RESTART for DeploymentMode
        /// </summary>
        public static readonly DeploymentMode RESTART = new DeploymentMode("RESTART");
        /// <summary>
        /// Constant STANDARD for DeploymentMode
        /// </summary>
        public static readonly DeploymentMode STANDARD = new DeploymentMode("STANDARD");
