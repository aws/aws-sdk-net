...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class CreateDeploymentRequest : AmazonCodeDeployRequest
    {
        ...
        /// you would call <code>CreateDeployment</code> to create a new deployment that uses
        /// a previous application revision that is known to work, and set its alarm configuration
        /// to turn off alarm polling. Turning off alarm polling ensures that the new deployment
