...
namespace Amazon.CodeDeploy.Model
{
    ...
    [Serializable]
    #endif
    public partial class IamUserArnRequiredException : AmazonCodeDeployException
    {
        ...
        public IamUserArnRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IamUserArnRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
