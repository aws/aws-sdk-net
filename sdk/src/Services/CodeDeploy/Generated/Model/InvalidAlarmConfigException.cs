...
namespace Amazon.CodeDeploy.Model
{
    ...
    public class InvalidAlarmConfigException : AmazonCodeDeployException 
    {
        ...
        public InvalidAlarmConfigException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidAlarmConfigException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
