...
namespace Amazon.CodeDeploy.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidTimeRangeException : AmazonCodeDeployException
    {

        /// <summary>
        /// Default constructor for InvalidTimeRangeException
        /// message.
        /// </summary>
        ...
        public InvalidTimeRangeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidTimeRangeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
