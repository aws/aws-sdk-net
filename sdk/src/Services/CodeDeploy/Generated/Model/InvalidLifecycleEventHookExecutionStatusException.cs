...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class InvalidLifecycleEventHookExecutionStatusException : AmazonCodeDeployException
    {
        ...
        public InvalidLifecycleEventHookExecutionStatusException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidLifecycleEventHookExecutionStatusException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
