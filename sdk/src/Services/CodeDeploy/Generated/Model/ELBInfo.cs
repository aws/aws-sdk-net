...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class ELBInfo
    {
        ...
        /// route traffic from original instances to replacement instances in a blue/green deployment.
        /// For in-place deployments, the name of the Classic Load Balancer that instances are
        /// deregistered from so they are not serving traffic during a deployment, and then re-registered
