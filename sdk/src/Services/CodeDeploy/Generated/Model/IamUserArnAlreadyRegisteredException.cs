...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class IamUserArnAlreadyRegisteredException : AmazonCodeDeployException
    {
        ...
        public IamUserArnAlreadyRegisteredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IamUserArnAlreadyRegisteredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
