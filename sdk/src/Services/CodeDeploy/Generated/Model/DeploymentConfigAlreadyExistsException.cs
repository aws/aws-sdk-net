...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class DeploymentConfigAlreadyExistsException : AmazonCodeDeployException
    {
        ...
        /// <summary>
        /// Default constructor for DeploymentConfigAlreadyExistsException
        /// message.
        /// </summary>
        public DeploymentConfigAlreadyExistsException() 
            : base() {}
        ...
        public DeploymentConfigAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DeploymentConfigAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
