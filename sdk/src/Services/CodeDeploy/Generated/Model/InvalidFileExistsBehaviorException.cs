...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class InvalidFileExistsBehaviorException : AmazonCodeDeployException
    {
        ...
        public InvalidFileExistsBehaviorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidFileExistsBehaviorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
