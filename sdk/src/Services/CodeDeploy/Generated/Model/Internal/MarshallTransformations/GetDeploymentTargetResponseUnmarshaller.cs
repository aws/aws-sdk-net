...
{
    /// <summary>
    /// Response Unmarshaller for GetDeploymentTarget operation
    /// </summary>  
    public class GetDeploymentTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeploymentTargetResponse response = new GetDeploymentTargetResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("deploymentTarget", targetDepth))
                {
                    var unmarshaller = DeploymentTargetUnmarshaller.Instance;
                    response.DeploymentTarget = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DeploymentTargetDoesNotExistException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            if (errorResponse.Code != null && errorResponse.Code.Equals("DeploymentTargetIdRequiredException"))
            {
                return new DeploymentTargetIdRequiredException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            {
                return new InvalidDeploymentTargetIdException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static GetDeploymentTargetResponseUnmarshaller _instance = new GetDeploymentTargetResponseUnmarshaller();        

        internal static GetDeploymentTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeploymentTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
