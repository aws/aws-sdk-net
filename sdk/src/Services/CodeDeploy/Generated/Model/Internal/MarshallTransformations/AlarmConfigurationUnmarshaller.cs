...
namespace Amazon.CodeDeploy.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AlarmConfigurationUnmarshaller : IJsonUnmarshaller<AlarmConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AlarmConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ignorePollAlarmFailure", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.IgnorePollAlarmFailure = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
