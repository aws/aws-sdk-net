...
{
    /// <summary>
    /// Response Unmarshaller for GetDeploymentGroup operation
    /// </summary>  
    public class GetDeploymentGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeploymentGroupResponse response = new GetDeploymentGroupResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("deploymentGroupInfo", targetDepth, ref reader))
                {
                    var unmarshaller = DeploymentGroupInfoUnmarshaller.Instance;
                    response.DeploymentGroupInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDeploymentGroupResponseUnmarshaller _instance = new GetDeploymentGroupResponseUnmarshaller();        

        internal static GetDeploymentGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeploymentGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
