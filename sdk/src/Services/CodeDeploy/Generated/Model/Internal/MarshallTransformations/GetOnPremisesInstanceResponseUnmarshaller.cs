...
{
    /// <summary>
    /// Response Unmarshaller for GetOnPremisesInstance operation
    /// </summary>  
    public class GetOnPremisesInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOnPremisesInstanceResponse response = new GetOnPremisesInstanceResponse();
            ...
            {
                if (context.TestExpression("instanceInfo", targetDepth, ref reader))
                {
                    var unmarshaller = InstanceInfoUnmarshaller.Instance;
                    response.InstanceInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InstanceNotRegisteredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static GetOnPremisesInstanceResponseUnmarshaller _instance = new GetOnPremisesInstanceResponseUnmarshaller();        

        internal static GetOnPremisesInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOnPremisesInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
