...
namespace Amazon.CodeDeploy.Model.Internal.MarshallTransformations
{
    ...
    public class SkipWaitTimeForInstanceTerminationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DeploymentAlreadyCompletedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
