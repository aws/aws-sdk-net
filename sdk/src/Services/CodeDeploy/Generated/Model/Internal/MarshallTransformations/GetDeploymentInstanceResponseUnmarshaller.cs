...
{
    /// <summary>
    /// Response Unmarshaller for GetDeploymentInstance operation
    /// </summary>  
    public class GetDeploymentInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeploymentInstanceResponse response = new GetDeploymentInstanceResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("instanceSummary", targetDepth, ref reader))
                {
                    var unmarshaller = InstanceSummaryUnmarshaller.Instance;
                    response.InstanceSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return InstanceDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        internal static GetDeploymentInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeploymentInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
