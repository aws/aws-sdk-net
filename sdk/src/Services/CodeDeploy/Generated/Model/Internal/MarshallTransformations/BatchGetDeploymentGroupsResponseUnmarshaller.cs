    ...
    public class BatchGetDeploymentGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DeploymentGroupInfo, DeploymentGroupInfoUnmarshaller>(DeploymentGroupInfoUnmarshaller.Instance);
                    response.DeploymentGroupsInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
