...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetApplications operation
    /// </summary>  
    public class BatchGetApplicationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetApplicationsResponse response = new BatchGetApplicationsResponse();
            ...
            {
                if (context.TestExpression("applicationsInfo", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ApplicationInfo, ApplicationInfoUnmarshaller>(ApplicationInfoUnmarshaller.Instance);
                    response.ApplicationsInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchGetApplicationsResponseUnmarshaller _instance = new BatchGetApplicationsResponseUnmarshaller();        

        internal static BatchGetApplicationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
