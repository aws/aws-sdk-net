...
{
    /// <summary>
    /// Blueprint Marshaller
    /// </summary>
    public class BlueprintMarshaller : IRequestMarshaller<Blueprint, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Blueprint requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static BlueprintMarshaller Instance = new BlueprintMarshaller();
