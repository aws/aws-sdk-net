...
using Amazon.Util;
using Amazon.NetworkMonitor.Endpoints;

#pragma warning disable 1591

namespace Amazon.NetworkMonitor.Internal
{
    /// <summary>
    ...
    /// </summary>
    public class AmazonNetworkMonitorEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonNetworkMonitorConfig)requestContext.ClientConfig;
            var result = new NetworkMonitorEndpointParameters();
