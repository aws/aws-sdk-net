...
namespace Amazon.NetworkMonitor
{
    ...
    public partial class AmazonNetworkMonitorClient : AmazonServiceClient, IAmazonNetworkMonitor
    {
        ...
        public AmazonNetworkMonitorClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonNetworkMonitorConfig()) { }
        ...
        public AmazonNetworkMonitorClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonNetworkMonitorConfig{RegionEndpoint = region}) { }
        ...
        internal virtual CreateProbeResponse CreateProbe(CreateProbeRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual DeleteProbeResponse DeleteProbe(DeleteProbeRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual GetProbeResponse GetProbe(GetProbeRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual UpdateProbeResponse UpdateProbe(UpdateProbeRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonNetworkMonitorEndpointResolver();
