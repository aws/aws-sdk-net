...
namespace Amazon.NetworkMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMonitorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("monitorArn", targetDepth, ref reader))
                {
                    ...
                    response.MonitorArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("monitorName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MonitorName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateMonitorResponseUnmarshaller _instance = new CreateMonitorResponseUnmarshaller();        

        internal static CreateMonitorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMonitorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
