...
namespace Amazon.Glue
{
    ...
    public partial interface IAmazonGlue : IAmazonService, IDisposable
    {
        ...
        Task<GetJobBookmarksResponse> GetJobBookmarksAsync(GetJobBookmarksRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
