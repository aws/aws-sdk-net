...
namespace Amazon.Glue.Model
{
    ...
    public partial class ViewDefinitionInput
    {
        ...
        /// <para>
        /// Statistics for each sub-object referenced by the materialized view, such as the source
        /// type, Glue version ID, and the partition, file, and byte counts. Each entry describes
        /// one sub-object, identified by its source type.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
