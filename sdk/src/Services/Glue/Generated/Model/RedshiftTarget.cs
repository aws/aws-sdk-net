...
namespace Amazon.Glue.Model
{
    ...
    /// </summary>
    public partial class RedshiftTarget
    {
        ...
        /// <summary>
        /// Gets and sets the property UpsertRedshiftOptions. 
        /// <para>
        ...
        {
            get { return this._upsertRedshiftOptions; }
            set { this._upsertRedshiftOptions = value; }
        }

        // Check to see if UpsertRedshiftOptions property is set
        internal bool IsSetUpsertRedshiftOptions()
        {
            return this._upsertRedshiftOptions != null;
        }
