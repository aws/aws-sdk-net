...
namespace Amazon.Glue.Model
{
    ...
    /// </summary>
    public partial class DataQualityRuleResultsOptions
    {
        private CatalogTableConfigOptions _catalogTableConfig;
        private bool? _writeDataQualityRuleResultsEnabled;
        ...
        /// <summary>
        /// Gets and sets the property WriteDataQualityRuleResultsEnabled. 
        /// <para>
        /// Set to true to write data quality rule results.
        /// </para>
        /// </summary>
        public bool? WriteDataQualityRuleResultsEnabled
        {
            get { return this._writeDataQualityRuleResultsEnabled; }
            set { this._writeDataQualityRuleResultsEnabled = value; }
        }

        // Check to see if WriteDataQualityRuleResultsEnabled property is set
        internal bool IsSetWriteDataQualityRuleResultsEnabled()
        {
            return this._writeDataQualityRuleResultsEnabled.HasValue; 
        }
