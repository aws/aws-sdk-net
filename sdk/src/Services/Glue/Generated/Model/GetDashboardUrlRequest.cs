...
{
    /// <summary>
    /// Container for the parameters to the GetDashboardUrl operation.
    /// Retrieves the URL for the Spark monitoring dashboard for a Glue resource.
    /// </summary>
    public partial class GetDashboardUrlRequest : AmazonGlueRequest
    {
        private string _requestOrigin;
        private string _resourceId;
        private GlueResourceType _resourceType;
        ...
        /// <para>
        /// The type of the resource. Valid values are <c>SESSION</c> and <c>JOB</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public GlueResourceType ResourceType
        {
