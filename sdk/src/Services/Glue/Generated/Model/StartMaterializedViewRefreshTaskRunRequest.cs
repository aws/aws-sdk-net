...
namespace Amazon.Glue.Model
{
    ...
    public partial class StartMaterializedViewRefreshTaskRunRequest : AmazonGlueRequest
    {
        ...
        /// <para>
        /// The ID of the Data Catalog where the table reside. If none is supplied, the account
        ...
        /// <summary>
        /// Gets and sets the property FullRefresh. 
        /// <para>
        ...
        {
            get { return this._fullRefresh.GetValueOrDefault(); }
            set { this._fullRefresh = value; }
        }

        // Check to see if FullRefresh property is set
        internal bool IsSetFullRefresh()
        {
            return this._fullRefresh.HasValue; 
        }
