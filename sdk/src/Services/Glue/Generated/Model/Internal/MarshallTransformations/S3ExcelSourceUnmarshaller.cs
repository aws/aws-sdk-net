...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ExcelSourceUnmarshaller : IUnmarshaller<S3ExcelSource, XmlUnmarshallerContext>, IUnmarshaller<S3ExcelSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        S3ExcelSource IUnmarshaller<S3ExcelSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public S3ExcelSource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("NumberRows", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberRows = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.SkipFooter = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
