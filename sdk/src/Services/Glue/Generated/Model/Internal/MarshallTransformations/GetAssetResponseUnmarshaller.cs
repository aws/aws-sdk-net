...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class GetAssetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("AssetTypeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetTypeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("IterableForms", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, IterableFormEntry, StringUnmarshaller, IterableFormEntryUnmarshaller>(StringUnmarshaller.Instance, IterableFormEntryUnmarshaller.Instance);
                    response.IterableForms = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
