...
{
    /// <summary>
    /// Response Unmarshaller for PutFormType operation
    /// </summary>  
    public class PutFormTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutFormTypeResponse response = new PutFormTypeResponse();
        ...
        private static PutFormTypeResponseUnmarshaller _instance = new PutFormTypeResponseUnmarshaller();        

        internal static PutFormTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutFormTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
