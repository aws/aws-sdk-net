...
{
    /// <summary>
    /// Response Unmarshaller for ListMLTransforms operation
    /// </summary>  
    public class ListMLTransformsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMLTransformsResponse response = new ListMLTransformsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TransformIds", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.TransformIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListMLTransformsResponseUnmarshaller _instance = new ListMLTransformsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMLTransformsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
