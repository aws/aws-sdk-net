    ...
    public class ListTableOptimizerRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TableOptimizerRun, TableOptimizerRunUnmarshaller>(TableOptimizerRunUnmarshaller.Instance);
                    response.TableOptimizerRuns = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
