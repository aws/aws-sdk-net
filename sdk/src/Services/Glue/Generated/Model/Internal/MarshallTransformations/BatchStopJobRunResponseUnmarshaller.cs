    ...
    public class BatchStopJobRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchStopJobRunError, BatchStopJobRunErrorUnmarshaller>(BatchStopJobRunErrorUnmarshaller.Instance);
                    response.Errors = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SuccessfulSubmissions", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<BatchStopJobRunSuccessfulSubmission, BatchStopJobRunSuccessfulSubmissionUnmarshaller>(BatchStopJobRunSuccessfulSubmissionUnmarshaller.Instance);
                    response.SuccessfulSubmissions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
