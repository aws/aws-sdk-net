    ...
    public class RouteUnmarshaller : IUnmarshaller<Route, XmlUnmarshallerContext>, IUnmarshaller<Route, JsonUnmarshallerContext>
    {
        ...
        public Route Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GroupFilters, GroupFiltersUnmarshaller>(GroupFiltersUnmarshaller.Instance);
                    unmarshalledObject.GroupFiltersList = unmarshaller.Unmarshall(context);
                    continue;
                }
