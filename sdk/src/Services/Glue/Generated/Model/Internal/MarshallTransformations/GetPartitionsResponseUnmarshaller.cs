...
{
    /// <summary>
    /// Response Unmarshaller for GetPartitions operation
    /// </summary>  
    public class GetPartitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Partition, PartitionUnmarshaller>(PartitionUnmarshaller.Instance);
        ...
        private static GetPartitionsResponseUnmarshaller _instance = new GetPartitionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartitionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
