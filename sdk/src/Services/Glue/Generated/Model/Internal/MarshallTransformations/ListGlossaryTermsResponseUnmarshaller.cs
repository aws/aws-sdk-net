...
{
    /// <summary>
    /// Response Unmarshaller for ListGlossaryTerms operation
    /// </summary>  
    public class ListGlossaryTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGlossaryTermsResponse response = new ListGlossaryTermsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GlossaryTermItem, GlossaryTermItemUnmarshaller>(GlossaryTermItemUnmarshaller.Instance);
        ...
        private static ListGlossaryTermsResponseUnmarshaller _instance = new ListGlossaryTermsResponseUnmarshaller();        

        internal static ListGlossaryTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGlossaryTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
