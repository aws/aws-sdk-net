...
{
    /// <summary>
    /// Response Unmarshaller for GetDataQualityModel operation
    /// </summary>  
    public class GetDataQualityModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataQualityModelResponse response = new GetDataQualityModelResponse();
        ...
        private static GetDataQualityModelResponseUnmarshaller _instance = new GetDataQualityModelResponseUnmarshaller();        

        internal static GetDataQualityModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataQualityModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
