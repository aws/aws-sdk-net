...
{
    /// <summary>
    /// Response Unmarshaller for ListAssetTypes operation
    /// </summary>  
    public class ListAssetTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssetTypesResponse response = new ListAssetTypesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssetTypeItem, AssetTypeItemUnmarshaller>(AssetTypeItemUnmarshaller.Instance);
        ...
        private static ListAssetTypesResponseUnmarshaller _instance = new ListAssetTypesResponseUnmarshaller();        

        internal static ListAssetTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssetTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
