...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAttachment operation
    /// </summary>  
    public class DeleteAttachmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteAttachmentResponseUnmarshaller _instance = new DeleteAttachmentResponseUnmarshaller();        

        internal static DeleteAttachmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAttachmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
