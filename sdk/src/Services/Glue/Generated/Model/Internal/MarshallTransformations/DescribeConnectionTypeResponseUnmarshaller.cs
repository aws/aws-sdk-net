        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AthenaConnectionProperties", targetDepth))
                {
                    ...
                    response.AthenaConnectionProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ComputeEnvironmentConfiguration, StringUnmarshaller, ComputeEnvironmentConfigurationUnmarshaller>(StringUnmarshaller.Instance, ComputeEnvironmentConfigurationUnmarshaller.Instance);
                    response.ComputeEnvironmentConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ConnectionOptions", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, Property, StringUnmarshaller, PropertyUnmarshaller>(StringUnmarshaller.Instance, PropertyUnmarshaller.Instance);
                    response.ConnectionOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, Property, StringUnmarshaller, PropertyUnmarshaller>(StringUnmarshaller.Instance, PropertyUnmarshaller.Instance);
                    response.PhysicalConnectionRequirements = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, Property, StringUnmarshaller, PropertyUnmarshaller>(StringUnmarshaller.Instance, PropertyUnmarshaller.Instance);
                    response.SparkConnectionProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
