...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3HudiCatalogTargetUnmarshaller : IUnmarshaller<S3HudiCatalogTarget, XmlUnmarshallerContext>, IUnmarshaller<S3HudiCatalogTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        S3HudiCatalogTarget IUnmarshaller<S3HudiCatalogTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public S3HudiCatalogTarget Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
