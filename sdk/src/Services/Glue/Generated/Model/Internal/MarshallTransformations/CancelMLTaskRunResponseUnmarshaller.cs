...
{
    /// <summary>
    /// Response Unmarshaller for CancelMLTaskRun operation
    /// </summary>  
    public class CancelMLTaskRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMLTaskRunResponse response = new CancelMLTaskRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TaskRunId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TaskRunId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TransformId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static CancelMLTaskRunResponseUnmarshaller _instance = new CancelMLTaskRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMLTaskRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
