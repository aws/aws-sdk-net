...
{
    /// <summary>
    /// Response Unmarshaller for ListEntities operation
    /// </summary>  
    public class ListEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListEntitiesResponse response = new ListEntitiesResponse();
        ...
        private static ListEntitiesResponseUnmarshaller _instance = new ListEntitiesResponseUnmarshaller();        

        internal static ListEntitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEntitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
