...
{
    /// <summary>
    /// Response Unmarshaller for GetMLTransforms operation
    /// </summary>  
    public class GetMLTransformsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLTransformsResponse response = new GetMLTransformsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Transforms", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<MLTransform, MLTransformUnmarshaller>(MLTransformUnmarshaller.Instance);
                    response.Transforms = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetMLTransformsResponseUnmarshaller _instance = new GetMLTransformsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLTransformsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
