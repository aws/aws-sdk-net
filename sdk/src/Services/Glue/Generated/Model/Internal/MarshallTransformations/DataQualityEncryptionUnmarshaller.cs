...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataQualityEncryptionUnmarshaller : IJsonUnmarshaller<DataQualityEncryption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataQualityEncryption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("DataQualityEncryptionMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataQualityEncryptionMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
