...
{
    /// <summary>
    /// Response Unmarshaller for GetJobBookmarks operation
    /// </summary>  
    public class GetJobBookmarksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJobBookmarksResponse response = new GetJobBookmarksResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<JobBookmarkEntry, JobBookmarkEntryUnmarshaller>(JobBookmarkEntryUnmarshaller.Instance);
                    response.JobBookmarkEntries = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetJobBookmarksResponseUnmarshaller _instance = new GetJobBookmarksResponseUnmarshaller();        

        internal static GetJobBookmarksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobBookmarksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
