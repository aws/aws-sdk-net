...
{
    /// <summary>
    /// Response Unmarshaller for GetClassifiers operation
    /// </summary>  
    public class GetClassifiersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetClassifiersResponse response = new GetClassifiersResponse();
            ...
            {
                if (context.TestExpression("Classifiers", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Classifier, ClassifierUnmarshaller>(ClassifierUnmarshaller.Instance);
                    response.Classifiers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetClassifiersResponseUnmarshaller _instance = new GetClassifiersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetClassifiersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
