...
{
    /// <summary>
    /// Response Unmarshaller for S3ParquetSource Object
    /// </summary>  
    public class S3ParquetSourceUnmarshaller : IJsonUnmarshaller<S3ParquetSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3ParquetSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Recurse", targetDepth, ref reader))
                {
        ...
        private static S3ParquetSourceUnmarshaller _instance = new S3ParquetSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3ParquetSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
