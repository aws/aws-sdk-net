...
{
    /// <summary>
    /// Response Unmarshaller for ListDataQualityStatistics operation
    /// </summary>  
    public class ListDataQualityStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDataQualityStatisticsResponse response = new ListDataQualityStatisticsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<StatisticSummary, StatisticSummaryUnmarshaller>(StatisticSummaryUnmarshaller.Instance);
        ...
        private static ListDataQualityStatisticsResponseUnmarshaller _instance = new ListDataQualityStatisticsResponseUnmarshaller();        

        internal static ListDataQualityStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDataQualityStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
