...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConnectionType operation
    /// </summary>  
    public class DeleteConnectionTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConnectionTypeResponse response = new DeleteConnectionTypeResponse();
        ...
        private static DeleteConnectionTypeResponseUnmarshaller _instance = new DeleteConnectionTypeResponseUnmarshaller();        

        internal static DeleteConnectionTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConnectionTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
