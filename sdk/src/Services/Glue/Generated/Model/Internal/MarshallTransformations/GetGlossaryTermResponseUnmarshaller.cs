...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGlossaryTermResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGlossaryTermResponse response = new GetGlossaryTermResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GlossaryId", targetDepth, ref reader))
                {
                    ...
                    response.GlossaryId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetGlossaryTermResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGlossaryTermResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
