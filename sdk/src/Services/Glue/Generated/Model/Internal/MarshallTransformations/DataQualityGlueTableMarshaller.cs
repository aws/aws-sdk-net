...
{
    /// <summary>
    /// DataQualityGlueTable Marshaller
    /// </summary>
    public class DataQualityGlueTableMarshaller : IRequestMarshaller<DataQualityGlueTable, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DataQualityGlueTable requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPreProcessingQuery())
            {
                context.Writer.WritePropertyName("PreProcessingQuery");
                context.Writer.WriteStringValue(requestObject.PreProcessingQuery);
            }
        ...
        /// </summary>
        public readonly static DataQualityGlueTableMarshaller Instance = new DataQualityGlueTableMarshaller();
