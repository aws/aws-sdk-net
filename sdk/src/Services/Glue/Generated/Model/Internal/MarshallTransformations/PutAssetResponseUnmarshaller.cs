...
{
    /// <summary>
    /// Response Unmarshaller for PutAsset operation
    /// </summary>  
    public class PutAssetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAssetResponse response = new PutAssetResponse();
        ...
        private static PutAssetResponseUnmarshaller _instance = new PutAssetResponseUnmarshaller();        

        internal static PutAssetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAssetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
