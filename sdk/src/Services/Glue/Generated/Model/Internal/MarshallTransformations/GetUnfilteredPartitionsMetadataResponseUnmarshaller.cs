    ...
    public class GetUnfilteredPartitionsMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<UnfilteredPartition, UnfilteredPartitionUnmarshaller>(UnfilteredPartitionUnmarshaller.Instance);
                    response.UnfilteredPartitions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return PermissionTypeMismatchExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
