...
{
    /// <summary>
    /// Response Unmarshaller for PutAttachment operation
    /// </summary>  
    public class PutAttachmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAttachmentResponse response = new PutAttachmentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AttachmentName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("FormTypeId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FormTypeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static PutAttachmentResponseUnmarshaller _instance = new PutAttachmentResponseUnmarshaller();        

        internal static PutAttachmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAttachmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
