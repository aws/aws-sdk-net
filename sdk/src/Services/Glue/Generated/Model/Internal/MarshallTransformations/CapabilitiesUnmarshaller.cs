    ...
    public class CapabilitiesUnmarshaller : IUnmarshaller<Capabilities, XmlUnmarshallerContext>, IUnmarshaller<Capabilities, JsonUnmarshallerContext>
    {
        ...
        public Capabilities Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SupportedComputeEnvironments = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SupportedDataOperations", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SupportedDataOperations = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
