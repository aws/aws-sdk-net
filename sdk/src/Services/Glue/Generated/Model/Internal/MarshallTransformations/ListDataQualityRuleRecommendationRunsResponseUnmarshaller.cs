...
{
    /// <summary>
    /// Response Unmarshaller for ListDataQualityRuleRecommendationRuns operation
    /// </summary>  
    public class ListDataQualityRuleRecommendationRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDataQualityRuleRecommendationRunsResponse response = new ListDataQualityRuleRecommendationRunsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Runs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<DataQualityRuleRecommendationRunDescription, DataQualityRuleRecommendationRunDescriptionUnmarshaller>(DataQualityRuleRecommendationRunDescriptionUnmarshaller.Instance);
                    response.Runs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListDataQualityRuleRecommendationRunsResponseUnmarshaller _instance = new ListDataQualityRuleRecommendationRunsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDataQualityRuleRecommendationRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
