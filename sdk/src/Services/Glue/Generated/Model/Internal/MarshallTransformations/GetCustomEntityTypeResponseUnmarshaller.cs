...
{
    /// <summary>
    /// Response Unmarshaller for GetCustomEntityType operation
    /// </summary>  
    public class GetCustomEntityTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCustomEntityTypeResponse response = new GetCustomEntityTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContextWords", targetDepth, ref reader))
                {
                    ...
                    response.ContextWords = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegexString = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCustomEntityTypeResponseUnmarshaller _instance = new GetCustomEntityTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCustomEntityTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
