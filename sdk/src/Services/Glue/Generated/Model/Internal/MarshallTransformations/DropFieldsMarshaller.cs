...
{
    /// <summary>
    /// DropFields Marshaller
    /// </summary>
    public class DropFieldsMarshaller : IRequestMarshaller<DropFields, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DropFields requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPaths())
            {
                ...
                foreach(var requestObjectPathsListValue in requestObject.Paths)
                {
                    ...
                    {
                            context.Writer.Write(requestObjectPathsListValueListValue);
                    }
                    context.Writer.WriteArrayEnd();
                }
                context.Writer.WriteArrayEnd();
        ...
        /// </summary>
        public readonly static DropFieldsMarshaller Instance = new DropFieldsMarshaller();
