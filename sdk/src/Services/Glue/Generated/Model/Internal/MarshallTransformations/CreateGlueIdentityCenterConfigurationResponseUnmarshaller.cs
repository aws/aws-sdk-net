...
{
    /// <summary>
    /// Response Unmarshaller for CreateGlueIdentityCenterConfiguration operation
    /// </summary>  
    public class CreateGlueIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGlueIdentityCenterConfigurationResponse response = new CreateGlueIdentityCenterConfigurationResponse();
        ...
        private static CreateGlueIdentityCenterConfigurationResponseUnmarshaller _instance = new CreateGlueIdentityCenterConfigurationResponseUnmarshaller();        

        internal static CreateGlueIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlueIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
