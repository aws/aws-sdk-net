...
{
    /// <summary>
    /// Response Unmarshaller for ListIntegrationTableProperties operation
    /// </summary>  
    public class ListIntegrationTablePropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIntegrationTablePropertiesResponse response = new ListIntegrationTablePropertiesResponse();
            ...
            {
                if (context.TestExpression("IntegrationTablePropertiesList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<IntegrationTableProperties, IntegrationTablePropertiesUnmarshaller>(IntegrationTablePropertiesUnmarshaller.Instance);
                    response.IntegrationTablePropertiesList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListIntegrationTablePropertiesResponseUnmarshaller _instance = new ListIntegrationTablePropertiesResponseUnmarshaller();        

        internal static ListIntegrationTablePropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntegrationTablePropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
