...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEntity operation
    /// </summary>  
    public class DescribeEntityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeEntityResponseUnmarshaller _instance = new DescribeEntityResponseUnmarshaller();        

        internal static DescribeEntityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEntityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
