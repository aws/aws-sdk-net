...
{
    /// <summary>
    /// Response Unmarshaller for GetEntityRecords operation
    /// </summary>  
    public class GetEntityRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEntityRecordsResponse response = new GetEntityRecordsResponse();
        ...
        private static GetEntityRecordsResponseUnmarshaller _instance = new GetEntityRecordsResponseUnmarshaller();        

        internal static GetEntityRecordsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEntityRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
