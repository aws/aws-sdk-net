...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JDBCConnectorOptionsUnmarshaller : IUnmarshaller<JDBCConnectorOptions, XmlUnmarshallerContext>, IUnmarshaller<JDBCConnectorOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        JDBCConnectorOptions IUnmarshaller<JDBCConnectorOptions, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public JDBCConnectorOptions Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DataTypeMapping", targetDepth))
                {
                    ...
                    unmarshalledObject.DataTypeMapping = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FilterPredicate", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FilterPredicate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("JobBookmarkKeys", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.JobBookmarkKeys = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("JobBookmarkKeysSortOrder", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.JobBookmarkKeysSortOrder = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    unmarshalledObject.NumPartitions = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PartitionColumn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PartitionColumn = unmarshaller.Unmarshall(context);
                    continue;
                }
