...
{
    /// <summary>
    /// StartColumnStatisticsTaskRun Request Marshaller
    /// </summary>       
    public class StartColumnStatisticsTaskRunRequestMarshaller : IMarshaller<IRequest, StartColumnStatisticsTaskRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartColumnStatisticsTaskRunRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartColumnStatisticsTaskRunRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.StartColumnStatisticsTaskRun";
        ...
        private static StartColumnStatisticsTaskRunRequestMarshaller _instance = new StartColumnStatisticsTaskRunRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartColumnStatisticsTaskRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
