...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CloudWatchEncryptionUnmarshaller : IJsonUnmarshaller<CloudWatchEncryption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CloudWatchEncryption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CloudWatchEncryptionMode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CloudWatchEncryptionMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
