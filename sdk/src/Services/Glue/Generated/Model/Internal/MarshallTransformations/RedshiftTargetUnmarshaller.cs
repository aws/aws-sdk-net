...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RedshiftTargetUnmarshaller : IUnmarshaller<RedshiftTarget, XmlUnmarshallerContext>, IUnmarshaller<RedshiftTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RedshiftTarget IUnmarshaller<RedshiftTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RedshiftTarget Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("UpsertRedshiftOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.UpsertRedshiftOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
