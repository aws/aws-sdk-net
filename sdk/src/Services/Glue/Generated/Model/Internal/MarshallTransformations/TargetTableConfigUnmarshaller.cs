...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetTableConfigUnmarshaller : IUnmarshaller<TargetTableConfig, XmlUnmarshallerContext>, IUnmarshaller<TargetTableConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TargetTableConfig IUnmarshaller<TargetTableConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TargetTableConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<IntegrationPartition, IntegrationPartitionUnmarshaller>(IntegrationPartitionUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UnnestSpec = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
