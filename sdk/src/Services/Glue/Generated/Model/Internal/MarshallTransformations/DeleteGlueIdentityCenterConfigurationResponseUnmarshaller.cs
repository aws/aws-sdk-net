...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGlueIdentityCenterConfiguration operation
    /// </summary>  
    public class DeleteGlueIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGlueIdentityCenterConfigurationResponse response = new DeleteGlueIdentityCenterConfigurationResponse();
        ...
        private static DeleteGlueIdentityCenterConfigurationResponseUnmarshaller _instance = new DeleteGlueIdentityCenterConfigurationResponseUnmarshaller();        

        internal static DeleteGlueIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGlueIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
