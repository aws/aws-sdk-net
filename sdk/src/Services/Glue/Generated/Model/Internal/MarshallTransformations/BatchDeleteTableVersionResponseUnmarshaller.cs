...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteTableVersion operation
    /// </summary>  
    public class BatchDeleteTableVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteTableVersionResponse response = new BatchDeleteTableVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TableVersionError, TableVersionErrorUnmarshaller>(TableVersionErrorUnmarshaller.Instance);
        ...
        private static BatchDeleteTableVersionResponseUnmarshaller _instance = new BatchDeleteTableVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteTableVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
