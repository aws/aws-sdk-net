...
{
    /// <summary>
    /// Response Unmarshaller for GetBlueprint operation
    /// </summary>  
    public class GetBlueprintResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBlueprintResponse response = new GetBlueprintResponse();
            ...
            {
                if (context.TestExpression("Blueprint", targetDepth, ref reader))
                {
                    var unmarshaller = BlueprintUnmarshaller.Instance;
                    response.Blueprint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetBlueprintResponseUnmarshaller _instance = new GetBlueprintResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBlueprintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
