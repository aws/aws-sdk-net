...
{
    /// <summary>
    /// Response Unmarshaller for GetStatement operation
    /// </summary>  
    public class GetStatementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetStatementResponseUnmarshaller _instance = new GetStatementResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStatementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
