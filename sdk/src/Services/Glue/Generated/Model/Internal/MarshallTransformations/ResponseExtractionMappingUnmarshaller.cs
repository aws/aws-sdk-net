...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResponseExtractionMappingUnmarshaller : IJsonUnmarshaller<ResponseExtractionMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResponseExtractionMapping Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HeaderKey", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HeaderKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
