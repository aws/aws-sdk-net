...
{
    /// <summary>
    /// Response Unmarshaller for AssociateGlossaryTerms operation
    /// </summary>  
    public class AssociateGlossaryTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateGlossaryTermsResponse response = new AssociateGlossaryTermsResponse();
        ...
        private static AssociateGlossaryTermsResponseUnmarshaller _instance = new AssociateGlossaryTermsResponseUnmarshaller();        

        internal static AssociateGlossaryTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateGlossaryTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
