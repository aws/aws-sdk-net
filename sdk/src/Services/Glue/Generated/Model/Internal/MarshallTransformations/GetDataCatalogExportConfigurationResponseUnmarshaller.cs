...
{
    /// <summary>
    /// Response Unmarshaller for GetDataCatalogExportConfiguration operation
    /// </summary>  
    public class GetDataCatalogExportConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataCatalogExportConfigurationResponse response = new GetDataCatalogExportConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ExportEncryptionConfigurationUnmarshaller.Instance;
                    response.EncryptionConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExportSetting", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExportSetting = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("S3TableBucketArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static GetDataCatalogExportConfigurationResponseUnmarshaller _instance = new GetDataCatalogExportConfigurationResponseUnmarshaller();        

        internal static GetDataCatalogExportConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataCatalogExportConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
