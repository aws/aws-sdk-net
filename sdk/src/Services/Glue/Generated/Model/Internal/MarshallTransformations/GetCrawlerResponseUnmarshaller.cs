...
{
    /// <summary>
    /// Response Unmarshaller for GetCrawler operation
    /// </summary>  
    public class GetCrawlerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCrawlerResponse response = new GetCrawlerResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Crawler", targetDepth, ref reader))
                {
                    var unmarshaller = CrawlerUnmarshaller.Instance;
                    response.Crawler = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCrawlerResponseUnmarshaller _instance = new GetCrawlerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCrawlerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
