...
{
    /// <summary>
    /// Response Unmarshaller for PutDataQualityProfileAnnotation operation
    /// </summary>  
    public class PutDataQualityProfileAnnotationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDataQualityProfileAnnotationResponse response = new PutDataQualityProfileAnnotationResponse();
        ...
        private static PutDataQualityProfileAnnotationResponseUnmarshaller _instance = new PutDataQualityProfileAnnotationResponseUnmarshaller();        

        internal static PutDataQualityProfileAnnotationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDataQualityProfileAnnotationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
