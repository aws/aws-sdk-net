...
{
    /// <summary>
    /// Response Unmarshaller for GetPlan operation
    /// </summary>  
    public class GetPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("PythonScript", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PythonScript = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ScalaCode", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScalaCode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetPlanResponseUnmarshaller _instance = new GetPlanResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
