...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ColumnImportanceUnmarshaller : IJsonUnmarshaller<ColumnImportance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ColumnImportance Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Importance", targetDepth, ref reader))
                {
