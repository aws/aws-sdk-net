...
{
    /// <summary>
    /// UpdateJobFromSourceControl Request Marshaller
    /// </summary>       
    public class UpdateJobFromSourceControlRequestMarshaller : IMarshaller<IRequest, UpdateJobFromSourceControlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateJobFromSourceControlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateJobFromSourceControlRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.UpdateJobFromSourceControl";
        ...
        private static UpdateJobFromSourceControlRequestMarshaller _instance = new UpdateJobFromSourceControlRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateJobFromSourceControlRequestMarshaller Instance
        {
            get
            {
                return _instance;
