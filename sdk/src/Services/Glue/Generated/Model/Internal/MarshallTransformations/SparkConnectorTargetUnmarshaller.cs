...
{
    /// <summary>
    /// Response Unmarshaller for SparkConnectorTarget Object
    /// </summary>  
    public class SparkConnectorTargetUnmarshaller : IUnmarshaller<SparkConnectorTarget, XmlUnmarshallerContext>, IUnmarshaller<SparkConnectorTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SparkConnectorTarget IUnmarshaller<SparkConnectorTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SparkConnectorTarget Unmarshall(JsonUnmarshallerContext context)
        {
            SparkConnectorTarget unmarshalledObject = new SparkConnectorTarget();
        ...
        private static SparkConnectorTargetUnmarshaller _instance = new SparkConnectorTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SparkConnectorTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
