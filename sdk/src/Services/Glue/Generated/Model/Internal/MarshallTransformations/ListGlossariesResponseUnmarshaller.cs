...
{
    /// <summary>
    /// Response Unmarshaller for ListGlossaries operation
    /// </summary>  
    public class ListGlossariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGlossariesResponse response = new ListGlossariesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GlossaryItem, GlossaryItemUnmarshaller>(GlossaryItemUnmarshaller.Instance);
        ...
        private static ListGlossariesResponseUnmarshaller _instance = new ListGlossariesResponseUnmarshaller();        

        internal static ListGlossariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGlossariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
