...
{
    /// <summary>
    /// Response Unmarshaller for GetDataCatalogEncryptionSettings operation
    /// </summary>  
    public class GetDataCatalogEncryptionSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataCatalogEncryptionSettingsResponse response = new GetDataCatalogEncryptionSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DataCatalogEncryptionSettings", targetDepth))
                {
                    ...
                    response.DataCatalogEncryptionSettings = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDataCatalogEncryptionSettingsResponseUnmarshaller _instance = new GetDataCatalogEncryptionSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataCatalogEncryptionSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
