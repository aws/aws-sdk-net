    ...
    public class BatchGetDataQualityResultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DataQualityResult, DataQualityResultUnmarshaller>(DataQualityResultUnmarshaller.Instance);
                ...
                if (context.TestExpression("ResultsNotFound", targetDepth))
                {
                    ...
                    response.ResultsNotFound = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
