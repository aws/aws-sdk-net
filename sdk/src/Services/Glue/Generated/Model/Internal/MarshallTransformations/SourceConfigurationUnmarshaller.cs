        ...
        public SourceConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("RequestMethod", targetDepth))
                {
                    ...
                    unmarshalledObject.RequestMethod = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RequestParameters", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ConnectorProperty, ConnectorPropertyUnmarshaller>(ConnectorPropertyUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RequestPath = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ResponseConfiguration", targetDepth))
                {
                    var unmarshaller = ResponseConfigurationUnmarshaller.Instance;
                    unmarshalledObject.ResponseConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
