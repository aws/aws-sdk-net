...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// Spigot Marshaller
    /// </summary>
    public class SpigotMarshaller : IRequestMarshaller<Spigot, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(Spigot requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetProb())
            {
                ...
                if(StringUtils.IsSpecialDoubleValue(requestObject.Prob.Value))
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(requestObject.Prob.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(requestObject.Prob.Value);
                }
            }
        ...
        /// </summary>
        public readonly static SpigotMarshaller Instance = new SpigotMarshaller();
