...
{
    /// <summary>
    /// UpdateClassifier Request Marshaller
    /// </summary>       
    public class UpdateClassifierRequestMarshaller : IMarshaller<IRequest, UpdateClassifierRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateClassifierRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateClassifierRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.UpdateClassifier";
        ...
        private static UpdateClassifierRequestMarshaller _instance = new UpdateClassifierRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateClassifierRequestMarshaller Instance
        {
            get
            {
                return _instance;
