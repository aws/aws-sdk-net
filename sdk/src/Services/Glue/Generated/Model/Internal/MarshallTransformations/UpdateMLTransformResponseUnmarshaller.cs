...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMLTransform operation
    /// </summary>  
    public class UpdateMLTransformResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMLTransformResponse response = new UpdateMLTransformResponse();
        ...
        private static UpdateMLTransformResponseUnmarshaller _instance = new UpdateMLTransformResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMLTransformResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
