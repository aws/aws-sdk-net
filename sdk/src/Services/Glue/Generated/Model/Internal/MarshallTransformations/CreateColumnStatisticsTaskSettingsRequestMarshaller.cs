...
{
    /// <summary>
    /// CreateColumnStatisticsTaskSettings Request Marshaller
    /// </summary>       
    public class CreateColumnStatisticsTaskSettingsRequestMarshaller : IMarshaller<IRequest, CreateColumnStatisticsTaskSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateColumnStatisticsTaskSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateColumnStatisticsTaskSettingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.CreateColumnStatisticsTaskSettings";
        ...
        private static CreateColumnStatisticsTaskSettingsRequestMarshaller _instance = new CreateColumnStatisticsTaskSettingsRequestMarshaller();        

        internal static CreateColumnStatisticsTaskSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateColumnStatisticsTaskSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
