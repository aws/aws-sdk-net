...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3DeltaSourceUnmarshaller : IUnmarshaller<S3DeltaSource, XmlUnmarshallerContext>, IUnmarshaller<S3DeltaSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        S3DeltaSource IUnmarshaller<S3DeltaSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public S3DeltaSource Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
