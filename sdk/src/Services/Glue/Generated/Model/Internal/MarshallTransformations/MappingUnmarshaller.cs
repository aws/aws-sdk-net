        ...
        public Mapping Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Dropped", targetDepth))
                {
                    ...
                    unmarshalledObject.Dropped = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FromPath", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.FromPath = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FromType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FromType = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ToKey", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ToKey = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ToType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ToType = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
