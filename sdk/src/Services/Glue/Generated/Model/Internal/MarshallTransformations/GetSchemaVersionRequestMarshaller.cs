...
{
    /// <summary>
    /// GetSchemaVersion Request Marshaller
    /// </summary>       
    public class GetSchemaVersionRequestMarshaller : IMarshaller<IRequest, GetSchemaVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSchemaVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSchemaVersionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.GetSchemaVersion";
        ...
        private static GetSchemaVersionRequestMarshaller _instance = new GetSchemaVersionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSchemaVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
