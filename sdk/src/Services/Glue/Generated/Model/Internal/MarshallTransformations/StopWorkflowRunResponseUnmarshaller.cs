...
{
    /// <summary>
    /// Response Unmarshaller for StopWorkflowRun operation
    /// </summary>  
    public class StopWorkflowRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopWorkflowRunResponse response = new StopWorkflowRunResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("IllegalWorkflowStateException"))
            {
                return new IllegalWorkflowStateException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static StopWorkflowRunResponseUnmarshaller _instance = new StopWorkflowRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopWorkflowRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
