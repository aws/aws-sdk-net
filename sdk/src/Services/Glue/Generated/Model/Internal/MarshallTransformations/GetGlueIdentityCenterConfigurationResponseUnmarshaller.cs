...
{
    /// <summary>
    /// Response Unmarshaller for GetGlueIdentityCenterConfiguration operation
    /// </summary>  
    public class GetGlueIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGlueIdentityCenterConfigurationResponse response = new GetGlueIdentityCenterConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UserBackgroundSessionsEnabled", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.UserBackgroundSessionsEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetGlueIdentityCenterConfigurationResponseUnmarshaller _instance = new GetGlueIdentityCenterConfigurationResponseUnmarshaller();        

        internal static GetGlueIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGlueIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
