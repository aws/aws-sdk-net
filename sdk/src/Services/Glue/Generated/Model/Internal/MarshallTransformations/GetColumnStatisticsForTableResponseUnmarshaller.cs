...
{
    /// <summary>
    /// Response Unmarshaller for GetColumnStatisticsForTable operation
    /// </summary>  
    public class GetColumnStatisticsForTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetColumnStatisticsForTableResponse response = new GetColumnStatisticsForTableResponse();
            ...
            {
                if (context.TestExpression("ColumnStatisticsList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ColumnStatistics, ColumnStatisticsUnmarshaller>(ColumnStatisticsUnmarshaller.Instance);
                    response.ColumnStatisticsList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Errors", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ColumnError, ColumnErrorUnmarshaller>(ColumnErrorUnmarshaller.Instance);
        ...
        private static GetColumnStatisticsForTableResponseUnmarshaller _instance = new GetColumnStatisticsForTableResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetColumnStatisticsForTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
