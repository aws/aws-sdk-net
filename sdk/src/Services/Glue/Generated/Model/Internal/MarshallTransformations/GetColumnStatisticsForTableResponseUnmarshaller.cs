    ...
    public class GetColumnStatisticsForTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ColumnStatistics, ColumnStatisticsUnmarshaller>(ColumnStatisticsUnmarshaller.Instance);
                    response.ColumnStatisticsList = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Errors", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ColumnError, ColumnErrorUnmarshaller>(ColumnErrorUnmarshaller.Instance);
