...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateGlossaryTerms operation
    /// </summary>  
    public class DisassociateGlossaryTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateGlossaryTermsResponse response = new DisassociateGlossaryTermsResponse();
        ...
        private static DisassociateGlossaryTermsResponseUnmarshaller _instance = new DisassociateGlossaryTermsResponseUnmarshaller();        

        internal static DisassociateGlossaryTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateGlossaryTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
