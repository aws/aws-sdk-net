...
{
    /// <summary>
    /// Response Unmarshaller for PutAssetType operation
    /// </summary>  
    public class PutAssetTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAssetTypeResponse response = new PutAssetTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, AssetTypeFormReference, StringUnmarshaller, AssetTypeFormReferenceUnmarshaller>(StringUnmarshaller.Instance, AssetTypeFormReferenceUnmarshaller.Instance);
        ...
        private static PutAssetTypeResponseUnmarshaller _instance = new PutAssetTypeResponseUnmarshaller();        

        internal static PutAssetTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAssetTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
