...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInboundIntegrations operation
    /// </summary>  
    public class DescribeInboundIntegrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInboundIntegrationsResponse response = new DescribeInboundIntegrationsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InboundIntegrations", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<InboundIntegration, InboundIntegrationUnmarshaller>(InboundIntegrationUnmarshaller.Instance);
                    response.InboundIntegrations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return IntegrationNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("TargetResourceNotFound"))
                {
                    return TargetResourceNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DescribeInboundIntegrationsResponseUnmarshaller _instance = new DescribeInboundIntegrationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInboundIntegrationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
