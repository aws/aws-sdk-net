...
{
    /// <summary>
    /// Response Unmarshaller for ListIterableForms operation
    /// </summary>  
    public class ListIterableFormsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIterableFormsResponse response = new ListIterableFormsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IterableFormListItem, IterableFormListItemUnmarshaller>(IterableFormListItemUnmarshaller.Instance);
        ...
        private static ListIterableFormsResponseUnmarshaller _instance = new ListIterableFormsResponseUnmarshaller();        

        internal static ListIterableFormsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIterableFormsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
