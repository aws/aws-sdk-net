...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MaterializedViewRefreshTaskRunUnmarshaller : IJsonUnmarshaller<MaterializedViewRefreshTaskRun, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MaterializedViewRefreshTaskRun Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MaterializedViewRefreshTaskRunId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ProcessedBytes", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.ProcessedBytes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
