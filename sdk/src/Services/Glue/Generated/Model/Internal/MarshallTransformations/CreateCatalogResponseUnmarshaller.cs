...
{
    /// <summary>
    /// Response Unmarshaller for CreateCatalog operation
    /// </summary>  
    public class CreateCatalogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return FederatedResourceAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateCatalogResponseUnmarshaller _instance = new CreateCatalogResponseUnmarshaller();        

        internal static CreateCatalogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCatalogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
