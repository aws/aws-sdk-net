    ...
    public class ListDataQualityResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DataQualityResultDescription, DataQualityResultDescriptionUnmarshaller>(DataQualityResultDescriptionUnmarshaller.Instance);
