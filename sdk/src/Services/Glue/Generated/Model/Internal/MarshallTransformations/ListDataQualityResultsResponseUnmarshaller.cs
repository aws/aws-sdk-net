...
{
    /// <summary>
    /// Response Unmarshaller for ListDataQualityResults operation
    /// </summary>  
    public class ListDataQualityResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDataQualityResultsResponse response = new ListDataQualityResultsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DataQualityResultDescription, DataQualityResultDescriptionUnmarshaller>(DataQualityResultDescriptionUnmarshaller.Instance);
        ...
        private static ListDataQualityResultsResponseUnmarshaller _instance = new ListDataQualityResultsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDataQualityResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
