...
{
    /// <summary>
    /// Response Unmarshaller for S3GlueParquetTarget Object
    /// </summary>  
    public class S3GlueParquetTargetUnmarshaller : IUnmarshaller<S3GlueParquetTarget, XmlUnmarshallerContext>, IUnmarshaller<S3GlueParquetTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        S3GlueParquetTarget IUnmarshaller<S3GlueParquetTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public S3GlueParquetTarget Unmarshall(JsonUnmarshallerContext context)
        {
            S3GlueParquetTarget unmarshalledObject = new S3GlueParquetTarget();
        ...
        private static S3GlueParquetTargetUnmarshaller _instance = new S3GlueParquetTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3GlueParquetTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
