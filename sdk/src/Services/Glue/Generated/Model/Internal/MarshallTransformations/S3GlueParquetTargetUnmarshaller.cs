...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3GlueParquetTargetUnmarshaller : IJsonUnmarshaller<S3GlueParquetTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3GlueParquetTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumberTargetPartitions", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
