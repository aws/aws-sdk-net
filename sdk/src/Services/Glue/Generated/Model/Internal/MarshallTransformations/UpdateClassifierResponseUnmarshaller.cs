...
{
    /// <summary>
    /// Response Unmarshaller for UpdateClassifier operation
    /// </summary>  
    public class UpdateClassifierResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateClassifierResponse response = new UpdateClassifierResponse();
        ...
        private static UpdateClassifierResponseUnmarshaller _instance = new UpdateClassifierResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateClassifierResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
