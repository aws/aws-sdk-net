...
{
    /// <summary>
    /// ConnectorAuthorizationCodeProperties Marshaller
    /// </summary>
    public class ConnectorAuthorizationCodePropertiesMarshaller : IRequestMarshaller<ConnectorAuthorizationCodeProperties, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ConnectorAuthorizationCodeProperties requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAuthorizationCodeUrl())
            {
                context.Writer.WritePropertyName("AuthorizationCodeUrl");
                context.Writer.WriteStartObject();

                var marshaller = ConnectorPropertyMarshaller.Instance;
                marshaller.Marshall(requestObject.AuthorizationCodeUrl, context);
            ...
            if(requestObject.IsSetRedirectUri())
            {
                ...
                var marshaller = ConnectorPropertyMarshaller.Instance;
                marshaller.Marshall(requestObject.RedirectUri, context);
        ...
        /// </summary>
        public readonly static ConnectorAuthorizationCodePropertiesMarshaller Instance = new ConnectorAuthorizationCodePropertiesMarshaller();
