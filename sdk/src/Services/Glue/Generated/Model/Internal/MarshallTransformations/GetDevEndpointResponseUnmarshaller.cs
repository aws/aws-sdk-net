...
{
    /// <summary>
    /// Response Unmarshaller for GetDevEndpoint operation
    /// </summary>  
    public class GetDevEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDevEndpointResponse response = new GetDevEndpointResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DevEndpoint", targetDepth, ref reader))
                {
                    var unmarshaller = DevEndpointUnmarshaller.Instance;
                    response.DevEndpoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDevEndpointResponseUnmarshaller _instance = new GetDevEndpointResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDevEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
