    ...
    public class BatchDeleteConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ErrorDetail, StringUnmarshaller, ErrorDetailUnmarshaller>(StringUnmarshaller.Instance, ErrorDetailUnmarshaller.Instance);
