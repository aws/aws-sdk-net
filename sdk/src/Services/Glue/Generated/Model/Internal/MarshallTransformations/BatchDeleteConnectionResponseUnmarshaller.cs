...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteConnection operation
    /// </summary>  
    public class BatchDeleteConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteConnectionResponse response = new BatchDeleteConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, ErrorDetail, StringUnmarshaller, ErrorDetailUnmarshaller>(StringUnmarshaller.Instance, ErrorDetailUnmarshaller.Instance);
        ...
        private static BatchDeleteConnectionResponseUnmarshaller _instance = new BatchDeleteConnectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
