...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IcebergTargetUnmarshaller : IUnmarshaller<IcebergTarget, XmlUnmarshallerContext>, IUnmarshaller<IcebergTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        IcebergTarget IUnmarshaller<IcebergTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public IcebergTarget Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
