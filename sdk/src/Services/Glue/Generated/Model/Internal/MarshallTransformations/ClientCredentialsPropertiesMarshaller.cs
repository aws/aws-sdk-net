...
{
    /// <summary>
    /// ClientCredentialsProperties Marshaller
    /// </summary>
    public class ClientCredentialsPropertiesMarshaller : IRequestMarshaller<ClientCredentialsProperties, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ClientCredentialsProperties requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetClientId())
            {
                ...
                marshaller.Marshall(requestObject.ClientId, context);
            ...
            if(requestObject.IsSetClientSecret())
            {
                ...
                var marshaller = ConnectorPropertyMarshaller.Instance;
                marshaller.Marshall(requestObject.ClientSecret, context);
        ...
        /// </summary>
        public readonly static ClientCredentialsPropertiesMarshaller Instance = new ClientCredentialsPropertiesMarshaller();
