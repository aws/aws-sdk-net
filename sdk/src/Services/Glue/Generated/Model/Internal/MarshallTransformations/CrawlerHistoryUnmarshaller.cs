...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CrawlerHistoryUnmarshaller : IUnmarshaller<CrawlerHistory, XmlUnmarshallerContext>, IUnmarshaller<CrawlerHistory, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CrawlerHistory IUnmarshaller<CrawlerHistory, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CrawlerHistory Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CrawlId", targetDepth))
                {
                    ...
                    unmarshalledObject.CrawlId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DPUHour", targetDepth))
                {
                    var unmarshaller = DoubleUnmarshaller.Instance;
                    unmarshalledObject.DPUHour = unmarshaller.Unmarshall(context);
                    continue;
                }
