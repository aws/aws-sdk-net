...
{
    /// <summary>
    /// Response Unmarshaller for StopColumnStatisticsTaskRunSchedule operation
    /// </summary>  
    public class StopColumnStatisticsTaskRunScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopColumnStatisticsTaskRunScheduleResponse response = new StopColumnStatisticsTaskRunScheduleResponse();
        ...
        private static StopColumnStatisticsTaskRunScheduleResponseUnmarshaller _instance = new StopColumnStatisticsTaskRunScheduleResponseUnmarshaller();        

        internal static StopColumnStatisticsTaskRunScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopColumnStatisticsTaskRunScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
