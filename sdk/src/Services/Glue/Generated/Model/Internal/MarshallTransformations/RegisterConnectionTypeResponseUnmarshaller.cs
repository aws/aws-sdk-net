...
{
    /// <summary>
    /// Response Unmarshaller for RegisterConnectionType operation
    /// </summary>  
    public class RegisterConnectionTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterConnectionTypeResponse response = new RegisterConnectionTypeResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ConnectionTypeArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConnectionTypeArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RegisterConnectionTypeResponseUnmarshaller _instance = new RegisterConnectionTypeResponseUnmarshaller();        

        internal static RegisterConnectionTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterConnectionTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
