...
{
    /// <summary>
    /// Response Unmarshaller for GetDataQualityModelResult operation
    /// </summary>  
    public class GetDataQualityModelResultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataQualityModelResultResponse response = new GetDataQualityModelResultResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<StatisticModelResult, StatisticModelResultUnmarshaller>(StatisticModelResultUnmarshaller.Instance);
        ...
        private static GetDataQualityModelResultResponseUnmarshaller _instance = new GetDataQualityModelResultResponseUnmarshaller();        

        internal static GetDataQualityModelResultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataQualityModelResultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
