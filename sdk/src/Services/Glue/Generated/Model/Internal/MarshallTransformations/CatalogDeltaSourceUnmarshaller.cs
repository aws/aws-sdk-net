...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CatalogDeltaSourceUnmarshaller : IJsonUnmarshaller<CatalogDeltaSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CatalogDeltaSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AdditionalDeltaOptions", targetDepth, ref reader))
                {
