...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JDBCConnectorSourceUnmarshaller : IJsonUnmarshaller<JDBCConnectorSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JDBCConnectorSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AdditionalOptions", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ConnectionTable", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ConnectionTable = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
