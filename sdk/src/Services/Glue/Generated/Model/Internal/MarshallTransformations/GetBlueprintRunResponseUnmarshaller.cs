...
{
    /// <summary>
    /// Response Unmarshaller for GetBlueprintRun operation
    /// </summary>  
    public class GetBlueprintRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBlueprintRunResponse response = new GetBlueprintRunResponse();
            ...
            {
                if (context.TestExpression("BlueprintRun", targetDepth, ref reader))
                {
                    var unmarshaller = BlueprintRunUnmarshaller.Instance;
                    response.BlueprintRun = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetBlueprintRunResponseUnmarshaller _instance = new GetBlueprintRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBlueprintRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
