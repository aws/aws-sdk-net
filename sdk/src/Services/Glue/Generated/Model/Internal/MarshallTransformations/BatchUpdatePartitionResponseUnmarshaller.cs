...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdatePartition operation
    /// </summary>  
    public class BatchUpdatePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUpdatePartitionResponse response = new BatchUpdatePartitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchUpdatePartitionFailureEntry, BatchUpdatePartitionFailureEntryUnmarshaller>(BatchUpdatePartitionFailureEntryUnmarshaller.Instance);
        ...
        private static BatchUpdatePartitionResponseUnmarshaller _instance = new BatchUpdatePartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdatePartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
