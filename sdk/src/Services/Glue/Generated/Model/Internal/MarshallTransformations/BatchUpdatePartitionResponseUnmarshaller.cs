    ...
    public class BatchUpdatePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchUpdatePartitionFailureEntry, BatchUpdatePartitionFailureEntryUnmarshaller>(BatchUpdatePartitionFailureEntryUnmarshaller.Instance);
