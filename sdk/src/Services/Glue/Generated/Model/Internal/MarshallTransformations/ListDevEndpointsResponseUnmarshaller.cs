...
{
    /// <summary>
    /// Response Unmarshaller for ListDevEndpoints operation
    /// </summary>  
    public class ListDevEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDevEndpointsResponse response = new ListDevEndpointsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DevEndpointNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.DevEndpointNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListDevEndpointsResponseUnmarshaller _instance = new ListDevEndpointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDevEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
