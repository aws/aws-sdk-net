...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CatalogImportStatusUnmarshaller : IUnmarshaller<CatalogImportStatus, XmlUnmarshallerContext>, IUnmarshaller<CatalogImportStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CatalogImportStatus IUnmarshaller<CatalogImportStatus, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CatalogImportStatus Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ImportCompleted", targetDepth))
                {
                    ...
                    unmarshalledObject.ImportCompleted = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ImportedBy", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ImportedBy = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ImportTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.ImportTime = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
