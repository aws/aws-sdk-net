        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AuthorizedColumns", targetDepth))
                {
                    ...
                    response.AuthorizedColumns = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CellFilters", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ColumnRowFilter, ColumnRowFilterUnmarshaller>(ColumnRowFilterUnmarshaller.Instance);
