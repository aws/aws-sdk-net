...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CatalogIcebergSourceUnmarshaller : IUnmarshaller<CatalogIcebergSource, XmlUnmarshallerContext>, IUnmarshaller<CatalogIcebergSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CatalogIcebergSource IUnmarshaller<CatalogIcebergSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CatalogIcebergSource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AdditionalIcebergOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.AdditionalIcebergOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
