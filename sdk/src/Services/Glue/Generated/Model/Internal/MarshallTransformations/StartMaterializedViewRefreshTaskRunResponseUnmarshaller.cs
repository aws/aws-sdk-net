...
{
    /// <summary>
    /// Response Unmarshaller for StartMaterializedViewRefreshTaskRun operation
    /// </summary>  
    public class StartMaterializedViewRefreshTaskRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMaterializedViewRefreshTaskRunResponse response = new StartMaterializedViewRefreshTaskRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("MaterializedViewRefreshTaskRunId", targetDepth))
                {
                    ...
                    response.MaterializedViewRefreshTaskRunId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MaterializedViewRefreshTaskRunningException"))
                {
                    return MaterializedViewRefreshTaskRunningExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static StartMaterializedViewRefreshTaskRunResponseUnmarshaller _instance = new StartMaterializedViewRefreshTaskRunResponseUnmarshaller();        

        internal static StartMaterializedViewRefreshTaskRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMaterializedViewRefreshTaskRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
