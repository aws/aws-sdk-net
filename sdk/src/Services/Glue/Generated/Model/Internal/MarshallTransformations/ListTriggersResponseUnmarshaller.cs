...
{
    /// <summary>
    /// Response Unmarshaller for ListTriggers operation
    /// </summary>  
    public class ListTriggersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTriggersResponse response = new ListTriggersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TriggerNames", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.TriggerNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTriggersResponseUnmarshaller _instance = new ListTriggersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTriggersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
