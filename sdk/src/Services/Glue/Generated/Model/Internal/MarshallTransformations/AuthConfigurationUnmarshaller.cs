...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthConfigurationUnmarshaller : IUnmarshaller<AuthConfiguration, XmlUnmarshallerContext>, IUnmarshaller<AuthConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AuthConfiguration IUnmarshaller<AuthConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AuthConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("BasicAuthenticationProperties", targetDepth))
                {
                    ...
                    unmarshalledObject.BasicAuthenticationProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CustomAuthenticationProperties", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, Property, StringUnmarshaller, PropertyUnmarshaller>(StringUnmarshaller.Instance, PropertyUnmarshaller.Instance);
                    unmarshalledObject.CustomAuthenticationProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
