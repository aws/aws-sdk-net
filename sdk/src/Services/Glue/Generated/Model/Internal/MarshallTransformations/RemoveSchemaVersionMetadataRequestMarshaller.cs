...
{
    /// <summary>
    /// RemoveSchemaVersionMetadata Request Marshaller
    /// </summary>       
    public class RemoveSchemaVersionMetadataRequestMarshaller : IMarshaller<IRequest, RemoveSchemaVersionMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveSchemaVersionMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveSchemaVersionMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.RemoveSchemaVersionMetadata";
        ...
        private static RemoveSchemaVersionMetadataRequestMarshaller _instance = new RemoveSchemaVersionMetadataRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveSchemaVersionMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
