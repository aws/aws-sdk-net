...
{
    /// <summary>
    /// Response Unmarshaller for StopSession operation
    /// </summary>  
    public class StopSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopSessionResponse response = new StopSessionResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return IllegalSessionStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static StopSessionResponseUnmarshaller _instance = new StopSessionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
