...
{
    /// <summary>
    /// Response Unmarshaller for GetDataflowGraph operation
    /// </summary>  
    public class GetDataflowGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataflowGraphResponse response = new GetDataflowGraphResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CodeGenEdge, CodeGenEdgeUnmarshaller>(CodeGenEdgeUnmarshaller.Instance);
                    response.DagEdges = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DagNodes", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<CodeGenNode, CodeGenNodeUnmarshaller>(CodeGenNodeUnmarshaller.Instance);
                    response.DagNodes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDataflowGraphResponseUnmarshaller _instance = new GetDataflowGraphResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataflowGraphResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
