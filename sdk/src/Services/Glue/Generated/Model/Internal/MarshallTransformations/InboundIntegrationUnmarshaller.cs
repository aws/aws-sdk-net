...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InboundIntegrationUnmarshaller : IUnmarshaller<InboundIntegration, XmlUnmarshallerContext>, IUnmarshaller<InboundIntegration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InboundIntegration IUnmarshaller<InboundIntegration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InboundIntegration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("IntegrationConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.IntegrationConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
