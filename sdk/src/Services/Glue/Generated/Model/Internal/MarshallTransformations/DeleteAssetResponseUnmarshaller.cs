...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAsset operation
    /// </summary>  
    public class DeleteAssetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteAssetResponseUnmarshaller _instance = new DeleteAssetResponseUnmarshaller();        

        internal static DeleteAssetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAssetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
