...
{
    /// <summary>
    /// Response Unmarshaller for ListCrawls operation
    /// </summary>  
    public class ListCrawlsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCrawlsResponse response = new ListCrawlsResponse();
            ...
            {
                if (context.TestExpression("Crawls", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<CrawlerHistory, CrawlerHistoryUnmarshaller>(CrawlerHistoryUnmarshaller.Instance);
                    response.Crawls = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCrawlsResponseUnmarshaller _instance = new ListCrawlsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCrawlsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
