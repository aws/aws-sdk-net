    ...
    public class ListCrawlsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CrawlerHistory, CrawlerHistoryUnmarshaller>(CrawlerHistoryUnmarshaller.Instance);
                    response.Crawls = unmarshaller.Unmarshall(context);
                    continue;
                }
