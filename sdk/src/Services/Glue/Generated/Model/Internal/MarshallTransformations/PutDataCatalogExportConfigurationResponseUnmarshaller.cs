...
{
    /// <summary>
    /// Response Unmarshaller for PutDataCatalogExportConfiguration operation
    /// </summary>  
    public class PutDataCatalogExportConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDataCatalogExportConfigurationResponse response = new PutDataCatalogExportConfigurationResponse();
        ...
        private static PutDataCatalogExportConfigurationResponseUnmarshaller _instance = new PutDataCatalogExportConfigurationResponseUnmarshaller();        

        internal static PutDataCatalogExportConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDataCatalogExportConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
