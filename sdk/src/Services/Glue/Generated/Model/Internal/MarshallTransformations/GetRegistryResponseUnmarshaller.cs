...
{
    /// <summary>
    /// Response Unmarshaller for GetRegistry operation
    /// </summary>  
    public class GetRegistryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRegistryResponse response = new GetRegistryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RegistryName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegistryName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetRegistryResponseUnmarshaller _instance = new GetRegistryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegistryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
