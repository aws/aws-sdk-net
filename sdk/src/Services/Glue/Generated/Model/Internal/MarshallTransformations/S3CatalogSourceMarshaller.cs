...
{
    /// <summary>
    /// S3CatalogSource Marshaller
    /// </summary>
    public class S3CatalogSourceMarshaller : IRequestMarshaller<S3CatalogSource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(S3CatalogSource requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAdditionalOptions())
            {
                ...
                var marshaller = S3SourceAdditionalOptionsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static S3CatalogSourceMarshaller Instance = new S3CatalogSourceMarshaller();
