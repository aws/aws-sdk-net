...
{
    /// <summary>
    /// Response Unmarshaller for DeleteClassifier operation
    /// </summary>  
    public class DeleteClassifierResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteClassifierResponse response = new DeleteClassifierResponse();
        ...
        private static DeleteClassifierResponseUnmarshaller _instance = new DeleteClassifierResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteClassifierResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
