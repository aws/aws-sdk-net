...
{
    /// <summary>
    /// Response Unmarshaller for GetBlueprintRuns operation
    /// </summary>  
    public class GetBlueprintRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBlueprintRunsResponse response = new GetBlueprintRunsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("BlueprintRuns", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<BlueprintRun, BlueprintRunUnmarshaller>(BlueprintRunUnmarshaller.Instance);
                    response.BlueprintRuns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetBlueprintRunsResponseUnmarshaller _instance = new GetBlueprintRunsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBlueprintRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
