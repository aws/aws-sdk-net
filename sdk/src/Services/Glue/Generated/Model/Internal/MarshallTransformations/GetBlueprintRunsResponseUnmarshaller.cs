    ...
    public class GetBlueprintRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BlueprintRun, BlueprintRunUnmarshaller>(BlueprintRunUnmarshaller.Instance);
                    response.BlueprintRuns = unmarshaller.Unmarshall(context);
                    continue;
                }
