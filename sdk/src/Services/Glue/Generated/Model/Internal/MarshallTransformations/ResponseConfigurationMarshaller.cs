    ...
    public class ResponseConfigurationMarshaller : IRequestMarshaller<ResponseConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ResponseConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetErrorPath())
            {
                context.Writer.WritePropertyName("ErrorPath");
                context.Writer.WriteStringValue(requestObject.ErrorPath);
            }

            if(requestObject.IsSetResultPath())
            {
                context.Writer.WritePropertyName("ResultPath");
                context.Writer.WriteStringValue(requestObject.ResultPath);
            }
