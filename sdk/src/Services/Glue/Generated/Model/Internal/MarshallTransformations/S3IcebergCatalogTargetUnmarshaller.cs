...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3IcebergCatalogTargetUnmarshaller : IJsonUnmarshaller<S3IcebergCatalogTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3IcebergCatalogTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AutoDataQuality", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("SchemaChangePolicy", targetDepth, ref reader))
                {
