...
{
    /// <summary>
    /// Response Unmarshaller for S3IcebergCatalogTarget Object
    /// </summary>  
    public class S3IcebergCatalogTargetUnmarshaller : IUnmarshaller<S3IcebergCatalogTarget, XmlUnmarshallerContext>, IUnmarshaller<S3IcebergCatalogTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        S3IcebergCatalogTarget IUnmarshaller<S3IcebergCatalogTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public S3IcebergCatalogTarget Unmarshall(JsonUnmarshallerContext context)
        {
            S3IcebergCatalogTarget unmarshalledObject = new S3IcebergCatalogTarget();
        ...
        private static S3IcebergCatalogTargetUnmarshaller _instance = new S3IcebergCatalogTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3IcebergCatalogTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
