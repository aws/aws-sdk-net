...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FederatedDatabaseUnmarshaller : IUnmarshaller<FederatedDatabase, XmlUnmarshallerContext>, IUnmarshaller<FederatedDatabase, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FederatedDatabase IUnmarshaller<FederatedDatabase, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FederatedDatabase Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
