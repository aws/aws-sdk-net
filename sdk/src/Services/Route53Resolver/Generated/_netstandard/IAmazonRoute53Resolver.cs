...
namespace Amazon.Route53Resolver
{
    ...
    public partial interface IAmazonRoute53Resolver : IAmazonService, IDisposable
    {
        ...
        Task<ListFirewallRuleTypesResponse> ListFirewallRuleTypesAsync(ListFirewallRuleTypesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
