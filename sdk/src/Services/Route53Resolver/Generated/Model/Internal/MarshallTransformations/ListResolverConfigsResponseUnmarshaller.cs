...
{
    /// <summary>
    /// Response Unmarshaller for ListResolverConfigs operation
    /// </summary>  
    public class ListResolverConfigsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResolverConfigsResponse response = new ListResolverConfigsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ResolverConfigs", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ResolverConfig, ResolverConfigUnmarshaller>(ResolverConfigUnmarshaller.Instance);
                    response.ResolverConfigs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListResolverConfigsResponseUnmarshaller _instance = new ListResolverConfigsResponseUnmarshaller();        

        internal static ListResolverConfigsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResolverConfigsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
