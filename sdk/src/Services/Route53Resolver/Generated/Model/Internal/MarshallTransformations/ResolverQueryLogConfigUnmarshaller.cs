...
{
    /// <summary>
    /// Response Unmarshaller for ResolverQueryLogConfig Object
    /// </summary>  
    public class ResolverQueryLogConfigUnmarshaller : IJsonUnmarshaller<ResolverQueryLogConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResolverQueryLogConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AssociationCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.AssociationCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ResolverQueryLogConfigUnmarshaller _instance = new ResolverQueryLogConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResolverQueryLogConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
