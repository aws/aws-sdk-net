...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FirewallRuleGroupAssociationUnmarshaller : IJsonUnmarshaller<FirewallRuleGroupAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FirewallRuleGroupAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MutationProtection", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MutationProtection = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
