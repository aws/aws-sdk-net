...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidNextTokenExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidNextTokenException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidNextTokenException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
