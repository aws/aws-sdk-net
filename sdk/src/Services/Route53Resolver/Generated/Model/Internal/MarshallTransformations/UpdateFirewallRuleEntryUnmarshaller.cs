...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFirewallRuleEntry Object
    /// </summary>  
    public class UpdateFirewallRuleEntryUnmarshaller : IJsonUnmarshaller<UpdateFirewallRuleEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UpdateFirewallRuleEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            UpdateFirewallRuleEntry unmarshalledObject = new UpdateFirewallRuleEntry();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FirewallThreatProtectionId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static UpdateFirewallRuleEntryUnmarshaller _instance = new UpdateFirewallRuleEntryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallRuleEntryUnmarshaller Instance
        {
            get
            {
                return _instance;
