...
{
    /// <summary>
    /// Response Unmarshaller for CreateFirewallRule operation
    /// </summary>  
    public class CreateFirewallRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("FirewallRule", targetDepth, ref reader))
                {
                    var unmarshaller = FirewallRuleUnmarshaller.Instance;
                    response.FirewallRule = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateFirewallRuleResponseUnmarshaller _instance = new CreateFirewallRuleResponseUnmarshaller();        

        internal static CreateFirewallRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFirewallRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
