...
{
    /// <summary>
    /// DeleteFirewallRuleEntry Marshaller
    /// </summary>
    public class DeleteFirewallRuleEntryMarshaller : IRequestMarshaller<DeleteFirewallRuleEntry, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DeleteFirewallRuleEntry requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetFirewallThreatProtectionId())
            {
                context.Writer.WritePropertyName("FirewallThreatProtectionId");
                context.Writer.WriteStringValue(requestObject.FirewallThreatProtectionId);
            }
        ...
        /// </summary>
        public readonly static DeleteFirewallRuleEntryMarshaller Instance = new DeleteFirewallRuleEntryMarshaller();
