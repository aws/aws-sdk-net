...
namespace Amazon.SimpleEmailV2
{
    ...
    public class PricingPlan : ConstantClass
    {
        ...
        /// <summary>
        /// Constant ENTERPRISE for PricingPlan
        /// </summary>
        public static readonly PricingPlan ENTERPRISE = new PricingPlan("ENTERPRISE");
        /// <summary>
        /// Constant ESSENTIALS for PricingPlan
        /// </summary>
        public static readonly PricingPlan ESSENTIALS = new PricingPlan("ESSENTIALS");
        /// <summary>
        /// Constant NONE for PricingPlan
        /// </summary>
        public static readonly PricingPlan NONE = new PricingPlan("NONE");
        /// <summary>
        /// Constant PRO for PricingPlan
        /// </summary>
        public static readonly PricingPlan PRO = new PricingPlan("PRO");
    ...
    /// <summary>
    /// Constants used for properties of type SuppressionListScope.
    /// </summary>
    public class SuppressionListScope : ConstantClass
    {

        /// <summary>
        /// Constant ACCOUNT for SuppressionListScope
        /// </summary>
        public static readonly SuppressionListScope ACCOUNT = new SuppressionListScope("ACCOUNT");
        /// <summary>
        /// Constant TENANT for SuppressionListScope
        /// </summary>
        public static readonly SuppressionListScope TENANT = new SuppressionListScope("TENANT");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public SuppressionListScope(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static SuppressionListScope FindValue(string value)
        {
            return FindValue<SuppressionListScope>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator SuppressionListScope(string value)
        {
            return FindValue(value);
        }
    }
