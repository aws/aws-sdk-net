...
namespace Amazon.SimpleEmailV2.Internal
{
    ...
    /// <para />
    /// Custom <see cref="PipelineHandler"/> responsible for resolving endpoint and setting authentication parameters for SimpleEmailServiceV2 service requests.
    /// <para />
    /// Collects values for <see cref="SimpleEmailServiceV2EndpointParameters"/> and then tries to resolve endpoint by calling
    /// <c>ResolveEndpoint</c> method on <see cref="GlobalEndpoints.Provider"/> if present, otherwise uses <see cref="AmazonSimpleEmailServiceV2EndpointProvider"/>.
    /// <para />
