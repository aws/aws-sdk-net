...
namespace Amazon.SimpleEmailV2
{
    ...
    public partial interface IAmazonSimpleEmailServiceV2 : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/GetEmailAddressInsights">REST API Reference for GetEmailAddressInsights Operation</seealso>
        Task<GetEmailAddressInsightsResponse> GetEmailAddressInsightsAsync(GetEmailAddressInsightsRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        PutAccountPricingAttributesResponse PutAccountPricingAttributes(PutAccountPricingAttributesRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/PutAccountPricingAttributes">REST API Reference for PutAccountPricingAttributes Operation</seealso>
        Task<PutAccountPricingAttributesResponse> PutAccountPricingAttributesAsync(PutAccountPricingAttributesRequest request, CancellationToken cancellationToken = default(CancellationToken));
