...
namespace Amazon.SimpleEmailV2
{
    ...
    public partial class AmazonSimpleEmailServiceV2Client : AmazonServiceClient, IAmazonSimpleEmailServiceV2
    {
        ...
        /// 
        /// </summary>
        public AmazonSimpleEmailServiceV2Client() : base(new AmazonSimpleEmailServiceV2Config()) { }
        ...
        public AmazonSimpleEmailServiceV2Client(RegionEndpoint region) : base(new AmazonSimpleEmailServiceV2Config { RegionEndpoint = region }) { }
        ...
        public AmazonSimpleEmailServiceV2Client(AmazonSimpleEmailServiceV2Config config) : base(config) { }
...
#else
        internal virtual AssociateEmailIdentityCertificateResponse AssociateEmailIdentityCertificate(AssociateEmailIdentityCertificateRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = AssociateEmailIdentityCertificateRequestMarshaller.Instance;
            options.ResponseUnmarshaller = AssociateEmailIdentityCertificateResponseUnmarshaller.Instance;
...
#else
        internal virtual DisassociateEmailIdentityCertificateResponse DisassociateEmailIdentityCertificate(DisassociateEmailIdentityCertificateRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = DisassociateEmailIdentityCertificateRequestMarshaller.Instance;
            options.ResponseUnmarshaller = DisassociateEmailIdentityCertificateResponseUnmarshaller.Instance;
...
#else
        internal virtual ListEmailIdentityCertificatesResponse ListEmailIdentityCertificates(ListEmailIdentityCertificatesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = ListEmailIdentityCertificatesRequestMarshaller.Instance;
            options.ResponseUnmarshaller = ListEmailIdentityCertificatesResponseUnmarshaller.Instance;
...
#else
        internal virtual PutAccountPricingAttributesResponse PutAccountPricingAttributes(PutAccountPricingAttributesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = PutAccountPricingAttributesRequestMarshaller.Instance;
            options.ResponseUnmarshaller = PutAccountPricingAttributesResponseUnmarshaller.Instance;
...
#else
        internal virtual PutTenantSuppressionAttributesResponse PutTenantSuppressionAttributes(PutTenantSuppressionAttributesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = PutTenantSuppressionAttributesRequestMarshaller.Instance;
            options.ResponseUnmarshaller = PutTenantSuppressionAttributesResponseUnmarshaller.Instance;
...
#else
        internal virtual UpdateConfigurationSetResponse UpdateConfigurationSet(UpdateConfigurationSetRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
            options.RequestMarshaller = UpdateConfigurationSetRequestMarshaller.Instance;
            options.ResponseUnmarshaller = UpdateConfigurationSetResponseUnmarshaller.Instance;
