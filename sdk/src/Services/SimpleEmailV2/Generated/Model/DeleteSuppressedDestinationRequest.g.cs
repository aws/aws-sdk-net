...
{
    /// <summary>
    /// Container for the parameters to the DeleteSuppressedDestination operation. Removes
    /// an email address from the suppression list for your account or for a specific tenant.
    /// To target a tenant's suppression list, specify the <c>TenantName</c> parameter. If
    /// you omit <c>TenantName</c>, the address is removed from the account-level suppression
    /// list.
    /// </summary>
