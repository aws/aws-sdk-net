...
{
    /// <summary>
    /// Container for the parameters to the PutTenantSuppressionAttributes operation. Configure
    /// the suppression list preferences for a tenant. Use this operation to enable or disable
    /// tenant-level suppression, or to change the suppressed reasons for a tenant. <para>
    ...
    /// uses the account-level suppression list. </para>
    /// </summary>
