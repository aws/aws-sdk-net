...
{
    /// <summary>
    /// Container for the parameters to the PutSuppressedDestination operation. Adds an email
    /// address to the suppression list for your account or for a specific tenant. To target
    /// a tenant's suppression list, specify the <c>TenantName</c> parameter. If you omit
    /// <c>TenantName</c>, the address is added to the account-level suppression list.
    /// </summary>
