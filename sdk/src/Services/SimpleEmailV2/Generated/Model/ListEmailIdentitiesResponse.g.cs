...
{
    /// <summary>
    /// This is the response object from the ListEmailIdentities operation.
    /// </summary>
    public partial class ListEmailIdentitiesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<IdentityInfo> EmailIdentities { get; set; } = AWSConfigs.InitializeCollections ? new List<IdentityInfo>() : null;

        /// <summary>
        /// Checks to see if the EmailIdentities property is set.
        /// </summary>
        internal bool IsSetEmailIdentities() => this.EmailIdentities != null && (this.EmailIdentities.Count > 0 || !AWSConfigs.InitializeCollections);
