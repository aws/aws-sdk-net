...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class TrackingConfigurationOverrides
    {
        ...
        ///  </note>
        /// </summary>
        public FeatureStatus ClickTrackingEnabled { get; set; }

        /// <summary>
        /// Checks to see if the ClickTrackingEnabled property is set.
        /// </summary>
        internal bool IsSetClickTrackingEnabled() => this.ClickTrackingEnabled != null;
        ...
        /// </para>
        /// </summary>
        public FeatureStatus OpenTrackingEnabled { get; set; }

        /// <summary>
        /// Checks to see if the OpenTrackingEnabled property is set.
        /// </summary>
        internal bool IsSetOpenTrackingEnabled() => this.OpenTrackingEnabled != null;
    }
}
