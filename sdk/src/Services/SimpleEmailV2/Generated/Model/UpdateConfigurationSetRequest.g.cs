...
{
    /// <summary>
    /// Container for the parameters to the UpdateConfigurationSet operation. Updates an existing
    /// configuration set. <para> This operation performs a partial update. Only the attributes
    /// that you include in the request are updated; any omitted attribute is left unchanged.
    /// </para>
    /// </summary>
