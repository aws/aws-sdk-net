...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    /// can use the Amazon SES API v2 to send the following types of messages: <ul> <li> <para>
    ...
    /// </para> </li> <li> <para> <b>Templated</b> – A message that contains personalization
    /// tags. When you send this type of email, Amazon SES API v2 automatically replaces the
    /// tags with values that you specify. </para> </li> </ul>
    /// </summary>
    public partial class SendEmailRequest : AmazonSimpleEmailServiceV2Request
    {
        ...
        /// <summary>
        /// Checks to see if the ListManagementOptions property is set.
        /// </summary>
        internal bool IsSetListManagementOptions() => this.ListManagementOptions != null;
