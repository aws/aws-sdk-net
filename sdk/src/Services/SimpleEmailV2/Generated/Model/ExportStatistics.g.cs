...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class ExportStatistics
    {
        ...
        /// </para>
        /// </summary>
        public int? ExportedRecordsCount { get; set; }

        /// <summary>
        /// Checks to see if the ExportedRecordsCount property is set.
        /// </summary>
        internal bool IsSetExportedRecordsCount() => this.ExportedRecordsCount.HasValue;
