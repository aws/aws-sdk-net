...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class VerificationInfo
    {
        ...
        ///  </li> </ul>
        /// </summary>
        public VerificationError ErrorType { get; set; }
        ...
        /// <summary>
        /// Checks to see if the LastSuccessTimestamp property is set.
        /// </summary>
        internal bool IsSetLastSuccessTimestamp() => this.LastSuccessTimestamp.HasValue;
        ...
        /// <summary>
        /// Checks to see if the SOARecord property is set.
        /// </summary>
        internal bool IsSetSOARecord() => this.SOARecord != null;
    }
}
