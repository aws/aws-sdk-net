...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class ContactListDestination
    {
        ...
        public ContactListImportAction ContactListImportAction { get; set; }

        /// <summary>
        /// Checks to see if the ContactListImportAction property is set.
        /// </summary>
        internal bool IsSetContactListImportAction() => this.ContactListImportAction != null;
