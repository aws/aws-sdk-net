...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetAccountResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DedicatedIpAutoWarmupEnabled", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DedicatedIpAutoWarmupEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("EnforcementStatus", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EnforcementStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("PricingAttributes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.PricingAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.ProductionAccessEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SendQuota", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SendQuota = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("VdmAttributes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VdmAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetAccountResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetAccountResponseUnmarshaller Instance => _instance;
    }
}
