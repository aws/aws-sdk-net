...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactList operation
    /// </summary>  
    public class DeleteContactListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactListResponse response = new DeleteContactListResponse();
        ...
        private static DeleteContactListResponseUnmarshaller _instance = new DeleteContactListResponseUnmarshaller();        

        internal static DeleteContactListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
