...
{
    /// <summary>
    /// Response Unmarshaller for GetMultiRegionEndpoint operation
    /// </summary>  
    public class GetMultiRegionEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMultiRegionEndpointResponse response = new GetMultiRegionEndpointResponse();
        ...
        private static GetMultiRegionEndpointResponseUnmarshaller _instance = new GetMultiRegionEndpointResponseUnmarshaller();        

        internal static GetMultiRegionEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMultiRegionEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
