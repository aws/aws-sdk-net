...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateConfigurationSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConfigurationSetResponse response = new CreateConfigurationSetResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigurationSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
