...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateEmailIdentityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateEmailIdentityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DkimAttributes", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DkimAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("VerifiedForSendingStatus", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VerifiedForSendingStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateEmailIdentityResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateEmailIdentityResponseUnmarshaller Instance => _instance;
    }
}
