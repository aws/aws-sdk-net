...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteEmailIdentityRequestMarshaller : IMarshaller<IRequest, DeleteEmailIdentityRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteEmailIdentityRequestMarshaller _instance = new();

        internal static DeleteEmailIdentityRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteEmailIdentityRequestMarshaller Instance => _instance;
    }
}
