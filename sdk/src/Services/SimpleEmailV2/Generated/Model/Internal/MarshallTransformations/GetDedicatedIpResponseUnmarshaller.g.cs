...
{
    /// <summary>
    /// Response Unmarshaller for GetDedicatedIp operation.
    /// </summary>
    public partial class GetDedicatedIpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetDedicatedIpResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DedicatedIp", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DedicatedIp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDedicatedIpResponseUnmarshaller _instance = new GetDedicatedIpResponseUnmarshaller();

        internal static GetDedicatedIpResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDedicatedIpResponseUnmarshaller Instance => _instance;
    }
}
