...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateConfigurationSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationSetResponse response = new UpdateConfigurationSetResponse();
        ...
        internal static UpdateConfigurationSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
