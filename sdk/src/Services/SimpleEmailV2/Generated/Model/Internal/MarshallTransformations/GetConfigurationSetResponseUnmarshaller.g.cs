...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetConfigurationSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetConfigurationSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ArchivingOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ArchivingOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("DeliveryOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.DeliveryOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("MessageSecurityOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.MessageSecurityOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ReputationOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ReputationOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SendingOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SendingOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SuppressionOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SuppressionOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TrackingOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.TrackingOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("VdmOptions", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.VdmOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetConfigurationSetResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetConfigurationSetResponseUnmarshaller Instance => _instance;
    }
}
