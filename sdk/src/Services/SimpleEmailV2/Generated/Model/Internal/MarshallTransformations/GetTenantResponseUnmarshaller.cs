...
{
    /// <summary>
    /// Response Unmarshaller for GetTenant operation
    /// </summary>  
    public class GetTenantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Tenant", targetDepth, ref reader))
                {
                    ...
                    response.Tenant = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTenantResponseUnmarshaller _instance = new GetTenantResponseUnmarshaller();        

        internal static GetTenantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTenantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
