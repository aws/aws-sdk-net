...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    public class DomainDeliverabilityTrackingOptionUnmarshaller : IJsonUnmarshaller<DomainDeliverabilityTrackingOption, JsonUnmarshallerContext>
    {
        ...
        private static DomainDeliverabilityTrackingOptionUnmarshaller _instance = new DomainDeliverabilityTrackingOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DomainDeliverabilityTrackingOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
