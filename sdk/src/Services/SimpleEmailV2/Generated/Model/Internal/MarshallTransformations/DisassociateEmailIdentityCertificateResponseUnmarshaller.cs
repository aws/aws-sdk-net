...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateEmailIdentityCertificate operation
    /// </summary>  
    public class DisassociateEmailIdentityCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateEmailIdentityCertificateResponse response = new DisassociateEmailIdentityCertificateResponse();
        ...
        private static DisassociateEmailIdentityCertificateResponseUnmarshaller _instance = new DisassociateEmailIdentityCertificateResponseUnmarshaller();        

        internal static DisassociateEmailIdentityCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateEmailIdentityCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
