...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExportJobSummaryUnmarshaller : IUnmarshaller<ExportJobSummary, XmlUnmarshallerContext>, IUnmarshaller<ExportJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ExportJobSummary IUnmarshaller<ExportJobSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ExportJobSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ExportSourceType", targetDepth))
                {
                    ...
                    unmarshalledObject.ExportSourceType = unmarshaller.Unmarshall(context);
                    continue;
                }
