...
{
    /// <summary>
    /// Response Unmarshaller for GetMessageInsights operation.
    /// </summary>
    public partial class GetMessageInsightsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetMessageInsightsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EmailTags", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.EmailTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetMessageInsightsResponseUnmarshaller _instance = new GetMessageInsightsResponseUnmarshaller();

        internal static GetMessageInsightsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetMessageInsightsResponseUnmarshaller Instance => _instance;
    }
}
