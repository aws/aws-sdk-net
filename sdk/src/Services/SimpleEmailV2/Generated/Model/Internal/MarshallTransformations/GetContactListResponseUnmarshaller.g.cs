...
{
    /// <summary>
    /// Response Unmarshaller for GetContactList operation.
    /// </summary>
    public partial class GetContactListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetContactListResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContactListName", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ContactListName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Topic, TopicUnmarshaller>(TopicUnmarshaller.Instance);
        ...
        private static GetContactListResponseUnmarshaller _instance = new GetContactListResponseUnmarshaller();

        internal static GetContactListResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetContactListResponseUnmarshaller Instance => _instance;
    }
}
