...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContact operation
    /// </summary>  
    public class DeleteContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteContactResponseUnmarshaller _instance = new DeleteContactResponseUnmarshaller();        

        internal static DeleteContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
