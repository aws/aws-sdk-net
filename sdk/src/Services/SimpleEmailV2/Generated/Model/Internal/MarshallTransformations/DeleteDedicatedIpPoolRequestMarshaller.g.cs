...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteDedicatedIpPoolRequestMarshaller : IMarshaller<IRequest, DeleteDedicatedIpPoolRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteDedicatedIpPoolRequestMarshaller _instance = new();

        internal static DeleteDedicatedIpPoolRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteDedicatedIpPoolRequestMarshaller Instance => _instance;
    }
}
