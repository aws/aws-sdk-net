...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEmailTemplateRequestMarshaller : IMarshaller<IRequest, GetEmailTemplateRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetEmailTemplateRequestMarshaller _instance = new();

        internal static GetEmailTemplateRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEmailTemplateRequestMarshaller Instance => _instance;
    }
}
