...
{
    /// <summary>
    /// MessageInsightsDataSource Marshaller
    /// </summary>
    public partial class MessageInsightsDataSourceMarshaller : IRequestMarshaller<MessageInsightsDataSource, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(MessageInsightsDataSource requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetStartDate())
            {
                ...
                context.Writer.WriteNumberValue(Amazon.Util.AWSSDKUtils.ConvertToUnixEpochSecondsDecimal(requestObject.StartDate.Value));
            }
        }
        ...
        /// </summary>
        public readonly static MessageInsightsDataSourceMarshaller Instance = new MessageInsightsDataSourceMarshaller();
    }
}
