...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetContactResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AttributesData", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AttributesData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetContactResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetContactResponseUnmarshaller Instance => _instance;
    }
}
