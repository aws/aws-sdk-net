...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDeliverabilityDashboardOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeliverabilityDashboardOptionsResponse response = new GetDeliverabilityDashboardOptionsResponse();
        ...
        internal static GetDeliverabilityDashboardOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeliverabilityDashboardOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
