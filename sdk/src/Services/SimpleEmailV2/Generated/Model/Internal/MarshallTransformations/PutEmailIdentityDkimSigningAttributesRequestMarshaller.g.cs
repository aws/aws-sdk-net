...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutEmailIdentityDkimSigningAttributesRequestMarshaller : IMarshaller<IRequest, PutEmailIdentityDkimSigningAttributesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutEmailIdentityDkimSigningAttributesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetSigningAttributesOrigin())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SigningAttributesOrigin);
            }
        ...
        private static readonly PutEmailIdentityDkimSigningAttributesRequestMarshaller _instance = new();

        internal static PutEmailIdentityDkimSigningAttributesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutEmailIdentityDkimSigningAttributesRequestMarshaller Instance => _instance;
    }
}
