...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TopicPreferenceMarshaller : IRequestMarshaller<TopicPreference, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(TopicPreference requestObject, JsonMarshallerContext context)
        {
            if (requestObject == null) return;

            if (requestObject.IsSetSubscriptionStatus())
            {
                context.Writer.WritePropertyName("SubscriptionStatus");
                context.Writer.WriteStringValue(requestObject.SubscriptionStatus);
            }
