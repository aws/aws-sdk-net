...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateEmailIdentityCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateEmailIdentityCertificateResponse response = new AssociateEmailIdentityCertificateResponse();
        ...
        internal static AssociateEmailIdentityCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateEmailIdentityCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
