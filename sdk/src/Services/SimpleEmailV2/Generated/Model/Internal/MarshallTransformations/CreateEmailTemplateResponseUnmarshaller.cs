...
{
    /// <summary>
    /// Response Unmarshaller for CreateEmailTemplate operation
    /// </summary>  
    public class CreateEmailTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEmailTemplateResponse response = new CreateEmailTemplateResponse();
        ...
        private static CreateEmailTemplateResponseUnmarshaller _instance = new CreateEmailTemplateResponseUnmarshaller();        

        internal static CreateEmailTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEmailTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
