...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetMetricData operation.
    /// </summary>
    public partial class BatchGetMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchGetMetricDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MetricDataError, MetricDataErrorUnmarshaller>(MetricDataErrorUnmarshaller.Instance);
        ...
        private static BatchGetMetricDataResponseUnmarshaller _instance = new BatchGetMetricDataResponseUnmarshaller();

        internal static BatchGetMetricDataResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchGetMetricDataResponseUnmarshaller Instance => _instance;
    }
}
