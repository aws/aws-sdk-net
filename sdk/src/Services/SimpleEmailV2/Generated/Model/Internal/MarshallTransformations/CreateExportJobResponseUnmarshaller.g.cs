...
{
    /// <summary>
    /// Response Unmarshaller for CreateExportJob operation.
    /// </summary>
    public partial class CreateExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateExportJobResponse();
        ...
        private static CreateExportJobResponseUnmarshaller _instance = new CreateExportJobResponseUnmarshaller();

        internal static CreateExportJobResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateExportJobResponseUnmarshaller Instance => _instance;
    }
}
