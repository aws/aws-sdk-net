...
{
    /// <summary>
    /// Response Unmarshaller for GetImportJob operation.
    /// </summary>
    public partial class GetImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FailedRecordsCount", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ImportDataSource", targetDepth, ref reader))
                {
                    var unmarshaller = ImportDataSourceUnmarshaller.Instance;
                    unmarshalledObject.ImportDataSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("ImportDestination", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ProcessedRecordsCount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        private static GetImportJobResponseUnmarshaller _instance = new GetImportJobResponseUnmarshaller();

        internal static GetImportJobResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetImportJobResponseUnmarshaller Instance => _instance;
    }
}
