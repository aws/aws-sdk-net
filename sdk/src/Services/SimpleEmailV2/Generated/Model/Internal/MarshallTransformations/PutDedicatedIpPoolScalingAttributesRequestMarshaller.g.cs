...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutDedicatedIpPoolScalingAttributesRequestMarshaller : IMarshaller<IRequest, PutDedicatedIpPoolScalingAttributesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutDedicatedIpPoolScalingAttributesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetScalingMode())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ScalingMode);
            }
        ...
        private static readonly PutDedicatedIpPoolScalingAttributesRequestMarshaller _instance = new();

        internal static PutDedicatedIpPoolScalingAttributesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutDedicatedIpPoolScalingAttributesRequestMarshaller Instance => _instance;
    }
}
