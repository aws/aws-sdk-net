...
{
    /// <summary>
    /// Response Unmarshaller for ListContactLists operation
    /// </summary>  
    public class ListContactListsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ContactLists", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ContactList, ContactListUnmarshaller>(ContactListUnmarshaller.Instance);
                    response.ContactLists = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListContactListsResponseUnmarshaller _instance = new ListContactListsResponseUnmarshaller();        

        internal static ListContactListsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContactListsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
