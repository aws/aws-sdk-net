...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReputationOptionsMarshaller : IRequestMarshaller<ReputationOptions, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ReputationOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetLastFreshStart())
            {
                ...
                context.Writer.WriteNumberValue(Amazon.Util.AWSSDKUtils.ConvertToUnixEpochSecondsDecimal(requestObject.LastFreshStart.Value));
            }
