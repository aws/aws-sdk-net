        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SendingStatus", targetDepth))
                {
                    ...
                    response.SendingStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TenantArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TenantId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TenantId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TenantName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TenantName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
