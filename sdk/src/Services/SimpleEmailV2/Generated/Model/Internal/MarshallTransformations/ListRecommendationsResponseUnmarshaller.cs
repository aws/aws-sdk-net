...
{
    /// <summary>
    /// Response Unmarshaller for ListRecommendations operation
    /// </summary>  
    public class ListRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRecommendationsResponse response = new ListRecommendationsResponse();
        ...
        private static ListRecommendationsResponseUnmarshaller _instance = new ListRecommendationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
