...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListManagementOptionsMarshaller : IRequestMarshaller<ListManagementOptions, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ListManagementOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetContactListName())
            {
                ...
                context.Writer.WriteStringValue(requestObject.ContactListName);
            }
