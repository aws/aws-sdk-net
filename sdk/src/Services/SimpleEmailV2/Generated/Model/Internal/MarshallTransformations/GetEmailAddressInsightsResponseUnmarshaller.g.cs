...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetEmailAddressInsightsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetEmailAddressInsightsResponse();
            ...
            {
                if (context.TestExpression("MailboxValidation", targetDepth, ref reader))
                {
                    var unmarshaller = MailboxValidationUnmarshaller.Instance;
                    unmarshalledObject.MailboxValidation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetEmailAddressInsightsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetEmailAddressInsightsResponseUnmarshaller Instance => _instance;
    }
}
