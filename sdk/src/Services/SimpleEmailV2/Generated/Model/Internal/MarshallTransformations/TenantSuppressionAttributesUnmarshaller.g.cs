...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TenantSuppressionAttributesUnmarshaller : IJsonUnmarshaller<TenantSuppressionAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TenantSuppressionAttributes();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SuppressionScope", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static TenantSuppressionAttributesUnmarshaller Instance => _instance;
    }
}
