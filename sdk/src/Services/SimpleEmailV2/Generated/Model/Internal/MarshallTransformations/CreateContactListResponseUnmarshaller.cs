...
{
    /// <summary>
    /// Response Unmarshaller for CreateContactList operation
    /// </summary>  
    public class CreateContactListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateContactListResponseUnmarshaller _instance = new CreateContactListResponseUnmarshaller();        

        internal static CreateContactListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContactListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
