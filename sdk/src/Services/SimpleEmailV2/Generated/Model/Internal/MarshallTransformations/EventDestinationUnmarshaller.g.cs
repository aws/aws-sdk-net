...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EventDestinationUnmarshaller : IJsonUnmarshaller<EventDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EventDestination();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EventBridgeDestination", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static EventDestinationUnmarshaller Instance => _instance;
    }
}
