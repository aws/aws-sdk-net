...
{
    /// <summary>
    /// Response Unmarshaller for GetEmailIdentityPolicies operation
    /// </summary>  
    public class GetEmailIdentityPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEmailIdentityPoliciesResponse response = new GetEmailIdentityPoliciesResponse();
        ...
        private static GetEmailIdentityPoliciesResponseUnmarshaller _instance = new GetEmailIdentityPoliciesResponseUnmarshaller();        

        internal static GetEmailIdentityPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEmailIdentityPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
