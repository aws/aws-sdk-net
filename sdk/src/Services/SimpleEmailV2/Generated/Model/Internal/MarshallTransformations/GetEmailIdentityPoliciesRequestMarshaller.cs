...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetEmailIdentityPoliciesRequestMarshaller : IMarshaller<IRequest, GetEmailIdentityPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetEmailIdentityPoliciesRequestMarshaller _instance = new GetEmailIdentityPoliciesRequestMarshaller();        

        internal static GetEmailIdentityPoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEmailIdentityPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
