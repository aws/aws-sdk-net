...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetBlacklistReportsRequestMarshaller : IMarshaller<IRequest, GetBlacklistReportsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetBlacklistReportsRequestMarshaller _instance = new();

        internal static GetBlacklistReportsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetBlacklistReportsRequestMarshaller Instance => _instance;
    }
}
