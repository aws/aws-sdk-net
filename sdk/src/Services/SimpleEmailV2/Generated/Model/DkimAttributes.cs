...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class DkimAttributes
    {
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <code>PENDING</code> – Amazon SES hasn't yet detected the DKIM records in the DNS
        /// configuration for the domain, but will continue to attempt to locate them.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <code>SUCCESS</code> – Amazon SES located the DKIM records in the DNS configuration
        /// for the domain and determined that they're correct. You can now send DKIM-signed email
        /// from the identity.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <code>FAILED</code> – Amazon SES wasn't able to locate the DKIM records in the DNS
        ...
        ///  </li> <li> 
        /// <para>
        ///  <code>NOT_STARTED</code> – Amazon SES hasn't yet started searching for the DKIM records
        ...
        /// Amazon SES usually detects these records within about 72 hours of adding them to the
