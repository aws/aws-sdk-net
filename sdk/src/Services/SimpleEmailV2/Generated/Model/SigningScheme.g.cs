...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class SigningScheme
    {
        ...
        /// </para>
        /// </summary>
        public DefaultSigningScheme DefaultScheme { get; set; }

        /// <summary>
        /// Checks to see if the DefaultScheme property is set.
        /// </summary>
        internal bool IsSetDefaultScheme() => this.DefaultScheme != null;
        ...
        /// </para>
        /// </summary>
        public SmimeSigningScheme SmimeScheme { get; set; }

        /// <summary>
        /// Checks to see if the SmimeScheme property is set.
        /// </summary>
        internal bool IsSetSmimeScheme() => this.SmimeScheme != null;
    }
}
