...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    /// You can use this operation to do any of the following: <ul> <li> <para> Update the
    /// signing attributes for an identity that uses Bring Your Own DKIM (BYODKIM). </para>
    /// </li> <li> <para> Update the key length that should be used for Easy DKIM. </para>
    /// </li> <li> <para> Change from using no DKIM authentication to using Easy DKIM. </para>
    /// </li> <li> <para> Change from using no DKIM authentication to using BYODKIM. </para>
    /// </li> <li> <para> Change from using Easy DKIM to using BYODKIM. </para> </li> <li>
    /// <para> Change from using BYODKIM to using Easy DKIM. </para> </li> </ul>
    /// </summary>
    public partial class PutEmailIdentityDkimSigningAttributesRequest : AmazonSimpleEmailServiceV2Request
    {
        ...
        /// <summary>
        /// Checks to see if the SigningAttributes property is set.
        /// </summary>
        internal bool IsSetSigningAttributes() => this.SigningAttributes != null;
