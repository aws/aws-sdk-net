...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    /// contains the content that you plan to send to your customers. Amazon SES then sends
    /// that message to special email addresses spread across several major email providers.
