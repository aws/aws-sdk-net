...
{
    /// <summary>
    /// Container for the parameters to the PutAccountSuppressionAttributes operation. Change
    ...
    public partial class PutAccountSuppressionAttributesRequest : AmazonSimpleEmailServiceV2Request
    {
        ...
        /// </para>
        /// </summary>
        public SuppressionValidationAttributes ValidationAttributes { get; set; }

        /// <summary>
        /// Checks to see if the ValidationAttributes property is set.
        /// </summary>
        internal bool IsSetValidationAttributes() => this.ValidationAttributes != null;
    }
}
