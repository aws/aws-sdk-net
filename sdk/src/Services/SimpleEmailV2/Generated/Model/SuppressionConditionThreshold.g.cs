...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class SuppressionConditionThreshold
    {
        ...
        public FeatureStatus ConditionThresholdEnabled { get; set; }

        /// <summary>
        /// Checks to see if the ConditionThresholdEnabled property is set.
        /// </summary>
        internal bool IsSetConditionThresholdEnabled() => this.ConditionThresholdEnabled != null;
        ...
        /// </para>
        /// </summary>
        public SuppressionConfidenceThreshold OverallConfidenceThreshold { get; set; }

        /// <summary>
        /// Checks to see if the OverallConfidenceThreshold property is set.
        /// </summary>
        internal bool IsSetOverallConfidenceThreshold() => this.OverallConfidenceThreshold != null;
    }
}
