...
{
    /// <summary>
    /// Container for the parameters to the GetTenant operation. Get information about a specific
    /// tenant, including the tenant's name, ID, ARN, creation timestamp, tags, sending status,
