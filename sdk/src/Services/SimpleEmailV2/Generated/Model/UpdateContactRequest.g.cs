...
{
    /// <summary>
    /// Container for the parameters to the UpdateContact operation. Updates a contact's preferences
    /// for a list. <note> <para> You must specify all existing topic preferences in the <c>TopicPreferences</c>
    /// object, not just the ones that need updating; otherwise, all your existing preferences
    /// will be removed. </para> </note>
    /// </summary>
