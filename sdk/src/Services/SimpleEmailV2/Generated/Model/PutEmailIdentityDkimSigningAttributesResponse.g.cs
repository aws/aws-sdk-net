...
{
    /// <summary>
    /// This is the response object from the PutEmailIdentityDkimSigningAttributes operation.
    /// </summary>
    public partial class PutEmailIdentityDkimSigningAttributesResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Checks to see if the DkimStatus property is set.
        /// </summary>
        internal bool IsSetDkimStatus() => this.DkimStatus != null;
        ...
        /// </summary>
        public List<string> DkimTokens { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the DkimTokens property is set.
        /// </summary>
        internal bool IsSetDkimTokens() => this.DkimTokens != null && (this.DkimTokens.Count > 0 || !AWSConfigs.InitializeCollections);
