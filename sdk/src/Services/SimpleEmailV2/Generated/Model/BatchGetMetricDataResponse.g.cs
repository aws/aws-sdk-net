...
{
    /// <summary>
    /// This is the response object from the BatchGetMetricData operation.
    /// </summary>
    public partial class BatchGetMetricDataResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<MetricDataError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<MetricDataError>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<MetricDataResult> Results { get; set; } = AWSConfigs.InitializeCollections ? new List<MetricDataResult>() : null;
