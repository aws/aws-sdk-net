...
{
    /// <summary>
    /// This is the response object from the ListTenantResources operation.
    /// </summary>
    public partial class ListTenantResourcesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<TenantResource> TenantResources { get; set; } = AWSConfigs.InitializeCollections ? new List<TenantResource>() : null;

        /// <summary>
        /// Checks to see if the TenantResources property is set.
        /// </summary>
        internal bool IsSetTenantResources() => this.TenantResources != null && (this.TenantResources.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
