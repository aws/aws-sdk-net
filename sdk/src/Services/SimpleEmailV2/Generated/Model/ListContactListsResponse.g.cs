...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class ListContactListsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ContactList> ContactLists { get; set; } = AWSConfigs.InitializeCollections ? new List<ContactList>() : null;

        /// <summary>
        /// Checks to see if the ContactLists property is set.
        /// </summary>
        internal bool IsSetContactLists() => this.ContactLists != null && (this.ContactLists.Count > 0 || !AWSConfigs.InitializeCollections);
