...
{
    /// <summary>
    /// Container for the parameters to the DeleteEmailIdentityPolicy operation. Deletes the
    /// specified sending authorization policy for the given identity (an email address or
    /// a domain). This API returns successfully even if a policy with the specified name
    /// does not exist. <note> <para> This API is for the identity owner only. If you have
    /// not verified the identity, this API will return an error. </para> </note> <para> Sending
