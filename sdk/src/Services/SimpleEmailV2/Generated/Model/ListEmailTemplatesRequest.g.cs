...
{
    /// <summary>
    /// Container for the parameters to the ListEmailTemplates operation. Lists the email
    /// templates present in your Amazon SES account in the current Amazon Web Services Region.
    /// <para> You can execute this operation no more than once per second. </para>
    /// </summary>
