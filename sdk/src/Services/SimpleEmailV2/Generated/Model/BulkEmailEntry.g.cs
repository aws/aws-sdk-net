...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class BulkEmailEntry
    {
        ...
        /// <summary>
        /// Checks to see if the ReplacementEmailContent property is set.
        /// </summary>
        internal bool IsSetReplacementEmailContent() => this.ReplacementEmailContent != null;
        ...
        public List<MessageHeader> ReplacementHeaders { get; set; } = AWSConfigs.InitializeCollections ? new List<MessageHeader>() : null;

        /// <summary>
        /// Checks to see if the ReplacementHeaders property is set.
        /// </summary>
        internal bool IsSetReplacementHeaders() => this.ReplacementHeaders != null && (this.ReplacementHeaders.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<MessageTag> ReplacementTags { get; set; } = AWSConfigs.InitializeCollections ? new List<MessageTag>() : null;

        /// <summary>
        /// Checks to see if the ReplacementTags property is set.
        /// </summary>
        internal bool IsSetReplacementTags() => this.ReplacementTags != null && (this.ReplacementTags.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
