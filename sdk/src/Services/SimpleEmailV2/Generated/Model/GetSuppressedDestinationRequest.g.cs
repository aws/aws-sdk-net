...
{
    /// <summary>
    /// Container for the parameters to the GetSuppressedDestination operation. Retrieves
    /// information about a specific email address that's on the suppression list for your
    /// account or for a specific tenant. To target a tenant's suppression list, specify the
    /// <c>TenantName</c> parameter. If you omit <c>TenantName</c>, the operation targets
