...
{
    /// <summary>
    /// This is the response object from the ListMultiRegionEndpoints operation.
    /// </summary>
    public partial class ListMultiRegionEndpointsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<MultiRegionEndpoint> MultiRegionEndpoints { get; set; } = AWSConfigs.InitializeCollections ? new List<MultiRegionEndpoint>() : null;

        /// <summary>
        /// Checks to see if the MultiRegionEndpoints property is set.
        /// </summary>
        internal bool IsSetMultiRegionEndpoints() => this.MultiRegionEndpoints != null && (this.MultiRegionEndpoints.Count > 0 || !AWSConfigs.InitializeCollections);
