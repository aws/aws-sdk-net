...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class SOARecord
    {
        ...
        /// <summary>
        /// Checks to see if the AdminEmail property is set.
        /// </summary>
        internal bool IsSetAdminEmail() => this.AdminEmail != null;
        ...
        /// <summary>
        /// Checks to see if the PrimaryNameServer property is set.
        /// </summary>
        internal bool IsSetPrimaryNameServer() => this.PrimaryNameServer != null;
        ...
        /// </summary>
        internal bool IsSetSerialNumber() => this.SerialNumber.HasValue;
    }
}
