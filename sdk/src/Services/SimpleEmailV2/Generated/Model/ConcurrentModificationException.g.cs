...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    [Serializable]
#endif
    public partial class ConcurrentModificationException : AmazonSimpleEmailServiceV2Exception
    {
        /// <summary>
        ...
        /// Construct instance of ConcurrentModificationException
        /// </summary>
        public ConcurrentModificationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ConcurrentModificationException
        /// </summary>
        public ConcurrentModificationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
