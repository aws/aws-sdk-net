...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    [Serializable]
#endif
    public partial class AccountSuspendedException : AmazonSimpleEmailServiceV2Exception
    {
        /// <summary>
        ...
        /// Construct instance of AccountSuspendedException
        /// </summary>
        public AccountSuspendedException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of AccountSuspendedException
        /// </summary>
        public AccountSuspendedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of AccountSuspendedException
        /// </summary>
        public AccountSuspendedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
