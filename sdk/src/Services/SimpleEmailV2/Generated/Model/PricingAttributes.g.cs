...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class PricingAttributes
    {
        ...
        /// <summary>
        /// Checks to see if the CurrentPlan property is set.
        /// </summary>
        internal bool IsSetCurrentPlan() => this.CurrentPlan != null;
        ...
        /// </para>
        /// </summary>
        public PricingPlan NextPlan { get; set; }

        /// <summary>
        /// Checks to see if the NextPlan property is set.
        /// </summary>
        internal bool IsSetNextPlan() => this.NextPlan != null;
    }
}
