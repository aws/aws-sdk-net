...
{
    /// <summary>
    /// Container for the parameters to the ListDeliverabilityTestReports operation. Show
    /// a list of the predictive inbox placement tests that you've performed, regardless of
    /// their statuses. For predictive inbox placement tests that are complete, you can use
    /// the <c>GetDeliverabilityTestReport</c> operation to view the results.
    /// </summary>
