...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    /// that are associated with your Amazon Web Services account. You can associate a pool
    /// with a configuration set. When you send an email that uses that configuration set,
    /// the message is sent from one of the addresses in the associated pool.
    /// </summary>
