...
namespace Amazon.SimpleEmailV2.Model
{
    ...
    public partial class InboxPlacementTrackingOption
    {
        ...
        /// </summary>
        internal bool IsSetGlobal() => this.Global.HasValue;
        ...
        /// </summary>
        public List<string> TrackedIsps { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the TrackedIsps property is set.
        /// </summary>
        internal bool IsSetTrackedIsps() => this.TrackedIsps != null && (this.TrackedIsps.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
