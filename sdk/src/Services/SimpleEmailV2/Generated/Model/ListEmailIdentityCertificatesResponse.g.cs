...
{
    /// <summary>
    /// This is the response object from the ListEmailIdentityCertificates operation.
    /// </summary>
    public partial class ListEmailIdentityCertificatesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<IdentityCertificate> Certificates { get; set; } = AWSConfigs.InitializeCollections ? new List<IdentityCertificate>() : null;
