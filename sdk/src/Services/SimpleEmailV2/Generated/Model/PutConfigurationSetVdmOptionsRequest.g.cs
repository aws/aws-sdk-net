...
{
    /// <summary>
    /// Container for the parameters to the PutConfigurationSetVdmOptions operation. Specify
    /// VDM preferences for email that you send using the configuration set. <para> You can
    /// execute this operation no more than once per second. </para>
    /// </summary>
