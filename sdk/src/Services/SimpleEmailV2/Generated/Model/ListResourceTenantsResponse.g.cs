...
{
    /// <summary>
    /// This is the response object from the ListResourceTenants operation.
    /// </summary>
    public partial class ListResourceTenantsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ResourceTenantMetadata> ResourceTenants { get; set; } = AWSConfigs.InitializeCollections ? new List<ResourceTenantMetadata>() : null;

        /// <summary>
        /// Checks to see if the ResourceTenants property is set.
        /// </summary>
        internal bool IsSetResourceTenants() => this.ResourceTenants != null && (this.ResourceTenants.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
