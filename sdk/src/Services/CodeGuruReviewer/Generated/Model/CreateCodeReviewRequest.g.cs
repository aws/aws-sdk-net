...
{
    /// <summary>
    /// Container for the parameters to the CreateCodeReview operation. Use to create a code
    /// review with a <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReviewType.html">CodeReviewType</a>
    ...
    public partial class CreateCodeReviewRequest : AmazonCodeGuruReviewerRequest
    {
        ...
        /// <summary>
        /// Checks to see if the RepositoryAssociationArn property is set.
        /// </summary>
        internal bool IsSetRepositoryAssociationArn() => this.RepositoryAssociationArn != null;
