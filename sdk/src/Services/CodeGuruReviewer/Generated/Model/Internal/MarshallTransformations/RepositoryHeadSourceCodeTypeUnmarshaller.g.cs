...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RepositoryHeadSourceCodeTypeUnmarshaller : IJsonUnmarshaller<RepositoryHeadSourceCodeType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RepositoryHeadSourceCodeType();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RepositoryHeadSourceCodeTypeUnmarshaller Instance => _instance;
    }
}
