...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RequestMetadataUnmarshaller : IJsonUnmarshaller<RequestMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RequestMetadata();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RequestMetadataUnmarshaller Instance => _instance;
    }
}
