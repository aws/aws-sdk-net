...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class S3BucketRepositoryUnmarshaller : IJsonUnmarshaller<S3BucketRepository, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new S3BucketRepository();
        ...
        /// Gets the singleton.
        /// </summary>
        public static S3BucketRepositoryUnmarshaller Instance => _instance;
    }
}
