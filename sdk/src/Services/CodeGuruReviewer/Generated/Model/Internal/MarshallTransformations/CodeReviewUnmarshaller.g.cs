...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    public partial class CodeReviewUnmarshaller : IJsonUnmarshaller<CodeReview, JsonUnmarshallerContext>
    {
        ...
        public CodeReview Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AnalysisTypes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ConfigFileState", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SourceCodeType", targetDepth, ref reader))
                {
