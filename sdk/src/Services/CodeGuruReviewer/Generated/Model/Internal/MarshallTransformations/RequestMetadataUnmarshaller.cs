...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RequestMetadataUnmarshaller : IJsonUnmarshaller<RequestMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RequestMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
