...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListRepositoryAssociationsRequestMarshaller : IMarshaller<IRequest, ListRepositoryAssociationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListRepositoryAssociationsRequestMarshaller _instance = new();

        internal static ListRepositoryAssociationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListRepositoryAssociationsRequestMarshaller Instance => _instance;
    }
}
