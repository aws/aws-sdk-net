...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositoryHeadSourceCodeTypeUnmarshaller : IJsonUnmarshaller<RepositoryHeadSourceCodeType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RepositoryHeadSourceCodeType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
