...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeCodeReviewRequestMarshaller : IMarshaller<IRequest, DescribeCodeReviewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeCodeReviewRequestMarshaller _instance = new DescribeCodeReviewRequestMarshaller();        

        internal static DescribeCodeReviewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCodeReviewRequestMarshaller Instance
        {
            get
            {
                return _instance;
