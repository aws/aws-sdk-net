...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListCodeReviewsRequestMarshaller : IMarshaller<IRequest, ListCodeReviewsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListCodeReviewsRequestMarshaller _instance = new();

        internal static ListCodeReviewsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListCodeReviewsRequestMarshaller Instance => _instance;
    }
}
