...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RepositoryAssociationUnmarshaller : IJsonUnmarshaller<RepositoryAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RepositoryAssociation();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RepositoryAssociationUnmarshaller Instance => _instance;
    }
}
