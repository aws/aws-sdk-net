...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BranchDiffSourceCodeTypeUnmarshaller : IJsonUnmarshaller<BranchDiffSourceCodeType, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public BranchDiffSourceCodeType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new BranchDiffSourceCodeType();
        ...
        /// Gets the singleton.
        /// </summary>
        public static BranchDiffSourceCodeTypeUnmarshaller Instance => _instance;
    }
}
