...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MetricsSummaryUnmarshaller : IJsonUnmarshaller<MetricsSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MetricsSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MetricsSummaryUnmarshaller Instance => _instance;
    }
}
