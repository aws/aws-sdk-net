...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RecommendationFeedbackUnmarshaller : IJsonUnmarshaller<RecommendationFeedback, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RecommendationFeedback();
            ...
            {
                if (context.TestExpression("CodeReviewArn", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RecommendationFeedbackUnmarshaller Instance => _instance;
    }
}
