...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuleMetadataUnmarshaller : IJsonUnmarshaller<RuleMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuleMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RuleTags", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.RuleTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
