...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RecommendationSummaryUnmarshaller : IJsonUnmarshaller<RecommendationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RecommendationSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RecommendationCategory", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("RuleMetadata", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static RecommendationSummaryUnmarshaller Instance => _instance;
    }
}
