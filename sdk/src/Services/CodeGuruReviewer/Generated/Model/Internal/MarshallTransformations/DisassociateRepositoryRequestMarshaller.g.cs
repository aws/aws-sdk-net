...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateRepositoryRequestMarshaller : IMarshaller<IRequest, DisassociateRepositoryRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateRepositoryRequestMarshaller _instance = new();

        internal static DisassociateRepositoryRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateRepositoryRequestMarshaller Instance => _instance;
    }
}
