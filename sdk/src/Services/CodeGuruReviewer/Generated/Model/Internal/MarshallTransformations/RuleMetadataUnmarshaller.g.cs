...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RuleMetadataUnmarshaller : IJsonUnmarshaller<RuleMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RuleMetadata();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RuleMetadataUnmarshaller Instance => _instance;
    }
}
