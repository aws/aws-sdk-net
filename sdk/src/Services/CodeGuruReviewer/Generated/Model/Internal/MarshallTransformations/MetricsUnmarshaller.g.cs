...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MetricsUnmarshaller : IJsonUnmarshaller<Metrics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Metrics();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MetricsUnmarshaller Instance => _instance;
    }
}
