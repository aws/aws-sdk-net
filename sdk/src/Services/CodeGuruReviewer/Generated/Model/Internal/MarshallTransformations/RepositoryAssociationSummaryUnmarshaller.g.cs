...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RepositoryAssociationSummaryUnmarshaller : IJsonUnmarshaller<RepositoryAssociationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RepositoryAssociationSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RepositoryAssociationSummaryUnmarshaller Instance => _instance;
    }
}
