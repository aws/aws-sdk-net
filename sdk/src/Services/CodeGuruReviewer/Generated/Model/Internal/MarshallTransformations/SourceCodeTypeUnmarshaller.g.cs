...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SourceCodeTypeUnmarshaller : IJsonUnmarshaller<SourceCodeType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SourceCodeType();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SourceCodeTypeUnmarshaller Instance => _instance;
    }
}
