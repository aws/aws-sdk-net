...
namespace Amazon.CodeGuruReviewer.Model
{
    ...
    public partial class ListRepositoryAssociationsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<RepositoryAssociationSummary> RepositoryAssociationSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<RepositoryAssociationSummary>() : null;

        /// <summary>
        /// Checks to see if the RepositoryAssociationSummaries property is set.
        /// </summary>
        internal bool IsSetRepositoryAssociationSummaries() => this.RepositoryAssociationSummaries != null && (this.RepositoryAssociationSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
