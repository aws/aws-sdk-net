...
namespace Amazon.CodeGuruReviewer
{
    ...
    public partial class AmazonCodeGuruReviewerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CodeGuru Reviewer", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "CodeGuru Reviewer";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "codeguru-reviewer";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2019-09-19";
