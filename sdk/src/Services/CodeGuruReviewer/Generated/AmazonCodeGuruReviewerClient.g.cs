...
namespace Amazon.CodeGuruReviewer
{
    ...
    public partial class AmazonCodeGuruReviewerClient : AmazonServiceClient, IAmazonCodeGuruReviewer
    {
        ...
        /// 
        /// </summary>
        public AmazonCodeGuruReviewerClient() : base(new AmazonCodeGuruReviewerConfig()) { }
        ...
        public AmazonCodeGuruReviewerClient(RegionEndpoint region) : base(new AmazonCodeGuruReviewerConfig { RegionEndpoint = region }) { }
        ...
        public AmazonCodeGuruReviewerClient(AmazonCodeGuruReviewerConfig config) : base(config) { }
