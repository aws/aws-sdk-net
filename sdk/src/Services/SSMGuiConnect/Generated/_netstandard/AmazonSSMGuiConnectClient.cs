...
namespace Amazon.SSMGuiConnect
{
    ...
    public partial class AmazonSSMGuiConnectClient : AmazonServiceClient, IAmazonSSMGuiConnect
    {
        ...
        public AmazonSSMGuiConnectClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSSMGuiConnectConfig()) { }
        ...
        public AmazonSSMGuiConnectClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonSSMGuiConnectConfig{RegionEndpoint = region}) { }
        ...
        public Amazon.Runtime.Endpoints.Endpoint DetermineServiceOperationEndpoint(AmazonWebServiceRequest request)
        {
            ...
            var resolver = new AmazonSSMGuiConnectEndpointResolver();
