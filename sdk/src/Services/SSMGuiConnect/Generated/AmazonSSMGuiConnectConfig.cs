...
namespace Amazon.SSMGuiConnect
{
    ...
    public partial class AmazonSSMGuiConnectConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("SSM GuiConnect", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "SSM GuiConnect";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "ssm-guiconnect";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-05-01";
