...
namespace Amazon.SSMGuiConnect
{
    ...
    public partial class AmazonSSMGuiConnectClient : AmazonServiceClient, IAmazonSSMGuiConnect
    {
        ...
        /// 
        /// </summary>
        public AmazonSSMGuiConnectClient() : base(new AmazonSSMGuiConnectConfig()) { }
        ...
        public AmazonSSMGuiConnectClient(RegionEndpoint region) : base(new AmazonSSMGuiConnectConfig { RegionEndpoint = region }) { }
        ...
        public AmazonSSMGuiConnectClient(AmazonSSMGuiConnectConfig config) : base(config) { }
