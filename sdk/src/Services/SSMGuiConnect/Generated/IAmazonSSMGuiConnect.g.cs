...
namespace Amazon.SSMGuiConnect
{
    ...
    public partial interface IAmazonSSMGuiConnect : IAmazonService, IDisposable
    {
        ...
        DeleteConnectionRecordingPreferencesResponse DeleteConnectionRecordingPreferences(DeleteConnectionRecordingPreferencesRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/DeleteConnectionRecordingPreferences">REST API Reference for DeleteConnectionRecordingPreferences Operation</seealso>
        Task<DeleteConnectionRecordingPreferencesResponse> DeleteConnectionRecordingPreferencesAsync(DeleteConnectionRecordingPreferencesRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        GetConnectionRecordingPreferencesResponse GetConnectionRecordingPreferences(GetConnectionRecordingPreferencesRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/GetConnectionRecordingPreferences">REST API Reference for GetConnectionRecordingPreferences Operation</seealso>
        Task<GetConnectionRecordingPreferencesResponse> GetConnectionRecordingPreferencesAsync(GetConnectionRecordingPreferencesRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        UpdateConnectionRecordingPreferencesResponse UpdateConnectionRecordingPreferences(UpdateConnectionRecordingPreferencesRequest request);
#endif
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/UpdateConnectionRecordingPreferences">REST API Reference for UpdateConnectionRecordingPreferences Operation</seealso>
        Task<UpdateConnectionRecordingPreferencesResponse> UpdateConnectionRecordingPreferencesAsync(UpdateConnectionRecordingPreferencesRequest request, CancellationToken cancellationToken = default(CancellationToken));
