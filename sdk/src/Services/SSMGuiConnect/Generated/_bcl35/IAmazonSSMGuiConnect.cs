...
namespace Amazon.SSMGuiConnect
{
    ...
    public partial interface IAmazonSSMGuiConnect : IAmazonService, IDisposable
    {
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the DeleteConnectionRecordingPreferences operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the DeleteConnectionRecordingPreferences operation on AmazonSSMGuiConnectClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndDeleteConnectionRecordingPreferences
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/DeleteConnectionRecordingPreferences">REST API Reference for DeleteConnectionRecordingPreferences Operation</seealso>
        IAsyncResult BeginDeleteConnectionRecordingPreferences(DeleteConnectionRecordingPreferencesRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  DeleteConnectionRecordingPreferences operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginDeleteConnectionRecordingPreferences.</param>
        /// 
        /// <returns>Returns a  DeleteConnectionRecordingPreferencesResult from SSMGuiConnect.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/DeleteConnectionRecordingPreferences">REST API Reference for DeleteConnectionRecordingPreferences Operation</seealso>
        DeleteConnectionRecordingPreferencesResponse EndDeleteConnectionRecordingPreferences(IAsyncResult asyncResult);
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GetConnectionRecordingPreferences operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GetConnectionRecordingPreferences operation on AmazonSSMGuiConnectClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGetConnectionRecordingPreferences
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/GetConnectionRecordingPreferences">REST API Reference for GetConnectionRecordingPreferences Operation</seealso>
        IAsyncResult BeginGetConnectionRecordingPreferences(GetConnectionRecordingPreferencesRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  GetConnectionRecordingPreferences operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetConnectionRecordingPreferences.</param>
        /// 
        /// <returns>Returns a  GetConnectionRecordingPreferencesResult from SSMGuiConnect.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/GetConnectionRecordingPreferences">REST API Reference for GetConnectionRecordingPreferences Operation</seealso>
        GetConnectionRecordingPreferencesResponse EndGetConnectionRecordingPreferences(IAsyncResult asyncResult);
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the UpdateConnectionRecordingPreferences operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the UpdateConnectionRecordingPreferences operation on AmazonSSMGuiConnectClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndUpdateConnectionRecordingPreferences
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/UpdateConnectionRecordingPreferences">REST API Reference for UpdateConnectionRecordingPreferences Operation</seealso>
        IAsyncResult BeginUpdateConnectionRecordingPreferences(UpdateConnectionRecordingPreferencesRequest request, AsyncCallback callback, object state);



        /// <summary>
        /// Finishes the asynchronous execution of the  UpdateConnectionRecordingPreferences operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginUpdateConnectionRecordingPreferences.</param>
        /// 
        /// <returns>Returns a  UpdateConnectionRecordingPreferencesResult from SSMGuiConnect.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/ssm-guiconnect-2021-05-01/UpdateConnectionRecordingPreferences">REST API Reference for UpdateConnectionRecordingPreferences Operation</seealso>
        UpdateConnectionRecordingPreferencesResponse EndUpdateConnectionRecordingPreferences(IAsyncResult asyncResult);
