...
namespace Amazon.SSMGuiConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ConnectionRecordingPreferencesUnmarshaller : IJsonUnmarshaller<ConnectionRecordingPreferences, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ConnectionRecordingPreferences();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConnectionRecordingPreferencesUnmarshaller Instance => _instance;
    }
}
