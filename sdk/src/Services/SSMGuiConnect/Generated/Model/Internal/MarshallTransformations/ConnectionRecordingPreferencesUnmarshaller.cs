...
namespace Amazon.SSMGuiConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionRecordingPreferencesUnmarshaller : IJsonUnmarshaller<ConnectionRecordingPreferences, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionRecordingPreferences Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
