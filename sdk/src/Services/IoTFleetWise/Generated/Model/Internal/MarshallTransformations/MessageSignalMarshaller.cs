...
{
    /// <summary>
    /// MessageSignal Marshaller
    /// </summary>
    public class MessageSignalMarshaller : IRequestMarshaller<MessageSignal, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(MessageSignal requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetStructuredMessage())
            {
                ...
                marshaller.Marshall(requestObject.StructuredMessage, context);
        ...
        /// </summary>
        public readonly static MessageSignalMarshaller Instance = new MessageSignalMarshaller();
