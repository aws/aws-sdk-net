...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActuatorUnmarshaller : IUnmarshaller<Actuator, XmlUnmarshallerContext>, IUnmarshaller<Actuator, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Actuator IUnmarshaller<Actuator, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Actuator Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
