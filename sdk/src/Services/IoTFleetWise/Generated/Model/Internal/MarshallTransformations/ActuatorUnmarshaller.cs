    ...
    public class ActuatorUnmarshaller : IJsonUnmarshaller<Actuator, JsonUnmarshallerContext>
    {
        ...
        public Actuator Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("assignedValue", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("deprecationMessage", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("structFullyQualifiedName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
