...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ConfigUnmarshaller : IJsonUnmarshaller<S3Config, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3Config Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("storageCompressionFormat", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StorageCompressionFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
