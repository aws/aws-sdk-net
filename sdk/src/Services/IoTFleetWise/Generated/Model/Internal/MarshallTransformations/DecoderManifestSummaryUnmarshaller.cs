...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DecoderManifestSummaryUnmarshaller : IJsonUnmarshaller<DecoderManifestSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DecoderManifestSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ModelManifestArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
