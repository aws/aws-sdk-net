...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class AccessPointNotFoundException : AmazonElasticFileSystemException
    {
        ...
        public AccessPointNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccessPointNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
