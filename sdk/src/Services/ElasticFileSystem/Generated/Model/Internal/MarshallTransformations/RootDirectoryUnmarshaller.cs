...
namespace Amazon.ElasticFileSystem.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RootDirectoryUnmarshaller : IJsonUnmarshaller<RootDirectory, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RootDirectory Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
