...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFileSystemPolicy operation
    /// </summary>  
    public class DeleteFileSystemPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFileSystemPolicyResponse response = new DeleteFileSystemPolicyResponse();
        ...
        private static DeleteFileSystemPolicyResponseUnmarshaller _instance = new DeleteFileSystemPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFileSystemPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
