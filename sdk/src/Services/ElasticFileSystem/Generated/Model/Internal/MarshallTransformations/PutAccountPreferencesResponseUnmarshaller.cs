...
{
    /// <summary>
    /// Response Unmarshaller for PutAccountPreferences operation
    /// </summary>  
    public class PutAccountPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccountPreferencesResponse response = new PutAccountPreferencesResponse();
            ...
            {
                if (context.TestExpression("ResourceIdPreference", targetDepth, ref reader))
                {
                    var unmarshaller = ResourceIdPreferenceUnmarshaller.Instance;
                    response.ResourceIdPreference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PutAccountPreferencesResponseUnmarshaller _instance = new PutAccountPreferencesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccountPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
