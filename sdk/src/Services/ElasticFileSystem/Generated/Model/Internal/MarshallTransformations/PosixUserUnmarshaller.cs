...
namespace Amazon.ElasticFileSystem.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PosixUserUnmarshaller : IUnmarshaller<PosixUser, XmlUnmarshallerContext>, IUnmarshaller<PosixUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PosixUser IUnmarshaller<PosixUser, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PosixUser Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
