...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("EFS", "4.0.0.0");
...
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("EFS", "3.7.401.34");
=======
            InternalSDKUtils.BuildUserAgentString("EFS", "3.7.401.50");
