...
namespace Amazon.ElasticFileSystem.Internal
{
    ...
    public class AmazonElasticFileSystemAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonElasticFileSystemAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ElasticFileSystem.
        /// </summary>
        public AmazonElasticFileSystemAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonElasticFileSystemAuthSchemeParameters
            {
    ...
    public class AmazonElasticFileSystemAuthSchemeResolver : IAuthSchemeResolver<AmazonElasticFileSystemAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonElasticFileSystemAuthSchemeParameters authParameters)
        {
