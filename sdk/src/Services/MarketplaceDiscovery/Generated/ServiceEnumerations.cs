...
namespace Amazon.MarketplaceDiscovery
{
    ...
    /// <summary>
    /// Constants used for properties of type SaasQuickLaunchStatus.
    /// </summary>
    public class SaasQuickLaunchStatus : ConstantClass
    {

        /// <summary>
        /// Constant DISABLED for SaasQuickLaunchStatus
        /// </summary>
        public static readonly SaasQuickLaunchStatus DISABLED = new SaasQuickLaunchStatus("DISABLED");
        /// <summary>
        /// Constant ENABLED for SaasQuickLaunchStatus
        /// </summary>
        public static readonly SaasQuickLaunchStatus ENABLED = new SaasQuickLaunchStatus("ENABLED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public SaasQuickLaunchStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static SaasQuickLaunchStatus FindValue(string value)
        {
            return FindValue<SaasQuickLaunchStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator SaasQuickLaunchStatus(string value)
        {
            return FindValue(value);
        }
    }
