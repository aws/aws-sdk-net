...
namespace Amazon.MarketplaceDiscovery
{
    ...
    public partial interface IAmazonMarketplaceDiscovery : IAmazonService, IDisposable
    {
        ...
        Task<GetOfferResponse> GetOfferAsync(GetOfferRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetOfferSetResponse> GetOfferSetAsync(GetOfferSetRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetOfferTermsResponse> GetOfferTermsAsync(GetOfferTermsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetProductResponse> GetProductAsync(GetProductRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListFulfillmentOptionsResponse> ListFulfillmentOptionsAsync(ListFulfillmentOptionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListPurchaseOptionsResponse> ListPurchaseOptionsAsync(ListPurchaseOptionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SearchFacetsResponse> SearchFacetsAsync(SearchFacetsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMarketplaceDiscoveryConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMarketplaceDiscoveryConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMarketplaceDiscoveryConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMarketplaceDiscoveryConfig to create AmazonMarketplaceDiscoveryClient");
            }

            return awsCredentials == null ? 
                    new AmazonMarketplaceDiscoveryClient(serviceClientConfig) :
                    new AmazonMarketplaceDiscoveryClient(awsCredentials, serviceClientConfig);
        }
