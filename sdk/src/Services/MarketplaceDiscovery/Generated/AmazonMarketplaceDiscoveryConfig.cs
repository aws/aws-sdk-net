...
namespace Amazon.MarketplaceDiscovery
{
    ...
    public partial class AmazonMarketplaceDiscoveryConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Marketplace Discovery", "4.0.100.2");
        ...
        /// Default constructor
        /// </summary>
        public AmazonMarketplaceDiscoveryConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonMarketplaceDiscoveryDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Marketplace Discovery";
            this.AuthenticationServiceName = "aws-marketplace";
            this.EndpointProvider = new AmazonMarketplaceDiscoveryEndpointProvider();
        }
