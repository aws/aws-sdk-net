...
namespace Amazon.MarketplaceDiscovery.Model
{
    ...
    public partial class SageMakerAlgorithmRecommendation
    {
        ...
        /// <summary>
        /// Gets and sets the property RecommendedTrainingInstanceType. 
        /// <para>
        /// The recommended instance type for training.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public string RecommendedTrainingInstanceType
        {
            get { return this._recommendedTrainingInstanceType; }
            set { this._recommendedTrainingInstanceType = value; }
        }

        // Check to see if RecommendedTrainingInstanceType property is set
        internal bool IsSetRecommendedTrainingInstanceType()
        {
            return this._recommendedTrainingInstanceType != null;
        }
