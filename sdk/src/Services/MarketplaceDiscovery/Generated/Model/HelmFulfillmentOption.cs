...
namespace Amazon.MarketplaceDiscovery.Model
{
    ...
    /// </summary>
    public partial class HelmFulfillmentOption
    {
        ...
        private List<HelmOperatingSystem> _operatingSystems = AWSConfigs.InitializeCollections ? new List<HelmOperatingSystem>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<HelmOperatingSystem> OperatingSystems
        {
