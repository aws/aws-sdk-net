...
{
    /// <summary>
    /// This is the response object from the ListFulfillmentOptions operation.
    /// </summary>
    public partial class ListFulfillmentOptionsResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property FulfillmentOptions. 
        /// <para>
        /// The fulfillment options available for the product. Each option describes how the buyer
        /// can deploy or access the product.
        /// </para>
        /// <para />
        ...
        public List<FulfillmentOption> FulfillmentOptions
        {
            get { return this._fulfillmentOptions; }
            set { this._fulfillmentOptions = value; }
        }

        // Check to see if FulfillmentOptions property is set
