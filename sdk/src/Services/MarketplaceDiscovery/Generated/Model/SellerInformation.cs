...
namespace Amazon.MarketplaceDiscovery.Model
{
    ...
    public partial class SellerInformation
    {
        ...
        private string _sellerProfileId;
        ...
        /// <summary>
        /// Gets and sets the property SellerProfileId. 
        /// <para>
        ...
        {
            get { return this._sellerProfileId; }
            set { this._sellerProfileId = value; }
        }

        // Check to see if SellerProfileId property is set
        internal bool IsSetSellerProfileId()
        {
            return this._sellerProfileId != null;
        }
