...
{
    /// <summary>
    /// Container for the parameters to the SearchFacets operation.
    ...
    /// </summary>
    public partial class SearchFacetsRequest : AmazonMarketplaceDiscoveryRequest
    {
        private List<string> _facetTypes = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private List<SearchFilter> _filters = AWSConfigs.InitializeCollections ? new List<SearchFilter>() : null;
        private string _nextToken;
        private string _searchText;

        /// <summary>
        /// Gets and sets the property FacetTypes. 
        /// <para>
        /// A list of specific facet types to retrieve. If empty or null, all available facets
        /// are returned.
        /// </para>
        /// <para />
        ...
        {
            get { return this._facetTypes; }
            set { this._facetTypes = value; }
        }

        // Check to see if FacetTypes property is set
        internal bool IsSetFacetTypes()
        {
            return this._facetTypes != null && (this._facetTypes.Count > 0 || !AWSConfigs.InitializeCollections); 
        }

        /// <summary>
        /// Gets and sets the property Filters. 
        /// <para>
        /// Filters to apply before retrieving facets. Multiple filters are combined with AND
