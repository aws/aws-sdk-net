...
namespace Amazon.MarketplaceDiscovery.Model
{
    ...
    /// </summary>
    public partial class EksAddOnFulfillmentOption
    {
        ...
        private List<EksAddOnOperatingSystem> _operatingSystems = AWSConfigs.InitializeCollections ? new List<EksAddOnOperatingSystem>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<EksAddOnOperatingSystem> OperatingSystems
        {
