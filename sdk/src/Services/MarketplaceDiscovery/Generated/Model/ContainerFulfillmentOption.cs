...
namespace Amazon.MarketplaceDiscovery.Model
{
    ...
    /// </summary>
    public partial class ContainerFulfillmentOption
    {
        ...
        private List<ContainerOperatingSystem> _operatingSystems = AWSConfigs.InitializeCollections ? new List<ContainerOperatingSystem>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<ContainerOperatingSystem> OperatingSystems
        {
