...
namespace Amazon.MarketplaceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FixedUpfrontPricingTermUnmarshaller : IJsonUnmarshaller<FixedUpfrontPricingTerm, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FixedUpfrontPricingTerm Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
