...
{
    /// <summary>
    /// Response Unmarshaller for ContainerFulfillmentOption Object
    /// </summary>  
    public class ContainerFulfillmentOptionUnmarshaller : IJsonUnmarshaller<ContainerFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ContainerFulfillmentOption unmarshalledObject = new ContainerFulfillmentOption();
            ...
            {
                if (context.TestExpression("awsSupportedServices", targetDepth, ref reader))
                {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ContainerOperatingSystem, ContainerOperatingSystemUnmarshaller>(ContainerOperatingSystemUnmarshaller.Instance);
        ...
        private static ContainerFulfillmentOptionUnmarshaller _instance = new ContainerFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContainerFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
