...
{
    /// <summary>
    /// Response Unmarshaller for ApiFulfillmentOption Object
    /// </summary>  
    public class ApiFulfillmentOptionUnmarshaller : IJsonUnmarshaller<ApiFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApiFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ApiFulfillmentOption unmarshalledObject = new ApiFulfillmentOption();
        ...
        private static ApiFulfillmentOptionUnmarshaller _instance = new ApiFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ApiFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
