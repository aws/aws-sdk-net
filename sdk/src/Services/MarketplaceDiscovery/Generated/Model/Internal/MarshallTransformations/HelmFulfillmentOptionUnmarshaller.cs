...
{
    /// <summary>
    /// Response Unmarshaller for HelmFulfillmentOption Object
    /// </summary>  
    public class HelmFulfillmentOptionUnmarshaller : IJsonUnmarshaller<HelmFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HelmFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HelmFulfillmentOption unmarshalledObject = new HelmFulfillmentOption();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HelmOperatingSystem, HelmOperatingSystemUnmarshaller>(HelmOperatingSystemUnmarshaller.Instance);
        ...
        private static HelmFulfillmentOptionUnmarshaller _instance = new HelmFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HelmFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
