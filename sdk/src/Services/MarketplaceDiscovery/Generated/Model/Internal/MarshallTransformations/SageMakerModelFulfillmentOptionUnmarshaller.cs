...
{
    /// <summary>
    /// Response Unmarshaller for SageMakerModelFulfillmentOption Object
    /// </summary>  
    public class SageMakerModelFulfillmentOptionUnmarshaller : IJsonUnmarshaller<SageMakerModelFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SageMakerModelFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SageMakerModelFulfillmentOption unmarshalledObject = new SageMakerModelFulfillmentOption();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SageMakerModelRecommendationUnmarshaller.Instance;
        ...
        private static SageMakerModelFulfillmentOptionUnmarshaller _instance = new SageMakerModelFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SageMakerModelFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
