...
{
    /// <summary>
    /// Response Unmarshaller for CloudFormationFulfillmentOption Object
    /// </summary>  
    public class CloudFormationFulfillmentOptionUnmarshaller : IJsonUnmarshaller<CloudFormationFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CloudFormationFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CloudFormationFulfillmentOption unmarshalledObject = new CloudFormationFulfillmentOption();
        ...
        private static CloudFormationFulfillmentOptionUnmarshaller _instance = new CloudFormationFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CloudFormationFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
