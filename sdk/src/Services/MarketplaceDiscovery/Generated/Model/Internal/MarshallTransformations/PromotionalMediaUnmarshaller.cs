...
{
    /// <summary>
    /// Response Unmarshaller for PromotionalMedia Object
    /// </summary>  
    public class PromotionalMediaUnmarshaller : IJsonUnmarshaller<PromotionalMedia, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PromotionalMedia Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PromotionalMedia unmarshalledObject = new PromotionalMedia();
        ...
        private static PromotionalMediaUnmarshaller _instance = new PromotionalMediaUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PromotionalMediaUnmarshaller Instance
        {
            get
            {
                return _instance;
