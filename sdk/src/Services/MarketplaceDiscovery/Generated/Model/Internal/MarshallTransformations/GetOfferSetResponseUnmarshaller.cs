...
{
    /// <summary>
    /// Response Unmarshaller for GetOfferSet operation
    /// </summary>  
    public class GetOfferSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOfferSetResponse response = new GetOfferSetResponse();
        ...
        private static GetOfferSetResponseUnmarshaller _instance = new GetOfferSetResponseUnmarshaller();        

        internal static GetOfferSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOfferSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
