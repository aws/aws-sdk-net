...
{
    /// <summary>
    /// Response Unmarshaller for SearchFacets operation
    /// </summary>  
    public class SearchFacetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchFacetsResponse response = new SearchFacetsResponse();
        ...
        private static SearchFacetsResponseUnmarshaller _instance = new SearchFacetsResponseUnmarshaller();        

        internal static SearchFacetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchFacetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
