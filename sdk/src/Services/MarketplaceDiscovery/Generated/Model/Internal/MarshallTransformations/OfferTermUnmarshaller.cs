...
{
    /// <summary>
    /// Response Unmarshaller for OfferTerm Object
    /// </summary>  
    public class OfferTermUnmarshaller : IJsonUnmarshaller<OfferTerm, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OfferTerm Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            OfferTerm unmarshalledObject = new OfferTerm();
        ...
        private static OfferTermUnmarshaller _instance = new OfferTermUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OfferTermUnmarshaller Instance
        {
            get
            {
                return _instance;
