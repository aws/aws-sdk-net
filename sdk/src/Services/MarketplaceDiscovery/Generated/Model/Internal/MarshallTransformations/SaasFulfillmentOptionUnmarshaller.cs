...
{
    /// <summary>
    /// Response Unmarshaller for SaasFulfillmentOption Object
    /// </summary>  
    public class SaasFulfillmentOptionUnmarshaller : IJsonUnmarshaller<SaasFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SaasFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SaasFulfillmentOption unmarshalledObject = new SaasFulfillmentOption();
        ...
        private static SaasFulfillmentOptionUnmarshaller _instance = new SaasFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SaasFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
