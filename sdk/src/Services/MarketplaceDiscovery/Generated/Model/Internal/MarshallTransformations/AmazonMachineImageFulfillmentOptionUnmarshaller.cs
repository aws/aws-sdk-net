...
{
    /// <summary>
    /// Response Unmarshaller for AmazonMachineImageFulfillmentOption Object
    /// </summary>  
    public class AmazonMachineImageFulfillmentOptionUnmarshaller : IJsonUnmarshaller<AmazonMachineImageFulfillmentOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AmazonMachineImageFulfillmentOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AmazonMachineImageFulfillmentOption unmarshalledObject = new AmazonMachineImageFulfillmentOption();
        ...
        private static AmazonMachineImageFulfillmentOptionUnmarshaller _instance = new AmazonMachineImageFulfillmentOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AmazonMachineImageFulfillmentOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
