...
namespace Amazon.S3Outposts.Internal
{
    ...
    public class AmazonS3OutpostsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonS3OutpostsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for S3Outposts.
        /// </summary>
        public AmazonS3OutpostsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonS3OutpostsAuthSchemeParameters
            {
    ...
    public class AmazonS3OutpostsAuthSchemeResolver : IAuthSchemeResolver<AmazonS3OutpostsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonS3OutpostsAuthSchemeParameters authParameters)
        {
