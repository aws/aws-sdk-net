...
namespace Amazon.S3Outposts.Model
{
    ...
    internal sealed partial class ListEndpointsPaginator : IPaginator<ListEndpointsResponse>, IListEndpointsPaginator
    {
        ...
        public IPaginatedEnumerable<Endpoint> Endpoints => 
            new PaginatedResultKeyResponse<ListEndpointsResponse, Endpoint>(this, (i) => i.Endpoints ?? new List<Endpoint>());

        internal ListEndpointsPaginator(IAmazonS3Outposts client, ListEndpointsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListEndpointsResponse> IPaginator<ListEndpointsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
