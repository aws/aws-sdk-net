...
namespace Amazon.S3Outposts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FailedReasonUnmarshaller : IJsonUnmarshaller<FailedReason, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedReason Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
