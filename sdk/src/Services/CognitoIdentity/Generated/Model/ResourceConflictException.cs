...
namespace Amazon.CognitoIdentity.Model
{
    ...
    public partial class ResourceConflictException : AmazonCognitoIdentityException
    {
        ...
        public ResourceConflictException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceConflictException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
