...
namespace Amazon.CognitoIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdentityPoolShortDescriptionUnmarshaller : IJsonUnmarshaller<IdentityPoolShortDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentityPoolShortDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IdentityPoolName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IdentityPoolName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
