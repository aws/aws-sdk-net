...
{
    /// <summary>
    /// SearchRelevantContent Request Marshaller
    /// </summary>       
    public class SearchRelevantContentRequestMarshaller : IMarshaller<IRequest, SearchRelevantContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchRelevantContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchRelevantContentRequest publicRequest)
        {
        ...
        private static SearchRelevantContentRequestMarshaller _instance = new SearchRelevantContentRequestMarshaller();        

        internal static SearchRelevantContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchRelevantContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
