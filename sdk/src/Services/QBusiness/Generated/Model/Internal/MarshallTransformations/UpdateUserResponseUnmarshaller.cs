    ...
    public class UpdateUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<UserAlias, UserAliasUnmarshaller>(UserAliasUnmarshaller.Instance);
                    response.UserAliasesAdded = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("userAliasesDeleted", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<UserAlias, UserAliasUnmarshaller>(UserAliasUnmarshaller.Instance);
                    response.UserAliasesDeleted = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("userAliasesUpdated", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<UserAlias, UserAliasUnmarshaller>(UserAliasUnmarshaller.Instance);
                    response.UserAliasesUpdated = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
