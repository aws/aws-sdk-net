...
{
    /// <summary>
    /// DeleteRetriever Request Marshaller
    /// </summary>       
    public class DeleteRetrieverRequestMarshaller : IMarshaller<IRequest, DeleteRetrieverRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRetrieverRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRetrieverRequest publicRequest)
        {
        ...
        private static DeleteRetrieverRequestMarshaller _instance = new DeleteRetrieverRequestMarshaller();        

        internal static DeleteRetrieverRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRetrieverRequestMarshaller Instance
        {
            get
            {
                return _instance;
