...
{
    /// <summary>
    /// IdentityProviderConfiguration Marshaller
    /// </summary>
    public class IdentityProviderConfigurationMarshaller : IRequestMarshaller<IdentityProviderConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(IdentityProviderConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetOpenIDConnectConfiguration())
            {
                ...
                var marshaller = OpenIDConnectProviderConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetSamlConfiguration())
            {
                ...
                var marshaller = SamlProviderConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static IdentityProviderConfigurationMarshaller Instance = new IdentityProviderConfigurationMarshaller();
