...
{
    /// <summary>
    /// Response Unmarshaller for CreateWebExperience operation
    /// </summary>  
    public class CreateWebExperienceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWebExperienceResponse response = new CreateWebExperienceResponse();
        ...
        private static CreateWebExperienceResponseUnmarshaller _instance = new CreateWebExperienceResponseUnmarshaller();        

        internal static CreateWebExperienceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWebExperienceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
