...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    public class SamlConfigurationUnmarshaller : IJsonUnmarshaller<SamlConfiguration, JsonUnmarshallerContext>
    {
        ...
        public SamlConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("metadataXML", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("userGroupAttribute", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UserGroupAttribute = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("userIdAttribute", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
