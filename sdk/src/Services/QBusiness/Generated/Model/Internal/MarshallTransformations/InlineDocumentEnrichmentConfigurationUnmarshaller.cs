...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InlineDocumentEnrichmentConfigurationUnmarshaller : IUnmarshaller<InlineDocumentEnrichmentConfiguration, XmlUnmarshallerContext>, IUnmarshaller<InlineDocumentEnrichmentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InlineDocumentEnrichmentConfiguration IUnmarshaller<InlineDocumentEnrichmentConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InlineDocumentEnrichmentConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("documentContentOperator", targetDepth))
                {
                    ...
                    unmarshalledObject.DocumentContentOperator = unmarshaller.Unmarshall(context);
                    continue;
                }
