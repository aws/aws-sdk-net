    ...
    public class ActionExecutionUnmarshaller : IUnmarshaller<ActionExecution, XmlUnmarshallerContext>, IUnmarshaller<ActionExecution, JsonUnmarshallerContext>
    {
        ...
        public ActionExecution Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, ActionExecutionPayloadField, StringUnmarshaller, ActionExecutionPayloadFieldUnmarshaller>(StringUnmarshaller.Instance, ActionExecutionPayloadFieldUnmarshaller.Instance);
