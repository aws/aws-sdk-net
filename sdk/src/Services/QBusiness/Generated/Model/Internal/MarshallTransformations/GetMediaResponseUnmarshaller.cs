    ...
    public class GetMediaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("mediaBytes", targetDepth))
                {
                    ...
                    response.MediaBytes = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("mediaMimeType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MediaMimeType = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return MediaTooLargeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
