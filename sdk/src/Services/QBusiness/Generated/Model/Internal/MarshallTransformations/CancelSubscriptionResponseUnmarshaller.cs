...
{
    /// <summary>
    /// Response Unmarshaller for CancelSubscription operation
    /// </summary>  
    public class CancelSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("currentSubscription", targetDepth))
                {
                    ...
                    response.CurrentSubscription = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("nextSubscription", targetDepth))
                {
                    var unmarshaller = SubscriptionDetailsUnmarshaller.Instance;
                    response.NextSubscription = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CancelSubscriptionResponseUnmarshaller _instance = new CancelSubscriptionResponseUnmarshaller();        

        internal static CancelSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
