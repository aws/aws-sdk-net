...
{
    /// <summary>
    /// Response Unmarshaller for MetadataEvent Object
    /// </summary>  
    public class MetadataEventUnmarshaller : IJsonUnmarshaller<MetadataEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetadataEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MetadataEvent unmarshalledObject = new MetadataEvent();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("finalTextMessage", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FinalTextMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static MetadataEventUnmarshaller _instance = new MetadataEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MetadataEventUnmarshaller Instance
        {
            get
            {
                return _instance;
