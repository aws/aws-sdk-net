...
{
    /// <summary>
    /// CreateDataAccessor Request Marshaller
    /// </summary>       
    public class CreateDataAccessorRequestMarshaller : IMarshaller<IRequest, CreateDataAccessorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDataAccessorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDataAccessorRequest publicRequest)
        {
            ...
            request.ResourcePath = "/applications/{applicationId}/dataaccessors";
#if !NETFRAMEWORK
        ...
        private static CreateDataAccessorRequestMarshaller _instance = new CreateDataAccessorRequestMarshaller();        

        internal static CreateDataAccessorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataAccessorRequestMarshaller Instance
        {
            get
            {
                return _instance;
