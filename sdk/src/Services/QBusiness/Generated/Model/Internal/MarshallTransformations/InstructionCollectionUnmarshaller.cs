...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstructionCollectionUnmarshaller : IUnmarshaller<InstructionCollection, XmlUnmarshallerContext>, IUnmarshaller<InstructionCollection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InstructionCollection IUnmarshaller<InstructionCollection, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InstructionCollection Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("customInstructions", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomInstructions = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OutputStyle = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("perspective", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Perspective = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("responseLength", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResponseLength = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("targetAudience", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TargetAudience = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("tone", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Tone = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
