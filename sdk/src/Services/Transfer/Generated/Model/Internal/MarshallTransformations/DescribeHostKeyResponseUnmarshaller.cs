...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeHostKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeHostKeyResponse response = new DescribeHostKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("HostKey", targetDepth))
                {
                    ...
                    response.HostKey = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeHostKeyResponseUnmarshaller _instance = new DescribeHostKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeHostKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
