...
{
    /// <summary>
    /// Response Unmarshaller for StartRemoteDelete operation
    /// </summary>  
    public class StartRemoteDeleteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRemoteDeleteResponse response = new StartRemoteDeleteResponse();
            ...
            {
                if (context.TestExpression("DeleteId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DeleteId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartRemoteDeleteResponseUnmarshaller _instance = new StartRemoteDeleteResponseUnmarshaller();        

        internal static StartRemoteDeleteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRemoteDeleteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
