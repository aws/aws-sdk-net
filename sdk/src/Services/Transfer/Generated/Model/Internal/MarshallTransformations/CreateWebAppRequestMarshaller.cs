...
{
    /// <summary>
    /// CreateWebApp Request Marshaller
    /// </summary>       
    public class CreateWebAppRequestMarshaller : IMarshaller<IRequest, CreateWebAppRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateWebAppRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateWebAppRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Transfer");
            string target = "TransferService.CreateWebApp";
            ...
            if(publicRequest.IsSetIdentityProviderDetails())
            {
                ...
                var marshaller = WebAppIdentityProviderDetailsMarshaller.Instance;
            ...
            if(publicRequest.IsSetWebAppEndpointPolicy())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.WebAppEndpointPolicy);
            }
        ...
        private static CreateWebAppRequestMarshaller _instance = new CreateWebAppRequestMarshaller();        

        internal static CreateWebAppRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWebAppRequestMarshaller Instance
        {
            get
            {
                return _instance;
