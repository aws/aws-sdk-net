...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCertificateResponse response = new UpdateCertificateResponse();
        ...
        private static UpdateCertificateResponseUnmarshaller _instance = new UpdateCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
