...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportSshPublicKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SshPublicKeyId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SshPublicKeyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ImportSshPublicKeyResponseUnmarshaller _instance = new ImportSshPublicKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportSshPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
