    ...
    public class DescribedWebAppCustomizationUnmarshaller : IJsonUnmarshaller<DescribedWebAppCustomization, JsonUnmarshallerContext>
    {
        ...
        public DescribedWebAppCustomization Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FaviconFile", targetDepth, ref reader))
                {
                    var unmarshaller = MemoryStreamUnmarshaller.Instance;
                    unmarshalledObject.FaviconFile = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("LogoFile", targetDepth, ref reader))
                {
                    var unmarshaller = MemoryStreamUnmarshaller.Instance;
        ...
        private static DescribedWebAppCustomizationUnmarshaller _instance = new DescribedWebAppCustomizationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DescribedWebAppCustomizationUnmarshaller Instance
        {
            get
            {
                return _instance;
