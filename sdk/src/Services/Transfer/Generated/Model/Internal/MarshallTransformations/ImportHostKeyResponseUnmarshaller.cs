...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportHostKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportHostKeyResponse response = new ImportHostKeyResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("HostKeyId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HostKeyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ServerId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ServerId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ImportHostKeyResponseUnmarshaller _instance = new ImportHostKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportHostKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
