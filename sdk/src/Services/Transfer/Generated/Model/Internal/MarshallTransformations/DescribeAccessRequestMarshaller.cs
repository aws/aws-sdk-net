...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeAccessRequestMarshaller : IMarshaller<IRequest, DescribeAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Transfer");
            string target = "TransferService.DescribeAccess";
        ...
        private static DescribeAccessRequestMarshaller _instance = new DescribeAccessRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
