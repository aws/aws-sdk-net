...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListServersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonTransferException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }

        private static ListServersResponseUnmarshaller _instance = new ListServersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
