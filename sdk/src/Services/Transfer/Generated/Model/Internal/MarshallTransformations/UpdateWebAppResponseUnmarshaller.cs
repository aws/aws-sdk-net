...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWebApp operation
    /// </summary>  
    public class UpdateWebAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWebAppResponse response = new UpdateWebAppResponse();
            ...
            {
                if (context.TestExpression("WebAppId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WebAppId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateWebAppResponseUnmarshaller _instance = new UpdateWebAppResponseUnmarshaller();        

        internal static UpdateWebAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWebAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
