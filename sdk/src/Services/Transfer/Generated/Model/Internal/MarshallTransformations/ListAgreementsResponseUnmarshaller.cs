    ...
    public class ListAgreementsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ListedAgreement, ListedAgreementUnmarshaller>(ListedAgreementUnmarshaller.Instance);
                    response.Agreements = unmarshaller.Unmarshall(context);
                    continue;
                }
