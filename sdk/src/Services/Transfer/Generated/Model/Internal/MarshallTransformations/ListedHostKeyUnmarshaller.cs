...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListedHostKeyUnmarshaller : IUnmarshaller<ListedHostKey, XmlUnmarshallerContext>, IUnmarshaller<ListedHostKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ListedHostKey IUnmarshaller<ListedHostKey, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ListedHostKey Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HostKeyId = unmarshaller.Unmarshall(context);
                    continue;
                }
