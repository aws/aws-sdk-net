...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ExternalId", targetDepth))
                {
                    ...
                    response.ExternalId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateAccessResponseUnmarshaller _instance = new CreateAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
