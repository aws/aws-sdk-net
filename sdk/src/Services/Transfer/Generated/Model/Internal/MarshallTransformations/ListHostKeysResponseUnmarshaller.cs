    ...
    public class ListHostKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ListedHostKey, ListedHostKeyUnmarshaller>(ListedHostKeyUnmarshaller.Instance);
                    response.HostKeys = unmarshaller.Unmarshall(context);
                    continue;
                }
