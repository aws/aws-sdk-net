...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAccessesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccessesResponse response = new ListAccessesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Accesses", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ListedAccess, ListedAccessUnmarshaller>(ListedAccessUnmarshaller.Instance);
                    response.Accesses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAccessesResponseUnmarshaller _instance = new ListAccessesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
