    ...
    public class ListAccessesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ListedAccess, ListedAccessUnmarshaller>(ListedAccessUnmarshaller.Instance);
                    response.Accesses = unmarshaller.Unmarshall(context);
                    continue;
                }
