...
{
    /// <summary>
    /// Response Unmarshaller for ListWebApps operation
    /// </summary>  
    public class ListWebAppsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWebAppsResponse response = new ListWebAppsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WebApps", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ListedWebApp, ListedWebAppUnmarshaller>(ListedWebAppUnmarshaller.Instance);
                    response.WebApps = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListWebAppsResponseUnmarshaller _instance = new ListWebAppsResponseUnmarshaller();        

        internal static ListWebAppsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWebAppsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
