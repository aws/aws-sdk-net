...
{
    /// <summary>
    /// VPC_LATTICE egress configuration details in the response, containing the Resource
    /// Configuration ARN and port number currently configured for the connector.
    /// </summary>
    public partial class DescribedConnectorVpcLatticeEgressConfig
    {
        ...
        /// <para>
        /// Port number currently configured for SFTP connections through VPC_LATTICE. Shows the
        /// port on which the connector attempts to connect to the target SFTP server.
        /// </para>
        /// </summary>
