...
{
    /// <summary>
    /// VPC_LATTICE egress configuration that specifies the Resource Configuration ARN and
    ...
    /// </summary>
    public partial class ConnectorVpcLatticeEgressConfig
    {
        ...
        /// <para>
        /// Port number for connecting to the SFTP server through VPC_LATTICE. Defaults to 22
        /// if not specified. Must match the port on which the target SFTP server is listening.
        /// </para>
        /// </summary>
