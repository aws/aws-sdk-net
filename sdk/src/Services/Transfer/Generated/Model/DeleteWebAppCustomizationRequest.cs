...
{
    /// <summary>
    /// Container for the parameters to the DeleteWebAppCustomization operation.
    /// Deletes the <c>WebAppCustomization</c> object that corresponds to the web app ID specified.
    /// </summary>
    public partial class DeleteWebAppCustomizationRequest : AmazonTransferRequest
    {
        ...
        /// <para>
        /// Provide the unique identifier for the web app that contains the customizations that
        /// you are deleting.
        /// </para>
        /// </summary>
