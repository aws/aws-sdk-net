...
namespace Amazon.Transfer.Internal
{
    /// <summary>
    ...
    /// </summary>
    public class AmazonTransferEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonTransferConfig)requestContext.ClientConfig;
            var result = new TransferEndpointParameters();
