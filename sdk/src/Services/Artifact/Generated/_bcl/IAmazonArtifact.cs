...
namespace Amazon.Artifact
{
    ...
    public partial interface IAmazonArtifact : IAmazonService, IDisposable
    {
        ...
        PutComplianceInquiryFeedbackResponse PutComplianceInquiryFeedback(PutComplianceInquiryFeedbackRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/artifact-2018-05-10/PutComplianceInquiryFeedback">REST API Reference for PutComplianceInquiryFeedback Operation</seealso>
        Task<PutComplianceInquiryFeedbackResponse> PutComplianceInquiryFeedbackAsync(PutComplianceInquiryFeedbackRequest request, CancellationToken cancellationToken = default(CancellationToken));
