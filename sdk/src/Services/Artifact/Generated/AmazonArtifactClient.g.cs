...
namespace Amazon.Artifact
{
    ...
    public partial class AmazonArtifactClient : AmazonServiceClient, IAmazonArtifact
    {
        ...
        /// 
        /// </summary>
        public AmazonArtifactClient() : base(new AmazonArtifactConfig()) { }
        ...
        public AmazonArtifactClient(RegionEndpoint region) : base(new AmazonArtifactConfig { RegionEndpoint = region }) { }
        ...
        public AmazonArtifactClient(AmazonArtifactConfig config) : base(config) { }
        ...
        public virtual ListReportVersionsResponse ListReportVersions(ListReportVersionsRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        public virtual PutComplianceInquiryFeedbackResponse PutComplianceInquiryFeedback(PutComplianceInquiryFeedbackRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
