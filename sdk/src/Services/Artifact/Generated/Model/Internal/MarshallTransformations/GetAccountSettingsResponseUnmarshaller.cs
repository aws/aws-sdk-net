...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAccountSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("accountSettings", targetDepth, ref reader))
                {
                    var unmarshaller = AccountSettingsUnmarshaller.Instance;
                    response.AccountSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetAccountSettingsResponseUnmarshaller _instance = new GetAccountSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
