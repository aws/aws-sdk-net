...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ExportComplianceInquiryRequestMarshaller : IMarshaller<IRequest, ExportComplianceInquiryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ExportComplianceInquiryRequestMarshaller _instance = new ExportComplianceInquiryRequestMarshaller();        

        internal static ExportComplianceInquiryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportComplianceInquiryRequestMarshaller Instance
        {
            get
            {
                return _instance;
