...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutComplianceInquiryFeedbackRequestMarshaller : IMarshaller<IRequest, PutComplianceInquiryFeedbackRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static PutComplianceInquiryFeedbackRequestMarshaller _instance = new PutComplianceInquiryFeedbackRequestMarshaller();        

        internal static PutComplianceInquiryFeedbackRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutComplianceInquiryFeedbackRequestMarshaller Instance
        {
            get
            {
                return _instance;
