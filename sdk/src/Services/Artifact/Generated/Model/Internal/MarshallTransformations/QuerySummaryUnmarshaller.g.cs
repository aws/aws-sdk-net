...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class QuerySummaryUnmarshaller : IJsonUnmarshaller<QuerySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new QuerySummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static QuerySummaryUnmarshaller Instance => _instance;
    }
}
