...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    public class AccountSettingsUnmarshaller : IJsonUnmarshaller<AccountSettings, JsonUnmarshallerContext>
    {
        ...
        public AccountSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("notificationSubscriptionStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NotificationSubscriptionStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
