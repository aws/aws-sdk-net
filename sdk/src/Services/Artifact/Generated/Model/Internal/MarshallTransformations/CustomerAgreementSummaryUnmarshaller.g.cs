...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CustomerAgreementSummaryUnmarshaller : IJsonUnmarshaller<CustomerAgreementSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CustomerAgreementSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CustomerAgreementSummaryUnmarshaller Instance => _instance;
    }
}
