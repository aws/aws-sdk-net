...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetTermForReportRequestMarshaller : IMarshaller<IRequest, GetTermForReportRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetTermForReportRequestMarshaller _instance = new();

        internal static GetTermForReportRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetTermForReportRequestMarshaller Instance => _instance;
    }
}
