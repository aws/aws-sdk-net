...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReportDetailUnmarshaller : IJsonUnmarshaller<ReportDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReportDetail();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReportDetailUnmarshaller Instance => _instance;
    }
}
