...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReportSummaryUnmarshaller : IJsonUnmarshaller<ReportSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ReportSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ReportSummaryUnmarshaller Instance => _instance;
    }
}
