...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomerAgreementSummaryUnmarshaller : IUnmarshaller<CustomerAgreementSummary, XmlUnmarshallerContext>, IUnmarshaller<CustomerAgreementSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CustomerAgreementSummary IUnmarshaller<CustomerAgreementSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CustomerAgreementSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("acceptanceTerms", targetDepth))
                {
                    ...
                    unmarshalledObject.AcceptanceTerms = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("agreementArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AgreementArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.TerminateTerms = unmarshaller.Unmarshall(context);
                    continue;
                }
