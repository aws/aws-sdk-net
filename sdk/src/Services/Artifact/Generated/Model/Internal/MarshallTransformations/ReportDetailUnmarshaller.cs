...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReportDetailUnmarshaller : IUnmarshaller<ReportDetail, XmlUnmarshallerContext>, IUnmarshaller<ReportDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReportDetail IUnmarshaller<ReportDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ReportDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("acceptanceType", targetDepth))
                {
                    ...
                    unmarshalledObject.AcceptanceType = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TermArn = unmarshaller.Unmarshall(context);
                    continue;
                }
