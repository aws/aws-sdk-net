...
{
    /// <summary>
    /// Container for the parameters to the CreateComplianceInquiry operation. Create a new
    /// compliance inquiry.
    /// </summary>
    public partial class CreateComplianceInquiryRequest : AmazonArtifactRequest
    {
        ...
        public InquiryContent InquiryContent { get; set; }

        /// <summary>
        /// Checks to see if the InquiryContent property is set.
        /// </summary>
        internal bool IsSetInquiryContent() => this.InquiryContent != null;
        ...
        /// </para>
        /// </summary>
        public InquirySupportMode SupportMode { get; set; }

        /// <summary>
        /// Checks to see if the SupportMode property is set.
        /// </summary>
        internal bool IsSetSupportMode() => this.SupportMode != null;
