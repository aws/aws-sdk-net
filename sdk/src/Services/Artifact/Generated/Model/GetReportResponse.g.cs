...
namespace Amazon.Artifact.Model
{
    ...
    public partial class GetReportResponse : AmazonWebServiceResponse
    {
        ...
        public string DocumentPresignedUrl { get; set; }

        /// <summary>
        /// Checks to see if the DocumentPresignedUrl property is set.
        /// </summary>
        internal bool IsSetDocumentPresignedUrl() => this.DocumentPresignedUrl != null;
    }
}
