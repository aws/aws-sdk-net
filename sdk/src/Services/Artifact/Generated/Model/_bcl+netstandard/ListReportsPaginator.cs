...
{
    /// <summary>
    /// Base class for ListReports paginators.
    /// </summary>
    internal sealed partial class ListReportsPaginator : IPaginator<ListReportsResponse>, IListReportsPaginator
    {
        private readonly IAmazonArtifact _client;
        private readonly ListReportsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListReportsResponse> Responses => new PaginatedResponse<ListReportsResponse>(this);
...
#if BCL
        IEnumerable<ListReportsResponse> IPaginator<ListReportsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListReports(_request);
        ...
        async IAsyncEnumerable<ListReportsResponse> IPaginator<ListReportsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListReportsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
