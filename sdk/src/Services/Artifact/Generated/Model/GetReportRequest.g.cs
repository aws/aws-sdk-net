...
{
    /// <summary>
    /// Container for the parameters to the GetReport operation. Get the content for a single
    /// report.
    /// </summary>
    public partial class GetReportRequest : AmazonArtifactRequest
    {
        /// <summary>
        ...
        public string TermToken { get; set; }

        /// <summary>
        /// Checks to see if the TermToken property is set.
        /// </summary>
        internal bool IsSetTermToken() => this.TermToken != null;
    }
}
