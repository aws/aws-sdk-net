        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("activityId", targetDepth))
                {
                    ...
                    response.ActivityId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("estimatedTimeToCompleteInMinutes", targetDepth))
                {
                    ...
                    response.EstimatedTimeToCompleteInMinutes = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InstructionsUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("reward", targetDepth))
                {
                    var unmarshaller = ActivityRewardUnmarshaller.Instance;
                    response.Reward = unmarshaller.Unmarshall(context);
                    continue;
                }
