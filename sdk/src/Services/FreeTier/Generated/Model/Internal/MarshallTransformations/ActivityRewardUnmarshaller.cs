...
namespace Amazon.FreeTier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivityRewardUnmarshaller : IUnmarshaller<ActivityReward, XmlUnmarshallerContext>, IUnmarshaller<ActivityReward, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ActivityReward IUnmarshaller<ActivityReward, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ActivityReward Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("credit", targetDepth))
                {
                    ...
                    unmarshalledObject.Credit = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
