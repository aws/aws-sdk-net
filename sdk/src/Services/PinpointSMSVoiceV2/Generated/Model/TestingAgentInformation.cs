...
namespace Amazon.PinpointSMSVoiceV2.Model
{
    ...
    /// </summary>
    public partial class TestingAgentInformation
    {
        private string _registrationId;
        private TestingAgentStatus _status;
        private string _testingAgentId;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public TestingAgentStatus Status
        {
        ...
        /// <summary>
        /// Gets and sets the property TestingAgentId. 
        /// <para>
        /// The unique identifier for the testing agent.
        /// </para>
        /// </summary>
        public string TestingAgentId
        {
            get { return this._testingAgentId; }
            set { this._testingAgentId = value; }
        }

        // Check to see if TestingAgentId property is set
        internal bool IsSetTestingAgentId()
        {
            return this._testingAgentId != null;
        }
