...
namespace Amazon.PinpointSMSVoiceV2.Model
{
    ...
    /// thumbnail.
    /// </summary>
    public partial class RcsFileMessage
    {
        ...
        /// <para>
        /// The S3 URI of the media file to send, in the format <c>s3://bucket-name/key</c>. The
        /// service downloads the file from your S3 bucket, rehosts it, and generates a presigned
        /// URL for the aggregator. Maximum 2000 characters.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The S3 URI of an optional thumbnail image for the media file, in the format <c>s3://bucket-name/key</c>.
