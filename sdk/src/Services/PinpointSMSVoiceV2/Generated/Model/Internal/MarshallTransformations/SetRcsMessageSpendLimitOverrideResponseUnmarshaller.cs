...
{
    /// <summary>
    /// Response Unmarshaller for SetRcsMessageSpendLimitOverride operation
    /// </summary>  
    public class SetRcsMessageSpendLimitOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetRcsMessageSpendLimitOverrideResponse response = new SetRcsMessageSpendLimitOverrideResponse();
        ...
        private static SetRcsMessageSpendLimitOverrideResponseUnmarshaller _instance = new SetRcsMessageSpendLimitOverrideResponseUnmarshaller();        

        internal static SetRcsMessageSpendLimitOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetRcsMessageSpendLimitOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
