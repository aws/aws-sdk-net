...
{
    /// <summary>
    /// Response Unmarshaller for CreateOptOutList operation
    /// </summary>  
    public class CreateOptOutListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOptOutListResponse response = new CreateOptOutListResponse();
        ...
        private static CreateOptOutListResponseUnmarshaller _instance = new CreateOptOutListResponseUnmarshaller();        

        internal static CreateOptOutListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOptOutListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
