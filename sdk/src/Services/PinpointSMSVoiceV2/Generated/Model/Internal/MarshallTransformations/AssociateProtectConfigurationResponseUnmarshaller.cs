...
{
    /// <summary>
    /// Response Unmarshaller for AssociateProtectConfiguration operation
    /// </summary>  
    public class AssociateProtectConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateProtectConfigurationResponse response = new AssociateProtectConfigurationResponse();
        ...
        private static AssociateProtectConfigurationResponseUnmarshaller _instance = new AssociateProtectConfigurationResponseUnmarshaller();        

        internal static AssociateProtectConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateProtectConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
