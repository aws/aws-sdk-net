...
{
    /// <summary>
    /// Response Unmarshaller for PutOptedOutNumber operation
    /// </summary>  
    public class PutOptedOutNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutOptedOutNumberResponse response = new PutOptedOutNumberResponse();
        ...
        private static PutOptedOutNumberResponseUnmarshaller _instance = new PutOptedOutNumberResponseUnmarshaller();        

        internal static PutOptedOutNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutOptedOutNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
