...
{
    /// <summary>
    /// Response Unmarshaller for SubmitRegistrationVersion operation
    /// </summary>  
    public class SubmitRegistrationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubmitRegistrationVersionResponse response = new SubmitRegistrationVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegistrationVersionStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RegistrationVersionStatusHistory", targetDepth))
                {
                    ...
                    response.RegistrationVersionStatusHistory = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static SubmitRegistrationVersionResponseUnmarshaller _instance = new SubmitRegistrationVersionResponseUnmarshaller();        

        internal static SubmitRegistrationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitRegistrationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
