        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("MessageTypes", targetDepth))
                {
                    ...
                    response.MessageTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = BoolUnmarshaller.Instance;
                    response.Registered = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SenderIdArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
