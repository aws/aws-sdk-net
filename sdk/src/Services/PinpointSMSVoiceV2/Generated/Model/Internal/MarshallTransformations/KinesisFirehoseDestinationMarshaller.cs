...
namespace Amazon.PinpointSMSVoiceV2.Model.Internal.MarshallTransformations
{
    ...
    public class KinesisFirehoseDestinationMarshaller : IRequestMarshaller<KinesisFirehoseDestination, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(KinesisFirehoseDestination requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetDeliveryStreamArn())
            {
                context.Writer.WritePropertyName("DeliveryStreamArn");
                context.Writer.WriteStringValue(requestObject.DeliveryStreamArn);
            }
