...
{
    /// <summary>
    /// Response Unmarshaller for TemplateVariableMetadata Object
    /// </summary>  
    public class TemplateVariableMetadataUnmarshaller : IJsonUnmarshaller<TemplateVariableMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TemplateVariableMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TemplateVariableMetadata unmarshalledObject = new TemplateVariableMetadata();
        ...
        private static TemplateVariableMetadataUnmarshaller _instance = new TemplateVariableMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TemplateVariableMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
