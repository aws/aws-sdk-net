...
{
    /// <summary>
    /// Response Unmarshaller for DeleteOptOutList operation
    /// </summary>  
    public class DeleteOptOutListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteOptOutListResponse response = new DeleteOptOutListResponse();
        ...
        private static DeleteOptOutListResponseUnmarshaller _instance = new DeleteOptOutListResponseUnmarshaller();        

        internal static DeleteOptOutListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOptOutListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
