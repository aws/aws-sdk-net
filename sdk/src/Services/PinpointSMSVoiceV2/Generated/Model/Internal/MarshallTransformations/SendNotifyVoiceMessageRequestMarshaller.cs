...
{
    /// <summary>
    /// SendNotifyVoiceMessage Request Marshaller
    /// </summary>       
    public class SendNotifyVoiceMessageRequestMarshaller : IMarshaller<IRequest, SendNotifyVoiceMessageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendNotifyVoiceMessageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendNotifyVoiceMessageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PinpointSMSVoiceV2");
            string target = "PinpointSMSVoiceV2.SendNotifyVoiceMessage";
            ...
            if(publicRequest.IsSetNotifyConfigurationId())
            {
                context.Writer.WritePropertyName("NotifyConfigurationId");
                context.Writer.WriteStringValue(publicRequest.NotifyConfigurationId);
            }
            ...
            if(publicRequest.IsSetTemplateVariables())
            {
                context.Writer.WritePropertyName("TemplateVariables");
                context.Writer.WriteStartObject();
                foreach (var publicRequestTemplateVariablesKvp in publicRequest.TemplateVariables)
                {
                    context.Writer.WritePropertyName(publicRequestTemplateVariablesKvp.Key);
                    var publicRequestTemplateVariablesValue = publicRequestTemplateVariablesKvp.Value;

                        context.Writer.WriteStringValue(publicRequestTemplateVariablesValue);
                }
                context.Writer.WriteEndObject();
            }
        ...
        private static SendNotifyVoiceMessageRequestMarshaller _instance = new SendNotifyVoiceMessageRequestMarshaller();        

        internal static SendNotifyVoiceMessageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendNotifyVoiceMessageRequestMarshaller Instance
        {
            get
            {
                return _instance;
