    ...
    public class DescribeAccountLimitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AccountLimit, AccountLimitUnmarshaller>(AccountLimitUnmarshaller.Instance);
                    response.AccountLimits = unmarshaller.Unmarshall(context);
                    continue;
                }
