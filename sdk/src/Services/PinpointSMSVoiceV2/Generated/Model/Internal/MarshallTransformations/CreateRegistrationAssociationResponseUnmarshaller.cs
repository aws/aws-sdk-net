...
{
    /// <summary>
    /// Response Unmarshaller for CreateRegistrationAssociation operation
    /// </summary>  
    public class CreateRegistrationAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRegistrationAssociationResponse response = new CreateRegistrationAssociationResponse();
        ...
        private static CreateRegistrationAssociationResponseUnmarshaller _instance = new CreateRegistrationAssociationResponseUnmarshaller();        

        internal static CreateRegistrationAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRegistrationAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
