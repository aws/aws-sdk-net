...
{
    /// <summary>
    /// Response Unmarshaller for CreateNotifyConfiguration operation
    /// </summary>  
    public class CreateNotifyConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateNotifyConfigurationResponse response = new CreateNotifyConfigurationResponse();
        ...
        private static CreateNotifyConfigurationResponseUnmarshaller _instance = new CreateNotifyConfigurationResponseUnmarshaller();        

        internal static CreateNotifyConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNotifyConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
