...
{
    /// <summary>
    /// Response Unmarshaller for SendTextMessage operation
    /// </summary>  
    public class SendTextMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SendTextMessageResponseUnmarshaller _instance = new SendTextMessageResponseUnmarshaller();        

        internal static SendTextMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendTextMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
