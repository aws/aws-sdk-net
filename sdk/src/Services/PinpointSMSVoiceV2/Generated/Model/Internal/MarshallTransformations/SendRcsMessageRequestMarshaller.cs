...
{
    /// <summary>
    /// SendRcsMessage Request Marshaller
    /// </summary>       
    public class SendRcsMessageRequestMarshaller : IMarshaller<IRequest, SendRcsMessageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendRcsMessageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendRcsMessageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PinpointSMSVoiceV2");
            string target = "PinpointSMSVoiceV2.SendRcsMessage";
            ...
            if(publicRequest.IsSetFallbackConfiguration())
            {
                context.Writer.WritePropertyName("FallbackConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = RcsFallbackConfigurationMarshaller.Instance;
                marshaller.Marshall(publicRequest.FallbackConfiguration, context);
            ...
            if(publicRequest.IsSetMessageTrafficType())
            {
                context.Writer.WritePropertyName("MessageTrafficType");
                context.Writer.WriteStringValue(publicRequest.MessageTrafficType);
            }
            ...
            if(publicRequest.IsSetRcsMessageContent())
            {
                context.Writer.WritePropertyName("RcsMessageContent");
                context.Writer.WriteStartObject();

                var marshaller = RcsMessageContentMarshaller.Instance;
                marshaller.Marshall(publicRequest.RcsMessageContent, context);
        ...
        private static SendRcsMessageRequestMarshaller _instance = new SendRcsMessageRequestMarshaller();        

        internal static SendRcsMessageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendRcsMessageRequestMarshaller Instance
        {
            get
            {
                return _instance;
