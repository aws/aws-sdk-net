...
{
    /// <summary>
    /// Response Unmarshaller for CreateProtectConfiguration operation
    /// </summary>  
    public class CreateProtectConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProtectConfigurationResponse response = new CreateProtectConfigurationResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AccountDefault", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.AccountDefault = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateProtectConfigurationResponseUnmarshaller _instance = new CreateProtectConfigurationResponseUnmarshaller();        

        internal static CreateProtectConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProtectConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
