...
{
    /// <summary>
    /// SendNotifyTextMessage Request Marshaller
    /// </summary>       
    public class SendNotifyTextMessageRequestMarshaller : IMarshaller<IRequest, SendNotifyTextMessageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendNotifyTextMessageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendNotifyTextMessageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PinpointSMSVoiceV2");
            string target = "PinpointSMSVoiceV2.SendNotifyTextMessage";
        ...
        private static SendNotifyTextMessageRequestMarshaller _instance = new SendNotifyTextMessageRequestMarshaller();        

        internal static SendNotifyTextMessageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendNotifyTextMessageRequestMarshaller Instance
        {
            get
            {
                return _instance;
