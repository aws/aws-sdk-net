...
{
    /// <summary>
    /// Response Unmarshaller for ConditionalValidation Object
    /// </summary>  
    public class ConditionalValidationUnmarshaller : IJsonUnmarshaller<ConditionalValidation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConditionalValidation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ConditionalValidation unmarshalledObject = new ConditionalValidation();
        ...
        private static ConditionalValidationUnmarshaller _instance = new ConditionalValidationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConditionalValidationUnmarshaller Instance
        {
            get
            {
                return _instance;
