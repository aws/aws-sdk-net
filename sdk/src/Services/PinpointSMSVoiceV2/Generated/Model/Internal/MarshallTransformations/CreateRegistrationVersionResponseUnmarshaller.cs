...
{
    /// <summary>
    /// Response Unmarshaller for CreateRegistrationVersion operation
    /// </summary>  
    public class CreateRegistrationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRegistrationVersionResponse response = new CreateRegistrationVersionResponse();
        ...
        private static CreateRegistrationVersionResponseUnmarshaller _instance = new CreateRegistrationVersionResponseUnmarshaller();        

        internal static CreateRegistrationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRegistrationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
