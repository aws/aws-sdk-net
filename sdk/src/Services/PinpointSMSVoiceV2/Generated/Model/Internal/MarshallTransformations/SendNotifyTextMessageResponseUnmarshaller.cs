...
{
    /// <summary>
    /// Response Unmarshaller for SendNotifyTextMessage operation
    /// </summary>  
    public class SendNotifyTextMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendNotifyTextMessageResponse response = new SendNotifyTextMessageResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ResolvedMessageBody", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResolvedMessageBody = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SendNotifyTextMessageResponseUnmarshaller _instance = new SendNotifyTextMessageResponseUnmarshaller();        

        internal static SendNotifyTextMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendNotifyTextMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
