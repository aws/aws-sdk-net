...
{
    /// <summary>
    /// Response Unmarshaller for SendRcsMessage operation
    /// </summary>  
    public class SendRcsMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendRcsMessageResponse response = new SendRcsMessageResponse();
        ...
        private static SendRcsMessageResponseUnmarshaller _instance = new SendRcsMessageResponseUnmarshaller();        

        internal static SendRcsMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendRcsMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
