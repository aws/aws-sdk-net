        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AdditionalAttributes", targetDepth))
                {
                    ...
                    response.AdditionalAttributes = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("CurrentVersionNumber", targetDepth))
                {
                    ...
                    response.CurrentVersionNumber = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegistrationStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
