...
{
    /// <summary>
    /// Response Unmarshaller for CreateRegistration operation
    /// </summary>  
    public class CreateRegistrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AdditionalAttributes", targetDepth, ref reader))
                {
                    ...
                    response.AdditionalAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("CurrentVersionNumber", targetDepth, ref reader))
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.CurrentVersionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RegistrationStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateRegistrationResponseUnmarshaller _instance = new CreateRegistrationResponseUnmarshaller();        

        internal static CreateRegistrationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRegistrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
