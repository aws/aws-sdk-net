...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRcsAgent operation
    /// </summary>  
    public class UpdateRcsAgentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRcsAgentResponse response = new UpdateRcsAgentResponse();
        ...
        private static UpdateRcsAgentResponseUnmarshaller _instance = new UpdateRcsAgentResponseUnmarshaller();        

        internal static UpdateRcsAgentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRcsAgentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
