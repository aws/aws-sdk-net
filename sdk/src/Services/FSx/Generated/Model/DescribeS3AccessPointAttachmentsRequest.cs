...
{
    /// <summary>
    /// Container for the parameters to the DescribeS3AccessPointAttachments operation.
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class DescribeS3AccessPointAttachmentsRequest : AmazonFSxRequest
    {
        private List<S3AccessPointAttachmentsFilter> _filters = AWSConfigs.InitializeCollections ? new List<S3AccessPointAttachmentsFilter>() : null;
        ...
        /// </summary>
        [AWSProperty(Max=2)]
        public List<S3AccessPointAttachmentsFilter> Filters
        {
