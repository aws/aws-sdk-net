...
{
    /// <summary>
    /// Specifies the FSx for ONTAP volume that the S3 access point will be attached to, and
    /// the file system user identity.
    /// </summary>
    public partial class CreateAndAttachS3AccessPointOntapConfiguration
    {
