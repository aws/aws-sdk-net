...
namespace Amazon.FSx.Model
{
    ...
    [Serializable]
    #endif
    public partial class TooManyAccessPointsException : AmazonFSxException
    {
        ...
        public TooManyAccessPointsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyAccessPointsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected TooManyAccessPointsException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
