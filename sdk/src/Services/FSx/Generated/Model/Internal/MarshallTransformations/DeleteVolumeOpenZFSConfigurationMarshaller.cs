...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteVolumeOpenZFSConfigurationMarshaller : IRequestMarshaller<DeleteVolumeOpenZFSConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DeleteVolumeOpenZFSConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetOptions())
            {
                ...
                {
                        context.Writer.WriteStringValue(requestObjectOptionsListValue);
                }
