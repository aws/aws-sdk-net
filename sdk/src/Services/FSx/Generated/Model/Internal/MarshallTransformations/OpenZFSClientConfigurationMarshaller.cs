...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    public class OpenZFSClientConfigurationMarshaller : IRequestMarshaller<OpenZFSClientConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(OpenZFSClientConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetClients())
            {
                context.Writer.WritePropertyName("Clients");
                context.Writer.WriteStringValue(requestObject.Clients);
            }
