...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    public class FileCacheCreatingUnmarshaller : IJsonUnmarshaller<FileCacheCreating, JsonUnmarshallerContext>
    {
        ...
        public FileCacheCreating Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CopyTagsToDataRepositoryAssociations", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("DataRepositoryAssociationIds", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("FileCacheType", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileCacheType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("FileCacheTypeVersion", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
