...
{
    /// <summary>
    /// Response Unmarshaller for RestoreVolumeFromSnapshot operation
    /// </summary>  
    public class RestoreVolumeFromSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreVolumeFromSnapshotResponse response = new RestoreVolumeFromSnapshotResponse();
            ...
            {
                if (context.TestExpression("AdministrativeActions", targetDepth, ref reader))
                {
                    ...
                    response.AdministrativeActions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RestoreVolumeFromSnapshotResponseUnmarshaller _instance = new RestoreVolumeFromSnapshotResponseUnmarshaller();        

        internal static RestoreVolumeFromSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreVolumeFromSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
