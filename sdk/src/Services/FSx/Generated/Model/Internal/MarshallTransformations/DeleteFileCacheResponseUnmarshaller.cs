...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFileCache operation
    /// </summary>  
    public class DeleteFileCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFileCacheResponse response = new DeleteFileCacheResponse();
            ...
            {
                if (context.TestExpression("FileCacheId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FileCacheId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("FileCacheNotFound"))
                {
                    return FileCacheNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static DeleteFileCacheResponseUnmarshaller _instance = new DeleteFileCacheResponseUnmarshaller();        

        internal static DeleteFileCacheResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFileCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
