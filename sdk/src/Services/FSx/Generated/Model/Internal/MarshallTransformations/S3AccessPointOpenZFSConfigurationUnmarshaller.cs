...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3AccessPointOpenZFSConfigurationUnmarshaller : IUnmarshaller<S3AccessPointOpenZFSConfiguration, XmlUnmarshallerContext>, IUnmarshaller<S3AccessPointOpenZFSConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        S3AccessPointOpenZFSConfiguration IUnmarshaller<S3AccessPointOpenZFSConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public S3AccessPointOpenZFSConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("FileSystemIdentity", targetDepth))
                {
                    ...
                    unmarshalledObject.FileSystemIdentity = unmarshaller.Unmarshall(context);
                    continue;
                }
