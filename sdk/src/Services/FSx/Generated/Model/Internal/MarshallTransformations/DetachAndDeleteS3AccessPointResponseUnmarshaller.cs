...
{
    /// <summary>
    /// Response Unmarshaller for DetachAndDeleteS3AccessPoint operation
    /// </summary>  
    public class DetachAndDeleteS3AccessPointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachAndDeleteS3AccessPointResponse response = new DetachAndDeleteS3AccessPointResponse();
        ...
        private static DetachAndDeleteS3AccessPointResponseUnmarshaller _instance = new DetachAndDeleteS3AccessPointResponseUnmarshaller();        

        internal static DetachAndDeleteS3AccessPointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachAndDeleteS3AccessPointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
