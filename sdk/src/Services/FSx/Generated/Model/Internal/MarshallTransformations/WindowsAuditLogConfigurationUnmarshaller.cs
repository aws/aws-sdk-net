...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    public class WindowsAuditLogConfigurationUnmarshaller : IJsonUnmarshaller<WindowsAuditLogConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static WindowsAuditLogConfigurationUnmarshaller _instance = new WindowsAuditLogConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WindowsAuditLogConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
