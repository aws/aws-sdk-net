    ...
    public class DescribeS3AccessPointAttachmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<S3AccessPointAttachment, S3AccessPointAttachmentUnmarshaller>(S3AccessPointAttachmentUnmarshaller.Instance);
                    response.S3AccessPointAttachments = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return S3AccessPointAttachmentNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
