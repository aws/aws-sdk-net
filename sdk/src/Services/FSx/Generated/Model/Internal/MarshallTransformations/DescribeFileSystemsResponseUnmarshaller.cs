...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeFileSystemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("FileSystems", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<FileSystem, FileSystemUnmarshaller>(FileSystemUnmarshaller.Instance);
                    response.FileSystems = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeFileSystemsResponseUnmarshaller _instance = new DescribeFileSystemsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFileSystemsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
