    ...
    public class DescribeFileSystemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FileSystem, FileSystemUnmarshaller>(FileSystemUnmarshaller.Instance);
                    response.FileSystems = unmarshaller.Unmarshall(context);
                    continue;
                }
