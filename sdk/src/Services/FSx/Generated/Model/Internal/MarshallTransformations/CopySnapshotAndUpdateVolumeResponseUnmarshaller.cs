...
{
    /// <summary>
    /// Response Unmarshaller for CopySnapshotAndUpdateVolume operation
    /// </summary>  
    public class CopySnapshotAndUpdateVolumeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CopySnapshotAndUpdateVolumeResponse response = new CopySnapshotAndUpdateVolumeResponse();
        ...
        private static CopySnapshotAndUpdateVolumeResponseUnmarshaller _instance = new CopySnapshotAndUpdateVolumeResponseUnmarshaller();        

        internal static CopySnapshotAndUpdateVolumeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CopySnapshotAndUpdateVolumeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
