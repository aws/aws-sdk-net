    ...
    public class OpenZFSOriginSnapshotConfigurationUnmarshaller : IJsonUnmarshaller<OpenZFSOriginSnapshotConfiguration, JsonUnmarshallerContext>
    {
        ...
        public OpenZFSOriginSnapshotConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SnapshotARN", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static OpenZFSOriginSnapshotConfigurationUnmarshaller _instance = new OpenZFSOriginSnapshotConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OpenZFSOriginSnapshotConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
