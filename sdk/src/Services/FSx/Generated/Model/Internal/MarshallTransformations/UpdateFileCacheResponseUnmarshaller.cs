...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFileCache operation
    /// </summary>  
    public class UpdateFileCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFileCacheResponse response = new UpdateFileCacheResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("FileCache", targetDepth))
                {
                    ...
                    response.FileCache = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MissingFileCacheConfiguration"))
                {
                    return MissingFileCacheConfigurationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateFileCacheResponseUnmarshaller _instance = new UpdateFileCacheResponseUnmarshaller();        

        internal static UpdateFileCacheResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFileCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
