...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataRepositoryAssociation operation
    /// </summary>  
    public class CreateDataRepositoryAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataRepositoryAssociationResponse response = new CreateDataRepositoryAssociationResponse();
        ...
        private static CreateDataRepositoryAssociationResponseUnmarshaller _instance = new CreateDataRepositoryAssociationResponseUnmarshaller();        

        internal static CreateDataRepositoryAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataRepositoryAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
