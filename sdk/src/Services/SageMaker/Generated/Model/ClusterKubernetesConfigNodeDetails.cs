...
{
    /// <summary>
    /// Node-specific Kubernetes configuration showing both current and desired state of labels
    /// and taints for an individual cluster node.
    /// </summary>
    public partial class ClusterKubernetesConfigNodeDetails
    {
