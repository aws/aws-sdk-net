...
{
    /// <summary>
    /// This is the response object from the BatchRebootClusterNodes operation.
    /// </summary>
    public partial class BatchRebootClusterNodesResponse : AmazonWebServiceResponse
    {
        private List<BatchRebootClusterNodesError> _failed = AWSConfigs.InitializeCollections ? new List<BatchRebootClusterNodesError>() : null;
        private List<BatchRebootClusterNodeLogicalIdsError> _failedNodeLogicalIds = AWSConfigs.InitializeCollections ? new List<BatchRebootClusterNodeLogicalIdsError>() : null;
        ...
        /// <para>
        /// A list of errors encountered for EC2 instance IDs that could not be rebooted. Each
        /// error includes the instance ID, an error code, and a descriptive message.
        /// </para>
        /// </summary>
        [AWSProperty(Min=0, Max=25)]
        public List<BatchRebootClusterNodesError> Failed
        {
        ...
        /// <para>
        /// A list of errors encountered for logical node IDs that could not be rebooted. Each
        ...
        /// </summary>
        [AWSProperty(Min=0, Max=25)]
        public List<BatchRebootClusterNodeLogicalIdsError> FailedNodeLogicalIds
        {
        ...
        /// <para>
        /// A list of logical node IDs for which the reboot operation was successfully initiated.
