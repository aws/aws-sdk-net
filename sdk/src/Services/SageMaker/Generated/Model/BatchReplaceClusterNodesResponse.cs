...
{
    /// <summary>
    /// This is the response object from the BatchReplaceClusterNodes operation.
    /// </summary>
    public partial class BatchReplaceClusterNodesResponse : AmazonWebServiceResponse
    {
        private List<BatchReplaceClusterNodesError> _failed = AWSConfigs.InitializeCollections ? new List<BatchReplaceClusterNodesError>() : null;
        private List<BatchReplaceClusterNodeLogicalIdsError> _failedNodeLogicalIds = AWSConfigs.InitializeCollections ? new List<BatchReplaceClusterNodeLogicalIdsError>() : null;
        ...
        /// <para>
        /// A list of errors encountered for EC2 instance IDs that could not be replaced. Each
        /// error includes the instance ID, an error code, and a descriptive message.
        /// </para>
        /// </summary>
        [AWSProperty(Min=0, Max=25)]
        public List<BatchReplaceClusterNodesError> Failed
        {
        ...
        /// <para>
        /// A list of errors encountered for logical node IDs that could not be replaced. Each
        /// error includes the logical node ID, an error code, and a descriptive message. This
        /// field is only present when <c>NodeLogicalIds</c> were provided in the request.
        /// </para>
        /// </summary>
        [AWSProperty(Min=0, Max=25)]
        public List<BatchReplaceClusterNodeLogicalIdsError> FailedNodeLogicalIds
        {
        ...
        /// This field is only present when <c>NodeLogicalIds</c> were provided in the request.
        /// </para>
        /// </summary>
