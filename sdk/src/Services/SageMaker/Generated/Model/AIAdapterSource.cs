...
{
    /// <summary>
    /// The source of LoRA adapters for an AI recommendation job. This is a union type — specify
    /// exactly one of the members.
    /// </summary>
    public partial class AIAdapterSource
    {
        ...
        /// <para>
        /// A list of LoRA adapters identified by their model package ARNs. Use this when your
        ...
        /// <para>
        /// A list of LoRA adapters identified by their Amazon S3 URIs. Use this when your adapters
        /// are stored as raw artifacts in Amazon S3.
        /// </para>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
