...
{
    /// <summary>
    /// The output configuration for an AI recommendation job, including the S3 location for
    /// results and the model package group for deployment.
    /// </summary>
    public partial class AIRecommendationOutputResult
    {
        ...
        /// <para>
        /// The name or Amazon Resource Name (ARN) of the model package group where deployment-ready
        /// model packages are registered.
        /// </para>
        /// </summary>
