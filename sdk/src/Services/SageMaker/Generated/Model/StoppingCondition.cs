...
{
    /// <summary>
    /// Specifies how long a model training or compilation job can run. When the job reaches
    /// the limit, Amazon SageMaker ends the training job. Use this API to cap model processing
    /// cost.
    /// 
    ///  
    /// <para>
    /// To stop a job, Amazon SageMaker sends the algorithm the <code>SIGTERM</code> signal,
    /// which delays job termination for 120 seconds. Algorithms might use this 120-second
    ...
    public partial class StoppingCondition
    {
        ...
        /// is not specified, default value is 1 day. Maximum value is 5 days.
        /// </para>
        /// </summary>
