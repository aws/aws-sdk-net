...
{
    /// <summary>
    /// Container for the parameters to the ListAIWorkloadConfigs operation.
    ...
    /// </summary>
    public partial class ListAIWorkloadConfigsRequest : AmazonSageMakerRequest
    {
        ...
        private ListAIWorkloadConfigsSortBy _sortBy;
        ...
        /// <para>
        /// A string in the configuration name. This filter returns only configurations whose
        ...
        /// <para>
        /// If the previous call to <c>ListAIWorkloadConfigs</c> didn't return the full set of
        /// configurations, the call returns a token for getting the next set of configurations.
        /// </para>
        /// </summary>
        ...
        /// </para>
        /// </summary>
        public ListAIWorkloadConfigsSortBy SortBy
        {
