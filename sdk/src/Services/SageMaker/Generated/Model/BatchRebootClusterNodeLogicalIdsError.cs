...
{
    /// <summary>
    /// Represents an error encountered when rebooting a node (identified by its logical node
    /// ID) from a SageMaker HyperPod cluster.
    /// </summary>
    public partial class BatchRebootClusterNodeLogicalIdsError
    {
        ...
        /// <para>
        /// The error code associated with the error encountered when rebooting a node by logical
        /// node ID.
        /// </para>
        ///  
        /// <para>
        ...
        ///  </li> <li> 
        /// <para>
        ///  <c>InvalidInstanceStatus</c>: The node is in a state that does not allow rebooting.
        ...
        /// <para>
        /// A human-readable message describing the error encountered when rebooting a node by
        /// logical node ID.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
