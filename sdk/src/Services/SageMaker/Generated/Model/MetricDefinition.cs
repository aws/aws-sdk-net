...
namespace Amazon.SageMaker.Model
{
    ...
    /// SageMakerhyperparameter tuning captures all defined metrics. You specify one metric
    /// that a hyperparameter tuning job uses as its objective metric to choose the best training
    /// job.
    /// </summary>
