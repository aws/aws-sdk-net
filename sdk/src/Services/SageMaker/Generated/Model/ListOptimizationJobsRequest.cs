...
{
    /// <summary>
    /// Container for the parameters to the ListOptimizationJobs operation.
    /// Lists the optimization jobs in your account and their properties.
    /// </summary>
    public partial class ListOptimizationJobsRequest : AmazonSageMakerRequest
    {
        ...
        private string _optimizationContains;
        private ListOptimizationJobsSortBy _sortBy;
        private SortOrder _sortOrder;
        private OptimizationJobStatus _statusEquals;

        /// <summary>
        /// Gets and sets the property CreationTimeAfter. 
        /// <para>
        /// Filters the results to only those optimization jobs that were created after the specified
        /// time.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Filters the results to only those optimization jobs that were created before the specified
        /// time.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Filters the results to only those optimization jobs that were updated after the specified
        /// time.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Filters the results to only those optimization jobs that were updated before the specified
        /// time.
        /// </para>
        /// </summary>
        ...
        public string OptimizationContains
        {
            ...
            set { this._optimizationContains = value; }
        }

        // Check to see if OptimizationContains property is set
        internal bool IsSetOptimizationContains()
        {
            return this._optimizationContains != null;
        }

        /// <summary>
        /// Gets and sets the property SortBy. 
        /// <para>
        /// The field by which to sort the optimization jobs in the response. The default is <c>CreationTime</c>
        /// 
        /// </para>
        /// </summary>
        public ListOptimizationJobsSortBy SortBy
        {
        ...
        /// </para>
        /// </summary>
        public OptimizationJobStatus StatusEquals
        {
