...
{
    /// <summary>
    /// Response Unmarshaller for CreateModelQualityJobDefinition operation
    /// </summary>  
    public class CreateModelQualityJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelQualityJobDefinitionResponse response = new CreateModelQualityJobDefinitionResponse();
        ...
        private static CreateModelQualityJobDefinitionResponseUnmarshaller _instance = new CreateModelQualityJobDefinitionResponseUnmarshaller();        

        internal static CreateModelQualityJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelQualityJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
