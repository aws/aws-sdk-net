...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DynamicScalingConfigurationUnmarshaller : IUnmarshaller<DynamicScalingConfiguration, XmlUnmarshallerContext>, IUnmarshaller<DynamicScalingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DynamicScalingConfiguration IUnmarshaller<DynamicScalingConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DynamicScalingConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
