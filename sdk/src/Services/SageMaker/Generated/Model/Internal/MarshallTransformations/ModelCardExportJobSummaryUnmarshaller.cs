...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelCardExportJobSummaryUnmarshaller : IUnmarshaller<ModelCardExportJobSummary, XmlUnmarshallerContext>, IUnmarshaller<ModelCardExportJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ModelCardExportJobSummary IUnmarshaller<ModelCardExportJobSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ModelCardExportJobSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ModelCardExportJobArn", targetDepth))
                {
                    ...
                    unmarshalledObject.ModelCardExportJobArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ModelCardExportJobName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ModelCardExportJobName = unmarshaller.Unmarshall(context);
                    continue;
                }
