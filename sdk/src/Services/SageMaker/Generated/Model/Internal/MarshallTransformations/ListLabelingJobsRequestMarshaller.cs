...
{
    /// <summary>
    /// ListLabelingJobs Request Marshaller
    /// </summary>       
    public class ListLabelingJobsRequestMarshaller : IMarshaller<IRequest, ListLabelingJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLabelingJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListLabelingJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListLabelingJobs";
        ...
        private static ListLabelingJobsRequestMarshaller _instance = new ListLabelingJobsRequestMarshaller();        

        internal static ListLabelingJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLabelingJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
