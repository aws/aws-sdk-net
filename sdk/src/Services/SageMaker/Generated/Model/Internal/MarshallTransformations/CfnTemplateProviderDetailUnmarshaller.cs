...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CfnTemplateProviderDetailUnmarshaller : IUnmarshaller<CfnTemplateProviderDetail, XmlUnmarshallerContext>, IUnmarshaller<CfnTemplateProviderDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CfnTemplateProviderDetail IUnmarshaller<CfnTemplateProviderDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CfnTemplateProviderDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CfnStackParameter, CfnStackParameterUnmarshaller>(CfnStackParameterUnmarshaller.Instance);
                ...
                if (context.TestExpression("StackDetail", targetDepth))
                {
                    ...
                    unmarshalledObject.StackDetail = unmarshaller.Unmarshall(context);
                    continue;
                }
