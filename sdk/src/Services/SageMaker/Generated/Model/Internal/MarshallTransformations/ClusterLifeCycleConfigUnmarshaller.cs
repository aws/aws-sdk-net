...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusterLifeCycleConfigUnmarshaller : IUnmarshaller<ClusterLifeCycleConfig, XmlUnmarshallerContext>, IUnmarshaller<ClusterLifeCycleConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ClusterLifeCycleConfig IUnmarshaller<ClusterLifeCycleConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ClusterLifeCycleConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("OnCreate", targetDepth))
                {
                    ...
                    unmarshalledObject.OnCreate = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SourceS3Uri", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SourceS3Uri = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
