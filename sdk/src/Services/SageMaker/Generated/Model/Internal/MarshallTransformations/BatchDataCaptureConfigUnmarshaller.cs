...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDataCaptureConfigUnmarshaller : IJsonUnmarshaller<BatchDataCaptureConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchDataCaptureConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("GenerateInferenceId", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.GenerateInferenceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
