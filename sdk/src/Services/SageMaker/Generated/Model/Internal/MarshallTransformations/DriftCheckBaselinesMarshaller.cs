...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class DriftCheckBaselinesMarshaller : IRequestMarshaller<DriftCheckBaselines, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DriftCheckBaselines requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetBias())
            {
                ...
                var marshaller = DriftCheckBiasMarshaller.Instance;
            ...
            if(requestObject.IsSetExplainability())
            {
                ...
                var marshaller = DriftCheckExplainabilityMarshaller.Instance;
            ...
            if(requestObject.IsSetModelDataQuality())
            {
                ...
                var marshaller = DriftCheckModelDataQualityMarshaller.Instance;
            ...
            if(requestObject.IsSetModelQuality())
            {
                ...
                var marshaller = DriftCheckModelQualityMarshaller.Instance;
