...
{
    /// <summary>
    /// ListModelExplainabilityJobDefinitions Request Marshaller
    /// </summary>       
    public class ListModelExplainabilityJobDefinitionsRequestMarshaller : IMarshaller<IRequest, ListModelExplainabilityJobDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListModelExplainabilityJobDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListModelExplainabilityJobDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListModelExplainabilityJobDefinitions";
        ...
        private static ListModelExplainabilityJobDefinitionsRequestMarshaller _instance = new ListModelExplainabilityJobDefinitionsRequestMarshaller();        

        internal static ListModelExplainabilityJobDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelExplainabilityJobDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
