...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ListAppsRequestMarshaller : IMarshaller<IRequest, ListAppsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListAppsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetDomainIdEquals())
            {
                context.Writer.WritePropertyName("DomainIdEquals");
                context.Writer.WriteStringValue(publicRequest.DomainIdEquals);
            }
            ...
            if(publicRequest.IsSetSpaceNameEquals())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.SpaceNameEquals);
            }

            if(publicRequest.IsSetUserProfileNameEquals())
            {
                context.Writer.WritePropertyName("UserProfileNameEquals");
                context.Writer.WriteStringValue(publicRequest.UserProfileNameEquals);
            }
