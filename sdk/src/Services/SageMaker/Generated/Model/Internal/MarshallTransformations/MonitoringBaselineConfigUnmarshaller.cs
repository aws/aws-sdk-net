...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MonitoringBaselineConfigUnmarshaller : IJsonUnmarshaller<MonitoringBaselineConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MonitoringBaselineConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("StatisticsResource", targetDepth, ref reader))
                {
                    var unmarshaller = MonitoringStatisticsResourceUnmarshaller.Instance;
                    unmarshalledObject.StatisticsResource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
