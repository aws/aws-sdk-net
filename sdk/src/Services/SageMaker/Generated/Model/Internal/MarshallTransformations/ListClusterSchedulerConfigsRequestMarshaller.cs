...
{
    /// <summary>
    /// ListClusterSchedulerConfigs Request Marshaller
    /// </summary>       
    public class ListClusterSchedulerConfigsRequestMarshaller : IMarshaller<IRequest, ListClusterSchedulerConfigsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListClusterSchedulerConfigsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListClusterSchedulerConfigsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListClusterSchedulerConfigs";
        ...
        private static ListClusterSchedulerConfigsRequestMarshaller _instance = new ListClusterSchedulerConfigsRequestMarshaller();        

        internal static ListClusterSchedulerConfigsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClusterSchedulerConfigsRequestMarshaller Instance
        {
            get
            {
                return _instance;
