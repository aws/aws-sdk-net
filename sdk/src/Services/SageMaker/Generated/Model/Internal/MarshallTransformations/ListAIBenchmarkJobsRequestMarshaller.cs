...
{
    /// <summary>
    /// ListAIBenchmarkJobs Request Marshaller
    /// </summary>       
    public class ListAIBenchmarkJobsRequestMarshaller : IMarshaller<IRequest, ListAIBenchmarkJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAIBenchmarkJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAIBenchmarkJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListAIBenchmarkJobs";
        ...
        private static ListAIBenchmarkJobsRequestMarshaller _instance = new ListAIBenchmarkJobsRequestMarshaller();        

        internal static ListAIBenchmarkJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAIBenchmarkJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
