...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FlowDefinitionSummaryUnmarshaller : IUnmarshaller<FlowDefinitionSummary, XmlUnmarshallerContext>, IUnmarshaller<FlowDefinitionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FlowDefinitionSummary IUnmarshaller<FlowDefinitionSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public FlowDefinitionSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FlowDefinitionArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FlowDefinitionName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FlowDefinitionName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FlowDefinitionStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FlowDefinitionStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
