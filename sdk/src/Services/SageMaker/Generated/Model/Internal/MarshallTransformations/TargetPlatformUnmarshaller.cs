...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetPlatformUnmarshaller : IUnmarshaller<TargetPlatform, XmlUnmarshallerContext>, IUnmarshaller<TargetPlatform, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TargetPlatform IUnmarshaller<TargetPlatform, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TargetPlatform Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Accelerator", targetDepth))
                {
                    ...
                    unmarshalledObject.Accelerator = unmarshaller.Unmarshall(context);
                    continue;
                }
