...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class TrialComponentStatusMarshaller : IRequestMarshaller<TrialComponentStatus, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(TrialComponentStatus requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPrimaryStatus())
            {
                context.Writer.WritePropertyName("PrimaryStatus");
                context.Writer.WriteStringValue(requestObject.PrimaryStatus);
            }
