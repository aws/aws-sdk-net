...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineVersionSummaryUnmarshaller : IUnmarshaller<PipelineVersionSummary, XmlUnmarshallerContext>, IUnmarshaller<PipelineVersionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PipelineVersionSummary IUnmarshaller<PipelineVersionSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PipelineVersionSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("LastExecutionPipelineExecutionArn", targetDepth))
                {
                    ...
                    unmarshalledObject.LastExecutionPipelineExecutionArn = unmarshaller.Unmarshall(context);
                    continue;
                }
