    ...
    public class DescribeInferenceRecommendationsJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InferenceRecommendation, InferenceRecommendationUnmarshaller>(InferenceRecommendationUnmarshaller.Instance);
                    response.InferenceRecommendations = unmarshaller.Unmarshall(context);
                    continue;
                }
