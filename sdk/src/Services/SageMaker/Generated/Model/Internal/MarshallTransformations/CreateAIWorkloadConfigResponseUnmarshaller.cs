...
{
    /// <summary>
    /// Response Unmarshaller for CreateAIWorkloadConfig operation
    /// </summary>  
    public class CreateAIWorkloadConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAIWorkloadConfigResponse response = new CreateAIWorkloadConfigResponse();
        ...
        private static CreateAIWorkloadConfigResponseUnmarshaller _instance = new CreateAIWorkloadConfigResponseUnmarshaller();        

        internal static CreateAIWorkloadConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIWorkloadConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
