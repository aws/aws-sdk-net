...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAIBenchmarkJob operation
    /// </summary>  
    public class DescribeAIBenchmarkJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAIBenchmarkJobResponse response = new DescribeAIBenchmarkJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AIBenchmarkJobName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AIBenchmarkJobStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AIBenchmarkJobStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("BenchmarkTarget", targetDepth, ref reader))
                {
                    var unmarshaller = AIBenchmarkTargetUnmarshaller.Instance;
                    response.BenchmarkTarget = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = AIBenchmarkNetworkConfigUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = AIBenchmarkOutputResultUnmarshaller.Instance;
        ...
        private static DescribeAIBenchmarkJobResponseUnmarshaller _instance = new DescribeAIBenchmarkJobResponseUnmarshaller();        

        internal static DescribeAIBenchmarkJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAIBenchmarkJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
