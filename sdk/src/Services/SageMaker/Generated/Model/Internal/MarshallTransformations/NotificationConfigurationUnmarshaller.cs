...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class NotificationConfigurationUnmarshaller : IJsonUnmarshaller<NotificationConfiguration, JsonUnmarshallerContext>
    {
        ...
        public NotificationConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("NotificationTopicArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NotificationTopicArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
