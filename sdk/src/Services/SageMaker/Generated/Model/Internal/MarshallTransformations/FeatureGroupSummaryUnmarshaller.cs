    ...
    public class FeatureGroupSummaryUnmarshaller : IJsonUnmarshaller<FeatureGroupSummary, JsonUnmarshallerContext>
    {
        ...
        public FeatureGroupSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FeatureGroupArn", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("FeatureGroupStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FeatureGroupStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("OfflineStoreStatus", targetDepth, ref reader))
                {
        ...
        private static FeatureGroupSummaryUnmarshaller _instance = new FeatureGroupSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FeatureGroupSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
