        ...
        public TrainingJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ModelPackageConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.ModelPackageConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OutputModelPackageArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
