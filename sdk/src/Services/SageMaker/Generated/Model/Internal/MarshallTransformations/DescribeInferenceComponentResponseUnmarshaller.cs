...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInferenceComponent operation
    /// </summary>  
    public class DescribeInferenceComponentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInferenceComponentResponse response = new DescribeInferenceComponentResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InferenceComponentArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("InferenceComponentName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InferenceComponentName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("RuntimeConfig", targetDepth))
                {
                    ...
                    response.RuntimeConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Specification", targetDepth))
                {
                    ...
                    response.Specification = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("VariantName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VariantName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeInferenceComponentResponseUnmarshaller _instance = new DescribeInferenceComponentResponseUnmarshaller();        

        internal static DescribeInferenceComponentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInferenceComponentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
