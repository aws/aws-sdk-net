...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteDomainRequestMarshaller : IMarshaller<IRequest, DeleteDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteDomainRequest publicRequest)
        {
            ...
            string target = "SageMaker.DeleteDomain";
            ...
            if(publicRequest.IsSetRetentionPolicy())
            {
                context.Writer.WritePropertyName("RetentionPolicy");
                context.Writer.WriteStartObject();

                var marshaller = RetentionPolicyMarshaller.Instance;
                marshaller.Marshall(publicRequest.RetentionPolicy, context);
