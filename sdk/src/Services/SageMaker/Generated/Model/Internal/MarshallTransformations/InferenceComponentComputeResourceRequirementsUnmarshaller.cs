...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class InferenceComponentComputeResourceRequirementsUnmarshaller : IJsonUnmarshaller<InferenceComponentComputeResourceRequirements, JsonUnmarshallerContext>
    {
        ...
        private static InferenceComponentComputeResourceRequirementsUnmarshaller _instance = new InferenceComponentComputeResourceRequirementsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InferenceComponentComputeResourceRequirementsUnmarshaller Instance
        {
            get
            {
                return _instance;
