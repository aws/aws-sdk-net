...
{
    /// <summary>
    /// ListAIRecommendationJobs Request Marshaller
    /// </summary>       
    public class ListAIRecommendationJobsRequestMarshaller : IMarshaller<IRequest, ListAIRecommendationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAIRecommendationJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAIRecommendationJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListAIRecommendationJobs";
        ...
        private static ListAIRecommendationJobsRequestMarshaller _instance = new ListAIRecommendationJobsRequestMarshaller();        

        internal static ListAIRecommendationJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAIRecommendationJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
