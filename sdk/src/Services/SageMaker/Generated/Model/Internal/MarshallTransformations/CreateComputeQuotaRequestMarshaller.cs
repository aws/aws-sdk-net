...
{
    /// <summary>
    /// CreateComputeQuota Request Marshaller
    /// </summary>       
    public class CreateComputeQuotaRequestMarshaller : IMarshaller<IRequest, CreateComputeQuotaRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateComputeQuotaRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateComputeQuotaRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.CreateComputeQuota";
        ...
        private static CreateComputeQuotaRequestMarshaller _instance = new CreateComputeQuotaRequestMarshaller();        

        internal static CreateComputeQuotaRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateComputeQuotaRequestMarshaller Instance
        {
            get
            {
                return _instance;
