...
{
    /// <summary>
    /// ListComputeQuotas Request Marshaller
    /// </summary>       
    public class ListComputeQuotasRequestMarshaller : IMarshaller<IRequest, ListComputeQuotasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListComputeQuotasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListComputeQuotasRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListComputeQuotas";
        ...
        private static ListComputeQuotasRequestMarshaller _instance = new ListComputeQuotasRequestMarshaller();        

        internal static ListComputeQuotasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListComputeQuotasRequestMarshaller Instance
        {
            get
            {
                return _instance;
