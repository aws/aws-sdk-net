...
{
    /// <summary>
    /// ThroughputConfig Marshaller
    /// </summary>
    public class ThroughputConfigMarshaller : IRequestMarshaller<ThroughputConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ThroughputConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetProvisionedWriteCapacityUnits())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.ProvisionedWriteCapacityUnits.Value);
            }
        ...
        /// </summary>
        public readonly static ThroughputConfigMarshaller Instance = new ThroughputConfigMarshaller();
