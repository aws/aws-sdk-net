...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class USDUnmarshaller : IJsonUnmarshaller<USD, JsonUnmarshallerContext>
    {
        ...
        public USD Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("Cents", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.Cents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Dollars", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.Dollars = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TenthFractionsOfACent", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
        ...
        private static USDUnmarshaller _instance = new USDUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static USDUnmarshaller Instance
        {
            get
            {
                return _instance;
