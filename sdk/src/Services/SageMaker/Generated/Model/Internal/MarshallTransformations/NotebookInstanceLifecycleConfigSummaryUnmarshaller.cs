...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NotebookInstanceLifecycleConfigSummaryUnmarshaller : IJsonUnmarshaller<NotebookInstanceLifecycleConfigSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NotebookInstanceLifecycleConfigSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NotebookInstanceLifecycleConfigArn", targetDepth))
                {
                    ...
                    unmarshalledObject.NotebookInstanceLifecycleConfigArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
