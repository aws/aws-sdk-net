...
{
    /// <summary>
    /// Response Unmarshaller for CreateProcessingJob operation
    /// </summary>  
    public class CreateProcessingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProcessingJobResponse response = new CreateProcessingJobResponse();
        ...
        private static CreateProcessingJobResponseUnmarshaller _instance = new CreateProcessingJobResponseUnmarshaller();        

        internal static CreateProcessingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProcessingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
