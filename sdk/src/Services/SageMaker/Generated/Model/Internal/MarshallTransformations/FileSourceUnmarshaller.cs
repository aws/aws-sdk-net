...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FileSourceUnmarshaller : IUnmarshaller<FileSource, XmlUnmarshallerContext>, IUnmarshaller<FileSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FileSource IUnmarshaller<FileSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FileSource Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
