...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ServerlessJobConfigUnmarshaller : IJsonUnmarshaller<ServerlessJobConfig, JsonUnmarshallerContext>
    {
        ...
        public ServerlessJobConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AcceptEula", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("CustomizationTechnique", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("Peft", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Peft = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SequenceLength", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SequenceLength = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
