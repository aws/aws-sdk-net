...
{
    /// <summary>
    /// ListAIWorkloadConfigs Request Marshaller
    /// </summary>       
    public class ListAIWorkloadConfigsRequestMarshaller : IMarshaller<IRequest, ListAIWorkloadConfigsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAIWorkloadConfigsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAIWorkloadConfigsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListAIWorkloadConfigs";
        ...
        private static ListAIWorkloadConfigsRequestMarshaller _instance = new ListAIWorkloadConfigsRequestMarshaller();        

        internal static ListAIWorkloadConfigsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAIWorkloadConfigsRequestMarshaller Instance
        {
            get
            {
                return _instance;
