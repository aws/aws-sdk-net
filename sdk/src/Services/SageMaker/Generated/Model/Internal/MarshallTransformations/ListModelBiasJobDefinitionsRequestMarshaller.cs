...
{
    /// <summary>
    /// ListModelBiasJobDefinitions Request Marshaller
    /// </summary>       
    public class ListModelBiasJobDefinitionsRequestMarshaller : IMarshaller<IRequest, ListModelBiasJobDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListModelBiasJobDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListModelBiasJobDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListModelBiasJobDefinitions";
        ...
        private static ListModelBiasJobDefinitionsRequestMarshaller _instance = new ListModelBiasJobDefinitionsRequestMarshaller();        

        internal static ListModelBiasJobDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelBiasJobDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
