...
{
    /// <summary>
    /// ListEdgeDeploymentPlans Request Marshaller
    /// </summary>       
    public class ListEdgeDeploymentPlansRequestMarshaller : IMarshaller<IRequest, ListEdgeDeploymentPlansRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListEdgeDeploymentPlansRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListEdgeDeploymentPlansRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListEdgeDeploymentPlans";
            ...
            if(publicRequest.IsSetDeviceFleetNameContains())
            {
                context.Writer.WritePropertyName("DeviceFleetNameContains");
                context.Writer.WriteStringValue(publicRequest.DeviceFleetNameContains);
            }
        ...
        private static ListEdgeDeploymentPlansRequestMarshaller _instance = new ListEdgeDeploymentPlansRequestMarshaller();        

        internal static ListEdgeDeploymentPlansRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEdgeDeploymentPlansRequestMarshaller Instance
        {
            get
            {
                return _instance;
