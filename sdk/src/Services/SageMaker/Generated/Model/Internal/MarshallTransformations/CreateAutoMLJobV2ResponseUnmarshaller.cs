...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutoMLJobV2 operation
    /// </summary>  
    public class CreateAutoMLJobV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutoMLJobV2Response response = new CreateAutoMLJobV2Response();
        ...
        private static CreateAutoMLJobV2ResponseUnmarshaller _instance = new CreateAutoMLJobV2ResponseUnmarshaller();        

        internal static CreateAutoMLJobV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutoMLJobV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
