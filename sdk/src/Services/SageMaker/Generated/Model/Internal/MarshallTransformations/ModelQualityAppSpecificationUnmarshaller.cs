...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelQualityAppSpecificationUnmarshaller : IUnmarshaller<ModelQualityAppSpecification, XmlUnmarshallerContext>, IUnmarshaller<ModelQualityAppSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ModelQualityAppSpecification IUnmarshaller<ModelQualityAppSpecification, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ModelQualityAppSpecification Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
