...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceComponentContainerSpecificationSummaryUnmarshaller : IUnmarshaller<InferenceComponentContainerSpecificationSummary, XmlUnmarshallerContext>, IUnmarshaller<InferenceComponentContainerSpecificationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InferenceComponentContainerSpecificationSummary IUnmarshaller<InferenceComponentContainerSpecificationSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InferenceComponentContainerSpecificationSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ArtifactUrl", targetDepth))
                {
                    ...
                    unmarshalledObject.ArtifactUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DeployedImage", targetDepth))
                {
                    var unmarshaller = DeployedImageUnmarshaller.Instance;
                    unmarshalledObject.DeployedImage = unmarshaller.Unmarshall(context);
                    continue;
                }
