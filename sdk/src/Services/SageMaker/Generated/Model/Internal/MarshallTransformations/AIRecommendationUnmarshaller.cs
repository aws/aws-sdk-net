...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class AIRecommendationUnmarshaller : IJsonUnmarshaller<AIRecommendation, JsonUnmarshallerContext>
    {
        ...
        public AIRecommendation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AdapterDetails", targetDepth, ref reader))
                {
                    var unmarshaller = AIRecommendationAdapterDetailsUnmarshaller.Instance;
                    unmarshalledObject.AdapterDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
