...
{
    /// <summary>
    /// ListModelPackages Request Marshaller
    /// </summary>       
    public class ListModelPackagesRequestMarshaller : IMarshaller<IRequest, ListModelPackagesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListModelPackagesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListModelPackagesRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetModelPackageType())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ModelPackageType);
            }
        ...
        private static ListModelPackagesRequestMarshaller _instance = new ListModelPackagesRequestMarshaller();        

        internal static ListModelPackagesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelPackagesRequestMarshaller Instance
        {
            get
            {
                return _instance;
