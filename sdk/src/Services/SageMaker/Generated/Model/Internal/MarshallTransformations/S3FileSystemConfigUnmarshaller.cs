...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3FileSystemConfigUnmarshaller : IJsonUnmarshaller<S3FileSystemConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3FileSystemConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("MountPath", targetDepth, ref reader))
                {
