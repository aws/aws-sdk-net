...
{
    /// <summary>
    /// Response Unmarshaller for CreateInferenceRecommendationsJob operation
    /// </summary>  
    public class CreateInferenceRecommendationsJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInferenceRecommendationsJobResponse response = new CreateInferenceRecommendationsJobResponse();
        ...
        private static CreateInferenceRecommendationsJobResponseUnmarshaller _instance = new CreateInferenceRecommendationsJobResponseUnmarshaller();        

        internal static CreateInferenceRecommendationsJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInferenceRecommendationsJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
