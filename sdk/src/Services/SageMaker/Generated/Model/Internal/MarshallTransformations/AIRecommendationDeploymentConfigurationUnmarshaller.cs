...
{
    /// <summary>
    /// Response Unmarshaller for AIRecommendationDeploymentConfiguration Object
    /// </summary>  
    public class AIRecommendationDeploymentConfigurationUnmarshaller : IJsonUnmarshaller<AIRecommendationDeploymentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AIRecommendationDeploymentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AIRecommendationDeploymentConfiguration unmarshalledObject = new AIRecommendationDeploymentConfiguration();
        ...
        private static AIRecommendationDeploymentConfigurationUnmarshaller _instance = new AIRecommendationDeploymentConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AIRecommendationDeploymentConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
