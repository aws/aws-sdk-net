    ...
    public class DescribeModelBiasJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ModelBiasAppSpecification", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ModelBiasBaselineConfig", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ModelBiasJobInput", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ModelBiasJobOutputConfig", targetDepth, ref reader))
                {
