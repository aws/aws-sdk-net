...
{
    /// <summary>
    /// CreatePresignedNotebookInstanceUrl Request Marshaller
    /// </summary>       
    public class CreatePresignedNotebookInstanceUrlRequestMarshaller : IMarshaller<IRequest, CreatePresignedNotebookInstanceUrlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePresignedNotebookInstanceUrlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePresignedNotebookInstanceUrlRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.CreatePresignedNotebookInstanceUrl";
