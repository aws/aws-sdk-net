...
{
    /// <summary>
    /// ListProcessingJobs Request Marshaller
    /// </summary>       
    public class ListProcessingJobsRequestMarshaller : IMarshaller<IRequest, ListProcessingJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListProcessingJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListProcessingJobsRequest publicRequest)
        {
        ...
        private static ListProcessingJobsRequestMarshaller _instance = new ListProcessingJobsRequestMarshaller();        

        internal static ListProcessingJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProcessingJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
