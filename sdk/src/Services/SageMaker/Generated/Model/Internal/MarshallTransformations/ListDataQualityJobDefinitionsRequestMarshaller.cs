...
{
    /// <summary>
    /// ListDataQualityJobDefinitions Request Marshaller
    /// </summary>       
    public class ListDataQualityJobDefinitionsRequestMarshaller : IMarshaller<IRequest, ListDataQualityJobDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDataQualityJobDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDataQualityJobDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListDataQualityJobDefinitions";
        ...
        private static ListDataQualityJobDefinitionsRequestMarshaller _instance = new ListDataQualityJobDefinitionsRequestMarshaller();        

        internal static ListDataQualityJobDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDataQualityJobDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
