...
{
    /// <summary>
    /// DeleteNotebookInstanceLifecycleConfig Request Marshaller
    /// </summary>       
    public class DeleteNotebookInstanceLifecycleConfigRequestMarshaller : IMarshaller<IRequest, DeleteNotebookInstanceLifecycleConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteNotebookInstanceLifecycleConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteNotebookInstanceLifecycleConfigRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.DeleteNotebookInstanceLifecycleConfig";
