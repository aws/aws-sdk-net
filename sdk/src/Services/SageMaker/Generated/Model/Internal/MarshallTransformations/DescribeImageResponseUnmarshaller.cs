...
{
    /// <summary>
    /// Response Unmarshaller for DescribeImage operation
    /// </summary>  
    public class DescribeImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ImageStatus", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ImageStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeImageResponseUnmarshaller _instance = new DescribeImageResponseUnmarshaller();        

        internal static DescribeImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
