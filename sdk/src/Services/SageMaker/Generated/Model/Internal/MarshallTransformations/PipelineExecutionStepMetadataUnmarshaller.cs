        ...
        public PipelineExecutionStepMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("BedrockCustomModel", targetDepth))
                {
                    ...
                    unmarshalledObject.BedrockCustomModel = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("BedrockCustomModelDeployment", targetDepth))
                {
                    ...
                    unmarshalledObject.BedrockCustomModelDeployment = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("BedrockModelImport", targetDepth))
                {
                    var unmarshaller = BedrockModelImportMetadataUnmarshaller.Instance;
                    unmarshalledObject.BedrockModelImport = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("BedrockProvisionedModelThroughput", targetDepth))
                {
                    ...
                    unmarshalledObject.BedrockProvisionedModelThroughput = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("InferenceComponent", targetDepth))
                {
                    ...
                    unmarshalledObject.InferenceComponent = unmarshaller.Unmarshall(context);
                    continue;
                }
