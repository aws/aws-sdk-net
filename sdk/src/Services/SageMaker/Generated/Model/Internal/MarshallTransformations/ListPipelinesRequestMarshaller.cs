...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ListPipelinesRequestMarshaller : IMarshaller<IRequest, ListPipelinesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListPipelinesRequest publicRequest)
        {
            ...
            string target = "SageMaker.ListPipelines";
            ...
            if(publicRequest.IsSetPipelineNamePrefix())
            {
                context.Writer.WritePropertyName("PipelineNamePrefix");
                context.Writer.WriteStringValue(publicRequest.PipelineNamePrefix);
            }
        ...
        private static ListPipelinesRequestMarshaller _instance = new ListPipelinesRequestMarshaller();        

        internal static ListPipelinesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPipelinesRequestMarshaller Instance
        {
            get
            {
                return _instance;
