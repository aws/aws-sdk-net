    ...
    public class ListPipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PipelineSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<PipelineSummary, PipelineSummaryUnmarshaller>(PipelineSummaryUnmarshaller.Instance);
                    response.PipelineSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
