...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParentHyperParameterTuningJobUnmarshaller : IJsonUnmarshaller<ParentHyperParameterTuningJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ParentHyperParameterTuningJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("HyperParameterTuningJobName", targetDepth, ref reader))
                {
