...
{
    /// <summary>
    /// Response Unmarshaller for CreateModelCard operation
    /// </summary>  
    public class CreateModelCardResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelCardResponse response = new CreateModelCardResponse();
            ...
            {
                if (context.TestExpression("ModelCardArn", targetDepth, ref reader))
                {
        ...
        private static CreateModelCardResponseUnmarshaller _instance = new CreateModelCardResponseUnmarshaller();        

        internal static CreateModelCardResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelCardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
