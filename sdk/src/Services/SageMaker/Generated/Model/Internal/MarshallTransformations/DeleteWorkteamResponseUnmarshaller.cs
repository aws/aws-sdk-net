...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWorkteam operation
    /// </summary>  
    public class DeleteWorkteamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWorkteamResponse response = new DeleteWorkteamResponse();
        ...
        private static DeleteWorkteamResponseUnmarshaller _instance = new DeleteWorkteamResponseUnmarshaller();        

        internal static DeleteWorkteamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWorkteamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
