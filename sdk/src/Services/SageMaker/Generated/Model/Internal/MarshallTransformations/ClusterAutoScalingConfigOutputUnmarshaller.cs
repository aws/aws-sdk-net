...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusterAutoScalingConfigOutputUnmarshaller : IUnmarshaller<ClusterAutoScalingConfigOutput, XmlUnmarshallerContext>, IUnmarshaller<ClusterAutoScalingConfigOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ClusterAutoScalingConfigOutput IUnmarshaller<ClusterAutoScalingConfigOutput, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ClusterAutoScalingConfigOutput Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AutoScalerType", targetDepth))
                {
                    ...
                    unmarshalledObject.AutoScalerType = unmarshaller.Unmarshall(context);
                    continue;
                }
