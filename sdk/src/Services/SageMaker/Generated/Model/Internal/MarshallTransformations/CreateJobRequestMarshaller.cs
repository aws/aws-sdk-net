...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class CreateJobRequestMarshaller : IMarshaller<IRequest, CreateJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateJobRequest publicRequest)
        {
            ...
            string target = "SageMaker.CreateJob";
            ...
            if(publicRequest.IsSetJobConfigDocument())
            {
                context.Writer.WritePropertyName("JobConfigDocument");
                context.Writer.WriteStringValue(publicRequest.JobConfigDocument);
            }
