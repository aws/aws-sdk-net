...
{
    /// <summary>
    /// CreateArtifact Request Marshaller
    /// </summary>       
    public class CreateArtifactRequestMarshaller : IMarshaller<IRequest, CreateArtifactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateArtifactRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateArtifactRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.CreateArtifact";
        ...
        private static CreateArtifactRequestMarshaller _instance = new CreateArtifactRequestMarshaller();        

        internal static CreateArtifactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateArtifactRequestMarshaller Instance
        {
            get
            {
                return _instance;
