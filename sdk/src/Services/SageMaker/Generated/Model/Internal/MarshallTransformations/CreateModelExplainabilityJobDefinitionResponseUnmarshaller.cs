...
{
    /// <summary>
    /// Response Unmarshaller for CreateModelExplainabilityJobDefinition operation
    /// </summary>  
    public class CreateModelExplainabilityJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelExplainabilityJobDefinitionResponse response = new CreateModelExplainabilityJobDefinitionResponse();
        ...
        private static CreateModelExplainabilityJobDefinitionResponseUnmarshaller _instance = new CreateModelExplainabilityJobDefinitionResponseUnmarshaller();        

        internal static CreateModelExplainabilityJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelExplainabilityJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
