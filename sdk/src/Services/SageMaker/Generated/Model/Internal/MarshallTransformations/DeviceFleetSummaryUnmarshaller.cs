...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceFleetSummaryUnmarshaller : IJsonUnmarshaller<DeviceFleetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeviceFleetSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DeviceFleetArn", targetDepth))
                {
                    ...
                    unmarshalledObject.DeviceFleetArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
