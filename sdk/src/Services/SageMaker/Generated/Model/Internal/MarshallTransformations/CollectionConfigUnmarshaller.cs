...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class CollectionConfigUnmarshaller : IJsonUnmarshaller<CollectionConfig, JsonUnmarshallerContext>
    {
        ...
        public CollectionConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("VectorConfig", targetDepth, ref reader))
                {
        ...
        private static CollectionConfigUnmarshaller _instance = new CollectionConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CollectionConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
