    ...
    public class BatchDeleteClusterNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchDeleteClusterNodesError, BatchDeleteClusterNodesErrorUnmarshaller>(BatchDeleteClusterNodesErrorUnmarshaller.Instance);
