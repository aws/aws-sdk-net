...
{
    /// <summary>
    /// ListInferenceRecommendationsJobs Request Marshaller
    /// </summary>       
    public class ListInferenceRecommendationsJobsRequestMarshaller : IMarshaller<IRequest, ListInferenceRecommendationsJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInferenceRecommendationsJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInferenceRecommendationsJobsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetModelNameEquals())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ModelNameEquals);
            }

            if(publicRequest.IsSetModelPackageVersionArnEquals())
            {
                context.Writer.WritePropertyName("ModelPackageVersionArnEquals");
                context.Writer.WriteStringValue(publicRequest.ModelPackageVersionArnEquals);
            }
        ...
        private static ListInferenceRecommendationsJobsRequestMarshaller _instance = new ListInferenceRecommendationsJobsRequestMarshaller();        

        internal static ListInferenceRecommendationsJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInferenceRecommendationsJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
