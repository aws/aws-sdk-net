...
{
    /// <summary>
    /// ListCompilationJobs Request Marshaller
    /// </summary>       
    public class ListCompilationJobsRequestMarshaller : IMarshaller<IRequest, ListCompilationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCompilationJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCompilationJobsRequest publicRequest)
        {
        ...
        private static ListCompilationJobsRequestMarshaller _instance = new ListCompilationJobsRequestMarshaller();        

        internal static ListCompilationJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCompilationJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
