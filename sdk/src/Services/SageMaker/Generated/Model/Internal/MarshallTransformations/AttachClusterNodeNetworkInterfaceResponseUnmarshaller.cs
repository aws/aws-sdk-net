...
{
    /// <summary>
    /// Response Unmarshaller for AttachClusterNodeNetworkInterface operation
    /// </summary>  
    public class AttachClusterNodeNetworkInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachClusterNodeNetworkInterfaceResponse response = new AttachClusterNodeNetworkInterfaceResponse();
        ...
        private static AttachClusterNodeNetworkInterfaceResponseUnmarshaller _instance = new AttachClusterNodeNetworkInterfaceResponseUnmarshaller();        

        internal static AttachClusterNodeNetworkInterfaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachClusterNodeNetworkInterfaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
