...
{
    /// <summary>
    /// Response Unmarshaller for CreateModelPackage operation
    /// </summary>  
    public class CreateModelPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelPackageResponse response = new CreateModelPackageResponse();
        ...
        private static CreateModelPackageResponseUnmarshaller _instance = new CreateModelPackageResponseUnmarshaller();        

        internal static CreateModelPackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelPackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
