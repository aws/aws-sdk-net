        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AutoScaling", targetDepth))
                {
                    ...
                    response.AutoScaling = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ClusterRole = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ClusterInstanceGroupDetails, ClusterInstanceGroupDetailsUnmarshaller>(ClusterInstanceGroupDetailsUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.NodeProvisioningMode = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ClusterRestrictedInstanceGroupDetails, ClusterRestrictedInstanceGroupDetailsUnmarshaller>(ClusterRestrictedInstanceGroupDetailsUnmarshaller.Instance);
