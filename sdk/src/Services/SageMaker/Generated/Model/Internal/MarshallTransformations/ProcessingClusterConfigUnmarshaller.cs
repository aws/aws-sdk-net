...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProcessingClusterConfigUnmarshaller : IUnmarshaller<ProcessingClusterConfig, XmlUnmarshallerContext>, IUnmarshaller<ProcessingClusterConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProcessingClusterConfig IUnmarshaller<ProcessingClusterConfig, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ProcessingClusterConfig Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
