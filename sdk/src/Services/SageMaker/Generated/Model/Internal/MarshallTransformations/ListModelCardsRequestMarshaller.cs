...
{
    /// <summary>
    /// ListModelCards Request Marshaller
    /// </summary>       
    public class ListModelCardsRequestMarshaller : IMarshaller<IRequest, ListModelCardsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListModelCardsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListModelCardsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListModelCards";
            ...
            if(publicRequest.IsSetModelCardStatus())
            {
                context.Writer.WritePropertyName("ModelCardStatus");
                context.Writer.WriteStringValue(publicRequest.ModelCardStatus);
            }
        ...
        private static ListModelCardsRequestMarshaller _instance = new ListModelCardsRequestMarshaller();        

        internal static ListModelCardsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelCardsRequestMarshaller Instance
        {
            get
            {
                return _instance;
