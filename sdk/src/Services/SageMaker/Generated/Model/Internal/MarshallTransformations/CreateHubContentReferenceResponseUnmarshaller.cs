...
{
    /// <summary>
    /// Response Unmarshaller for CreateHubContentReference operation
    /// </summary>  
    public class CreateHubContentReferenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHubContentReferenceResponse response = new CreateHubContentReferenceResponse();
        ...
        private static CreateHubContentReferenceResponseUnmarshaller _instance = new CreateHubContentReferenceResponseUnmarshaller();        

        internal static CreateHubContentReferenceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHubContentReferenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
