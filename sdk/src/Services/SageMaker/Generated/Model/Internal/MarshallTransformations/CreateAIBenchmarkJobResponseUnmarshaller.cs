...
{
    /// <summary>
    /// Response Unmarshaller for CreateAIBenchmarkJob operation
    /// </summary>  
    public class CreateAIBenchmarkJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAIBenchmarkJobResponse response = new CreateAIBenchmarkJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AIBenchmarkJobArn", targetDepth))
                {
                    ...
                    response.AIBenchmarkJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAIBenchmarkJobResponseUnmarshaller _instance = new CreateAIBenchmarkJobResponseUnmarshaller();        

        internal static CreateAIBenchmarkJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIBenchmarkJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
