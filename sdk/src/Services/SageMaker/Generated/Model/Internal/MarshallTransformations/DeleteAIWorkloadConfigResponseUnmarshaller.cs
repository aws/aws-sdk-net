...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAIWorkloadConfig operation
    /// </summary>  
    public class DeleteAIWorkloadConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAIWorkloadConfigResponse response = new DeleteAIWorkloadConfigResponse();
        ...
        private static DeleteAIWorkloadConfigResponseUnmarshaller _instance = new DeleteAIWorkloadConfigResponseUnmarshaller();        

        internal static DeleteAIWorkloadConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAIWorkloadConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
