...
{
    /// <summary>
    /// ListModelQualityJobDefinitions Request Marshaller
    /// </summary>       
    public class ListModelQualityJobDefinitionsRequestMarshaller : IMarshaller<IRequest, ListModelQualityJobDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListModelQualityJobDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListModelQualityJobDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListModelQualityJobDefinitions";
        ...
        private static ListModelQualityJobDefinitionsRequestMarshaller _instance = new ListModelQualityJobDefinitionsRequestMarshaller();        

        internal static ListModelQualityJobDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelQualityJobDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
