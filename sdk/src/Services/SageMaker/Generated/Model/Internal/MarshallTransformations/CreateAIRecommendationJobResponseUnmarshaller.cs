...
{
    /// <summary>
    /// Response Unmarshaller for CreateAIRecommendationJob operation
    /// </summary>  
    public class CreateAIRecommendationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAIRecommendationJobResponse response = new CreateAIRecommendationJobResponse();
        ...
        private static CreateAIRecommendationJobResponseUnmarshaller _instance = new CreateAIRecommendationJobResponseUnmarshaller();        

        internal static CreateAIRecommendationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIRecommendationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
