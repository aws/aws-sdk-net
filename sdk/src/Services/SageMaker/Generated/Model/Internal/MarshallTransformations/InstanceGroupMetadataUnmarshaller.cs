...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceGroupMetadataUnmarshaller : IJsonUnmarshaller<InstanceGroupMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceGroupMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AmiOverride", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AmiOverride = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
