...
namespace Amazon.SageMaker.Model
{
    ...
    {
        private List<ClusterSummary> _clusterSummaries = new List<ClusterSummary>();
        ...
        {
            return this._clusterSummaries != null && this._clusterSummaries.Count > 0; 
        }

        /// <summary>
        /// Gets and sets the property NextToken. 
        /// <para>
        /// If the result of the previous <code>ListClusters</code> request was truncated, the
        /// response includes a <code>NextToken</code>. To retrieve the next set of clusters,
