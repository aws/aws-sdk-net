...
namespace Amazon.SageMaker.Model
{
    ...
    /// configuration. There are two modes: <code>ON_DEMAND</code> and <code>PROVISIONED</code>.
    /// With on-demand mode, you are charged for data reads and writes that your application
    /// performs on your feature group. You do not need to specify read and write throughput
    /// because Feature Store accommodates your workloads as they ramp up and down. You can
    /// switch a feature group to on-demand only once in a 24 hour period. With provisioned
    /// throughput mode, you specify the read and write capacity per second that you expect
