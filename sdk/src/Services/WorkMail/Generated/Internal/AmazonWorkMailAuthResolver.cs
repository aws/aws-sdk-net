...
namespace Amazon.WorkMail.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonWorkMailAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkMailAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkMail.
        /// </summary>
        public AmazonWorkMailAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkMailAuthSchemeParameters
            {
    ...
    public class AmazonWorkMailAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkMailAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkMailAuthSchemeParameters authParameters)
        {
