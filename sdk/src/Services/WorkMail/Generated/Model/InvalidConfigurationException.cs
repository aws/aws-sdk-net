...
namespace Amazon.WorkMail.Model
{
    ...
    public partial class InvalidConfigurationException : AmazonWorkMailException
    {
        ...
        /// <summary>
        /// Construct instance of InvalidConfigurationException
        /// </summary>
        ...
        public InvalidConfigurationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidConfigurationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
