...
{
    /// <summary>
    /// CreateAvailabilityConfiguration Request Marshaller
    /// </summary>       
    public class CreateAvailabilityConfigurationRequestMarshaller : IMarshaller<IRequest, CreateAvailabilityConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAvailabilityConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAvailabilityConfigurationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkMail");
            string target = "WorkMailService.CreateAvailabilityConfiguration";
        ...
        private static CreateAvailabilityConfigurationRequestMarshaller _instance = new CreateAvailabilityConfigurationRequestMarshaller();        

        internal static CreateAvailabilityConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAvailabilityConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
