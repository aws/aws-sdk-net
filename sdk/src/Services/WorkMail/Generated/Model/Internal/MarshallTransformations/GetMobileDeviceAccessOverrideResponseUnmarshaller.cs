...
{
    /// <summary>
    /// Response Unmarshaller for GetMobileDeviceAccessOverride operation
    /// </summary>  
    public class GetMobileDeviceAccessOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMobileDeviceAccessOverrideResponse response = new GetMobileDeviceAccessOverrideResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DateCreated", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.DateCreated = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DateModified", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.DateModified = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetMobileDeviceAccessOverrideResponseUnmarshaller _instance = new GetMobileDeviceAccessOverrideResponseUnmarshaller();        

        internal static GetMobileDeviceAccessOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMobileDeviceAccessOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
