...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEmailMonitoringConfiguration operation
    /// </summary>  
    public class DeleteEmailMonitoringConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEmailMonitoringConfigurationResponse response = new DeleteEmailMonitoringConfigurationResponse();
        ...
        private static DeleteEmailMonitoringConfigurationResponseUnmarshaller _instance = new DeleteEmailMonitoringConfigurationResponseUnmarshaller();        

        internal static DeleteEmailMonitoringConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEmailMonitoringConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
