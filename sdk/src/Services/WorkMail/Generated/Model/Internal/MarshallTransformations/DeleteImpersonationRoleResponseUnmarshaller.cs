...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImpersonationRole operation
    /// </summary>  
    public class DeleteImpersonationRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImpersonationRoleResponse response = new DeleteImpersonationRoleResponse();
        ...
        private static DeleteImpersonationRoleResponseUnmarshaller _instance = new DeleteImpersonationRoleResponseUnmarshaller();        

        internal static DeleteImpersonationRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImpersonationRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
