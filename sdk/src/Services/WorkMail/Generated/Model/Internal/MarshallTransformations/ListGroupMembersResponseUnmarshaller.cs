...
namespace Amazon.WorkMail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGroupMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static ListGroupMembersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGroupMembersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
