...
{
    /// <summary>
    /// Response Unmarshaller for PutMobileDeviceAccessOverride operation
    /// </summary>  
    public class PutMobileDeviceAccessOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutMobileDeviceAccessOverrideResponse response = new PutMobileDeviceAccessOverrideResponse();
        ...
        private static PutMobileDeviceAccessOverrideResponseUnmarshaller _instance = new PutMobileDeviceAccessOverrideResponseUnmarshaller();        

        internal static PutMobileDeviceAccessOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMobileDeviceAccessOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
