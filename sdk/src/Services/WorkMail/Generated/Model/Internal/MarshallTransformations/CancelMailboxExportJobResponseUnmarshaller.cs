...
{
    /// <summary>
    /// Response Unmarshaller for CancelMailboxExportJob operation
    /// </summary>  
    public class CancelMailboxExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMailboxExportJobResponse response = new CancelMailboxExportJobResponse();
        ...
        private static CancelMailboxExportJobResponseUnmarshaller _instance = new CancelMailboxExportJobResponseUnmarshaller();        

        internal static CancelMailboxExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMailboxExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
