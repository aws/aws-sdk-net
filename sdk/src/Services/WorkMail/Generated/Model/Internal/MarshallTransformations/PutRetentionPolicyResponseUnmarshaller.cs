...
namespace Amazon.WorkMail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRetentionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRetentionPolicyResponse response = new PutRetentionPolicyResponse();
        ...
        private static PutRetentionPolicyResponseUnmarshaller _instance = new PutRetentionPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRetentionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
