...
{
    /// <summary>
    /// Response Unmarshaller for GetImpersonationRoleEffect operation
    /// </summary>  
    public class GetImpersonationRoleEffectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImpersonationRoleEffectResponse response = new GetImpersonationRoleEffectResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImpersonationMatchedRule, ImpersonationMatchedRuleUnmarshaller>(ImpersonationMatchedRuleUnmarshaller.Instance);
        ...
        private static GetImpersonationRoleEffectResponseUnmarshaller _instance = new GetImpersonationRoleEffectResponseUnmarshaller();        

        internal static GetImpersonationRoleEffectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImpersonationRoleEffectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
