...
{
    /// <summary>
    /// GetAccessControlEffect Request Marshaller
    /// </summary>       
    public class GetAccessControlEffectRequestMarshaller : IMarshaller<IRequest, GetAccessControlEffectRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAccessControlEffectRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAccessControlEffectRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkMail");
            string target = "WorkMailService.GetAccessControlEffect";
        ...
        private static GetAccessControlEffectRequestMarshaller _instance = new GetAccessControlEffectRequestMarshaller();        

        internal static GetAccessControlEffectRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessControlEffectRequestMarshaller Instance
        {
            get
            {
                return _instance;
