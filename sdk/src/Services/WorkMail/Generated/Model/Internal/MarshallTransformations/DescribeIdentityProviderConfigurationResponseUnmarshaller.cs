...
{
    /// <summary>
    /// Response Unmarshaller for DescribeIdentityProviderConfiguration operation
    /// </summary>  
    public class DescribeIdentityProviderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeIdentityProviderConfigurationResponse response = new DescribeIdentityProviderConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AuthenticationMode", targetDepth))
                {
                    ...
                    response.AuthenticationMode = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("IdentityCenterConfiguration", targetDepth))
                {
                    ...
                    response.IdentityCenterConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PersonalAccessTokenConfiguration", targetDepth))
                {
                    ...
                    response.PersonalAccessTokenConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeIdentityProviderConfigurationResponseUnmarshaller _instance = new DescribeIdentityProviderConfigurationResponseUnmarshaller();        

        internal static DescribeIdentityProviderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIdentityProviderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
