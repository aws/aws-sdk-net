...
{
    /// <summary>
    /// Response Unmarshaller for CreateMobileDeviceAccessRule operation
    /// </summary>  
    public class CreateMobileDeviceAccessRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMobileDeviceAccessRuleResponse response = new CreateMobileDeviceAccessRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("MobileDeviceAccessRuleId", targetDepth))
                {
                    ...
                    response.MobileDeviceAccessRuleId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateMobileDeviceAccessRuleResponseUnmarshaller _instance = new CreateMobileDeviceAccessRuleResponseUnmarshaller();        

        internal static CreateMobileDeviceAccessRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMobileDeviceAccessRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
