...
{
    /// <summary>
    /// Response Unmarshaller for CreateImpersonationRole operation
    /// </summary>  
    public class CreateImpersonationRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateImpersonationRoleResponse response = new CreateImpersonationRoleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ImpersonationRoleId", targetDepth))
                {
                    ...
                    response.ImpersonationRoleId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateImpersonationRoleResponseUnmarshaller _instance = new CreateImpersonationRoleResponseUnmarshaller();        

        internal static CreateImpersonationRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImpersonationRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
