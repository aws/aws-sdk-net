...
{
    /// <summary>
    /// Response Unmarshaller for RegisterMailDomain operation
    /// </summary>  
    public class RegisterMailDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterMailDomainResponse response = new RegisterMailDomainResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MailDomainInUseException"))
                {
                    return MailDomainInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static RegisterMailDomainResponseUnmarshaller _instance = new RegisterMailDomainResponseUnmarshaller();        

        internal static RegisterMailDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterMailDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
