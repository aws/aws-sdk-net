...
{
    /// <summary>
    /// Response Unmarshaller for ListOrganizations operation
    /// </summary>  
    public class ListOrganizationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OrganizationSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<OrganizationSummary, OrganizationSummaryUnmarshaller>(OrganizationSummaryUnmarshaller.Instance);
                    response.OrganizationSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListOrganizationsResponseUnmarshaller _instance = new ListOrganizationsResponseUnmarshaller();        

        internal static ListOrganizationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOrganizationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
