    ...
    public class ListMailDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MailDomainSummary, MailDomainSummaryUnmarshaller>(MailDomainSummaryUnmarshaller.Instance);
                    response.MailDomains = unmarshaller.Unmarshall(context);
                    continue;
                }
