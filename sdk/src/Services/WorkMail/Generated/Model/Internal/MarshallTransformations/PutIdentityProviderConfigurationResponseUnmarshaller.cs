...
{
    /// <summary>
    /// Response Unmarshaller for PutIdentityProviderConfiguration operation
    /// </summary>  
    public class PutIdentityProviderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutIdentityProviderConfigurationResponse response = new PutIdentityProviderConfigurationResponse();
        ...
        private static PutIdentityProviderConfigurationResponseUnmarshaller _instance = new PutIdentityProviderConfigurationResponseUnmarshaller();        

        internal static PutIdentityProviderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutIdentityProviderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
