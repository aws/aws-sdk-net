    ...
    public class GetMobileDeviceAccessEffectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MobileDeviceAccessMatchedRule, MobileDeviceAccessMatchedRuleUnmarshaller>(MobileDeviceAccessMatchedRuleUnmarshaller.Instance);
