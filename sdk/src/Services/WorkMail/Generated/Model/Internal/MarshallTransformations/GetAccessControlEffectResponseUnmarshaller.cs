...
{
    /// <summary>
    /// Response Unmarshaller for GetAccessControlEffect operation
    /// </summary>  
    public class GetAccessControlEffectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccessControlEffectResponse response = new GetAccessControlEffectResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("MatchedRules", targetDepth))
                {
                    ...
                    response.MatchedRules = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetAccessControlEffectResponseUnmarshaller _instance = new GetAccessControlEffectResponseUnmarshaller();        

        internal static GetAccessControlEffectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessControlEffectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
