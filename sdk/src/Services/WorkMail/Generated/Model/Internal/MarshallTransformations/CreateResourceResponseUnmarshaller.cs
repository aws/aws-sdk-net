...
namespace Amazon.WorkMail.Model.Internal.MarshallTransformations
{
    ...
    public class CreateResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("NameAvailabilityException"))
            {
                return new NameAvailabilityException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("ReservedNameException"))
            {
                return new ReservedNameException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
