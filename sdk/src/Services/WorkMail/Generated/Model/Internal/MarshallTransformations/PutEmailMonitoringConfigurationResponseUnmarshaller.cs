...
{
    /// <summary>
    /// Response Unmarshaller for PutEmailMonitoringConfiguration operation
    /// </summary>  
    public class PutEmailMonitoringConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutEmailMonitoringConfigurationResponse response = new PutEmailMonitoringConfigurationResponse();
        ...
        private static PutEmailMonitoringConfigurationResponseUnmarshaller _instance = new PutEmailMonitoringConfigurationResponseUnmarshaller();        

        internal static PutEmailMonitoringConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutEmailMonitoringConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
