...
{
    /// <summary>
    /// Response Unmarshaller for ListAccessControlRules operation
    /// </summary>  
    public class ListAccessControlRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccessControlRulesResponse response = new ListAccessControlRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AccessControlRule, AccessControlRuleUnmarshaller>(AccessControlRuleUnmarshaller.Instance);
        ...
        private static ListAccessControlRulesResponseUnmarshaller _instance = new ListAccessControlRulesResponseUnmarshaller();        

        internal static ListAccessControlRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessControlRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
