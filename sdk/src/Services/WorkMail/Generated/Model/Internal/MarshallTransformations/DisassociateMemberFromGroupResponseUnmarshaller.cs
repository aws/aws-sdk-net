...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateMemberFromGroup operation
    /// </summary>  
    public class DisassociateMemberFromGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateMemberFromGroupResponse response = new DisassociateMemberFromGroupResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DirectoryServiceAuthenticationFailedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DisassociateMemberFromGroupResponseUnmarshaller _instance = new DisassociateMemberFromGroupResponseUnmarshaller();        

        internal static DisassociateMemberFromGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateMemberFromGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
