...
{
    /// <summary>
    /// Response Unmarshaller for ListGroupsForEntity operation
    /// </summary>  
    public class ListGroupsForEntityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGroupsForEntityResponse response = new ListGroupsForEntityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GroupIdentifier, GroupIdentifierUnmarshaller>(GroupIdentifierUnmarshaller.Instance);
        ...
        private static ListGroupsForEntityResponseUnmarshaller _instance = new ListGroupsForEntityResponseUnmarshaller();        

        internal static ListGroupsForEntityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGroupsForEntityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
