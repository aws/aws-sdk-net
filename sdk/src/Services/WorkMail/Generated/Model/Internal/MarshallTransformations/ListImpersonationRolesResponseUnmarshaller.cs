...
{
    /// <summary>
    /// Response Unmarshaller for ListImpersonationRoles operation
    /// </summary>  
    public class ListImpersonationRolesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImpersonationRolesResponse response = new ListImpersonationRolesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImpersonationRole, ImpersonationRoleUnmarshaller>(ImpersonationRoleUnmarshaller.Instance);
        ...
        private static ListImpersonationRolesResponseUnmarshaller _instance = new ListImpersonationRolesResponseUnmarshaller();        

        internal static ListImpersonationRolesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImpersonationRolesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
