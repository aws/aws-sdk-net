...
{
    /// <summary>
    /// Response Unmarshaller for ResetPassword operation
    /// </summary>  
    public class ResetPasswordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ResetPasswordResponseUnmarshaller _instance = new ResetPasswordResponseUnmarshaller();        

        internal static ResetPasswordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetPasswordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
