...
{
    /// <summary>
    /// Response Unmarshaller for DeleteOrganization operation
    /// </summary>  
    public class DeleteOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("OrganizationId", targetDepth))
                {
                    ...
                    response.OrganizationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteOrganizationResponseUnmarshaller _instance = new DeleteOrganizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
