...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonServerMigrationServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonServerMigrationServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonServerMigrationServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonServerMigrationServiceConfig to create AmazonServerMigrationServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonServerMigrationServiceClient(serviceClientConfig) :
                    new AmazonServerMigrationServiceClient(awsCredentials, serviceClientConfig);
        }
