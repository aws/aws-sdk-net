    ...
    public class CreateReplicationJobRequestMarshaller : IMarshaller<IRequest, CreateReplicationJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateReplicationJobRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetRunOnce())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.RunOnce.Value);
            }

            if(publicRequest.IsSetSeedReplicationTime())
            {
                context.Writer.WritePropertyName("seedReplicationTime");
                context.Writer.WriteNumberValue(Convert.ToInt64(StringUtils.FromDateTimeToUnixTimestamp(publicRequest.SeedReplicationTime.Value)));
            }
