...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VmServerAddressUnmarshaller : IJsonUnmarshaller<VmServerAddress, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VmServerAddress Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VmManagerId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
