...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetConnectorsRequestMarshaller : IMarshaller<IRequest, GetConnectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetConnectorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetConnectorsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServerMigrationService");
            string target = "AWSServerMigrationService_V2016_10_24.GetConnectors";
