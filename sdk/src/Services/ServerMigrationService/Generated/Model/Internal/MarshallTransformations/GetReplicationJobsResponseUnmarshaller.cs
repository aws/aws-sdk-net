    ...
    public class GetReplicationJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ReplicationJob, ReplicationJobUnmarshaller>(ReplicationJobUnmarshaller.Instance);
                    response.ReplicationJobList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
