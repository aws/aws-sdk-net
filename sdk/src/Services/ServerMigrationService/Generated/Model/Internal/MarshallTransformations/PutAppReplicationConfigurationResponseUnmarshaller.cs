...
{
    /// <summary>
    /// Response Unmarshaller for PutAppReplicationConfiguration operation
    /// </summary>  
    public class PutAppReplicationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAppReplicationConfigurationResponse response = new PutAppReplicationConfigurationResponse();
        ...
        private static PutAppReplicationConfigurationResponseUnmarshaller _instance = new PutAppReplicationConfigurationResponseUnmarshaller();        

        internal static PutAppReplicationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAppReplicationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
