        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("appSummary", targetDepth))
                {
                    ...
                    response.AppSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("serverGroups", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ServerGroup, ServerGroupUnmarshaller>(ServerGroupUnmarshaller.Instance);
                    response.ServerGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
