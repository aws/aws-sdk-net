...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApp operation
    /// </summary>  
    public class DeleteAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteAppResponseUnmarshaller _instance = new DeleteAppResponseUnmarshaller();        

        internal static DeleteAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
