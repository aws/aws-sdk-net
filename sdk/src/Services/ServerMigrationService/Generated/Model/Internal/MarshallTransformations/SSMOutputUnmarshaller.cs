...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SSMOutputUnmarshaller : IJsonUnmarshaller<SSMOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SSMOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
