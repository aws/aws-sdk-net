...
{
    /// <summary>
    /// Response Unmarshaller for StartAppReplication operation
    /// </summary>  
    public class StartAppReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAppReplicationResponse response = new StartAppReplicationResponse();
        ...
        private static StartAppReplicationResponseUnmarshaller _instance = new StartAppReplicationResponseUnmarshaller();        

        internal static StartAppReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAppReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
