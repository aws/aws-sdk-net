...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServerReplicationParametersUnmarshaller : IJsonUnmarshaller<ServerReplicationParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServerReplicationParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("seedTime", targetDepth))
                {
                    ...
                    unmarshalledObject.SeedTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
