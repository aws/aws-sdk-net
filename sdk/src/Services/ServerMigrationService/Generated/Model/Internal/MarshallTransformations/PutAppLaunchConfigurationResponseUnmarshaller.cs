...
{
    /// <summary>
    /// Response Unmarshaller for PutAppLaunchConfiguration operation
    /// </summary>  
    public class PutAppLaunchConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAppLaunchConfigurationResponse response = new PutAppLaunchConfigurationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonServerMigrationServiceException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static PutAppLaunchConfigurationResponseUnmarshaller _instance = new PutAppLaunchConfigurationResponseUnmarshaller();        

        internal static PutAppLaunchConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAppLaunchConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
