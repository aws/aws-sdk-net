...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisassociateConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateConnectorResponse response = new DisassociateConnectorResponse();
        ...
        private static DisassociateConnectorResponseUnmarshaller _instance = new DisassociateConnectorResponseUnmarshaller();        

        internal static DisassociateConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
