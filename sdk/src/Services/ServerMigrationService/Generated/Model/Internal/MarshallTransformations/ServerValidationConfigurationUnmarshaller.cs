...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServerValidationConfigurationUnmarshaller : IJsonUnmarshaller<ServerValidationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServerValidationConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ServerValidationStrategy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("userDataValidationParameters", targetDepth))
                {
                    ...
                    unmarshalledObject.UserDataValidationParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
