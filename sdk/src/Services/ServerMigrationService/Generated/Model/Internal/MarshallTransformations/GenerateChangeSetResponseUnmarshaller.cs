...
{
    /// <summary>
    /// Response Unmarshaller for GenerateChangeSet operation
    /// </summary>  
    public class GenerateChangeSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateChangeSetResponse response = new GenerateChangeSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("s3Location", targetDepth))
                {
                    ...
                    response.S3Location = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GenerateChangeSetResponseUnmarshaller _instance = new GenerateChangeSetResponseUnmarshaller();        

        internal static GenerateChangeSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateChangeSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
