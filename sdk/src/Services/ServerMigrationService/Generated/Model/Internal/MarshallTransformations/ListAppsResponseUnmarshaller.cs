...
{
    /// <summary>
    /// Response Unmarshaller for ListApps operation
    /// </summary>  
    public class ListAppsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AppSummary, AppSummaryUnmarshaller>(AppSummaryUnmarshaller.Instance);
        ...
        private static ListAppsResponseUnmarshaller _instance = new ListAppsResponseUnmarshaller();        

        internal static ListAppsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAppsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
