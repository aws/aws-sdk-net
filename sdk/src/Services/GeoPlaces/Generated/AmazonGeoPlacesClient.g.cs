...
namespace Amazon.GeoPlaces
{
    ...
    public partial class AmazonGeoPlacesClient : AmazonServiceClient, IAmazonGeoPlaces
    {
        ...
        /// 
        /// </summary>
        public AmazonGeoPlacesClient() : base(new AmazonGeoPlacesConfig()) { }
        ...
        public AmazonGeoPlacesClient(RegionEndpoint region) : base(new AmazonGeoPlacesConfig { RegionEndpoint = region }) { }
        ...
        public AmazonGeoPlacesClient(AmazonGeoPlacesConfig config) : base(config) { }
