...
{
    /// <summary>
    /// Container for the parameters to the Autocomplete operation. <c>Autocomplete</c> completes
    /// potential places and addresses as the user types, based on the partial input. The
    /// API enhances the efficiency and accuracy of address by completing query based on a
    /// few entered keystrokes. It helps you by completing partial queries with valid address
    /// completion. Also, the API supports the filtering of results based on geographic location,
    /// country, or specific place types, and can be tailored using optional parameters like
    /// language and political views. Not supported in <c>ap-southeast-1</c> and <c>ap-southeast-5</c>
    /// regions for <a href="https://docs.aws.amazon.com/location/latest/developerguide/GrabMaps.html">GrabMaps</a>
    /// customers. <para> For more information, see <a href="https://docs.aws.amazon.com/location/latest/developerguide/autocomplete.html">Autocomplete</a>
    ...
    public partial class AutocompleteRequest : AmazonGeoPlacesRequest
    {
        ...
        /// </para>
        /// </summary>
        public AutocompleteIntendedUse IntendedUse { get; set; }
