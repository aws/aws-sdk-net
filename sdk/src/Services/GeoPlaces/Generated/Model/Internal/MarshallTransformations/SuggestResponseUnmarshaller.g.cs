...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SuggestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SuggestResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("QueryRefinements", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.QueryRefinements = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static SuggestResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SuggestResponseUnmarshaller Instance => _instance;
    }
}
