...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AccessPointUnmarshaller : IJsonUnmarshaller<AccessPoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AccessPoint();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AccessPointUnmarshaller Instance => _instance;
    }
}
