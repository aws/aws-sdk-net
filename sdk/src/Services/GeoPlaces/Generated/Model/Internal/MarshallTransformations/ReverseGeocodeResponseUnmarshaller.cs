...
{
    /// <summary>
    /// Response Unmarshaller for ReverseGeocode operation
    /// </summary>  
    public class ReverseGeocodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ReverseGeocodeResultItem, ReverseGeocodeResultItemUnmarshaller>(ReverseGeocodeResultItemUnmarshaller.Instance);
        ...
        private static ReverseGeocodeResponseUnmarshaller _instance = new ReverseGeocodeResponseUnmarshaller();        

        internal static ReverseGeocodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReverseGeocodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
