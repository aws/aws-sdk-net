...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    public partial class AddressUnmarshaller : IJsonUnmarshaller<Address, JsonUnmarshallerContext>
    {
        ...
        public Address Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AddressNumber", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Building", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SecondaryAddressComponents", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("StreetComponents", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("SubBlock", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("SubDistrict", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
