...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddressComponentPhonemesUnmarshaller : IJsonUnmarshaller<AddressComponentPhonemes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AddressComponentPhonemes();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AddressComponentPhonemesUnmarshaller Instance => _instance;
    }
}
