...
{
    /// <summary>
    /// Response Unmarshaller for Geocode operation
    /// </summary>  
    public class GeocodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GeocodeResultItem, GeocodeResultItemUnmarshaller>(GeocodeResultItemUnmarshaller.Instance);
        ...
        private static GeocodeResponseUnmarshaller _instance = new GeocodeResponseUnmarshaller();        

        internal static GeocodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GeocodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
