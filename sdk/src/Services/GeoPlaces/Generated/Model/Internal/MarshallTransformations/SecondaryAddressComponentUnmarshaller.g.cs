...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SecondaryAddressComponentUnmarshaller : IJsonUnmarshaller<SecondaryAddressComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SecondaryAddressComponent();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SecondaryAddressComponentUnmarshaller Instance => _instance;
    }
}
