...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchTextRequestMarshaller : IMarshaller<IRequest, SearchTextRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(SearchTextRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/search-text";
#if !NETFRAMEWORK
        ...
        private static readonly SearchTextRequestMarshaller _instance = new();

        internal static SearchTextRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchTextRequestMarshaller Instance => _instance;
    }
}
