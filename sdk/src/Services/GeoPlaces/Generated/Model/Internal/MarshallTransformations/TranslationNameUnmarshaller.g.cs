...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TranslationNameUnmarshaller : IJsonUnmarshaller<TranslationName, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TranslationName();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TranslationNameUnmarshaller Instance => _instance;
    }
}
