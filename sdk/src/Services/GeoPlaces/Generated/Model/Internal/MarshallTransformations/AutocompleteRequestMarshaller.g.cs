...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutocompleteRequestMarshaller : IMarshaller<IRequest, AutocompleteRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AutocompleteRequestMarshaller _instance = new();

        internal static AutocompleteRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AutocompleteRequestMarshaller Instance => _instance;
    }
}
