...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ReverseGeocodeRequestMarshaller : IMarshaller<IRequest, ReverseGeocodeRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ReverseGeocodeRequestMarshaller _instance = new();

        internal static ReverseGeocodeRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ReverseGeocodeRequestMarshaller Instance => _instance;
    }
}
