...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ComponentMatchScoresUnmarshaller : IJsonUnmarshaller<ComponentMatchScores, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ComponentMatchScores();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ComponentMatchScoresUnmarshaller Instance => _instance;
    }
}
