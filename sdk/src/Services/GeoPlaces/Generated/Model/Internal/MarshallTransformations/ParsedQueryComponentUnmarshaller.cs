...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParsedQueryComponentUnmarshaller : IUnmarshaller<ParsedQueryComponent, XmlUnmarshallerContext>, IUnmarshaller<ParsedQueryComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ParsedQueryComponent IUnmarshaller<ParsedQueryComponent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ParsedQueryComponent Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("QueryComponent", targetDepth))
                {
                    ...
                    unmarshalledObject.QueryComponent = unmarshaller.Unmarshall(context);
                    continue;
                }
