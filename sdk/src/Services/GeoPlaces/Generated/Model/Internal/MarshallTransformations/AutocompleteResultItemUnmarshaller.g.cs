...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutocompleteResultItemUnmarshaller : IJsonUnmarshaller<AutocompleteResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AutocompleteResultItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutocompleteResultItemUnmarshaller Instance => _instance;
    }
}
