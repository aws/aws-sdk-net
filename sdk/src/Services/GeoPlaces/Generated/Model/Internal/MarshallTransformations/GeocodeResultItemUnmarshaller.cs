    ...
    public class GeocodeResultItemUnmarshaller : IJsonUnmarshaller<GeocodeResultItem, JsonUnmarshallerContext>
    {
        ...
        public GeocodeResultItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Intersections", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("MatchScores", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("ParsedQuery", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Translations", targetDepth, ref reader))
                {
                    var unmarshaller = TranslationDetailsUnmarshaller.Instance;
                    unmarshalledObject.Translations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
