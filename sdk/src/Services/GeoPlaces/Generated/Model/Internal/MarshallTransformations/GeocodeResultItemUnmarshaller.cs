...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeocodeResultItemUnmarshaller : IUnmarshaller<GeocodeResultItem, XmlUnmarshallerContext>, IUnmarshaller<GeocodeResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeocodeResultItem IUnmarshaller<GeocodeResultItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GeocodeResultItem Unmarshall(JsonUnmarshallerContext context)
        {
