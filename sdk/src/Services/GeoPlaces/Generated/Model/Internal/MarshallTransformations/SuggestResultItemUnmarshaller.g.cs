...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SuggestResultItemUnmarshaller : IJsonUnmarshaller<SuggestResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SuggestResultItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SuggestResultItemUnmarshaller Instance => _instance;
    }
}
