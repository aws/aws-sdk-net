...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RelatedPlaceUnmarshaller : IUnmarshaller<RelatedPlace, XmlUnmarshallerContext>, IUnmarshaller<RelatedPlace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RelatedPlace IUnmarshaller<RelatedPlace, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public RelatedPlace Unmarshall(JsonUnmarshallerContext context)
        {
