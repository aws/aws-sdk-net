...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpeningHoursUnmarshaller : IUnmarshaller<OpeningHours, XmlUnmarshallerContext>, IUnmarshaller<OpeningHours, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        OpeningHours IUnmarshaller<OpeningHours, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public OpeningHours Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<OpeningHoursComponents, OpeningHoursComponentsUnmarshaller>(OpeningHoursComponentsUnmarshaller.Instance);
                ...
                if (context.TestExpression("OpenNow", targetDepth))
                {
                    ...
                    unmarshalledObject.OpenNow = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
