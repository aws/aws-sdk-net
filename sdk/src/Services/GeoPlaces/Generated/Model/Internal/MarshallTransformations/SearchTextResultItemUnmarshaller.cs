...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SearchTextResultItemUnmarshaller : IJsonUnmarshaller<SearchTextResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SearchTextResultItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
