...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AdminNamesUnmarshaller : IJsonUnmarshaller<AdminNames, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AdminNames();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AdminNamesUnmarshaller Instance => _instance;
    }
}
