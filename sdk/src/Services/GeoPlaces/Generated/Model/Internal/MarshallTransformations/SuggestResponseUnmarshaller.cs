    ...
    public class SuggestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<QueryRefinement, QueryRefinementUnmarshaller>(QueryRefinementUnmarshaller.Instance);
                    response.QueryRefinements = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ResultItems", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<SuggestResultItem, SuggestResultItemUnmarshaller>(SuggestResultItemUnmarshaller.Instance);
