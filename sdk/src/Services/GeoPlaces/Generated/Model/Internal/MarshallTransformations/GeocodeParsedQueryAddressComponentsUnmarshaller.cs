...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeocodeParsedQueryAddressComponentsUnmarshaller : IUnmarshaller<GeocodeParsedQueryAddressComponents, XmlUnmarshallerContext>, IUnmarshaller<GeocodeParsedQueryAddressComponents, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GeocodeParsedQueryAddressComponents IUnmarshaller<GeocodeParsedQueryAddressComponents, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GeocodeParsedQueryAddressComponents Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ParsedQuerySecondaryAddressComponent, ParsedQuerySecondaryAddressComponentUnmarshaller>(ParsedQuerySecondaryAddressComponentUnmarshaller.Instance);
