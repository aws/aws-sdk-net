...
{
    /// <summary>
    /// Response Unmarshaller for SearchNearbyResultItem Object
    /// </summary>  
    public class SearchNearbyResultItemUnmarshaller : IUnmarshaller<SearchNearbyResultItem, XmlUnmarshallerContext>, IUnmarshaller<SearchNearbyResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SearchNearbyResultItem IUnmarshaller<SearchNearbyResultItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SearchNearbyResultItem Unmarshall(JsonUnmarshallerContext context)
        {
            SearchNearbyResultItem unmarshalledObject = new SearchNearbyResultItem();
        ...
        private static SearchNearbyResultItemUnmarshaller _instance = new SearchNearbyResultItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SearchNearbyResultItemUnmarshaller Instance
        {
            get
            {
                return _instance;
