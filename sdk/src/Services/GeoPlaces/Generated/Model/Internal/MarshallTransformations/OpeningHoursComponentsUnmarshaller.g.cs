...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OpeningHoursComponentsUnmarshaller : IJsonUnmarshaller<OpeningHoursComponents, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new OpeningHoursComponents();
        ...
        /// Gets the singleton.
        /// </summary>
        public static OpeningHoursComponentsUnmarshaller Instance => _instance;
    }
}
