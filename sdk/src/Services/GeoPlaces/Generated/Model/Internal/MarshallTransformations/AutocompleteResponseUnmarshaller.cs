...
{
    /// <summary>
    /// Response Unmarshaller for Autocomplete operation
    /// </summary>  
    public class AutocompleteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AutocompleteResultItem, AutocompleteResultItemUnmarshaller>(AutocompleteResultItemUnmarshaller.Instance);
        ...
        private static AutocompleteResponseUnmarshaller _instance = new AutocompleteResponseUnmarshaller();        

        internal static AutocompleteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AutocompleteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
