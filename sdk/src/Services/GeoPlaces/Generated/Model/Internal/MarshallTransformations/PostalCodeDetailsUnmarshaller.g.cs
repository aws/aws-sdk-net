...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PostalCodeDetailsUnmarshaller : IJsonUnmarshaller<PostalCodeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public PostalCodeDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new PostalCodeDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PostalCodeDetailsUnmarshaller Instance => _instance;
    }
}
