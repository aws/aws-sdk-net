...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactDetailsUnmarshaller : IJsonUnmarshaller<ContactDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContactDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
