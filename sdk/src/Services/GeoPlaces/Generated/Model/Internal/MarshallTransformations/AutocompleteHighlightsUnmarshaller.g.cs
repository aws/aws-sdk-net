...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AutocompleteHighlightsUnmarshaller : IJsonUnmarshaller<AutocompleteHighlights, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AutocompleteHighlights();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AutocompleteHighlightsUnmarshaller Instance => _instance;
    }
}
