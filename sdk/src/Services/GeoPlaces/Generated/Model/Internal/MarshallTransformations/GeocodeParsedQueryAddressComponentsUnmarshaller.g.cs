...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GeocodeParsedQueryAddressComponentsUnmarshaller : IJsonUnmarshaller<GeocodeParsedQueryAddressComponents, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GeocodeParsedQueryAddressComponents();
        ...
        /// Gets the singleton.
        /// </summary>
        public static GeocodeParsedQueryAddressComponentsUnmarshaller Instance => _instance;
    }
}
