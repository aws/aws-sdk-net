...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ContactsUnmarshaller : IJsonUnmarshaller<Contacts, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Contacts();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ContactsUnmarshaller Instance => _instance;
    }
}
