...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ParsedQueryComponentUnmarshaller : IJsonUnmarshaller<ParsedQueryComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ParsedQueryComponent();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ParsedQueryComponentUnmarshaller Instance => _instance;
    }
}
