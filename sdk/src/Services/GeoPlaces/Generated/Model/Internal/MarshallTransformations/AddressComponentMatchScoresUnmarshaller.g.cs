...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AddressComponentMatchScoresUnmarshaller : IJsonUnmarshaller<AddressComponentMatchScores, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AddressComponentMatchScores();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AddressComponentMatchScoresUnmarshaller Instance => _instance;
    }
}
