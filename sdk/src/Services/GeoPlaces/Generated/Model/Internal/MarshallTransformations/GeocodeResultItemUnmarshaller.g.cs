...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GeocodeResultItemUnmarshaller : IJsonUnmarshaller<GeocodeResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GeocodeResultItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static GeocodeResultItemUnmarshaller Instance => _instance;
    }
}
