...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CountryUnmarshaller : IJsonUnmarshaller<Country, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Country();
            ...
            {
                if (context.TestExpression("Code2", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Code3", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>
        public static CountryUnmarshaller Instance => _instance;
    }
}
