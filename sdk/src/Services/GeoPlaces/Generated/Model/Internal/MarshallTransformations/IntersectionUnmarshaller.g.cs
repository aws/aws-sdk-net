...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class IntersectionUnmarshaller : IJsonUnmarshaller<Intersection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Intersection();
        ...
        /// Gets the singleton.
        /// </summary>
        public static IntersectionUnmarshaller Instance => _instance;
    }
}
