...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PhonemeDetailsUnmarshaller : IJsonUnmarshaller<PhonemeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PhonemeDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static PhonemeDetailsUnmarshaller Instance => _instance;
    }
}
