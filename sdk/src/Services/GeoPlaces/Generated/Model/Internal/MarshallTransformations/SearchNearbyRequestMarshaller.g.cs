...
{
    /// <summary>
    /// SearchNearby Request Marshaller
    /// </summary>
    public partial class SearchNearbyRequestMarshaller : IMarshaller<IRequest, SearchNearbyRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchNearbyRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(SearchNearbyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v2/search-nearby";
#if !NETFRAMEWORK
            ...
            if (publicRequest.IsSetFilter())
            {
                ...
                var marshaller = SearchNearbyFilterMarshaller.Instance;
        ...
        private static readonly SearchNearbyRequestMarshaller _instance = new();

        internal static SearchNearbyRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SearchNearbyRequestMarshaller Instance => _instance;
    }
}
