...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchNearbyResultItemUnmarshaller : IJsonUnmarshaller<SearchNearbyResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchNearbyResultItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SearchNearbyResultItemUnmarshaller Instance => _instance;
    }
}
