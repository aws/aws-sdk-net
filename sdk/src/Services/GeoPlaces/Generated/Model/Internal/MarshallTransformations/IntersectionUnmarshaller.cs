...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IntersectionUnmarshaller : IUnmarshaller<Intersection, XmlUnmarshallerContext>, IUnmarshaller<Intersection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Intersection IUnmarshaller<Intersection, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Intersection Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = LongUnmarshaller.Instance;
                    unmarshalledObject.RouteDistance = unmarshaller.Unmarshall(context);
                    continue;
                }
