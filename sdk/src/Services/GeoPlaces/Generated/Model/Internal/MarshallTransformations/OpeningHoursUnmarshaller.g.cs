...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class OpeningHoursUnmarshaller : IJsonUnmarshaller<OpeningHours, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new OpeningHours();
        ...
        /// Gets the singleton.
        /// </summary>
        public static OpeningHoursUnmarshaller Instance => _instance;
    }
}
