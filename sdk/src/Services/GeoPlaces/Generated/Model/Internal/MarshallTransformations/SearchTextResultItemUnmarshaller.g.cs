...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SearchTextResultItemUnmarshaller : IJsonUnmarshaller<SearchTextResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new SearchTextResultItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static SearchTextResultItemUnmarshaller Instance => _instance;
    }
}
