...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TranslationDetailsUnmarshaller : IJsonUnmarshaller<TranslationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new TranslationDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static TranslationDetailsUnmarshaller Instance => _instance;
    }
}
