...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CountryHighlightsUnmarshaller : IJsonUnmarshaller<CountryHighlights, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CountryHighlights();
        ...
        /// Gets the singleton.
        /// </summary>
        public static CountryHighlightsUnmarshaller Instance => _instance;
    }
}
