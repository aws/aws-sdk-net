...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ContactDetailsUnmarshaller : IJsonUnmarshaller<ContactDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ContactDetails();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ContactDetailsUnmarshaller Instance => _instance;
    }
}
