...
{
    /// <summary>
    /// Response Unmarshaller for ReverseGeocodeResultItem Object
    /// </summary>
    public partial class ReverseGeocodeResultItemUnmarshaller : IJsonUnmarshaller<ReverseGeocodeResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ReverseGeocodeResultItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ReverseGeocodeResultItem();
        ...
        private static ReverseGeocodeResultItemUnmarshaller _instance = new ReverseGeocodeResultItemUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ReverseGeocodeResultItemUnmarshaller Instance => _instance;
    }
}
