...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class HighlightUnmarshaller : IJsonUnmarshaller<Highlight, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Highlight();
        ...
        /// Gets the singleton.
        /// </summary>
        public static HighlightUnmarshaller Instance => _instance;
    }
}
