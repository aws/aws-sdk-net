...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParsedQuerySecondaryAddressComponentUnmarshaller : IUnmarshaller<ParsedQuerySecondaryAddressComponent, XmlUnmarshallerContext>, IUnmarshaller<ParsedQuerySecondaryAddressComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ParsedQuerySecondaryAddressComponent IUnmarshaller<ParsedQuerySecondaryAddressComponent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ParsedQuerySecondaryAddressComponent Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Designator", targetDepth))
                {
                    ...
                    unmarshalledObject.Designator = unmarshaller.Unmarshall(context);
                    continue;
                }
