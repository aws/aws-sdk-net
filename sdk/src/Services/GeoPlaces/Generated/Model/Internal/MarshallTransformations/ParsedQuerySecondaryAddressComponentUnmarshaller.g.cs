...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ParsedQuerySecondaryAddressComponentUnmarshaller : IJsonUnmarshaller<ParsedQuerySecondaryAddressComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ParsedQuerySecondaryAddressComponent();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ParsedQuerySecondaryAddressComponentUnmarshaller Instance => _instance;
    }
}
