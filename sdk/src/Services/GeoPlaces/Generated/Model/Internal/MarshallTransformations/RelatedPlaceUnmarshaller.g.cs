...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RelatedPlaceUnmarshaller : IJsonUnmarshaller<RelatedPlace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new RelatedPlace();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RelatedPlaceUnmarshaller Instance => _instance;
    }
}
