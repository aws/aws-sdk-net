...
namespace Amazon.GeoPlaces.Model
{
    ...
    public partial class CrossReference
    {
        ...
        public List<Category> SourceCategories { get; set; } = AWSConfigs.InitializeCollections ? new List<Category>() : null;

        /// <summary>
        /// Checks to see if the SourceCategories property is set.
        /// </summary>
        internal bool IsSetSourceCategories() => this.SourceCategories != null && (this.SourceCategories.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the SourcePlaceId property is set.
        /// </summary>
        internal bool IsSetSourcePlaceId() => this.SourcePlaceId != null;
    }
}
