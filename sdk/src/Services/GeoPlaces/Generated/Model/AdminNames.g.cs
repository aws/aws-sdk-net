...
namespace Amazon.GeoPlaces.Model
{
    ...
    public partial class AdminNames
    {
        ...
        public List<TranslationName> Names { get; set; } = AWSConfigs.InitializeCollections ? new List<TranslationName>() : null;
        ...
        /// </para>
        /// </summary>
        public AdminNamesPreference Preference { get; set; }

        /// <summary>
        /// Checks to see if the Preference property is set.
        /// </summary>
        internal bool IsSetPreference() => this.Preference != null;
    }
}
