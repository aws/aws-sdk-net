...
namespace Amazon.GeoPlaces
{
    ...
    public partial class AmazonGeoPlacesConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Geo Places", "4.0.101.11");
        ...
        /// </summary>
        public static new string ServiceId => "Geo Places";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "geo-places";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2020-11-19";
