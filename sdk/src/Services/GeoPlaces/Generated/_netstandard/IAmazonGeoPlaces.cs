...
namespace Amazon.GeoPlaces
{
    ...
    public partial interface IAmazonGeoPlaces : IAmazonService, IDisposable
    {
        ...
        Task<AutocompleteResponse> AutocompleteAsync(AutocompleteRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GeocodeResponse> GeocodeAsync(GeocodeRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ReverseGeocodeResponse> ReverseGeocodeAsync(ReverseGeocodeRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SearchNearbyResponse> SearchNearbyAsync(SearchNearbyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SearchTextResponse> SearchTextAsync(SearchTextRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonGeoPlacesConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonGeoPlacesConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonGeoPlacesConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonGeoPlacesConfig to create AmazonGeoPlacesClient");
            }

            return awsCredentials == null ? 
                    new AmazonGeoPlacesClient(serviceClientConfig) :
                    new AmazonGeoPlacesClient(awsCredentials, serviceClientConfig);
        }
