        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("LookbackWindow", targetDepth))
                {
                    ...
                    response.LookbackWindow = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromoteMode = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RetrainingFrequency", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RetrainingFrequency = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("RetrainingStartDate", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.RetrainingStartDate = unmarshaller.Unmarshall(context);
                    continue;
                }
