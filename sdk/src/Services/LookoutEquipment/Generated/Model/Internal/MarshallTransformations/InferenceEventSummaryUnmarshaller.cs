...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceEventSummaryUnmarshaller : IUnmarshaller<InferenceEventSummary, XmlUnmarshallerContext>, IUnmarshaller<InferenceEventSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InferenceEventSummary IUnmarshaller<InferenceEventSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InferenceEventSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("EventDurationInSeconds", targetDepth))
                {
                    ...
                    unmarshalledObject.EventDurationInSeconds = unmarshaller.Unmarshall(context);
                    continue;
                }
