        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Equipment", targetDepth))
                {
                    ...
                    response.Equipment = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("FaultCode", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FaultCode = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LabelId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Notes", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Notes = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("Rating", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Rating = unmarshaller.Unmarshall(context);
                    continue;
                }
