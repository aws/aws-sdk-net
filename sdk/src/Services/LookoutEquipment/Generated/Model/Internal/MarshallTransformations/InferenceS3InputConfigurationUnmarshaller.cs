...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceS3InputConfigurationUnmarshaller : IJsonUnmarshaller<InferenceS3InputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InferenceS3InputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
