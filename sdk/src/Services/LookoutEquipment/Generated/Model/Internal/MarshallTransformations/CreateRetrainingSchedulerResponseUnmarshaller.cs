...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateRetrainingSchedulerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRetrainingSchedulerResponse response = new CreateRetrainingSchedulerResponse();
        ...
        private static CreateRetrainingSchedulerResponseUnmarshaller _instance = new CreateRetrainingSchedulerResponseUnmarshaller();        

        internal static CreateRetrainingSchedulerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRetrainingSchedulerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
