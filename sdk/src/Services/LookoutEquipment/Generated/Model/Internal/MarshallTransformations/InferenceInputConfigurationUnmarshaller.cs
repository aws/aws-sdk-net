...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceInputConfigurationUnmarshaller : IJsonUnmarshaller<InferenceInputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InferenceInputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
