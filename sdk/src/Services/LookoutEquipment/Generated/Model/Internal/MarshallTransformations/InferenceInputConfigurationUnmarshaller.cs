...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceInputConfigurationUnmarshaller : IUnmarshaller<InferenceInputConfiguration, XmlUnmarshallerContext>, IUnmarshaller<InferenceInputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InferenceInputConfiguration IUnmarshaller<InferenceInputConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public InferenceInputConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("InferenceInputNameConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.InferenceInputNameConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("InputTimeZoneOffset", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InputTimeZoneOffset = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static InferenceInputConfigurationUnmarshaller _instance = new InferenceInputConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InferenceInputConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
