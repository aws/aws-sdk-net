...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LabelsInputConfigurationUnmarshaller : IJsonUnmarshaller<LabelsInputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LabelsInputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
