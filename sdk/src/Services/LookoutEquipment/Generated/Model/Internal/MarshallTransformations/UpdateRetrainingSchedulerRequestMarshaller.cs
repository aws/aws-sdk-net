...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateRetrainingSchedulerRequestMarshaller : IMarshaller<IRequest, UpdateRetrainingSchedulerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRetrainingSchedulerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRetrainingSchedulerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.LookoutEquipment");
            string target = "AWSLookoutEquipmentFrontendService.UpdateRetrainingScheduler";
            ...
            if(publicRequest.IsSetLookbackWindow())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.LookbackWindow);
            }
            ...
            if(publicRequest.IsSetPromoteMode())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.PromoteMode);
            }

            if(publicRequest.IsSetRetrainingFrequency())
            {
                context.Writer.WritePropertyName("RetrainingFrequency");
                context.Writer.WriteStringValue(publicRequest.RetrainingFrequency);
            }
        ...
        private static UpdateRetrainingSchedulerRequestMarshaller _instance = new UpdateRetrainingSchedulerRequestMarshaller();        

        internal static UpdateRetrainingSchedulerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRetrainingSchedulerRequestMarshaller Instance
        {
            get
            {
                return _instance;
