...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListInferenceEventsRequestMarshaller : IMarshaller<IRequest, ListInferenceEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInferenceEventsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInferenceEventsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.LookoutEquipment");
            string target = "AWSLookoutEquipmentFrontendService.ListInferenceEvents";
        ...
        private static ListInferenceEventsRequestMarshaller _instance = new ListInferenceEventsRequestMarshaller();        

        internal static ListInferenceEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInferenceEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
