...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceSchedulerSummaryUnmarshaller : IUnmarshaller<InferenceSchedulerSummary, XmlUnmarshallerContext>, IUnmarshaller<InferenceSchedulerSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InferenceSchedulerSummary IUnmarshaller<InferenceSchedulerSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public InferenceSchedulerSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("DataUploadFrequency", targetDepth))
                {
                    ...
                    unmarshalledObject.DataUploadFrequency = unmarshaller.Unmarshall(context);
                    continue;
                }
