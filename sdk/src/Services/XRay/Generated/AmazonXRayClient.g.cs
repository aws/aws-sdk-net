...
namespace Amazon.XRay
{
    ...
    public partial class AmazonXRayClient : AmazonServiceClient, IAmazonXRay
    {
        ...
        /// 
        /// </summary>
        public AmazonXRayClient() : base(new AmazonXRayConfig()) { }
        ...
        public AmazonXRayClient(RegionEndpoint region) : base(new AmazonXRayConfig { RegionEndpoint = region }) { }
        ...
        public AmazonXRayClient(AmazonXRayConfig config) : base(config) { }
