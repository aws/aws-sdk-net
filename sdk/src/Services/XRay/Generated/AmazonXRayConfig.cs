...
namespace Amazon.XRay
{
    ...
    public partial class AmazonXRayConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("XRay", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "XRay";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "xray";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2016-04-12";
