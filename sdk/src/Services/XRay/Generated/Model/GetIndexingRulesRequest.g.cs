...
{
    /// <summary>
    /// Container for the parameters to the GetIndexingRules operation. Retrieves all indexing
    /// rules. <para> Indexing rules are used to determine the server-side sampling rate for
    /// spans ingested through the CloudWatchLogs destination and indexed by X-Ray. For more
