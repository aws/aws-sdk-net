...
namespace Amazon.XRay.Model
{
    ...
    public partial class GraphLink
    {
        ...
        /// </summary>
        public List<string> DestinationTraceIds { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the DestinationTraceIds property is set.
        /// </summary>
        internal bool IsSetDestinationTraceIds() => this.DestinationTraceIds != null && (this.DestinationTraceIds.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the SourceTraceId property is set.
        /// </summary>
        internal bool IsSetSourceTraceId() => this.SourceTraceId != null;
    }
}
