...
namespace Amazon.XRay.Model
{
    ...
    public partial class GetTimeSeriesServiceStatisticsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<TimeSeriesServiceStatistics> TimeSeriesServiceStatistics { get; set; } = AWSConfigs.InitializeCollections ? new List<TimeSeriesServiceStatistics>() : null;

        /// <summary>
        /// Checks to see if the TimeSeriesServiceStatistics property is set.
        /// </summary>
        internal bool IsSetTimeSeriesServiceStatistics() => this.TimeSeriesServiceStatistics != null && (this.TimeSeriesServiceStatistics.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
