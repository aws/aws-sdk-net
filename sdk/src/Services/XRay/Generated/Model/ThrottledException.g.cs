...
namespace Amazon.XRay.Model
{
    ...
    public partial class ThrottledException : AmazonXRayException
    {
        ...
        /// Construct instance of ThrottledException
        /// </summary>
        public ThrottledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ThrottledException
        /// </summary>
        public ThrottledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
