...
namespace Amazon.XRay.Model
{
    ...
    public partial class ListResourcePoliciesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<ResourcePolicy> ResourcePolicies { get; set; } = AWSConfigs.InitializeCollections ? new List<ResourcePolicy>() : null;

        /// <summary>
        /// Checks to see if the ResourcePolicies property is set.
        /// </summary>
        internal bool IsSetResourcePolicies() => this.ResourcePolicies != null && (this.ResourcePolicies.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
