...
{
    /// <summary>
    /// Container for the parameters to the CancelTraceRetrieval operation. Cancels an ongoing
    /// trace retrieval job initiated by <c>StartTraceRetrieval</c> using the provided <c>RetrievalToken</c>.
