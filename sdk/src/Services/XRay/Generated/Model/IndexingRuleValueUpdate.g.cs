...
namespace Amazon.XRay.Model
{
    ...
    public partial class IndexingRuleValueUpdate
    {
        ...
        /// </para>
        /// </summary>
        public ProbabilisticRuleValueUpdate Probabilistic { get; set; }

        /// <summary>
        /// Checks to see if the Probabilistic property is set.
        /// </summary>
        internal bool IsSetProbabilistic() => this.Probabilistic != null;
    }
}
