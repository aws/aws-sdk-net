...
{
    /// <summary>
    /// Container for the parameters to the StartTraceRetrieval operation. Initiates a trace
    /// retrieval process using the specified time range and for the given trace IDs in the
    /// Transaction Search generated CloudWatch log group. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html">Transaction
    /// Search</a>. <para> API returns a <c>RetrievalToken</c>, which can be used with <c>ListRetrievedTraces</c>
    ...
    /// </para> <para> If you are using <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html">CloudWatch
    ...
    /// search enabled. </para> <para> For retrieving data from X-Ray directly as opposed
    /// to the Transaction-Search Log group, see <a href="https://docs.aws.amazon.com/xray/latest/api/API_BatchGetTraces.html">BatchGetTraces</a>.
    /// </para>
    /// </summary>
