...
{
    /// <summary>
    /// Response Unmarshaller for GetSamplingStatisticSummaries operation
    /// </summary>  
    public class GetSamplingStatisticSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSamplingStatisticSummariesResponse response = new GetSamplingStatisticSummariesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SamplingStatisticSummaries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<SamplingStatisticSummary, SamplingStatisticSummaryUnmarshaller>(SamplingStatisticSummaryUnmarshaller.Instance);
                    response.SamplingStatisticSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSamplingStatisticSummariesResponseUnmarshaller _instance = new GetSamplingStatisticSummariesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSamplingStatisticSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
