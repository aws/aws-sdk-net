...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AnnotationValueUnmarshaller : IJsonUnmarshaller<AnnotationValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AnnotationValue();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumberValue", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static AnnotationValueUnmarshaller Instance => _instance;
    }
}
