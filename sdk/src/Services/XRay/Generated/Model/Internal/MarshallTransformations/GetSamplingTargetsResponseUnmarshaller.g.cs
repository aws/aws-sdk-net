...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetSamplingTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetSamplingTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("LastRuleModification", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.LastRuleModification = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SamplingTargetDocuments", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SamplingTargetDocuments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("UnprocessedBoostStatistics", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.UnprocessedBoostStatistics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UnprocessedStatistics, UnprocessedStatisticsUnmarshaller>(UnprocessedStatisticsUnmarshaller.Instance);
                    unmarshalledObject.UnprocessedStatistics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetSamplingTargetsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetSamplingTargetsResponseUnmarshaller Instance => _instance;
    }
}
