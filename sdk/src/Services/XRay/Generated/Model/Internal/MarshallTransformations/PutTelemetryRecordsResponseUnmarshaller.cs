...
{
    /// <summary>
    /// Response Unmarshaller for PutTelemetryRecords operation
    /// </summary>  
    public class PutTelemetryRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTelemetryRecordsResponse response = new PutTelemetryRecordsResponse();
        ...
        private static PutTelemetryRecordsResponseUnmarshaller _instance = new PutTelemetryRecordsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTelemetryRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
