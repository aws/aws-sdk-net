...
{
    /// <summary>
    /// Response Unmarshaller for GetEncryptionConfig operation
    /// </summary>  
    public class GetEncryptionConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEncryptionConfigResponse response = new GetEncryptionConfigResponse();
        ...
        private static GetEncryptionConfigResponseUnmarshaller _instance = new GetEncryptionConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEncryptionConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
