...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RetrievedServiceUnmarshaller : IJsonUnmarshaller<RetrievedService, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public RetrievedService Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new RetrievedService();
        ...
        /// Gets the singleton.
        /// </summary>
        public static RetrievedServiceUnmarshaller Instance => _instance;
    }
}
