...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ErrorRootCauseUnmarshaller : IJsonUnmarshaller<ErrorRootCause, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ErrorRootCause Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ErrorRootCause();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ErrorRootCauseUnmarshaller Instance => _instance;
    }
}
