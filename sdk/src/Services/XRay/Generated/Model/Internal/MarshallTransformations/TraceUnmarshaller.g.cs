...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class TraceUnmarshaller : IJsonUnmarshaller<Trace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new Trace();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LimitExceeded", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static TraceUnmarshaller Instance => _instance;
    }
}
