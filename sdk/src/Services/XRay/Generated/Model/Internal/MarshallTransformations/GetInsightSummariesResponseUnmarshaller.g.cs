...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetInsightSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetInsightSummariesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InsightSummaries", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.InsightSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetInsightSummariesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetInsightSummariesResponseUnmarshaller Instance => _instance;
    }
}
