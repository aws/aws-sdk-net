...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ResourcePolicyUnmarshaller : IJsonUnmarshaller<ResourcePolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ResourcePolicy();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PolicyRevisionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResourcePolicyUnmarshaller Instance => _instance;
    }
}
