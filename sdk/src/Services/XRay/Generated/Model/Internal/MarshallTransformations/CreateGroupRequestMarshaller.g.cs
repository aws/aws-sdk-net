...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateGroupRequestMarshaller : IMarshaller<IRequest, CreateGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateGroupRequest publicRequest)
        {
            ...
            request.ResourcePath = "/CreateGroup";
#if !NETFRAMEWORK
        ...
        private static readonly CreateGroupRequestMarshaller _instance = new();

        internal static CreateGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateGroupRequestMarshaller Instance => _instance;
    }
}
