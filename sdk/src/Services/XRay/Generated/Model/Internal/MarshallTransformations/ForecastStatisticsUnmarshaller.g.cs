...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ForecastStatisticsUnmarshaller : IJsonUnmarshaller<ForecastStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ForecastStatistics Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ForecastStatistics();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ForecastStatisticsUnmarshaller Instance => _instance;
    }
}
