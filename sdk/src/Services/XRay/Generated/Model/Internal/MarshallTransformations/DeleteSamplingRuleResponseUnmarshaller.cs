...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSamplingRule operation
    /// </summary>  
    public class DeleteSamplingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSamplingRuleResponse response = new DeleteSamplingRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SamplingRuleRecord", targetDepth))
                {
                    ...
                    response.SamplingRuleRecord = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DeleteSamplingRuleResponseUnmarshaller _instance = new DeleteSamplingRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSamplingRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
