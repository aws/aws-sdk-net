...
{
    /// <summary>
    /// Response Unmarshaller for GetInsightEvents operation
    /// </summary>  
    public class GetInsightEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInsightEventsResponse response = new GetInsightEventsResponse();
            ...
            {
                if (context.TestExpression("InsightEvents", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<InsightEvent, InsightEventUnmarshaller>(InsightEventUnmarshaller.Instance);
                    response.InsightEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetInsightEventsResponseUnmarshaller _instance = new GetInsightEventsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInsightEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
