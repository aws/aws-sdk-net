...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutTraceSegmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PutTraceSegmentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UnprocessedTraceSegments", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.UnprocessedTraceSegments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static PutTraceSegmentsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutTraceSegmentsResponseUnmarshaller Instance => _instance;
    }
}
