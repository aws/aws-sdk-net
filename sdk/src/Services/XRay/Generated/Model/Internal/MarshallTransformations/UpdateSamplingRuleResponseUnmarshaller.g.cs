...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSamplingRule operation.
    /// </summary>
    public partial class UpdateSamplingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateSamplingRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SamplingRuleRecord", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.SamplingRuleRecord = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateSamplingRuleResponseUnmarshaller _instance = new UpdateSamplingRuleResponseUnmarshaller();

        internal static UpdateSamplingRuleResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateSamplingRuleResponseUnmarshaller Instance => _instance;
    }
}
