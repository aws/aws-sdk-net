...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetRetrievedTracesGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetRetrievedTracesGraphResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RetrievalStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetRetrievedTracesGraphResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetRetrievedTracesGraphResponseUnmarshaller Instance => _instance;
    }
}
