...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutEncryptionConfigRequestMarshaller : IMarshaller<IRequest, PutEncryptionConfigRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(PutEncryptionConfigRequest publicRequest)
        {
            ...
            request.ResourcePath = "/PutEncryptionConfig";
#if !NETFRAMEWORK
        ...
        private static readonly PutEncryptionConfigRequestMarshaller _instance = new();

        internal static PutEncryptionConfigRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutEncryptionConfigRequestMarshaller Instance => _instance;
    }
}
