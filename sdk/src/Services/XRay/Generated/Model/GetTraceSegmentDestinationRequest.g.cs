...
{
    /// <summary>
    /// Container for the parameters to the GetTraceSegmentDestination operation. Retrieves
    /// the current destination of data sent to <c>PutTraceSegments</c> and <i>OpenTelemetry
