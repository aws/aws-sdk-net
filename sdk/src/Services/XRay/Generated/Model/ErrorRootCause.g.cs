...
namespace Amazon.XRay.Model
{
    ...
    public partial class ErrorRootCause
    {
        ...
        /// </para>
        /// </summary>
        public bool? ClientImpacting { get; set; }

        /// <summary>
        /// Checks to see if the ClientImpacting property is set.
        /// </summary>
        internal bool IsSetClientImpacting() => this.ClientImpacting.HasValue;
        ...
        /// </summary>
        public List<ErrorRootCauseService> Services { get; set; } = AWSConfigs.InitializeCollections ? new List<ErrorRootCauseService>() : null;
