...
namespace Amazon.XRay.Model
{
    ...
    public partial class GetInsightEventsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<InsightEvent> InsightEvents { get; set; } = AWSConfigs.InitializeCollections ? new List<InsightEvent>() : null;

        /// <summary>
        /// Checks to see if the InsightEvents property is set.
        /// </summary>
        internal bool IsSetInsightEvents() => this.InsightEvents != null && (this.InsightEvents.Count > 0 || !AWSConfigs.InitializeCollections);
