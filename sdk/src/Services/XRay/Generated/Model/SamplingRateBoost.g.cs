...
namespace Amazon.XRay.Model
{
    ...
    public partial class SamplingRateBoost
    {
        ...
        /// <summary>
        /// Checks to see if the CooldownWindowMinutes property is set.
        /// </summary>
        internal bool IsSetCooldownWindowMinutes() => this.CooldownWindowMinutes.HasValue;
        ...
        /// <summary>
        /// Checks to see if the MaxRate property is set.
        /// </summary>
        internal bool IsSetMaxRate() => this.MaxRate.HasValue;
    }
}
