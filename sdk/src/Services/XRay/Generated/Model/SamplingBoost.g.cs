...
namespace Amazon.XRay.Model
{
    ...
    public partial class SamplingBoost
    {
        ...
        /// <summary>
        /// Checks to see if the BoostRate property is set.
        /// </summary>
        internal bool IsSetBoostRate() => this.BoostRate.HasValue;
        ...
        /// </summary>
        [AWSProperty(Required = true)]
        public DateTime? BoostRateTTL { get; set; }

        /// <summary>
        /// Checks to see if the BoostRateTTL property is set.
        /// </summary>
        internal bool IsSetBoostRateTTL() => this.BoostRateTTL.HasValue;
    }
}
