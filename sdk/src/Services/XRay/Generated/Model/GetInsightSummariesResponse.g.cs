...
namespace Amazon.XRay.Model
{
    ...
    public partial class GetInsightSummariesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<InsightSummary> InsightSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<InsightSummary>() : null;

        /// <summary>
        /// Checks to see if the InsightSummaries property is set.
        /// </summary>
        internal bool IsSetInsightSummaries() => this.InsightSummaries != null && (this.InsightSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
