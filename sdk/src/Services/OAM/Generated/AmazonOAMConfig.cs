...
namespace Amazon.OAM
{
    ...
    public partial class AmazonOAMConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("OAM", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "OAM";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "oam";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2022-06-10";
