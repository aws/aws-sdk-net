...
namespace Amazon.OAM
{
    ...
    public partial class AmazonOAMClient : AmazonServiceClient, IAmazonOAM
    {
        ...
        /// 
        /// </summary>
        public AmazonOAMClient() : base(new AmazonOAMConfig()) { }
        ...
        public AmazonOAMClient(RegionEndpoint region) : base(new AmazonOAMConfig { RegionEndpoint = region }) { }
        ...
        public AmazonOAMClient(AmazonOAMConfig config) : base(config) { }
