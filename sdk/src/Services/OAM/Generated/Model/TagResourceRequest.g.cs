...
namespace Amazon.OAM.Model
{
    ...
    /// (key-value pairs) to the specified resource. Both sinks and links can be tagged. <para>
    /// Tags can help you organize and categorize your resources. You can also use them to
    /// scope user permissions by granting a user permission to access or change only resources
    /// with certain tag values. </para> <para> Tags don't have any semantic meaning to Amazon
    /// Web Services and are interpreted strictly as strings of characters. </para> <para>
    ...
    /// tag. </para> <para> You can associate as many as 50 tags with a resource. </para>
    /// <important> <para> Unlike tagging permissions in other Amazon Web Services services,
    /// to tag or untag links and sinks you must have the <c>oam:ResourceTag</c> permission.
    /// The <c>iam:ResourceTag</c> permission does not allow you to tag and untag links and
