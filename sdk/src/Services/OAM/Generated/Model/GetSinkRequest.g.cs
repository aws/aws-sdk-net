...
{
    /// <summary>
    /// Container for the parameters to the GetSink operation. Returns complete information
    /// about one monitoring account sink. <para> To use this operation, provide the sink
    /// ARN. To retrieve a list of sink ARNs, use <a href="https://docs.aws.amazon.com/OAM/latest/APIReference/API_ListSinks.html">ListSinks</a>.
    /// </para>
    /// </summary>
