...
namespace Amazon.OAM.Model
{
    ...
    public partial class MissingRequiredParameterException : AmazonOAMException
    {
        ...
        /// Construct instance of MissingRequiredParameterException
        /// </summary>
        public MissingRequiredParameterException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of MissingRequiredParameterException
        /// </summary>
        public MissingRequiredParameterException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of MissingRequiredParameterException
        /// </summary>
        public MissingRequiredParameterException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
