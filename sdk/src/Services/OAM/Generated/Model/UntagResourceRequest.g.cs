...
namespace Amazon.OAM.Model
{
    ...
    /// from the specified resource. <important> <para> Unlike tagging permissions in other
    /// Amazon Web Services services, to tag or untag links and sinks you must have the <c>oam:ResourceTag</c>
    /// permission. The <c>iam:TagResource</c> permission does not allow you to tag and untag
    /// links and sinks. </para> </important>
    /// </summary>
