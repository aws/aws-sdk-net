...
namespace Amazon.OAM.Model
{
    ...
    [Serializable]
#endif
    public partial class InvalidParameterException : AmazonOAMException
    {
        /// <summary>
        ...
        /// Construct instance of InvalidParameterException
        /// </summary>
        public InvalidParameterException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InvalidParameterException
        /// </summary>
        public InvalidParameterException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
