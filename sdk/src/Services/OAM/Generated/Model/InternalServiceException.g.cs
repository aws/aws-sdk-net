...
namespace Amazon.OAM.Model
{
    ...
    [Serializable]
#endif
    public partial class InternalServiceException : AmazonOAMException
    {
        /// <summary>
        ...
        /// Construct instance of InternalServiceException
        /// </summary>
        public InternalServiceException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of InternalServiceException
        /// </summary>
        public InternalServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of InternalServiceException
        /// </summary>
        public InternalServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
