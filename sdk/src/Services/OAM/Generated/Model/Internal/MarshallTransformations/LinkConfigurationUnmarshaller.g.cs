...
namespace Amazon.OAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LinkConfigurationUnmarshaller : IJsonUnmarshaller<LinkConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LinkConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LinkConfigurationUnmarshaller Instance => _instance;
    }
}
