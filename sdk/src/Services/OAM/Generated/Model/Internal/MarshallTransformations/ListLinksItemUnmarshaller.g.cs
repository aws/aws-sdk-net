...
namespace Amazon.OAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListLinksItemUnmarshaller : IJsonUnmarshaller<ListLinksItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListLinksItem();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ListLinksItemUnmarshaller Instance => _instance;
    }
}
