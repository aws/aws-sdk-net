...
namespace Amazon.OAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateLinkRequestMarshaller : IMarshaller<IRequest, CreateLinkRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateLinkRequestMarshaller _instance = new();

        internal static CreateLinkRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateLinkRequestMarshaller Instance => _instance;
    }
}
