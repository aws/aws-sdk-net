...
namespace Amazon.OAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLinksItemUnmarshaller : IUnmarshaller<ListLinksItem, XmlUnmarshallerContext>, IUnmarshaller<ListLinksItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ListLinksItem IUnmarshaller<ListLinksItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ListLinksItem Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
