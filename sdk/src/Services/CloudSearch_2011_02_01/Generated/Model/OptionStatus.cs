...
{
    /// <summary>
    /// The status of an option, including when it was last updated and whether it is actively
    /// in use for searches.
    /// </summary>
    public partial class OptionStatus
    {
        ...
        /// be visible in searches until <a>IndexDocuments</a> has been called and indexing is
        /// complete.</li> <li> <code>Processing</code>: the option's latest value is not yet
        /// visible in all searches but is in the process of being activated. </li> <li> <code>Active</code>:
        /// the option's latest value is completely visible. Any warnings or messages generated
        /// during processing are provided in <code>Diagnostics</code>.</li> </ul>
        /// </summary>
