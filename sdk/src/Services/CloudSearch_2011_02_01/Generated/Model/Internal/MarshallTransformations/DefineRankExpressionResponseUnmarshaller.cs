...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DefineRankExpressionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DefineRankExpressionResponse response = new DefineRankExpressionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DefineRankExpressionResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DefineRankExpressionResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("RankExpression", targetDepth))
                    {
                        ...
                        response.RankExpression = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static DefineRankExpressionResponseUnmarshaller _instance = new DefineRankExpressionResponseUnmarshaller();        

        internal static DefineRankExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DefineRankExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
