...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDomains operation
    /// </summary>  
    public class DescribeDomainsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeDomainsResponseUnmarshaller _instance = new DescribeDomainsResponseUnmarshaller();        

        internal static DescribeDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
