...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDefaultSearchFieldResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeDefaultSearchFieldResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = DefaultSearchFieldStatusUnmarshaller.Instance;
                        response.DefaultSearchField = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeDefaultSearchFieldResponseUnmarshaller _instance = new DescribeDefaultSearchFieldResponseUnmarshaller();        

        internal static DescribeDefaultSearchFieldResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDefaultSearchFieldResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
