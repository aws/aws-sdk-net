...
{
    /// <summary>
    /// Response Unmarshaller for DescribeServiceAccessPolicies operation
    /// </summary>  
    public class DescribeServiceAccessPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeServiceAccessPoliciesResponse response = new DescribeServiceAccessPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeServiceAccessPoliciesResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeServiceAccessPoliciesResponse response)
        {
        ...
        private static DescribeServiceAccessPoliciesResponseUnmarshaller _instance = new DescribeServiceAccessPoliciesResponseUnmarshaller();        

        internal static DescribeServiceAccessPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServiceAccessPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
