...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateStemmingOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateStemmingOptionsResponseUnmarshaller _instance = new UpdateStemmingOptionsResponseUnmarshaller();        

        internal static UpdateStemmingOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStemmingOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
