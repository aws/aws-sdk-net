...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAvailabilityOptions operation
    /// </summary>  
    public class DescribeAvailabilityOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            DescribeAvailabilityOptionsResponse response = new DescribeAvailabilityOptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeAvailabilityOptionsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeAvailabilityOptionsResponse response)
        {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("DisabledAction"))
            {
                return new DisabledOperationException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DescribeAvailabilityOptionsResponseUnmarshaller _instance = new DescribeAvailabilityOptionsResponseUnmarshaller();        

        internal static DescribeAvailabilityOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeAvailabilityOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
