...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteRankExpressionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeleteRankExpressionResponse response)
        {
        ...
        private static DeleteRankExpressionResponseUnmarshaller _instance = new DeleteRankExpressionResponseUnmarshaller();        

        internal static DeleteRankExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRankExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
