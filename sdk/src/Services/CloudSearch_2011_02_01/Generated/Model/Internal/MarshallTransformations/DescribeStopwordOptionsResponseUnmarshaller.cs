...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeStopwordOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            DescribeStopwordOptionsResponse response = new DescribeStopwordOptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeStopwordOptionsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeStopwordOptionsResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StopwordOptionsStatusUnmarshaller.Instance;
                        response.Stopwords = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeStopwordOptionsResponseUnmarshaller _instance = new DescribeStopwordOptionsResponseUnmarshaller();        

        internal static DescribeStopwordOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DescribeStopwordOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
