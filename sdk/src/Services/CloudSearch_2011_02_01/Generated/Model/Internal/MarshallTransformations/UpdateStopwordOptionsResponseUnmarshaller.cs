...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateStopwordOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateStopwordOptionsResponse response)
        {
        ...
        private static UpdateStopwordOptionsResponseUnmarshaller _instance = new UpdateStopwordOptionsResponseUnmarshaller();        

        internal static UpdateStopwordOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStopwordOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
