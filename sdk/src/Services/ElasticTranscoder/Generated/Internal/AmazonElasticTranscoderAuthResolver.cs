...
namespace Amazon.ElasticTranscoder.Internal
{
    ...
    public class AmazonElasticTranscoderAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonElasticTranscoderAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ElasticTranscoder.
        /// </summary>
        public AmazonElasticTranscoderAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonElasticTranscoderAuthSchemeParameters
            {
    ...
    public class AmazonElasticTranscoderAuthSchemeResolver : IAuthSchemeResolver<AmazonElasticTranscoderAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonElasticTranscoderAuthSchemeParameters authParameters)
        {
