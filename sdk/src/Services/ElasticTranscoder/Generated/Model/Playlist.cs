...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    /// the value of Container is <c>fmp4</c> (Fragmented MP4) or <c>ts</c> (MPEG-TS), Playlists
    /// contains information about the master playlists that you want Elastic Transcoder to
    /// create. We recommend that you create only one master playlist per output format. The
    ...
    public partial class Playlist
    {
        ...
        /// (<c>.m3u8</c> for <c>HLSv3</c> and <c>HLSv4</c> playlists, and <c>.ism</c> and <c>.ismc</c>
        /// for <c>Smooth</c> playlists). If you include a file extension in <c>Name</c>, the
