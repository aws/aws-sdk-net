...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReadPipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return IncompatibleVersionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            ...
            return new AmazonElasticTranscoderException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static ReadPipelineResponseUnmarshaller _instance = new ReadPipelineResponseUnmarshaller();        

        internal static ReadPipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReadPipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
