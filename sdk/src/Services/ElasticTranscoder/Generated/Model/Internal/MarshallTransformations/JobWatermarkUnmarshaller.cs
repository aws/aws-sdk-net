...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobWatermarkUnmarshaller : IJsonUnmarshaller<JobWatermark, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobWatermark Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("InputKey", targetDepth))
                {
                    ...
                    unmarshalledObject.InputKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PresetWatermarkId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PresetWatermarkId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
