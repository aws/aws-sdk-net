...
namespace Amazon.Route53RecoveryControlConfig
{
    ...
    public partial class AmazonRoute53RecoveryControlConfigException : AmazonServiceException
    {
        ...
        public AmazonRoute53RecoveryControlConfigException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonRoute53RecoveryControlConfigException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
