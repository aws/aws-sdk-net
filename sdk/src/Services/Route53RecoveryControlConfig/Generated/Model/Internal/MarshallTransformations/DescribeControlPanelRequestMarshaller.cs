...
{
    /// <summary>
    /// DescribeControlPanel Request Marshaller
    /// </summary>       
    public class DescribeControlPanelRequestMarshaller : IMarshaller<IRequest, DescribeControlPanelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeControlPanelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeControlPanelRequest publicRequest)
        {
        ...
        private static DescribeControlPanelRequestMarshaller _instance = new DescribeControlPanelRequestMarshaller();        

        internal static DescribeControlPanelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeControlPanelRequestMarshaller Instance
        {
            get
            {
                return _instance;
