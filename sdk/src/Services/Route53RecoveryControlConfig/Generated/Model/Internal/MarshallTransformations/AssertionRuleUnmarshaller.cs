...
namespace Amazon.Route53RecoveryControlConfig.Model.Internal.MarshallTransformations
{
    ...
    public class AssertionRuleUnmarshaller : IJsonUnmarshaller<AssertionRule, JsonUnmarshallerContext>
    {
        ...
        public AssertionRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AssertedControls", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AssertedControls = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ControlPanelArn", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("RuleConfig", targetDepth, ref reader))
                {
                    var unmarshaller = RuleConfigUnmarshaller.Instance;
                    unmarshalledObject.RuleConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SafetyRuleArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                ...
                if (context.TestExpression("WaitPeriodMs", targetDepth, ref reader))
                {
