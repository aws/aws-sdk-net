    ...
    public class ClusterUnmarshaller : IUnmarshaller<Cluster, XmlUnmarshallerContext>, IUnmarshaller<Cluster, JsonUnmarshallerContext>
    {
        ...
        public Cluster Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ClusterEndpoint, ClusterEndpointUnmarshaller>(ClusterEndpointUnmarshaller.Instance);
                    unmarshalledObject.ClusterEndpoints = unmarshaller.Unmarshall(context);
                    continue;
                }
