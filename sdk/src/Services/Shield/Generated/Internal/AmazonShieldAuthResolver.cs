...
namespace Amazon.Shield.Internal
{
    ...
    public class AmazonShieldAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonShieldAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Shield.
        /// </summary>
        public AmazonShieldAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonShieldAuthSchemeParameters
            {
    ...
    public class AmazonShieldAuthSchemeResolver : IAuthSchemeResolver<AmazonShieldAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonShieldAuthSchemeParameters authParameters)
        {
