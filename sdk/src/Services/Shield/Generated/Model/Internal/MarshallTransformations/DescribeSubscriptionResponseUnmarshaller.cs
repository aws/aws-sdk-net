...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSubscription operation
    /// </summary>  
    public class DescribeSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSubscriptionResponse response = new DescribeSubscriptionResponse();
        ...
        private static DescribeSubscriptionResponseUnmarshaller _instance = new DescribeSubscriptionResponseUnmarshaller();        

        internal static DescribeSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
