...
{
    /// <summary>
    /// Response Unmarshaller for EnableProactiveEngagement operation
    /// </summary>  
    public class EnableProactiveEngagementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableProactiveEngagementResponse response = new EnableProactiveEngagementResponse();
        ...
        private static EnableProactiveEngagementResponseUnmarshaller _instance = new EnableProactiveEngagementResponseUnmarshaller();        

        internal static EnableProactiveEngagementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableProactiveEngagementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
