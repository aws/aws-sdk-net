...
namespace Amazon.Shield.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProtectionGroupLimitsUnmarshaller : IUnmarshaller<ProtectionGroupLimits, XmlUnmarshallerContext>, IUnmarshaller<ProtectionGroupLimits, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProtectionGroupLimits IUnmarshaller<ProtectionGroupLimits, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ProtectionGroupLimits Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("MaxProtectionGroups", targetDepth))
                {
                    ...
                    unmarshalledObject.MaxProtectionGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PatternTypeLimits", targetDepth))
                {
                    ...
                    unmarshalledObject.PatternTypeLimits = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
