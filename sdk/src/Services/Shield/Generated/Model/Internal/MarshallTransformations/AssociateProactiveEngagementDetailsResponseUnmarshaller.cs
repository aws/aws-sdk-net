...
{
    /// <summary>
    /// Response Unmarshaller for AssociateProactiveEngagementDetails operation
    /// </summary>  
    public class AssociateProactiveEngagementDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateProactiveEngagementDetailsResponse response = new AssociateProactiveEngagementDetailsResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return OptimisticLockExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static AssociateProactiveEngagementDetailsResponseUnmarshaller _instance = new AssociateProactiveEngagementDetailsResponseUnmarshaller();        

        internal static AssociateProactiveEngagementDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateProactiveEngagementDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
