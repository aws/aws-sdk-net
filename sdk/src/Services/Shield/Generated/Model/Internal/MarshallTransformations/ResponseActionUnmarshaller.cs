...
namespace Amazon.Shield.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResponseActionUnmarshaller : IJsonUnmarshaller<ResponseAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResponseAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
