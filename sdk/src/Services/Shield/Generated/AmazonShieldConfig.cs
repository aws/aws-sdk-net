...
<<<<<<< HEAD
            InternalSDKUtils.BuildUserAgentString("Shield", "4.0.0.0");

        private static readonly AmazonShieldEndpointResolver EndpointResolver =
            new AmazonShieldEndpointResolver();
||||||| Commit version number update changes
            InternalSDKUtils.BuildUserAgentString("Shield", "3.7.400.130");
=======
            InternalSDKUtils.BuildUserAgentString("Shield", "3.7.400.140");
