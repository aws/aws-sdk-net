...
namespace Amazon.ChimeSDKMessaging
{
    ...
    public partial class AmazonChimeSDKMessagingConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Chime SDK Messaging", "4.0.100.15");
        ...
        /// </summary>
        public static new string ServiceId => "Chime SDK Messaging";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "messaging-chime";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-05-15";
