...
{
    /// <summary>
    /// Container for the parameters to the GetChannelMembershipPreferences operation. Gets
    /// the membership preferences of an <c>AppInstanceUser</c> or <c>AppInstanceBot</c> for
    /// the specified channel. A user or a bot must be a member of the channel and own the
    /// membership in order to retrieve membership preferences. Users or bots in the <c>AppInstanceAdmin</c>
    ...
    /// are banned. <note> <para> The <c>x-amz-chime-bearer</c> request header is mandatory.
