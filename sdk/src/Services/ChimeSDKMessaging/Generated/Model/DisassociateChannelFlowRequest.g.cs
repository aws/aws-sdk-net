...
{
    /// <summary>
    /// Container for the parameters to the DisassociateChannelFlow operation. Disassociates
    /// a channel flow from all its channels. Once disassociated, all messages to that channel
    /// stop going through the channel flow processor. <note> <para> Only administrators or
    /// channel moderators can disassociate a channel flow. </para> <para> The <c>x-amz-chime-bearer</c>
