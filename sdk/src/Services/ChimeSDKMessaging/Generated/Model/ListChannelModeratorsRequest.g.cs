...
{
    /// <summary>
    /// Container for the parameters to the ListChannelModerators operation. Lists all the
    /// moderators for a channel. <note> <para> The <c>x-amz-chime-bearer</c> request header
    ...
    /// </summary>
    public partial class ListChannelModeratorsRequest : AmazonChimeSDKMessagingRequest
    {
        /// <summary>
