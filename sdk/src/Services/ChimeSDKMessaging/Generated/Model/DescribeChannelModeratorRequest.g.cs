...
{
    /// <summary>
    /// Container for the parameters to the DescribeChannelModerator operation. Returns the
    /// full details of a single ChannelModerator. <note> <para> The <c>x-amz-chime-bearer</c>
    /// request header is mandatory. Use the <c>AppInstanceUserArn</c> of the user that makes
    /// the API call as the value in the header. </para> </note>
    /// </summary>
