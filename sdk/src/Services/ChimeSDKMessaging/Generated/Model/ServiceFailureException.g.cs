...
namespace Amazon.ChimeSDKMessaging.Model
{
    ...
    [Serializable]
#endif
    public partial class ServiceFailureException : AmazonChimeSDKMessagingException
    {
        /// <summary>
        ...
        /// Construct instance of ServiceFailureException
        /// </summary>
        public ServiceFailureException(Exception innerException) : base(innerException) { }

        /// <summary>
        /// Construct instance of ServiceFailureException
        /// </summary>
        public ServiceFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, innerException, errorType, errorCode, requestId, statusCode) { }

        /// <summary>
        /// Construct instance of ServiceFailureException
        /// </summary>
        public ServiceFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) : base(message, errorType, errorCode, requestId, statusCode) { }
