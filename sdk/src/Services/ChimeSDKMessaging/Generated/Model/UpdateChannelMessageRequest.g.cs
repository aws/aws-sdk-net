...
{
    /// <summary>
    /// Container for the parameters to the UpdateChannelMessage operation. Updates the content
    /// of a message. <note> <para> The <c>x-amz-chime-bearer</c> request header is mandatory.
