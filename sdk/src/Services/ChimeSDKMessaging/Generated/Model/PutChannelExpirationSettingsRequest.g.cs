...
{
    /// <summary>
    /// Container for the parameters to the PutChannelExpirationSettings operation. Sets the
    /// number of days before the channel is automatically deleted. <note> <ul> <li> <para>
    /// A background process deletes expired channels within 6 hours of expiration. Actual
    /// deletion times may vary. </para> </li> <li> <para> Expired channels that have not
    /// yet been deleted appear as active, and you can update their expiration settings. The
    /// system honors the new settings. </para> </li> <li> <para> The <c>x-amz-chime-bearer</c>
