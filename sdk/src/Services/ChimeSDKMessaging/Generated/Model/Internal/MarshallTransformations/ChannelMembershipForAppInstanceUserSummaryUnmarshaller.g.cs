...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelMembershipForAppInstanceUserSummaryUnmarshaller : IJsonUnmarshaller<ChannelMembershipForAppInstanceUserSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelMembershipForAppInstanceUserSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelMembershipForAppInstanceUserSummaryUnmarshaller Instance => _instance;
    }
}
