...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateChannelMessageRequestMarshaller : IMarshaller<IRequest, UpdateChannelMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateChannelMessageRequestMarshaller _instance = new();

        internal static UpdateChannelMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateChannelMessageRequestMarshaller Instance => _instance;
    }
}
