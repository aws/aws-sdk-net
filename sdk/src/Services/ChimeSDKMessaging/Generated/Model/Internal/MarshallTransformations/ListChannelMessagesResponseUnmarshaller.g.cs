...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListChannelMessagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ChannelMessages", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChannelMessages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListChannelMessagesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelMessagesResponseUnmarshaller Instance => _instance;
    }
}
