...
{
    /// <summary>
    /// DescribeChannelMembership Request Marshaller
    /// </summary>       
    public class DescribeChannelMembershipRequestMarshaller : IMarshaller<IRequest, DescribeChannelMembershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeChannelMembershipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeChannelMembershipRequest publicRequest)
        {
        ...
        private static DescribeChannelMembershipRequestMarshaller _instance = new DescribeChannelMembershipRequestMarshaller();        

        internal static DescribeChannelMembershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelMembershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
