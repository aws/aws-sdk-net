...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteChannelBanRequestMarshaller : IMarshaller<IRequest, DeleteChannelBanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteChannelBanRequestMarshaller _instance = new();

        internal static DeleteChannelBanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteChannelBanRequestMarshaller Instance => _instance;
    }
}
