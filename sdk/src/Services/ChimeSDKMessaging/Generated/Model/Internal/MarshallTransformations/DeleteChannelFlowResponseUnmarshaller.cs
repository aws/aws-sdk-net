...
{
    /// <summary>
    /// Response Unmarshaller for DeleteChannelFlow operation
    /// </summary>  
    public class DeleteChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteChannelFlowResponse response = new DeleteChannelFlowResponse();
        ...
        private static DeleteChannelFlowResponseUnmarshaller _instance = new DeleteChannelFlowResponseUnmarshaller();        

        internal static DeleteChannelFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
