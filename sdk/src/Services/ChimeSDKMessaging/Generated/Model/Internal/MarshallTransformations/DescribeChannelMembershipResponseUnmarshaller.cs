...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelMembership operation
    /// </summary>  
    public class DescribeChannelMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelMembershipResponse response = new DescribeChannelMembershipResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChannelMembership", targetDepth, ref reader))
                {
                    var unmarshaller = ChannelMembershipUnmarshaller.Instance;
                    response.ChannelMembership = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeChannelMembershipResponseUnmarshaller _instance = new DescribeChannelMembershipResponseUnmarshaller();        

        internal static DescribeChannelMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
