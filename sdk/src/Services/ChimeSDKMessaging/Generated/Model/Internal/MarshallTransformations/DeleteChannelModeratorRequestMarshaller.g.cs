...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteChannelModeratorRequestMarshaller : IMarshaller<IRequest, DeleteChannelModeratorRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteChannelModeratorRequestMarshaller _instance = new();

        internal static DeleteChannelModeratorRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteChannelModeratorRequestMarshaller Instance => _instance;
    }
}
