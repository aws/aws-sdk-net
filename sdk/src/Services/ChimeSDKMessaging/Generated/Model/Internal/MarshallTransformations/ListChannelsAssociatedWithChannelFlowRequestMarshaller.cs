...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListChannelsAssociatedWithChannelFlowRequestMarshaller : IMarshaller<IRequest, ListChannelsAssociatedWithChannelFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListChannelsAssociatedWithChannelFlowRequestMarshaller _instance = new ListChannelsAssociatedWithChannelFlowRequestMarshaller();        

        internal static ListChannelsAssociatedWithChannelFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelsAssociatedWithChannelFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
