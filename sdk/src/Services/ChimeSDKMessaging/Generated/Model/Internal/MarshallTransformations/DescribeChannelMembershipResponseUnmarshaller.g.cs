...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeChannelMembershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChannelMembership", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChannelMembership = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeChannelMembershipResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelMembershipResponseUnmarshaller Instance => _instance;
    }
}
