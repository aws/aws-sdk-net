...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelBanUnmarshaller : IJsonUnmarshaller<ChannelBan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelBan();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelBanUnmarshaller Instance => _instance;
    }
}
