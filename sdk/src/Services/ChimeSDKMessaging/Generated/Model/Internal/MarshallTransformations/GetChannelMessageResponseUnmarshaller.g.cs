...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetChannelMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new GetChannelMessageResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChannelMessage", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChannelMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static GetChannelMessageResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetChannelMessageResponseUnmarshaller Instance => _instance;
    }
}
