...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelMessagesRequestMarshaller : IMarshaller<IRequest, ListChannelMessagesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListChannelMessagesRequestMarshaller _instance = new();

        internal static ListChannelMessagesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelMessagesRequestMarshaller Instance => _instance;
    }
}
