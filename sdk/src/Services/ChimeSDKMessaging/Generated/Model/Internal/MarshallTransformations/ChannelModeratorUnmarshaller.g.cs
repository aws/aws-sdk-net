...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelModeratorUnmarshaller : IJsonUnmarshaller<ChannelModerator, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelModerator();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelModeratorUnmarshaller Instance => _instance;
    }
}
