...
{
    /// <summary>
    /// Response Unmarshaller for DeleteChannelModerator operation
    /// </summary>  
    public class DeleteChannelModeratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteChannelModeratorResponse response = new DeleteChannelModeratorResponse();
        ...
        private static DeleteChannelModeratorResponseUnmarshaller _instance = new DeleteChannelModeratorResponseUnmarshaller();        

        internal static DeleteChannelModeratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelModeratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
