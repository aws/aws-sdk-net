...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelModeratorRequestMarshaller : IMarshaller<IRequest, DescribeChannelModeratorRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChannelModeratorRequestMarshaller _instance = new();

        internal static DescribeChannelModeratorRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelModeratorRequestMarshaller Instance => _instance;
    }
}
