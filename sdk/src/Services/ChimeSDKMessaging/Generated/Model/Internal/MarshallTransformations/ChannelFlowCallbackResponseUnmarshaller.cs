...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChannelFlowCallbackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ChannelFlowCallbackResponse response = new ChannelFlowCallbackResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CallbackId", targetDepth))
                {
                    ...
                    response.CallbackId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ChannelFlowCallbackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChannelFlowCallbackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
