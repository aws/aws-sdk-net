...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelMessageUnmarshaller : IJsonUnmarshaller<ChannelMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelMessage();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelMessageUnmarshaller Instance => _instance;
    }
}
