...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteChannelMembershipRequestMarshaller : IMarshaller<IRequest, DeleteChannelMembershipRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteChannelMembershipRequestMarshaller _instance = new();

        internal static DeleteChannelMembershipRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteChannelMembershipRequestMarshaller Instance => _instance;
    }
}
