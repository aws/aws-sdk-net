...
{
    /// <summary>
    /// GetChannelMembershipPreferences Request Marshaller
    /// </summary>
    public partial class GetChannelMembershipPreferencesRequestMarshaller : IMarshaller<IRequest, GetChannelMembershipPreferencesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetChannelMembershipPreferencesRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetChannelMembershipPreferencesRequest publicRequest)
        {
        ...
        private static readonly GetChannelMembershipPreferencesRequestMarshaller _instance = new();

        internal static GetChannelMembershipPreferencesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetChannelMembershipPreferencesRequestMarshaller Instance => _instance;
    }
}
