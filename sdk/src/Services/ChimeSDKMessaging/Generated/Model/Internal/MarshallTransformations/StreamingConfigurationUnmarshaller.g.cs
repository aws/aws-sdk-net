...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class StreamingConfigurationUnmarshaller : IJsonUnmarshaller<StreamingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new StreamingConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static StreamingConfigurationUnmarshaller Instance => _instance;
    }
}
