...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelFlowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListChannelFlowsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChannelFlows", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChannelFlows = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListChannelFlowsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelFlowsResponseUnmarshaller Instance => _instance;
    }
}
