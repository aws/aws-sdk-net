...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelBanRequestMarshaller : IMarshaller<IRequest, DescribeChannelBanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChannelBanRequestMarshaller _instance = new();

        internal static DescribeChannelBanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelBanRequestMarshaller Instance => _instance;
    }
}
