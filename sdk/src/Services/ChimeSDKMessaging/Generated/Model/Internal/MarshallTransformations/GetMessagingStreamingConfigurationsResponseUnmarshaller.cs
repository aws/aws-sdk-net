...
{
    /// <summary>
    /// Response Unmarshaller for GetMessagingStreamingConfigurations operation
    /// </summary>  
    public class GetMessagingStreamingConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMessagingStreamingConfigurationsResponse response = new GetMessagingStreamingConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StreamingConfiguration, StreamingConfigurationUnmarshaller>(StreamingConfigurationUnmarshaller.Instance);
                    response.StreamingConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetMessagingStreamingConfigurationsResponseUnmarshaller _instance = new GetMessagingStreamingConfigurationsResponseUnmarshaller();        

        internal static GetMessagingStreamingConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMessagingStreamingConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
