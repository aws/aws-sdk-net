...
{
    /// <summary>
    /// Response Unmarshaller for ChannelMembership Object
    /// </summary>  
    public class ChannelMembershipUnmarshaller : IJsonUnmarshaller<ChannelMembership, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChannelMembership Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("InvitedBy", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("SubChannelId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SubChannelId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ChannelMembershipUnmarshaller _instance = new ChannelMembershipUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChannelMembershipUnmarshaller Instance
        {
            get
            {
                return _instance;
