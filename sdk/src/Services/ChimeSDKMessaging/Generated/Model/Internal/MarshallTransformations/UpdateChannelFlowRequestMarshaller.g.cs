...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateChannelFlowRequestMarshaller : IMarshaller<IRequest, UpdateChannelFlowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateChannelFlowRequestMarshaller _instance = new();

        internal static UpdateChannelFlowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateChannelFlowRequestMarshaller Instance => _instance;
    }
}
