...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelMembershipForAppInstanceUserRequestMarshaller : IMarshaller<IRequest, DescribeChannelMembershipForAppInstanceUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChannelMembershipForAppInstanceUserRequestMarshaller _instance = new();

        internal static DescribeChannelMembershipForAppInstanceUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelMembershipForAppInstanceUserRequestMarshaller Instance => _instance;
    }
}
