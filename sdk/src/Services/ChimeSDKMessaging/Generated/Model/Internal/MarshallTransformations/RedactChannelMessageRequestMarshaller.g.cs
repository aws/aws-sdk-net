...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RedactChannelMessageRequestMarshaller : IMarshaller<IRequest, RedactChannelMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RedactChannelMessageRequestMarshaller _instance = new();

        internal static RedactChannelMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RedactChannelMessageRequestMarshaller Instance => _instance;
    }
}
