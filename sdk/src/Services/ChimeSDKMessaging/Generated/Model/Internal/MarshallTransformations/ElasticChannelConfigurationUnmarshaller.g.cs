...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ElasticChannelConfigurationUnmarshaller : IJsonUnmarshaller<ElasticChannelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ElasticChannelConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ElasticChannelConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ElasticChannelConfigurationUnmarshaller Instance => _instance;
    }
}
