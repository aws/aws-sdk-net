...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelMembershipPreferencesUnmarshaller : IJsonUnmarshaller<ChannelMembershipPreferences, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelMembershipPreferences();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelMembershipPreferencesUnmarshaller Instance => _instance;
    }
}
