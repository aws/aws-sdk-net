...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelMembershipUnmarshaller : IJsonUnmarshaller<ChannelMembership, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelMembership();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelMembershipUnmarshaller Instance => _instance;
    }
}
