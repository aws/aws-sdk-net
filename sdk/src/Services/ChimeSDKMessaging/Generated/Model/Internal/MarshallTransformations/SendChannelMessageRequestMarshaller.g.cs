...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class SendChannelMessageRequestMarshaller : IMarshaller<IRequest, SendChannelMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly SendChannelMessageRequestMarshaller _instance = new();

        internal static SendChannelMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SendChannelMessageRequestMarshaller Instance => _instance;
    }
}
