...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchCreateChannelMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BatchCreateChannelMembershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("BatchChannelMemberships", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.BatchChannelMemberships = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static BatchCreateChannelMembershipResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchCreateChannelMembershipResponseUnmarshaller Instance => _instance;
    }
}
