...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListSubChannelsRequestMarshaller : IMarshaller<IRequest, ListSubChannelsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListSubChannelsRequestMarshaller _instance = new();

        internal static ListSubChannelsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListSubChannelsRequestMarshaller Instance => _instance;
    }
}
