...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeChannelFlowResponse();
            ...
            {
                if (context.TestExpression("ChannelFlow", targetDepth, ref reader))
                {
                    var unmarshaller = ChannelFlowUnmarshaller.Instance;
                    unmarshalledObject.ChannelFlow = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeChannelFlowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelFlowResponseUnmarshaller Instance => _instance;
    }
}
