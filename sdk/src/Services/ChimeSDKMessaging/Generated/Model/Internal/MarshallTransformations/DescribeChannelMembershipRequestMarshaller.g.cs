...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelMembershipRequestMarshaller : IMarshaller<IRequest, DescribeChannelMembershipRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChannelMembershipRequestMarshaller _instance = new();

        internal static DescribeChannelMembershipRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelMembershipRequestMarshaller Instance => _instance;
    }
}
