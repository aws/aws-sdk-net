...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelBansResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListChannelBansResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ChannelBans", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.ChannelBans = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListChannelBansResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelBansResponseUnmarshaller Instance => _instance;
    }
}
