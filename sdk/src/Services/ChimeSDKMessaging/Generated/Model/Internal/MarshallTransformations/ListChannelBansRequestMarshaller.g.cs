...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelBansRequestMarshaller : IMarshaller<IRequest, ListChannelBansRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListChannelBansRequestMarshaller _instance = new();

        internal static ListChannelBansRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelBansRequestMarshaller Instance => _instance;
    }
}
