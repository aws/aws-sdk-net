...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class MessageAttributeValueUnmarshaller : IJsonUnmarshaller<MessageAttributeValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new MessageAttributeValue();
        ...
        /// Gets the singleton.
        /// </summary>
        public static MessageAttributeValueUnmarshaller Instance => _instance;
    }
}
