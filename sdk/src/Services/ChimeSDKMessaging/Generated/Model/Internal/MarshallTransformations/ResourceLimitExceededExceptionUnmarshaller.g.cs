...
{
    /// <summary>
    /// Exception Unmarshaller for ResourceLimitExceededException
    /// </summary>
    public partial class ResourceLimitExceededExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ResourceLimitExceededException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ResourceLimitExceededException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        ...
        /// Gets the singleton.
        /// </summary>
        public static ResourceLimitExceededExceptionUnmarshaller Instance => _instance;
    }
}
