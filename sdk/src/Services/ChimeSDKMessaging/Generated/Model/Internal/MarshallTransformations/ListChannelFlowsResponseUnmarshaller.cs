...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelFlows operation
    /// </summary>  
    public class ListChannelFlowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelFlowsResponse response = new ListChannelFlowsResponse();
            ...
            {
                if (context.TestExpression("ChannelFlows", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelFlowSummary, ChannelFlowSummaryUnmarshaller>(ChannelFlowSummaryUnmarshaller.Instance);
                    response.ChannelFlows = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListChannelFlowsResponseUnmarshaller _instance = new ListChannelFlowsResponseUnmarshaller();        

        internal static ListChannelFlowsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelFlowsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
