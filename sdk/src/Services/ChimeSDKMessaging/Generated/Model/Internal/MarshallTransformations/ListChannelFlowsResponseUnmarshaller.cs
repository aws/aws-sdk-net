    ...
    public class ListChannelFlowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ChannelFlowSummary, ChannelFlowSummaryUnmarshaller>(ChannelFlowSummaryUnmarshaller.Instance);
                    response.ChannelFlows = unmarshaller.Unmarshall(context);
                    continue;
                }
