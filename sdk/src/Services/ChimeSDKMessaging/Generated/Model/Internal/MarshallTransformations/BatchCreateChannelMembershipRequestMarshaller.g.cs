...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BatchCreateChannelMembershipRequestMarshaller : IMarshaller<IRequest, BatchCreateChannelMembershipRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly BatchCreateChannelMembershipRequestMarshaller _instance = new();

        internal static BatchCreateChannelMembershipRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static BatchCreateChannelMembershipRequestMarshaller Instance => _instance;
    }
}
