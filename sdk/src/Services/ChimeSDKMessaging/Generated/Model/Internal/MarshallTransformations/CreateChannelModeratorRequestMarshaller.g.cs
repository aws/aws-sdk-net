...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateChannelModeratorRequestMarshaller : IMarshaller<IRequest, CreateChannelModeratorRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateChannelModeratorRequestMarshaller _instance = new();

        internal static CreateChannelModeratorRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChannelModeratorRequestMarshaller Instance => _instance;
    }
}
