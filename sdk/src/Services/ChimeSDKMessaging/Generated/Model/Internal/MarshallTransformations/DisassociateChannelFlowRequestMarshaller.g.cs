...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DisassociateChannelFlowRequestMarshaller : IMarshaller<IRequest, DisassociateChannelFlowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DisassociateChannelFlowRequestMarshaller _instance = new();

        internal static DisassociateChannelFlowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DisassociateChannelFlowRequestMarshaller Instance => _instance;
    }
}
