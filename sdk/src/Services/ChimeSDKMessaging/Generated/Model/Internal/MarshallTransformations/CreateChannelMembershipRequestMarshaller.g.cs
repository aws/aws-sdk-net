...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateChannelMembershipRequestMarshaller : IMarshaller<IRequest, CreateChannelMembershipRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateChannelMembershipRequestMarshaller _instance = new();

        internal static CreateChannelMembershipRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChannelMembershipRequestMarshaller Instance => _instance;
    }
}
