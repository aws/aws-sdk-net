...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelRequestMarshaller : IMarshaller<IRequest, DescribeChannelRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChannelRequestMarshaller _instance = new();

        internal static DescribeChannelRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelRequestMarshaller Instance => _instance;
    }
}
