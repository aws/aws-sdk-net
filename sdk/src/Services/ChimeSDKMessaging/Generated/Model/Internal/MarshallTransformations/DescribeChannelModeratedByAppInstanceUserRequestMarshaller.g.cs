...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeChannelModeratedByAppInstanceUserRequestMarshaller : IMarshaller<IRequest, DescribeChannelModeratedByAppInstanceUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeChannelModeratedByAppInstanceUserRequestMarshaller _instance = new();

        internal static DescribeChannelModeratedByAppInstanceUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeChannelModeratedByAppInstanceUserRequestMarshaller Instance => _instance;
    }
}
