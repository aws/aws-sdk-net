...
{
    /// <summary>
    /// Response Unmarshaller for ChannelFlow Object
    /// </summary>
    public partial class ChannelFlowUnmarshaller : IJsonUnmarshaller<ChannelFlow, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ChannelFlow Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ChannelFlow();
        ...
        private static ChannelFlowUnmarshaller _instance = new ChannelFlowUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ChannelFlowUnmarshaller Instance => _instance;
    }
}
