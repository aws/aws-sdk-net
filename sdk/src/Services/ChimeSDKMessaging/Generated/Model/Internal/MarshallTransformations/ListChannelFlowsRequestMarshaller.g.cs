...
{
    /// <summary>
    /// ListChannelFlows Request Marshaller
    /// </summary>
    public partial class ListChannelFlowsRequestMarshaller : IMarshaller<IRequest, ListChannelFlowsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListChannelFlowsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListChannelFlowsRequest publicRequest)
        {
        ...
        private static readonly ListChannelFlowsRequestMarshaller _instance = new();

        internal static ListChannelFlowsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelFlowsRequestMarshaller Instance => _instance;
    }
}
