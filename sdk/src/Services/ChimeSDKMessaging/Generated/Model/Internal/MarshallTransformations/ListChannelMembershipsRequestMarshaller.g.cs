...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelMembershipsRequestMarshaller : IMarshaller<IRequest, ListChannelMembershipsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListChannelMembershipsRequestMarshaller _instance = new();

        internal static ListChannelMembershipsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelMembershipsRequestMarshaller Instance => _instance;
    }
}
