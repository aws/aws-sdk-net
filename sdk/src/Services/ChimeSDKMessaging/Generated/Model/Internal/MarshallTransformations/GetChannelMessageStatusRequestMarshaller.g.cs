...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetChannelMessageStatusRequestMarshaller : IMarshaller<IRequest, GetChannelMessageStatusRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetChannelMessageStatusRequestMarshaller _instance = new();

        internal static GetChannelMessageStatusRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetChannelMessageStatusRequestMarshaller Instance => _instance;
    }
}
