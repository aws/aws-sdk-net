...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateChannelFlowRequestMarshaller : IMarshaller<IRequest, CreateChannelFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateChannelFlowRequestMarshaller _instance = new CreateChannelFlowRequestMarshaller();        

        internal static CreateChannelFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
