...
{
    /// <summary>
    /// DescribeChannelModerator Request Marshaller
    /// </summary>       
    public class DescribeChannelModeratorRequestMarshaller : IMarshaller<IRequest, DescribeChannelModeratorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeChannelModeratorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeChannelModeratorRequest publicRequest)
        {
        ...
        private static DescribeChannelModeratorRequestMarshaller _instance = new DescribeChannelModeratorRequestMarshaller();        

        internal static DescribeChannelModeratorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelModeratorRequestMarshaller Instance
        {
            get
            {
                return _instance;
