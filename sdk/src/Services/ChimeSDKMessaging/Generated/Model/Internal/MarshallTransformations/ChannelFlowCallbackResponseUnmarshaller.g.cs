...
{
    /// <summary>
    /// Response Unmarshaller for ChannelFlowCallback operation.
    /// </summary>
    public partial class ChannelFlowCallbackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ChannelFlowCallbackResponse();
            ...
            {
                if (context.TestExpression("CallbackId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CallbackId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ChannelFlowCallbackResponseUnmarshaller _instance = new ChannelFlowCallbackResponseUnmarshaller();

        internal static ChannelFlowCallbackResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ChannelFlowCallbackResponseUnmarshaller Instance => _instance;
    }
}
