...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    public class ChannelMembershipForAppInstanceUserSummaryUnmarshaller : IJsonUnmarshaller<ChannelMembershipForAppInstanceUserSummary, JsonUnmarshallerContext>
    {
        ...
        private static ChannelMembershipForAppInstanceUserSummaryUnmarshaller _instance = new ChannelMembershipForAppInstanceUserSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChannelMembershipForAppInstanceUserSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
