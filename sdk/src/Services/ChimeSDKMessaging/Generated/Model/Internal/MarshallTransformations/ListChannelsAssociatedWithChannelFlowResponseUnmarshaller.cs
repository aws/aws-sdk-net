...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListChannelsAssociatedWithChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelsAssociatedWithChannelFlowResponse response = new ListChannelsAssociatedWithChannelFlowResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ChannelAssociatedWithFlowSummary, ChannelAssociatedWithFlowSummaryUnmarshaller>(ChannelAssociatedWithFlowSummaryUnmarshaller.Instance);
        ...
        internal static ListChannelsAssociatedWithChannelFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelsAssociatedWithChannelFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
