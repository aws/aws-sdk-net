...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelBan operation
    /// </summary>  
    public class DescribeChannelBanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelBanResponse response = new DescribeChannelBanResponse();
            ...
            {
                if (context.TestExpression("ChannelBan", targetDepth, ref reader))
                {
                    var unmarshaller = ChannelBanUnmarshaller.Instance;
                    response.ChannelBan = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeChannelBanResponseUnmarshaller _instance = new DescribeChannelBanResponseUnmarshaller();        

        internal static DescribeChannelBanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelBanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
