...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AssociateChannelFlowRequestMarshaller : IMarshaller<IRequest, AssociateChannelFlowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly AssociateChannelFlowRequestMarshaller _instance = new();

        internal static AssociateChannelFlowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static AssociateChannelFlowRequestMarshaller Instance => _instance;
    }
}
