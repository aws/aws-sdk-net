...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelMemberships operation.
    /// </summary>
    public partial class ListChannelMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListChannelMembershipsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ChannelMemberships", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelMembershipSummary, ChannelMembershipSummaryUnmarshaller>(ChannelMembershipSummaryUnmarshaller.Instance);
                    unmarshalledObject.ChannelMemberships = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListChannelMembershipsResponseUnmarshaller _instance = new ListChannelMembershipsResponseUnmarshaller();

        internal static ListChannelMembershipsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelMembershipsResponseUnmarshaller Instance => _instance;
    }
}
