...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutChannelMembershipPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PutChannelMembershipPreferencesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Preferences", targetDepth, ref reader))
                {
                    var unmarshaller = ChannelMembershipPreferencesUnmarshaller.Instance;
                    unmarshalledObject.Preferences = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static PutChannelMembershipPreferencesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutChannelMembershipPreferencesResponseUnmarshaller Instance => _instance;
    }
}
