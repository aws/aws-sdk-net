...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteChannelMessageRequestMarshaller : IMarshaller<IRequest, DeleteChannelMessageRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteChannelMessageRequestMarshaller _instance = new();

        internal static DeleteChannelMessageRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteChannelMessageRequestMarshaller Instance => _instance;
    }
}
