...
{
    /// <summary>
    /// RedactChannelMessage Request Marshaller
    /// </summary>       
    public class RedactChannelMessageRequestMarshaller : IMarshaller<IRequest, RedactChannelMessageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RedactChannelMessageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RedactChannelMessageRequest publicRequest)
        {
        ...
        private static RedactChannelMessageRequestMarshaller _instance = new RedactChannelMessageRequestMarshaller();        

        internal static RedactChannelMessageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RedactChannelMessageRequestMarshaller Instance
        {
            get
            {
                return _instance;
