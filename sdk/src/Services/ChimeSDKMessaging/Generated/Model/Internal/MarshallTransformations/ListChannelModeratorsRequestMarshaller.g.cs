...
{
    /// <summary>
    /// ListChannelModerators Request Marshaller
    /// </summary>
    public partial class ListChannelModeratorsRequestMarshaller : IMarshaller<IRequest, ListChannelModeratorsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListChannelModeratorsRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(ListChannelModeratorsRequest publicRequest)
        {
        ...
        private static readonly ListChannelModeratorsRequestMarshaller _instance = new();

        internal static ListChannelModeratorsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelModeratorsRequestMarshaller Instance => _instance;
    }
}
