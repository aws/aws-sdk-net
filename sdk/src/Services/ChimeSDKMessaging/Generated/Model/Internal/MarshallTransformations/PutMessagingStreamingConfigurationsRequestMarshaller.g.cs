...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutMessagingStreamingConfigurationsRequestMarshaller : IMarshaller<IRequest, PutMessagingStreamingConfigurationsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutMessagingStreamingConfigurationsRequestMarshaller _instance = new();

        internal static PutMessagingStreamingConfigurationsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutMessagingStreamingConfigurationsRequestMarshaller Instance => _instance;
    }
}
