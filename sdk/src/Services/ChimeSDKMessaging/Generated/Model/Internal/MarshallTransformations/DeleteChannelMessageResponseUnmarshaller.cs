...
{
    /// <summary>
    /// Response Unmarshaller for DeleteChannelMessage operation
    /// </summary>  
    public class DeleteChannelMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteChannelMessageResponse response = new DeleteChannelMessageResponse();
        ...
        private static DeleteChannelMessageResponseUnmarshaller _instance = new DeleteChannelMessageResponseUnmarshaller();        

        internal static DeleteChannelMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
