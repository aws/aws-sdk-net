...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelsAssociatedWithChannelFlow operation.
    /// </summary>
    public partial class ListChannelsAssociatedWithChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListChannelsAssociatedWithChannelFlowResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelAssociatedWithFlowSummary, ChannelAssociatedWithFlowSummaryUnmarshaller>(ChannelAssociatedWithFlowSummaryUnmarshaller.Instance);
        ...
        private static ListChannelsAssociatedWithChannelFlowResponseUnmarshaller _instance = new ListChannelsAssociatedWithChannelFlowResponseUnmarshaller();

        internal static ListChannelsAssociatedWithChannelFlowResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelsAssociatedWithChannelFlowResponseUnmarshaller Instance => _instance;
    }
}
