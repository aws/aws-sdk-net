...
{
    /// <summary>
    /// CreateChannelFlow Request Marshaller
    /// </summary>
    public partial class CreateChannelFlowRequestMarshaller : IMarshaller<IRequest, CreateChannelFlowRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateChannelFlowRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(CreateChannelFlowRequest publicRequest)
        {
            ...
            request.ResourcePath = "/channel-flows";
#if !NETFRAMEWORK
        ...
        private static readonly CreateChannelFlowRequestMarshaller _instance = new();

        internal static CreateChannelFlowRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChannelFlowRequestMarshaller Instance => _instance;
    }
}
