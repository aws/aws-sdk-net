...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateChannelReadMarkerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateChannelReadMarkerResponse();
        ...
        internal static UpdateChannelReadMarkerResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateChannelReadMarkerResponseUnmarshaller Instance => _instance;
    }
}
