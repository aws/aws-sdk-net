...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListChannelsModeratedByAppInstanceUserRequestMarshaller : IMarshaller<IRequest, ListChannelsModeratedByAppInstanceUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListChannelsModeratedByAppInstanceUserRequestMarshaller _instance = new();

        internal static ListChannelsModeratedByAppInstanceUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListChannelsModeratedByAppInstanceUserRequestMarshaller Instance => _instance;
    }
}
