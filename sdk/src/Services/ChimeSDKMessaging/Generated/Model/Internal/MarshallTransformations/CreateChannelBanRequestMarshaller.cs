...
{
    /// <summary>
    /// CreateChannelBan Request Marshaller
    /// </summary>       
    public class CreateChannelBanRequestMarshaller : IMarshaller<IRequest, CreateChannelBanRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateChannelBanRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateChannelBanRequest publicRequest)
        {
        ...
        private static CreateChannelBanRequestMarshaller _instance = new CreateChannelBanRequestMarshaller();        

        internal static CreateChannelBanRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelBanRequestMarshaller Instance
        {
            get
            {
                return _instance;
