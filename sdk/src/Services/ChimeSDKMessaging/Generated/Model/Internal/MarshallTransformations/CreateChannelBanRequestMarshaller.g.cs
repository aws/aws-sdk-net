...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateChannelBanRequestMarshaller : IMarshaller<IRequest, CreateChannelBanRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateChannelBanRequestMarshaller _instance = new();

        internal static CreateChannelBanRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateChannelBanRequestMarshaller Instance => _instance;
    }
}
