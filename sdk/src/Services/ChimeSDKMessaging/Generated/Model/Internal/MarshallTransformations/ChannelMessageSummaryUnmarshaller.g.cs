...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ChannelMessageSummaryUnmarshaller : IJsonUnmarshaller<ChannelMessageSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public ChannelMessageSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new ChannelMessageSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LastEditedTimestamp", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.LastEditedTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("MessageAttributes", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("Redacted", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.Redacted = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }

                if (context.TestExpression("Sender", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static ChannelMessageSummaryUnmarshaller Instance => _instance;
    }
}
