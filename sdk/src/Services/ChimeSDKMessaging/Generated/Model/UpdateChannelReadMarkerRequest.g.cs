...
{
    /// <summary>
    /// Container for the parameters to the UpdateChannelReadMarker operation. The details
    /// of the time when a user last read messages in a channel. <note> <para> The <c>x-amz-chime-bearer</c>
