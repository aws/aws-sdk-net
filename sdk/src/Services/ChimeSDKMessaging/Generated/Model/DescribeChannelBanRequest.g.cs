...
{
    /// <summary>
    /// Container for the parameters to the DescribeChannelBan operation. Returns the full
    /// details of a channel ban. <note> <para> The <c>x-amz-chime-bearer</c> request header
