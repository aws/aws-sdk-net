...
{
    /// <summary>
    /// Container for the parameters to the DeleteChannelMembership operation. Removes a member
    /// from a channel. <note> <para> The <c>x-amz-chime-bearer</c> request header is mandatory.
    /// Use the <c>AppInstanceUserArn</c> of the user that makes the API call as the value
