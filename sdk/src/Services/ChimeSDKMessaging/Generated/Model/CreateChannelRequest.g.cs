...
{
    /// <summary>
    /// Container for the parameters to the CreateChannel operation. Creates a channel to
    /// which you can add users and send messages. <para> <b>Restriction</b>: You can't change
    /// a channel's privacy. </para> <note> <para> The <c>x-amz-chime-bearer</c> request header
    ...
    public partial class CreateChannelRequest : AmazonChimeSDKMessagingRequest
    {
        ...
        /// </summary>
        [AWSProperty(Min = 1, Max = 10)]
        public List<string> ModeratorArns { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the ModeratorArns property is set.
        /// </summary>
        internal bool IsSetModeratorArns() => this.ModeratorArns != null && (this.ModeratorArns.Count > 0 || !AWSConfigs.InitializeCollections);
