...
{
    /// <summary>
    /// Container for the parameters to the DescribeChannel operation. Returns the full details
    /// of a channel in an Amazon Chime <c>AppInstance</c>. <note> <para> The <c>x-amz-chime-bearer</c>
