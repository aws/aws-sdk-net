...
{
    /// <summary>
    /// Container for the parameters to the DeleteChannelBan operation. Removes a member from
    /// a channel's ban list. <note> <para> The <c>x-amz-chime-bearer</c> request header is
