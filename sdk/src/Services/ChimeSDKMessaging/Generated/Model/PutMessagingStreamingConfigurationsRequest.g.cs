...
namespace Amazon.ChimeSDKMessaging.Model
{
    ...
    public partial class PutMessagingStreamingConfigurationsRequest : AmazonChimeSDKMessagingRequest
    {
        ...
        public List<StreamingConfiguration> StreamingConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<StreamingConfiguration>() : null;

        /// <summary>
        /// Checks to see if the StreamingConfigurations property is set.
        /// </summary>
        internal bool IsSetStreamingConfigurations() => this.StreamingConfigurations != null && (this.StreamingConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
