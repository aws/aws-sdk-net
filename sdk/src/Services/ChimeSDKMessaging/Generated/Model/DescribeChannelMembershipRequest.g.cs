...
{
    /// <summary>
    /// Container for the parameters to the DescribeChannelMembership operation. Returns the
    /// full details of a user's channel membership. <note> <para> The <c>x-amz-chime-bearer</c>
    ...
    public partial class DescribeChannelMembershipRequest : AmazonChimeSDKMessagingRequest
    {
        ...
        /// <para>
        /// The <c>AppInstanceUserArn</c> of the member.
        /// </para>
        /// </summary>
        [AWSProperty(Required = true, Min = 5, Max = 1600)]
        ...
        /// <para>
        /// The ID of the SubChannel in the request. The response contains an <c>ElasticChannelConfiguration</c>
        /// object.
        /// </para>
        ///  <note> 
        /// <para>
