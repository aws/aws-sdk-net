...
{
    /// <summary>
    /// Container for the parameters to the RedactChannelMessage operation. Redacts message
    /// content and metadata. The message exists in the back end, but the action returns null
    /// content, and the state shows as redacted. <note> <para> The <c>x-amz-chime-bearer</c>
