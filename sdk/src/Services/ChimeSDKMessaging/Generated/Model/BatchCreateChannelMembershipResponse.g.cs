...
namespace Amazon.ChimeSDKMessaging.Model
{
    ...
    public partial class BatchCreateChannelMembershipResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Checks to see if the BatchChannelMemberships property is set.
        /// </summary>
        internal bool IsSetBatchChannelMemberships() => this.BatchChannelMemberships != null;
        ...
        /// </summary>
        public List<BatchCreateChannelMembershipError> Errors { get; set; } = AWSConfigs.InitializeCollections ? new List<BatchCreateChannelMembershipError>() : null;
