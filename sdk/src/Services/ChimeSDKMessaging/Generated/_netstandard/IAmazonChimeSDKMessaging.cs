...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonChimeSDKMessagingConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonChimeSDKMessagingConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonChimeSDKMessagingConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonChimeSDKMessagingConfig to create AmazonChimeSDKMessagingClient");
            }

            return awsCredentials == null ? 
                    new AmazonChimeSDKMessagingClient(serviceClientConfig) :
                    new AmazonChimeSDKMessagingClient(awsCredentials, serviceClientConfig);
        }
