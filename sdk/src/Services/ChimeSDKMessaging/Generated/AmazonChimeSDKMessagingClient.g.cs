...
namespace Amazon.ChimeSDKMessaging
{
    ...
    public partial class AmazonChimeSDKMessagingClient : AmazonServiceClient, IAmazonChimeSDKMessaging
    {
        ...
        /// 
        /// </summary>
        public AmazonChimeSDKMessagingClient() : base(new AmazonChimeSDKMessagingConfig()) { }
        ...
        public AmazonChimeSDKMessagingClient(RegionEndpoint region) : base(new AmazonChimeSDKMessagingConfig { RegionEndpoint = region }) { }
        ...
        public AmazonChimeSDKMessagingClient(AmazonChimeSDKMessagingConfig config) : base(config) { }
