...
namespace Amazon.BedrockRuntime.Model
{
    ...
    /// </summary>
    public partial class GuardrailAutomatedReasoningTranslationAmbiguousFinding
    {
        private List<GuardrailAutomatedReasoningScenario> _differenceScenarios = AWSConfigs.InitializeCollections ? new List<GuardrailAutomatedReasoningScenario>() : null;
        private List<GuardrailAutomatedReasoningTranslationOption> _options = AWSConfigs.InitializeCollections ? new List<GuardrailAutomatedReasoningTranslationOption>() : null;
        ...
        public List<GuardrailAutomatedReasoningScenario> DifferenceScenarios
        {
        ...
        /// </summary>
        [AWSProperty(Min=0, Max=2)]
        public List<GuardrailAutomatedReasoningTranslationOption> Options
        {
