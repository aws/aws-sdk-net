...
namespace Amazon.BedrockRuntime.Model
{
    ...
    /// Each block references a single tool via its <c>tool</c> field. Use within a <c>system</c>
    /// role message to remove a tool without re-sending the full tool configuration.
    /// </summary>
    public partial class ToolRemovalBlock
    {
