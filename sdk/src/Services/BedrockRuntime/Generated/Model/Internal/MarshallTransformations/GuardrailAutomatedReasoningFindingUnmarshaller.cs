...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GuardrailAutomatedReasoningFindingUnmarshaller : IUnmarshaller<GuardrailAutomatedReasoningFinding, XmlUnmarshallerContext>, IUnmarshaller<GuardrailAutomatedReasoningFinding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GuardrailAutomatedReasoningFinding IUnmarshaller<GuardrailAutomatedReasoningFinding, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GuardrailAutomatedReasoningFinding Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("impossible", targetDepth))
                {
                    ...
                    unmarshalledObject.Impossible = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("invalid", targetDepth))
                {
                    ...
                    unmarshalledObject.Invalid = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("noTranslations", targetDepth))
                {
                    ...
                    unmarshalledObject.NoTranslations = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("satisfiable", targetDepth))
                {
                    ...
                    unmarshalledObject.Satisfiable = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("tooComplex", targetDepth))
                {
                    ...
                    unmarshalledObject.TooComplex = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("translationAmbiguous", targetDepth))
                {
                    ...
                    unmarshalledObject.TranslationAmbiguous = unmarshaller.Unmarshall(context);
                    continue;
                }
