...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AsyncInvokeSummaryUnmarshaller : IUnmarshaller<AsyncInvokeSummary, XmlUnmarshallerContext>, IUnmarshaller<AsyncInvokeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AsyncInvokeSummary IUnmarshaller<AsyncInvokeSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AsyncInvokeSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InvocationArn = unmarshaller.Unmarshall(context);
                    continue;
                }
