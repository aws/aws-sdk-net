...
{
    /// <summary>
    /// Response Unmarshaller for GetAsyncInvoke operation
    /// </summary>  
    public class GetAsyncInvokeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAsyncInvokeResponse response = new GetAsyncInvokeResponse();
        ...
        private static GetAsyncInvokeResponseUnmarshaller _instance = new GetAsyncInvokeResponseUnmarshaller();        

        internal static GetAsyncInvokeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAsyncInvokeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
