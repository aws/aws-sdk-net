...
{
    /// <summary>
    /// Response Unmarshaller for InvokeGuardrailChecks operation
    /// </summary>  
    public class InvokeGuardrailChecksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InvokeGuardrailChecksResponse response = new InvokeGuardrailChecksResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = GuardrailChecksResultsUnmarshaller.Instance;
                    response.Results = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("usage", targetDepth, ref reader))
                {
                    var unmarshaller = GuardrailChecksUsageResultsUnmarshaller.Instance;
        ...
        private static InvokeGuardrailChecksResponseUnmarshaller _instance = new InvokeGuardrailChecksResponseUnmarshaller();        

        internal static InvokeGuardrailChecksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeGuardrailChecksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
