...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MessageStopEventUnmarshaller : IUnmarshaller<MessageStopEvent, XmlUnmarshallerContext>, IUnmarshaller<MessageStopEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MessageStopEvent IUnmarshaller<MessageStopEvent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MessageStopEvent Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("additionalModelResponseFields", targetDepth))
                {
                    ...
                    unmarshalledObject.AdditionalModelResponseFields = unmarshaller.Unmarshall(context);
                    continue;
                }
