...
{
    /// <summary>
    /// Information about the <c>DeleteNetworkAclEntries</c> action in Amazon EC2. This is
    /// a remediation option in <c>RemediationAction</c>.
    /// </summary>
    public partial class DeleteNetworkAclEntriesAction
    {
        private string _description;
        private bool? _fmsCanRemediate;
        private List<EntryDescription> _networkAclEntriesToBeDeleted = AWSConfigs.InitializeCollections ? new List<EntryDescription>() : null;
        ...
        /// <summary>
        /// Gets and sets the property NetworkAclEntriesToBeDeleted. 
        /// <para>
        ...
        /// </summary>
        public List<EntryDescription> NetworkAclEntriesToBeDeleted
        {
            get { return this._networkAclEntriesToBeDeleted; }
            set { this._networkAclEntriesToBeDeleted = value; }
        }

        // Check to see if NetworkAclEntriesToBeDeleted property is set
        internal bool IsSetNetworkAclEntriesToBeDeleted()
        {
            return this._networkAclEntriesToBeDeleted != null && (this._networkAclEntriesToBeDeleted.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
