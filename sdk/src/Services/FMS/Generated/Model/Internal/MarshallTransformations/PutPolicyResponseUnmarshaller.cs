...
{
    /// <summary>
    /// Response Unmarshaller for PutPolicy operation
    /// </summary>  
    public class PutPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutPolicyResponse response = new PutPolicyResponse();
        ...
        private static PutPolicyResponseUnmarshaller _instance = new PutPolicyResponseUnmarshaller();        

        internal static PutPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
