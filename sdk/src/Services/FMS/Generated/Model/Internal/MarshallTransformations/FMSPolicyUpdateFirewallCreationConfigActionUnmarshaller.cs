    ...
    public class FMSPolicyUpdateFirewallCreationConfigActionUnmarshaller : IJsonUnmarshaller<FMSPolicyUpdateFirewallCreationConfigAction, JsonUnmarshallerContext>
    {
        ...
        public FMSPolicyUpdateFirewallCreationConfigAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FirewallCreationConfig", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static FMSPolicyUpdateFirewallCreationConfigActionUnmarshaller _instance = new FMSPolicyUpdateFirewallCreationConfigActionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FMSPolicyUpdateFirewallCreationConfigActionUnmarshaller Instance
        {
            get
            {
                return _instance;
