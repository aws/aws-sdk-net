...
namespace Amazon.FMS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkFirewallUnexpectedGatewayRoutesViolationUnmarshaller : IUnmarshaller<NetworkFirewallUnexpectedGatewayRoutesViolation, XmlUnmarshallerContext>, IUnmarshaller<NetworkFirewallUnexpectedGatewayRoutesViolation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NetworkFirewallUnexpectedGatewayRoutesViolation IUnmarshaller<NetworkFirewallUnexpectedGatewayRoutesViolation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public NetworkFirewallUnexpectedGatewayRoutesViolation Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
