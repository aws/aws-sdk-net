...
namespace Amazon.FMS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemediationActionWithOrderUnmarshaller : IUnmarshaller<RemediationActionWithOrder, XmlUnmarshallerContext>, IUnmarshaller<RemediationActionWithOrder, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RemediationActionWithOrder IUnmarshaller<RemediationActionWithOrder, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RemediationActionWithOrder Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("RemediationAction", targetDepth))
                {
                    ...
                    unmarshalledObject.RemediationAction = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
