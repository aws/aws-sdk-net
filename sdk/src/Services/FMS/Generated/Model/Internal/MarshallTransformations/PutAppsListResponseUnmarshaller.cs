...
{
    /// <summary>
    /// Response Unmarshaller for PutAppsList operation
    /// </summary>  
    public class PutAppsListResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAppsListResponse response = new PutAppsListResponse();
        ...
        private static PutAppsListResponseUnmarshaller _instance = new PutAppsListResponseUnmarshaller();        

        internal static PutAppsListResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAppsListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
