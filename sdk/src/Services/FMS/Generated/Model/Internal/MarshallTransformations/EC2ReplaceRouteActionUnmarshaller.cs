...
namespace Amazon.FMS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EC2ReplaceRouteActionUnmarshaller : IUnmarshaller<EC2ReplaceRouteAction, XmlUnmarshallerContext>, IUnmarshaller<EC2ReplaceRouteAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        EC2ReplaceRouteAction IUnmarshaller<EC2ReplaceRouteAction, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public EC2ReplaceRouteAction Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
