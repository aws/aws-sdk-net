...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonFMSConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonFMSConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonFMSConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonFMSConfig to create AmazonFMSClient");
            }

            return awsCredentials == null ? 
                    new AmazonFMSClient(serviceClientConfig) :
                    new AmazonFMSClient(awsCredentials, serviceClientConfig);
        }
