...
{
    /// <summary>
    /// OverrideConfiguration Marshaller
    /// </summary>
    public class OverrideConfigurationMarshaller : IRequestMarshaller<OverrideConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(OverrideConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDocument())
            {
                ...
                var marshaller = DocumentOverrideConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static OverrideConfigurationMarshaller Instance = new OverrideConfigurationMarshaller();
