...
namespace Amazon.BedrockDataAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BlueprintOptimizationSampleUnmarshaller : IUnmarshaller<BlueprintOptimizationSample, XmlUnmarshallerContext>, IUnmarshaller<BlueprintOptimizationSample, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        BlueprintOptimizationSample IUnmarshaller<BlueprintOptimizationSample, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public BlueprintOptimizationSample Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assetS3Object", targetDepth))
                {
                    ...
                    unmarshalledObject.AssetS3Object = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("groundTruthS3Object", targetDepth))
                {
                    var unmarshaller = S3ObjectUnmarshaller.Instance;
                    unmarshalledObject.GroundTruthS3Object = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
