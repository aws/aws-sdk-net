...
{
    /// <summary>
    /// Response Unmarshaller for DataAutomationLibraryIngestionJob Object
    /// </summary>  
    public class DataAutomationLibraryIngestionJobUnmarshaller : IJsonUnmarshaller<DataAutomationLibraryIngestionJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataAutomationLibraryIngestionJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DataAutomationLibraryIngestionJob unmarshalledObject = new DataAutomationLibraryIngestionJob();
        ...
        private static DataAutomationLibraryIngestionJobUnmarshaller _instance = new DataAutomationLibraryIngestionJobUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataAutomationLibraryIngestionJobUnmarshaller Instance
        {
            get
            {
                return _instance;
