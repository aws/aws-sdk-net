...
namespace Amazon.BedrockDataAutomation
{
    ...
    /// <summary>
    /// Constants used for properties of type BlueprintOptimizationJobStatus.
    /// </summary>
    public class BlueprintOptimizationJobStatus : ConstantClass
    {

        /// <summary>
        /// Constant ClientError for BlueprintOptimizationJobStatus
        /// </summary>
        public static readonly BlueprintOptimizationJobStatus ClientError = new BlueprintOptimizationJobStatus("ClientError");
        /// <summary>
        /// Constant Created for BlueprintOptimizationJobStatus
        /// </summary>
        public static readonly BlueprintOptimizationJobStatus Created = new BlueprintOptimizationJobStatus("Created");
        /// <summary>
        /// Constant InProgress for BlueprintOptimizationJobStatus
        /// </summary>
        public static readonly BlueprintOptimizationJobStatus InProgress = new BlueprintOptimizationJobStatus("InProgress");
        /// <summary>
        /// Constant ServiceError for BlueprintOptimizationJobStatus
        /// </summary>
        public static readonly BlueprintOptimizationJobStatus ServiceError = new BlueprintOptimizationJobStatus("ServiceError");
        /// <summary>
        /// Constant Success for BlueprintOptimizationJobStatus
        /// </summary>
        public static readonly BlueprintOptimizationJobStatus Success = new BlueprintOptimizationJobStatus("Success");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public BlueprintOptimizationJobStatus(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static BlueprintOptimizationJobStatus FindValue(string value)
        {
            return FindValue<BlueprintOptimizationJobStatus>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator BlueprintOptimizationJobStatus(string value)
        {
            return FindValue(value);
        }
    }
