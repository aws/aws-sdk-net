...
#elif NET6_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (6.0) - Schemas. This release introduces support for Amazon EventBridge schema registry, making it easy to discover and write code for events in EventBridge.")]
#else
