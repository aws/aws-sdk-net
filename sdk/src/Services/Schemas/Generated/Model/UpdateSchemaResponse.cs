...
namespace Amazon.Schemas.Model
{
    ...
    public partial class UpdateSchemaResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property VersionCreatedDate. 
        /// <para>
        ...
        // Check to see if VersionCreatedDate property is set
        internal bool IsSetVersionCreatedDate()
        {
            return this._versionCreatedDate.HasValue; 
        }
