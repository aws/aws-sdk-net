...
{
    /// <summary>
    /// UpdateDiscoverer Request Marshaller
    /// </summary>       
    public class UpdateDiscovererRequestMarshaller : IMarshaller<IRequest, UpdateDiscovererRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateDiscovererRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateDiscovererRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCrossAccount())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.CrossAccount.Value);
            }
        ...
        private static UpdateDiscovererRequestMarshaller _instance = new UpdateDiscovererRequestMarshaller();        

        internal static UpdateDiscovererRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDiscovererRequestMarshaller Instance
        {
            get
            {
                return _instance;
