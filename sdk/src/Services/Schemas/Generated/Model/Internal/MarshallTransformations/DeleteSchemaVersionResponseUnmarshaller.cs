...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSchemaVersion operation
    /// </summary>  
    public class DeleteSchemaVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSchemaVersionResponse response = new DeleteSchemaVersionResponse();
        ...
        private static DeleteSchemaVersionResponseUnmarshaller _instance = new DeleteSchemaVersionResponseUnmarshaller();        

        internal static DeleteSchemaVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSchemaVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
