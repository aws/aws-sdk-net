...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDiscoverer operation
    /// </summary>  
    public class DeleteDiscovererResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDiscovererResponse response = new DeleteDiscovererResponse();
        ...
        private static DeleteDiscovererResponseUnmarshaller _instance = new DeleteDiscovererResponseUnmarshaller();        

        internal static DeleteDiscovererResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDiscovererResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
