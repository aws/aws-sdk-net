...
namespace Amazon.Schemas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeRegistryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRegistryResponse response = new DescribeRegistryResponse();
        ...
        private static DescribeRegistryResponseUnmarshaller _instance = new DescribeRegistryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRegistryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
