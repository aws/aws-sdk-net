...
{
    /// <summary>
    /// Response Unmarshaller for SearchSchemas operation
    /// </summary>  
    public class SearchSchemasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchSchemasResponse response = new SearchSchemasResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SearchSchemaSummary, SearchSchemaSummaryUnmarshaller>(SearchSchemaSummaryUnmarshaller.Instance);
        ...
        private static SearchSchemasResponseUnmarshaller _instance = new SearchSchemasResponseUnmarshaller();        

        internal static SearchSchemasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchSchemasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
