...
{
    /// <summary>
    /// Response Unmarshaller for GetCodeBindingSource operation
    /// </summary>  
    public class GetCodeBindingSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCodeBindingSourceResponse response = new GetCodeBindingSourceResponse();
        ...
        private static GetCodeBindingSourceResponseUnmarshaller _instance = new GetCodeBindingSourceResponseUnmarshaller();        

        internal static GetCodeBindingSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCodeBindingSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
