...
{
    /// <summary>
    /// Response Unmarshaller for CreateDiscoverer operation
    /// </summary>  
    public class CreateDiscovererResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDiscovererResponse response = new CreateDiscovererResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CrossAccount", targetDepth, ref reader))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.CrossAccount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("DiscovererArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DiscovererArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DiscovererId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DiscovererId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateDiscovererResponseUnmarshaller _instance = new CreateDiscovererResponseUnmarshaller();        

        internal static CreateDiscovererResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDiscovererResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
