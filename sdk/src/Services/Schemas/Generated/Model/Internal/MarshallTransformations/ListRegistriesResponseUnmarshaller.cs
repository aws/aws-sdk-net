    ...
    public class ListRegistriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RegistrySummary, RegistrySummaryUnmarshaller>(RegistrySummaryUnmarshaller.Instance);
                    response.Registries = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
