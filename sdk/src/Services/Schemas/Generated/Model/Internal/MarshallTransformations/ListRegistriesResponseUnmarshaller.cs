...
{
    /// <summary>
    /// Response Unmarshaller for ListRegistries operation
    /// </summary>  
    public class ListRegistriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRegistriesResponse response = new ListRegistriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Registries", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<RegistrySummary, RegistrySummaryUnmarshaller>(RegistrySummaryUnmarshaller.Instance);
                    response.Registries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListRegistriesResponseUnmarshaller _instance = new ListRegistriesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRegistriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
