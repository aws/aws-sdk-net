...
namespace Amazon.SQS.Model
{
    ...
    [Serializable]
    #endif
    public partial class KmsInvalidKeyUsageException : AmazonSQSException
    {
        ...
        public KmsInvalidKeyUsageException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KmsInvalidKeyUsageException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
