    ...
    public class DeleteMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, true, context.ResponseData))
            {
                ...
                if (errorTypeName != null && errorTypeName.Equals("InvalidIdFormat"))
                {
                    return InvalidIdFormatExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorTypeName != null && errorTypeName.Equals("ReceiptHandleIsInvalid"))
                {
                    return ReceiptHandleIsInvalidExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
