...
{
    /// <summary>
    /// CancelMessageMoveTask Request Marshaller
    /// </summary>       
    public class CancelMessageMoveTaskRequestMarshaller : IMarshaller<IRequest, CancelMessageMoveTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CancelMessageMoveTaskRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetTaskHandle())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TaskHandle);
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMessageMoveTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
