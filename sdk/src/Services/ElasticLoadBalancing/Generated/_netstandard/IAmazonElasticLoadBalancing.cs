...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElasticLoadBalancingConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElasticLoadBalancingConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElasticLoadBalancingConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElasticLoadBalancingConfig to create AmazonElasticLoadBalancingClient");
            }

            return awsCredentials == null ? 
                    new AmazonElasticLoadBalancingClient(serviceClientConfig) :
                    new AmazonElasticLoadBalancingClient(awsCredentials, serviceClientConfig);
        }
