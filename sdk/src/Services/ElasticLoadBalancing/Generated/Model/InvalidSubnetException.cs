...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidSubnetException : AmazonElasticLoadBalancingException
    {
        ...
        public InvalidSubnetException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSubnetException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
