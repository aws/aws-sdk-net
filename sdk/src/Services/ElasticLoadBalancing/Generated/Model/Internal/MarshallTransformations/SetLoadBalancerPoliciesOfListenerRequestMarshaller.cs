...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetLoadBalancerPoliciesOfListenerRequestMarshaller : IMarshaller<IRequest, SetLoadBalancerPoliciesOfListenerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetLoadBalancerPoliciesOfListenerRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetLoadBalancerPoliciesOfListenerRequestMarshaller Instance
        {
            get
            {
                return _instance;
