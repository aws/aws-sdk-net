...
namespace Amazon.NimbleStudio
{
    ...
    public partial class AmazonNimbleStudioException : AmazonServiceException
    {
        ...
        public AmazonNimbleStudioException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonNimbleStudioException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
