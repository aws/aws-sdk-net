...
namespace Amazon.NimbleStudio
{
    ...
    public partial interface IAmazonNimbleStudio : IAmazonService, IDisposable
    {
        ...
        Task<GetStreamingSessionBackupResponse> GetStreamingSessionBackupAsync(GetStreamingSessionBackupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListStreamingSessionBackupsResponse> ListStreamingSessionBackupsAsync(ListStreamingSessionBackupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonNimbleStudioConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonNimbleStudioConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonNimbleStudioConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonNimbleStudioConfig to create AmazonNimbleStudioClient");
            }

            return awsCredentials == null ? 
                    new AmazonNimbleStudioClient(serviceClientConfig) :
                    new AmazonNimbleStudioClient(awsCredentials, serviceClientConfig);
        }
