        ...
        public Studio Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("adminRoleArn", targetDepth))
                {
                    ...
                    unmarshalledObject.AdminRoleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StudioEncryptionConfigurationUnmarshaller.Instance;
                    unmarshalledObject.StudioEncryptionConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StudioName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("studioUrl", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StudioUrl = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UserRoleArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
