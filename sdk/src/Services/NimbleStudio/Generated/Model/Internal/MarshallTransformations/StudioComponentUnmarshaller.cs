...
{
    /// <summary>
    /// Response Unmarshaller for StudioComponent Object
    /// </summary>  
    public class StudioComponentUnmarshaller : IUnmarshaller<StudioComponent, XmlUnmarshallerContext>, IUnmarshaller<StudioComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        StudioComponent IUnmarshaller<StudioComponent, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public StudioComponent Unmarshall(JsonUnmarshallerContext context)
        {
            StudioComponent unmarshalledObject = new StudioComponent();
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StudioComponentConfigurationUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StudioComponentInitializationScript, StudioComponentInitializationScriptUnmarshaller>(StudioComponentInitializationScriptUnmarshaller.Instance);
                    unmarshalledObject.InitializationScripts = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static StudioComponentUnmarshaller _instance = new StudioComponentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static StudioComponentUnmarshaller Instance
        {
            get
            {
                return _instance;
