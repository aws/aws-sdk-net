...
namespace Amazon.NimbleStudio.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActiveDirectoryConfigurationUnmarshaller : IUnmarshaller<ActiveDirectoryConfiguration, XmlUnmarshallerContext>, IUnmarshaller<ActiveDirectoryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ActiveDirectoryConfiguration IUnmarshaller<ActiveDirectoryConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ActiveDirectoryConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ActiveDirectoryComputerAttribute, ActiveDirectoryComputerAttributeUnmarshaller>(ActiveDirectoryComputerAttributeUnmarshaller.Instance);
