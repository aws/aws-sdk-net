...
{
    /// <summary>
    /// UpdateStreamingImage Request Marshaller
    /// </summary>       
    public class UpdateStreamingImageRequestMarshaller : IMarshaller<IRequest, UpdateStreamingImageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateStreamingImageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateStreamingImageRequest publicRequest)
        {
        ...
        private static UpdateStreamingImageRequestMarshaller _instance = new UpdateStreamingImageRequestMarshaller();        

        internal static UpdateStreamingImageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStreamingImageRequestMarshaller Instance
        {
            get
            {
                return _instance;
