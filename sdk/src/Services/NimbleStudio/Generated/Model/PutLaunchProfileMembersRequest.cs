...
{
    /// <summary>
    /// Container for the parameters to the PutLaunchProfileMembers operation.
    /// Add/update users with given persona to launch profile membership.
    /// </summary>
    public partial class PutLaunchProfileMembersRequest : AmazonNimbleStudioRequest
    {
        private string _clientToken;
        private string _identityStoreId;
        private string _launchProfileId;
        private List<NewLaunchProfileMember> _members = AWSConfigs.InitializeCollections ? new List<NewLaunchProfileMember>() : null;
