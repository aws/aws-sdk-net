...
{
    /// <summary>
    /// Base class for ListTableMetadata paginators.
    /// </summary>
    internal sealed partial class ListTableMetadataPaginator : IPaginator<ListTableMetadataResponse>, IListTableMetadataPaginator
    {
        private readonly IAmazonAthena _client;
        private readonly ListTableMetadataRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListTableMetadataResponse> Responses => new PaginatedResponse<ListTableMetadataResponse>(this);
        ...
        async IAsyncEnumerable<ListTableMetadataResponse> IPaginator<ListTableMetadataResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListTableMetadataAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
